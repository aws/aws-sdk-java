 ...
 */
public class AudioCodecOptionsJsonUnmarshaller implements Unmarshaller<AudioCodecOptions, JsonUnmarshallerContext> {
    ...
    public static AudioCodecOptionsJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AudioCodecOptionsJsonUnmarshaller();
        return instance;
    }
}
