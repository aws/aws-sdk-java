 ...
 */
public class ReadJobResultJsonUnmarshaller implements
        Unmarshaller<ReadJobResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Job", targetDepth)) {
                    context.nextToken();
                    readJobResult.setJob(JobJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
    ...
    public static ReadJobResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReadJobResultJsonUnmarshaller();
        return instance;
    }
}
