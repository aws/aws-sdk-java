...
public class CreatePipelineRequest extends AmazonWebServiceRequest implements
     ...
     * that Amazon SNS returned when you created the topic. For more
     ...
     * this pipeline. This is the ARN that Amazon SNS returned when you created
     * the topic.</li>
     ...
     *        Transcoder grants to the files. <important>When Elastic Transcoder
     *        saves files in <code>OutputBucket</code>, it grants full control
     *        over the files only to the AWS account that owns the role that is
     *        specified by <code>Role</code>.</important></li>
     ...
     *        the Amazon S3 storage class, omit <code>OutputBucket</code> and
     ...
     *         <li>You do not want to specify the permissions that Elastic
     *         Transcoder grants to the files. <important>When Elastic
     *         Transcoder saves files in <code>OutputBucket</code>, it grants
     *         full control over the files only to the AWS account that owns the
     *         role that is specified by <code>Role</code>.</important></li>
     ...
     *        when Elastic Transcoder has started to process a job in this
     ...
     *        a job in this pipeline. This is the ARN that Amazon SNS returned
     ...
     *         the Amazon Simple Notification Service Developer Guide.</li>
     *         <li><b>Completed</b>: The topic ARN for the Amazon SNS topic that
     *         you want to notify when Elastic Transcoder has finished
     *         processing a job in this pipeline. This is the ARN that Amazon
     *         SNS returned when you created the topic.</li>
     *         <li><b>Warning</b>: The topic ARN for the Amazon SNS topic that
     *         you want to notify when Elastic Transcoder encounters a warning
