...
/**
 * <p>
 * <important>Outputs recommended instead.</important>If you specified one
...
public class JobOutput implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The value of the <code>Id</code> object for the preset that you want to
     ...
     * <code>Outputs:Status</code> for that output and <code>Job:Status</code>
     ...
     * starts to process the output.</li>
     * <li>Job:Status remains Progressing until all of the outputs reach a
     * terminal status, either Complete or Error.</li>
     * <li>When all of the outputs reach a terminal status,
     * <code>Job:Status</code> changes to Complete only if
     ...
     * preset that you specify in <code>Preset</code> for the current output.
     * </p>
     * <p>
     ...
     * used. If no <code>ColorSpaceConversionMode</code> was defined in the
     ...
     * </p>
     * 
     * @return A sequential counter, starting with 1, that identifies an output
     ...
     *        <p>
     *        <code>auto</code>, <code>0</code>, <code>90</code>,
     *        <code>180</code>, <code>270</code>
     *        </p>
     *        <p>
     *        The value <code>auto</code> generally works only if the file that
     ...
     * 
     * @param presetId
     *        The value of the <code>Id</code> object for the preset that you
     ...
     * </p>
     * 
     * @return The value of the <code>Id</code> object for the preset that you
     *         want to use for this job. The preset determines the audio, video,
     *         and thumbnail settings that Elastic Transcoder uses for
     *         transcoding. To use a preset that you created, specify the preset
     *         ID that Elastic Transcoder returned in the response when you
     *         created the preset. You can also use the Elastic Transcoder
     *         system presets, which you can get with <code>ListPresets</code>.
     */
     ...
     *        <li>When Elastic Transcoder starts to process the first output,
     *        <code>Outputs:Status</code> for that output and
     *        <code>Job:Status</code> both change to Progressing. For each
     *        output, the value of <code>Outputs:Status</code> remains Submitted
     *        until Elastic Transcoder starts to process the output.</li>
     *        <li>Job:Status remains Progressing until all of the outputs reach
     *        a terminal status, either Complete or Error.</li>
     *        <li>When all of the outputs reach a terminal status,
     *        <code>Job:Status</code> changes to Complete only if
     *        <code>Outputs:Status</code> for all of the outputs is
     ...
     * </p>
     * 
     * @return The status of one output in a job. If you specified only one
     *         output for the job, <code>Outputs:Status</code> is always the
     ...
     *         <code>Outputs:Status</code> for that output and
     *         <code>Job:Status</code> both change to Progressing. For each
     *         output, the value of <code>Outputs:Status</code> remains
     ...
     *         be defined in the preset that you specify in <code>Preset</code>
     ...
     *        defined in the preset that you specify in <code>Preset</code> for
     ...
     *         chained together.
     */
    public JobOutput withWatermarks(
     ...
     *        If Elastic Transcoder used a preset with a
     *        <code>ColorSpaceConversionMode</code> to transcode the output
     *        file, the <code>AppliedColorSpaceConversion</code> parameter shows
     *        the conversion used. If no <code>ColorSpaceConversionMode</code>
     *        was defined in the preset, this parameter will not be included in
     *        the job response.
     */
    public void setAppliedColorSpaceConversion(
     ...
     *         <code>ColorSpaceConversionMode</code> to transcode the output
     *         file, the <code>AppliedColorSpaceConversion</code> parameter
     *         shows the conversion used. If no
     *         <code>ColorSpaceConversionMode</code> was defined in the preset,
     *         this parameter will not be included in the job response.
     */
     ...
     *         chained together.
     */
    public JobOutput withAppliedColorSpaceConversion(
            String appliedColorSpaceConversion) {
    ...
    public String toString() {
        ...
        if (getAppliedColorSpaceConversion() != null)
            sb.append("AppliedColorSpaceConversion: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEncryption() != null
            ...
            return false;
        if (other.getAppliedColorSpaceConversion() == null
                ^ this.getAppliedColorSpaceConversion() == null)
            return false;
        if (other.getAppliedColorSpaceConversion() != null
                && other.getAppliedColorSpaceConversion().equals(
                        this.getAppliedColorSpaceConversion()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getStatusDetail() == null) ? 0 : getStatusDetail()
                        .hashCode());
        hashCode = prime * hashCode
        ...
        hashCode = prime
                * hashCode
                + ((getAppliedColorSpaceConversion() == null) ? 0
                        : getAppliedColorSpaceConversion().hashCode());
        return hashCode;
    }
