...
public class EncryptionJsonUnmarshaller implements Unmarshaller<Encryption, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Mode", targetDepth)) {
                    context.nextToken();
                    encryption.setMode(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    encryption.setKey(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("KeyMd5", targetDepth)) {
                    context.nextToken();
                    encryption.setKeyMd5(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("InitializationVector", targetDepth)) {
                    context.nextToken();
                    encryption.setInitializationVector(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static EncryptionJsonUnmarshaller getInstance() {
        if (instance == null) instance = new EncryptionJsonUnmarshaller();
        return instance;
    }
}
