 ...
 */
public class CreatePresetResultJsonUnmarshaller implements Unmarshaller<CreatePresetResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Preset", targetDepth)) {
                    context.nextToken();
                    createPresetResult.setPreset(PresetJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Warning", targetDepth)) {
                    context.nextToken();
                    createPresetResult.setWarning(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CreatePresetResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreatePresetResultJsonUnmarshaller();
        return instance;
    }
}
