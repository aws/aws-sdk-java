...
public class AmazonElasticTranscoderAsyncClient extends
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * Elastic Transcoder using the specified parameters.
     *
    ...
    @Override
    public java.util.concurrent.Future<CreatePresetResult> createPresetAsync(
    ...
    public java.util.concurrent.Future<CreatePresetResult> createPresetAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreatePresetResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<DeletePresetResult> deletePresetAsync(
    ...
    public java.util.concurrent.Future<DeletePresetResult> deletePresetAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeletePresetResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ListJobsByPipelineResult> listJobsByPipelineAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListJobsByPipelineResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<ListJobsByStatusResult> listJobsByStatusAsync(
    ...
    public java.util.concurrent.Future<ListJobsByStatusResult> listJobsByStatusAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListJobsByStatusResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ListPresetsResult> listPresetsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListPresetsResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<ReadJobResult> readJobAsync(
    ...
    public java.util.concurrent.Future<ReadJobResult> readJobAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ReadJobResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<ReadPipelineResult> readPipelineAsync(
    ...
    public java.util.concurrent.Future<ReadPipelineResult> readPipelineAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ReadPipelineResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ReadPresetResult> readPresetAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ReadPresetResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<TestRoleResult> testRoleAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<TestRoleResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<UpdatePipelineNotificationsResult> updatePipelineNotificationsAsync(
    ...
    public java.util.concurrent.Future<UpdatePipelineNotificationsResult> updatePipelineNotificationsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UpdatePipelineNotificationsResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<UpdatePipelineStatusResult> updatePipelineStatusAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UpdatePipelineStatusResult>() {
                    @Override
