...
public class UpdatePipelineRequestProtocolMarshaller implements Marshaller<Request<UpdatePipelineRequest>, UpdatePipelineRequest> {
    ...
    public UpdatePipelineRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<UpdatePipelineRequest> marshall(UpdatePipelineRequest updatePipelineRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<UpdatePipelineRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    updatePipelineRequest);

            protocolMarshaller.startMarshalling();
            UpdatePipelineRequestMarshaller.getInstance().marshall(updatePipelineRequest, protocolMarshaller);
