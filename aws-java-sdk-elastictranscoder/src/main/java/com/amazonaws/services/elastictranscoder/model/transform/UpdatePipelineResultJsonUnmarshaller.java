 ...
 */
public class UpdatePipelineResultJsonUnmarshaller implements
        Unmarshaller<UpdatePipelineResult, JsonUnmarshallerContext> {

    public UpdatePipelineResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Pipeline", targetDepth)) {
                    context.nextToken();
                    updatePipelineResult.setPipeline(PipelineJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
                if (context.testExpression("Warnings", targetDepth)) {
                    context.nextToken();
                    updatePipelineResult
                            .setWarnings(new ListUnmarshaller<Warning>(
