...
public class VideoParameters implements Serializable, Cloneable {
     ...
     *        either MaxWidth and MaxHeight, or Resolution. <i>Maximum decoded
     *        picture buffer in macroblocks</i> depends on the value of the
     ...
     *        </p>
     *        <p>
     *        Valid values include <code>Progressive</code> (no interlacing, top
     *        to bottom), <code>TopFirst</code> (top field first),
     *        <code>BottomFirst</code> (bottom field first), and
     *        <code>Auto</code>.
     *        </p>
     *        <p>
     *        If <code>InterlaceMode</code> is not specified, Elastic Transcoder
     *        uses <code>Progressive</code> for the output. If <code>Auto</code>
     ...
     *        <code>Bt.601</code> is the standard for standard definition video,
     *        while <code>Bt.709</code> is the standard for high definition
     *        video.
     *        </p>
     *        <p>
     *        Valid values include <code>None</code>, <code>Bt709toBt601</code>,
     ...
     *        <code>24</code>, <code>25</code>, <code>29.97</code>,
     *        <code>50</code>, or <code>60</code>, your
     *        <code>SegmentDuration</code> is null, and you are using one of the
     ...
     *        video. Valid values include <code>yuv420p</code> and
     *        <code>yuv422p</code>.
     *        </p>
     *        <p>
     *        <code>yuv420p</code> samples the chroma information of every other
     *        horizontal and every other vertical line, <code>yuv422p</code>
    ...
    public void setCodecOptions(java.util.Map<String, String> codecOptions) {
        this.codecOptions = codecOptions == null ? null
     ...
     *         chained together.
     */
    public VideoParameters withCodecOptions(
            java.util.Map<String, String> codecOptions) {
    ...
    /**
     * Removes all the entries added into CodecOptions. &lt;p> Returns a
     ...
     *        Applicable only when the value of Video:Codec is one of
     *        <code>H.264</code>, <code>MPEG2</code>, or <code>VP8</code>.</p>
     *        <p>
     ...
     *        </p>
     *        <p>
     *        For <code>Smooth</code> outputs, the <code>FrameRate</code> must
     *        have a constant ratio to the <code>KeyframesMaxDist</code>. This
     *        allows <code>Smooth</code> playlists to switch between different
     *        quality levels while the file is being played.
     *        </p>
     *        <p>
     *        For example, an input file can have a <code>FrameRate</code> of 30
     *        with a <code>KeyframesMaxDist</code> of 90. The output file then
     *        needs to have a ratio of 1:3. Valid outputs would have
     *        <code>FrameRate</code> of 30, 25, and 10, and
     *        <code>KeyframesMaxDist</code> of 90, 75, and 30, respectively.
     *        </p>
     *        <p>
     ...
     *         </p>
     *         <p>
     *         For example, an input file can have a <code>FrameRate</code> of
     *         30 with a <code>KeyframesMaxDist</code> of 90. The output file
     ...
     *        <code>H.264</code>, <code>MPEG2</code>, or <code>VP8</code>.</p>
     *        <p>
     *        Whether to use a fixed value for <code>FixedGOP</code>. Valid
     ...
     *        <code>auto</code>, Elastic Transcoder uses the detected bit rate
     *        of the input source. If you specify a value other than
     *        <code>auto</code>, we recommend that you specify a value less than
     ...
     *         <code>auto</code>, Elastic Transcoder uses the detected bit rate
     *         of the input source. If you specify a value other than
     *         <code>auto</code>, we recommend that you specify a value less
     *         than or equal to the maximum H.264-compliant value listed for
     *         your level and profile:</p>
     *         <p>
     *         <i>Level - Maximum video bit rate in kilobits/second (baseline
     ...
     *        <p>
     *        <code>auto</code>, <code>10</code>, <code>15</code>,
     *        <code>23.97</code>, <code>24</code>, <code>25</code>,
     *        <code>29.97</code>, <code>30</code>, <code>60</code>
     *        </p>
     *        <p>
     *        If you specify <code>auto</code>, Elastic Transcoder uses the
     ...
     *        </p>
     *        <ul>
     *        <li><i>width in pixels</i> and <i>height in pixels</i> represent
     *        the Resolution of the output video.</li>
     *        <li><i>maximum recommended decoding speed in Luma
     *        samples/second</i> is less than or equal to the maximum value
     *        listed in the following table, based on the value that you
     *        specified for Level.</li>
     *        </ul>
     *        <p>
     *        The maximum recommended decoding speed in Luma samples/second for
     *        each level is described in the following list (<i>Level - Decoding
     *        speed</i>):
     *        </p>
     *        <ul>
     *        <li>1 - 380160</li>
     ...
     * </ul>
     * 
     * @return The frames per second for the video stream in the output file.
     *         Valid values include:</p>
     *         <p>
     *         <code>auto</code>, <code>10</code>, <code>15</code>,
     *         <code>23.97</code>, <code>24</code>, <code>25</code>,
     ...
     *         <p>
     *         The maximum recommended decoding speed in Luma samples/second for
     *         each level is described in the following list (<i>Level -
     *         Decoding speed</i>):
     *         </p>
     *         <ul>
     *         <li>1 - 380160</li>
     ...
     * 
     * @param maxFrameRate
     *        If you specify <code>auto</code> for <code>FrameRate</code>,
     ...
     *        output video. Valid values include: <code>10</code>,
     *        <code>15</code>, <code>23.97</code>, <code>24</code>,
     *        <code>25</code>, <code>29.97</code>, <code>30</code>,
     *        <code>60</code>.
     */
     ...
     * </p>
     * 
     * @return If you specify <code>auto</code> for <code>FrameRate</code>,
     *         Elastic Transcoder uses the frame rate of the input video for the
     *         frame rate of the output video. Specify the maximum frame rate
     ...
     *         the output video. Valid values include: <code>10</code>,
     *         <code>15</code>, <code>23.97</code>, <code>24</code>,
     *         <code>25</code>, <code>29.97</code>, <code>30</code>,
     *         <code>60</code>.
     */
     ...
     *        instead of <code>Resolution</code> and <code>AspectRatio</code>.
     ...
     *        Valid values are <code>auto</code> and <i>width</i> x
     *        <i>height</i>:
     *        </p>
     *        <ul>
     ...
     *        </p>
     *        <ul>
     *        <li>The width must be an even integer between 128 and 4096,
     *        inclusive.</li>
     *        <li>The height must be an even integer between 96 and 3072,
     *        inclusive.</li>
     *        <li>If you specify a resolution that is less than the resolution
     *        of the input file, Elastic Transcoder rescales the output file to
     *        the lower resolution.</li>
     *        <li>If you specify a resolution that is greater than the
     *        resolution of the input file, Elastic Transcoder rescales the
     *        output to the higher resolution.</li>
     *        <li>We recommend that you specify a resolution for which the
     *        product of width and height is less than or equal to the
     *        applicable value in the following list (<i>List - Max width x
     *        height value</i>):</li>
     *        <ul>
     *        <li>1 - 25344</li>
     *        <li>1b - 25344</li>
     ...
     *        </p>
     *        <p>
     *        <code>auto</code>, <code>1:1</code>, <code>4:3</code>,
     *        <code>3:2</code>, <code>16:9</code>
     *        </p>
     *        <p>
     ...
     *        pillarboxing (black bars on the sides) or letterboxing (black bars
     *        on the top and bottom) to maintain the aspect ratio of the active
     *        region of the video.
     */
     ...
     * </p>
     * 
     * @return The value that Elastic Transcoder adds to the metadata in the
     *         output file.
     */
     ...
     * </p>
     * 
     * @return Specify one of the following values to control scaling of the
     *         output video:</p>
     *         <p>
     *         <ul>
     *         <li><code>Fit</code>: Elastic Transcoder scales the output video
     ...
     * 
     * @param paddingPolicy
     *        When you set <code>PaddingPolicy</code> to <code>Pad</code>,
     ...
     * </p>
     * 
     * @return When you set <code>PaddingPolicy</code> to <code>Pad</code>,
     ...
     * </p>
     * 
     * @return Settings for the size, location, and opacity of graphics that you
     ...
     *         transcoded video.</p>
     *         <p>
     *         Watermarks can be in .png or .jpg format. If you want to display
     *         a watermark that is not rectangular, use the .png format, which
     *         supports transparency.
     *         </p>
     *         <p>
     *         When you create a job that uses this preset, you specify the .png
     *         or .jpg graphics that you want Elastic Transcoder to include in
     *         the transcoded videos. You can specify fewer graphics in the job
     *         than you specify watermark settings in the preset, which allows
     *         you to use the same preset for up to four watermarks that have
    ...
    public void setWatermarks(java.util.Collection<PresetWatermark> watermarks) {
        ...
        this.watermarks = new com.amazonaws.internal.SdkInternalList<PresetWatermark>(
                watermarks);
    }
    ...
    public VideoParameters withWatermarks(PresetWatermark... watermarks) {
        if (this.watermarks == null) {
            setWatermarks(new com.amazonaws.internal.SdkInternalList<PresetWatermark>(
                    watermarks.length));
        }
     ...
     *         chained together.
     */
    public VideoParameters withWatermarks(
            java.util.Collection<PresetWatermark> watermarks) {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCodecOptions() != null
            ...
            return false;
        if (other.getKeyframesMaxDist() == null
                ^ this.getKeyframesMaxDist() == null)
            return false;
        if (other.getKeyframesMaxDist() != null
                && other.getKeyframesMaxDist().equals(
                        this.getKeyframesMaxDist()) == false)
            return false;
        if (other.getFixedGOP() == null ^ this.getFixedGOP() == null)
            return false;
        if (other.getFixedGOP() != null
                && other.getFixedGOP().equals(this.getFixedGOP()) == false)
            return false;
        ...
        if (other.getMaxFrameRate() == null ^ this.getMaxFrameRate() == null)
            return false;
        if (other.getMaxFrameRate() != null
                && other.getMaxFrameRate().equals(this.getMaxFrameRate()) == false)
            return false;
        ...
        if (other.getMaxWidth() == null ^ this.getMaxWidth() == null)
            return false;
        if (other.getMaxWidth() != null
                && other.getMaxWidth().equals(this.getMaxWidth()) == false)
            return false;
        if (other.getMaxHeight() == null ^ this.getMaxHeight() == null)
            return false;
        if (other.getMaxHeight() != null
                && other.getMaxHeight().equals(this.getMaxHeight()) == false)
            return false;
        if (other.getDisplayAspectRatio() == null
                ^ this.getDisplayAspectRatio() == null)
            return false;
        if (other.getDisplayAspectRatio() != null
                && other.getDisplayAspectRatio().equals(
                        this.getDisplayAspectRatio()) == false)
            return false;
        if (other.getSizingPolicy() == null ^ this.getSizingPolicy() == null)
            return false;
        if (other.getSizingPolicy() != null
                && other.getSizingPolicy().equals(this.getSizingPolicy()) == false)
            return false;
        if (other.getPaddingPolicy() == null ^ this.getPaddingPolicy() == null)
            return false;
        if (other.getPaddingPolicy() != null
                && other.getPaddingPolicy().equals(this.getPaddingPolicy()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getKeyframesMaxDist() == null) ? 0 : getKeyframesMaxDist()
                        .hashCode());
        hashCode = prime * hashCode
                + ((getFixedGOP() == null) ? 0 : getFixedGOP().hashCode());
        hashCode = prime * hashCode
        ...
        hashCode = prime * hashCode
                + ((getMaxWidth() == null) ? 0 : getMaxWidth().hashCode());
        hashCode = prime * hashCode
                + ((getMaxHeight() == null) ? 0 : getMaxHeight().hashCode());
        hashCode = prime
                * hashCode
                + ((getDisplayAspectRatio() == null) ? 0
                        : getDisplayAspectRatio().hashCode());
        hashCode = prime
                * hashCode
                + ((getSizingPolicy() == null) ? 0 : getSizingPolicy()
                        .hashCode());
        hashCode = prime
                * hashCode
                + ((getPaddingPolicy() == null) ? 0 : getPaddingPolicy()
                        .hashCode());
        hashCode = prime * hashCode
