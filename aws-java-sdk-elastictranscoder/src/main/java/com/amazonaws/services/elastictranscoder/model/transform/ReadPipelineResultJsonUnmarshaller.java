 ...
 */
public class ReadPipelineResultJsonUnmarshaller implements
        Unmarshaller<ReadPipelineResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Pipeline", targetDepth)) {
                    context.nextToken();
                    readPipelineResult.setPipeline(PipelineJsonUnmarshaller
