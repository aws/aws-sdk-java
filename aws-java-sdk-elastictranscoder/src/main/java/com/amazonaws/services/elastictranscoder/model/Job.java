...
public class Job implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * <important>Outputs recommended instead.</important> A section of the
     * request or response body that provides information about the transcoded
     * (target) file.
     * </p>
     */
     ...
     * <code>Outputs</code> and <code>Output</code> syntaxes in the same
     ...
     * which the value of <code>Container</code> is fmp4 (Fragmented MP4) or ts
     * (MPEG-TS), <code>Playlists</code> contains information about the master
     ...
     * </p>
     * <p>
     * Metadata <code>keys</code> and <code>values</code> must use characters
     ...
     *        object.</p>
     *        <p>
     *        <important>Outputs recommended instead.</important> A section of
     ...
     * </p>
     * 
     * @return If you specified one output for a job, information about that
     *         output. If you specified multiple outputs for a job, the Output
     *         object lists information about the first output. This duplicates
     ...
     *         <code>Outputs</code> syntax for all jobs, even when you want
     *         Elastic Transcoder to transcode a file into only one format. Do
     *         not use both the <code>Outputs</code> and <code>Output</code>
    ...
    public void setOutputs(java.util.Collection<JobOutput> outputs) {
        ...
        this.outputs = new com.amazonaws.internal.SdkInternalList<JobOutput>(
                outputs);
    }
     ...
     *         of <code>Container</code> is fmp4 (Fragmented MP4) or ts
    ...
    public void setPlaylists(java.util.Collection<Playlist> playlists) {
        ...
        this.playlists = new com.amazonaws.internal.SdkInternalList<Playlist>(
                playlists);
    }
     ...
     *         <p>
     *         Metadata <code>keys</code> and <code>values</code> must use
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTiming() != null
                && other.getTiming().equals(this.getTiming()) == false)
            return false;
        return true;
    }
        ...
        hashCode = prime
                * hashCode
                + ((getUserMetadata() == null) ? 0 : getUserMetadata()
                        .hashCode());
        hashCode = prime * hashCode
                + ((getTiming() == null) ? 0 : getTiming().hashCode());
        return hashCode;
    }
