...
public class Pipeline implements Serializable, Cloneable {
     ...
     * <li><b>Error</b> (optional): The Amazon SNS topic that you want to notify
     ...
     * both <code>ContentConfig</code> and <code>ThumbnailConfig</code>, or you
     ...
     * <li><b>Permissions</b>: A list of the users and/or predefined Amazon S3
     * groups you want to have access to transcoded files and playlists, and the
     * type of access that you want them to have.
     * <ul>
     * <li>GranteeType: The type of value that appears in the
     ...
     * </ul>
     * </li>
     * <li><code>Grantee</code>: The AWS user or group that you want to have
     * access to transcoded files and playlists.</li>
     * <li><code>Access</code>: The permission that you want to give to the AWS
     * user that is listed in <code>Grantee</code>. Valid values include:
     * <ul>
     ...
     * </ul>
     * </li>
     * <li><b>StorageClass</b>: The Amazon S3 storage class, Standard or
     * ReducedRedundancy, that you want Elastic Transcoder to assign to the
     * video files and playlists that it stores in your Amazon S3 bucket.</li>
     * </ul>
     */
     ...
     * <li><code>Permissions</code>: A list of the users and/or predefined
     ...
     * </li>
     * <li><code>Grantee</code>: The AWS user or group that you want to have
     * access to thumbnail files.</li>
     * <li>Access: The permission that you want to give to the AWS user that is
     ...
     * </p>
     * 
     * @return The identifier for the pipeline. You use this value to identify
     ...
     * </p>
     * 
     * @return The Amazon S3 bucket from which Elastic Transcoder gets media
     *         files for transcoding and the graphics files, if any, that you
     *         want to use for watermarks.
     */
     ...
     *        want to notify to report job status.</p> <important>To receive
     *        notifications, you must also subscribe to the new topic in the
     *        Amazon SNS console.</important>
     *        <ul>
     *        <li><b>Progressing</b> (optional): The Amazon Simple Notification
     *        Service (Amazon SNS) topic that you want to notify when Elastic
     *        Transcoder has started to process the job.</li>
     *        <li><b>Completed</b> (optional): The Amazon SNS topic that you
     *        want to notify when Elastic Transcoder has finished processing the
     *        job.</li>
     *        <li><b>Warning</b> (optional): The Amazon SNS topic that you want
     *        to notify when Elastic Transcoder encounters a warning condition.</li>
     ...
     *         you want to notify to report job status.</p> <important>To
     ...
     *        specify both <code>ContentConfig</code> and
     *        <code>ThumbnailConfig</code>, or you specify
     *        <code>OutputBucket</code>.</p>
     *        <ul>
     *        <li><b>Bucket</b>: The Amazon S3 bucket in which you want Elastic
     *        Transcoder to save transcoded files and playlists.</li>
     *        <li><b>Permissions</b>: A list of the users and/or predefined
     ...
     *        </ul>
     *        </li>
     *        <li><code>Grantee</code>: The AWS user or group that you want to
     *        have access to transcoded files and playlists.</li>
     *        <li><code>Access</code>: The permission that you want to give to
     *        the AWS user that is listed in <code>Grantee</code>. Valid values
     *        include:
     *        <ul>
     ...
     *        Information about the Amazon S3 bucket in which you want Elastic
     *        Transcoder to save thumbnail files. Either you specify both
     *        <code>ContentConfig</code> and <code>ThumbnailConfig</code>, or
     *        you specify <code>OutputBucket</code>.</p>
     *        <ul>
     *        <li><code>Bucket</code>: The Amazon S3 bucket in which you want
     *        Elastic Transcoder to save thumbnail files.</li>
     *        <li><code>Permissions</code>: A list of the users and/or
     *        predefined Amazon S3 groups you want to have access to thumbnail
     *        files, and the type of access that you want them to have.
     *        <ul>
     *        <li>GranteeType: The type of value that appears in the Grantee
     *        object:
     *        <ul>
     *        <li><code>Canonical</code>: Either the canonical user ID for an
     *        AWS account or an origin access identity for an Amazon CloudFront
     ...
     *        </li>
     *        <li><code>Grantee</code>: The AWS user or group that you want to
     *        have access to thumbnail files.</li>
     *        <li>Access: The permission that you want to give to the AWS user
