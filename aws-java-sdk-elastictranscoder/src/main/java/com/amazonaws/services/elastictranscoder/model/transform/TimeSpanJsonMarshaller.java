...
public class TimeSpanJsonMarshaller {
    ...
    public void marshall(TimeSpan timeSpan, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (timeSpan.getStartTime() != null) {
                jsonGenerator.writeFieldName("StartTime").writeValue(timeSpan.getStartTime());
            }
            if (timeSpan.getDuration() != null) {
                jsonGenerator.writeFieldName("Duration").writeValue(timeSpan.getDuration());
            }
    ...
    public static TimeSpanJsonMarshaller getInstance() {
        if (instance == null)
            instance = new TimeSpanJsonMarshaller();
        return instance;
    }
