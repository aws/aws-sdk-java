 ...
 */
public class JobAlbumArtJsonUnmarshaller implements
        Unmarshaller<JobAlbumArt, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Artwork", targetDepth)) {
                    context.nextToken();
                    jobAlbumArt.setArtwork(new ListUnmarshaller<Artwork>(
                            ArtworkJsonUnmarshaller.getInstance())
                            .unmarshall(context));
                }
