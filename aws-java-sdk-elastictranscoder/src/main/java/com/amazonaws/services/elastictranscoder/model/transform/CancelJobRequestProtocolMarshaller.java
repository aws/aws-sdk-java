...
public class CancelJobRequestProtocolMarshaller implements Marshaller<Request<CancelJobRequest>, CancelJobRequest> {
    ...
    public CancelJobRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<CancelJobRequest> marshall(CancelJobRequest cancelJobRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<CancelJobRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    cancelJobRequest);

            protocolMarshaller.startMarshalling();
            CancelJobRequestMarshaller.getInstance().marshall(cancelJobRequest, protocolMarshaller);
