...
public class CreateJobOutput implements Serializable, Cloneable {
     ...
     * file in the Amazon S3 bucket specified by the <code>OutputBucket</code>
     ...
     * you must include <code>{count}</code> in the
     ...
     * <code>{resolution}</code> but you omit <code>{count}</code>, Elastic
     * Transcoder returns a validation error and does not create the
     * job.</important></li>
     * <li>
     * <p>
     * <b>Literal values (Optional)</b>: You can specify literal values anywhere
     * in the <code>ThumbnailPattern</code> object. For example, you can include
     ...
     * specified in the <code>PresetID</code> value of
     ...
     * <code>180</code>, <code>270</code>. The value <code>auto</code> generally
     ...
     * segment in seconds. For <code>HLSv3</code> format playlists, each media
     * segment is stored in a separate <code>.ts</code> file. For
     * <code>HLSv4</code> and <code>Smooth</code> playlists, all media segments
     * for an output are stored in a single file. Each segment is approximately
     * the length of the <code>SegmentDuration</code>, though individual
     * segments might be shorter or longer.
     * </p>
     * <p>
     * The range of valid values is 1 to 60 seconds. If the duration of the
     * video is not evenly divisible by <code>SegmentDuration</code>, the
     ...
     * <code>HLS</code> output that you specify in OutputKeys. To add an output
     ...
     * </p>
     * <p>
     * Valid input values include: <code>CEA-608 (EIA-608</code>, first
     * non-empty channel only), <code>CEA-708 (EIA-708</code>, first non-empty
     * channel only), and <code>mov-text</code>
     * </p>
     * <p>
     ...
     * from the audio and video data. Sidecar captions require a player that is
     * capable of understanding the relationship between the video file and the
     * sidecar file. Elastic Transcoder supports only one sidecar caption per
     * language, to a maximum of 20 sidecar captions per file.
     * </p>
     * <p>
     * Valid input values include: <code>dfxp</code> (first div element only),
     * <code>ebu-tt</code>, <code>scc</code>, <code>smpt</code>,
     ...
     * </p>
     * <p>
     * To remove captions or leave the captions empty, set <code>Captions</code>
     ...
     *        <code>OutputBucket</code> object in the pipeline that is specified
     ...
     * </p>
     * 
     * @return The name to assign to the transcoded file. Elastic Transcoder
     *         saves the file in the Amazon S3 bucket specified by the
     *         <code>OutputBucket</code> object in the pipeline that is
     ...
     *        the information that you want to include in the file name for each
     ...
     *        thumbnails, you must include <code>{count}</code> in the
     *        <code>ThumbnailPattern</code> object. Wherever you specify
     *        <code>{count}</code>, Elastic Transcoder adds a five-digit
     *        sequence number (beginning with <b>00001</b>) to thumbnail file
     *        names. The number indicates where a given thumbnail appears in the
     *        sequence of thumbnails for a transcoded file.
     *        </p>
     *        <important>If you specify a literal value and/or
     *        <code>{resolution}</code> but you omit <code>{count}</code>,
     *        Elastic Transcoder returns a validation error and does not create
     *        the job.</important></li>
     *        <li>
     *        <p>
     ...
     *        between <code>{resolution}</code> and <code>{count}</code>.
     *        </p>
     *        </li>
     *        <li>
     *        <p>
     ...
     *        that you specified in the <code>PresetID</code> value of
     *        <code>CreateJobOutput</code>. Elastic Transcoder also appends the
     *        applicable file name extension.
     */
     ...
     *         <p>
     *         <b>Literal values (Optional)</b>: You can specify literal values
     *         anywhere in the <code>ThumbnailPattern</code> object. For
     *         example, you can include them as a file name prefix or as a
     *         delimiter between <code>{resolution}</code> and
     *         <code>{count}</code>.
     *         </p>
     *         </li>
     *         <li>
     ...
     *        of the following values: <code>auto</code>, <code>0</code>,
     *        <code>90</code>, <code>180</code>, <code>270</code>. The value
     ...
     * </p>
     * 
     * @return The number of degrees clockwise by which you want Elastic
     *         Transcoder to rotate the output relative to the input. Enter one
     *         of the following values: <code>auto</code>, <code>0</code>,
     *         <code>90</code>, <code>180</code>, <code>270</code>. The value
     *         <code>auto</code> generally works only if the file that you're
     ...
     *        (Outputs in Fragmented MP4 or MPEG-TS format only.</important>If
     *        you specify a preset in <code>PresetId</code> for which the value
     *        of <code>Container</code> is <code>fmp4</code> (Fragmented MP4) or
     *        <code>ts</code> (MPEG-TS), <code>SegmentDuration</code> is the
     *        target maximum duration of each segment in seconds. For
     *        <code>HLSv3</code> format playlists, each media segment is stored
     *        in a separate <code>.ts</code> file. For <code>HLSv4</code> and
     *        <code>Smooth</code> playlists, all media segments for an output
     *        are stored in a single file. Each segment is approximately the
     *        length of the <code>SegmentDuration</code>, though individual
     *        segments might be shorter or longer.</p>
     *        <p>
     *        The range of valid values is 1 to 60 seconds. If the duration of
     *        the video is not evenly divisible by <code>SegmentDuration</code>,
     ...
     *        output <code>HLS</code> output that you specify in OutputKeys. To
     ...
     * </p>
     * 
     * @return (Outputs in Fragmented MP4 or MPEG-TS format only.</important>If
     *         you specify a preset in <code>PresetId</code> for which the value
     *         of <code>Container</code> is <code>fmp4</code> (Fragmented MP4)
     *         or <code>ts</code> (MPEG-TS), <code>SegmentDuration</code> is the
     *         target maximum duration of each segment in seconds. For
     *         <code>HLSv3</code> format playlists, each media segment is stored
     *         in a separate <code>.ts</code> file. For <code>HLSv4</code> and
     *         <code>Smooth</code> playlists, all media segments for an output
    ...
    public void setWatermarks(java.util.Collection<JobWatermark> watermarks) {
        ...
        this.watermarks = new com.amazonaws.internal.SdkInternalList<JobWatermark>(
                watermarks);
    }
     ...
     * any). Use {@link #setWatermarks(java.util.Collection)} or
     * {@link #withWatermarks(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param watermarks
     ...
     * </p>
     * 
     * @return Information about the album art that you want Elastic Transcoder
     *         to add to the file during transcoding. You can specify up to
     *         twenty album artworks for each output. Settings for each artwork
     *         must be defined in the job for the current output.
     */
     ...
     * </p>
     * 
     * @return You can create an output file that contains an excerpt from the
    ...
    public void setComposition(java.util.Collection<Clip> composition) {
        ...
        this.composition = new com.amazonaws.internal.SdkInternalList<Clip>(
                composition);
    }
     ...
     * <p>
     * <b>NOTE:</b> This method appends the values to the existing list (if
     * any). Use {@link #setComposition(java.util.Collection)} or
     * {@link #withComposition(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param composition
     ...
     *        UTF-8. Elastic Transcoder supports two types of captions:</p>
     *        <ul>
     *        <li>
     *        <p>
     *        <b>Embedded:</b> Embedded captions are included in the same file
     *        as the audio and video. Elastic Transcoder supports only one
     *        embedded caption per language, to a maximum of 300 embedded
     *        captions per file.
     *        </p>
     *        <p>
     *        Valid input values include: <code>CEA-608 (EIA-608</code>, first
     *        non-empty channel only), <code>CEA-708 (EIA-708</code>, first
     *        non-empty channel only), and <code>mov-text</code>
     *        </p>
     *        <p>
     *        Valid outputs include: <code>mov-text</code>
     *        </p>
     ...
     *        <li>
     *        <p>
     *        <b>Sidecar:</b> Sidecar captions are kept in a separate metadata
     ...
     *        </p>
     *        <p>
     *        Valid input values include: <code>dfxp</code> (first div element
     ...
     *        Transcoder does not preserve text formatting (for example,
     *        italics) during the transcoding process.
     *        </p>
     *        <p>
     *        To remove captions or leave the captions empty, set
     *        <code>Captions</code> to null. To pass through existing captions
     *        unchanged, set the <code>MergePolicy</code> to
     *        <code>MergeRetain</code>, and pass in a null
     *        <code>CaptionSources</code> array.
     *        </p>
     *        <p>
     *        For more information on embedded files, see the Subtitles
     *        Wikipedia page.
     *        </p>
     *        <p>
     *        For more information on sidecar files, see the Extensible Metadata
     ...
     *         </p>
     *         <p>
     *         Valid outputs include: <code>dfxp</code> (first div element
     *         only), <code>scc</code>, <code>srt</code>, and
     *         <code>webvtt</code>.
     *         </p>
     *         </li>
     *         </ul>
     ...
     *         Elastic Transcoder does not support OCR (Optical Character
     *         Recognition), does not accept pictures as a valid input for
     *         captions, and is not available for audio-only transcoding.
     *         Elastic Transcoder does not preserve text formatting (for
     ...
     * </p>
     * 
     * @return You can specify encryption settings for any output files that you
     *         want to use for a transcoding job. This includes the output file
     *         and any watermarks, thumbnails, album art, or captions that you
     *         want to use. You must specify encryption settings for each file
     *         individually.
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getKey() != null
            ...
            return false;
        if (other.getThumbnailPattern() == null
                ^ this.getThumbnailPattern() == null)
            return false;
        if (other.getThumbnailPattern() != null
                && other.getThumbnailPattern().equals(
                        this.getThumbnailPattern()) == false)
            return false;
        if (other.getThumbnailEncryption() == null
                ^ this.getThumbnailEncryption() == null)
            return false;
        if (other.getThumbnailEncryption() != null
                && other.getThumbnailEncryption().equals(
                        this.getThumbnailEncryption()) == false)
            return false;
        if (other.getRotate() == null ^ this.getRotate() == null)
            return false;
        if (other.getRotate() != null
                && other.getRotate().equals(this.getRotate()) == false)
            return false;
        if (other.getPresetId() == null ^ this.getPresetId() == null)
            return false;
        if (other.getPresetId() != null
                && other.getPresetId().equals(this.getPresetId()) == false)
            return false;
        if (other.getSegmentDuration() == null
                ^ this.getSegmentDuration() == null)
            return false;
        if (other.getSegmentDuration() != null
                && other.getSegmentDuration().equals(this.getSegmentDuration()) == false)
            return false;
        if (other.getWatermarks() == null ^ this.getWatermarks() == null)
            return false;
        if (other.getWatermarks() != null
                && other.getWatermarks().equals(this.getWatermarks()) == false)
            return false;
        if (other.getAlbumArt() == null ^ this.getAlbumArt() == null)
            return false;
        if (other.getAlbumArt() != null
                && other.getAlbumArt().equals(this.getAlbumArt()) == false)
            return false;
        if (other.getComposition() == null ^ this.getComposition() == null)
            return false;
        if (other.getComposition() != null
                && other.getComposition().equals(this.getComposition()) == false)
            return false;
        if (other.getCaptions() == null ^ this.getCaptions() == null)
            return false;
        if (other.getCaptions() != null
                && other.getCaptions().equals(this.getCaptions()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getThumbnailPattern() == null) ? 0 : getThumbnailPattern()
                        .hashCode());
        hashCode = prime
                * hashCode
                + ((getThumbnailEncryption() == null) ? 0
                        : getThumbnailEncryption().hashCode());
        hashCode = prime * hashCode
                + ((getRotate() == null) ? 0 : getRotate().hashCode());
        hashCode = prime * hashCode
                + ((getPresetId() == null) ? 0 : getPresetId().hashCode());
        hashCode = prime
                * hashCode
                + ((getSegmentDuration() == null) ? 0 : getSegmentDuration()
                        .hashCode());
        hashCode = prime * hashCode
                + ((getWatermarks() == null) ? 0 : getWatermarks().hashCode());
        hashCode = prime * hashCode
                + ((getAlbumArt() == null) ? 0 : getAlbumArt().hashCode());
        hashCode = prime
                * hashCode
                + ((getComposition() == null) ? 0 : getComposition().hashCode());
        hashCode = prime * hashCode
                + ((getCaptions() == null) ? 0 : getCaptions().hashCode());
        hashCode = prime * hashCode
