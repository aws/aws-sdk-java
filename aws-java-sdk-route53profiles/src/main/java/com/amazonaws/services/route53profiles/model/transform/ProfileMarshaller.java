...
public class ProfileMarshaller {
    ...
    public void marshall(Profile profile, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(profile.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(profile.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(profile.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(profile.getId(), ID_BINDING);
            protocolMarshaller.marshall(profile.getModificationTime(), MODIFICATIONTIME_BINDING);
            protocolMarshaller.marshall(profile.getName(), NAME_BINDING);
            protocolMarshaller.marshall(profile.getOwnerId(), OWNERID_BINDING);
            protocolMarshaller.marshall(profile.getShareStatus(), SHARESTATUS_BINDING);
            protocolMarshaller.marshall(profile.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(profile.getStatusMessage(), STATUSMESSAGE_BINDING);
        } catch (Exception e) {
