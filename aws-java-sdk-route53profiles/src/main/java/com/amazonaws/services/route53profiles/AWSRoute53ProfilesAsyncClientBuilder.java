...
/**
 * Fluent builder for {@link com.amazonaws.services.route53profiles.AWSRoute53ProfilesAsync}. Use of the builder is
...
public final class AWSRoute53ProfilesAsyncClientBuilder extends AwsAsyncClientBuilder<AWSRoute53ProfilesAsyncClientBuilder, AWSRoute53ProfilesAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSRoute53ProfilesAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSRoute53ProfilesAsync.
     */
    @Override
    protected AWSRoute53ProfilesAsync build(AwsAsyncClientParams params) {
        return new AWSRoute53ProfilesAsyncClient(params);
    }
