...
public class InvalidNextTokenExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidNextTokenExceptionUnmarshaller() {
        super(com.amazonaws.services.route53profiles.model.InvalidNextTokenException.class, "InvalidNextTokenException");
    }

    @Override
    public com.amazonaws.services.route53profiles.model.InvalidNextTokenException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.route53profiles.model.InvalidNextTokenException invalidNextTokenException = new com.amazonaws.services.route53profiles.model.InvalidNextTokenException(
                null);
