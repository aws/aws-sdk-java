...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.bedrockagentruntime.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.bedrockagentruntime.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bedrockagentruntime.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.bedrockagentruntime.model.ResourceNotFoundException(
                null);
