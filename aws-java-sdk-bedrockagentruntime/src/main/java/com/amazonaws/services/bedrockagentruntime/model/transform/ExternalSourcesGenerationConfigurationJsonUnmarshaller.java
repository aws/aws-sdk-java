...
/**
 * ExternalSourcesGenerationConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExternalSourcesGenerationConfigurationJsonUnmarshaller implements Unmarshaller<ExternalSourcesGenerationConfiguration, JsonUnmarshallerContext> {

    public ExternalSourcesGenerationConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ExternalSourcesGenerationConfiguration externalSourcesGenerationConfiguration = new ExternalSourcesGenerationConfiguration();
    ...
    private static ExternalSourcesGenerationConfigurationJsonUnmarshaller instance;

    public static ExternalSourcesGenerationConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExternalSourcesGenerationConfigurationJsonUnmarshaller();
        return instance;
    }
}
