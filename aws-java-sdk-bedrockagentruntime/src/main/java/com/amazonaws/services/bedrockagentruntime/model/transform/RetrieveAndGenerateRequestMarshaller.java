...
public class RetrieveAndGenerateRequestMarshaller {
    ...
    public static RetrieveAndGenerateRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RetrieveAndGenerateRequest retrieveAndGenerateRequest, ProtocolMarshaller protocolMarshaller) {

        if (retrieveAndGenerateRequest == null) {
