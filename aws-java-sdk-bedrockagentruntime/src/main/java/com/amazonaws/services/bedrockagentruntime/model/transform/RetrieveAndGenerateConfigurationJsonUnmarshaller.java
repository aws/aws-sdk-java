...
/**
 * RetrieveAndGenerateConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RetrieveAndGenerateConfigurationJsonUnmarshaller implements Unmarshaller<RetrieveAndGenerateConfiguration, JsonUnmarshallerContext> {

    public RetrieveAndGenerateConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static RetrieveAndGenerateConfigurationJsonUnmarshaller instance;

    public static RetrieveAndGenerateConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RetrieveAndGenerateConfigurationJsonUnmarshaller();
        return instance;
    }
}
