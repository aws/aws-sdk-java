...
public class GuardrailConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> GUARDRAILID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("guardrailId").build();
    ...
    public void marshall(GuardrailConfiguration guardrailConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(guardrailConfiguration.getGuardrailId(), GUARDRAILID_BINDING);
