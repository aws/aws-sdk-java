...
/**
 * RetrievedReferenceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RetrievedReferenceMarshaller {
    ...
    private static final RetrievedReferenceMarshaller instance = new RetrievedReferenceMarshaller();

    public static RetrievedReferenceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RetrievedReference retrievedReference, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(retrievedReference.getContent(), CONTENT_BINDING);
            protocolMarshaller.marshall(retrievedReference.getLocation(), LOCATION_BINDING);
        } catch (Exception e) {
