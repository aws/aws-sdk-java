...
/**
 * GenerationConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GenerationConfigurationJsonUnmarshaller implements Unmarshaller<GenerationConfiguration, JsonUnmarshallerContext> {

    public GenerationConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static GenerationConfigurationJsonUnmarshaller instance;

    public static GenerationConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GenerationConfigurationJsonUnmarshaller();
        return instance;
    }
}
