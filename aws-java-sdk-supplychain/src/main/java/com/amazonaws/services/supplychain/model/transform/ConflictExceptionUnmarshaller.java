...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.supplychain.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.supplychain.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.supplychain.model.ConflictException conflictException = new com.amazonaws.services.supplychain.model.ConflictException(null);
