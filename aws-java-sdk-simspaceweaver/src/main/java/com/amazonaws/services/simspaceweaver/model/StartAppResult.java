...
public class StartAppResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartAppResult == false)
            return false;
        StartAppResult other = (StartAppResult) obj;
    ...
    public StartAppResult clone() {
        try {
            return (StartAppResult) super.clone();
