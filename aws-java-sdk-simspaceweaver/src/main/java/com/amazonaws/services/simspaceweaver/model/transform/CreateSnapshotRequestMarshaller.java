...
public class CreateSnapshotRequestMarshaller {
    ...
    public void marshall(CreateSnapshotRequest createSnapshotRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createSnapshotRequest.getDestination(), DESTINATION_BINDING);
            protocolMarshaller.marshall(createSnapshotRequest.getSimulation(), SIMULATION_BINDING);
        } catch (Exception e) {
