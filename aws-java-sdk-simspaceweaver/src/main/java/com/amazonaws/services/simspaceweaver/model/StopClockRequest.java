...
public class StopClockRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StopClockRequest withSimulation(String simulation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopClockRequest == false)
            return false;
        StopClockRequest other = (StopClockRequest) obj;
    ...
    @Override
    public StopClockRequest clone() {
        return (StopClockRequest) super.clone();
    }
