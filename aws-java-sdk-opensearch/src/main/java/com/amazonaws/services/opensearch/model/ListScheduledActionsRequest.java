...
public class ListScheduledActionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * If your initial <code>ListScheduledActions</code> operation returns a <code>nextToken</code>, you can include the
     * returned <code>nextToken</code> in subsequent <code>ListScheduledActions</code> operations, which returns results
     * in the next page.
     * </p>
     */
    ...
    public ListScheduledActionsRequest withDomainName(String domainName) {
     ...
     * 
     * @param nextToken
     *        If your initial <code>ListScheduledActions</code> operation returns a <code>nextToken</code>, you can
     *        include the returned <code>nextToken</code> in subsequent <code>ListScheduledActions</code> operations,
     ...
     * </p>
     * 
     * @return If your initial <code>ListScheduledActions</code> operation returns a <code>nextToken</code>, you can
     *         include the returned <code>nextToken</code> in subsequent <code>ListScheduledActions</code> operations,
     *         which returns results in the next page.
     */
