...
public enum OpenSearchWarmPartitionInstanceType {
     ...
     * @param value
     *        real value
     * @return OpenSearchWarmPartitionInstanceType corresponding to the value
     *
    ...
    public static OpenSearchWarmPartitionInstanceType fromValue(String value) {
        ...
        for (OpenSearchWarmPartitionInstanceType enumEntry : OpenSearchWarmPartitionInstanceType.values()) {
