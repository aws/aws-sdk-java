...
public class DeleteInboundConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteInboundConnectionResult == false)
            return false;
        DeleteInboundConnectionResult other = (DeleteInboundConnectionResult) obj;
    ...
    public DeleteInboundConnectionResult clone() {
        try {
            return (DeleteInboundConnectionResult) super.clone();
