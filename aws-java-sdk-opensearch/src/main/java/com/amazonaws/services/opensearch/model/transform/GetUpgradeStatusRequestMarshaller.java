...
public class GetUpgradeStatusRequestMarshaller {
    ...
    private static final GetUpgradeStatusRequestMarshaller instance = new GetUpgradeStatusRequestMarshaller();

    public static GetUpgradeStatusRequestMarshaller getInstance() {
        return instance;
    }
