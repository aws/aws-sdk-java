...
/**
 * Limits JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LimitsJsonUnmarshaller implements Unmarshaller<Limits, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("InstanceLimits", targetDepth)) {
                    context.nextToken();
                    limits.setInstanceLimits(InstanceLimitsJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    private static LimitsJsonUnmarshaller instance;

    public static LimitsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LimitsJsonUnmarshaller();
        return instance;
    }
}
