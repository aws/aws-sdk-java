...
public class NodeToNodeEncryptionOptionsStatus implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The node-to-node encryption options for the specified domain.
     */
     ...
     * </p>
     * 
     * @return The status of the node-to-node encryption options for the specified domain.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.opensearch.model.transform.NodeToNodeEncryptionOptionsStatusMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
