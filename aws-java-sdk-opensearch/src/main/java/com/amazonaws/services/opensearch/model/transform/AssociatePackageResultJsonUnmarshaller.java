...
/**
 * AssociatePackageResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssociatePackageResultJsonUnmarshaller implements Unmarshaller<AssociatePackageResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DomainPackageDetails", targetDepth)) {
                    context.nextToken();
                    associatePackageResult.setDomainPackageDetails(DomainPackageDetailsJsonUnmarshaller.getInstance().unmarshall(context));
                }
