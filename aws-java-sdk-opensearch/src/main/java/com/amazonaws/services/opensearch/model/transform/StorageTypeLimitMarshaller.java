...
public class StorageTypeLimitMarshaller {
    ...
    public void marshall(StorageTypeLimit storageTypeLimit, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(storageTypeLimit.getLimitName(), LIMITNAME_BINDING);
            protocolMarshaller.marshall(storageTypeLimit.getLimitValues(), LIMITVALUES_BINDING);
        } catch (Exception e) {
