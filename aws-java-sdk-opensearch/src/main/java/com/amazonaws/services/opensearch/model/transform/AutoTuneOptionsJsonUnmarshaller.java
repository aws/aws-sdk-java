...
/**
 * AutoTuneOptions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AutoTuneOptionsJsonUnmarshaller implements Unmarshaller<AutoTuneOptions, JsonUnmarshallerContext> {

    public AutoTuneOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
        AutoTuneOptions autoTuneOptions = new AutoTuneOptions();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("UseOffPeakWindow", targetDepth)) {
                    context.nextToken();
                    autoTuneOptions.setUseOffPeakWindow(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
    ...
    private static AutoTuneOptionsJsonUnmarshaller instance;

    public static AutoTuneOptionsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AutoTuneOptionsJsonUnmarshaller();
        return instance;
    }
}
