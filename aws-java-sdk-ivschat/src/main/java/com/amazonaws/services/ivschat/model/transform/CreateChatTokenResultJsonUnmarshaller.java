...
/**
 * CreateChatTokenResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateChatTokenResultJsonUnmarshaller implements Unmarshaller<CreateChatTokenResult, JsonUnmarshallerContext> {

    public CreateChatTokenResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateChatTokenResult createChatTokenResult = new CreateChatTokenResult();
    ...
    private static CreateChatTokenResultJsonUnmarshaller instance;

    public static CreateChatTokenResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateChatTokenResultJsonUnmarshaller();
        return instance;
    }
}
