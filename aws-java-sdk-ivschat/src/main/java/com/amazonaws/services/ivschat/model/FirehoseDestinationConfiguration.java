 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivschat-2020-07-14/FirehoseDestinationConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FirehoseDestinationConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FirehoseDestinationConfiguration == false)
            return false;
        FirehoseDestinationConfiguration other = (FirehoseDestinationConfiguration) obj;
    ...
    public FirehoseDestinationConfiguration clone() {
        try {
            return (FirehoseDestinationConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.ivschat.model.transform.FirehoseDestinationConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
