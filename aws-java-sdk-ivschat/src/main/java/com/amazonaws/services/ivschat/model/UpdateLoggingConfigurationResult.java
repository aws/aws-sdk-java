...
public class UpdateLoggingConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateLoggingConfigurationResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public UpdateLoggingConfigurationResult withCreateTime(java.util.Date createTime) {
     ...
     *        to log chat content.
     * @see UpdateLoggingConfigurationState
     */
    ...
    public UpdateLoggingConfigurationResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateLoggingConfigurationResult#withTags
    ...
    public UpdateLoggingConfigurationResult withUpdateTime(java.util.Date updateTime) {
