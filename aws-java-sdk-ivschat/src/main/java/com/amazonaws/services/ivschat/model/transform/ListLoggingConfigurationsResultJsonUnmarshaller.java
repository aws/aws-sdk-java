        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("loggingConfigurations", targetDepth)) {
                    context.nextToken();
                    listLoggingConfigurationsResult.setLoggingConfigurations(new ListUnmarshaller<LoggingConfigurationSummary>(
                            LoggingConfigurationSummaryJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listLoggingConfigurationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
