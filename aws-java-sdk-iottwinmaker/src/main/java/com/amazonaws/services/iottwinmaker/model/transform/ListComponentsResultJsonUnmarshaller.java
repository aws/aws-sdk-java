    ...
    public ListComponentsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("componentSummaries", targetDepth)) {
                    context.nextToken();
                    listComponentsResult.setComponentSummaries(new ListUnmarshaller<ComponentSummary>(ComponentSummaryJsonUnmarshaller.getInstance())
