...
public class ListEntitiesFilterMarshaller {
    ...
    public static ListEntitiesFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListEntitiesFilter listEntitiesFilter, ProtocolMarshaller protocolMarshaller) {

        if (listEntitiesFilter == null) {
