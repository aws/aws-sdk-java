...
public class CancelMetadataTransferJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CancelMetadataTransferJobRequest withMetadataTransferJobId(String metadataTransferJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelMetadataTransferJobRequest == false)
            return false;
        CancelMetadataTransferJobRequest other = (CancelMetadataTransferJobRequest) obj;
    ...
    @Override
    public CancelMetadataTransferJobRequest clone() {
        return (CancelMetadataTransferJobRequest) super.clone();
    }
