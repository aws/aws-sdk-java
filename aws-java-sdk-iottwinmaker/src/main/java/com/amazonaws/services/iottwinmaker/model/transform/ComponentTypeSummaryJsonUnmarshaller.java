...
/**
 * ComponentTypeSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ComponentTypeSummaryJsonUnmarshaller implements Unmarshaller<ComponentTypeSummary, JsonUnmarshallerContext> {

    public ComponentTypeSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ComponentTypeSummary componentTypeSummary = new ComponentTypeSummary();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("arn", targetDepth)) {
                    context.nextToken();
                    componentTypeSummary.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("componentTypeId", targetDepth)) {
                    context.nextToken();
                    componentTypeSummary.setComponentTypeId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ComponentTypeSummaryJsonUnmarshaller instance;

    public static ComponentTypeSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ComponentTypeSummaryJsonUnmarshaller();
        return instance;
    }
}
