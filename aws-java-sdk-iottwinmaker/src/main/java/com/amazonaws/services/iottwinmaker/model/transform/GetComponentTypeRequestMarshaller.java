...
public class GetComponentTypeRequestMarshaller {
    ...
    public static GetComponentTypeRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetComponentTypeRequest getComponentTypeRequest, ProtocolMarshaller protocolMarshaller) {
