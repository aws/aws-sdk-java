...
public class BatchPutPropertyValuesRequestMarshaller {
    ...
    public static BatchPutPropertyValuesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchPutPropertyValuesRequest batchPutPropertyValuesRequest, ProtocolMarshaller protocolMarshaller) {

        if (batchPutPropertyValuesRequest == null) {
