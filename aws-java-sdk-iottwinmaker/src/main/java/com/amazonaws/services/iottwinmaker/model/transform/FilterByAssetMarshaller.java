...
public class FilterByAssetMarshaller {
    ...
    private static final MarshallingInfo<Boolean> INCLUDEASSETMODEL_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("includeAssetModel").build();
