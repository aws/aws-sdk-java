...
public class UpdateLogPatternResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateLogPatternResult == false)
            return false;
        UpdateLogPatternResult other = (UpdateLogPatternResult) obj;
    ...
    @Override
    public UpdateLogPatternResult clone() {
        try {
            return (UpdateLogPatternResult) super.clone();
