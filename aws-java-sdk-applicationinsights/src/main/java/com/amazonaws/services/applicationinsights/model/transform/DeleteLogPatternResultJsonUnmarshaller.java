...
/**
 * DeleteLogPatternResult JSON Unmarshaller
 */
...
public class DeleteLogPatternResultJsonUnmarshaller implements Unmarshaller<DeleteLogPatternResult, JsonUnmarshallerContext> {
    ...
    public DeleteLogPatternResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLogPatternResult deleteLogPatternResult = new DeleteLogPatternResult();

        return deleteLogPatternResult;
    }
