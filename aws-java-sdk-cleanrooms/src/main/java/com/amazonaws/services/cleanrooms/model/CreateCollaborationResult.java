...
public class CreateCollaborationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateCollaborationResult withCollaboration(Collaboration collaboration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCollaborationResult == false)
            return false;
        CreateCollaborationResult other = (CreateCollaborationResult) obj;
    ...
    @Override
    public CreateCollaborationResult clone() {
        try {
            return (CreateCollaborationResult) super.clone();
