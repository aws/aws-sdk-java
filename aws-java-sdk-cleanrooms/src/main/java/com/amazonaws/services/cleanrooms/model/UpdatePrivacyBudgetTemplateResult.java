...
public class UpdatePrivacyBudgetTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Summary of the privacy budget template.
     */
    ...
    public UpdatePrivacyBudgetTemplateResult withPrivacyBudgetTemplate(PrivacyBudgetTemplate privacyBudgetTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePrivacyBudgetTemplateResult == false)
            return false;
        UpdatePrivacyBudgetTemplateResult other = (UpdatePrivacyBudgetTemplateResult) obj;
    ...
    @Override
    public UpdatePrivacyBudgetTemplateResult clone() {
        try {
            return (UpdatePrivacyBudgetTemplateResult) super.clone();
