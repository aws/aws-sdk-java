...
public class UpdateProtectedQueryRequestMarshaller {
    ...
    private static final UpdateProtectedQueryRequestMarshaller instance = new UpdateProtectedQueryRequestMarshaller();

    public static UpdateProtectedQueryRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateProtectedQueryRequest updateProtectedQueryRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateProtectedQueryRequest.getMembershipIdentifier(), MEMBERSHIPIDENTIFIER_BINDING);
            protocolMarshaller.marshall(updateProtectedQueryRequest.getProtectedQueryIdentifier(), PROTECTEDQUERYIDENTIFIER_BINDING);
            protocolMarshaller.marshall(updateProtectedQueryRequest.getTargetStatus(), TARGETSTATUS_BINDING);
        } catch (Exception e) {
