...
/**
 * PrivacyBudgetTemplateMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PrivacyBudgetTemplateMarshaller {
    ...
    private static final PrivacyBudgetTemplateMarshaller instance = new PrivacyBudgetTemplateMarshaller();

    public static PrivacyBudgetTemplateMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PrivacyBudgetTemplate privacyBudgetTemplate, ProtocolMarshaller protocolMarshaller) {

        if (privacyBudgetTemplate == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(privacyBudgetTemplate.getId(), ID_BINDING);
            protocolMarshaller.marshall(privacyBudgetTemplate.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(privacyBudgetTemplate.getMembershipId(), MEMBERSHIPID_BINDING);
            protocolMarshaller.marshall(privacyBudgetTemplate.getMembershipArn(), MEMBERSHIPARN_BINDING);
            protocolMarshaller.marshall(privacyBudgetTemplate.getCollaborationId(), COLLABORATIONID_BINDING);
            protocolMarshaller.marshall(privacyBudgetTemplate.getCollaborationArn(), COLLABORATIONARN_BINDING);
            protocolMarshaller.marshall(privacyBudgetTemplate.getCreateTime(), CREATETIME_BINDING);
            protocolMarshaller.marshall(privacyBudgetTemplate.getUpdateTime(), UPDATETIME_BINDING);
            protocolMarshaller.marshall(privacyBudgetTemplate.getPrivacyBudgetType(), PRIVACYBUDGETTYPE_BINDING);
            protocolMarshaller.marshall(privacyBudgetTemplate.getAutoRefresh(), AUTOREFRESH_BINDING);
            protocolMarshaller.marshall(privacyBudgetTemplate.getParameters(), PARAMETERS_BINDING);
        } catch (Exception e) {
