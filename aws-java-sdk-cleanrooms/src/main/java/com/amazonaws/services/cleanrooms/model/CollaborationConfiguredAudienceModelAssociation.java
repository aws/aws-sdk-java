 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/CollaborationConfiguredAudienceModelAssociation"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CollaborationConfiguredAudienceModelAssociation implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the configure audience model.
     */
    ...
    public CollaborationConfiguredAudienceModelAssociation withCreateTime(java.util.Date createTime) {
    ...
    public CollaborationConfiguredAudienceModelAssociation withUpdateTime(java.util.Date updateTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CollaborationConfiguredAudienceModelAssociation == false)
            return false;
        CollaborationConfiguredAudienceModelAssociation other = (CollaborationConfiguredAudienceModelAssociation) obj;
    ...
    public CollaborationConfiguredAudienceModelAssociation clone() {
        try {
            return (CollaborationConfiguredAudienceModelAssociation) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cleanrooms.model.transform.CollaborationConfiguredAudienceModelAssociationMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
