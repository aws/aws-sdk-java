 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/MembershipQueryComputePaymentConfig"
...
public class MembershipQueryComputePaymentConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * Indicates whether the collaboration member has accepted to pay for query compute costs (<code>TRUE</code>) or has
     * not accepted to pay for query compute costs (<code>FALSE</code>).
     * </p>
     * <p>
     ...
     * <li>
     * <p>
     * If you set the value to <code>FALSE</code> but you are responsible to pay for query compute costs.
     * </p>
     * </li>
     * <li>
     * <p>
     * If you set the value to <code>TRUE</code> but you are not responsible to pay for query compute costs.
     * </p>
     * </li>
     * </ul>
     */
     ...
     * 
     * @param isResponsible
     *        Indicates whether the collaboration member has accepted to pay for query compute costs (<code>TRUE</code>)
     *        or has not accepted to pay for query compute costs (<code>FALSE</code>).</p>
     *        <p>
     ...
     * </ul>
     * 
     * @return Indicates whether the collaboration member has accepted to pay for query compute costs (<code>TRUE</code>
     *         ) or has not accepted to pay for query compute costs (<code>FALSE</code>).</p>
     *         <p>
     *         If the collaboration creator has not specified anyone to pay for query compute costs, then the member who
     *         can query is the default payer.
