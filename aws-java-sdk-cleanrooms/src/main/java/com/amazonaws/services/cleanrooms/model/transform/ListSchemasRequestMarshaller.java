...
public class ListSchemasRequestMarshaller {
    ...
    private static final MarshallingInfo<String> SCHEMATYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("schemaType").build();
    ...
    public void marshall(ListSchemasRequest listSchemasRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listSchemasRequest.getCollaborationIdentifier(), COLLABORATIONIDENTIFIER_BINDING);
            protocolMarshaller.marshall(listSchemasRequest.getSchemaType(), SCHEMATYPE_BINDING);
