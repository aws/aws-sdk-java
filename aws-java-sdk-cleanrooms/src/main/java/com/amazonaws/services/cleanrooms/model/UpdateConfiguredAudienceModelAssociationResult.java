...
public class UpdateConfiguredAudienceModelAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
     ...
     * </p>
     * 
     * @return Details about the configured audience model association that you updated.
     */
    ...
    public UpdateConfiguredAudienceModelAssociationResult withConfiguredAudienceModelAssociation(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateConfiguredAudienceModelAssociationResult == false)
            return false;
        UpdateConfiguredAudienceModelAssociationResult other = (UpdateConfiguredAudienceModelAssociationResult) obj;
    ...
    @Override
    public UpdateConfiguredAudienceModelAssociationResult clone() {
        try {
            return (UpdateConfiguredAudienceModelAssociationResult) super.clone();
