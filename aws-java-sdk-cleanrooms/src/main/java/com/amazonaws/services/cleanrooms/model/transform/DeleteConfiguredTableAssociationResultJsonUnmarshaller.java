...
/**
 * DeleteConfiguredTableAssociationResult JSON Unmarshaller
 */
...
public class DeleteConfiguredTableAssociationResultJsonUnmarshaller implements Unmarshaller<DeleteConfiguredTableAssociationResult, JsonUnmarshallerContext> {
    ...
    public DeleteConfiguredTableAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteConfiguredTableAssociationResult deleteConfiguredTableAssociationResult = new DeleteConfiguredTableAssociationResult();
