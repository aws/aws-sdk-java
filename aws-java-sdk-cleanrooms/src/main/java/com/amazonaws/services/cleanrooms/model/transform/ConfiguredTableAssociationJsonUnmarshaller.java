...
/**
 * ConfiguredTableAssociation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConfiguredTableAssociationJsonUnmarshaller implements Unmarshaller<ConfiguredTableAssociation, JsonUnmarshallerContext> {

    public ConfiguredTableAssociation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ConfiguredTableAssociation configuredTableAssociation = new ConfiguredTableAssociation();
    ...
    private static ConfiguredTableAssociationJsonUnmarshaller instance;

    public static ConfiguredTableAssociationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConfiguredTableAssociationJsonUnmarshaller();
        return instance;
    }
}
