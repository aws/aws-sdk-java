...
/**
 * DeletePrivacyBudgetTemplateResult JSON Unmarshaller
 */
...
public class DeletePrivacyBudgetTemplateResultJsonUnmarshaller implements Unmarshaller<DeletePrivacyBudgetTemplateResult, JsonUnmarshallerContext> {
    ...
    public DeletePrivacyBudgetTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeletePrivacyBudgetTemplateResult deletePrivacyBudgetTemplateResult = new DeletePrivacyBudgetTemplateResult();
