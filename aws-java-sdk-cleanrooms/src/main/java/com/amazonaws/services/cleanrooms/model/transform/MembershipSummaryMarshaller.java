...
/**
 * MembershipSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MembershipSummaryMarshaller {
    ...
    private static final MembershipSummaryMarshaller instance = new MembershipSummaryMarshaller();

    public static MembershipSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MembershipSummary membershipSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(membershipSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(membershipSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(membershipSummary.getCollaborationArn(), COLLABORATIONARN_BINDING);
            protocolMarshaller.marshall(membershipSummary.getCollaborationId(), COLLABORATIONID_BINDING);
            protocolMarshaller.marshall(membershipSummary.getCollaborationCreatorAccountId(), COLLABORATIONCREATORACCOUNTID_BINDING);
            protocolMarshaller.marshall(membershipSummary.getCollaborationCreatorDisplayName(), COLLABORATIONCREATORDISPLAYNAME_BINDING);
            protocolMarshaller.marshall(membershipSummary.getCollaborationName(), COLLABORATIONNAME_BINDING);
            protocolMarshaller.marshall(membershipSummary.getCreateTime(), CREATETIME_BINDING);
            protocolMarshaller.marshall(membershipSummary.getUpdateTime(), UPDATETIME_BINDING);
            protocolMarshaller.marshall(membershipSummary.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(membershipSummary.getMemberAbilities(), MEMBERABILITIES_BINDING);
            protocolMarshaller.marshall(membershipSummary.getPaymentConfiguration(), PAYMENTCONFIGURATION_BINDING);
        } catch (Exception e) {
