...
public class CreateMembershipResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateMembershipResult withMembership(Membership membership) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateMembershipResult == false)
            return false;
        CreateMembershipResult other = (CreateMembershipResult) obj;
    ...
    @Override
    public CreateMembershipResult clone() {
        try {
            return (CreateMembershipResult) super.clone();
