 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/PrivacyBudgetTemplateParametersInput"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PrivacyBudgetTemplateParametersInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public DifferentialPrivacyTemplateParametersInput getDifferentialPrivacy() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PrivacyBudgetTemplateParametersInput == false)
            return false;
    ...
    public PrivacyBudgetTemplateParametersInput clone() {
        try {
            return (PrivacyBudgetTemplateParametersInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cleanrooms.model.transform.PrivacyBudgetTemplateParametersInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
