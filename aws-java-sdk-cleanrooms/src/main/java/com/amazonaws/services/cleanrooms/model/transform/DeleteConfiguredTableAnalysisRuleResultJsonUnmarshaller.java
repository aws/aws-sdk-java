...
/**
 * DeleteConfiguredTableAnalysisRuleResult JSON Unmarshaller
 */
...
public class DeleteConfiguredTableAnalysisRuleResultJsonUnmarshaller implements Unmarshaller<DeleteConfiguredTableAnalysisRuleResult, JsonUnmarshallerContext> {
    ...
    public DeleteConfiguredTableAnalysisRuleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteConfiguredTableAnalysisRuleResult deleteConfiguredTableAnalysisRuleResult = new DeleteConfiguredTableAnalysisRuleResult();
