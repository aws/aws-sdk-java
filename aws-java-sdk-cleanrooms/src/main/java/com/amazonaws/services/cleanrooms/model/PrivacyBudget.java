 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/PrivacyBudget" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PrivacyBudget implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private DifferentialPrivacyPrivacyBudget differentialPrivacy;
     ...
     * </p>
     * 
     * @return An object that specifies the epsilon parameter and the utility in terms of total aggregations, as well as
     *         the remaining aggregations available.
     */

    public DifferentialPrivacyPrivacyBudget getDifferentialPrivacy() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PrivacyBudget == false)
            return false;
        PrivacyBudget other = (PrivacyBudget) obj;
    ...
    public PrivacyBudget clone() {
        try {
            return (PrivacyBudget) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cleanrooms.model.transform.PrivacyBudgetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
