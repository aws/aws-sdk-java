 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/DifferentialPrivacyPreviewParametersInput"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DifferentialPrivacyPreviewParametersInput implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The epsilon value that you want to preview.
     */
    ...
    public DifferentialPrivacyPreviewParametersInput withEpsilon(Integer epsilon) {
        setEpsilon(epsilon);
        return this;
    }
    ...
    public DifferentialPrivacyPreviewParametersInput withUsersNoisePerQuery(Integer usersNoisePerQuery) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DifferentialPrivacyPreviewParametersInput == false)
            return false;
        DifferentialPrivacyPreviewParametersInput other = (DifferentialPrivacyPreviewParametersInput) obj;
    ...
    @Override
    public DifferentialPrivacyPreviewParametersInput clone() {
        try {
            return (DifferentialPrivacyPreviewParametersInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cleanrooms.model.transform.DifferentialPrivacyPreviewParametersInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
