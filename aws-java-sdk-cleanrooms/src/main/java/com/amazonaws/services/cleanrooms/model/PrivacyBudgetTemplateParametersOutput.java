 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/PrivacyBudgetTemplateParametersOutput"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PrivacyBudgetTemplateParametersOutput implements Serializable, Cloneable, StructuredPojo {
    ...
    public DifferentialPrivacyTemplateParametersOutput getDifferentialPrivacy() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PrivacyBudgetTemplateParametersOutput == false)
            return false;
    ...
    public PrivacyBudgetTemplateParametersOutput clone() {
        try {
            return (PrivacyBudgetTemplateParametersOutput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cleanrooms.model.transform.PrivacyBudgetTemplateParametersOutputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
