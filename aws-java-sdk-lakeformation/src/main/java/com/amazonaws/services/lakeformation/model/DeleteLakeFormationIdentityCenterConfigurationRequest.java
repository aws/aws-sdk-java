...
public class DeleteLakeFormationIdentityCenterConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * The identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata
     * store. It contains database definitions, table definitions, view definition, and other control information to
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteLakeFormationIdentityCenterConfigurationRequest == false)
            return false;
        DeleteLakeFormationIdentityCenterConfigurationRequest other = (DeleteLakeFormationIdentityCenterConfigurationRequest) obj;
    ...
    public DeleteLakeFormationIdentityCenterConfigurationRequest clone() {
        return (DeleteLakeFormationIdentityCenterConfigurationRequest) super.clone();
    }
