...
public class CreateLakeFormationIdentityCenterConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLakeFormationIdentityCenterConfigurationResult == false)
            return false;
        CreateLakeFormationIdentityCenterConfigurationResult other = (CreateLakeFormationIdentityCenterConfigurationResult) obj;
    ...
    public CreateLakeFormationIdentityCenterConfigurationResult clone() {
        try {
            return (CreateLakeFormationIdentityCenterConfigurationResult) super.clone();
