...
/**
 * UpdateLFTagResult JSON Unmarshaller
 */
...
public class UpdateLFTagResultJsonUnmarshaller implements Unmarshaller<UpdateLFTagResult, JsonUnmarshallerContext> {
    ...
    public UpdateLFTagResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateLFTagResult updateLFTagResult = new UpdateLFTagResult();

        return updateLFTagResult;
    }
