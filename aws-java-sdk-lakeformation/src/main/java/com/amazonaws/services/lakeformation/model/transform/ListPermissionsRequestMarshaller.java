...
public class ListPermissionsRequestMarshaller {
    ...
    public void marshall(ListPermissionsRequest listPermissionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listPermissionsRequest.getCatalogId(), CATALOGID_BINDING);
            protocolMarshaller.marshall(listPermissionsRequest.getPrincipal(), PRINCIPAL_BINDING);
            protocolMarshaller.marshall(listPermissionsRequest.getResourceType(), RESOURCETYPE_BINDING);
