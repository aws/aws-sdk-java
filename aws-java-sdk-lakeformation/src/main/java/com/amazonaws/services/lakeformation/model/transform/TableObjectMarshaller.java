...
/**
 * TableObjectMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TableObjectMarshaller {
    ...
    private static final TableObjectMarshaller instance = new TableObjectMarshaller();

    public static TableObjectMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TableObject tableObject, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(tableObject.getUri(), URI_BINDING);
            protocolMarshaller.marshall(tableObject.getETag(), ETAG_BINDING);
            protocolMarshaller.marshall(tableObject.getSize(), SIZE_BINDING);
        } catch (Exception e) {
