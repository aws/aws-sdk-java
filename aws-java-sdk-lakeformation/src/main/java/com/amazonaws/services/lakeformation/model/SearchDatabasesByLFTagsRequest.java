...
public class SearchDatabasesByLFTagsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of conditions (<code>LFTag</code> structures) to search for in database resources.
     */
    ...
    public SearchDatabasesByLFTagsRequest withExpression(java.util.Collection<LFTag> expression) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchDatabasesByLFTagsRequest == false)
            return false;
        SearchDatabasesByLFTagsRequest other = (SearchDatabasesByLFTagsRequest) obj;
    ...
    @Override
    public SearchDatabasesByLFTagsRequest clone() {
