...
/**
 * AssumeDecoratedRoleWithSAMLResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssumeDecoratedRoleWithSAMLResultJsonUnmarshaller implements Unmarshaller<AssumeDecoratedRoleWithSAMLResult, JsonUnmarshallerContext> {

    public AssumeDecoratedRoleWithSAMLResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssumeDecoratedRoleWithSAMLResult assumeDecoratedRoleWithSAMLResult = new AssumeDecoratedRoleWithSAMLResult();
    ...
    private static AssumeDecoratedRoleWithSAMLResultJsonUnmarshaller instance;

    public static AssumeDecoratedRoleWithSAMLResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssumeDecoratedRoleWithSAMLResultJsonUnmarshaller();
        return instance;
    }
}
