...
/**
 * CreateDataCellsFilterResult JSON Unmarshaller
 */
...
public class CreateDataCellsFilterResultJsonUnmarshaller implements Unmarshaller<CreateDataCellsFilterResult, JsonUnmarshallerContext> {
    ...
    public CreateDataCellsFilterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateDataCellsFilterResult createDataCellsFilterResult = new CreateDataCellsFilterResult();

        return createDataCellsFilterResult;
    }
