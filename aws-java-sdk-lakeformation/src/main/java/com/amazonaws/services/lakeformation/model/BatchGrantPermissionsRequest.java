...
public class BatchGrantPermissionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of up to 20 entries for resource permissions to be granted by batch operation to the principal.
     */
    ...
    public BatchGrantPermissionsRequest withEntries(java.util.Collection<BatchPermissionsRequestEntry> entries) {
        setEntries(entries);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGrantPermissionsRequest == false)
            return false;
        BatchGrantPermissionsRequest other = (BatchGrantPermissionsRequest) obj;
