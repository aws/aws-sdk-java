...
public class GetDataLakeSettingsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetDataLakeSettingsRequest withCatalogId(String catalogId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDataLakeSettingsRequest == false)
            return false;
        GetDataLakeSettingsRequest other = (GetDataLakeSettingsRequest) obj;
    ...
    @Override
    public GetDataLakeSettingsRequest clone() {
        return (GetDataLakeSettingsRequest) super.clone();
    }
