...
public class AddLFTagsToResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AddLFTagsToResourceResult withFailures(LFTagError... failures) {
    ...
    public AddLFTagsToResourceResult withFailures(java.util.Collection<LFTagError> failures) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddLFTagsToResourceResult == false)
            return false;
        AddLFTagsToResourceResult other = (AddLFTagsToResourceResult) obj;
    ...
    public AddLFTagsToResourceResult clone() {
        try {
            return (AddLFTagsToResourceResult) super.clone();
