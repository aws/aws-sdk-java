...
/**
 * AddObjectInputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AddObjectInputMarshaller {
    ...
    private static final AddObjectInputMarshaller instance = new AddObjectInputMarshaller();

    public static AddObjectInputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AddObjectInput addObjectInput, ProtocolMarshaller protocolMarshaller) {

        if (addObjectInput == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(addObjectInput.getUri(), URI_BINDING);
            protocolMarshaller.marshall(addObjectInput.getETag(), ETAG_BINDING);
            protocolMarshaller.marshall(addObjectInput.getSize(), SIZE_BINDING);
            protocolMarshaller.marshall(addObjectInput.getPartitionValues(), PARTITIONVALUES_BINDING);
        } catch (Exception e) {
