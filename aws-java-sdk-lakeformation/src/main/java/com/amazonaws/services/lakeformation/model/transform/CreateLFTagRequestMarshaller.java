...
@SdkInternalApi
public class CreateLFTagRequestMarshaller {
    ...
    private static final CreateLFTagRequestMarshaller instance = new CreateLFTagRequestMarshaller();

    public static CreateLFTagRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateLFTagRequest createLFTagRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createLFTagRequest.getCatalogId(), CATALOGID_BINDING);
            protocolMarshaller.marshall(createLFTagRequest.getTagKey(), TAGKEY_BINDING);
            protocolMarshaller.marshall(createLFTagRequest.getTagValues(), TAGVALUES_BINDING);
        } catch (Exception e) {
