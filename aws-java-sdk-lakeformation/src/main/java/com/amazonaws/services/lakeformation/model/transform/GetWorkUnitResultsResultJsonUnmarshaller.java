...
/**
 * GetWorkUnitResultsResult JSON Unmarshaller
 */
...
public class GetWorkUnitResultsResultJsonUnmarshaller implements Unmarshaller<GetWorkUnitResultsResult, JsonUnmarshallerContext> {
    ...
    public GetWorkUnitResultsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetWorkUnitResultsResult getWorkUnitResultsResult = new GetWorkUnitResultsResult();

        getWorkUnitResultsResult.setResultStream(context.getHttpResponse().getContent());
