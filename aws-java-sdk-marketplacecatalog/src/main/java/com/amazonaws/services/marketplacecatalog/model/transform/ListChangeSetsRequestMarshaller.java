...
public class ListChangeSetsRequestMarshaller {
    ...
    private static final ListChangeSetsRequestMarshaller instance = new ListChangeSetsRequestMarshaller();

    public static ListChangeSetsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListChangeSetsRequest listChangeSetsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listChangeSetsRequest.getCatalog(), CATALOG_BINDING);
            protocolMarshaller.marshall(listChangeSetsRequest.getFilterList(), FILTERLIST_BINDING);
            protocolMarshaller.marshall(listChangeSetsRequest.getSort(), SORT_BINDING);
            protocolMarshaller.marshall(listChangeSetsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listChangeSetsRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
