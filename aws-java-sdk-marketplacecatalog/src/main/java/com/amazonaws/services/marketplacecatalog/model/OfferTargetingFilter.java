 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/OfferTargetingFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OfferTargetingFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Allows filtering on the <code>Targeting</code> of an offer with list input.
    ...
    public OfferTargetingFilter withValueList(String... valueList) {
    ...
    public OfferTargetingFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public OfferTargetingFilter withValueList(OfferTargetingString... valueList) {
        java.util.ArrayList<String> valueListCopy = new java.util.ArrayList<String>(valueList.length);
        for (OfferTargetingString value : valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OfferTargetingFilter == false)
            return false;
    ...
    @Override
    public OfferTargetingFilter clone() {
        try {
            return (OfferTargetingFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.OfferTargetingFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
