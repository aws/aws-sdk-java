 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/OfferEntityIdFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OfferEntityIdFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Allows filtering on entity id of an offer with list input.
     */
    ...
    public OfferEntityIdFilter withValueList(String... valueList) {
    ...
    public OfferEntityIdFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OfferEntityIdFilter == false)
            return false;
        OfferEntityIdFilter other = (OfferEntityIdFilter) obj;
    ...
    @Override
    public OfferEntityIdFilter clone() {
        try {
            return (OfferEntityIdFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.OfferEntityIdFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
