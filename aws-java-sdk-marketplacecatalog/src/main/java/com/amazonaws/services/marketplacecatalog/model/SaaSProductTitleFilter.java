 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/SaaSProductTitleFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SaaSProductTitleFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public SaaSProductTitleFilter withValueList(String... valueList) {
    ...
    public SaaSProductTitleFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public SaaSProductTitleFilter withWildCardValue(String wildCardValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SaaSProductTitleFilter == false)
            return false;
    ...
    @Override
    public SaaSProductTitleFilter clone() {
        try {
            return (SaaSProductTitleFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.SaaSProductTitleFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
