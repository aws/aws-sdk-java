 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/SaaSProductEntityIdFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SaaSProductEntityIdFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public SaaSProductEntityIdFilter withValueList(String... valueList) {
    ...
    public SaaSProductEntityIdFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SaaSProductEntityIdFilter == false)
            return false;
        SaaSProductEntityIdFilter other = (SaaSProductEntityIdFilter) obj;
    ...
    @Override
    public SaaSProductEntityIdFilter clone() {
        try {
            return (SaaSProductEntityIdFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.SaaSProductEntityIdFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
