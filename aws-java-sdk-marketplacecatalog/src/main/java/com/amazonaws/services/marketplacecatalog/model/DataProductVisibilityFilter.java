 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/DataProductVisibilityFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataProductVisibilityFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public DataProductVisibilityFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public DataProductVisibilityFilter withValueList(DataProductVisibilityString... valueList) {
        ...
        for (DataProductVisibilityString value : valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DataProductVisibilityFilter == false)
            return false;
        DataProductVisibilityFilter other = (DataProductVisibilityFilter) obj;
    ...
    public DataProductVisibilityFilter clone() {
        try {
            return (DataProductVisibilityFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.DataProductVisibilityFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
