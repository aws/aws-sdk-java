...
public class DataProductSummaryMarshaller {
    ...
    public void marshall(DataProductSummary dataProductSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dataProductSummary.getProductTitle(), PRODUCTTITLE_BINDING);
            protocolMarshaller.marshall(dataProductSummary.getVisibility(), VISIBILITY_BINDING);
        } catch (Exception e) {
