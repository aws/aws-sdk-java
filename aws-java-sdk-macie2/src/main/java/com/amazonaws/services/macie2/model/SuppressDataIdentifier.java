...
/**
 * <p>
 * Specifies a custom data identifier or managed data identifier that detected a type of sensitive data to start
 * excluding or including in an S3 bucket's sensitivity score.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01/SuppressDataIdentifier" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SuppressDataIdentifier implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The unique identifier for the custom data identifier or managed data identifier that detected the type of
     *         sensitive data to exclude or include in the score.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SuppressDataIdentifier == false)
            return false;
        SuppressDataIdentifier other = (SuppressDataIdentifier) obj;
    ...
    public SuppressDataIdentifier clone() {
        try {
            return (SuppressDataIdentifier) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.macie2.model.transform.SuppressDataIdentifierMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
