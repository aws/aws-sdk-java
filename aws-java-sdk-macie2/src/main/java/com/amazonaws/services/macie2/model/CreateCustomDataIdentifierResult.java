...
public class CreateCustomDataIdentifierResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateCustomDataIdentifierResult withCustomDataIdentifierId(String customDataIdentifierId) {
        setCustomDataIdentifierId(customDataIdentifierId);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getCustomDataIdentifierId() != null)
            sb.append("CustomDataIdentifierId: ").append(getCustomDataIdentifierId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCustomDataIdentifierId() == null ^ this.getCustomDataIdentifierId() == null)
            return false;
        if (other.getCustomDataIdentifierId() != null && other.getCustomDataIdentifierId().equals(this.getCustomDataIdentifierId()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getCustomDataIdentifierId() == null) ? 0 : getCustomDataIdentifierId().hashCode());
        return hashCode;
    }
    ...
    public CreateCustomDataIdentifierResult clone() {
        try {
            return (CreateCustomDataIdentifierResult) super.clone();
