...
public class UnprocessedAccountMarshaller {
    ...
    public void marshall(UnprocessedAccount unprocessedAccount, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(unprocessedAccount.getAccountId(), ACCOUNTID_BINDING);
            protocolMarshaller.marshall(unprocessedAccount.getErrorCode(), ERRORCODE_BINDING);
            protocolMarshaller.marshall(unprocessedAccount.getErrorMessage(), ERRORMESSAGE_BINDING);
        } catch (Exception e) {
