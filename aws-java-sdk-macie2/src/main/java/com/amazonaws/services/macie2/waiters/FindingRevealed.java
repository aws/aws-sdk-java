...
class FindingRevealed {
    ...
    static class IsSUCCESSMatcher extends WaiterAcceptor<GetSensitiveDataOccurrencesResult> {
         ...
         */
        @Override
        public boolean matches(GetSensitiveDataOccurrencesResult result) {
    ...
    static class IsERRORMatcher extends WaiterAcceptor<GetSensitiveDataOccurrencesResult> {
        private static final JsonNode expectedResult;
