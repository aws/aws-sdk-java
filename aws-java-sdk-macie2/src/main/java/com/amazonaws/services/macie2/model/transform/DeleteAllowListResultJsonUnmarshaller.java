...
/**
 * DeleteAllowListResult JSON Unmarshaller
 */
...
public class DeleteAllowListResultJsonUnmarshaller implements Unmarshaller<DeleteAllowListResult, JsonUnmarshallerContext> {
    ...
    public DeleteAllowListResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAllowListResult deleteAllowListResult = new DeleteAllowListResult();

        return deleteAllowListResult;
    }
