...
/**
 * UpdateClassificationScopeResult JSON Unmarshaller
 */
...
public class UpdateClassificationScopeResultJsonUnmarshaller implements Unmarshaller<UpdateClassificationScopeResult, JsonUnmarshallerContext> {
    ...
    public UpdateClassificationScopeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateClassificationScopeResult updateClassificationScopeResult = new UpdateClassificationScopeResult();

        return updateClassificationScopeResult;
    }
