...
public class SeverityLevelJsonUnmarshaller implements Unmarshaller<SeverityLevel, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("occurrencesThreshold", targetDepth)) {
                    context.nextToken();
                    severityLevel.setOccurrencesThreshold(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("severity", targetDepth)) {
                    context.nextToken();
                    severityLevel.setSeverity(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static SeverityLevelJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SeverityLevelJsonUnmarshaller();
        return instance;
    }
}
