...
/**
 * DisableOrganizationAdminAccountResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DisableOrganizationAdminAccountResultJsonUnmarshaller implements Unmarshaller<DisableOrganizationAdminAccountResult, JsonUnmarshallerContext> {

    public DisableOrganizationAdminAccountResult unmarshall(JsonUnmarshallerContext context) throws Exception {
