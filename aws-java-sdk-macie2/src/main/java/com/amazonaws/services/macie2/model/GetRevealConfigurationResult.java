...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01/GetRevealConfiguration" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetRevealConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The KMS key that's used to encrypt the sensitive data, and the status of the configuration for the Amazon
     *         Macie account.
     */
     ...
     * </p>
     * 
     * @return The access method and settings that are used to retrieve the sensitive data.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetRevealConfigurationResult == false)
            return false;
        GetRevealConfigurationResult other = (GetRevealConfigurationResult) obj;
