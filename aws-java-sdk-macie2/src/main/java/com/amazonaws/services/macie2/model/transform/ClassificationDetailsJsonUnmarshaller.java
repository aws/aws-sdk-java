...
/**
 * ClassificationDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ClassificationDetailsJsonUnmarshaller implements Unmarshaller<ClassificationDetails, JsonUnmarshallerContext> {
    ...
    public ClassificationDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("detailedResultsLocation", targetDepth)) {
                    context.nextToken();
                    classificationDetails.setDetailedResultsLocation(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("jobArn", targetDepth)) {
                    context.nextToken();
                    classificationDetails.setJobArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
