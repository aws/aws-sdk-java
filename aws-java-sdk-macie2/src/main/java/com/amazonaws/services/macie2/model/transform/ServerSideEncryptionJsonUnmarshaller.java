...
/**
 * ServerSideEncryption JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ServerSideEncryptionJsonUnmarshaller implements Unmarshaller<ServerSideEncryption, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("encryptionType", targetDepth)) {
                    context.nextToken();
                    serverSideEncryption.setEncryptionType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("kmsMasterKeyId", targetDepth)) {
                    context.nextToken();
                    serverSideEncryption.setKmsMasterKeyId(context.getUnmarshaller(String.class).unmarshall(context));
                }
