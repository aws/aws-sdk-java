...
public class SearchResourcesSimpleCriterion implements Serializable, Cloneable, StructuredPojo {
     ...
     * >BucketMetadata.sharedAccess</a> property of an S3 bucket.
     * </p>
     * </li>
     * </ul>
     * <p>
     ...
     * @param key
     *        The property to use in the condition.
     * @see SearchResourcesSimpleCriterionKey
     */
    ...
    public SearchResourcesSimpleCriterion withValues(java.util.Collection<String> values) {
        setValues(values);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchResourcesSimpleCriterion == false)
            return false;
    ...
    public SearchResourcesSimpleCriterion clone() {
        try {
            return (SearchResourcesSimpleCriterion) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.macie2.model.transform.SearchResourcesSimpleCriterionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
