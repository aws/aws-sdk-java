...
public class SensitivityInspectionTemplatesEntry implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SensitivityInspectionTemplatesEntry == false)
            return false;
        SensitivityInspectionTemplatesEntry other = (SensitivityInspectionTemplatesEntry) obj;
    ...
    public SensitivityInspectionTemplatesEntry clone() {
        try {
            return (SensitivityInspectionTemplatesEntry) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.macie2.model.transform.SensitivityInspectionTemplatesEntryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
