...
public class Scoping implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Scoping == false)
            return false;
    ...
    @Override
    public Scoping clone() {
        try {
            return (Scoping) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.macie2.model.transform.ScopingMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
