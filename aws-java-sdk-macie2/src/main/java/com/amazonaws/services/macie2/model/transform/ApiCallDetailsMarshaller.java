...
public class ApiCallDetailsMarshaller {
    ...
    private static final MarshallingInfo<String> APISERVICENAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("apiServiceName").build();
    private static final MarshallingInfo<java.util.Date> FIRSTSEEN_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("firstSeen").timestampFormat("iso8601").build();
    private static final MarshallingInfo<java.util.Date> LASTSEEN_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("lastSeen").timestampFormat("iso8601").build();
