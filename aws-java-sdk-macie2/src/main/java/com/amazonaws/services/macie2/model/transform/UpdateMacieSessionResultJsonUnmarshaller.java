...
/**
 * UpdateMacieSessionResult JSON Unmarshaller
 */
...
public class UpdateMacieSessionResultJsonUnmarshaller implements Unmarshaller<UpdateMacieSessionResult, JsonUnmarshallerContext> {
    ...
    public UpdateMacieSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateMacieSessionResult updateMacieSessionResult = new UpdateMacieSessionResult();
