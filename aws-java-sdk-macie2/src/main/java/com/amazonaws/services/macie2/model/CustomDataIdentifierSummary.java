 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01/CustomDataIdentifierSummary" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CustomDataIdentifierSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public CustomDataIdentifierSummary clone() {
        try {
            return (CustomDataIdentifierSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.macie2.model.transform.CustomDataIdentifierSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
