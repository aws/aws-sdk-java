...
/**
 * UserPausedDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UserPausedDetailsJsonUnmarshaller implements Unmarshaller<UserPausedDetails, JsonUnmarshallerContext> {

    public UserPausedDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        UserPausedDetails userPausedDetails = new UserPausedDetails();
    ...
    private static UserPausedDetailsJsonUnmarshaller instance;

    public static UserPausedDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UserPausedDetailsJsonUnmarshaller();
        return instance;
    }
}
