...
public enum LastRunErrorStatusCode {
     ...
     * @param value
     *        real value
     * @return LastRunErrorStatusCode corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static LastRunErrorStatusCode fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (LastRunErrorStatusCode enumEntry : LastRunErrorStatusCode.values()) {
