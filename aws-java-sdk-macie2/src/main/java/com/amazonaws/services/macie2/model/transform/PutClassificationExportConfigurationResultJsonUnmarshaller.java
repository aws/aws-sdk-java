...
/**
 * PutClassificationExportConfigurationResult JSON Unmarshaller
 */
...
public class PutClassificationExportConfigurationResultJsonUnmarshaller implements
    ...
    public PutClassificationExportConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("configuration", targetDepth)) {
                    context.nextToken();
                    putClassificationExportConfigurationResult.setConfiguration(ClassificationExportConfigurationJsonUnmarshaller.getInstance().unmarshall(
                            context));
                }
