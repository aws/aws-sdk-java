...
/**
 * UpdateClassificationJobResult JSON Unmarshaller
 */
...
public class UpdateClassificationJobResultJsonUnmarshaller implements Unmarshaller<UpdateClassificationJobResult, JsonUnmarshallerContext> {
    ...
    public UpdateClassificationJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateClassificationJobResult updateClassificationJobResult = new UpdateClassificationJobResult();
