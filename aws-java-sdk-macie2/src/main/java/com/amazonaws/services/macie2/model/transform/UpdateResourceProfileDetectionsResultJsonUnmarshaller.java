...
/**
 * UpdateResourceProfileDetectionsResult JSON Unmarshaller
 */
...
public class UpdateResourceProfileDetectionsResultJsonUnmarshaller implements Unmarshaller<UpdateResourceProfileDetectionsResult, JsonUnmarshallerContext> {
    ...
    public UpdateResourceProfileDetectionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateResourceProfileDetectionsResult updateResourceProfileDetectionsResult = new UpdateResourceProfileDetectionsResult();

        return updateResourceProfileDetectionsResult;
    }
