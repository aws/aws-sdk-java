...
public class PutClassificationExportConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param configuration
     *        The location to export data classification results to, and the encryption settings to use when storing
     ...
     * </p>
     * 
     * @return The location to export data classification results to, and the encryption settings to use when storing
     *         results in that location.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutClassificationExportConfigurationRequest == false)
            return false;
    ...
    public PutClassificationExportConfigurationRequest clone() {
        return (PutClassificationExportConfigurationRequest) super.clone();
    }
