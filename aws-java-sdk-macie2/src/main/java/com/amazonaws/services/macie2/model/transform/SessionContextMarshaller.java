...
public class SessionContextMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> SESSIONISSUER_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("sessionIssuer").build();
