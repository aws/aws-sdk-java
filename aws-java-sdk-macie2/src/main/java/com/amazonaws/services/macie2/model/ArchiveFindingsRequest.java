...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01T00:00:00Z/ArchiveFindings" target="_top">AWS
 *      API Documentation</a>
 */
...
public class ArchiveFindingsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array of strings that lists the unique identifiers for the findings to archive.
     */
    ...
    @Override
    public ArchiveFindingsRequest clone() {
        return (ArchiveFindingsRequest) super.clone();
    }
