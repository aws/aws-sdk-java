...
public class CreateAllowListResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAllowListResult == false)
            return false;
        CreateAllowListResult other = (CreateAllowListResult) obj;
    ...
    public CreateAllowListResult clone() {
        try {
            return (CreateAllowListResult) super.clone();
