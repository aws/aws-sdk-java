        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("approximateNumberOfObjectsToProcess", targetDepth)) {
                    context.nextToken();
                    statistics.setApproximateNumberOfObjectsToProcess(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("numberOfRuns", targetDepth)) {
                    context.nextToken();
                    statistics.setNumberOfRuns(context.getUnmarshaller(Double.class).unmarshall(context));
                }
