...
/**
 * DeleteCustomDataIdentifierResult JSON Unmarshaller
 */
...
public class DeleteCustomDataIdentifierResultJsonUnmarshaller implements Unmarshaller<DeleteCustomDataIdentifierResult, JsonUnmarshallerContext> {
    ...
    public DeleteCustomDataIdentifierResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCustomDataIdentifierResult deleteCustomDataIdentifierResult = new DeleteCustomDataIdentifierResult();
