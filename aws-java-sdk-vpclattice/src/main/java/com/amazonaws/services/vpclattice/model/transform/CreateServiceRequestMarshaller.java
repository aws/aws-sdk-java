...
public class CreateServiceRequestMarshaller {
    ...
    public void marshall(CreateServiceRequest createServiceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createServiceRequest.getAuthType(), AUTHTYPE_BINDING);
            protocolMarshaller.marshall(createServiceRequest.getCertificateArn(), CERTIFICATEARN_BINDING);
            protocolMarshaller.marshall(createServiceRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createServiceRequest.getCustomDomainName(), CUSTOMDOMAINNAME_BINDING);
