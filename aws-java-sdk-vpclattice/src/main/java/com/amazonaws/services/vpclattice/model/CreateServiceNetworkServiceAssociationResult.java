...
public class CreateServiceNetworkServiceAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateServiceNetworkServiceAssociationResult == false)
            return false;
        CreateServiceNetworkServiceAssociationResult other = (CreateServiceNetworkServiceAssociationResult) obj;
    ...
    public CreateServiceNetworkServiceAssociationResult clone() {
        try {
            return (CreateServiceNetworkServiceAssociationResult) super.clone();
