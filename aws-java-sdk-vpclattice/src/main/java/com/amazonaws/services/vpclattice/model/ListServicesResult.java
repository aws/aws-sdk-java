...
public class ListServicesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setItems(java.util.Collection<ServiceSummary> items) {
        ...
        this.items = new java.util.ArrayList<ServiceSummary>(items);
    }
    ...
    public ListServicesResult withItems(ServiceSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<ServiceSummary>(items.length));
        }
        for (ServiceSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListServicesResult withItems(java.util.Collection<ServiceSummary> items) {
        setItems(items);
        return this;
    }
