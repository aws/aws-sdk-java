...
/**
 * DeleteAccessLogSubscriptionResult JSON Unmarshaller
 */
...
public class DeleteAccessLogSubscriptionResultJsonUnmarshaller implements Unmarshaller<DeleteAccessLogSubscriptionResult, JsonUnmarshallerContext> {
    ...
    public DeleteAccessLogSubscriptionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAccessLogSubscriptionResult deleteAccessLogSubscriptionResult = new DeleteAccessLogSubscriptionResult();

        return deleteAccessLogSubscriptionResult;
    }
