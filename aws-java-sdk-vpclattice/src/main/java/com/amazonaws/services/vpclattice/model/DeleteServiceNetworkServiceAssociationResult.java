...
public class DeleteServiceNetworkServiceAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteServiceNetworkServiceAssociationResult == false)
            return false;
        DeleteServiceNetworkServiceAssociationResult other = (DeleteServiceNetworkServiceAssociationResult) obj;
    ...
    public DeleteServiceNetworkServiceAssociationResult clone() {
        try {
            return (DeleteServiceNetworkServiceAssociationResult) super.clone();
