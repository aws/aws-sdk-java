...
/**
 * RuleUpdateFailureMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RuleUpdateFailureMarshaller {
    ...
    private static final RuleUpdateFailureMarshaller instance = new RuleUpdateFailureMarshaller();

    public static RuleUpdateFailureMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RuleUpdateFailure ruleUpdateFailure, ProtocolMarshaller protocolMarshaller) {

        if (ruleUpdateFailure == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(ruleUpdateFailure.getFailureCode(), FAILURECODE_BINDING);
            protocolMarshaller.marshall(ruleUpdateFailure.getFailureMessage(), FAILUREMESSAGE_BINDING);
            protocolMarshaller.marshall(ruleUpdateFailure.getRuleIdentifier(), RULEIDENTIFIER_BINDING);
        } catch (Exception e) {
