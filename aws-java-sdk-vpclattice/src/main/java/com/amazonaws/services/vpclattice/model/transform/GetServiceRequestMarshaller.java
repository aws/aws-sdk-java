...
@SdkInternalApi
public class GetServiceRequestMarshaller {
    ...
    private static final GetServiceRequestMarshaller instance = new GetServiceRequestMarshaller();

    public static GetServiceRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetServiceRequest getServiceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getServiceRequest.getServiceIdentifier(), SERVICEIDENTIFIER_BINDING);
        } catch (Exception e) {
