...
/**
 * DeleteAuthPolicyResult JSON Unmarshaller
 */
...
public class DeleteAuthPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteAuthPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteAuthPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAuthPolicyResult deleteAuthPolicyResult = new DeleteAuthPolicyResult();

        return deleteAuthPolicyResult;
    }
