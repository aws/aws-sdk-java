...
public class PutAuthPolicyRequestMarshaller {
    ...
    private static final PutAuthPolicyRequestMarshaller instance = new PutAuthPolicyRequestMarshaller();

    public static PutAuthPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutAuthPolicyRequest putAuthPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putAuthPolicyRequest.getPolicy(), POLICY_BINDING);
            protocolMarshaller.marshall(putAuthPolicyRequest.getResourceIdentifier(), RESOURCEIDENTIFIER_BINDING);
        } catch (Exception e) {
