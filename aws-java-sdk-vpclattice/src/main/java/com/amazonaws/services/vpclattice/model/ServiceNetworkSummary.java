 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/vpc-lattice-2022-11-30/ServiceNetworkSummary" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ServiceNetworkSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public ServiceNetworkSummary withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The date and time that the service network was last updated, specified in ISO-8601 format.
     */
    ...
    public ServiceNetworkSummary withLastUpdatedAt(java.util.Date lastUpdatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ServiceNetworkSummary == false)
            return false;
    ...
    public ServiceNetworkSummary clone() {
        try {
            return (ServiceNetworkSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.vpclattice.model.transform.ServiceNetworkSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
