...
public class UpdateServiceNetworkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateServiceNetworkResult == false)
            return false;
        UpdateServiceNetworkResult other = (UpdateServiceNetworkResult) obj;
    ...
    public UpdateServiceNetworkResult clone() {
        try {
            return (UpdateServiceNetworkResult) super.clone();
