...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.vpclattice.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.vpclattice.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.vpclattice.model.ConflictException conflictException = new com.amazonaws.services.vpclattice.model.ConflictException(null);
