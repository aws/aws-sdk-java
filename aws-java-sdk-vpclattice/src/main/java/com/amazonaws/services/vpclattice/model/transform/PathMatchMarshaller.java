...
@SdkInternalApi
public class PathMatchMarshaller {
    ...
    private static final PathMatchMarshaller instance = new PathMatchMarshaller();

    public static PathMatchMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PathMatch pathMatch, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(pathMatch.getCaseSensitive(), CASESENSITIVE_BINDING);
            protocolMarshaller.marshall(pathMatch.getMatch(), MATCH_BINDING);
        } catch (Exception e) {
