...
/**
 * HttpMatch JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HttpMatchJsonUnmarshaller implements Unmarshaller<HttpMatch, JsonUnmarshallerContext> {

    public HttpMatch unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static HttpMatchJsonUnmarshaller instance;

    public static HttpMatchJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new HttpMatchJsonUnmarshaller();
        return instance;
    }
}
