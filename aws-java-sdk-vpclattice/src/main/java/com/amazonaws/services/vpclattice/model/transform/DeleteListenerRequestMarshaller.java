...
public class DeleteListenerRequestMarshaller {
    ...
    private static final DeleteListenerRequestMarshaller instance = new DeleteListenerRequestMarshaller();

    public static DeleteListenerRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DeleteListenerRequest deleteListenerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteListenerRequest.getListenerIdentifier(), LISTENERIDENTIFIER_BINDING);
            protocolMarshaller.marshall(deleteListenerRequest.getServiceIdentifier(), SERVICEIDENTIFIER_BINDING);
        } catch (Exception e) {
