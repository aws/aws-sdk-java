...
/**
 * ListMembersRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListMembersRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> ISOWNED_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("isOwned").build();
    private static final MarshallingInfo<Integer> MAXRESULTS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("maxResults").build();
    private static final MarshallingInfo<String> NEXTTOKEN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("nextToken").build();

    private static final ListMembersRequestMarshaller instance = new ListMembersRequestMarshaller();

    public static ListMembersRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(ListMembersRequest listMembersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listMembersRequest.getNetworkId(), NETWORKID_BINDING);
            protocolMarshaller.marshall(listMembersRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(listMembersRequest.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(listMembersRequest.getIsOwned(), ISOWNED_BINDING);
