...
/**
 * CreateMemberRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateMemberRequestMarshaller {
    ...
    private static final CreateMemberRequestMarshaller instance = new CreateMemberRequestMarshaller();

    public static CreateMemberRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateMemberRequest createMemberRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createMemberRequest.getClientRequestToken(), CLIENTREQUESTTOKEN_BINDING);
            protocolMarshaller.marshall(createMemberRequest.getInvitationId(), INVITATIONID_BINDING);
            protocolMarshaller.marshall(createMemberRequest.getNetworkId(), NETWORKID_BINDING);
            protocolMarshaller.marshall(createMemberRequest.getMemberConfiguration(), MEMBERCONFIGURATION_BINDING);
        } catch (Exception e) {
