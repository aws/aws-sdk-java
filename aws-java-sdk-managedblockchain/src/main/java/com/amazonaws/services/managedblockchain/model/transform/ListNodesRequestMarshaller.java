...
public class ListNodesRequestMarshaller {
    ...
    private static final MarshallingInfo<String> MEMBERID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("memberId").build();
    ...
    public void marshall(ListNodesRequest listNodesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listNodesRequest.getNetworkId(), NETWORKID_BINDING);
            protocolMarshaller.marshall(listNodesRequest.getMemberId(), MEMBERID_BINDING);
            protocolMarshaller.marshall(listNodesRequest.getStatus(), STATUS_BINDING);
