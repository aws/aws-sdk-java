...
/**
 * DeleteAccessorResult JSON Unmarshaller
 */
...
public class DeleteAccessorResultJsonUnmarshaller implements Unmarshaller<DeleteAccessorResult, JsonUnmarshallerContext> {
    ...
    public DeleteAccessorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAccessorResult deleteAccessorResult = new DeleteAccessorResult();

        return deleteAccessorResult;
    }
