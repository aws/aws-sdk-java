...
/**
 * VoteOnProposalResult JSON Unmarshaller
 */
...
public class VoteOnProposalResultJsonUnmarshaller implements Unmarshaller<VoteOnProposalResult, JsonUnmarshallerContext> {
    ...
    public VoteOnProposalResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        VoteOnProposalResult voteOnProposalResult = new VoteOnProposalResult();
