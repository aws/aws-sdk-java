...
public class DeleteMemberRequestMarshaller {
    ...
    public void marshall(DeleteMemberRequest deleteMemberRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteMemberRequest.getNetworkId(), NETWORKID_BINDING);
            protocolMarshaller.marshall(deleteMemberRequest.getMemberId(), MEMBERID_BINDING);
        } catch (Exception e) {
