...
public class GetNodeRequestProtocolMarshaller implements Marshaller<Request<GetNodeRequest>, GetNodeRequest> {
    ...
    public GetNodeRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<GetNodeRequest> marshall(GetNodeRequest getNodeRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<GetNodeRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING, getNodeRequest);

            protocolMarshaller.startMarshalling();
            GetNodeRequestMarshaller.getInstance().marshall(getNodeRequest, protocolMarshaller);
