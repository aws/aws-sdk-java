...
/**
 * Abstract implementation of {@code AWSSecurityTokenServiceAsync}. Convenient
 * method forms pass through to the corresponding overload that takes a request
 * object and an {@code AsyncHandler}, which throws an
 * {@code UnsupportedOperationException}.
 */
public class AbstractAWSSecurityTokenServiceAsync extends
        AbstractAWSSecurityTokenService implements AWSSecurityTokenServiceAsync {
