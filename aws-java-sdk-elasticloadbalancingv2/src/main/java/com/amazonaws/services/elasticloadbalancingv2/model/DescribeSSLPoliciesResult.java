 ...
 * </p>
 */
public class DescribeSSLPoliciesResult implements Serializable, Cloneable {
     ...
     * any). Use {@link #setSslPolicies(java.util.Collection)} or
     * {@link #withSslPolicies(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param sslPolicies
    ...
    public DescribeSSLPoliciesResult withSslPolicies(SslPolicy... sslPolicies) {
        if (this.sslPolicies == null) {
            setSslPolicies(new java.util.ArrayList<SslPolicy>(
                    sslPolicies.length));
        }
    ...
    public DescribeSSLPoliciesResult withSslPolicies(
            java.util.Collection<SslPolicy> sslPolicies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSslPolicies() == null ^ this.getSslPolicies() == null)
            return false;
        if (other.getSslPolicies() != null
                && other.getSslPolicies().equals(this.getSslPolicies()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getSslPolicies() == null) ? 0 : getSslPolicies().hashCode());
