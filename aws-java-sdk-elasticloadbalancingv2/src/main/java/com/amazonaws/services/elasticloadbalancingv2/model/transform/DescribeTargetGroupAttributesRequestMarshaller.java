...
public class DescribeTargetGroupAttributesRequestMarshaller
    ...
    public Request<DescribeTargetGroupAttributesRequest> marshall(
        ...
        Request<DescribeTargetGroupAttributesRequest> request = new DefaultRequest<DescribeTargetGroupAttributesRequest>(
        ...
        if (describeTargetGroupAttributesRequest.getTargetGroupArn() != null) {
            request.addParameter("TargetGroupArn", StringUtils
                    .fromString(describeTargetGroupAttributesRequest
                            .getTargetGroupArn()));
        }
