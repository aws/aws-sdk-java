 ...
 */
public class DescribeRulesResultStaxUnmarshaller implements
        Unmarshaller<DescribeRulesResult, StaxUnmarshallerContext> {

    public DescribeRulesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Rules/member", targetDepth)) {
                    describeRulesResult.withRules(RuleStaxUnmarshaller
