 ...
 */
public class CreateRuleResultStaxUnmarshaller implements
        Unmarshaller<CreateRuleResult, StaxUnmarshallerContext> {

    public CreateRuleResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Rules/member", targetDepth)) {
                    createRuleResult.withRules(RuleStaxUnmarshaller
