...
/**
 * MutualAuthenticationAttributes StAX Unmarshaller
 */
...
public class MutualAuthenticationAttributesStaxUnmarshaller implements Unmarshaller<MutualAuthenticationAttributes, StaxUnmarshallerContext> {
    ...
    public MutualAuthenticationAttributes unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Mode", targetDepth)) {
                    mutualAuthenticationAttributes.setMode(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("TrustStoreArn", targetDepth)) {
                    mutualAuthenticationAttributes.setTrustStoreArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
