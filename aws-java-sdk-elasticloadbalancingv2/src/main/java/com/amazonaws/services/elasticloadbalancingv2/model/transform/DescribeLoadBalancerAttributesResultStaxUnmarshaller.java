 ...
 */
public class DescribeLoadBalancerAttributesResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeLoadBalancerAttributesResult, StaxUnmarshallerContext> {

    public DescribeLoadBalancerAttributesResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Attributes/member", targetDepth)) {
                    describeLoadBalancerAttributesResult
                            .withAttributes(LoadBalancerAttributeStaxUnmarshaller
