 ...
 */
public class RemoveTagsResultStaxUnmarshaller implements
        Unmarshaller<RemoveTagsResult, StaxUnmarshallerContext> {

    public RemoveTagsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
