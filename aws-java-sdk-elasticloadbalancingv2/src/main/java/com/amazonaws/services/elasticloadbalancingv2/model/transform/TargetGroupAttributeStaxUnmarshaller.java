 ...
 */
public class TargetGroupAttributeStaxUnmarshaller implements
        Unmarshaller<TargetGroupAttribute, StaxUnmarshallerContext> {

    public TargetGroupAttribute unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Key", targetDepth)) {
                    targetGroupAttribute.setKey(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Value", targetDepth)) {
                    targetGroupAttribute.setValue(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
