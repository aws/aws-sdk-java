 ...
 */
public class DescribeTargetGroupsResultStaxUnmarshaller implements
        Unmarshaller<DescribeTargetGroupsResult, StaxUnmarshallerContext> {

    public DescribeTargetGroupsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("TargetGroups/member", targetDepth)) {
                    describeTargetGroupsResult
                            .withTargetGroups(TargetGroupStaxUnmarshaller
