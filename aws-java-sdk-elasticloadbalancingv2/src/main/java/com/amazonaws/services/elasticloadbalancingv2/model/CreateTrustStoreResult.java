...
public class CreateTrustStoreResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the trust store created.
     */
    ...
    public CreateTrustStoreResult withTrustStores(TrustStore... trustStores) {
    ...
    public CreateTrustStoreResult withTrustStores(java.util.Collection<TrustStore> trustStores) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTrustStoreResult == false)
            return false;
        CreateTrustStoreResult other = (CreateTrustStoreResult) obj;
    ...
    public CreateTrustStoreResult clone() {
        try {
            return (CreateTrustStoreResult) super.clone();
