 ...
 */
public class RulePriorityPairStaxUnmarshaller implements
        Unmarshaller<RulePriorityPair, StaxUnmarshallerContext> {

    public RulePriorityPair unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("RuleArn", targetDepth)) {
                    rulePriorityPair.setRuleArn(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Priority", targetDepth)) {
                    rulePriorityPair.setPriority(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
