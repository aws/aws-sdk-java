...
public class CreateListenerResultStaxUnmarshaller implements Unmarshaller<CreateListenerResult, StaxUnmarshallerContext> {

    public CreateListenerResult unmarshall(StaxUnmarshallerContext context) throws Exception {
