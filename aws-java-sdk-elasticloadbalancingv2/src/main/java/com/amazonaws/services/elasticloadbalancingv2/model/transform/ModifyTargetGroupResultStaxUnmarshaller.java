 ...
 */
public class ModifyTargetGroupResultStaxUnmarshaller implements
        Unmarshaller<ModifyTargetGroupResult, StaxUnmarshallerContext> {

    public ModifyTargetGroupResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
