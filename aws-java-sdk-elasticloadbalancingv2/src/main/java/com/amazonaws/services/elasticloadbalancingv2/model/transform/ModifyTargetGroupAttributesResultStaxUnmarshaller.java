 ...
 */
public class ModifyTargetGroupAttributesResultStaxUnmarshaller
        implements
        Unmarshaller<ModifyTargetGroupAttributesResult, StaxUnmarshallerContext> {

    public ModifyTargetGroupAttributesResult unmarshall(
