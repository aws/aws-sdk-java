 ...
 */
public class DescribeListenersResultStaxUnmarshaller implements
        Unmarshaller<DescribeListenersResult, StaxUnmarshallerContext> {

    public DescribeListenersResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
