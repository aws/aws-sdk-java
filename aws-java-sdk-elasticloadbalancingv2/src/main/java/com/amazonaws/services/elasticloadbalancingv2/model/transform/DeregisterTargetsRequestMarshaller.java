...
public class DeregisterTargetsRequestMarshaller implements
        Marshaller<Request<DeregisterTargetsRequest>, DeregisterTargetsRequest> {

    public Request<DeregisterTargetsRequest> marshall(
        ...
        Request<DeregisterTargetsRequest> request = new DefaultRequest<DeregisterTargetsRequest>(
                deregisterTargetsRequest, "AmazonElasticLoadBalancing");
        ...
        if (deregisterTargetsRequest.getTargetGroupArn() != null) {
            request.addParameter("TargetGroupArn", StringUtils
                    .fromString(deregisterTargetsRequest.getTargetGroupArn()));
        }

        java.util.List<TargetDescription> targetsList = deregisterTargetsRequest
                .getTargets();
