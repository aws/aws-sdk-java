 ...
 */
public class RuleConditionStaxUnmarshaller implements
        Unmarshaller<RuleCondition, StaxUnmarshallerContext> {

    public RuleCondition unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Field", targetDepth)) {
                    ruleCondition.setField(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }

                if (context.testExpression("Values/member", targetDepth)) {
                    ruleCondition.withValues(StringStaxUnmarshaller
