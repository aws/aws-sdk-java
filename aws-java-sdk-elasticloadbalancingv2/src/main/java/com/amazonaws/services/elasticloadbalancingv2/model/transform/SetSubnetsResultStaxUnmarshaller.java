 ...
 */
public class SetSubnetsResultStaxUnmarshaller implements
        Unmarshaller<SetSubnetsResult, StaxUnmarshallerContext> {

    public SetSubnetsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
