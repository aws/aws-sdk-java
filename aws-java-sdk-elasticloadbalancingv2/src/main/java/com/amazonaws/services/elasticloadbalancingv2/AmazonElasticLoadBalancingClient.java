...
public class AmazonElasticLoadBalancingClient extends AmazonWebServiceClient
    ...
    public CreateRuleResult createRule(CreateRuleRequest createRuleRequest) {
        ...
        try {
            ...
            StaxResponseHandler<CreateRuleResult> responseHandler = new StaxResponseHandler<CreateRuleResult>(
    ...
    public ModifyRuleResult modifyRule(ModifyRuleRequest modifyRuleRequest) {
        ...
        try {
            ...
            StaxResponseHandler<ModifyRuleResult> responseHandler = new StaxResponseHandler<ModifyRuleResult>(
    ...
    public SetSubnetsResult setSubnets(SetSubnetsRequest setSubnetsRequest) {
        ...
        try {
            ...
            StaxResponseHandler<SetSubnetsResult> responseHandler = new StaxResponseHandler<SetSubnetsResult>(
