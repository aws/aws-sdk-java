 ...
 */
public class DeleteRuleResultStaxUnmarshaller implements
        Unmarshaller<DeleteRuleResult, StaxUnmarshallerContext> {

    public DeleteRuleResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
