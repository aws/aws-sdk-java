...
public interface AmazonElasticLoadBalancing {
     ...
     * with a listener, you can delete it using <a>DeleteListener</a>. If you
     * are finished with both the listener and the load balancer, you can delete
     * them both using <a>DeleteLoadBalancer</a>.
     * </p>
     * <p>
     * For more information, see <a href=
     * "http://docs.aws.amazon.com/elasticloadbalancing/latest/application/load-balancer-listeners.html"
     * >Listeners for Your Application Load Balancers</a> in the <i>Application
     ...
     * </p>
     * <p>
     * To create listeners for your load balancer, use <a>CreateListener</a>.
     * You can add security groups, subnets, and tags when you create your load
     * balancer, or you can add them later using <a>SetSecurityGroups</a>,
     ...
     * >Limits for Your Application Load Balancer</a> in the <i>Application Load
     * Balancers Guide</i>.
     * </p>
     * 
     ...
     * >Target Groups for Your Application Load Balancers</a> in the
     ...
     * it is attached to using <a>DeleteLoadBalancer</a>.
     * </p>
     * 
     ...
     * <a>DescribeTargetHealth</a>. To describe the attributes of a target
     * group, use <a>DescribeTargetGroupAttributes</a>.
     * </p>
     * 
