...
public class DeleteTrustStoreRequestMarshaller implements Marshaller<Request<DeleteTrustStoreRequest>, DeleteTrustStoreRequest> {
    ...
    public Request<DeleteTrustStoreRequest> marshall(DeleteTrustStoreRequest deleteTrustStoreRequest) {
        ...
        Request<DeleteTrustStoreRequest> request = new DefaultRequest<DeleteTrustStoreRequest>(deleteTrustStoreRequest, "AmazonElasticLoadBalancing");
        request.addParameter("Action", "DeleteTrustStore");
        request.addParameter("Version", "2015-12-01");
        request.setHttpMethod(HttpMethodName.POST);

        if (deleteTrustStoreRequest.getTrustStoreArn() != null) {
            request.addParameter("TrustStoreArn", StringUtils.fromString(deleteTrustStoreRequest.getTrustStoreArn()));
        }
