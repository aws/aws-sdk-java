 ...
 */
public class DescribeTargetGroupAttributesResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeTargetGroupAttributesResult, StaxUnmarshallerContext> {

    public DescribeTargetGroupAttributesResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Attributes/member", targetDepth)) {
                    describeTargetGroupAttributesResult
                            .withAttributes(TargetGroupAttributeStaxUnmarshaller
