 ...
 */
public class ModifyListenerResultStaxUnmarshaller implements
        Unmarshaller<ModifyListenerResult, StaxUnmarshallerContext> {

    public ModifyListenerResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Listeners/member", targetDepth)) {
                    modifyListenerResult.withListeners(ListenerStaxUnmarshaller
