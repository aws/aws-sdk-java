...
public class CreateListenerRequest extends AmazonWebServiceRequest implements
     ...
     * </p>
     * 
     * @return The SSL server certificate. You must provide exactly one
     *         certificate if the protocol is HTTPS.
     */
     ...
     * 
     * @param certificates
     *        The SSL server certificate. You must provide exactly one
     *        certificate if the protocol is HTTPS.
     */
    ...
    public CreateListenerRequest withCertificates(
    ...
    public CreateListenerRequest withDefaultActions(
