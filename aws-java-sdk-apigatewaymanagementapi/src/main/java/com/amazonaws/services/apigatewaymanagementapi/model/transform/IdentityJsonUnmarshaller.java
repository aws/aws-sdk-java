        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("sourceIp", targetDepth)) {
                    context.nextToken();
                    identity.setSourceIp(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("userAgent", targetDepth)) {
                    context.nextToken();
                    identity.setUserAgent(context.getUnmarshaller(String.class).unmarshall(context));
                }
