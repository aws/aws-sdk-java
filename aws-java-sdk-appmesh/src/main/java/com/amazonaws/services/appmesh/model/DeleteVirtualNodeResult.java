...
public class DeleteVirtualNodeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The virtual node that was deleted.
     */
    ...
    public DeleteVirtualNodeResult withVirtualNode(VirtualNodeData virtualNode) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVirtualNodeResult == false)
            return false;
        DeleteVirtualNodeResult other = (DeleteVirtualNodeResult) obj;
    ...
    @Override
    public DeleteVirtualNodeResult clone() {
        try {
