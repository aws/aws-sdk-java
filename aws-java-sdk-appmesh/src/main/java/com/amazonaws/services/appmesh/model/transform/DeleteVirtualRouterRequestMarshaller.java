...
/**
 * DeleteVirtualRouterRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteVirtualRouterRequestMarshaller {
    ...
    private static final DeleteVirtualRouterRequestMarshaller instance = new DeleteVirtualRouterRequestMarshaller();

    public static DeleteVirtualRouterRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DeleteVirtualRouterRequest deleteVirtualRouterRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteVirtualRouterRequest.getMeshName(), MESHNAME_BINDING);
            protocolMarshaller.marshall(deleteVirtualRouterRequest.getMeshOwner(), MESHOWNER_BINDING);
            protocolMarshaller.marshall(deleteVirtualRouterRequest.getVirtualRouterName(), VIRTUALROUTERNAME_BINDING);
        } catch (Exception e) {
