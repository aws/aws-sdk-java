...
/**
 * VirtualServiceStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VirtualServiceStatusJsonUnmarshaller implements Unmarshaller<VirtualServiceStatus, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("status", targetDepth)) {
                    context.nextToken();
                    virtualServiceStatus.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
