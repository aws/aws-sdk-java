...
/**
 * BackendDefaults JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BackendDefaultsJsonUnmarshaller implements Unmarshaller<BackendDefaults, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("clientPolicy", targetDepth)) {
                    context.nextToken();
                    backendDefaults.setClientPolicy(ClientPolicyJsonUnmarshaller.getInstance().unmarshall(context));
                }
