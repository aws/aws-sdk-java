...
public class ListVirtualRoutersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The maximum number of mesh results returned by <code>ListVirtualRouters</code> in paginated output. When this
     * parameter is used, <code>ListVirtualRouters</code> only returns <code>limit</code> results in a single page along
     * with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by
     * sending another <code>ListVirtualRouters</code> request with the returned <code>nextToken</code> value. This
     * value can be between 1 and 100. If this parameter is not used, then <code>ListVirtualRouters</code> returns up to
     ...
     * 
     * @param limit
     *        The maximum number of mesh results returned by <code>ListVirtualRouters</code> in paginated output. When
     *        this parameter is used, <code>ListVirtualRouters</code> only returns <code>limit</code> results in a
     *        single page along with a <code>nextToken</code> response element. The remaining results of the initial
     *        request can be seen by sending another <code>ListVirtualRouters</code> request with the returned
     ...
     * </p>
     * 
     * @return The maximum number of mesh results returned by <code>ListVirtualRouters</code> in paginated output. When
     *         this parameter is used, <code>ListVirtualRouters</code> only returns <code>limit</code> results in a
     *         single page along with a <code>nextToken</code> response element. The remaining results of the initial
     *         request can be seen by sending another <code>ListVirtualRouters</code> request with the returned
     *         <code>nextToken</code> value. This value can be between 1 and 100. If this parameter is not used, then
     ...
     * </p>
     * 
     * @return The name of the service mesh in which to list virtual routers.
     */
