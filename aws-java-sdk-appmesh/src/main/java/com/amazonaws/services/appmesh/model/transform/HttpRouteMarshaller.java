...
@SdkInternalApi
public class HttpRouteMarshaller {
    ...
    public static HttpRouteMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HttpRoute httpRoute, ProtocolMarshaller protocolMarshaller) {
