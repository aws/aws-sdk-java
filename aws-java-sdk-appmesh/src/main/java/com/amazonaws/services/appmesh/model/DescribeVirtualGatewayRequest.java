...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/DescribeVirtualGateway" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeVirtualGatewayRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeVirtualGatewayRequest withMeshName(String meshName) {
    ...
    public DescribeVirtualGatewayRequest withMeshOwner(String meshOwner) {
     ...
     * </p>
     * 
     * @return The name of the virtual gateway to describe.
     */
    ...
    public DescribeVirtualGatewayRequest withVirtualGatewayName(String virtualGatewayName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeVirtualGatewayRequest == false)
            return false;
        DescribeVirtualGatewayRequest other = (DescribeVirtualGatewayRequest) obj;
    ...
    @Override
    public DescribeVirtualGatewayRequest clone() {
        return (DescribeVirtualGatewayRequest) super.clone();
    }
