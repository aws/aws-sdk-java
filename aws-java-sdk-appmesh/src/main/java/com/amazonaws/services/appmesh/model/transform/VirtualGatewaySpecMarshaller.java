...
/**
 * VirtualGatewaySpecMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VirtualGatewaySpecMarshaller {
    ...
    private static final VirtualGatewaySpecMarshaller instance = new VirtualGatewaySpecMarshaller();

    public static VirtualGatewaySpecMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VirtualGatewaySpec virtualGatewaySpec, ProtocolMarshaller protocolMarshaller) {

        if (virtualGatewaySpec == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(virtualGatewaySpec.getBackendDefaults(), BACKENDDEFAULTS_BINDING);
            protocolMarshaller.marshall(virtualGatewaySpec.getListeners(), LISTENERS_BINDING);
            protocolMarshaller.marshall(virtualGatewaySpec.getLogging(), LOGGING_BINDING);
        } catch (Exception e) {
