...
/**
 * GrpcGatewayRouteMatchMarshaller
 */
...
public class GrpcGatewayRouteMatchMarshaller {
    ...
    private static final GrpcGatewayRouteMatchMarshaller instance = new GrpcGatewayRouteMatchMarshaller();

    public static GrpcGatewayRouteMatchMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GrpcGatewayRouteMatch grpcGatewayRouteMatch, ProtocolMarshaller protocolMarshaller) {

        if (grpcGatewayRouteMatch == null) {
