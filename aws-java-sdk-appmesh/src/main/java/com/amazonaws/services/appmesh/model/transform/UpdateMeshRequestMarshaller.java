...
/**
 * UpdateMeshRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateMeshRequestMarshaller {
    ...
    private static final UpdateMeshRequestMarshaller instance = new UpdateMeshRequestMarshaller();

    public static UpdateMeshRequestMarshaller getInstance() {
        return instance;
    }
