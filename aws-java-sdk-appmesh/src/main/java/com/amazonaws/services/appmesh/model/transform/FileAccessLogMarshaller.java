...
public class FileAccessLogMarshaller {
    ...
    private static final FileAccessLogMarshaller instance = new FileAccessLogMarshaller();

    public static FileAccessLogMarshaller getInstance() {
        return instance;
    }
