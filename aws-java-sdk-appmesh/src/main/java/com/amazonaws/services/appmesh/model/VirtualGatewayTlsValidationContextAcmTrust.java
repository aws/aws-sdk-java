 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/VirtualGatewayTlsValidationContextAcmTrust"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VirtualGatewayTlsValidationContextAcmTrust implements Serializable, Cloneable, StructuredPojo {
    ...
    public VirtualGatewayTlsValidationContextAcmTrust withCertificateAuthorityArns(java.util.Collection<String> certificateAuthorityArns) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VirtualGatewayTlsValidationContextAcmTrust == false)
            return false;
        VirtualGatewayTlsValidationContextAcmTrust other = (VirtualGatewayTlsValidationContextAcmTrust) obj;
    ...
    @Override
    public VirtualGatewayTlsValidationContextAcmTrust clone() {
        try {
            return (VirtualGatewayTlsValidationContextAcmTrust) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.VirtualGatewayTlsValidationContextAcmTrustMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
