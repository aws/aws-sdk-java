...
/**
 * GatewayRouteRefMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GatewayRouteRefMarshaller {
    ...
    private static final GatewayRouteRefMarshaller instance = new GatewayRouteRefMarshaller();

    public static GatewayRouteRefMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GatewayRouteRef gatewayRouteRef, ProtocolMarshaller protocolMarshaller) {

        if (gatewayRouteRef == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(gatewayRouteRef.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(gatewayRouteRef.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(gatewayRouteRef.getGatewayRouteName(), GATEWAYROUTENAME_BINDING);
            protocolMarshaller.marshall(gatewayRouteRef.getLastUpdatedAt(), LASTUPDATEDAT_BINDING);
            protocolMarshaller.marshall(gatewayRouteRef.getMeshName(), MESHNAME_BINDING);
            protocolMarshaller.marshall(gatewayRouteRef.getMeshOwner(), MESHOWNER_BINDING);
            protocolMarshaller.marshall(gatewayRouteRef.getResourceOwner(), RESOURCEOWNER_BINDING);
            protocolMarshaller.marshall(gatewayRouteRef.getVersion(), VERSION_BINDING);
            protocolMarshaller.marshall(gatewayRouteRef.getVirtualGatewayName(), VIRTUALGATEWAYNAME_BINDING);
        } catch (Exception e) {
