...
/**
 * RouteStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RouteStatusJsonUnmarshaller implements Unmarshaller<RouteStatus, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("status", targetDepth)) {
                    context.nextToken();
                    routeStatus.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
