 ...
 * proxy must be configured with a local SDS provider via a Unix Domain Socket. See App Mesh <a
 * href="https://docs.aws.amazon.com/app-mesh/latest/userguide/tls.html">TLS documentation</a> for more info.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/TlsValidationContextSdsTrust"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TlsValidationContextSdsTrust implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return A reference to an object that represents the name of the secret for a Transport Layer Security (TLS)
     *         Secret Discovery Service validation context trust.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TlsValidationContextSdsTrust == false)
            return false;
        TlsValidationContextSdsTrust other = (TlsValidationContextSdsTrust) obj;
    ...
    @Override
    public TlsValidationContextSdsTrust clone() {
        try {
            return (TlsValidationContextSdsTrust) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.TlsValidationContextSdsTrustMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
