 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/VirtualGatewayLogging" target="_top">AWS API
 *      Documentation</a>
 */
...
public class VirtualGatewayLogging implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setAccessLog(VirtualGatewayAccessLog accessLog) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VirtualGatewayLogging == false)
            return false;
    ...
    @Override
    public VirtualGatewayLogging clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.VirtualGatewayLoggingMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
