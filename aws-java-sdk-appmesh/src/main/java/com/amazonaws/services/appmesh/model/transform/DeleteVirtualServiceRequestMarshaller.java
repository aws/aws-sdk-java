...
/**
 * DeleteVirtualServiceRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteVirtualServiceRequestMarshaller {
    ...
    private static final DeleteVirtualServiceRequestMarshaller instance = new DeleteVirtualServiceRequestMarshaller();

    public static DeleteVirtualServiceRequestMarshaller getInstance() {
        return instance;
    }
