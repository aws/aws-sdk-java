...
public class UpdateVirtualGatewayResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateVirtualGatewayResult == false)
            return false;
        UpdateVirtualGatewayResult other = (UpdateVirtualGatewayResult) obj;
    ...
    @Override
    public UpdateVirtualGatewayResult clone() {
        try {
            return (UpdateVirtualGatewayResult) super.clone();
