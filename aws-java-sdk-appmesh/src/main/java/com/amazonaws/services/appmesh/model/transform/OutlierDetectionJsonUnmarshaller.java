...
/**
 * OutlierDetection JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OutlierDetectionJsonUnmarshaller implements Unmarshaller<OutlierDetection, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("maxEjectionPercent", targetDepth)) {
                    context.nextToken();
                    outlierDetection.setMaxEjectionPercent(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("maxServerErrors", targetDepth)) {
                    context.nextToken();
                    outlierDetection.setMaxServerErrors(context.getUnmarshaller(Long.class).unmarshall(context));
                }
