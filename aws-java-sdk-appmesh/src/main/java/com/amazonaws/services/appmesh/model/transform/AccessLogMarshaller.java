...
@SdkInternalApi
public class AccessLogMarshaller {
    ...
    private static final AccessLogMarshaller instance = new AccessLogMarshaller();

    public static AccessLogMarshaller getInstance() {
        return instance;
    }
