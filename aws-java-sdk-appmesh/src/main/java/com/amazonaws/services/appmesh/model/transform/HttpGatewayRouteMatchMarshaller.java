...
/**
 * HttpGatewayRouteMatchMarshaller
 */
...
public class HttpGatewayRouteMatchMarshaller {
    ...
    public static HttpGatewayRouteMatchMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HttpGatewayRouteMatch httpGatewayRouteMatch, ProtocolMarshaller protocolMarshaller) {

        if (httpGatewayRouteMatch == null) {
        ...
        try {
            ...
            protocolMarshaller.marshall(httpGatewayRouteMatch.getPort(), PORT_BINDING);
