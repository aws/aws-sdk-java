...
/**
 * DescribeRouteRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeRouteRequestMarshaller {
    ...
    private static final DescribeRouteRequestMarshaller instance = new DescribeRouteRequestMarshaller();

    public static DescribeRouteRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeRouteRequest describeRouteRequest, ProtocolMarshaller protocolMarshaller) {

        if (describeRouteRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(describeRouteRequest.getMeshName(), MESHNAME_BINDING);
            protocolMarshaller.marshall(describeRouteRequest.getMeshOwner(), MESHOWNER_BINDING);
            protocolMarshaller.marshall(describeRouteRequest.getRouteName(), ROUTENAME_BINDING);
            protocolMarshaller.marshall(describeRouteRequest.getVirtualRouterName(), VIRTUALROUTERNAME_BINDING);
        } catch (Exception e) {
