...
public class NotificationConfigJsonUnmarshaller implements Unmarshaller<NotificationConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NotificationEvents", targetDepth)) {
                    context.nextToken();
                    notificationConfig.setNotificationEvents(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
    ...
    private static NotificationConfigJsonUnmarshaller instance;

    public static NotificationConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new NotificationConfigJsonUnmarshaller();
        return instance;
    }
}
