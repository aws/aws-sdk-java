...
public class IncompatiblePolicyException extends com.amazonaws.services.simplesystemsmanagement.model.AWSSimpleSystemsManagementException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new IncompatiblePolicyException with the specified error message.
     *
     * @param message
