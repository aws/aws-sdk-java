 ...
 * Organizations to a centralized Amazon S3 bucket. Data is synchronized to individual key prefixes in the central
 * bucket. Each key prefix represents a different Amazon Web Services account ID.
 * </p>
 * 
