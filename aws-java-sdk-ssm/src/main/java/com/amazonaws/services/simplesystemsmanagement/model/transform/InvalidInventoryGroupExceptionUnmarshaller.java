...
public class InvalidInventoryGroupExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidInventoryGroupExceptionUnmarshaller instance;

    public static InvalidInventoryGroupExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidInventoryGroupExceptionUnmarshaller();
        return instance;
    }
}
