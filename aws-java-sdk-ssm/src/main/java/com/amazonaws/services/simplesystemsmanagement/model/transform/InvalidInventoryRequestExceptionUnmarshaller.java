...
public class InvalidInventoryRequestExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidInventoryRequestExceptionUnmarshaller instance;

    public static InvalidInventoryRequestExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidInventoryRequestExceptionUnmarshaller();
        return instance;
    }
}
