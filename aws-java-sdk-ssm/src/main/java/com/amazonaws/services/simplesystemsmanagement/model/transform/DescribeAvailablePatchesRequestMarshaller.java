 ...
 */
public class DescribeAvailablePatchesRequestMarshaller implements Marshaller<Request<DescribeAvailablePatchesRequest>, DescribeAvailablePatchesRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public DescribeAvailablePatchesRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<DescribeAvailablePatchesRequest> marshall(DescribeAvailablePatchesRequest describeAvailablePatchesRequest) {
        ...
        Request<DescribeAvailablePatchesRequest> request = new DefaultRequest<DescribeAvailablePatchesRequest>(describeAvailablePatchesRequest,
        ...
        try {
            ...
            com.amazonaws.internal.SdkInternalList<PatchOrchestratorFilter> filtersList = (com.amazonaws.internal.SdkInternalList<PatchOrchestratorFilter>) describeAvailablePatchesRequest
                    .getFilters();
