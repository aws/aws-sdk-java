...
public class DeregisterManagedInstanceRequestMarshaller
    ...
    public DeregisterManagedInstanceRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeregisterManagedInstanceRequest> marshall(
        ...
        Request<DeregisterManagedInstanceRequest> request = new DefaultRequest<DeregisterManagedInstanceRequest>(
                deregisterManagedInstanceRequest, "AWSSimpleSystemsManagement");
        ...
        try {
            ...
            if (deregisterManagedInstanceRequest.getInstanceId() != null) {
                jsonGenerator.writeFieldName("InstanceId").writeValue(
                        deregisterManagedInstanceRequest.getInstanceId());
            }
