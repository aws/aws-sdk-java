 ...
 */
public class DeleteActivationResultJsonUnmarshaller implements
        Unmarshaller<DeleteActivationResult, JsonUnmarshallerContext> {

    public DeleteActivationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
