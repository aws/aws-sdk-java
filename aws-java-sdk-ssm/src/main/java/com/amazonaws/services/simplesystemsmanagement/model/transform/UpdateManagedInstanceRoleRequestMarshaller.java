...
public class UpdateManagedInstanceRoleRequestMarshaller
    ...
    public UpdateManagedInstanceRoleRequestMarshaller(
    ...
    public Request<UpdateManagedInstanceRoleRequest> marshall(
        ...
        Request<UpdateManagedInstanceRoleRequest> request = new DefaultRequest<UpdateManagedInstanceRoleRequest>(
                updateManagedInstanceRoleRequest, "AWSSimpleSystemsManagement");
