...
/**
 * UpdateAssociationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateAssociationResultJsonUnmarshaller implements Unmarshaller<UpdateAssociationResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AssociationDescription", targetDepth)) {
                    context.nextToken();
                    updateAssociationResult.setAssociationDescription(AssociationDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
