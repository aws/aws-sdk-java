...
public class SubTypeCountLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SubTypeCountLimitExceededExceptionUnmarshaller instance;

    public static SubTypeCountLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SubTypeCountLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
