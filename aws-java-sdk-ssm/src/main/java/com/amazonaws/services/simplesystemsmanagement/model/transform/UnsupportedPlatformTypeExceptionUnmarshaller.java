...
public class UnsupportedPlatformTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.UnsupportedPlatformTypeException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return unsupportedPlatformTypeException;
    }

    private static UnsupportedPlatformTypeExceptionUnmarshaller instance;

    public static UnsupportedPlatformTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedPlatformTypeExceptionUnmarshaller();
        return instance;
    }
}
