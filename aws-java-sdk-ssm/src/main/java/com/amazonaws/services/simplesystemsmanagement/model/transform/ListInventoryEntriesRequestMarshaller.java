...
public class ListInventoryEntriesRequestMarshaller implements Marshaller<Request<ListInventoryEntriesRequest>, ListInventoryEntriesRequest> {
    ...
    public Request<ListInventoryEntriesRequest> marshall(ListInventoryEntriesRequest listInventoryEntriesRequest) {
        ...
        Request<ListInventoryEntriesRequest> request = new DefaultRequest<ListInventoryEntriesRequest>(listInventoryEntriesRequest,
        ...
        try {
            ...
            com.amazonaws.internal.SdkInternalList<InventoryFilter> filtersList = (com.amazonaws.internal.SdkInternalList<InventoryFilter>) listInventoryEntriesRequest
                    .getFilters();
