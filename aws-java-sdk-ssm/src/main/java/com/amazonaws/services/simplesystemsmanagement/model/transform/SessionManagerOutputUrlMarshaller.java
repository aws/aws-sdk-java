...
/**
 * SessionManagerOutputUrlMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SessionManagerOutputUrlMarshaller {

    private static final MarshallingInfo<String> S3OUTPUTURL_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("S3OutputUrl").build();
    private static final MarshallingInfo<String> CLOUDWATCHOUTPUTURL_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CloudWatchOutputUrl").build();
