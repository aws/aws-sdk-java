...
/**
 * Describe Document Result JSON Unmarshaller
 */
public class DescribeDocumentResultJsonUnmarshaller implements Unmarshaller<DescribeDocumentResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Document", targetDepth)) {
                    context.nextToken();
                    describeDocumentResult.setDocument(DocumentDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DescribeDocumentResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeDocumentResultJsonUnmarshaller();
        return instance;
    }
}
