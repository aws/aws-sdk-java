...
public class AssociationDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.AssociationDoesNotExistException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return associationDoesNotExistException;
    }

    private static AssociationDoesNotExistExceptionUnmarshaller instance;

    public static AssociationDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssociationDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
