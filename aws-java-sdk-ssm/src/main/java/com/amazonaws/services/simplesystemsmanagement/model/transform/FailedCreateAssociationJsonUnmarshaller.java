...
/**
 * Failed Create Association JSON Unmarshaller
 */
public class FailedCreateAssociationJsonUnmarshaller implements Unmarshaller<FailedCreateAssociation, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    failedCreateAssociation.setMessage(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Fault", targetDepth)) {
                    context.nextToken();
                    failedCreateAssociation.setFault(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static FailedCreateAssociationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new FailedCreateAssociationJsonUnmarshaller();
        return instance;
    }
}
