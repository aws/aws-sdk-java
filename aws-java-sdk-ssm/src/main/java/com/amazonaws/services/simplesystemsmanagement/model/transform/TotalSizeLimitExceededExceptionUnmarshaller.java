...
public class TotalSizeLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TotalSizeLimitExceededExceptionUnmarshaller instance;

    public static TotalSizeLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TotalSizeLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
