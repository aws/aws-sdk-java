...
/**
 * StepExecutionFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StepExecutionFilterMarshaller {
    ...
    private static final StepExecutionFilterMarshaller instance = new StepExecutionFilterMarshaller();

    public static StepExecutionFilterMarshaller getInstance() {
        return instance;
    }
