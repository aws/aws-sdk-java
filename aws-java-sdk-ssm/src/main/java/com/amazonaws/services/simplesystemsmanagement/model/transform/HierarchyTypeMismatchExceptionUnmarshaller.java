...
public class HierarchyTypeMismatchExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static HierarchyTypeMismatchExceptionUnmarshaller instance;

    public static HierarchyTypeMismatchExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new HierarchyTypeMismatchExceptionUnmarshaller();
        return instance;
    }
}
