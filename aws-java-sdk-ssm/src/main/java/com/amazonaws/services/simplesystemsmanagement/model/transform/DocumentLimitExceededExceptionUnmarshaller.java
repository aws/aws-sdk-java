...
public class DocumentLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.DocumentLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return documentLimitExceededException;
    }

    private static DocumentLimitExceededExceptionUnmarshaller instance;

    public static DocumentLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DocumentLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
