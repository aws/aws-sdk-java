...
public class InstanceInformationFilterJsonMarshaller {
     ...
     */
    public void marshall(InstanceInformationFilter instanceInformationFilter, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (instanceInformationFilter.getKey() != null) {
                jsonGenerator.writeFieldName("key").writeValue(instanceInformationFilter.getKey());
            }
