...
public class InvalidOutputLocationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidOutputLocationException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidOutputLocationException;
    }

    private static InvalidOutputLocationExceptionUnmarshaller instance;

    public static InvalidOutputLocationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidOutputLocationExceptionUnmarshaller();
        return instance;
    }
}
