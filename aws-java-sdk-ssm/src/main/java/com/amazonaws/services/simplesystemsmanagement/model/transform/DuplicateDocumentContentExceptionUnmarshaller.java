...
public class DuplicateDocumentContentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.DuplicateDocumentContentException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return duplicateDocumentContentException;
    }

    private static DuplicateDocumentContentExceptionUnmarshaller instance;

    public static DuplicateDocumentContentExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicateDocumentContentExceptionUnmarshaller();
        return instance;
    }
}
