 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ssm-2014-11-06/OpsEntity" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpsEntity implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public OpsEntity clone() {
        try {
            return (OpsEntity) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.simplesystemsmanagement.model.transform.OpsEntityMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
