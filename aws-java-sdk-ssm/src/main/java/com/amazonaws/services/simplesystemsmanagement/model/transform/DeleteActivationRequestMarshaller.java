...
@SdkInternalApi
public class DeleteActivationRequestMarshaller {
    ...
    private static final DeleteActivationRequestMarshaller instance = new DeleteActivationRequestMarshaller();

    public static DeleteActivationRequestMarshaller getInstance() {
        return instance;
    }
