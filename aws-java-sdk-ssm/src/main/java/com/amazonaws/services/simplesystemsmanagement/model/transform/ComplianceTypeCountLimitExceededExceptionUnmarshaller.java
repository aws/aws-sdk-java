...
public class ComplianceTypeCountLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ComplianceTypeCountLimitExceededExceptionUnmarshaller instance;

    public static ComplianceTypeCountLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ComplianceTypeCountLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
