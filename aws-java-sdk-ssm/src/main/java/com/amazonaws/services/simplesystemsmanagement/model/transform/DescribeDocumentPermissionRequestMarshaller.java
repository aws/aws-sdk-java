...
public class DescribeDocumentPermissionRequestMarshaller
    ...
    public DescribeDocumentPermissionRequestMarshaller(
    ...
    public Request<DescribeDocumentPermissionRequest> marshall(
        ...
        Request<DescribeDocumentPermissionRequest> request = new DefaultRequest<DescribeDocumentPermissionRequest>(
                describeDocumentPermissionRequest, "AWSSimpleSystemsManagement");
