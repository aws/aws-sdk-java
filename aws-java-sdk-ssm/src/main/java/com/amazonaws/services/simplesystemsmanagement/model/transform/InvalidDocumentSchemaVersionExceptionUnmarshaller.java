...
public class InvalidDocumentSchemaVersionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidDocumentSchemaVersionException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidDocumentSchemaVersionException;
    }

    private static InvalidDocumentSchemaVersionExceptionUnmarshaller instance;

    public static InvalidDocumentSchemaVersionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDocumentSchemaVersionExceptionUnmarshaller();
        return instance;
    }
}
