...
public class PoliciesLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PoliciesLimitExceededExceptionUnmarshaller instance;

    public static PoliciesLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PoliciesLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
