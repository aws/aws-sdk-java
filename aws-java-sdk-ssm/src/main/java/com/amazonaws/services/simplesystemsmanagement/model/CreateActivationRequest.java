...
public class CreateActivationRequest extends
     ...
     * </p>
     * 
     * @return A user-defined description of the resource that you want to
     *         register with Amazon EC2.
     */
     ...
     *        the Amazon EC2 console or when you use the AWS command line tools
     *        to list EC2 resources.
     */
     ...
     * </p>
     * 
     * @return The name of the registered, managed instance as it will appear in
     *         the Amazon EC2 console or when you use the AWS command line tools
     *         to list EC2 resources.
     */
    ...
    public CreateActivationRequest withDefaultInstanceName(
     ...
     * </p>
     * 
     * @return The Amazon Identity and Access Management (IAM) role that you
     ...
     * </p>
     * 
     * @return Specify the maximum number of managed instances you want to
     *         register. The default value is 1 instance.
     */
    ...
    public CreateActivationRequest withRegistrationLimit(
     ...
     * </p>
     * 
     * @return The date by which this activation request should expire. The
     *         default value is 24 hours.
     */
    ...
    public CreateActivationRequest withExpirationDate(
