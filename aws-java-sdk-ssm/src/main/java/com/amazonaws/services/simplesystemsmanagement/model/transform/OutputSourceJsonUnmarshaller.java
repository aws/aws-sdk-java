        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("OutputSourceId", targetDepth)) {
                    context.nextToken();
                    outputSource.setOutputSourceId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("OutputSourceType", targetDepth)) {
                    context.nextToken();
                    outputSource.setOutputSourceType(context.getUnmarshaller(String.class).unmarshall(context));
                }
