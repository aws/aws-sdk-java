...
/**
 * GetDefaultPatchBaselineResult JSON Unmarshaller
 */
...
public class GetDefaultPatchBaselineResultJsonUnmarshaller implements Unmarshaller<GetDefaultPatchBaselineResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BaselineId", targetDepth)) {
                    context.nextToken();
                    getDefaultPatchBaselineResult.setBaselineId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("OperatingSystem", targetDepth)) {
                    context.nextToken();
                    getDefaultPatchBaselineResult.setOperatingSystem(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static GetDefaultPatchBaselineResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetDefaultPatchBaselineResultJsonUnmarshaller();
        return instance;
    }
}
