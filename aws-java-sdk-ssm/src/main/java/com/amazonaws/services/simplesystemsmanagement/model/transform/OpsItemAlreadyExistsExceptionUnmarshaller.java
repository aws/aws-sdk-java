...
public class OpsItemAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("OpsItemId", targetDepth)) {
                    context.nextToken();
                    opsItemAlreadyExistsException.setOpsItemId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static OpsItemAlreadyExistsExceptionUnmarshaller instance;

    public static OpsItemAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OpsItemAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
