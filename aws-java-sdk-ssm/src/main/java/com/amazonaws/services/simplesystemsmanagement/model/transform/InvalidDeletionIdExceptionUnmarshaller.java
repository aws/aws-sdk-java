...
public class InvalidDeletionIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDeletionIdExceptionUnmarshaller instance;

    public static InvalidDeletionIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDeletionIdExceptionUnmarshaller();
        return instance;
    }
}
