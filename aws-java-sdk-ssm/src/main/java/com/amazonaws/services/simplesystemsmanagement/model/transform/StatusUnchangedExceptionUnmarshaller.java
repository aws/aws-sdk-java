...
public class StatusUnchangedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.StatusUnchangedException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return statusUnchangedException;
    }

    private static StatusUnchangedExceptionUnmarshaller instance;

    public static StatusUnchangedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new StatusUnchangedExceptionUnmarshaller();
        return instance;
    }
}
