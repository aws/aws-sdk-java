...
public class DescribeActivationsResultJsonUnmarshaller implements
    ...
    public DescribeActivationsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ActivationList", targetDepth)) {
                    ...
                    describeActivationsResult
                            .setActivationList(new ListUnmarshaller<Activation>(
                                    ActivationJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeActivationsResult.setNextToken(context
