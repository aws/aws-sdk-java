        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PolicyId", targetDepth)) {
                    context.nextToken();
                    putResourcePolicyResult.setPolicyId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("PolicyHash", targetDepth)) {
                    context.nextToken();
                    putResourcePolicyResult.setPolicyHash(context.getUnmarshaller(String.class).unmarshall(context));
                }
