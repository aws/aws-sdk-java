...
public class DoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DoesNotExistExceptionUnmarshaller instance;

    public static DoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
