...
public class DescribePatchBaselinesRequestMarshaller implements Marshaller<Request<DescribePatchBaselinesRequest>, DescribePatchBaselinesRequest> {
    ...
    public DescribePatchBaselinesRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DescribePatchBaselinesRequest> marshall(DescribePatchBaselinesRequest describePatchBaselinesRequest) {
        ...
        Request<DescribePatchBaselinesRequest> request = new DefaultRequest<DescribePatchBaselinesRequest>(describePatchBaselinesRequest,
        ...
        try {
            ...
            com.amazonaws.internal.SdkInternalList<PatchOrchestratorFilter> filtersList = (com.amazonaws.internal.SdkInternalList<PatchOrchestratorFilter>) describePatchBaselinesRequest
                    .getFilters();
            ...
            if (describePatchBaselinesRequest.getMaxResults() != null) {
                jsonGenerator.writeFieldName("MaxResults").writeValue(describePatchBaselinesRequest.getMaxResults());
            }
