 ...
 */
public class UpdateManagedInstanceRoleResultJsonUnmarshaller implements
        Unmarshaller<UpdateManagedInstanceRoleResult, JsonUnmarshallerContext> {

    public UpdateManagedInstanceRoleResult unmarshall(
