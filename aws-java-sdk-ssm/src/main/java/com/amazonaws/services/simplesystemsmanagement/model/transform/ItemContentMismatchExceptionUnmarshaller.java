...
public class ItemContentMismatchExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TypeName", targetDepth)) {
                    context.nextToken();
                    itemContentMismatchException.setTypeName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ItemContentMismatchExceptionUnmarshaller instance;

    public static ItemContentMismatchExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ItemContentMismatchExceptionUnmarshaller();
        return instance;
    }
}
