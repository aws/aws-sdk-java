...
public class AssociationStatusMarshaller {
    ...
    public void marshall(AssociationStatus associationStatus, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(associationStatus.getDate(), DATE_BINDING);
            protocolMarshaller.marshall(associationStatus.getName(), NAME_BINDING);
            protocolMarshaller.marshall(associationStatus.getMessage(), MESSAGE_BINDING);
            protocolMarshaller.marshall(associationStatus.getAdditionalInfo(), ADDITIONALINFO_BINDING);
        } catch (Exception e) {
