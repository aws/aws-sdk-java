...
public class AssociatedInstancesExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("AssociatedInstances"));
        } else {
            return errorTypeFromHeader.equals("AssociatedInstances");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        AssociatedInstancesException e = (AssociatedInstancesException)super.unmarshall(json);
