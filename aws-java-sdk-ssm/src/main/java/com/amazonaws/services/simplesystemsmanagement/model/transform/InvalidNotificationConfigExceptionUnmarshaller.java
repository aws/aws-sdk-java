...
public class InvalidNotificationConfigExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidNotificationConfigException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidNotificationConfigException;
    }

    private static InvalidNotificationConfigExceptionUnmarshaller instance;

    public static InvalidNotificationConfigExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidNotificationConfigExceptionUnmarshaller();
        return instance;
    }
}
