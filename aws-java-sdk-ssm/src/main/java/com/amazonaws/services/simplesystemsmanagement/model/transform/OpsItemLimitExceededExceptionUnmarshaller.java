...
public class OpsItemLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Limit", targetDepth)) {
                    context.nextToken();
                    opsItemLimitExceededException.setLimit(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("LimitType", targetDepth)) {
                    context.nextToken();
                    opsItemLimitExceededException.setLimitType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static OpsItemLimitExceededExceptionUnmarshaller instance;

    public static OpsItemLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OpsItemLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
