...
public class InvalidPermissionTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidPermissionTypeException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidPermissionTypeException;
    }

    private static InvalidPermissionTypeExceptionUnmarshaller instance;

    public static InvalidPermissionTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidPermissionTypeExceptionUnmarshaller();
        return instance;
    }
}
