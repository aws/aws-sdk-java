...
public class UnsupportedInventoryItemContextExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TypeName", targetDepth)) {
                    context.nextToken();
                    unsupportedInventoryItemContextException.setTypeName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static UnsupportedInventoryItemContextExceptionUnmarshaller instance;

    public static UnsupportedInventoryItemContextExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedInventoryItemContextExceptionUnmarshaller();
        return instance;
    }
}
