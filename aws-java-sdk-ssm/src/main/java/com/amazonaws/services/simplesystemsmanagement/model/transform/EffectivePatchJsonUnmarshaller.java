...
public class EffectivePatchJsonUnmarshaller implements Unmarshaller<EffectivePatch, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Patch", targetDepth)) {
                    context.nextToken();
                    effectivePatch.setPatch(PatchJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("PatchStatus", targetDepth)) {
                    context.nextToken();
                    effectivePatch.setPatchStatus(PatchStatusJsonUnmarshaller.getInstance().unmarshall(context));
                }
