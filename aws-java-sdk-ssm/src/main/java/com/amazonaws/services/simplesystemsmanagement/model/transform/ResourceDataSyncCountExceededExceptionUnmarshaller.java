...
public class ResourceDataSyncCountExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceDataSyncCountExceededExceptionUnmarshaller instance;

    public static ResourceDataSyncCountExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceDataSyncCountExceededExceptionUnmarshaller();
        return instance;
    }
}
