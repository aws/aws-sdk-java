...
public class CreateActivationResultJsonUnmarshaller implements
    ...
    public CreateActivationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ActivationId", targetDepth)) {
                    context.nextToken();
                    createActivationResult.setActivationId(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ActivationCode", targetDepth)) {
                    context.nextToken();
                    createActivationResult.setActivationCode(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
