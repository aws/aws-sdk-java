...
/**
 * <p>
 * The document doesn't support the platform type of the given managed node IDs. For example, you sent an document for a
 * Windows managed node to a Linux node.
 * </p>
 */
