...
public class NonCompliantSummaryJsonUnmarshaller implements Unmarshaller<NonCompliantSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NonCompliantCount", targetDepth)) {
                    context.nextToken();
                    nonCompliantSummary.setNonCompliantCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("SeveritySummary", targetDepth)) {
                    context.nextToken();
                    nonCompliantSummary.setSeveritySummary(SeveritySummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
