...
public class InvalidCommandIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidCommandIdException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidCommandIdException;
    }

    private static InvalidCommandIdExceptionUnmarshaller instance;

    public static InvalidCommandIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidCommandIdExceptionUnmarshaller();
        return instance;
    }
}
