...
/**
 * CancelMaintenanceWindowExecutionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CancelMaintenanceWindowExecutionResultJsonUnmarshaller implements Unmarshaller<CancelMaintenanceWindowExecutionResult, JsonUnmarshallerContext> {

    public CancelMaintenanceWindowExecutionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("WindowExecutionId", targetDepth)) {
                    context.nextToken();
                    cancelMaintenanceWindowExecutionResult.setWindowExecutionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
