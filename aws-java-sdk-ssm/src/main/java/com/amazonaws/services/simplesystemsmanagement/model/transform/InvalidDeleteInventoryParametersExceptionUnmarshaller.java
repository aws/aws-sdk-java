...
public class InvalidDeleteInventoryParametersExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDeleteInventoryParametersExceptionUnmarshaller instance;

    public static InvalidDeleteInventoryParametersExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDeleteInventoryParametersExceptionUnmarshaller();
        return instance;
    }
}
