...
public class InvalidResourceIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidResourceIdException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidResourceIdException;
    }

    private static InvalidResourceIdExceptionUnmarshaller instance;

    public static InvalidResourceIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidResourceIdExceptionUnmarshaller();
        return instance;
    }
}
