...
public class DescribeMaintenanceWindowTargetsRequestMarshaller {
    ...
    private static final DescribeMaintenanceWindowTargetsRequestMarshaller instance = new DescribeMaintenanceWindowTargetsRequestMarshaller();

    public static DescribeMaintenanceWindowTargetsRequestMarshaller getInstance() {
        return instance;
    }
