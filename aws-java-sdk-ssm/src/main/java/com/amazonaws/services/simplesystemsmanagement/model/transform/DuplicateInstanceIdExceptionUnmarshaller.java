...
public class DuplicateInstanceIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.DuplicateInstanceIdException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return duplicateInstanceIdException;
    }

    private static DuplicateInstanceIdExceptionUnmarshaller instance;

    public static DuplicateInstanceIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicateInstanceIdExceptionUnmarshaller();
        return instance;
    }
}
