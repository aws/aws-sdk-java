...
/**
 * OpsItemEventSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpsItemEventSummaryJsonUnmarshaller implements Unmarshaller<OpsItemEventSummary, JsonUnmarshallerContext> {

    public OpsItemEventSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        OpsItemEventSummary opsItemEventSummary = new OpsItemEventSummary();
    ...
    private static OpsItemEventSummaryJsonUnmarshaller instance;

    public static OpsItemEventSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OpsItemEventSummaryJsonUnmarshaller();
        return instance;
    }
}
