 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ssm-2014-11-06/InstancePropertyFilter" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstancePropertyFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public InstancePropertyFilter withValueSet(String... valueSet) {
    ...
    public InstancePropertyFilter withValueSet(java.util.Collection<String> valueSet) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InstancePropertyFilter == false)
            return false;
    ...
    public InstancePropertyFilter clone() {
        try {
            return (InstancePropertyFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.simplesystemsmanagement.model.transform.InstancePropertyFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
