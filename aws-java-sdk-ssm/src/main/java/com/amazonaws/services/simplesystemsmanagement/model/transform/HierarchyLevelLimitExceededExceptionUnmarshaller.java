...
public class HierarchyLevelLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static HierarchyLevelLimitExceededExceptionUnmarshaller instance;

    public static HierarchyLevelLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new HierarchyLevelLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
