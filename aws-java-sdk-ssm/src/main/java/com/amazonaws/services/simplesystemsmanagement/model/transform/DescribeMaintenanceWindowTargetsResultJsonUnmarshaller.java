...
/**
 * DescribeMaintenanceWindowTargetsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeMaintenanceWindowTargetsResultJsonUnmarshaller implements Unmarshaller<DescribeMaintenanceWindowTargetsResult, JsonUnmarshallerContext> {

    public DescribeMaintenanceWindowTargetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeMaintenanceWindowTargetsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
