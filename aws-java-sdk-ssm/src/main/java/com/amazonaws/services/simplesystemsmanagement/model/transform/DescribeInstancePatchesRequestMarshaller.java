...
@SdkInternalApi
public class DescribeInstancePatchesRequestMarshaller {
    ...
    private static final DescribeInstancePatchesRequestMarshaller instance = new DescribeInstancePatchesRequestMarshaller();

    public static DescribeInstancePatchesRequestMarshaller getInstance() {
        return instance;
    }
