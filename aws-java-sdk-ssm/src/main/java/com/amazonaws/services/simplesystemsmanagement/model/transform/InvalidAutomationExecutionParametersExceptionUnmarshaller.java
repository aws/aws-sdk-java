...
public class InvalidAutomationExecutionParametersExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidAutomationExecutionParametersExceptionUnmarshaller instance;

    public static InvalidAutomationExecutionParametersExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidAutomationExecutionParametersExceptionUnmarshaller();
        return instance;
    }
}
