...
public class RemoveTagsFromResourceRequestMarshaller {
    ...
    public void marshall(RemoveTagsFromResourceRequest removeTagsFromResourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(removeTagsFromResourceRequest.getResourceType(), RESOURCETYPE_BINDING);
            protocolMarshaller.marshall(removeTagsFromResourceRequest.getResourceId(), RESOURCEID_BINDING);
            protocolMarshaller.marshall(removeTagsFromResourceRequest.getTagKeys(), TAGKEYS_BINDING);
        } catch (Exception e) {
