...
public class InvalidInstanceIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidInstanceIdException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidInstanceIdException;
    }

    private static InvalidInstanceIdExceptionUnmarshaller instance;

    public static InvalidInstanceIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidInstanceIdExceptionUnmarshaller();
        return instance;
    }
}
