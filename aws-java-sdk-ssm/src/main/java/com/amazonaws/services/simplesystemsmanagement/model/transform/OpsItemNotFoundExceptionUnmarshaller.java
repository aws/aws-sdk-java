...
public class OpsItemNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OpsItemNotFoundExceptionUnmarshaller instance;

    public static OpsItemNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OpsItemNotFoundExceptionUnmarshaller();
        return instance;
    }
}
