...
public class CreateActivationResult implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID number generated by the system when it processed the
     *         activation. The activation ID functions like a user name.
     */
     ...
     *        The activation code functions like a password to validate the
     *        activation ID.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getActivationId() != null
            ...
            return false;
        if (other.getActivationCode() == null
                ^ this.getActivationCode() == null)
            return false;
        if (other.getActivationCode() != null
                && other.getActivationCode().equals(this.getActivationCode()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getActivationCode() == null) ? 0 : getActivationCode()
                        .hashCode());
        return hashCode;
    }
