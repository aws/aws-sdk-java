...
public class UnsupportedParameterTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.UnsupportedParameterTypeException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return unsupportedParameterTypeException;
    }

    private static UnsupportedParameterTypeExceptionUnmarshaller instance;

    public static UnsupportedParameterTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedParameterTypeExceptionUnmarshaller();
        return instance;
    }
}
