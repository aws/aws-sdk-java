...
public class InvalidKeyIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidKeyIdExceptionUnmarshaller instance;

    public static InvalidKeyIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidKeyIdExceptionUnmarshaller();
        return instance;
    }
}
