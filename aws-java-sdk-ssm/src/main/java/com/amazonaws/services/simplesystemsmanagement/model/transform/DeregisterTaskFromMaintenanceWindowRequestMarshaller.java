...
@SdkInternalApi
public class DeregisterTaskFromMaintenanceWindowRequestMarshaller {
    ...
    private static final DeregisterTaskFromMaintenanceWindowRequestMarshaller instance = new DeregisterTaskFromMaintenanceWindowRequestMarshaller();

    public static DeregisterTaskFromMaintenanceWindowRequestMarshaller getInstance() {
        return instance;
    }
