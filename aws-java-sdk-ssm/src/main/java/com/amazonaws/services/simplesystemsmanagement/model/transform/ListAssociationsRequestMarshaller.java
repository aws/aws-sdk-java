...
public class ListAssociationsRequestMarshaller {
    ...
    private static final MarshallingInfo<List> ASSOCIATIONFILTERLIST_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AssociationFilterList").build();
