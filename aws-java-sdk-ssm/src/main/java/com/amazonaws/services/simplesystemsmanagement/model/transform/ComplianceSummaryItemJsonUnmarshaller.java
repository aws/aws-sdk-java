...
public class ComplianceSummaryItemJsonUnmarshaller implements Unmarshaller<ComplianceSummaryItem, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ComplianceType", targetDepth)) {
                    context.nextToken();
                    complianceSummaryItem.setComplianceType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("CompliantSummary", targetDepth)) {
                    context.nextToken();
                    complianceSummaryItem.setCompliantSummary(CompliantSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("NonCompliantSummary", targetDepth)) {
                    context.nextToken();
                    complianceSummaryItem.setNonCompliantSummary(NonCompliantSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ComplianceSummaryItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ComplianceSummaryItemJsonUnmarshaller();
        return instance;
    }
}
