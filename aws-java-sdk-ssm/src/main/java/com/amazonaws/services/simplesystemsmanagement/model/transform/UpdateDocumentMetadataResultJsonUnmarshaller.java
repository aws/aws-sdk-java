...
/**
 * UpdateDocumentMetadataResult JSON Unmarshaller
 */
...
public class UpdateDocumentMetadataResultJsonUnmarshaller implements Unmarshaller<UpdateDocumentMetadataResult, JsonUnmarshallerContext> {
    ...
    public UpdateDocumentMetadataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDocumentMetadataResult updateDocumentMetadataResult = new UpdateDocumentMetadataResult();
