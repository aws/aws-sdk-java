...
public class InvalidDocumentOperationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidDocumentOperationException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidDocumentOperationException;
    }

    private static InvalidDocumentOperationExceptionUnmarshaller instance;

    public static InvalidDocumentOperationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDocumentOperationExceptionUnmarshaller();
        return instance;
    }
}
