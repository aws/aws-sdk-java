...
/**
 * DescribeAvailablePatchesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeAvailablePatchesResultJsonUnmarshaller implements Unmarshaller<DescribeAvailablePatchesResult, JsonUnmarshallerContext> {

    public DescribeAvailablePatchesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeAvailablePatchesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
