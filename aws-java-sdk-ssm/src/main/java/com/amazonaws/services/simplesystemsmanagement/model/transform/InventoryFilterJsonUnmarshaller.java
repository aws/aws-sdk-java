...
public class InventoryFilterJsonUnmarshaller implements Unmarshaller<InventoryFilter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    inventoryFilter.setKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    inventoryFilter.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
