...
@SdkInternalApi
public class InstancePatchStateFilterMarshaller {
    ...
    private static final InstancePatchStateFilterMarshaller instance = new InstancePatchStateFilterMarshaller();

    public static InstancePatchStateFilterMarshaller getInstance() {
        return instance;
    }
