 ...
 */
public class CancelCommandRequestMarshaller implements Marshaller<Request<CancelCommandRequest>, CancelCommandRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public CancelCommandRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<CancelCommandRequest> marshall(CancelCommandRequest cancelCommandRequest) {
        ...
        Request<CancelCommandRequest> request = new DefaultRequest<CancelCommandRequest>(cancelCommandRequest, "AWSSimpleSystemsManagement");
        ...
        try {
            ...
            if (cancelCommandRequest.getCommandId() != null) {
                jsonGenerator.writeFieldName("CommandId").writeValue(cancelCommandRequest.getCommandId());
            }
