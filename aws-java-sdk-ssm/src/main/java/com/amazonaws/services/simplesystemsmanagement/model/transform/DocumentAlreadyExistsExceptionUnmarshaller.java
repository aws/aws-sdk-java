...
public class DocumentAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.DocumentAlreadyExistsException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return documentAlreadyExistsException;
    }

    private static DocumentAlreadyExistsExceptionUnmarshaller instance;

    public static DocumentAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DocumentAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
