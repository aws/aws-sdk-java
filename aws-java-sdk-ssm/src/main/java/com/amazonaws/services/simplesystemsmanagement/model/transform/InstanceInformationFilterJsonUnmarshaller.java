 ...
 */
public class InstanceInformationFilterJsonUnmarshaller implements
        Unmarshaller<InstanceInformationFilter, JsonUnmarshallerContext> {

    public InstanceInformationFilter unmarshall(JsonUnmarshallerContext context)
            throws Exception {
