...
public class ResourceDataSyncInvalidConfigurationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceDataSyncInvalidConfigurationExceptionUnmarshaller instance;

    public static ResourceDataSyncInvalidConfigurationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceDataSyncInvalidConfigurationExceptionUnmarshaller();
        return instance;
    }
}
