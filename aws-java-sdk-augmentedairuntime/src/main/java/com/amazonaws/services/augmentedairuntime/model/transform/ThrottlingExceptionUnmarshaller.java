...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.augmentedairuntime.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.augmentedairuntime.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.augmentedairuntime.model.ThrottlingException throttlingException = new com.amazonaws.services.augmentedairuntime.model.ThrottlingException(
                null);
