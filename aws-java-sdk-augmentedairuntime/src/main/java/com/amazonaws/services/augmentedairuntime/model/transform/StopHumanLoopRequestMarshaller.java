...
public class StopHumanLoopRequestMarshaller {
    ...
    private static final StopHumanLoopRequestMarshaller instance = new StopHumanLoopRequestMarshaller();

    public static StopHumanLoopRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StopHumanLoopRequest stopHumanLoopRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(stopHumanLoopRequest.getHumanLoopName(), HUMANLOOPNAME_BINDING);
        } catch (Exception e) {
