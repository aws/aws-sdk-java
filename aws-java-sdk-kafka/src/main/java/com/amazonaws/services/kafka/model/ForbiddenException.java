...
public class ForbiddenException extends com.amazonaws.services.kafka.model.AWSKafkaException {
    ...
    public ForbiddenException withInvalidParameter(String invalidParameter) {
