...
public class UpdateConfigurationRequestMarshaller {
    ...
    private static final UpdateConfigurationRequestMarshaller instance = new UpdateConfigurationRequestMarshaller();

    public static UpdateConfigurationRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(UpdateConfigurationRequest updateConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateConfigurationRequest.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(updateConfigurationRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateConfigurationRequest.getServerProperties(), SERVERPROPERTIES_BINDING);
        } catch (Exception e) {
