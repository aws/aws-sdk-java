...
public class UpdateClusterKafkaVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateClusterKafkaVersionResult == false)
            return false;
        UpdateClusterKafkaVersionResult other = (UpdateClusterKafkaVersionResult) obj;
    ...
    public UpdateClusterKafkaVersionResult clone() {
        try {
            return (UpdateClusterKafkaVersionResult) super.clone();
