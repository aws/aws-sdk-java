        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("errorCode", targetDepth)) {
                    context.nextToken();
                    errorInfo.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("errorString", targetDepth)) {
                    context.nextToken();
                    errorInfo.setErrorString(context.getUnmarshaller(String.class).unmarshall(context));
                }
