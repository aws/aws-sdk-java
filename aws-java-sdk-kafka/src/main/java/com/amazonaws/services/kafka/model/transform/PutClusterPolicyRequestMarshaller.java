...
@SdkInternalApi
public class PutClusterPolicyRequestMarshaller {
    ...
    private static final PutClusterPolicyRequestMarshaller instance = new PutClusterPolicyRequestMarshaller();

    public static PutClusterPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutClusterPolicyRequest putClusterPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putClusterPolicyRequest.getClusterArn(), CLUSTERARN_BINDING);
            protocolMarshaller.marshall(putClusterPolicyRequest.getCurrentVersion(), CURRENTVERSION_BINDING);
            protocolMarshaller.marshall(putClusterPolicyRequest.getPolicy(), POLICY_BINDING);
        } catch (Exception e) {
