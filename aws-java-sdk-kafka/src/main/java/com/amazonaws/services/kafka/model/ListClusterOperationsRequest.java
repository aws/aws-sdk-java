...
public class ListClusterOperationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListClusterOperationsRequest withClusterArn(String clusterArn) {
    ...
    public ListClusterOperationsRequest withMaxResults(Integer maxResults) {
    ...
    public ListClusterOperationsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListClusterOperationsRequest == false)
            return false;
        ListClusterOperationsRequest other = (ListClusterOperationsRequest) obj;
    ...
    public ListClusterOperationsRequest clone() {
        return (ListClusterOperationsRequest) super.clone();
    }
