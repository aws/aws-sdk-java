...
public class EBSStorageInfoMarshaller {
    ...
    private static final EBSStorageInfoMarshaller instance = new EBSStorageInfoMarshaller();

    public static EBSStorageInfoMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EBSStorageInfo eBSStorageInfo, ProtocolMarshaller protocolMarshaller) {

        if (eBSStorageInfo == null) {
