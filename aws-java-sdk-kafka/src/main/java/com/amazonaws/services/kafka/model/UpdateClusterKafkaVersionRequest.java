...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafka-2018-11-14/UpdateClusterKafkaVersion" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateClusterKafkaVersionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateClusterKafkaVersionRequest withTargetKafkaVersion(String targetKafkaVersion) {
        setTargetKafkaVersion(targetKafkaVersion);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getTargetKafkaVersion() != null)
            sb.append("TargetKafkaVersion: ").append(getTargetKafkaVersion());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTargetKafkaVersion() == null ^ this.getTargetKafkaVersion() == null)
            return false;
        if (other.getTargetKafkaVersion() != null && other.getTargetKafkaVersion().equals(this.getTargetKafkaVersion()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getTargetKafkaVersion() == null) ? 0 : getTargetKafkaVersion().hashCode());
        return hashCode;
    }

    @Override
    public UpdateClusterKafkaVersionRequest clone() {
        return (UpdateClusterKafkaVersionRequest) super.clone();
    }
