...
public class BatchDisassociateScramSecretRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public BatchDisassociateScramSecretRequest withSecretArnList(java.util.Collection<String> secretArnList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchDisassociateScramSecretRequest == false)
            return false;
    ...
    public BatchDisassociateScramSecretRequest clone() {
        return (BatchDisassociateScramSecretRequest) super.clone();
    }
