...
public class UpdateClusterConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateClusterConfigurationResult withClusterArn(String clusterArn) {
    ...
    public UpdateClusterConfigurationResult withClusterOperationArn(String clusterOperationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateClusterConfigurationResult == false)
            return false;
        UpdateClusterConfigurationResult other = (UpdateClusterConfigurationResult) obj;
    ...
    @Override
    public UpdateClusterConfigurationResult clone() {
        try {
            return (UpdateClusterConfigurationResult) super.clone();
