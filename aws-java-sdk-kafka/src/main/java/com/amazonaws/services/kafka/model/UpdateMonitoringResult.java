...
public class UpdateMonitoringResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateMonitoringResult withClusterArn(String clusterArn) {
    ...
    public UpdateMonitoringResult withClusterOperationArn(String clusterOperationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateMonitoringResult == false)
            return false;
        UpdateMonitoringResult other = (UpdateMonitoringResult) obj;
    ...
    @Override
    public UpdateMonitoringResult clone() {
        try {
            return (UpdateMonitoringResult) super.clone();
