...
/**
 * UnprocessedScramSecretMarshaller
 */
...
public class UnprocessedScramSecretMarshaller {
    ...
    public void marshall(UnprocessedScramSecret unprocessedScramSecret, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(unprocessedScramSecret.getErrorCode(), ERRORCODE_BINDING);
            protocolMarshaller.marshall(unprocessedScramSecret.getErrorMessage(), ERRORMESSAGE_BINDING);
            protocolMarshaller.marshall(unprocessedScramSecret.getSecretArn(), SECRETARN_BINDING);
        } catch (Exception e) {
