 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafka-2018-11-14/OpenMonitoringInfo" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpenMonitoringInfo implements Serializable, Cloneable, StructuredPojo {
    ...
    public OpenMonitoringInfo clone() {
        try {
            return (OpenMonitoringInfo) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafka.model.transform.OpenMonitoringInfoMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
