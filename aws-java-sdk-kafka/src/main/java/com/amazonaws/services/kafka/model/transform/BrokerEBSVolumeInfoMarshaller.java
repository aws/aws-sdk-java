...
/**
 * BrokerEBSVolumeInfoMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BrokerEBSVolumeInfoMarshaller {
    ...
    private static final BrokerEBSVolumeInfoMarshaller instance = new BrokerEBSVolumeInfoMarshaller();

    public static BrokerEBSVolumeInfoMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BrokerEBSVolumeInfo brokerEBSVolumeInfo, ProtocolMarshaller protocolMarshaller) {
