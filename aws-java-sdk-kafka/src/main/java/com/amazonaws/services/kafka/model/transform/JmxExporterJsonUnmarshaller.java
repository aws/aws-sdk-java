...
/**
 * JmxExporter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JmxExporterJsonUnmarshaller implements Unmarshaller<JmxExporter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("enabledInBroker", targetDepth)) {
                    context.nextToken();
                    jmxExporter.setEnabledInBroker(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
