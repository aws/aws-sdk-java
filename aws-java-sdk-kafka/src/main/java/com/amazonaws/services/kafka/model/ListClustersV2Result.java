...
public class ListClustersV2Result extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<Cluster> clusterInfoList;
    /**
     * <p>
    ...
    public java.util.List<Cluster> getClusterInfoList() {
    ...
    public void setClusterInfoList(java.util.Collection<Cluster> clusterInfoList) {
        if (clusterInfoList == null) {
            this.clusterInfoList = null;
            return;
        }

        this.clusterInfoList = new java.util.ArrayList<Cluster>(clusterInfoList);
    }
    ...
    public ListClustersV2Result withClusterInfoList(Cluster... clusterInfoList) {
        if (this.clusterInfoList == null) {
            setClusterInfoList(new java.util.ArrayList<Cluster>(clusterInfoList.length));
        }
        for (Cluster ele : clusterInfoList) {
    ...
    public ListClustersV2Result withClusterInfoList(java.util.Collection<Cluster> clusterInfoList) {
    ...
    public ListClustersV2Result withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListClustersV2Result == false)
            return false;
        ListClustersV2Result other = (ListClustersV2Result) obj;
    ...
    @Override
    public ListClustersV2Result clone() {
        try {
            return (ListClustersV2Result) super.clone();
