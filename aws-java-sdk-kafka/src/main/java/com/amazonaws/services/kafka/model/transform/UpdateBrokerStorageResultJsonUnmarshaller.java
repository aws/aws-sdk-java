...
/**
 * UpdateBrokerStorageResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateBrokerStorageResultJsonUnmarshaller implements Unmarshaller<UpdateBrokerStorageResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("clusterArn", targetDepth)) {
                    context.nextToken();
                    updateBrokerStorageResult.setClusterArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("clusterOperationArn", targetDepth)) {
                    context.nextToken();
                    updateBrokerStorageResult.setClusterOperationArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
