...
/**
 * ClusterOperationV2SummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ClusterOperationV2SummaryMarshaller {
    ...
    private static final ClusterOperationV2SummaryMarshaller instance = new ClusterOperationV2SummaryMarshaller();

    public static ClusterOperationV2SummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ClusterOperationV2Summary clusterOperationV2Summary, ProtocolMarshaller protocolMarshaller) {

        if (clusterOperationV2Summary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(clusterOperationV2Summary.getClusterArn(), CLUSTERARN_BINDING);
            protocolMarshaller.marshall(clusterOperationV2Summary.getClusterType(), CLUSTERTYPE_BINDING);
            protocolMarshaller.marshall(clusterOperationV2Summary.getStartTime(), STARTTIME_BINDING);
            protocolMarshaller.marshall(clusterOperationV2Summary.getEndTime(), ENDTIME_BINDING);
            protocolMarshaller.marshall(clusterOperationV2Summary.getOperationArn(), OPERATIONARN_BINDING);
            protocolMarshaller.marshall(clusterOperationV2Summary.getOperationState(), OPERATIONSTATE_BINDING);
            protocolMarshaller.marshall(clusterOperationV2Summary.getOperationType(), OPERATIONTYPE_BINDING);
        } catch (Exception e) {
