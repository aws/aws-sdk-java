...
/**
 * DeleteClusterPolicyResult JSON Unmarshaller
 */
...
public class DeleteClusterPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteClusterPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteClusterPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteClusterPolicyResult deleteClusterPolicyResult = new DeleteClusterPolicyResult();

        return deleteClusterPolicyResult;
    }
