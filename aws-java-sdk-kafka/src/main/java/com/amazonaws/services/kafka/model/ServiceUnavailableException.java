...
public class ServiceUnavailableException extends com.amazonaws.services.kafka.model.AWSKafkaException {
    ...
    public ServiceUnavailableException withInvalidParameter(String invalidParameter) {
