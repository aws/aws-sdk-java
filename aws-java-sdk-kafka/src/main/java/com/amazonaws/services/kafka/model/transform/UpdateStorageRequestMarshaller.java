...
/**
 * UpdateStorageRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateStorageRequestMarshaller {
    ...
    private static final UpdateStorageRequestMarshaller instance = new UpdateStorageRequestMarshaller();

    public static UpdateStorageRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateStorageRequest updateStorageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateStorageRequest.getClusterArn(), CLUSTERARN_BINDING);
            protocolMarshaller.marshall(updateStorageRequest.getCurrentVersion(), CURRENTVERSION_BINDING);
            protocolMarshaller.marshall(updateStorageRequest.getProvisionedThroughput(), PROVISIONEDTHROUGHPUT_BINDING);
            protocolMarshaller.marshall(updateStorageRequest.getStorageMode(), STORAGEMODE_BINDING);
            protocolMarshaller.marshall(updateStorageRequest.getVolumeSizeGB(), VOLUMESIZEGB_BINDING);
        } catch (Exception e) {
