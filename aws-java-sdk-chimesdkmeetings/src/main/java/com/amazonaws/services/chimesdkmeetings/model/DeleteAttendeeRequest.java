...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-meetings-2021-07-15/DeleteAttendee" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteAttendeeRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteAttendeeRequest withMeetingId(String meetingId) {
    ...
    public DeleteAttendeeRequest withAttendeeId(String attendeeId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAttendeeRequest == false)
            return false;
        DeleteAttendeeRequest other = (DeleteAttendeeRequest) obj;
    ...
    @Override
    public DeleteAttendeeRequest clone() {
        return (DeleteAttendeeRequest) super.clone();
    }
