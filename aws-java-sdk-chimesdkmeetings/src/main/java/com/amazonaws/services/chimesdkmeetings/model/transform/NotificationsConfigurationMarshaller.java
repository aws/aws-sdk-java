...
/**
 * NotificationsConfigurationMarshaller
 */
...
public class NotificationsConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> SQSQUEUEARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("SqsQueueArn").build();
