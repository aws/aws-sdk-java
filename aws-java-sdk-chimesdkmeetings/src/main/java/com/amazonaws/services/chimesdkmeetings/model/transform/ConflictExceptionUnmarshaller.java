...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.chimesdkmeetings.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.chimesdkmeetings.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.chimesdkmeetings.model.ConflictException conflictException = new com.amazonaws.services.chimesdkmeetings.model.ConflictException(
                null);
