...
/**
 * DeleteAttendeeResult JSON Unmarshaller
 */
...
public class DeleteAttendeeResultJsonUnmarshaller implements Unmarshaller<DeleteAttendeeResult, JsonUnmarshallerContext> {
    ...
    public DeleteAttendeeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAttendeeResult deleteAttendeeResult = new DeleteAttendeeResult();
