...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.chimesdkmeetings.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.chimesdkmeetings.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.chimesdkmeetings.model.ThrottlingException throttlingException = new com.amazonaws.services.chimesdkmeetings.model.ThrottlingException(
                null);
