...
/**
 * DisassociateServiceQuotaTemplateResult JSON Unmarshaller
 */
...
public class DisassociateServiceQuotaTemplateResultJsonUnmarshaller implements Unmarshaller<DisassociateServiceQuotaTemplateResult, JsonUnmarshallerContext> {
    ...
    public DisassociateServiceQuotaTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateServiceQuotaTemplateResult disassociateServiceQuotaTemplateResult = new DisassociateServiceQuotaTemplateResult();
