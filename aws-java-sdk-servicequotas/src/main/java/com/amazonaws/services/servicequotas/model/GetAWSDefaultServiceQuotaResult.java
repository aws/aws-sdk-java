...
public class GetAWSDefaultServiceQuotaResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetAWSDefaultServiceQuotaResult withQuota(ServiceQuota quota) {
        setQuota(quota);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAWSDefaultServiceQuotaResult == false)
            return false;
        GetAWSDefaultServiceQuotaResult other = (GetAWSDefaultServiceQuotaResult) obj;
    ...
    @Override
    public GetAWSDefaultServiceQuotaResult clone() {
        try {
            return (GetAWSDefaultServiceQuotaResult) super.clone();
