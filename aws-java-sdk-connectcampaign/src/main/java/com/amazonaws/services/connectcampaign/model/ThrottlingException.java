...
public class ThrottlingException extends com.amazonaws.services.connectcampaign.model.AmazonConnectCampaignException {
    ...
    public ThrottlingException withXAmzErrorType(String xAmzErrorType) {
