...
public class InvalidStateException extends com.amazonaws.services.connectcampaign.model.AmazonConnectCampaignException {
    ...
    public InvalidStateException withXAmzErrorType(String xAmzErrorType) {
