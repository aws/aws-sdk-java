...
/**
 * PauseCampaignResult JSON Unmarshaller
 */
...
public class PauseCampaignResultJsonUnmarshaller implements Unmarshaller<PauseCampaignResult, JsonUnmarshallerContext> {
    ...
    public PauseCampaignResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PauseCampaignResult pauseCampaignResult = new PauseCampaignResult();
