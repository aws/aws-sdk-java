...
public class StartInstanceOnboardingJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartInstanceOnboardingJobResult withConnectInstanceOnboardingJobStatus(InstanceOnboardingJobStatus connectInstanceOnboardingJobStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartInstanceOnboardingJobResult == false)
            return false;
        StartInstanceOnboardingJobResult other = (StartInstanceOnboardingJobResult) obj;
    ...
    @Override
    public StartInstanceOnboardingJobResult clone() {
        try {
            return (StartInstanceOnboardingJobResult) super.clone();
