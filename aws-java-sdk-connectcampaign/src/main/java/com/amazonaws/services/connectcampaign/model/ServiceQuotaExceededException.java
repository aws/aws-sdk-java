...
public class ServiceQuotaExceededException extends com.amazonaws.services.connectcampaign.model.AmazonConnectCampaignException {
    ...
    public ServiceQuotaExceededException withXAmzErrorType(String xAmzErrorType) {
