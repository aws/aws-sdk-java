...
/**
 * UpdateCampaignNameResult JSON Unmarshaller
 */
...
public class UpdateCampaignNameResultJsonUnmarshaller implements Unmarshaller<UpdateCampaignNameResult, JsonUnmarshallerContext> {
    ...
    public UpdateCampaignNameResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateCampaignNameResult updateCampaignNameResult = new UpdateCampaignNameResult();
