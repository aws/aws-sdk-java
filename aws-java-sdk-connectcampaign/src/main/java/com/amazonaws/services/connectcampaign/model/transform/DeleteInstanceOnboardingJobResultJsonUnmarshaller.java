...
/**
 * DeleteInstanceOnboardingJobResult JSON Unmarshaller
 */
...
public class DeleteInstanceOnboardingJobResultJsonUnmarshaller implements Unmarshaller<DeleteInstanceOnboardingJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteInstanceOnboardingJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteInstanceOnboardingJobResult deleteInstanceOnboardingJobResult = new DeleteInstanceOnboardingJobResult();
