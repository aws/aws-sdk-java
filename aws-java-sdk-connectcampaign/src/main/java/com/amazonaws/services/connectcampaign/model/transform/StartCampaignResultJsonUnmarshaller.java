...
/**
 * StartCampaignResult JSON Unmarshaller
 */
...
public class StartCampaignResultJsonUnmarshaller implements Unmarshaller<StartCampaignResult, JsonUnmarshallerContext> {
    ...
    public StartCampaignResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartCampaignResult startCampaignResult = new StartCampaignResult();
