...
public class ResourceNotFoundException extends com.amazonaws.services.connectcampaign.model.AmazonConnectCampaignException {
    ...
    public ResourceNotFoundException withXAmzErrorType(String xAmzErrorType) {
