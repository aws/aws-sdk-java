...
/**
 * ResumeCampaignResult JSON Unmarshaller
 */
...
public class ResumeCampaignResultJsonUnmarshaller implements Unmarshaller<ResumeCampaignResult, JsonUnmarshallerContext> {
    ...
    public ResumeCampaignResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResumeCampaignResult resumeCampaignResult = new ResumeCampaignResult();
