        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("clientToken", targetDepth)) {
                    context.nextToken();
                    successfulRequest.setClientToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    successfulRequest.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
