...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/resource-explorer-2-2022-07-28/GetDefaultView" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetDefaultViewResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon resource name
     * (ARN)</a> of the view that is the current default for the Amazon Web Services Region in which you called this
     * operation.
     * </p>
     */
     ...
     *        name (ARN)</a> of the view that is the current default for the Amazon Web Services Region in which you
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDefaultViewResult == false)
            return false;
        GetDefaultViewResult other = (GetDefaultViewResult) obj;
    ...
    public GetDefaultViewResult clone() {
        try {
            return (GetDefaultViewResult) super.clone();
