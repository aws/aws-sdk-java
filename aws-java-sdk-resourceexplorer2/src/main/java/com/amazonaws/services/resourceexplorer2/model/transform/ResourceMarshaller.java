...
public class ResourceMarshaller {
    ...
    public void marshall(Resource resource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(resource.getLastReportedAt(), LASTREPORTEDAT_BINDING);
            protocolMarshaller.marshall(resource.getOwningAccountId(), OWNINGACCOUNTID_BINDING);
            ...
            protocolMarshaller.marshall(resource.getService(), SERVICE_BINDING);
        } catch (Exception e) {
