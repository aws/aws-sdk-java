...
public class AssociateDefaultViewResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon resource name
     * (ARN)</a> of the view that the operation set as the default for queries made in the Amazon Web Services Region
     ...
     *        name (ARN)</a> of the view that the operation set as the default for queries made in the Amazon Web
     *        Services Region and Amazon Web Services account in which you called this operation.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateDefaultViewResult == false)
            return false;
        AssociateDefaultViewResult other = (AssociateDefaultViewResult) obj;
    ...
    public AssociateDefaultViewResult clone() {
        try {
            return (AssociateDefaultViewResult) super.clone();
