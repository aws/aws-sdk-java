        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Count", targetDepth)) {
                    context.nextToken();
                    searchResult.setCount(ResourceCountJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("Resources", targetDepth)) {
                    context.nextToken();
                    searchResult.setResources(new ListUnmarshaller<Resource>(ResourceJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("ViewArn", targetDepth)) {
                    context.nextToken();
                    searchResult.setViewArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
