...
public class UnauthorizedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UnauthorizedExceptionUnmarshaller() {
        super(com.amazonaws.services.resourceexplorer2.model.UnauthorizedException.class, "UnauthorizedException");
    }

    @Override
    public com.amazonaws.services.resourceexplorer2.model.UnauthorizedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.resourceexplorer2.model.UnauthorizedException unauthorizedException = new com.amazonaws.services.resourceexplorer2.model.UnauthorizedException(
                null);
