...
/**
 * DeleteLanguageModelResult JSON Unmarshaller
 */
...
public class DeleteLanguageModelResultJsonUnmarshaller implements Unmarshaller<DeleteLanguageModelResult, JsonUnmarshallerContext> {
    ...
    public DeleteLanguageModelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLanguageModelResult deleteLanguageModelResult = new DeleteLanguageModelResult();
