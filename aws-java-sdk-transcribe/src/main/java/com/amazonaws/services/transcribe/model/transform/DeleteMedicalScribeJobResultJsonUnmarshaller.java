...
/**
 * DeleteMedicalScribeJobResult JSON Unmarshaller
 */
...
public class DeleteMedicalScribeJobResultJsonUnmarshaller implements Unmarshaller<DeleteMedicalScribeJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteMedicalScribeJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMedicalScribeJobResult deleteMedicalScribeJobResult = new DeleteMedicalScribeJobResult();

        return deleteMedicalScribeJobResult;
    }
