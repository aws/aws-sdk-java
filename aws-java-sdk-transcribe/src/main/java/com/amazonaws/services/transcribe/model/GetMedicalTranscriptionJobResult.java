...
public class GetMedicalTranscriptionJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetMedicalTranscriptionJobResult clone() {
        try {
            return (GetMedicalTranscriptionJobResult) super.clone();
