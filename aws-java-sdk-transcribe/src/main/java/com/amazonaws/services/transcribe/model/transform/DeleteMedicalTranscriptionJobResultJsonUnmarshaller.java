...
/**
 * DeleteMedicalTranscriptionJobResult JSON Unmarshaller
 */
...
public class DeleteMedicalTranscriptionJobResultJsonUnmarshaller implements Unmarshaller<DeleteMedicalTranscriptionJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteMedicalTranscriptionJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMedicalTranscriptionJobResult deleteMedicalTranscriptionJobResult = new DeleteMedicalTranscriptionJobResult();
