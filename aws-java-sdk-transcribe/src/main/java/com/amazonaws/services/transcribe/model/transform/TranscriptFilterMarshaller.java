...
public class TranscriptFilterMarshaller {
    ...
    private static final MarshallingInfo<String> TRANSCRIPTFILTERTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("TranscriptFilterType").build();
    ...
    public void marshall(TranscriptFilter transcriptFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(transcriptFilter.getTranscriptFilterType(), TRANSCRIPTFILTERTYPE_BINDING);
            protocolMarshaller.marshall(transcriptFilter.getAbsoluteTimeRange(), ABSOLUTETIMERANGE_BINDING);
            protocolMarshaller.marshall(transcriptFilter.getRelativeTimeRange(), RELATIVETIMERANGE_BINDING);
            protocolMarshaller.marshall(transcriptFilter.getParticipantRole(), PARTICIPANTROLE_BINDING);
            protocolMarshaller.marshall(transcriptFilter.getNegate(), NEGATE_BINDING);
            protocolMarshaller.marshall(transcriptFilter.getTargets(), TARGETS_BINDING);
        } catch (Exception e) {
