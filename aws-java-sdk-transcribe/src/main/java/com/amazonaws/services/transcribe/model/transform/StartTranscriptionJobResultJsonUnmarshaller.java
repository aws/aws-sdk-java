...
/**
 * StartTranscriptionJobResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartTranscriptionJobResultJsonUnmarshaller implements Unmarshaller<StartTranscriptionJobResult, JsonUnmarshallerContext> {
    ...
    private static StartTranscriptionJobResultJsonUnmarshaller instance;

    public static StartTranscriptionJobResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StartTranscriptionJobResultJsonUnmarshaller();
        return instance;
    }
}
