...
/**
 * CallAnalyticsJobSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CallAnalyticsJobSettingsJsonUnmarshaller implements Unmarshaller<CallAnalyticsJobSettings, JsonUnmarshallerContext> {
    ...
    private static CallAnalyticsJobSettingsJsonUnmarshaller instance;

    public static CallAnalyticsJobSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CallAnalyticsJobSettingsJsonUnmarshaller();
        return instance;
    }
}
