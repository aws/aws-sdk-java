...
public class InputDataConfigMarshaller {
    ...
    private static final MarshallingInfo<String> TUNINGDATAS3URI_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("TuningDataS3Uri").build();
    ...
    public void marshall(InputDataConfig inputDataConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(inputDataConfig.getTuningDataS3Uri(), TUNINGDATAS3URI_BINDING);
            protocolMarshaller.marshall(inputDataConfig.getDataAccessRoleArn(), DATAACCESSROLEARN_BINDING);
        } catch (Exception e) {
