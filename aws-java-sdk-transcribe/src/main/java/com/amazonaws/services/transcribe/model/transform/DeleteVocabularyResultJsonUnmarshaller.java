...
/**
 * DeleteVocabularyResult JSON Unmarshaller
 */
...
public class DeleteVocabularyResultJsonUnmarshaller implements Unmarshaller<DeleteVocabularyResult, JsonUnmarshallerContext> {
    ...
    public DeleteVocabularyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteVocabularyResult deleteVocabularyResult = new DeleteVocabularyResult();
