...
/**
 * DeleteCallAnalyticsCategoryResult JSON Unmarshaller
 */
...
public class DeleteCallAnalyticsCategoryResultJsonUnmarshaller implements Unmarshaller<DeleteCallAnalyticsCategoryResult, JsonUnmarshallerContext> {
    ...
    public DeleteCallAnalyticsCategoryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCallAnalyticsCategoryResult deleteCallAnalyticsCategoryResult = new DeleteCallAnalyticsCategoryResult();
