...
/**
 * StartMedicalScribeJobResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartMedicalScribeJobResultJsonUnmarshaller implements Unmarshaller<StartMedicalScribeJobResult, JsonUnmarshallerContext> {
    ...
    public StartMedicalScribeJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MedicalScribeJob", targetDepth)) {
                    context.nextToken();
                    startMedicalScribeJobResult.setMedicalScribeJob(MedicalScribeJobJsonUnmarshaller.getInstance().unmarshall(context));
                }
