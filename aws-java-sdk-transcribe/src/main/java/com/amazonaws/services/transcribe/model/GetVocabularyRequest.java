...
public class GetVocabularyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetVocabularyRequest clone() {
        return (GetVocabularyRequest) super.clone();
    }
