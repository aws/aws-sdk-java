...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/transcribe-2017-10-26/ListMedicalScribeJobs" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListMedicalScribeJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setMedicalScribeJobSummaries(java.util.Collection<MedicalScribeJobSummary> medicalScribeJobSummaries) {
        if (medicalScribeJobSummaries == null) {
            this.medicalScribeJobSummaries = null;
            return;
        }

        this.medicalScribeJobSummaries = new java.util.ArrayList<MedicalScribeJobSummary>(medicalScribeJobSummaries);
    }
    ...
    public ListMedicalScribeJobsResult withMedicalScribeJobSummaries(MedicalScribeJobSummary... medicalScribeJobSummaries) {
        if (this.medicalScribeJobSummaries == null) {
            setMedicalScribeJobSummaries(new java.util.ArrayList<MedicalScribeJobSummary>(medicalScribeJobSummaries.length));
        }
    ...
    public ListMedicalScribeJobsResult withMedicalScribeJobSummaries(java.util.Collection<MedicalScribeJobSummary> medicalScribeJobSummaries) {
