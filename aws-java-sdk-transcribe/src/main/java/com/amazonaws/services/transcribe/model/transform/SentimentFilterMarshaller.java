...
/**
 * SentimentFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SentimentFilterMarshaller {

    private static final MarshallingInfo<List> SENTIMENTS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Sentiments").build();
    ...
    public void marshall(SentimentFilter sentimentFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(sentimentFilter.getAbsoluteTimeRange(), ABSOLUTETIMERANGE_BINDING);
            protocolMarshaller.marshall(sentimentFilter.getRelativeTimeRange(), RELATIVETIMERANGE_BINDING);
            protocolMarshaller.marshall(sentimentFilter.getParticipantRole(), PARTICIPANTROLE_BINDING);
            protocolMarshaller.marshall(sentimentFilter.getNegate(), NEGATE_BINDING);
        } catch (Exception e) {
