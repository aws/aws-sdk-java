...
/**
 * SubtitlesOutput JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SubtitlesOutputJsonUnmarshaller implements Unmarshaller<SubtitlesOutput, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Formats", targetDepth)) {
                    context.nextToken();
                    subtitlesOutput.setFormats(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("SubtitleFileUris", targetDepth)) {
                    context.nextToken();
                    subtitlesOutput.setSubtitleFileUris(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("OutputStartIndex", targetDepth)) {
                    context.nextToken();
                    subtitlesOutput.setOutputStartIndex(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
