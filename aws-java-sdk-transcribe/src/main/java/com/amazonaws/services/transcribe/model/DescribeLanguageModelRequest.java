...
public class DescribeLanguageModelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the custom language model you want information about. Model names are case sensitive.
     */
    ...
    @Override
    public DescribeLanguageModelRequest clone() {
        return (DescribeLanguageModelRequest) super.clone();
    }
