...
/**
 * GetApnsVoipChannelRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetApnsVoipChannelRequestMarshaller {

    private static final MarshallingInfo<String> APPLICATIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("application-id").build();

    private static final GetApnsVoipChannelRequestMarshaller instance = new GetApnsVoipChannelRequestMarshaller();

    public static GetApnsVoipChannelRequestMarshaller getInstance() {
        return instance;
    }
