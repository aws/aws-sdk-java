...
/**
 * DeleteEmailChannelRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteEmailChannelRequestMarshaller {

    private static final MarshallingInfo<String> APPLICATIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("application-id").build();

    private static final DeleteEmailChannelRequestMarshaller instance = new DeleteEmailChannelRequestMarshaller();

    public static DeleteEmailChannelRequestMarshaller getInstance() {
        return instance;
    }
