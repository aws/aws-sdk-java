...
public class DeleteSmsTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteSmsTemplateRequest withTemplateName(String templateName) {
    ...
    public DeleteSmsTemplateRequest withVersion(String version) {
        setVersion(version);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteSmsTemplateRequest == false)
            return false;
        DeleteSmsTemplateRequest other = (DeleteSmsTemplateRequest) obj;
    ...
    @Override
    public DeleteSmsTemplateRequest clone() {
