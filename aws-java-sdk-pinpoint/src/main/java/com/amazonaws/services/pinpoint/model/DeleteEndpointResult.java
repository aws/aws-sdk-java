...
public class DeleteEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteEndpointResult withEndpointResponse(EndpointResponse endpointResponse) {
        setEndpointResponse(endpointResponse);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEndpointResponse() == null ^ this.getEndpointResponse() == null)
            return false;
        if (other.getEndpointResponse() != null && other.getEndpointResponse().equals(this.getEndpointResponse()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getEndpointResponse() == null) ? 0 : getEndpointResponse().hashCode());
        return hashCode;
    }
