...
/**
 * JourneySMSMessage JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JourneySMSMessageJsonUnmarshaller implements Unmarshaller<JourneySMSMessage, JsonUnmarshallerContext> {

    public JourneySMSMessage unmarshall(JsonUnmarshallerContext context) throws Exception {
        JourneySMSMessage journeySMSMessage = new JourneySMSMessage();
    ...
    private static JourneySMSMessageJsonUnmarshaller instance;

    public static JourneySMSMessageJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new JourneySMSMessageJsonUnmarshaller();
        return instance;
    }
}
