...
public class CreateVoiceTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateVoiceTemplateResult withCreateTemplateMessageBody(CreateTemplateMessageBody createTemplateMessageBody) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateVoiceTemplateResult == false)
            return false;
        CreateVoiceTemplateResult other = (CreateVoiceTemplateResult) obj;
    ...
    @Override
    public CreateVoiceTemplateResult clone() {
        try {
            return (CreateVoiceTemplateResult) super.clone();
