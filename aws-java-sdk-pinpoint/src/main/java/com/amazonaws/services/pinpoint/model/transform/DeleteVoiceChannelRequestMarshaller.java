...
@SdkInternalApi
public class DeleteVoiceChannelRequestMarshaller {

    private static final MarshallingInfo<String> APPLICATIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("application-id").build();

    private static final DeleteVoiceChannelRequestMarshaller instance = new DeleteVoiceChannelRequestMarshaller();

    public static DeleteVoiceChannelRequestMarshaller getInstance() {
        return instance;
    }
