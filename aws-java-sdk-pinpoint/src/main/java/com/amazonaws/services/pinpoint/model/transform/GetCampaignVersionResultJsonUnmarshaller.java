...
/**
 * GetCampaignVersionResult JSON Unmarshaller
 */
...
public class GetCampaignVersionResultJsonUnmarshaller implements Unmarshaller<GetCampaignVersionResult, JsonUnmarshallerContext> {
    ...
    public GetCampaignVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            getCampaignVersionResult.setCampaignResponse(CampaignResponseJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
