...
/**
 * MessageResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MessageResponseJsonUnmarshaller implements Unmarshaller<MessageResponse, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Result", targetDepth)) {
                    context.nextToken();
                    messageResponse.setResult(new MapUnmarshaller<String, MessageResult>(context.getUnmarshaller(String.class), MessageResultJsonUnmarshaller
