...
/**
 * DeleteApnsVoipSandboxChannelRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteApnsVoipSandboxChannelRequestMarshaller {

    private static final MarshallingInfo<String> APPLICATIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("application-id").build();

    private static final DeleteApnsVoipSandboxChannelRequestMarshaller instance = new DeleteApnsVoipSandboxChannelRequestMarshaller();

    public static DeleteApnsVoipSandboxChannelRequestMarshaller getInstance() {
        return instance;
    }
