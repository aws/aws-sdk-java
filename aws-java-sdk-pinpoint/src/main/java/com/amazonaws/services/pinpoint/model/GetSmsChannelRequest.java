...
public class GetSmsChannelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetSmsChannelRequest clone() {
        return (GetSmsChannelRequest) super.clone();
    }
