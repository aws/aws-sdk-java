...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-2016-12-01/DeleteUserEndpoints" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteUserEndpointsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteUserEndpointsResult == false)
            return false;
        DeleteUserEndpointsResult other = (DeleteUserEndpointsResult) obj;
    ...
    @Override
    public DeleteUserEndpointsResult clone() {
        try {
            return (DeleteUserEndpointsResult) super.clone();
