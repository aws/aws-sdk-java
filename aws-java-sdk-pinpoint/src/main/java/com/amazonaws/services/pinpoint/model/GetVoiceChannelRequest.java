...
public class GetVoiceChannelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetVoiceChannelRequest clone() {
        return (GetVoiceChannelRequest) super.clone();
    }
