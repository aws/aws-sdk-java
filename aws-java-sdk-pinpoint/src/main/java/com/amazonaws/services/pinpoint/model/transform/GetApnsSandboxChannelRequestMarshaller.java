...
/**
 * GetApnsSandboxChannelRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetApnsSandboxChannelRequestMarshaller {

    private static final MarshallingInfo<String> APPLICATIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("application-id").build();

    private static final GetApnsSandboxChannelRequestMarshaller instance = new GetApnsSandboxChannelRequestMarshaller();

    public static GetApnsSandboxChannelRequestMarshaller getInstance() {
        return instance;
    }
