...
public class SegmentGroupListMarshaller {
    ...
    private static final MarshallingInfo<String> INCLUDE_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(SegmentGroupList segmentGroupList, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(segmentGroupList.getGroups(), GROUPS_BINDING);
            protocolMarshaller.marshall(segmentGroupList.getInclude(), INCLUDE_BINDING);
        } catch (Exception e) {
