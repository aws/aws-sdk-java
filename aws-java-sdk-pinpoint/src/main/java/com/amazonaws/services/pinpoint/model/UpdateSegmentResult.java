...
public class UpdateSegmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public UpdateSegmentResult clone() {
        try {
            return (UpdateSegmentResult) super.clone();
