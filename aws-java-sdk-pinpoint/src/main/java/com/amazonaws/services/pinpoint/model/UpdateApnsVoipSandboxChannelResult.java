...
public class UpdateApnsVoipSandboxChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateApnsVoipSandboxChannelResult == false)
            return false;
        UpdateApnsVoipSandboxChannelResult other = (UpdateApnsVoipSandboxChannelResult) obj;
    ...
    @Override
    public UpdateApnsVoipSandboxChannelResult clone() {
        try {
            return (UpdateApnsVoipSandboxChannelResult) super.clone();
