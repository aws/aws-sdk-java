...
public class DeleteSmsChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public DeleteSmsChannelResult clone() {
        try {
            return (DeleteSmsChannelResult) super.clone();
