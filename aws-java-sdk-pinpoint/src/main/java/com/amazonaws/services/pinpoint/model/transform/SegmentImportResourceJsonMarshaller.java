 ...
 */
public class SegmentImportResourceJsonMarshaller {

    /**
     * Marshall the given parameter object, and output to a SdkJsonGenerator
     */
    public void marshall(SegmentImportResource segmentImportResource, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (segmentImportResource.getExternalId() != null) {
                jsonGenerator.writeFieldName("ExternalId").writeValue(segmentImportResource.getExternalId());
            }
