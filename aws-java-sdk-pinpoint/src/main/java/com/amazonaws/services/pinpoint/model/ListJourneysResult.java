...
public class ListJourneysResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListJourneysResult withJourneysResponse(JourneysResponse journeysResponse) {
        setJourneysResponse(journeysResponse);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getJourneysResponse() != null)
            sb.append("JourneysResponse: ").append(getJourneysResponse());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getJourneysResponse() == null ^ this.getJourneysResponse() == null)
            return false;
        if (other.getJourneysResponse() != null && other.getJourneysResponse().equals(this.getJourneysResponse()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getJourneysResponse() == null) ? 0 : getJourneysResponse().hashCode());
        return hashCode;
    }

    @Override
    public ListJourneysResult clone() {
        try {
            return (ListJourneysResult) super.clone();
