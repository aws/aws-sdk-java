...
public class CreateAppRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CREATEAPPLICATIONREQUEST_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public void marshall(CreateAppRequest createAppRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createAppRequest.getCreateApplicationRequest(), CREATEAPPLICATIONREQUEST_BINDING);
        } catch (Exception e) {
