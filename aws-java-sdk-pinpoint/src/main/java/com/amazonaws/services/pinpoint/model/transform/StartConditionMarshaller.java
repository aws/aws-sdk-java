...
/**
 * StartConditionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StartConditionMarshaller {
    ...
    private static final StartConditionMarshaller instance = new StartConditionMarshaller();

    public static StartConditionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartCondition startCondition, ProtocolMarshaller protocolMarshaller) {
