...
public class DeleteGcmChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public DeleteGcmChannelResult clone() {
        try {
            return (DeleteGcmChannelResult) super.clone();
