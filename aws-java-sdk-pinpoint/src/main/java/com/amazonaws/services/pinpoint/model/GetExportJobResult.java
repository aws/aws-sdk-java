...
public class GetExportJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getExportJobResponse() == null ^ this.getExportJobResponse() == null)
            return false;
        if (other.getExportJobResponse() != null && other.getExportJobResponse().equals(this.getExportJobResponse()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getExportJobResponse() == null) ? 0 : getExportJobResponse().hashCode());
        return hashCode;
    }
