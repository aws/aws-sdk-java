...
/**
 * UpdateSmsTemplateRequestMarshaller
 */
...
public class UpdateSmsTemplateRequestMarshaller {
    ...
    public static UpdateSmsTemplateRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateSmsTemplateRequest updateSmsTemplateRequest, ProtocolMarshaller protocolMarshaller) {

        if (updateSmsTemplateRequest == null) {
