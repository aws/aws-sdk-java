...
/**
 * ApplicationResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ApplicationResponseJsonUnmarshaller implements Unmarshaller<ApplicationResponse, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("CreationDate", targetDepth)) {
                    context.nextToken();
                    applicationResponse.setCreationDate(context.getUnmarshaller(String.class).unmarshall(context));
                }
