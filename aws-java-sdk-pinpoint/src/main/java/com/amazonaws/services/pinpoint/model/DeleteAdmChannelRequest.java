...
public class DeleteAdmChannelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeleteAdmChannelRequest clone() {
        return (DeleteAdmChannelRequest) super.clone();
    }
