...
/**
 * UpdateApnsChannelResult JSON Unmarshaller
 */
...
public class UpdateApnsChannelResultJsonUnmarshaller implements Unmarshaller<UpdateApnsChannelResult, JsonUnmarshallerContext> {
    ...
    public UpdateApnsChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            updateApnsChannelResult.setAPNSChannelResponse(APNSChannelResponseJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
