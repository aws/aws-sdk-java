...
/**
 * ActivitiesResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ActivitiesResponseJsonUnmarshaller implements Unmarshaller<ActivitiesResponse, JsonUnmarshallerContext> {

    public ActivitiesResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
