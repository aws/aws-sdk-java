...
public class GetSmsTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    private SMSTemplateResponse sMSTemplateResponse;

    /**
     * @param sMSTemplateResponse
     */
    ...
    public SMSTemplateResponse getSMSTemplateResponse() {
        return this.sMSTemplateResponse;
    }
    ...
    public GetSmsTemplateResult withSMSTemplateResponse(SMSTemplateResponse sMSTemplateResponse) {
        setSMSTemplateResponse(sMSTemplateResponse);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getSMSTemplateResponse() != null)
            sb.append("SMSTemplateResponse: ").append(getSMSTemplateResponse());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSMSTemplateResponse() == null ^ this.getSMSTemplateResponse() == null)
            return false;
        if (other.getSMSTemplateResponse() != null && other.getSMSTemplateResponse().equals(this.getSMSTemplateResponse()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSMSTemplateResponse() == null) ? 0 : getSMSTemplateResponse().hashCode());
        return hashCode;
    }

    @Override
    public GetSmsTemplateResult clone() {
        try {
            return (GetSmsTemplateResult) super.clone();
