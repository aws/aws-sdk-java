...
@SdkInternalApi
public class SegmentsResponseMarshaller {
    ...
    private static final SegmentsResponseMarshaller instance = new SegmentsResponseMarshaller();

    public static SegmentsResponseMarshaller getInstance() {
        return instance;
    }
