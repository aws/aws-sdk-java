...
public class GetSegmentsRequestMarshaller implements Marshaller<Request<GetSegmentsRequest>, GetSegmentsRequest> {
    ...
    public GetSegmentsRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<GetSegmentsRequest> marshall(GetSegmentsRequest getSegmentsRequest) {
        ...
        uriResourcePath = uriResourcePath.replace("{application-id}",
                (getSegmentsRequest.getApplicationId() != null) ? SdkHttpUtils.urlEncode(StringUtils.fromString(getSegmentsRequest.getApplicationId()), false)
                        : "");
