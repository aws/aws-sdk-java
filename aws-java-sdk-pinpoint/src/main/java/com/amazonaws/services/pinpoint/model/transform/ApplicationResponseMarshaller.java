...
public class ApplicationResponseMarshaller {
    ...
    public static ApplicationResponseMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ApplicationResponse applicationResponse, ProtocolMarshaller protocolMarshaller) {
