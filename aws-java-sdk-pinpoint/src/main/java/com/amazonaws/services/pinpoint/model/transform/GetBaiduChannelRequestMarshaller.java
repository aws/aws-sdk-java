...
@SdkInternalApi
public class GetBaiduChannelRequestMarshaller {

    private static final MarshallingInfo<String> APPLICATIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("application-id").build();

    private static final GetBaiduChannelRequestMarshaller instance = new GetBaiduChannelRequestMarshaller();

    public static GetBaiduChannelRequestMarshaller getInstance() {
        return instance;
    }
