...
public class CampaignStateJsonMarshaller {
     ...
     */
    public void marshall(CampaignState campaignState, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (campaignState.getCampaignStatus() != null) {
                jsonGenerator.writeFieldName("CampaignStatus").writeValue(campaignState.getCampaignStatus());
            }
