 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-2016-12-01/JourneyRunExecutionMetricsResponse"
...
public class JourneyRunExecutionMetricsResponse implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The date and time, in ISO 8601 format, when Amazon Pinpoint last evaluated the journey run and updated
     ...
     *
     * @see JourneyRunExecutionMetricsResponse#withMetrics
     * @returns a reference to this object so that method calls can be chained together.
     */

    public JourneyRunExecutionMetricsResponse addMetricsEntry(String key, String value) {
     ...
     * </p>
     * 
     * @return The unique identifier for the journey run that the metric applies to.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof JourneyRunExecutionMetricsResponse == false)
            return false;
    ...
    @Override
    public JourneyRunExecutionMetricsResponse clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pinpoint.model.transform.JourneyRunExecutionMetricsResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
