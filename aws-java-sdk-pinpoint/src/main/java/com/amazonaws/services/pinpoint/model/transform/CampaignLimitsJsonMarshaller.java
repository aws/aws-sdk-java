...
public class CampaignLimitsJsonMarshaller {
     ...
     */
    public void marshall(CampaignLimits campaignLimits, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (campaignLimits.getDaily() != null) {
                jsonGenerator.writeFieldName("Daily").writeValue(campaignLimits.getDaily());
            }
            if (campaignLimits.getTotal() != null) {
                jsonGenerator.writeFieldName("Total").writeValue(campaignLimits.getTotal());
            }
