...
public class CreateEmailTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateEmailTemplateResult withCreateTemplateMessageBody(CreateTemplateMessageBody createTemplateMessageBody) {
    ...
    @Override
    public CreateEmailTemplateResult clone() {
        try {
            return (CreateEmailTemplateResult) super.clone();
