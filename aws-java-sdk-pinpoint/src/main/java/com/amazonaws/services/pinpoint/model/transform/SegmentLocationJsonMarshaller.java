...
public class SegmentLocationJsonMarshaller {
     ...
     */
    public void marshall(SegmentLocation segmentLocation, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (segmentLocation.getCountry() != null) {
                ...
                SetDimensionJsonMarshaller.getInstance().marshall(segmentLocation.getCountry(), jsonGenerator);
            }
