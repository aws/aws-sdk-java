...
/**
 * ExportJobRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExportJobRequestJsonUnmarshaller implements Unmarshaller<ExportJobRequest, JsonUnmarshallerContext> {

    public ExportJobRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RoleArn", targetDepth)) {
                    context.nextToken();
                    exportJobRequest.setRoleArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("S3UrlPrefix", targetDepth)) {
                    context.nextToken();
                    exportJobRequest.setS3UrlPrefix(context.getUnmarshaller(String.class).unmarshall(context));
                }
