...
public class UpdateGcmChannelRequestMarshaller implements Marshaller<Request<UpdateGcmChannelRequest>, UpdateGcmChannelRequest> {
    ...
    public UpdateGcmChannelRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<UpdateGcmChannelRequest> marshall(UpdateGcmChannelRequest updateGcmChannelRequest) {
        ...
        uriResourcePath = uriResourcePath.replace(
                "{application-id}",
                (updateGcmChannelRequest.getApplicationId() != null) ? SdkHttpUtils.urlEncode(
                        StringUtils.fromString(updateGcmChannelRequest.getApplicationId()), false) : "");
