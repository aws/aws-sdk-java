...
/**
 * EventsResponse JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Results", targetDepth)) {
                    context.nextToken();
                    eventsResponse.setResults(new MapUnmarshaller<String, ItemResponse>(context.getUnmarshaller(String.class), ItemResponseJsonUnmarshaller
