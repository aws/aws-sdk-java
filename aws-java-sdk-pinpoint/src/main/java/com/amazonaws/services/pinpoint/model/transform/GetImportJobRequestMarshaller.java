...
public class GetImportJobRequestMarshaller implements Marshaller<Request<GetImportJobRequest>, GetImportJobRequest> {
    ...
    public GetImportJobRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<GetImportJobRequest> marshall(GetImportJobRequest getImportJobRequest) {
        ...
        uriResourcePath = uriResourcePath
                .replace(
                        "{application-id}",
                        (getImportJobRequest.getApplicationId() != null) ? SdkHttpUtils.urlEncode(
                                StringUtils.fromString(getImportJobRequest.getApplicationId()), false) : "");
        uriResourcePath = uriResourcePath.replace("{job-id}",
                (getImportJobRequest.getJobId() != null) ? SdkHttpUtils.urlEncode(StringUtils.fromString(getImportJobRequest.getJobId()), false) : "");
