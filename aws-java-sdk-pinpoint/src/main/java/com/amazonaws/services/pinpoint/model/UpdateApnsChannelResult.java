...
public class UpdateApnsChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public UpdateApnsChannelResult clone() {
        try {
            return (UpdateApnsChannelResult) super.clone();
