...
public class UpdateEmailTemplateRequestMarshaller {
    ...
    public static UpdateEmailTemplateRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateEmailTemplateRequest updateEmailTemplateRequest, ProtocolMarshaller protocolMarshaller) {
