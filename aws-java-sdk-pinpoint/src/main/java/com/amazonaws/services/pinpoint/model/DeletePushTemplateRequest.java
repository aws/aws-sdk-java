...
public class DeletePushTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeletePushTemplateRequest clone() {
        return (DeletePushTemplateRequest) super.clone();
    }
