...
/**
 * GetAppRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetAppRequestMarshaller {

    private static final MarshallingInfo<String> APPLICATIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("application-id").build();

    private static final GetAppRequestMarshaller instance = new GetAppRequestMarshaller();

    public static GetAppRequestMarshaller getInstance() {
        return instance;
    }
