...
/**
 * UpdateApnsVoipSandboxChannelResult JSON Unmarshaller
 */
...
public class UpdateApnsVoipSandboxChannelResultJsonUnmarshaller implements Unmarshaller<UpdateApnsVoipSandboxChannelResult, JsonUnmarshallerContext> {
    ...
    public UpdateApnsVoipSandboxChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateApnsVoipSandboxChannelResult updateApnsVoipSandboxChannelResult = new UpdateApnsVoipSandboxChannelResult();
        ...
        while (true) {
            ...
            updateApnsVoipSandboxChannelResult.setAPNSVoipSandboxChannelResponse(APNSVoipSandboxChannelResponseJsonUnmarshaller.getInstance().unmarshall(
                    context));
            token = context.nextToken();
        }
