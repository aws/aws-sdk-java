...
public class UpdateApnsSandboxChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public UpdateApnsSandboxChannelResult clone() {
        try {
            return (UpdateApnsSandboxChannelResult) super.clone();
