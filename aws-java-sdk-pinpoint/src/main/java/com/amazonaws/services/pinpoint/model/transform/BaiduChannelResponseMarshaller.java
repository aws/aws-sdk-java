...
/**
 * BaiduChannelResponseMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BaiduChannelResponseMarshaller {
    ...
    private static final BaiduChannelResponseMarshaller instance = new BaiduChannelResponseMarshaller();

    public static BaiduChannelResponseMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BaiduChannelResponse baiduChannelResponse, ProtocolMarshaller protocolMarshaller) {

        if (baiduChannelResponse == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(baiduChannelResponse.getApplicationId(), APPLICATIONID_BINDING);
            ...
            protocolMarshaller.marshall(baiduChannelResponse.getLastModifiedDate(), LASTMODIFIEDDATE_BINDING);
            protocolMarshaller.marshall(baiduChannelResponse.getPlatform(), PLATFORM_BINDING);
            protocolMarshaller.marshall(baiduChannelResponse.getVersion(), VERSION_BINDING);
        } catch (Exception e) {
