...
/**
 * UpdateAttributesRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateAttributesRequestJsonUnmarshaller implements Unmarshaller<UpdateAttributesRequest, JsonUnmarshallerContext> {

    public UpdateAttributesRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
