...
public class UpdateJourneyStateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateJourneyStateResult withJourneyResponse(JourneyResponse journeyResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateJourneyStateResult == false)
            return false;
        UpdateJourneyStateResult other = (UpdateJourneyStateResult) obj;
    ...
    @Override
    public UpdateJourneyStateResult clone() {
        try {
            return (UpdateJourneyStateResult) super.clone();
