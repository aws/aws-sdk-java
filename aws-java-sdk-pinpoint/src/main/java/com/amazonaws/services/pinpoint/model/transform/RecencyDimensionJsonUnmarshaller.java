...
/**
 * RecencyDimension JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RecencyDimensionJsonUnmarshaller implements Unmarshaller<RecencyDimension, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Duration", targetDepth)) {
                    context.nextToken();
                    recencyDimension.setDuration(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RecencyType", targetDepth)) {
                    context.nextToken();
                    recencyDimension.setRecencyType(context.getUnmarshaller(String.class).unmarshall(context));
                }
