...
public class GetEmailChannelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetEmailChannelRequest clone() {
        return (GetEmailChannelRequest) super.clone();
    }
