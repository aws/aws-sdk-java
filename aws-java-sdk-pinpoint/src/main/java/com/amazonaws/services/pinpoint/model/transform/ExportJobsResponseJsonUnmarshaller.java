...
/**
 * ExportJobsResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExportJobsResponseJsonUnmarshaller implements Unmarshaller<ExportJobsResponse, JsonUnmarshallerContext> {

    public ExportJobsResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    exportJobsResponse.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
