...
/**
 * Fluent builder for {@link com.amazonaws.services.appconfigdata.AWSAppConfigData}. Use of the builder is preferred
...
public final class AWSAppConfigDataClientBuilder extends AwsSyncClientBuilder<AWSAppConfigDataClientBuilder, AWSAppConfigData> {
    ...
    /**
     * Construct a synchronous implementation of AWSAppConfigData using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSAppConfigData.
     */
    @Override
    protected AWSAppConfigData build(AwsSyncClientParams params) {
        return new AWSAppConfigDataClient(params);
    }
