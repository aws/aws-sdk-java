        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("InvalidParameters", targetDepth)) {
                    context.nextToken();
                    badRequestDetails.setInvalidParameters(new MapUnmarshaller<String, InvalidParameterDetail>(context.getUnmarshaller(String.class),
                            InvalidParameterDetailJsonUnmarshaller.getInstance()).unmarshall(context));
                }
