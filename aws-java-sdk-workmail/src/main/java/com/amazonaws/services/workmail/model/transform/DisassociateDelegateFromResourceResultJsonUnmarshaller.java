...
/**
 * DisassociateDelegateFromResourceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DisassociateDelegateFromResourceResultJsonUnmarshaller implements Unmarshaller<DisassociateDelegateFromResourceResult, JsonUnmarshallerContext> {

    public DisassociateDelegateFromResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
