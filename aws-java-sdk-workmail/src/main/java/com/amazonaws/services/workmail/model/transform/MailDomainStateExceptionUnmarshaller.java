...
public class MailDomainStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MailDomainStateExceptionUnmarshaller instance;

    public static MailDomainStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MailDomainStateExceptionUnmarshaller();
        return instance;
    }
}
