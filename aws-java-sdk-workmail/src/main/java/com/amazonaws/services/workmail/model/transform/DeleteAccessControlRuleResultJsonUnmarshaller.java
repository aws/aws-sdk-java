...
/**
 * DeleteAccessControlRuleResult JSON Unmarshaller
 */
...
public class DeleteAccessControlRuleResultJsonUnmarshaller implements Unmarshaller<DeleteAccessControlRuleResult, JsonUnmarshallerContext> {
    ...
    public DeleteAccessControlRuleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAccessControlRuleResult deleteAccessControlRuleResult = new DeleteAccessControlRuleResult();

        return deleteAccessControlRuleResult;
    }
