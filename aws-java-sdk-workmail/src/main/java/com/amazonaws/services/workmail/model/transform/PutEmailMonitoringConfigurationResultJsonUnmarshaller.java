...
/**
 * PutEmailMonitoringConfigurationResult JSON Unmarshaller
 */
...
public class PutEmailMonitoringConfigurationResultJsonUnmarshaller implements Unmarshaller<PutEmailMonitoringConfigurationResult, JsonUnmarshallerContext> {
    ...
    public PutEmailMonitoringConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutEmailMonitoringConfigurationResult putEmailMonitoringConfigurationResult = new PutEmailMonitoringConfigurationResult();

        return putEmailMonitoringConfigurationResult;
    }
