...
public class EmailAddressInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EmailAddressInUseExceptionUnmarshaller instance;

    public static EmailAddressInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EmailAddressInUseExceptionUnmarshaller();
        return instance;
    }
}
