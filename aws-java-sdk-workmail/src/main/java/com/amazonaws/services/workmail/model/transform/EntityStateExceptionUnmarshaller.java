...
public class EntityStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EntityStateExceptionUnmarshaller instance;

    public static EntityStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EntityStateExceptionUnmarshaller();
        return instance;
    }
}
