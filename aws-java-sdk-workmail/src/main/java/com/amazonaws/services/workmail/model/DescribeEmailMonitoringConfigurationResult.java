...
public class DescribeEmailMonitoringConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEmailMonitoringConfigurationResult == false)
            return false;
        DescribeEmailMonitoringConfigurationResult other = (DescribeEmailMonitoringConfigurationResult) obj;
    ...
    public DescribeEmailMonitoringConfigurationResult clone() {
        try {
            return (DescribeEmailMonitoringConfigurationResult) super.clone();
