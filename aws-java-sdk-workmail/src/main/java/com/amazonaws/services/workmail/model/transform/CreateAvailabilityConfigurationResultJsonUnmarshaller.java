...
/**
 * CreateAvailabilityConfigurationResult JSON Unmarshaller
 */
...
public class CreateAvailabilityConfigurationResultJsonUnmarshaller implements Unmarshaller<CreateAvailabilityConfigurationResult, JsonUnmarshallerContext> {
    ...
    public CreateAvailabilityConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateAvailabilityConfigurationResult createAvailabilityConfigurationResult = new CreateAvailabilityConfigurationResult();

        return createAvailabilityConfigurationResult;
    }
