...
public class DirectoryServiceAuthenticationFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DirectoryServiceAuthenticationFailedExceptionUnmarshaller instance;

    public static DirectoryServiceAuthenticationFailedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DirectoryServiceAuthenticationFailedExceptionUnmarshaller();
        return instance;
    }
}
