...
/**
 * DeleteAvailabilityConfigurationResult JSON Unmarshaller
 */
...
public class DeleteAvailabilityConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteAvailabilityConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteAvailabilityConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAvailabilityConfigurationResult deleteAvailabilityConfigurationResult = new DeleteAvailabilityConfigurationResult();

        return deleteAvailabilityConfigurationResult;
    }
