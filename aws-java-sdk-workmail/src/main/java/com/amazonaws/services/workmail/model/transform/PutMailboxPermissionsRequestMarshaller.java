...
/**
 * PutMailboxPermissionsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutMailboxPermissionsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> GRANTEEID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("GranteeId").build();
    private static final MarshallingInfo<List> PERMISSIONVALUES_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("PermissionValues").build();

    private static final PutMailboxPermissionsRequestMarshaller instance = new PutMailboxPermissionsRequestMarshaller();

    public static PutMailboxPermissionsRequestMarshaller getInstance() {
        return instance;
    }
