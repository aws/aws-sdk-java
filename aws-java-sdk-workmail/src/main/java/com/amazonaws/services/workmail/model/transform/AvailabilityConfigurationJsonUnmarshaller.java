...
/**
 * AvailabilityConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AvailabilityConfigurationJsonUnmarshaller implements Unmarshaller<AvailabilityConfiguration, JsonUnmarshallerContext> {

    public AvailabilityConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        AvailabilityConfiguration availabilityConfiguration = new AvailabilityConfiguration();
    ...
    private static AvailabilityConfigurationJsonUnmarshaller instance;

    public static AvailabilityConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AvailabilityConfigurationJsonUnmarshaller();
        return instance;
    }
}
