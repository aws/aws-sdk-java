...
/**
 * ListAccessControlRulesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListAccessControlRulesResultJsonUnmarshaller implements Unmarshaller<ListAccessControlRulesResult, JsonUnmarshallerContext> {

    public ListAccessControlRulesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
