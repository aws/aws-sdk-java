...
public class CreateImpersonationRoleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The new impersonation role ID.
     */
    ...
    public CreateImpersonationRoleResult withImpersonationRoleId(String impersonationRoleId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateImpersonationRoleResult == false)
            return false;
        CreateImpersonationRoleResult other = (CreateImpersonationRoleResult) obj;
    ...
    @Override
    public CreateImpersonationRoleResult clone() {
        try {
            return (CreateImpersonationRoleResult) super.clone();
