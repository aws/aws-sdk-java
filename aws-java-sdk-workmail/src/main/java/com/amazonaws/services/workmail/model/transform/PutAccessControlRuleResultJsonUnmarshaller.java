...
/**
 * PutAccessControlRuleResult JSON Unmarshaller
 */
...
public class PutAccessControlRuleResultJsonUnmarshaller implements Unmarshaller<PutAccessControlRuleResult, JsonUnmarshallerContext> {
    ...
    public PutAccessControlRuleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutAccessControlRuleResult putAccessControlRuleResult = new PutAccessControlRuleResult();

        return putAccessControlRuleResult;
    }
