...
/**
 * GetMailDomainResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetMailDomainResultJsonUnmarshaller implements Unmarshaller<GetMailDomainResult, JsonUnmarshallerContext> {

    public GetMailDomainResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetMailDomainResult getMailDomainResult = new GetMailDomainResult();
    ...
    private static GetMailDomainResultJsonUnmarshaller instance;

    public static GetMailDomainResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetMailDomainResultJsonUnmarshaller();
        return instance;
    }
}
