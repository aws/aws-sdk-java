...
public class OrganizationNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OrganizationNotFoundExceptionUnmarshaller instance;

    public static OrganizationNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OrganizationNotFoundExceptionUnmarshaller();
        return instance;
    }
}
