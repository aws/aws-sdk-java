...
public class GetConferenceProviderRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetConferenceProviderRequest clone() {
        return (GetConferenceProviderRequest) super.clone();
    }
