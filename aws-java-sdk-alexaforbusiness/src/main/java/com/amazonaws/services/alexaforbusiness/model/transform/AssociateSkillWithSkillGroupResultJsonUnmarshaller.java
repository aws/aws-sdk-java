...
/**
 * AssociateSkillWithSkillGroupResult JSON Unmarshaller
 */
...
public class AssociateSkillWithSkillGroupResultJsonUnmarshaller implements Unmarshaller<AssociateSkillWithSkillGroupResult, JsonUnmarshallerContext> {
    ...
    public AssociateSkillWithSkillGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateSkillWithSkillGroupResult associateSkillWithSkillGroupResult = new AssociateSkillWithSkillGroupResult();
