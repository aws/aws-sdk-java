...
/**
 * CreateEndOfMeetingReminder JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateEndOfMeetingReminderJsonUnmarshaller implements Unmarshaller<CreateEndOfMeetingReminder, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ReminderAtMinutes", targetDepth)) {
                    context.nextToken();
                    createEndOfMeetingReminder.setReminderAtMinutes(new ListUnmarshaller<Integer>(context.getUnmarshaller(Integer.class)).unmarshall(context));
                }
                if (context.testExpression("ReminderType", targetDepth)) {
                    context.nextToken();
                    createEndOfMeetingReminder.setReminderType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Enabled", targetDepth)) {
                    context.nextToken();
                    createEndOfMeetingReminder.setEnabled(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
