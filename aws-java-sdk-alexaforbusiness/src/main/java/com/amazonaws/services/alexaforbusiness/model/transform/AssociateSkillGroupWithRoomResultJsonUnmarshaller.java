...
/**
 * AssociateSkillGroupWithRoomResult JSON Unmarshaller
 */
...
public class AssociateSkillGroupWithRoomResultJsonUnmarshaller implements Unmarshaller<AssociateSkillGroupWithRoomResult, JsonUnmarshallerContext> {
    ...
    public AssociateSkillGroupWithRoomResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateSkillGroupWithRoomResult associateSkillGroupWithRoomResult = new AssociateSkillGroupWithRoomResult();
