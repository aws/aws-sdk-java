...
/**
 * GetInvitationConfigurationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetInvitationConfigurationResultJsonUnmarshaller implements Unmarshaller<GetInvitationConfigurationResult, JsonUnmarshallerContext> {

    public GetInvitationConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("PrivateSkillIds", targetDepth)) {
                    ...
                    getInvitationConfigurationResult
                            .setPrivateSkillIds(new ListUnmarshaller<String>(context.getUnmarshaller(String.class)).unmarshall(context));
                }
