...
/**
 * <p>
 * Creates settings for the require check in feature that are applied to a room profile. Require check in allows a
 * meeting room’s Alexa or AVS device to prompt the user to check in; otherwise, the room will be released.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/alexaforbusiness-2017-11-09/CreateRequireCheckIn"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateRequireCheckIn implements Serializable, Cloneable, StructuredPojo {
    ...
    public CreateRequireCheckIn withReleaseAfterMinutes(Integer releaseAfterMinutes) {
    ...
    public CreateRequireCheckIn withEnabled(Boolean enabled) {
        setEnabled(enabled);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRequireCheckIn == false)
            return false;
        CreateRequireCheckIn other = (CreateRequireCheckIn) obj;
    ...
    @Override
    public CreateRequireCheckIn clone() {
        try {
            return (CreateRequireCheckIn) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.alexaforbusiness.model.transform.CreateRequireCheckInMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
