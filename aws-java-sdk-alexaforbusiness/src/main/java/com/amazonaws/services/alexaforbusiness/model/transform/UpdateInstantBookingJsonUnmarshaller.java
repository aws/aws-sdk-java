...
/**
 * UpdateInstantBooking JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateInstantBookingJsonUnmarshaller implements Unmarshaller<UpdateInstantBooking, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DurationInMinutes", targetDepth)) {
                    context.nextToken();
                    updateInstantBooking.setDurationInMinutes(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("Enabled", targetDepth)) {
                    context.nextToken();
                    updateInstantBooking.setEnabled(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
