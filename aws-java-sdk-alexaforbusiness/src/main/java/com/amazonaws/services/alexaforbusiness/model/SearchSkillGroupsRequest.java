...
public class SearchSkillGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public SearchSkillGroupsRequest withNextToken(String nextToken) {
    ...
    public SearchSkillGroupsRequest withMaxResults(Integer maxResults) {
    ...
    public SearchSkillGroupsRequest withFilters(Filter... filters) {
    ...
    public SearchSkillGroupsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
     ...
     * </p>
     * 
     * @return The sort order to use in listing the specified set of skill groups. The supported sort key is
     *         SkillGroupName.
     */
    ...
    public SearchSkillGroupsRequest withSortCriteria(Sort... sortCriteria) {
    ...
    public SearchSkillGroupsRequest withSortCriteria(java.util.Collection<Sort> sortCriteria) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchSkillGroupsRequest == false)
            return false;
        SearchSkillGroupsRequest other = (SearchSkillGroupsRequest) obj;
    ...
    public SearchSkillGroupsRequest clone() {
        return (SearchSkillGroupsRequest) super.clone();
    }
