...
/**
 * DisassociateSkillFromSkillGroupRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DisassociateSkillFromSkillGroupRequestMarshaller {
    ...
    private static final DisassociateSkillFromSkillGroupRequestMarshaller instance = new DisassociateSkillFromSkillGroupRequestMarshaller();

    public static DisassociateSkillFromSkillGroupRequestMarshaller getInstance() {
        return instance;
    }
