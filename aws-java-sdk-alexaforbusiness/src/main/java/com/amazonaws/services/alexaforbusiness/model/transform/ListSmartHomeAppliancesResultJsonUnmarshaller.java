...
/**
 * ListSmartHomeAppliancesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSmartHomeAppliancesResultJsonUnmarshaller implements Unmarshaller<ListSmartHomeAppliancesResult, JsonUnmarshallerContext> {

    public ListSmartHomeAppliancesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listSmartHomeAppliancesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
