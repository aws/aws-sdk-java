...
@SdkInternalApi
public class GetContactRequestMarshaller {
    ...
    private static final GetContactRequestMarshaller instance = new GetContactRequestMarshaller();

    public static GetContactRequestMarshaller getInstance() {
        return instance;
    }
