...
/**
 * <p>
 * Creates settings for the instant booking feature that are applied to a room profile. When users start their meeting
 * with Alexa, Alexa automatically books the room for the configured duration if the room is available.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/alexaforbusiness-2017-11-09/CreateInstantBooking"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateInstantBooking implements Serializable, Cloneable, StructuredPojo {
    ...
    public CreateInstantBooking clone() {
        try {
            return (CreateInstantBooking) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.alexaforbusiness.model.transform.CreateInstantBookingMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
