...
/**
 * ListBusinessReportSchedulesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListBusinessReportSchedulesResultJsonUnmarshaller implements Unmarshaller<ListBusinessReportSchedulesResult, JsonUnmarshallerContext> {

    public ListBusinessReportSchedulesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listBusinessReportSchedulesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
