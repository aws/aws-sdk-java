...
public class SearchUsersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The filters to use for listing a specific set of users. Required. Supported filter keys are UserId, FirstName,
     * LastName, Email, and EnrollmentStatus.
     * </p>
     */
    private java.util.List<Filter> filters;
    /**
     * <p>
     * The sort order to use in listing the filtered set of users. Required. Supported sort keys are UserId, FirstName,
     * LastName, Email, and EnrollmentStatus.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The filters to use for listing a specific set of users. Required. Supported filter keys are UserId,
     *         FirstName, LastName, Email, and EnrollmentStatus.
     */
    ...
    public SearchUsersRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
     ...
     * </p>
     * 
     * @return The sort order to use in listing the filtered set of users. Required. Supported sort keys are UserId,
     *         FirstName, LastName, Email, and EnrollmentStatus.
     */
    ...
    public SearchUsersRequest withSortCriteria(java.util.Collection<Sort> sortCriteria) {
