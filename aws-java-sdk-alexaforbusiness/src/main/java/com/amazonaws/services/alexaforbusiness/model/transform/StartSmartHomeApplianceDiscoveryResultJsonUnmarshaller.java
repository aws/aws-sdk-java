...
/**
 * StartSmartHomeApplianceDiscoveryResult JSON Unmarshaller
 */
...
public class StartSmartHomeApplianceDiscoveryResultJsonUnmarshaller implements Unmarshaller<StartSmartHomeApplianceDiscoveryResult, JsonUnmarshallerContext> {
    ...
    public StartSmartHomeApplianceDiscoveryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartSmartHomeApplianceDiscoveryResult startSmartHomeApplianceDiscoveryResult = new StartSmartHomeApplianceDiscoveryResult();
