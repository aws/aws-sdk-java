...
/**
 * DeleteContactResult JSON Unmarshaller
 */
...
public class DeleteContactResultJsonUnmarshaller implements Unmarshaller<DeleteContactResult, JsonUnmarshallerContext> {
    ...
    public DeleteContactResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteContactResult deleteContactResult = new DeleteContactResult();
