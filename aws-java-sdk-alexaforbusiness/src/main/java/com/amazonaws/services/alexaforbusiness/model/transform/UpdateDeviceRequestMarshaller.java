...
public class UpdateDeviceRequestMarshaller {
    ...
    public void marshall(UpdateDeviceRequest updateDeviceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateDeviceRequest.getDeviceArn(), DEVICEARN_BINDING);
            protocolMarshaller.marshall(updateDeviceRequest.getDeviceName(), DEVICENAME_BINDING);
        } catch (Exception e) {
