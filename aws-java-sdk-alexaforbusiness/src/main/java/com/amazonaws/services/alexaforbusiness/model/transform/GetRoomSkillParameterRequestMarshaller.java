...
/**
 * GetRoomSkillParameterRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetRoomSkillParameterRequestMarshaller {
    ...
    private static final GetRoomSkillParameterRequestMarshaller instance = new GetRoomSkillParameterRequestMarshaller();

    public static GetRoomSkillParameterRequestMarshaller getInstance() {
        return instance;
    }
