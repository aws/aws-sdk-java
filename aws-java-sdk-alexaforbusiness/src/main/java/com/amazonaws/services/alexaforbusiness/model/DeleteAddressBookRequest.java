...
public class DeleteAddressBookRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteAddressBookRequest withAddressBookArn(String addressBookArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAddressBookRequest == false)
            return false;
    ...
    @Override
    public DeleteAddressBookRequest clone() {
        return (DeleteAddressBookRequest) super.clone();
    }
