...
/**
 * InstantBooking JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstantBookingJsonUnmarshaller implements Unmarshaller<InstantBooking, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DurationInMinutes", targetDepth)) {
                    context.nextToken();
                    instantBooking.setDurationInMinutes(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("Enabled", targetDepth)) {
                    context.nextToken();
                    instantBooking.setEnabled(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
