...
public class SearchRoomsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The sort order to use in listing the specified set of rooms. The supported sort keys are RoomName and
     * ProfileName.
     * </p>
     */
    ...
    public SearchRoomsRequest withNextToken(String nextToken) {
    ...
    public SearchRoomsRequest withMaxResults(Integer maxResults) {
     ...
     * </p>
     * 
     * @return The filters to use to list a specified set of rooms. The supported filter keys are RoomName and
     *         ProfileName.
     */
    ...
    public SearchRoomsRequest withFilters(Filter... filters) {
    ...
    public SearchRoomsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
     ...
     * </p>
     * 
     * @return The sort order to use in listing the specified set of rooms. The supported sort keys are RoomName and
     *         ProfileName.
     */
    ...
    public SearchRoomsRequest withSortCriteria(Sort... sortCriteria) {
    ...
    public SearchRoomsRequest withSortCriteria(java.util.Collection<Sort> sortCriteria) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchRoomsRequest == false)
            return false;
        SearchRoomsRequest other = (SearchRoomsRequest) obj;
    ...
    @Override
    public SearchRoomsRequest clone() {
        return (SearchRoomsRequest) super.clone();
    }
