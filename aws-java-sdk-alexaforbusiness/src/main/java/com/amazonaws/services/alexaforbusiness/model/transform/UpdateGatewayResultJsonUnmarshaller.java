...
/**
 * UpdateGatewayResult JSON Unmarshaller
 */
...
public class UpdateGatewayResultJsonUnmarshaller implements Unmarshaller<UpdateGatewayResult, JsonUnmarshallerContext> {
    ...
    public UpdateGatewayResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateGatewayResult updateGatewayResult = new UpdateGatewayResult();
