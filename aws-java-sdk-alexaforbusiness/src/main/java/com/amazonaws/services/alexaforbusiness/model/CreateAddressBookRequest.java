...
public class CreateAddressBookRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateAddressBookRequest withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public CreateAddressBookRequest withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAddressBookRequest == false)
            return false;
        CreateAddressBookRequest other = (CreateAddressBookRequest) obj;
    ...
    @Override
    public CreateAddressBookRequest clone() {
        return (CreateAddressBookRequest) super.clone();
    }
