...
public class ForgetSmartHomeAppliancesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ForgetSmartHomeAppliancesRequest withRoomArn(String roomArn) {
        setRoomArn(roomArn);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ForgetSmartHomeAppliancesRequest == false)
            return false;
        ForgetSmartHomeAppliancesRequest other = (ForgetSmartHomeAppliancesRequest) obj;
    ...
    @Override
    public ForgetSmartHomeAppliancesRequest clone() {
        return (ForgetSmartHomeAppliancesRequest) super.clone();
    }
