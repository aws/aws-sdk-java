...
/**
 * ForgetSmartHomeAppliancesResult JSON Unmarshaller
 */
...
public class ForgetSmartHomeAppliancesResultJsonUnmarshaller implements Unmarshaller<ForgetSmartHomeAppliancesResult, JsonUnmarshallerContext> {
    ...
    public ForgetSmartHomeAppliancesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ForgetSmartHomeAppliancesResult forgetSmartHomeAppliancesResult = new ForgetSmartHomeAppliancesResult();
