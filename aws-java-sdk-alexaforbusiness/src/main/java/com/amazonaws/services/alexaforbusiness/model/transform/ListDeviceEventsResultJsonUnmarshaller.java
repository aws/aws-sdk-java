...
/**
 * ListDeviceEventsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDeviceEventsResultJsonUnmarshaller implements Unmarshaller<ListDeviceEventsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DeviceEvents", targetDepth)) {
                    context.nextToken();
                    listDeviceEventsResult.setDeviceEvents(new ListUnmarshaller<DeviceEvent>(DeviceEventJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listDeviceEventsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
