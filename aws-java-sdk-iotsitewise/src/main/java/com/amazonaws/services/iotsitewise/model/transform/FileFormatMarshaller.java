...
/**
 * FileFormatMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FileFormatMarshaller {
    ...
    private static final FileFormatMarshaller instance = new FileFormatMarshaller();

    public static FileFormatMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FileFormat fileFormat, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(fileFormat.getCsv(), CSV_BINDING);
            protocolMarshaller.marshall(fileFormat.getParquet(), PARQUET_BINDING);
        } catch (Exception e) {
