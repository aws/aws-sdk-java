...
public class FileMarshaller {
    ...
    private static final FileMarshaller instance = new FileMarshaller();

    public static FileMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(File file, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(file.getBucket(), BUCKET_BINDING);
            protocolMarshaller.marshall(file.getKey(), KEY_BINDING);
            protocolMarshaller.marshall(file.getVersionId(), VERSIONID_BINDING);
        } catch (Exception e) {
