...
public class ActionSummaryMarshaller {
    ...
    private static final MarshallingInfo<String> ACTIONDEFINITIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("actionDefinitionId").build();
    ...
    public void marshall(ActionSummary actionSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(actionSummary.getActionId(), ACTIONID_BINDING);
            protocolMarshaller.marshall(actionSummary.getActionDefinitionId(), ACTIONDEFINITIONID_BINDING);
            protocolMarshaller.marshall(actionSummary.getTargetResource(), TARGETRESOURCE_BINDING);
        } catch (Exception e) {
