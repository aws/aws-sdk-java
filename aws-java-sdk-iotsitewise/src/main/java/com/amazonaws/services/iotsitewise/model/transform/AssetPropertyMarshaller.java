...
/**
 * AssetPropertyMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssetPropertyMarshaller {
    ...
    public static AssetPropertyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssetProperty assetProperty, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(assetProperty.getId(), ID_BINDING);
            protocolMarshaller.marshall(assetProperty.getName(), NAME_BINDING);
