...
public class ResourceMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> PORTAL_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("portal").build();
    ...
    public void marshall(Resource resource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resource.getPortal(), PORTAL_BINDING);
            protocolMarshaller.marshall(resource.getProject(), PROJECT_BINDING);
        } catch (Exception e) {
