...
/**
 * ListAccessPoliciesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListAccessPoliciesRequestMarshaller {

    private static final MarshallingInfo<String> IDENTITYTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("identityType").build();
    private static final MarshallingInfo<String> IDENTITYID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("identityId").build();
    ...
    private static final ListAccessPoliciesRequestMarshaller instance = new ListAccessPoliciesRequestMarshaller();

    public static ListAccessPoliciesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListAccessPoliciesRequest listAccessPoliciesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listAccessPoliciesRequest.getIdentityType(), IDENTITYTYPE_BINDING);
