...
public class ListActionsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> TARGETRESOURCETYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("targetResourceType").build();
    private static final MarshallingInfo<String> TARGETRESOURCEID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("targetResourceId").build();
    ...
    public void marshall(ListActionsRequest listActionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listActionsRequest.getTargetResourceType(), TARGETRESOURCETYPE_BINDING);
            protocolMarshaller.marshall(listActionsRequest.getTargetResourceId(), TARGETRESOURCEID_BINDING);
