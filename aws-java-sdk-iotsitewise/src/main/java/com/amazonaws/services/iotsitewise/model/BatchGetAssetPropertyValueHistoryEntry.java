 ...
 * </ul>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/BatchGetAssetPropertyValueHistoryEntry"
...
public class BatchGetAssetPropertyValueHistoryEntry implements Serializable, Cloneable, StructuredPojo {
    ...
    public BatchGetAssetPropertyValueHistoryEntry withStartDate(java.util.Date startDate) {
    ...
    public BatchGetAssetPropertyValueHistoryEntry withEndDate(java.util.Date endDate) {
        setEndDate(endDate);
        return this;
    }
    ...
    public BatchGetAssetPropertyValueHistoryEntry withQualities(java.util.Collection<String> qualities) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetAssetPropertyValueHistoryEntry == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotsitewise.model.transform.BatchGetAssetPropertyValueHistoryEntryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
