...
public class CompositeModelPropertyMarshaller {
    ...
    public void marshall(CompositeModelProperty compositeModelProperty, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(compositeModelProperty.getId(), ID_BINDING);
            protocolMarshaller.marshall(compositeModelProperty.getExternalId(), EXTERNALID_BINDING);
        } catch (Exception e) {
