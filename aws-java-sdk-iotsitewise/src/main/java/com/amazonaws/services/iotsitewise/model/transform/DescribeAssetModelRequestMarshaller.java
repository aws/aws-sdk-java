...
/**
 * DescribeAssetModelRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeAssetModelRequestMarshaller {
    ...
    public static DescribeAssetModelRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeAssetModelRequest describeAssetModelRequest, ProtocolMarshaller protocolMarshaller) {

        if (describeAssetModelRequest == null) {
