...
/**
 * CreateGatewayResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateGatewayResultJsonUnmarshaller implements Unmarshaller<CreateGatewayResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("gatewayId", targetDepth)) {
                    context.nextToken();
                    createGatewayResult.setGatewayId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("gatewayArn", targetDepth)) {
                    context.nextToken();
                    createGatewayResult.setGatewayArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
