...
public class AssociateTimeSeriesToAssetPropertyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        format, or else <code>externalId:</code> followed by the external ID, if it has one. For more information,
     *        see <a
     *        href="https://docs.aws.amazon.com/iot-sitewise/latest/userguide/object-ids.html#external-id-references"
     *        >Referencing objects with external IDs</a> in the <i>IoT SiteWise User Guide</i>.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateTimeSeriesToAssetPropertyRequest == false)
            return false;
        AssociateTimeSeriesToAssetPropertyRequest other = (AssociateTimeSeriesToAssetPropertyRequest) obj;
    ...
    public AssociateTimeSeriesToAssetPropertyRequest clone() {
        return (AssociateTimeSeriesToAssetPropertyRequest) super.clone();
    }
