...
/**
 * AssetModelHierarchyMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssetModelHierarchyMarshaller {
    ...
    public static AssetModelHierarchyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssetModelHierarchy assetModelHierarchy, ProtocolMarshaller protocolMarshaller) {

        if (assetModelHierarchy == null) {
