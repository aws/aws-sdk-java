 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/AssetHierarchy" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssetHierarchy implements Serializable, Cloneable, StructuredPojo {
    ...
    public AssetHierarchy clone() {
        try {
            return (AssetHierarchy) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotsitewise.model.transform.AssetHierarchyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
