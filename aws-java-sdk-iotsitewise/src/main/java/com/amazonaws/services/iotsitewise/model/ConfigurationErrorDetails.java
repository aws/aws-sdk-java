...
public class ConfigurationErrorDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConfigurationErrorDetails == false)
            return false;
    ...
    public ConfigurationErrorDetails clone() {
        try {
            return (ConfigurationErrorDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotsitewise.model.transform.ConfigurationErrorDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
