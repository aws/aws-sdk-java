...
/**
 * AssociatedAssetsSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssociatedAssetsSummaryMarshaller {
    ...
    public static AssociatedAssetsSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssociatedAssetsSummary associatedAssetsSummary, ProtocolMarshaller protocolMarshaller) {

        if (associatedAssetsSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(associatedAssetsSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(associatedAssetsSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(associatedAssetsSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(associatedAssetsSummary.getAssetModelId(), ASSETMODELID_BINDING);
            protocolMarshaller.marshall(associatedAssetsSummary.getCreationDate(), CREATIONDATE_BINDING);
            protocolMarshaller.marshall(associatedAssetsSummary.getLastUpdateDate(), LASTUPDATEDATE_BINDING);
