...
public class AggregatedValueMarshaller {
    ...
    public void marshall(AggregatedValue aggregatedValue, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(aggregatedValue.getTimestamp(), TIMESTAMP_BINDING);
            protocolMarshaller.marshall(aggregatedValue.getQuality(), QUALITY_BINDING);
            protocolMarshaller.marshall(aggregatedValue.getValue(), VALUE_BINDING);
        } catch (Exception e) {
