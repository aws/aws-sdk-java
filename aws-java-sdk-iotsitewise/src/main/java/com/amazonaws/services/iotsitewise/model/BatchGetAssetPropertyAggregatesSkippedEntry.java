 ...
 * >BatchGetAssetPropertyAggregates</a> request.
 * </p>
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/BatchGetAssetPropertyAggregatesSkippedEntry"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchGetAssetPropertyAggregatesSkippedEntry implements Serializable, Cloneable, StructuredPojo {
    ...
    public BatchGetAssetPropertyAggregatesErrorInfo getErrorInfo() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetAssetPropertyAggregatesSkippedEntry == false)
            return false;
    ...
    public BatchGetAssetPropertyAggregatesSkippedEntry clone() {
        try {
            return (BatchGetAssetPropertyAggregatesSkippedEntry) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotsitewise.model.transform.BatchGetAssetPropertyAggregatesSkippedEntryMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
