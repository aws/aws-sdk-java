 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/BatchGetAssetPropertyValueHistorySkippedEntry"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchGetAssetPropertyValueHistorySkippedEntry implements Serializable, Cloneable, StructuredPojo {
    ...
    public BatchGetAssetPropertyValueHistorySkippedEntry withCompletionStatus(String completionStatus) {
    ...
    public BatchGetAssetPropertyValueHistorySkippedEntry withCompletionStatus(BatchEntryCompletionStatus completionStatus) {
    ...
    public void setErrorInfo(BatchGetAssetPropertyValueHistoryErrorInfo errorInfo) {
    ...
    public BatchGetAssetPropertyValueHistoryErrorInfo getErrorInfo() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetAssetPropertyValueHistorySkippedEntry == false)
            return false;
    ...
    @Override
    public BatchGetAssetPropertyValueHistorySkippedEntry clone() {
        try {
            return (BatchGetAssetPropertyValueHistorySkippedEntry) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotsitewise.model.transform.BatchGetAssetPropertyValueHistorySkippedEntryMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
