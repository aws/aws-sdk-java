...
/**
 * BatchGetAssetPropertyValueEntry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchGetAssetPropertyValueEntryJsonUnmarshaller implements Unmarshaller<BatchGetAssetPropertyValueEntry, JsonUnmarshallerContext> {

    public BatchGetAssetPropertyValueEntry unmarshall(JsonUnmarshallerContext context) throws Exception {
        BatchGetAssetPropertyValueEntry batchGetAssetPropertyValueEntry = new BatchGetAssetPropertyValueEntry();
    ...
    private static BatchGetAssetPropertyValueEntryJsonUnmarshaller instance;

    public static BatchGetAssetPropertyValueEntryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BatchGetAssetPropertyValueEntryJsonUnmarshaller();
        return instance;
    }
}
