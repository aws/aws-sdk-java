...
/**
 * DataIntegrationAssociationSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataIntegrationAssociationSummaryJsonUnmarshaller implements Unmarshaller<DataIntegrationAssociationSummary, JsonUnmarshallerContext> {

    public DataIntegrationAssociationSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        DataIntegrationAssociationSummary dataIntegrationAssociationSummary = new DataIntegrationAssociationSummary();
    ...
    private static DataIntegrationAssociationSummaryJsonUnmarshaller instance;

    public static DataIntegrationAssociationSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DataIntegrationAssociationSummaryJsonUnmarshaller();
        return instance;
    }
}
