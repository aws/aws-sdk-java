...
public class UnsupportedOperationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UnsupportedOperationExceptionUnmarshaller() {
        super(com.amazonaws.services.appintegrations.model.UnsupportedOperationException.class, "UnsupportedOperationException");
    }

    @Override
    public com.amazonaws.services.appintegrations.model.UnsupportedOperationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.appintegrations.model.UnsupportedOperationException unsupportedOperationException = new com.amazonaws.services.appintegrations.model.UnsupportedOperationException(
                null);
