...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.appintegrations.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.appintegrations.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.appintegrations.model.ThrottlingException throttlingException = new com.amazonaws.services.appintegrations.model.ThrottlingException(
                null);
