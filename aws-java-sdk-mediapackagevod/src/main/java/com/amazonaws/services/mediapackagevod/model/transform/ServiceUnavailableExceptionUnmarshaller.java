...
public class ServiceUnavailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceUnavailableExceptionUnmarshaller() {
        super(com.amazonaws.services.mediapackagevod.model.ServiceUnavailableException.class, "ServiceUnavailableException");
    }

    @Override
    public com.amazonaws.services.mediapackagevod.model.ServiceUnavailableException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
