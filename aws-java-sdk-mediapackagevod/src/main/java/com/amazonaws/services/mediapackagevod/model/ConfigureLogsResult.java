...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediapackage-vod-2018-11-07/ConfigureLogs" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConfigureLogsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ConfigureLogsResult withAuthorization(Authorization authorization) {
    ...
    public ConfigureLogsResult withDomainName(String domainName) {
    ...
    public ConfigureLogsResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ConfigureLogsResult#withTags
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConfigureLogsResult == false)
            return false;
        ConfigureLogsResult other = (ConfigureLogsResult) obj;
    ...
    public ConfigureLogsResult clone() {
        try {
            return (ConfigureLogsResult) super.clone();
