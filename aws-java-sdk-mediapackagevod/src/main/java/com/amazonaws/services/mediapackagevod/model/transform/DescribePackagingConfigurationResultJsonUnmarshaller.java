...
/**
 * DescribePackagingConfigurationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribePackagingConfigurationResultJsonUnmarshaller implements Unmarshaller<DescribePackagingConfigurationResult, JsonUnmarshallerContext> {

    public DescribePackagingConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
