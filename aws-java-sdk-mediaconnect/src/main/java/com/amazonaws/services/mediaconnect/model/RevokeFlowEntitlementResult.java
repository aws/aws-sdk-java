...
public class RevokeFlowEntitlementResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RevokeFlowEntitlementResult == false)
            return false;
        RevokeFlowEntitlementResult other = (RevokeFlowEntitlementResult) obj;
    ...
    public RevokeFlowEntitlementResult clone() {
        try {
            return (RevokeFlowEntitlementResult) super.clone();
