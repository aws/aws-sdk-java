...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/UpdateIngressGatewayBridgeRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateIngressGatewayBridgeRequest implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateIngressGatewayBridgeRequest == false)
            return false;
        UpdateIngressGatewayBridgeRequest other = (UpdateIngressGatewayBridgeRequest) obj;
    ...
    @Override
    public UpdateIngressGatewayBridgeRequest clone() {
        try {
            return (UpdateIngressGatewayBridgeRequest) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediaconnect.model.transform.UpdateIngressGatewayBridgeRequestMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
