        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("flow", targetDepth)) {
                    context.nextToken();
                    describeFlowResult.setFlow(FlowJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("messages", targetDepth)) {
                    context.nextToken();
                    describeFlowResult.setMessages(MessagesJsonUnmarshaller.getInstance().unmarshall(context));
                }
