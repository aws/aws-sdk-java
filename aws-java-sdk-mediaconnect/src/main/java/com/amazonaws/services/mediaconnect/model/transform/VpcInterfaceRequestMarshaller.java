...
/**
 * VpcInterfaceRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VpcInterfaceRequestMarshaller {
    ...
    private static final VpcInterfaceRequestMarshaller instance = new VpcInterfaceRequestMarshaller();

    public static VpcInterfaceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VpcInterfaceRequest vpcInterfaceRequest, ProtocolMarshaller protocolMarshaller) {

        if (vpcInterfaceRequest == null) {
