...
public class GrantFlowEntitlements420ExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static GrantFlowEntitlements420ExceptionUnmarshaller instance;

    public static GrantFlowEntitlements420ExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new GrantFlowEntitlements420ExceptionUnmarshaller();
        return instance;
    }
}
