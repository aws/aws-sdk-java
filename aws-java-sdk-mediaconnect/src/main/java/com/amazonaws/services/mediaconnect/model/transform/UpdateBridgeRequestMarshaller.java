...
/**
 * UpdateBridgeRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateBridgeRequestMarshaller {
    ...
    private static final UpdateBridgeRequestMarshaller instance = new UpdateBridgeRequestMarshaller();

    public static UpdateBridgeRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateBridgeRequest updateBridgeRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateBridgeRequest.getBridgeArn(), BRIDGEARN_BINDING);
            protocolMarshaller.marshall(updateBridgeRequest.getEgressGatewayBridge(), EGRESSGATEWAYBRIDGE_BINDING);
            protocolMarshaller.marshall(updateBridgeRequest.getIngressGatewayBridge(), INGRESSGATEWAYBRIDGE_BINDING);
            protocolMarshaller.marshall(updateBridgeRequest.getSourceFailoverConfig(), SOURCEFAILOVERCONFIG_BINDING);
        } catch (Exception e) {
