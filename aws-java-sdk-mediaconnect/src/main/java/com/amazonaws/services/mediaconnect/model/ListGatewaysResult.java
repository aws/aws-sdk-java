...
public class ListGatewaysResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    private java.util.List<ListedGateway> gateways;
    /**
     * The token that identifies which batch of results that you want to see. For example, you submit a ListGateways
     ...
     * A list of gateway summaries.
     * 
     * @return A list of gateway summaries.
     */

    public java.util.List<ListedGateway> getGateways() {
        return gateways;
    }
    ...
    public void setGateways(java.util.Collection<ListedGateway> gateways) {
        if (gateways == null) {
            this.gateways = null;
            return;
        }

        this.gateways = new java.util.ArrayList<ListedGateway>(gateways);
    }
    ...
    public ListGatewaysResult withGateways(ListedGateway... gateways) {
        if (this.gateways == null) {
            setGateways(new java.util.ArrayList<ListedGateway>(gateways.length));
        }
        for (ListedGateway ele : gateways) {
    ...
    public ListGatewaysResult withGateways(java.util.Collection<ListedGateway> gateways) {
