...
public class CreateGatewayRequestMarshaller {
    ...
    public void marshall(CreateGatewayRequest createGatewayRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createGatewayRequest.getEgressCidrBlocks(), EGRESSCIDRBLOCKS_BINDING);
            protocolMarshaller.marshall(createGatewayRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createGatewayRequest.getNetworks(), NETWORKS_BINDING);
        } catch (Exception e) {
