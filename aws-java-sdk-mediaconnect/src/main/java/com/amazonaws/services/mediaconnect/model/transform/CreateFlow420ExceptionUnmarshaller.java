...
public class CreateFlow420ExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CreateFlow420ExceptionUnmarshaller instance;

    public static CreateFlow420ExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateFlow420ExceptionUnmarshaller();
        return instance;
    }
}
