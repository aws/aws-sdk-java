...
public class RemoveFlowMediaStreamRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The name of the media stream that you want to remove.
     * 
     * @return The name of the media stream that you want to remove.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RemoveFlowMediaStreamRequest == false)
            return false;
        RemoveFlowMediaStreamRequest other = (RemoveFlowMediaStreamRequest) obj;
    ...
    public RemoveFlowMediaStreamRequest clone() {
        return (RemoveFlowMediaStreamRequest) super.clone();
    }
