 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/AddBridgeSourceRequest"
...
public class AddBridgeSourceRequest implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setFlowSource(AddBridgeFlowSourceRequest flowSource) {
    ...
    public AddBridgeSourceRequest withFlowSource(AddBridgeFlowSourceRequest flowSource) {
    ...
    public void setNetworkSource(AddBridgeNetworkSourceRequest networkSource) {
    ...
    public AddBridgeSourceRequest withNetworkSource(AddBridgeNetworkSourceRequest networkSource) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddBridgeSourceRequest == false)
            return false;
    ...
    @Override
    public AddBridgeSourceRequest clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediaconnect.model.transform.AddBridgeSourceRequestMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
