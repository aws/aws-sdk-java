...
class FlowActive {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<DescribeFlowResult> {
    ...
    static class IsSTARTINGMatcher extends WaiterAcceptor<DescribeFlowResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATINGMatcher extends WaiterAcceptor<DescribeFlowResult> {
        private static final JsonNode expectedResult;
