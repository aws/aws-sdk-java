...
public class RemoveBridgeSourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The name of the bridge source that you want to remove.
     * 
     * @return The name of the bridge source that you want to remove.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RemoveBridgeSourceRequest == false)
            return false;
        RemoveBridgeSourceRequest other = (RemoveBridgeSourceRequest) obj;
    ...
    public RemoveBridgeSourceRequest clone() {
        return (RemoveBridgeSourceRequest) super.clone();
    }
