...
/**
 * FailoverConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FailoverConfigJsonUnmarshaller implements Unmarshaller<FailoverConfig, JsonUnmarshallerContext> {

    public FailoverConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static FailoverConfigJsonUnmarshaller instance;

    public static FailoverConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FailoverConfigJsonUnmarshaller();
        return instance;
    }
}
