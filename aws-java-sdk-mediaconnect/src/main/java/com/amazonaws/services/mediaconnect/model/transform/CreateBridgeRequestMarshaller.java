...
/**
 * CreateBridgeRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateBridgeRequestMarshaller {
    ...
    private static final CreateBridgeRequestMarshaller instance = new CreateBridgeRequestMarshaller();

    public static CreateBridgeRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateBridgeRequest createBridgeRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createBridgeRequest.getEgressGatewayBridge(), EGRESSGATEWAYBRIDGE_BINDING);
            protocolMarshaller.marshall(createBridgeRequest.getIngressGatewayBridge(), INGRESSGATEWAYBRIDGE_BINDING);
            protocolMarshaller.marshall(createBridgeRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createBridgeRequest.getOutputs(), OUTPUTS_BINDING);
            protocolMarshaller.marshall(createBridgeRequest.getPlacementArn(), PLACEMENTARN_BINDING);
            protocolMarshaller.marshall(createBridgeRequest.getSourceFailoverConfig(), SOURCEFAILOVERCONFIG_BINDING);
            protocolMarshaller.marshall(createBridgeRequest.getSources(), SOURCES_BINDING);
        } catch (Exception e) {
