 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/EncodingParametersRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EncodingParametersRequest implements Serializable, Cloneable, StructuredPojo {
     ...
     * associated with outputs that use the ST 2110 JPEG XS protocol, if at least one source on the flow uses the CDI
     * protocol.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EncodingParametersRequest == false)
            return false;
        EncodingParametersRequest other = (EncodingParametersRequest) obj;
    ...
    public EncodingParametersRequest clone() {
        try {
            return (EncodingParametersRequest) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediaconnect.model.transform.EncodingParametersRequestMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
