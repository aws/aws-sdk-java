 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/BridgeNetworkOutput" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BridgeNetworkOutput implements Serializable, Cloneable, StructuredPojo {
     ...
     * The network output name.
     * 
     * @return The network output name.
     */
    ...
    public BridgeNetworkOutput withProtocol(String protocol) {
    ...
    public BridgeNetworkOutput withProtocol(Protocol protocol) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BridgeNetworkOutput == false)
            return false;
        BridgeNetworkOutput other = (BridgeNetworkOutput) obj;
    ...
    @Override
    public BridgeNetworkOutput clone() {
        try {
            return (BridgeNetworkOutput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediaconnect.model.transform.BridgeNetworkOutputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
