...
/**
 * <p>
 * For <code>List</code> operations, an optional specification to return a subset of objects, such as resolver endpoints
 * or resolver rules.
 * </p>
 * 
...
public class Filter implements Serializable, Cloneable, StructuredPojo {
     ...
     * example, to list only inbound resolver endpoints, specify <code>Direction</code> for the value of
     * <code>Name</code>.
     * </p>
     */
    private String name;
     ...
     * example, to list only inbound resolver endpoints, specify <code>INBOUND</code> for the value of
     * <code>Values</code>.
     * </p>
     */
     ...
     *        objects. For example, to list only inbound resolver endpoints, specify <code>Direction</code> for the
     ...
     *         objects. For example, to list only inbound resolver endpoints, specify <code>INBOUND</code> for the value
     *         of <code>Values</code>.
     */
