...
public class AssociateResolverEndpointIpAddressResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public AssociateResolverEndpointIpAddressResult withResolverEndpoint(ResolverEndpoint resolverEndpoint) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateResolverEndpointIpAddressResult == false)
            return false;
        AssociateResolverEndpointIpAddressResult other = (AssociateResolverEndpointIpAddressResult) obj;
    ...
    @Override
    public AssociateResolverEndpointIpAddressResult clone() {
        try {
            return (AssociateResolverEndpointIpAddressResult) super.clone();
