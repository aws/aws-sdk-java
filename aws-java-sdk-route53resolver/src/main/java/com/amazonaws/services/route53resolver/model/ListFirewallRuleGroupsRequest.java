...
public class ListFirewallRuleGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListFirewallRuleGroupsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFirewallRuleGroupsRequest == false)
            return false;
        ListFirewallRuleGroupsRequest other = (ListFirewallRuleGroupsRequest) obj;
    ...
    @Override
    public ListFirewallRuleGroupsRequest clone() {
        return (ListFirewallRuleGroupsRequest) super.clone();
    }
