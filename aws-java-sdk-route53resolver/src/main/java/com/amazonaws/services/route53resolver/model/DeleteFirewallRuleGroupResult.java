...
public class DeleteFirewallRuleGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteFirewallRuleGroupResult withFirewallRuleGroup(FirewallRuleGroup firewallRuleGroup) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteFirewallRuleGroupResult == false)
            return false;
        DeleteFirewallRuleGroupResult other = (DeleteFirewallRuleGroupResult) obj;
    ...
    @Override
    public DeleteFirewallRuleGroupResult clone() {
        try {
            return (DeleteFirewallRuleGroupResult) super.clone();
