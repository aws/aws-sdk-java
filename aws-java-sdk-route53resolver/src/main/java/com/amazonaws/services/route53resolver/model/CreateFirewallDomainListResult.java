...
public class CreateFirewallDomainListResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The domain list that you just created.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateFirewallDomainListResult == false)
            return false;
        CreateFirewallDomainListResult other = (CreateFirewallDomainListResult) obj;
        if (other.getFirewallDomainList() == null ^ this.getFirewallDomainList() == null)
            return false;
        if (other.getFirewallDomainList() != null && other.getFirewallDomainList().equals(this.getFirewallDomainList()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getFirewallDomainList() == null) ? 0 : getFirewallDomainList().hashCode());
        return hashCode;
    }
    ...
    public CreateFirewallDomainListResult clone() {
        try {
            return (CreateFirewallDomainListResult) super.clone();
