...
public class DisassociateResolverEndpointIpAddressResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DisassociateResolverEndpointIpAddressResult withResolverEndpoint(ResolverEndpoint resolverEndpoint) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateResolverEndpointIpAddressResult == false)
            return false;
        DisassociateResolverEndpointIpAddressResult other = (DisassociateResolverEndpointIpAddressResult) obj;
    ...
    @Override
    public DisassociateResolverEndpointIpAddressResult clone() {
        try {
            return (DisassociateResolverEndpointIpAddressResult) super.clone();
