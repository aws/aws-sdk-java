...
/**
 * IpAddressResponseMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class IpAddressResponseMarshaller {
    ...
    private static final IpAddressResponseMarshaller instance = new IpAddressResponseMarshaller();

    public static IpAddressResponseMarshaller getInstance() {
        return instance;
    }
