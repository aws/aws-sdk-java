...
public class PutResolverQueryLogConfigPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public PutResolverQueryLogConfigPolicyResult withReturnValue(Boolean returnValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutResolverQueryLogConfigPolicyResult == false)
            return false;
        PutResolverQueryLogConfigPolicyResult other = (PutResolverQueryLogConfigPolicyResult) obj;
    ...
    @Override
    public PutResolverQueryLogConfigPolicyResult clone() {
        try {
            return (PutResolverQueryLogConfigPolicyResult) super.clone();
