...
/**
 * TargetAddressMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TargetAddressMarshaller {
    ...
    public static TargetAddressMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TargetAddress targetAddress, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(targetAddress.getProtocol(), PROTOCOL_BINDING);
        } catch (Exception e) {
