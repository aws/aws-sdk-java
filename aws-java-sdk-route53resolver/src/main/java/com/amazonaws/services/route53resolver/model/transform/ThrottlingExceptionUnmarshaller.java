...
public class ThrottlingExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.route53resolver.model.ThrottlingException> {
    private ThrottlingExceptionUnmarshaller() {
        super("ThrottlingException");
    }

    @Override
    public com.amazonaws.services.route53resolver.model.ThrottlingException unmarshall(JsonUnmarshallerContext context) throws Exception {
