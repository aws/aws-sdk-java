...
public class GetResolverRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetResolverRuleResult withResolverRule(ResolverRule resolverRule) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetResolverRuleResult == false)
            return false;
        GetResolverRuleResult other = (GetResolverRuleResult) obj;
    ...
    @Override
    public GetResolverRuleResult clone() {
        try {
            return (GetResolverRuleResult) super.clone();
