...
public class ListFirewallConfigsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListFirewallConfigsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFirewallConfigsRequest == false)
            return false;
        ListFirewallConfigsRequest other = (ListFirewallConfigsRequest) obj;
    ...
    @Override
    public ListFirewallConfigsRequest clone() {
        return (ListFirewallConfigsRequest) super.clone();
    }
