...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/DeleteResolverRule" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteResolverRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * Information about the <code>DeleteResolverRule</code> request, including the status of the request.
     * </p>
     */
    ...
    public DeleteResolverRuleResult withResolverRule(ResolverRule resolverRule) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteResolverRuleResult == false)
            return false;
        DeleteResolverRuleResult other = (DeleteResolverRuleResult) obj;
    ...
    public DeleteResolverRuleResult clone() {
        try {
            return (DeleteResolverRuleResult) super.clone();
