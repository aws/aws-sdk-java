...
/**
 * EmvEncryptionAttributes JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EmvEncryptionAttributesJsonUnmarshaller implements Unmarshaller<EmvEncryptionAttributes, JsonUnmarshallerContext> {

    public EmvEncryptionAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        EmvEncryptionAttributes emvEncryptionAttributes = new EmvEncryptionAttributes();
        ...
        return emvEncryptionAttributes;
    }

    private static EmvEncryptionAttributesJsonUnmarshaller instance;

    public static EmvEncryptionAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EmvEncryptionAttributesJsonUnmarshaller();
        return instance;
    }
}
