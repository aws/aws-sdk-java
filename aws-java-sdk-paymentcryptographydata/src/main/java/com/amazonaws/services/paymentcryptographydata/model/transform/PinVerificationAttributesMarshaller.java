...
/**
 * PinVerificationAttributesMarshaller
 */
...
public class PinVerificationAttributesMarshaller {
    ...
    public static PinVerificationAttributesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PinVerificationAttributes pinVerificationAttributes, ProtocolMarshaller protocolMarshaller) {

        if (pinVerificationAttributes == null) {
