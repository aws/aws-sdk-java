...
public class CancelMetadataGenerationRunRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the Amazon DataZone domain in which the metadata generation run is to be cancelled.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelMetadataGenerationRunRequest == false)
            return false;
        CancelMetadataGenerationRunRequest other = (CancelMetadataGenerationRunRequest) obj;
    ...
    public CancelMetadataGenerationRunRequest clone() {
        return (CancelMetadataGenerationRunRequest) super.clone();
    }
