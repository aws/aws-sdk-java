...
public class DeleteDefaultSenderIdResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The current sender ID for the configuration set.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDefaultSenderIdResult == false)
            return false;
        DeleteDefaultSenderIdResult other = (DeleteDefaultSenderIdResult) obj;
    ...
    public DeleteDefaultSenderIdResult clone() {
        try {
            return (DeleteDefaultSenderIdResult) super.clone();
