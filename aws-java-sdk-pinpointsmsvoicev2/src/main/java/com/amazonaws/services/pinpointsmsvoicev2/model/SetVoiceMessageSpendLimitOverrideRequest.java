...
public class SetVoiceMessageSpendLimitOverrideRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The new monthly limit to enforce on voice messages.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetVoiceMessageSpendLimitOverrideRequest == false)
            return false;
        SetVoiceMessageSpendLimitOverrideRequest other = (SetVoiceMessageSpendLimitOverrideRequest) obj;
    ...
    @Override
    public SetVoiceMessageSpendLimitOverrideRequest clone() {
        return (SetVoiceMessageSpendLimitOverrideRequest) super.clone();
    }
