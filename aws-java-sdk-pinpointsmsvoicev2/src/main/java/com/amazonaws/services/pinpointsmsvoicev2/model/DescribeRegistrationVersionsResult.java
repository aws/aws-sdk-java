...
public class DescribeRegistrationVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<RegistrationVersionInformation> registrationVersions;
    /**
     * <p>
    ...
    public java.util.List<RegistrationVersionInformation> getRegistrationVersions() {
    ...
    public void setRegistrationVersions(java.util.Collection<RegistrationVersionInformation> registrationVersions) {
        if (registrationVersions == null) {
            this.registrationVersions = null;
            return;
        }

        this.registrationVersions = new java.util.ArrayList<RegistrationVersionInformation>(registrationVersions);
    }
     ...
     * {@link #setRegistrationVersions(java.util.Collection)} or {@link #withRegistrationVersions(java.util.Collection)}
    ...
    public DescribeRegistrationVersionsResult withRegistrationVersions(RegistrationVersionInformation... registrationVersions) {
        if (this.registrationVersions == null) {
            setRegistrationVersions(new java.util.ArrayList<RegistrationVersionInformation>(registrationVersions.length));
        }
        for (RegistrationVersionInformation ele : registrationVersions) {
            this.registrationVersions.add(ele);
        }
        return this;
    }
    ...
    public DescribeRegistrationVersionsResult withRegistrationVersions(java.util.Collection<RegistrationVersionInformation> registrationVersions) {
        setRegistrationVersions(registrationVersions);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeRegistrationVersionsResult == false)
            return false;
        DescribeRegistrationVersionsResult other = (DescribeRegistrationVersionsResult) obj;
        ...
        if (other.getRegistrationId() != null && other.getRegistrationId().equals(this.getRegistrationId()) == false)
            return false;
        if (other.getRegistrationVersions() == null ^ this.getRegistrationVersions() == null)
            return false;
        if (other.getRegistrationVersions() != null && other.getRegistrationVersions().equals(this.getRegistrationVersions()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getRegistrationVersions() == null) ? 0 : getRegistrationVersions().hashCode());
