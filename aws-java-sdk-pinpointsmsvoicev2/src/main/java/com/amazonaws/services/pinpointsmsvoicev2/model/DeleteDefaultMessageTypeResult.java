...
public class DeleteDefaultMessageTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteDefaultMessageTypeResult withMessageType(String messageType) {
    ...
    public DeleteDefaultMessageTypeResult withMessageType(MessageType messageType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDefaultMessageTypeResult == false)
            return false;
        DeleteDefaultMessageTypeResult other = (DeleteDefaultMessageTypeResult) obj;
    ...
    @Override
    public DeleteDefaultMessageTypeResult clone() {
        try {
            return (DeleteDefaultMessageTypeResult) super.clone();
