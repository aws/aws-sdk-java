...
public class DescribePoolsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<PoolFilter> filters;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The unique identifier of pools to find. This is an array of strings that can be either the PoolId or
     *         PoolArn.
     */
    ...
    public DescribePoolsRequest withPoolIds(String... poolIds) {
        if (this.poolIds == null) {
            setPoolIds(new java.util.ArrayList<String>(poolIds.length));
        }
    ...
    public DescribePoolsRequest withPoolIds(java.util.Collection<String> poolIds) {
        setPoolIds(poolIds);
        return this;
    }
     ...
     * </p>
     * 
     * @return An array of PoolFilter objects to filter the results.
     */

    public java.util.List<PoolFilter> getFilters() {
        return filters;
    }
    ...
    public void setFilters(java.util.Collection<PoolFilter> filters) {
        if (filters == null) {
            this.filters = null;
            return;
        }

        this.filters = new java.util.ArrayList<PoolFilter>(filters);
    }
    ...
    public DescribePoolsRequest withFilters(PoolFilter... filters) {
        if (this.filters == null) {
            setFilters(new java.util.ArrayList<PoolFilter>(filters.length));
        }
    ...
    public DescribePoolsRequest withFilters(java.util.Collection<PoolFilter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribePoolsRequest == false)
            return false;
