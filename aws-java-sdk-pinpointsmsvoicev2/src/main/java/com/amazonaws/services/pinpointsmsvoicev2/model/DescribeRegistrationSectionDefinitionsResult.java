...
public class DescribeRegistrationSectionDefinitionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     */
    private java.util.List<RegistrationSectionDefinition> registrationSectionDefinitions;
    /**
     * <p>
    ...
    public java.util.List<RegistrationSectionDefinition> getRegistrationSectionDefinitions() {
    ...
    public void setRegistrationSectionDefinitions(java.util.Collection<RegistrationSectionDefinition> registrationSectionDefinitions) {
        if (registrationSectionDefinitions == null) {
            this.registrationSectionDefinitions = null;
            return;
        }

        this.registrationSectionDefinitions = new java.util.ArrayList<RegistrationSectionDefinition>(registrationSectionDefinitions);
    }
    ...
    public DescribeRegistrationSectionDefinitionsResult withRegistrationSectionDefinitions(RegistrationSectionDefinition... registrationSectionDefinitions) {
        if (this.registrationSectionDefinitions == null) {
            setRegistrationSectionDefinitions(new java.util.ArrayList<RegistrationSectionDefinition>(registrationSectionDefinitions.length));
        }
    ...
    public DescribeRegistrationSectionDefinitionsResult withRegistrationSectionDefinitions(
            java.util.Collection<RegistrationSectionDefinition> registrationSectionDefinitions) {
