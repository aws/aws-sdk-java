...
public class CreateProtectConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateProtectConfigurationResult withCreatedTimestamp(java.util.Date createdTimestamp) {
    ...
    public CreateProtectConfigurationResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public CreateProtectConfigurationResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateProtectConfigurationResult == false)
            return false;
        CreateProtectConfigurationResult other = (CreateProtectConfigurationResult) obj;
    ...
    public CreateProtectConfigurationResult clone() {
        try {
            return (CreateProtectConfigurationResult) super.clone();
