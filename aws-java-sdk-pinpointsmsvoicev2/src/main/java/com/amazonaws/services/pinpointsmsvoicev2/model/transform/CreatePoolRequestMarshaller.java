...
public class CreatePoolRequestMarshaller {
    ...
    private static final CreatePoolRequestMarshaller instance = new CreatePoolRequestMarshaller();

    public static CreatePoolRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreatePoolRequest createPoolRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createPoolRequest.getOriginationIdentity(), ORIGINATIONIDENTITY_BINDING);
            protocolMarshaller.marshall(createPoolRequest.getIsoCountryCode(), ISOCOUNTRYCODE_BINDING);
            protocolMarshaller.marshall(createPoolRequest.getMessageType(), MESSAGETYPE_BINDING);
            protocolMarshaller.marshall(createPoolRequest.getDeletionProtectionEnabled(), DELETIONPROTECTIONENABLED_BINDING);
            protocolMarshaller.marshall(createPoolRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(createPoolRequest.getClientToken(), CLIENTTOKEN_BINDING);
        } catch (Exception e) {
