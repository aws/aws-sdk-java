...
public class SetAccountDefaultProtectConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public SetAccountDefaultProtectConfigurationRequest withProtectConfigurationId(String protectConfigurationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetAccountDefaultProtectConfigurationRequest == false)
            return false;
        SetAccountDefaultProtectConfigurationRequest other = (SetAccountDefaultProtectConfigurationRequest) obj;
    ...
    @Override
    public SetAccountDefaultProtectConfigurationRequest clone() {
        return (SetAccountDefaultProtectConfigurationRequest) super.clone();
    }
