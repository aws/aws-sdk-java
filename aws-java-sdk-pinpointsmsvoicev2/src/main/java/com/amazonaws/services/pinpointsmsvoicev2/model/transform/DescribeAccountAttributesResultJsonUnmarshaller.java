    ...
    public DescribeAccountAttributesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AccountAttributes", targetDepth)) {
                    context.nextToken();
                    describeAccountAttributesResult.setAccountAttributes(new ListUnmarshaller<AccountAttribute>(AccountAttributeJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeAccountAttributesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
