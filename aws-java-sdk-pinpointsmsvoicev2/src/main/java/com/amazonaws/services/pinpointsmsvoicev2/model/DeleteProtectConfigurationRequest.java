...
public class DeleteProtectConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteProtectConfigurationRequest withProtectConfigurationId(String protectConfigurationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteProtectConfigurationRequest == false)
            return false;
        DeleteProtectConfigurationRequest other = (DeleteProtectConfigurationRequest) obj;
    ...
    @Override
    public DeleteProtectConfigurationRequest clone() {
        return (DeleteProtectConfigurationRequest) super.clone();
    }
