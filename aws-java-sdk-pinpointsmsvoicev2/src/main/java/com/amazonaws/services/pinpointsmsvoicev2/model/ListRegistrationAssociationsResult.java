...
public class ListRegistrationAssociationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<RegistrationAssociationMetadata> registrationAssociations;
    /**
     * <p>
    ...
    public java.util.List<RegistrationAssociationMetadata> getRegistrationAssociations() {
    ...
    public void setRegistrationAssociations(java.util.Collection<RegistrationAssociationMetadata> registrationAssociations) {
        if (registrationAssociations == null) {
            this.registrationAssociations = null;
            return;
        }

        this.registrationAssociations = new java.util.ArrayList<RegistrationAssociationMetadata>(registrationAssociations);
    }
    ...
    public ListRegistrationAssociationsResult withRegistrationAssociations(RegistrationAssociationMetadata... registrationAssociations) {
        if (this.registrationAssociations == null) {
            setRegistrationAssociations(new java.util.ArrayList<RegistrationAssociationMetadata>(registrationAssociations.length));
        }
    ...
    public ListRegistrationAssociationsResult withRegistrationAssociations(java.util.Collection<RegistrationAssociationMetadata> registrationAssociations) {
