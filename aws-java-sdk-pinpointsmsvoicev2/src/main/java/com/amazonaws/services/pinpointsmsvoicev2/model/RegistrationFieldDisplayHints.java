 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-v2-2022-03-31/RegistrationFieldDisplayHints"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RegistrationFieldDisplayHints implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<SelectOptionDescription> selectOptionDescriptions;
    /**
     * <p>
    ...
    public java.util.List<SelectOptionDescription> getSelectOptionDescriptions() {
    ...
    public void setSelectOptionDescriptions(java.util.Collection<SelectOptionDescription> selectOptionDescriptions) {
        if (selectOptionDescriptions == null) {
            this.selectOptionDescriptions = null;
            return;
        }

        this.selectOptionDescriptions = new java.util.ArrayList<SelectOptionDescription>(selectOptionDescriptions);
    }
     ...
     * {@link #setSelectOptionDescriptions(java.util.Collection)} or
     * {@link #withSelectOptionDescriptions(java.util.Collection)} if you want to override the existing values.
     * </p>
     * 
     * @param selectOptionDescriptions
     *        An array of SelectOptionDescription objects.
    ...
    public RegistrationFieldDisplayHints withSelectOptionDescriptions(SelectOptionDescription... selectOptionDescriptions) {
        if (this.selectOptionDescriptions == null) {
            setSelectOptionDescriptions(new java.util.ArrayList<SelectOptionDescription>(selectOptionDescriptions.length));
        }
        for (SelectOptionDescription ele : selectOptionDescriptions) {
            this.selectOptionDescriptions.add(ele);
        }
        return this;
    }
    ...
    public RegistrationFieldDisplayHints withSelectOptionDescriptions(java.util.Collection<SelectOptionDescription> selectOptionDescriptions) {
        setSelectOptionDescriptions(selectOptionDescriptions);
        return this;
    }
    ...
    public void setTextValidationDescription(String textValidationDescription) {
    ...
    public String getTextValidationDescription() {
    ...
    public RegistrationFieldDisplayHints withTextValidationDescription(String textValidationDescription) {
        setTextValidationDescription(textValidationDescription);
        return this;
    }
    ...
    public void setExampleTextValue(String exampleTextValue) {
    ...
    public String getExampleTextValue() {
    ...
    public RegistrationFieldDisplayHints withExampleTextValue(String exampleTextValue) {
        setExampleTextValue(exampleTextValue);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getDocumentationLink() != null)
            sb.append("DocumentationLink: ").append(getDocumentationLink()).append(",");
        if (getSelectOptionDescriptions() != null)
            sb.append("SelectOptionDescriptions: ").append(getSelectOptionDescriptions()).append(",");
        if (getTextValidationDescription() != null)
            sb.append("TextValidationDescription: ").append(getTextValidationDescription()).append(",");
        if (getExampleTextValue() != null)
            sb.append("ExampleTextValue: ").append(getExampleTextValue());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RegistrationFieldDisplayHints == false)
            return false;
        ...
        if (other.getDocumentationLink() != null && other.getDocumentationLink().equals(this.getDocumentationLink()) == false)
            return false;
        if (other.getSelectOptionDescriptions() == null ^ this.getSelectOptionDescriptions() == null)
            return false;
        if (other.getSelectOptionDescriptions() != null && other.getSelectOptionDescriptions().equals(this.getSelectOptionDescriptions()) == false)
            return false;
        if (other.getTextValidationDescription() == null ^ this.getTextValidationDescription() == null)
            return false;
        if (other.getTextValidationDescription() != null && other.getTextValidationDescription().equals(this.getTextValidationDescription()) == false)
            return false;
        if (other.getExampleTextValue() == null ^ this.getExampleTextValue() == null)
            return false;
        if (other.getExampleTextValue() != null && other.getExampleTextValue().equals(this.getExampleTextValue()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSelectOptionDescriptions() == null) ? 0 : getSelectOptionDescriptions().hashCode());
        hashCode = prime * hashCode + ((getTextValidationDescription() == null) ? 0 : getTextValidationDescription().hashCode());
        hashCode = prime * hashCode + ((getExampleTextValue() == null) ? 0 : getExampleTextValue().hashCode());
        return hashCode;
    }
    ...
    public RegistrationFieldDisplayHints clone() {
        try {
            return (RegistrationFieldDisplayHints) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pinpointsmsvoicev2.model.transform.RegistrationFieldDisplayHintsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
