...
public class VerifyDestinationNumberResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The status for being able to send messages to the phone number.
     * @see VerificationStatus
     */
    ...
    public VerifyDestinationNumberResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public VerifyDestinationNumberResult withStatus(VerificationStatus status) {
    ...
    public VerifyDestinationNumberResult withCreatedTimestamp(java.util.Date createdTimestamp) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VerifyDestinationNumberResult == false)
            return false;
        VerifyDestinationNumberResult other = (VerifyDestinationNumberResult) obj;
    ...
    @Override
    public VerifyDestinationNumberResult clone() {
        try {
            return (VerifyDestinationNumberResult) super.clone();
