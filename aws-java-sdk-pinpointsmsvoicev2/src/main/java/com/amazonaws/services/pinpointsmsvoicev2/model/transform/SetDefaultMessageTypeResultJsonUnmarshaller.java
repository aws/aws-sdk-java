...
/**
 * SetDefaultMessageTypeResult JSON Unmarshaller
 */
...
public class SetDefaultMessageTypeResultJsonUnmarshaller implements Unmarshaller<SetDefaultMessageTypeResult, JsonUnmarshallerContext> {
    ...
    public SetDefaultMessageTypeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ConfigurationSetArn", targetDepth)) {
                    context.nextToken();
                    setDefaultMessageTypeResult.setConfigurationSetArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ConfigurationSetName", targetDepth)) {
                    context.nextToken();
                    setDefaultMessageTypeResult.setConfigurationSetName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MessageType", targetDepth)) {
                    context.nextToken();
                    setDefaultMessageTypeResult.setMessageType(context.getUnmarshaller(String.class).unmarshall(context));
                }
