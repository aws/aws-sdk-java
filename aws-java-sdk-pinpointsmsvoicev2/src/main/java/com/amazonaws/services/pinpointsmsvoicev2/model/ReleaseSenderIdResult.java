...
public class ReleaseSenderIdResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The sender ID that was released.
     */
    ...
    public ReleaseSenderIdResult withMessageTypes(java.util.Collection<String> messageTypes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReleaseSenderIdResult == false)
            return false;
        ReleaseSenderIdResult other = (ReleaseSenderIdResult) obj;
    ...
    public ReleaseSenderIdResult clone() {
        try {
            return (ReleaseSenderIdResult) super.clone();
