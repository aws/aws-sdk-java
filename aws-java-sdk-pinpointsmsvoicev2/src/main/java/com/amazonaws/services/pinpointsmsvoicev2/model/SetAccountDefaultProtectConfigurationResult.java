...
public class SetAccountDefaultProtectConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetAccountDefaultProtectConfigurationResult == false)
            return false;
        SetAccountDefaultProtectConfigurationResult other = (SetAccountDefaultProtectConfigurationResult) obj;
    ...
    public SetAccountDefaultProtectConfigurationResult clone() {
        try {
            return (SetAccountDefaultProtectConfigurationResult) super.clone();
