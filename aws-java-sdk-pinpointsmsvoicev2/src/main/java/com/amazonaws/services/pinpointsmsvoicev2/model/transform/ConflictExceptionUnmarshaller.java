...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.pinpointsmsvoicev2.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.pinpointsmsvoicev2.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.pinpointsmsvoicev2.model.ConflictException conflictException = new com.amazonaws.services.pinpointsmsvoicev2.model.ConflictException(
                null);
