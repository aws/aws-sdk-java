...
public class DescribeRegistrationSectionDefinitionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<String> sectionPaths;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return An array of paths for the registration form section.
     */

    public java.util.List<String> getSectionPaths() {
        return sectionPaths;
    }
    ...
    public void setSectionPaths(java.util.Collection<String> sectionPaths) {
        if (sectionPaths == null) {
            this.sectionPaths = null;
            return;
        }

        this.sectionPaths = new java.util.ArrayList<String>(sectionPaths);
    }
     ...
     * {@link #setSectionPaths(java.util.Collection)} or {@link #withSectionPaths(java.util.Collection)} if you want to
    ...
    public DescribeRegistrationSectionDefinitionsRequest withSectionPaths(String... sectionPaths) {
        if (this.sectionPaths == null) {
            setSectionPaths(new java.util.ArrayList<String>(sectionPaths.length));
        }
        for (String ele : sectionPaths) {
            this.sectionPaths.add(ele);
        }
        return this;
    }
    ...
    public DescribeRegistrationSectionDefinitionsRequest withSectionPaths(java.util.Collection<String> sectionPaths) {
        setSectionPaths(sectionPaths);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeRegistrationSectionDefinitionsRequest == false)
            return false;
        DescribeRegistrationSectionDefinitionsRequest other = (DescribeRegistrationSectionDefinitionsRequest) obj;
        ...
        if (other.getRegistrationType() != null && other.getRegistrationType().equals(this.getRegistrationType()) == false)
            return false;
        if (other.getSectionPaths() == null ^ this.getSectionPaths() == null)
            return false;
        if (other.getSectionPaths() != null && other.getSectionPaths().equals(this.getSectionPaths()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSectionPaths() == null) ? 0 : getSectionPaths().hashCode());
