...
public class AssociateProtectConfigurationRequestMarshaller {
    ...
    private static final AssociateProtectConfigurationRequestMarshaller instance = new AssociateProtectConfigurationRequestMarshaller();

    public static AssociateProtectConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssociateProtectConfigurationRequest associateProtectConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(associateProtectConfigurationRequest.getProtectConfigurationId(), PROTECTCONFIGURATIONID_BINDING);
            protocolMarshaller.marshall(associateProtectConfigurationRequest.getConfigurationSetName(), CONFIGURATIONSETNAME_BINDING);
        } catch (Exception e) {
