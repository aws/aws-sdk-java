...
public class SubmitRegistrationVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public SubmitRegistrationVersionResult withRegistrationVersionStatus(String registrationVersionStatus) {
    ...
    public SubmitRegistrationVersionResult withRegistrationVersionStatus(RegistrationVersionStatus registrationVersionStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SubmitRegistrationVersionResult == false)
            return false;
        SubmitRegistrationVersionResult other = (SubmitRegistrationVersionResult) obj;
    ...
    @Override
    public SubmitRegistrationVersionResult clone() {
        try {
            return (SubmitRegistrationVersionResult) super.clone();
