 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/emr-serverless-2021-07-13/WorkerTypeSpecificationInput"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorkerTypeSpecificationInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WorkerTypeSpecificationInput == false)
            return false;
    ...
    @Override
    public WorkerTypeSpecificationInput clone() {
        try {
            return (WorkerTypeSpecificationInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.emrserverless.model.transform.WorkerTypeSpecificationInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
