...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.emrserverless.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.emrserverless.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.emrserverless.model.ConflictException conflictException = new com.amazonaws.services.emrserverless.model.ConflictException(null);
