        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("applicationId", targetDepth)) {
                    context.nextToken();
                    startJobRunResult.setApplicationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("jobRunId", targetDepth)) {
                    context.nextToken();
                    startJobRunResult.setJobRunId(context.getUnmarshaller(String.class).unmarshall(context));
                }
