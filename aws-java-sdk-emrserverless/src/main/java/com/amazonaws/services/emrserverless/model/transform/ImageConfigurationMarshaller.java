...
public class ImageConfigurationMarshaller {
    ...
    public void marshall(ImageConfiguration imageConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(imageConfiguration.getImageUri(), IMAGEURI_BINDING);
            protocolMarshaller.marshall(imageConfiguration.getResolvedImageDigest(), RESOLVEDIMAGEDIGEST_BINDING);
        } catch (Exception e) {
