...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.emrserverless.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.emrserverless.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.emrserverless.model.InternalServerException internalServerException = new com.amazonaws.services.emrserverless.model.InternalServerException(
                null);
