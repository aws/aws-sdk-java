...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.emrserverless.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.emrserverless.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.emrserverless.model.ValidationException validationException = new com.amazonaws.services.emrserverless.model.ValidationException(
                null);
