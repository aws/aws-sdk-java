...
public class CreateUserAccessLoggingSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateUserAccessLoggingSettingsResult withUserAccessLoggingSettingsArn(String userAccessLoggingSettingsArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateUserAccessLoggingSettingsResult == false)
            return false;
        CreateUserAccessLoggingSettingsResult other = (CreateUserAccessLoggingSettingsResult) obj;
    ...
    @Override
    public CreateUserAccessLoggingSettingsResult clone() {
        try {
            return (CreateUserAccessLoggingSettingsResult) super.clone();
