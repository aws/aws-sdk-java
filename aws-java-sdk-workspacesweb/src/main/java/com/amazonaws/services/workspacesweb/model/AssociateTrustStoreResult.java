...
public class AssociateTrustStoreResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateTrustStoreResult == false)
            return false;
        AssociateTrustStoreResult other = (AssociateTrustStoreResult) obj;
    ...
    public AssociateTrustStoreResult clone() {
        try {
            return (AssociateTrustStoreResult) super.clone();
