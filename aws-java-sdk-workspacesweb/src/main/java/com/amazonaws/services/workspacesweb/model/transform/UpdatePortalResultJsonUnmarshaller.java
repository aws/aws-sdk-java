...
/**
 * UpdatePortalResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdatePortalResultJsonUnmarshaller implements Unmarshaller<UpdatePortalResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("portal", targetDepth)) {
                    context.nextToken();
                    updatePortalResult.setPortal(PortalJsonUnmarshaller.getInstance().unmarshall(context));
                }
