...
public class CreateBrowserSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateBrowserSettingsResult withBrowserSettingsArn(String browserSettingsArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBrowserSettingsResult == false)
            return false;
        CreateBrowserSettingsResult other = (CreateBrowserSettingsResult) obj;
    ...
    @Override
    public CreateBrowserSettingsResult clone() {
        try {
            return (CreateBrowserSettingsResult) super.clone();
