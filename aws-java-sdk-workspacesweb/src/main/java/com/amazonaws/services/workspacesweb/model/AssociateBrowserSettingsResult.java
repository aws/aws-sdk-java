...
public class AssociateBrowserSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateBrowserSettingsResult == false)
            return false;
        AssociateBrowserSettingsResult other = (AssociateBrowserSettingsResult) obj;
    ...
    public AssociateBrowserSettingsResult clone() {
        try {
            return (AssociateBrowserSettingsResult) super.clone();
