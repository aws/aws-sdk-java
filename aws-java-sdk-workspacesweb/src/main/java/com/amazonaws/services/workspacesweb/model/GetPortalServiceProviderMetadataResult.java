...
public class GetPortalServiceProviderMetadataResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public GetPortalServiceProviderMetadataResult withPortalArn(String portalArn) {
     ...
     * </p>
     * 
     * @return The service provider SAML metadata.
     */
    ...
    public GetPortalServiceProviderMetadataResult withServiceProviderSamlMetadata(String serviceProviderSamlMetadata) {
    ...
    public String toString() {
        ...
        if (getServiceProviderSamlMetadata() != null)
            sb.append("ServiceProviderSamlMetadata: ").append(getServiceProviderSamlMetadata());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPortalServiceProviderMetadataResult == false)
            return false;
        GetPortalServiceProviderMetadataResult other = (GetPortalServiceProviderMetadataResult) obj;
    ...
    @Override
    public GetPortalServiceProviderMetadataResult clone() {
        try {
            return (GetPortalServiceProviderMetadataResult) super.clone();
