...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.workspacesweb.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.workspacesweb.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.workspacesweb.model.ConflictException conflictException = new com.amazonaws.services.workspacesweb.model.ConflictException(null);
