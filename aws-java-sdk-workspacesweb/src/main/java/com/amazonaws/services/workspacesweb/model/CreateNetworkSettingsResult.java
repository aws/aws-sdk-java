...
public class CreateNetworkSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateNetworkSettingsResult withNetworkSettingsArn(String networkSettingsArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateNetworkSettingsResult == false)
            return false;
        CreateNetworkSettingsResult other = (CreateNetworkSettingsResult) obj;
    ...
    @Override
    public CreateNetworkSettingsResult clone() {
        try {
            return (CreateNetworkSettingsResult) super.clone();
