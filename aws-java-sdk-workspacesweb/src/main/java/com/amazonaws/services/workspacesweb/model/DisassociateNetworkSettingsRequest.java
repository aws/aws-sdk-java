...
public class DisassociateNetworkSettingsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateNetworkSettingsRequest == false)
            return false;
        DisassociateNetworkSettingsRequest other = (DisassociateNetworkSettingsRequest) obj;
    ...
    @Override
    public DisassociateNetworkSettingsRequest clone() {
        return (DisassociateNetworkSettingsRequest) super.clone();
    }
