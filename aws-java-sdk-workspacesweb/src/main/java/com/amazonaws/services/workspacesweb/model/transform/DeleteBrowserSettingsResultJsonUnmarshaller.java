...
/**
 * DeleteBrowserSettingsResult JSON Unmarshaller
 */
...
public class DeleteBrowserSettingsResultJsonUnmarshaller implements Unmarshaller<DeleteBrowserSettingsResult, JsonUnmarshallerContext> {
    ...
    public DeleteBrowserSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteBrowserSettingsResult deleteBrowserSettingsResult = new DeleteBrowserSettingsResult();
