...
public class GetPortalRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetPortalRequest withPortalArn(String portalArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPortalRequest == false)
            return false;
        GetPortalRequest other = (GetPortalRequest) obj;
    ...
    public GetPortalRequest clone() {
        return (GetPortalRequest) super.clone();
    }
