...
/**
 * DeleteUserAccessLoggingSettingsResult JSON Unmarshaller
 */
...
public class DeleteUserAccessLoggingSettingsResultJsonUnmarshaller implements Unmarshaller<DeleteUserAccessLoggingSettingsResult, JsonUnmarshallerContext> {
    ...
    public DeleteUserAccessLoggingSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteUserAccessLoggingSettingsResult deleteUserAccessLoggingSettingsResult = new DeleteUserAccessLoggingSettingsResult();
