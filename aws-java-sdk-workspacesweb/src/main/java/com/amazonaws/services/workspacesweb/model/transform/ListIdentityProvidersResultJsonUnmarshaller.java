...
/**
 * ListIdentityProvidersResult JSON Unmarshaller
 */
...
public class ListIdentityProvidersResultJsonUnmarshaller implements Unmarshaller<ListIdentityProvidersResult, JsonUnmarshallerContext> {
    ...
    public ListIdentityProvidersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("identityProviders", targetDepth)) {
                    context.nextToken();
                    listIdentityProvidersResult.setIdentityProviders(new ListUnmarshaller<IdentityProviderSummary>(IdentityProviderSummaryJsonUnmarshaller
                            .getInstance())
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listIdentityProvidersResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
