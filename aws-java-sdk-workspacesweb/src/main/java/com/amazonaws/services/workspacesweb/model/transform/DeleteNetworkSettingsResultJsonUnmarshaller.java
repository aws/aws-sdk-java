...
/**
 * DeleteNetworkSettingsResult JSON Unmarshaller
 */
...
public class DeleteNetworkSettingsResultJsonUnmarshaller implements Unmarshaller<DeleteNetworkSettingsResult, JsonUnmarshallerContext> {
    ...
    public DeleteNetworkSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteNetworkSettingsResult deleteNetworkSettingsResult = new DeleteNetworkSettingsResult();
