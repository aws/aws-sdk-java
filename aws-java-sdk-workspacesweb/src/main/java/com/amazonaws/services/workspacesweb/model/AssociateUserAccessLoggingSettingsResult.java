...
public class AssociateUserAccessLoggingSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateUserAccessLoggingSettingsResult == false)
            return false;
        AssociateUserAccessLoggingSettingsResult other = (AssociateUserAccessLoggingSettingsResult) obj;
    ...
    public AssociateUserAccessLoggingSettingsResult clone() {
        try {
            return (AssociateUserAccessLoggingSettingsResult) super.clone();
