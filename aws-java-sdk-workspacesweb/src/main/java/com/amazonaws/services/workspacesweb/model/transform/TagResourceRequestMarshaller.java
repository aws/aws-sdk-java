...
public class TagResourceRequestMarshaller {
    ...
    private static final MarshallingInfo<String> RESOURCEARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.GREEDY_PATH).marshallLocationName("resourceArn").build();
    ...
    public void marshall(TagResourceRequest tagResourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(tagResourceRequest.getClientToken(), CLIENTTOKEN_BINDING);
