...
public class DescribeStacksResultStaxUnmarshaller implements
    ...
    public DescribeStacksResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Stacks/member", targetDepth)) {
                    describeStacksResult.getStacks().add(
                            StackStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }

                if (context.testExpression("NextToken", targetDepth)) {
                    describeStacksResult.setNextToken(StringStaxUnmarshaller
