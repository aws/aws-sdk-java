...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.cloudformation.AmazonCloudFormationAsync}. Use
 * of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonCloudFormationAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonCloudFormationAsyncClientBuilder, AmazonCloudFormationAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonCloudFormationAsync
     * using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AmazonCloudFormationAsync.
     */
    @Override
    protected AmazonCloudFormationAsync build(AwsAsyncClientParams params) {
