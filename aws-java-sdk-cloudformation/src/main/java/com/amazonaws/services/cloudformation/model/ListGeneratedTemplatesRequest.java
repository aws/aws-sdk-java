...
public class ListGeneratedTemplatesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <code>ListGeneratedTemplates</code> API action will return at most 50 results in each response. The maximum value
     * is 100.
     * </p>
     */
     ...
     *        the <code>ListGeneratedTemplates</code> API action will return at most 50 results in each response. The
     ...
     *         default the <code>ListGeneratedTemplates</code> API action will return at most 50 results in each
    ...
    public ListGeneratedTemplatesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListGeneratedTemplatesRequest == false)
            return false;
        ListGeneratedTemplatesRequest other = (ListGeneratedTemplatesRequest) obj;
    ...
    public ListGeneratedTemplatesRequest clone() {
        return (ListGeneratedTemplatesRequest) super.clone();
    }
