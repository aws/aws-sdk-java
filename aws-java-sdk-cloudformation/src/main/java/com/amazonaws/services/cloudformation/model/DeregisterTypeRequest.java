...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cloudformation-2010-05-15/DeregisterType" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeregisterTypeRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeregisterTypeRequest withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public DeregisterTypeRequest withType(String type) {
        setType(type);
        return this;
    }
    ...
    public DeregisterTypeRequest withType(RegistryType type) {
    ...
    public DeregisterTypeRequest withTypeName(String typeName) {
    ...
    public DeregisterTypeRequest withVersionId(String versionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeregisterTypeRequest == false)
            return false;
        DeregisterTypeRequest other = (DeregisterTypeRequest) obj;
    ...
    @Override
    public DeregisterTypeRequest clone() {
        return (DeregisterTypeRequest) super.clone();
    }
