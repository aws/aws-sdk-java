...
public class DescribeStackDriftDetectionStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeStackDriftDetectionStatusRequest clone() {
        return (DescribeStackDriftDetectionStatusRequest) super.clone();
    }
