...
/**
 * DescribeStackSetResult StAX Unmarshaller
 */
...
public class DescribeStackSetResultStaxUnmarshaller implements Unmarshaller<DescribeStackSetResult, StaxUnmarshallerContext> {
    ...
    public DescribeStackSetResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("StackSet", targetDepth)) {
                    describeStackSetResult.setStackSet(StackSetStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
