 ...
 */
public class DescribeStackEventsResultStaxUnmarshaller implements
        Unmarshaller<DescribeStackEventsResult, StaxUnmarshallerContext> {

    public DescribeStackEventsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
