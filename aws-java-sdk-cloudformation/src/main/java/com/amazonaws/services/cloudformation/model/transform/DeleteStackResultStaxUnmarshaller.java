 ...
 */
public class DeleteStackResultStaxUnmarshaller implements
        Unmarshaller<DeleteStackResult, StaxUnmarshallerContext> {

    public DeleteStackResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
