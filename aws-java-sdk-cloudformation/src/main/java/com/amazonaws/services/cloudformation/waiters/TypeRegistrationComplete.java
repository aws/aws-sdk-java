...
class TypeRegistrationComplete {
    ...
    static class IsCOMPLETEMatcher extends WaiterAcceptor<DescribeTypeRegistrationResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("ProgressStatus");
         ...
         */
        @Override
        public boolean matches(DescribeTypeRegistrationResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<DescribeTypeRegistrationResult> {
        private static final JsonNode expectedResult;
