...
/**
 * ScannedResourceIdentifier StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScannedResourceIdentifierStaxUnmarshaller implements Unmarshaller<ScannedResourceIdentifier, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ResourceType", targetDepth)) {
                    scannedResourceIdentifier.setResourceType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
