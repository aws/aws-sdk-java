...
public class SignalResourceRequestMarshaller implements
    ...
    public Request<SignalResourceRequest> marshall(
        ...
        Request<SignalResourceRequest> request = new DefaultRequest<SignalResourceRequest>(
                signalResourceRequest, "AmazonCloudFormation");
        ...
        if (signalResourceRequest.getStackName() != null) {
            request.addParameter("StackName", StringUtils
                    .fromString(signalResourceRequest.getStackName()));
        }

        if (signalResourceRequest.getLogicalResourceId() != null) {
            request.addParameter("LogicalResourceId", StringUtils
                    .fromString(signalResourceRequest.getLogicalResourceId()));
        }

        if (signalResourceRequest.getUniqueId() != null) {
            request.addParameter("UniqueId",
                    StringUtils.fromString(signalResourceRequest.getUniqueId()));
        }

        if (signalResourceRequest.getStatus() != null) {
            request.addParameter("Status",
                    StringUtils.fromString(signalResourceRequest.getStatus()));
        }
