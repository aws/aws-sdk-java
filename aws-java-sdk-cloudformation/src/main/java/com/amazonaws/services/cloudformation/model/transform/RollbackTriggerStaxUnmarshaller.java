        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Arn", targetDepth)) {
                    rollbackTrigger.setArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Type", targetDepth)) {
                    rollbackTrigger.setType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
