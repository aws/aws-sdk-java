...
public class DeleteGeneratedTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteGeneratedTemplateRequest withGeneratedTemplateName(String generatedTemplateName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteGeneratedTemplateRequest == false)
            return false;
        DeleteGeneratedTemplateRequest other = (DeleteGeneratedTemplateRequest) obj;
    ...
    @Override
    public DeleteGeneratedTemplateRequest clone() {
        return (DeleteGeneratedTemplateRequest) super.clone();
    }
