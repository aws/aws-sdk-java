...
public class DeleteChangeSetRequestMarshaller implements
    ...
    public Request<DeleteChangeSetRequest> marshall(
        ...
        Request<DeleteChangeSetRequest> request = new DefaultRequest<DeleteChangeSetRequest>(
                deleteChangeSetRequest, "AmazonCloudFormation");
        ...
        if (deleteChangeSetRequest.getChangeSetName() != null) {
            request.addParameter("ChangeSetName", StringUtils
                    .fromString(deleteChangeSetRequest.getChangeSetName()));
        }

        if (deleteChangeSetRequest.getStackName() != null) {
            request.addParameter("StackName", StringUtils
                    .fromString(deleteChangeSetRequest.getStackName()));
        }
