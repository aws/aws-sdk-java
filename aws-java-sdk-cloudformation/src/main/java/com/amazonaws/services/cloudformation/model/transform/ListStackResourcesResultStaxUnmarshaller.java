...
public class ListStackResourcesResultStaxUnmarshaller implements
    ...
    public ListStackResourcesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("StackResourceSummaries/member",
                        targetDepth)) {
                    listStackResourcesResult.getStackResourceSummaries().add(
                            StackResourceSummaryStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
