 ...
 */
public class DeleteChangeSetResultStaxUnmarshaller implements
        Unmarshaller<DeleteChangeSetResult, StaxUnmarshallerContext> {

    public DeleteChangeSetResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
