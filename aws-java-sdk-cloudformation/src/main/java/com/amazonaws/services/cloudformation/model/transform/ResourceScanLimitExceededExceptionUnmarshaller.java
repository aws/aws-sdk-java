...
public class ResourceScanLimitExceededExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("ResourceScanLimitExceeded"))
            return null;

        ResourceScanLimitExceededException e = (ResourceScanLimitExceededException) super.unmarshall(node);
