...
public class ResourceChangeDetail implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A <code>ResourceTargetDefinition</code> structure that describes
     *         the field that AWS CloudFormation will change and whether the
     *         resource will be recreated.
     */
     ...
     * </p>
     * 
     * @return Indicates whether AWS CloudFormation can determine the target
     ...
     * </p>
     * 
     * @return The identity of the entity that triggered this change. This
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getChangeSource() == null) ? 0 : getChangeSource()
                        .hashCode());
        hashCode = prime
                * hashCode
                + ((getCausingEntity() == null) ? 0 : getCausingEntity()
                        .hashCode());
        return hashCode;
    }
