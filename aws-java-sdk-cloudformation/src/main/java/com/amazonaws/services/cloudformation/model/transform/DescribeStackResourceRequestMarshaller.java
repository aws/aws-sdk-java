...
public class DescribeStackResourceRequestMarshaller
        implements
        Marshaller<Request<DescribeStackResourceRequest>, DescribeStackResourceRequest> {
    ...
    public Request<DescribeStackResourceRequest> marshall(
        ...
        Request<DescribeStackResourceRequest> request = new DefaultRequest<DescribeStackResourceRequest>(
