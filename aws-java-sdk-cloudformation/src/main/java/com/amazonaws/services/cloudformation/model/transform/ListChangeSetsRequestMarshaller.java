...
public class ListChangeSetsRequestMarshaller implements
    ...
    public Request<ListChangeSetsRequest> marshall(
        ...
        Request<ListChangeSetsRequest> request = new DefaultRequest<ListChangeSetsRequest>(
                listChangeSetsRequest, "AmazonCloudFormation");
        ...
        if (listChangeSetsRequest.getStackName() != null) {
            request.addParameter("StackName", StringUtils
                    .fromString(listChangeSetsRequest.getStackName()));
        }

        if (listChangeSetsRequest.getNextToken() != null) {
            request.addParameter("NextToken", StringUtils
                    .fromString(listChangeSetsRequest.getNextToken()));
        }
