...
/**
 * StackSetOperationStatusDetails StAX Unmarshaller
 */
...
public class StackSetOperationStatusDetailsStaxUnmarshaller implements Unmarshaller<StackSetOperationStatusDetails, StaxUnmarshallerContext> {
    ...
    public StackSetOperationStatusDetails unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("FailedStackInstancesCount", targetDepth)) {
                    stackSetOperationStatusDetails.setFailedStackInstancesCount(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
