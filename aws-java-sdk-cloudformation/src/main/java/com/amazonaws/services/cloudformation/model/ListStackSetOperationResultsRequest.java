...
public class ListStackSetOperationResultsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name or unique ID of the stack set that you want to get operation results for.
     */
     ...
     * </p>
     * 
     * @return The ID of the stack set operation.
     */
    ...
    public ListStackSetOperationResultsRequest clone() {
        return (ListStackSetOperationResultsRequest) super.clone();
    }
