...
class StackCreateComplete {
    ...
    static class IsCREATE_COMPLETEMatcher extends WaiterAcceptor<DescribeStacksResult> {
    ...
    static class IsDELETE_IN_PROGRESSMatcher extends WaiterAcceptor<DescribeStacksResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"DELETE_IN_PROGRESS\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsROLLBACK_COMPLETEMatcher extends WaiterAcceptor<DescribeStacksResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsROLLBACK_IN_PROGRESSMatcher extends WaiterAcceptor<DescribeStacksResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"ROLLBACK_IN_PROGRESS\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
