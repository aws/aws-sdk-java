...
/**
 * TemplateProgress StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TemplateProgressStaxUnmarshaller implements Unmarshaller<TemplateProgress, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ResourcesSucceeded", targetDepth)) {
                    templateProgress.setResourcesSucceeded(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ResourcesFailed", targetDepth)) {
                    templateProgress.setResourcesFailed(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ResourcesProcessing", targetDepth)) {
                    templateProgress.setResourcesProcessing(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ResourcesPending", targetDepth)) {
                    templateProgress.setResourcesPending(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
