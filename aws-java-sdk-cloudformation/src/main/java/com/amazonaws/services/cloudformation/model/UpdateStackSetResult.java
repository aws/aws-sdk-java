...
public class UpdateStackSetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateStackSetResult == false)
            return false;
        UpdateStackSetResult other = (UpdateStackSetResult) obj;
    ...
    public UpdateStackSetResult clone() {
        try {
            return (UpdateStackSetResult) super.clone();
