...
public class InvalidChangeSetStatusExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("InvalidChangeSetStatus"))
            return null;

        InvalidChangeSetStatusException e = (InvalidChangeSetStatusException) super
                .unmarshall(node);
