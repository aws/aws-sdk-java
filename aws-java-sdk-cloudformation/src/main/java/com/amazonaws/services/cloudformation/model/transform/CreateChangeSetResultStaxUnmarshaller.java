...
public class CreateChangeSetResultStaxUnmarshaller implements Unmarshaller<CreateChangeSetResult, StaxUnmarshallerContext> {

    public CreateChangeSetResult unmarshall(StaxUnmarshallerContext context) throws Exception {
