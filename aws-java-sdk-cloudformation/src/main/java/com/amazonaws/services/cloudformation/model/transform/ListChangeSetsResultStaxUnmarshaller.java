 ...
 */
public class ListChangeSetsResultStaxUnmarshaller implements
        Unmarshaller<ListChangeSetsResult, StaxUnmarshallerContext> {

    public ListChangeSetsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Summaries/member", targetDepth)) {
                    listChangeSetsResult.getSummaries().add(
                            ChangeSetSummaryStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }

                if (context.testExpression("NextToken", targetDepth)) {
                    listChangeSetsResult.setNextToken(StringStaxUnmarshaller
