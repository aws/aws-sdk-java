 ...
 */
public class CancelUpdateStackResultStaxUnmarshaller implements
        Unmarshaller<CancelUpdateStackResult, StaxUnmarshallerContext> {

    public CancelUpdateStackResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
