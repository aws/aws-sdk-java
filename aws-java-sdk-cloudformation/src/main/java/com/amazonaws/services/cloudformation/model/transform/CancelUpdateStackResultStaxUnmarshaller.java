...
public class CancelUpdateStackResultStaxUnmarshaller implements Unmarshaller<CancelUpdateStackResult, StaxUnmarshallerContext> {

    public CancelUpdateStackResult unmarshall(StaxUnmarshallerContext context) throws Exception {
    ...
    public static CancelUpdateStackResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new CancelUpdateStackResultStaxUnmarshaller();
        return instance;
    }
}
