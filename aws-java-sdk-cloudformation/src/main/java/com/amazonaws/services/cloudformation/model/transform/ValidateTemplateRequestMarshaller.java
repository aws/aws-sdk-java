...
public class ValidateTemplateRequestMarshaller implements
    ...
    public Request<ValidateTemplateRequest> marshall(
        ...
        Request<ValidateTemplateRequest> request = new DefaultRequest<ValidateTemplateRequest>(
                validateTemplateRequest, "AmazonCloudFormation");
        ...
        if (validateTemplateRequest.getTemplateBody() != null) {
            request.addParameter("TemplateBody", StringUtils
                    .fromString(validateTemplateRequest.getTemplateBody()));
        }

        if (validateTemplateRequest.getTemplateURL() != null) {
            request.addParameter("TemplateURL", StringUtils
                    .fromString(validateTemplateRequest.getTemplateURL()));
        }
