 ...
 * 
 */
public class PutEvaluationsRequest extends
     ...
     * </p>
     * 
     * @return The assessments that the AWS Lambda function performs. Each
    ...
    public void setEvaluations(java.util.Collection<Evaluation> evaluations) {
        ...
        this.evaluations = new com.amazonaws.internal.SdkInternalList<Evaluation>(
                evaluations);
    }
     ...
     * any). Use {@link #setEvaluations(java.util.Collection)} or
     * {@link #withEvaluations(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param evaluations
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEvaluations() == null ^ this.getEvaluations() == null)
            return false;
        if (other.getEvaluations() != null
                && other.getEvaluations().equals(this.getEvaluations()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getEvaluations() == null) ? 0 : getEvaluations().hashCode());
        hashCode = prime
                * hashCode
