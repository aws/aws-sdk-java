 ...
 */
public class DescribeDeliveryChannelStatusResultJsonUnmarshaller
        implements
        Unmarshaller<DescribeDeliveryChannelStatusResult, JsonUnmarshallerContext> {

    public DescribeDeliveryChannelStatusResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DeliveryChannelsStatus",
                        targetDepth)) {
                    context.nextToken();
                    describeDeliveryChannelStatusResult
                            .setDeliveryChannelsStatus(new ListUnmarshaller<DeliveryChannelStatus>(
