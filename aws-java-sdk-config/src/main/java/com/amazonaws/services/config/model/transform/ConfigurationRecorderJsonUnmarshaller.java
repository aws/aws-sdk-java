 ...
 */
public class ConfigurationRecorderJsonUnmarshaller implements
        Unmarshaller<ConfigurationRecorder, JsonUnmarshallerContext> {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("recordingGroup", targetDepth)) {
                    ...
                    configurationRecorder
                            .setRecordingGroup(RecordingGroupJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
