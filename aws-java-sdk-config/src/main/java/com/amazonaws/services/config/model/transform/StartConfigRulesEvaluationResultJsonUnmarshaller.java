 ...
 */
public class StartConfigRulesEvaluationResultJsonUnmarshaller implements
        Unmarshaller<StartConfigRulesEvaluationResult, JsonUnmarshallerContext> {

    public StartConfigRulesEvaluationResult unmarshall(
