...
public class MaxNumberOfOrganizationConfigRulesExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaxNumberOfOrganizationConfigRulesExceededExceptionUnmarshaller instance;

    public static MaxNumberOfOrganizationConfigRulesExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaxNumberOfOrganizationConfigRulesExceededExceptionUnmarshaller();
        return instance;
    }
}
