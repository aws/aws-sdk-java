 ...
 */
public class ListDiscoveredResourcesResultJsonUnmarshaller implements
        Unmarshaller<ListDiscoveredResourcesResult, JsonUnmarshallerContext> {

    public ListDiscoveredResourcesResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("resourceIdentifiers", targetDepth)) {
                    ...
                    listDiscoveredResourcesResult
                            .setResourceIdentifiers(new ListUnmarshaller<ResourceIdentifier>(
                                    ResourceIdentifierJsonUnmarshaller
                                            .getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listDiscoveredResourcesResult.setNextToken(context
    ...
    public static ListDiscoveredResourcesResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListDiscoveredResourcesResultJsonUnmarshaller();
        return instance;
    }
}
