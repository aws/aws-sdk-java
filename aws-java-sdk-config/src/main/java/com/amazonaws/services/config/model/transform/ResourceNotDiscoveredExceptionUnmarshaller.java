...
public class ResourceNotDiscoveredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceNotDiscoveredExceptionUnmarshaller instance;

    public static ResourceNotDiscoveredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceNotDiscoveredExceptionUnmarshaller();
        return instance;
    }
}
