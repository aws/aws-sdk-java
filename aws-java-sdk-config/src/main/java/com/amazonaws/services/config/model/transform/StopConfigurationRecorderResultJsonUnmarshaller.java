 ...
 */
public class StopConfigurationRecorderResultJsonUnmarshaller implements
        Unmarshaller<StopConfigurationRecorderResult, JsonUnmarshallerContext> {

    public StopConfigurationRecorderResult unmarshall(
            JsonUnmarshallerContext context) throws Exception {
        StopConfigurationRecorderResult stopConfigurationRecorderResult = new StopConfigurationRecorderResult();
