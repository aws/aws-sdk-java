...
public class EvaluationResultQualifierJsonMarshaller {
     ...
     */
    public void marshall(EvaluationResultQualifier evaluationResultQualifier, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (evaluationResultQualifier.getConfigRuleName() != null) {
                jsonGenerator.writeFieldName("ConfigRuleName").writeValue(evaluationResultQualifier.getConfigRuleName());
            }
            if (evaluationResultQualifier.getResourceType() != null) {
                jsonGenerator.writeFieldName("ResourceType").writeValue(evaluationResultQualifier.getResourceType());
            }
            if (evaluationResultQualifier.getResourceId() != null) {
                jsonGenerator.writeFieldName("ResourceId").writeValue(evaluationResultQualifier.getResourceId());
            }
