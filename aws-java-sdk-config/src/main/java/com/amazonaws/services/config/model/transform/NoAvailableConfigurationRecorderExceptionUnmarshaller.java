...
public class NoAvailableConfigurationRecorderExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoAvailableConfigurationRecorderExceptionUnmarshaller instance;

    public static NoAvailableConfigurationRecorderExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoAvailableConfigurationRecorderExceptionUnmarshaller();
        return instance;
    }
}
