 ...
 */
public class DeleteConfigRuleResultJsonUnmarshaller implements
        Unmarshaller<DeleteConfigRuleResult, JsonUnmarshallerContext> {

    public DeleteConfigRuleResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
