...
/**
 * DeleteConformancePackResult JSON Unmarshaller
 */
...
public class DeleteConformancePackResultJsonUnmarshaller implements Unmarshaller<DeleteConformancePackResult, JsonUnmarshallerContext> {
    ...
    public DeleteConformancePackResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteConformancePackResult deleteConformancePackResult = new DeleteConformancePackResult();
