 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/FailedDeleteRemediationExceptionsBatch"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FailedDeleteRemediationExceptionsBatch implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<RemediationExceptionResourceKey> failedItems;
    ...
    public java.util.List<RemediationExceptionResourceKey> getFailedItems() {
        if (failedItems == null) {
            failedItems = new com.amazonaws.internal.SdkInternalList<RemediationExceptionResourceKey>();
        }
        return failedItems;
    }
    ...
    public void setFailedItems(java.util.Collection<RemediationExceptionResourceKey> failedItems) {
        if (failedItems == null) {
            this.failedItems = null;
            return;
        }

        this.failedItems = new com.amazonaws.internal.SdkInternalList<RemediationExceptionResourceKey>(failedItems);
    }
    ...
    public FailedDeleteRemediationExceptionsBatch withFailedItems(RemediationExceptionResourceKey... failedItems) {
        if (this.failedItems == null) {
            setFailedItems(new com.amazonaws.internal.SdkInternalList<RemediationExceptionResourceKey>(failedItems.length));
        }
        for (RemediationExceptionResourceKey ele : failedItems) {
    ...
    public FailedDeleteRemediationExceptionsBatch withFailedItems(java.util.Collection<RemediationExceptionResourceKey> failedItems) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FailedDeleteRemediationExceptionsBatch == false)
            return false;
        FailedDeleteRemediationExceptionsBatch other = (FailedDeleteRemediationExceptionsBatch) obj;
    ...
    public FailedDeleteRemediationExceptionsBatch clone() {
        try {
            return (FailedDeleteRemediationExceptionsBatch) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.config.model.transform.FailedDeleteRemediationExceptionsBatchMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
