 ...
 */
public class EvaluationResultIdentifierJsonUnmarshaller implements
        Unmarshaller<EvaluationResultIdentifier, JsonUnmarshallerContext> {
    ...
    public EvaluationResultIdentifier unmarshall(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("EvaluationResultQualifier",
                        targetDepth)) {
                    context.nextToken();
                    evaluationResultIdentifier
                            .setEvaluationResultQualifier(EvaluationResultQualifierJsonUnmarshaller
