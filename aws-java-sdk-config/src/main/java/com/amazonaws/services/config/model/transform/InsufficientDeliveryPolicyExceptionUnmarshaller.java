...
public class InsufficientDeliveryPolicyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InsufficientDeliveryPolicyExceptionUnmarshaller instance;

    public static InsufficientDeliveryPolicyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InsufficientDeliveryPolicyExceptionUnmarshaller();
        return instance;
    }
}
