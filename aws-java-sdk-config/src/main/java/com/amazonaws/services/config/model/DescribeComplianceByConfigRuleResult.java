 ...
 * 
 */
public class DescribeComplianceByConfigRuleResult implements Serializable, Cloneable {

    /**
     * Indicates whether each of the specified AWS Config rules is compliant.
     */
    private com.amazonaws.internal.ListWithAutoConstructFlag<ComplianceByConfigRule> complianceByConfigRules;
    ...
    public java.util.List<ComplianceByConfigRule> getComplianceByConfigRules() {
        if (complianceByConfigRules == null) {
              complianceByConfigRules = new com.amazonaws.internal.ListWithAutoConstructFlag<ComplianceByConfigRule>();
              complianceByConfigRules.setAutoConstruct(true);
        }
    ...
    public void setComplianceByConfigRules(java.util.Collection<ComplianceByConfigRule> complianceByConfigRules) {
        ...
        com.amazonaws.internal.ListWithAutoConstructFlag<ComplianceByConfigRule> complianceByConfigRulesCopy = new com.amazonaws.internal.ListWithAutoConstructFlag<ComplianceByConfigRule>(complianceByConfigRules.size());
        complianceByConfigRulesCopy.addAll(complianceByConfigRules);
        this.complianceByConfigRules = complianceByConfigRulesCopy;
    }
     ...
     * {@link #withComplianceByConfigRules(java.util.Collection)} if you want
    ...
    public DescribeComplianceByConfigRuleResult withComplianceByConfigRules(ComplianceByConfigRule... complianceByConfigRules) {
        if (getComplianceByConfigRules() == null) setComplianceByConfigRules(new java.util.ArrayList<ComplianceByConfigRule>(complianceByConfigRules.length));
        for (ComplianceByConfigRule value : complianceByConfigRules) {
            getComplianceByConfigRules().add(value);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getComplianceByConfigRules() != null) sb.append("ComplianceByConfigRules: " + getComplianceByConfigRules() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeComplianceByConfigRuleResult == false) return false;
        DescribeComplianceByConfigRuleResult other = (DescribeComplianceByConfigRuleResult)obj;
        
        if (other.getComplianceByConfigRules() == null ^ this.getComplianceByConfigRules() == null) return false;
        if (other.getComplianceByConfigRules() != null && other.getComplianceByConfigRules().equals(this.getComplianceByConfigRules()) == false) return false; 
