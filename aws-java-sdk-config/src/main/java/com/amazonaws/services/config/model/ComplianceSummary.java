...
public class ComplianceSummary implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getNonCompliantResourceCount() != null)
            sb.append("NonCompliantResourceCount: "
                    + getNonCompliantResourceCount() + ",");
        if (getComplianceSummaryTimestamp() != null)
            sb.append("ComplianceSummaryTimestamp: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCompliantResourceCount() == null
                ^ this.getCompliantResourceCount() == null)
            return false;
        if (other.getCompliantResourceCount() != null
                && other.getCompliantResourceCount().equals(
                        this.getCompliantResourceCount()) == false)
            return false;
        if (other.getNonCompliantResourceCount() == null
                ^ this.getNonCompliantResourceCount() == null)
            return false;
        if (other.getNonCompliantResourceCount() != null
                && other.getNonCompliantResourceCount().equals(
                        this.getNonCompliantResourceCount()) == false)
            return false;
        if (other.getComplianceSummaryTimestamp() == null
                ^ this.getComplianceSummaryTimestamp() == null)
            return false;
        if (other.getComplianceSummaryTimestamp() != null
                && other.getComplianceSummaryTimestamp().equals(
                        this.getComplianceSummaryTimestamp()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getCompliantResourceCount() == null) ? 0
                        : getCompliantResourceCount().hashCode());
        hashCode = prime
                * hashCode
                + ((getNonCompliantResourceCount() == null) ? 0
                        : getNonCompliantResourceCount().hashCode());
        hashCode = prime
                * hashCode
                + ((getComplianceSummaryTimestamp() == null) ? 0
                        : getComplianceSummaryTimestamp().hashCode());
        return hashCode;
    }
