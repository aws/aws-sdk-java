...
/**
 * Describe Compliance By Resource Request Marshaller
 */
public class DescribeComplianceByResourceRequestMarshaller implements Marshaller<Request<DescribeComplianceByResourceRequest>, DescribeComplianceByResourceRequest> {
    ...
    public Request<DescribeComplianceByResourceRequest> marshall(DescribeComplianceByResourceRequest describeComplianceByResourceRequest) {
        ...
        Request<DescribeComplianceByResourceRequest> request = new DefaultRequest<DescribeComplianceByResourceRequest>(describeComplianceByResourceRequest, "AmazonConfig");
        ...
        try {
          ...
          jsonWriter.object();
            ...
            com.amazonaws.internal.ListWithAutoConstructFlag<String> complianceTypesList = (com.amazonaws.internal.ListWithAutoConstructFlag<String>)(describeComplianceByResourceRequest.getComplianceTypes());
