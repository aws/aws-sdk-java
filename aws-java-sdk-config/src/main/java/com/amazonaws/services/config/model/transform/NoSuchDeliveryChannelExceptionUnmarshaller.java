...
public class NoSuchDeliveryChannelExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoSuchDeliveryChannelExceptionUnmarshaller instance;

    public static NoSuchDeliveryChannelExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoSuchDeliveryChannelExceptionUnmarshaller();
        return instance;
    }
}
