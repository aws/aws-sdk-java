 ...
 */
public class DescribeDeliveryChannelStatusRequestMarshaller implements
        Marshaller<Request<DescribeDeliveryChannelStatusRequest>, DescribeDeliveryChannelStatusRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public DescribeDeliveryChannelStatusRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<DescribeDeliveryChannelStatusRequest> marshall(DescribeDeliveryChannelStatusRequest describeDeliveryChannelStatusRequest) {
        ...
        Request<DescribeDeliveryChannelStatusRequest> request = new DefaultRequest<DescribeDeliveryChannelStatusRequest>(describeDeliveryChannelStatusRequest,
                "AmazonConfig");
        ...
        try {
            ...
            com.amazonaws.internal.SdkInternalList<String> deliveryChannelNamesList = (com.amazonaws.internal.SdkInternalList<String>) describeDeliveryChannelStatusRequest
