...
/**
 * PutExternalEvaluationResult JSON Unmarshaller
 */
...
public class PutExternalEvaluationResultJsonUnmarshaller implements Unmarshaller<PutExternalEvaluationResult, JsonUnmarshallerContext> {
    ...
    public PutExternalEvaluationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutExternalEvaluationResult putExternalEvaluationResult = new PutExternalEvaluationResult();
