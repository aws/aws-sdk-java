...
public class DeleteConfigRuleRequestMarshaller implements
    ...
    public Request<DeleteConfigRuleRequest> marshall(
        ...
        Request<DeleteConfigRuleRequest> request = new DefaultRequest<DeleteConfigRuleRequest>(
                deleteConfigRuleRequest, "AmazonConfig");
        ...
        try {
            ...
            if (deleteConfigRuleRequest.getConfigRuleName() != null) {
                jsonWriter.key("ConfigRuleName").value(
                        deleteConfigRuleRequest.getConfigRuleName());
            }
