...
/**
 * Delivery Channel JSON Unmarshaller
 */
public class DeliveryChannelJsonUnmarshaller implements Unmarshaller<DeliveryChannel, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    deliveryChannel.setName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("s3BucketName", targetDepth)) {
                    context.nextToken();
                    deliveryChannel.setS3BucketName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("s3KeyPrefix", targetDepth)) {
                    context.nextToken();
                    deliveryChannel.setS3KeyPrefix(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DeliveryChannelJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeliveryChannelJsonUnmarshaller();
        return instance;
    }
}
