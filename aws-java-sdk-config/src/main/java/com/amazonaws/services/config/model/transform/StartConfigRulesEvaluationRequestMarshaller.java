...
public class StartConfigRulesEvaluationRequestMarshaller
        implements
        Marshaller<Request<StartConfigRulesEvaluationRequest>, StartConfigRulesEvaluationRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public StartConfigRulesEvaluationRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<StartConfigRulesEvaluationRequest> marshall(
        ...
        Request<StartConfigRulesEvaluationRequest> request = new DefaultRequest<StartConfigRulesEvaluationRequest>(
                startConfigRulesEvaluationRequest, "AmazonConfig");
        ...
        try {
            ...
            com.amazonaws.internal.SdkInternalList<String> configRuleNamesList = (com.amazonaws.internal.SdkInternalList<String>) startConfigRulesEvaluationRequest
                    .getConfigRuleNames();
            if (!configRuleNamesList.isEmpty()
                    || !configRuleNamesList.isAutoConstruct()) {
