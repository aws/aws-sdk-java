 ...
 */
public class DescribeDeliveryChannelsResultJsonUnmarshaller implements
        Unmarshaller<DescribeDeliveryChannelsResult, JsonUnmarshallerContext> {

    public DescribeDeliveryChannelsResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DeliveryChannels", targetDepth)) {
                    ...
                    describeDeliveryChannelsResult
                            .setDeliveryChannels(new ListUnmarshaller<DeliveryChannel>(
