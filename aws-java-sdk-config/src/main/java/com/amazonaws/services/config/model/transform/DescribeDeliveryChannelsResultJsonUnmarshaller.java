...
/**
 * Describe Delivery Channels Result JSON Unmarshaller
 */
public class DescribeDeliveryChannelsResultJsonUnmarshaller implements Unmarshaller<DescribeDeliveryChannelsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DeliveryChannels", targetDepth)) {
                    context.nextToken();
                    describeDeliveryChannelsResult.setDeliveryChannels(new ListUnmarshaller<DeliveryChannel>(DeliveryChannelJsonUnmarshaller.getInstance()).unmarshall(context));
                }
    ...
    public static DescribeDeliveryChannelsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeDeliveryChannelsResultJsonUnmarshaller();
        return instance;
    }
}
