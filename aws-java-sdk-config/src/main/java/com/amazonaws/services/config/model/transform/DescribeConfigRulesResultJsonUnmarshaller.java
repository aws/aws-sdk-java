...
/**
 * Describe Config Rules Result JSON Unmarshaller
 */
public class DescribeConfigRulesResultJsonUnmarshaller implements Unmarshaller<DescribeConfigRulesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeConfigRulesResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DescribeConfigRulesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeConfigRulesResultJsonUnmarshaller();
        return instance;
    }
}
