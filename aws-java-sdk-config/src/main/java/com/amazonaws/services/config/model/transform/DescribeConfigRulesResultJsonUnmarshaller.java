 ...
 */
public class DescribeConfigRulesResultJsonUnmarshaller implements
        Unmarshaller<DescribeConfigRulesResult, JsonUnmarshallerContext> {

    public DescribeConfigRulesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ConfigRules", targetDepth)) {
                    ...
                    describeConfigRulesResult
                            .setConfigRules(new ListUnmarshaller<ConfigRule>(
                                    ConfigRuleJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeConfigRulesResult.setNextToken(context
