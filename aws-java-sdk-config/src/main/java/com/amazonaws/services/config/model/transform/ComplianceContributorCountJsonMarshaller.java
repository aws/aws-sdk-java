...
/**
 * ComplianceContributorCountMarshaller
 */
public class ComplianceContributorCountJsonMarshaller {
     ...
     */
    public void marshall(ComplianceContributorCount complianceContributorCount, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (complianceContributorCount.getCappedCount() != null) {
                jsonGenerator.writeFieldName("CappedCount").writeValue(complianceContributorCount.getCappedCount());
            }
            if (complianceContributorCount.getCapExceeded() != null) {
                jsonGenerator.writeFieldName("CapExceeded").writeValue(complianceContributorCount.getCapExceeded());
            }
