 ...
 */
public class DeleteConfigurationRecorderResultJsonUnmarshaller
        implements
        Unmarshaller<DeleteConfigurationRecorderResult, JsonUnmarshallerContext> {

    public DeleteConfigurationRecorderResult unmarshall(
