...
public class NoSuchConfigurationRecorderExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoSuchConfigurationRecorderExceptionUnmarshaller instance;

    public static NoSuchConfigurationRecorderExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoSuchConfigurationRecorderExceptionUnmarshaller();
        return instance;
    }
}
