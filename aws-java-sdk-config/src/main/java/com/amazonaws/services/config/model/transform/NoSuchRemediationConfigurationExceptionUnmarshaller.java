...
public class NoSuchRemediationConfigurationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoSuchRemediationConfigurationExceptionUnmarshaller instance;

    public static NoSuchRemediationConfigurationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoSuchRemediationConfigurationExceptionUnmarshaller();
        return instance;
    }
}
