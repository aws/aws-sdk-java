...
public class PutConfigurationRecorderRequestMarshaller
        implements
        Marshaller<Request<PutConfigurationRecorderRequest>, PutConfigurationRecorderRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public PutConfigurationRecorderRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<PutConfigurationRecorderRequest> marshall(
        ...
        Request<PutConfigurationRecorderRequest> request = new DefaultRequest<PutConfigurationRecorderRequest>(
                putConfigurationRecorderRequest, "AmazonConfig");
