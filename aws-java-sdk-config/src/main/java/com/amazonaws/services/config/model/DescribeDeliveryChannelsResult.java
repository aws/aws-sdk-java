 ...
 * </p>
 */
public class DescribeDeliveryChannelsResult extends
    ...
    public void setDeliveryChannels(
        ...
        this.deliveryChannels = new com.amazonaws.internal.SdkInternalList<DeliveryChannel>(
                deliveryChannels);
    }
    ...
    public DescribeDeliveryChannelsResult withDeliveryChannels(
        ...
        if (this.deliveryChannels == null) {
            setDeliveryChannels(new com.amazonaws.internal.SdkInternalList<DeliveryChannel>(
