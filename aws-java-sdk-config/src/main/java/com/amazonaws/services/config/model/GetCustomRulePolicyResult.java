...
public class GetCustomRulePolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetCustomRulePolicyResult withPolicyText(String policyText) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCustomRulePolicyResult == false)
            return false;
        GetCustomRulePolicyResult other = (GetCustomRulePolicyResult) obj;
    ...
    @Override
    public GetCustomRulePolicyResult clone() {
        try {
            return (GetCustomRulePolicyResult) super.clone();
