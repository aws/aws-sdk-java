...
public class MaxNumberOfConfigurationRecordersExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaxNumberOfConfigurationRecordersExceededExceptionUnmarshaller instance;

    public static MaxNumberOfConfigurationRecordersExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaxNumberOfConfigurationRecordersExceededExceptionUnmarshaller();
        return instance;
    }
}
