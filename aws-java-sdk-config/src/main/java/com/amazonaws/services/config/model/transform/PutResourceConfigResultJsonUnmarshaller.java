...
/**
 * PutResourceConfigResult JSON Unmarshaller
 */
...
public class PutResourceConfigResultJsonUnmarshaller implements Unmarshaller<PutResourceConfigResult, JsonUnmarshallerContext> {
    ...
    public PutResourceConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutResourceConfigResult putResourceConfigResult = new PutResourceConfigResult();
