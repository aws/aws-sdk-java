...
public class NoSuchOrganizationConfigRuleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoSuchOrganizationConfigRuleExceptionUnmarshaller instance;

    public static NoSuchOrganizationConfigRuleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoSuchOrganizationConfigRuleExceptionUnmarshaller();
        return instance;
    }
}
