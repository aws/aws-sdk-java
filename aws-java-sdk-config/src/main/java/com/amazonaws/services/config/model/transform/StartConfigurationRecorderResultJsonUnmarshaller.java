 ...
 */
public class StartConfigurationRecorderResultJsonUnmarshaller implements
        Unmarshaller<StartConfigurationRecorderResult, JsonUnmarshallerContext> {

    public StartConfigurationRecorderResult unmarshall(
