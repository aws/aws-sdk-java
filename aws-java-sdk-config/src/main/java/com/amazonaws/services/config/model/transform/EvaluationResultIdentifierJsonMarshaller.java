...
public class EvaluationResultIdentifierJsonMarshaller {
     ...
     */
    public void marshall(EvaluationResultIdentifier evaluationResultIdentifier, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (evaluationResultIdentifier.getEvaluationResultQualifier() != null) {
                ...
                EvaluationResultQualifierJsonMarshaller.getInstance().marshall(evaluationResultIdentifier.getEvaluationResultQualifier(), jsonGenerator);
            }
            if (evaluationResultIdentifier.getOrderingTimestamp() != null) {
                jsonGenerator.writeFieldName("OrderingTimestamp").writeValue(evaluationResultIdentifier.getOrderingTimestamp());
            }
