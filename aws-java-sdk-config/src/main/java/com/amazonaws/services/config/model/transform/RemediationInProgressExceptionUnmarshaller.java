...
public class RemediationInProgressExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RemediationInProgressExceptionUnmarshaller instance;

    public static RemediationInProgressExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RemediationInProgressExceptionUnmarshaller();
        return instance;
    }
}
