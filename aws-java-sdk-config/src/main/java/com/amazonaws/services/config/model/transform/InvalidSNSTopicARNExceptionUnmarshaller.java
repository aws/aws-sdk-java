...
public class InvalidSNSTopicARNExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSNSTopicARNExceptionUnmarshaller instance;

    public static InvalidSNSTopicARNExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSNSTopicARNExceptionUnmarshaller();
        return instance;
    }
}
