 ...
 */
public class DeleteDeliveryChannelResultJsonUnmarshaller implements
        Unmarshaller<DeleteDeliveryChannelResult, JsonUnmarshallerContext> {

    public DeleteDeliveryChannelResult unmarshall(
