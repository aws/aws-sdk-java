...
/**
 * GetComplianceDetailsByResourceRequestMarshaller
 */
...
public class GetComplianceDetailsByResourceRequestMarshaller {
    ...
    public static GetComplianceDetailsByResourceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetComplianceDetailsByResourceRequest getComplianceDetailsByResourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getComplianceDetailsByResourceRequest.getResourceType(), RESOURCETYPE_BINDING);
