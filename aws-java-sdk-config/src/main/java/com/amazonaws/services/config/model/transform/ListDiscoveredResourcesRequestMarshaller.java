...
/**
 * List Discovered Resources Request Marshaller
 */
    ...
    public Request<ListDiscoveredResourcesRequest> marshall(ListDiscoveredResourcesRequest listDiscoveredResourcesRequest) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            com.amazonaws.internal.ListWithAutoConstructFlag<String> resourceIdsList = (com.amazonaws.internal.ListWithAutoConstructFlag<String>)(listDiscoveredResourcesRequest.getResourceIds());
            if (resourceIdsList != null && !(resourceIdsList.isAutoConstruct() && resourceIdsList.isEmpty())) {
            ...
            if (listDiscoveredResourcesRequest.isIncludeDeletedResources() != null) {
                jsonWriter.key("includeDeletedResources").value(listDiscoveredResourcesRequest.isIncludeDeletedResources());
            }
