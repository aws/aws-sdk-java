...
public class StartConfigurationRecorderRequestMarshaller
    ...
    public Request<StartConfigurationRecorderRequest> marshall(
        ...
        Request<StartConfigurationRecorderRequest> request = new DefaultRequest<StartConfigurationRecorderRequest>(
                startConfigurationRecorderRequest, "AmazonConfig");
        ...
        try {
            ...
            if (startConfigurationRecorderRequest
