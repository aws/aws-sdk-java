...
@SdkInternalApi
public class EvaluationResultQualifierMarshaller {
    ...
    public static EvaluationResultQualifierMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EvaluationResultQualifier evaluationResultQualifier, ProtocolMarshaller protocolMarshaller) {
