...
/**
 * Delivery Channel Status JSON Unmarshaller
 */
public class DeliveryChannelStatusJsonUnmarshaller implements Unmarshaller<DeliveryChannelStatus, JsonUnmarshallerContext> {

    public DeliveryChannelStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    deliveryChannelStatus.setName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DeliveryChannelStatusJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeliveryChannelStatusJsonUnmarshaller();
        return instance;
    }
}
