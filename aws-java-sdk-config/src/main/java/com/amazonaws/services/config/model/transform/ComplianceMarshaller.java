...
public class ComplianceMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> COMPLIANCECONTRIBUTORCOUNT_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ComplianceContributorCount").build();
    ...
    public void marshall(Compliance compliance, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(compliance.getComplianceType(), COMPLIANCETYPE_BINDING);
            protocolMarshaller.marshall(compliance.getComplianceContributorCount(), COMPLIANCECONTRIBUTORCOUNT_BINDING);
        } catch (Exception e) {
