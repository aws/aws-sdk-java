...
/**
 * StartRemediationExecutionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StartRemediationExecutionRequestMarshaller {
    ...
    private static final StartRemediationExecutionRequestMarshaller instance = new StartRemediationExecutionRequestMarshaller();

    public static StartRemediationExecutionRequestMarshaller getInstance() {
        return instance;
    }
