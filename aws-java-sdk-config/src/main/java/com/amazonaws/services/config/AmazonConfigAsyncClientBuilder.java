...
/**
 * Fluent builder for {@link com.amazonaws.services.config.AmazonConfigAsync}.
 * Use of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonConfigAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonConfigAsyncClientBuilder, AmazonConfigAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonConfigAsync using the
