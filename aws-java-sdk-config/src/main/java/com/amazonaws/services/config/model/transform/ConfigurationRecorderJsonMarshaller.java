...
public class ConfigurationRecorderJsonMarshaller {
    ...
    public void marshall(ConfigurationRecorder configurationRecorder, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (configurationRecorder.getName() != null) {
                jsonGenerator.writeFieldName("name").writeValue(configurationRecorder.getName());
            }
            if (configurationRecorder.getRoleARN() != null) {
                jsonGenerator.writeFieldName("roleARN").writeValue(configurationRecorder.getRoleARN());
            }
            if (configurationRecorder.getRecordingGroup() != null) {
                jsonGenerator.writeFieldName("recordingGroup");
                RecordingGroupJsonMarshaller.getInstance().marshall(configurationRecorder.getRecordingGroup(), jsonGenerator);
            }
    ...
    public static ConfigurationRecorderJsonMarshaller getInstance() {
        if (instance == null)
            instance = new ConfigurationRecorderJsonMarshaller();
        return instance;
    }
