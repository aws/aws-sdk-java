...
public class OrganizationAccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OrganizationAccessDeniedExceptionUnmarshaller instance;

    public static OrganizationAccessDeniedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OrganizationAccessDeniedExceptionUnmarshaller();
        return instance;
    }
}
