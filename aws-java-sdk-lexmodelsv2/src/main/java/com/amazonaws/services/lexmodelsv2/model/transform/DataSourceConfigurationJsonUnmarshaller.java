        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("opensearchConfiguration", targetDepth)) {
                    context.nextToken();
                    dataSourceConfiguration.setOpensearchConfiguration(OpensearchConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("kendraConfiguration", targetDepth)) {
                    context.nextToken();
                    dataSourceConfiguration.setKendraConfiguration(QnAKendraConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("bedrockKnowledgeStoreConfiguration", targetDepth)) {
                    context.nextToken();
                    dataSourceConfiguration.setBedrockKnowledgeStoreConfiguration(BedrockKnowledgeStoreConfigurationJsonUnmarshaller.getInstance().unmarshall(
                            context));
                }
