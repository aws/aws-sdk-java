...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/models.lex.v2-2020-08-07/UpdateResourcePolicy" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateResourcePolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateResourcePolicyResult withResourceArn(String resourceArn) {
    ...
    public UpdateResourcePolicyResult withRevisionId(String revisionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateResourcePolicyResult == false)
            return false;
        UpdateResourcePolicyResult other = (UpdateResourcePolicyResult) obj;
    ...
    @Override
    public UpdateResourcePolicyResult clone() {
        try {
