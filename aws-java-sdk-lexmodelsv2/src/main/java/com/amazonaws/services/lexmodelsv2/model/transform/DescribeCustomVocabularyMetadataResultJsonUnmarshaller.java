...
/**
 * DescribeCustomVocabularyMetadataResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeCustomVocabularyMetadataResultJsonUnmarshaller implements Unmarshaller<DescribeCustomVocabularyMetadataResult, JsonUnmarshallerContext> {

    public DescribeCustomVocabularyMetadataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribeCustomVocabularyMetadataResult describeCustomVocabularyMetadataResult = new DescribeCustomVocabularyMetadataResult();
    ...
    private static DescribeCustomVocabularyMetadataResultJsonUnmarshaller instance;

    public static DescribeCustomVocabularyMetadataResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeCustomVocabularyMetadataResultJsonUnmarshaller();
        return instance;
    }
}
