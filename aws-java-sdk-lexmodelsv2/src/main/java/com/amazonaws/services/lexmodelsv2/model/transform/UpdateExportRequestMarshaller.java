...
public class UpdateExportRequestMarshaller {
    ...
    public void marshall(UpdateExportRequest updateExportRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateExportRequest.getExportId(), EXPORTID_BINDING);
            protocolMarshaller.marshall(updateExportRequest.getFilePassword(), FILEPASSWORD_BINDING);
        } catch (Exception e) {
