...
class BotAliasAvailable {
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeBotAliasResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("botAliasStatus");
         ...
         */
        @Override
        public boolean matches(DescribeBotAliasResult result) {
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeBotAliasResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeBotAliasResult> {
        private static final JsonNode expectedResult;
