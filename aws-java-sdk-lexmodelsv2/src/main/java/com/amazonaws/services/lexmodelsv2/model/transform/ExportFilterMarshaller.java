...
public class ExportFilterMarshaller {
    ...
    public void marshall(ExportFilter exportFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(exportFilter.getName(), NAME_BINDING);
            protocolMarshaller.marshall(exportFilter.getValues(), VALUES_BINDING);
            protocolMarshaller.marshall(exportFilter.getOperator(), OPERATOR_BINDING);
        } catch (Exception e) {
