...
@SdkInternalApi
public class DeleteIntentRequestMarshaller {
    ...
    public static DeleteIntentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteIntentRequest deleteIntentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteIntentRequest.getIntentId(), INTENTID_BINDING);
            protocolMarshaller.marshall(deleteIntentRequest.getBotId(), BOTID_BINDING);
            protocolMarshaller.marshall(deleteIntentRequest.getBotVersion(), BOTVERSION_BINDING);
            protocolMarshaller.marshall(deleteIntentRequest.getLocaleId(), LOCALEID_BINDING);
        } catch (Exception e) {
