 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/models.lex.v2-2020-08-07/SampleUtterance" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SampleUtterance implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getUtterance() != null)
            sb.append("Utterance: ").append(getUtterance());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SampleUtterance == false)
            return false;
    ...
    public SampleUtterance clone() {
        try {
            return (SampleUtterance) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lexmodelsv2.model.transform.SampleUtteranceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
