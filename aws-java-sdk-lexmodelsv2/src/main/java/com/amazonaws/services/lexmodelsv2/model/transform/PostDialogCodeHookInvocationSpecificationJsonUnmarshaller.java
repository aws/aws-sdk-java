...
/**
 * PostDialogCodeHookInvocationSpecification JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PostDialogCodeHookInvocationSpecificationJsonUnmarshaller implements
        Unmarshaller<PostDialogCodeHookInvocationSpecification, JsonUnmarshallerContext> {

    public PostDialogCodeHookInvocationSpecification unmarshall(JsonUnmarshallerContext context) throws Exception {
        PostDialogCodeHookInvocationSpecification postDialogCodeHookInvocationSpecification = new PostDialogCodeHookInvocationSpecification();
    ...
    private static PostDialogCodeHookInvocationSpecificationJsonUnmarshaller instance;

    public static PostDialogCodeHookInvocationSpecificationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PostDialogCodeHookInvocationSpecificationJsonUnmarshaller();
        return instance;
    }
}
