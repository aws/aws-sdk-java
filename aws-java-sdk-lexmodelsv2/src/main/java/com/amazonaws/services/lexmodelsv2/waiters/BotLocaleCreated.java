...
class BotLocaleCreated {
    ...
    static class IsBuiltMatcher extends WaiterAcceptor<DescribeBotLocaleResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"Built\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }

        private static final JmesPathExpression ast = new JmesPathField("botLocaleStatus");
         ...
         */
        @Override
        public boolean matches(DescribeBotLocaleResult result) {
    ...
    static class IsReadyExpressTestingMatcher extends WaiterAcceptor<DescribeBotLocaleResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"ReadyExpressTesting\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsNotBuiltMatcher extends WaiterAcceptor<DescribeBotLocaleResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"NotBuilt\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeBotLocaleResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeBotLocaleResult> {
        private static final JsonNode expectedResult;
