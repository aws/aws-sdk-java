 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/models.lex.v2-2020-08-07/IntentFilter" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IntentFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public IntentFilter withName(String name) {
        setName(name);
        return this;
    }
    ...
    public IntentFilter withName(IntentFilterName name) {
    ...
    public IntentFilter withValues(java.util.Collection<String> values) {
        setValues(values);
        return this;
    }
    ...
    public IntentFilter withOperator(String operator) {
    ...
    public IntentFilter withOperator(IntentFilterOperator operator) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IntentFilter == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lexmodelsv2.model.transform.IntentFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
