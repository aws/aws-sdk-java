...
public class CreateBotReplicaRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The request for the unique bot ID of the source bot to be replicated in the secondary region.
     */
     ...
     * </p>
     * 
     * @return The request for the secondary region that will be used in the replication of the source bot.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBotReplicaRequest == false)
            return false;
        CreateBotReplicaRequest other = (CreateBotReplicaRequest) obj;
    ...
    public CreateBotReplicaRequest clone() {
        return (CreateBotReplicaRequest) super.clone();
    }
