...
/**
 * DialogCodeHookInvocationSetting JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DialogCodeHookInvocationSettingJsonUnmarshaller implements Unmarshaller<DialogCodeHookInvocationSetting, JsonUnmarshallerContext> {

    public DialogCodeHookInvocationSetting unmarshall(JsonUnmarshallerContext context) throws Exception {
        DialogCodeHookInvocationSetting dialogCodeHookInvocationSetting = new DialogCodeHookInvocationSetting();
    ...
    private static DialogCodeHookInvocationSettingJsonUnmarshaller instance;

    public static DialogCodeHookInvocationSettingJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DialogCodeHookInvocationSettingJsonUnmarshaller();
        return instance;
    }
}
