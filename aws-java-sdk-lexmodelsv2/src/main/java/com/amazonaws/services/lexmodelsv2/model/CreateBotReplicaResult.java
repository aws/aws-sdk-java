...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/models.lex.v2-2020-08-07/CreateBotReplica" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateBotReplicaResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateBotReplicaResult withCreationDateTime(java.util.Date creationDateTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBotReplicaResult == false)
            return false;
        CreateBotReplicaResult other = (CreateBotReplicaResult) obj;
    ...
    public CreateBotReplicaResult clone() {
        try {
            return (CreateBotReplicaResult) super.clone();
