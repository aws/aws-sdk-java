...
public class GenerationSummaryMarshaller {
    ...
    public void marshall(GenerationSummary generationSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(generationSummary.getGenerationId(), GENERATIONID_BINDING);
            protocolMarshaller.marshall(generationSummary.getGenerationStatus(), GENERATIONSTATUS_BINDING);
            protocolMarshaller.marshall(generationSummary.getCreationDateTime(), CREATIONDATETIME_BINDING);
            protocolMarshaller.marshall(generationSummary.getLastUpdatedDateTime(), LASTUPDATEDDATETIME_BINDING);
        } catch (Exception e) {
