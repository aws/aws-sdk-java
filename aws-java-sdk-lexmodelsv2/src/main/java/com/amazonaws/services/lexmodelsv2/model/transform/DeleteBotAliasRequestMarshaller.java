...
public class DeleteBotAliasRequestMarshaller {
    ...
    public void marshall(DeleteBotAliasRequest deleteBotAliasRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteBotAliasRequest.getBotAliasId(), BOTALIASID_BINDING);
            protocolMarshaller.marshall(deleteBotAliasRequest.getBotId(), BOTID_BINDING);
            protocolMarshaller.marshall(deleteBotAliasRequest.getSkipResourceInUseCheck(), SKIPRESOURCEINUSECHECK_BINDING);
        } catch (Exception e) {
