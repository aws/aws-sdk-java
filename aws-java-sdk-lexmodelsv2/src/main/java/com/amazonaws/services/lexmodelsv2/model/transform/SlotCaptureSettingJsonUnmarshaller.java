...
/**
 * SlotCaptureSetting JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SlotCaptureSettingJsonUnmarshaller implements Unmarshaller<SlotCaptureSetting, JsonUnmarshallerContext> {

    public SlotCaptureSetting unmarshall(JsonUnmarshallerContext context) throws Exception {
        SlotCaptureSetting slotCaptureSetting = new SlotCaptureSetting();
    ...
    private static SlotCaptureSettingJsonUnmarshaller instance;

    public static SlotCaptureSettingJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SlotCaptureSettingJsonUnmarshaller();
        return instance;
    }
}
