...
public class Cluster implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The status of the cluster. The valid values are
     *         <code>ACTIVE</code> or <code>INACTIVE</code>. <code>ACTIVE</code>
     *         indicates that you can register container instances with the
     *         cluster and the associated instances can accept tasks.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getActiveServicesCount() == null
                ^ this.getActiveServicesCount() == null)
            return false;
        if (other.getActiveServicesCount() != null
                && other.getActiveServicesCount().equals(
                        this.getActiveServicesCount()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getActiveServicesCount() == null) ? 0
                        : getActiveServicesCount().hashCode());
        return hashCode;
    }
