...
public class CapacityProviderStrategyItemMarshaller {
    ...
    public static CapacityProviderStrategyItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CapacityProviderStrategyItem capacityProviderStrategyItem, ProtocolMarshaller protocolMarshaller) {
