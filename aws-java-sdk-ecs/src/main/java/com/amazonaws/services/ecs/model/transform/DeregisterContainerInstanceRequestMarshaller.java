...
public class DeregisterContainerInstanceRequestMarshaller
    ...
    public DeregisterContainerInstanceRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeregisterContainerInstanceRequest> marshall(
        ...
        Request<DeregisterContainerInstanceRequest> request = new DefaultRequest<DeregisterContainerInstanceRequest>(
                deregisterContainerInstanceRequest, "AmazonECS");
        ...
        try {
            ...
            if (deregisterContainerInstanceRequest.getCluster() != null) {
                jsonGenerator.writeFieldName("cluster").writeValue(
                        deregisterContainerInstanceRequest.getCluster());
            }
            ...
            if (deregisterContainerInstanceRequest.getForce() != null) {
                jsonGenerator.writeFieldName("force").writeValue(
                        deregisterContainerInstanceRequest.getForce());
            }
