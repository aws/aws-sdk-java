...
class ServicesStable {
    ...
    static class IsMISSINGMatcher extends
            WaiterAcceptor<DescribeServicesResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(
                new JmesPathFlatten(new JmesPathField("failures")),
                new JmesPathField("reason"));
    ...
    static class IsDRAININGMatcher extends
            WaiterAcceptor<DescribeServicesResult> {
        private static final JsonNode expectedResult;
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(
                new JmesPathFlatten(new JmesPathField("services")),
    ...
    static class IsINACTIVEMatcher extends
            WaiterAcceptor<DescribeServicesResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsTrueMatcher extends WaiterAcceptor<DescribeServicesResult> {
        ...
        private static final JmesPathExpression ast = new OpEquals(
                new JmesPathLengthFunction(new JmesPathFilter(
                        new JmesPathField("services"), new JmesPathIdentity(),
                        new JmesPathNotExpression(new JmesPathAndExpression(
                                new OpEquals(new JmesPathLengthFunction(
                                        new JmesPathField("deployments")),
                                        new JmesPathLiteral("1")),
                                new OpEquals(new JmesPathField("runningCount"),
                                        new JmesPathField("desiredCount")))))),
