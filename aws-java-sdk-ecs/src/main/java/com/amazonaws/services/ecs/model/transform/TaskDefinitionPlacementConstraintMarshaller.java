...
@SdkInternalApi
public class TaskDefinitionPlacementConstraintMarshaller {
    ...
    private static final TaskDefinitionPlacementConstraintMarshaller instance = new TaskDefinitionPlacementConstraintMarshaller();

    public static TaskDefinitionPlacementConstraintMarshaller getInstance() {
        return instance;
    }
