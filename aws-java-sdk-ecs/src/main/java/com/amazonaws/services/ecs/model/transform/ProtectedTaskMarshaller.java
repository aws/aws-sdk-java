...
public class ProtectedTaskMarshaller {
    ...
    private static final MarshallingInfo<Boolean> PROTECTIONENABLED_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("protectionEnabled").build();
    ...
    public void marshall(ProtectedTask protectedTask, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(protectedTask.getTaskArn(), TASKARN_BINDING);
            protocolMarshaller.marshall(protectedTask.getProtectionEnabled(), PROTECTIONENABLED_BINDING);
            protocolMarshaller.marshall(protectedTask.getExpirationDate(), EXPIRATIONDATE_BINDING);
        } catch (Exception e) {
