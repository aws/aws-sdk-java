...
/**
 * Version Info JSON Unmarshaller
 */
public class VersionInfoJsonUnmarshaller implements Unmarshaller<VersionInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("agentVersion", targetDepth)) {
                    context.nextToken();
                    versionInfo.setAgentVersion(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("agentHash", targetDepth)) {
                    context.nextToken();
                    versionInfo.setAgentHash(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("dockerVersion", targetDepth)) {
                    context.nextToken();
                    versionInfo.setDockerVersion(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static VersionInfoJsonUnmarshaller getInstance() {
        if (instance == null) instance = new VersionInfoJsonUnmarshaller();
        return instance;
    }
}
