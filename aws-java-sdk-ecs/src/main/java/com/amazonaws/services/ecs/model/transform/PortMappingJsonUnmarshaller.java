...
/**
 * Port Mapping JSON Unmarshaller
 */
public class PortMappingJsonUnmarshaller implements Unmarshaller<PortMapping, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("containerPort", targetDepth)) {
                    context.nextToken();
                    portMapping.setContainerPort(IntegerJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("hostPort", targetDepth)) {
                    context.nextToken();
                    portMapping.setHostPort(IntegerJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("protocol", targetDepth)) {
                    context.nextToken();
                    portMapping.setProtocol(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static PortMappingJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PortMappingJsonUnmarshaller();
        return instance;
    }
}
