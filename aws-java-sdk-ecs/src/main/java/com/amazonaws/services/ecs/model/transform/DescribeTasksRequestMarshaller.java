...
/**
 * Describe Tasks Request Marshaller
 */
    ...
    public Request<DescribeTasksRequest> marshall(DescribeTasksRequest describeTasksRequest) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            com.amazonaws.internal.ListWithAutoConstructFlag<String> tasksList = (com.amazonaws.internal.ListWithAutoConstructFlag<String>)(describeTasksRequest.getTasks());
            if (tasksList != null && !(tasksList.isAutoConstruct() && tasksList.isEmpty())) {
