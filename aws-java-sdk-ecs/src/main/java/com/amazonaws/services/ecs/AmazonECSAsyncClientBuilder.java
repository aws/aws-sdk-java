...
/**
 * Fluent builder for {@link com.amazonaws.services.ecs.AmazonECSAsync}. Use of
 * the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonECSAsyncClientBuilder extends
        AwsAsyncClientBuilder<AmazonECSAsyncClientBuilder, AmazonECSAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonECSAsync using the
