...
/**
 * Load Balancer JSON Unmarshaller
 */
public class LoadBalancerJsonUnmarshaller implements Unmarshaller<LoadBalancer, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("loadBalancerName", targetDepth)) {
                    context.nextToken();
                    loadBalancer.setLoadBalancerName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("containerName", targetDepth)) {
                    context.nextToken();
                    loadBalancer.setContainerName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("containerPort", targetDepth)) {
                    context.nextToken();
                    loadBalancer.setContainerPort(IntegerJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static LoadBalancerJsonUnmarshaller getInstance() {
        if (instance == null) instance = new LoadBalancerJsonUnmarshaller();
        return instance;
    }
}
