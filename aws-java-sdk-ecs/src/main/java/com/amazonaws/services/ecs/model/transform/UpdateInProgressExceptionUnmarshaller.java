...
public class UpdateInProgressExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UpdateInProgressExceptionUnmarshaller instance;

    public static UpdateInProgressExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateInProgressExceptionUnmarshaller();
        return instance;
    }
}
