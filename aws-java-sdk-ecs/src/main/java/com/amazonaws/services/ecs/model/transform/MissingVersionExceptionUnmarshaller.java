...
public class MissingVersionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MissingVersionExceptionUnmarshaller instance;

    public static MissingVersionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MissingVersionExceptionUnmarshaller();
        return instance;
    }
}
