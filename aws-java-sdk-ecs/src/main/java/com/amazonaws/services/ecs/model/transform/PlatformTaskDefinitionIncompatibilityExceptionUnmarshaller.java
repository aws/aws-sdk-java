...
public class PlatformTaskDefinitionIncompatibilityExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PlatformTaskDefinitionIncompatibilityExceptionUnmarshaller instance;

    public static PlatformTaskDefinitionIncompatibilityExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PlatformTaskDefinitionIncompatibilityExceptionUnmarshaller();
        return instance;
    }
}
