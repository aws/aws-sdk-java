...
@SdkInternalApi
public class SystemControlMarshaller {
    ...
    private static final SystemControlMarshaller instance = new SystemControlMarshaller();

    public static SystemControlMarshaller getInstance() {
        return instance;
    }
