...
/**
 * Describe Container Instances Request Marshaller
 */
public class DescribeContainerInstancesRequestMarshaller implements Marshaller<Request<DescribeContainerInstancesRequest>, DescribeContainerInstancesRequest> {
    ...
    public Request<DescribeContainerInstancesRequest> marshall(DescribeContainerInstancesRequest describeContainerInstancesRequest) {
        ...
        Request<DescribeContainerInstancesRequest> request = new DefaultRequest<DescribeContainerInstancesRequest>(describeContainerInstancesRequest, "AmazonECS");
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (describeContainerInstancesRequest.getCluster() != null) {
                jsonWriter.key("cluster").value(describeContainerInstancesRequest.getCluster());
            }

            com.amazonaws.internal.ListWithAutoConstructFlag<String> containerInstancesList = (com.amazonaws.internal.ListWithAutoConstructFlag<String>)(describeContainerInstancesRequest.getContainerInstances());
