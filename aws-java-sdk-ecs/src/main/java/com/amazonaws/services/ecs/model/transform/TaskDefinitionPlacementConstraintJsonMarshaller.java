...
public class TaskDefinitionPlacementConstraintJsonMarshaller {
     ...
     */
    public void marshall(TaskDefinitionPlacementConstraint taskDefinitionPlacementConstraint, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (taskDefinitionPlacementConstraint.getType() != null) {
                jsonGenerator.writeFieldName("type").writeValue(taskDefinitionPlacementConstraint.getType());
            }
            if (taskDefinitionPlacementConstraint.getExpression() != null) {
                jsonGenerator.writeFieldName("expression").writeValue(taskDefinitionPlacementConstraint.getExpression());
            }
