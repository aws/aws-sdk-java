...
public class TaskDefinition implements Serializable, Cloneable {
     ...
     *        <code>1</code>; each time you register a new revision of a task
     ...
     * </p>
     * 
     * @return The revision of the task in a particular family. The revision is
    ...
    public void setRequiresAttributes(
        ...
        this.requiresAttributes = new com.amazonaws.internal.SdkInternalList<Attribute>(
                requiresAttributes);
    }
    ...
    public TaskDefinition withRequiresAttributes(
        ...
        if (this.requiresAttributes == null) {
            setRequiresAttributes(new com.amazonaws.internal.SdkInternalList<Attribute>(
                    requiresAttributes.length));
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRequiresAttributes() == null
                ^ this.getRequiresAttributes() == null)
            return false;
        if (other.getRequiresAttributes() != null
                && other.getRequiresAttributes().equals(
                        this.getRequiresAttributes()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getRequiresAttributes() == null) ? 0
                        : getRequiresAttributes().hashCode());
        return hashCode;
    }
