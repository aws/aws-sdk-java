...
/**
 * Container for the parameters to the {@link com.amazonaws.services.ecs.AmazonECS#listServices(ListServicesRequest) ListServices operation}.
 * <p>
 * Lists the services that are running in a specified cluster.
 * </p>
 *
 * @see com.amazonaws.services.ecs.AmazonECS#listServices(ListServicesRequest)
 */
public class ListServicesRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <code>ListServices</code> request where <code>maxResults</code> was
     ...
     * this parameter is not used, then <code>ListServices</code> returns up
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListServicesRequest == false) return false;
