...
public class AmazonECSWaiters {
    ...
    /**
     * Builds a TasksRunning waiter by using custom parameters waiterParameters
    ...
    public Waiter<DescribeTasksRequest> tasksRunning() {
        ...
        return new WaiterBuilder<DescribeTasksRequest, DescribeTasksResult>()
                ...
                .withAcceptors(new TasksRunning.IsSTOPPEDMatcher(),
                        new TasksRunning.IsMISSINGMatcher(),
                        new TasksRunning.IsRUNNINGMatcher())
                .withDefaultPollingStrategy(
                        new PollingStrategy(new MaxAttemptsRetryStrategy(100),
                                new FixedDelayStrategy(6)))
                .withExecutorService(executorService).build();
    }

    /**
     * Builds a ServicesStable waiter by using custom parameters
    ...
    public Waiter<DescribeServicesRequest> servicesStable() {
        ...
        return new WaiterBuilder<DescribeServicesRequest, DescribeServicesResult>()
                ...
                .withAcceptors(new ServicesStable.IsMISSINGMatcher(),
                        new ServicesStable.IsDRAININGMatcher(),
                        new ServicesStable.IsINACTIVEMatcher(),
    ...
    /**
     * Builds a ServicesInactive waiter by using custom parameters
     * waiterParameters and other parameters defined in the waiters
     * specification, and then polls until it determines whether the resource
     * entered the desired state or not, where polling criteria is bound by
     * either default polling strategy or custom polling strategy.
    ...
    public Waiter<DescribeServicesRequest> servicesInactive() {
        ...
        return new WaiterBuilder<DescribeServicesRequest, DescribeServicesResult>()
                .withSdkFunction(new DescribeServicesFunction(client))
                .withAcceptors(new ServicesInactive.IsMISSINGMatcher(),
                        new ServicesInactive.IsINACTIVEMatcher())
                .withDefaultPollingStrategy(
                        new PollingStrategy(new MaxAttemptsRetryStrategy(40),
                                new FixedDelayStrategy(15)))
                .withExecutorService(executorService).build();
    ...
    /**
     * Builds a TasksStopped waiter by using custom parameters waiterParameters
     * and other parameters defined in the waiters specification, and then polls
     * until it determines whether the resource entered the desired state or
     * not, where polling criteria is bound by either default polling strategy
     * or custom polling strategy.
