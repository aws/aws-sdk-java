...
public class AttributeJsonUnmarshaller implements Unmarshaller<Attribute, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    attribute.setName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("value", targetDepth)) {
                    context.nextToken();
                    attribute.setValue(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static AttributeJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AttributeJsonUnmarshaller();
        return instance;
    }
}
