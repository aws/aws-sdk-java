 ...
 */
public class AttributeJsonUnmarshaller implements
        Unmarshaller<Attribute, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    attribute.setName(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
                if (context.testExpression("value", targetDepth)) {
                    context.nextToken();
                    attribute.setValue(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
