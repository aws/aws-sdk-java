    ...
    public Request<DescribeClustersRequest> marshall(DescribeClustersRequest describeClustersRequest) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            com.amazonaws.internal.ListWithAutoConstructFlag<String> clustersList = (com.amazonaws.internal.ListWithAutoConstructFlag<String>)(describeClustersRequest.getClusters());
            if (clustersList != null && !(clustersList.isAutoConstruct() && clustersList.isEmpty())) {
                ...
                for (String clustersListValue : clustersList) {
                    if (clustersListValue != null) {
                        jsonWriter.value(clustersListValue);
                    }
                }
                jsonWriter.endArray();
            }
