...
/**
 * Start Task Result JSON Unmarshaller
 */
public class StartTaskResultJsonUnmarshaller implements Unmarshaller<StartTaskResult, JsonUnmarshallerContext> {
    ...
    public static StartTaskResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new StartTaskResultJsonUnmarshaller();
        return instance;
    }
}
