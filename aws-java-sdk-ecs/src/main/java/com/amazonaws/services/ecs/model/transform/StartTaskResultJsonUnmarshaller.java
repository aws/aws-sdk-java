...
public class StartTaskResultJsonUnmarshaller implements
    ...
    public StartTaskResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("tasks", targetDepth)) {
                    context.nextToken();
                    startTaskResult.setTasks(new ListUnmarshaller<Task>(
                            TaskJsonUnmarshaller.getInstance())
                            .unmarshall(context));
                }
                if (context.testExpression("failures", targetDepth)) {
                    context.nextToken();
                    startTaskResult.setFailures(new ListUnmarshaller<Failure>(
