...
public class RunTaskRequest extends AmazonWebServiceRequest implements
     ...
     * task definition to run. If a <code>revision</code> is not specified, the
     ...
     * </important>
     * 
     * @return The number of instantiations of the specified task to place on
     *         your cluster.</p> <important>
     *         <p>
     *         The <code>count</code> parameter is limited to 10 tasks per call.
     *         </p>
