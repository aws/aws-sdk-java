 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ecs-2014-11-13/ServiceVolumeConfiguration" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ServiceVolumeConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setManagedEBSVolume(ServiceManagedEBSVolumeConfiguration managedEBSVolume) {
    ...
    public ServiceManagedEBSVolumeConfiguration getManagedEBSVolume() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ServiceVolumeConfiguration == false)
            return false;
    ...
    public ServiceVolumeConfiguration clone() {
        try {
            return (ServiceVolumeConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.ecs.model.transform.ServiceVolumeConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
