...
public class UpdateClusterSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public UpdateClusterSettingsResult clone() {
        try {
            return (UpdateClusterSettingsResult) super.clone();
