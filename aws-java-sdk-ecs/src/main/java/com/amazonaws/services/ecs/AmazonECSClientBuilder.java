...
/**
 * Fluent builder for {@link com.amazonaws.services.ecs.AmazonECS}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonECSClientBuilder extends
        AwsSyncClientBuilder<AmazonECSClientBuilder, AmazonECS> {
     ...
     * @return Fully configured implementation of AmazonECS.
     */
    @Override
    protected AmazonECS build(AwsSyncClientParams params) {
