 ...
 */
public class TaskOverrideJsonUnmarshaller implements
        Unmarshaller<TaskOverride, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("containerOverrides", targetDepth)) {
                    context.nextToken();
                    taskOverride
                            .setContainerOverrides(new ListUnmarshaller<ContainerOverride>(
                                    ContainerOverrideJsonUnmarshaller
                                            .getInstance()).unmarshall(context));
                }
                if (context.testExpression("taskRoleArn", targetDepth)) {
                    context.nextToken();
                    taskOverride.setTaskRoleArn(context.getUnmarshaller(
