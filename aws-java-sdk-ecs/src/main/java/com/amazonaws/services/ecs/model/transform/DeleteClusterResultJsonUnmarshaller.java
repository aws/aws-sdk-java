 ...
 */
public class DeleteClusterResultJsonUnmarshaller implements
        Unmarshaller<DeleteClusterResult, JsonUnmarshallerContext> {

    public DeleteClusterResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("cluster", targetDepth)) {
                    context.nextToken();
                    deleteClusterResult.setCluster(ClusterJsonUnmarshaller
