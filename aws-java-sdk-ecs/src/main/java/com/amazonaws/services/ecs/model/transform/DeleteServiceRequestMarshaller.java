...
/**
 * Delete Service Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (deleteServiceRequest.getCluster() != null) {
                jsonWriter.key("cluster").value(deleteServiceRequest.getCluster());
            }
            if (deleteServiceRequest.getService() != null) {
                jsonWriter.key("service").value(deleteServiceRequest.getService());
            }
