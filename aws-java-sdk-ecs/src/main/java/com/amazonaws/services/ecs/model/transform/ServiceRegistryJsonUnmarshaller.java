...
/**
 * ServiceRegistry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ServiceRegistryJsonUnmarshaller implements Unmarshaller<ServiceRegistry, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("registryArn", targetDepth)) {
                    context.nextToken();
                    serviceRegistry.setRegistryArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
