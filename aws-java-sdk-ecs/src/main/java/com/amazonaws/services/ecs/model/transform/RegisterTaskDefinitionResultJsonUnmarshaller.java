 ...
 */
public class RegisterTaskDefinitionResultJsonUnmarshaller implements
        Unmarshaller<RegisterTaskDefinitionResult, JsonUnmarshallerContext> {

    public RegisterTaskDefinitionResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("taskDefinition", targetDepth)) {
                    ...
                    registerTaskDefinitionResult
                            .setTaskDefinition(TaskDefinitionJsonUnmarshaller
