    ...
    public void marshall(PortMapping portMapping, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (portMapping.getContainerPort() != null) {
                jsonGenerator.writeFieldName("containerPort").writeValue(portMapping.getContainerPort());
            }
            if (portMapping.getHostPort() != null) {
                jsonGenerator.writeFieldName("hostPort").writeValue(portMapping.getHostPort());
            }
