...
/**
 * ServiceManagedEBSVolumeConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ServiceManagedEBSVolumeConfigurationMarshaller {
    ...
    private static final ServiceManagedEBSVolumeConfigurationMarshaller instance = new ServiceManagedEBSVolumeConfigurationMarshaller();

    public static ServiceManagedEBSVolumeConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ServiceManagedEBSVolumeConfiguration serviceManagedEBSVolumeConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (serviceManagedEBSVolumeConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(serviceManagedEBSVolumeConfiguration.getEncrypted(), ENCRYPTED_BINDING);
            protocolMarshaller.marshall(serviceManagedEBSVolumeConfiguration.getKmsKeyId(), KMSKEYID_BINDING);
            protocolMarshaller.marshall(serviceManagedEBSVolumeConfiguration.getVolumeType(), VOLUMETYPE_BINDING);
            protocolMarshaller.marshall(serviceManagedEBSVolumeConfiguration.getSizeInGiB(), SIZEINGIB_BINDING);
            protocolMarshaller.marshall(serviceManagedEBSVolumeConfiguration.getSnapshotId(), SNAPSHOTID_BINDING);
            protocolMarshaller.marshall(serviceManagedEBSVolumeConfiguration.getIops(), IOPS_BINDING);
            protocolMarshaller.marshall(serviceManagedEBSVolumeConfiguration.getThroughput(), THROUGHPUT_BINDING);
            protocolMarshaller.marshall(serviceManagedEBSVolumeConfiguration.getTagSpecifications(), TAGSPECIFICATIONS_BINDING);
            protocolMarshaller.marshall(serviceManagedEBSVolumeConfiguration.getRoleArn(), ROLEARN_BINDING);
            protocolMarshaller.marshall(serviceManagedEBSVolumeConfiguration.getFilesystemType(), FILESYSTEMTYPE_BINDING);
        } catch (Exception e) {
