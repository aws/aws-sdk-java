...
/**
 * PutActionRevisionRequestMarshaller
 */
...
public class PutActionRevisionRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> ACTIONREVISION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("actionRevision").build();

    private static final PutActionRevisionRequestMarshaller instance = new PutActionRevisionRequestMarshaller();

    public static PutActionRevisionRequestMarshaller getInstance() {
        return instance;
    }
