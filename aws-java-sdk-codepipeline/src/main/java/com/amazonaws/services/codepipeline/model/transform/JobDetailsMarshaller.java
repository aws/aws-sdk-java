...
public class JobDetailsMarshaller {
    ...
    public void marshall(JobDetails jobDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(jobDetails.getId(), ID_BINDING);
            protocolMarshaller.marshall(jobDetails.getData(), DATA_BINDING);
            protocolMarshaller.marshall(jobDetails.getAccountId(), ACCOUNTID_BINDING);
        } catch (Exception e) {
