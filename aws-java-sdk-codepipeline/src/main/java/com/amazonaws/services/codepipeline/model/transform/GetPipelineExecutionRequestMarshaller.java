...
public class GetPipelineExecutionRequestMarshaller
        implements
        Marshaller<Request<GetPipelineExecutionRequest>, GetPipelineExecutionRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public GetPipelineExecutionRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<GetPipelineExecutionRequest> marshall(
        ...
        Request<GetPipelineExecutionRequest> request = new DefaultRequest<GetPipelineExecutionRequest>(
                getPipelineExecutionRequest, "AWSCodePipeline");
