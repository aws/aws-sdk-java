...
/**
 * ListWebhookItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListWebhookItemJsonUnmarshaller implements Unmarshaller<ListWebhookItem, JsonUnmarshallerContext> {

    public ListWebhookItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        ListWebhookItem listWebhookItem = new ListWebhookItem();
    ...
    private static ListWebhookItemJsonUnmarshaller instance;

    public static ListWebhookItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListWebhookItemJsonUnmarshaller();
        return instance;
    }
}
