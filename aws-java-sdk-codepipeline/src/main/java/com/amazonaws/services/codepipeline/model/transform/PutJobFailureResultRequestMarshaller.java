...
public class PutJobFailureResultRequestMarshaller implements Marshaller<Request<PutJobFailureResultRequest>, PutJobFailureResultRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public PutJobFailureResultRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<PutJobFailureResultRequest> marshall(PutJobFailureResultRequest putJobFailureResultRequest) {
        ...
        Request<PutJobFailureResultRequest> request = new DefaultRequest<PutJobFailureResultRequest>(putJobFailureResultRequest, "AWSCodePipeline");
