 ...
 */
public class PutThirdPartyJobSuccessResultResultJsonUnmarshaller
        implements
        Unmarshaller<PutThirdPartyJobSuccessResultResult, JsonUnmarshallerContext> {

    public PutThirdPartyJobSuccessResultResult unmarshall(
            JsonUnmarshallerContext context) throws Exception {
        PutThirdPartyJobSuccessResultResult putThirdPartyJobSuccessResultResult = new PutThirdPartyJobSuccessResultResult();
