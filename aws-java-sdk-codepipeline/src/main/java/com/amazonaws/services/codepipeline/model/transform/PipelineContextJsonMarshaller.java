    ...
    public void marshall(PipelineContext pipelineContext, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (pipelineContext.getStage() != null) {
                ...
                StageContextJsonMarshaller.getInstance().marshall(pipelineContext.getStage(), jsonGenerator);
            }
            if (pipelineContext.getAction() != null) {
                jsonGenerator.writeFieldName("action");
                ActionContextJsonMarshaller.getInstance().marshall(pipelineContext.getAction(), jsonGenerator);
            }
