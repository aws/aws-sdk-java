 ...
 */
public class PutThirdPartyJobFailureResultResultJsonUnmarshaller
        implements
        Unmarshaller<PutThirdPartyJobFailureResultResult, JsonUnmarshallerContext> {

    public PutThirdPartyJobFailureResultResult unmarshall(
