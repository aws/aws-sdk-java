...
public class DisableStageTransitionRequestMarshaller
        implements
        Marshaller<Request<DisableStageTransitionRequest>, DisableStageTransitionRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DisableStageTransitionRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DisableStageTransitionRequest> marshall(
        ...
        Request<DisableStageTransitionRequest> request = new DefaultRequest<DisableStageTransitionRequest>(
                disableStageTransitionRequest, "AWSCodePipeline");
