...
public class ActionDeclarationMarshaller {
    ...
    private static final MarshallingInfo<Integer> RUNORDER_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("runOrder").build();
    ...
    public void marshall(ActionDeclaration actionDeclaration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(actionDeclaration.getName(), NAME_BINDING);
            protocolMarshaller.marshall(actionDeclaration.getActionTypeId(), ACTIONTYPEID_BINDING);
            protocolMarshaller.marshall(actionDeclaration.getRunOrder(), RUNORDER_BINDING);
            protocolMarshaller.marshall(actionDeclaration.getConfiguration(), CONFIGURATION_BINDING);
