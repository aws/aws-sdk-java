    ...
    public void marshall(ArtifactLocation artifactLocation, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (artifactLocation.getType() != null) {
                jsonGenerator.writeFieldName("type").writeValue(artifactLocation.getType());
            }
            if (artifactLocation.getS3Location() != null) {
                jsonGenerator.writeFieldName("s3Location");
                S3ArtifactLocationJsonMarshaller.getInstance().marshall(artifactLocation.getS3Location(), jsonGenerator);
            }
