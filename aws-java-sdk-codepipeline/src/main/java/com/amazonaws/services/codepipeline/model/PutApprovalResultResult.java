 ...
 * </p>
 */
public class PutApprovalResultResult implements Serializable, Cloneable {
     ...
     * 
     * @param approvedAt
     *        The timestamp showing when the approval or rejection was
     *        submitted.
     */
     ...
     * </p>
     * 
     * @return The timestamp showing when the approval or rejection was
     *         submitted.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getApprovedAt() == null ^ this.getApprovedAt() == null)
            return false;
        if (other.getApprovedAt() != null
                && other.getApprovedAt().equals(this.getApprovedAt()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getApprovedAt() == null) ? 0 : getApprovedAt().hashCode());
        return hashCode;
    }
