...
public class AWSSessionCredentialsJsonMarshaller {
     ...
     */
    public void marshall(AWSSessionCredentials aWSSessionCredentials, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (aWSSessionCredentials.getAccessKeyId() != null) {
                jsonGenerator.writeFieldName("accessKeyId").writeValue(aWSSessionCredentials.getAccessKeyId());
            }
            if (aWSSessionCredentials.getSecretAccessKey() != null) {
                jsonGenerator.writeFieldName("secretAccessKey").writeValue(aWSSessionCredentials.getSecretAccessKey());
            }
            if (aWSSessionCredentials.getSessionToken() != null) {
                jsonGenerator.writeFieldName("sessionToken").writeValue(aWSSessionCredentials.getSessionToken());
            }
