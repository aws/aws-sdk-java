...
public class DeleteCustomActionTypeRequestMarshaller
        implements
        Marshaller<Request<DeleteCustomActionTypeRequest>, DeleteCustomActionTypeRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DeleteCustomActionTypeRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeleteCustomActionTypeRequest> marshall(
        ...
        Request<DeleteCustomActionTypeRequest> request = new DefaultRequest<DeleteCustomActionTypeRequest>(
                deleteCustomActionTypeRequest, "AWSCodePipeline");
