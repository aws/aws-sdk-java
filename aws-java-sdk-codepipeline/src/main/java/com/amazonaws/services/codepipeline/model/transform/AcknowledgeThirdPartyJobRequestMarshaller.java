...
public class AcknowledgeThirdPartyJobRequestMarshaller
        implements
        Marshaller<Request<AcknowledgeThirdPartyJobRequest>, AcknowledgeThirdPartyJobRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public AcknowledgeThirdPartyJobRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<AcknowledgeThirdPartyJobRequest> marshall(
        ...
        Request<AcknowledgeThirdPartyJobRequest> request = new DefaultRequest<AcknowledgeThirdPartyJobRequest>(
                acknowledgeThirdPartyJobRequest, "AWSCodePipeline");
