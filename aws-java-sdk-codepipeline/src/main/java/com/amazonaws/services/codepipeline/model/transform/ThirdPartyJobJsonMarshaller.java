...
public class ThirdPartyJobJsonMarshaller {
    ...
    public void marshall(ThirdPartyJob thirdPartyJob, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (thirdPartyJob.getClientId() != null) {
                jsonGenerator.writeFieldName("clientId").writeValue(thirdPartyJob.getClientId());
            }
            if (thirdPartyJob.getJobId() != null) {
                jsonGenerator.writeFieldName("jobId").writeValue(thirdPartyJob.getJobId());
            }
    ...
    public static ThirdPartyJobJsonMarshaller getInstance() {
        if (instance == null)
            instance = new ThirdPartyJobJsonMarshaller();
        return instance;
    }
