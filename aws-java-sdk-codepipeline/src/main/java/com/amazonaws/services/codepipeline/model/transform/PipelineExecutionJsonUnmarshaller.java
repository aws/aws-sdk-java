 ...
 */
public class PipelineExecutionJsonUnmarshaller implements
        Unmarshaller<PipelineExecution, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("pipelineName", targetDepth)) {
                    context.nextToken();
                    pipelineExecution.setPipelineName(context.getUnmarshaller(
                ...
                if (context.testExpression("pipelineExecutionId", targetDepth)) {
                    context.nextToken();
                    pipelineExecution.setPipelineExecutionId(context
