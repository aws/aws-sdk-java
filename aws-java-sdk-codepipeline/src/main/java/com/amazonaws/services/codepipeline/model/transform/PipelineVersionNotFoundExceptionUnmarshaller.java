...
public class PipelineVersionNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PipelineVersionNotFoundExceptionUnmarshaller instance;

    public static PipelineVersionNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PipelineVersionNotFoundExceptionUnmarshaller();
        return instance;
    }
}
