...
public class UpdatePipelineRequestMarshaller implements
    ...
    public Request<UpdatePipelineRequest> marshall(
        ...
        Request<UpdatePipelineRequest> request = new DefaultRequest<UpdatePipelineRequest>(
                updatePipelineRequest, "AWSCodePipeline");
        ...
        try {
            ...
            if (updatePipelineRequest.getPipeline() != null) {
                jsonWriter.key("pipeline");
                PipelineDeclarationJsonMarshaller.getInstance().marshall(
                        updatePipelineRequest.getPipeline(), jsonWriter);
            }
