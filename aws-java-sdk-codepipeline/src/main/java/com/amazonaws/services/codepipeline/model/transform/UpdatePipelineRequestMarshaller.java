...
public class UpdatePipelineRequestMarshaller implements Marshaller<Request<UpdatePipelineRequest>, UpdatePipelineRequest> {
    ...
    public Request<UpdatePipelineRequest> marshall(UpdatePipelineRequest updatePipelineRequest) {
        ...
        Request<UpdatePipelineRequest> request = new DefaultRequest<UpdatePipelineRequest>(updatePipelineRequest, "AWSCodePipeline");
        request.addHeader("X-Amz-Target", "CodePipeline_20150709.UpdatePipeline");
        ...
        try {
            ...
            if (updatePipelineRequest.getPipeline() != null) {
                jsonGenerator.writeFieldName("pipeline");
                PipelineDeclarationJsonMarshaller.getInstance().marshall(updatePipelineRequest.getPipeline(), jsonGenerator);
            }
