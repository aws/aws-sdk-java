 ...
 */
public class ErrorDetailsJsonUnmarshaller implements
        Unmarshaller<ErrorDetails, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("code", targetDepth)) {
                    context.nextToken();
                    errorDetails.setCode(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
                if (context.testExpression("message", targetDepth)) {
                    context.nextToken();
                    errorDetails.setMessage(context.getUnmarshaller(
