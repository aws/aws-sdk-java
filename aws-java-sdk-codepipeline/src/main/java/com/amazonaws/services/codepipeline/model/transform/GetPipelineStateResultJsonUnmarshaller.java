 ...
 */
public class GetPipelineStateResultJsonUnmarshaller implements
        Unmarshaller<GetPipelineStateResult, JsonUnmarshallerContext> {

    public GetPipelineStateResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("stageStates", targetDepth)) {
                    context.nextToken();
                    getPipelineStateResult
                            .setStageStates(new ListUnmarshaller<StageState>(
                                    StageStateJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
