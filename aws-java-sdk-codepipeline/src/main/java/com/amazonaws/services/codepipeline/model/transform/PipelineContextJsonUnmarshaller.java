 ...
 */
public class PipelineContextJsonUnmarshaller implements
        Unmarshaller<PipelineContext, JsonUnmarshallerContext> {

    public PipelineContext unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("stage", targetDepth)) {
                    context.nextToken();
                    pipelineContext.setStage(StageContextJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
                if (context.testExpression("action", targetDepth)) {
                    context.nextToken();
                    pipelineContext.setAction(ActionContextJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
