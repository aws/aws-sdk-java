...
public class InvalidApprovalTokenExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidApprovalTokenExceptionUnmarshaller instance;

    public static InvalidApprovalTokenExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidApprovalTokenExceptionUnmarshaller();
        return instance;
    }
}
