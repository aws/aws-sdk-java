...
public interface AWSCodePipeline {
     ...
     * ("https://codepipeline.us-east-1.amazonaws.com"). Callers can use this
    ...
    /**
     * An alternative to {@link AWSCodePipeline#setEndpoint(String)}, sets the
     ...
     */
    RetryStageExecutionResult retryStageExecution(
