...
public class InputArtifactJsonUnmarshaller implements Unmarshaller<InputArtifact, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    inputArtifact.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static InputArtifactJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new InputArtifactJsonUnmarshaller();
        return instance;
    }
}
