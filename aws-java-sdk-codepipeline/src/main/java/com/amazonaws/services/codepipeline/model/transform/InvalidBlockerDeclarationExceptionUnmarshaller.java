...
public class InvalidBlockerDeclarationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidBlockerDeclarationExceptionUnmarshaller instance;

    public static InvalidBlockerDeclarationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidBlockerDeclarationExceptionUnmarshaller();
        return instance;
    }
}
