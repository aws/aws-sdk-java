...
public class SourceRevisionMarshaller {
    ...
    public void marshall(SourceRevision sourceRevision, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sourceRevision.getActionName(), ACTIONNAME_BINDING);
            protocolMarshaller.marshall(sourceRevision.getRevisionId(), REVISIONID_BINDING);
            protocolMarshaller.marshall(sourceRevision.getRevisionSummary(), REVISIONSUMMARY_BINDING);
            protocolMarshaller.marshall(sourceRevision.getRevisionUrl(), REVISIONURL_BINDING);
        } catch (Exception e) {
