 ...
 */
public class StageDeclarationJsonUnmarshaller implements
        Unmarshaller<StageDeclaration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    stageDeclaration.setName(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("blockers", targetDepth)) {
                    context.nextToken();
                    stageDeclaration
                            .setBlockers(new ListUnmarshaller<BlockerDeclaration>(
                ...
                if (context.testExpression("actions", targetDepth)) {
                    context.nextToken();
                    stageDeclaration
                            .setActions(new ListUnmarshaller<ActionDeclaration>(
