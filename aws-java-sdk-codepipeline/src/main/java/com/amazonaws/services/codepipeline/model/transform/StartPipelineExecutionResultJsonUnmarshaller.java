 ...
 */
public class StartPipelineExecutionResultJsonUnmarshaller implements
        Unmarshaller<StartPipelineExecutionResult, JsonUnmarshallerContext> {

    public StartPipelineExecutionResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("pipelineExecutionId", targetDepth)) {
                    context.nextToken();
                    startPipelineExecutionResult.setPipelineExecutionId(context
