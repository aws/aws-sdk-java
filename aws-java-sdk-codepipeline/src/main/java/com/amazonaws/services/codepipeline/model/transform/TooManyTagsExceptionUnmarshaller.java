...
public class TooManyTagsExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.codepipeline.model.TooManyTagsException> {
    private TooManyTagsExceptionUnmarshaller() {
        super("TooManyTagsException");
    }

    @Override
    public com.amazonaws.services.codepipeline.model.TooManyTagsException unmarshall(JsonUnmarshallerContext context) throws Exception {
