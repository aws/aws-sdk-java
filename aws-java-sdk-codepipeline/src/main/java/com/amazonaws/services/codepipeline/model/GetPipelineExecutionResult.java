 ...
 * </p>
 */
public class GetPipelineExecutionResult implements Serializable, Cloneable {
    ...
    public GetPipelineExecutionResult withPipelineExecution(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPipelineExecution() == null
                ^ this.getPipelineExecution() == null)
            return false;
        if (other.getPipelineExecution() != null
                && other.getPipelineExecution().equals(
                        this.getPipelineExecution()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getPipelineExecution() == null) ? 0
                        : getPipelineExecution().hashCode());
        return hashCode;
    }
