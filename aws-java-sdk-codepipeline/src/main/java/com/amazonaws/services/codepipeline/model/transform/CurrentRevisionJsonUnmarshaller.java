...
public class CurrentRevisionJsonUnmarshaller implements Unmarshaller<CurrentRevision, JsonUnmarshallerContext> {

    public CurrentRevision unmarshall(JsonUnmarshallerContext context) throws Exception {
