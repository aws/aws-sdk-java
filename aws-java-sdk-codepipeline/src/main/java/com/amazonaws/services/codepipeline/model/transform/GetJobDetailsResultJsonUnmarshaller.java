 ...
 */
public class GetJobDetailsResultJsonUnmarshaller implements
        Unmarshaller<GetJobDetailsResult, JsonUnmarshallerContext> {

    public GetJobDetailsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("jobDetails", targetDepth)) {
                    context.nextToken();
                    getJobDetailsResult
                            .setJobDetails(JobDetailsJsonUnmarshaller
