...
public class S3ArtifactLocationJsonMarshaller {
     ...
     */
    public void marshall(S3ArtifactLocation s3ArtifactLocation, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (s3ArtifactLocation.getBucketName() != null) {
                jsonGenerator.writeFieldName("bucketName").writeValue(s3ArtifactLocation.getBucketName());
            }
            if (s3ArtifactLocation.getObjectKey() != null) {
                jsonGenerator.writeFieldName("objectKey").writeValue(s3ArtifactLocation.getObjectKey());
            }
