...
@SdkInternalApi
public class DeleteWebhookRequestMarshaller {

    private static final MarshallingInfo<String> NAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("name").build();

    private static final DeleteWebhookRequestMarshaller instance = new DeleteWebhookRequestMarshaller();

    public static DeleteWebhookRequestMarshaller getInstance() {
        return instance;
    }
