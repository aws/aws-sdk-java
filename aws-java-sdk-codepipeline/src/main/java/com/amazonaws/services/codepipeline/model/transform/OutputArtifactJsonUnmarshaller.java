...
public class OutputArtifactJsonUnmarshaller implements Unmarshaller<OutputArtifact, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    outputArtifact.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static OutputArtifactJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OutputArtifactJsonUnmarshaller();
        return instance;
    }
}
