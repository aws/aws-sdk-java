 ...
 */
public class OutputArtifactJsonUnmarshaller implements
        Unmarshaller<OutputArtifact, JsonUnmarshallerContext> {

    public OutputArtifact unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    outputArtifact.setName(StringJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
