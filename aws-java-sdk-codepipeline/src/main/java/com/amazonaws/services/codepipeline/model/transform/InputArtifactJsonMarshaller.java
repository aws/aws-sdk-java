...
public class InputArtifactJsonMarshaller {
     ...
     */
    public void marshall(InputArtifact inputArtifact, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (inputArtifact.getName() != null) {
                jsonGenerator.writeFieldName("name").writeValue(inputArtifact.getName());
            }
