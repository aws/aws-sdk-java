...
public class InvalidJobExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidJobExceptionUnmarshaller instance;

    public static InvalidJobExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidJobExceptionUnmarshaller();
        return instance;
    }
}
