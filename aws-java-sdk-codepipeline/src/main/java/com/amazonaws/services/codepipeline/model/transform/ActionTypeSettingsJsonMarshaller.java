    ...
    public void marshall(ActionTypeSettings actionTypeSettings, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (actionTypeSettings.getThirdPartyConfigurationUrl() != null) {
                jsonGenerator.writeFieldName("thirdPartyConfigurationUrl").writeValue(actionTypeSettings.getThirdPartyConfigurationUrl());
            }
            if (actionTypeSettings.getEntityUrlTemplate() != null) {
                jsonGenerator.writeFieldName("entityUrlTemplate").writeValue(actionTypeSettings.getEntityUrlTemplate());
            }
            if (actionTypeSettings.getExecutionUrlTemplate() != null) {
                jsonGenerator.writeFieldName("executionUrlTemplate").writeValue(actionTypeSettings.getExecutionUrlTemplate());
            }
            if (actionTypeSettings.getRevisionUrlTemplate() != null) {
                jsonGenerator.writeFieldName("revisionUrlTemplate").writeValue(actionTypeSettings.getRevisionUrlTemplate());
            }
