...
public class InvalidWebhookAuthenticationParametersExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidWebhookAuthenticationParametersExceptionUnmarshaller instance;

    public static InvalidWebhookAuthenticationParametersExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidWebhookAuthenticationParametersExceptionUnmarshaller();
        return instance;
    }
}
