 ...
 */
public class PollForJobsResultJsonUnmarshaller implements
        Unmarshaller<PollForJobsResult, JsonUnmarshallerContext> {

    public PollForJobsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("jobs", targetDepth)) {
                    context.nextToken();
                    pollForJobsResult.setJobs(new ListUnmarshaller<Job>(
