...
public class ListPipelineExecutionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * To view all items in the list, continue to call this operation with each subsequent token until no more nextToken
     * values are returned.
     * </p>
     */
     ...
     * </p>
     * 
     * @return A token that can be used in the next list pipeline executions call to return the next set of pipeline
     *         executions. To view all items in the list, continue to call this operation with each subsequent token
     *         until no more nextToken values are returned.
     */
