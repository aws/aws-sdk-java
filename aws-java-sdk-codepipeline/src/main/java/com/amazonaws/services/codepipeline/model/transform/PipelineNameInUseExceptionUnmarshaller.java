...
public class PipelineNameInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PipelineNameInUseExceptionUnmarshaller instance;

    public static PipelineNameInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PipelineNameInUseExceptionUnmarshaller();
        return instance;
    }
}
