...
public class WebhookNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static WebhookNotFoundExceptionUnmarshaller instance;

    public static WebhookNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WebhookNotFoundExceptionUnmarshaller();
        return instance;
    }
}
