 ...
 */
public class ArtifactStoreJsonUnmarshaller implements
        Unmarshaller<ArtifactStore, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("type", targetDepth)) {
                    context.nextToken();
                    artifactStore.setType(StringJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
    ...
    public static ArtifactStoreJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ArtifactStoreJsonUnmarshaller();
        return instance;
    }
}
