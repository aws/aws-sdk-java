...
public class PutJobFailureResultRequestMarshaller
        implements
        Marshaller<Request<PutJobFailureResultRequest>, PutJobFailureResultRequest> {

    public Request<PutJobFailureResultRequest> marshall(
        ...
        Request<PutJobFailureResultRequest> request = new DefaultRequest<PutJobFailureResultRequest>(
                putJobFailureResultRequest, "AWSCodePipeline");
        ...
        try {
            ...
            if (putJobFailureResultRequest.getJobId() != null) {
                jsonWriter.key("jobId").value(
                        putJobFailureResultRequest.getJobId());
            }
            ...
            if (putJobFailureResultRequest.getFailureDetails() != null) {
                ...
                FailureDetailsJsonMarshaller.getInstance().marshall(
                        putJobFailureResultRequest.getFailureDetails(),
                        jsonWriter);
            }
