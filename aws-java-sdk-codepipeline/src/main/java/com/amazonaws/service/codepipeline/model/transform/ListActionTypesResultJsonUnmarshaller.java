 ...
 */
public class ListActionTypesResultJsonUnmarshaller implements
        Unmarshaller<ListActionTypesResult, JsonUnmarshallerContext> {

    public ListActionTypesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("actionTypes", targetDepth)) {
                    ...
                    listActionTypesResult
                            .setActionTypes(new ListUnmarshaller<ActionType>(
                                    ActionTypeJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listActionTypesResult.setNextToken(StringJsonUnmarshaller
