 ...
 */
public class ThirdPartyJobDetailsJsonUnmarshaller implements
        Unmarshaller<ThirdPartyJobDetails, JsonUnmarshallerContext> {

    public ThirdPartyJobDetails unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ThirdPartyJobDetails thirdPartyJobDetails = new ThirdPartyJobDetails();
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("data", targetDepth)) {
                    ...
                    thirdPartyJobDetails
                            .setData(ThirdPartyJobDataJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
    ...
    public static ThirdPartyJobDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ThirdPartyJobDetailsJsonUnmarshaller();
        return instance;
    }
}
