 ...
 */
public class PutActionRevisionResultJsonUnmarshaller implements
        Unmarshaller<PutActionRevisionResult, JsonUnmarshallerContext> {

    public PutActionRevisionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        PutActionRevisionResult putActionRevisionResult = new PutActionRevisionResult();
    ...
    public static PutActionRevisionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PutActionRevisionResultJsonUnmarshaller();
        return instance;
    }
}
