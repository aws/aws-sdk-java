 ...
 */
public class GetPipelineResultJsonUnmarshaller implements
        Unmarshaller<GetPipelineResult, JsonUnmarshallerContext> {

    public GetPipelineResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("pipeline", targetDepth)) {
                    context.nextToken();
                    getPipelineResult
                            .setPipeline(PipelineDeclarationJsonUnmarshaller
