 ...
 */
public class StageContextJsonUnmarshaller implements
        Unmarshaller<StageContext, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    stageContext.setName(StringJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
    ...
    public static StageContextJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StageContextJsonUnmarshaller();
        return instance;
    }
}
