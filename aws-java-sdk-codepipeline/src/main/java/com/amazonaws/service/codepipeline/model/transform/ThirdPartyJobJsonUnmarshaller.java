 ...
 */
public class ThirdPartyJobJsonUnmarshaller implements
        Unmarshaller<ThirdPartyJob, JsonUnmarshallerContext> {

    public ThirdPartyJob unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ThirdPartyJob thirdPartyJob = new ThirdPartyJob();
    ...
    public static ThirdPartyJobJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ThirdPartyJobJsonUnmarshaller();
        return instance;
    }
}
