...
public class PutJobSuccessResultRequestMarshaller
        implements
        Marshaller<Request<PutJobSuccessResultRequest>, PutJobSuccessResultRequest> {

    public Request<PutJobSuccessResultRequest> marshall(
        ...
        Request<PutJobSuccessResultRequest> request = new DefaultRequest<PutJobSuccessResultRequest>(
                putJobSuccessResultRequest, "AWSCodePipeline");
