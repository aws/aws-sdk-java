...
/**
 * AssociateCreatedArtifactRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssociateCreatedArtifactRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CREATEDARTIFACT_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CreatedArtifact").build();
    ...
    private static final AssociateCreatedArtifactRequestMarshaller instance = new AssociateCreatedArtifactRequestMarshaller();

    public static AssociateCreatedArtifactRequestMarshaller getInstance() {
        return instance;
    }
