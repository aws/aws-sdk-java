...
public class ListDiscoveredResourcesRequestMarshaller {
    ...
    public void marshall(ListDiscoveredResourcesRequest listDiscoveredResourcesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listDiscoveredResourcesRequest.getProgressUpdateStream(), PROGRESSUPDATESTREAM_BINDING);
            protocolMarshaller.marshall(listDiscoveredResourcesRequest.getMigrationTaskName(), MIGRATIONTASKNAME_BINDING);
