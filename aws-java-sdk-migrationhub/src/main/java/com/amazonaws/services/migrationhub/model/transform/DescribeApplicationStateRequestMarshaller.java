...
public class DescribeApplicationStateRequestMarshaller {
    ...
    private static final DescribeApplicationStateRequestMarshaller instance = new DescribeApplicationStateRequestMarshaller();

    public static DescribeApplicationStateRequestMarshaller getInstance() {
        return instance;
    }
