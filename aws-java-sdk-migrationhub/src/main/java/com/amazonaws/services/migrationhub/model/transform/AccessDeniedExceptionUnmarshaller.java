...
public class AccessDeniedExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.migrationhub.model.AccessDeniedException> {
    private AccessDeniedExceptionUnmarshaller() {
        super("AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.migrationhub.model.AccessDeniedException unmarshall(JsonUnmarshallerContext context) throws Exception {
