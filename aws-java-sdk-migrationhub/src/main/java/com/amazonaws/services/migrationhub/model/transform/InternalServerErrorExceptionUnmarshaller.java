...
public class InternalServerErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerErrorExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhub.model.InternalServerErrorException.class, "InternalServerError");
    }

    @Override
    public com.amazonaws.services.migrationhub.model.InternalServerErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
