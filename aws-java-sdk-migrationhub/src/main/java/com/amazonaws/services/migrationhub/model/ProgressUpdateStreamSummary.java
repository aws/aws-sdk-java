 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/ProgressUpdateStreamSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProgressUpdateStreamSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public ProgressUpdateStreamSummary clone() {
        try {
            return (ProgressUpdateStreamSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.migrationhub.model.transform.ProgressUpdateStreamSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
