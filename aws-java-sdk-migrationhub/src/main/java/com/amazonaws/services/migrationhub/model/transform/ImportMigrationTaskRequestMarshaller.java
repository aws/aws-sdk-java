...
/**
 * ImportMigrationTaskRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ImportMigrationTaskRequestMarshaller {
    ...
    private static final ImportMigrationTaskRequestMarshaller instance = new ImportMigrationTaskRequestMarshaller();

    public static ImportMigrationTaskRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ImportMigrationTaskRequest importMigrationTaskRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(importMigrationTaskRequest.getProgressUpdateStream(), PROGRESSUPDATESTREAM_BINDING);
            protocolMarshaller.marshall(importMigrationTaskRequest.getMigrationTaskName(), MIGRATIONTASKNAME_BINDING);
            protocolMarshaller.marshall(importMigrationTaskRequest.getDryRun(), DRYRUN_BINDING);
        } catch (Exception e) {
