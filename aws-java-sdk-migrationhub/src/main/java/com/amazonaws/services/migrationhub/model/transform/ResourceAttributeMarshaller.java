...
public class ResourceAttributeMarshaller {
    ...
    public void marshall(ResourceAttribute resourceAttribute, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourceAttribute.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(resourceAttribute.getValue(), VALUE_BINDING);
        } catch (Exception e) {
