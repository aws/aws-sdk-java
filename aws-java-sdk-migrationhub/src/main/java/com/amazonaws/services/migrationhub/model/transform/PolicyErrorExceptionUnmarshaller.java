...
public class PolicyErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PolicyErrorExceptionUnmarshaller instance;

    public static PolicyErrorExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PolicyErrorExceptionUnmarshaller();
        return instance;
    }
}
