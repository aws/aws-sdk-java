...
/**
 * DeleteProgressUpdateStreamResult JSON Unmarshaller
 */
...
public class DeleteProgressUpdateStreamResultJsonUnmarshaller implements Unmarshaller<DeleteProgressUpdateStreamResult, JsonUnmarshallerContext> {
    ...
    public DeleteProgressUpdateStreamResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteProgressUpdateStreamResult deleteProgressUpdateStreamResult = new DeleteProgressUpdateStreamResult();
