...
/**
 * DeleteLedgerResult JSON Unmarshaller
 */
...
public class DeleteLedgerResultJsonUnmarshaller implements Unmarshaller<DeleteLedgerResult, JsonUnmarshallerContext> {
    ...
    public DeleteLedgerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLedgerResult deleteLedgerResult = new DeleteLedgerResult();
