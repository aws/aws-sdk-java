...
/**
 * GetRevisionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetRevisionRequestMarshaller {
    ...
    private static final GetRevisionRequestMarshaller instance = new GetRevisionRequestMarshaller();

    public static GetRevisionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetRevisionRequest getRevisionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getRevisionRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(getRevisionRequest.getBlockAddress(), BLOCKADDRESS_BINDING);
            protocolMarshaller.marshall(getRevisionRequest.getDocumentId(), DOCUMENTID_BINDING);
            protocolMarshaller.marshall(getRevisionRequest.getDigestTipAddress(), DIGESTTIPADDRESS_BINDING);
        } catch (Exception e) {
