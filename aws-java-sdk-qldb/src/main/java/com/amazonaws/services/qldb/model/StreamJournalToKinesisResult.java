...
public class StreamJournalToKinesisResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StreamJournalToKinesisResult == false)
            return false;
        StreamJournalToKinesisResult other = (StreamJournalToKinesisResult) obj;
    ...
    @Override
    public StreamJournalToKinesisResult clone() {
        try {
            return (StreamJournalToKinesisResult) super.clone();
