...
public class ListJournalS3ExportsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * of results, use the value of <code>NextToken</code> in a subsequent <code>ListJournalS3Exports</code> call.
     * </p>
     * </li>
     * </ul>
     */
     ...
     * </p>
     * 
     * @return The journal export jobs for all ledgers that are associated with the current Amazon Web Services account
     *         and Region.
     */
     ...
     *        The journal export jobs for all ledgers that are associated with the current Amazon Web Services account
     *        and Region.
     */
    ...
    public ListJournalS3ExportsResult withJournalS3Exports(JournalS3ExportDescription... journalS3Exports) {
    ...
    public ListJournalS3ExportsResult withJournalS3Exports(java.util.Collection<JournalS3ExportDescription> journalS3Exports) {
     ...
     *        page of results, use the value of <code>NextToken</code> in a subsequent <code>ListJournalS3Exports</code>
     *        call.
     *        </p>
     *        </li>
     */
     ...
     *         <code>ListJournalS3Exports</code> call.
     *         </p>
     *         </li>
     */
    ...
    @Override
    public ListJournalS3ExportsResult clone() {
        try {
            return (ListJournalS3ExportsResult) super.clone();
