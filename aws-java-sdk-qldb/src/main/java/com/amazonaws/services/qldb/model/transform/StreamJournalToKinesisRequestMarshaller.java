...
/**
 * StreamJournalToKinesisRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StreamJournalToKinesisRequestMarshaller {
    ...
    private static final StreamJournalToKinesisRequestMarshaller instance = new StreamJournalToKinesisRequestMarshaller();

    public static StreamJournalToKinesisRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StreamJournalToKinesisRequest streamJournalToKinesisRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(streamJournalToKinesisRequest.getLedgerName(), LEDGERNAME_BINDING);
            protocolMarshaller.marshall(streamJournalToKinesisRequest.getRoleArn(), ROLEARN_BINDING);
            protocolMarshaller.marshall(streamJournalToKinesisRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(streamJournalToKinesisRequest.getInclusiveStartTime(), INCLUSIVESTARTTIME_BINDING);
            protocolMarshaller.marshall(streamJournalToKinesisRequest.getExclusiveEndTime(), EXCLUSIVEENDTIME_BINDING);
            protocolMarshaller.marshall(streamJournalToKinesisRequest.getKinesisConfiguration(), KINESISCONFIGURATION_BINDING);
            protocolMarshaller.marshall(streamJournalToKinesisRequest.getStreamName(), STREAMNAME_BINDING);
        } catch (Exception e) {
