 ...
 */
public class DecisionTaskCompletedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<DecisionTaskCompletedEventAttributes, JsonUnmarshallerContext> {

    public DecisionTaskCompletedEventAttributes unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("executionContext", targetDepth)) {
                    ...
                    decisionTaskCompletedEventAttributes
                            .setExecutionContext(context.getUnmarshaller(
