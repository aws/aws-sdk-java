 ...
 * 
 */
public class RespondDecisionTaskCompletedRequest extends
     ...
     * 
     * @param taskToken
     *        The <code>taskToken</code> from the <a>DecisionTask</a>.</p>
     ...
     * provide its progress and respond with results.</important>
     * 
     * @return The <code>taskToken</code> from the <a>DecisionTask</a>.</p>
     *         <important><code>taskToken</code> is generated by the service and
     *         should be treated as an opaque value. If the task is passed to
     *         another process, its <code>taskToken</code> must also be passed.
     *         This enables it to provide its progress and respond with results.
     ...
     * any). Use {@link #setDecisions(java.util.Collection)} or
     * {@link #withDecisions(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param decisions
    ...
    public RespondDecisionTaskCompletedRequest withDecisions(
            Decision... decisions) {
    ...
    public RespondDecisionTaskCompletedRequest withDecisions(
            java.util.Collection<Decision> decisions) {
    ...
    public RespondDecisionTaskCompletedRequest withExecutionContext(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDecisions() == null ^ this.getDecisions() == null)
            return false;
        if (other.getDecisions() != null
                && other.getDecisions().equals(this.getDecisions()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getDecisions() == null) ? 0 : getDecisions().hashCode());
        hashCode = prime
                * hashCode
