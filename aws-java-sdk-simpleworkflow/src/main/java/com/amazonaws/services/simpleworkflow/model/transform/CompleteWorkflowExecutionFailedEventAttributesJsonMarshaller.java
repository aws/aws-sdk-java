    ...
    public void marshall(CompleteWorkflowExecutionFailedEventAttributes completeWorkflowExecutionFailedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (completeWorkflowExecutionFailedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(completeWorkflowExecutionFailedEventAttributes.getCause());
            }
            if (completeWorkflowExecutionFailedEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(
                        completeWorkflowExecutionFailedEventAttributes.getDecisionTaskCompletedEventId());
            }
