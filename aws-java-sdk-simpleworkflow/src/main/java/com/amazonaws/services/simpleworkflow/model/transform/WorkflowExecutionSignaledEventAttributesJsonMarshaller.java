    ...
    public void marshall(WorkflowExecutionSignaledEventAttributes workflowExecutionSignaledEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (workflowExecutionSignaledEventAttributes.getSignalName() != null) {
                jsonGenerator.writeFieldName("signalName").writeValue(workflowExecutionSignaledEventAttributes.getSignalName());
            }
            if (workflowExecutionSignaledEventAttributes.getInput() != null) {
                jsonGenerator.writeFieldName("input").writeValue(workflowExecutionSignaledEventAttributes.getInput());
            }
            if (workflowExecutionSignaledEventAttributes.getExternalWorkflowExecution() != null) {
                ...
                WorkflowExecutionJsonMarshaller.getInstance().marshall(workflowExecutionSignaledEventAttributes.getExternalWorkflowExecution(), jsonGenerator);
            }
            if (workflowExecutionSignaledEventAttributes.getExternalInitiatedEventId() != null) {
                jsonGenerator.writeFieldName("externalInitiatedEventId").writeValue(workflowExecutionSignaledEventAttributes.getExternalInitiatedEventId());
            }
