    ...
    public void marshall(DecisionTaskStartedEventAttributes decisionTaskStartedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (decisionTaskStartedEventAttributes.getIdentity() != null) {
                jsonGenerator.writeFieldName("identity").writeValue(decisionTaskStartedEventAttributes.getIdentity());
            }
            if (decisionTaskStartedEventAttributes.getScheduledEventId() != null) {
                jsonGenerator.writeFieldName("scheduledEventId").writeValue(decisionTaskStartedEventAttributes.getScheduledEventId());
            }
