...
public class RecordMarkerFailedEventAttributes implements Serializable,
     ...
     * the decision task that resulted in the <code>RecordMarkerFailed</code>
    ...
    public RecordMarkerFailedEventAttributes withCause(
     ...
     *         corresponding to the decision task that resulted in the
     *         <code>RecordMarkerFailed</code> decision for this cancellation
     *         request. This information can be useful for diagnosing problems
    ...
    public RecordMarkerFailedEventAttributes withDecisionTaskCompletedEventId(
            Long decisionTaskCompletedEventId) {
