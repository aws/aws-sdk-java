 ...
 */
public class WorkflowExecutionTerminatedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<WorkflowExecutionTerminatedEventAttributes, JsonUnmarshallerContext> {

    public WorkflowExecutionTerminatedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("cause", targetDepth)) {
                    context.nextToken();
                    workflowExecutionTerminatedEventAttributes.setCause(context
