    ...
    public void marshall(ChildWorkflowExecutionTimedOutEventAttributes childWorkflowExecutionTimedOutEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (childWorkflowExecutionTimedOutEventAttributes.getWorkflowExecution() != null) {
                ...
                WorkflowExecutionJsonMarshaller.getInstance().marshall(childWorkflowExecutionTimedOutEventAttributes.getWorkflowExecution(), jsonGenerator);
            }
            if (childWorkflowExecutionTimedOutEventAttributes.getWorkflowType() != null) {
                jsonGenerator.writeFieldName("workflowType");
                WorkflowTypeJsonMarshaller.getInstance().marshall(childWorkflowExecutionTimedOutEventAttributes.getWorkflowType(), jsonGenerator);
            }
            if (childWorkflowExecutionTimedOutEventAttributes.getTimeoutType() != null) {
                jsonGenerator.writeFieldName("timeoutType").writeValue(childWorkflowExecutionTimedOutEventAttributes.getTimeoutType());
            }
            if (childWorkflowExecutionTimedOutEventAttributes.getInitiatedEventId() != null) {
                jsonGenerator.writeFieldName("initiatedEventId").writeValue(childWorkflowExecutionTimedOutEventAttributes.getInitiatedEventId());
            }
            if (childWorkflowExecutionTimedOutEventAttributes.getStartedEventId() != null) {
                jsonGenerator.writeFieldName("startedEventId").writeValue(childWorkflowExecutionTimedOutEventAttributes.getStartedEventId());
            }
