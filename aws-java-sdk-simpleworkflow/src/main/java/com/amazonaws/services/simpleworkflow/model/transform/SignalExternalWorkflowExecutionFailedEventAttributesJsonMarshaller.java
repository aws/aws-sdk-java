    ...
    public void marshall(SignalExternalWorkflowExecutionFailedEventAttributes signalExternalWorkflowExecutionFailedEventAttributes,
        ...
        try {
            ...
            if (signalExternalWorkflowExecutionFailedEventAttributes.getWorkflowId() != null) {
                jsonGenerator.writeFieldName("workflowId").writeValue(signalExternalWorkflowExecutionFailedEventAttributes.getWorkflowId());
            }
            if (signalExternalWorkflowExecutionFailedEventAttributes.getRunId() != null) {
                jsonGenerator.writeFieldName("runId").writeValue(signalExternalWorkflowExecutionFailedEventAttributes.getRunId());
            }
            if (signalExternalWorkflowExecutionFailedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(signalExternalWorkflowExecutionFailedEventAttributes.getCause());
            }
            if (signalExternalWorkflowExecutionFailedEventAttributes.getInitiatedEventId() != null) {
                jsonGenerator.writeFieldName("initiatedEventId").writeValue(signalExternalWorkflowExecutionFailedEventAttributes.getInitiatedEventId());
            }
            if (signalExternalWorkflowExecutionFailedEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(
                        signalExternalWorkflowExecutionFailedEventAttributes.getDecisionTaskCompletedEventId());
            }
            if (signalExternalWorkflowExecutionFailedEventAttributes.getControl() != null) {
                jsonGenerator.writeFieldName("control").writeValue(signalExternalWorkflowExecutionFailedEventAttributes.getControl());
            }
