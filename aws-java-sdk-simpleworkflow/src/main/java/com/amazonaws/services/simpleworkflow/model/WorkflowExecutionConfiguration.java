 ...
 * specified when registering the workflow type and those specified when
...
public class WorkflowExecutionConfiguration implements Serializable, Cloneable {
    ...
    public WorkflowExecutionConfiguration withTaskStartToCloseTimeout(
    ...
    public WorkflowExecutionConfiguration withExecutionStartToCloseTimeout(
            String executionStartToCloseTimeout) {
     ...
     * </p>
     * 
     * @return The task list used for the decision tasks generated for this
     *         workflow execution.
     */
     ...
     * </p>
     * 
     * @return The priority assigned to decision tasks for this workflow
     *         execution. Valid values are integers that range from Java's
     *         <code>Integer.MIN_VALUE</code> (-2147483648) to
     *         <code>Integer.MAX_VALUE</code> (2147483647). Higher numbers
     *         indicate higher priority.</p>
    ...
    public WorkflowExecutionConfiguration withChildPolicy(
     ...
     * </p>
     * 
     * @return The IAM role used by this workflow execution when invoking AWS
     *         Lambda functions.
     */
