 ...
 * </p>
 */
public class ChildWorkflowExecutionCompletedEventAttributes implements
    ...
    public ChildWorkflowExecutionCompletedEventAttributes withWorkflowExecution(
    ...
    public ChildWorkflowExecutionCompletedEventAttributes withWorkflowType(
    ...
    public ChildWorkflowExecutionCompletedEventAttributes withResult(
            String result) {
        setResult(result);
        return this;
    }
    ...
    public ChildWorkflowExecutionCompletedEventAttributes withInitiatedEventId(
    ...
    public ChildWorkflowExecutionCompletedEventAttributes withStartedEventId(
            Long startedEventId) {
    ...
    public ChildWorkflowExecutionCompletedEventAttributes clone() {
        try {
            return (ChildWorkflowExecutionCompletedEventAttributes) super
                    .clone();
