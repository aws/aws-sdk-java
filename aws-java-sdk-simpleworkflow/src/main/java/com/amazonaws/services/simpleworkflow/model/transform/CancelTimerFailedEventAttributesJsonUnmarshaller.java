 ...
 */
public class CancelTimerFailedEventAttributesJsonUnmarshaller implements
        Unmarshaller<CancelTimerFailedEventAttributes, JsonUnmarshallerContext> {

    public CancelTimerFailedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("timerId", targetDepth)) {
                    context.nextToken();
                    cancelTimerFailedEventAttributes.setTimerId(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("cause", targetDepth)) {
                    context.nextToken();
                    cancelTimerFailedEventAttributes.setCause(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
