 ...
 */
public class StartTimerFailedEventAttributesJsonUnmarshaller implements
        Unmarshaller<StartTimerFailedEventAttributes, JsonUnmarshallerContext> {

    public StartTimerFailedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("timerId", targetDepth)) {
                    context.nextToken();
                    startTimerFailedEventAttributes.setTimerId(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("cause", targetDepth)) {
                    context.nextToken();
                    startTimerFailedEventAttributes.setCause(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
