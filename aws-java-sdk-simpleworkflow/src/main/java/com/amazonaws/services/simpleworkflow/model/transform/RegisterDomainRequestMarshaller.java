...
public class RegisterDomainRequestMarshaller implements
    ...
    public Request<RegisterDomainRequest> marshall(
        ...
        Request<RegisterDomainRequest> request = new DefaultRequest<RegisterDomainRequest>(
                registerDomainRequest, "AmazonSimpleWorkflow");
        ...
        try {
            ...
            if (registerDomainRequest.getName() != null) {
                jsonGenerator.writeFieldName("name").writeValue(
                        registerDomainRequest.getName());
            }
            if (registerDomainRequest.getDescription() != null) {
                jsonGenerator.writeFieldName("description").writeValue(
                        registerDomainRequest.getDescription());
            }
            if (registerDomainRequest
                    .getWorkflowExecutionRetentionPeriodInDays() != null) {
