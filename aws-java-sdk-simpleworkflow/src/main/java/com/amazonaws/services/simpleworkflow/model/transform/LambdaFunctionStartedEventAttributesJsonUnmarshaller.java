 ...
 */
public class LambdaFunctionStartedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<LambdaFunctionStartedEventAttributes, JsonUnmarshallerContext> {

    public LambdaFunctionStartedEventAttributes unmarshall(
