 ...
 */
public class PendingTaskCountJsonUnmarshaller implements
        Unmarshaller<PendingTaskCount, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("count", targetDepth)) {
                    context.nextToken();
                    pendingTaskCount.setCount(context.getUnmarshaller(
                            Integer.class).unmarshall(context));
                }
                if (context.testExpression("truncated", targetDepth)) {
                    context.nextToken();
                    pendingTaskCount.setTruncated(context.getUnmarshaller(
