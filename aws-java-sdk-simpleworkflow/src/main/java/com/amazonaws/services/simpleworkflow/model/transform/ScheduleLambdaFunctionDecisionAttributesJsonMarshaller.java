        ...
        try {
            ...
            if (scheduleLambdaFunctionDecisionAttributes.getId() != null) {
                jsonGenerator.writeFieldName("id").writeValue(
                        scheduleLambdaFunctionDecisionAttributes.getId());
            }
            if (scheduleLambdaFunctionDecisionAttributes.getName() != null) {
                jsonGenerator.writeFieldName("name").writeValue(
                        scheduleLambdaFunctionDecisionAttributes.getName());
            }
            if (scheduleLambdaFunctionDecisionAttributes.getInput() != null) {
                jsonGenerator.writeFieldName("input").writeValue(
                        scheduleLambdaFunctionDecisionAttributes.getInput());
            }
            if (scheduleLambdaFunctionDecisionAttributes
                    .getStartToCloseTimeout() != null) {
