 ...
 */
public class ActivityTaskCompletedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<ActivityTaskCompletedEventAttributes, JsonUnmarshallerContext> {

    public ActivityTaskCompletedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("result", targetDepth)) {
                    context.nextToken();
                    activityTaskCompletedEventAttributes.setResult(context
    ...
    public static ActivityTaskCompletedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ActivityTaskCompletedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
