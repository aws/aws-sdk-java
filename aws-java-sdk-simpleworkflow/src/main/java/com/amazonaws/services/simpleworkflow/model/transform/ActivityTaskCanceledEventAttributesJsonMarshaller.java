        ...
        try {
            ...
            if (activityTaskCanceledEventAttributes.getDetails() != null) {
                jsonGenerator.writeFieldName("details").writeValue(
                        activityTaskCanceledEventAttributes.getDetails());
            }
            ...
            if (activityTaskCanceledEventAttributes
                    .getLatestCancelRequestedEventId() != null) {
                jsonGenerator.writeFieldName("latestCancelRequestedEventId")
                        .writeValue(
                                activityTaskCanceledEventAttributes
