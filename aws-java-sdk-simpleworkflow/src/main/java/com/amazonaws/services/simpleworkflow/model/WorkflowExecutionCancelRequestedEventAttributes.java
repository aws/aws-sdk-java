 ...
 * </p>
 */
public class WorkflowExecutionCancelRequestedEventAttributes implements
    ...
    public void setExternalWorkflowExecution(
    ...
    public WorkflowExecutionCancelRequestedEventAttributes withExternalWorkflowExecution(
            WorkflowExecution externalWorkflowExecution) {
    ...
    public WorkflowExecutionCancelRequestedEventAttributes withExternalInitiatedEventId(
     ...
     * </p>
     * 
     * @return If set, indicates that the request to cancel the workflow
     *         execution was automatically generated, and specifies the cause.
     *         This happens if the parent workflow execution times out or is
     *         terminated, and the child policy is set to cancel child
     *         executions.
    ...
    public WorkflowExecutionCancelRequestedEventAttributes withCause(
            String cause) {
        setCause(cause);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getExternalWorkflowExecution() == null
                ^ this.getExternalWorkflowExecution() == null)
            return false;
        if (other.getExternalWorkflowExecution() != null
                && other.getExternalWorkflowExecution().equals(
                        this.getExternalWorkflowExecution()) == false)
            return false;
        if (other.getExternalInitiatedEventId() == null
                ^ this.getExternalInitiatedEventId() == null)
            return false;
        if (other.getExternalInitiatedEventId() != null
                && other.getExternalInitiatedEventId().equals(
                        this.getExternalInitiatedEventId()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getExternalWorkflowExecution() == null) ? 0
                        : getExternalWorkflowExecution().hashCode());
        hashCode = prime
                * hashCode
                + ((getExternalInitiatedEventId() == null) ? 0
                        : getExternalInitiatedEventId().hashCode());
    ...
    public WorkflowExecutionCancelRequestedEventAttributes clone() {
        try {
            return (WorkflowExecutionCancelRequestedEventAttributes) super
                    .clone();
