...
public class WorkflowExecutionAlreadyStartedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simpleworkflow.model.WorkflowExecutionAlreadyStartedException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return workflowExecutionAlreadyStartedException;
    }

    private static WorkflowExecutionAlreadyStartedExceptionUnmarshaller instance;

    public static WorkflowExecutionAlreadyStartedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WorkflowExecutionAlreadyStartedExceptionUnmarshaller();
        return instance;
    }
}
