 ...
 */
public class LambdaFunctionScheduledEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<LambdaFunctionScheduledEventAttributes, JsonUnmarshallerContext> {

    public LambdaFunctionScheduledEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    lambdaFunctionScheduledEventAttributes.setId(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    lambdaFunctionScheduledEventAttributes.setName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("input", targetDepth)) {
                    context.nextToken();
                    lambdaFunctionScheduledEventAttributes.setInput(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
