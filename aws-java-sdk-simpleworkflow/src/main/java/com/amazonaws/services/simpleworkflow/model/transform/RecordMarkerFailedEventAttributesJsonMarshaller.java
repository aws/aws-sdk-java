    ...
    public void marshall(RecordMarkerFailedEventAttributes recordMarkerFailedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (recordMarkerFailedEventAttributes.getMarkerName() != null) {
                jsonGenerator.writeFieldName("markerName").writeValue(recordMarkerFailedEventAttributes.getMarkerName());
            }
            if (recordMarkerFailedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(recordMarkerFailedEventAttributes.getCause());
            }
            if (recordMarkerFailedEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(recordMarkerFailedEventAttributes.getDecisionTaskCompletedEventId());
            }
