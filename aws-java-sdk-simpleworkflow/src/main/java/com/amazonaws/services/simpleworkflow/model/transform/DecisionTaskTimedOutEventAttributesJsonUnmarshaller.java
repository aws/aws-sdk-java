 ...
 */
public class DecisionTaskTimedOutEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<DecisionTaskTimedOutEventAttributes, JsonUnmarshallerContext> {

    public DecisionTaskTimedOutEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("timeoutType", targetDepth)) {
                    context.nextToken();
                    decisionTaskTimedOutEventAttributes.setTimeoutType(context
