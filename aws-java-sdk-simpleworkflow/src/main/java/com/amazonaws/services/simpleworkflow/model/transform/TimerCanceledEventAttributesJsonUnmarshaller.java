 ...
 */
public class TimerCanceledEventAttributesJsonUnmarshaller implements
        Unmarshaller<TimerCanceledEventAttributes, JsonUnmarshallerContext> {

    public TimerCanceledEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("timerId", targetDepth)) {
                    context.nextToken();
                    timerCanceledEventAttributes.setTimerId(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("startedEventId", targetDepth)) {
                    context.nextToken();
                    timerCanceledEventAttributes.setStartedEventId(context
