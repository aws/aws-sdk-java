 ...
 */
public class MarkerRecordedEventAttributesJsonUnmarshaller implements
        Unmarshaller<MarkerRecordedEventAttributes, JsonUnmarshallerContext> {

    public MarkerRecordedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("markerName", targetDepth)) {
                    context.nextToken();
                    markerRecordedEventAttributes.setMarkerName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("details", targetDepth)) {
                    context.nextToken();
                    markerRecordedEventAttributes.setDetails(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
