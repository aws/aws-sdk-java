...
public class DescribeActivityTypeRequestMarshaller
        implements
        Marshaller<Request<DescribeActivityTypeRequest>, DescribeActivityTypeRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeActivityTypeRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeActivityTypeRequest> marshall(
        ...
        Request<DescribeActivityTypeRequest> request = new DefaultRequest<DescribeActivityTypeRequest>(
                describeActivityTypeRequest, "AmazonSimpleWorkflow");
        ...
        try {
            ...
            if (describeActivityTypeRequest.getDomain() != null) {
                jsonGenerator.writeFieldName("domain").writeValue(
                        describeActivityTypeRequest.getDomain());
            }
