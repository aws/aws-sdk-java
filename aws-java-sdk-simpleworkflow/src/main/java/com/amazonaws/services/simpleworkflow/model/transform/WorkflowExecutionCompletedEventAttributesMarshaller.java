...
@SdkInternalApi
public class WorkflowExecutionCompletedEventAttributesMarshaller {
    ...
    private static final WorkflowExecutionCompletedEventAttributesMarshaller instance = new WorkflowExecutionCompletedEventAttributesMarshaller();

    public static WorkflowExecutionCompletedEventAttributesMarshaller getInstance() {
        return instance;
    }
