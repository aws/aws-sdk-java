    ...
    public void marshall(CancelWorkflowExecutionFailedEventAttributes cancelWorkflowExecutionFailedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (cancelWorkflowExecutionFailedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(cancelWorkflowExecutionFailedEventAttributes.getCause());
            }
            if (cancelWorkflowExecutionFailedEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(
                        cancelWorkflowExecutionFailedEventAttributes.getDecisionTaskCompletedEventId());
            }
