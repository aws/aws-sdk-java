        ...
        try {
            ...
            if (scheduleLambdaFunctionFailedEventAttributes.getId() != null) {
                jsonGenerator.writeFieldName("id").writeValue(
                        scheduleLambdaFunctionFailedEventAttributes.getId());
            }
            if (scheduleLambdaFunctionFailedEventAttributes.getName() != null) {
                jsonGenerator.writeFieldName("name").writeValue(
                        scheduleLambdaFunctionFailedEventAttributes.getName());
            }
            if (scheduleLambdaFunctionFailedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(
                        scheduleLambdaFunctionFailedEventAttributes.getCause());
            }
            if (scheduleLambdaFunctionFailedEventAttributes
