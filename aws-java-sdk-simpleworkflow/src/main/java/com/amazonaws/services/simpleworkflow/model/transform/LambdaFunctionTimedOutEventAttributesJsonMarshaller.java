...
public class LambdaFunctionTimedOutEventAttributesJsonMarshaller {
     ...
     */
    public void marshall(LambdaFunctionTimedOutEventAttributes lambdaFunctionTimedOutEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (lambdaFunctionTimedOutEventAttributes.getScheduledEventId() != null) {
                jsonGenerator.writeFieldName("scheduledEventId").writeValue(lambdaFunctionTimedOutEventAttributes.getScheduledEventId());
            }
            if (lambdaFunctionTimedOutEventAttributes.getStartedEventId() != null) {
                jsonGenerator.writeFieldName("startedEventId").writeValue(lambdaFunctionTimedOutEventAttributes.getStartedEventId());
            }
            if (lambdaFunctionTimedOutEventAttributes.getTimeoutType() != null) {
                jsonGenerator.writeFieldName("timeoutType").writeValue(lambdaFunctionTimedOutEventAttributes.getTimeoutType());
            }
