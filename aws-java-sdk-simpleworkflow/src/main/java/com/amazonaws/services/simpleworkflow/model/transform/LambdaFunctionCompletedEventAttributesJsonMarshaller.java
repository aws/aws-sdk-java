    ...
    public void marshall(LambdaFunctionCompletedEventAttributes lambdaFunctionCompletedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (lambdaFunctionCompletedEventAttributes.getScheduledEventId() != null) {
                jsonGenerator.writeFieldName("scheduledEventId").writeValue(lambdaFunctionCompletedEventAttributes.getScheduledEventId());
            }
            if (lambdaFunctionCompletedEventAttributes.getStartedEventId() != null) {
                jsonGenerator.writeFieldName("startedEventId").writeValue(lambdaFunctionCompletedEventAttributes.getStartedEventId());
            }
            if (lambdaFunctionCompletedEventAttributes.getResult() != null) {
                jsonGenerator.writeFieldName("result").writeValue(lambdaFunctionCompletedEventAttributes.getResult());
            }
