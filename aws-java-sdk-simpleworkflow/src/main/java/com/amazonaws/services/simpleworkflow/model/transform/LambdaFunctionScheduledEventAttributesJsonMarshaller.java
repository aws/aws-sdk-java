...
public class LambdaFunctionScheduledEventAttributesJsonMarshaller {
    ...
    public void marshall(
        ...
        try {
            ...
            if (lambdaFunctionScheduledEventAttributes
