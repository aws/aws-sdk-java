 ...
 */
public class ChildWorkflowExecutionTimedOutEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<ChildWorkflowExecutionTimedOutEventAttributes, JsonUnmarshallerContext> {

    public ChildWorkflowExecutionTimedOutEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("timeoutType", targetDepth)) {
                    context.nextToken();
                    childWorkflowExecutionTimedOutEventAttributes
                            .setTimeoutType(context.getUnmarshaller(
