...
public class RespondActivityTaskCanceledRequestMarshaller
    ...
    public RespondActivityTaskCanceledRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<RespondActivityTaskCanceledRequest> marshall(
        ...
        Request<RespondActivityTaskCanceledRequest> request = new DefaultRequest<RespondActivityTaskCanceledRequest>(
                respondActivityTaskCanceledRequest, "AmazonSimpleWorkflow");
