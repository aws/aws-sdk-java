 ...
 */
public class DomainConfigurationJsonUnmarshaller implements
        Unmarshaller<DomainConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression(
                        "workflowExecutionRetentionPeriodInDays", targetDepth)) {
                    context.nextToken();
                    domainConfiguration
                            .setWorkflowExecutionRetentionPeriodInDays(context
