    ...
    public void marshall(ContinueAsNewWorkflowExecutionFailedEventAttributes continueAsNewWorkflowExecutionFailedEventAttributes,
        ...
        try {
            ...
            if (continueAsNewWorkflowExecutionFailedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(continueAsNewWorkflowExecutionFailedEventAttributes.getCause());
            }
            if (continueAsNewWorkflowExecutionFailedEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(
                        continueAsNewWorkflowExecutionFailedEventAttributes.getDecisionTaskCompletedEventId());
            }
