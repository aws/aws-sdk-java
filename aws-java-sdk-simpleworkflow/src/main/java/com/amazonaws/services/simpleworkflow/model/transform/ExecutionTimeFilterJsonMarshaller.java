...
public class ExecutionTimeFilterJsonMarshaller {
     ...
     */
    public void marshall(ExecutionTimeFilter executionTimeFilter, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (executionTimeFilter.getOldestDate() != null) {
                jsonGenerator.writeFieldName("oldestDate").writeValue(executionTimeFilter.getOldestDate());
            }
            if (executionTimeFilter.getLatestDate() != null) {
                jsonGenerator.writeFieldName("latestDate").writeValue(executionTimeFilter.getLatestDate());
            }
