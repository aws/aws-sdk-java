 ...
 */
public class WorkflowExecutionCompletedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<WorkflowExecutionCompletedEventAttributes, JsonUnmarshallerContext> {

    public WorkflowExecutionCompletedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("result", targetDepth)) {
                    context.nextToken();
                    workflowExecutionCompletedEventAttributes.setResult(context
