...
public class DeprecateWorkflowTypeRequestMarshaller implements Marshaller<Request<DeprecateWorkflowTypeRequest>, DeprecateWorkflowTypeRequest> {
    ...
    public Request<DeprecateWorkflowTypeRequest> marshall(DeprecateWorkflowTypeRequest deprecateWorkflowTypeRequest) {
        ...
        request.addHeader("X-Amz-Target", "SimpleWorkflowService.DeprecateWorkflowType");
        ...
        try {
            ...
            if (deprecateWorkflowTypeRequest.getDomain() != null) {
                jsonGenerator.writeFieldName("domain").writeValue(deprecateWorkflowTypeRequest.getDomain());
            }
            if (deprecateWorkflowTypeRequest.getWorkflowType() != null) {
                jsonGenerator.writeFieldName("workflowType");
                WorkflowTypeJsonMarshaller.getInstance().marshall(deprecateWorkflowTypeRequest.getWorkflowType(), jsonGenerator);
            }
