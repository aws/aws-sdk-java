...
public class DeprecateWorkflowTypeRequestMarshaller
        implements
        Marshaller<Request<DeprecateWorkflowTypeRequest>, DeprecateWorkflowTypeRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DeprecateWorkflowTypeRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeprecateWorkflowTypeRequest> marshall(
        ...
        Request<DeprecateWorkflowTypeRequest> request = new DefaultRequest<DeprecateWorkflowTypeRequest>(
                deprecateWorkflowTypeRequest, "AmazonSimpleWorkflow");
        ...
        try {
            ...
            if (deprecateWorkflowTypeRequest.getDomain() != null) {
                jsonGenerator.writeFieldName("domain").writeValue(
                        deprecateWorkflowTypeRequest.getDomain());
            }
            if (deprecateWorkflowTypeRequest.getWorkflowType() != null) {
