 ...
 */
public class SignalExternalWorkflowExecutionFailedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<SignalExternalWorkflowExecutionFailedEventAttributes, JsonUnmarshallerContext> {

    public SignalExternalWorkflowExecutionFailedEventAttributes unmarshall(
