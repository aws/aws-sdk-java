 ...
 */
public class LambdaFunctionTimedOutEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<LambdaFunctionTimedOutEventAttributes, JsonUnmarshallerContext> {

    public LambdaFunctionTimedOutEventAttributes unmarshall(
