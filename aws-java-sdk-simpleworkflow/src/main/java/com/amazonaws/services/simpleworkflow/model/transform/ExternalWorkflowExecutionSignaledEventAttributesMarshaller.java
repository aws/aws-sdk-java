...
@SdkInternalApi
public class ExternalWorkflowExecutionSignaledEventAttributesMarshaller {
    ...
    private static final ExternalWorkflowExecutionSignaledEventAttributesMarshaller instance = new ExternalWorkflowExecutionSignaledEventAttributesMarshaller();

    public static ExternalWorkflowExecutionSignaledEventAttributesMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(ExternalWorkflowExecutionSignaledEventAttributes externalWorkflowExecutionSignaledEventAttributes,
        ...
        try {
            protocolMarshaller.marshall(externalWorkflowExecutionSignaledEventAttributes.getWorkflowExecution(), WORKFLOWEXECUTION_BINDING);
            protocolMarshaller.marshall(externalWorkflowExecutionSignaledEventAttributes.getInitiatedEventId(), INITIATEDEVENTID_BINDING);
        } catch (Exception e) {
