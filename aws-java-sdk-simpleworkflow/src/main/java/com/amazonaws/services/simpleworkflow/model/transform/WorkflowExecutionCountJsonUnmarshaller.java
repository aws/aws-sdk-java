 ...
 */
public class WorkflowExecutionCountJsonUnmarshaller implements
        Unmarshaller<WorkflowExecutionCount, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("count", targetDepth)) {
                    context.nextToken();
                    workflowExecutionCount.setCount(context.getUnmarshaller(
