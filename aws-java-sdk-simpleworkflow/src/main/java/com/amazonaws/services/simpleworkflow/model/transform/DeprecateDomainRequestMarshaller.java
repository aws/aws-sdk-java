...
public class DeprecateDomainRequestMarshaller implements
    ...
    public Request<DeprecateDomainRequest> marshall(
        ...
        Request<DeprecateDomainRequest> request = new DefaultRequest<DeprecateDomainRequest>(
                deprecateDomainRequest, "AmazonSimpleWorkflow");
        ...
        try {
            ...
            if (deprecateDomainRequest.getName() != null) {
                jsonGenerator.writeFieldName("name").writeValue(
                        deprecateDomainRequest.getName());
            }
