 ...
 */
public class WorkflowExecutionCanceledEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<WorkflowExecutionCanceledEventAttributes, JsonUnmarshallerContext> {

    public WorkflowExecutionCanceledEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("details", targetDepth)) {
                    context.nextToken();
                    workflowExecutionCanceledEventAttributes.setDetails(context
