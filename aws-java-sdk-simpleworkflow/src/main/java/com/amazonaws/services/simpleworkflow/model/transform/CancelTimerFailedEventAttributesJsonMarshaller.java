...
public class CancelTimerFailedEventAttributesJsonMarshaller {
     ...
     */
    public void marshall(CancelTimerFailedEventAttributes cancelTimerFailedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (cancelTimerFailedEventAttributes.getTimerId() != null) {
                jsonGenerator.writeFieldName("timerId").writeValue(cancelTimerFailedEventAttributes.getTimerId());
            }
            if (cancelTimerFailedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(cancelTimerFailedEventAttributes.getCause());
            }
            if (cancelTimerFailedEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(cancelTimerFailedEventAttributes.getDecisionTaskCompletedEventId());
            }
