 ...
 */
public class ActivityTaskFailedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<ActivityTaskFailedEventAttributes, JsonUnmarshallerContext> {

    public ActivityTaskFailedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("reason", targetDepth)) {
                    context.nextToken();
                    activityTaskFailedEventAttributes.setReason(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("details", targetDepth)) {
                    context.nextToken();
                    activityTaskFailedEventAttributes.setDetails(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("startedEventId", targetDepth)) {
                    context.nextToken();
                    activityTaskFailedEventAttributes.setStartedEventId(context
