 ...
 */
public class ChildWorkflowExecutionStartedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<ChildWorkflowExecutionStartedEventAttributes, JsonUnmarshallerContext> {

    public ChildWorkflowExecutionStartedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("initiatedEventId", targetDepth)) {
                    context.nextToken();
                    childWorkflowExecutionStartedEventAttributes
                            .setInitiatedEventId(context.getUnmarshaller(
