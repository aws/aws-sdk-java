...
@SdkInternalApi
public class SignalExternalWorkflowExecutionInitiatedEventAttributesMarshaller {
    ...
    private static final SignalExternalWorkflowExecutionInitiatedEventAttributesMarshaller instance = new SignalExternalWorkflowExecutionInitiatedEventAttributesMarshaller();

    public static SignalExternalWorkflowExecutionInitiatedEventAttributesMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(SignalExternalWorkflowExecutionInitiatedEventAttributes signalExternalWorkflowExecutionInitiatedEventAttributes,
        ...
        try {
            protocolMarshaller.marshall(signalExternalWorkflowExecutionInitiatedEventAttributes.getWorkflowId(), WORKFLOWID_BINDING);
            protocolMarshaller.marshall(signalExternalWorkflowExecutionInitiatedEventAttributes.getRunId(), RUNID_BINDING);
            protocolMarshaller.marshall(signalExternalWorkflowExecutionInitiatedEventAttributes.getSignalName(), SIGNALNAME_BINDING);
            protocolMarshaller.marshall(signalExternalWorkflowExecutionInitiatedEventAttributes.getInput(), INPUT_BINDING);
            protocolMarshaller.marshall(signalExternalWorkflowExecutionInitiatedEventAttributes.getDecisionTaskCompletedEventId(),
                    DECISIONTASKCOMPLETEDEVENTID_BINDING);
            protocolMarshaller.marshall(signalExternalWorkflowExecutionInitiatedEventAttributes.getControl(), CONTROL_BINDING);
        } catch (Exception e) {
