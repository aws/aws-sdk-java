 ...
 */
public class ActivityTaskCanceledEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<ActivityTaskCanceledEventAttributes, JsonUnmarshallerContext> {

    public ActivityTaskCanceledEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("details", targetDepth)) {
                    context.nextToken();
                    activityTaskCanceledEventAttributes.setDetails(context
                ...
                if (context.testExpression("latestCancelRequestedEventId",
                        targetDepth)) {
                    context.nextToken();
                    activityTaskCanceledEventAttributes
                            .setLatestCancelRequestedEventId(context
