...
public class WorkflowExecutionStartedEventAttributes implements Serializable,
     ...
     * the <code>runId</code> of the previous workflow execution that was closed
    ...
    public WorkflowExecutionStartedEventAttributes withExecutionStartToCloseTimeout(
            String executionStartToCloseTimeout) {
     ...
     * </p>
     * 
     * @return The maximum duration of decision tasks for this workflow
     *         type.</p>
     *         <p>
     *         The duration is specified in seconds; an integer greater than or
     *         equal to 0. The value "NONE" can be used to specify unlimited
    ...
    public WorkflowExecutionStartedEventAttributes withTaskStartToCloseTimeout(
    ...
    public WorkflowExecutionStartedEventAttributes withChildPolicy(
            String childPolicy) {
     ...
     * </p>
     * 
     * @return The name of the task list for scheduling the decision tasks for
     *         this workflow execution.
     */
    ...
    public WorkflowExecutionStartedEventAttributes withTaskList(
            TaskList taskList) {
    ...
    public WorkflowExecutionStartedEventAttributes withWorkflowType(
     ...
     * </p>
     * 
     * @return The list of tags associated with this workflow execution. An
    ...
    public WorkflowExecutionStartedEventAttributes withTagList(
            String... tagList) {
    ...
    public WorkflowExecutionStartedEventAttributes withTaskPriority(
            String taskPriority) {
     ...
     *        If this workflow execution was started due to a
     *        <code>ContinueAsNewWorkflowExecution</code> decision, then it
     *        contains the <code>runId</code> of the previous workflow execution
     ...
     *         <code>ContinueAsNewWorkflowExecution</code> decision, then it
     *         contains the <code>runId</code> of the previous workflow
     *         execution that was closed and continued as this execution.
     */
    ...
    public WorkflowExecutionStartedEventAttributes withContinuedExecutionRunId(
    ...
    public void setParentWorkflowExecution(
     ...
     * </p>
     * 
     * @return The source workflow execution that started this workflow
    ...
    public WorkflowExecutionStartedEventAttributes withParentWorkflowExecution(
            WorkflowExecution parentWorkflowExecution) {
    ...
    public WorkflowExecutionStartedEventAttributes withParentInitiatedEventId(
    ...
    public WorkflowExecutionStartedEventAttributes withLambdaRole(
            String lambdaRole) {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTaskPriority() != null
            ...
            return false;
        if (other.getContinuedExecutionRunId() == null
                ^ this.getContinuedExecutionRunId() == null)
            return false;
        if (other.getContinuedExecutionRunId() != null
                && other.getContinuedExecutionRunId().equals(
                        this.getContinuedExecutionRunId()) == false)
            return false;
        if (other.getParentWorkflowExecution() == null
                ^ this.getParentWorkflowExecution() == null)
            return false;
        if (other.getParentWorkflowExecution() != null
                && other.getParentWorkflowExecution().equals(
                        this.getParentWorkflowExecution()) == false)
            return false;
        if (other.getParentInitiatedEventId() == null
                ^ this.getParentInitiatedEventId() == null)
            return false;
        if (other.getParentInitiatedEventId() != null
                && other.getParentInitiatedEventId().equals(
                        this.getParentInitiatedEventId()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getContinuedExecutionRunId() == null) ? 0
                        : getContinuedExecutionRunId().hashCode());
        hashCode = prime
                * hashCode
                + ((getParentWorkflowExecution() == null) ? 0
                        : getParentWorkflowExecution().hashCode());
        hashCode = prime
                * hashCode
                + ((getParentInitiatedEventId() == null) ? 0
                        : getParentInitiatedEventId().hashCode());
        hashCode = prime * hashCode
