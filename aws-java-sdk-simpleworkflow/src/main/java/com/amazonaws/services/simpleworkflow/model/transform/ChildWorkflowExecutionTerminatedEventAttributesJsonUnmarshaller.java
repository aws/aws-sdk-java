 ...
 */
public class ChildWorkflowExecutionTerminatedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<ChildWorkflowExecutionTerminatedEventAttributes, JsonUnmarshallerContext> {

    public ChildWorkflowExecutionTerminatedEventAttributes unmarshall(
    ...
    public static ChildWorkflowExecutionTerminatedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ChildWorkflowExecutionTerminatedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
