...
public class ContinueAsNewWorkflowExecutionDecisionAttributesJsonMarshaller {
    ...
    public void marshall(
        ...
        try {
            ...
            if (continueAsNewWorkflowExecutionDecisionAttributes
            ...
            java.util.List<String> tagListList = continueAsNewWorkflowExecutionDecisionAttributes
                    .getTagList();
            if (tagListList != null) {
            ...
            if (continueAsNewWorkflowExecutionDecisionAttributes
                    .getWorkflowTypeVersion() != null) {
                jsonGenerator.writeFieldName("workflowTypeVersion").writeValue(
                        continueAsNewWorkflowExecutionDecisionAttributes
