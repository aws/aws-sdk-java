...
public class WorkflowExecutionTimedOutEventAttributesJsonMarshaller {
    ...
    public void marshall(WorkflowExecutionTimedOutEventAttributes workflowExecutionTimedOutEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (workflowExecutionTimedOutEventAttributes.getTimeoutType() != null) {
                jsonGenerator.writeFieldName("timeoutType").writeValue(workflowExecutionTimedOutEventAttributes.getTimeoutType());
            }
            if (workflowExecutionTimedOutEventAttributes.getChildPolicy() != null) {
                jsonGenerator.writeFieldName("childPolicy").writeValue(workflowExecutionTimedOutEventAttributes.getChildPolicy());
            }
    ...
    public static WorkflowExecutionTimedOutEventAttributesJsonMarshaller getInstance() {
        if (instance == null)
            instance = new WorkflowExecutionTimedOutEventAttributesJsonMarshaller();
        return instance;
    }
