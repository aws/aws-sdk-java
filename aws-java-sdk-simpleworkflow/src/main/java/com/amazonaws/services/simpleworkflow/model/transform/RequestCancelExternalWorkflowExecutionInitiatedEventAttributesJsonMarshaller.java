    ...
    public void marshall(RequestCancelExternalWorkflowExecutionInitiatedEventAttributes requestCancelExternalWorkflowExecutionInitiatedEventAttributes,
        ...
        try {
            ...
            if (requestCancelExternalWorkflowExecutionInitiatedEventAttributes.getWorkflowId() != null) {
                jsonGenerator.writeFieldName("workflowId").writeValue(requestCancelExternalWorkflowExecutionInitiatedEventAttributes.getWorkflowId());
            }
            if (requestCancelExternalWorkflowExecutionInitiatedEventAttributes.getRunId() != null) {
                jsonGenerator.writeFieldName("runId").writeValue(requestCancelExternalWorkflowExecutionInitiatedEventAttributes.getRunId());
            }
            if (requestCancelExternalWorkflowExecutionInitiatedEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(
                        requestCancelExternalWorkflowExecutionInitiatedEventAttributes.getDecisionTaskCompletedEventId());
            }
            if (requestCancelExternalWorkflowExecutionInitiatedEventAttributes.getControl() != null) {
                jsonGenerator.writeFieldName("control").writeValue(requestCancelExternalWorkflowExecutionInitiatedEventAttributes.getControl());
            }
