...
public class ExecutionTimeFilterMarshaller {
    ...
    public static ExecutionTimeFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ExecutionTimeFilter executionTimeFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(executionTimeFilter.getOldestDate(), OLDESTDATE_BINDING);
            protocolMarshaller.marshall(executionTimeFilter.getLatestDate(), LATESTDATE_BINDING);
        } catch (Exception e) {
