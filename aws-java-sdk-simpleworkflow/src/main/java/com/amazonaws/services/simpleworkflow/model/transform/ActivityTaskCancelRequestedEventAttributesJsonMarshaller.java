...
public class ActivityTaskCancelRequestedEventAttributesJsonMarshaller {
     ...
     */
    public void marshall(ActivityTaskCancelRequestedEventAttributes activityTaskCancelRequestedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (activityTaskCancelRequestedEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(
                        activityTaskCancelRequestedEventAttributes.getDecisionTaskCompletedEventId());
            }
            if (activityTaskCancelRequestedEventAttributes.getActivityId() != null) {
                jsonGenerator.writeFieldName("activityId").writeValue(activityTaskCancelRequestedEventAttributes.getActivityId());
            }
