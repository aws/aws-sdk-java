...
public class StartLambdaFunctionFailedEventAttributesJsonMarshaller {
     ...
     */
    public void marshall(StartLambdaFunctionFailedEventAttributes startLambdaFunctionFailedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (startLambdaFunctionFailedEventAttributes.getScheduledEventId() != null) {
                jsonGenerator.writeFieldName("scheduledEventId").writeValue(startLambdaFunctionFailedEventAttributes.getScheduledEventId());
            }
            if (startLambdaFunctionFailedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(startLambdaFunctionFailedEventAttributes.getCause());
            }
            if (startLambdaFunctionFailedEventAttributes.getMessage() != null) {
                jsonGenerator.writeFieldName("message").writeValue(startLambdaFunctionFailedEventAttributes.getMessage());
            }
