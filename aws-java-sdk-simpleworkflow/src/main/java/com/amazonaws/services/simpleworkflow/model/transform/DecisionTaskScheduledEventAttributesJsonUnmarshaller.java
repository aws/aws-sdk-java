 ...
 */
public class DecisionTaskScheduledEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<DecisionTaskScheduledEventAttributes, JsonUnmarshallerContext> {

    public DecisionTaskScheduledEventAttributes unmarshall(
