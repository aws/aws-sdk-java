 ...
 * <ul>
 * <li> <code>tagList.member.N</code>: The key is "swf:tagList.N" where N is the
 * tag number from 0 to 4, inclusive.</li>
 ...
 * </p>
 */
public class StartChildWorkflowExecutionDecisionAttributes implements
     ...
     * decider in subsequent workflow tasks. This data is not sent to the child
     * workflow execution.
     * </p>
     */
     ...
     * by calling the <a>TerminateWorkflowExecution</a> action explicitly or due
     ...
     * a specific tag by calling <a>ListOpenWorkflowExecutions</a> or
    ...
    public StartChildWorkflowExecutionDecisionAttributes withWorkflowType(
     ...
     * 
     * @param workflowId
     *        Required.</b> The <code>workflowId</code> of the workflow
     *        execution.</p>
     *        <p>
     ...
     * </p>
     * 
     * @return Required.</b> The <code>workflowId</code> of the workflow
     *         execution.</p>
     *         <p>
     *         The specified string must not start or end with whitespace. It
    ...
    public StartChildWorkflowExecutionDecisionAttributes withWorkflowId(
            String workflowId) {
    ...
    public StartChildWorkflowExecutionDecisionAttributes withControl(
            String control) {
        setControl(control);
        return this;
    }
    ...
    public StartChildWorkflowExecutionDecisionAttributes withExecutionStartToCloseTimeout(
            String executionStartToCloseTimeout) {
     ...
     *        child workflow execution.</p> <note>A task list for this workflow
     *        execution must be specified either as a default for the workflow
     *        type or through this parameter. If neither this parameter is set
     ...
     * </p>
     * 
     * @return The name of the task list to be used for decision tasks of the
     *         child workflow execution.</p> <note>A task list for this workflow
     *         execution must be specified either as a default for the workflow
     *         type or through this parameter. If neither this parameter is set
     *         nor a default task list was specified at registration time then a
    ...
    public StartChildWorkflowExecutionDecisionAttributes withTaskList(
            TaskList taskList) {
    ...
    public StartChildWorkflowExecutionDecisionAttributes withTaskPriority(
            String taskPriority) {
     ...
     *        duration.
     *        </p>
     *        <note>A task start-to-close timeout for this workflow execution
    ...
    public StartChildWorkflowExecutionDecisionAttributes withTaskStartToCloseTimeout(
     ...
     * 
     * @param childPolicy
     *        Optional.</i> If set, specifies the policy to use for the child
     ...
     * registration time then a fault will be returned.</note>
     * 
     * @return Optional.</i> If set, specifies the policy to use for the child
     *         workflow executions if the workflow execution being started is
     ...
     *         workflow type using <a>RegisterWorkflowType</a>.</p>
     *         <p>
     *         The supported child policies are:
     *         </p>
     *         <ul>
    ...
    public StartChildWorkflowExecutionDecisionAttributes withChildPolicy(
            String childPolicy) {
     ...
     * </p>
     * 
     * @return The list of tags to associate with the child workflow execution.
    ...
    public StartChildWorkflowExecutionDecisionAttributes withTagList(
            String... tagList) {
    ...
    public StartChildWorkflowExecutionDecisionAttributes withLambdaRole(
            String lambdaRole) {
    ...
    public StartChildWorkflowExecutionDecisionAttributes clone() {
        try {
            return (StartChildWorkflowExecutionDecisionAttributes) super
                    .clone();
