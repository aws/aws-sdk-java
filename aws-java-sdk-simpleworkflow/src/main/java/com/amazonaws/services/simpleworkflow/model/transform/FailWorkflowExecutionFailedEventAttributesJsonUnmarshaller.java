 ...
 */
public class FailWorkflowExecutionFailedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<FailWorkflowExecutionFailedEventAttributes, JsonUnmarshallerContext> {

    public FailWorkflowExecutionFailedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("cause", targetDepth)) {
                    context.nextToken();
                    failWorkflowExecutionFailedEventAttributes.setCause(context
