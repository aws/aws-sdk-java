...
public class WorkflowTypeConfigurationJsonMarshaller {
     ...
     */
    public void marshall(WorkflowTypeConfiguration workflowTypeConfiguration,
        ...
        try {
            ...
            if (workflowTypeConfiguration.getDefaultTaskStartToCloseTimeout() != null) {
                jsonGenerator.writeFieldName("defaultTaskStartToCloseTimeout")
                        .writeValue(
                                workflowTypeConfiguration
                                        .getDefaultTaskStartToCloseTimeout());
            }
            if (workflowTypeConfiguration
                    .getDefaultExecutionStartToCloseTimeout() != null) {
                jsonGenerator.writeFieldName(
                        "defaultExecutionStartToCloseTimeout").writeValue(
                        workflowTypeConfiguration
            ...
            if (workflowTypeConfiguration.getDefaultTaskPriority() != null) {
                jsonGenerator.writeFieldName("defaultTaskPriority").writeValue(
                        workflowTypeConfiguration.getDefaultTaskPriority());
            }
            if (workflowTypeConfiguration.getDefaultChildPolicy() != null) {
                jsonGenerator.writeFieldName("defaultChildPolicy").writeValue(
                        workflowTypeConfiguration.getDefaultChildPolicy());
            }
            if (workflowTypeConfiguration.getDefaultLambdaRole() != null) {
                jsonGenerator.writeFieldName("defaultLambdaRole").writeValue(
                        workflowTypeConfiguration.getDefaultLambdaRole());
            }
