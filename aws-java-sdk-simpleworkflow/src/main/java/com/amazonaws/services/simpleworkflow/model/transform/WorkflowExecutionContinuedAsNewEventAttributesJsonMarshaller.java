...
public class WorkflowExecutionContinuedAsNewEventAttributesJsonMarshaller {
    ...
    public void marshall(
        ...
        try {
            ...
            if (workflowExecutionContinuedAsNewEventAttributes
                    .getNewExecutionRunId() != null) {
                jsonGenerator.writeFieldName("newExecutionRunId").writeValue(
                        workflowExecutionContinuedAsNewEventAttributes
            ...
            java.util.List<String> tagListList = workflowExecutionContinuedAsNewEventAttributes
                    .getTagList();
            if (tagListList != null) {
