...
public class ScheduleActivityTaskFailedEventAttributesJsonMarshaller {
     ...
     */
    public void marshall(ScheduleActivityTaskFailedEventAttributes scheduleActivityTaskFailedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (scheduleActivityTaskFailedEventAttributes.getActivityType() != null) {
                ...
                ActivityTypeJsonMarshaller.getInstance().marshall(scheduleActivityTaskFailedEventAttributes.getActivityType(), jsonGenerator);
            }
            if (scheduleActivityTaskFailedEventAttributes.getActivityId() != null) {
                jsonGenerator.writeFieldName("activityId").writeValue(scheduleActivityTaskFailedEventAttributes.getActivityId());
            }
            if (scheduleActivityTaskFailedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(scheduleActivityTaskFailedEventAttributes.getCause());
            }
            if (scheduleActivityTaskFailedEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(
                        scheduleActivityTaskFailedEventAttributes.getDecisionTaskCompletedEventId());
            }
