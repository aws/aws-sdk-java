 ...
 */
public class ContinueAsNewWorkflowExecutionDecisionAttributesJsonUnmarshaller
        implements
        Unmarshaller<ContinueAsNewWorkflowExecutionDecisionAttributes, JsonUnmarshallerContext> {

    public ContinueAsNewWorkflowExecutionDecisionAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("workflowTypeVersion", targetDepth)) {
                    context.nextToken();
                    continueAsNewWorkflowExecutionDecisionAttributes
                            .setWorkflowTypeVersion(context.getUnmarshaller(
                                    String.class).unmarshall(context));
                }
