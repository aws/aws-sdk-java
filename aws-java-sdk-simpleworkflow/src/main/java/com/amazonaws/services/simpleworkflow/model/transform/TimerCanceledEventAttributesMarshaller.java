...
@SdkInternalApi
public class TimerCanceledEventAttributesMarshaller {
    ...
    private static final TimerCanceledEventAttributesMarshaller instance = new TimerCanceledEventAttributesMarshaller();

    public static TimerCanceledEventAttributesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TimerCanceledEventAttributes timerCanceledEventAttributes, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(timerCanceledEventAttributes.getTimerId(), TIMERID_BINDING);
            protocolMarshaller.marshall(timerCanceledEventAttributes.getStartedEventId(), STARTEDEVENTID_BINDING);
            protocolMarshaller.marshall(timerCanceledEventAttributes.getDecisionTaskCompletedEventId(), DECISIONTASKCOMPLETEDEVENTID_BINDING);
        } catch (Exception e) {
