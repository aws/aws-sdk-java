 ...
 */
public class CancelWorkflowExecutionDecisionAttributesJsonUnmarshaller
        implements
        Unmarshaller<CancelWorkflowExecutionDecisionAttributes, JsonUnmarshallerContext> {

    public CancelWorkflowExecutionDecisionAttributes unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("details", targetDepth)) {
                    ...
                    cancelWorkflowExecutionDecisionAttributes
                            .setDetails(context.getUnmarshaller(String.class)
                                    .unmarshall(context));
                }
