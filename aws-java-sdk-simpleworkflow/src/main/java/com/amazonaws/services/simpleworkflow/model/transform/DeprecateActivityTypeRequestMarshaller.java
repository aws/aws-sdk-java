...
public class DeprecateActivityTypeRequestMarshaller
        implements
        Marshaller<Request<DeprecateActivityTypeRequest>, DeprecateActivityTypeRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DeprecateActivityTypeRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeprecateActivityTypeRequest> marshall(
        ...
        Request<DeprecateActivityTypeRequest> request = new DefaultRequest<DeprecateActivityTypeRequest>(
                deprecateActivityTypeRequest, "AmazonSimpleWorkflow");
        ...
        try {
            ...
            if (deprecateActivityTypeRequest.getDomain() != null) {
                jsonGenerator.writeFieldName("domain").writeValue(
                        deprecateActivityTypeRequest.getDomain());
            }
