 ...
 */
public class WorkflowExecutionFailedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<WorkflowExecutionFailedEventAttributes, JsonUnmarshallerContext> {

    public WorkflowExecutionFailedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("reason", targetDepth)) {
                    context.nextToken();
                    workflowExecutionFailedEventAttributes.setReason(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("details", targetDepth)) {
                    context.nextToken();
                    workflowExecutionFailedEventAttributes.setDetails(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
