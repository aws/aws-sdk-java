 ...
 */
public class DomainDetailJsonUnmarshaller implements
        Unmarshaller<DomainDetail, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("domainInfo", targetDepth)) {
                    context.nextToken();
                    domainDetail.setDomainInfo(DomainInfoJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
                if (context.testExpression("configuration", targetDepth)) {
                    context.nextToken();
                    domainDetail
                            .setConfiguration(DomainConfigurationJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
    ...
    public static DomainDetailJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DomainDetailJsonUnmarshaller();
        return instance;
    }
}
