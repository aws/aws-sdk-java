 ...
 * <ul>
 * <li> <code>tag</code>: <i>Optional.</i>. A tag used to identify the workflow
 * execution</li>
 ...
 * </p>
 */
public class ContinueAsNewWorkflowExecutionDecisionAttributes implements
     ...
     * </p>
     * <note>An execution start-to-close timeout for this workflow execution
    ...
    /**
     * <p>
     * <i>Optional.</i> The task priority that, if set, specifies the priority
     ...
     * 0. The value "NONE" can be used to specify unlimited duration.
     * </p>
     * <note>A task start-to-close timeout for the new workflow execution must
     ...
     * continue to run.</li>
     * </ul>
     * <note>A child policy for this workflow execution must be specified either
     ...
     * functions.
     * </p>
     * <note>In order for this workflow execution to invoke AWS Lambda
     * functions, an appropriate IAM role must be specified either as a default
     * for the workflow type or through this field.</note>
     */
    ...
    public ContinueAsNewWorkflowExecutionDecisionAttributes withInput(
            String input) {
        setInput(input);
        return this;
    }
     ...
     *        This overrides the
     *        <code>defaultExecutionStartToCloseTimeout</code> specified when
     *        registering the workflow type.</p>
     *        <p>
     ...
     *        duration.
     *        </p>
     *        <note>An execution start-to-close timeout for this workflow
     ...
     *        default execution start-to-close timeout was specified at
     ...
     * will be returned.</note>
     * 
     * @return If set, specifies the total duration for this workflow execution.
     *         This overrides the
     *         <code>defaultExecutionStartToCloseTimeout</code> specified when
     *         registering the workflow type.</p>
     *         <p>
    ...
    public ContinueAsNewWorkflowExecutionDecisionAttributes withExecutionStartToCloseTimeout(
            String executionStartToCloseTimeout) {
    ...
    public ContinueAsNewWorkflowExecutionDecisionAttributes withTaskList(
            TaskList taskList) {
     ...
     * 
     * @param taskPriority
     *        Optional.</i> The task priority that, if set, specifies the
     ...
     * </p>
     * 
     * @return Optional.</i> The task priority that, if set, specifies the
     *         priority for the decision tasks for this workflow execution. This
     *         overrides the defaultTaskPriority specified when registering the
     *         workflow type. Valid values are integers that range from Java's
     *         <code>Integer.MIN_VALUE</code> (-2147483648) to
    ...
    public ContinueAsNewWorkflowExecutionDecisionAttributes withTaskPriority(
            String taskPriority) {
     ...
     *        <code>defaultTaskStartToCloseTimout</code> specified when
     ...
     *        duration.
     *        </p>
     *        <note>A task start-to-close timeout for the new workflow execution
     ...
     * will be returned.</note>
     * 
     * @return Specifies the maximum duration of decision tasks for the new
     *         workflow execution. This parameter overrides the
     *         <code>defaultTaskStartToCloseTimout</code> specified when
     *         registering the workflow type using
     *         <a>RegisterWorkflowType</a>.</p>
     ...
     *         duration.
     *         </p>
     *         <note>A task start-to-close timeout for the new workflow
     *         execution must be specified either as a default for the workflow
    ...
    public ContinueAsNewWorkflowExecutionDecisionAttributes withTaskStartToCloseTimeout(
     ...
     *         will continue to run.</li>
     *         </ul>
     *         <note>A child policy for this workflow execution must be
    ...
    public ContinueAsNewWorkflowExecutionDecisionAttributes withChildPolicy(
            String childPolicy) {
     ...
     *         <a>ListOpenWorkflowExecutions</a> or
     *         <a>ListClosedWorkflowExecutions</a> and specifying a
     *         <a>TagFilter</a>.
     */
    ...
    public ContinueAsNewWorkflowExecutionDecisionAttributes withTagList(
            String... tagList) {
    ...
    public ContinueAsNewWorkflowExecutionDecisionAttributes withWorkflowTypeVersion(
     ...
     *        Lambda functions.</p> <note>In order for this workflow execution
    ...
    public ContinueAsNewWorkflowExecutionDecisionAttributes withLambdaRole(
            String lambdaRole) {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTagList() != null
            ...
            return false;
        if (other.getWorkflowTypeVersion() == null
                ^ this.getWorkflowTypeVersion() == null)
            return false;
        if (other.getWorkflowTypeVersion() != null
                && other.getWorkflowTypeVersion().equals(
                        this.getWorkflowTypeVersion()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getWorkflowTypeVersion() == null) ? 0
                        : getWorkflowTypeVersion().hashCode());
        hashCode = prime * hashCode
    ...
    public ContinueAsNewWorkflowExecutionDecisionAttributes clone() {
        try {
            return (ContinueAsNewWorkflowExecutionDecisionAttributes) super
                    .clone();
