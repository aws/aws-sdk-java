    ...
    public void marshall(TimerCanceledEventAttributes timerCanceledEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (timerCanceledEventAttributes.getTimerId() != null) {
                jsonGenerator.writeFieldName("timerId").writeValue(timerCanceledEventAttributes.getTimerId());
            }
            if (timerCanceledEventAttributes.getStartedEventId() != null) {
                jsonGenerator.writeFieldName("startedEventId").writeValue(timerCanceledEventAttributes.getStartedEventId());
            }
            if (timerCanceledEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(timerCanceledEventAttributes.getDecisionTaskCompletedEventId());
            }
