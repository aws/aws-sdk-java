 ...
 */
public class WorkflowTypeDetailJsonUnmarshaller implements
        Unmarshaller<WorkflowTypeDetail, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("typeInfo", targetDepth)) {
                    context.nextToken();
                    workflowTypeDetail
                            .setTypeInfo(WorkflowTypeInfoJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
                if (context.testExpression("configuration", targetDepth)) {
                    context.nextToken();
                    workflowTypeDetail
                            .setConfiguration(WorkflowTypeConfigurationJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
