...
public class DecisionJsonMarshaller {
     ...
     */
    public void marshall(Decision decision,
        ...
        try {
            ...
            if (decision.getDecisionType() != null) {
                jsonGenerator.writeFieldName("decisionType").writeValue(
                        decision.getDecisionType());
            }
            if (decision.getScheduleActivityTaskDecisionAttributes() != null) {
                jsonGenerator
                        .writeFieldName("scheduleActivityTaskDecisionAttributes");
                ScheduleActivityTaskDecisionAttributesJsonMarshaller
                        .getInstance()
                        .marshall(
            ...
            if (decision.getRequestCancelActivityTaskDecisionAttributes() != null) {
                jsonGenerator
                        .writeFieldName("requestCancelActivityTaskDecisionAttributes");
                RequestCancelActivityTaskDecisionAttributesJsonMarshaller
                        .getInstance()
                        .marshall(
            ...
            if (decision.getCompleteWorkflowExecutionDecisionAttributes() != null) {
                jsonGenerator
                        .writeFieldName("completeWorkflowExecutionDecisionAttributes");
            ...
            if (decision.getFailWorkflowExecutionDecisionAttributes() != null) {
                jsonGenerator
                        .writeFieldName("failWorkflowExecutionDecisionAttributes");
                FailWorkflowExecutionDecisionAttributesJsonMarshaller
                        .getInstance()
                        .marshall(
            ...
            if (decision.getCancelWorkflowExecutionDecisionAttributes() != null) {
                jsonGenerator
                        .writeFieldName("cancelWorkflowExecutionDecisionAttributes");
            ...
            if (decision.getContinueAsNewWorkflowExecutionDecisionAttributes() != null) {
                jsonGenerator
                        .writeFieldName("continueAsNewWorkflowExecutionDecisionAttributes");
                ContinueAsNewWorkflowExecutionDecisionAttributesJsonMarshaller
                        .getInstance()
                        .marshall(
            ...
            if (decision.getRecordMarkerDecisionAttributes() != null) {
                ...
                RecordMarkerDecisionAttributesJsonMarshaller.getInstance()
                        .marshall(decision.getRecordMarkerDecisionAttributes(),
                                jsonGenerator);
            }
            if (decision.getStartTimerDecisionAttributes() != null) {
                jsonGenerator.writeFieldName("startTimerDecisionAttributes");
                StartTimerDecisionAttributesJsonMarshaller.getInstance()
                        .marshall(decision.getStartTimerDecisionAttributes(),
                                jsonGenerator);
            }
            if (decision.getCancelTimerDecisionAttributes() != null) {
                jsonGenerator.writeFieldName("cancelTimerDecisionAttributes");
                CancelTimerDecisionAttributesJsonMarshaller.getInstance()
                        .marshall(decision.getCancelTimerDecisionAttributes(),
                                jsonGenerator);
            }
            if (decision.getSignalExternalWorkflowExecutionDecisionAttributes() != null) {
                jsonGenerator
                        .writeFieldName("signalExternalWorkflowExecutionDecisionAttributes");
                SignalExternalWorkflowExecutionDecisionAttributesJsonMarshaller
                        .getInstance()
                        .marshall(
            ...
            if (decision
                    .getRequestCancelExternalWorkflowExecutionDecisionAttributes() != null) {
                jsonGenerator
                        .writeFieldName("requestCancelExternalWorkflowExecutionDecisionAttributes");
                RequestCancelExternalWorkflowExecutionDecisionAttributesJsonMarshaller
                        .getInstance()
                        .marshall(
            ...
            if (decision.getStartChildWorkflowExecutionDecisionAttributes() != null) {
                jsonGenerator
                        .writeFieldName("startChildWorkflowExecutionDecisionAttributes");
                StartChildWorkflowExecutionDecisionAttributesJsonMarshaller
                        .getInstance()
                        .marshall(
            ...
            if (decision.getScheduleLambdaFunctionDecisionAttributes() != null) {
                jsonGenerator
                        .writeFieldName("scheduleLambdaFunctionDecisionAttributes");
                ScheduleLambdaFunctionDecisionAttributesJsonMarshaller
                        .getInstance()
                        .marshall(
