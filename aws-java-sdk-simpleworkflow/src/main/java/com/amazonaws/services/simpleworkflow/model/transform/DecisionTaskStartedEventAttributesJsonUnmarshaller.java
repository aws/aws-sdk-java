...
public class DecisionTaskStartedEventAttributesJsonUnmarshaller implements Unmarshaller<DecisionTaskStartedEventAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("identity", targetDepth)) {
                    context.nextToken();
                    decisionTaskStartedEventAttributes.setIdentity(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("scheduledEventId", targetDepth)) {
                    context.nextToken();
                    decisionTaskStartedEventAttributes.setScheduledEventId(context.getUnmarshaller(Long.class).unmarshall(context));
                }
    ...
    public static DecisionTaskStartedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DecisionTaskStartedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
