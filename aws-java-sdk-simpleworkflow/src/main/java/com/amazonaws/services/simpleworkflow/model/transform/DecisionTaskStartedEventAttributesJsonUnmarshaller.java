...
public class DecisionTaskStartedEventAttributesJsonUnmarshaller implements Unmarshaller<DecisionTaskStartedEventAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("identity", targetDepth)) {
                    context.nextToken();
                    decisionTaskStartedEventAttributes.setIdentity(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DecisionTaskStartedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DecisionTaskStartedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
