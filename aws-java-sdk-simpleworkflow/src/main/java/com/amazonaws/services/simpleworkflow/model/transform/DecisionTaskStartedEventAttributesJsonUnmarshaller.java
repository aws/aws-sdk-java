 ...
 */
public class DecisionTaskStartedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<DecisionTaskStartedEventAttributes, JsonUnmarshallerContext> {

    public DecisionTaskStartedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("identity", targetDepth)) {
                    context.nextToken();
                    decisionTaskStartedEventAttributes.setIdentity(context
