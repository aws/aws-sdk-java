...
public class DescribeWorkflowTypeRequestMarshaller
        implements
        Marshaller<Request<DescribeWorkflowTypeRequest>, DescribeWorkflowTypeRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeWorkflowTypeRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeWorkflowTypeRequest> marshall(
        ...
        Request<DescribeWorkflowTypeRequest> request = new DefaultRequest<DescribeWorkflowTypeRequest>(
                describeWorkflowTypeRequest, "AmazonSimpleWorkflow");
        ...
        try {
            ...
            if (describeWorkflowTypeRequest.getDomain() != null) {
                jsonGenerator.writeFieldName("domain").writeValue(
                        describeWorkflowTypeRequest.getDomain());
            }
