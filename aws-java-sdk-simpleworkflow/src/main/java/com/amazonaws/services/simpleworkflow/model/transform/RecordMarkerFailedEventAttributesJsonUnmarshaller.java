 ...
 */
public class RecordMarkerFailedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<RecordMarkerFailedEventAttributes, JsonUnmarshallerContext> {

    public RecordMarkerFailedEventAttributes unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("markerName", targetDepth)) {
                    context.nextToken();
                    recordMarkerFailedEventAttributes.setMarkerName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("cause", targetDepth)) {
                    context.nextToken();
                    recordMarkerFailedEventAttributes.setCause(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
