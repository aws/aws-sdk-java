 ...
 */
public class ActivityTypeDetailJsonUnmarshaller implements
        Unmarshaller<ActivityTypeDetail, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("typeInfo", targetDepth)) {
                    context.nextToken();
                    activityTypeDetail
                            .setTypeInfo(ActivityTypeInfoJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
                if (context.testExpression("configuration", targetDepth)) {
                    context.nextToken();
                    activityTypeDetail
                            .setConfiguration(ActivityTypeConfigurationJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
