...
public class WorkflowExecutionJsonUnmarshaller implements Unmarshaller<WorkflowExecution, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("workflowId", targetDepth)) {
                    context.nextToken();
                    workflowExecution.setWorkflowId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("runId", targetDepth)) {
                    context.nextToken();
                    workflowExecution.setRunId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static WorkflowExecutionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new WorkflowExecutionJsonUnmarshaller();
        return instance;
    }
}
