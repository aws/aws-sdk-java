 ...
 * 
 */
public class StartWorkflowExecutionRequest extends
     ...
     * logically a <i>restart</i> of a previous execution. You cannot have two
     * open workflow executions with the same <code>workflowId</code> at the
     * same time.
     * </p>
     * <p>
     ...
     *        workflow execution is logically a <i>restart</i> of a previous
     ...
     *        <code>defaultTaskList</code> specified when registering the
     *        workflow type.</p> <note>A task list for this workflow execution
     ...
     *         that range from Java's <code>Integer.MIN_VALUE</code>
     *         (-2147483648) to <code>Integer.MAX_VALUE</code> (2147483647).
     ...
     *        <code>input</code> is made available to the new workflow execution
     ...
     *         which should be meaningful to the workflow you are starting. This
     *         <code>input</code> is made available to the new workflow
     *         execution in the <code>WorkflowExecutionStarted</code> history
     *         event.
     */
     ...
     *        run.
     *        </p>
     *        <note> An execution start-to-close timeout must be specified
     ...
     *         with a specific tag by calling <a>ListOpenWorkflowExecutions</a>
     *         or <a>ListClosedWorkflowExecutions</a> and specifying a
     *         <a>TagFilter</a>.
     */
     ...
     *         executions of this workflow execution if it is terminated, by
     *         calling the <a>TerminateWorkflowExecution</a> action explicitly
