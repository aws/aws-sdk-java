 ...
 */
public class ExternalWorkflowExecutionCancelRequestedEventAttributesJsonUnmarshaller
        implements
        Unmarshaller<ExternalWorkflowExecutionCancelRequestedEventAttributes, JsonUnmarshallerContext> {

    public ExternalWorkflowExecutionCancelRequestedEventAttributes unmarshall(
