...
public class ExternalWorkflowExecutionCancelRequestedEventAttributesJsonUnmarshaller implements
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("workflowExecution", targetDepth)) {
                    context.nextToken();
                    externalWorkflowExecutionCancelRequestedEventAttributes.setWorkflowExecution(WorkflowExecutionJsonUnmarshaller.getInstance().unmarshall(
                            context));
                }
                if (context.testExpression("initiatedEventId", targetDepth)) {
                    context.nextToken();
                    externalWorkflowExecutionCancelRequestedEventAttributes.setInitiatedEventId(context.getUnmarshaller(Long.class).unmarshall(context));
                }
    ...
    public static ExternalWorkflowExecutionCancelRequestedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExternalWorkflowExecutionCancelRequestedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
