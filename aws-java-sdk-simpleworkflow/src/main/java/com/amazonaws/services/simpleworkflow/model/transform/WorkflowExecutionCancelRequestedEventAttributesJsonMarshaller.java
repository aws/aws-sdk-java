    ...
    public void marshall(WorkflowExecutionCancelRequestedEventAttributes workflowExecutionCancelRequestedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (workflowExecutionCancelRequestedEventAttributes.getExternalWorkflowExecution() != null) {
                ...
                WorkflowExecutionJsonMarshaller.getInstance().marshall(workflowExecutionCancelRequestedEventAttributes.getExternalWorkflowExecution(),
                        jsonGenerator);
            }
            if (workflowExecutionCancelRequestedEventAttributes.getExternalInitiatedEventId() != null) {
                jsonGenerator.writeFieldName("externalInitiatedEventId").writeValue(
                        workflowExecutionCancelRequestedEventAttributes.getExternalInitiatedEventId());
            }
            if (workflowExecutionCancelRequestedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(workflowExecutionCancelRequestedEventAttributes.getCause());
            }
