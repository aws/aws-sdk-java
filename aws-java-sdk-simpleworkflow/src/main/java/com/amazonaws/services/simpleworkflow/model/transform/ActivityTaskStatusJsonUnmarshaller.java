 ...
 */
public class ActivityTaskStatusJsonUnmarshaller implements
        Unmarshaller<ActivityTaskStatus, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("cancelRequested", targetDepth)) {
                    context.nextToken();
                    activityTaskStatus
                            .setCancelRequested(context.getUnmarshaller(
