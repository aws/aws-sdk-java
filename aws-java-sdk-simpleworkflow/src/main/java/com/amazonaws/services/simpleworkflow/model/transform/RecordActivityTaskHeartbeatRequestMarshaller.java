...
public class RecordActivityTaskHeartbeatRequestMarshaller
    ...
    public Request<RecordActivityTaskHeartbeatRequest> marshall(
        ...
        Request<RecordActivityTaskHeartbeatRequest> request = new DefaultRequest<RecordActivityTaskHeartbeatRequest>(
                recordActivityTaskHeartbeatRequest, "AmazonSimpleWorkflow");
