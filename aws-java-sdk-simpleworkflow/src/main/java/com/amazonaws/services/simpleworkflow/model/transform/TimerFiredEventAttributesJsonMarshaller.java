...
public class TimerFiredEventAttributesJsonMarshaller {
    ...
    public void marshall(TimerFiredEventAttributes timerFiredEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (timerFiredEventAttributes.getTimerId() != null) {
                jsonGenerator.writeFieldName("timerId").writeValue(timerFiredEventAttributes.getTimerId());
            }
            if (timerFiredEventAttributes.getStartedEventId() != null) {
                jsonGenerator.writeFieldName("startedEventId").writeValue(timerFiredEventAttributes.getStartedEventId());
            }
    ...
    public static TimerFiredEventAttributesJsonMarshaller getInstance() {
        if (instance == null)
            instance = new TimerFiredEventAttributesJsonMarshaller();
        return instance;
    }
