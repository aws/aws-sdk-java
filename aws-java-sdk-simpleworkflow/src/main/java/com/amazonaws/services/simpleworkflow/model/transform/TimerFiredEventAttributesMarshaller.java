...
@SdkInternalApi
public class TimerFiredEventAttributesMarshaller {
    ...
    private static final TimerFiredEventAttributesMarshaller instance = new TimerFiredEventAttributesMarshaller();

    public static TimerFiredEventAttributesMarshaller getInstance() {
        return instance;
    }
