...
public class RequestCancelActivityTaskFailedEventAttributesJsonMarshaller {
     ...
     */
    public void marshall(RequestCancelActivityTaskFailedEventAttributes requestCancelActivityTaskFailedEventAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (requestCancelActivityTaskFailedEventAttributes.getActivityId() != null) {
                jsonGenerator.writeFieldName("activityId").writeValue(requestCancelActivityTaskFailedEventAttributes.getActivityId());
            }
            if (requestCancelActivityTaskFailedEventAttributes.getCause() != null) {
                jsonGenerator.writeFieldName("cause").writeValue(requestCancelActivityTaskFailedEventAttributes.getCause());
            }
            if (requestCancelActivityTaskFailedEventAttributes.getDecisionTaskCompletedEventId() != null) {
                jsonGenerator.writeFieldName("decisionTaskCompletedEventId").writeValue(
                        requestCancelActivityTaskFailedEventAttributes.getDecisionTaskCompletedEventId());
            }
