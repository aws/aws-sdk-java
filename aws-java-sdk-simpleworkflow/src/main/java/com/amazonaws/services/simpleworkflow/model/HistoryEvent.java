 ...
 * <li><b>WorkflowExecutionCompleted</b>: The workflow execution was closed due
 * to successful completion.</li>
 * <li><b>WorkflowExecutionFailed</b>: The workflow execution closed due to a
 * failure.</li>
 * <li><b>WorkflowExecutionTimedOut</b>: The workflow execution was closed
 * because a time out was exceeded.</li>
 * <li><b>WorkflowExecutionCanceled</b>: The workflow execution was successfully
 ...
 * <li><b>WorkflowExecutionCancelRequested</b>: A request to cancel this
 * workflow execution was made.</li>
 * <li><b>DecisionTaskScheduled</b>: A decision task was scheduled for the
 * workflow execution.</li>
 * <li><b>DecisionTaskStarted</b>: The decision task was dispatched to a
 * decider.</li>
 * <li><b>DecisionTaskCompleted</b>: The decider successfully completed a
 * decision task by calling <a>RespondDecisionTaskCompleted</a>.</li>
 * <li><b>DecisionTaskTimedOut</b>: The decision task timed out.</li>
 * <li><b>ActivityTaskScheduled</b>: An activity task was scheduled for
 * execution.</li>
 ...
 * example the activity type specified is not registered.</li>
 * <li><b>ActivityTaskStarted</b>: The scheduled activity task was dispatched to
 * a worker.</li>
 * <li><b>ActivityTaskCompleted</b>: An activity worker successfully completed
 * an activity task by calling <a>RespondActivityTaskCompleted</a>.</li>
 * <li><b>ActivityTaskFailed</b>: An activity worker failed an activity task by
 * calling <a>RespondActivityTaskFailed</a>.</li>
 * <li><b>ActivityTaskTimedOut</b>: The activity task timed out.</li>
 * <li><b>ActivityTaskCanceled</b>: The activity task was successfully canceled.
 * </li>
 ...
 * <li><b>WorkflowExecutionSignaled</b>: An external signal was received for the
 * workflow execution.</li>
 * <li><b>MarkerRecorded</b>: A marker was recorded in the workflow history as
 * the result of a <code>RecordMarker</code> decision.</li>
 * <li><b>TimerStarted</b>: A timer was started for the workflow execution due
 * to a <code>StartTimer</code> decision.</li>
 * <li><b>StartTimerFailed</b>: Failed to process StartTimer decision. This
 * happens when the decision is not configured properly, for example a timer
 * already exists with the specified timer ID.</li>
 * <li><b>TimerFired</b>: A timer, previously started for this workflow
 * execution, fired.</li>
 * <li><b>TimerCanceled</b>: A timer, previously started for this workflow
 * execution, was successfully canceled.</li>
 * <li><b>CancelTimerFailed</b>: Failed to process CancelTimer decision. This
 * happens when the decision is not configured properly, for example no timer
 * exists with the specified timer ID.</li>
 * <li><b>StartChildWorkflowExecutionInitiated</b>: A request was made to start
 * a child workflow execution.</li>
 ...
 * registered.</li>
 * <li><b>ChildWorkflowExecutionStarted</b>: A child workflow execution was
 * successfully started.</li>
 * <li><b>ChildWorkflowExecutionCompleted</b>: A child workflow execution,
 * started by this workflow execution, completed successfully and was closed.</li>
 * <li><b>ChildWorkflowExecutionFailed</b>: A child workflow execution, started
 * by this workflow execution, failed to complete successfully and was closed.</li>
 * <li><b>ChildWorkflowExecutionTimedOut</b>: A child workflow execution,
 * started by this workflow execution, timed out and was closed.</li>
 * <li><b>ChildWorkflowExecutionCanceled</b>: A child workflow execution,
 * started by this workflow execution, was canceled and closed.</li>
 * <li><b>ChildWorkflowExecutionTerminated</b>: A child workflow execution,
 * started by this workflow execution, was terminated.</li>
 * <li><b>SignalExternalWorkflowExecutionInitiated</b>: A request to signal an
 * external workflow was made.</li>
 * <li><b>ExternalWorkflowExecutionSignaled</b>: A signal, requested by this
 * workflow execution, was successfully delivered to the target external
 * workflow execution.</li>
 * <li><b>SignalExternalWorkflowExecutionFailed</b>: The request to signal an
 * external workflow execution failed.</li>
 * <li><b>RequestCancelExternalWorkflowExecutionInitiated</b>: A request was
 * made to request the cancellation of an external workflow execution.</li>
 * <li><b>ExternalWorkflowExecutionCancelRequested</b>: Request to cancel an
 * external workflow execution was successfully delivered to the target
 * execution.</li>
 * <li><b>RequestCancelExternalWorkflowExecutionFailed</b>: Request to cancel an
 * external workflow execution failed.</li>
 * <li><b>LambdaFunctionScheduled</b>: An AWS Lambda function was scheduled for
 * execution.</li>
 * <li><b>LambdaFunctionStarted</b>: The scheduled function was invoked in the
 * AWS Lambda service.</li>
 * <li><b>LambdaFunctionCompleted</b>: The AWS Lambda function successfully
 * completed.</li>
 * <li><b>LambdaFunctionFailed</b>: The AWS Lambda function execution failed.</li>
 * <li><b>LambdaFunctionTimedOut</b>: The AWS Lambda function execution timed
 * out.</li>
 ...
 * does not have the proper IAM role attached to invoke AWS Lambda functions.</li>
 * <li><b>StartLambdaFunctionFailed</b>: Failed to invoke the scheduled function
 * in the AWS Lambda service. This happens when the AWS Lambda service is not
 * available in the current region, or received too many requests.</li>
 * </ul>
 */
public class HistoryEvent implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * If the event is of type <code>CancelWorkflowExecutionFailed</code> then
     * this member is set and provides detailed information about the event. It
     * is not set for other event types.
     * </p>
     */
    ...
    /**
     * <p>
     * If the event is of type <code>DecisionTaskStarted</code> then this member
    ...
    /**
     * <p>
     * If the event is of type <code>ActivityTaskStarted</code> then this member
     * is set and provides detailed information about the event. It is not set
     * for other event types.
     * </p>
     */
    ...
    /**
     * <p>
     * If the event is of type <code>ActivityTaskFailed</code> then this member
     * is set and provides detailed information about the event. It is not set
     * for other event types.
     * </p>
     */
    ...
    /**
     * <p>
     * If the event is of type <code>MarkerRecorded</code> then this member is
    ...
    /**
     * <p>
     * If the event is of type <code>DecisionTaskFailed</code> then this member
     * is set and provides detailed information about the event. It is not set
     * for other event types.
     * </p>
     */
    ...
    /**
     * <p>
     * If the event is of type <code>TimerFired</code> then this member is set
     * and provides detailed information about the event. It is not set for
     * other event types.
     * </p>
     */
    ...
    /**
     * <p>
     * If the event is of type <code>ChildWorkflowExecutionStarted</code> then
     * this member is set and provides detailed information about the event. It
     * is not set for other event types.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The system generated ID of the event. This ID uniquely identifies
     *         the event with in the workflow execution history.
     */
    ...
    public void setWorkflowExecutionStartedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>WorkflowExecutionStarted</code>
    ...
    public HistoryEvent withWorkflowExecutionStartedEventAttributes(
            WorkflowExecutionStartedEventAttributes workflowExecutionStartedEventAttributes) {
     ...
     *        If the event is of type <code>WorkflowExecutionCompleted</code>
     *        then this member is set and provides detailed information about
     *        the event. It is not set for other event types.
     */

    public void setWorkflowExecutionCompletedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>WorkflowExecutionCompleted</code>
     *         then this member is set and provides detailed information about
     *         the event. It is not set for other event types.
     */
    ...
    public HistoryEvent withWorkflowExecutionCompletedEventAttributes(
            WorkflowExecutionCompletedEventAttributes workflowExecutionCompletedEventAttributes) {
     ...
     *        If the event is of type
     *        <code>CompleteWorkflowExecutionFailed</code> then this member is
     *        set and provides detailed information about the event. It is not
     *        set for other event types.
     */

    public void setCompleteWorkflowExecutionFailedEventAttributes(
     ...
     *        If the event is of type <code>WorkflowExecutionFailed</code> then
     *        this member is set and provides detailed information about the
     *        event. It is not set for other event types.
     */

    public void setWorkflowExecutionFailedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>WorkflowExecutionFailed</code> then
     *         this member is set and provides detailed information about the
     *         event. It is not set for other event types.
     */
    ...
    public HistoryEvent withWorkflowExecutionFailedEventAttributes(
            WorkflowExecutionFailedEventAttributes workflowExecutionFailedEventAttributes) {
     ...
     *        If the event is of type <code>FailWorkflowExecutionFailed</code>
     *        then this member is set and provides detailed information about
     *        the event. It is not set for other event types.
     */

    public void setFailWorkflowExecutionFailedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>FailWorkflowExecutionFailed</code>
     *         then this member is set and provides detailed information about
     *         the event. It is not set for other event types.
     */
    ...
    public HistoryEvent withFailWorkflowExecutionFailedEventAttributes(
            FailWorkflowExecutionFailedEventAttributes failWorkflowExecutionFailedEventAttributes) {
     ...
     *        If the event is of type <code>WorkflowExecutionTimedOut</code>
     *        then this member is set and provides detailed information about
     *        the event. It is not set for other event types.
     */

    public void setWorkflowExecutionTimedOutEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>WorkflowExecutionTimedOut</code>
     *         then this member is set and provides detailed information about
     *         the event. It is not set for other event types.
     */
    ...
    public HistoryEvent withWorkflowExecutionTimedOutEventAttributes(
            WorkflowExecutionTimedOutEventAttributes workflowExecutionTimedOutEventAttributes) {
     ...
     *        If the event is of type <code>WorkflowExecutionCanceled</code>
     *        then this member is set and provides detailed information about
     *        the event. It is not set for other event types.
     */

    public void setWorkflowExecutionCanceledEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>WorkflowExecutionCanceled</code>
     *         then this member is set and provides detailed information about
     *         the event. It is not set for other event types.
     */
    ...
    public HistoryEvent withWorkflowExecutionCanceledEventAttributes(
            WorkflowExecutionCanceledEventAttributes workflowExecutionCanceledEventAttributes) {
    ...
    public void setCancelWorkflowExecutionFailedEventAttributes(
     ...
     * 
     * @return If the event is of type
     *         <code>CancelWorkflowExecutionFailed</code> then this member is
     *         set and provides detailed information about the event. It is not
     *         set for other event types.
     */
     ...
     *        If the event is of type
     *        <code>WorkflowExecutionContinuedAsNew</code> then this member is
     *        set and provides detailed information about the event. It is not
     *        set for other event types.
     */

    public void setWorkflowExecutionContinuedAsNewEventAttributes(
     ...
     *        If the event is of type
     *        <code>ContinueAsNewWorkflowExecutionFailed</code> then this member
     ...
     * 
     * @return If the event is of type
     *         <code>ContinueAsNewWorkflowExecutionFailed</code> then this
     ...
     *        If the event is of type <code>WorkflowExecutionTerminated</code>
     *        then this member is set and provides detailed information about
     *        the event. It is not set for other event types.
     */

    public void setWorkflowExecutionTerminatedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>WorkflowExecutionTerminated</code>
     *         then this member is set and provides detailed information about
     *         the event. It is not set for other event types.
     */
    ...
    public HistoryEvent withWorkflowExecutionTerminatedEventAttributes(
            WorkflowExecutionTerminatedEventAttributes workflowExecutionTerminatedEventAttributes) {
     ...
     *        If the event is of type
     *        <code>WorkflowExecutionCancelRequested</code> then this member is
     *        set and provides detailed information about the event. It is not
     *        set for other event types.
     */
     ...
     *        If the event is of type <code>DecisionTaskScheduled</code> then
     *        this member is set and provides detailed information about the
     *        event. It is not set for other event types.
     */

    public void setDecisionTaskScheduledEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>DecisionTaskScheduled</code> then
     *         this member is set and provides detailed information about the
     *         event. It is not set for other event types.
     */
    ...
    public HistoryEvent withDecisionTaskScheduledEventAttributes(
            DecisionTaskScheduledEventAttributes decisionTaskScheduledEventAttributes) {
    ...
    public void setDecisionTaskStartedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>DecisionTaskStarted</code> then
     *         this member is set and provides detailed information about the
     *         event. It is not set for other event types.
     */
    ...
    public HistoryEvent withDecisionTaskStartedEventAttributes(
            DecisionTaskStartedEventAttributes decisionTaskStartedEventAttributes) {
     ...
     *        If the event is of type <code>DecisionTaskCompleted</code> then
     *        this member is set and provides detailed information about the
     *        event. It is not set for other event types.
     */

    public void setDecisionTaskCompletedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>DecisionTaskCompleted</code> then
     *         this member is set and provides detailed information about the
     *         event. It is not set for other event types.
     */
    ...
    public HistoryEvent withDecisionTaskCompletedEventAttributes(
            DecisionTaskCompletedEventAttributes decisionTaskCompletedEventAttributes) {
     ...
     *        If the event is of type <code>DecisionTaskTimedOut</code> then
     *        this member is set and provides detailed information about the
     *        event. It is not set for other event types.
     */

    public void setDecisionTaskTimedOutEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>DecisionTaskTimedOut</code> then
     *         this member is set and provides detailed information about the
     *         event. It is not set for other event types.
     */
    ...
    public HistoryEvent withDecisionTaskTimedOutEventAttributes(
            DecisionTaskTimedOutEventAttributes decisionTaskTimedOutEventAttributes) {
     ...
     *        If the event is of type <code>ActivityTaskScheduled</code> then
     *        this member is set and provides detailed information about the
     *        event. It is not set for other event types.
     */

    public void setActivityTaskScheduledEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>ActivityTaskScheduled</code> then
     *         this member is set and provides detailed information about the
     *         event. It is not set for other event types.
     */
    ...
    public HistoryEvent withActivityTaskScheduledEventAttributes(
            ActivityTaskScheduledEventAttributes activityTaskScheduledEventAttributes) {
    ...
    public void setActivityTaskStartedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>ActivityTaskStarted</code> then
     *         this member is set and provides detailed information about the
     *         event. It is not set for other event types.
     */
    ...
    public HistoryEvent withActivityTaskStartedEventAttributes(
            ActivityTaskStartedEventAttributes activityTaskStartedEventAttributes) {
     ...
     *        If the event is of type <code>ActivityTaskCompleted</code> then
     *        this member is set and provides detailed information about the
     *        event. It is not set for other event types.
     */

    public void setActivityTaskCompletedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>ActivityTaskCompleted</code> then
     *         this member is set and provides detailed information about the
     *         event. It is not set for other event types.
     */
    ...
    public HistoryEvent withActivityTaskCompletedEventAttributes(
            ActivityTaskCompletedEventAttributes activityTaskCompletedEventAttributes) {
    ...
    public void setActivityTaskFailedEventAttributes(
    ...
    public HistoryEvent withActivityTaskFailedEventAttributes(
            ActivityTaskFailedEventAttributes activityTaskFailedEventAttributes) {
     ...
     *        If the event is of type <code>ActivityTaskTimedOut</code> then
     *        this member is set and provides detailed information about the
     *        event. It is not set for other event types.
     */

    public void setActivityTaskTimedOutEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>ActivityTaskTimedOut</code> then
     *         this member is set and provides detailed information about the
     *         event. It is not set for other event types.
     */
    ...
    public HistoryEvent withActivityTaskTimedOutEventAttributes(
            ActivityTaskTimedOutEventAttributes activityTaskTimedOutEventAttributes) {
     ...
     *        If the event is of type <code>ActivityTaskCanceled</code> then
     *        this member is set and provides detailed information about the
     *        event. It is not set for other event types.
     */

    public void setActivityTaskCanceledEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>ActivityTaskCanceled</code> then
     *         this member is set and provides detailed information about the
     *         event. It is not set for other event types.
     */
    ...
    public HistoryEvent withActivityTaskCanceledEventAttributes(
            ActivityTaskCanceledEventAttributes activityTaskCanceledEventAttributes) {
     ...
     *        If the event is of type <code>ActivityTaskcancelRequested</code>
     *        then this member is set and provides detailed information about
     *        the event. It is not set for other event types.
     */

    public void setActivityTaskCancelRequestedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>ActivityTaskcancelRequested</code>
     *         then this member is set and provides detailed information about
     *         the event. It is not set for other event types.
     */
    ...
    public HistoryEvent withActivityTaskCancelRequestedEventAttributes(
            ActivityTaskCancelRequestedEventAttributes activityTaskCancelRequestedEventAttributes) {
     ...
     *        If the event is of type <code>WorkflowExecutionSignaled</code>
     *        then this member is set and provides detailed information about
     *        the event. It is not set for other event types.
     */

    public void setWorkflowExecutionSignaledEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>WorkflowExecutionSignaled</code>
     *         then this member is set and provides detailed information about
     *         the event. It is not set for other event types.
     */
    ...
    public HistoryEvent withWorkflowExecutionSignaledEventAttributes(
            WorkflowExecutionSignaledEventAttributes workflowExecutionSignaledEventAttributes) {
     ...
     *        If the event is of type <code>MarkerRecorded</code> then this
     *        member is set and provides detailed information about the event.
     *        It is not set for other event types.
     */

    public void setMarkerRecordedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>MarkerRecorded</code> then this
     *         member is set and provides detailed information about the event.
     *         It is not set for other event types.
     */
    ...
    public void setRecordMarkerFailedEventAttributes(
    ...
    public HistoryEvent withRecordMarkerFailedEventAttributes(
            RecordMarkerFailedEventAttributes recordMarkerFailedEventAttributes) {
     ...
     *        If the event is of type <code>TimerStarted</code> then this member
     *        is set and provides detailed information about the event. It is
     *        not set for other event types.
     */

    public void setTimerStartedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>TimerStarted</code> then this
     *         member is set and provides detailed information about the event.
     *         It is not set for other event types.
     */
    ...
    public HistoryEvent withTimerStartedEventAttributes(
            TimerStartedEventAttributes timerStartedEventAttributes) {
     ...
     *        If the event is of type <code>TimerFired</code> then this member
     *        is set and provides detailed information about the event. It is
     *        not set for other event types.
     */

    public void setTimerFiredEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>TimerFired</code> then this member
     *         is set and provides detailed information about the event. It is
     *         not set for other event types.
     */
    ...
    public HistoryEvent withTimerFiredEventAttributes(
            TimerFiredEventAttributes timerFiredEventAttributes) {
     ...
     *        If the event is of type <code>TimerCanceled</code> then this
     *        member is set and provides detailed information about the event.
     *        It is not set for other event types.
     */

    public void setTimerCanceledEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>TimerCanceled</code> then this
     *         member is set and provides detailed information about the event.
     *         It is not set for other event types.
     */
    ...
    public HistoryEvent withTimerCanceledEventAttributes(
            TimerCanceledEventAttributes timerCanceledEventAttributes) {
     ...
     *        If the event is of type
     *        <code>StartChildWorkflowExecutionInitiated</code> then this member
     *        is set and provides detailed information about the event. It is
     *        not set for other event types.
     */
     ...
     * 
     * @return If the event is of type
     *         <code>StartChildWorkflowExecutionInitiated</code> then this
     *         member is set and provides detailed information about the event.
     *         It is not set for other event types.
     */
    ...
    public void setChildWorkflowExecutionStartedEventAttributes(
     ...
     * 
     * @return If the event is of type
     *         <code>ChildWorkflowExecutionStarted</code> then this member is
     *         set and provides detailed information about the event. It is not
     *         set for other event types.
     */
     ...
     *        If the event is of type
     *        <code>ChildWorkflowExecutionCompleted</code> then this member is
     *        set and provides detailed information about the event. It is not
     *        set for other event types.
     */

    public void setChildWorkflowExecutionCompletedEventAttributes(
     ...
     *        If the event is of type <code>ChildWorkflowExecutionFailed</code>
     *        then this member is set and provides detailed information about
     *        the event. It is not set for other event types.
     */

    public void setChildWorkflowExecutionFailedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>ChildWorkflowExecutionFailed</code>
     *         then this member is set and provides detailed information about
     *         the event. It is not set for other event types.
     */
    ...
    public HistoryEvent withChildWorkflowExecutionFailedEventAttributes(
            ChildWorkflowExecutionFailedEventAttributes childWorkflowExecutionFailedEventAttributes) {
     ...
     *        If the event is of type
     *        <code>ChildWorkflowExecutionTimedOut</code> then this member is
     *        set and provides detailed information about the event. It is not
     *        set for other event types.
     */

    public void setChildWorkflowExecutionTimedOutEventAttributes(
     ...
     *        If the event is of type
     *        <code>ChildWorkflowExecutionCanceled</code> then this member is
     *        set and provides detailed information about the event. It is not
     *        set for other event types.
     */

    public void setChildWorkflowExecutionCanceledEventAttributes(
     ...
     *        If the event is of type
     *        <code>ChildWorkflowExecutionTerminated</code> then this member is
     *        set and provides detailed information about the event. It is not
     *        set for other event types.
     */
     ...
     *        If the event is of type
     *        <code>SignalExternalWorkflowExecutionInitiated</code> then this
     *        member is set and provides detailed information about the event.
     *        It is not set for other event types.
     */
     ...
     *        If the event is of type
     *        <code>ExternalWorkflowExecutionSignaled</code> then this member is
     *        set and provides detailed information about the event. It is not
     *        set for other event types.
     */
     ...
     * 
     * @return If the event is of type
     *         <code>ExternalWorkflowExecutionSignaled</code> then this member
     *         is set and provides detailed information about the event. It is
     *         not set for other event types.
     */
     ...
     *        If the event is of type
     *        <code>SignalExternalWorkflowExecutionFailed</code> then this
     *        member is set and provides detailed information about the event.
     *        It is not set for other event types.
     */
     ...
     *        If the event is of type
     *        <code>ExternalWorkflowExecutionCancelRequested</code> then this
     *        member is set and provides detailed information about the event.
     *        It is not set for other event types.
     */
     ...
     *        If the event is of type
     *        <code>RequestCancelExternalWorkflowExecutionInitiated</code> then
     *        this member is set and provides detailed information about the
     *        event. It is not set for other event types.
     */
     ...
     *        If the event is of type
     *        <code>RequestCancelExternalWorkflowExecutionFailed</code> then
     *        this member is set and provides detailed information about the
     *        event. It is not set for other event types.
     */
     ...
     *        If the event is of type <code>ScheduleActivityTaskFailed</code>
     *        then this member is set and provides detailed information about
     *        the event. It is not set for other event types.
     */

    public void setScheduleActivityTaskFailedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>ScheduleActivityTaskFailed</code>
     *         then this member is set and provides detailed information about
     *         the event. It is not set for other event types.
     */
    ...
    public HistoryEvent withScheduleActivityTaskFailedEventAttributes(
            ScheduleActivityTaskFailedEventAttributes scheduleActivityTaskFailedEventAttributes) {
     ...
     *        If the event is of type
     *        <code>RequestCancelActivityTaskFailed</code> then this member is
     *        set and provides detailed information about the event. It is not
     *        set for other event types.
     */

    public void setRequestCancelActivityTaskFailedEventAttributes(
     ...
     *        If the event is of type <code>StartTimerFailed</code> then this
     *        member is set and provides detailed information about the event.
     *        It is not set for other event types.
     */

    public void setStartTimerFailedEventAttributes(
     ...
     * </p>
     * 
     * @return If the event is of type <code>StartTimerFailed</code> then this
     *         member is set and provides detailed information about the event.
     *         It is not set for other event types.
     */
    ...
    public HistoryEvent withStartTimerFailedEventAttributes(
            StartTimerFailedEventAttributes startTimerFailedEventAttributes) {
    ...
    public void setCancelTimerFailedEventAttributes(
    ...
    public HistoryEvent withCancelTimerFailedEventAttributes(
            CancelTimerFailedEventAttributes cancelTimerFailedEventAttributes) {
     ...
     *        If the event is of type
     *        <code>StartChildWorkflowExecutionFailed</code> then this member is
     *        set and provides detailed information about the event. It is not
     *        set for other event types.
     */
     ...
     * 
     * @return If the event is of type
     *         <code>StartChildWorkflowExecutionFailed</code> then this member
     *         is set and provides detailed information about the event. It is
     *         not set for other event types.
     */
    ...
    public void setLambdaFunctionScheduledEventAttributes(
    ...
    public HistoryEvent withLambdaFunctionScheduledEventAttributes(
            LambdaFunctionScheduledEventAttributes lambdaFunctionScheduledEventAttributes) {
    ...
    public void setLambdaFunctionStartedEventAttributes(
    ...
    public HistoryEvent withLambdaFunctionStartedEventAttributes(
            LambdaFunctionStartedEventAttributes lambdaFunctionStartedEventAttributes) {
    ...
    public void setLambdaFunctionCompletedEventAttributes(
    ...
    public HistoryEvent withLambdaFunctionCompletedEventAttributes(
            LambdaFunctionCompletedEventAttributes lambdaFunctionCompletedEventAttributes) {
    ...
    public void setLambdaFunctionFailedEventAttributes(
    ...
    public HistoryEvent withLambdaFunctionFailedEventAttributes(
            LambdaFunctionFailedEventAttributes lambdaFunctionFailedEventAttributes) {
    ...
    public void setLambdaFunctionTimedOutEventAttributes(
    ...
    public HistoryEvent withLambdaFunctionTimedOutEventAttributes(
            LambdaFunctionTimedOutEventAttributes lambdaFunctionTimedOutEventAttributes) {
    ...
    public void setScheduleLambdaFunctionFailedEventAttributes(
    ...
    public HistoryEvent withScheduleLambdaFunctionFailedEventAttributes(
            ScheduleLambdaFunctionFailedEventAttributes scheduleLambdaFunctionFailedEventAttributes) {
    ...
    public void setStartLambdaFunctionFailedEventAttributes(
    ...
    public HistoryEvent withStartLambdaFunctionFailedEventAttributes(
            StartLambdaFunctionFailedEventAttributes startLambdaFunctionFailedEventAttributes) {
    ...
    public String toString() {
        ...
        if (getFailWorkflowExecutionFailedEventAttributes() != null)
            sb.append("FailWorkflowExecutionFailedEventAttributes: "
        ...
        if (getCancelWorkflowExecutionFailedEventAttributes() != null)
            sb.append("CancelWorkflowExecutionFailedEventAttributes: "
        ...
        if (getRecordMarkerFailedEventAttributes() != null)
            sb.append("RecordMarkerFailedEventAttributes: "
        ...
        if (getScheduleActivityTaskFailedEventAttributes() != null)
            sb.append("ScheduleActivityTaskFailedEventAttributes: "
        ...
        if (getStartTimerFailedEventAttributes() != null)
            sb.append("StartTimerFailedEventAttributes: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEventTimestamp() == null
                ^ this.getEventTimestamp() == null)
            return false;
        if (other.getEventTimestamp() != null
                && other.getEventTimestamp().equals(this.getEventTimestamp()) == false)
            return false;
        ...
        if (other.getWorkflowExecutionStartedEventAttributes() == null
                ^ this.getWorkflowExecutionStartedEventAttributes() == null)
            return false;
        if (other.getWorkflowExecutionStartedEventAttributes() != null
                && other.getWorkflowExecutionStartedEventAttributes().equals(
                        this.getWorkflowExecutionStartedEventAttributes()) == false)
            return false;
        if (other.getWorkflowExecutionCompletedEventAttributes() == null
                ^ this.getWorkflowExecutionCompletedEventAttributes() == null)
            return false;
        if (other.getWorkflowExecutionCompletedEventAttributes() != null
                && other.getWorkflowExecutionCompletedEventAttributes().equals(
                        this.getWorkflowExecutionCompletedEventAttributes()) == false)
            return false;
        if (other.getCompleteWorkflowExecutionFailedEventAttributes() == null
                ^ this.getCompleteWorkflowExecutionFailedEventAttributes() == null)
            return false;
        if (other.getCompleteWorkflowExecutionFailedEventAttributes() != null
                && other.getCompleteWorkflowExecutionFailedEventAttributes()
                        .equals(this
                                .getCompleteWorkflowExecutionFailedEventAttributes()) == false)
            return false;
        if (other.getWorkflowExecutionFailedEventAttributes() == null
                ^ this.getWorkflowExecutionFailedEventAttributes() == null)
            return false;
        if (other.getWorkflowExecutionFailedEventAttributes() != null
                && other.getWorkflowExecutionFailedEventAttributes().equals(
                        this.getWorkflowExecutionFailedEventAttributes()) == false)
            return false;
        if (other.getFailWorkflowExecutionFailedEventAttributes() == null
                ^ this.getFailWorkflowExecutionFailedEventAttributes() == null)
            return false;
        if (other.getFailWorkflowExecutionFailedEventAttributes() != null
                && other.getFailWorkflowExecutionFailedEventAttributes()
                        .equals(this
                                .getFailWorkflowExecutionFailedEventAttributes()) == false)
            return false;
        if (other.getWorkflowExecutionTimedOutEventAttributes() == null
                ^ this.getWorkflowExecutionTimedOutEventAttributes() == null)
            return false;
        if (other.getWorkflowExecutionTimedOutEventAttributes() != null
                && other.getWorkflowExecutionTimedOutEventAttributes().equals(
                        this.getWorkflowExecutionTimedOutEventAttributes()) == false)
            return false;
        if (other.getWorkflowExecutionCanceledEventAttributes() == null
                ^ this.getWorkflowExecutionCanceledEventAttributes() == null)
            return false;
        if (other.getWorkflowExecutionCanceledEventAttributes() != null
                && other.getWorkflowExecutionCanceledEventAttributes().equals(
                        this.getWorkflowExecutionCanceledEventAttributes()) == false)
            return false;
        if (other.getCancelWorkflowExecutionFailedEventAttributes() == null
                ^ this.getCancelWorkflowExecutionFailedEventAttributes() == null)
            return false;
        if (other.getCancelWorkflowExecutionFailedEventAttributes() != null
                && other.getCancelWorkflowExecutionFailedEventAttributes()
                        .equals(this
                                .getCancelWorkflowExecutionFailedEventAttributes()) == false)
            return false;
        if (other.getWorkflowExecutionContinuedAsNewEventAttributes() == null
                ^ this.getWorkflowExecutionContinuedAsNewEventAttributes() == null)
            return false;
        if (other.getWorkflowExecutionContinuedAsNewEventAttributes() != null
                && other.getWorkflowExecutionContinuedAsNewEventAttributes()
                        .equals(this
                                .getWorkflowExecutionContinuedAsNewEventAttributes()) == false)
            return false;
        if (other.getContinueAsNewWorkflowExecutionFailedEventAttributes() == null
                ^ this.getContinueAsNewWorkflowExecutionFailedEventAttributes() == null)
            return false;
        if (other.getContinueAsNewWorkflowExecutionFailedEventAttributes() != null
                && other.getContinueAsNewWorkflowExecutionFailedEventAttributes()
                        .equals(this
                                .getContinueAsNewWorkflowExecutionFailedEventAttributes()) == false)
            return false;
        if (other.getWorkflowExecutionTerminatedEventAttributes() == null
                ^ this.getWorkflowExecutionTerminatedEventAttributes() == null)
            return false;
        if (other.getWorkflowExecutionTerminatedEventAttributes() != null
                && other.getWorkflowExecutionTerminatedEventAttributes()
                        .equals(this
                                .getWorkflowExecutionTerminatedEventAttributes()) == false)
            return false;
        if (other.getWorkflowExecutionCancelRequestedEventAttributes() == null
                ^ this.getWorkflowExecutionCancelRequestedEventAttributes() == null)
            return false;
        if (other.getWorkflowExecutionCancelRequestedEventAttributes() != null
                && other.getWorkflowExecutionCancelRequestedEventAttributes()
                        .equals(this
                                .getWorkflowExecutionCancelRequestedEventAttributes()) == false)
            return false;
        if (other.getDecisionTaskScheduledEventAttributes() == null
                ^ this.getDecisionTaskScheduledEventAttributes() == null)
            return false;
        if (other.getDecisionTaskScheduledEventAttributes() != null
                && other.getDecisionTaskScheduledEventAttributes().equals(
                        this.getDecisionTaskScheduledEventAttributes()) == false)
            return false;
        if (other.getDecisionTaskStartedEventAttributes() == null
                ^ this.getDecisionTaskStartedEventAttributes() == null)
            return false;
        if (other.getDecisionTaskStartedEventAttributes() != null
                && other.getDecisionTaskStartedEventAttributes().equals(
                        this.getDecisionTaskStartedEventAttributes()) == false)
            return false;
        if (other.getDecisionTaskCompletedEventAttributes() == null
                ^ this.getDecisionTaskCompletedEventAttributes() == null)
            return false;
        if (other.getDecisionTaskCompletedEventAttributes() != null
                && other.getDecisionTaskCompletedEventAttributes().equals(
                        this.getDecisionTaskCompletedEventAttributes()) == false)
            return false;
        if (other.getDecisionTaskTimedOutEventAttributes() == null
                ^ this.getDecisionTaskTimedOutEventAttributes() == null)
            return false;
        if (other.getDecisionTaskTimedOutEventAttributes() != null
                && other.getDecisionTaskTimedOutEventAttributes().equals(
                        this.getDecisionTaskTimedOutEventAttributes()) == false)
            return false;
        if (other.getActivityTaskScheduledEventAttributes() == null
                ^ this.getActivityTaskScheduledEventAttributes() == null)
            return false;
        if (other.getActivityTaskScheduledEventAttributes() != null
                && other.getActivityTaskScheduledEventAttributes().equals(
                        this.getActivityTaskScheduledEventAttributes()) == false)
            return false;
        if (other.getActivityTaskStartedEventAttributes() == null
                ^ this.getActivityTaskStartedEventAttributes() == null)
            return false;
        if (other.getActivityTaskStartedEventAttributes() != null
                && other.getActivityTaskStartedEventAttributes().equals(
                        this.getActivityTaskStartedEventAttributes()) == false)
            return false;
        if (other.getActivityTaskCompletedEventAttributes() == null
                ^ this.getActivityTaskCompletedEventAttributes() == null)
            return false;
        if (other.getActivityTaskCompletedEventAttributes() != null
                && other.getActivityTaskCompletedEventAttributes().equals(
                        this.getActivityTaskCompletedEventAttributes()) == false)
            return false;
        if (other.getActivityTaskFailedEventAttributes() == null
                ^ this.getActivityTaskFailedEventAttributes() == null)
            return false;
        if (other.getActivityTaskFailedEventAttributes() != null
                && other.getActivityTaskFailedEventAttributes().equals(
                        this.getActivityTaskFailedEventAttributes()) == false)
            return false;
        if (other.getActivityTaskTimedOutEventAttributes() == null
                ^ this.getActivityTaskTimedOutEventAttributes() == null)
            return false;
        if (other.getActivityTaskTimedOutEventAttributes() != null
                && other.getActivityTaskTimedOutEventAttributes().equals(
                        this.getActivityTaskTimedOutEventAttributes()) == false)
            return false;
        if (other.getActivityTaskCanceledEventAttributes() == null
                ^ this.getActivityTaskCanceledEventAttributes() == null)
            return false;
        if (other.getActivityTaskCanceledEventAttributes() != null
                && other.getActivityTaskCanceledEventAttributes().equals(
                        this.getActivityTaskCanceledEventAttributes()) == false)
            return false;
        if (other.getActivityTaskCancelRequestedEventAttributes() == null
                ^ this.getActivityTaskCancelRequestedEventAttributes() == null)
            return false;
        if (other.getActivityTaskCancelRequestedEventAttributes() != null
                && other.getActivityTaskCancelRequestedEventAttributes()
                        .equals(this
                                .getActivityTaskCancelRequestedEventAttributes()) == false)
            return false;
        if (other.getWorkflowExecutionSignaledEventAttributes() == null
                ^ this.getWorkflowExecutionSignaledEventAttributes() == null)
            return false;
        if (other.getWorkflowExecutionSignaledEventAttributes() != null
                && other.getWorkflowExecutionSignaledEventAttributes().equals(
                        this.getWorkflowExecutionSignaledEventAttributes()) == false)
            return false;
        if (other.getMarkerRecordedEventAttributes() == null
                ^ this.getMarkerRecordedEventAttributes() == null)
            return false;
        if (other.getMarkerRecordedEventAttributes() != null
                && other.getMarkerRecordedEventAttributes().equals(
                        this.getMarkerRecordedEventAttributes()) == false)
            return false;
        if (other.getRecordMarkerFailedEventAttributes() == null
                ^ this.getRecordMarkerFailedEventAttributes() == null)
            return false;
        if (other.getRecordMarkerFailedEventAttributes() != null
                && other.getRecordMarkerFailedEventAttributes().equals(
                        this.getRecordMarkerFailedEventAttributes()) == false)
            return false;
        if (other.getTimerStartedEventAttributes() == null
                ^ this.getTimerStartedEventAttributes() == null)
            return false;
        if (other.getTimerStartedEventAttributes() != null
                && other.getTimerStartedEventAttributes().equals(
                        this.getTimerStartedEventAttributes()) == false)
            return false;
        if (other.getTimerFiredEventAttributes() == null
                ^ this.getTimerFiredEventAttributes() == null)
            return false;
        if (other.getTimerFiredEventAttributes() != null
                && other.getTimerFiredEventAttributes().equals(
                        this.getTimerFiredEventAttributes()) == false)
            return false;
        if (other.getTimerCanceledEventAttributes() == null
                ^ this.getTimerCanceledEventAttributes() == null)
            return false;
        if (other.getTimerCanceledEventAttributes() != null
                && other.getTimerCanceledEventAttributes().equals(
                        this.getTimerCanceledEventAttributes()) == false)
            return false;
        ...
        if (other.getStartChildWorkflowExecutionInitiatedEventAttributes() != null
                && other.getStartChildWorkflowExecutionInitiatedEventAttributes()
                        .equals(this
                                .getStartChildWorkflowExecutionInitiatedEventAttributes()) == false)
            return false;
        if (other.getChildWorkflowExecutionStartedEventAttributes() == null
                ^ this.getChildWorkflowExecutionStartedEventAttributes() == null)
            return false;
        if (other.getChildWorkflowExecutionStartedEventAttributes() != null
                && other.getChildWorkflowExecutionStartedEventAttributes()
                        .equals(this
                                .getChildWorkflowExecutionStartedEventAttributes()) == false)
            return false;
        if (other.getChildWorkflowExecutionCompletedEventAttributes() == null
                ^ this.getChildWorkflowExecutionCompletedEventAttributes() == null)
            return false;
        if (other.getChildWorkflowExecutionCompletedEventAttributes() != null
                && other.getChildWorkflowExecutionCompletedEventAttributes()
                        .equals(this
                                .getChildWorkflowExecutionCompletedEventAttributes()) == false)
            return false;
        if (other.getChildWorkflowExecutionFailedEventAttributes() == null
                ^ this.getChildWorkflowExecutionFailedEventAttributes() == null)
            return false;
        if (other.getChildWorkflowExecutionFailedEventAttributes() != null
                && other.getChildWorkflowExecutionFailedEventAttributes()
                        .equals(this
                                .getChildWorkflowExecutionFailedEventAttributes()) == false)
            return false;
        if (other.getChildWorkflowExecutionTimedOutEventAttributes() == null
                ^ this.getChildWorkflowExecutionTimedOutEventAttributes() == null)
            return false;
        if (other.getChildWorkflowExecutionTimedOutEventAttributes() != null
                && other.getChildWorkflowExecutionTimedOutEventAttributes()
                        .equals(this
                                .getChildWorkflowExecutionTimedOutEventAttributes()) == false)
            return false;
        if (other.getChildWorkflowExecutionCanceledEventAttributes() == null
                ^ this.getChildWorkflowExecutionCanceledEventAttributes() == null)
            return false;
        if (other.getChildWorkflowExecutionCanceledEventAttributes() != null
                && other.getChildWorkflowExecutionCanceledEventAttributes()
                        .equals(this
                                .getChildWorkflowExecutionCanceledEventAttributes()) == false)
            return false;
        if (other.getChildWorkflowExecutionTerminatedEventAttributes() == null
                ^ this.getChildWorkflowExecutionTerminatedEventAttributes() == null)
            return false;
        if (other.getChildWorkflowExecutionTerminatedEventAttributes() != null
                && other.getChildWorkflowExecutionTerminatedEventAttributes()
                        .equals(this
                                .getChildWorkflowExecutionTerminatedEventAttributes()) == false)
            return false;
        if (other.getSignalExternalWorkflowExecutionInitiatedEventAttributes() == null
            ...
            return false;
        if (other.getSignalExternalWorkflowExecutionInitiatedEventAttributes() != null
                && other.getSignalExternalWorkflowExecutionInitiatedEventAttributes()
                        .equals(this
                                .getSignalExternalWorkflowExecutionInitiatedEventAttributes()) == false)
            return false;
        if (other.getExternalWorkflowExecutionSignaledEventAttributes() == null
                ^ this.getExternalWorkflowExecutionSignaledEventAttributes() == null)
            return false;
        if (other.getExternalWorkflowExecutionSignaledEventAttributes() != null
                && other.getExternalWorkflowExecutionSignaledEventAttributes()
                        .equals(this
                                .getExternalWorkflowExecutionSignaledEventAttributes()) == false)
            return false;
        if (other.getSignalExternalWorkflowExecutionFailedEventAttributes() == null
                ^ this.getSignalExternalWorkflowExecutionFailedEventAttributes() == null)
            return false;
        if (other.getSignalExternalWorkflowExecutionFailedEventAttributes() != null
                && other.getSignalExternalWorkflowExecutionFailedEventAttributes()
                        .equals(this
                                .getSignalExternalWorkflowExecutionFailedEventAttributes()) == false)
            return false;
        if (other.getExternalWorkflowExecutionCancelRequestedEventAttributes() == null
            ...
            return false;
        if (other.getExternalWorkflowExecutionCancelRequestedEventAttributes() != null
                && other.getExternalWorkflowExecutionCancelRequestedEventAttributes()
                        .equals(this
                                .getExternalWorkflowExecutionCancelRequestedEventAttributes()) == false)
            return false;
        if (other
                .getRequestCancelExternalWorkflowExecutionInitiatedEventAttributes() == null
        ...
        if (other
                ...
                && other.getRequestCancelExternalWorkflowExecutionInitiatedEventAttributes()
                        .equals(this
                                .getRequestCancelExternalWorkflowExecutionInitiatedEventAttributes()) == false)
            return false;
        if (other
                .getRequestCancelExternalWorkflowExecutionFailedEventAttributes() == null
        ...
        if (other
                ...
                && other.getRequestCancelExternalWorkflowExecutionFailedEventAttributes()
                        .equals(this
                                .getRequestCancelExternalWorkflowExecutionFailedEventAttributes()) == false)
            return false;
        if (other.getScheduleActivityTaskFailedEventAttributes() == null
                ^ this.getScheduleActivityTaskFailedEventAttributes() == null)
            return false;
        if (other.getScheduleActivityTaskFailedEventAttributes() != null
                && other.getScheduleActivityTaskFailedEventAttributes().equals(
                        this.getScheduleActivityTaskFailedEventAttributes()) == false)
            return false;
        if (other.getRequestCancelActivityTaskFailedEventAttributes() == null
                ^ this.getRequestCancelActivityTaskFailedEventAttributes() == null)
            return false;
        if (other.getRequestCancelActivityTaskFailedEventAttributes() != null
                && other.getRequestCancelActivityTaskFailedEventAttributes()
                        .equals(this
                                .getRequestCancelActivityTaskFailedEventAttributes()) == false)
            return false;
        if (other.getStartTimerFailedEventAttributes() == null
                ^ this.getStartTimerFailedEventAttributes() == null)
            return false;
        if (other.getStartTimerFailedEventAttributes() != null
                && other.getStartTimerFailedEventAttributes().equals(
                        this.getStartTimerFailedEventAttributes()) == false)
            return false;
        if (other.getCancelTimerFailedEventAttributes() == null
                ^ this.getCancelTimerFailedEventAttributes() == null)
            return false;
        if (other.getCancelTimerFailedEventAttributes() != null
                && other.getCancelTimerFailedEventAttributes().equals(
                        this.getCancelTimerFailedEventAttributes()) == false)
            return false;
        if (other.getStartChildWorkflowExecutionFailedEventAttributes() == null
                ^ this.getStartChildWorkflowExecutionFailedEventAttributes() == null)
            return false;
        if (other.getStartChildWorkflowExecutionFailedEventAttributes() != null
                && other.getStartChildWorkflowExecutionFailedEventAttributes()
                        .equals(this
                                .getStartChildWorkflowExecutionFailedEventAttributes()) == false)
            return false;
        if (other.getLambdaFunctionScheduledEventAttributes() == null
                ^ this.getLambdaFunctionScheduledEventAttributes() == null)
            return false;
        if (other.getLambdaFunctionScheduledEventAttributes() != null
                && other.getLambdaFunctionScheduledEventAttributes().equals(
                        this.getLambdaFunctionScheduledEventAttributes()) == false)
            return false;
        if (other.getLambdaFunctionStartedEventAttributes() == null
                ^ this.getLambdaFunctionStartedEventAttributes() == null)
            return false;
        if (other.getLambdaFunctionStartedEventAttributes() != null
                && other.getLambdaFunctionStartedEventAttributes().equals(
                        this.getLambdaFunctionStartedEventAttributes()) == false)
            return false;
        if (other.getLambdaFunctionCompletedEventAttributes() == null
                ^ this.getLambdaFunctionCompletedEventAttributes() == null)
            return false;
        if (other.getLambdaFunctionCompletedEventAttributes() != null
                && other.getLambdaFunctionCompletedEventAttributes().equals(
                        this.getLambdaFunctionCompletedEventAttributes()) == false)
            return false;
        if (other.getLambdaFunctionFailedEventAttributes() == null
                ^ this.getLambdaFunctionFailedEventAttributes() == null)
            return false;
        if (other.getLambdaFunctionFailedEventAttributes() != null
                && other.getLambdaFunctionFailedEventAttributes().equals(
                        this.getLambdaFunctionFailedEventAttributes()) == false)
            return false;
        if (other.getLambdaFunctionTimedOutEventAttributes() == null
                ^ this.getLambdaFunctionTimedOutEventAttributes() == null)
            return false;
        if (other.getLambdaFunctionTimedOutEventAttributes() != null
                && other.getLambdaFunctionTimedOutEventAttributes().equals(
                        this.getLambdaFunctionTimedOutEventAttributes()) == false)
            return false;
        if (other.getScheduleLambdaFunctionFailedEventAttributes() == null
                ^ this.getScheduleLambdaFunctionFailedEventAttributes() == null)
            return false;
        if (other.getScheduleLambdaFunctionFailedEventAttributes() != null
                && other.getScheduleLambdaFunctionFailedEventAttributes()
                        .equals(this
                                .getScheduleLambdaFunctionFailedEventAttributes()) == false)
            return false;
        ...
        if (other.getStartLambdaFunctionFailedEventAttributes() != null
                && other.getStartLambdaFunctionFailedEventAttributes().equals(
                        this.getStartLambdaFunctionFailedEventAttributes()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getEventTimestamp() == null) ? 0 : getEventTimestamp()
                        .hashCode());
        ...
        hashCode = prime
                * hashCode
                + ((getWorkflowExecutionStartedEventAttributes() == null) ? 0
                        : getWorkflowExecutionStartedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getWorkflowExecutionCompletedEventAttributes() == null) ? 0
                        : getWorkflowExecutionCompletedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getCompleteWorkflowExecutionFailedEventAttributes() == null) ? 0
                        : getCompleteWorkflowExecutionFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getWorkflowExecutionFailedEventAttributes() == null) ? 0
                        : getWorkflowExecutionFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getFailWorkflowExecutionFailedEventAttributes() == null) ? 0
                        : getFailWorkflowExecutionFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getWorkflowExecutionTimedOutEventAttributes() == null) ? 0
                        : getWorkflowExecutionTimedOutEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getWorkflowExecutionCanceledEventAttributes() == null) ? 0
                        : getWorkflowExecutionCanceledEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getCancelWorkflowExecutionFailedEventAttributes() == null) ? 0
                        : getCancelWorkflowExecutionFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getWorkflowExecutionContinuedAsNewEventAttributes() == null) ? 0
                        : getWorkflowExecutionContinuedAsNewEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getContinueAsNewWorkflowExecutionFailedEventAttributes() == null) ? 0
                        : getContinueAsNewWorkflowExecutionFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getWorkflowExecutionTerminatedEventAttributes() == null) ? 0
                        : getWorkflowExecutionTerminatedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getWorkflowExecutionCancelRequestedEventAttributes() == null) ? 0
                        : getWorkflowExecutionCancelRequestedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getDecisionTaskScheduledEventAttributes() == null) ? 0
                        : getDecisionTaskScheduledEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getDecisionTaskStartedEventAttributes() == null) ? 0
                        : getDecisionTaskStartedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getDecisionTaskCompletedEventAttributes() == null) ? 0
                        : getDecisionTaskCompletedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getDecisionTaskTimedOutEventAttributes() == null) ? 0
                        : getDecisionTaskTimedOutEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getActivityTaskScheduledEventAttributes() == null) ? 0
                        : getActivityTaskScheduledEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getActivityTaskStartedEventAttributes() == null) ? 0
                        : getActivityTaskStartedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getActivityTaskCompletedEventAttributes() == null) ? 0
                        : getActivityTaskCompletedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getActivityTaskFailedEventAttributes() == null) ? 0
                        : getActivityTaskFailedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getActivityTaskTimedOutEventAttributes() == null) ? 0
                        : getActivityTaskTimedOutEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getActivityTaskCanceledEventAttributes() == null) ? 0
                        : getActivityTaskCanceledEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getActivityTaskCancelRequestedEventAttributes() == null) ? 0
                        : getActivityTaskCancelRequestedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getWorkflowExecutionSignaledEventAttributes() == null) ? 0
                        : getWorkflowExecutionSignaledEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getMarkerRecordedEventAttributes() == null) ? 0
                        : getMarkerRecordedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getRecordMarkerFailedEventAttributes() == null) ? 0
                        : getRecordMarkerFailedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getTimerStartedEventAttributes() == null) ? 0
                        : getTimerStartedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getTimerFiredEventAttributes() == null) ? 0
                        : getTimerFiredEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getTimerCanceledEventAttributes() == null) ? 0
                        : getTimerCanceledEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getStartChildWorkflowExecutionInitiatedEventAttributes() == null) ? 0
                        : getStartChildWorkflowExecutionInitiatedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getChildWorkflowExecutionStartedEventAttributes() == null) ? 0
                        : getChildWorkflowExecutionStartedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getChildWorkflowExecutionCompletedEventAttributes() == null) ? 0
                        : getChildWorkflowExecutionCompletedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getChildWorkflowExecutionFailedEventAttributes() == null) ? 0
                        : getChildWorkflowExecutionFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getChildWorkflowExecutionTimedOutEventAttributes() == null) ? 0
                        : getChildWorkflowExecutionTimedOutEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getChildWorkflowExecutionCanceledEventAttributes() == null) ? 0
                        : getChildWorkflowExecutionCanceledEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getChildWorkflowExecutionTerminatedEventAttributes() == null) ? 0
                        : getChildWorkflowExecutionTerminatedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getSignalExternalWorkflowExecutionInitiatedEventAttributes() == null) ? 0
                        : getSignalExternalWorkflowExecutionInitiatedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getExternalWorkflowExecutionSignaledEventAttributes() == null) ? 0
                        : getExternalWorkflowExecutionSignaledEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getSignalExternalWorkflowExecutionFailedEventAttributes() == null) ? 0
                        : getSignalExternalWorkflowExecutionFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getExternalWorkflowExecutionCancelRequestedEventAttributes() == null) ? 0
                        : getExternalWorkflowExecutionCancelRequestedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
        ...
        hashCode = prime
                * hashCode
                + ((getScheduleActivityTaskFailedEventAttributes() == null) ? 0
                        : getScheduleActivityTaskFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getRequestCancelActivityTaskFailedEventAttributes() == null) ? 0
                        : getRequestCancelActivityTaskFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getStartTimerFailedEventAttributes() == null) ? 0
                        : getStartTimerFailedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getCancelTimerFailedEventAttributes() == null) ? 0
                        : getCancelTimerFailedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getStartChildWorkflowExecutionFailedEventAttributes() == null) ? 0
                        : getStartChildWorkflowExecutionFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getLambdaFunctionScheduledEventAttributes() == null) ? 0
                        : getLambdaFunctionScheduledEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getLambdaFunctionStartedEventAttributes() == null) ? 0
                        : getLambdaFunctionStartedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getLambdaFunctionCompletedEventAttributes() == null) ? 0
                        : getLambdaFunctionCompletedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getLambdaFunctionFailedEventAttributes() == null) ? 0
                        : getLambdaFunctionFailedEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getLambdaFunctionTimedOutEventAttributes() == null) ? 0
                        : getLambdaFunctionTimedOutEventAttributes().hashCode());
        hashCode = prime
                * hashCode
                + ((getScheduleLambdaFunctionFailedEventAttributes() == null) ? 0
                        : getScheduleLambdaFunctionFailedEventAttributes()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getStartLambdaFunctionFailedEventAttributes() == null) ? 0
                        : getStartLambdaFunctionFailedEventAttributes()
                                .hashCode());
        return hashCode;
    }
