...
public class TypeDeprecatedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TypeDeprecatedExceptionUnmarshaller instance;

    public static TypeDeprecatedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TypeDeprecatedExceptionUnmarshaller();
        return instance;
    }
}
