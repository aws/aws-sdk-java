 ...
 */
public class WorkflowExecutionInfosJsonUnmarshaller implements
        Unmarshaller<WorkflowExecutionInfos, JsonUnmarshallerContext> {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("executionInfos", targetDepth)) {
                    ...
                    workflowExecutionInfos
                            .setExecutionInfos(new ListUnmarshaller<WorkflowExecutionInfo>(
                                    WorkflowExecutionInfoJsonUnmarshaller
                                            .getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextPageToken", targetDepth)) {
                    context.nextToken();
                    workflowExecutionInfos.setNextPageToken(context
    ...
    public static WorkflowExecutionInfosJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new WorkflowExecutionInfosJsonUnmarshaller();
        return instance;
    }
}
