...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param resourceArn
     *        The ARN of the CloudWatch Logs resource that you're removing tags from.</p>
     *        <p>
     *        The ARN format of a log group is
     *        <code>arn:aws:logs:<i>Region</i>:<i>account-id</i>:log-group:<i>log-group-name</i> </code>
     *        </p>
     ...
     * </p>
     * 
     * @return The ARN of the CloudWatch Logs resource that you're removing tags from.</p>
     *         <p>
     *         The ARN format of a log group is
     *         <code>arn:aws:logs:<i>Region</i>:<i>account-id</i>:log-group:<i>log-group-name</i> </code>
     *         </p>
