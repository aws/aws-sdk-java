 ...
 */
public class GetLogEventsResultJsonUnmarshaller implements
        Unmarshaller<GetLogEventsResult, JsonUnmarshallerContext> {

    public GetLogEventsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("events", targetDepth)) {
                    context.nextToken();
                    getLogEventsResult
                            .setEvents(new ListUnmarshaller<OutputLogEvent>(
