...
public class DescribeExportTasksResultJsonUnmarshaller implements
    ...
    public DescribeExportTasksResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("exportTasks", targetDepth)) {
                    ...
                    describeExportTasksResult
                            .setExportTasks(new ListUnmarshaller<ExportTask>(
                                    ExportTaskJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeExportTasksResult.setNextToken(context
