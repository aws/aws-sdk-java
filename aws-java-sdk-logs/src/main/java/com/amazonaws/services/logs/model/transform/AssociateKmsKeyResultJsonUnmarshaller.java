...
/**
 * AssociateKmsKeyResult JSON Unmarshaller
 */
...
public class AssociateKmsKeyResultJsonUnmarshaller implements Unmarshaller<AssociateKmsKeyResult, JsonUnmarshallerContext> {
    ...
    public AssociateKmsKeyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateKmsKeyResult associateKmsKeyResult = new AssociateKmsKeyResult();
