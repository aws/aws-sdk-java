...
public class GetDeliveryResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A structure that contains information about the delivery.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDeliveryResult == false)
            return false;
        GetDeliveryResult other = (GetDeliveryResult) obj;
    ...
    @Override
    public GetDeliveryResult clone() {
        try {
            return (GetDeliveryResult) super.clone();
