...
public class PutDataProtectionPolicyRequestMarshaller {
    ...
    private static final PutDataProtectionPolicyRequestMarshaller instance = new PutDataProtectionPolicyRequestMarshaller();

    public static PutDataProtectionPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutDataProtectionPolicyRequest putDataProtectionPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putDataProtectionPolicyRequest.getLogGroupIdentifier(), LOGGROUPIDENTIFIER_BINDING);
            protocolMarshaller.marshall(putDataProtectionPolicyRequest.getPolicyDocument(), POLICYDOCUMENT_BINDING);
        } catch (Exception e) {
