...
/**
 * PutQueryDefinitionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PutQueryDefinitionResultJsonUnmarshaller implements Unmarshaller<PutQueryDefinitionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("queryDefinitionId", targetDepth)) {
                    context.nextToken();
                    putQueryDefinitionResult.setQueryDefinitionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
