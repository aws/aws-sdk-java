...
public class DeleteRetentionPolicyRequestMarshaller {
    ...
    private static final DeleteRetentionPolicyRequestMarshaller instance = new DeleteRetentionPolicyRequestMarshaller();

    public static DeleteRetentionPolicyRequestMarshaller getInstance() {
        return instance;
    }
