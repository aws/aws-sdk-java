 ...
 */
public class DescribeDestinationsResultJsonUnmarshaller implements
        Unmarshaller<DescribeDestinationsResult, JsonUnmarshallerContext> {

    public DescribeDestinationsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("destinations", targetDepth)) {
                    ...
                    describeDestinationsResult
                            .setDestinations(new ListUnmarshaller<Destination>(
                                    DestinationJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeDestinationsResult.setNextToken(context
