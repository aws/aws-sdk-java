...
/**
 * Describe Subscription Filters Request Marshaller
 */
public class DescribeSubscriptionFiltersRequestMarshaller implements Marshaller<Request<DescribeSubscriptionFiltersRequest>, DescribeSubscriptionFiltersRequest> {
    ...
    public Request<DescribeSubscriptionFiltersRequest> marshall(DescribeSubscriptionFiltersRequest describeSubscriptionFiltersRequest) {
        ...
        Request<DescribeSubscriptionFiltersRequest> request = new DefaultRequest<DescribeSubscriptionFiltersRequest>(describeSubscriptionFiltersRequest, "AWSLogs");
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (describeSubscriptionFiltersRequest.getLogGroupName() != null) {
                jsonWriter.key("logGroupName").value(describeSubscriptionFiltersRequest.getLogGroupName());
            }
            if (describeSubscriptionFiltersRequest.getFilterNamePrefix() != null) {
                jsonWriter.key("filterNamePrefix").value(describeSubscriptionFiltersRequest.getFilterNamePrefix());
            }
            if (describeSubscriptionFiltersRequest.getNextToken() != null) {
                jsonWriter.key("nextToken").value(describeSubscriptionFiltersRequest.getNextToken());
            }
            if (describeSubscriptionFiltersRequest.getLimit() != null) {
                jsonWriter.key("limit").value(describeSubscriptionFiltersRequest.getLimit());
            }
