...
public class PutDeliveryDestinationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A structure containing information about the delivery destination that you just created or updated.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutDeliveryDestinationResult == false)
            return false;
        PutDeliveryDestinationResult other = (PutDeliveryDestinationResult) obj;
    ...
    public PutDeliveryDestinationResult clone() {
        try {
            return (PutDeliveryDestinationResult) super.clone();
