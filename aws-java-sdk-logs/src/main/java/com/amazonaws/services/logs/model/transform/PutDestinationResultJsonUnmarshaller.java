...
/**
 * Put Destination Result JSON Unmarshaller
 */
public class PutDestinationResultJsonUnmarshaller implements Unmarshaller<PutDestinationResult, JsonUnmarshallerContext> {

    public PutDestinationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("destination", targetDepth)) {
                    context.nextToken();
                    putDestinationResult.setDestination(DestinationJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static PutDestinationResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PutDestinationResultJsonUnmarshaller();
        return instance;
    }
}
