 ...
 */
public class PutDestinationResultJsonUnmarshaller implements
        Unmarshaller<PutDestinationResult, JsonUnmarshallerContext> {

    public PutDestinationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("destination", targetDepth)) {
                    ...
                    putDestinationResult
                            .setDestination(DestinationJsonUnmarshaller
