...
/**
 * DeleteDataProtectionPolicyResult JSON Unmarshaller
 */
...
public class DeleteDataProtectionPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteDataProtectionPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteDataProtectionPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDataProtectionPolicyResult deleteDataProtectionPolicyResult = new DeleteDataProtectionPolicyResult();

        return deleteDataProtectionPolicyResult;
    }
