 ...
 */
public class CreateLogStreamResultJsonUnmarshaller implements
        Unmarshaller<CreateLogStreamResult, JsonUnmarshallerContext> {

    public CreateLogStreamResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
