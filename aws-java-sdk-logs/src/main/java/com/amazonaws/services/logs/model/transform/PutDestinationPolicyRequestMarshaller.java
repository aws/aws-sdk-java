...
/**
 * Put Destination Policy Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (putDestinationPolicyRequest.getDestinationName() != null) {
                jsonWriter.key("destinationName").value(putDestinationPolicyRequest.getDestinationName());
            }
            if (putDestinationPolicyRequest.getAccessPolicy() != null) {
                jsonWriter.key("accessPolicy").value(putDestinationPolicyRequest.getAccessPolicy());
            }
