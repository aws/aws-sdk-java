...
/**
 * TagLogGroupResult JSON Unmarshaller
 */
...
public class TagLogGroupResultJsonUnmarshaller implements Unmarshaller<TagLogGroupResult, JsonUnmarshallerContext> {
    ...
    public TagLogGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        TagLogGroupResult tagLogGroupResult = new TagLogGroupResult();
