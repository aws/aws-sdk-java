 ...
 */
public class CreateLogGroupResultJsonUnmarshaller implements
        Unmarshaller<CreateLogGroupResult, JsonUnmarshallerContext> {

    public CreateLogGroupResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
