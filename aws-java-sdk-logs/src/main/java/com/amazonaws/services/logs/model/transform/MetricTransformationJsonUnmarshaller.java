...
/**
 * Metric Transformation JSON Unmarshaller
 */
public class MetricTransformationJsonUnmarshaller implements Unmarshaller<MetricTransformation, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("metricName", targetDepth)) {
                    context.nextToken();
                    metricTransformation.setMetricName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("metricNamespace", targetDepth)) {
                    context.nextToken();
                    metricTransformation.setMetricNamespace(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("metricValue", targetDepth)) {
                    context.nextToken();
                    metricTransformation.setMetricValue(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static MetricTransformationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new MetricTransformationJsonUnmarshaller();
        return instance;
    }
}
