        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("logGroupClass", targetDepth)) {
                    context.nextToken();
                    logGroup.setLogGroupClass(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("logGroupArn", targetDepth)) {
                    context.nextToken();
                    logGroup.setLogGroupArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
