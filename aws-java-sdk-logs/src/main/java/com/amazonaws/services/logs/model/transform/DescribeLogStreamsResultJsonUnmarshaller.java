 ...
 */
public class DescribeLogStreamsResultJsonUnmarshaller implements
        Unmarshaller<DescribeLogStreamsResult, JsonUnmarshallerContext> {

    public DescribeLogStreamsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("logStreams", targetDepth)) {
                    ...
                    describeLogStreamsResult
                            .setLogStreams(new ListUnmarshaller<LogStream>(
                                    LogStreamJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeLogStreamsResult.setNextToken(context
