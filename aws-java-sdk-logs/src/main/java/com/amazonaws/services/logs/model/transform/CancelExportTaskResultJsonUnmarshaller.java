 ...
 */
public class CancelExportTaskResultJsonUnmarshaller implements
        Unmarshaller<CancelExportTaskResult, JsonUnmarshallerContext> {

    public CancelExportTaskResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
