 ...
 */
public class PutSubscriptionFilterResultJsonUnmarshaller implements
        Unmarshaller<PutSubscriptionFilterResult, JsonUnmarshallerContext> {

    public PutSubscriptionFilterResult unmarshall(
            JsonUnmarshallerContext context) throws Exception {
        PutSubscriptionFilterResult putSubscriptionFilterResult = new PutSubscriptionFilterResult();
