...
public class DestinationJsonUnmarshaller implements Unmarshaller<Destination, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("destinationName", targetDepth)) {
                    context.nextToken();
                    destination.setDestinationName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("accessPolicy", targetDepth)) {
                    context.nextToken();
                    destination.setAccessPolicy(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DestinationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DestinationJsonUnmarshaller();
        return instance;
    }
}
