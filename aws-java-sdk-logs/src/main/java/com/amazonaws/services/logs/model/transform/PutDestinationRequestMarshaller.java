...
/**
 * Put Destination Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (putDestinationRequest.getDestinationName() != null) {
                jsonWriter.key("destinationName").value(putDestinationRequest.getDestinationName());
            }
            if (putDestinationRequest.getTargetArn() != null) {
                jsonWriter.key("targetArn").value(putDestinationRequest.getTargetArn());
            }
            if (putDestinationRequest.getRoleArn() != null) {
                jsonWriter.key("roleArn").value(putDestinationRequest.getRoleArn());
            }
