 ...
 */
public class DeleteSubscriptionFilterResultJsonUnmarshaller implements
        Unmarshaller<DeleteSubscriptionFilterResult, JsonUnmarshallerContext> {

    public DeleteSubscriptionFilterResult unmarshall(
