    ...
    public void marshall(ExportTaskExecutionInfo exportTaskExecutionInfo, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (exportTaskExecutionInfo.getCreationTime() != null) {
                jsonGenerator.writeFieldName("creationTime").writeValue(exportTaskExecutionInfo.getCreationTime());
            }
            if (exportTaskExecutionInfo.getCompletionTime() != null) {
                jsonGenerator.writeFieldName("completionTime").writeValue(exportTaskExecutionInfo.getCompletionTime());
            }
