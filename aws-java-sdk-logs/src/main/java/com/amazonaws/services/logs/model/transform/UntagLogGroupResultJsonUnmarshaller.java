...
/**
 * UntagLogGroupResult JSON Unmarshaller
 */
...
public class UntagLogGroupResultJsonUnmarshaller implements Unmarshaller<UntagLogGroupResult, JsonUnmarshallerContext> {
    ...
    public UntagLogGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UntagLogGroupResult untagLogGroupResult = new UntagLogGroupResult();
