...
public class DescribeLogGroupsResultJsonUnmarshaller implements
    ...
    public DescribeLogGroupsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("logGroups", targetDepth)) {
                    ...
                    describeLogGroupsResult
                            .setLogGroups(new ListUnmarshaller<LogGroup>(
                                    LogGroupJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeLogGroupsResult.setNextToken(StringJsonUnmarshaller
