...
/**
 * LogGroupField JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LogGroupFieldJsonUnmarshaller implements Unmarshaller<LogGroupField, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    logGroupField.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("percent", targetDepth)) {
                    context.nextToken();
                    logGroupField.setPercent(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
