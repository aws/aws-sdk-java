 ...
 */
public class DescribeSubscriptionFiltersResultJsonUnmarshaller
        implements
        Unmarshaller<DescribeSubscriptionFiltersResult, JsonUnmarshallerContext> {

    public DescribeSubscriptionFiltersResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeSubscriptionFiltersResult.setNextToken(context
