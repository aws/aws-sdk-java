 ...
 */
public class RejectedLogEventsInfoJsonUnmarshaller implements
        Unmarshaller<RejectedLogEventsInfo, JsonUnmarshallerContext> {
    ...
    public RejectedLogEventsInfo unmarshall(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("tooNewLogEventStartIndex",
                        targetDepth)) {
                    context.nextToken();
