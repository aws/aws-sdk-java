...
public class FilterLogEventsResultJsonUnmarshaller implements
    ...
    public FilterLogEventsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("events", targetDepth)) {
                    ...
                    filterLogEventsResult
                            .setEvents(new ListUnmarshaller<FilteredLogEvent>(
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    filterLogEventsResult.setNextToken(context.getUnmarshaller(
