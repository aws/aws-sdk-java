...
public class SelectAttributesActivity implements Serializable, Cloneable, StructuredPojo {
    ...
    public SelectAttributesActivity withAttributes(java.util.Collection<String> attributes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SelectAttributesActivity == false)
            return false;
    ...
    @Override
    public SelectAttributesActivity clone() {
        try {
            return (SelectAttributesActivity) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotanalytics.model.transform.SelectAttributesActivityMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
