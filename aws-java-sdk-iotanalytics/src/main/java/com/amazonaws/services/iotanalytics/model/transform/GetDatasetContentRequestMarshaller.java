...
public class GetDatasetContentRequestMarshaller {
    ...
    private static final GetDatasetContentRequestMarshaller instance = new GetDatasetContentRequestMarshaller();

    public static GetDatasetContentRequestMarshaller getInstance() {
        return instance;
    }
