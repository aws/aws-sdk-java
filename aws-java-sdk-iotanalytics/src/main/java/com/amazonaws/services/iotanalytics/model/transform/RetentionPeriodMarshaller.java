...
public class RetentionPeriodMarshaller {
    ...
    private static final MarshallingInfo<Integer> NUMBEROFDAYS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("numberOfDays").build();
    ...
    public void marshall(RetentionPeriod retentionPeriod, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(retentionPeriod.getUnlimited(), UNLIMITED_BINDING);
            protocolMarshaller.marshall(retentionPeriod.getNumberOfDays(), NUMBEROFDAYS_BINDING);
        } catch (Exception e) {
