        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("creationTime", targetDepth)) {
                    context.nextToken();
                    datastore.setCreationTime(context.getUnmarshaller(java.util.Date.class).unmarshall(context));
                }
                if (context.testExpression("lastUpdateTime", targetDepth)) {
                    context.nextToken();
                    datastore.setLastUpdateTime(context.getUnmarshaller(java.util.Date.class).unmarshall(context));
                }
