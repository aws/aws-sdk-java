...
public class TimestampPartition implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimestampPartition == false)
            return false;
    ...
    public TimestampPartition clone() {
        try {
            return (TimestampPartition) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotanalytics.model.transform.TimestampPartitionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
