...
/**
 * CancelPipelineReprocessingResult JSON Unmarshaller
 */
...
public class CancelPipelineReprocessingResultJsonUnmarshaller implements Unmarshaller<CancelPipelineReprocessingResult, JsonUnmarshallerContext> {
    ...
    public CancelPipelineReprocessingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelPipelineReprocessingResult cancelPipelineReprocessingResult = new CancelPipelineReprocessingResult();
