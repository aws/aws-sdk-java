...
public class AgentConfigurationStatusJsonMarshaller {
     ...
     */
    public void marshall(AgentConfigurationStatus agentConfigurationStatus,
        ...
        try {
            ...
            if (agentConfigurationStatus.getAgentId() != null) {
                jsonGenerator.writeFieldName("agentId").writeValue(
                        agentConfigurationStatus.getAgentId());
            }
            if (agentConfigurationStatus.getOperationSucceeded() != null) {
                jsonGenerator.writeFieldName("operationSucceeded").writeValue(
                        agentConfigurationStatus.getOperationSucceeded());
            }
            if (agentConfigurationStatus.getDescription() != null) {
                jsonGenerator.writeFieldName("description").writeValue(
                        agentConfigurationStatus.getDescription());
            }
