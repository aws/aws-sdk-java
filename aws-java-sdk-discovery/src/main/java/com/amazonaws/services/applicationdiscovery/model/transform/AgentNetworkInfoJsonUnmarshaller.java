 ...
 */
public class AgentNetworkInfoJsonUnmarshaller implements
        Unmarshaller<AgentNetworkInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ipAddress", targetDepth)) {
                    context.nextToken();
                    agentNetworkInfo.setIpAddress(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("macAddress", targetDepth)) {
                    context.nextToken();
                    agentNetworkInfo.setMacAddress(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
