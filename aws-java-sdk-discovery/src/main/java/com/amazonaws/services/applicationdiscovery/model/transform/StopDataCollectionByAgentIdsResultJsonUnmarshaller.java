 ...
 */
public class StopDataCollectionByAgentIdsResultJsonUnmarshaller
        implements
        Unmarshaller<StopDataCollectionByAgentIdsResult, JsonUnmarshallerContext> {

    public StopDataCollectionByAgentIdsResult unmarshall(
