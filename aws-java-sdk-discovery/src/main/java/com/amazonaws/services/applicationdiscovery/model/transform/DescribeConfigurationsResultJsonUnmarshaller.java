 ...
 */
public class DescribeConfigurationsResultJsonUnmarshaller implements
        Unmarshaller<DescribeConfigurationsResult, JsonUnmarshallerContext> {

    public DescribeConfigurationsResult unmarshall(
