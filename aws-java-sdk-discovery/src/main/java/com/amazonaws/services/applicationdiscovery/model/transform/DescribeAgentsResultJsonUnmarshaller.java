 ...
 */
public class DescribeAgentsResultJsonUnmarshaller implements
        Unmarshaller<DescribeAgentsResult, JsonUnmarshallerContext> {

    public DescribeAgentsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("agentsInfo", targetDepth)) {
                    ...
                    describeAgentsResult
                            .setAgentsInfo(new ListUnmarshaller<AgentInfo>(
                                    AgentInfoJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeAgentsResult.setNextToken(context.getUnmarshaller(
