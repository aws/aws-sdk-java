...
public class DeleteTagsRequestMarshaller {
    ...
    public void marshall(DeleteTagsRequest deleteTagsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteTagsRequest.getConfigurationIds(), CONFIGURATIONIDS_BINDING);
            protocolMarshaller.marshall(deleteTagsRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
