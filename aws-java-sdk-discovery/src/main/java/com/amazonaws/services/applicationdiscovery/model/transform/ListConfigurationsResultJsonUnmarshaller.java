...
public class ListConfigurationsResultJsonUnmarshaller implements
    ...
    public ListConfigurationsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("configurations", targetDepth)) {
                    ...
                    listConfigurationsResult
                            .setConfigurations(new ListUnmarshaller<java.util.Map<String, String>>(
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listConfigurationsResult.setNextToken(context
