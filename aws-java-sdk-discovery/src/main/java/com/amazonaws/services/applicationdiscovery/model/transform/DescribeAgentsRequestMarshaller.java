 ...
 */
public class DescribeAgentsRequestMarshaller implements
        Marshaller<Request<DescribeAgentsRequest>, DescribeAgentsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeAgentsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeAgentsRequest> marshall(
        ...
        Request<DescribeAgentsRequest> request = new DefaultRequest<DescribeAgentsRequest>(
                describeAgentsRequest, "AWSApplicationDiscovery");
        ...
        try {
            ...
            java.util.List<String> agentIdsList = describeAgentsRequest
                    .getAgentIds();
            ...
            if (describeAgentsRequest.getMaxResults() != null) {
                jsonGenerator.writeFieldName("maxResults").writeValue(
                        describeAgentsRequest.getMaxResults());
            }
            if (describeAgentsRequest.getNextToken() != null) {
                jsonGenerator.writeFieldName("nextToken").writeValue(
                        describeAgentsRequest.getNextToken());
            }
