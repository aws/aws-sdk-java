...
public class DescribeExportConfigurationsRequestMarshaller
    ...
    public DescribeExportConfigurationsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeExportConfigurationsRequest> marshall(
        ...
        Request<DescribeExportConfigurationsRequest> request = new DefaultRequest<DescribeExportConfigurationsRequest>(
                describeExportConfigurationsRequest, "AWSApplicationDiscovery");
        ...
        try {
            ...
            java.util.List<String> exportIdsList = describeExportConfigurationsRequest
                    .getExportIds();
            ...
            if (describeExportConfigurationsRequest.getMaxResults() != null) {
                jsonGenerator.writeFieldName("maxResults").writeValue(
                        describeExportConfigurationsRequest.getMaxResults());
            }
            if (describeExportConfigurationsRequest.getNextToken() != null) {
                jsonGenerator.writeFieldName("nextToken").writeValue(
                        describeExportConfigurationsRequest.getNextToken());
            }
