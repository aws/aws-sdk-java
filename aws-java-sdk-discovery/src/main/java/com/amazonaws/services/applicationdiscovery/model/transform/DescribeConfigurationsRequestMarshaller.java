...
public class DescribeConfigurationsRequestMarshaller
        implements
        Marshaller<Request<DescribeConfigurationsRequest>, DescribeConfigurationsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeConfigurationsRequestMarshaller(
    ...
    public Request<DescribeConfigurationsRequest> marshall(
        ...
        Request<DescribeConfigurationsRequest> request = new DefaultRequest<DescribeConfigurationsRequest>(
        ...
        try {
            ...
            java.util.List<String> configurationIdsList = describeConfigurationsRequest
                    .getConfigurationIds();
