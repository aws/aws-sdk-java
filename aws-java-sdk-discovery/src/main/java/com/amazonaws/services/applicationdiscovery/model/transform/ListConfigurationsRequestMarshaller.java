...
public class ListConfigurationsRequestMarshaller
    ...
    public ListConfigurationsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<ListConfigurationsRequest> marshall(
        ...
        Request<ListConfigurationsRequest> request = new DefaultRequest<ListConfigurationsRequest>(
                listConfigurationsRequest, "AWSApplicationDiscovery");
        ...
        try {
            ...
            if (listConfigurationsRequest.getConfigurationType() != null) {
                jsonGenerator.writeFieldName("configurationType").writeValue(
                        listConfigurationsRequest.getConfigurationType());
            }

            java.util.List<Filter> filtersList = listConfigurationsRequest
                    .getFilters();
            if (filtersList != null) {
            ...
            if (listConfigurationsRequest.getMaxResults() != null) {
                jsonGenerator.writeFieldName("maxResults").writeValue(
                        listConfigurationsRequest.getMaxResults());
            }
            if (listConfigurationsRequest.getNextToken() != null) {
                jsonGenerator.writeFieldName("nextToken").writeValue(
                        listConfigurationsRequest.getNextToken());
            }
