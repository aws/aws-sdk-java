...
public class ConfigurationTagJsonMarshaller {
     ...
     */
    public void marshall(ConfigurationTag configurationTag,
        ...
        try {
            ...
            if (configurationTag.getConfigurationType() != null) {
                jsonGenerator.writeFieldName("configurationType").writeValue(
                        configurationTag.getConfigurationType());
            }
            if (configurationTag.getConfigurationId() != null) {
                jsonGenerator.writeFieldName("configurationId").writeValue(
                        configurationTag.getConfigurationId());
            }
            if (configurationTag.getKey() != null) {
                jsonGenerator.writeFieldName("key").writeValue(
                        configurationTag.getKey());
            }
            if (configurationTag.getValue() != null) {
                jsonGenerator.writeFieldName("value").writeValue(
                        configurationTag.getValue());
            }
            if (configurationTag.getTimeOfCreation() != null) {
                jsonGenerator.writeFieldName("timeOfCreation").writeValue(
                        configurationTag.getTimeOfCreation());
            }
