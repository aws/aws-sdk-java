...
public class AgentNetworkInfoMarshaller {
    ...
    public void marshall(AgentNetworkInfo agentNetworkInfo, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(agentNetworkInfo.getIpAddress(), IPADDRESS_BINDING);
            protocolMarshaller.marshall(agentNetworkInfo.getMacAddress(), MACADDRESS_BINDING);
        } catch (Exception e) {
