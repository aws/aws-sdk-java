...
public class StartDataCollectionByAgentIdsRequestMarshaller
    ...
    public StartDataCollectionByAgentIdsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<StartDataCollectionByAgentIdsRequest> marshall(
        ...
        Request<StartDataCollectionByAgentIdsRequest> request = new DefaultRequest<StartDataCollectionByAgentIdsRequest>(
                startDataCollectionByAgentIdsRequest, "AWSApplicationDiscovery");
        ...
        try {
            ...
            java.util.List<String> agentIdsList = startDataCollectionByAgentIdsRequest
                    .getAgentIds();
