...
@SdkInternalApi
public class ListRobotsRequestMarshaller {
    ...
    private static final ListRobotsRequestMarshaller instance = new ListRobotsRequestMarshaller();

    public static ListRobotsRequestMarshaller getInstance() {
        return instance;
    }
