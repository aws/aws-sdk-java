...
/**
 * DeleteRobotApplicationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteRobotApplicationRequestMarshaller {
    ...
    private static final DeleteRobotApplicationRequestMarshaller instance = new DeleteRobotApplicationRequestMarshaller();

    public static DeleteRobotApplicationRequestMarshaller getInstance() {
        return instance;
    }
