...
/**
 * SimulationJobBatchSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SimulationJobBatchSummaryJsonUnmarshaller implements Unmarshaller<SimulationJobBatchSummary, JsonUnmarshallerContext> {

    public SimulationJobBatchSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        SimulationJobBatchSummary simulationJobBatchSummary = new SimulationJobBatchSummary();
    ...
    private static SimulationJobBatchSummaryJsonUnmarshaller instance;

    public static SimulationJobBatchSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SimulationJobBatchSummaryJsonUnmarshaller();
        return instance;
    }
}
