...
public class DeregisterRobotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeregisterRobotResult == false)
            return false;
        DeregisterRobotResult other = (DeregisterRobotResult) obj;
    ...
    public DeregisterRobotResult clone() {
        try {
            return (DeregisterRobotResult) super.clone();
