...
public class ListRobotApplicationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The version qualifier of the robot application.
     */
    ...
    public ListRobotApplicationsRequest withMaxResults(Integer maxResults) {
    ...
    public ListRobotApplicationsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListRobotApplicationsRequest == false)
            return false;
        ListRobotApplicationsRequest other = (ListRobotApplicationsRequest) obj;
    ...
    @Override
    public ListRobotApplicationsRequest clone() {
        return (ListRobotApplicationsRequest) super.clone();
    }
