...
public class BatchDescribeSimulationJobRequestMarshaller {
    ...
    private static final BatchDescribeSimulationJobRequestMarshaller instance = new BatchDescribeSimulationJobRequestMarshaller();

    public static BatchDescribeSimulationJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchDescribeSimulationJobRequest batchDescribeSimulationJobRequest, ProtocolMarshaller protocolMarshaller) {
