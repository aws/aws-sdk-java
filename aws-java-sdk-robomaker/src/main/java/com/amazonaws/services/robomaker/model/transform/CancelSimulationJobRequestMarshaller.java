...
/**
 * CancelSimulationJobRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CancelSimulationJobRequestMarshaller {
    ...
    private static final CancelSimulationJobRequestMarshaller instance = new CancelSimulationJobRequestMarshaller();

    public static CancelSimulationJobRequestMarshaller getInstance() {
        return instance;
    }
