...
/**
 * CancelSimulationJobBatchResult JSON Unmarshaller
 */
...
public class CancelSimulationJobBatchResultJsonUnmarshaller implements Unmarshaller<CancelSimulationJobBatchResult, JsonUnmarshallerContext> {
    ...
    public CancelSimulationJobBatchResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelSimulationJobBatchResult cancelSimulationJobBatchResult = new CancelSimulationJobBatchResult();

        return cancelSimulationJobBatchResult;
    }
