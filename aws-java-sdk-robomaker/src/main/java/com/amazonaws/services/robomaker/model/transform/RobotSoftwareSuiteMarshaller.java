...
/**
 * RobotSoftwareSuiteMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RobotSoftwareSuiteMarshaller {
    ...
    private static final RobotSoftwareSuiteMarshaller instance = new RobotSoftwareSuiteMarshaller();

    public static RobotSoftwareSuiteMarshaller getInstance() {
        return instance;
    }
