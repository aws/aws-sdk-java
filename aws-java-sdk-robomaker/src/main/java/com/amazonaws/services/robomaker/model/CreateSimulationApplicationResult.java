...
public class CreateSimulationApplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateSimulationApplicationResult withSources(Source... sources) {
    ...
    public CreateSimulationApplicationResult withSources(java.util.Collection<Source> sources) {
        setSources(sources);
        return this;
    }
    ...
    public CreateSimulationApplicationResult withLastUpdatedAt(java.util.Date lastUpdatedAt) {
     ...
     * </p>
     * 
     * @return The list of all tags added to the simulation application.
     */
    ...
    public CreateSimulationApplicationResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSimulationApplicationResult == false)
            return false;
        CreateSimulationApplicationResult other = (CreateSimulationApplicationResult) obj;
