...
public class UpdateGlobalSettingsRequestProtocolMarshaller implements Marshaller<Request<UpdateGlobalSettingsRequest>, UpdateGlobalSettingsRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.REST_JSON).requestUri("/settings")
            .httpMethodName(HttpMethodName.PUT).hasExplicitPayloadMember(false).hasPayloadMembers(true).serviceName("AmazonChime").build();
