...
public class GetProxySessionRequestMarshaller {
    ...
    private static final GetProxySessionRequestMarshaller instance = new GetProxySessionRequestMarshaller();

    public static GetProxySessionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetProxySessionRequest getProxySessionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getProxySessionRequest.getVoiceConnectorId(), VOICECONNECTORID_BINDING);
