...
public class ListMeetingTagsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListMeetingTagsRequest clone() {
        return (ListMeetingTagsRequest) super.clone();
    }
