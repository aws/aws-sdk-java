...
/**
 * ResetPersonalPINRequest Marshaller
 */
...
public class ResetPersonalPINRequestProtocolMarshaller implements Marshaller<Request<ResetPersonalPINRequest>, ResetPersonalPINRequest> {
    ...
    public ResetPersonalPINRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<ResetPersonalPINRequest> marshall(ResetPersonalPINRequest resetPersonalPINRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<ResetPersonalPINRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    resetPersonalPINRequest);

            protocolMarshaller.startMarshalling();
            ResetPersonalPINRequestMarshaller.getInstance().marshall(resetPersonalPINRequest, protocolMarshaller);
