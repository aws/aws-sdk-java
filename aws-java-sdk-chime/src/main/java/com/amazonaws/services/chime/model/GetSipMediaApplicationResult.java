...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/GetSipMediaApplication" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetSipMediaApplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetSipMediaApplicationResult withSipMediaApplication(SipMediaApplication sipMediaApplication) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSipMediaApplicationResult == false)
            return false;
        GetSipMediaApplicationResult other = (GetSipMediaApplicationResult) obj;
    ...
    @Override
    public GetSipMediaApplicationResult clone() {
        try {
            return (GetSipMediaApplicationResult) super.clone();
