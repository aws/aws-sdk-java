...
public class DeleteAppInstanceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteAppInstanceRequest withAppInstanceArn(String appInstanceArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAppInstanceRequest == false)
            return false;
        DeleteAppInstanceRequest other = (DeleteAppInstanceRequest) obj;
    ...
    @Override
    public DeleteAppInstanceRequest clone() {
        return (DeleteAppInstanceRequest) super.clone();
    }
