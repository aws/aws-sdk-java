...
/**
 * DeleteVoiceConnectorOriginationResult JSON Unmarshaller
 */
...
public class DeleteVoiceConnectorOriginationResultJsonUnmarshaller implements Unmarshaller<DeleteVoiceConnectorOriginationResult, JsonUnmarshallerContext> {
    ...
    public DeleteVoiceConnectorOriginationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteVoiceConnectorOriginationResult deleteVoiceConnectorOriginationResult = new DeleteVoiceConnectorOriginationResult();
