...
public class DescribeChannelBanResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getChannelBan() == null ^ this.getChannelBan() == null)
            return false;
        if (other.getChannelBan() != null && other.getChannelBan().equals(this.getChannelBan()) == false)
            return false;
        return true;
    }
