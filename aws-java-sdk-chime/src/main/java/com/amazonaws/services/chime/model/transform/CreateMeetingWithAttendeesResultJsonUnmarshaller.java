...
/**
 * CreateMeetingWithAttendeesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateMeetingWithAttendeesResultJsonUnmarshaller implements Unmarshaller<CreateMeetingWithAttendeesResult, JsonUnmarshallerContext> {

    public CreateMeetingWithAttendeesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Meeting", targetDepth)) {
                    context.nextToken();
                    createMeetingWithAttendeesResult.setMeeting(MeetingJsonUnmarshaller.getInstance().unmarshall(context));
                }
