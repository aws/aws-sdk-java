...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/UpdateAppInstanceUser" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateAppInstanceUserResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAppInstanceUserResult == false)
            return false;
        UpdateAppInstanceUserResult other = (UpdateAppInstanceUserResult) obj;
    ...
    public UpdateAppInstanceUserResult clone() {
        try {
            return (UpdateAppInstanceUserResult) super.clone();
