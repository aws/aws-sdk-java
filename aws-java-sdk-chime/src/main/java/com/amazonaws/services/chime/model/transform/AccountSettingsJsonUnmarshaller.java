        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DisableRemoteControl", targetDepth)) {
                    context.nextToken();
                    accountSettings.setDisableRemoteControl(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("EnableDialOut", targetDepth)) {
                    context.nextToken();
                    accountSettings.setEnableDialOut(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
