...
/**
 * UpdateAppInstanceUserResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateAppInstanceUserResultJsonUnmarshaller implements Unmarshaller<UpdateAppInstanceUserResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AppInstanceUserArn", targetDepth)) {
                    context.nextToken();
                    updateAppInstanceUserResult.setAppInstanceUserArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
