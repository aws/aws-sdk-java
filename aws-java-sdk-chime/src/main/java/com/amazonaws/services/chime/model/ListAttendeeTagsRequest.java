...
public class ListAttendeeTagsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListAttendeeTagsRequest clone() {
        return (ListAttendeeTagsRequest) super.clone();
    }
