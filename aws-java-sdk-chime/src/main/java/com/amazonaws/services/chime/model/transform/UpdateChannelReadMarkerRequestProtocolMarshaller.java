...
/**
 * UpdateChannelReadMarkerRequest Marshaller
 */
...
public class UpdateChannelReadMarkerRequestProtocolMarshaller implements Marshaller<Request<UpdateChannelReadMarkerRequest>, UpdateChannelReadMarkerRequest> {
    ...
    public UpdateChannelReadMarkerRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<UpdateChannelReadMarkerRequest> marshall(UpdateChannelReadMarkerRequest updateChannelReadMarkerRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<UpdateChannelReadMarkerRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(
                    SDK_OPERATION_BINDING, updateChannelReadMarkerRequest);

            protocolMarshaller.startMarshalling();
            UpdateChannelReadMarkerRequestMarshaller.getInstance().marshall(updateChannelReadMarkerRequest, protocolMarshaller);
