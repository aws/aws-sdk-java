...
public class GetSipMediaApplicationLoggingConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetSipMediaApplicationLoggingConfigurationRequest withSipMediaApplicationId(String sipMediaApplicationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSipMediaApplicationLoggingConfigurationRequest == false)
            return false;
        GetSipMediaApplicationLoggingConfigurationRequest other = (GetSipMediaApplicationLoggingConfigurationRequest) obj;
    ...
    @Override
    public GetSipMediaApplicationLoggingConfigurationRequest clone() {
        return (GetSipMediaApplicationLoggingConfigurationRequest) super.clone();
    }
