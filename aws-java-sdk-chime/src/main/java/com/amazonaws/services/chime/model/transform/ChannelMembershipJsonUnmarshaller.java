...
/**
 * ChannelMembership JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChannelMembershipJsonUnmarshaller implements Unmarshaller<ChannelMembership, JsonUnmarshallerContext> {

    public ChannelMembership unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ChannelMembershipJsonUnmarshaller instance;

    public static ChannelMembershipJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ChannelMembershipJsonUnmarshaller();
        return instance;
    }
}
