...
/**
 * AppInstanceUserMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AppInstanceUserMarshaller {
    ...
    public static AppInstanceUserMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AppInstanceUser appInstanceUser, ProtocolMarshaller protocolMarshaller) {

        if (appInstanceUser == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(appInstanceUser.getAppInstanceUserArn(), APPINSTANCEUSERARN_BINDING);
            protocolMarshaller.marshall(appInstanceUser.getName(), NAME_BINDING);
