...
public class RoomRetentionSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RoomRetentionSettings == false)
            return false;
        RoomRetentionSettings other = (RoomRetentionSettings) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.chime.model.transform.RoomRetentionSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
