...
/**
 * DeleteAppInstanceAdminResult JSON Unmarshaller
 */
...
public class DeleteAppInstanceAdminResultJsonUnmarshaller implements Unmarshaller<DeleteAppInstanceAdminResult, JsonUnmarshallerContext> {
    ...
    public DeleteAppInstanceAdminResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAppInstanceAdminResult deleteAppInstanceAdminResult = new DeleteAppInstanceAdminResult();
