...
/**
 * UpdateChannelReadMarkerResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateChannelReadMarkerResultJsonUnmarshaller implements Unmarshaller<UpdateChannelReadMarkerResult, JsonUnmarshallerContext> {

    public UpdateChannelReadMarkerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
