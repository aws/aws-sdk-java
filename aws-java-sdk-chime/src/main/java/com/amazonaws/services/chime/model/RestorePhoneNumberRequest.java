...
public class RestorePhoneNumberRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public RestorePhoneNumberRequest withPhoneNumberId(String phoneNumberId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RestorePhoneNumberRequest == false)
            return false;
        RestorePhoneNumberRequest other = (RestorePhoneNumberRequest) obj;
    ...
    @Override
    public RestorePhoneNumberRequest clone() {
        return (RestorePhoneNumberRequest) super.clone();
    }
