...
public class DeleteVoiceConnectorRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeleteVoiceConnectorRequest clone() {
        return (DeleteVoiceConnectorRequest) super.clone();
    }
