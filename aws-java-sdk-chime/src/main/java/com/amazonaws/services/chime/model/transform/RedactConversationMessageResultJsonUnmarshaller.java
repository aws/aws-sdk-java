...
/**
 * RedactConversationMessageResult JSON Unmarshaller
 */
...
public class RedactConversationMessageResultJsonUnmarshaller implements Unmarshaller<RedactConversationMessageResult, JsonUnmarshallerContext> {
    ...
    public RedactConversationMessageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RedactConversationMessageResult redactConversationMessageResult = new RedactConversationMessageResult();
