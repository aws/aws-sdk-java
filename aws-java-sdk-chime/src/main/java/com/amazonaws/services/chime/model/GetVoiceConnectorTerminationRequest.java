...
public class GetVoiceConnectorTerminationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetVoiceConnectorTerminationRequest withVoiceConnectorId(String voiceConnectorId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetVoiceConnectorTerminationRequest == false)
            return false;
        GetVoiceConnectorTerminationRequest other = (GetVoiceConnectorTerminationRequest) obj;
    ...
    @Override
    public GetVoiceConnectorTerminationRequest clone() {
        return (GetVoiceConnectorTerminationRequest) super.clone();
    }
