...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/DeleteChannelModerator" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteChannelModeratorRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteChannelModeratorRequest withChannelModeratorArn(String channelModeratorArn) {
    ...
    public DeleteChannelModeratorRequest withChimeBearer(String chimeBearer) {
    ...
    public String toString() {
        ...
        if (getChannelModeratorArn() != null)
            sb.append("ChannelModeratorArn: ").append(getChannelModeratorArn()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteChannelModeratorRequest == false)
            return false;
        DeleteChannelModeratorRequest other = (DeleteChannelModeratorRequest) obj;
    ...
    @Override
    public DeleteChannelModeratorRequest clone() {
        return (DeleteChannelModeratorRequest) super.clone();
    }
