...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/DescribeAppInstanceUser" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeAppInstanceUserRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeAppInstanceUserRequest withAppInstanceUserArn(String appInstanceUserArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAppInstanceUserRequest == false)
            return false;
        DescribeAppInstanceUserRequest other = (DescribeAppInstanceUserRequest) obj;
    ...
    @Override
    public DescribeAppInstanceUserRequest clone() {
        return (DescribeAppInstanceUserRequest) super.clone();
    }
