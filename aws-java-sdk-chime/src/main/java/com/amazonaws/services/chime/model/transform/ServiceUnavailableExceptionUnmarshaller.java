...
public class ServiceUnavailableExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.chime.model.ServiceUnavailableException> {
    private ServiceUnavailableExceptionUnmarshaller() {
        super("ServiceUnavailableException");
    }

    @Override
    public com.amazonaws.services.chime.model.ServiceUnavailableException unmarshall(JsonUnmarshallerContext context) throws Exception {
