...
public class BatchUpdatePhoneNumberResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchUpdatePhoneNumberResult withPhoneNumberErrors(java.util.Collection<PhoneNumberError> phoneNumberErrors) {
    ...
    public BatchUpdatePhoneNumberResult clone() {
        try {
            return (BatchUpdatePhoneNumberResult) super.clone();
