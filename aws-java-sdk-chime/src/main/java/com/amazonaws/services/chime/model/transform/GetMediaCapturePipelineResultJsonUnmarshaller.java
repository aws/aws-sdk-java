...
/**
 * GetMediaCapturePipelineResult JSON Unmarshaller
 */
...
public class GetMediaCapturePipelineResultJsonUnmarshaller implements Unmarshaller<GetMediaCapturePipelineResult, JsonUnmarshallerContext> {
    ...
    public GetMediaCapturePipelineResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MediaCapturePipeline", targetDepth)) {
                    context.nextToken();
                    getMediaCapturePipelineResult.setMediaCapturePipeline(MediaCapturePipelineJsonUnmarshaller.getInstance().unmarshall(context));
                }
