...
public class GetUserRequestProtocolMarshaller implements Marshaller<Request<GetUserRequest>, GetUserRequest> {
    ...
    public GetUserRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<GetUserRequest> marshall(GetUserRequest getUserRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<GetUserRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING, getUserRequest);

            protocolMarshaller.startMarshalling();
            GetUserRequestMarshaller.getInstance().marshall(getUserRequest, protocolMarshaller);
