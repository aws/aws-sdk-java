...
/**
 * UpdateAppInstanceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateAppInstanceResultJsonUnmarshaller implements Unmarshaller<UpdateAppInstanceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AppInstanceArn", targetDepth)) {
                    context.nextToken();
                    updateAppInstanceResult.setAppInstanceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
