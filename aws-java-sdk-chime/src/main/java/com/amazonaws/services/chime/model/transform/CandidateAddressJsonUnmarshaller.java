...
/**
 * CandidateAddress JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CandidateAddressJsonUnmarshaller implements Unmarshaller<CandidateAddress, JsonUnmarshallerContext> {

    public CandidateAddress unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static CandidateAddressJsonUnmarshaller instance;

    public static CandidateAddressJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CandidateAddressJsonUnmarshaller();
        return instance;
    }
}
