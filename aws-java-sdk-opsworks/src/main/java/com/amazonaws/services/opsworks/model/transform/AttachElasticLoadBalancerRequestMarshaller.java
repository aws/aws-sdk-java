...
public class AttachElasticLoadBalancerRequestMarshaller
        implements
        Marshaller<Request<AttachElasticLoadBalancerRequest>, AttachElasticLoadBalancerRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public AttachElasticLoadBalancerRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<AttachElasticLoadBalancerRequest> marshall(
        ...
        Request<AttachElasticLoadBalancerRequest> request = new DefaultRequest<AttachElasticLoadBalancerRequest>(
                attachElasticLoadBalancerRequest, "AWSOpsWorks");
        ...
        try {
            ...
            if (attachElasticLoadBalancerRequest.getLayerId() != null) {
                jsonGenerator.writeFieldName("LayerId").writeValue(
                        attachElasticLoadBalancerRequest.getLayerId());
            }
