 ...
 */
public class DescribeElasticIpsResultJsonUnmarshaller implements
        Unmarshaller<DescribeElasticIpsResult, JsonUnmarshallerContext> {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ElasticIps", targetDepth)) {
                    ...
                    describeElasticIpsResult
                            .setElasticIps(new ListUnmarshaller<ElasticIp>(
                                    ElasticIpJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
