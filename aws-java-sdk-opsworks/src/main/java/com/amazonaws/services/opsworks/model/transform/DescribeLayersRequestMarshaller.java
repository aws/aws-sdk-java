...
public class DescribeLayersRequestMarshaller implements Marshaller<Request<DescribeLayersRequest>, DescribeLayersRequest> {
    ...
    public DescribeLayersRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<DescribeLayersRequest> marshall(DescribeLayersRequest describeLayersRequest) {
        ...
        try {
            ...
            if (describeLayersRequest.getStackId() != null) {
                jsonGenerator.writeFieldName("StackId").writeValue(describeLayersRequest.getStackId());
            }

            com.amazonaws.internal.SdkInternalList<String> layerIdsList = (com.amazonaws.internal.SdkInternalList<String>) describeLayersRequest.getLayerIds();
