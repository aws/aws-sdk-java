...
/**
 * Fluent builder for {@link com.amazonaws.services.opsworks.AWSOpsWorks}. Use
 * of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AWSOpsWorksClientBuilder extends
        AwsSyncClientBuilder<AWSOpsWorksClientBuilder, AWSOpsWorks> {
    ...
    /**
     * Construct a synchronous implementation of AWSOpsWorks using the current
