 ...
 */
public class SetLoadBasedAutoScalingResultJsonUnmarshaller implements
        Unmarshaller<SetLoadBasedAutoScalingResult, JsonUnmarshallerContext> {

    public SetLoadBasedAutoScalingResult unmarshall(
