...
public class EcsClusterJsonUnmarshaller implements Unmarshaller<EcsCluster, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("EcsClusterArn", targetDepth)) {
                    context.nextToken();
                    ecsCluster.setEcsClusterArn(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("EcsClusterName", targetDepth)) {
                    context.nextToken();
                    ecsCluster.setEcsClusterName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("StackId", targetDepth)) {
                    context.nextToken();
                    ecsCluster.setStackId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RegisteredAt", targetDepth)) {
                    context.nextToken();
                    ecsCluster.setRegisteredAt(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static EcsClusterJsonUnmarshaller getInstance() {
        if (instance == null) instance = new EcsClusterJsonUnmarshaller();
        return instance;
    }
}
