 ...
 */
public class StartStackResultJsonUnmarshaller implements
        Unmarshaller<StartStackResult, JsonUnmarshallerContext> {

    public StartStackResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
