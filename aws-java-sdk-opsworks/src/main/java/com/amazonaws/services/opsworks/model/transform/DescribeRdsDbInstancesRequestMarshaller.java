...
public class DescribeRdsDbInstancesRequestMarshaller
        implements
        Marshaller<Request<DescribeRdsDbInstancesRequest>, DescribeRdsDbInstancesRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeRdsDbInstancesRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeRdsDbInstancesRequest> marshall(
        ...
        Request<DescribeRdsDbInstancesRequest> request = new DefaultRequest<DescribeRdsDbInstancesRequest>(
                describeRdsDbInstancesRequest, "AWSOpsWorks");
        ...
        try {
            ...
            com.amazonaws.internal.SdkInternalList<String> rdsDbInstanceArnsList = (com.amazonaws.internal.SdkInternalList<String>) describeRdsDbInstancesRequest
