 ...
 */
public class UpdateElasticIpRequestMarshaller implements
        Marshaller<Request<UpdateElasticIpRequest>, UpdateElasticIpRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public UpdateElasticIpRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<UpdateElasticIpRequest> marshall(
        ...
        Request<UpdateElasticIpRequest> request = new DefaultRequest<UpdateElasticIpRequest>(
                updateElasticIpRequest, "AWSOpsWorks");
