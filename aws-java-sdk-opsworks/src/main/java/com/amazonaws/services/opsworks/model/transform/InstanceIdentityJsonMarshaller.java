...
public class InstanceIdentityJsonMarshaller {
     ...
     */
    public void marshall(InstanceIdentity instanceIdentity, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (instanceIdentity.getDocument() != null) {
                jsonGenerator.writeFieldName("Document").writeValue(instanceIdentity.getDocument());
            }
            if (instanceIdentity.getSignature() != null) {
                jsonGenerator.writeFieldName("Signature").writeValue(instanceIdentity.getSignature());
            }
