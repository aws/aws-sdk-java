 ...
 */
public class DescribeDeploymentsResultJsonUnmarshaller implements
        Unmarshaller<DescribeDeploymentsResult, JsonUnmarshallerContext> {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Deployments", targetDepth)) {
                    ...
                    describeDeploymentsResult
                            .setDeployments(new ListUnmarshaller<Deployment>(
