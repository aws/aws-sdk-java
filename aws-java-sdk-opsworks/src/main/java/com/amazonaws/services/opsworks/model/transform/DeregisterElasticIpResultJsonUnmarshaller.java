 ...
 */
public class DeregisterElasticIpResultJsonUnmarshaller implements
        Unmarshaller<DeregisterElasticIpResult, JsonUnmarshallerContext> {

    public DeregisterElasticIpResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
