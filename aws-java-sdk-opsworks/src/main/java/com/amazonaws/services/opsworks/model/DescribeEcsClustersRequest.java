 ...
 * 
 */
public class DescribeEcsClustersRequest extends AmazonWebServiceRequest
    ...
    public void setEcsClusterArns(java.util.Collection<String> ecsClusterArns) {
        ...
        this.ecsClusterArns = new com.amazonaws.internal.SdkInternalList<String>(
                ecsClusterArns);
    }
     ...
     * any). Use {@link #setEcsClusterArns(java.util.Collection)} or
     * {@link #withEcsClusterArns(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param ecsClusterArns
    ...
    public DescribeEcsClustersRequest withEcsClusterArns(
        ...
        if (this.ecsClusterArns == null) {
            setEcsClusterArns(new com.amazonaws.internal.SdkInternalList<String>(
                    ecsClusterArns.length));
        }
     ...
     *        results, call <code>DescribeEcsClusters</code> again and assign
     ...
     * </p>
     * 
     * @return If the previous paginated request did not return all of the
     *         remaining results, the response object's<code>NextToken</code>
     *         parameter value is set to a token. To retrieve the next set of
     *         results, call <code>DescribeEcsClusters</code> again and assign
     *         that token to the request object's <code>NextToken</code>
     ...
     * </p>
     * 
     * @return To receive a paginated response, use this parameter to specify
    ...
    public String toString() {
        ...
        if (getEcsClusterArns() != null)
            sb.append("EcsClusterArns: " + getEcsClusterArns() + ",");
        if (getStackId() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEcsClusterArns() == null
                ^ this.getEcsClusterArns() == null)
            return false;
        if (other.getEcsClusterArns() != null
                && other.getEcsClusterArns().equals(this.getEcsClusterArns()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getEcsClusterArns() == null) ? 0 : getEcsClusterArns()
                        .hashCode());
