...
/**
 * Register Ecs Cluster Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (registerEcsClusterRequest.getEcsClusterArn() != null) {
                jsonWriter.key("EcsClusterArn").value(registerEcsClusterRequest.getEcsClusterArn());
            }
            if (registerEcsClusterRequest.getStackId() != null) {
                jsonWriter.key("StackId").value(registerEcsClusterRequest.getStackId());
            }
