 ...
 */
public class DeleteStackResultJsonUnmarshaller implements
        Unmarshaller<DeleteStackResult, JsonUnmarshallerContext> {

    public DeleteStackResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
