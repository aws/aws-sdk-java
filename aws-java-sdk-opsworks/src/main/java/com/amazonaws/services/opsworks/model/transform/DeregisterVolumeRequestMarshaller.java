...
public class DeregisterVolumeRequestMarshaller implements
    ...
    public Request<DeregisterVolumeRequest> marshall(
        ...
        Request<DeregisterVolumeRequest> request = new DefaultRequest<DeregisterVolumeRequest>(
                deregisterVolumeRequest, "AWSOpsWorks");
        ...
        try {
            ...
            if (deregisterVolumeRequest.getVolumeId() != null) {
                jsonWriter.key("VolumeId").value(
                        deregisterVolumeRequest.getVolumeId());
            }
