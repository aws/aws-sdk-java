 ...
 * </p>
 */
public class DescribeStackProvisioningParametersResult extends
    ...
    public DescribeStackProvisioningParametersResult addParametersEntry(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAgentInstallerUrl() == null
                ^ this.getAgentInstallerUrl() == null)
            return false;
        if (other.getAgentInstallerUrl() != null
                && other.getAgentInstallerUrl().equals(
                        this.getAgentInstallerUrl()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getAgentInstallerUrl() == null) ? 0
                        : getAgentInstallerUrl().hashCode());
