 ...
 */
public class DeregisterEcsClusterResultJsonUnmarshaller implements
        Unmarshaller<DeregisterEcsClusterResult, JsonUnmarshallerContext> {

    public DeregisterEcsClusterResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
