 ...
 */
public class DeleteUserProfileResultJsonUnmarshaller implements
        Unmarshaller<DeleteUserProfileResult, JsonUnmarshallerContext> {

    public DeleteUserProfileResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
