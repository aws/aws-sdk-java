...
public class ShutdownEventConfigurationJsonMarshaller {
     ...
     */
    public void marshall(ShutdownEventConfiguration shutdownEventConfiguration, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (shutdownEventConfiguration.getExecutionTimeout() != null) {
                jsonGenerator.writeFieldName("ExecutionTimeout").writeValue(shutdownEventConfiguration.getExecutionTimeout());
            }
            if (shutdownEventConfiguration.getDelayUntilElbConnectionsDrained() != null) {
                jsonGenerator.writeFieldName("DelayUntilElbConnectionsDrained").writeValue(shutdownEventConfiguration.getDelayUntilElbConnectionsDrained());
            }
