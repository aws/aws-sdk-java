...
/**
 * Agent Version JSON Unmarshaller
 */
public class AgentVersionJsonUnmarshaller implements Unmarshaller<AgentVersion, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Version", targetDepth)) {
                    context.nextToken();
                    agentVersion.setVersion(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ConfigurationManager", targetDepth)) {
                    context.nextToken();
                    agentVersion.setConfigurationManager(StackConfigurationManagerJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static AgentVersionJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AgentVersionJsonUnmarshaller();
        return instance;
    }
}
