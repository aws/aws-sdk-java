 ...
 */
public class GetHostnameSuggestionResultJsonUnmarshaller implements
        Unmarshaller<GetHostnameSuggestionResult, JsonUnmarshallerContext> {

    public GetHostnameSuggestionResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("LayerId", targetDepth)) {
                    context.nextToken();
                    getHostnameSuggestionResult.setLayerId(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Hostname", targetDepth)) {
                    context.nextToken();
                    getHostnameSuggestionResult.setHostname(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
