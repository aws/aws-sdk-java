...
class InstanceOnline {
    ...
    static class IsShutting_downMatcher extends WaiterAcceptor<DescribeInstancesResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"shutting_down\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsStoppedMatcher extends WaiterAcceptor<DescribeInstancesResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsTerminatingMatcher extends WaiterAcceptor<DescribeInstancesResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsStop_failedMatcher extends WaiterAcceptor<DescribeInstancesResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"stop_failed\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
