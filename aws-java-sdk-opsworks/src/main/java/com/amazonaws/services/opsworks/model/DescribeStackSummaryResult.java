 ...
 * </p>
 */
public class DescribeStackSummaryResult extends
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getStackSummary() == null ^ this.getStackSummary() == null)
            return false;
        if (other.getStackSummary() != null
                && other.getStackSummary().equals(this.getStackSummary()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getStackSummary() == null) ? 0 : getStackSummary()
                        .hashCode());
        return hashCode;
    }
