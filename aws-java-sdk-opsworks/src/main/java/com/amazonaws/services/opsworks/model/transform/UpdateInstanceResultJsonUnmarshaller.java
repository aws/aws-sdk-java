 ...
 */
public class UpdateInstanceResultJsonUnmarshaller implements
        Unmarshaller<UpdateInstanceResult, JsonUnmarshallerContext> {

    public UpdateInstanceResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
