...
/**
 * RebootInstanceRequestMarshaller
 */
...
public class RebootInstanceRequestMarshaller {
    ...
    private static final RebootInstanceRequestMarshaller instance = new RebootInstanceRequestMarshaller();

    public static RebootInstanceRequestMarshaller getInstance() {
        return instance;
    }
