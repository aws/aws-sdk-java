 ...
 */
public class DescribeUserProfilesResultJsonUnmarshaller implements
        Unmarshaller<DescribeUserProfilesResult, JsonUnmarshallerContext> {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UserProfiles", targetDepth)) {
                    ...
                    describeUserProfilesResult
                            .setUserProfiles(new ListUnmarshaller<UserProfile>(
                                    UserProfileJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
