...
/**
 * Block Device Mapping JSON Unmarshaller
 */
public class BlockDeviceMappingJsonUnmarshaller implements Unmarshaller<BlockDeviceMapping, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DeviceName", targetDepth)) {
                    context.nextToken();
                    blockDeviceMapping.setDeviceName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("NoDevice", targetDepth)) {
                    context.nextToken();
                    blockDeviceMapping.setNoDevice(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("VirtualName", targetDepth)) {
                    context.nextToken();
                    blockDeviceMapping.setVirtualName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static BlockDeviceMappingJsonUnmarshaller getInstance() {
        if (instance == null) instance = new BlockDeviceMappingJsonUnmarshaller();
        return instance;
    }
}
