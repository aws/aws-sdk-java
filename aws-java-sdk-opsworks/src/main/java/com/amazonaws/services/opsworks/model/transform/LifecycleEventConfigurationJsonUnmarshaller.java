 ...
 */
public class LifecycleEventConfigurationJsonUnmarshaller implements
        Unmarshaller<LifecycleEventConfiguration, JsonUnmarshallerContext> {

    public LifecycleEventConfiguration unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Shutdown", targetDepth)) {
                    ...
                    lifecycleEventConfiguration
                            .setShutdown(ShutdownEventConfigurationJsonUnmarshaller
