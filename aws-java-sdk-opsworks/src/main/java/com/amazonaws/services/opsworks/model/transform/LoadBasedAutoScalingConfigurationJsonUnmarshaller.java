 ...
 */
public class LoadBasedAutoScalingConfigurationJsonUnmarshaller
        implements
        Unmarshaller<LoadBasedAutoScalingConfiguration, JsonUnmarshallerContext> {

    public LoadBasedAutoScalingConfiguration unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("UpScaling", targetDepth)) {
                    context.nextToken();
                    loadBasedAutoScalingConfiguration
                            .setUpScaling(AutoScalingThresholdsJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
                if (context.testExpression("DownScaling", targetDepth)) {
                    context.nextToken();
                    loadBasedAutoScalingConfiguration
                            .setDownScaling(AutoScalingThresholdsJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
    ...
    public static LoadBasedAutoScalingConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LoadBasedAutoScalingConfigurationJsonUnmarshaller();
        return instance;
    }
}
