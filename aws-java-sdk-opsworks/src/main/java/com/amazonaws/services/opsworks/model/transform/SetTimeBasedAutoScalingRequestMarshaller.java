...
public class SetTimeBasedAutoScalingRequestMarshaller implements Marshaller<Request<SetTimeBasedAutoScalingRequest>, SetTimeBasedAutoScalingRequest> {
    ...
    public SetTimeBasedAutoScalingRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<SetTimeBasedAutoScalingRequest> marshall(SetTimeBasedAutoScalingRequest setTimeBasedAutoScalingRequest) {
        ...
        request.addHeader("X-Amz-Target", "OpsWorks_20130218.SetTimeBasedAutoScaling");
        ...
        try {
            ...
            if (setTimeBasedAutoScalingRequest.getInstanceId() != null) {
                jsonGenerator.writeFieldName("InstanceId").writeValue(setTimeBasedAutoScalingRequest.getInstanceId());
            }
            if (setTimeBasedAutoScalingRequest.getAutoScalingSchedule() != null) {
                jsonGenerator.writeFieldName("AutoScalingSchedule");
                WeeklyAutoScalingScheduleJsonMarshaller.getInstance().marshall(setTimeBasedAutoScalingRequest.getAutoScalingSchedule(), jsonGenerator);
            }
