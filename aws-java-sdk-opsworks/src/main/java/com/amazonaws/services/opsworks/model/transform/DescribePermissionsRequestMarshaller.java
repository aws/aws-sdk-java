...
public class DescribePermissionsRequestMarshaller
        implements
        Marshaller<Request<DescribePermissionsRequest>, DescribePermissionsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribePermissionsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribePermissionsRequest> marshall(
        ...
        Request<DescribePermissionsRequest> request = new DefaultRequest<DescribePermissionsRequest>(
                describePermissionsRequest, "AWSOpsWorks");
