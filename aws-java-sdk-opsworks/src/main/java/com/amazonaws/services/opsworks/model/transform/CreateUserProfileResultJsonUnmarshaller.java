...
public class CreateUserProfileResultJsonUnmarshaller implements Unmarshaller<CreateUserProfileResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IamUserArn", targetDepth)) {
                    context.nextToken();
                    createUserProfileResult.setIamUserArn(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CreateUserProfileResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreateUserProfileResultJsonUnmarshaller();
        return instance;
    }
}
