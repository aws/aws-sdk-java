 ...
 */
public class CloneStackResultJsonUnmarshaller implements
        Unmarshaller<CloneStackResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StackId", targetDepth)) {
                    context.nextToken();
                    cloneStackResult.setStackId(context.getUnmarshaller(
