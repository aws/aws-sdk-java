 ...
 */
public class UpdateElasticIpResultJsonUnmarshaller implements
        Unmarshaller<UpdateElasticIpResult, JsonUnmarshallerContext> {

    public UpdateElasticIpResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
