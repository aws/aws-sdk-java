...
/**
 * Chef Configuration JSON Unmarshaller
 */
public class ChefConfigurationJsonUnmarshaller implements Unmarshaller<ChefConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ManageBerkshelf", targetDepth)) {
                    context.nextToken();
                    chefConfiguration.setManageBerkshelf(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("BerkshelfVersion", targetDepth)) {
                    context.nextToken();
                    chefConfiguration.setBerkshelfVersion(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ChefConfigurationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ChefConfigurationJsonUnmarshaller();
        return instance;
    }
}
