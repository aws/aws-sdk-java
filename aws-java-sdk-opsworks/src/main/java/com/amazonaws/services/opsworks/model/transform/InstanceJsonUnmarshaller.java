        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AgentVersion", targetDepth)) {
                    context.nextToken();
                    instance.setAgentVersion(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("Platform", targetDepth)) {
                    context.nextToken();
                    instance.setPlatform(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
