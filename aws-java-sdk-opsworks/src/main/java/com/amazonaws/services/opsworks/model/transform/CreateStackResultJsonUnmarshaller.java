 ...
 */
public class CreateStackResultJsonUnmarshaller implements
        Unmarshaller<CreateStackResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StackId", targetDepth)) {
                    context.nextToken();
                    createStackResult.setStackId(context.getUnmarshaller(
