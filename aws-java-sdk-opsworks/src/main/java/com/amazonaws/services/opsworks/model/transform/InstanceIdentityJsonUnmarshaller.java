 ...
 */
public class InstanceIdentityJsonUnmarshaller implements
        Unmarshaller<InstanceIdentity, JsonUnmarshallerContext> {

    public InstanceIdentity unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Document", targetDepth)) {
                    context.nextToken();
                    instanceIdentity.setDocument(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("Signature", targetDepth)) {
                    context.nextToken();
                    instanceIdentity.setSignature(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
