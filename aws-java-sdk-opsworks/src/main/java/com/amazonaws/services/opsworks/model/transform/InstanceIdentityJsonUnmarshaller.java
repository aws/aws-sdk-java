...
public class InstanceIdentityJsonUnmarshaller implements Unmarshaller<InstanceIdentity, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Document", targetDepth)) {
                    context.nextToken();
                    instanceIdentity.setDocument(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Signature", targetDepth)) {
                    context.nextToken();
                    instanceIdentity.setSignature(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static InstanceIdentityJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new InstanceIdentityJsonUnmarshaller();
        return instance;
    }
}
