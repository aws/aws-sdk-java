    ...
    public void marshall(Permission permission, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (permission.getStackId() != null) {
                jsonGenerator.writeFieldName("StackId").writeValue(permission.getStackId());
            }
            if (permission.getIamUserArn() != null) {
                jsonGenerator.writeFieldName("IamUserArn").writeValue(permission.getIamUserArn());
            }
            if (permission.getAllowSsh() != null) {
                jsonGenerator.writeFieldName("AllowSsh").writeValue(permission.getAllowSsh());
            }
            if (permission.getAllowSudo() != null) {
                jsonGenerator.writeFieldName("AllowSudo").writeValue(permission.getAllowSudo());
            }
            if (permission.getLevel() != null) {
                jsonGenerator.writeFieldName("Level").writeValue(permission.getLevel());
            }
