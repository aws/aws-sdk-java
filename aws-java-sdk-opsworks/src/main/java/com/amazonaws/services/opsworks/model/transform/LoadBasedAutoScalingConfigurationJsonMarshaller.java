...
public class LoadBasedAutoScalingConfigurationJsonMarshaller {
     ...
     */
    public void marshall(LoadBasedAutoScalingConfiguration loadBasedAutoScalingConfiguration, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (loadBasedAutoScalingConfiguration.getLayerId() != null) {
                jsonGenerator.writeFieldName("LayerId").writeValue(loadBasedAutoScalingConfiguration.getLayerId());
            }
            if (loadBasedAutoScalingConfiguration.getEnable() != null) {
                jsonGenerator.writeFieldName("Enable").writeValue(loadBasedAutoScalingConfiguration.getEnable());
            }
            if (loadBasedAutoScalingConfiguration.getUpScaling() != null) {
                jsonGenerator.writeFieldName("UpScaling");
                AutoScalingThresholdsJsonMarshaller.getInstance().marshall(loadBasedAutoScalingConfiguration.getUpScaling(), jsonGenerator);
            }
            if (loadBasedAutoScalingConfiguration.getDownScaling() != null) {
                jsonGenerator.writeFieldName("DownScaling");
                AutoScalingThresholdsJsonMarshaller.getInstance().marshall(loadBasedAutoScalingConfiguration.getDownScaling(), jsonGenerator);
            }
