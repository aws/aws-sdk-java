 ...
 */
public class DeregisterInstanceResultJsonUnmarshaller implements
        Unmarshaller<DeregisterInstanceResult, JsonUnmarshallerContext> {

    public DeregisterInstanceResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
