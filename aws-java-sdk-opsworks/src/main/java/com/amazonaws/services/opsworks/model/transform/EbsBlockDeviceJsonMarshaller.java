    ...
    public void marshall(EbsBlockDevice ebsBlockDevice, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (ebsBlockDevice.getSnapshotId() != null) {
                jsonGenerator.writeFieldName("SnapshotId").writeValue(ebsBlockDevice.getSnapshotId());
            }
            if (ebsBlockDevice.getIops() != null) {
                jsonGenerator.writeFieldName("Iops").writeValue(ebsBlockDevice.getIops());
            }
            if (ebsBlockDevice.getVolumeSize() != null) {
                jsonGenerator.writeFieldName("VolumeSize").writeValue(ebsBlockDevice.getVolumeSize());
            }
            if (ebsBlockDevice.getVolumeType() != null) {
                jsonGenerator.writeFieldName("VolumeType").writeValue(ebsBlockDevice.getVolumeType());
            }
            if (ebsBlockDevice.getDeleteOnTermination() != null) {
                jsonGenerator.writeFieldName("DeleteOnTermination").writeValue(ebsBlockDevice.getDeleteOnTermination());
            }
