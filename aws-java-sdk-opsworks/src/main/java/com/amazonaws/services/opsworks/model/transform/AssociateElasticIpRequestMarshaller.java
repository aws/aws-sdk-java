...
public class AssociateElasticIpRequestMarshaller
        implements
        Marshaller<Request<AssociateElasticIpRequest>, AssociateElasticIpRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public AssociateElasticIpRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<AssociateElasticIpRequest> marshall(
        ...
        Request<AssociateElasticIpRequest> request = new DefaultRequest<AssociateElasticIpRequest>(
                associateElasticIpRequest, "AWSOpsWorks");
