 ...
 */
public class DisassociateElasticIpResultJsonUnmarshaller implements
        Unmarshaller<DisassociateElasticIpResult, JsonUnmarshallerContext> {

    public DisassociateElasticIpResult unmarshall(
