...
public class DescribeRaidArraysResult implements Serializable, Cloneable {
    ...
    public void setRaidArrays(java.util.Collection<RaidArray> raidArrays) {
        ...
        this.raidArrays = new com.amazonaws.internal.SdkInternalList<RaidArray>(
                raidArrays);
    }
     ...
     * any). Use {@link #setRaidArrays(java.util.Collection)} or
     * {@link #withRaidArrays(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param raidArrays
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRaidArrays() == null ^ this.getRaidArrays() == null)
            return false;
        if (other.getRaidArrays() != null
                && other.getRaidArrays().equals(this.getRaidArrays()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getRaidArrays() == null) ? 0 : getRaidArrays().hashCode());
        return hashCode;
    }
