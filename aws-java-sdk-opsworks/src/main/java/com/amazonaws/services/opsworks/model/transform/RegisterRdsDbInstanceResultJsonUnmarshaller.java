 ...
 */
public class RegisterRdsDbInstanceResultJsonUnmarshaller implements
        Unmarshaller<RegisterRdsDbInstanceResult, JsonUnmarshallerContext> {

    public RegisterRdsDbInstanceResult unmarshall(
