 ...
 */
public class UnassignInstanceResultJsonUnmarshaller implements
        Unmarshaller<UnassignInstanceResult, JsonUnmarshallerContext> {

    public UnassignInstanceResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
