...
public class DescribeTimeBasedAutoScalingRequestMarshaller implements
    ...
    public Request<DescribeTimeBasedAutoScalingRequest> marshall(DescribeTimeBasedAutoScalingRequest describeTimeBasedAutoScalingRequest) {
        ...
        Request<DescribeTimeBasedAutoScalingRequest> request = new DefaultRequest<DescribeTimeBasedAutoScalingRequest>(describeTimeBasedAutoScalingRequest,
                "AWSOpsWorks");
        request.addHeader("X-Amz-Target", "OpsWorks_20130218.DescribeTimeBasedAutoScaling");
