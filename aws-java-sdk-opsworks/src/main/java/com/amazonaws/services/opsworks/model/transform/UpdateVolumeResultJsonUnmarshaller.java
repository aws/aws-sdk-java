 ...
 */
public class UpdateVolumeResultJsonUnmarshaller implements
        Unmarshaller<UpdateVolumeResult, JsonUnmarshallerContext> {

    public UpdateVolumeResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
