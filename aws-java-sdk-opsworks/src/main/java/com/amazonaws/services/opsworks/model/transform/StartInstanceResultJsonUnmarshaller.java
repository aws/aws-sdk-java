 ...
 */
public class StartInstanceResultJsonUnmarshaller implements
        Unmarshaller<StartInstanceResult, JsonUnmarshallerContext> {

    public StartInstanceResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
