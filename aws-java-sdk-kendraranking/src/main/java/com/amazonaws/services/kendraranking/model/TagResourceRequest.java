...
public class TagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A list of tag keys to add to a rescore execution plan. If a tag already exists, the existing value is replaced
     * with the new value.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the rescore execution plan to tag.
     */
     ...
     * </p>
     * 
     * @return A list of tag keys to add to a rescore execution plan. If a tag already exists, the existing value is
     ...
     * 
     * @param tags
     *        A list of tag keys to add to a rescore execution plan. If a tag already exists, the existing value is
     *        replaced with the new value.
     */
