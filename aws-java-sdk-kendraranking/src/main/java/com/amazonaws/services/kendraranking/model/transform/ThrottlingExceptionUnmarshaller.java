...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.kendraranking.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.kendraranking.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.kendraranking.model.ThrottlingException throttlingException = new com.amazonaws.services.kendraranking.model.ThrottlingException(
                null);
