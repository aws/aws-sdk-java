...
public class CreateRescoreExecutionPlanResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRescoreExecutionPlanResult == false)
            return false;
        CreateRescoreExecutionPlanResult other = (CreateRescoreExecutionPlanResult) obj;
    ...
    public CreateRescoreExecutionPlanResult clone() {
        try {
            return (CreateRescoreExecutionPlanResult) super.clone();
