...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.kendraranking.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.kendraranking.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.kendraranking.model.ValidationException validationException = new com.amazonaws.services.kendraranking.model.ValidationException(
                null);
