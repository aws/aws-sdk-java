...
public class ResourceUnavailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceUnavailableExceptionUnmarshaller() {
        super(com.amazonaws.services.kendraranking.model.ResourceUnavailableException.class, "ResourceUnavailableException");
    }

    @Override
    public com.amazonaws.services.kendraranking.model.ResourceUnavailableException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.kendraranking.model.ResourceUnavailableException resourceUnavailableException = new com.amazonaws.services.kendraranking.model.ResourceUnavailableException(
                null);
