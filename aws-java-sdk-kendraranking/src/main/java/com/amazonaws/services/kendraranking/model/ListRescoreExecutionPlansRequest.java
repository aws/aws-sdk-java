...
public class ListRescoreExecutionPlansRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * If the response is truncated, Amazon Kendra Intelligent Ranking returns a pagination token in the response. You
     * can use this pagination token to retrieve the next set of rescore execution plans.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The maximum number of rescore execution plans to return.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListRescoreExecutionPlansRequest == false)
            return false;
        ListRescoreExecutionPlansRequest other = (ListRescoreExecutionPlansRequest) obj;
    ...
    @Override
    public ListRescoreExecutionPlansRequest clone() {
        return (ListRescoreExecutionPlansRequest) super.clone();
    }
