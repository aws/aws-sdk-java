...
@SdkInternalApi
public class StopSuiteRunRequestMarshaller {
    ...
    private static final StopSuiteRunRequestMarshaller instance = new StopSuiteRunRequestMarshaller();

    public static StopSuiteRunRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StopSuiteRunRequest stopSuiteRunRequest, ProtocolMarshaller protocolMarshaller) {

        if (stopSuiteRunRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(stopSuiteRunRequest.getSuiteDefinitionId(), SUITEDEFINITIONID_BINDING);
            protocolMarshaller.marshall(stopSuiteRunRequest.getSuiteRunId(), SUITERUNID_BINDING);
        } catch (Exception e) {
