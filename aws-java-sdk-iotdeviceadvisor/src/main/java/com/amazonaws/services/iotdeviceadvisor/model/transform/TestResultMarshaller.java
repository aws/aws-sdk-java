...
public class TestResultMarshaller {
    ...
    private static final TestResultMarshaller instance = new TestResultMarshaller();

    public static TestResultMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TestResult testResult, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(testResult.getGroups(), GROUPS_BINDING);
        } catch (Exception e) {
