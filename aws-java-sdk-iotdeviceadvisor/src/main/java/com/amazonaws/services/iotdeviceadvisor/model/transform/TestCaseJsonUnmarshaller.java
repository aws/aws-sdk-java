        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("configuration", targetDepth)) {
                    context.nextToken();
                    testCase.setConfiguration(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context.getUnmarshaller(String.class))
                            .unmarshall(context));
                }
                if (context.testExpression("test", targetDepth)) {
                    context.nextToken();
                    testCase.setTest(TestCaseDefinitionJsonUnmarshaller.getInstance().unmarshall(context));
                }
