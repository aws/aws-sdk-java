...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.iotdeviceadvisor.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.iotdeviceadvisor.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iotdeviceadvisor.model.ValidationException validationException = new com.amazonaws.services.iotdeviceadvisor.model.ValidationException(
                null);
