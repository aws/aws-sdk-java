...
/**
 * StopSuiteRunResult JSON Unmarshaller
 */
...
public class StopSuiteRunResultJsonUnmarshaller implements Unmarshaller<StopSuiteRunResult, JsonUnmarshallerContext> {
    ...
    public StopSuiteRunResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopSuiteRunResult stopSuiteRunResult = new StopSuiteRunResult();
