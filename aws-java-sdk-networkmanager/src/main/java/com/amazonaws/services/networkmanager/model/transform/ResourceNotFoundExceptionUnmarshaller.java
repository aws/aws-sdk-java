...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.networkmanager.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.networkmanager.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.networkmanager.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.networkmanager.model.ResourceNotFoundException(
                null);
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Context", targetDepth)) {
                    context.nextToken();
                    resourceNotFoundException.setContext(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
