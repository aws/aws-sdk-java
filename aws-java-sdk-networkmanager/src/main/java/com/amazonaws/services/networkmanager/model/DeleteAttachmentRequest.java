...
public class DeleteAttachmentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the attachment to delete.
     */
    ...
    public DeleteAttachmentRequest withAttachmentId(String attachmentId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAttachmentRequest == false)
            return false;
    ...
    public DeleteAttachmentRequest clone() {
        return (DeleteAttachmentRequest) super.clone();
    }
