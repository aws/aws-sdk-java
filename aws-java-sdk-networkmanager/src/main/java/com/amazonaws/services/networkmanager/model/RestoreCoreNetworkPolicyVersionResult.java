...
public class RestoreCoreNetworkPolicyVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return Describes the restored core network policy.
     */
    ...
    public RestoreCoreNetworkPolicyVersionResult withCoreNetworkPolicy(CoreNetworkPolicy coreNetworkPolicy) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RestoreCoreNetworkPolicyVersionResult == false)
            return false;
        RestoreCoreNetworkPolicyVersionResult other = (RestoreCoreNetworkPolicyVersionResult) obj;
    ...
    @Override
    public RestoreCoreNetworkPolicyVersionResult clone() {
        try {
            return (RestoreCoreNetworkPolicyVersionResult) super.clone();
