...
public class GetDevicesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetDevicesResult withDevices(Device... devices) {
    ...
    public GetDevicesResult withDevices(java.util.Collection<Device> devices) {
        setDevices(devices);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDevicesResult == false)
            return false;
        GetDevicesResult other = (GetDevicesResult) obj;
    ...
    public GetDevicesResult clone() {
        try {
            return (GetDevicesResult) super.clone();
