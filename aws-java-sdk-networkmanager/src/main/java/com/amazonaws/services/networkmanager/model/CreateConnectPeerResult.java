...
public class CreateConnectPeerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateConnectPeerResult withConnectPeer(ConnectPeer connectPeer) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateConnectPeerResult == false)
            return false;
        CreateConnectPeerResult other = (CreateConnectPeerResult) obj;
    ...
    @Override
    public CreateConnectPeerResult clone() {
        try {
            return (CreateConnectPeerResult) super.clone();
