...
public class CreateTransitGatewayPeeringResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Returns information about the transit gateway peering connection request.
     */
    ...
    public CreateTransitGatewayPeeringResult withTransitGatewayPeering(TransitGatewayPeering transitGatewayPeering) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTransitGatewayPeeringResult == false)
            return false;
        CreateTransitGatewayPeeringResult other = (CreateTransitGatewayPeeringResult) obj;
    ...
    @Override
    public CreateTransitGatewayPeeringResult clone() {
        try {
            return (CreateTransitGatewayPeeringResult) super.clone();
