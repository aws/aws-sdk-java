...
public class GetConnectionsRequestMarshaller {
    ...
    private static final MarshallingInfo<List> CONNECTIONIDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("connectionIds").build();
    ...
    public void marshall(GetConnectionsRequest getConnectionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getConnectionsRequest.getGlobalNetworkId(), GLOBALNETWORKID_BINDING);
            protocolMarshaller.marshall(getConnectionsRequest.getConnectionIds(), CONNECTIONIDS_BINDING);
            protocolMarshaller.marshall(getConnectionsRequest.getDeviceId(), DEVICEID_BINDING);
