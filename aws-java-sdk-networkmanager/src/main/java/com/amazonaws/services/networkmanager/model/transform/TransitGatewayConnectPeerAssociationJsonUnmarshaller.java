...
/**
 * TransitGatewayConnectPeerAssociation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TransitGatewayConnectPeerAssociationJsonUnmarshaller implements Unmarshaller<TransitGatewayConnectPeerAssociation, JsonUnmarshallerContext> {

    public TransitGatewayConnectPeerAssociation unmarshall(JsonUnmarshallerContext context) throws Exception {
        TransitGatewayConnectPeerAssociation transitGatewayConnectPeerAssociation = new TransitGatewayConnectPeerAssociation();
    ...
    private static TransitGatewayConnectPeerAssociationJsonUnmarshaller instance;

    public static TransitGatewayConnectPeerAssociationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TransitGatewayConnectPeerAssociationJsonUnmarshaller();
        return instance;
    }
}
