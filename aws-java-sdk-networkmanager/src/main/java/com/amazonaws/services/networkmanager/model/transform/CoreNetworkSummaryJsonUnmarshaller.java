...
/**
 * CoreNetworkSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CoreNetworkSummaryJsonUnmarshaller implements Unmarshaller<CoreNetworkSummary, JsonUnmarshallerContext> {

    public CoreNetworkSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        CoreNetworkSummary coreNetworkSummary = new CoreNetworkSummary();
    ...
    private static CoreNetworkSummaryJsonUnmarshaller instance;

    public static CoreNetworkSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CoreNetworkSummaryJsonUnmarshaller();
        return instance;
    }
}
