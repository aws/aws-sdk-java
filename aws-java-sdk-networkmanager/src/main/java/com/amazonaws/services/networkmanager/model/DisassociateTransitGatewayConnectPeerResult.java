...
public class DisassociateTransitGatewayConnectPeerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DisassociateTransitGatewayConnectPeerResult withTransitGatewayConnectPeerAssociation(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateTransitGatewayConnectPeerResult == false)
            return false;
        DisassociateTransitGatewayConnectPeerResult other = (DisassociateTransitGatewayConnectPeerResult) obj;
    ...
    @Override
    public DisassociateTransitGatewayConnectPeerResult clone() {
        try {
            return (DisassociateTransitGatewayConnectPeerResult) super.clone();
