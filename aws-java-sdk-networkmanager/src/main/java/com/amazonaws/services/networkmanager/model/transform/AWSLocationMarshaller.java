...
/**
 * AWSLocationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AWSLocationMarshaller {

    private static final MarshallingInfo<String> ZONE_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Zone").build();
    ...
    public void marshall(AWSLocation aWSLocation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(aWSLocation.getZone(), ZONE_BINDING);
            protocolMarshaller.marshall(aWSLocation.getSubnetArn(), SUBNETARN_BINDING);
        } catch (Exception e) {
