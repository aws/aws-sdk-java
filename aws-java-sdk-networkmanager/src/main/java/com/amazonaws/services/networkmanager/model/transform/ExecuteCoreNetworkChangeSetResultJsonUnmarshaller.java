...
/**
 * ExecuteCoreNetworkChangeSetResult JSON Unmarshaller
 */
...
public class ExecuteCoreNetworkChangeSetResultJsonUnmarshaller implements Unmarshaller<ExecuteCoreNetworkChangeSetResult, JsonUnmarshallerContext> {
    ...
    public ExecuteCoreNetworkChangeSetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ExecuteCoreNetworkChangeSetResult executeCoreNetworkChangeSetResult = new ExecuteCoreNetworkChangeSetResult();

        return executeCoreNetworkChangeSetResult;
    }
