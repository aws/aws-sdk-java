...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/networkmanager-2019-07-05/DeleteGlobalNetwork" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteGlobalNetworkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteGlobalNetworkResult withGlobalNetwork(GlobalNetwork globalNetwork) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteGlobalNetworkResult == false)
            return false;
        DeleteGlobalNetworkResult other = (DeleteGlobalNetworkResult) obj;
    ...
    @Override
    public DeleteGlobalNetworkResult clone() {
        try {
            return (DeleteGlobalNetworkResult) super.clone();
