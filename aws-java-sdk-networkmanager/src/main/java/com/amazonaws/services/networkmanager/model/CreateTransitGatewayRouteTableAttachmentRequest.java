...
public class CreateTransitGatewayRouteTableAttachmentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateTransitGatewayRouteTableAttachmentRequest withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public CreateTransitGatewayRouteTableAttachmentRequest withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTransitGatewayRouteTableAttachmentRequest == false)
            return false;
    ...
    public CreateTransitGatewayRouteTableAttachmentRequest clone() {
        return (CreateTransitGatewayRouteTableAttachmentRequest) super.clone();
    }
