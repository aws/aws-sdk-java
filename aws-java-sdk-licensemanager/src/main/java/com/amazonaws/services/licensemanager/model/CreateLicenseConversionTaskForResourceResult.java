...
public class CreateLicenseConversionTaskForResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the created license type conversion task.
     */
    ...
    public CreateLicenseConversionTaskForResourceResult withLicenseConversionTaskId(String licenseConversionTaskId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLicenseConversionTaskForResourceResult == false)
            return false;
        CreateLicenseConversionTaskForResourceResult other = (CreateLicenseConversionTaskForResourceResult) obj;
    ...
    @Override
    public CreateLicenseConversionTaskForResourceResult clone() {
        try {
            return (CreateLicenseConversionTaskForResourceResult) super.clone();
