...
public class ListDistributedGrantsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDistributedGrantsRequest withGrantArns(java.util.Collection<String> grantArns) {
    ...
    public ListDistributedGrantsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public ListDistributedGrantsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDistributedGrantsRequest == false)
            return false;
        ListDistributedGrantsRequest other = (ListDistributedGrantsRequest) obj;
    ...
    @Override
    public ListDistributedGrantsRequest clone() {
        return (ListDistributedGrantsRequest) super.clone();
    }
