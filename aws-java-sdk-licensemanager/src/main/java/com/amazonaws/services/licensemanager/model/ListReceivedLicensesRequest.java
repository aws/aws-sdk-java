...
public class ListReceivedLicensesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListReceivedLicensesRequest withLicenseArns(java.util.Collection<String> licenseArns) {
    ...
    public ListReceivedLicensesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public ListReceivedLicensesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListReceivedLicensesRequest == false)
            return false;
        ListReceivedLicensesRequest other = (ListReceivedLicensesRequest) obj;
    ...
    @Override
    public ListReceivedLicensesRequest clone() {
