...
public class ResourceLimitExceededExceptionUnmarshaller extends
        JsonErrorUnmarshaller<com.amazonaws.services.licensemanager.model.ResourceLimitExceededException> {
    private ResourceLimitExceededExceptionUnmarshaller() {
        super("ResourceLimitExceededException");
    }

    @Override
    public com.amazonaws.services.licensemanager.model.ResourceLimitExceededException unmarshall(JsonUnmarshallerContext context) throws Exception {
