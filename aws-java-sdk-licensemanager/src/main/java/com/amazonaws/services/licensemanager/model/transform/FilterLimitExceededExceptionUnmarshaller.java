...
public class FilterLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FilterLimitExceededExceptionUnmarshaller instance;

    public static FilterLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FilterLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
