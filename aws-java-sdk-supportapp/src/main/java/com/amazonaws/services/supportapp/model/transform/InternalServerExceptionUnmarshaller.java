...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.supportapp.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.supportapp.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.supportapp.model.InternalServerException internalServerException = new com.amazonaws.services.supportapp.model.InternalServerException(
                null);
