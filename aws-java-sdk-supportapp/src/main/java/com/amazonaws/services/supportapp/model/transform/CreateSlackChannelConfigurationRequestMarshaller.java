...
public class CreateSlackChannelConfigurationRequestMarshaller {
    ...
    public void marshall(CreateSlackChannelConfigurationRequest createSlackChannelConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createSlackChannelConfigurationRequest.getChannelId(), CHANNELID_BINDING);
            protocolMarshaller.marshall(createSlackChannelConfigurationRequest.getChannelName(), CHANNELNAME_BINDING);
            protocolMarshaller.marshall(createSlackChannelConfigurationRequest.getChannelRoleArn(), CHANNELROLEARN_BINDING);
            protocolMarshaller.marshall(createSlackChannelConfigurationRequest.getNotifyOnAddCorrespondenceToCase(), NOTIFYONADDCORRESPONDENCETOCASE_BINDING);
            protocolMarshaller.marshall(createSlackChannelConfigurationRequest.getNotifyOnCaseSeverity(), NOTIFYONCASESEVERITY_BINDING);
            protocolMarshaller.marshall(createSlackChannelConfigurationRequest.getNotifyOnCreateOrReopenCase(), NOTIFYONCREATEORREOPENCASE_BINDING);
            protocolMarshaller.marshall(createSlackChannelConfigurationRequest.getNotifyOnResolveCase(), NOTIFYONRESOLVECASE_BINDING);
            protocolMarshaller.marshall(createSlackChannelConfigurationRequest.getTeamId(), TEAMID_BINDING);
        } catch (Exception e) {
