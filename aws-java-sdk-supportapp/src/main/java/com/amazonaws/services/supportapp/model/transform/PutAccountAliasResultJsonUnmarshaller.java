...
/**
 * PutAccountAliasResult JSON Unmarshaller
 */
...
public class PutAccountAliasResultJsonUnmarshaller implements Unmarshaller<PutAccountAliasResult, JsonUnmarshallerContext> {
    ...
    public PutAccountAliasResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutAccountAliasResult putAccountAliasResult = new PutAccountAliasResult();
