...
/**
 * DeleteSlackChannelConfigurationResult JSON Unmarshaller
 */
...
public class DeleteSlackChannelConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteSlackChannelConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteSlackChannelConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSlackChannelConfigurationResult deleteSlackChannelConfigurationResult = new DeleteSlackChannelConfigurationResult();
