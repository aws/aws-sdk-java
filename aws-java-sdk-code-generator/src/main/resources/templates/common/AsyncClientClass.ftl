...
<#if customizationConfig.emitClientConstructors()>
    ...
    *
    * @param asyncClientParams Object providing client parameters.
    * @param endpointDiscoveryEnabled true will enable endpoint discovery if the service supports it.
    */
    ${metadata.asyncClient}(AwsAsyncClientParams asyncClientParams, boolean endpointDiscoveryEnabled) {
