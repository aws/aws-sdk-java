 ...
 */
final class AddOutputShapes extends AddShapes {
    AddOutputShapes(ServiceModel serviceModel, CustomizationConfig customizationConfig) {
        super(serviceModel, customizationConfig);
    }

    public final Map<String, ShapeModel> constructOutputShapes() {
        ...
        for (Map.Entry<String, Operation> entry : operations.entrySet()) {
            ...
            if (output != null) {
                ...
                String javaResponseClassName = NameUtils.getResponseClassName(
                        output.getShape(), operationName);

                ShapeModel outputShape = generateOutputShapeModel(operation, javaResponseClassName, c2jShapes);
    ...
    private final ShapeModel generateOutputShapeModel(Operation c2jOperationModel, String javaOutputShapeNameOverride, Map<String, Shape> c2jShapes) {
        ...
        ShapeUnmarshaller shapeUnmarshaller =
                new ShapeUnmarshaller()
