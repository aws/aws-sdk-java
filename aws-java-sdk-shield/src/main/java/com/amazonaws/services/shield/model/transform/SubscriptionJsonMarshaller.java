    ...
    public void marshall(Subscription subscription, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (subscription.getStartTime() != null) {
                jsonGenerator.writeFieldName("StartTime").writeValue(subscription.getStartTime());
            }
            if (subscription.getTimeCommitmentInSeconds() != null) {
                jsonGenerator.writeFieldName("TimeCommitmentInSeconds").writeValue(subscription.getTimeCommitmentInSeconds());
            }
