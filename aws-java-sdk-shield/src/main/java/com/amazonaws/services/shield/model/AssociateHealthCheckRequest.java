...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/shield-2016-06-02/AssociateHealthCheck" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssociateHealthCheckRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * The unique identifier (ID) for the <a>Protection</a> object to add the health check association to.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The unique identifier (ID) for the <a>Protection</a> object to add the health check association to.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateHealthCheckRequest == false)
            return false;
        AssociateHealthCheckRequest other = (AssociateHealthCheckRequest) obj;
    ...
    @Override
    public AssociateHealthCheckRequest clone() {
        return (AssociateHealthCheckRequest) super.clone();
    }
