...
/**
 * AssociateHealthCheckResult JSON Unmarshaller
 */
...
public class AssociateHealthCheckResultJsonUnmarshaller implements Unmarshaller<AssociateHealthCheckResult, JsonUnmarshallerContext> {
    ...
    public AssociateHealthCheckResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateHealthCheckResult associateHealthCheckResult = new AssociateHealthCheckResult();

        return associateHealthCheckResult;
    }
