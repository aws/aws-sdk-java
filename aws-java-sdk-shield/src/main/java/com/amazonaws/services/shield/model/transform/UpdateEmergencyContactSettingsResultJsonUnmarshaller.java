...
/**
 * UpdateEmergencyContactSettingsResult JSON Unmarshaller
 */
...
public class UpdateEmergencyContactSettingsResultJsonUnmarshaller implements Unmarshaller<UpdateEmergencyContactSettingsResult, JsonUnmarshallerContext> {
    ...
    public UpdateEmergencyContactSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateEmergencyContactSettingsResult updateEmergencyContactSettingsResult = new UpdateEmergencyContactSettingsResult();
