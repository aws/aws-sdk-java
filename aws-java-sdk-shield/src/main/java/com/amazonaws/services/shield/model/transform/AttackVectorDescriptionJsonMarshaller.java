...
public class AttackVectorDescriptionJsonMarshaller {
     ...
     */
    public void marshall(AttackVectorDescription attackVectorDescription, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (attackVectorDescription.getVectorType() != null) {
                jsonGenerator.writeFieldName("VectorType").writeValue(attackVectorDescription.getVectorType());
            }
