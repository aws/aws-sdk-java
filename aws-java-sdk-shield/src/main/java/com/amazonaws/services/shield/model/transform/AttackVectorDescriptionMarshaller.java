...
/**
 * AttackVectorDescriptionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AttackVectorDescriptionMarshaller {

    private static final MarshallingInfo<String> VECTORTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("VectorType").build();
    ...
    public void marshall(AttackVectorDescription attackVectorDescription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(attackVectorDescription.getVectorType(), VECTORTYPE_BINDING);
        } catch (Exception e) {
