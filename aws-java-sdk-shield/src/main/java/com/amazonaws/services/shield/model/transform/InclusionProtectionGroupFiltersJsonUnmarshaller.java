...
/**
 * InclusionProtectionGroupFilters JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InclusionProtectionGroupFiltersJsonUnmarshaller implements Unmarshaller<InclusionProtectionGroupFilters, JsonUnmarshallerContext> {

    public InclusionProtectionGroupFilters unmarshall(JsonUnmarshallerContext context) throws Exception {
        InclusionProtectionGroupFilters inclusionProtectionGroupFilters = new InclusionProtectionGroupFilters();
    ...
    private static InclusionProtectionGroupFiltersJsonUnmarshaller instance;

    public static InclusionProtectionGroupFiltersJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new InclusionProtectionGroupFiltersJsonUnmarshaller();
        return instance;
    }
}
