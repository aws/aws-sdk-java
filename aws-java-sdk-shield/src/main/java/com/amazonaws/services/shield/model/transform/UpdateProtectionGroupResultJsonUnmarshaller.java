...
/**
 * UpdateProtectionGroupResult JSON Unmarshaller
 */
...
public class UpdateProtectionGroupResultJsonUnmarshaller implements Unmarshaller<UpdateProtectionGroupResult, JsonUnmarshallerContext> {
    ...
    public UpdateProtectionGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateProtectionGroupResult updateProtectionGroupResult = new UpdateProtectionGroupResult();

        return updateProtectionGroupResult;
    }
