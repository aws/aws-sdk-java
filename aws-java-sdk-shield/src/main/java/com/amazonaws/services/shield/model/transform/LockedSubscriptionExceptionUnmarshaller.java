...
public class LockedSubscriptionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LockedSubscriptionExceptionUnmarshaller instance;

    public static LockedSubscriptionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LockedSubscriptionExceptionUnmarshaller();
        return instance;
    }
}
