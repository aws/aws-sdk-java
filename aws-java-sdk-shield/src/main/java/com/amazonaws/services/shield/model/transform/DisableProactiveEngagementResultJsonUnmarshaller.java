...
/**
 * DisableProactiveEngagementResult JSON Unmarshaller
 */
...
public class DisableProactiveEngagementResultJsonUnmarshaller implements Unmarshaller<DisableProactiveEngagementResult, JsonUnmarshallerContext> {
    ...
    public DisableProactiveEngagementResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisableProactiveEngagementResult disableProactiveEngagementResult = new DisableProactiveEngagementResult();

        return disableProactiveEngagementResult;
    }
