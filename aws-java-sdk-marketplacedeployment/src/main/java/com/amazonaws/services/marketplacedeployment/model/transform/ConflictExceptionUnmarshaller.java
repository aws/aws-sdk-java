...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.marketplacedeployment.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.marketplacedeployment.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.marketplacedeployment.model.ConflictException conflictException = new com.amazonaws.services.marketplacedeployment.model.ConflictException(
                null);
