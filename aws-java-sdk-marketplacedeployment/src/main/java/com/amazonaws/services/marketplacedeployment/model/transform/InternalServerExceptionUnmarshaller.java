...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.marketplacedeployment.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.marketplacedeployment.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.marketplacedeployment.model.InternalServerException internalServerException = new com.amazonaws.services.marketplacedeployment.model.InternalServerException(
                null);
