...
/**
 * FetchPageRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FetchPageRequestMarshaller {
    ...
    private static final FetchPageRequestMarshaller instance = new FetchPageRequestMarshaller();

    public static FetchPageRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FetchPageRequest fetchPageRequest, ProtocolMarshaller protocolMarshaller) {

        if (fetchPageRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(fetchPageRequest.getTransactionId(), TRANSACTIONID_BINDING);
            protocolMarshaller.marshall(fetchPageRequest.getNextPageToken(), NEXTPAGETOKEN_BINDING);
        } catch (Exception e) {
