...
/**
 * AbortTransactionRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AbortTransactionRequestJsonUnmarshaller implements Unmarshaller<AbortTransactionRequest, JsonUnmarshallerContext> {
    ...
    public static AbortTransactionRequestJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AbortTransactionRequestJsonUnmarshaller();
        return instance;
    }
}
