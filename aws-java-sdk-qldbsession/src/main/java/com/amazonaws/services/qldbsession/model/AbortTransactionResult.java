 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/qldb-session-2019-07-11/AbortTransactionResult"
...
public class AbortTransactionResult implements Serializable, Cloneable, StructuredPojo {
    ...
    public AbortTransactionResult clone() {
        try {
            return (AbortTransactionResult) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.qldbsession.model.transform.AbortTransactionResultMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
