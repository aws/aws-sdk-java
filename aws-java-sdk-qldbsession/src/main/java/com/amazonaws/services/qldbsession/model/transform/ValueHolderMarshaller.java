...
public class ValueHolderMarshaller {
    ...
    private static final MarshallingInfo<java.nio.ByteBuffer> IONBINARY_BINDING = MarshallingInfo.builder(MarshallingType.BYTE_BUFFER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("IonBinary").build();
    ...
    public void marshall(ValueHolder valueHolder, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(valueHolder.getIonBinary(), IONBINARY_BINDING);
