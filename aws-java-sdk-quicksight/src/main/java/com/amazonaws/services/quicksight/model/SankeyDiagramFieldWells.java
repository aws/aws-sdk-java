 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/SankeyDiagramFieldWells" target="_top">AWS
 *      API Documentation</a>
 */
...
public class SankeyDiagramFieldWells implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SankeyDiagramFieldWells == false)
            return false;
        SankeyDiagramFieldWells other = (SankeyDiagramFieldWells) obj;
        if (other.getSankeyDiagramAggregatedFieldWells() == null ^ this.getSankeyDiagramAggregatedFieldWells() == null)
            return false;
        if (other.getSankeyDiagramAggregatedFieldWells() != null
                && other.getSankeyDiagramAggregatedFieldWells().equals(this.getSankeyDiagramAggregatedFieldWells()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSankeyDiagramAggregatedFieldWells() == null) ? 0 : getSankeyDiagramAggregatedFieldWells().hashCode());
        return hashCode;
    }

    @Override
    public SankeyDiagramFieldWells clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.SankeyDiagramFieldWellsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
