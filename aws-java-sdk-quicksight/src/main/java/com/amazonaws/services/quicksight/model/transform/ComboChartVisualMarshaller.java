...
/**
 * ComboChartVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ComboChartVisualMarshaller {
    ...
    private static final ComboChartVisualMarshaller instance = new ComboChartVisualMarshaller();

    public static ComboChartVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ComboChartVisual comboChartVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(comboChartVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(comboChartVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(comboChartVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(comboChartVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(comboChartVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(comboChartVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
