...
/**
 * LineChartAggregatedFieldWellsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LineChartAggregatedFieldWellsMarshaller {
    ...
    private static final LineChartAggregatedFieldWellsMarshaller instance = new LineChartAggregatedFieldWellsMarshaller();

    public static LineChartAggregatedFieldWellsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LineChartAggregatedFieldWells lineChartAggregatedFieldWells, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(lineChartAggregatedFieldWells.getCategory(), CATEGORY_BINDING);
            protocolMarshaller.marshall(lineChartAggregatedFieldWells.getValues(), VALUES_BINDING);
            protocolMarshaller.marshall(lineChartAggregatedFieldWells.getColors(), COLORS_BINDING);
            protocolMarshaller.marshall(lineChartAggregatedFieldWells.getSmallMultiples(), SMALLMULTIPLES_BINDING);
        } catch (Exception e) {
