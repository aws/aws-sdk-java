...
public class SearchGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<GroupSearchFilter> filters;
     ...
     * </p>
     * 
     * @return The namespace that you want to search.
     */
    ...
    public java.util.List<GroupSearchFilter> getFilters() {
        return filters;
    }
    ...
    public void setFilters(java.util.Collection<GroupSearchFilter> filters) {
        if (filters == null) {
            this.filters = null;
            return;
        }

        this.filters = new java.util.ArrayList<GroupSearchFilter>(filters);
    }
    ...
    public SearchGroupsRequest withFilters(GroupSearchFilter... filters) {
        if (this.filters == null) {
            setFilters(new java.util.ArrayList<GroupSearchFilter>(filters.length));
        }
        for (GroupSearchFilter ele : filters) {
    ...
    public SearchGroupsRequest withFilters(java.util.Collection<GroupSearchFilter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchGroupsRequest == false)
            return false;
    ...
    public SearchGroupsRequest clone() {
        return (SearchGroupsRequest) super.clone();
    }
