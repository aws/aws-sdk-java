...
public class ListGroupsResultJsonUnmarshaller implements Unmarshaller<ListGroupsResult, JsonUnmarshallerContext> {
    ...
    public ListGroupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        listGroupsResult.setStatus(context.getHttpResponse().getStatusCode());
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GroupList", targetDepth)) {
                    context.nextToken();
                    listGroupsResult.setGroupList(new ListUnmarshaller<Group>(GroupJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                ...
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    listGroupsResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
