...
/**
 * FilterDropDownControlMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FilterDropDownControlMarshaller {
    ...
    private static final FilterDropDownControlMarshaller instance = new FilterDropDownControlMarshaller();

    public static FilterDropDownControlMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FilterDropDownControl filterDropDownControl, ProtocolMarshaller protocolMarshaller) {

        if (filterDropDownControl == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(filterDropDownControl.getFilterControlId(), FILTERCONTROLID_BINDING);
            protocolMarshaller.marshall(filterDropDownControl.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(filterDropDownControl.getSourceFilterId(), SOURCEFILTERID_BINDING);
            protocolMarshaller.marshall(filterDropDownControl.getDisplayOptions(), DISPLAYOPTIONS_BINDING);
            protocolMarshaller.marshall(filterDropDownControl.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(filterDropDownControl.getSelectableValues(), SELECTABLEVALUES_BINDING);
            protocolMarshaller.marshall(filterDropDownControl.getCascadingControlConfiguration(), CASCADINGCONTROLCONFIGURATION_BINDING);
        } catch (Exception e) {
