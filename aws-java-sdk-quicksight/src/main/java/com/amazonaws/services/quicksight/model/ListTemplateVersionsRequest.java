...
public class ListTemplateVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the Amazon Web Services account that contains the templates that you're listing.
     */
    ...
    public ListTemplateVersionsRequest withAwsAccountId(String awsAccountId) {
    ...
    public ListTemplateVersionsRequest withMaxResults(Integer maxResults) {
