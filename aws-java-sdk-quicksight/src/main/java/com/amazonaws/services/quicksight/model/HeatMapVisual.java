 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/HeatMapVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HeatMapVisual implements Serializable, Cloneable, StructuredPojo {
    ...
    public HeatMapVisual withVisualId(String visualId) {
    ...
    public HeatMapVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public HeatMapVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(HeatMapConfiguration chartConfiguration) {
     ...
     * </p>
     * 
     * @return The configuration of a heat map.
     */

    public HeatMapConfiguration getChartConfiguration() {
    ...
    public HeatMapVisual withChartConfiguration(HeatMapConfiguration chartConfiguration) {
    ...
    public HeatMapVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public HeatMapVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public HeatMapVisual withActions(VisualCustomAction... actions) {
    ...
    public HeatMapVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HeatMapVisual == false)
            return false;
        HeatMapVisual other = (HeatMapVisual) obj;
    ...
    @Override
    public HeatMapVisual clone() {
        try {
            return (HeatMapVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.HeatMapVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
