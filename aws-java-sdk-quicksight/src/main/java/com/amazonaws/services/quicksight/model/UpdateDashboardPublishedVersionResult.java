...
public class UpdateDashboardPublishedVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDashboardPublishedVersionResult == false)
            return false;
        UpdateDashboardPublishedVersionResult other = (UpdateDashboardPublishedVersionResult) obj;
    ...
    public UpdateDashboardPublishedVersionResult clone() {
        try {
            return (UpdateDashboardPublishedVersionResult) super.clone();
