...
public class IntegerParameter implements Serializable, Cloneable, StructuredPojo {
    ...
    public IntegerParameter clone() {
        try {
            return (IntegerParameter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.IntegerParameterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
