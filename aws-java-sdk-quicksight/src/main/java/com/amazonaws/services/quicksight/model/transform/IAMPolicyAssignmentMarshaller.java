...
/**
 * IAMPolicyAssignmentMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class IAMPolicyAssignmentMarshaller {
    ...
    private static final IAMPolicyAssignmentMarshaller instance = new IAMPolicyAssignmentMarshaller();

    public static IAMPolicyAssignmentMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(IAMPolicyAssignment iAMPolicyAssignment, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(iAMPolicyAssignment.getAwsAccountId(), AWSACCOUNTID_BINDING);
            protocolMarshaller.marshall(iAMPolicyAssignment.getAssignmentId(), ASSIGNMENTID_BINDING);
            protocolMarshaller.marshall(iAMPolicyAssignment.getAssignmentName(), ASSIGNMENTNAME_BINDING);
            protocolMarshaller.marshall(iAMPolicyAssignment.getPolicyArn(), POLICYARN_BINDING);
            protocolMarshaller.marshall(iAMPolicyAssignment.getIdentities(), IDENTITIES_BINDING);
            protocolMarshaller.marshall(iAMPolicyAssignment.getAssignmentStatus(), ASSIGNMENTSTATUS_BINDING);
        } catch (Exception e) {
