...
/**
 * RowLevelPermissionDataSet JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RowLevelPermissionDataSetJsonUnmarshaller implements Unmarshaller<RowLevelPermissionDataSet, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    rowLevelPermissionDataSet.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
