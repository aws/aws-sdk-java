...
/**
 * CreateIAMPolicyAssignmentResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateIAMPolicyAssignmentResultJsonUnmarshaller implements Unmarshaller<CreateIAMPolicyAssignmentResult, JsonUnmarshallerContext> {

    public CreateIAMPolicyAssignmentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
