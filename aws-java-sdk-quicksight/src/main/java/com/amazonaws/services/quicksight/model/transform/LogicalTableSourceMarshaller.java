...
/**
 * LogicalTableSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LogicalTableSourceMarshaller {

    private static final MarshallingInfo<StructuredPojo> JOININSTRUCTION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public static LogicalTableSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LogicalTableSource logicalTableSource, ProtocolMarshaller protocolMarshaller) {

        if (logicalTableSource == null) {
