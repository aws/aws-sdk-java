...
public class DescribeAccountCustomizationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the customization that's associated with this AWS account.
     */
    ...
    public DescribeAccountCustomizationResult clone() {
        try {
            return (DescribeAccountCustomizationResult) super.clone();
