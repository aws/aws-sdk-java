...
@SdkInternalApi
public class RegisteredUserQuickSightConsoleEmbeddingConfigurationMarshaller {
    ...
    public static RegisteredUserQuickSightConsoleEmbeddingConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RegisteredUserQuickSightConsoleEmbeddingConfiguration registeredUserQuickSightConsoleEmbeddingConfiguration,
            ProtocolMarshaller protocolMarshaller) {

        if (registeredUserQuickSightConsoleEmbeddingConfiguration == null) {
