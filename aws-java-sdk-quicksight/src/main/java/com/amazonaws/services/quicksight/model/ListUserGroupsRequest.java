...
public class ListUserGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The Amazon Web Services account ID that the user is in. Currently, you use the ID for the Amazon Web Services
     ...
     * 
     * @param awsAccountId
     *        The Amazon Web Services account ID that the user is in. Currently, you use the ID for the Amazon Web
     ...
     * </p>
     * 
     * @return The Amazon Web Services account ID that the user is in. Currently, you use the ID for the Amazon Web
     *         Services account that contains your Amazon QuickSight account.
     */
