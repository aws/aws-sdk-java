...
public class ListUsersRequestMarshaller {
    ...
    public void marshall(ListUsersRequest listUsersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listUsersRequest.getAwsAccountId(), AWSACCOUNTID_BINDING);
            ...
            protocolMarshaller.marshall(listUsersRequest.getNamespace(), NAMESPACE_BINDING);
        } catch (Exception e) {
