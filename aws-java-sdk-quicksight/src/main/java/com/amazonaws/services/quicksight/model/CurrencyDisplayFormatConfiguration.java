 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/CurrencyDisplayFormatConfiguration"
...
public class CurrencyDisplayFormatConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Determines the prefix value of the currency format.
     */
    ...
    public CurrencyDisplayFormatConfiguration withPrefix(String prefix) {
        setPrefix(prefix);
        return this;
    }
     ...
     * </p>
     * 
     * @return Determines the suffix value of the currency format.
     */
    ...
    public CurrencyDisplayFormatConfiguration withSuffix(String suffix) {
        setSuffix(suffix);
        return this;
    }
    ...
    public CurrencyDisplayFormatConfiguration withSeparatorConfiguration(NumericSeparatorConfiguration separatorConfiguration) {
     ...
     * </p>
     * 
     * @return Determines the symbol for the currency format.
     */
    ...
    public CurrencyDisplayFormatConfiguration withSymbol(String symbol) {
        setSymbol(symbol);
        return this;
    }
     ...
     * </p>
     * 
     * @return Determines the number scale value for the currency format.
     * @see NumberScale
     */
    ...
    public CurrencyDisplayFormatConfiguration withNumberScale(String numberScale) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CurrencyDisplayFormatConfiguration == false)
            return false;
        CurrencyDisplayFormatConfiguration other = (CurrencyDisplayFormatConfiguration) obj;
    ...
    @Override
    public CurrencyDisplayFormatConfiguration clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.CurrencyDisplayFormatConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
