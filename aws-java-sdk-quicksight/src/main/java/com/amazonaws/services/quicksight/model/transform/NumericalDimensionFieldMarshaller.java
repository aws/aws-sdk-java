...
/**
 * NumericalDimensionFieldMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class NumericalDimensionFieldMarshaller {
    ...
    private static final NumericalDimensionFieldMarshaller instance = new NumericalDimensionFieldMarshaller();

    public static NumericalDimensionFieldMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(NumericalDimensionField numericalDimensionField, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(numericalDimensionField.getFieldId(), FIELDID_BINDING);
            protocolMarshaller.marshall(numericalDimensionField.getColumn(), COLUMN_BINDING);
            protocolMarshaller.marshall(numericalDimensionField.getHierarchyId(), HIERARCHYID_BINDING);
            protocolMarshaller.marshall(numericalDimensionField.getFormatConfiguration(), FORMATCONFIGURATION_BINDING);
        } catch (Exception e) {
