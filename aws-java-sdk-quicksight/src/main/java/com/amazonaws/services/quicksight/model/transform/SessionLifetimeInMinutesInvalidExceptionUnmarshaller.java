...
public class SessionLifetimeInMinutesInvalidExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    sessionLifetimeInMinutesInvalidException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static SessionLifetimeInMinutesInvalidExceptionUnmarshaller instance;

    public static SessionLifetimeInMinutesInvalidExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SessionLifetimeInMinutesInvalidExceptionUnmarshaller();
        return instance;
    }
}
