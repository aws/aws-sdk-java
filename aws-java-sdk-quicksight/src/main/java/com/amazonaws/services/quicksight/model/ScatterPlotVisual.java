 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/ScatterPlotVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScatterPlotVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private ScatterPlotConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public ScatterPlotVisual withVisualId(String visualId) {
    ...
    public ScatterPlotVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public ScatterPlotVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(ScatterPlotConfiguration chartConfiguration) {
    ...
    public ScatterPlotConfiguration getChartConfiguration() {
    ...
    public ScatterPlotVisual withChartConfiguration(ScatterPlotConfiguration chartConfiguration) {
    ...
    public ScatterPlotVisual withActions(VisualCustomAction... actions) {
    ...
    public ScatterPlotVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public ScatterPlotVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public ScatterPlotVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScatterPlotVisual == false)
            return false;
        ScatterPlotVisual other = (ScatterPlotVisual) obj;
    ...
    @Override
    public ScatterPlotVisual clone() {
        try {
            return (ScatterPlotVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.ScatterPlotVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
