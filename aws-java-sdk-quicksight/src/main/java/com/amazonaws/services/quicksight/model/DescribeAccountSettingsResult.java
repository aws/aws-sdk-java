...
public class DescribeAccountSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The settings associated with the QuickSight subscription associated with this AWS account. This information
     * includes the edition of Amazon QuickSight that you subscribed to (Standard or Enterprise) and the notification
     * email for the QuickSight subscription. The QuickSight console, the QuickSight subscription is sometimes referred
     * to as a QuickSight "account" even though it is technically not an account, but a subscription in your AWS
     * account.
     * </p>
     */
     ...
     *        The settings associated with the QuickSight subscription associated with this AWS account. This
     ...
     *        account, but a subscription in your AWS account.
     */
     ...
     * </p>
     * 
     * @return The settings associated with the QuickSight subscription associated with this AWS account. This
     *         information includes the edition of Amazon QuickSight that you subscribed to (Standard or Enterprise) and
     *         the notification email for the QuickSight subscription. The QuickSight console, the QuickSight
     *         subscription is sometimes referred to as a QuickSight "account" even though it is technically not an
     *         account, but a subscription in your AWS account.
