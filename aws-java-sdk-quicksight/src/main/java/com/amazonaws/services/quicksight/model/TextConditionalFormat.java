 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/TextConditionalFormat" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TextConditionalFormat implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The conditional formatting for the text background color.
     */
    ...
    public TextConditionalFormat withBackgroundColor(ConditionalFormattingColor backgroundColor) {
     ...
     * </p>
     * 
     * @return The conditional formatting for the text color.
     */
    ...
    public TextConditionalFormat withTextColor(ConditionalFormattingColor textColor) {
     ...
     * </p>
     * 
     * @return The conditional formatting for the icon.
     */
    ...
    public TextConditionalFormat withIcon(ConditionalFormattingIcon icon) {
        setIcon(icon);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextConditionalFormat == false)
            return false;
        TextConditionalFormat other = (TextConditionalFormat) obj;
    ...
    @Override
    public TextConditionalFormat clone() {
        try {
            return (TextConditionalFormat) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.TextConditionalFormatMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
