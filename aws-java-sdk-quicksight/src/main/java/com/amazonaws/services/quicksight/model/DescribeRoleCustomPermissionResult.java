...
public class DescribeRoleCustomPermissionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the custom permission that is described.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeRoleCustomPermissionResult == false)
            return false;
        DescribeRoleCustomPermissionResult other = (DescribeRoleCustomPermissionResult) obj;
    ...
    public DescribeRoleCustomPermissionResult clone() {
        try {
            return (DescribeRoleCustomPermissionResult) super.clone();
