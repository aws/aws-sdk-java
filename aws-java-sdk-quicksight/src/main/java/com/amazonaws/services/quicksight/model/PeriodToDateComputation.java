 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/PeriodToDateComputation" target="_top">AWS
 *      API Documentation</a>
 */
...
public class PeriodToDateComputation implements Serializable, Cloneable, StructuredPojo {
     ...
     *        The time granularity setup of period to date computation. Choose from the following options:</p>
     *        <ul>
     *        <li>
     *        <p>
     *        YEAR: Year to date.
     ...
     * </ul>
     * 
     * @return The time granularity setup of period to date computation. Choose from the following options:</p>
     *         <ul>
     *         <li>
     *         <p>
     *         YEAR: Year to date.
