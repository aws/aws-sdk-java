...
/**
 * ParameterTextAreaControl JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParameterTextAreaControlJsonUnmarshaller implements Unmarshaller<ParameterTextAreaControl, JsonUnmarshallerContext> {

    public ParameterTextAreaControl unmarshall(JsonUnmarshallerContext context) throws Exception {
        ParameterTextAreaControl parameterTextAreaControl = new ParameterTextAreaControl();
    ...
    private static ParameterTextAreaControlJsonUnmarshaller instance;

    public static ParameterTextAreaControlJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterTextAreaControlJsonUnmarshaller();
        return instance;
    }
}
