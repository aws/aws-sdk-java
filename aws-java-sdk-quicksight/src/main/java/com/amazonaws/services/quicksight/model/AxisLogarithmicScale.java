 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/AxisLogarithmicScale" target="_top">AWS
 *      API Documentation</a>
 */
...
public class AxisLogarithmicScale implements Serializable, Cloneable, StructuredPojo {
    ...
    public AxisLogarithmicScale withBase(Double base) {
        setBase(base);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AxisLogarithmicScale == false)
            return false;
    ...
    @Override
    public AxisLogarithmicScale clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.AxisLogarithmicScaleMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
