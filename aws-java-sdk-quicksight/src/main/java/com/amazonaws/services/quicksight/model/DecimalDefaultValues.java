 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/DecimalDefaultValues" target="_top">AWS
 *      API Documentation</a>
 */
...
public class DecimalDefaultValues implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The dynamic value of the <code>DecimalDefaultValues</code>. Different defaults are displayed according to users,
     ...
     * 
     * @param dynamicValue
     *        The dynamic value of the <code>DecimalDefaultValues</code>. Different defaults are displayed according to
     ...
     * </p>
     * 
     * @return The dynamic value of the <code>DecimalDefaultValues</code>. Different defaults are displayed according to
     *         users, groups, and values mapping.
     */
    ...
    public DecimalDefaultValues withDynamicValue(DynamicDefaultValue dynamicValue) {
    ...
    public DecimalDefaultValues withStaticValues(Double... staticValues) {
    ...
    public DecimalDefaultValues withStaticValues(java.util.Collection<Double> staticValues) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DecimalDefaultValues == false)
            return false;
        DecimalDefaultValues other = (DecimalDefaultValues) obj;
    ...
    @Override
    public DecimalDefaultValues clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.DecimalDefaultValuesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
