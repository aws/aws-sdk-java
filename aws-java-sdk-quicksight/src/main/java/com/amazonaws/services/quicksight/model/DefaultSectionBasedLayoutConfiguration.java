 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/DefaultSectionBasedLayoutConfiguration"
...
public class DefaultSectionBasedLayoutConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Determines the screen canvas size options for a section-based layout.
     */
    ...
    public DefaultSectionBasedLayoutConfiguration withCanvasSizeOptions(SectionBasedLayoutCanvasSizeOptions canvasSizeOptions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DefaultSectionBasedLayoutConfiguration == false)
            return false;
        DefaultSectionBasedLayoutConfiguration other = (DefaultSectionBasedLayoutConfiguration) obj;
    ...
    @Override
    public DefaultSectionBasedLayoutConfiguration clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.DefaultSectionBasedLayoutConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
