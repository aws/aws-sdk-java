 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/SheetLayoutElementMaximizationOption"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SheetLayoutElementMaximizationOption implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The status of the sheet layout maximization options of a dashbaord.
     * @see DashboardBehavior
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SheetLayoutElementMaximizationOption == false)
            return false;
        SheetLayoutElementMaximizationOption other = (SheetLayoutElementMaximizationOption) obj;
    ...
    public SheetLayoutElementMaximizationOption clone() {
        try {
            return (SheetLayoutElementMaximizationOption) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.SheetLayoutElementMaximizationOptionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
