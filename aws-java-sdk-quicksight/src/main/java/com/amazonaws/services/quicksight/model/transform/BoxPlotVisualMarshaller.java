...
/**
 * BoxPlotVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BoxPlotVisualMarshaller {
    ...
    private static final BoxPlotVisualMarshaller instance = new BoxPlotVisualMarshaller();

    public static BoxPlotVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BoxPlotVisual boxPlotVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(boxPlotVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(boxPlotVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(boxPlotVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(boxPlotVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(boxPlotVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(boxPlotVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
