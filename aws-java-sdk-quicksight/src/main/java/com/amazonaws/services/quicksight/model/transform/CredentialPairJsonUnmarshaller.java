...
/**
 * CredentialPair JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CredentialPairJsonUnmarshaller implements Unmarshaller<CredentialPair, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Username", targetDepth)) {
                    context.nextToken();
                    credentialPair.setUsername(context.getUnmarshaller(String.class).unmarshall(context));
                }
