 ...
 * href="https://docs.aws.amazon.com/quicksight/latest/user/custom-visual-content.html">Using custom visual content</a>
 * in the <i>Amazon QuickSight User Guide</i>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/CustomContentVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CustomContentVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private CustomContentConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public CustomContentVisual withVisualId(String visualId) {
    ...
    public CustomContentVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public CustomContentVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(CustomContentConfiguration chartConfiguration) {
     ...
     * </p>
     * 
     * @return The configuration of a <code>CustomContentVisual</code>.
     */

    public CustomContentConfiguration getChartConfiguration() {
    ...
    public CustomContentVisual withChartConfiguration(CustomContentConfiguration chartConfiguration) {
    ...
    public CustomContentVisual withActions(VisualCustomAction... actions) {
    ...
    public CustomContentVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
     ...
     * </p>
     * 
     * @return The dataset that is used to create the custom content visual. You can't create a visual without a
     *         dataset.
     */
    ...
    public CustomContentVisual withDataSetIdentifier(String dataSetIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CustomContentVisual == false)
            return false;
        CustomContentVisual other = (CustomContentVisual) obj;
    ...
    @Override
    public CustomContentVisual clone() {
        try {
            return (CustomContentVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.CustomContentVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
