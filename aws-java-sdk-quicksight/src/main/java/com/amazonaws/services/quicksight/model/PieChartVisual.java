 ...
 * </p>
 * <p>
 * The <code>PieChartVisual</code> structure describes a visual that is a member of the pie chart family.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * For more information, see <a href="https://docs.aws.amazon.com/quicksight/latest/user/donut-chart.html">Using donut
 * charts</a> in the <i>Amazon QuickSight User Guide</i>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/PieChartVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PieChartVisual implements Serializable, Cloneable, StructuredPojo {
    ...
    public PieChartVisual withVisualId(String visualId) {
    ...
    public PieChartVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public PieChartVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(PieChartConfiguration chartConfiguration) {
     ...
     * </p>
     * 
     * @return The configuration of a pie chart.
     */

    public PieChartConfiguration getChartConfiguration() {
    ...
    public PieChartVisual withChartConfiguration(PieChartConfiguration chartConfiguration) {
    ...
    public PieChartVisual withActions(VisualCustomAction... actions) {
    ...
    public PieChartVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public PieChartVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public PieChartVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PieChartVisual == false)
            return false;
    ...
    @Override
    public PieChartVisual clone() {
        try {
            return (PieChartVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.PieChartVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
