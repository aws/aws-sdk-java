...
/**
 * BarChartAggregatedFieldWellsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BarChartAggregatedFieldWellsMarshaller {
    ...
    private static final BarChartAggregatedFieldWellsMarshaller instance = new BarChartAggregatedFieldWellsMarshaller();

    public static BarChartAggregatedFieldWellsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BarChartAggregatedFieldWells barChartAggregatedFieldWells, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(barChartAggregatedFieldWells.getCategory(), CATEGORY_BINDING);
            protocolMarshaller.marshall(barChartAggregatedFieldWells.getValues(), VALUES_BINDING);
            protocolMarshaller.marshall(barChartAggregatedFieldWells.getColors(), COLORS_BINDING);
            protocolMarshaller.marshall(barChartAggregatedFieldWells.getSmallMultiples(), SMALLMULTIPLES_BINDING);
        } catch (Exception e) {
