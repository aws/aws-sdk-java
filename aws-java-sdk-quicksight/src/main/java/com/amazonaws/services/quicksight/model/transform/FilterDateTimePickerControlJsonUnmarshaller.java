...
/**
 * FilterDateTimePickerControl JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FilterDateTimePickerControlJsonUnmarshaller implements Unmarshaller<FilterDateTimePickerControl, JsonUnmarshallerContext> {

    public FilterDateTimePickerControl unmarshall(JsonUnmarshallerContext context) throws Exception {
        FilterDateTimePickerControl filterDateTimePickerControl = new FilterDateTimePickerControl();
    ...
    private static FilterDateTimePickerControlJsonUnmarshaller instance;

    public static FilterDateTimePickerControlJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FilterDateTimePickerControlJsonUnmarshaller();
        return instance;
    }
}
