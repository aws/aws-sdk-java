 ...
 * </p>
 * <p>
 * For more information, see <a href="https://docs.aws.amazon.com/quicksight/latest/user/pivot-table.html">Using pivot
 * tables</a> in the <i>Amazon QuickSight User Guide</i>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/PivotTableVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PivotTableVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private PivotTableConfiguration chartConfiguration;
    /**
     * <p>
     * The conditional formatting for a <code>PivotTableVisual</code>.
     * </p>
     */
    private PivotTableConditionalFormatting conditionalFormatting;
    /**
     * <p>
    ...
    public PivotTableVisual withVisualId(String visualId) {
    ...
    public PivotTableVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public PivotTableVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(PivotTableConfiguration chartConfiguration) {
    ...
    public PivotTableConfiguration getChartConfiguration() {
    ...
    public PivotTableVisual withChartConfiguration(PivotTableConfiguration chartConfiguration) {
    ...
    public void setConditionalFormatting(PivotTableConditionalFormatting conditionalFormatting) {
     ...
     * </p>
     * 
     * @return The conditional formatting for a <code>PivotTableVisual</code>.
     */

    public PivotTableConditionalFormatting getConditionalFormatting() {
    ...
    public PivotTableVisual withConditionalFormatting(PivotTableConditionalFormatting conditionalFormatting) {
    ...
    public PivotTableVisual withActions(VisualCustomAction... actions) {
    ...
    public PivotTableVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PivotTableVisual == false)
            return false;
        PivotTableVisual other = (PivotTableVisual) obj;
    ...
    @Override
    public PivotTableVisual clone() {
        try {
            return (PivotTableVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.PivotTableVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
