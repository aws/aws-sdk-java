        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Group", targetDepth)) {
                    context.nextToken();
                    describeGroupResult.setGroup(GroupJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    describeGroupResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
