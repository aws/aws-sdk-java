 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/FilledMapVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FilledMapVisual implements Serializable, Cloneable, StructuredPojo {
    ...
    public FilledMapVisual withVisualId(String visualId) {
    ...
    public FilledMapVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public FilledMapVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(FilledMapConfiguration chartConfiguration) {
    ...
    public FilledMapConfiguration getChartConfiguration() {
    ...
    public FilledMapVisual withChartConfiguration(FilledMapConfiguration chartConfiguration) {
    ...
    public void setConditionalFormatting(FilledMapConditionalFormatting conditionalFormatting) {
     ...
     * </p>
     * 
     * @return The conditional formatting of a <code>FilledMapVisual</code>.
     */

    public FilledMapConditionalFormatting getConditionalFormatting() {
    ...
    public FilledMapVisual withConditionalFormatting(FilledMapConditionalFormatting conditionalFormatting) {
    ...
    public FilledMapVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public FilledMapVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public FilledMapVisual withActions(VisualCustomAction... actions) {
    ...
    public FilledMapVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getColumnHierarchies() != null)
            sb.append("ColumnHierarchies: ").append(getColumnHierarchies()).append(",");
        if (getActions() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FilledMapVisual == false)
            return false;
    ...
    @Override
    public FilledMapVisual clone() {
        try {
            return (FilledMapVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.FilledMapVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
