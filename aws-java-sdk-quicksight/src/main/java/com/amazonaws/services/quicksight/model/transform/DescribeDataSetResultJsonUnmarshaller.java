...
public class DescribeDataSetResultJsonUnmarshaller implements Unmarshaller<DescribeDataSetResult, JsonUnmarshallerContext> {
    ...
    public DescribeDataSetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        describeDataSetResult.setStatus(context.getHttpResponse().getStatusCode());
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DataSet", targetDepth)) {
                    context.nextToken();
                    describeDataSetResult.setDataSet(DataSetJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    describeDataSetResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
