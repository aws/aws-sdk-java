...
/**
 * SankeyDiagramVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SankeyDiagramVisualMarshaller {
    ...
    private static final SankeyDiagramVisualMarshaller instance = new SankeyDiagramVisualMarshaller();

    public static SankeyDiagramVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SankeyDiagramVisual sankeyDiagramVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sankeyDiagramVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(sankeyDiagramVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(sankeyDiagramVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(sankeyDiagramVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(sankeyDiagramVisual.getActions(), ACTIONS_BINDING);
        } catch (Exception e) {
