 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/ParameterTextAreaControl"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParameterTextAreaControl implements Serializable, Cloneable, StructuredPojo {
    ...
    public ParameterTextAreaControl withDelimiter(String delimiter) {
    ...
    public ParameterTextAreaControl withDisplayOptions(TextAreaControlDisplayOptions displayOptions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ParameterTextAreaControl == false)
            return false;
    ...
    @Override
    public ParameterTextAreaControl clone() {
        try {
            return (ParameterTextAreaControl) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.ParameterTextAreaControlMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
