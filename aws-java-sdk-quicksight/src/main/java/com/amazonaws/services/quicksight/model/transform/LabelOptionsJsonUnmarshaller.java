...
/**
 * LabelOptions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LabelOptionsJsonUnmarshaller implements Unmarshaller<LabelOptions, JsonUnmarshallerContext> {

    public LabelOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static LabelOptionsJsonUnmarshaller instance;

    public static LabelOptionsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LabelOptionsJsonUnmarshaller();
        return instance;
    }
}
