...
public class HeatMapVisualMarshaller {
    ...
    public void marshall(HeatMapVisual heatMapVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(heatMapVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(heatMapVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(heatMapVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(heatMapVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
