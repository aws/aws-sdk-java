 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/CustomSql" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CustomSql implements Serializable, Cloneable, StructuredPojo {
    ...
    public CustomSql withColumns(InputColumn... columns) {
        if (this.columns == null) {
            setColumns(new java.util.ArrayList<InputColumn>(columns.length));
        }
        for (InputColumn ele : columns) {
    ...
    @Override
    public CustomSql clone() {
        try {
            return (CustomSql) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.CustomSqlMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
