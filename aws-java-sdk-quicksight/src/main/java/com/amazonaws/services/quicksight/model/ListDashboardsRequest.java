...
public class ListDashboardsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the Amazon Web Services account that contains the dashboards that you're listing.
     */
    ...
    public ListDashboardsRequest withAwsAccountId(String awsAccountId) {
