...
@SdkInternalApi
public class FieldSortMarshaller {
    ...
    private static final FieldSortMarshaller instance = new FieldSortMarshaller();

    public static FieldSortMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FieldSort fieldSort, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(fieldSort.getFieldId(), FIELDID_BINDING);
            protocolMarshaller.marshall(fieldSort.getDirection(), DIRECTION_BINDING);
        } catch (Exception e) {
