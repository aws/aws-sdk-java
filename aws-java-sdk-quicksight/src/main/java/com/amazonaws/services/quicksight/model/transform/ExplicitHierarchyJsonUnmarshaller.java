...
/**
 * ExplicitHierarchy JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExplicitHierarchyJsonUnmarshaller implements Unmarshaller<ExplicitHierarchy, JsonUnmarshallerContext> {

    public ExplicitHierarchy unmarshall(JsonUnmarshallerContext context) throws Exception {
        ExplicitHierarchy explicitHierarchy = new ExplicitHierarchy();
    ...
    private static ExplicitHierarchyJsonUnmarshaller instance;

    public static ExplicitHierarchyJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExplicitHierarchyJsonUnmarshaller();
        return instance;
    }
}
