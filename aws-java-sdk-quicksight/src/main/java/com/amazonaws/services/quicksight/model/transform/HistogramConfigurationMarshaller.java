...
/**
 * HistogramConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class HistogramConfigurationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> BINOPTIONS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("BinOptions").build();
    ...
    public static HistogramConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HistogramConfiguration histogramConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (histogramConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(histogramConfiguration.getFieldWells(), FIELDWELLS_BINDING);
            protocolMarshaller.marshall(histogramConfiguration.getXAxisDisplayOptions(), XAXISDISPLAYOPTIONS_BINDING);
            protocolMarshaller.marshall(histogramConfiguration.getXAxisLabelOptions(), XAXISLABELOPTIONS_BINDING);
            protocolMarshaller.marshall(histogramConfiguration.getYAxisDisplayOptions(), YAXISDISPLAYOPTIONS_BINDING);
            protocolMarshaller.marshall(histogramConfiguration.getBinOptions(), BINOPTIONS_BINDING);
