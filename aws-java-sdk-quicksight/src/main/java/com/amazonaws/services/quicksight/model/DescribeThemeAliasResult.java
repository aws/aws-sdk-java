...
public class DescribeThemeAliasResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeThemeAliasResult withThemeAlias(ThemeAlias themeAlias) {
    ...
    public DescribeThemeAliasResult withStatus(Integer status) {
        setStatus(status);
        return this;
    }
    ...
    public DescribeThemeAliasResult withRequestId(String requestId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeThemeAliasResult == false)
            return false;
        DescribeThemeAliasResult other = (DescribeThemeAliasResult) obj;
    ...
    @Override
    public DescribeThemeAliasResult clone() {
        try {
            return (DescribeThemeAliasResult) super.clone();
