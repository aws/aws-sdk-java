 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/LineChartAggregatedFieldWells"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LineChartAggregatedFieldWells implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The category field wells of a line chart. Values are grouped by category fields.
     */
    ...
    public LineChartAggregatedFieldWells withCategory(DimensionField... category) {
    ...
    public LineChartAggregatedFieldWells withCategory(java.util.Collection<DimensionField> category) {
     ...
     * </p>
     * 
     * @return The value field wells of a line chart. Values are aggregated based on categories.
     */
    ...
    public LineChartAggregatedFieldWells withValues(MeasureField... values) {
        if (this.values == null) {
    ...
    public LineChartAggregatedFieldWells withValues(java.util.Collection<MeasureField> values) {
        setValues(values);
        return this;
    }
     ...
     * </p>
     * 
     * @return The color field wells of a line chart. Values are grouped by category fields.
     */
    ...
    public LineChartAggregatedFieldWells withColors(DimensionField... colors) {
        if (this.colors == null) {
    ...
    public LineChartAggregatedFieldWells withColors(java.util.Collection<DimensionField> colors) {
        setColors(colors);
        return this;
    }
     ...
     * </p>
     * 
     * @return The small multiples field well of a line chart.
     */
    ...
    public LineChartAggregatedFieldWells withSmallMultiples(DimensionField... smallMultiples) {
    ...
    public LineChartAggregatedFieldWells withSmallMultiples(java.util.Collection<DimensionField> smallMultiples) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LineChartAggregatedFieldWells == false)
            return false;
        LineChartAggregatedFieldWells other = (LineChartAggregatedFieldWells) obj;
    ...
    @Override
    public LineChartAggregatedFieldWells clone() {
        try {
            return (LineChartAggregatedFieldWells) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.LineChartAggregatedFieldWellsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
