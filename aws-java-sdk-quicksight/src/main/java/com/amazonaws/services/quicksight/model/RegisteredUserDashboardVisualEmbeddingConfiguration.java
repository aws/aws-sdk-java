 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/RegisteredUserDashboardVisualEmbeddingConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RegisteredUserDashboardVisualEmbeddingConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     *        The visual ID for the visual that you want the user to embed. This ID is included in the output URL. When
    ...
    public RegisteredUserDashboardVisualEmbeddingConfiguration withInitialDashboardVisualId(DashboardVisualId initialDashboardVisualId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RegisteredUserDashboardVisualEmbeddingConfiguration == false)
            return false;
    ...
    @Override
    public RegisteredUserDashboardVisualEmbeddingConfiguration clone() {
        try {
            return (RegisteredUserDashboardVisualEmbeddingConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.RegisteredUserDashboardVisualEmbeddingConfigurationMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
