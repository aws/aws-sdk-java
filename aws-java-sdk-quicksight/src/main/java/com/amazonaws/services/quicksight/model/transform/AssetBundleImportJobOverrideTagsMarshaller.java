...
/**
 * AssetBundleImportJobOverrideTagsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssetBundleImportJobOverrideTagsMarshaller {
    ...
    private static final AssetBundleImportJobOverrideTagsMarshaller instance = new AssetBundleImportJobOverrideTagsMarshaller();

    public static AssetBundleImportJobOverrideTagsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssetBundleImportJobOverrideTags assetBundleImportJobOverrideTags, ProtocolMarshaller protocolMarshaller) {

        if (assetBundleImportJobOverrideTags == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(assetBundleImportJobOverrideTags.getVPCConnections(), VPCCONNECTIONS_BINDING);
            protocolMarshaller.marshall(assetBundleImportJobOverrideTags.getDataSources(), DATASOURCES_BINDING);
            protocolMarshaller.marshall(assetBundleImportJobOverrideTags.getDataSets(), DATASETS_BINDING);
            protocolMarshaller.marshall(assetBundleImportJobOverrideTags.getThemes(), THEMES_BINDING);
            protocolMarshaller.marshall(assetBundleImportJobOverrideTags.getAnalyses(), ANALYSES_BINDING);
            protocolMarshaller.marshall(assetBundleImportJobOverrideTags.getDashboards(), DASHBOARDS_BINDING);
        } catch (Exception e) {
