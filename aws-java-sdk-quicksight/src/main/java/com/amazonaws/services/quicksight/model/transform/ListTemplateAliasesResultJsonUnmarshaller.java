...
/**
 * ListTemplateAliasesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListTemplateAliasesResultJsonUnmarshaller implements Unmarshaller<ListTemplateAliasesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    listTemplateAliasesResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listTemplateAliasesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
