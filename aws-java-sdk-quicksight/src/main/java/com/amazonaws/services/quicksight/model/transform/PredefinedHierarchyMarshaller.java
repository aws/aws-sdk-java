...
/**
 * PredefinedHierarchyMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PredefinedHierarchyMarshaller {
    ...
    private static final PredefinedHierarchyMarshaller instance = new PredefinedHierarchyMarshaller();

    public static PredefinedHierarchyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PredefinedHierarchy predefinedHierarchy, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(predefinedHierarchy.getHierarchyId(), HIERARCHYID_BINDING);
            protocolMarshaller.marshall(predefinedHierarchy.getColumns(), COLUMNS_BINDING);
            protocolMarshaller.marshall(predefinedHierarchy.getDrillDownFilters(), DRILLDOWNFILTERS_BINDING);
        } catch (Exception e) {
