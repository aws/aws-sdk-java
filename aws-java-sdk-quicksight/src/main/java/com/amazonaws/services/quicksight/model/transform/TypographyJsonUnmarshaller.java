...
/**
 * Typography JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TypographyJsonUnmarshaller implements Unmarshaller<Typography, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FontFamilies", targetDepth)) {
                    context.nextToken();
                    typography.setFontFamilies(new ListUnmarshaller<Font>(FontJsonUnmarshaller.getInstance())
