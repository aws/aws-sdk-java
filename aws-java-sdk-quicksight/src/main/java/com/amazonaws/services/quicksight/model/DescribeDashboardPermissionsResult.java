...
public class DescribeDashboardPermissionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeDashboardPermissionsResult withPermissions(java.util.Collection<ResourcePermission> permissions) {
    ...
    public DescribeDashboardPermissionsResult clone() {
        try {
            return (DescribeDashboardPermissionsResult) super.clone();
