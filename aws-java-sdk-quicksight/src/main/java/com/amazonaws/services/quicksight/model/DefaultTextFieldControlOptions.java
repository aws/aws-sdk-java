 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/DefaultTextFieldControlOptions"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DefaultTextFieldControlOptions implements Serializable, Cloneable, StructuredPojo {
    ...
    public DefaultTextFieldControlOptions withDisplayOptions(TextFieldControlDisplayOptions displayOptions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DefaultTextFieldControlOptions == false)
            return false;
    ...
    @Override
    public DefaultTextFieldControlOptions clone() {
        try {
            return (DefaultTextFieldControlOptions) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.DefaultTextFieldControlOptionsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
