...
/**
 * AthenaParameters JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AthenaParametersJsonUnmarshaller implements Unmarshaller<AthenaParameters, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("WorkGroup", targetDepth)) {
                    context.nextToken();
                    athenaParameters.setWorkGroup(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RoleArn", targetDepth)) {
                    context.nextToken();
                    athenaParameters.setRoleArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
