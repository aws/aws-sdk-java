...
/**
 * CustomParameterValuesMarshaller
 */
...
public class CustomParameterValuesMarshaller {
    ...
    private static final MarshallingInfo<List> DECIMALVALUES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("DecimalValues").build();
    private static final MarshallingInfo<List> DATETIMEVALUES_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DateTimeValues").build();
