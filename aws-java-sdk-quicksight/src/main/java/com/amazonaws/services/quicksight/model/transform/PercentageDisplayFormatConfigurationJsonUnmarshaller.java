...
/**
 * PercentageDisplayFormatConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PercentageDisplayFormatConfigurationJsonUnmarshaller implements Unmarshaller<PercentageDisplayFormatConfiguration, JsonUnmarshallerContext> {

    public PercentageDisplayFormatConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        PercentageDisplayFormatConfiguration percentageDisplayFormatConfiguration = new PercentageDisplayFormatConfiguration();
    ...
    private static PercentageDisplayFormatConfigurationJsonUnmarshaller instance;

    public static PercentageDisplayFormatConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PercentageDisplayFormatConfigurationJsonUnmarshaller();
        return instance;
    }
}
