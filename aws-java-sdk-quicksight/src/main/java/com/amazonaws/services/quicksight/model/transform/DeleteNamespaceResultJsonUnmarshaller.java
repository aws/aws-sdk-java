...
/**
 * DeleteNamespaceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteNamespaceResultJsonUnmarshaller implements Unmarshaller<DeleteNamespaceResult, JsonUnmarshallerContext> {
    ...
    public DeleteNamespaceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        deleteNamespaceResult.setStatus(context.getHttpResponse().getStatusCode());
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    deleteNamespaceResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
