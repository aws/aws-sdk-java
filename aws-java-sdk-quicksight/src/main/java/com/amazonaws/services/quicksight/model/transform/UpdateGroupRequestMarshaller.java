...
public class UpdateGroupRequestMarshaller {
    ...
    public void marshall(UpdateGroupRequest updateGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateGroupRequest.getAwsAccountId(), AWSACCOUNTID_BINDING);
            protocolMarshaller.marshall(updateGroupRequest.getNamespace(), NAMESPACE_BINDING);
        } catch (Exception e) {
