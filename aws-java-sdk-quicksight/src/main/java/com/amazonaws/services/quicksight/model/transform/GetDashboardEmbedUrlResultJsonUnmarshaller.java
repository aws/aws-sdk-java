...
/**
 * GetDashboardEmbedUrlResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetDashboardEmbedUrlResultJsonUnmarshaller implements Unmarshaller<GetDashboardEmbedUrlResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("EmbedUrl", targetDepth)) {
                    context.nextToken();
                    getDashboardEmbedUrlResult.setEmbedUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    getDashboardEmbedUrlResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
