...
@SdkInternalApi
public class KPIVisualMarshaller {
    ...
    private static final KPIVisualMarshaller instance = new KPIVisualMarshaller();

    public static KPIVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(KPIVisual kPIVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(kPIVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(kPIVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(kPIVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(kPIVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(kPIVisual.getConditionalFormatting(), CONDITIONALFORMATTING_BINDING);
            protocolMarshaller.marshall(kPIVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(kPIVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
