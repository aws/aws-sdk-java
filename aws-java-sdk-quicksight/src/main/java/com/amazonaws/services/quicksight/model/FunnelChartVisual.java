 ...
 * href="https://docs.aws.amazon.com/quicksight/latest/user/funnel-visual-content.html">Using funnel charts</a> in the
 * <i>Amazon QuickSight User Guide</i>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/FunnelChartVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FunnelChartVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private FunnelChartConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public FunnelChartVisual withVisualId(String visualId) {
    ...
    public FunnelChartVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public FunnelChartVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(FunnelChartConfiguration chartConfiguration) {
     ...
     * </p>
     * 
     * @return The configuration of a <code>FunnelChartVisual</code>.
     */

    public FunnelChartConfiguration getChartConfiguration() {
    ...
    public FunnelChartVisual withChartConfiguration(FunnelChartConfiguration chartConfiguration) {
    ...
    public FunnelChartVisual withActions(VisualCustomAction... actions) {
    ...
    public FunnelChartVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public FunnelChartVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public FunnelChartVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FunnelChartVisual == false)
            return false;
        FunnelChartVisual other = (FunnelChartVisual) obj;
    ...
    @Override
    public FunnelChartVisual clone() {
        try {
            return (FunnelChartVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.FunnelChartVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
