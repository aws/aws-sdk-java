 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/NumericalMeasureField" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NumericalMeasureField implements Serializable, Cloneable, StructuredPojo {
    ...
    public NumericalAggregationFunction getAggregationFunction() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NumericalMeasureField == false)
            return false;
    ...
    public NumericalMeasureField clone() {
        try {
            return (NumericalMeasureField) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.NumericalMeasureFieldMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
