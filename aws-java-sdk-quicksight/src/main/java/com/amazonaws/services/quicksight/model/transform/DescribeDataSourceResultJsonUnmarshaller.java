...
public class DescribeDataSourceResultJsonUnmarshaller implements Unmarshaller<DescribeDataSourceResult, JsonUnmarshallerContext> {
    ...
    public DescribeDataSourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        describeDataSourceResult.setStatus(context.getHttpResponse().getStatusCode());
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DataSource", targetDepth)) {
                    context.nextToken();
                    describeDataSourceResult.setDataSource(DataSourceJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    describeDataSourceResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
