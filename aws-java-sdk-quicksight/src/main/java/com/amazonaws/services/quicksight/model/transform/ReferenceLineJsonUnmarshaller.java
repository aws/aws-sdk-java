...
/**
 * ReferenceLine JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReferenceLineJsonUnmarshaller implements Unmarshaller<ReferenceLine, JsonUnmarshallerContext> {

    public ReferenceLine unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ReferenceLineJsonUnmarshaller instance;

    public static ReferenceLineJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReferenceLineJsonUnmarshaller();
        return instance;
    }
}
