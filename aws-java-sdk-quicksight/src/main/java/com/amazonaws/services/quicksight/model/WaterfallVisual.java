 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/WaterfallVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WaterfallVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private WaterfallChartConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public WaterfallVisual withVisualId(String visualId) {
    ...
    public WaterfallVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public WaterfallVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(WaterfallChartConfiguration chartConfiguration) {
     ...
     * </p>
     * 
     * @return The configuration for a waterfall visual.
     */

    public WaterfallChartConfiguration getChartConfiguration() {
    ...
    public WaterfallVisual withChartConfiguration(WaterfallChartConfiguration chartConfiguration) {
    ...
    public WaterfallVisual withActions(VisualCustomAction... actions) {
    ...
    public WaterfallVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public WaterfallVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public WaterfallVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WaterfallVisual == false)
            return false;
        WaterfallVisual other = (WaterfallVisual) obj;
    ...
    @Override
    public WaterfallVisual clone() {
        try {
            return (WaterfallVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.WaterfallVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
