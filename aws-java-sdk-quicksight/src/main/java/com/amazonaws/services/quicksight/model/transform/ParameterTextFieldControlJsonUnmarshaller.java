...
/**
 * ParameterTextFieldControl JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParameterTextFieldControlJsonUnmarshaller implements Unmarshaller<ParameterTextFieldControl, JsonUnmarshallerContext> {

    public ParameterTextFieldControl unmarshall(JsonUnmarshallerContext context) throws Exception {
        ParameterTextFieldControl parameterTextFieldControl = new ParameterTextFieldControl();
    ...
    private static ParameterTextFieldControlJsonUnmarshaller instance;

    public static ParameterTextFieldControlJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterTextFieldControlJsonUnmarshaller();
        return instance;
    }
}
