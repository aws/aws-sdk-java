...
/**
 * ColumnTooltipItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ColumnTooltipItemJsonUnmarshaller implements Unmarshaller<ColumnTooltipItem, JsonUnmarshallerContext> {

    public ColumnTooltipItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        ColumnTooltipItem columnTooltipItem = new ColumnTooltipItem();
    ...
    private static ColumnTooltipItemJsonUnmarshaller instance;

    public static ColumnTooltipItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ColumnTooltipItemJsonUnmarshaller();
        return instance;
    }
}
