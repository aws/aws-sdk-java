 ...
 * </p>
 * <p>
 * The <code>ComboChartVisual</code> includes stacked bar combo charts and clustered bar combo charts
 * </p>
 * <p>
 * For more information, see <a href="https://docs.aws.amazon.com/quicksight/latest/user/combo-charts.html">Using combo
 * charts</a> in the <i>Amazon QuickSight User Guide</i>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/ComboChartVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ComboChartVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private ComboChartConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public ComboChartVisual withVisualId(String visualId) {
    ...
    public ComboChartVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public ComboChartVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(ComboChartConfiguration chartConfiguration) {
    ...
    public ComboChartConfiguration getChartConfiguration() {
    ...
    public ComboChartVisual withChartConfiguration(ComboChartConfiguration chartConfiguration) {
    ...
    public ComboChartVisual withActions(VisualCustomAction... actions) {
    ...
    public ComboChartVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public ComboChartVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public ComboChartVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ComboChartVisual == false)
            return false;
        ComboChartVisual other = (ComboChartVisual) obj;
    ...
    @Override
    public ComboChartVisual clone() {
        try {
            return (ComboChartVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.ComboChartVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
