 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/ConditionalFormattingSolidColor"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConditionalFormattingSolidColor implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConditionalFormattingSolidColor == false)
            return false;
    ...
    @Override
    public ConditionalFormattingSolidColor clone() {
        try {
            return (ConditionalFormattingSolidColor) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.ConditionalFormattingSolidColorMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
