 ...
 * </p>
 * <p>
 * For more information, see <a href="https://docs.aws.amazon.com/quicksight/latest/user/gauge-chart.html">Using gauge
 * charts</a> in the <i>Amazon QuickSight User Guide</i>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/GaugeChartVisual" target="_top">AWS API
 *      Documentation</a>
 */
...
public class GaugeChartVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The configuration of a <code>GaugeChartVisual</code>.
     */
     ...
     * </p>
     * 
     * @return The conditional formatting of a <code>GaugeChartVisual</code>.
     */
    ...
    public GaugeChartVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
