...
public class ListTemplateVersionsRequestMarshaller {
    ...
    public void marshall(ListTemplateVersionsRequest listTemplateVersionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listTemplateVersionsRequest.getAwsAccountId(), AWSACCOUNTID_BINDING);
            protocolMarshaller.marshall(listTemplateVersionsRequest.getTemplateId(), TEMPLATEID_BINDING);
            protocolMarshaller.marshall(listTemplateVersionsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listTemplateVersionsRequest.getMaxResults(), MAXRESULTS_BINDING);
        } catch (Exception e) {
