...
/**
 * WhatIfRangeScenarioMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class WhatIfRangeScenarioMarshaller {
    ...
    private static final WhatIfRangeScenarioMarshaller instance = new WhatIfRangeScenarioMarshaller();

    public static WhatIfRangeScenarioMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(WhatIfRangeScenario whatIfRangeScenario, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(whatIfRangeScenario.getStartDate(), STARTDATE_BINDING);
            protocolMarshaller.marshall(whatIfRangeScenario.getEndDate(), ENDDATE_BINDING);
            protocolMarshaller.marshall(whatIfRangeScenario.getValue(), VALUE_BINDING);
        } catch (Exception e) {
