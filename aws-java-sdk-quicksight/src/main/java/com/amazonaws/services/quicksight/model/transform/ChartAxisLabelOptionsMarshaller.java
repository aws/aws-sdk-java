...
/**
 * ChartAxisLabelOptionsMarshaller
 */
...
public class ChartAxisLabelOptionsMarshaller {
    ...
    private static final MarshallingInfo<String> SORTICONVISIBILITY_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("SortIconVisibility").build();
    private static final MarshallingInfo<List> AXISLABELOPTIONS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AxisLabelOptions").build();
