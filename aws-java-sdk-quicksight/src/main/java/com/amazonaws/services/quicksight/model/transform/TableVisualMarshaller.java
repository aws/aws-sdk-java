...
/**
 * TableVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TableVisualMarshaller {
    ...
    private static final TableVisualMarshaller instance = new TableVisualMarshaller();

    public static TableVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TableVisual tableVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(tableVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(tableVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(tableVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(tableVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(tableVisual.getConditionalFormatting(), CONDITIONALFORMATTING_BINDING);
            protocolMarshaller.marshall(tableVisual.getActions(), ACTIONS_BINDING);
        } catch (Exception e) {
