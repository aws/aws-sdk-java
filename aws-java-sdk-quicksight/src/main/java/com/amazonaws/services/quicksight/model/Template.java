...
/**
 * <p>
 * A template object. A template is an entity in QuickSight which encapsulates the metadata required to create an
 * analysis that can be used to create dashboard. It adds a layer of abstraction by replacing the dataset associated
 * with the analysis with placeholders. Templates can be used to create dashboards by replacing dataset placeholders
 * with datasets which follow the same schema that was used to create the source analysis and template.
 * </p>
 * <p>
