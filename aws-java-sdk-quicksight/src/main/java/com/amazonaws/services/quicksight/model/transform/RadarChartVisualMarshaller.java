...
/**
 * RadarChartVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RadarChartVisualMarshaller {
    ...
    private static final RadarChartVisualMarshaller instance = new RadarChartVisualMarshaller();

    public static RadarChartVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RadarChartVisual radarChartVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(radarChartVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(radarChartVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(radarChartVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(radarChartVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(radarChartVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(radarChartVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
