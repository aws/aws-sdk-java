...
public class CreateAccountSubscriptionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateAccountSubscriptionResult withSignupResponse(SignupResponse signupResponse) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getSignupResponse() != null)
            sb.append("SignupResponse: ").append(getSignupResponse()).append(",");
        if (getStatus() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAccountSubscriptionResult == false)
            return false;
        CreateAccountSubscriptionResult other = (CreateAccountSubscriptionResult) obj;
        if (other.getSignupResponse() == null ^ this.getSignupResponse() == null)
            return false;
        if (other.getSignupResponse() != null && other.getSignupResponse().equals(this.getSignupResponse()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSignupResponse() == null) ? 0 : getSignupResponse().hashCode());
    ...
    public CreateAccountSubscriptionResult clone() {
        try {
            return (CreateAccountSubscriptionResult) super.clone();
