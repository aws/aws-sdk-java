...
/**
 * LineChartVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LineChartVisualMarshaller {
    ...
    private static final LineChartVisualMarshaller instance = new LineChartVisualMarshaller();

    public static LineChartVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LineChartVisual lineChartVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(lineChartVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(lineChartVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(lineChartVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(lineChartVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(lineChartVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(lineChartVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
