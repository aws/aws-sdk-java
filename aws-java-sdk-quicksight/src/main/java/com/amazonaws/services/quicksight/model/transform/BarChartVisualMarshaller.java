...
/**
 * BarChartVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BarChartVisualMarshaller {
    ...
    private static final BarChartVisualMarshaller instance = new BarChartVisualMarshaller();

    public static BarChartVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BarChartVisual barChartVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(barChartVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(barChartVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(barChartVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(barChartVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(barChartVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(barChartVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
