...
public class CreateTemplateAliasResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getTemplateAlias() != null)
            sb.append("TemplateAlias: ").append(getTemplateAlias()).append(",");
        if (getStatus() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTemplateAliasResult == false)
            return false;
        CreateTemplateAliasResult other = (CreateTemplateAliasResult) obj;
        if (other.getTemplateAlias() == null ^ this.getTemplateAlias() == null)
            return false;
        if (other.getTemplateAlias() != null && other.getTemplateAlias().equals(this.getTemplateAlias()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getTemplateAlias() == null) ? 0 : getTemplateAlias().hashCode());
    ...
    public CreateTemplateAliasResult clone() {
        try {
            return (CreateTemplateAliasResult) super.clone();
