 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/DateDimensionField" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DateDimensionField implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The date granularity of the <code>DateDimensionField</code>. Choose one of the following options:
     * </p>
     * <ul>
     * <li>
     * <p>
     ...
     * </p>
     * 
     * @return The column that is used in the <code>DateDimensionField</code>.
     */
    ...
    public DateDimensionField withColumn(ColumnIdentifier column) {
        setColumn(column);
        return this;
    }
     ...
     *        The date granularity of the <code>DateDimensionField</code>. Choose one of the following options:</p>
     *        <ul>
     *        <li>
     *        <p>
     *        <code>YEAR</code>
     ...
     * </ul>
     * 
     * @return The date granularity of the <code>DateDimensionField</code>. Choose one of the following options:</p>
     *         <ul>
     *         <li>
     *         <p>
     *         <code>YEAR</code>
    ...
    public DateDimensionField withDateGranularity(String dateGranularity) {
    ...
    public DateDimensionField withDateGranularity(TimeGranularity dateGranularity) {
        this.dateGranularity = dateGranularity.toString();
        return this;
    }
    ...
    public DateTimeFormatConfiguration getFormatConfiguration() {
    ...
    public String toString() {
        ...
        if (getDateGranularity() != null)
            sb.append("DateGranularity: ").append(getDateGranularity()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DateDimensionField == false)
            return false;
        ...
        if (other.getColumn() != null && other.getColumn().equals(this.getColumn()) == false)
            return false;
        if (other.getDateGranularity() == null ^ this.getDateGranularity() == null)
            return false;
        if (other.getDateGranularity() != null && other.getDateGranularity().equals(this.getDateGranularity()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getDateGranularity() == null) ? 0 : getDateGranularity().hashCode());
    ...
    @Override
    public DateDimensionField clone() {
        try {
            return (DateDimensionField) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.DateDimensionFieldMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
