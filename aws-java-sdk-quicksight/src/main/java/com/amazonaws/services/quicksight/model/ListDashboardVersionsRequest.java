...
public class ListDashboardVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return AWS account ID that contains the dashboard you are listing.
     */
    ...
    @Override
    public ListDashboardVersionsRequest clone() {
        return (ListDashboardVersionsRequest) super.clone();
    }
