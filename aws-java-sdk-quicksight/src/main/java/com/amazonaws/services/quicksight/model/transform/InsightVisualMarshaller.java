...
public class InsightVisualMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> INSIGHTCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("InsightConfiguration").build();
    ...
    public void marshall(InsightVisual insightVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(insightVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(insightVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(insightVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(insightVisual.getInsightConfiguration(), INSIGHTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(insightVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(insightVisual.getDataSetIdentifier(), DATASETIDENTIFIER_BINDING);
        } catch (Exception e) {
