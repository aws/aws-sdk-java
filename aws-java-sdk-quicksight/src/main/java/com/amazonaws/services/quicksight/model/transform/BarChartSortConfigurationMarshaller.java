...
/**
 * BarChartSortConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BarChartSortConfigurationMarshaller {
    ...
    private static final BarChartSortConfigurationMarshaller instance = new BarChartSortConfigurationMarshaller();

    public static BarChartSortConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BarChartSortConfiguration barChartSortConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (barChartSortConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(barChartSortConfiguration.getCategorySort(), CATEGORYSORT_BINDING);
            protocolMarshaller.marshall(barChartSortConfiguration.getCategoryItemsLimit(), CATEGORYITEMSLIMIT_BINDING);
            protocolMarshaller.marshall(barChartSortConfiguration.getColorSort(), COLORSORT_BINDING);
            protocolMarshaller.marshall(barChartSortConfiguration.getColorItemsLimit(), COLORITEMSLIMIT_BINDING);
            protocolMarshaller.marshall(barChartSortConfiguration.getSmallMultiplesSort(), SMALLMULTIPLESSORT_BINDING);
            protocolMarshaller.marshall(barChartSortConfiguration.getSmallMultiplesLimitConfiguration(), SMALLMULTIPLESLIMITCONFIGURATION_BINDING);
        } catch (Exception e) {
