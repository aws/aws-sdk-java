...
/**
 * DataPathColor JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataPathColorJsonUnmarshaller implements Unmarshaller<DataPathColor, JsonUnmarshallerContext> {

    public DataPathColor unmarshall(JsonUnmarshallerContext context) throws Exception {
        DataPathColor dataPathColor = new DataPathColor();
    ...
    private static DataPathColorJsonUnmarshaller instance;

    public static DataPathColorJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DataPathColorJsonUnmarshaller();
        return instance;
    }
}
