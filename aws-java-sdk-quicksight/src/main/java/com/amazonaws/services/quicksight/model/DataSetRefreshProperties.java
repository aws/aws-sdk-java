 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/DataSetRefreshProperties"
...
public class DataSetRefreshProperties implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DataSetRefreshProperties == false)
            return false;
        DataSetRefreshProperties other = (DataSetRefreshProperties) obj;
        if (other.getRefreshConfiguration() == null ^ this.getRefreshConfiguration() == null)
            return false;
        if (other.getRefreshConfiguration() != null && other.getRefreshConfiguration().equals(this.getRefreshConfiguration()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getRefreshConfiguration() == null) ? 0 : getRefreshConfiguration().hashCode());
        return hashCode;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.DataSetRefreshPropertiesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
