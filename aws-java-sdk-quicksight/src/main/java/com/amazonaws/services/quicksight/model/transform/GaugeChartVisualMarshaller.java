...
/**
 * GaugeChartVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GaugeChartVisualMarshaller {
    ...
    private static final GaugeChartVisualMarshaller instance = new GaugeChartVisualMarshaller();

    public static GaugeChartVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GaugeChartVisual gaugeChartVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(gaugeChartVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(gaugeChartVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(gaugeChartVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(gaugeChartVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(gaugeChartVisual.getConditionalFormatting(), CONDITIONALFORMATTING_BINDING);
            protocolMarshaller.marshall(gaugeChartVisual.getActions(), ACTIONS_BINDING);
        } catch (Exception e) {
