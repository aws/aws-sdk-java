...
public class AuroraPostgreSqlParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AuroraPostgreSqlParameters == false)
            return false;
        AuroraPostgreSqlParameters other = (AuroraPostgreSqlParameters) obj;
    ...
    public AuroraPostgreSqlParameters clone() {
        try {
            return (AuroraPostgreSqlParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.AuroraPostgreSqlParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
