...
/**
 * FunnelChartVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FunnelChartVisualMarshaller {
    ...
    private static final FunnelChartVisualMarshaller instance = new FunnelChartVisualMarshaller();

    public static FunnelChartVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FunnelChartVisual funnelChartVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(funnelChartVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(funnelChartVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(funnelChartVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(funnelChartVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(funnelChartVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(funnelChartVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
