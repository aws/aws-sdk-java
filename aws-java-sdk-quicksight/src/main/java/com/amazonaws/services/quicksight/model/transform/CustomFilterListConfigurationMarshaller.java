...
/**
 * CustomFilterListConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CustomFilterListConfigurationMarshaller {
    ...
    private static final CustomFilterListConfigurationMarshaller instance = new CustomFilterListConfigurationMarshaller();

    public static CustomFilterListConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CustomFilterListConfiguration customFilterListConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(customFilterListConfiguration.getMatchOperator(), MATCHOPERATOR_BINDING);
            protocolMarshaller.marshall(customFilterListConfiguration.getCategoryValues(), CATEGORYVALUES_BINDING);
            protocolMarshaller.marshall(customFilterListConfiguration.getSelectAllOptions(), SELECTALLOPTIONS_BINDING);
            protocolMarshaller.marshall(customFilterListConfiguration.getNullOption(), NULLOPTION_BINDING);
        } catch (Exception e) {
