...
public class DeleteFolderMembershipResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteFolderMembershipResult == false)
            return false;
        DeleteFolderMembershipResult other = (DeleteFolderMembershipResult) obj;
    ...
    public DeleteFolderMembershipResult clone() {
        try {
            return (DeleteFolderMembershipResult) super.clone();
