...
/**
 * HistogramVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class HistogramVisualMarshaller {
    ...
    private static final HistogramVisualMarshaller instance = new HistogramVisualMarshaller();

    public static HistogramVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HistogramVisual histogramVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(histogramVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(histogramVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(histogramVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(histogramVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(histogramVisual.getActions(), ACTIONS_BINDING);
        } catch (Exception e) {
