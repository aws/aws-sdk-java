 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/HistogramVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HistogramVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private HistogramConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public HistogramVisual withVisualId(String visualId) {
    ...
    public HistogramVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public HistogramVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(HistogramConfiguration chartConfiguration) {
     ...
     * </p>
     * 
     * @return The configuration for a <code>HistogramVisual</code>.
     */

    public HistogramConfiguration getChartConfiguration() {
    ...
    public HistogramVisual withChartConfiguration(HistogramConfiguration chartConfiguration) {
    ...
    public HistogramVisual withActions(VisualCustomAction... actions) {
    ...
    public HistogramVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HistogramVisual == false)
            return false;
        HistogramVisual other = (HistogramVisual) obj;
    ...
    @Override
    public HistogramVisual clone() {
        try {
            return (HistogramVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.HistogramVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
