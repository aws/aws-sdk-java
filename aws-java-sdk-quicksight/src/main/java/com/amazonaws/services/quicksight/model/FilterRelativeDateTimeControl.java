 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/FilterRelativeDateTimeControl"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FilterRelativeDateTimeControl implements Serializable, Cloneable, StructuredPojo {
    ...
    public FilterRelativeDateTimeControl withFilterControlId(String filterControlId) {
    ...
    public FilterRelativeDateTimeControl withTitle(String title) {
        setTitle(title);
        return this;
    }
    ...
    public FilterRelativeDateTimeControl withSourceFilterId(String sourceFilterId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FilterRelativeDateTimeControl == false)
            return false;
        FilterRelativeDateTimeControl other = (FilterRelativeDateTimeControl) obj;
    ...
    @Override
    public FilterRelativeDateTimeControl clone() {
        try {
            return (FilterRelativeDateTimeControl) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.FilterRelativeDateTimeControlMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
