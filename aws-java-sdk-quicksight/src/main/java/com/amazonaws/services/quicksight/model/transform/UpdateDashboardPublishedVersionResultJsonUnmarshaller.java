...
/**
 * UpdateDashboardPublishedVersionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateDashboardPublishedVersionResultJsonUnmarshaller implements Unmarshaller<UpdateDashboardPublishedVersionResult, JsonUnmarshallerContext> {

    public UpdateDashboardPublishedVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
