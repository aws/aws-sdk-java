 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/ReferenceLineCustomLabelConfiguration"
...
public class ReferenceLineCustomLabelConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReferenceLineCustomLabelConfiguration == false)
            return false;
    ...
    @Override
    public ReferenceLineCustomLabelConfiguration clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.ReferenceLineCustomLabelConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
