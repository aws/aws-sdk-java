...
/**
 * ScatterPlotVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ScatterPlotVisualMarshaller {
    ...
    private static final ScatterPlotVisualMarshaller instance = new ScatterPlotVisualMarshaller();

    public static ScatterPlotVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ScatterPlotVisual scatterPlotVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(scatterPlotVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(scatterPlotVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(scatterPlotVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(scatterPlotVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(scatterPlotVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(scatterPlotVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
