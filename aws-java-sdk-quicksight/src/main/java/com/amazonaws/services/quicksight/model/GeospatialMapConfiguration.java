 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/GeospatialMapConfiguration"
...
public class GeospatialMapConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setPointStyleOptions(GeospatialPointStyleOptions pointStyleOptions) {
    ...
    public GeospatialMapConfiguration withPointStyleOptions(GeospatialPointStyleOptions pointStyleOptions) {
        setPointStyleOptions(pointStyleOptions);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GeospatialMapConfiguration == false)
            return false;
        ...
        if (other.getMapStyleOptions() != null && other.getMapStyleOptions().equals(this.getMapStyleOptions()) == false)
            return false;
        if (other.getPointStyleOptions() == null ^ this.getPointStyleOptions() == null)
            return false;
        if (other.getPointStyleOptions() != null && other.getPointStyleOptions().equals(this.getPointStyleOptions()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getPointStyleOptions() == null) ? 0 : getPointStyleOptions().hashCode());
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.GeospatialMapConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
