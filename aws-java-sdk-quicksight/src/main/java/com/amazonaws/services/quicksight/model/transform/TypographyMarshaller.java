...
/**
 * TypographyMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TypographyMarshaller {

    private static final MarshallingInfo<List> FONTFAMILIES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("FontFamilies").build();
