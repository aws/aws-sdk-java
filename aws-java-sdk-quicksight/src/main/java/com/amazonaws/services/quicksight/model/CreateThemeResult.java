...
public class CreateThemeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) for the new theme.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateThemeResult == false)
            return false;
        CreateThemeResult other = (CreateThemeResult) obj;
    ...
    public CreateThemeResult clone() {
        try {
            return (CreateThemeResult) super.clone();
