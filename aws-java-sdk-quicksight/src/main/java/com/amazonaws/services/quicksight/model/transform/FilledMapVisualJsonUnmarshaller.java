...
/**
 * FilledMapVisual JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FilledMapVisualJsonUnmarshaller implements Unmarshaller<FilledMapVisual, JsonUnmarshallerContext> {

    public FilledMapVisual unmarshall(JsonUnmarshallerContext context) throws Exception {
        FilledMapVisual filledMapVisual = new FilledMapVisual();
    ...
    private static FilledMapVisualJsonUnmarshaller instance;

    public static FilledMapVisualJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FilledMapVisualJsonUnmarshaller();
        return instance;
    }
}
