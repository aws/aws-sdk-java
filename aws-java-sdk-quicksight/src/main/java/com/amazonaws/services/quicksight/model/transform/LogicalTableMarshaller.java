...
public class LogicalTableMarshaller {
    ...
    private static final MarshallingInfo<List> DATATRANSFORMS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DataTransforms").build();
    ...
    public void marshall(LogicalTable logicalTable, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(logicalTable.getAlias(), ALIAS_BINDING);
            protocolMarshaller.marshall(logicalTable.getDataTransforms(), DATATRANSFORMS_BINDING);
            protocolMarshaller.marshall(logicalTable.getSource(), SOURCE_BINDING);
        } catch (Exception e) {
