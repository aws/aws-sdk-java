...
/**
 * FindingSourceDetailMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FindingSourceDetailMarshaller {
    ...
    public static FindingSourceDetailMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FindingSourceDetail findingSourceDetail, ProtocolMarshaller protocolMarshaller) {

        if (findingSourceDetail == null) {
