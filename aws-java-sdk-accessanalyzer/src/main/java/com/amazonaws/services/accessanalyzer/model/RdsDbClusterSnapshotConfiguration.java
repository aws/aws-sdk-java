 ...
 * <code>RdsDbClusterSnapshotAttributeValue</code> and optional KMS encryption key. For more information, see <a
 * href="https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_ModifyDBClusterSnapshotAttribute.html"
 * >ModifyDBClusterSnapshotAttribute</a>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/RdsDbClusterSnapshotConfiguration"
...
public class RdsDbClusterSnapshotConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.Map<String, RdsDbClusterSnapshotAttributeValue> attributes;
    /**
     * <p>
     ...
     *         valid value for <code>AttributeName</code> for the attribute map is <code>restore</code>
     */

    public java.util.Map<String, RdsDbClusterSnapshotAttributeValue> getAttributes() {
        return attributes;
    }
    ...
    public void setAttributes(java.util.Map<String, RdsDbClusterSnapshotAttributeValue> attributes) {
    ...
    public RdsDbClusterSnapshotConfiguration addAttributesEntry(String key, RdsDbClusterSnapshotAttributeValue value) {
        if (null == this.attributes) {
            this.attributes = new java.util.HashMap<String, RdsDbClusterSnapshotAttributeValue>();
        }
