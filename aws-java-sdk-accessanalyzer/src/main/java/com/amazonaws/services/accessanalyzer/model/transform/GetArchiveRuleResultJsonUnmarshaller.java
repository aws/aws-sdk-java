...
/**
 * GetArchiveRuleResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetArchiveRuleResultJsonUnmarshaller implements Unmarshaller<GetArchiveRuleResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("archiveRule", targetDepth)) {
                    context.nextToken();
                    getArchiveRuleResult.setArchiveRule(ArchiveRuleSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
