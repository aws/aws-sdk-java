...
/**
 * CreateArchiveRuleResult JSON Unmarshaller
 */
...
public class CreateArchiveRuleResultJsonUnmarshaller implements Unmarshaller<CreateArchiveRuleResult, JsonUnmarshallerContext> {
    ...
    public CreateArchiveRuleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateArchiveRuleResult createArchiveRuleResult = new CreateArchiveRuleResult();
