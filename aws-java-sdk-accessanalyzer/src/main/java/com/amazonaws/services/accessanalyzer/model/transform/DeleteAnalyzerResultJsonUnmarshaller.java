...
/**
 * DeleteAnalyzerResult JSON Unmarshaller
 */
...
public class DeleteAnalyzerResultJsonUnmarshaller implements Unmarshaller<DeleteAnalyzerResult, JsonUnmarshallerContext> {
    ...
    public DeleteAnalyzerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAnalyzerResult deleteAnalyzerResult = new DeleteAnalyzerResult();
