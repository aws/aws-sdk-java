...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/ListFindingsV2" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListFindingsV2Result extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<FindingSummaryV2> findings;
    /**
     * <p>
    ...
    public java.util.List<FindingSummaryV2> getFindings() {
        return findings;
    }
    ...
    public void setFindings(java.util.Collection<FindingSummaryV2> findings) {
        if (findings == null) {
            this.findings = null;
            return;
        }

        this.findings = new java.util.ArrayList<FindingSummaryV2>(findings);
    }
    ...
    public ListFindingsV2Result withFindings(FindingSummaryV2... findings) {
        if (this.findings == null) {
            setFindings(new java.util.ArrayList<FindingSummaryV2>(findings.length));
        }
    ...
    public ListFindingsV2Result withFindings(java.util.Collection<FindingSummaryV2> findings) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFindingsV2Result == false)
            return false;
