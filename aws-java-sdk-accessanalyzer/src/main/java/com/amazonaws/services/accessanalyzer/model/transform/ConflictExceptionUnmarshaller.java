...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.accessanalyzer.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.accessanalyzer.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.accessanalyzer.model.ConflictException conflictException = new com.amazonaws.services.accessanalyzer.model.ConflictException(
                null);
