...
public class ListPolicyGenerationsRequestMarshaller {
    ...
    public static ListPolicyGenerationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListPolicyGenerationsRequest listPolicyGenerationsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listPolicyGenerationsRequest == null) {
