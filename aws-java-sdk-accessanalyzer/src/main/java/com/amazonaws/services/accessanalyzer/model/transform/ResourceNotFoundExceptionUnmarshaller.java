...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.accessanalyzer.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.accessanalyzer.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.accessanalyzer.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.accessanalyzer.model.ResourceNotFoundException(
                null);
