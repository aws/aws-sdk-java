...
/**
 * DeleteArchiveRuleResult JSON Unmarshaller
 */
...
public class DeleteArchiveRuleResultJsonUnmarshaller implements Unmarshaller<DeleteArchiveRuleResult, JsonUnmarshallerContext> {
    ...
    public DeleteArchiveRuleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteArchiveRuleResult deleteArchiveRuleResult = new DeleteArchiveRuleResult();
