...
public class KmsKeyConfigurationMarshaller {
    ...
    public static KmsKeyConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(KmsKeyConfiguration kmsKeyConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (kmsKeyConfiguration == null) {
