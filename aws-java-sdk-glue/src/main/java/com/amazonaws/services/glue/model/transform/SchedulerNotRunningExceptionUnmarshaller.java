...
public class SchedulerNotRunningExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SchedulerNotRunningExceptionUnmarshaller instance;

    public static SchedulerNotRunningExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SchedulerNotRunningExceptionUnmarshaller();
        return instance;
    }
}
