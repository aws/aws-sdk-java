...
public class TagResourceRequestMarshaller {
    ...
    private static final MarshallingInfo<Map> TAGSTOADD_BINDING = MarshallingInfo.builder(MarshallingType.MAP).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(TagResourceRequest tagResourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(tagResourceRequest.getTagsToAdd(), TAGSTOADD_BINDING);
        } catch (Exception e) {
