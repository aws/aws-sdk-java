...
@SdkInternalApi
public class GetDevEndpointRequestMarshaller {
    ...
    private static final GetDevEndpointRequestMarshaller instance = new GetDevEndpointRequestMarshaller();

    public static GetDevEndpointRequestMarshaller getInstance() {
        return instance;
    }
