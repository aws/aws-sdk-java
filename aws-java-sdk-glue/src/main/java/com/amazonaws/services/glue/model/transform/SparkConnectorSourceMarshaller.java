...
/**
 * SparkConnectorSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SparkConnectorSourceMarshaller {
    ...
    private static final SparkConnectorSourceMarshaller instance = new SparkConnectorSourceMarshaller();

    public static SparkConnectorSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SparkConnectorSource sparkConnectorSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sparkConnectorSource.getName(), NAME_BINDING);
            protocolMarshaller.marshall(sparkConnectorSource.getConnectionName(), CONNECTIONNAME_BINDING);
            protocolMarshaller.marshall(sparkConnectorSource.getConnectorName(), CONNECTORNAME_BINDING);
            protocolMarshaller.marshall(sparkConnectorSource.getConnectionType(), CONNECTIONTYPE_BINDING);
            protocolMarshaller.marshall(sparkConnectorSource.getAdditionalOptions(), ADDITIONALOPTIONS_BINDING);
            protocolMarshaller.marshall(sparkConnectorSource.getOutputSchemas(), OUTPUTSCHEMAS_BINDING);
        } catch (Exception e) {
