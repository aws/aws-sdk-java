...
public class GetDataQualityResultResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The date and time when the run for this data quality result started.
     */
    ...
    public GetDataQualityResultResult withStartedOn(java.util.Date startedOn) {
     ...
     * </p>
     * 
     * @return The date and time when the run for this data quality result was completed.
     */
    ...
    public GetDataQualityResultResult withCompletedOn(java.util.Date completedOn) {
     ...
     * </p>
     * 
     * @return The unique run ID associated with the ruleset evaluation.
     */
    ...
    public GetDataQualityResultResult withRuleResults(java.util.Collection<DataQualityRuleResult> ruleResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDataQualityResultResult == false)
            return false;
        GetDataQualityResultResult other = (GetDataQualityResultResult) obj;
    ...
    public GetDataQualityResultResult clone() {
        try {
            return (GetDataQualityResultResult) super.clone();
