...
/**
 * RedshiftSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RedshiftSourceMarshaller {
    ...
    private static final RedshiftSourceMarshaller instance = new RedshiftSourceMarshaller();

    public static RedshiftSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RedshiftSource redshiftSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(redshiftSource.getName(), NAME_BINDING);
            protocolMarshaller.marshall(redshiftSource.getDatabase(), DATABASE_BINDING);
            protocolMarshaller.marshall(redshiftSource.getTable(), TABLE_BINDING);
            protocolMarshaller.marshall(redshiftSource.getRedshiftTmpDir(), REDSHIFTTMPDIR_BINDING);
            protocolMarshaller.marshall(redshiftSource.getTmpDirIAMRole(), TMPDIRIAMROLE_BINDING);
        } catch (Exception e) {
