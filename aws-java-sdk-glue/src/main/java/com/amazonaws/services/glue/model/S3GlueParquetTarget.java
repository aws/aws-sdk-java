 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/S3GlueParquetTarget" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class S3GlueParquetTarget implements Serializable, Cloneable, StructuredPojo {
    ...
    public S3GlueParquetTarget withInputs(java.util.Collection<String> inputs) {
        setInputs(inputs);
        return this;
    }
    ...
    public S3GlueParquetTarget withPartitionKeys(java.util.List<String>... partitionKeys) {
    ...
    public S3GlueParquetTarget withPartitionKeys(java.util.Collection<java.util.List<String>> partitionKeys) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof S3GlueParquetTarget == false)
            return false;
        S3GlueParquetTarget other = (S3GlueParquetTarget) obj;
    ...
    public S3GlueParquetTarget clone() {
        try {
            return (S3GlueParquetTarget) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.S3GlueParquetTargetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
