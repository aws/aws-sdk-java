...
public class BatchCreatePartitionRequestMarshaller {
    ...
    private static final MarshallingInfo<List> PARTITIONINPUTLIST_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("PartitionInputList").build();

    private static final BatchCreatePartitionRequestMarshaller instance = new BatchCreatePartitionRequestMarshaller();

    public static BatchCreatePartitionRequestMarshaller getInstance() {
        return instance;
    }
