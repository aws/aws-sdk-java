...
/**
 * UpdatePartitionResult JSON Unmarshaller
 */
...
public class UpdatePartitionResultJsonUnmarshaller implements Unmarshaller<UpdatePartitionResult, JsonUnmarshallerContext> {
    ...
    public UpdatePartitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdatePartitionResult updatePartitionResult = new UpdatePartitionResult();
