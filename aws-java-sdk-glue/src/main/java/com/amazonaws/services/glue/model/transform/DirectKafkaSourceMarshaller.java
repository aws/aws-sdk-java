...
/**
 * DirectKafkaSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DirectKafkaSourceMarshaller {
    ...
    private static final DirectKafkaSourceMarshaller instance = new DirectKafkaSourceMarshaller();

    public static DirectKafkaSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DirectKafkaSource directKafkaSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(directKafkaSource.getName(), NAME_BINDING);
            protocolMarshaller.marshall(directKafkaSource.getStreamingOptions(), STREAMINGOPTIONS_BINDING);
            protocolMarshaller.marshall(directKafkaSource.getWindowSize(), WINDOWSIZE_BINDING);
            protocolMarshaller.marshall(directKafkaSource.getDetectSchema(), DETECTSCHEMA_BINDING);
            protocolMarshaller.marshall(directKafkaSource.getDataPreviewOptions(), DATAPREVIEWOPTIONS_BINDING);
        } catch (Exception e) {
