        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Jobs", targetDepth)) {
                    context.nextToken();
                    batchGetJobsResult.setJobs(new ListUnmarshaller<Job>(JobJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("JobsNotFound", targetDepth)) {
                    context.nextToken();
                    batchGetJobsResult.setJobsNotFound(new ListUnmarshaller<String>(context.getUnmarshaller(String.class)).unmarshall(context));
                }
