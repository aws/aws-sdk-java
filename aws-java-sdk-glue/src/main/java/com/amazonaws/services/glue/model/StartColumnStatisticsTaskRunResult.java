...
public class StartColumnStatisticsTaskRunResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The identifier for the column statistics task run.
     */
    ...
    public StartColumnStatisticsTaskRunResult withColumnStatisticsTaskRunId(String columnStatisticsTaskRunId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartColumnStatisticsTaskRunResult == false)
            return false;
        StartColumnStatisticsTaskRunResult other = (StartColumnStatisticsTaskRunResult) obj;
    ...
    @Override
    public StartColumnStatisticsTaskRunResult clone() {
        try {
            return (StartColumnStatisticsTaskRunResult) super.clone();
