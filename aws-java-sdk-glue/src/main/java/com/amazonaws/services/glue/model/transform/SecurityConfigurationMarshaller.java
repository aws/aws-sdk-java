...
/**
 * SecurityConfigurationMarshaller
 */
...
public class SecurityConfigurationMarshaller {
    ...
    public void marshall(SecurityConfiguration securityConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(securityConfiguration.getName(), NAME_BINDING);
            protocolMarshaller.marshall(securityConfiguration.getCreatedTimeStamp(), CREATEDTIMESTAMP_BINDING);
            protocolMarshaller.marshall(securityConfiguration.getEncryptionConfiguration(), ENCRYPTIONCONFIGURATION_BINDING);
        } catch (Exception e) {
