...
/**
 * StopCrawlerScheduleResult JSON Unmarshaller
 */
...
public class StopCrawlerScheduleResultJsonUnmarshaller implements Unmarshaller<StopCrawlerScheduleResult, JsonUnmarshallerContext> {
    ...
    public StopCrawlerScheduleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopCrawlerScheduleResult stopCrawlerScheduleResult = new StopCrawlerScheduleResult();
