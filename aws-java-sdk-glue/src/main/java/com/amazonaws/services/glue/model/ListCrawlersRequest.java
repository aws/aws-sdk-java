...
public class ListCrawlersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *
     * @see ListCrawlersRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ListCrawlersRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCrawlersRequest == false)
            return false;
        ListCrawlersRequest other = (ListCrawlersRequest) obj;
    ...
    @Override
    public ListCrawlersRequest clone() {
        return (ListCrawlersRequest) super.clone();
    }
