...
@SdkInternalApi
public class S3DirectTargetMarshaller {
    ...
    private static final S3DirectTargetMarshaller instance = new S3DirectTargetMarshaller();

    public static S3DirectTargetMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(S3DirectTarget s3DirectTarget, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3DirectTarget.getName(), NAME_BINDING);
            protocolMarshaller.marshall(s3DirectTarget.getInputs(), INPUTS_BINDING);
            protocolMarshaller.marshall(s3DirectTarget.getPartitionKeys(), PARTITIONKEYS_BINDING);
            protocolMarshaller.marshall(s3DirectTarget.getPath(), PATH_BINDING);
            protocolMarshaller.marshall(s3DirectTarget.getCompression(), COMPRESSION_BINDING);
            protocolMarshaller.marshall(s3DirectTarget.getFormat(), FORMAT_BINDING);
            protocolMarshaller.marshall(s3DirectTarget.getSchemaChangePolicy(), SCHEMACHANGEPOLICY_BINDING);
        } catch (Exception e) {
