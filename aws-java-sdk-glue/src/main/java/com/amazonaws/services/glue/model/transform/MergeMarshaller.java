...
public class MergeMarshaller {
    ...
    private static final MergeMarshaller instance = new MergeMarshaller();

    public static MergeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Merge merge, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(merge.getName(), NAME_BINDING);
            protocolMarshaller.marshall(merge.getInputs(), INPUTS_BINDING);
            protocolMarshaller.marshall(merge.getSource(), SOURCE_BINDING);
            protocolMarshaller.marshall(merge.getPrimaryKeys(), PRIMARYKEYS_BINDING);
        } catch (Exception e) {
