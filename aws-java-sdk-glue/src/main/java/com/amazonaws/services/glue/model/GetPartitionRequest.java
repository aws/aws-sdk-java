...
public class GetPartitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * The ID of the Data Catalog where the partition in question resides. If none is supplied, the AWS account ID is
     * used by default.
     * </p>
     */
     ...
     * 
     * @param catalogId
     *        The ID of the Data Catalog where the partition in question resides. If none is supplied, the AWS account
     ...
     * </p>
     * 
     * @return The ID of the Data Catalog where the partition in question resides. If none is supplied, the AWS account
     *         ID is used by default.
     */
     ...
     * </p>
     * 
     * @return The name of the catalog database where the partition resides.
     */
     ...
     * </p>
     * 
     * @return The name of the partition's table.
     */
    ...
    public GetPartitionRequest clone() {
        return (GetPartitionRequest) super.clone();
    }
