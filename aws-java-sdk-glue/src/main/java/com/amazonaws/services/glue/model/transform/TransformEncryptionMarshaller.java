...
/**
 * TransformEncryptionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TransformEncryptionMarshaller {

    private static final MarshallingInfo<StructuredPojo> MLUSERDATAENCRYPTION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MlUserDataEncryption").build();
    private static final MarshallingInfo<String> TASKRUNSECURITYCONFIGURATIONNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("TaskRunSecurityConfigurationName").build();
