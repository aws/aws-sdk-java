...
public class EntityNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EntityNotFoundExceptionUnmarshaller instance;

    public static EntityNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EntityNotFoundExceptionUnmarshaller();
        return instance;
    }
}
