 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/S3JsonSource" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class S3JsonSource implements Serializable, Cloneable, StructuredPojo {
    ...
    public S3JsonSource withPaths(java.util.Collection<String> paths) {
        setPaths(paths);
        return this;
    }
    ...
    public S3JsonSource withExclusions(java.util.Collection<String> exclusions) {
     ...
     * </p>
     * 
     * @return A JsonPath string defining the JSON data.
     */
     ...
     * </p>
     * 
     * @return Specifies the data schema for the S3 JSON source.
     */
    ...
    public S3JsonSource withOutputSchemas(java.util.Collection<GlueSchema> outputSchemas) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof S3JsonSource == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.S3JsonSourceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
