 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/S3HudiCatalogTarget" target="_top">AWS API
 *      Documentation</a>
 */
...
public class S3HudiCatalogTarget implements Serializable, Cloneable, StructuredPojo {
    ...
    public S3HudiCatalogTarget withInputs(java.util.Collection<String> inputs) {
        setInputs(inputs);
        return this;
    }
    ...
    public S3HudiCatalogTarget withPartitionKeys(java.util.List<String>... partitionKeys) {
    ...
    public S3HudiCatalogTarget withPartitionKeys(java.util.Collection<java.util.List<String>> partitionKeys) {
     ...
     *
     * @see S3HudiCatalogTarget#withAdditionalOptions
     * @returns a reference to this object so that method calls can be chained together.
     */

    public S3HudiCatalogTarget addAdditionalOptionsEntry(String key, String value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof S3HudiCatalogTarget == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.S3HudiCatalogTargetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
