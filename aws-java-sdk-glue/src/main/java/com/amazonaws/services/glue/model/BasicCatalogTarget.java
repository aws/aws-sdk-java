 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/BasicCatalogTarget" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BasicCatalogTarget implements Serializable, Cloneable, StructuredPojo {
    ...
    public BasicCatalogTarget withInputs(java.util.Collection<String> inputs) {
        setInputs(inputs);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BasicCatalogTarget == false)
            return false;
    ...
    public BasicCatalogTarget clone() {
        try {
            return (BasicCatalogTarget) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.BasicCatalogTargetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
