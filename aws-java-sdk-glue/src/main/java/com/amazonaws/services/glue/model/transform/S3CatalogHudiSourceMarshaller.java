...
/**
 * S3CatalogHudiSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class S3CatalogHudiSourceMarshaller {
    ...
    private static final S3CatalogHudiSourceMarshaller instance = new S3CatalogHudiSourceMarshaller();

    public static S3CatalogHudiSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(S3CatalogHudiSource s3CatalogHudiSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3CatalogHudiSource.getName(), NAME_BINDING);
            protocolMarshaller.marshall(s3CatalogHudiSource.getDatabase(), DATABASE_BINDING);
            protocolMarshaller.marshall(s3CatalogHudiSource.getTable(), TABLE_BINDING);
            protocolMarshaller.marshall(s3CatalogHudiSource.getAdditionalHudiOptions(), ADDITIONALHUDIOPTIONS_BINDING);
            protocolMarshaller.marshall(s3CatalogHudiSource.getOutputSchemas(), OUTPUTSCHEMAS_BINDING);
        } catch (Exception e) {
