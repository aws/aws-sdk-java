...
/**
 * DeleteDatabaseRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteDatabaseRequestMarshaller {
    ...
    private static final DeleteDatabaseRequestMarshaller instance = new DeleteDatabaseRequestMarshaller();

    public static DeleteDatabaseRequestMarshaller getInstance() {
        return instance;
    }
