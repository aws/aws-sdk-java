 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/JDBCConnectorTarget" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JDBCConnectorTarget implements Serializable, Cloneable, StructuredPojo {
    ...
    public JDBCConnectorTarget withInputs(java.util.Collection<String> inputs) {
        setInputs(inputs);
        return this;
    }
     ...
     *
     * @see JDBCConnectorTarget#withAdditionalOptions
     * @returns a reference to this object so that method calls can be chained together.
     */

    public JDBCConnectorTarget addAdditionalOptionsEntry(String key, String value) {
    ...
    public JDBCConnectorTarget withOutputSchemas(java.util.Collection<GlueSchema> outputSchemas) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof JDBCConnectorTarget == false)
            return false;
    ...
    public JDBCConnectorTarget clone() {
        try {
            return (JDBCConnectorTarget) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.JDBCConnectorTargetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
