...
/**
 * GovernedCatalogSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GovernedCatalogSourceMarshaller {
    ...
    private static final GovernedCatalogSourceMarshaller instance = new GovernedCatalogSourceMarshaller();

    public static GovernedCatalogSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GovernedCatalogSource governedCatalogSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(governedCatalogSource.getName(), NAME_BINDING);
            protocolMarshaller.marshall(governedCatalogSource.getDatabase(), DATABASE_BINDING);
            protocolMarshaller.marshall(governedCatalogSource.getTable(), TABLE_BINDING);
            protocolMarshaller.marshall(governedCatalogSource.getPartitionPredicate(), PARTITIONPREDICATE_BINDING);
            protocolMarshaller.marshall(governedCatalogSource.getAdditionalOptions(), ADDITIONALOPTIONS_BINDING);
        } catch (Exception e) {
