...
public class ListTriggersRequestMarshaller {
    ...
    private static final MarshallingInfo<String> DEPENDENTJOBNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DependentJobName").build();
