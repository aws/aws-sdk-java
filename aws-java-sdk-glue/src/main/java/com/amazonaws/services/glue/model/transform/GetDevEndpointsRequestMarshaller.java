...
@SdkInternalApi
public class GetDevEndpointsRequestMarshaller {
    ...
    private static final GetDevEndpointsRequestMarshaller instance = new GetDevEndpointsRequestMarshaller();

    public static GetDevEndpointsRequestMarshaller getInstance() {
        return instance;
    }
