...
/**
 * GetTableVersionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetTableVersionResultJsonUnmarshaller implements Unmarshaller<GetTableVersionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TableVersion", targetDepth)) {
                    context.nextToken();
                    getTableVersionResult.setTableVersion(TableVersionJsonUnmarshaller.getInstance().unmarshall(context));
                }
