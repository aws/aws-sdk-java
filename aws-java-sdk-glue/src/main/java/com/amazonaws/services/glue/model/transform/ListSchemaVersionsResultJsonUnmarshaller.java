...
/**
 * ListSchemaVersionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSchemaVersionsResultJsonUnmarshaller implements Unmarshaller<ListSchemaVersionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Schemas", targetDepth)) {
                    context.nextToken();
                    listSchemaVersionsResult.setSchemas(new ListUnmarshaller<SchemaVersionListItem>(SchemaVersionListItemJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listSchemaVersionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
