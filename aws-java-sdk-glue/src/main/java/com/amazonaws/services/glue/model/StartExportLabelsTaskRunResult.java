...
public class StartExportLabelsTaskRunResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartExportLabelsTaskRunResult withTaskRunId(String taskRunId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartExportLabelsTaskRunResult == false)
            return false;
        StartExportLabelsTaskRunResult other = (StartExportLabelsTaskRunResult) obj;
    ...
    @Override
    public StartExportLabelsTaskRunResult clone() {
        try {
            return (StartExportLabelsTaskRunResult) super.clone();
