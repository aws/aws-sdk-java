...
public class ConcurrentModificationExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.glue.model.ConcurrentModificationException> {
    private ConcurrentModificationExceptionUnmarshaller() {
        super("ConcurrentModificationException");
    }

    @Override
    public com.amazonaws.services.glue.model.ConcurrentModificationException unmarshall(JsonUnmarshallerContext context) throws Exception {
