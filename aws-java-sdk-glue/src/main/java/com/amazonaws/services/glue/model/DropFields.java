 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/DropFields" target="_top">AWS API
 *      Documentation</a>
 */
...
public class DropFields implements Serializable, Cloneable, StructuredPojo {
    ...
    public DropFields withInputs(java.util.Collection<String> inputs) {
        setInputs(inputs);
        return this;
    }
    ...
    public DropFields withPaths(java.util.List<String>... paths) {
        if (this.paths == null) {
    ...
    public DropFields withPaths(java.util.Collection<java.util.List<String>> paths) {
        setPaths(paths);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DropFields == false)
            return false;
        DropFields other = (DropFields) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.DropFieldsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
