...
/**
 * DataCatalogEncryptionSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataCatalogEncryptionSettingsJsonUnmarshaller implements Unmarshaller<DataCatalogEncryptionSettings, JsonUnmarshallerContext> {

    public DataCatalogEncryptionSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
