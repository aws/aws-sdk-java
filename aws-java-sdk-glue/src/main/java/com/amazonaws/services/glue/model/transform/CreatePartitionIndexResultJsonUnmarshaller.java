...
/**
 * CreatePartitionIndexResult JSON Unmarshaller
 */
...
public class CreatePartitionIndexResultJsonUnmarshaller implements Unmarshaller<CreatePartitionIndexResult, JsonUnmarshallerContext> {
    ...
    public CreatePartitionIndexResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreatePartitionIndexResult createPartitionIndexResult = new CreatePartitionIndexResult();

        return createPartitionIndexResult;
    }
