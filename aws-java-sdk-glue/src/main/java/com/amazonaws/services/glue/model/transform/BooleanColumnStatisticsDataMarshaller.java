...
/**
 * BooleanColumnStatisticsDataMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BooleanColumnStatisticsDataMarshaller {

    private static final MarshallingInfo<Long> NUMBEROFTRUES_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("NumberOfTrues").build();
    private static final MarshallingInfo<Long> NUMBEROFFALSES_BINDING = MarshallingInfo.builder(MarshallingType.LONG)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("NumberOfFalses").build();
