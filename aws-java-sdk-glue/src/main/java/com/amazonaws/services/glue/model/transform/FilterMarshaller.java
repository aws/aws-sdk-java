...
public class FilterMarshaller {
    ...
    public void marshall(Filter filter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(filter.getInputs(), INPUTS_BINDING);
            protocolMarshaller.marshall(filter.getLogicalOperator(), LOGICALOPERATOR_BINDING);
            protocolMarshaller.marshall(filter.getFilters(), FILTERS_BINDING);
        } catch (Exception e) {
