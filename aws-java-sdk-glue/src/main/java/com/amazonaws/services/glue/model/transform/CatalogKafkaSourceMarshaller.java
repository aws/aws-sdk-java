...
/**
 * CatalogKafkaSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CatalogKafkaSourceMarshaller {
    ...
    private static final CatalogKafkaSourceMarshaller instance = new CatalogKafkaSourceMarshaller();

    public static CatalogKafkaSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CatalogKafkaSource catalogKafkaSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(catalogKafkaSource.getName(), NAME_BINDING);
            protocolMarshaller.marshall(catalogKafkaSource.getWindowSize(), WINDOWSIZE_BINDING);
            protocolMarshaller.marshall(catalogKafkaSource.getDetectSchema(), DETECTSCHEMA_BINDING);
            protocolMarshaller.marshall(catalogKafkaSource.getTable(), TABLE_BINDING);
            protocolMarshaller.marshall(catalogKafkaSource.getDatabase(), DATABASE_BINDING);
            protocolMarshaller.marshall(catalogKafkaSource.getStreamingOptions(), STREAMINGOPTIONS_BINDING);
            protocolMarshaller.marshall(catalogKafkaSource.getDataPreviewOptions(), DATAPREVIEWOPTIONS_BINDING);
        } catch (Exception e) {
