...
/**
 * DeleteCrawlerResult JSON Unmarshaller
 */
...
public class DeleteCrawlerResultJsonUnmarshaller implements Unmarshaller<DeleteCrawlerResult, JsonUnmarshallerContext> {
    ...
    public DeleteCrawlerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCrawlerResult deleteCrawlerResult = new DeleteCrawlerResult();
