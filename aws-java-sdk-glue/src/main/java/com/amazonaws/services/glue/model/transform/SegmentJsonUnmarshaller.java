    ...
    public Segment unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SegmentNumber", targetDepth)) {
                    context.nextToken();
                    segment.setSegmentNumber(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("TotalSegments", targetDepth)) {
                    context.nextToken();
                    segment.setTotalSegments(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
