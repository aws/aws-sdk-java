...
public class GetWorkflowRunResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetWorkflowRunResult == false)
            return false;
        GetWorkflowRunResult other = (GetWorkflowRunResult) obj;
    ...
    public GetWorkflowRunResult clone() {
        try {
            return (GetWorkflowRunResult) super.clone();
