...
/**
 * GovernedCatalogTargetMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GovernedCatalogTargetMarshaller {
    ...
    private static final GovernedCatalogTargetMarshaller instance = new GovernedCatalogTargetMarshaller();

    public static GovernedCatalogTargetMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GovernedCatalogTarget governedCatalogTarget, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(governedCatalogTarget.getName(), NAME_BINDING);
            protocolMarshaller.marshall(governedCatalogTarget.getInputs(), INPUTS_BINDING);
            protocolMarshaller.marshall(governedCatalogTarget.getPartitionKeys(), PARTITIONKEYS_BINDING);
            protocolMarshaller.marshall(governedCatalogTarget.getTable(), TABLE_BINDING);
            protocolMarshaller.marshall(governedCatalogTarget.getDatabase(), DATABASE_BINDING);
            protocolMarshaller.marshall(governedCatalogTarget.getSchemaChangePolicy(), SCHEMACHANGEPOLICY_BINDING);
        } catch (Exception e) {
