...
public class BatchGetCustomEntityTypesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public BatchGetCustomEntityTypesRequest withNames(java.util.Collection<String> names) {
        setNames(names);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetCustomEntityTypesRequest == false)
            return false;
        BatchGetCustomEntityTypesRequest other = (BatchGetCustomEntityTypesRequest) obj;
    ...
    public BatchGetCustomEntityTypesRequest clone() {
        return (BatchGetCustomEntityTypesRequest) super.clone();
    }
