...
public class CrawlerRunningExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CrawlerRunningExceptionUnmarshaller instance;

    public static CrawlerRunningExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CrawlerRunningExceptionUnmarshaller();
        return instance;
    }
}
