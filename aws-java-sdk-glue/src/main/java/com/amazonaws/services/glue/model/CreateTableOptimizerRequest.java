...
public class CreateTableOptimizerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateTableOptimizerRequest withCatalogId(String catalogId) {
    ...
    public CreateTableOptimizerRequest withDatabaseName(String databaseName) {
    ...
    public CreateTableOptimizerRequest withTableName(String tableName) {
    ...
    public CreateTableOptimizerRequest withType(String type) {
        setType(type);
        return this;
    }
    ...
    public CreateTableOptimizerRequest withType(TableOptimizerType type) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTableOptimizerRequest == false)
            return false;
        CreateTableOptimizerRequest other = (CreateTableOptimizerRequest) obj;
    ...
    @Override
    public CreateTableOptimizerRequest clone() {
