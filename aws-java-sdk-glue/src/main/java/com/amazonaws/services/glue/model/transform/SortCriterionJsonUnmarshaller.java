        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FieldName", targetDepth)) {
                    context.nextToken();
                    sortCriterion.setFieldName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Sort", targetDepth)) {
                    context.nextToken();
                    sortCriterion.setSort(context.getUnmarshaller(String.class).unmarshall(context));
                }
