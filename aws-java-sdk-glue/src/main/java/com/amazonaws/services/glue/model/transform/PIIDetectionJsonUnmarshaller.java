...
/**
 * PIIDetection JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PIIDetectionJsonUnmarshaller implements Unmarshaller<PIIDetection, JsonUnmarshallerContext> {

    public PIIDetection unmarshall(JsonUnmarshallerContext context) throws Exception {
        PIIDetection pIIDetection = new PIIDetection();
    ...
    private static PIIDetectionJsonUnmarshaller instance;

    public static PIIDetectionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PIIDetectionJsonUnmarshaller();
        return instance;
    }
}
