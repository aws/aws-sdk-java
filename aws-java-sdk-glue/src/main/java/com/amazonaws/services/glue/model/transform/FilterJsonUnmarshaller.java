        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Inputs", targetDepth)) {
                    context.nextToken();
                    filter.setInputs(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("LogicalOperator", targetDepth)) {
                    context.nextToken();
                    filter.setLogicalOperator(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Filters", targetDepth)) {
                    context.nextToken();
                    filter.setFilters(new ListUnmarshaller<FilterExpression>(FilterExpressionJsonUnmarshaller.getInstance())
