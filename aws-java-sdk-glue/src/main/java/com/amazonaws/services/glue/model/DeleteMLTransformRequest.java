...
public class DeleteMLTransformRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique identifier of the transform to delete.
     */
    ...
    @Override
    public DeleteMLTransformRequest clone() {
        return (DeleteMLTransformRequest) super.clone();
    }
