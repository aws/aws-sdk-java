...
/**
 * CatalogKinesisSource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CatalogKinesisSourceJsonUnmarshaller implements Unmarshaller<CatalogKinesisSource, JsonUnmarshallerContext> {

    public CatalogKinesisSource unmarshall(JsonUnmarshallerContext context) throws Exception {
        CatalogKinesisSource catalogKinesisSource = new CatalogKinesisSource();
    ...
    private static CatalogKinesisSourceJsonUnmarshaller instance;

    public static CatalogKinesisSourceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CatalogKinesisSourceJsonUnmarshaller();
        return instance;
    }
}
