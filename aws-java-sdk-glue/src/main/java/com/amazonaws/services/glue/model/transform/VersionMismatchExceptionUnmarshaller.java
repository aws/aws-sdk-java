...
public class VersionMismatchExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static VersionMismatchExceptionUnmarshaller instance;

    public static VersionMismatchExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new VersionMismatchExceptionUnmarshaller();
        return instance;
    }
}
