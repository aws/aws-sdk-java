...
/**
 * AthenaConnectorSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AthenaConnectorSourceMarshaller {
    ...
    private static final AthenaConnectorSourceMarshaller instance = new AthenaConnectorSourceMarshaller();

    public static AthenaConnectorSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AthenaConnectorSource athenaConnectorSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(athenaConnectorSource.getName(), NAME_BINDING);
            protocolMarshaller.marshall(athenaConnectorSource.getConnectionName(), CONNECTIONNAME_BINDING);
            protocolMarshaller.marshall(athenaConnectorSource.getConnectorName(), CONNECTORNAME_BINDING);
            protocolMarshaller.marshall(athenaConnectorSource.getConnectionType(), CONNECTIONTYPE_BINDING);
            protocolMarshaller.marshall(athenaConnectorSource.getConnectionTable(), CONNECTIONTABLE_BINDING);
            protocolMarshaller.marshall(athenaConnectorSource.getSchemaName(), SCHEMANAME_BINDING);
            protocolMarshaller.marshall(athenaConnectorSource.getOutputSchemas(), OUTPUTSCHEMAS_BINDING);
        } catch (Exception e) {
