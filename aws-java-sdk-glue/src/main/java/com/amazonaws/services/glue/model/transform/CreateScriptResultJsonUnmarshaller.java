...
/**
 * CreateScriptResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateScriptResultJsonUnmarshaller implements Unmarshaller<CreateScriptResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PythonScript", targetDepth)) {
                    context.nextToken();
                    createScriptResult.setPythonScript(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ScalaCode", targetDepth)) {
                    context.nextToken();
                    createScriptResult.setScalaCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
