...
public class ListMLTransformsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * {@link #setTransformIds(java.util.Collection)} or {@link #withTransformIds(java.util.Collection)} if you want to
    ...
    public ListMLTransformsResult withTransformIds(String... transformIds) {
        if (this.transformIds == null) {
            setTransformIds(new java.util.ArrayList<String>(transformIds.length));
        }
        for (String ele : transformIds) {
            this.transformIds.add(ele);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getTransformIds() != null)
            sb.append("TransformIds: ").append(getTransformIds()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTransformIds() == null ^ this.getTransformIds() == null)
            return false;
        if (other.getTransformIds() != null && other.getTransformIds().equals(this.getTransformIds()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getTransformIds() == null) ? 0 : getTransformIds().hashCode());
        hashCode = prime * hashCode + ((getNextToken() == null) ? 0 : getNextToken().hashCode());
        return hashCode;
    }

    @Override
    public ListMLTransformsResult clone() {
        try {
            return (ListMLTransformsResult) super.clone();
