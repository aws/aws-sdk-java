...
public class UnionMarshaller {
    ...
    private static final MarshallingInfo<String> UNIONTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("UnionType").build();
