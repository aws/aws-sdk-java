 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/OracleSQLCatalogTarget" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OracleSQLCatalogTarget implements Serializable, Cloneable, StructuredPojo {
    ...
    public OracleSQLCatalogTarget withInputs(java.util.Collection<String> inputs) {
        setInputs(inputs);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OracleSQLCatalogTarget == false)
            return false;
        OracleSQLCatalogTarget other = (OracleSQLCatalogTarget) obj;
    ...
    @Override
    public OracleSQLCatalogTarget clone() {
        try {
            return (OracleSQLCatalogTarget) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.OracleSQLCatalogTargetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
