...
@SdkInternalApi
public class S3GlueParquetTargetMarshaller {
    ...
    private static final S3GlueParquetTargetMarshaller instance = new S3GlueParquetTargetMarshaller();

    public static S3GlueParquetTargetMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(S3GlueParquetTarget s3GlueParquetTarget, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3GlueParquetTarget.getName(), NAME_BINDING);
            protocolMarshaller.marshall(s3GlueParquetTarget.getInputs(), INPUTS_BINDING);
            protocolMarshaller.marshall(s3GlueParquetTarget.getPartitionKeys(), PARTITIONKEYS_BINDING);
            protocolMarshaller.marshall(s3GlueParquetTarget.getPath(), PATH_BINDING);
            protocolMarshaller.marshall(s3GlueParquetTarget.getCompression(), COMPRESSION_BINDING);
            protocolMarshaller.marshall(s3GlueParquetTarget.getSchemaChangePolicy(), SCHEMACHANGEPOLICY_BINDING);
        } catch (Exception e) {
