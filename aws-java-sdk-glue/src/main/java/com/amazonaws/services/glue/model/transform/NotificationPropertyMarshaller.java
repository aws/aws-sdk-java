...
/**
 * NotificationPropertyMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class NotificationPropertyMarshaller {

    private static final MarshallingInfo<Integer> NOTIFYDELAYAFTER_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("NotifyDelayAfter").build();
