...
/**
 * FilterValue JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FilterValueJsonUnmarshaller implements Unmarshaller<FilterValue, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Value", targetDepth)) {
                    context.nextToken();
                    filterValue.setValue(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
