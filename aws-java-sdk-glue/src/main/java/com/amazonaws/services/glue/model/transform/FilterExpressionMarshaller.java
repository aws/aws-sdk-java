...
public class FilterExpressionMarshaller {
    ...
    public void marshall(FilterExpression filterExpression, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(filterExpression.getOperation(), OPERATION_BINDING);
            protocolMarshaller.marshall(filterExpression.getNegated(), NEGATED_BINDING);
            protocolMarshaller.marshall(filterExpression.getValues(), VALUES_BINDING);
        } catch (Exception e) {
