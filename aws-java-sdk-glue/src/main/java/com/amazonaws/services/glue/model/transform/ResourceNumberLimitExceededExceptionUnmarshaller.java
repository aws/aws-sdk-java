...
public class ResourceNumberLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceNumberLimitExceededExceptionUnmarshaller instance;

    public static ResourceNumberLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceNumberLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
