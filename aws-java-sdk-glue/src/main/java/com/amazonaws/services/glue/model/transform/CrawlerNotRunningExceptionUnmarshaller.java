...
public class CrawlerNotRunningExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CrawlerNotRunningExceptionUnmarshaller instance;

    public static CrawlerNotRunningExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CrawlerNotRunningExceptionUnmarshaller();
        return instance;
    }
}
