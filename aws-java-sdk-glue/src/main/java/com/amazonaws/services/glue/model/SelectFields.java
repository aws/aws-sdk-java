 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/SelectFields" target="_top">AWS API
 *      Documentation</a>
 */
...
public class SelectFields implements Serializable, Cloneable, StructuredPojo {
    ...
    public SelectFields withInputs(java.util.Collection<String> inputs) {
        setInputs(inputs);
        return this;
    }
    ...
    public SelectFields withPaths(java.util.List<String>... paths) {
        if (this.paths == null) {
    ...
    public SelectFields withPaths(java.util.Collection<java.util.List<String>> paths) {
        setPaths(paths);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SelectFields == false)
            return false;
        SelectFields other = (SelectFields) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.SelectFieldsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
