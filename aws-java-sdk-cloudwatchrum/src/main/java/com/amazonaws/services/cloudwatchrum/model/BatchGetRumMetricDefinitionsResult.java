...
public class BatchGetRumMetricDefinitionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array of structures that display information about the metrics that are sent by the specified app
    ...
    public BatchGetRumMetricDefinitionsResult withMetricDefinitions(MetricDefinition... metricDefinitions) {
    ...
    public BatchGetRumMetricDefinitionsResult withMetricDefinitions(java.util.Collection<MetricDefinition> metricDefinitions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetRumMetricDefinitionsResult == false)
            return false;
        BatchGetRumMetricDefinitionsResult other = (BatchGetRumMetricDefinitionsResult) obj;
    ...
    public BatchGetRumMetricDefinitionsResult clone() {
        try {
            return (BatchGetRumMetricDefinitionsResult) super.clone();
