...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudwatchrum.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.cloudwatchrum.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudwatchrum.model.ValidationException validationException = new com.amazonaws.services.cloudwatchrum.model.ValidationException(
                null);
