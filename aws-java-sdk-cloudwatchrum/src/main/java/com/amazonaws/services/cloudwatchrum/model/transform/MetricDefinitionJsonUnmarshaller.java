...
/**
 * MetricDefinition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MetricDefinitionJsonUnmarshaller implements Unmarshaller<MetricDefinition, JsonUnmarshallerContext> {

    public MetricDefinition unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static MetricDefinitionJsonUnmarshaller instance;

    public static MetricDefinitionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MetricDefinitionJsonUnmarshaller();
        return instance;
    }
}
