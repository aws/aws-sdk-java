...
/**
 * MetricDefinitionRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MetricDefinitionRequestJsonUnmarshaller implements Unmarshaller<MetricDefinitionRequest, JsonUnmarshallerContext> {

    public MetricDefinitionRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
        MetricDefinitionRequest metricDefinitionRequest = new MetricDefinitionRequest();
    ...
    private static MetricDefinitionRequestJsonUnmarshaller instance;

    public static MetricDefinitionRequestJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MetricDefinitionRequestJsonUnmarshaller();
        return instance;
    }
}
