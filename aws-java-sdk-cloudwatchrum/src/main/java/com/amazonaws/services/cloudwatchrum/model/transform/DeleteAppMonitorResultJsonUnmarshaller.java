...
/**
 * DeleteAppMonitorResult JSON Unmarshaller
 */
...
public class DeleteAppMonitorResultJsonUnmarshaller implements Unmarshaller<DeleteAppMonitorResult, JsonUnmarshallerContext> {
    ...
    public DeleteAppMonitorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAppMonitorResult deleteAppMonitorResult = new DeleteAppMonitorResult();
