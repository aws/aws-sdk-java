...
public class RumEventMarshaller {
    ...
    private static final MarshallingInfo<String> METADATA_BINDING = MarshallingInfo.builder(MarshallingType.JSON_VALUE)
    ...
    public void marshall(RumEvent rumEvent, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(rumEvent.getDetails(), DETAILS_BINDING);
            protocolMarshaller.marshall(rumEvent.getId(), ID_BINDING);
            protocolMarshaller.marshall(rumEvent.getMetadata(), METADATA_BINDING);
            protocolMarshaller.marshall(rumEvent.getTimestamp(), TIMESTAMP_BINDING);
            protocolMarshaller.marshall(rumEvent.getType(), TYPE_BINDING);
        } catch (Exception e) {
