 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotevents-data-2018-10-23/ResetAlarmActionRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResetAlarmActionRequest implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The note that you can leave when you reset the alarm.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResetAlarmActionRequest == false)
            return false;
        ResetAlarmActionRequest other = (ResetAlarmActionRequest) obj;
    ...
    @Override
    public ResetAlarmActionRequest clone() {
        try {
            return (ResetAlarmActionRequest) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.ioteventsdata.model.transform.ResetAlarmActionRequestMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
