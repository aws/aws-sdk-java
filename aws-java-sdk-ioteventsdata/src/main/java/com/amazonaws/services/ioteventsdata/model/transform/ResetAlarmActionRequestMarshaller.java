...
/**
 * ResetAlarmActionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ResetAlarmActionRequestMarshaller {
    ...
    private static final ResetAlarmActionRequestMarshaller instance = new ResetAlarmActionRequestMarshaller();

    public static ResetAlarmActionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ResetAlarmActionRequest resetAlarmActionRequest, ProtocolMarshaller protocolMarshaller) {

        if (resetAlarmActionRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(resetAlarmActionRequest.getRequestId(), REQUESTID_BINDING);
            protocolMarshaller.marshall(resetAlarmActionRequest.getAlarmModelName(), ALARMMODELNAME_BINDING);
            protocolMarshaller.marshall(resetAlarmActionRequest.getKeyValue(), KEYVALUE_BINDING);
            protocolMarshaller.marshall(resetAlarmActionRequest.getNote(), NOTE_BINDING);
        } catch (Exception e) {
