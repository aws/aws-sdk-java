...
/**
 * DescribeDetectorResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeDetectorResultJsonUnmarshaller implements Unmarshaller<DescribeDetectorResult, JsonUnmarshallerContext> {
    ...
    public DescribeDetectorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("detector", targetDepth)) {
                    context.nextToken();
                    describeDetectorResult.setDetector(DetectorJsonUnmarshaller.getInstance().unmarshall(context));
                }
