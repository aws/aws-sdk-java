...
/**
 * PredictedActionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PredictedActionMarshaller {
    ...
    private static final PredictedActionMarshaller instance = new PredictedActionMarshaller();

    public static PredictedActionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PredictedAction predictedAction, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(predictedAction.getActionId(), ACTIONID_BINDING);
            protocolMarshaller.marshall(predictedAction.getScore(), SCORE_BINDING);
        } catch (Exception e) {
