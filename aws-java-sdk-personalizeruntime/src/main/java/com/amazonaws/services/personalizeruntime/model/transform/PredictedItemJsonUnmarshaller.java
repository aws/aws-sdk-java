...
/**
 * PredictedItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PredictedItemJsonUnmarshaller implements Unmarshaller<PredictedItem, JsonUnmarshallerContext> {
    ...
    public static PredictedItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PredictedItemJsonUnmarshaller();
        return instance;
    }
}
