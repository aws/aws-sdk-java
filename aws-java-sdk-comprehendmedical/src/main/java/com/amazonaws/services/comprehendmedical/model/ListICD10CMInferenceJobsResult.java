...
public class ListICD10CMInferenceJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListICD10CMInferenceJobsResult clone() {
        try {
            return (ListICD10CMInferenceJobsResult) super.clone();
