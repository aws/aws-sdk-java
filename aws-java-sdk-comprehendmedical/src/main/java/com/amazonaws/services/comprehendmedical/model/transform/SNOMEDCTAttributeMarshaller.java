...
/**
 * SNOMEDCTAttributeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SNOMEDCTAttributeMarshaller {
    ...
    private static final SNOMEDCTAttributeMarshaller instance = new SNOMEDCTAttributeMarshaller();

    public static SNOMEDCTAttributeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SNOMEDCTAttribute sNOMEDCTAttribute, ProtocolMarshaller protocolMarshaller) {

        if (sNOMEDCTAttribute == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(sNOMEDCTAttribute.getCategory(), CATEGORY_BINDING);
            protocolMarshaller.marshall(sNOMEDCTAttribute.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(sNOMEDCTAttribute.getScore(), SCORE_BINDING);
            protocolMarshaller.marshall(sNOMEDCTAttribute.getRelationshipScore(), RELATIONSHIPSCORE_BINDING);
            protocolMarshaller.marshall(sNOMEDCTAttribute.getRelationshipType(), RELATIONSHIPTYPE_BINDING);
            protocolMarshaller.marshall(sNOMEDCTAttribute.getId(), ID_BINDING);
            protocolMarshaller.marshall(sNOMEDCTAttribute.getBeginOffset(), BEGINOFFSET_BINDING);
            protocolMarshaller.marshall(sNOMEDCTAttribute.getEndOffset(), ENDOFFSET_BINDING);
            protocolMarshaller.marshall(sNOMEDCTAttribute.getText(), TEXT_BINDING);
            protocolMarshaller.marshall(sNOMEDCTAttribute.getTraits(), TRAITS_BINDING);
            protocolMarshaller.marshall(sNOMEDCTAttribute.getSNOMEDCTConcepts(), SNOMEDCTCONCEPTS_BINDING);
        } catch (Exception e) {
