...
public class ListEntitiesDetectionV2JobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListEntitiesDetectionV2JobsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEntitiesDetectionV2JobsRequest == false)
            return false;
        ListEntitiesDetectionV2JobsRequest other = (ListEntitiesDetectionV2JobsRequest) obj;
    ...
    @Override
    public ListEntitiesDetectionV2JobsRequest clone() {
        return (ListEntitiesDetectionV2JobsRequest) super.clone();
    }
