...
public class ListPHIDetectionJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListPHIDetectionJobsResult withComprehendMedicalAsyncJobPropertiesList(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPHIDetectionJobsResult == false)
            return false;
        ListPHIDetectionJobsResult other = (ListPHIDetectionJobsResult) obj;
    ...
    public ListPHIDetectionJobsResult clone() {
        try {
            return (ListPHIDetectionJobsResult) super.clone();
