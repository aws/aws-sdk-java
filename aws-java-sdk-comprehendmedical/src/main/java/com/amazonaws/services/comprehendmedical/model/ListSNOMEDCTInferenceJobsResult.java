...
public class ListSNOMEDCTInferenceJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListSNOMEDCTInferenceJobsResult withComprehendMedicalAsyncJobPropertiesList(
    ...
    public ListSNOMEDCTInferenceJobsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSNOMEDCTInferenceJobsResult == false)
            return false;
        ListSNOMEDCTInferenceJobsResult other = (ListSNOMEDCTInferenceJobsResult) obj;
    ...
    @Override
    public ListSNOMEDCTInferenceJobsResult clone() {
        try {
            return (ListSNOMEDCTInferenceJobsResult) super.clone();
