...
public class ListPHIDetectionJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * Filters the jobs that are returned. You can filter jobs based on their names, status, or the date and time that
     ...
     * </p>
     * 
     * @return Filters the jobs that are returned. You can filter jobs based on their names, status, or the date and
    ...
    public ListPHIDetectionJobsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPHIDetectionJobsRequest == false)
            return false;
        ListPHIDetectionJobsRequest other = (ListPHIDetectionJobsRequest) obj;
    ...
    @Override
    public ListPHIDetectionJobsRequest clone() {
        return (ListPHIDetectionJobsRequest) super.clone();
    }
