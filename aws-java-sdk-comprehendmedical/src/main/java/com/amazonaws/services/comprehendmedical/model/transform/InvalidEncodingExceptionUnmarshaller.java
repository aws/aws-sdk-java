...
public class InvalidEncodingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidEncodingExceptionUnmarshaller instance;

    public static InvalidEncodingExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidEncodingExceptionUnmarshaller();
        return instance;
    }
}
