...
public class DescribeICD10CMInferenceJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeICD10CMInferenceJobResult withComprehendMedicalAsyncJobProperties(ComprehendMedicalAsyncJobProperties comprehendMedicalAsyncJobProperties) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeICD10CMInferenceJobResult == false)
            return false;
        DescribeICD10CMInferenceJobResult other = (DescribeICD10CMInferenceJobResult) obj;
    ...
    @Override
    public DescribeICD10CMInferenceJobResult clone() {
        try {
            return (DescribeICD10CMInferenceJobResult) super.clone();
