        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("permission", targetDepth)) {
                    context.nextToken();
                    createPermissionResult.setPermission(ResourceSharePermissionSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("clientToken", targetDepth)) {
                    context.nextToken();
                    createPermissionResult.setClientToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
