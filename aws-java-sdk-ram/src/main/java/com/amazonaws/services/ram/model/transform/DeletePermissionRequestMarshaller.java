...
public class DeletePermissionRequestMarshaller {
    ...
    private static final MarshallingInfo<String> PERMISSIONARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("permissionArn").build();
    ...
    public void marshall(DeletePermissionRequest deletePermissionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deletePermissionRequest.getPermissionArn(), PERMISSIONARN_BINDING);
            protocolMarshaller.marshall(deletePermissionRequest.getClientToken(), CLIENTTOKEN_BINDING);
        } catch (Exception e) {
