...
public class EnableSharingWithAwsOrganizationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableSharingWithAwsOrganizationResult == false)
            return false;
        EnableSharingWithAwsOrganizationResult other = (EnableSharingWithAwsOrganizationResult) obj;
    ...
    public EnableSharingWithAwsOrganizationResult clone() {
        try {
            return (EnableSharingWithAwsOrganizationResult) super.clone();
