...
public class ResourceShareInvitationExpiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceShareInvitationExpiredExceptionUnmarshaller instance;

    public static ResourceShareInvitationExpiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceShareInvitationExpiredExceptionUnmarshaller();
        return instance;
    }
}
