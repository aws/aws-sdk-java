...
public class IdempotentParameterMismatchExceptionUnmarshaller extends
        JsonErrorUnmarshaller<com.amazonaws.services.ram.model.IdempotentParameterMismatchException> {
    private IdempotentParameterMismatchExceptionUnmarshaller() {
        super("IdempotentParameterMismatchException");
    }

    @Override
    public com.amazonaws.services.ram.model.IdempotentParameterMismatchException unmarshall(JsonUnmarshallerContext context) throws Exception {
