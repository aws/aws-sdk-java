...
public class ResourceArnNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceArnNotFoundExceptionUnmarshaller instance;

    public static ResourceArnNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceArnNotFoundExceptionUnmarshaller();
        return instance;
    }
}
