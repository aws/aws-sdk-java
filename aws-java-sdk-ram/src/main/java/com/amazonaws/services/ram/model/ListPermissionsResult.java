...
public class ListPermissionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListPermissionsResult withPermissions(ResourceSharePermissionSummary... permissions) {
    ...
    public ListPermissionsResult withPermissions(java.util.Collection<ResourceSharePermissionSummary> permissions) {
