...
public class PromotePermissionCreatedFromPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public PromotePermissionCreatedFromPolicyResult withClientToken(String clientToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PromotePermissionCreatedFromPolicyResult == false)
            return false;
        PromotePermissionCreatedFromPolicyResult other = (PromotePermissionCreatedFromPolicyResult) obj;
    ...
    public PromotePermissionCreatedFromPolicyResult clone() {
        try {
            return (PromotePermissionCreatedFromPolicyResult) super.clone();
