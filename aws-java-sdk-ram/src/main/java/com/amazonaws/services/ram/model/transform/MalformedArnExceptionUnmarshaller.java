...
public class MalformedArnExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MalformedArnExceptionUnmarshaller instance;

    public static MalformedArnExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MalformedArnExceptionUnmarshaller();
        return instance;
    }
}
