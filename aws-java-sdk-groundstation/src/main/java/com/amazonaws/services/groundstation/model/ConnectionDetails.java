 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/groundstation-2019-05-23/ConnectionDetails" target="_top">AWS
 *      API Documentation</a>
 */
...
public class ConnectionDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getMtu() != null && other.getMtu().equals(this.getMtu()) == false)
            return false;
        if (other.getSocketAddress() == null ^ this.getSocketAddress() == null)
            return false;
        if (other.getSocketAddress() != null && other.getSocketAddress().equals(this.getSocketAddress()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSocketAddress() == null) ? 0 : getSocketAddress().hashCode());
        return hashCode;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.groundstation.model.transform.ConnectionDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
