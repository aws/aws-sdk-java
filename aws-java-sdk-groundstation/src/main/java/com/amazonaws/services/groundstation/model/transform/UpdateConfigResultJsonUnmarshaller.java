...
/**
 * UpdateConfigResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateConfigResultJsonUnmarshaller implements Unmarshaller<UpdateConfigResult, JsonUnmarshallerContext> {

    public UpdateConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static UpdateConfigResultJsonUnmarshaller instance;

    public static UpdateConfigResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateConfigResultJsonUnmarshaller();
        return instance;
    }
}
