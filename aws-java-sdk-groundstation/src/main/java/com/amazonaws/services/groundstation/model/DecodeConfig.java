 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/groundstation-2019-05-23/DecodeConfig" target="_top">AWS API
 *      Documentation</a>
 */
...
public class DecodeConfig implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Unvalidated JSON of a decode <code>Config</code>.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DecodeConfig == false)
            return false;
        DecodeConfig other = (DecodeConfig) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.groundstation.model.transform.DecodeConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
