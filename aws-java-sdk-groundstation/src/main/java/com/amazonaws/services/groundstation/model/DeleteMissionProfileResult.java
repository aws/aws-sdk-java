 ...
 * <p/>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/groundstation-2019-05-23/DeleteMissionProfile" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteMissionProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteMissionProfileResult withMissionProfileId(String missionProfileId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteMissionProfileResult == false)
            return false;
        DeleteMissionProfileResult other = (DeleteMissionProfileResult) obj;
    ...
    @Override
    public DeleteMissionProfileResult clone() {
        try {
            return (DeleteMissionProfileResult) super.clone();
