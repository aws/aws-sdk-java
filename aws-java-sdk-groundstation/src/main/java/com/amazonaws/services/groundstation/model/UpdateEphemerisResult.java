...
public class UpdateEphemerisResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateEphemerisResult == false)
            return false;
        UpdateEphemerisResult other = (UpdateEphemerisResult) obj;
    ...
    @Override
    public UpdateEphemerisResult clone() {
        try {
            return (UpdateEphemerisResult) super.clone();
