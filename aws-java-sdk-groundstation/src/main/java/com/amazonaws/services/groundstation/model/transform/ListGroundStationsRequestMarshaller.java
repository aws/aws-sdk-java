...
@SdkInternalApi
public class ListGroundStationsRequestMarshaller {
    ...
    public static ListGroundStationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListGroundStationsRequest listGroundStationsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listGroundStationsRequest == null) {
