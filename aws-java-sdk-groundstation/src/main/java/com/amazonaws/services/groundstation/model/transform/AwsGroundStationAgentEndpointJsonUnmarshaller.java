...
/**
 * AwsGroundStationAgentEndpoint JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsGroundStationAgentEndpointJsonUnmarshaller implements Unmarshaller<AwsGroundStationAgentEndpoint, JsonUnmarshallerContext> {

    public AwsGroundStationAgentEndpoint unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsGroundStationAgentEndpoint awsGroundStationAgentEndpoint = new AwsGroundStationAgentEndpoint();
    ...
    private static AwsGroundStationAgentEndpointJsonUnmarshaller instance;

    public static AwsGroundStationAgentEndpointJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsGroundStationAgentEndpointJsonUnmarshaller();
        return instance;
    }
}
