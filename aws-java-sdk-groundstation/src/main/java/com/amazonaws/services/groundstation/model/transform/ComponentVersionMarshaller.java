...
public class ComponentVersionMarshaller {
    ...
    public void marshall(ComponentVersion componentVersion, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(componentVersion.getComponentType(), COMPONENTTYPE_BINDING);
            protocolMarshaller.marshall(componentVersion.getVersions(), VERSIONS_BINDING);
        } catch (Exception e) {
