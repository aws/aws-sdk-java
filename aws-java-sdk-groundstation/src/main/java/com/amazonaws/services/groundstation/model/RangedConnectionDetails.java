 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/groundstation-2019-05-23/RangedConnectionDetails"
...
public class RangedConnectionDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setSocketAddress(RangedSocketAddress socketAddress) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RangedConnectionDetails == false)
            return false;
    ...
    @Override
    public RangedConnectionDetails clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.groundstation.model.transform.RangedConnectionDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
