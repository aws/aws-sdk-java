...
public class ConnectionDetailsMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> SOCKETADDRESS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("socketAddress").build();
    ...
    public void marshall(ConnectionDetails connectionDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(connectionDetails.getMtu(), MTU_BINDING);
            protocolMarshaller.marshall(connectionDetails.getSocketAddress(), SOCKETADDRESS_BINDING);
        } catch (Exception e) {
