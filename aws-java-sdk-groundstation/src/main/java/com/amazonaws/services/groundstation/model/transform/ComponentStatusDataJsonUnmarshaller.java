...
/**
 * ComponentStatusData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ComponentStatusDataJsonUnmarshaller implements Unmarshaller<ComponentStatusData, JsonUnmarshallerContext> {

    public ComponentStatusData unmarshall(JsonUnmarshallerContext context) throws Exception {
        ComponentStatusData componentStatusData = new ComponentStatusData();
    ...
    private static ComponentStatusDataJsonUnmarshaller instance;

    public static ComponentStatusDataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ComponentStatusDataJsonUnmarshaller();
        return instance;
    }
}
