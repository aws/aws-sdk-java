...
public class S3RecordingDetailsMarshaller {
    ...
    private static final MarshallingInfo<String> KEYTEMPLATE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("keyTemplate").build();
