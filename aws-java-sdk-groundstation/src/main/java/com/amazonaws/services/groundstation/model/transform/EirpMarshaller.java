...
public class EirpMarshaller {
    ...
    private static final EirpMarshaller instance = new EirpMarshaller();

    public static EirpMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Eirp eirp, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(eirp.getUnits(), UNITS_BINDING);
            protocolMarshaller.marshall(eirp.getValue(), VALUE_BINDING);
        } catch (Exception e) {
