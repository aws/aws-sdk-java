...
public class ProvisionedThroughputExceededExceptionUnmarshaller extends
        JsonErrorUnmarshaller<com.amazonaws.services.textract.model.ProvisionedThroughputExceededException> {
    private ProvisionedThroughputExceededExceptionUnmarshaller() {
        super("ProvisionedThroughputExceededException");
    }

    @Override
    public com.amazonaws.services.textract.model.ProvisionedThroughputExceededException unmarshall(JsonUnmarshallerContext context) throws Exception {
