...
public class ExpenseCurrencyMarshaller {
    ...
    public void marshall(ExpenseCurrency expenseCurrency, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(expenseCurrency.getCode(), CODE_BINDING);
            protocolMarshaller.marshall(expenseCurrency.getConfidence(), CONFIDENCE_BINDING);
        } catch (Exception e) {
