...
public class IdempotentParameterMismatchExceptionUnmarshaller extends
        JsonErrorUnmarshaller<com.amazonaws.services.textract.model.IdempotentParameterMismatchException> {
    private IdempotentParameterMismatchExceptionUnmarshaller() {
        super("IdempotentParameterMismatchException");
    }

    @Override
    public com.amazonaws.services.textract.model.IdempotentParameterMismatchException unmarshall(JsonUnmarshallerContext context) throws Exception {
