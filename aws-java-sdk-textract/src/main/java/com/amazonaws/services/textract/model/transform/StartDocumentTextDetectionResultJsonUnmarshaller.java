...
/**
 * StartDocumentTextDetectionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartDocumentTextDetectionResultJsonUnmarshaller implements Unmarshaller<StartDocumentTextDetectionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobId", targetDepth)) {
                    context.nextToken();
                    startDocumentTextDetectionResult.setJobId(context.getUnmarshaller(String.class).unmarshall(context));
                }
