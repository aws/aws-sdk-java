...
public class NotificationChannelMarshaller {
    ...
    public void marshall(NotificationChannel notificationChannel, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(notificationChannel.getSNSTopicArn(), SNSTOPICARN_BINDING);
            protocolMarshaller.marshall(notificationChannel.getRoleArn(), ROLEARN_BINDING);
        } catch (Exception e) {
