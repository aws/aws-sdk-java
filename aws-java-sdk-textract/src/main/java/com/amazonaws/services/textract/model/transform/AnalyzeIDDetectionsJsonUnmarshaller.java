...
/**
 * AnalyzeIDDetections JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AnalyzeIDDetectionsJsonUnmarshaller implements Unmarshaller<AnalyzeIDDetections, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Text", targetDepth)) {
                    context.nextToken();
                    analyzeIDDetections.setText(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("NormalizedValue", targetDepth)) {
                    context.nextToken();
                    analyzeIDDetections.setNormalizedValue(NormalizedValueJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Confidence", targetDepth)) {
                    context.nextToken();
                    analyzeIDDetections.setConfidence(context.getUnmarshaller(Float.class).unmarshall(context));
                }
