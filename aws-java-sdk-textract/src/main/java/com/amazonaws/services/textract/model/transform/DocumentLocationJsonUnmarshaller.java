...
/**
 * DocumentLocation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DocumentLocationJsonUnmarshaller implements Unmarshaller<DocumentLocation, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("S3Object", targetDepth)) {
                    context.nextToken();
                    documentLocation.setS3Object(S3ObjectJsonUnmarshaller.getInstance().unmarshall(context));
                }
