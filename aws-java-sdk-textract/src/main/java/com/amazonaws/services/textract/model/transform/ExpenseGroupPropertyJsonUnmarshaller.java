...
/**
 * ExpenseGroupProperty JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExpenseGroupPropertyJsonUnmarshaller implements Unmarshaller<ExpenseGroupProperty, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Types", targetDepth)) {
                    context.nextToken();
                    expenseGroupProperty.setTypes(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("Id", targetDepth)) {
                    context.nextToken();
                    expenseGroupProperty.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
