...
@SdkInternalApi
public class GetDocumentTextDetectionRequestMarshaller {
    ...
    private static final GetDocumentTextDetectionRequestMarshaller instance = new GetDocumentTextDetectionRequestMarshaller();

    public static GetDocumentTextDetectionRequestMarshaller getInstance() {
        return instance;
    }
