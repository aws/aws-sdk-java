...
public class BadDocumentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static BadDocumentExceptionUnmarshaller instance;

    public static BadDocumentExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BadDocumentExceptionUnmarshaller();
        return instance;
    }
}
