...
/**
 * Fluent builder for {@link com.amazonaws.services.sns.AmazonSNSAsync}. Use of
 * the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonSNSAsyncClientBuilder extends
        AwsAsyncClientBuilder<AmazonSNSAsyncClientBuilder, AmazonSNSAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonSNSAsync using the
