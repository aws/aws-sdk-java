 ...
 */
public class ListSubscriptionsByTopicResultStaxUnmarshaller implements
        Unmarshaller<ListSubscriptionsByTopicResult, StaxUnmarshallerContext> {

    public ListSubscriptionsByTopicResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Subscriptions/member", targetDepth)) {
                    listSubscriptionsByTopicResult.getSubscriptions().add(
