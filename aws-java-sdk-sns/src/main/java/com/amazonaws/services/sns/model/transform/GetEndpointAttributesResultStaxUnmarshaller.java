 ...
 */
public class GetEndpointAttributesResultStaxUnmarshaller implements
        Unmarshaller<GetEndpointAttributesResult, StaxUnmarshallerContext> {
    ...
    public GetEndpointAttributesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Attributes/entry", targetDepth)) {
                    ...
                    getEndpointAttributesResult.getAttributes().put(
