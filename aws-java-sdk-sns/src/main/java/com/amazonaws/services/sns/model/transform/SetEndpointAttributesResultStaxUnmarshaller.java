 ...
 */
public class SetEndpointAttributesResultStaxUnmarshaller implements
        Unmarshaller<SetEndpointAttributesResult, StaxUnmarshallerContext> {

    public SetEndpointAttributesResult unmarshall(
