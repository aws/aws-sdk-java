 ...
 */
public class SetTopicAttributesResultStaxUnmarshaller implements
        Unmarshaller<SetTopicAttributesResult, StaxUnmarshallerContext> {

    public SetTopicAttributesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
