 ...
 */
public class CheckIfPhoneNumberIsOptedOutResultStaxUnmarshaller
        implements
        Unmarshaller<CheckIfPhoneNumberIsOptedOutResult, StaxUnmarshallerContext> {

    public CheckIfPhoneNumberIsOptedOutResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("isOptedOut", targetDepth)) {
                    checkIfPhoneNumberIsOptedOutResult
                            .setIsOptedOut(BooleanStaxUnmarshaller
