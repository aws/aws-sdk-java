 ...
 */
public class OptInPhoneNumberResultStaxUnmarshaller implements
        Unmarshaller<OptInPhoneNumberResult, StaxUnmarshallerContext> {

    public OptInPhoneNumberResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
