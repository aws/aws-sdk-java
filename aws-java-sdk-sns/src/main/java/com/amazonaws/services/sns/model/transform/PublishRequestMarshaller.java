    ...
    public Request<PublishRequest> marshall(PublishRequest publishRequest) {
        ...
        if (publishRequest.getTopicArn() != null) {
            request.addParameter("TopicArn",
                    StringUtils.fromString(publishRequest.getTopicArn()));
        }

        if (publishRequest.getTargetArn() != null) {
            request.addParameter("TargetArn",
        ...
        if (publishRequest.getSubject() != null) {
            request.addParameter("Subject",
                    StringUtils.fromString(publishRequest.getSubject()));
        }

        if (publishRequest.getMessageStructure() != null) {
            request.addParameter("MessageStructure", StringUtils
                    .fromString(publishRequest.getMessageStructure()));
        }
        ...
        for (Map.Entry<String, MessageAttributeValue> entry : messageAttributes
            ...
            if (entry.getKey() != null) {
                request.addParameter("MessageAttributes.entry."
