 ...
 */
public class ListPhoneNumbersOptedOutResultStaxUnmarshaller implements
        Unmarshaller<ListPhoneNumbersOptedOutResult, StaxUnmarshallerContext> {

    public ListPhoneNumbersOptedOutResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("phoneNumbers/member", targetDepth)) {
                    listPhoneNumbersOptedOutResult
                            .withPhoneNumbers(StringStaxUnmarshaller
