...
/**
 * SetSMSAttributesResult StAX Unmarshaller
 */
public class SetSMSAttributesResultStaxUnmarshaller implements
        Unmarshaller<SetSMSAttributesResult, StaxUnmarshallerContext> {

    public SetSMSAttributesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
