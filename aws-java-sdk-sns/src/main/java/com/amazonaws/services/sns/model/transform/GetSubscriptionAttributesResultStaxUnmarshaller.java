 ...
 */
public class GetSubscriptionAttributesResultStaxUnmarshaller implements
        Unmarshaller<GetSubscriptionAttributesResult, StaxUnmarshallerContext> {
    ...
    public GetSubscriptionAttributesResult unmarshall(
