 ...
 */
public class CreatePlatformEndpointResultStaxUnmarshaller implements
        Unmarshaller<CreatePlatformEndpointResult, StaxUnmarshallerContext> {

    public CreatePlatformEndpointResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("EndpointArn", targetDepth)) {
                    createPlatformEndpointResult
                            .setEndpointArn(StringStaxUnmarshaller
