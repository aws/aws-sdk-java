 ...
 */
public class ListSubscriptionsResultStaxUnmarshaller implements
        Unmarshaller<ListSubscriptionsResult, StaxUnmarshallerContext> {

    public ListSubscriptionsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Subscriptions/member", targetDepth)) {
                    listSubscriptionsResult
                            .withSubscriptions(SubscriptionStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("NextToken", targetDepth)) {
                    listSubscriptionsResult.setNextToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
