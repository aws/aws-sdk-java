...
/**
 * Fluent builder for {@link com.amazonaws.services.sns.AmazonSNS}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonSNSClientBuilder extends
        AwsSyncClientBuilder<AmazonSNSClientBuilder, AmazonSNS> {
    ...
    /**
     * Construct a synchronous implementation of AmazonSNS using the current
