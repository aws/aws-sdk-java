 ...
 */
public class UnsubscribeResultStaxUnmarshaller implements
        Unmarshaller<UnsubscribeResult, StaxUnmarshallerContext> {

    public UnsubscribeResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
