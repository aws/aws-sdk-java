...
public class Topics {
     ...
     *         successfully subscribed to the topic.
     */
    public static String subscribeQueue(AmazonSNS sns, AmazonSQS sqs, String snsTopicArn, String sqsQueueUrl, boolean extendPolicy)
                throws AmazonClientException, AmazonServiceException {
        ...
        Policy policy = extendPolicy ? Policy.fromJson(sqsAttrs.get(QueueAttributeName.Policy.toString())) : new Policy();
