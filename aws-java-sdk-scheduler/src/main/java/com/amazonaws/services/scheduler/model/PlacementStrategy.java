 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/scheduler-2021-06-30/PlacementStrategy" target="_top">AWS API
 *      Documentation</a>
 */
...
public class PlacementStrategy implements Serializable, Cloneable, StructuredPojo {
     ...
     * <code>instanceId</code> (or <code>instanceId</code>, which has the same effect), or any platform or custom
     * attribute that is applied to a container instance, such as <code>attribute:ecs.availability-zone</code>. For the
     * binpack placement strategy, valid values are <code>cpu</code> and <code>memory</code>. For the random placement
     ...
     *        The field to apply the placement strategy against. For the spread placement strategy, valid values are
     *        <code>instanceId</code> (or <code>instanceId</code>, which has the same effect), or any platform or custom
     *        attribute that is applied to a container instance, such as <code>attribute:ecs.availability-zone</code>.
     *        For the binpack placement strategy, valid values are <code>cpu</code> and <code>memory</code>. For the
     ...
     *         <code>instanceId</code> (or <code>instanceId</code>, which has the same effect), or any platform or
     *         custom attribute that is applied to a container instance, such as
     *         <code>attribute:ecs.availability-zone</code>. For the binpack placement strategy, valid values are
     *         <code>cpu</code> and <code>memory</code>. For the random placement strategy, this field is not used.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.scheduler.model.transform.PlacementStrategyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
