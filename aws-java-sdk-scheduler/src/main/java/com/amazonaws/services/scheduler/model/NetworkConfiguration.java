 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/scheduler-2021-06-30/NetworkConfiguration" target="_top">AWS API
 *      Documentation</a>
 */
...
public class NetworkConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     *        Specifies the Amazon VPC subnets and security groups for the task, and whether a public IP address is to
     *        be used. This structure is relevant only for ECS tasks that use the awsvpc network mode.
     */
     ...
     * </p>
     * 
     * @return Specifies the Amazon VPC subnets and security groups for the task, and whether a public IP address is to
     *         be used. This structure is relevant only for ECS tasks that use the awsvpc network mode.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.scheduler.model.transform.NetworkConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
