...
/**
 * CapacityProviderStrategyItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CapacityProviderStrategyItemJsonUnmarshaller implements Unmarshaller<CapacityProviderStrategyItem, JsonUnmarshallerContext> {

    public CapacityProviderStrategyItem unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static CapacityProviderStrategyItemJsonUnmarshaller instance;

    public static CapacityProviderStrategyItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CapacityProviderStrategyItemJsonUnmarshaller();
        return instance;
    }
}
