...
/**
 * MSKAccessCredentialsMarshaller
 */
...
public class MSKAccessCredentialsMarshaller {
    ...
    public static MSKAccessCredentialsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MSKAccessCredentials mSKAccessCredentials, ProtocolMarshaller protocolMarshaller) {

        if (mSKAccessCredentials == null) {
