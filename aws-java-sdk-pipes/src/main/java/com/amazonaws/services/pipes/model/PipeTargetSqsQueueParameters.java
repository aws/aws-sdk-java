 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/PipeTargetSqsQueueParameters" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PipeTargetSqsQueueParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public PipeTargetSqsQueueParameters clone() {
        try {
            return (PipeTargetSqsQueueParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.PipeTargetSqsQueueParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
