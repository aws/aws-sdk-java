 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/BatchRetryStrategy" target="_top">AWS API
 *      Documentation</a>
 */
...
public class BatchRetryStrategy implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The number of times to move a job to the <code>RUNNABLE</code> status. If the value of <code>attempts</code> is
     ...
     * 
     * @param attempts
     *        The number of times to move a job to the <code>RUNNABLE</code> status. If the value of
     *        <code>attempts</code> is greater than one, the job is retried on failure the same number of attempts as
     *        the value.
     */
     ...
     * </p>
     * 
     * @return The number of times to move a job to the <code>RUNNABLE</code> status. If the value of
     *         <code>attempts</code> is greater than one, the job is retried on failure the same number of attempts as
     *         the value.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.BatchRetryStrategyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
