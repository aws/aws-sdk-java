 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/PipeSourceSqsQueueParameters" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PipeSourceSqsQueueParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public PipeSourceSqsQueueParameters withBatchSize(Integer batchSize) {
    ...
    public PipeSourceSqsQueueParameters withMaximumBatchingWindowInSeconds(Integer maximumBatchingWindowInSeconds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PipeSourceSqsQueueParameters == false)
            return false;
    ...
    @Override
    public PipeSourceSqsQueueParameters clone() {
        try {
            return (PipeSourceSqsQueueParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.PipeSourceSqsQueueParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
