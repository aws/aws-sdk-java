 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/PipeTargetSageMakerPipelineParameters"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PipeTargetSageMakerPipelineParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public PipeTargetSageMakerPipelineParameters withPipelineParameterList(java.util.Collection<SageMakerPipelineParameter> pipelineParameterList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PipeTargetSageMakerPipelineParameters == false)
            return false;
        PipeTargetSageMakerPipelineParameters other = (PipeTargetSageMakerPipelineParameters) obj;
    ...
    @Override
    public PipeTargetSageMakerPipelineParameters clone() {
        try {
            return (PipeTargetSageMakerPipelineParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.PipeTargetSageMakerPipelineParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
