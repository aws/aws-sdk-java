...
public class CreatePipeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreatePipeResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreatePipeResult withCreationTime(java.util.Date creationTime) {
    ...
    public CreatePipeResult withCurrentState(String currentState) {
    ...
    public CreatePipeResult withCurrentState(PipeState currentState) {
    ...
    public CreatePipeResult withDesiredState(String desiredState) {
    ...
    public CreatePipeResult withDesiredState(RequestedPipeState desiredState) {
    ...
    public CreatePipeResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public CreatePipeResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePipeResult == false)
            return false;
        CreatePipeResult other = (CreatePipeResult) obj;
    ...
    @Override
    public CreatePipeResult clone() {
        try {
            return (CreatePipeResult) super.clone();
