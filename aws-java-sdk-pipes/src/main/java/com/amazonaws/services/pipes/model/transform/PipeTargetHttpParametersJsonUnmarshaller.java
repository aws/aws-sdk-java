...
/**
 * PipeTargetHttpParameters JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PipeTargetHttpParametersJsonUnmarshaller implements Unmarshaller<PipeTargetHttpParameters, JsonUnmarshallerContext> {

    public PipeTargetHttpParameters unmarshall(JsonUnmarshallerContext context) throws Exception {
        PipeTargetHttpParameters pipeTargetHttpParameters = new PipeTargetHttpParameters();
    ...
    private static PipeTargetHttpParametersJsonUnmarshaller instance;

    public static PipeTargetHttpParametersJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PipeTargetHttpParametersJsonUnmarshaller();
        return instance;
    }
}
