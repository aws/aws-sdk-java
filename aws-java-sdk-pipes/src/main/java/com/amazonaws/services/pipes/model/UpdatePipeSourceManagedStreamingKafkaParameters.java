 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/UpdatePipeSourceManagedStreamingKafkaParameters"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdatePipeSourceManagedStreamingKafkaParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePipeSourceManagedStreamingKafkaParameters == false)
            return false;
    ...
    public UpdatePipeSourceManagedStreamingKafkaParameters clone() {
        try {
            return (UpdatePipeSourceManagedStreamingKafkaParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.UpdatePipeSourceManagedStreamingKafkaParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
