...
/**
 * UpdatePipeSourceRabbitMQBrokerParametersMarshaller
 */
...
public class UpdatePipeSourceRabbitMQBrokerParametersMarshaller {
    ...
    private static final UpdatePipeSourceRabbitMQBrokerParametersMarshaller instance = new UpdatePipeSourceRabbitMQBrokerParametersMarshaller();

    public static UpdatePipeSourceRabbitMQBrokerParametersMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdatePipeSourceRabbitMQBrokerParameters updatePipeSourceRabbitMQBrokerParameters, ProtocolMarshaller protocolMarshaller) {

        if (updatePipeSourceRabbitMQBrokerParameters == null) {
