...
/**
 * UpdatePipeSourceKinesisStreamParametersMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdatePipeSourceKinesisStreamParametersMarshaller {
    ...
    private static final UpdatePipeSourceKinesisStreamParametersMarshaller instance = new UpdatePipeSourceKinesisStreamParametersMarshaller();

    public static UpdatePipeSourceKinesisStreamParametersMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdatePipeSourceKinesisStreamParameters updatePipeSourceKinesisStreamParameters, ProtocolMarshaller protocolMarshaller) {

        if (updatePipeSourceKinesisStreamParameters == null) {
