 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/BatchResourceRequirement" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchResourceRequirement implements Serializable, Cloneable, StructuredPojo {
     ...
     *        The type of resource to assign to a container. The supported resources include <code>GPU</code>,
     *        <code>MEMORY</code>, and <code>VCPU</code>.
     * @see BatchResourceRequirementType
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchResourceRequirement == false)
            return false;
        BatchResourceRequirement other = (BatchResourceRequirement) obj;
    ...
    public BatchResourceRequirement clone() {
        try {
            return (BatchResourceRequirement) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.BatchResourceRequirementMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
