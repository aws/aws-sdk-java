...
public class NetworkConfigurationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> AWSVPCCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("awsvpcConfiguration").build();
    ...
    public void marshall(NetworkConfiguration networkConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(networkConfiguration.getAwsvpcConfiguration(), AWSVPCCONFIGURATION_BINDING);
        } catch (Exception e) {
