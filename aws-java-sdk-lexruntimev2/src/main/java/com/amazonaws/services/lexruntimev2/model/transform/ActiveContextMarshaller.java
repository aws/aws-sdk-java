...
public class ActiveContextMarshaller {
    ...
    private static final MarshallingInfo<Map> CONTEXTATTRIBUTES_BINDING = MarshallingInfo.builder(MarshallingType.MAP)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("contextAttributes").build();
    ...
    public void marshall(ActiveContext activeContext, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(activeContext.getContextAttributes(), CONTEXTATTRIBUTES_BINDING);
        } catch (Exception e) {
