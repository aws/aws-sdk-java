...
public class DeleteSessionRequestMarshaller {
    ...
    public void marshall(DeleteSessionRequest deleteSessionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteSessionRequest.getBotId(), BOTID_BINDING);
            protocolMarshaller.marshall(deleteSessionRequest.getBotAliasId(), BOTALIASID_BINDING);
            protocolMarshaller.marshall(deleteSessionRequest.getLocaleId(), LOCALEID_BINDING);
            protocolMarshaller.marshall(deleteSessionRequest.getSessionId(), SESSIONID_BINDING);
        } catch (Exception e) {
