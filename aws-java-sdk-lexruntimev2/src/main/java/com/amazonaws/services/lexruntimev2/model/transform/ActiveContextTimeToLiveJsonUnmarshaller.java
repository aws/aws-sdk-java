...
/**
 * ActiveContextTimeToLive JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ActiveContextTimeToLiveJsonUnmarshaller implements Unmarshaller<ActiveContextTimeToLive, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("timeToLiveInSeconds", targetDepth)) {
                    context.nextToken();
                    activeContextTimeToLive.setTimeToLiveInSeconds(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("turnsToLive", targetDepth)) {
                    context.nextToken();
                    activeContextTimeToLive.setTurnsToLive(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
