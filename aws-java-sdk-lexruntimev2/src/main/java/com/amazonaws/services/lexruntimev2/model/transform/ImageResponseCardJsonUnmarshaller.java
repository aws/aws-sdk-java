...
/**
 * ImageResponseCard JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImageResponseCardJsonUnmarshaller implements Unmarshaller<ImageResponseCard, JsonUnmarshallerContext> {

    public ImageResponseCard unmarshall(JsonUnmarshallerContext context) throws Exception {
        ImageResponseCard imageResponseCard = new ImageResponseCard();
    ...
    private static ImageResponseCardJsonUnmarshaller instance;

    public static ImageResponseCardJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ImageResponseCardJsonUnmarshaller();
        return instance;
    }
}
