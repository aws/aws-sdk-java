...
/**
 * InputDataConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InputDataConfigJsonUnmarshaller implements Unmarshaller<InputDataConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("S3Uri", targetDepth)) {
                    context.nextToken();
                    inputDataConfig.setS3Uri(context.getUnmarshaller(String.class).unmarshall(context));
                }
