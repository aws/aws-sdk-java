...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.healthlake.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.healthlake.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.healthlake.model.ConflictException conflictException = new com.amazonaws.services.healthlake.model.ConflictException(null);
