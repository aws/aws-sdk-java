...
/**
 * CodeContentDescription JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CodeContentDescriptionJsonUnmarshaller implements Unmarshaller<CodeContentDescription, JsonUnmarshallerContext> {

    public CodeContentDescription unmarshall(JsonUnmarshallerContext context) throws Exception {
        CodeContentDescription codeContentDescription = new CodeContentDescription();
    ...
    private static CodeContentDescriptionJsonUnmarshaller instance;

    public static CodeContentDescriptionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CodeContentDescriptionJsonUnmarshaller();
        return instance;
    }
}
