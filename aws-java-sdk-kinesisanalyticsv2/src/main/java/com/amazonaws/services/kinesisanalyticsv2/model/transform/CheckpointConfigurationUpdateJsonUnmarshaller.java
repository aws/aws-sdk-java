...
/**
 * CheckpointConfigurationUpdate JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CheckpointConfigurationUpdateJsonUnmarshaller implements Unmarshaller<CheckpointConfigurationUpdate, JsonUnmarshallerContext> {

    public CheckpointConfigurationUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        CheckpointConfigurationUpdate checkpointConfigurationUpdate = new CheckpointConfigurationUpdate();
    ...
    private static CheckpointConfigurationUpdateJsonUnmarshaller instance;

    public static CheckpointConfigurationUpdateJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CheckpointConfigurationUpdateJsonUnmarshaller();
        return instance;
    }
}
