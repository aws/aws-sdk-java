...
public class ListApplicationVersionsRequestMarshaller {
    ...
    public void marshall(ListApplicationVersionsRequest listApplicationVersionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listApplicationVersionsRequest.getApplicationName(), APPLICATIONNAME_BINDING);
            protocolMarshaller.marshall(listApplicationVersionsRequest.getLimit(), LIMIT_BINDING);
