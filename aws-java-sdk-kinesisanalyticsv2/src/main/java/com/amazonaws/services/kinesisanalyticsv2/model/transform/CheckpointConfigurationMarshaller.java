...
/**
 * CheckpointConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CheckpointConfigurationMarshaller {
    ...
    private static final CheckpointConfigurationMarshaller instance = new CheckpointConfigurationMarshaller();

    public static CheckpointConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CheckpointConfiguration checkpointConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(checkpointConfiguration.getConfigurationType(), CONFIGURATIONTYPE_BINDING);
            protocolMarshaller.marshall(checkpointConfiguration.getCheckpointingEnabled(), CHECKPOINTINGENABLED_BINDING);
            protocolMarshaller.marshall(checkpointConfiguration.getCheckpointInterval(), CHECKPOINTINTERVAL_BINDING);
            protocolMarshaller.marshall(checkpointConfiguration.getMinPauseBetweenCheckpoints(), MINPAUSEBETWEENCHECKPOINTS_BINDING);
        } catch (Exception e) {
