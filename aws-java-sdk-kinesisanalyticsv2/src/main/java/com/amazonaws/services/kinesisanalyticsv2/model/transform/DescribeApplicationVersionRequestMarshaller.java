...
public class DescribeApplicationVersionRequestMarshaller {
    ...
    private static final DescribeApplicationVersionRequestMarshaller instance = new DescribeApplicationVersionRequestMarshaller();

    public static DescribeApplicationVersionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeApplicationVersionRequest describeApplicationVersionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeApplicationVersionRequest.getApplicationName(), APPLICATIONNAME_BINDING);
            protocolMarshaller.marshall(describeApplicationVersionRequest.getApplicationVersionId(), APPLICATIONVERSIONID_BINDING);
        } catch (Exception e) {
