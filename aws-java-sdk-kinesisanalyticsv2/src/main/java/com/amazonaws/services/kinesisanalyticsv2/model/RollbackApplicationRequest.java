...
public class RollbackApplicationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getCurrentApplicationVersionId() != null)
            sb.append("CurrentApplicationVersionId: ").append(getCurrentApplicationVersionId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RollbackApplicationRequest == false)
            return false;
        RollbackApplicationRequest other = (RollbackApplicationRequest) obj;
    ...
    public RollbackApplicationRequest clone() {
        return (RollbackApplicationRequest) super.clone();
    }
