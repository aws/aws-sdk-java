...
/**
 * FlinkApplicationConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FlinkApplicationConfigurationMarshaller {

    private static final MarshallingInfo<StructuredPojo> CHECKPOINTCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CheckpointConfiguration").build();
    ...
    private static final FlinkApplicationConfigurationMarshaller instance = new FlinkApplicationConfigurationMarshaller();

    public static FlinkApplicationConfigurationMarshaller getInstance() {
        return instance;
    }
