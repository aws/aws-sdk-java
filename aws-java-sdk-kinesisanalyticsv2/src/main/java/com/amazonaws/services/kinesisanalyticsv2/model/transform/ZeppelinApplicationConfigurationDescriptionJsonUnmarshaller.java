...
/**
 * ZeppelinApplicationConfigurationDescription JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ZeppelinApplicationConfigurationDescriptionJsonUnmarshaller implements
        Unmarshaller<ZeppelinApplicationConfigurationDescription, JsonUnmarshallerContext> {

    public ZeppelinApplicationConfigurationDescription unmarshall(JsonUnmarshallerContext context) throws Exception {
        ZeppelinApplicationConfigurationDescription zeppelinApplicationConfigurationDescription = new ZeppelinApplicationConfigurationDescription();
    ...
    private static ZeppelinApplicationConfigurationDescriptionJsonUnmarshaller instance;

    public static ZeppelinApplicationConfigurationDescriptionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ZeppelinApplicationConfigurationDescriptionJsonUnmarshaller();
        return instance;
    }
}
