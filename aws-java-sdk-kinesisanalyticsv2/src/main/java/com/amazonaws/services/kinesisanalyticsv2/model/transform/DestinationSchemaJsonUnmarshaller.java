...
public class DestinationSchemaJsonUnmarshaller implements Unmarshaller<DestinationSchema, JsonUnmarshallerContext> {

    public DestinationSchema unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RecordFormatType", targetDepth)) {
                    context.nextToken();
                    destinationSchema.setRecordFormatType(context.getUnmarshaller(String.class).unmarshall(context));
                }
