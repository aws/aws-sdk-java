...
/**
 * ApplicationRestoreConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ApplicationRestoreConfigurationMarshaller {

    private static final MarshallingInfo<String> APPLICATIONRESTORETYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ApplicationRestoreType").build();
    ...
    private static final ApplicationRestoreConfigurationMarshaller instance = new ApplicationRestoreConfigurationMarshaller();

    public static ApplicationRestoreConfigurationMarshaller getInstance() {
        return instance;
    }
