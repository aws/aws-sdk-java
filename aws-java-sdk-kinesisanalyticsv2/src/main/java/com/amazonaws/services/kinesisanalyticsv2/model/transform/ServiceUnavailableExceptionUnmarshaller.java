...
public class ServiceUnavailableExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.kinesisanalyticsv2.model.ServiceUnavailableException> {
    private ServiceUnavailableExceptionUnmarshaller() {
        super("ServiceUnavailableException");
    }

    @Override
    public com.amazonaws.services.kinesisanalyticsv2.model.ServiceUnavailableException unmarshall(JsonUnmarshallerContext context) throws Exception {
