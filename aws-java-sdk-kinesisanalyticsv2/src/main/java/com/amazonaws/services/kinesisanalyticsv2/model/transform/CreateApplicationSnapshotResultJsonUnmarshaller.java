...
/**
 * CreateApplicationSnapshotResult JSON Unmarshaller
 */
...
public class CreateApplicationSnapshotResultJsonUnmarshaller implements Unmarshaller<CreateApplicationSnapshotResult, JsonUnmarshallerContext> {
    ...
    public CreateApplicationSnapshotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateApplicationSnapshotResult createApplicationSnapshotResult = new CreateApplicationSnapshotResult();

        return createApplicationSnapshotResult;
    }
