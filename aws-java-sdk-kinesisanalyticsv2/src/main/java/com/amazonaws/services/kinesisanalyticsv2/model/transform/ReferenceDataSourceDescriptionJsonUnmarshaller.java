...
/**
 * ReferenceDataSourceDescription JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReferenceDataSourceDescriptionJsonUnmarshaller implements Unmarshaller<ReferenceDataSourceDescription, JsonUnmarshallerContext> {

    public ReferenceDataSourceDescription unmarshall(JsonUnmarshallerContext context) throws Exception {
        ReferenceDataSourceDescription referenceDataSourceDescription = new ReferenceDataSourceDescription();
    ...
    private static ReferenceDataSourceDescriptionJsonUnmarshaller instance;

    public static ReferenceDataSourceDescriptionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReferenceDataSourceDescriptionJsonUnmarshaller();
        return instance;
    }
}
