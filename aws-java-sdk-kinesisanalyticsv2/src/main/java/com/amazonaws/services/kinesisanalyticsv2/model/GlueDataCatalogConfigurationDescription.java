 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/GlueDataCatalogConfigurationDescription"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GlueDataCatalogConfigurationDescription implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GlueDataCatalogConfigurationDescription == false)
            return false;
        GlueDataCatalogConfigurationDescription other = (GlueDataCatalogConfigurationDescription) obj;
    ...
    public GlueDataCatalogConfigurationDescription clone() {
        try {
            return (GlueDataCatalogConfigurationDescription) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kinesisanalyticsv2.model.transform.GlueDataCatalogConfigurationDescriptionMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
