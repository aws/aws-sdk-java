...
/**
 * StrategyOption JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StrategyOptionJsonUnmarshaller implements Unmarshaller<StrategyOption, JsonUnmarshallerContext> {

    public StrategyOption unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static StrategyOptionJsonUnmarshaller instance;

    public static StrategyOptionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StrategyOptionJsonUnmarshaller();
        return instance;
    }
}
