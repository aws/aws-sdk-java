...
/**
 * UpdateApplicationComponentConfigResult JSON Unmarshaller
 */
...
public class UpdateApplicationComponentConfigResultJsonUnmarshaller implements Unmarshaller<UpdateApplicationComponentConfigResult, JsonUnmarshallerContext> {
    ...
    public UpdateApplicationComponentConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateApplicationComponentConfigResult updateApplicationComponentConfigResult = new UpdateApplicationComponentConfigResult();
