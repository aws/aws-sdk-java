...
/**
 * PutPortfolioPreferencesResult JSON Unmarshaller
 */
...
public class PutPortfolioPreferencesResultJsonUnmarshaller implements Unmarshaller<PutPortfolioPreferencesResult, JsonUnmarshallerContext> {
    ...
    public PutPortfolioPreferencesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutPortfolioPreferencesResult putPortfolioPreferencesResult = new PutPortfolioPreferencesResult();
