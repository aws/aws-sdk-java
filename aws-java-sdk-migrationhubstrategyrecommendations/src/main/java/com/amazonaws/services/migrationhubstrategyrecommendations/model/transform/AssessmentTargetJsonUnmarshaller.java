        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("condition", targetDepth)) {
                    context.nextToken();
                    assessmentTarget.setCondition(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("values", targetDepth)) {
                    context.nextToken();
                    assessmentTarget.setValues(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
