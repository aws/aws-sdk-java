...
/**
 * PutPortfolioPreferencesRequestMarshaller
 */
...
public class PutPortfolioPreferencesRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> DATABASEPREFERENCES_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("databasePreferences").build();
    private static final MarshallingInfo<StructuredPojo> PRIORITIZEBUSINESSGOALS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("prioritizeBusinessGoals").build();

    private static final PutPortfolioPreferencesRequestMarshaller instance = new PutPortfolioPreferencesRequestMarshaller();

    public static PutPortfolioPreferencesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutPortfolioPreferencesRequest putPortfolioPreferencesRequest, ProtocolMarshaller protocolMarshaller) {
