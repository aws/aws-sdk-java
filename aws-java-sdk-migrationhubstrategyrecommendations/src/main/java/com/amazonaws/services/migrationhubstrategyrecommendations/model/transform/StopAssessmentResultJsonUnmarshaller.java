...
/**
 * StopAssessmentResult JSON Unmarshaller
 */
...
public class StopAssessmentResultJsonUnmarshaller implements Unmarshaller<StopAssessmentResult, JsonUnmarshallerContext> {
    ...
    public StopAssessmentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopAssessmentResult stopAssessmentResult = new StopAssessmentResult();
