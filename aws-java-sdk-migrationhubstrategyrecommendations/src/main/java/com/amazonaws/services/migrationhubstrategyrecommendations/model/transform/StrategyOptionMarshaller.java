...
/**
 * StrategyOptionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StrategyOptionMarshaller {
    ...
    private static final StrategyOptionMarshaller instance = new StrategyOptionMarshaller();

    public static StrategyOptionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StrategyOption strategyOption, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(strategyOption.getIsPreferred(), ISPREFERRED_BINDING);
            protocolMarshaller.marshall(strategyOption.getStrategy(), STRATEGY_BINDING);
            protocolMarshaller.marshall(strategyOption.getTargetDestination(), TARGETDESTINATION_BINDING);
            protocolMarshaller.marshall(strategyOption.getToolName(), TOOLNAME_BINDING);
        } catch (Exception e) {
