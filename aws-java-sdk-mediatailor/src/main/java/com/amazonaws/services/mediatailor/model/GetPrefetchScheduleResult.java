...
public class GetPrefetchScheduleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPrefetchScheduleResult == false)
            return false;
        GetPrefetchScheduleResult other = (GetPrefetchScheduleResult) obj;
    ...
    public GetPrefetchScheduleResult clone() {
        try {
            return (GetPrefetchScheduleResult) super.clone();
