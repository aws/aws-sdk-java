...
/**
 * DescribeSourceLocationRequestMarshaller
 */
...
public class DescribeSourceLocationRequestMarshaller {
    ...
    public static DescribeSourceLocationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeSourceLocationRequest describeSourceLocationRequest, ProtocolMarshaller protocolMarshaller) {

        if (describeSourceLocationRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(describeSourceLocationRequest.getSourceLocationName(), SOURCELOCATIONNAME_BINDING);
        } catch (Exception e) {
