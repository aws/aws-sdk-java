...
public class UpdateVodSourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateVodSourceResult withCreationTime(java.util.Date creationTime) {
    ...
    public UpdateVodSourceResult withHttpPackageConfigurations(HttpPackageConfiguration... httpPackageConfigurations) {
    ...
    public UpdateVodSourceResult withHttpPackageConfigurations(java.util.Collection<HttpPackageConfiguration> httpPackageConfigurations) {
    ...
    public UpdateVodSourceResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public UpdateVodSourceResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateVodSourceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateVodSourceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateVodSourceResult == false)
            return false;
        UpdateVodSourceResult other = (UpdateVodSourceResult) obj;
    ...
    public UpdateVodSourceResult clone() {
        try {
            return (UpdateVodSourceResult) super.clone();
