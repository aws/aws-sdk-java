...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediatailor-2018-04-23/UpdateLiveSource" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateLiveSourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The timestamp that indicates when the live source was created.
     */
    ...
    public UpdateLiveSourceResult withCreationTime(java.util.Date creationTime) {
    ...
    public UpdateLiveSourceResult withHttpPackageConfigurations(HttpPackageConfiguration... httpPackageConfigurations) {
    ...
    public UpdateLiveSourceResult withHttpPackageConfigurations(java.util.Collection<HttpPackageConfiguration> httpPackageConfigurations) {
    ...
    public UpdateLiveSourceResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public UpdateLiveSourceResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateLiveSourceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateLiveSourceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateLiveSourceResult == false)
            return false;
        UpdateLiveSourceResult other = (UpdateLiveSourceResult) obj;
    ...
    public UpdateLiveSourceResult clone() {
        try {
            return (UpdateLiveSourceResult) super.clone();
