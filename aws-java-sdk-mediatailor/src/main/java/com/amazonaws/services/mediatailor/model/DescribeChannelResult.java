...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediatailor-2018-04-23/DescribeChannel" target="_top">AWS API
 *      Documentation</a>
 */
...
public class DescribeChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeChannelResult withAudiences(String... audiences) {
    ...
    public DescribeChannelResult withAudiences(java.util.Collection<String> audiences) {
    ...
    public DescribeChannelResult withCreationTime(java.util.Date creationTime) {
    ...
    public DescribeChannelResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public DescribeChannelResult withOutputs(ResponseOutputItem... outputs) {
    ...
    public DescribeChannelResult withOutputs(java.util.Collection<ResponseOutputItem> outputs) {
        setOutputs(outputs);
        return this;
    }
