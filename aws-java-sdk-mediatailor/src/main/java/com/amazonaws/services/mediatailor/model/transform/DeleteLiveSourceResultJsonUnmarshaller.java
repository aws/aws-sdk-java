...
/**
 * DeleteLiveSourceResult JSON Unmarshaller
 */
...
public class DeleteLiveSourceResultJsonUnmarshaller implements Unmarshaller<DeleteLiveSourceResult, JsonUnmarshallerContext> {
    ...
    public DeleteLiveSourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLiveSourceResult deleteLiveSourceResult = new DeleteLiveSourceResult();

        return deleteLiveSourceResult;
    }
