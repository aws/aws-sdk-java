...
/**
 * ScheduleAdBreak JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScheduleAdBreakJsonUnmarshaller implements Unmarshaller<ScheduleAdBreak, JsonUnmarshallerContext> {

    public ScheduleAdBreak unmarshall(JsonUnmarshallerContext context) throws Exception {
        ScheduleAdBreak scheduleAdBreak = new ScheduleAdBreak();
    ...
    private static ScheduleAdBreakJsonUnmarshaller instance;

    public static ScheduleAdBreakJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ScheduleAdBreakJsonUnmarshaller();
        return instance;
    }
}
