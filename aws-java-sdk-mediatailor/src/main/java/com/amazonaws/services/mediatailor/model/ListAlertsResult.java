...
public class ListAlertsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setItems(java.util.Collection<Alert> items) {
        ...
        this.items = new java.util.ArrayList<Alert>(items);
    }
    ...
    public ListAlertsResult withItems(Alert... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<Alert>(items.length));
        }
        for (Alert ele : items) {
            this.items.add(ele);
        }
    ...
    public ListAlertsResult withItems(java.util.Collection<Alert> items) {
        setItems(items);
        return this;
    }
