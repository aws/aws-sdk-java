...
public class CreateProgramResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateProgramResult withAdBreaks(AdBreak... adBreaks) {
    ...
    public CreateProgramResult withAdBreaks(java.util.Collection<AdBreak> adBreaks) {
    ...
    public CreateProgramResult withScheduledStartTime(java.util.Date scheduledStartTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateProgramResult == false)
            return false;
        CreateProgramResult other = (CreateProgramResult) obj;
