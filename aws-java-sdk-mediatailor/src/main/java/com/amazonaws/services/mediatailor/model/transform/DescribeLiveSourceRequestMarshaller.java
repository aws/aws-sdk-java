...
/**
 * DescribeLiveSourceRequestMarshaller
 */
...
public class DescribeLiveSourceRequestMarshaller {
    ...
    public static DescribeLiveSourceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeLiveSourceRequest describeLiveSourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeLiveSourceRequest.getLiveSourceName(), LIVESOURCENAME_BINDING);
            protocolMarshaller.marshall(describeLiveSourceRequest.getSourceLocationName(), SOURCELOCATIONNAME_BINDING);
        } catch (Exception e) {
