...
public class ListPlaybackConfigurationsRequestMarshaller {
    ...
    private static final ListPlaybackConfigurationsRequestMarshaller instance = new ListPlaybackConfigurationsRequestMarshaller();

    public static ListPlaybackConfigurationsRequestMarshaller getInstance() {
        return instance;
    }
