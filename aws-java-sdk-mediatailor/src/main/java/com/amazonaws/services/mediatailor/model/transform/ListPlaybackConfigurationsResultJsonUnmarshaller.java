...
/**
 * ListPlaybackConfigurationsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListPlaybackConfigurationsResultJsonUnmarshaller implements Unmarshaller<ListPlaybackConfigurationsResult, JsonUnmarshallerContext> {

    public ListPlaybackConfigurationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listPlaybackConfigurationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
