...
/**
 * AudienceMediaMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AudienceMediaMarshaller {

    private static final MarshallingInfo<List> ALTERNATEMEDIA_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AlternateMedia").build();
    ...
    public void marshall(AudienceMedia audienceMedia, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(audienceMedia.getAudience(), AUDIENCE_BINDING);
        } catch (Exception e) {
