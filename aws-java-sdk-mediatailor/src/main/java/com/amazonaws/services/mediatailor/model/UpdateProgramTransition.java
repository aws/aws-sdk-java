 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediatailor-2018-04-23/UpdateProgramTransition"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateProgramTransition implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getScheduledStartTimeMillis() != null)
            sb.append("ScheduledStartTimeMillis: ").append(getScheduledStartTimeMillis());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateProgramTransition == false)
            return false;
    ...
    public UpdateProgramTransition clone() {
        try {
            return (UpdateProgramTransition) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediatailor.model.transform.UpdateProgramTransitionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
