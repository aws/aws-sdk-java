...
public class ScheduleEntryMarshaller {
    ...
    private static final MarshallingInfo<String> SCHEDULEENTRYTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ScheduleEntryType").build();
    ...
    public void marshall(ScheduleEntry scheduleEntry, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(scheduleEntry.getScheduleEntryType(), SCHEDULEENTRYTYPE_BINDING);
