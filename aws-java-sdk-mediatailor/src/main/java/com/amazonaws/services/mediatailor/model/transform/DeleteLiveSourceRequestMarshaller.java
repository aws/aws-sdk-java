...
/**
 * DeleteLiveSourceRequestMarshaller
 */
...
public class DeleteLiveSourceRequestMarshaller {
    ...
    public static DeleteLiveSourceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteLiveSourceRequest deleteLiveSourceRequest, ProtocolMarshaller protocolMarshaller) {

        if (deleteLiveSourceRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(deleteLiveSourceRequest.getLiveSourceName(), LIVESOURCENAME_BINDING);
            protocolMarshaller.marshall(deleteLiveSourceRequest.getSourceLocationName(), SOURCELOCATIONNAME_BINDING);
        } catch (Exception e) {
