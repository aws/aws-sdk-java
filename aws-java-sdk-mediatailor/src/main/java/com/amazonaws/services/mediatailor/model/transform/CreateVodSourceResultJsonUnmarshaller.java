...
/**
 * CreateVodSourceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateVodSourceResultJsonUnmarshaller implements Unmarshaller<CreateVodSourceResult, JsonUnmarshallerContext> {

    public CreateVodSourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateVodSourceResult createVodSourceResult = new CreateVodSourceResult();
    ...
    private static CreateVodSourceResultJsonUnmarshaller instance;

    public static CreateVodSourceResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateVodSourceResultJsonUnmarshaller();
        return instance;
    }
}
