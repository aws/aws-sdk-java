 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediatailor-2018-04-23/AudienceMedia" target="_top">AWS API
 *      Documentation</a>
 */
...
public class AudienceMedia implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<AlternateMedia> alternateMedia;
    /**
     * <p>
    ...
    public java.util.List<AlternateMedia> getAlternateMedia() {
    ...
    public void setAlternateMedia(java.util.Collection<AlternateMedia> alternateMedia) {
        if (alternateMedia == null) {
            this.alternateMedia = null;
            return;
        }

        this.alternateMedia = new java.util.ArrayList<AlternateMedia>(alternateMedia);
    }
    ...
    public AudienceMedia withAlternateMedia(AlternateMedia... alternateMedia) {
        if (this.alternateMedia == null) {
            setAlternateMedia(new java.util.ArrayList<AlternateMedia>(alternateMedia.length));
        }
    ...
    public AudienceMedia withAlternateMedia(java.util.Collection<AlternateMedia> alternateMedia) {
