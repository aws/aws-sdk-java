...
/**
 * DeleteVodSourceResult JSON Unmarshaller
 */
...
public class DeleteVodSourceResultJsonUnmarshaller implements Unmarshaller<DeleteVodSourceResult, JsonUnmarshallerContext> {
    ...
    public DeleteVodSourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteVodSourceResult deleteVodSourceResult = new DeleteVodSourceResult();
