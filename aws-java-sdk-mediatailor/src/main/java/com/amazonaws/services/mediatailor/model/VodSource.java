 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediatailor-2018-04-23/VodSource" target="_top">AWS API
 *      Documentation</a>
 */
...
public class VodSource implements Serializable, Cloneable, StructuredPojo {
    ...
    public VodSource withHttpPackageConfigurations(java.util.Collection<HttpPackageConfiguration> httpPackageConfigurations) {
    ...
    public VodSource withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
