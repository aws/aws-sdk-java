...
public class CreateSourceLocationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateSourceLocationResult withSegmentDeliveryConfigurations(java.util.Collection<SegmentDeliveryConfiguration> segmentDeliveryConfigurations) {
    ...
    public CreateSourceLocationResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
