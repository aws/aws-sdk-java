...
/**
 * DeleteProgramResult JSON Unmarshaller
 */
...
public class DeleteProgramResultJsonUnmarshaller implements Unmarshaller<DeleteProgramResult, JsonUnmarshallerContext> {
    ...
    public DeleteProgramResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteProgramResult deleteProgramResult = new DeleteProgramResult();
