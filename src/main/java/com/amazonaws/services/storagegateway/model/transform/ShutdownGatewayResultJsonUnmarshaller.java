...
public class ShutdownGatewayResultJsonUnmarshaller implements Unmarshaller<ShutdownGatewayResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    shutdownGatewayResult.setGatewayARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ShutdownGatewayResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ShutdownGatewayResultJsonUnmarshaller();
        return instance;
    }
}
