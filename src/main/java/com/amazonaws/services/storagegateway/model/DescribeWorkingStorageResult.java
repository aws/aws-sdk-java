...
public class DescribeWorkingStorageResult {
    ...
    public String toString() {
        ...
        if (workingStorageUsedInBytes != null) sb.append("WorkingStorageUsedInBytes: " + workingStorageUsedInBytes + ", ");
        if (workingStorageAllocatedInBytes != null) sb.append("WorkingStorageAllocatedInBytes: " + workingStorageAllocatedInBytes + ", ");
        sb.append("}");
        return sb.toString();
    }
