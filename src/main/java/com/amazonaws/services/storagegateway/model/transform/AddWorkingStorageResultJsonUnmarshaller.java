...
public class AddWorkingStorageResultJsonUnmarshaller implements Unmarshaller<AddWorkingStorageResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    addWorkingStorageResult.setGatewayARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static AddWorkingStorageResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AddWorkingStorageResultJsonUnmarshaller();
        return instance;
    }
}
