...
public class DisableGatewayResultJsonUnmarshaller implements Unmarshaller<DisableGatewayResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    disableGatewayResult.setGatewayARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DisableGatewayResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DisableGatewayResultJsonUnmarshaller();
        return instance;
    }
}
