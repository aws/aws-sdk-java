...
public class StackConfigurationManagerJsonUnmarshaller implements Unmarshaller<StackConfigurationManager, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    stackConfigurationManager.setName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Version", targetDepth)) {
                    context.nextToken();
                    stackConfigurationManager.setVersion(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static StackConfigurationManagerJsonUnmarshaller getInstance() {
        if (instance == null) instance = new StackConfigurationManagerJsonUnmarshaller();
        return instance;
    }
}
