...
public class CreateDeploymentResultJsonUnmarshaller implements Unmarshaller<CreateDeploymentResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DeploymentId", targetDepth)) {
                    context.nextToken();
                    createDeploymentResult.setDeploymentId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CreateDeploymentResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreateDeploymentResultJsonUnmarshaller();
        return instance;
    }
}
