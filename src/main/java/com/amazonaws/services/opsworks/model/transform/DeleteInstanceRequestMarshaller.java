    ...
    if (deleteInstanceRequest == null) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (deleteInstanceRequest.isDeleteElasticIp() != null) {
                jsonWriter.key("DeleteElasticIp").value(deleteInstanceRequest.isDeleteElasticIp());
            }
            if (deleteInstanceRequest.isDeleteVolumes() != null) {
                jsonWriter.key("DeleteVolumes").value(deleteInstanceRequest.isDeleteVolumes());
            }
