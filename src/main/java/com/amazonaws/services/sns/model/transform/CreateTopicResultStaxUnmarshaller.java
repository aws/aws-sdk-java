...
public class CreateTopicResultStaxUnmarshaller implements Unmarshaller<CreateTopicResult, StaxUnmarshallerContext> {
    ...
    public CreateTopicResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createTopicResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("TopicArn", targetDepth)) {
                    createTopicResult.setTopicArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CreateTopicResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateTopicResultStaxUnmarshaller();
        return instance;
    }
}
