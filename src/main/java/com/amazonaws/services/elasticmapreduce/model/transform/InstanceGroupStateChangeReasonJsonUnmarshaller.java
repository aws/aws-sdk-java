...
public class InstanceGroupStateChangeReasonJsonUnmarshaller implements Unmarshaller<InstanceGroupStateChangeReason, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Code", targetDepth)) {
                    context.nextToken();
                    instanceGroupStateChangeReason.setCode(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    instanceGroupStateChangeReason.setMessage(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static InstanceGroupStateChangeReasonJsonUnmarshaller getInstance() {
        if (instance == null) instance = new InstanceGroupStateChangeReasonJsonUnmarshaller();
        return instance;
    }
}
