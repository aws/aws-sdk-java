 ...
 */
public class StepDetailJsonUnmarshaller implements Unmarshaller<StepDetail, JsonUnmarshallerContext> {
    ...
    public static StepDetailJsonUnmarshaller getInstance() {
        if (instance == null) instance = new StepDetailJsonUnmarshaller();
        return instance;
    }
}
