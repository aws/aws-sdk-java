 ...
 */
public class DescribeJobFlowsResultJsonUnmarshaller implements Unmarshaller<DescribeJobFlowsResult, JsonUnmarshallerContext> {
    ...
    public static DescribeJobFlowsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeJobFlowsResultJsonUnmarshaller();
        return instance;
    }
}
