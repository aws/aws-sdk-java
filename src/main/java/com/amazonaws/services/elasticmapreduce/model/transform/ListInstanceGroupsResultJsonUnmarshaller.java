...
public class ListInstanceGroupsResultJsonUnmarshaller implements Unmarshaller<ListInstanceGroupsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("InstanceGroups", targetDepth)) {
                    listInstanceGroupsResult.setInstanceGroups(new ListUnmarshaller<InstanceGroup>(InstanceGroupJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("Marker", targetDepth)) {
                    context.nextToken();
                    listInstanceGroupsResult.setMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ListInstanceGroupsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListInstanceGroupsResultJsonUnmarshaller();
        return instance;
    }
}
