 ...
 */
public class BootstrapActionDetailJsonUnmarshaller implements Unmarshaller<BootstrapActionDetail, JsonUnmarshallerContext> {

    

    public BootstrapActionDetail unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    public static BootstrapActionDetailJsonUnmarshaller getInstance() {
        if (instance == null) instance = new BootstrapActionDetailJsonUnmarshaller();
        return instance;
    }
}
