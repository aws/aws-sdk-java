 ...
 */
public class InstanceStateChangeReasonJsonUnmarshaller implements Unmarshaller<InstanceStateChangeReason, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Code", targetDepth)) {
                    context.nextToken();
                    instanceStateChangeReason.setCode(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    instanceStateChangeReason.setMessage(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static InstanceStateChangeReasonJsonUnmarshaller getInstance() {
        if (instance == null) instance = new InstanceStateChangeReasonJsonUnmarshaller();
        return instance;
    }
}
