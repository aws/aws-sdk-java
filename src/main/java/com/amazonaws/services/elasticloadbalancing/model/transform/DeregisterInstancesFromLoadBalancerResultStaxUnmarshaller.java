...
public class DeregisterInstancesFromLoadBalancerResultStaxUnmarshaller implements Unmarshaller<DeregisterInstancesFromLoadBalancerResult, StaxUnmarshallerContext> {
    ...
    public DeregisterInstancesFromLoadBalancerResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return deregisterInstancesFromLoadBalancerResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("Instances/member", targetDepth)) {
                    deregisterInstancesFromLoadBalancerResult.getInstances().add(InstanceStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DeregisterInstancesFromLoadBalancerResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DeregisterInstancesFromLoadBalancerResultStaxUnmarshaller();
        return instance;
    }
}
