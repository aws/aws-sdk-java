...
public class ListenerUnmarshaller implements Unmarshaller<Listener, Node> {
    ...
    public Listener unmarshall(Node node) throws Exception {
        ...
        listener.setLoadBalancerPort(new IntegerUnmarshaller().unmarshall(loadBalancerPortNode));
    
        Node instancePortNode = XpathUtils.asNode("InstancePort", node);
        listener.setInstancePort(new IntegerUnmarshaller().unmarshall(instancePortNode));
