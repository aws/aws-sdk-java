 ...
 */
public class DescribeReservedCacheNodesOfferingsResultStaxUnmarshaller implements Unmarshaller<DescribeReservedCacheNodesOfferingsResult, StaxUnmarshallerContext> {
    ...
    public DescribeReservedCacheNodesOfferingsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeReservedCacheNodesOfferingsResult;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ReservedCacheNodesOfferings/ReservedCacheNodesOffering", targetDepth)) {
                    describeReservedCacheNodesOfferingsResult.getReservedCacheNodesOfferings().add(ReservedCacheNodesOfferingStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeReservedCacheNodesOfferingsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeReservedCacheNodesOfferingsResultStaxUnmarshaller();
        return instance;
    }
}
