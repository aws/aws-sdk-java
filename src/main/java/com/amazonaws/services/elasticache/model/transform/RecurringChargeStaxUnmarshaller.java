...
public class RecurringChargeStaxUnmarshaller implements Unmarshaller<RecurringCharge, StaxUnmarshallerContext> {
    ...
    public RecurringCharge unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return recurringCharge;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("RecurringChargeAmount", targetDepth)) {
                    recurringCharge.setRecurringChargeAmount(DoubleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("RecurringChargeFrequency", targetDepth)) {
                    recurringCharge.setRecurringChargeFrequency(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static RecurringChargeStaxUnmarshaller getInstance() {
        if (instance == null) instance = new RecurringChargeStaxUnmarshaller();
        return instance;
    }
}
