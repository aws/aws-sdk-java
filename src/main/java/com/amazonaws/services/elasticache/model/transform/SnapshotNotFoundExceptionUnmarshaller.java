...
public class SnapshotNotFoundExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public SnapshotNotFoundExceptionUnmarshaller() {
        super(SnapshotNotFoundException.class);
    }
