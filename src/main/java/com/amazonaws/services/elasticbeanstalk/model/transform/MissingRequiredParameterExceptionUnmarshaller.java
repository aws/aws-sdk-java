...
import com.amazonaws.services.elasticbeanstalk.model.MissingRequiredParameterException;
...
public class MissingRequiredParameterExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("MissingRequiredParameterException"))
            return null;
