...
public class S3LocationStaxUnmarshaller implements Unmarshaller<S3Location, StaxUnmarshallerContext> {
    ...
    public S3Location unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return s3Location;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("S3Bucket", targetDepth)) {
                    s3Location.setS3Bucket(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("S3Key", targetDepth)) {
                    s3Location.setS3Key(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static S3LocationStaxUnmarshaller getInstance() {
        if (instance == null) instance = new S3LocationStaxUnmarshaller();
        return instance;
    }
}
