...
import com.amazonaws.services.elasticbeanstalk.model.InvalidParameterCombinationException;
...
public class InvalidParameterCombinationExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("InvalidParameterCombinationException"))
            return null;
