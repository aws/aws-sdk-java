...
public class DynamoDBReflector {
    ...
    /*
     * BKJ: added for performance in getAttributeName()
     */
    
    private final ReentrantReadWriteLock readWriteLock = new ReentrantReadWriteLock();
    private final ReadLock r = readWriteLock.readLock();
    private final WriteLock w = readWriteLock.writeLock();
    ...
    String getAttributeName(Method getter) {
    	...
    	r.lock();
    	String attributeName = attributeNameCache.get(getter);
    	r. unlock();
    	
    	if(attributeName == null) {
    		    		
    		// BKJ: need to check why these tests on the annotations aren't cached too
            ...
            // BKJ: I believe this is actually buggy...it should use beans.Introspector
