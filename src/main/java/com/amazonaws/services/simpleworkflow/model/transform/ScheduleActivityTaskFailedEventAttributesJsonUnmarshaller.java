...
public class ScheduleActivityTaskFailedEventAttributesJsonUnmarshaller implements Unmarshaller<ScheduleActivityTaskFailedEventAttributes, JsonUnmarshallerContext> {
    ...
    public ScheduleActivityTaskFailedEventAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            if (token == null) return scheduleActivityTaskFailedEventAttributes;
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("activityId", targetDepth)) {
                    context.nextToken();
                    scheduleActivityTaskFailedEventAttributes.setActivityId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("cause", targetDepth)) {
                    context.nextToken();
                    scheduleActivityTaskFailedEventAttributes.setCause(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("decisionTaskCompletedEventId", targetDepth)) {
                    context.nextToken();
                    scheduleActivityTaskFailedEventAttributes.setDecisionTaskCompletedEventId(LongJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ScheduleActivityTaskFailedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ScheduleActivityTaskFailedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
