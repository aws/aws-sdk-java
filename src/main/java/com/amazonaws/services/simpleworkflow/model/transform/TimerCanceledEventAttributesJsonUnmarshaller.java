...
public class TimerCanceledEventAttributesJsonUnmarshaller implements Unmarshaller<TimerCanceledEventAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("timerId", targetDepth)) {
                    context.nextToken();
                    timerCanceledEventAttributes.setTimerId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("startedEventId", targetDepth)) {
                    context.nextToken();
                    timerCanceledEventAttributes.setStartedEventId(LongJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static TimerCanceledEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null) instance = new TimerCanceledEventAttributesJsonUnmarshaller();
        return instance;
    }
}
