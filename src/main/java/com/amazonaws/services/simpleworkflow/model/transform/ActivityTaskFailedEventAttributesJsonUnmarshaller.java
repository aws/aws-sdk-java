...
public class ActivityTaskFailedEventAttributesJsonUnmarshaller implements Unmarshaller<ActivityTaskFailedEventAttributes, JsonUnmarshallerContext> {
    ...
    public ActivityTaskFailedEventAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            if (token == null) return activityTaskFailedEventAttributes;

            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("reason", targetDepth)) {
                    context.nextToken();
                    activityTaskFailedEventAttributes.setReason(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("details", targetDepth)) {
                    context.nextToken();
                    activityTaskFailedEventAttributes.setDetails(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("scheduledEventId", targetDepth)) {
                    context.nextToken();
                    activityTaskFailedEventAttributes.setScheduledEventId(LongJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("startedEventId", targetDepth)) {
                    context.nextToken();
                    activityTaskFailedEventAttributes.setStartedEventId(LongJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ActivityTaskFailedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ActivityTaskFailedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
