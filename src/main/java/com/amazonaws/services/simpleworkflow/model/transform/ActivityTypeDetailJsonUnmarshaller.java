 ...
 */
public class ActivityTypeDetailJsonUnmarshaller implements Unmarshaller<ActivityTypeDetail, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("typeInfo", targetDepth)) {
                    context.nextToken();
                    activityTypeDetail.setTypeInfo(ActivityTypeInfoJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ActivityTypeDetailJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ActivityTypeDetailJsonUnmarshaller();
        return instance;
    }
}
