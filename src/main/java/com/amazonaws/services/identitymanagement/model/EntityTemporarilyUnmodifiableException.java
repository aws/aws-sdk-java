 ...
 * temporarily unmodifiable, such as a user that was deleted and then
 * re-created. The error indicates that the request is likely to succeed
 * after waiting several minutes. The error message describes the entity.
 * </p>
 */        
