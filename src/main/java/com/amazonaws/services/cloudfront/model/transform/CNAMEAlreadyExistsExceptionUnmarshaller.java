...
public class CNAMEAlreadyExistsExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public CNAMEAlreadyExistsExceptionUnmarshaller() {
        super(CNAMEAlreadyExistsException.class);
    }
