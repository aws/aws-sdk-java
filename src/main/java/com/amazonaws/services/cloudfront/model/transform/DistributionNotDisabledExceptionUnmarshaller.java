...
public class DistributionNotDisabledExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public DistributionNotDisabledExceptionUnmarshaller() {
        super(DistributionNotDisabledException.class);
    }
