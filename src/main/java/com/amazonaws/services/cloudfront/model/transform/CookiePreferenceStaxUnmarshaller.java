 ...
 */
public class CookiePreferenceStaxUnmarshaller implements Unmarshaller<CookiePreference, StaxUnmarshallerContext> {
    ...
    public CookiePreference unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return cookiePreference;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("Forward", targetDepth)) {
                    cookiePreference.setForward(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CookiePreferenceStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CookiePreferenceStaxUnmarshaller();
        return instance;
    }
}
