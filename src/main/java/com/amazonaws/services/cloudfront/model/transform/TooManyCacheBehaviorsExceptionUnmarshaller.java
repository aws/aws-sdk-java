...
public class TooManyCacheBehaviorsExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public TooManyCacheBehaviorsExceptionUnmarshaller() {
        super(TooManyCacheBehaviorsException.class);
    }
