...
public class InsufficientSnsTopicPolicyExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("InsufficientSnsTopicPolicyException"));
        } else {
            return errorTypeFromHeader.equals("InsufficientSnsTopicPolicyException");
        }
    }
    ...
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        ...
        e.setErrorCode("InsufficientSnsTopicPolicyException");
