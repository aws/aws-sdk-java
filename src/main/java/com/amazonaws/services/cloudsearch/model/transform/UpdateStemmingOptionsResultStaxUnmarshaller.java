...
public class UpdateStemmingOptionsResultStaxUnmarshaller implements Unmarshaller<UpdateStemmingOptionsResult, StaxUnmarshallerContext> {
    ...
    public UpdateStemmingOptionsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return updateStemmingOptionsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("Stems", targetDepth)) {
                    updateStemmingOptionsResult.setStems(StemmingOptionsStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    private static UpdateStemmingOptionsResultStaxUnmarshaller instance;
    public static UpdateStemmingOptionsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateStemmingOptionsResultStaxUnmarshaller();
        return instance;
    }
}
