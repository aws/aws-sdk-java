...
public class DescribeDefaultSearchFieldResultStaxUnmarshaller implements Unmarshaller<DescribeDefaultSearchFieldResult, StaxUnmarshallerContext> {
    ...
    public DescribeDefaultSearchFieldResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeDefaultSearchFieldResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("DefaultSearchField", targetDepth)) {
                    describeDefaultSearchFieldResult.setDefaultSearchField(DefaultSearchFieldStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeDefaultSearchFieldResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeDefaultSearchFieldResultStaxUnmarshaller();
        return instance;
    }
}
