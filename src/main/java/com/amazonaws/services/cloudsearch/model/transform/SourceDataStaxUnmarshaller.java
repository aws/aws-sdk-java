 ...
 */
public class SourceDataStaxUnmarshaller implements Unmarshaller<SourceData, StaxUnmarshallerContext> {
    ...
    public SourceData unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return sourceData;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("SourceName", targetDepth)) {
                    sourceData.setSourceName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("DefaultValue", targetDepth)) {
                    sourceData.setDefaultValue(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static SourceDataStaxUnmarshaller getInstance() {
        if (instance == null) instance = new SourceDataStaxUnmarshaller();
        return instance;
    }
}
