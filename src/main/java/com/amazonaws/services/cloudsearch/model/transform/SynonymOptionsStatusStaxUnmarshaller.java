...
public class SynonymOptionsStatusStaxUnmarshaller implements Unmarshaller<SynonymOptionsStatus, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Status", targetDepth)) {
                    synonymOptionsStatus.setStatus(OptionStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    private static SynonymOptionsStatusStaxUnmarshaller instance;
    public static SynonymOptionsStatusStaxUnmarshaller getInstance() {
        if (instance == null) instance = new SynonymOptionsStatusStaxUnmarshaller();
        return instance;
    }
}
