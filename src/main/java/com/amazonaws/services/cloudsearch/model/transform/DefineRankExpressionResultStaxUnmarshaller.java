...
public class DefineRankExpressionResultStaxUnmarshaller implements Unmarshaller<DefineRankExpressionResult, StaxUnmarshallerContext> {
    ...
    public DefineRankExpressionResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return defineRankExpressionResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("RankExpression", targetDepth)) {
                    defineRankExpressionResult.setRankExpression(RankExpressionStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    private static DefineRankExpressionResultStaxUnmarshaller instance;
    public static DefineRankExpressionResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DefineRankExpressionResultStaxUnmarshaller();
        return instance;
    }
}
