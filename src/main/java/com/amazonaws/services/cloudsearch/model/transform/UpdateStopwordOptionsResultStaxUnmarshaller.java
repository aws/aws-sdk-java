...
public class UpdateStopwordOptionsResultStaxUnmarshaller implements Unmarshaller<UpdateStopwordOptionsResult, StaxUnmarshallerContext> {
    ...
    public UpdateStopwordOptionsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return updateStopwordOptionsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("Stopwords", targetDepth)) {
                    updateStopwordOptionsResult.setStopwords(StopwordOptionsStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    private static UpdateStopwordOptionsResultStaxUnmarshaller instance;
    public static UpdateStopwordOptionsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateStopwordOptionsResultStaxUnmarshaller();
        return instance;
    }
}
