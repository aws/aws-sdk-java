...
public class CreateKeyPairResultStaxUnmarshaller implements Unmarshaller<CreateKeyPairResult, StaxUnmarshallerContext> {
    ...
    public CreateKeyPairResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createKeyPairResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression(".", targetDepth)) {
                    createKeyPairResult.setKeyPair(KeyPairStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CreateKeyPairResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateKeyPairResultStaxUnmarshaller();
        return instance;
    }
}
