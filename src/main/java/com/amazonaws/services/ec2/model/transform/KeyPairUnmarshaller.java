...
public class KeyPairUnmarshaller implements Unmarshaller<KeyPair, Node> {
    ...
    public KeyPair unmarshall(Node node) throws Exception {
        ...
        keyPair.setKeyFingerprint(new StringUnmarshaller().unmarshall(keyFingerprintNode));
    
        Node keyMaterialNode = XpathUtils.asNode("keyMaterial", node);
        keyPair.setKeyMaterial(new StringUnmarshaller().unmarshall(keyMaterialNode));
