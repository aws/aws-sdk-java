...
public class DescribeInstanceAttributeResultStaxUnmarshaller implements Unmarshaller<DescribeInstanceAttributeResult, StaxUnmarshallerContext> {
    ...
    public DescribeInstanceAttributeResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeInstanceAttributeResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression(".", targetDepth)) {
                    describeInstanceAttributeResult.setInstanceAttribute(InstanceAttributeStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeInstanceAttributeResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeInstanceAttributeResultStaxUnmarshaller();
        return instance;
    }
}
