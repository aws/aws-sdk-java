...
public class CreateSnapshotResultStaxUnmarshaller implements Unmarshaller<CreateSnapshotResult, StaxUnmarshallerContext> {
    ...
    public CreateSnapshotResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createSnapshotResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression(".", targetDepth)) {
                    createSnapshotResult.setSnapshot(SnapshotStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CreateSnapshotResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateSnapshotResultStaxUnmarshaller();
        return instance;
    }
}
