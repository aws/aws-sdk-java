...
public class DescribeInstanceStatusResultStaxUnmarshaller implements Unmarshaller<DescribeInstanceStatusResult, StaxUnmarshallerContext> {
    ...
    public DescribeInstanceStatusResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeInstanceStatusResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("instanceStatusSet/item", targetDepth)) {
                    describeInstanceStatusResult.getInstanceStatuses().add(InstanceStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    describeInstanceStatusResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeInstanceStatusResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeInstanceStatusResultStaxUnmarshaller();
        return instance;
    }
}
