...
public class InstanceStateChangeUnmarshaller implements Unmarshaller<InstanceStateChange, Node> {
    ...
    public InstanceStateChange unmarshall(Node node) throws Exception {
        ...
        Node currentStateNode = XpathUtils.asNode("currentState", node);
        instanceStateChange.setCurrentState(new InstanceStateUnmarshaller().unmarshall(currentStateNode));
    
        Node previousStateNode = XpathUtils.asNode("previousState", node);
        instanceStateChange.setPreviousState(new InstanceStateUnmarshaller().unmarshall(previousStateNode));
