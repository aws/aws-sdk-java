...
/**
 * Describe Spot Instance Requests Result Unmarshaller
 */
public class DescribeSpotInstanceRequestsResultUnmarshaller implements Unmarshaller<DescribeSpotInstanceRequestsResult, Node> {

    public DescribeSpotInstanceRequestsResult unmarshall(Node node) throws Exception {
        ...
        for (int spotInstanceRequestsIndex = 0; spotInstanceRequestsIndex < XpathUtils.nodeLength(spotInstanceRequestsNodes); ++spotInstanceRequestsIndex) {
            ...
            describeSpotInstanceRequestsResult.getSpotInstanceRequests().add(new SpotInstanceRequestUnmarshaller().unmarshall(spotInstanceRequestsNode));
