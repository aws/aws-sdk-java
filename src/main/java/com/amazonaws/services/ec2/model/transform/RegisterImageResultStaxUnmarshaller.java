...
public class RegisterImageResultStaxUnmarshaller implements Unmarshaller<RegisterImageResult, StaxUnmarshallerContext> {
    ...
    public RegisterImageResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return registerImageResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("imageId", targetDepth)) {
                    registerImageResult.setImageId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static RegisterImageResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new RegisterImageResultStaxUnmarshaller();
        return instance;
    }
}
