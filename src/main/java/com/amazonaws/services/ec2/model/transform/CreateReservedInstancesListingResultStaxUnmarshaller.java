...
public class CreateReservedInstancesListingResultStaxUnmarshaller implements Unmarshaller<CreateReservedInstancesListingResult, StaxUnmarshallerContext> {
    ...
    public CreateReservedInstancesListingResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createReservedInstancesListingResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("reservedInstancesListingsSet/item", targetDepth)) {
                    createReservedInstancesListingResult.getReservedInstancesListings().add(ReservedInstancesListingStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CreateReservedInstancesListingResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateReservedInstancesListingResultStaxUnmarshaller();
        return instance;
    }
}
