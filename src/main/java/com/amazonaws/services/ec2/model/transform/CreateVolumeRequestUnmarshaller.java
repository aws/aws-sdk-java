...
public class CreateVolumeRequestUnmarshaller implements Unmarshaller<CreateVolumeRequest, Node> {
    ...
    public CreateVolumeRequest unmarshall(Node node) throws Exception {
        ...
        createVolumeRequest.setSnapshotId(new StringUnmarshaller().unmarshall(snapshotIdNode));
    
        Node availabilityZoneNode = XpathUtils.asNode("AvailabilityZone", node);
        createVolumeRequest.setAvailabilityZone(new StringUnmarshaller().unmarshall(availabilityZoneNode));
