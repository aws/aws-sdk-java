...
public class DescribeReservedInstancesResultStaxUnmarshaller implements Unmarshaller<DescribeReservedInstancesResult, StaxUnmarshallerContext> {
    ...
    public DescribeReservedInstancesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeReservedInstancesResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("reservedInstancesSet/item", targetDepth)) {
                    describeReservedInstancesResult.getReservedInstances().add(ReservedInstancesStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeReservedInstancesResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeReservedInstancesResultStaxUnmarshaller();
        return instance;
    }
}
