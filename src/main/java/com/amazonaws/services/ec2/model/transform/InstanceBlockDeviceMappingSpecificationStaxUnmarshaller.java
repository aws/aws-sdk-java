...
/**
 * Instance Block Device Mapping Specification StAX Unmarshaller
 */
public class InstanceBlockDeviceMappingSpecificationStaxUnmarshaller implements Unmarshaller<InstanceBlockDeviceMappingSpecification, StaxUnmarshallerContext> {
    ...
    public InstanceBlockDeviceMappingSpecification unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return instanceBlockDeviceMappingSpecification;
    ...
    private static InstanceBlockDeviceMappingSpecificationStaxUnmarshaller instance;
    public static InstanceBlockDeviceMappingSpecificationStaxUnmarshaller getInstance() {
        if (instance == null) instance = new InstanceBlockDeviceMappingSpecificationStaxUnmarshaller();
        return instance;
    }
}
