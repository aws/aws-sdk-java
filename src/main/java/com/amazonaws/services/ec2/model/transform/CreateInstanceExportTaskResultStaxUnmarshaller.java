...
public class CreateInstanceExportTaskResultStaxUnmarshaller implements Unmarshaller<CreateInstanceExportTaskResult, StaxUnmarshallerContext> {
    ...
    public CreateInstanceExportTaskResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createInstanceExportTaskResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("exportTask", targetDepth)) {
                    createInstanceExportTaskResult.setExportTask(ExportTaskStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CreateInstanceExportTaskResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateInstanceExportTaskResultStaxUnmarshaller();
        return instance;
    }
}
