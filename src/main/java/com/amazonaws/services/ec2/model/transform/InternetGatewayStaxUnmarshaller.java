...
public class InternetGatewayStaxUnmarshaller implements Unmarshaller<InternetGateway, StaxUnmarshallerContext> {
    ...
    public InternetGateway unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return internetGateway;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("attachmentSet/item", targetDepth)) {
                    internetGateway.getAttachments().add(InternetGatewayAttachmentStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("tagSet/item", targetDepth)) {
                    internetGateway.getTags().add(TagStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static InternetGatewayStaxUnmarshaller getInstance() {
        if (instance == null) instance = new InternetGatewayStaxUnmarshaller();
        return instance;
    }
}
