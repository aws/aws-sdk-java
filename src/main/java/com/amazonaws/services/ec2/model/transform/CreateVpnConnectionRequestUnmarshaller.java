...
/**
 * Create Vpn Connection Request Unmarshaller
 */        
public class CreateVpnConnectionRequestUnmarshaller implements Unmarshaller<CreateVpnConnectionRequest, Node> {
    ...
    public CreateVpnConnectionRequest unmarshall(Node node) throws Exception {
        ...
        createVpnConnectionRequest.setCustomerGatewayId(new StringUnmarshaller().unmarshall(customerGatewayIdNode));
    
        Node vpnGatewayIdNode = XpathUtils.asNode("VpnGatewayId", node);
        createVpnConnectionRequest.setVpnGatewayId(new StringUnmarshaller().unmarshall(vpnGatewayIdNode));
