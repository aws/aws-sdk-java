...
/**
 * Get Password Data Request StAX Unmarshaller
 */
public class GetPasswordDataRequestStaxUnmarshaller implements Unmarshaller<GetPasswordDataRequest, StaxUnmarshallerContext> {
    ...
    public GetPasswordDataRequest unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (event.isEndDocument()) return getPasswordDataRequest;

            if (event.isAttribute() || event.isStartElement()) {
                if (context.testExpression("InstanceId", targetDepth)) {
                    getPasswordDataRequest.setInstanceId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static GetPasswordDataRequestStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GetPasswordDataRequestStaxUnmarshaller();
        return instance;
    }
}
