...
public class CancelReservedInstancesListingResultStaxUnmarshaller implements Unmarshaller<CancelReservedInstancesListingResult, StaxUnmarshallerContext> {
    ...
    public CancelReservedInstancesListingResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return cancelReservedInstancesListingResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("reservedInstancesListingsSet/item", targetDepth)) {
                    cancelReservedInstancesListingResult.getReservedInstancesListings().add(ReservedInstancesListingStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CancelReservedInstancesListingResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CancelReservedInstancesListingResultStaxUnmarshaller();
        return instance;
    }
}
