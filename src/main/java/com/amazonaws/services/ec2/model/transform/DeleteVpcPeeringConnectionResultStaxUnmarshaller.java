...
/**
 * Delete Vpc Peering Connection Result StAX Unmarshaller
 */
public class DeleteVpcPeeringConnectionResultStaxUnmarshaller implements Unmarshaller<DeleteVpcPeeringConnectionResult, StaxUnmarshallerContext> {
    ...
    public DeleteVpcPeeringConnectionResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return deleteVpcPeeringConnectionResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("return", targetDepth)) {
                    deleteVpcPeeringConnectionResult.setReturn(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DeleteVpcPeeringConnectionResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteVpcPeeringConnectionResultStaxUnmarshaller();
        return instance;
    }
}
