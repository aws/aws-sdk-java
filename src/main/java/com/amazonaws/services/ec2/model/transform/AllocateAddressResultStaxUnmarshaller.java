...
public class AllocateAddressResultStaxUnmarshaller implements Unmarshaller<AllocateAddressResult, StaxUnmarshallerContext> {
    ...
    public AllocateAddressResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return allocateAddressResult;
    ...
    public static AllocateAddressResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new AllocateAddressResultStaxUnmarshaller();
        return instance;
    }
}
