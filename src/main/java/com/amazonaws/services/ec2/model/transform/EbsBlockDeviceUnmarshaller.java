...
public class EbsBlockDeviceUnmarshaller implements Unmarshaller<EbsBlockDevice, Node> {
    ...
    public EbsBlockDevice unmarshall(Node node) throws Exception {
        ...
        ebsBlockDevice.setSnapshotId(new StringUnmarshaller().unmarshall(snapshotIdNode));
    
        Node volumeSizeNode = XpathUtils.asNode("volumeSize", node);
        ebsBlockDevice.setVolumeSize(new IntegerUnmarshaller().unmarshall(volumeSizeNode));
    
        Node deleteOnTerminationNode = XpathUtils.asNode("deleteOnTermination", node);
        ebsBlockDevice.setDeleteOnTermination(new BooleanUnmarshaller().unmarshall(deleteOnTerminationNode));
