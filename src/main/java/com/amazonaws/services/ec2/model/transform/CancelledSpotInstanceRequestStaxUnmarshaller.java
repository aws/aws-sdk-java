...
public class CancelledSpotInstanceRequestStaxUnmarshaller implements Unmarshaller<CancelledSpotInstanceRequest, StaxUnmarshallerContext> {
    ...
    public CancelledSpotInstanceRequest unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return cancelledSpotInstanceRequest;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("spotInstanceRequestId", targetDepth)) {
                    cancelledSpotInstanceRequest.setSpotInstanceRequestId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("state", targetDepth)) {
                    cancelledSpotInstanceRequest.setState(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CancelledSpotInstanceRequestStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CancelledSpotInstanceRequestStaxUnmarshaller();
        return instance;
    }
}
