...
public class InstanceMonitoringStaxUnmarshaller implements Unmarshaller<InstanceMonitoring, StaxUnmarshallerContext> {
    ...
    public InstanceMonitoring unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (event.isEndDocument()) return instanceMonitoring;

            if (event.isAttribute() || event.isStartElement()) {
                if (context.testExpression("instanceId", targetDepth)) {
                    instanceMonitoring.setInstanceId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("monitoring", targetDepth)) {
                    instanceMonitoring.setMonitoring(MonitoringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
