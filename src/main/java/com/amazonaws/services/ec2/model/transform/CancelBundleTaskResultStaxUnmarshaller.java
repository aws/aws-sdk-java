...
public class CancelBundleTaskResultStaxUnmarshaller implements Unmarshaller<CancelBundleTaskResult, StaxUnmarshallerContext> {
    ...
    public CancelBundleTaskResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return cancelBundleTaskResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("bundleInstanceTask", targetDepth)) {
                    cancelBundleTaskResult.setBundleTask(BundleTaskStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CancelBundleTaskResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CancelBundleTaskResultStaxUnmarshaller();
        return instance;
    }
}
