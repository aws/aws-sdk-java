...
/**
 * Describe Spot Instance Requests Request Unmarshaller
 */
public class DescribeSpotInstanceRequestsRequestUnmarshaller implements Unmarshaller<DescribeSpotInstanceRequestsRequest, Node> {

    public DescribeSpotInstanceRequestsRequest unmarshall(Node node) throws Exception {
        ...
        for (int spotInstanceRequestIdsIndex = 0; spotInstanceRequestIdsIndex < XpathUtils.nodeLength(spotInstanceRequestIdsNodes); ++spotInstanceRequestIdsIndex) {
            ...
            describeSpotInstanceRequestsRequest.getSpotInstanceRequestIds().add(new StringUnmarshaller().unmarshall(spotInstanceRequestIdsNode));
