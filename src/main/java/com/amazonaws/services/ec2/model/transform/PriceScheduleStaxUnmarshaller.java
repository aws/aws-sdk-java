...
public class PriceScheduleStaxUnmarshaller implements Unmarshaller<PriceSchedule, StaxUnmarshallerContext> {
    ...
    public PriceSchedule unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return priceSchedule;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("currencyCode", targetDepth)) {
                    priceSchedule.setCurrencyCode(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static PriceScheduleStaxUnmarshaller getInstance() {
        if (instance == null) instance = new PriceScheduleStaxUnmarshaller();
        return instance;
    }
}
