...
public class DescribeReservedInstancesOfferingsResultStaxUnmarshaller implements Unmarshaller<DescribeReservedInstancesOfferingsResult, StaxUnmarshallerContext> {
    ...
    public DescribeReservedInstancesOfferingsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeReservedInstancesOfferingsResult;
    ...
    public static DescribeReservedInstancesOfferingsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeReservedInstancesOfferingsResultStaxUnmarshaller();
        return instance;
    }
}
