...
public class ListStacksResultStaxUnmarshaller implements Unmarshaller<ListStacksResult, StaxUnmarshallerContext> {
    ...
    public ListStacksResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return listStacksResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("StackSummaries/member", targetDepth)) {
                    listStacksResult.getStackSummaries().add(StackSummaryStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ListStacksResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ListStacksResultStaxUnmarshaller();
        return instance;
    }
}
