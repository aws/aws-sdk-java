...
public class FieldJsonUnmarshaller implements Unmarshaller<Field, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("key", targetDepth)) {
                    context.nextToken();
                    field.setKey(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("stringValue", targetDepth)) {
                    context.nextToken();
                    field.setStringValue(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("refValue", targetDepth)) {
                    context.nextToken();
                    field.setRefValue(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static FieldJsonUnmarshaller getInstance() {
        if (instance == null) instance = new FieldJsonUnmarshaller();
        return instance;
    }
}
