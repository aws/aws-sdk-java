 ...
 */
public class SequenceNumberRangeJsonUnmarshaller implements Unmarshaller<SequenceNumberRange, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StartingSequenceNumber", targetDepth)) {
                    context.nextToken();
                    sequenceNumberRange.setStartingSequenceNumber(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("EndingSequenceNumber", targetDepth)) {
                    context.nextToken();
                    sequenceNumberRange.setEndingSequenceNumber(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static SequenceNumberRangeJsonUnmarshaller getInstance() {
        if (instance == null) instance = new SequenceNumberRangeJsonUnmarshaller();
        return instance;
    }
}
