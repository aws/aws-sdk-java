...
public class AmazonSQSAsyncClient extends AmazonSQSClient
	...
	public Future<Void> setQueueAttributesAsync(final SetQueueAttributesRequest setQueueAttributesRequest,
			final AsyncServiceHandler<Void, SetQueueAttributesRequest> asyncHandler) throws AmazonServiceException,
			AmazonClientException {
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					setQueueAttributes(setQueueAttributesRequest);
					asyncHandler.handleResult(null, setQueueAttributesRequest);
					return null;
				} catch (Exception ex) {
	 ...
	 *            ChangeMessageVisibilityBatch operation on AmazonSQS.
	 *            
	 * @param asyncHandler
	 *            Asynchronous callback for service events. The calling class
	 *            will ignore returned future and provide implementation of
	...
	public Future<ChangeMessageVisibilityBatchResult> changeMessageVisibilityBatchAsync(
			...
			final AsyncServiceHandler<ChangeMessageVisibilityBatchResult, ChangeMessageVisibilityBatchRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<ChangeMessageVisibilityBatchResult>() {
			public ChangeMessageVisibilityBatchResult call() throws Exception {
				try {
					ChangeMessageVisibilityBatchResult result = changeMessageVisibilityBatch(changeMessageVisibilityBatchRequest);
					asyncHandler.handleResult(result, changeMessageVisibilityBatchRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<Void> changeMessageVisibilityAsync(
			...
			final AsyncServiceHandler<Void, ChangeMessageVisibilityRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					changeMessageVisibility(changeMessageVisibilityRequest);
					asyncHandler.handleResult(null, changeMessageVisibilityRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<GetQueueUrlResult> getQueueUrlAsync(final GetQueueUrlRequest getQueueUrlRequest,
			final AsyncServiceHandler<GetQueueUrlResult, GetQueueUrlRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<GetQueueUrlResult>() {
			public GetQueueUrlResult call() throws Exception {
				try {
				GetQueueUrlResult result = getQueueUrl(getQueueUrlRequest);
				asyncHandler.handleResult(result, getQueueUrlRequest);
				return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	/**
	 * <p>
	 * The <code>RemovePermission</code> action revokes any permissions in the
	 * queue policy that matches the specified <code>Label</code> parameter.
	 * Only the owner of the queue can remove permissions.
	 * </p>
	 * 
	 * @param removePermissionRequest
	 *            Container for the necessary parameters to execute the
	 *            RemovePermission operation on AmazonSQS.
	 * 
	 * @param asyncHandler
	 *            Asynchronous callback for service events. The calling class
	 *            will ignore returned future and provide implementation of
	...
	public Future<Void> removePermissionAsync(final RemovePermissionRequest removePermissionRequest,
			final AsyncServiceHandler<Void, RemovePermissionRequest> asyncHandler) throws AmazonServiceException,
			AmazonClientException {
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					removePermission(removePermissionRequest);
					asyncHandler.handleResult(null, removePermissionRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	 ...
	 *            Container for the necessary parameters to execute the
	 *            GetQueueAttributes operation on AmazonSQS.
	 * 
	 * @param asyncHandler
	 *            Asynchronous callback for service events. The calling class
	 *            will ignore returned future and provide implementation of
	...
	public Future<GetQueueAttributesResult> getQueueAttributesAsync(
			...
			final AsyncServiceHandler<GetQueueAttributesResult, GetQueueAttributesRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<GetQueueAttributesResult>() {
			public GetQueueAttributesResult call() throws Exception {
				try {
					GetQueueAttributesResult result = getQueueAttributes(getQueueAttributesRequest);
					asyncHandler.handleResult(result, getQueueAttributesRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<SendMessageBatchResult> sendMessageBatchAsync(final SendMessageBatchRequest sendMessageBatchRequest,
			final AsyncServiceHandler<SendMessageBatchResult, SendMessageBatchRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<SendMessageBatchResult>() {
			public SendMessageBatchResult call() throws Exception {
				try {
					SendMessageBatchResult result = sendMessageBatch(sendMessageBatchRequest);
					asyncHandler.handleResult(result, sendMessageBatchRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<Void> deleteQueueAsync(final DeleteQueueRequest deleteQueueRequest,
			final AsyncServiceHandler<Void, DeleteQueueRequest> asyncHandler) throws AmazonServiceException,
			AmazonClientException {
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					deleteQueue(deleteQueueRequest);
					asyncHandler.handleResult(null, deleteQueueRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<SendMessageResult> sendMessageAsync(final SendMessageRequest sendMessageRequest,
			final AsyncServiceHandler<SendMessageResult, SendMessageRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<SendMessageResult>() {
			public SendMessageResult call() throws Exception {
				try {
					SendMessageResult result = sendMessage(sendMessageRequest);
					asyncHandler.handleResult(result, sendMessageRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<ReceiveMessageResult> receiveMessageAsync(final ReceiveMessageRequest receiveMessageRequest,
			final AsyncServiceHandler<ReceiveMessageResult, ReceiveMessageRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<ReceiveMessageResult>() {
			public ReceiveMessageResult call() throws Exception {
				try {
					ReceiveMessageResult result = receiveMessage(receiveMessageRequest);
					asyncHandler.handleResult(result, receiveMessageRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<ListQueuesResult> listQueuesAsync(final ListQueuesRequest listQueuesRequest,
			final AsyncServiceHandler<ListQueuesResult, ListQueuesRequest> asyncHandler) throws AmazonServiceException,
			AmazonClientException {
		return executorService.submit(new Callable<ListQueuesResult>() {
			public ListQueuesResult call() throws Exception {
				try {
					ListQueuesResult result = listQueues(listQueuesRequest);
					asyncHandler.handleResult(result, listQueuesRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<DeleteMessageBatchResult> deleteMessageBatchAsync(
			...
			final AsyncServiceHandler<DeleteMessageBatchResult, DeleteMessageBatchRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<DeleteMessageBatchResult>() {
			public DeleteMessageBatchResult call() throws Exception {
				try {
					DeleteMessageBatchResult result = deleteMessageBatch(deleteMessageBatchRequest);
					asyncHandler.handleResult(result, deleteMessageBatchRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<CreateQueueResult> createQueueAsync(final CreateQueueRequest createQueueRequest,
			final AsyncServiceHandler<CreateQueueResult, CreateQueueRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<CreateQueueResult>() {
			public CreateQueueResult call() throws Exception {
				try {
					CreateQueueResult result = createQueue(createQueueRequest);
					asyncHandler.handleResult(result, createQueueRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<Void> addPermissionAsync(final AddPermissionRequest addPermissionRequest,
			final AsyncServiceHandler<Void, AddPermissionRequest> asyncHandler) throws AmazonServiceException,
			AmazonClientException {
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					addPermission(addPermissionRequest);
					asyncHandler.handleResult(null, addPermissionRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
	...
	public Future<Void> deleteMessageAsync(final DeleteMessageRequest deleteMessageRequest,
			final AsyncServiceHandler<Void, DeleteMessageRequest> asyncHandler) throws AmazonServiceException,
			AmazonClientException {
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					deleteMessage(deleteMessageRequest);
					asyncHandler.handleResult(null, deleteMessageRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
