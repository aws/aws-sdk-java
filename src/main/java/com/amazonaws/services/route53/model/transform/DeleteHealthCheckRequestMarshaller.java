 ...
 */
public class DeleteHealthCheckRequestMarshaller implements Marshaller<Request<DeleteHealthCheckRequest>, DeleteHealthCheckRequest> {

    public Request<DeleteHealthCheckRequest> marshall(DeleteHealthCheckRequest deleteHealthCheckRequest) {
