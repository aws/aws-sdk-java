...
public class NoSuchChangeExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public NoSuchChangeExceptionUnmarshaller() {
        super(NoSuchChangeException.class);
    }
