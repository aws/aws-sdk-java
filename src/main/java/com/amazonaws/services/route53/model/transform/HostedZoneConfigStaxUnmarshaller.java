 ...
 */
public class HostedZoneConfigStaxUnmarshaller implements Unmarshaller<HostedZoneConfig, StaxUnmarshallerContext> {
    ...
    public static HostedZoneConfigStaxUnmarshaller getInstance() {
        if (instance == null) instance = new HostedZoneConfigStaxUnmarshaller();
        return instance;
    }
}
