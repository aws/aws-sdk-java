...
public class IncompatibleVersionExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public IncompatibleVersionExceptionUnmarshaller() {
        super(IncompatibleVersionException.class);
    }
