...
public class TooManyHealthChecksExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public TooManyHealthChecksExceptionUnmarshaller() {
        super(TooManyHealthChecksException.class);
    }
