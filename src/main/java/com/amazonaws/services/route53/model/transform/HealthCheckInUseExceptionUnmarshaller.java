...
public class HealthCheckInUseExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public HealthCheckInUseExceptionUnmarshaller() {
        super(HealthCheckInUseException.class);
    }
