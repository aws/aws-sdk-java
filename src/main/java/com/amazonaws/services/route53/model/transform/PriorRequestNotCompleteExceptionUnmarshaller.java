...
public class PriorRequestNotCompleteExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public PriorRequestNotCompleteExceptionUnmarshaller() {
        super(PriorRequestNotCompleteException.class);
    }
