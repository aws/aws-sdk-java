...
/**
 * Describe Log Groups Result JSON Unmarshaller
 */
public class DescribeLogGroupsResultJsonUnmarshaller implements Unmarshaller<DescribeLogGroupsResult, JsonUnmarshallerContext> {
    ...
    public DescribeLogGroupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeLogGroupsResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DescribeLogGroupsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeLogGroupsResultJsonUnmarshaller();
        return instance;
    }
}
