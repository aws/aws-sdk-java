...
/**
 * Create Log Stream Request Marshaller
 */
public class CreateLogStreamRequestMarshaller implements Marshaller<Request<CreateLogStreamRequest>, CreateLogStreamRequest> {
    ...
    if (createLogStreamRequest == null) {
        ...
        String target = "Logs_20140328.CreateLogStream";
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (createLogStreamRequest.getLogGroupName() != null) {
                jsonWriter.key("logGroupName").value(createLogStreamRequest.getLogGroupName());
            }
            if (createLogStreamRequest.getLogStreamName() != null) {
                jsonWriter.key("logStreamName").value(createLogStreamRequest.getLogStreamName());
            }
