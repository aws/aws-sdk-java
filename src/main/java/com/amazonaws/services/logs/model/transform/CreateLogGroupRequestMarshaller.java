...
/**
 * Create Log Group Request Marshaller
 */
public class CreateLogGroupRequestMarshaller implements Marshaller<Request<CreateLogGroupRequest>, CreateLogGroupRequest> {
    ...
    if (createLogGroupRequest == null) {
        ...
        Request<CreateLogGroupRequest> request = new DefaultRequest<CreateLogGroupRequest>(createLogGroupRequest, "AWSLogs");
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (createLogGroupRequest.getLogGroupName() != null) {
                jsonWriter.key("logGroupName").value(createLogGroupRequest.getLogGroupName());
            }
