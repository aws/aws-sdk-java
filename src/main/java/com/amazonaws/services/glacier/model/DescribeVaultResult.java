...
public class DescribeVaultResult {
    ...
    public String toString() {
        ...
        if (lastInventoryDate != null) sb.append("LastInventoryDate: " + lastInventoryDate + ", ");
        if (numberOfArchives != null) sb.append("NumberOfArchives: " + numberOfArchives + ", ");
        if (sizeInBytes != null) sb.append("SizeInBytes: " + sizeInBytes + ", ");
        sb.append("}");
        return sb.toString();
    }
