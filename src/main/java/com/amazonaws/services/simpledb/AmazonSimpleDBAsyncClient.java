...
public class AmazonSimpleDBAsyncClient extends AmazonSimpleDBClient
     ...
     *           
	 * @param asyncHandler
	 *            Asynchronous callback for service events. The calling class
	 *            will ignore returned future and provide implementation of
	 *            handler instead.
     * 
     * @return A Java Future object containing the response from the Select
     *         service method, as returned by AmazonSimpleDB.
     ...
     */
	public Future<SelectResult> selectAsync(final SelectRequest selectRequest,
			final AsyncServiceHandler<SelectResult, SelectRequest> asyncHandler) 
					throws AmazonServiceException, AmazonClientException {

		return executorService.submit(new Callable<SelectResult>() {
			public SelectResult call() throws Exception {
				try {
					SelectResult result = select(selectRequest);
					asyncHandler.handleResult(result, selectRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
				}
			}
		});
     ...
     */
	public Future<Void> putAttributesAsync(final PutAttributesRequest putAttributesRequest,
			final AsyncServiceHandler<Void, PutAttributesRequest> asyncHandler) 
			throws AmazonServiceException,	AmazonClientException {
		...
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					putAttributes(putAttributesRequest);
					asyncHandler.handleResult(null, putAttributesRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
     ...
     */
	public Future<Void> batchDeleteAttributesAsync(final BatchDeleteAttributesRequest batchDeleteAttributesRequest,
			final AsyncServiceHandler<Void, BatchDeleteAttributesRequest> asyncHandler) throws AmazonServiceException,
		...
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					batchDeleteAttributes(batchDeleteAttributesRequest);
					asyncHandler.handleResult(null, batchDeleteAttributesRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
     ...
     */
	public Future<Void> deleteDomainAsync(final DeleteDomainRequest deleteDomainRequest,
			final AsyncServiceHandler<Void, DeleteDomainRequest> asyncHandler) throws AmazonServiceException,
			AmazonClientException {
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					deleteDomain(deleteDomainRequest);
					asyncHandler.handleResult(null, deleteDomainRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
     ...
     */
	public Future<Void> createDomainAsync(final CreateDomainRequest createDomainRequest,
			final AsyncServiceHandler<Void, CreateDomainRequest> asyncHandler) throws AmazonServiceException,
			AmazonClientException {
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					createDomain(createDomainRequest);
					asyncHandler.handleResult(null, createDomainRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
     ...
     */
	public Future<Void> deleteAttributesAsync(final DeleteAttributesRequest deleteAttributesRequest,
			final AsyncServiceHandler<Void, DeleteAttributesRequest> asyncHandler) throws AmazonServiceException,
			AmazonClientException {
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					deleteAttributes(deleteAttributesRequest);
					asyncHandler.handleResult(null, deleteAttributesRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
     ...
     */
	public Future<ListDomainsResult> listDomainsAsync(final ListDomainsRequest listDomainsRequest,
			final AsyncServiceHandler<ListDomainsResult, ListDomainsRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<ListDomainsResult>() {
			public ListDomainsResult call() throws Exception {
				try {
					ListDomainsResult result = listDomains(listDomainsRequest);
					asyncHandler.handleResult(result, listDomainsRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
     ...
     */
	public Future<GetAttributesResult> getAttributesAsync(final GetAttributesRequest getAttributesRequest,
			final AsyncServiceHandler<GetAttributesResult, GetAttributesRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<GetAttributesResult>() {
			public GetAttributesResult call() throws Exception {
				try {
					GetAttributesResult result = getAttributes(getAttributesRequest);
					asyncHandler.handleResult(result, getAttributesRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
     ...
     */
	public Future<Void> batchPutAttributesAsync(final BatchPutAttributesRequest batchPutAttributesRequest,
			final AsyncServiceHandler<Void, BatchPutAttributesRequest> asyncHandler) throws AmazonServiceException,
			AmazonClientException {
		return executorService.submit(new Callable<Void>() {
			public Void call() throws Exception {
				try {
					batchPutAttributes(batchPutAttributesRequest);
					asyncHandler.handleResult(null, batchPutAttributesRequest);
					return null;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
     ...
     */
	public Future<DomainMetadataResult> domainMetadataAsync(final DomainMetadataRequest domainMetadataRequest,
			final AsyncServiceHandler<DomainMetadataResult, DomainMetadataRequest> asyncHandler)
			throws AmazonServiceException, AmazonClientException {
		return executorService.submit(new Callable<DomainMetadataResult>() {
			public DomainMetadataResult call() throws Exception {
				try {
					DomainMetadataResult result = domainMetadata(domainMetadataRequest);
					asyncHandler.handleResult(result, domainMetadataRequest);
					return result;
				} catch (Exception ex) {
					asyncHandler.handleException(ex);
					throw ex;
