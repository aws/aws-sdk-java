...
public class InvalidOriginExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public InvalidOriginExceptionUnmarshaller() {
        super(InvalidOriginException.class);
    }
