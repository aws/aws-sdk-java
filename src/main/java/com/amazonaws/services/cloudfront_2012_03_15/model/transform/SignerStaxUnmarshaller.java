 ...
 */
public class SignerStaxUnmarshaller implements Unmarshaller<Signer, StaxUnmarshallerContext> {
    ...
    public Signer unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return signer;
    ...
    public static SignerStaxUnmarshaller getInstance() {
        if (instance == null) instance = new SignerStaxUnmarshaller();
        return instance;
    }
}
