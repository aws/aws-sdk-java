...
/**
 * List Identity Pools Result JSON Unmarshaller
 */
public class ListIdentityPoolsResultJsonUnmarshaller implements Unmarshaller<ListIdentityPoolsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityPools", targetDepth)) {
                    context.nextToken();
                    listIdentityPoolsResult.setIdentityPools(new ListUnmarshaller<IdentityPoolShortDescription>(IdentityPoolShortDescriptionJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listIdentityPoolsResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ListIdentityPoolsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListIdentityPoolsResultJsonUnmarshaller();
        return instance;
    }
}
