...
public class CreateDomainResultStaxUnmarshaller implements Unmarshaller<CreateDomainResult, StaxUnmarshallerContext> {
    ...
    public CreateDomainResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createDomainResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("DomainStatus", targetDepth)) {
                    createDomainResult.setDomainStatus(DomainStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CreateDomainResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateDomainResultStaxUnmarshaller();
        return instance;
    }
}
