...
/**
 * Update Availability Options Result StAX Unmarshaller
 */
public class UpdateAvailabilityOptionsResultStaxUnmarshaller implements Unmarshaller<UpdateAvailabilityOptionsResult, StaxUnmarshallerContext> {
    ...
    public UpdateAvailabilityOptionsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return updateAvailabilityOptionsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("AvailabilityOptions", targetDepth)) {
                    updateAvailabilityOptionsResult.setAvailabilityOptions(AvailabilityOptionsStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static UpdateAvailabilityOptionsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateAvailabilityOptionsResultStaxUnmarshaller();
        return instance;
    }
}
