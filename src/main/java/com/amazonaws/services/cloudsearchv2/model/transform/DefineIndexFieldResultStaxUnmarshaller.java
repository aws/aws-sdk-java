...
public class DefineIndexFieldResultStaxUnmarshaller implements Unmarshaller<DefineIndexFieldResult, StaxUnmarshallerContext> {
    ...
    public DefineIndexFieldResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return defineIndexFieldResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("IndexField", targetDepth)) {
                    defineIndexFieldResult.setIndexField(IndexFieldStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DefineIndexFieldResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DefineIndexFieldResultStaxUnmarshaller();
        return instance;
    }
}
