...
public class DeleteAnalysisSchemeRequestMarshaller implements Marshaller<Request<DeleteAnalysisSchemeRequest>, DeleteAnalysisSchemeRequest> {
    ...
    public Request<DeleteAnalysisSchemeRequest> marshall(DeleteAnalysisSchemeRequest deleteAnalysisSchemeRequest) {
        ...
        Request<DeleteAnalysisSchemeRequest> request = new DefaultRequest<DeleteAnalysisSchemeRequest>(deleteAnalysisSchemeRequest, "AmazonCloudSearchv2");
        request.addParameter("Action", "DeleteAnalysisScheme");
        request.addParameter("Version", "2013-01-01");

        if (deleteAnalysisSchemeRequest.getDomainName() != null) {
            request.addParameter("DomainName", StringUtils.fromString(deleteAnalysisSchemeRequest.getDomainName()));
        }
        if (deleteAnalysisSchemeRequest.getAnalysisSchemeName() != null) {
            request.addParameter("AnalysisSchemeName", StringUtils.fromString(deleteAnalysisSchemeRequest.getAnalysisSchemeName()));
        }
