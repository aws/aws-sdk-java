...
public class Subnet {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (subnetIdentifier != null) sb.append("SubnetIdentifier: " + subnetIdentifier + ", ");
        if (subnetAvailabilityZone != null) sb.append("SubnetAvailabilityZone: " + subnetAvailabilityZone + ", ");
        if (subnetStatus != null) sb.append("SubnetStatus: " + subnetStatus + ", ");
        sb.append("}");
        return sb.toString();
    }
