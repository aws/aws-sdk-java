...
public class DescribeDBInstancesResultStaxUnmarshaller implements Unmarshaller<DescribeDBInstancesResult, StaxUnmarshallerContext> {
    ...
    public DescribeDBInstancesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeDBInstancesResult;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DBInstances/DBInstance", targetDepth)) {
                    describeDBInstancesResult.getDBInstances().add(DBInstanceStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeDBInstancesResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeDBInstancesResultStaxUnmarshaller();
        return instance;
    }
}
