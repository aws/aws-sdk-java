...
public class DescribeDBSubnetGroupsRequest extends AmazonWebServiceRequest {
    ...
    /**
     * An optional marker provided in the previous DescribeDBSubnetGroups
     ...
     * <code>MaxRecords</code>.
     *
     * @return An optional marker provided in the previous DescribeDBSubnetGroups
     *         request. If this parameter is specified, the response includes only
     *         records beyond the marker, up to the value specified by
     *         <code>MaxRecords</code>.
     */
     ...
     * <code>MaxRecords</code>.
     *
     * @param marker An optional marker provided in the previous DescribeDBSubnetGroups
     *         request. If this parameter is specified, the response includes only
     *         records beyond the marker, up to the value specified by
     *         <code>MaxRecords</code>.
     */
