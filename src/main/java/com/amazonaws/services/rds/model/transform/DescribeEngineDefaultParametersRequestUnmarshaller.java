...
public class DescribeEngineDefaultParametersRequestUnmarshaller implements Unmarshaller<DescribeEngineDefaultParametersRequest, Node> {
    ...
    public DescribeEngineDefaultParametersRequest unmarshall(Node node) throws Exception {
        ...
        describeEngineDefaultParametersRequest.setMaxRecords(new IntegerUnmarshaller().unmarshall(maxRecordsNode));
    
        Node markerNode = XpathUtils.asNode("Marker", node);
        describeEngineDefaultParametersRequest.setMarker(new StringUnmarshaller().unmarshall(markerNode));
