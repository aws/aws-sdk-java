...
/**
 * Domain Summary JSON Unmarshaller
 */
public class DomainSummaryJsonUnmarshaller implements Unmarshaller<DomainSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DomainName", targetDepth)) {
                    context.nextToken();
                    domainSummary.setDomainName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("AutoRenew", targetDepth)) {
                    context.nextToken();
                    domainSummary.setAutoRenew(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("TransferLock", targetDepth)) {
                    context.nextToken();
                    domainSummary.setTransferLock(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Expiry", targetDepth)) {
                    context.nextToken();
                    domainSummary.setExpiry(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DomainSummaryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DomainSummaryJsonUnmarshaller();
        return instance;
    }
}
