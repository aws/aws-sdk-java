...
public class TLDRulesViolationExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("TLDRulesViolation"));
        } else {
            return errorTypeFromHeader.equals("TLDRulesViolation");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        TLDRulesViolationException e = (TLDRulesViolationException)super.unmarshall(json);
        e.setErrorCode("TLDRulesViolation");
