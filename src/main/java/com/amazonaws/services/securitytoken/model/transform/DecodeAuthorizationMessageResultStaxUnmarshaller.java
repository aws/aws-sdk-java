...
public class DecodeAuthorizationMessageResultStaxUnmarshaller implements Unmarshaller<DecodeAuthorizationMessageResult, StaxUnmarshallerContext> {
    ...
    public DecodeAuthorizationMessageResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return decodeAuthorizationMessageResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("DecodedMessage", targetDepth)) {
                    decodeAuthorizationMessageResult.setDecodedMessage(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DecodeAuthorizationMessageResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DecodeAuthorizationMessageResultStaxUnmarshaller();
        return instance;
    }
}
