...
public class ListVerifiedEmailAddressesResultStaxUnmarshaller implements Unmarshaller<ListVerifiedEmailAddressesResult, StaxUnmarshallerContext> {
    ...
    public ListVerifiedEmailAddressesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return listVerifiedEmailAddressesResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("VerifiedEmailAddresses/member", targetDepth)) {
                    listVerifiedEmailAddressesResult.getVerifiedEmailAddresses().add(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ListVerifiedEmailAddressesResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ListVerifiedEmailAddressesResultStaxUnmarshaller();
        return instance;
    }
}
