...
/**
 * Search Status JSON Unmarshaller
 */
public class SearchStatusJsonUnmarshaller implements Unmarshaller<SearchStatus, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("timems", targetDepth)) {
                    context.nextToken();
                    searchStatus.setTimems(LongJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("rid", targetDepth)) {
                    context.nextToken();
                    searchStatus.setRid(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static SearchStatusJsonUnmarshaller getInstance() {
        if (instance == null) instance = new SearchStatusJsonUnmarshaller();
        return instance;
    }
}
