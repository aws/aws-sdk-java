...
public class CompleteMultipartUploadRetryCondition implements RetryPolicy.RetryCondition {
    ...
    private final CompleteMultipartUploadRetryablePredicate completeMultipartRetryablePredicate;
    ...
    CompleteMultipartUploadRetryCondition(CompleteMultipartUploadRetryablePredicate predicate,
