 ...
 */
public class CaptionsJsonUnmarshaller implements Unmarshaller<Captions, JsonUnmarshallerContext> {

    public Captions unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MergePolicy", targetDepth)) {
                    context.nextToken();
                    captions.setMergePolicy(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CaptionsJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CaptionsJsonUnmarshaller();
        return instance;
    }
}
