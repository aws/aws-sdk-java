...
/**
 * Caption Source JSON Unmarshaller
 */
public class CaptionSourceJsonUnmarshaller implements Unmarshaller<CaptionSource, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    captionSource.setKey(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Language", targetDepth)) {
                    context.nextToken();
                    captionSource.setLanguage(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("TimeOffset", targetDepth)) {
                    context.nextToken();
                    captionSource.setTimeOffset(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CaptionSourceJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CaptionSourceJsonUnmarshaller();
        return instance;
    }
}
