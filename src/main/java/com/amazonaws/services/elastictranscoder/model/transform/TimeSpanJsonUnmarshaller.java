...
public class TimeSpanJsonUnmarshaller implements Unmarshaller<TimeSpan, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StartTime", targetDepth)) {
                    context.nextToken();
                    timeSpan.setStartTime(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Duration", targetDepth)) {
                    context.nextToken();
                    timeSpan.setDuration(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static TimeSpanJsonUnmarshaller getInstance() {
        if (instance == null) instance = new TimeSpanJsonUnmarshaller();
        return instance;
    }
}
