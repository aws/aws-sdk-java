...
/**
 * Enter Standby Request Marshaller
 */
public class EnterStandbyRequestMarshaller implements Marshaller<Request<EnterStandbyRequest>, EnterStandbyRequest> {
    ...
    public Request<EnterStandbyRequest> marshall(EnterStandbyRequest enterStandbyRequest) {
        ...
        java.util.List<String> instanceIdsList = enterStandbyRequest.getInstanceIds();
        ...
        if (enterStandbyRequest.isShouldDecrementDesiredCapacity() != null) {
            request.addParameter("ShouldDecrementDesiredCapacity", StringUtils.fromBoolean(enterStandbyRequest.isShouldDecrementDesiredCapacity()));
        }
