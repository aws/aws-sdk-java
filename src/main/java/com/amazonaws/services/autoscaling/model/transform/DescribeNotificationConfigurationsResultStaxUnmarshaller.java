...
public class DescribeNotificationConfigurationsResultStaxUnmarshaller implements Unmarshaller<DescribeNotificationConfigurationsResult, StaxUnmarshallerContext> {
    ...
    public DescribeNotificationConfigurationsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeNotificationConfigurationsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("NotificationConfigurations/member", targetDepth)) {
                    describeNotificationConfigurationsResult.getNotificationConfigurations().add(NotificationConfigurationStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    describeNotificationConfigurationsResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeNotificationConfigurationsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeNotificationConfigurationsResultStaxUnmarshaller();
        return instance;
    }
}
