...
public class MetricCollectionTypeStaxUnmarshaller implements Unmarshaller<MetricCollectionType, StaxUnmarshallerContext> {
    ...
    public MetricCollectionType unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return metricCollectionType;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("Metric", targetDepth)) {
                    metricCollectionType.setMetric(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static MetricCollectionTypeStaxUnmarshaller getInstance() {
        if (instance == null) instance = new MetricCollectionTypeStaxUnmarshaller();
        return instance;
    }
}
