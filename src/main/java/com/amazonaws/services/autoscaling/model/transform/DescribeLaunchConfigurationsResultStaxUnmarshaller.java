...
public class DescribeLaunchConfigurationsResultStaxUnmarshaller implements Unmarshaller<DescribeLaunchConfigurationsResult, StaxUnmarshallerContext> {
    ...
    public DescribeLaunchConfigurationsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeLaunchConfigurationsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("LaunchConfigurations/member", targetDepth)) {
                    describeLaunchConfigurationsResult.getLaunchConfigurations().add(LaunchConfigurationStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeLaunchConfigurationsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeLaunchConfigurationsResultStaxUnmarshaller();
        return instance;
    }
}
