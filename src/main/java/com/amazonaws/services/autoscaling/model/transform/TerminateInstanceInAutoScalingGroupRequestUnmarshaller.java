...
public class TerminateInstanceInAutoScalingGroupRequestUnmarshaller implements Unmarshaller<TerminateInstanceInAutoScalingGroupRequest, Node> {
    ...
    public TerminateInstanceInAutoScalingGroupRequest unmarshall(Node node) throws Exception {
        ...
        Node shouldDecrementDesiredCapacityNode = XpathUtils.asNode("ShouldDecrementDesiredCapacity", node);
        terminateInstanceInAutoScalingGroupRequest.setShouldDecrementDesiredCapacity(new BooleanUnmarshaller().unmarshall(shouldDecrementDesiredCapacityNode));
