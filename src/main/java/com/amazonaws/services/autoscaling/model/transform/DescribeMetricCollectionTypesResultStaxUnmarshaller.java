...
public class DescribeMetricCollectionTypesResultStaxUnmarshaller implements Unmarshaller<DescribeMetricCollectionTypesResult, StaxUnmarshallerContext> {
    ...
    public DescribeMetricCollectionTypesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("Metrics/member", targetDepth)) {
                    describeMetricCollectionTypesResult.getMetrics().add(MetricCollectionTypeStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Granularities/member", targetDepth)) {
                    describeMetricCollectionTypesResult.getGranularities().add(MetricGranularityTypeStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeMetricCollectionTypesResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeMetricCollectionTypesResultStaxUnmarshaller();
        return instance;
    }
}
