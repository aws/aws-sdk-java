 ...
 * load balancer when the instances are launched. If you suspend this
 ...
 * from Amazon CloudWatch alarms that are associated with the Auto
 * Scaling group. If you suspend the <code>AlarmNotification</code>
 * process type, Auto Scaling will not automatically execute scaling
 * policies that would be triggered by alarms.
 * </p>
 * <p>
 * Although the <code>AlarmNotification</code> process type is not
 * directly affected by a suspension of <code>Launch</code> or
 * <code>Terminate</code> ,
 ...
 * <code>Launch</code> or <code>Terminate</code> , Auto Scaling might not
 ...
 * type, the AZRebalance process will neither launch new instances nor
 ...
 * instances. If you call SuspendProcesses on the terminate process type,
 * the AZRebalance process can cause your Auto Scaling group to grow up
 * to ten percent larger than the maximum size. This is because Auto
 * Scaling allows groups to temporarily grow larger than the maximum size
 * during rebalancing activities. If Auto Scaling cannot terminate
 * instances, your Auto Scaling group could remain up to ten percent
 * larger than the maximum size until you resume the terminate process
 * type.
 * </p>
 * <p>
 * The <code>HealthCheck</code> process type checks the health of the
 ...
 * unhealthy. The <code>HealthCheck</code> process can override the
 * health status of an instance that you set with SetInstanceHealth.
 * </p>
 * <p>
 * The <code>ReplaceUnhealthy</code> process type terminates instances
 ...
 * with the ReplaceUnhealthly process type to provide health check
 * functionality. If you suspend either Launch or Terminate, the
 * ReplaceUnhealthy process type will not function properly.
 * </p>
 * <p>
 * The <code>ScheduledActions</code> process type performs scheduled
 ...
 * instances. If you suspend either <code>Launch</code> or
 * <code>Terminate</code> , your scheduled actions might not function as
 * expected.
 * </p>
 */
