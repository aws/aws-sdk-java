...
public class MetricGranularityTypeStaxUnmarshaller implements Unmarshaller<MetricGranularityType, StaxUnmarshallerContext> {
    ...
    public MetricGranularityType unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return metricGranularityType;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("Granularity", targetDepth)) {
                    metricGranularityType.setGranularity(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static MetricGranularityTypeStaxUnmarshaller getInstance() {
        if (instance == null) instance = new MetricGranularityTypeStaxUnmarshaller();
        return instance;
    }
}
