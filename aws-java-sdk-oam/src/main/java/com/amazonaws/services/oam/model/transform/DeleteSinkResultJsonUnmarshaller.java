...
/**
 * DeleteSinkResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteSinkResultJsonUnmarshaller implements Unmarshaller<DeleteSinkResult, JsonUnmarshallerContext> {

    public DeleteSinkResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSinkResult deleteSinkResult = new DeleteSinkResult();
