...
public class CreateLinkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The label that you assigned to this link. If the <code>labelTemplate</code> includes variables, this field
     ...
     * </p>
     * 
     * @return The ARN of the link that is newly created.
     */
    ...
    public CreateLinkResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreateLinkResult withId(String id) {
        setId(id);
        return this;
    }
     ...
     * </p>
     * 
     * @return The label that you assigned to this link. If the <code>labelTemplate</code> includes variables, this
     ...
     * </p>
     * 
     * @return The exact label template that you specified, with the variables not resolved.
     */
    ...
    public CreateLinkResult withResourceTypes(String... resourceTypes) {
    ...
    public CreateLinkResult withResourceTypes(java.util.Collection<String> resourceTypes) {
    ...
    public CreateLinkResult withSinkArn(String sinkArn) {
        setSinkArn(sinkArn);
        return this;
    }
    ...
    public CreateLinkResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateLinkResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateLinkResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateLinkResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
