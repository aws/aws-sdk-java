 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/oam-2022-06-10/ListSinksItem" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSinksItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSinksItem == false)
            return false;
        ListSinksItem other = (ListSinksItem) obj;
    ...
    public ListSinksItem clone() {
        try {
            return (ListSinksItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.oam.model.transform.ListSinksItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
