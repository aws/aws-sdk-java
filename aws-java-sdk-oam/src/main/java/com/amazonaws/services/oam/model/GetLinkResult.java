...
public class GetLinkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetLinkResult withResourceTypes(String... resourceTypes) {
    ...
    public GetLinkResult withResourceTypes(java.util.Collection<String> resourceTypes) {
    ...
    public GetLinkResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see GetLinkResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetLinkResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetLinkResult == false)
            return false;
        GetLinkResult other = (GetLinkResult) obj;
