...
/**
 * CreateLinkResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateLinkResultJsonUnmarshaller implements Unmarshaller<CreateLinkResult, JsonUnmarshallerContext> {

    public CreateLinkResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateLinkResult createLinkResult = new CreateLinkResult();
    ...
    private static CreateLinkResultJsonUnmarshaller instance;

    public static CreateLinkResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateLinkResultJsonUnmarshaller();
        return instance;
    }
}
