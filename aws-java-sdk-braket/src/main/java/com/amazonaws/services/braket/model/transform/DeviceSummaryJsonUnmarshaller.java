        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("deviceType", targetDepth)) {
                    context.nextToken();
                    deviceSummary.setDeviceType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("providerName", targetDepth)) {
                    context.nextToken();
                    deviceSummary.setProviderName(context.getUnmarshaller(String.class).unmarshall(context));
                }
