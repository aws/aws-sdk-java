...
public class SearchJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<SearchJobsFilter> filters;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The filter values to use when searching for a job.
     */

    public java.util.List<SearchJobsFilter> getFilters() {
        return filters;
    }
    ...
    public void setFilters(java.util.Collection<SearchJobsFilter> filters) {
        if (filters == null) {
            this.filters = null;
            return;
        }

        this.filters = new java.util.ArrayList<SearchJobsFilter>(filters);
    }
    ...
    public SearchJobsRequest withFilters(SearchJobsFilter... filters) {
        if (this.filters == null) {
            setFilters(new java.util.ArrayList<SearchJobsFilter>(filters.length));
        }
        for (SearchJobsFilter ele : filters) {
    ...
    public SearchJobsRequest withFilters(java.util.Collection<SearchJobsFilter> filters) {
        setFilters(filters);
        return this;
    }
