...
/**
 * DeleteBotVersionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteBotVersionRequestMarshaller {
    ...
    private static final DeleteBotVersionRequestMarshaller instance = new DeleteBotVersionRequestMarshaller();

    public static DeleteBotVersionRequestMarshaller getInstance() {
        return instance;
    }
