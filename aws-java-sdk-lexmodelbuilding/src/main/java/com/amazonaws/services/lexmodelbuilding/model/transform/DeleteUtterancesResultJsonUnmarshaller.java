...
/**
 * DeleteUtterancesResult JSON Unmarshaller
 */
...
public class DeleteUtterancesResultJsonUnmarshaller implements Unmarshaller<DeleteUtterancesResult, JsonUnmarshallerContext> {
    ...
    public DeleteUtterancesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteUtterancesResult deleteUtterancesResult = new DeleteUtterancesResult();
