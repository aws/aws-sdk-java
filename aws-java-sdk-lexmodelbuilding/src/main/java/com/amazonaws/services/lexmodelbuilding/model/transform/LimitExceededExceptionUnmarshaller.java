...
public class LimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.lexmodelbuilding.model.LimitExceededException> {
    private LimitExceededExceptionUnmarshaller() {
        super("LimitExceededException");
    }

    @Override
    public com.amazonaws.services.lexmodelbuilding.model.LimitExceededException unmarshall(JsonUnmarshallerContext context) throws Exception {
