...
/**
 * DeleteIntentResult JSON Unmarshaller
 */
...
public class DeleteIntentResultJsonUnmarshaller implements Unmarshaller<DeleteIntentResult, JsonUnmarshallerContext> {
    ...
    public DeleteIntentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteIntentResult deleteIntentResult = new DeleteIntentResult();
