...
/**
 * UtteranceList JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UtteranceListJsonUnmarshaller implements Unmarshaller<UtteranceList, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("botVersion", targetDepth)) {
                    context.nextToken();
                    utteranceList.setBotVersion(context.getUnmarshaller(String.class).unmarshall(context));
                }
