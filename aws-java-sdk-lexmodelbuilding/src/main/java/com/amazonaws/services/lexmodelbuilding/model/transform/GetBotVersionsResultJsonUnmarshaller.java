...
/**
 * GetBotVersionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetBotVersionsResultJsonUnmarshaller implements Unmarshaller<GetBotVersionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("bots", targetDepth)) {
                    context.nextToken();
                    getBotVersionsResult.setBots(new ListUnmarshaller<BotMetadata>(BotMetadataJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    getBotVersionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
