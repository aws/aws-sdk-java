...
@SdkInternalApi
public class GetIntentRequestMarshaller {
    ...
    private static final GetIntentRequestMarshaller instance = new GetIntentRequestMarshaller();

    public static GetIntentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetIntentRequest getIntentRequest, ProtocolMarshaller protocolMarshaller) {
