...
/**
 * DeleteSlotTypeVersionResult JSON Unmarshaller
 */
...
public class DeleteSlotTypeVersionResultJsonUnmarshaller implements Unmarshaller<DeleteSlotTypeVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteSlotTypeVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSlotTypeVersionResult deleteSlotTypeVersionResult = new DeleteSlotTypeVersionResult();
