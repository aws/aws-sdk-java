...
public class SourceConfigurationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> APPINTEGRATIONS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("appIntegrations").build();
    ...
    public void marshall(SourceConfiguration sourceConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sourceConfiguration.getAppIntegrations(), APPINTEGRATIONS_BINDING);
        } catch (Exception e) {
