 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/wisdom-2020-10-19/QuickResponseData" target="_top">AWS API
 *      Documentation</a>
 */
...
public class QuickResponseData implements Serializable, Cloneable, StructuredPojo {
    ...
    public QuickResponseData withChannels(java.util.Collection<String> channels) {
    ...
    public QuickResponseData withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connectwisdom.model.transform.QuickResponseDataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
