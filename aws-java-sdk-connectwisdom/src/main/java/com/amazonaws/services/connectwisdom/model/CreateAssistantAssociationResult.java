...
public class CreateAssistantAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateAssistantAssociationResult withAssistantAssociation(AssistantAssociationData assistantAssociation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAssistantAssociationResult == false)
            return false;
        CreateAssistantAssociationResult other = (CreateAssistantAssociationResult) obj;
    ...
    @Override
    public CreateAssistantAssociationResult clone() {
        try {
            return (CreateAssistantAssociationResult) super.clone();
