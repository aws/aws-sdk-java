...
@SdkInternalApi
public class ContentSummaryMarshaller {
    ...
    private static final ContentSummaryMarshaller instance = new ContentSummaryMarshaller();

    public static ContentSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ContentSummary contentSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(contentSummary.getContentArn(), CONTENTARN_BINDING);
            protocolMarshaller.marshall(contentSummary.getContentId(), CONTENTID_BINDING);
            protocolMarshaller.marshall(contentSummary.getContentType(), CONTENTTYPE_BINDING);
            protocolMarshaller.marshall(contentSummary.getKnowledgeBaseArn(), KNOWLEDGEBASEARN_BINDING);
            protocolMarshaller.marshall(contentSummary.getKnowledgeBaseId(), KNOWLEDGEBASEID_BINDING);
            protocolMarshaller.marshall(contentSummary.getMetadata(), METADATA_BINDING);
            protocolMarshaller.marshall(contentSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(contentSummary.getRevisionId(), REVISIONID_BINDING);
            protocolMarshaller.marshall(contentSummary.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(contentSummary.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(contentSummary.getTitle(), TITLE_BINDING);
        } catch (Exception e) {
