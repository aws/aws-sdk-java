...
public class ListQuickResponsesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListQuickResponsesRequest withKnowledgeBaseId(String knowledgeBaseId) {
    ...
    public ListQuickResponsesRequest withMaxResults(Integer maxResults) {
    ...
    public ListQuickResponsesRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListQuickResponsesRequest == false)
            return false;
        ListQuickResponsesRequest other = (ListQuickResponsesRequest) obj;
    ...
    @Override
    public ListQuickResponsesRequest clone() {
        return (ListQuickResponsesRequest) super.clone();
    }
