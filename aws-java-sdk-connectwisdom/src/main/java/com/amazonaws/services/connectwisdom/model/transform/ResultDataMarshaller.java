...
@SdkInternalApi
public class ResultDataMarshaller {
    ...
    private static final ResultDataMarshaller instance = new ResultDataMarshaller();

    public static ResultDataMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ResultData resultData, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resultData.getDocument(), DOCUMENT_BINDING);
            protocolMarshaller.marshall(resultData.getRelevanceScore(), RELEVANCESCORE_BINDING);
            protocolMarshaller.marshall(resultData.getResultId(), RESULTID_BINDING);
        } catch (Exception e) {
