...
/**
 * DeleteAssistantAssociationResult JSON Unmarshaller
 */
...
public class DeleteAssistantAssociationResultJsonUnmarshaller implements Unmarshaller<DeleteAssistantAssociationResult, JsonUnmarshallerContext> {
    ...
    public DeleteAssistantAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAssistantAssociationResult deleteAssistantAssociationResult = new DeleteAssistantAssociationResult();
