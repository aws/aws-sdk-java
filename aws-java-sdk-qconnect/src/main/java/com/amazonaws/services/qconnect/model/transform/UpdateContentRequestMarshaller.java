...
public class UpdateContentRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> REMOVEOVERRIDELINKOUTURI_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("removeOverrideLinkOutUri").build();
