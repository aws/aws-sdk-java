...
/**
 * OrConditionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OrConditionMarshaller {
    ...
    private static final OrConditionMarshaller instance = new OrConditionMarshaller();

    public static OrConditionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OrCondition orCondition, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(orCondition.getAndConditions(), ANDCONDITIONS_BINDING);
            protocolMarshaller.marshall(orCondition.getTagCondition(), TAGCONDITION_BINDING);
        } catch (Exception e) {
