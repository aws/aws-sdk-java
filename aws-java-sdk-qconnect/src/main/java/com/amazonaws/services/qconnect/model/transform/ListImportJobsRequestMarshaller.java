...
public class ListImportJobsRequestMarshaller {
    ...
    public void marshall(ListImportJobsRequest listImportJobsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listImportJobsRequest.getKnowledgeBaseId(), KNOWLEDGEBASEID_BINDING);
            protocolMarshaller.marshall(listImportJobsRequest.getMaxResults(), MAXRESULTS_BINDING);
