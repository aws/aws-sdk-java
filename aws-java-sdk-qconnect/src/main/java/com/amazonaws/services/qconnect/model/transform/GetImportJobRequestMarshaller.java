...
public class GetImportJobRequestMarshaller {
    ...
    public void marshall(GetImportJobRequest getImportJobRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getImportJobRequest.getImportJobId(), IMPORTJOBID_BINDING);
            protocolMarshaller.marshall(getImportJobRequest.getKnowledgeBaseId(), KNOWLEDGEBASEID_BINDING);
        } catch (Exception e) {
