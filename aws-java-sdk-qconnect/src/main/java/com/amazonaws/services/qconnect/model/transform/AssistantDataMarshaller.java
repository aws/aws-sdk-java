...
public class AssistantDataMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CAPABILITYCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public void marshall(AssistantData assistantData, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(assistantData.getCapabilityConfiguration(), CAPABILITYCONFIGURATION_BINDING);
