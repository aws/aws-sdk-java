...
public class ConfigurationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CONNECTCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("connectConfiguration").build();
    ...
    public void marshall(Configuration configuration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(configuration.getConnectConfiguration(), CONNECTCONFIGURATION_BINDING);
        } catch (Exception e) {
