...
public class UpdateSessionRequestMarshaller {
    ...
    public void marshall(UpdateSessionRequest updateSessionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateSessionRequest.getAssistantId(), ASSISTANTID_BINDING);
            protocolMarshaller.marshall(updateSessionRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateSessionRequest.getSessionId(), SESSIONID_BINDING);
            protocolMarshaller.marshall(updateSessionRequest.getTagFilter(), TAGFILTER_BINDING);
        } catch (Exception e) {
