...
public class StartImportJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartImportJobResult withImportJob(ImportJobData importJob) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartImportJobResult == false)
            return false;
        StartImportJobResult other = (StartImportJobResult) obj;
    ...
    @Override
    public StartImportJobResult clone() {
        try {
            return (StartImportJobResult) super.clone();
