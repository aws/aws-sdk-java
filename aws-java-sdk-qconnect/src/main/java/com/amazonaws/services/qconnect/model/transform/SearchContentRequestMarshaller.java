...
public class SearchContentRequestMarshaller {
    ...
    private static final SearchContentRequestMarshaller instance = new SearchContentRequestMarshaller();

    public static SearchContentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SearchContentRequest searchContentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(searchContentRequest.getKnowledgeBaseId(), KNOWLEDGEBASEID_BINDING);
            protocolMarshaller.marshall(searchContentRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(searchContentRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(searchContentRequest.getSearchExpression(), SEARCHEXPRESSION_BINDING);
        } catch (Exception e) {
