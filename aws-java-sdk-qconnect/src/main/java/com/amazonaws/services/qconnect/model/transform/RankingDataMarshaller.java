...
/**
 * RankingDataMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RankingDataMarshaller {
    ...
    private static final RankingDataMarshaller instance = new RankingDataMarshaller();

    public static RankingDataMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RankingData rankingData, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(rankingData.getRelevanceLevel(), RELEVANCELEVEL_BINDING);
            protocolMarshaller.marshall(rankingData.getRelevanceScore(), RELEVANCESCORE_BINDING);
        } catch (Exception e) {
