...
/**
 * Sort JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SortJsonUnmarshaller implements Unmarshaller<Sort, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("sortOrder", targetDepth)) {
                    context.nextToken();
                    sort.setSortOrder(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("sortField", targetDepth)) {
                    context.nextToken();
                    sort.setSortField(context.getUnmarshaller(String.class).unmarshall(context));
                }
