...
public class DeleteDbInstanceRequestMarshaller {
    ...
    private static final DeleteDbInstanceRequestMarshaller instance = new DeleteDbInstanceRequestMarshaller();

    public static DeleteDbInstanceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteDbInstanceRequest deleteDbInstanceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteDbInstanceRequest.getIdentifier(), IDENTIFIER_BINDING);
        } catch (Exception e) {
