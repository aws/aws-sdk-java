...
public class ListDbParameterGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDbParameterGroupsRequest withNextToken(String nextToken) {
    ...
    public ListDbParameterGroupsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDbParameterGroupsRequest == false)
            return false;
        ListDbParameterGroupsRequest other = (ListDbParameterGroupsRequest) obj;
    ...
    @Override
    public ListDbParameterGroupsRequest clone() {
        return (ListDbParameterGroupsRequest) super.clone();
    }
