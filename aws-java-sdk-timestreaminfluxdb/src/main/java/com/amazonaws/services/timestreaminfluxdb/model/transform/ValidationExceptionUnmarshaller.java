...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.timestreaminfluxdb.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.timestreaminfluxdb.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.timestreaminfluxdb.model.ValidationException validationException = new com.amazonaws.services.timestreaminfluxdb.model.ValidationException(
                null);
