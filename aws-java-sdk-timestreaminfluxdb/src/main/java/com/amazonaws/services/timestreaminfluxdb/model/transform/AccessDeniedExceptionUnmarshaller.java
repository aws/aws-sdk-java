...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.timestreaminfluxdb.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.timestreaminfluxdb.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.timestreaminfluxdb.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.timestreaminfluxdb.model.AccessDeniedException(
                null);
