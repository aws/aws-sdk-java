...
public class CreateDbInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateDbInstanceResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public CreateDbInstanceResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public CreateDbInstanceResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreateDbInstanceResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public CreateDbInstanceResult withStatus(Status status) {
    ...
    public CreateDbInstanceResult withEndpoint(String endpoint) {
    ...
    public CreateDbInstanceResult withDbInstanceType(String dbInstanceType) {
    ...
    public CreateDbInstanceResult withDbInstanceType(DbInstanceType dbInstanceType) {
    ...
    public CreateDbInstanceResult withDbStorageType(String dbStorageType) {
    ...
    public CreateDbInstanceResult withDbStorageType(DbStorageType dbStorageType) {
    ...
    public CreateDbInstanceResult withAllocatedStorage(Integer allocatedStorage) {
    ...
    public CreateDbInstanceResult withDeploymentType(String deploymentType) {
    ...
    public CreateDbInstanceResult withDeploymentType(DeploymentType deploymentType) {
    ...
    public CreateDbInstanceResult withVpcSubnetIds(String... vpcSubnetIds) {
    ...
    public CreateDbInstanceResult withVpcSubnetIds(java.util.Collection<String> vpcSubnetIds) {
    ...
    public CreateDbInstanceResult withPubliclyAccessible(Boolean publiclyAccessible) {
    ...
    public CreateDbInstanceResult withVpcSecurityGroupIds(String... vpcSecurityGroupIds) {
    ...
    public CreateDbInstanceResult withVpcSecurityGroupIds(java.util.Collection<String> vpcSecurityGroupIds) {
    ...
    public CreateDbInstanceResult withDbParameterGroupIdentifier(String dbParameterGroupIdentifier) {
    ...
    public CreateDbInstanceResult withAvailabilityZone(String availabilityZone) {
    ...
    public CreateDbInstanceResult withSecondaryAvailabilityZone(String secondaryAvailabilityZone) {
    ...
    public CreateDbInstanceResult withLogDeliveryConfiguration(LogDeliveryConfiguration logDeliveryConfiguration) {
    ...
    public CreateDbInstanceResult withInfluxAuthParametersSecretArn(String influxAuthParametersSecretArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDbInstanceResult == false)
            return false;
        CreateDbInstanceResult other = (CreateDbInstanceResult) obj;
    ...
    @Override
    public CreateDbInstanceResult clone() {
        try {
            return (CreateDbInstanceResult) super.clone();
