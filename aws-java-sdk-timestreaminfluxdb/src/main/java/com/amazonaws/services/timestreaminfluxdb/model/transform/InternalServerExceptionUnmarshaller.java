...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.timestreaminfluxdb.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.timestreaminfluxdb.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.timestreaminfluxdb.model.InternalServerException internalServerException = new com.amazonaws.services.timestreaminfluxdb.model.InternalServerException(
                null);
