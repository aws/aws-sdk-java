...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.timestreaminfluxdb.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.timestreaminfluxdb.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.timestreaminfluxdb.model.ThrottlingException throttlingException = new com.amazonaws.services.timestreaminfluxdb.model.ThrottlingException(
                null);
