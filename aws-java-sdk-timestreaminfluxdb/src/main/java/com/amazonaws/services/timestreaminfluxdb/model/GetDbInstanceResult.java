...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/timestream-influxdb-2023-01-27/GetDbInstance" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetDbInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetDbInstanceResult withVpcSubnetIds(java.util.Collection<String> vpcSubnetIds) {
    ...
    public GetDbInstanceResult withVpcSecurityGroupIds(java.util.Collection<String> vpcSecurityGroupIds) {
