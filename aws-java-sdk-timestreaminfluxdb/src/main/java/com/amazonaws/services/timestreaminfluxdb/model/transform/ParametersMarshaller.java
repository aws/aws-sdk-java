...
/**
 * ParametersMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ParametersMarshaller {

    private static final MarshallingInfo<StructuredPojo> INFLUXDBV2_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("InfluxDBv2").build();
    ...
    public void marshall(Parameters parameters, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(parameters.getInfluxDBv2(), INFLUXDBV2_BINDING);
        } catch (Exception e) {
