...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.timestreaminfluxdb.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.timestreaminfluxdb.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.timestreaminfluxdb.model.ConflictException conflictException = new com.amazonaws.services.timestreaminfluxdb.model.ConflictException(
                null);
