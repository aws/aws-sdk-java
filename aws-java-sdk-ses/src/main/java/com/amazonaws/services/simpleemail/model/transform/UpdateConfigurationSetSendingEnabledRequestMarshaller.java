...
public class UpdateConfigurationSetSendingEnabledRequestMarshaller implements
    ...
    public Request<UpdateConfigurationSetSendingEnabledRequest> marshall(UpdateConfigurationSetSendingEnabledRequest updateConfigurationSetSendingEnabledRequest) {
        ...
        if (updateConfigurationSetSendingEnabledRequest.getConfigurationSetName() != null) {
            request.addParameter("ConfigurationSetName", StringUtils.fromString(updateConfigurationSetSendingEnabledRequest.getConfigurationSetName()));
        }

        if (updateConfigurationSetSendingEnabledRequest.getEnabled() != null) {
            request.addParameter("Enabled", StringUtils.fromBoolean(updateConfigurationSetSendingEnabledRequest.getEnabled()));
        }
