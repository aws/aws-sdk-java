 ...
 */
public class VerifyEmailIdentityResultStaxUnmarshaller implements
        Unmarshaller<VerifyEmailIdentityResult, StaxUnmarshallerContext> {

    public VerifyEmailIdentityResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
