 ...
 */
public class GetIdentityDkimAttributesResultStaxUnmarshaller implements
        Unmarshaller<GetIdentityDkimAttributesResult, StaxUnmarshallerContext> {
    ...
    private static class DkimAttributesMapEntryUnmarshaller
        ...
        @Override
        public Entry<String, IdentityDkimAttributes> unmarshall(
            ...
            while (true) {
                ...
                if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                    ...
                    if (context.testExpression("value", targetDepth)) {
                        entry.setValue(IdentityDkimAttributesStaxUnmarshaller
    ...
    public GetIdentityDkimAttributesResult unmarshall(
            StaxUnmarshallerContext context) throws Exception {
