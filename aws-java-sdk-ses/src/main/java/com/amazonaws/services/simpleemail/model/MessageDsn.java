...
public class MessageDsn implements Serializable, Cloneable {
     ...
     *        as specified in <a href="https://tools.ietf.org/html/rfc3464">RFC
     ...
     * </p>
     * 
     * @return The reporting MTA that attempted to deliver the message,
     ...
     * </p>
     * 
     * @return When the message was received by the reporting mail transfer
     *         agent (MTA), in <a
