...
public class SendRawEmailResultStaxUnmarshaller implements Unmarshaller<SendRawEmailResult, StaxUnmarshallerContext> {
    ...
    public SendRawEmailResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return sendRawEmailResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("MessageId", targetDepth)) {
                    sendRawEmailResult.setMessageId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static SendRawEmailResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new SendRawEmailResultStaxUnmarshaller();
        return instance;
    }
}
