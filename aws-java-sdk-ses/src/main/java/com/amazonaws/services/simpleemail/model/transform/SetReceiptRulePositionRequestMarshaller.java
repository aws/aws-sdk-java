...
public class SetReceiptRulePositionRequestMarshaller
        implements
        Marshaller<Request<SetReceiptRulePositionRequest>, SetReceiptRulePositionRequest> {
    ...
    public Request<SetReceiptRulePositionRequest> marshall(
        ...
        Request<SetReceiptRulePositionRequest> request = new DefaultRequest<SetReceiptRulePositionRequest>(
        ...
        if (setReceiptRulePositionRequest.getRuleSetName() != null) {
            request.addParameter("RuleSetName", StringUtils
                    .fromString(setReceiptRulePositionRequest.getRuleSetName()));
        }

        if (setReceiptRulePositionRequest.getRuleName() != null) {
            request.addParameter("RuleName", StringUtils
                    .fromString(setReceiptRulePositionRequest.getRuleName()));
        }

        if (setReceiptRulePositionRequest.getAfter() != null) {
            request.addParameter("After", StringUtils
                    .fromString(setReceiptRulePositionRequest.getAfter()));
        }
