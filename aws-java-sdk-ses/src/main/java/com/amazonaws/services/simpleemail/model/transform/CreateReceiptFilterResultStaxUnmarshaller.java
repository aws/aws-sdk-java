 ...
 */
public class CreateReceiptFilterResultStaxUnmarshaller implements
        Unmarshaller<CreateReceiptFilterResult, StaxUnmarshallerContext> {

    public CreateReceiptFilterResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
