...
/**
 * Create Receipt Filter Result StAX Unmarshaller
 */
public class CreateReceiptFilterResultStaxUnmarshaller implements Unmarshaller<CreateReceiptFilterResult, StaxUnmarshallerContext> {
    ...
    public CreateReceiptFilterResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createReceiptFilterResult;
    ...
    public static CreateReceiptFilterResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateReceiptFilterResultStaxUnmarshaller();
        return instance;
    }
}
