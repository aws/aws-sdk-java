 ...
 */
public class ReceiptRuleSetMetadataStaxUnmarshaller implements
        Unmarshaller<ReceiptRuleSetMetadata, StaxUnmarshallerContext> {

    public ReceiptRuleSetMetadata unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Name", targetDepth)) {
                    receiptRuleSetMetadata.setName(StringStaxUnmarshaller
                ...
                if (context.testExpression("CreatedTimestamp", targetDepth)) {
                    receiptRuleSetMetadata
                            .setCreatedTimestamp(DateStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
