...
public class DescribeReceiptRuleResult implements Serializable, Cloneable {
     ...
     * Transport Layer Security (TLS) policy.
     *
     * @return A data structure that contains the specified receipt rule's name,
     *         actions, recipients, domains, enabled status, scan status, and
     *         Transport Layer Security (TLS) policy.
     */
     ...
     * Transport Layer Security (TLS) policy.
     *
     * @param rule A data structure that contains the specified receipt rule's name,
     *         actions, recipients, domains, enabled status, scan status, and
     *         Transport Layer Security (TLS) policy.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeReceiptRuleResult == false) return false;
