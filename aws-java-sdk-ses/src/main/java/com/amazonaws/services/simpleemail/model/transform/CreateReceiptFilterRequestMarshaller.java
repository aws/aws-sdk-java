...
public class CreateReceiptFilterRequestMarshaller
    ...
    public Request<CreateReceiptFilterRequest> marshall(
        ...
        Request<CreateReceiptFilterRequest> request = new DefaultRequest<CreateReceiptFilterRequest>(
        ...
        if (filter != null) {
            ...
            if (filter.getName() != null) {
                request.addParameter("Filter.Name",
                        StringUtils.fromString(filter.getName()));
            }
            ...
            if (ipFilter != null) {
                ...
                if (ipFilter.getPolicy() != null) {
                    request.addParameter("Filter.IpFilter.Policy",
                            StringUtils.fromString(ipFilter.getPolicy()));
                }

                if (ipFilter.getCidr() != null) {
                    request.addParameter("Filter.IpFilter.Cidr",
                            StringUtils.fromString(ipFilter.getCidr()));
                }
            }
        }
