 ...
 */
public class CreateReceiptRuleSetResultStaxUnmarshaller implements
        Unmarshaller<CreateReceiptRuleSetResult, StaxUnmarshallerContext> {

    public CreateReceiptRuleSetResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
