...
public class FromEmailAddressNotVerifiedExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("FromEmailAddressNotVerified"))
            return null;

        FromEmailAddressNotVerifiedException e = (FromEmailAddressNotVerifiedException) super.unmarshall(node);
        e.setFromEmailAddress(XpathUtils.asString(getErrorPropertyPath("FromEmailAddress"), node));
