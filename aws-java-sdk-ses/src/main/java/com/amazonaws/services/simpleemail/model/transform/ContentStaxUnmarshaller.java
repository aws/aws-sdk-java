 ...
 */
public class ContentStaxUnmarshaller implements
        Unmarshaller<Content, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Data", targetDepth)) {
                    content.setData(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }

                if (context.testExpression("Charset", targetDepth)) {
                    content.setCharset(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
