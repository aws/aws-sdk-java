...
public class GetIdentityVerificationAttributesResult implements Serializable,
    ...
    public void setVerificationAttributes(
        ...
        this.verificationAttributes = verificationAttributes == null ? null
                : new com.amazonaws.internal.SdkInternalMap<String, IdentityVerificationAttributes>(
    ...
    public GetIdentityVerificationAttributesResult addVerificationAttributesEntry(
            String key, IdentityVerificationAttributes value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getVerificationAttributes() == null
                ^ this.getVerificationAttributes() == null)
            return false;
        if (other.getVerificationAttributes() != null
                && other.getVerificationAttributes().equals(
                        this.getVerificationAttributes()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getVerificationAttributes() == null) ? 0
                        : getVerificationAttributes().hashCode());
        return hashCode;
    }
