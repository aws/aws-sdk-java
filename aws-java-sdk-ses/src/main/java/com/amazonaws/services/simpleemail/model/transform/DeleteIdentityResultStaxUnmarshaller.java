 ...
 */
public class DeleteIdentityResultStaxUnmarshaller implements
        Unmarshaller<DeleteIdentityResult, StaxUnmarshallerContext> {

    public DeleteIdentityResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
