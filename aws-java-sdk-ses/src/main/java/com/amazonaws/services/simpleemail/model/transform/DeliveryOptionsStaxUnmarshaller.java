        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("TlsPolicy", targetDepth)) {
                    deliveryOptions.setTlsPolicy(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
