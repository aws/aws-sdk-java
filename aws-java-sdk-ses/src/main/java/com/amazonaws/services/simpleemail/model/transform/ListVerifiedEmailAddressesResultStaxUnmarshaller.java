 ...
 */
public class ListVerifiedEmailAddressesResultStaxUnmarshaller implements
        Unmarshaller<ListVerifiedEmailAddressesResult, StaxUnmarshallerContext> {

    public ListVerifiedEmailAddressesResult unmarshall(
