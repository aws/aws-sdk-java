...
public class SendBounceRequestMarshaller implements
    ...
    public Request<SendBounceRequest> marshall(
        ...
        if (sendBounceRequest.getOriginalMessageId() != null) {
            request.addParameter("OriginalMessageId", StringUtils
                    .fromString(sendBounceRequest.getOriginalMessageId()));
        }

        if (sendBounceRequest.getBounceSender() != null) {
            request.addParameter("BounceSender",
                    StringUtils.fromString(sendBounceRequest.getBounceSender()));
        }

        if (sendBounceRequest.getExplanation() != null) {
            request.addParameter("Explanation",
                    StringUtils.fromString(sendBounceRequest.getExplanation()));
        }
        ...
        if (messageDsn != null) {
            ...
            if (messageDsn.getReportingMta() != null) {
                request.addParameter("MessageDsn.ReportingMta",
                        StringUtils.fromString(messageDsn.getReportingMta()));
            }

            if (messageDsn.getArrivalDate() != null) {
                request.addParameter("MessageDsn.ArrivalDate",
                        StringUtils.fromDate(messageDsn.getArrivalDate()));
            }
            ...
            if (!extensionFieldsList.isEmpty()
                    || !extensionFieldsList.isAutoConstruct()) {
                ...
                for (ExtensionField extensionFieldsListValue : extensionFieldsList) {
                    ...
                    if (extensionFieldsListValue.getName() != null) {
                        request.addParameter(
                                "MessageDsn.ExtensionFields.member."
                                        + extensionFieldsListIndex + ".Name",
                                StringUtils.fromString(extensionFieldsListValue
                                        .getName()));
                    }
                    ...
                    if (extensionFieldsListValue.getValue() != null) {
                        request.addParameter(
                                "MessageDsn.ExtensionFields.member."
                                        + extensionFieldsListIndex + ".Value",
                                StringUtils.fromString(extensionFieldsListValue
                                        .getValue()));
                    }
        ...
        if (!bouncedRecipientInfoListList.isEmpty()
                || !bouncedRecipientInfoListList.isAutoConstruct()) {
            ...
            for (BouncedRecipientInfo bouncedRecipientInfoListListValue : bouncedRecipientInfoListList) {
                ...
                if (bouncedRecipientInfoListListValue.getRecipient() != null) {
                    request.addParameter(
                            "BouncedRecipientInfoList.member."
                                    ...
                                    + ".Recipient",
                            StringUtils
                                    .fromString(bouncedRecipientInfoListListValue
                                            .getRecipient()));
                }
                ...
                RecipientDsnFields recipientDsnFields = bouncedRecipientInfoListListValue
                ...
                if (recipientDsnFields != null) {
                    ...
                    if (recipientDsnFields.getFinalRecipient() != null) {
                        request.addParameter("BouncedRecipientInfoList.member."
                                ...
                                StringUtils.fromString(recipientDsnFields
                                        .getFinalRecipient()));
                    }
                    ...
                    if (recipientDsnFields.getAction() != null) {
                        request.addParameter("BouncedRecipientInfoList.member."
                                + bouncedRecipientInfoListListIndex
                                + ".RecipientDsnFields.Action", StringUtils
                                .fromString(recipientDsnFields.getAction()));
                    }

                    if (recipientDsnFields.getRemoteMta() != null) {
                        request.addParameter("BouncedRecipientInfoList.member."
                                + bouncedRecipientInfoListListIndex
                                + ".RecipientDsnFields.RemoteMta", StringUtils
                                .fromString(recipientDsnFields.getRemoteMta()));
                    }

                    if (recipientDsnFields.getStatus() != null) {
                        request.addParameter("BouncedRecipientInfoList.member."
                                + bouncedRecipientInfoListListIndex
                                + ".RecipientDsnFields.Status", StringUtils
                                .fromString(recipientDsnFields.getStatus()));
                    }
                    ...
                    if (recipientDsnFields.getLastAttemptDate() != null) {
                        request.addParameter("BouncedRecipientInfoList.member."
                                ...
                                StringUtils.fromDate(recipientDsnFields
                                        .getLastAttemptDate()));
                    }
                        ...
                        for (ExtensionField extensionFieldsListValue : extensionFieldsList) {
                            ...
                            if (extensionFieldsListValue.getName() != null) {
                                request.addParameter(
                                        "BouncedRecipientInfoList.member."
                                                + bouncedRecipientInfoListListIndex
                                                + ".RecipientDsnFields.ExtensionFields.member."
                                                + extensionFieldsListIndex
                                                + ".Name",
                                        StringUtils
                                                .fromString(extensionFieldsListValue
                                                        .getName()));
                            }
        ...
        if (sendBounceRequest.getBounceSenderArn() != null) {
            request.addParameter("BounceSenderArn", StringUtils
                    .fromString(sendBounceRequest.getBounceSenderArn()));
        }
