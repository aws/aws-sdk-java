...
public class CustomVerificationEmailInvalidContentExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("CustomVerificationEmailInvalidContent"))
            return null;

        CustomVerificationEmailInvalidContentException e = (CustomVerificationEmailInvalidContentException) super.unmarshall(node);
