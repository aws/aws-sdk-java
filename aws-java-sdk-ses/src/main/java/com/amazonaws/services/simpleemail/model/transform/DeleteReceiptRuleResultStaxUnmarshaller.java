 ...
 */
public class DeleteReceiptRuleResultStaxUnmarshaller implements
        Unmarshaller<DeleteReceiptRuleResult, StaxUnmarshallerContext> {

    public DeleteReceiptRuleResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
