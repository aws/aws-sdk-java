 ...
 */
public class SendEmailResultStaxUnmarshaller implements
        Unmarshaller<SendEmailResult, StaxUnmarshallerContext> {

    public SendEmailResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("MessageId", targetDepth)) {
                    sendEmailResult.setMessageId(StringStaxUnmarshaller
