...
public class SendEmailResultStaxUnmarshaller implements Unmarshaller<SendEmailResult, StaxUnmarshallerContext> {
    ...
    public SendEmailResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return sendEmailResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("MessageId", targetDepth)) {
                    sendEmailResult.setMessageId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static SendEmailResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new SendEmailResultStaxUnmarshaller();
        return instance;
    }
}
