...
public class GetSendStatisticsResultStaxUnmarshaller implements
    ...
    public GetSendStatisticsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context
                        .testExpression("SendDataPoints/member", targetDepth)) {
                    getSendStatisticsResult
                            .withSendDataPoints(SendDataPointStaxUnmarshaller
