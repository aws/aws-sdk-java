...
@SdkInternalApi
public class GetIdentityVerificationAttributesFunction
        implements
    ...
    /**
     * Constructs a new GetIdentityVerificationAttributesFunction with the given
     * client
     * 
     * @param client
     *        Service client
     */
    public GetIdentityVerificationAttributesFunction(
     ...
     */
    @Override
    public GetIdentityVerificationAttributesResult apply(
