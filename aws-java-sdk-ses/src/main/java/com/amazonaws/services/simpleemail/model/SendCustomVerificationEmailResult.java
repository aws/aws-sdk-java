...
public class SendCustomVerificationEmailResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public SendCustomVerificationEmailResult clone() {
        try {
            return (SendCustomVerificationEmailResult) super.clone();
