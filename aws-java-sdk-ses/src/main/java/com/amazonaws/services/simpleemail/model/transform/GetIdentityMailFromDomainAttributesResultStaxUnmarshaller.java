 ...
 */
public class GetIdentityMailFromDomainAttributesResultStaxUnmarshaller
        implements
    ...
    public GetIdentityMailFromDomainAttributesResult unmarshall(
            StaxUnmarshallerContext context) throws Exception {
