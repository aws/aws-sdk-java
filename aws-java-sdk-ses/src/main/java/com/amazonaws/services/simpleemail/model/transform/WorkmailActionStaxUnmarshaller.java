 ...
 */
public class WorkmailActionStaxUnmarshaller implements
        Unmarshaller<WorkmailAction, StaxUnmarshallerContext> {

    public WorkmailAction unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("TopicArn", targetDepth)) {
                    workmailAction.setTopicArn(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("OrganizationArn", targetDepth)) {
                    workmailAction.setOrganizationArn(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
