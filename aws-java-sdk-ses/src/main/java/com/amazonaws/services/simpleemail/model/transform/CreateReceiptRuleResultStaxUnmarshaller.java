...
/**
 * Create Receipt Rule Result StAX Unmarshaller
 */
public class CreateReceiptRuleResultStaxUnmarshaller implements Unmarshaller<CreateReceiptRuleResult, StaxUnmarshallerContext> {
    ...
    public CreateReceiptRuleResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createReceiptRuleResult;
    ...
    public static CreateReceiptRuleResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateReceiptRuleResultStaxUnmarshaller();
        return instance;
    }
}
