 ...
 */
public class CreateReceiptRuleResultStaxUnmarshaller implements
        Unmarshaller<CreateReceiptRuleResult, StaxUnmarshallerContext> {

    public CreateReceiptRuleResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
