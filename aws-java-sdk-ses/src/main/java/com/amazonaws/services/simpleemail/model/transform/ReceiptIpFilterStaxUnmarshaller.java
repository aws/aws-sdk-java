 ...
 */
public class ReceiptIpFilterStaxUnmarshaller implements
        Unmarshaller<ReceiptIpFilter, StaxUnmarshallerContext> {

    public ReceiptIpFilter unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Policy", targetDepth)) {
                    receiptIpFilter.setPolicy(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Cidr", targetDepth)) {
                    receiptIpFilter.setCidr(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
