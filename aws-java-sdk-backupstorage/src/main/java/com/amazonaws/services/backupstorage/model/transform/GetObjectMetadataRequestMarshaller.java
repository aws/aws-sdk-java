...
public class GetObjectMetadataRequestMarshaller {
    ...
    private static final GetObjectMetadataRequestMarshaller instance = new GetObjectMetadataRequestMarshaller();

    public static GetObjectMetadataRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetObjectMetadataRequest getObjectMetadataRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getObjectMetadataRequest.getStorageJobId(), STORAGEJOBID_BINDING);
            protocolMarshaller.marshall(getObjectMetadataRequest.getObjectToken(), OBJECTTOKEN_BINDING);
        } catch (Exception e) {
