...
public class PutChunkRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable, SignerTypeAware {
    ...
    public PutChunkRequest withData(java.io.InputStream data) {
        setData(data);
        return this;
    }
    ...
    public PutChunkRequest withChecksumAlgorithm(String checksumAlgorithm) {
    ...
    public PutChunkRequest withChecksumAlgorithm(DataChecksumAlgorithm checksumAlgorithm) {
    ...
    public String toString() {
        ...
        if (getChunkIndex() != null)
            sb.append("ChunkIndex: ").append(getChunkIndex()).append(",");
        if (getData() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutChunkRequest == false)
            return false;
        ...
        if (other.getUploadId() != null && other.getUploadId().equals(this.getUploadId()) == false)
            return false;
        if (other.getChunkIndex() == null ^ this.getChunkIndex() == null)
            return false;
        if (other.getChunkIndex() != null && other.getChunkIndex().equals(this.getChunkIndex()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getChunkIndex() == null) ? 0 : getChunkIndex().hashCode());
    ...
    @Override
    public PutChunkRequest clone() {
        return (PutChunkRequest) super.clone();
    }
