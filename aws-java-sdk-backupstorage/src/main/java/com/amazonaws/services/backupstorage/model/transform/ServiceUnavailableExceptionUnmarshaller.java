...
public class ServiceUnavailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceUnavailableExceptionUnmarshaller() {
        super(com.amazonaws.services.backupstorage.model.ServiceUnavailableException.class, "ServiceUnavailableException");
    }

    @Override
    public com.amazonaws.services.backupstorage.model.ServiceUnavailableException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.backupstorage.model.ServiceUnavailableException serviceUnavailableException = new com.amazonaws.services.backupstorage.model.ServiceUnavailableException(
                null);
