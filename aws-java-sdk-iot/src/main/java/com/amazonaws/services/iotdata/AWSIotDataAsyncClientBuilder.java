...
/**
 * Fluent builder for {@link com.amazonaws.services.iotdata.AWSIotDataAsync}.
 * Use of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AWSIotDataAsyncClientBuilder extends
        AwsAsyncClientBuilder<AWSIotDataAsyncClientBuilder, AWSIotDataAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSIotDataAsync using the
