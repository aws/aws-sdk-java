...
public class ListViolationEventsRequestMarshaller {
    ...
    private static final ListViolationEventsRequestMarshaller instance = new ListViolationEventsRequestMarshaller();

    public static ListViolationEventsRequestMarshaller getInstance() {
        return instance;
    }
