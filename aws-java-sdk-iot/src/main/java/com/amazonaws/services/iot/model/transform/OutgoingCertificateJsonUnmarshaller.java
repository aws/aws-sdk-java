 ...
 */
public class OutgoingCertificateJsonUnmarshaller implements
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("certificateArn", targetDepth)) {
                    context.nextToken();
                    outgoingCertificate.setCertificateArn(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("certificateId", targetDepth)) {
                    context.nextToken();
                    outgoingCertificate.setCertificateId(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("transferredTo", targetDepth)) {
                    context.nextToken();
                    outgoingCertificate.setTransferredTo(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("transferDate", targetDepth)) {
                    context.nextToken();
                    outgoingCertificate.setTransferDate(context
                            .getUnmarshaller(java.util.Date.class).unmarshall(
                                    context));
                }
                if (context.testExpression("transferMessage", targetDepth)) {
                    context.nextToken();
                    outgoingCertificate.setTransferMessage(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("creationDate", targetDepth)) {
                    context.nextToken();
                    outgoingCertificate.setCreationDate(context
                            .getUnmarshaller(java.util.Date.class).unmarshall(
                                    context));
                }
