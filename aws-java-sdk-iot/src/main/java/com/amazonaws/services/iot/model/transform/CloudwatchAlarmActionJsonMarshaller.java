...
public class CloudwatchAlarmActionJsonMarshaller {
     ...
     */
    public void marshall(CloudwatchAlarmAction cloudwatchAlarmAction,
        ...
        try {
            ...
            if (cloudwatchAlarmAction.getRoleArn() != null) {
                jsonGenerator.writeFieldName("roleArn").writeValue(
                        cloudwatchAlarmAction.getRoleArn());
            }
            if (cloudwatchAlarmAction.getAlarmName() != null) {
                jsonGenerator.writeFieldName("alarmName").writeValue(
                        cloudwatchAlarmAction.getAlarmName());
            }
            if (cloudwatchAlarmAction.getStateReason() != null) {
                jsonGenerator.writeFieldName("stateReason").writeValue(
                        cloudwatchAlarmAction.getStateReason());
            }
            if (cloudwatchAlarmAction.getStateValue() != null) {
                jsonGenerator.writeFieldName("stateValue").writeValue(
                        cloudwatchAlarmAction.getStateValue());
            }
