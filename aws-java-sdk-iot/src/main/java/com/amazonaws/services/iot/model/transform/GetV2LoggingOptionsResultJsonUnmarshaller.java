...
/**
 * GetV2LoggingOptionsResult JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("roleArn", targetDepth)) {
                    context.nextToken();
                    getV2LoggingOptionsResult.setRoleArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("defaultLogLevel", targetDepth)) {
                    context.nextToken();
                    getV2LoggingOptionsResult.setDefaultLogLevel(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("disableAllLogs", targetDepth)) {
                    context.nextToken();
                    getV2LoggingOptionsResult.setDisableAllLogs(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
