...
/**
 * ListThingRegistrationTasksResult JSON Unmarshaller
 */
...
public class ListThingRegistrationTasksResultJsonUnmarshaller implements Unmarshaller<ListThingRegistrationTasksResult, JsonUnmarshallerContext> {
    ...
    public ListThingRegistrationTasksResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listThingRegistrationTasksResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
