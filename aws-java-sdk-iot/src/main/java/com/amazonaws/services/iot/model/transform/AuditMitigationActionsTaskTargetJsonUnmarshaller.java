...
/**
 * AuditMitigationActionsTaskTarget JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AuditMitigationActionsTaskTargetJsonUnmarshaller implements Unmarshaller<AuditMitigationActionsTaskTarget, JsonUnmarshallerContext> {

    public AuditMitigationActionsTaskTarget unmarshall(JsonUnmarshallerContext context) throws Exception {
