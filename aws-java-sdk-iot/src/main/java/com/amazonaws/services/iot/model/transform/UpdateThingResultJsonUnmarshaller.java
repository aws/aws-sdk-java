 ...
 */
public class UpdateThingResultJsonUnmarshaller implements
        Unmarshaller<UpdateThingResult, JsonUnmarshallerContext> {

    public UpdateThingResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
