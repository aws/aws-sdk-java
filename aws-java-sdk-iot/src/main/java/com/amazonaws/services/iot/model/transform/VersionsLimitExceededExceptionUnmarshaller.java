...
public class VersionsLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static VersionsLimitExceededExceptionUnmarshaller instance;

    public static VersionsLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new VersionsLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
