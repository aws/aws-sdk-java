            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("thingTypes", targetDepth)) {
                    ...
                    listThingTypesResult
                            .setThingTypes(new ListUnmarshaller<ThingTypeDefinition>(
                                    ThingTypeDefinitionJsonUnmarshaller
                                            .getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listThingTypesResult.setNextToken(context.getUnmarshaller(
