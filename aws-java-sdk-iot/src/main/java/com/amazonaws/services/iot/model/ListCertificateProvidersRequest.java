...
public class ListCertificateProvidersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * The token for the next set of results, or <code>null</code> if there are no more results.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The token for the next set of results, or <code>null</code> if there are no more results.
     */
    ...
    @Override
    public ListCertificateProvidersRequest clone() {
        return (ListCertificateProvidersRequest) super.clone();
    }
