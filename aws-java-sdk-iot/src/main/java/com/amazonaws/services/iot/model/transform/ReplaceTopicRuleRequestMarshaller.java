...
public class ReplaceTopicRuleRequestMarshaller {
    ...
    private static final ReplaceTopicRuleRequestMarshaller instance = new ReplaceTopicRuleRequestMarshaller();

    public static ReplaceTopicRuleRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(ReplaceTopicRuleRequest replaceTopicRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(replaceTopicRuleRequest.getRuleName(), RULENAME_BINDING);
            protocolMarshaller.marshall(replaceTopicRuleRequest.getTopicRulePayload(), TOPICRULEPAYLOAD_BINDING);
        } catch (Exception e) {
