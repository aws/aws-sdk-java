...
public class DeleteBillingGroupRequestMarshaller {
    ...
    private static final DeleteBillingGroupRequestMarshaller instance = new DeleteBillingGroupRequestMarshaller();

    public static DeleteBillingGroupRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteBillingGroupRequest deleteBillingGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteBillingGroupRequest.getBillingGroupName(), BILLINGGROUPNAME_BINDING);
            protocolMarshaller.marshall(deleteBillingGroupRequest.getExpectedVersion(), EXPECTEDVERSION_BINDING);
        } catch (Exception e) {
