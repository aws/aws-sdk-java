...
/**
 * ListBillingGroupsResult JSON Unmarshaller
 */
...
public class ListBillingGroupsResultJsonUnmarshaller implements Unmarshaller<ListBillingGroupsResult, JsonUnmarshallerContext> {
    ...
    public ListBillingGroupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listBillingGroupsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
