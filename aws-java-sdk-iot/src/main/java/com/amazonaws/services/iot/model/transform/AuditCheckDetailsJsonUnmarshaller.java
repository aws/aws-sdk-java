...
public class AuditCheckDetailsJsonUnmarshaller implements Unmarshaller<AuditCheckDetails, JsonUnmarshallerContext> {

    public AuditCheckDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
