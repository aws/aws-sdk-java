 ...
 */
public class DeleteTopicRuleResultJsonUnmarshaller implements
        Unmarshaller<DeleteTopicRuleResult, JsonUnmarshallerContext> {

    public DeleteTopicRuleResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
