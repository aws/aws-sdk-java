...
/**
 * IndexingFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IndexingFilterJsonUnmarshaller implements Unmarshaller<IndexingFilter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("namedShadowNames", targetDepth)) {
                    context.nextToken();
                    indexingFilter.setNamedShadowNames(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
