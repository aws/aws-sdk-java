...
public class TaskAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TaskAlreadyExistsExceptionUnmarshaller instance;

    public static TaskAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TaskAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
