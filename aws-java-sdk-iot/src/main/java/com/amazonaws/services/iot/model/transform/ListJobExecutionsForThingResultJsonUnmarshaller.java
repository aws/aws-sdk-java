...
/**
 * ListJobExecutionsForThingResult JSON Unmarshaller
 */
...
public class ListJobExecutionsForThingResultJsonUnmarshaller implements Unmarshaller<ListJobExecutionsForThingResult, JsonUnmarshallerContext> {
    ...
    public ListJobExecutionsForThingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("executionSummaries", targetDepth)) {
                    context.nextToken();
                    listJobExecutionsForThingResult.setExecutionSummaries(new ListUnmarshaller<JobExecutionSummaryForThing>(
                            JobExecutionSummaryForThingJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listJobExecutionsForThingResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
