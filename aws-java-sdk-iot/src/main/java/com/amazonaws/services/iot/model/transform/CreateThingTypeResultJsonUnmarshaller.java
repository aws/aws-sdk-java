 ...
 */
public class CreateThingTypeResultJsonUnmarshaller implements
        Unmarshaller<CreateThingTypeResult, JsonUnmarshallerContext> {

    public CreateThingTypeResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("thingTypeName", targetDepth)) {
                    context.nextToken();
                    createThingTypeResult.setThingTypeName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("thingTypeArn", targetDepth)) {
                    context.nextToken();
                    createThingTypeResult.setThingTypeArn(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
