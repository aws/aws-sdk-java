 ...
 */
public class DeletePolicyResultJsonUnmarshaller implements
        Unmarshaller<DeletePolicyResult, JsonUnmarshallerContext> {

    public DeletePolicyResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
