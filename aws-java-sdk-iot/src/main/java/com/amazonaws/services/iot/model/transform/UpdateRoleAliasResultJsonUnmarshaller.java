...
/**
 * UpdateRoleAliasResult JSON Unmarshaller
 */
...
public class UpdateRoleAliasResultJsonUnmarshaller implements Unmarshaller<UpdateRoleAliasResult, JsonUnmarshallerContext> {
    ...
    public UpdateRoleAliasResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("roleAlias", targetDepth)) {
                    context.nextToken();
                    updateRoleAliasResult.setRoleAlias(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("roleAliasArn", targetDepth)) {
                    context.nextToken();
                    updateRoleAliasResult.setRoleAliasArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
