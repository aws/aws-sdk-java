...
public class TransferCertificateResult implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getTransferredCertificateArn() != null)
            sb.append("TransferredCertificateArn: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTransferredCertificateArn() == null
            ...
            return false;
        if (other.getTransferredCertificateArn() != null
                && other.getTransferredCertificateArn().equals(
                        this.getTransferredCertificateArn()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getTransferredCertificateArn() == null) ? 0
                        : getTransferredCertificateArn().hashCode());
        return hashCode;
    }
