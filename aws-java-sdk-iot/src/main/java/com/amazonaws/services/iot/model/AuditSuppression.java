...
public class AuditSuppression implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AuditSuppression == false)
            return false;
    ...
    public AuditSuppression clone() {
        try {
            return (AuditSuppression) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iot.model.transform.AuditSuppressionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
