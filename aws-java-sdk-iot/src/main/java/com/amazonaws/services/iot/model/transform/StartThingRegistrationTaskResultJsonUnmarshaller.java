...
/**
 * StartThingRegistrationTaskResult JSON Unmarshaller
 */
...
public class StartThingRegistrationTaskResultJsonUnmarshaller implements Unmarshaller<StartThingRegistrationTaskResult, JsonUnmarshallerContext> {
    ...
    public StartThingRegistrationTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("taskId", targetDepth)) {
                    context.nextToken();
                    startThingRegistrationTaskResult.setTaskId(context.getUnmarshaller(String.class).unmarshall(context));
                }
