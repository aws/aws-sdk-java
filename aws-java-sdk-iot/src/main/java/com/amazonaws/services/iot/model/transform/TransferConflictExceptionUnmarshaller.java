...
public class TransferConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TransferConflictExceptionUnmarshaller instance;

    public static TransferConflictExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TransferConflictExceptionUnmarshaller();
        return instance;
    }
}
