...
/**
 * CreateProvisioningTemplateResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateProvisioningTemplateResultJsonUnmarshaller implements Unmarshaller<CreateProvisioningTemplateResult, JsonUnmarshallerContext> {

    public CreateProvisioningTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
