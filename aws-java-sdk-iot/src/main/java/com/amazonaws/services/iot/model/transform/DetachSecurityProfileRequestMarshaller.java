...
/**
 * DetachSecurityProfileRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DetachSecurityProfileRequestMarshaller {
    ...
    private static final DetachSecurityProfileRequestMarshaller instance = new DetachSecurityProfileRequestMarshaller();

    public static DetachSecurityProfileRequestMarshaller getInstance() {
        return instance;
    }
