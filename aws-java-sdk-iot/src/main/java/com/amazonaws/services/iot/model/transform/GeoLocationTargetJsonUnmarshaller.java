...
/**
 * GeoLocationTarget JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GeoLocationTargetJsonUnmarshaller implements Unmarshaller<GeoLocationTarget, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    geoLocationTarget.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("order", targetDepth)) {
                    context.nextToken();
                    geoLocationTarget.setOrder(context.getUnmarshaller(String.class).unmarshall(context));
                }
