...
@SdkInternalApi
public class CancelJobExecutionRequestMarshaller {
    ...
    private static final CancelJobExecutionRequestMarshaller instance = new CancelJobExecutionRequestMarshaller();

    public static CancelJobExecutionRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(CancelJobExecutionRequest cancelJobExecutionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(cancelJobExecutionRequest.getJobId(), JOBID_BINDING);
            protocolMarshaller.marshall(cancelJobExecutionRequest.getThingName(), THINGNAME_BINDING);
            protocolMarshaller.marshall(cancelJobExecutionRequest.getForce(), FORCE_BINDING);
            protocolMarshaller.marshall(cancelJobExecutionRequest.getExpectedVersion(), EXPECTEDVERSION_BINDING);
            protocolMarshaller.marshall(cancelJobExecutionRequest.getStatusDetails(), STATUSDETAILS_BINDING);
        } catch (Exception e) {
