...
public class InvalidQueryExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidQueryExceptionUnmarshaller instance;

    public static InvalidQueryExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidQueryExceptionUnmarshaller();
        return instance;
    }
}
