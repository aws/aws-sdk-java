        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("signingProfileParameter", targetDepth)) {
                    context.nextToken();
                    startSigningJobParameter.setSigningProfileParameter(SigningProfileParameterJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("signingProfileName", targetDepth)) {
                    context.nextToken();
                    startSigningJobParameter.setSigningProfileName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("destination", targetDepth)) {
                    context.nextToken();
                    startSigningJobParameter.setDestination(DestinationJsonUnmarshaller.getInstance().unmarshall(context));
                }
