...
/**
 * ListThingRegistrationTaskReportsResult JSON Unmarshaller
 */
...
public class ListThingRegistrationTaskReportsResultJsonUnmarshaller implements Unmarshaller<ListThingRegistrationTaskReportsResult, JsonUnmarshallerContext> {
    ...
    public ListThingRegistrationTaskReportsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("reportType", targetDepth)) {
                    context.nextToken();
                    listThingRegistrationTaskReportsResult.setReportType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listThingRegistrationTaskReportsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
