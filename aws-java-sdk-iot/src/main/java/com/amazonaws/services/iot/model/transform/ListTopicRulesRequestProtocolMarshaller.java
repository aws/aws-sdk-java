...
public class ListTopicRulesRequestProtocolMarshaller implements Marshaller<Request<ListTopicRulesRequest>, ListTopicRulesRequest> {
    ...
    public ListTopicRulesRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<ListTopicRulesRequest> marshall(ListTopicRulesRequest listTopicRulesRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<ListTopicRulesRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    listTopicRulesRequest);

            protocolMarshaller.startMarshalling();
            ListTopicRulesRequestMarshaller.getInstance().marshall(listTopicRulesRequest, protocolMarshaller);
