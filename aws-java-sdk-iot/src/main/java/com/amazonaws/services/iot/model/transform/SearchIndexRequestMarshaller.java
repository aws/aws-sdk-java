...
public class SearchIndexRequestMarshaller {
    ...
    private static final SearchIndexRequestMarshaller instance = new SearchIndexRequestMarshaller();

    public static SearchIndexRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SearchIndexRequest searchIndexRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(searchIndexRequest.getIndexName(), INDEXNAME_BINDING);
            protocolMarshaller.marshall(searchIndexRequest.getQueryString(), QUERYSTRING_BINDING);
            protocolMarshaller.marshall(searchIndexRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(searchIndexRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(searchIndexRequest.getQueryVersion(), QUERYVERSION_BINDING);
        } catch (Exception e) {
