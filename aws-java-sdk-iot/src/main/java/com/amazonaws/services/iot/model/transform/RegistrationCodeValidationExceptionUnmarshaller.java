...
public class RegistrationCodeValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RegistrationCodeValidationExceptionUnmarshaller instance;

    public static RegistrationCodeValidationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RegistrationCodeValidationExceptionUnmarshaller();
        return instance;
    }
}
