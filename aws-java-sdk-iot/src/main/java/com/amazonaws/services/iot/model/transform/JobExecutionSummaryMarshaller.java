...
public class JobExecutionSummaryMarshaller {
    ...
    private static final MarshallingInfo<java.util.Date> QUEUEDAT_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("queuedAt").build();
    ...
    public void marshall(JobExecutionSummary jobExecutionSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(jobExecutionSummary.getStatus(), STATUS_BINDING);
