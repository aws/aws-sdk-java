...
/**
 * DeleteScheduledAuditResult JSON Unmarshaller
 */
...
public class DeleteScheduledAuditResultJsonUnmarshaller implements Unmarshaller<DeleteScheduledAuditResult, JsonUnmarshallerContext> {
    ...
    public DeleteScheduledAuditResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteScheduledAuditResult deleteScheduledAuditResult = new DeleteScheduledAuditResult();
