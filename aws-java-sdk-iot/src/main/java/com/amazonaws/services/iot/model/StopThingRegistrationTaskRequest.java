...
public class StopThingRegistrationTaskRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public StopThingRegistrationTaskRequest clone() {
        return (StopThingRegistrationTaskRequest) super.clone();
    }
