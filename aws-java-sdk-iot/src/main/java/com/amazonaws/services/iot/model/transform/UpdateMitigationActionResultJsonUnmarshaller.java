...
/**
 * UpdateMitigationActionResult JSON Unmarshaller
 */
...
public class UpdateMitigationActionResultJsonUnmarshaller implements Unmarshaller<UpdateMitigationActionResult, JsonUnmarshallerContext> {
    ...
    public UpdateMitigationActionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("actionArn", targetDepth)) {
                    context.nextToken();
                    updateMitigationActionResult.setActionArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("actionId", targetDepth)) {
                    context.nextToken();
                    updateMitigationActionResult.setActionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
