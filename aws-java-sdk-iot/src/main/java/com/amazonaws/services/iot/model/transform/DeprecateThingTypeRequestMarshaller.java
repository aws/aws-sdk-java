...
public class DeprecateThingTypeRequestMarshaller
    ...
    public DeprecateThingTypeRequestMarshaller(
    ...
    public Request<DeprecateThingTypeRequest> marshall(
        ...
        uriResourcePath = uriResourcePath
                .replace(
                        "{thingTypeName}",
                        (deprecateThingTypeRequest.getThingTypeName() != null) ? SdkHttpUtils
                                .urlEncode(StringUtils
                                        .fromString(deprecateThingTypeRequest
        ...
        try {
            ...
            if (deprecateThingTypeRequest.getUndoDeprecate() != null) {
                jsonGenerator.writeFieldName("undoDeprecate").writeValue(
                        deprecateThingTypeRequest.getUndoDeprecate());
            }
