...
public class UpdateBillingGroupRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> BILLINGGROUPPROPERTIES_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("billingGroupProperties").build();
