...
/**
 * DeleteDomainConfigurationResult JSON Unmarshaller
 */
...
public class DeleteDomainConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteDomainConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteDomainConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDomainConfigurationResult deleteDomainConfigurationResult = new DeleteDomainConfigurationResult();

        return deleteDomainConfigurationResult;
    }
