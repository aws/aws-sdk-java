...
public class ListThingsInThingGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListThingsInThingGroupResult clone() {
        try {
            return (ListThingsInThingGroupResult) super.clone();
