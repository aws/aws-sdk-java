 ...
 */
public class ThingTypePropertiesJsonUnmarshaller implements
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("thingTypeDescription", targetDepth)) {
                    context.nextToken();
                    thingTypeProperties.setThingTypeDescription(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("searchableAttributes", targetDepth)) {
                    context.nextToken();
                    thingTypeProperties
                            .setSearchableAttributes(new ListUnmarshaller<String>(
