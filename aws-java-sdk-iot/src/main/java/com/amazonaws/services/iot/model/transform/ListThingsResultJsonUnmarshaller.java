...
public class ListThingsResultJsonUnmarshaller implements
    ...
    public ListThingsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("things", targetDepth)) {
                    context.nextToken();
                    listThingsResult
                            .setThings(new ListUnmarshaller<ThingAttribute>(
                                    ThingAttributeJsonUnmarshaller
                                            .getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listThingsResult.setNextToken(context.getUnmarshaller(
