...
@SdkInternalApi
public class ListRoleAliasesRequestMarshaller {
    ...
    private static final ListRoleAliasesRequestMarshaller instance = new ListRoleAliasesRequestMarshaller();

    public static ListRoleAliasesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListRoleAliasesRequest listRoleAliasesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listRoleAliasesRequest.getPageSize(), PAGESIZE_BINDING);
            protocolMarshaller.marshall(listRoleAliasesRequest.getMarker(), MARKER_BINDING);
            protocolMarshaller.marshall(listRoleAliasesRequest.getAscendingOrder(), ASCENDINGORDER_BINDING);
        } catch (Exception e) {
