...
/**
 * UpdateFleetMetricResult JSON Unmarshaller
 */
...
public class UpdateFleetMetricResultJsonUnmarshaller implements Unmarshaller<UpdateFleetMetricResult, JsonUnmarshallerContext> {
    ...
    public UpdateFleetMetricResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateFleetMetricResult updateFleetMetricResult = new UpdateFleetMetricResult();

        return updateFleetMetricResult;
    }
