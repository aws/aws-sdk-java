...
/**
 * SetDefaultAuthorizerResult JSON Unmarshaller
 */
...
public class SetDefaultAuthorizerResultJsonUnmarshaller implements Unmarshaller<SetDefaultAuthorizerResult, JsonUnmarshallerContext> {
    ...
    public SetDefaultAuthorizerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("authorizerName", targetDepth)) {
                    context.nextToken();
                    setDefaultAuthorizerResult.setAuthorizerName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("authorizerArn", targetDepth)) {
                    context.nextToken();
                    setDefaultAuthorizerResult.setAuthorizerArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
