...
public class RegisterCertificateRequestMarshaller
        implements
        Marshaller<Request<RegisterCertificateRequest>, RegisterCertificateRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public RegisterCertificateRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<RegisterCertificateRequest> marshall(
        ...
        Request<RegisterCertificateRequest> request = new DefaultRequest<RegisterCertificateRequest>(
                registerCertificateRequest, "AWSIot");
        ...
        if (registerCertificateRequest.getSetAsActive() != null) {
            request.addParameter("setAsActive", StringUtils
                    .fromBoolean(registerCertificateRequest.getSetAsActive()));
        }
        ...
        try {
            ...
            if (registerCertificateRequest.getCertificatePem() != null) {
                jsonGenerator.writeFieldName("certificatePem").writeValue(
                        registerCertificateRequest.getCertificatePem());
            }
