...
public class CodeSigningCertificateChainJsonUnmarshaller implements Unmarshaller<CodeSigningCertificateChain, JsonUnmarshallerContext> {

    public CodeSigningCertificateChain unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("inlineDocument", targetDepth)) {
                    context.nextToken();
                    codeSigningCertificateChain.setInlineDocument(context.getUnmarshaller(String.class).unmarshall(context));
                }
