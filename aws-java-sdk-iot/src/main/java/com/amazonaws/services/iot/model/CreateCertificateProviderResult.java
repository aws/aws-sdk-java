...
public class CreateCertificateProviderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateCertificateProviderResult withCertificateProviderName(String certificateProviderName) {
    ...
    @Override
    public CreateCertificateProviderResult clone() {
        try {
            return (CreateCertificateProviderResult) super.clone();
