...
/**
 * UpdateDynamicThingGroupResult JSON Unmarshaller
 */
...
public class UpdateDynamicThingGroupResultJsonUnmarshaller implements Unmarshaller<UpdateDynamicThingGroupResult, JsonUnmarshallerContext> {
    ...
    public UpdateDynamicThingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("version", targetDepth)) {
                    context.nextToken();
                    updateDynamicThingGroupResult.setVersion(context.getUnmarshaller(Long.class).unmarshall(context));
                }
