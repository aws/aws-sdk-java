...
/**
 * DeleteRoleAliasResult JSON Unmarshaller
 */
...
public class DeleteRoleAliasResultJsonUnmarshaller implements Unmarshaller<DeleteRoleAliasResult, JsonUnmarshallerContext> {
    ...
    public DeleteRoleAliasResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRoleAliasResult deleteRoleAliasResult = new DeleteRoleAliasResult();
