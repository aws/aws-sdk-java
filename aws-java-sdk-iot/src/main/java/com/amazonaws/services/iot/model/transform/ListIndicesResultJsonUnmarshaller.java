...
/**
 * ListIndicesResult JSON Unmarshaller
 */
...
public class ListIndicesResultJsonUnmarshaller implements Unmarshaller<ListIndicesResult, JsonUnmarshallerContext> {
    ...
    public ListIndicesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("indexNames", targetDepth)) {
                    context.nextToken();
                    listIndicesResult.setIndexNames(new ListUnmarshaller<String>(context.getUnmarshaller(String.class)).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listIndicesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
