...
/**
 * DescribeRoleAliasResult JSON Unmarshaller
 */
...
public class DescribeRoleAliasResultJsonUnmarshaller implements Unmarshaller<DescribeRoleAliasResult, JsonUnmarshallerContext> {
    ...
    public DescribeRoleAliasResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("roleAliasDescription", targetDepth)) {
                    context.nextToken();
                    describeRoleAliasResult.setRoleAliasDescription(RoleAliasDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
