 ...
 */
public class ThingTypeDefinitionJsonUnmarshaller implements
        Unmarshaller<ThingTypeDefinition, JsonUnmarshallerContext> {

    public ThingTypeDefinition unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("thingTypeName", targetDepth)) {
                    context.nextToken();
                    thingTypeDefinition.setThingTypeName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("thingTypeProperties", targetDepth)) {
                    context.nextToken();
                    thingTypeDefinition
                            .setThingTypeProperties(ThingTypePropertiesJsonUnmarshaller
