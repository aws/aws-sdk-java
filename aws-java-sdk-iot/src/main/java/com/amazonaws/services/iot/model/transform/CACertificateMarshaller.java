...
@SdkInternalApi
public class CACertificateMarshaller {
    ...
    private static final CACertificateMarshaller instance = new CACertificateMarshaller();

    public static CACertificateMarshaller getInstance() {
        return instance;
    }
