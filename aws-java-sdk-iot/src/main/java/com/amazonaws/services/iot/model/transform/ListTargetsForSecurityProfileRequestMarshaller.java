...
@SdkInternalApi
public class ListTargetsForSecurityProfileRequestMarshaller {
    ...
    private static final ListTargetsForSecurityProfileRequestMarshaller instance = new ListTargetsForSecurityProfileRequestMarshaller();

    public static ListTargetsForSecurityProfileRequestMarshaller getInstance() {
        return instance;
    }
