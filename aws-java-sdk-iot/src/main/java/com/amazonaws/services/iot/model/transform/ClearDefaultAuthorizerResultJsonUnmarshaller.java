...
/**
 * ClearDefaultAuthorizerResult JSON Unmarshaller
 */
...
public class ClearDefaultAuthorizerResultJsonUnmarshaller implements Unmarshaller<ClearDefaultAuthorizerResult, JsonUnmarshallerContext> {
    ...
    public ClearDefaultAuthorizerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ClearDefaultAuthorizerResult clearDefaultAuthorizerResult = new ClearDefaultAuthorizerResult();
