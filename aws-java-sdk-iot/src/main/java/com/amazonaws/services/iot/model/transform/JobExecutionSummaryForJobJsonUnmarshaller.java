...
public class JobExecutionSummaryForJobJsonUnmarshaller implements Unmarshaller<JobExecutionSummaryForJob, JsonUnmarshallerContext> {

    public JobExecutionSummaryForJob unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("thingArn", targetDepth)) {
                    context.nextToken();
                    jobExecutionSummaryForJob.setThingArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("jobExecutionSummary", targetDepth)) {
                    context.nextToken();
                    jobExecutionSummaryForJob.setJobExecutionSummary(JobExecutionSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
