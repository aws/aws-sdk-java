...
/**
 * DescribeThingRegistrationTaskRequestMarshaller
 */
...
public class DescribeThingRegistrationTaskRequestMarshaller {
    ...
    private static final DescribeThingRegistrationTaskRequestMarshaller instance = new DescribeThingRegistrationTaskRequestMarshaller();

    public static DescribeThingRegistrationTaskRequestMarshaller getInstance() {
        return instance;
    }
