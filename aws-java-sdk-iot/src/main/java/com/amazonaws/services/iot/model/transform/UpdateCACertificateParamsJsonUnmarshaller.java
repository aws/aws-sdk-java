...
/**
 * UpdateCACertificateParams JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateCACertificateParamsJsonUnmarshaller implements Unmarshaller<UpdateCACertificateParams, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("action", targetDepth)) {
                    context.nextToken();
                    updateCACertificateParams.setAction(context.getUnmarshaller(String.class).unmarshall(context));
                }
