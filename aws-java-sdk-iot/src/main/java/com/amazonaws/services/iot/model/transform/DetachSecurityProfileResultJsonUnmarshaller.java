...
/**
 * DetachSecurityProfileResult JSON Unmarshaller
 */
...
public class DetachSecurityProfileResultJsonUnmarshaller implements Unmarshaller<DetachSecurityProfileResult, JsonUnmarshallerContext> {
    ...
    public DetachSecurityProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DetachSecurityProfileResult detachSecurityProfileResult = new DetachSecurityProfileResult();
