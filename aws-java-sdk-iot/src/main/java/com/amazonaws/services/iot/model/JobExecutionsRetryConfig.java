...
public class JobExecutionsRetryConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public JobExecutionsRetryConfig withCriteriaList(RetryCriteria... criteriaList) {
        if (this.criteriaList == null) {
            setCriteriaList(new java.util.ArrayList<RetryCriteria>(criteriaList.length));
        }
        for (RetryCriteria ele : criteriaList) {
    ...
    public JobExecutionsRetryConfig withCriteriaList(java.util.Collection<RetryCriteria> criteriaList) {
    ...
    public JobExecutionsRetryConfig clone() {
        try {
            return (JobExecutionsRetryConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iot.model.transform.JobExecutionsRetryConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
