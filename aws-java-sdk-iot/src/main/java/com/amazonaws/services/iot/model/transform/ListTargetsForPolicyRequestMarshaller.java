...
public class ListTargetsForPolicyRequestMarshaller {
    ...
    private static final ListTargetsForPolicyRequestMarshaller instance = new ListTargetsForPolicyRequestMarshaller();

    public static ListTargetsForPolicyRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(ListTargetsForPolicyRequest listTargetsForPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listTargetsForPolicyRequest.getPolicyName(), POLICYNAME_BINDING);
            protocolMarshaller.marshall(listTargetsForPolicyRequest.getMarker(), MARKER_BINDING);
            protocolMarshaller.marshall(listTargetsForPolicyRequest.getPageSize(), PAGESIZE_BINDING);
        } catch (Exception e) {
