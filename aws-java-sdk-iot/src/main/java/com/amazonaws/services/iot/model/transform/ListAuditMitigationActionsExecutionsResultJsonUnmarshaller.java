...
/**
 * ListAuditMitigationActionsExecutionsResult JSON Unmarshaller
 */
...
public class ListAuditMitigationActionsExecutionsResultJsonUnmarshaller implements
    ...
    public ListAuditMitigationActionsExecutionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listAuditMitigationActionsExecutionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
