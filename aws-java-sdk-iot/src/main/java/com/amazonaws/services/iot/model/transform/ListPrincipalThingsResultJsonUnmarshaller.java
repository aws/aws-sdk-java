...
public class ListPrincipalThingsResultJsonUnmarshaller implements Unmarshaller<ListPrincipalThingsResult, JsonUnmarshallerContext> {
    ...
    public ListPrincipalThingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("things", targetDepth)) {
                    context.nextToken();
                    listPrincipalThingsResult.setThings(new ListUnmarshaller<String>(context.getUnmarshaller(String.class)).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listPrincipalThingsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
