 ...
 */
public class GetPolicyVersionResultJsonUnmarshaller implements
        Unmarshaller<GetPolicyVersionResult, JsonUnmarshallerContext> {

    public GetPolicyVersionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
