...
/**
 * ListTargetsForSecurityProfileResult JSON Unmarshaller
 */
...
public class ListTargetsForSecurityProfileResultJsonUnmarshaller implements Unmarshaller<ListTargetsForSecurityProfileResult, JsonUnmarshallerContext> {
    ...
    public ListTargetsForSecurityProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("securityProfileTargets", targetDepth)) {
                    context.nextToken();
                    listTargetsForSecurityProfileResult.setSecurityProfileTargets(new ListUnmarshaller<SecurityProfileTarget>(
                            SecurityProfileTargetJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listTargetsForSecurityProfileResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
