...
public class DeleteCustomMetricRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeleteCustomMetricRequest clone() {
        return (DeleteCustomMetricRequest) super.clone();
    }
