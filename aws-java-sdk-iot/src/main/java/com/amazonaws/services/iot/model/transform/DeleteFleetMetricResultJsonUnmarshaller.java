...
/**
 * DeleteFleetMetricResult JSON Unmarshaller
 */
...
public class DeleteFleetMetricResultJsonUnmarshaller implements Unmarshaller<DeleteFleetMetricResult, JsonUnmarshallerContext> {
    ...
    public DeleteFleetMetricResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFleetMetricResult deleteFleetMetricResult = new DeleteFleetMetricResult();

        return deleteFleetMetricResult;
    }
