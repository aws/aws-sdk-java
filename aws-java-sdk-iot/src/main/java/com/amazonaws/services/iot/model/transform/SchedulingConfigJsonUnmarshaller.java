...
/**
 * SchedulingConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SchedulingConfigJsonUnmarshaller implements Unmarshaller<SchedulingConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("startTime", targetDepth)) {
                    context.nextToken();
                    schedulingConfig.setStartTime(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("endTime", targetDepth)) {
                    context.nextToken();
                    schedulingConfig.setEndTime(context.getUnmarshaller(String.class).unmarshall(context));
                }
