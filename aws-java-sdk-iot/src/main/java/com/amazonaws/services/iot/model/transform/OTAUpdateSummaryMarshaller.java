...
public class OTAUpdateSummaryMarshaller {
    ...
    public void marshall(OTAUpdateSummary oTAUpdateSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(oTAUpdateSummary.getOtaUpdateId(), OTAUPDATEID_BINDING);
            protocolMarshaller.marshall(oTAUpdateSummary.getOtaUpdateArn(), OTAUPDATEARN_BINDING);
            protocolMarshaller.marshall(oTAUpdateSummary.getCreationDate(), CREATIONDATE_BINDING);
        } catch (Exception e) {
