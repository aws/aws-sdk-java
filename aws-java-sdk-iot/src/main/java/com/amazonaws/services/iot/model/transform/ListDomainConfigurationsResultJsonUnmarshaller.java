...
/**
 * ListDomainConfigurationsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDomainConfigurationsResultJsonUnmarshaller implements Unmarshaller<ListDomainConfigurationsResult, JsonUnmarshallerContext> {

    public ListDomainConfigurationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextMarker", targetDepth)) {
                    context.nextToken();
                    listDomainConfigurationsResult.setNextMarker(context.getUnmarshaller(String.class).unmarshall(context));
                }
