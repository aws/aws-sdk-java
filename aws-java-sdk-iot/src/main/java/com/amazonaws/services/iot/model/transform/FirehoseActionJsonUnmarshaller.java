 ...
 */
public class FirehoseActionJsonUnmarshaller implements
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("roleArn", targetDepth)) {
                    context.nextToken();
                    firehoseAction.setRoleArn(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("deliveryStreamName", targetDepth)) {
                    context.nextToken();
                    firehoseAction.setDeliveryStreamName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("separator", targetDepth)) {
                    context.nextToken();
                    firehoseAction.setSeparator(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
