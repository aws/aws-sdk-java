...
/**
 * CancelAuditMitigationActionsTaskResult JSON Unmarshaller
 */
...
public class CancelAuditMitigationActionsTaskResultJsonUnmarshaller implements Unmarshaller<CancelAuditMitigationActionsTaskResult, JsonUnmarshallerContext> {
    ...
    public CancelAuditMitigationActionsTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
