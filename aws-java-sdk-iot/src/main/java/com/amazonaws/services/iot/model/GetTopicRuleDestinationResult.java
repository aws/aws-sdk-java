...
public class GetTopicRuleDestinationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetTopicRuleDestinationResult withTopicRuleDestination(TopicRuleDestination topicRuleDestination) {
    ...
    @Override
    public GetTopicRuleDestinationResult clone() {
        try {
            return (GetTopicRuleDestinationResult) super.clone();
