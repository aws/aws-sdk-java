...
public class LogTargetConfigurationJsonUnmarshaller implements Unmarshaller<LogTargetConfiguration, JsonUnmarshallerContext> {
    ...
    public LogTargetConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("logTarget", targetDepth)) {
                    context.nextToken();
                    logTargetConfiguration.setLogTarget(LogTargetJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("logLevel", targetDepth)) {
                    context.nextToken();
                    logTargetConfiguration.setLogLevel(context.getUnmarshaller(String.class).unmarshall(context));
                }
