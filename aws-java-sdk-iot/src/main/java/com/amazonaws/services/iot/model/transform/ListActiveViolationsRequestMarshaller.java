...
@SdkInternalApi
public class ListActiveViolationsRequestMarshaller {
    ...
    private static final ListActiveViolationsRequestMarshaller instance = new ListActiveViolationsRequestMarshaller();

    public static ListActiveViolationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListActiveViolationsRequest listActiveViolationsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(listActiveViolationsRequest.getVerificationState(), VERIFICATIONSTATE_BINDING);
