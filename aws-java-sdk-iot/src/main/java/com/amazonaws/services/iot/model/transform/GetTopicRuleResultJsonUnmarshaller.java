 ...
 */
public class GetTopicRuleResultJsonUnmarshaller implements
        Unmarshaller<GetTopicRuleResult, JsonUnmarshallerContext> {

    public GetTopicRuleResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ruleArn", targetDepth)) {
                    context.nextToken();
                    getTopicRuleResult.setRuleArn(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("rule", targetDepth)) {
                    context.nextToken();
                    getTopicRuleResult.setRule(TopicRuleJsonUnmarshaller
