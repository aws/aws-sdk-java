 ...
 */
public class SetDefaultPolicyVersionResultJsonUnmarshaller implements
        Unmarshaller<SetDefaultPolicyVersionResult, JsonUnmarshallerContext> {

    public SetDefaultPolicyVersionResult unmarshall(
