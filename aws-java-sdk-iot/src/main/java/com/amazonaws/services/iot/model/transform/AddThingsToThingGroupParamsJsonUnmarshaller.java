...
/**
 * AddThingsToThingGroupParams JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AddThingsToThingGroupParamsJsonUnmarshaller implements Unmarshaller<AddThingsToThingGroupParams, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("overrideDynamicGroups", targetDepth)) {
                    context.nextToken();
                    addThingsToThingGroupParams.setOverrideDynamicGroups(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
