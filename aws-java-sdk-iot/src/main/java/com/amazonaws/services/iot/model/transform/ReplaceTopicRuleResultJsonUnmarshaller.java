 ...
 */
public class ReplaceTopicRuleResultJsonUnmarshaller implements
        Unmarshaller<ReplaceTopicRuleResult, JsonUnmarshallerContext> {

    public ReplaceTopicRuleResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
