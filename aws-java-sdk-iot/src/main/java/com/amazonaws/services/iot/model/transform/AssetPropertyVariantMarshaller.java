...
/**
 * AssetPropertyVariantMarshaller
 */
...
public class AssetPropertyVariantMarshaller {
    ...
    private static final MarshallingInfo<String> INTEGERVALUE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("integerValue").build();
    private static final MarshallingInfo<String> DOUBLEVALUE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("doubleValue").build();
    private static final MarshallingInfo<String> BOOLEANVALUE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
