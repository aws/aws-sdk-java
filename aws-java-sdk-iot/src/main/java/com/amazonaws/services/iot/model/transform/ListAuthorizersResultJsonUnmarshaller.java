...
/**
 * ListAuthorizersResult JSON Unmarshaller
 */
...
public class ListAuthorizersResultJsonUnmarshaller implements Unmarshaller<ListAuthorizersResult, JsonUnmarshallerContext> {
    ...
    public ListAuthorizersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextMarker", targetDepth)) {
                    context.nextToken();
                    listAuthorizersResult.setNextMarker(context.getUnmarshaller(String.class).unmarshall(context));
                }
