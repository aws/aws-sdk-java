...
/**
 * UpdateThingGroupResult JSON Unmarshaller
 */
...
public class UpdateThingGroupResultJsonUnmarshaller implements Unmarshaller<UpdateThingGroupResult, JsonUnmarshallerContext> {
    ...
    public UpdateThingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("version", targetDepth)) {
                    context.nextToken();
                    updateThingGroupResult.setVersion(context.getUnmarshaller(Long.class).unmarshall(context));
                }
