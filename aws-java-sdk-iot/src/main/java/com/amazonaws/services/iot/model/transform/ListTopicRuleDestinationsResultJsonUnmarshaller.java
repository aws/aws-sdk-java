...
/**
 * ListTopicRuleDestinationsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListTopicRuleDestinationsResultJsonUnmarshaller implements Unmarshaller<ListTopicRuleDestinationsResult, JsonUnmarshallerContext> {

    public ListTopicRuleDestinationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listTopicRuleDestinationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
