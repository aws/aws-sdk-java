 ...
 */
public class DescribeCACertificateResultJsonUnmarshaller implements
        Unmarshaller<DescribeCACertificateResult, JsonUnmarshallerContext> {

    public DescribeCACertificateResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("certificateDescription",
                        targetDepth)) {
                    context.nextToken();
