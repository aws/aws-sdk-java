...
/**
 * ListOTAUpdatesResult JSON Unmarshaller
 */
...
public class ListOTAUpdatesResultJsonUnmarshaller implements Unmarshaller<ListOTAUpdatesResult, JsonUnmarshallerContext> {
    ...
    public ListOTAUpdatesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listOTAUpdatesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
