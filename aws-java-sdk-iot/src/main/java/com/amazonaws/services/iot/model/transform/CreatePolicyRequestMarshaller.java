...
public class CreatePolicyRequestMarshaller implements Marshaller<Request<CreatePolicyRequest>, CreatePolicyRequest> {
    ...
    public CreatePolicyRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<CreatePolicyRequest> marshall(CreatePolicyRequest createPolicyRequest) {
        ...
        uriResourcePath = uriResourcePath
                .replace(
                        "{policyName}",
                        (createPolicyRequest.getPolicyName() != null) ? SdkHttpUtils.urlEncode(StringUtils.fromString(createPolicyRequest.getPolicyName()),
                                false) : "");
