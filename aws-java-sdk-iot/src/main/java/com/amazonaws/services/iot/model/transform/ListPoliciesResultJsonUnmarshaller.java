...
public class ListPoliciesResultJsonUnmarshaller implements
    ...
    public ListPoliciesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("policies", targetDepth)) {
                    context.nextToken();
                    listPoliciesResult
                            .setPolicies(new ListUnmarshaller<Policy>(
                                    PolicyJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("nextMarker", targetDepth)) {
                    context.nextToken();
                    listPoliciesResult.setNextMarker(context.getUnmarshaller(
