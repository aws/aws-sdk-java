...
/**
 * ScheduledJobRollout JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScheduledJobRolloutJsonUnmarshaller implements Unmarshaller<ScheduledJobRollout, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("startTime", targetDepth)) {
                    context.nextToken();
                    scheduledJobRollout.setStartTime(context.getUnmarshaller(String.class).unmarshall(context));
                }
