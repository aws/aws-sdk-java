...
public class ListFleetMetricsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListFleetMetricsRequest clone() {
        return (ListFleetMetricsRequest) super.clone();
    }
