...
public class ListFleetMetricsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * {@link #setFleetMetrics(java.util.Collection)} or {@link #withFleetMetrics(java.util.Collection)} if you want to
    ...
    public ListFleetMetricsResult withFleetMetrics(FleetMetricNameAndArn... fleetMetrics) {
        if (this.fleetMetrics == null) {
            setFleetMetrics(new java.util.ArrayList<FleetMetricNameAndArn>(fleetMetrics.length));
        }
        for (FleetMetricNameAndArn ele : fleetMetrics) {
            this.fleetMetrics.add(ele);
        }
        return this;
    }
    ...
    public ListFleetMetricsResult withFleetMetrics(java.util.Collection<FleetMetricNameAndArn> fleetMetrics) {
    ...
    public String toString() {
        ...
        if (getFleetMetrics() != null)
            sb.append("FleetMetrics: ").append(getFleetMetrics()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getFleetMetrics() == null ^ this.getFleetMetrics() == null)
            return false;
        if (other.getFleetMetrics() != null && other.getFleetMetrics().equals(this.getFleetMetrics()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getFleetMetrics() == null) ? 0 : getFleetMetrics().hashCode());
    ...
    public ListFleetMetricsResult clone() {
        try {
            return (ListFleetMetricsResult) super.clone();
