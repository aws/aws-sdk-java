...
/**
 * DeleteAccountAuditConfigurationResult JSON Unmarshaller
 */
...
public class DeleteAccountAuditConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteAccountAuditConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteAccountAuditConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAccountAuditConfigurationResult deleteAccountAuditConfigurationResult = new DeleteAccountAuditConfigurationResult();
