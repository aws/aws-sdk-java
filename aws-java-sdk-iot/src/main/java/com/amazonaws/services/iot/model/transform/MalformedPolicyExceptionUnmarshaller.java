...
public class MalformedPolicyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MalformedPolicyExceptionUnmarshaller instance;

    public static MalformedPolicyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MalformedPolicyExceptionUnmarshaller();
        return instance;
    }
}
