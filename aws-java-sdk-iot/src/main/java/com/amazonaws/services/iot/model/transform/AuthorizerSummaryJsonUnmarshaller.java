...
public class AuthorizerSummaryJsonUnmarshaller implements Unmarshaller<AuthorizerSummary, JsonUnmarshallerContext> {

    public AuthorizerSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("authorizerName", targetDepth)) {
                    context.nextToken();
                    authorizerSummary.setAuthorizerName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("authorizerArn", targetDepth)) {
                    context.nextToken();
                    authorizerSummary.setAuthorizerArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
