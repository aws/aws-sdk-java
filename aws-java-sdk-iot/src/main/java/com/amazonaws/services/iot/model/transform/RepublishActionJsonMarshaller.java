...
public class RepublishActionJsonMarshaller {
     ...
     */
    public void marshall(RepublishAction republishAction, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (republishAction.getRoleArn() != null) {
                jsonGenerator.writeFieldName("roleArn").writeValue(republishAction.getRoleArn());
            }
            if (republishAction.getTopic() != null) {
                jsonGenerator.writeFieldName("topic").writeValue(republishAction.getTopic());
            }
