...
@SdkInternalApi
public class SetDefaultAuthorizerRequestMarshaller {
    ...
    private static final SetDefaultAuthorizerRequestMarshaller instance = new SetDefaultAuthorizerRequestMarshaller();

    public static SetDefaultAuthorizerRequestMarshaller getInstance() {
        return instance;
    }
