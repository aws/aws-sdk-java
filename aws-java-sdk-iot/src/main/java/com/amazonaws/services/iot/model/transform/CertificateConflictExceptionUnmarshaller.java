...
public class CertificateConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CertificateConflictExceptionUnmarshaller instance;

    public static CertificateConflictExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CertificateConflictExceptionUnmarshaller();
        return instance;
    }
}
