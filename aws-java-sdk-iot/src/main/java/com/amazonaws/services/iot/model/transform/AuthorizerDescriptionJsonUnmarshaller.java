        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("creationDate", targetDepth)) {
                    context.nextToken();
                    authorizerDescription.setCreationDate(context.getUnmarshaller(java.util.Date.class).unmarshall(context));
                }
                if (context.testExpression("lastModifiedDate", targetDepth)) {
                    context.nextToken();
                    authorizerDescription.setLastModifiedDate(context.getUnmarshaller(java.util.Date.class).unmarshall(context));
                }
