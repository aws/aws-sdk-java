...
/**
 * ListV2LoggingLevelsResult JSON Unmarshaller
 */
...
public class ListV2LoggingLevelsResultJsonUnmarshaller implements Unmarshaller<ListV2LoggingLevelsResult, JsonUnmarshallerContext> {
    ...
    public ListV2LoggingLevelsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("logTargetConfigurations", targetDepth)) {
                    context.nextToken();
                    listV2LoggingLevelsResult.setLogTargetConfigurations(new ListUnmarshaller<LogTargetConfiguration>(LogTargetConfigurationJsonUnmarshaller
                            .getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listV2LoggingLevelsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
