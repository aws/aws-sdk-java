...
/**
 * JobExecutionsRolloutConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class JobExecutionsRolloutConfigMarshaller {
    ...
    private static final JobExecutionsRolloutConfigMarshaller instance = new JobExecutionsRolloutConfigMarshaller();

    public static JobExecutionsRolloutConfigMarshaller getInstance() {
        return instance;
    }
