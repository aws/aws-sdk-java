...
public class LocationTimestamp implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LocationTimestamp == false)
            return false;
        LocationTimestamp other = (LocationTimestamp) obj;
    ...
    @Override
    public LocationTimestamp clone() {
        try {
            return (LocationTimestamp) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iot.model.transform.LocationTimestampMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
