...
public class ListCertificatesByCAResult implements Serializable, Cloneable {
    ...
    public ListCertificatesByCAResult withCertificates(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCertificatesByCAResult == false)
            return false;
        ListCertificatesByCAResult other = (ListCertificatesByCAResult) obj;
    ...
    public ListCertificatesByCAResult clone() {
        try {
            return (ListCertificatesByCAResult) super.clone();
