 ...
 */
public class AttachPrincipalPolicyResultJsonUnmarshaller implements
        Unmarshaller<AttachPrincipalPolicyResult, JsonUnmarshallerContext> {

    public AttachPrincipalPolicyResult unmarshall(
