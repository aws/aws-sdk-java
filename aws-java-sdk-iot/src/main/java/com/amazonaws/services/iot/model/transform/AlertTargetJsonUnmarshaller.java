...
public class AlertTargetJsonUnmarshaller implements Unmarshaller<AlertTarget, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("alertTargetArn", targetDepth)) {
                    context.nextToken();
                    alertTarget.setAlertTargetArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("roleArn", targetDepth)) {
                    context.nextToken();
                    alertTarget.setRoleArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
