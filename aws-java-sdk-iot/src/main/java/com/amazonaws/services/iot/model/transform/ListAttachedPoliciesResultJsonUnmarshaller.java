...
/**
 * ListAttachedPoliciesResult JSON Unmarshaller
 */
...
public class ListAttachedPoliciesResultJsonUnmarshaller implements Unmarshaller<ListAttachedPoliciesResult, JsonUnmarshallerContext> {
    ...
    public ListAttachedPoliciesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextMarker", targetDepth)) {
                    context.nextToken();
                    listAttachedPoliciesResult.setNextMarker(context.getUnmarshaller(String.class).unmarshall(context));
                }
