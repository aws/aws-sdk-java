...
public class InvalidResponseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidResponseExceptionUnmarshaller instance;

    public static InvalidResponseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidResponseExceptionUnmarshaller();
        return instance;
    }
}
