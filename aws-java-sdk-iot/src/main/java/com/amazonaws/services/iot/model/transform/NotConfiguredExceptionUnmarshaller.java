...
public class NotConfiguredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NotConfiguredExceptionUnmarshaller instance;

    public static NotConfiguredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NotConfiguredExceptionUnmarshaller();
        return instance;
    }
}
