 ...
 */
public class AcceptCertificateTransferResultJsonUnmarshaller implements
        Unmarshaller<AcceptCertificateTransferResult, JsonUnmarshallerContext> {

    public AcceptCertificateTransferResult unmarshall(
