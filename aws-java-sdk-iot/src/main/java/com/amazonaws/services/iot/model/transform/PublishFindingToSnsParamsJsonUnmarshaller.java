...
/**
 * PublishFindingToSnsParams JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PublishFindingToSnsParamsJsonUnmarshaller implements Unmarshaller<PublishFindingToSnsParams, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("topicArn", targetDepth)) {
                    context.nextToken();
                    publishFindingToSnsParams.setTopicArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
