 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chatbot-2017-10-11/TeamsChannelConfiguration" target="_top">AWS
 *      API Documentation</a>
 */
...
public class TeamsChannelConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public TeamsChannelConfiguration withSnsTopicArns(java.util.Collection<String> snsTopicArns) {
    ...
    public TeamsChannelConfiguration withGuardrailPolicyArns(java.util.Collection<String> guardrailPolicyArns) {
    ...
    public TeamsChannelConfiguration withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
