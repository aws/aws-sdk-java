...
/**
 * DeleteMicrosoftTeamsUserIdentityResult JSON Unmarshaller
 */
...
public class DeleteMicrosoftTeamsUserIdentityResultJsonUnmarshaller implements Unmarshaller<DeleteMicrosoftTeamsUserIdentityResult, JsonUnmarshallerContext> {
    ...
    public DeleteMicrosoftTeamsUserIdentityResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMicrosoftTeamsUserIdentityResult deleteMicrosoftTeamsUserIdentityResult = new DeleteMicrosoftTeamsUserIdentityResult();
