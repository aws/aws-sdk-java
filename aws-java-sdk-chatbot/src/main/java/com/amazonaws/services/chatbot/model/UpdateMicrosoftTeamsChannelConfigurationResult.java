...
public class UpdateMicrosoftTeamsChannelConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateMicrosoftTeamsChannelConfigurationResult == false)
            return false;
        UpdateMicrosoftTeamsChannelConfigurationResult other = (UpdateMicrosoftTeamsChannelConfigurationResult) obj;
    ...
    public UpdateMicrosoftTeamsChannelConfigurationResult clone() {
        try {
            return (UpdateMicrosoftTeamsChannelConfigurationResult) super.clone();
