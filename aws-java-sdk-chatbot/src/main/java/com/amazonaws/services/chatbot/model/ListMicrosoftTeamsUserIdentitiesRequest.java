...
public class ListMicrosoftTeamsUserIdentitiesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The ARN of the MicrosoftTeamsChannelConfiguration associated with the user identities to list.
     * 
     * @return The ARN of the MicrosoftTeamsChannelConfiguration associated with the user identities to list.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListMicrosoftTeamsUserIdentitiesRequest == false)
            return false;
        ListMicrosoftTeamsUserIdentitiesRequest other = (ListMicrosoftTeamsUserIdentitiesRequest) obj;
    ...
    public ListMicrosoftTeamsUserIdentitiesRequest clone() {
        return (ListMicrosoftTeamsUserIdentitiesRequest) super.clone();
    }
