...
/**
 * ChimeWebhookConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ChimeWebhookConfigurationMarshaller {
    ...
    private static final ChimeWebhookConfigurationMarshaller instance = new ChimeWebhookConfigurationMarshaller();

    public static ChimeWebhookConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ChimeWebhookConfiguration chimeWebhookConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (chimeWebhookConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(chimeWebhookConfiguration.getWebhookDescription(), WEBHOOKDESCRIPTION_BINDING);
            protocolMarshaller.marshall(chimeWebhookConfiguration.getChatConfigurationArn(), CHATCONFIGURATIONARN_BINDING);
            protocolMarshaller.marshall(chimeWebhookConfiguration.getIamRoleArn(), IAMROLEARN_BINDING);
            protocolMarshaller.marshall(chimeWebhookConfiguration.getSnsTopicArns(), SNSTOPICARNS_BINDING);
            protocolMarshaller.marshall(chimeWebhookConfiguration.getConfigurationName(), CONFIGURATIONNAME_BINDING);
            protocolMarshaller.marshall(chimeWebhookConfiguration.getLoggingLevel(), LOGGINGLEVEL_BINDING);
            protocolMarshaller.marshall(chimeWebhookConfiguration.getTags(), TAGS_BINDING);
        } catch (Exception e) {
