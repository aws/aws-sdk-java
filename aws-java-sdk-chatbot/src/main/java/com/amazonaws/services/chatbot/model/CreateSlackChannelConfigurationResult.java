...
public class CreateSlackChannelConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public SlackChannelConfiguration getChannelConfiguration() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSlackChannelConfigurationResult == false)
            return false;
        CreateSlackChannelConfigurationResult other = (CreateSlackChannelConfigurationResult) obj;
    ...
    public CreateSlackChannelConfigurationResult clone() {
        try {
            return (CreateSlackChannelConfigurationResult) super.clone();
