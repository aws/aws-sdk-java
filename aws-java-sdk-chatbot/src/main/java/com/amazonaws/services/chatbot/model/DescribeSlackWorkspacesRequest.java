...
public class DescribeSlackWorkspacesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeSlackWorkspacesRequest withMaxResults(Integer maxResults) {
    ...
    public DescribeSlackWorkspacesRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeSlackWorkspacesRequest == false)
            return false;
        DescribeSlackWorkspacesRequest other = (DescribeSlackWorkspacesRequest) obj;
    ...
    @Override
    public DescribeSlackWorkspacesRequest clone() {
        return (DescribeSlackWorkspacesRequest) super.clone();
    }
