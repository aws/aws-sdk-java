...
public class GetMicrosoftTeamsChannelConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The ARN of the MicrosoftTeamsChannelConfiguration to retrieve.
     * 
     * @return The ARN of the MicrosoftTeamsChannelConfiguration to retrieve.
     */
    ...
    public GetMicrosoftTeamsChannelConfigurationRequest withChatConfigurationArn(String chatConfigurationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetMicrosoftTeamsChannelConfigurationRequest == false)
            return false;
        GetMicrosoftTeamsChannelConfigurationRequest other = (GetMicrosoftTeamsChannelConfigurationRequest) obj;
    ...
    @Override
    public GetMicrosoftTeamsChannelConfigurationRequest clone() {
        return (GetMicrosoftTeamsChannelConfigurationRequest) super.clone();
    }
