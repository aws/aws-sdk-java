...
/**
 * DeleteSlackUserIdentityResult JSON Unmarshaller
 */
...
public class DeleteSlackUserIdentityResultJsonUnmarshaller implements Unmarshaller<DeleteSlackUserIdentityResult, JsonUnmarshallerContext> {
    ...
    public DeleteSlackUserIdentityResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSlackUserIdentityResult deleteSlackUserIdentityResult = new DeleteSlackUserIdentityResult();
