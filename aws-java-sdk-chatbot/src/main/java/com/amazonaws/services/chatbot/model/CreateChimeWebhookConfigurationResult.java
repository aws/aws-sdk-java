...
public class CreateChimeWebhookConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateChimeWebhookConfigurationResult == false)
            return false;
        CreateChimeWebhookConfigurationResult other = (CreateChimeWebhookConfigurationResult) obj;
    ...
    @Override
    public CreateChimeWebhookConfigurationResult clone() {
        try {
            return (CreateChimeWebhookConfigurationResult) super.clone();
