...
public class CreateSlackChannelConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateSlackChannelConfigurationRequest withSlackTeamId(String slackTeamId) {
    ...
    public CreateSlackChannelConfigurationRequest withSlackChannelId(String slackChannelId) {
    ...
    public CreateSlackChannelConfigurationRequest withSlackChannelName(String slackChannelName) {
    ...
    public CreateSlackChannelConfigurationRequest withSnsTopicArns(String... snsTopicArns) {
    ...
    public CreateSlackChannelConfigurationRequest withSnsTopicArns(java.util.Collection<String> snsTopicArns) {
    ...
    public CreateSlackChannelConfigurationRequest withIamRoleArn(String iamRoleArn) {
    ...
    public CreateSlackChannelConfigurationRequest withConfigurationName(String configurationName) {
    ...
    public CreateSlackChannelConfigurationRequest withLoggingLevel(String loggingLevel) {
    ...
    public CreateSlackChannelConfigurationRequest withGuardrailPolicyArns(String... guardrailPolicyArns) {
    ...
    public CreateSlackChannelConfigurationRequest withGuardrailPolicyArns(java.util.Collection<String> guardrailPolicyArns) {
    ...
    public CreateSlackChannelConfigurationRequest withUserAuthorizationRequired(Boolean userAuthorizationRequired) {
    ...
    public CreateSlackChannelConfigurationRequest withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public CreateSlackChannelConfigurationRequest withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSlackChannelConfigurationRequest == false)
            return false;
        CreateSlackChannelConfigurationRequest other = (CreateSlackChannelConfigurationRequest) obj;
    ...
    @Override
    public CreateSlackChannelConfigurationRequest clone() {
