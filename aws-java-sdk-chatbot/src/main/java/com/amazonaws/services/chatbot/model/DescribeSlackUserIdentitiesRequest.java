...
public class DescribeSlackUserIdentitiesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The ARN of the SlackChannelConfiguration associated with the user identities to describe.
     * 
     * @return The ARN of the SlackChannelConfiguration associated with the user identities to describe.
     */
    ...
    public DescribeSlackUserIdentitiesRequest withChatConfigurationArn(String chatConfigurationArn) {
    ...
    public DescribeSlackUserIdentitiesRequest withNextToken(String nextToken) {
    ...
    public DescribeSlackUserIdentitiesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeSlackUserIdentitiesRequest == false)
            return false;
        DescribeSlackUserIdentitiesRequest other = (DescribeSlackUserIdentitiesRequest) obj;
    ...
    @Override
    public DescribeSlackUserIdentitiesRequest clone() {
        return (DescribeSlackUserIdentitiesRequest) super.clone();
    }
