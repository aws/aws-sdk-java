...
public class DeleteMicrosoftTeamsChannelConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The ARN of the MicrosoftTeamsChannelConfiguration to delete.
     * 
     * @return The ARN of the MicrosoftTeamsChannelConfiguration to delete.
     */
    ...
    public DeleteMicrosoftTeamsChannelConfigurationRequest withChatConfigurationArn(String chatConfigurationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteMicrosoftTeamsChannelConfigurationRequest == false)
            return false;
        DeleteMicrosoftTeamsChannelConfigurationRequest other = (DeleteMicrosoftTeamsChannelConfigurationRequest) obj;
    ...
    @Override
    public DeleteMicrosoftTeamsChannelConfigurationRequest clone() {
        return (DeleteMicrosoftTeamsChannelConfigurationRequest) super.clone();
    }
