...
public class DeleteSlackChannelConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The ARN of the SlackChannelConfiguration to delete.
     * 
     * @return The ARN of the SlackChannelConfiguration to delete.
     */
    ...
    public DeleteSlackChannelConfigurationRequest withChatConfigurationArn(String chatConfigurationArn) {
