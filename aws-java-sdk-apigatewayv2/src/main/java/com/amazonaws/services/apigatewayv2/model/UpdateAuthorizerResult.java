...
public class UpdateAuthorizerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateAuthorizerResult withAuthorizerCredentialsArn(String authorizerCredentialsArn) {
    ...
    public UpdateAuthorizerResult withAuthorizerId(String authorizerId) {
    ...
    public UpdateAuthorizerResult withAuthorizerPayloadFormatVersion(String authorizerPayloadFormatVersion) {
    ...
    public UpdateAuthorizerResult withAuthorizerType(String authorizerType) {
    ...
    public UpdateAuthorizerResult withAuthorizerType(AuthorizerType authorizerType) {
    ...
    public UpdateAuthorizerResult withEnableSimpleResponses(Boolean enableSimpleResponses) {
    ...
    public UpdateAuthorizerResult withIdentitySource(java.util.Collection<String> identitySource) {
    ...
    public UpdateAuthorizerResult withJwtConfiguration(JWTConfiguration jwtConfiguration) {
