...
public class VpcLink implements Serializable, Cloneable, StructuredPojo {
    ...
    public VpcLink withCreatedDate(java.util.Date createdDate) {
    ...
    public VpcLink withSecurityGroupIds(java.util.Collection<String> securityGroupIds) {
    ...
    public VpcLink withSubnetIds(java.util.Collection<String> subnetIds) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.apigatewayv2.model.transform.VpcLinkMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
