...
public class CreateAuthorizerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * can return a boolean value instead of an IAM policy. Supported only for HTTP APIs. To learn more, see <a
     * href="https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-lambda-authorizer.html">Working with
     * AWS Lambda authorizers for HTTP APIs</a>
     * </p>
     */
     ...
     *        permissions on the Lambda function, don't specify this parameter. Supported only for REQUEST authorizers.
     */
    ...
    public CreateAuthorizerResult withAuthorizerCredentialsArn(String authorizerCredentialsArn) {
    ...
    public CreateAuthorizerResult withAuthorizerId(String authorizerId) {
    ...
    public CreateAuthorizerResult withAuthorizerPayloadFormatVersion(String authorizerPayloadFormatVersion) {
    ...
    public CreateAuthorizerResult withAuthorizerType(String authorizerType) {
    ...
    public CreateAuthorizerResult withAuthorizerType(AuthorizerType authorizerType) {
     ...
     * </p>
     * 
     * @return Specifies whether a Lambda authorizer returns a response in a simple format. If enabled, the Lambda
     *         authorizer can return a boolean value instead of an IAM policy. Supported only for HTTP APIs. To learn
     *         more, see <a
     *         href="https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-lambda-authorizer.html"
     *         >Working with AWS Lambda authorizers for HTTP APIs</a>
    ...
    public CreateAuthorizerResult withEnableSimpleResponses(Boolean enableSimpleResponses) {
     ...
     *        <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-lambda-authorizer.html">
     *        Working with AWS Lambda authorizers for HTTP APIs</a>.
     *        </p>
     *        <p>
     *        For JWT, a single entry that specifies where to extract the JSON Web Token (JWT) from inbound requests.
    ...
    public CreateAuthorizerResult withIdentitySource(java.util.Collection<String> identitySource) {
    ...
    public CreateAuthorizerResult withIdentityValidationExpression(String identityValidationExpression) {
    ...
    public CreateAuthorizerResult withJwtConfiguration(JWTConfiguration jwtConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAuthorizerResult == false)
            return false;
        CreateAuthorizerResult other = (CreateAuthorizerResult) obj;
