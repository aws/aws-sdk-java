...
public class GetModelTemplateResultJsonUnmarshaller implements Unmarshaller<GetModelTemplateResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("value", targetDepth)) {
                    context.nextToken();
                    getModelTemplateResult.setValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
