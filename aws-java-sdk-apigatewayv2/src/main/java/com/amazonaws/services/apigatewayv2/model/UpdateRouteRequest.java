...
public class UpdateRouteRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies whether an API key is required for the route.
     */
    ...
    public UpdateRouteRequest withAuthorizationScopes(java.util.Collection<String> authorizationScopes) {
    ...
    public UpdateRouteRequest withRequestParameters(java.util.Map<String, ParameterConstraints> requestParameters) {
