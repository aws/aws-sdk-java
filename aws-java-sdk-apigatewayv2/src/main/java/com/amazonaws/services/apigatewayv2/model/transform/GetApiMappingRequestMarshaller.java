...
public class GetApiMappingRequestMarshaller {
    ...
    private static final GetApiMappingRequestMarshaller instance = new GetApiMappingRequestMarshaller();

    public static GetApiMappingRequestMarshaller getInstance() {
        return instance;
    }
