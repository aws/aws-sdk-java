...
public class GetApiMappingRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetApiMappingRequest withApiId(String apiId) {
        setApiId(apiId);
        return this;
    }
    ...
    @Override
    public GetApiMappingRequest clone() {
        return (GetApiMappingRequest) super.clone();
    }
