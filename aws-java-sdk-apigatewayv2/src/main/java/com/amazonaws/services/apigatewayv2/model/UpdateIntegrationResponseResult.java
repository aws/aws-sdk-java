...
public class UpdateIntegrationResponseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateIntegrationResponseResult withContentHandlingStrategy(String contentHandlingStrategy) {
    ...
    public UpdateIntegrationResponseResult withIntegrationResponseId(String integrationResponseId) {
    ...
    public UpdateIntegrationResponseResult withIntegrationResponseKey(String integrationResponseKey) {
    ...
    public UpdateIntegrationResponseResult withTemplateSelectionExpression(String templateSelectionExpression) {
