...
public class UpdateAuthorizerRequestMarshaller {
    ...
    public void marshall(UpdateAuthorizerRequest updateAuthorizerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateAuthorizerRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateAuthorizerRequest.getProviderArns(), PROVIDERARNS_BINDING);
        } catch (Exception e) {
