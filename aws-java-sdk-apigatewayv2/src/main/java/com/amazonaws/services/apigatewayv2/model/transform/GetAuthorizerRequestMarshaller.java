...
@SdkInternalApi
public class GetAuthorizerRequestMarshaller {
    ...
    private static final GetAuthorizerRequestMarshaller instance = new GetAuthorizerRequestMarshaller();

    public static GetAuthorizerRequestMarshaller getInstance() {
        return instance;
    }
