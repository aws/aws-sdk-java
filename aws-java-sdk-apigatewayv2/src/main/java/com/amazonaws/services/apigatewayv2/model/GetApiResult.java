...
public class GetApiResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetApiResult withApiGatewayManaged(Boolean apiGatewayManaged) {
    ...
    public GetApiResult withCorsConfiguration(Cors corsConfiguration) {
    ...
    public GetApiResult withCreatedDate(java.util.Date createdDate) {
    ...
    public GetApiResult withDisableExecuteApiEndpoint(Boolean disableExecuteApiEndpoint) {
    ...
    public GetApiResult withImportInfo(String... importInfo) {
    ...
    public GetApiResult withImportInfo(java.util.Collection<String> importInfo) {
    ...
    public GetApiResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
    ...
    public GetApiResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public GetApiResult withWarnings(String... warnings) {
    ...
    public GetApiResult withWarnings(java.util.Collection<String> warnings) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetApiResult == false)
            return false;
        GetApiResult other = (GetApiResult) obj;
    ...
    public GetApiResult clone() {
        try {
            return (GetApiResult) super.clone();
