 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/PredictiveScalingPredefinedMetricPair"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PredictiveScalingPredefinedMetricPair implements Serializable, Cloneable {

    /**
     * <p>
     * Indicates which metrics to use. There are two different types of metrics for each metric type: one is a load
     * metric and one is a scaling metric. For example, if the metric type is <code>ASGCPUUtilization</code>, the Auto
     ...
     * total and average request count served by your Auto Scaling group. You can't specify a resource label unless the
     ...
     *        load metric and one is a scaling metric. For example, if the metric type is <code>ASGCPUUtilization</code>
     ...
     *         <code>ASGCPUUtilization</code>, the Auto Scaling group's total CPU metric is used as the load metric, and
     ...
     *        the total and average request count served by your Auto Scaling group. You can't specify a resource label
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PredictiveScalingPredefinedMetricPair == false)
            return false;
        PredictiveScalingPredefinedMetricPair other = (PredictiveScalingPredefinedMetricPair) obj;
    ...
    @Override
    public PredictiveScalingPredefinedMetricPair clone() {
        try {
            return (PredictiveScalingPredefinedMetricPair) super.clone();
