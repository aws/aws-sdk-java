 ...
 */
public class DescribeAutoScalingInstancesResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeAutoScalingInstancesResult, StaxUnmarshallerContext> {
    ...
    public DescribeAutoScalingInstancesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("AutoScalingInstances/member",
                        targetDepth)) {
                    describeAutoScalingInstancesResult
                            .withAutoScalingInstances(AutoScalingInstanceDetailsStaxUnmarshaller
