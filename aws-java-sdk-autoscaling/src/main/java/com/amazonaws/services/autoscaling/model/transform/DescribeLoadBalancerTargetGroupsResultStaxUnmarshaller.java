 ...
 */
public class DescribeLoadBalancerTargetGroupsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeLoadBalancerTargetGroupsResult, StaxUnmarshallerContext> {

    public DescribeLoadBalancerTargetGroupsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("LoadBalancerTargetGroups/member",
                        targetDepth)) {
