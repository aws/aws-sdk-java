...
@SdkInternalApi
public class DescribeAutoScalingGroupsFunction
        implements
        SdkFunction<DescribeAutoScalingGroupsRequest, DescribeAutoScalingGroupsResult> {
     ...
     */
    @Override
    public DescribeAutoScalingGroupsResult apply(
