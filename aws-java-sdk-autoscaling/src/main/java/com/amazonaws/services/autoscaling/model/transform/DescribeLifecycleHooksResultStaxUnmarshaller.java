 ...
 */
public class DescribeLifecycleHooksResultStaxUnmarshaller implements
        Unmarshaller<DescribeLifecycleHooksResult, StaxUnmarshallerContext> {

    public DescribeLifecycleHooksResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context
                        .testExpression("LifecycleHooks/member", targetDepth)) {
                    describeLifecycleHooksResult
                            .withLifecycleHooks(LifecycleHookStaxUnmarshaller
