...
public class DescribeTrafficSourcesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeTrafficSourcesRequest withTrafficSourceType(String trafficSourceType) {
        setTrafficSourceType(trafficSourceType);
        return this;
    }
     ...
     * </p>
     * 
     * @return The maximum number of items to return with this call. The maximum value is <code>50</code>.
     */
    ...
    public String toString() {
        ...
        if (getTrafficSourceType() != null)
            sb.append("TrafficSourceType: ").append(getTrafficSourceType()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeTrafficSourcesRequest == false)
            return false;
        DescribeTrafficSourcesRequest other = (DescribeTrafficSourcesRequest) obj;
        if (other.getAutoScalingGroupName() == null ^ this.getAutoScalingGroupName() == null)
            return false;
        if (other.getAutoScalingGroupName() != null && other.getAutoScalingGroupName().equals(this.getAutoScalingGroupName()) == false)
            return false;
        if (other.getTrafficSourceType() == null ^ this.getTrafficSourceType() == null)
            return false;
        if (other.getTrafficSourceType() != null && other.getTrafficSourceType().equals(this.getTrafficSourceType()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getTrafficSourceType() == null) ? 0 : getTrafficSourceType().hashCode());
    ...
    public DescribeTrafficSourcesRequest clone() {
        return (DescribeTrafficSourcesRequest) super.clone();
    }
