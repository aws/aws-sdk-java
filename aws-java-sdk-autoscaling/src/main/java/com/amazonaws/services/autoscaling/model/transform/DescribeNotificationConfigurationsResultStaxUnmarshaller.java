 ...
 */
public class DescribeNotificationConfigurationsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeNotificationConfigurationsResult, StaxUnmarshallerContext> {

    public DescribeNotificationConfigurationsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("NotificationConfigurations/member",
                        targetDepth)) {
                    describeNotificationConfigurationsResult
                            .getNotificationConfigurations().add(
