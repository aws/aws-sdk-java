 ...
 */
public class DisableMetricsCollectionResultStaxUnmarshaller implements
        Unmarshaller<DisableMetricsCollectionResult, StaxUnmarshallerContext> {

    public DisableMetricsCollectionResult unmarshall(
