...
class GroupNotExists {
    ...
    static class IsFalseMatcher extends
            WaiterAcceptor<DescribeAutoScalingGroupsResult> {
        ...
        private static final JmesPathExpression ast = new OpGreaterThan(
                new JmesPathLengthFunction(new JmesPathField(
                        "AutoScalingGroups")), new JmesPathLiteral("0"));
         ...
         */
        @Override
        public boolean matches(DescribeAutoScalingGroupsResult result) {
    ...
    static class IsTrueMatcher extends
            WaiterAcceptor<DescribeAutoScalingGroupsResult> {
        private static final JsonNode expectedResult;
