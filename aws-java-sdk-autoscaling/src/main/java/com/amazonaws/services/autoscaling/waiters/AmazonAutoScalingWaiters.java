...
public class AmazonAutoScalingWaiters {
    ...
    /**
     * Builds a GroupInService waiter by using custom parameters
    ...
    public Waiter<DescribeAutoScalingGroupsRequest> groupInService() {
        ...
        return new WaiterBuilder<DescribeAutoScalingGroupsRequest, DescribeAutoScalingGroupsResult>()
                ...
                .withAcceptors(new GroupInService.IsFalseMatcher(),
                        new GroupInService.IsTrueMatcher())
    ...
    /**
     * Builds a GroupNotExists waiter by using custom parameters
     * waiterParameters and other parameters defined in the waiters
     * specification, and then polls until it determines whether the resource
     * entered the desired state or not, where polling criteria is bound by
     * either default polling strategy or custom polling strategy.
    ...
    public Waiter<DescribeAutoScalingGroupsRequest> groupNotExists() {
        ...
        return new WaiterBuilder<DescribeAutoScalingGroupsRequest, DescribeAutoScalingGroupsResult>()
                .withSdkFunction(new DescribeAutoScalingGroupsFunction(client))
                .withAcceptors(new GroupNotExists.IsFalseMatcher(),
                        new GroupNotExists.IsTrueMatcher())
                .withDefaultPollingStrategy(
                        new PollingStrategy(new MaxAttemptsRetryStrategy(40),
                                new FixedDelayStrategy(15)))
                .withExecutorService(executorService).build();
    ...
    /**
     * Builds a GroupExists waiter by using custom parameters waiterParameters
    ...
    public Waiter<DescribeAutoScalingGroupsRequest> groupExists() {
        ...
        return new WaiterBuilder<DescribeAutoScalingGroupsRequest, DescribeAutoScalingGroupsResult>()
                .withSdkFunction(new DescribeAutoScalingGroupsFunction(client))
                .withAcceptors(new GroupExists.IsTrueMatcher(),
                        new GroupExists.IsFalseMatcher())
                .withDefaultPollingStrategy(
                        new PollingStrategy(new MaxAttemptsRetryStrategy(10),
