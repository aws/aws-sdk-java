 ...
 */
public class SetInstanceProtectionResultStaxUnmarshaller implements
        Unmarshaller<SetInstanceProtectionResult, StaxUnmarshallerContext> {

    public SetInstanceProtectionResult unmarshall(
