 ...
 */
public class DescribeScalingProcessTypesResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeScalingProcessTypesResult, StaxUnmarshallerContext> {

    public DescribeScalingProcessTypesResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Processes/member", targetDepth)) {
                    describeScalingProcessTypesResult
                            .withProcesses(ProcessTypeStaxUnmarshaller
