 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/LoadForecast" target="_top">AWS API
 *      Documentation</a>
 */
...
public class LoadForecast implements Serializable, Cloneable {
    ...
    public LoadForecast withTimestamps(java.util.Collection<java.util.Date> timestamps) {
    ...
    public LoadForecast withValues(java.util.Collection<Double> values) {
        setValues(values);
        return this;
    }
