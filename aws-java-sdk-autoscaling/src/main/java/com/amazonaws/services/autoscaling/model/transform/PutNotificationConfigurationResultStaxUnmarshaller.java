 ...
 */
public class PutNotificationConfigurationResultStaxUnmarshaller
        implements
        Unmarshaller<PutNotificationConfigurationResult, StaxUnmarshallerContext> {

    public PutNotificationConfigurationResult unmarshall(
