 ...
 */
public class ProcessTypeStaxUnmarshaller implements
        Unmarshaller<ProcessType, StaxUnmarshallerContext> {

    public ProcessType unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ProcessName", targetDepth)) {
                    processType.setProcessName(StringStaxUnmarshaller
