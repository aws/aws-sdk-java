 ...
 */
public class DescribeLoadBalancersResultStaxUnmarshaller implements
        Unmarshaller<DescribeLoadBalancersResult, StaxUnmarshallerContext> {

    public DescribeLoadBalancersResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("LoadBalancers/member", targetDepth)) {
                    describeLoadBalancersResult
                            .withLoadBalancers(LoadBalancerStateStaxUnmarshaller
