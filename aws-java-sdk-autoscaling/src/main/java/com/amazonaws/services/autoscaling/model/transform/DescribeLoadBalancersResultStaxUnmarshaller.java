...
public class DescribeLoadBalancersResultStaxUnmarshaller implements Unmarshaller<DescribeLoadBalancersResult, StaxUnmarshallerContext> {
    ...
    public DescribeLoadBalancersResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeLoadBalancersResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("LoadBalancers/member", targetDepth)) {
                    describeLoadBalancersResult.getLoadBalancers().add(LoadBalancerStateStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    describeLoadBalancersResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeLoadBalancersResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeLoadBalancersResultStaxUnmarshaller();
        return instance;
    }
}
