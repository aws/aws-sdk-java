 ...
 */
public class DescribeScheduledActionsResultStaxUnmarshaller implements
        Unmarshaller<DescribeScheduledActionsResult, StaxUnmarshallerContext> {

    public DescribeScheduledActionsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression(
                        "ScheduledUpdateGroupActions/member", targetDepth)) {
                    describeScheduledActionsResult
                            .getScheduledUpdateGroupActions().add(
