...
public class CreateAutoScalingGroupResultStaxUnmarshaller implements Unmarshaller<CreateAutoScalingGroupResult, StaxUnmarshallerContext> {

    public CreateAutoScalingGroupResult unmarshall(StaxUnmarshallerContext context) throws Exception {
    ...
    public static CreateAutoScalingGroupResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateAutoScalingGroupResultStaxUnmarshaller();
        return instance;
    }
}
