 ...
 */
public class CreateAutoScalingGroupResultStaxUnmarshaller implements
        Unmarshaller<CreateAutoScalingGroupResult, StaxUnmarshallerContext> {

    public CreateAutoScalingGroupResult unmarshall(
