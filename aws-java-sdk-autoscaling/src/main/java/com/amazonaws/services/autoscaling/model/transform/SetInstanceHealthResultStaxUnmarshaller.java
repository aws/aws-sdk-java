 ...
 */
public class SetInstanceHealthResultStaxUnmarshaller implements
        Unmarshaller<SetInstanceHealthResult, StaxUnmarshallerContext> {

    public SetInstanceHealthResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
