 ...
 */
public class LoadBalancerTargetGroupStateStaxUnmarshaller implements
        Unmarshaller<LoadBalancerTargetGroupState, StaxUnmarshallerContext> {

    public LoadBalancerTargetGroupState unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("LoadBalancerTargetGroupARN",
                        targetDepth)) {
                    loadBalancerTargetGroupState
                            .setLoadBalancerTargetGroupARN(StringStaxUnmarshaller
