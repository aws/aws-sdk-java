 ...
 */
public class SuspendedProcessStaxUnmarshaller implements
        Unmarshaller<SuspendedProcess, StaxUnmarshallerContext> {

    public SuspendedProcess unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ProcessName", targetDepth)) {
                    suspendedProcess.setProcessName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("SuspensionReason", targetDepth)) {
                    suspendedProcess.setSuspensionReason(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
