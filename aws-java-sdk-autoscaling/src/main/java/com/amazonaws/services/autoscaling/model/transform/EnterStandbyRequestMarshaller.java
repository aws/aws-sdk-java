...
public class EnterStandbyRequestMarshaller implements
    ...
    public Request<EnterStandbyRequest> marshall(
        ...
        if (enterStandbyRequest.getAutoScalingGroupName() != null) {
            request.addParameter("AutoScalingGroupName", StringUtils
                    .fromString(enterStandbyRequest.getAutoScalingGroupName()));
        }

        if (enterStandbyRequest.getShouldDecrementDesiredCapacity() != null) {
            request.addParameter("ShouldDecrementDesiredCapacity", StringUtils
                    .fromBoolean(enterStandbyRequest
