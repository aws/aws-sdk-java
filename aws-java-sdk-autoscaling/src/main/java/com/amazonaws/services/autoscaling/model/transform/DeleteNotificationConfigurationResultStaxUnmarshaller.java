 ...
 */
public class DeleteNotificationConfigurationResultStaxUnmarshaller
        implements
        Unmarshaller<DeleteNotificationConfigurationResult, StaxUnmarshallerContext> {

    public DeleteNotificationConfigurationResult unmarshall(
