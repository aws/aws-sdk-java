...
class GroupInService {
    ...
    static class IsFalseMatcher extends
        ...
        private static final JmesPathExpression ast = new JmesPathContainsFunction(
                new JmesPathProjection(
                        new JmesPathFlatten(
                                new JmesPathProjection(
                                        new JmesPathFlatten(new JmesPathField(
                                                "AutoScalingGroups")),
                                        new JmesPathMultiSelectList(
                                                new OpGreaterThanOrEqualTo(
                                                        new JmesPathLengthFunction(
                                                                new JmesPathFilter(
                                                                        new JmesPathField(
                                                                                "Instances"),
                                                        ...
                                                        new JmesPathField(
                                                                "MinSize"))))),
                        new JmesPathIdentity()), new JmesPathLiteral("false"));
