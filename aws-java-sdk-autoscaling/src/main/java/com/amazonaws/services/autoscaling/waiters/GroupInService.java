...
class GroupInService {
    ...
    static class IsFalseMatcher extends WaiterAcceptor<DescribeAutoScalingGroupsResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathContainsFunction(new JmesPathProjection(new JmesPathFlatten(new JmesPathProjection(
                new JmesPathFlatten(new JmesPathField("AutoScalingGroups")), new JmesPathMultiSelectList(new OpGreaterThanOrEqualTo(new JmesPathLengthFunction(
                        new JmesPathFilter(new JmesPathField("Instances"), new JmesPathIdentity(), new OpEquals(new JmesPathField("LifecycleState"),
                                new JmesPathLiteral("\"InService\"")))), new JmesPathField("MinSize"))))), new JmesPathIdentity()),
