...
public class PutLifecycleHookRequestMarshaller implements
    ...
    public Request<PutLifecycleHookRequest> marshall(
        ...
        if (putLifecycleHookRequest.getLifecycleHookName() != null) {
            request.addParameter("LifecycleHookName", StringUtils
                    .fromString(putLifecycleHookRequest.getLifecycleHookName()));
        }

        if (putLifecycleHookRequest.getAutoScalingGroupName() != null) {
            request.addParameter("AutoScalingGroupName", StringUtils
                    .fromString(putLifecycleHookRequest
                            .getAutoScalingGroupName()));
        }

        if (putLifecycleHookRequest.getLifecycleTransition() != null) {
            request.addParameter("LifecycleTransition", StringUtils
                    .fromString(putLifecycleHookRequest
        ...
        if (putLifecycleHookRequest.getRoleARN() != null) {
            request.addParameter("RoleARN", StringUtils
                    .fromString(putLifecycleHookRequest.getRoleARN()));
        }

        if (putLifecycleHookRequest.getNotificationTargetARN() != null) {
            request.addParameter("NotificationTargetARN", StringUtils
                    .fromString(putLifecycleHookRequest
                            .getNotificationTargetARN()));
        }

        if (putLifecycleHookRequest.getNotificationMetadata() != null) {
            request.addParameter("NotificationMetadata", StringUtils
                    .fromString(putLifecycleHookRequest
                            .getNotificationMetadata()));
        }

        if (putLifecycleHookRequest.getHeartbeatTimeout() != null) {
            request.addParameter("HeartbeatTimeout", StringUtils
                    .fromInteger(putLifecycleHookRequest.getHeartbeatTimeout()));
        }

        if (putLifecycleHookRequest.getDefaultResult() != null) {
            request.addParameter("DefaultResult", StringUtils
                    .fromString(putLifecycleHookRequest.getDefaultResult()));
        }
