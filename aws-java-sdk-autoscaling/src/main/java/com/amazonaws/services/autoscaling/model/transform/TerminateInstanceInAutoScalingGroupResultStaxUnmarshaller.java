 ...
 */
public class TerminateInstanceInAutoScalingGroupResultStaxUnmarshaller
        implements
        Unmarshaller<TerminateInstanceInAutoScalingGroupResult, StaxUnmarshallerContext> {

    public TerminateInstanceInAutoScalingGroupResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Activity", targetDepth)) {
                    terminateInstanceInAutoScalingGroupResult
                            .setActivity(ActivityStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
