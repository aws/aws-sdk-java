...
/**
 * <p>
 * Specifies the minimum and maximum for the <code>VCpuCount</code> object when you specify <a>InstanceRequirements</a>
 * for an Auto Scaling group.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/VCpuCountRequest" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VCpuCountRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VCpuCountRequest == false)
            return false;
        VCpuCountRequest other = (VCpuCountRequest) obj;
    ...
    public VCpuCountRequest clone() {
        try {
            return (VCpuCountRequest) super.clone();
