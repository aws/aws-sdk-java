 ...
 */
public class PutScalingPolicyResultStaxUnmarshaller implements
        Unmarshaller<PutScalingPolicyResult, StaxUnmarshallerContext> {

    public PutScalingPolicyResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("PolicyARN", targetDepth)) {
                    putScalingPolicyResult.setPolicyARN(StringStaxUnmarshaller
