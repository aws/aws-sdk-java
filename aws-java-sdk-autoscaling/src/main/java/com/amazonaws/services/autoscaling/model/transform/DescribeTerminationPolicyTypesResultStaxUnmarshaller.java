...
public class DescribeTerminationPolicyTypesResultStaxUnmarshaller implements Unmarshaller<DescribeTerminationPolicyTypesResult, StaxUnmarshallerContext> {
    ...
    public DescribeTerminationPolicyTypesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeTerminationPolicyTypesResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("TerminationPolicyTypes/member", targetDepth)) {
                    describeTerminationPolicyTypesResult.getTerminationPolicyTypes().add(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeTerminationPolicyTypesResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeTerminationPolicyTypesResultStaxUnmarshaller();
        return instance;
    }
}
