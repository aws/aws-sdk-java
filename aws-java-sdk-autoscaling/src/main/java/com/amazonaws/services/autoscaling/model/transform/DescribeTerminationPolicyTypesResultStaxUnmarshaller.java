 ...
 */
public class DescribeTerminationPolicyTypesResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeTerminationPolicyTypesResult, StaxUnmarshallerContext> {

    public DescribeTerminationPolicyTypesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("TerminationPolicyTypes/member",
                        targetDepth)) {
                    describeTerminationPolicyTypesResult
                            .withTerminationPolicyTypes(StringStaxUnmarshaller
