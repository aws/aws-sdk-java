 ...
 */
public class PutScheduledUpdateGroupActionResultStaxUnmarshaller
        implements
        Unmarshaller<PutScheduledUpdateGroupActionResult, StaxUnmarshallerContext> {

    public PutScheduledUpdateGroupActionResult unmarshall(
