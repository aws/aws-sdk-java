...
public class DescribeLaunchConfigurationsRequestMarshaller
    ...
    public Request<DescribeLaunchConfigurationsRequest> marshall(
        ...
        if (!launchConfigurationNamesList.isEmpty()
                || !launchConfigurationNamesList.isAutoConstruct()) {
            ...
            for (String launchConfigurationNamesListValue : launchConfigurationNamesList) {
                if (launchConfigurationNamesListValue != null) {
                    request.addParameter("LaunchConfigurationNames.member."
                            + launchConfigurationNamesListIndex, StringUtils
                            .fromString(launchConfigurationNamesListValue));
                }
