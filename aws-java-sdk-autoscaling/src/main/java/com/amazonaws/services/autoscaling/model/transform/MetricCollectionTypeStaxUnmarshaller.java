 ...
 */
public class MetricCollectionTypeStaxUnmarshaller implements
        Unmarshaller<MetricCollectionType, StaxUnmarshallerContext> {

    public MetricCollectionType unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Metric", targetDepth)) {
                    metricCollectionType.setMetric(StringStaxUnmarshaller
