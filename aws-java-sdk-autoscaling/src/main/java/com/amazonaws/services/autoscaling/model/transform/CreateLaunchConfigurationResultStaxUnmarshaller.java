 ...
 */
public class CreateLaunchConfigurationResultStaxUnmarshaller implements
        Unmarshaller<CreateLaunchConfigurationResult, StaxUnmarshallerContext> {

    public CreateLaunchConfigurationResult unmarshall(
