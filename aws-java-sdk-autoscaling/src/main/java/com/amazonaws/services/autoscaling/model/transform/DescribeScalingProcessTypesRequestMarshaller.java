...
public class DescribeScalingProcessTypesRequestMarshaller
        implements
        Marshaller<Request<DescribeScalingProcessTypesRequest>, DescribeScalingProcessTypesRequest> {

    public Request<DescribeScalingProcessTypesRequest> marshall(
        ...
        Request<DescribeScalingProcessTypesRequest> request = new DefaultRequest<DescribeScalingProcessTypesRequest>(
                describeScalingProcessTypesRequest, "AmazonAutoScaling");
