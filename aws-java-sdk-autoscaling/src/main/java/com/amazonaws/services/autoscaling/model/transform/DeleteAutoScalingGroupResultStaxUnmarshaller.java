 ...
 */
public class DeleteAutoScalingGroupResultStaxUnmarshaller implements
        Unmarshaller<DeleteAutoScalingGroupResult, StaxUnmarshallerContext> {

    public DeleteAutoScalingGroupResult unmarshall(
