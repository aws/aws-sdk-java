...
public class AdjustmentTypeStaxUnmarshaller implements Unmarshaller<AdjustmentType, StaxUnmarshallerContext> {
    ...
    public AdjustmentType unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return adjustmentType;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("AdjustmentType", targetDepth)) {
                    adjustmentType.setAdjustmentType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static AdjustmentTypeStaxUnmarshaller getInstance() {
        if (instance == null) instance = new AdjustmentTypeStaxUnmarshaller();
        return instance;
    }
}
