 ...
 */
public class AdjustmentTypeStaxUnmarshaller implements
        Unmarshaller<AdjustmentType, StaxUnmarshallerContext> {

    public AdjustmentType unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("AdjustmentType", targetDepth)) {
                    adjustmentType.setAdjustmentType(StringStaxUnmarshaller
