...
/**
 * DimensionValues JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DimensionValuesJsonUnmarshaller implements Unmarshaller<DimensionValues, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    dimensionValues.setKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static DimensionValuesJsonUnmarshaller instance;

    public static DimensionValuesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DimensionValuesJsonUnmarshaller();
        return instance;
    }
}
