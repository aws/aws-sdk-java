...
/**
 * Client for accessing AWS Free Tier asynchronously. Each asynchronous method will return a Java Future object
...
public class AWSFreeTierAsyncClient extends AWSFreeTierClient implements AWSFreeTierAsync {
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on AWS Free Tier using the specified parameters.
     *
    ...
    @Override
    public java.util.concurrent.Future<GetFreeTierUsageResult> getFreeTierUsageAsync(GetFreeTierUsageRequest request) {

        return getFreeTierUsageAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<GetFreeTierUsageResult> getFreeTierUsageAsync(final GetFreeTierUsageRequest request,
            final com.amazonaws.handlers.AsyncHandler<GetFreeTierUsageRequest, GetFreeTierUsageResult> asyncHandler) {
        final GetFreeTierUsageRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<GetFreeTierUsageResult>() {
            @Override
            public GetFreeTierUsageResult call() throws Exception {
                GetFreeTierUsageResult result = null;

                try {
                    result = executeGetFreeTierUsage(finalRequest);
                } catch (Exception ex) {
