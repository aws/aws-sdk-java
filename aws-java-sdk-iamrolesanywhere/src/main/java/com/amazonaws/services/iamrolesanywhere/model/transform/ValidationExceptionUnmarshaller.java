...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.iamrolesanywhere.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.iamrolesanywhere.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iamrolesanywhere.model.ValidationException validationException = new com.amazonaws.services.iamrolesanywhere.model.ValidationException(
                null);
