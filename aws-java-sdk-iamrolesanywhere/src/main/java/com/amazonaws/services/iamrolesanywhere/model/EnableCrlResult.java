...
public class EnableCrlResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public EnableCrlResult withCrl(CrlDetail crl) {
        setCrl(crl);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableCrlResult == false)
            return false;
        EnableCrlResult other = (EnableCrlResult) obj;
    ...
    @Override
    public EnableCrlResult clone() {
        try {
            return (EnableCrlResult) super.clone();
