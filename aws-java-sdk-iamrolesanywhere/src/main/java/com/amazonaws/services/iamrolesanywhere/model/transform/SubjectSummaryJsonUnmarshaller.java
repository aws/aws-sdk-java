...
/**
 * SubjectSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SubjectSummaryJsonUnmarshaller implements Unmarshaller<SubjectSummary, JsonUnmarshallerContext> {

    public SubjectSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SubjectSummaryJsonUnmarshaller instance;

    public static SubjectSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SubjectSummaryJsonUnmarshaller();
        return instance;
    }
}
