...
public class DisableProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DisableProfileResult withProfile(ProfileDetail profile) {
        setProfile(profile);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableProfileResult == false)
            return false;
        DisableProfileResult other = (DisableProfileResult) obj;
    ...
    @Override
    public DisableProfileResult clone() {
        try {
            return (DisableProfileResult) super.clone();
