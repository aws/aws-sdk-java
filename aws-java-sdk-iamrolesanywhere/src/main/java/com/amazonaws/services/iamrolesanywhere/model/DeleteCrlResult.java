...
public class DeleteCrlResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteCrlResult withCrl(CrlDetail crl) {
        setCrl(crl);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteCrlResult == false)
            return false;
        DeleteCrlResult other = (DeleteCrlResult) obj;
    ...
    @Override
    public DeleteCrlResult clone() {
        try {
            return (DeleteCrlResult) super.clone();
