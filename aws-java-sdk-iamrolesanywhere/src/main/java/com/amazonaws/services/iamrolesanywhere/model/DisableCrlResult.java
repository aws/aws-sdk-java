...
public class DisableCrlResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableCrlResult == false)
            return false;
        DisableCrlResult other = (DisableCrlResult) obj;
    ...
    public DisableCrlResult clone() {
        try {
            return (DisableCrlResult) super.clone();
