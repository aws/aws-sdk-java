...
public class GetSubjectResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The state of the subject after a read or write operation.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSubjectResult == false)
            return false;
        GetSubjectResult other = (GetSubjectResult) obj;
    ...
    public GetSubjectResult clone() {
        try {
            return (GetSubjectResult) super.clone();
