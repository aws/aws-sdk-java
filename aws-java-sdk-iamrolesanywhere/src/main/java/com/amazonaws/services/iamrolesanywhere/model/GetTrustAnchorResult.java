...
public class GetTrustAnchorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTrustAnchorResult == false)
            return false;
        GetTrustAnchorResult other = (GetTrustAnchorResult) obj;
    ...
    @Override
    public GetTrustAnchorResult clone() {
        try {
            return (GetTrustAnchorResult) super.clone();
