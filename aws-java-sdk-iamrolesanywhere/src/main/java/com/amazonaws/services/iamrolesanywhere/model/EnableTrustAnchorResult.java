...
public class EnableTrustAnchorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableTrustAnchorResult == false)
            return false;
        EnableTrustAnchorResult other = (EnableTrustAnchorResult) obj;
    ...
    @Override
    public EnableTrustAnchorResult clone() {
        try {
            return (EnableTrustAnchorResult) super.clone();
