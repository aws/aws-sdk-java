...
public class DeleteAttributeMappingResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAttributeMappingResult == false)
            return false;
        DeleteAttributeMappingResult other = (DeleteAttributeMappingResult) obj;
    ...
    public DeleteAttributeMappingResult clone() {
        try {
            return (DeleteAttributeMappingResult) super.clone();
