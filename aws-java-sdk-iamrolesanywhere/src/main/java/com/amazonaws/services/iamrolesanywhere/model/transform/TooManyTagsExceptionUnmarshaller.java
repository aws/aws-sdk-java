...
public class TooManyTagsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private TooManyTagsExceptionUnmarshaller() {
        super(com.amazonaws.services.iamrolesanywhere.model.TooManyTagsException.class, "TooManyTagsException");
    }

    @Override
    public com.amazonaws.services.iamrolesanywhere.model.TooManyTagsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iamrolesanywhere.model.TooManyTagsException tooManyTagsException = new com.amazonaws.services.iamrolesanywhere.model.TooManyTagsException(
                null);
