...
public class EnableCrlRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableCrlRequest == false)
            return false;
        EnableCrlRequest other = (EnableCrlRequest) obj;
    ...
    @Override
    public EnableCrlRequest clone() {
        return (EnableCrlRequest) super.clone();
    }
