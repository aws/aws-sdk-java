...
public class MappingRuleMarshaller {
    ...
    private static final MarshallingInfo<String> SPECIFIER_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("specifier").build();
    ...
    public void marshall(MappingRule mappingRule, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(mappingRule.getSpecifier(), SPECIFIER_BINDING);
        } catch (Exception e) {
