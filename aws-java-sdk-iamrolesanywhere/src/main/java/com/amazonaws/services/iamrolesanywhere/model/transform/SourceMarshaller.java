...
public class SourceMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> SOURCEDATA_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("sourceData").build();
    ...
    public void marshall(Source source, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(source.getSourceData(), SOURCEDATA_BINDING);
            protocolMarshaller.marshall(source.getSourceType(), SOURCETYPE_BINDING);
        } catch (Exception e) {
