...
public class UpdateTrustAnchorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateTrustAnchorResult == false)
            return false;
        UpdateTrustAnchorResult other = (UpdateTrustAnchorResult) obj;
    ...
    public UpdateTrustAnchorResult clone() {
        try {
            return (UpdateTrustAnchorResult) super.clone();
