...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.iamrolesanywhere.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.iamrolesanywhere.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iamrolesanywhere.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.iamrolesanywhere.model.AccessDeniedException(
                null);
