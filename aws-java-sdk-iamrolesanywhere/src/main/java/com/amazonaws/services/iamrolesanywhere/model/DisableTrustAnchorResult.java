...
public class DisableTrustAnchorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableTrustAnchorResult == false)
            return false;
        DisableTrustAnchorResult other = (DisableTrustAnchorResult) obj;
    ...
    @Override
    public DisableTrustAnchorResult clone() {
        try {
            return (DisableTrustAnchorResult) super.clone();
