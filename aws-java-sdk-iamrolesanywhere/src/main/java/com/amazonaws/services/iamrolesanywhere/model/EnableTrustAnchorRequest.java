...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/rolesanywhere-2018-05-10/EnableTrustAnchor" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EnableTrustAnchorRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public EnableTrustAnchorRequest withTrustAnchorId(String trustAnchorId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableTrustAnchorRequest == false)
            return false;
        EnableTrustAnchorRequest other = (EnableTrustAnchorRequest) obj;
    ...
    @Override
    public EnableTrustAnchorRequest clone() {
        return (EnableTrustAnchorRequest) super.clone();
    }
