...
public class DescribeExecutionRequestMarshaller {
    ...
    public void marshall(DescribeExecutionRequest describeExecutionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeExecutionRequest.getManagedDeviceId(), MANAGEDDEVICEID_BINDING);
            protocolMarshaller.marshall(describeExecutionRequest.getTaskId(), TASKID_BINDING);
        } catch (Exception e) {
