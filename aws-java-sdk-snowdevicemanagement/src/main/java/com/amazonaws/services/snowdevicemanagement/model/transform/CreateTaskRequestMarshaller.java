...
public class CreateTaskRequestMarshaller {
    ...
    public void marshall(CreateTaskRequest createTaskRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createTaskRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createTaskRequest.getCommand(), COMMAND_BINDING);
            protocolMarshaller.marshall(createTaskRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(createTaskRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(createTaskRequest.getTargets(), TARGETS_BINDING);
        } catch (Exception e) {
