...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.snowdevicemanagement.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.snowdevicemanagement.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.snowdevicemanagement.model.ValidationException validationException = new com.amazonaws.services.snowdevicemanagement.model.ValidationException(
                null);
