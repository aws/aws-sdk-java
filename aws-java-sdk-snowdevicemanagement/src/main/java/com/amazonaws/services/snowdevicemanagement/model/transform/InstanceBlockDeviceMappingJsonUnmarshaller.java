...
/**
 * InstanceBlockDeviceMapping JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceBlockDeviceMappingJsonUnmarshaller implements Unmarshaller<InstanceBlockDeviceMapping, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("deviceName", targetDepth)) {
                    context.nextToken();
                    instanceBlockDeviceMapping.setDeviceName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ebs", targetDepth)) {
                    context.nextToken();
                    instanceBlockDeviceMapping.setEbs(EbsInstanceBlockDeviceJsonUnmarshaller.getInstance().unmarshall(context));
                }
