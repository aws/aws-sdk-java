...
public class ListCheckDetailsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListCheckDetailsRequest withMaxResults(Integer maxResults) {
    ...
    public ListCheckDetailsRequest withLensArn(String lensArn) {
        setLensArn(lensArn);
        return this;
    }
    ...
    public ListCheckDetailsRequest withPillarId(String pillarId) {
    ...
    public ListCheckDetailsRequest withQuestionId(String questionId) {
    ...
    public ListCheckDetailsRequest withChoiceId(String choiceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCheckDetailsRequest == false)
            return false;
        ListCheckDetailsRequest other = (ListCheckDetailsRequest) obj;
    ...
    @Override
    public ListCheckDetailsRequest clone() {
        return (ListCheckDetailsRequest) super.clone();
    }
