 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/wellarchitected-2020-03-31/AssociateLenses" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssociateLensesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public AssociateLensesRequest withWorkloadId(String workloadId) {
    ...
    public AssociateLensesRequest withLensAliases(String... lensAliases) {
    ...
    public AssociateLensesRequest withLensAliases(java.util.Collection<String> lensAliases) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateLensesRequest == false)
            return false;
    ...
    @Override
    public AssociateLensesRequest clone() {
        return (AssociateLensesRequest) super.clone();
    }
