...
public class UpdateIntegrationRequestMarshaller {
    ...
    private static final MarshallingInfo<String> INTEGRATINGSERVICE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("IntegratingService").build();
    ...
    public void marshall(UpdateIntegrationRequest updateIntegrationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateIntegrationRequest.getWorkloadId(), WORKLOADID_BINDING);
            protocolMarshaller.marshall(updateIntegrationRequest.getClientRequestToken(), CLIENTREQUESTTOKEN_BINDING);
            protocolMarshaller.marshall(updateIntegrationRequest.getIntegratingService(), INTEGRATINGSERVICE_BINDING);
        } catch (Exception e) {
