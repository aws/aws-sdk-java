...
/**
 * AssociateLensesResult JSON Unmarshaller
 */
...
public class AssociateLensesResultJsonUnmarshaller implements Unmarshaller<AssociateLensesResult, JsonUnmarshallerContext> {
    ...
    public AssociateLensesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateLensesResult associateLensesResult = new AssociateLensesResult();
