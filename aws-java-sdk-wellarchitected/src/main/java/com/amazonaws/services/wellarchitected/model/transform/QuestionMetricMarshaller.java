...
public class QuestionMetricMarshaller {
    ...
    private static final MarshallingInfo<List> BESTPRACTICES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("BestPractices").build();
    ...
    public void marshall(QuestionMetric questionMetric, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(questionMetric.getQuestionId(), QUESTIONID_BINDING);
            protocolMarshaller.marshall(questionMetric.getRisk(), RISK_BINDING);
