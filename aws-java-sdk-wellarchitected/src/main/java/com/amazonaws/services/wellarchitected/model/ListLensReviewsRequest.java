...
public class ListLensReviewsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListLensReviewsRequest withMilestoneNumber(Integer milestoneNumber) {
    ...
    public ListLensReviewsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLensReviewsRequest == false)
            return false;
        ListLensReviewsRequest other = (ListLensReviewsRequest) obj;
    ...
    @Override
    public ListLensReviewsRequest clone() {
        return (ListLensReviewsRequest) super.clone();
    }
