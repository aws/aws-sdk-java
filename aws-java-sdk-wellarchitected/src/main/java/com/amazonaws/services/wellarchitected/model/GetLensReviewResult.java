...
public class GetLensReviewResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetLensReviewResult withWorkloadId(String workloadId) {
    ...
    public GetLensReviewResult withMilestoneNumber(Integer milestoneNumber) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetLensReviewResult == false)
            return false;
        GetLensReviewResult other = (GetLensReviewResult) obj;
    ...
    @Override
    public GetLensReviewResult clone() {
        try {
