...
public class ImportLensRequestMarshaller {
    ...
    private static final MarshallingInfo<String> JSONSTRING_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("JSONString").build();
    ...
    public void marshall(ImportLensRequest importLensRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(importLensRequest.getLensAlias(), LENSALIAS_BINDING);
            protocolMarshaller.marshall(importLensRequest.getJSONString(), JSONSTRING_BINDING);
            protocolMarshaller.marshall(importLensRequest.getClientRequestToken(), CLIENTREQUESTTOKEN_BINDING);
