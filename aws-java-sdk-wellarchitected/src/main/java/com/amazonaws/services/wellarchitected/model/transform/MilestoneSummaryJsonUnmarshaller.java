...
/**
 * MilestoneSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MilestoneSummaryJsonUnmarshaller implements Unmarshaller<MilestoneSummary, JsonUnmarshallerContext> {

    public MilestoneSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static MilestoneSummaryJsonUnmarshaller instance;

    public static MilestoneSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MilestoneSummaryJsonUnmarshaller();
        return instance;
    }
}
