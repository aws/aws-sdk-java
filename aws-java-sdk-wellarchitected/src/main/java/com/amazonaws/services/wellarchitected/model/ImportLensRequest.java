...
public class ImportLensRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Tags to associate to a lens.
     */
    ...
    public ImportLensRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ImportLensRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ImportLensRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportLensRequest == false)
            return false;
        ImportLensRequest other = (ImportLensRequest) obj;
        ...
        if (other.getLensAlias() != null && other.getLensAlias().equals(this.getLensAlias()) == false)
            return false;
        if (other.getJSONString() == null ^ this.getJSONString() == null)
            return false;
        if (other.getJSONString() != null && other.getJSONString().equals(this.getJSONString()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getJSONString() == null) ? 0 : getJSONString().hashCode());
    ...
    public ImportLensRequest clone() {
        return (ImportLensRequest) super.clone();
    }
