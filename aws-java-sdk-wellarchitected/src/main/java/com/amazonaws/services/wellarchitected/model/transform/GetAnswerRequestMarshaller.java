...
/**
 * GetAnswerRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetAnswerRequestMarshaller {
    ...
    private static final GetAnswerRequestMarshaller instance = new GetAnswerRequestMarshaller();

    public static GetAnswerRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetAnswerRequest getAnswerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getAnswerRequest.getWorkloadId(), WORKLOADID_BINDING);
            protocolMarshaller.marshall(getAnswerRequest.getLensAlias(), LENSALIAS_BINDING);
            protocolMarshaller.marshall(getAnswerRequest.getQuestionId(), QUESTIONID_BINDING);
            protocolMarshaller.marshall(getAnswerRequest.getMilestoneNumber(), MILESTONENUMBER_BINDING);
        } catch (Exception e) {
