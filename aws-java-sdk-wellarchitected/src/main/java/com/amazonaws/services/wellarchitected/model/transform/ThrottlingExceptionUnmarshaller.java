...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.wellarchitected.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.wellarchitected.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.wellarchitected.model.ThrottlingException throttlingException = new com.amazonaws.services.wellarchitected.model.ThrottlingException(
                null);
