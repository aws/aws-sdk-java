...
public class CopyClusterSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CopyClusterSnapshotResult withSnapshot(ClusterSnapshot snapshot) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CopyClusterSnapshotResult == false)
            return false;
        CopyClusterSnapshotResult other = (CopyClusterSnapshotResult) obj;
    ...
    @Override
    public CopyClusterSnapshotResult clone() {
        try {
            return (CopyClusterSnapshotResult) super.clone();
