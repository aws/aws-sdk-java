...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.docdbelastic.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.docdbelastic.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.docdbelastic.model.ConflictException conflictException = new com.amazonaws.services.docdbelastic.model.ConflictException(null);
