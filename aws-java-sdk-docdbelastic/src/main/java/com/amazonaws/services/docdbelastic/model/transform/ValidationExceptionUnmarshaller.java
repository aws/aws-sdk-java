...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.docdbelastic.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.docdbelastic.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.docdbelastic.model.ValidationException validationException = new com.amazonaws.services.docdbelastic.model.ValidationException(
                null);
