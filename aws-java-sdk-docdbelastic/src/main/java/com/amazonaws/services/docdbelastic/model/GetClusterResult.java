...
public class GetClusterResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetClusterResult == false)
            return false;
        GetClusterResult other = (GetClusterResult) obj;
    ...
    @Override
    public GetClusterResult clone() {
        try {
            return (GetClusterResult) super.clone();
