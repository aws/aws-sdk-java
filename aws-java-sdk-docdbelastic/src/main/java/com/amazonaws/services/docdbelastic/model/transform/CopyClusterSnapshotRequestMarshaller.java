...
public class CopyClusterSnapshotRequestMarshaller {
    ...
    private static final CopyClusterSnapshotRequestMarshaller instance = new CopyClusterSnapshotRequestMarshaller();

    public static CopyClusterSnapshotRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CopyClusterSnapshotRequest copyClusterSnapshotRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(copyClusterSnapshotRequest.getCopyTags(), COPYTAGS_BINDING);
            protocolMarshaller.marshall(copyClusterSnapshotRequest.getKmsKeyId(), KMSKEYID_BINDING);
            protocolMarshaller.marshall(copyClusterSnapshotRequest.getSnapshotArn(), SNAPSHOTARN_BINDING);
            protocolMarshaller.marshall(copyClusterSnapshotRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(copyClusterSnapshotRequest.getTargetSnapshotName(), TARGETSNAPSHOTNAME_BINDING);
        } catch (Exception e) {
