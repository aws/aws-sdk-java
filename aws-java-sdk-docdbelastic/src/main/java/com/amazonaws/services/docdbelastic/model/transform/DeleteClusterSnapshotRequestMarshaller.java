...
public class DeleteClusterSnapshotRequestMarshaller {
    ...
    private static final DeleteClusterSnapshotRequestMarshaller instance = new DeleteClusterSnapshotRequestMarshaller();

    public static DeleteClusterSnapshotRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteClusterSnapshotRequest deleteClusterSnapshotRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteClusterSnapshotRequest.getSnapshotArn(), SNAPSHOTARN_BINDING);
        } catch (Exception e) {
