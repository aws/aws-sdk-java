...
/**
 * ClusterSnapshotInListMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ClusterSnapshotInListMarshaller {
    ...
    private static final ClusterSnapshotInListMarshaller instance = new ClusterSnapshotInListMarshaller();

    public static ClusterSnapshotInListMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ClusterSnapshotInList clusterSnapshotInList, ProtocolMarshaller protocolMarshaller) {

        if (clusterSnapshotInList == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(clusterSnapshotInList.getClusterArn(), CLUSTERARN_BINDING);
            protocolMarshaller.marshall(clusterSnapshotInList.getSnapshotArn(), SNAPSHOTARN_BINDING);
            protocolMarshaller.marshall(clusterSnapshotInList.getSnapshotCreationTime(), SNAPSHOTCREATIONTIME_BINDING);
            protocolMarshaller.marshall(clusterSnapshotInList.getSnapshotName(), SNAPSHOTNAME_BINDING);
            protocolMarshaller.marshall(clusterSnapshotInList.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
