...
/**
 * ClusterSnapshotInList JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ClusterSnapshotInListJsonUnmarshaller implements Unmarshaller<ClusterSnapshotInList, JsonUnmarshallerContext> {

    public ClusterSnapshotInList unmarshall(JsonUnmarshallerContext context) throws Exception {
        ClusterSnapshotInList clusterSnapshotInList = new ClusterSnapshotInList();
    ...
    private static ClusterSnapshotInListJsonUnmarshaller instance;

    public static ClusterSnapshotInListJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ClusterSnapshotInListJsonUnmarshaller();
        return instance;
    }
}
