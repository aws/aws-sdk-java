...
public class StopModelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * from <code>StopModel</code>. In this case, safely retry your call to <code>StopModel</code> by using the same
     * <code>ClientToken</code> parameter value. An error occurs if the other input parameters are not the same as in
     * the first request. Using a different value for <code>ClientToken</code> is considered a new call to
     ...
     *        choose the value to pass. For example, An issue, such as an network outage, might prevent you from getting
     *        a response from <code>StopModel</code>. In this case, safely retry your call to <code>StopModel</code> by
     ...
     *        new call to <code>StopModel</code>. An idempotency token is active for 8 hours.
     */
     ...
     *         getting a response from <code>StopModel</code>. In this case, safely retry your call to
     *         <code>StopModel</code> by using the same <code>ClientToken</code> parameter value. An error occurs if the
     *         other input parameters are not the same as in the first request. Using a different value for
     *         <code>ClientToken</code> is considered a new call to <code>StopModel</code>. An idempotency token is
     *         active for 8 hours.
     */
