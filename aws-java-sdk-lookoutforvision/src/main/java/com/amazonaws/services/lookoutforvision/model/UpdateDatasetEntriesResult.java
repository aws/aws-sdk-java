...
public class UpdateDatasetEntriesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDatasetEntriesResult == false)
            return false;
        UpdateDatasetEntriesResult other = (UpdateDatasetEntriesResult) obj;
    ...
    public UpdateDatasetEntriesResult clone() {
        try {
            return (UpdateDatasetEntriesResult) super.clone();
