...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.lookoutforvision.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.lookoutforvision.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.lookoutforvision.model.ValidationException validationException = new com.amazonaws.services.lookoutforvision.model.ValidationException(
                null);
