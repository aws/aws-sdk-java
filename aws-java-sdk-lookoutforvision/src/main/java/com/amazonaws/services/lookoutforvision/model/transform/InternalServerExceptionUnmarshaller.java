...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.lookoutforvision.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.lookoutforvision.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.lookoutforvision.model.InternalServerException internalServerException = new com.amazonaws.services.lookoutforvision.model.InternalServerException(
                null);
