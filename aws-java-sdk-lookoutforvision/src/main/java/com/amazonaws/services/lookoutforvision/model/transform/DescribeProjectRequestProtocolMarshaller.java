...
public class DescribeProjectRequestProtocolMarshaller implements Marshaller<Request<DescribeProjectRequest>, DescribeProjectRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.REST_JSON)
            .requestUri("/2020-11-20/projects/{projectName}").httpMethodName(HttpMethodName.GET).hasExplicitPayloadMember(false).hasPayloadMembers(false)
            .serviceName("AmazonLookoutforVision").build();
