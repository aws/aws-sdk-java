        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    anomaly.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("PixelAnomaly", targetDepth)) {
                    context.nextToken();
                    anomaly.setPixelAnomaly(PixelAnomalyJsonUnmarshaller.getInstance().unmarshall(context));
                }
