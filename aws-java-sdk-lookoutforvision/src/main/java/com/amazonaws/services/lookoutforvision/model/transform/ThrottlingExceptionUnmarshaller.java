...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.lookoutforvision.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.lookoutforvision.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.lookoutforvision.model.ThrottlingException throttlingException = new com.amazonaws.services.lookoutforvision.model.ThrottlingException(
                null);
