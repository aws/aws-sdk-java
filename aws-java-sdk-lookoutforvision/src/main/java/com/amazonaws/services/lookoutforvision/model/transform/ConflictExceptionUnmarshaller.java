...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.lookoutforvision.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.lookoutforvision.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.lookoutforvision.model.ConflictException conflictException = new com.amazonaws.services.lookoutforvision.model.ConflictException(
                null);
