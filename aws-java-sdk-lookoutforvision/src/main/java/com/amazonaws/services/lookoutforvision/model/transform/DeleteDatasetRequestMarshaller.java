...
public class DeleteDatasetRequestMarshaller {
    ...
    public void marshall(DeleteDatasetRequest deleteDatasetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteDatasetRequest.getProjectName(), PROJECTNAME_BINDING);
            protocolMarshaller.marshall(deleteDatasetRequest.getDatasetType(), DATASETTYPE_BINDING);
            protocolMarshaller.marshall(deleteDatasetRequest.getClientToken(), CLIENTTOKEN_BINDING);
        } catch (Exception e) {
