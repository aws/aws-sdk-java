    ...
    public CreateProjectResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ProjectMetadata", targetDepth)) {
                    context.nextToken();
                    createProjectResult.setProjectMetadata(ProjectMetadataJsonUnmarshaller.getInstance().unmarshall(context));
                }
