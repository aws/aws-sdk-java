...
/**
 * ConnectorRuntimeSetting JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConnectorRuntimeSettingJsonUnmarshaller implements Unmarshaller<ConnectorRuntimeSetting, JsonUnmarshallerContext> {

    public ConnectorRuntimeSetting unmarshall(JsonUnmarshallerContext context) throws Exception {
        ConnectorRuntimeSetting connectorRuntimeSetting = new ConnectorRuntimeSetting();
    ...
    private static ConnectorRuntimeSettingJsonUnmarshaller instance;

    public static ConnectorRuntimeSettingJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConnectorRuntimeSettingJsonUnmarshaller();
        return instance;
    }
}
