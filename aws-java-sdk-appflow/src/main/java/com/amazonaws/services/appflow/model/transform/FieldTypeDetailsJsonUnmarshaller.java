...
/**
 * FieldTypeDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FieldTypeDetailsJsonUnmarshaller implements Unmarshaller<FieldTypeDetails, JsonUnmarshallerContext> {

    public FieldTypeDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        FieldTypeDetails fieldTypeDetails = new FieldTypeDetails();
    ...
    private static FieldTypeDetailsJsonUnmarshaller instance;

    public static FieldTypeDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FieldTypeDetailsJsonUnmarshaller();
        return instance;
    }
}
