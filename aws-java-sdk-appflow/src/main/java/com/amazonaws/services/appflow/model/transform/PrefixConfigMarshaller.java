...
public class PrefixConfigMarshaller {
    ...
    private static final MarshallingInfo<List> PATHPREFIXHIERARCHY_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("pathPrefixHierarchy").build();
    ...
    public void marshall(PrefixConfig prefixConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(prefixConfig.getPathPrefixHierarchy(), PATHPREFIXHIERARCHY_BINDING);
        } catch (Exception e) {
