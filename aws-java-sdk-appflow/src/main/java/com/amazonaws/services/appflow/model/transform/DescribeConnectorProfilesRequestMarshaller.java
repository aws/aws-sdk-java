...
public class DescribeConnectorProfilesRequestMarshaller {
    ...
    private static final MarshallingInfo<List> CONNECTORPROFILENAMES_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
    ...
    private static final DescribeConnectorProfilesRequestMarshaller instance = new DescribeConnectorProfilesRequestMarshaller();

    public static DescribeConnectorProfilesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeConnectorProfilesRequest describeConnectorProfilesRequest, ProtocolMarshaller protocolMarshaller) {
