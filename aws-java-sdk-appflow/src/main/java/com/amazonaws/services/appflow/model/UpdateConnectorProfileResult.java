...
public class UpdateConnectorProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateConnectorProfileResult withConnectorProfileArn(String connectorProfileArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateConnectorProfileResult == false)
            return false;
        UpdateConnectorProfileResult other = (UpdateConnectorProfileResult) obj;
    ...
    @Override
    public UpdateConnectorProfileResult clone() {
        try {
            return (UpdateConnectorProfileResult) super.clone();
