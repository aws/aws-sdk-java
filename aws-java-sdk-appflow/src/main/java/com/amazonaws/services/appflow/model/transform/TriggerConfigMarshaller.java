...
public class TriggerConfigMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> TRIGGERPROPERTIES_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("triggerProperties").build();
    ...
    public void marshall(TriggerConfig triggerConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(triggerConfig.getTriggerType(), TRIGGERTYPE_BINDING);
            protocolMarshaller.marshall(triggerConfig.getTriggerProperties(), TRIGGERPROPERTIES_BINDING);
        } catch (Exception e) {
