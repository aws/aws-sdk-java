 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appflow-2020-08-23/EventBridgeDestinationProperties"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EventBridgeDestinationProperties implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The object specified in the Amazon EventBridge flow destination.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EventBridgeDestinationProperties == false)
            return false;
        EventBridgeDestinationProperties other = (EventBridgeDestinationProperties) obj;
    ...
    public EventBridgeDestinationProperties clone() {
        try {
            return (EventBridgeDestinationProperties) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appflow.model.transform.EventBridgeDestinationPropertiesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
