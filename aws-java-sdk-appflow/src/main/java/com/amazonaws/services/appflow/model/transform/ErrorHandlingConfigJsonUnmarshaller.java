...
/**
 * ErrorHandlingConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ErrorHandlingConfigJsonUnmarshaller implements Unmarshaller<ErrorHandlingConfig, JsonUnmarshallerContext> {

    public ErrorHandlingConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ErrorHandlingConfigJsonUnmarshaller instance;

    public static ErrorHandlingConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ErrorHandlingConfigJsonUnmarshaller();
        return instance;
    }
}
