 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appflow-2020-08-23/ConnectorProvisioningConfig"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConnectorProvisioningConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public LambdaConnectorProvisioningConfig getLambda() {
        return this.lambda;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConnectorProvisioningConfig == false)
            return false;
    ...
    public ConnectorProvisioningConfig clone() {
        try {
            return (ConnectorProvisioningConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appflow.model.transform.ConnectorProvisioningConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
