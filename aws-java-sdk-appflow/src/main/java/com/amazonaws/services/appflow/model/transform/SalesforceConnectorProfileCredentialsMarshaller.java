...
/**
 * SalesforceConnectorProfileCredentialsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SalesforceConnectorProfileCredentialsMarshaller {
    ...
    public static SalesforceConnectorProfileCredentialsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SalesforceConnectorProfileCredentials salesforceConnectorProfileCredentials, ProtocolMarshaller protocolMarshaller) {

        if (salesforceConnectorProfileCredentials == null) {
