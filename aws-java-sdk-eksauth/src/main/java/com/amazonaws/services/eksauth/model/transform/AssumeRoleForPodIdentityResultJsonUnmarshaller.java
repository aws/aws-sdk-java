...
/**
 * AssumeRoleForPodIdentityResult JSON Unmarshaller
 */
...
public class AssumeRoleForPodIdentityResultJsonUnmarshaller implements Unmarshaller<AssumeRoleForPodIdentityResult, JsonUnmarshallerContext> {
    ...
    public AssumeRoleForPodIdentityResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("subject", targetDepth)) {
                    context.nextToken();
                    assumeRoleForPodIdentityResult.setSubject(SubjectJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("audience", targetDepth)) {
                    context.nextToken();
                    assumeRoleForPodIdentityResult.setAudience(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("podIdentityAssociation", targetDepth)) {
                    context.nextToken();
                    assumeRoleForPodIdentityResult.setPodIdentityAssociation(PodIdentityAssociationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("assumedRoleUser", targetDepth)) {
                    context.nextToken();
                    assumeRoleForPodIdentityResult.setAssumedRoleUser(AssumedRoleUserJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("credentials", targetDepth)) {
                    context.nextToken();
                    assumeRoleForPodIdentityResult.setCredentials(CredentialsJsonUnmarshaller.getInstance().unmarshall(context));
                }
