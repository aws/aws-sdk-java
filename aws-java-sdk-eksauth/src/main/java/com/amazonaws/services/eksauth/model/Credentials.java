 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/eks-auth-2023-11-26/Credentials" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Credentials implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The token that applications inside the pods must pass to any service API to use the temporary
     *         credentials.
     */
     ...
     * </p>
     * 
     * @return The secret access key that applications inside the pods use to sign requests.
     */
     ...
     * </p>
     * 
     * @return The Unix epoch timestamp in seconds when the current credentials expire.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.eksauth.model.transform.CredentialsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
