 ...
 */
public class OptionGroupMembershipStaxUnmarshaller implements
        Unmarshaller<OptionGroupMembership, StaxUnmarshallerContext> {

    public OptionGroupMembership unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("OptionGroupName", targetDepth)) {
                    optionGroupMembership
                            .setOptionGroupName(StringStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Status", targetDepth)) {
                    optionGroupMembership.setStatus(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
