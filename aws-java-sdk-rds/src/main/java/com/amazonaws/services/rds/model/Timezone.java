...
/**
 * <p>
 * A time zone associated with a <a>DBInstance</a> or a <a>DBSnapshot</a>. This
 * data type is an element in the response to the <a>DescribeDBInstances</a>,
 * the <a>DescribeDBSnapshots</a>, and the <a>DescribeDBEngineVersions</a>
 * actions.
 * </p>
 */
public class Timezone implements Serializable, Cloneable {
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getTimezoneName() == null) ? 0 : getTimezoneName()
                        .hashCode());
        return hashCode;
    }
