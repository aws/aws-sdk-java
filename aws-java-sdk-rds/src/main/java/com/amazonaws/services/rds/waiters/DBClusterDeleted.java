...
class DBClusterDeleted {
    ...
    static class IsTrueMatcher extends WaiterAcceptor<DescribeDBClustersResult> {
        ...
        private static final JmesPathExpression ast = new OpEquals(new JmesPathLengthFunction(new JmesPathField("DBClusters")), new JmesPathLiteral("0"));
         ...
         */
        @Override
        public boolean matches(DescribeDBClustersResult result) {
    ...
    static class IsDBClusterNotFoundFaultMatcher extends WaiterAcceptor<DescribeDBClustersResult> {
        /**
        ...
        public boolean matches(AmazonServiceException e) {
            return "DBClusterNotFoundFault".equals(e.getErrorCode());
        }
    ...
    static class IsCreatingMatcher extends WaiterAcceptor<DescribeDBClustersResult> {
        private static final JsonNode expectedResult;
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("DBClusters")), new JmesPathField("Status"));
    ...
    static class IsModifyingMatcher extends WaiterAcceptor<DescribeDBClustersResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsRebootingMatcher extends WaiterAcceptor<DescribeDBClustersResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsResettingmastercredentialsMatcher extends WaiterAcceptor<DescribeDBClustersResult> {
        private static final JsonNode expectedResult;
