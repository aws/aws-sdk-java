...
/**
 * DescribeDBProxiesResult StAX Unmarshaller
 */
    ...
    public DescribeDBProxiesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DBProxies", targetDepth)) {
                    describeDBProxiesResult.withDBProxies(new ArrayList<DBProxy>());
                    continue;
                }

                if (context.testExpression("DBProxies/member", targetDepth)) {
                    describeDBProxiesResult.withDBProxies(DBProxyStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Marker", targetDepth)) {
                    describeDBProxiesResult.setMarker(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
