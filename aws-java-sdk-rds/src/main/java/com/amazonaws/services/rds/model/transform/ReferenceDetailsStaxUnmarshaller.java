    ...
    public ReferenceDetails unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ScalarReferenceDetails", targetDepth)) {
                    referenceDetails.setScalarReferenceDetails(ScalarReferenceDetailsStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
