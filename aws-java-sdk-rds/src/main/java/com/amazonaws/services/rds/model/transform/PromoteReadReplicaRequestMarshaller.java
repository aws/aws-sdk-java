...
public class PromoteReadReplicaRequestMarshaller
        implements
        Marshaller<Request<PromoteReadReplicaRequest>, PromoteReadReplicaRequest> {
    ...
    public Request<PromoteReadReplicaRequest> marshall(
        ...
        Request<PromoteReadReplicaRequest> request = new DefaultRequest<PromoteReadReplicaRequest>(
                promoteReadReplicaRequest, "AmazonRDS");
        ...
        if (promoteReadReplicaRequest.getBackupRetentionPeriod() != null) {
            request.addParameter("BackupRetentionPeriod", StringUtils
                    .fromInteger(promoteReadReplicaRequest
