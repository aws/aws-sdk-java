...
public class DeleteDBShardGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteDBShardGroupResult withDBShardGroupResourceId(String dBShardGroupResourceId) {
    ...
    public DeleteDBShardGroupResult withDBShardGroupIdentifier(String dBShardGroupIdentifier) {
    ...
    public DeleteDBShardGroupResult withDBClusterIdentifier(String dBClusterIdentifier) {
    ...
    public DeleteDBShardGroupResult withMaxACU(Double maxACU) {
        setMaxACU(maxACU);
        return this;
    }
    ...
    public DeleteDBShardGroupResult withComputeRedundancy(Integer computeRedundancy) {
    ...
    public DeleteDBShardGroupResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public DeleteDBShardGroupResult withPubliclyAccessible(Boolean publiclyAccessible) {
    ...
    public DeleteDBShardGroupResult withEndpoint(String endpoint) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDBShardGroupResult == false)
            return false;
        DeleteDBShardGroupResult other = (DeleteDBShardGroupResult) obj;
    ...
    @Override
    public DeleteDBShardGroupResult clone() {
        try {
            return (DeleteDBShardGroupResult) super.clone();
