...
public class RebootDBInstanceRequestMarshaller implements
    ...
    public Request<RebootDBInstanceRequest> marshall(
        ...
        Request<RebootDBInstanceRequest> request = new DefaultRequest<RebootDBInstanceRequest>(
                rebootDBInstanceRequest, "AmazonRDS");
        ...
        if (rebootDBInstanceRequest.getDBInstanceIdentifier() != null) {
            request.addParameter("DBInstanceIdentifier", StringUtils
                    .fromString(rebootDBInstanceRequest
                            .getDBInstanceIdentifier()));
        }

        if (rebootDBInstanceRequest.getForceFailover() != null) {
            request.addParameter("ForceFailover", StringUtils
                    .fromBoolean(rebootDBInstanceRequest.getForceFailover()));
        }
