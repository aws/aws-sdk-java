 ...
 */
public class DeleteDBSubnetGroupResultStaxUnmarshaller implements
        Unmarshaller<DeleteDBSubnetGroupResult, StaxUnmarshallerContext> {

    public DeleteDBSubnetGroupResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
