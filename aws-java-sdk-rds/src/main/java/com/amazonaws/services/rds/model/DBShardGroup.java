...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/rds-2014-10-31/DBShardGroup" target="_top">AWS API
 *      Documentation</a>
 */
...
public class DBShardGroup implements Serializable, Cloneable {
    ...
    public DBShardGroup withDBShardGroupResourceId(String dBShardGroupResourceId) {
    ...
    public DBShardGroup withDBShardGroupIdentifier(String dBShardGroupIdentifier) {
    ...
    public DBShardGroup withDBClusterIdentifier(String dBClusterIdentifier) {
    ...
    public DBShardGroup withMaxACU(Double maxACU) {
        setMaxACU(maxACU);
        return this;
    }
    ...
    public DBShardGroup withComputeRedundancy(Integer computeRedundancy) {
    ...
    public DBShardGroup withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public DBShardGroup withPubliclyAccessible(Boolean publiclyAccessible) {
    ...
    public DBShardGroup withEndpoint(String endpoint) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DBShardGroup == false)
            return false;
        DBShardGroup other = (DBShardGroup) obj;
