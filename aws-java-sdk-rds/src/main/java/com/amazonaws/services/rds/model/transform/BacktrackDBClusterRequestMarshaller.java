...
/**
 * BacktrackDBClusterRequest Marshaller
 */
...
public class BacktrackDBClusterRequestMarshaller implements Marshaller<Request<BacktrackDBClusterRequest>, BacktrackDBClusterRequest> {
    ...
    public Request<BacktrackDBClusterRequest> marshall(BacktrackDBClusterRequest backtrackDBClusterRequest) {
        ...
        Request<BacktrackDBClusterRequest> request = new DefaultRequest<BacktrackDBClusterRequest>(backtrackDBClusterRequest, "AmazonRDS");
        ...
        if (backtrackDBClusterRequest.getUseEarliestTimeOnPointInTimeUnavailable() != null) {
            request.addParameter("UseEarliestTimeOnPointInTimeUnavailable",
                    StringUtils.fromBoolean(backtrackDBClusterRequest.getUseEarliestTimeOnPointInTimeUnavailable()));
        }
