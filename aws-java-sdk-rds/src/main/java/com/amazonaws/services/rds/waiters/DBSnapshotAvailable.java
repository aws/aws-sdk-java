...
class DBSnapshotAvailable {
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeDBSnapshotsResult> {
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeDBSnapshotsResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeDBSnapshotsResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIncompatiblerestoreMatcher extends WaiterAcceptor<DescribeDBSnapshotsResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIncompatibleparametersMatcher extends WaiterAcceptor<DescribeDBSnapshotsResult> {
        private static final JsonNode expectedResult;
