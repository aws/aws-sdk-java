...
public class RestoreDBClusterFromS3RequestMarshaller
    ...
    public Request<RestoreDBClusterFromS3Request> marshall(
        ...
        Request<RestoreDBClusterFromS3Request> request = new DefaultRequest<RestoreDBClusterFromS3Request>(
                restoreDBClusterFromS3Request, "AmazonRDS");
        ...
        if (restoreDBClusterFromS3Request.getBackupRetentionPeriod() != null) {
            request.addParameter("BackupRetentionPeriod", StringUtils
                    .fromInteger(restoreDBClusterFromS3Request
                            .getBackupRetentionPeriod()));
        }

        if (restoreDBClusterFromS3Request.getCharacterSetName() != null) {
            request.addParameter("CharacterSetName", StringUtils
                    .fromString(restoreDBClusterFromS3Request
                            .getCharacterSetName()));
        }

        if (restoreDBClusterFromS3Request.getDatabaseName() != null) {
            request.addParameter("DatabaseName",
                    StringUtils.fromString(restoreDBClusterFromS3Request
                            .getDatabaseName()));
        }
        ...
        if (restoreDBClusterFromS3Request.getEngine() != null) {
            request.addParameter("Engine", StringUtils
                    .fromString(restoreDBClusterFromS3Request.getEngine()));
        }
        ...
        if (restoreDBClusterFromS3Request.getPort() != null) {
            request.addParameter("Port", StringUtils
                    .fromInteger(restoreDBClusterFromS3Request.getPort()));
        }
        ...
        com.amazonaws.internal.SdkInternalList<Tag> tagsList = (com.amazonaws.internal.SdkInternalList<Tag>) restoreDBClusterFromS3Request
                .getTags();
