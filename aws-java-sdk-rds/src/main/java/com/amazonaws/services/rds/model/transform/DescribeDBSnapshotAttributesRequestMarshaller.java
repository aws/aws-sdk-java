...
/**
 * DescribeDBSnapshotAttributesRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeDBSnapshotAttributesRequestMarshaller implements
    ...
    public Request<DescribeDBSnapshotAttributesRequest> marshall(DescribeDBSnapshotAttributesRequest describeDBSnapshotAttributesRequest) {
        ...
        Request<DescribeDBSnapshotAttributesRequest> request = new DefaultRequest<DescribeDBSnapshotAttributesRequest>(describeDBSnapshotAttributesRequest,
                "AmazonRDS");
