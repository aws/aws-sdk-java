...
public class DBProxyAlreadyExistsExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public DBProxyAlreadyExistsExceptionUnmarshaller() {
        super(DBProxyAlreadyExistsException.class);
    }
