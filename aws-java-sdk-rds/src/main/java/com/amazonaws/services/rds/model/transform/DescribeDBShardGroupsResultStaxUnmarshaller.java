...
/**
 * DescribeDBShardGroupsResult StAX Unmarshaller
 */
...
public class DescribeDBShardGroupsResultStaxUnmarshaller implements Unmarshaller<DescribeDBShardGroupsResult, StaxUnmarshallerContext> {
    ...
    public DescribeDBShardGroupsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DBShardGroups", targetDepth)) {
                    describeDBShardGroupsResult.withDBShardGroups(new ArrayList<DBShardGroup>());
                    continue;
                }

                if (context.testExpression("DBShardGroups/DBShardGroup", targetDepth)) {
                    describeDBShardGroupsResult.withDBShardGroups(DBShardGroupStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Marker", targetDepth)) {
                    describeDBShardGroupsResult.setMarker(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
