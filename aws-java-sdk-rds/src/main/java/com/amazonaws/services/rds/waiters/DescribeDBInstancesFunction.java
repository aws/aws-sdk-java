...
@SdkInternalApi
public class DescribeDBInstancesFunction implements
        SdkFunction<DescribeDBInstancesRequest, DescribeDBInstancesResult> {
     ...
     *        Service client
     */
    public DescribeDBInstancesFunction(AmazonRDS client) {
        this.client = client;
    }
     ...
     */
    @Override
    public DescribeDBInstancesResult apply(
