 ...
 */
public class ResetDBClusterParameterGroupResultStaxUnmarshaller
        implements
        Unmarshaller<ResetDBClusterParameterGroupResult, StaxUnmarshallerContext> {

    public ResetDBClusterParameterGroupResult unmarshall(
