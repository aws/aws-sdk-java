...
public class ProvisionedIopsNotAvailableInAZExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null
                || !errorCode.equals("ProvisionedIopsNotAvailableInAZFault"))
            return null;

        ProvisionedIopsNotAvailableInAZException e = (ProvisionedIopsNotAvailableInAZException) super
                .unmarshall(node);
