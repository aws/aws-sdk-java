...
public class RebootDBShardGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the DB shard group to reboot.
     */
    ...
    public RebootDBShardGroupRequest withDBShardGroupIdentifier(String dBShardGroupIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RebootDBShardGroupRequest == false)
            return false;
        RebootDBShardGroupRequest other = (RebootDBShardGroupRequest) obj;
    ...
    @Override
    public RebootDBShardGroupRequest clone() {
        return (RebootDBShardGroupRequest) super.clone();
    }
