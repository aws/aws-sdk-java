...
/**
 * ValidStorageOptions StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ValidStorageOptionsStaxUnmarshaller implements Unmarshaller<ValidStorageOptions, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("StorageType", targetDepth)) {
                    validStorageOptions.setStorageType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
