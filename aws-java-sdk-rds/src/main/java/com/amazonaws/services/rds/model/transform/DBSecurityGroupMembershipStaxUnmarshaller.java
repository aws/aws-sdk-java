 ...
 */
public class DBSecurityGroupMembershipStaxUnmarshaller implements
        Unmarshaller<DBSecurityGroupMembership, StaxUnmarshallerContext> {

    public DBSecurityGroupMembership unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Status", targetDepth)) {
                    dBSecurityGroupMembership.setStatus(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
