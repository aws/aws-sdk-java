...
public class CopyDBSnapshotRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * AWS Region. KMS encryption keys are specific to the AWS Region that they are created in, and you cannot use
     ...
     * call the <code>CopyDBSnapshot</code> action in the us-east-1 region and provide a presigned URL that contains a
     * call to the <code>CopyDBSnapshot</code> action in the us-west-2 region. For this example, the
     ...
     * destination AWS Region. This is the same identifier for both the <code>CopyDBSnapshot</code> action that is
     ...
     * are copying an encrypted DB snapshot from the us-west-2 region, then your <code>SourceDBSnapshotIdentifier</code>
     ...
     *        you call the <code>CopyDBSnapshot</code> action in the us-east-1 region and provide a presigned URL that
     ...
     *        in the destination AWS Region. This is the same identifier for both the <code>CopyDBSnapshot</code> action
     ...
     *         <p>
     *         <code>KmsKeyId</code> - The KMS key identifier for the key to use to encrypt the copy of the DB snapshot
     *         in the destination AWS Region. This is the same identifier for both the <code>CopyDBSnapshot</code>
