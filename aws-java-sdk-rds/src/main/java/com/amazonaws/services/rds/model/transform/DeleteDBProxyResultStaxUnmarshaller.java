...
/**
 * DeleteDBProxyResult StAX Unmarshaller
 */
...
public class DeleteDBProxyResultStaxUnmarshaller implements Unmarshaller<DeleteDBProxyResult, StaxUnmarshallerContext> {
    ...
    public DeleteDBProxyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DBProxy", targetDepth)) {
                    deleteDBProxyResult.setDBProxy(DBProxyStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
