...
public class UserAuthConfigInfo implements Serializable, Cloneable {
    ...
    public UserAuthConfigInfo withClientPasswordAuthType(String clientPasswordAuthType) {
    ...
    public UserAuthConfigInfo withClientPasswordAuthType(ClientPasswordAuthType clientPasswordAuthType) {
