...
public class ModifyIntegrationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ModifyIntegrationResult withAdditionalEncryptionContext(java.util.Map<String, String> additionalEncryptionContext) {
     ...
     *
     * @see ModifyIntegrationResult#withAdditionalEncryptionContext
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ModifyIntegrationResult addAdditionalEncryptionContextEntry(String key, String value) {
    ...
    public ModifyIntegrationResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public ModifyIntegrationResult withCreateTime(java.util.Date createTime) {
    ...
    public ModifyIntegrationResult withErrors(IntegrationError... errors) {
        if (this.errors == null) {
    ...
    public ModifyIntegrationResult withErrors(java.util.Collection<IntegrationError> errors) {
        setErrors(errors);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyIntegrationResult == false)
            return false;
        ModifyIntegrationResult other = (ModifyIntegrationResult) obj;
    ...
    public ModifyIntegrationResult clone() {
        try {
            return (ModifyIntegrationResult) super.clone();
