...
public class DescribeDBSubnetGroupsResult extends
    ...
    public void setDBSubnetGroups(
        ...
        this.dBSubnetGroups = new com.amazonaws.internal.SdkInternalList<DBSubnetGroup>(
                dBSubnetGroups);
    }
     ...
     * any). Use {@link #setDBSubnetGroups(java.util.Collection)} or
     * {@link #withDBSubnetGroups(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param dBSubnetGroups
    ...
    public DescribeDBSubnetGroupsResult withDBSubnetGroups(
        ...
        if (this.dBSubnetGroups == null) {
            setDBSubnetGroups(new com.amazonaws.internal.SdkInternalList<DBSubnetGroup>(
                    dBSubnetGroups.length));
        }
