...
public class DescribeDBClusterSnapshotAttributesRequestMarshaller
    ...
    public Request<DescribeDBClusterSnapshotAttributesRequest> marshall(
        ...
        if (describeDBClusterSnapshotAttributesRequest
                .getDBClusterSnapshotIdentifier() != null) {
            request.addParameter("DBClusterSnapshotIdentifier", StringUtils
                    .fromString(describeDBClusterSnapshotAttributesRequest
