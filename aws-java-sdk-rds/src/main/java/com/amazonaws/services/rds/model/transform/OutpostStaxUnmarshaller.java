        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Arn", targetDepth)) {
                    outpost.setArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
