 ...
 * <p/>
 */
public class ModifyDBInstanceRequest extends
     ...
     * </p>
     * <p>
     * If this parameter is set to <code>false</code>, changes to the DB
     ...
     * >Modifying a DB Instance and Using the Apply Immediately Parameter</a> to
     * see the impact that setting <code>ApplyImmediately</code> to
     * <code>true</code> or <code>false</code> has for each modified parameter
     ...
     * maintenance window unless the <code>ApplyImmediately</code> parameter is
     * set to <code>true</code> for this request. If the parameter change
     ...
     * <code>Apply Immediately</code> to false. This value is stored as a
     * lowercase string.
     * </p>
     * <p>
     * Constraints:
     ...
     * DNS name. Set to <code>True</code> to make the DB instance
     * Internet-facing with a publicly resolvable DNS name, which resolves to a
     * public IP address. Set to <code>False</code> to make the DB instance
     ...
     *        <code>ApplyImmediately</code> is set to <code>true</code> for this
     *        request. </p>
     *        <p>
     *        <b>MySQL</b>
     *        </p>
     ...
     *         setting does not result in an outage and the change is applied
     *         during the next maintenance window unless
     *         <code>ApplyImmediately</code> is set to <code>true</code> for
     *         this request. </p>
     *         <p>
     *         <b>MySQL</b>
     *         </p>
     ...
     *        DB engine, use the <a>DescribeOrderableDBInstanceOptions</a>
     *        action. </p>
     *        <p>
     ...
     *        <code>ApplyImmediately</code> is specified as <code>true</code>
     *        for this request.
     *        </p>
     *        <p>
     *        Default: Uses existing setting
    ...
    public void setDBSecurityGroups(
        ...
        this.dBSecurityGroups = new com.amazonaws.internal.SdkInternalList<String>(
                dBSecurityGroups);
    }
    ...
    public ModifyDBInstanceRequest withDBSecurityGroups(
        ...
        if (this.dBSecurityGroups == null) {
            setDBSecurityGroups(new com.amazonaws.internal.SdkInternalList<String>(
     ...
     *        next call to <a>RebootDBInstance</a>, or the next failure reboot.
     *        Review the table of parameters in <a href=
     *        "http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Overview.DBInstance.Modifying.html"
     *        >Modifying a DB Instance and Using the Apply Immediately
     *        Parameter</a> to see the impact that setting
     *        <code>ApplyImmediately</code> to <code>true</code> or
     *        <code>false</code> has for each modified parameter and to
     ...
     *        <code>true</code> for this request. If you change the parameter
     ...
     *        <code>true</code> during the maintenance window, and a newer minor
     ...
     *         to <code>true</code> during the maintenance window, and a newer
     ...
     *         window unless the <code>ApplyImmediately</code> parameter is set
     *         to <code>true</code> for this request. </p>
     *         <p>
     *         Default: Uses existing setting
     *         </p>
     *         <p>
     ...
     *        <code>Apply Immediately</code> to true, or will occur during the
     *        next maintenance window if <code>Apply Immediately</code> to
     *        false. This value is stored as a lowercase string. </p>
     *        <p>
     *        Constraints:
     *        </p>
     *        <ul>
     ...
     *        </p>
     *        <p>
     *        Valid Values: <code>1150-65535</code> except for <code>1434</code>, <code>3389</code>, <code>47001</code>, <code>49152</code>, and
     *        <code>49152</code> through <code>49156</code>.
     *        </p>
     *        <p>
     *        <b>Amazon Aurora</b>
     ...
     *         </p>
     *         <p>
     *         Valid Values: <code>1150-65535</code> except for
     *         <code>1434</code>, <code>3389</code>, <code>47001</code>,
     *         <code>49152</code>, and <code>49152</code> through
     *         <code>49156</code>.
     *         </p>
     *         <p>
     *         <b>Amazon Aurora</b>
     ...
     *        resolvable DNS name. Set to <code>True</code> to make the DB
     *        instance Internet-facing with a publicly resolvable DNS name,
     *        which resolves to a public IP address. Set to <code>False</code>
     ...
     *         <code>PubliclyAccessible</code> only applies to DB instances in a
     *         VPC. The DB instance must be part of a public subnet and
     *         <code>PubliclyAccessible</code> must be true in order for it to
     ...
     *        <p>
     *        If <code>MonitoringInterval</code> is set to a value other than 0,
