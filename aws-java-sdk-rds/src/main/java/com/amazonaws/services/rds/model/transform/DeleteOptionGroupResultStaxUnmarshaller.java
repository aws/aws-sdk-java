 ...
 */
public class DeleteOptionGroupResultStaxUnmarshaller implements
        Unmarshaller<DeleteOptionGroupResult, StaxUnmarshallerContext> {

    public DeleteOptionGroupResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
