 ...
 * <p/>
 */
public class CreateEventSubscriptionRequest extends
    ...
    public void setSourceIds(java.util.Collection<String> sourceIds) {
        ...
        this.sourceIds = new com.amazonaws.internal.SdkInternalList<String>(
                sourceIds);
    }
    ...
    public CreateEventSubscriptionRequest withSourceIds(String... sourceIds) {
        if (this.sourceIds == null) {
            setSourceIds(new com.amazonaws.internal.SdkInternalList<String>(
                    sourceIds.length));
        }
    ...
    public CreateEventSubscriptionRequest withSourceIds(
            java.util.Collection<String> sourceIds) {
