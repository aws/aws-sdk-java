 ...
 */
public class DescribeSourceRegionsResultStaxUnmarshaller implements
        Unmarshaller<DescribeSourceRegionsResult, StaxUnmarshallerContext> {

    public DescribeSourceRegionsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("SourceRegions/SourceRegion",
                        targetDepth)) {
                    describeSourceRegionsResult
                            .withSourceRegions(SourceRegionStaxUnmarshaller
