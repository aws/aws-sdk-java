...
public class ReservedDBInstanceAlreadyExistsExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null
                || !errorCode.equals("ReservedDBInstanceAlreadyExists"))
            return null;

        ReservedDBInstanceAlreadyExistsException e = (ReservedDBInstanceAlreadyExistsException) super
                .unmarshall(node);
