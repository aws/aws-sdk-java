...
/**
 * RestoreWindow StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RestoreWindowStaxUnmarshaller implements Unmarshaller<RestoreWindow, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("EarliestTime", targetDepth)) {
                    restoreWindow.setEarliestTime(DateStaxUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                    continue;
                }

                if (context.testExpression("LatestTime", targetDepth)) {
                    restoreWindow.setLatestTime(DateStaxUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                    continue;
                }
