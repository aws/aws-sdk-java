 ...
 */
public class ModifyDBClusterParameterGroupResultStaxUnmarshaller
        implements
        Unmarshaller<ModifyDBClusterParameterGroupResult, StaxUnmarshallerContext> {

    public ModifyDBClusterParameterGroupResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DBClusterParameterGroupName",
                        targetDepth)) {
                    modifyDBClusterParameterGroupResult
                            .setDBClusterParameterGroupName(StringStaxUnmarshaller
