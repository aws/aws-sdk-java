...
public class CreateDBClusterEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateDBClusterEndpointResult withStaticMembers(java.util.Collection<String> staticMembers) {
    ...
    public CreateDBClusterEndpointResult withExcludedMembers(java.util.Collection<String> excludedMembers) {
