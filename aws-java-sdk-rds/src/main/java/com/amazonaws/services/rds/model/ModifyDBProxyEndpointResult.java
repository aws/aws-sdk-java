...
public class ModifyDBProxyEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ModifyDBProxyEndpointResult withDBProxyEndpoint(DBProxyEndpoint dBProxyEndpoint) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyDBProxyEndpointResult == false)
            return false;
        ModifyDBProxyEndpointResult other = (ModifyDBProxyEndpointResult) obj;
    ...
    public ModifyDBProxyEndpointResult clone() {
        try {
            return (ModifyDBProxyEndpointResult) super.clone();
