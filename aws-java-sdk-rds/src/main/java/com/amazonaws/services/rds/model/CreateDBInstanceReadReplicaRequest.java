 ...
 * 
 */
public class CreateDBInstanceReadReplicaRequest extends
    ...
    /**
     * Constructs a new CreateDBInstanceReadReplicaRequest object. Callers
     ...
     * </p>
     * 
     * @return The DB instance identifier of the Read Replica. This identifier
    ...
    public CreateDBInstanceReadReplicaRequest withDBInstanceIdentifier(
    ...
    public CreateDBInstanceReadReplicaRequest withDBInstanceClass(
    ...
    public CreateDBInstanceReadReplicaRequest withAvailabilityZone(
     ...
     * </p>
     * 
     * @return The option group the DB instance will be associated with. If
    ...
    public CreateDBInstanceReadReplicaRequest withOptionGroupName(
    ...
    public CreateDBInstanceReadReplicaRequest withPubliclyAccessible(
    ...
    public CreateDBInstanceReadReplicaRequest withTags(
    ...
    public CreateDBInstanceReadReplicaRequest withDBSubnetGroupName(
     ...
     *        True to copy all tags from the Read Replica to snapshots of the
     *        Read Replica; otherwise false. The default is false.
     */
     ...
     * </p>
     * 
     * @return True to copy all tags from the Read Replica to snapshots of the
     *         Read Replica; otherwise false. The default is false.
     */
    ...
    public CreateDBInstanceReadReplicaRequest withCopyTagsToSnapshot(
    ...
    public CreateDBInstanceReadReplicaRequest withMonitoringInterval(
    ...
    public CreateDBInstanceReadReplicaRequest withMonitoringRoleArn(
