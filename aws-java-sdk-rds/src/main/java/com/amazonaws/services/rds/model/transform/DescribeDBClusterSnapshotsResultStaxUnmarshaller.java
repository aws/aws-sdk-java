 ...
 */
public class DescribeDBClusterSnapshotsResultStaxUnmarshaller implements
        Unmarshaller<DescribeDBClusterSnapshotsResult, StaxUnmarshallerContext> {

    public DescribeDBClusterSnapshotsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression(
                        "DBClusterSnapshots/DBClusterSnapshot", targetDepth)) {
                    describeDBClusterSnapshotsResult
                            .withDBClusterSnapshots(DBClusterSnapshotStaxUnmarshaller
