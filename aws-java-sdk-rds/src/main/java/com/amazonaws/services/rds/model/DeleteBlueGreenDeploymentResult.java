...
public class DeleteBlueGreenDeploymentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteBlueGreenDeploymentResult == false)
            return false;
        DeleteBlueGreenDeploymentResult other = (DeleteBlueGreenDeploymentResult) obj;
    ...
    public DeleteBlueGreenDeploymentResult clone() {
        try {
            return (DeleteBlueGreenDeploymentResult) super.clone();
