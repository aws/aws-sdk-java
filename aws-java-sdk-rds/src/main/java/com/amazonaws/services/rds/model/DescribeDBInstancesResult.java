 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/rds-2014-10-31/DescribeDBInstances"/>AWS API Documentation</a>
 */
public class DescribeDBInstancesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public java.util.List<DBInstance> getDBInstances() {
        if (dBInstances == null) {
            dBInstances = new com.amazonaws.internal.SdkInternalList<DBInstance>();
        }
        return dBInstances;
    }
