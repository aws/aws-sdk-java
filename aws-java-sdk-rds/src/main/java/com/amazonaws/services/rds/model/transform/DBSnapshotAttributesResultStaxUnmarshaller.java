 ...
 */
public class DBSnapshotAttributesResultStaxUnmarshaller implements
        Unmarshaller<DBSnapshotAttributesResult, StaxUnmarshallerContext> {

    public DBSnapshotAttributesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DBSnapshotIdentifier", targetDepth)) {
                    dBSnapshotAttributesResult
                            .setDBSnapshotIdentifier(StringStaxUnmarshaller
