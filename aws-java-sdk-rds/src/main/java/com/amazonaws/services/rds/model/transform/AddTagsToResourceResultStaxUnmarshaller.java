 ...
 */
public class AddTagsToResourceResultStaxUnmarshaller implements
        Unmarshaller<AddTagsToResourceResult, StaxUnmarshallerContext> {

    public AddTagsToResourceResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
