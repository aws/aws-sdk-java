 ...
 */
public class VpcSecurityGroupMembershipStaxUnmarshaller implements
        Unmarshaller<VpcSecurityGroupMembership, StaxUnmarshallerContext> {

    public VpcSecurityGroupMembership unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("VpcSecurityGroupId", targetDepth)) {
                    vpcSecurityGroupMembership
                            .setVpcSecurityGroupId(StringStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Status", targetDepth)) {
                    vpcSecurityGroupMembership.setStatus(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
