 ...
 * <p/>
 */
public class RevokeDBSecurityGroupIngressRequest extends
     ...
     * in the <code>EC2SecurityGroupName</code> parameter. The AWS Access Key ID
    ...
    /**
     * Constructs a new RevokeDBSecurityGroupIngressRequest object. Callers
    ...
    public RevokeDBSecurityGroupIngressRequest withDBSecurityGroupName(
     ...
     * @param cIDRIP
     *        The IP range to revoke access from. Must be a valid CIDR range. If
     *        <code>CIDRIP</code> is specified,
     *        <code>EC2SecurityGroupName</code>, <code>EC2SecurityGroupId</code>
     ...
     * </p>
     * 
     * @return The IP range to revoke access from. Must be a valid CIDR range.
     *         If <code>CIDRIP</code> is specified,
     *         <code>EC2SecurityGroupName</code>,
     ...
     *        DB security groups, <code>EC2SecurityGroupId</code> must be
     ...
     * </p>
     * 
     * @return The name of the EC2 security group to revoke access from. For VPC
     *         DB security groups, <code>EC2SecurityGroupId</code> must be
     *         provided. Otherwise, EC2SecurityGroupOwnerId and either
     *         <code>EC2SecurityGroupName</code> or
     *         <code>EC2SecurityGroupId</code> must be provided.
    ...
    public RevokeDBSecurityGroupIngressRequest withEC2SecurityGroupName(
     ...
     * </p>
     * 
     * @return The id of the EC2 security group to revoke access from. For VPC
     *         DB security groups, <code>EC2SecurityGroupId</code> must be
     *         provided. Otherwise, EC2SecurityGroupOwnerId and either
     *         <code>EC2SecurityGroupName</code> or
     *         <code>EC2SecurityGroupId</code> must be provided.
    ...
    public RevokeDBSecurityGroupIngressRequest withEC2SecurityGroupId(
    ...
    public RevokeDBSecurityGroupIngressRequest withEC2SecurityGroupOwnerId(
