...
public class DescribeAccountAttributesResult implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A list of <a>AccountQuota</a> objects. Within this list, each quota has a
     ...
     * </p>
     * 
     * @return A list of <a>AccountQuota</a> objects. Within this list, each
     *         quota has a name, a count of usage toward the quota maximum, and
     *         a maximum value for the quota.
     */
     ...
     * 
     * @param accountQuotas
     *        A list of <a>AccountQuota</a> objects. Within this list, each
     *        quota has a name, a count of usage toward the quota maximum, and a
     *        maximum value for the quota.
     */

    public void setAccountQuotas(
        ...
        this.accountQuotas = new com.amazonaws.internal.SdkInternalList<AccountQuota>(
                accountQuotas);
    }
     ...
     * any). Use {@link #setAccountQuotas(java.util.Collection)} or
     * {@link #withAccountQuotas(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param accountQuotas
    ...
    public DescribeAccountAttributesResult withAccountQuotas(
        ...
        if (this.accountQuotas == null) {
            setAccountQuotas(new com.amazonaws.internal.SdkInternalList<AccountQuota>(
                    accountQuotas.length));
        }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getAccountQuotas() == null) ? 0 : getAccountQuotas()
                        .hashCode());
        return hashCode;
    }
