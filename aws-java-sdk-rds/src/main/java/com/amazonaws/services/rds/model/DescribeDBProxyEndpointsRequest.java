...
public class DescribeDBProxyEndpointsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * The name of the DB proxy whose endpoints you want to describe. If you omit this parameter, the output includes
     * information about all DB proxy endpoints associated with all your DB proxies.
     * </p>
     */
    private String dBProxyName;
    /**
     * <p>
     * The name of a DB proxy endpoint to describe. If you omit this parameter, the output includes information about
     * all DB proxy endpoints associated with the specified proxy.
     * </p>
     */
     ...
     * 
     * @param dBProxyName
     *        The name of the DB proxy whose endpoints you want to describe. If you omit this parameter, the output
     *        includes information about all DB proxy endpoints associated with all your DB proxies.
     */
     ...
     * </p>
     * 
     * @return The name of the DB proxy whose endpoints you want to describe. If you omit this parameter, the output
     *         includes information about all DB proxy endpoints associated with all your DB proxies.
     */
     ...
     *        The name of a DB proxy endpoint to describe. If you omit this parameter, the output includes information
     *        about all DB proxy endpoints associated with the specified proxy.
     */
     ...
     * </p>
     * 
     * @return The name of a DB proxy endpoint to describe. If you omit this parameter, the output includes information
     *         about all DB proxy endpoints associated with the specified proxy.
     */
    ...
    public DescribeDBProxyEndpointsRequest withFilters(Filter... filters) {
    ...
    public DescribeDBProxyEndpointsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeDBProxyEndpointsRequest == false)
            return false;
        DescribeDBProxyEndpointsRequest other = (DescribeDBProxyEndpointsRequest) obj;
    ...
    @Override
    public DescribeDBProxyEndpointsRequest clone() {
        return (DescribeDBProxyEndpointsRequest) super.clone();
    }
