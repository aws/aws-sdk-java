 ...
 */
public class DeleteDBClusterParameterGroupResultStaxUnmarshaller
        implements
        Unmarshaller<DeleteDBClusterParameterGroupResult, StaxUnmarshallerContext> {

    public DeleteDBClusterParameterGroupResult unmarshall(
