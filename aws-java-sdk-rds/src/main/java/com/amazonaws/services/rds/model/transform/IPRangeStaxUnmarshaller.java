 ...
 */
public class IPRangeStaxUnmarshaller implements
        Unmarshaller<IPRange, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Status", targetDepth)) {
                    iPRange.setStatus(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }

                if (context.testExpression("CIDRIP", targetDepth)) {
                    iPRange.setCIDRIP(StringStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
