 ...
 */
public class DescribeDBParametersResultStaxUnmarshaller implements
        Unmarshaller<DescribeDBParametersResult, StaxUnmarshallerContext> {

    public DescribeDBParametersResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    describeDBParametersResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
