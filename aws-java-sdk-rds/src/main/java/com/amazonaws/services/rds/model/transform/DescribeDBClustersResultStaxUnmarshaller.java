...
public class DescribeDBClustersResultStaxUnmarshaller implements
    ...
    public DescribeDBClustersResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    describeDBClustersResult.setMarker(StringStaxUnmarshaller
                ...
                if (context.testExpression("DBClusters/DBCluster", targetDepth)) {
                    describeDBClustersResult
                            .withDBClusters(DBClusterStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
