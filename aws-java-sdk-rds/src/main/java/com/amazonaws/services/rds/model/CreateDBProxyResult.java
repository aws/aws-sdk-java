...
public class CreateDBProxyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The <code>DBProxy</code> structure corresponding to the new proxy.
     */
    ...
    public CreateDBProxyResult withDBProxy(DBProxy dBProxy) {
        setDBProxy(dBProxy);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDBProxyResult == false)
            return false;
        CreateDBProxyResult other = (CreateDBProxyResult) obj;
    ...
    public CreateDBProxyResult clone() {
        try {
            return (CreateDBProxyResult) super.clone();
