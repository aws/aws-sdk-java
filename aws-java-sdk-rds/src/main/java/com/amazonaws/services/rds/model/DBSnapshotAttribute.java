...
public class DBSnapshotAttribute implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * An attribute name of <code>restore</code> applies to the list of AWS
     * accounts that have permission to copy or restore the manual DB snapshot.
     * </p>
     */
     ...
     * </p>
     * <p>
     * If the <code>AttributeName</code> field is <code>restore</code>, then
     * this field returns a list of AWS account ids that are authorized to copy
     * or restore the manual DB snapshot. If a value of <code>all</code> is in
     * the list, then the manual DB snapshot is public and available for any AWS
     ...
     *        <p>
     *        An attribute name of <code>restore</code> applies to the list of
     ...
     * </p>
     * 
     * @return The value(s) for the manual DB snapshot attribute.</p>
     *         <p>
     *         If the <code>AttributeName</code> field is <code>restore</code>,
     *         then this field returns a list of AWS account ids that are
     *         authorized to copy or restore the manual DB snapshot. If a value
     *         of <code>all</code> is in the list, then the manual DB snapshot
     ...
     *        The value(s) for the manual DB snapshot attribute.</p>
     *        <p>
     *        If the <code>AttributeName</code> field is <code>restore</code>,
     *        then this field returns a list of AWS account ids that are
     *        authorized to copy or restore the manual DB snapshot. If a value
     *        of <code>all</code> is in the list, then the manual DB snapshot is
    ...
    public void setAttributeValues(java.util.Collection<String> attributeValues) {
        ...
        this.attributeValues = new com.amazonaws.internal.SdkInternalList<String>(
                attributeValues);
    }
    ...
    public DBSnapshotAttribute withAttributeValues(String... attributeValues) {
        if (this.attributeValues == null) {
            setAttributeValues(new com.amazonaws.internal.SdkInternalList<String>(
    ...
    public DBSnapshotAttribute withAttributeValues(
