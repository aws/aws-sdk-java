...
public class DeviceConfigurationType implements Serializable, Cloneable {
    ...
    public void setChallengeRequiredOnNewDevice(
     ...
     * </p>
     * 
     * @return Indicates whether a challenge is required on a new device. Only
     *         applicable to a new device.
     */
    ...
    public void setDeviceOnlyRememberedOnUserPrompt(
    ...
    public String toString() {
        ...
        if (getChallengeRequiredOnNewDevice() != null)
            sb.append("ChallengeRequiredOnNewDevice: "
                    + getChallengeRequiredOnNewDevice() + ",");
        if (getDeviceOnlyRememberedOnUserPrompt() != null)
            sb.append("DeviceOnlyRememberedOnUserPrompt: "
