...
public class CreateUserImportJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateUserImportJobResult withUserImportJob(UserImportJobType userImportJob) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateUserImportJobResult == false)
            return false;
        CreateUserImportJobResult other = (CreateUserImportJobResult) obj;
    ...
    @Override
    public CreateUserImportJobResult clone() {
        try {
            return (CreateUserImportJobResult) super.clone();
