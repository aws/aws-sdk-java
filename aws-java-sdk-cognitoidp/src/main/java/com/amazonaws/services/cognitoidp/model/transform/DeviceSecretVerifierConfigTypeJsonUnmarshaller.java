 ...
 */
public class DeviceSecretVerifierConfigTypeJsonUnmarshaller implements
        Unmarshaller<DeviceSecretVerifierConfigType, JsonUnmarshallerContext> {

    public DeviceSecretVerifierConfigType unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PasswordVerifier", targetDepth)) {
                    context.nextToken();
                    deviceSecretVerifierConfigType.setPasswordVerifier(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Salt", targetDepth)) {
                    context.nextToken();
                    deviceSecretVerifierConfigType.setSalt(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
