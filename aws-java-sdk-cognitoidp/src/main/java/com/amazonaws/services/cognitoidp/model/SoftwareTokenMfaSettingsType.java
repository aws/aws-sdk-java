...
public class SoftwareTokenMfaSettingsType implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * Specifies whether software token MFA is activated. If an MFA type is activated for a user, the user will be
     ...
     * 
     * @param enabled
     *        Specifies whether software token MFA is activated. If an MFA type is activated for a user, the user will
     ...
     * </p>
     * 
     * @return Specifies whether software token MFA is activated. If an MFA type is activated for a user, the user will
     *         be prompted for MFA during all sign-in attempts, unless device tracking is turned on and the device has
     *         been trusted.
     */
