...
public class ForgotPasswordRequestMarshaller implements
    ...
    public Request<ForgotPasswordRequest> marshall(
        ...
        Request<ForgotPasswordRequest> request = new DefaultRequest<ForgotPasswordRequest>(
                forgotPasswordRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            if (forgotPasswordRequest.getSecretHash() != null) {
                jsonGenerator.writeFieldName("SecretHash").writeValue(
                        forgotPasswordRequest.getSecretHash());
            }
