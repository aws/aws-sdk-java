...
/**
 * DeleteIdentityProviderResult JSON Unmarshaller
 */
...
public class DeleteIdentityProviderResultJsonUnmarshaller implements Unmarshaller<DeleteIdentityProviderResult, JsonUnmarshallerContext> {
    ...
    public DeleteIdentityProviderResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteIdentityProviderResult deleteIdentityProviderResult = new DeleteIdentityProviderResult();
