...
public class SetUICustomizationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetUICustomizationResult == false)
            return false;
        SetUICustomizationResult other = (SetUICustomizationResult) obj;
    ...
    public SetUICustomizationResult clone() {
        try {
            return (SetUICustomizationResult) super.clone();
