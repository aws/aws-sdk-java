 ...
 */
public class UpdateUserPoolResultJsonUnmarshaller implements
        Unmarshaller<UpdateUserPoolResult, JsonUnmarshallerContext> {

    public UpdateUserPoolResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
