...
public class InvalidEmailRoleAccessPolicyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidEmailRoleAccessPolicyExceptionUnmarshaller instance;

    public static InvalidEmailRoleAccessPolicyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidEmailRoleAccessPolicyExceptionUnmarshaller();
        return instance;
    }
}
