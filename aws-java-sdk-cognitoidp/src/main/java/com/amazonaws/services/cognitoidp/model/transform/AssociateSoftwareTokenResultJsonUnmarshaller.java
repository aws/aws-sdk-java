...
/**
 * AssociateSoftwareTokenResult JSON Unmarshaller
 */
...
public class AssociateSoftwareTokenResultJsonUnmarshaller implements Unmarshaller<AssociateSoftwareTokenResult, JsonUnmarshallerContext> {
    ...
    public AssociateSoftwareTokenResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SecretCode", targetDepth)) {
                    context.nextToken();
                    associateSoftwareTokenResult.setSecretCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Session", targetDepth)) {
                    context.nextToken();
                    associateSoftwareTokenResult.setSession(context.getUnmarshaller(String.class).unmarshall(context));
                }
