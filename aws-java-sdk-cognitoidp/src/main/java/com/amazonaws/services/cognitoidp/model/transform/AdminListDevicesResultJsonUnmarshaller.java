...
public class AdminListDevicesResultJsonUnmarshaller implements
    ...
    public AdminListDevicesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Devices", targetDepth)) {
                    ...
                    adminListDevicesResult
                            .setDevices(new ListUnmarshaller<DeviceType>(
                                    DeviceTypeJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("PaginationToken", targetDepth)) {
                    context.nextToken();
                    adminListDevicesResult.setPaginationToken(context
