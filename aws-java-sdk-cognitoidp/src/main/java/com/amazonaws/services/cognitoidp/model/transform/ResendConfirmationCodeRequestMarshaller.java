...
public class ResendConfirmationCodeRequestMarshaller
    ...
    public ResendConfirmationCodeRequestMarshaller(
    ...
    public Request<ResendConfirmationCodeRequest> marshall(
        ...
        Request<ResendConfirmationCodeRequest> request = new DefaultRequest<ResendConfirmationCodeRequest>(
                resendConfirmationCodeRequest, "AWSCognitoIdentityProvider");
