...
/**
 * ListUserImportJobsResult JSON Unmarshaller
 */
public class ListUserImportJobsResultJsonUnmarshaller implements
    ...
    public ListUserImportJobsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UserImportJobs", targetDepth)) {
                    ...
                    listUserImportJobsResult
                            .setUserImportJobs(new ListUnmarshaller<UserImportJobType>(
                                    UserImportJobTypeJsonUnmarshaller
                                            .getInstance()).unmarshall(context));
                }
                if (context.testExpression("PaginationToken", targetDepth)) {
                    context.nextToken();
                    listUserImportJobsResult.setPaginationToken(context
