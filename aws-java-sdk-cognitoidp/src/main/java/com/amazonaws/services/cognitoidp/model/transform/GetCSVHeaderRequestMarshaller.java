 ...
 */
public class GetCSVHeaderRequestMarshaller implements
        Marshaller<Request<GetCSVHeaderRequest>, GetCSVHeaderRequest> {
    ...
    public Request<GetCSVHeaderRequest> marshall(
        ...
        Request<GetCSVHeaderRequest> request = new DefaultRequest<GetCSVHeaderRequest>(
                getCSVHeaderRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            if (getCSVHeaderRequest.getUserPoolId() != null) {
                jsonGenerator.writeFieldName("UserPoolId").writeValue(
                        getCSVHeaderRequest.getUserPoolId());
            }
