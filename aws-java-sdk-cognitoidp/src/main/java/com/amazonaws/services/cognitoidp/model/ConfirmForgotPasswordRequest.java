...
public class ConfirmForgotPasswordRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * ConfirmForgotPassword API action, Amazon Cognito invokes the functions that are assigned to the <i>post
     * confirmation</i> and <i>pre mutation</i> triggers. When Amazon Cognito invokes either of these functions, it
     ...
     * ConfirmForgotPassword request. In your function code in AWS Lambda, you can process the
     ...
     *         You create custom workflows by assigning AWS Lambda functions to user pool triggers. When you use the
     *         ConfirmForgotPassword API action, Amazon Cognito invokes the functions that are assigned to the <i>post
     *         confirmation</i> and <i>pre mutation</i> triggers. When Amazon Cognito invokes either of these functions,
     ...
     *         parameter in your ConfirmForgotPassword request. In your function code in AWS Lambda, you can process the
     *         <code>clientMetadata</code> value to enhance your workflow for your specific needs.
     *         </p>
     *         <p>
     *         For more information, see <a href=
