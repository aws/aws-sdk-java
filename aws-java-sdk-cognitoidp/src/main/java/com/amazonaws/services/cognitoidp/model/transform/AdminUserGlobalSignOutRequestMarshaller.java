...
public class AdminUserGlobalSignOutRequestMarshaller
        implements
        Marshaller<Request<AdminUserGlobalSignOutRequest>, AdminUserGlobalSignOutRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public AdminUserGlobalSignOutRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<AdminUserGlobalSignOutRequest> marshall(
        ...
        Request<AdminUserGlobalSignOutRequest> request = new DefaultRequest<AdminUserGlobalSignOutRequest>(
                adminUserGlobalSignOutRequest, "AWSCognitoIdentityProvider");
