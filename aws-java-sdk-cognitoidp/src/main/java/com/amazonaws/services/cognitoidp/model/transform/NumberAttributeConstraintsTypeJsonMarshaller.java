...
public class NumberAttributeConstraintsTypeJsonMarshaller {
     ...
     */
    public void marshall(NumberAttributeConstraintsType numberAttributeConstraintsType, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (numberAttributeConstraintsType.getMinValue() != null) {
                jsonGenerator.writeFieldName("MinValue").writeValue(numberAttributeConstraintsType.getMinValue());
            }
            if (numberAttributeConstraintsType.getMaxValue() != null) {
                jsonGenerator.writeFieldName("MaxValue").writeValue(numberAttributeConstraintsType.getMaxValue());
            }
