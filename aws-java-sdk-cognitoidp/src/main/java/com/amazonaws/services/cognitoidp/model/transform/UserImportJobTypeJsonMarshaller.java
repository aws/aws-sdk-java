...
public class UserImportJobTypeJsonMarshaller {
     ...
     */
    public void marshall(UserImportJobType userImportJobType,
        ...
        try {
            ...
            if (userImportJobType.getJobName() != null) {
                jsonGenerator.writeFieldName("JobName").writeValue(
                        userImportJobType.getJobName());
            }
            if (userImportJobType.getJobId() != null) {
                jsonGenerator.writeFieldName("JobId").writeValue(
                        userImportJobType.getJobId());
            }
            if (userImportJobType.getUserPoolId() != null) {
                jsonGenerator.writeFieldName("UserPoolId").writeValue(
                        userImportJobType.getUserPoolId());
            }
            if (userImportJobType.getPreSignedUrl() != null) {
                jsonGenerator.writeFieldName("PreSignedUrl").writeValue(
                        userImportJobType.getPreSignedUrl());
            }
            if (userImportJobType.getCreationDate() != null) {
                jsonGenerator.writeFieldName("CreationDate").writeValue(
                        userImportJobType.getCreationDate());
            }
            if (userImportJobType.getStartDate() != null) {
                jsonGenerator.writeFieldName("StartDate").writeValue(
                        userImportJobType.getStartDate());
            }
            if (userImportJobType.getCompletionDate() != null) {
                jsonGenerator.writeFieldName("CompletionDate").writeValue(
                        userImportJobType.getCompletionDate());
            }
            if (userImportJobType.getStatus() != null) {
                jsonGenerator.writeFieldName("Status").writeValue(
                        userImportJobType.getStatus());
            }
            if (userImportJobType.getCloudWatchLogsRoleArn() != null) {
                jsonGenerator.writeFieldName("CloudWatchLogsRoleArn")
                        .writeValue(
                                userImportJobType.getCloudWatchLogsRoleArn());
            }
            if (userImportJobType.getImportedUsers() != null) {
                jsonGenerator.writeFieldName("ImportedUsers").writeValue(
                        userImportJobType.getImportedUsers());
            }
            if (userImportJobType.getSkippedUsers() != null) {
                jsonGenerator.writeFieldName("SkippedUsers").writeValue(
                        userImportJobType.getSkippedUsers());
            }
            if (userImportJobType.getFailedUsers() != null) {
                jsonGenerator.writeFieldName("FailedUsers").writeValue(
                        userImportJobType.getFailedUsers());
            }
            if (userImportJobType.getCompletionMessage() != null) {
                jsonGenerator.writeFieldName("CompletionMessage").writeValue(
                        userImportJobType.getCompletionMessage());
            }
