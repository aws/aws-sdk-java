...
public class ListUsersRequestMarshaller implements
    ...
    public Request<ListUsersRequest> marshall(ListUsersRequest listUsersRequest) {
        ...
        Request<ListUsersRequest> request = new DefaultRequest<ListUsersRequest>(
                listUsersRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            if (listUsersRequest.getUserPoolId() != null) {
                jsonGenerator.writeFieldName("UserPoolId").writeValue(
                        listUsersRequest.getUserPoolId());
            }

            java.util.List<String> attributesToGetList = listUsersRequest
                    .getAttributesToGet();
