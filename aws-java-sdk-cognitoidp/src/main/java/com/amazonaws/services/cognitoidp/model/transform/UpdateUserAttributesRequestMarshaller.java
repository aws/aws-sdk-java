...
public class UpdateUserAttributesRequestMarshaller implements Marshaller<Request<UpdateUserAttributesRequest>, UpdateUserAttributesRequest> {
    ...
    public UpdateUserAttributesRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<UpdateUserAttributesRequest> marshall(UpdateUserAttributesRequest updateUserAttributesRequest) {
        ...
        Request<UpdateUserAttributesRequest> request = new DefaultRequest<UpdateUserAttributesRequest>(updateUserAttributesRequest,
                "AWSCognitoIdentityProvider");
        request.addHeader("X-Amz-Target", "AWSCognitoIdentityProviderService.UpdateUserAttributes");
        ...
        try {
            ...
            java.util.List<AttributeType> userAttributesList = updateUserAttributesRequest.getUserAttributes();
            ...
            if (updateUserAttributesRequest.getAccessToken() != null) {
                jsonGenerator.writeFieldName("AccessToken").writeValue(updateUserAttributesRequest.getAccessToken());
            }
