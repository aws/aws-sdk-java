...
public class DeleteUserPoolClientRequestMarshaller
    ...
    public DeleteUserPoolClientRequestMarshaller(
    ...
    public Request<DeleteUserPoolClientRequest> marshall(
        ...
        Request<DeleteUserPoolClientRequest> request = new DefaultRequest<DeleteUserPoolClientRequest>(
                deleteUserPoolClientRequest, "AWSCognitoIdentityProvider");
