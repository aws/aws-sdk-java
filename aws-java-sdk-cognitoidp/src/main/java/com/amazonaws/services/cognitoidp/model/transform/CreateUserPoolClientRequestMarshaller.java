...
public class CreateUserPoolClientRequestMarshaller
    ...
    public CreateUserPoolClientRequestMarshaller(
    ...
    public Request<CreateUserPoolClientRequest> marshall(
        ...
        Request<CreateUserPoolClientRequest> request = new DefaultRequest<CreateUserPoolClientRequest>(
                createUserPoolClientRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            if (createUserPoolClientRequest.getUserPoolId() != null) {
                jsonGenerator.writeFieldName("UserPoolId").writeValue(
                        createUserPoolClientRequest.getUserPoolId());
            }
            if (createUserPoolClientRequest.getClientName() != null) {
                jsonGenerator.writeFieldName("ClientName").writeValue(
                        createUserPoolClientRequest.getClientName());
            }
            if (createUserPoolClientRequest.getGenerateSecret() != null) {
                jsonGenerator.writeFieldName("GenerateSecret").writeValue(
                        createUserPoolClientRequest.getGenerateSecret());
            }
            ...
            java.util.List<String> readAttributesList = createUserPoolClientRequest
                    .getReadAttributes();
            ...
            java.util.List<String> writeAttributesList = createUserPoolClientRequest
                    .getWriteAttributes();
            ...
            java.util.List<String> explicitAuthFlowsList = createUserPoolClientRequest
