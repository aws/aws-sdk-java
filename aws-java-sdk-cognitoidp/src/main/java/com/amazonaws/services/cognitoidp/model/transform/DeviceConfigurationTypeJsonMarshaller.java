...
public class DeviceConfigurationTypeJsonMarshaller {
     ...
     */
    public void marshall(DeviceConfigurationType deviceConfigurationType,
        ...
        try {
            ...
            if (deviceConfigurationType.getChallengeRequiredOnNewDevice() != null) {
                jsonGenerator.writeFieldName("ChallengeRequiredOnNewDevice")
                        .writeValue(
            ...
            if (deviceConfigurationType.getDeviceOnlyRememberedOnUserPrompt() != null) {
                jsonGenerator
                        .writeFieldName("DeviceOnlyRememberedOnUserPrompt")
                        .writeValue(
                                deviceConfigurationType
