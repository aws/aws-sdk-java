...
public class CreateUserPoolRequestMarshaller implements
    ...
    public CreateUserPoolRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<CreateUserPoolRequest> marshall(
        ...
        Request<CreateUserPoolRequest> request = new DefaultRequest<CreateUserPoolRequest>(
                createUserPoolRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            if (createUserPoolRequest.getPoolName() != null) {
                jsonGenerator.writeFieldName("PoolName").writeValue(
                        createUserPoolRequest.getPoolName());
            }
            if (createUserPoolRequest.getPolicies() != null) {
                ...
                UserPoolPolicyTypeJsonMarshaller.getInstance().marshall(
                        createUserPoolRequest.getPolicies(), jsonGenerator);
            }
            if (createUserPoolRequest.getLambdaConfig() != null) {
                ...
                LambdaConfigTypeJsonMarshaller.getInstance().marshall(
                        createUserPoolRequest.getLambdaConfig(), jsonGenerator);
            }

            java.util.List<String> autoVerifiedAttributesList = createUserPoolRequest
            ...
            java.util.List<String> aliasAttributesList = createUserPoolRequest
                    .getAliasAttributes();
            ...
            if (createUserPoolRequest.getMfaConfiguration() != null) {
                jsonGenerator.writeFieldName("MfaConfiguration").writeValue(
                        createUserPoolRequest.getMfaConfiguration());
            }
            if (createUserPoolRequest.getDeviceConfiguration() != null) {
                ...
                DeviceConfigurationTypeJsonMarshaller.getInstance().marshall(
                        createUserPoolRequest.getDeviceConfiguration(),
                        jsonGenerator);
            }
            if (createUserPoolRequest.getEmailConfiguration() != null) {
                ...
                EmailConfigurationTypeJsonMarshaller.getInstance().marshall(
                        createUserPoolRequest.getEmailConfiguration(),
                        jsonGenerator);
            }
