...
public class UnsupportedIdentityProviderExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedIdentityProviderExceptionUnmarshaller instance;

    public static UnsupportedIdentityProviderExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedIdentityProviderExceptionUnmarshaller();
        return instance;
    }
}
