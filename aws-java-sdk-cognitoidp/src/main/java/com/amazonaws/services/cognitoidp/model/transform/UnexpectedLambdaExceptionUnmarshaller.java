...
public class UnexpectedLambdaExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnexpectedLambdaExceptionUnmarshaller instance;

    public static UnexpectedLambdaExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnexpectedLambdaExceptionUnmarshaller();
        return instance;
    }
}
