...
public class AdminUpdateUserAttributesRequestMarshaller
    ...
    public AdminUpdateUserAttributesRequestMarshaller(
    ...
    public Request<AdminUpdateUserAttributesRequest> marshall(
        ...
        Request<AdminUpdateUserAttributesRequest> request = new DefaultRequest<AdminUpdateUserAttributesRequest>(
                adminUpdateUserAttributesRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            if (adminUpdateUserAttributesRequest.getUserPoolId() != null) {
                jsonGenerator.writeFieldName("UserPoolId").writeValue(
                        adminUpdateUserAttributesRequest.getUserPoolId());
            }
            if (adminUpdateUserAttributesRequest.getUsername() != null) {
                jsonGenerator.writeFieldName("Username").writeValue(
                        adminUpdateUserAttributesRequest.getUsername());
            }

            java.util.List<AttributeType> userAttributesList = adminUpdateUserAttributesRequest
                    .getUserAttributes();
