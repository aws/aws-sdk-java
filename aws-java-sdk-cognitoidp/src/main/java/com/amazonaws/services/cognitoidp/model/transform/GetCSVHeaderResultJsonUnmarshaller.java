...
public class GetCSVHeaderResultJsonUnmarshaller implements
    ...
    public GetCSVHeaderResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UserPoolId", targetDepth)) {
                    context.nextToken();
                    getCSVHeaderResult.setUserPoolId(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("CSVHeader", targetDepth)) {
                    context.nextToken();
                    getCSVHeaderResult
                            .setCSVHeader(new ListUnmarshaller<String>(context
