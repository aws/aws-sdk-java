 ...
 */
public class NewDeviceMetadataTypeJsonUnmarshaller implements
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DeviceKey", targetDepth)) {
                    context.nextToken();
                    newDeviceMetadataType.setDeviceKey(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("DeviceGroupKey", targetDepth)) {
                    context.nextToken();
                    newDeviceMetadataType.setDeviceGroupKey(context
