...
public class UserPoolDescriptionTypeJsonMarshaller {
     ...
     */
    public void marshall(UserPoolDescriptionType userPoolDescriptionType,
        ...
        try {
            ...
            if (userPoolDescriptionType.getId() != null) {
                jsonGenerator.writeFieldName("Id").writeValue(
                        userPoolDescriptionType.getId());
            }
            if (userPoolDescriptionType.getName() != null) {
                jsonGenerator.writeFieldName("Name").writeValue(
                        userPoolDescriptionType.getName());
            }
