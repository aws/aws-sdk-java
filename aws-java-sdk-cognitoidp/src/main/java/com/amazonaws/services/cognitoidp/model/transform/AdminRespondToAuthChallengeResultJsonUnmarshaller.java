 ...
 */
public class AdminRespondToAuthChallengeResultJsonUnmarshaller
        implements
        Unmarshaller<AdminRespondToAuthChallengeResult, JsonUnmarshallerContext> {

    public AdminRespondToAuthChallengeResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChallengeName", targetDepth)) {
                    context.nextToken();
                    adminRespondToAuthChallengeResult.setChallengeName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Session", targetDepth)) {
                    context.nextToken();
                    adminRespondToAuthChallengeResult.setSession(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ChallengeParameters", targetDepth)) {
                    context.nextToken();
                    adminRespondToAuthChallengeResult
                            .setChallengeParameters(new MapUnmarshaller<String, String>(
