...
public class SchemaAttributeTypeJsonMarshaller {
     ...
     */
    public void marshall(SchemaAttributeType schemaAttributeType,
        ...
        try {
            ...
            if (schemaAttributeType.getName() != null) {
                jsonGenerator.writeFieldName("Name").writeValue(
                        schemaAttributeType.getName());
            }
            if (schemaAttributeType.getAttributeDataType() != null) {
                jsonGenerator.writeFieldName("AttributeDataType").writeValue(
                        schemaAttributeType.getAttributeDataType());
            }
            if (schemaAttributeType.getDeveloperOnlyAttribute() != null) {
                jsonGenerator
                        .writeFieldName("DeveloperOnlyAttribute")
                        .writeValue(
                                schemaAttributeType.getDeveloperOnlyAttribute());
            }
            if (schemaAttributeType.getMutable() != null) {
                jsonGenerator.writeFieldName("Mutable").writeValue(
                        schemaAttributeType.getMutable());
            }
            if (schemaAttributeType.getRequired() != null) {
                jsonGenerator.writeFieldName("Required").writeValue(
                        schemaAttributeType.getRequired());
            }
