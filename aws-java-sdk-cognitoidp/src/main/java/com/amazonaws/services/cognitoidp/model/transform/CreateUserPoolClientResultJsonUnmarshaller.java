 ...
 */
public class CreateUserPoolClientResultJsonUnmarshaller implements
        Unmarshaller<CreateUserPoolClientResult, JsonUnmarshallerContext> {

    public CreateUserPoolClientResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UserPoolClient", targetDepth)) {
                    ...
                    createUserPoolClientResult
                            .setUserPoolClient(UserPoolClientTypeJsonUnmarshaller
