...
public class DeviceTypeJsonMarshaller {
     ...
     */
    public void marshall(DeviceType deviceType,
        ...
        try {
            ...
            if (deviceType.getDeviceKey() != null) {
                jsonGenerator.writeFieldName("DeviceKey").writeValue(
                        deviceType.getDeviceKey());
            }

            java.util.List<AttributeType> deviceAttributesList = deviceType
                    .getDeviceAttributes();
                ...
                for (AttributeType deviceAttributesListValue : deviceAttributesList) {
                    if (deviceAttributesListValue != null) {
                        ...
                        AttributeTypeJsonMarshaller.getInstance().marshall(
                                deviceAttributesListValue, jsonGenerator);
                    }
                }
                jsonGenerator.writeEndArray();
            }
            if (deviceType.getDeviceCreateDate() != null) {
                jsonGenerator.writeFieldName("DeviceCreateDate").writeValue(
            ...
            if (deviceType.getDeviceLastModifiedDate() != null) {
                jsonGenerator.writeFieldName("DeviceLastModifiedDate")
                        .writeValue(deviceType.getDeviceLastModifiedDate());
            }
            if (deviceType.getDeviceLastAuthenticatedDate() != null) {
                jsonGenerator
                        .writeFieldName("DeviceLastAuthenticatedDate")
                        .writeValue(deviceType.getDeviceLastAuthenticatedDate());
            }
