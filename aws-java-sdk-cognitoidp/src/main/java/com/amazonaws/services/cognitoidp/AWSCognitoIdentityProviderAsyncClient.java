...
public class AWSCognitoIdentityProviderAsyncClient extends
    ...
    @Override
    public java.util.concurrent.Future<GetJWKSResult> getJWKSAsync(
            final GetJWKSRequest request,
            final com.amazonaws.handlers.AsyncHandler<GetJWKSRequest, GetJWKSResult> asyncHandler) {

        return executorService
                .submit(new java.util.concurrent.Callable<GetJWKSResult>() {
                    @Override
                    public GetJWKSResult call() throws Exception {
                        GetJWKSResult result;

                        try {
                            result = getJWKS(request);
                        } catch (Exception ex) {
                            if (asyncHandler != null) {
                                asyncHandler.onError(ex);
                            }
    ...
    @Override
    public java.util.concurrent.Future<GetOpenIdConfigurationResult> getOpenIdConfigurationAsync(
            final GetOpenIdConfigurationRequest request,
            final com.amazonaws.handlers.AsyncHandler<GetOpenIdConfigurationRequest, GetOpenIdConfigurationResult> asyncHandler) {

        return executorService
                .submit(new java.util.concurrent.Callable<GetOpenIdConfigurationResult>() {
                    @Override
                    public GetOpenIdConfigurationResult call() throws Exception {
                        GetOpenIdConfigurationResult result;

                        try {
                            result = getOpenIdConfiguration(request);
                        } catch (Exception ex) {
                            if (asyncHandler != null) {
                                asyncHandler.onError(ex);
                            }
