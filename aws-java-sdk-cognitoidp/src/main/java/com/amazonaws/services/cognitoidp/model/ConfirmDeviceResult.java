 ...
 * </p>
 */
public class ConfirmDeviceResult implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Indicates whether the user confirmation is necessary to confirm
     *         the device response.
     */
    ...
    public ConfirmDeviceResult withUserConfirmationNecessary(
    ...
    public String toString() {
        ...
        if (getUserConfirmationNecessary() != null)
            sb.append("UserConfirmationNecessary: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getUserConfirmationNecessary() == null
            ...
            return false;
        if (other.getUserConfirmationNecessary() != null
                && other.getUserConfirmationNecessary().equals(
                        this.getUserConfirmationNecessary()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getUserConfirmationNecessary() == null) ? 0
                        : getUserConfirmationNecessary().hashCode());
        return hashCode;
    }
