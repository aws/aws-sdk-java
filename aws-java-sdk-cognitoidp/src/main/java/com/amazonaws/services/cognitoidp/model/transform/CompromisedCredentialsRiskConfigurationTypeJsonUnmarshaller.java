...
/**
 * CompromisedCredentialsRiskConfigurationType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CompromisedCredentialsRiskConfigurationTypeJsonUnmarshaller implements
        Unmarshaller<CompromisedCredentialsRiskConfigurationType, JsonUnmarshallerContext> {

    public CompromisedCredentialsRiskConfigurationType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Actions", targetDepth)) {
                    context.nextToken();
                    compromisedCredentialsRiskConfigurationType.setActions(CompromisedCredentialsActionsTypeJsonUnmarshaller.getInstance().unmarshall(context));
                }
