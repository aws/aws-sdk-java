...
public class UpdateDeviceStatusRequestMarshaller
    ...
    public UpdateDeviceStatusRequestMarshaller(
    ...
    public Request<UpdateDeviceStatusRequest> marshall(
        ...
        Request<UpdateDeviceStatusRequest> request = new DefaultRequest<UpdateDeviceStatusRequest>(
                updateDeviceStatusRequest, "AWSCognitoIdentityProvider");
