 ...
 */
public class DeleteUserResultJsonUnmarshaller implements
        Unmarshaller<DeleteUserResult, JsonUnmarshallerContext> {

    public DeleteUserResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
