...
/**
 * ProviderUserIdentifierType JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ProviderName", targetDepth)) {
                    context.nextToken();
                    providerUserIdentifierType.setProviderName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ProviderAttributeName", targetDepth)) {
                    context.nextToken();
                    providerUserIdentifierType.setProviderAttributeName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ProviderAttributeValue", targetDepth)) {
                    context.nextToken();
                    providerUserIdentifierType.setProviderAttributeValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
