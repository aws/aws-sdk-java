...
public class ListUserImportJobsRequestMarshaller
    ...
    public ListUserImportJobsRequestMarshaller(
    ...
    public Request<ListUserImportJobsRequest> marshall(
        ...
        Request<ListUserImportJobsRequest> request = new DefaultRequest<ListUserImportJobsRequest>(
                listUserImportJobsRequest, "AWSCognitoIdentityProvider");
