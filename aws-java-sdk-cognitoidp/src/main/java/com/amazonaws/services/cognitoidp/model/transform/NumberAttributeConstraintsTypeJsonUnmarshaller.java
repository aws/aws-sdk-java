 ...
 */
public class NumberAttributeConstraintsTypeJsonUnmarshaller implements
        Unmarshaller<NumberAttributeConstraintsType, JsonUnmarshallerContext> {

    public NumberAttributeConstraintsType unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MinValue", targetDepth)) {
                    context.nextToken();
                    numberAttributeConstraintsType.setMinValue(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MaxValue", targetDepth)) {
                    context.nextToken();
                    numberAttributeConstraintsType.setMaxValue(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
