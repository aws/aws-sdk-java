...
public class TooManyFailedAttemptsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TooManyFailedAttemptsExceptionUnmarshaller instance;

    public static TooManyFailedAttemptsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TooManyFailedAttemptsExceptionUnmarshaller();
        return instance;
    }
}
