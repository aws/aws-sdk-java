...
public interface AWSCognitoIdentityProviderAsync extends
     ...
     * @return A Java Future containing the result of the GetJWKS operation
     *         returned by the service.
     * @sample AWSCognitoIdentityProviderAsync.GetJWKS
     */
    java.util.concurrent.Future<GetJWKSResult> getJWKSAsync(
            GetJWKSRequest getJWKSRequest);
     ...
     * @return A Java Future containing the result of the GetJWKS operation
     *         returned by the service.
     * @sample AWSCognitoIdentityProviderAsyncHandler.GetJWKS
     */
    java.util.concurrent.Future<GetJWKSResult> getJWKSAsync(
            GetJWKSRequest getJWKSRequest,
     ...
     * @return A Java Future containing the result of the GetOpenIdConfiguration
     *         operation returned by the service.
     * @sample AWSCognitoIdentityProviderAsync.GetOpenIdConfiguration
     */
    java.util.concurrent.Future<GetOpenIdConfigurationResult> getOpenIdConfigurationAsync(
     ...
     * @return A Java Future containing the result of the GetOpenIdConfiguration
     *         operation returned by the service.
     * @sample AWSCognitoIdentityProviderAsyncHandler.GetOpenIdConfiguration
     */
    java.util.concurrent.Future<GetOpenIdConfigurationResult> getOpenIdConfigurationAsync(
            GetOpenIdConfigurationRequest getOpenIdConfigurationRequest,
