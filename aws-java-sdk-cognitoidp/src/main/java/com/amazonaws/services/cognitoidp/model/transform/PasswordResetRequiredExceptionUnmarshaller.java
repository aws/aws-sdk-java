...
public class PasswordResetRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PasswordResetRequiredExceptionUnmarshaller instance;

    public static PasswordResetRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PasswordResetRequiredExceptionUnmarshaller();
        return instance;
    }
}
