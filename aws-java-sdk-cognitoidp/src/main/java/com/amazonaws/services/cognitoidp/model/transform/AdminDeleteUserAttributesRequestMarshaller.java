...
public class AdminDeleteUserAttributesRequestMarshaller
    ...
    public AdminDeleteUserAttributesRequestMarshaller(
    ...
    public Request<AdminDeleteUserAttributesRequest> marshall(
        ...
        Request<AdminDeleteUserAttributesRequest> request = new DefaultRequest<AdminDeleteUserAttributesRequest>(
                adminDeleteUserAttributesRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            if (adminDeleteUserAttributesRequest.getUserPoolId() != null) {
                jsonGenerator.writeFieldName("UserPoolId").writeValue(
                        adminDeleteUserAttributesRequest.getUserPoolId());
            }
            if (adminDeleteUserAttributesRequest.getUsername() != null) {
                jsonGenerator.writeFieldName("Username").writeValue(
                        adminDeleteUserAttributesRequest.getUsername());
            }

            java.util.List<String> userAttributeNamesList = adminDeleteUserAttributesRequest
