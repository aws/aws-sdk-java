...
/**
 * RiskConfigurationTypeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RiskConfigurationTypeMarshaller {
    ...
    public static RiskConfigurationTypeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RiskConfigurationType riskConfigurationType, ProtocolMarshaller protocolMarshaller) {

        if (riskConfigurationType == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(riskConfigurationType.getUserPoolId(), USERPOOLID_BINDING);
            protocolMarshaller.marshall(riskConfigurationType.getClientId(), CLIENTID_BINDING);
            protocolMarshaller.marshall(riskConfigurationType.getCompromisedCredentialsRiskConfiguration(), COMPROMISEDCREDENTIALSRISKCONFIGURATION_BINDING);
            protocolMarshaller.marshall(riskConfigurationType.getAccountTakeoverRiskConfiguration(), ACCOUNTTAKEOVERRISKCONFIGURATION_BINDING);
            protocolMarshaller.marshall(riskConfigurationType.getRiskExceptionConfiguration(), RISKEXCEPTIONCONFIGURATION_BINDING);
            protocolMarshaller.marshall(riskConfigurationType.getLastModifiedDate(), LASTMODIFIEDDATE_BINDING);
        } catch (Exception e) {
