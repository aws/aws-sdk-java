...
public class GetDeviceRequestMarshaller implements Marshaller<Request<GetDeviceRequest>, GetDeviceRequest> {
    ...
    public Request<GetDeviceRequest> marshall(GetDeviceRequest getDeviceRequest) {
        ...
        Request<GetDeviceRequest> request = new DefaultRequest<GetDeviceRequest>(getDeviceRequest, "AWSCognitoIdentityProvider");
        request.addHeader("X-Amz-Target", "AWSCognitoIdentityProviderService.GetDevice");
        ...
        try {
            ...
            if (getDeviceRequest.getDeviceKey() != null) {
                jsonGenerator.writeFieldName("DeviceKey").writeValue(getDeviceRequest.getDeviceKey());
            }
            if (getDeviceRequest.getAccessToken() != null) {
                jsonGenerator.writeFieldName("AccessToken").writeValue(getDeviceRequest.getAccessToken());
            }
