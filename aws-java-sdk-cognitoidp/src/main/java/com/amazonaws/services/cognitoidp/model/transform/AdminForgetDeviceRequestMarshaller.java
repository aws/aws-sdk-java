...
public class AdminForgetDeviceRequestMarshaller implements
    ...
    public AdminForgetDeviceRequestMarshaller(
    ...
    public Request<AdminForgetDeviceRequest> marshall(
        ...
        Request<AdminForgetDeviceRequest> request = new DefaultRequest<AdminForgetDeviceRequest>(
                adminForgetDeviceRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            if (adminForgetDeviceRequest.getUserPoolId() != null) {
                jsonGenerator.writeFieldName("UserPoolId").writeValue(
                        adminForgetDeviceRequest.getUserPoolId());
            }
            if (adminForgetDeviceRequest.getUsername() != null) {
                jsonGenerator.writeFieldName("Username").writeValue(
                        adminForgetDeviceRequest.getUsername());
            }
            if (adminForgetDeviceRequest.getDeviceKey() != null) {
                jsonGenerator.writeFieldName("DeviceKey").writeValue(
                        adminForgetDeviceRequest.getDeviceKey());
            }
