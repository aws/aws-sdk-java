...
public class AdminInitiateAuthResultJsonUnmarshaller implements
    ...
    public AdminInitiateAuthResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChallengeName", targetDepth)) {
                    context.nextToken();
                    adminInitiateAuthResult.setChallengeName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Session", targetDepth)) {
                    context.nextToken();
                    adminInitiateAuthResult.setSession(context.getUnmarshaller(
