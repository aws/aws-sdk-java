...
public class UserPoolPolicyTypeJsonMarshaller {
     ...
     */
    public void marshall(UserPoolPolicyType userPoolPolicyType,
        ...
        try {
            ...
            if (userPoolPolicyType.getPasswordPolicy() != null) {
                ...
                PasswordPolicyTypeJsonMarshaller.getInstance().marshall(
                        userPoolPolicyType.getPasswordPolicy(), jsonGenerator);
            }
