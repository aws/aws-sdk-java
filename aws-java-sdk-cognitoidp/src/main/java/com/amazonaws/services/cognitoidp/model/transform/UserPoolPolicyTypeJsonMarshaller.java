...
public class UserPoolPolicyTypeJsonMarshaller {
     ...
     */
    public void marshall(UserPoolPolicyType userPoolPolicyType, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (userPoolPolicyType.getPasswordPolicy() != null) {
                jsonGenerator.writeFieldName("PasswordPolicy");
                PasswordPolicyTypeJsonMarshaller.getInstance().marshall(userPoolPolicyType.getPasswordPolicy(), jsonGenerator);
            }
