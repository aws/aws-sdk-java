...
public class AdminConfirmSignUpRequestMarshaller
    ...
    public AdminConfirmSignUpRequestMarshaller(
    ...
    public Request<AdminConfirmSignUpRequest> marshall(
        ...
        Request<AdminConfirmSignUpRequest> request = new DefaultRequest<AdminConfirmSignUpRequest>(
                adminConfirmSignUpRequest, "AWSCognitoIdentityProvider");
