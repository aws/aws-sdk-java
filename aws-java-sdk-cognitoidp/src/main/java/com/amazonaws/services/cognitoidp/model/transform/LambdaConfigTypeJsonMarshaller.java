...
public class LambdaConfigTypeJsonMarshaller {
     ...
     */
    public void marshall(LambdaConfigType lambdaConfigType,
        ...
        try {
            ...
            if (lambdaConfigType.getPreSignUp() != null) {
                jsonGenerator.writeFieldName("PreSignUp").writeValue(
                        lambdaConfigType.getPreSignUp());
            }
            if (lambdaConfigType.getCustomMessage() != null) {
                jsonGenerator.writeFieldName("CustomMessage").writeValue(
                        lambdaConfigType.getCustomMessage());
            }
            if (lambdaConfigType.getPostConfirmation() != null) {
                jsonGenerator.writeFieldName("PostConfirmation").writeValue(
                        lambdaConfigType.getPostConfirmation());
            }
            if (lambdaConfigType.getPreAuthentication() != null) {
                jsonGenerator.writeFieldName("PreAuthentication").writeValue(
                        lambdaConfigType.getPreAuthentication());
            }
