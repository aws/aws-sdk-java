...
public class MFAOptionTypeJsonMarshaller {
     ...
     */
    public void marshall(MFAOptionType mFAOptionType,
        ...
        try {
            ...
            if (mFAOptionType.getDeliveryMedium() != null) {
                jsonGenerator.writeFieldName("DeliveryMedium").writeValue(
                        mFAOptionType.getDeliveryMedium());
            }
            if (mFAOptionType.getAttributeName() != null) {
                jsonGenerator.writeFieldName("AttributeName").writeValue(
                        mFAOptionType.getAttributeName());
            }
