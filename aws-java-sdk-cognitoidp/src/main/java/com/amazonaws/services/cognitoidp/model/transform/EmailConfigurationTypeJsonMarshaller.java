...
public class EmailConfigurationTypeJsonMarshaller {
     ...
     */
    public void marshall(EmailConfigurationType emailConfigurationType,
        ...
        try {
            ...
            if (emailConfigurationType.getSourceArn() != null) {
                jsonGenerator.writeFieldName("SourceArn").writeValue(
                        emailConfigurationType.getSourceArn());
            }
            if (emailConfigurationType.getReplyToEmailAddress() != null) {
                jsonGenerator.writeFieldName("ReplyToEmailAddress").writeValue(
                        emailConfigurationType.getReplyToEmailAddress());
            }
