...
/**
 * CreateResourceServerResult JSON Unmarshaller
 */
...
public class CreateResourceServerResultJsonUnmarshaller implements Unmarshaller<CreateResourceServerResult, JsonUnmarshallerContext> {
    ...
    public CreateResourceServerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceServer", targetDepth)) {
                    context.nextToken();
                    createResourceServerResult.setResourceServer(ResourceServerTypeJsonUnmarshaller.getInstance().unmarshall(context));
                }
