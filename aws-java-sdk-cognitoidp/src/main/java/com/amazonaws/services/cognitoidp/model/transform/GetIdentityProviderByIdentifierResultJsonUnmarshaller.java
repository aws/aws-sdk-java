...
/**
 * GetIdentityProviderByIdentifierResult JSON Unmarshaller
 */
...
public class GetIdentityProviderByIdentifierResultJsonUnmarshaller implements Unmarshaller<GetIdentityProviderByIdentifierResult, JsonUnmarshallerContext> {
    ...
    public GetIdentityProviderByIdentifierResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityProvider", targetDepth)) {
                    context.nextToken();
                    getIdentityProviderByIdentifierResult.setIdentityProvider(IdentityProviderTypeJsonUnmarshaller.getInstance().unmarshall(context));
                }
