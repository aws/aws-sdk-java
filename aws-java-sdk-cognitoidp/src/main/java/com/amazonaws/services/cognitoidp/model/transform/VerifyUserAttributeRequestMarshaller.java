...
public class VerifyUserAttributeRequestMarshaller
        implements
        Marshaller<Request<VerifyUserAttributeRequest>, VerifyUserAttributeRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public VerifyUserAttributeRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<VerifyUserAttributeRequest> marshall(
        ...
        Request<VerifyUserAttributeRequest> request = new DefaultRequest<VerifyUserAttributeRequest>(
                verifyUserAttributeRequest, "AWSCognitoIdentityProvider");
