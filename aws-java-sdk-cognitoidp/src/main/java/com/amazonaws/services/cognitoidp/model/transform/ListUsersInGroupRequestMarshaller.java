...
/**
 * ListUsersInGroupRequest Marshaller
 */
public class ListUsersInGroupRequestMarshaller implements Marshaller<Request<ListUsersInGroupRequest>, ListUsersInGroupRequest> {
    ...
    public ListUsersInGroupRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<ListUsersInGroupRequest> marshall(ListUsersInGroupRequest listUsersInGroupRequest) {
        ...
        Request<ListUsersInGroupRequest> request = new DefaultRequest<ListUsersInGroupRequest>(listUsersInGroupRequest, "AWSCognitoIdentityProvider");
