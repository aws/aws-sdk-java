...
public class ListUsersInGroupRequestMarshaller {
    ...
    private static final ListUsersInGroupRequestMarshaller instance = new ListUsersInGroupRequestMarshaller();

    public static ListUsersInGroupRequestMarshaller getInstance() {
        return instance;
    }
