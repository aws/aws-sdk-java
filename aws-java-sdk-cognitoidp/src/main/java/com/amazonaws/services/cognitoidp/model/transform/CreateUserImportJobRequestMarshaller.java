...
public class CreateUserImportJobRequestMarshaller
    ...
    public CreateUserImportJobRequestMarshaller(
    ...
    public Request<CreateUserImportJobRequest> marshall(
        ...
        Request<CreateUserImportJobRequest> request = new DefaultRequest<CreateUserImportJobRequest>(
                createUserImportJobRequest, "AWSCognitoIdentityProvider");
