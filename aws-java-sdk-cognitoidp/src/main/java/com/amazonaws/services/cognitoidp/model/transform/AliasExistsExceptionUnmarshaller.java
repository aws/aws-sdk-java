...
public class AliasExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AliasExistsExceptionUnmarshaller instance;

    public static AliasExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AliasExistsExceptionUnmarshaller();
        return instance;
    }
}
