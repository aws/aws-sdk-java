 ...
 */
public class StringAttributeConstraintsTypeJsonUnmarshaller implements
        Unmarshaller<StringAttributeConstraintsType, JsonUnmarshallerContext> {

    public StringAttributeConstraintsType unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MinLength", targetDepth)) {
                    context.nextToken();
                    stringAttributeConstraintsType.setMinLength(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MaxLength", targetDepth)) {
                    context.nextToken();
                    stringAttributeConstraintsType.setMaxLength(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
