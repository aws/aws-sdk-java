...
public class ContextDataTypeMarshaller {
    ...
    private static final MarshallingInfo<String> SERVERPATH_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ServerPath").build();
    private static final MarshallingInfo<List> HTTPHEADERS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("HttpHeaders").build();
