...
public class InitiateAuthRequestMarshaller implements Marshaller<Request<InitiateAuthRequest>, InitiateAuthRequest> {
    ...
    public InitiateAuthRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<InitiateAuthRequest> marshall(InitiateAuthRequest initiateAuthRequest) {
        ...
        Request<InitiateAuthRequest> request = new DefaultRequest<InitiateAuthRequest>(initiateAuthRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            java.util.Map<String, String> authParametersMap = initiateAuthRequest.getAuthParameters();
            ...
            java.util.Map<String, String> clientMetadataMap = initiateAuthRequest.getClientMetadata();
