...
public class DescribeUserPoolClientRequestMarshaller
        implements
        Marshaller<Request<DescribeUserPoolClientRequest>, DescribeUserPoolClientRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeUserPoolClientRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeUserPoolClientRequest> marshall(
        ...
        Request<DescribeUserPoolClientRequest> request = new DefaultRequest<DescribeUserPoolClientRequest>(
                describeUserPoolClientRequest, "AWSCognitoIdentityProvider");
