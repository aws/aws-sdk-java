...
/**
 * SetRiskConfigurationResult JSON Unmarshaller
 */
...
public class SetRiskConfigurationResultJsonUnmarshaller implements Unmarshaller<SetRiskConfigurationResult, JsonUnmarshallerContext> {
    ...
    public SetRiskConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RiskConfiguration", targetDepth)) {
                    context.nextToken();
                    setRiskConfigurationResult.setRiskConfiguration(RiskConfigurationTypeJsonUnmarshaller.getInstance().unmarshall(context));
                }
