 ...
 */
public class AdminDisableUserResultJsonUnmarshaller implements
        Unmarshaller<AdminDisableUserResult, JsonUnmarshallerContext> {

    public AdminDisableUserResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
