...
public class InvalidSmsRoleTrustRelationshipExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSmsRoleTrustRelationshipExceptionUnmarshaller instance;

    public static InvalidSmsRoleTrustRelationshipExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSmsRoleTrustRelationshipExceptionUnmarshaller();
        return instance;
    }
}
