...
public class ConfirmSignUpRequestMarshaller implements
    ...
    public Request<ConfirmSignUpRequest> marshall(
        ...
        Request<ConfirmSignUpRequest> request = new DefaultRequest<ConfirmSignUpRequest>(
                confirmSignUpRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            if (confirmSignUpRequest.getClientId() != null) {
                jsonGenerator.writeFieldName("ClientId").writeValue(
                        confirmSignUpRequest.getClientId());
            }
            if (confirmSignUpRequest.getSecretHash() != null) {
                jsonGenerator.writeFieldName("SecretHash").writeValue(
                        confirmSignUpRequest.getSecretHash());
            }
            if (confirmSignUpRequest.getUsername() != null) {
                jsonGenerator.writeFieldName("Username").writeValue(
                        confirmSignUpRequest.getUsername());
            }
            if (confirmSignUpRequest.getConfirmationCode() != null) {
                jsonGenerator.writeFieldName("ConfirmationCode").writeValue(
                        confirmSignUpRequest.getConfirmationCode());
            }
            if (confirmSignUpRequest.getForceAliasCreation() != null) {
                jsonGenerator.writeFieldName("ForceAliasCreation").writeValue(
                        confirmSignUpRequest.getForceAliasCreation());
            }
