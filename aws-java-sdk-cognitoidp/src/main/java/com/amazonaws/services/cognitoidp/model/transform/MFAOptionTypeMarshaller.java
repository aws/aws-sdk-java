...
public class MFAOptionTypeMarshaller {
    ...
    private static final MarshallingInfo<String> DELIVERYMEDIUM_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DeliveryMedium").build();
