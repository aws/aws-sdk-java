...
public class InitiateAuthResultJsonUnmarshaller implements
    ...
    public InitiateAuthResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChallengeName", targetDepth)) {
                    context.nextToken();
                    initiateAuthResult.setChallengeName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Session", targetDepth)) {
                    context.nextToken();
                    initiateAuthResult.setSession(context.getUnmarshaller(
