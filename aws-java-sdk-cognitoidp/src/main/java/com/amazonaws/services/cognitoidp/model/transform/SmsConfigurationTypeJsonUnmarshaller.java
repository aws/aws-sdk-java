 ...
 */
public class SmsConfigurationTypeJsonUnmarshaller implements
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SnsCallerArn", targetDepth)) {
                    context.nextToken();
                    smsConfigurationType.setSnsCallerArn(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ExternalId", targetDepth)) {
                    context.nextToken();
                    smsConfigurationType.setExternalId(context.getUnmarshaller(
