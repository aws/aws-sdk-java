...
/**
 * SmsConfigurationType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SmsConfigurationTypeJsonUnmarshaller implements Unmarshaller<SmsConfigurationType, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SnsCallerArn", targetDepth)) {
                    context.nextToken();
                    smsConfigurationType.setSnsCallerArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
