...
public class StringAttributeConstraintsTypeJsonMarshaller {
     ...
     */
    public void marshall(StringAttributeConstraintsType stringAttributeConstraintsType, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (stringAttributeConstraintsType.getMinLength() != null) {
                jsonGenerator.writeFieldName("MinLength").writeValue(stringAttributeConstraintsType.getMinLength());
            }
            if (stringAttributeConstraintsType.getMaxLength() != null) {
                jsonGenerator.writeFieldName("MaxLength").writeValue(stringAttributeConstraintsType.getMaxLength());
            }
