    ...
    public void marshall(
        ...
        try {
            ...
            if (deviceSecretVerifierConfigType.getPasswordVerifier() != null) {
                jsonGenerator.writeFieldName("PasswordVerifier").writeValue(
                        deviceSecretVerifierConfigType.getPasswordVerifier());
            }
            if (deviceSecretVerifierConfigType.getSalt() != null) {
                jsonGenerator.writeFieldName("Salt").writeValue(
                        deviceSecretVerifierConfigType.getSalt());
            }
