...
/**
 * CustomSMSLambdaVersionConfigType JSON Unmarshaller
 */
...
public class CustomSMSLambdaVersionConfigTypeJsonUnmarshaller implements Unmarshaller<CustomSMSLambdaVersionConfigType, JsonUnmarshallerContext> {
    ...
    public CustomSMSLambdaVersionConfigType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("LambdaVersion", targetDepth)) {
                    context.nextToken();
                    customSMSLambdaVersionConfigType.setLambdaVersion(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("LambdaArn", targetDepth)) {
                    context.nextToken();
                    customSMSLambdaVersionConfigType.setLambdaArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
