...
public class SetUserPoolMfaConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public SetUserPoolMfaConfigResult clone() {
        try {
            return (SetUserPoolMfaConfigResult) super.clone();
