...
public class UICustomizationTypeMarshaller {
    ...
    private static final MarshallingInfo<String> CSSVERSION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CSSVersion").build();
    ...
    public void marshall(UICustomizationType uICustomizationType, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(uICustomizationType.getUserPoolId(), USERPOOLID_BINDING);
            protocolMarshaller.marshall(uICustomizationType.getClientId(), CLIENTID_BINDING);
            protocolMarshaller.marshall(uICustomizationType.getImageUrl(), IMAGEURL_BINDING);
            protocolMarshaller.marshall(uICustomizationType.getCSS(), CSS_BINDING);
            protocolMarshaller.marshall(uICustomizationType.getCSSVersion(), CSSVERSION_BINDING);
            protocolMarshaller.marshall(uICustomizationType.getLastModifiedDate(), LASTMODIFIEDDATE_BINDING);
            protocolMarshaller.marshall(uICustomizationType.getCreationDate(), CREATIONDATE_BINDING);
        } catch (Exception e) {
