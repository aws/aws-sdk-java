...
public class ConfirmForgotPasswordRequestMarshaller
    ...
    public ConfirmForgotPasswordRequestMarshaller(
    ...
    public Request<ConfirmForgotPasswordRequest> marshall(
        ...
        Request<ConfirmForgotPasswordRequest> request = new DefaultRequest<ConfirmForgotPasswordRequest>(
                confirmForgotPasswordRequest, "AWSCognitoIdentityProvider");
