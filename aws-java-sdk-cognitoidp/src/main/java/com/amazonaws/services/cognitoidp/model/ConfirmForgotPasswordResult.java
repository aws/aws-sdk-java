...
public class ConfirmForgotPasswordResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConfirmForgotPasswordResult == false)
            return false;
        ConfirmForgotPasswordResult other = (ConfirmForgotPasswordResult) obj;
        return true;
    }
    ...
    public ConfirmForgotPasswordResult clone() {
        try {
            return (ConfirmForgotPasswordResult) super.clone();
