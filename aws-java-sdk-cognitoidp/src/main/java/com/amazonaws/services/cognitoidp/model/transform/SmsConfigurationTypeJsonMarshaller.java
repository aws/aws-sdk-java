...
public class SmsConfigurationTypeJsonMarshaller {
     ...
     */
    public void marshall(SmsConfigurationType smsConfigurationType,
        ...
        try {
            ...
            if (smsConfigurationType.getSnsCallerArn() != null) {
                jsonGenerator.writeFieldName("SnsCallerArn").writeValue(
                        smsConfigurationType.getSnsCallerArn());
            }
            if (smsConfigurationType.getExternalId() != null) {
                jsonGenerator.writeFieldName("ExternalId").writeValue(
                        smsConfigurationType.getExternalId());
            }
