...
public class DeleteUserAttributesRequestMarshaller
    ...
    public DeleteUserAttributesRequestMarshaller(
    ...
    public Request<DeleteUserAttributesRequest> marshall(
        ...
        Request<DeleteUserAttributesRequest> request = new DefaultRequest<DeleteUserAttributesRequest>(
                deleteUserAttributesRequest, "AWSCognitoIdentityProvider");
        ...
        try {
            ...
            java.util.List<String> userAttributeNamesList = deleteUserAttributesRequest
            ...
            if (deleteUserAttributesRequest.getAccessToken() != null) {
                jsonGenerator.writeFieldName("AccessToken").writeValue(
                        deleteUserAttributesRequest.getAccessToken());
            }
