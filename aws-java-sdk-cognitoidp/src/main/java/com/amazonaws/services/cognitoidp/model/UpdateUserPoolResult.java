...
public class UpdateUserPoolResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateUserPoolResult == false)
            return false;
        UpdateUserPoolResult other = (UpdateUserPoolResult) obj;
        return true;
    }
    ...
    @Override
    public UpdateUserPoolResult clone() {
        try {
            return (UpdateUserPoolResult) super.clone();
