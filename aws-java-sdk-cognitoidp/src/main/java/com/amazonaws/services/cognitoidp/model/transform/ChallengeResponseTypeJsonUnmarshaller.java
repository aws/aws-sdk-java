...
/**
 * ChallengeResponseType JSON Unmarshaller
 */
...
public class ChallengeResponseTypeJsonUnmarshaller implements Unmarshaller<ChallengeResponseType, JsonUnmarshallerContext> {
    ...
    public ChallengeResponseType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChallengeName", targetDepth)) {
                    context.nextToken();
                    challengeResponseType.setChallengeName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ChallengeResponse", targetDepth)) {
                    context.nextToken();
                    challengeResponseType.setChallengeResponse(context.getUnmarshaller(String.class).unmarshall(context));
                }
