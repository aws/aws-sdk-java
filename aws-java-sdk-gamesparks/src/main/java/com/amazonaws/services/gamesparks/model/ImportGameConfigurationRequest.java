...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/gamesparks-2021-08-17/ImportGameConfiguration" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportGameConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public void setImportSource(ImportGameConfigurationSource importSource) {
     ...
     * </p>
     * 
     * @return The source used to import configuration sections.
     */

    public ImportGameConfigurationSource getImportSource() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportGameConfigurationRequest == false)
            return false;
        ImportGameConfigurationRequest other = (ImportGameConfigurationRequest) obj;
    ...
    @Override
    public ImportGameConfigurationRequest clone() {
        return (ImportGameConfigurationRequest) super.clone();
    }
