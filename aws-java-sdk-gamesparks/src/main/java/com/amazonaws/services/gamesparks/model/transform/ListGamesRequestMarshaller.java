...
public class ListGamesRequestMarshaller {
    ...
    public void marshall(ListGamesRequest listGamesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listGamesRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listGamesRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
