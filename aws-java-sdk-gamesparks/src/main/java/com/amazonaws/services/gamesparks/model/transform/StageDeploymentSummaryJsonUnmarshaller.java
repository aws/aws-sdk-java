...
/**
 * StageDeploymentSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StageDeploymentSummaryJsonUnmarshaller implements Unmarshaller<StageDeploymentSummary, JsonUnmarshallerContext> {

    public StageDeploymentSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        StageDeploymentSummary stageDeploymentSummary = new StageDeploymentSummary();
    ...
    private static StageDeploymentSummaryJsonUnmarshaller instance;

    public static StageDeploymentSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StageDeploymentSummaryJsonUnmarshaller();
        return instance;
    }
}
