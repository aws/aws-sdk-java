...
public class GetGameResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetGameResult == false)
            return false;
        GetGameResult other = (GetGameResult) obj;
    ...
    public GetGameResult clone() {
        try {
            return (GetGameResult) super.clone();
