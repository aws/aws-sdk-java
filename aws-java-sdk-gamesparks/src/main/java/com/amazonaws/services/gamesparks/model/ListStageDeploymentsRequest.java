...
public class ListStageDeploymentsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListStageDeploymentsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListStageDeploymentsRequest == false)
            return false;
        ListStageDeploymentsRequest other = (ListStageDeploymentsRequest) obj;
    ...
    @Override
    public ListStageDeploymentsRequest clone() {
