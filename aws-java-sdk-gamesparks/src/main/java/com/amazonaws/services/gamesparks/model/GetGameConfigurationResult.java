...
public class GetGameConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetGameConfigurationResult == false)
            return false;
        GetGameConfigurationResult other = (GetGameConfigurationResult) obj;
    ...
    @Override
    public GetGameConfigurationResult clone() {
        try {
            return (GetGameConfigurationResult) super.clone();
