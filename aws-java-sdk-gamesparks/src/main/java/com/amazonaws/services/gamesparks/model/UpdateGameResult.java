...
public class UpdateGameResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateGameResult == false)
            return false;
        UpdateGameResult other = (UpdateGameResult) obj;
    ...
    @Override
    public UpdateGameResult clone() {
        try {
            return (UpdateGameResult) super.clone();
