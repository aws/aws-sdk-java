...
public class ExportSnapshotRequestMarshaller {
    ...
    public void marshall(ExportSnapshotRequest exportSnapshotRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(exportSnapshotRequest.getGameName(), GAMENAME_BINDING);
            protocolMarshaller.marshall(exportSnapshotRequest.getSnapshotId(), SNAPSHOTID_BINDING);
        } catch (Exception e) {
