...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.managedgrafana.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.managedgrafana.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.managedgrafana.model.ConflictException conflictException = new com.amazonaws.services.managedgrafana.model.ConflictException(
                null);
