...
/**
 * AssertionAttributes JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssertionAttributesJsonUnmarshaller implements Unmarshaller<AssertionAttributes, JsonUnmarshallerContext> {

    public AssertionAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssertionAttributes assertionAttributes = new AssertionAttributes();
    ...
    private static AssertionAttributesJsonUnmarshaller instance;

    public static AssertionAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssertionAttributesJsonUnmarshaller();
        return instance;
    }
}
