        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("causedBy", targetDepth)) {
                    context.nextToken();
                    updateError.setCausedBy(UpdateInstructionJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("code", targetDepth)) {
                    context.nextToken();
                    updateError.setCode(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("message", targetDepth)) {
                    context.nextToken();
                    updateError.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
