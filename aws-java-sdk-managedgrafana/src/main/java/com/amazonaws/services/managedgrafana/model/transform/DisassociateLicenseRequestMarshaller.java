...
public class DisassociateLicenseRequestMarshaller {
    ...
    private static final DisassociateLicenseRequestMarshaller instance = new DisassociateLicenseRequestMarshaller();

    public static DisassociateLicenseRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DisassociateLicenseRequest disassociateLicenseRequest, ProtocolMarshaller protocolMarshaller) {

        if (disassociateLicenseRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(disassociateLicenseRequest.getLicenseType(), LICENSETYPE_BINDING);
            protocolMarshaller.marshall(disassociateLicenseRequest.getWorkspaceId(), WORKSPACEID_BINDING);
        } catch (Exception e) {
