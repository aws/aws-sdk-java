...
public class DescribeLocationFsxWindowsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeLocationFsxWindowsRequest == false)
            return false;
        DescribeLocationFsxWindowsRequest other = (DescribeLocationFsxWindowsRequest) obj;
    ...
    @Override
    public DescribeLocationFsxWindowsRequest clone() {
        return (DescribeLocationFsxWindowsRequest) super.clone();
    }
