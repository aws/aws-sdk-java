...
public class RemoveStorageSystemRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the Amazon Resource Name (ARN) of the storage system that you want to permanently remove from
     *         DataSync Discovery.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RemoveStorageSystemRequest == false)
            return false;
        RemoveStorageSystemRequest other = (RemoveStorageSystemRequest) obj;
    ...
    public RemoveStorageSystemRequest clone() {
        return (RemoveStorageSystemRequest) super.clone();
    }
