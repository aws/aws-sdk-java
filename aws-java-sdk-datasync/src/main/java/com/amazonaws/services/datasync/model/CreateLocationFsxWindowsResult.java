...
public class CreateLocationFsxWindowsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLocationFsxWindowsResult == false)
            return false;
        CreateLocationFsxWindowsResult other = (CreateLocationFsxWindowsResult) obj;
    ...
    public CreateLocationFsxWindowsResult clone() {
        try {
            return (CreateLocationFsxWindowsResult) super.clone();
