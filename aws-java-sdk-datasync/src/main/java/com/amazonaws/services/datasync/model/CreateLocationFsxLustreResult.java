...
public class CreateLocationFsxLustreResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the FSx for Lustre file system location that's created.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLocationFsxLustreResult == false)
            return false;
        CreateLocationFsxLustreResult other = (CreateLocationFsxLustreResult) obj;
    ...
    public CreateLocationFsxLustreResult clone() {
        try {
            return (CreateLocationFsxLustreResult) super.clone();
