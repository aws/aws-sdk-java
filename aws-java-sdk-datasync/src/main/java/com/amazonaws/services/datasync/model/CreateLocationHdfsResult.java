...
public class CreateLocationHdfsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the source HDFS cluster location that's created.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLocationHdfsResult == false)
            return false;
        CreateLocationHdfsResult other = (CreateLocationHdfsResult) obj;
    ...
    @Override
    public CreateLocationHdfsResult clone() {
        try {
            return (CreateLocationHdfsResult) super.clone();
