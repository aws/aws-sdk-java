...
/**
 * UpdateLocationSmbResult JSON Unmarshaller
 */
...
public class UpdateLocationSmbResultJsonUnmarshaller implements Unmarshaller<UpdateLocationSmbResult, JsonUnmarshallerContext> {
    ...
    public UpdateLocationSmbResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateLocationSmbResult updateLocationSmbResult = new UpdateLocationSmbResult();

        return updateLocationSmbResult;
    }
