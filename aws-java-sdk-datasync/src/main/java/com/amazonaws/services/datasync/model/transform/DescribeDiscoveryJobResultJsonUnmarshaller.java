...
/**
 * DescribeDiscoveryJobResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeDiscoveryJobResultJsonUnmarshaller implements Unmarshaller<DescribeDiscoveryJobResult, JsonUnmarshallerContext> {

    public DescribeDiscoveryJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribeDiscoveryJobResult describeDiscoveryJobResult = new DescribeDiscoveryJobResult();
    ...
    private static DescribeDiscoveryJobResultJsonUnmarshaller instance;

    public static DescribeDiscoveryJobResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeDiscoveryJobResultJsonUnmarshaller();
        return instance;
    }
}
