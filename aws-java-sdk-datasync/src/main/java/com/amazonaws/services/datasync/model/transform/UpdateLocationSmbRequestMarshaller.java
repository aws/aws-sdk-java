...
public class UpdateLocationSmbRequestMarshaller {
    ...
    private static final UpdateLocationSmbRequestMarshaller instance = new UpdateLocationSmbRequestMarshaller();

    public static UpdateLocationSmbRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateLocationSmbRequest updateLocationSmbRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateLocationSmbRequest.getLocationArn(), LOCATIONARN_BINDING);
            protocolMarshaller.marshall(updateLocationSmbRequest.getSubdirectory(), SUBDIRECTORY_BINDING);
            protocolMarshaller.marshall(updateLocationSmbRequest.getUser(), USER_BINDING);
            protocolMarshaller.marshall(updateLocationSmbRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(updateLocationSmbRequest.getPassword(), PASSWORD_BINDING);
            protocolMarshaller.marshall(updateLocationSmbRequest.getAgentArns(), AGENTARNS_BINDING);
            protocolMarshaller.marshall(updateLocationSmbRequest.getMountOptions(), MOUNTOPTIONS_BINDING);
        } catch (Exception e) {
