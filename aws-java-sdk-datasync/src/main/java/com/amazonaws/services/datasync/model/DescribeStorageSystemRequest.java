...
public class DescribeStorageSystemRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the Amazon Resource Name (ARN) of an on-premises storage system that you're using with DataSync
     *         Discovery.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeStorageSystemRequest == false)
            return false;
        DescribeStorageSystemRequest other = (DescribeStorageSystemRequest) obj;
    ...
    @Override
    public DescribeStorageSystemRequest clone() {
