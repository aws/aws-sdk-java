...
/**
 * StopDiscoveryJobResult JSON Unmarshaller
 */
...
public class StopDiscoveryJobResultJsonUnmarshaller implements Unmarshaller<StopDiscoveryJobResult, JsonUnmarshallerContext> {
    ...
    public StopDiscoveryJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopDiscoveryJobResult stopDiscoveryJobResult = new StopDiscoveryJobResult();

        return stopDiscoveryJobResult;
    }
