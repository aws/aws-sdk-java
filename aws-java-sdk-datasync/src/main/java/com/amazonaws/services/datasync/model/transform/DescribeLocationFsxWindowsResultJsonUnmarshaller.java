...
/**
 * DescribeLocationFsxWindowsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeLocationFsxWindowsResultJsonUnmarshaller implements Unmarshaller<DescribeLocationFsxWindowsResult, JsonUnmarshallerContext> {

    public DescribeLocationFsxWindowsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribeLocationFsxWindowsResult describeLocationFsxWindowsResult = new DescribeLocationFsxWindowsResult();
    ...
    private static DescribeLocationFsxWindowsResultJsonUnmarshaller instance;

    public static DescribeLocationFsxWindowsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeLocationFsxWindowsResultJsonUnmarshaller();
        return instance;
    }
}
