...
/**
 * UpdateLocationObjectStorageResult JSON Unmarshaller
 */
...
public class UpdateLocationObjectStorageResultJsonUnmarshaller implements Unmarshaller<UpdateLocationObjectStorageResult, JsonUnmarshallerContext> {
    ...
    public UpdateLocationObjectStorageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateLocationObjectStorageResult updateLocationObjectStorageResult = new UpdateLocationObjectStorageResult();

        return updateLocationObjectStorageResult;
    }
