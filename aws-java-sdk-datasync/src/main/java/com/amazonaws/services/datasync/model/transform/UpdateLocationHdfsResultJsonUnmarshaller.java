...
/**
 * UpdateLocationHdfsResult JSON Unmarshaller
 */
...
public class UpdateLocationHdfsResultJsonUnmarshaller implements Unmarshaller<UpdateLocationHdfsResult, JsonUnmarshallerContext> {
    ...
    public UpdateLocationHdfsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateLocationHdfsResult updateLocationHdfsResult = new UpdateLocationHdfsResult();

        return updateLocationHdfsResult;
    }
