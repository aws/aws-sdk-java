...
/**
 * ACLPendingChangesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ACLPendingChangesMarshaller {

    private static final MarshallingInfo<List> USERNAMESTOREMOVE_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("UserNamesToRemove").build();
    private static final MarshallingInfo<List> USERNAMESTOADD_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("UserNamesToAdd").build();
