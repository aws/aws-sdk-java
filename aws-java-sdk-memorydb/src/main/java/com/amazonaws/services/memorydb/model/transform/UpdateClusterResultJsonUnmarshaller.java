...
/**
 * UpdateClusterResult JSON Unmarshaller
 */
...
public class UpdateClusterResultJsonUnmarshaller implements Unmarshaller<UpdateClusterResult, JsonUnmarshallerContext> {
    ...
    public UpdateClusterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateClusterResult updateClusterResult = new UpdateClusterResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Cluster", targetDepth)) {
                    context.nextToken();
                    updateClusterResult.setCluster(ClusterJsonUnmarshaller.getInstance().unmarshall(context));
                }
