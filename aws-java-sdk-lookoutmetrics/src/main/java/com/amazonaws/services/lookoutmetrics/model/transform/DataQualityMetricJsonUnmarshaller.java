...
/**
 * DataQualityMetric JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataQualityMetricJsonUnmarshaller implements Unmarshaller<DataQualityMetric, JsonUnmarshallerContext> {

    public DataQualityMetric unmarshall(JsonUnmarshallerContext context) throws Exception {
        DataQualityMetric dataQualityMetric = new DataQualityMetric();
    ...
    private static DataQualityMetricJsonUnmarshaller instance;

    public static DataQualityMetricJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DataQualityMetricJsonUnmarshaller();
        return instance;
    }
}
