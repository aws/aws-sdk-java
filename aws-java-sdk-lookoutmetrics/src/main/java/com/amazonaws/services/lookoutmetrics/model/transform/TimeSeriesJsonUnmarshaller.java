...
/**
 * TimeSeries JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TimeSeriesJsonUnmarshaller implements Unmarshaller<TimeSeries, JsonUnmarshallerContext> {

    public TimeSeries unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static TimeSeriesJsonUnmarshaller instance;

    public static TimeSeriesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TimeSeriesJsonUnmarshaller();
        return instance;
    }
}
