...
public class PutFeedbackRequestMarshaller {
    ...
    public void marshall(PutFeedbackRequest putFeedbackRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putFeedbackRequest.getAnomalyDetectorArn(), ANOMALYDETECTORARN_BINDING);
            protocolMarshaller.marshall(putFeedbackRequest.getAnomalyGroupTimeSeriesFeedback(), ANOMALYGROUPTIMESERIESFEEDBACK_BINDING);
        } catch (Exception e) {
