...
/**
 * AlertSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AlertSummaryJsonUnmarshaller implements Unmarshaller<AlertSummary, JsonUnmarshallerContext> {

    public AlertSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static AlertSummaryJsonUnmarshaller instance;

    public static AlertSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AlertSummaryJsonUnmarshaller();
        return instance;
    }
}
