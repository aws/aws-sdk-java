...
public class FilterMarshaller {
    ...
    private static final MarshallingInfo<String> FILTEROPERATION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public void marshall(Filter filter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(filter.getDimensionValue(), DIMENSIONVALUE_BINDING);
            protocolMarshaller.marshall(filter.getFilterOperation(), FILTEROPERATION_BINDING);
        } catch (Exception e) {
