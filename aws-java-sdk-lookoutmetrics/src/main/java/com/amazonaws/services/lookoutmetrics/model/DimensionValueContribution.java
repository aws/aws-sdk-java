 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/lookoutmetrics-2017-07-25/DimensionValueContribution"
...
public class DimensionValueContribution implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DimensionValueContribution == false)
            return false;
        ...
        if (other.getDimensionValue() != null && other.getDimensionValue().equals(this.getDimensionValue()) == false)
            return false;
        if (other.getContributionScore() == null ^ this.getContributionScore() == null)
            return false;
        if (other.getContributionScore() != null && other.getContributionScore().equals(this.getContributionScore()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getContributionScore() == null) ? 0 : getContributionScore().hashCode());
        return hashCode;
    }

    @Override
    public DimensionValueContribution clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lookoutmetrics.model.transform.DimensionValueContributionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
