...
public class CreateMetricSetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateMetricSetResult == false)
            return false;
        CreateMetricSetResult other = (CreateMetricSetResult) obj;
    ...
    public CreateMetricSetResult clone() {
        try {
            return (CreateMetricSetResult) super.clone();
