...
/**
 * LambdaConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LambdaConfigurationJsonUnmarshaller implements Unmarshaller<LambdaConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RoleArn", targetDepth)) {
                    context.nextToken();
                    lambdaConfiguration.setRoleArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("LambdaArn", targetDepth)) {
                    context.nextToken();
                    lambdaConfiguration.setLambdaArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
