        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DimensionValue", targetDepth)) {
                    context.nextToken();
                    filter.setDimensionValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("FilterOperation", targetDepth)) {
                    context.nextToken();
                    filter.setFilterOperation(context.getUnmarshaller(String.class).unmarshall(context));
                }
