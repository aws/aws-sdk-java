...
/**
 * BackTestAnomalyDetectorResult JSON Unmarshaller
 */
...
public class BackTestAnomalyDetectorResultJsonUnmarshaller implements Unmarshaller<BackTestAnomalyDetectorResult, JsonUnmarshallerContext> {
    ...
    public BackTestAnomalyDetectorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        BackTestAnomalyDetectorResult backTestAnomalyDetectorResult = new BackTestAnomalyDetectorResult();
