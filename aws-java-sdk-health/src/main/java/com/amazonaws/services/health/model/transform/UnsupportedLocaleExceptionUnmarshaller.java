...
public class UnsupportedLocaleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.health.model.UnsupportedLocaleException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return unsupportedLocaleException;
    }

    private static UnsupportedLocaleExceptionUnmarshaller instance;

    public static UnsupportedLocaleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedLocaleExceptionUnmarshaller();
        return instance;
    }
}
