...
public class DescribeEventsForOrganizationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public void setFilter(OrganizationEventFilter filter) {
        this.filter = filter;
    }
    ...
    public OrganizationEventFilter getFilter() {
        return this.filter;
    }
    ...
    public DescribeEventsForOrganizationRequest withFilter(OrganizationEventFilter filter) {
        setFilter(filter);
        return this;
    }
    ...
    public DescribeEventsForOrganizationRequest withMaxResults(Integer maxResults) {
    ...
    public DescribeEventsForOrganizationRequest withLocale(String locale) {
        setLocale(locale);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEventsForOrganizationRequest == false)
            return false;
        DescribeEventsForOrganizationRequest other = (DescribeEventsForOrganizationRequest) obj;
    ...
    @Override
    public DescribeEventsForOrganizationRequest clone() {
        return (DescribeEventsForOrganizationRequest) super.clone();
    }
