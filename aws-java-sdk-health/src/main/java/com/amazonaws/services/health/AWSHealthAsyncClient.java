...
public class AWSHealthAsyncClient extends AWSHealthClient implements AWSHealthAsync {
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSHealthAsyncClient(com.amazonaws.ClientConfiguration clientConfiguration) {
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSHealthAsyncClient(com.amazonaws.auth.AWSCredentials awsCredentials) {
     ...
     */
    public AWSHealthAsyncClient(com.amazonaws.auth.AWSCredentials awsCredentials, java.util.concurrent.ExecutorService executorService) {
     ...
     *        The executor service by which all asynchronous requests will be executed.
     */
    public AWSHealthAsyncClient(com.amazonaws.auth.AWSCredentials awsCredentials, com.amazonaws.ClientConfiguration clientConfiguration,
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSHealthAsyncClient(com.amazonaws.auth.AWSCredentialsProvider awsCredentialsProvider) {
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSHealthAsyncClient(com.amazonaws.auth.AWSCredentialsProvider awsCredentialsProvider, com.amazonaws.ClientConfiguration clientConfiguration) {
     ...
     *        The executor service by which all asynchronous requests will be executed.
     */
    public AWSHealthAsyncClient(com.amazonaws.auth.AWSCredentialsProvider awsCredentialsProvider, java.util.concurrent.ExecutorService executorService) {
