...
public class ListDatasourcePackagesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDatasourcePackagesRequest withGraphArn(String graphArn) {
    ...
    public ListDatasourcePackagesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDatasourcePackagesRequest == false)
            return false;
        ListDatasourcePackagesRequest other = (ListDatasourcePackagesRequest) obj;
    ...
    @Override
    public ListDatasourcePackagesRequest clone() {
        return (ListDatasourcePackagesRequest) super.clone();
    }
