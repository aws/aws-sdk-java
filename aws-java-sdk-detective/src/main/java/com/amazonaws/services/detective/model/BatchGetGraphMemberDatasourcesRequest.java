...
public class BatchGetGraphMemberDatasourcesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The list of Amazon Web Services accounts to get data source package information on.
     */
    ...
    public BatchGetGraphMemberDatasourcesRequest withAccountIds(String... accountIds) {
    ...
    public BatchGetGraphMemberDatasourcesRequest withAccountIds(java.util.Collection<String> accountIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetGraphMemberDatasourcesRequest == false)
            return false;
        BatchGetGraphMemberDatasourcesRequest other = (BatchGetGraphMemberDatasourcesRequest) obj;
    ...
    public BatchGetGraphMemberDatasourcesRequest clone() {
        return (BatchGetGraphMemberDatasourcesRequest) super.clone();
    }
