...
public class ListGraphsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The maximum number of graphs to return at a time. The total must be less than the overall limit on the number of
    ...
    public ListGraphsRequest withNextToken(String nextToken) {
     ...
     * 
     * @param maxResults
     *        The maximum number of graphs to return at a time. The total must be less than the overall limit on the
     ...
     * </p>
     * 
     * @return The maximum number of graphs to return at a time. The total must be less than the overall limit on the
     *         number of results to return, which is currently 200.
     */
    ...
    public ListGraphsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListGraphsRequest == false)
            return false;
        ListGraphsRequest other = (ListGraphsRequest) obj;
    ...
    @Override
    public ListGraphsRequest clone() {
        return (ListGraphsRequest) super.clone();
    }
