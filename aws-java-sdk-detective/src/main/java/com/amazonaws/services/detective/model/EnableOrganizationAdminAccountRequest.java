...
public class EnableOrganizationAdminAccountRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param accountId
     *        The Amazon Web Services account identifier of the account to designate as the Detective administrator
     ...
     * </p>
     * 
     * @return The Amazon Web Services account identifier of the account to designate as the Detective administrator
     *         account for the organization.
     */
    ...
    public EnableOrganizationAdminAccountRequest withAccountId(String accountId) {
