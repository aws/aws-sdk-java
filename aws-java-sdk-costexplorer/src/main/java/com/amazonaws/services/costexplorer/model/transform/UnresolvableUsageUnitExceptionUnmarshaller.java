...
public class UnresolvableUsageUnitExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnresolvableUsageUnitExceptionUnmarshaller instance;

    public static UnresolvableUsageUnitExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnresolvableUsageUnitExceptionUnmarshaller();
        return instance;
    }
}
