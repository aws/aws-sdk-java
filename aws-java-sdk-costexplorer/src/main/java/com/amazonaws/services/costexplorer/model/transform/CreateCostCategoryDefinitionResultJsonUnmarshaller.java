...
/**
 * CreateCostCategoryDefinitionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateCostCategoryDefinitionResultJsonUnmarshaller implements Unmarshaller<CreateCostCategoryDefinitionResult, JsonUnmarshallerContext> {

    public CreateCostCategoryDefinitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
