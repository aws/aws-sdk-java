...
public class RequestChangedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RequestChangedExceptionUnmarshaller instance;

    public static RequestChangedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RequestChangedExceptionUnmarshaller();
        return instance;
    }
}
