...
/**
 * GetReservationUtilizationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetReservationUtilizationResultJsonUnmarshaller implements Unmarshaller<GetReservationUtilizationResult, JsonUnmarshallerContext> {

    public GetReservationUtilizationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
