...
/**
 * DeleteAnomalyMonitorResult JSON Unmarshaller
 */
...
public class DeleteAnomalyMonitorResultJsonUnmarshaller implements Unmarshaller<DeleteAnomalyMonitorResult, JsonUnmarshallerContext> {
    ...
    public DeleteAnomalyMonitorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAnomalyMonitorResult deleteAnomalyMonitorResult = new DeleteAnomalyMonitorResult();
