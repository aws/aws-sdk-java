...
/**
 * EC2Specification JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EC2SpecificationJsonUnmarshaller implements Unmarshaller<EC2Specification, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("OfferingClass", targetDepth)) {
                    context.nextToken();
                    eC2Specification.setOfferingClass(context.getUnmarshaller(String.class).unmarshall(context));
                }
