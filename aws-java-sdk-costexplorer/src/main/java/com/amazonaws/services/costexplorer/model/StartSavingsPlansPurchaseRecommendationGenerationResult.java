...
public class StartSavingsPlansPurchaseRecommendationGenerationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartSavingsPlansPurchaseRecommendationGenerationResult == false)
            return false;
        StartSavingsPlansPurchaseRecommendationGenerationResult other = (StartSavingsPlansPurchaseRecommendationGenerationResult) obj;
    ...
    public StartSavingsPlansPurchaseRecommendationGenerationResult clone() {
        try {
            return (StartSavingsPlansPurchaseRecommendationGenerationResult) super.clone();
