...
@SdkInternalApi
public class GetCostAndUsageRequestMarshaller {
    ...
    private static final GetCostAndUsageRequestMarshaller instance = new GetCostAndUsageRequestMarshaller();

    public static GetCostAndUsageRequestMarshaller getInstance() {
        return instance;
    }
