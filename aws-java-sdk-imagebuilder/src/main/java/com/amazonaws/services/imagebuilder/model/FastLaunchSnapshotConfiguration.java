 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/imagebuilder-2019-12-02/FastLaunchSnapshotConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FastLaunchSnapshotConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FastLaunchSnapshotConfiguration == false)
            return false;
        FastLaunchSnapshotConfiguration other = (FastLaunchSnapshotConfiguration) obj;
    ...
    public FastLaunchSnapshotConfiguration clone() {
        try {
            return (FastLaunchSnapshotConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.imagebuilder.model.transform.FastLaunchSnapshotConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
