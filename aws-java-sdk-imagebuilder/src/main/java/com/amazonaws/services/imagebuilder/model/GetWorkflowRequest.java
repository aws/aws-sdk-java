...
public class GetWorkflowRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the workflow resource that you want to get.
     */
    ...
    public GetWorkflowRequest withWorkflowBuildVersionArn(String workflowBuildVersionArn) {
