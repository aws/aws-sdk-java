...
public class PutImageRecipePolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the image recipe that this policy was applied to.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutImageRecipePolicyResult == false)
            return false;
        PutImageRecipePolicyResult other = (PutImageRecipePolicyResult) obj;
    ...
    public PutImageRecipePolicyResult clone() {
        try {
            return (PutImageRecipePolicyResult) super.clone();
