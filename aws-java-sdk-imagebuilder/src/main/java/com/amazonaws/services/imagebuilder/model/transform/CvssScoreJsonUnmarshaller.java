...
/**
 * CvssScore JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CvssScoreJsonUnmarshaller implements Unmarshaller<CvssScore, JsonUnmarshallerContext> {

    public CvssScore unmarshall(JsonUnmarshallerContext context) throws Exception {
        CvssScore cvssScore = new CvssScore();
    ...
    private static CvssScoreJsonUnmarshaller instance;

    public static CvssScoreJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CvssScoreJsonUnmarshaller();
        return instance;
    }
}
