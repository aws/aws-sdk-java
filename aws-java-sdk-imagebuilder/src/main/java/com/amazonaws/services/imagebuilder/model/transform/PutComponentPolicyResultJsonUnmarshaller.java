...
/**
 * PutComponentPolicyResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PutComponentPolicyResultJsonUnmarshaller implements Unmarshaller<PutComponentPolicyResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("requestId", targetDepth)) {
                    context.nextToken();
                    putComponentPolicyResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("componentArn", targetDepth)) {
                    context.nextToken();
                    putComponentPolicyResult.setComponentArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
