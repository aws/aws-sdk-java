        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("requestId", targetDepth)) {
                    context.nextToken();
                    createComponentResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("clientToken", targetDepth)) {
                    context.nextToken();
                    createComponentResult.setClientToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("componentBuildVersionArn", targetDepth)) {
                    context.nextToken();
                    createComponentResult.setComponentBuildVersionArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
