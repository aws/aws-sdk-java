...
public class ListComponentsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The owner defines whose components you wish to list. By default this request will only show components owned by
     * your account. You may use this field to specify if you wish to view components owned by yourself, Amazon, or
     ...
     *        Amazon, or those components that have been shared with you by other customers.
     * @see Ownership
     */
     ...
     * </p>
     * 
     * @return The owner defines whose components you wish to list. By default this request will only show components
     *         owned by your account. You may use this field to specify if you wish to view components owned by
     *         yourself, Amazon, or those components that have been shared with you by other customers.
     * @see Ownership
     */
