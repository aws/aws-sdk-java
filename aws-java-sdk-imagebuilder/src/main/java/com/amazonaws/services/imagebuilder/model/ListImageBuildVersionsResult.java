...
public class ListImageBuildVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListImageBuildVersionsResult withRequestId(String requestId) {
    ...
    public ListImageBuildVersionsResult withImageSummaryList(ImageSummary... imageSummaryList) {
    ...
    public ListImageBuildVersionsResult withImageSummaryList(java.util.Collection<ImageSummary> imageSummaryList) {
    ...
    public ListImageBuildVersionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListImageBuildVersionsResult == false)
            return false;
        ListImageBuildVersionsResult other = (ListImageBuildVersionsResult) obj;
    ...
    @Override
    public ListImageBuildVersionsResult clone() {
        try {
            return (ListImageBuildVersionsResult) super.clone();
