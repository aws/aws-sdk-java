...
public class ImagePipelineMarshaller {
    ...
    public void marshall(ImagePipeline imagePipeline, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(imagePipeline.getContainerRecipeArn(), CONTAINERRECIPEARN_BINDING);
            ...
            protocolMarshaller.marshall(imagePipeline.getExecutionRole(), EXECUTIONROLE_BINDING);
            protocolMarshaller.marshall(imagePipeline.getWorkflows(), WORKFLOWS_BINDING);
        } catch (Exception e) {
