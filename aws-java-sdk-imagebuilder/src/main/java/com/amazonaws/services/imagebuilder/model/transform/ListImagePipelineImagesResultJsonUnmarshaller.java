...
/**
 * ListImagePipelineImagesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListImagePipelineImagesResultJsonUnmarshaller implements Unmarshaller<ListImagePipelineImagesResult, JsonUnmarshallerContext> {

    public ListImagePipelineImagesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("requestId", targetDepth)) {
                    context.nextToken();
                    listImagePipelineImagesResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listImagePipelineImagesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
