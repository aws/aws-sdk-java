...
/**
 * ListInfrastructureConfigurationsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListInfrastructureConfigurationsResultJsonUnmarshaller implements Unmarshaller<ListInfrastructureConfigurationsResult, JsonUnmarshallerContext> {

    public ListInfrastructureConfigurationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("requestId", targetDepth)) {
                    context.nextToken();
                    listInfrastructureConfigurationsResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listInfrastructureConfigurationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
