...
public class ListWaitingWorkflowStepsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<WorkflowStepExecution> steps;
    /**
     * <p>
    ...
    public java.util.List<WorkflowStepExecution> getSteps() {
        return steps;
    }
    ...
    public void setSteps(java.util.Collection<WorkflowStepExecution> steps) {
        if (steps == null) {
            this.steps = null;
            return;
        }

        this.steps = new java.util.ArrayList<WorkflowStepExecution>(steps);
    }
    ...
    public ListWaitingWorkflowStepsResult withSteps(WorkflowStepExecution... steps) {
        if (this.steps == null) {
            setSteps(new java.util.ArrayList<WorkflowStepExecution>(steps.length));
        }
        for (WorkflowStepExecution ele : steps) {
            this.steps.add(ele);
        }
        return this;
    }
    ...
    public ListWaitingWorkflowStepsResult withSteps(java.util.Collection<WorkflowStepExecution> steps) {
        setSteps(steps);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListWaitingWorkflowStepsResult == false)
            return false;
        ListWaitingWorkflowStepsResult other = (ListWaitingWorkflowStepsResult) obj;
    ...
    public ListWaitingWorkflowStepsResult clone() {
        try {
            return (ListWaitingWorkflowStepsResult) super.clone();
