        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("requestId", targetDepth)) {
                    context.nextToken();
                    deleteComponentResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("componentBuildVersionArn", targetDepth)) {
                    context.nextToken();
                    deleteComponentResult.setComponentBuildVersionArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
