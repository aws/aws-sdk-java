...
/**
 * DeleteImagePipelineResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteImagePipelineResultJsonUnmarshaller implements Unmarshaller<DeleteImagePipelineResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("requestId", targetDepth)) {
                    context.nextToken();
                    deleteImagePipelineResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("imagePipelineArn", targetDepth)) {
                    context.nextToken();
                    deleteImagePipelineResult.setImagePipelineArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
