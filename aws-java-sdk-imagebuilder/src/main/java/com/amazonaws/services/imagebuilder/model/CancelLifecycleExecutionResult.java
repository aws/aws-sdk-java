...
public class CancelLifecycleExecutionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique identifier for the image lifecycle runtime instance that was canceled.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelLifecycleExecutionResult == false)
            return false;
        CancelLifecycleExecutionResult other = (CancelLifecycleExecutionResult) obj;
    ...
    public CancelLifecycleExecutionResult clone() {
        try {
            return (CancelLifecycleExecutionResult) super.clone();
