...
public class DeleteWorkflowRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the workflow resource to delete.
     */
    ...
    public DeleteWorkflowRequest withWorkflowBuildVersionArn(String workflowBuildVersionArn) {
