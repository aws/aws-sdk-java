 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/imagebuilder-2019-12-02/WorkflowParameter" target="_top">AWS API
 *      Documentation</a>
 */
...
public class WorkflowParameter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The name of the workflow parameter to set.
     */
     ...
     * </p>
     * 
     * @return Sets the value for the named workflow parameter.
     */
    ...
    public WorkflowParameter withValue(String... value) {
        if (this.value == null) {
    ...
    public WorkflowParameter withValue(java.util.Collection<String> value) {
        setValue(value);
        return this;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.imagebuilder.model.transform.WorkflowParameterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
