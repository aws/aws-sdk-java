...
public class ListImagesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The owner defines whose images you wish to list. By default this request will only show images owned by your
     * account. You may use this field to specify if you wish to view images owned by yourself, Amazon, or those images
     ...
     * 
     * @param owner
     *        The owner defines whose images you wish to list. By default this request will only show images owned by
     *        your account. You may use this field to specify if you wish to view images owned by yourself, Amazon, or
     ...
     * </p>
     * 
     * @return The owner defines whose images you wish to list. By default this request will only show images owned by
     *         your account. You may use this field to specify if you wish to view images owned by yourself, Amazon, or
     *         those images that have been shared with you by other customers.
     * @see Ownership
     */
