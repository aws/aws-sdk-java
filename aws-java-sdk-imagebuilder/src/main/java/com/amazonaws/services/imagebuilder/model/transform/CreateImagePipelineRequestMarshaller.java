...
public class CreateImagePipelineRequestMarshaller {
    ...
    public void marshall(CreateImagePipelineRequest createImagePipelineRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createImagePipelineRequest.getWorkflows(), WORKFLOWS_BINDING);
            protocolMarshaller.marshall(createImagePipelineRequest.getExecutionRole(), EXECUTIONROLE_BINDING);
        } catch (Exception e) {
