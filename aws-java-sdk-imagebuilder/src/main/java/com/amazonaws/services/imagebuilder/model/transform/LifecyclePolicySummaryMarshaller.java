...
public class LifecyclePolicySummaryMarshaller {
    ...
    public void marshall(LifecyclePolicySummary lifecyclePolicySummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(lifecyclePolicySummary.getArn(), ARN_BINDING);
            ...
            protocolMarshaller.marshall(lifecyclePolicySummary.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(lifecyclePolicySummary.getExecutionRole(), EXECUTIONROLE_BINDING);
            protocolMarshaller.marshall(lifecyclePolicySummary.getResourceType(), RESOURCETYPE_BINDING);
            protocolMarshaller.marshall(lifecyclePolicySummary.getDateCreated(), DATECREATED_BINDING);
            protocolMarshaller.marshall(lifecyclePolicySummary.getDateUpdated(), DATEUPDATED_BINDING);
            protocolMarshaller.marshall(lifecyclePolicySummary.getDateLastRun(), DATELASTRUN_BINDING);
