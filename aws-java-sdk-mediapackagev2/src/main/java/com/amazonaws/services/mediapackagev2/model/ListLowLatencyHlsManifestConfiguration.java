 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/mediapackagev2-2022-12-25/ListLowLatencyHlsManifestConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListLowLatencyHlsManifestConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public ListLowLatencyHlsManifestConfiguration withManifestName(String manifestName) {
    ...
    public ListLowLatencyHlsManifestConfiguration withChildManifestName(String childManifestName) {
    ...
    public ListLowLatencyHlsManifestConfiguration withUrl(String url) {
        setUrl(url);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLowLatencyHlsManifestConfiguration == false)
            return false;
        ListLowLatencyHlsManifestConfiguration other = (ListLowLatencyHlsManifestConfiguration) obj;
    ...
    @Override
    public ListLowLatencyHlsManifestConfiguration clone() {
        try {
            return (ListLowLatencyHlsManifestConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediapackagev2.model.transform.ListLowLatencyHlsManifestConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
