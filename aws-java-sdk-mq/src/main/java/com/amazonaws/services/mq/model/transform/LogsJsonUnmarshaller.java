...
/**
 * Logs JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LogsJsonUnmarshaller implements Unmarshaller<Logs, JsonUnmarshallerContext> {
    ...
    private static LogsJsonUnmarshaller instance;

    public static LogsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LogsJsonUnmarshaller();
        return instance;
    }
}
