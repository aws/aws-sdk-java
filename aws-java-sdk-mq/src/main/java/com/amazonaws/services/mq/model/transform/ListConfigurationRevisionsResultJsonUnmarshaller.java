...
/**
 * ListConfigurationRevisionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListConfigurationRevisionsResultJsonUnmarshaller implements Unmarshaller<ListConfigurationRevisionsResult, JsonUnmarshallerContext> {

    public ListConfigurationRevisionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("configurationId", targetDepth)) {
                    context.nextToken();
                    listConfigurationRevisionsResult.setConfigurationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("maxResults", targetDepth)) {
                    context.nextToken();
                    listConfigurationRevisionsResult.setMaxResults(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listConfigurationRevisionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
