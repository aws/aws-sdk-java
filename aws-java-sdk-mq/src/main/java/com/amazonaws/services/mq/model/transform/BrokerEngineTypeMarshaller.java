...
public class BrokerEngineTypeMarshaller {
    ...
    private static final MarshallingInfo<List> ENGINEVERSIONS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("engineVersions").build();
    ...
    public void marshall(BrokerEngineType brokerEngineType, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(brokerEngineType.getEngineType(), ENGINETYPE_BINDING);
