...
public class GetDiskSnapshotsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * To get a page token, perform an initial <code>GetDiskSnapshots</code> request. If your results are paginated, the
     ...
     *        <p>
     *        To get a page token, perform an initial <code>GetDiskSnapshots</code> request. If your results are
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDiskSnapshotsRequest == false)
            return false;
        GetDiskSnapshotsRequest other = (GetDiskSnapshotsRequest) obj;
    ...
    @Override
    public GetDiskSnapshotsRequest clone() {
        return (GetDiskSnapshotsRequest) super.clone();
    }
