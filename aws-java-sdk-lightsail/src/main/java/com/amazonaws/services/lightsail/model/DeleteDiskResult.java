...
public class DeleteDiskResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteDiskResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDiskResult == false)
            return false;
        DeleteDiskResult other = (DeleteDiskResult) obj;
    ...
    @Override
    public DeleteDiskResult clone() {
        try {
            return (DeleteDiskResult) super.clone();
