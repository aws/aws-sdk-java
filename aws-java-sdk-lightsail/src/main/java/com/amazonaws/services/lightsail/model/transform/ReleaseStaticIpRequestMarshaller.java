...
public class ReleaseStaticIpRequestMarshaller implements Marshaller<Request<ReleaseStaticIpRequest>, ReleaseStaticIpRequest> {
    ...
    public Request<ReleaseStaticIpRequest> marshall(ReleaseStaticIpRequest releaseStaticIpRequest) {
        ...
        Request<ReleaseStaticIpRequest> request = new DefaultRequest<ReleaseStaticIpRequest>(releaseStaticIpRequest, "AmazonLightsail");
        request.addHeader("X-Amz-Target", "Lightsail_20161128.ReleaseStaticIp");
        ...
        try {
            ...
            if (releaseStaticIpRequest.getStaticIpName() != null) {
                jsonGenerator.writeFieldName("staticIpName").writeValue(releaseStaticIpRequest.getStaticIpName());
            }
