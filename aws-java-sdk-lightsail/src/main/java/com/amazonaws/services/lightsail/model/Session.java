 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/Session" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Session implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getIsPrimary() != null)
            sb.append("IsPrimary: ").append(getIsPrimary());
        sb.append("}");
        return sb.toString();
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lightsail.model.transform.SessionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
