...
public class CreateDiskFromSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateDiskFromSnapshotResult withOperations(Operation... operations) {
    ...
    public CreateDiskFromSnapshotResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDiskFromSnapshotResult == false)
            return false;
        CreateDiskFromSnapshotResult other = (CreateDiskFromSnapshotResult) obj;
    ...
    @Override
    public CreateDiskFromSnapshotResult clone() {
        try {
            return (CreateDiskFromSnapshotResult) super.clone();
