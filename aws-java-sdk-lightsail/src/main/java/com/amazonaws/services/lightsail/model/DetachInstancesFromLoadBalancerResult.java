...
public class DetachInstancesFromLoadBalancerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DetachInstancesFromLoadBalancerResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DetachInstancesFromLoadBalancerResult == false)
            return false;
        DetachInstancesFromLoadBalancerResult other = (DetachInstancesFromLoadBalancerResult) obj;
    ...
    @Override
    public DetachInstancesFromLoadBalancerResult clone() {
        try {
            return (DetachInstancesFromLoadBalancerResult) super.clone();
