...
/**
 * DeleteKnownHostKeysRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteKnownHostKeysRequestMarshaller {
    ...
    private static final DeleteKnownHostKeysRequestMarshaller instance = new DeleteKnownHostKeysRequestMarshaller();

    public static DeleteKnownHostKeysRequestMarshaller getInstance() {
        return instance;
    }
