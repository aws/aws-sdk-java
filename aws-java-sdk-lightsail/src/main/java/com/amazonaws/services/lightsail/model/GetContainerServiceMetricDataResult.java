...
public class GetContainerServiceMetricDataResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public GetContainerServiceMetricDataResult withMetricName(String metricName) {
    ...
    public GetContainerServiceMetricDataResult withMetricName(ContainerServiceMetricName metricName) {
    ...
    public GetContainerServiceMetricDataResult withMetricData(java.util.Collection<MetricDatapoint> metricData) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetContainerServiceMetricDataResult == false)
            return false;
        GetContainerServiceMetricDataResult other = (GetContainerServiceMetricDataResult) obj;
    ...
    @Override
    public GetContainerServiceMetricDataResult clone() {
        try {
            return (GetContainerServiceMetricDataResult) super.clone();
