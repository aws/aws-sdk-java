...
/**
 * GetLoadBalancersRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetLoadBalancersRequestMarshaller {
    ...
    private static final GetLoadBalancersRequestMarshaller instance = new GetLoadBalancersRequestMarshaller();

    public static GetLoadBalancersRequestMarshaller getInstance() {
        return instance;
    }
