...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/RebootInstance"/>AWS API Documentation</a>
 */
public class RebootInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public RebootInstanceResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RebootInstanceResult == false)
            return false;
        RebootInstanceResult other = (RebootInstanceResult) obj;
    ...
    @Override
    public RebootInstanceResult clone() {
        try {
            return (RebootInstanceResult) super.clone();
