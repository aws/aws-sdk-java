...
public class AttachCertificateToDistributionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttachCertificateToDistributionResult == false)
            return false;
        AttachCertificateToDistributionResult other = (AttachCertificateToDistributionResult) obj;
    ...
    public AttachCertificateToDistributionResult clone() {
        try {
            return (AttachCertificateToDistributionResult) super.clone();
