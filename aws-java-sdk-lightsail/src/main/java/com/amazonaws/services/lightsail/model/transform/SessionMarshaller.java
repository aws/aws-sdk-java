...
public class SessionMarshaller {
    ...
    public void marshall(Session session, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(session.getName(), NAME_BINDING);
            protocolMarshaller.marshall(session.getUrl(), URL_BINDING);
            protocolMarshaller.marshall(session.getIsPrimary(), ISPRIMARY_BINDING);
        } catch (Exception e) {
