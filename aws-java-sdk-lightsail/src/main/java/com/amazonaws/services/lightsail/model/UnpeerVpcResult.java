...
public class UnpeerVpcResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public UnpeerVpcResult clone() {
        try {
            return (UnpeerVpcResult) super.clone();
