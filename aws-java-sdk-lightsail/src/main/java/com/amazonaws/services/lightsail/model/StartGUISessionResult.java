...
public class StartGUISessionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartGUISessionResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartGUISessionResult == false)
            return false;
        StartGUISessionResult other = (StartGUISessionResult) obj;
    ...
    public StartGUISessionResult clone() {
        try {
            return (StartGUISessionResult) super.clone();
