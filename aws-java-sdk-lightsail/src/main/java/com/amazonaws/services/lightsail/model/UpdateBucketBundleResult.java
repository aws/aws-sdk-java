...
public class UpdateBucketBundleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateBucketBundleResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateBucketBundleResult == false)
            return false;
        UpdateBucketBundleResult other = (UpdateBucketBundleResult) obj;
    ...
    @Override
    public UpdateBucketBundleResult clone() {
        try {
            return (UpdateBucketBundleResult) super.clone();
