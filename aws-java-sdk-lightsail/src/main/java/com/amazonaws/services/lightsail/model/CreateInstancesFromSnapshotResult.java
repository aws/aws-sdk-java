...
public class CreateInstancesFromSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array of key-value pairs containing information about the results of your create instances from
     *         snapshot request.
     */
    ...
    public CreateInstancesFromSnapshotResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateInstancesFromSnapshotResult == false)
            return false;
        CreateInstancesFromSnapshotResult other = (CreateInstancesFromSnapshotResult) obj;
    ...
    @Override
    public CreateInstancesFromSnapshotResult clone() {
        try {
            return (CreateInstancesFromSnapshotResult) super.clone();
