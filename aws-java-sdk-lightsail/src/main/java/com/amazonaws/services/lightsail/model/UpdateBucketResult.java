...
public class UpdateBucketResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An object that describes the bucket that is updated.
     */
    ...
    public UpdateBucketResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateBucketResult == false)
            return false;
        UpdateBucketResult other = (UpdateBucketResult) obj;
    ...
    @Override
    public UpdateBucketResult clone() {
        try {
            return (UpdateBucketResult) super.clone();
