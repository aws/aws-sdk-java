...
/**
 * SetupInstanceHttpsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SetupInstanceHttpsRequestMarshaller {
    ...
    private static final SetupInstanceHttpsRequestMarshaller instance = new SetupInstanceHttpsRequestMarshaller();

    public static SetupInstanceHttpsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SetupInstanceHttpsRequest setupInstanceHttpsRequest, ProtocolMarshaller protocolMarshaller) {

        if (setupInstanceHttpsRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(setupInstanceHttpsRequest.getInstanceName(), INSTANCENAME_BINDING);
            protocolMarshaller.marshall(setupInstanceHttpsRequest.getEmailAddress(), EMAILADDRESS_BINDING);
            protocolMarshaller.marshall(setupInstanceHttpsRequest.getDomainNames(), DOMAINNAMES_BINDING);
            protocolMarshaller.marshall(setupInstanceHttpsRequest.getCertificateProvider(), CERTIFICATEPROVIDER_BINDING);
        } catch (Exception e) {
