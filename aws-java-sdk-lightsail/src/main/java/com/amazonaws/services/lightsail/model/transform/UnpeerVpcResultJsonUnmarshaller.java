...
/**
 * UnpeerVpcResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UnpeerVpcResultJsonUnmarshaller implements Unmarshaller<UnpeerVpcResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("operation", targetDepth)) {
                    context.nextToken();
                    unpeerVpcResult.setOperation(OperationJsonUnmarshaller.getInstance().unmarshall(context));
                }
