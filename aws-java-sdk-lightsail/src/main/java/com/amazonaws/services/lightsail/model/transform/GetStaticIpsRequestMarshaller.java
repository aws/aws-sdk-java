...
/**
 * GetStaticIpsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetStaticIpsRequestMarshaller {
    ...
    private static final GetStaticIpsRequestMarshaller instance = new GetStaticIpsRequestMarshaller();

    public static GetStaticIpsRequestMarshaller getInstance() {
        return instance;
    }
