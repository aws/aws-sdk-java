...
/**
 * GetBundlesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetBundlesRequestMarshaller {
    ...
    private static final GetBundlesRequestMarshaller instance = new GetBundlesRequestMarshaller();

    public static GetBundlesRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetBundlesRequest getBundlesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(getBundlesRequest.getAppCategory(), APPCATEGORY_BINDING);
        } catch (Exception e) {
