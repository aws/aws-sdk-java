...
public class CreateLoadBalancerTlsCertificateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateLoadBalancerTlsCertificateResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLoadBalancerTlsCertificateResult == false)
            return false;
        CreateLoadBalancerTlsCertificateResult other = (CreateLoadBalancerTlsCertificateResult) obj;
    ...
    @Override
    public CreateLoadBalancerTlsCertificateResult clone() {
        try {
