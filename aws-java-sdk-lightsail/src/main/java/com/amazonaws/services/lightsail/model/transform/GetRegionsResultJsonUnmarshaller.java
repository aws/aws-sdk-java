...
/**
 * GetRegionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetRegionsResultJsonUnmarshaller implements Unmarshaller<GetRegionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("regions", targetDepth)) {
                    context.nextToken();
                    getRegionsResult.setRegions(new ListUnmarshaller<Region>(RegionJsonUnmarshaller.getInstance()).unmarshall(context));
                }
