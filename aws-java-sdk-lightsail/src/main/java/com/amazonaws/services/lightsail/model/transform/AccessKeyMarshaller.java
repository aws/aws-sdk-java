...
@SdkInternalApi
public class AccessKeyMarshaller {
    ...
    public static AccessKeyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AccessKey accessKey, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(accessKey.getAccessKeyId(), ACCESSKEYID_BINDING);
