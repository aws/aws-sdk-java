...
public class StopGUISessionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The available API operations.
     */
    ...
    public StopGUISessionResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopGUISessionResult == false)
            return false;
        StopGUISessionResult other = (StopGUISessionResult) obj;
    ...
    @Override
    public StopGUISessionResult clone() {
        try {
            return (StopGUISessionResult) super.clone();
