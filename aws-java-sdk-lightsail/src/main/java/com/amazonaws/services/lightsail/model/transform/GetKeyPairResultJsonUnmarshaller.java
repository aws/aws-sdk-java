...
/**
 * GetKeyPairResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetKeyPairResultJsonUnmarshaller implements Unmarshaller<GetKeyPairResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("keyPair", targetDepth)) {
                    context.nextToken();
                    getKeyPairResult.setKeyPair(KeyPairJsonUnmarshaller.getInstance().unmarshall(context));
                }
