...
public class UpdateRelationalDatabaseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An object describing the result of your update relational database request.
     */
    ...
    public UpdateRelationalDatabaseResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateRelationalDatabaseResult == false)
            return false;
        UpdateRelationalDatabaseResult other = (UpdateRelationalDatabaseResult) obj;
    ...
    @Override
    public UpdateRelationalDatabaseResult clone() {
        try {
            return (UpdateRelationalDatabaseResult) super.clone();
