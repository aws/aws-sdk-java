...
public class GetContactMethodsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * {@link #setContactMethods(java.util.Collection)} or {@link #withContactMethods(java.util.Collection)} if you want
    ...
    public GetContactMethodsResult withContactMethods(ContactMethod... contactMethods) {
        if (this.contactMethods == null) {
            setContactMethods(new java.util.ArrayList<ContactMethod>(contactMethods.length));
        }
        for (ContactMethod ele : contactMethods) {
            this.contactMethods.add(ele);
        }
        return this;
    }
    ...
    public GetContactMethodsResult withContactMethods(java.util.Collection<ContactMethod> contactMethods) {
    ...
    public String toString() {
        ...
        if (getContactMethods() != null)
            sb.append("ContactMethods: ").append(getContactMethods());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getContactMethods() == null ^ this.getContactMethods() == null)
            return false;
        if (other.getContactMethods() != null && other.getContactMethods().equals(this.getContactMethods()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getContactMethods() == null) ? 0 : getContactMethods().hashCode());
        return hashCode;
    }
    ...
    public GetContactMethodsResult clone() {
        try {
            return (GetContactMethodsResult) super.clone();
