...
public class SetResourceAccessForBucketResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public SetResourceAccessForBucketResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetResourceAccessForBucketResult == false)
            return false;
        SetResourceAccessForBucketResult other = (SetResourceAccessForBucketResult) obj;
    ...
    @Override
    public SetResourceAccessForBucketResult clone() {
        try {
            return (SetResourceAccessForBucketResult) super.clone();
