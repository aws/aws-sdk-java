...
public class DisableAddOnResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DisableAddOnResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableAddOnResult == false)
            return false;
        DisableAddOnResult other = (DisableAddOnResult) obj;
    ...
    @Override
    public DisableAddOnResult clone() {
        try {
            return (DisableAddOnResult) super.clone();
