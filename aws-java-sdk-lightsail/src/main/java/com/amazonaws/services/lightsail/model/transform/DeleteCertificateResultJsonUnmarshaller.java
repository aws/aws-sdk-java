...
public class DeleteCertificateResultJsonUnmarshaller implements Unmarshaller<DeleteCertificateResult, JsonUnmarshallerContext> {
    ...
    public DeleteCertificateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("operations", targetDepth)) {
                    context.nextToken();
                    deleteCertificateResult.setOperations(new ListUnmarshaller<Operation>(OperationJsonUnmarshaller.getInstance())
