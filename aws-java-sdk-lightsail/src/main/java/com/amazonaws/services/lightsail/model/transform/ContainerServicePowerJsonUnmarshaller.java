...
/**
 * ContainerServicePower JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ContainerServicePowerJsonUnmarshaller implements Unmarshaller<ContainerServicePower, JsonUnmarshallerContext> {

    public ContainerServicePower unmarshall(JsonUnmarshallerContext context) throws Exception {
        ContainerServicePower containerServicePower = new ContainerServicePower();
    ...
    private static ContainerServicePowerJsonUnmarshaller instance;

    public static ContainerServicePowerJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ContainerServicePowerJsonUnmarshaller();
        return instance;
    }
}
