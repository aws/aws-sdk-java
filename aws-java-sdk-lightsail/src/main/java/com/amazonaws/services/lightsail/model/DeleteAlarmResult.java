...
public class DeleteAlarmResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteAlarmResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAlarmResult == false)
            return false;
        DeleteAlarmResult other = (DeleteAlarmResult) obj;
    ...
    @Override
    public DeleteAlarmResult clone() {
        try {
            return (DeleteAlarmResult) super.clone();
