...
public class GetStaticIpsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * To get a page token, perform an initial <code>GetStaticIps</code> request. If your results are paginated, the
     ...
     *        <p>
     *        To get a page token, perform an initial <code>GetStaticIps</code> request. If your results are paginated,
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetStaticIpsRequest == false)
            return false;
        GetStaticIpsRequest other = (GetStaticIpsRequest) obj;
