...
public class DetachCertificateFromDistributionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        The name of the distribution from which to detach the certificate.</p>
     *        <p>
     *        Use the <code>GetDistributions</code> action to get a list of distribution names that you can specify.
     */
     ...
     * </p>
     * 
     * @return The name of the distribution from which to detach the certificate.</p>
     *         <p>
     *         Use the <code>GetDistributions</code> action to get a list of distribution names that you can specify.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DetachCertificateFromDistributionRequest == false)
            return false;
        DetachCertificateFromDistributionRequest other = (DetachCertificateFromDistributionRequest) obj;
    ...
    @Override
    public DetachCertificateFromDistributionRequest clone() {
        return (DetachCertificateFromDistributionRequest) super.clone();
    }
