...
public class DetachCertificateFromDistributionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DetachCertificateFromDistributionResult == false)
            return false;
        DetachCertificateFromDistributionResult other = (DetachCertificateFromDistributionResult) obj;
    ...
    @Override
    public DetachCertificateFromDistributionResult clone() {
        try {
            return (DetachCertificateFromDistributionResult) super.clone();
