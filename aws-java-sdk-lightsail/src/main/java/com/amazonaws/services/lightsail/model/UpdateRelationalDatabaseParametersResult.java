...
public class UpdateRelationalDatabaseParametersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return An object describing the result of your update relational database parameters request.
     */
    ...
    public UpdateRelationalDatabaseParametersResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateRelationalDatabaseParametersResult == false)
            return false;
        UpdateRelationalDatabaseParametersResult other = (UpdateRelationalDatabaseParametersResult) obj;
    ...
    @Override
    public UpdateRelationalDatabaseParametersResult clone() {
        try {
            return (UpdateRelationalDatabaseParametersResult) super.clone();
