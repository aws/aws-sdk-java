...
public class DeleteBucketRequestMarshaller {
    ...
    private static final DeleteBucketRequestMarshaller instance = new DeleteBucketRequestMarshaller();

    public static DeleteBucketRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteBucketRequest deleteBucketRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteBucketRequest.getBucketName(), BUCKETNAME_BINDING);
            protocolMarshaller.marshall(deleteBucketRequest.getForceDelete(), FORCEDELETE_BINDING);
        } catch (Exception e) {
