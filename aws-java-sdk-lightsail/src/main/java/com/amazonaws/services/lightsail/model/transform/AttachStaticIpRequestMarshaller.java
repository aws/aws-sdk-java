 ...
 */
public class AttachStaticIpRequestMarshaller implements Marshaller<Request<AttachStaticIpRequest>, AttachStaticIpRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public AttachStaticIpRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<AttachStaticIpRequest> marshall(AttachStaticIpRequest attachStaticIpRequest) {
        ...
        Request<AttachStaticIpRequest> request = new DefaultRequest<AttachStaticIpRequest>(attachStaticIpRequest, "AmazonLightsail");
