...
public class AttachStaticIpRequestMarshaller {
    ...
    private static final AttachStaticIpRequestMarshaller instance = new AttachStaticIpRequestMarshaller();

    public static AttachStaticIpRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AttachStaticIpRequest attachStaticIpRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(attachStaticIpRequest.getStaticIpName(), STATICIPNAME_BINDING);
            protocolMarshaller.marshall(attachStaticIpRequest.getInstanceName(), INSTANCENAME_BINDING);
        } catch (Exception e) {
