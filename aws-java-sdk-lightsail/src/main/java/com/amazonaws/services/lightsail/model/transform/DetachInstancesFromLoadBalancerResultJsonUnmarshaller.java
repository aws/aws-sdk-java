...
/**
 * DetachInstancesFromLoadBalancerResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DetachInstancesFromLoadBalancerResultJsonUnmarshaller implements Unmarshaller<DetachInstancesFromLoadBalancerResult, JsonUnmarshallerContext> {

    public DetachInstancesFromLoadBalancerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
