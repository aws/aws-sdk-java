...
/**
 * DeleteDiskSnapshotRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteDiskSnapshotRequestMarshaller {
    ...
    private static final DeleteDiskSnapshotRequestMarshaller instance = new DeleteDiskSnapshotRequestMarshaller();

    public static DeleteDiskSnapshotRequestMarshaller getInstance() {
        return instance;
    }
