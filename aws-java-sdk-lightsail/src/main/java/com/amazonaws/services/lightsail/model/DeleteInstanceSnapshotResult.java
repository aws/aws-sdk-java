...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteInstanceSnapshot" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteInstanceSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array of key-value pairs containing information about the results of your delete instance snapshot
     *         request.
     */
    ...
    public DeleteInstanceSnapshotResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteInstanceSnapshotResult == false)
            return false;
        DeleteInstanceSnapshotResult other = (DeleteInstanceSnapshotResult) obj;
    ...
    public DeleteInstanceSnapshotResult clone() {
        try {
            return (DeleteInstanceSnapshotResult) super.clone();
