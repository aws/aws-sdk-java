...
/**
 * LightsailDistribution JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LightsailDistributionJsonUnmarshaller implements Unmarshaller<LightsailDistribution, JsonUnmarshallerContext> {

    public LightsailDistribution unmarshall(JsonUnmarshallerContext context) throws Exception {
        LightsailDistribution lightsailDistribution = new LightsailDistribution();
    ...
    private static LightsailDistributionJsonUnmarshaller instance;

    public static LightsailDistributionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LightsailDistributionJsonUnmarshaller();
        return instance;
    }
}
