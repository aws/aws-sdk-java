        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("continentCode", targetDepth)) {
                    context.nextToken();
                    region.setContinentCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("description", targetDepth)) {
                    context.nextToken();
                    region.setDescription(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("displayName", targetDepth)) {
                    context.nextToken();
                    region.setDisplayName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("availabilityZones", targetDepth)) {
                    context.nextToken();
                    region.setAvailabilityZones(new ListUnmarshaller<AvailabilityZone>(AvailabilityZoneJsonUnmarshaller.getInstance())
