...
public class EnableAddOnResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public EnableAddOnResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableAddOnResult == false)
            return false;
        EnableAddOnResult other = (EnableAddOnResult) obj;
    ...
    @Override
    public EnableAddOnResult clone() {
        try {
            return (EnableAddOnResult) super.clone();
