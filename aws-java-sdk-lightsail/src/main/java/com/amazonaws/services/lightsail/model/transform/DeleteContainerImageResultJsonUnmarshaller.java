...
/**
 * DeleteContainerImageResult JSON Unmarshaller
 */
...
public class DeleteContainerImageResultJsonUnmarshaller implements Unmarshaller<DeleteContainerImageResult, JsonUnmarshallerContext> {
    ...
    public DeleteContainerImageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteContainerImageResult deleteContainerImageResult = new DeleteContainerImageResult();
