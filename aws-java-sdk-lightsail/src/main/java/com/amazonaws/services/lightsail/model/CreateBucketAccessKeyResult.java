...
public class CreateBucketAccessKeyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An object that describes the access key that is created.
     */
    ...
    public CreateBucketAccessKeyResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBucketAccessKeyResult == false)
            return false;
        CreateBucketAccessKeyResult other = (CreateBucketAccessKeyResult) obj;
    ...
    @Override
    public CreateBucketAccessKeyResult clone() {
        try {
            return (CreateBucketAccessKeyResult) super.clone();
