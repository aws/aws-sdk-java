...
/**
 * Fluent builder for {@link com.amazonaws.services.codeartifact.AWSCodeArtifactAsync}. Use of the builder is preferred
...
public final class AWSCodeArtifactAsyncClientBuilder extends AwsAsyncClientBuilder<AWSCodeArtifactAsyncClientBuilder, AWSCodeArtifactAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSCodeArtifactAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSCodeArtifactAsync.
     */
    @Override
    protected AWSCodeArtifactAsync build(AwsAsyncClientParams params) {
        return new AWSCodeArtifactAsyncClient(params);
    }
