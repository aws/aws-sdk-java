...
public class DeletePackageGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeletePackageGroupResult == false)
            return false;
        DeletePackageGroupResult other = (DeletePackageGroupResult) obj;
    ...
    public DeletePackageGroupResult clone() {
        try {
            return (DeletePackageGroupResult) super.clone();
