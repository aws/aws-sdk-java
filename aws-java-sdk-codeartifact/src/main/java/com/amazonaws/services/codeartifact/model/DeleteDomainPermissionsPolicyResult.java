...
public class DeleteDomainPermissionsPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DeleteDomainPermissionsPolicyResult clone() {
        try {
            return (DeleteDomainPermissionsPolicyResult) super.clone();
