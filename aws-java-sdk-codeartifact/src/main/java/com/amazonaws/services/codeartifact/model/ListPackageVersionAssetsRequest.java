...
public class ListPackageVersionAssetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the repository that contains the package that contains the requested package version assets.
     */
     ...
     *        component that specifies its namespace depends on its type. For example:</p> <note>
     *        <p>
     *        The namespace is required requesting assets from package versions of the following formats:
     *        </p>
     *        <ul>
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPackageVersionAssetsRequest == false)
            return false;
    ...
    public ListPackageVersionAssetsRequest clone() {
        return (ListPackageVersionAssetsRequest) super.clone();
    }
