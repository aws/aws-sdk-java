...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/codeartifact-2018-09-22/DescribePackageGroup" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribePackageGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * A <a href="https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_PackageGroupDescription.html">
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribePackageGroupResult == false)
            return false;
        DescribePackageGroupResult other = (DescribePackageGroupResult) obj;
    ...
    @Override
    public DescribePackageGroupResult clone() {
        try {
            return (DescribePackageGroupResult) super.clone();
