...
public class PutRepositoryPermissionsPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutRepositoryPermissionsPolicyResult == false)
            return false;
        PutRepositoryPermissionsPolicyResult other = (PutRepositoryPermissionsPolicyResult) obj;
    ...
    public PutRepositoryPermissionsPolicyResult clone() {
        try {
            return (PutRepositoryPermissionsPolicyResult) super.clone();
