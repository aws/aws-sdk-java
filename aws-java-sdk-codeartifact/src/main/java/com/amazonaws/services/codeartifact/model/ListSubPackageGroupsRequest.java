...
public class ListSubPackageGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the domain which contains the package group from which to list sub package groups.
     */
     ...
     * </p>
     * 
     * @return The pattern of the package group from which to list sub package groups.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSubPackageGroupsRequest == false)
            return false;
        ListSubPackageGroupsRequest other = (ListSubPackageGroupsRequest) obj;
    ...
    public ListSubPackageGroupsRequest clone() {
        return (ListSubPackageGroupsRequest) super.clone();
    }
