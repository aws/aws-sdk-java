...
@SdkInternalApi
public class GetRepositoryEndpointRequestMarshaller {
    ...
    private static final GetRepositoryEndpointRequestMarshaller instance = new GetRepositoryEndpointRequestMarshaller();

    public static GetRepositoryEndpointRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetRepositoryEndpointRequest getRepositoryEndpointRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getRepositoryEndpointRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(getRepositoryEndpointRequest.getDomainOwner(), DOMAINOWNER_BINDING);
            protocolMarshaller.marshall(getRepositoryEndpointRequest.getRepository(), REPOSITORY_BINDING);
            protocolMarshaller.marshall(getRepositoryEndpointRequest.getFormat(), FORMAT_BINDING);
        } catch (Exception e) {
