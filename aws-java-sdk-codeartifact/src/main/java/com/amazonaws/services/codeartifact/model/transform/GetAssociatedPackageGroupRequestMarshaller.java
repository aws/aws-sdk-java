...
/**
 * GetAssociatedPackageGroupRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetAssociatedPackageGroupRequestMarshaller {
    ...
    private static final GetAssociatedPackageGroupRequestMarshaller instance = new GetAssociatedPackageGroupRequestMarshaller();

    public static GetAssociatedPackageGroupRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetAssociatedPackageGroupRequest getAssociatedPackageGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getAssociatedPackageGroupRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(getAssociatedPackageGroupRequest.getDomainOwner(), DOMAINOWNER_BINDING);
            protocolMarshaller.marshall(getAssociatedPackageGroupRequest.getFormat(), FORMAT_BINDING);
            protocolMarshaller.marshall(getAssociatedPackageGroupRequest.getNamespace(), NAMESPACE_BINDING);
            protocolMarshaller.marshall(getAssociatedPackageGroupRequest.getPackage(), PACKAGE_BINDING);
        } catch (Exception e) {
