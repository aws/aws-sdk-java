...
public class ListRepositoriesRequestMarshaller {
    ...
    public void marshall(ListRepositoriesRequest listRepositoriesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listRepositoriesRequest.getRepositoryPrefix(), REPOSITORYPREFIX_BINDING);
            protocolMarshaller.marshall(listRepositoriesRequest.getMaxResults(), MAXRESULTS_BINDING);
