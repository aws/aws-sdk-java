...
public class ListSubPackageGroupsRequestMarshaller {
    ...
    private static final ListSubPackageGroupsRequestMarshaller instance = new ListSubPackageGroupsRequestMarshaller();

    public static ListSubPackageGroupsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListSubPackageGroupsRequest listSubPackageGroupsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listSubPackageGroupsRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(listSubPackageGroupsRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(listSubPackageGroupsRequest.getDomainOwner(), DOMAINOWNER_BINDING);
            protocolMarshaller.marshall(listSubPackageGroupsRequest.getPackageGroup(), PACKAGEGROUP_BINDING);
            protocolMarshaller.marshall(listSubPackageGroupsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listSubPackageGroupsRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
