...
public class DeletePackageVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeletePackageVersionsResult withSuccessfulVersions(java.util.Map<String, SuccessfulPackageVersionInfo> successfulVersions) {
     ...
     *
     * @see DeletePackageVersionsResult#withSuccessfulVersions
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DeletePackageVersionsResult addSuccessfulVersionsEntry(String key, SuccessfulPackageVersionInfo value) {
    ...
    public DeletePackageVersionsResult clearSuccessfulVersionsEntries() {
     ...
     *        A <code>PackageVersionError</code> object that contains a map of errors codes for the deleted package that
     *        failed. The possible error codes are: </p>
     *        <ul>
     *        <li>
     *        <p>
     *        <code>ALREADY_EXISTS</code>
    ...
    public DeletePackageVersionsResult withFailedVersions(java.util.Map<String, PackageVersionError> failedVersions) {
     ...
     *
     * @see DeletePackageVersionsResult#withFailedVersions
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DeletePackageVersionsResult addFailedVersionsEntry(String key, PackageVersionError value) {
    ...
    public DeletePackageVersionsResult clearFailedVersionsEntries() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeletePackageVersionsResult == false)
            return false;
        DeletePackageVersionsResult other = (DeletePackageVersionsResult) obj;
    ...
    @Override
    public DeletePackageVersionsResult clone() {
        try {
            return (DeletePackageVersionsResult) super.clone();
