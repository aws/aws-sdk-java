...
public class AssetSummaryMarshaller {
    ...
    private static final MarshallingInfo<Map> HASHES_BINDING = MarshallingInfo.builder(MarshallingType.MAP).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("hashes").build();
    ...
    public void marshall(AssetSummary assetSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(assetSummary.getSize(), SIZE_BINDING);
            protocolMarshaller.marshall(assetSummary.getHashes(), HASHES_BINDING);
        } catch (Exception e) {
