...
public class DeleteRepositoryPermissionsPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRepositoryPermissionsPolicyResult == false)
            return false;
        DeleteRepositoryPermissionsPolicyResult other = (DeleteRepositoryPermissionsPolicyResult) obj;
    ...
    public DeleteRepositoryPermissionsPolicyResult clone() {
        try {
            return (DeleteRepositoryPermissionsPolicyResult) super.clone();
