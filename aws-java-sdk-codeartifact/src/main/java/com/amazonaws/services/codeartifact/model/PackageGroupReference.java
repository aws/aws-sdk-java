 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/codeartifact-2018-09-22/PackageGroupReference" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PackageGroupReference implements Serializable, Cloneable, StructuredPojo {
     ...
     * and is also the identifier of the package group.
     * </p>
     */
     ...
     *        group, and is also the identifier of the package group.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PackageGroupReference == false)
            return false;
        PackageGroupReference other = (PackageGroupReference) obj;
    ...
    public PackageGroupReference clone() {
        try {
            return (PackageGroupReference) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.codeartifact.model.transform.PackageGroupReferenceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
