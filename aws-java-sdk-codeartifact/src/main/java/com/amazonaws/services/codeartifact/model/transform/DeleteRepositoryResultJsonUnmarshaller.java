...
public class DeleteRepositoryResultJsonUnmarshaller implements Unmarshaller<DeleteRepositoryResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("repository", targetDepth)) {
                    context.nextToken();
                    deleteRepositoryResult.setRepository(RepositoryDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
