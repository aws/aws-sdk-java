...
public class AssociateExternalConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociateExternalConnectionResult clone() {
        try {
            return (AssociateExternalConnectionResult) super.clone();
