...
public class ListPackageGroupsRequestMarshaller {
    ...
    private static final ListPackageGroupsRequestMarshaller instance = new ListPackageGroupsRequestMarshaller();

    public static ListPackageGroupsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListPackageGroupsRequest listPackageGroupsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listPackageGroupsRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(listPackageGroupsRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(listPackageGroupsRequest.getDomainOwner(), DOMAINOWNER_BINDING);
            protocolMarshaller.marshall(listPackageGroupsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listPackageGroupsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listPackageGroupsRequest.getPrefix(), PREFIX_BINDING);
        } catch (Exception e) {
