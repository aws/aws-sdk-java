        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("resourceArn", targetDepth)) {
                    context.nextToken();
                    resourcePolicy.setResourceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("revision", targetDepth)) {
                    context.nextToken();
                    resourcePolicy.setRevision(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("document", targetDepth)) {
                    context.nextToken();
                    resourcePolicy.setDocument(context.getUnmarshaller(String.class).unmarshall(context));
                }
