...
public class DescribeSharedVpcConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeSharedVpcConfigurationResult == false)
            return false;
        DescribeSharedVpcConfigurationResult other = (DescribeSharedVpcConfigurationResult) obj;
    ...
    public DescribeSharedVpcConfigurationResult clone() {
        try {
            return (DescribeSharedVpcConfigurationResult) super.clone();
