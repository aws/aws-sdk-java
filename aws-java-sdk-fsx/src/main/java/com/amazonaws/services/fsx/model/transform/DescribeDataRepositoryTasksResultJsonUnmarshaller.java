...
/**
 * DescribeDataRepositoryTasksResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeDataRepositoryTasksResultJsonUnmarshaller implements Unmarshaller<DescribeDataRepositoryTasksResult, JsonUnmarshallerContext> {

    public DescribeDataRepositoryTasksResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeDataRepositoryTasksResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
