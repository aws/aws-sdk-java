...
public class DeleteSnapshotRequestMarshaller {
    ...
    public void marshall(DeleteSnapshotRequest deleteSnapshotRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteSnapshotRequest.getClientRequestToken(), CLIENTREQUESTTOKEN_BINDING);
            protocolMarshaller.marshall(deleteSnapshotRequest.getSnapshotId(), SNAPSHOTID_BINDING);
        } catch (Exception e) {
