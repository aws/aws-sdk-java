...
public class ResourceDoesNotSupportTaggingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.fsx.model.ResourceDoesNotSupportTaggingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceARN", targetDepth)) {
                    context.nextToken();
                    resourceDoesNotSupportTaggingException.setResourceARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return resourceDoesNotSupportTaggingException;
    }

    private static ResourceDoesNotSupportTaggingExceptionUnmarshaller instance;

    public static ResourceDoesNotSupportTaggingExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceDoesNotSupportTaggingExceptionUnmarshaller();
        return instance;
    }
}
