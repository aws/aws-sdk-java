...
/**
 * UpdateFileSystemOntapConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateFileSystemOntapConfigurationJsonUnmarshaller implements Unmarshaller<UpdateFileSystemOntapConfiguration, JsonUnmarshallerContext> {

    public UpdateFileSystemOntapConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateFileSystemOntapConfiguration updateFileSystemOntapConfiguration = new UpdateFileSystemOntapConfiguration();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AutomaticBackupRetentionDays", targetDepth)) {
                    context.nextToken();
                    updateFileSystemOntapConfiguration.setAutomaticBackupRetentionDays(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("DailyAutomaticBackupStartTime", targetDepth)) {
                    context.nextToken();
                    updateFileSystemOntapConfiguration.setDailyAutomaticBackupStartTime(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("FsxAdminPassword", targetDepth)) {
                    context.nextToken();
                    updateFileSystemOntapConfiguration.setFsxAdminPassword(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("ThroughputCapacityPerHAPair", targetDepth)) {
                    context.nextToken();
                    updateFileSystemOntapConfiguration.setThroughputCapacityPerHAPair(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
    ...
    private static UpdateFileSystemOntapConfigurationJsonUnmarshaller instance;

    public static UpdateFileSystemOntapConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateFileSystemOntapConfigurationJsonUnmarshaller();
        return instance;
    }
}
