...
/**
 * BackupFailureDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BackupFailureDetailsJsonUnmarshaller implements Unmarshaller<BackupFailureDetails, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    backupFailureDetails.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
