...
public class IncompatibleParameterErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.fsx.model.IncompatibleParameterErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Parameter", targetDepth)) {
                    context.nextToken();
                    incompatibleParameterErrorException.setParameter(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return incompatibleParameterErrorException;
    }

    private static IncompatibleParameterErrorExceptionUnmarshaller instance;

    public static IncompatibleParameterErrorExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IncompatibleParameterErrorExceptionUnmarshaller();
        return instance;
    }
}
