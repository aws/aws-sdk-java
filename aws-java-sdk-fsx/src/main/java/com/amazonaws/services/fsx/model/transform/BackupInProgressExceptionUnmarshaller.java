...
public class BackupInProgressExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.fsx.model.BackupInProgressException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return backupInProgressException;
    }

    private static BackupInProgressExceptionUnmarshaller instance;

    public static BackupInProgressExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BackupInProgressExceptionUnmarshaller();
        return instance;
    }
}
