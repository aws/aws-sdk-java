...
public class UpdateVolumeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateVolumeResult withVolume(Volume volume) {
        setVolume(volume);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateVolumeResult == false)
            return false;
        UpdateVolumeResult other = (UpdateVolumeResult) obj;
    ...
    public UpdateVolumeResult clone() {
        try {
            return (UpdateVolumeResult) super.clone();
