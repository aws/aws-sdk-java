...
/**
 * StorageVirtualMachineMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StorageVirtualMachineMarshaller {
    ...
    private static final StorageVirtualMachineMarshaller instance = new StorageVirtualMachineMarshaller();

    public static StorageVirtualMachineMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StorageVirtualMachine storageVirtualMachine, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(storageVirtualMachine.getActiveDirectoryConfiguration(), ACTIVEDIRECTORYCONFIGURATION_BINDING);
            protocolMarshaller.marshall(storageVirtualMachine.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(storageVirtualMachine.getEndpoints(), ENDPOINTS_BINDING);
            protocolMarshaller.marshall(storageVirtualMachine.getFileSystemId(), FILESYSTEMID_BINDING);
            protocolMarshaller.marshall(storageVirtualMachine.getLifecycle(), LIFECYCLE_BINDING);
            ...
            protocolMarshaller.marshall(storageVirtualMachine.getRootVolumeSecurityStyle(), ROOTVOLUMESECURITYSTYLE_BINDING);
        } catch (Exception e) {
