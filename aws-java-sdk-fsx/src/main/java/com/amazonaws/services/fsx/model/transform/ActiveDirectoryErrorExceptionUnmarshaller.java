...
public class ActiveDirectoryErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.fsx.model.ActiveDirectoryErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ActiveDirectoryId", targetDepth)) {
                    context.nextToken();
                    activeDirectoryErrorException.setActiveDirectoryId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    activeDirectoryErrorException.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return activeDirectoryErrorException;
    }

    private static ActiveDirectoryErrorExceptionUnmarshaller instance;

    public static ActiveDirectoryErrorExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ActiveDirectoryErrorExceptionUnmarshaller();
        return instance;
    }
}
