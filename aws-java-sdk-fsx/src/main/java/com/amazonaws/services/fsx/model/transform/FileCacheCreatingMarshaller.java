...
/**
 * FileCacheCreatingMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FileCacheCreatingMarshaller {
    ...
    private static final MarshallingInfo<Boolean> COPYTAGSTODATAREPOSITORYASSOCIATIONS_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CopyTagsToDataRepositoryAssociations").build();
    ...
    private static final FileCacheCreatingMarshaller instance = new FileCacheCreatingMarshaller();

    public static FileCacheCreatingMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FileCacheCreating fileCacheCreating, ProtocolMarshaller protocolMarshaller) {

        if (fileCacheCreating == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(fileCacheCreating.getOwnerId(), OWNERID_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getFileCacheId(), FILECACHEID_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getFileCacheType(), FILECACHETYPE_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getFileCacheTypeVersion(), FILECACHETYPEVERSION_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getLifecycle(), LIFECYCLE_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getFailureDetails(), FAILUREDETAILS_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getStorageCapacity(), STORAGECAPACITY_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getVpcId(), VPCID_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getSubnetIds(), SUBNETIDS_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getNetworkInterfaceIds(), NETWORKINTERFACEIDS_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getDNSName(), DNSNAME_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getKmsKeyId(), KMSKEYID_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getResourceARN(), RESOURCEARN_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getCopyTagsToDataRepositoryAssociations(), COPYTAGSTODATAREPOSITORYASSOCIATIONS_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getLustreConfiguration(), LUSTRECONFIGURATION_BINDING);
            protocolMarshaller.marshall(fileCacheCreating.getDataRepositoryAssociationIds(), DATAREPOSITORYASSOCIATIONIDS_BINDING);
        } catch (Exception e) {
