...
public class DescribeVolumesResultJsonUnmarshaller implements Unmarshaller<DescribeVolumesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Volumes", targetDepth)) {
                    context.nextToken();
                    describeVolumesResult.setVolumes(new ListUnmarshaller<Volume>(VolumeJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeVolumesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
