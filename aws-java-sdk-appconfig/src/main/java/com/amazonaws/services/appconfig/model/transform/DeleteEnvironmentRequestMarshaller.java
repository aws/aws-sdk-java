...
public class DeleteEnvironmentRequestMarshaller {
    ...
    public void marshall(DeleteEnvironmentRequest deleteEnvironmentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteEnvironmentRequest.getApplicationId(), APPLICATIONID_BINDING);
            protocolMarshaller.marshall(deleteEnvironmentRequest.getEnvironmentId(), ENVIRONMENTID_BINDING);
        } catch (Exception e) {
