...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appconfig-2019-10-09/Environment" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Environment implements Serializable, Cloneable, StructuredPojo {
    ...
    public Environment withMonitors(Monitor... monitors) {
    ...
    public Environment withMonitors(java.util.Collection<Monitor> monitors) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appconfig.model.transform.EnvironmentMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
