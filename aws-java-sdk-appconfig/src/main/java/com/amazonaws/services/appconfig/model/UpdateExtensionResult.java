...
public class UpdateExtensionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateExtensionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public UpdateExtensionResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public UpdateExtensionResult withVersionNumber(Integer versionNumber) {
    ...
    public UpdateExtensionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public UpdateExtensionResult withDescription(String description) {
    ...
    public UpdateExtensionResult withActions(java.util.Map<String, java.util.List<Action>> actions) {
        setActions(actions);
        return this;
    }
     ...
     *
     * @see UpdateExtensionResult#withActions
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateExtensionResult addActionsEntry(String key, java.util.List<Action> value) {
    ...
    public UpdateExtensionResult clearActionsEntries() {
        this.actions = null;
        return this;
    }
    ...
    public UpdateExtensionResult withParameters(java.util.Map<String, Parameter> parameters) {
     ...
     *
     * @see UpdateExtensionResult#withParameters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateExtensionResult addParametersEntry(String key, Parameter value) {
    ...
    public UpdateExtensionResult clearParametersEntries() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateExtensionResult == false)
            return false;
        UpdateExtensionResult other = (UpdateExtensionResult) obj;
    ...
    @Override
    public UpdateExtensionResult clone() {
        try {
            return (UpdateExtensionResult) super.clone();
