...
/**
 * DeleteExtensionResult JSON Unmarshaller
 */
...
public class DeleteExtensionResultJsonUnmarshaller implements Unmarshaller<DeleteExtensionResult, JsonUnmarshallerContext> {
    ...
    public DeleteExtensionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteExtensionResult deleteExtensionResult = new DeleteExtensionResult();

        return deleteExtensionResult;
    }
