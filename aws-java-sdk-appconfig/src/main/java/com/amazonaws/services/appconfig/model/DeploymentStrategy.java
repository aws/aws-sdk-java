...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appconfig-2019-10-09/DeploymentStrategy" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeploymentStrategy implements Serializable, Cloneable, StructuredPojo {
    ...
    public DeploymentStrategy withId(String id) {
        setId(id);
        return this;
    }
    ...
    public DeploymentStrategy withName(String name) {
        setName(name);
        return this;
    }
    ...
    public DeploymentStrategy withDescription(String description) {
    ...
    public DeploymentStrategy withDeploymentDurationInMinutes(Integer deploymentDurationInMinutes) {
    ...
    public DeploymentStrategy withGrowthType(String growthType) {
    ...
    public DeploymentStrategy withGrowthType(GrowthType growthType) {
    ...
    public DeploymentStrategy withGrowthFactor(Float growthFactor) {
    ...
    public DeploymentStrategy withFinalBakeTimeInMinutes(Integer finalBakeTimeInMinutes) {
    ...
    public DeploymentStrategy withReplicateTo(String replicateTo) {
    ...
    public DeploymentStrategy withReplicateTo(ReplicateTo replicateTo) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeploymentStrategy == false)
            return false;
    ...
    public DeploymentStrategy clone() {
        try {
            return (DeploymentStrategy) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appconfig.model.transform.DeploymentStrategyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
