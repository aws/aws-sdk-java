...
public class CreateExtensionAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateExtensionAssociationResult withParameters(java.util.Map<String, String> parameters) {
     ...
     *
     * @see CreateExtensionAssociationResult#withParameters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateExtensionAssociationResult addParametersEntry(String key, String value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateExtensionAssociationResult == false)
            return false;
        CreateExtensionAssociationResult other = (CreateExtensionAssociationResult) obj;
    ...
    public CreateExtensionAssociationResult clone() {
        try {
            return (CreateExtensionAssociationResult) super.clone();
