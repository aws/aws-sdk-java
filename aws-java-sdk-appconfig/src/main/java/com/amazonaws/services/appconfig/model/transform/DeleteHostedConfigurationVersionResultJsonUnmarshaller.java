...
/**
 * DeleteHostedConfigurationVersionResult JSON Unmarshaller
 */
...
public class DeleteHostedConfigurationVersionResultJsonUnmarshaller implements Unmarshaller<DeleteHostedConfigurationVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteHostedConfigurationVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteHostedConfigurationVersionResult deleteHostedConfigurationVersionResult = new DeleteHostedConfigurationVersionResult();

        return deleteHostedConfigurationVersionResult;
    }
