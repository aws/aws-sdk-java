...
public class ActionMarshaller {
    ...
    public void marshall(Action action, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(action.getName(), NAME_BINDING);
            protocolMarshaller.marshall(action.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(action.getUri(), URI_BINDING);
            protocolMarshaller.marshall(action.getRoleArn(), ROLEARN_BINDING);
        } catch (Exception e) {
