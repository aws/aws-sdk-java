...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appconfig-2019-10-09/GetExtensionAssociation" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetExtensionAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetExtensionAssociationResult withParameters(java.util.Map<String, String> parameters) {
     ...
     *
     * @see GetExtensionAssociationResult#withParameters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetExtensionAssociationResult addParametersEntry(String key, String value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetExtensionAssociationResult == false)
            return false;
        GetExtensionAssociationResult other = (GetExtensionAssociationResult) obj;
