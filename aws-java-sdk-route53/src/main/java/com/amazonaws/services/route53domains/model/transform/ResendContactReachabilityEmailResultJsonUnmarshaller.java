 ...
 */
public class ResendContactReachabilityEmailResultJsonUnmarshaller
        implements
        Unmarshaller<ResendContactReachabilityEmailResult, JsonUnmarshallerContext> {

    public ResendContactReachabilityEmailResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("domainName", targetDepth)) {
                    context.nextToken();
                    resendContactReachabilityEmailResult.setDomainName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("emailAddress", targetDepth)) {
                    context.nextToken();
                    resendContactReachabilityEmailResult
                            .setEmailAddress(context.getUnmarshaller(
                                    String.class).unmarshall(context));
                }
                if (context.testExpression("isAlreadyVerified", targetDepth)) {
                    context.nextToken();
                    resendContactReachabilityEmailResult
                            .setIsAlreadyVerified(context.getUnmarshaller(
