 ...
 */
public class RenewDomainResultJsonUnmarshaller implements
        Unmarshaller<RenewDomainResult, JsonUnmarshallerContext> {

    public RenewDomainResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("OperationId", targetDepth)) {
                    context.nextToken();
                    renewDomainResult.setOperationId(context.getUnmarshaller(
