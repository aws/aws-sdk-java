...
public class UpdateDomainContactPrivacyRequestMarshaller implements Marshaller<Request<UpdateDomainContactPrivacyRequest>, UpdateDomainContactPrivacyRequest> {
    ...
    public Request<UpdateDomainContactPrivacyRequest> marshall(UpdateDomainContactPrivacyRequest updateDomainContactPrivacyRequest) {
        ...
        Request<UpdateDomainContactPrivacyRequest> request = new DefaultRequest<UpdateDomainContactPrivacyRequest>(updateDomainContactPrivacyRequest,
                "AmazonRoute53Domains");
        request.addHeader("X-Amz-Target", "Route53Domains_v20140515.UpdateDomainContactPrivacy");
        ...
        try {
            ...
            if (updateDomainContactPrivacyRequest.getDomainName() != null) {
                jsonGenerator.writeFieldName("DomainName").writeValue(updateDomainContactPrivacyRequest.getDomainName());
            }
            if (updateDomainContactPrivacyRequest.getAdminPrivacy() != null) {
                jsonGenerator.writeFieldName("AdminPrivacy").writeValue(updateDomainContactPrivacyRequest.getAdminPrivacy());
            }
            if (updateDomainContactPrivacyRequest.getRegistrantPrivacy() != null) {
                jsonGenerator.writeFieldName("RegistrantPrivacy").writeValue(updateDomainContactPrivacyRequest.getRegistrantPrivacy());
            }
            if (updateDomainContactPrivacyRequest.getTechPrivacy() != null) {
                jsonGenerator.writeFieldName("TechPrivacy").writeValue(updateDomainContactPrivacyRequest.getTechPrivacy());
            }
