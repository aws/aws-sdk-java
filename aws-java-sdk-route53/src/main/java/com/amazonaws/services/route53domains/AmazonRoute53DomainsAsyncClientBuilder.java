...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.route53domains.AmazonRoute53DomainsAsync}. Use
 * of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonRoute53DomainsAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonRoute53DomainsAsyncClientBuilder, AmazonRoute53DomainsAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonRoute53DomainsAsync
