...
public class OperationLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.route53domains.model.OperationLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return operationLimitExceededException;
    }

    private static OperationLimitExceededExceptionUnmarshaller instance;

    public static OperationLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OperationLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
