...
public class DeleteTagsForDomainRequest extends AmazonWebServiceRequest
    ...
    public void setTagsToDelete(java.util.Collection<String> tagsToDelete) {
        ...
        this.tagsToDelete = new com.amazonaws.internal.SdkInternalList<String>(
                tagsToDelete);
    }
     ...
     * {@link #withTagsToDelete(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param tagsToDelete
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getTagsToDelete() == null) ? 0 : getTagsToDelete()
                        .hashCode());
        return hashCode;
    }
