...
public class ConsentMarshaller {
    ...
    private static final MarshallingInfo<Double> MAXPRICE_BINDING = MarshallingInfo.builder(MarshallingType.DOUBLE).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(Consent consent, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(consent.getMaxPrice(), MAXPRICE_BINDING);
            protocolMarshaller.marshall(consent.getCurrency(), CURRENCY_BINDING);
        } catch (Exception e) {
