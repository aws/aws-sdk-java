 ...
 */
public class RenewDomainRequestMarshaller implements
        Marshaller<Request<RenewDomainRequest>, RenewDomainRequest> {
    ...
    public Request<RenewDomainRequest> marshall(
        ...
        Request<RenewDomainRequest> request = new DefaultRequest<RenewDomainRequest>(
                renewDomainRequest, "AmazonRoute53Domains");
        ...
        try {
            ...
            if (renewDomainRequest.getDomainName() != null) {
                jsonGenerator.writeFieldName("DomainName").writeValue(
                        renewDomainRequest.getDomainName());
            }
            if (renewDomainRequest.getDurationInYears() != null) {
                jsonGenerator.writeFieldName("DurationInYears").writeValue(
                        renewDomainRequest.getDurationInYears());
            }
            if (renewDomainRequest.getCurrentExpiryYear() != null) {
                jsonGenerator.writeFieldName("CurrentExpiryYear").writeValue(
                        renewDomainRequest.getCurrentExpiryYear());
            }
