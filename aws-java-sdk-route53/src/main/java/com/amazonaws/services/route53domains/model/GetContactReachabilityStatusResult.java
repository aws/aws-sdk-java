 ...
 * 
 */
public class GetContactReachabilityStatusResult extends
    ...
    /**
     * <p>
     * Whether the registrant contact has responded. <code>PENDING</code>
     * indicates that we sent the confirmation email and haven't received a
     * response yet, <code>DONE</code> indicates that we sent the email and got
     * confirmation from the registrant contact, and <code>EXPIRED</code>
     ...
     * </p>
     * <p>
     * Valid values: <code>PENDING</code>, <code>DONE</code>,
     * <code>EXPIRED</code>
     * </p>
     */
     ...
     *        a response yet, <code>DONE</code> indicates that we sent the email
     *        and got confirmation from the registrant contact, and
     *        <code>EXPIRED</code> indicates that the time limit expired before
     *        the registrant contact responded. </p>
     *        <p>
     *        Type: String
     *        </p>
     *        <p>
     ...
     * </p>
     * 
     * @return Whether the registrant contact has responded.
     *         <code>PENDING</code> indicates that we sent the confirmation
     *         email and haven't received a response yet, <code>DONE</code>
     *         indicates that we sent the email and got confirmation from the
     *         registrant contact, and <code>EXPIRED</code> indicates that the
     *         time limit expired before the registrant contact responded. </p>
     *         <p>
     *         Type: String
     *         </p>
     *         <p>
    ...
    public GetContactReachabilityStatusResult withStatus(
