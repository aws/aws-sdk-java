 ...
 */
public class ListTagsForDomainResultJsonUnmarshaller implements
        Unmarshaller<ListTagsForDomainResult, JsonUnmarshallerContext> {

    public ListTagsForDomainResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
