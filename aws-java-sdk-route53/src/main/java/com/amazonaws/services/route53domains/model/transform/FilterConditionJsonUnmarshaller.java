        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    filterCondition.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Operator", targetDepth)) {
                    context.nextToken();
                    filterCondition.setOperator(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Values", targetDepth)) {
                    context.nextToken();
                    filterCondition.setValues(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
