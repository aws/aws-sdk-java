...
public class GetDomainSuggestionsRequestMarshaller
    ...
    public GetDomainSuggestionsRequestMarshaller(
        ...
        try {
            ...
            if (getDomainSuggestionsRequest.getDomainName() != null) {
                jsonGenerator.writeFieldName("DomainName").writeValue(
                        getDomainSuggestionsRequest.getDomainName());
            }
            if (getDomainSuggestionsRequest.getSuggestionCount() != null) {
                jsonGenerator.writeFieldName("SuggestionCount").writeValue(
                        getDomainSuggestionsRequest.getSuggestionCount());
            }
            if (getDomainSuggestionsRequest.getOnlyAvailable() != null) {
                jsonGenerator.writeFieldName("OnlyAvailable").writeValue(
                        getDomainSuggestionsRequest.getOnlyAvailable());
            }
