 ...
 */
public class RetrieveDomainAuthCodeResultJsonUnmarshaller implements
        Unmarshaller<RetrieveDomainAuthCodeResult, JsonUnmarshallerContext> {

    public RetrieveDomainAuthCodeResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AuthCode", targetDepth)) {
                    context.nextToken();
                    retrieveDomainAuthCodeResult.setAuthCode(context
