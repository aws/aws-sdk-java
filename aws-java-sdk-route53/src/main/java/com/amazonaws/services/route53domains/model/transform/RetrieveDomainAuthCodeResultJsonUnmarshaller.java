...
/**
 * Retrieve Domain Auth Code Result JSON Unmarshaller
 */
public class RetrieveDomainAuthCodeResultJsonUnmarshaller implements Unmarshaller<RetrieveDomainAuthCodeResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AuthCode", targetDepth)) {
                    context.nextToken();
                    retrieveDomainAuthCodeResult.setAuthCode(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static RetrieveDomainAuthCodeResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RetrieveDomainAuthCodeResultJsonUnmarshaller();
        return instance;
    }
}
