...
public class RetrieveDomainAuthCodeResultJsonUnmarshaller implements Unmarshaller<RetrieveDomainAuthCodeResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AuthCode", targetDepth)) {
                    context.nextToken();
                    retrieveDomainAuthCodeResult.setAuthCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static RetrieveDomainAuthCodeResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RetrieveDomainAuthCodeResultJsonUnmarshaller();
        return instance;
    }
}
