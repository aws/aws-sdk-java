...
public class BillingRecordJsonMarshaller {
     ...
     */
    public void marshall(BillingRecord billingRecord,
        ...
        try {
            ...
            if (billingRecord.getDomainName() != null) {
                jsonGenerator.writeFieldName("DomainName").writeValue(
                        billingRecord.getDomainName());
            }
            if (billingRecord.getOperation() != null) {
                jsonGenerator.writeFieldName("Operation").writeValue(
                        billingRecord.getOperation());
            }
            if (billingRecord.getInvoiceId() != null) {
                jsonGenerator.writeFieldName("InvoiceId").writeValue(
                        billingRecord.getInvoiceId());
            }
            if (billingRecord.getBillDate() != null) {
                jsonGenerator.writeFieldName("BillDate").writeValue(
                        billingRecord.getBillDate());
            }
            if (billingRecord.getPrice() != null) {
                jsonGenerator.writeFieldName("Price").writeValue(
                        billingRecord.getPrice());
            }
