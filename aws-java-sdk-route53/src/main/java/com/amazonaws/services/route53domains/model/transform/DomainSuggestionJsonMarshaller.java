...
public class DomainSuggestionJsonMarshaller {
     ...
     */
    public void marshall(DomainSuggestion domainSuggestion,
        ...
        try {
            ...
            if (domainSuggestion.getDomainName() != null) {
                jsonGenerator.writeFieldName("DomainName").writeValue(
                        domainSuggestion.getDomainName());
            }
            if (domainSuggestion.getAvailability() != null) {
                jsonGenerator.writeFieldName("Availability").writeValue(
                        domainSuggestion.getAvailability());
            }
