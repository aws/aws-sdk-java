...
public class DomainLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DomainLimitExceededExceptionUnmarshaller instance;

    public static DomainLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DomainLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
