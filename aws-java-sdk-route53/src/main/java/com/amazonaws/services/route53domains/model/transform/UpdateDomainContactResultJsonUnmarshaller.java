 ...
 */
public class UpdateDomainContactResultJsonUnmarshaller implements
        Unmarshaller<UpdateDomainContactResult, JsonUnmarshallerContext> {

    public UpdateDomainContactResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("OperationId", targetDepth)) {
                    context.nextToken();
                    updateDomainContactResult.setOperationId(context
