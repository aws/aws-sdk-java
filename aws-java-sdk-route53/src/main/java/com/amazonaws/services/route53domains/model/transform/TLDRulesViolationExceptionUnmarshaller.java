...
public class TLDRulesViolationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TLDRulesViolationExceptionUnmarshaller instance;

    public static TLDRulesViolationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TLDRulesViolationExceptionUnmarshaller();
        return instance;
    }
}
