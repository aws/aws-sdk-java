...
/**
 * ResendOperationAuthorizationResult JSON Unmarshaller
 */
...
public class ResendOperationAuthorizationResultJsonUnmarshaller implements Unmarshaller<ResendOperationAuthorizationResult, JsonUnmarshallerContext> {
    ...
    public ResendOperationAuthorizationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResendOperationAuthorizationResult resendOperationAuthorizationResult = new ResendOperationAuthorizationResult();

        return resendOperationAuthorizationResult;
    }
