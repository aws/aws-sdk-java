...
public class ViewBillingRequest extends com.amazonaws.AmazonWebServiceRequest
     ...
     * 
     * @param start
     *        The beginning date and time for the time period for which you want
     *        a list of billing records. Specify the date in Unix time
     *        format.</p>
     *        <p>
     *        Type: Double
     *        </p>
     ...
     * </p>
     * 
     * @return The beginning date and time for the time period for which you
     *         want a list of billing records. Specify the date in Unix time
     *         format.</p>
     *         <p>
     *         Type: Double
     *         </p>
     ...
     *        list of billing records. Specify the date in Unix time format.</p>
     *        <p>
     *        Type: Double
     *        </p>
     *        <p>
     ...
     * </p>
     * 
     * @return The end date and time for the time period for which you want a
     *         list of billing records. Specify the date in Unix time
     *         format.</p>
     *         <p>
     *         Type: Double
     *         </p>
     ...
     *        the current AWS account during the specified period is greater
     *        than the value that you specified for <code>MaxItems</code>, you
     *        can use <code>Marker</code> to return additional billing records.
     *        Get the value of <code>NextPageMarker</code> from the previous
     ...
     * </p>
     * 
     * @return For an initial request for a list of billing records, omit this
