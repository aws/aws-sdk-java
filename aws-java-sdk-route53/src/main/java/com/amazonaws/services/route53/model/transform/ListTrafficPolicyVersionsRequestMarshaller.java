...
/**
 * List Traffic Policy Versions Request Marshaller
 */
public class ListTrafficPolicyVersionsRequestMarshaller implements Marshaller<Request<ListTrafficPolicyVersionsRequest>, ListTrafficPolicyVersionsRequest> {
    ...
    public Request<ListTrafficPolicyVersionsRequest> marshall(ListTrafficPolicyVersionsRequest listTrafficPolicyVersionsRequest) {
        ...
        Request<ListTrafficPolicyVersionsRequest> request = new DefaultRequest<ListTrafficPolicyVersionsRequest>(listTrafficPolicyVersionsRequest, "AmazonRoute53");
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("Id")) {
            ...
            String value = (listTrafficPolicyVersionsRequest.getId() == null) ? null : StringUtils.fromString(listTrafficPolicyVersionsRequest.getId());
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("TrafficPolicyVersionMarker")) {
            String name = DYNAMIC_QUERY_PARAMS.get("TrafficPolicyVersionMarker");
            String value = (listTrafficPolicyVersionsRequest.getTrafficPolicyVersionMarker() == null) ? null : StringUtils.fromString(listTrafficPolicyVersionsRequest.getTrafficPolicyVersionMarker());
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("MaxItems")) {
            ...
            String value = (listTrafficPolicyVersionsRequest.getMaxItems() == null) ? null : StringUtils.fromString(listTrafficPolicyVersionsRequest.getMaxItems());
