...
public class CreateHealthCheckRequestMarshaller implements
    ...
    public Request<CreateHealthCheckRequest> marshall(
        ...
        Request<CreateHealthCheckRequest> request = new DefaultRequest<CreateHealthCheckRequest>(
            ...
            if (createHealthCheckRequest != null) {
                ...
                if (createHealthCheckRequest.getCallerReference() != null) {
                    xmlWriter
                            ...
                            .value(createHealthCheckRequest
                ...
                if (healthCheckConfig != null) {
                    ...
                    if (healthCheckConfig.getPort() != null) {
                        xmlWriter.startElement("Port")
                                .value(healthCheckConfig.getPort())
                                .endElement();
                    }

                    if (healthCheckConfig.getType() != null) {
                        xmlWriter.startElement("Type")
                                .value(healthCheckConfig.getType())
                                .endElement();
                    }
                    ...
                    if (healthCheckConfig.getInverted() != null) {
                        xmlWriter.startElement("Inverted")
                                .value(healthCheckConfig.getInverted())
                                .endElement();
                    }

                    if (healthCheckConfig.getHealthThreshold() != null) {
                        xmlWriter.startElement("HealthThreshold")
                    ...
                    if (!healthCheckConfigChildHealthChecksList.isEmpty()
                        ...
                        for (String healthCheckConfigChildHealthChecksListValue : healthCheckConfigChildHealthChecksList) {
                            ...
                            xmlWriter
                                    .value(healthCheckConfigChildHealthChecksListValue);
