...
/**
 * Traffic Policy Summary StAX Unmarshaller
 */
public class TrafficPolicySummaryStaxUnmarshaller implements Unmarshaller<TrafficPolicySummary, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("LatestVersion", targetDepth)) {
                    trafficPolicySummary.setLatestVersion(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("TrafficPolicyCount", targetDepth)) {
                    trafficPolicySummary.setTrafficPolicyCount(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static TrafficPolicySummaryStaxUnmarshaller getInstance() {
        if (instance == null) instance = new TrafficPolicySummaryStaxUnmarshaller();
        return instance;
    }
}
