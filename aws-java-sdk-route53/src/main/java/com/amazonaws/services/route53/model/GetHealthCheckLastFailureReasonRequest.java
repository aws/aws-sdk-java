 ...
 * the most recent failure. Send a <code>GET</code> request to the
...
public class GetHealthCheckLastFailureReasonRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Length: </b>0 - 64<br/>
     *
     * @return The ID of the health check for which you want to retrieve the reason
     *         for the most recent failure.
     */
     ...
     * <b>Length: </b>0 - 64<br/>
     *
     * @param healthCheckId The ID of the health check for which you want to retrieve the reason
     *         for the most recent failure.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetHealthCheckLastFailureReasonRequest == false) return false;
