 ...
 * </p>
 */
public class ListTrafficPolicyVersionsRequest extends AmazonWebServiceRequest
    ...
    /**
     * <p>
     * For your first request to <code>ListTrafficPolicyVersions</code>, do not
     ...
     * only the first group of <code>MaxItems</code> versions. To get the next
     * group of <code>MaxItems</code> traffic policy versions, submit another
     * request to <code>ListTrafficPolicyVersions</code>. For the value of
     ...
     * the <code>IsTruncated</code> element in the response is <code>true</code>
     * , and the value of the <code>TrafficPolicyVersionMarker</code> element is
     * the ID of the first version in the next group of <code>MaxItems</code>
     ...
     *        do not include the <code>TrafficPolicyVersionMarker</code>
     *        parameter.</p>
     *        <p>
     *        If you have more traffic policy versions than the value of
     *        <code>MaxItems</code>, <code>ListTrafficPolicyVersions</code>
     *        returns only the first group of <code>MaxItems</code> versions. To
     *        get the next group of <code>MaxItems</code> traffic policy
     *        versions, submit another request to
     *        <code>ListTrafficPolicyVersions</code>. For the value of
     *        <code>TrafficPolicyVersionMarker</code>, specify the value of the
     *        <code>TrafficPolicyVersionMarker</code> element that was returned
     ...
     * </p>
     * 
     * @return For your first request to <code>ListTrafficPolicyVersions</code>,
     *         do not include the <code>TrafficPolicyVersionMarker</code>
     *         parameter.</p>
     *         <p>
     *         If you have more traffic policy versions than the value of
     ...
     *         To get the next group of <code>MaxItems</code> traffic policy
     *         versions, submit another request to
     *         <code>ListTrafficPolicyVersions</code>. For the value of
     *         <code>TrafficPolicyVersionMarker</code>, specify the value of the
     *         <code>TrafficPolicyVersionMarker</code> element that was returned
     ...
     *        versions, the value of the <code>IsTruncated</code> element in the
     ...
     * </p>
     * 
     * @return The maximum number of traffic policy versions that you want
     *         Amazon Route 53 to include in the response body for this request.
     *         If the specified traffic policy has more than
     *         <code>MaxItems</code> versions, the value of the
