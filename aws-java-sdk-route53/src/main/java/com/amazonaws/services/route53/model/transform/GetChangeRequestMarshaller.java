...
public class GetChangeRequestMarshaller implements Marshaller<Request<GetChangeRequest>, GetChangeRequest> {
    ...
    static {
        String path = "/2013-04-01/change/{Id}";
    ...
    public Request<GetChangeRequest> marshall(GetChangeRequest getChangeRequest) {
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("Id")) {
            ...
            String value = (getChangeRequest.getId() == null) ? null : StringUtils.fromString(getChangeRequest.getId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{Id}", (getChangeRequest.getId() == null) ? "" : StringUtils.fromString(getChangeRequest.getId())); 
        }
