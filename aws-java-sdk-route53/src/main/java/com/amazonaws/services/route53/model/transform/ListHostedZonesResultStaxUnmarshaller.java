 ...
 */
public class ListHostedZonesResultStaxUnmarshaller implements
        Unmarshaller<ListHostedZonesResult, StaxUnmarshallerContext> {

    public ListHostedZonesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("HostedZones/HostedZone",
                        targetDepth)) {
                    listHostedZonesResult.getHostedZones().add(
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    listHostedZonesResult.setMarker(StringStaxUnmarshaller
                ...
                if (context.testExpression("NextMarker", targetDepth)) {
                    listHostedZonesResult.setNextMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("MaxItems", targetDepth)) {
                    listHostedZonesResult.setMaxItems(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
