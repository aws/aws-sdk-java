 ...
 */
public class GetHealthCheckStatusResultStaxUnmarshaller implements
        Unmarshaller<GetHealthCheckStatusResult, StaxUnmarshallerContext> {

    public GetHealthCheckStatusResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
