 ...
 * </p>
 */
public class ListTrafficPolicyInstancesByHostedZoneResult implements Serializable, Cloneable {
     ...
     * in the call to <code>ListTrafficPolicyInstancesByHostedZone</code>
     ...
     * <b>Allowed Values: </b>SOA, A, TXT, NS, CNAME, MX, PTR, SRV, SPF, AAAA
     *
     * @param trafficPolicyInstanceTypeMarker If <code>IsTruncated</code> is true,
     *         <code>TrafficPolicyInstanceTypeMarker</code> is the DNS type of the
     *         resource record sets that are associated with the first traffic policy
     *         instance in the next group of <code>MaxItems</code> traffic policy
     *         instances.
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTrafficPolicyInstancesByHostedZoneResult == false) return false;
