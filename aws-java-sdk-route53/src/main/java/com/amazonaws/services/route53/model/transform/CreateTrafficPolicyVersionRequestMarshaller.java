...
/**
 * Create Traffic Policy Version Request Marshaller
 */
public class CreateTrafficPolicyVersionRequestMarshaller implements Marshaller<Request<CreateTrafficPolicyVersionRequest>, CreateTrafficPolicyVersionRequest> {
    ...
    static {
        String path = "/2013-04-01/trafficpolicy/{Id}";
    ...
    public Request<CreateTrafficPolicyVersionRequest> marshall(CreateTrafficPolicyVersionRequest createTrafficPolicyVersionRequest) {
        ...
        Request<CreateTrafficPolicyVersionRequest> request = new DefaultRequest<CreateTrafficPolicyVersionRequest>(createTrafficPolicyVersionRequest, "AmazonRoute53");
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("Id")) {
            ...
            String value = (createTrafficPolicyVersionRequest.getId() == null) ? null : StringUtils.fromString(createTrafficPolicyVersionRequest.getId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{Id}", (createTrafficPolicyVersionRequest.getId() == null) ? "" : StringUtils.fromString(createTrafficPolicyVersionRequest.getId())); 
        }
