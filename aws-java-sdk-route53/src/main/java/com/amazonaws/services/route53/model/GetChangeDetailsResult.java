...
public class GetChangeDetailsResult implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getChangeBatchRecord() == null
                ^ this.getChangeBatchRecord() == null)
            return false;
        if (other.getChangeBatchRecord() != null
                && other.getChangeBatchRecord().equals(
                        this.getChangeBatchRecord()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getChangeBatchRecord() == null) ? 0
                        : getChangeBatchRecord().hashCode());
        return hashCode;
    }
