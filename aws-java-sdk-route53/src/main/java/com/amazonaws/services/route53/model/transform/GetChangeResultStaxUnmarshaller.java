...
public class GetChangeResultStaxUnmarshaller implements Unmarshaller<GetChangeResult, StaxUnmarshallerContext> {
    ...
    public GetChangeResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return getChangeResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("ChangeInfo", targetDepth)) {
                    getChangeResult.setChangeInfo(ChangeInfoStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static GetChangeResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GetChangeResultStaxUnmarshaller();
        return instance;
    }
}
