...
/**
 * GetChangeResult StAX Unmarshaller
 */
public class GetChangeResultStaxUnmarshaller implements
        Unmarshaller<GetChangeResult, StaxUnmarshallerContext> {

    public GetChangeResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ChangeInfo", targetDepth)) {
                    getChangeResult.setChangeInfo(ChangeInfoStaxUnmarshaller
