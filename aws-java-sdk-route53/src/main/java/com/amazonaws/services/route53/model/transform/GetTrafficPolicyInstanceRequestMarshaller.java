...
/**
 * Get Traffic Policy Instance Request Marshaller
 */
public class GetTrafficPolicyInstanceRequestMarshaller implements Marshaller<Request<GetTrafficPolicyInstanceRequest>, GetTrafficPolicyInstanceRequest> {
    ...
    static {
        String path = "/2013-04-01/trafficpolicyinstance/{Id}";
    ...
    public Request<GetTrafficPolicyInstanceRequest> marshall(GetTrafficPolicyInstanceRequest getTrafficPolicyInstanceRequest) {
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("Id")) {
            ...
            String value = (getTrafficPolicyInstanceRequest.getId() == null) ? null : StringUtils.fromString(getTrafficPolicyInstanceRequest.getId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{Id}", (getTrafficPolicyInstanceRequest.getId() == null) ? "" : StringUtils.fromString(getTrafficPolicyInstanceRequest.getId())); 
        }
