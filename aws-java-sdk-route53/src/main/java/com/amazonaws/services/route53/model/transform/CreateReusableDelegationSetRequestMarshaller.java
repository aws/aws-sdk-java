...
public class CreateReusableDelegationSetRequestMarshaller
        implements
        Marshaller<Request<CreateReusableDelegationSetRequest>, CreateReusableDelegationSetRequest> {

    public Request<CreateReusableDelegationSetRequest> marshall(
        ...
        Request<CreateReusableDelegationSetRequest> request = new DefaultRequest<CreateReusableDelegationSetRequest>(
                createReusableDelegationSetRequest, "AmazonRoute53");
            ...
            if (createReusableDelegationSetRequest != null) {
                ...
                if (createReusableDelegationSetRequest.getCallerReference() != null) {
                    xmlWriter
                            ...
                            .value(createReusableDelegationSetRequest
