...
public class GetGeoLocationRequestMarshaller implements Marshaller<Request<GetGeoLocationRequest>, GetGeoLocationRequest> {
    ...
    public Request<GetGeoLocationRequest> marshall(GetGeoLocationRequest getGeoLocationRequest) {
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("ContinentCode")) {
            String name = DYNAMIC_QUERY_PARAMS.get("ContinentCode");
            String value = (getGeoLocationRequest.getContinentCode() == null) ? null : StringUtils.fromString(getGeoLocationRequest.getContinentCode());
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("CountryCode")) {
            String name = DYNAMIC_QUERY_PARAMS.get("CountryCode");
            String value = (getGeoLocationRequest.getCountryCode() == null) ? null : StringUtils.fromString(getGeoLocationRequest.getCountryCode());
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("SubdivisionCode")) {
            String name = DYNAMIC_QUERY_PARAMS.get("SubdivisionCode");
            String value = (getGeoLocationRequest.getSubdivisionCode() == null) ? null : StringUtils.fromString(getGeoLocationRequest.getSubdivisionCode());
