 ...
 */
public class GetChangeDetailsResultStaxUnmarshaller implements
        Unmarshaller<GetChangeDetailsResult, StaxUnmarshallerContext> {

    public GetChangeDetailsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ChangeBatchRecord", targetDepth)) {
                    getChangeDetailsResult
                            .setChangeBatchRecord(ChangeBatchRecordStaxUnmarshaller
