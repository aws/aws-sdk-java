...
/**
 * Get Reusable Delegation Set Request Marshaller
 */
public class GetReusableDelegationSetRequestMarshaller implements Marshaller<Request<GetReusableDelegationSetRequest>, GetReusableDelegationSetRequest> {
    ...
    static {
        String path = "/2013-04-01/delegationset/{Id}";
    ...
    public Request<GetReusableDelegationSetRequest> marshall(GetReusableDelegationSetRequest getReusableDelegationSetRequest) {
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("Id")) {
            ...
            String value = (getReusableDelegationSetRequest.getId() == null) ? null : StringUtils.fromString(getReusableDelegationSetRequest.getId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{Id}", (getReusableDelegationSetRequest.getId() == null) ? "" : StringUtils.fromString(getReusableDelegationSetRequest.getId())); 
        }
