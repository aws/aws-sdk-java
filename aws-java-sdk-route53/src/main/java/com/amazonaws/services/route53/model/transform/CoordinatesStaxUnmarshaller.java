...
/**
 * Coordinates StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CoordinatesStaxUnmarshaller implements Unmarshaller<Coordinates, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Latitude", targetDepth)) {
                    coordinates.setLatitude(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Longitude", targetDepth)) {
                    coordinates.setLongitude(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
