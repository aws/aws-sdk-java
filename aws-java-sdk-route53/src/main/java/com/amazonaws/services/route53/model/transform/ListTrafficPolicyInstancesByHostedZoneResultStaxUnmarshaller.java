...
/**
 * List Traffic Policy Instances By Hosted Zone Result StAX Unmarshaller
 */
public class ListTrafficPolicyInstancesByHostedZoneResultStaxUnmarshaller implements Unmarshaller<ListTrafficPolicyInstancesByHostedZoneResult, StaxUnmarshallerContext> {
    ...
    public ListTrafficPolicyInstancesByHostedZoneResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return listTrafficPolicyInstancesByHostedZoneResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("TrafficPolicyInstances/TrafficPolicyInstance", targetDepth)) {
                    listTrafficPolicyInstancesByHostedZoneResult.getTrafficPolicyInstances().add(TrafficPolicyInstanceStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ListTrafficPolicyInstancesByHostedZoneResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ListTrafficPolicyInstancesByHostedZoneResultStaxUnmarshaller();
        return instance;
    }
}
