 ...
 */
public class GetTrafficPolicyInstanceCountResultStaxUnmarshaller
        implements
        Unmarshaller<GetTrafficPolicyInstanceCountResult, StaxUnmarshallerContext> {

    public GetTrafficPolicyInstanceCountResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("TrafficPolicyInstanceCount",
                        targetDepth)) {
                    getTrafficPolicyInstanceCountResult
                            .setTrafficPolicyInstanceCount(IntegerStaxUnmarshaller
