...
public class GetHostedZoneRequestMarshaller implements Marshaller<Request<GetHostedZoneRequest>, GetHostedZoneRequest> {
    ...
    public Request<GetHostedZoneRequest> marshall(GetHostedZoneRequest getHostedZoneRequest) {
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("Id")) {
            ...
            String value = (getHostedZoneRequest.getId() == null) ? null : StringUtils.fromString(getHostedZoneRequest.getId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{Id}", (getHostedZoneRequest.getId() == null) ? "" : StringUtils.fromString(getHostedZoneRequest.getId())); 
        }
