 ...
 */
public class UpdateHealthCheckResultStaxUnmarshaller implements
        Unmarshaller<UpdateHealthCheckResult, StaxUnmarshallerContext> {

    public UpdateHealthCheckResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
