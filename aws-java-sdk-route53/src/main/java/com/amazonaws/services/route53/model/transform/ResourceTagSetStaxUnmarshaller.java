...
/**
 * Resource Tag Set StAX Unmarshaller
 */
public class ResourceTagSetStaxUnmarshaller implements Unmarshaller<ResourceTagSet, StaxUnmarshallerContext> {
    ...
    public ResourceTagSet unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return resourceTagSet;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Tags/Tag", targetDepth)) {
                    resourceTagSet.getTags().add(TagStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ResourceTagSetStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ResourceTagSetStaxUnmarshaller();
        return instance;
    }
}
