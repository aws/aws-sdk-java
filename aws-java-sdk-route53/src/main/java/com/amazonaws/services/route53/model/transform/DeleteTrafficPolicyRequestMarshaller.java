...
/**
 * Delete Traffic Policy Request Marshaller
 */
public class DeleteTrafficPolicyRequestMarshaller implements Marshaller<Request<DeleteTrafficPolicyRequest>, DeleteTrafficPolicyRequest> {
    ...
    public Request<DeleteTrafficPolicyRequest> marshall(DeleteTrafficPolicyRequest deleteTrafficPolicyRequest) {
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("Id")) {
            ...
            String value = (deleteTrafficPolicyRequest.getId() == null) ? null : StringUtils.fromString(deleteTrafficPolicyRequest.getId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{Id}", (deleteTrafficPolicyRequest.getId() == null) ? "" : StringUtils.fromString(deleteTrafficPolicyRequest.getId())); 
        }
        
        if (DYNAMIC_QUERY_PARAMS.containsKey("Version")) {
            String name = DYNAMIC_QUERY_PARAMS.get("Version");
            String value = (deleteTrafficPolicyRequest.getVersion() == null) ? null : StringUtils.fromInteger(deleteTrafficPolicyRequest.getVersion());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{Version}", (deleteTrafficPolicyRequest.getVersion() == null) ? "" : StringUtils.fromInteger(deleteTrafficPolicyRequest.getVersion())); 
        }
