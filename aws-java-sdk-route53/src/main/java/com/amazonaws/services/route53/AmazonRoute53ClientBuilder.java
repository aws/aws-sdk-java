...
/**
 * Fluent builder for {@link com.amazonaws.services.route53.AmazonRoute53}. Use
 * of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonRoute53ClientBuilder extends
        AwsSyncClientBuilder<AmazonRoute53ClientBuilder, AmazonRoute53> {
    ...
    /**
     * Construct a synchronous implementation of AmazonRoute53 using the current
