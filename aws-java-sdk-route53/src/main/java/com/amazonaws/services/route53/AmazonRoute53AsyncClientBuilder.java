...
/**
 * Fluent builder for {@link com.amazonaws.services.route53.AmazonRoute53Async}.
 * Use of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonRoute53AsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonRoute53AsyncClientBuilder, AmazonRoute53Async> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonRoute53Async using the
