 ...
 */
public class ListChangeBatchesByHostedZoneResultStaxUnmarshaller
        implements
        Unmarshaller<ListChangeBatchesByHostedZoneResult, StaxUnmarshallerContext> {

    public ListChangeBatchesByHostedZoneResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression(
                    ...
                    listChangeBatchesByHostedZoneResult.getChangeBatchRecords()
                            .add(ChangeBatchRecordStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
