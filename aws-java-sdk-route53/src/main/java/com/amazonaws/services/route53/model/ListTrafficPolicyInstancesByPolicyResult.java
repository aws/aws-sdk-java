 ...
 * </p>
 */
public class ListTrafficPolicyInstancesByPolicyResult implements Serializable, Cloneable {
     ...
     * <code>ListTrafficPolicyInstancesByPolicy</code> again and specifying
     ...
     * in the call to <code>ListTrafficPolicyInstancesByPolicy</code> that
     ...
     *         together.
     */
    public ListTrafficPolicyInstancesByPolicyResult withTrafficPolicyInstances(java.util.Collection<TrafficPolicyInstance> trafficPolicyInstances) {
        if (trafficPolicyInstances == null) {
            this.trafficPolicyInstances = null;
        } else {
            com.amazonaws.internal.ListWithAutoConstructFlag<TrafficPolicyInstance> trafficPolicyInstancesCopy = new com.amazonaws.internal.ListWithAutoConstructFlag<TrafficPolicyInstance>(trafficPolicyInstances.size());
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTrafficPolicyInstancesByPolicyResult == false) return false;
