...
public class GetHealthCheckStatusRequestMarshaller implements Marshaller<Request<GetHealthCheckStatusRequest>, GetHealthCheckStatusRequest> {
    ...
    static {
        String path = "/2013-04-01/healthcheck/{HealthCheckId}/status";
    ...
    public Request<GetHealthCheckStatusRequest> marshall(GetHealthCheckStatusRequest getHealthCheckStatusRequest) {
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("HealthCheckId")) {
            ...
            String value = (getHealthCheckStatusRequest.getHealthCheckId() == null) ? null : StringUtils.fromString(getHealthCheckStatusRequest.getHealthCheckId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{HealthCheckId}", (getHealthCheckStatusRequest.getHealthCheckId() == null) ? "" : StringUtils.fromString(getHealthCheckStatusRequest.getHealthCheckId())); 
        }
