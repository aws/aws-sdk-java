...
/**
 * Get Change Details Request Marshaller
 */
public class GetChangeDetailsRequestMarshaller implements Marshaller<Request<GetChangeDetailsRequest>, GetChangeDetailsRequest> {
    ...
    static {
        String path = "/2013-04-01/changedetails/{Id}";
    ...
    public Request<GetChangeDetailsRequest> marshall(GetChangeDetailsRequest getChangeDetailsRequest) {
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("Id")) {
            ...
            String value = (getChangeDetailsRequest.getId() == null) ? null : StringUtils.fromString(getChangeDetailsRequest.getId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{Id}", (getChangeDetailsRequest.getId() == null) ? "" : StringUtils.fromString(getChangeDetailsRequest.getId())); 
        }
