...
public class UpdateHealthCheckRequestMarshaller implements
    ...
    public Request<UpdateHealthCheckRequest> marshall(
        ...
        uriResourcePath = uriResourcePath
                .replace(
                        "{HealthCheckId}",
                        (updateHealthCheckRequest.getHealthCheckId() != null) ? StringUtils
        ...
        try {
            ...
            if (updateHealthCheckRequest != null) {
                ...
                if (updateHealthCheckRequest.getHealthCheckVersion() != null) {
                    xmlWriter
                            .startElement("HealthCheckVersion")
                            .value(updateHealthCheckRequest
                                    .getHealthCheckVersion()).endElement();
                }

                if (updateHealthCheckRequest.getIPAddress() != null) {
                    xmlWriter.startElement("IPAddress")
                            .value(updateHealthCheckRequest.getIPAddress())
                            .endElement();
                }

                if (updateHealthCheckRequest.getPort() != null) {
                    xmlWriter.startElement("Port")
                            .value(updateHealthCheckRequest.getPort())
                            .endElement();
                }

                if (updateHealthCheckRequest.getResourcePath() != null) {
                    xmlWriter.startElement("ResourcePath")
                            .value(updateHealthCheckRequest.getResourcePath())
                            .endElement();
                }
                ...
                if (updateHealthCheckRequest.getSearchString() != null) {
                    xmlWriter.startElement("SearchString")
                            .value(updateHealthCheckRequest.getSearchString())
                            .endElement();
                }
                ...
                if (updateHealthCheckRequest.getFailureThreshold() != null) {
                    xmlWriter
                            ...
                            .value(updateHealthCheckRequest
                                    .getFailureThreshold()).endElement();
                }

                if (updateHealthCheckRequest.getInverted() != null) {
                    xmlWriter.startElement("Inverted")
                            .value(updateHealthCheckRequest.getInverted())
                            .endElement();
                }
                ...
                if (!updateHealthCheckRequestChildHealthChecksList.isEmpty()
                        || !updateHealthCheckRequestChildHealthChecksList
                                .isAutoConstruct()) {
                    ...
                    for (String updateHealthCheckRequestChildHealthChecksListValue : updateHealthCheckRequestChildHealthChecksList) {
                        ...
                        xmlWriter
                                .value(updateHealthCheckRequestChildHealthChecksListValue);
