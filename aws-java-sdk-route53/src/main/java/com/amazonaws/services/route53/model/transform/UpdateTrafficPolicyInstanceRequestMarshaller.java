...
public class UpdateTrafficPolicyInstanceRequestMarshaller
    ...
    public Request<UpdateTrafficPolicyInstanceRequest> marshall(
        ...
        uriResourcePath = uriResourcePath
                .replace(
                        "{Id}",
                        (updateTrafficPolicyInstanceRequest.getId() != null) ? SdkHttpUtils.urlEncode(
                                StringUtils
                                        .fromString(updateTrafficPolicyInstanceRequest
                                                .getId()), false)
                                : "");
            ...
            if (updateTrafficPolicyInstanceRequest != null) {
                ...
                if (updateTrafficPolicyInstanceRequest.getTTL() != null) {
                    xmlWriter.startElement("TTL")
                            .value(updateTrafficPolicyInstanceRequest.getTTL())
                            .endElement();
                }
                ...
                if (updateTrafficPolicyInstanceRequest.getTrafficPolicyId() != null) {
                    xmlWriter
                            ...
                            .value(updateTrafficPolicyInstanceRequest
                                    .getTrafficPolicyId()).endElement();
                }

                if (updateTrafficPolicyInstanceRequest
