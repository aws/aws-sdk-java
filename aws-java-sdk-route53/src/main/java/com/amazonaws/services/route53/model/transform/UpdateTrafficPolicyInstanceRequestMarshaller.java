...
/**
 * Update Traffic Policy Instance Request Marshaller
 */
public class UpdateTrafficPolicyInstanceRequestMarshaller implements Marshaller<Request<UpdateTrafficPolicyInstanceRequest>, UpdateTrafficPolicyInstanceRequest> {
    ...
    public Request<UpdateTrafficPolicyInstanceRequest> marshall(UpdateTrafficPolicyInstanceRequest updateTrafficPolicyInstanceRequest) {
        ...
        Request<UpdateTrafficPolicyInstanceRequest> request = new DefaultRequest<UpdateTrafficPolicyInstanceRequest>(updateTrafficPolicyInstanceRequest, "AmazonRoute53");
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("Id")) {
            ...
            String value = (updateTrafficPolicyInstanceRequest.getId() == null) ? null : StringUtils.fromString(updateTrafficPolicyInstanceRequest.getId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{Id}", (updateTrafficPolicyInstanceRequest.getId() == null) ? "" : StringUtils.fromString(updateTrafficPolicyInstanceRequest.getId())); 
        }
