...
public class DeleteHostedZoneRequestMarshaller implements Marshaller<Request<DeleteHostedZoneRequest>, DeleteHostedZoneRequest> {
    ...
    public Request<DeleteHostedZoneRequest> marshall(DeleteHostedZoneRequest deleteHostedZoneRequest) {
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("Id")) {
            ...
            String value = (deleteHostedZoneRequest.getId() == null) ? null : StringUtils.fromString(deleteHostedZoneRequest.getId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{Id}", (deleteHostedZoneRequest.getId() == null) ? "" : StringUtils.fromString(deleteHostedZoneRequest.getId())); 
        }
