...
public class TestDNSAnswerResultStaxUnmarshaller implements
    ...
    public TestDNSAnswerResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Nameserver", targetDepth)) {
                    testDNSAnswerResult.setNameserver(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("RecordName", targetDepth)) {
                    testDNSAnswerResult.setRecordName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("RecordType", targetDepth)) {
                    testDNSAnswerResult.setRecordType(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("RecordData/RecordDataEntry",
                        targetDepth)) {
                    testDNSAnswerResult.withRecordData(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ResponseCode", targetDepth)) {
                    testDNSAnswerResult.setResponseCode(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Protocol", targetDepth)) {
                    testDNSAnswerResult.setProtocol(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
