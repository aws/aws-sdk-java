 ...
 * </p>
 */
public class ListTrafficPolicyInstancesByPolicyRequest extends
    ...
    /**
     * <p>
     * For the first request to <code>ListTrafficPolicyInstancesByPolicy</code>,
     * omit this value.
     * </p>
     * <p>
     * If the value of <code>IsTruncated</code> in the previous response was
     * <code>true</code>, <code>HostedZoneIdMarker</code> is the ID of the
     ...
     * </p>
     * 
     * @return The version of the traffic policy for which you want to list
     *         traffic policy instances. The version must be associated with the
     *         traffic policy that is specified by <code>TrafficPolicyId</code>.
     */
     ...
     *        <code>ListTrafficPolicyInstancesByPolicy</code>, omit this
     *        value.</p>
     *        <p>
     *        If the value of <code>IsTruncated</code> in the previous response
     *        was <code>true</code>, <code>HostedZoneIdMarker</code> is the ID
     *        of the hosted zone for the first traffic policy instance in the
