...
/**
 * List Traffic Policy Instances By Policy Result StAX Unmarshaller
 */
public class ListTrafficPolicyInstancesByPolicyResultStaxUnmarshaller implements Unmarshaller<ListTrafficPolicyInstancesByPolicyResult, StaxUnmarshallerContext> {
    ...
    public ListTrafficPolicyInstancesByPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return listTrafficPolicyInstancesByPolicyResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("TrafficPolicyInstances/TrafficPolicyInstance", targetDepth)) {
                    listTrafficPolicyInstancesByPolicyResult.getTrafficPolicyInstances().add(TrafficPolicyInstanceStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ListTrafficPolicyInstancesByPolicyResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ListTrafficPolicyInstancesByPolicyResultStaxUnmarshaller();
        return instance;
    }
}
