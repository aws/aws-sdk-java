...
/**
 * DeleteSyncConfigurationResult JSON Unmarshaller
 */
...
public class DeleteSyncConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteSyncConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteSyncConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSyncConfigurationResult deleteSyncConfigurationResult = new DeleteSyncConfigurationResult();

        return deleteSyncConfigurationResult;
    }
