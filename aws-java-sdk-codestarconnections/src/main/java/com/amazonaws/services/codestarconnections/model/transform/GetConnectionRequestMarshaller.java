...
@SdkInternalApi
public class GetConnectionRequestMarshaller {
    ...
    public static GetConnectionRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetConnectionRequest getConnectionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getConnectionRequest.getConnectionArn(), CONNECTIONARN_BINDING);
        } catch (Exception e) {
