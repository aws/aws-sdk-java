...
public class CreateRepositoryLinkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The returned information about the created repository link.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRepositoryLinkResult == false)
            return false;
        CreateRepositoryLinkResult other = (CreateRepositoryLinkResult) obj;
    ...
    public CreateRepositoryLinkResult clone() {
        try {
            return (CreateRepositoryLinkResult) super.clone();
