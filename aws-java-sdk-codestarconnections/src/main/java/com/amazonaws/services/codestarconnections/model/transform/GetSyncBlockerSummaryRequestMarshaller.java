...
public class GetSyncBlockerSummaryRequestMarshaller {
    ...
    private static final GetSyncBlockerSummaryRequestMarshaller instance = new GetSyncBlockerSummaryRequestMarshaller();

    public static GetSyncBlockerSummaryRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetSyncBlockerSummaryRequest getSyncBlockerSummaryRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getSyncBlockerSummaryRequest.getSyncType(), SYNCTYPE_BINDING);
            protocolMarshaller.marshall(getSyncBlockerSummaryRequest.getResourceName(), RESOURCENAME_BINDING);
        } catch (Exception e) {
