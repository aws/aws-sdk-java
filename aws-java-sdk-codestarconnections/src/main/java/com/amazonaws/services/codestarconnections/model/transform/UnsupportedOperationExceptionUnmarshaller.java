...
public class UnsupportedOperationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UnsupportedOperationExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarconnections.model.UnsupportedOperationException.class, "UnsupportedOperationException");
    }

    @Override
    public com.amazonaws.services.codestarconnections.model.UnsupportedOperationException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.codestarconnections.model.UnsupportedOperationException unsupportedOperationException = new com.amazonaws.services.codestarconnections.model.UnsupportedOperationException(
                null);
