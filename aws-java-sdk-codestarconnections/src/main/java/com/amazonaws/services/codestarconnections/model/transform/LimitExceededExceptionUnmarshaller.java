...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarconnections.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.codestarconnections.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codestarconnections.model.LimitExceededException limitExceededException = new com.amazonaws.services.codestarconnections.model.LimitExceededException(
                null);
