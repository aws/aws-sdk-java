...
public class ConcurrentModificationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConcurrentModificationExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarconnections.model.ConcurrentModificationException.class, "ConcurrentModificationException");
    }

    @Override
    public com.amazonaws.services.codestarconnections.model.ConcurrentModificationException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.codestarconnections.model.ConcurrentModificationException concurrentModificationException = new com.amazonaws.services.codestarconnections.model.ConcurrentModificationException(
                null);
