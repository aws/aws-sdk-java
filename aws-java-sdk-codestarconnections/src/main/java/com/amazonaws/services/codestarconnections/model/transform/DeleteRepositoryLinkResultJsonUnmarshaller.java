...
/**
 * DeleteRepositoryLinkResult JSON Unmarshaller
 */
...
public class DeleteRepositoryLinkResultJsonUnmarshaller implements Unmarshaller<DeleteRepositoryLinkResult, JsonUnmarshallerContext> {
    ...
    public DeleteRepositoryLinkResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRepositoryLinkResult deleteRepositoryLinkResult = new DeleteRepositoryLinkResult();

        return deleteRepositoryLinkResult;
    }
