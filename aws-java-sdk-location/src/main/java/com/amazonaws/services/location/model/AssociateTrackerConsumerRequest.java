...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/location-2020-11-19/AssociateTrackerConsumer" target="_top">AWS
 *      API Documentation</a>
 */
...
public class AssociateTrackerConsumerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        you need to specify a resource across all Amazon Web Services.</p>
     *        <ul>
     *        <li>
     *        <p>
     *        Format example:
     ...
     *         when you need to specify a resource across all Amazon Web Services.</p>
     *         <ul>
     *         <li>
     *         <p>
     *         Format example:
