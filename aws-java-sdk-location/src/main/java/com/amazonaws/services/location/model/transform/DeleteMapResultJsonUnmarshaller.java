...
/**
 * DeleteMapResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteMapResultJsonUnmarshaller implements Unmarshaller<DeleteMapResult, JsonUnmarshallerContext> {

    public DeleteMapResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMapResult deleteMapResult = new DeleteMapResult();
