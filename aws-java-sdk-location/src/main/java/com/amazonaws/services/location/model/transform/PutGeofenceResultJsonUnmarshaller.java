...
/**
 * PutGeofenceResult JSON Unmarshaller
 */
...
public class PutGeofenceResultJsonUnmarshaller implements Unmarshaller<PutGeofenceResult, JsonUnmarshallerContext> {
    ...
    public PutGeofenceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("UpdateTime", targetDepth)) {
                    context.nextToken();
                    putGeofenceResult.setUpdateTime(DateJsonUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                }
