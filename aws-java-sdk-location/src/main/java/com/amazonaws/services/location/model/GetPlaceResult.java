...
public class GetPlaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Details about the result, such as its address and position.
     */
    ...
    @Override
    public GetPlaceResult clone() {
        try {
            return (GetPlaceResult) super.clone();
