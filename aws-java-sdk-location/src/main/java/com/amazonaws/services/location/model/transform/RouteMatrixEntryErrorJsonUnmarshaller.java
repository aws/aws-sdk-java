...
/**
 * RouteMatrixEntryError JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RouteMatrixEntryErrorJsonUnmarshaller implements Unmarshaller<RouteMatrixEntryError, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Code", targetDepth)) {
                    context.nextToken();
                    routeMatrixEntryError.setCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    routeMatrixEntryError.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
