...
/**
 * GetPlaceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetPlaceResultJsonUnmarshaller implements Unmarshaller<GetPlaceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Place", targetDepth)) {
                    context.nextToken();
                    getPlaceResult.setPlace(PlaceJsonUnmarshaller.getInstance().unmarshall(context));
                }
