...
@SdkInternalApi
public class GetPlaceRequestMarshaller {
    ...
    public static GetPlaceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetPlaceRequest getPlaceRequest, ProtocolMarshaller protocolMarshaller) {
