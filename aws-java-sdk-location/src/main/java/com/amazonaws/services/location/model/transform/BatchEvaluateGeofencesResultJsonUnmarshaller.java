...
/**
 * BatchEvaluateGeofencesResult JSON Unmarshaller
 */
...
public class BatchEvaluateGeofencesResultJsonUnmarshaller implements Unmarshaller<BatchEvaluateGeofencesResult, JsonUnmarshallerContext> {
    ...
    public BatchEvaluateGeofencesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Errors", targetDepth)) {
                    context.nextToken();
                    batchEvaluateGeofencesResult.setErrors(new ListUnmarshaller<BatchEvaluateGeofencesError>(BatchEvaluateGeofencesErrorJsonUnmarshaller
                            .getInstance())
