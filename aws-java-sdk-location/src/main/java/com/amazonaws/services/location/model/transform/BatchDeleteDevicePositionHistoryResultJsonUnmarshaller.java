...
/**
 * BatchDeleteDevicePositionHistoryResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchDeleteDevicePositionHistoryResultJsonUnmarshaller implements Unmarshaller<BatchDeleteDevicePositionHistoryResult, JsonUnmarshallerContext> {

    public BatchDeleteDevicePositionHistoryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Errors", targetDepth)) {
                    context.nextToken();
                    batchDeleteDevicePositionHistoryResult.setErrors(new ListUnmarshaller<BatchDeleteDevicePositionHistoryError>(
