...
/**
 * ListTrackersResponseEntryMarshaller
 */
...
public class ListTrackersResponseEntryMarshaller {
    ...
    private static final ListTrackersResponseEntryMarshaller instance = new ListTrackersResponseEntryMarshaller();

    public static ListTrackersResponseEntryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListTrackersResponseEntry listTrackersResponseEntry, ProtocolMarshaller protocolMarshaller) {

        if (listTrackersResponseEntry == null) {
