...
public class GetMapGlyphsRequestMarshaller {
    ...
    public static GetMapGlyphsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetMapGlyphsRequest getMapGlyphsRequest, ProtocolMarshaller protocolMarshaller) {
