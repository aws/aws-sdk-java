...
/**
 * ApiKeyRestrictions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ApiKeyRestrictionsJsonUnmarshaller implements Unmarshaller<ApiKeyRestrictions, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AllowActions", targetDepth)) {
                    context.nextToken();
                    apiKeyRestrictions.setAllowActions(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
