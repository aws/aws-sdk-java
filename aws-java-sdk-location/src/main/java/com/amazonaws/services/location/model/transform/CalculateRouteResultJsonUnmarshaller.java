...
/**
 * CalculateRouteResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CalculateRouteResultJsonUnmarshaller implements Unmarshaller<CalculateRouteResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Legs", targetDepth)) {
                    context.nextToken();
                    calculateRouteResult.setLegs(new ListUnmarshaller<Leg>(LegJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("Summary", targetDepth)) {
                    context.nextToken();
                    calculateRouteResult.setSummary(CalculateRouteSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
