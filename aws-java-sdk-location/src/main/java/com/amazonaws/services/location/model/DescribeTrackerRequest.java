...
public class DescribeTrackerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DescribeTrackerRequest clone() {
        return (DescribeTrackerRequest) super.clone();
    }
