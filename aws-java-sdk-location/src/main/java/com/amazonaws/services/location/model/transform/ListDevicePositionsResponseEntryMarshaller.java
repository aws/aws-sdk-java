...
/**
 * ListDevicePositionsResponseEntryMarshaller
 */
...
public class ListDevicePositionsResponseEntryMarshaller {
    ...
    public static ListDevicePositionsResponseEntryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListDevicePositionsResponseEntry listDevicePositionsResponseEntry, ProtocolMarshaller protocolMarshaller) {

        if (listDevicePositionsResponseEntry == null) {
