...
public class ListPlaceIndexesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Lists the place index resources that exist in your AWS account
     */
    ...
    public void setEntries(java.util.Collection<ListPlaceIndexesResponseEntry> entries) {
        ...
        this.entries = new java.util.ArrayList<ListPlaceIndexesResponseEntry>(entries);
    }
    ...
    public ListPlaceIndexesResult withEntries(ListPlaceIndexesResponseEntry... entries) {
        if (this.entries == null) {
            setEntries(new java.util.ArrayList<ListPlaceIndexesResponseEntry>(entries.length));
        }
        for (ListPlaceIndexesResponseEntry ele : entries) {
    ...
    public ListPlaceIndexesResult withEntries(java.util.Collection<ListPlaceIndexesResponseEntry> entries) {
        setEntries(entries);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPlaceIndexesResult == false)
            return false;
        ListPlaceIndexesResult other = (ListPlaceIndexesResult) obj;
    ...
    public ListPlaceIndexesResult clone() {
        try {
            return (ListPlaceIndexesResult) super.clone();
