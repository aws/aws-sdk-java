...
public class ListGeofencesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListGeofencesResult withEntries(ListGeofenceResponseEntry... entries) {
        if (this.entries == null) {
            setEntries(new java.util.ArrayList<ListGeofenceResponseEntry>(entries.length));
        }
        for (ListGeofenceResponseEntry ele : entries) {
    ...
    public ListGeofencesResult clone() {
        try {
            return (ListGeofencesResult) super.clone();
