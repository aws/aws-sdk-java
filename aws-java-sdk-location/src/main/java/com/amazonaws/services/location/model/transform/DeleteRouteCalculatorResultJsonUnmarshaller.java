...
/**
 * DeleteRouteCalculatorResult JSON Unmarshaller
 */
...
public class DeleteRouteCalculatorResultJsonUnmarshaller implements Unmarshaller<DeleteRouteCalculatorResult, JsonUnmarshallerContext> {
    ...
    public DeleteRouteCalculatorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRouteCalculatorResult deleteRouteCalculatorResult = new DeleteRouteCalculatorResult();
