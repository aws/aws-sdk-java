...
public class DataSourceConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> INTENDEDUSE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("IntendedUse").build();
    ...
    public void marshall(DataSourceConfiguration dataSourceConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dataSourceConfiguration.getIntendedUse(), INTENDEDUSE_BINDING);
        } catch (Exception e) {
