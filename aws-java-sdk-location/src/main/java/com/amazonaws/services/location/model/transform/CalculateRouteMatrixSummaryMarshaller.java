...
/**
 * CalculateRouteMatrixSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CalculateRouteMatrixSummaryMarshaller {
    ...
    public static CalculateRouteMatrixSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CalculateRouteMatrixSummary calculateRouteMatrixSummary, ProtocolMarshaller protocolMarshaller) {

        if (calculateRouteMatrixSummary == null) {
