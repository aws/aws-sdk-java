...
/**
 * CalculateRouteMatrixSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CalculateRouteMatrixSummaryJsonUnmarshaller implements Unmarshaller<CalculateRouteMatrixSummary, JsonUnmarshallerContext> {

    public CalculateRouteMatrixSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        CalculateRouteMatrixSummary calculateRouteMatrixSummary = new CalculateRouteMatrixSummary();
    ...
    private static CalculateRouteMatrixSummaryJsonUnmarshaller instance;

    public static CalculateRouteMatrixSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CalculateRouteMatrixSummaryJsonUnmarshaller();
        return instance;
    }
}
