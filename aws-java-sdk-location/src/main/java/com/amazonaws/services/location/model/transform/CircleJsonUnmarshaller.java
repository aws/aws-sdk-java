...
/**
 * Circle JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CircleJsonUnmarshaller implements Unmarshaller<Circle, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Center", targetDepth)) {
                    context.nextToken();
                    circle.setCenter(new ListUnmarshaller<Double>(context.getUnmarshaller(Double.class))

                    .unmarshall(context));
                }
                if (context.testExpression("Radius", targetDepth)) {
                    context.nextToken();
                    circle.setRadius(context.getUnmarshaller(Double.class).unmarshall(context));
                }
