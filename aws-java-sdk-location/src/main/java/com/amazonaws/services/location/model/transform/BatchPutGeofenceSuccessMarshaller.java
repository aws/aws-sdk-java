...
/**
 * BatchPutGeofenceSuccessMarshaller
 */
...
public class BatchPutGeofenceSuccessMarshaller {
    ...
    private static final BatchPutGeofenceSuccessMarshaller instance = new BatchPutGeofenceSuccessMarshaller();

    public static BatchPutGeofenceSuccessMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchPutGeofenceSuccess batchPutGeofenceSuccess, ProtocolMarshaller protocolMarshaller) {

        if (batchPutGeofenceSuccess == null) {
