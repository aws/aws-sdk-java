...
/**
 * BatchPutGeofenceError JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchPutGeofenceErrorJsonUnmarshaller implements Unmarshaller<BatchPutGeofenceError, JsonUnmarshallerContext> {

    public BatchPutGeofenceError unmarshall(JsonUnmarshallerContext context) throws Exception {
