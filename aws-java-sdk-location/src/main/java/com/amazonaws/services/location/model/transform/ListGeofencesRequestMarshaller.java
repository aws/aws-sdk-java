...
@SdkInternalApi
public class ListGeofencesRequestMarshaller {
    ...
    private static final ListGeofencesRequestMarshaller instance = new ListGeofencesRequestMarshaller();

    public static ListGeofencesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListGeofencesRequest listGeofencesRequest, ProtocolMarshaller protocolMarshaller) {
