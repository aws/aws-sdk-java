...
/**
 * ListRouteCalculatorsResult JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Entries", targetDepth)) {
                    context.nextToken();
                    listRouteCalculatorsResult.setEntries(new ListUnmarshaller<ListRouteCalculatorsResponseEntry>(
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listRouteCalculatorsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
