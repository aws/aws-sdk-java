...
/**
 * ListKeysResponseEntry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListKeysResponseEntryJsonUnmarshaller implements Unmarshaller<ListKeysResponseEntry, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("UpdateTime", targetDepth)) {
                    context.nextToken();
                    listKeysResponseEntry.setUpdateTime(DateJsonUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                }
