...
/**
 * SearchPlaceIndexForSuggestionsResult JSON Unmarshaller
 */
...
public class SearchPlaceIndexForSuggestionsResultJsonUnmarshaller implements Unmarshaller<SearchPlaceIndexForSuggestionsResult, JsonUnmarshallerContext> {
    ...
    public SearchPlaceIndexForSuggestionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
