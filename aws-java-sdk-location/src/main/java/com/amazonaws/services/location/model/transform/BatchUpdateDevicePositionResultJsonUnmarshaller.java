...
/**
 * BatchUpdateDevicePositionResult JSON Unmarshaller
 */
...
public class BatchUpdateDevicePositionResultJsonUnmarshaller implements Unmarshaller<BatchUpdateDevicePositionResult, JsonUnmarshallerContext> {
    ...
    public BatchUpdateDevicePositionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Errors", targetDepth)) {
                    context.nextToken();
                    batchUpdateDevicePositionResult.setErrors(new ListUnmarshaller<BatchUpdateDevicePositionError>(
                            BatchUpdateDevicePositionErrorJsonUnmarshaller.getInstance())
