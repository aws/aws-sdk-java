...
/**
 * ListTrackersResponseEntry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListTrackersResponseEntryJsonUnmarshaller implements Unmarshaller<ListTrackersResponseEntry, JsonUnmarshallerContext> {

    public ListTrackersResponseEntry unmarshall(JsonUnmarshallerContext context) throws Exception {
        ListTrackersResponseEntry listTrackersResponseEntry = new ListTrackersResponseEntry();
    ...
    private static ListTrackersResponseEntryJsonUnmarshaller instance;

    public static ListTrackersResponseEntryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListTrackersResponseEntryJsonUnmarshaller();
        return instance;
    }
}
