...
public class ListKeysResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * Contains API key resources in your Amazon Web Services account. Details include API key name, allowed referers
     * and timestamp for when the API key will expire.
     * </p>
     */
    private java.util.List<ListKeysResponseEntry> entries;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return Contains API key resources in your Amazon Web Services account. Details include API key name, allowed
     *         referers and timestamp for when the API key will expire.
     */

    public java.util.List<ListKeysResponseEntry> getEntries() {
        return entries;
    }
     ...
     * 
     * @param entries
     *        Contains API key resources in your Amazon Web Services account. Details include API key name, allowed
     *        referers and timestamp for when the API key will expire.
     */

    public void setEntries(java.util.Collection<ListKeysResponseEntry> entries) {
        if (entries == null) {
            this.entries = null;
            return;
        }

        this.entries = new java.util.ArrayList<ListKeysResponseEntry>(entries);
    }
    ...
    public ListKeysResult withEntries(ListKeysResponseEntry... entries) {
        if (this.entries == null) {
            setEntries(new java.util.ArrayList<ListKeysResponseEntry>(entries.length));
        }
        for (ListKeysResponseEntry ele : entries) {
    ...
    public ListKeysResult withEntries(java.util.Collection<ListKeysResponseEntry> entries) {
        setEntries(entries);
        return this;
    }
