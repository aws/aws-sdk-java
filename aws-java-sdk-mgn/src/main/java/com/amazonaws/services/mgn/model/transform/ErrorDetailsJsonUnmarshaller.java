        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("resourceId", targetDepth)) {
                    context.nextToken();
                    errorDetails.setResourceId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("resourceType", targetDepth)) {
                    context.nextToken();
                    errorDetails.setResourceType(context.getUnmarshaller(String.class).unmarshall(context));
                }
