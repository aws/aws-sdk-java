 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/LifeCycleLastCutoverFinalized" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LifeCycleLastCutoverFinalized implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LifeCycleLastCutoverFinalized == false)
            return false;
        LifeCycleLastCutoverFinalized other = (LifeCycleLastCutoverFinalized) obj;
    ...
    @Override
    public LifeCycleLastCutoverFinalized clone() {
        try {
            return (LifeCycleLastCutoverFinalized) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mgn.model.transform.LifeCycleLastCutoverFinalizedMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
