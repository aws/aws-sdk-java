...
/**
 * LifeCycleLastCutover JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LifeCycleLastCutoverJsonUnmarshaller implements Unmarshaller<LifeCycleLastCutover, JsonUnmarshallerContext> {

    public LifeCycleLastCutover unmarshall(JsonUnmarshallerContext context) throws Exception {
        LifeCycleLastCutover lifeCycleLastCutover = new LifeCycleLastCutover();
    ...
    private static LifeCycleLastCutoverJsonUnmarshaller instance;

    public static LifeCycleLastCutoverJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LifeCycleLastCutoverJsonUnmarshaller();
        return instance;
    }
}
