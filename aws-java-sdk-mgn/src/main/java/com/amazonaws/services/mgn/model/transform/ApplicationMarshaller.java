...
public class ApplicationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> APPLICATIONAGGREGATEDSTATUS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("applicationAggregatedStatus").build();
    ...
    public void marshall(Application application, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(application.getApplicationAggregatedStatus(), APPLICATIONAGGREGATEDSTATUS_BINDING);
            ...
            protocolMarshaller.marshall(application.getCreationDateTime(), CREATIONDATETIME_BINDING);
            protocolMarshaller.marshall(application.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(application.getIsArchived(), ISARCHIVED_BINDING);
            protocolMarshaller.marshall(application.getLastModifiedDateTime(), LASTMODIFIEDDATETIME_BINDING);
            protocolMarshaller.marshall(application.getName(), NAME_BINDING);
            protocolMarshaller.marshall(application.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(application.getWaveID(), WAVEID_BINDING);
        } catch (Exception e) {
