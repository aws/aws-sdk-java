...
public class ArchiveWaveResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ArchiveWaveResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public ArchiveWaveResult withCreationDateTime(String creationDateTime) {
    ...
    public ArchiveWaveResult withDescription(String description) {
    ...
    public ArchiveWaveResult withIsArchived(Boolean isArchived) {
    ...
    public ArchiveWaveResult withLastModifiedDateTime(String lastModifiedDateTime) {
    ...
    public ArchiveWaveResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public ArchiveWaveResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ArchiveWaveResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ArchiveWaveResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public ArchiveWaveResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public ArchiveWaveResult withWaveAggregatedStatus(WaveAggregatedStatus waveAggregatedStatus) {
    ...
    public ArchiveWaveResult withWaveID(String waveID) {
        setWaveID(waveID);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ArchiveWaveResult == false)
            return false;
        ArchiveWaveResult other = (ArchiveWaveResult) obj;
    ...
    @Override
    public ArchiveWaveResult clone() {
        try {
            return (ArchiveWaveResult) super.clone();
