...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/LaunchConfigurationTemplate" target="_top">AWS
 *      API Documentation</a>
 */
...
public class LaunchConfigurationTemplate implements Serializable, Cloneable, StructuredPojo {
    ...
    public LaunchConfigurationTemplate withBootMode(String bootMode) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mgn.model.transform.LaunchConfigurationTemplateMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
