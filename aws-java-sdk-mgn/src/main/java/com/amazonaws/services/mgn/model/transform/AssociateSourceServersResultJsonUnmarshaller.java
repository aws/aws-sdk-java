...
/**
 * AssociateSourceServersResult JSON Unmarshaller
 */
...
public class AssociateSourceServersResultJsonUnmarshaller implements Unmarshaller<AssociateSourceServersResult, JsonUnmarshallerContext> {
    ...
    public AssociateSourceServersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateSourceServersResult associateSourceServersResult = new AssociateSourceServersResult();
