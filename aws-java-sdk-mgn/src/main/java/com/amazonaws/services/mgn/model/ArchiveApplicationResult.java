...
public class ArchiveApplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ArchiveApplicationResult withApplicationAggregatedStatus(ApplicationAggregatedStatus applicationAggregatedStatus) {
    ...
    public ArchiveApplicationResult withApplicationID(String applicationID) {
    ...
    public ArchiveApplicationResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public ArchiveApplicationResult withCreationDateTime(String creationDateTime) {
    ...
    public ArchiveApplicationResult withDescription(String description) {
    ...
    public ArchiveApplicationResult withIsArchived(Boolean isArchived) {
    ...
    public ArchiveApplicationResult withLastModifiedDateTime(String lastModifiedDateTime) {
    ...
    public ArchiveApplicationResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public ArchiveApplicationResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ArchiveApplicationResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ArchiveApplicationResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public ArchiveApplicationResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public ArchiveApplicationResult withWaveID(String waveID) {
        setWaveID(waveID);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ArchiveApplicationResult == false)
            return false;
        ArchiveApplicationResult other = (ArchiveApplicationResult) obj;
    ...
    @Override
    public ArchiveApplicationResult clone() {
        try {
            return (ArchiveApplicationResult) super.clone();
