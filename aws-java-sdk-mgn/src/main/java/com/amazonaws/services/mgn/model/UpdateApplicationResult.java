...
public class UpdateApplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateApplicationResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public UpdateApplicationResult withCreationDateTime(String creationDateTime) {
    ...
    public UpdateApplicationResult withIsArchived(Boolean isArchived) {
    ...
    public UpdateApplicationResult withLastModifiedDateTime(String lastModifiedDateTime) {
    ...
    public UpdateApplicationResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateApplicationResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateApplicationResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UpdateApplicationResult withWaveID(String waveID) {
        setWaveID(waveID);
        return this;
    }
