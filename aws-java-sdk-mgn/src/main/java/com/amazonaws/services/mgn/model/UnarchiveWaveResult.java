...
public class UnarchiveWaveResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UnarchiveWaveResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public UnarchiveWaveResult withCreationDateTime(String creationDateTime) {
    ...
    public UnarchiveWaveResult withDescription(String description) {
    ...
    public UnarchiveWaveResult withIsArchived(Boolean isArchived) {
    ...
    public UnarchiveWaveResult withLastModifiedDateTime(String lastModifiedDateTime) {
    ...
    public UnarchiveWaveResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public UnarchiveWaveResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UnarchiveWaveResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UnarchiveWaveResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UnarchiveWaveResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public UnarchiveWaveResult withWaveAggregatedStatus(WaveAggregatedStatus waveAggregatedStatus) {
    ...
    public UnarchiveWaveResult withWaveID(String waveID) {
        setWaveID(waveID);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UnarchiveWaveResult == false)
            return false;
        UnarchiveWaveResult other = (UnarchiveWaveResult) obj;
    ...
    @Override
    public UnarchiveWaveResult clone() {
        try {
            return (UnarchiveWaveResult) super.clone();
