...
public class UpdateLaunchConfigurationTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
    ...
    public UpdateLaunchConfigurationTemplateResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public UpdateLaunchConfigurationTemplateResult withAssociatePublicIpAddress(Boolean associatePublicIpAddress) {
    ...
    public UpdateLaunchConfigurationTemplateResult withBootMode(String bootMode) {
    ...
    public UpdateLaunchConfigurationTemplateResult withBootMode(BootMode bootMode) {
    ...
    public UpdateLaunchConfigurationTemplateResult withCopyPrivateIp(Boolean copyPrivateIp) {
    ...
    public UpdateLaunchConfigurationTemplateResult withCopyTags(Boolean copyTags) {
    ...
    public UpdateLaunchConfigurationTemplateResult withEc2LaunchTemplateID(String ec2LaunchTemplateID) {
    ...
    public UpdateLaunchConfigurationTemplateResult withEnableMapAutoTagging(Boolean enableMapAutoTagging) {
    ...
    public UpdateLaunchConfigurationTemplateResult withLargeVolumeConf(LaunchTemplateDiskConf largeVolumeConf) {
    ...
    public UpdateLaunchConfigurationTemplateResult withLaunchConfigurationTemplateID(String launchConfigurationTemplateID) {
    ...
    public UpdateLaunchConfigurationTemplateResult withLaunchDisposition(String launchDisposition) {
    ...
    public UpdateLaunchConfigurationTemplateResult withLaunchDisposition(LaunchDisposition launchDisposition) {
    ...
    public UpdateLaunchConfigurationTemplateResult withLicensing(Licensing licensing) {
    ...
    public UpdateLaunchConfigurationTemplateResult withMapAutoTaggingMpeID(String mapAutoTaggingMpeID) {
    ...
    public UpdateLaunchConfigurationTemplateResult withPostLaunchActions(PostLaunchActions postLaunchActions) {
    ...
    public UpdateLaunchConfigurationTemplateResult withSmallVolumeConf(LaunchTemplateDiskConf smallVolumeConf) {
    ...
    public UpdateLaunchConfigurationTemplateResult withSmallVolumeMaxSize(Long smallVolumeMaxSize) {
    ...
    public UpdateLaunchConfigurationTemplateResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateLaunchConfigurationTemplateResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateLaunchConfigurationTemplateResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UpdateLaunchConfigurationTemplateResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public UpdateLaunchConfigurationTemplateResult withTargetInstanceTypeRightSizingMethod(String targetInstanceTypeRightSizingMethod) {
    ...
    public UpdateLaunchConfigurationTemplateResult withTargetInstanceTypeRightSizingMethod(
