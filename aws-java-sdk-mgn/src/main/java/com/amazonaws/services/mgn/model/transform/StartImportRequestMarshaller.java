...
public class StartImportRequestMarshaller {
    ...
    public void marshall(StartImportRequest startImportRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startImportRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(startImportRequest.getS3BucketSource(), S3BUCKETSOURCE_BINDING);
        } catch (Exception e) {
