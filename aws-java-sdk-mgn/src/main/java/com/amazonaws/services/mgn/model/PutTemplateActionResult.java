...
public class PutTemplateActionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PutTemplateActionResult withActionID(String actionID) {
    ...
    public PutTemplateActionResult withActionName(String actionName) {
    ...
    public PutTemplateActionResult withActive(Boolean active) {
        setActive(active);
        return this;
    }
    ...
    public PutTemplateActionResult withDocumentIdentifier(String documentIdentifier) {
    ...
    public PutTemplateActionResult withMustSucceedForCutover(Boolean mustSucceedForCutover) {
    ...
    public PutTemplateActionResult withOperatingSystem(String operatingSystem) {
    ...
    public PutTemplateActionResult withOrder(Integer order) {
        setOrder(order);
        return this;
    }
    ...
    public PutTemplateActionResult withParameters(java.util.Map<String, java.util.List<SsmParameterStoreParameter>> parameters) {
     ...
     *
     * @see PutTemplateActionResult#withParameters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PutTemplateActionResult addParametersEntry(String key, java.util.List<SsmParameterStoreParameter> value) {
    ...
    public PutTemplateActionResult clearParametersEntries() {
    ...
    public PutTemplateActionResult withTimeoutSeconds(Integer timeoutSeconds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutTemplateActionResult == false)
            return false;
        PutTemplateActionResult other = (PutTemplateActionResult) obj;
    ...
    @Override
    public PutTemplateActionResult clone() {
        try {
            return (PutTemplateActionResult) super.clone();
