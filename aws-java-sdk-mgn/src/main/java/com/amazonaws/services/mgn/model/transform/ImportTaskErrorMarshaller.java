...
/**
 * ImportTaskErrorMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ImportTaskErrorMarshaller {
    ...
    private static final ImportTaskErrorMarshaller instance = new ImportTaskErrorMarshaller();

    public static ImportTaskErrorMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ImportTaskError importTaskError, ProtocolMarshaller protocolMarshaller) {

        if (importTaskError == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(importTaskError.getErrorData(), ERRORDATA_BINDING);
            protocolMarshaller.marshall(importTaskError.getErrorDateTime(), ERRORDATETIME_BINDING);
            protocolMarshaller.marshall(importTaskError.getErrorType(), ERRORTYPE_BINDING);
        } catch (Exception e) {
