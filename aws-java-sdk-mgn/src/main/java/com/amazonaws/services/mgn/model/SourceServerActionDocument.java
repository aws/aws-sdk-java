...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/SourceServerActionDocument" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SourceServerActionDocument implements Serializable, Cloneable, StructuredPojo {
     ...
     *
     * @see SourceServerActionDocument#withExternalParameters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public SourceServerActionDocument addExternalParametersEntry(String key, SsmExternalParameter value) {
    ...
    public SourceServerActionDocument withParameters(java.util.Map<String, java.util.List<SsmParameterStoreParameter>> parameters) {
     ...
     *
     * @see SourceServerActionDocument#withParameters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public SourceServerActionDocument addParametersEntry(String key, java.util.List<SsmParameterStoreParameter> value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SourceServerActionDocument == false)
            return false;
    ...
    public SourceServerActionDocument clone() {
        try {
            return (SourceServerActionDocument) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mgn.model.transform.SourceServerActionDocumentMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
