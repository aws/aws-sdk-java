...
/**
 * JobPostLaunchActionsLaunchStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JobPostLaunchActionsLaunchStatusJsonUnmarshaller implements Unmarshaller<JobPostLaunchActionsLaunchStatus, JsonUnmarshallerContext> {

    public JobPostLaunchActionsLaunchStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        JobPostLaunchActionsLaunchStatus jobPostLaunchActionsLaunchStatus = new JobPostLaunchActionsLaunchStatus();
    ...
    private static JobPostLaunchActionsLaunchStatusJsonUnmarshaller instance;

    public static JobPostLaunchActionsLaunchStatusJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new JobPostLaunchActionsLaunchStatusJsonUnmarshaller();
        return instance;
    }
}
