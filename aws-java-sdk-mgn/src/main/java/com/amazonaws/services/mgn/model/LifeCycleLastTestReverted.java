 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/LifeCycleLastTestReverted" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LifeCycleLastTestReverted implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Lifecycle last Test reverted API call date and time.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LifeCycleLastTestReverted == false)
            return false;
        LifeCycleLastTestReverted other = (LifeCycleLastTestReverted) obj;
    ...
    @Override
    public LifeCycleLastTestReverted clone() {
        try {
            return (LifeCycleLastTestReverted) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mgn.model.transform.LifeCycleLastTestRevertedMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
