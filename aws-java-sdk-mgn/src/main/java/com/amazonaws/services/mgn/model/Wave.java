...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/Wave" target="_top">AWS API Documentation</a>
 */
...
public class Wave implements Serializable, Cloneable, StructuredPojo {
    ...
    public Wave addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mgn.model.transform.WaveMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
