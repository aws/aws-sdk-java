...
public class ListExportsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ExportTask> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return List export response items.
     */

    public java.util.List<ExportTask> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<ExportTask> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<ExportTask>(items);
    }
    ...
    public ListExportsResult withItems(ExportTask... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<ExportTask>(items.length));
        }
        for (ExportTask ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListExportsResult withItems(java.util.Collection<ExportTask> items) {
        setItems(items);
        return this;
    }
     ...
     * </p>
     * 
     * @return List export response next token.
     */
