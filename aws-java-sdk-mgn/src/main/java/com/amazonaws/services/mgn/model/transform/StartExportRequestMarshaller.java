...
public class StartExportRequestMarshaller {
    ...
    private static final StartExportRequestMarshaller instance = new StartExportRequestMarshaller();

    public static StartExportRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartExportRequest startExportRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startExportRequest.getS3Bucket(), S3BUCKET_BINDING);
            protocolMarshaller.marshall(startExportRequest.getS3BucketOwner(), S3BUCKETOWNER_BINDING);
            protocolMarshaller.marshall(startExportRequest.getS3Key(), S3KEY_BINDING);
        } catch (Exception e) {
