...
public class ErrorDetailsMarshaller {
    ...
    public void marshall(ErrorDetails errorDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(errorDetails.getResourceId(), RESOURCEID_BINDING);
            protocolMarshaller.marshall(errorDetails.getResourceType(), RESOURCETYPE_BINDING);
        } catch (Exception e) {
