...
public class UpdateConnectorRequestMarshaller {
    ...
    public void marshall(UpdateConnectorRequest updateConnectorRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateConnectorRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateConnectorRequest.getSsmCommandConfig(), SSMCOMMANDCONFIG_BINDING);
        } catch (Exception e) {
