...
public class GetECSServiceRecommendationProjectedMetricsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetECSServiceRecommendationProjectedMetricsRequest withStat(String stat) {
        setStat(stat);
        return this;
    }
    ...
    public GetECSServiceRecommendationProjectedMetricsRequest withStat(MetricStatistic stat) {
    ...
    public GetECSServiceRecommendationProjectedMetricsRequest withStartTime(java.util.Date startTime) {
    ...
    public GetECSServiceRecommendationProjectedMetricsRequest withEndTime(java.util.Date endTime) {
        setEndTime(endTime);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetECSServiceRecommendationProjectedMetricsRequest == false)
            return false;
        GetECSServiceRecommendationProjectedMetricsRequest other = (GetECSServiceRecommendationProjectedMetricsRequest) obj;
    ...
    @Override
    public GetECSServiceRecommendationProjectedMetricsRequest clone() {
