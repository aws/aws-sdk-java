 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/compute-optimizer-2019-11-01/EBSSavingsEstimationMode"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EBSSavingsEstimationMode implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EBSSavingsEstimationMode == false)
            return false;
    ...
    public EBSSavingsEstimationMode clone() {
        try {
            return (EBSSavingsEstimationMode) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.computeoptimizer.model.transform.EBSSavingsEstimationModeMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
