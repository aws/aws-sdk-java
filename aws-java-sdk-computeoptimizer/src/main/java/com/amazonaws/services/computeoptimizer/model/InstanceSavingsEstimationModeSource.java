...
public enum InstanceSavingsEstimationModeSource {
     ...
     * @param value
     *        real value
     * @return InstanceSavingsEstimationModeSource corresponding to the value
     *
    ...
    public static InstanceSavingsEstimationModeSource fromValue(String value) {
        ...
        for (InstanceSavingsEstimationModeSource enumEntry : InstanceSavingsEstimationModeSource.values()) {
