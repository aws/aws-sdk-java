...
public class ExportEBSVolumeRecommendationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExportEBSVolumeRecommendationsResult == false)
            return false;
        ExportEBSVolumeRecommendationsResult other = (ExportEBSVolumeRecommendationsResult) obj;
    ...
    public ExportEBSVolumeRecommendationsResult clone() {
        try {
            return (ExportEBSVolumeRecommendationsResult) super.clone();
