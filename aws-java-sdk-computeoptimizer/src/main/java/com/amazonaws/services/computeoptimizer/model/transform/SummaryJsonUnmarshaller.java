...
/**
 * Summary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SummaryJsonUnmarshaller implements Unmarshaller<Summary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    summary.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
