...
/**
 * GetRecommendationSummariesResult JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    getRecommendationSummariesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("recommendationSummaries", targetDepth)) {
                    context.nextToken();
                    getRecommendationSummariesResult.setRecommendationSummaries(new ListUnmarshaller<RecommendationSummary>(
                            RecommendationSummaryJsonUnmarshaller.getInstance()).unmarshall(context));
                }
