...
/**
 * LambdaFunctionMemoryRecommendationOptionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LambdaFunctionMemoryRecommendationOptionMarshaller {
    ...
    public static LambdaFunctionMemoryRecommendationOptionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LambdaFunctionMemoryRecommendationOption lambdaFunctionMemoryRecommendationOption, ProtocolMarshaller protocolMarshaller) {

        if (lambdaFunctionMemoryRecommendationOption == null) {
