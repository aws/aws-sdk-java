 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/compute-optimizer-2019-11-01/ECSEffectiveRecommendationPreferences"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ECSEffectiveRecommendationPreferences implements Serializable, Cloneable, StructuredPojo {

    /**
     * <p>
     * Describes the savings estimation mode preference applied for calculating savings opportunity for Amazon ECS
     * services.
     * </p>
     */
    private ECSSavingsEstimationMode savingsEstimationMode;
    ...
    public ECSSavingsEstimationMode getSavingsEstimationMode() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ECSEffectiveRecommendationPreferences == false)
            return false;
        ECSEffectiveRecommendationPreferences other = (ECSEffectiveRecommendationPreferences) obj;
    ...
    public ECSEffectiveRecommendationPreferences clone() {
        try {
            return (ECSEffectiveRecommendationPreferences) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.computeoptimizer.model.transform.ECSEffectiveRecommendationPreferencesMarshaller.getInstance()
