...
public class ValidationErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ValidationErrorExceptionUnmarshaller instance;

    public static ValidationErrorExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ValidationErrorExceptionUnmarshaller();
        return instance;
    }
}
