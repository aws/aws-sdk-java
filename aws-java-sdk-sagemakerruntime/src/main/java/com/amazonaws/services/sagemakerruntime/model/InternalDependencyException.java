...
public class InternalDependencyException extends com.amazonaws.services.sagemakerruntime.model.AmazonSageMakerRuntimeException {
     ...
     */
    public InternalDependencyException(String message) {
        super(message);
    }
