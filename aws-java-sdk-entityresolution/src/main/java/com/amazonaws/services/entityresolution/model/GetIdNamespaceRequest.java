...
public class GetIdNamespaceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetIdNamespaceRequest withIdNamespaceName(String idNamespaceName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIdNamespaceRequest == false)
            return false;
        GetIdNamespaceRequest other = (GetIdNamespaceRequest) obj;
    ...
    @Override
    public GetIdNamespaceRequest clone() {
        return (GetIdNamespaceRequest) super.clone();
    }
