...
public class ServiceLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceLimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.billingconductor.model.ServiceLimitExceededException.class, "ServiceLimitExceededException");
    }

    @Override
    public com.amazonaws.services.billingconductor.model.ServiceLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.billingconductor.model.ServiceLimitExceededException serviceLimitExceededException = new com.amazonaws.services.billingconductor.model.ServiceLimitExceededException(
                null);
    ...
    private static ServiceLimitExceededExceptionUnmarshaller instance;

    public static ServiceLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ServiceLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
