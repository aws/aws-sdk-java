 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/billingconductor-2021-07-30/ListPricingRulesFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListPricingRulesFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public ListPricingRulesFilter withArns(String... arns) {
        if (this.arns == null) {
    ...
    public ListPricingRulesFilter withArns(java.util.Collection<String> arns) {
        setArns(arns);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPricingRulesFilter == false)
            return false;
    ...
    public ListPricingRulesFilter clone() {
        try {
            return (ListPricingRulesFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.billingconductor.model.transform.ListPricingRulesFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
