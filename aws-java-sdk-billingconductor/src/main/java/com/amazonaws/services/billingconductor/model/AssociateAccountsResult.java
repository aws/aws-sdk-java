...
public class AssociateAccountsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateAccountsResult == false)
            return false;
        AssociateAccountsResult other = (AssociateAccountsResult) obj;
    ...
    public AssociateAccountsResult clone() {
        try {
            return (AssociateAccountsResult) super.clone();
