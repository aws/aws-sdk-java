...
public class CreatePricingRuleRequestMarshaller {
    ...
    public void marshall(CreatePricingRuleRequest createPricingRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createPricingRuleRequest.getUsageType(), USAGETYPE_BINDING);
            protocolMarshaller.marshall(createPricingRuleRequest.getOperation(), OPERATION_BINDING);
        } catch (Exception e) {
