...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.billingconductor.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.billingconductor.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.billingconductor.model.ValidationException validationException = new com.amazonaws.services.billingconductor.model.ValidationException(
                null);
