...
/**
 * DeleteBillingGroupResult JSON Unmarshaller
 */
...
public class DeleteBillingGroupResultJsonUnmarshaller implements Unmarshaller<DeleteBillingGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteBillingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteBillingGroupResult deleteBillingGroupResult = new DeleteBillingGroupResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Arn", targetDepth)) {
                    context.nextToken();
                    deleteBillingGroupResult.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
