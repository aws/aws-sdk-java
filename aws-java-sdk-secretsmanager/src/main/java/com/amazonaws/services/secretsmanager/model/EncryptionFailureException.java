...
/**
 * <p>
 * AWS Secrets Manager can't encrypt the protected secret text using the provided KMS key. Check that the customer
 * master key (CMK) is available, enabled, and not in an invalid state. For more information, see <a
