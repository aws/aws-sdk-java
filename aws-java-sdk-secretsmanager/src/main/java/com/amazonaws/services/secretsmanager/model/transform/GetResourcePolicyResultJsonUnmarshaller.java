        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ARN", targetDepth)) {
                    context.nextToken();
                    getResourcePolicyResult.setARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    getResourcePolicyResult.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ResourcePolicy", targetDepth)) {
                    context.nextToken();
                    getResourcePolicyResult.setResourcePolicy(context.getUnmarshaller(String.class).unmarshall(context));
                }
