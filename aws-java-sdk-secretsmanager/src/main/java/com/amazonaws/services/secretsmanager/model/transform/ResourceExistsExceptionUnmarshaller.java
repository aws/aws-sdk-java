...
public class ResourceExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceExistsExceptionUnmarshaller instance;

    public static ResourceExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceExistsExceptionUnmarshaller();
        return instance;
    }
}
