 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/states-2016-11-23/TaskFailedEventDetails" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TaskFailedEventDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TaskFailedEventDetails == false)
            return false;
        TaskFailedEventDetails other = (TaskFailedEventDetails) obj;
    ...
    @Override
    public TaskFailedEventDetails clone() {
        try {
            return (TaskFailedEventDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.stepfunctions.model.transform.TaskFailedEventDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
