 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/states-2016-11-23/MapRunFailedEventDetails" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MapRunFailedEventDetails implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The error code of the Map Run failure.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MapRunFailedEventDetails == false)
            return false;
        MapRunFailedEventDetails other = (MapRunFailedEventDetails) obj;
    ...
    public MapRunFailedEventDetails clone() {
        try {
            return (MapRunFailedEventDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.stepfunctions.model.transform.MapRunFailedEventDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
