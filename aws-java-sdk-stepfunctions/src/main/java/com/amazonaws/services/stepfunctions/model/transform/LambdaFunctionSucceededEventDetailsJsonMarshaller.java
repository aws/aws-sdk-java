...
public class LambdaFunctionSucceededEventDetailsJsonMarshaller {
     ...
     */
    public void marshall(LambdaFunctionSucceededEventDetails lambdaFunctionSucceededEventDetails, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (lambdaFunctionSucceededEventDetails.getOutput() != null) {
                jsonGenerator.writeFieldName("output").writeValue(lambdaFunctionSucceededEventDetails.getOutput());
            }
