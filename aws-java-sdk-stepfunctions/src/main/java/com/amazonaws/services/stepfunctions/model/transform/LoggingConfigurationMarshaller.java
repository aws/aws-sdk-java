...
public class LoggingConfigurationMarshaller {
    ...
    public void marshall(LoggingConfiguration loggingConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(loggingConfiguration.getLevel(), LEVEL_BINDING);
            protocolMarshaller.marshall(loggingConfiguration.getIncludeExecutionData(), INCLUDEEXECUTIONDATA_BINDING);
            protocolMarshaller.marshall(loggingConfiguration.getDestinations(), DESTINATIONS_BINDING);
        } catch (Exception e) {
