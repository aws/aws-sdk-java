...
public class StateMachineAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.stepfunctions.model.StateMachineAlreadyExistsException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return stateMachineAlreadyExistsException;
    }

    private static StateMachineAlreadyExistsExceptionUnmarshaller instance;

    public static StateMachineAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new StateMachineAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
