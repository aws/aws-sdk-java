...
@SdkInternalApi
public class StateMachineListItemMarshaller {
    ...
    private static final StateMachineListItemMarshaller instance = new StateMachineListItemMarshaller();

    public static StateMachineListItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StateMachineListItem stateMachineListItem, ProtocolMarshaller protocolMarshaller) {
