...
public class InvalidDefinitionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDefinitionExceptionUnmarshaller instance;

    public static InvalidDefinitionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDefinitionExceptionUnmarshaller();
        return instance;
    }
}
