...
public class ListMapRunsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the execution for which the Map Runs must be listed.
     */
    ...
    public ListMapRunsRequest withExecutionArn(String executionArn) {
    ...
    public ListMapRunsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListMapRunsRequest == false)
            return false;
        ListMapRunsRequest other = (ListMapRunsRequest) obj;
    ...
    @Override
    public ListMapRunsRequest clone() {
        return (ListMapRunsRequest) super.clone();
    }
