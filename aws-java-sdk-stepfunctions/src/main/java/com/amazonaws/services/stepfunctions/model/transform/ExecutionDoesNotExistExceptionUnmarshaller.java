...
public class ExecutionDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.stepfunctions.model.ExecutionDoesNotExistException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return executionDoesNotExistException;
    }

    private static ExecutionDoesNotExistExceptionUnmarshaller instance;

    public static ExecutionDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExecutionDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
