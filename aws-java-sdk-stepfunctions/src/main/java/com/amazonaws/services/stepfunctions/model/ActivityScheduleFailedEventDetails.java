...
public class ActivityScheduleFailedEventDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ActivityScheduleFailedEventDetails == false)
            return false;
        ActivityScheduleFailedEventDetails other = (ActivityScheduleFailedEventDetails) obj;
    ...
    public ActivityScheduleFailedEventDetails clone() {
        try {
            return (ActivityScheduleFailedEventDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.stepfunctions.model.transform.ActivityScheduleFailedEventDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
