...
public class GetDeploymentsResultJsonUnmarshaller implements Unmarshaller<GetDeploymentsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Deployments", targetDepth)) {
                    context.nextToken();
                    getDeploymentsResult.setDeployments(new ListUnmarshaller<EdgeDeployment>(EdgeDeploymentJsonUnmarshaller.getInstance())
