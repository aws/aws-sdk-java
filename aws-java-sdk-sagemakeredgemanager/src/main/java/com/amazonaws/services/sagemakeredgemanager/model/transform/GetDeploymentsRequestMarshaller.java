...
public class GetDeploymentsRequestMarshaller {
    ...
    public void marshall(GetDeploymentsRequest getDeploymentsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getDeploymentsRequest.getDeviceName(), DEVICENAME_BINDING);
            protocolMarshaller.marshall(getDeploymentsRequest.getDeviceFleetName(), DEVICEFLEETNAME_BINDING);
        } catch (Exception e) {
