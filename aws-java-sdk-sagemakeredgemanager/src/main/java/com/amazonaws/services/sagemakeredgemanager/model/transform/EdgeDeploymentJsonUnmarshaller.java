...
/**
 * EdgeDeployment JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EdgeDeploymentJsonUnmarshaller implements Unmarshaller<EdgeDeployment, JsonUnmarshallerContext> {

    public EdgeDeployment unmarshall(JsonUnmarshallerContext context) throws Exception {
        EdgeDeployment edgeDeployment = new EdgeDeployment();
    ...
    private static EdgeDeploymentJsonUnmarshaller instance;

    public static EdgeDeploymentJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EdgeDeploymentJsonUnmarshaller();
        return instance;
    }
}
