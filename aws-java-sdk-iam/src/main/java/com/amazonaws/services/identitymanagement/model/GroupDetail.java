...
public class GroupDetail implements Serializable, Cloneable {
    ...
    public void setGroupPolicyList(
        ...
        this.groupPolicyList = new com.amazonaws.internal.SdkInternalList<PolicyDetail>(
                groupPolicyList);
    }
     ...
     * any). Use {@link #setGroupPolicyList(java.util.Collection)} or
     * {@link #withGroupPolicyList(java.util.Collection)} if you want to
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getGroupPolicyList() == null) ? 0 : getGroupPolicyList()
                        .hashCode());
        hashCode = prime
                * hashCode
