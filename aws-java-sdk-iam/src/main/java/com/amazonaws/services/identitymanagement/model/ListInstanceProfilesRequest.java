...
public class ListInstanceProfilesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        end with forward slashes. In addition, it can contain any ASCII character from the ! (<code>\u0021</code>)
     *        through the DEL character (<code>\u007F</code>), including most punctuation characters, digits, and upper
     ...
     *         a string of characters consisting of either a forward slash (/) by itself or a string that must begin and
     *         end with forward slashes. In addition, it can contain any ASCII character from the ! (<code>\u0021</code>
     *         ) through the DEL character (<code>\u007F</code>), including most punctuation characters, digits, and
