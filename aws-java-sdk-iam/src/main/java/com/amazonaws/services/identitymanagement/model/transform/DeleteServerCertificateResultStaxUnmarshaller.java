...
public class DeleteServerCertificateResultStaxUnmarshaller implements Unmarshaller<DeleteServerCertificateResult, StaxUnmarshallerContext> {

    public DeleteServerCertificateResult unmarshall(StaxUnmarshallerContext context) throws Exception {
