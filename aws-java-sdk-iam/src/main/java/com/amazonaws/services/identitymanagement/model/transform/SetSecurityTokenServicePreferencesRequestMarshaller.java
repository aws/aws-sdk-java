...
/**
 * SetSecurityTokenServicePreferencesRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SetSecurityTokenServicePreferencesRequestMarshaller implements
        Marshaller<Request<SetSecurityTokenServicePreferencesRequest>, SetSecurityTokenServicePreferencesRequest> {
    ...
    public Request<SetSecurityTokenServicePreferencesRequest> marshall(SetSecurityTokenServicePreferencesRequest setSecurityTokenServicePreferencesRequest) {
        ...
        Request<SetSecurityTokenServicePreferencesRequest> request = new DefaultRequest<SetSecurityTokenServicePreferencesRequest>(
                setSecurityTokenServicePreferencesRequest, "AmazonIdentityManagement");
