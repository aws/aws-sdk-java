...
public class DeleteRolePolicyRequestMarshaller implements
    ...
    public Request<DeleteRolePolicyRequest> marshall(
        ...
        Request<DeleteRolePolicyRequest> request = new DefaultRequest<DeleteRolePolicyRequest>(
                deleteRolePolicyRequest, "AmazonIdentityManagement");
        ...
        if (deleteRolePolicyRequest.getRoleName() != null) {
            request.addParameter("RoleName", StringUtils
                    .fromString(deleteRolePolicyRequest.getRoleName()));
        }

        if (deleteRolePolicyRequest.getPolicyName() != null) {
            request.addParameter("PolicyName", StringUtils
                    .fromString(deleteRolePolicyRequest.getPolicyName()));
        }
