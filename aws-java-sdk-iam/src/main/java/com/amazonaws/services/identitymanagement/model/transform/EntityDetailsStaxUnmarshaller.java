...
/**
 * EntityDetails StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EntityDetailsStaxUnmarshaller implements Unmarshaller<EntityDetails, StaxUnmarshallerContext> {

    public EntityDetails unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("LastAuthenticated", targetDepth)) {
                    entityDetails.setLastAuthenticated(DateStaxUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                    continue;
                }
