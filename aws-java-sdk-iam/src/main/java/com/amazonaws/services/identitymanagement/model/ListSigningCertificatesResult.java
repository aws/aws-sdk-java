 ...
 * </p>
 */
public class ListSigningCertificatesResult extends
    ...
    public void setCertificates(
        ...
        this.certificates = new com.amazonaws.internal.SdkInternalList<SigningCertificate>(
                certificates);
    }
    ...
    public ListSigningCertificatesResult withCertificates(
        ...
        if (this.certificates == null) {
            setCertificates(new com.amazonaws.internal.SdkInternalList<SigningCertificate>(
                    certificates.length));
        }
