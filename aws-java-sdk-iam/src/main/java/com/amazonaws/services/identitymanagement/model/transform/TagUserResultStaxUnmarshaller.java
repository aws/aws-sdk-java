...
/**
 * TagUserResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TagUserResultStaxUnmarshaller implements Unmarshaller<TagUserResult, StaxUnmarshallerContext> {

    public TagUserResult unmarshall(StaxUnmarshallerContext context) throws Exception {
