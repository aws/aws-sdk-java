 ...
 * 
 */
public class SimulatePrincipalPolicyRequest extends
     ...
     * of the APIs. If you do not specify a <code>CallerArn</code>, it defaults
     * to the ARN of the user that you specify in <code>PolicySourceArn</code>,
