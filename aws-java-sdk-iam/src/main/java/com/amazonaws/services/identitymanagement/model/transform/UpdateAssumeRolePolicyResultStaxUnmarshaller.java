 ...
 */
public class UpdateAssumeRolePolicyResultStaxUnmarshaller implements
        Unmarshaller<UpdateAssumeRolePolicyResult, StaxUnmarshallerContext> {

    public UpdateAssumeRolePolicyResult unmarshall(
