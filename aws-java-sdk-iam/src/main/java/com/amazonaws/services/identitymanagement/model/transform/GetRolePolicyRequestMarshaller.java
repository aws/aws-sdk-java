...
public class GetRolePolicyRequestMarshaller implements
    ...
    public Request<GetRolePolicyRequest> marshall(
        ...
        Request<GetRolePolicyRequest> request = new DefaultRequest<GetRolePolicyRequest>(
                getRolePolicyRequest, "AmazonIdentityManagement");
        ...
        if (getRolePolicyRequest.getRoleName() != null) {
            request.addParameter("RoleName",
                    StringUtils.fromString(getRolePolicyRequest.getRoleName()));
        }

        if (getRolePolicyRequest.getPolicyName() != null) {
            request.addParameter("PolicyName", StringUtils
                    .fromString(getRolePolicyRequest.getPolicyName()));
        }
