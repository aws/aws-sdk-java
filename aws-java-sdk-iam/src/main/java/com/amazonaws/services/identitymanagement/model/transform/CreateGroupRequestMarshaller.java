...
public class CreateGroupRequestMarshaller implements
    ...
    public Request<CreateGroupRequest> marshall(
        ...
        Request<CreateGroupRequest> request = new DefaultRequest<CreateGroupRequest>(
                createGroupRequest, "AmazonIdentityManagement");
        ...
        if (createGroupRequest.getPath() != null) {
            request.addParameter("Path",
                    StringUtils.fromString(createGroupRequest.getPath()));
        }

        if (createGroupRequest.getGroupName() != null) {
            request.addParameter("GroupName",
                    StringUtils.fromString(createGroupRequest.getGroupName()));
        }
