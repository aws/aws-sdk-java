 ...
 */
public class UpdateSigningCertificateResultStaxUnmarshaller implements
        Unmarshaller<UpdateSigningCertificateResult, StaxUnmarshallerContext> {

    public UpdateSigningCertificateResult unmarshall(
