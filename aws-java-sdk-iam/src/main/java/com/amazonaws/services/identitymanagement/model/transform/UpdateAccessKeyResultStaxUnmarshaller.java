...
public class UpdateAccessKeyResultStaxUnmarshaller implements Unmarshaller<UpdateAccessKeyResult, StaxUnmarshallerContext> {

    public UpdateAccessKeyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
