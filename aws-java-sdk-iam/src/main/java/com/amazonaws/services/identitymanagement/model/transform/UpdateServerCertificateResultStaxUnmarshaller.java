 ...
 */
public class UpdateServerCertificateResultStaxUnmarshaller implements
        Unmarshaller<UpdateServerCertificateResult, StaxUnmarshallerContext> {

    public UpdateServerCertificateResult unmarshall(
