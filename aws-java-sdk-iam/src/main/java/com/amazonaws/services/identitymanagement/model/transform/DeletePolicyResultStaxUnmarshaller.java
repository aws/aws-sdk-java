...
public class DeletePolicyResultStaxUnmarshaller implements Unmarshaller<DeletePolicyResult, StaxUnmarshallerContext> {

    public DeletePolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
