...
public class DeleteSigningCertificateRequestMarshaller
    ...
    public Request<DeleteSigningCertificateRequest> marshall(
        ...
        Request<DeleteSigningCertificateRequest> request = new DefaultRequest<DeleteSigningCertificateRequest>(
                deleteSigningCertificateRequest, "AmazonIdentityManagement");
        ...
        if (deleteSigningCertificateRequest.getUserName() != null) {
            request.addParameter("UserName", StringUtils
                    .fromString(deleteSigningCertificateRequest.getUserName()));
        }

        if (deleteSigningCertificateRequest.getCertificateId() != null) {
            request.addParameter("CertificateId", StringUtils
                    .fromString(deleteSigningCertificateRequest
                            .getCertificateId()));
        }
