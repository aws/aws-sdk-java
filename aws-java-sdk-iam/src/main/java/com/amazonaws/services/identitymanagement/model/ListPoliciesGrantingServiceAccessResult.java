...
public class ListPoliciesGrantingServiceAccessResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<ListPoliciesGrantingServiceAccessEntry> policiesGrantingServiceAccess;
    /**
     * <p>
    ...
    public java.util.List<ListPoliciesGrantingServiceAccessEntry> getPoliciesGrantingServiceAccess() {
        if (policiesGrantingServiceAccess == null) {
            policiesGrantingServiceAccess = new com.amazonaws.internal.SdkInternalList<ListPoliciesGrantingServiceAccessEntry>();
        }
    ...
    public void setPoliciesGrantingServiceAccess(java.util.Collection<ListPoliciesGrantingServiceAccessEntry> policiesGrantingServiceAccess) {
        if (policiesGrantingServiceAccess == null) {
            this.policiesGrantingServiceAccess = null;
            return;
        }

        this.policiesGrantingServiceAccess = new com.amazonaws.internal.SdkInternalList<ListPoliciesGrantingServiceAccessEntry>(policiesGrantingServiceAccess);
    }
     ...
     *        a subsequent pagination request using the <code>Marker</code> request parameter to retrieve more items. We
