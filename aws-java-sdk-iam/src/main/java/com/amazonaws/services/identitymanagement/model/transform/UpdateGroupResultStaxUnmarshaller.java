...
public class UpdateGroupResultStaxUnmarshaller implements Unmarshaller<UpdateGroupResult, StaxUnmarshallerContext> {

    public UpdateGroupResult unmarshall(StaxUnmarshallerContext context) throws Exception {
