...
public class DeleteGroupResultStaxUnmarshaller implements Unmarshaller<DeleteGroupResult, StaxUnmarshallerContext> {

    public DeleteGroupResult unmarshall(StaxUnmarshallerContext context) throws Exception {
