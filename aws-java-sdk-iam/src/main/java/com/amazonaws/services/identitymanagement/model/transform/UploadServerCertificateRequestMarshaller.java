...
public class UploadServerCertificateRequestMarshaller
    ...
    public Request<UploadServerCertificateRequest> marshall(
        ...
        Request<UploadServerCertificateRequest> request = new DefaultRequest<UploadServerCertificateRequest>(
                uploadServerCertificateRequest, "AmazonIdentityManagement");
        ...
        if (uploadServerCertificateRequest.getPrivateKey() != null) {
            request.addParameter("PrivateKey", StringUtils
                    .fromString(uploadServerCertificateRequest.getPrivateKey()));
        }

        if (uploadServerCertificateRequest.getCertificateChain() != null) {
            request.addParameter("CertificateChain", StringUtils
                    .fromString(uploadServerCertificateRequest
                            .getCertificateChain()));
        }
