...
/**
 * Container for the parameters to the {@link com.amazonaws.services.identitymanagement.AmazonIdentityManagement#attachGroupPolicy(AttachGroupPolicyRequest) AttachGroupPolicy operation}.
 * <p>
...
public class AttachGroupPolicyRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <b>Pattern: </b>[\w+=,.@-]+<br/>
     *
     * @return The name (friendly name, not ARN) of the group to attach the policy
     *         to.
     */
     ...
     * <b>Pattern: </b>[\w+=,.@-]+<br/>
     *
     * @param groupName The name (friendly name, not ARN) of the group to attach the policy
     *         to.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttachGroupPolicyRequest == false) return false;
