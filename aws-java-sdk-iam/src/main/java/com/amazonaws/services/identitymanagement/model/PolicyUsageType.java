...
/**
 * <p>
 * The policy usage type that indicates whether the policy is used as a permissions policy or as the permissions
...
public enum PolicyUsageType {
     ...
     * @param value
     *        real value
     * @return PolicyUsageType corresponding to the value
     *
    ...
    public static PolicyUsageType fromValue(String value) {
        ...
        for (PolicyUsageType enumEntry : PolicyUsageType.values()) {
