 ...
 */
public class ListInstanceProfilesResultStaxUnmarshaller implements
        Unmarshaller<ListInstanceProfilesResult, StaxUnmarshallerContext> {
    ...
    public ListInstanceProfilesResult unmarshall(StaxUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("InstanceProfiles/member",
                        targetDepth)) {
                    listInstanceProfilesResult.getInstanceProfiles().add(
                            InstanceProfileStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    listInstanceProfilesResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
