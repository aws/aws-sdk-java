...
/**
 * Container for the parameters to the {@link com.amazonaws.services.identitymanagement.AmazonIdentityManagement#detachRolePolicy(DetachRolePolicyRequest) DetachRolePolicy operation}.
 * <p>
...
public class DetachRolePolicyRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <b>Pattern: </b>[\w+=,.@-]+<br/>
     *
     * @return The name (friendly name, not ARN) of the role to detach the policy
     *         from.
     */
     ...
     * <b>Pattern: </b>[\w+=,.@-]+<br/>
     *
     * @param roleName The name (friendly name, not ARN) of the role to detach the policy
     *         from.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DetachRolePolicyRequest == false) return false;
