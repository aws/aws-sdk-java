...
/**
 * RemoveUserFromGroupRequest Marshaller
 */
...
public class RemoveUserFromGroupRequestMarshaller
    ...
    public Request<RemoveUserFromGroupRequest> marshall(
        ...
        Request<RemoveUserFromGroupRequest> request = new DefaultRequest<RemoveUserFromGroupRequest>(
                removeUserFromGroupRequest, "AmazonIdentityManagement");
        ...
        if (removeUserFromGroupRequest.getGroupName() != null) {
            request.addParameter("GroupName", StringUtils
                    .fromString(removeUserFromGroupRequest.getGroupName()));
        }

        if (removeUserFromGroupRequest.getUserName() != null) {
            request.addParameter("UserName", StringUtils
                    .fromString(removeUserFromGroupRequest.getUserName()));
        }
