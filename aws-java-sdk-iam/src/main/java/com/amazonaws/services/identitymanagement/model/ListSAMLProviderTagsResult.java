...
public class ListSAMLProviderTagsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The list of tags that are currently attached to the Security Assertion Markup Language (SAML) identity provider.
     * Each tag consists of a key name and an associated value. If no tags are attached to the specified resource, the
     ...
     * </p>
     * 
     * @return The list of tags that are currently attached to the Security Assertion Markup Language (SAML) identity
     *         provider. Each tag consists of a key name and an associated value. If no tags are attached to the
     ...
     * 
     * @param tags
     *        The list of tags that are currently attached to the Security Assertion Markup Language (SAML) identity
     *        provider. Each tag consists of a key name and an associated value. If no tags are attached to the
     *        specified resource, the response contains an empty list.
     */
    ...
    public ListSAMLProviderTagsResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public ListSAMLProviderTagsResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public ListSAMLProviderTagsResult withIsTruncated(Boolean isTruncated) {
    ...
    public ListSAMLProviderTagsResult withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSAMLProviderTagsResult == false)
            return false;
        ListSAMLProviderTagsResult other = (ListSAMLProviderTagsResult) obj;
    ...
    @Override
    public ListSAMLProviderTagsResult clone() {
        try {
            return (ListSAMLProviderTagsResult) super.clone();
