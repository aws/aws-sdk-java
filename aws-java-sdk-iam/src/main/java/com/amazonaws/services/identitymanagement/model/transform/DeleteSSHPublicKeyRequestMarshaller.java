...
public class DeleteSSHPublicKeyRequestMarshaller
    ...
    public Request<DeleteSSHPublicKeyRequest> marshall(
        ...
        Request<DeleteSSHPublicKeyRequest> request = new DefaultRequest<DeleteSSHPublicKeyRequest>(
                deleteSSHPublicKeyRequest, "AmazonIdentityManagement");
        ...
        if (deleteSSHPublicKeyRequest.getUserName() != null) {
            request.addParameter("UserName", StringUtils
                    .fromString(deleteSSHPublicKeyRequest.getUserName()));
        }

        if (deleteSSHPublicKeyRequest.getSSHPublicKeyId() != null) {
            request.addParameter("SSHPublicKeyId", StringUtils
                    .fromString(deleteSSHPublicKeyRequest.getSSHPublicKeyId()));
        }
