...
public class DeletePolicyVersionResultStaxUnmarshaller implements Unmarshaller<DeletePolicyVersionResult, StaxUnmarshallerContext> {

    public DeletePolicyVersionResult unmarshall(StaxUnmarshallerContext context) throws Exception {
