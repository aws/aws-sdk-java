...
/**
 * Add Client I D To Open I D Connect Provider Request Marshaller
 */
public class AddClientIDToOpenIDConnectProviderRequestMarshaller implements Marshaller<Request<AddClientIDToOpenIDConnectProviderRequest>, AddClientIDToOpenIDConnectProviderRequest> {
    ...
    public Request<AddClientIDToOpenIDConnectProviderRequest> marshall(AddClientIDToOpenIDConnectProviderRequest addClientIDToOpenIDConnectProviderRequest) {
        ...
        Request<AddClientIDToOpenIDConnectProviderRequest> request = new DefaultRequest<AddClientIDToOpenIDConnectProviderRequest>(addClientIDToOpenIDConnectProviderRequest, "AmazonIdentityManagement");
