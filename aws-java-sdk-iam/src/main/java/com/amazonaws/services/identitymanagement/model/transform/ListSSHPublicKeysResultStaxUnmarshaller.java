 ...
 */
public class ListSSHPublicKeysResultStaxUnmarshaller implements
        Unmarshaller<ListSSHPublicKeysResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("SSHPublicKeys/member", targetDepth)) {
                    listSSHPublicKeysResult.getSSHPublicKeys().add(
                            SSHPublicKeyMetadataStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    listSSHPublicKeysResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
