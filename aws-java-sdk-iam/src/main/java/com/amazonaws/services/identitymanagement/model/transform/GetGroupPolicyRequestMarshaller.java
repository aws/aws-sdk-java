...
public class GetGroupPolicyRequestMarshaller implements
    ...
    public Request<GetGroupPolicyRequest> marshall(
        ...
        Request<GetGroupPolicyRequest> request = new DefaultRequest<GetGroupPolicyRequest>(
                getGroupPolicyRequest, "AmazonIdentityManagement");
        ...
        if (getGroupPolicyRequest.getGroupName() != null) {
            request.addParameter("GroupName", StringUtils
                    .fromString(getGroupPolicyRequest.getGroupName()));
        }

        if (getGroupPolicyRequest.getPolicyName() != null) {
            request.addParameter("PolicyName", StringUtils
                    .fromString(getGroupPolicyRequest.getPolicyName()));
        }
