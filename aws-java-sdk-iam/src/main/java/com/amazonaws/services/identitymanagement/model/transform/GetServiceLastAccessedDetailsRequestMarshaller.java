...
/**
 * GetServiceLastAccessedDetailsRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetServiceLastAccessedDetailsRequestMarshaller implements
    ...
    public Request<GetServiceLastAccessedDetailsRequest> marshall(GetServiceLastAccessedDetailsRequest getServiceLastAccessedDetailsRequest) {
        ...
        Request<GetServiceLastAccessedDetailsRequest> request = new DefaultRequest<GetServiceLastAccessedDetailsRequest>(getServiceLastAccessedDetailsRequest,
