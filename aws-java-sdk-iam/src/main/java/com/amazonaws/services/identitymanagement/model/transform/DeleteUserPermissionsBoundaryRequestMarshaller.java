...
/**
 * DeleteUserPermissionsBoundaryRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteUserPermissionsBoundaryRequestMarshaller implements
        Marshaller<Request<DeleteUserPermissionsBoundaryRequest>, DeleteUserPermissionsBoundaryRequest> {
    ...
    public Request<DeleteUserPermissionsBoundaryRequest> marshall(DeleteUserPermissionsBoundaryRequest deleteUserPermissionsBoundaryRequest) {
        ...
        Request<DeleteUserPermissionsBoundaryRequest> request = new DefaultRequest<DeleteUserPermissionsBoundaryRequest>(deleteUserPermissionsBoundaryRequest,
