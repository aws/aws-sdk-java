...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/ListServerCertificateTags" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListServerCertificateTagsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The list of tags that are currently attached to the IAM server certificate. Each tag consists of a key name and
     * an associated value. If no tags are attached to the specified resource, the response contains an empty list.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The list of tags that are currently attached to the IAM server certificate. Each tag consists of a key
     *         name and an associated value. If no tags are attached to the specified resource, the response contains an
     *         empty list.
     */
     ...
     * 
     * @param tags
     *        The list of tags that are currently attached to the IAM server certificate. Each tag consists of a key
     *        name and an associated value. If no tags are attached to the specified resource, the response contains an
     *        empty list.
     */
    ...
    public ListServerCertificateTagsResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public ListServerCertificateTagsResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public ListServerCertificateTagsResult withIsTruncated(Boolean isTruncated) {
    ...
    public ListServerCertificateTagsResult withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListServerCertificateTagsResult == false)
            return false;
        ListServerCertificateTagsResult other = (ListServerCertificateTagsResult) obj;
    ...
    @Override
    public ListServerCertificateTagsResult clone() {
        try {
            return (ListServerCertificateTagsResult) super.clone();
