...
public class DeleteSAMLProviderRequestMarshaller
        implements
        Marshaller<Request<DeleteSAMLProviderRequest>, DeleteSAMLProviderRequest> {

    public Request<DeleteSAMLProviderRequest> marshall(
        ...
        Request<DeleteSAMLProviderRequest> request = new DefaultRequest<DeleteSAMLProviderRequest>(
                deleteSAMLProviderRequest, "AmazonIdentityManagement");
        ...
        if (deleteSAMLProviderRequest.getSAMLProviderArn() != null) {
            request.addParameter("SAMLProviderArn", StringUtils
                    .fromString(deleteSAMLProviderRequest.getSAMLProviderArn()));
        }
