...
/**
 * ServiceLastAccessed StAX Unmarshaller
 */
...
public class ServiceLastAccessedStaxUnmarshaller implements Unmarshaller<ServiceLastAccessed, StaxUnmarshallerContext> {
    ...
    public ServiceLastAccessed unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ServiceName", targetDepth)) {
                    serviceLastAccessed.setServiceName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("LastAuthenticated", targetDepth)) {
                    serviceLastAccessed.setLastAuthenticated(DateStaxUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                    continue;
                }

                if (context.testExpression("ServiceNamespace", targetDepth)) {
                    serviceLastAccessed.setServiceNamespace(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("LastAuthenticatedEntity", targetDepth)) {
                    serviceLastAccessed.setLastAuthenticatedEntity(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
