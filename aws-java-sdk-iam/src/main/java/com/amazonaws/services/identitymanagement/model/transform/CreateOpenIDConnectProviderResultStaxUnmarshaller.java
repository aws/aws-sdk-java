...
public class CreateOpenIDConnectProviderResultStaxUnmarshaller
        implements
        Unmarshaller<CreateOpenIDConnectProviderResult, StaxUnmarshallerContext> {

    public CreateOpenIDConnectProviderResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("OpenIDConnectProviderArn",
                        targetDepth)) {
                    createOpenIDConnectProviderResult
                            .setOpenIDConnectProviderArn(StringStaxUnmarshaller
