...
public class AddRoleToInstanceProfileRequestMarshaller
    ...
    public Request<AddRoleToInstanceProfileRequest> marshall(
        ...
        Request<AddRoleToInstanceProfileRequest> request = new DefaultRequest<AddRoleToInstanceProfileRequest>(
                addRoleToInstanceProfileRequest, "AmazonIdentityManagement");
        ...
        if (addRoleToInstanceProfileRequest.getInstanceProfileName() != null) {
            request.addParameter("InstanceProfileName", StringUtils
                    .fromString(addRoleToInstanceProfileRequest
                            .getInstanceProfileName()));
        }

        if (addRoleToInstanceProfileRequest.getRoleName() != null) {
            request.addParameter("RoleName", StringUtils
                    .fromString(addRoleToInstanceProfileRequest.getRoleName()));
        }
