 ...
 * 
 */
public class CreateOpenIDConnectProviderRequest extends
     ...
     * should correspond to the <code>iss</code> claim in the provider's OpenID
     ...
     * <code>CreateOpenIDConnectProviderRequest</code> action accepts client IDs
     ...
     *        "https://" and should correspond to the <code>iss</code> claim in
     ...
     * </p>
     * 
     * @return The URL of the identity provider. The URL must begin with
     *         "https://" and should correspond to the <code>iss</code> claim in
     *         the provider's OpenID Connect ID tokens. Per the OIDC standard,
     *         path components are allowed but query parameters are not.
     *         Typically the URL consists of only a host name, like
     ...
     * </p>
     * 
     * @return A list of client IDs (also known as audiences). When a mobile or
     ...
     *        You can register multiple client IDs with the same provider. For
     *        example, you might have multiple applications that use the same
     *        OIDC provider. You cannot register more than 100 client IDs with a
     ...
     * </p>
     * 
     * @return A list of server certificate thumbprints for the OpenID Connect
