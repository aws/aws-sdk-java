...
public class PutRolePolicyResultStaxUnmarshaller implements Unmarshaller<PutRolePolicyResult, StaxUnmarshallerContext> {

    public PutRolePolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
