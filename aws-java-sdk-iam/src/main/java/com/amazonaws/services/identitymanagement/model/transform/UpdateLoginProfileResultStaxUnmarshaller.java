...
public class UpdateLoginProfileResultStaxUnmarshaller implements Unmarshaller<UpdateLoginProfileResult, StaxUnmarshallerContext> {

    public UpdateLoginProfileResult unmarshall(StaxUnmarshallerContext context) throws Exception {
