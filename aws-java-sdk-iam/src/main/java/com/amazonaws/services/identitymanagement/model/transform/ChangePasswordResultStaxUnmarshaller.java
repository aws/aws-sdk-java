...
public class ChangePasswordResultStaxUnmarshaller implements Unmarshaller<ChangePasswordResult, StaxUnmarshallerContext> {

    public ChangePasswordResult unmarshall(StaxUnmarshallerContext context) throws Exception {
