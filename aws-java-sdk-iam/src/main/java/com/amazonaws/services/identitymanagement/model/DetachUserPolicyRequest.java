...
/**
 * Container for the parameters to the {@link com.amazonaws.services.identitymanagement.AmazonIdentityManagement#detachUserPolicy(DetachUserPolicyRequest) DetachUserPolicy operation}.
 * <p>
...
public class DetachUserPolicyRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <b>Pattern: </b>[\w+=,.@-]+<br/>
     *
     * @return The name (friendly name, not ARN) of the user to detach the policy
     *         from.
     */
     ...
     * <b>Pattern: </b>[\w+=,.@-]+<br/>
     *
     * @param userName The name (friendly name, not ARN) of the user to detach the policy
     *         from.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DetachUserPolicyRequest == false) return false;
