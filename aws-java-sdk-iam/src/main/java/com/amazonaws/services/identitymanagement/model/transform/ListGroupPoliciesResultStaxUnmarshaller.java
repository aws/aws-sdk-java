 ...
 */
public class ListGroupPoliciesResultStaxUnmarshaller implements
        Unmarshaller<ListGroupPoliciesResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("PolicyNames/member", targetDepth)) {
                    listGroupPoliciesResult.getPolicyNames().add(
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    listGroupPoliciesResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
