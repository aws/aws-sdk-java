...
/**
 * Create Policy Version Result StAX Unmarshaller
 */
public class CreatePolicyVersionResultStaxUnmarshaller implements Unmarshaller<CreatePolicyVersionResult, StaxUnmarshallerContext> {
    ...
    public CreatePolicyVersionResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createPolicyVersionResult;
    ...
    public static CreatePolicyVersionResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreatePolicyVersionResultStaxUnmarshaller();
        return instance;
    }
}
