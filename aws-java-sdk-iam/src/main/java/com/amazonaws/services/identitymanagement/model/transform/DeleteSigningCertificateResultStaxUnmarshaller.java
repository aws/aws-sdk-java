...
public class DeleteSigningCertificateResultStaxUnmarshaller implements Unmarshaller<DeleteSigningCertificateResult, StaxUnmarshallerContext> {

    public DeleteSigningCertificateResult unmarshall(StaxUnmarshallerContext context) throws Exception {
