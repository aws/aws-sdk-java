 ...
 */
public class ListAttachedUserPoliciesResultStaxUnmarshaller implements
        Unmarshaller<ListAttachedUserPoliciesResult, StaxUnmarshallerContext> {

    public ListAttachedUserPoliciesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("AttachedPolicies/member",
                        targetDepth)) {
                    listAttachedUserPoliciesResult.getAttachedPolicies().add(
