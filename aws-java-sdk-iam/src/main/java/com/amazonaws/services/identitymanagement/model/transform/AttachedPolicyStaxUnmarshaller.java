 ...
 */
public class AttachedPolicyStaxUnmarshaller implements
        Unmarshaller<AttachedPolicy, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("PolicyName", targetDepth)) {
                    attachedPolicy.setPolicyName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("PolicyArn", targetDepth)) {
                    attachedPolicy.setPolicyArn(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
