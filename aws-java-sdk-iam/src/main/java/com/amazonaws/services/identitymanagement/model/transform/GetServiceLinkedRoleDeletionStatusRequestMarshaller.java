...
/**
 * GetServiceLinkedRoleDeletionStatusRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetServiceLinkedRoleDeletionStatusRequestMarshaller implements
        Marshaller<Request<GetServiceLinkedRoleDeletionStatusRequest>, GetServiceLinkedRoleDeletionStatusRequest> {
    ...
    public Request<GetServiceLinkedRoleDeletionStatusRequest> marshall(GetServiceLinkedRoleDeletionStatusRequest getServiceLinkedRoleDeletionStatusRequest) {
        ...
        Request<GetServiceLinkedRoleDeletionStatusRequest> request = new DefaultRequest<GetServiceLinkedRoleDeletionStatusRequest>(
                getServiceLinkedRoleDeletionStatusRequest, "AmazonIdentityManagement");
