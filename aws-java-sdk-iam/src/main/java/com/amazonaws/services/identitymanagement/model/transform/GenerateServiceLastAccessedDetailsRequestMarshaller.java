...
/**
 * GenerateServiceLastAccessedDetailsRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GenerateServiceLastAccessedDetailsRequestMarshaller implements
    ...
    public Request<GenerateServiceLastAccessedDetailsRequest> marshall(GenerateServiceLastAccessedDetailsRequest generateServiceLastAccessedDetailsRequest) {
        ...
        Request<GenerateServiceLastAccessedDetailsRequest> request = new DefaultRequest<GenerateServiceLastAccessedDetailsRequest>(
                generateServiceLastAccessedDetailsRequest, "AmazonIdentityManagement");
