...
public class DeleteSAMLProviderResultStaxUnmarshaller implements Unmarshaller<DeleteSAMLProviderResult, StaxUnmarshallerContext> {

    public DeleteSAMLProviderResult unmarshall(StaxUnmarshallerContext context) throws Exception {
