...
public class AttachUserPolicyResultStaxUnmarshaller implements Unmarshaller<AttachUserPolicyResult, StaxUnmarshallerContext> {

    public AttachUserPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
