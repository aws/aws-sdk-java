...
/**
 * Detach User Policy Request Marshaller
 */
public class DetachUserPolicyRequestMarshaller implements Marshaller<Request<DetachUserPolicyRequest>, DetachUserPolicyRequest> {
    ...
    public Request<DetachUserPolicyRequest> marshall(DetachUserPolicyRequest detachUserPolicyRequest) {
        ...
        Request<DetachUserPolicyRequest> request = new DefaultRequest<DetachUserPolicyRequest>(detachUserPolicyRequest, "AmazonIdentityManagement");
