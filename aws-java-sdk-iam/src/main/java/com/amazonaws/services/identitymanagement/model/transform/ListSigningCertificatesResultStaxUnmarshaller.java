 ...
 */
public class ListSigningCertificatesResultStaxUnmarshaller implements
        Unmarshaller<ListSigningCertificatesResult, StaxUnmarshallerContext> {

    public ListSigningCertificatesResult unmarshall(
