 ...
 */
public class GetLoginProfileResultStaxUnmarshaller implements
        Unmarshaller<GetLoginProfileResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("LoginProfile", targetDepth)) {
                    getLoginProfileResult
                            .setLoginProfile(LoginProfileStaxUnmarshaller
