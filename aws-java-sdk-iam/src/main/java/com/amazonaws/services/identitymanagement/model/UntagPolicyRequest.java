...
public class UntagPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UntagPolicyRequest withTagKeys(java.util.Collection<String> tagKeys) {
        setTagKeys(tagKeys);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UntagPolicyRequest == false)
            return false;
        UntagPolicyRequest other = (UntagPolicyRequest) obj;
    ...
    @Override
    public UntagPolicyRequest clone() {
        return (UntagPolicyRequest) super.clone();
    }
