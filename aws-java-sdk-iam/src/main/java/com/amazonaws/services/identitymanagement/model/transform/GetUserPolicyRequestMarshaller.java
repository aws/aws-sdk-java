...
public class GetUserPolicyRequestMarshaller implements
    ...
    public Request<GetUserPolicyRequest> marshall(
        ...
        Request<GetUserPolicyRequest> request = new DefaultRequest<GetUserPolicyRequest>(
                getUserPolicyRequest, "AmazonIdentityManagement");
        ...
        if (getUserPolicyRequest.getUserName() != null) {
            request.addParameter("UserName",
                    StringUtils.fromString(getUserPolicyRequest.getUserName()));
        }

        if (getUserPolicyRequest.getPolicyName() != null) {
            request.addParameter("PolicyName", StringUtils
                    .fromString(getUserPolicyRequest.getPolicyName()));
        }
