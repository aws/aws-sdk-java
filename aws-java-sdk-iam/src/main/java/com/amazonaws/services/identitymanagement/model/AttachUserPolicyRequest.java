...
public class AttachUserPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param userName
     *        The name (friendly name, not ARN) of the IAM user to attach the policy to.</p>
     *        <p>
     ...
     * </p>
     * 
     * @return The name (friendly name, not ARN) of the IAM user to attach the policy to.</p>
     *         <p>
     *         This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string
     *         of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also
     *         include any of the following characters: _+=,.@-
