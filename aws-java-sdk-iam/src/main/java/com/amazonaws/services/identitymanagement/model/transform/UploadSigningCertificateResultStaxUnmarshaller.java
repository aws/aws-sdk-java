 ...
 */
public class UploadSigningCertificateResultStaxUnmarshaller implements
        Unmarshaller<UploadSigningCertificateResult, StaxUnmarshallerContext> {

    public UploadSigningCertificateResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Certificate", targetDepth)) {
                    uploadSigningCertificateResult
                            .setCertificate(SigningCertificateStaxUnmarshaller
