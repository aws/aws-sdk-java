...
/**
 * Get Open I D Connect Provider Request Marshaller
 */
public class GetOpenIDConnectProviderRequestMarshaller implements Marshaller<Request<GetOpenIDConnectProviderRequest>, GetOpenIDConnectProviderRequest> {
    ...
    public Request<GetOpenIDConnectProviderRequest> marshall(GetOpenIDConnectProviderRequest getOpenIDConnectProviderRequest) {
        ...
        Request<GetOpenIDConnectProviderRequest> request = new DefaultRequest<GetOpenIDConnectProviderRequest>(getOpenIDConnectProviderRequest, "AmazonIdentityManagement");
