...
/**
 * TrackedActionLastAccessed StAX Unmarshaller
 */
...
public class TrackedActionLastAccessedStaxUnmarshaller implements Unmarshaller<TrackedActionLastAccessed, StaxUnmarshallerContext> {
    ...
    public TrackedActionLastAccessed unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ActionName", targetDepth)) {
                    trackedActionLastAccessed.setActionName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("LastAccessedEntity", targetDepth)) {
                    trackedActionLastAccessed.setLastAccessedEntity(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("LastAccessedTime", targetDepth)) {
                    trackedActionLastAccessed.setLastAccessedTime(DateStaxUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                    continue;
                }

                if (context.testExpression("LastAccessedRegion", targetDepth)) {
                    trackedActionLastAccessed.setLastAccessedRegion(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
