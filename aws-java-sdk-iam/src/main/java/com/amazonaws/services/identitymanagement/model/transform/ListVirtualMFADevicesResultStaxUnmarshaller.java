...
public class ListVirtualMFADevicesResultStaxUnmarshaller implements
    ...
    public ListVirtualMFADevicesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("VirtualMFADevices/member",
                        targetDepth)) {
                    listVirtualMFADevicesResult.getVirtualMFADevices().add(
                            VirtualMFADeviceStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
