...
/**
 * Get Account Authorization Details Request Marshaller
 */
public class GetAccountAuthorizationDetailsRequestMarshaller implements Marshaller<Request<GetAccountAuthorizationDetailsRequest>, GetAccountAuthorizationDetailsRequest> {
    ...
    public Request<GetAccountAuthorizationDetailsRequest> marshall(GetAccountAuthorizationDetailsRequest getAccountAuthorizationDetailsRequest) {
        ...
        Request<GetAccountAuthorizationDetailsRequest> request = new DefaultRequest<GetAccountAuthorizationDetailsRequest>(getAccountAuthorizationDetailsRequest, "AmazonIdentityManagement");
        request.addParameter("Action", "GetAccountAuthorizationDetails");
        request.addParameter("Version", "2010-05-08");

        java.util.List<String> filterList = getAccountAuthorizationDetailsRequest.getFilter();
