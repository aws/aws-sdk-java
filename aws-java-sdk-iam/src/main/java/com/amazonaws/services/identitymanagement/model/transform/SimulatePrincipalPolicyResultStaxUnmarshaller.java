 ...
 */
public class SimulatePrincipalPolicyResultStaxUnmarshaller implements
        Unmarshaller<SimulatePrincipalPolicyResult, StaxUnmarshallerContext> {

    public SimulatePrincipalPolicyResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("EvaluationResults/member",
                        targetDepth)) {
                    simulatePrincipalPolicyResult.getEvaluationResults().add(
                            EvaluationResultStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
