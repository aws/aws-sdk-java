...
public class DeactivateMFADeviceRequestMarshaller
    ...
    public Request<DeactivateMFADeviceRequest> marshall(
        ...
        Request<DeactivateMFADeviceRequest> request = new DefaultRequest<DeactivateMFADeviceRequest>(
                deactivateMFADeviceRequest, "AmazonIdentityManagement");
        ...
        if (deactivateMFADeviceRequest.getUserName() != null) {
            request.addParameter("UserName", StringUtils
                    .fromString(deactivateMFADeviceRequest.getUserName()));
        }

        if (deactivateMFADeviceRequest.getSerialNumber() != null) {
            request.addParameter("SerialNumber", StringUtils
                    .fromString(deactivateMFADeviceRequest.getSerialNumber()));
        }
