...
public class UpdateUserRequestMarshaller implements
    ...
    public Request<UpdateUserRequest> marshall(
        ...
        Request<UpdateUserRequest> request = new DefaultRequest<UpdateUserRequest>(
                updateUserRequest, "AmazonIdentityManagement");
        ...
        if (updateUserRequest.getUserName() != null) {
            request.addParameter("UserName",
                    StringUtils.fromString(updateUserRequest.getUserName()));
        }

        if (updateUserRequest.getNewPath() != null) {
            request.addParameter("NewPath",
                    StringUtils.fromString(updateUserRequest.getNewPath()));
        }

        if (updateUserRequest.getNewUserName() != null) {
            request.addParameter("NewUserName",
                    StringUtils.fromString(updateUserRequest.getNewUserName()));
        }
