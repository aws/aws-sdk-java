...
public class AttachGroupPolicyResultStaxUnmarshaller implements Unmarshaller<AttachGroupPolicyResult, StaxUnmarshallerContext> {

    public AttachGroupPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
