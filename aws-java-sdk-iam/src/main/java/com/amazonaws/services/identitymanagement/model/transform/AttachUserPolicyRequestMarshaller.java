...
public class AttachUserPolicyRequestMarshaller implements
    ...
    public Request<AttachUserPolicyRequest> marshall(
        ...
        Request<AttachUserPolicyRequest> request = new DefaultRequest<AttachUserPolicyRequest>(
                attachUserPolicyRequest, "AmazonIdentityManagement");
        ...
        if (attachUserPolicyRequest.getUserName() != null) {
            request.addParameter("UserName", StringUtils
                    .fromString(attachUserPolicyRequest.getUserName()));
        }

        if (attachUserPolicyRequest.getPolicyArn() != null) {
            request.addParameter("PolicyArn", StringUtils
                    .fromString(attachUserPolicyRequest.getPolicyArn()));
        }
