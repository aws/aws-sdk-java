...
/**
 * Get Account Authorization Details Result StAX Unmarshaller
 */
public class GetAccountAuthorizationDetailsResultStaxUnmarshaller implements Unmarshaller<GetAccountAuthorizationDetailsResult, StaxUnmarshallerContext> {
    ...
    public GetAccountAuthorizationDetailsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return getAccountAuthorizationDetailsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("UserDetailList/member", targetDepth)) {
                    getAccountAuthorizationDetailsResult.getUserDetailList().add(UserDetailStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("GroupDetailList/member", targetDepth)) {
                    getAccountAuthorizationDetailsResult.getGroupDetailList().add(GroupDetailStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static GetAccountAuthorizationDetailsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GetAccountAuthorizationDetailsResultStaxUnmarshaller();
        return instance;
    }
}
