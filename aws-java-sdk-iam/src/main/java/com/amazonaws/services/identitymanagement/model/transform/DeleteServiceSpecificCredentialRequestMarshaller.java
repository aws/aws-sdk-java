...
/**
 * DeleteServiceSpecificCredentialRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteServiceSpecificCredentialRequestMarshaller implements
        Marshaller<Request<DeleteServiceSpecificCredentialRequest>, DeleteServiceSpecificCredentialRequest> {
    ...
    public Request<DeleteServiceSpecificCredentialRequest> marshall(DeleteServiceSpecificCredentialRequest deleteServiceSpecificCredentialRequest) {
        ...
        Request<DeleteServiceSpecificCredentialRequest> request = new DefaultRequest<DeleteServiceSpecificCredentialRequest>(
                deleteServiceSpecificCredentialRequest, "AmazonIdentityManagement");
