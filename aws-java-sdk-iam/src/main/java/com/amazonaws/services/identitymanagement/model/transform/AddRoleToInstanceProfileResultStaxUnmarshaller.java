 ...
 */
public class AddRoleToInstanceProfileResultStaxUnmarshaller implements
        Unmarshaller<AddRoleToInstanceProfileResult, StaxUnmarshallerContext> {

    public AddRoleToInstanceProfileResult unmarshall(
