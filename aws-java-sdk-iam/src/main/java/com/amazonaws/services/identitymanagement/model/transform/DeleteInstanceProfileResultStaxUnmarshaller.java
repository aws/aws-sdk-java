...
public class DeleteInstanceProfileResultStaxUnmarshaller implements Unmarshaller<DeleteInstanceProfileResult, StaxUnmarshallerContext> {

    public DeleteInstanceProfileResult unmarshall(StaxUnmarshallerContext context) throws Exception {
