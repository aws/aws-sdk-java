 ...
 */
public class DeleteInstanceProfileResultStaxUnmarshaller implements
        Unmarshaller<DeleteInstanceProfileResult, StaxUnmarshallerContext> {

    public DeleteInstanceProfileResult unmarshall(
