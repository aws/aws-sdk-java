...
public class AddUserToGroupResultStaxUnmarshaller implements Unmarshaller<AddUserToGroupResult, StaxUnmarshallerContext> {

    public AddUserToGroupResult unmarshall(StaxUnmarshallerContext context) throws Exception {
