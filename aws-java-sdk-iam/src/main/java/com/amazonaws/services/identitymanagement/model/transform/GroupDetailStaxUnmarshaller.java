...
/**
 * Group Detail StAX Unmarshaller
 */
public class GroupDetailStaxUnmarshaller implements Unmarshaller<GroupDetail, StaxUnmarshallerContext> {
    ...
    public GroupDetail unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return groupDetail;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("GroupPolicyList/member", targetDepth)) {
                    groupDetail.getGroupPolicyList().add(PolicyDetailStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("AttachedManagedPolicies/member", targetDepth)) {
                    groupDetail.getAttachedManagedPolicies().add(AttachedPolicyStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static GroupDetailStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GroupDetailStaxUnmarshaller();
        return instance;
    }
}
