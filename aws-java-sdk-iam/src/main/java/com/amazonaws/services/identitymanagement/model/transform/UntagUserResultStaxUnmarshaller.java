...
/**
 * UntagUserResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UntagUserResultStaxUnmarshaller implements Unmarshaller<UntagUserResult, StaxUnmarshallerContext> {

    public UntagUserResult unmarshall(StaxUnmarshallerContext context) throws Exception {
