...
public class DeleteUserPolicyResultStaxUnmarshaller implements Unmarshaller<DeleteUserPolicyResult, StaxUnmarshallerContext> {

    public DeleteUserPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
