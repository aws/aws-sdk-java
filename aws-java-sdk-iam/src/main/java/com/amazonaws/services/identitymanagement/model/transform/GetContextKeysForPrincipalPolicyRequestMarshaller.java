...
/**
 * Get Context Keys For Principal Policy Request Marshaller
 */
public class GetContextKeysForPrincipalPolicyRequestMarshaller implements Marshaller<Request<GetContextKeysForPrincipalPolicyRequest>, GetContextKeysForPrincipalPolicyRequest> {
    ...
    public Request<GetContextKeysForPrincipalPolicyRequest> marshall(GetContextKeysForPrincipalPolicyRequest getContextKeysForPrincipalPolicyRequest) {
        ...
        Request<GetContextKeysForPrincipalPolicyRequest> request = new DefaultRequest<GetContextKeysForPrincipalPolicyRequest>(getContextKeysForPrincipalPolicyRequest, "AmazonIdentityManagement");
        ...
        java.util.List<String> policyInputListList = getContextKeysForPrincipalPolicyRequest.getPolicyInputList();
