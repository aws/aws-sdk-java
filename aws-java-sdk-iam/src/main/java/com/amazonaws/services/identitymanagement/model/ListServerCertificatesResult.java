 ...
 * </p>
 */
public class ListServerCertificatesResult extends
    ...
    public void setServerCertificateMetadataList(
        ...
        this.serverCertificateMetadataList = new com.amazonaws.internal.SdkInternalList<ServerCertificateMetadata>(
     ...
     * any). Use {@link #setServerCertificateMetadataList(java.util.Collection)}
     * or {@link #withServerCertificateMetadataList(java.util.Collection)} if
    ...
    public ListServerCertificatesResult withServerCertificateMetadataList(
        ...
        if (this.serverCertificateMetadataList == null) {
            setServerCertificateMetadataList(new com.amazonaws.internal.SdkInternalList<ServerCertificateMetadata>(
    ...
    public String toString() {
        ...
        if (getServerCertificateMetadataList() != null)
            sb.append("ServerCertificateMetadataList: "
