...
/**
 * Container for the parameters to the {@link com.amazonaws.services.identitymanagement.AmazonIdentityManagement#listAttachedUserPolicies(ListAttachedUserPoliciesRequest) ListAttachedUserPolicies operation}.
 * <p>
...
public class ListAttachedUserPoliciesRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>[\w+=,.@-]*<br/>
     *
     * @param userName The name (friendly name, not ARN) of the user to list attached
     *         policies for.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAttachedUserPoliciesRequest == false) return false;
