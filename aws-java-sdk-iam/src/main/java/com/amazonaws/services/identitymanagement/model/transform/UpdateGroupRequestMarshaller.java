...
public class UpdateGroupRequestMarshaller implements
    ...
    public Request<UpdateGroupRequest> marshall(
        ...
        Request<UpdateGroupRequest> request = new DefaultRequest<UpdateGroupRequest>(
                updateGroupRequest, "AmazonIdentityManagement");
        ...
        if (updateGroupRequest.getGroupName() != null) {
            request.addParameter("GroupName",
                    StringUtils.fromString(updateGroupRequest.getGroupName()));
        }

        if (updateGroupRequest.getNewPath() != null) {
            request.addParameter("NewPath",
                    StringUtils.fromString(updateGroupRequest.getNewPath()));
        }

        if (updateGroupRequest.getNewGroupName() != null) {
            request.addParameter("NewGroupName", StringUtils
                    .fromString(updateGroupRequest.getNewGroupName()));
        }
