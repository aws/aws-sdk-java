...
/**
 * Get Access Key Last Used Result StAX Unmarshaller
 */
public class GetAccessKeyLastUsedResultStaxUnmarshaller implements Unmarshaller<GetAccessKeyLastUsedResult, StaxUnmarshallerContext> {
    ...
    public GetAccessKeyLastUsedResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return getAccessKeyLastUsedResult;
    ...
    public static GetAccessKeyLastUsedResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new GetAccessKeyLastUsedResultStaxUnmarshaller();
        return instance;
    }
}
