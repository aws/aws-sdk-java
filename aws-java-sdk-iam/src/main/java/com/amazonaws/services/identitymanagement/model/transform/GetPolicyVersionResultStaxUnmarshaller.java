 ...
 */
public class GetPolicyVersionResultStaxUnmarshaller implements
        Unmarshaller<GetPolicyVersionResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("PolicyVersion", targetDepth)) {
                    getPolicyVersionResult
                            .setPolicyVersion(PolicyVersionStaxUnmarshaller
