 ...
 */
public class ListAccountAliasesResultStaxUnmarshaller implements
        Unmarshaller<ListAccountAliasesResult, StaxUnmarshallerContext> {
    ...
    public ListAccountAliasesResult unmarshall(StaxUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context
                        .testExpression("AccountAliases/member", targetDepth)) {
                    listAccountAliasesResult.getAccountAliases().add(
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    listAccountAliasesResult.setMarker(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
