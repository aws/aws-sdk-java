...
/**
 * Update Open I D Connect Provider Thumbprint Request Marshaller
 */
public class UpdateOpenIDConnectProviderThumbprintRequestMarshaller implements Marshaller<Request<UpdateOpenIDConnectProviderThumbprintRequest>, UpdateOpenIDConnectProviderThumbprintRequest> {
    ...
    public Request<UpdateOpenIDConnectProviderThumbprintRequest> marshall(UpdateOpenIDConnectProviderThumbprintRequest updateOpenIDConnectProviderThumbprintRequest) {
        ...
        Request<UpdateOpenIDConnectProviderThumbprintRequest> request = new DefaultRequest<UpdateOpenIDConnectProviderThumbprintRequest>(updateOpenIDConnectProviderThumbprintRequest, "AmazonIdentityManagement");
        ...
        java.util.List<String> thumbprintListList = updateOpenIDConnectProviderThumbprintRequest.getThumbprintList();
