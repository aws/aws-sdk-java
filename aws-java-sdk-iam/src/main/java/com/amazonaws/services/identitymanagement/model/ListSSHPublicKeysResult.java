 ...
 * </p>
 */
public class ListSSHPublicKeysResult extends
    ...
    public void setSSHPublicKeys(
        ...
        this.sSHPublicKeys = new com.amazonaws.internal.SdkInternalList<SSHPublicKeyMetadata>(
                sSHPublicKeys);
    }
     ...
     * any). Use {@link #setSSHPublicKeys(java.util.Collection)} or
     * {@link #withSSHPublicKeys(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param sSHPublicKeys
    ...
    public ListSSHPublicKeysResult withSSHPublicKeys(
        ...
        if (this.sSHPublicKeys == null) {
            setSSHPublicKeys(new com.amazonaws.internal.SdkInternalList<SSHPublicKeyMetadata>(
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getSSHPublicKeys() == null) ? 0 : getSSHPublicKeys()
                        .hashCode());
        hashCode = prime
                * hashCode
