 ...
 */
public class GetInstanceProfileResultStaxUnmarshaller implements
        Unmarshaller<GetInstanceProfileResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("InstanceProfile", targetDepth)) {
                    getInstanceProfileResult
                            .setInstanceProfile(InstanceProfileStaxUnmarshaller
