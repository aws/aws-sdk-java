...
public class CreateAccountAliasResultStaxUnmarshaller implements Unmarshaller<CreateAccountAliasResult, StaxUnmarshallerContext> {

    public CreateAccountAliasResult unmarshall(StaxUnmarshallerContext context) throws Exception {
