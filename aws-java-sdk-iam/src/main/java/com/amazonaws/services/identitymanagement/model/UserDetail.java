...
public class UserDetail implements Serializable, Cloneable {
    ...
    public void setUserPolicyList(
        ...
        this.userPolicyList = new com.amazonaws.internal.SdkInternalList<PolicyDetail>(
                userPolicyList);
    }
     ...
     * any). Use {@link #setUserPolicyList(java.util.Collection)} or
     * {@link #withUserPolicyList(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param userPolicyList
    ...
    public void setGroupList(java.util.Collection<String> groupList) {
        ...
        this.groupList = new com.amazonaws.internal.SdkInternalList<String>(
                groupList);
    }
     ...
     * <p>
     * <b>NOTE:</b> This method appends the values to the existing list (if
     * any). Use {@link #setGroupList(java.util.Collection)} or
     * {@link #withGroupList(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param groupList
        ...
        hashCode = prime
                * hashCode
                + ((getUserPolicyList() == null) ? 0 : getUserPolicyList()
                        .hashCode());
        hashCode = prime * hashCode
                + ((getGroupList() == null) ? 0 : getGroupList().hashCode());
        hashCode = prime
                * hashCode
