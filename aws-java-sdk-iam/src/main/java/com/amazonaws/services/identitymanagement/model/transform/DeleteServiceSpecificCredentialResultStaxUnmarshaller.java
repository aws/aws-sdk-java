...
/**
 * DeleteServiceSpecificCredentialResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteServiceSpecificCredentialResultStaxUnmarshaller implements Unmarshaller<DeleteServiceSpecificCredentialResult, StaxUnmarshallerContext> {

    public DeleteServiceSpecificCredentialResult unmarshall(StaxUnmarshallerContext context) throws Exception {
