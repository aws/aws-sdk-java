 ...
 * </p>
 */
public class GetOpenIDConnectProviderResult extends
     ...
     * </p>
     * 
     * @return A list of client IDs (also known as audiences) that are
    ...
    public void setClientIDList(java.util.Collection<String> clientIDList) {
        ...
        this.clientIDList = new com.amazonaws.internal.SdkInternalList<String>(
                clientIDList);
    }
     ...
     * any). Use {@link #setClientIDList(java.util.Collection)} or
     * {@link #withClientIDList(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param clientIDList
    ...
    public GetOpenIDConnectProviderResult withClientIDList(
        ...
        if (this.clientIDList == null) {
            setClientIDList(new com.amazonaws.internal.SdkInternalList<String>(
                    clientIDList.length));
        }
     ...
     * </p>
     * 
     * @return The date and time when the IAM OIDC provider resource object was
     *         created in the AWS account.
     */
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getClientIDList() == null) ? 0 : getClientIDList()
                        .hashCode());
        hashCode = prime
                * hashCode
