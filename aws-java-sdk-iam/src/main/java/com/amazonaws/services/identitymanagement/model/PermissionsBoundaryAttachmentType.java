...
public enum PermissionsBoundaryAttachmentType {
     ...
     * @param value
     *        real value
     * @return PermissionsBoundaryAttachmentType corresponding to the value
     *
    ...
    public static PermissionsBoundaryAttachmentType fromValue(String value) {
        ...
        for (PermissionsBoundaryAttachmentType enumEntry : PermissionsBoundaryAttachmentType.values()) {
