 ...
 */
public class OpenIDConnectProviderListEntryStaxUnmarshaller implements
        Unmarshaller<OpenIDConnectProviderListEntry, StaxUnmarshallerContext> {

    public OpenIDConnectProviderListEntry unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Arn", targetDepth)) {
                    openIDConnectProviderListEntry
                            .setArn(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
