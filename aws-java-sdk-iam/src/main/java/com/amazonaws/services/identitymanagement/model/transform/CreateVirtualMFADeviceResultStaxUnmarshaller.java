 ...
 */
public class CreateVirtualMFADeviceResultStaxUnmarshaller implements
        Unmarshaller<CreateVirtualMFADeviceResult, StaxUnmarshallerContext> {

    public CreateVirtualMFADeviceResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("VirtualMFADevice", targetDepth)) {
                    createVirtualMFADeviceResult
                            .setVirtualMFADevice(VirtualMFADeviceStaxUnmarshaller
