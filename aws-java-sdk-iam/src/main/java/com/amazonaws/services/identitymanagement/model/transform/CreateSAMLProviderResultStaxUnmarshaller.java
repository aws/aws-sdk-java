 ...
 */
public class CreateSAMLProviderResultStaxUnmarshaller implements
        Unmarshaller<CreateSAMLProviderResult, StaxUnmarshallerContext> {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("SAMLProviderArn", targetDepth)) {
                    createSAMLProviderResult
                            .setSAMLProviderArn(StringStaxUnmarshaller
