 ...
 * </p>
 */
public class ListAccessKeysResult extends
    ...
    public void setAccessKeyMetadata(
            java.util.Collection<AccessKeyMetadata> accessKeyMetadata) {
        if (accessKeyMetadata == null) {
            this.accessKeyMetadata = null;
            return;
        }

        this.accessKeyMetadata = new com.amazonaws.internal.SdkInternalList<AccessKeyMetadata>(
                accessKeyMetadata);
    }
    ...
    public ListAccessKeysResult withAccessKeyMetadata(
            AccessKeyMetadata... accessKeyMetadata) {
        if (this.accessKeyMetadata == null) {
            setAccessKeyMetadata(new com.amazonaws.internal.SdkInternalList<AccessKeyMetadata>(
                    accessKeyMetadata.length));
        }
    ...
    public String toString() {
        ...
        if (getAccessKeyMetadata() != null)
            sb.append("AccessKeyMetadata: " + getAccessKeyMetadata() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAccessKeyMetadata() == null
                ^ this.getAccessKeyMetadata() == null)
            return false;
        if (other.getAccessKeyMetadata() != null
                && other.getAccessKeyMetadata().equals(
                        this.getAccessKeyMetadata()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getAccessKeyMetadata() == null) ? 0
                        : getAccessKeyMetadata().hashCode());
        hashCode = prime
                * hashCode
