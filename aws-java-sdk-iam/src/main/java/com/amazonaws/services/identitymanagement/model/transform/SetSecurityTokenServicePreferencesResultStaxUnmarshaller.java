...
/**
 * SetSecurityTokenServicePreferencesResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SetSecurityTokenServicePreferencesResultStaxUnmarshaller implements
        Unmarshaller<SetSecurityTokenServicePreferencesResult, StaxUnmarshallerContext> {

    public SetSecurityTokenServicePreferencesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
