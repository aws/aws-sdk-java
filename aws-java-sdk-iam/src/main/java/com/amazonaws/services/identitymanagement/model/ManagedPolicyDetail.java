...
public class ManagedPolicyDetail implements Serializable, Cloneable {
     ...
     * >Versioning for Managed Policies</a> in the <i>Using IAM</i> guide.
     * </p>
     */
     ...
     *        For more information about policy versions, see <a href=
     *        "http://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-versions.html"
     *        >Versioning for Managed Policies</a> in the <i>Using IAM</i>
     *        guide.
     */
     ...
     * </p>
     * 
     * @return The number of principal entities (users, groups, and roles) that
     *         the policy is attached to.
     */
     ...
     *        A list containing information about the versions of the policy.
     */
    public void setPolicyVersionList(
            java.util.Collection<PolicyVersion> policyVersionList) {
        if (policyVersionList == null) {
            this.policyVersionList = null;
            return;
        }

        this.policyVersionList = new com.amazonaws.internal.SdkInternalList<PolicyVersion>(
                policyVersionList);
    }
     ...
     *         chained together.
     */
    public ManagedPolicyDetail withPolicyVersionList(
            PolicyVersion... policyVersionList) {
        if (this.policyVersionList == null) {
            setPolicyVersionList(new com.amazonaws.internal.SdkInternalList<PolicyVersion>(
                    policyVersionList.length));
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getUpdateDate() != null
            ...
            return false;
        if (other.getPolicyVersionList() == null
                ^ this.getPolicyVersionList() == null)
            return false;
        if (other.getPolicyVersionList() != null
                && other.getPolicyVersionList().equals(
                        this.getPolicyVersionList()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getPolicyVersionList() == null) ? 0
                        : getPolicyVersionList().hashCode());
        return hashCode;
    }
