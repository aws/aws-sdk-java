 ...
 */
public class DeleteVirtualMFADeviceResultStaxUnmarshaller implements
        Unmarshaller<DeleteVirtualMFADeviceResult, StaxUnmarshallerContext> {

    public DeleteVirtualMFADeviceResult unmarshall(
