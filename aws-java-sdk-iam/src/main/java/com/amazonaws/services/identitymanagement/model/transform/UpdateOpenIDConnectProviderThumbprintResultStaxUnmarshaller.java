...
public class UpdateOpenIDConnectProviderThumbprintResultStaxUnmarshaller implements
        Unmarshaller<UpdateOpenIDConnectProviderThumbprintResult, StaxUnmarshallerContext> {

    public UpdateOpenIDConnectProviderThumbprintResult unmarshall(StaxUnmarshallerContext context) throws Exception {
