...
public class AddUserToGroupRequestMarshaller implements
    ...
    public Request<AddUserToGroupRequest> marshall(
        ...
        Request<AddUserToGroupRequest> request = new DefaultRequest<AddUserToGroupRequest>(
                addUserToGroupRequest, "AmazonIdentityManagement");
        ...
        if (addUserToGroupRequest.getGroupName() != null) {
            request.addParameter("GroupName", StringUtils
                    .fromString(addUserToGroupRequest.getGroupName()));
        }

        if (addUserToGroupRequest.getUserName() != null) {
            request.addParameter("UserName",
                    StringUtils.fromString(addUserToGroupRequest.getUserName()));
        }
