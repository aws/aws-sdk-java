...
public class GetMobileSdkReleaseRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetMobileSdkReleaseRequest withPlatform(String platform) {
    ...
    public GetMobileSdkReleaseRequest withPlatform(Platform platform) {
