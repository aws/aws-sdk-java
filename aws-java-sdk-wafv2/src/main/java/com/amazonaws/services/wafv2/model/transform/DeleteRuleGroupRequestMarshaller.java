...
public class DeleteRuleGroupRequestMarshaller {
    ...
    public void marshall(DeleteRuleGroupRequest deleteRuleGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteRuleGroupRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(deleteRuleGroupRequest.getScope(), SCOPE_BINDING);
            protocolMarshaller.marshall(deleteRuleGroupRequest.getId(), ID_BINDING);
            protocolMarshaller.marshall(deleteRuleGroupRequest.getLockToken(), LOCKTOKEN_BINDING);
        } catch (Exception e) {
