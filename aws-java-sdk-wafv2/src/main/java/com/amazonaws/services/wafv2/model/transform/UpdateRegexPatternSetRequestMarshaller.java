...
public class UpdateRegexPatternSetRequestMarshaller {
    ...
    public void marshall(UpdateRegexPatternSetRequest updateRegexPatternSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateRegexPatternSetRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateRegexPatternSetRequest.getScope(), SCOPE_BINDING);
            protocolMarshaller.marshall(updateRegexPatternSetRequest.getId(), ID_BINDING);
            protocolMarshaller.marshall(updateRegexPatternSetRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateRegexPatternSetRequest.getRegularExpressionList(), REGULAREXPRESSIONLIST_BINDING);
            protocolMarshaller.marshall(updateRegexPatternSetRequest.getLockToken(), LOCKTOKEN_BINDING);
        } catch (Exception e) {
