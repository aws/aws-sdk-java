...
public class CreateAPIKeyRequestMarshaller {
    ...
    public void marshall(CreateAPIKeyRequest createAPIKeyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createAPIKeyRequest.getScope(), SCOPE_BINDING);
            protocolMarshaller.marshall(createAPIKeyRequest.getTokenDomains(), TOKENDOMAINS_BINDING);
        } catch (Exception e) {
