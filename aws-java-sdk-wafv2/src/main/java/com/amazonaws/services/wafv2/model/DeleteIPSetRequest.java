...
public class DeleteIPSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteIPSetRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public DeleteIPSetRequest withScope(String scope) {
        setScope(scope);
        return this;
    }
    ...
    public DeleteIPSetRequest withScope(Scope scope) {
    ...
    public DeleteIPSetRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public DeleteIPSetRequest withLockToken(String lockToken) {
