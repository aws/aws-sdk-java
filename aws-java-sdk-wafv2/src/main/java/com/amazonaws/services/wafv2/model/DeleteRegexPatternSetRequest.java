...
public class DeleteRegexPatternSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteRegexPatternSetRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public DeleteRegexPatternSetRequest withScope(String scope) {
        setScope(scope);
        return this;
    }
    ...
    public DeleteRegexPatternSetRequest withScope(Scope scope) {
    ...
    public DeleteRegexPatternSetRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public DeleteRegexPatternSetRequest withLockToken(String lockToken) {
