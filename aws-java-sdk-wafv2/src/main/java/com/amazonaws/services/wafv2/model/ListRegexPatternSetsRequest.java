...
public class ListRegexPatternSetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListRegexPatternSetsRequest withScope(String scope) {
        setScope(scope);
        return this;
    }
    ...
    public ListRegexPatternSetsRequest withScope(Scope scope) {
    ...
    public ListRegexPatternSetsRequest withLimit(Integer limit) {
        setLimit(limit);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListRegexPatternSetsRequest == false)
            return false;
        ListRegexPatternSetsRequest other = (ListRegexPatternSetsRequest) obj;
    ...
    @Override
    public ListRegexPatternSetsRequest clone() {
        return (ListRegexPatternSetsRequest) super.clone();
    }
