        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Id", targetDepth)) {
                    context.nextToken();
                    ruleGroupSummary.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Description", targetDepth)) {
                    context.nextToken();
                    ruleGroupSummary.setDescription(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("LockToken", targetDepth)) {
                    context.nextToken();
                    ruleGroupSummary.setLockToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ARN", targetDepth)) {
                    context.nextToken();
                    ruleGroupSummary.setARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
