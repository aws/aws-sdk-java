...
public class UpdateWebACLResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * A token used for optimistic locking. WAF returns this token to your <code>update</code> requests. You use
     ...
     * </p>
     * 
     * @return A token used for optimistic locking. WAF returns this token to your <code>update</code> requests. You use
     *         <code>NextLockToken</code> in the same manner as you use <code>LockToken</code>.
     */
    ...
    public UpdateWebACLResult withNextLockToken(String nextLockToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateWebACLResult == false)
            return false;
