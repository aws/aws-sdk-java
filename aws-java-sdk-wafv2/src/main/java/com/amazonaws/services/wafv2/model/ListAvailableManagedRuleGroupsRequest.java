...
public class ListAvailableManagedRuleGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAvailableManagedRuleGroupsRequest withScope(String scope) {
        setScope(scope);
        return this;
    }
    ...
    public ListAvailableManagedRuleGroupsRequest withScope(Scope scope) {
    ...
    public ListAvailableManagedRuleGroupsRequest withNextMarker(String nextMarker) {
    ...
    public ListAvailableManagedRuleGroupsRequest withLimit(Integer limit) {
        setLimit(limit);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAvailableManagedRuleGroupsRequest == false)
            return false;
        ListAvailableManagedRuleGroupsRequest other = (ListAvailableManagedRuleGroupsRequest) obj;
    ...
    @Override
    public ListAvailableManagedRuleGroupsRequest clone() {
        return (ListAvailableManagedRuleGroupsRequest) super.clone();
    }
