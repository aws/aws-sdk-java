...
public class LoggingConfigurationMarshaller {
    ...
    public void marshall(LoggingConfiguration loggingConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(loggingConfiguration.getLogType(), LOGTYPE_BINDING);
            protocolMarshaller.marshall(loggingConfiguration.getLogScope(), LOGSCOPE_BINDING);
        } catch (Exception e) {
