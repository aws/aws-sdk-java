...
/**
 * APIKeySummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class APIKeySummaryMarshaller {
    ...
    private static final APIKeySummaryMarshaller instance = new APIKeySummaryMarshaller();

    public static APIKeySummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(APIKeySummary aPIKeySummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(aPIKeySummary.getTokenDomains(), TOKENDOMAINS_BINDING);
            protocolMarshaller.marshall(aPIKeySummary.getAPIKey(), APIKEY_BINDING);
            protocolMarshaller.marshall(aPIKeySummary.getCreationTimestamp(), CREATIONTIMESTAMP_BINDING);
            protocolMarshaller.marshall(aPIKeySummary.getVersion(), VERSION_BINDING);
        } catch (Exception e) {
