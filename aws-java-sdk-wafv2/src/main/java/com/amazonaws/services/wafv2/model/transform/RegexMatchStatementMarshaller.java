...
@SdkInternalApi
public class RegexMatchStatementMarshaller {
    ...
    private static final RegexMatchStatementMarshaller instance = new RegexMatchStatementMarshaller();

    public static RegexMatchStatementMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RegexMatchStatement regexMatchStatement, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(regexMatchStatement.getRegexString(), REGEXSTRING_BINDING);
            protocolMarshaller.marshall(regexMatchStatement.getFieldToMatch(), FIELDTOMATCH_BINDING);
            protocolMarshaller.marshall(regexMatchStatement.getTextTransformations(), TEXTTRANSFORMATIONS_BINDING);
        } catch (Exception e) {
