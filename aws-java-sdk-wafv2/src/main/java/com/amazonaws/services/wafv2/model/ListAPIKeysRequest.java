...
public class ListAPIKeysRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAPIKeysRequest withScope(String scope) {
        setScope(scope);
        return this;
    }
    ...
    public ListAPIKeysRequest withScope(Scope scope) {
    ...
    public ListAPIKeysRequest withNextMarker(String nextMarker) {
    ...
    public ListAPIKeysRequest withLimit(Integer limit) {
        setLimit(limit);
        return this;
    }
