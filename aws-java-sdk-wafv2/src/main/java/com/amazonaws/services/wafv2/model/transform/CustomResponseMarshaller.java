...
/**
 * CustomResponseMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CustomResponseMarshaller {
    ...
    private static final CustomResponseMarshaller instance = new CustomResponseMarshaller();

    public static CustomResponseMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CustomResponse customResponse, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(customResponse.getResponseCode(), RESPONSECODE_BINDING);
            protocolMarshaller.marshall(customResponse.getCustomResponseBodyKey(), CUSTOMRESPONSEBODYKEY_BINDING);
            protocolMarshaller.marshall(customResponse.getResponseHeaders(), RESPONSEHEADERS_BINDING);
        } catch (Exception e) {
