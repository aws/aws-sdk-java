...
public class GetLoggingConfigurationRequestMarshaller {
    ...
    public static GetLoggingConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetLoggingConfigurationRequest getLoggingConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
