...
/**
 * DeleteRuleGroupResult JSON Unmarshaller
 */
...
public class DeleteRuleGroupResultJsonUnmarshaller implements Unmarshaller<DeleteRuleGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteRuleGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRuleGroupResult deleteRuleGroupResult = new DeleteRuleGroupResult();
