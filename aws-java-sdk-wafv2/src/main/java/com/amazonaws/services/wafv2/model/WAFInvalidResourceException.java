...
public class WAFInvalidResourceException extends com.amazonaws.services.wafv2.model.AWSWAFV2Exception {
     ...
     */
    public WAFInvalidResourceException(String message) {
        super(message);
    }
