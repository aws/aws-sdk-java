        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listTagsForResourceResult.setNextMarker(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("TagInfoForResource", targetDepth)) {
                    context.nextToken();
                    listTagsForResourceResult.setTagInfoForResource(TagInfoForResourceJsonUnmarshaller.getInstance().unmarshall(context));
                }
