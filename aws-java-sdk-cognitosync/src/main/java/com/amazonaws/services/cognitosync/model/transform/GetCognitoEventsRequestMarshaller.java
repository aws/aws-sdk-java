...
/**
 * Get Cognito Events Request Marshaller
 */
public class GetCognitoEventsRequestMarshaller implements Marshaller<Request<GetCognitoEventsRequest>, GetCognitoEventsRequest> {
    ...
    public Request<GetCognitoEventsRequest> marshall(GetCognitoEventsRequest getCognitoEventsRequest) {
        ...
        String target = "AWSCognitoSyncService.GetCognitoEvents";
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("IdentityPoolId")) {
            ...
            String value = (getCognitoEventsRequest.getIdentityPoolId() == null) ? null : StringUtils.fromString(getCognitoEventsRequest.getIdentityPoolId());
