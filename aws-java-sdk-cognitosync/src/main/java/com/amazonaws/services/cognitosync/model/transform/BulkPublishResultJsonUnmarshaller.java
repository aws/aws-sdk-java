...
/**
 * Bulk Publish Result JSON Unmarshaller
 */
public class BulkPublishResultJsonUnmarshaller implements Unmarshaller<BulkPublishResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityPoolId", targetDepth)) {
                    context.nextToken();
                    bulkPublishResult.setIdentityPoolId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static BulkPublishResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new BulkPublishResultJsonUnmarshaller();
        return instance;
    }
}
