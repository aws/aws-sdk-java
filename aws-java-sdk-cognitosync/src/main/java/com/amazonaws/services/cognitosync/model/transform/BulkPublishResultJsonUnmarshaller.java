 ...
 */
public class BulkPublishResultJsonUnmarshaller implements
        Unmarshaller<BulkPublishResult, JsonUnmarshallerContext> {

    public BulkPublishResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityPoolId", targetDepth)) {
                    context.nextToken();
                    bulkPublishResult.setIdentityPoolId(StringJsonUnmarshaller
