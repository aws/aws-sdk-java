...
/**
 * Set Cognito Events Request Marshaller
 */
public class SetCognitoEventsRequestMarshaller implements Marshaller<Request<SetCognitoEventsRequest>, SetCognitoEventsRequest> {
    ...
    static {
        String path = "/identitypools/{IdentityPoolId}/events";
    ...
    public Request<SetCognitoEventsRequest> marshall(SetCognitoEventsRequest setCognitoEventsRequest) {
        ...
        String target = "AWSCognitoSyncService.SetCognitoEvents";
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (setCognitoEventsRequest.getEvents() != null) {
                jsonWriter.key("Events");
                jsonWriter.object();
                for (Map.Entry<String, String> eventsListValue : setCognitoEventsRequest.getEvents().entrySet()) {
                    if (eventsListValue.getValue() != null) {
                        jsonWriter.key(eventsListValue.getKey());

                        jsonWriter.value(eventsListValue.getValue());
                    }
                }
