...
public class InvalidLambdaFunctionOutputExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("InvalidLambdaFunctionOutputException"));
        } else {
            return errorTypeFromHeader.equals("InvalidLambdaFunctionOutputException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        InvalidLambdaFunctionOutputException e = (InvalidLambdaFunctionOutputException)super.unmarshall(json);
