...
/**
 * Cognito Streams JSON Unmarshaller
 */
public class CognitoStreamsJsonUnmarshaller implements Unmarshaller<CognitoStreams, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StreamName", targetDepth)) {
                    context.nextToken();
                    cognitoStreams.setStreamName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RoleArn", targetDepth)) {
                    context.nextToken();
                    cognitoStreams.setRoleArn(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("StreamingStatus", targetDepth)) {
                    context.nextToken();
                    cognitoStreams.setStreamingStatus(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CognitoStreamsJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CognitoStreamsJsonUnmarshaller();
        return instance;
    }
}
