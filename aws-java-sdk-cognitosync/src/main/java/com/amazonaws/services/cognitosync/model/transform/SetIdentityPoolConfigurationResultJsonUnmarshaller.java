 ...
 */
public class SetIdentityPoolConfigurationResultJsonUnmarshaller
        implements
        Unmarshaller<SetIdentityPoolConfigurationResult, JsonUnmarshallerContext> {

    public SetIdentityPoolConfigurationResult unmarshall(
