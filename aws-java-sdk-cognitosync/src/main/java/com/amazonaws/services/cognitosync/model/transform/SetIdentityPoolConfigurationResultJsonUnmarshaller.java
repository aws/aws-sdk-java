...
/**
 * Set Identity Pool Configuration Result JSON Unmarshaller
 */
public class SetIdentityPoolConfigurationResultJsonUnmarshaller implements Unmarshaller<SetIdentityPoolConfigurationResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityPoolId", targetDepth)) {
                    context.nextToken();
                    setIdentityPoolConfigurationResult.setIdentityPoolId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static SetIdentityPoolConfigurationResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new SetIdentityPoolConfigurationResultJsonUnmarshaller();
        return instance;
    }
}
