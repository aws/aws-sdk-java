 ...
 */
public class DescribeIdentityUsageResultJsonUnmarshaller implements
        Unmarshaller<DescribeIdentityUsageResult, JsonUnmarshallerContext> {

    public DescribeIdentityUsageResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityUsage", targetDepth)) {
                    ...
                    describeIdentityUsageResult
                            .setIdentityUsage(IdentityUsageJsonUnmarshaller
