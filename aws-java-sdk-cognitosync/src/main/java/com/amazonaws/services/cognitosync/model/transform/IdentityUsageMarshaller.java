...
public class IdentityUsageMarshaller {
    ...
    private static final MarshallingInfo<Integer> DATASETCOUNT_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DatasetCount").build();
    ...
    public void marshall(IdentityUsage identityUsage, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(identityUsage.getIdentityId(), IDENTITYID_BINDING);
            protocolMarshaller.marshall(identityUsage.getIdentityPoolId(), IDENTITYPOOLID_BINDING);
            protocolMarshaller.marshall(identityUsage.getLastModifiedDate(), LASTMODIFIEDDATE_BINDING);
            protocolMarshaller.marshall(identityUsage.getDatasetCount(), DATASETCOUNT_BINDING);
            protocolMarshaller.marshall(identityUsage.getDataStorage(), DATASTORAGE_BINDING);
        } catch (Exception e) {
