 ...
 */
public class ListIdentityPoolUsageResultJsonUnmarshaller implements
        Unmarshaller<ListIdentityPoolUsageResult, JsonUnmarshallerContext> {

    public ListIdentityPoolUsageResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityPoolUsages", targetDepth)) {
                    ...
                    listIdentityPoolUsageResult
                            .setIdentityPoolUsages(new ListUnmarshaller<IdentityPoolUsage>(
