...
public interface AmazonCognitoSync {
     ...
     *
     * @param endpoint
     *        The endpoint (ex: "cognito-sync.us-east-1.amazonaws.com/") or a
     ...
     */
    DescribeDatasetResult describeDataset(
     ...
     */
    DescribeIdentityPoolUsageResult describeIdentityPoolUsage(
     ...
     */
    DescribeIdentityUsageResult describeIdentityUsage(
     ...
     */
    GetBulkPublishDetailsResult getBulkPublishDetails(
     ...
     */
    GetCognitoEventsResult getCognitoEvents(
     ...
     */
    GetIdentityPoolConfigurationResult getIdentityPoolConfiguration(
     ...
     */
    ListIdentityPoolUsageResult listIdentityPoolUsage(
     ...
     */
    SubscribeToDatasetResult subscribeToDataset(
