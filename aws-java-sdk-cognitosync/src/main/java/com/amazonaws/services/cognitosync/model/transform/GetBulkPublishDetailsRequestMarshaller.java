...
/**
 * Get Bulk Publish Details Request Marshaller
 */
public class GetBulkPublishDetailsRequestMarshaller implements Marshaller<Request<GetBulkPublishDetailsRequest>, GetBulkPublishDetailsRequest> {
    ...
    static {
        String path = "/identitypools/{IdentityPoolId}/getBulkPublishDetails";
    ...
    public Request<GetBulkPublishDetailsRequest> marshall(GetBulkPublishDetailsRequest getBulkPublishDetailsRequest) {
        ...
        String target = "AWSCognitoSyncService.GetBulkPublishDetails";
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("IdentityPoolId")) {
            ...
            String value = (getBulkPublishDetailsRequest.getIdentityPoolId() == null) ? null : StringUtils.fromString(getBulkPublishDetailsRequest.getIdentityPoolId());

            if (!(value == null || value.isEmpty())) {
                request.addParameter(name, value);
            }
        } else {
            uriResourcePath = uriResourcePath.replace("{IdentityPoolId}", (getBulkPublishDetailsRequest.getIdentityPoolId() == null) ? "" : StringUtils.fromString(getBulkPublishDetailsRequest.getIdentityPoolId())); 
        }
