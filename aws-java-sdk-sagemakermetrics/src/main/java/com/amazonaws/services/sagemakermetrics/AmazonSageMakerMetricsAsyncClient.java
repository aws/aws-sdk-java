...
/**
 * Client for accessing SageMaker Metrics asynchronously. Each asynchronous method will return a Java Future object
...
public class AmazonSageMakerMetricsAsyncClient extends AmazonSageMakerMetricsClient implements AmazonSageMakerMetricsAsync {
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on SageMaker Metrics using the specified
     * parameters.
     *
    ...
    @Override
    public java.util.concurrent.Future<BatchPutMetricsResult> batchPutMetricsAsync(BatchPutMetricsRequest request) {

        return batchPutMetricsAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<BatchPutMetricsResult> batchPutMetricsAsync(final BatchPutMetricsRequest request,
            final com.amazonaws.handlers.AsyncHandler<BatchPutMetricsRequest, BatchPutMetricsResult> asyncHandler) {
        final BatchPutMetricsRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<BatchPutMetricsResult>() {
            @Override
            public BatchPutMetricsResult call() throws Exception {
                BatchPutMetricsResult result = null;

                try {
                    result = executeBatchPutMetrics(finalRequest);
                } catch (Exception ex) {
