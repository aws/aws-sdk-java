...
/**
 * UpdateContactChannelResult JSON Unmarshaller
 */
...
public class UpdateContactChannelResultJsonUnmarshaller implements Unmarshaller<UpdateContactChannelResult, JsonUnmarshallerContext> {
    ...
    public UpdateContactChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateContactChannelResult updateContactChannelResult = new UpdateContactChannelResult();
