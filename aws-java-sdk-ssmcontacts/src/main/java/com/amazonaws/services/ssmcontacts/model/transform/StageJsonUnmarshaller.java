        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DurationInMinutes", targetDepth)) {
                    context.nextToken();
                    stage.setDurationInMinutes(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("Targets", targetDepth)) {
                    context.nextToken();
                    stage.setTargets(new ListUnmarshaller<Target>(TargetJsonUnmarshaller.getInstance())
