...
/**
 * ActivateContactChannelResult JSON Unmarshaller
 */
...
public class ActivateContactChannelResultJsonUnmarshaller implements Unmarshaller<ActivateContactChannelResult, JsonUnmarshallerContext> {
    ...
    public ActivateContactChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ActivateContactChannelResult activateContactChannelResult = new ActivateContactChannelResult();
