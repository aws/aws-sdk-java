...
public class DescribePageRequestMarshaller {
    ...
    private static final DescribePageRequestMarshaller instance = new DescribePageRequestMarshaller();

    public static DescribePageRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribePageRequest describePageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describePageRequest.getPageId(), PAGEID_BINDING);
        } catch (Exception e) {
