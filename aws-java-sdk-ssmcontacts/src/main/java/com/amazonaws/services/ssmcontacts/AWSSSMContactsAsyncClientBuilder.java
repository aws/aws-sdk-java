...
/**
 * Fluent builder for {@link com.amazonaws.services.ssmcontacts.AWSSSMContactsAsync}. Use of the builder is preferred
...
public final class AWSSSMContactsAsyncClientBuilder extends AwsAsyncClientBuilder<AWSSSMContactsAsyncClientBuilder, AWSSSMContactsAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSSSMContactsAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSSSMContactsAsync.
     */
    @Override
    protected AWSSSMContactsAsync build(AwsAsyncClientParams params) {
        return new AWSSSMContactsAsyncClient(params);
    }
