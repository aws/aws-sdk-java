...
public class PutContactPolicyRequestMarshaller {
    ...
    private static final PutContactPolicyRequestMarshaller instance = new PutContactPolicyRequestMarshaller();

    public static PutContactPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutContactPolicyRequest putContactPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putContactPolicyRequest.getContactArn(), CONTACTARN_BINDING);
            protocolMarshaller.marshall(putContactPolicyRequest.getPolicy(), POLICY_BINDING);
        } catch (Exception e) {
