...
/**
 * PutContactPolicyResult JSON Unmarshaller
 */
...
public class PutContactPolicyResultJsonUnmarshaller implements Unmarshaller<PutContactPolicyResult, JsonUnmarshallerContext> {
    ...
    public PutContactPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutContactPolicyResult putContactPolicyResult = new PutContactPolicyResult();
