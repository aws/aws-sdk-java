...
public class UpdateContactRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> PLAN_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("Plan").build();
    ...
    public void marshall(UpdateContactRequest updateContactRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateContactRequest.getContactId(), CONTACTID_BINDING);
            protocolMarshaller.marshall(updateContactRequest.getDisplayName(), DISPLAYNAME_BINDING);
            protocolMarshaller.marshall(updateContactRequest.getPlan(), PLAN_BINDING);
        } catch (Exception e) {
