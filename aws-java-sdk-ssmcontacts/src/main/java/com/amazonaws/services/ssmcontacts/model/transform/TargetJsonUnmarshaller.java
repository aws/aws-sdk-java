        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChannelTargetInfo", targetDepth)) {
                    context.nextToken();
                    target.setChannelTargetInfo(ChannelTargetInfoJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ContactTargetInfo", targetDepth)) {
                    context.nextToken();
                    target.setContactTargetInfo(ContactTargetInfoJsonUnmarshaller.getInstance().unmarshall(context));
                }
