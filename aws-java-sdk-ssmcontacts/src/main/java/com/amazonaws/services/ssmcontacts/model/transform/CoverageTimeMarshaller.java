...
/**
 * CoverageTimeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CoverageTimeMarshaller {
    ...
    private static final CoverageTimeMarshaller instance = new CoverageTimeMarshaller();

    public static CoverageTimeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CoverageTime coverageTime, ProtocolMarshaller protocolMarshaller) {

        if (coverageTime == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(coverageTime.getStart(), START_BINDING);
            protocolMarshaller.marshall(coverageTime.getEnd(), END_BINDING);
        } catch (Exception e) {
