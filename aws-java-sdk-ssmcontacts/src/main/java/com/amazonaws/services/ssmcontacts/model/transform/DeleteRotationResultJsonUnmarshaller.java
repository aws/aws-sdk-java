...
/**
 * DeleteRotationResult JSON Unmarshaller
 */
...
public class DeleteRotationResultJsonUnmarshaller implements Unmarshaller<DeleteRotationResult, JsonUnmarshallerContext> {
    ...
    public DeleteRotationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRotationResult deleteRotationResult = new DeleteRotationResult();
