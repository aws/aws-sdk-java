...
/**
 * <p>
 * (Discontinued) The request was rejected because it attempted to create resources beyond the current Amazon Web
 * Services account quotas. The error code describes the quota exceeded.
 * </p>
 */
