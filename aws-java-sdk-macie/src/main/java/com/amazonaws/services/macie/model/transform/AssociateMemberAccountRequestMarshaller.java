...
/**
 * AssociateMemberAccountRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssociateMemberAccountRequestMarshaller {
    ...
    private static final AssociateMemberAccountRequestMarshaller instance = new AssociateMemberAccountRequestMarshaller();

    public static AssociateMemberAccountRequestMarshaller getInstance() {
        return instance;
    }
