...
/**
 * MemberAccount JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MemberAccountJsonUnmarshaller implements Unmarshaller<MemberAccount, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("accountId", targetDepth)) {
                    context.nextToken();
                    memberAccount.setAccountId(context.getUnmarshaller(String.class).unmarshall(context));
                }
