...
public class UpdateS3ResourcesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The S3 resources whose classification types can't be updated. An error code and an error message are provided for
     * each failed item.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The S3 resources whose classification types can't be updated. An error code and an error message are
     ...
     *        The S3 resources whose classification types can't be updated. An error code and an error message are
     *        provided for each failed item.
     */
    ...
    public UpdateS3ResourcesResult withFailedS3Resources(java.util.Collection<FailedS3Resource> failedS3Resources) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateS3ResourcesResult == false)
            return false;
        UpdateS3ResourcesResult other = (UpdateS3ResourcesResult) obj;
    ...
    public UpdateS3ResourcesResult clone() {
        try {
            return (UpdateS3ResourcesResult) super.clone();
