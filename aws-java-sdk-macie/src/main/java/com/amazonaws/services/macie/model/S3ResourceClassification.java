 ...
 * classification. This data type is used as a request parameter in the <code>AssociateS3Resources</code> action and a
...
public class S3ResourceClassification implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return (Discontinued) The name of the S3 bucket that you want to associate with Amazon Macie Classic.
     */
     ...
     * </p>
     * 
     * @return (Discontinued) The prefix of the S3 bucket that you want to associate with Amazon Macie Classic.
     */
     ...
     *        (Discontinued) The classification type that you want to specify for the resource associated with Amazon
     *        Macie Classic.
     */
     ...
     * </p>
     * 
     * @return (Discontinued) The classification type that you want to specify for the resource associated with Amazon
     *         Macie Classic.
     */
