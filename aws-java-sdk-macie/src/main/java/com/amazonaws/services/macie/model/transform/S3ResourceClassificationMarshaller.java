...
/**
 * S3ResourceClassificationMarshaller
 */
...
public class S3ResourceClassificationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CLASSIFICATIONTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("classificationType").build();
