...
public class DescribeClusterVersionsResultStaxUnmarshaller implements
    ...
    public DescribeClusterVersionsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ClusterVersions/ClusterVersion",
                        targetDepth)) {
                    describeClusterVersionsResult
                            .withClusterVersions(ClusterVersionStaxUnmarshaller
