 ...
 */
public class DescribeClusterParametersResultStaxUnmarshaller implements
        Unmarshaller<DescribeClusterParametersResult, StaxUnmarshallerContext> {

    public DescribeClusterParametersResult unmarshall(
