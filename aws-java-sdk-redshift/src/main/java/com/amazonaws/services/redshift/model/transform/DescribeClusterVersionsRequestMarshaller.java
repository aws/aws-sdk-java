...
public class DescribeClusterVersionsRequestMarshaller
    ...
    public Request<DescribeClusterVersionsRequest> marshall(
        ...
        if (describeClusterVersionsRequest.getClusterVersion() != null) {
            request.addParameter("ClusterVersion", StringUtils
                    .fromString(describeClusterVersionsRequest
                            .getClusterVersion()));
        }

        if (describeClusterVersionsRequest.getClusterParameterGroupFamily() != null) {
            request.addParameter("ClusterParameterGroupFamily", StringUtils
                    .fromString(describeClusterVersionsRequest
        ...
        if (describeClusterVersionsRequest.getMaxRecords() != null) {
            request.addParameter("MaxRecords",
                    StringUtils.fromInteger(describeClusterVersionsRequest
                            .getMaxRecords()));
        }

        if (describeClusterVersionsRequest.getMarker() != null) {
            request.addParameter("Marker", StringUtils
                    .fromString(describeClusterVersionsRequest.getMarker()));
        }
