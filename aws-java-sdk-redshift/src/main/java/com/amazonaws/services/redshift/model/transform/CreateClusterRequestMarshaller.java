...
public class CreateClusterRequestMarshaller implements
    ...
    public Request<CreateClusterRequest> marshall(
        ...
        if (createClusterRequest.getElasticIp() != null) {
            request.addParameter("ElasticIp",
                    StringUtils.fromString(createClusterRequest.getElasticIp()));
        }

        com.amazonaws.internal.SdkInternalList<Tag> tagsList = (com.amazonaws.internal.SdkInternalList<Tag>) createClusterRequest
                .getTags();
        ...
        com.amazonaws.internal.SdkInternalList<String> iamRolesList = (com.amazonaws.internal.SdkInternalList<String>) createClusterRequest
                .getIamRoles();
