 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/ScheduledAction" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ScheduledAction implements Serializable, Cloneable {
    ...
    public ScheduledAction withState(String state) {
        setState(state);
        return this;
    }
    ...
    public ScheduledAction withState(ScheduledActionState state) {
    ...
    public ScheduledAction withNextInvocations(java.util.Date... nextInvocations) {
    ...
    public ScheduledAction withNextInvocations(java.util.Collection<java.util.Date> nextInvocations) {
