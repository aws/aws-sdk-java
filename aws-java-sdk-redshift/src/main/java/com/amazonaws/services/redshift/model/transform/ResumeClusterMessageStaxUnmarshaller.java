...
/**
 * ResumeClusterMessage StAX Unmarshaller
 */
...
public class ResumeClusterMessageStaxUnmarshaller implements Unmarshaller<ResumeClusterMessage, StaxUnmarshallerContext> {
    ...
    public ResumeClusterMessage unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ClusterIdentifier", targetDepth)) {
                    resumeClusterMessage.setClusterIdentifier(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
