...
public class DisassociateDataShareConsumerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DisassociateDataShareConsumerResult withDataShareArn(String dataShareArn) {
    ...
    public DisassociateDataShareConsumerResult withProducerArn(String producerArn) {
    ...
    public DisassociateDataShareConsumerResult withAllowPubliclyAccessibleConsumers(Boolean allowPubliclyAccessibleConsumers) {
    ...
    public DisassociateDataShareConsumerResult withDataShareAssociations(DataShareAssociation... dataShareAssociations) {
    ...
    public DisassociateDataShareConsumerResult withDataShareAssociations(java.util.Collection<DataShareAssociation> dataShareAssociations) {
    ...
    public DisassociateDataShareConsumerResult withManagedBy(String managedBy) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateDataShareConsumerResult == false)
            return false;
        DisassociateDataShareConsumerResult other = (DisassociateDataShareConsumerResult) obj;
    ...
    @Override
    public DisassociateDataShareConsumerResult clone() {
        try {
            return (DisassociateDataShareConsumerResult) super.clone();
