...
public class UnknownSnapshotCopyRegionExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null
                || !errorCode.equals("UnknownSnapshotCopyRegionFault"))
            return null;

        UnknownSnapshotCopyRegionException e = (UnknownSnapshotCopyRegionException) super
                .unmarshall(node);
