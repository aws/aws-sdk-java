...
/**
 * DeleteSnapshotCopyGrantResult StAX Unmarshaller
 */
public class DeleteSnapshotCopyGrantResultStaxUnmarshaller implements
        Unmarshaller<DeleteSnapshotCopyGrantResult, StaxUnmarshallerContext> {

    public DeleteSnapshotCopyGrantResult unmarshall(
