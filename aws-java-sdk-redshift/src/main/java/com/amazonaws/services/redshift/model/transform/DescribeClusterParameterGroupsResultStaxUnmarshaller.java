 ...
 */
public class DescribeClusterParameterGroupsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeClusterParameterGroupsResult, StaxUnmarshallerContext> {

    public DescribeClusterParameterGroupsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression(
                        "ParameterGroups/ClusterParameterGroup", targetDepth)) {
                    describeClusterParameterGroupsResult
                            .withParameterGroups(ClusterParameterGroupStaxUnmarshaller
