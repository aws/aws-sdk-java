...
public class DescribeTableRestoreStatusResult extends
    ...
    public void setTableRestoreStatusDetails(
        ...
        this.tableRestoreStatusDetails = new com.amazonaws.internal.SdkInternalList<TableRestoreStatus>(
     ...
     * any). Use {@link #setTableRestoreStatusDetails(java.util.Collection)} or
     * {@link #withTableRestoreStatusDetails(java.util.Collection)} if you want
    ...
    public DescribeTableRestoreStatusResult withTableRestoreStatusDetails(
        ...
        if (this.tableRestoreStatusDetails == null) {
            setTableRestoreStatusDetails(new com.amazonaws.internal.SdkInternalList<TableRestoreStatus>(
    ...
    public String toString() {
        ...
        if (getTableRestoreStatusDetails() != null)
            sb.append("TableRestoreStatusDetails: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTableRestoreStatusDetails() == null
            ...
            return false;
        if (other.getTableRestoreStatusDetails() != null
                && other.getTableRestoreStatusDetails().equals(
                        this.getTableRestoreStatusDetails()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getTableRestoreStatusDetails() == null) ? 0
                        : getTableRestoreStatusDetails().hashCode());
