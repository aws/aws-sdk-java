 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/UsageLimit" target="_top">AWS API
 *      Documentation</a>
 */
...
public class UsageLimit implements Serializable, Cloneable {
    ...
    public UsageLimit withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
