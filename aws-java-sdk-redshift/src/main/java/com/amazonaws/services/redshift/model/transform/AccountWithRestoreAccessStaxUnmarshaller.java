 ...
 */
public class AccountWithRestoreAccessStaxUnmarshaller implements
        Unmarshaller<AccountWithRestoreAccess, StaxUnmarshallerContext> {

    public AccountWithRestoreAccess unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("AccountId", targetDepth)) {
                    accountWithRestoreAccess
                            .setAccountId(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
