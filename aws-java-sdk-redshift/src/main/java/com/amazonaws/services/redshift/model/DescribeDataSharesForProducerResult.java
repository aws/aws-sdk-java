...
public class DescribeDataSharesForProducerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return Shows the results of datashares available for producers.
     */
    ...
    public DescribeDataSharesForProducerResult withDataShares(java.util.Collection<DataShare> dataShares) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeDataSharesForProducerResult == false)
            return false;
        DescribeDataSharesForProducerResult other = (DescribeDataSharesForProducerResult) obj;
    ...
    @Override
    public DescribeDataSharesForProducerResult clone() {
        try {
            return (DescribeDataSharesForProducerResult) super.clone();
