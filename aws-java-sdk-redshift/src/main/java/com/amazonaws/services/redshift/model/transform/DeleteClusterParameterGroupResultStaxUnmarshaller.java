 ...
 */
public class DeleteClusterParameterGroupResultStaxUnmarshaller
        implements
        Unmarshaller<DeleteClusterParameterGroupResult, StaxUnmarshallerContext> {

    public DeleteClusterParameterGroupResult unmarshall(
