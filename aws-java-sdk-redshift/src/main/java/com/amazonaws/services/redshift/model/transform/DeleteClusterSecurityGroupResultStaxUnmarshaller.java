 ...
 */
public class DeleteClusterSecurityGroupResultStaxUnmarshaller implements
        Unmarshaller<DeleteClusterSecurityGroupResult, StaxUnmarshallerContext> {

    public DeleteClusterSecurityGroupResult unmarshall(
