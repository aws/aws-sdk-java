...
/**
 * ReferenceLink StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReferenceLinkStaxUnmarshaller implements Unmarshaller<ReferenceLink, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Text", targetDepth)) {
                    referenceLink.setText(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Link", targetDepth)) {
                    referenceLink.setLink(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
