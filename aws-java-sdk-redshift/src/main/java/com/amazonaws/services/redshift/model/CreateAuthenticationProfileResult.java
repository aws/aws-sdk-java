...
public class CreateAuthenticationProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the authentication profile that was created.
     */
     ...
     * </p>
     * 
     * @return The content of the authentication profile in JSON format.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAuthenticationProfileResult == false)
            return false;
        CreateAuthenticationProfileResult other = (CreateAuthenticationProfileResult) obj;
    ...
    public CreateAuthenticationProfileResult clone() {
        try {
            return (CreateAuthenticationProfileResult) super.clone();
