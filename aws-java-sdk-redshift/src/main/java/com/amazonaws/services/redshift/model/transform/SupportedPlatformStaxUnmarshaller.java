...
/**
 * SupportedPlatform StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SupportedPlatformStaxUnmarshaller implements Unmarshaller<SupportedPlatform, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Name", targetDepth)) {
                    supportedPlatform.setName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
