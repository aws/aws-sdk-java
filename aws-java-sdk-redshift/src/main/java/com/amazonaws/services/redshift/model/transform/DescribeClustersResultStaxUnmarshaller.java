...
public class DescribeClustersResultStaxUnmarshaller implements Unmarshaller<DescribeClustersResult, StaxUnmarshallerContext> {
    ...
    public DescribeClustersResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeClustersResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("Marker", targetDepth)) {
                    describeClustersResult.setMarker(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("Clusters/Cluster", targetDepth)) {
                    describeClustersResult.getClusters().add(ClusterStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeClustersResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeClustersResultStaxUnmarshaller();
        return instance;
    }
}
