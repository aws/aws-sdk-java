...
public class AmazonRedshiftWaiters {
    ...
    public Waiter<DescribeClustersRequest> clusterDeleted() {
        ...
        return new WaiterBuilder<DescribeClustersRequest, DescribeClustersResult>()
                ...
                .withAcceptors(new ClusterDeleted.IsClusterNotFoundMatcher(),
                        new ClusterDeleted.IsCreatingMatcher(),
                        new ClusterDeleted.IsModifyingMatcher())
                .withDefaultPollingStrategy(
                        new PollingStrategy(new MaxAttemptsRetryStrategy(30),
                                new FixedDelayStrategy(60)))
                .withExecutorService(executorService).build();
    }

    /**
     * Builds a SnapshotAvailable waiter by using custom parameters
     * waiterParameters and other parameters defined in the waiters
     * specification, and then polls until it determines whether the resource
     * entered the desired state or not, where polling criteria is bound by
     * either default polling strategy or custom polling strategy.
    ...
    public Waiter<DescribeClusterSnapshotsRequest> snapshotAvailable() {
        ...
        return new WaiterBuilder<DescribeClusterSnapshotsRequest, DescribeClusterSnapshotsResult>()
                ...
                .withAcceptors(new SnapshotAvailable.IsAvailableMatcher(),
                        new SnapshotAvailable.IsFailedMatcher(),
                        new SnapshotAvailable.IsDeletedMatcher())
                .withDefaultPollingStrategy(
    ...
    public Waiter<DescribeClustersRequest> clusterRestored() {
        ...
        return new WaiterBuilder<DescribeClustersRequest, DescribeClustersResult>()
                .withSdkFunction(new DescribeClustersFunction(client))
                .withAcceptors(new ClusterRestored.IsCompletedMatcher(),
                        new ClusterRestored.IsDeletingMatcher())
                .withDefaultPollingStrategy(
                        new PollingStrategy(new MaxAttemptsRetryStrategy(30),
                                new FixedDelayStrategy(60)))
                .withExecutorService(executorService).build();
    ...
    public Waiter<DescribeClustersRequest> clusterAvailable() {
        ...
        return new WaiterBuilder<DescribeClustersRequest, DescribeClustersResult>()
                .withSdkFunction(new DescribeClustersFunction(client))
                .withAcceptors(new ClusterAvailable.IsAvailableMatcher(),
