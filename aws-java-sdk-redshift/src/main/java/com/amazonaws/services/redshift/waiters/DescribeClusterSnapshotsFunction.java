...
@SdkInternalApi
public class DescribeClusterSnapshotsFunction
        implements
        SdkFunction<DescribeClusterSnapshotsRequest, DescribeClusterSnapshotsResult> {
     ...
     */
    @Override
    public DescribeClusterSnapshotsResult apply(
