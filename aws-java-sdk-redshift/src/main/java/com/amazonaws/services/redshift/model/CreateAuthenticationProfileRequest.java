...
public class CreateAuthenticationProfileRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The content of the authentication profile in JSON format. The maximum length of the JSON string is determined by
     * a quota for your account.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The name of the authentication profile to be created.
     */
     ...
     * </p>
     * 
     * @return The content of the authentication profile in JSON format. The maximum length of the JSON string is
     *         determined by a quota for your account.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAuthenticationProfileRequest == false)
            return false;
        CreateAuthenticationProfileRequest other = (CreateAuthenticationProfileRequest) obj;
    ...
    public CreateAuthenticationProfileRequest clone() {
        return (CreateAuthenticationProfileRequest) super.clone();
    }
