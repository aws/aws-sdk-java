...
public class ClusterSnapshotCopyStatus implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The destination region that snapshots are automatically copied to
     *         when cross-region snapshot copy is enabled.
     */
    ...
    public ClusterSnapshotCopyStatus withDestinationRegion(
    ...
    public ClusterSnapshotCopyStatus withSnapshotCopyGrantName(
