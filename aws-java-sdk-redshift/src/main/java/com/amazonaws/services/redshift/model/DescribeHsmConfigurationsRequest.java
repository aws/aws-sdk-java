 ...
 * <p/>
 */
public class DescribeHsmConfigurationsRequest extends AmazonWebServiceRequest
     ...
     * </p>
     * 
     * @return The identifier of a specific Amazon Redshift HSM configuration to
     *         be described. If no identifier is specified, information is
     *         returned for all HSM configurations owned by your AWS customer
     *         account.
     */
    ...
    public DescribeHsmConfigurationsRequest withTagKeys(
    ...
    public DescribeHsmConfigurationsRequest withTagValues(
