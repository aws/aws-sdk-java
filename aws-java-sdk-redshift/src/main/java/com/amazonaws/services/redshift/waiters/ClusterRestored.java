...
class ClusterRestored {
    ...
    static class IsCompletedMatcher extends
            WaiterAcceptor<DescribeClustersResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(
                new JmesPathFlatten(new JmesPathField("Clusters")),
                new JmesPathSubExpression(new JmesPathField("RestoreStatus"),
    ...
    static class IsDeletingMatcher extends
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(
                new JmesPathFlatten(new JmesPathField("Clusters")),
                new JmesPathField("ClusterStatus"));
