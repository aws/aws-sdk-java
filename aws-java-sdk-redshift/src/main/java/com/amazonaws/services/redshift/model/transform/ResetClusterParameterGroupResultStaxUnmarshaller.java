 ...
 */
public class ResetClusterParameterGroupResultStaxUnmarshaller implements
        Unmarshaller<ResetClusterParameterGroupResult, StaxUnmarshallerContext> {

    public ResetClusterParameterGroupResult unmarshall(
