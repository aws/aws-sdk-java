...
/**
 * RevisionTarget StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RevisionTargetStaxUnmarshaller implements Unmarshaller<RevisionTarget, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DatabaseRevision", targetDepth)) {
                    revisionTarget.setDatabaseRevision(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Description", targetDepth)) {
                    revisionTarget.setDescription(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
