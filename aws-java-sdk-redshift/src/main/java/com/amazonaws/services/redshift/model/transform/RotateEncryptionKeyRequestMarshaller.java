...
public class RotateEncryptionKeyRequestMarshaller
        implements
        Marshaller<Request<RotateEncryptionKeyRequest>, RotateEncryptionKeyRequest> {

    public Request<RotateEncryptionKeyRequest> marshall(
        ...
        Request<RotateEncryptionKeyRequest> request = new DefaultRequest<RotateEncryptionKeyRequest>(
                rotateEncryptionKeyRequest, "AmazonRedshift");
        ...
        if (rotateEncryptionKeyRequest.getClusterIdentifier() != null) {
            request.addParameter("ClusterIdentifier", StringUtils
                    .fromString(rotateEncryptionKeyRequest
