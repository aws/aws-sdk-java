 ...
 */
public class OrderableClusterOptionStaxUnmarshaller implements
        Unmarshaller<OrderableClusterOption, StaxUnmarshallerContext> {

    public OrderableClusterOption unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ClusterType", targetDepth)) {
                    orderableClusterOption
                            .setClusterType(StringStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("NodeType", targetDepth)) {
                    orderableClusterOption.setNodeType(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
