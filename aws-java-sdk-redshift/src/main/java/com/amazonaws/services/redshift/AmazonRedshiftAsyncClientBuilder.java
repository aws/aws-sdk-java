...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.redshift.AmazonRedshiftAsync}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonRedshiftAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonRedshiftAsyncClientBuilder, AmazonRedshiftAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonRedshiftAsync using the
