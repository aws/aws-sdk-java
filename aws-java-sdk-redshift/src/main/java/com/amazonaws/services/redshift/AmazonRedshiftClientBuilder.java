...
/**
 * Fluent builder for {@link com.amazonaws.services.redshift.AmazonRedshift}.
 * Use of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonRedshiftClientBuilder extends
        AwsSyncClientBuilder<AmazonRedshiftClientBuilder, AmazonRedshift> {
    ...
    /**
     * Construct a synchronous implementation of AmazonRedshift using the
