 ...
 */
public class ClusterParameterGroupStaxUnmarshaller implements
        Unmarshaller<ClusterParameterGroup, StaxUnmarshallerContext> {

    public ClusterParameterGroup unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Description", targetDepth)) {
                    clusterParameterGroup.setDescription(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Tags/Tag", targetDepth)) {
                    clusterParameterGroup.withTags(TagStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
