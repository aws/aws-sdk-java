...
public class AuthorizeEndpointAccessResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AuthorizeEndpointAccessResult withGrantor(String grantor) {
        setGrantor(grantor);
        return this;
    }
    ...
    public AuthorizeEndpointAccessResult withGrantee(String grantee) {
        setGrantee(grantee);
        return this;
    }
    ...
    public AuthorizeEndpointAccessResult withClusterIdentifier(String clusterIdentifier) {
    ...
    public AuthorizeEndpointAccessResult withAuthorizeTime(java.util.Date authorizeTime) {
    ...
    public AuthorizeEndpointAccessResult withClusterStatus(String clusterStatus) {
    ...
    public AuthorizeEndpointAccessResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public AuthorizeEndpointAccessResult withStatus(AuthorizationStatus status) {
    ...
    public AuthorizeEndpointAccessResult withAllowedAllVPCs(Boolean allowedAllVPCs) {
    ...
    public AuthorizeEndpointAccessResult withAllowedVPCs(String... allowedVPCs) {
    ...
    public AuthorizeEndpointAccessResult withAllowedVPCs(java.util.Collection<String> allowedVPCs) {
    ...
    public AuthorizeEndpointAccessResult withEndpointCount(Integer endpointCount) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AuthorizeEndpointAccessResult == false)
            return false;
        AuthorizeEndpointAccessResult other = (AuthorizeEndpointAccessResult) obj;
    ...
    @Override
    public AuthorizeEndpointAccessResult clone() {
        try {
