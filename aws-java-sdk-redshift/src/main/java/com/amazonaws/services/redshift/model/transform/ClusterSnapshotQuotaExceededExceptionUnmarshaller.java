...
public class ClusterSnapshotQuotaExceededExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null
                || !errorCode.equals("ClusterSnapshotQuotaExceeded"))
            return null;

        ClusterSnapshotQuotaExceededException e = (ClusterSnapshotQuotaExceededException) super
                .unmarshall(node);
