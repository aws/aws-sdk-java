 ...
 * <p/>
 */
public class DescribeClusterParameterGroupsRequest extends
     ...
     * </p>
     * 
     * @return The name of a specific parameter group for which to return
     *         details. By default, details about all parameter groups and the
     *         default parameter group are returned.
     */
    ...
    public DescribeClusterParameterGroupsRequest withParameterGroupName(
    ...
    public DescribeClusterParameterGroupsRequest withMaxRecords(
            Integer maxRecords) {
     ...
     *        the request, Amazon Redshift returns a response with the parameter
    ...
    public DescribeClusterParameterGroupsRequest withTagKeys(
