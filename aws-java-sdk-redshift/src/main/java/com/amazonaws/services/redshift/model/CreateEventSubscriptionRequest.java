...
public class CreateEventSubscriptionRequest extends AmazonWebServiceRequest
     ...
     * </p>
     * 
     * @return A list of one or more identifiers of Amazon Redshift source
     ...
     * </p>
     * 
     * @return Specifies the Amazon Redshift event categories to be published by
     ...
     * </p>
     * 
     * @return Specifies the Amazon Redshift event severity to be published by
     *         the event notification subscription.</p>
     *         <p>
     *         Values: ERROR, INFO
     */
     ...
     *         subscription, set to <code>false</code> to create the
