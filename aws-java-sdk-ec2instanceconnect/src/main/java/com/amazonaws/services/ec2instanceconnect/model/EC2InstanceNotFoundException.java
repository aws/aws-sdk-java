...
public class EC2InstanceNotFoundException extends com.amazonaws.services.ec2instanceconnect.model.AWSEC2InstanceConnectException {
     ...
     */
    public EC2InstanceNotFoundException(String message) {
        super(message);
    }
