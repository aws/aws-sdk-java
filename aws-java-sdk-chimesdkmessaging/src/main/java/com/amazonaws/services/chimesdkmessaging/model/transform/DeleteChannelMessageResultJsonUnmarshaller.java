...
/**
 * DeleteChannelMessageResult JSON Unmarshaller
 */
...
public class DeleteChannelMessageResultJsonUnmarshaller implements Unmarshaller<DeleteChannelMessageResult, JsonUnmarshallerContext> {
    ...
    public DeleteChannelMessageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteChannelMessageResult deleteChannelMessageResult = new DeleteChannelMessageResult();
