...
/**
 * ProcessorConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProcessorConfigurationJsonUnmarshaller implements Unmarshaller<ProcessorConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Lambda", targetDepth)) {
                    context.nextToken();
                    processorConfiguration.setLambda(LambdaConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
