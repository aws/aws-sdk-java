...
/**
 * ChannelFlowSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChannelFlowSummaryJsonUnmarshaller implements Unmarshaller<ChannelFlowSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChannelFlowArn", targetDepth)) {
                    context.nextToken();
                    channelFlowSummary.setChannelFlowArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    channelFlowSummary.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Processors", targetDepth)) {
                    context.nextToken();
                    channelFlowSummary.setProcessors(new ListUnmarshaller<Processor>(ProcessorJsonUnmarshaller.getInstance())
