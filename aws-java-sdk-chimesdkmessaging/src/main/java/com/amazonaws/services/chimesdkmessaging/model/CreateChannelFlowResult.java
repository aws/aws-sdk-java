...
public class CreateChannelFlowResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateChannelFlowResult == false)
            return false;
        CreateChannelFlowResult other = (CreateChannelFlowResult) obj;
    ...
    public CreateChannelFlowResult clone() {
        try {
            return (CreateChannelFlowResult) super.clone();
