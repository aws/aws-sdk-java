...
public class GetChannelMessageStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetChannelMessageStatusRequest withChimeBearer(String chimeBearer) {
    ...
    public GetChannelMessageStatusRequest withSubChannelId(String subChannelId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetChannelMessageStatusRequest == false)
            return false;
        GetChannelMessageStatusRequest other = (GetChannelMessageStatusRequest) obj;
    ...
    public GetChannelMessageStatusRequest clone() {
        return (GetChannelMessageStatusRequest) super.clone();
    }
