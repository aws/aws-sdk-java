...
/**
 * DescribeChannelModeratedByAppInstanceUserResult JSON Unmarshaller
 */
...
public class DescribeChannelModeratedByAppInstanceUserResultJsonUnmarshaller implements
    ...
    public DescribeChannelModeratedByAppInstanceUserResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Channel", targetDepth)) {
                    context.nextToken();
                    describeChannelModeratedByAppInstanceUserResult.setChannel(ChannelModeratedByAppInstanceUserSummaryJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
