...
/**
 * ListChannelsAssociatedWithChannelFlowResult JSON Unmarshaller
 */
...
public class ListChannelsAssociatedWithChannelFlowResultJsonUnmarshaller implements
    ...
    public ListChannelsAssociatedWithChannelFlowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Channels", targetDepth)) {
                    context.nextToken();
                    listChannelsAssociatedWithChannelFlowResult.setChannels(new ListUnmarshaller<ChannelAssociatedWithFlowSummary>(
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listChannelsAssociatedWithChannelFlowResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
