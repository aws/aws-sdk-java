...
public class ListChannelsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> PRIVACY_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("privacy").build();
    ...
    public void marshall(ListChannelsRequest listChannelsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listChannelsRequest.getAppInstanceArn(), APPINSTANCEARN_BINDING);
            protocolMarshaller.marshall(listChannelsRequest.getPrivacy(), PRIVACY_BINDING);
            ...
            protocolMarshaller.marshall(listChannelsRequest.getChimeBearer(), CHIMEBEARER_BINDING);
        } catch (Exception e) {
