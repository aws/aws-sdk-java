...
@SdkInternalApi
public class CreateChannelBanRequestMarshaller {
    ...
    public static CreateChannelBanRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateChannelBanRequest createChannelBanRequest, ProtocolMarshaller protocolMarshaller) {
