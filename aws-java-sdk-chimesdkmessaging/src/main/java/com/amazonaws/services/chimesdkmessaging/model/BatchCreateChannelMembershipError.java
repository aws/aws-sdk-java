 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-messaging-2021-05-15/BatchCreateChannelMembershipError"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchCreateChannelMembershipError implements Serializable, Cloneable, StructuredPojo {
    ...
    public BatchCreateChannelMembershipError clone() {
        try {
            return (BatchCreateChannelMembershipError) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.chimesdkmessaging.model.transform.BatchCreateChannelMembershipErrorMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
