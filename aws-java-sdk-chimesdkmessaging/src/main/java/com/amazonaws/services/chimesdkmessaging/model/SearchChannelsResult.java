...
public class SearchChannelsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of the channels in the request.
     */
    ...
    public SearchChannelsResult withChannels(ChannelSummary... channels) {
    ...
    public SearchChannelsResult withChannels(java.util.Collection<ChannelSummary> channels) {
     ...
     * </p>
     * 
     * @return The token returned from previous API responses until the number of channels is reached.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchChannelsResult == false)
            return false;
        SearchChannelsResult other = (SearchChannelsResult) obj;
    ...
    public SearchChannelsResult clone() {
        try {
            return (SearchChannelsResult) super.clone();
