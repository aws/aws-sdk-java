...
/**
 * ChannelMembershipSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChannelMembershipSummaryJsonUnmarshaller implements Unmarshaller<ChannelMembershipSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Member", targetDepth)) {
                    context.nextToken();
                    channelMembershipSummary.setMember(IdentityJsonUnmarshaller.getInstance().unmarshall(context));
                }
