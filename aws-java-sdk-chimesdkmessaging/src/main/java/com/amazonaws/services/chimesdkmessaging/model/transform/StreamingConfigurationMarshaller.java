...
public class StreamingConfigurationMarshaller {
    ...
    public void marshall(StreamingConfiguration streamingConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(streamingConfiguration.getDataType(), DATATYPE_BINDING);
            protocolMarshaller.marshall(streamingConfiguration.getResourceArn(), RESOURCEARN_BINDING);
        } catch (Exception e) {
