...
/**
 * DescribeChannelMembershipRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeChannelMembershipRequestMarshaller {
    ...
    private static final MarshallingInfo<String> SUBCHANNELID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("sub-channel-id").build();

    private static final DescribeChannelMembershipRequestMarshaller instance = new DescribeChannelMembershipRequestMarshaller();

    public static DescribeChannelMembershipRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeChannelMembershipRequest describeChannelMembershipRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(describeChannelMembershipRequest.getSubChannelId(), SUBCHANNELID_BINDING);
        } catch (Exception e) {
