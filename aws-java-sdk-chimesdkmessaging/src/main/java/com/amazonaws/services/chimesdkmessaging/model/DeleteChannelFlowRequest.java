...
public class DeleteChannelFlowRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteChannelFlowRequest withChannelFlowArn(String channelFlowArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteChannelFlowRequest == false)
            return false;
        DeleteChannelFlowRequest other = (DeleteChannelFlowRequest) obj;
    ...
    @Override
    public DeleteChannelFlowRequest clone() {
        return (DeleteChannelFlowRequest) super.clone();
    }
