...
public class ListTablesRequestProtocolMarshaller implements Marshaller<Request<ListTablesRequest>, ListTablesRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.REST_JSON)
            .requestUri("/workbooks/{workbookId}/tables").httpMethodName(HttpMethodName.GET).hasExplicitPayloadMember(false).hasPayloadMembers(false)
            .serviceName("AmazonHoneycode").build();
