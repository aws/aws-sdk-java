...
/**
 * TableDataImportJobMetadata JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TableDataImportJobMetadataJsonUnmarshaller implements Unmarshaller<TableDataImportJobMetadata, JsonUnmarshallerContext> {

    public TableDataImportJobMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        TableDataImportJobMetadata tableDataImportJobMetadata = new TableDataImportJobMetadata();
    ...
    private static TableDataImportJobMetadataJsonUnmarshaller instance;

    public static TableDataImportJobMetadataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TableDataImportJobMetadataJsonUnmarshaller();
        return instance;
    }
}
