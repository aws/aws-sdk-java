...
public class DataItemMarshaller {
    ...
    private static final MarshallingInfo<String> OVERRIDEFORMAT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("overrideFormat").build();
    ...
    public void marshall(DataItem dataItem, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dataItem.getOverrideFormat(), OVERRIDEFORMAT_BINDING);
            protocolMarshaller.marshall(dataItem.getRawValue(), RAWVALUE_BINDING);
            protocolMarshaller.marshall(dataItem.getFormattedValue(), FORMATTEDVALUE_BINDING);
        } catch (Exception e) {
