...
@SdkInternalApi
public class TableRowMarshaller {
    ...
    private static final TableRowMarshaller instance = new TableRowMarshaller();

    public static TableRowMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TableRow tableRow, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(tableRow.getRowId(), ROWID_BINDING);
            protocolMarshaller.marshall(tableRow.getCells(), CELLS_BINDING);
        } catch (Exception e) {
