...
public class UnauthorizedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UnauthorizedExceptionUnmarshaller() {
        super(com.amazonaws.services.sso.model.UnauthorizedException.class, "UnauthorizedException");
    }

    @Override
    public com.amazonaws.services.sso.model.UnauthorizedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.sso.model.UnauthorizedException unauthorizedException = new com.amazonaws.services.sso.model.UnauthorizedException(null);
