...
public class PutHypervisorPropertyMappingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutHypervisorPropertyMappingsResult == false)
            return false;
        PutHypervisorPropertyMappingsResult other = (PutHypervisorPropertyMappingsResult) obj;
    ...
    public PutHypervisorPropertyMappingsResult clone() {
        try {
            return (PutHypervisorPropertyMappingsResult) super.clone();
