...
public class UpdateGatewaySoftwareNowResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateGatewaySoftwareNowResult == false)
            return false;
        UpdateGatewaySoftwareNowResult other = (UpdateGatewaySoftwareNowResult) obj;
    ...
    public UpdateGatewaySoftwareNowResult clone() {
        try {
            return (UpdateGatewaySoftwareNowResult) super.clone();
