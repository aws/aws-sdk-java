...
public class GetHypervisorRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetHypervisorRequest withHypervisorArn(String hypervisorArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetHypervisorRequest == false)
            return false;
        GetHypervisorRequest other = (GetHypervisorRequest) obj;
    ...
    @Override
    public GetHypervisorRequest clone() {
        return (GetHypervisorRequest) super.clone();
    }
