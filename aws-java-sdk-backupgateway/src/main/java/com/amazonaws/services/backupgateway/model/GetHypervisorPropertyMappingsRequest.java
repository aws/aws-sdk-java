...
public class GetHypervisorPropertyMappingsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetHypervisorPropertyMappingsRequest withHypervisorArn(String hypervisorArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetHypervisorPropertyMappingsRequest == false)
            return false;
        GetHypervisorPropertyMappingsRequest other = (GetHypervisorPropertyMappingsRequest) obj;
    ...
    @Override
    public GetHypervisorPropertyMappingsRequest clone() {
        return (GetHypervisorPropertyMappingsRequest) super.clone();
    }
