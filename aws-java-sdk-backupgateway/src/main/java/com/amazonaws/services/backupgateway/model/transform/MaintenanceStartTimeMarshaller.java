...
/**
 * MaintenanceStartTimeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MaintenanceStartTimeMarshaller {
    ...
    private static final MaintenanceStartTimeMarshaller instance = new MaintenanceStartTimeMarshaller();

    public static MaintenanceStartTimeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MaintenanceStartTime maintenanceStartTime, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(maintenanceStartTime.getDayOfMonth(), DAYOFMONTH_BINDING);
            protocolMarshaller.marshall(maintenanceStartTime.getDayOfWeek(), DAYOFWEEK_BINDING);
            protocolMarshaller.marshall(maintenanceStartTime.getHourOfDay(), HOUROFDAY_BINDING);
            protocolMarshaller.marshall(maintenanceStartTime.getMinuteOfHour(), MINUTEOFHOUR_BINDING);
        } catch (Exception e) {
