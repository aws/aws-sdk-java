...
public class GetHypervisorPropertyMappingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return This is a display of the mappings of on-premises VMware tags to the Amazon Web Services tags.
     */
    ...
    public GetHypervisorPropertyMappingsResult withVmwareToAwsTagMappings(VmwareToAwsTagMapping... vmwareToAwsTagMappings) {
    ...
    public GetHypervisorPropertyMappingsResult withVmwareToAwsTagMappings(java.util.Collection<VmwareToAwsTagMapping> vmwareToAwsTagMappings) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetHypervisorPropertyMappingsResult == false)
            return false;
        GetHypervisorPropertyMappingsResult other = (GetHypervisorPropertyMappingsResult) obj;
    ...
    public GetHypervisorPropertyMappingsResult clone() {
        try {
            return (GetHypervisorPropertyMappingsResult) super.clone();
