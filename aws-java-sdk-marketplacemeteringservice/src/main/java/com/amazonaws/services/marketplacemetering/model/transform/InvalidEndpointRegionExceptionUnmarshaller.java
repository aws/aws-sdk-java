...
public class InvalidEndpointRegionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidEndpointRegionExceptionUnmarshaller instance;

    public static InvalidEndpointRegionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidEndpointRegionExceptionUnmarshaller();
        return instance;
    }
}
