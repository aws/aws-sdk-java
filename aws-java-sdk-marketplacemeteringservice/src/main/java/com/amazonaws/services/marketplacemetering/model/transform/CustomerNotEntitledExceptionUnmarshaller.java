...
public class CustomerNotEntitledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CustomerNotEntitledExceptionUnmarshaller instance;

    public static CustomerNotEntitledExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CustomerNotEntitledExceptionUnmarshaller();
        return instance;
    }
}
