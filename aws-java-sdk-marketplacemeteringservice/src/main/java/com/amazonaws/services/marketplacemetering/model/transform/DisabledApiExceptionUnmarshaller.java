...
public class DisabledApiExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DisabledApiExceptionUnmarshaller instance;

    public static DisabledApiExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DisabledApiExceptionUnmarshaller();
        return instance;
    }
}
