...
public class InvalidPublicKeyVersionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidPublicKeyVersionExceptionUnmarshaller instance;

    public static InvalidPublicKeyVersionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidPublicKeyVersionExceptionUnmarshaller();
        return instance;
    }
}
