 ...
 */
@ThreadSafe
public class AWSMarketplaceMeteringAsyncClient extends
        AWSMarketplaceMeteringClient implements AWSMarketplaceMeteringAsync {
     ...
     * AWSMarketplace Metering. A credentials provider chain will be used that
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on
     * AWSMarketplace Metering using the specified parameters.
     *
