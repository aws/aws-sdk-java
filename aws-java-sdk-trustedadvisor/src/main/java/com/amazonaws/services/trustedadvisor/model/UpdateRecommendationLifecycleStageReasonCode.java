...
public enum UpdateRecommendationLifecycleStageReasonCode {
    ...
    private UpdateRecommendationLifecycleStageReasonCode(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return UpdateRecommendationLifecycleStageReasonCode corresponding to the value
     *
    ...
    public static UpdateRecommendationLifecycleStageReasonCode fromValue(String value) {
        ...
        for (UpdateRecommendationLifecycleStageReasonCode enumEntry : UpdateRecommendationLifecycleStageReasonCode.values()) {
