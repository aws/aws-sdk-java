...
public class GetOrganizationRecommendationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetOrganizationRecommendationRequest == false)
            return false;
        GetOrganizationRecommendationRequest other = (GetOrganizationRecommendationRequest) obj;
    ...
    @Override
    public GetOrganizationRecommendationRequest clone() {
        return (GetOrganizationRecommendationRequest) super.clone();
    }
