...
public class CheckSummaryMarshaller {
    ...
    public void marshall(CheckSummary checkSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(checkSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(checkSummary.getAwsServices(), AWSSERVICES_BINDING);
            ...
            protocolMarshaller.marshall(checkSummary.getMetadata(), METADATA_BINDING);
            protocolMarshaller.marshall(checkSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(checkSummary.getPillars(), PILLARS_BINDING);
            protocolMarshaller.marshall(checkSummary.getSource(), SOURCE_BINDING);
        } catch (Exception e) {
