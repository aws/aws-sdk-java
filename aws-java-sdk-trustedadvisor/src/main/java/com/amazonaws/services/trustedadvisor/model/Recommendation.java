 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/trustedadvisor-2022-09-15/Recommendation" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Recommendation implements Serializable, Cloneable, StructuredPojo {
    ...
    public Recommendation withAwsServices(String... awsServices) {
    ...
    public Recommendation withAwsServices(java.util.Collection<String> awsServices) {
    ...
    public Recommendation withLastUpdatedAt(java.util.Date lastUpdatedAt) {
    ...
    public Recommendation withPillars(java.util.Collection<String> pillars) {
        setPillars(pillars);
        return this;
    }
    ...
    public Recommendation withResolvedAt(java.util.Date resolvedAt) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.trustedadvisor.model.transform.RecommendationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
