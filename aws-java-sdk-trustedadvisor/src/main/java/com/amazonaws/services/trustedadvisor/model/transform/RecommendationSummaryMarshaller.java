...
public class RecommendationSummaryMarshaller {
    ...
    public void marshall(RecommendationSummary recommendationSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(recommendationSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getAwsServices(), AWSSERVICES_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getCheckArn(), CHECKARN_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getLastUpdatedAt(), LASTUPDATEDAT_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getLifecycleStage(), LIFECYCLESTAGE_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getPillarSpecificAggregates(), PILLARSPECIFICAGGREGATES_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getPillars(), PILLARS_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getResourcesAggregates(), RESOURCESAGGREGATES_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getSource(), SOURCE_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(recommendationSummary.getType(), TYPE_BINDING);
        } catch (Exception e) {
