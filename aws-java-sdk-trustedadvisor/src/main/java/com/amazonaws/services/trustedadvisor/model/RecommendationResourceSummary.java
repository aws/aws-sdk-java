 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/trustedadvisor-2022-09-15/RecommendationResourceSummary"
...
public class RecommendationResourceSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public RecommendationResourceSummary withExclusionStatus(String exclusionStatus) {
    ...
    public RecommendationResourceSummary withLastUpdatedAt(java.util.Date lastUpdatedAt) {
    ...
    public RecommendationResourceSummary withMetadata(java.util.Map<String, String> metadata) {
     ...
     *
     * @see RecommendationResourceSummary#withMetadata
     * @returns a reference to this object so that method calls can be chained together.
     */

    public RecommendationResourceSummary addMetadataEntry(String key, String value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RecommendationResourceSummary == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.trustedadvisor.model.transform.RecommendationResourceSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
