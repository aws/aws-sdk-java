...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.trustedadvisor.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.trustedadvisor.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.trustedadvisor.model.ValidationException validationException = new com.amazonaws.services.trustedadvisor.model.ValidationException(
                null);
