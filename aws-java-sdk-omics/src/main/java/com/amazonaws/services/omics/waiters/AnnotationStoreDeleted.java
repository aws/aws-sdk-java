...
class AnnotationStoreDeleted {
    ...
    static class IsDELETEDMatcher extends WaiterAcceptor<GetAnnotationStoreResult> {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<GetAnnotationStoreResult> {
        /**
    ...
    static class IsDELETINGMatcher extends WaiterAcceptor<GetAnnotationStoreResult> {
        private static final JsonNode expectedResult;
