...
public class GetVariantStoreFunction implements SdkFunction<GetVariantStoreRequest, GetVariantStoreResult> {
    ...
    /**
     * Constructs a new GetVariantStoreFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetVariantStoreFunction(AmazonOmics client) {
        this.client = client;
    }
    ...
    public GetVariantStoreResult apply(GetVariantStoreRequest getVariantStoreRequest) {
        return client.getVariantStore(getVariantStoreRequest);
    }
}
