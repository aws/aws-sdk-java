...
class AnnotationStoreCreated {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<GetAnnotationStoreResult> {
         ...
         */
        @Override
        public boolean matches(GetAnnotationStoreResult result) {
    ...
    static class IsCREATINGMatcher extends WaiterAcceptor<GetAnnotationStoreResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATINGMatcher extends WaiterAcceptor<GetAnnotationStoreResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetAnnotationStoreResult> {
        private static final JsonNode expectedResult;
