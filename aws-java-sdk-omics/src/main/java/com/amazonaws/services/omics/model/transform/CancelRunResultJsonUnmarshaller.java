...
/**
 * CancelRunResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CancelRunResultJsonUnmarshaller implements Unmarshaller<CancelRunResult, JsonUnmarshallerContext> {

    public CancelRunResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelRunResult cancelRunResult = new CancelRunResult();
