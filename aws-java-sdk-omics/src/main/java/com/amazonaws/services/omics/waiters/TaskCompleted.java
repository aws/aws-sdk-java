...
class TaskCompleted {
    ...
    static class IsCOMPLETEDMatcher extends WaiterAcceptor<GetRunTaskResult> {
         ...
         */
        @Override
        public boolean matches(GetRunTaskResult result) {
    ...
    static class IsPENDINGMatcher extends WaiterAcceptor<GetRunTaskResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsSTARTINGMatcher extends WaiterAcceptor<GetRunTaskResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsRUNNINGMatcher extends WaiterAcceptor<GetRunTaskResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsSTOPPINGMatcher extends WaiterAcceptor<GetRunTaskResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetRunTaskResult> {
        private static final JsonNode expectedResult;
