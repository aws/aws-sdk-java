...
/**
 * VariantImportJobItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VariantImportJobItemJsonUnmarshaller implements Unmarshaller<VariantImportJobItem, JsonUnmarshallerContext> {

    public VariantImportJobItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        VariantImportJobItem variantImportJobItem = new VariantImportJobItem();
    ...
    private static VariantImportJobItemJsonUnmarshaller instance;

    public static VariantImportJobItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new VariantImportJobItemJsonUnmarshaller();
        return instance;
    }
}
