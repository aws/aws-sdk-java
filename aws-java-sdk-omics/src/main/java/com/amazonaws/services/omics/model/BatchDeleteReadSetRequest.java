...
public class BatchDeleteReadSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public BatchDeleteReadSetRequest withIds(String... ids) {
        if (this.ids == null) {
    ...
    public BatchDeleteReadSetRequest withIds(java.util.Collection<String> ids) {
        setIds(ids);
        return this;
    }
     ...
     * </p>
     * 
     * @return The read sets' sequence store ID.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchDeleteReadSetRequest == false)
            return false;
        BatchDeleteReadSetRequest other = (BatchDeleteReadSetRequest) obj;
