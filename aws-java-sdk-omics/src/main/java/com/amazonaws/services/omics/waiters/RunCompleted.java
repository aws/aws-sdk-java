...
class RunCompleted {
    ...
    static class IsCOMPLETEDMatcher extends WaiterAcceptor<GetRunResult> {
         ...
         */
        @Override
        public boolean matches(GetRunResult result) {
    ...
    static class IsPENDINGMatcher extends WaiterAcceptor<GetRunResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsSTARTINGMatcher extends WaiterAcceptor<GetRunResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsRUNNINGMatcher extends WaiterAcceptor<GetRunResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsSTOPPINGMatcher extends WaiterAcceptor<GetRunResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetRunResult> {
        private static final JsonNode expectedResult;
