...
class ReferenceImportJobCompleted {
    ...
    static class IsCOMPLETEDMatcher extends WaiterAcceptor<GetReferenceImportJobResult> {
         ...
         */
        @Override
        public boolean matches(GetReferenceImportJobResult result) {
    ...
    static class IsSUBMITTEDMatcher extends WaiterAcceptor<GetReferenceImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIN_PROGRESSMatcher extends WaiterAcceptor<GetReferenceImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCANCELLINGMatcher extends WaiterAcceptor<GetReferenceImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCANCELLEDMatcher extends WaiterAcceptor<GetReferenceImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetReferenceImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCOMPLETED_WITH_FAILURESMatcher extends WaiterAcceptor<GetReferenceImportJobResult> {
        private static final JsonNode expectedResult;
