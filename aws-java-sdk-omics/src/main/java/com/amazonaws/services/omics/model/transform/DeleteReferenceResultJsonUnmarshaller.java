...
/**
 * DeleteReferenceResult JSON Unmarshaller
 */
...
public class DeleteReferenceResultJsonUnmarshaller implements Unmarshaller<DeleteReferenceResult, JsonUnmarshallerContext> {
    ...
    public DeleteReferenceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteReferenceResult deleteReferenceResult = new DeleteReferenceResult();
