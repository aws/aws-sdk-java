...
public class BatchGetRepositoriesRequestMarshaller implements Marshaller<Request<BatchGetRepositoriesRequest>, BatchGetRepositoriesRequest> {
    ...
    public Request<BatchGetRepositoriesRequest> marshall(BatchGetRepositoriesRequest batchGetRepositoriesRequest) {
        ...
        Request<BatchGetRepositoriesRequest> request = new DefaultRequest<BatchGetRepositoriesRequest>(batchGetRepositoriesRequest, "AWSCodeCommit");
        ...
        try {
            ...
            java.util.List<String> repositoryNamesList = batchGetRepositoriesRequest.getRepositoryNames();
