...
public class OverrideStatusRequiredException extends com.amazonaws.services.codecommit.model.AWSCodeCommitException {
     ...
     */
    public OverrideStatusRequiredException(String message) {
        super(message);
    }
