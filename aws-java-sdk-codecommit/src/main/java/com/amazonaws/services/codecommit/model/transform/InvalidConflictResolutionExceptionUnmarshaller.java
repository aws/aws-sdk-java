...
public class InvalidConflictResolutionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidConflictResolutionExceptionUnmarshaller instance;

    public static InvalidConflictResolutionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidConflictResolutionExceptionUnmarshaller();
        return instance;
    }
}
