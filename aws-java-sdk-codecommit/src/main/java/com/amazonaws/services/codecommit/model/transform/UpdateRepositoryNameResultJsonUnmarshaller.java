 ...
 */
public class UpdateRepositoryNameResultJsonUnmarshaller implements
        Unmarshaller<UpdateRepositoryNameResult, JsonUnmarshallerContext> {

    public UpdateRepositoryNameResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
