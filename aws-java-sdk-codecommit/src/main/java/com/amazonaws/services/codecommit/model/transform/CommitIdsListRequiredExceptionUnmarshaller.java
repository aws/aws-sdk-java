...
public class CommitIdsListRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CommitIdsListRequiredExceptionUnmarshaller instance;

    public static CommitIdsListRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CommitIdsListRequiredExceptionUnmarshaller();
        return instance;
    }
}
