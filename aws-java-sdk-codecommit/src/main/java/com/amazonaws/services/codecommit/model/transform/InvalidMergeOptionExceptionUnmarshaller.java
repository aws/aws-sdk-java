...
public class InvalidMergeOptionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidMergeOptionExceptionUnmarshaller instance;

    public static InvalidMergeOptionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidMergeOptionExceptionUnmarshaller();
        return instance;
    }
}
