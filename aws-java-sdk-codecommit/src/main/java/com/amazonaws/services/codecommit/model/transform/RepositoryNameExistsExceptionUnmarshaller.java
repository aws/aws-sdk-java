...
public class RepositoryNameExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RepositoryNameExistsExceptionUnmarshaller instance;

    public static RepositoryNameExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RepositoryNameExistsExceptionUnmarshaller();
        return instance;
    }
}
