...
public class EncryptionKeyAccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EncryptionKeyAccessDeniedExceptionUnmarshaller instance;

    public static EncryptionKeyAccessDeniedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EncryptionKeyAccessDeniedExceptionUnmarshaller();
        return instance;
    }
}
