...
public class RepositoryTriggerEventsListRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RepositoryTriggerEventsListRequiredExceptionUnmarshaller instance;

    public static RepositoryTriggerEventsListRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RepositoryTriggerEventsListRequiredExceptionUnmarshaller();
        return instance;
    }
}
