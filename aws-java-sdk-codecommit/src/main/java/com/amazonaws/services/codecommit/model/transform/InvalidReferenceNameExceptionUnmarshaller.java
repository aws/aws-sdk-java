...
public class InvalidReferenceNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidReferenceNameExceptionUnmarshaller instance;

    public static InvalidReferenceNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidReferenceNameExceptionUnmarshaller();
        return instance;
    }
}
