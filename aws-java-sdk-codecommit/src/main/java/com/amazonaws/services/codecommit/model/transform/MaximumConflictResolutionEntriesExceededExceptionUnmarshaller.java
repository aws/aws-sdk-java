...
public class MaximumConflictResolutionEntriesExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaximumConflictResolutionEntriesExceededExceptionUnmarshaller instance;

    public static MaximumConflictResolutionEntriesExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaximumConflictResolutionEntriesExceededExceptionUnmarshaller();
        return instance;
    }
}
