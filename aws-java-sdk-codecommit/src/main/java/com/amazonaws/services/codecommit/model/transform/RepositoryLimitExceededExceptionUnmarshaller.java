...
public class RepositoryLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RepositoryLimitExceededExceptionUnmarshaller instance;

    public static RepositoryLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RepositoryLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
