...
public class InvalidDestinationCommitSpecifierExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDestinationCommitSpecifierExceptionUnmarshaller instance;

    public static InvalidDestinationCommitSpecifierExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDestinationCommitSpecifierExceptionUnmarshaller();
        return instance;
    }
}
