...
public class FileContentAndSourceFileSpecifiedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FileContentAndSourceFileSpecifiedExceptionUnmarshaller instance;

    public static FileContentAndSourceFileSpecifiedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileContentAndSourceFileSpecifiedExceptionUnmarshaller();
        return instance;
    }
}
