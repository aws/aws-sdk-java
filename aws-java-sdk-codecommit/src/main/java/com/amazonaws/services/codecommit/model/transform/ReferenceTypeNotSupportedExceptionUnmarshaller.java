...
public class ReferenceTypeNotSupportedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ReferenceTypeNotSupportedExceptionUnmarshaller instance;

    public static ReferenceTypeNotSupportedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReferenceTypeNotSupportedExceptionUnmarshaller();
        return instance;
    }
}
