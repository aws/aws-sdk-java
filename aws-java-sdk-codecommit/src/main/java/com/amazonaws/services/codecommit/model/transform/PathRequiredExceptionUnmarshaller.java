...
public class PathRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PathRequiredExceptionUnmarshaller instance;

    public static PathRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PathRequiredExceptionUnmarshaller();
        return instance;
    }
}
