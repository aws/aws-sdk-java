...
public class BlobIdRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static BlobIdRequiredExceptionUnmarshaller instance;

    public static BlobIdRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BlobIdRequiredExceptionUnmarshaller();
        return instance;
    }
}
