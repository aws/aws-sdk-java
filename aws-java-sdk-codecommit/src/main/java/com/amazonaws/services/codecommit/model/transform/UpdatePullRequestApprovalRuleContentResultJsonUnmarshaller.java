...
/**
 * UpdatePullRequestApprovalRuleContentResult JSON Unmarshaller
 */
...
public class UpdatePullRequestApprovalRuleContentResultJsonUnmarshaller implements
    ...
    public UpdatePullRequestApprovalRuleContentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("approvalRule", targetDepth)) {
                    context.nextToken();
                    updatePullRequestApprovalRuleContentResult.setApprovalRule(ApprovalRuleJsonUnmarshaller.getInstance().unmarshall(context));
                }
