...
public class GetPullRequestResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPullRequestResult == false)
            return false;
        GetPullRequestResult other = (GetPullRequestResult) obj;
    ...
    public GetPullRequestResult clone() {
        try {
            return (GetPullRequestResult) super.clone();
