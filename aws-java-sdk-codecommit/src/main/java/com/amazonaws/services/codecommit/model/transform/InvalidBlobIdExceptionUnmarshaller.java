...
public class InvalidBlobIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidBlobIdExceptionUnmarshaller instance;

    public static InvalidBlobIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidBlobIdExceptionUnmarshaller();
        return instance;
    }
}
