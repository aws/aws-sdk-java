...
public class EncryptionKeyUnavailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EncryptionKeyUnavailableExceptionUnmarshaller instance;

    public static EncryptionKeyUnavailableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EncryptionKeyUnavailableExceptionUnmarshaller();
        return instance;
    }
}
