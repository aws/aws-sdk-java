...
public class InvalidRepositoryTriggerBranchNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidRepositoryTriggerBranchNameExceptionUnmarshaller instance;

    public static InvalidRepositoryTriggerBranchNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRepositoryTriggerBranchNameExceptionUnmarshaller();
        return instance;
    }
}
