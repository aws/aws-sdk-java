...
public class UpdateApprovalRuleTemplateContentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateApprovalRuleTemplateContentResult withApprovalRuleTemplate(ApprovalRuleTemplate approvalRuleTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateApprovalRuleTemplateContentResult == false)
            return false;
        UpdateApprovalRuleTemplateContentResult other = (UpdateApprovalRuleTemplateContentResult) obj;
    ...
    @Override
    public UpdateApprovalRuleTemplateContentResult clone() {
        try {
            return (UpdateApprovalRuleTemplateContentResult) super.clone();
