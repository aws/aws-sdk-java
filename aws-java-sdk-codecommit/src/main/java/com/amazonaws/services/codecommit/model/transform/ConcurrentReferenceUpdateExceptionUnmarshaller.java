...
public class ConcurrentReferenceUpdateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ConcurrentReferenceUpdateExceptionUnmarshaller instance;

    public static ConcurrentReferenceUpdateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConcurrentReferenceUpdateExceptionUnmarshaller();
        return instance;
    }
}
