...
public class FilePathConflictsWithSubmodulePathExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FilePathConflictsWithSubmodulePathExceptionUnmarshaller instance;

    public static FilePathConflictsWithSubmodulePathExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FilePathConflictsWithSubmodulePathExceptionUnmarshaller();
        return instance;
    }
}
