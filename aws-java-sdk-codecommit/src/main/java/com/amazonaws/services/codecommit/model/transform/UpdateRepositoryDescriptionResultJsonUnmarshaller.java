 ...
 */
public class UpdateRepositoryDescriptionResultJsonUnmarshaller
        implements
        Unmarshaller<UpdateRepositoryDescriptionResult, JsonUnmarshallerContext> {

    public UpdateRepositoryDescriptionResult unmarshall(
