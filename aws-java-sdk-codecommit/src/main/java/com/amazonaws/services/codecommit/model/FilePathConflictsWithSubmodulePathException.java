...
public class FilePathConflictsWithSubmodulePathException extends com.amazonaws.services.codecommit.model.AWSCodeCommitException {
     ...
     */
    public FilePathConflictsWithSubmodulePathException(String message) {
        super(message);
    }
