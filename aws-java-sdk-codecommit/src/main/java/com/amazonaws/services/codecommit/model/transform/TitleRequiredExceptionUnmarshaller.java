...
public class TitleRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TitleRequiredExceptionUnmarshaller instance;

    public static TitleRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TitleRequiredExceptionUnmarshaller();
        return instance;
    }
}
