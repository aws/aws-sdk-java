...
public class CreateRepositoryRequestMarshaller implements Marshaller<Request<CreateRepositoryRequest>, CreateRepositoryRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public CreateRepositoryRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<CreateRepositoryRequest> marshall(CreateRepositoryRequest createRepositoryRequest) {
        ...
        Request<CreateRepositoryRequest> request = new DefaultRequest<CreateRepositoryRequest>(createRepositoryRequest, "AWSCodeCommit");
