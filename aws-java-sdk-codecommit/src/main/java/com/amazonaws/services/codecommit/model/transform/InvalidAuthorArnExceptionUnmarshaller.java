...
public class InvalidAuthorArnExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidAuthorArnExceptionUnmarshaller instance;

    public static InvalidAuthorArnExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidAuthorArnExceptionUnmarshaller();
        return instance;
    }
}
