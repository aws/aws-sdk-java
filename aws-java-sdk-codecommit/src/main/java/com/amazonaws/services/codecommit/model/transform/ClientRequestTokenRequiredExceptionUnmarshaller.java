...
public class ClientRequestTokenRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ClientRequestTokenRequiredExceptionUnmarshaller instance;

    public static ClientRequestTokenRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ClientRequestTokenRequiredExceptionUnmarshaller();
        return instance;
    }
}
