...
public class GetRepositoryResultJsonUnmarshaller implements Unmarshaller<GetRepositoryResult, JsonUnmarshallerContext> {

    public GetRepositoryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("repositoryMetadata", targetDepth)) {
                    context.nextToken();
                    getRepositoryResult.setRepositoryMetadata(RepositoryMetadataJsonUnmarshaller.getInstance().unmarshall(context));
                }
