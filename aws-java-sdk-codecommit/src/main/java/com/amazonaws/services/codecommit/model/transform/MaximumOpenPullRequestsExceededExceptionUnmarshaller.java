...
public class MaximumOpenPullRequestsExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaximumOpenPullRequestsExceededExceptionUnmarshaller instance;

    public static MaximumOpenPullRequestsExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaximumOpenPullRequestsExceededExceptionUnmarshaller();
        return instance;
    }
}
