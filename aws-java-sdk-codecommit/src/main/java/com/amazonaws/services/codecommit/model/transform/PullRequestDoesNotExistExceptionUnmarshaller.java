...
public class PullRequestDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PullRequestDoesNotExistExceptionUnmarshaller instance;

    public static PullRequestDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PullRequestDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
