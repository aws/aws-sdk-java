...
public class UpdateApprovalRuleTemplateNameResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateApprovalRuleTemplateNameResult withApprovalRuleTemplate(ApprovalRuleTemplate approvalRuleTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateApprovalRuleTemplateNameResult == false)
            return false;
        UpdateApprovalRuleTemplateNameResult other = (UpdateApprovalRuleTemplateNameResult) obj;
    ...
    @Override
    public UpdateApprovalRuleTemplateNameResult clone() {
        try {
            return (UpdateApprovalRuleTemplateNameResult) super.clone();
