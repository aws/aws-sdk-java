...
public class GetCommitRequestMarshaller {
    ...
    private static final GetCommitRequestMarshaller instance = new GetCommitRequestMarshaller();

    public static GetCommitRequestMarshaller getInstance() {
        return instance;
    }
