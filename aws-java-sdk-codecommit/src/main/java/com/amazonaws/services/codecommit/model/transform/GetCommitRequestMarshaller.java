...
public class GetCommitRequestMarshaller implements
    ...
    public Request<GetCommitRequest> marshall(GetCommitRequest getCommitRequest) {
        ...
        Request<GetCommitRequest> request = new DefaultRequest<GetCommitRequest>(
                getCommitRequest, "AWSCodeCommit");
        ...
        try {
            ...
            if (getCommitRequest.getRepositoryName() != null) {
                jsonWriter.key("repositoryName").value(
                        getCommitRequest.getRepositoryName());
            }

            if (getCommitRequest.getCommitId() != null) {
                jsonWriter.key("commitId")
                        .value(getCommitRequest.getCommitId());
            }
