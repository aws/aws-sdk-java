...
public class InvalidTagKeysListExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTagKeysListExceptionUnmarshaller instance;

    public static InvalidTagKeysListExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTagKeysListExceptionUnmarshaller();
        return instance;
    }
}
