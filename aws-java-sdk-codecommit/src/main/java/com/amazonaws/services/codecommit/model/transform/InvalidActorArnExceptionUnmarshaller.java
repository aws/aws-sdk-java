...
public class InvalidActorArnExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidActorArnExceptionUnmarshaller instance;

    public static InvalidActorArnExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidActorArnExceptionUnmarshaller();
        return instance;
    }
}
