...
public class InvalidFileModeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidFileModeExceptionUnmarshaller instance;

    public static InvalidFileModeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidFileModeExceptionUnmarshaller();
        return instance;
    }
}
