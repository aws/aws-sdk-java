...
public class NoChangeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoChangeExceptionUnmarshaller instance;

    public static NoChangeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoChangeExceptionUnmarshaller();
        return instance;
    }
}
