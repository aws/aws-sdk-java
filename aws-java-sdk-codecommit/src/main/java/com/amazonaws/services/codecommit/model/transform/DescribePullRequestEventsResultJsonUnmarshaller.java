...
/**
 * DescribePullRequestEventsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribePullRequestEventsResultJsonUnmarshaller implements Unmarshaller<DescribePullRequestEventsResult, JsonUnmarshallerContext> {

    public DescribePullRequestEventsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describePullRequestEventsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
