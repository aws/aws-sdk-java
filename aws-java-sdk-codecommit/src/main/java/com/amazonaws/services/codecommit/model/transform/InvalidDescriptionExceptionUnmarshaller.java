...
public class InvalidDescriptionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDescriptionExceptionUnmarshaller instance;

    public static InvalidDescriptionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDescriptionExceptionUnmarshaller();
        return instance;
    }
}
