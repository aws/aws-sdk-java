...
public class EncryptionKeyNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EncryptionKeyNotFoundExceptionUnmarshaller instance;

    public static EncryptionKeyNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EncryptionKeyNotFoundExceptionUnmarshaller();
        return instance;
    }
}
