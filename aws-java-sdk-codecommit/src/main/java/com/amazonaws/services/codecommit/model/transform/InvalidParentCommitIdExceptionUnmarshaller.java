...
public class InvalidParentCommitIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidParentCommitIdExceptionUnmarshaller instance;

    public static InvalidParentCommitIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidParentCommitIdExceptionUnmarshaller();
        return instance;
    }
}
