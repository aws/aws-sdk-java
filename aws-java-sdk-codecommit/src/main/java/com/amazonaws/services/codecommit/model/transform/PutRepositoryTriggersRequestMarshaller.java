 ...
 */
public class PutRepositoryTriggersRequestMarshaller implements Marshaller<Request<PutRepositoryTriggersRequest>, PutRepositoryTriggersRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public PutRepositoryTriggersRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<PutRepositoryTriggersRequest> marshall(PutRepositoryTriggersRequest putRepositoryTriggersRequest) {
        ...
        Request<PutRepositoryTriggersRequest> request = new DefaultRequest<PutRepositoryTriggersRequest>(putRepositoryTriggersRequest, "AWSCodeCommit");
        ...
        try {
            ...
            java.util.List<RepositoryTrigger> triggersList = putRepositoryTriggersRequest.getTriggers();
