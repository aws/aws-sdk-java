...
public class InvalidRepositoryTriggerRegionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidRepositoryTriggerRegionExceptionUnmarshaller instance;

    public static InvalidRepositoryTriggerRegionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRepositoryTriggerRegionExceptionUnmarshaller();
        return instance;
    }
}
