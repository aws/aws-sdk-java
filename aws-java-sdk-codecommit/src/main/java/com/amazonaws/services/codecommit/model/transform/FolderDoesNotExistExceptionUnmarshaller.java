...
public class FolderDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FolderDoesNotExistExceptionUnmarshaller instance;

    public static FolderDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FolderDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
