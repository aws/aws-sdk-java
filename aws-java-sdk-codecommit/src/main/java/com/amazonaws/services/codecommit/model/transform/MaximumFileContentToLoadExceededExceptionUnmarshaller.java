...
public class MaximumFileContentToLoadExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaximumFileContentToLoadExceededExceptionUnmarshaller instance;

    public static MaximumFileContentToLoadExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaximumFileContentToLoadExceededExceptionUnmarshaller();
        return instance;
    }
}
