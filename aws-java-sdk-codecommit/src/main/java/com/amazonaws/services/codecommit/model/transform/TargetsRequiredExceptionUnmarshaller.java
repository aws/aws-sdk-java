...
public class TargetsRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TargetsRequiredExceptionUnmarshaller instance;

    public static TargetsRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TargetsRequiredExceptionUnmarshaller();
        return instance;
    }
}
