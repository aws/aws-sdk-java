...
public class MaximumItemsToCompareExceededException extends com.amazonaws.services.codecommit.model.AWSCodeCommitException {
     ...
     */
    public MaximumItemsToCompareExceededException(String message) {
        super(message);
    }
