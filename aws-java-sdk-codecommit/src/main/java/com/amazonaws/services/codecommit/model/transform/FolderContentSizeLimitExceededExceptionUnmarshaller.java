...
public class FolderContentSizeLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FolderContentSizeLimitExceededExceptionUnmarshaller instance;

    public static FolderContentSizeLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FolderContentSizeLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
