...
public class CommentNotCreatedByCallerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CommentNotCreatedByCallerExceptionUnmarshaller instance;

    public static CommentNotCreatedByCallerExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CommentNotCreatedByCallerExceptionUnmarshaller();
        return instance;
    }
}
