...
public class DeleteBranchRequestProtocolMarshaller implements Marshaller<Request<DeleteBranchRequest>, DeleteBranchRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.AWS_JSON).requestUri("/")
            ...
            .operationIdentifier("CodeCommit_20150413.DeleteBranch").serviceName("AWSCodeCommit").build();

    private final com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory;

    public DeleteBranchRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
