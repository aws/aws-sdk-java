...
public class FileModeRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FileModeRequiredExceptionUnmarshaller instance;

    public static FileModeRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileModeRequiredExceptionUnmarshaller();
        return instance;
    }
}
