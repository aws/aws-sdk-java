...
public class MergeOptionRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MergeOptionRequiredExceptionUnmarshaller instance;

    public static MergeOptionRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MergeOptionRequiredExceptionUnmarshaller();
        return instance;
    }
}
