...
public class ReferenceDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ReferenceDoesNotExistExceptionUnmarshaller instance;

    public static ReferenceDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReferenceDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
