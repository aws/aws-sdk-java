...
public class PullRequestIdRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PullRequestIdRequiredExceptionUnmarshaller instance;

    public static PullRequestIdRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PullRequestIdRequiredExceptionUnmarshaller();
        return instance;
    }
}
