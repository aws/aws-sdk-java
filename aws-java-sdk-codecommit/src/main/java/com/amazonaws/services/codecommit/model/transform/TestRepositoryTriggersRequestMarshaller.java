...
public class TestRepositoryTriggersRequestMarshaller
    ...
    public TestRepositoryTriggersRequestMarshaller(
        ...
        try {
            ...
            if (testRepositoryTriggersRequest.getRepositoryName() != null) {
                jsonGenerator.writeFieldName("repositoryName").writeValue(
                        testRepositoryTriggersRequest.getRepositoryName());
            }

            java.util.List<RepositoryTrigger> triggersList = testRepositoryTriggersRequest
                    .getTriggers();
