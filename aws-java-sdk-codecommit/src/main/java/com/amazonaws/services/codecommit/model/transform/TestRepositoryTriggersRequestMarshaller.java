 ...
 */
public class TestRepositoryTriggersRequestMarshaller implements Marshaller<Request<TestRepositoryTriggersRequest>, TestRepositoryTriggersRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public TestRepositoryTriggersRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<TestRepositoryTriggersRequest> marshall(TestRepositoryTriggersRequest testRepositoryTriggersRequest) {
        ...
        Request<TestRepositoryTriggersRequest> request = new DefaultRequest<TestRepositoryTriggersRequest>(testRepositoryTriggersRequest, "AWSCodeCommit");
        ...
        try {
            ...
            java.util.List<RepositoryTrigger> triggersList = testRepositoryTriggersRequest.getTriggers();
