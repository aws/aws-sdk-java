...
public class InvalidMaxConflictFilesExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidMaxConflictFilesExceptionUnmarshaller instance;

    public static InvalidMaxConflictFilesExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidMaxConflictFilesExceptionUnmarshaller();
        return instance;
    }
}
