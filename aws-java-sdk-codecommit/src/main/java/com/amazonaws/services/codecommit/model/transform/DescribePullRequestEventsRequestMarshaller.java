...
/**
 * DescribePullRequestEventsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribePullRequestEventsRequestMarshaller {
    ...
    private static final DescribePullRequestEventsRequestMarshaller instance = new DescribePullRequestEventsRequestMarshaller();

    public static DescribePullRequestEventsRequestMarshaller getInstance() {
        return instance;
    }
