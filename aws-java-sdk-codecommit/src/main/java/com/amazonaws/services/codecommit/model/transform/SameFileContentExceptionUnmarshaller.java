...
public class SameFileContentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SameFileContentExceptionUnmarshaller instance;

    public static SameFileContentExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SameFileContentExceptionUnmarshaller();
        return instance;
    }
}
