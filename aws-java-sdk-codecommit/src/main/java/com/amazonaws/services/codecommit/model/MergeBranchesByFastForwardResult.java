...
public class MergeBranchesByFastForwardResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MergeBranchesByFastForwardResult == false)
            return false;
        MergeBranchesByFastForwardResult other = (MergeBranchesByFastForwardResult) obj;
    ...
    public MergeBranchesByFastForwardResult clone() {
        try {
            return (MergeBranchesByFastForwardResult) super.clone();
