...
public class InvalidContinuationTokenExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidContinuationTokenExceptionUnmarshaller instance;

    public static InvalidContinuationTokenExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidContinuationTokenExceptionUnmarshaller();
        return instance;
    }
}
