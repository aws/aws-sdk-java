...
public class FileContentRequiredException extends com.amazonaws.services.codecommit.model.AWSCodeCommitException {
     ...
     */
    public FileContentRequiredException(String message) {
        super(message);
    }
