...
public class CommentDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CommentDoesNotExistExceptionUnmarshaller instance;

    public static CommentDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CommentDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
