...
public class FileMarshaller {
    ...
    public void marshall(File file, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(file.getBlobId(), BLOBID_BINDING);
            protocolMarshaller.marshall(file.getAbsolutePath(), ABSOLUTEPATH_BINDING);
            protocolMarshaller.marshall(file.getRelativePath(), RELATIVEPATH_BINDING);
            protocolMarshaller.marshall(file.getFileMode(), FILEMODE_BINDING);
        } catch (Exception e) {
