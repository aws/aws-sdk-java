...
public class TipOfSourceReferenceIsDifferentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TipOfSourceReferenceIsDifferentExceptionUnmarshaller instance;

    public static TipOfSourceReferenceIsDifferentExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TipOfSourceReferenceIsDifferentExceptionUnmarshaller();
        return instance;
    }
}
