...
public class InvalidRepositoryTriggerCustomDataExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidRepositoryTriggerCustomDataExceptionUnmarshaller instance;

    public static InvalidRepositoryTriggerCustomDataExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRepositoryTriggerCustomDataExceptionUnmarshaller();
        return instance;
    }
}
