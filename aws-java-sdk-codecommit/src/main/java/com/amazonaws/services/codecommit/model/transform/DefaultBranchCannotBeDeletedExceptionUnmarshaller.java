...
public class DefaultBranchCannotBeDeletedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DefaultBranchCannotBeDeletedExceptionUnmarshaller instance;

    public static DefaultBranchCannotBeDeletedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DefaultBranchCannotBeDeletedExceptionUnmarshaller();
        return instance;
    }
}
