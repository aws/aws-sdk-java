...
public class UpdateNetworkSitePlanResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateNetworkSitePlanResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateNetworkSitePlanResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateNetworkSitePlanResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateNetworkSitePlanResult == false)
            return false;
        UpdateNetworkSitePlanResult other = (UpdateNetworkSitePlanResult) obj;
    ...
    public UpdateNetworkSitePlanResult clone() {
        try {
            return (UpdateNetworkSitePlanResult) super.clone();
