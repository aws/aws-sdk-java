...
public class ListNetworkSitesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListNetworkSitesRequest withFilters(java.util.Map<String, java.util.List<String>> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public ListNetworkSitesRequest addFiltersEntry(String key, java.util.List<String> value) {
