...
public class ActivateDeviceIdentifierRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ActivateDeviceIdentifierRequest withClientToken(String clientToken) {
    ...
    public ActivateDeviceIdentifierRequest withDeviceIdentifierArn(String deviceIdentifierArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ActivateDeviceIdentifierRequest == false)
            return false;
        ActivateDeviceIdentifierRequest other = (ActivateDeviceIdentifierRequest) obj;
    ...
    @Override
    public ActivateDeviceIdentifierRequest clone() {
        return (ActivateDeviceIdentifierRequest) super.clone();
    }
