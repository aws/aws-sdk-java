...
public class UpdateNetworkSitePlanRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateNetworkSitePlanRequest withClientToken(String clientToken) {
    ...
    public UpdateNetworkSitePlanRequest withNetworkSiteArn(String networkSiteArn) {
    ...
    public UpdateNetworkSitePlanRequest withPendingPlan(SitePlan pendingPlan) {
    ...
    public String toString() {
        ...
        if (getPendingPlan() != null)
            sb.append("PendingPlan: ").append(getPendingPlan());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateNetworkSitePlanRequest == false)
            return false;
        UpdateNetworkSitePlanRequest other = (UpdateNetworkSitePlanRequest) obj;
    ...
    @Override
    public UpdateNetworkSitePlanRequest clone() {
        return (UpdateNetworkSitePlanRequest) super.clone();
    }
