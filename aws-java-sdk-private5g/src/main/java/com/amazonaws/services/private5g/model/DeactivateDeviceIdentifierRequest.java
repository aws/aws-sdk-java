...
public class DeactivateDeviceIdentifierRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeactivateDeviceIdentifierRequest withClientToken(String clientToken) {
    ...
    public DeactivateDeviceIdentifierRequest withDeviceIdentifierArn(String deviceIdentifierArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeactivateDeviceIdentifierRequest == false)
            return false;
    ...
    @Override
    public DeactivateDeviceIdentifierRequest clone() {
        return (DeactivateDeviceIdentifierRequest) super.clone();
    }
