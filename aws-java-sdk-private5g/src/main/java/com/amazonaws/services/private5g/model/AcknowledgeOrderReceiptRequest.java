...
public class AcknowledgeOrderReceiptRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public AcknowledgeOrderReceiptRequest withOrderArn(String orderArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AcknowledgeOrderReceiptRequest == false)
            return false;
    ...
    @Override
    public AcknowledgeOrderReceiptRequest clone() {
        return (AcknowledgeOrderReceiptRequest) super.clone();
    }
