...
public class CreateNetworkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateNetworkResult withNetwork(Network network) {
        setNetwork(network);
        return this;
    }
    ...
    public CreateNetworkResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateNetworkResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateNetworkResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateNetworkResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
