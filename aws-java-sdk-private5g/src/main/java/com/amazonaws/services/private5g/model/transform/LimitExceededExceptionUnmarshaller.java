...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.private5g.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.private5g.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.private5g.model.LimitExceededException limitExceededException = new com.amazonaws.services.private5g.model.LimitExceededException(
                null);
