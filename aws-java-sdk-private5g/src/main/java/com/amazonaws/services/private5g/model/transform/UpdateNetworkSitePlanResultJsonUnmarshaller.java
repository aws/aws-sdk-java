...
/**
 * UpdateNetworkSitePlanResult JSON Unmarshaller
 */
...
public class UpdateNetworkSitePlanResultJsonUnmarshaller implements Unmarshaller<UpdateNetworkSitePlanResult, JsonUnmarshallerContext> {
    ...
    public UpdateNetworkSitePlanResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("networkSite", targetDepth)) {
                    context.nextToken();
                    updateNetworkSitePlanResult.setNetworkSite(NetworkSiteJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("tags", targetDepth)) {
                    context.nextToken();
                    updateNetworkSitePlanResult.setTags(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
