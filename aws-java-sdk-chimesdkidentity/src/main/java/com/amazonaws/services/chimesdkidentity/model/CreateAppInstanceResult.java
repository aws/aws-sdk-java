...
public class CreateAppInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Number (ARN) of the <code>AppInstance</code>.
     */
    ...
    public CreateAppInstanceResult withAppInstanceArn(String appInstanceArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAppInstanceResult == false)
            return false;
        CreateAppInstanceResult other = (CreateAppInstanceResult) obj;
    ...
    @Override
    public CreateAppInstanceResult clone() {
        try {
