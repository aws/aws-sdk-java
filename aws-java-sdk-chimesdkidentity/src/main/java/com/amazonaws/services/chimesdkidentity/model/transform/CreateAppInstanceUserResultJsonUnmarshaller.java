...
/**
 * CreateAppInstanceUserResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateAppInstanceUserResultJsonUnmarshaller implements Unmarshaller<CreateAppInstanceUserResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AppInstanceUserArn", targetDepth)) {
                    context.nextToken();
                    createAppInstanceUserResult.setAppInstanceUserArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
