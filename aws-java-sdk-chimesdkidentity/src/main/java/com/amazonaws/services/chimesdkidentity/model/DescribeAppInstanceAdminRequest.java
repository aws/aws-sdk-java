...
public class DescribeAppInstanceAdminRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the <code>AppInstanceAdmin</code>.
     */
    ...
    @Override
    public DescribeAppInstanceAdminRequest clone() {
        return (DescribeAppInstanceAdminRequest) super.clone();
    }
