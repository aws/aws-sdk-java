...
/**
 * CreateAppInstanceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateAppInstanceResultJsonUnmarshaller implements Unmarshaller<CreateAppInstanceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AppInstanceArn", targetDepth)) {
                    context.nextToken();
                    createAppInstanceResult.setAppInstanceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
