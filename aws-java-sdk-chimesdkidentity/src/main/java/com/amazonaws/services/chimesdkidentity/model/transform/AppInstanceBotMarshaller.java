...
/**
 * AppInstanceBotMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AppInstanceBotMarshaller {
    ...
    private static final AppInstanceBotMarshaller instance = new AppInstanceBotMarshaller();

    public static AppInstanceBotMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AppInstanceBot appInstanceBot, ProtocolMarshaller protocolMarshaller) {

        if (appInstanceBot == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(appInstanceBot.getAppInstanceBotArn(), APPINSTANCEBOTARN_BINDING);
            protocolMarshaller.marshall(appInstanceBot.getName(), NAME_BINDING);
            protocolMarshaller.marshall(appInstanceBot.getConfiguration(), CONFIGURATION_BINDING);
            protocolMarshaller.marshall(appInstanceBot.getCreatedTimestamp(), CREATEDTIMESTAMP_BINDING);
            protocolMarshaller.marshall(appInstanceBot.getLastUpdatedTimestamp(), LASTUPDATEDTIMESTAMP_BINDING);
            protocolMarshaller.marshall(appInstanceBot.getMetadata(), METADATA_BINDING);
        } catch (Exception e) {
