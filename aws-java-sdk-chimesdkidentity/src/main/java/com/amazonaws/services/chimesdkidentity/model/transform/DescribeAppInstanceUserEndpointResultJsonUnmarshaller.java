...
/**
 * DescribeAppInstanceUserEndpointResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeAppInstanceUserEndpointResultJsonUnmarshaller implements Unmarshaller<DescribeAppInstanceUserEndpointResult, JsonUnmarshallerContext> {

    public DescribeAppInstanceUserEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AppInstanceUserEndpoint", targetDepth)) {
                    context.nextToken();
                    describeAppInstanceUserEndpointResult.setAppInstanceUserEndpoint(AppInstanceUserEndpointJsonUnmarshaller.getInstance().unmarshall(context));
                }
