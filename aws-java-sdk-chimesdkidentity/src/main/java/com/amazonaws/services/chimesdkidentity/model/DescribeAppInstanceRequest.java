...
public class DescribeAppInstanceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeAppInstanceRequest withAppInstanceArn(String appInstanceArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAppInstanceRequest == false)
            return false;
        DescribeAppInstanceRequest other = (DescribeAppInstanceRequest) obj;
    ...
    @Override
    public DescribeAppInstanceRequest clone() {
        return (DescribeAppInstanceRequest) super.clone();
    }
