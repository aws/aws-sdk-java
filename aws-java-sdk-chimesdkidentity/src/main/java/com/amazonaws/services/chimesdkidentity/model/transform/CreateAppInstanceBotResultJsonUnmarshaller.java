...
/**
 * CreateAppInstanceBotResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateAppInstanceBotResultJsonUnmarshaller implements Unmarshaller<CreateAppInstanceBotResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AppInstanceBotArn", targetDepth)) {
                    context.nextToken();
                    createAppInstanceBotResult.setAppInstanceBotArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
