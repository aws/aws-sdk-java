...
public class DescribeAppInstanceUserResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeAppInstanceUserResult withAppInstanceUser(AppInstanceUser appInstanceUser) {
        setAppInstanceUser(appInstanceUser);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getAppInstanceUser() != null)
            sb.append("AppInstanceUser: ").append(getAppInstanceUser());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAppInstanceUser() == null ^ this.getAppInstanceUser() == null)
            return false;
        if (other.getAppInstanceUser() != null && other.getAppInstanceUser().equals(this.getAppInstanceUser()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getAppInstanceUser() == null) ? 0 : getAppInstanceUser().hashCode());
        return hashCode;
    }
    ...
    public DescribeAppInstanceUserResult clone() {
        try {
            return (DescribeAppInstanceUserResult) super.clone();
