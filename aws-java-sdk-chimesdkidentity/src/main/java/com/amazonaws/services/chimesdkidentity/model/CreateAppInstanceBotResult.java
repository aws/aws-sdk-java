...
public class CreateAppInstanceBotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAppInstanceBotResult == false)
            return false;
        CreateAppInstanceBotResult other = (CreateAppInstanceBotResult) obj;
    ...
    public CreateAppInstanceBotResult clone() {
        try {
            return (CreateAppInstanceBotResult) super.clone();
