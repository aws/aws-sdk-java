...
public class DeleteAppInstanceAdminRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteAppInstanceAdminRequest withAppInstanceAdminArn(String appInstanceAdminArn) {
    ...
    public DeleteAppInstanceAdminRequest withAppInstanceArn(String appInstanceArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAppInstanceAdminRequest == false)
            return false;
    ...
    @Override
    public DeleteAppInstanceAdminRequest clone() {
