...
class ImageUpdated {
    ...
    static class IsCREATEDMatcher extends WaiterAcceptor<DescribeImageResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("ImageStatus");
    ...
    static class IsUPDATE_FAILEDMatcher extends WaiterAcceptor<DescribeImageResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsValidationExceptionMatcher extends WaiterAcceptor<DescribeImageResult> {
        /**
