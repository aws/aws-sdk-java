...
/**
 * MemberDefinition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MemberDefinitionJsonUnmarshaller implements Unmarshaller<MemberDefinition, JsonUnmarshallerContext> {
    ...
    public MemberDefinition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CognitoMemberDefinition", targetDepth)) {
                    context.nextToken();
