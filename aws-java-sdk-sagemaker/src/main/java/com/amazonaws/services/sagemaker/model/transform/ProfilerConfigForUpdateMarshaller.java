...
/**
 * ProfilerConfigForUpdateMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ProfilerConfigForUpdateMarshaller {
    ...
    private static final ProfilerConfigForUpdateMarshaller instance = new ProfilerConfigForUpdateMarshaller();

    public static ProfilerConfigForUpdateMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ProfilerConfigForUpdate profilerConfigForUpdate, ProtocolMarshaller protocolMarshaller) {

        if (profilerConfigForUpdate == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(profilerConfigForUpdate.getS3OutputPath(), S3OUTPUTPATH_BINDING);
            protocolMarshaller.marshall(profilerConfigForUpdate.getProfilingIntervalInMilliseconds(), PROFILINGINTERVALINMILLISECONDS_BINDING);
            protocolMarshaller.marshall(profilerConfigForUpdate.getProfilingParameters(), PROFILINGPARAMETERS_BINDING);
            protocolMarshaller.marshall(profilerConfigForUpdate.getDisableProfiler(), DISABLEPROFILER_BINDING);
        } catch (Exception e) {
