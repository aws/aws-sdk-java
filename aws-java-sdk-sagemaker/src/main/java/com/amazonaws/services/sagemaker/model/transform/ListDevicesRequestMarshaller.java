...
public class ListDevicesRequestMarshaller {
    ...
    private static final MarshallingInfo<java.util.Date> LATESTHEARTBEATAFTER_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("LatestHeartbeatAfter").timestampFormat("unixTimestamp").build();
    ...
    public void marshall(ListDevicesRequest listDevicesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(listDevicesRequest.getLatestHeartbeatAfter(), LATESTHEARTBEATAFTER_BINDING);
            protocolMarshaller.marshall(listDevicesRequest.getModelName(), MODELNAME_BINDING);
            protocolMarshaller.marshall(listDevicesRequest.getDeviceFleetName(), DEVICEFLEETNAME_BINDING);
        } catch (Exception e) {
