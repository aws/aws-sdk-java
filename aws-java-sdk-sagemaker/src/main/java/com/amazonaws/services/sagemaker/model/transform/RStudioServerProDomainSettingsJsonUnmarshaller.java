...
/**
 * RStudioServerProDomainSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RStudioServerProDomainSettingsJsonUnmarshaller implements Unmarshaller<RStudioServerProDomainSettings, JsonUnmarshallerContext> {

    public RStudioServerProDomainSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        RStudioServerProDomainSettings rStudioServerProDomainSettings = new RStudioServerProDomainSettings();
    ...
    private static RStudioServerProDomainSettingsJsonUnmarshaller instance;

    public static RStudioServerProDomainSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RStudioServerProDomainSettingsJsonUnmarshaller();
        return instance;
    }
}
