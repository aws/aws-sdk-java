...
/**
 * LabelingJobDataAttributesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LabelingJobDataAttributesMarshaller {
    ...
    private static final LabelingJobDataAttributesMarshaller instance = new LabelingJobDataAttributesMarshaller();

    public static LabelingJobDataAttributesMarshaller getInstance() {
        return instance;
    }
