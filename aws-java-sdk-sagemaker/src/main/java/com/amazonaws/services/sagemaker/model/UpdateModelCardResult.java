...
public class UpdateModelCardResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getModelCardArn() != null)
            sb.append("ModelCardArn: ").append(getModelCardArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateModelCardResult == false)
            return false;
        UpdateModelCardResult other = (UpdateModelCardResult) obj;
    ...
    public UpdateModelCardResult clone() {
        try {
            return (UpdateModelCardResult) super.clone();
