...
/**
 * ListHumanTaskUisResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListHumanTaskUisResultJsonUnmarshaller implements Unmarshaller<ListHumanTaskUisResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listHumanTaskUisResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
