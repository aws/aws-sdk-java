...
/**
 * DeleteImageVersionResult JSON Unmarshaller
 */
...
public class DeleteImageVersionResultJsonUnmarshaller implements Unmarshaller<DeleteImageVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteImageVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteImageVersionResult deleteImageVersionResult = new DeleteImageVersionResult();

        return deleteImageVersionResult;
    }
