...
public class CreateFeatureGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The Amazon Resource Name (ARN) of the <code>FeatureGroup</code>. This is a unique identifier for the feature
     * group.
     * </p>
     */
     ...
     *        The Amazon Resource Name (ARN) of the <code>FeatureGroup</code>. This is a unique identifier for the
     *        feature group.
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the <code>FeatureGroup</code>. This is a unique identifier for the
     *         feature group.
     */
    ...
    public CreateFeatureGroupResult withFeatureGroupArn(String featureGroupArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateFeatureGroupResult == false)
            return false;
        CreateFeatureGroupResult other = (CreateFeatureGroupResult) obj;
    ...
    public CreateFeatureGroupResult clone() {
        try {
            return (CreateFeatureGroupResult) super.clone();
