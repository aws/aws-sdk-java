...
/**
 * DriftCheckBaselinesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DriftCheckBaselinesMarshaller {
    ...
    private static final DriftCheckBaselinesMarshaller instance = new DriftCheckBaselinesMarshaller();

    public static DriftCheckBaselinesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DriftCheckBaselines driftCheckBaselines, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(driftCheckBaselines.getBias(), BIAS_BINDING);
            protocolMarshaller.marshall(driftCheckBaselines.getExplainability(), EXPLAINABILITY_BINDING);
            protocolMarshaller.marshall(driftCheckBaselines.getModelQuality(), MODELQUALITY_BINDING);
            protocolMarshaller.marshall(driftCheckBaselines.getModelDataQuality(), MODELDATAQUALITY_BINDING);
        } catch (Exception e) {
