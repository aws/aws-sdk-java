...
/**
 * DeleteImageVersionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteImageVersionRequestMarshaller {
    ...
    public static DeleteImageVersionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteImageVersionRequest deleteImageVersionRequest, ProtocolMarshaller protocolMarshaller) {

        if (deleteImageVersionRequest == null) {
