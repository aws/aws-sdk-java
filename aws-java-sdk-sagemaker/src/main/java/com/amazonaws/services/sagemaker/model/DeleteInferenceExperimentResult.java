...
public class DeleteInferenceExperimentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the deleted inference experiment.
     */
    ...
    public DeleteInferenceExperimentResult withInferenceExperimentArn(String inferenceExperimentArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteInferenceExperimentResult == false)
            return false;
        DeleteInferenceExperimentResult other = (DeleteInferenceExperimentResult) obj;
    ...
    @Override
    public DeleteInferenceExperimentResult clone() {
        try {
            return (DeleteInferenceExperimentResult) super.clone();
