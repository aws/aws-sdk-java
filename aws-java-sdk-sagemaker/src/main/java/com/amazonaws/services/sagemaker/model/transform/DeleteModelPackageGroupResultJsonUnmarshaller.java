...
/**
 * DeleteModelPackageGroupResult JSON Unmarshaller
 */
...
public class DeleteModelPackageGroupResultJsonUnmarshaller implements Unmarshaller<DeleteModelPackageGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteModelPackageGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteModelPackageGroupResult deleteModelPackageGroupResult = new DeleteModelPackageGroupResult();

        return deleteModelPackageGroupResult;
    }
