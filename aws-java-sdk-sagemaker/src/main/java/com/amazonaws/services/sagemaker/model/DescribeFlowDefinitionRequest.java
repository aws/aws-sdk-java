...
public class DescribeFlowDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DescribeFlowDefinitionRequest clone() {
        return (DescribeFlowDefinitionRequest) super.clone();
    }
