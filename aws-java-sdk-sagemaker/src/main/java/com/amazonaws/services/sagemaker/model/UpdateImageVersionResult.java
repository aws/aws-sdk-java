...
public class UpdateImageVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateImageVersionResult withImageVersionArn(String imageVersionArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateImageVersionResult == false)
            return false;
        UpdateImageVersionResult other = (UpdateImageVersionResult) obj;
    ...
    @Override
    public UpdateImageVersionResult clone() {
        try {
            return (UpdateImageVersionResult) super.clone();
