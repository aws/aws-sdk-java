...
/**
 * CreateCodeRepositoryRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateCodeRepositoryRequestMarshaller {
    ...
    private static final CreateCodeRepositoryRequestMarshaller instance = new CreateCodeRepositoryRequestMarshaller();

    public static CreateCodeRepositoryRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(CreateCodeRepositoryRequest createCodeRepositoryRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createCodeRepositoryRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
