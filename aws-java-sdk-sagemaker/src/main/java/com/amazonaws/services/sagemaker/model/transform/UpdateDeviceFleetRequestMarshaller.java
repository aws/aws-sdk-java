...
/**
 * UpdateDeviceFleetRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateDeviceFleetRequestMarshaller {
    ...
    public static UpdateDeviceFleetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateDeviceFleetRequest updateDeviceFleetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateDeviceFleetRequest.getDeviceFleetName(), DEVICEFLEETNAME_BINDING);
