...
public class UpdateModelPackageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateModelPackageResult == false)
            return false;
        UpdateModelPackageResult other = (UpdateModelPackageResult) obj;
    ...
    public UpdateModelPackageResult clone() {
        try {
            return (UpdateModelPackageResult) super.clone();
