...
/**
 * DeleteAlgorithmRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteAlgorithmRequestMarshaller {
    ...
    private static final DeleteAlgorithmRequestMarshaller instance = new DeleteAlgorithmRequestMarshaller();

    public static DeleteAlgorithmRequestMarshaller getInstance() {
        return instance;
    }
