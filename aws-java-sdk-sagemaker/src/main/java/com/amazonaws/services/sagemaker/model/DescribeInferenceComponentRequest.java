...
public class DescribeInferenceComponentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeInferenceComponentRequest withInferenceComponentName(String inferenceComponentName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeInferenceComponentRequest == false)
            return false;
        DescribeInferenceComponentRequest other = (DescribeInferenceComponentRequest) obj;
    ...
    @Override
    public DescribeInferenceComponentRequest clone() {
        return (DescribeInferenceComponentRequest) super.clone();
    }
