...
/**
 * MonitoringAlertSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MonitoringAlertSummaryJsonUnmarshaller implements Unmarshaller<MonitoringAlertSummary, JsonUnmarshallerContext> {

    public MonitoringAlertSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        MonitoringAlertSummary monitoringAlertSummary = new MonitoringAlertSummary();
    ...
    private static MonitoringAlertSummaryJsonUnmarshaller instance;

    public static MonitoringAlertSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MonitoringAlertSummaryJsonUnmarshaller();
        return instance;
    }
}
