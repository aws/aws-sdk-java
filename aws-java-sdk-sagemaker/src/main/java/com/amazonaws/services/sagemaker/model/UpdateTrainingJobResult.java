...
public class UpdateTrainingJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateTrainingJobResult == false)
            return false;
        UpdateTrainingJobResult other = (UpdateTrainingJobResult) obj;
    ...
    public UpdateTrainingJobResult clone() {
        try {
            return (UpdateTrainingJobResult) super.clone();
