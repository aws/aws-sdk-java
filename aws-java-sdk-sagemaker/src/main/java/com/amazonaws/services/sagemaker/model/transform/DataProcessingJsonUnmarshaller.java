...
/**
 * DataProcessing JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataProcessingJsonUnmarshaller implements Unmarshaller<DataProcessing, JsonUnmarshallerContext> {

    public DataProcessing unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DataProcessingJsonUnmarshaller instance;

    public static DataProcessingJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DataProcessingJsonUnmarshaller();
        return instance;
    }
}
