...
/**
 * DeleteEdgeDeploymentStageResult JSON Unmarshaller
 */
...
public class DeleteEdgeDeploymentStageResultJsonUnmarshaller implements Unmarshaller<DeleteEdgeDeploymentStageResult, JsonUnmarshallerContext> {
    ...
    public DeleteEdgeDeploymentStageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEdgeDeploymentStageResult deleteEdgeDeploymentStageResult = new DeleteEdgeDeploymentStageResult();

        return deleteEdgeDeploymentStageResult;
    }
