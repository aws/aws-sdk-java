...
/**
 * CreateLabelingJobResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateLabelingJobResultJsonUnmarshaller implements Unmarshaller<CreateLabelingJobResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("LabelingJobArn", targetDepth)) {
                    context.nextToken();
                    createLabelingJobResult.setLabelingJobArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
