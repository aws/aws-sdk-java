...
public class CreateInferenceExperimentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN for your inference experiment.
     */
    ...
    public CreateInferenceExperimentResult withInferenceExperimentArn(String inferenceExperimentArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateInferenceExperimentResult == false)
            return false;
        CreateInferenceExperimentResult other = (CreateInferenceExperimentResult) obj;
    ...
    @Override
    public CreateInferenceExperimentResult clone() {
        try {
            return (CreateInferenceExperimentResult) super.clone();
