...
class TrainingJob_Created {
    ...
    static class IsCreatedMatcher extends WaiterAcceptor<DescribeTrainingJobResult> {
    ...
    static class IsInProgressMatcher extends WaiterAcceptor<DescribeTrainingJobResult> {
        private static final JsonNode expectedResult;
