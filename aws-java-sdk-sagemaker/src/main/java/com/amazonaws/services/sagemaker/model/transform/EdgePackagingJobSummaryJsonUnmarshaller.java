...
/**
 * EdgePackagingJobSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EdgePackagingJobSummaryJsonUnmarshaller implements Unmarshaller<EdgePackagingJobSummary, JsonUnmarshallerContext> {

    public EdgePackagingJobSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        EdgePackagingJobSummary edgePackagingJobSummary = new EdgePackagingJobSummary();
    ...
    private static EdgePackagingJobSummaryJsonUnmarshaller instance;

    public static EdgePackagingJobSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EdgePackagingJobSummaryJsonUnmarshaller();
        return instance;
    }
}
