...
/**
 * ListHubsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListHubsRequestMarshaller {
    ...
    private static final ListHubsRequestMarshaller instance = new ListHubsRequestMarshaller();

    public static ListHubsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListHubsRequest listHubsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listHubsRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(listHubsRequest.getNameContains(), NAMECONTAINS_BINDING);
            protocolMarshaller.marshall(listHubsRequest.getCreationTimeBefore(), CREATIONTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listHubsRequest.getCreationTimeAfter(), CREATIONTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listHubsRequest.getLastModifiedTimeBefore(), LASTMODIFIEDTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listHubsRequest.getLastModifiedTimeAfter(), LASTMODIFIEDTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listHubsRequest.getSortBy(), SORTBY_BINDING);
            protocolMarshaller.marshall(listHubsRequest.getSortOrder(), SORTORDER_BINDING);
            protocolMarshaller.marshall(listHubsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listHubsRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
