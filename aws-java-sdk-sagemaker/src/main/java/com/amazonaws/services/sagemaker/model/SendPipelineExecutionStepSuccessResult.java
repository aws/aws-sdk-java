...
public class SendPipelineExecutionStepSuccessResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SendPipelineExecutionStepSuccessResult == false)
            return false;
        SendPipelineExecutionStepSuccessResult other = (SendPipelineExecutionStepSuccessResult) obj;
    ...
    public SendPipelineExecutionStepSuccessResult clone() {
        try {
            return (SendPipelineExecutionStepSuccessResult) super.clone();
