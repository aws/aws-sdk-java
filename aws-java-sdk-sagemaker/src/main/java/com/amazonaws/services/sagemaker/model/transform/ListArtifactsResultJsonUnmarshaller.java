...
public class ListArtifactsResultJsonUnmarshaller implements Unmarshaller<ListArtifactsResult, JsonUnmarshallerContext> {
    ...
    public ListArtifactsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ArtifactSummaries", targetDepth)) {
                    context.nextToken();
                    listArtifactsResult.setArtifactSummaries(new ListUnmarshaller<ArtifactSummary>(ArtifactSummaryJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listArtifactsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
