...
public class DescribeNotebookInstanceLifecycleConfigRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeNotebookInstanceLifecycleConfigRequest withNotebookInstanceLifecycleConfigName(String notebookInstanceLifecycleConfigName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeNotebookInstanceLifecycleConfigRequest == false)
            return false;
    ...
    @Override
    public DescribeNotebookInstanceLifecycleConfigRequest clone() {
        return (DescribeNotebookInstanceLifecycleConfigRequest) super.clone();
    }
