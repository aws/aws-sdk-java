...
public class DeleteArtifactResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteArtifactResult withArtifactArn(String artifactArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteArtifactResult == false)
            return false;
        DeleteArtifactResult other = (DeleteArtifactResult) obj;
    ...
    @Override
    public DeleteArtifactResult clone() {
        try {
            return (DeleteArtifactResult) super.clone();
