...
@SdkInternalApi
public class DeleteHubContentRequestMarshaller {
    ...
    private static final DeleteHubContentRequestMarshaller instance = new DeleteHubContentRequestMarshaller();

    public static DeleteHubContentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteHubContentRequest deleteHubContentRequest, ProtocolMarshaller protocolMarshaller) {

        if (deleteHubContentRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(deleteHubContentRequest.getHubName(), HUBNAME_BINDING);
            protocolMarshaller.marshall(deleteHubContentRequest.getHubContentType(), HUBCONTENTTYPE_BINDING);
            protocolMarshaller.marshall(deleteHubContentRequest.getHubContentName(), HUBCONTENTNAME_BINDING);
            protocolMarshaller.marshall(deleteHubContentRequest.getHubContentVersion(), HUBCONTENTVERSION_BINDING);
        } catch (Exception e) {
