...
public class ListModelQualityJobDefinitionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    /**
     * <p>
     * If the response is truncated, Amazon SageMaker returns this token. To retrieve the next set of model quality
     * monitoring job definitions, use it in the next request.
     * </p>
     */
     ...
     * </p>
     * 
     * @return A list of summaries of model quality monitoring job definitions.
     */
    ...
    public ListModelQualityJobDefinitionsResult withJobDefinitionSummaries(MonitoringJobDefinitionSummary... jobDefinitionSummaries) {
    ...
    public ListModelQualityJobDefinitionsResult withJobDefinitionSummaries(java.util.Collection<MonitoringJobDefinitionSummary> jobDefinitionSummaries) {
    ...
    public ListModelQualityJobDefinitionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListModelQualityJobDefinitionsResult == false)
            return false;
        ListModelQualityJobDefinitionsResult other = (ListModelQualityJobDefinitionsResult) obj;
    ...
    @Override
    public ListModelQualityJobDefinitionsResult clone() {
        try {
            return (ListModelQualityJobDefinitionsResult) super.clone();
