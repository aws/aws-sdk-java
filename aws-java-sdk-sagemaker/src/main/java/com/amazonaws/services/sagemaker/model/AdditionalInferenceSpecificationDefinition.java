 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/AdditionalInferenceSpecificationDefinition"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AdditionalInferenceSpecificationDefinition implements Serializable, Cloneable, StructuredPojo {
    ...
    public AdditionalInferenceSpecificationDefinition withContainers(java.util.Collection<ModelPackageContainerDefinition> containers) {
    ...
    public AdditionalInferenceSpecificationDefinition withSupportedTransformInstanceTypes(java.util.Collection<String> supportedTransformInstanceTypes) {
    ...
    public AdditionalInferenceSpecificationDefinition withSupportedRealtimeInferenceInstanceTypes(
    ...
    public AdditionalInferenceSpecificationDefinition withSupportedContentTypes(java.util.Collection<String> supportedContentTypes) {
    ...
    public AdditionalInferenceSpecificationDefinition withSupportedResponseMIMETypes(java.util.Collection<String> supportedResponseMIMETypes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdditionalInferenceSpecificationDefinition == false)
            return false;
    ...
    public AdditionalInferenceSpecificationDefinition clone() {
        try {
            return (AdditionalInferenceSpecificationDefinition) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.AdditionalInferenceSpecificationDefinitionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
