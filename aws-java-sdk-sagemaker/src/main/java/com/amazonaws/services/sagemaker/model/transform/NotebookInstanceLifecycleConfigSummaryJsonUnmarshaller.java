...
/**
 * NotebookInstanceLifecycleConfigSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NotebookInstanceLifecycleConfigSummaryJsonUnmarshaller implements Unmarshaller<NotebookInstanceLifecycleConfigSummary, JsonUnmarshallerContext> {

    public NotebookInstanceLifecycleConfigSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
