...
/**
 * HyperParameterTuningJobConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HyperParameterTuningJobConfigJsonUnmarshaller implements Unmarshaller<HyperParameterTuningJobConfig, JsonUnmarshallerContext> {

    public HyperParameterTuningJobConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        HyperParameterTuningJobConfig hyperParameterTuningJobConfig = new HyperParameterTuningJobConfig();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ResourceLimits", targetDepth)) {
                    context.nextToken();
                    hyperParameterTuningJobConfig.setResourceLimits(ResourceLimitsJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    private static HyperParameterTuningJobConfigJsonUnmarshaller instance;

    public static HyperParameterTuningJobConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new HyperParameterTuningJobConfigJsonUnmarshaller();
        return instance;
    }
}
