...
/**
 * CreateHubRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateHubRequestMarshaller {
    ...
    private static final CreateHubRequestMarshaller instance = new CreateHubRequestMarshaller();

    public static CreateHubRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateHubRequest createHubRequest, ProtocolMarshaller protocolMarshaller) {

        if (createHubRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createHubRequest.getHubName(), HUBNAME_BINDING);
            protocolMarshaller.marshall(createHubRequest.getHubDescription(), HUBDESCRIPTION_BINDING);
            protocolMarshaller.marshall(createHubRequest.getHubDisplayName(), HUBDISPLAYNAME_BINDING);
            protocolMarshaller.marshall(createHubRequest.getHubSearchKeywords(), HUBSEARCHKEYWORDS_BINDING);
            protocolMarshaller.marshall(createHubRequest.getS3StorageConfig(), S3STORAGECONFIG_BINDING);
            protocolMarshaller.marshall(createHubRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
