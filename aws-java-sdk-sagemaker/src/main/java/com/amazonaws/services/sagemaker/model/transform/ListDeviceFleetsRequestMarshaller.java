...
@SdkInternalApi
public class ListDeviceFleetsRequestMarshaller {
    ...
    private static final ListDeviceFleetsRequestMarshaller instance = new ListDeviceFleetsRequestMarshaller();

    public static ListDeviceFleetsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListDeviceFleetsRequest listDeviceFleetsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listDeviceFleetsRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(listDeviceFleetsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listDeviceFleetsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listDeviceFleetsRequest.getCreationTimeAfter(), CREATIONTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listDeviceFleetsRequest.getCreationTimeBefore(), CREATIONTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listDeviceFleetsRequest.getLastModifiedTimeAfter(), LASTMODIFIEDTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listDeviceFleetsRequest.getLastModifiedTimeBefore(), LASTMODIFIEDTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listDeviceFleetsRequest.getNameContains(), NAMECONTAINS_BINDING);
            protocolMarshaller.marshall(listDeviceFleetsRequest.getSortBy(), SORTBY_BINDING);
            protocolMarshaller.marshall(listDeviceFleetsRequest.getSortOrder(), SORTORDER_BINDING);
        } catch (Exception e) {
