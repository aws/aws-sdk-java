...
public class ListClustersRequestMarshaller {
    ...
    public void marshall(ListClustersRequest listClustersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listClustersRequest.getCreationTimeAfter(), CREATIONTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listClustersRequest.getCreationTimeBefore(), CREATIONTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listClustersRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listClustersRequest.getNameContains(), NAMECONTAINS_BINDING);
            protocolMarshaller.marshall(listClustersRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listClustersRequest.getSortBy(), SORTBY_BINDING);
            protocolMarshaller.marshall(listClustersRequest.getSortOrder(), SORTORDER_BINDING);
        } catch (Exception e) {
