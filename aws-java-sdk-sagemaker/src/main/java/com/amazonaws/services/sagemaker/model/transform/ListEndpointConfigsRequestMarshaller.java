...
@SdkInternalApi
public class ListEndpointConfigsRequestMarshaller {
    ...
    private static final ListEndpointConfigsRequestMarshaller instance = new ListEndpointConfigsRequestMarshaller();

    public static ListEndpointConfigsRequestMarshaller getInstance() {
        return instance;
    }
