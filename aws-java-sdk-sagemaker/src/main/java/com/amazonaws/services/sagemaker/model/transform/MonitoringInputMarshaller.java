...
/**
 * MonitoringInputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MonitoringInputMarshaller {
    ...
    public static MonitoringInputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MonitoringInput monitoringInput, ProtocolMarshaller protocolMarshaller) {

        if (monitoringInput == null) {
