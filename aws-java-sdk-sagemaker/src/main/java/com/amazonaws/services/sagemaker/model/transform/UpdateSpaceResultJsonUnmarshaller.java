...
/**
 * UpdateSpaceResult JSON Unmarshaller
 */
...
public class UpdateSpaceResultJsonUnmarshaller implements Unmarshaller<UpdateSpaceResult, JsonUnmarshallerContext> {
    ...
    public UpdateSpaceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateSpaceResult updateSpaceResult = new UpdateSpaceResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SpaceArn", targetDepth)) {
                    context.nextToken();
                    updateSpaceResult.setSpaceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
