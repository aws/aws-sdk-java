...
/**
 * AlgorithmSpecification JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AlgorithmSpecificationJsonUnmarshaller implements Unmarshaller<AlgorithmSpecification, JsonUnmarshallerContext> {
    ...
    private static AlgorithmSpecificationJsonUnmarshaller instance;

    public static AlgorithmSpecificationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AlgorithmSpecificationJsonUnmarshaller();
        return instance;
    }
}
