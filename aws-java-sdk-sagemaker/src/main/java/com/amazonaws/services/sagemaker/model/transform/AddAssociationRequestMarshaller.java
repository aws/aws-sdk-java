...
@SdkInternalApi
public class AddAssociationRequestMarshaller {
    ...
    private static final AddAssociationRequestMarshaller instance = new AddAssociationRequestMarshaller();

    public static AddAssociationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AddAssociationRequest addAssociationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(addAssociationRequest.getSourceArn(), SOURCEARN_BINDING);
            protocolMarshaller.marshall(addAssociationRequest.getDestinationArn(), DESTINATIONARN_BINDING);
            protocolMarshaller.marshall(addAssociationRequest.getAssociationType(), ASSOCIATIONTYPE_BINDING);
        } catch (Exception e) {
