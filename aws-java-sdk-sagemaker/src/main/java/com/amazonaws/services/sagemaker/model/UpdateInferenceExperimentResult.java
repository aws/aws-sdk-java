...
public class UpdateInferenceExperimentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateInferenceExperimentResult withInferenceExperimentArn(String inferenceExperimentArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateInferenceExperimentResult == false)
            return false;
        UpdateInferenceExperimentResult other = (UpdateInferenceExperimentResult) obj;
    ...
    @Override
    public UpdateInferenceExperimentResult clone() {
        try {
            return (UpdateInferenceExperimentResult) super.clone();
