...
/**
 * FlowDefinitionOutputConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FlowDefinitionOutputConfigJsonUnmarshaller implements Unmarshaller<FlowDefinitionOutputConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("S3OutputPath", targetDepth)) {
                    context.nextToken();
                    flowDefinitionOutputConfig.setS3OutputPath(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("KmsKeyId", targetDepth)) {
                    context.nextToken();
                    flowDefinitionOutputConfig.setKmsKeyId(context.getUnmarshaller(String.class).unmarshall(context));
                }
