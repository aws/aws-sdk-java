 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/ResourceConfigForUpdate" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResourceConfigForUpdate implements Serializable, Cloneable, StructuredPojo {
    ...
    public ResourceConfigForUpdate withKeepAlivePeriodInSeconds(Integer keepAlivePeriodInSeconds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResourceConfigForUpdate == false)
            return false;
    ...
    @Override
    public ResourceConfigForUpdate clone() {
        try {
            return (ResourceConfigForUpdate) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.ResourceConfigForUpdateMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
