 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeploymentStageStatusSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeploymentStageStatusSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setDeploymentStatus(EdgeDeploymentStatus deploymentStatus) {
    ...
    public EdgeDeploymentStatus getDeploymentStatus() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeploymentStageStatusSummary == false)
            return false;
    ...
    @Override
    public DeploymentStageStatusSummary clone() {
        try {
            return (DeploymentStageStatusSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.DeploymentStageStatusSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
