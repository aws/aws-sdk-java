...
public class ObjectiveStatusCountersMarshaller {
    ...
    private static final MarshallingInfo<Integer> SUCCEEDED_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
    ...
    public void marshall(ObjectiveStatusCounters objectiveStatusCounters, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(objectiveStatusCounters.getSucceeded(), SUCCEEDED_BINDING);
            protocolMarshaller.marshall(objectiveStatusCounters.getPending(), PENDING_BINDING);
            protocolMarshaller.marshall(objectiveStatusCounters.getFailed(), FAILED_BINDING);
        } catch (Exception e) {
