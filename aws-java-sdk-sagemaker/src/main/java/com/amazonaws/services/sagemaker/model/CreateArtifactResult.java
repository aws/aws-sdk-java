...
public class CreateArtifactResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateArtifactResult == false)
            return false;
        CreateArtifactResult other = (CreateArtifactResult) obj;
    ...
    public CreateArtifactResult clone() {
        try {
            return (CreateArtifactResult) super.clone();
