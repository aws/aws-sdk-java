...
public class ListLabelingJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * If the result of the previous <code>ListLabelingJobs</code> request was truncated, the response includes a
    ...
    /**
     * <p>
     * A string in the labeling job name. This filter returns only labeling jobs whose name contains the specified
     * string.
     * </p>
     */
    ...
    public ListLabelingJobsRequest withCreationTimeAfter(java.util.Date creationTimeAfter) {
    ...
    public ListLabelingJobsRequest withCreationTimeBefore(java.util.Date creationTimeBefore) {
     ...
     * </p>
     * 
     * @return A filter that returns only labeling jobs modified after the specified time (timestamp).
     */
    ...
    public ListLabelingJobsRequest withLastModifiedTimeAfter(java.util.Date lastModifiedTimeAfter) {
     ...
     * </p>
     * 
     * @return A filter that returns only labeling jobs modified before the specified time (timestamp).
     */
    ...
    public ListLabelingJobsRequest withLastModifiedTimeBefore(java.util.Date lastModifiedTimeBefore) {
     ...
     * </p>
     * 
     * @return If the result of the previous <code>ListLabelingJobs</code> request was truncated, the response includes
     *         a <code>NextToken</code>. To retrieve the next set of labeling jobs, use the token in the next request.
     */
     ...
     * </p>
     * 
     * @return A string in the labeling job name. This filter returns only labeling jobs whose name contains the
     *         specified string.
     */
     ...
     * </p>
     * 
     * @return A filter that retrieves only labeling jobs with a specific status.
     * @see LabelingJobStatus
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLabelingJobsRequest == false)
            return false;
        ListLabelingJobsRequest other = (ListLabelingJobsRequest) obj;
    ...
    public ListLabelingJobsRequest clone() {
        return (ListLabelingJobsRequest) super.clone();
    }
