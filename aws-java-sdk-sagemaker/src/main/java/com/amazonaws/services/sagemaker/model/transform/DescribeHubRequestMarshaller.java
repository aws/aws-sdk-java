...
public class DescribeHubRequestMarshaller {
    ...
    public static DescribeHubRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeHubRequest describeHubRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeHubRequest.getHubName(), HUBNAME_BINDING);
        } catch (Exception e) {
