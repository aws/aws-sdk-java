...
public class DeleteTrialComponentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the component is being deleted.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTrialComponentResult == false)
            return false;
        DeleteTrialComponentResult other = (DeleteTrialComponentResult) obj;
    ...
    public DeleteTrialComponentResult clone() {
        try {
            return (DeleteTrialComponentResult) super.clone();
