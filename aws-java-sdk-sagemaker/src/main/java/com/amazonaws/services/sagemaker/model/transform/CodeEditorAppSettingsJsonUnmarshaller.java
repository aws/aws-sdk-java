...
/**
 * CodeEditorAppSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CodeEditorAppSettingsJsonUnmarshaller implements Unmarshaller<CodeEditorAppSettings, JsonUnmarshallerContext> {

    public CodeEditorAppSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        CodeEditorAppSettings codeEditorAppSettings = new CodeEditorAppSettings();
    ...
    private static CodeEditorAppSettingsJsonUnmarshaller instance;

    public static CodeEditorAppSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CodeEditorAppSettingsJsonUnmarshaller();
        return instance;
    }
}
