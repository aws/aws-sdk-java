...
/**
 * OidcConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OidcConfigJsonUnmarshaller implements Unmarshaller<OidcConfig, JsonUnmarshallerContext> {

    public OidcConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static OidcConfigJsonUnmarshaller instance;

    public static OidcConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OidcConfigJsonUnmarshaller();
        return instance;
    }
}
