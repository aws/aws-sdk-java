 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/RecommendationJobPayloadConfig"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RecommendationJobPayloadConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public RecommendationJobPayloadConfig withSupportedContentTypes(java.util.Collection<String> supportedContentTypes) {
    ...
    public String toString() {
        ...
        if (getSupportedContentTypes() != null)
            sb.append("SupportedContentTypes: ").append(getSupportedContentTypes());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RecommendationJobPayloadConfig == false)
            return false;
    ...
    @Override
    public RecommendationJobPayloadConfig clone() {
        try {
            return (RecommendationJobPayloadConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.RecommendationJobPayloadConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
