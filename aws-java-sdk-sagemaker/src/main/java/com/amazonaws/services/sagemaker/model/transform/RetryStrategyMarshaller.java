...
@SdkInternalApi
public class RetryStrategyMarshaller {
    ...
    public static RetryStrategyMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(RetryStrategy retryStrategy, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(retryStrategy.getMaximumRetryAttempts(), MAXIMUMRETRYATTEMPTS_BINDING);
        } catch (Exception e) {
