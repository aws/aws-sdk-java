        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("InstanceCount", targetDepth)) {
                    context.nextToken();
                    instanceGroup.setInstanceCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("InstanceGroupName", targetDepth)) {
                    context.nextToken();
                    instanceGroup.setInstanceGroupName(context.getUnmarshaller(String.class).unmarshall(context));
                }
