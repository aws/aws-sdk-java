...
public class DeleteInferenceComponentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the inference component to delete.
     */
    ...
    public DeleteInferenceComponentRequest withInferenceComponentName(String inferenceComponentName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteInferenceComponentRequest == false)
            return false;
        DeleteInferenceComponentRequest other = (DeleteInferenceComponentRequest) obj;
    ...
    @Override
    public DeleteInferenceComponentRequest clone() {
