...
/**
 * HyperParameterAlgorithmSpecification JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HyperParameterAlgorithmSpecificationJsonUnmarshaller implements Unmarshaller<HyperParameterAlgorithmSpecification, JsonUnmarshallerContext> {

    public HyperParameterAlgorithmSpecification unmarshall(JsonUnmarshallerContext context) throws Exception {
