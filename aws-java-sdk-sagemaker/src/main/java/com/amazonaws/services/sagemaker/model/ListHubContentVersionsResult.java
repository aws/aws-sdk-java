...
public class ListHubContentVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * If the response is truncated, SageMaker returns this token. To retrieve the next set of hub content versions, use
     ...
     * </p>
     * 
     * @return The summaries of the listed hub content versions.
     */
    ...
    public ListHubContentVersionsResult withHubContentSummaries(HubContentInfo... hubContentSummaries) {
    ...
    public ListHubContentVersionsResult withHubContentSummaries(java.util.Collection<HubContentInfo> hubContentSummaries) {
     ...
     * </p>
     * 
     * @return If the response is truncated, SageMaker returns this token. To retrieve the next set of hub content
     *         versions, use it in the subsequent request.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListHubContentVersionsResult == false)
            return false;
        ListHubContentVersionsResult other = (ListHubContentVersionsResult) obj;
