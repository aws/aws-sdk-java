...
class EndpointInService {
    ...
    static class IsInServiceMatcher extends WaiterAcceptor<DescribeEndpointResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("EndpointStatus");
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeEndpointResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsValidationExceptionMatcher extends WaiterAcceptor<DescribeEndpointResult> {
        /**
