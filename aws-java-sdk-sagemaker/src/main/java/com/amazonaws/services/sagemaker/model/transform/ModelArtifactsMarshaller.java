...
/**
 * ModelArtifactsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ModelArtifactsMarshaller {

    private static final MarshallingInfo<String> S3MODELARTIFACTS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("S3ModelArtifacts").build();
