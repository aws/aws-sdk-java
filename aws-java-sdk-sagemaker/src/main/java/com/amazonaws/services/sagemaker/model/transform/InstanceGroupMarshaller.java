...
public class InstanceGroupMarshaller {
    ...
    public void marshall(InstanceGroup instanceGroup, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(instanceGroup.getInstanceCount(), INSTANCECOUNT_BINDING);
            protocolMarshaller.marshall(instanceGroup.getInstanceGroupName(), INSTANCEGROUPNAME_BINDING);
        } catch (Exception e) {
