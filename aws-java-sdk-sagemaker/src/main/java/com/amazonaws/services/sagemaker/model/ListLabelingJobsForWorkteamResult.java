...
public class ListLabelingJobsForWorkteamResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setLabelingJobSummaryList(java.util.Collection<LabelingJobForWorkteamSummary> labelingJobSummaryList) {
        if (labelingJobSummaryList == null) {
            this.labelingJobSummaryList = null;
            return;
        }

        this.labelingJobSummaryList = new java.util.ArrayList<LabelingJobForWorkteamSummary>(labelingJobSummaryList);
    }
    ...
    public ListLabelingJobsForWorkteamResult withLabelingJobSummaryList(LabelingJobForWorkteamSummary... labelingJobSummaryList) {
        if (this.labelingJobSummaryList == null) {
            setLabelingJobSummaryList(new java.util.ArrayList<LabelingJobForWorkteamSummary>(labelingJobSummaryList.length));
        }
        for (LabelingJobForWorkteamSummary ele : labelingJobSummaryList) {
    ...
    public ListLabelingJobsForWorkteamResult withLabelingJobSummaryList(java.util.Collection<LabelingJobForWorkteamSummary> labelingJobSummaryList) {
    ...
    @Override
    public ListLabelingJobsForWorkteamResult clone() {
        try {
            return (ListLabelingJobsForWorkteamResult) super.clone();
