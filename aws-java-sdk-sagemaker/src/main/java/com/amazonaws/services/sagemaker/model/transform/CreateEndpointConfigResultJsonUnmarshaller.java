...
/**
 * CreateEndpointConfigResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateEndpointConfigResultJsonUnmarshaller implements Unmarshaller<CreateEndpointConfigResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("EndpointConfigArn", targetDepth)) {
                    context.nextToken();
                    createEndpointConfigResult.setEndpointConfigArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
