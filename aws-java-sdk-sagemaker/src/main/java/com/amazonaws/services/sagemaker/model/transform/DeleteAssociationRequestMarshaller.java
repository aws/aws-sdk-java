...
public class DeleteAssociationRequestMarshaller {
    ...
    public void marshall(DeleteAssociationRequest deleteAssociationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteAssociationRequest.getSourceArn(), SOURCEARN_BINDING);
            protocolMarshaller.marshall(deleteAssociationRequest.getDestinationArn(), DESTINATIONARN_BINDING);
        } catch (Exception e) {
