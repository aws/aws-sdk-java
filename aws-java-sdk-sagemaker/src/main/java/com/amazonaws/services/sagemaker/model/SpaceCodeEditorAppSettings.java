 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/SpaceCodeEditorAppSettings"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SpaceCodeEditorAppSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public SpaceCodeEditorAppSettings withDefaultResourceSpec(ResourceSpec defaultResourceSpec) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SpaceCodeEditorAppSettings == false)
            return false;
    ...
    @Override
    public SpaceCodeEditorAppSettings clone() {
        try {
            return (SpaceCodeEditorAppSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.SpaceCodeEditorAppSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
