 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/SpaceSharingSettings" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SpaceSharingSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SpaceSharingSettings == false)
            return false;
        SpaceSharingSettings other = (SpaceSharingSettings) obj;
    ...
    public SpaceSharingSettings clone() {
        try {
            return (SpaceSharingSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.SpaceSharingSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
