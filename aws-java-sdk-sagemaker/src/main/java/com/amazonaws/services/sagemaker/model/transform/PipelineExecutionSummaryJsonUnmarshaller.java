...
/**
 * PipelineExecutionSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PipelineExecutionSummaryJsonUnmarshaller implements Unmarshaller<PipelineExecutionSummary, JsonUnmarshallerContext> {

    public PipelineExecutionSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        PipelineExecutionSummary pipelineExecutionSummary = new PipelineExecutionSummary();
    ...
    private static PipelineExecutionSummaryJsonUnmarshaller instance;

    public static PipelineExecutionSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PipelineExecutionSummaryJsonUnmarshaller();
        return instance;
    }
}
