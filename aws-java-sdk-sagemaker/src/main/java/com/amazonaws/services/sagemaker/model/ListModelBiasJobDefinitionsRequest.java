...
public class ListModelBiasJobDefinitionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Name of the endpoint to monitor for model bias.
     */
    ...
    public ListModelBiasJobDefinitionsRequest withSortBy(String sortBy) {
        setSortBy(sortBy);
        return this;
    }
    ...
    public ListModelBiasJobDefinitionsRequest withSortBy(MonitoringJobDefinitionSortKey sortBy) {
    ...
    public ListModelBiasJobDefinitionsRequest withSortOrder(String sortOrder) {
    ...
    public ListModelBiasJobDefinitionsRequest withSortOrder(SortOrder sortOrder) {
     ...
     * </p>
     * 
     * @return The maximum number of model bias jobs to return in the response. The default value is 10.
     */
     ...
     * </p>
     * 
     * @return Filter for model bias jobs whose name contains a specified string.
     */
     ...
     * </p>
     * 
     * @return A filter that returns only model bias jobs created before a specified time.
     */
    ...
    public ListModelBiasJobDefinitionsRequest withCreationTimeBefore(java.util.Date creationTimeBefore) {
     ...
     * </p>
     * 
     * @return A filter that returns only model bias jobs created after a specified time.
     */
    ...
    public ListModelBiasJobDefinitionsRequest withCreationTimeAfter(java.util.Date creationTimeAfter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListModelBiasJobDefinitionsRequest == false)
            return false;
        ListModelBiasJobDefinitionsRequest other = (ListModelBiasJobDefinitionsRequest) obj;
    ...
    @Override
    public ListModelBiasJobDefinitionsRequest clone() {
        return (ListModelBiasJobDefinitionsRequest) super.clone();
    }
