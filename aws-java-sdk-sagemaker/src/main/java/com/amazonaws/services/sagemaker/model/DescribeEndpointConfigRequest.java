...
public class DescribeEndpointConfigRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeEndpointConfigRequest withEndpointConfigName(String endpointConfigName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEndpointConfigRequest == false)
            return false;
        DescribeEndpointConfigRequest other = (DescribeEndpointConfigRequest) obj;
    ...
    @Override
    public DescribeEndpointConfigRequest clone() {
        return (DescribeEndpointConfigRequest) super.clone();
    }
