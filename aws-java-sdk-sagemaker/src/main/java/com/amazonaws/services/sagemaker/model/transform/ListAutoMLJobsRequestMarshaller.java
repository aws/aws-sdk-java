...
/**
 * ListAutoMLJobsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListAutoMLJobsRequestMarshaller {
    ...
    private static final ListAutoMLJobsRequestMarshaller instance = new ListAutoMLJobsRequestMarshaller();

    public static ListAutoMLJobsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListAutoMLJobsRequest listAutoMLJobsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listAutoMLJobsRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(listAutoMLJobsRequest.getCreationTimeAfter(), CREATIONTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listAutoMLJobsRequest.getCreationTimeBefore(), CREATIONTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listAutoMLJobsRequest.getLastModifiedTimeAfter(), LASTMODIFIEDTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listAutoMLJobsRequest.getLastModifiedTimeBefore(), LASTMODIFIEDTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listAutoMLJobsRequest.getNameContains(), NAMECONTAINS_BINDING);
            protocolMarshaller.marshall(listAutoMLJobsRequest.getStatusEquals(), STATUSEQUALS_BINDING);
            protocolMarshaller.marshall(listAutoMLJobsRequest.getSortOrder(), SORTORDER_BINDING);
            protocolMarshaller.marshall(listAutoMLJobsRequest.getSortBy(), SORTBY_BINDING);
            protocolMarshaller.marshall(listAutoMLJobsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listAutoMLJobsRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
