...
/**
 * ModelMetrics JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModelMetricsJsonUnmarshaller implements Unmarshaller<ModelMetrics, JsonUnmarshallerContext> {

    public ModelMetrics unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ModelMetricsJsonUnmarshaller instance;

    public static ModelMetricsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ModelMetricsJsonUnmarshaller();
        return instance;
    }
}
