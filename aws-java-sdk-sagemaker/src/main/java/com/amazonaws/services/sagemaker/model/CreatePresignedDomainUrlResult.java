...
public class CreatePresignedDomainUrlResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public CreatePresignedDomainUrlResult clone() {
        try {
            return (CreatePresignedDomainUrlResult) super.clone();
