...
public class ListClustersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ClusterSummary> clusterSummaries;
    ...
    public java.util.List<ClusterSummary> getClusterSummaries() {
    ...
    public void setClusterSummaries(java.util.Collection<ClusterSummary> clusterSummaries) {
        if (clusterSummaries == null) {
            this.clusterSummaries = null;
            return;
        }

        this.clusterSummaries = new java.util.ArrayList<ClusterSummary>(clusterSummaries);
    }
     ...
     * {@link #setClusterSummaries(java.util.Collection)} or {@link #withClusterSummaries(java.util.Collection)} if you
    ...
    public ListClustersResult withClusterSummaries(ClusterSummary... clusterSummaries) {
        if (this.clusterSummaries == null) {
            setClusterSummaries(new java.util.ArrayList<ClusterSummary>(clusterSummaries.length));
        }
    ...
    public ListClustersResult withClusterSummaries(java.util.Collection<ClusterSummary> clusterSummaries) {
        setClusterSummaries(clusterSummaries);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getClusterSummaries() != null)
            sb.append("ClusterSummaries: ").append(getClusterSummaries());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getClusterSummaries() == null ^ this.getClusterSummaries() == null)
            return false;
        if (other.getClusterSummaries() != null && other.getClusterSummaries().equals(this.getClusterSummaries()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getClusterSummaries() == null) ? 0 : getClusterSummaries().hashCode());
        return hashCode;
    }
