 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/ProfilerRuleEvaluationStatus"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProfilerRuleEvaluationStatus implements Serializable, Cloneable, StructuredPojo {
    ...
    public ProfilerRuleEvaluationStatus withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ProfilerRuleEvaluationStatus == false)
            return false;
    ...
    public ProfilerRuleEvaluationStatus clone() {
        try {
            return (ProfilerRuleEvaluationStatus) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.ProfilerRuleEvaluationStatusMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
