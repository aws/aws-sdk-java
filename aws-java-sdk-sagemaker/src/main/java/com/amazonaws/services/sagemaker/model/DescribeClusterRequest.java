...
public class DescribeClusterRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The string name or the Amazon Resource Name (ARN) of the SageMaker HyperPod cluster.
     */
    ...
    public DescribeClusterRequest withClusterName(String clusterName) {
