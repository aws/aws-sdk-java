 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/WorkforceVpcConfigResponse"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorkforceVpcConfigResponse implements Serializable, Cloneable, StructuredPojo {
    ...
    public WorkforceVpcConfigResponse withSecurityGroupIds(java.util.Collection<String> securityGroupIds) {
    ...
    public WorkforceVpcConfigResponse withSubnets(java.util.Collection<String> subnets) {
        setSubnets(subnets);
        return this;
    }
     ...
     * </p>
     * 
     * @return The IDs for the VPC service endpoints of your VPC workforce when it is created and updated.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WorkforceVpcConfigResponse == false)
            return false;
        WorkforceVpcConfigResponse other = (WorkforceVpcConfigResponse) obj;
    ...
    public WorkforceVpcConfigResponse clone() {
        try {
            return (WorkforceVpcConfigResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.WorkforceVpcConfigResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
