...
public class CreateInferenceComponentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateInferenceComponentResult == false)
            return false;
        CreateInferenceComponentResult other = (CreateInferenceComponentResult) obj;
    ...
    public CreateInferenceComponentResult clone() {
        try {
            return (CreateInferenceComponentResult) super.clone();
