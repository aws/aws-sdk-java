...
public class PutModelPackageGroupPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the model package group.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutModelPackageGroupPolicyResult == false)
            return false;
        PutModelPackageGroupPolicyResult other = (PutModelPackageGroupPolicyResult) obj;
    ...
    public PutModelPackageGroupPolicyResult clone() {
        try {
            return (PutModelPackageGroupPolicyResult) super.clone();
