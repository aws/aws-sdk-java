...
public class CreateImageVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateImageVersionResult withImageVersionArn(String imageVersionArn) {
    ...
    public String toString() {
        ...
        if (getImageVersionArn() != null)
            sb.append("ImageVersionArn: ").append(getImageVersionArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateImageVersionResult == false)
            return false;
        CreateImageVersionResult other = (CreateImageVersionResult) obj;
    ...
    @Override
    public CreateImageVersionResult clone() {
        try {
            return (CreateImageVersionResult) super.clone();
