...
/**
 * JupyterLabAppImageConfigMarshaller
 */
...
public class JupyterLabAppImageConfigMarshaller {
    ...
    private static final JupyterLabAppImageConfigMarshaller instance = new JupyterLabAppImageConfigMarshaller();

    public static JupyterLabAppImageConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(JupyterLabAppImageConfig jupyterLabAppImageConfig, ProtocolMarshaller protocolMarshaller) {
