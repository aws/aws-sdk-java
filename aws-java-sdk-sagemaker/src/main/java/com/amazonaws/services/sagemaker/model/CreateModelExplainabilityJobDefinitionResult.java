...
public class CreateModelExplainabilityJobDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateModelExplainabilityJobDefinitionResult withJobDefinitionArn(String jobDefinitionArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateModelExplainabilityJobDefinitionResult == false)
            return false;
        CreateModelExplainabilityJobDefinitionResult other = (CreateModelExplainabilityJobDefinitionResult) obj;
    ...
    @Override
    public CreateModelExplainabilityJobDefinitionResult clone() {
        try {
            return (CreateModelExplainabilityJobDefinitionResult) super.clone();
