...
/**
 * EdgeOutputConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EdgeOutputConfigMarshaller {
    ...
    public static EdgeOutputConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EdgeOutputConfig edgeOutputConfig, ProtocolMarshaller protocolMarshaller) {

        if (edgeOutputConfig == null) {
