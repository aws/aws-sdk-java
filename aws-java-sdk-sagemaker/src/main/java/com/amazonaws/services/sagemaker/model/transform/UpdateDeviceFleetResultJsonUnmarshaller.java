...
/**
 * UpdateDeviceFleetResult JSON Unmarshaller
 */
...
public class UpdateDeviceFleetResultJsonUnmarshaller implements Unmarshaller<UpdateDeviceFleetResult, JsonUnmarshallerContext> {
    ...
    public UpdateDeviceFleetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDeviceFleetResult updateDeviceFleetResult = new UpdateDeviceFleetResult();

        return updateDeviceFleetResult;
    }
