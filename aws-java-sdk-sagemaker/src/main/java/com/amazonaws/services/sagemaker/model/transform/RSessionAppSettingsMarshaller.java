...
public class RSessionAppSettingsMarshaller {
    ...
    public static RSessionAppSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RSessionAppSettings rSessionAppSettings, ProtocolMarshaller protocolMarshaller) {
