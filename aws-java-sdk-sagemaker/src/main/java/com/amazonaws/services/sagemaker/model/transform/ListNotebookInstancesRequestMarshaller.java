...
public class ListNotebookInstancesRequestMarshaller {
    ...
    public static ListNotebookInstancesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListNotebookInstancesRequest listNotebookInstancesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listNotebookInstancesRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listNotebookInstancesRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listNotebookInstancesRequest.getSortBy(), SORTBY_BINDING);
            protocolMarshaller.marshall(listNotebookInstancesRequest.getSortOrder(), SORTORDER_BINDING);
            protocolMarshaller.marshall(listNotebookInstancesRequest.getNameContains(), NAMECONTAINS_BINDING);
            protocolMarshaller.marshall(listNotebookInstancesRequest.getCreationTimeBefore(), CREATIONTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listNotebookInstancesRequest.getCreationTimeAfter(), CREATIONTIMEAFTER_BINDING);
