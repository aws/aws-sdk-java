...
@SdkInternalApi
public class HyperParameterTuningJobObjectiveMarshaller {
    ...
    private static final HyperParameterTuningJobObjectiveMarshaller instance = new HyperParameterTuningJobObjectiveMarshaller();

    public static HyperParameterTuningJobObjectiveMarshaller getInstance() {
        return instance;
    }
