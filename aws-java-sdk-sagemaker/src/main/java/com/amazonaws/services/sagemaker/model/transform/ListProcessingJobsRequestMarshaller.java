...
/**
 * ListProcessingJobsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListProcessingJobsRequestMarshaller {
    ...
    private static final ListProcessingJobsRequestMarshaller instance = new ListProcessingJobsRequestMarshaller();

    public static ListProcessingJobsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListProcessingJobsRequest listProcessingJobsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listProcessingJobsRequest.getCreationTimeAfter(), CREATIONTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listProcessingJobsRequest.getCreationTimeBefore(), CREATIONTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listProcessingJobsRequest.getLastModifiedTimeAfter(), LASTMODIFIEDTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listProcessingJobsRequest.getLastModifiedTimeBefore(), LASTMODIFIEDTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listProcessingJobsRequest.getNameContains(), NAMECONTAINS_BINDING);
            protocolMarshaller.marshall(listProcessingJobsRequest.getStatusEquals(), STATUSEQUALS_BINDING);
            protocolMarshaller.marshall(listProcessingJobsRequest.getSortBy(), SORTBY_BINDING);
            protocolMarshaller.marshall(listProcessingJobsRequest.getSortOrder(), SORTORDER_BINDING);
            protocolMarshaller.marshall(listProcessingJobsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listProcessingJobsRequest.getMaxResults(), MAXRESULTS_BINDING);
        } catch (Exception e) {
