...
public class DisassociateTrialComponentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateTrialComponentResult == false)
            return false;
        DisassociateTrialComponentResult other = (DisassociateTrialComponentResult) obj;
    ...
    public DisassociateTrialComponentResult clone() {
        try {
            return (DisassociateTrialComponentResult) super.clone();
