        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("DataSource", targetDepth)) {
                    context.nextToken();
                    channel.setDataSource(DataSourceJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ContentType", targetDepth)) {
                    context.nextToken();
                    channel.setContentType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("CompressionType", targetDepth)) {
                    context.nextToken();
                    channel.setCompressionType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("ShuffleConfig", targetDepth)) {
                    context.nextToken();
                    channel.setShuffleConfig(ShuffleConfigJsonUnmarshaller.getInstance().unmarshall(context));
                }
