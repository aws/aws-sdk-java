...
/**
 * TrialComponentArtifact JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TrialComponentArtifactJsonUnmarshaller implements Unmarshaller<TrialComponentArtifact, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MediaType", targetDepth)) {
                    context.nextToken();
                    trialComponentArtifact.setMediaType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Value", targetDepth)) {
                    context.nextToken();
                    trialComponentArtifact.setValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
