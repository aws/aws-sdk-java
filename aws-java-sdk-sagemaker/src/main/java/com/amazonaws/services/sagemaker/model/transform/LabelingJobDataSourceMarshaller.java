...
/**
 * LabelingJobDataSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LabelingJobDataSourceMarshaller {
    ...
    public static LabelingJobDataSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LabelingJobDataSource labelingJobDataSource, ProtocolMarshaller protocolMarshaller) {

        if (labelingJobDataSource == null) {
