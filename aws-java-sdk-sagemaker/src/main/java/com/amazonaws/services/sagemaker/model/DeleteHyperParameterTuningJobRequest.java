...
public class DeleteHyperParameterTuningJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the hyperparameter tuning job that you want to delete.
     */
    ...
    public DeleteHyperParameterTuningJobRequest withHyperParameterTuningJobName(String hyperParameterTuningJobName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteHyperParameterTuningJobRequest == false)
            return false;
        DeleteHyperParameterTuningJobRequest other = (DeleteHyperParameterTuningJobRequest) obj;
    ...
    public DeleteHyperParameterTuningJobRequest clone() {
        return (DeleteHyperParameterTuningJobRequest) super.clone();
    }
