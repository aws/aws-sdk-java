...
/**
 * MonitoringStoppingCondition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MonitoringStoppingConditionJsonUnmarshaller implements Unmarshaller<MonitoringStoppingCondition, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MaxRuntimeInSeconds", targetDepth)) {
                    context.nextToken();
                    monitoringStoppingCondition.setMaxRuntimeInSeconds(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
