...
/**
 * AlgorithmValidationSpecificationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AlgorithmValidationSpecificationMarshaller {
    ...
    private static final AlgorithmValidationSpecificationMarshaller instance = new AlgorithmValidationSpecificationMarshaller();

    public static AlgorithmValidationSpecificationMarshaller getInstance() {
        return instance;
    }
