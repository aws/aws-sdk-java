...
/**
 * CreateExperimentResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateExperimentResultJsonUnmarshaller implements Unmarshaller<CreateExperimentResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ExperimentArn", targetDepth)) {
                    context.nextToken();
                    createExperimentResult.setExperimentArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
