...
class NotebookInstance_Stopped {
    ...
    static class IsStoppedMatcher extends WaiterAcceptor<DescribeNotebookInstanceResult> {
    ...
    static class IsStoppingMatcher extends WaiterAcceptor<DescribeNotebookInstanceResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsThrottlingExceptionMatcher extends WaiterAcceptor<DescribeNotebookInstanceResult> {
        /**
