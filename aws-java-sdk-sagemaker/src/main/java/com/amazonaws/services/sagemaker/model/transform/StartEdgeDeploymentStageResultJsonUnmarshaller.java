...
/**
 * StartEdgeDeploymentStageResult JSON Unmarshaller
 */
...
public class StartEdgeDeploymentStageResultJsonUnmarshaller implements Unmarshaller<StartEdgeDeploymentStageResult, JsonUnmarshallerContext> {
    ...
    public StartEdgeDeploymentStageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartEdgeDeploymentStageResult startEdgeDeploymentStageResult = new StartEdgeDeploymentStageResult();

        return startEdgeDeploymentStageResult;
    }
