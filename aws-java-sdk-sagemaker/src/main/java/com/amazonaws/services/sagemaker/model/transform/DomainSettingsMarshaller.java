...
public class DomainSettingsMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> RSTUDIOSERVERPRODOMAINSETTINGS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
