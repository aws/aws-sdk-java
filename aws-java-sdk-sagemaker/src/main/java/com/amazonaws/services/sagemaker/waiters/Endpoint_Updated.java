...
class Endpoint_Updated {
    ...
    static class Is200Matcher extends WaiterAcceptor<DescribeEndpointResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("EndpointName");
    ...
    static class IsUpdatingMatcher extends WaiterAcceptor<DescribeEndpointResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsRollingBackMatcher extends WaiterAcceptor<DescribeEndpointResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsThrottlingExceptionMatcher extends WaiterAcceptor<DescribeEndpointResult> {
        /**
