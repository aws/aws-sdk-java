...
/**
 * DeleteDataQualityJobDefinitionResult JSON Unmarshaller
 */
...
public class DeleteDataQualityJobDefinitionResultJsonUnmarshaller implements Unmarshaller<DeleteDataQualityJobDefinitionResult, JsonUnmarshallerContext> {
    ...
    public DeleteDataQualityJobDefinitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDataQualityJobDefinitionResult deleteDataQualityJobDefinitionResult = new DeleteDataQualityJobDefinitionResult();

        return deleteDataQualityJobDefinitionResult;
    }
