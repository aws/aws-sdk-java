...
/**
 * ListAssociatedFleetsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListAssociatedFleetsRequestMarshaller {
    ...
    private static final ListAssociatedFleetsRequestMarshaller instance = new ListAssociatedFleetsRequestMarshaller();

    public static ListAssociatedFleetsRequestMarshaller getInstance() {
        return instance;
    }
