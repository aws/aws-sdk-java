...
public class DescribeFleetsRequestMarshaller implements Marshaller<Request<DescribeFleetsRequest>, DescribeFleetsRequest> {
    ...
    public Request<DescribeFleetsRequest> marshall(DescribeFleetsRequest describeFleetsRequest) {
        ...
        Request<DescribeFleetsRequest> request = new DefaultRequest<DescribeFleetsRequest>(describeFleetsRequest, "AmazonAppStream");
        request.addHeader("X-Amz-Target", "PhotonAdminProxyService.DescribeFleets");
        ...
        try {
            ...
            java.util.List<String> namesList = describeFleetsRequest.getNames();
            if (namesList != null) {
            ...
            if (describeFleetsRequest.getNextToken() != null) {
                jsonGenerator.writeFieldName("NextToken").writeValue(describeFleetsRequest.getNextToken());
            }
