...
public class ImageStateChangeReasonJsonMarshaller {
     ...
     */
    public void marshall(ImageStateChangeReason imageStateChangeReason, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (imageStateChangeReason.getCode() != null) {
                jsonGenerator.writeFieldName("Code").writeValue(imageStateChangeReason.getCode());
            }
            if (imageStateChangeReason.getMessage() != null) {
                jsonGenerator.writeFieldName("Message").writeValue(imageStateChangeReason.getMessage());
            }
