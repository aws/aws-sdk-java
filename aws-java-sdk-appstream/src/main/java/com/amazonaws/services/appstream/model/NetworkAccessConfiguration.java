 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appstream-2016-12-01/NetworkAccessConfiguration"
...
public class NetworkAccessConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public NetworkAccessConfiguration withEniPrivateIpAddress(String eniPrivateIpAddress) {
        setEniPrivateIpAddress(eniPrivateIpAddress);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEniPrivateIpAddress() == null ^ this.getEniPrivateIpAddress() == null)
            return false;
        if (other.getEniPrivateIpAddress() != null && other.getEniPrivateIpAddress().equals(this.getEniPrivateIpAddress()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getEniPrivateIpAddress() == null) ? 0 : getEniPrivateIpAddress().hashCode());
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appstream.model.transform.NetworkAccessConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
