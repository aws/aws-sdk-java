...
public class BatchDisassociateUserStackRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public BatchDisassociateUserStackRequest withUserStackAssociations(java.util.Collection<UserStackAssociation> userStackAssociations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchDisassociateUserStackRequest == false)
            return false;
        BatchDisassociateUserStackRequest other = (BatchDisassociateUserStackRequest) obj;
    ...
    @Override
    public BatchDisassociateUserStackRequest clone() {
        return (BatchDisassociateUserStackRequest) super.clone();
    }
