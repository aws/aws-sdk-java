...
public class DescribeStacksRequestMarshaller {
    ...
    public void marshall(DescribeStacksRequest describeStacksRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeStacksRequest.getNames(), NAMES_BINDING);
            protocolMarshaller.marshall(describeStacksRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
