...
public class CreateEntitlementRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateEntitlementRequest withAttributes(java.util.Collection<EntitlementAttribute> attributes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateEntitlementRequest == false)
            return false;
        CreateEntitlementRequest other = (CreateEntitlementRequest) obj;
    ...
    public CreateEntitlementRequest clone() {
        return (CreateEntitlementRequest) super.clone();
    }
