...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appstream-2016-12-01/DescribeFleets"/>AWS API Documentation</a>
 */
public class DescribeFleetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeFleetsRequest withNames(java.util.Collection<String> names) {
        setNames(names);
        return this;
    }
