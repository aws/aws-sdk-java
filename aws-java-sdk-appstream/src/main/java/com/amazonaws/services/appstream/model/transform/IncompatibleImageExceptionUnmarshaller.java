...
public class IncompatibleImageExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static IncompatibleImageExceptionUnmarshaller instance;

    public static IncompatibleImageExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IncompatibleImageExceptionUnmarshaller();
        return instance;
    }
}
