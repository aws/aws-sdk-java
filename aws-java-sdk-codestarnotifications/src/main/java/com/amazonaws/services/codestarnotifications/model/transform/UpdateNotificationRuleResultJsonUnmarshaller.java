...
/**
 * UpdateNotificationRuleResult JSON Unmarshaller
 */
...
public class UpdateNotificationRuleResultJsonUnmarshaller implements Unmarshaller<UpdateNotificationRuleResult, JsonUnmarshallerContext> {
    ...
    public UpdateNotificationRuleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateNotificationRuleResult updateNotificationRuleResult = new UpdateNotificationRuleResult();
