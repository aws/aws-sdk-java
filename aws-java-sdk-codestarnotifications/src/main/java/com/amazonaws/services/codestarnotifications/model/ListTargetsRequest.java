...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/codestar-notifications-2019-10-15/ListTargets" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListTargetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </note>
     */
    private java.util.List<ListTargetsFilter> filters;
    /**
     * <p>
    ...
    public java.util.List<ListTargetsFilter> getFilters() {
        return filters;
    }
    ...
    public void setFilters(java.util.Collection<ListTargetsFilter> filters) {
        if (filters == null) {
            this.filters = null;
            return;
        }

        this.filters = new java.util.ArrayList<ListTargetsFilter>(filters);
    }
    ...
    public ListTargetsRequest withFilters(ListTargetsFilter... filters) {
        if (this.filters == null) {
            setFilters(new java.util.ArrayList<ListTargetsFilter>(filters.length));
        }
    ...
    public ListTargetsRequest withFilters(java.util.Collection<ListTargetsFilter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTargetsRequest == false)
            return false;
