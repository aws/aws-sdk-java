        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TargetType", targetDepth)) {
                    context.nextToken();
                    target.setTargetType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("TargetAddress", targetDepth)) {
                    context.nextToken();
                    target.setTargetAddress(context.getUnmarshaller(String.class).unmarshall(context));
                }
