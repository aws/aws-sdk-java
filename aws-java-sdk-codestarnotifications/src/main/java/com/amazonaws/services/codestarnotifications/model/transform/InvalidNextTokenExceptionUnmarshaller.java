...
public class InvalidNextTokenExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidNextTokenExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarnotifications.model.InvalidNextTokenException.class, "InvalidNextTokenException");
    }

    @Override
    public com.amazonaws.services.codestarnotifications.model.InvalidNextTokenException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codestarnotifications.model.InvalidNextTokenException invalidNextTokenException = new com.amazonaws.services.codestarnotifications.model.InvalidNextTokenException(
                null);
