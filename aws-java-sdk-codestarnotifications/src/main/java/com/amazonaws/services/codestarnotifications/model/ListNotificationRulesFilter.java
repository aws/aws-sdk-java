...
/**
 * <p>
 * Information about a filter to apply to the list of returned notification rules. You can filter by event type, owner,
 * resource, or target.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/codestar-notifications-2019-10-15/ListNotificationRulesFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListNotificationRulesFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * @param name
     *        The name of the attribute you want to use to filter the returned notification rules.
     * @see ListNotificationRulesFilterName
     */
     ...
     * </p>
     * 
     * @return The name of the attribute you want to use to filter the returned notification rules.
     * @see ListNotificationRulesFilterName
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListNotificationRulesFilter == false)
            return false;
        ListNotificationRulesFilter other = (ListNotificationRulesFilter) obj;
    ...
    public ListNotificationRulesFilter clone() {
        try {
            return (ListNotificationRulesFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.codestarnotifications.model.transform.ListNotificationRulesFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
