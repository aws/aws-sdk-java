...
public class StopCisSessionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public void setMessage(StopCisSessionMessage message) {
    ...
    public StopCisSessionMessage getMessage() {
        return this.message;
    }
    ...
    public StopCisSessionRequest withMessage(StopCisSessionMessage message) {
        setMessage(message);
        return this;
    }
    ...
    public StopCisSessionRequest withScanJobId(String scanJobId) {
    ...
    public StopCisSessionRequest withSessionToken(String sessionToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopCisSessionRequest == false)
            return false;
    ...
    @Override
    public StopCisSessionRequest clone() {
        return (StopCisSessionRequest) super.clone();
    }
