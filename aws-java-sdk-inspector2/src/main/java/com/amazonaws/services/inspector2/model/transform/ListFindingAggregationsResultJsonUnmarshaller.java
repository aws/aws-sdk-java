...
/**
 * ListFindingAggregationsResult JSON Unmarshaller
 */
...
public class ListFindingAggregationsResultJsonUnmarshaller implements Unmarshaller<ListFindingAggregationsResult, JsonUnmarshallerContext> {
    ...
    public ListFindingAggregationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("aggregationType", targetDepth)) {
                    context.nextToken();
                    listFindingAggregationsResult.setAggregationType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listFindingAggregationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("responses", targetDepth)) {
                    context.nextToken();
                    listFindingAggregationsResult.setResponses(new ListUnmarshaller<AggregationResponse>(AggregationResponseJsonUnmarshaller.getInstance())
