...
/**
 * LambdaFunctionMetadata JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LambdaFunctionMetadataJsonUnmarshaller implements Unmarshaller<LambdaFunctionMetadata, JsonUnmarshallerContext> {

    public LambdaFunctionMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        LambdaFunctionMetadata lambdaFunctionMetadata = new LambdaFunctionMetadata();
    ...
    private static LambdaFunctionMetadataJsonUnmarshaller instance;

    public static LambdaFunctionMetadataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LambdaFunctionMetadataJsonUnmarshaller();
        return instance;
    }
}
