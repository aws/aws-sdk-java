...
public class ListFindingsResultJsonUnmarshaller implements Unmarshaller<ListFindingsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("findings", targetDepth)) {
                    context.nextToken();
                    listFindingsResult.setFindings(new ListUnmarshaller<Finding>(FindingJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listFindingsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
