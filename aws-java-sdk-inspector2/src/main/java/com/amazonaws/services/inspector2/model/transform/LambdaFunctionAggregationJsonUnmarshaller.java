...
/**
 * LambdaFunctionAggregation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LambdaFunctionAggregationJsonUnmarshaller implements Unmarshaller<LambdaFunctionAggregation, JsonUnmarshallerContext> {

    public LambdaFunctionAggregation unmarshall(JsonUnmarshallerContext context) throws Exception {
        LambdaFunctionAggregation lambdaFunctionAggregation = new LambdaFunctionAggregation();
    ...
    private static LambdaFunctionAggregationJsonUnmarshaller instance;

    public static LambdaFunctionAggregationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LambdaFunctionAggregationJsonUnmarshaller();
        return instance;
    }
}
