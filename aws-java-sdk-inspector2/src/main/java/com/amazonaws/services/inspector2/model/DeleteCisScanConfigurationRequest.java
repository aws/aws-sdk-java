...
public class DeleteCisScanConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the CIS scan configuration.
     */
    ...
    public DeleteCisScanConfigurationRequest withScanConfigurationArn(String scanConfigurationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteCisScanConfigurationRequest == false)
            return false;
        DeleteCisScanConfigurationRequest other = (DeleteCisScanConfigurationRequest) obj;
    ...
    @Override
    public DeleteCisScanConfigurationRequest clone() {
        return (DeleteCisScanConfigurationRequest) super.clone();
    }
