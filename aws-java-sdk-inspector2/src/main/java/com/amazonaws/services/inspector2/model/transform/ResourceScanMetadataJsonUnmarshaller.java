...
/**
 * ResourceScanMetadata JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResourceScanMetadataJsonUnmarshaller implements Unmarshaller<ResourceScanMetadata, JsonUnmarshallerContext> {

    public ResourceScanMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResourceScanMetadata resourceScanMetadata = new ResourceScanMetadata();
    ...
    private static ResourceScanMetadataJsonUnmarshaller instance;

    public static ResourceScanMetadataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceScanMetadataJsonUnmarshaller();
        return instance;
    }
}
