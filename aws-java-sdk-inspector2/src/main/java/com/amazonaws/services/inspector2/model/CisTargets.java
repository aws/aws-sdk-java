 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/inspector2-2020-06-08/CisTargets" target="_top">AWS API
 *      Documentation</a>
 */
...
public class CisTargets implements Serializable, Cloneable, StructuredPojo {
    ...
    public CisTargets withAccountIds(java.util.Collection<String> accountIds) {
    ...
    public CisTargets withTargetResourceTags(java.util.Map<String, java.util.List<String>> targetResourceTags) {
    ...
    public CisTargets addTargetResourceTagsEntry(String key, java.util.List<String> value) {
