 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/inspector2-2020-06-08/CisFindingStatusFilter" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CisFindingStatusFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * @param comparison
     *        The comparison value of the CIS finding status filter.
     * @see CisFindingStatusComparison
     */
     ...
     * </p>
     * 
     * @return The comparison value of the CIS finding status filter.
     * @see CisFindingStatusComparison
     */
     ...
     * </p>
     * 
     * @return The value of the CIS finding status filter.
     * @see CisFindingStatus
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CisFindingStatusFilter == false)
            return false;
        CisFindingStatusFilter other = (CisFindingStatusFilter) obj;
    ...
    public CisFindingStatusFilter clone() {
        try {
            return (CisFindingStatusFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.inspector2.model.transform.CisFindingStatusFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
