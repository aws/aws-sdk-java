...
public class CreateCisScanConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The scan configuration ARN for the CIS scan configuration.
     */
    ...
    public CreateCisScanConfigurationResult withScanConfigurationArn(String scanConfigurationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCisScanConfigurationResult == false)
            return false;
        CreateCisScanConfigurationResult other = (CreateCisScanConfigurationResult) obj;
    ...
    @Override
    public CreateCisScanConfigurationResult clone() {
        try {
            return (CreateCisScanConfigurationResult) super.clone();
