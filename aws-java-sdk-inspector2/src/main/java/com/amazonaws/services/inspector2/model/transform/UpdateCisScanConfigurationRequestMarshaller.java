...
/**
 * UpdateCisScanConfigurationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateCisScanConfigurationRequestMarshaller {
    ...
    private static final UpdateCisScanConfigurationRequestMarshaller instance = new UpdateCisScanConfigurationRequestMarshaller();

    public static UpdateCisScanConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateCisScanConfigurationRequest updateCisScanConfigurationRequest, ProtocolMarshaller protocolMarshaller) {

        if (updateCisScanConfigurationRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(updateCisScanConfigurationRequest.getScanConfigurationArn(), SCANCONFIGURATIONARN_BINDING);
            protocolMarshaller.marshall(updateCisScanConfigurationRequest.getScanName(), SCANNAME_BINDING);
            protocolMarshaller.marshall(updateCisScanConfigurationRequest.getSchedule(), SCHEDULE_BINDING);
            protocolMarshaller.marshall(updateCisScanConfigurationRequest.getSecurityLevel(), SECURITYLEVEL_BINDING);
            protocolMarshaller.marshall(updateCisScanConfigurationRequest.getTargets(), TARGETS_BINDING);
        } catch (Exception e) {
