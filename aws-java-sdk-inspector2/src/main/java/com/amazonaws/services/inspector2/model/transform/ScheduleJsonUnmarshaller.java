        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("daily", targetDepth)) {
                    context.nextToken();
                    schedule.setDaily(DailyScheduleJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("monthly", targetDepth)) {
                    context.nextToken();
                    schedule.setMonthly(MonthlyScheduleJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("oneTime", targetDepth)) {
                    context.nextToken();
                    schedule.setOneTime(OneTimeScheduleJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("weekly", targetDepth)) {
                    context.nextToken();
                    schedule.setWeekly(WeeklyScheduleJsonUnmarshaller.getInstance().unmarshall(context));
                }
