...
/**
 * LambdaLayerAggregationMarshaller
 */
...
public class LambdaLayerAggregationMarshaller {
    ...
    private static final MarshallingInfo<List> LAYERARNS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("layerArns").build();
