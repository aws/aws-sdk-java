...
public class ListCisScanResultsAggregatedByChecksRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CisScanResultsAggregatedByChecksFilterCriteria getFilterCriteria() {
    ...
    public ListCisScanResultsAggregatedByChecksRequest withSortBy(String sortBy) {
        setSortBy(sortBy);
        return this;
    }
    ...
    public ListCisScanResultsAggregatedByChecksRequest withSortBy(CisScanResultsAggregatedByChecksSortBy sortBy) {
    ...
    public ListCisScanResultsAggregatedByChecksRequest withSortOrder(String sortOrder) {
    ...
    public ListCisScanResultsAggregatedByChecksRequest withSortOrder(CisSortOrder sortOrder) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCisScanResultsAggregatedByChecksRequest == false)
            return false;
    ...
    @Override
    public ListCisScanResultsAggregatedByChecksRequest clone() {
        return (ListCisScanResultsAggregatedByChecksRequest) super.clone();
    }
