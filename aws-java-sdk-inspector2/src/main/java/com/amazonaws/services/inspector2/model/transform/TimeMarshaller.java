...
public class TimeMarshaller {
    ...
    private static final TimeMarshaller instance = new TimeMarshaller();
     ...
     */
    public void marshall(Time time, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(time.getTimeOfDay(), TIMEOFDAY_BINDING);
            protocolMarshaller.marshall(time.getTimezone(), TIMEZONE_BINDING);
        } catch (Exception e) {
