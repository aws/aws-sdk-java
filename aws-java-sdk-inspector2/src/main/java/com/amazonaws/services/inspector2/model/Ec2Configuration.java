 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/inspector2-2020-06-08/Ec2Configuration" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Ec2Configuration implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getScanMode() != null)
            sb.append("ScanMode: ").append(getScanMode());
        sb.append("}");
        return sb.toString();
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.inspector2.model.transform.Ec2ConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
