...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/inspector2-2020-06-08/SendCisSessionHealth" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SendCisSessionHealthRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public SendCisSessionHealthRequest withScanJobId(String scanJobId) {
    ...
    public SendCisSessionHealthRequest withSessionToken(String sessionToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SendCisSessionHealthRequest == false)
            return false;
    ...
    @Override
    public SendCisSessionHealthRequest clone() {
