...
public class CreateWebhookRequestMarshaller {
    ...
    public void marshall(CreateWebhookRequest createWebhookRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createWebhookRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(createWebhookRequest.getBranchName(), BRANCHNAME_BINDING);
            protocolMarshaller.marshall(createWebhookRequest.getDescription(), DESCRIPTION_BINDING);
        } catch (Exception e) {
