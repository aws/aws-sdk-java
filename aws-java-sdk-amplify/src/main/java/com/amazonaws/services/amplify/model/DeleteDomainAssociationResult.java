...
public class DeleteDomainAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDomainAssociationResult == false)
            return false;
        DeleteDomainAssociationResult other = (DeleteDomainAssociationResult) obj;
    ...
    @Override
    public DeleteDomainAssociationResult clone() {
        try {
            return (DeleteDomainAssociationResult) super.clone();
