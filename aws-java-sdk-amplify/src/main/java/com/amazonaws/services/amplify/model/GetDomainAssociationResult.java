...
public class GetDomainAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDomainAssociationResult == false)
            return false;
        GetDomainAssociationResult other = (GetDomainAssociationResult) obj;
    ...
    public GetDomainAssociationResult clone() {
        try {
            return (GetDomainAssociationResult) super.clone();
