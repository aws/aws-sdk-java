...
/**
 * ListWebhooksRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListWebhooksRequestMarshaller {
    ...
    private static final ListWebhooksRequestMarshaller instance = new ListWebhooksRequestMarshaller();

    public static ListWebhooksRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(ListWebhooksRequest listWebhooksRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listWebhooksRequest.getAppId(), APPID_BINDING);
