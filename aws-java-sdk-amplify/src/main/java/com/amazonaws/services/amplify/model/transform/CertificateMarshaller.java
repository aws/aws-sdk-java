...
public class CertificateMarshaller {
    ...
    public void marshall(Certificate certificate, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(certificate.getCustomCertificateArn(), CUSTOMCERTIFICATEARN_BINDING);
            protocolMarshaller.marshall(certificate.getCertificateVerificationDNSRecord(), CERTIFICATEVERIFICATIONDNSRECORD_BINDING);
        } catch (Exception e) {
