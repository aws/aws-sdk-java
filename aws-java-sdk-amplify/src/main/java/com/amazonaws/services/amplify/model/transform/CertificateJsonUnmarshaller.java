        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("customCertificateArn", targetDepth)) {
                    context.nextToken();
                    certificate.setCustomCertificateArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("certificateVerificationDNSRecord", targetDepth)) {
                    context.nextToken();
                    certificate.setCertificateVerificationDNSRecord(context.getUnmarshaller(String.class).unmarshall(context));
                }
