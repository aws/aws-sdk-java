        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("jobId", targetDepth)) {
                    context.nextToken();
                    createDeploymentResult.setJobId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("fileUploadUrls", targetDepth)) {
                    context.nextToken();
                    createDeploymentResult.setFileUploadUrls(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
                            .getUnmarshaller(String.class)).unmarshall(context));
                }
                if (context.testExpression("zipUploadUrl", targetDepth)) {
                    context.nextToken();
                    createDeploymentResult.setZipUploadUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
