...
/**
 * TranslateDocumentRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TranslateDocumentRequestMarshaller {
    ...
    private static final TranslateDocumentRequestMarshaller instance = new TranslateDocumentRequestMarshaller();

    public static TranslateDocumentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TranslateDocumentRequest translateDocumentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(translateDocumentRequest.getDocument(), DOCUMENT_BINDING);
            protocolMarshaller.marshall(translateDocumentRequest.getTerminologyNames(), TERMINOLOGYNAMES_BINDING);
            protocolMarshaller.marshall(translateDocumentRequest.getSourceLanguageCode(), SOURCELANGUAGECODE_BINDING);
            protocolMarshaller.marshall(translateDocumentRequest.getTargetLanguageCode(), TARGETLANGUAGECODE_BINDING);
            protocolMarshaller.marshall(translateDocumentRequest.getSettings(), SETTINGS_BINDING);
        } catch (Exception e) {
