...
public class UnsupportedLanguagePairExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SourceLanguageCode", targetDepth)) {
                    context.nextToken();
                    unsupportedLanguagePairException.setSourceLanguageCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("TargetLanguageCode", targetDepth)) {
                    context.nextToken();
                    unsupportedLanguagePairException.setTargetLanguageCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static UnsupportedLanguagePairExceptionUnmarshaller instance;

    public static UnsupportedLanguagePairExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedLanguagePairExceptionUnmarshaller();
        return instance;
    }
}
