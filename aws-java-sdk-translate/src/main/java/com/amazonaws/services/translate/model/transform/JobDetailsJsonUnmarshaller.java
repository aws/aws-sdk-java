        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TranslatedDocumentsCount", targetDepth)) {
                    context.nextToken();
                    jobDetails.setTranslatedDocumentsCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("DocumentsWithErrorsCount", targetDepth)) {
                    context.nextToken();
                    jobDetails.setDocumentsWithErrorsCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("InputDocumentsCount", targetDepth)) {
                    context.nextToken();
                    jobDetails.setInputDocumentsCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
