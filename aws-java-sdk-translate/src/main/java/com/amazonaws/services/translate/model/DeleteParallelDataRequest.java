...
public class DeleteParallelDataRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeleteParallelDataRequest clone() {
        return (DeleteParallelDataRequest) super.clone();
    }
