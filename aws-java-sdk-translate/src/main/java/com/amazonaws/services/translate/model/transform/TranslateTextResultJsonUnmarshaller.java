...
/**
 * TranslateTextResult JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TranslatedText", targetDepth)) {
                    context.nextToken();
                    translateTextResult.setTranslatedText(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("SourceLanguageCode", targetDepth)) {
                    context.nextToken();
                    translateTextResult.setSourceLanguageCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("TargetLanguageCode", targetDepth)) {
                    context.nextToken();
                    translateTextResult.setTargetLanguageCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
