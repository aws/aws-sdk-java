...
public class JsonErrorUnmarshallerV2Test {
    ...
    @Before
    public void setup() {
        unmarshaller = new JsonErrorUnmarshallerV2(CustomException.class, ERROR_TYPE);
    }
    ...
    public void match_DefaultUnmarshaller_MatchesEverything() {
        unmarshaller = JsonErrorUnmarshallerV2.DEFAULT_UNMARSHALLER;
