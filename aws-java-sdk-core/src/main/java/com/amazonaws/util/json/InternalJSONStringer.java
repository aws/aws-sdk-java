 ...
 * information.
 */
public class InternalJSONStringer {
    ...
    public InternalJSONStringer() {
        indent = null;
    }

    InternalJSONStringer(int indentSpaces) {
     ...
     */
    public InternalJSONStringer array() throws JSONException {
     ...
     * @return this stringer.
     */
    public InternalJSONStringer endArray() throws JSONException {
     ...
     * @return this stringer.
     */
    public InternalJSONStringer object() throws JSONException {
     ...
     * @return this stringer.
     */
    public InternalJSONStringer endObject() throws JSONException {
     ...
     * bracket.
     */
    InternalJSONStringer open(Scope empty, String openBracket) throws JSONException {
     ...
     * given bracket.
     */
    InternalJSONStringer close(Scope empty, Scope nonempty, String closeBracket) throws JSONException {
        Scope context = peek();
     ...
     * @return this stringer.
     */
    public InternalJSONStringer value(Object value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
     ...
     * @return this stringer.
     */
    public InternalJSONStringer value(boolean value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
        beforeValue();
     ...
     * @return this stringer.
     */
    public InternalJSONStringer value(double value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
        beforeValue();
     ...
     * @return this stringer.
     */
    public InternalJSONStringer value(long value) throws JSONException {
        if (stack.isEmpty()) {
            throw new JSONException("Nesting problem");
        }
        beforeValue();
     ...
     * @return this stringer.
     */
    public InternalJSONStringer key(String name) throws JSONException {
        if (name == null) {
