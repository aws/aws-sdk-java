...
public class JSONArray {
    ...
    public String join(String separator) throws JSONException {
        InternalJSONStringer stringer = new InternalJSONStringer();
        stringer.open(InternalJSONStringer.Scope.NULL, "");
        ...
        stringer.close(InternalJSONStringer.Scope.NULL, InternalJSONStringer.Scope.NULL, "");
    ...
    public String toString(int indentSpaces) throws JSONException {
        InternalJSONStringer stringer = new InternalJSONStringer(indentSpaces);
        writeTo(stringer);
        return stringer.toString();
    }

    void writeTo(InternalJSONStringer stringer) throws JSONException {
        stringer.array();
