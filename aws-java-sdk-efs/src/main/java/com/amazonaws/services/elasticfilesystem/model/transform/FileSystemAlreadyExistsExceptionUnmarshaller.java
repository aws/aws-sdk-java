...
public class FileSystemAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    fileSystemAlreadyExistsException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("FileSystemId", targetDepth)) {
                    context.nextToken();
                    fileSystemAlreadyExistsException.setFileSystemId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static FileSystemAlreadyExistsExceptionUnmarshaller instance;

    public static FileSystemAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileSystemAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
