...
public class IncorrectFileSystemLifeCycleStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.elasticfilesystem.model.IncorrectFileSystemLifeCycleStateException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    incorrectFileSystemLifeCycleStateException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return incorrectFileSystemLifeCycleStateException;
    }

    private static IncorrectFileSystemLifeCycleStateExceptionUnmarshaller instance;

    public static IncorrectFileSystemLifeCycleStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IncorrectFileSystemLifeCycleStateExceptionUnmarshaller();
        return instance;
    }
}
