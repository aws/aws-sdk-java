...
public class DescribeFileSystemPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies which EFS file system to retrieve the <code>FileSystemPolicy</code> for.
     */
    ...
    @Override
    public DescribeFileSystemPolicyRequest clone() {
        return (DescribeFileSystemPolicyRequest) super.clone();
    }
