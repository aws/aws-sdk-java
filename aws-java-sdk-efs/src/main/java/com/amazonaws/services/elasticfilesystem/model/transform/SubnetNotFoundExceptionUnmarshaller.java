...
public class SubnetNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    subnetNotFoundException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static SubnetNotFoundExceptionUnmarshaller instance;

    public static SubnetNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SubnetNotFoundExceptionUnmarshaller();
        return instance;
    }
}
