...
public class MountTargetConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.elasticfilesystem.model.MountTargetConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    mountTargetConflictException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return mountTargetConflictException;
    }

    private static MountTargetConflictExceptionUnmarshaller instance;

    public static MountTargetConflictExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MountTargetConflictExceptionUnmarshaller();
        return instance;
    }
}
