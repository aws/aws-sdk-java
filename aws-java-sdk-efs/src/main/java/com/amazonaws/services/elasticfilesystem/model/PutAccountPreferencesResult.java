...
public class PutAccountPreferencesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PutAccountPreferencesResult withResourceIdPreference(ResourceIdPreference resourceIdPreference) {
    ...
    public String toString() {
        ...
        if (getResourceIdPreference() != null)
            sb.append("ResourceIdPreference: ").append(getResourceIdPreference());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutAccountPreferencesResult == false)
            return false;
        PutAccountPreferencesResult other = (PutAccountPreferencesResult) obj;
    ...
    @Override
    public PutAccountPreferencesResult clone() {
        try {
            return (PutAccountPreferencesResult) super.clone();
