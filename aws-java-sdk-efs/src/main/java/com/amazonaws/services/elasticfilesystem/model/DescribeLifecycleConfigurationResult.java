...
public class DescribeLifecycleConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DescribeLifecycleConfigurationResult withLifecyclePolicies(LifecyclePolicy... lifecyclePolicies) {
    ...
    public DescribeLifecycleConfigurationResult withLifecyclePolicies(java.util.Collection<LifecyclePolicy> lifecyclePolicies) {
    ...
    @Override
    public DescribeLifecycleConfigurationResult clone() {
        try {
