...
public class SecurityGroupLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    securityGroupLimitExceededException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static SecurityGroupLimitExceededExceptionUnmarshaller instance;

    public static SecurityGroupLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SecurityGroupLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
