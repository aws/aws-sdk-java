...
public class IpAddressInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.elasticfilesystem.model.IpAddressInUseException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    ipAddressInUseException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return ipAddressInUseException;
    }

    private static IpAddressInUseExceptionUnmarshaller instance;

    public static IpAddressInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IpAddressInUseExceptionUnmarshaller();
        return instance;
    }
}
