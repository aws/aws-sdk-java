...
/**
 * DescribeLifecycleConfigurationResult JSON Unmarshaller
 */
...
public class DescribeLifecycleConfigurationResultJsonUnmarshaller implements Unmarshaller<DescribeLifecycleConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DescribeLifecycleConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
