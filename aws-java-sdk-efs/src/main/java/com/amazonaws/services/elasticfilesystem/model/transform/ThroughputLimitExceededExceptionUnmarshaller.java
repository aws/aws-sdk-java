...
public class ThroughputLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.elasticfilesystem.model.ThroughputLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    throughputLimitExceededException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return throughputLimitExceededException;
    }

    private static ThroughputLimitExceededExceptionUnmarshaller instance;

    public static ThroughputLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ThroughputLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
