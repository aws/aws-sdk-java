...
/**
 * UpdateConnectClientAddInResult JSON Unmarshaller
 */
...
public class UpdateConnectClientAddInResultJsonUnmarshaller implements Unmarshaller<UpdateConnectClientAddInResult, JsonUnmarshallerContext> {
    ...
    public UpdateConnectClientAddInResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateConnectClientAddInResult updateConnectClientAddInResult = new UpdateConnectClientAddInResult();
