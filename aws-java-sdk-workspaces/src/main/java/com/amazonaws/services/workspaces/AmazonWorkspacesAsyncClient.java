...
public class AmazonWorkspacesAsyncClient extends AmazonWorkspacesClient
     ...
     * WorkSpaces. A credentials provider chain will be used that searches for
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * WorkSpaces using the specified AWS account credentials provider. Default
    ...
    @Override
    public java.util.concurrent.Future<DescribeWorkspaceBundlesResult> describeWorkspaceBundlesAsync(
            final DescribeWorkspaceBundlesRequest request,
            final com.amazonaws.handlers.AsyncHandler<DescribeWorkspaceBundlesRequest, DescribeWorkspaceBundlesResult> asyncHandler) {

        return executorService
                .submit(new java.util.concurrent.Callable<DescribeWorkspaceBundlesResult>() {
                    @Override
                    public DescribeWorkspaceBundlesResult call()
                            throws Exception {
    ...
    @Override
    public java.util.concurrent.Future<DescribeWorkspaceDirectoriesResult> describeWorkspaceDirectoriesAsync(
            final DescribeWorkspaceDirectoriesRequest request,
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DescribeWorkspaceDirectoriesResult>() {
                    @Override
                    public DescribeWorkspaceDirectoriesResult call()
                            throws Exception {
