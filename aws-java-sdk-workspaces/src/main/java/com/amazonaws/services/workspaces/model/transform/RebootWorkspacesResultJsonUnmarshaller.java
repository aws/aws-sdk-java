 ...
 */
public class RebootWorkspacesResultJsonUnmarshaller implements
        Unmarshaller<RebootWorkspacesResult, JsonUnmarshallerContext> {

    public RebootWorkspacesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
