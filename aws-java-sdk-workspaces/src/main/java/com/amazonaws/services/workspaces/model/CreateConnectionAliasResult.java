...
public class CreateConnectionAliasResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateConnectionAliasResult == false)
            return false;
        CreateConnectionAliasResult other = (CreateConnectionAliasResult) obj;
    ...
    public CreateConnectionAliasResult clone() {
        try {
            return (CreateConnectionAliasResult) super.clone();
