...
public class WorkspacePropertiesJsonMarshaller {
     ...
     */
    public void marshall(WorkspaceProperties workspaceProperties,
        ...
        try {
            ...
            if (workspaceProperties.getRunningMode() != null) {
                jsonGenerator.writeFieldName("RunningMode").writeValue(
                        workspaceProperties.getRunningMode());
            }
            if (workspaceProperties.getRunningModeAutoStopTimeoutInMinutes() != null) {
                jsonGenerator.writeFieldName(
                        "RunningModeAutoStopTimeoutInMinutes").writeValue(
                        workspaceProperties
