...
/**
 * AuthorizeIpRulesResult JSON Unmarshaller
 */
...
public class AuthorizeIpRulesResultJsonUnmarshaller implements Unmarshaller<AuthorizeIpRulesResult, JsonUnmarshallerContext> {
    ...
    public AuthorizeIpRulesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AuthorizeIpRulesResult authorizeIpRulesResult = new AuthorizeIpRulesResult();
