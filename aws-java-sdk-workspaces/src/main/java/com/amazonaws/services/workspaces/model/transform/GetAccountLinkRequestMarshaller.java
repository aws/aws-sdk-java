...
public class GetAccountLinkRequestMarshaller {
    ...
    private static final GetAccountLinkRequestMarshaller instance = new GetAccountLinkRequestMarshaller();

    public static GetAccountLinkRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetAccountLinkRequest getAccountLinkRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getAccountLinkRequest.getLinkId(), LINKID_BINDING);
            protocolMarshaller.marshall(getAccountLinkRequest.getLinkedAccountId(), LINKEDACCOUNTID_BINDING);
        } catch (Exception e) {
