...
/**
 * ModifyWorkspaceStateResult JSON Unmarshaller
 */
...
public class ModifyWorkspaceStateResultJsonUnmarshaller implements Unmarshaller<ModifyWorkspaceStateResult, JsonUnmarshallerContext> {
    ...
    public ModifyWorkspaceStateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ModifyWorkspaceStateResult modifyWorkspaceStateResult = new ModifyWorkspaceStateResult();
