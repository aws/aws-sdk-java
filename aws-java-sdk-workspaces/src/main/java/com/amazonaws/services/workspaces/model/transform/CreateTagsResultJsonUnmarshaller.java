 ...
 */
public class CreateTagsResultJsonUnmarshaller implements
        Unmarshaller<CreateTagsResult, JsonUnmarshallerContext> {

    public CreateTagsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
