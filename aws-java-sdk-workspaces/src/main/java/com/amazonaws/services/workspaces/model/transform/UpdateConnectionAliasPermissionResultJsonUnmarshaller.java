...
/**
 * UpdateConnectionAliasPermissionResult JSON Unmarshaller
 */
...
public class UpdateConnectionAliasPermissionResultJsonUnmarshaller implements Unmarshaller<UpdateConnectionAliasPermissionResult, JsonUnmarshallerContext> {
    ...
    public UpdateConnectionAliasPermissionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateConnectionAliasPermissionResult updateConnectionAliasPermissionResult = new UpdateConnectionAliasPermissionResult();
