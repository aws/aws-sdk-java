 ...
 */
public class WorkspaceDirectoryJsonUnmarshaller implements
        Unmarshaller<WorkspaceDirectory, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("WorkspaceCreationProperties",
                    ...
                    context.nextToken();
                    workspaceDirectory
                            .setWorkspaceCreationProperties(DefaultWorkspaceCreationPropertiesJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
