...
public class WorkspaceConnectionStatusJsonMarshaller {
     ...
     */
    public void marshall(WorkspaceConnectionStatus workspaceConnectionStatus,
        ...
        try {
            ...
            if (workspaceConnectionStatus.getLastKnownUserConnectionTimestamp() != null) {
                jsonGenerator
                        .writeFieldName("LastKnownUserConnectionTimestamp")
                        .writeValue(
                                workspaceConnectionStatus
