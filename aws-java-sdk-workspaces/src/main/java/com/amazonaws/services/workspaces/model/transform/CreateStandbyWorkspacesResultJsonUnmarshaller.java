...
/**
 * CreateStandbyWorkspacesResult JSON Unmarshaller
 */
...
public class CreateStandbyWorkspacesResultJsonUnmarshaller implements Unmarshaller<CreateStandbyWorkspacesResult, JsonUnmarshallerContext> {
    ...
    public CreateStandbyWorkspacesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FailedStandbyRequests", targetDepth)) {
                    context.nextToken();
                    createStandbyWorkspacesResult.setFailedStandbyRequests(new ListUnmarshaller<FailedCreateStandbyWorkspacesRequest>(
                            FailedCreateStandbyWorkspacesRequestJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("PendingStandbyRequests", targetDepth)) {
                    context.nextToken();
                    createStandbyWorkspacesResult.setPendingStandbyRequests(new ListUnmarshaller<PendingCreateStandbyWorkspacesRequest>(
                            PendingCreateStandbyWorkspacesRequestJsonUnmarshaller.getInstance())
