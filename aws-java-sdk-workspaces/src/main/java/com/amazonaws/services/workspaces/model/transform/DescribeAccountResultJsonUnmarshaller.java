...
/**
 * DescribeAccountResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeAccountResultJsonUnmarshaller implements Unmarshaller<DescribeAccountResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("DedicatedTenancyAccountType", targetDepth)) {
                    context.nextToken();
                    describeAccountResult.setDedicatedTenancyAccountType(context.getUnmarshaller(String.class).unmarshall(context));
                }
