...
/**
 * ModifyWorkspaceCreationPropertiesResult JSON Unmarshaller
 */
...
public class ModifyWorkspaceCreationPropertiesResultJsonUnmarshaller implements Unmarshaller<ModifyWorkspaceCreationPropertiesResult, JsonUnmarshallerContext> {
    ...
    public ModifyWorkspaceCreationPropertiesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ModifyWorkspaceCreationPropertiesResult modifyWorkspaceCreationPropertiesResult = new ModifyWorkspaceCreationPropertiesResult();
