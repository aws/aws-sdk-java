 ...
 */
public class DescribeWorkspacesResultJsonUnmarshaller implements
        Unmarshaller<DescribeWorkspacesResult, JsonUnmarshallerContext> {

    public DescribeWorkspacesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Workspaces", targetDepth)) {
                    ...
                    describeWorkspacesResult
                            .setWorkspaces(new ListUnmarshaller<Workspace>(
                                    WorkspaceJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeWorkspacesResult.setNextToken(context
