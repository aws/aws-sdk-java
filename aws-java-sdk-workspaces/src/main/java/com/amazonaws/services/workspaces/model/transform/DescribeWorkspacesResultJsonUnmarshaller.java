...
/**
 * Describe Workspaces Result JSON Unmarshaller
 */
public class DescribeWorkspacesResultJsonUnmarshaller implements Unmarshaller<DescribeWorkspacesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeWorkspacesResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DescribeWorkspacesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeWorkspacesResultJsonUnmarshaller();
        return instance;
    }
}
