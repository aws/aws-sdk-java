...
/**
 * ModifyAccountResult JSON Unmarshaller
 */
...
public class ModifyAccountResultJsonUnmarshaller implements Unmarshaller<ModifyAccountResult, JsonUnmarshallerContext> {
    ...
    public ModifyAccountResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ModifyAccountResult modifyAccountResult = new ModifyAccountResult();
