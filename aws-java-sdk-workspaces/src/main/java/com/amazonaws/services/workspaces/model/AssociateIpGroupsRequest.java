...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-2015-04-08/AssociateIpGroups" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssociateIpGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public AssociateIpGroupsRequest withGroupIds(java.util.Collection<String> groupIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateIpGroupsRequest == false)
            return false;
        AssociateIpGroupsRequest other = (AssociateIpGroupsRequest) obj;
    ...
    @Override
    public AssociateIpGroupsRequest clone() {
        return (AssociateIpGroupsRequest) super.clone();
    }
