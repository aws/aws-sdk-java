...
/**
 * IosClientBrandingAttributes JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IosClientBrandingAttributesJsonUnmarshaller implements Unmarshaller<IosClientBrandingAttributes, JsonUnmarshallerContext> {

    public IosClientBrandingAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        IosClientBrandingAttributes iosClientBrandingAttributes = new IosClientBrandingAttributes();
    ...
    private static IosClientBrandingAttributesJsonUnmarshaller instance;

    public static IosClientBrandingAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new IosClientBrandingAttributesJsonUnmarshaller();
        return instance;
    }
}
