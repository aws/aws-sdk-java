...
@SdkInternalApi
public class UserStorageMarshaller {
    ...
    private static final UserStorageMarshaller instance = new UserStorageMarshaller();

    public static UserStorageMarshaller getInstance() {
        return instance;
    }
