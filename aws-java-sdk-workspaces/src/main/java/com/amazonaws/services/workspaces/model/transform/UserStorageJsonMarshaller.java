...
public class UserStorageJsonMarshaller {
     ...
     */
    public void marshall(UserStorage userStorage, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (userStorage.getCapacity() != null) {
                jsonGenerator.writeFieldName("Capacity").writeValue(userStorage.getCapacity());
            }
