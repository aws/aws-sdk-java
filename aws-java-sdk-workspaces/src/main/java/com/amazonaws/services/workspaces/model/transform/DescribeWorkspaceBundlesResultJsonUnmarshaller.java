...
/**
 * Describe Workspace Bundles Result JSON Unmarshaller
 */
public class DescribeWorkspaceBundlesResultJsonUnmarshaller implements Unmarshaller<DescribeWorkspaceBundlesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Bundles", targetDepth)) {
                    context.nextToken();
                    describeWorkspaceBundlesResult.setBundles(new ListUnmarshaller<WorkspaceBundle>(WorkspaceBundleJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeWorkspaceBundlesResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DescribeWorkspaceBundlesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeWorkspaceBundlesResultJsonUnmarshaller();
        return instance;
    }
}
