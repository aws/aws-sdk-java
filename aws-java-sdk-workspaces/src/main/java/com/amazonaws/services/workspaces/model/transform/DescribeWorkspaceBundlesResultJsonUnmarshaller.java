 ...
 */
public class DescribeWorkspaceBundlesResultJsonUnmarshaller implements
        Unmarshaller<DescribeWorkspaceBundlesResult, JsonUnmarshallerContext> {

    public DescribeWorkspaceBundlesResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Bundles", targetDepth)) {
                    ...
                    describeWorkspaceBundlesResult
                            .setBundles(new ListUnmarshaller<WorkspaceBundle>(
