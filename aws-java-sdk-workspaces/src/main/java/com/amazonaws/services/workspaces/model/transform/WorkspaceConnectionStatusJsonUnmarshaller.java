...
public class WorkspaceConnectionStatusJsonUnmarshaller implements Unmarshaller<WorkspaceConnectionStatus, JsonUnmarshallerContext> {
    ...
    private static WorkspaceConnectionStatusJsonUnmarshaller instance;

    public static WorkspaceConnectionStatusJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new WorkspaceConnectionStatusJsonUnmarshaller();
        return instance;
    }
}
