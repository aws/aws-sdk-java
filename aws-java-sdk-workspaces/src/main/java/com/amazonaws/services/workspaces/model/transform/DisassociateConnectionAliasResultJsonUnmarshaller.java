...
/**
 * DisassociateConnectionAliasResult JSON Unmarshaller
 */
...
public class DisassociateConnectionAliasResultJsonUnmarshaller implements Unmarshaller<DisassociateConnectionAliasResult, JsonUnmarshallerContext> {
    ...
    public DisassociateConnectionAliasResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateConnectionAliasResult disassociateConnectionAliasResult = new DisassociateConnectionAliasResult();
