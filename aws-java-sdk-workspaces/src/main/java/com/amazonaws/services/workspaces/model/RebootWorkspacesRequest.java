 ...
 * </p>
 */
public class RebootWorkspacesRequest extends AmazonWebServiceRequest implements
    ...
    public void setRebootWorkspaceRequests(
        ...
        this.rebootWorkspaceRequests = new com.amazonaws.internal.SdkInternalList<RebootRequest>(
     ...
     * {@link #withRebootWorkspaceRequests(java.util.Collection)} if you want to
    ...
    public RebootWorkspacesRequest withRebootWorkspaceRequests(
        ...
        if (this.rebootWorkspaceRequests == null) {
            setRebootWorkspaceRequests(new com.amazonaws.internal.SdkInternalList<RebootRequest>(
                    rebootWorkspaceRequests.length));
        }
    ...
    public String toString() {
        ...
        if (getRebootWorkspaceRequests() != null)
            sb.append("RebootWorkspaceRequests: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRebootWorkspaceRequests() == null
                ^ this.getRebootWorkspaceRequests() == null)
            return false;
        if (other.getRebootWorkspaceRequests() != null
                && other.getRebootWorkspaceRequests().equals(
                        this.getRebootWorkspaceRequests()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getRebootWorkspaceRequests() == null) ? 0
                        : getRebootWorkspaceRequests().hashCode());
        return hashCode;
    }
