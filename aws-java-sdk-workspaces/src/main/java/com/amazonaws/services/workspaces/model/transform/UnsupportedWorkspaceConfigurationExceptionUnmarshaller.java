...
public class UnsupportedWorkspaceConfigurationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedWorkspaceConfigurationExceptionUnmarshaller instance;

    public static UnsupportedWorkspaceConfigurationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedWorkspaceConfigurationExceptionUnmarshaller();
        return instance;
    }
}
