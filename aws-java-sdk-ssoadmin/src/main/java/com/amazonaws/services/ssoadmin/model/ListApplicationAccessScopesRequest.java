...
public class ListApplicationAccessScopesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListApplicationAccessScopesRequest withApplicationArn(String applicationArn) {
    ...
    public ListApplicationAccessScopesRequest withMaxResults(Integer maxResults) {
    ...
    public ListApplicationAccessScopesRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListApplicationAccessScopesRequest == false)
            return false;
        ListApplicationAccessScopesRequest other = (ListApplicationAccessScopesRequest) obj;
    ...
    @Override
    public ListApplicationAccessScopesRequest clone() {
        return (ListApplicationAccessScopesRequest) super.clone();
    }
