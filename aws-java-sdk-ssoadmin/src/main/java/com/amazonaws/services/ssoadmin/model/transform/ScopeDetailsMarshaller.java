...
public class ScopeDetailsMarshaller {
    ...
    public void marshall(ScopeDetails scopeDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(scopeDetails.getAuthorizedTargets(), AUTHORIZEDTARGETS_BINDING);
            protocolMarshaller.marshall(scopeDetails.getScope(), SCOPE_BINDING);
        } catch (Exception e) {
