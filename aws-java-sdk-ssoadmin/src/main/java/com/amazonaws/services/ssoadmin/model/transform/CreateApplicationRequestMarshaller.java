...
public class CreateApplicationRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> PORTALOPTIONS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("PortalOptions").build();
    ...
    public void marshall(CreateApplicationRequest createApplicationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createApplicationRequest.getApplicationProviderArn(), APPLICATIONPROVIDERARN_BINDING);
            ...
            protocolMarshaller.marshall(createApplicationRequest.getInstanceArn(), INSTANCEARN_BINDING);
            protocolMarshaller.marshall(createApplicationRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createApplicationRequest.getPortalOptions(), PORTALOPTIONS_BINDING);
            protocolMarshaller.marshall(createApplicationRequest.getStatus(), STATUS_BINDING);
