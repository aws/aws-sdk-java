...
/**
 * DeleteApplicationAccessScopeResult JSON Unmarshaller
 */
...
public class DeleteApplicationAccessScopeResultJsonUnmarshaller implements Unmarshaller<DeleteApplicationAccessScopeResult, JsonUnmarshallerContext> {
    ...
    public DeleteApplicationAccessScopeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteApplicationAccessScopeResult deleteApplicationAccessScopeResult = new DeleteApplicationAccessScopeResult();
