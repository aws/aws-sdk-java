...
public class CreateInstanceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the instance of IAM Identity Center.
     */
     ...
     * </p>
     * 
     * @return Specifies tags to be attached to the instance of IAM Identity Center.
     */
    ...
    public CreateInstanceRequest withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public CreateInstanceRequest withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
