        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ApplicationAccount", targetDepth)) {
                    context.nextToken();
                    application.setApplicationAccount(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ApplicationArn", targetDepth)) {
                    context.nextToken();
                    application.setApplicationArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ApplicationProviderArn", targetDepth)) {
                    context.nextToken();
                    application.setApplicationProviderArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("CreatedDate", targetDepth)) {
                    context.nextToken();
                    application.setCreatedDate(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
                ...
                if (context.testExpression("InstanceArn", targetDepth)) {
                    context.nextToken();
                    application.setInstanceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("PortalOptions", targetDepth)) {
                    context.nextToken();
                    application.setPortalOptions(PortalOptionsJsonUnmarshaller.getInstance().unmarshall(context));
                }
