...
public class UpdateApplicationRequestMarshaller {
    ...
    public void marshall(UpdateApplicationRequest updateApplicationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateApplicationRequest.getApplicationArn(), APPLICATIONARN_BINDING);
            ...
            protocolMarshaller.marshall(updateApplicationRequest.getPortalOptions(), PORTALOPTIONS_BINDING);
            protocolMarshaller.marshall(updateApplicationRequest.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
