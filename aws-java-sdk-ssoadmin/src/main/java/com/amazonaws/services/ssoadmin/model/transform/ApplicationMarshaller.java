...
public class ApplicationMarshaller {
    ...
    private static final MarshallingInfo<String> APPLICATIONACCOUNT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ApplicationAccount").build();
    ...
    public void marshall(Application application, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(application.getApplicationAccount(), APPLICATIONACCOUNT_BINDING);
            protocolMarshaller.marshall(application.getApplicationArn(), APPLICATIONARN_BINDING);
            protocolMarshaller.marshall(application.getApplicationProviderArn(), APPLICATIONPROVIDERARN_BINDING);
            protocolMarshaller.marshall(application.getCreatedDate(), CREATEDDATE_BINDING);
            protocolMarshaller.marshall(application.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(application.getInstanceArn(), INSTANCEARN_BINDING);
            protocolMarshaller.marshall(application.getName(), NAME_BINDING);
            protocolMarshaller.marshall(application.getPortalOptions(), PORTALOPTIONS_BINDING);
