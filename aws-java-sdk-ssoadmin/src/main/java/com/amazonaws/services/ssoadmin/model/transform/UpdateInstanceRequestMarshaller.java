...
public class UpdateInstanceRequestMarshaller {
    ...
    public void marshall(UpdateInstanceRequest updateInstanceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateInstanceRequest.getInstanceArn(), INSTANCEARN_BINDING);
            protocolMarshaller.marshall(updateInstanceRequest.getName(), NAME_BINDING);
        } catch (Exception e) {
