...
/**
 * PutApplicationAccessScopeResult JSON Unmarshaller
 */
...
public class PutApplicationAccessScopeResultJsonUnmarshaller implements Unmarshaller<PutApplicationAccessScopeResult, JsonUnmarshallerContext> {
    ...
    public PutApplicationAccessScopeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutApplicationAccessScopeResult putApplicationAccessScopeResult = new PutApplicationAccessScopeResult();
