...
/**
 * PutApplicationGrantResult JSON Unmarshaller
 */
...
public class PutApplicationGrantResultJsonUnmarshaller implements Unmarshaller<PutApplicationGrantResult, JsonUnmarshallerContext> {
    ...
    public PutApplicationGrantResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutApplicationGrantResult putApplicationGrantResult = new PutApplicationGrantResult();
