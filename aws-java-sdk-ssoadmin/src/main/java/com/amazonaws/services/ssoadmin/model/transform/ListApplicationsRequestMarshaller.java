...
public class ListApplicationsRequestMarshaller {
    ...
    public void marshall(ListApplicationsRequest listApplicationsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listApplicationsRequest.getFilter(), FILTER_BINDING);
            protocolMarshaller.marshall(listApplicationsRequest.getInstanceArn(), INSTANCEARN_BINDING);
