        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ApplicationAccount", targetDepth)) {
                    context.nextToken();
                    describeApplicationResult.setApplicationAccount(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("ApplicationProviderArn", targetDepth)) {
                    context.nextToken();
                    describeApplicationResult.setApplicationProviderArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("CreatedDate", targetDepth)) {
                    context.nextToken();
                    describeApplicationResult.setCreatedDate(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
                if (context.testExpression("Description", targetDepth)) {
                    context.nextToken();
                    describeApplicationResult.setDescription(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("InstanceArn", targetDepth)) {
                    context.nextToken();
                    describeApplicationResult.setInstanceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    describeApplicationResult.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("PortalOptions", targetDepth)) {
                    context.nextToken();
                    describeApplicationResult.setPortalOptions(PortalOptionsJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    describeApplicationResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
