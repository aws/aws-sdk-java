...
/**
 * CreateApplicationAssignmentResult JSON Unmarshaller
 */
...
public class CreateApplicationAssignmentResultJsonUnmarshaller implements Unmarshaller<CreateApplicationAssignmentResult, JsonUnmarshallerContext> {
    ...
    public CreateApplicationAssignmentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateApplicationAssignmentResult createApplicationAssignmentResult = new CreateApplicationAssignmentResult();
