...
public class DeleteTrustedTokenIssuerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the ARN of the trusted token issuer configuration to delete.
     */
    ...
    public DeleteTrustedTokenIssuerRequest withTrustedTokenIssuerArn(String trustedTokenIssuerArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTrustedTokenIssuerRequest == false)
            return false;
        DeleteTrustedTokenIssuerRequest other = (DeleteTrustedTokenIssuerRequest) obj;
    ...
    @Override
    public DeleteTrustedTokenIssuerRequest clone() {
        return (DeleteTrustedTokenIssuerRequest) super.clone();
    }
