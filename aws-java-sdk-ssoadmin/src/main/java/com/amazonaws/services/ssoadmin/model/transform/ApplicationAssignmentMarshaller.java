...
/**
 * ApplicationAssignmentMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ApplicationAssignmentMarshaller {
    ...
    private static final ApplicationAssignmentMarshaller instance = new ApplicationAssignmentMarshaller();

    public static ApplicationAssignmentMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ApplicationAssignment applicationAssignment, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(applicationAssignment.getApplicationArn(), APPLICATIONARN_BINDING);
            protocolMarshaller.marshall(applicationAssignment.getPrincipalId(), PRINCIPALID_BINDING);
            protocolMarshaller.marshall(applicationAssignment.getPrincipalType(), PRINCIPALTYPE_BINDING);
        } catch (Exception e) {
