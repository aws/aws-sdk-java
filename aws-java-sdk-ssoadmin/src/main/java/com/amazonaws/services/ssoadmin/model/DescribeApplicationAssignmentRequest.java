...
public class DescribeApplicationAssignmentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeApplicationAssignmentRequest withApplicationArn(String applicationArn) {
    ...
    public DescribeApplicationAssignmentRequest withPrincipalId(String principalId) {
    ...
    public DescribeApplicationAssignmentRequest withPrincipalType(String principalType) {
    ...
    public DescribeApplicationAssignmentRequest withPrincipalType(PrincipalType principalType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeApplicationAssignmentRequest == false)
            return false;
        DescribeApplicationAssignmentRequest other = (DescribeApplicationAssignmentRequest) obj;
    ...
    @Override
    public DescribeApplicationAssignmentRequest clone() {
        return (DescribeApplicationAssignmentRequest) super.clone();
    }
