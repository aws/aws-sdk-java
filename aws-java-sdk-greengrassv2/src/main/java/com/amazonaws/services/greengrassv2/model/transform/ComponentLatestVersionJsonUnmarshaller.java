...
/**
 * ComponentLatestVersion JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ComponentLatestVersionJsonUnmarshaller implements Unmarshaller<ComponentLatestVersion, JsonUnmarshallerContext> {

    public ComponentLatestVersion unmarshall(JsonUnmarshallerContext context) throws Exception {
        ComponentLatestVersion componentLatestVersion = new ComponentLatestVersion();
    ...
    private static ComponentLatestVersionJsonUnmarshaller instance;

    public static ComponentLatestVersionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ComponentLatestVersionJsonUnmarshaller();
        return instance;
    }
}
