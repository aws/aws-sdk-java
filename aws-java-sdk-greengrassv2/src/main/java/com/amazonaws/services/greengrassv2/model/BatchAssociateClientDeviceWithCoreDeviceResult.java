...
public class BatchAssociateClientDeviceWithCoreDeviceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public java.util.List<AssociateClientDeviceWithCoreDeviceErrorEntry> getErrorEntries() {
        return errorEntries;
    }
    ...
    public void setErrorEntries(java.util.Collection<AssociateClientDeviceWithCoreDeviceErrorEntry> errorEntries) {
        ...
        this.errorEntries = new java.util.ArrayList<AssociateClientDeviceWithCoreDeviceErrorEntry>(errorEntries);
    }
    ...
    public BatchAssociateClientDeviceWithCoreDeviceResult withErrorEntries(AssociateClientDeviceWithCoreDeviceErrorEntry... errorEntries) {
        if (this.errorEntries == null) {
            setErrorEntries(new java.util.ArrayList<AssociateClientDeviceWithCoreDeviceErrorEntry>(errorEntries.length));
        }
    ...
    public BatchAssociateClientDeviceWithCoreDeviceResult withErrorEntries(java.util.Collection<AssociateClientDeviceWithCoreDeviceErrorEntry> errorEntries) {
