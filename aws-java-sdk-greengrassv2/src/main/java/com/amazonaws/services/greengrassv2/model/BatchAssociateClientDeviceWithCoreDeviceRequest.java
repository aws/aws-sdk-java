...
public class BatchAssociateClientDeviceWithCoreDeviceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<AssociateClientDeviceWithCoreDeviceEntry> entries;
    /**
     * <p>
    ...
    public java.util.List<AssociateClientDeviceWithCoreDeviceEntry> getEntries() {
        return entries;
    }
    ...
    public void setEntries(java.util.Collection<AssociateClientDeviceWithCoreDeviceEntry> entries) {
        if (entries == null) {
            this.entries = null;
            return;
        }

        this.entries = new java.util.ArrayList<AssociateClientDeviceWithCoreDeviceEntry>(entries);
    }
    ...
    public BatchAssociateClientDeviceWithCoreDeviceRequest withEntries(AssociateClientDeviceWithCoreDeviceEntry... entries) {
        if (this.entries == null) {
            setEntries(new java.util.ArrayList<AssociateClientDeviceWithCoreDeviceEntry>(entries.length));
        }
        for (AssociateClientDeviceWithCoreDeviceEntry ele : entries) {
    ...
    public BatchAssociateClientDeviceWithCoreDeviceRequest withEntries(java.util.Collection<AssociateClientDeviceWithCoreDeviceEntry> entries) {
        setEntries(entries);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchAssociateClientDeviceWithCoreDeviceRequest == false)
            return false;
    ...
    public BatchAssociateClientDeviceWithCoreDeviceRequest clone() {
        return (BatchAssociateClientDeviceWithCoreDeviceRequest) super.clone();
    }
