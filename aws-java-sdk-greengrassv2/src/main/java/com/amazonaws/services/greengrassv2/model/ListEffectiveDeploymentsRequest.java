...
public class ListEffectiveDeploymentsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListEffectiveDeploymentsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEffectiveDeploymentsRequest == false)
            return false;
        ListEffectiveDeploymentsRequest other = (ListEffectiveDeploymentsRequest) obj;
    ...
    @Override
    public ListEffectiveDeploymentsRequest clone() {
        return (ListEffectiveDeploymentsRequest) super.clone();
    }
