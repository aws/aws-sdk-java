...
/**
 * DeleteCoreDeviceResult JSON Unmarshaller
 */
...
public class DeleteCoreDeviceResultJsonUnmarshaller implements Unmarshaller<DeleteCoreDeviceResult, JsonUnmarshallerContext> {
    ...
    public DeleteCoreDeviceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCoreDeviceResult deleteCoreDeviceResult = new DeleteCoreDeviceResult();
