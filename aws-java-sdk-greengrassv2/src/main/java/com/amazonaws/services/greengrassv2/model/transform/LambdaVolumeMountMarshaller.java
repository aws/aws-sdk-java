...
/**
 * LambdaVolumeMountMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LambdaVolumeMountMarshaller {
    ...
    private static final LambdaVolumeMountMarshaller instance = new LambdaVolumeMountMarshaller();

    public static LambdaVolumeMountMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LambdaVolumeMount lambdaVolumeMount, ProtocolMarshaller protocolMarshaller) {

        if (lambdaVolumeMount == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(lambdaVolumeMount.getSourcePath(), SOURCEPATH_BINDING);
            protocolMarshaller.marshall(lambdaVolumeMount.getDestinationPath(), DESTINATIONPATH_BINDING);
            protocolMarshaller.marshall(lambdaVolumeMount.getPermission(), PERMISSION_BINDING);
            protocolMarshaller.marshall(lambdaVolumeMount.getAddGroupOwner(), ADDGROUPOWNER_BINDING);
        } catch (Exception e) {
