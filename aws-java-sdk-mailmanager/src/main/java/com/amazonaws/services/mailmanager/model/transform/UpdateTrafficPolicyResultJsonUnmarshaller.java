...
/**
 * UpdateTrafficPolicyResult JSON Unmarshaller
 */
...
public class UpdateTrafficPolicyResultJsonUnmarshaller implements Unmarshaller<UpdateTrafficPolicyResult, JsonUnmarshallerContext> {
    ...
    public UpdateTrafficPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateTrafficPolicyResult updateTrafficPolicyResult = new UpdateTrafficPolicyResult();
