...
/**
 * StartArchiveSearchRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StartArchiveSearchRequestMarshaller {
    ...
    private static final StartArchiveSearchRequestMarshaller instance = new StartArchiveSearchRequestMarshaller();

    public static StartArchiveSearchRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartArchiveSearchRequest startArchiveSearchRequest, ProtocolMarshaller protocolMarshaller) {

        if (startArchiveSearchRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(startArchiveSearchRequest.getArchiveId(), ARCHIVEID_BINDING);
            protocolMarshaller.marshall(startArchiveSearchRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(startArchiveSearchRequest.getFromTimestamp(), FROMTIMESTAMP_BINDING);
            protocolMarshaller.marshall(startArchiveSearchRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(startArchiveSearchRequest.getToTimestamp(), TOTIMESTAMP_BINDING);
        } catch (Exception e) {
