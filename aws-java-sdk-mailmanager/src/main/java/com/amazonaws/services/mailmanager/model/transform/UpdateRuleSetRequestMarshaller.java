...
public class UpdateRuleSetRequestMarshaller {
    ...
    public void marshall(UpdateRuleSetRequest updateRuleSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateRuleSetRequest.getRuleSetId(), RULESETID_BINDING);
            protocolMarshaller.marshall(updateRuleSetRequest.getRuleSetName(), RULESETNAME_BINDING);
