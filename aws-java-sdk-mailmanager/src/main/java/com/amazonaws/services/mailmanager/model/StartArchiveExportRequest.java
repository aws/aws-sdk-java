...
public class StartArchiveExportRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The identifier of the archive to export emails from.
     */
     ...
     * </p>
     * 
     * @return Details on where to deliver the exported email data.
     */
     ...
     * </p>
     * 
     * @return Criteria to filter which emails are included in the export.
     */
     ...
     * </p>
     * 
     * @return The start of the timestamp range to include emails from.
     */
    ...
    public StartArchiveExportRequest withFromTimestamp(java.util.Date fromTimestamp) {
     ...
     * </p>
     * 
     * @return The maximum number of email items to include in the export.
     */
     ...
     * </p>
     * 
     * @return The end of the timestamp range to include emails from.
     */
    ...
    public StartArchiveExportRequest withToTimestamp(java.util.Date toTimestamp) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartArchiveExportRequest == false)
            return false;
        StartArchiveExportRequest other = (StartArchiveExportRequest) obj;
