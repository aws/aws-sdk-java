...
public class GetRelayRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A unique relay identifier.
     */
    ...
    public GetRelayRequest withRelayId(String relayId) {
        setRelayId(relayId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetRelayRequest == false)
            return false;
        GetRelayRequest other = (GetRelayRequest) obj;
    ...
    @Override
    public GetRelayRequest clone() {
        return (GetRelayRequest) super.clone();
    }
