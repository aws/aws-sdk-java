...
/**
 * DeleteRelayResult JSON Unmarshaller
 */
...
public class DeleteRelayResultJsonUnmarshaller implements Unmarshaller<DeleteRelayResult, JsonUnmarshallerContext> {
    ...
    public DeleteRelayResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRelayResult deleteRelayResult = new DeleteRelayResult();
