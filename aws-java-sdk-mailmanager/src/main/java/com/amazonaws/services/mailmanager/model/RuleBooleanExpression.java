 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mailmanager-2023-10-17/RuleBooleanExpression" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RuleBooleanExpression implements Serializable, Cloneable, StructuredPojo {
    ...
    public RuleBooleanToEvaluate getEvaluate() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RuleBooleanExpression == false)
            return false;
    ...
    public RuleBooleanExpression clone() {
        try {
            return (RuleBooleanExpression) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mailmanager.model.transform.RuleBooleanExpressionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
