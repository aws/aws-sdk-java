...
public class DeleteAddonSubscriptionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Add On subscription ID to delete.
     */
    ...
    public DeleteAddonSubscriptionRequest withAddonSubscriptionId(String addonSubscriptionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAddonSubscriptionRequest == false)
            return false;
        DeleteAddonSubscriptionRequest other = (DeleteAddonSubscriptionRequest) obj;
    ...
    @Override
    public DeleteAddonSubscriptionRequest clone() {
        return (DeleteAddonSubscriptionRequest) super.clone();
    }
