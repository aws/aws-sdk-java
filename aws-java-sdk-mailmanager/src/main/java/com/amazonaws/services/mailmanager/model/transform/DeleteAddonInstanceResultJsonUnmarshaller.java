...
/**
 * DeleteAddonInstanceResult JSON Unmarshaller
 */
...
public class DeleteAddonInstanceResultJsonUnmarshaller implements Unmarshaller<DeleteAddonInstanceResult, JsonUnmarshallerContext> {
    ...
    public DeleteAddonInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAddonInstanceResult deleteAddonInstanceResult = new DeleteAddonInstanceResult();
