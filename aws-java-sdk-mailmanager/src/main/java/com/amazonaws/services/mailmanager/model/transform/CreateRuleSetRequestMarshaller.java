...
public class CreateRuleSetRequestMarshaller {
    ...
    public void marshall(CreateRuleSetRequest createRuleSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createRuleSetRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createRuleSetRequest.getRuleSetName(), RULESETNAME_BINDING);
