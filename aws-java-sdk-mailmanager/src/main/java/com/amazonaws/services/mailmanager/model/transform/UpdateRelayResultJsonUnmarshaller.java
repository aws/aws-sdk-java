...
/**
 * UpdateRelayResult JSON Unmarshaller
 */
...
public class UpdateRelayResultJsonUnmarshaller implements Unmarshaller<UpdateRelayResult, JsonUnmarshallerContext> {
    ...
    public UpdateRelayResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateRelayResult updateRelayResult = new UpdateRelayResult();
