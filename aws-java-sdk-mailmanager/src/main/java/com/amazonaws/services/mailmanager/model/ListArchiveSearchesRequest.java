...
public class ListArchiveSearchesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The maximum number of archive search jobs that are returned per call. You can use NextToken to obtain further
     * pages of archives.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The maximum number of archive search jobs that are returned per call. You can use NextToken to obtain
     *         further pages of archives.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListArchiveSearchesRequest == false)
            return false;
        ListArchiveSearchesRequest other = (ListArchiveSearchesRequest) obj;
    ...
    public ListArchiveSearchesRequest clone() {
        return (ListArchiveSearchesRequest) super.clone();
    }
