...
public class CreateAddonInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique ID of the Add On instance created by this API.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAddonInstanceResult == false)
            return false;
        CreateAddonInstanceResult other = (CreateAddonInstanceResult) obj;
    ...
    public CreateAddonInstanceResult clone() {
        try {
            return (CreateAddonInstanceResult) super.clone();
