...
/**
 * DeleteAddonSubscriptionResult JSON Unmarshaller
 */
...
public class DeleteAddonSubscriptionResultJsonUnmarshaller implements Unmarshaller<DeleteAddonSubscriptionResult, JsonUnmarshallerContext> {
    ...
    public DeleteAddonSubscriptionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAddonSubscriptionResult deleteAddonSubscriptionResult = new DeleteAddonSubscriptionResult();
