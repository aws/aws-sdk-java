        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ActionFailurePolicy", targetDepth)) {
                    context.nextToken();
                    s3Action.setActionFailurePolicy(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("S3Bucket", targetDepth)) {
                    context.nextToken();
                    s3Action.setS3Bucket(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("S3Prefix", targetDepth)) {
                    context.nextToken();
                    s3Action.setS3Prefix(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("S3SseKmsKeyId", targetDepth)) {
                    context.nextToken();
                    s3Action.setS3SseKmsKeyId(context.getUnmarshaller(String.class).unmarshall(context));
                }
