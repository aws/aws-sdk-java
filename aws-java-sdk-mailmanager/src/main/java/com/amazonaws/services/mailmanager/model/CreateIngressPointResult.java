...
public class CreateIngressPointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique identifier for a previously created ingress endpoint.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateIngressPointResult == false)
            return false;
        CreateIngressPointResult other = (CreateIngressPointResult) obj;
    ...
    public CreateIngressPointResult clone() {
        try {
            return (CreateIngressPointResult) super.clone();
