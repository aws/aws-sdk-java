...
/**
 * DeleteIngressPointResult JSON Unmarshaller
 */
...
public class DeleteIngressPointResultJsonUnmarshaller implements Unmarshaller<DeleteIngressPointResult, JsonUnmarshallerContext> {
    ...
    public DeleteIngressPointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteIngressPointResult deleteIngressPointResult = new DeleteIngressPointResult();
