...
@SdkInternalApi
public class RuleVerdictExpressionMarshaller {
    ...
    private static final RuleVerdictExpressionMarshaller instance = new RuleVerdictExpressionMarshaller();

    public static RuleVerdictExpressionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RuleVerdictExpression ruleVerdictExpression, ProtocolMarshaller protocolMarshaller) {

        if (ruleVerdictExpression == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(ruleVerdictExpression.getEvaluate(), EVALUATE_BINDING);
            protocolMarshaller.marshall(ruleVerdictExpression.getOperator(), OPERATOR_BINDING);
            protocolMarshaller.marshall(ruleVerdictExpression.getValues(), VALUES_BINDING);
        } catch (Exception e) {
