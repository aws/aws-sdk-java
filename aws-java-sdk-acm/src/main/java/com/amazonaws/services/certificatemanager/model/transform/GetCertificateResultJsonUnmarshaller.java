 ...
 */
public class GetCertificateResultJsonUnmarshaller implements
        Unmarshaller<GetCertificateResult, JsonUnmarshallerContext> {

    public GetCertificateResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
