...
public class DescribeCertificateRequestMarshaller
    ...
    public Request<DescribeCertificateRequest> marshall(
        ...
        Request<DescribeCertificateRequest> request = new DefaultRequest<DescribeCertificateRequest>(
                describeCertificateRequest, "AWSCertificateManager");
        ...
        try {
            ...
            if (describeCertificateRequest.getCertificateArn() != null) {
                jsonGenerator.writeFieldName("CertificateArn").writeValue(
                        describeCertificateRequest.getCertificateArn());
            }
