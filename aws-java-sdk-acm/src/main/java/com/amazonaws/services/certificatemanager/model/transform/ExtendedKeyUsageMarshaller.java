...
public class ExtendedKeyUsageMarshaller {
    ...
    private static final MarshallingInfo<String> OID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("OID").build();
