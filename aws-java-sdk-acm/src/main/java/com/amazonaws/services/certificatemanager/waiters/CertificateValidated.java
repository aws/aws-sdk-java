...
class CertificateValidated {
    ...
    static class IsSUCCESSMatcher extends WaiterAcceptor<DescribeCertificateResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathSubExpression(new JmesPathField("Certificate"),
                new JmesPathField("DomainValidationOptions"))), new JmesPathField("ValidationStatus"));
    ...
    static class IsPENDING_VALIDATIONMatcher extends WaiterAcceptor<DescribeCertificateResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<DescribeCertificateResult> {
        private static final JsonNode expectedResult;
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("Certificate"), new JmesPathField("Status"));
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<DescribeCertificateResult> {
        /**
