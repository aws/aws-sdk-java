...
/**
 * <p>
 * This structure is used in the request object of the <a>RequestCertificate</a>
 * action.
 * </p>
 */
public class DomainValidationOption implements Serializable, Cloneable {
     ...
     * the same as the <code>DomainName</code> value or a superdomain of the
     * <code>DomainName</code> value. For example, if you requested a
     ...
     *        addresses. This must be the same as the <code>DomainName</code>
     *        value or a superdomain of the <code>DomainName</code> value. For
