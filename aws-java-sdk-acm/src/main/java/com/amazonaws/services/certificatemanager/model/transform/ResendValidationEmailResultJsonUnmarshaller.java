 ...
 */
public class ResendValidationEmailResultJsonUnmarshaller implements
        Unmarshaller<ResendValidationEmailResult, JsonUnmarshallerContext> {

    public ResendValidationEmailResult unmarshall(
