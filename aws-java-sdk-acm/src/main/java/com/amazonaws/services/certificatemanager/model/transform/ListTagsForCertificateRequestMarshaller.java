...
public class ListTagsForCertificateRequestMarshaller implements Marshaller<Request<ListTagsForCertificateRequest>, ListTagsForCertificateRequest> {
    ...
    public Request<ListTagsForCertificateRequest> marshall(ListTagsForCertificateRequest listTagsForCertificateRequest) {
        ...
        Request<ListTagsForCertificateRequest> request = new DefaultRequest<ListTagsForCertificateRequest>(listTagsForCertificateRequest,
                "AWSCertificateManager");
        request.addHeader("X-Amz-Target", "CertificateManager.ListTagsForCertificate");
        ...
        try {
            ...
            if (listTagsForCertificateRequest.getCertificateArn() != null) {
                jsonGenerator.writeFieldName("CertificateArn").writeValue(listTagsForCertificateRequest.getCertificateArn());
            }
