 ...
 */
public class ListTagsForCertificateResultJsonUnmarshaller implements
        Unmarshaller<ListTagsForCertificateResult, JsonUnmarshallerContext> {

    public ListTagsForCertificateResult unmarshall(
