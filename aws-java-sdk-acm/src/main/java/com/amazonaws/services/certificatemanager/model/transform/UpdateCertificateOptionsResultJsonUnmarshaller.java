...
/**
 * UpdateCertificateOptionsResult JSON Unmarshaller
 */
...
public class UpdateCertificateOptionsResultJsonUnmarshaller implements Unmarshaller<UpdateCertificateOptionsResult, JsonUnmarshallerContext> {
    ...
    public UpdateCertificateOptionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateCertificateOptionsResult updateCertificateOptionsResult = new UpdateCertificateOptionsResult();

        return updateCertificateOptionsResult;
    }
