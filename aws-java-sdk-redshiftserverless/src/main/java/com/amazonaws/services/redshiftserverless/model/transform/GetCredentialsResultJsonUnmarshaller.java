...
/**
 * GetCredentialsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetCredentialsResultJsonUnmarshaller implements Unmarshaller<GetCredentialsResult, JsonUnmarshallerContext> {

    public GetCredentialsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static GetCredentialsResultJsonUnmarshaller instance;

    public static GetCredentialsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetCredentialsResultJsonUnmarshaller();
        return instance;
    }
}
