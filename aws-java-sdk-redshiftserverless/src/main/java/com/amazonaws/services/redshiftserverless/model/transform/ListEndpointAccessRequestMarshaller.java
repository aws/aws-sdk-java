...
/**
 * ListEndpointAccessRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListEndpointAccessRequestMarshaller {
    ...
    private static final ListEndpointAccessRequestMarshaller instance = new ListEndpointAccessRequestMarshaller();

    public static ListEndpointAccessRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListEndpointAccessRequest listEndpointAccessRequest, ProtocolMarshaller protocolMarshaller) {
