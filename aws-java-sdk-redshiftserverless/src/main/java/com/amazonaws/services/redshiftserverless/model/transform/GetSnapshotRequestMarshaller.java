...
/**
 * GetSnapshotRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetSnapshotRequestMarshaller {
    ...
    private static final GetSnapshotRequestMarshaller instance = new GetSnapshotRequestMarshaller();

    public static GetSnapshotRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetSnapshotRequest getSnapshotRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getSnapshotRequest.getOwnerAccount(), OWNERACCOUNT_BINDING);
            protocolMarshaller.marshall(getSnapshotRequest.getSnapshotArn(), SNAPSHOTARN_BINDING);
            protocolMarshaller.marshall(getSnapshotRequest.getSnapshotName(), SNAPSHOTNAME_BINDING);
        } catch (Exception e) {
