...
/**
 * DeleteWorkgroupResult JSON Unmarshaller
 */
...
public class DeleteWorkgroupResultJsonUnmarshaller implements Unmarshaller<DeleteWorkgroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteWorkgroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteWorkgroupResult deleteWorkgroupResult = new DeleteWorkgroupResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("workgroup", targetDepth)) {
                    context.nextToken();
                    deleteWorkgroupResult.setWorkgroup(WorkgroupJsonUnmarshaller.getInstance().unmarshall(context));
                }
