...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.redshiftserverless.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.redshiftserverless.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.redshiftserverless.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.redshiftserverless.model.ResourceNotFoundException(
                null);
