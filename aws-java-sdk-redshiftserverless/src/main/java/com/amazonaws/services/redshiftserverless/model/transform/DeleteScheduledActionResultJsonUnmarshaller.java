...
/**
 * DeleteScheduledActionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteScheduledActionResultJsonUnmarshaller implements Unmarshaller<DeleteScheduledActionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("scheduledAction", targetDepth)) {
                    context.nextToken();
                    deleteScheduledActionResult.setScheduledAction(ScheduledActionResponseJsonUnmarshaller.getInstance().unmarshall(context));
                }
