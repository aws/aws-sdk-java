...
public class GetScheduledActionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetScheduledActionRequest withScheduledActionName(String scheduledActionName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetScheduledActionRequest == false)
            return false;
        GetScheduledActionRequest other = (GetScheduledActionRequest) obj;
    ...
    @Override
    public GetScheduledActionRequest clone() {
        return (GetScheduledActionRequest) super.clone();
    }
