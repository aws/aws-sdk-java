...
public class ListCapabilitiesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListCapabilitiesRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCapabilitiesRequest == false)
            return false;
        ListCapabilitiesRequest other = (ListCapabilitiesRequest) obj;
    ...
    public ListCapabilitiesRequest clone() {
        return (ListCapabilitiesRequest) super.clone();
    }
