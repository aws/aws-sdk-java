...
public class GetPartnershipRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetPartnershipRequest withPartnershipId(String partnershipId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPartnershipRequest == false)
            return false;
        GetPartnershipRequest other = (GetPartnershipRequest) obj;
    ...
    @Override
    public GetPartnershipRequest clone() {
        return (GetPartnershipRequest) super.clone();
    }
