...
public class CreateTransformerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateTransformerResult withTransformerId(String transformerId) {
    ...
    public CreateTransformerResult withTransformerArn(String transformerArn) {
    ...
    public CreateTransformerResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public CreateTransformerResult withFileFormat(String fileFormat) {
    ...
    public CreateTransformerResult withFileFormat(FileFormat fileFormat) {
    ...
    public CreateTransformerResult withMappingTemplate(String mappingTemplate) {
    ...
    public CreateTransformerResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public CreateTransformerResult withStatus(TransformerStatus status) {
    ...
    public CreateTransformerResult withEdiType(EdiType ediType) {
        setEdiType(ediType);
        return this;
    }
    ...
    public CreateTransformerResult withSampleDocument(String sampleDocument) {
    ...
    public CreateTransformerResult withCreatedAt(java.util.Date createdAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTransformerResult == false)
            return false;
        CreateTransformerResult other = (CreateTransformerResult) obj;
    ...
    @Override
    public CreateTransformerResult clone() {
        try {
            return (CreateTransformerResult) super.clone();
