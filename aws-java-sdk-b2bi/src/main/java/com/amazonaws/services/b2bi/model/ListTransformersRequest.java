...
public class ListTransformersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListTransformersRequest withNextToken(String nextToken) {
     ...
     * </p>
     * 
     * @return Specifies the number of items to return for the API response.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTransformersRequest == false)
            return false;
        ListTransformersRequest other = (ListTransformersRequest) obj;
    ...
    public ListTransformersRequest clone() {
        return (ListTransformersRequest) super.clone();
    }
