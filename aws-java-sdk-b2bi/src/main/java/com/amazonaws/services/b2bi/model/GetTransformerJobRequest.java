...
public class GetTransformerJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetTransformerJobRequest withTransformerJobId(String transformerJobId) {
    ...
    public GetTransformerJobRequest withTransformerId(String transformerId) {
    ...
    public String toString() {
        ...
        if (getTransformerJobId() != null)
            sb.append("TransformerJobId: ").append(getTransformerJobId()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTransformerJobRequest == false)
            return false;
    ...
    @Override
    public GetTransformerJobRequest clone() {
        return (GetTransformerJobRequest) super.clone();
    }
