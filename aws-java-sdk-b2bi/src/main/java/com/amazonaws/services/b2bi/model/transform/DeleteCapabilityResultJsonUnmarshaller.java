...
/**
 * DeleteCapabilityResult JSON Unmarshaller
 */
...
public class DeleteCapabilityResultJsonUnmarshaller implements Unmarshaller<DeleteCapabilityResult, JsonUnmarshallerContext> {
    ...
    public DeleteCapabilityResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCapabilityResult deleteCapabilityResult = new DeleteCapabilityResult();
