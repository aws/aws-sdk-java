...
public class CreatePartnershipResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreatePartnershipResult withCapabilities(String... capabilities) {
    ...
    public CreatePartnershipResult withCapabilities(java.util.Collection<String> capabilities) {
    ...
    public CreatePartnershipResult withCreatedAt(java.util.Date createdAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePartnershipResult == false)
            return false;
        CreatePartnershipResult other = (CreatePartnershipResult) obj;
