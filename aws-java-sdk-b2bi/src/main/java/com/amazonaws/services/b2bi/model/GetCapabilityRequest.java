...
public class GetCapabilityRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetCapabilityRequest withCapabilityId(String capabilityId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCapabilityRequest == false)
            return false;
        GetCapabilityRequest other = (GetCapabilityRequest) obj;
    ...
    public GetCapabilityRequest clone() {
        return (GetCapabilityRequest) super.clone();
    }
