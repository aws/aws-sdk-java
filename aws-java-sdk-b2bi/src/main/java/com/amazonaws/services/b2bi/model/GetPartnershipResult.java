...
public class GetPartnershipResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Returns the display name of the partnership
     */
    ...
    public GetPartnershipResult withCapabilities(String... capabilities) {
    ...
    public GetPartnershipResult withCapabilities(java.util.Collection<String> capabilities) {
     ...
     * </p>
     * 
     * @return Returns the unique identifier for the partner for this partnership.
     */
    ...
    public GetPartnershipResult withCreatedAt(java.util.Date createdAt) {
    ...
    public GetPartnershipResult withModifiedAt(java.util.Date modifiedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPartnershipResult == false)
            return false;
        GetPartnershipResult other = (GetPartnershipResult) obj;
    ...
    public GetPartnershipResult clone() {
        try {
            return (GetPartnershipResult) super.clone();
