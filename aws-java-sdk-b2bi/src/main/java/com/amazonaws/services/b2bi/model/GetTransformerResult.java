...
public class GetTransformerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetTransformerResult withCreatedAt(java.util.Date createdAt) {
    ...
    public GetTransformerResult withModifiedAt(java.util.Date modifiedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTransformerResult == false)
            return false;
        GetTransformerResult other = (GetTransformerResult) obj;
    ...
    public GetTransformerResult clone() {
        try {
            return (GetTransformerResult) super.clone();
