...
/**
 * Abstract implementation of {@code AmazonImportExportAsync}. Convenient method
 * forms pass through to the corresponding overload that takes a request object
 * and an {@code AsyncHandler}, which throws an
 * {@code UnsupportedOperationException}.
 */
public class AbstractAmazonImportExportAsync extends AbstractAmazonImportExport
