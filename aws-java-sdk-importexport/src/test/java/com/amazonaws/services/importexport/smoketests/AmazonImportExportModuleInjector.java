 ...
 */
public class AmazonImportExportModuleInjector implements InjectorSource {

    @Override
    public Injector getInjector() {
        return Guice.createInjector(Stage.PRODUCTION, CucumberModules.SCENARIO,
                new AmazonImportExportModule());
    }

    static class AmazonImportExportModule extends AbstractModule {
