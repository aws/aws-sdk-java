...
/**
 * H265QvbrSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class H265QvbrSettingsMarshaller {
    ...
    public static H265QvbrSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(H265QvbrSettings h265QvbrSettings, ProtocolMarshaller protocolMarshaller) {

        if (h265QvbrSettings == null) {
