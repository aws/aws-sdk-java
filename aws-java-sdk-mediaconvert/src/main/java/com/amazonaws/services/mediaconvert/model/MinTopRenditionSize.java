 ...
 * resolution.
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediaconvert-2017-08-29/MinTopRenditionSize" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MinTopRenditionSize implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MinTopRenditionSize == false)
            return false;
    ...
    public MinTopRenditionSize clone() {
        try {
            return (MinTopRenditionSize) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediaconvert.model.transform.MinTopRenditionSizeMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
