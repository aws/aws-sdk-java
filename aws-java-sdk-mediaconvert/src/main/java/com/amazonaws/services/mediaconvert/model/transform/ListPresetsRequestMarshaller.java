...
public class ListPresetsRequestMarshaller {
    ...
    public void marshall(ListPresetsRequest listPresetsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listPresetsRequest.getCategory(), CATEGORY_BINDING);
            protocolMarshaller.marshall(listPresetsRequest.getListBy(), LISTBY_BINDING);
            protocolMarshaller.marshall(listPresetsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listPresetsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listPresetsRequest.getOrder(), ORDER_BINDING);
        } catch (Exception e) {
