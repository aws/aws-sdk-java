...
public class GetPresetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPresetResult == false)
            return false;
        GetPresetResult other = (GetPresetResult) obj;
    ...
    public GetPresetResult clone() {
        try {
            return (GetPresetResult) super.clone();
