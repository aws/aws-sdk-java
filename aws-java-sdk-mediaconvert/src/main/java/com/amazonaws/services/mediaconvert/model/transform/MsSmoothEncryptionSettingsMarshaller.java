...
/**
 * MsSmoothEncryptionSettingsMarshaller
 */
...
public class MsSmoothEncryptionSettingsMarshaller {
    ...
    public void marshall(MsSmoothEncryptionSettings msSmoothEncryptionSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        if (msSmoothEncryptionSettings == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(msSmoothEncryptionSettings.getSpekeKeyProvider(), SPEKEKEYPROVIDER_BINDING);
        } catch (Exception e) {
