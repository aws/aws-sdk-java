...
/**
 * ClipLimits JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ClipLimitsJsonUnmarshaller implements Unmarshaller<ClipLimits, JsonUnmarshallerContext> {

    public ClipLimits unmarshall(JsonUnmarshallerContext context) throws Exception {
        ClipLimits clipLimits = new ClipLimits();
    ...
    private static ClipLimitsJsonUnmarshaller instance;

    public static ClipLimitsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ClipLimitsJsonUnmarshaller();
        return instance;
    }
}
