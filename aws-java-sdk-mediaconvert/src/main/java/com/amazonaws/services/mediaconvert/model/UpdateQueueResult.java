...
public class UpdateQueueResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public UpdateQueueResult clone() {
        try {
            return (UpdateQueueResult) super.clone();
