...
public class ListQueuesRequestMarshaller {
    ...
    private static final MarshallingInfo<String> LISTBY_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("listBy").build();
