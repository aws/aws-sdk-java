...
public enum UncompressedFramerateConversionAlgorithm {
    ...
    private UncompressedFramerateConversionAlgorithm(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return UncompressedFramerateConversionAlgorithm corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static UncompressedFramerateConversionAlgorithm fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (UncompressedFramerateConversionAlgorithm enumEntry : UncompressedFramerateConversionAlgorithm.values()) {
