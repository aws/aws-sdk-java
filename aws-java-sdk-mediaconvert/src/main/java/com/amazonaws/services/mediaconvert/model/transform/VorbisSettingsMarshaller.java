...
public class VorbisSettingsMarshaller {
    ...
    public void marshall(VorbisSettings vorbisSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(vorbisSettings.getChannels(), CHANNELS_BINDING);
            protocolMarshaller.marshall(vorbisSettings.getSampleRate(), SAMPLERATE_BINDING);
            protocolMarshaller.marshall(vorbisSettings.getVbrQuality(), VBRQUALITY_BINDING);
        } catch (Exception e) {
