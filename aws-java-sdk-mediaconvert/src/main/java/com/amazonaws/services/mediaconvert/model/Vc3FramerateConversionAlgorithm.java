...
public enum Vc3FramerateConversionAlgorithm {
    ...
    private Vc3FramerateConversionAlgorithm(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return Vc3FramerateConversionAlgorithm corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static Vc3FramerateConversionAlgorithm fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (Vc3FramerateConversionAlgorithm enumEntry : Vc3FramerateConversionAlgorithm.values()) {
