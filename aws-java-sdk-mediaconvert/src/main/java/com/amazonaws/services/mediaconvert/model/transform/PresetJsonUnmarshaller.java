        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("category", targetDepth)) {
                    context.nextToken();
                    preset.setCategory(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("createdAt", targetDepth)) {
                    context.nextToken();
                    preset.setCreatedAt(context.getUnmarshaller(java.util.Date.class).unmarshall(context));
                }
                ...
                if (context.testExpression("lastUpdated", targetDepth)) {
                    context.nextToken();
                    preset.setLastUpdated(context.getUnmarshaller(java.util.Date.class).unmarshall(context));
                }
                ...
                if (context.testExpression("settings", targetDepth)) {
                    context.nextToken();
                    preset.setSettings(PresetSettingsJsonUnmarshaller.getInstance().unmarshall(context));
                }
