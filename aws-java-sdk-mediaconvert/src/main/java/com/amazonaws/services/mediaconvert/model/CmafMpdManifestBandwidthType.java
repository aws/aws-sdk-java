...
public enum CmafMpdManifestBandwidthType {
    ...
    private CmafMpdManifestBandwidthType(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return CmafMpdManifestBandwidthType corresponding to the value
     *
    ...
    public static CmafMpdManifestBandwidthType fromValue(String value) {
        ...
        for (CmafMpdManifestBandwidthType enumEntry : CmafMpdManifestBandwidthType.values()) {
