...
/**
 * NoiseReducerSpatialFilterSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class NoiseReducerSpatialFilterSettingsMarshaller {

    private static final MarshallingInfo<Integer> POSTFILTERSHARPENSTRENGTH_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("postFilterSharpenStrength").build();
