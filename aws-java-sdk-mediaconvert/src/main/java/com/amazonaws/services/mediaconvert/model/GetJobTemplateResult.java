...
public class GetJobTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetJobTemplateResult withJobTemplate(JobTemplate jobTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetJobTemplateResult == false)
            return false;
        GetJobTemplateResult other = (GetJobTemplateResult) obj;
    ...
    @Override
    public GetJobTemplateResult clone() {
        try {
            return (GetJobTemplateResult) super.clone();
