...
public enum XavcEntropyEncoding {
    ...
    private XavcEntropyEncoding(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return XavcEntropyEncoding corresponding to the value
     *
    ...
    public static XavcEntropyEncoding fromValue(String value) {
        ...
        for (XavcEntropyEncoding enumEntry : XavcEntropyEncoding.values()) {
