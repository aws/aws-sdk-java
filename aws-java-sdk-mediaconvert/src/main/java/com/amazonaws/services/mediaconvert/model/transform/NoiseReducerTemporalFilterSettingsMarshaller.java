...
public class NoiseReducerTemporalFilterSettingsMarshaller {
    ...
    private static final MarshallingInfo<String> POSTTEMPORALSHARPENINGSTRENGTH_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("postTemporalSharpeningStrength").build();
    ...
    public void marshall(NoiseReducerTemporalFilterSettings noiseReducerTemporalFilterSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(noiseReducerTemporalFilterSettings.getPostTemporalSharpeningStrength(), POSTTEMPORALSHARPENINGSTRENGTH_BINDING);
