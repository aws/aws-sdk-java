...
/**
 * AssociateCertificateResult JSON Unmarshaller
 */
...
public class AssociateCertificateResultJsonUnmarshaller implements Unmarshaller<AssociateCertificateResult, JsonUnmarshallerContext> {
    ...
    public AssociateCertificateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateCertificateResult associateCertificateResult = new AssociateCertificateResult();
