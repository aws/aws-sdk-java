...
/**
 * ListJobTemplatesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListJobTemplatesResultJsonUnmarshaller implements Unmarshaller<ListJobTemplatesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("jobTemplates", targetDepth)) {
                    context.nextToken();
                    listJobTemplatesResult.setJobTemplates(new ListUnmarshaller<JobTemplate>(JobTemplateJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listJobTemplatesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
