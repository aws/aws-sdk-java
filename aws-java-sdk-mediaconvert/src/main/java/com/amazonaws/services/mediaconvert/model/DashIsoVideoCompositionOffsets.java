...
public enum DashIsoVideoCompositionOffsets {
    ...
    private DashIsoVideoCompositionOffsets(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return DashIsoVideoCompositionOffsets corresponding to the value
     *
    ...
    public static DashIsoVideoCompositionOffsets fromValue(String value) {
        ...
        for (DashIsoVideoCompositionOffsets enumEntry : DashIsoVideoCompositionOffsets.values()) {
