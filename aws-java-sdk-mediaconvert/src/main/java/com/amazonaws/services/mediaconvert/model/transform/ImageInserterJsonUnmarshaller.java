...
/**
 * ImageInserter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImageInserterJsonUnmarshaller implements Unmarshaller<ImageInserter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("insertableImages", targetDepth)) {
                    context.nextToken();
                    imageInserter.setInsertableImages(new ListUnmarshaller<InsertableImage>(InsertableImageJsonUnmarshaller.getInstance()).unmarshall(context));
                }
