...
public class FinalizingOrganizationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FinalizingOrganizationExceptionUnmarshaller instance;

    public static FinalizingOrganizationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FinalizingOrganizationExceptionUnmarshaller();
        return instance;
    }
}
