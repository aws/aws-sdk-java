...
public class ListHandshakesForOrganizationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <code>ENABLE-ALL-FEATURES</code>, or <code>APPROVE-ALL-FEATURES</code>. Alternatively, you can specify the
     * <code>ENABLE-ALL-FEATURES</code> handshake, which generates a separate child handshake for each member account.
     * When you do, specify the <code>ParentHandshakeId</code> to see only the handshakes that were generated by that
     * parent request.
     * </p>
     */
     ...
     *        <code>ActionType</code> element to limit the output to only a specified type, such as <code>INVITE</code>,
     *        <code>ENABLE-ALL-FEATURES</code>, or <code>APPROVE-ALL-FEATURES</code>. Alternatively, you can specify the
     *        <code>ENABLE-ALL-FEATURES</code> handshake, which generates a separate child handshake for each member
     *        account. When you do, specify the <code>ParentHandshakeId</code> to see only the handshakes that were
     ...
     *         <code>ActionType</code> element to limit the output to only a specified type, such as <code>INVITE</code>
     *         , <code>ENABLE-ALL-FEATURES</code>, or <code>APPROVE-ALL-FEATURES</code>. Alternatively, you can specify
     *         the <code>ENABLE-ALL-FEATURES</code> handshake, which generates a separate child handshake for each
     *         member account. When you do, specify the <code>ParentHandshakeId</code> to see only the handshakes that
