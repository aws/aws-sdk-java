        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Targets", targetDepth)) {
                    context.nextToken();
                    listTargetsForPolicyResult.setTargets(new ListUnmarshaller<PolicyTargetSummary>(PolicyTargetSummaryJsonUnmarshaller.getInstance())
                            .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listTargetsForPolicyResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
