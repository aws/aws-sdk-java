...
/**
 * EnabledServicePrincipal JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EnabledServicePrincipalJsonUnmarshaller implements Unmarshaller<EnabledServicePrincipal, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ServicePrincipal", targetDepth)) {
                    context.nextToken();
                    enabledServicePrincipal.setServicePrincipal(context.getUnmarshaller(String.class).unmarshall(context));
                }
