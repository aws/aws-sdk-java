...
/**
 * ListAccountsForParentResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListAccountsForParentResultJsonUnmarshaller implements Unmarshaller<ListAccountsForParentResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listAccountsForParentResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
