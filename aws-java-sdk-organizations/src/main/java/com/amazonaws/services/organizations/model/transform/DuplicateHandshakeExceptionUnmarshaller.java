...
public class DuplicateHandshakeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DuplicateHandshakeExceptionUnmarshaller instance;

    public static DuplicateHandshakeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicateHandshakeExceptionUnmarshaller();
        return instance;
    }
}
