...
public class CancelHandshakeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelHandshakeResult == false)
            return false;
        CancelHandshakeResult other = (CancelHandshakeResult) obj;
    ...
    public CancelHandshakeResult clone() {
        try {
            return (CancelHandshakeResult) super.clone();
