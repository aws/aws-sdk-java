...
/**
 * <p>
 * You can't use the specified policy type with the organization in its current mode of operation. For example, you can
 * enable service control policies (SCPs) only after the organization upgrades to full-control mode.
 * </p>
 */
