...
public class ListAccountsForParentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListAccountsForParentRequest clone() {
        return (ListAccountsForParentRequest) super.clone();
    }
