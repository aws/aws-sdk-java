...
public class ListHandshakesForAccountRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <code>ENABLE_ALL_FEATURES</code>, or <code>APPROVE_ALL_FEATURES</code>. Alternatively, you can specify the
     * <code>ENABLE_ALL_FEATURES</code> handshake, which generates a separate child handshake for each member account.
     * When you do specify <code>ParentHandshakeId</code> to see only the handshakes that were generated by that parent
     * request.
     * </p>
     */
     ...
     *        <code>ActionType</code> element to limit the output to only a specified type, such as <code>INVITE</code>,
     *        <code>ENABLE_ALL_FEATURES</code>, or <code>APPROVE_ALL_FEATURES</code>. Alternatively, you can specify the
     *        <code>ENABLE_ALL_FEATURES</code> handshake, which generates a separate child handshake for each member
     *        account. When you do specify <code>ParentHandshakeId</code> to see only the handshakes that were generated
     ...
     *         <code>ActionType</code> element to limit the output to only a specified type, such as <code>INVITE</code>
     *         , <code>ENABLE_ALL_FEATURES</code>, or <code>APPROVE_ALL_FEATURES</code>. Alternatively, you can specify
     *         the <code>ENABLE_ALL_FEATURES</code> handshake, which generates a separate child handshake for each
     *         member account. When you do specify <code>ParentHandshakeId</code> to see only the handshakes that were
