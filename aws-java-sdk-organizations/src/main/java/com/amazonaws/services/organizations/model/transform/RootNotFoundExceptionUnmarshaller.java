...
public class RootNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RootNotFoundExceptionUnmarshaller instance;

    public static RootNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RootNotFoundExceptionUnmarshaller();
        return instance;
    }
}
