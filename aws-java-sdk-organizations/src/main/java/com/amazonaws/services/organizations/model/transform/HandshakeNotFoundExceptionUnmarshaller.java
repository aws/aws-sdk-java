...
public class HandshakeNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static HandshakeNotFoundExceptionUnmarshaller instance;

    public static HandshakeNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new HandshakeNotFoundExceptionUnmarshaller();
        return instance;
    }
}
