...
public class PolicyTypeAlreadyEnabledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PolicyTypeAlreadyEnabledExceptionUnmarshaller instance;

    public static PolicyTypeAlreadyEnabledExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PolicyTypeAlreadyEnabledExceptionUnmarshaller();
        return instance;
    }
}
