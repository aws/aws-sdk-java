...
public class RemoveAccountFromOrganizationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param accountId
     *        The unique identifier (ID) of the member account that you want to remove from the organization.</p>
     *        <p>
     ...
     * </p>
     * 
     * @return The unique identifier (ID) of the member account that you want to remove from the organization.</p>
     *         <p>
     *         The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for an account ID string requires exactly
     *         12 digits.
     */
    ...
    @Override
    public RemoveAccountFromOrganizationRequest clone() {
        return (RemoveAccountFromOrganizationRequest) super.clone();
    }
