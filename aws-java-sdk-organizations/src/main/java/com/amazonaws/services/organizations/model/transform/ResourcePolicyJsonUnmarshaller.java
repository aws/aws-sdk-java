        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourcePolicySummary", targetDepth)) {
                    context.nextToken();
                    resourcePolicy.setResourcePolicySummary(ResourcePolicySummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Content", targetDepth)) {
                    context.nextToken();
                    resourcePolicy.setContent(context.getUnmarshaller(String.class).unmarshall(context));
                }
