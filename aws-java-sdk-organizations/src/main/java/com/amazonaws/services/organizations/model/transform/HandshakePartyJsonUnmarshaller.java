...
/**
 * HandshakeParty JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HandshakePartyJsonUnmarshaller implements Unmarshaller<HandshakeParty, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Id", targetDepth)) {
                    context.nextToken();
                    handshakeParty.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    handshakeParty.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
