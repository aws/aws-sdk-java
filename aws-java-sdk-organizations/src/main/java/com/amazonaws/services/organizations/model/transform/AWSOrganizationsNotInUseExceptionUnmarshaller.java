...
public class AWSOrganizationsNotInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AWSOrganizationsNotInUseExceptionUnmarshaller instance;

    public static AWSOrganizationsNotInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AWSOrganizationsNotInUseExceptionUnmarshaller();
        return instance;
    }
}
