...
public class MasterCannotLeaveOrganizationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MasterCannotLeaveOrganizationExceptionUnmarshaller instance;

    public static MasterCannotLeaveOrganizationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MasterCannotLeaveOrganizationExceptionUnmarshaller();
        return instance;
    }
}
