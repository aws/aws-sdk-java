...
public class ResourcePolicyMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> RESOURCEPOLICYSUMMARY_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ResourcePolicySummary").build();
    ...
    public void marshall(ResourcePolicy resourcePolicy, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourcePolicy.getResourcePolicySummary(), RESOURCEPOLICYSUMMARY_BINDING);
            protocolMarshaller.marshall(resourcePolicy.getContent(), CONTENT_BINDING);
        } catch (Exception e) {
