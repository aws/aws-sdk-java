...
public class OrganizationalUnitNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OrganizationalUnitNotFoundExceptionUnmarshaller instance;

    public static OrganizationalUnitNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OrganizationalUnitNotFoundExceptionUnmarshaller();
        return instance;
    }
}
