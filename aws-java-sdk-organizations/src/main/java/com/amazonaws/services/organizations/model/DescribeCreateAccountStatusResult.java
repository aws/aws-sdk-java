...
public class DescribeCreateAccountStatusResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeCreateAccountStatusResult withCreateAccountStatus(CreateAccountStatus createAccountStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeCreateAccountStatusResult == false)
            return false;
        DescribeCreateAccountStatusResult other = (DescribeCreateAccountStatusResult) obj;
    ...
    @Override
    public DescribeCreateAccountStatusResult clone() {
        try {
            return (DescribeCreateAccountStatusResult) super.clone();
