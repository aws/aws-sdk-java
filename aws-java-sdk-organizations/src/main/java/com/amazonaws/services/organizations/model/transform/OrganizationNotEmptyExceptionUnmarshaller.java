...
public class OrganizationNotEmptyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OrganizationNotEmptyExceptionUnmarshaller instance;

    public static OrganizationNotEmptyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OrganizationNotEmptyExceptionUnmarshaller();
        return instance;
    }
}
