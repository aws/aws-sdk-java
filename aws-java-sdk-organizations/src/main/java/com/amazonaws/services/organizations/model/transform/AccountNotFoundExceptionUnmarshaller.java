...
public class AccountNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AccountNotFoundExceptionUnmarshaller instance;

    public static AccountNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AccountNotFoundExceptionUnmarshaller();
        return instance;
    }
}
