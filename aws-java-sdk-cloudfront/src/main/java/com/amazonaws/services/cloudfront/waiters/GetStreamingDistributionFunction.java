...
@SdkInternalApi
public class GetStreamingDistributionFunction
        implements
        SdkFunction<GetStreamingDistributionRequest, GetStreamingDistributionResult> {
     ...
     */
    @Override
    public GetStreamingDistributionResult apply(
