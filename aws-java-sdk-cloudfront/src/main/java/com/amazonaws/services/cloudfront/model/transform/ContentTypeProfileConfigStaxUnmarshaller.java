...
/**
 * ContentTypeProfileConfig StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ContentTypeProfileConfigStaxUnmarshaller implements Unmarshaller<ContentTypeProfileConfig, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ForwardWhenContentTypeIsUnknown", targetDepth)) {
                    contentTypeProfileConfig.setForwardWhenContentTypeIsUnknown(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
