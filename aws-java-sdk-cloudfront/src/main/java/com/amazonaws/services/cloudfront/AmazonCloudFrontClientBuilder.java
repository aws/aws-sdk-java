...
/**
 * Fluent builder for {@link com.amazonaws.services.cloudfront.AmazonCloudFront}
 * . Use of the builder is preferred over using constructors of the client
 * class.
 **/
@NotThreadSafe
public final class AmazonCloudFrontClientBuilder extends
        AwsSyncClientBuilder<AmazonCloudFrontClientBuilder, AmazonCloudFront> {
    ...
    /**
     * Construct a synchronous implementation of AmazonCloudFront using the
