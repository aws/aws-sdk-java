 ...
 */
public class ActiveTrustedSignersStaxUnmarshaller implements
        Unmarshaller<ActiveTrustedSigners, StaxUnmarshallerContext> {

    public ActiveTrustedSigners unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Enabled", targetDepth)) {
                    activeTrustedSigners.setEnabled(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Quantity", targetDepth)) {
                    activeTrustedSigners.setQuantity(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
