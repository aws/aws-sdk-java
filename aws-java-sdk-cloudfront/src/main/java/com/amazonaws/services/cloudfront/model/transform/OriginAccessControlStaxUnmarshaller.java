...
/**
 * OriginAccessControl StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OriginAccessControlStaxUnmarshaller implements Unmarshaller<OriginAccessControl, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Id", targetDepth)) {
                    originAccessControl.setId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
