...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cloudfront.AmazonCloudFront#listDistributionsByWebACLId(ListDistributionsByWebACLIdRequest) ListDistributionsByWebACLId operation}.
 * <p>
 * List the distributions that are associated with a specified AWS WAF
 * web ACL.
 * </p>
 *
 * @see com.amazonaws.services.cloudfront.AmazonCloudFront#listDistributionsByWebACLId(ListDistributionsByWebACLIdRequest)
 */
public class ListDistributionsByWebACLIdRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * omit Marker.)
     *
     * @return Use Marker and MaxItems to control pagination of results. If you have
     *         more than MaxItems distributions that satisfy the request, the
     *         response includes a NextMarker element. To get the next page of
     *         results, submit another request. For the value of Marker, specify the
     *         value of NextMarker from the last response. (For the first request,
     ...
     * omit Marker.)
     *
     * @param marker Use Marker and MaxItems to control pagination of results. If you have
     *         more than MaxItems distributions that satisfy the request, the
     *         response includes a NextMarker element. To get the next page of
     *         results, submit another request. For the value of Marker, specify the
     *         value of NextMarker from the last response. (For the first request,
     ...
     * in the response body. The maximum and default values are both 100.
     *
     * @return The maximum number of distributions that you want CloudFront to return
     *         in the response body. The maximum and default values are both 100.
     */
     ...
     * with a web ACL.
     *
     * @param webACLId The Id of the AWS WAF web ACL for which you want to list the
     *         associated distributions. If you specify "null" for the Id, the
     *         request returns a list of the distributions that aren't associated
     *         with a web ACL.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDistributionsByWebACLIdRequest == false) return false;
