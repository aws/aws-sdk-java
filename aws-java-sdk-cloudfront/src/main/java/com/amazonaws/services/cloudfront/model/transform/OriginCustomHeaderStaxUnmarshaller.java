...
public class OriginCustomHeaderStaxUnmarshaller implements Unmarshaller<OriginCustomHeader, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("HeaderName", targetDepth)) {
                    originCustomHeader.setHeaderName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("HeaderValue", targetDepth)) {
                    originCustomHeader.setHeaderValue(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
