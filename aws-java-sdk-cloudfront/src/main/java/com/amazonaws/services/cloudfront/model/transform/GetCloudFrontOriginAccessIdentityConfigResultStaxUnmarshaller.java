 ...
 */
public class GetCloudFrontOriginAccessIdentityConfigResultStaxUnmarshaller
        implements
        Unmarshaller<GetCloudFrontOriginAccessIdentityConfigResult, StaxUnmarshallerContext> {

    public GetCloudFrontOriginAccessIdentityConfigResult unmarshall(
        ...
        if (context.isStartOfDocument()) {
            getCloudFrontOriginAccessIdentityConfigResult.setETag(context
                    .getHeader("ETag"));
        }
