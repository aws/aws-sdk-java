...
/**
 * CreateFieldLevelEncryptionProfileRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateFieldLevelEncryptionProfileRequestMarshaller implements
        Marshaller<Request<CreateFieldLevelEncryptionProfileRequest>, CreateFieldLevelEncryptionProfileRequest> {
    ...
    public Request<CreateFieldLevelEncryptionProfileRequest> marshall(CreateFieldLevelEncryptionProfileRequest createFieldLevelEncryptionProfileRequest) {
        ...
        Request<CreateFieldLevelEncryptionProfileRequest> request = new DefaultRequest<CreateFieldLevelEncryptionProfileRequest>(
                createFieldLevelEncryptionProfileRequest, "AmazonCloudFront");

        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/2018-06-18/field-level-encryption-profile";
