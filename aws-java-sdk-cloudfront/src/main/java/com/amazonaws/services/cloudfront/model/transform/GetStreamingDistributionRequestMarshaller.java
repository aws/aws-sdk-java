...
public class GetStreamingDistributionRequestMarshaller
    ...
    public Request<GetStreamingDistributionRequest> marshall(
        ...
        String uriResourcePath = "/2016-08-20/streaming-distribution/{Id}";

        uriResourcePath = uriResourcePath
                .replace(
                        "{Id}",
                        (getStreamingDistributionRequest.getId() != null) ? SdkHttpUtils.urlEncode(
                                StringUtils
                                        .fromString(getStreamingDistributionRequest
                                                .getId()), false)
                                : "");
