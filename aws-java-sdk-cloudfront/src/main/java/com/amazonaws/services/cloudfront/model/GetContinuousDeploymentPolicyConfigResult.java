...
public class GetContinuousDeploymentPolicyConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public GetContinuousDeploymentPolicyConfigResult withETag(String eTag) {
        setETag(eTag);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetContinuousDeploymentPolicyConfigResult == false)
            return false;
        GetContinuousDeploymentPolicyConfigResult other = (GetContinuousDeploymentPolicyConfigResult) obj;
    ...
    @Override
    public GetContinuousDeploymentPolicyConfigResult clone() {
        try {
            return (GetContinuousDeploymentPolicyConfigResult) super.clone();
