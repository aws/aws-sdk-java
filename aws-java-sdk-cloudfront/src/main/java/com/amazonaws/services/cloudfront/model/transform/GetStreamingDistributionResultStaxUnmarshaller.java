 ...
 */
public class GetStreamingDistributionResultStaxUnmarshaller implements
        Unmarshaller<GetStreamingDistributionResult, StaxUnmarshallerContext> {

    public GetStreamingDistributionResult unmarshall(
        ...
        if (context.isStartOfDocument()) {
            ...
            getStreamingDistributionResult.setETag(StringStaxUnmarshaller
