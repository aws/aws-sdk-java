...
/**
 * UpdateFieldLevelEncryptionConfigRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateFieldLevelEncryptionConfigRequestMarshaller implements
        Marshaller<Request<UpdateFieldLevelEncryptionConfigRequest>, UpdateFieldLevelEncryptionConfigRequest> {
    ...
    public Request<UpdateFieldLevelEncryptionConfigRequest> marshall(UpdateFieldLevelEncryptionConfigRequest updateFieldLevelEncryptionConfigRequest) {
        ...
        Request<UpdateFieldLevelEncryptionConfigRequest> request = new DefaultRequest<UpdateFieldLevelEncryptionConfigRequest>(
                updateFieldLevelEncryptionConfigRequest, "AmazonCloudFront");
        ...
        String uriResourcePath = "/2019-03-26/field-level-encryption/{Id}/config";
