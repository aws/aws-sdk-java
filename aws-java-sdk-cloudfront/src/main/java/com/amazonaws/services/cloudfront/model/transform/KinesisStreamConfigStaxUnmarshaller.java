...
/**
 * KinesisStreamConfig StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KinesisStreamConfigStaxUnmarshaller implements Unmarshaller<KinesisStreamConfig, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("RoleARN", targetDepth)) {
                    kinesisStreamConfig.setRoleARN(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("StreamARN", targetDepth)) {
                    kinesisStreamConfig.setStreamARN(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
