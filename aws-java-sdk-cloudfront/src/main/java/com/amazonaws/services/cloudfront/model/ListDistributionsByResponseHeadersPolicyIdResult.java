...
public class ListDistributionsByResponseHeadersPolicyIdResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDistributionsByResponseHeadersPolicyIdResult == false)
            return false;
        ListDistributionsByResponseHeadersPolicyIdResult other = (ListDistributionsByResponseHeadersPolicyIdResult) obj;
    ...
    @Override
    public ListDistributionsByResponseHeadersPolicyIdResult clone() {
        try {
            return (ListDistributionsByResponseHeadersPolicyIdResult) super.clone();
