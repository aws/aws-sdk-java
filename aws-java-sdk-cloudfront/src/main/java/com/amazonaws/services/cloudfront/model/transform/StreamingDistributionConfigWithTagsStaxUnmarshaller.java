...
public class StreamingDistributionConfigWithTagsStaxUnmarshaller implements Unmarshaller<StreamingDistributionConfigWithTags, StaxUnmarshallerContext> {

    public StreamingDistributionConfigWithTags unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("StreamingDistributionConfig", targetDepth)) {
                    streamingDistributionConfigWithTags.setStreamingDistributionConfig(StreamingDistributionConfigStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }

                if (context.testExpression("Tags", targetDepth)) {
                    streamingDistributionConfigWithTags.setTags(TagsStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
