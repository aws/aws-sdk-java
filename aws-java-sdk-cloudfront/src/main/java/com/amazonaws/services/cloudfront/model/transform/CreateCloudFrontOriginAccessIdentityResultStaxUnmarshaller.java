 ...
 */
public class CreateCloudFrontOriginAccessIdentityResultStaxUnmarshaller
        implements
        Unmarshaller<CreateCloudFrontOriginAccessIdentityResult, StaxUnmarshallerContext> {

    public CreateCloudFrontOriginAccessIdentityResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("CloudFrontOriginAccessIdentity",
                        targetDepth)) {
