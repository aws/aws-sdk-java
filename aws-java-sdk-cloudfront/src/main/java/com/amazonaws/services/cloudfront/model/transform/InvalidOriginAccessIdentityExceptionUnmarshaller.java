...
public class InvalidOriginAccessIdentityExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null
                || !errorCode.equals("InvalidOriginAccessIdentity"))
            return null;

        InvalidOriginAccessIdentityException e = (InvalidOriginAccessIdentityException) super
                .unmarshall(node);
