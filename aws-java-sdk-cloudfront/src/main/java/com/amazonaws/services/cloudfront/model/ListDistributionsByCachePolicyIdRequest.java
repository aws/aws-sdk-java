...
public class ListDistributionsByCachePolicyIdRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDistributionsByCachePolicyIdRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public ListDistributionsByCachePolicyIdRequest withMaxItems(String maxItems) {
    ...
    public ListDistributionsByCachePolicyIdRequest withCachePolicyId(String cachePolicyId) {
    ...
    public String toString() {
        ...
        if (getCachePolicyId() != null)
            sb.append("CachePolicyId: ").append(getCachePolicyId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDistributionsByCachePolicyIdRequest == false)
            return false;
    ...
    @Override
    public ListDistributionsByCachePolicyIdRequest clone() {
        return (ListDistributionsByCachePolicyIdRequest) super.clone();
    }
