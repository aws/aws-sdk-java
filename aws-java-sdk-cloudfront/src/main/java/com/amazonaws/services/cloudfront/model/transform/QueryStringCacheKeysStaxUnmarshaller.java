 ...
 */
public class QueryStringCacheKeysStaxUnmarshaller implements
        Unmarshaller<QueryStringCacheKeys, StaxUnmarshallerContext> {

    public QueryStringCacheKeys unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Quantity", targetDepth)) {
                    queryStringCacheKeys.setQuantity(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Items/Name", targetDepth)) {
                    queryStringCacheKeys.withItems(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
