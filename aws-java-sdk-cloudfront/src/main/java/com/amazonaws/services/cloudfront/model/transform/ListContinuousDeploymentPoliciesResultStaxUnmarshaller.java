...
/**
 * ListContinuousDeploymentPoliciesResult StAX Unmarshaller
 */
...
public class ListContinuousDeploymentPoliciesResultStaxUnmarshaller implements Unmarshaller<ListContinuousDeploymentPoliciesResult, StaxUnmarshallerContext> {
    ...
    public ListContinuousDeploymentPoliciesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ContinuousDeploymentPolicyList", targetDepth)) {
                    listContinuousDeploymentPoliciesResult.setContinuousDeploymentPolicyList(ContinuousDeploymentPolicyListStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
