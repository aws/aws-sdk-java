 ...
 */
public class GetCloudFrontOriginAccessIdentityResultStaxUnmarshaller
        implements
        Unmarshaller<GetCloudFrontOriginAccessIdentityResult, StaxUnmarshallerContext> {

    public GetCloudFrontOriginAccessIdentityResult unmarshall(
        ...
        if (context.isStartOfDocument()) {
            getCloudFrontOriginAccessIdentityResult.setETag(context
                    .getHeader("ETag"));
        }
