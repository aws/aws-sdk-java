 ...
 */
public class CookiePreferenceStaxUnmarshaller implements
        Unmarshaller<CookiePreference, StaxUnmarshallerContext> {

    public CookiePreference unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Forward", targetDepth)) {
                    cookiePreference.setForward(StringStaxUnmarshaller
                ...
                if (context.testExpression("WhitelistedNames", targetDepth)) {
                    cookiePreference
                            .setWhitelistedNames(CookieNamesStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
