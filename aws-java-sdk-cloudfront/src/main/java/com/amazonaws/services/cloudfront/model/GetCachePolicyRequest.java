...
public class GetCachePolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetCachePolicyRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCachePolicyRequest == false)
            return false;
        GetCachePolicyRequest other = (GetCachePolicyRequest) obj;
    ...
    @Override
    public GetCachePolicyRequest clone() {
        return (GetCachePolicyRequest) super.clone();
    }
