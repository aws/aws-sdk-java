 ...
 */
public class S3OriginConfigStaxUnmarshaller implements Unmarshaller<S3OriginConfig, StaxUnmarshallerContext> {
    ...
    public S3OriginConfig unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return s3OriginConfig;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("OriginAccessIdentity", targetDepth)) {
                    s3OriginConfig.setOriginAccessIdentity(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static S3OriginConfigStaxUnmarshaller getInstance() {
        if (instance == null) instance = new S3OriginConfigStaxUnmarshaller();
        return instance;
    }
}
