 ...
 */
public class S3OriginConfigStaxUnmarshaller implements
        Unmarshaller<S3OriginConfig, StaxUnmarshallerContext> {

    public S3OriginConfig unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("OriginAccessIdentity", targetDepth)) {
                    s3OriginConfig
                            .setOriginAccessIdentity(StringStaxUnmarshaller
