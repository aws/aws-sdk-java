...
public class ListDistributionsByResponseHeadersPolicyIdRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDistributionsByResponseHeadersPolicyIdRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
     ...
     * </p>
     * 
     * @return The maximum number of distribution IDs that you want to get in the response.
     */
     ...
     * </p>
     * 
     * @return The ID of the response headers policy whose associated distribution IDs you want to list.
     */
    ...
    public String toString() {
        ...
        if (getResponseHeadersPolicyId() != null)
            sb.append("ResponseHeadersPolicyId: ").append(getResponseHeadersPolicyId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDistributionsByResponseHeadersPolicyIdRequest == false)
            return false;
        ListDistributionsByResponseHeadersPolicyIdRequest other = (ListDistributionsByResponseHeadersPolicyIdRequest) obj;
    ...
    public ListDistributionsByResponseHeadersPolicyIdRequest clone() {
        return (ListDistributionsByResponseHeadersPolicyIdRequest) super.clone();
    }
