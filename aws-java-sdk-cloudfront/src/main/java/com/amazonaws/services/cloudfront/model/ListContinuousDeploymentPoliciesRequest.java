...
public class ListContinuousDeploymentPoliciesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListContinuousDeploymentPoliciesRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
     ...
     * </p>
     * 
     * @return The maximum number of continuous deployment policies that you want returned in the response.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListContinuousDeploymentPoliciesRequest == false)
            return false;
        ListContinuousDeploymentPoliciesRequest other = (ListContinuousDeploymentPoliciesRequest) obj;
    ...
    public ListContinuousDeploymentPoliciesRequest clone() {
        return (ListContinuousDeploymentPoliciesRequest) super.clone();
    }
