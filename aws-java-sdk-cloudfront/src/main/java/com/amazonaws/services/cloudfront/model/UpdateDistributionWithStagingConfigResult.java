...
public class UpdateDistributionWithStagingConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDistributionWithStagingConfigResult == false)
            return false;
        UpdateDistributionWithStagingConfigResult other = (UpdateDistributionWithStagingConfigResult) obj;
    ...
    @Override
    public UpdateDistributionWithStagingConfigResult clone() {
        try {
            return (UpdateDistributionWithStagingConfigResult) super.clone();
