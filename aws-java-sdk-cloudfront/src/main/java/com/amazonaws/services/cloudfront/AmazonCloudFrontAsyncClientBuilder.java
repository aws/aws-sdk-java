...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.cloudfront.AmazonCloudFrontAsync}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonCloudFrontAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonCloudFrontAsyncClientBuilder, AmazonCloudFrontAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonCloudFrontAsync using
