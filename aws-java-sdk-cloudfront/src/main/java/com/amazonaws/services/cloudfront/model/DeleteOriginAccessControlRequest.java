...
public class DeleteOriginAccessControlRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique identifier of the origin access control that you are deleting.
     */
     ...
     * </p>
     * 
     * @return The current version (<code>ETag</code> value) of the origin access control that you are deleting.
     */
    ...
    public DeleteOriginAccessControlRequest withIfMatch(String ifMatch) {
        setIfMatch(ifMatch);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteOriginAccessControlRequest == false)
            return false;
        DeleteOriginAccessControlRequest other = (DeleteOriginAccessControlRequest) obj;
    ...
    public DeleteOriginAccessControlRequest clone() {
        return (DeleteOriginAccessControlRequest) super.clone();
    }
