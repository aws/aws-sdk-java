 ...
 */
public class CacheBehaviorsStaxUnmarshaller implements Unmarshaller<CacheBehaviors, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Items/CacheBehavior", targetDepth)) {
                    cacheBehaviors.getItems().add(CacheBehaviorStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CacheBehaviorsStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CacheBehaviorsStaxUnmarshaller();
        return instance;
    }
}
