 ...
 */
public class CacheBehaviorsStaxUnmarshaller implements
        Unmarshaller<CacheBehaviors, StaxUnmarshallerContext> {

    public CacheBehaviors unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Quantity", targetDepth)) {
                    cacheBehaviors.setQuantity(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Items/CacheBehavior", targetDepth)) {
                    cacheBehaviors.getItems().add(
                            CacheBehaviorStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
