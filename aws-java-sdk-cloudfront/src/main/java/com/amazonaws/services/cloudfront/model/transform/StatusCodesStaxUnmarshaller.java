        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Quantity", targetDepth)) {
                    statusCodes.setQuantity(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Items/StatusCode", targetDepth)) {
                    statusCodes.withItems(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
