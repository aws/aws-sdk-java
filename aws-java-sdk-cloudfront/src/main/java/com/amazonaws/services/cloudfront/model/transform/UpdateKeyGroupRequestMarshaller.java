...
/**
 * UpdateKeyGroupRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateKeyGroupRequestMarshaller implements Marshaller<Request<UpdateKeyGroupRequest>, UpdateKeyGroupRequest> {

    public Request<UpdateKeyGroupRequest> marshall(UpdateKeyGroupRequest updateKeyGroupRequest) {

        if (updateKeyGroupRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        Request<UpdateKeyGroupRequest> request = new DefaultRequest<UpdateKeyGroupRequest>(updateKeyGroupRequest, "AmazonCloudFront");

        request.setHttpMethod(HttpMethodName.PUT);

        if (updateKeyGroupRequest.getIfMatch() != null) {
            request.addHeader("If-Match", StringUtils.fromString(updateKeyGroupRequest.getIfMatch()));
        }

        String uriResourcePath = "/2020-05-31/key-group/{Id}";

        uriResourcePath = com.amazonaws.transform.PathMarshallers.NON_GREEDY.marshall(uriResourcePath, "Id", updateKeyGroupRequest.getId());
        ...
        try {
            ...
            KeyGroupConfig keyGroupConfig = updateKeyGroupRequest.getKeyGroupConfig();
