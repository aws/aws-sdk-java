...
public class DistributionList implements Serializable, Cloneable {
     ...
     * make a follow-up pagination request using the Marker request parameter to retrieve more distributions in the
     * list.
     */
     ...
     *        can make a follow-up pagination request using the Marker request parameter to retrieve more distributions
     *        in the list.
     */
     ...
     * current AWS account.
     * 
     * @return A complex type that contains one DistributionSummary element for each distribution that was created by
