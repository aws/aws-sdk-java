 ...
 */
public class OriginSslProtocolsStaxUnmarshaller implements
        Unmarshaller<OriginSslProtocols, StaxUnmarshallerContext> {

    public OriginSslProtocols unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Quantity", targetDepth)) {
                    originSslProtocols.setQuantity(IntegerStaxUnmarshaller
