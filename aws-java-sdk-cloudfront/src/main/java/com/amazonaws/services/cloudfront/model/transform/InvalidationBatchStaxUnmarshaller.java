 ...
 */
public class InvalidationBatchStaxUnmarshaller implements
        Unmarshaller<InvalidationBatch, StaxUnmarshallerContext> {

    public InvalidationBatch unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Paths", targetDepth)) {
                    invalidationBatch.setPaths(PathsStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("CallerReference", targetDepth)) {
                    invalidationBatch.setCallerReference(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
