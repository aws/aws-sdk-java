 ...
 */
public class StreamingDistributionListStaxUnmarshaller implements
        Unmarshaller<StreamingDistributionList, StaxUnmarshallerContext> {

    public StreamingDistributionList unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    streamingDistributionList.setMarker(StringStaxUnmarshaller
                ...
                if (context.testExpression("MaxItems", targetDepth)) {
                    streamingDistributionList
                            .setMaxItems(IntegerStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Quantity", targetDepth)) {
                    streamingDistributionList
                            .setQuantity(IntegerStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
