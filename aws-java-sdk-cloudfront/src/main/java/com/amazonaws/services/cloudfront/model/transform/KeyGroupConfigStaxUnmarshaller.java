...
/**
 * KeyGroupConfig StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KeyGroupConfigStaxUnmarshaller implements Unmarshaller<KeyGroupConfig, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Name", targetDepth)) {
                    keyGroupConfig.setName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Items/PublicKey", targetDepth)) {
                    keyGroupConfig.withItems(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Comment", targetDepth)) {
                    keyGroupConfig.setComment(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
