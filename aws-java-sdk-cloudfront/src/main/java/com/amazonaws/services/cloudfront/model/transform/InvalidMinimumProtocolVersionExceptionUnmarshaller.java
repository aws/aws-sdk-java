...
public class InvalidMinimumProtocolVersionExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null
                || !errorCode.equals("InvalidMinimumProtocolVersion"))
            return null;

        InvalidMinimumProtocolVersionException e = (InvalidMinimumProtocolVersionException) super
                .unmarshall(node);
