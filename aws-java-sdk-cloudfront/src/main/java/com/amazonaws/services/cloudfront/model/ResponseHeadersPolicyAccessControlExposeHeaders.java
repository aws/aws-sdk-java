 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2020-05-31/ResponseHeadersPolicyAccessControlExposeHeaders"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResponseHeadersPolicyAccessControlExposeHeaders implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The number of HTTP headers in the list.
     */
     ...
     * </p>
     * 
     * @return The list of HTTP headers. You can specify <code>*</code> to expose all headers.
     */
    ...
    public ResponseHeadersPolicyAccessControlExposeHeaders withItems(java.util.Collection<String> items) {
        setItems(items);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResponseHeadersPolicyAccessControlExposeHeaders == false)
            return false;
        ResponseHeadersPolicyAccessControlExposeHeaders other = (ResponseHeadersPolicyAccessControlExposeHeaders) obj;
    ...
    public ResponseHeadersPolicyAccessControlExposeHeaders clone() {
        try {
            return (ResponseHeadersPolicyAccessControlExposeHeaders) super.clone();
