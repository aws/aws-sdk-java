...
public class UpdateOriginRequestPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An origin request policy.
     */
    ...
    public UpdateOriginRequestPolicyResult withETag(String eTag) {
        setETag(eTag);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateOriginRequestPolicyResult == false)
            return false;
        UpdateOriginRequestPolicyResult other = (UpdateOriginRequestPolicyResult) obj;
    ...
    @Override
    public UpdateOriginRequestPolicyResult clone() {
        try {
            return (UpdateOriginRequestPolicyResult) super.clone();
