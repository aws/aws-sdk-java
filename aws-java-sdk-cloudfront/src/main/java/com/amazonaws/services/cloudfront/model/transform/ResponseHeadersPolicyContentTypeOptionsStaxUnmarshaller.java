...
/**
 * ResponseHeadersPolicyContentTypeOptions StAX Unmarshaller
 */
...
public class ResponseHeadersPolicyContentTypeOptionsStaxUnmarshaller implements Unmarshaller<ResponseHeadersPolicyContentTypeOptions, StaxUnmarshallerContext> {
    ...
    public ResponseHeadersPolicyContentTypeOptions unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Override", targetDepth)) {
                    responseHeadersPolicyContentTypeOptions.setOverride(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
