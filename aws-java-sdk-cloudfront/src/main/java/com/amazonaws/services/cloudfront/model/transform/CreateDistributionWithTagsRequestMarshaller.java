...
public class CreateDistributionWithTagsRequestMarshaller
        implements
        Marshaller<Request<CreateDistributionWithTagsRequest>, CreateDistributionWithTagsRequest> {

    public Request<CreateDistributionWithTagsRequest> marshall(
        ...
        Request<CreateDistributionWithTagsRequest> request = new DefaultRequest<CreateDistributionWithTagsRequest>(
                createDistributionWithTagsRequest, "AmazonCloudFront");
        ...
        try {
            ...
            if (distributionConfigWithTags != null) {
                ...
                DistributionConfig distributionConfig = distributionConfigWithTags
                    ...
                    if (distributionConfig.getDefaultRootObject() != null) {
                        xmlWriter
                                ...
                                .value(distributionConfig
                                        .getDefaultRootObject()).endElement();
                    }
                        ...
                        if (!originsItemsList.isEmpty()
                            ...
                            for (Origin originsItemsListValue : originsItemsList) {
                                ...
                                if (customOriginConfig != null) {
                                    xmlWriter
                                            .startElement("CustomOriginConfig");
                                    ...
                                    if (originSslProtocols != null) {
                                        ...
                                        com.amazonaws.internal.SdkInternalList<String> originSslProtocolsItemsList = (com.amazonaws.internal.SdkInternalList<String>) originSslProtocols
                                                .getItems();
                                        if (!originSslProtocolsItemsList
                                                .isEmpty()
                        ...
                        if (!cacheBehaviorsItemsList.isEmpty()
                            ...
                            for (CacheBehavior cacheBehaviorsItemsListValue : cacheBehaviorsItemsList) {
                                ...
                                if (forwardedValues != null) {
                                    ...
                                    Headers headers = forwardedValues
                                            .getHeaders();
                                    if (headers != null) {
                                        xmlWriter.startElement("Headers");
                        ...
                        if (geoRestriction != null) {
                            ...
                            if (!geoRestrictionItemsList.isEmpty()
                                ...
                                for (String geoRestrictionItemsListValue : geoRestrictionItemsList) {
                                    ...
                                    xmlWriter
                                            .value(geoRestrictionItemsListValue);
                                    xmlWriter.endElement();
                                }
                                xmlWriter.endElement();
                            }
