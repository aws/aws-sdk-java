...
public class CachePolicyHeadersConfig implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CachePolicyHeadersConfig == false)
            return false;
        CachePolicyHeadersConfig other = (CachePolicyHeadersConfig) obj;
    ...
    public CachePolicyHeadersConfig clone() {
        try {
            return (CachePolicyHeadersConfig) super.clone();
