 ...
 */
public class GetDistributionResultStaxUnmarshaller implements
        Unmarshaller<GetDistributionResult, StaxUnmarshallerContext> {

    public GetDistributionResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        if (context.isStartOfDocument()) {
            ...
            getDistributionResult.setETag(StringStaxUnmarshaller.getInstance()
                    .unmarshall(context));
