...
/**
 * ListOriginAccessControlsRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListOriginAccessControlsRequestMarshaller implements Marshaller<Request<ListOriginAccessControlsRequest>, ListOriginAccessControlsRequest> {
    ...
    public Request<ListOriginAccessControlsRequest> marshall(ListOriginAccessControlsRequest listOriginAccessControlsRequest) {
        ...
        Request<ListOriginAccessControlsRequest> request = new DefaultRequest<ListOriginAccessControlsRequest>(listOriginAccessControlsRequest,
                "AmazonCloudFront");
