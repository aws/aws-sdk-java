...
public class CreateRealtimeLogConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRealtimeLogConfigResult == false)
            return false;
        CreateRealtimeLogConfigResult other = (CreateRealtimeLogConfigResult) obj;
    ...
    @Override
    public CreateRealtimeLogConfigResult clone() {
        try {
            return (CreateRealtimeLogConfigResult) super.clone();
