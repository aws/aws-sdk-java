 ...
 */
public class CustomHeadersStaxUnmarshaller implements
        Unmarshaller<CustomHeaders, StaxUnmarshallerContext> {

    public CustomHeaders unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Quantity", targetDepth)) {
                    customHeaders.setQuantity(IntegerStaxUnmarshaller
