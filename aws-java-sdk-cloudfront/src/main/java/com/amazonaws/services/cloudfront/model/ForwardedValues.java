...
public class ForwardedValues implements Serializable, Cloneable {
     ...
     * behavior and cache based on the query string parameters. CloudFront behavior depends on the value of QueryString
     * and on the values that you specify for QueryStringCacheKeys, if any:
     * </p>
     * <ul>
     * <li>If you specify true for QueryString and you don't specify any values for QueryStringCacheKeys, CloudFront
     * forwards all query string parameters to the origin and caches based on all query string parameters. Depending on
     * how many query string parameters and values you have, this can adversely affect performance because CloudFront
     * must forward more requests to the origin.</li>
     * <li>If you specify true for QueryString and you specify one or more values for QueryStringCacheKeys, CloudFront
     * forwards all query string parameters to the origin, but it only caches based on the query string parameters that
     * you specify.</li>
     * <li>If you specify false for QueryString, CloudFront doesn't forward any query string parameters to the origin,
     * and doesn't cache based on query string parameters.</li>
     * </ul>
     */
     ...
     *        QueryString and on the values that you specify for QueryStringCacheKeys, if any:</p>
     *        <ul>
     *        <li>If you specify true for QueryString and you don't specify any values for QueryStringCacheKeys,
     *        CloudFront forwards all query string parameters to the origin and caches based on all query string
     *        parameters. Depending on how many query string parameters and values you have, this can adversely affect
     *        performance because CloudFront must forward more requests to the origin.</li>
     *        <li>If you specify true for QueryString and you specify one or more values for QueryStringCacheKeys,
     *        CloudFront forwards all query string parameters to the origin, but it only caches based on the query
     *        string parameters that you specify.</li>
     *        <li>If you specify false for QueryString, CloudFront doesn't forward any query string parameters to the
     *        origin, and doesn't cache based on query string parameters.</li>
     */
     ...
     *         of QueryString and on the values that you specify for QueryStringCacheKeys, if any:</p>
     *         <ul>
     *         <li>If you specify true for QueryString and you don't specify any values for QueryStringCacheKeys,
     *         CloudFront forwards all query string parameters to the origin and caches based on all query string
     *         parameters. Depending on how many query string parameters and values you have, this can adversely affect
     ...
     * 
     * @param headers
     *        A complex type that specifies the Headers, if any, that you want CloudFront to vary upon for this cache
     *        behavior.
     */
     ...
     * A complex type that specifies the Headers, if any, that you want CloudFront to vary upon for this cache behavior.
     * 
     * @return A complex type that specifies the Headers, if any, that you want CloudFront to vary upon for this cache
     *         behavior.
     */
