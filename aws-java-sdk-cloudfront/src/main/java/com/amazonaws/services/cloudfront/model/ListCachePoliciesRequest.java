...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2020-05-31/ListCachePolicies" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListCachePoliciesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListCachePoliciesRequest withType(String type) {
        setType(type);
        return this;
    }
    ...
    public ListCachePoliciesRequest withType(CachePolicyType type) {
    ...
    public ListCachePoliciesRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public ListCachePoliciesRequest withMaxItems(String maxItems) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCachePoliciesRequest == false)
            return false;
    ...
    @Override
    public ListCachePoliciesRequest clone() {
        return (ListCachePoliciesRequest) super.clone();
    }
