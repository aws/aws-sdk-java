 ...
 */
public class GeoRestrictionStaxUnmarshaller implements
        Unmarshaller<GeoRestriction, StaxUnmarshallerContext> {

    public GeoRestriction unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("RestrictionType", targetDepth)) {
                    geoRestriction.setRestrictionType(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Quantity", targetDepth)) {
                    geoRestriction.setQuantity(IntegerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
