...
public class MissingBodyExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public MissingBodyExceptionUnmarshaller() {
        super(MissingBodyException.class);
    }
