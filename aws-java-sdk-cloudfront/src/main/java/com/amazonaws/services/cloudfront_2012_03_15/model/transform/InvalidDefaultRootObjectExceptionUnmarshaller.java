...
public class InvalidDefaultRootObjectExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public InvalidDefaultRootObjectExceptionUnmarshaller() {
        super(InvalidDefaultRootObjectException.class);
    }
