...
public class InvalidIfMatchVersionExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public InvalidIfMatchVersionExceptionUnmarshaller() {
        super(InvalidIfMatchVersionException.class);
    }
