...
public class DistributionAlreadyExistsExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public DistributionAlreadyExistsExceptionUnmarshaller() {
        super(DistributionAlreadyExistsException.class);
    }
