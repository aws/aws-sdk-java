...
public class DeliveryOptionsMarshaller {
    ...
    private static final DeliveryOptionsMarshaller instance = new DeliveryOptionsMarshaller();

    public static DeliveryOptionsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeliveryOptions deliveryOptions, ProtocolMarshaller protocolMarshaller) {
