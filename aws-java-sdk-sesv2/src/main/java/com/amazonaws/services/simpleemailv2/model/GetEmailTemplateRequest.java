...
public class GetEmailTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetEmailTemplateRequest clone() {
        return (GetEmailTemplateRequest) super.clone();
    }
