...
@SdkInternalApi
public class DeleteEmailIdentityRequestMarshaller {
    ...
    private static final DeleteEmailIdentityRequestMarshaller instance = new DeleteEmailIdentityRequestMarshaller();

    public static DeleteEmailIdentityRequestMarshaller getInstance() {
        return instance;
    }
