...
/**
 * CustomVerificationEmailTemplateMetadata JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CustomVerificationEmailTemplateMetadataJsonUnmarshaller implements Unmarshaller<CustomVerificationEmailTemplateMetadata, JsonUnmarshallerContext> {

    public CustomVerificationEmailTemplateMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        CustomVerificationEmailTemplateMetadata customVerificationEmailTemplateMetadata = new CustomVerificationEmailTemplateMetadata();
    ...
    private static CustomVerificationEmailTemplateMetadataJsonUnmarshaller instance;

    public static CustomVerificationEmailTemplateMetadataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CustomVerificationEmailTemplateMetadataJsonUnmarshaller();
        return instance;
    }
}
