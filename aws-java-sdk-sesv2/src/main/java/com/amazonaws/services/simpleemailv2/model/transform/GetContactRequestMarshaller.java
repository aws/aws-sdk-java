...
public class GetContactRequestMarshaller {
    ...
    public void marshall(GetContactRequest getContactRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getContactRequest.getContactListName(), CONTACTLISTNAME_BINDING);
            protocolMarshaller.marshall(getContactRequest.getEmailAddress(), EMAILADDRESS_BINDING);
        } catch (Exception e) {
