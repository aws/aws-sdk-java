...
public class FailureInfoMarshaller {
    ...
    private static final MarshallingInfo<String> FAILEDRECORDSS3URL_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("FailedRecordsS3Url").build();
    ...
    public void marshall(FailureInfo failureInfo, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(failureInfo.getFailedRecordsS3Url(), FAILEDRECORDSS3URL_BINDING);
