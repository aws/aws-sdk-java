...
public class TopicFilterMarshaller {
    ...
    private static final MarshallingInfo<Boolean> USEDEFAULTIFPREFERENCEUNAVAILABLE_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("UseDefaultIfPreferenceUnavailable").build();
    ...
    public void marshall(TopicFilter topicFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(topicFilter.getTopicName(), TOPICNAME_BINDING);
            protocolMarshaller.marshall(topicFilter.getUseDefaultIfPreferenceUnavailable(), USEDEFAULTIFPREFERENCEUNAVAILABLE_BINDING);
        } catch (Exception e) {
