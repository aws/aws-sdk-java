...
public class GetDedicatedIpPoolRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the dedicated IP pool to retrieve.
     */
    ...
    public GetDedicatedIpPoolRequest withPoolName(String poolName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDedicatedIpPoolRequest == false)
            return false;
        GetDedicatedIpPoolRequest other = (GetDedicatedIpPoolRequest) obj;
    ...
    @Override
    public GetDedicatedIpPoolRequest clone() {
        return (GetDedicatedIpPoolRequest) super.clone();
    }
