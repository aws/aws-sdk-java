...
public class ListRecommendationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * provided in the <code>ListRecommendationsResponse</code> to use in the subsequent call to
     * <code>ListRecommendations</code> with the same parameters to retrieve the next page of recommendations.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The recommendations applicable to your account.
     */
     ...
     *        token provided in the <code>ListRecommendationsResponse</code> to use in the subsequent call to
     *        <code>ListRecommendations</code> with the same parameters to retrieve the next page of recommendations.
     */
     ...
     * </p>
     * 
     * @return A string token indicating that there might be additional recommendations available to be listed. Use the
     *         token provided in the <code>ListRecommendationsResponse</code> to use in the subsequent call to
     *         <code>ListRecommendations</code> with the same parameters to retrieve the next page of recommendations.
     */
