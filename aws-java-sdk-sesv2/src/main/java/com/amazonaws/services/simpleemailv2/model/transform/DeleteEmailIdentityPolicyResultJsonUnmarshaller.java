...
/**
 * DeleteEmailIdentityPolicyResult JSON Unmarshaller
 */
...
public class DeleteEmailIdentityPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteEmailIdentityPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteEmailIdentityPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEmailIdentityPolicyResult deleteEmailIdentityPolicyResult = new DeleteEmailIdentityPolicyResult();

        return deleteEmailIdentityPolicyResult;
    }
