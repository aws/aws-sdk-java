...
public class CreateEmailIdentityPolicyRequestMarshaller {
    ...
    private static final CreateEmailIdentityPolicyRequestMarshaller instance = new CreateEmailIdentityPolicyRequestMarshaller();

    public static CreateEmailIdentityPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateEmailIdentityPolicyRequest createEmailIdentityPolicyRequest, ProtocolMarshaller protocolMarshaller) {

        if (createEmailIdentityPolicyRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createEmailIdentityPolicyRequest.getEmailIdentity(), EMAILIDENTITY_BINDING);
            protocolMarshaller.marshall(createEmailIdentityPolicyRequest.getPolicyName(), POLICYNAME_BINDING);
            protocolMarshaller.marshall(createEmailIdentityPolicyRequest.getPolicy(), POLICY_BINDING);
        } catch (Exception e) {
