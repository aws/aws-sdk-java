    ...
    public FilterCondition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("equalsValue", targetDepth)) {
                    context.nextToken();
                    filterCondition.setEqualsValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("greaterThan", targetDepth)) {
                    context.nextToken();
                    filterCondition.setGreaterThan(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("lessThan", targetDepth)) {
                    context.nextToken();
                    filterCondition.setLessThan(context.getUnmarshaller(Long.class).unmarshall(context));
                }
