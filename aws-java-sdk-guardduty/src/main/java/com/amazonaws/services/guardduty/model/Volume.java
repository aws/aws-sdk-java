 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/Volume" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Volume implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getHostPath() != null)
            sb.append("HostPath: ").append(getHostPath());
        sb.append("}");
        return sb.toString();
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.guardduty.model.transform.VolumeMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
