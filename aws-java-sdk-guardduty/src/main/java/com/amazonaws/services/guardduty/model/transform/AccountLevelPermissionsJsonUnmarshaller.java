...
/**
 * AccountLevelPermissions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AccountLevelPermissionsJsonUnmarshaller implements Unmarshaller<AccountLevelPermissions, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("blockPublicAccess", targetDepth)) {
                    context.nextToken();
                    accountLevelPermissions.setBlockPublicAccess(BlockPublicAccessJsonUnmarshaller.getInstance().unmarshall(context));
                }
