...
public class UpdateMemberDetectorsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateMemberDetectorsResult withUnprocessedAccounts(UnprocessedAccount... unprocessedAccounts) {
    ...
    public UpdateMemberDetectorsResult withUnprocessedAccounts(java.util.Collection<UnprocessedAccount> unprocessedAccounts) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateMemberDetectorsResult == false)
            return false;
        UpdateMemberDetectorsResult other = (UpdateMemberDetectorsResult) obj;
    ...
    public UpdateMemberDetectorsResult clone() {
        try {
            return (UpdateMemberDetectorsResult) super.clone();
