...
public class LocalPortDetailsMarshaller {
    ...
    public void marshall(LocalPortDetails localPortDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        if (localPortDetails == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(localPortDetails.getPort(), PORT_BINDING);
            protocolMarshaller.marshall(localPortDetails.getPortName(), PORTNAME_BINDING);
        } catch (Exception e) {
