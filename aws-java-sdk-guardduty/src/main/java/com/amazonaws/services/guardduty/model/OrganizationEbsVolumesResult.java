 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/OrganizationEbsVolumesResult"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OrganizationEbsVolumesResult implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return An object that contains the status of whether scanning EBS volumes should be auto-enabled for new members
     *         joining the organization.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OrganizationEbsVolumesResult == false)
            return false;
        OrganizationEbsVolumesResult other = (OrganizationEbsVolumesResult) obj;
    ...
    public OrganizationEbsVolumesResult clone() {
        try {
            return (OrganizationEbsVolumesResult) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.guardduty.model.transform.OrganizationEbsVolumesResultMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
