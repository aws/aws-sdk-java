 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/OrganizationScanEc2InstanceWithFindingsResult"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OrganizationScanEc2InstanceWithFindingsResult implements Serializable, Cloneable, StructuredPojo {
    ...
    public OrganizationEbsVolumesResult getEbsVolumes() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OrganizationScanEc2InstanceWithFindingsResult == false)
            return false;
    ...
    @Override
    public OrganizationScanEc2InstanceWithFindingsResult clone() {
        try {
            return (OrganizationScanEc2InstanceWithFindingsResult) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.guardduty.model.transform.OrganizationScanEc2InstanceWithFindingsResultMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
