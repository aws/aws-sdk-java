...
/**
 * UpdateDetectorResult JSON Unmarshaller
 */
...
public class UpdateDetectorResultJsonUnmarshaller implements Unmarshaller<UpdateDetectorResult, JsonUnmarshallerContext> {
    ...
    public UpdateDetectorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDetectorResult updateDetectorResult = new UpdateDetectorResult();
