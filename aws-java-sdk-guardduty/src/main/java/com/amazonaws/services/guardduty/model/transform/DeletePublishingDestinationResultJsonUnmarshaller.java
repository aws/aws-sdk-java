...
/**
 * DeletePublishingDestinationResult JSON Unmarshaller
 */
...
public class DeletePublishingDestinationResultJsonUnmarshaller implements Unmarshaller<DeletePublishingDestinationResult, JsonUnmarshallerContext> {
    ...
    public DeletePublishingDestinationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeletePublishingDestinationResult deletePublishingDestinationResult = new DeletePublishingDestinationResult();
