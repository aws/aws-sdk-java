...
/**
 * DataSourceConfigurationsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataSourceConfigurationsResultJsonUnmarshaller implements Unmarshaller<DataSourceConfigurationsResult, JsonUnmarshallerContext> {

    public DataSourceConfigurationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DataSourceConfigurationsResult dataSourceConfigurationsResult = new DataSourceConfigurationsResult();
    ...
    private static DataSourceConfigurationsResultJsonUnmarshaller instance;

    public static DataSourceConfigurationsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DataSourceConfigurationsResultJsonUnmarshaller();
        return instance;
    }
}
