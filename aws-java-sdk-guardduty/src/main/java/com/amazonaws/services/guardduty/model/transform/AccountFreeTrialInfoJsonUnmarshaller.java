...
/**
 * AccountFreeTrialInfo JSON Unmarshaller
 */
...
public class AccountFreeTrialInfoJsonUnmarshaller implements Unmarshaller<AccountFreeTrialInfo, JsonUnmarshallerContext> {
    ...
    public AccountFreeTrialInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("accountId", targetDepth)) {
                    context.nextToken();
                    accountFreeTrialInfo.setAccountId(context.getUnmarshaller(String.class).unmarshall(context));
                }
