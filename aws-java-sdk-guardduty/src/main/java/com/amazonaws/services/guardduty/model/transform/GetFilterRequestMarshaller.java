...
/**
 * GetFilterRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetFilterRequestMarshaller {
    ...
    private static final GetFilterRequestMarshaller instance = new GetFilterRequestMarshaller();

    public static GetFilterRequestMarshaller getInstance() {
        return instance;
    }
