...
/**
 * PortProbeDetailMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PortProbeDetailMarshaller {
    ...
    private static final PortProbeDetailMarshaller instance = new PortProbeDetailMarshaller();

    public static PortProbeDetailMarshaller getInstance() {
        return instance;
    }
