...
/**
 * UpdateOrganizationConfigurationResult JSON Unmarshaller
 */
...
public class UpdateOrganizationConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateOrganizationConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateOrganizationConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
