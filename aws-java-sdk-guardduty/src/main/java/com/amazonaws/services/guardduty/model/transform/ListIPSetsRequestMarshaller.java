...
public class ListIPSetsRequestMarshaller {
    ...
    public void marshall(ListIPSetsRequest listIPSetsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listIPSetsRequest.getDetectorId(), DETECTORID_BINDING);
            protocolMarshaller.marshall(listIPSetsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listIPSetsRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
