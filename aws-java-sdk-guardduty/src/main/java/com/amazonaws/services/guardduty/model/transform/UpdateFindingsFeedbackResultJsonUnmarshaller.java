...
/**
 * UpdateFindingsFeedbackResult JSON Unmarshaller
 */
...
public class UpdateFindingsFeedbackResultJsonUnmarshaller implements Unmarshaller<UpdateFindingsFeedbackResult, JsonUnmarshallerContext> {
    ...
    public UpdateFindingsFeedbackResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateFindingsFeedbackResult updateFindingsFeedbackResult = new UpdateFindingsFeedbackResult();
