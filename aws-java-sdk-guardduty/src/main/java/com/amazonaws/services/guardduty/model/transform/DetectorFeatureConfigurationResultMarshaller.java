...
/**
 * DetectorFeatureConfigurationResultMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DetectorFeatureConfigurationResultMarshaller {
    ...
    public static DetectorFeatureConfigurationResultMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DetectorFeatureConfigurationResult detectorFeatureConfigurationResult, ProtocolMarshaller protocolMarshaller) {

        if (detectorFeatureConfigurationResult == null) {
