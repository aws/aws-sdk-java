...
public class FilterConditionMarshaller {
    ...
    private static final MarshallingInfo<String> EQUALSVALUE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("equalsValue").build();
    ...
    public void marshall(FilterCondition filterCondition, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(filterCondition.getEqualsValue(), EQUALSVALUE_BINDING);
            protocolMarshaller.marshall(filterCondition.getGreaterThan(), GREATERTHAN_BINDING);
            protocolMarshaller.marshall(filterCondition.getLessThan(), LESSTHAN_BINDING);
        } catch (Exception e) {
