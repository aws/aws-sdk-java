        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("guardDutyFindingId", targetDepth)) {
                    context.nextToken();
                    triggerDetails.setGuardDutyFindingId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("description", targetDepth)) {
                    context.nextToken();
                    triggerDetails.setDescription(context.getUnmarshaller(String.class).unmarshall(context));
                }
