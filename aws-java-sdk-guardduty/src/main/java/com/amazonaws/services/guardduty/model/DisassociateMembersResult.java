...
public class DisassociateMembersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DisassociateMembersResult withUnprocessedAccounts(UnprocessedAccount... unprocessedAccounts) {
    ...
    public DisassociateMembersResult withUnprocessedAccounts(java.util.Collection<UnprocessedAccount> unprocessedAccounts) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateMembersResult == false)
            return false;
        DisassociateMembersResult other = (DisassociateMembersResult) obj;
    ...
    public DisassociateMembersResult clone() {
        try {
            return (DisassociateMembersResult) super.clone();
