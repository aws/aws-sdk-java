...
public class AdministratorMarshaller {
    ...
    public void marshall(Administrator administrator, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(administrator.getInvitationId(), INVITATIONID_BINDING);
            protocolMarshaller.marshall(administrator.getRelationshipStatus(), RELATIONSHIPSTATUS_BINDING);
            protocolMarshaller.marshall(administrator.getInvitedAt(), INVITEDAT_BINDING);
        } catch (Exception e) {
