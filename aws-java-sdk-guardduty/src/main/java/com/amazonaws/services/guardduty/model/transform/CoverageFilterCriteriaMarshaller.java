...
public class CoverageFilterCriteriaMarshaller {
    ...
    private static final MarshallingInfo<List> FILTERCRITERION_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("filterCriterion").build();
    ...
    public void marshall(CoverageFilterCriteria coverageFilterCriteria, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(coverageFilterCriteria.getFilterCriterion(), FILTERCRITERION_BINDING);
        } catch (Exception e) {
