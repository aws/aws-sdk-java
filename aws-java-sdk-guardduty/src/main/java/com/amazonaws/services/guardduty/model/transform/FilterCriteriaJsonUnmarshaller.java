    ...
    public FilterCriteria unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("filterCriterion", targetDepth)) {
                    context.nextToken();
                    filterCriteria.setFilterCriterion(new ListUnmarshaller<FilterCriterion>(FilterCriterionJsonUnmarshaller.getInstance())
