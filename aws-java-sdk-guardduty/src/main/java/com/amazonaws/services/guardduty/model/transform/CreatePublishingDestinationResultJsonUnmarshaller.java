...
/**
 * CreatePublishingDestinationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreatePublishingDestinationResultJsonUnmarshaller implements Unmarshaller<CreatePublishingDestinationResult, JsonUnmarshallerContext> {

    public CreatePublishingDestinationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("destinationId", targetDepth)) {
                    context.nextToken();
                    createPublishingDestinationResult.setDestinationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
