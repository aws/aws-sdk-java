 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/Administrator" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Administrator implements Serializable, Cloneable, StructuredPojo {
    ...
    public Administrator withInvitationId(String invitationId) {
    ...
    public Administrator withRelationshipStatus(String relationshipStatus) {
    ...
    public Administrator withInvitedAt(String invitedAt) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.guardduty.model.transform.AdministratorMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
