...
/**
 * ChannelDefinition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChannelDefinitionJsonUnmarshaller implements Unmarshaller<ChannelDefinition, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChannelId", targetDepth)) {
                    context.nextToken();
                    channelDefinition.setChannelId(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("ParticipantRole", targetDepth)) {
                    context.nextToken();
                    channelDefinition.setParticipantRole(context.getUnmarshaller(String.class).unmarshall(context));
                }
