...
public class GetMediaInsightsPipelineConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * The unique identifier of the requested resource. Valid values include the name and ARN of the media insights
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetMediaInsightsPipelineConfigurationRequest == false)
            return false;
        GetMediaInsightsPipelineConfigurationRequest other = (GetMediaInsightsPipelineConfigurationRequest) obj;
    ...
    public GetMediaInsightsPipelineConfigurationRequest clone() {
        return (GetMediaInsightsPipelineConfigurationRequest) super.clone();
    }
