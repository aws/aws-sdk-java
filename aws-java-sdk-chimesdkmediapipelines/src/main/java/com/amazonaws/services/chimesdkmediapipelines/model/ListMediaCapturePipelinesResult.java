...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-media-pipelines-2021-07-15/ListMediaCapturePipelines"
...
public class ListMediaCapturePipelinesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setMediaCapturePipelines(java.util.Collection<MediaCapturePipelineSummary> mediaCapturePipelines) {
        ...
        this.mediaCapturePipelines = new java.util.ArrayList<MediaCapturePipelineSummary>(mediaCapturePipelines);
    }
    ...
    public ListMediaCapturePipelinesResult withMediaCapturePipelines(MediaCapturePipelineSummary... mediaCapturePipelines) {
        if (this.mediaCapturePipelines == null) {
            setMediaCapturePipelines(new java.util.ArrayList<MediaCapturePipelineSummary>(mediaCapturePipelines.length));
        }
        for (MediaCapturePipelineSummary ele : mediaCapturePipelines) {
    ...
    public ListMediaCapturePipelinesResult withMediaCapturePipelines(java.util.Collection<MediaCapturePipelineSummary> mediaCapturePipelines) {
