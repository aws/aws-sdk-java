...
/**
 * MediaLiveConnectorPipelineMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MediaLiveConnectorPipelineMarshaller {
    ...
    private static final MediaLiveConnectorPipelineMarshaller instance = new MediaLiveConnectorPipelineMarshaller();

    public static MediaLiveConnectorPipelineMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MediaLiveConnectorPipeline mediaLiveConnectorPipeline, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(mediaLiveConnectorPipeline.getSources(), SOURCES_BINDING);
            protocolMarshaller.marshall(mediaLiveConnectorPipeline.getSinks(), SINKS_BINDING);
            protocolMarshaller.marshall(mediaLiveConnectorPipeline.getMediaPipelineId(), MEDIAPIPELINEID_BINDING);
            protocolMarshaller.marshall(mediaLiveConnectorPipeline.getMediaPipelineArn(), MEDIAPIPELINEARN_BINDING);
            protocolMarshaller.marshall(mediaLiveConnectorPipeline.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(mediaLiveConnectorPipeline.getCreatedTimestamp(), CREATEDTIMESTAMP_BINDING);
            protocolMarshaller.marshall(mediaLiveConnectorPipeline.getUpdatedTimestamp(), UPDATEDTIMESTAMP_BINDING);
        } catch (Exception e) {
