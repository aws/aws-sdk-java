...
/**
 * DeleteMediaCapturePipelineResult JSON Unmarshaller
 */
...
public class DeleteMediaCapturePipelineResultJsonUnmarshaller implements Unmarshaller<DeleteMediaCapturePipelineResult, JsonUnmarshallerContext> {
    ...
    public DeleteMediaCapturePipelineResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMediaCapturePipelineResult deleteMediaCapturePipelineResult = new DeleteMediaCapturePipelineResult();
