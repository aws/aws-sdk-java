...
/**
 * MediaConcatenationPipelineMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MediaConcatenationPipelineMarshaller {
    ...
    private static final MediaConcatenationPipelineMarshaller instance = new MediaConcatenationPipelineMarshaller();

    public static MediaConcatenationPipelineMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MediaConcatenationPipeline mediaConcatenationPipeline, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(mediaConcatenationPipeline.getMediaPipelineId(), MEDIAPIPELINEID_BINDING);
            protocolMarshaller.marshall(mediaConcatenationPipeline.getMediaPipelineArn(), MEDIAPIPELINEARN_BINDING);
            protocolMarshaller.marshall(mediaConcatenationPipeline.getSources(), SOURCES_BINDING);
            protocolMarshaller.marshall(mediaConcatenationPipeline.getSinks(), SINKS_BINDING);
            protocolMarshaller.marshall(mediaConcatenationPipeline.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(mediaConcatenationPipeline.getCreatedTimestamp(), CREATEDTIMESTAMP_BINDING);
            protocolMarshaller.marshall(mediaConcatenationPipeline.getUpdatedTimestamp(), UPDATEDTIMESTAMP_BINDING);
        } catch (Exception e) {
