...
public class UpdateMediaInsightsPipelineConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public UpdateMediaInsightsPipelineConfigurationResult withMediaInsightsPipelineConfiguration(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateMediaInsightsPipelineConfigurationResult == false)
            return false;
        UpdateMediaInsightsPipelineConfigurationResult other = (UpdateMediaInsightsPipelineConfigurationResult) obj;
    ...
    @Override
    public UpdateMediaInsightsPipelineConfigurationResult clone() {
        try {
            return (UpdateMediaInsightsPipelineConfigurationResult) super.clone();
