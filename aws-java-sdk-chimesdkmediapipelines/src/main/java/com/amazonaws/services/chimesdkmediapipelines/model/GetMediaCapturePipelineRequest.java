...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-media-pipelines-2021-07-15/GetMediaCapturePipeline"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetMediaCapturePipelineRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetMediaCapturePipelineRequest withMediaPipelineId(String mediaPipelineId) {
    ...
    public String toString() {
        ...
        if (getMediaPipelineId() != null)
            sb.append("MediaPipelineId: ").append(getMediaPipelineId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetMediaCapturePipelineRequest == false)
            return false;
    ...
    @Override
    public GetMediaCapturePipelineRequest clone() {
        return (GetMediaCapturePipelineRequest) super.clone();
    }
