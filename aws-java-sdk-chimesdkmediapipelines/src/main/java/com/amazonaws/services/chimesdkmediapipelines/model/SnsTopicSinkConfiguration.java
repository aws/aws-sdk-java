 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-media-pipelines-2021-07-15/SnsTopicSinkConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SnsTopicSinkConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SnsTopicSinkConfiguration == false)
            return false;
        SnsTopicSinkConfiguration other = (SnsTopicSinkConfiguration) obj;
    ...
    public SnsTopicSinkConfiguration clone() {
        try {
            return (SnsTopicSinkConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.chimesdkmediapipelines.model.transform.SnsTopicSinkConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
