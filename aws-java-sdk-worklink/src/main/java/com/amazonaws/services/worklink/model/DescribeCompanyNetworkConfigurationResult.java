...
public class DescribeCompanyNetworkConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DescribeCompanyNetworkConfigurationResult withSubnetIds(java.util.Collection<String> subnetIds) {
    ...
    public DescribeCompanyNetworkConfigurationResult withSecurityGroupIds(String... securityGroupIds) {
    ...
    public DescribeCompanyNetworkConfigurationResult withSecurityGroupIds(java.util.Collection<String> securityGroupIds) {
    ...
    public DescribeCompanyNetworkConfigurationResult clone() {
        try {
            return (DescribeCompanyNetworkConfigurationResult) super.clone();
