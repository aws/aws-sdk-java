...
public class DescribeWebsiteCertificateAuthorityRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DescribeWebsiteCertificateAuthorityRequest clone() {
        return (DescribeWebsiteCertificateAuthorityRequest) super.clone();
    }
