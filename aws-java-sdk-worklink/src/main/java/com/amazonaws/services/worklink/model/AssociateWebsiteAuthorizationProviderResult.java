...
public class AssociateWebsiteAuthorizationProviderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public AssociateWebsiteAuthorizationProviderResult withAuthorizationProviderId(String authorizationProviderId) {
    ...
    @Override
    public AssociateWebsiteAuthorizationProviderResult clone() {
        try {
            return (AssociateWebsiteAuthorizationProviderResult) super.clone();
