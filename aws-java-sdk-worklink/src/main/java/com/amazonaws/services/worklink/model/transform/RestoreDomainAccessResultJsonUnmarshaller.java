...
/**
 * RestoreDomainAccessResult JSON Unmarshaller
 */
...
public class RestoreDomainAccessResultJsonUnmarshaller implements Unmarshaller<RestoreDomainAccessResult, JsonUnmarshallerContext> {
    ...
    public RestoreDomainAccessResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RestoreDomainAccessResult restoreDomainAccessResult = new RestoreDomainAccessResult();
