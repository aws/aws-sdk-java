...
/**
 * DescribeAuditStreamConfigurationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeAuditStreamConfigurationResultJsonUnmarshaller implements Unmarshaller<DescribeAuditStreamConfigurationResult, JsonUnmarshallerContext> {

    public DescribeAuditStreamConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AuditStreamArn", targetDepth)) {
                    context.nextToken();
                    describeAuditStreamConfigurationResult.setAuditStreamArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
