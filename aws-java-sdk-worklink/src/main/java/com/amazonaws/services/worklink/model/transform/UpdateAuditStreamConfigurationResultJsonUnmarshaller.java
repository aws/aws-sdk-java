...
/**
 * UpdateAuditStreamConfigurationResult JSON Unmarshaller
 */
...
public class UpdateAuditStreamConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateAuditStreamConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateAuditStreamConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateAuditStreamConfigurationResult updateAuditStreamConfigurationResult = new UpdateAuditStreamConfigurationResult();
