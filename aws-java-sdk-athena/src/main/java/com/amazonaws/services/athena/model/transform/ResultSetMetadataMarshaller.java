...
public class ResultSetMetadataMarshaller {
    ...
    private static final MarshallingInfo<List> COLUMNINFO_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("ColumnInfo").build();
    ...
    public void marshall(ResultSetMetadata resultSetMetadata, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resultSetMetadata.getColumnInfo(), COLUMNINFO_BINDING);
        } catch (Exception e) {
