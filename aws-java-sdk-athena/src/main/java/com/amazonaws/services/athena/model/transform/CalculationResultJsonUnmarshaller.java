...
/**
 * CalculationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CalculationResultJsonUnmarshaller implements Unmarshaller<CalculationResult, JsonUnmarshallerContext> {

    public CalculationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static CalculationResultJsonUnmarshaller instance;

    public static CalculationResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CalculationResultJsonUnmarshaller();
        return instance;
    }
}
