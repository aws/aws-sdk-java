...
public class GetQueryRuntimeStatisticsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetQueryRuntimeStatisticsRequest withQueryExecutionId(String queryExecutionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetQueryRuntimeStatisticsRequest == false)
            return false;
        GetQueryRuntimeStatisticsRequest other = (GetQueryRuntimeStatisticsRequest) obj;
    ...
    @Override
    public GetQueryRuntimeStatisticsRequest clone() {
        return (GetQueryRuntimeStatisticsRequest) super.clone();
    }
