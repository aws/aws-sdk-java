...
public class CreateNotebookResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateNotebookResult == false)
            return false;
        CreateNotebookResult other = (CreateNotebookResult) obj;
    ...
    public CreateNotebookResult clone() {
        try {
            return (CreateNotebookResult) super.clone();
