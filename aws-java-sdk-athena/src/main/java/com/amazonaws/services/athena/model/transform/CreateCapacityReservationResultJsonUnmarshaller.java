...
/**
 * CreateCapacityReservationResult JSON Unmarshaller
 */
...
public class CreateCapacityReservationResultJsonUnmarshaller implements Unmarshaller<CreateCapacityReservationResult, JsonUnmarshallerContext> {
    ...
    public CreateCapacityReservationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateCapacityReservationResult createCapacityReservationResult = new CreateCapacityReservationResult();
