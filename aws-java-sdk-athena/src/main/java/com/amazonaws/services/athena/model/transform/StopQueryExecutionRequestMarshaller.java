...
@SdkInternalApi
public class StopQueryExecutionRequestMarshaller {

    private static final MarshallingInfo<String> QUERYEXECUTIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("QueryExecutionId")
            .defaultValueSupplier(com.amazonaws.util.IdempotentUtils.getGenerator()).build();

    private static final StopQueryExecutionRequestMarshaller instance = new StopQueryExecutionRequestMarshaller();

    public static StopQueryExecutionRequestMarshaller getInstance() {
        return instance;
    }
