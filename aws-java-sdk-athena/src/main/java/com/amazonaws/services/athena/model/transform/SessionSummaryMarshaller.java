...
public class SessionSummaryMarshaller {
    ...
    public void marshall(SessionSummary sessionSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(sessionSummary.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(sessionSummary.getEngineVersion(), ENGINEVERSION_BINDING);
            protocolMarshaller.marshall(sessionSummary.getNotebookVersion(), NOTEBOOKVERSION_BINDING);
            protocolMarshaller.marshall(sessionSummary.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
