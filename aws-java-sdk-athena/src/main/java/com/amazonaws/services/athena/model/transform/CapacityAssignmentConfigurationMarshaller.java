...
/**
 * CapacityAssignmentConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CapacityAssignmentConfigurationMarshaller {

    private static final MarshallingInfo<String> CAPACITYRESERVATIONNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CapacityReservationName").build();
    private static final MarshallingInfo<List> CAPACITYASSIGNMENTS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CapacityAssignments").build();
