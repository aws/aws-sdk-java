...
public class QueryExecution implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The location of a manifest file that tracks file locations generated by the query, the amount of data scanned by
     * the query, and the amount of time that it took the query to run.
     * </p>
     */
     ...
     * 
     * @param statistics
     *        The location of a manifest file that tracks file locations generated by the query, the amount of data
     *        scanned by the query, and the amount of time that it took the query to run.
     */
     ...
     * </p>
     * 
     * @return The location of a manifest file that tracks file locations generated by the query, the amount of data
     *         scanned by the query, and the amount of time that it took the query to run.
     */
