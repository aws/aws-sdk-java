...
/**
 * ResultSetMetadata JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResultSetMetadataJsonUnmarshaller implements Unmarshaller<ResultSetMetadata, JsonUnmarshallerContext> {
    ...
    private static ResultSetMetadataJsonUnmarshaller instance;

    public static ResultSetMetadataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResultSetMetadataJsonUnmarshaller();
        return instance;
    }
}
