        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("SubmissionDateTime", targetDepth)) {
                    context.nextToken();
                    queryExecutionStatus.setSubmissionDateTime(context.getUnmarshaller(java.util.Date.class).unmarshall(context));
                }
                if (context.testExpression("CompletionDateTime", targetDepth)) {
                    context.nextToken();
                    queryExecutionStatus.setCompletionDateTime(context.getUnmarshaller(java.util.Date.class).unmarshall(context));
                }
