...
/**
 * UpdateNotebookResult JSON Unmarshaller
 */
...
public class UpdateNotebookResultJsonUnmarshaller implements Unmarshaller<UpdateNotebookResult, JsonUnmarshallerContext> {
    ...
    public UpdateNotebookResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateNotebookResult updateNotebookResult = new UpdateNotebookResult();
