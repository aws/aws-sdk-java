...
/**
 * SessionConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SessionConfigurationJsonUnmarshaller implements Unmarshaller<SessionConfiguration, JsonUnmarshallerContext> {

    public SessionConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SessionConfigurationJsonUnmarshaller instance;

    public static SessionConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SessionConfigurationJsonUnmarshaller();
        return instance;
    }
}
