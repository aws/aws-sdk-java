...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/RestoreServer"/>AWS API Documentation</a>
 */
public class RestoreServerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public RestoreServerResult clone() {
        try {
            return (RestoreServerResult) super.clone();
