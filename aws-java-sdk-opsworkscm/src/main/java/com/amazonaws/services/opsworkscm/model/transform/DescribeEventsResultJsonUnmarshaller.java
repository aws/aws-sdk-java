...
/**
 * DescribeEventsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeEventsResultJsonUnmarshaller implements Unmarshaller<DescribeEventsResult, JsonUnmarshallerContext> {

    public DescribeEventsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DescribeEventsResultJsonUnmarshaller instance;

    public static DescribeEventsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeEventsResultJsonUnmarshaller();
        return instance;
    }
}
