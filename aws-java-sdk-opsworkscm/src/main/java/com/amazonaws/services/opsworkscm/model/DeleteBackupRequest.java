...
public class DeleteBackupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * the format <code>ServerName-yyyyMMddHHmmssSSS</code>.
     * </p>
     */
     ...
     *        are in the format <code>ServerName-yyyyMMddHHmmssSSS</code>.
     */
     ...
     * </p>
     * 
     * @return The ID of the backup to delete. Run the DescribeBackups command to get a list of backup IDs. Backup IDs
     *         are in the format <code>ServerName-yyyyMMddHHmmssSSS</code>.
     */
