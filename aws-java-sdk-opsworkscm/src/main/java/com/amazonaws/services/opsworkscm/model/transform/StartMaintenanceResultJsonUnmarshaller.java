...
/**
 * StartMaintenanceResult JSON Unmarshaller
 */
...
public class StartMaintenanceResultJsonUnmarshaller implements Unmarshaller<StartMaintenanceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Server", targetDepth)) {
                    context.nextToken();
                    startMaintenanceResult.setServer(ServerJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static StartMaintenanceResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StartMaintenanceResultJsonUnmarshaller();
        return instance;
    }
}
