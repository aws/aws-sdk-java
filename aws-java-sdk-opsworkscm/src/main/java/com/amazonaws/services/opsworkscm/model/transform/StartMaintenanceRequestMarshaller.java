...
public class StartMaintenanceRequestMarshaller implements Marshaller<Request<StartMaintenanceRequest>, StartMaintenanceRequest> {
    ...
    public Request<StartMaintenanceRequest> marshall(StartMaintenanceRequest startMaintenanceRequest) {
        ...
        Request<StartMaintenanceRequest> request = new DefaultRequest<StartMaintenanceRequest>(startMaintenanceRequest, "AWSOpsWorksCM");
        request.addHeader("X-Amz-Target", "OpsWorksCM_V2016_11_01.StartMaintenance");
        ...
        try {
            ...
            if (startMaintenanceRequest.getServerName() != null) {
                jsonGenerator.writeFieldName("ServerName").writeValue(startMaintenanceRequest.getServerName());
            }
