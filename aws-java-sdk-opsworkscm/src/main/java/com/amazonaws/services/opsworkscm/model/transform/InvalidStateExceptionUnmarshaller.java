...
public class InvalidStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidStateExceptionUnmarshaller instance;

    public static InvalidStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidStateExceptionUnmarshaller();
        return instance;
    }
}
