...
public class SetTerminationProtectionRequestMarshaller implements Marshaller<Request<SetTerminationProtectionRequest>, SetTerminationProtectionRequest> {
    ...
    public Request<SetTerminationProtectionRequest> marshall(SetTerminationProtectionRequest setTerminationProtectionRequest) {
        ...
        Request<SetTerminationProtectionRequest> request = new DefaultRequest<SetTerminationProtectionRequest>(setTerminationProtectionRequest,
                "AmazonElasticMapReduce");
        request.addHeader("X-Amz-Target", "ElasticMapReduce.SetTerminationProtection");
        ...
        try {
            ...
            if (setTerminationProtectionRequest.getTerminationProtected() != null) {
                jsonGenerator.writeFieldName("TerminationProtected").writeValue(setTerminationProtectionRequest.getTerminationProtected());
            }
