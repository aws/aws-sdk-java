    ...
    public void marshall(InstanceStateChangeReason instanceStateChangeReason, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (instanceStateChangeReason.getCode() != null) {
                jsonGenerator.writeFieldName("Code").writeValue(instanceStateChangeReason.getCode());
            }
            if (instanceStateChangeReason.getMessage() != null) {
                jsonGenerator.writeFieldName("Message").writeValue(instanceStateChangeReason.getMessage());
            }
