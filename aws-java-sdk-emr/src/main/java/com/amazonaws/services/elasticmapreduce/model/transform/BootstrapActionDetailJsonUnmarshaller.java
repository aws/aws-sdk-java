 ...
 */
public class BootstrapActionDetailJsonUnmarshaller implements
        Unmarshaller<BootstrapActionDetail, JsonUnmarshallerContext> {
    ...
    public BootstrapActionDetail unmarshall(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context
                        .testExpression("BootstrapActionConfig", targetDepth)) {
                    context.nextToken();
                    bootstrapActionDetail
                            .setBootstrapActionConfig(BootstrapActionConfigJsonUnmarshaller
