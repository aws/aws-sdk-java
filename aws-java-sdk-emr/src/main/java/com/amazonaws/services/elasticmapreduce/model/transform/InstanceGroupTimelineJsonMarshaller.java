...
public class InstanceGroupTimelineJsonMarshaller {
     ...
     */
    public void marshall(InstanceGroupTimeline instanceGroupTimeline, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (instanceGroupTimeline.getCreationDateTime() != null) {
                jsonGenerator.writeFieldName("CreationDateTime").writeValue(instanceGroupTimeline.getCreationDateTime());
            }
            if (instanceGroupTimeline.getReadyDateTime() != null) {
                jsonGenerator.writeFieldName("ReadyDateTime").writeValue(instanceGroupTimeline.getReadyDateTime());
            }
            if (instanceGroupTimeline.getEndDateTime() != null) {
                jsonGenerator.writeFieldName("EndDateTime").writeValue(instanceGroupTimeline.getEndDateTime());
            }
