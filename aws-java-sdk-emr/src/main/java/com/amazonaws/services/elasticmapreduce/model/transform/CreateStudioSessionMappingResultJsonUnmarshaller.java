...
/**
 * CreateStudioSessionMappingResult JSON Unmarshaller
 */
...
public class CreateStudioSessionMappingResultJsonUnmarshaller implements Unmarshaller<CreateStudioSessionMappingResult, JsonUnmarshallerContext> {
    ...
    public CreateStudioSessionMappingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateStudioSessionMappingResult createStudioSessionMappingResult = new CreateStudioSessionMappingResult();

        return createStudioSessionMappingResult;
    }
