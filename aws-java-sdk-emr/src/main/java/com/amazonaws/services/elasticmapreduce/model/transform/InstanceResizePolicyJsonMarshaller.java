...
public class InstanceResizePolicyJsonMarshaller {
     ...
     */
    public void marshall(InstanceResizePolicy instanceResizePolicy,
        ...
        try {
            ...
            if (!instancesToTerminateList.isEmpty()
                    || !instancesToTerminateList.isAutoConstruct()) {
            ...
            if (!instancesToProtectList.isEmpty()
                    || !instancesToProtectList.isAutoConstruct()) {
            ...
            if (instanceResizePolicy.getInstanceTerminationTimeout() != null) {
                jsonGenerator.writeFieldName("InstanceTerminationTimeout")
                        .writeValue(
