...
/**
 * SimpleScalingPolicyConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SimpleScalingPolicyConfigurationJsonUnmarshaller implements Unmarshaller<SimpleScalingPolicyConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AdjustmentType", targetDepth)) {
                    context.nextToken();
                    simpleScalingPolicyConfiguration.setAdjustmentType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ScalingAdjustment", targetDepth)) {
                    context.nextToken();
                    simpleScalingPolicyConfiguration.setScalingAdjustment(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("CoolDown", targetDepth)) {
                    context.nextToken();
                    simpleScalingPolicyConfiguration.setCoolDown(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
