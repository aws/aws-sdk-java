...
/**
 * AddInstanceFleetResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AddInstanceFleetResultJsonUnmarshaller implements Unmarshaller<AddInstanceFleetResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ClusterId", targetDepth)) {
                    context.nextToken();
                    addInstanceFleetResult.setClusterId(context.getUnmarshaller(String.class).unmarshall(context));
                }
