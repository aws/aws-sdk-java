...
public class InstanceGroupStateChangeReasonJsonMarshaller {
     ...
     */
    public void marshall(InstanceGroupStateChangeReason instanceGroupStateChangeReason, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (instanceGroupStateChangeReason.getCode() != null) {
                jsonGenerator.writeFieldName("Code").writeValue(instanceGroupStateChangeReason.getCode());
            }
            if (instanceGroupStateChangeReason.getMessage() != null) {
                jsonGenerator.writeFieldName("Message").writeValue(instanceGroupStateChangeReason.getMessage());
            }
