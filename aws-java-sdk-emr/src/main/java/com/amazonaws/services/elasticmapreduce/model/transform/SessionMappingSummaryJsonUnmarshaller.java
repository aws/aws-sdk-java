...
/**
 * SessionMappingSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SessionMappingSummaryJsonUnmarshaller implements Unmarshaller<SessionMappingSummary, JsonUnmarshallerContext> {

    public SessionMappingSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        SessionMappingSummary sessionMappingSummary = new SessionMappingSummary();
    ...
    private static SessionMappingSummaryJsonUnmarshaller instance;

    public static SessionMappingSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SessionMappingSummaryJsonUnmarshaller();
        return instance;
    }
}
