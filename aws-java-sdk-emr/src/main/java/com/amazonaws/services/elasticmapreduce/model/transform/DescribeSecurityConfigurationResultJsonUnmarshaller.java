...
public class DescribeSecurityConfigurationResultJsonUnmarshaller
    ...
    public DescribeSecurityConfigurationResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    describeSecurityConfigurationResult.setName(context
                ...
                if (context
                    ...
                    describeSecurityConfigurationResult
                            .setSecurityConfiguration(context.getUnmarshaller(
                                    String.class).unmarshall(context));
                }
                if (context.testExpression("CreationDateTime", targetDepth)) {
                    context.nextToken();
                    describeSecurityConfigurationResult
                            .setCreationDateTime(context.getUnmarshaller(
