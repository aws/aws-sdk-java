 ...
 */
public class SecurityConfigurationSummaryJsonUnmarshaller implements
        Unmarshaller<SecurityConfigurationSummary, JsonUnmarshallerContext> {

    public SecurityConfigurationSummary unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    securityConfigurationSummary.setName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("CreationDateTime", targetDepth)) {
                    context.nextToken();
                    securityConfigurationSummary.setCreationDateTime(context
