    ...
    public void marshall(InstanceTimeline instanceTimeline, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (instanceTimeline.getCreationDateTime() != null) {
                jsonGenerator.writeFieldName("CreationDateTime").writeValue(instanceTimeline.getCreationDateTime());
            }
            if (instanceTimeline.getReadyDateTime() != null) {
                jsonGenerator.writeFieldName("ReadyDateTime").writeValue(instanceTimeline.getReadyDateTime());
            }
            if (instanceTimeline.getEndDateTime() != null) {
                jsonGenerator.writeFieldName("EndDateTime").writeValue(instanceTimeline.getEndDateTime());
            }
