...
public class ModifyClusterRequestMarshaller {
    ...
    private static final ModifyClusterRequestMarshaller instance = new ModifyClusterRequestMarshaller();

    public static ModifyClusterRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ModifyClusterRequest modifyClusterRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(modifyClusterRequest.getClusterId(), CLUSTERID_BINDING);
            protocolMarshaller.marshall(modifyClusterRequest.getStepConcurrencyLevel(), STEPCONCURRENCYLEVEL_BINDING);
        } catch (Exception e) {
