...
class ClusterRunning {
    ...
    static class IsRUNNINGMatcher extends WaiterAcceptor<DescribeClusterResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("Cluster"), new JmesPathField("Status"), new JmesPathField(
                "State"));
    ...
    static class IsWAITINGMatcher extends WaiterAcceptor<DescribeClusterResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsTERMINATINGMatcher extends WaiterAcceptor<DescribeClusterResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsTERMINATEDMatcher extends WaiterAcceptor<DescribeClusterResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsTERMINATED_WITH_ERRORSMatcher extends WaiterAcceptor<DescribeClusterResult> {
        private static final JsonNode expectedResult;
