...
class ClusterRunning {
    ...
    static class IsRUNNINGMatcher extends WaiterAcceptor<DescribeClusterResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(
                new JmesPathField("Cluster"), new JmesPathField("Status"),
    ...
    static class IsTERMINATINGMatcher extends
            WaiterAcceptor<DescribeClusterResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsTERMINATED_WITH_ERRORSMatcher extends
            WaiterAcceptor<DescribeClusterResult> {
        private static final JsonNode expectedResult;
        ...
        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper()
                        .readTree("\"TERMINATED_WITH_ERRORS\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
