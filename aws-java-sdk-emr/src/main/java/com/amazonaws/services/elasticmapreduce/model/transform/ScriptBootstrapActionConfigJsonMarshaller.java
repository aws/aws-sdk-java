...
public class ScriptBootstrapActionConfigJsonMarshaller {
     ...
     */
    public void marshall(ScriptBootstrapActionConfig scriptBootstrapActionConfig, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (scriptBootstrapActionConfig.getPath() != null) {
                jsonGenerator.writeFieldName("Path").writeValue(scriptBootstrapActionConfig.getPath());
            }

            com.amazonaws.internal.SdkInternalList<String> argsList = (com.amazonaws.internal.SdkInternalList<String>) scriptBootstrapActionConfig.getArgs();
