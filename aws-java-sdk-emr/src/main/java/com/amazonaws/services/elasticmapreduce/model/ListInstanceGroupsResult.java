...
public class ListInstanceGroupsResult implements Serializable, Cloneable {
    ...
    public void setInstanceGroups(
        ...
        this.instanceGroups = new com.amazonaws.internal.SdkInternalList<InstanceGroup>(
                instanceGroups);
    }
    ...
    public ListInstanceGroupsResult withInstanceGroups(
        ...
        if (this.instanceGroups == null) {
            setInstanceGroups(new com.amazonaws.internal.SdkInternalList<InstanceGroup>(
