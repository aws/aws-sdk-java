    ...
    public void marshall(StepTimeline stepTimeline, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (stepTimeline.getCreationDateTime() != null) {
                jsonGenerator.writeFieldName("CreationDateTime").writeValue(stepTimeline.getCreationDateTime());
            }
            if (stepTimeline.getStartDateTime() != null) {
                jsonGenerator.writeFieldName("StartDateTime").writeValue(stepTimeline.getStartDateTime());
            }
            if (stepTimeline.getEndDateTime() != null) {
                jsonGenerator.writeFieldName("EndDateTime").writeValue(stepTimeline.getEndDateTime());
            }
