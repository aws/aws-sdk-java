...
public class DeleteSecurityConfigurationRequestMarshaller
    ...
    public DeleteSecurityConfigurationRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeleteSecurityConfigurationRequest> marshall(
        ...
        Request<DeleteSecurityConfigurationRequest> request = new DefaultRequest<DeleteSecurityConfigurationRequest>(
                deleteSecurityConfigurationRequest, "AmazonElasticMapReduce");
        ...
        try {
            ...
            if (deleteSecurityConfigurationRequest.getName() != null) {
                jsonGenerator.writeFieldName("Name").writeValue(
                        deleteSecurityConfigurationRequest.getName());
            }
