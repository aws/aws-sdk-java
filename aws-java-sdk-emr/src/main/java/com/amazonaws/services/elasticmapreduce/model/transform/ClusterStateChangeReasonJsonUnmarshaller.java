 ...
 */
public class ClusterStateChangeReasonJsonUnmarshaller implements Unmarshaller<ClusterStateChangeReason, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Code", targetDepth)) {
                    context.nextToken();
                    clusterStateChangeReason.setCode(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    clusterStateChangeReason.setMessage(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ClusterStateChangeReasonJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ClusterStateChangeReasonJsonUnmarshaller();
        return instance;
    }
}
