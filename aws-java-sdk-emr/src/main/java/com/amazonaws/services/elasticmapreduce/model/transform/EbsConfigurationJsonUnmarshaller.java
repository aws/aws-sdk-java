 ...
 */
public class EbsConfigurationJsonUnmarshaller implements
        Unmarshaller<EbsConfiguration, JsonUnmarshallerContext> {
    ...
    public EbsConfiguration unmarshall(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context
                        .testExpression("EbsBlockDeviceConfigs", targetDepth)) {
                    context.nextToken();
                    ebsConfiguration
                            .setEbsBlockDeviceConfigs(new ListUnmarshaller<EbsBlockDeviceConfig>(
