...
/**
 * SessionMappingDetail JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SessionMappingDetailJsonUnmarshaller implements Unmarshaller<SessionMappingDetail, JsonUnmarshallerContext> {

    public SessionMappingDetail unmarshall(JsonUnmarshallerContext context) throws Exception {
        SessionMappingDetail sessionMappingDetail = new SessionMappingDetail();
    ...
    private static SessionMappingDetailJsonUnmarshaller instance;

    public static SessionMappingDetailJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SessionMappingDetailJsonUnmarshaller();
        return instance;
    }
}
