...
public class SetVisibleToAllUsersResultJsonUnmarshaller implements Unmarshaller<SetVisibleToAllUsersResult, JsonUnmarshallerContext> {

    public SetVisibleToAllUsersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
