...
public class ListBootstrapActionsRequestMarshaller
        implements
        Marshaller<Request<ListBootstrapActionsRequest>, ListBootstrapActionsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public ListBootstrapActionsRequestMarshaller(
    ...
    public Request<ListBootstrapActionsRequest> marshall(
        ...
        Request<ListBootstrapActionsRequest> request = new DefaultRequest<ListBootstrapActionsRequest>(
