 ...
 */
public class RemoveAutoScalingPolicyRequestMarshaller implements Marshaller<Request<RemoveAutoScalingPolicyRequest>, RemoveAutoScalingPolicyRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public RemoveAutoScalingPolicyRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<RemoveAutoScalingPolicyRequest> marshall(RemoveAutoScalingPolicyRequest removeAutoScalingPolicyRequest) {
        ...
        Request<RemoveAutoScalingPolicyRequest> request = new DefaultRequest<RemoveAutoScalingPolicyRequest>(removeAutoScalingPolicyRequest,
