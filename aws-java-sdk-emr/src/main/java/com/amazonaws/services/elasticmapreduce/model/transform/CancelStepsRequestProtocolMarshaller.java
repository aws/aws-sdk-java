...
@SdkInternalApi
public class CancelStepsRequestProtocolMarshaller implements Marshaller<Request<CancelStepsRequest>, CancelStepsRequest> {
    ...
    public CancelStepsRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<CancelStepsRequest> marshall(CancelStepsRequest cancelStepsRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<CancelStepsRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    cancelStepsRequest);
