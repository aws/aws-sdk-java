...
/**
 * ScalingAction JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScalingActionJsonUnmarshaller implements Unmarshaller<ScalingAction, JsonUnmarshallerContext> {

    public ScalingAction unmarshall(JsonUnmarshallerContext context) throws Exception {
