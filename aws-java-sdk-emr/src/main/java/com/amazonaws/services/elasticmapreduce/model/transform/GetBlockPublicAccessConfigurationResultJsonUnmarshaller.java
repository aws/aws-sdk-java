...
/**
 * GetBlockPublicAccessConfigurationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetBlockPublicAccessConfigurationResultJsonUnmarshaller implements Unmarshaller<GetBlockPublicAccessConfigurationResult, JsonUnmarshallerContext> {

    public GetBlockPublicAccessConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("BlockPublicAccessConfigurationMetadata", targetDepth)) {
                    context.nextToken();
                    getBlockPublicAccessConfigurationResult.setBlockPublicAccessConfigurationMetadata(BlockPublicAccessConfigurationMetadataJsonUnmarshaller
