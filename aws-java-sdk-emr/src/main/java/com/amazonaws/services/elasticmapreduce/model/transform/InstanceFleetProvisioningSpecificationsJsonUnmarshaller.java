...
/**
 * InstanceFleetProvisioningSpecifications JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceFleetProvisioningSpecificationsJsonUnmarshaller implements Unmarshaller<InstanceFleetProvisioningSpecifications, JsonUnmarshallerContext> {

    public InstanceFleetProvisioningSpecifications unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("OnDemandSpecification", targetDepth)) {
                    context.nextToken();
                    instanceFleetProvisioningSpecifications.setOnDemandSpecification(OnDemandProvisioningSpecificationJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
