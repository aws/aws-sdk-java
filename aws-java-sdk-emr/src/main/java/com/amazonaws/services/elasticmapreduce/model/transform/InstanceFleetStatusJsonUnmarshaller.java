...
/**
 * InstanceFleetStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceFleetStatusJsonUnmarshaller implements Unmarshaller<InstanceFleetStatus, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("State", targetDepth)) {
                    context.nextToken();
                    instanceFleetStatus.setState(context.getUnmarshaller(String.class).unmarshall(context));
                }
