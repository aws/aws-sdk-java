...
public class ListInstanceGroupsRequestMarshaller
        implements
        Marshaller<Request<ListInstanceGroupsRequest>, ListInstanceGroupsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public ListInstanceGroupsRequestMarshaller(
    ...
    public Request<ListInstanceGroupsRequest> marshall(
        ...
        Request<ListInstanceGroupsRequest> request = new DefaultRequest<ListInstanceGroupsRequest>(
