 ...
 */
public class ListInstanceGroupsRequestMarshaller implements Marshaller<Request<ListInstanceGroupsRequest>, ListInstanceGroupsRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public ListInstanceGroupsRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<ListInstanceGroupsRequest> marshall(ListInstanceGroupsRequest listInstanceGroupsRequest) {
        ...
        Request<ListInstanceGroupsRequest> request = new DefaultRequest<ListInstanceGroupsRequest>(listInstanceGroupsRequest, "AmazonElasticMapReduce");
