...
/**
 * RemoveManagedScalingPolicyResult JSON Unmarshaller
 */
...
public class RemoveManagedScalingPolicyResultJsonUnmarshaller implements Unmarshaller<RemoveManagedScalingPolicyResult, JsonUnmarshallerContext> {
    ...
    public RemoveManagedScalingPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RemoveManagedScalingPolicyResult removeManagedScalingPolicyResult = new RemoveManagedScalingPolicyResult();
