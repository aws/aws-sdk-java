 ...
 */
public class AutoScalingPolicyStatusJsonMarshaller {

    /**
     * Marshall the given parameter object, and output to a SdkJsonGenerator
     */
    public void marshall(AutoScalingPolicyStatus autoScalingPolicyStatus, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (autoScalingPolicyStatus.getState() != null) {
                jsonGenerator.writeFieldName("State").writeValue(autoScalingPolicyStatus.getState());
            }
            if (autoScalingPolicyStatus.getStateChangeReason() != null) {
                jsonGenerator.writeFieldName("StateChangeReason");
                AutoScalingPolicyStateChangeReasonJsonMarshaller.getInstance().marshall(autoScalingPolicyStatus.getStateChangeReason(), jsonGenerator);
            }
