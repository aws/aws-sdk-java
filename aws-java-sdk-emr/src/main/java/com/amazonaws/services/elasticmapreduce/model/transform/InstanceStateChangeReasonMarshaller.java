...
@SdkInternalApi
public class InstanceStateChangeReasonMarshaller {
    ...
    private static final InstanceStateChangeReasonMarshaller instance = new InstanceStateChangeReasonMarshaller();

    public static InstanceStateChangeReasonMarshaller getInstance() {
        return instance;
    }
