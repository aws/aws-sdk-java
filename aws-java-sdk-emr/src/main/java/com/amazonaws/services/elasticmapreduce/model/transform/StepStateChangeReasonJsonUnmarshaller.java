...
public class StepStateChangeReasonJsonUnmarshaller implements Unmarshaller<StepStateChangeReason, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Code", targetDepth)) {
                    context.nextToken();
                    stepStateChangeReason.setCode(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    stepStateChangeReason.setMessage(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static StepStateChangeReasonJsonUnmarshaller getInstance() {
        if (instance == null) instance = new StepStateChangeReasonJsonUnmarshaller();
        return instance;
    }
}
