...
/**
 * UpdateStudioSessionMappingRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateStudioSessionMappingRequestMarshaller {
    ...
    private static final UpdateStudioSessionMappingRequestMarshaller instance = new UpdateStudioSessionMappingRequestMarshaller();

    public static UpdateStudioSessionMappingRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateStudioSessionMappingRequest updateStudioSessionMappingRequest, ProtocolMarshaller protocolMarshaller) {

        if (updateStudioSessionMappingRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(updateStudioSessionMappingRequest.getStudioId(), STUDIOID_BINDING);
            protocolMarshaller.marshall(updateStudioSessionMappingRequest.getIdentityId(), IDENTITYID_BINDING);
            protocolMarshaller.marshall(updateStudioSessionMappingRequest.getIdentityName(), IDENTITYNAME_BINDING);
            protocolMarshaller.marshall(updateStudioSessionMappingRequest.getIdentityType(), IDENTITYTYPE_BINDING);
            protocolMarshaller.marshall(updateStudioSessionMappingRequest.getSessionPolicyArn(), SESSIONPOLICYARN_BINDING);
        } catch (Exception e) {
