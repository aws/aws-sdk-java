...
public class DescribeSecurityConfigurationRequestMarshaller
    ...
    public DescribeSecurityConfigurationRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeSecurityConfigurationRequest> marshall(
        ...
        Request<DescribeSecurityConfigurationRequest> request = new DefaultRequest<DescribeSecurityConfigurationRequest>(
                describeSecurityConfigurationRequest, "AmazonElasticMapReduce");
        ...
        try {
            ...
            if (describeSecurityConfigurationRequest.getName() != null) {
                jsonGenerator.writeFieldName("Name").writeValue(
                        describeSecurityConfigurationRequest.getName());
            }
