...
public class AmazonElasticMapReduceAsyncClient extends
    ...
    public java.util.concurrent.Future<AddInstanceGroupsResult> addInstanceGroupsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<AddInstanceGroupsResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<DescribeJobFlowsResult> describeJobFlowsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DescribeJobFlowsResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ListBootstrapActionsResult> listBootstrapActionsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListBootstrapActionsResult>() {
                    @Override
