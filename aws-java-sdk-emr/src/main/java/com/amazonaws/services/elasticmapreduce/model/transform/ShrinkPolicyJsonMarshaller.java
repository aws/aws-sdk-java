...
public class ShrinkPolicyJsonMarshaller {
     ...
     */
    public void marshall(ShrinkPolicy shrinkPolicy,
        ...
        try {
            ...
            if (shrinkPolicy.getDecommissionTimeout() != null) {
                jsonGenerator.writeFieldName("DecommissionTimeout").writeValue(
                        shrinkPolicy.getDecommissionTimeout());
            }
            if (shrinkPolicy.getInstanceResizePolicy() != null) {
                jsonGenerator.writeFieldName("InstanceResizePolicy");
                InstanceResizePolicyJsonMarshaller.getInstance().marshall(
                        shrinkPolicy.getInstanceResizePolicy(), jsonGenerator);
            }
