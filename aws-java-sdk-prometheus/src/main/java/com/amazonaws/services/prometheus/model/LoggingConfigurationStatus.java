...
public class LoggingConfigurationStatus implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LoggingConfigurationStatus == false)
            return false;
        LoggingConfigurationStatus other = (LoggingConfigurationStatus) obj;
    ...
    public LoggingConfigurationStatus clone() {
        try {
            return (LoggingConfigurationStatus) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.prometheus.model.transform.LoggingConfigurationStatusMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
