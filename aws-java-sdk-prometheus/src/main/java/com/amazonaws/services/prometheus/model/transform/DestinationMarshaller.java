...
public class DestinationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> AMPCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ampConfiguration").build();
    ...
    public void marshall(Destination destination, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(destination.getAmpConfiguration(), AMPCONFIGURATION_BINDING);
        } catch (Exception e) {
