...
/**
 * ScrapeConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ScrapeConfigurationMarshaller {

    private static final MarshallingInfo<java.nio.ByteBuffer> CONFIGURATIONBLOB_BINDING = MarshallingInfo.builder(MarshallingType.BYTE_BUFFER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("configurationBlob").build();
    ...
    public void marshall(ScrapeConfiguration scrapeConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(scrapeConfiguration.getConfigurationBlob(), CONFIGURATIONBLOB_BINDING);
        } catch (Exception e) {
