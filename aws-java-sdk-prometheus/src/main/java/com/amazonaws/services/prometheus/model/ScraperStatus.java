...
public class ScraperStatus implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScraperStatus == false)
            return false;
        ScraperStatus other = (ScraperStatus) obj;
    ...
    public ScraperStatus clone() {
        try {
            return (ScraperStatus) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.prometheus.model.transform.ScraperStatusMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
