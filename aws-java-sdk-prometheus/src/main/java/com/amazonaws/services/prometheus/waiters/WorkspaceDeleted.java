...
class WorkspaceDeleted {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<DescribeWorkspaceResult> {
        /**
    ...
    static class IsDELETINGMatcher extends WaiterAcceptor<DescribeWorkspaceResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("workspace"), new JmesPathField("status"), new JmesPathField(
                "statusCode"));
         ...
         */
        @Override
        public boolean matches(DescribeWorkspaceResult result) {
