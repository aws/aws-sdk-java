...
/**
 * ListScrapersRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListScrapersRequestMarshaller {
    ...
    public static ListScrapersRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListScrapersRequest listScrapersRequest, ProtocolMarshaller protocolMarshaller) {

        if (listScrapersRequest == null) {
