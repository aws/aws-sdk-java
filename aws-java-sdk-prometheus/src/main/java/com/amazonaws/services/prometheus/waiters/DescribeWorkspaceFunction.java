...
public class DescribeWorkspaceFunction implements SdkFunction<DescribeWorkspaceRequest, DescribeWorkspaceResult> {
    ...
    /**
     * Constructs a new DescribeWorkspaceFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public DescribeWorkspaceFunction(AmazonPrometheus client) {
        this.client = client;
    }
    ...
    public DescribeWorkspaceResult apply(DescribeWorkspaceRequest describeWorkspaceRequest) {
        return client.describeWorkspace(describeWorkspaceRequest);
    }
}
