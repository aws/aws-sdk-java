...
public class UpdateResultMarshaller {
    ...
    private static final MarshallingInfo<List> GENERATEDFIELDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("generatedFields").build();
    ...
    public void marshall(UpdateResult updateResult, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateResult.getGeneratedFields(), GENERATEDFIELDS_BINDING);
        } catch (Exception e) {
