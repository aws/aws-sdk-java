 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/LambdaFunction"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LambdaFunction implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setConfiguration(LambdaFunctionConfiguration configuration) {
     ...
     * </p>
     * 
     * @return The Lambda function configuration used for recommendations.
     */

    public LambdaFunctionConfiguration getConfiguration() {
    ...
    public LambdaFunction withConfiguration(LambdaFunctionConfiguration configuration) {
    ...
    public LambdaFunction withCostCalculation(ResourceCostCalculation costCalculation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LambdaFunction == false)
            return false;
    ...
    public LambdaFunction clone() {
        try {
            return (LambdaFunction) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.costoptimizationhub.model.transform.LambdaFunctionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
