...
/**
 * Usage JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UsageJsonUnmarshaller implements Unmarshaller<Usage, JsonUnmarshallerContext> {

    public Usage unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("productCode", targetDepth)) {
                    context.nextToken();
                    usage.setProductCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static UsageJsonUnmarshaller instance;

    public static UsageJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UsageJsonUnmarshaller();
        return instance;
    }
}
