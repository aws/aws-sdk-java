...
public class UpdateEnrollmentStatusRequestMarshaller {
    ...
    public static UpdateEnrollmentStatusRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateEnrollmentStatusRequest updateEnrollmentStatusRequest, ProtocolMarshaller protocolMarshaller) {
