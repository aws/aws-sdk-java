...
public class UpdatePreferencesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePreferencesResult == false)
            return false;
        UpdatePreferencesResult other = (UpdatePreferencesResult) obj;
    ...
    public UpdatePreferencesResult clone() {
        try {
            return (UpdatePreferencesResult) super.clone();
