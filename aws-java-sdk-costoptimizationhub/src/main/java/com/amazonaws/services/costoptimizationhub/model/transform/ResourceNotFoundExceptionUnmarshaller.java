...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.costoptimizationhub.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.costoptimizationhub.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.costoptimizationhub.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.costoptimizationhub.model.ResourceNotFoundException(
                null);
