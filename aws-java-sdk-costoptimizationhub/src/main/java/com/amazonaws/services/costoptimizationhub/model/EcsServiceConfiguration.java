 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/EcsServiceConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EcsServiceConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public ComputeConfiguration getCompute() {
        return this.compute;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EcsServiceConfiguration == false)
            return false;
    ...
    @Override
    public EcsServiceConfiguration clone() {
        try {
            return (EcsServiceConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.costoptimizationhub.model.transform.EcsServiceConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
