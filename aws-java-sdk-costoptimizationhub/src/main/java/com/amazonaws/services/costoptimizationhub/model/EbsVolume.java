...
/**
 * <p>
 * Describes the Amazon Elastic Block Store volume configuration of the current and recommended resource configuration
 * for a recommendation.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/EbsVolume" target="_top">AWS
 *      API Documentation</a>
 */
...
public class EbsVolume implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private EbsVolumeConfiguration configuration;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The Amazon Elastic Block Store volume configuration used for recommendations.
     */

    public EbsVolumeConfiguration getConfiguration() {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.costoptimizationhub.model.transform.EbsVolumeMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
