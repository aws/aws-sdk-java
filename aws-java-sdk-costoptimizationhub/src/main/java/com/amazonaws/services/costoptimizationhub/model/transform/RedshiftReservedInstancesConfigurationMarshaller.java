...
/**
 * RedshiftReservedInstancesConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RedshiftReservedInstancesConfigurationMarshaller {
    ...
    private static final RedshiftReservedInstancesConfigurationMarshaller instance = new RedshiftReservedInstancesConfigurationMarshaller();

    public static RedshiftReservedInstancesConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RedshiftReservedInstancesConfiguration redshiftReservedInstancesConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (redshiftReservedInstancesConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getAccountScope(), ACCOUNTSCOPE_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getCurrentGeneration(), CURRENTGENERATION_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getInstanceFamily(), INSTANCEFAMILY_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getInstanceType(), INSTANCETYPE_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getMonthlyRecurringCost(), MONTHLYRECURRINGCOST_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getNormalizedUnitsToPurchase(), NORMALIZEDUNITSTOPURCHASE_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getNumberOfInstancesToPurchase(), NUMBEROFINSTANCESTOPURCHASE_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getPaymentOption(), PAYMENTOPTION_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getReservedInstancesRegion(), RESERVEDINSTANCESREGION_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getService(), SERVICE_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getSizeFlexEligible(), SIZEFLEXELIGIBLE_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getTerm(), TERM_BINDING);
            protocolMarshaller.marshall(redshiftReservedInstancesConfiguration.getUpfrontCost(), UPFRONTCOST_BINDING);
        } catch (Exception e) {
