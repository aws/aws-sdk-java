 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/OpenSearchReservedInstancesConfiguration"
...
public class OpenSearchReservedInstancesConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public OpenSearchReservedInstancesConfiguration withAccountScope(String accountScope) {
    ...
    public OpenSearchReservedInstancesConfiguration withCurrentGeneration(String currentGeneration) {
    ...
    public OpenSearchReservedInstancesConfiguration withInstanceType(String instanceType) {
    ...
    public OpenSearchReservedInstancesConfiguration withMonthlyRecurringCost(String monthlyRecurringCost) {
    ...
    public OpenSearchReservedInstancesConfiguration withNormalizedUnitsToPurchase(String normalizedUnitsToPurchase) {
    ...
    public OpenSearchReservedInstancesConfiguration withNumberOfInstancesToPurchase(String numberOfInstancesToPurchase) {
    ...
    public OpenSearchReservedInstancesConfiguration withPaymentOption(String paymentOption) {
    ...
    public OpenSearchReservedInstancesConfiguration withReservedInstancesRegion(String reservedInstancesRegion) {
    ...
    public OpenSearchReservedInstancesConfiguration withService(String service) {
        setService(service);
        return this;
    }
    ...
    public OpenSearchReservedInstancesConfiguration withSizeFlexEligible(Boolean sizeFlexEligible) {
    ...
    public OpenSearchReservedInstancesConfiguration withTerm(String term) {
        setTerm(term);
        return this;
    }
    ...
    public OpenSearchReservedInstancesConfiguration withUpfrontCost(String upfrontCost) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpenSearchReservedInstancesConfiguration == false)
            return false;
        OpenSearchReservedInstancesConfiguration other = (OpenSearchReservedInstancesConfiguration) obj;
    ...
    @Override
    public OpenSearchReservedInstancesConfiguration clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.costoptimizationhub.model.transform.OpenSearchReservedInstancesConfigurationMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
