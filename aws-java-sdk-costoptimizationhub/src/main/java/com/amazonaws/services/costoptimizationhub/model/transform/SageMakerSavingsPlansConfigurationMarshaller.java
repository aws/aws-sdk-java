...
/**
 * SageMakerSavingsPlansConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SageMakerSavingsPlansConfigurationMarshaller {
    ...
    public static SageMakerSavingsPlansConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SageMakerSavingsPlansConfiguration sageMakerSavingsPlansConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (sageMakerSavingsPlansConfiguration == null) {
