...
public class CreateElasticsearchDomainResultJsonUnmarshaller implements Unmarshaller<CreateElasticsearchDomainResult, JsonUnmarshallerContext> {

    public CreateElasticsearchDomainResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DomainStatus", targetDepth)) {
                    context.nextToken();
                    createElasticsearchDomainResult.setDomainStatus(ElasticsearchDomainStatusJsonUnmarshaller.getInstance().unmarshall(context));
                }
