...
public class SnapshotOptionsJsonMarshaller {
    ...
    public void marshall(SnapshotOptions snapshotOptions, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (snapshotOptions.getAutomatedSnapshotStartHour() != null) {
                jsonGenerator.writeFieldName("AutomatedSnapshotStartHour").writeValue(snapshotOptions.getAutomatedSnapshotStartHour());
            }
    ...
    public static SnapshotOptionsJsonMarshaller getInstance() {
        if (instance == null)
            instance = new SnapshotOptionsJsonMarshaller();
        return instance;
    }
