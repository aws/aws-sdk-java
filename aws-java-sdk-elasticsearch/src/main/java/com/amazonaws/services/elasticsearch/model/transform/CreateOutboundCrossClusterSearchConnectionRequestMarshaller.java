...
public class CreateOutboundCrossClusterSearchConnectionRequestMarshaller {
    ...
    private static final CreateOutboundCrossClusterSearchConnectionRequestMarshaller instance = new CreateOutboundCrossClusterSearchConnectionRequestMarshaller();

    public static CreateOutboundCrossClusterSearchConnectionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateOutboundCrossClusterSearchConnectionRequest createOutboundCrossClusterSearchConnectionRequest,
        ...
        try {
            protocolMarshaller.marshall(createOutboundCrossClusterSearchConnectionRequest.getSourceDomainInfo(), SOURCEDOMAININFO_BINDING);
            protocolMarshaller.marshall(createOutboundCrossClusterSearchConnectionRequest.getDestinationDomainInfo(), DESTINATIONDOMAININFO_BINDING);
            protocolMarshaller.marshall(createOutboundCrossClusterSearchConnectionRequest.getConnectionAlias(), CONNECTIONALIAS_BINDING);
        } catch (Exception e) {
