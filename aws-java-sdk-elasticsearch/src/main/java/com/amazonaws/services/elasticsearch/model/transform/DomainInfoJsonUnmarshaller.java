 ...
 */
public class DomainInfoJsonUnmarshaller implements
        Unmarshaller<DomainInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DomainName", targetDepth)) {
                    context.nextToken();
                    domainInfo.setDomainName(context.getUnmarshaller(
    ...
    public static DomainInfoJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DomainInfoJsonUnmarshaller();
        return instance;
    }
}
