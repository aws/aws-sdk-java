...
public class EBSOptionsStatusJsonMarshaller {
     ...
     */
    public void marshall(EBSOptionsStatus eBSOptionsStatus, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (eBSOptionsStatus.getOptions() != null) {
                ...
                EBSOptionsJsonMarshaller.getInstance().marshall(eBSOptionsStatus.getOptions(), jsonGenerator);
            }
            if (eBSOptionsStatus.getStatus() != null) {
                jsonGenerator.writeFieldName("Status");
                OptionStatusJsonMarshaller.getInstance().marshall(eBSOptionsStatus.getStatus(), jsonGenerator);
            }
