...
/**
 * DeleteElasticsearchServiceRoleResult JSON Unmarshaller
 */
...
public class DeleteElasticsearchServiceRoleResultJsonUnmarshaller implements Unmarshaller<DeleteElasticsearchServiceRoleResult, JsonUnmarshallerContext> {
    ...
    public DeleteElasticsearchServiceRoleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteElasticsearchServiceRoleResult deleteElasticsearchServiceRoleResult = new DeleteElasticsearchServiceRoleResult();

        return deleteElasticsearchServiceRoleResult;
    }
