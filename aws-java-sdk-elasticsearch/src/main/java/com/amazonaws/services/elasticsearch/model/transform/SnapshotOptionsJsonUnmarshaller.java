 ...
 */
public class SnapshotOptionsJsonUnmarshaller implements
        Unmarshaller<SnapshotOptions, JsonUnmarshallerContext> {
    ...
    public SnapshotOptions unmarshall(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AutomatedSnapshotStartHour",
                        targetDepth)) {
                    context.nextToken();
                    snapshotOptions
