...
public class SnapshotOptionsStatusJsonMarshaller {
     ...
     */
    public void marshall(SnapshotOptionsStatus snapshotOptionsStatus, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (snapshotOptionsStatus.getOptions() != null) {
                ...
                SnapshotOptionsJsonMarshaller.getInstance().marshall(snapshotOptionsStatus.getOptions(), jsonGenerator);
            }
            if (snapshotOptionsStatus.getStatus() != null) {
                jsonGenerator.writeFieldName("Status");
                OptionStatusJsonMarshaller.getInstance().marshall(snapshotOptionsStatus.getStatus(), jsonGenerator);
            }
