...
public class AccessPoliciesStatusJsonMarshaller {
     ...
     */
    public void marshall(AccessPoliciesStatus accessPoliciesStatus, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (accessPoliciesStatus.getOptions() != null) {
                jsonGenerator.writeFieldName("Options").writeValue(accessPoliciesStatus.getOptions());
            }
            if (accessPoliciesStatus.getStatus() != null) {
                jsonGenerator.writeFieldName("Status");
                OptionStatusJsonMarshaller.getInstance().marshall(accessPoliciesStatus.getStatus(), jsonGenerator);
            }
