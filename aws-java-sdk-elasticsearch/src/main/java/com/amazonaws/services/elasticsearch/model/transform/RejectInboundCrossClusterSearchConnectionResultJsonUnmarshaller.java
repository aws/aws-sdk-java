...
/**
 * RejectInboundCrossClusterSearchConnectionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RejectInboundCrossClusterSearchConnectionResultJsonUnmarshaller implements
        Unmarshaller<RejectInboundCrossClusterSearchConnectionResult, JsonUnmarshallerContext> {

    public RejectInboundCrossClusterSearchConnectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CrossClusterSearchConnection", targetDepth)) {
                    context.nextToken();
                    rejectInboundCrossClusterSearchConnectionResult.setCrossClusterSearchConnection(InboundCrossClusterSearchConnectionJsonUnmarshaller
