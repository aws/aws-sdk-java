...
public class OutboundCrossClusterSearchConnection implements Serializable, Cloneable, StructuredPojo {
    ...
    public OutboundCrossClusterSearchConnection withSourceDomainInfo(DomainInformation sourceDomainInfo) {
    ...
    public OutboundCrossClusterSearchConnection withDestinationDomainInfo(DomainInformation destinationDomainInfo) {
    ...
    public OutboundCrossClusterSearchConnection withConnectionStatus(OutboundCrossClusterSearchConnectionStatus connectionStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OutboundCrossClusterSearchConnection == false)
            return false;
    ...
    public OutboundCrossClusterSearchConnection clone() {
        try {
            return (OutboundCrossClusterSearchConnection) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.elasticsearch.model.transform.OutboundCrossClusterSearchConnectionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
