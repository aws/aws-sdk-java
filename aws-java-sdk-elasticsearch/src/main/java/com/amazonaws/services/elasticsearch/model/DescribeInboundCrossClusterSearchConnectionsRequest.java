...
public class DescribeInboundCrossClusterSearchConnectionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of filters used to match properties for inbound cross-cluster search connection. Available
     *         <code><a>Filter</a></code> names for this operation are:
     *         <ul>
     *         <li>cross-cluster-search-connection-id</li>
     *         <li>source-domain-info.domain-name</li>
    ...
    public DescribeInboundCrossClusterSearchConnectionsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    @Override
    public DescribeInboundCrossClusterSearchConnectionsRequest clone() {
        return (DescribeInboundCrossClusterSearchConnectionsRequest) super.clone();
    }
