...
public class ElasticsearchClusterConfigStatusMarshaller {
    ...
    public void marshall(ElasticsearchClusterConfigStatus elasticsearchClusterConfigStatus, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(elasticsearchClusterConfigStatus.getOptions(), OPTIONS_BINDING);
            protocolMarshaller.marshall(elasticsearchClusterConfigStatus.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
