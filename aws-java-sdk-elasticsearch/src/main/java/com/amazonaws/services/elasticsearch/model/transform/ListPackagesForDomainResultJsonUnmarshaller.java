...
/**
 * ListPackagesForDomainResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListPackagesForDomainResultJsonUnmarshaller implements Unmarshaller<ListPackagesForDomainResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DomainPackageDetailsList", targetDepth)) {
                    context.nextToken();
                    listPackagesForDomainResult.setDomainPackageDetailsList(new ListUnmarshaller<DomainPackageDetails>(DomainPackageDetailsJsonUnmarshaller
                            .getInstance())
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listPackagesForDomainResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
