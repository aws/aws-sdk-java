...
public class AssociatePackageRequestMarshaller {
    ...
    private static final AssociatePackageRequestMarshaller instance = new AssociatePackageRequestMarshaller();

    public static AssociatePackageRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssociatePackageRequest associatePackageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(associatePackageRequest.getPackageID(), PACKAGEID_BINDING);
            protocolMarshaller.marshall(associatePackageRequest.getDomainName(), DOMAINNAME_BINDING);
        } catch (Exception e) {
