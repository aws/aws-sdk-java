...
public class ElasticsearchClusterConfigStatusJsonMarshaller {
     ...
     */
    public void marshall(ElasticsearchClusterConfigStatus elasticsearchClusterConfigStatus, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (elasticsearchClusterConfigStatus.getOptions() != null) {
                ...
                ElasticsearchClusterConfigJsonMarshaller.getInstance().marshall(elasticsearchClusterConfigStatus.getOptions(), jsonGenerator);
            }
            if (elasticsearchClusterConfigStatus.getStatus() != null) {
                jsonGenerator.writeFieldName("Status");
                OptionStatusJsonMarshaller.getInstance().marshall(elasticsearchClusterConfigStatus.getStatus(), jsonGenerator);
            }
