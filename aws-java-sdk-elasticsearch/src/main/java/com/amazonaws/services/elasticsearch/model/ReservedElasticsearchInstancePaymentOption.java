...
public enum ReservedElasticsearchInstancePaymentOption {
     ...
     * @param value
     *        real value
     * @return ReservedElasticsearchInstancePaymentOption corresponding to the value
     *
    ...
    public static ReservedElasticsearchInstancePaymentOption fromValue(String value) {
        ...
        for (ReservedElasticsearchInstancePaymentOption enumEntry : ReservedElasticsearchInstancePaymentOption.values()) {
