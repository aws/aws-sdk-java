...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/greengrass-2017-06-07/GetCoreDefinition" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetCoreDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetCoreDefinitionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public GetCoreDefinitionResult withCreationTimestamp(String creationTimestamp) {
    ...
    public GetCoreDefinitionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public GetCoreDefinitionResult withLastUpdatedTimestamp(String lastUpdatedTimestamp) {
    ...
    public GetCoreDefinitionResult withLatestVersion(String latestVersion) {
    ...
    public GetCoreDefinitionResult withLatestVersionArn(String latestVersionArn) {
    ...
    public GetCoreDefinitionResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public GetCoreDefinitionResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see GetCoreDefinitionResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetCoreDefinitionResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public GetCoreDefinitionResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCoreDefinitionResult == false)
            return false;
        GetCoreDefinitionResult other = (GetCoreDefinitionResult) obj;
    ...
    @Override
    public GetCoreDefinitionResult clone() {
        try {
            return (GetCoreDefinitionResult) super.clone();
