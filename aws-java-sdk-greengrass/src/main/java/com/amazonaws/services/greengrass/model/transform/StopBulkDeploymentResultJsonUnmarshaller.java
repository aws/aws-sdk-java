...
/**
 * StopBulkDeploymentResult JSON Unmarshaller
 */
...
public class StopBulkDeploymentResultJsonUnmarshaller implements Unmarshaller<StopBulkDeploymentResult, JsonUnmarshallerContext> {
    ...
    public StopBulkDeploymentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopBulkDeploymentResult stopBulkDeploymentResult = new StopBulkDeploymentResult();

        return stopBulkDeploymentResult;
    }
