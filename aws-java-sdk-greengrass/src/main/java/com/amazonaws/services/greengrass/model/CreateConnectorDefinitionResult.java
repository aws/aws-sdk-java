...
public class CreateConnectorDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateConnectorDefinitionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreateConnectorDefinitionResult withCreationTimestamp(String creationTimestamp) {
    ...
    public CreateConnectorDefinitionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public CreateConnectorDefinitionResult withLastUpdatedTimestamp(String lastUpdatedTimestamp) {
    ...
    public CreateConnectorDefinitionResult withLatestVersion(String latestVersion) {
    ...
    public CreateConnectorDefinitionResult withLatestVersionArn(String latestVersionArn) {
    ...
    public CreateConnectorDefinitionResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateConnectorDefinitionResult == false)
            return false;
        CreateConnectorDefinitionResult other = (CreateConnectorDefinitionResult) obj;
    ...
    @Override
    public CreateConnectorDefinitionResult clone() {
        try {
            return (CreateConnectorDefinitionResult) super.clone();
