...
public class ConnectorMarshaller {
    ...
    public void marshall(Connector connector, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(connector.getConnectorArn(), CONNECTORARN_BINDING);
            protocolMarshaller.marshall(connector.getId(), ID_BINDING);
            protocolMarshaller.marshall(connector.getParameters(), PARAMETERS_BINDING);
        } catch (Exception e) {
