...
public class CreateConnectorDefinitionVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateConnectorDefinitionVersionResult == false)
            return false;
        CreateConnectorDefinitionVersionResult other = (CreateConnectorDefinitionVersionResult) obj;
    ...
    public CreateConnectorDefinitionVersionResult clone() {
        try {
            return (CreateConnectorDefinitionVersionResult) super.clone();
