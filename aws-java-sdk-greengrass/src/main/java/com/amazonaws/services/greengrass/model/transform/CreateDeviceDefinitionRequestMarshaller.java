...
/**
 * CreateDeviceDefinitionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateDeviceDefinitionRequestMarshaller {
    ...
    private static final CreateDeviceDefinitionRequestMarshaller instance = new CreateDeviceDefinitionRequestMarshaller();

    public static CreateDeviceDefinitionRequestMarshaller getInstance() {
        return instance;
    }
