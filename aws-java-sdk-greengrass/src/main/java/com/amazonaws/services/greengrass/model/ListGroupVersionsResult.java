...
public class ListGroupVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListGroupVersionsResult withVersions(java.util.Collection<VersionInformation> versions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListGroupVersionsResult == false)
            return false;
        ListGroupVersionsResult other = (ListGroupVersionsResult) obj;
    ...
    public ListGroupVersionsResult clone() {
        try {
            return (ListGroupVersionsResult) super.clone();
