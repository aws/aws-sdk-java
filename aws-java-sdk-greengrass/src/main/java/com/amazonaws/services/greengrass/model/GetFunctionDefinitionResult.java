...
public class GetFunctionDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetFunctionDefinitionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public GetFunctionDefinitionResult withCreationTimestamp(String creationTimestamp) {
    ...
    public GetFunctionDefinitionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public GetFunctionDefinitionResult withLastUpdatedTimestamp(String lastUpdatedTimestamp) {
    ...
    public GetFunctionDefinitionResult withLatestVersion(String latestVersion) {
    ...
    public GetFunctionDefinitionResult withLatestVersionArn(String latestVersionArn) {
    ...
    public GetFunctionDefinitionResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public GetFunctionDefinitionResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see GetFunctionDefinitionResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetFunctionDefinitionResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetFunctionDefinitionResult == false)
            return false;
        GetFunctionDefinitionResult other = (GetFunctionDefinitionResult) obj;
    ...
    @Override
    public GetFunctionDefinitionResult clone() {
        try {
