...
/**
 * DeleteConnectorDefinitionResult JSON Unmarshaller
 */
...
public class DeleteConnectorDefinitionResultJsonUnmarshaller implements Unmarshaller<DeleteConnectorDefinitionResult, JsonUnmarshallerContext> {
    ...
    public DeleteConnectorDefinitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteConnectorDefinitionResult deleteConnectorDefinitionResult = new DeleteConnectorDefinitionResult();

        return deleteConnectorDefinitionResult;
    }
