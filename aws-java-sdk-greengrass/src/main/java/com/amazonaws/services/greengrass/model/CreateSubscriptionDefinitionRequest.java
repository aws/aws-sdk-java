...
public class CreateSubscriptionDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateSubscriptionDefinitionRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateSubscriptionDefinitionRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateSubscriptionDefinitionRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSubscriptionDefinitionRequest == false)
            return false;
    ...
    public CreateSubscriptionDefinitionRequest clone() {
        return (CreateSubscriptionDefinitionRequest) super.clone();
    }
