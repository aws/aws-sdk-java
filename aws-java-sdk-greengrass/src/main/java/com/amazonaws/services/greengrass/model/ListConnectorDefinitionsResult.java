...
public class ListConnectorDefinitionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListConnectorDefinitionsResult withDefinitions(DefinitionInformation... definitions) {
    ...
    public ListConnectorDefinitionsResult withDefinitions(java.util.Collection<DefinitionInformation> definitions) {
    ...
    public ListConnectorDefinitionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListConnectorDefinitionsResult == false)
            return false;
        ListConnectorDefinitionsResult other = (ListConnectorDefinitionsResult) obj;
    ...
    @Override
    public ListConnectorDefinitionsResult clone() {
        try {
            return (ListConnectorDefinitionsResult) super.clone();
