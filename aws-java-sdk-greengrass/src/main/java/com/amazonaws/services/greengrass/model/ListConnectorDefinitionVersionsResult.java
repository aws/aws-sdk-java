...
public class ListConnectorDefinitionVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public ListConnectorDefinitionVersionsResult withNextToken(String nextToken) {
    ...
    public ListConnectorDefinitionVersionsResult withVersions(VersionInformation... versions) {
    ...
    public ListConnectorDefinitionVersionsResult withVersions(java.util.Collection<VersionInformation> versions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListConnectorDefinitionVersionsResult == false)
            return false;
        ListConnectorDefinitionVersionsResult other = (ListConnectorDefinitionVersionsResult) obj;
    ...
    @Override
    public ListConnectorDefinitionVersionsResult clone() {
        try {
            return (ListConnectorDefinitionVersionsResult) super.clone();
