...
public class CreateDeviceDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateDeviceDefinitionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreateDeviceDefinitionResult withCreationTimestamp(String creationTimestamp) {
    ...
    public CreateDeviceDefinitionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public CreateDeviceDefinitionResult withLastUpdatedTimestamp(String lastUpdatedTimestamp) {
    ...
    public CreateDeviceDefinitionResult withLatestVersion(String latestVersion) {
    ...
    public CreateDeviceDefinitionResult withLatestVersionArn(String latestVersionArn) {
    ...
    public CreateDeviceDefinitionResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDeviceDefinitionResult == false)
            return false;
        CreateDeviceDefinitionResult other = (CreateDeviceDefinitionResult) obj;
    ...
    @Override
    public CreateDeviceDefinitionResult clone() {
        try {
            return (CreateDeviceDefinitionResult) super.clone();
