...
/**
 * CreateSubscriptionDefinitionVersionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateSubscriptionDefinitionVersionRequestMarshaller {
    ...
    private static final CreateSubscriptionDefinitionVersionRequestMarshaller instance = new CreateSubscriptionDefinitionVersionRequestMarshaller();

    public static CreateSubscriptionDefinitionVersionRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(CreateSubscriptionDefinitionVersionRequest createSubscriptionDefinitionVersionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createSubscriptionDefinitionVersionRequest.getAmznClientToken(), AMZNCLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createSubscriptionDefinitionVersionRequest.getSubscriptionDefinitionId(), SUBSCRIPTIONDEFINITIONID_BINDING);
            protocolMarshaller.marshall(createSubscriptionDefinitionVersionRequest.getSubscriptions(), SUBSCRIPTIONS_BINDING);
        } catch (Exception e) {
