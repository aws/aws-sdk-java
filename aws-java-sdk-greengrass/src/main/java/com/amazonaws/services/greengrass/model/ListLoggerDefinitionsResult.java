...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/greengrass-2017-06-07/ListLoggerDefinitions" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListLoggerDefinitionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListLoggerDefinitionsResult withDefinitions(DefinitionInformation... definitions) {
    ...
    public ListLoggerDefinitionsResult withDefinitions(java.util.Collection<DefinitionInformation> definitions) {
    ...
    public ListLoggerDefinitionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLoggerDefinitionsResult == false)
            return false;
        ListLoggerDefinitionsResult other = (ListLoggerDefinitionsResult) obj;
    ...
    @Override
    public ListLoggerDefinitionsResult clone() {
        try {
            return (ListLoggerDefinitionsResult) super.clone();
