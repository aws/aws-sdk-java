...
public class GetSubscriptionDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetSubscriptionDefinitionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public GetSubscriptionDefinitionResult withCreationTimestamp(String creationTimestamp) {
    ...
    public GetSubscriptionDefinitionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public GetSubscriptionDefinitionResult withLastUpdatedTimestamp(String lastUpdatedTimestamp) {
    ...
    public GetSubscriptionDefinitionResult withLatestVersion(String latestVersion) {
    ...
    public GetSubscriptionDefinitionResult withLatestVersionArn(String latestVersionArn) {
    ...
    public GetSubscriptionDefinitionResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public GetSubscriptionDefinitionResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see GetSubscriptionDefinitionResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetSubscriptionDefinitionResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public GetSubscriptionDefinitionResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSubscriptionDefinitionResult == false)
            return false;
        GetSubscriptionDefinitionResult other = (GetSubscriptionDefinitionResult) obj;
    ...
    @Override
    public GetSubscriptionDefinitionResult clone() {
        try {
            return (GetSubscriptionDefinitionResult) super.clone();
