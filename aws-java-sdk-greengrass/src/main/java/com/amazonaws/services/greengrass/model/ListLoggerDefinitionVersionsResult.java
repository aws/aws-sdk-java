...
public class ListLoggerDefinitionVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListLoggerDefinitionVersionsResult withNextToken(String nextToken) {
    ...
    public ListLoggerDefinitionVersionsResult withVersions(VersionInformation... versions) {
    ...
    public ListLoggerDefinitionVersionsResult withVersions(java.util.Collection<VersionInformation> versions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLoggerDefinitionVersionsResult == false)
            return false;
        ListLoggerDefinitionVersionsResult other = (ListLoggerDefinitionVersionsResult) obj;
    ...
    @Override
    public ListLoggerDefinitionVersionsResult clone() {
        try {
            return (ListLoggerDefinitionVersionsResult) super.clone();
