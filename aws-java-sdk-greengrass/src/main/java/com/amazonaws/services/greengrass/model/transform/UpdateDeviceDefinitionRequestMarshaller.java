...
/**
 * UpdateDeviceDefinitionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateDeviceDefinitionRequestMarshaller {
    ...
    private static final UpdateDeviceDefinitionRequestMarshaller instance = new UpdateDeviceDefinitionRequestMarshaller();

    public static UpdateDeviceDefinitionRequestMarshaller getInstance() {
        return instance;
    }
