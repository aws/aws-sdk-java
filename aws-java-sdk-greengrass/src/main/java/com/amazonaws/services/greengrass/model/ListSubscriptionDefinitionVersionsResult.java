...
public class ListSubscriptionDefinitionVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public ListSubscriptionDefinitionVersionsResult withNextToken(String nextToken) {
    ...
    public ListSubscriptionDefinitionVersionsResult withVersions(VersionInformation... versions) {
    ...
    public ListSubscriptionDefinitionVersionsResult withVersions(java.util.Collection<VersionInformation> versions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSubscriptionDefinitionVersionsResult == false)
            return false;
        ListSubscriptionDefinitionVersionsResult other = (ListSubscriptionDefinitionVersionsResult) obj;
    ...
    @Override
    public ListSubscriptionDefinitionVersionsResult clone() {
        try {
            return (ListSubscriptionDefinitionVersionsResult) super.clone();
