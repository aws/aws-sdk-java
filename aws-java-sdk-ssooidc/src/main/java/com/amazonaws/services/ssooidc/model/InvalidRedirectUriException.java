...
public class InvalidRedirectUriException extends com.amazonaws.services.ssooidc.model.AWSSSOOIDCException {
    private static final long serialVersionUID = 1L;

    /**
     * <p>
     * Single error code. For this exception the value will be <code>invalid_redirect_uri</code>.
     * </p>
     */
    ...
    /**
     * Constructs a new InvalidRedirectUriException with the specified error message.
     *
     * @param message
     ...
     * </p>
     * 
     * @return Single error code. For this exception the value will be <code>invalid_redirect_uri</code>.
     */
    ...
    public InvalidRedirectUriException withError(String error) {
        setError(error);
        return this;
    }
    ...
    public InvalidRedirectUriException withError_description(String error_description) {
