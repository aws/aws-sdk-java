...
public class UnauthorizedClientException extends com.amazonaws.services.ssooidc.model.AWSSSOOIDCException {
    ...
    public UnauthorizedClientException withError(String error) {
        setError(error);
        return this;
    }
    ...
    public UnauthorizedClientException withError_description(String error_description) {
