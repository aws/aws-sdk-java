...
public class RequestedRangeNotSatisfiableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RequestedRangeNotSatisfiableExceptionUnmarshaller instance;

    public static RequestedRangeNotSatisfiableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RequestedRangeNotSatisfiableExceptionUnmarshaller();
        return instance;
    }
}
