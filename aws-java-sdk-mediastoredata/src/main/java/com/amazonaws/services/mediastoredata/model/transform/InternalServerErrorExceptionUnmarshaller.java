...
public class InternalServerErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerErrorExceptionUnmarshaller() {
        super(com.amazonaws.services.mediastoredata.model.InternalServerErrorException.class, "InternalServerError");
    }

    @Override
    public com.amazonaws.services.mediastoredata.model.InternalServerErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
