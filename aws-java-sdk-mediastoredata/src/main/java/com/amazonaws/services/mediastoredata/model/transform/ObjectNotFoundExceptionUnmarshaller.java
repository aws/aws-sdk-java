...
public class ObjectNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ObjectNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.mediastoredata.model.ObjectNotFoundException.class, "ObjectNotFoundException");
    }

    @Override
    public com.amazonaws.services.mediastoredata.model.ObjectNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
