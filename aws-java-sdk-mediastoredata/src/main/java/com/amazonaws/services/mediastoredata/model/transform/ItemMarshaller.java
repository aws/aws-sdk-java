...
public class ItemMarshaller {
    ...
    public void marshall(Item item, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(item.getName(), NAME_BINDING);
            protocolMarshaller.marshall(item.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(item.getETag(), ETAG_BINDING);
            protocolMarshaller.marshall(item.getLastModified(), LASTMODIFIED_BINDING);
            protocolMarshaller.marshall(item.getContentType(), CONTENTTYPE_BINDING);
            protocolMarshaller.marshall(item.getContentLength(), CONTENTLENGTH_BINDING);
        } catch (Exception e) {
