...
/**
 * DisableGatewayRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DisableGatewayRequestMarshaller {
    ...
    private static final DisableGatewayRequestMarshaller instance = new DisableGatewayRequestMarshaller();

    public static DisableGatewayRequestMarshaller getInstance() {
        return instance;
    }
