...
public class UpdateSMBFileShareResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSMBFileShareResult == false)
            return false;
        UpdateSMBFileShareResult other = (UpdateSMBFileShareResult) obj;
    ...
    public UpdateSMBFileShareResult clone() {
        try {
            return (UpdateSMBFileShareResult) super.clone();
