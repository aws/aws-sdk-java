...
/**
 * DescribeCacheRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeCacheRequestMarshaller {
    ...
    private static final DescribeCacheRequestMarshaller instance = new DescribeCacheRequestMarshaller();

    public static DescribeCacheRequestMarshaller getInstance() {
        return instance;
    }
