...
public class TapeArchiveMarshaller {
    ...
    public void marshall(TapeArchive tapeArchive, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(tapeArchive.getWorm(), WORM_BINDING);
            protocolMarshaller.marshall(tapeArchive.getRetentionStartDate(), RETENTIONSTARTDATE_BINDING);
            protocolMarshaller.marshall(tapeArchive.getPoolEntryDate(), POOLENTRYDATE_BINDING);
        } catch (Exception e) {
