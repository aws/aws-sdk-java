    ...
    public void marshall(GatewayInfo gatewayInfo, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (gatewayInfo.getGatewayId() != null) {
                jsonGenerator.writeFieldName("GatewayId").writeValue(gatewayInfo.getGatewayId());
            }
            if (gatewayInfo.getGatewayARN() != null) {
                jsonGenerator.writeFieldName("GatewayARN").writeValue(gatewayInfo.getGatewayARN());
            }
            if (gatewayInfo.getGatewayType() != null) {
                jsonGenerator.writeFieldName("GatewayType").writeValue(gatewayInfo.getGatewayType());
            }
            if (gatewayInfo.getGatewayOperationalState() != null) {
                jsonGenerator.writeFieldName("GatewayOperationalState").writeValue(gatewayInfo.getGatewayOperationalState());
            }
            if (gatewayInfo.getGatewayName() != null) {
                jsonGenerator.writeFieldName("GatewayName").writeValue(gatewayInfo.getGatewayName());
            }
