...
public class ListTapesResultJsonUnmarshaller implements
    ...
    public ListTapesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TapeInfos", targetDepth)) {
                    context.nextToken();
                    listTapesResult
                            .setTapeInfos(new ListUnmarshaller<TapeInfo>(
                                    TapeInfoJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("Marker", targetDepth)) {
                    context.nextToken();
                    listTapesResult.setMarker(context.getUnmarshaller(
