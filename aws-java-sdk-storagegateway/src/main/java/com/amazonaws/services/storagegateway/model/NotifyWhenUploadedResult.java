...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/storagegateway-2013-06-30/NotifyWhenUploaded" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NotifyWhenUploadedResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public NotifyWhenUploadedResult withFileShareARN(String fileShareARN) {
    ...
    public NotifyWhenUploadedResult withNotificationId(String notificationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NotifyWhenUploadedResult == false)
            return false;
        NotifyWhenUploadedResult other = (NotifyWhenUploadedResult) obj;
    ...
    @Override
    public NotifyWhenUploadedResult clone() {
        try {
            return (NotifyWhenUploadedResult) super.clone();
