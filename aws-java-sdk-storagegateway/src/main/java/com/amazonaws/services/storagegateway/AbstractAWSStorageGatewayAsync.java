...
public class AbstractAWSStorageGatewayAsync extends AbstractAWSStorageGateway
    ...
    @Override
    public java.util.concurrent.Future<ActivateGatewayResult> activateGatewayAsync(
    ...
    @Override
    public java.util.concurrent.Future<AddCacheResult> addCacheAsync(
    ...
    @Override
    public java.util.concurrent.Future<AddUploadBufferResult> addUploadBufferAsync(
    ...
    @Override
    public java.util.concurrent.Future<AddWorkingStorageResult> addWorkingStorageAsync(
    ...
    @Override
    public java.util.concurrent.Future<CancelArchivalResult> cancelArchivalAsync(
    ...
    @Override
    public java.util.concurrent.Future<CancelRetrievalResult> cancelRetrievalAsync(
    ...
    @Override
    public java.util.concurrent.Future<CreateCachediSCSIVolumeResult> createCachediSCSIVolumeAsync(
    ...
    @Override
    public java.util.concurrent.Future<CreateStorediSCSIVolumeResult> createStorediSCSIVolumeAsync(
    ...
    @Override
    public java.util.concurrent.Future<DeleteBandwidthRateLimitResult> deleteBandwidthRateLimitAsync(
    ...
    @Override
    public java.util.concurrent.Future<DeleteChapCredentialsResult> deleteChapCredentialsAsync(
    ...
    @Override
    public java.util.concurrent.Future<DeleteGatewayResult> deleteGatewayAsync(
    ...
    @Override
    public java.util.concurrent.Future<DeleteSnapshotScheduleResult> deleteSnapshotScheduleAsync(
    ...
    @Override
    public java.util.concurrent.Future<DeleteTapeResult> deleteTapeAsync(
    ...
    @Override
    public java.util.concurrent.Future<DeleteTapeArchiveResult> deleteTapeArchiveAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeBandwidthRateLimitResult> describeBandwidthRateLimitAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeCacheResult> describeCacheAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeCachediSCSIVolumesResult> describeCachediSCSIVolumesAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeChapCredentialsResult> describeChapCredentialsAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeGatewayInformationResult> describeGatewayInformationAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeMaintenanceStartTimeResult> describeMaintenanceStartTimeAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeSnapshotScheduleResult> describeSnapshotScheduleAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeStorediSCSIVolumesResult> describeStorediSCSIVolumesAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeTapeRecoveryPointsResult> describeTapeRecoveryPointsAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeTapesResult> describeTapesAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeUploadBufferResult> describeUploadBufferAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeVTLDevicesResult> describeVTLDevicesAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeWorkingStorageResult> describeWorkingStorageAsync(
    ...
    @Override
    public java.util.concurrent.Future<DisableGatewayResult> disableGatewayAsync(
    ...
    @Override
    public java.util.concurrent.Future<ListLocalDisksResult> listLocalDisksAsync(
    ...
    @Override
    public java.util.concurrent.Future<ListVolumeRecoveryPointsResult> listVolumeRecoveryPointsAsync(
    ...
    @Override
    public java.util.concurrent.Future<ListVolumesResult> listVolumesAsync(
    ...
    @Override
    public java.util.concurrent.Future<ResetCacheResult> resetCacheAsync(
    ...
    @Override
    public java.util.concurrent.Future<RetrieveTapeArchiveResult> retrieveTapeArchiveAsync(
    ...
    @Override
    public java.util.concurrent.Future<StartGatewayResult> startGatewayAsync(
    ...
    @Override
    public java.util.concurrent.Future<UpdateBandwidthRateLimitResult> updateBandwidthRateLimitAsync(
    ...
    @Override
    public java.util.concurrent.Future<UpdateChapCredentialsResult> updateChapCredentialsAsync(
    ...
    @Override
    public java.util.concurrent.Future<UpdateGatewayInformationResult> updateGatewayInformationAsync(
    ...
    @Override
    public java.util.concurrent.Future<UpdateGatewaySoftwareNowResult> updateGatewaySoftwareNowAsync(
    ...
    @Override
    public java.util.concurrent.Future<UpdateMaintenanceStartTimeResult> updateMaintenanceStartTimeAsync(
    ...
    @Override
    public java.util.concurrent.Future<UpdateSnapshotScheduleResult> updateSnapshotScheduleAsync(
    ...
    @Override
    public java.util.concurrent.Future<UpdateVTLDeviceTypeResult> updateVTLDeviceTypeAsync(
