...
/**
 * NotifyWhenUploadedRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class NotifyWhenUploadedRequestMarshaller {
    ...
    private static final NotifyWhenUploadedRequestMarshaller instance = new NotifyWhenUploadedRequestMarshaller();

    public static NotifyWhenUploadedRequestMarshaller getInstance() {
        return instance;
    }
