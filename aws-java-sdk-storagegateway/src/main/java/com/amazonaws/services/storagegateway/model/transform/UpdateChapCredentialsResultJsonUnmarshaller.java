 ...
 */
public class UpdateChapCredentialsResultJsonUnmarshaller implements
        Unmarshaller<UpdateChapCredentialsResult, JsonUnmarshallerContext> {

    public UpdateChapCredentialsResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TargetARN", targetDepth)) {
                    context.nextToken();
                    updateChapCredentialsResult.setTargetARN(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("InitiatorName", targetDepth)) {
                    context.nextToken();
                    updateChapCredentialsResult.setInitiatorName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
