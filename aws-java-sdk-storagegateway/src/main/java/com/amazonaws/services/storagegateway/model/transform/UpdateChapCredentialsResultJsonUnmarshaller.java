...
public class UpdateChapCredentialsResultJsonUnmarshaller implements Unmarshaller<UpdateChapCredentialsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TargetARN", targetDepth)) {
                    context.nextToken();
                    updateChapCredentialsResult.setTargetARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("InitiatorName", targetDepth)) {
                    context.nextToken();
                    updateChapCredentialsResult.setInitiatorName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static UpdateChapCredentialsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateChapCredentialsResultJsonUnmarshaller();
        return instance;
    }
}
