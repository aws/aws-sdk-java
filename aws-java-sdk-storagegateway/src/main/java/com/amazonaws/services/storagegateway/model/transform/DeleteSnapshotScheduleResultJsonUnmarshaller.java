 ...
 */
public class DeleteSnapshotScheduleResultJsonUnmarshaller implements
        Unmarshaller<DeleteSnapshotScheduleResult, JsonUnmarshallerContext> {

    public DeleteSnapshotScheduleResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("VolumeARN", targetDepth)) {
                    context.nextToken();
                    deleteSnapshotScheduleResult.setVolumeARN(context
    ...
    public static DeleteSnapshotScheduleResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeleteSnapshotScheduleResultJsonUnmarshaller();
        return instance;
    }
}
