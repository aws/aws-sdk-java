...
public class ListVolumeRecoveryPointsRequestMarshaller implements Marshaller<Request<ListVolumeRecoveryPointsRequest>, ListVolumeRecoveryPointsRequest> {
    ...
    public Request<ListVolumeRecoveryPointsRequest> marshall(ListVolumeRecoveryPointsRequest listVolumeRecoveryPointsRequest) {
        ...
        Request<ListVolumeRecoveryPointsRequest> request = new DefaultRequest<ListVolumeRecoveryPointsRequest>(listVolumeRecoveryPointsRequest,
                "AWSStorageGateway");
        request.addHeader("X-Amz-Target", "StorageGateway_20130630.ListVolumeRecoveryPoints");
        ...
        try {
            ...
            if (listVolumeRecoveryPointsRequest.getGatewayARN() != null) {
                jsonGenerator.writeFieldName("GatewayARN").writeValue(listVolumeRecoveryPointsRequest.getGatewayARN());
            }
