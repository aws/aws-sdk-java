 ...
 */
public class VolumeRecoveryPointInfoJsonUnmarshaller implements
        Unmarshaller<VolumeRecoveryPointInfo, JsonUnmarshallerContext> {
    ...
    public static VolumeRecoveryPointInfoJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new VolumeRecoveryPointInfoJsonUnmarshaller();
        return instance;
    }
}
