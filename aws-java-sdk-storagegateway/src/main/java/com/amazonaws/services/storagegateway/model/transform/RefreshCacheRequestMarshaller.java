...
@SdkInternalApi
public class RefreshCacheRequestMarshaller {
    ...
    public static RefreshCacheRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RefreshCacheRequest refreshCacheRequest, ProtocolMarshaller protocolMarshaller) {
