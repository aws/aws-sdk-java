 ...
 * 
 */
public class ListVolumesResult extends
    ...
    public void setVolumeInfos(java.util.Collection<VolumeInfo> volumeInfos) {
        ...
        this.volumeInfos = new com.amazonaws.internal.SdkInternalList<VolumeInfo>(
                volumeInfos);
    }
     ...
     * any). Use {@link #setVolumeInfos(java.util.Collection)} or
     * {@link #withVolumeInfos(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param volumeInfos
