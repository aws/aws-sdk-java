...
public class ListGatewaysRequestMarshaller implements
    ...
    public ListGatewaysRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<ListGatewaysRequest> marshall(
        ...
        Request<ListGatewaysRequest> request = new DefaultRequest<ListGatewaysRequest>(
                listGatewaysRequest, "AWSStorageGateway");
