...
/**
 * AssignTapePoolResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssignTapePoolResultJsonUnmarshaller implements Unmarshaller<AssignTapePoolResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TapeARN", targetDepth)) {
                    context.nextToken();
                    assignTapePoolResult.setTapeARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
