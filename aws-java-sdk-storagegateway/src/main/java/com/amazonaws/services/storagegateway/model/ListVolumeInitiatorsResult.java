 ...
 * </p>
 */
public class ListVolumeInitiatorsResult extends
    ...
    public void setInitiators(java.util.Collection<String> initiators) {
        ...
        this.initiators = new com.amazonaws.internal.SdkInternalList<String>(
                initiators);
    }
     ...
     * any). Use {@link #setInitiators(java.util.Collection)} or
     * {@link #withInitiators(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param initiators
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getInitiators() == null) ? 0 : getInitiators().hashCode());
        return hashCode;
    }
