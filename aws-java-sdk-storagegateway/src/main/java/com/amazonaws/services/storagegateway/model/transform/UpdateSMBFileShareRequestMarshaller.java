...
public class UpdateSMBFileShareRequestMarshaller {
    ...
    public void marshall(UpdateSMBFileShareRequest updateSMBFileShareRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateSMBFileShareRequest.getAccessBasedEnumeration(), ACCESSBASEDENUMERATION_BINDING);
            ...
            protocolMarshaller.marshall(updateSMBFileShareRequest.getNotificationPolicy(), NOTIFICATIONPOLICY_BINDING);
            protocolMarshaller.marshall(updateSMBFileShareRequest.getOplocksEnabled(), OPLOCKSENABLED_BINDING);
        } catch (Exception e) {
