 ...
 */
public class AddCacheResultJsonUnmarshaller implements
        Unmarshaller<AddCacheResult, JsonUnmarshallerContext> {

    public AddCacheResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    addCacheResult.setGatewayARN(context.getUnmarshaller(
