...
public class DescribeVTLDevicesResultJsonUnmarshaller implements Unmarshaller<DescribeVTLDevicesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    context.nextToken();
                    describeVTLDevicesResult.setMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DescribeVTLDevicesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeVTLDevicesResultJsonUnmarshaller();
        return instance;
    }
}
