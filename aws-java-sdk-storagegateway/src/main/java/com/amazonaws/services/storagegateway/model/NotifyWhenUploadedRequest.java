...
public class NotifyWhenUploadedRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public NotifyWhenUploadedRequest clone() {
        return (NotifyWhenUploadedRequest) super.clone();
    }
