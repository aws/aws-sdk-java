...
public class CreateSnapshotResultJsonUnmarshaller implements Unmarshaller<CreateSnapshotResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("VolumeARN", targetDepth)) {
                    context.nextToken();
                    createSnapshotResult.setVolumeARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("SnapshotId", targetDepth)) {
                    context.nextToken();
                    createSnapshotResult.setSnapshotId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CreateSnapshotResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreateSnapshotResultJsonUnmarshaller();
        return instance;
    }
}
