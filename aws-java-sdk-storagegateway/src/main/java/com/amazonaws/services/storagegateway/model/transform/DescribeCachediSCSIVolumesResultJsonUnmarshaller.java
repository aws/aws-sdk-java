 ...
 */
public class DescribeCachediSCSIVolumesResultJsonUnmarshaller implements
        Unmarshaller<DescribeCachediSCSIVolumesResult, JsonUnmarshallerContext> {

    public DescribeCachediSCSIVolumesResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CachediSCSIVolumes", targetDepth)) {
                    ...
                    describeCachediSCSIVolumesResult
                            .setCachediSCSIVolumes(new ListUnmarshaller<CachediSCSIVolume>(
