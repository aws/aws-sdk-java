...
public class CreateSnapshotFromVolumeRecoveryPointRequestMarshaller
    ...
    public CreateSnapshotFromVolumeRecoveryPointRequestMarshaller(
    ...
    public Request<CreateSnapshotFromVolumeRecoveryPointRequest> marshall(
        ...
        try {
            ...
            if (createSnapshotFromVolumeRecoveryPointRequest
                    .getSnapshotDescription() != null) {
                jsonGenerator.writeFieldName("SnapshotDescription").writeValue(
                        createSnapshotFromVolumeRecoveryPointRequest
