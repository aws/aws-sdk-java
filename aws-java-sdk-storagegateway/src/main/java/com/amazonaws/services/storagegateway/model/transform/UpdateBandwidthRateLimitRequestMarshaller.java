        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (updateBandwidthRateLimitRequest.getGatewayARN() != null) {
                jsonWriter.key("GatewayARN").value(updateBandwidthRateLimitRequest.getGatewayARN());
            }
            if (updateBandwidthRateLimitRequest.getAverageUploadRateLimitInBitsPerSec() != null) {
                jsonWriter.key("AverageUploadRateLimitInBitsPerSec").value(updateBandwidthRateLimitRequest.getAverageUploadRateLimitInBitsPerSec());
            }
            if (updateBandwidthRateLimitRequest.getAverageDownloadRateLimitInBitsPerSec() != null) {
                jsonWriter.key("AverageDownloadRateLimitInBitsPerSec").value(updateBandwidthRateLimitRequest.getAverageDownloadRateLimitInBitsPerSec());
            }
