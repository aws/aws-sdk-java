...
public class UpdateBandwidthRateLimitRequestMarshaller {
    ...
    private static final UpdateBandwidthRateLimitRequestMarshaller instance = new UpdateBandwidthRateLimitRequestMarshaller();

    public static UpdateBandwidthRateLimitRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateBandwidthRateLimitRequest updateBandwidthRateLimitRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateBandwidthRateLimitRequest.getGatewayARN(), GATEWAYARN_BINDING);
            protocolMarshaller.marshall(updateBandwidthRateLimitRequest.getAverageUploadRateLimitInBitsPerSec(), AVERAGEUPLOADRATELIMITINBITSPERSEC_BINDING);
            protocolMarshaller
                    .marshall(updateBandwidthRateLimitRequest.getAverageDownloadRateLimitInBitsPerSec(), AVERAGEDOWNLOADRATELIMITINBITSPERSEC_BINDING);
        } catch (Exception e) {
