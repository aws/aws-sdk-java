...
public class UpdateBandwidthRateLimitRequestMarshaller
        implements
        Marshaller<Request<UpdateBandwidthRateLimitRequest>, UpdateBandwidthRateLimitRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public UpdateBandwidthRateLimitRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<UpdateBandwidthRateLimitRequest> marshall(
        ...
        Request<UpdateBandwidthRateLimitRequest> request = new DefaultRequest<UpdateBandwidthRateLimitRequest>(
                updateBandwidthRateLimitRequest, "AWSStorageGateway");
        ...
        try {
            ...
            if (updateBandwidthRateLimitRequest
                ...
                jsonGenerator.writeFieldName(
                        "AverageUploadRateLimitInBitsPerSec").writeValue(
            ...
            if (updateBandwidthRateLimitRequest
                ...
                jsonGenerator.writeFieldName(
                        "AverageDownloadRateLimitInBitsPerSec").writeValue(
                        updateBandwidthRateLimitRequest
