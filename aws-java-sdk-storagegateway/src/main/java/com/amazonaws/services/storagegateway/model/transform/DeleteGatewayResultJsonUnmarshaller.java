 ...
 */
public class DeleteGatewayResultJsonUnmarshaller implements
        Unmarshaller<DeleteGatewayResult, JsonUnmarshallerContext> {

    public DeleteGatewayResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    deleteGatewayResult.setGatewayARN(context.getUnmarshaller(
