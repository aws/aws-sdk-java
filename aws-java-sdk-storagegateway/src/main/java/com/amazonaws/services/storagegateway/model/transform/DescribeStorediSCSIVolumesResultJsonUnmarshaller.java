 ...
 */
public class DescribeStorediSCSIVolumesResultJsonUnmarshaller implements
        Unmarshaller<DescribeStorediSCSIVolumesResult, JsonUnmarshallerContext> {

    public DescribeStorediSCSIVolumesResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StorediSCSIVolumes", targetDepth)) {
                    ...
                    describeStorediSCSIVolumesResult
                            .setStorediSCSIVolumes(new ListUnmarshaller<StorediSCSIVolume>(
