...
public class DeleteChapCredentialsResultJsonUnmarshaller implements Unmarshaller<DeleteChapCredentialsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TargetARN", targetDepth)) {
                    context.nextToken();
                    deleteChapCredentialsResult.setTargetARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("InitiatorName", targetDepth)) {
                    context.nextToken();
                    deleteChapCredentialsResult.setInitiatorName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DeleteChapCredentialsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteChapCredentialsResultJsonUnmarshaller();
        return instance;
    }
}
