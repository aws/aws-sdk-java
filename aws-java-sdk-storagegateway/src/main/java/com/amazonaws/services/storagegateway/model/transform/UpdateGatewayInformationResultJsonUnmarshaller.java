 ...
 */
public class UpdateGatewayInformationResultJsonUnmarshaller implements
        Unmarshaller<UpdateGatewayInformationResult, JsonUnmarshallerContext> {

    public UpdateGatewayInformationResult unmarshall(
