...
public class UpdateGatewayInformationResultJsonUnmarshaller implements Unmarshaller<UpdateGatewayInformationResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    updateGatewayInformationResult.setGatewayARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("GatewayName", targetDepth)) {
                    context.nextToken();
                    updateGatewayInformationResult.setGatewayName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static UpdateGatewayInformationResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateGatewayInformationResultJsonUnmarshaller();
        return instance;
    }
}
