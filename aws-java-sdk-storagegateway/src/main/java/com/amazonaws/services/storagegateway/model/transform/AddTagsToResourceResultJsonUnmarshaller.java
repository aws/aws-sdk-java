...
/**
 * Add Tags To Resource Result JSON Unmarshaller
 */
public class AddTagsToResourceResultJsonUnmarshaller implements Unmarshaller<AddTagsToResourceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceARN", targetDepth)) {
                    context.nextToken();
                    addTagsToResourceResult.setResourceARN(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static AddTagsToResourceResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AddTagsToResourceResultJsonUnmarshaller();
        return instance;
    }
}
