 ...
 */
public class ApplicationVersionDescriptionStaxUnmarshaller implements
        Unmarshaller<ApplicationVersionDescription, StaxUnmarshallerContext> {

    public ApplicationVersionDescription unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("SourceBundle", targetDepth)) {
                    applicationVersionDescription
                            .setSourceBundle(S3LocationStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
