 ...
 */
public class DescribeEnvironmentManagedActionsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeEnvironmentManagedActionsResult, StaxUnmarshallerContext> {

    public DescribeEnvironmentManagedActionsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context
                        .testExpression("ManagedActions/member", targetDepth)) {
                    describeEnvironmentManagedActionsResult
                            .withManagedActions(ManagedActionStaxUnmarshaller
