 ...
 */
public class ConfigurationSettingsDescriptionStaxUnmarshaller implements
        Unmarshaller<ConfigurationSettingsDescription, StaxUnmarshallerContext> {

    public ConfigurationSettingsDescription unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context
                    ...
                    configurationSettingsDescription.getOptionSettings().add(
