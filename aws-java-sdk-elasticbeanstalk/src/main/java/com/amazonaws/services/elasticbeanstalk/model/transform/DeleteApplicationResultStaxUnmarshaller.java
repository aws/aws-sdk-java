 ...
 */
public class DeleteApplicationResultStaxUnmarshaller implements
        Unmarshaller<DeleteApplicationResult, StaxUnmarshallerContext> {

    public DeleteApplicationResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
