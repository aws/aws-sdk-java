 ...
 */
public class SystemStatusStaxUnmarshaller implements
        Unmarshaller<SystemStatus, StaxUnmarshallerContext> {

    public SystemStatus unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("CPUUtilization", targetDepth)) {
                    systemStatus
                            .setCPUUtilization(CPUUtilizationStaxUnmarshaller
