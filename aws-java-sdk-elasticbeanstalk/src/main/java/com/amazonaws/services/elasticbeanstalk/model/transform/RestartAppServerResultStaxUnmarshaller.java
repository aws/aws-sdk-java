 ...
 */
public class RestartAppServerResultStaxUnmarshaller implements
        Unmarshaller<RestartAppServerResult, StaxUnmarshallerContext> {

    public RestartAppServerResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
