 ...
 */
public class SourceConfigurationStaxUnmarshaller implements
        Unmarshaller<SourceConfiguration, StaxUnmarshallerContext> {

    public SourceConfiguration unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("TemplateName", targetDepth)) {
                    sourceConfiguration.setTemplateName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
