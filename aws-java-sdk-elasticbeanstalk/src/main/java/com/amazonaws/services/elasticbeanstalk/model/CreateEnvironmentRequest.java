 ...
 * <p/>
 */
public class CreateEnvironmentRequest extends AmazonWebServiceRequest implements
    ...
    /**
     * Default constructor for CreateEnvironmentRequest object. Callers should
    ...
    /**
     * Constructs a new CreateEnvironmentRequest object. Callers should use the
     ...
     * </p>
     * 
     * @return The name of the application that contains the version to be
     *         deployed. </p>
     *         <p>
     *         If no application is found with this name,
     *         <code>CreateEnvironment</code> returns an
     ...
     * </p>
     * 
     * @return If specified, the environment attempts to use this value as the
     *         prefix for the CNAME. If not specified, the CNAME is generated
     *         automatically by appending a random alphanumeric string to the
     *         environment name.
     */
     ...
     *        versions, AWS Elastic Beanstalk <code>UpdateEnvironment</code>
     *        returns an <code>InvalidParameterValue</code> error.
     *        </p>
     *        <p>
     ...
     *        <p>
     *        Condition: You must specify either this parameter or a
     *        <code>SolutionStackName</code>, but not both. If you specify both,
     ...
     * </p>
     * 
     * @return The name of the configuration template to use in deployment. If
     *         no configuration template is found with this name, AWS Elastic
     *         Beanstalk returns an <code>InvalidParameterValue</code> error.
     *         </p>
     *         <p>
     *         Condition: You must specify either this parameter or a
     *         <code>SolutionStackName</code>, but not both. If you specify
