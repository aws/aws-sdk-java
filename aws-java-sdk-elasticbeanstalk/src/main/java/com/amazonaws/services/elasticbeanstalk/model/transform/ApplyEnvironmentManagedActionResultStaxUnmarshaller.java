 ...
 */
public class ApplyEnvironmentManagedActionResultStaxUnmarshaller
        implements
        Unmarshaller<ApplyEnvironmentManagedActionResult, StaxUnmarshallerContext> {

    public ApplyEnvironmentManagedActionResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ActionId", targetDepth)) {
                    applyEnvironmentManagedActionResult
                            .setActionId(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("ActionDescription", targetDepth)) {
                    applyEnvironmentManagedActionResult
                            .setActionDescription(StringStaxUnmarshaller
                ...
                if (context.testExpression("ActionType", targetDepth)) {
                    applyEnvironmentManagedActionResult
                            .setActionType(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
