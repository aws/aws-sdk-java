 ...
 */
public class DescribeConfigurationSettingsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeConfigurationSettingsResult, StaxUnmarshallerContext> {

    public DescribeConfigurationSettingsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ConfigurationSettings/member",
                        targetDepth)) {
                    describeConfigurationSettingsResult
                            .getConfigurationSettings().add(
