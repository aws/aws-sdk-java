...
class EnvironmentTerminated {
    ...
    static class IsTerminatedMatcher extends WaiterAcceptor<DescribeEnvironmentsResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("Environments")),
         ...
         */
        @Override
        public boolean matches(DescribeEnvironmentsResult result) {
    ...
    static class IsTerminatingMatcher extends WaiterAcceptor<DescribeEnvironmentsResult> {
        private static final JsonNode expectedResult;
