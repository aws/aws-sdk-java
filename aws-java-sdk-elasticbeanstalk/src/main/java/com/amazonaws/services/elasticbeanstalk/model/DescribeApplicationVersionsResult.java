...
public class DescribeApplicationVersionsResult implements Serializable,
    ...
    public void setApplicationVersions(
        ...
        this.applicationVersions = new com.amazonaws.internal.SdkInternalList<ApplicationVersionDescription>(
                applicationVersions);
    }
     ...
     * any). Use {@link #setApplicationVersions(java.util.Collection)} or
     * {@link #withApplicationVersions(java.util.Collection)} if you want to
    ...
    public DescribeApplicationVersionsResult withApplicationVersions(
        ...
        if (this.applicationVersions == null) {
            setApplicationVersions(new com.amazonaws.internal.SdkInternalList<ApplicationVersionDescription>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getApplicationVersions() == null
                ^ this.getApplicationVersions() == null)
            return false;
        if (other.getApplicationVersions() != null
                && other.getApplicationVersions().equals(
                        this.getApplicationVersions()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getApplicationVersions() == null) ? 0
                        : getApplicationVersions().hashCode());
        return hashCode;
    }
