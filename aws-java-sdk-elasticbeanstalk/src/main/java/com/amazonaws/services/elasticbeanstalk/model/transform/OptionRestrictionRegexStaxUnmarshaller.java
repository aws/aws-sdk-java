 ...
 */
public class OptionRestrictionRegexStaxUnmarshaller implements
        Unmarshaller<OptionRestrictionRegex, StaxUnmarshallerContext> {

    public OptionRestrictionRegex unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Pattern", targetDepth)) {
                    optionRestrictionRegex.setPattern(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Label", targetDepth)) {
                    optionRestrictionRegex.setLabel(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
