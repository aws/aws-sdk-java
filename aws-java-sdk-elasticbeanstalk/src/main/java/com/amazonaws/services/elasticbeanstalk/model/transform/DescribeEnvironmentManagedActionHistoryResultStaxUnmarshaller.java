 ...
 */
public class DescribeEnvironmentManagedActionHistoryResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeEnvironmentManagedActionHistoryResult, StaxUnmarshallerContext> {

    public DescribeEnvironmentManagedActionHistoryResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ManagedActionHistoryItems/member",
                        targetDepth)) {
