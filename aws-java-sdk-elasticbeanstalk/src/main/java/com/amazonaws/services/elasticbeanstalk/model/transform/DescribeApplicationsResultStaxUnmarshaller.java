 ...
 */
public class DescribeApplicationsResultStaxUnmarshaller implements
        Unmarshaller<DescribeApplicationsResult, StaxUnmarshallerContext> {

    public DescribeApplicationsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Applications/member", targetDepth)) {
                    describeApplicationsResult
                            .withApplications(ApplicationDescriptionStaxUnmarshaller
