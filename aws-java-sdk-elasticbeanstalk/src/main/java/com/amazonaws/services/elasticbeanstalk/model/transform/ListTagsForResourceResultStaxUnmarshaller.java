        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ResourceArn", targetDepth)) {
                    listTagsForResourceResult.setResourceArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ResourceTags", targetDepth)) {
                    listTagsForResourceResult.withResourceTags(new ArrayList<Tag>());
                    continue;
                }

                if (context.testExpression("ResourceTags/member", targetDepth)) {
                    listTagsForResourceResult.withResourceTags(TagStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
