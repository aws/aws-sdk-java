 ...
 */
public class UpdateApplicationVersionResultStaxUnmarshaller implements
        Unmarshaller<UpdateApplicationVersionResult, StaxUnmarshallerContext> {

    public UpdateApplicationVersionResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ApplicationVersion", targetDepth)) {
                    updateApplicationVersionResult
                            .setApplicationVersion(ApplicationVersionDescriptionStaxUnmarshaller
