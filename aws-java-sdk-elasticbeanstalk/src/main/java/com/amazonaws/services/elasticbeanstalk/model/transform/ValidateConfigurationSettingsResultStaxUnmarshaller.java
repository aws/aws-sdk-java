 ...
 */
public class ValidateConfigurationSettingsResultStaxUnmarshaller
        implements
        Unmarshaller<ValidateConfigurationSettingsResult, StaxUnmarshallerContext> {

    public ValidateConfigurationSettingsResult unmarshall(
