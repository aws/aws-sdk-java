 ...
 */
public class DescribeConfigurationOptionsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeConfigurationOptionsResult, StaxUnmarshallerContext> {

    public DescribeConfigurationOptionsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Options/member", targetDepth)) {
                    describeConfigurationOptionsResult
                            .withOptions(ConfigurationOptionDescriptionStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
