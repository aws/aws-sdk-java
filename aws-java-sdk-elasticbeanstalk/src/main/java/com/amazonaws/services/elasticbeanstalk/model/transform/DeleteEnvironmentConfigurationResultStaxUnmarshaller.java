 ...
 */
public class DeleteEnvironmentConfigurationResultStaxUnmarshaller
        implements
        Unmarshaller<DeleteEnvironmentConfigurationResult, StaxUnmarshallerContext> {

    public DeleteEnvironmentConfigurationResult unmarshall(
