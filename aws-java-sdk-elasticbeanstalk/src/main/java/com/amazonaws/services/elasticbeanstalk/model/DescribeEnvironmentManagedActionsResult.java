 ...
 * </p>
 */
public class DescribeEnvironmentManagedActionsResult extends
    ...
    public void setManagedActions(
        ...
        this.managedActions = new com.amazonaws.internal.SdkInternalList<ManagedAction>(
                managedActions);
    }
     ...
     * any). Use {@link #setManagedActions(java.util.Collection)} or
     * {@link #withManagedActions(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param managedActions
    ...
    public DescribeEnvironmentManagedActionsResult withManagedActions(
        ...
        if (this.managedActions == null) {
            setManagedActions(new com.amazonaws.internal.SdkInternalList<ManagedAction>(
                    managedActions.length));
        }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getManagedActions() == null) ? 0 : getManagedActions()
                        .hashCode());
        return hashCode;
    }
