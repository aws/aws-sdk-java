...
/**
 * ResourceQuota StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResourceQuotaStaxUnmarshaller implements Unmarshaller<ResourceQuota, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Maximum", targetDepth)) {
                    resourceQuota.setMaximum(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
