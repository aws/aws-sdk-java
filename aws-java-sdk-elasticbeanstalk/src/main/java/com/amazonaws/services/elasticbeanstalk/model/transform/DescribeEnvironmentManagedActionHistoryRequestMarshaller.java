...
public class DescribeEnvironmentManagedActionHistoryRequestMarshaller implements
    ...
    public Request<DescribeEnvironmentManagedActionHistoryRequest> marshall(
        ...
        if (describeEnvironmentManagedActionHistoryRequest.getEnvironmentId() != null) {
            request.addParameter("EnvironmentId", StringUtils.fromString(describeEnvironmentManagedActionHistoryRequest.getEnvironmentId()));
        }

        if (describeEnvironmentManagedActionHistoryRequest.getEnvironmentName() != null) {
            request.addParameter("EnvironmentName", StringUtils.fromString(describeEnvironmentManagedActionHistoryRequest.getEnvironmentName()));
        }

        if (describeEnvironmentManagedActionHistoryRequest.getNextToken() != null) {
            request.addParameter("NextToken", StringUtils.fromString(describeEnvironmentManagedActionHistoryRequest.getNextToken()));
        }

        if (describeEnvironmentManagedActionHistoryRequest.getMaxItems() != null) {
            request.addParameter("MaxItems", StringUtils.fromInteger(describeEnvironmentManagedActionHistoryRequest.getMaxItems()));
        }
