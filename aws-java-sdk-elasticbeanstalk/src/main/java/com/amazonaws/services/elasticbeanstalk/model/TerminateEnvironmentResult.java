...
public class TerminateEnvironmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public TerminateEnvironmentResult withHealthStatus(String healthStatus) {
    ...
    public TerminateEnvironmentResult withOperationsRole(String operationsRole) {
    ...
    @Override
    public TerminateEnvironmentResult clone() {
        try {
