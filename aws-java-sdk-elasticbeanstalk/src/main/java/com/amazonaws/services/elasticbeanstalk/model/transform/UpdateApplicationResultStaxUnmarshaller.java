 ...
 */
public class UpdateApplicationResultStaxUnmarshaller implements
        Unmarshaller<UpdateApplicationResult, StaxUnmarshallerContext> {

    public UpdateApplicationResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Application", targetDepth)) {
                    updateApplicationResult
                            .setApplication(ApplicationDescriptionStaxUnmarshaller
