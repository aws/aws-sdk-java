    ...
    public Request<DescribeConfigurationOptionsRequest> marshall(
        ...
        if (describeConfigurationOptionsRequest.getApplicationName() != null) {
            request.addParameter("ApplicationName", StringUtils
                    .fromString(describeConfigurationOptionsRequest
                            .getApplicationName()));
        }
        ...
        if (!optionsList.isEmpty() || !optionsList.isAutoConstruct()) {
            ...
            for (OptionSpecification optionsListValue : optionsList) {
                ...
                if (optionsListValue.getResourceName() != null) {
                    request.addParameter("Options.member." + optionsListIndex
                            + ".ResourceName", StringUtils
                            .fromString(optionsListValue.getResourceName()));
                }

                if (optionsListValue.getNamespace() != null) {
                    request.addParameter("Options.member." + optionsListIndex
                            + ".Namespace", StringUtils
                            .fromString(optionsListValue.getNamespace()));
                }

                if (optionsListValue.getOptionName() != null) {
                    request.addParameter("Options.member." + optionsListIndex
                            + ".OptionName", StringUtils
                            .fromString(optionsListValue.getOptionName()));
                }
                optionsListIndex++;
            }
        }
