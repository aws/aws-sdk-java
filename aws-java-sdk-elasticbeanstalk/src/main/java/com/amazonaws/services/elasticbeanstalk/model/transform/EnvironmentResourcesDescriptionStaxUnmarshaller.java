 ...
 */
public class EnvironmentResourcesDescriptionStaxUnmarshaller implements
        Unmarshaller<EnvironmentResourcesDescription, StaxUnmarshallerContext> {

    public EnvironmentResourcesDescription unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("LoadBalancer", targetDepth)) {
                    environmentResourcesDescription
                            .setLoadBalancer(LoadBalancerDescriptionStaxUnmarshaller
