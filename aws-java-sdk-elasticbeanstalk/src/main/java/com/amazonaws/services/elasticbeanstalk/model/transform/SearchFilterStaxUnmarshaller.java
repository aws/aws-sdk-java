...
/**
 * SearchFilter StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchFilterStaxUnmarshaller implements Unmarshaller<SearchFilter, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Attribute", targetDepth)) {
                    searchFilter.setAttribute(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Operator", targetDepth)) {
                    searchFilter.setOperator(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Values/member", targetDepth)) {
                    searchFilter.withValues(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
