...
/**
 * SchemaVersionSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SchemaVersionSummaryJsonUnmarshaller implements Unmarshaller<SchemaVersionSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SchemaArn", targetDepth)) {
                    context.nextToken();
                    schemaVersionSummary.setSchemaArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("SchemaName", targetDepth)) {
                    context.nextToken();
                    schemaVersionSummary.setSchemaName(context.getUnmarshaller(String.class).unmarshall(context));
                }
