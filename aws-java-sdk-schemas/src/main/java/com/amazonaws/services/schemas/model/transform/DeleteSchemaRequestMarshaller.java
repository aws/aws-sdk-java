...
public class DeleteSchemaRequestMarshaller {
    ...
    public void marshall(DeleteSchemaRequest deleteSchemaRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteSchemaRequest.getRegistryName(), REGISTRYNAME_BINDING);
            protocolMarshaller.marshall(deleteSchemaRequest.getSchemaName(), SCHEMANAME_BINDING);
        } catch (Exception e) {
