...
public class ListSchemasResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<SchemaSummary> schemas;
     ...
     * </p>
     * 
     * @return An array of schema summaries.
     */

    public java.util.List<SchemaSummary> getSchemas() {
        return schemas;
    }
    ...
    public void setSchemas(java.util.Collection<SchemaSummary> schemas) {
        if (schemas == null) {
            this.schemas = null;
            return;
        }

        this.schemas = new java.util.ArrayList<SchemaSummary>(schemas);
    }
    ...
    public ListSchemasResult withSchemas(SchemaSummary... schemas) {
        if (this.schemas == null) {
            setSchemas(new java.util.ArrayList<SchemaSummary>(schemas.length));
        }
        for (SchemaSummary ele : schemas) {
    ...
    public ListSchemasResult withSchemas(java.util.Collection<SchemaSummary> schemas) {
        setSchemas(schemas);
        return this;
    }
