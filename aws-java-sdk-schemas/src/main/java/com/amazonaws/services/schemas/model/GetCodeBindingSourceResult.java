...
public class GetCodeBindingSourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public GetCodeBindingSourceResult clone() {
        try {
            return (GetCodeBindingSourceResult) super.clone();
