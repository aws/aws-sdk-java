...
/**
 * StartDiscovererResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartDiscovererResultJsonUnmarshaller implements Unmarshaller<StartDiscovererResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DiscovererId", targetDepth)) {
                    context.nextToken();
                    startDiscovererResult.setDiscovererId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("State", targetDepth)) {
                    context.nextToken();
                    startDiscovererResult.setState(context.getUnmarshaller(String.class).unmarshall(context));
                }
