...
public class InvalidTaskIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTaskIdExceptionUnmarshaller instance;

    public static InvalidTaskIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTaskIdExceptionUnmarshaller();
        return instance;
    }
}
