...
public class MaxLexemeLengthExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaxLexemeLengthExceededExceptionUnmarshaller instance;

    public static MaxLexemeLengthExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaxLexemeLengthExceededExceptionUnmarshaller();
        return instance;
    }
}
