...
public class MaxLexiconsNumberExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaxLexiconsNumberExceededExceptionUnmarshaller instance;

    public static MaxLexiconsNumberExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaxLexiconsNumberExceededExceptionUnmarshaller();
        return instance;
    }
}
