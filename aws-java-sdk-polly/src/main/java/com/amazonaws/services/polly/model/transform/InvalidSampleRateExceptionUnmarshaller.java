...
public class InvalidSampleRateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSampleRateExceptionUnmarshaller instance;

    public static InvalidSampleRateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSampleRateExceptionUnmarshaller();
        return instance;
    }
}
