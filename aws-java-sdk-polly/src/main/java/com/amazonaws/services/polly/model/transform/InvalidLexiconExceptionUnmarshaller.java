...
public class InvalidLexiconExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidLexiconExceptionUnmarshaller instance;

    public static InvalidLexiconExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidLexiconExceptionUnmarshaller();
        return instance;
    }
}
