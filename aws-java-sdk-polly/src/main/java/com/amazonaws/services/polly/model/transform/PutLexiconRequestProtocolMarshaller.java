...
public class PutLexiconRequestProtocolMarshaller implements Marshaller<Request<PutLexiconRequest>, PutLexiconRequest> {
    ...
    public PutLexiconRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<PutLexiconRequest> marshall(PutLexiconRequest putLexiconRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<PutLexiconRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    putLexiconRequest);

            protocolMarshaller.startMarshalling();
            PutLexiconRequestMarshaller.getInstance().marshall(putLexiconRequest, protocolMarshaller);
