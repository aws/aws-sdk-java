...
public class LexiconNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LexiconNotFoundExceptionUnmarshaller instance;

    public static LexiconNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LexiconNotFoundExceptionUnmarshaller();
        return instance;
    }
}
