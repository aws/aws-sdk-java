...
public class LanguageNotSupportedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LanguageNotSupportedExceptionUnmarshaller instance;

    public static LanguageNotSupportedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LanguageNotSupportedExceptionUnmarshaller();
        return instance;
    }
}
