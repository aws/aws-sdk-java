...
public class SynthesisTaskNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SynthesisTaskNotFoundExceptionUnmarshaller instance;

    public static SynthesisTaskNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SynthesisTaskNotFoundExceptionUnmarshaller();
        return instance;
    }
}
