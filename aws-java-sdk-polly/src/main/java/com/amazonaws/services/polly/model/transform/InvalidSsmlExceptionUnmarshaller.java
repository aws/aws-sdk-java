...
public class InvalidSsmlExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSsmlExceptionUnmarshaller instance;

    public static InvalidSsmlExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSsmlExceptionUnmarshaller();
        return instance;
    }
}
