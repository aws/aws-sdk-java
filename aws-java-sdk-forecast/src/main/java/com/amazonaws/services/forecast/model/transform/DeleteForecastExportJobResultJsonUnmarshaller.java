...
/**
 * DeleteForecastExportJobResult JSON Unmarshaller
 */
...
public class DeleteForecastExportJobResultJsonUnmarshaller implements Unmarshaller<DeleteForecastExportJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteForecastExportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteForecastExportJobResult deleteForecastExportJobResult = new DeleteForecastExportJobResult();
