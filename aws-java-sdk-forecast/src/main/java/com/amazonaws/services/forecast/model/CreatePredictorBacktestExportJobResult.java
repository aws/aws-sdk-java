...
public class CreatePredictorBacktestExportJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the predictor backtest export job that you want to export.
     */
    ...
    public CreatePredictorBacktestExportJobResult withPredictorBacktestExportJobArn(String predictorBacktestExportJobArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePredictorBacktestExportJobResult == false)
            return false;
        CreatePredictorBacktestExportJobResult other = (CreatePredictorBacktestExportJobResult) obj;
    ...
    @Override
    public CreatePredictorBacktestExportJobResult clone() {
        try {
