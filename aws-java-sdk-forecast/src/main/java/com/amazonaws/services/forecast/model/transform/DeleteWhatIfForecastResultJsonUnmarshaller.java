...
/**
 * DeleteWhatIfForecastResult JSON Unmarshaller
 */
...
public class DeleteWhatIfForecastResultJsonUnmarshaller implements Unmarshaller<DeleteWhatIfForecastResult, JsonUnmarshallerContext> {
    ...
    public DeleteWhatIfForecastResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteWhatIfForecastResult deleteWhatIfForecastResult = new DeleteWhatIfForecastResult();

        return deleteWhatIfForecastResult;
    }
