...
public class DeleteWhatIfAnalysisRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the what-if analysis that you want to delete.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteWhatIfAnalysisRequest == false)
            return false;
        DeleteWhatIfAnalysisRequest other = (DeleteWhatIfAnalysisRequest) obj;
    ...
    @Override
    public DeleteWhatIfAnalysisRequest clone() {
        return (DeleteWhatIfAnalysisRequest) super.clone();
    }
