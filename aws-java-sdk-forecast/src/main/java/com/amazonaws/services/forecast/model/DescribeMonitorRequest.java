...
public class DescribeMonitorRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the monitor resource to describe.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMonitorRequest == false)
            return false;
        DescribeMonitorRequest other = (DescribeMonitorRequest) obj;
    ...
    @Override
    public DescribeMonitorRequest clone() {
        return (DescribeMonitorRequest) super.clone();
    }
