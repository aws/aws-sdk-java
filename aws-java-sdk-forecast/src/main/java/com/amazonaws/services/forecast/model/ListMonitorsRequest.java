...
public class ListMonitorsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <li>
     * <p>
     * <code>Key</code> - The name of the parameter to filter on. The only valid value is <code>Status</code>.
     * </p>
     * </li>
     * <li>
     * <p>
     ...
     * </p>
     * 
     * @return The maximum number of monitors to include in the response.
     */
    ...
    public ListMonitorsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
