...
public class DescribeWhatIfForecastRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the what-if forecast that you are interested in.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeWhatIfForecastRequest == false)
            return false;
        DescribeWhatIfForecastRequest other = (DescribeWhatIfForecastRequest) obj;
    ...
    @Override
    public DescribeWhatIfForecastRequest clone() {
        return (DescribeWhatIfForecastRequest) super.clone();
    }
