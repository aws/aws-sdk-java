...
/**
 * TimeAlignmentBoundary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TimeAlignmentBoundaryJsonUnmarshaller implements Unmarshaller<TimeAlignmentBoundary, JsonUnmarshallerContext> {

    public TimeAlignmentBoundary unmarshall(JsonUnmarshallerContext context) throws Exception {
        TimeAlignmentBoundary timeAlignmentBoundary = new TimeAlignmentBoundary();
    ...
    private static TimeAlignmentBoundaryJsonUnmarshaller instance;

    public static TimeAlignmentBoundaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TimeAlignmentBoundaryJsonUnmarshaller();
        return instance;
    }
}
