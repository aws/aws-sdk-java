...
/**
 * DeleteDatasetImportJobResult JSON Unmarshaller
 */
...
public class DeleteDatasetImportJobResultJsonUnmarshaller implements Unmarshaller<DeleteDatasetImportJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteDatasetImportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDatasetImportJobResult deleteDatasetImportJobResult = new DeleteDatasetImportJobResult();
