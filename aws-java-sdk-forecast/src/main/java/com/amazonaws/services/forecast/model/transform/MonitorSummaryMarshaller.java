...
public class MonitorSummaryMarshaller {
    ...
    public void marshall(MonitorSummary monitorSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(monitorSummary.getResourceArn(), RESOURCEARN_BINDING);
            protocolMarshaller.marshall(monitorSummary.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(monitorSummary.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(monitorSummary.getLastModificationTime(), LASTMODIFICATIONTIME_BINDING);
        } catch (Exception e) {
