...
/**
 * DeleteForecastResult JSON Unmarshaller
 */
...
public class DeleteForecastResultJsonUnmarshaller implements Unmarshaller<DeleteForecastResult, JsonUnmarshallerContext> {
    ...
    public DeleteForecastResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteForecastResult deleteForecastResult = new DeleteForecastResult();
