...
/**
 * DeleteWhatIfForecastExportResult JSON Unmarshaller
 */
...
public class DeleteWhatIfForecastExportResultJsonUnmarshaller implements Unmarshaller<DeleteWhatIfForecastExportResult, JsonUnmarshallerContext> {
    ...
    public DeleteWhatIfForecastExportResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteWhatIfForecastExportResult deleteWhatIfForecastExportResult = new DeleteWhatIfForecastExportResult();

        return deleteWhatIfForecastExportResult;
    }
