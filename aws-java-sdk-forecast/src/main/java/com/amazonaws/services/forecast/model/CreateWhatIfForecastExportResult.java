...
public class CreateWhatIfForecastExportResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateWhatIfForecastExportResult == false)
            return false;
        CreateWhatIfForecastExportResult other = (CreateWhatIfForecastExportResult) obj;
    ...
    public CreateWhatIfForecastExportResult clone() {
        try {
            return (CreateWhatIfForecastExportResult) super.clone();
