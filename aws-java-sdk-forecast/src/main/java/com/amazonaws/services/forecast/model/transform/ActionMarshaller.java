...
public class ActionMarshaller {
    ...
    public void marshall(Action action, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(action.getAttributeName(), ATTRIBUTENAME_BINDING);
            protocolMarshaller.marshall(action.getOperation(), OPERATION_BINDING);
            protocolMarshaller.marshall(action.getValue(), VALUE_BINDING);
        } catch (Exception e) {
