...
public class CreateAutoPredictorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAutoPredictorResult == false)
            return false;
        CreateAutoPredictorResult other = (CreateAutoPredictorResult) obj;
    ...
    public CreateAutoPredictorResult clone() {
        try {
            return (CreateAutoPredictorResult) super.clone();
