...
public class ListWhatIfForecastsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <code>IS</code> or <code>IS_NOT</code>, which specifies whether to include or exclude the what-if forecast export
     ...
     * <li>
     * <p>
     * <code>Key</code> - The name of the parameter to filter on. Valid values are <code>WhatIfForecastArn</code> and
     * <code>Status</code>.
     * </p>
     * </li>
     * <li>
     ...
     * </ul>
     * <p>
     * For example, to list all jobs that export a forecast named <i>electricityWhatIfForecast</i>, specify the
     * following filter:
     * </p>
     * <p>
     * <code>"Filters": [ { "Condition": "IS", "Key": "WhatIfForecastArn", "Value": "arn:aws:forecast:us-west-2:&lt;acct-id&gt;:forecast/electricityWhatIfForecast" } ]</code>
     * </p>
     */
    ...
    public ListWhatIfForecastsRequest withMaxResults(Integer maxResults) {
     ...
     *         either <code>IS</code> or <code>IS_NOT</code>, which specifies whether to include or exclude the what-if
     *         forecast export jobs that match the statement from the list, respectively. The match statement consists
     *         of a key and a value.</p>
     *         <p>
     *         <b>Filter properties</b>
     *         </p>
     *         <ul>
     ...
     *         <code>WhatIfForecastArn</code> and <code>Status</code>.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     ...
     *        either <code>IS</code> or <code>IS_NOT</code>, which specifies whether to include or exclude the what-if
     *        forecast export jobs that match the statement from the list, respectively. The match statement consists of
     *        a key and a value.</p>
     *        <p>
     *        <b>Filter properties</b>
     *        </p>
    ...
    public ListWhatIfForecastsRequest withFilters(Filter... filters) {
    ...
    public ListWhatIfForecastsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListWhatIfForecastsRequest == false)
            return false;
        ListWhatIfForecastsRequest other = (ListWhatIfForecastsRequest) obj;
    ...
    @Override
    public ListWhatIfForecastsRequest clone() {
        return (ListWhatIfForecastsRequest) super.clone();
    }
