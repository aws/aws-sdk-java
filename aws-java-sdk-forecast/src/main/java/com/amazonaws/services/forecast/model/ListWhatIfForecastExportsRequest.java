...
public class ListWhatIfForecastExportsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </ul>
     * <p>
     * For example, to list all jobs that export a forecast named <i>electricityWIFExport</i>, specify the following
     * filter:
     * </p>
     * <p>
     * <code>"Filters": [ { "Condition": "IS", "Key": "WhatIfForecastExportArn", "Value": "arn:aws:forecast:us-west-2:&lt;acct-id&gt;:forecast/electricityWIFExport" } ]</code>
     * </p>
     */
    ...
    public ListWhatIfForecastExportsRequest withMaxResults(Integer maxResults) {
     ...
     *         <code>WhatIfForecastExportArn</code> and <code>Status</code>.
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     ...
     *         </ul>
     *         <p>
     *         For example, to list all jobs that export a forecast named <i>electricityWIFExport</i>, specify the
     *         following filter:
     *         </p>
     *         <p>
     *         <code>"Filters": [ { "Condition": "IS", "Key": "WhatIfForecastExportArn", "Value": "arn:aws:forecast:us-west-2:&lt;acct-id&gt;:forecast/electricityWIFExport" } ]</code>
    ...
    public ListWhatIfForecastExportsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListWhatIfForecastExportsRequest == false)
            return false;
        ListWhatIfForecastExportsRequest other = (ListWhatIfForecastExportsRequest) obj;
    ...
    @Override
    public ListWhatIfForecastExportsRequest clone() {
        return (ListWhatIfForecastExportsRequest) super.clone();
    }
