...
/**
 * ResumeResourceResult JSON Unmarshaller
 */
...
public class ResumeResourceResultJsonUnmarshaller implements Unmarshaller<ResumeResourceResult, JsonUnmarshallerContext> {
    ...
    public ResumeResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResumeResourceResult resumeResourceResult = new ResumeResourceResult();

        return resumeResourceResult;
    }
