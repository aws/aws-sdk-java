...
/**
 * DeleteMonitorResult JSON Unmarshaller
 */
...
public class DeleteMonitorResultJsonUnmarshaller implements Unmarshaller<DeleteMonitorResult, JsonUnmarshallerContext> {
    ...
    public DeleteMonitorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMonitorResult deleteMonitorResult = new DeleteMonitorResult();
