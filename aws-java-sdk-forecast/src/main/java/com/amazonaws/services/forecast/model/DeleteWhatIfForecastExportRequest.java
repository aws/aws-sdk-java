...
public class DeleteWhatIfForecastExportRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the what-if forecast export that you want to delete.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteWhatIfForecastExportRequest == false)
            return false;
        DeleteWhatIfForecastExportRequest other = (DeleteWhatIfForecastExportRequest) obj;
    ...
    public DeleteWhatIfForecastExportRequest clone() {
        return (DeleteWhatIfForecastExportRequest) super.clone();
    }
