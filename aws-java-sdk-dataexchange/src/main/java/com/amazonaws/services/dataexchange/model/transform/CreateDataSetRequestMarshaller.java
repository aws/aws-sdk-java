...
public class CreateDataSetRequestMarshaller {
    ...
    public void marshall(CreateDataSetRequest createDataSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createDataSetRequest.getAssetType(), ASSETTYPE_BINDING);
            protocolMarshaller.marshall(createDataSetRequest.getDescription(), DESCRIPTION_BINDING);
