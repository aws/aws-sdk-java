 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/dataexchange-2017-07-25/DatabaseLFTagPolicy" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DatabaseLFTagPolicy implements Serializable, Cloneable, StructuredPojo {
    ...
    public DatabaseLFTagPolicy withExpression(LFTag... expression) {
    ...
    public DatabaseLFTagPolicy withExpression(java.util.Collection<LFTag> expression) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DatabaseLFTagPolicy == false)
            return false;
    ...
    public DatabaseLFTagPolicy clone() {
        try {
            return (DatabaseLFTagPolicy) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.dataexchange.model.transform.DatabaseLFTagPolicyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
