 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/dataexchange-2017-07-25/ImportAssetsFromRedshiftDataSharesRequestDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportAssetsFromRedshiftDataSharesRequestDetails implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return A list of Amazon Redshift datashare assets.
     */
    ...
    public ImportAssetsFromRedshiftDataSharesRequestDetails withAssetSources(RedshiftDataShareAssetSourceEntry... assetSources) {
    ...
    public ImportAssetsFromRedshiftDataSharesRequestDetails withAssetSources(java.util.Collection<RedshiftDataShareAssetSourceEntry> assetSources) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportAssetsFromRedshiftDataSharesRequestDetails == false)
            return false;
        ImportAssetsFromRedshiftDataSharesRequestDetails other = (ImportAssetsFromRedshiftDataSharesRequestDetails) obj;
    ...
    @Override
    public ImportAssetsFromRedshiftDataSharesRequestDetails clone() {
        try {
            return (ImportAssetsFromRedshiftDataSharesRequestDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.dataexchange.model.transform.ImportAssetsFromRedshiftDataSharesRequestDetailsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
