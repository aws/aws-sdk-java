...
/**
 * ImportAssetFromApiGatewayApiRequestDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportAssetFromApiGatewayApiRequestDetailsJsonUnmarshaller implements
        Unmarshaller<ImportAssetFromApiGatewayApiRequestDetails, JsonUnmarshallerContext> {

    public ImportAssetFromApiGatewayApiRequestDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        ImportAssetFromApiGatewayApiRequestDetails importAssetFromApiGatewayApiRequestDetails = new ImportAssetFromApiGatewayApiRequestDetails();
    ...
    private static ImportAssetFromApiGatewayApiRequestDetailsJsonUnmarshaller instance;

    public static ImportAssetFromApiGatewayApiRequestDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ImportAssetFromApiGatewayApiRequestDetailsJsonUnmarshaller();
        return instance;
    }
}
