...
public class CreateRevisionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateRevisionResult withRevocationComment(String revocationComment) {
    ...
    public CreateRevisionResult withRevoked(Boolean revoked) {
        setRevoked(revoked);
        return this;
    }
    ...
    public CreateRevisionResult withRevokedAt(java.util.Date revokedAt) {
