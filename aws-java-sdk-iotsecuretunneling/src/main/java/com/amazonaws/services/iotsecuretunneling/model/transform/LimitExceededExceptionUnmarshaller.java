...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.iotsecuretunneling.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.iotsecuretunneling.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iotsecuretunneling.model.LimitExceededException limitExceededException = new com.amazonaws.services.iotsecuretunneling.model.LimitExceededException(
                null);
