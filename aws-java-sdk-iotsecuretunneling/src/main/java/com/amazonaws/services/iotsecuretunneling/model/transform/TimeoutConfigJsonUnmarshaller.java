...
/**
 * TimeoutConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TimeoutConfigJsonUnmarshaller implements Unmarshaller<TimeoutConfig, JsonUnmarshallerContext> {

    public TimeoutConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("maxLifetimeTimeoutMinutes", targetDepth)) {
                    context.nextToken();
                    timeoutConfig.setMaxLifetimeTimeoutMinutes(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
