 ...
 */
public class DescribeHapgResultJsonUnmarshaller implements
        Unmarshaller<DescribeHapgResult, JsonUnmarshallerContext> {

    public DescribeHapgResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
