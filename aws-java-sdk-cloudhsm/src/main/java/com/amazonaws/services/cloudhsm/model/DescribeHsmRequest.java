...
public class DescribeHsmRequest extends AmazonWebServiceRequest implements
    ...
    /**
     * <p>
     * The ARN of the HSM. Either the <i>HsmArn</i> or the <i>SerialNumber</i>
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getHsmArn() != null
            ...
            return false;
        if (other.getHsmSerialNumber() == null
                ^ this.getHsmSerialNumber() == null)
            return false;
        if (other.getHsmSerialNumber() != null
                && other.getHsmSerialNumber().equals(this.getHsmSerialNumber()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getHsmSerialNumber() == null) ? 0 : getHsmSerialNumber()
                        .hashCode());
        return hashCode;
    }
