...
public class GetConfigRequestMarshaller implements Marshaller<Request<GetConfigRequest>, GetConfigRequest> {
    ...
    public GetConfigRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<GetConfigRequest> marshall(GetConfigRequest getConfigRequest) {
        ...
        try {
            ...
            com.amazonaws.internal.SdkInternalList<String> hapgListList = (com.amazonaws.internal.SdkInternalList<String>) getConfigRequest.getHapgList();
