...
/**
 * Describe Luna Client Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (describeLunaClientRequest.getClientArn() != null) {
                jsonWriter.key("ClientArn").value(describeLunaClientRequest.getClientArn());
            }
            if (describeLunaClientRequest.getCertificateFingerprint() != null) {
                jsonWriter.key("CertificateFingerprint").value(describeLunaClientRequest.getCertificateFingerprint());
            }
