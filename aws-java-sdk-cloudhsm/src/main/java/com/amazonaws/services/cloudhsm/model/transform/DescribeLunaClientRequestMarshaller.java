...
public class DescribeLunaClientRequestMarshaller
        implements
        Marshaller<Request<DescribeLunaClientRequest>, DescribeLunaClientRequest> {

    public Request<DescribeLunaClientRequest> marshall(
        ...
        Request<DescribeLunaClientRequest> request = new DefaultRequest<DescribeLunaClientRequest>(
                describeLunaClientRequest, "AWSCloudHSM");
        ...
        try {
            ...
            if (describeLunaClientRequest.getClientArn() != null) {
                jsonWriter.key("ClientArn").value(
                        describeLunaClientRequest.getClientArn());
            }

            if (describeLunaClientRequest.getCertificateFingerprint() != null) {
                jsonWriter.key("CertificateFingerprint").value(
                        describeLunaClientRequest.getCertificateFingerprint());
            }
