...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cloudhsm.AWSCloudHSM#listHapgs(ListHapgsRequest) ListHapgs operation}.
 * <p>
...
public class ListHapgsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Pattern: </b>[a-zA-Z0-9+/]*<br/>
     *
     * @return The <i>NextToken</i> value from a previous call to <a>ListHapgs</a>.
     *         Pass null if this is the first call.
     */
     ...
     * <b>Pattern: </b>[a-zA-Z0-9+/]*<br/>
     *
     * @param nextToken The <i>NextToken</i> value from a previous call to <a>ListHapgs</a>.
     *         Pass null if this is the first call.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListHapgsRequest == false) return false;
