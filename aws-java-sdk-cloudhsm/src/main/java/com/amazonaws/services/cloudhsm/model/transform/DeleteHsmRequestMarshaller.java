...
public class DeleteHsmRequestMarshaller implements
    ...
    public Request<DeleteHsmRequest> marshall(DeleteHsmRequest deleteHsmRequest) {
        ...
        Request<DeleteHsmRequest> request = new DefaultRequest<DeleteHsmRequest>(
                deleteHsmRequest, "AWSCloudHSM");
        ...
        try {
            ...
            if (deleteHsmRequest.getHsmArn() != null) {
                jsonWriter.key("HsmArn").value(deleteHsmRequest.getHsmArn());
            }
