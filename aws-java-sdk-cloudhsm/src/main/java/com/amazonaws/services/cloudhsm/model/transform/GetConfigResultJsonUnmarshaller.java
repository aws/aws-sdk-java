 ...
 */
public class GetConfigResultJsonUnmarshaller implements
        Unmarshaller<GetConfigResult, JsonUnmarshallerContext> {

    public GetConfigResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
