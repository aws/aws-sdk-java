...
/**
 * Get Config Result JSON Unmarshaller
 */
public class GetConfigResultJsonUnmarshaller implements Unmarshaller<GetConfigResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ConfigType", targetDepth)) {
                    context.nextToken();
                    getConfigResult.setConfigType(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ConfigFile", targetDepth)) {
                    context.nextToken();
                    getConfigResult.setConfigFile(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ConfigCred", targetDepth)) {
                    context.nextToken();
                    getConfigResult.setConfigCred(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static GetConfigResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetConfigResultJsonUnmarshaller();
        return instance;
    }
}
