...
/**
 * Container for the parameters to the {@link com.amazonaws.services.cloudhsm.AWSCloudHSM#listHsms(ListHsmsRequest) ListHsms operation}.
 * <p>
...
public class ListHsmsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <b>Pattern: </b>[a-zA-Z0-9+/]*<br/>
     *
     * @return The <i>NextToken</i> value from a previous call to <a>ListHsms</a>.
     *         Pass null if this is the first call.
     */
     ...
     * <b>Pattern: </b>[a-zA-Z0-9+/]*<br/>
     *
     * @param nextToken The <i>NextToken</i> value from a previous call to <a>ListHsms</a>.
     *         Pass null if this is the first call.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListHsmsRequest == false) return false;
