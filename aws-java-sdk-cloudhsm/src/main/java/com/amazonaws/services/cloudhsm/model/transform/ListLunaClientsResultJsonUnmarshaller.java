 ...
 */
public class ListLunaClientsResultJsonUnmarshaller implements
        Unmarshaller<ListLunaClientsResult, JsonUnmarshallerContext> {

    public ListLunaClientsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
