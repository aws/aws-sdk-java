...
/**
 * List Luna Clients Result JSON Unmarshaller
 */
public class ListLunaClientsResultJsonUnmarshaller implements Unmarshaller<ListLunaClientsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ClientList", targetDepth)) {
                    context.nextToken();
                    listLunaClientsResult.setClientList(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listLunaClientsResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ListLunaClientsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListLunaClientsResultJsonUnmarshaller();
        return instance;
    }
}
