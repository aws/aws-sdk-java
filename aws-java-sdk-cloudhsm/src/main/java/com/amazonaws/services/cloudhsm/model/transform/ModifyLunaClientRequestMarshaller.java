...
public class ModifyLunaClientRequestMarshaller implements
    ...
    public Request<ModifyLunaClientRequest> marshall(
        ...
        Request<ModifyLunaClientRequest> request = new DefaultRequest<ModifyLunaClientRequest>(
                modifyLunaClientRequest, "AWSCloudHSM");
