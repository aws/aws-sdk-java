...
public class ModifyLunaClientRequestMarshaller {
    ...
    private static final ModifyLunaClientRequestMarshaller instance = new ModifyLunaClientRequestMarshaller();

    public static ModifyLunaClientRequestMarshaller getInstance() {
        return instance;
    }
