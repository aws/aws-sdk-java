 ...
 */
public class CreateLunaClientRequestMarshaller implements
        Marshaller<Request<CreateLunaClientRequest>, CreateLunaClientRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public CreateLunaClientRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<CreateLunaClientRequest> marshall(
        ...
        Request<CreateLunaClientRequest> request = new DefaultRequest<CreateLunaClientRequest>(
                createLunaClientRequest, "AWSCloudHSM");
