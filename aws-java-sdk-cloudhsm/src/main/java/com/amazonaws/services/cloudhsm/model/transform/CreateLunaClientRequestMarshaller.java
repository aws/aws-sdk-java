...
/**
 * Create Luna Client Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (createLunaClientRequest.getLabel() != null) {
                jsonWriter.key("Label").value(createLunaClientRequest.getLabel());
            }
            if (createLunaClientRequest.getCertificate() != null) {
                jsonWriter.key("Certificate").value(createLunaClientRequest.getCertificate());
            }
