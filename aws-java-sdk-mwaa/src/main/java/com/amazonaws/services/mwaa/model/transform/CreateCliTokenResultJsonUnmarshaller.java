...
/**
 * CreateCliTokenResult JSON Unmarshaller
 */
...
public class CreateCliTokenResultJsonUnmarshaller implements Unmarshaller<CreateCliTokenResult, JsonUnmarshallerContext> {
    ...
    public CreateCliTokenResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CliToken", targetDepth)) {
                    context.nextToken();
                    createCliTokenResult.setCliToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("WebServerHostname", targetDepth)) {
                    context.nextToken();
                    createCliTokenResult.setWebServerHostname(context.getUnmarshaller(String.class).unmarshall(context));
                }
