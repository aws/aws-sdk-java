...
/**
 * PublishMetricsResult JSON Unmarshaller
 */
...
public class PublishMetricsResultJsonUnmarshaller implements Unmarshaller<PublishMetricsResult, JsonUnmarshallerContext> {
    ...
    public PublishMetricsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PublishMetricsResult publishMetricsResult = new PublishMetricsResult();

        return publishMetricsResult;
    }
