...
public class CreateEnvironmentRequestMarshaller {
    ...
    private static final MarshallingInfo<Integer> MINWEBSERVERS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MinWebservers").build();
    private static final MarshallingInfo<Integer> MAXWEBSERVERS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MaxWebservers").build();
    ...
    public void marshall(CreateEnvironmentRequest createEnvironmentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createEnvironmentRequest.getStartupScriptS3Path(), STARTUPSCRIPTS3PATH_BINDING);
            protocolMarshaller.marshall(createEnvironmentRequest.getStartupScriptS3ObjectVersion(), STARTUPSCRIPTS3OBJECTVERSION_BINDING);
            ...
            protocolMarshaller.marshall(createEnvironmentRequest.getMinWebservers(), MINWEBSERVERS_BINDING);
            protocolMarshaller.marshall(createEnvironmentRequest.getMaxWebservers(), MAXWEBSERVERS_BINDING);
        } catch (Exception e) {
