...
public class UpdateEnvironmentRequestMarshaller {
    ...
    public void marshall(UpdateEnvironmentRequest updateEnvironmentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateEnvironmentRequest.getMinWebservers(), MINWEBSERVERS_BINDING);
            protocolMarshaller.marshall(updateEnvironmentRequest.getMaxWebservers(), MAXWEBSERVERS_BINDING);
        } catch (Exception e) {
