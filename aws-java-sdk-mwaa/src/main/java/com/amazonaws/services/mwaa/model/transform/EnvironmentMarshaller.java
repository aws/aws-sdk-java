...
public class EnvironmentMarshaller {
    ...
    public void marshall(Environment environment, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(environment.getMinWebservers(), MINWEBSERVERS_BINDING);
            protocolMarshaller.marshall(environment.getMaxWebservers(), MAXWEBSERVERS_BINDING);
        } catch (Exception e) {
