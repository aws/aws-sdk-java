...
/**
 * StatisticSet JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StatisticSetJsonUnmarshaller implements Unmarshaller<StatisticSet, JsonUnmarshallerContext> {

    public StatisticSet unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static StatisticSetJsonUnmarshaller instance;

    public static StatisticSetJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StatisticSetJsonUnmarshaller();
        return instance;
    }
}
