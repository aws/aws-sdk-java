...
public class LimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.mobile.model.LimitExceededException> {
    private LimitExceededExceptionUnmarshaller() {
        super("LimitExceededException");
    }

    @Override
    public com.amazonaws.services.mobile.model.LimitExceededException unmarshall(JsonUnmarshallerContext context) throws Exception {
