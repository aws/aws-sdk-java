...
public class ServiceUnavailableExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.mobile.model.ServiceUnavailableException> {
    private ServiceUnavailableExceptionUnmarshaller() {
        super("ServiceUnavailableException");
    }

    @Override
    public com.amazonaws.services.mobile.model.ServiceUnavailableException unmarshall(JsonUnmarshallerContext context) throws Exception {
