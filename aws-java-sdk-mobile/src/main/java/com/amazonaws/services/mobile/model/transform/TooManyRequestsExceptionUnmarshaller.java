...
public class TooManyRequestsExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.mobile.model.TooManyRequestsException> {
    private TooManyRequestsExceptionUnmarshaller() {
        super("TooManyRequestsException");
    }

    @Override
    public com.amazonaws.services.mobile.model.TooManyRequestsException unmarshall(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.mobile.model.TooManyRequestsException tooManyRequestsException = new com.amazonaws.services.mobile.model.TooManyRequestsException(
                null);
