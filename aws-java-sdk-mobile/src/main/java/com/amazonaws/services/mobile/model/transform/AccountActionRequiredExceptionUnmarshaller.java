...
public class AccountActionRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AccountActionRequiredExceptionUnmarshaller instance;

    public static AccountActionRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AccountActionRequiredExceptionUnmarshaller();
        return instance;
    }
}
