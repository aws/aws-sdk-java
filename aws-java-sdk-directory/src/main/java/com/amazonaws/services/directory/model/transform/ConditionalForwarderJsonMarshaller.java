...
public class ConditionalForwarderJsonMarshaller {
     ...
     */
    public void marshall(ConditionalForwarder conditionalForwarder,
        ...
        try {
            ...
            if (conditionalForwarder.getRemoteDomainName() != null) {
                jsonGenerator.writeFieldName("RemoteDomainName").writeValue(
                        conditionalForwarder.getRemoteDomainName());
            }
            ...
            if (conditionalForwarder.getReplicationScope() != null) {
                jsonGenerator.writeFieldName("ReplicationScope").writeValue(
                        conditionalForwarder.getReplicationScope());
            }
