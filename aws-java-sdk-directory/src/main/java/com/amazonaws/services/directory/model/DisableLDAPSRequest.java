...
public class DisableLDAPSRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The type of LDAP security that the customer wants to enable. The security can be either server or client, but
     ...
     * 
     * @param type
     *        The type of LDAP security that the customer wants to enable. The security can be either server or client,
     *        but currently only the default <code>Client</code> is supported.
     * @see LDAPSType
     */
     ...
     * </p>
     * 
     * @return The type of LDAP security that the customer wants to enable. The security can be either server or client,
     *         but currently only the default <code>Client</code> is supported.
     * @see LDAPSType
     */
