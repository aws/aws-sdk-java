...
public class UpdateConditionalForwarderRequestMarshaller
    ...
    public UpdateConditionalForwarderRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<UpdateConditionalForwarderRequest> marshall(
        ...
        Request<UpdateConditionalForwarderRequest> request = new DefaultRequest<UpdateConditionalForwarderRequest>(
                updateConditionalForwarderRequest, "AWSDirectoryService");
        ...
        try {
            ...
            if (updateConditionalForwarderRequest.getDirectoryId() != null) {
                jsonGenerator.writeFieldName("DirectoryId").writeValue(
                        updateConditionalForwarderRequest.getDirectoryId());
            }
