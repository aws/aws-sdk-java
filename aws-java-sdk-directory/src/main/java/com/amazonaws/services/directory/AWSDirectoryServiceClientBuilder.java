...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.directory.AWSDirectoryService}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AWSDirectoryServiceClientBuilder
        extends
        AwsSyncClientBuilder<AWSDirectoryServiceClientBuilder, AWSDirectoryService> {
    ...
    /**
     * Construct a synchronous implementation of AWSDirectoryService using the
