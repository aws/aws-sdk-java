 ...
 */
public class EnableSsoResultJsonUnmarshaller implements
        Unmarshaller<EnableSsoResult, JsonUnmarshallerContext> {

    public EnableSsoResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
