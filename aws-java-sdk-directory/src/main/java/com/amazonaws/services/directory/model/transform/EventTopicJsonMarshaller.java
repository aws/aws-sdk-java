...
public class EventTopicJsonMarshaller {
     ...
     */
    public void marshall(EventTopic eventTopic, SdkJsonGenerator jsonGenerator) {
        if (eventTopic == null) {
