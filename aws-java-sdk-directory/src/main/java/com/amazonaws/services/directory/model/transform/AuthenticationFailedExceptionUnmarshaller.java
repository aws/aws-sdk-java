...
public class AuthenticationFailedExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("AuthenticationFailedException"));
        } else {
            return errorTypeFromHeader.equals("AuthenticationFailedException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        AuthenticationFailedException e = (AuthenticationFailedException)super.unmarshall(json);
        e.setErrorCode("AuthenticationFailedException");
