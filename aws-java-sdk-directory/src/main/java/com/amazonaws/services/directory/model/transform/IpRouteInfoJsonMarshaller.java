...
public class IpRouteInfoJsonMarshaller {
     ...
     */
    public void marshall(IpRouteInfo ipRouteInfo,
        ...
        try {
            ...
            if (ipRouteInfo.getDirectoryId() != null) {
                jsonGenerator.writeFieldName("DirectoryId").writeValue(
                        ipRouteInfo.getDirectoryId());
            }
            if (ipRouteInfo.getCidrIp() != null) {
                jsonGenerator.writeFieldName("CidrIp").writeValue(
                        ipRouteInfo.getCidrIp());
            }
            if (ipRouteInfo.getIpRouteStatusMsg() != null) {
                jsonGenerator.writeFieldName("IpRouteStatusMsg").writeValue(
                        ipRouteInfo.getIpRouteStatusMsg());
            }
            if (ipRouteInfo.getAddedDateTime() != null) {
                jsonGenerator.writeFieldName("AddedDateTime").writeValue(
                        ipRouteInfo.getAddedDateTime());
            }
            if (ipRouteInfo.getIpRouteStatusReason() != null) {
                jsonGenerator.writeFieldName("IpRouteStatusReason").writeValue(
                        ipRouteInfo.getIpRouteStatusReason());
            }
            if (ipRouteInfo.getDescription() != null) {
                jsonGenerator.writeFieldName("Description").writeValue(
                        ipRouteInfo.getDescription());
            }
