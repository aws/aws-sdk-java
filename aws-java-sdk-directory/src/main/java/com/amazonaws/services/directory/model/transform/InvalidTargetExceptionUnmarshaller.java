...
public class InvalidTargetExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    invalidTargetException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static InvalidTargetExceptionUnmarshaller instance;

    public static InvalidTargetExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTargetExceptionUnmarshaller();
        return instance;
    }
}
