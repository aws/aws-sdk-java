...
public class EnableSsoRequest extends AmazonWebServiceRequest implements
     ...
     *        must have privileges to add a service principle name. </p>
     *        <p>
     *        If the AD Connector service account does not have privileges to
     *        add a service principle name, you can specify an alternate account
     ...
     *         <p>
     *         If the AD Connector service account does not have privileges to
     *         add a service principle name, you can specify an alternate
