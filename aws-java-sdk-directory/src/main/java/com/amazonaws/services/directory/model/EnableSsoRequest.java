...
/**
 * Container for the parameters to the {@link com.amazonaws.services.directory.AWSDirectoryService#enableSso(EnableSsoRequest) EnableSso operation}.
 * <p>
 * Enables single-sign on for a directory.
 * </p>
 *
 * @see com.amazonaws.services.directory.AWSDirectoryService#enableSso(EnableSsoRequest)
 */
public class EnableSsoRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * privileges to add a service principle name. <p>If the AD Connector
     * service account does not have privileges to add a service principle
     ...
     * <b>Pattern: </b>^d-[0-9a-f]{10}$<br/>
     *
     * @return The identifier of the directory to enable single-sign on for.
     */
     ...
     * <b>Pattern: </b>^d-[0-9a-f]{10}$<br/>
     *
     * @param directoryId The identifier of the directory to enable single-sign on for.
     */
     ...
     * <b>Pattern: </b>[a-zA-Z0-9._-]+<br/>
     *
     * @return The username of an alternate account to use to enable single-sign on.
     *         This is only used for AD Connector directories. This account must have
     *         privileges to add a service principle name. <p>If the AD Connector
     *         service account does not have privileges to add a service principle
     *         name, you can specify an alternate account with the <i>UserName</i>
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableSsoRequest == false) return false;
