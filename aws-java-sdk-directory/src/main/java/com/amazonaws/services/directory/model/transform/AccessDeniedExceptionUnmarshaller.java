...
public class AccessDeniedExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.directory.model.AccessDeniedException> {
    private AccessDeniedExceptionUnmarshaller() {
        super("AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.directory.model.AccessDeniedException unmarshall(JsonUnmarshallerContext context) throws Exception {
