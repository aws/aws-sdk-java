...
public class GetSnapshotLimitsRequestMarshaller implements
    ...
    public Request<GetSnapshotLimitsRequest> marshall(
        ...
        Request<GetSnapshotLimitsRequest> request = new DefaultRequest<GetSnapshotLimitsRequest>(
                getSnapshotLimitsRequest, "AWSDirectoryService");
        ...
        try {
            ...
            if (getSnapshotLimitsRequest.getDirectoryId() != null) {
                jsonWriter.key("DirectoryId").value(
                        getSnapshotLimitsRequest.getDirectoryId());
            }
