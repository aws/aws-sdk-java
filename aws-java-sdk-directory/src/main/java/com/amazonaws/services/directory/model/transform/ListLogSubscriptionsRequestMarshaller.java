...
@SdkInternalApi
public class ListLogSubscriptionsRequestMarshaller {
    ...
    private static final ListLogSubscriptionsRequestMarshaller instance = new ListLogSubscriptionsRequestMarshaller();

    public static ListLogSubscriptionsRequestMarshaller getInstance() {
        return instance;
    }
