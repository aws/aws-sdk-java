 ...
 */
public class ListIpRoutesResultJsonUnmarshaller implements
        Unmarshaller<ListIpRoutesResult, JsonUnmarshallerContext> {

    public ListIpRoutesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IpRoutesInfo", targetDepth)) {
                    context.nextToken();
                    listIpRoutesResult
                            .setIpRoutesInfo(new ListUnmarshaller<IpRouteInfo>(
                                    IpRouteInfoJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listIpRoutesResult.setNextToken(context.getUnmarshaller(
