...
public class GetDirectoryLimitsResult implements Serializable, Cloneable {
     ...
     * the current region.
     *
     * @return A <a>DirectoryLimits</a> object that contains the directory limits for
     *         the current region.
     */
     ...
     * the current region.
     *
     * @param directoryLimits A <a>DirectoryLimits</a> object that contains the directory limits for
     *         the current region.
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getDirectoryLimits() != null) sb.append("DirectoryLimits: " + getDirectoryLimits() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDirectoryLimitsResult == false) return false;
        GetDirectoryLimitsResult other = (GetDirectoryLimitsResult)obj;
        
        if (other.getDirectoryLimits() == null ^ this.getDirectoryLimits() == null) return false;
        if (other.getDirectoryLimits() != null && other.getDirectoryLimits().equals(this.getDirectoryLimits()) == false) return false; 
        return true;
    }
