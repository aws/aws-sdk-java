...
/**
 * UpdateDirectorySetupResult JSON Unmarshaller
 */
...
public class UpdateDirectorySetupResultJsonUnmarshaller implements Unmarshaller<UpdateDirectorySetupResult, JsonUnmarshallerContext> {
    ...
    public UpdateDirectorySetupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDirectorySetupResult updateDirectorySetupResult = new UpdateDirectorySetupResult();
