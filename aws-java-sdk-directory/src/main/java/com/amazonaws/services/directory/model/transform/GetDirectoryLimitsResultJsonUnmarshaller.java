 ...
 */
public class GetDirectoryLimitsResultJsonUnmarshaller implements
        Unmarshaller<GetDirectoryLimitsResult, JsonUnmarshallerContext> {

    public GetDirectoryLimitsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DirectoryLimits", targetDepth)) {
                    ...
                    getDirectoryLimitsResult
                            .setDirectoryLimits(DirectoryLimitsJsonUnmarshaller
