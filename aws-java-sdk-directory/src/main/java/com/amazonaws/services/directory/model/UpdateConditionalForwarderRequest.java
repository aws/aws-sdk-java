 ...
 * </p>
 */
public class UpdateConditionalForwarderRequest extends
     ...
     * </p>
     * 
     * @return The directory ID of the AWS directory for which to update the
     *         conditional forwarder.
     */
    ...
    public UpdateConditionalForwarderRequest withRemoteDomainName(
     ...
     * </p>
     * 
     * @return The updated IP addresses of the remote DNS server associated with
    ...
    public UpdateConditionalForwarderRequest withDnsIpAddrs(
            String... dnsIpAddrs) {
