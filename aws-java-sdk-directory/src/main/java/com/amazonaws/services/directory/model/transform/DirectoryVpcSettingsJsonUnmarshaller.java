 ...
 */
public class DirectoryVpcSettingsJsonUnmarshaller implements
        Unmarshaller<DirectoryVpcSettings, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("VpcId", targetDepth)) {
                    context.nextToken();
                    directoryVpcSettings.setVpcId(context.getUnmarshaller(
