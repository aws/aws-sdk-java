 ...
 */
public class DescribeConditionalForwardersResultJsonUnmarshaller
        implements
        Unmarshaller<DescribeConditionalForwardersResult, JsonUnmarshallerContext> {

    public DescribeConditionalForwardersResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context
                        .testExpression("ConditionalForwarders", targetDepth)) {
                    context.nextToken();
                    describeConditionalForwardersResult
                            .setConditionalForwarders(new ListUnmarshaller<ConditionalForwarder>(
