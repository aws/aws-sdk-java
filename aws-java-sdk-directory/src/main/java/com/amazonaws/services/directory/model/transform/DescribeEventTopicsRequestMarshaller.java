...
public class DescribeEventTopicsRequestMarshaller
        implements
        Marshaller<Request<DescribeEventTopicsRequest>, DescribeEventTopicsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeEventTopicsRequestMarshaller(
    ...
    public Request<DescribeEventTopicsRequest> marshall(
        ...
        Request<DescribeEventTopicsRequest> request = new DefaultRequest<DescribeEventTopicsRequest>(
        ...
        try {
            ...
            if (describeEventTopicsRequest.getDirectoryId() != null) {
                jsonGenerator.writeFieldName("DirectoryId").writeValue(
                        describeEventTopicsRequest.getDirectoryId());
            }
