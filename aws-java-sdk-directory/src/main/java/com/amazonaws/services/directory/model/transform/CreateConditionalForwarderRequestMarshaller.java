...
public class CreateConditionalForwarderRequestMarshaller implements Marshaller<Request<CreateConditionalForwarderRequest>, CreateConditionalForwarderRequest> {
    ...
    public Request<CreateConditionalForwarderRequest> marshall(CreateConditionalForwarderRequest createConditionalForwarderRequest) {
        ...
        Request<CreateConditionalForwarderRequest> request = new DefaultRequest<CreateConditionalForwarderRequest>(createConditionalForwarderRequest,
                "AWSDirectoryService");
        ...
        try {
            ...
            if (createConditionalForwarderRequest.getDirectoryId() != null) {
                jsonGenerator.writeFieldName("DirectoryId").writeValue(createConditionalForwarderRequest.getDirectoryId());
            }
            if (createConditionalForwarderRequest.getRemoteDomainName() != null) {
                jsonGenerator.writeFieldName("RemoteDomainName").writeValue(createConditionalForwarderRequest.getRemoteDomainName());
            }
