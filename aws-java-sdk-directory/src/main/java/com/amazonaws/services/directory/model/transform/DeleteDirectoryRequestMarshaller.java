...
public class DeleteDirectoryRequestMarshaller implements
    ...
    public Request<DeleteDirectoryRequest> marshall(
        ...
        Request<DeleteDirectoryRequest> request = new DefaultRequest<DeleteDirectoryRequest>(
                deleteDirectoryRequest, "AWSDirectoryService");
        ...
        try {
            ...
            if (deleteDirectoryRequest.getDirectoryId() != null) {
                jsonWriter.key("DirectoryId").value(
                        deleteDirectoryRequest.getDirectoryId());
            }
