...
public class DeleteDirectoryRequestMarshaller implements Marshaller<Request<DeleteDirectoryRequest>, DeleteDirectoryRequest> {
    ...
    public Request<DeleteDirectoryRequest> marshall(DeleteDirectoryRequest deleteDirectoryRequest) {
        ...
        Request<DeleteDirectoryRequest> request = new DefaultRequest<DeleteDirectoryRequest>(deleteDirectoryRequest, "AWSDirectoryService");
        request.addHeader("X-Amz-Target", "DirectoryService_20150416.DeleteDirectory");
        ...
        try {
            ...
            if (deleteDirectoryRequest.getDirectoryId() != null) {
                jsonGenerator.writeFieldName("DirectoryId").writeValue(deleteDirectoryRequest.getDirectoryId());
            }
