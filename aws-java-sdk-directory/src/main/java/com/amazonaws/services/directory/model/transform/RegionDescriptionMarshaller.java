...
/**
 * RegionDescriptionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RegionDescriptionMarshaller {
    ...
    private static final MarshallingInfo<String> REGIONTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RegionType").build();
    ...
    private static final RegionDescriptionMarshaller instance = new RegionDescriptionMarshaller();

    public static RegionDescriptionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RegionDescription regionDescription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(regionDescription.getDirectoryId(), DIRECTORYID_BINDING);
            protocolMarshaller.marshall(regionDescription.getRegionName(), REGIONNAME_BINDING);
            protocolMarshaller.marshall(regionDescription.getRegionType(), REGIONTYPE_BINDING);
            protocolMarshaller.marshall(regionDescription.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(regionDescription.getVpcSettings(), VPCSETTINGS_BINDING);
            protocolMarshaller.marshall(regionDescription.getDesiredNumberOfDomainControllers(), DESIREDNUMBEROFDOMAINCONTROLLERS_BINDING);
            protocolMarshaller.marshall(regionDescription.getLaunchTime(), LAUNCHTIME_BINDING);
            protocolMarshaller.marshall(regionDescription.getStatusLastUpdatedDateTime(), STATUSLASTUPDATEDDATETIME_BINDING);
            protocolMarshaller.marshall(regionDescription.getLastUpdatedDateTime(), LASTUPDATEDDATETIME_BINDING);
        } catch (Exception e) {
