 ...
 */
public class UpdateRadiusResultJsonUnmarshaller implements
        Unmarshaller<UpdateRadiusResult, JsonUnmarshallerContext> {

    public UpdateRadiusResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
