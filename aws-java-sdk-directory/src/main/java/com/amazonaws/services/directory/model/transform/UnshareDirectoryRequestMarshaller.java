...
/**
 * UnshareDirectoryRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UnshareDirectoryRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> UNSHARETARGET_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("UnshareTarget").build();

    private static final UnshareDirectoryRequestMarshaller instance = new UnshareDirectoryRequestMarshaller();

    public static UnshareDirectoryRequestMarshaller getInstance() {
        return instance;
    }
