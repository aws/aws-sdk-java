...
@SdkInternalApi
public class DirectoryVpcSettingsDescriptionMarshaller {
    ...
    private static final DirectoryVpcSettingsDescriptionMarshaller instance = new DirectoryVpcSettingsDescriptionMarshaller();

    public static DirectoryVpcSettingsDescriptionMarshaller getInstance() {
        return instance;
    }
