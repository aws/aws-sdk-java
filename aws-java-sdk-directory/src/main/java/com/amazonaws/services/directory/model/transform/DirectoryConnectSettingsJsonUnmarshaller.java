 ...
 */
public class DirectoryConnectSettingsJsonUnmarshaller implements
        Unmarshaller<DirectoryConnectSettings, JsonUnmarshallerContext> {

    public DirectoryConnectSettings unmarshall(JsonUnmarshallerContext context)
            throws Exception {
