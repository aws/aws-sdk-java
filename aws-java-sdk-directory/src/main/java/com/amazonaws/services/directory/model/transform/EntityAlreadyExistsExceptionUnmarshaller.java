...
public class EntityAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    entityAlreadyExistsException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static EntityAlreadyExistsExceptionUnmarshaller instance;

    public static EntityAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EntityAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
