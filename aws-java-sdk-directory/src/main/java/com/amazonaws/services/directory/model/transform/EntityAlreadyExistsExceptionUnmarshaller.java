...
public class EntityAlreadyExistsExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("EntityAlreadyExistsException"));
        } else {
            return errorTypeFromHeader.equals("EntityAlreadyExistsException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        EntityAlreadyExistsException e = (EntityAlreadyExistsException)super.unmarshall(json);
        e.setErrorCode("EntityAlreadyExistsException");
