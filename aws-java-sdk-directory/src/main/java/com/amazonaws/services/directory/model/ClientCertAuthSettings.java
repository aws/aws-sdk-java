...
public class ClientCertAuthSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ClientCertAuthSettings == false)
            return false;
        ClientCertAuthSettings other = (ClientCertAuthSettings) obj;
        if (other.getOCSPUrl() == null ^ this.getOCSPUrl() == null)
            return false;
        if (other.getOCSPUrl() != null && other.getOCSPUrl().equals(this.getOCSPUrl()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getOCSPUrl() == null) ? 0 : getOCSPUrl().hashCode());
        return hashCode;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.directory.model.transform.ClientCertAuthSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
