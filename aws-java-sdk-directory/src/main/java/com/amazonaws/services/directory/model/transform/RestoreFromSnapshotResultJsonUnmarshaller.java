 ...
 */
public class RestoreFromSnapshotResultJsonUnmarshaller implements
        Unmarshaller<RestoreFromSnapshotResult, JsonUnmarshallerContext> {

    public RestoreFromSnapshotResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
