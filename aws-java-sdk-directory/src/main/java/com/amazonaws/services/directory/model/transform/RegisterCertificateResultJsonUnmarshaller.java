...
public class RegisterCertificateResultJsonUnmarshaller implements Unmarshaller<RegisterCertificateResult, JsonUnmarshallerContext> {
    ...
    public RegisterCertificateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CertificateId", targetDepth)) {
                    context.nextToken();
                    registerCertificateResult.setCertificateId(context.getUnmarshaller(String.class).unmarshall(context));
                }
