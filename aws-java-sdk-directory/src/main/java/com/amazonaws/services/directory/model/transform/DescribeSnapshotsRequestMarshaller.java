    ...
    public Request<DescribeSnapshotsRequest> marshall(DescribeSnapshotsRequest describeSnapshotsRequest) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            com.amazonaws.internal.ListWithAutoConstructFlag<String> snapshotIdsList = (com.amazonaws.internal.ListWithAutoConstructFlag<String>)(describeSnapshotsRequest.getSnapshotIds());
            if (snapshotIdsList != null && !(snapshotIdsList.isAutoConstruct() && snapshotIdsList.isEmpty())) {
