 ...
 */
public class ListIpRoutesRequestMarshaller implements
        Marshaller<Request<ListIpRoutesRequest>, ListIpRoutesRequest> {
    ...
    public Request<ListIpRoutesRequest> marshall(
        ...
        Request<ListIpRoutesRequest> request = new DefaultRequest<ListIpRoutesRequest>(
                listIpRoutesRequest, "AWSDirectoryService");
