...
public class DescribeLDAPSSettingsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The type of LDAP security the customer wants to enable, either server or client. Currently supports only
     *         <code>Client</code>, (the default).
     * @see LDAPSType
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeLDAPSSettingsRequest == false)
            return false;
        DescribeLDAPSSettingsRequest other = (DescribeLDAPSSettingsRequest) obj;
    ...
    public DescribeLDAPSSettingsRequest clone() {
        return (DescribeLDAPSSettingsRequest) super.clone();
    }
