...
public class UpdateSettingsRequestMarshaller {
    ...
    public void marshall(UpdateSettingsRequest updateSettingsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateSettingsRequest.getDirectoryId(), DIRECTORYID_BINDING);
            protocolMarshaller.marshall(updateSettingsRequest.getSettings(), SETTINGS_BINDING);
        } catch (Exception e) {
