    ...
    public void marshall(SnapshotLimits snapshotLimits, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (snapshotLimits.getManualSnapshotsLimit() != null) {
                jsonGenerator.writeFieldName("ManualSnapshotsLimit").writeValue(snapshotLimits.getManualSnapshotsLimit());
            }
            if (snapshotLimits.getManualSnapshotsCurrentCount() != null) {
                jsonGenerator.writeFieldName("ManualSnapshotsCurrentCount").writeValue(snapshotLimits.getManualSnapshotsCurrentCount());
            }
            if (snapshotLimits.getManualSnapshotsLimitReached() != null) {
                jsonGenerator.writeFieldName("ManualSnapshotsLimitReached").writeValue(snapshotLimits.getManualSnapshotsLimitReached());
            }
