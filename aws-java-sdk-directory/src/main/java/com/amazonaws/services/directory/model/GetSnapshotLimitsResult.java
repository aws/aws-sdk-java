...
public class GetSnapshotLimitsResult implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A <a>SnapshotLimits</a> object that contains the manual snapshot limits
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSnapshotLimits() == null
                ^ this.getSnapshotLimits() == null)
            return false;
        if (other.getSnapshotLimits() != null
                && other.getSnapshotLimits().equals(this.getSnapshotLimits()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getSnapshotLimits() == null) ? 0 : getSnapshotLimits()
                        .hashCode());
        return hashCode;
    }
