...
/**
 * Directory Limits JSON Unmarshaller
 */
public class DirectoryLimitsJsonUnmarshaller implements Unmarshaller<DirectoryLimits, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CloudOnlyDirectoriesLimit", targetDepth)) {
                    context.nextToken();
                    directoryLimits.setCloudOnlyDirectoriesLimit(IntegerJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("CloudOnlyDirectoriesCurrentCount", targetDepth)) {
                    context.nextToken();
                    directoryLimits.setCloudOnlyDirectoriesCurrentCount(IntegerJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("CloudOnlyDirectoriesLimitReached", targetDepth)) {
                    context.nextToken();
                    directoryLimits.setCloudOnlyDirectoriesLimitReached(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ConnectedDirectoriesLimit", targetDepth)) {
                    context.nextToken();
                    directoryLimits.setConnectedDirectoriesLimit(IntegerJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ConnectedDirectoriesCurrentCount", targetDepth)) {
                    context.nextToken();
                    directoryLimits.setConnectedDirectoriesCurrentCount(IntegerJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ConnectedDirectoriesLimitReached", targetDepth)) {
                    context.nextToken();
                    directoryLimits.setConnectedDirectoriesLimitReached(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DirectoryLimitsJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DirectoryLimitsJsonUnmarshaller();
        return instance;
    }
}
