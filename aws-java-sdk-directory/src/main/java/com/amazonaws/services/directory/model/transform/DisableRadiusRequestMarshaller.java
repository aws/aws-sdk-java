...
public class DisableRadiusRequestMarshaller implements
    ...
    public Request<DisableRadiusRequest> marshall(
        ...
        Request<DisableRadiusRequest> request = new DefaultRequest<DisableRadiusRequest>(
                disableRadiusRequest, "AWSDirectoryService");
        ...
        try {
            ...
            if (disableRadiusRequest.getDirectoryId() != null) {
                jsonWriter.key("DirectoryId").value(
                        disableRadiusRequest.getDirectoryId());
            }
