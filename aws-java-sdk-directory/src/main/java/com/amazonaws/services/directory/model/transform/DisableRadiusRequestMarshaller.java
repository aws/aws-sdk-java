...
/**
 * DisableRadiusRequestMarshaller
 */
...
public class DisableRadiusRequestMarshaller {
    ...
    private static final DisableRadiusRequestMarshaller instance = new DisableRadiusRequestMarshaller();

    public static DisableRadiusRequestMarshaller getInstance() {
        return instance;
    }
