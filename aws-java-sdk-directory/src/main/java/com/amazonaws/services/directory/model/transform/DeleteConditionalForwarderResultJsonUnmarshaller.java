 ...
 */
public class DeleteConditionalForwarderResultJsonUnmarshaller implements
        Unmarshaller<DeleteConditionalForwarderResult, JsonUnmarshallerContext> {

    public DeleteConditionalForwarderResult unmarshall(
            JsonUnmarshallerContext context) throws Exception {
        DeleteConditionalForwarderResult deleteConditionalForwarderResult = new DeleteConditionalForwarderResult();
