 ...
 * </p>
 */
public class DescribeDirectoriesResult extends
     ...
     * </p>
     * 
     * @return The list of <a>DirectoryDescription</a> objects that were
     *         retrieved.</p>
     *         <p>
    ...
    public void setDirectoryDescriptions(
        ...
        this.directoryDescriptions = new com.amazonaws.internal.SdkInternalList<DirectoryDescription>(
     ...
     * {@link #withDirectoryDescriptions(java.util.Collection)} if you want to
    ...
    public DescribeDirectoriesResult withDirectoryDescriptions(
        ...
        if (this.directoryDescriptions == null) {
            setDirectoryDescriptions(new com.amazonaws.internal.SdkInternalList<DirectoryDescription>(
                    directoryDescriptions.length));
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDirectoryDescriptions() == null
                ^ this.getDirectoryDescriptions() == null)
            return false;
        if (other.getDirectoryDescriptions() != null
                && other.getDirectoryDescriptions().equals(
                        this.getDirectoryDescriptions()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getDirectoryDescriptions() == null) ? 0
                        : getDirectoryDescriptions().hashCode());
