...
public class NumberSubmittedItemsExceededExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null
                || !errorCode.equals("NumberSubmittedItemsExceeded"))
            return null;

        NumberSubmittedItemsExceededException e = (NumberSubmittedItemsExceededException) super
                .unmarshall(node);
