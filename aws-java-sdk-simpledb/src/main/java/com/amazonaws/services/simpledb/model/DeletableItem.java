...
public class DeletableItem implements Serializable, Cloneable {
    ...
    /**
     * Default constructor for DeletableItem object. Callers should use the
    ...
    /**
     * Constructs a new DeletableItem object. Callers should use the setter or
    ...
    public DeletableItem withAttributes(
