...
public class BatchDeleteAttributesRequest extends
    ...
    public void setItems(java.util.Collection<DeletableItem> items) {
        ...
        this.items = new com.amazonaws.internal.SdkInternalList<DeletableItem>(
                items);
    }
    ...
    public BatchDeleteAttributesRequest withItems(DeletableItem... items) {
        if (this.items == null) {
            setItems(new com.amazonaws.internal.SdkInternalList<DeletableItem>(
                    items.length));
        }
    ...
    public BatchDeleteAttributesRequest withItems(
            java.util.Collection<DeletableItem> items) {
        setItems(items);
        return this;
    }
