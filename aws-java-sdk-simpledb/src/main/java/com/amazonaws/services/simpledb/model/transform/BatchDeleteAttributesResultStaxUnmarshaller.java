 ...
 */
public class BatchDeleteAttributesResultStaxUnmarshaller implements
        Unmarshaller<BatchDeleteAttributesResult, StaxUnmarshallerContext> {

    public BatchDeleteAttributesResult unmarshall(
