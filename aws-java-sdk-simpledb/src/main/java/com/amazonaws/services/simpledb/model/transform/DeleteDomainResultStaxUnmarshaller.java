 ...
 */
public class DeleteDomainResultStaxUnmarshaller implements
        Unmarshaller<DeleteDomainResult, StaxUnmarshallerContext> {

    public DeleteDomainResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
