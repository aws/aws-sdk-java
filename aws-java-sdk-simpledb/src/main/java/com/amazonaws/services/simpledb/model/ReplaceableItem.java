...
public class ReplaceableItem implements Serializable, Cloneable {
    ...
    /**
     * Default constructor for ReplaceableItem object. Callers should use the
    ...
    /**
     * Constructs a new ReplaceableItem object. Callers should use the setter or
    ...
    public ReplaceableItem withAttributes(
            java.util.Collection<ReplaceableAttribute> attributes) {
        setAttributes(attributes);
        return this;
    }
