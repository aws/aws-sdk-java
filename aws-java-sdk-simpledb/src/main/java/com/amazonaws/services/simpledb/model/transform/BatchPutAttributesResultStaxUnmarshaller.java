 ...
 */
public class BatchPutAttributesResultStaxUnmarshaller implements
        Unmarshaller<BatchPutAttributesResult, StaxUnmarshallerContext> {

    public BatchPutAttributesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
