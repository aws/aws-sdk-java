...
public class TooManyRequestedAttributesExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null
                || !errorCode.equals("TooManyRequestedAttributes"))
            return null;

        TooManyRequestedAttributesException e = (TooManyRequestedAttributesException) super
                .unmarshall(node);
