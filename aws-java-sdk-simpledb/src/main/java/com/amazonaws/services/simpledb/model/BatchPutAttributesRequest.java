 ...
 * 
 */
public class BatchPutAttributesRequest extends
    ...
    /**
     * Default constructor for BatchPutAttributesRequest object. Callers should
    ...
    /**
     * Constructs a new BatchPutAttributesRequest object. Callers should use the
    ...
    public void setItems(java.util.Collection<ReplaceableItem> items) {
        ...
        this.items = new com.amazonaws.internal.SdkInternalList<ReplaceableItem>(
                items);
    }
    ...
    public BatchPutAttributesRequest withItems(ReplaceableItem... items) {
        if (this.items == null) {
            setItems(new com.amazonaws.internal.SdkInternalList<ReplaceableItem>(
                    items.length));
        }
    ...
    public BatchPutAttributesRequest withItems(
            java.util.Collection<ReplaceableItem> items) {
        setItems(items);
        return this;
    }
