 ...
 */
public class PutAttributesResultStaxUnmarshaller implements
        Unmarshaller<PutAttributesResult, StaxUnmarshallerContext> {

    public PutAttributesResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
