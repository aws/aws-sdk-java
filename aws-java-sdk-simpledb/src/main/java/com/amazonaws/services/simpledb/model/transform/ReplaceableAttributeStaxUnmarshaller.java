 ...
 */
public class ReplaceableAttributeStaxUnmarshaller implements
        Unmarshaller<ReplaceableAttribute, StaxUnmarshallerContext> {

    public ReplaceableAttribute unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Name", targetDepth)) {
                    replaceableAttribute.setName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Value", targetDepth)) {
                    replaceableAttribute.setValue(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Replace", targetDepth)) {
                    replaceableAttribute.setReplace(BooleanStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
