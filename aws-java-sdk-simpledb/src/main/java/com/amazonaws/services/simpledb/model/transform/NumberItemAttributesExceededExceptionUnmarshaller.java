...
public class NumberItemAttributesExceededExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null
                || !errorCode.equals("NumberItemAttributesExceeded"))
            return null;

        NumberItemAttributesExceededException e = (NumberItemAttributesExceededException) super
                .unmarshall(node);
