...
public interface AmazonSimpleDBAsync extends AmazonSimpleDB {
     ...
     */
    java.util.concurrent.Future<BatchDeleteAttributesResult> batchDeleteAttributesAsync(
     ...
     */
    java.util.concurrent.Future<BatchPutAttributesResult> batchPutAttributesAsync(
     ...
     */
    java.util.concurrent.Future<CreateDomainResult> createDomainAsync(
     ...
     */
    java.util.concurrent.Future<DeleteAttributesResult> deleteAttributesAsync(
     ...
     */
    java.util.concurrent.Future<DeleteDomainResult> deleteDomainAsync(
     ...
     */
    java.util.concurrent.Future<DomainMetadataResult> domainMetadataAsync(
     ...
     */
    java.util.concurrent.Future<GetAttributesResult> getAttributesAsync(
     ...
     */
    java.util.concurrent.Future<PutAttributesResult> putAttributesAsync(
     ...
     */
    java.util.concurrent.Future<SelectResult> selectAsync(
