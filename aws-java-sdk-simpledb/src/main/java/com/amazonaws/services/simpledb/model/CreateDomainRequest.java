...
public class CreateDomainRequest extends AmazonWebServiceRequest implements
    ...
    /**
     * Default constructor for CreateDomainRequest object. Callers should use
    ...
    /**
     * Constructs a new CreateDomainRequest object. Callers should use the
     ...
     * '-', and '.'.
     * 
     * @return The name of the domain to create. The name can range between 3
