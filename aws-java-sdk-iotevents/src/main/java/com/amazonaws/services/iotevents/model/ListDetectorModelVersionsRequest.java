...
public class ListDetectorModelVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the detector model whose versions are returned.
     */
    ...
    @Override
    public ListDetectorModelVersionsRequest clone() {
        return (ListDetectorModelVersionsRequest) super.clone();
    }
