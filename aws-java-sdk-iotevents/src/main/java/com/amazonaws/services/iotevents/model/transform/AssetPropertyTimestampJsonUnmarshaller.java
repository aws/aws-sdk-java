...
/**
 * AssetPropertyTimestamp JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssetPropertyTimestampJsonUnmarshaller implements Unmarshaller<AssetPropertyTimestamp, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("timeInSeconds", targetDepth)) {
                    context.nextToken();
                    assetPropertyTimestamp.setTimeInSeconds(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("offsetInNanos", targetDepth)) {
                    context.nextToken();
                    assetPropertyTimestamp.setOffsetInNanos(context.getUnmarshaller(String.class).unmarshall(context));
                }
