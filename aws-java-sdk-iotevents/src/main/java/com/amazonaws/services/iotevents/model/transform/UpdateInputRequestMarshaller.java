...
public class UpdateInputRequestMarshaller {
    ...
    public void marshall(UpdateInputRequest updateInputRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateInputRequest.getInputName(), INPUTNAME_BINDING);
            protocolMarshaller.marshall(updateInputRequest.getInputDescription(), INPUTDESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateInputRequest.getInputDefinition(), INPUTDEFINITION_BINDING);
        } catch (Exception e) {
