...
public class UpdateDetectorModelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateDetectorModelResult withDetectorModelConfiguration(DetectorModelConfiguration detectorModelConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDetectorModelResult == false)
            return false;
        UpdateDetectorModelResult other = (UpdateDetectorModelResult) obj;
    ...
    @Override
    public UpdateDetectorModelResult clone() {
        try {
            return (UpdateDetectorModelResult) super.clone();
