...
/**
 * DeleteAlarmModelResult JSON Unmarshaller
 */
...
public class DeleteAlarmModelResultJsonUnmarshaller implements Unmarshaller<DeleteAlarmModelResult, JsonUnmarshallerContext> {
    ...
    public DeleteAlarmModelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAlarmModelResult deleteAlarmModelResult = new DeleteAlarmModelResult();

        return deleteAlarmModelResult;
    }
