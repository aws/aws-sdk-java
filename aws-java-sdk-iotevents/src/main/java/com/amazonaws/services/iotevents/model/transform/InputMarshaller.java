...
public class InputMarshaller {
    ...
    public void marshall(Input input, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(input.getInputConfiguration(), INPUTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(input.getInputDefinition(), INPUTDEFINITION_BINDING);
        } catch (Exception e) {
