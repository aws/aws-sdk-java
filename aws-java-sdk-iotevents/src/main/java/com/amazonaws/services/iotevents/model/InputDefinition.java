...
public class InputDefinition implements Serializable, Cloneable, StructuredPojo {
     ...
     * those attributes (and their paired values) specified here is available for use in the <code>condition</code>
     ...
     *         a JSON payload, and those attributes (and their paired values) specified here is available for use in the
