...
/**
 * InputSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class InputSummaryMarshaller {
    ...
    private static final InputSummaryMarshaller instance = new InputSummaryMarshaller();

    public static InputSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(InputSummary inputSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(inputSummary.getInputName(), INPUTNAME_BINDING);
            protocolMarshaller.marshall(inputSummary.getInputDescription(), INPUTDESCRIPTION_BINDING);
            protocolMarshaller.marshall(inputSummary.getInputArn(), INPUTARN_BINDING);
            protocolMarshaller.marshall(inputSummary.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(inputSummary.getLastUpdateTime(), LASTUPDATETIME_BINDING);
            protocolMarshaller.marshall(inputSummary.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
