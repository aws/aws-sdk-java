...
/**
 * DeregisterAdminResult JSON Unmarshaller
 */
...
public class DeregisterAdminResultJsonUnmarshaller implements Unmarshaller<DeregisterAdminResult, JsonUnmarshallerContext> {
    ...
    public DeregisterAdminResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterAdminResult deregisterAdminResult = new DeregisterAdminResult();

        return deregisterAdminResult;
    }
