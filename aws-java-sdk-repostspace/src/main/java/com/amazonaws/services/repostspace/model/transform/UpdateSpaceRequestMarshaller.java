...
public class UpdateSpaceRequestMarshaller {
    ...
    public void marshall(UpdateSpaceRequest updateSpaceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateSpaceRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateSpaceRequest.getRoleArn(), ROLEARN_BINDING);
            protocolMarshaller.marshall(updateSpaceRequest.getSpaceId(), SPACEID_BINDING);
            protocolMarshaller.marshall(updateSpaceRequest.getTier(), TIER_BINDING);
        } catch (Exception e) {
