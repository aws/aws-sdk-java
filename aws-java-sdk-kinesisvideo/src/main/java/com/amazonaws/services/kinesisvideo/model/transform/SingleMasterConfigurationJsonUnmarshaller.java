...
/**
 * SingleMasterConfiguration JSON Unmarshaller
 */
...
public class SingleMasterConfigurationJsonUnmarshaller implements Unmarshaller<SingleMasterConfiguration, JsonUnmarshallerContext> {
    ...
    public SingleMasterConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MessageTtlSeconds", targetDepth)) {
                    context.nextToken();
                    singleMasterConfiguration.setMessageTtlSeconds(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
