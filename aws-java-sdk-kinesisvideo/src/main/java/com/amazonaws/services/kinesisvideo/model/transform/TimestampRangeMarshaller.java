...
@SdkInternalApi
public class TimestampRangeMarshaller {
    ...
    private static final MarshallingInfo<java.util.Date> ENDTIMESTAMP_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("EndTimestamp").build();

    private static final TimestampRangeMarshaller instance = new TimestampRangeMarshaller();

    public static TimestampRangeMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(TimestampRange timestampRange, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(timestampRange.getStartTimestamp(), STARTTIMESTAMP_BINDING);
            protocolMarshaller.marshall(timestampRange.getEndTimestamp(), ENDTIMESTAMP_BINDING);
        } catch (Exception e) {
