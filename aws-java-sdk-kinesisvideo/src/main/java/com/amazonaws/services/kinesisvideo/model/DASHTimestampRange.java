...
public class DASHTimestampRange implements Serializable, Cloneable, StructuredPojo {
    ...
    public DASHTimestampRange withStartTimestamp(java.util.Date startTimestamp) {
    ...
    public DASHTimestampRange withEndTimestamp(java.util.Date endTimestamp) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DASHTimestampRange == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kinesisvideo.model.transform.DASHTimestampRangeMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
