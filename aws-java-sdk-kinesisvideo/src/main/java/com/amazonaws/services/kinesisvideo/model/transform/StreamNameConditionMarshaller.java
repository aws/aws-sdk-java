...
/**
 * StreamNameConditionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StreamNameConditionMarshaller {
    ...
    private static final StreamNameConditionMarshaller instance = new StreamNameConditionMarshaller();

    public static StreamNameConditionMarshaller getInstance() {
        return instance;
    }
