...
/**
 * DescribeMediaStorageConfigurationResult JSON Unmarshaller
 */
...
public class DescribeMediaStorageConfigurationResultJsonUnmarshaller implements Unmarshaller<DescribeMediaStorageConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DescribeMediaStorageConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MediaStorageConfiguration", targetDepth)) {
                    context.nextToken();
                    describeMediaStorageConfigurationResult.setMediaStorageConfiguration(MediaStorageConfigurationJsonUnmarshaller.getInstance().unmarshall(
                            context));
                }
