...
/**
 * DescribeImageGenerationConfigurationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeImageGenerationConfigurationResultJsonUnmarshaller implements
        Unmarshaller<DescribeImageGenerationConfigurationResult, JsonUnmarshallerContext> {

    public DescribeImageGenerationConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ImageGenerationConfiguration", targetDepth)) {
                    context.nextToken();
                    describeImageGenerationConfigurationResult.setImageGenerationConfiguration(ImageGenerationConfigurationJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
