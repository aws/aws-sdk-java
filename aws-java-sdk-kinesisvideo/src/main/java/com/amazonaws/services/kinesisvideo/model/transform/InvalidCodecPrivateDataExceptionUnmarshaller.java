...
public class InvalidCodecPrivateDataExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidCodecPrivateDataExceptionUnmarshaller instance;

    public static InvalidCodecPrivateDataExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidCodecPrivateDataExceptionUnmarshaller();
        return instance;
    }
}
