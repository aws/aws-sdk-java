...
/**
 * ResourceEndpointListItem JSON Unmarshaller
 */
...
public class ResourceEndpointListItemJsonUnmarshaller implements Unmarshaller<ResourceEndpointListItem, JsonUnmarshallerContext> {
    ...
    public ResourceEndpointListItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Protocol", targetDepth)) {
                    context.nextToken();
                    resourceEndpointListItem.setProtocol(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ResourceEndpoint", targetDepth)) {
                    context.nextToken();
                    resourceEndpointListItem.setResourceEndpoint(context.getUnmarshaller(String.class).unmarshall(context));
                }
