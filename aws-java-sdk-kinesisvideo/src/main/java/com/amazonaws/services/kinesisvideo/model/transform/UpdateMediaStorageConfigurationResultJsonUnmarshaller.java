...
/**
 * UpdateMediaStorageConfigurationResult JSON Unmarshaller
 */
...
public class UpdateMediaStorageConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateMediaStorageConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateMediaStorageConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateMediaStorageConfigurationResult updateMediaStorageConfigurationResult = new UpdateMediaStorageConfigurationResult();

        return updateMediaStorageConfigurationResult;
    }
