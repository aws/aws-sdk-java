...
public class DescribeEdgeConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DescribeEdgeConfigurationRequest clone() {
        return (DescribeEdgeConfigurationRequest) super.clone();
    }
