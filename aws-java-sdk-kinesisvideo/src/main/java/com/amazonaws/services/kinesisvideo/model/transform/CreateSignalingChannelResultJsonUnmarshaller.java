...
/**
 * CreateSignalingChannelResult JSON Unmarshaller
 */
...
public class CreateSignalingChannelResultJsonUnmarshaller implements Unmarshaller<CreateSignalingChannelResult, JsonUnmarshallerContext> {
    ...
    public CreateSignalingChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChannelARN", targetDepth)) {
                    context.nextToken();
                    createSignalingChannelResult.setChannelARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
