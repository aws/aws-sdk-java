...
/**
 * DeleteSignalingChannelResult JSON Unmarshaller
 */
...
public class DeleteSignalingChannelResultJsonUnmarshaller implements Unmarshaller<DeleteSignalingChannelResult, JsonUnmarshallerContext> {
    ...
    public DeleteSignalingChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSignalingChannelResult deleteSignalingChannelResult = new DeleteSignalingChannelResult();
