...
public class MissingCodecPrivateDataExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MissingCodecPrivateDataExceptionUnmarshaller instance;

    public static MissingCodecPrivateDataExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MissingCodecPrivateDataExceptionUnmarshaller();
        return instance;
    }
}
