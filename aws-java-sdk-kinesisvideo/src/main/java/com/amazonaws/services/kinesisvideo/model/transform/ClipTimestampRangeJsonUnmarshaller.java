...
/**
 * ClipTimestampRange JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ClipTimestampRangeJsonUnmarshaller implements Unmarshaller<ClipTimestampRange, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StartTimestamp", targetDepth)) {
                    context.nextToken();
                    clipTimestampRange.setStartTimestamp(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
                if (context.testExpression("EndTimestamp", targetDepth)) {
                    context.nextToken();
                    clipTimestampRange.setEndTimestamp(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
