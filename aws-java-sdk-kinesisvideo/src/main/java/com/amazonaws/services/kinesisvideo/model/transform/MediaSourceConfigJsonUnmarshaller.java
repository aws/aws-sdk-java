...
/**
 * MediaSourceConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MediaSourceConfigJsonUnmarshaller implements Unmarshaller<MediaSourceConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MediaUriSecretArn", targetDepth)) {
                    context.nextToken();
                    mediaSourceConfig.setMediaUriSecretArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MediaUriType", targetDepth)) {
                    context.nextToken();
                    mediaSourceConfig.setMediaUriType(context.getUnmarshaller(String.class).unmarshall(context));
                }
