...
/**
 * DeleteSamplingRuleRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteSamplingRuleRequestMarshaller {
    ...
    private static final DeleteSamplingRuleRequestMarshaller instance = new DeleteSamplingRuleRequestMarshaller();

    public static DeleteSamplingRuleRequestMarshaller getInstance() {
        return instance;
    }
