...
/**
 * BackendConnectionErrors JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BackendConnectionErrorsJsonUnmarshaller implements Unmarshaller<BackendConnectionErrors, JsonUnmarshallerContext> {

    public BackendConnectionErrors unmarshall(JsonUnmarshallerContext context) throws Exception {
        BackendConnectionErrors backendConnectionErrors = new BackendConnectionErrors();
    ...
    private static BackendConnectionErrorsJsonUnmarshaller instance;

    public static BackendConnectionErrorsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BackendConnectionErrorsJsonUnmarshaller();
        return instance;
    }
}
