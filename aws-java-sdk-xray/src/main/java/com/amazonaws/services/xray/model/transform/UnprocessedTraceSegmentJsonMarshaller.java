...
public class UnprocessedTraceSegmentJsonMarshaller {
     ...
     */
    public void marshall(UnprocessedTraceSegment unprocessedTraceSegment, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (unprocessedTraceSegment.getId() != null) {
                jsonGenerator.writeFieldName("Id").writeValue(unprocessedTraceSegment.getId());
            }
            if (unprocessedTraceSegment.getErrorCode() != null) {
                jsonGenerator.writeFieldName("ErrorCode").writeValue(unprocessedTraceSegment.getErrorCode());
            }
            if (unprocessedTraceSegment.getMessage() != null) {
                jsonGenerator.writeFieldName("Message").writeValue(unprocessedTraceSegment.getMessage());
            }
