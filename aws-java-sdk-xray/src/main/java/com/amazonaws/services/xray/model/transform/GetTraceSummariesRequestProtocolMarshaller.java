...
public class GetTraceSummariesRequestProtocolMarshaller implements Marshaller<Request<GetTraceSummariesRequest>, GetTraceSummariesRequest> {
    ...
    public GetTraceSummariesRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<GetTraceSummariesRequest> marshall(GetTraceSummariesRequest getTraceSummariesRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<GetTraceSummariesRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    getTraceSummariesRequest);

            protocolMarshaller.startMarshalling();
            GetTraceSummariesRequestMarshaller.getInstance().marshall(getTraceSummariesRequest, protocolMarshaller);
