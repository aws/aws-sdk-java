...
public class ServiceIdMarshaller {
    ...
    public void marshall(ServiceId serviceId, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(serviceId.getName(), NAME_BINDING);
            protocolMarshaller.marshall(serviceId.getNames(), NAMES_BINDING);
            protocolMarshaller.marshall(serviceId.getAccountId(), ACCOUNTID_BINDING);
            protocolMarshaller.marshall(serviceId.getType(), TYPE_BINDING);
        } catch (Exception e) {
