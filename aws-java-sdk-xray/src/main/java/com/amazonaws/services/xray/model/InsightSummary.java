 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/InsightSummary" target="_top">AWS API
 *      Documentation</a>
 */
...
public class InsightSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public InsightSummary withCategories(java.util.Collection<String> categories) {
    ...
    public InsightSummary withStartTime(java.util.Date startTime) {
    ...
    public InsightSummary withEndTime(java.util.Date endTime) {
        setEndTime(endTime);
        return this;
    }
    ...
    public InsightSummary withTopAnomalousServices(java.util.Collection<AnomalousService> topAnomalousServices) {
    ...
    public InsightSummary withLastUpdateTime(java.util.Date lastUpdateTime) {
    ...
    public String toString() {
        ...
        if (getTopAnomalousServices() != null)
            sb.append("TopAnomalousServices: ").append(getTopAnomalousServices()).append(",");
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.xray.model.transform.InsightSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
