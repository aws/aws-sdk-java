...
public class AssociateApiResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociateApiResult withApiAssociation(ApiAssociation apiAssociation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateApiResult == false)
            return false;
        AssociateApiResult other = (AssociateApiResult) obj;
    ...
    @Override
    public AssociateApiResult clone() {
        try {
            return (AssociateApiResult) super.clone();
