...
public class CreateDataSourceRequestMarshaller {
    ...
    public void marshall(CreateDataSourceRequest createDataSourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createDataSourceRequest.getOpenSearchServiceConfig(), OPENSEARCHSERVICECONFIG_BINDING);
            ...
            protocolMarshaller.marshall(createDataSourceRequest.getEventBridgeConfig(), EVENTBRIDGECONFIG_BINDING);
            protocolMarshaller.marshall(createDataSourceRequest.getMetricsConfig(), METRICSCONFIG_BINDING);
        } catch (Exception e) {
