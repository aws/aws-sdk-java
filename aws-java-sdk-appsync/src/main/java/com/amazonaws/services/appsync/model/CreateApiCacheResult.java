...
public class CreateApiCacheResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateApiCacheResult withApiCache(ApiCache apiCache) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateApiCacheResult == false)
            return false;
        CreateApiCacheResult other = (CreateApiCacheResult) obj;
    ...
    @Override
    public CreateApiCacheResult clone() {
        try {
            return (CreateApiCacheResult) super.clone();
