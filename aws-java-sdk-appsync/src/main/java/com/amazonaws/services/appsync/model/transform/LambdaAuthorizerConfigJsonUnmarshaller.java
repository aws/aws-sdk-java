...
/**
 * LambdaAuthorizerConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LambdaAuthorizerConfigJsonUnmarshaller implements Unmarshaller<LambdaAuthorizerConfig, JsonUnmarshallerContext> {

    public LambdaAuthorizerConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        LambdaAuthorizerConfig lambdaAuthorizerConfig = new LambdaAuthorizerConfig();
    ...
    private static LambdaAuthorizerConfigJsonUnmarshaller instance;

    public static LambdaAuthorizerConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LambdaAuthorizerConfigJsonUnmarshaller();
        return instance;
    }
}
