...
public class OperationMarshaller {
    ...
    private static final MarshallingInfo<String> EQUATION_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Equation").build();
    ...
    public void marshall(Operation operation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(operation.getEquation(), EQUATION_BINDING);
            protocolMarshaller.marshall(operation.getName(), NAME_BINDING);
            protocolMarshaller.marshall(operation.getOutputType(), OUTPUTTYPE_BINDING);
        } catch (Exception e) {
