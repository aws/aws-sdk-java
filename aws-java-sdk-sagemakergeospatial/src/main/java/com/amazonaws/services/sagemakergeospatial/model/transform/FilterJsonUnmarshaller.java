        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Maximum", targetDepth)) {
                    context.nextToken();
                    filter.setMaximum(context.getUnmarshaller(Float.class).unmarshall(context));
                }
                if (context.testExpression("Minimum", targetDepth)) {
                    context.nextToken();
                    filter.setMinimum(context.getUnmarshaller(Float.class).unmarshall(context));
                }
                ...
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    filter.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
