...
/**
 * StopVectorEnrichmentJobResult JSON Unmarshaller
 */
...
public class StopVectorEnrichmentJobResultJsonUnmarshaller implements Unmarshaller<StopVectorEnrichmentJobResult, JsonUnmarshallerContext> {
    ...
    public StopVectorEnrichmentJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopVectorEnrichmentJobResult stopVectorEnrichmentJobResult = new StopVectorEnrichmentJobResult();

        return stopVectorEnrichmentJobResult;
    }
