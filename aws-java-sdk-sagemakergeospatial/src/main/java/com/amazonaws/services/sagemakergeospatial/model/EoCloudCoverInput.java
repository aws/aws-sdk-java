...
public class EoCloudCoverInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EoCloudCoverInput == false)
            return false;
        EoCloudCoverInput other = (EoCloudCoverInput) obj;
    ...
    @Override
    public EoCloudCoverInput clone() {
        try {
            return (EoCloudCoverInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemakergeospatial.model.transform.EoCloudCoverInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
