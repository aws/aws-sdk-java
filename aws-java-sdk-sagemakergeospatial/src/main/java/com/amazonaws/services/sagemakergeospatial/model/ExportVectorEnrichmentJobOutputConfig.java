 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-geospatial-2020-05-27/ExportVectorEnrichmentJobOutputConfig"
...
public class ExportVectorEnrichmentJobOutputConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExportVectorEnrichmentJobOutputConfig == false)
            return false;
    ...
    public ExportVectorEnrichmentJobOutputConfig clone() {
        try {
            return (ExportVectorEnrichmentJobOutputConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemakergeospatial.model.transform.ExportVectorEnrichmentJobOutputConfigMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
