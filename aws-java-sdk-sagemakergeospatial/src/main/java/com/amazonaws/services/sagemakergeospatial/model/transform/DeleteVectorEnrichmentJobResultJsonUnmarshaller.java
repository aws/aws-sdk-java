...
/**
 * DeleteVectorEnrichmentJobResult JSON Unmarshaller
 */
...
public class DeleteVectorEnrichmentJobResultJsonUnmarshaller implements Unmarshaller<DeleteVectorEnrichmentJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteVectorEnrichmentJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteVectorEnrichmentJobResult deleteVectorEnrichmentJobResult = new DeleteVectorEnrichmentJobResult();

        return deleteVectorEnrichmentJobResult;
    }
