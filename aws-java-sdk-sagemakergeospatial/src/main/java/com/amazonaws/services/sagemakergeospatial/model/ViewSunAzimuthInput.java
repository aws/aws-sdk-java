...
public class ViewSunAzimuthInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ViewSunAzimuthInput == false)
            return false;
        ViewSunAzimuthInput other = (ViewSunAzimuthInput) obj;
    ...
    public ViewSunAzimuthInput clone() {
        try {
            return (ViewSunAzimuthInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemakergeospatial.model.transform.ViewSunAzimuthInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
