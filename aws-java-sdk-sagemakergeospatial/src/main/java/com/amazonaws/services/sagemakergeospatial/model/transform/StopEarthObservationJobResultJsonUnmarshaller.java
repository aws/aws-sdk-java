...
/**
 * StopEarthObservationJobResult JSON Unmarshaller
 */
...
public class StopEarthObservationJobResultJsonUnmarshaller implements Unmarshaller<StopEarthObservationJobResult, JsonUnmarshallerContext> {
    ...
    public StopEarthObservationJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopEarthObservationJobResult stopEarthObservationJobResult = new StopEarthObservationJobResult();

        return stopEarthObservationJobResult;
    }
