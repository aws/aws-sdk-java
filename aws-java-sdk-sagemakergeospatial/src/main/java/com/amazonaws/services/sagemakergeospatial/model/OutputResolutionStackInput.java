...
public class OutputResolutionStackInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OutputResolutionStackInput == false)
            return false;
    ...
    public OutputResolutionStackInput clone() {
        try {
            return (OutputResolutionStackInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemakergeospatial.model.transform.OutputResolutionStackInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
