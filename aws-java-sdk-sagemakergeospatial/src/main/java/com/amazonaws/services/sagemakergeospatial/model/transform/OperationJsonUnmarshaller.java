        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Equation", targetDepth)) {
                    context.nextToken();
                    operation.setEquation(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    operation.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("OutputType", targetDepth)) {
                    context.nextToken();
                    operation.setOutputType(context.getUnmarshaller(String.class).unmarshall(context));
                }
