...
public class StepAdjustmentJsonMarshaller {
     ...
     */
    public void marshall(StepAdjustment stepAdjustment,
        ...
        try {
            ...
            if (stepAdjustment.getMetricIntervalLowerBound() != null) {
                jsonGenerator.writeFieldName("MetricIntervalLowerBound")
                        .writeValue(
                                stepAdjustment.getMetricIntervalLowerBound());
            }
            if (stepAdjustment.getMetricIntervalUpperBound() != null) {
                jsonGenerator.writeFieldName("MetricIntervalUpperBound")
                        .writeValue(
                                stepAdjustment.getMetricIntervalUpperBound());
            }
            if (stepAdjustment.getScalingAdjustment() != null) {
                jsonGenerator.writeFieldName("ScalingAdjustment").writeValue(
                        stepAdjustment.getScalingAdjustment());
            }
