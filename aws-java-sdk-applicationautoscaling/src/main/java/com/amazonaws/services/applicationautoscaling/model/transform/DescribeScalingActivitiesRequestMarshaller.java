...
public class DescribeScalingActivitiesRequestMarshaller
    ...
    public DescribeScalingActivitiesRequestMarshaller(
    ...
    public Request<DescribeScalingActivitiesRequest> marshall(
        ...
        Request<DescribeScalingActivitiesRequest> request = new DefaultRequest<DescribeScalingActivitiesRequest>(
                describeScalingActivitiesRequest, "AWSApplicationAutoScaling");
        ...
        try {
            ...
            if (describeScalingActivitiesRequest.getMaxResults() != null) {
                jsonGenerator.writeFieldName("MaxResults").writeValue(
                        describeScalingActivitiesRequest.getMaxResults());
            }
            if (describeScalingActivitiesRequest.getNextToken() != null) {
                jsonGenerator.writeFieldName("NextToken").writeValue(
                        describeScalingActivitiesRequest.getNextToken());
            }
