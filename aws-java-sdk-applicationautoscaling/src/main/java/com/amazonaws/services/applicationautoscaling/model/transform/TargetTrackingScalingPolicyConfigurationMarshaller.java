...
public class TargetTrackingScalingPolicyConfigurationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> PREDEFINEDMETRICSPECIFICATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("PredefinedMetricSpecification").build();
    private static final MarshallingInfo<StructuredPojo> CUSTOMIZEDMETRICSPECIFICATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
