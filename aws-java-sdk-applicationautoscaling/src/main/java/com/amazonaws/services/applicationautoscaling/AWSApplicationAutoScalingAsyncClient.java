...
public class AWSApplicationAutoScalingAsyncClient extends
    ...
    @Override
    public java.util.concurrent.Future<DeregisterScalableTargetResult> deregisterScalableTargetAsync(
    ...
    public java.util.concurrent.Future<DeregisterScalableTargetResult> deregisterScalableTargetAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeregisterScalableTargetResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<DescribeScalableTargetsResult> describeScalableTargetsAsync(
    ...
    public java.util.concurrent.Future<DescribeScalableTargetsResult> describeScalableTargetsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DescribeScalableTargetsResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<RegisterScalableTargetResult> registerScalableTargetAsync(
    ...
    public java.util.concurrent.Future<RegisterScalableTargetResult> registerScalableTargetAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<RegisterScalableTargetResult>() {
                    @Override
