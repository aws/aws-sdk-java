...
public class DescribeScalingPoliciesRequestMarshaller
    ...
    public Request<DescribeScalingPoliciesRequest> marshall(
        ...
        try {
            ...
            java.util.List<String> policyNamesList = describeScalingPoliciesRequest
                    .getPolicyNames();
