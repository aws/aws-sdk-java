...
public class PutScalingPolicyRequestMarshaller implements
    ...
    public PutScalingPolicyRequestMarshaller(
    ...
    public Request<PutScalingPolicyRequest> marshall(
        ...
        Request<PutScalingPolicyRequest> request = new DefaultRequest<PutScalingPolicyRequest>(
                putScalingPolicyRequest, "AWSApplicationAutoScaling");
        ...
        try {
            ...
            if (putScalingPolicyRequest.getPolicyName() != null) {
                jsonGenerator.writeFieldName("PolicyName").writeValue(
                        putScalingPolicyRequest.getPolicyName());
            }
            if (putScalingPolicyRequest.getServiceNamespace() != null) {
                jsonGenerator.writeFieldName("ServiceNamespace").writeValue(
                        putScalingPolicyRequest.getServiceNamespace());
            }
            if (putScalingPolicyRequest.getResourceId() != null) {
                jsonGenerator.writeFieldName("ResourceId").writeValue(
                        putScalingPolicyRequest.getResourceId());
            }
            if (putScalingPolicyRequest.getScalableDimension() != null) {
                jsonGenerator.writeFieldName("ScalableDimension").writeValue(
                        putScalingPolicyRequest.getScalableDimension());
            }
            if (putScalingPolicyRequest.getPolicyType() != null) {
                jsonGenerator.writeFieldName("PolicyType").writeValue(
                        putScalingPolicyRequest.getPolicyType());
            }
            if (putScalingPolicyRequest.getStepScalingPolicyConfiguration() != null) {
                ...
                StepScalingPolicyConfigurationJsonMarshaller
                        .getInstance()
                        .marshall(
