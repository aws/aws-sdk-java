...
public class DescribeScalingPoliciesRequest extends AmazonWebServiceRequest
     ...
     * is associated with. For more information, see <a href=
     ...
     * scaling policy is associated with. For Amazon ECS services, the resource
     ...
     * for the target capacity of an Amazon EC2 Spot fleet request. If you
     ...
     * <code>DescribeScalingPolicies</code> in paginated output. When this
     * parameter is used, <code>DescribeScalingPolicies</code> returns up to
     ...
     * parameter is not used, then <code>DescribeScalingPolicies</code> returns
     ...
     * <code>DescribeScalingPolicies</code> request. Pagination continues from
     ...
     *        policy is associated with. For more information, see <a href=
     *        "http://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#genref-aws-service-namespaces"
     ...
     * @param maxResults
     *        The maximum number of scaling policy results returned by
     *        <code>DescribeScalingPolicies</code> in paginated output. When
     *        this parameter is used, <code>DescribeScalingPolicies</code>
     ...
     *        another <code>DescribeScalingPolicies</code> request with the
     *        returned <code>NextToken</code> value. This value can be between 1
     *        and 50. If this parameter is not used, then
     *        <code>DescribeScalingPolicies</code> returns up to 50 results and
     ...
     *        paginated <code>DescribeScalingPolicies</code> request. Pagination
     ...
     *         paginated <code>DescribeScalingPolicies</code> request.
