...
public class FailedResourceAccessExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FailedResourceAccessExceptionUnmarshaller instance;

    public static FailedResourceAccessExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FailedResourceAccessExceptionUnmarshaller();
        return instance;
    }
}
