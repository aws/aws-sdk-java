...
public class ListCustomRoutingListenersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the accelerator to list listeners for.
     */
    ...
    public ListCustomRoutingListenersRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCustomRoutingListenersRequest == false)
            return false;
        ListCustomRoutingListenersRequest other = (ListCustomRoutingListenersRequest) obj;
    ...
    @Override
    public ListCustomRoutingListenersRequest clone() {
        return (ListCustomRoutingListenersRequest) super.clone();
    }
