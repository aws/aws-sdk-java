...
public class EndpointGroupNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EndpointGroupNotFoundExceptionUnmarshaller instance;

    public static EndpointGroupNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EndpointGroupNotFoundExceptionUnmarshaller();
        return instance;
    }
}
