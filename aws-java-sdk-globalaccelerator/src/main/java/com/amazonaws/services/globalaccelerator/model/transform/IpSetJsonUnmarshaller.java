        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IpFamily", targetDepth)) {
                    context.nextToken();
                    ipSet.setIpFamily(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("IpAddresses", targetDepth)) {
                    context.nextToken();
                    ipSet.setIpAddresses(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("IpAddressFamily", targetDepth)) {
                    context.nextToken();
                    ipSet.setIpAddressFamily(context.getUnmarshaller(String.class).unmarshall(context));
                }
