...
public class AcceleratorNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AcceleratorNotFoundExceptionUnmarshaller instance;

    public static AcceleratorNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AcceleratorNotFoundExceptionUnmarshaller();
        return instance;
    }
}
