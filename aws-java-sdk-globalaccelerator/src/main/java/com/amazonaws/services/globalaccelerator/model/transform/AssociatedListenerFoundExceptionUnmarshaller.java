...
public class AssociatedListenerFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AssociatedListenerFoundExceptionUnmarshaller instance;

    public static AssociatedListenerFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssociatedListenerFoundExceptionUnmarshaller();
        return instance;
    }
}
