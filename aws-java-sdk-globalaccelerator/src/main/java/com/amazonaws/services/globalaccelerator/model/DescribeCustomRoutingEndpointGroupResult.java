...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/globalaccelerator-2018-08-08/DescribeCustomRoutingEndpointGroup"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeCustomRoutingEndpointGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CustomRoutingEndpointGroup getEndpointGroup() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeCustomRoutingEndpointGroupResult == false)
            return false;
        DescribeCustomRoutingEndpointGroupResult other = (DescribeCustomRoutingEndpointGroupResult) obj;
    ...
    public DescribeCustomRoutingEndpointGroupResult clone() {
        try {
            return (DescribeCustomRoutingEndpointGroupResult) super.clone();
