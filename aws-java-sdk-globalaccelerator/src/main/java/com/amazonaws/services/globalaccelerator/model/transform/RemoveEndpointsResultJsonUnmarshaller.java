...
/**
 * RemoveEndpointsResult JSON Unmarshaller
 */
...
public class RemoveEndpointsResultJsonUnmarshaller implements Unmarshaller<RemoveEndpointsResult, JsonUnmarshallerContext> {
    ...
    public RemoveEndpointsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RemoveEndpointsResult removeEndpointsResult = new RemoveEndpointsResult();

        return removeEndpointsResult;
    }
