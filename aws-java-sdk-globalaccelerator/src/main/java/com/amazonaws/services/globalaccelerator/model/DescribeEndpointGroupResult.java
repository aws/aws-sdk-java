...
public class DescribeEndpointGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEndpointGroupResult == false)
            return false;
        DescribeEndpointGroupResult other = (DescribeEndpointGroupResult) obj;
    ...
    public DescribeEndpointGroupResult clone() {
        try {
            return (DescribeEndpointGroupResult) super.clone();
