...
/**
 * DeleteEndpointGroupRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteEndpointGroupRequestMarshaller {
    ...
    private static final DeleteEndpointGroupRequestMarshaller instance = new DeleteEndpointGroupRequestMarshaller();

    public static DeleteEndpointGroupRequestMarshaller getInstance() {
        return instance;
    }
