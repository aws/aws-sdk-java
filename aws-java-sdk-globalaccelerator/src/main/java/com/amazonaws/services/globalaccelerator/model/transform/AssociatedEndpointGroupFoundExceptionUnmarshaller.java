...
public class AssociatedEndpointGroupFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AssociatedEndpointGroupFoundExceptionUnmarshaller instance;

    public static AssociatedEndpointGroupFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssociatedEndpointGroupFoundExceptionUnmarshaller();
        return instance;
    }
}
