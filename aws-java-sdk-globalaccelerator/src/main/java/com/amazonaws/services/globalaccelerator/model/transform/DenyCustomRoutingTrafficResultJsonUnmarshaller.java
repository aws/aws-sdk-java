...
/**
 * DenyCustomRoutingTrafficResult JSON Unmarshaller
 */
...
public class DenyCustomRoutingTrafficResultJsonUnmarshaller implements Unmarshaller<DenyCustomRoutingTrafficResult, JsonUnmarshallerContext> {
    ...
    public DenyCustomRoutingTrafficResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DenyCustomRoutingTrafficResult denyCustomRoutingTrafficResult = new DenyCustomRoutingTrafficResult();

        return denyCustomRoutingTrafficResult;
    }
