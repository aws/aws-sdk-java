...
/**
 * CustomRoutingEndpointGroup JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CustomRoutingEndpointGroupJsonUnmarshaller implements Unmarshaller<CustomRoutingEndpointGroup, JsonUnmarshallerContext> {

    public CustomRoutingEndpointGroup unmarshall(JsonUnmarshallerContext context) throws Exception {
        CustomRoutingEndpointGroup customRoutingEndpointGroup = new CustomRoutingEndpointGroup();
    ...
    private static CustomRoutingEndpointGroupJsonUnmarshaller instance;

    public static CustomRoutingEndpointGroupJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CustomRoutingEndpointGroupJsonUnmarshaller();
        return instance;
    }
}
