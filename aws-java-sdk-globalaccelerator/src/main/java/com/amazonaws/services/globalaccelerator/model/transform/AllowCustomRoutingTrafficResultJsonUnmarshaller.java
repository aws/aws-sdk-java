...
/**
 * AllowCustomRoutingTrafficResult JSON Unmarshaller
 */
...
public class AllowCustomRoutingTrafficResultJsonUnmarshaller implements Unmarshaller<AllowCustomRoutingTrafficResult, JsonUnmarshallerContext> {
    ...
    public AllowCustomRoutingTrafficResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AllowCustomRoutingTrafficResult allowCustomRoutingTrafficResult = new AllowCustomRoutingTrafficResult();

        return allowCustomRoutingTrafficResult;
    }
