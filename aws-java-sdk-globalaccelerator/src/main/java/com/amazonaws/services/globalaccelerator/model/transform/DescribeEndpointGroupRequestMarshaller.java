...
/**
 * DescribeEndpointGroupRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeEndpointGroupRequestMarshaller {
    ...
    private static final DescribeEndpointGroupRequestMarshaller instance = new DescribeEndpointGroupRequestMarshaller();

    public static DescribeEndpointGroupRequestMarshaller getInstance() {
        return instance;
    }
