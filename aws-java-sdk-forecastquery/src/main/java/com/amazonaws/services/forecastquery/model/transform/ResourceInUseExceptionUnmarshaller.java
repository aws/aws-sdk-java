...
public class ResourceInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceInUseExceptionUnmarshaller() {
        super(com.amazonaws.services.forecastquery.model.ResourceInUseException.class, "ResourceInUseException");
    }

    @Override
    public com.amazonaws.services.forecastquery.model.ResourceInUseException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
