...
public class QueryWhatIfForecastRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The start date for the what-if forecast. Specify the date using this format: yyyy-MM-dd'T'HH:mm:ss (ISO 8601
     ...
     * href="https://docs.aws.amazon.com/en_us/forecast/latest/dg/API_CreateWhatIfForecastExport.html"
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the what-if forecast to query.
     */
     ...
     *        8601 format). For example, 2015-01-01T08:00:00.
     */
     ...
     * </p>
     * 
     * @return The start date for the what-if forecast. Specify the date using this format: yyyy-MM-dd'T'HH:mm:ss (ISO
     *         8601 format). For example, 2015-01-01T08:00:00.
     */
     ...
     * </p>
     * 
     * @return The end date for the what-if forecast. Specify the date using this format: yyyy-MM-dd'T'HH:mm:ss (ISO
     *         8601 format). For example, 2015-01-01T20:00:00.
     */
     ...
     *
     * @see QueryWhatIfForecastRequest#withFilters
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof QueryWhatIfForecastRequest == false)
            return false;
        QueryWhatIfForecastRequest other = (QueryWhatIfForecastRequest) obj;
