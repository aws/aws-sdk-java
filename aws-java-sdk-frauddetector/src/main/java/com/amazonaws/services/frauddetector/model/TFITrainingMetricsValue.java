 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/frauddetector-2019-11-15/TFITrainingMetricsValue"
...
public class TFITrainingMetricsValue implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<TFIMetricDataPoint> metricDataPoints;
    /**
     * <p>
    ...
    public java.util.List<TFIMetricDataPoint> getMetricDataPoints() {
    ...
    public void setMetricDataPoints(java.util.Collection<TFIMetricDataPoint> metricDataPoints) {
        if (metricDataPoints == null) {
            this.metricDataPoints = null;
            return;
        }

        this.metricDataPoints = new java.util.ArrayList<TFIMetricDataPoint>(metricDataPoints);
    }
    ...
    public TFITrainingMetricsValue withMetricDataPoints(TFIMetricDataPoint... metricDataPoints) {
        if (this.metricDataPoints == null) {
            setMetricDataPoints(new java.util.ArrayList<TFIMetricDataPoint>(metricDataPoints.length));
        }
    ...
    public TFITrainingMetricsValue withMetricDataPoints(java.util.Collection<TFIMetricDataPoint> metricDataPoints) {
