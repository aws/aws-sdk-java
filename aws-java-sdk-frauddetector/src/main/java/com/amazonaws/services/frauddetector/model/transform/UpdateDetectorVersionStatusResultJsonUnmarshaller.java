...
/**
 * UpdateDetectorVersionStatusResult JSON Unmarshaller
 */
...
public class UpdateDetectorVersionStatusResultJsonUnmarshaller implements Unmarshaller<UpdateDetectorVersionStatusResult, JsonUnmarshallerContext> {
    ...
    public UpdateDetectorVersionStatusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDetectorVersionStatusResult updateDetectorVersionStatusResult = new UpdateDetectorVersionStatusResult();
