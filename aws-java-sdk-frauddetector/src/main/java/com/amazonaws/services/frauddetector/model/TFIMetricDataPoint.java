 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/frauddetector-2019-11-15/TFIMetricDataPoint" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TFIMetricDataPoint implements Serializable, Cloneable, StructuredPojo {
    ...
    public TFIMetricDataPoint withFpr(Float fpr) {
        setFpr(fpr);
        return this;
    }
    ...
    public TFIMetricDataPoint withPrecision(Float precision) {
    ...
    public TFIMetricDataPoint withTpr(Float tpr) {
        setTpr(tpr);
        return this;
    }
    ...
    public TFIMetricDataPoint withThreshold(Float threshold) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TFIMetricDataPoint == false)
            return false;
        TFIMetricDataPoint other = (TFIMetricDataPoint) obj;
    ...
    @Override
    public TFIMetricDataPoint clone() {
        try {
            return (TFIMetricDataPoint) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.frauddetector.model.transform.TFIMetricDataPointMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
