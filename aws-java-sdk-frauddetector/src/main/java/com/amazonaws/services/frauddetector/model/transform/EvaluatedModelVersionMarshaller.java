...
/**
 * EvaluatedModelVersionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EvaluatedModelVersionMarshaller {
    ...
    private static final EvaluatedModelVersionMarshaller instance = new EvaluatedModelVersionMarshaller();

    public static EvaluatedModelVersionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EvaluatedModelVersion evaluatedModelVersion, ProtocolMarshaller protocolMarshaller) {

        if (evaluatedModelVersion == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(evaluatedModelVersion.getModelId(), MODELID_BINDING);
            protocolMarshaller.marshall(evaluatedModelVersion.getModelVersion(), MODELVERSION_BINDING);
            protocolMarshaller.marshall(evaluatedModelVersion.getModelType(), MODELTYPE_BINDING);
            protocolMarshaller.marshall(evaluatedModelVersion.getEvaluations(), EVALUATIONS_BINDING);
        } catch (Exception e) {
