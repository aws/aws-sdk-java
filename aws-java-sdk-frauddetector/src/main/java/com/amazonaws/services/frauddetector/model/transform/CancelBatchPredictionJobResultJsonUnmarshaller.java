...
/**
 * CancelBatchPredictionJobResult JSON Unmarshaller
 */
...
public class CancelBatchPredictionJobResultJsonUnmarshaller implements Unmarshaller<CancelBatchPredictionJobResult, JsonUnmarshallerContext> {
    ...
    public CancelBatchPredictionJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelBatchPredictionJobResult cancelBatchPredictionJobResult = new CancelBatchPredictionJobResult();
