...
/**
 * ModelVariable JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModelVariableJsonUnmarshaller implements Unmarshaller<ModelVariable, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    modelVariable.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("index", targetDepth)) {
                    context.nextToken();
                    modelVariable.setIndex(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
