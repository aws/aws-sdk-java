...
/**
 * OFIMetricDataPointMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OFIMetricDataPointMarshaller {
    ...
    private static final OFIMetricDataPointMarshaller instance = new OFIMetricDataPointMarshaller();

    public static OFIMetricDataPointMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OFIMetricDataPoint oFIMetricDataPoint, ProtocolMarshaller protocolMarshaller) {

        if (oFIMetricDataPoint == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(oFIMetricDataPoint.getFpr(), FPR_BINDING);
            protocolMarshaller.marshall(oFIMetricDataPoint.getPrecision(), PRECISION_BINDING);
            protocolMarshaller.marshall(oFIMetricDataPoint.getTpr(), TPR_BINDING);
            protocolMarshaller.marshall(oFIMetricDataPoint.getThreshold(), THRESHOLD_BINDING);
        } catch (Exception e) {
