...
/**
 * ModelVersionEvaluation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModelVersionEvaluationJsonUnmarshaller implements Unmarshaller<ModelVersionEvaluation, JsonUnmarshallerContext> {

    public ModelVersionEvaluation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ModelVersionEvaluation modelVersionEvaluation = new ModelVersionEvaluation();
    ...
    private static ModelVersionEvaluationJsonUnmarshaller instance;

    public static ModelVersionEvaluationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ModelVersionEvaluationJsonUnmarshaller();
        return instance;
    }
}
