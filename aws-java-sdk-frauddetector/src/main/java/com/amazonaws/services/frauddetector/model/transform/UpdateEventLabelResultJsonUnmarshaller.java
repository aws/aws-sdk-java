...
/**
 * UpdateEventLabelResult JSON Unmarshaller
 */
...
public class UpdateEventLabelResultJsonUnmarshaller implements Unmarshaller<UpdateEventLabelResult, JsonUnmarshallerContext> {
    ...
    public UpdateEventLabelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateEventLabelResult updateEventLabelResult = new UpdateEventLabelResult();
