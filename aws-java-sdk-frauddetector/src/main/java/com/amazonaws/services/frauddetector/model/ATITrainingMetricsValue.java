 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/frauddetector-2019-11-15/ATITrainingMetricsValue"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ATITrainingMetricsValue implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<ATIMetricDataPoint> metricDataPoints;
    /**
     * <p>
    ...
    public java.util.List<ATIMetricDataPoint> getMetricDataPoints() {
    ...
    public void setMetricDataPoints(java.util.Collection<ATIMetricDataPoint> metricDataPoints) {
        if (metricDataPoints == null) {
            this.metricDataPoints = null;
            return;
        }

        this.metricDataPoints = new java.util.ArrayList<ATIMetricDataPoint>(metricDataPoints);
    }
    ...
    public ATITrainingMetricsValue withMetricDataPoints(ATIMetricDataPoint... metricDataPoints) {
        if (this.metricDataPoints == null) {
            setMetricDataPoints(new java.util.ArrayList<ATIMetricDataPoint>(metricDataPoints.length));
        }
    ...
    public ATITrainingMetricsValue withMetricDataPoints(java.util.Collection<ATIMetricDataPoint> metricDataPoints) {
     ...
     * </p>
     * 
     * @return The model's overall performance scores.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ATITrainingMetricsValue == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.frauddetector.model.transform.ATITrainingMetricsValueMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
