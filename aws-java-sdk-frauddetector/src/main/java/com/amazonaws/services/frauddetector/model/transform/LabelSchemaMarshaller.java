...
public class LabelSchemaMarshaller {
    ...
    public static LabelSchemaMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LabelSchema labelSchema, ProtocolMarshaller protocolMarshaller) {
