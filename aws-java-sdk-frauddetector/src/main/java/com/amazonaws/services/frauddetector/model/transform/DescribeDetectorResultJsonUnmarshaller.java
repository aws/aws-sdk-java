        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("detectorId", targetDepth)) {
                    context.nextToken();
                    describeDetectorResult.setDetectorId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeDetectorResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("arn", targetDepth)) {
                    context.nextToken();
                    describeDetectorResult.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
