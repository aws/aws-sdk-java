...
public class PredictionTimeRangeMarshaller {
    ...
    public static PredictionTimeRangeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PredictionTimeRange predictionTimeRange, ProtocolMarshaller protocolMarshaller) {
