...
/**
 * DeleteEventTypeResult JSON Unmarshaller
 */
...
public class DeleteEventTypeResultJsonUnmarshaller implements Unmarshaller<DeleteEventTypeResult, JsonUnmarshallerContext> {
    ...
    public DeleteEventTypeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEventTypeResult deleteEventTypeResult = new DeleteEventTypeResult();
