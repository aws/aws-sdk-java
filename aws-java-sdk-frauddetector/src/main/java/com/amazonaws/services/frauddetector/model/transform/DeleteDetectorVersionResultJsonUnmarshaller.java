...
/**
 * DeleteDetectorVersionResult JSON Unmarshaller
 */
...
public class DeleteDetectorVersionResultJsonUnmarshaller implements Unmarshaller<DeleteDetectorVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteDetectorVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDetectorVersionResult deleteDetectorVersionResult = new DeleteDetectorVersionResult();
