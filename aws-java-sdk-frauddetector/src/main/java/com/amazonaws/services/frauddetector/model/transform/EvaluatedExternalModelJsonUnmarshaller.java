...
/**
 * EvaluatedExternalModel JSON Unmarshaller
 */
...
public class EvaluatedExternalModelJsonUnmarshaller implements Unmarshaller<EvaluatedExternalModel, JsonUnmarshallerContext> {
    ...
    public EvaluatedExternalModel unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("modelEndpoint", targetDepth)) {
                    context.nextToken();
                    evaluatedExternalModel.setModelEndpoint(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("useEventVariables", targetDepth)) {
                    context.nextToken();
                    evaluatedExternalModel.setUseEventVariables(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("inputVariables", targetDepth)) {
                    context.nextToken();
                    evaluatedExternalModel.setInputVariables(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
                            .getUnmarshaller(String.class)).unmarshall(context));
                }
                if (context.testExpression("outputVariables", targetDepth)) {
                    context.nextToken();
                    evaluatedExternalModel.setOutputVariables(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
                            .getUnmarshaller(String.class)).unmarshall(context));
                }
