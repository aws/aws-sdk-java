...
/**
 * IngestedEventStatistics JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IngestedEventStatisticsJsonUnmarshaller implements Unmarshaller<IngestedEventStatistics, JsonUnmarshallerContext> {

    public IngestedEventStatistics unmarshall(JsonUnmarshallerContext context) throws Exception {
        IngestedEventStatistics ingestedEventStatistics = new IngestedEventStatistics();
    ...
    private static IngestedEventStatisticsJsonUnmarshaller instance;

    public static IngestedEventStatisticsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new IngestedEventStatisticsJsonUnmarshaller();
        return instance;
    }
}
