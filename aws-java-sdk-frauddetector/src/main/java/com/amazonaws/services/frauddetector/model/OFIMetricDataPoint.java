 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/frauddetector-2019-11-15/OFIMetricDataPoint" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OFIMetricDataPoint implements Serializable, Cloneable, StructuredPojo {
    ...
    public OFIMetricDataPoint withFpr(Float fpr) {
        setFpr(fpr);
        return this;
    }
    ...
    public OFIMetricDataPoint withPrecision(Float precision) {
    ...
    public OFIMetricDataPoint withTpr(Float tpr) {
        setTpr(tpr);
        return this;
    }
    ...
    public OFIMetricDataPoint withThreshold(Float threshold) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OFIMetricDataPoint == false)
            return false;
    ...
    @Override
    public OFIMetricDataPoint clone() {
        try {
            return (OFIMetricDataPoint) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.frauddetector.model.transform.OFIMetricDataPointMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
