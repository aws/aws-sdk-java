...
public class BlockMarshaller {
    ...
    private static final MarshallingInfo<Integer> BLOCKINDEX_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("BlockIndex").build();
    private static final MarshallingInfo<String> BLOCKTOKEN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("BlockToken").build();
