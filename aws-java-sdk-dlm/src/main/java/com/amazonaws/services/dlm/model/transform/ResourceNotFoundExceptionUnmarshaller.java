...
public class ResourceNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.dlm.model.ResourceNotFoundException> {
    private ResourceNotFoundExceptionUnmarshaller() {
        super("ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.dlm.model.ResourceNotFoundException unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ResourceIds", targetDepth)) {
                    context.nextToken();
                    resourceNotFoundException.setResourceIds(new ListUnmarshaller<String>(context.getUnmarshaller(String.class)).unmarshall(context));
                }
