...
/**
 * GetLifecyclePolicyResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetLifecyclePolicyResultJsonUnmarshaller implements Unmarshaller<GetLifecyclePolicyResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Policy", targetDepth)) {
                    context.nextToken();
                    getLifecyclePolicyResult.setPolicy(LifecyclePolicyJsonUnmarshaller.getInstance().unmarshall(context));
                }
