...
public class SoftwareSetMarshaller {
    ...
    private static final MarshallingInfo<List> SOFTWARE_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(SoftwareSet softwareSet, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(softwareSet.getId(), ID_BINDING);
            protocolMarshaller.marshall(softwareSet.getVersion(), VERSION_BINDING);
            protocolMarshaller.marshall(softwareSet.getReleasedAt(), RELEASEDAT_BINDING);
            protocolMarshaller.marshall(softwareSet.getSupportedUntil(), SUPPORTEDUNTIL_BINDING);
