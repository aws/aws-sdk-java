...
public class ListSoftwareSetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListSoftwareSetsRequest withNextToken(String nextToken) {
    ...
    public ListSoftwareSetsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSoftwareSetsRequest == false)
            return false;
        ListSoftwareSetsRequest other = (ListSoftwareSetsRequest) obj;
    ...
    @Override
    public ListSoftwareSetsRequest clone() {
        return (ListSoftwareSetsRequest) super.clone();
    }
