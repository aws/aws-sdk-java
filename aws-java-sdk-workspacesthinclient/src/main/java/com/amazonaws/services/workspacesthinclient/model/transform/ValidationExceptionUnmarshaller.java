...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.workspacesthinclient.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.workspacesthinclient.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.workspacesthinclient.model.ValidationException validationException = new com.amazonaws.services.workspacesthinclient.model.ValidationException(
                null);
