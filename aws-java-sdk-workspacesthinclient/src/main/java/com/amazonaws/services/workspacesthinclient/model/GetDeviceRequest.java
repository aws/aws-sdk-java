...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-thin-client-2023-08-22/GetDevice" target="_top">AWS
 *      API Documentation</a>
 */
...
public class GetDeviceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the device for which to return information.
     */
    ...
    public GetDeviceRequest withId(String id) {
        setId(id);
        return this;
    }
