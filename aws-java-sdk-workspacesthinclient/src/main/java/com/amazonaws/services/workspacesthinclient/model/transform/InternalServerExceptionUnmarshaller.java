...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.workspacesthinclient.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.workspacesthinclient.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.workspacesthinclient.model.InternalServerException internalServerException = new com.amazonaws.services.workspacesthinclient.model.InternalServerException(
                null);
