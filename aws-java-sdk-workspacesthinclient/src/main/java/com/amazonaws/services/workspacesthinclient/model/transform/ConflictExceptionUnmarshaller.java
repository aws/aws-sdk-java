...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.workspacesthinclient.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.workspacesthinclient.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.workspacesthinclient.model.ConflictException conflictException = new com.amazonaws.services.workspacesthinclient.model.ConflictException(
                null);
