...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.workspacesthinclient.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.workspacesthinclient.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.workspacesthinclient.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.workspacesthinclient.model.ResourceNotFoundException(
                null);
