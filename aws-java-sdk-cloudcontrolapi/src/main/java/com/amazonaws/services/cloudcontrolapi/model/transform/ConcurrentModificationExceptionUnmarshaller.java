...
public class ConcurrentModificationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConcurrentModificationExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudcontrolapi.model.ConcurrentModificationException.class, "ConcurrentModificationException");
    }

    @Override
    public com.amazonaws.services.cloudcontrolapi.model.ConcurrentModificationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudcontrolapi.model.ConcurrentModificationException concurrentModificationException = new com.amazonaws.services.cloudcontrolapi.model.ConcurrentModificationException(
                null);
