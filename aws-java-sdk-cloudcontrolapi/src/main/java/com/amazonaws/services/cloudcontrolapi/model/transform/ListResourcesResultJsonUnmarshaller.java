        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TypeName", targetDepth)) {
                    context.nextToken();
                    listResourcesResult.setTypeName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ResourceDescriptions", targetDepth)) {
                    context.nextToken();
                    listResourcesResult.setResourceDescriptions(new ListUnmarshaller<ResourceDescription>(ResourceDescriptionJsonUnmarshaller.getInstance())
