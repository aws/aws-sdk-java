...
public class AlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AlreadyExistsExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudcontrolapi.model.AlreadyExistsException.class, "AlreadyExistsException");
    }

    @Override
    public com.amazonaws.services.cloudcontrolapi.model.AlreadyExistsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudcontrolapi.model.AlreadyExistsException alreadyExistsException = new com.amazonaws.services.cloudcontrolapi.model.AlreadyExistsException(
                null);
