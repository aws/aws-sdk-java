...
public class AWSCloudControlApiException extends com.amazonaws.AmazonServiceException {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new AWSCloudControlApiException with the specified error message.
     *
     * @param message
