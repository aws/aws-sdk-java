        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TypeName", targetDepth)) {
                    context.nextToken();
                    getResourceResult.setTypeName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ResourceDescription", targetDepth)) {
                    context.nextToken();
                    getResourceResult.setResourceDescription(ResourceDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
