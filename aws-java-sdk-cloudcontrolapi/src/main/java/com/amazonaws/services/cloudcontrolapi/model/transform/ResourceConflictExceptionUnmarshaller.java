...
public class ResourceConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudcontrolapi.model.ResourceConflictException.class, "ResourceConflictException");
    }

    @Override
    public com.amazonaws.services.cloudcontrolapi.model.ResourceConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudcontrolapi.model.ResourceConflictException resourceConflictException = new com.amazonaws.services.cloudcontrolapi.model.ResourceConflictException(
                null);
