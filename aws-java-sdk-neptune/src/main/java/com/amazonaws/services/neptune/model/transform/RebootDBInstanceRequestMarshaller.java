...
/**
 * RebootDBInstanceRequest Marshaller
 */
...
public class RebootDBInstanceRequestMarshaller implements Marshaller<Request<RebootDBInstanceRequest>, RebootDBInstanceRequest> {
    ...
    public Request<RebootDBInstanceRequest> marshall(RebootDBInstanceRequest rebootDBInstanceRequest) {
        ...
        Request<RebootDBInstanceRequest> request = new DefaultRequest<RebootDBInstanceRequest>(rebootDBInstanceRequest, "AmazonNeptune");
        ...
        if (rebootDBInstanceRequest.getForceFailover() != null) {
            request.addParameter("ForceFailover", StringUtils.fromBoolean(rebootDBInstanceRequest.getForceFailover()));
        }
