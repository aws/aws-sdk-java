...
public class InvalidDBInstanceStateExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public InvalidDBInstanceStateExceptionUnmarshaller() {
        super(InvalidDBInstanceStateException.class);
    }
