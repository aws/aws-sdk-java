...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/RemoveFromGlobalCluster" target="_top">AWS
 *      API Documentation</a>
 */
...
public class RemoveFromGlobalClusterRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The identifier of the Neptune global database from which to detach the specified Neptune DB cluster.
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) identifying the cluster to be detached from the Neptune global database
     *         cluster.
     */
