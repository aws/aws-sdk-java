 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DeleteDBClusterEndpoint" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteDBClusterEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteDBClusterEndpointResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public DeleteDBClusterEndpointResult withStaticMembers(String... staticMembers) {
    ...
    public DeleteDBClusterEndpointResult withStaticMembers(java.util.Collection<String> staticMembers) {
    ...
    public DeleteDBClusterEndpointResult withExcludedMembers(String... excludedMembers) {
    ...
    public DeleteDBClusterEndpointResult withExcludedMembers(java.util.Collection<String> excludedMembers) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDBClusterEndpointResult == false)
            return false;
        DeleteDBClusterEndpointResult other = (DeleteDBClusterEndpointResult) obj;
