...
/**
 * <p>
 * An object that defines a Amazon Pinpoint destination for email events. You can use Amazon Pinpoint events to create
 * attributes in Amazon Pinpoint projects. You can use these attributes to create segments for your campaigns.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PinpointDestination" target="_top">AWS
 *      API Documentation</a>
 */
...
public class PinpointDestination implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pinpointemail.model.transform.PinpointDestinationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
