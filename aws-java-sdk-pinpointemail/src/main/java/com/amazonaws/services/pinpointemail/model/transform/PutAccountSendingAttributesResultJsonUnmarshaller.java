...
/**
 * PutAccountSendingAttributesResult JSON Unmarshaller
 */
...
public class PutAccountSendingAttributesResultJsonUnmarshaller implements Unmarshaller<PutAccountSendingAttributesResult, JsonUnmarshallerContext> {
    ...
    public PutAccountSendingAttributesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutAccountSendingAttributesResult putAccountSendingAttributesResult = new PutAccountSendingAttributesResult();

        return putAccountSendingAttributesResult;
    }
