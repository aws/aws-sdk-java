...
/**
 * IdentityInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IdentityInfoJsonUnmarshaller implements Unmarshaller<IdentityInfo, JsonUnmarshallerContext> {

    public IdentityInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static IdentityInfoJsonUnmarshaller instance;

    public static IdentityInfoJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new IdentityInfoJsonUnmarshaller();
        return instance;
    }
}
