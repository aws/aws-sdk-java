...
public class AccountSuspendedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AccountSuspendedExceptionUnmarshaller instance;

    public static AccountSuspendedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AccountSuspendedExceptionUnmarshaller();
        return instance;
    }
}
