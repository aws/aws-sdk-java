...
/**
 * ReputationOptionsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ReputationOptionsMarshaller {
    ...
    private static final MarshallingInfo<java.util.Date> LASTFRESHSTART_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("LastFreshStart").timestampFormat("unixTimestamp").build();

    private static final ReputationOptionsMarshaller instance = new ReputationOptionsMarshaller();

    public static ReputationOptionsMarshaller getInstance() {
        return instance;
    }
