...
/**
 * OverallVolume JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OverallVolumeJsonUnmarshaller implements Unmarshaller<OverallVolume, JsonUnmarshallerContext> {

    public OverallVolume unmarshall(JsonUnmarshallerContext context) throws Exception {
        OverallVolume overallVolume = new OverallVolume();
    ...
    private static OverallVolumeJsonUnmarshaller instance;

    public static OverallVolumeJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OverallVolumeJsonUnmarshaller();
        return instance;
    }
}
