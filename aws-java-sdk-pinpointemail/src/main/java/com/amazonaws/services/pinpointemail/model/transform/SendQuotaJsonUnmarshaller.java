...
/**
 * SendQuota JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SendQuotaJsonUnmarshaller implements Unmarshaller<SendQuota, JsonUnmarshallerContext> {

    public SendQuota unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SendQuotaJsonUnmarshaller instance;

    public static SendQuotaJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SendQuotaJsonUnmarshaller();
        return instance;
    }
}
