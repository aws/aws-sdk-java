...
/**
 * DeleteEmailIdentityResult JSON Unmarshaller
 */
...
public class DeleteEmailIdentityResultJsonUnmarshaller implements Unmarshaller<DeleteEmailIdentityResult, JsonUnmarshallerContext> {
    ...
    public DeleteEmailIdentityResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEmailIdentityResult deleteEmailIdentityResult = new DeleteEmailIdentityResult();

        return deleteEmailIdentityResult;
    }
