...
/**
 * DeleteWorkflowStepResult JSON Unmarshaller
 */
...
public class DeleteWorkflowStepResultJsonUnmarshaller implements Unmarshaller<DeleteWorkflowStepResult, JsonUnmarshallerContext> {
    ...
    public DeleteWorkflowStepResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteWorkflowStepResult deleteWorkflowStepResult = new DeleteWorkflowStepResult();
