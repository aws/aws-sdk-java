...
/**
 * ListPluginsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListPluginsRequestMarshaller {
    ...
    public static ListPluginsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListPluginsRequest listPluginsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listPluginsRequest == null) {
