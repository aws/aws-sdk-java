...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhuborchestrator.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.migrationhuborchestrator.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhuborchestrator.model.ValidationException validationException = new com.amazonaws.services.migrationhuborchestrator.model.ValidationException(
                null);
