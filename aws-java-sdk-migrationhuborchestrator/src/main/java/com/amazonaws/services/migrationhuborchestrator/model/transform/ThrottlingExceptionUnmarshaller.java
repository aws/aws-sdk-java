...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhuborchestrator.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.migrationhuborchestrator.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhuborchestrator.model.ThrottlingException throttlingException = new com.amazonaws.services.migrationhuborchestrator.model.ThrottlingException(
                null);
