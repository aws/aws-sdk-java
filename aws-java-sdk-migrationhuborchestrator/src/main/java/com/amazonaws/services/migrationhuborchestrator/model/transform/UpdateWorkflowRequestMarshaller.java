...
public class UpdateWorkflowRequestMarshaller {
    ...
    public void marshall(UpdateWorkflowRequest updateWorkflowRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateWorkflowRequest.getInputParameters(), INPUTPARAMETERS_BINDING);
            protocolMarshaller.marshall(updateWorkflowRequest.getStepTargets(), STEPTARGETS_BINDING);
        } catch (Exception e) {
