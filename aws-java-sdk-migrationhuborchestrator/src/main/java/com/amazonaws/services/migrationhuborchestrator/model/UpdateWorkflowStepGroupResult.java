...
public class UpdateWorkflowStepGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateWorkflowStepGroupResult withWorkflowId(String workflowId) {
    ...
    public UpdateWorkflowStepGroupResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public UpdateWorkflowStepGroupResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public UpdateWorkflowStepGroupResult withDescription(String description) {
    ...
    public UpdateWorkflowStepGroupResult withTools(Tool... tools) {
        if (this.tools == null) {
    ...
    public UpdateWorkflowStepGroupResult withTools(java.util.Collection<Tool> tools) {
        setTools(tools);
        return this;
    }
    ...
    public UpdateWorkflowStepGroupResult withNext(String... next) {
        if (this.next == null) {
    ...
    public UpdateWorkflowStepGroupResult withNext(java.util.Collection<String> next) {
        setNext(next);
        return this;
    }
    ...
    public UpdateWorkflowStepGroupResult withPrevious(String... previous) {
    ...
    public UpdateWorkflowStepGroupResult withPrevious(java.util.Collection<String> previous) {
    ...
    public UpdateWorkflowStepGroupResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateWorkflowStepGroupResult == false)
            return false;
        UpdateWorkflowStepGroupResult other = (UpdateWorkflowStepGroupResult) obj;
    ...
    @Override
    public UpdateWorkflowStepGroupResult clone() {
        try {
