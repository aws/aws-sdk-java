...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhuborchestrator.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.migrationhuborchestrator.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhuborchestrator.model.ConflictException conflictException = new com.amazonaws.services.migrationhuborchestrator.model.ConflictException(
                null);
