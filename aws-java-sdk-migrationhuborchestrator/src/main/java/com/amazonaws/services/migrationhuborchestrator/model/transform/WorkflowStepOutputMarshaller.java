...
/**
 * WorkflowStepOutputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class WorkflowStepOutputMarshaller {
    ...
    private static final WorkflowStepOutputMarshaller instance = new WorkflowStepOutputMarshaller();

    public static WorkflowStepOutputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(WorkflowStepOutput workflowStepOutput, ProtocolMarshaller protocolMarshaller) {

        if (workflowStepOutput == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(workflowStepOutput.getName(), NAME_BINDING);
            protocolMarshaller.marshall(workflowStepOutput.getDataType(), DATATYPE_BINDING);
            protocolMarshaller.marshall(workflowStepOutput.getRequired(), REQUIRED_BINDING);
            protocolMarshaller.marshall(workflowStepOutput.getValue(), VALUE_BINDING);
        } catch (Exception e) {
