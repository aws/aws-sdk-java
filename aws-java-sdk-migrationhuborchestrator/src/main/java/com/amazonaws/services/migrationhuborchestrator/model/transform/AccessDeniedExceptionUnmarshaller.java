...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhuborchestrator.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.migrationhuborchestrator.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhuborchestrator.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.migrationhuborchestrator.model.AccessDeniedException(
                null);
