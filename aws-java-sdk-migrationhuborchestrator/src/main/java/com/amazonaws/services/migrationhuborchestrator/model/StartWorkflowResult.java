...
public class StartWorkflowResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartWorkflowResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public StartWorkflowResult withStatus(MigrationWorkflowStatusEnum status) {
    ...
    public StartWorkflowResult withLastStartTime(java.util.Date lastStartTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartWorkflowResult == false)
            return false;
        StartWorkflowResult other = (StartWorkflowResult) obj;
    ...
    @Override
    public StartWorkflowResult clone() {
        try {
