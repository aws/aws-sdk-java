...
public class UpdateWorkflowResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the application configured in Application Discovery Service.
     */
     ...
     * </p>
     * 
     * @return The inputs required to update a migration workflow.
     */
    ...
    public UpdateWorkflowResult withWorkflowInputs(java.util.Map<String, StepInput> workflowInputs) {
     ...
     *
     * @see UpdateWorkflowResult#withWorkflowInputs
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateWorkflowResult addWorkflowInputsEntry(String key, StepInput value) {
    ...
    public UpdateWorkflowResult withStepTargets(String... stepTargets) {
    ...
    public UpdateWorkflowResult withStepTargets(java.util.Collection<String> stepTargets) {
    ...
    public UpdateWorkflowResult withCreationTime(java.util.Date creationTime) {
    ...
    public UpdateWorkflowResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public UpdateWorkflowResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateWorkflowResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateWorkflowResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
