...
/**
 * DeleteWorkflowStepGroupResult JSON Unmarshaller
 */
...
public class DeleteWorkflowStepGroupResultJsonUnmarshaller implements Unmarshaller<DeleteWorkflowStepGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteWorkflowStepGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteWorkflowStepGroupResult deleteWorkflowStepGroupResult = new DeleteWorkflowStepGroupResult();
