...
/**
 * PlatformCommandMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PlatformCommandMarshaller {
    ...
    private static final PlatformCommandMarshaller instance = new PlatformCommandMarshaller();

    public static PlatformCommandMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PlatformCommand platformCommand, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(platformCommand.getLinux(), LINUX_BINDING);
            protocolMarshaller.marshall(platformCommand.getWindows(), WINDOWS_BINDING);
        } catch (Exception e) {
