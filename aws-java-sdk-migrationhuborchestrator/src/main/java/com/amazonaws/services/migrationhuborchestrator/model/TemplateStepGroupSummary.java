 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/migrationhuborchestrator-2021-08-28/TemplateStepGroupSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TemplateStepGroupSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public TemplateStepGroupSummary withPrevious(java.util.Collection<String> previous) {
    ...
    public TemplateStepGroupSummary withNext(java.util.Collection<String> next) {
        setNext(next);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TemplateStepGroupSummary == false)
            return false;
        TemplateStepGroupSummary other = (TemplateStepGroupSummary) obj;
    ...
    @Override
    public TemplateStepGroupSummary clone() {
        try {
            return (TemplateStepGroupSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.migrationhuborchestrator.model.transform.TemplateStepGroupSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
