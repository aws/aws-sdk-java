...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.controlcatalog.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.controlcatalog.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.controlcatalog.model.ValidationException validationException = new com.amazonaws.services.controlcatalog.model.ValidationException(
                null);
