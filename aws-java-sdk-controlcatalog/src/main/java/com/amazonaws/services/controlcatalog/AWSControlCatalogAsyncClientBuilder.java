...
/**
 * Fluent builder for {@link com.amazonaws.services.controlcatalog.AWSControlCatalogAsync}. Use of the builder is
...
public final class AWSControlCatalogAsyncClientBuilder extends AwsAsyncClientBuilder<AWSControlCatalogAsyncClientBuilder, AWSControlCatalogAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSControlCatalogAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSControlCatalogAsync.
     */
    @Override
    protected AWSControlCatalogAsync build(AwsAsyncClientParams params) {
        return new AWSControlCatalogAsyncClient(params);
    }
