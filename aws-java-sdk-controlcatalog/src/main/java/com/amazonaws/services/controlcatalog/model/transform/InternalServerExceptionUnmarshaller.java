...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.controlcatalog.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.controlcatalog.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.controlcatalog.model.InternalServerException internalServerException = new com.amazonaws.services.controlcatalog.model.InternalServerException(
                null);
