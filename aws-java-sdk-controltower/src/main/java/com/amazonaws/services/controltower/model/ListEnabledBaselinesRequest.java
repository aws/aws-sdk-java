...
public class ListEnabledBaselinesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * @param filter
     *        A filter applied on the <code>ListEnabledBaseline</code> operation. Allowed filters are
     *        <code>baselineIdentifiers</code> and <code>targetIdentifiers</code>. The filter can be applied for either,
     *        or both.
     */

    public void setFilter(EnabledBaselineFilter filter) {
        this.filter = filter;
    }
    ...
    public EnabledBaselineFilter getFilter() {
        return this.filter;
    }
    ...
    public ListEnabledBaselinesRequest withFilter(EnabledBaselineFilter filter) {
        setFilter(filter);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEnabledBaselinesRequest == false)
            return false;
    ...
    @Override
    public ListEnabledBaselinesRequest clone() {
        return (ListEnabledBaselinesRequest) super.clone();
    }
