...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/controltower-2018-05-10/ResetLandingZone" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResetLandingZoneResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ResetLandingZoneResult withOperationIdentifier(String operationIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResetLandingZoneResult == false)
            return false;
        ResetLandingZoneResult other = (ResetLandingZoneResult) obj;
    ...
    public ResetLandingZoneResult clone() {
        try {
            return (ResetLandingZoneResult) super.clone();
