...
public class ResetEnabledBaselineResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ResetEnabledBaselineResult withOperationIdentifier(String operationIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResetEnabledBaselineResult == false)
            return false;
        ResetEnabledBaselineResult other = (ResetEnabledBaselineResult) obj;
    ...
    public ResetEnabledBaselineResult clone() {
        try {
            return (ResetEnabledBaselineResult) super.clone();
