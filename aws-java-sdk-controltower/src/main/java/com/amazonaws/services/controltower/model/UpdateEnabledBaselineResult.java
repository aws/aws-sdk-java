...
public class UpdateEnabledBaselineResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The ID (in UUID format) of the asynchronous <code>UpdateEnabledBaseline</code> operation. This
     ...
     * </p>
     * 
     * @return The ID (in UUID format) of the asynchronous <code>UpdateEnabledBaseline</code> operation. This
     *         <code>operationIdentifier</code> is used to track status through calls to the
     *         <code>GetBaselineOperation</code> API.
     */
    ...
    public UpdateEnabledBaselineResult withOperationIdentifier(String operationIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateEnabledBaselineResult == false)
            return false;
        UpdateEnabledBaselineResult other = (UpdateEnabledBaselineResult) obj;
    ...
    @Override
    public UpdateEnabledBaselineResult clone() {
        try {
            return (UpdateEnabledBaselineResult) super.clone();
