...
/**
 * EnabledBaselineSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EnabledBaselineSummaryMarshaller {
    ...
    private static final EnabledBaselineSummaryMarshaller instance = new EnabledBaselineSummaryMarshaller();

    public static EnabledBaselineSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EnabledBaselineSummary enabledBaselineSummary, ProtocolMarshaller protocolMarshaller) {

        if (enabledBaselineSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(enabledBaselineSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(enabledBaselineSummary.getBaselineIdentifier(), BASELINEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(enabledBaselineSummary.getBaselineVersion(), BASELINEVERSION_BINDING);
            protocolMarshaller.marshall(enabledBaselineSummary.getStatusSummary(), STATUSSUMMARY_BINDING);
            protocolMarshaller.marshall(enabledBaselineSummary.getTargetIdentifier(), TARGETIDENTIFIER_BINDING);
        } catch (Exception e) {
