...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/controltower-2018-05-10/DisableBaseline" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DisableBaselineRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Identifier of the <code>EnabledBaseline</code> resource to be deactivated, in ARN format.
     */
    ...
    public DisableBaselineRequest withEnabledBaselineIdentifier(String enabledBaselineIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableBaselineRequest == false)
            return false;
        DisableBaselineRequest other = (DisableBaselineRequest) obj;
    ...
    @Override
    public DisableBaselineRequest clone() {
        return (DisableBaselineRequest) super.clone();
    }
