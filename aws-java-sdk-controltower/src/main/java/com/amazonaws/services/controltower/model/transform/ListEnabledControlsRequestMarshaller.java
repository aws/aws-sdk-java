...
/**
 * ListEnabledControlsRequestMarshaller
 */
...
public class ListEnabledControlsRequestMarshaller {
    ...
    private static final ListEnabledControlsRequestMarshaller instance = new ListEnabledControlsRequestMarshaller();

    public static ListEnabledControlsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListEnabledControlsRequest listEnabledControlsRequest, ProtocolMarshaller protocolMarshaller) {
