...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/controltower-2018-05-10/ResetEnabledBaseline" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResetEnabledBaselineRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the ID of the <code>EnabledBaseline</code> resource to be re-enabled, in ARN format.
     */
    ...
    public ResetEnabledBaselineRequest withEnabledBaselineIdentifier(String enabledBaselineIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResetEnabledBaselineRequest == false)
            return false;
        ResetEnabledBaselineRequest other = (ResetEnabledBaselineRequest) obj;
