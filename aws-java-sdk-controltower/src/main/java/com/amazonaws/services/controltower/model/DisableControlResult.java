...
public class DisableControlResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableControlResult == false)
            return false;
        DisableControlResult other = (DisableControlResult) obj;
    ...
    public DisableControlResult clone() {
        try {
            return (DisableControlResult) super.clone();
