...
public class ControlOperationMarshaller {
    ...
    public static ControlOperationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ControlOperation controlOperation, ProtocolMarshaller protocolMarshaller) {
