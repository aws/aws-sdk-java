...
public class DisableBaselineResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The ID (in UUID format) of the asynchronous <code>DisableBaseline</code> operation. This
     ...
     * </p>
     * 
     * @return The ID (in UUID format) of the asynchronous <code>DisableBaseline</code> operation. This
     *         <code>operationIdentifier</code> is used to track status through calls to the
     *         <code>GetBaselineOperation</code> API.
     */
    ...
    public DisableBaselineResult withOperationIdentifier(String operationIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableBaselineResult == false)
            return false;
        DisableBaselineResult other = (DisableBaselineResult) obj;
    ...
    public DisableBaselineResult clone() {
        try {
            return (DisableBaselineResult) super.clone();
