        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("dataviewName", targetDepth)) {
                    context.nextToken();
                    kxDatabaseConfiguration.setDataviewName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("dataviewConfiguration", targetDepth)) {
                    context.nextToken();
                    kxDatabaseConfiguration.setDataviewConfiguration(KxDataviewConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
