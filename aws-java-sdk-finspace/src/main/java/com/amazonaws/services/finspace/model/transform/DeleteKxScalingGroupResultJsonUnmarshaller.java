...
/**
 * DeleteKxScalingGroupResult JSON Unmarshaller
 */
...
public class DeleteKxScalingGroupResultJsonUnmarshaller implements Unmarshaller<DeleteKxScalingGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteKxScalingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteKxScalingGroupResult deleteKxScalingGroupResult = new DeleteKxScalingGroupResult();
