...
public class DeleteKxDataviewRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteKxDataviewRequest withEnvironmentId(String environmentId) {
     ...
     * </p>
     * 
     * @return The name of the database whose dataview you want to delete.
     */
    ...
    public DeleteKxDataviewRequest withDatabaseName(String databaseName) {
     ...
     * </p>
     * 
     * @return The name of the dataview that you want to delete.
     */
    ...
    public DeleteKxDataviewRequest withDataviewName(String dataviewName) {
    ...
    public DeleteKxDataviewRequest withClientToken(String clientToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteKxDataviewRequest == false)
            return false;
        DeleteKxDataviewRequest other = (DeleteKxDataviewRequest) obj;
    ...
    @Override
    public DeleteKxDataviewRequest clone() {
        return (DeleteKxDataviewRequest) super.clone();
    }
