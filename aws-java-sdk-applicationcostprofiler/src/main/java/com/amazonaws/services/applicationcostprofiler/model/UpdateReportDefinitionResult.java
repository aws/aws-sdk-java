...
public class UpdateReportDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateReportDefinitionResult == false)
            return false;
        UpdateReportDefinitionResult other = (UpdateReportDefinitionResult) obj;
    ...
    @Override
    public UpdateReportDefinitionResult clone() {
        try {
            return (UpdateReportDefinitionResult) super.clone();
