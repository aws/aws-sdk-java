...
public class ImportApplicationUsageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return ID of the import request.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportApplicationUsageResult == false)
            return false;
        ImportApplicationUsageResult other = (ImportApplicationUsageResult) obj;
    ...
    @Override
    public ImportApplicationUsageResult clone() {
        try {
            return (ImportApplicationUsageResult) super.clone();
