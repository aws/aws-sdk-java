...
public class GetRestoreTestingPlanRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Required unique name of the restore testing plan.
     */
    ...
    public GetRestoreTestingPlanRequest withRestoreTestingPlanName(String restoreTestingPlanName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetRestoreTestingPlanRequest == false)
            return false;
        GetRestoreTestingPlanRequest other = (GetRestoreTestingPlanRequest) obj;
    ...
    @Override
    public GetRestoreTestingPlanRequest clone() {
        return (GetRestoreTestingPlanRequest) super.clone();
    }
