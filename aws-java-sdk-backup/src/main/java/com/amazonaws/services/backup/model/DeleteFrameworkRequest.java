...
public class DeleteFrameworkRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteFrameworkRequest withFrameworkName(String frameworkName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteFrameworkRequest == false)
            return false;
        DeleteFrameworkRequest other = (DeleteFrameworkRequest) obj;
    ...
    public DeleteFrameworkRequest clone() {
        return (DeleteFrameworkRequest) super.clone();
    }
