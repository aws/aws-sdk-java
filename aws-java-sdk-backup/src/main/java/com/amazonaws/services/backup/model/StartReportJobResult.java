...
public class StartReportJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartReportJobResult == false)
            return false;
        StartReportJobResult other = (StartReportJobResult) obj;
    ...
    public StartReportJobResult clone() {
        try {
            return (StartReportJobResult) super.clone();
