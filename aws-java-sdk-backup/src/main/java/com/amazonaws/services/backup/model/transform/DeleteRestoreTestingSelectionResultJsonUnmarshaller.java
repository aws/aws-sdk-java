...
/**
 * DeleteRestoreTestingSelectionResult JSON Unmarshaller
 */
...
public class DeleteRestoreTestingSelectionResultJsonUnmarshaller implements Unmarshaller<DeleteRestoreTestingSelectionResult, JsonUnmarshallerContext> {
    ...
    public DeleteRestoreTestingSelectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRestoreTestingSelectionResult deleteRestoreTestingSelectionResult = new DeleteRestoreTestingSelectionResult();

        return deleteRestoreTestingSelectionResult;
    }
