...
public class ListCopyJobSummariesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListCopyJobSummariesRequest withAccountId(String accountId) {
    ...
    public ListCopyJobSummariesRequest withState(String state) {
        setState(state);
        return this;
    }
    ...
    public ListCopyJobSummariesRequest withState(CopyJobStatus state) {
    ...
    public ListCopyJobSummariesRequest withResourceType(String resourceType) {
    ...
    public ListCopyJobSummariesRequest withMessageCategory(String messageCategory) {
    ...
    public ListCopyJobSummariesRequest withAggregationPeriod(String aggregationPeriod) {
    ...
    public ListCopyJobSummariesRequest withMaxResults(Integer maxResults) {
    ...
    public ListCopyJobSummariesRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCopyJobSummariesRequest == false)
            return false;
    ...
    @Override
    public ListCopyJobSummariesRequest clone() {
        return (ListCopyJobSummariesRequest) super.clone();
    }
