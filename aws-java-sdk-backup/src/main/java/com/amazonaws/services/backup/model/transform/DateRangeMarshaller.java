...
public class DateRangeMarshaller {
    ...
    private static final MarshallingInfo<java.util.Date> TODATE_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ToDate").timestampFormat("unixTimestamp").build();
    ...
    public void marshall(DateRange dateRange, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dateRange.getFromDate(), FROMDATE_BINDING);
            protocolMarshaller.marshall(dateRange.getToDate(), TODATE_BINDING);
        } catch (Exception e) {
