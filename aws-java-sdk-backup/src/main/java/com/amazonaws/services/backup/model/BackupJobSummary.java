 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/BackupJobSummary" target="_top">AWS API
 *      Documentation</a>
 */
...
public class BackupJobSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public BackupJobSummary withRegion(String region) {
        setRegion(region);
        return this;
    }
    ...
    public BackupJobSummary withAccountId(String accountId) {
    ...
    public BackupJobSummary withState(String state) {
        setState(state);
        return this;
    }
    ...
    public BackupJobSummary withState(BackupJobStatus state) {
    ...
    public BackupJobSummary withResourceType(String resourceType) {
    ...
    public BackupJobSummary withMessageCategory(String messageCategory) {
    ...
    public BackupJobSummary withCount(Integer count) {
        setCount(count);
        return this;
    }
    ...
    public BackupJobSummary withStartTime(java.util.Date startTime) {
    ...
    public BackupJobSummary withEndTime(java.util.Date endTime) {
        setEndTime(endTime);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BackupJobSummary == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.backup.model.transform.BackupJobSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
