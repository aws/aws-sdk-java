...
/**
 * DeleteBackupVaultResult JSON Unmarshaller
 */
...
public class DeleteBackupVaultResultJsonUnmarshaller implements Unmarshaller<DeleteBackupVaultResult, JsonUnmarshallerContext> {
    ...
    public DeleteBackupVaultResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteBackupVaultResult deleteBackupVaultResult = new DeleteBackupVaultResult();
