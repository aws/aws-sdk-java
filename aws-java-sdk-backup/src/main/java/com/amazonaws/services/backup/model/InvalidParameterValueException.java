...
public class InvalidParameterValueException extends com.amazonaws.services.backup.model.AWSBackupException {
    ...
    public InvalidParameterValueException withContext(String context) {
        setContext(context);
        return this;
    }
