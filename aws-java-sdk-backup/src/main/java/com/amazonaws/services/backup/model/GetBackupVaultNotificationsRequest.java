...
public class GetBackupVaultNotificationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetBackupVaultNotificationsRequest withBackupVaultName(String backupVaultName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetBackupVaultNotificationsRequest == false)
            return false;
        GetBackupVaultNotificationsRequest other = (GetBackupVaultNotificationsRequest) obj;
    ...
    @Override
    public GetBackupVaultNotificationsRequest clone() {
        return (GetBackupVaultNotificationsRequest) super.clone();
    }
