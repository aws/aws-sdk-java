        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ConditionType", targetDepth)) {
                    context.nextToken();
                    condition.setConditionType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ConditionKey", targetDepth)) {
                    context.nextToken();
                    condition.setConditionKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ConditionValue", targetDepth)) {
                    context.nextToken();
                    condition.setConditionValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
