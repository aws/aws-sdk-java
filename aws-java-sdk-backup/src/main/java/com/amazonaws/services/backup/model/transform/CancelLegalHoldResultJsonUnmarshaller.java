...
/**
 * CancelLegalHoldResult JSON Unmarshaller
 */
...
public class CancelLegalHoldResultJsonUnmarshaller implements Unmarshaller<CancelLegalHoldResult, JsonUnmarshallerContext> {
    ...
    public CancelLegalHoldResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelLegalHoldResult cancelLegalHoldResult = new CancelLegalHoldResult();

        return cancelLegalHoldResult;
    }
