...
/**
 * ListCopyJobsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListCopyJobsResultJsonUnmarshaller implements Unmarshaller<ListCopyJobsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listCopyJobsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
