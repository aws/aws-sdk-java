...
public class MissingParameterValueException extends com.amazonaws.services.backup.model.AWSBackupException {
    ...
    public MissingParameterValueException withContext(String context) {
        setContext(context);
        return this;
    }
