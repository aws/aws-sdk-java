...
public class ListRestoreJobsByProtectedResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * <code>MaxResults</code> number of items, <code>NextToken</code> allows youto return more items in your list
    ...
    public ListRestoreJobsByProtectedResourceResult withRestoreJobs(RestoreJobsListMember... restoreJobs) {
    ...
    public ListRestoreJobsByProtectedResourceResult withRestoreJobs(java.util.Collection<RestoreJobsListMember> restoreJobs) {
     ...
     * @param nextToken
     *        The next item following a partial list of returned items. For example, if a request is made to return
     *        <code>MaxResults</code> number of items, <code>NextToken</code> allows youto return more items in your
    ...
    public ListRestoreJobsByProtectedResourceResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListRestoreJobsByProtectedResourceResult == false)
            return false;
        ListRestoreJobsByProtectedResourceResult other = (ListRestoreJobsByProtectedResourceResult) obj;
    ...
    public ListRestoreJobsByProtectedResourceResult clone() {
        try {
            return (ListRestoreJobsByProtectedResourceResult) super.clone();
