...
public class DeleteBackupPlanRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteBackupPlanRequest withBackupPlanId(String backupPlanId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteBackupPlanRequest == false)
            return false;
        DeleteBackupPlanRequest other = (DeleteBackupPlanRequest) obj;
    ...
    public DeleteBackupPlanRequest clone() {
        return (DeleteBackupPlanRequest) super.clone();
    }
