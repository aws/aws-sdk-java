...
/**
 * DescribeProtectedResourceRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeProtectedResourceRequestMarshaller {
    ...
    private static final DescribeProtectedResourceRequestMarshaller instance = new DescribeProtectedResourceRequestMarshaller();

    public static DescribeProtectedResourceRequestMarshaller getInstance() {
        return instance;
    }
