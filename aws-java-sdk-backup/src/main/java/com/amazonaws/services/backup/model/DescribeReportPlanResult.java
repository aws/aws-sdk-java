...
public class DescribeReportPlanResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeReportPlanResult == false)
            return false;
        DescribeReportPlanResult other = (DescribeReportPlanResult) obj;
        if (other.getReportPlan() == null ^ this.getReportPlan() == null)
            return false;
        if (other.getReportPlan() != null && other.getReportPlan().equals(this.getReportPlan()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getReportPlan() == null) ? 0 : getReportPlan().hashCode());
        return hashCode;
    }
