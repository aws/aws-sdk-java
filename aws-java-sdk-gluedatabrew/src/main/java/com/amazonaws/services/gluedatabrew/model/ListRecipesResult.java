...
public class ListRecipesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of recipes that are defined.
     */
    ...
    public ListRecipesResult withRecipes(Recipe... recipes) {
    ...
    public ListRecipesResult withRecipes(java.util.Collection<Recipe> recipes) {
        setRecipes(recipes);
        return this;
    }
