...
/**
 * ViewFrame JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ViewFrameJsonUnmarshaller implements Unmarshaller<ViewFrame, JsonUnmarshallerContext> {

    public ViewFrame unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ViewFrameJsonUnmarshaller instance;

    public static ViewFrameJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ViewFrameJsonUnmarshaller();
        return instance;
    }
}
