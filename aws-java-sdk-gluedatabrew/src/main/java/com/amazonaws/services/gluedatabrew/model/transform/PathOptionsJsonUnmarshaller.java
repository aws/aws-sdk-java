...
/**
 * PathOptions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PathOptionsJsonUnmarshaller implements Unmarshaller<PathOptions, JsonUnmarshallerContext> {

    public PathOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static PathOptionsJsonUnmarshaller instance;

    public static PathOptionsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PathOptionsJsonUnmarshaller();
        return instance;
    }
}
