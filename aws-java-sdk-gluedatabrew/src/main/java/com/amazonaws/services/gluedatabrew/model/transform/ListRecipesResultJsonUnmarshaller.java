...
/**
 * ListRecipesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListRecipesResultJsonUnmarshaller implements Unmarshaller<ListRecipesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Recipes", targetDepth)) {
                    context.nextToken();
                    listRecipesResult.setRecipes(new ListUnmarshaller<Recipe>(RecipeJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listRecipesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
