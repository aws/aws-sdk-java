...
public class StatisticsConfigurationMarshaller {
    ...
    private static final MarshallingInfo<List> INCLUDEDSTATISTICS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("IncludedStatistics").build();
