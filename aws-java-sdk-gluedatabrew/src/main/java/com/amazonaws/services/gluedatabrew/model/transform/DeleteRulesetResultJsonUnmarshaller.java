...
/**
 * DeleteRulesetResult JSON Unmarshaller
 */
...
public class DeleteRulesetResultJsonUnmarshaller implements Unmarshaller<DeleteRulesetResult, JsonUnmarshallerContext> {
    ...
    public DeleteRulesetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRulesetResult deleteRulesetResult = new DeleteRulesetResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    deleteRulesetResult.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
