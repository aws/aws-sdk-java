...
public class CreateProjectRequestMarshaller {
    ...
    public void marshall(CreateProjectRequest createProjectRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createProjectRequest.getDatasetName(), DATASETNAME_BINDING);
            protocolMarshaller.marshall(createProjectRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createProjectRequest.getRecipeName(), RECIPENAME_BINDING);
            protocolMarshaller.marshall(createProjectRequest.getSample(), SAMPLE_BINDING);
            protocolMarshaller.marshall(createProjectRequest.getRoleArn(), ROLEARN_BINDING);
