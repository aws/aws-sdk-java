...
/**
 * DeleteWorkerFleetResult JSON Unmarshaller
 */
...
public class DeleteWorkerFleetResultJsonUnmarshaller implements Unmarshaller<DeleteWorkerFleetResult, JsonUnmarshallerContext> {
    ...
    public DeleteWorkerFleetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteWorkerFleetResult deleteWorkerFleetResult = new DeleteWorkerFleetResult();
