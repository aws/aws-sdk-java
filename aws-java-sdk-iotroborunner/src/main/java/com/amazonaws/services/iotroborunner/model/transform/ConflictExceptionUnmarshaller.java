...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.iotroborunner.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.iotroborunner.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iotroborunner.model.ConflictException conflictException = new com.amazonaws.services.iotroborunner.model.ConflictException(null);
