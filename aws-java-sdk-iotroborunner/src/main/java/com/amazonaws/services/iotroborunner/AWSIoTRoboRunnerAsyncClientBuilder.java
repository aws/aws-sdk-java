...
/**
 * Fluent builder for {@link com.amazonaws.services.iotroborunner.AWSIoTRoboRunnerAsync}. Use of the builder is
...
public final class AWSIoTRoboRunnerAsyncClientBuilder extends AwsAsyncClientBuilder<AWSIoTRoboRunnerAsyncClientBuilder, AWSIoTRoboRunnerAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSIoTRoboRunnerAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSIoTRoboRunnerAsync.
     */
    @Override
    protected AWSIoTRoboRunnerAsync build(AwsAsyncClientParams params) {
        return new AWSIoTRoboRunnerAsyncClient(params);
    }
