...
@SdkInternalApi
public class UpdateWorkerRequestMarshaller {
    ...
    private static final UpdateWorkerRequestMarshaller instance = new UpdateWorkerRequestMarshaller();

    public static UpdateWorkerRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateWorkerRequest updateWorkerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateWorkerRequest.getId(), ID_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getAdditionalTransientProperties(), ADDITIONALTRANSIENTPROPERTIES_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getAdditionalFixedProperties(), ADDITIONALFIXEDPROPERTIES_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getVendorProperties(), VENDORPROPERTIES_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getPosition(), POSITION_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getOrientation(), ORIENTATION_BINDING);
        } catch (Exception e) {
