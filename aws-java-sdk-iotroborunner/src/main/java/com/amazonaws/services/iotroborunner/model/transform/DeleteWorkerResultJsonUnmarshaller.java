...
/**
 * DeleteWorkerResult JSON Unmarshaller
 */
...
public class DeleteWorkerResultJsonUnmarshaller implements Unmarshaller<DeleteWorkerResult, JsonUnmarshallerContext> {
    ...
    public DeleteWorkerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteWorkerResult deleteWorkerResult = new DeleteWorkerResult();
