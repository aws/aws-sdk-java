...
public class UpdateWorkerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateWorkerRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public UpdateWorkerRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public UpdateWorkerRequest withAdditionalTransientProperties(String additionalTransientProperties) {
    ...
    public UpdateWorkerRequest withAdditionalFixedProperties(String additionalFixedProperties) {
    ...
    public UpdateWorkerRequest withVendorProperties(VendorProperties vendorProperties) {
    ...
    public UpdateWorkerRequest withPosition(PositionCoordinates position) {
    ...
    public UpdateWorkerRequest withOrientation(Orientation orientation) {
