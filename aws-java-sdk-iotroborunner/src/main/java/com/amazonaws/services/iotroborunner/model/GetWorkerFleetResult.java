...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iot-roborunner-2018-05-10/GetWorkerFleet" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetWorkerFleetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetWorkerFleetResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public GetWorkerFleetResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public GetWorkerFleetResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public GetWorkerFleetResult withSite(String site) {
        setSite(site);
        return this;
    }
    ...
    public GetWorkerFleetResult withCreatedAt(java.util.Date createdAt) {
    ...
    public GetWorkerFleetResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public GetWorkerFleetResult withAdditionalFixedProperties(String additionalFixedProperties) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetWorkerFleetResult == false)
            return false;
        GetWorkerFleetResult other = (GetWorkerFleetResult) obj;
    ...
    @Override
    public GetWorkerFleetResult clone() {
        try {
            return (GetWorkerFleetResult) super.clone();
