 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iot-roborunner-2018-05-10/WorkerFleet" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorkerFleet implements Serializable, Cloneable, StructuredPojo {
    ...
    public WorkerFleet withCreatedAt(java.util.Date createdAt) {
    ...
    public WorkerFleet withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WorkerFleet == false)
            return false;
        WorkerFleet other = (WorkerFleet) obj;
    ...
    @Override
    public WorkerFleet clone() {
        try {
            return (WorkerFleet) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotroborunner.model.transform.WorkerFleetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
