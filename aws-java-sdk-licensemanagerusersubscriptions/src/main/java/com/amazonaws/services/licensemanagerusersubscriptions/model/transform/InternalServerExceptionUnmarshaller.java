...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.licensemanagerusersubscriptions.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.licensemanagerusersubscriptions.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.licensemanagerusersubscriptions.model.InternalServerException internalServerException = new com.amazonaws.services.licensemanagerusersubscriptions.model.InternalServerException(
                null);
