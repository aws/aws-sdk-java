        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SecurityGroupId", targetDepth)) {
                    context.nextToken();
                    settings.setSecurityGroupId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Subnets", targetDepth)) {
                    context.nextToken();
                    settings.setSubnets(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
