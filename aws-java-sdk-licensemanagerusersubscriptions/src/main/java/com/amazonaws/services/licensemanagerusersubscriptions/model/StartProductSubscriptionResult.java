...
public class StartProductSubscriptionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartProductSubscriptionResult withProductUserSummary(ProductUserSummary productUserSummary) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartProductSubscriptionResult == false)
            return false;
        StartProductSubscriptionResult other = (StartProductSubscriptionResult) obj;
    ...
    @Override
    public StartProductSubscriptionResult clone() {
        try {
            return (StartProductSubscriptionResult) super.clone();
