...
public class DescribeJobExecutionRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> INCLUDEJOBDOCUMENT_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("includeJobDocument").build();
    ...
    public void marshall(DescribeJobExecutionRequest describeJobExecutionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(describeJobExecutionRequest.getIncludeJobDocument(), INCLUDEJOBDOCUMENT_BINDING);
