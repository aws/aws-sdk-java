...
public class GetPendingJobExecutionsRequestMarshaller {
    ...
    private static final GetPendingJobExecutionsRequestMarshaller instance = new GetPendingJobExecutionsRequestMarshaller();

    public static GetPendingJobExecutionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetPendingJobExecutionsRequest getPendingJobExecutionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getPendingJobExecutionsRequest.getThingName(), THINGNAME_BINDING);
        } catch (Exception e) {
