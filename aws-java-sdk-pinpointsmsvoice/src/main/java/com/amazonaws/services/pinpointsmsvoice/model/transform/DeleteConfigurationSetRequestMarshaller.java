...
public class DeleteConfigurationSetRequestMarshaller {
    ...
    private static final DeleteConfigurationSetRequestMarshaller instance = new DeleteConfigurationSetRequestMarshaller();

    public static DeleteConfigurationSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteConfigurationSetRequest deleteConfigurationSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteConfigurationSetRequest.getConfigurationSetName(), CONFIGURATIONSETNAME_BINDING);
        } catch (Exception e) {
