...
public class DeleteConfigurationSetEventDestinationRequestMarshaller {
    ...
    private static final DeleteConfigurationSetEventDestinationRequestMarshaller instance = new DeleteConfigurationSetEventDestinationRequestMarshaller();

    public static DeleteConfigurationSetEventDestinationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteConfigurationSetEventDestinationRequest deleteConfigurationSetEventDestinationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteConfigurationSetEventDestinationRequest.getConfigurationSetName(), CONFIGURATIONSETNAME_BINDING);
            protocolMarshaller.marshall(deleteConfigurationSetEventDestinationRequest.getEventDestinationName(), EVENTDESTINATIONNAME_BINDING);
        } catch (Exception e) {
