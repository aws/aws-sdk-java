...
/**
 * VoiceMessageContent JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VoiceMessageContentJsonUnmarshaller implements Unmarshaller<VoiceMessageContent, JsonUnmarshallerContext> {

    public VoiceMessageContent unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static VoiceMessageContentJsonUnmarshaller instance;

    public static VoiceMessageContentJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new VoiceMessageContentJsonUnmarshaller();
        return instance;
    }
}
