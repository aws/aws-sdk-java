        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Address1", targetDepth)) {
                    context.nextToken();
                    address.setAddress1(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Address2", targetDepth)) {
                    context.nextToken();
                    address.setAddress2(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Address3", targetDepth)) {
                    context.nextToken();
                    address.setAddress3(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Address4", targetDepth)) {
                    context.nextToken();
                    address.setAddress4(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("County", targetDepth)) {
                    context.nextToken();
                    address.setCounty(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("Province", targetDepth)) {
                    context.nextToken();
                    address.setProvince(context.getUnmarshaller(String.class).unmarshall(context));
                }
