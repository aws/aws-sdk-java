...
public class ConflictResolutionMarshaller {
    ...
    private static final MarshallingInfo<String> CONFLICTRESOLVINGMODEL_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ConflictResolvingModel").build();
    ...
    public void marshall(ConflictResolution conflictResolution, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(conflictResolution.getConflictResolvingModel(), CONFLICTRESOLVINGMODEL_BINDING);
            protocolMarshaller.marshall(conflictResolution.getSourceName(), SOURCENAME_BINDING);
        } catch (Exception e) {
