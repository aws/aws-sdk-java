...
public class GetWorkflowRequestMarshaller {
    ...
    private static final MarshallingInfo<String> WORKFLOWID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PATH)
            .marshallLocationName("WorkflowId").build();
    ...
    public void marshall(GetWorkflowRequest getWorkflowRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getWorkflowRequest.getDomainName(), DOMAINNAME_BINDING);
            protocolMarshaller.marshall(getWorkflowRequest.getWorkflowId(), WORKFLOWID_BINDING);
        } catch (Exception e) {
