...
public class PutIntegrationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PutIntegrationResult withCreatedAt(java.util.Date createdAt) {
    ...
    public PutIntegrationResult withLastUpdatedAt(java.util.Date lastUpdatedAt) {
    ...
    public PutIntegrationResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see PutIntegrationResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PutIntegrationResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public PutIntegrationResult withObjectTypeNames(java.util.Map<String, String> objectTypeNames) {
     ...
     *
     * @see PutIntegrationResult#withObjectTypeNames
     * @returns a reference to this object so that method calls can be chained together.
     */
