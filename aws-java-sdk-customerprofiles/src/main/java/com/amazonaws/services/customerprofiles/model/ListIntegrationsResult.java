...
public class ListIntegrationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The list of ListIntegrations instances.
     */
    ...
    public ListIntegrationsResult withItems(ListIntegrationItem... items) {
        if (this.items == null) {
    ...
    public ListIntegrationsResult withItems(java.util.Collection<ListIntegrationItem> items) {
        setItems(items);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListIntegrationsResult == false)
            return false;
        ListIntegrationsResult other = (ListIntegrationsResult) obj;
    ...
    @Override
    public ListIntegrationsResult clone() {
        try {
            return (ListIntegrationsResult) super.clone();
