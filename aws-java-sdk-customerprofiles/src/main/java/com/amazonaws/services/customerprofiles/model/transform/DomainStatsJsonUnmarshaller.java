...
/**
 * DomainStats JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DomainStatsJsonUnmarshaller implements Unmarshaller<DomainStats, JsonUnmarshallerContext> {

    public DomainStats unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DomainStatsJsonUnmarshaller instance;

    public static DomainStatsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DomainStatsJsonUnmarshaller();
        return instance;
    }
}
