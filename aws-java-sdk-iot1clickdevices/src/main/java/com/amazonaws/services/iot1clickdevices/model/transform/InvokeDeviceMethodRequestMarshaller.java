...
public class InvokeDeviceMethodRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> DEVICEMETHOD_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("deviceMethod").build();
    private static final MarshallingInfo<String> DEVICEMETHODPARAMETERS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("deviceMethodParameters").build();

    private static final InvokeDeviceMethodRequestMarshaller instance = new InvokeDeviceMethodRequestMarshaller();

    public static InvokeDeviceMethodRequestMarshaller getInstance() {
        return instance;
    }
