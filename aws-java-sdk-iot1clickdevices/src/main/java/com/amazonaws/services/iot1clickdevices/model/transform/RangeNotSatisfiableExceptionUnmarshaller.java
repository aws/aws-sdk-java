...
public class RangeNotSatisfiableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("code", targetDepth)) {
                    context.nextToken();
                    rangeNotSatisfiableException.setCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static RangeNotSatisfiableExceptionUnmarshaller instance;

    public static RangeNotSatisfiableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RangeNotSatisfiableExceptionUnmarshaller();
        return instance;
    }
}
