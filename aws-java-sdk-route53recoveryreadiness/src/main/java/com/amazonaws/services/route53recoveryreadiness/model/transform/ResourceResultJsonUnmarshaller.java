...
/**
 * ResourceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResourceResultJsonUnmarshaller implements Unmarshaller<ResourceResult, JsonUnmarshallerContext> {

    public ResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ResourceResultJsonUnmarshaller instance;

    public static ResourceResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceResultJsonUnmarshaller();
        return instance;
    }
}
