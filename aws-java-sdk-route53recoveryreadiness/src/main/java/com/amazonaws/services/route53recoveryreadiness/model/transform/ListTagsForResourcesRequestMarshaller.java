...
public class ListTagsForResourcesRequestMarshaller {
    ...
    private static final ListTagsForResourcesRequestMarshaller instance = new ListTagsForResourcesRequestMarshaller();

    public static ListTagsForResourcesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListTagsForResourcesRequest listTagsForResourcesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listTagsForResourcesRequest.getResourceArn(), RESOURCEARN_BINDING);
        } catch (Exception e) {
