...
public class CreateResourceSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateResourceSetRequest withResources(Resource... resources) {
    ...
    public CreateResourceSetRequest withResources(java.util.Collection<Resource> resources) {
    ...
    public CreateResourceSetRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateResourceSetRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateResourceSetRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateResourceSetRequest == false)
            return false;
        CreateResourceSetRequest other = (CreateResourceSetRequest) obj;
    ...
    public CreateResourceSetRequest clone() {
        return (CreateResourceSetRequest) super.clone();
    }
