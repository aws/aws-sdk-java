...
public class GetCellResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetCellResult withCells(String... cells) {
        if (this.cells == null) {
    ...
    public GetCellResult withCells(java.util.Collection<String> cells) {
        setCells(cells);
        return this;
    }
    ...
    public GetCellResult withParentReadinessScopes(String... parentReadinessScopes) {
    ...
    public GetCellResult withParentReadinessScopes(java.util.Collection<String> parentReadinessScopes) {
    ...
    public GetCellResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCellResult == false)
            return false;
        GetCellResult other = (GetCellResult) obj;
    ...
    public GetCellResult clone() {
        try {
            return (GetCellResult) super.clone();
