...
/**
 * DeleteCrossAccountAuthorizationResult JSON Unmarshaller
 */
...
public class DeleteCrossAccountAuthorizationResultJsonUnmarshaller implements Unmarshaller<DeleteCrossAccountAuthorizationResult, JsonUnmarshallerContext> {
    ...
    public DeleteCrossAccountAuthorizationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCrossAccountAuthorizationResult deleteCrossAccountAuthorizationResult = new DeleteCrossAccountAuthorizationResult();
