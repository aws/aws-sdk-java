...
public class RecommendationMarshaller {
    ...
    private static final MarshallingInfo<String> RECOMMENDATIONTEXT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public void marshall(Recommendation recommendation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(recommendation.getRecommendationText(), RECOMMENDATIONTEXT_BINDING);
        } catch (Exception e) {
