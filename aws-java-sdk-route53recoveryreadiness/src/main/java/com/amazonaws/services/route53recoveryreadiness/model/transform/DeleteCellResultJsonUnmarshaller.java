...
/**
 * DeleteCellResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteCellResultJsonUnmarshaller implements Unmarshaller<DeleteCellResult, JsonUnmarshallerContext> {

    public DeleteCellResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCellResult deleteCellResult = new DeleteCellResult();
