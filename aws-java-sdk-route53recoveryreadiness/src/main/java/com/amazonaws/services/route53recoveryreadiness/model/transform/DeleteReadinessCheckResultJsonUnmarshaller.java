...
/**
 * DeleteReadinessCheckResult JSON Unmarshaller
 */
...
public class DeleteReadinessCheckResultJsonUnmarshaller implements Unmarshaller<DeleteReadinessCheckResult, JsonUnmarshallerContext> {
    ...
    public DeleteReadinessCheckResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteReadinessCheckResult deleteReadinessCheckResult = new DeleteReadinessCheckResult();
