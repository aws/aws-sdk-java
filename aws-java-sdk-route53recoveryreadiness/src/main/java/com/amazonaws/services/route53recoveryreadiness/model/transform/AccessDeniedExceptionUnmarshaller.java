...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.route53recoveryreadiness.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.route53recoveryreadiness.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.route53recoveryreadiness.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.route53recoveryreadiness.model.AccessDeniedException(
                null);
