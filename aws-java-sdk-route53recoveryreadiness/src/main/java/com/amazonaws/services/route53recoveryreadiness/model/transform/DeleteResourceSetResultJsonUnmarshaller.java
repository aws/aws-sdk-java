...
/**
 * DeleteResourceSetResult JSON Unmarshaller
 */
...
public class DeleteResourceSetResultJsonUnmarshaller implements Unmarshaller<DeleteResourceSetResult, JsonUnmarshallerContext> {
    ...
    public DeleteResourceSetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteResourceSetResult deleteResourceSetResult = new DeleteResourceSetResult();
