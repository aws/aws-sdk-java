...
public class ResourceInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceInUseExceptionUnmarshaller() {
        super(com.amazonaws.services.iotthingsgraph.model.ResourceInUseException.class, "ResourceInUseException");
    }

    @Override
    public com.amazonaws.services.iotthingsgraph.model.ResourceInUseException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
