...
public class GetEntitiesRequestMarshaller {
    ...
    private static final GetEntitiesRequestMarshaller instance = new GetEntitiesRequestMarshaller();

    public static GetEntitiesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetEntitiesRequest getEntitiesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getEntitiesRequest.getIds(), IDS_BINDING);
            protocolMarshaller.marshall(getEntitiesRequest.getNamespaceVersion(), NAMESPACEVERSION_BINDING);
        } catch (Exception e) {
