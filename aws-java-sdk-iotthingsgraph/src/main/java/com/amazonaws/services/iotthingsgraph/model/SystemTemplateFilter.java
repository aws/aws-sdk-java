 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotthingsgraph-2018-09-06/SystemTemplateFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SystemTemplateFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public SystemTemplateFilter withName(String name) {
        setName(name);
        return this;
    }
    ...
    public SystemTemplateFilter withName(SystemTemplateFilterName name) {
    ...
    public SystemTemplateFilter withValue(java.util.Collection<String> value) {
        setValue(value);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SystemTemplateFilter == false)
            return false;
    ...
    @Override
    public SystemTemplateFilter clone() {
        try {
            return (SystemTemplateFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotthingsgraph.model.transform.SystemTemplateFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
