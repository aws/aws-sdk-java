 ...
 * that includes a <code>NAMESPACE</code> and a <code>REFERENCED_ENTITY_ID</code> filter searches for entities in the
 * specified namespace that use the entity specified by the value of <code>REFERENCED_ENTITY_ID</code>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotthingsgraph-2018-09-06/EntityFilter" target="_top">AWS API
 *      Documentation</a>
 */
...
public class EntityFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The name of the entity search filter field. <code>REFERENCED_ENTITY_ID</code> filters on entities that are used
     ...
     * 
     * @param name
     *        The name of the entity search filter field. <code>REFERENCED_ENTITY_ID</code> filters on entities that are
     *        used by the entity in the result set. For example, you can filter on the ID of a property that is used in
     *        a state.
     ...
     * </p>
     * 
     * @return The name of the entity search filter field. <code>REFERENCED_ENTITY_ID</code> filters on entities that
    ...
    public EntityFilter withName(String name) {
        setName(name);
        return this;
    }
    ...
    public EntityFilter withName(EntityFilterName name) {
    ...
    public EntityFilter withValue(java.util.Collection<String> value) {
        setValue(value);
        return this;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotthingsgraph.model.transform.EntityFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
