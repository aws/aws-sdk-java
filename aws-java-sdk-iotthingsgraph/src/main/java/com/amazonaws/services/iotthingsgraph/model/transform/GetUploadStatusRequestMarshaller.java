...
public class GetUploadStatusRequestMarshaller {
    ...
    private static final GetUploadStatusRequestMarshaller instance = new GetUploadStatusRequestMarshaller();

    public static GetUploadStatusRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetUploadStatusRequest getUploadStatusRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getUploadStatusRequest.getUploadId(), UPLOADID_BINDING);
        } catch (Exception e) {
