...
public class GetSystemTemplateRevisionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param id
     *        The ID of the system template.</p>
     *        <p>
     *        The ID should be in the following format.
     *        </p>
     *        <p>
     ...
     * </p>
     * 
     * @return The ID of the system template.</p>
     *         <p>
     *         The ID should be in the following format.
     *         </p>
     *         <p>
    ...
    public GetSystemTemplateRevisionsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSystemTemplateRevisionsRequest == false)
            return false;
        GetSystemTemplateRevisionsRequest other = (GetSystemTemplateRevisionsRequest) obj;
    ...
    @Override
    public GetSystemTemplateRevisionsRequest clone() {
        return (GetSystemTemplateRevisionsRequest) super.clone();
    }
