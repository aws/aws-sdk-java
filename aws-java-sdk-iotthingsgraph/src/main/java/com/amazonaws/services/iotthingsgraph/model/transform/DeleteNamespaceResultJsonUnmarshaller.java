        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("namespaceArn", targetDepth)) {
                    context.nextToken();
                    deleteNamespaceResult.setNamespaceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("namespaceName", targetDepth)) {
                    context.nextToken();
                    deleteNamespaceResult.setNamespaceName(context.getUnmarshaller(String.class).unmarshall(context));
                }
