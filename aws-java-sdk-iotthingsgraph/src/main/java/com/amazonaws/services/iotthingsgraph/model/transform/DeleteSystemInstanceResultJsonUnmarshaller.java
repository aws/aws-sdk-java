...
/**
 * DeleteSystemInstanceResult JSON Unmarshaller
 */
...
public class DeleteSystemInstanceResultJsonUnmarshaller implements Unmarshaller<DeleteSystemInstanceResult, JsonUnmarshallerContext> {
    ...
    public DeleteSystemInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSystemInstanceResult deleteSystemInstanceResult = new DeleteSystemInstanceResult();

        return deleteSystemInstanceResult;
    }
