...
public class GetSystemTemplateRevisionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetSystemTemplateRevisionsResult withSummaries(SystemTemplateSummary... summaries) {
    ...
    public GetSystemTemplateRevisionsResult withSummaries(java.util.Collection<SystemTemplateSummary> summaries) {
    ...
    public GetSystemTemplateRevisionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSystemTemplateRevisionsResult == false)
            return false;
        GetSystemTemplateRevisionsResult other = (GetSystemTemplateRevisionsResult) obj;
    ...
    public GetSystemTemplateRevisionsResult clone() {
        try {
            return (GetSystemTemplateRevisionsResult) super.clone();
