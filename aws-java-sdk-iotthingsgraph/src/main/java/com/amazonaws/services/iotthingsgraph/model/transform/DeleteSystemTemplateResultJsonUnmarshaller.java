...
/**
 * DeleteSystemTemplateResult JSON Unmarshaller
 */
...
public class DeleteSystemTemplateResultJsonUnmarshaller implements Unmarshaller<DeleteSystemTemplateResult, JsonUnmarshallerContext> {
    ...
    public DeleteSystemTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSystemTemplateResult deleteSystemTemplateResult = new DeleteSystemTemplateResult();

        return deleteSystemTemplateResult;
    }
