...
public class ElasticsearchBufferingHints implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * We recommend setting <b>SizeInMBs</b> to a value greater than the amount
     * of data you typically ingest into the delivery stream in 10 seconds. For
     * example, if you typically ingest data at 1 MB/sec, set <b>SizeInMBs</b>
    ...
    public ElasticsearchBufferingHints withIntervalInSeconds(
     ...
     *        <p>
     *        We recommend setting <b>SizeInMBs</b> to a value greater than the
     ...
     *        set <b>SizeInMBs</b> to be 10 MB or higher.
     */
     ...
     *         <p>
     *         We recommend setting <b>SizeInMBs</b> to a value greater than the
     *         amount of data you typically ingest into the delivery stream in
     *         10 seconds. For example, if you typically ingest data at 1
     *         MB/sec, set <b>SizeInMBs</b> to be 10 MB or higher.
     */
