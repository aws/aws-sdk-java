 ...
 */
public class DestinationDescriptionJsonUnmarshaller implements
        Unmarshaller<DestinationDescription, JsonUnmarshallerContext> {
    ...
    public DestinationDescription unmarshall(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("RedshiftDestinationDescription",
                        targetDepth)) {
                    context.nextToken();
                    destinationDescription
