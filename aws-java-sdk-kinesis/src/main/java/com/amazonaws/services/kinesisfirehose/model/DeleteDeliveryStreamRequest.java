...
public class DeleteDeliveryStreamRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * CMK. Firehose might be unable to retire the grant due to a customer error, such as when the CMK or the grant are
     * in an invalid state. If you force deletion, you can then use the <a
     * href="https://docs.aws.amazon.com/kms/latest/APIReference/API_RevokeGrant.html">RevokeGrant</a> operation to
     * revoke the grant you gave to Firehose. If a failure to retire the grant happens due to an Amazon Web Services KMS
     * issue, Firehose keeps retrying the delete operation.
     * </p>
     * <p>
     ...
     *        the grant are in an invalid state. If you force deletion, you can then use the <a
     *        href="https://docs.aws.amazon.com/kms/latest/APIReference/API_RevokeGrant.html">RevokeGrant</a> operation
     *        to revoke the grant you gave to Firehose. If a failure to retire the grant happens due to an Amazon Web
     *        Services KMS issue, Firehose keeps retrying the delete operation.</p>
     *        <p>
     *        The default value is false.
     */
     ...
     * </p>
     * 
     * @return Set this to true if you want to delete the delivery stream even if Firehose is unable to retire the grant
     *         for the CMK. Firehose might be unable to retire the grant due to a customer error, such as when the CMK
     *         or the grant are in an invalid state. If you force deletion, you can then use the <a
     *         href="https://docs.aws.amazon.com/kms/latest/APIReference/API_RevokeGrant.html">RevokeGrant</a> operation
     *         to revoke the grant you gave to Firehose. If a failure to retire the grant happens due to an Amazon Web
     *         Services KMS issue, Firehose keeps retrying the delete operation.</p>
     *         <p>
