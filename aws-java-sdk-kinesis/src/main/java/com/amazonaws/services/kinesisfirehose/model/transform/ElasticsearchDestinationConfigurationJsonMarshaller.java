    ...
    public void marshall(
        ...
        try {
            ...
            if (elasticsearchDestinationConfiguration.getS3BackupMode() != null) {
                jsonGenerator.writeFieldName("S3BackupMode")
                        .writeValue(
                                elasticsearchDestinationConfiguration
                                        .getS3BackupMode());
            }
