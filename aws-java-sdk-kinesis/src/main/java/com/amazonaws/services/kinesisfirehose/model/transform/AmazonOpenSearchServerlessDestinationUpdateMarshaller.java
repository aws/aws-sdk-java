...
/**
 * AmazonOpenSearchServerlessDestinationUpdateMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AmazonOpenSearchServerlessDestinationUpdateMarshaller {
    ...
    private static final AmazonOpenSearchServerlessDestinationUpdateMarshaller instance = new AmazonOpenSearchServerlessDestinationUpdateMarshaller();

    public static AmazonOpenSearchServerlessDestinationUpdateMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AmazonOpenSearchServerlessDestinationUpdate amazonOpenSearchServerlessDestinationUpdate, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(amazonOpenSearchServerlessDestinationUpdate.getRoleARN(), ROLEARN_BINDING);
            protocolMarshaller.marshall(amazonOpenSearchServerlessDestinationUpdate.getCollectionEndpoint(), COLLECTIONENDPOINT_BINDING);
            protocolMarshaller.marshall(amazonOpenSearchServerlessDestinationUpdate.getIndexName(), INDEXNAME_BINDING);
            protocolMarshaller.marshall(amazonOpenSearchServerlessDestinationUpdate.getBufferingHints(), BUFFERINGHINTS_BINDING);
            protocolMarshaller.marshall(amazonOpenSearchServerlessDestinationUpdate.getRetryOptions(), RETRYOPTIONS_BINDING);
            protocolMarshaller.marshall(amazonOpenSearchServerlessDestinationUpdate.getS3Update(), S3UPDATE_BINDING);
            protocolMarshaller.marshall(amazonOpenSearchServerlessDestinationUpdate.getProcessingConfiguration(), PROCESSINGCONFIGURATION_BINDING);
            protocolMarshaller.marshall(amazonOpenSearchServerlessDestinationUpdate.getCloudWatchLoggingOptions(), CLOUDWATCHLOGGINGOPTIONS_BINDING);
        } catch (Exception e) {
