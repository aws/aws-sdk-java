        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("FileExtension", targetDepth)) {
                    context.nextToken();
                    extendedS3DestinationConfiguration.setFileExtension(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("CustomTimeZone", targetDepth)) {
                    context.nextToken();
                    extendedS3DestinationConfiguration.setCustomTimeZone(context.getUnmarshaller(String.class).unmarshall(context));
                }
