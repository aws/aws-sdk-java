...
public class GetKinesisStreamRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetKinesisStreamRequest withDeliveryStreamARN(String deliveryStreamARN) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetKinesisStreamRequest == false)
            return false;
        GetKinesisStreamRequest other = (GetKinesisStreamRequest) obj;
    ...
    @Override
    public GetKinesisStreamRequest clone() {
