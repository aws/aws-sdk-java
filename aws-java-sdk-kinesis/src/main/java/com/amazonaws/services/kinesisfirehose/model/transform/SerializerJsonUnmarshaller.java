...
/**
 * Serializer JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SerializerJsonUnmarshaller implements Unmarshaller<Serializer, JsonUnmarshallerContext> {
    ...
    private static SerializerJsonUnmarshaller instance;

    public static SerializerJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SerializerJsonUnmarshaller();
        return instance;
    }
}
