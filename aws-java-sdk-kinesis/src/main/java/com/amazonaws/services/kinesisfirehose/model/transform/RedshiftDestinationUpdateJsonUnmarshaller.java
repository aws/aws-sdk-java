 ...
 */
public class RedshiftDestinationUpdateJsonUnmarshaller implements
        Unmarshaller<RedshiftDestinationUpdate, JsonUnmarshallerContext> {

    public RedshiftDestinationUpdate unmarshall(JsonUnmarshallerContext context)
            throws Exception {
