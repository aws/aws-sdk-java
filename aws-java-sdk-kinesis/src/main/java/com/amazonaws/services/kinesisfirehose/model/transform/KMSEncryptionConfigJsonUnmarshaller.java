 ...
 */
public class KMSEncryptionConfigJsonUnmarshaller implements
        Unmarshaller<KMSEncryptionConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AWSKMSKeyARN", targetDepth)) {
                    context.nextToken();
                    kMSEncryptionConfig.setAWSKMSKeyARN(StringJsonUnmarshaller
