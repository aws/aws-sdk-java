...
public class ElasticsearchBufferingHintsJsonMarshaller {
     ...
     */
    public void marshall(ElasticsearchBufferingHints elasticsearchBufferingHints, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (elasticsearchBufferingHints.getIntervalInSeconds() != null) {
                jsonGenerator.writeFieldName("IntervalInSeconds").writeValue(elasticsearchBufferingHints.getIntervalInSeconds());
            }
            if (elasticsearchBufferingHints.getSizeInMBs() != null) {
                jsonGenerator.writeFieldName("SizeInMBs").writeValue(elasticsearchBufferingHints.getSizeInMBs());
            }
