...
public class ListDeliveryStreamsRequestMarshaller implements Marshaller<Request<ListDeliveryStreamsRequest>, ListDeliveryStreamsRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public ListDeliveryStreamsRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<ListDeliveryStreamsRequest> marshall(ListDeliveryStreamsRequest listDeliveryStreamsRequest) {
        ...
        Request<ListDeliveryStreamsRequest> request = new DefaultRequest<ListDeliveryStreamsRequest>(listDeliveryStreamsRequest, "AmazonKinesisFirehose");
