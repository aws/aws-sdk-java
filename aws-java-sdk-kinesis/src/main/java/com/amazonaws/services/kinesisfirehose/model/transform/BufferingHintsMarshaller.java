...
public class BufferingHintsMarshaller {
    ...
    public void marshall(BufferingHints bufferingHints, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(bufferingHints.getSizeInMBs(), SIZEINMBS_BINDING);
            protocolMarshaller.marshall(bufferingHints.getIntervalInSeconds(), INTERVALINSECONDS_BINDING);
        } catch (Exception e) {
