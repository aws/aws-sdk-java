 ...
 */
public class S3DestinationUpdateJsonUnmarshaller implements
        Unmarshaller<S3DestinationUpdate, JsonUnmarshallerContext> {

    public S3DestinationUpdate unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("BufferingHints", targetDepth)) {
                    context.nextToken();
                    s3DestinationUpdate
                            .setBufferingHints(BufferingHintsJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
