...
public class BufferingHints implements Serializable, Cloneable {
     ...
     * if you typically ingest data at 1 MB/sec set SizeInMBs to be 10 MB or
     * higher.
     * </p>
     */
     ...
     *        delivering it to the destination. The default value is 5.</p>
     *        <p>
     *        We recommend setting SizeInMBs to a value greater than the amount
     *        of data you typically ingest into the delivery stream in 10
     ...
     * </p>
     * 
     * @return Buffer incoming data for the specified period of time, in
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSizeInMBs() == null ^ this.getSizeInMBs() == null)
            return false;
        if (other.getSizeInMBs() != null
                && other.getSizeInMBs().equals(this.getSizeInMBs()) == false)
            return false;
        if (other.getIntervalInSeconds() == null
                ^ this.getIntervalInSeconds() == null)
            return false;
        if (other.getIntervalInSeconds() != null
                && other.getIntervalInSeconds().equals(
                        this.getIntervalInSeconds()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSizeInMBs() == null) ? 0 : getSizeInMBs().hashCode());
        hashCode = prime
                * hashCode
                + ((getIntervalInSeconds() == null) ? 0
                        : getIntervalInSeconds().hashCode());
        return hashCode;
    }
