...
public class UpdateDestinationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * required, and it helps the service perform conditional operations. For example, if there is an interleaving
     ...
     *        is required, and it helps the service perform conditional operations. For example, if there is an
