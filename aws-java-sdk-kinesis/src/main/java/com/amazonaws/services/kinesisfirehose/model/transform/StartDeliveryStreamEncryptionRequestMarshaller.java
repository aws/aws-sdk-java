...
public class StartDeliveryStreamEncryptionRequestMarshaller {
    ...
    public static StartDeliveryStreamEncryptionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartDeliveryStreamEncryptionRequest startDeliveryStreamEncryptionRequest, ProtocolMarshaller protocolMarshaller) {

        if (startDeliveryStreamEncryptionRequest == null) {
