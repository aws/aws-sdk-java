...
public class ListDeliveryStreamsResultJsonUnmarshaller implements Unmarshaller<ListDeliveryStreamsResult, JsonUnmarshallerContext> {

    public ListDeliveryStreamsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("HasMoreDeliveryStreams", targetDepth)) {
                    context.nextToken();
                    listDeliveryStreamsResult.setHasMoreDeliveryStreams(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
