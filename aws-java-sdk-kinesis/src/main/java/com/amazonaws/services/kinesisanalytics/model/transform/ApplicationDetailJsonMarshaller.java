...
public class ApplicationDetailJsonMarshaller {
     ...
     */
    public void marshall(ApplicationDetail applicationDetail,
        ...
        try {
            ...
            if (applicationDetail.getApplicationName() != null) {
                jsonGenerator.writeFieldName("ApplicationName").writeValue(
                        applicationDetail.getApplicationName());
            }
            if (applicationDetail.getApplicationDescription() != null) {
                jsonGenerator.writeFieldName("ApplicationDescription")
                        .writeValue(
                                applicationDetail.getApplicationDescription());
            }
            if (applicationDetail.getApplicationARN() != null) {
                jsonGenerator.writeFieldName("ApplicationARN").writeValue(
                        applicationDetail.getApplicationARN());
            }
            if (applicationDetail.getApplicationStatus() != null) {
                jsonGenerator.writeFieldName("ApplicationStatus").writeValue(
                        applicationDetail.getApplicationStatus());
            }
            if (applicationDetail.getCreateTimestamp() != null) {
                jsonGenerator.writeFieldName("CreateTimestamp").writeValue(
                        applicationDetail.getCreateTimestamp());
            }
            if (applicationDetail.getLastUpdateTimestamp() != null) {
                jsonGenerator.writeFieldName("LastUpdateTimestamp").writeValue(
                        applicationDetail.getLastUpdateTimestamp());
            }

            java.util.List<InputDescription> inputDescriptionsList = applicationDetail
            ...
            if (inputDescriptionsList != null) {
                ...
                for (InputDescription inputDescriptionsListValue : inputDescriptionsList) {
                    if (inputDescriptionsListValue != null) {
                        ...
                        InputDescriptionJsonMarshaller.getInstance().marshall(
                                inputDescriptionsListValue, jsonGenerator);
                    }
                }
                jsonGenerator.writeEndArray();
            }

            java.util.List<OutputDescription> outputDescriptionsList = applicationDetail
            ...
            if (outputDescriptionsList != null) {
                ...
                for (OutputDescription outputDescriptionsListValue : outputDescriptionsList) {
                    if (outputDescriptionsListValue != null) {
                        ...
                        OutputDescriptionJsonMarshaller.getInstance().marshall(
                                outputDescriptionsListValue, jsonGenerator);
                    }
                }
                jsonGenerator.writeEndArray();
            }

            java.util.List<ReferenceDataSourceDescription> referenceDataSourceDescriptionsList = applicationDetail
            ...
            if (referenceDataSourceDescriptionsList != null) {
                ...
                for (ReferenceDataSourceDescription referenceDataSourceDescriptionsListValue : referenceDataSourceDescriptionsList) {
                    if (referenceDataSourceDescriptionsListValue != null) {
                        ...
                        ReferenceDataSourceDescriptionJsonMarshaller
                                .getInstance()
                                .marshall(
                                        referenceDataSourceDescriptionsListValue,
                                        jsonGenerator);
                    }
                }
                jsonGenerator.writeEndArray();
            ...
            if (applicationDetail.getApplicationCode() != null) {
                jsonGenerator.writeFieldName("ApplicationCode").writeValue(
                        applicationDetail.getApplicationCode());
            }
            if (applicationDetail.getApplicationVersionId() != null) {
                jsonGenerator
                        .writeFieldName("ApplicationVersionId")
                        .writeValue(applicationDetail.getApplicationVersionId());
            }
