 ...
 */
@ThreadSafe
public class AmazonKinesisAnalyticsAsyncClient extends
        AmazonKinesisAnalyticsClient implements AmazonKinesisAnalyticsAsync {
     ...
     * Analytics. A credentials provider chain will be used that searches for
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Kinesis
     * Analytics using the specified AWS account credentials.
     * <p>
     * Asynchronous methods are delegated to a fixed-size thread pool containing
     * 50 threads (to match the default maximum number of concurrent connections
     * to the service).
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Kinesis
     * Analytics using the specified AWS account credentials and executor
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Kinesis
     * Analytics using the specified AWS account credentials, executor service,
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Kinesis
     * Analytics using the specified AWS account credentials provider. Default
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Kinesis
     * Analytics using the provided AWS account credentials provider and client
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Kinesis
     * Analytics using the specified AWS account credentials provider and
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Kinesis
     * Analytics using the specified AWS account credentials provider, executor
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Kinesis
     * Analytics using the specified parameters.
     *
    ...
    @Override
    public java.util.concurrent.Future<AddApplicationInputResult> addApplicationInputAsync(
    ...
    @Override
    public java.util.concurrent.Future<AddApplicationOutputResult> addApplicationOutputAsync(
    ...
    public java.util.concurrent.Future<AddApplicationReferenceDataSourceResult> addApplicationReferenceDataSourceAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<AddApplicationReferenceDataSourceResult>() {
                    @Override
                    public AddApplicationReferenceDataSourceResult call()
                            throws Exception {
    ...
    @Override
    public java.util.concurrent.Future<DeleteApplicationOutputResult> deleteApplicationOutputAsync(
    ...
    @Override
    public java.util.concurrent.Future<DeleteApplicationOutputResult> deleteApplicationOutputAsync(
            final DeleteApplicationOutputRequest request,
            final com.amazonaws.handlers.AsyncHandler<DeleteApplicationOutputRequest, DeleteApplicationOutputResult> asyncHandler) {

        return executorService
                .submit(new java.util.concurrent.Callable<DeleteApplicationOutputResult>() {
                    @Override
                    public DeleteApplicationOutputResult call()
                            throws Exception {
    ...
    public java.util.concurrent.Future<DeleteApplicationReferenceDataSourceResult> deleteApplicationReferenceDataSourceAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeleteApplicationReferenceDataSourceResult>() {
                    @Override
                    public DeleteApplicationReferenceDataSourceResult call()
                            throws Exception {
    ...
    @Override
    public java.util.concurrent.Future<DiscoverInputSchemaResult> discoverInputSchemaAsync(
    ...
    @Override
    public java.util.concurrent.Future<StartApplicationResult> startApplicationAsync(
    ...
    @Override
    public java.util.concurrent.Future<StopApplicationResult> stopApplicationAsync(
