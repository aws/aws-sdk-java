...
public class CreateApplicationRequestMarshaller implements
    ...
    public Request<CreateApplicationRequest> marshall(
        ...
        Request<CreateApplicationRequest> request = new DefaultRequest<CreateApplicationRequest>(
                createApplicationRequest, "AmazonKinesisAnalytics");
        ...
        try {
            ...
            java.util.List<Input> inputsList = createApplicationRequest
                    .getInputs();
            if (inputsList != null) {
                ...
                for (Input inputsListValue : inputsList) {
                    if (inputsListValue != null) {
                        ...
                        InputJsonMarshaller.getInstance().marshall(
                                inputsListValue, jsonGenerator);
                    }
                }
                jsonGenerator.writeEndArray();
            }

            java.util.List<Output> outputsList = createApplicationRequest
                    .getOutputs();
            if (outputsList != null) {
            ...
            if (createApplicationRequest.getApplicationCode() != null) {
                jsonGenerator.writeFieldName("ApplicationCode").writeValue(
                        createApplicationRequest.getApplicationCode());
            }
