    ...
    public void marshall(
        ...
        try {
            ...
            if (s3ReferenceDataSourceUpdate.getBucketARNUpdate() != null) {
                jsonGenerator.writeFieldName("BucketARNUpdate").writeValue(
                        s3ReferenceDataSourceUpdate.getBucketARNUpdate());
            }
            if (s3ReferenceDataSourceUpdate.getFileKeyUpdate() != null) {
                jsonGenerator.writeFieldName("FileKeyUpdate").writeValue(
                        s3ReferenceDataSourceUpdate.getFileKeyUpdate());
            }
            if (s3ReferenceDataSourceUpdate.getReferenceRoleARNUpdate() != null) {
                jsonGenerator.writeFieldName("ReferenceRoleARNUpdate")
                        .writeValue(
