 ...
 */
public class InputSchemaUpdateJsonUnmarshaller implements
        Unmarshaller<InputSchemaUpdate, JsonUnmarshallerContext> {

    public InputSchemaUpdate unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RecordFormatUpdate", targetDepth)) {
                    context.nextToken();
                    inputSchemaUpdate
                            .setRecordFormatUpdate(RecordFormatJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
                if (context.testExpression("RecordEncodingUpdate", targetDepth)) {
                    context.nextToken();
                    inputSchemaUpdate.setRecordEncodingUpdate(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RecordColumnUpdates", targetDepth)) {
                    context.nextToken();
                    inputSchemaUpdate
                            .setRecordColumnUpdates(new ListUnmarshaller<RecordColumn>(
                                    RecordColumnJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
