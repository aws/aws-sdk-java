...
/**
 * LambdaOutputDescriptionMarshaller
 */
...
public class LambdaOutputDescriptionMarshaller {
    ...
    public void marshall(LambdaOutputDescription lambdaOutputDescription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(lambdaOutputDescription.getResourceARN(), RESOURCEARN_BINDING);
            protocolMarshaller.marshall(lambdaOutputDescription.getRoleARN(), ROLEARN_BINDING);
        } catch (Exception e) {
