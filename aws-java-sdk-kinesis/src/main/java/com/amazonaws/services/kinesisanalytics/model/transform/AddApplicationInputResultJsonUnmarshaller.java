 ...
 */
public class AddApplicationInputResultJsonUnmarshaller implements
        Unmarshaller<AddApplicationInputResult, JsonUnmarshallerContext> {

    public AddApplicationInputResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
