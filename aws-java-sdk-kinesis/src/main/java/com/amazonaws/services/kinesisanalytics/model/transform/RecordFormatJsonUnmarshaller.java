 ...
 */
public class RecordFormatJsonUnmarshaller implements
        Unmarshaller<RecordFormat, JsonUnmarshallerContext> {

    public RecordFormat unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RecordFormatType", targetDepth)) {
                    context.nextToken();
                    recordFormat.setRecordFormatType(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("MappingParameters", targetDepth)) {
                    context.nextToken();
                    recordFormat
                            .setMappingParameters(MappingParametersJsonUnmarshaller
