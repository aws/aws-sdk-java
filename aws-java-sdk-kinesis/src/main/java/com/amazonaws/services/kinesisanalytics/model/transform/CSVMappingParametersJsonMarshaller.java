...
public class CSVMappingParametersJsonMarshaller {
     ...
     */
    public void marshall(CSVMappingParameters cSVMappingParameters,
        ...
        try {
            ...
            if (cSVMappingParameters.getRecordRowDelimiter() != null) {
                jsonGenerator.writeFieldName("RecordRowDelimiter").writeValue(
                        cSVMappingParameters.getRecordRowDelimiter());
            }
            if (cSVMappingParameters.getRecordColumnDelimiter() != null) {
                jsonGenerator
                        .writeFieldName("RecordColumnDelimiter")
                        .writeValue(
                                cSVMappingParameters.getRecordColumnDelimiter());
            }
