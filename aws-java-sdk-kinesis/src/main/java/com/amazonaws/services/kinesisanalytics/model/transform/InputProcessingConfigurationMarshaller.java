...
/**
 * InputProcessingConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class InputProcessingConfigurationMarshaller {

    private static final MarshallingInfo<StructuredPojo> INPUTLAMBDAPROCESSOR_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("InputLambdaProcessor").build();
    ...
    public void marshall(InputProcessingConfiguration inputProcessingConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(inputProcessingConfiguration.getInputLambdaProcessor(), INPUTLAMBDAPROCESSOR_BINDING);
        } catch (Exception e) {
