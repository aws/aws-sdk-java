    ...
    public void marshall(Input input, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (input.getKinesisStreamsInput() != null) {
                ...
                KinesisStreamsInputJsonMarshaller.getInstance().marshall(
                        input.getKinesisStreamsInput(), jsonGenerator);
            }
            if (input.getKinesisFirehoseInput() != null) {
                jsonGenerator.writeFieldName("KinesisFirehoseInput");
                KinesisFirehoseInputJsonMarshaller.getInstance().marshall(
                        input.getKinesisFirehoseInput(), jsonGenerator);
            }
