...
public class SourceSchemaJsonMarshaller {
     ...
     */
    public void marshall(SourceSchema sourceSchema,
        ...
        try {
            ...
            if (sourceSchema.getRecordFormat() != null) {
                ...
                RecordFormatJsonMarshaller.getInstance().marshall(
                        sourceSchema.getRecordFormat(), jsonGenerator);
            }
            if (sourceSchema.getRecordEncoding() != null) {
                jsonGenerator.writeFieldName("RecordEncoding").writeValue(
                        sourceSchema.getRecordEncoding());
            }

            java.util.List<RecordColumn> recordColumnsList = sourceSchema
                    .getRecordColumns();
            if (recordColumnsList != null) {
                jsonGenerator.writeFieldName("RecordColumns");
                jsonGenerator.writeStartArray();
                for (RecordColumn recordColumnsListValue : recordColumnsList) {
                    if (recordColumnsListValue != null) {

                        RecordColumnJsonMarshaller.getInstance().marshall(
                                recordColumnsListValue, jsonGenerator);
                    }
                }
