...
public class DeleteApplicationOutputRequestMarshaller
        implements
        Marshaller<Request<DeleteApplicationOutputRequest>, DeleteApplicationOutputRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DeleteApplicationOutputRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeleteApplicationOutputRequest> marshall(
        ...
        Request<DeleteApplicationOutputRequest> request = new DefaultRequest<DeleteApplicationOutputRequest>(
                deleteApplicationOutputRequest, "AmazonKinesisAnalytics");
        ...
        try {
            ...
            if (deleteApplicationOutputRequest.getApplicationName() != null) {
                jsonGenerator.writeFieldName("ApplicationName").writeValue(
                        deleteApplicationOutputRequest.getApplicationName());
            }
            ...
            if (deleteApplicationOutputRequest.getOutputId() != null) {
                jsonGenerator.writeFieldName("OutputId").writeValue(
                        deleteApplicationOutputRequest.getOutputId());
            }
