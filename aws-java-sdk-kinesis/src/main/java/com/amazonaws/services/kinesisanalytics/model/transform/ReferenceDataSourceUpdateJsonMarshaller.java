...
public class ReferenceDataSourceUpdateJsonMarshaller {
     ...
     */
    public void marshall(ReferenceDataSourceUpdate referenceDataSourceUpdate,
        ...
        try {
            ...
            if (referenceDataSourceUpdate.getReferenceId() != null) {
                jsonGenerator.writeFieldName("ReferenceId").writeValue(
                        referenceDataSourceUpdate.getReferenceId());
            }
            if (referenceDataSourceUpdate.getTableNameUpdate() != null) {
                jsonGenerator.writeFieldName("TableNameUpdate").writeValue(
                        referenceDataSourceUpdate.getTableNameUpdate());
            }
            if (referenceDataSourceUpdate.getS3ReferenceDataSourceUpdate() != null) {
                jsonGenerator.writeFieldName("S3ReferenceDataSourceUpdate");
                S3ReferenceDataSourceUpdateJsonMarshaller
                        .getInstance()
                        .marshall(
            ...
            if (referenceDataSourceUpdate.getReferenceSchemaUpdate() != null) {
                ...
                SourceSchemaJsonMarshaller.getInstance().marshall(
                        referenceDataSourceUpdate.getReferenceSchemaUpdate(),
                        jsonGenerator);
            }
