 ...
 * two. For more information, see <a href=
...
public class Input implements Serializable, Cloneable {
     ...
     * create one or more (as per the <code>InputParallelism</code> count you
     ...
     * 
     * @param namePrefix
     *        Name prefix to use when creating in-application stream. Suppose
     *        you specify a prefix "MyInApplicationStream". Kinesis Analytics
     *        will then create one or more (as per the
     *        <code>InputParallelism</code> count you specified) in-application
     *        streams with names "MyInApplicationStream_001",
     *        "MyInApplicationStream_002" and so on.
     */
     ...
     * </p>
     * 
     * @return Name prefix to use when creating in-application stream. Suppose
     *         you specify a prefix "MyInApplicationStream". Kinesis Analytics
     *         will then create one or more (as per the
     *         <code>InputParallelism</code> count you specified) in-application
     *         streams with names "MyInApplicationStream_001",
     ...
     *        the stream's Amazon Resource Name (ARN) and an IAM role that
     ...
     * </p>
     * 
     * @return If the streaming source is an Amazon Kinesis stream, identifies
     *         the stream's Amazon Resource Name (ARN) and an IAM role that
     *         enables Amazon Kinesis Analytics to access the stream on your
     *         behalf.
     */
    ...
    public void setKinesisFirehoseInput(
     ...
     * </p>
     * 
     * @return If the streaming source is an Amazon Kinesis Firehose delivery
     *         stream, identifies the Firehose delivery stream's ARN and an IAM
     *         role that enables Amazon Kinesis Analytics to access the stream
     *         on your behalf.
     */
    ...
    public Input withKinesisFirehoseInput(
            KinesisFirehoseInput kinesisFirehoseInput) {
     ...
     *         <p>
     *         Data from your source will be routed to these in-application
     *         input streams.
     *         </p>
     *         <p>
     *         (see <a href=
     ...
     *        in-application stream that is being created.</p>
     *        <p>
     *        Also used to describe the format of the reference data source.
     */
     ...
     * </p>
     * 
     * @return Describes the format of the data in the streaming source, and how
     *         each data element maps to corresponding columns in the
     *         in-application stream that is being created.</p>
     *         <p>
     *         Also used to describe the format of the reference data source.
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getNamePrefix() != null
            ...
            return false;
        if (other.getKinesisStreamsInput() == null
                ^ this.getKinesisStreamsInput() == null)
            return false;
        if (other.getKinesisStreamsInput() != null
                && other.getKinesisStreamsInput().equals(
                        this.getKinesisStreamsInput()) == false)
            return false;
        if (other.getKinesisFirehoseInput() == null
                ^ this.getKinesisFirehoseInput() == null)
            return false;
        if (other.getKinesisFirehoseInput() != null
                && other.getKinesisFirehoseInput().equals(
                        this.getKinesisFirehoseInput()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getKinesisStreamsInput() == null) ? 0
                        : getKinesisStreamsInput().hashCode());
        hashCode = prime
                * hashCode
                + ((getKinesisFirehoseInput() == null) ? 0
                        : getKinesisFirehoseInput().hashCode());
        hashCode = prime
                * hashCode
