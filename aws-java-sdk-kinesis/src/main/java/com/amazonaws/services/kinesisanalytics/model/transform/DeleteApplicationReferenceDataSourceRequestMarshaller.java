...
public class DeleteApplicationReferenceDataSourceRequestMarshaller
    ...
    public DeleteApplicationReferenceDataSourceRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeleteApplicationReferenceDataSourceRequest> marshall(
        ...
        try {
            ...
            if (deleteApplicationReferenceDataSourceRequest
