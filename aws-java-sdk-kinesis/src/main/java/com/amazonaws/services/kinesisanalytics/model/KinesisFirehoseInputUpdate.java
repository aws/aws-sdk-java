...
public class KinesisFirehoseInputUpdate implements Serializable, Cloneable {
     ...
     * can assume to access the stream on your behalf. You need to grant
    ...
    public KinesisFirehoseInputUpdate withResourceARNUpdate(
     ...
     * </p>
     * 
     * @return Amazon Resource Name (ARN) of the IAM role that Amazon Kinesis
     *         Analytics can assume to access the stream on your behalf. You
