        ...
        try {
            ...
            if (referenceDataSourceDescription.getReferenceId() != null) {
                jsonGenerator.writeFieldName("ReferenceId").writeValue(
                        referenceDataSourceDescription.getReferenceId());
            }
            if (referenceDataSourceDescription.getTableName() != null) {
                jsonGenerator.writeFieldName("TableName").writeValue(
                        referenceDataSourceDescription.getTableName());
            }
            if (referenceDataSourceDescription
                    .getS3ReferenceDataSourceDescription() != null) {
                jsonGenerator
                        .writeFieldName("S3ReferenceDataSourceDescription");
                S3ReferenceDataSourceDescriptionJsonMarshaller
                        .getInstance()
                        .marshall(
            ...
            if (referenceDataSourceDescription.getReferenceSchema() != null) {
                ...
                SourceSchemaJsonMarshaller.getInstance().marshall(
                        referenceDataSourceDescription.getReferenceSchema(),
                        jsonGenerator);
            }
