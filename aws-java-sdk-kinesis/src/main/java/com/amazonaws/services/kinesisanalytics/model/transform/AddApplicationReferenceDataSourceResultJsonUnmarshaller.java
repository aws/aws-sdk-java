 ...
 */
public class AddApplicationReferenceDataSourceResultJsonUnmarshaller
        implements
        Unmarshaller<AddApplicationReferenceDataSourceResult, JsonUnmarshallerContext> {

    public AddApplicationReferenceDataSourceResult unmarshall(
