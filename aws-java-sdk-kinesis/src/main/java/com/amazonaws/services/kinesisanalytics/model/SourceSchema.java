...
public class SourceSchema implements Serializable, Cloneable {
    ...
    public void setRecordColumns(
            java.util.Collection<RecordColumn> recordColumns) {
        if (recordColumns == null) {
            this.recordColumns = null;
            return;
        }

        this.recordColumns = new java.util.ArrayList<RecordColumn>(
                recordColumns);
    }
     ...
     * any). Use {@link #setRecordColumns(java.util.Collection)} or
     * {@link #withRecordColumns(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param recordColumns
    ...
    public SourceSchema withRecordColumns(RecordColumn... recordColumns) {
        if (this.recordColumns == null) {
            setRecordColumns(new java.util.ArrayList<RecordColumn>(
    ...
    public SourceSchema withRecordColumns(
            java.util.Collection<RecordColumn> recordColumns) {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRecordFormat() == null ^ this.getRecordFormat() == null)
            return false;
        if (other.getRecordFormat() != null
                && other.getRecordFormat().equals(this.getRecordFormat()) == false)
            return false;
        if (other.getRecordEncoding() == null
                ^ this.getRecordEncoding() == null)
            return false;
        if (other.getRecordEncoding() != null
                && other.getRecordEncoding().equals(this.getRecordEncoding()) == false)
            return false;
        if (other.getRecordColumns() == null ^ this.getRecordColumns() == null)
            return false;
        if (other.getRecordColumns() != null
                && other.getRecordColumns().equals(this.getRecordColumns()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getRecordFormat() == null) ? 0 : getRecordFormat()
                        .hashCode());
        hashCode = prime
                * hashCode
                + ((getRecordEncoding() == null) ? 0 : getRecordEncoding()
                        .hashCode());
        hashCode = prime
                * hashCode
                + ((getRecordColumns() == null) ? 0 : getRecordColumns()
                        .hashCode());
        return hashCode;
    }
