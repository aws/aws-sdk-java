...
/**
 * S3ReferenceDataSource JSON Unmarshaller
 */
public class S3ReferenceDataSourceJsonUnmarshaller implements
        Unmarshaller<S3ReferenceDataSource, JsonUnmarshallerContext> {

    public S3ReferenceDataSource unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BucketARN", targetDepth)) {
                    context.nextToken();
                    s3ReferenceDataSource.setBucketARN(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("FileKey", targetDepth)) {
                    context.nextToken();
                    s3ReferenceDataSource.setFileKey(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("ReferenceRoleARN", targetDepth)) {
                    context.nextToken();
                    s3ReferenceDataSource.setReferenceRoleARN(context
