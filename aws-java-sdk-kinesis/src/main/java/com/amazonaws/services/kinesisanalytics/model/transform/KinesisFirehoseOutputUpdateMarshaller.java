...
public class KinesisFirehoseOutputUpdateMarshaller {
    ...
    public void marshall(KinesisFirehoseOutputUpdate kinesisFirehoseOutputUpdate, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(kinesisFirehoseOutputUpdate.getResourceARNUpdate(), RESOURCEARNUPDATE_BINDING);
            protocolMarshaller.marshall(kinesisFirehoseOutputUpdate.getRoleARNUpdate(), ROLEARNUPDATE_BINDING);
        } catch (Exception e) {
