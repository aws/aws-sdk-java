    ...
    public void marshall(Output output, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (output.getKinesisStreamsOutput() != null) {
                ...
                KinesisStreamsOutputJsonMarshaller.getInstance().marshall(
                        output.getKinesisStreamsOutput(), jsonGenerator);
            }
            if (output.getKinesisFirehoseOutput() != null) {
                jsonGenerator.writeFieldName("KinesisFirehoseOutput");
                KinesisFirehoseOutputJsonMarshaller.getInstance().marshall(
                        output.getKinesisFirehoseOutput(), jsonGenerator);
            }
            if (output.getDestinationSchema() != null) {
                jsonGenerator.writeFieldName("DestinationSchema");
                DestinationSchemaJsonMarshaller.getInstance().marshall(
                        output.getDestinationSchema(), jsonGenerator);
            }
