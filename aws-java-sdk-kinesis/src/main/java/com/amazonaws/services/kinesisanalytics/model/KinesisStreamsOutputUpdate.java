...
/**
 * <p>
 * When updating an output configuration using the <a>UpdateApplication</a>
...
public class KinesisStreamsOutputUpdate implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Amazon Resource Name (ARN) of the Amazon Kinesis stream where you
     *         want to write the output.
     */
    ...
    public KinesisStreamsOutputUpdate withResourceARNUpdate(
