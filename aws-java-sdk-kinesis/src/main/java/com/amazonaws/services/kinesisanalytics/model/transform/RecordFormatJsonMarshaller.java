...
public class RecordFormatJsonMarshaller {
     ...
     */
    public void marshall(RecordFormat recordFormat,
        ...
        try {
            ...
            if (recordFormat.getRecordFormatType() != null) {
                jsonGenerator.writeFieldName("RecordFormatType").writeValue(
                        recordFormat.getRecordFormatType());
            }
            if (recordFormat.getMappingParameters() != null) {
                jsonGenerator.writeFieldName("MappingParameters");
                MappingParametersJsonMarshaller.getInstance().marshall(
                        recordFormat.getMappingParameters(), jsonGenerator);
            }
