...
public class InputUpdateJsonMarshaller {
     ...
     */
    public void marshall(InputUpdate inputUpdate,
        ...
        try {
            ...
            if (inputUpdate.getInputId() != null) {
                jsonGenerator.writeFieldName("InputId").writeValue(
                        inputUpdate.getInputId());
            }
            if (inputUpdate.getNamePrefixUpdate() != null) {
                jsonGenerator.writeFieldName("NamePrefixUpdate").writeValue(
                        inputUpdate.getNamePrefixUpdate());
            }
            if (inputUpdate.getKinesisStreamsInputUpdate() != null) {
                jsonGenerator.writeFieldName("KinesisStreamsInputUpdate");
                KinesisStreamsInputUpdateJsonMarshaller.getInstance().marshall(
            ...
            if (inputUpdate.getKinesisFirehoseInputUpdate() != null) {
                ...
                KinesisFirehoseInputUpdateJsonMarshaller.getInstance()
                        .marshall(inputUpdate.getKinesisFirehoseInputUpdate(),
                                jsonGenerator);
            }
            if (inputUpdate.getInputSchemaUpdate() != null) {
                jsonGenerator.writeFieldName("InputSchemaUpdate");
                InputSchemaUpdateJsonMarshaller.getInstance().marshall(
                        inputUpdate.getInputSchemaUpdate(), jsonGenerator);
            }
            if (inputUpdate.getInputParallelismUpdate() != null) {
                jsonGenerator.writeFieldName("InputParallelismUpdate");
                InputParallelismUpdateJsonMarshaller.getInstance().marshall(
                        inputUpdate.getInputParallelismUpdate(), jsonGenerator);
            }
