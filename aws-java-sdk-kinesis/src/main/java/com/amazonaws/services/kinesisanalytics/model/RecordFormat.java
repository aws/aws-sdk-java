...
public class RecordFormat implements Serializable, Cloneable {
    ...
    public RecordFormat withMappingParameters(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRecordFormatType() != null
            ...
            return false;
        if (other.getMappingParameters() == null
                ^ this.getMappingParameters() == null)
            return false;
        if (other.getMappingParameters() != null
                && other.getMappingParameters().equals(
                        this.getMappingParameters()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getMappingParameters() == null) ? 0
                        : getMappingParameters().hashCode());
        return hashCode;
    }
