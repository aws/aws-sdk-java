 ...
 */
public class KinesisStreamsInputUpdateJsonUnmarshaller implements
        Unmarshaller<KinesisStreamsInputUpdate, JsonUnmarshallerContext> {

    public KinesisStreamsInputUpdate unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceARNUpdate", targetDepth)) {
                    context.nextToken();
                    kinesisStreamsInputUpdate.setResourceARNUpdate(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RoleARNUpdate", targetDepth)) {
                    context.nextToken();
                    kinesisStreamsInputUpdate.setRoleARNUpdate(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
