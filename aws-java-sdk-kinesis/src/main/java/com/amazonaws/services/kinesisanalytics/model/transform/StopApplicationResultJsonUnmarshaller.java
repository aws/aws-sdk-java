 ...
 */
public class StopApplicationResultJsonUnmarshaller implements
        Unmarshaller<StopApplicationResult, JsonUnmarshallerContext> {

    public StopApplicationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
