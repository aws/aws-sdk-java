...
public class AddApplicationInputRequestMarshaller
    ...
    public AddApplicationInputRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<AddApplicationInputRequest> marshall(
        ...
        Request<AddApplicationInputRequest> request = new DefaultRequest<AddApplicationInputRequest>(
                addApplicationInputRequest, "AmazonKinesisAnalytics");
        ...
        try {
            ...
            if (addApplicationInputRequest.getApplicationName() != null) {
                jsonGenerator.writeFieldName("ApplicationName").writeValue(
                        addApplicationInputRequest.getApplicationName());
            }
            ...
            if (addApplicationInputRequest.getInput() != null) {
                ...
                InputJsonMarshaller.getInstance().marshall(
                        addApplicationInputRequest.getInput(), jsonGenerator);
            }
