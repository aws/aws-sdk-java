...
public class ApplicationUpdateJsonMarshaller {
    ...
    public void marshall(ApplicationUpdate applicationUpdate,
        ...
        try {
            ...
            java.util.List<InputUpdate> inputUpdatesList = applicationUpdate
                    .getInputUpdates();
            if (inputUpdatesList != null) {
                ...
                for (InputUpdate inputUpdatesListValue : inputUpdatesList) {
                    if (inputUpdatesListValue != null) {
                        ...
                        InputUpdateJsonMarshaller.getInstance().marshall(
                                inputUpdatesListValue, jsonGenerator);
                    }
                }
                jsonGenerator.writeEndArray();
            }
            if (applicationUpdate.getApplicationCodeUpdate() != null) {
                jsonGenerator.writeFieldName("ApplicationCodeUpdate")
                        .writeValue(
                                applicationUpdate.getApplicationCodeUpdate());
            }

            java.util.List<OutputUpdate> outputUpdatesList = applicationUpdate
                    .getOutputUpdates();
            if (outputUpdatesList != null) {
                ...
                for (OutputUpdate outputUpdatesListValue : outputUpdatesList) {
                    if (outputUpdatesListValue != null) {
                        ...
                        OutputUpdateJsonMarshaller.getInstance().marshall(
                                outputUpdatesListValue, jsonGenerator);
                    }
                }
                jsonGenerator.writeEndArray();
            }

            java.util.List<ReferenceDataSourceUpdate> referenceDataSourceUpdatesList = applicationUpdate
            ...
            if (referenceDataSourceUpdatesList != null) {
                ...
                for (ReferenceDataSourceUpdate referenceDataSourceUpdatesListValue : referenceDataSourceUpdatesList) {
                    if (referenceDataSourceUpdatesListValue != null) {
                        ...
                        ReferenceDataSourceUpdateJsonMarshaller.getInstance()
                                .marshall(referenceDataSourceUpdatesListValue,
                                        jsonGenerator);
                    }
                }
                jsonGenerator.writeEndArray();
