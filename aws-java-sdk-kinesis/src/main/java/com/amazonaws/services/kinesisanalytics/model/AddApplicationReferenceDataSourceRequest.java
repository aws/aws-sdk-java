 ...
 * <p/>
 */
public class AddApplicationReferenceDataSourceRequest extends
    ...
    public AddApplicationReferenceDataSourceRequest withApplicationName(
     ...
     *        data source. You can use the <a>DescribeApplication</a> operation
     *        to get the current application version. If the version specified
     ...
     * </p>
     * 
     * @return Version of the application for which you are adding the reference
     *         data source. You can use the <a>DescribeApplication</a> operation
     *         to get the current application version. If the version specified
     *         is not the current version, the
     *         <code>ConcurrentModificationException</code> is returned.
    ...
    public AddApplicationReferenceDataSourceRequest withCurrentApplicationVersionId(
     ...
     * </p>
     * 
     * @return The reference data source can be an object in your Amazon S3
     *         bucket. Amazon Kinesis Analytics reads the object and copies the
     *         data into the in-application table that is created. You provide
     *         an S3 bucket, object key name, and the resulting in-application
     *         table that is created. You must also provide an IAM role with the
     *         necessary permissions that Amazon Kinesis Analytics can assume to
     *         read the object from your S3 bucket on your behalf.
     */
    ...
    public AddApplicationReferenceDataSourceRequest withReferenceDataSource(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCurrentApplicationVersionId() != null
            ...
            return false;
        if (other.getReferenceDataSource() == null
                ^ this.getReferenceDataSource() == null)
            return false;
        if (other.getReferenceDataSource() != null
                && other.getReferenceDataSource().equals(
                        this.getReferenceDataSource()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getReferenceDataSource() == null) ? 0
                        : getReferenceDataSource().hashCode());
        return hashCode;
    }
