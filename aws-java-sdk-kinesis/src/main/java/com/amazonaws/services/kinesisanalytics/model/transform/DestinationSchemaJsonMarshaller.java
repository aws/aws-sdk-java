...
public class DestinationSchemaJsonMarshaller {
     ...
     */
    public void marshall(DestinationSchema destinationSchema, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (destinationSchema.getRecordFormatType() != null) {
                jsonGenerator.writeFieldName("RecordFormatType").writeValue(destinationSchema.getRecordFormatType());
            }
