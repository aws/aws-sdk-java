 ...
 */
public class KinesisFirehoseOutputUpdateJsonUnmarshaller implements
        Unmarshaller<KinesisFirehoseOutputUpdate, JsonUnmarshallerContext> {

    public KinesisFirehoseOutputUpdate unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceARNUpdate", targetDepth)) {
                    context.nextToken();
                    kinesisFirehoseOutputUpdate.setResourceARNUpdate(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RoleARNUpdate", targetDepth)) {
                    context.nextToken();
                    kinesisFirehoseOutputUpdate.setRoleARNUpdate(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
