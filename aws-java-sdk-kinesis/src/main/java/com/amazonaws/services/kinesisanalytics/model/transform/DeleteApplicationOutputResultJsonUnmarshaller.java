 ...
 */
public class DeleteApplicationOutputResultJsonUnmarshaller implements
        Unmarshaller<DeleteApplicationOutputResult, JsonUnmarshallerContext> {

    public DeleteApplicationOutputResult unmarshall(
