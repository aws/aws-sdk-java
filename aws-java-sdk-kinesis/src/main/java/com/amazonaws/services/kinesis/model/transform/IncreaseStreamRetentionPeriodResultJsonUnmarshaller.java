 ...
 */
public class IncreaseStreamRetentionPeriodResultJsonUnmarshaller
        implements
        Unmarshaller<IncreaseStreamRetentionPeriodResult, JsonUnmarshallerContext> {

    public IncreaseStreamRetentionPeriodResult unmarshall(
