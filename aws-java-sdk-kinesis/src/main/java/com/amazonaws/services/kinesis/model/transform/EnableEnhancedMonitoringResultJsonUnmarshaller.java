...
public class EnableEnhancedMonitoringResultJsonUnmarshaller implements
    ...
    public EnableEnhancedMonitoringResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StreamName", targetDepth)) {
                    context.nextToken();
                    enableEnhancedMonitoringResult.setStreamName(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("CurrentShardLevelMetrics",
                        targetDepth)) {
                    context.nextToken();
                ...
                if (context.testExpression("DesiredShardLevelMetrics",
                        targetDepth)) {
                    context.nextToken();
                    enableEnhancedMonitoringResult
