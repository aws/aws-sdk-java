...
/**
 * DescribeStreamConsumerRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeStreamConsumerRequestMarshaller {
    ...
    private static final DescribeStreamConsumerRequestMarshaller instance = new DescribeStreamConsumerRequestMarshaller();

    public static DescribeStreamConsumerRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DescribeStreamConsumerRequest describeStreamConsumerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        if (describeStreamConsumerRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(describeStreamConsumerRequest.getStreamARN(), STREAMARN_BINDING);
            protocolMarshaller.marshall(describeStreamConsumerRequest.getConsumerName(), CONSUMERNAME_BINDING);
            protocolMarshaller.marshall(describeStreamConsumerRequest.getConsumerARN(), CONSUMERARN_BINDING);
        } catch (Exception e) {
