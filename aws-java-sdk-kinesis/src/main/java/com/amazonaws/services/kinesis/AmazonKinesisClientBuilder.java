...
/**
 * Fluent builder for {@link com.amazonaws.services.kinesis.AmazonKinesis}. Use of the builder is preferred over using
...
public final class AmazonKinesisClientBuilder extends AwsSyncClientBuilder<AmazonKinesisClientBuilder, AmazonKinesis> {
    ...
    /**
     * Construct a synchronous implementation of AmazonKinesis using the current builder configuration.
     *
     * @param params
