...
/**
 * Fluent builder for {@link com.amazonaws.services.kinesis.AmazonKinesis}. Use
 * of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonKinesisClientBuilder extends
        AwsSyncClientBuilder<AmazonKinesisClientBuilder, AmazonKinesis> {
    ...
    /**
     * Construct a synchronous implementation of AmazonKinesis using the current
     * builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AmazonKinesis.
     */
    @Override
