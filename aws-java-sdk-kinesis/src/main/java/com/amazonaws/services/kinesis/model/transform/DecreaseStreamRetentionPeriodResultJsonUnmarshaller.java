 ...
 */
public class DecreaseStreamRetentionPeriodResultJsonUnmarshaller
        implements
        Unmarshaller<DecreaseStreamRetentionPeriodResult, JsonUnmarshallerContext> {

    public DecreaseStreamRetentionPeriodResult unmarshall(
            JsonUnmarshallerContext context) throws Exception {
        DecreaseStreamRetentionPeriodResult decreaseStreamRetentionPeriodResult = new DecreaseStreamRetentionPeriodResult();
