 ...
 */
public class PutRecordsRequestEntryJsonUnmarshaller implements
        Unmarshaller<PutRecordsRequestEntry, JsonUnmarshallerContext> {

    public PutRecordsRequestEntry unmarshall(JsonUnmarshallerContext context)
            throws Exception {
