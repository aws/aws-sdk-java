...
/**
 * DeregisterStreamConsumerRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeregisterStreamConsumerRequestMarshaller {
    ...
    private static final DeregisterStreamConsumerRequestMarshaller instance = new DeregisterStreamConsumerRequestMarshaller();

    public static DeregisterStreamConsumerRequestMarshaller getInstance() {
        return instance;
    }
