...
public class CreateStreamRequestMarshaller implements
    ...
    public CreateStreamRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<CreateStreamRequest> marshall(
        ...
        Request<CreateStreamRequest> request = new DefaultRequest<CreateStreamRequest>(
                createStreamRequest, "AmazonKinesis");
        ...
        try {
            ...
            if (createStreamRequest.getShardCount() != null) {
                jsonGenerator.writeFieldName("ShardCount").writeValue(
                        createStreamRequest.getShardCount());
            }
