...
@SdkInternalApi
public class DeleteStreamRequestMarshaller {
    ...
    public static DeleteStreamRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteStreamRequest deleteStreamRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(deleteStreamRequest.getStreamARN(), STREAMARN_BINDING);
        } catch (Exception e) {
