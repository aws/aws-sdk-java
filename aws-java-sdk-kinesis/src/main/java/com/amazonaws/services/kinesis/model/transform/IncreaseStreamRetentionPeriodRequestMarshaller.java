...
public class IncreaseStreamRetentionPeriodRequestMarshaller
    ...
    public IncreaseStreamRetentionPeriodRequestMarshaller(
    ...
    public Request<IncreaseStreamRetentionPeriodRequest> marshall(
        ...
        Request<IncreaseStreamRetentionPeriodRequest> request = new DefaultRequest<IncreaseStreamRetentionPeriodRequest>(
        ...
        try {
            ...
            if (increaseStreamRetentionPeriodRequest.getStreamName() != null) {
                jsonGenerator.writeFieldName("StreamName").writeValue(
                        increaseStreamRetentionPeriodRequest.getStreamName());
            }
