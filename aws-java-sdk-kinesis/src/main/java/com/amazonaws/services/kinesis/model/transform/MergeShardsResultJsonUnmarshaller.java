 ...
 */
public class MergeShardsResultJsonUnmarshaller implements
        Unmarshaller<MergeShardsResult, JsonUnmarshallerContext> {

    public MergeShardsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
