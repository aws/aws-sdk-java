...
public class AmazonKinesisClient extends AmazonWebServiceClient implements
    ...
    public void addTagsToStream(AddTagsToStreamRequest addTagsToStreamRequest) {
        ...
        try {
            ...
            try {
                request = new AddTagsToStreamRequestMarshaller()
                        .marshall(addTagsToStreamRequest);
    ...
    public void createStream(CreateStreamRequest createStreamRequest) {
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new CreateStreamRequestMarshaller()
                        .marshall(createStreamRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
    ...
    public void deleteStream(DeleteStreamRequest deleteStreamRequest) {
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new DeleteStreamRequestMarshaller()
                        .marshall(deleteStreamRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
    ...
    public void mergeShards(MergeShardsRequest mergeShardsRequest) {
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new MergeShardsRequestMarshaller()
                        .marshall(mergeShardsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
    ...
    public PutRecordsResult putRecords(PutRecordsRequest putRecordsRequest) {
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new PutRecordsRequestMarshaller()
                        .marshall(putRecordsRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
    ...
    public void splitShard(SplitShardRequest splitShardRequest) {
        ...
        try {
            awsRequestMetrics.startEvent(Field.RequestMarshallTime);
            try {
                request = new SplitShardRequestMarshaller()
                        .marshall(splitShardRequest);
                // Binds the request metrics to the current request.
                request.setAWSRequestMetrics(awsRequestMetrics);
            } finally {
                awsRequestMetrics.endEvent(Field.RequestMarshallTime);
