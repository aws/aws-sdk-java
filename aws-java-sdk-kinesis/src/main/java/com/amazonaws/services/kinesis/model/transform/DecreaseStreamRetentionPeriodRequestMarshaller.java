...
public class DecreaseStreamRetentionPeriodRequestMarshaller
    ...
    public DecreaseStreamRetentionPeriodRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DecreaseStreamRetentionPeriodRequest> marshall(
        ...
        Request<DecreaseStreamRetentionPeriodRequest> request = new DefaultRequest<DecreaseStreamRetentionPeriodRequest>(
                decreaseStreamRetentionPeriodRequest, "AmazonKinesis");
        ...
        try {
            ...
            if (decreaseStreamRetentionPeriodRequest.getStreamName() != null) {
                jsonGenerator.writeFieldName("StreamName").writeValue(
                        decreaseStreamRetentionPeriodRequest.getStreamName());
            }
            if (decreaseStreamRetentionPeriodRequest.getRetentionPeriodHours() != null) {
                jsonGenerator.writeFieldName("RetentionPeriodHours")
                        .writeValue(
