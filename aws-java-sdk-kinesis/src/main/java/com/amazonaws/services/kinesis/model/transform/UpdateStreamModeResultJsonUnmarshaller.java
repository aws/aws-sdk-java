...
/**
 * UpdateStreamModeResult JSON Unmarshaller
 */
...
public class UpdateStreamModeResultJsonUnmarshaller implements Unmarshaller<UpdateStreamModeResult, JsonUnmarshallerContext> {
    ...
    public UpdateStreamModeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateStreamModeResult updateStreamModeResult = new UpdateStreamModeResult();
