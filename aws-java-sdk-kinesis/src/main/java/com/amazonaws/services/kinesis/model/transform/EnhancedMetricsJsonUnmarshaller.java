 ...
 */
public class EnhancedMetricsJsonUnmarshaller implements
        Unmarshaller<EnhancedMetrics, JsonUnmarshallerContext> {

    public EnhancedMetrics unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ShardLevelMetrics", targetDepth)) {
                    context.nextToken();
                    enhancedMetrics
                            .setShardLevelMetrics(new ListUnmarshaller<String>(
