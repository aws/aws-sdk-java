...
/**
 * Put Records Result JSON Unmarshaller
 */
public class PutRecordsResultJsonUnmarshaller implements Unmarshaller<PutRecordsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FailedRecordCount", targetDepth)) {
                    context.nextToken();
                    putRecordsResult.setFailedRecordCount(IntegerJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static PutRecordsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PutRecordsResultJsonUnmarshaller();
        return instance;
    }
}
