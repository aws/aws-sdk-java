...
public class InvalidArgumentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidArgumentExceptionUnmarshaller() {
        super(com.amazonaws.services.kinesisvideosignalingchannels.model.InvalidArgumentException.class, "InvalidArgumentException");
    }

    @Override
    public com.amazonaws.services.kinesisvideosignalingchannels.model.InvalidArgumentException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.kinesisvideosignalingchannels.model.InvalidArgumentException invalidArgumentException = new com.amazonaws.services.kinesisvideosignalingchannels.model.InvalidArgumentException(
                null);
