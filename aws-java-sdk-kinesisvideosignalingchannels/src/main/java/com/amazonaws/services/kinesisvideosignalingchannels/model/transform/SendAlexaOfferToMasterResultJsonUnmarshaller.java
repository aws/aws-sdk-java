...
/**
 * SendAlexaOfferToMasterResult JSON Unmarshaller
 */
...
public class SendAlexaOfferToMasterResultJsonUnmarshaller implements Unmarshaller<SendAlexaOfferToMasterResult, JsonUnmarshallerContext> {
    ...
    public SendAlexaOfferToMasterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Answer", targetDepth)) {
                    context.nextToken();
                    sendAlexaOfferToMasterResult.setAnswer(context.getUnmarshaller(String.class).unmarshall(context));
                }
