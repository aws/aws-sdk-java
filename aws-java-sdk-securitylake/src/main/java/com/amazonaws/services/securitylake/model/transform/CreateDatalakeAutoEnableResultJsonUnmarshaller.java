...
/**
 * CreateDatalakeAutoEnableResult JSON Unmarshaller
 */
...
public class CreateDatalakeAutoEnableResultJsonUnmarshaller implements Unmarshaller<CreateDatalakeAutoEnableResult, JsonUnmarshallerContext> {
    ...
    public CreateDatalakeAutoEnableResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateDatalakeAutoEnableResult createDatalakeAutoEnableResult = new CreateDatalakeAutoEnableResult();

        return createDatalakeAutoEnableResult;
    }
