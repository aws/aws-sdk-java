...
/**
 * UpdateDatalakeExceptionsExpiryResult JSON Unmarshaller
 */
...
public class UpdateDatalakeExceptionsExpiryResultJsonUnmarshaller implements Unmarshaller<UpdateDatalakeExceptionsExpiryResult, JsonUnmarshallerContext> {
    ...
    public UpdateDatalakeExceptionsExpiryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDatalakeExceptionsExpiryResult updateDatalakeExceptionsExpiryResult = new UpdateDatalakeExceptionsExpiryResult();

        return updateDatalakeExceptionsExpiryResult;
    }
