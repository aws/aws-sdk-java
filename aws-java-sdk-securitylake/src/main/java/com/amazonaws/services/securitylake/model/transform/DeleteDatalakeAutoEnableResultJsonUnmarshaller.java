...
/**
 * DeleteDatalakeAutoEnableResult JSON Unmarshaller
 */
...
public class DeleteDatalakeAutoEnableResultJsonUnmarshaller implements Unmarshaller<DeleteDatalakeAutoEnableResult, JsonUnmarshallerContext> {
    ...
    public DeleteDatalakeAutoEnableResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDatalakeAutoEnableResult deleteDatalakeAutoEnableResult = new DeleteDatalakeAutoEnableResult();

        return deleteDatalakeAutoEnableResult;
    }
