...
/**
 * CreateSubscriptionNotificationConfigurationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateSubscriptionNotificationConfigurationRequestMarshaller {

    private static final MarshallingInfo<Boolean> CREATESQS_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("createSqs").build();
    private static final MarshallingInfo<String> HTTPSAPIKEYNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("httpsApiKeyName").build();
    private static final MarshallingInfo<String> HTTPSAPIKEYVALUE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("httpsApiKeyValue").build();
    private static final MarshallingInfo<String> HTTPSMETHOD_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("httpsMethod").build();
    ...
    private static final MarshallingInfo<String> SUBSCRIPTIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("subscriptionId").build();
     ...
     */
    public void marshall(CreateSubscriptionNotificationConfigurationRequest createSubscriptionNotificationConfigurationRequest,
