...
/**
 * LakeConfigurationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LakeConfigurationRequestMarshaller {
    ...
    private static final LakeConfigurationRequestMarshaller instance = new LakeConfigurationRequestMarshaller();

    public static LakeConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LakeConfigurationRequest lakeConfigurationRequest, ProtocolMarshaller protocolMarshaller) {

        if (lakeConfigurationRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(lakeConfigurationRequest.getEncryptionKey(), ENCRYPTIONKEY_BINDING);
            protocolMarshaller.marshall(lakeConfigurationRequest.getReplicationDestinationRegions(), REPLICATIONDESTINATIONREGIONS_BINDING);
            protocolMarshaller.marshall(lakeConfigurationRequest.getReplicationRoleArn(), REPLICATIONROLEARN_BINDING);
            protocolMarshaller.marshall(lakeConfigurationRequest.getRetentionSettings(), RETENTIONSETTINGS_BINDING);
            protocolMarshaller.marshall(lakeConfigurationRequest.getTagsMap(), TAGSMAP_BINDING);
        } catch (Exception e) {
