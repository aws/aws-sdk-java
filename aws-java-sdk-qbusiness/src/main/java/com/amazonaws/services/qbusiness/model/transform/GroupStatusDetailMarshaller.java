...
public class GroupStatusDetailMarshaller {
    ...
    public static GroupStatusDetailMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GroupStatusDetail groupStatusDetail, ProtocolMarshaller protocolMarshaller) {

        if (groupStatusDetail == null) {
