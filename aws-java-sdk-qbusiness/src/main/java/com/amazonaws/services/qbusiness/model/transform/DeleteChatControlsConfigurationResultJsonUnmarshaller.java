...
/**
 * DeleteChatControlsConfigurationResult JSON Unmarshaller
 */
...
public class DeleteChatControlsConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteChatControlsConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteChatControlsConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteChatControlsConfigurationResult deleteChatControlsConfigurationResult = new DeleteChatControlsConfigurationResult();

        return deleteChatControlsConfigurationResult;
    }
