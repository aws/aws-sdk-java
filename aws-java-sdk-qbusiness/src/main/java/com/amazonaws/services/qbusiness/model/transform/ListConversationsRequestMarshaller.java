...
@SdkInternalApi
public class ListConversationsRequestMarshaller {
    ...
    public static ListConversationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListConversationsRequest listConversationsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listConversationsRequest == null) {
