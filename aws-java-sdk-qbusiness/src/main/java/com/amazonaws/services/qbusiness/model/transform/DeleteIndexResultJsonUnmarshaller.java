...
/**
 * DeleteIndexResult JSON Unmarshaller
 */
...
public class DeleteIndexResultJsonUnmarshaller implements Unmarshaller<DeleteIndexResult, JsonUnmarshallerContext> {
    ...
    public DeleteIndexResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteIndexResult deleteIndexResult = new DeleteIndexResult();
