...
public class BatchPutDocumentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setFailedDocuments(java.util.Collection<FailedDocument> failedDocuments) {
        ...
        this.failedDocuments = new java.util.ArrayList<FailedDocument>(failedDocuments);
    }
    ...
    public BatchPutDocumentResult withFailedDocuments(FailedDocument... failedDocuments) {
        if (this.failedDocuments == null) {
            setFailedDocuments(new java.util.ArrayList<FailedDocument>(failedDocuments.length));
        }
        for (FailedDocument ele : failedDocuments) {
    ...
    public BatchPutDocumentResult withFailedDocuments(java.util.Collection<FailedDocument> failedDocuments) {
