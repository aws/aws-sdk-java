...
/**
 * ActionReviewPayloadField JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ActionReviewPayloadFieldJsonUnmarshaller implements Unmarshaller<ActionReviewPayloadField, JsonUnmarshallerContext> {

    public ActionReviewPayloadField unmarshall(JsonUnmarshallerContext context) throws Exception {
        ActionReviewPayloadField actionReviewPayloadField = new ActionReviewPayloadField();
    ...
    private static ActionReviewPayloadFieldJsonUnmarshaller instance;

    public static ActionReviewPayloadFieldJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ActionReviewPayloadFieldJsonUnmarshaller();
        return instance;
    }
}
