...
public class GetDataSourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetDataSourceRequest withApplicationId(String applicationId) {
     ...
     * </p>
     * 
     * @return The identfier of the index used with the data source connector.
     */
    ...
    public GetDataSourceRequest withIndexId(String indexId) {
        setIndexId(indexId);
        return this;
    }
