...
/**
 * SourceAttribution JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SourceAttributionJsonUnmarshaller implements Unmarshaller<SourceAttribution, JsonUnmarshallerContext> {

    public SourceAttribution unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SourceAttributionJsonUnmarshaller instance;

    public static SourceAttributionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SourceAttributionJsonUnmarshaller();
        return instance;
    }
}
