...
public class AttachmentInputMarshaller {
    ...
    public static AttachmentInputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AttachmentInput attachmentInput, ProtocolMarshaller protocolMarshaller) {
