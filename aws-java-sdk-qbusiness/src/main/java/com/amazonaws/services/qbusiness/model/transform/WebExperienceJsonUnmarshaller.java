...
/**
 * WebExperience JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WebExperienceJsonUnmarshaller implements Unmarshaller<WebExperience, JsonUnmarshallerContext> {

    public WebExperience unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("defaultEndpoint", targetDepth)) {
                    context.nextToken();
                    webExperience.setDefaultEndpoint(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static WebExperienceJsonUnmarshaller instance;

    public static WebExperienceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new WebExperienceJsonUnmarshaller();
        return instance;
    }
}
