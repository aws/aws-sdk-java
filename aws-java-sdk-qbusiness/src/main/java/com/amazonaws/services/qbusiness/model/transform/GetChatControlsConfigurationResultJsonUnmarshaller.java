...
/**
 * GetChatControlsConfigurationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetChatControlsConfigurationResultJsonUnmarshaller implements Unmarshaller<GetChatControlsConfigurationResult, JsonUnmarshallerContext> {

    public GetChatControlsConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetChatControlsConfigurationResult getChatControlsConfigurationResult = new GetChatControlsConfigurationResult();
        ...
        if (token == VALUE_NULL) {
            return getChatControlsConfigurationResult;
        }
    ...
    private static GetChatControlsConfigurationResultJsonUnmarshaller instance;

    public static GetChatControlsConfigurationResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetChatControlsConfigurationResultJsonUnmarshaller();
        return instance;
    }
}
