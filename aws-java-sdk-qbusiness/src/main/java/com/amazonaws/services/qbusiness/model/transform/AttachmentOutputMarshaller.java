...
public class AttachmentOutputMarshaller {
    ...
    public static AttachmentOutputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AttachmentOutput attachmentOutput, ProtocolMarshaller protocolMarshaller) {
