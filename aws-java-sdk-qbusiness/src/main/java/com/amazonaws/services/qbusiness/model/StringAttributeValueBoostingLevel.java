...
public enum StringAttributeValueBoostingLevel {
     ...
     * @param value
     *        real value
     * @return StringAttributeValueBoostingLevel corresponding to the value
     *
    ...
    public static StringAttributeValueBoostingLevel fromValue(String value) {
        ...
        for (StringAttributeValueBoostingLevel enumEntry : StringAttributeValueBoostingLevel.values()) {
