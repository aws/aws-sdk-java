...
public class InvalidDBSnapshotStateExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public InvalidDBSnapshotStateExceptionUnmarshaller() {
        super(InvalidDBSnapshotStateException.class);
    }
