 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/ModifyEventSubscription" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ModifyEventSubscriptionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * an instance, set this parameter to <code>db-instance</code>. If this value is not specified, all events are
     * returned.
     * </p>
     * <p>
     ...
     * </p>
     * 
     * @return The name of the Amazon DocumentDB event notification subscription.
     */
     ...
     *        generated by an instance, set this parameter to <code>db-instance</code>. If this value is not specified,
     ...
     * </p>
     * 
     * @return A Boolean value; set to <code>true</code> to activate the subscription.
     */
