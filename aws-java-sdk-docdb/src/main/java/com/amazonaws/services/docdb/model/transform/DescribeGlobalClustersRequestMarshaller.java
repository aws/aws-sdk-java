...
public class DescribeGlobalClustersRequestMarshaller implements Marshaller<Request<DescribeGlobalClustersRequest>, DescribeGlobalClustersRequest> {
    ...
    public Request<DescribeGlobalClustersRequest> marshall(DescribeGlobalClustersRequest describeGlobalClustersRequest) {
        ...
        Request<DescribeGlobalClustersRequest> request = new DefaultRequest<DescribeGlobalClustersRequest>(describeGlobalClustersRequest, "AmazonDocDB");
        ...
        if (describeGlobalClustersRequest.getFilters() != null) {
            java.util.List<Filter> filtersList = describeGlobalClustersRequest.getFilters();
