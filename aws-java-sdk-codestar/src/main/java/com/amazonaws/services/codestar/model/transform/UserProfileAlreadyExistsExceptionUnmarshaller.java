...
public class UserProfileAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UserProfileAlreadyExistsExceptionUnmarshaller instance;

    public static UserProfileAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UserProfileAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
