...
public class ProjectConfigurationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ProjectConfigurationExceptionUnmarshaller instance;

    public static ProjectConfigurationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProjectConfigurationExceptionUnmarshaller();
        return instance;
    }
}
