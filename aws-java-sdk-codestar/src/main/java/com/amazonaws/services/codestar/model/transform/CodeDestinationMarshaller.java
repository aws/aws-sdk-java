...
public class CodeDestinationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> GITHUB_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("gitHub").build();
    ...
    public void marshall(CodeDestination codeDestination, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(codeDestination.getCodeCommit(), CODECOMMIT_BINDING);
            protocolMarshaller.marshall(codeDestination.getGitHub(), GITHUB_BINDING);
        } catch (Exception e) {
