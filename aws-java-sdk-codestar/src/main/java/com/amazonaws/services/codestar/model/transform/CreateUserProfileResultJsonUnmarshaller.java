        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("createdTimestamp", targetDepth)) {
                    context.nextToken();
                    createUserProfileResult.setCreatedTimestamp(context.getUnmarshaller(java.util.Date.class).unmarshall(context));
                }
                if (context.testExpression("lastModifiedTimestamp", targetDepth)) {
                    context.nextToken();
                    createUserProfileResult.setLastModifiedTimestamp(context.getUnmarshaller(java.util.Date.class).unmarshall(context));
                }
