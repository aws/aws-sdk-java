...
/**
 * AssociateTeamMemberResult JSON Unmarshaller
 */
...
public class AssociateTeamMemberResultJsonUnmarshaller implements Unmarshaller<AssociateTeamMemberResult, JsonUnmarshallerContext> {
    ...
    public AssociateTeamMemberResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("clientRequestToken", targetDepth)) {
                    context.nextToken();
                    associateTeamMemberResult.setClientRequestToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
