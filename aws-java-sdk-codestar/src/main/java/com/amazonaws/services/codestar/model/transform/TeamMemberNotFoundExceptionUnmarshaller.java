...
public class TeamMemberNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TeamMemberNotFoundExceptionUnmarshaller instance;

    public static TeamMemberNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TeamMemberNotFoundExceptionUnmarshaller();
        return instance;
    }
}
