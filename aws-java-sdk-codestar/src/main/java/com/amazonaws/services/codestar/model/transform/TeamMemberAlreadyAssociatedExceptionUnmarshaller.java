...
public class TeamMemberAlreadyAssociatedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TeamMemberAlreadyAssociatedExceptionUnmarshaller instance;

    public static TeamMemberAlreadyAssociatedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TeamMemberAlreadyAssociatedExceptionUnmarshaller();
        return instance;
    }
}
