...
public class ProjectCreationFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ProjectCreationFailedExceptionUnmarshaller instance;

    public static ProjectCreationFailedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProjectCreationFailedExceptionUnmarshaller();
        return instance;
    }
}
