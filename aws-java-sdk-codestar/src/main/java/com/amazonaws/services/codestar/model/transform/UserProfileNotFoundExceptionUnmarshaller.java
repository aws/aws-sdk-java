...
public class UserProfileNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UserProfileNotFoundExceptionUnmarshaller instance;

    public static UserProfileNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UserProfileNotFoundExceptionUnmarshaller();
        return instance;
    }
}
