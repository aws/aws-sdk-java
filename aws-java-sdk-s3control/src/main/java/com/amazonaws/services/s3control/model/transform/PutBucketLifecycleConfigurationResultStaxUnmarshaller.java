...
/**
 * PutBucketLifecycleConfigurationResult StAX Unmarshaller
 */
...
public class PutBucketLifecycleConfigurationResultStaxUnmarshaller implements Unmarshaller<PutBucketLifecycleConfigurationResult, StaxUnmarshallerContext> {
    ...
    public PutBucketLifecycleConfigurationResult unmarshall(StaxUnmarshallerContext context) throws Exception {
