...
/**
 * GetStorageLensConfigurationResult StAX Unmarshaller
 */
...
public class GetStorageLensConfigurationResultStaxUnmarshaller implements Unmarshaller<GetStorageLensConfigurationResult, StaxUnmarshallerContext> {
    ...
    public GetStorageLensConfigurationResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("StorageLensConfiguration", targetDepth)) {
                    getStorageLensConfigurationResult.setStorageLensConfiguration(StorageLensConfigurationStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
