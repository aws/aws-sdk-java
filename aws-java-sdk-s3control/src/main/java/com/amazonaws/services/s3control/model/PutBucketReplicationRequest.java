...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/s3control-2018-08-20/PutBucketReplication" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PutBucketReplicationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Web Services account ID of the Outposts bucket.
     */
     ...
     * 
     * @param bucket
     *        Specifies the S3 on Outposts bucket to set the configuration for.</p>
     *        <p>
     *        For using this parameter with Amazon S3 on Outposts with the REST API, you must specify the name and the
     *        x-amz-outpost-id as well.
     *        </p>
     ...
     * </p>
     * 
     * @return Specifies the S3 on Outposts bucket to set the configuration for.</p>
     *         <p>
     *         For using this parameter with Amazon S3 on Outposts with the REST API, you must specify the name and the
     *         x-amz-outpost-id as well.
     *         </p>
    ...
    @Override
    public PutBucketReplicationRequest clone() {
        return (PutBucketReplicationRequest) super.clone();
    }
