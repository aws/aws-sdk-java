 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/s3control-2018-08-20/ListAccessGrantsInstanceEntry"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListAccessGrantsInstanceEntry implements Serializable, Cloneable {
    ...
    public ListAccessGrantsInstanceEntry withAccessGrantsInstanceId(String accessGrantsInstanceId) {
    ...
    public ListAccessGrantsInstanceEntry withCreatedAt(java.util.Date createdAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAccessGrantsInstanceEntry == false)
            return false;
    ...
    public ListAccessGrantsInstanceEntry clone() {
        try {
            return (ListAccessGrantsInstanceEntry) super.clone();
