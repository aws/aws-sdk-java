        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ID", targetDepth)) {
                    s3ObjectOwner.setID(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("DisplayName", targetDepth)) {
                    s3ObjectOwner.setDisplayName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
