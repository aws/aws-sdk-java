...
/**
 * NoncurrentVersionTransition StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NoncurrentVersionTransitionStaxUnmarshaller implements Unmarshaller<NoncurrentVersionTransition, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("NoncurrentDays", targetDepth)) {
                    noncurrentVersionTransition.setNoncurrentDays(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("StorageClass", targetDepth)) {
                    noncurrentVersionTransition.setStorageClass(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
