...
public class DeleteBucketReplicationRequestMarshaller implements Marshaller<Request<DeleteBucketReplicationRequest>, DeleteBucketReplicationRequest> {
    ...
    public Request<DeleteBucketReplicationRequest> marshall(DeleteBucketReplicationRequest deleteBucketReplicationRequest) {
        ...
        Request<DeleteBucketReplicationRequest> request = new DefaultRequest<DeleteBucketReplicationRequest>(deleteBucketReplicationRequest, "AWSS3Control");

        request.setHttpMethod(HttpMethodName.DELETE);

        if (deleteBucketReplicationRequest.getAccountId() != null) {
            request.addHeader("x-amz-account-id", StringUtils.fromString(deleteBucketReplicationRequest.getAccountId()));
        }

        String uriResourcePath = "/v20180820/bucket/{name}/replication";

        uriResourcePath = com.amazonaws.transform.PathMarshallers.NON_GREEDY.marshall(uriResourcePath, "name", deleteBucketReplicationRequest.getBucket());
