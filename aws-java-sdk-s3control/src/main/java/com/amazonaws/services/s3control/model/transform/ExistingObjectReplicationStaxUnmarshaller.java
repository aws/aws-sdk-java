...
/**
 * ExistingObjectReplication StAX Unmarshaller
 */
...
public class ExistingObjectReplicationStaxUnmarshaller implements Unmarshaller<ExistingObjectReplication, StaxUnmarshallerContext> {
    ...
    public ExistingObjectReplication unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Status", targetDepth)) {
                    existingObjectReplication.setStatus(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
