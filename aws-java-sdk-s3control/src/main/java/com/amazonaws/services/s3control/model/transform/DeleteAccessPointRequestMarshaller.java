...
public class DeleteAccessPointRequestMarshaller implements Marshaller<Request<DeleteAccessPointRequest>, DeleteAccessPointRequest> {
    ...
    public Request<DeleteAccessPointRequest> marshall(DeleteAccessPointRequest deleteAccessPointRequest) {
        ...
        if (deleteAccessPointRequest.getAccountId() != null) {
            request.addHeader("x-amz-account-id", StringUtils.fromString(deleteAccessPointRequest.getAccountId()));
        }

        String uriResourcePath = "/v20180820/accesspoint/{name}";

        uriResourcePath = com.amazonaws.transform.PathMarshallers.NON_GREEDY.marshall(uriResourcePath, "name", deleteAccessPointRequest.getName());
