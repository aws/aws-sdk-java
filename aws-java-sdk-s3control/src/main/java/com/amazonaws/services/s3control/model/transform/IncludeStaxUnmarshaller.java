...
/**
 * Include StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IncludeStaxUnmarshaller implements Unmarshaller<Include, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Buckets/Arn", targetDepth)) {
                    include.withBuckets(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Regions/Region", targetDepth)) {
                    include.withRegions(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
