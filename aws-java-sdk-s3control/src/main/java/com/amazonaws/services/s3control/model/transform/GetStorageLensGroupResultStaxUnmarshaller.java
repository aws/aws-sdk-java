...
/**
 * GetStorageLensGroupResult StAX Unmarshaller
 */
...
public class GetStorageLensGroupResultStaxUnmarshaller implements Unmarshaller<GetStorageLensGroupResult, StaxUnmarshallerContext> {
    ...
    public GetStorageLensGroupResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("StorageLensGroup", targetDepth)) {
                    getStorageLensGroupResult.setStorageLensGroup(StorageLensGroupStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
