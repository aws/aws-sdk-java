...
public class DeleteBucketRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The account ID that owns the Outposts bucket.
     */
    ...
    public DeleteBucketRequest withAccountId(String accountId) {
     ...
     * 
     * @param bucket
     *        Specifies the bucket being deleted.</p>
     *        <p>
     *        For using this parameter with Amazon S3 on Outposts with the REST API, you must specify the name and the
     *        x-amz-outpost-id as well.
     *        </p>
     ...
     * </p>
     * 
     * @return Specifies the bucket being deleted.</p>
     *         <p>
     *         For using this parameter with Amazon S3 on Outposts with the REST API, you must specify the name and the
     *         x-amz-outpost-id as well.
     *         </p>
