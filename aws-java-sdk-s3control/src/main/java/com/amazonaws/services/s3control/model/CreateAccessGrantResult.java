...
public class CreateAccessGrantResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.services.s3control.S3ControlResponseMetadata> implements
    ...
    public CreateAccessGrantResult withCreatedAt(java.util.Date createdAt) {
    ...
    public CreateAccessGrantResult withAccessGrantsLocationId(String accessGrantsLocationId) {
    ...
    public CreateAccessGrantResult withGrantScope(String grantScope) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAccessGrantResult == false)
            return false;
        CreateAccessGrantResult other = (CreateAccessGrantResult) obj;
