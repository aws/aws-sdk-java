...
public class DeleteBucketTaggingRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The AWS account ID of the Outposts bucket tag set to be removed.
     */
    ...
    public DeleteBucketTaggingRequest withAccountId(String accountId) {
    ...
    @Override
    public DeleteBucketTaggingRequest clone() {
        return (DeleteBucketTaggingRequest) super.clone();
    }
