...
/**
 * PrefixLevelStorageMetrics StAX Unmarshaller
 */
...
public class PrefixLevelStorageMetricsStaxUnmarshaller implements Unmarshaller<PrefixLevelStorageMetrics, StaxUnmarshallerContext> {
    ...
    public PrefixLevelStorageMetrics unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("IsEnabled", targetDepth)) {
                    prefixLevelStorageMetrics.setIsEnabled(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("SelectionCriteria", targetDepth)) {
                    prefixLevelStorageMetrics.setSelectionCriteria(SelectionCriteriaStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
