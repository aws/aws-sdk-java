...
import com.amazonaws.services.s3control.model.NoSuchPublicAccessBlockConfigurationException;
...
public class NoSuchPublicAccessBlockConfigurationExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("NoSuchPublicAccessBlockConfiguration"))
            return null;
