 ...
 * </note>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/s3control-2018-08-20/ReplicationTime" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ReplicationTime implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies whether S3 Replication Time Control (S3 RTC) is enabled.
     * @see ReplicationTimeStatus
     */
     ...
     * </p>
     * 
     * @return A container that specifies the time by which replication should be complete for all objects and
