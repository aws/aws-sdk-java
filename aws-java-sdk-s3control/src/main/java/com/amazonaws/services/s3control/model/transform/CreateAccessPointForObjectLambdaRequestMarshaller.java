...
/**
 * CreateAccessPointForObjectLambdaRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateAccessPointForObjectLambdaRequestMarshaller implements
        Marshaller<Request<CreateAccessPointForObjectLambdaRequest>, CreateAccessPointForObjectLambdaRequest> {

    public Request<CreateAccessPointForObjectLambdaRequest> marshall(CreateAccessPointForObjectLambdaRequest createAccessPointForObjectLambdaRequest) {

        if (createAccessPointForObjectLambdaRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        Request<CreateAccessPointForObjectLambdaRequest> request = new DefaultRequest<CreateAccessPointForObjectLambdaRequest>(
                createAccessPointForObjectLambdaRequest, "AWSS3Control");

        request.setHttpMethod(HttpMethodName.PUT);

        if (createAccessPointForObjectLambdaRequest.getAccountId() != null) {
            request.addHeader("x-amz-account-id", StringUtils.fromString(createAccessPointForObjectLambdaRequest.getAccountId()));
        }
        ...
        uriResourcePath = com.amazonaws.transform.PathMarshallers.NON_GREEDY.marshall(uriResourcePath, "name",
                createAccessPointForObjectLambdaRequest.getName());
        ...
        try {
            ...
            xmlWriter.startElement("CreateAccessPointForObjectLambdaRequest");
            if (createAccessPointForObjectLambdaRequest != null) {

                {
                    ObjectLambdaConfiguration configuration = createAccessPointForObjectLambdaRequest.getConfiguration();
