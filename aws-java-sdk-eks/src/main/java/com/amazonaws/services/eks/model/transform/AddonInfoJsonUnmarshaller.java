...
/**
 * AddonInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AddonInfoJsonUnmarshaller implements Unmarshaller<AddonInfo, JsonUnmarshallerContext> {

    public AddonInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static AddonInfoJsonUnmarshaller instance;

    public static AddonInfoJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AddonInfoJsonUnmarshaller();
        return instance;
    }
}
