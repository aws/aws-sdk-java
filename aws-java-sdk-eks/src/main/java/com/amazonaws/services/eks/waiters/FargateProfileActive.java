...
class FargateProfileActive {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<DescribeFargateProfileResult> {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<DescribeFargateProfileResult> {
        private static final JsonNode expectedResult;
