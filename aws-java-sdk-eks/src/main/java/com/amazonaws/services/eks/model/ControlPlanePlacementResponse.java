 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/ControlPlanePlacementResponse" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ControlPlanePlacementResponse implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ControlPlanePlacementResponse == false)
            return false;
        ControlPlanePlacementResponse other = (ControlPlanePlacementResponse) obj;
    ...
    public ControlPlanePlacementResponse clone() {
        try {
            return (ControlPlanePlacementResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.eks.model.transform.ControlPlanePlacementResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
