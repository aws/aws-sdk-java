...
public class CreateEksAnywhereSubscriptionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateEksAnywhereSubscriptionResult == false)
            return false;
        CreateEksAnywhereSubscriptionResult other = (CreateEksAnywhereSubscriptionResult) obj;
    ...
    public CreateEksAnywhereSubscriptionResult clone() {
        try {
            return (CreateEksAnywhereSubscriptionResult) super.clone();
