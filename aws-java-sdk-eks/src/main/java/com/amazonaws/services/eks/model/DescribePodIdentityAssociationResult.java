...
public class DescribePodIdentityAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The full description of the EKS Pod Identity association.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribePodIdentityAssociationResult == false)
            return false;
        DescribePodIdentityAssociationResult other = (DescribePodIdentityAssociationResult) obj;
    ...
    public DescribePodIdentityAssociationResult clone() {
        try {
            return (DescribePodIdentityAssociationResult) super.clone();
