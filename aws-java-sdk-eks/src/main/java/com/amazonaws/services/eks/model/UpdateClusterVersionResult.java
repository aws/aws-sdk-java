...
public class UpdateClusterVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateClusterVersionResult == false)
            return false;
        UpdateClusterVersionResult other = (UpdateClusterVersionResult) obj;
    ...
    public UpdateClusterVersionResult clone() {
        try {
            return (UpdateClusterVersionResult) super.clone();
