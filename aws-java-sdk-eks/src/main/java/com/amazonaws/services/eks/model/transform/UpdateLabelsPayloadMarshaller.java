...
/**
 * UpdateLabelsPayloadMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateLabelsPayloadMarshaller {

    private static final MarshallingInfo<Map> ADDORUPDATELABELS_BINDING = MarshallingInfo.builder(MarshallingType.MAP)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("addOrUpdateLabels").build();
    private static final MarshallingInfo<List> REMOVELABELS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("removeLabels").build();
