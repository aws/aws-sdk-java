...
@SdkInternalApi
public class ProviderMarshaller {
    ...
    public static ProviderMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Provider provider, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(provider.getKeyArn(), KEYARN_BINDING);
        } catch (Exception e) {
