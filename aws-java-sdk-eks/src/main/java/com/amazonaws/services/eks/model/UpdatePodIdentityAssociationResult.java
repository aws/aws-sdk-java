...
public class UpdatePodIdentityAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The full description of the EKS Pod Identity association that was updated.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePodIdentityAssociationResult == false)
            return false;
        UpdatePodIdentityAssociationResult other = (UpdatePodIdentityAssociationResult) obj;
    ...
    @Override
    public UpdatePodIdentityAssociationResult clone() {
        try {
            return (UpdatePodIdentityAssociationResult) super.clone();
