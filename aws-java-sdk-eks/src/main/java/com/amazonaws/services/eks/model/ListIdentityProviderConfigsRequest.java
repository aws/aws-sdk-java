...
public class ListIdentityProviderConfigsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListIdentityProviderConfigsRequest withMaxResults(Integer maxResults) {
    ...
    public ListIdentityProviderConfigsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListIdentityProviderConfigsRequest == false)
            return false;
        ListIdentityProviderConfigsRequest other = (ListIdentityProviderConfigsRequest) obj;
    ...
    @Override
    public ListIdentityProviderConfigsRequest clone() {
        return (ListIdentityProviderConfigsRequest) super.clone();
    }
