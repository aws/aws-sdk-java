...
class AddonDeleted {
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<DescribeAddonResult> {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<DescribeAddonResult> {
        /**
