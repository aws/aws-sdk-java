...
public class VpcConfigRequest implements Serializable, Cloneable, StructuredPojo {
     ...
     * use to allow communication between your worker nodes and the Kubernetes control plane. If you don't specify any
     ...
     *         defaults for clusters deployed with Kubernetes:</p>
     *         <ul>
     *         <li>
     *         <p>
     *         1.14 Amazon EKS platform version <code>eks.2</code> and earlier
