...
public class InsightsFilterMarshaller {
    ...
    private static final MarshallingInfo<List> KUBERNETESVERSIONS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("kubernetesVersions").build();
