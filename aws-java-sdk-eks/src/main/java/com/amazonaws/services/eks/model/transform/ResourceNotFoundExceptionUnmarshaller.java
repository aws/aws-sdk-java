...
public class ResourceNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.eks.model.ResourceNotFoundException> {
    private ResourceNotFoundExceptionUnmarshaller() {
        super("ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.eks.model.ResourceNotFoundException unmarshall(JsonUnmarshallerContext context) throws Exception {
