...
public class CreateAccessEntryResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateAccessEntryResult withAccessEntry(AccessEntry accessEntry) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAccessEntryResult == false)
            return false;
        CreateAccessEntryResult other = (CreateAccessEntryResult) obj;
    ...
    @Override
    public CreateAccessEntryResult clone() {
        try {
            return (CreateAccessEntryResult) super.clone();
