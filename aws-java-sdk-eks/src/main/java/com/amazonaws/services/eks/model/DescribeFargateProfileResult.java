...
public class DescribeFargateProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The full description of your Fargate profile.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeFargateProfileResult == false)
            return false;
        DescribeFargateProfileResult other = (DescribeFargateProfileResult) obj;
    ...
    @Override
    public DescribeFargateProfileResult clone() {
        try {
            return (DescribeFargateProfileResult) super.clone();
