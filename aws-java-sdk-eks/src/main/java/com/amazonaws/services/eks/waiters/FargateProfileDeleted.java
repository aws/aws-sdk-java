...
class FargateProfileDeleted {
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<DescribeFargateProfileResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("fargateProfile"), new JmesPathField("status"));
         ...
         */
        @Override
        public boolean matches(DescribeFargateProfileResult result) {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<DescribeFargateProfileResult> {
        /**
