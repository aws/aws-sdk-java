...
public class CreateNodegroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateNodegroupResult == false)
            return false;
        CreateNodegroupResult other = (CreateNodegroupResult) obj;
    ...
    @Override
    public CreateNodegroupResult clone() {
        try {
            return (CreateNodegroupResult) super.clone();
