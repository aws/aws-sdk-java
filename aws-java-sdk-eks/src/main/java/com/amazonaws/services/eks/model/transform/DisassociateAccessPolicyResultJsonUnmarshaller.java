...
/**
 * DisassociateAccessPolicyResult JSON Unmarshaller
 */
...
public class DisassociateAccessPolicyResultJsonUnmarshaller implements Unmarshaller<DisassociateAccessPolicyResult, JsonUnmarshallerContext> {
    ...
    public DisassociateAccessPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateAccessPolicyResult disassociateAccessPolicyResult = new DisassociateAccessPolicyResult();

        return disassociateAccessPolicyResult;
    }
