...
public class DeleteEndpointRequestMarshaller {
    ...
    private static final MarshallingInfo<String> ENDPOINTID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("endpointId").build();
    ...
    public void marshall(DeleteEndpointRequest deleteEndpointRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteEndpointRequest.getEndpointId(), ENDPOINTID_BINDING);
            protocolMarshaller.marshall(deleteEndpointRequest.getOutpostId(), OUTPOSTID_BINDING);
        } catch (Exception e) {
