...
public class ListSharedEndpointsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The list of endpoints associated with the specified Outpost that have been shared by Amazon Web Services
    ...
    public ListSharedEndpointsResult withEndpoints(Endpoint... endpoints) {
    ...
    public ListSharedEndpointsResult withEndpoints(java.util.Collection<Endpoint> endpoints) {
    ...
    public ListSharedEndpointsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSharedEndpointsResult == false)
            return false;
        ListSharedEndpointsResult other = (ListSharedEndpointsResult) obj;
    ...
    public ListSharedEndpointsResult clone() {
        try {
            return (ListSharedEndpointsResult) super.clone();
