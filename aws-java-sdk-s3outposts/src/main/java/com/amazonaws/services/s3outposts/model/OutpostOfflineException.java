...
public class OutpostOfflineException extends com.amazonaws.services.s3outposts.model.AmazonS3OutpostsException {
     ...
     */
    public OutpostOfflineException(String message) {
        super(message);
    }
