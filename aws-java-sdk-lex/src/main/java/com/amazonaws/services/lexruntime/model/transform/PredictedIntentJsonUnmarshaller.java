...
/**
 * PredictedIntent JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PredictedIntentJsonUnmarshaller implements Unmarshaller<PredictedIntent, JsonUnmarshallerContext> {
    ...
    private static PredictedIntentJsonUnmarshaller instance;

    public static PredictedIntentJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PredictedIntentJsonUnmarshaller();
        return instance;
    }
}
