 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/runtime.lex-2016-11-28/IntentConfidence" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IntentConfidence implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public IntentConfidence clone() {
        try {
            return (IntentConfidence) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lexruntime.model.transform.IntentConfidenceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
