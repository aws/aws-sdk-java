...
public class LoopDetectedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LoopDetectedExceptionUnmarshaller instance;

    public static LoopDetectedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LoopDetectedExceptionUnmarshaller();
        return instance;
    }
}
