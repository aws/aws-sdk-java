...
public class LimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.lexruntime.model.LimitExceededException> {
    private LimitExceededExceptionUnmarshaller() {
        super("LimitExceededException");
    }

    @Override
    public com.amazonaws.services.lexruntime.model.LimitExceededException unmarshall(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.lexruntime.model.LimitExceededException limitExceededException = new com.amazonaws.services.lexruntime.model.LimitExceededException(
                null);
