...
public class ButtonJsonMarshaller {

    /**
     * Marshall the given parameter object, and output to a SdkJsonGenerator
     */
    public void marshall(Button button, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (button.getText() != null) {
                jsonGenerator.writeFieldName("text").writeValue(button.getText());
            }
            if (button.getValue() != null) {
                jsonGenerator.writeFieldName("value").writeValue(button.getValue());
            }
