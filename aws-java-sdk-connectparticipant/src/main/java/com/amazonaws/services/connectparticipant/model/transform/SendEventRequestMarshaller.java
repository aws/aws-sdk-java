...
public class SendEventRequestMarshaller {
    ...
    public void marshall(SendEventRequest sendEventRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sendEventRequest.getContentType(), CONTENTTYPE_BINDING);
            protocolMarshaller.marshall(sendEventRequest.getContent(), CONTENT_BINDING);
            protocolMarshaller.marshall(sendEventRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(sendEventRequest.getConnectionToken(), CONNECTIONTOKEN_BINDING);
        } catch (Exception e) {
