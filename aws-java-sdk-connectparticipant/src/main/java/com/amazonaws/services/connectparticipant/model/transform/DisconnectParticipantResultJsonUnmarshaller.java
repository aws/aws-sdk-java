...
/**
 * DisconnectParticipantResult JSON Unmarshaller
 */
...
public class DisconnectParticipantResultJsonUnmarshaller implements Unmarshaller<DisconnectParticipantResult, JsonUnmarshallerContext> {
    ...
    public DisconnectParticipantResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisconnectParticipantResult disconnectParticipantResult = new DisconnectParticipantResult();
