...
public class DisconnectParticipantRequestMarshaller {
    ...
    public static DisconnectParticipantRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DisconnectParticipantRequest disconnectParticipantRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(disconnectParticipantRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(disconnectParticipantRequest.getConnectionToken(), CONNECTIONTOKEN_BINDING);
        } catch (Exception e) {
