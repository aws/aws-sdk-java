...
/**
 * An Abstract class that users needs to extend instead of {@link AmazonS3} interface. This abstract class is provided
 * so we don't break any customers when we introduce new methods in {@link AmazonS3} interface.
 */
