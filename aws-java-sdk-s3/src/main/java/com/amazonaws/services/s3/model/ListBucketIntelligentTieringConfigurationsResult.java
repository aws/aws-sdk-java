...
public class ListBucketIntelligentTieringConfigurationsResult implements Serializable {
     ...
     *
     * @return The value <code>true</code> if the S3 Intelligent-Tiering configuration listing is <b>not complete</b>.
     ...
     *
     * @param isTruncated
     *            The value <code>true</code> if the S3 Intelligent-Tiering configuration listing is <b>not complete</b>.
