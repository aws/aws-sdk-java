...
public class AuthenticationConfigurationMarshaller {
    ...
    private static final MarshallingInfo<Integer> ACCEPTANCETHRESHOLD_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AcceptanceThreshold").build();
    ...
    public void marshall(AuthenticationConfiguration authenticationConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(authenticationConfiguration.getAcceptanceThreshold(), ACCEPTANCETHRESHOLD_BINDING);
        } catch (Exception e) {
