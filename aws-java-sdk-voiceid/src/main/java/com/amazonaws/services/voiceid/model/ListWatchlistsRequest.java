...
public class ListWatchlistsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListWatchlistsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListWatchlistsRequest == false)
            return false;
        ListWatchlistsRequest other = (ListWatchlistsRequest) obj;
    ...
    public ListWatchlistsRequest clone() {
        return (ListWatchlistsRequest) super.clone();
    }
