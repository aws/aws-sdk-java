    ...
    public ListDomainsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DomainSummaries", targetDepth)) {
                    context.nextToken();
                    listDomainsResult.setDomainSummaries(new ListUnmarshaller<DomainSummary>(DomainSummaryJsonUnmarshaller.getInstance())
