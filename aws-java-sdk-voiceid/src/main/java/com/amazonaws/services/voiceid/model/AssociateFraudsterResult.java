...
public class AssociateFraudsterResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociateFraudsterResult withFraudster(Fraudster fraudster) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateFraudsterResult == false)
            return false;
        AssociateFraudsterResult other = (AssociateFraudsterResult) obj;
    ...
    @Override
    public AssociateFraudsterResult clone() {
        try {
            return (AssociateFraudsterResult) super.clone();
