...
/**
 * FraudRiskDetailsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FraudRiskDetailsMarshaller {
    ...
    public static FraudRiskDetailsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FraudRiskDetails fraudRiskDetails, ProtocolMarshaller protocolMarshaller) {

        if (fraudRiskDetails == null) {
