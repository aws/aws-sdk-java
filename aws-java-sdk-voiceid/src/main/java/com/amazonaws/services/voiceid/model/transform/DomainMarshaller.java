...
public class DomainMarshaller {
    ...
    public void marshall(Domain domain, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(domain.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(domain.getDomainId(), DOMAINID_BINDING);
            protocolMarshaller.marshall(domain.getDomainStatus(), DOMAINSTATUS_BINDING);
