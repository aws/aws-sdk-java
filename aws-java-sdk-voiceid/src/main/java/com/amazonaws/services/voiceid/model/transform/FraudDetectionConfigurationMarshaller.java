...
@SdkInternalApi
public class FraudDetectionConfigurationMarshaller {
    ...
    public static FraudDetectionConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FraudDetectionConfiguration fraudDetectionConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (fraudDetectionConfiguration == null) {
