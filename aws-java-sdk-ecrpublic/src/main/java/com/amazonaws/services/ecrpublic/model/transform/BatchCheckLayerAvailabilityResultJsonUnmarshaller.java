...
public class BatchCheckLayerAvailabilityResultJsonUnmarshaller implements Unmarshaller<BatchCheckLayerAvailabilityResult, JsonUnmarshallerContext> {

    public BatchCheckLayerAvailabilityResult unmarshall(JsonUnmarshallerContext context) throws Exception {
