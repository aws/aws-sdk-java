...
public class PutRepositoryCatalogDataResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The catalog data for the repository.
     */
    ...
    public PutRepositoryCatalogDataResult withCatalogData(RepositoryCatalogData catalogData) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutRepositoryCatalogDataResult == false)
            return false;
        PutRepositoryCatalogDataResult other = (PutRepositoryCatalogDataResult) obj;
    ...
    @Override
    public PutRepositoryCatalogDataResult clone() {
        try {
            return (PutRepositoryCatalogDataResult) super.clone();
