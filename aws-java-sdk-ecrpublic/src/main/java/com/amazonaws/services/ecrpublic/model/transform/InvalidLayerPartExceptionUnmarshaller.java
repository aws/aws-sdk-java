...
public class InvalidLayerPartExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidLayerPartExceptionUnmarshaller() {
        super(com.amazonaws.services.ecrpublic.model.InvalidLayerPartException.class, "InvalidLayerPartException");
    }

    @Override
    public com.amazonaws.services.ecrpublic.model.InvalidLayerPartException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ecrpublic.model.InvalidLayerPartException invalidLayerPartException = new com.amazonaws.services.ecrpublic.model.InvalidLayerPartException(
                null);
