...
/**
 * RepositoryCatalogData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RepositoryCatalogDataJsonUnmarshaller implements Unmarshaller<RepositoryCatalogData, JsonUnmarshallerContext> {

    public RepositoryCatalogData unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static RepositoryCatalogDataJsonUnmarshaller instance;

    public static RepositoryCatalogDataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RepositoryCatalogDataJsonUnmarshaller();
        return instance;
    }
}
