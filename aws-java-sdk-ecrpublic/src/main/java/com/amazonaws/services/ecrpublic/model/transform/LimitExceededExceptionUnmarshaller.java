...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.ecrpublic.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.ecrpublic.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ecrpublic.model.LimitExceededException limitExceededException = new com.amazonaws.services.ecrpublic.model.LimitExceededException(
                null);
