...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.connectcontactlens.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.connectcontactlens.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.connectcontactlens.model.ThrottlingException throttlingException = new com.amazonaws.services.connectcontactlens.model.ThrottlingException(
                null);
