...
public class ListSizeConstraintSetsRequestMarshaller
        implements
        Marshaller<Request<ListSizeConstraintSetsRequest>, ListSizeConstraintSetsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public ListSizeConstraintSetsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<ListSizeConstraintSetsRequest> marshall(
        ...
        Request<ListSizeConstraintSetsRequest> request = new DefaultRequest<ListSizeConstraintSetsRequest>(
                listSizeConstraintSetsRequest, "AWSWAF");
