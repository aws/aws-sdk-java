...
public class DeleteSqlInjectionMatchSetResultJsonUnmarshaller implements Unmarshaller<DeleteSqlInjectionMatchSetResult, JsonUnmarshallerContext> {

    public DeleteSqlInjectionMatchSetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChangeToken", targetDepth)) {
                    context.nextToken();
                    deleteSqlInjectionMatchSetResult.setChangeToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
