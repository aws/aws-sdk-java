 ...
 */
public class XssMatchTupleJsonUnmarshaller implements
        Unmarshaller<XssMatchTuple, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FieldToMatch", targetDepth)) {
                    context.nextToken();
                    xssMatchTuple.setFieldToMatch(FieldToMatchJsonUnmarshaller
