...
public class WebACL implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A friendly name or description of the <code>WebACL</code>. You
     *         can't change the name of a <code>WebACL</code> after you create
     *         it.
     */
     ...
     * </p>
     * 
     * @return The action to perform if none of the <code>Rules</code> contained
     *         in the <code>WebACL</code> match. The action is specified by the
     *         <a>WafAction</a> object.
     */
     ...
     * </p>
     * 
     * @return An array that contains the action for each <code>Rule</code> in a
