...
@SdkInternalApi
public class GetRuleRequestMarshaller {
    ...
    private static final GetRuleRequestMarshaller instance = new GetRuleRequestMarshaller();
     ...
     */
    public void marshall(GetRuleRequest getRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getRuleRequest.getRuleId(), RULEID_BINDING);
        } catch (Exception e) {
