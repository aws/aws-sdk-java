...
public class SizeConstraintSetUpdateJsonUnmarshaller implements Unmarshaller<SizeConstraintSetUpdate, JsonUnmarshallerContext> {
    ...
    public static SizeConstraintSetUpdateJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SizeConstraintSetUpdateJsonUnmarshaller();
        return instance;
    }
}
