 ...
 */
public class GetIPSetResultJsonUnmarshaller implements
        Unmarshaller<GetIPSetResult, JsonUnmarshallerContext> {

    public GetIPSetResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IPSet", targetDepth)) {
                    context.nextToken();
                    getIPSetResult.setIPSet(IPSetJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
