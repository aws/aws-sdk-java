 ...
 */
public class XssMatchSetSummaryJsonUnmarshaller implements
        Unmarshaller<XssMatchSetSummary, JsonUnmarshallerContext> {

    public XssMatchSetSummary unmarshall(JsonUnmarshallerContext context)
            throws Exception {
