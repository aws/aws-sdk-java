...
/**
 * ListSubscribedRuleGroupsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSubscribedRuleGroupsResultJsonUnmarshaller implements Unmarshaller<ListSubscribedRuleGroupsResult, JsonUnmarshallerContext> {

    public ListSubscribedRuleGroupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listSubscribedRuleGroupsResult.setNextMarker(context.getUnmarshaller(String.class).unmarshall(context));
                }
