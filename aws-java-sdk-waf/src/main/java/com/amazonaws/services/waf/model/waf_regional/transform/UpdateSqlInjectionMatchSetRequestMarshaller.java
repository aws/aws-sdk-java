...
public class UpdateSqlInjectionMatchSetRequestMarshaller {
    ...
    private static final UpdateSqlInjectionMatchSetRequestMarshaller instance = new UpdateSqlInjectionMatchSetRequestMarshaller();

    public static UpdateSqlInjectionMatchSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateSqlInjectionMatchSetRequest updateSqlInjectionMatchSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateSqlInjectionMatchSetRequest.getSqlInjectionMatchSetId(), SQLINJECTIONMATCHSETID_BINDING);
            protocolMarshaller.marshall(updateSqlInjectionMatchSetRequest.getChangeToken(), CHANGETOKEN_BINDING);
            protocolMarshaller.marshall(updateSqlInjectionMatchSetRequest.getUpdates(), UPDATES_BINDING);
        } catch (Exception e) {
