...
public class DeleteSizeConstraintSetRequestMarshaller
        implements
        Marshaller<Request<DeleteSizeConstraintSetRequest>, DeleteSizeConstraintSetRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DeleteSizeConstraintSetRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeleteSizeConstraintSetRequest> marshall(
        ...
        Request<DeleteSizeConstraintSetRequest> request = new DefaultRequest<DeleteSizeConstraintSetRequest>(
                deleteSizeConstraintSetRequest, "AWSWAF");
