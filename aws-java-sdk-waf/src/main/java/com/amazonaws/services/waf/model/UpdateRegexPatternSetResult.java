...
public class UpdateRegexPatternSetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The <code>ChangeToken</code> that you used to submit the <code>UpdateRegexPatternSet</code> request. You can also
     ...
     * 
     * @param changeToken
     *        The <code>ChangeToken</code> that you used to submit the <code>UpdateRegexPatternSet</code> request. You
     ...
     * </p>
     * 
     * @return The <code>ChangeToken</code> that you used to submit the <code>UpdateRegexPatternSet</code> request. You
     *         can also use this value to query the status of the request. For more information, see
     *         <a>GetChangeTokenStatus</a>.
     */
    ...
    public UpdateRegexPatternSetResult withChangeToken(String changeToken) {
