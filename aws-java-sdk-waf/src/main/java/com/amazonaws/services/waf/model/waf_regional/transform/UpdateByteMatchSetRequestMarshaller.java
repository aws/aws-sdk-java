 ...
 */
public class UpdateByteMatchSetRequestMarshaller implements Marshaller<Request<UpdateByteMatchSetRequest>, UpdateByteMatchSetRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public UpdateByteMatchSetRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<UpdateByteMatchSetRequest> marshall(UpdateByteMatchSetRequest updateByteMatchSetRequest) {
        ...
        Request<UpdateByteMatchSetRequest> request = new DefaultRequest<UpdateByteMatchSetRequest>(updateByteMatchSetRequest, "AWSWAFRegional");
        request.addHeader("X-Amz-Target", "AWSWAF_Regional_20161128.UpdateByteMatchSet");
