...
public class GetChangeTokenStatusResult implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getChangeTokenStatus() == null
                ^ this.getChangeTokenStatus() == null)
            return false;
        if (other.getChangeTokenStatus() != null
                && other.getChangeTokenStatus().equals(
                        this.getChangeTokenStatus()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getChangeTokenStatus() == null) ? 0
                        : getChangeTokenStatus().hashCode());
        return hashCode;
    }
