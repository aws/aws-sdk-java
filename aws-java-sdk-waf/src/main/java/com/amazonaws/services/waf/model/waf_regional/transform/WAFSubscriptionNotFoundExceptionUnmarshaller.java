...
public class WAFSubscriptionNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static WAFSubscriptionNotFoundExceptionUnmarshaller instance;

    public static WAFSubscriptionNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WAFSubscriptionNotFoundExceptionUnmarshaller();
        return instance;
    }
}
