...
public class PutLoggingConfigurationRequestMarshaller {
    ...
    private static final PutLoggingConfigurationRequestMarshaller instance = new PutLoggingConfigurationRequestMarshaller();

    public static PutLoggingConfigurationRequestMarshaller getInstance() {
        return instance;
    }
