...
public class PredicateMarshaller {
    ...
    public void marshall(Predicate predicate, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(predicate.getNegated(), NEGATED_BINDING);
            protocolMarshaller.marshall(predicate.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(predicate.getDataId(), DATAID_BINDING);
        } catch (Exception e) {
