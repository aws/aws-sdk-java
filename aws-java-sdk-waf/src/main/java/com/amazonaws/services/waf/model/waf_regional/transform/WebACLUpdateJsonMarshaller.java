...
public class WebACLUpdateJsonMarshaller {
    ...
    public void marshall(WebACLUpdate webACLUpdate, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (webACLUpdate.getAction() != null) {
                jsonGenerator.writeFieldName("Action").writeValue(webACLUpdate.getAction());
            }
            if (webACLUpdate.getActivatedRule() != null) {
                jsonGenerator.writeFieldName("ActivatedRule");
                ActivatedRuleJsonMarshaller.getInstance().marshall(webACLUpdate.getActivatedRule(), jsonGenerator);
            }
    ...
    public static WebACLUpdateJsonMarshaller getInstance() {
        if (instance == null)
            instance = new WebACLUpdateJsonMarshaller();
        return instance;
    }
