...
@SdkInternalApi
public class GetRegexPatternSetRequestMarshaller {
    ...
    private static final GetRegexPatternSetRequestMarshaller instance = new GetRegexPatternSetRequestMarshaller();

    public static GetRegexPatternSetRequestMarshaller getInstance() {
        return instance;
    }
