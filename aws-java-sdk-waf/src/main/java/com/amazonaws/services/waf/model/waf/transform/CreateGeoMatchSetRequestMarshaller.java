...
@SdkInternalApi
public class CreateGeoMatchSetRequestMarshaller {
    ...
    private static final CreateGeoMatchSetRequestMarshaller instance = new CreateGeoMatchSetRequestMarshaller();

    public static CreateGeoMatchSetRequestMarshaller getInstance() {
        return instance;
    }
