 ...
 */
public class RuleSummaryJsonUnmarshaller implements
        Unmarshaller<RuleSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RuleId", targetDepth)) {
                    context.nextToken();
                    ruleSummary.setRuleId(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    ruleSummary.setName(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
