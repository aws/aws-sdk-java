...
public class ListSqlInjectionMatchSetsResultJsonUnmarshaller implements
    ...
    public ListSqlInjectionMatchSetsResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listSqlInjectionMatchSetsResult.setNextMarker(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context
                        .testExpression("SqlInjectionMatchSets", targetDepth)) {
                    context.nextToken();
