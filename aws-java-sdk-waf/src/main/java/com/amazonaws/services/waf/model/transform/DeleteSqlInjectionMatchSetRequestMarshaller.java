...
public class DeleteSqlInjectionMatchSetRequestMarshaller
    ...
    public DeleteSqlInjectionMatchSetRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeleteSqlInjectionMatchSetRequest> marshall(
        ...
        Request<DeleteSqlInjectionMatchSetRequest> request = new DefaultRequest<DeleteSqlInjectionMatchSetRequest>(
                deleteSqlInjectionMatchSetRequest, "AWSWAF");
        ...
        try {
            ...
            if (deleteSqlInjectionMatchSetRequest.getChangeToken() != null) {
                jsonGenerator.writeFieldName("ChangeToken").writeValue(
                        deleteSqlInjectionMatchSetRequest.getChangeToken());
            }
