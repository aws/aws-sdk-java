...
public class WAFDisallowedNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static WAFDisallowedNameExceptionUnmarshaller instance;

    public static WAFDisallowedNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WAFDisallowedNameExceptionUnmarshaller();
        return instance;
    }
}
