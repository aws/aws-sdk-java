...
public class UpdateSizeConstraintSetResultJsonUnmarshaller implements Unmarshaller<UpdateSizeConstraintSetResult, JsonUnmarshallerContext> {
    ...
    private static UpdateSizeConstraintSetResultJsonUnmarshaller instance;

    public static UpdateSizeConstraintSetResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateSizeConstraintSetResultJsonUnmarshaller();
        return instance;
    }
}
