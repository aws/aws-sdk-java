...
public class XssMatchSetUpdate implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * Specify <code>INSERT</code> to add a <a>XssMatchSetUpdate</a> to an
     ...
     * </p>
     * 
     * @return Specify <code>INSERT</code> to add a <a>XssMatchSetUpdate</a> to
     *         an <a>XssMatchSet</a>. Use <code>DELETE</code> to remove a
     *         <code>XssMatchSetUpdate</code> from an <code>XssMatchSet</code>.
     * @see ChangeAction
     */
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getXssMatchTuple() == null) ? 0 : getXssMatchTuple()
                        .hashCode());
        return hashCode;
    }
