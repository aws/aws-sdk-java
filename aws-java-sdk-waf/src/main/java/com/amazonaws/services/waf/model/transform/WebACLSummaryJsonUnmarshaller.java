 ...
 */
public class WebACLSummaryJsonUnmarshaller implements
        Unmarshaller<WebACLSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("WebACLId", targetDepth)) {
                    context.nextToken();
                    webACLSummary.setWebACLId(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    webACLSummary.setName(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
