...
public class ListWebACLsResultJsonUnmarshaller implements
    ...
    public ListWebACLsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listWebACLsResult.setNextMarker(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("WebACLs", targetDepth)) {
                    context.nextToken();
                    listWebACLsResult
                            .setWebACLs(new ListUnmarshaller<WebACLSummary>(
