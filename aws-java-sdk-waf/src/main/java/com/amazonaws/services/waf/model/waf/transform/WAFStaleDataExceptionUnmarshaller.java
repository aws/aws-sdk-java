...
public class WAFStaleDataExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static WAFStaleDataExceptionUnmarshaller instance;

    public static WAFStaleDataExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WAFStaleDataExceptionUnmarshaller();
        return instance;
    }
}
