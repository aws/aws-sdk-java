 ...
 */
public class SizeConstraintSetUpdateJsonUnmarshaller implements
        Unmarshaller<SizeConstraintSetUpdate, JsonUnmarshallerContext> {

    public SizeConstraintSetUpdate unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("SizeConstraint", targetDepth)) {
                    ...
                    sizeConstraintSetUpdate
                            .setSizeConstraint(SizeConstraintJsonUnmarshaller
