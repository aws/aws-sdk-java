...
/**
 * RegexPatternSetSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RegexPatternSetSummaryJsonUnmarshaller implements Unmarshaller<RegexPatternSetSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RegexPatternSetId", targetDepth)) {
                    context.nextToken();
                    regexPatternSetSummary.setRegexPatternSetId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    regexPatternSetSummary.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
