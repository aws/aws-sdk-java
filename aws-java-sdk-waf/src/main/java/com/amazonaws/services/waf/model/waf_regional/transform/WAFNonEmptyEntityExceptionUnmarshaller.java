...
public class WAFNonEmptyEntityExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static WAFNonEmptyEntityExceptionUnmarshaller instance;

    public static WAFNonEmptyEntityExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WAFNonEmptyEntityExceptionUnmarshaller();
        return instance;
    }
}
