...
public class AWSWAFRegionalAsyncClient extends AWSWAFRegionalClient implements AWSWAFRegionalAsync {
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSWAFRegionalAsyncClient(com.amazonaws.ClientConfiguration clientConfiguration) {
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSWAFRegionalAsyncClient(com.amazonaws.auth.AWSCredentials awsCredentials) {
     ...
     */
    public AWSWAFRegionalAsyncClient(com.amazonaws.auth.AWSCredentials awsCredentials, java.util.concurrent.ExecutorService executorService) {
     ...
     *        The executor service by which all asynchronous requests will be executed.
     */
    public AWSWAFRegionalAsyncClient(com.amazonaws.auth.AWSCredentials awsCredentials, com.amazonaws.ClientConfiguration clientConfiguration,
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSWAFRegionalAsyncClient(com.amazonaws.auth.AWSCredentialsProvider awsCredentialsProvider) {
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSWAFRegionalAsyncClient(com.amazonaws.auth.AWSCredentialsProvider awsCredentialsProvider, com.amazonaws.ClientConfiguration clientConfiguration) {
     ...
     *        The executor service by which all asynchronous requests will be executed.
     */
    public AWSWAFRegionalAsyncClient(com.amazonaws.auth.AWSCredentialsProvider awsCredentialsProvider, java.util.concurrent.ExecutorService executorService) {
