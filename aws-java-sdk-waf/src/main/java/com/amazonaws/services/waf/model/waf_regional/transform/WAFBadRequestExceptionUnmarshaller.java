...
public class WAFBadRequestExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static WAFBadRequestExceptionUnmarshaller instance;

    public static WAFBadRequestExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WAFBadRequestExceptionUnmarshaller();
        return instance;
    }
}
