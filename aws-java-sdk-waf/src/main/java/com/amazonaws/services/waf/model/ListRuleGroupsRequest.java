...
public class ListRuleGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * If you specify a value for <code>Limit</code> and you have more <code>RuleGroups</code> than the value of
     * <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to list
     * another group of <code>RuleGroups</code>. For the second and subsequent <code>ListRuleGroups</code> requests,
    ...
    /**
     * <p>
     * Specifies the number of <code>RuleGroups</code> that you want AWS WAF to return for this request. If you have
     * more <code>RuleGroups</code> than the number that you specify for <code>Limit</code>, the response includes a
     * <code>NextMarker</code> value that you can use to get another batch of <code>RuleGroups</code>.
     * </p>
     */
     ...
     *        list another group of <code>RuleGroups</code>. For the second and subsequent <code>ListRuleGroups</code>
     ...
     * </p>
     * 
     * @return If you specify a value for <code>Limit</code> and you have more <code>RuleGroups</code> than the value of
     *         <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to
     *         list another group of <code>RuleGroups</code>. For the second and subsequent <code>ListRuleGroups</code>
     ...
     * 
     * @param limit
     *        Specifies the number of <code>RuleGroups</code> that you want AWS WAF to return for this request. If you
     *        have more <code>RuleGroups</code> than the number that you specify for <code>Limit</code>, the response
     *        includes a <code>NextMarker</code> value that you can use to get another batch of <code>RuleGroups</code>.
     */
     ...
     * </p>
     * 
     * @return Specifies the number of <code>RuleGroups</code> that you want AWS WAF to return for this request. If you
     *         have more <code>RuleGroups</code> than the number that you specify for <code>Limit</code>, the response
     *         includes a <code>NextMarker</code> value that you can use to get another batch of <code>RuleGroups</code>
     *         .
     */
