 ...
 */
public class SqlInjectionMatchSetUpdateJsonUnmarshaller implements
        Unmarshaller<SqlInjectionMatchSetUpdate, JsonUnmarshallerContext> {

    public SqlInjectionMatchSetUpdate unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Action", targetDepth)) {
                    context.nextToken();
                    sqlInjectionMatchSetUpdate.setAction(StringJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
                if (context.testExpression("SqlInjectionMatchTuple",
                        targetDepth)) {
                    context.nextToken();
