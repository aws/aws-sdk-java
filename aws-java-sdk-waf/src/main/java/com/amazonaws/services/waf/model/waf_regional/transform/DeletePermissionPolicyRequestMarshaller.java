...
@SdkInternalApi
public class DeletePermissionPolicyRequestMarshaller {

    private static final MarshallingInfo<String> RESOURCEARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ResourceArn").build();

    private static final DeletePermissionPolicyRequestMarshaller instance = new DeletePermissionPolicyRequestMarshaller();

    public static DeletePermissionPolicyRequestMarshaller getInstance() {
        return instance;
    }
