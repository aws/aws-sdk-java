...
public class ListIPSetsResultJsonUnmarshaller implements
    ...
    public ListIPSetsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listIPSetsResult.setNextMarker(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("IPSets", targetDepth)) {
                    context.nextToken();
                    listIPSetsResult
                            .setIPSets(new ListUnmarshaller<IPSetSummary>(
