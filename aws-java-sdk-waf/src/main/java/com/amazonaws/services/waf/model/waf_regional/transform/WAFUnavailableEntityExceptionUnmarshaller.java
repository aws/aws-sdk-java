...
public class WAFUnavailableEntityExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static WAFUnavailableEntityExceptionUnmarshaller instance;

    public static WAFUnavailableEntityExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WAFUnavailableEntityExceptionUnmarshaller();
        return instance;
    }
}
