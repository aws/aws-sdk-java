...
public class SqlInjectionMatchSetUpdateJsonMarshaller {
     ...
     */
    public void marshall(SqlInjectionMatchSetUpdate sqlInjectionMatchSetUpdate, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (sqlInjectionMatchSetUpdate.getAction() != null) {
                jsonGenerator.writeFieldName("Action").writeValue(sqlInjectionMatchSetUpdate.getAction());
            }
            if (sqlInjectionMatchSetUpdate.getSqlInjectionMatchTuple() != null) {
                jsonGenerator.writeFieldName("SqlInjectionMatchTuple");
                SqlInjectionMatchTupleJsonMarshaller.getInstance().marshall(sqlInjectionMatchSetUpdate.getSqlInjectionMatchTuple(), jsonGenerator);
            }
