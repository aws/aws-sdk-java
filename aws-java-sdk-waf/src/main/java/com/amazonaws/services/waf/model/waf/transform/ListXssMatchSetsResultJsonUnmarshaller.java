...
public class ListXssMatchSetsResultJsonUnmarshaller implements Unmarshaller<ListXssMatchSetsResult, JsonUnmarshallerContext> {
    ...
    private static ListXssMatchSetsResultJsonUnmarshaller instance;

    public static ListXssMatchSetsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListXssMatchSetsResultJsonUnmarshaller();
        return instance;
    }
}
