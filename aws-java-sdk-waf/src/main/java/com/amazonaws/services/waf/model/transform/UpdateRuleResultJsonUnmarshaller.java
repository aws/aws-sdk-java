 ...
 */
public class UpdateRuleResultJsonUnmarshaller implements
        Unmarshaller<UpdateRuleResult, JsonUnmarshallerContext> {

    public UpdateRuleResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChangeToken", targetDepth)) {
                    context.nextToken();
                    updateRuleResult.setChangeToken(context.getUnmarshaller(
