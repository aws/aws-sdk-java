 ...
 */
public class DeleteRuleResultJsonUnmarshaller implements
        Unmarshaller<DeleteRuleResult, JsonUnmarshallerContext> {

    public DeleteRuleResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChangeToken", targetDepth)) {
                    context.nextToken();
                    deleteRuleResult.setChangeToken(context.getUnmarshaller(
