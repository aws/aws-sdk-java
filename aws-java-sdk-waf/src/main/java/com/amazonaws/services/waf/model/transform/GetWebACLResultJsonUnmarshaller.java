 ...
 */
public class GetWebACLResultJsonUnmarshaller implements
        Unmarshaller<GetWebACLResult, JsonUnmarshallerContext> {

    public GetWebACLResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("WebACL", targetDepth)) {
                    context.nextToken();
                    getWebACLResult.setWebACL(WebACLJsonUnmarshaller
