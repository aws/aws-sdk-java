...
public class GetSampledRequestsRequestMarshaller
        implements
        Marshaller<Request<GetSampledRequestsRequest>, GetSampledRequestsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public GetSampledRequestsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<GetSampledRequestsRequest> marshall(
        ...
        Request<GetSampledRequestsRequest> request = new DefaultRequest<GetSampledRequestsRequest>(
                getSampledRequestsRequest, "AWSWAF");
