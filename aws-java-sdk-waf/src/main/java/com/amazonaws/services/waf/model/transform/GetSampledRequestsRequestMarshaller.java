 ...
 */
public class GetSampledRequestsRequestMarshaller implements Marshaller<Request<GetSampledRequestsRequest>, GetSampledRequestsRequest> {
    ...
    public Request<GetSampledRequestsRequest> marshall(GetSampledRequestsRequest getSampledRequestsRequest) {
        ...
        Request<GetSampledRequestsRequest> request = new DefaultRequest<GetSampledRequestsRequest>(getSampledRequestsRequest, "AWSWAF");
        ...
        try {
            ...
            if (getSampledRequestsRequest.getMaxItems() != null) {
                jsonGenerator.writeFieldName("MaxItems").writeValue(getSampledRequestsRequest.getMaxItems());
            }
