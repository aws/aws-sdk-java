 ...
 */
public class CreateWebACLResultJsonUnmarshaller implements
        Unmarshaller<CreateWebACLResult, JsonUnmarshallerContext> {

    public CreateWebACLResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("WebACL", targetDepth)) {
                    context.nextToken();
                    createWebACLResult.setWebACL(WebACLJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
                if (context.testExpression("ChangeToken", targetDepth)) {
                    context.nextToken();
                    createWebACLResult.setChangeToken(context.getUnmarshaller(
