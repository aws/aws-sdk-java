...
/**
 * CreateRegexMatchSetResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateRegexMatchSetResultJsonUnmarshaller implements Unmarshaller<CreateRegexMatchSetResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RegexMatchSet", targetDepth)) {
                    context.nextToken();
                    createRegexMatchSetResult.setRegexMatchSet(RegexMatchSetJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ChangeToken", targetDepth)) {
                    context.nextToken();
                    createRegexMatchSetResult.setChangeToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
