...
public class XssMatchSetUpdateJsonMarshaller {
     ...
     */
    public void marshall(XssMatchSetUpdate xssMatchSetUpdate,
        ...
        try {
            ...
            if (xssMatchSetUpdate.getAction() != null) {
                jsonGenerator.writeFieldName("Action").writeValue(
                        xssMatchSetUpdate.getAction());
            }
            if (xssMatchSetUpdate.getXssMatchTuple() != null) {
                jsonGenerator.writeFieldName("XssMatchTuple");
                XssMatchTupleJsonMarshaller.getInstance().marshall(
                        xssMatchSetUpdate.getXssMatchTuple(), jsonGenerator);
            }
