 ...
 */
public class GetSampledRequestsResultJsonUnmarshaller implements
        Unmarshaller<GetSampledRequestsResult, JsonUnmarshallerContext> {

    public GetSampledRequestsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SampledRequests", targetDepth)) {
                    ...
                    getSampledRequestsResult
                            .setSampledRequests(new ListUnmarshaller<SampledHTTPRequest>(
                ...
                if (context.testExpression("TimeWindow", targetDepth)) {
                    context.nextToken();
                    getSampledRequestsResult
                            .setTimeWindow(TimeWindowJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
