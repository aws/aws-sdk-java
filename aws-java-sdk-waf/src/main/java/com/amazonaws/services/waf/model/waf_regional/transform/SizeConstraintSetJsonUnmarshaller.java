...
public class SizeConstraintSetJsonUnmarshaller implements Unmarshaller<SizeConstraintSet, JsonUnmarshallerContext> {
    ...
    public static SizeConstraintSetJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SizeConstraintSetJsonUnmarshaller();
        return instance;
    }
}
