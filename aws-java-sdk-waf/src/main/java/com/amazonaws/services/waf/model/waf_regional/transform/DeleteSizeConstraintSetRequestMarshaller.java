...
/**
 * DeleteSizeConstraintSetRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteSizeConstraintSetRequestMarshaller {
    ...
    private static final DeleteSizeConstraintSetRequestMarshaller instance = new DeleteSizeConstraintSetRequestMarshaller();

    public static DeleteSizeConstraintSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteSizeConstraintSetRequest deleteSizeConstraintSetRequest, ProtocolMarshaller protocolMarshaller) {
