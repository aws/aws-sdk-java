...
public class UpdateWebACLResultJsonUnmarshaller implements Unmarshaller<UpdateWebACLResult, JsonUnmarshallerContext> {
    ...
    private static UpdateWebACLResultJsonUnmarshaller instance;

    public static UpdateWebACLResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateWebACLResultJsonUnmarshaller();
        return instance;
    }
}
