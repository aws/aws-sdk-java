 ...
 * 
 */
public class GetSampledRequestsResult extends
     ...
     * any). Use {@link #setSampledRequests(java.util.Collection)} or
     * {@link #withSampledRequests(java.util.Collection)} if you want to
    ...
    public GetSampledRequestsResult withSampledRequests(
        ...
        if (this.sampledRequests == null) {
            setSampledRequests(new java.util.ArrayList<SampledHTTPRequest>(
     ...
     * </p>
     * 
     * @return The total number of requests from which
     *         <code>GetSampledRequests</code> got a sample of
     *         <code>MaxItems</code> requests. If <code>PopulationSize</code> is
     ...
     *        specified in the <code>GetSampledRequests</code> request. However,
     ...
     * </p>
     * 
     * @return Usually, <code>TimeWindow</code> is the time range that you
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getPopulationSize() == null) ? 0 : getPopulationSize()
                        .hashCode());
