...
/**
 * UpdateXssMatchSetRequestMarshaller
 */
...
public class UpdateXssMatchSetRequestMarshaller {
    ...
    private static final UpdateXssMatchSetRequestMarshaller instance = new UpdateXssMatchSetRequestMarshaller();

    public static UpdateXssMatchSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateXssMatchSetRequest updateXssMatchSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateXssMatchSetRequest.getXssMatchSetId(), XSSMATCHSETID_BINDING);
            protocolMarshaller.marshall(updateXssMatchSetRequest.getChangeToken(), CHANGETOKEN_BINDING);
            protocolMarshaller.marshall(updateXssMatchSetRequest.getUpdates(), UPDATES_BINDING);
        } catch (Exception e) {
