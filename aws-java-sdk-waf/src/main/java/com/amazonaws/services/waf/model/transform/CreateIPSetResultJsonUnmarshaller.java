...
public class CreateIPSetResultJsonUnmarshaller implements
    ...
    public CreateIPSetResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IPSet", targetDepth)) {
                    context.nextToken();
                    createIPSetResult.setIPSet(IPSetJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
                if (context.testExpression("ChangeToken", targetDepth)) {
                    context.nextToken();
                    createIPSetResult.setChangeToken(context.getUnmarshaller(
