...
public class XssMatchSetJsonMarshaller {
     ...
     */
    public void marshall(XssMatchSet xssMatchSet, SdkJsonGenerator jsonGenerator) {
        if (xssMatchSet == null) {
        ...
        try {
            ...
            java.util.List<XssMatchTuple> xssMatchTuplesList = xssMatchSet
                    .getXssMatchTuples();
                ...
                for (XssMatchTuple xssMatchTuplesListValue : xssMatchTuplesList) {
                    if (xssMatchTuplesListValue != null) {
                        ...
                        XssMatchTupleJsonMarshaller.getInstance().marshall(
                                xssMatchTuplesListValue, jsonGenerator);
                    }
                }
