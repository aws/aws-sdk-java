...
public class ListByteMatchSetsResultJsonUnmarshaller implements Unmarshaller<ListByteMatchSetsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listByteMatchSetsResult.setNextMarker(context.getUnmarshaller(String.class).unmarshall(context));
                }
