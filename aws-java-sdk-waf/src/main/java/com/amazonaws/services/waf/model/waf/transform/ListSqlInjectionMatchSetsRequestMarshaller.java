...
public class ListSqlInjectionMatchSetsRequestMarshaller implements Marshaller<Request<ListSqlInjectionMatchSetsRequest>, ListSqlInjectionMatchSetsRequest> {
    ...
    public ListSqlInjectionMatchSetsRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<ListSqlInjectionMatchSetsRequest> marshall(ListSqlInjectionMatchSetsRequest listSqlInjectionMatchSetsRequest) {
        ...
        Request<ListSqlInjectionMatchSetsRequest> request = new DefaultRequest<ListSqlInjectionMatchSetsRequest>(listSqlInjectionMatchSetsRequest, "AWSWAF");
        request.addHeader("X-Amz-Target", "AWSWAF_20150824.ListSqlInjectionMatchSets");
