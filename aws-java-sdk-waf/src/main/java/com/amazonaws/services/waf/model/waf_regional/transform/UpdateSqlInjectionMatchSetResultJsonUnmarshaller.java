...
public class UpdateSqlInjectionMatchSetResultJsonUnmarshaller implements Unmarshaller<UpdateSqlInjectionMatchSetResult, JsonUnmarshallerContext> {
    ...
    private static UpdateSqlInjectionMatchSetResultJsonUnmarshaller instance;

    public static UpdateSqlInjectionMatchSetResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateSqlInjectionMatchSetResultJsonUnmarshaller();
        return instance;
    }
}
