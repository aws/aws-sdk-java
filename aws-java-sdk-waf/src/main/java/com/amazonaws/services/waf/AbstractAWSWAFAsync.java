...
public class AbstractAWSWAFAsync extends AbstractAWSWAF implements AWSWAFAsync {
    ...
    @Override
    public java.util.concurrent.Future<CreateByteMatchSetResult> createByteMatchSetAsync(
    ...
    @Override
    public java.util.concurrent.Future<CreateIPSetResult> createIPSetAsync(
    ...
    @Override
    public java.util.concurrent.Future<CreateRuleResult> createRuleAsync(
    ...
    @Override
    public java.util.concurrent.Future<DeleteIPSetResult> deleteIPSetAsync(
    ...
    @Override
    public java.util.concurrent.Future<GetByteMatchSetResult> getByteMatchSetAsync(
    ...
    @Override
    public java.util.concurrent.Future<GetChangeTokenResult> getChangeTokenAsync(
    ...
    @Override
    public java.util.concurrent.Future<GetChangeTokenStatusResult> getChangeTokenStatusAsync(
    ...
    @Override
    public java.util.concurrent.Future<GetIPSetResult> getIPSetAsync(
    ...
    @Override
    public java.util.concurrent.Future<GetRuleResult> getRuleAsync(
    ...
    @Override
    public java.util.concurrent.Future<GetSampledRequestsResult> getSampledRequestsAsync(
    ...
    @Override
    public java.util.concurrent.Future<ListIPSetsResult> listIPSetsAsync(
    ...
    @Override
    public java.util.concurrent.Future<UpdateByteMatchSetResult> updateByteMatchSetAsync(
    ...
    @Override
    public java.util.concurrent.Future<UpdateIPSetResult> updateIPSetAsync(
