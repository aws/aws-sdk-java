...
/**
 * ListActivatedRulesInRuleGroupResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListActivatedRulesInRuleGroupResultJsonUnmarshaller implements Unmarshaller<ListActivatedRulesInRuleGroupResult, JsonUnmarshallerContext> {

    public ListActivatedRulesInRuleGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listActivatedRulesInRuleGroupResult.setNextMarker(context.getUnmarshaller(String.class).unmarshall(context));
                }
