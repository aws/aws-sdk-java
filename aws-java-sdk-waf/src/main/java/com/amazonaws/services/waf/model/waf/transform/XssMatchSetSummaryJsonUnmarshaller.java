...
public class XssMatchSetSummaryJsonUnmarshaller implements Unmarshaller<XssMatchSetSummary, JsonUnmarshallerContext> {
    ...
    public static XssMatchSetSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new XssMatchSetSummaryJsonUnmarshaller();
        return instance;
    }
}
