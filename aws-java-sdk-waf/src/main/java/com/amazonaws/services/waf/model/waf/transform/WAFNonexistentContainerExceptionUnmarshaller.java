...
public class WAFNonexistentContainerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static WAFNonexistentContainerExceptionUnmarshaller instance;

    public static WAFNonexistentContainerExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WAFNonexistentContainerExceptionUnmarshaller();
        return instance;
    }
}
