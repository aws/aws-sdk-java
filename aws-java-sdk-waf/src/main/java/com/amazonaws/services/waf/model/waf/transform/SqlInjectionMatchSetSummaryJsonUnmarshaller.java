...
public class SqlInjectionMatchSetSummaryJsonUnmarshaller implements Unmarshaller<SqlInjectionMatchSetSummary, JsonUnmarshallerContext> {
    ...
    public static SqlInjectionMatchSetSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SqlInjectionMatchSetSummaryJsonUnmarshaller();
        return instance;
    }
}
