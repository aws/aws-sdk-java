...
public class ByteMatchSetSummaryJsonMarshaller {
     ...
     */
    public void marshall(ByteMatchSetSummary byteMatchSetSummary, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (byteMatchSetSummary.getByteMatchSetId() != null) {
                jsonGenerator.writeFieldName("ByteMatchSetId").writeValue(byteMatchSetSummary.getByteMatchSetId());
            }
            if (byteMatchSetSummary.getName() != null) {
                jsonGenerator.writeFieldName("Name").writeValue(byteMatchSetSummary.getName());
            }
