...
public class WAFInvalidRegexPatternExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static WAFInvalidRegexPatternExceptionUnmarshaller instance;

    public static WAFInvalidRegexPatternExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WAFInvalidRegexPatternExceptionUnmarshaller();
        return instance;
    }
}
