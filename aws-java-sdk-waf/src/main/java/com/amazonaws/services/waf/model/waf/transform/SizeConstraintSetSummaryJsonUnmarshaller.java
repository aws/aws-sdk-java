...
public class SizeConstraintSetSummaryJsonUnmarshaller implements Unmarshaller<SizeConstraintSetSummary, JsonUnmarshallerContext> {
    ...
    public static SizeConstraintSetSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SizeConstraintSetSummaryJsonUnmarshaller();
        return instance;
    }
}
