...
public class UpdateDeploymentRequestMarshaller implements Marshaller<Request<UpdateDeploymentRequest>, UpdateDeploymentRequest> {
    ...
    public UpdateDeploymentRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<UpdateDeploymentRequest> marshall(UpdateDeploymentRequest updateDeploymentRequest) {
        ...
        uriResourcePath = com.amazonaws.transform.PathMarshallers.NON_GREEDY.marshall(uriResourcePath, "restapi_id", updateDeploymentRequest.getRestApiId());
        uriResourcePath = com.amazonaws.transform.PathMarshallers.NON_GREEDY.marshall(uriResourcePath, "deployment_id",
                updateDeploymentRequest.getDeploymentId());
