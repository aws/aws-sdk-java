 ...
 * >Create an API</a> </div>
 */
public class CreateResourceResult implements Serializable, Cloneable {
     ...
     * enabled on the resource. This method map is included in the
     * <code>200 OK</code> response of the
     ...
     * 
     * <pre>
     * <code>GET /restapis/fugvjdxtri/resources/3kzxbg5sa2/methods/GET HTTP/1.1 Content-Type: application/json Host: apigateway.us-east-1.amazonaws.com X-Amz-Date: 20160608T031827Z Authorization: AWS4-HMAC-SHA256 Credential={access_key_ID}/20160608/us-east-1/apigateway/aws4_request, SignedHeaders=content-type;host;x-amz-date, Signature={sig4_hash}</code>
     * </pre>
     * 
     * <h5>Response</h5>
     * 
     ...
     * </pre>
     * <p>
     * If the <code>OPTIONS</code> is enabled on the resource, you can follow
     * the example here to get that method. Just replace the <code>GET</code> of
     * the last path segment in the request URL with <code>OPTIONS</code>.
     * </p>
     ...
     * </div> <div class="seeAlso"> </div>
     * 
     * @return Gets an API resource's method of a given HTTP verb.</p> <div
     *         class="remarks">
     *         <p>
     *         The resource methods are a map of methods indexed by methods'
     *         HTTP verbs enabled on the resource. This method map is included
     *         in the <code>200 OK</code> response of the
     *         <code>GET /restapis/{restapi_id}/resources/{resource_id}</code>
     *         or
     *         <code>GET /restapis/{restapi_id}/resources/{resource_id}?embed=methods</code>
     *         request.
     *         </p>
     *         <h4>Example: Get the GET method of an API resource</h4> <h5>
     *         Request</h5>
     * 
     *         <pre>
     * <code>GET /restapis/fugvjdxtri/resources/3kzxbg5sa2/methods/GET HTTP/1.1 Content-Type: application/json Host: apigateway.us-east-1.amazonaws.com X-Amz-Date: 20160608T031827Z Authorization: AWS4-HMAC-SHA256 Credential={access_key_ID}/20160608/us-east-1/apigateway/aws4_request, SignedHeaders=content-type;host;x-amz-date, Signature={sig4_hash}</code>
     ...
     * </pre>
     *         <p>
     *         If the <code>OPTIONS</code> is enabled on the resource, you can
     *         follow the example here to get that method. Just replace the
     ...
     *        Gets an API resource's method of a given HTTP verb.</p> <div
     *        class="remarks">
     *        <p>
