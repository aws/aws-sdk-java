 ...
 */
public class UpdateDeploymentResultJsonUnmarshaller implements
        Unmarshaller<UpdateDeploymentResult, JsonUnmarshallerContext> {

    public UpdateDeploymentResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
