 ...
 */
public class DeleteDomainNameResultJsonUnmarshaller implements
        Unmarshaller<DeleteDomainNameResult, JsonUnmarshallerContext> {

    public DeleteDomainNameResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
