...
public class GetDomainNamesResultJsonUnmarshaller implements
    ...
    public GetDomainNamesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("position", targetDepth)) {
                    context.nextToken();
                    getDomainNamesResult.setPosition(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("item", targetDepth)) {
                    context.nextToken();
                    getDomainNamesResult
                            .setItems(new ListUnmarshaller<DomainName>(
