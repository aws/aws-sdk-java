    ...
    public void marshall(ThrottleSettings throttleSettings, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (throttleSettings.getBurstLimit() != null) {
                jsonGenerator.writeFieldName("burstLimit").writeValue(throttleSettings.getBurstLimit());
            }
            if (throttleSettings.getRateLimit() != null) {
                jsonGenerator.writeFieldName("rateLimit").writeValue(throttleSettings.getRateLimit());
            }
