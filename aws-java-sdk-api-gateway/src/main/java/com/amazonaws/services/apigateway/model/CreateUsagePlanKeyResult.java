 ...
 * Plans</a> </div>
 */
public class CreateUsagePlanKeyResult implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateUsagePlanKeyResult == false)
            return false;
    ...
    @Override
    public CreateUsagePlanKeyResult clone() {
        try {
