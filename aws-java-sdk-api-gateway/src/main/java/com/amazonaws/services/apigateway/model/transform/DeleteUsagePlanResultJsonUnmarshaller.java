 ...
 */
public class DeleteUsagePlanResultJsonUnmarshaller implements
        Unmarshaller<DeleteUsagePlanResult, JsonUnmarshallerContext> {

    public DeleteUsagePlanResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
