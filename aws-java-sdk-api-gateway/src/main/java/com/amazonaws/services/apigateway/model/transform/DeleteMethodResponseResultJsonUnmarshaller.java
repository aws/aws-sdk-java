 ...
 */
public class DeleteMethodResponseResultJsonUnmarshaller implements
        Unmarshaller<DeleteMethodResponseResult, JsonUnmarshallerContext> {

    public DeleteMethodResponseResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
