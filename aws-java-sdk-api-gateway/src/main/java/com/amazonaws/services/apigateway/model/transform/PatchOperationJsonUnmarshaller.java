 ...
 */
public class PatchOperationJsonUnmarshaller implements
        Unmarshaller<PatchOperation, JsonUnmarshallerContext> {

    public PatchOperation unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("op", targetDepth)) {
                    context.nextToken();
                    patchOperation.setOp(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
                if (context.testExpression("path", targetDepth)) {
                    context.nextToken();
                    patchOperation.setPath(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("value", targetDepth)) {
                    context.nextToken();
                    patchOperation.setValue(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("from", targetDepth)) {
                    context.nextToken();
                    patchOperation.setFrom(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
