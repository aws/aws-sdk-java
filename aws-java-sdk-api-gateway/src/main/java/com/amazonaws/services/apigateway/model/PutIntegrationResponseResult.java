 ...
 * </p>
 */
public class PutIntegrationResponseResult implements Serializable, Cloneable {
    ...
    public PutIntegrationResponseResult addResponseParametersEntry(String key,
            String value) {
    ...
    public PutIntegrationResponseResult addResponseTemplatesEntry(String key,
            String value) {
