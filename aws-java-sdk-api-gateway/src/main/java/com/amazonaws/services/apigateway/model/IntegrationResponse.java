 ...
 * </p>
 */
public class IntegrationResponse implements Serializable, Cloneable {
    ...
    public IntegrationResponse addResponseParametersEntry(String key,
            String value) {
    ...
    public IntegrationResponse addResponseTemplatesEntry(String key,
            String value) {
