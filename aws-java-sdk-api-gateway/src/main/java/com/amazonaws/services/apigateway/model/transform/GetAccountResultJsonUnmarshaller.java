...
public class GetAccountResultJsonUnmarshaller implements
    ...
    public GetAccountResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("cloudwatchRoleArn", targetDepth)) {
                    context.nextToken();
                    getAccountResult.setCloudwatchRoleArn(context
                ...
                if (context.testExpression("features", targetDepth)) {
                    context.nextToken();
                    getAccountResult.setFeatures(new ListUnmarshaller<String>(
                            context.getUnmarshaller(String.class))
                            .unmarshall(context));
                }
                if (context.testExpression("apiKeyVersion", targetDepth)) {
                    context.nextToken();
                    getAccountResult.setApiKeyVersion(context.getUnmarshaller(
