...
public class GenerateClientCertificateResultJsonUnmarshaller implements
    ...
    public GenerateClientCertificateResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("description", targetDepth)) {
                    context.nextToken();
                    generateClientCertificateResult.setDescription(context
                ...
                if (context.testExpression("createdDate", targetDepth)) {
                    context.nextToken();
                    generateClientCertificateResult.setCreatedDate(context
                            .getUnmarshaller(java.util.Date.class).unmarshall(
                                    context));
                }
                if (context.testExpression("expirationDate", targetDepth)) {
                    context.nextToken();
                    generateClientCertificateResult.setExpirationDate(context
                            .getUnmarshaller(java.util.Date.class).unmarshall(
                                    context));
                }
