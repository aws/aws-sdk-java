...
public class DeleteUsagePlanRequestMarshaller implements Marshaller<Request<DeleteUsagePlanRequest>, DeleteUsagePlanRequest> {
    ...
    public DeleteUsagePlanRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DeleteUsagePlanRequest> marshall(DeleteUsagePlanRequest deleteUsagePlanRequest) {
        ...
        uriResourcePath = uriResourcePath.replace(
                "{usageplanId}",
                (deleteUsagePlanRequest.getUsagePlanId() != null) ? SdkHttpUtils.urlEncode(StringUtils.fromString(deleteUsagePlanRequest.getUsagePlanId()),
                        false) : "");
