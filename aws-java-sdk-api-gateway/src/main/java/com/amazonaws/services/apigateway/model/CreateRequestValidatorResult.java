...
public class CreateRequestValidatorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateRequestValidatorResult withValidateRequestParameters(Boolean validateRequestParameters) {
    ...
    @Override
    public CreateRequestValidatorResult clone() {
        try {
            return (CreateRequestValidatorResult) super.clone();
