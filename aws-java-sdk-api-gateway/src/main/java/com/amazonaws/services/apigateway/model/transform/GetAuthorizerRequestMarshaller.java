 ...
 */
public class GetAuthorizerRequestMarshaller implements Marshaller<Request<GetAuthorizerRequest>, GetAuthorizerRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public GetAuthorizerRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<GetAuthorizerRequest> marshall(GetAuthorizerRequest getAuthorizerRequest) {
        ...
        Request<GetAuthorizerRequest> request = new DefaultRequest<GetAuthorizerRequest>(getAuthorizerRequest, "AmazonApiGateway");
