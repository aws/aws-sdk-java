...
/**
 * ApiStage JSON Unmarshaller
 */
public class ApiStageJsonUnmarshaller implements
        Unmarshaller<ApiStage, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("apiId", targetDepth)) {
                    context.nextToken();
                    apiStage.setApiId(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
                if (context.testExpression("stage", targetDepth)) {
                    context.nextToken();
                    apiStage.setStage(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
