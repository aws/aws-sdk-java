...
public class UpdateApiKeyRequestProtocolMarshaller implements Marshaller<Request<UpdateApiKeyRequest>, UpdateApiKeyRequest> {
    ...
    public UpdateApiKeyRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<UpdateApiKeyRequest> marshall(UpdateApiKeyRequest updateApiKeyRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<UpdateApiKeyRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    updateApiKeyRequest);

            protocolMarshaller.startMarshalling();
            UpdateApiKeyRequestMarshaller.getInstance().marshall(updateApiKeyRequest, protocolMarshaller);
