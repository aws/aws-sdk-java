...
/**
 * GetGatewayResponsesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetGatewayResponsesRequestMarshaller {
     ...
     */
    public void marshall(GetGatewayResponsesRequest getGatewayResponsesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getGatewayResponsesRequest.getRestApiId(), RESTAPIID_BINDING);
            protocolMarshaller.marshall(getGatewayResponsesRequest.getPosition(), POSITION_BINDING);
            protocolMarshaller.marshall(getGatewayResponsesRequest.getLimit(), LIMIT_BINDING);
        } catch (Exception e) {
