 ...
 */
public class StageKeyJsonUnmarshaller implements
        Unmarshaller<StageKey, JsonUnmarshallerContext> {

    public StageKey unmarshall(JsonUnmarshallerContext context)
            throws Exception {
