 ...
 */
public class CreateBasePathMappingResultJsonUnmarshaller implements
        Unmarshaller<CreateBasePathMappingResult, JsonUnmarshallerContext> {

    public CreateBasePathMappingResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("basePath", targetDepth)) {
                    context.nextToken();
                    createBasePathMappingResult.setBasePath(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("restApiId", targetDepth)) {
                    context.nextToken();
                    createBasePathMappingResult.setRestApiId(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("stage", targetDepth)) {
                    context.nextToken();
                    createBasePathMappingResult.setStage(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
