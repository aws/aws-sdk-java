...
public class ServiceUnavailableExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.apigateway.model.ServiceUnavailableException> {
    private ServiceUnavailableExceptionUnmarshaller() {
        super("ServiceUnavailableException");
    }

    @Override
    public com.amazonaws.services.apigateway.model.ServiceUnavailableException unmarshall(JsonUnmarshallerContext context) throws Exception {
