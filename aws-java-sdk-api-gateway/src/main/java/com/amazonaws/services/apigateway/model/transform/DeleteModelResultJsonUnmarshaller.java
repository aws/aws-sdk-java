 ...
 */
public class DeleteModelResultJsonUnmarshaller implements
        Unmarshaller<DeleteModelResult, JsonUnmarshallerContext> {

    public DeleteModelResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
