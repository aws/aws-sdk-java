 ...
 * </p>
 */
public class PutMethodResponseResult implements Serializable, Cloneable {
     ...
     *         chained together.
     */
    public PutMethodResponseResult withResponseParameters(
            java.util.Map<String, Boolean> responseParameters) {
        setResponseParameters(responseParameters);
        return this;
    }

    public PutMethodResponseResult addResponseParametersEntry(String key,
            Boolean value) {
     ...
     *         chained together.
     */
    public PutMethodResponseResult withResponseModels(
            java.util.Map<String, String> responseModels) {
        setResponseModels(responseModels);
        return this;
    }

    public PutMethodResponseResult addResponseModelsEntry(String key,
            String value) {
