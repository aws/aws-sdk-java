...
public class GetTagsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> RESOURCEARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PATH)
            .marshallLocationName("resource_arn").build();
    ...
    public void marshall(GetTagsRequest getTagsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getTagsRequest.getResourceArn(), RESOURCEARN_BINDING);
            protocolMarshaller.marshall(getTagsRequest.getPosition(), POSITION_BINDING);
            protocolMarshaller.marshall(getTagsRequest.getLimit(), LIMIT_BINDING);
        } catch (Exception e) {
