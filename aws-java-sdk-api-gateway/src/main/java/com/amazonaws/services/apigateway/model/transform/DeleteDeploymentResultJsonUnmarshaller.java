 ...
 */
public class DeleteDeploymentResultJsonUnmarshaller implements
        Unmarshaller<DeleteDeploymentResult, JsonUnmarshallerContext> {

    public DeleteDeploymentResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
