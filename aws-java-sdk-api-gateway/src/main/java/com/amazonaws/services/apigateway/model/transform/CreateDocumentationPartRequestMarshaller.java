 ...
 */
public class CreateDocumentationPartRequestMarshaller implements Marshaller<Request<CreateDocumentationPartRequest>, CreateDocumentationPartRequest> {
    ...
    public Request<CreateDocumentationPartRequest> marshall(CreateDocumentationPartRequest createDocumentationPartRequest) {
        ...
        Request<CreateDocumentationPartRequest> request = new DefaultRequest<CreateDocumentationPartRequest>(createDocumentationPartRequest, "AmazonApiGateway");
        ...
        uriResourcePath = uriResourcePath.replace(
                "{restapi_id}",
                (createDocumentationPartRequest.getRestApiId() != null) ? SdkHttpUtils.urlEncode(
                        StringUtils.fromString(createDocumentationPartRequest.getRestApiId()), false) : "");
