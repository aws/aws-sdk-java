...
public class LimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.apigateway.model.LimitExceededException> {
    private LimitExceededExceptionUnmarshaller() {
        super("LimitExceededException");
    }

    @Override
    public com.amazonaws.services.apigateway.model.LimitExceededException unmarshall(JsonUnmarshallerContext context) throws Exception {
