 ...
 */
public class DeleteResourceResultJsonUnmarshaller implements
        Unmarshaller<DeleteResourceResult, JsonUnmarshallerContext> {

    public DeleteResourceResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
