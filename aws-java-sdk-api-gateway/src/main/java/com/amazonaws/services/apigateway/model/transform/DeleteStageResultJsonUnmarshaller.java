 ...
 */
public class DeleteStageResultJsonUnmarshaller implements
        Unmarshaller<DeleteStageResult, JsonUnmarshallerContext> {

    public DeleteStageResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
