 ...
 */
public class DeleteIntegrationResultJsonUnmarshaller implements
        Unmarshaller<DeleteIntegrationResult, JsonUnmarshallerContext> {

    public DeleteIntegrationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
