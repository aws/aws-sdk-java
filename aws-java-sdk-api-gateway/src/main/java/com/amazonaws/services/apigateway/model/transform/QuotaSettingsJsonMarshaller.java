...
public class QuotaSettingsJsonMarshaller {
     ...
     */
    public void marshall(QuotaSettings quotaSettings, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (quotaSettings.getLimit() != null) {
                jsonGenerator.writeFieldName("limit").writeValue(quotaSettings.getLimit());
            }
            if (quotaSettings.getOffset() != null) {
                jsonGenerator.writeFieldName("offset").writeValue(quotaSettings.getOffset());
            }
            if (quotaSettings.getPeriod() != null) {
                jsonGenerator.writeFieldName("period").writeValue(quotaSettings.getPeriod());
            }
