...
public class GetDeploymentsResultJsonUnmarshaller implements
    ...
    public GetDeploymentsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("position", targetDepth)) {
                    context.nextToken();
                    getDeploymentsResult.setPosition(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("item", targetDepth)) {
                    context.nextToken();
                    getDeploymentsResult
                            .setItems(new ListUnmarshaller<Deployment>(
