...
public class GetDocumentationVersionRequestMarshaller implements Marshaller<Request<GetDocumentationVersionRequest>, GetDocumentationVersionRequest> {
    ...
    public GetDocumentationVersionRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<GetDocumentationVersionRequest> marshall(GetDocumentationVersionRequest getDocumentationVersionRequest) {
        ...
        uriResourcePath = uriResourcePath.replace(
                "{restapi_id}",
                (getDocumentationVersionRequest.getRestApiId() != null) ? SdkHttpUtils.urlEncode(
                        StringUtils.fromString(getDocumentationVersionRequest.getRestApiId()), false) : "");
        uriResourcePath = uriResourcePath.replace(
                "{doc_version}",
                (getDocumentationVersionRequest.getDocumentationVersion() != null) ? SdkHttpUtils.urlEncode(
                        StringUtils.fromString(getDocumentationVersionRequest.getDocumentationVersion()), false) : "");
