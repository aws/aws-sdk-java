...
public class IntegrationResponseJsonMarshaller {
    ...
    public void marshall(IntegrationResponse integrationResponse, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            java.util.Map<String, String> responseParametersMap = integrationResponse.getResponseParameters();
            ...
            java.util.Map<String, String> responseTemplatesMap = integrationResponse.getResponseTemplates();
