...
public class UpdateAuthorizerRequestMarshaller {
    ...
    public void marshall(UpdateAuthorizerRequest updateAuthorizerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateAuthorizerRequest.getRestApiId(), RESTAPIID_BINDING);
            protocolMarshaller.marshall(updateAuthorizerRequest.getAuthorizerId(), AUTHORIZERID_BINDING);
            protocolMarshaller.marshall(updateAuthorizerRequest.getPatchOperations(), PATCHOPERATIONS_BINDING);
        } catch (Exception e) {
