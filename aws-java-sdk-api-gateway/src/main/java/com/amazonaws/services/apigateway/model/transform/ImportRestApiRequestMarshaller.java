...
public class ImportRestApiRequestMarshaller implements
    ...
    public Request<ImportRestApiRequest> marshall(
        ...
        if (importRestApiRequest.getFailOnWarnings() != null) {
            request.addParameter("failonwarnings", StringUtils
                    .fromBoolean(importRestApiRequest.getFailOnWarnings()));
        }

        java.util.Map<String, String> parameters = importRestApiRequest
                .getParameters();
