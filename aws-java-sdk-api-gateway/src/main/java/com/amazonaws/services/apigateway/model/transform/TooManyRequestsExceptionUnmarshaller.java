...
public class TooManyRequestsExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.apigateway.model.TooManyRequestsException> {
    private TooManyRequestsExceptionUnmarshaller() {
        super("TooManyRequestsException");
    }

    @Override
    public com.amazonaws.services.apigateway.model.TooManyRequestsException unmarshall(JsonUnmarshallerContext context) throws Exception {
