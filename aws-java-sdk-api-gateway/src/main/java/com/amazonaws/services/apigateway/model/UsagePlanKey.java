 ...
 * </p>
 * </div>" <div class="seeAlso"> <a href="[[AwsDocsUrlPrefix]]/apigateway/latest/developerguide/api-gateway-api-usage-
 * plans.html">Create and Use Usage Plans</a> </div>
 */
...
public class UsagePlanKey implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UsagePlanKey == false)
            return false;
    ...
    public UsagePlanKey clone() {
        try {
            return (UsagePlanKey) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.apigateway.model.transform.UsagePlanKeyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
