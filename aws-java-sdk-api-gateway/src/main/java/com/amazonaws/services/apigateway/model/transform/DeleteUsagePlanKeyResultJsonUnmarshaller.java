 ...
 */
public class DeleteUsagePlanKeyResultJsonUnmarshaller implements
        Unmarshaller<DeleteUsagePlanKeyResult, JsonUnmarshallerContext> {

    public DeleteUsagePlanKeyResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
