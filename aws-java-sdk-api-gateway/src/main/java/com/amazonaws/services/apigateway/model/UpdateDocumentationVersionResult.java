...
public class UpdateDocumentationVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateDocumentationVersionResult withVersion(String version) {
        setVersion(version);
        return this;
    }
    ...
    public UpdateDocumentationVersionResult withCreatedDate(java.util.Date createdDate) {
    ...
    public UpdateDocumentationVersionResult withDescription(String description) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDocumentationVersionResult == false)
            return false;
        UpdateDocumentationVersionResult other = (UpdateDocumentationVersionResult) obj;
    ...
    @Override
    public UpdateDocumentationVersionResult clone() {
        try {
            return (UpdateDocumentationVersionResult) super.clone();
