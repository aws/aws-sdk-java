...
public class SdkTypeMarshaller {
    ...
    public void marshall(SdkType sdkType, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sdkType.getId(), ID_BINDING);
            protocolMarshaller.marshall(sdkType.getFriendlyName(), FRIENDLYNAME_BINDING);
            protocolMarshaller.marshall(sdkType.getDescription(), DESCRIPTION_BINDING);
