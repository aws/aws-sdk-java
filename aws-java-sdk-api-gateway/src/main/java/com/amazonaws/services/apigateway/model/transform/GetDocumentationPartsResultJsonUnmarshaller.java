...
public class GetDocumentationPartsResultJsonUnmarshaller implements Unmarshaller<GetDocumentationPartsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("position", targetDepth)) {
                    context.nextToken();
                    getDocumentationPartsResult.setPosition(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("item", targetDepth)) {
                    context.nextToken();
                    getDocumentationPartsResult.setItems(new ListUnmarshaller<DocumentationPart>(DocumentationPartJsonUnmarshaller.getInstance())
                            .unmarshall(context));
                }
