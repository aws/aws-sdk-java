...
public class GetVpcLinksResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetVpcLinksResult withItems(VpcLink... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<VpcLink>(items.length));
        }
        for (VpcLink ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public GetVpcLinksResult clone() {
        try {
            return (GetVpcLinksResult) super.clone();
