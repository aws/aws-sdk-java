...
public class GetMethodResult implements Serializable, Cloneable {
     ...
     *         chained together.
     */
    public GetMethodResult withRequestParameters(
            java.util.Map<String, Boolean> requestParameters) {
     ...
     *         chained together.
     */
    public GetMethodResult withRequestModels(
     ...
     *         chained together.
     */
    public GetMethodResult withMethodResponses(
            java.util.Map<String, MethodResponse> methodResponses) {
        setMethodResponses(methodResponses);
        return this;
    }

    public GetMethodResult addMethodResponsesEntry(String key,
