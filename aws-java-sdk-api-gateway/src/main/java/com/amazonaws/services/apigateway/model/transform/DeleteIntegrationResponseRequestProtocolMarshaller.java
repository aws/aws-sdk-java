...
@SdkInternalApi
public class DeleteIntegrationResponseRequestProtocolMarshaller implements
    ...
    public DeleteIntegrationResponseRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DeleteIntegrationResponseRequest> marshall(DeleteIntegrationResponseRequest deleteIntegrationResponseRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<DeleteIntegrationResponseRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(
                    SDK_OPERATION_BINDING, deleteIntegrationResponseRequest);

            protocolMarshaller.startMarshalling();
            DeleteIntegrationResponseRequestMarshaller.getInstance().marshall(deleteIntegrationResponseRequest, protocolMarshaller);
