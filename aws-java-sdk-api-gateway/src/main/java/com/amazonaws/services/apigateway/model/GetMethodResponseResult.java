...
public class GetMethodResponseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetMethodResponseResult withResponseParameters(java.util.Map<String, Boolean> responseParameters) {
    ...
    public GetMethodResponseResult withResponseModels(java.util.Map<String, String> responseModels) {
