 ...
 */
public class FlushStageAuthorizersCacheResultJsonUnmarshaller implements
        Unmarshaller<FlushStageAuthorizersCacheResult, JsonUnmarshallerContext> {

    public FlushStageAuthorizersCacheResult unmarshall(
            JsonUnmarshallerContext context) throws Exception {
        FlushStageAuthorizersCacheResult flushStageAuthorizersCacheResult = new FlushStageAuthorizersCacheResult();
