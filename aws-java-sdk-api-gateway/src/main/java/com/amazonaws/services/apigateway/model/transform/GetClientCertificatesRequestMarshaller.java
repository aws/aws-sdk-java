...
public class GetClientCertificatesRequestMarshaller {
    ...
    private static final GetClientCertificatesRequestMarshaller instance = new GetClientCertificatesRequestMarshaller();

    public static GetClientCertificatesRequestMarshaller getInstance() {
        return instance;
    }
