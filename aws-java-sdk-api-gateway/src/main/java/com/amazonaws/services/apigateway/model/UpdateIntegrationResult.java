 ...
 */
public class UpdateIntegrationResult implements Serializable, Cloneable {
    ...
    public UpdateIntegrationResult addRequestParametersEntry(String key,
            String value) {
    ...
    public UpdateIntegrationResult addRequestTemplatesEntry(String key,
            String value) {
    ...
    public UpdateIntegrationResult withPassthroughBehavior(
