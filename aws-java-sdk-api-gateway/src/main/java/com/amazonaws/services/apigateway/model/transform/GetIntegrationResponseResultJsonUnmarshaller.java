 ...
 */
public class GetIntegrationResponseResultJsonUnmarshaller implements
        Unmarshaller<GetIntegrationResponseResult, JsonUnmarshallerContext> {

    public GetIntegrationResponseResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("statusCode", targetDepth)) {
                    context.nextToken();
                    getIntegrationResponseResult.setStatusCode(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("selectionPattern", targetDepth)) {
                    context.nextToken();
                    getIntegrationResponseResult.setSelectionPattern(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
