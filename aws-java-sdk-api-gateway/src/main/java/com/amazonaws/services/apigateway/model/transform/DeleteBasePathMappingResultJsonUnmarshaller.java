 ...
 */
public class DeleteBasePathMappingResultJsonUnmarshaller implements
        Unmarshaller<DeleteBasePathMappingResult, JsonUnmarshallerContext> {

    public DeleteBasePathMappingResult unmarshall(
