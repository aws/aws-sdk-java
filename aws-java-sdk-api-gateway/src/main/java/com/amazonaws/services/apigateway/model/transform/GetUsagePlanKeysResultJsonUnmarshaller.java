...
public class GetUsagePlanKeysResultJsonUnmarshaller implements Unmarshaller<GetUsagePlanKeysResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("position", targetDepth)) {
                    context.nextToken();
                    getUsagePlanKeysResult.setPosition(context.getUnmarshaller(String.class).unmarshall(context));
                }
