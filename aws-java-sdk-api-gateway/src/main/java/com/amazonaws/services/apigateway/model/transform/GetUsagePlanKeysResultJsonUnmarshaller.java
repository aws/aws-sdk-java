...
public class GetUsagePlanKeysResultJsonUnmarshaller implements
    ...
    public GetUsagePlanKeysResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("position", targetDepth)) {
                    context.nextToken();
                    getUsagePlanKeysResult.setPosition(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("item", targetDepth)) {
                    context.nextToken();
                    getUsagePlanKeysResult
                            .setItems(new ListUnmarshaller<UsagePlanKey>(
