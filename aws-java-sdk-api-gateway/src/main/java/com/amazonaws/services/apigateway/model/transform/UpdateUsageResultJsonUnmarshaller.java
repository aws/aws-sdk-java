...
public class UpdateUsageResultJsonUnmarshaller implements
    ...
    public UpdateUsageResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("usagePlanId", targetDepth)) {
                    context.nextToken();
                    updateUsageResult.setUsagePlanId(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("startDate", targetDepth)) {
                    context.nextToken();
                    updateUsageResult.setStartDate(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("endDate", targetDepth)) {
                    context.nextToken();
                    updateUsageResult.setEndDate(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("position", targetDepth)) {
                    context.nextToken();
                    updateUsageResult.setPosition(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
