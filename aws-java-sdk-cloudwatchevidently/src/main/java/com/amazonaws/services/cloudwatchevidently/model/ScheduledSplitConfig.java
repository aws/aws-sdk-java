 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/evidently-2021-02-01/ScheduledSplitConfig" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScheduledSplitConfig implements Serializable, Cloneable, StructuredPojo {
     ...
     *
     * @see ScheduledSplitConfig#withGroupWeights
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ScheduledSplitConfig addGroupWeightsEntry(String key, Long value) {
    ...
    public ScheduledSplitConfig withStartTime(java.util.Date startTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScheduledSplitConfig == false)
            return false;
    ...
    @Override
    public ScheduledSplitConfig clone() {
        try {
            return (ScheduledSplitConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cloudwatchevidently.model.transform.ScheduledSplitConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
