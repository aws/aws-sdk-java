...
public class DeleteSegmentRequestMarshaller {
    ...
    private static final MarshallingInfo<String> SEGMENT_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PATH)
    ...
    public void marshall(DeleteSegmentRequest deleteSegmentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteSegmentRequest.getSegment(), SEGMENT_BINDING);
        } catch (Exception e) {
