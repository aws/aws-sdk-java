...
public class UpdateExperimentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A structure containing the configuration details of the experiment that was updated.
     */
    ...
    public UpdateExperimentResult clone() {
        try {
            return (UpdateExperimentResult) super.clone();
