...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudwatchevidently.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.cloudwatchevidently.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudwatchevidently.model.ThrottlingException throttlingException = new com.amazonaws.services.cloudwatchevidently.model.ThrottlingException(
                null);
