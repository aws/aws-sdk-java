...
/**
 * SegmentOverride JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SegmentOverrideJsonUnmarshaller implements Unmarshaller<SegmentOverride, JsonUnmarshallerContext> {

    public SegmentOverride unmarshall(JsonUnmarshallerContext context) throws Exception {
        SegmentOverride segmentOverride = new SegmentOverride();
    ...
    private static SegmentOverrideJsonUnmarshaller instance;

    public static SegmentOverrideJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SegmentOverrideJsonUnmarshaller();
        return instance;
    }
}
