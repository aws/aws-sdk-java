...
public class ListLaunchesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name or ARN of the project to return the launch list from.
     */
     ...
     * </p>
     * 
     * @return Use this optional parameter to limit the returned results to only the launches with the status that you
     *         specify here.
     * @see LaunchStatus
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLaunchesRequest == false)
            return false;
        ListLaunchesRequest other = (ListLaunchesRequest) obj;
    ...
    public ListLaunchesRequest clone() {
        return (ListLaunchesRequest) super.clone();
    }
