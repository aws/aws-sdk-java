...
public class GetSegmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A structure that contains the complete information about the segment.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSegmentResult == false)
            return false;
    ...
    @Override
    public GetSegmentResult clone() {
        try {
            return (GetSegmentResult) super.clone();
