 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/evidently-2021-02-01/ProjectDataDeliveryConfig"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProjectDataDeliveryConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ProjectDataDeliveryConfig == false)
            return false;
    ...
    public ProjectDataDeliveryConfig clone() {
        try {
            return (ProjectDataDeliveryConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cloudwatchevidently.model.transform.ProjectDataDeliveryConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
