...
public class ProjectSummaryMarshaller {
    ...
    public void marshall(ProjectSummary projectSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(projectSummary.getActiveExperimentCount(), ACTIVEEXPERIMENTCOUNT_BINDING);
            protocolMarshaller.marshall(projectSummary.getActiveLaunchCount(), ACTIVELAUNCHCOUNT_BINDING);
            protocolMarshaller.marshall(projectSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(projectSummary.getCreatedTime(), CREATEDTIME_BINDING);
            protocolMarshaller.marshall(projectSummary.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(projectSummary.getExperimentCount(), EXPERIMENTCOUNT_BINDING);
            protocolMarshaller.marshall(projectSummary.getFeatureCount(), FEATURECOUNT_BINDING);
            protocolMarshaller.marshall(projectSummary.getLastUpdatedTime(), LASTUPDATEDTIME_BINDING);
            protocolMarshaller.marshall(projectSummary.getLaunchCount(), LAUNCHCOUNT_BINDING);
            protocolMarshaller.marshall(projectSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(projectSummary.getStatus(), STATUS_BINDING);
