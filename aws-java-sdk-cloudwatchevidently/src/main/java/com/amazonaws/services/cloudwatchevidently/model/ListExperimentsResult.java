...
public class ListExperimentsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The token to use in a subsequent <code>ListExperiments</code> operation to return the next set of results.
     * </p>
     */
     ...
     * </p>
     * 
     * @return An array of structures that contain the configuration details of the experiments in the specified
     *         project.
     */
    ...
    public void setExperiments(java.util.Collection<Experiment> experiments) {
        if (experiments == null) {
            this.experiments = null;
            return;
        }

        this.experiments = new java.util.ArrayList<Experiment>(experiments);
    }
    ...
    public ListExperimentsResult withExperiments(Experiment... experiments) {
        if (this.experiments == null) {
            setExperiments(new java.util.ArrayList<Experiment>(experiments.length));
        }
        for (Experiment ele : experiments) {
    ...
    public ListExperimentsResult withExperiments(java.util.Collection<Experiment> experiments) {
     ...
     * </p>
     * 
     * @return The token to use in a subsequent <code>ListExperiments</code> operation to return the next set of
     *         results.
     */
