...
public class GetFeatureRequestMarshaller {
    ...
    private static final GetFeatureRequestMarshaller instance = new GetFeatureRequestMarshaller();

    public static GetFeatureRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetFeatureRequest getFeatureRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getFeatureRequest.getFeature(), FEATURE_BINDING);
            protocolMarshaller.marshall(getFeatureRequest.getProject(), PROJECT_BINDING);
        } catch (Exception e) {
