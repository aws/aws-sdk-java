...
public class CreateLaunchResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A structure that contains the configuration of the launch that was created.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLaunchResult == false)
            return false;
        CreateLaunchResult other = (CreateLaunchResult) obj;
    ...
    public CreateLaunchResult clone() {
        try {
            return (CreateLaunchResult) super.clone();
