...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudwatchevidently.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.cloudwatchevidently.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudwatchevidently.model.ConflictException conflictException = new com.amazonaws.services.cloudwatchevidently.model.ConflictException(
                null);
