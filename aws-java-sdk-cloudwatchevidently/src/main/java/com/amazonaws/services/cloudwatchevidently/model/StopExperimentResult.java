...
public class StopExperimentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The date and time that the experiment stopped.
     */
    ...
    public StopExperimentResult withEndedTime(java.util.Date endedTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopExperimentResult == false)
            return false;
        StopExperimentResult other = (StopExperimentResult) obj;
    ...
    public StopExperimentResult clone() {
        try {
            return (StopExperimentResult) super.clone();
