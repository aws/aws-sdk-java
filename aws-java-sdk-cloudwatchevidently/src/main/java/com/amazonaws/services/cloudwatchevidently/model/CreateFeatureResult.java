...
public class CreateFeatureResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A structure that contains information about the new feature.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateFeatureResult == false)
            return false;
        CreateFeatureResult other = (CreateFeatureResult) obj;
    ...
    public CreateFeatureResult clone() {
        try {
            return (CreateFeatureResult) super.clone();
