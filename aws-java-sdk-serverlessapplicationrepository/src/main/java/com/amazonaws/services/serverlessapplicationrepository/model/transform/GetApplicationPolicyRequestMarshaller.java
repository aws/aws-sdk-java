...
public class GetApplicationPolicyRequestMarshaller {
    ...
    private static final GetApplicationPolicyRequestMarshaller instance = new GetApplicationPolicyRequestMarshaller();

    public static GetApplicationPolicyRequestMarshaller getInstance() {
        return instance;
    }
