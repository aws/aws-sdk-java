...
/**
 * Fluent builder for {@link com.amazonaws.services.serverlessapplicationrepository.AWSServerlessApplicationRepository}.
...
public final class AWSServerlessApplicationRepositoryClientBuilder extends
        AwsSyncClientBuilder<AWSServerlessApplicationRepositoryClientBuilder, AWSServerlessApplicationRepository> {
     ...
     */
    public static AWSServerlessApplicationRepositoryClientBuilder standard() {
     ...
     */
    public static AWSServerlessApplicationRepository defaultClient() {
        return standard().build();
    }

    private AWSServerlessApplicationRepositoryClientBuilder() {
