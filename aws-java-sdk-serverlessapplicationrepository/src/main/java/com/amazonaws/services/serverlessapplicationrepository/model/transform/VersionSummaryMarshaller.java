...
public class VersionSummaryMarshaller {
    ...
    public void marshall(VersionSummary versionSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(versionSummary.getApplicationId(), APPLICATIONID_BINDING);
            protocolMarshaller.marshall(versionSummary.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(versionSummary.getSemanticVersion(), SEMANTICVERSION_BINDING);
            protocolMarshaller.marshall(versionSummary.getSourceCodeUrl(), SOURCECODEURL_BINDING);
        } catch (Exception e) {
