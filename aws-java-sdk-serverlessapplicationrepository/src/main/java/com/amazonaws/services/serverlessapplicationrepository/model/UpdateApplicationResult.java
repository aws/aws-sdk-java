...
public class UpdateApplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateApplicationResult withIsVerifiedAuthor(Boolean isVerifiedAuthor) {
    ...
    public UpdateApplicationResult withLabels(java.util.Collection<String> labels) {
        setLabels(labels);
        return this;
    }
    ...
    public UpdateApplicationResult withVerifiedAuthorUrl(String verifiedAuthorUrl) {
