...
public class ReportTaskProgressRequestMarshaller {
    ...
    private static final ReportTaskProgressRequestMarshaller instance = new ReportTaskProgressRequestMarshaller();

    public static ReportTaskProgressRequestMarshaller getInstance() {
        return instance;
    }
