 ...
 */
public class PollForTaskResultJsonUnmarshaller implements
        Unmarshaller<PollForTaskResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("taskObject", targetDepth)) {
                    context.nextToken();
                    pollForTaskResult.setTaskObject(TaskObjectJsonUnmarshaller
