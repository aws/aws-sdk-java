...
public class GetPipelineDefinitionRequestMarshaller
        implements
        Marshaller<Request<GetPipelineDefinitionRequest>, GetPipelineDefinitionRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public GetPipelineDefinitionRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<GetPipelineDefinitionRequest> marshall(
        ...
        Request<GetPipelineDefinitionRequest> request = new DefaultRequest<GetPipelineDefinitionRequest>(
                getPipelineDefinitionRequest, "DataPipeline");
