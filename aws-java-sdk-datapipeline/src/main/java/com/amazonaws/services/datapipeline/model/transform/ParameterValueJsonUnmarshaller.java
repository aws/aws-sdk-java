...
/**
 * Parameter Value JSON Unmarshaller
 */
public class ParameterValueJsonUnmarshaller implements Unmarshaller<ParameterValue, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    parameterValue.setId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("stringValue", targetDepth)) {
                    context.nextToken();
                    parameterValue.setStringValue(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ParameterValueJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ParameterValueJsonUnmarshaller();
        return instance;
    }
}
