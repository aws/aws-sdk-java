 ...
 */
public class CreatePipelineResultJsonUnmarshaller implements
        Unmarshaller<CreatePipelineResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("pipelineId", targetDepth)) {
                    context.nextToken();
                    createPipelineResult.setPipelineId(context.getUnmarshaller(
    ...
    public static CreatePipelineResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreatePipelineResultJsonUnmarshaller();
        return instance;
    }
}
