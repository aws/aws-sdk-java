 ...
 */
public class ReportTaskRunnerHeartbeatResultJsonUnmarshaller implements
        Unmarshaller<ReportTaskRunnerHeartbeatResult, JsonUnmarshallerContext> {

    public ReportTaskRunnerHeartbeatResult unmarshall(
