 ...
 */
public class DescribeObjectsResultJsonUnmarshaller implements
        Unmarshaller<DescribeObjectsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("marker", targetDepth)) {
                    context.nextToken();
                    describeObjectsResult.setMarker(context.getUnmarshaller(
