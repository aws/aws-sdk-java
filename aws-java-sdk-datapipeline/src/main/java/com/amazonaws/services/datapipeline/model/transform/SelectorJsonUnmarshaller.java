 ...
 */
public class SelectorJsonUnmarshaller implements
        Unmarshaller<Selector, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("fieldName", targetDepth)) {
                    context.nextToken();
                    selector.setFieldName(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
                if (context.testExpression("operator", targetDepth)) {
                    context.nextToken();
                    selector.setOperator(OperatorJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
