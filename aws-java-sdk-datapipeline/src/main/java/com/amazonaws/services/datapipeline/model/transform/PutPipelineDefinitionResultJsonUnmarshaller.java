 ...
 */
public class PutPipelineDefinitionResultJsonUnmarshaller implements
        Unmarshaller<PutPipelineDefinitionResult, JsonUnmarshallerContext> {

    public PutPipelineDefinitionResult unmarshall(
