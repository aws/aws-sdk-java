 ...
 */
public class ValidatePipelineDefinitionResultJsonUnmarshaller implements
        Unmarshaller<ValidatePipelineDefinitionResult, JsonUnmarshallerContext> {

    public ValidatePipelineDefinitionResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("validationWarnings", targetDepth)) {
                    context.nextToken();
                    validatePipelineDefinitionResult
                            .setValidationWarnings(new ListUnmarshaller<ValidationWarning>(
    ...
    public static ValidatePipelineDefinitionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ValidatePipelineDefinitionResultJsonUnmarshaller();
        return instance;
    }
}
