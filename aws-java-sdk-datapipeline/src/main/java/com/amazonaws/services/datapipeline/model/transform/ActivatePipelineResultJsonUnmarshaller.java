 ...
 */
public class ActivatePipelineResultJsonUnmarshaller implements
        Unmarshaller<ActivatePipelineResult, JsonUnmarshallerContext> {

    public ActivatePipelineResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
