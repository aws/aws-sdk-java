...
public class ReportTaskRunnerHeartbeatResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTerminate() == null ^ this.getTerminate() == null)
            return false;
        if (other.getTerminate() != null && other.getTerminate().equals(this.getTerminate()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getTerminate() == null) ? 0 : getTerminate().hashCode());
        return hashCode;
    }
