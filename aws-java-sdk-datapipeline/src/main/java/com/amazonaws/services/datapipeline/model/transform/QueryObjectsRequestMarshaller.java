...
public class QueryObjectsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> SPHERE_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("sphere").build();
