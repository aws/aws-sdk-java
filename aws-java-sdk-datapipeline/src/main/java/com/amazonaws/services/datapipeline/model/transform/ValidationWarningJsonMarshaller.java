    ...
    public void marshall(ValidationWarning validationWarning, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (validationWarning.getId() != null) {
                jsonGenerator.writeFieldName("id").writeValue(validationWarning.getId());
            }

            com.amazonaws.internal.SdkInternalList<String> warningsList = (com.amazonaws.internal.SdkInternalList<String>) validationWarning.getWarnings();
