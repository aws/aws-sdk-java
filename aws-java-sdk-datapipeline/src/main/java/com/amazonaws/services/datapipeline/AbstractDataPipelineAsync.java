...
/**
 * Abstract implementation of {@code DataPipelineAsync}. Convenient method forms
 ...
 */
public class AbstractDataPipelineAsync extends AbstractDataPipeline implements
        DataPipelineAsync {
    ...
    @Override
    public java.util.concurrent.Future<ActivatePipelineResult> activatePipelineAsync(
    ...
    @Override
    public java.util.concurrent.Future<DeactivatePipelineResult> deactivatePipelineAsync(
    ...
    @Override
    public java.util.concurrent.Future<DescribeObjectsResult> describeObjectsAsync(
            DescribeObjectsRequest request) {
    ...
    @Override
    public java.util.concurrent.Future<DescribePipelinesResult> describePipelinesAsync(
    ...
    @Override
    public java.util.concurrent.Future<EvaluateExpressionResult> evaluateExpressionAsync(
    ...
    @Override
    public java.util.concurrent.Future<GetPipelineDefinitionResult> getPipelineDefinitionAsync(
    ...
    @Override
    public java.util.concurrent.Future<PollForTaskResult> pollForTaskAsync(
            PollForTaskRequest request) {
    ...
    @Override
    public java.util.concurrent.Future<PutPipelineDefinitionResult> putPipelineDefinitionAsync(
    ...
    @Override
    public java.util.concurrent.Future<QueryObjectsResult> queryObjectsAsync(
            QueryObjectsRequest request) {
    ...
    @Override
    public java.util.concurrent.Future<ReportTaskProgressResult> reportTaskProgressAsync(
    ...
    @Override
    public java.util.concurrent.Future<ReportTaskRunnerHeartbeatResult> reportTaskRunnerHeartbeatAsync(
    ...
    @Override
    public java.util.concurrent.Future<SetTaskStatusResult> setTaskStatusAsync(
    ...
    @Override
    public java.util.concurrent.Future<ValidatePipelineDefinitionResult> validatePipelineDefinitionAsync(
