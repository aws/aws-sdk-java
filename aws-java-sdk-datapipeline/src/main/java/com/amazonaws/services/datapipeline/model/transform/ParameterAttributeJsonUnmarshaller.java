 ...
 */
public class ParameterAttributeJsonUnmarshaller implements
        Unmarshaller<ParameterAttribute, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("key", targetDepth)) {
                    context.nextToken();
                    parameterAttribute.setKey(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("stringValue", targetDepth)) {
                    context.nextToken();
                    parameterAttribute.setStringValue(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
