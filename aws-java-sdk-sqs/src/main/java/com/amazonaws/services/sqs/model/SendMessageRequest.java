 ...
 * <p/>
 */
public class SendMessageRequest extends com.amazonaws.AmazonWebServiceRequest
    ...
    public SendMessageRequest addMessageAttributesEntry(String key,
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getDelaySeconds() == null) ? 0 : getDelaySeconds()
                        .hashCode());
        hashCode = prime
                * hashCode
