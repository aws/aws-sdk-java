...
public class DeleteMessageBatchResult implements Serializable, Cloneable {
    ...
    public void setSuccessful(
        ...
        this.successful = new com.amazonaws.internal.SdkInternalList<DeleteMessageBatchResultEntry>(
                successful);
    }
    ...
    public DeleteMessageBatchResult withSuccessful(
        ...
        if (this.successful == null) {
            setSuccessful(new com.amazonaws.internal.SdkInternalList<DeleteMessageBatchResultEntry>(
                    successful.length));
        }
