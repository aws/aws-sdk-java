...
public class CreateQueueRequestMarshaller implements
    ...
    public Request<CreateQueueRequest> marshall(
        ...
        if (createQueueRequest.getQueueName() != null) {
            request.addParameter("QueueName",
                    StringUtils.fromString(createQueueRequest.getQueueName()));
        }

        java.util.Map<String, String> attributes = createQueueRequest
                .getAttributes();
