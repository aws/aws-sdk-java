...
/**
 * Fluent builder for {@link com.amazonaws.services.sqs.AmazonSQS}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonSQSClientBuilder extends
        AwsSyncClientBuilder<AmazonSQSClientBuilder, AmazonSQS> {
    ...
    /**
     * Construct a synchronous implementation of AmazonSQS using the current
