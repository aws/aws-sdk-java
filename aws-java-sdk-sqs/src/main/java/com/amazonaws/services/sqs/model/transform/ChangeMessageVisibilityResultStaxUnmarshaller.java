 ...
 */
public class ChangeMessageVisibilityResultStaxUnmarshaller implements
        Unmarshaller<ChangeMessageVisibilityResult, StaxUnmarshallerContext> {

    public ChangeMessageVisibilityResult unmarshall(
