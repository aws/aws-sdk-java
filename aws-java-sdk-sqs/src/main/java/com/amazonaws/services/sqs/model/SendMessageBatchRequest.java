 ...
 * 
 */
public class SendMessageBatchRequest extends AmazonWebServiceRequest implements
    ...
    public void setEntries(
        ...
        this.entries = new com.amazonaws.internal.SdkInternalList<SendMessageBatchRequestEntry>(
                entries);
    }
    ...
    public SendMessageBatchRequest withEntries(
        ...
        if (this.entries == null) {
            setEntries(new com.amazonaws.internal.SdkInternalList<SendMessageBatchRequestEntry>(
                    entries.length));
        }
