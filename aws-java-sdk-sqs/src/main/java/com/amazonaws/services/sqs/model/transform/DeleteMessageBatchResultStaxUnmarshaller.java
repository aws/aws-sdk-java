        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DeleteMessageBatchResultEntry", targetDepth)) {
                    deleteMessageBatchResult.withSuccessful(DeleteMessageBatchResultEntryStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("BatchResultErrorEntry", targetDepth)) {
                    deleteMessageBatchResult.withFailed(BatchResultErrorEntryStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
