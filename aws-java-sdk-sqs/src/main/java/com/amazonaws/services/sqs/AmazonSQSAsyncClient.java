...
public class AmazonSQSAsyncClient extends AmazonSQSClient implements
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * SQS using the specified parameters.
     *
    ...
    @Override
    public java.util.concurrent.Future<ChangeMessageVisibilityBatchResult> changeMessageVisibilityBatchAsync(
    ...
    public java.util.concurrent.Future<ChangeMessageVisibilityBatchResult> changeMessageVisibilityBatchAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ChangeMessageVisibilityBatchResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<CreateQueueResult> createQueueAsync(
    ...
    public java.util.concurrent.Future<CreateQueueResult> createQueueAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateQueueResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<DeleteMessageBatchResult> deleteMessageBatchAsync(
    ...
    public java.util.concurrent.Future<DeleteMessageBatchResult> deleteMessageBatchAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeleteMessageBatchResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<GetQueueAttributesResult> getQueueAttributesAsync(
    ...
    public java.util.concurrent.Future<GetQueueAttributesResult> getQueueAttributesAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetQueueAttributesResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<GetQueueUrlResult> getQueueUrlAsync(
    ...
    public java.util.concurrent.Future<GetQueueUrlResult> getQueueUrlAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetQueueUrlResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<ListDeadLetterSourceQueuesResult> listDeadLetterSourceQueuesAsync(
    ...
    public java.util.concurrent.Future<ListDeadLetterSourceQueuesResult> listDeadLetterSourceQueuesAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListDeadLetterSourceQueuesResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ListQueuesResult> listQueuesAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListQueuesResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<ReceiveMessageResult> receiveMessageAsync(
    ...
    public java.util.concurrent.Future<ReceiveMessageResult> receiveMessageAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ReceiveMessageResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<SendMessageResult> sendMessageAsync(
    ...
    public java.util.concurrent.Future<SendMessageResult> sendMessageAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<SendMessageResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<SendMessageBatchResult> sendMessageBatchAsync(
    ...
    public java.util.concurrent.Future<SendMessageBatchResult> sendMessageBatchAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<SendMessageBatchResult>() {
                    @Override
