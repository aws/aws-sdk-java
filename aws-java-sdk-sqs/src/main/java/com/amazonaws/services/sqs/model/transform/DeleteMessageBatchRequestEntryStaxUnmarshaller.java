 ...
 */
public class DeleteMessageBatchRequestEntryStaxUnmarshaller implements
        Unmarshaller<DeleteMessageBatchRequestEntry, StaxUnmarshallerContext> {

    public DeleteMessageBatchRequestEntry unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Id", targetDepth)) {
                    deleteMessageBatchRequestEntry.setId(StringStaxUnmarshaller
