...
public class SetQueueAttributesRequest extends AmazonWebServiceRequest
     ...
     * to 20 (seconds). The default for this attribute is 0.</li>
     ...
     * Queues in the <i>Amazon SQS Developer Guide</i>.</li>
     * </ul>
     * </p>
     */
     ...
     *        which a ReceiveMessage call will wait for a message to arrive. An
     ...
     *        Guide</i>.</li>
     *        <li><code>RedrivePolicy</code> - The parameters for dead letter
     *        queue functionality of the source queue. For more information
     *        about RedrivePolicy and dead letter queues, see Using Amazon SQS
     *        Dead Letter Queues in the <i>Amazon SQS Developer Guide</i>.</li>
     *        </ul>
     */
    public SetQueueAttributesRequest(String queueUrl,
