...
/**
 * DeleteQueueResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteQueueResultStaxUnmarshaller implements Unmarshaller<DeleteQueueResult, StaxUnmarshallerContext> {

    public DeleteQueueResult unmarshall(StaxUnmarshallerContext context) throws Exception {
