 ...
 */
public class DeleteMessageBatchResultEntryStaxUnmarshaller implements
        Unmarshaller<DeleteMessageBatchResultEntry, StaxUnmarshallerContext> {

    public DeleteMessageBatchResultEntry unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Id", targetDepth)) {
                    deleteMessageBatchResultEntry.setId(StringStaxUnmarshaller
