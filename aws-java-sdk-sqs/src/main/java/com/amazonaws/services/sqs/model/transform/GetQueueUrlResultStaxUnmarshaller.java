 ...
 */
public class GetQueueUrlResultStaxUnmarshaller implements
        Unmarshaller<GetQueueUrlResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("QueueUrl", targetDepth)) {
                    getQueueUrlResult.setQueueUrl(StringStaxUnmarshaller
