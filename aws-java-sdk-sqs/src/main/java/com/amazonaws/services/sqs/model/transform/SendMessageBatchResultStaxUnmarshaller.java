 ...
 */
public class SendMessageBatchResultStaxUnmarshaller implements
        Unmarshaller<SendMessageBatchResult, StaxUnmarshallerContext> {
    ...
    public SendMessageBatchResult unmarshall(StaxUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("SendMessageBatchResultEntry",
                        targetDepth)) {
                ...
                if (context
                    ...
                    sendMessageBatchResult.getFailed().add(
