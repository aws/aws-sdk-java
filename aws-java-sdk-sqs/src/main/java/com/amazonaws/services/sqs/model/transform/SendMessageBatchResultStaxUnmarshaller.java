...
/**
 * SendMessageBatchResult StAX Unmarshaller
 */
...
public class SendMessageBatchResultStaxUnmarshaller implements Unmarshaller<SendMessageBatchResult, StaxUnmarshallerContext> {
    ...
    public SendMessageBatchResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("SendMessageBatchResultEntry", targetDepth)) {
                    sendMessageBatchResult.withSuccessful(SendMessageBatchResultEntryStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("BatchResultErrorEntry", targetDepth)) {
                    sendMessageBatchResult.withFailed(BatchResultErrorEntryStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
