...
/**
 * Fluent builder for {@link com.amazonaws.services.sqs.AmazonSQSAsync}. Use of
 * the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonSQSAsyncClientBuilder extends
        AwsAsyncClientBuilder<AmazonSQSAsyncClientBuilder, AmazonSQSAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonSQSAsync using the
