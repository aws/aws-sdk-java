...
/**
 * ComponentDataConfigurationMarshaller
 */
...
public class ComponentDataConfigurationMarshaller {
    ...
    public static ComponentDataConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ComponentDataConfiguration componentDataConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (componentDataConfiguration == null) {
