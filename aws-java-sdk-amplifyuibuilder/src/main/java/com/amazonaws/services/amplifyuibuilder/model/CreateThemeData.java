 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/amplifyuibuilder-2021-08-11/CreateThemeData" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateThemeData implements Serializable, Cloneable, StructuredPojo {
    ...
    public CreateThemeData withOverrides(ThemeValues... overrides) {
    ...
    public CreateThemeData withOverrides(java.util.Collection<ThemeValues> overrides) {
    ...
    public CreateThemeData withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateThemeData#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateThemeData addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateThemeData withValues(ThemeValues... values) {
        if (this.values == null) {
    ...
    public CreateThemeData withValues(java.util.Collection<ThemeValues> values) {
        setValues(values);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateThemeData == false)
            return false;
    ...
    public CreateThemeData clone() {
        try {
            return (CreateThemeData) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.amplifyuibuilder.model.transform.CreateThemeDataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
