...
public class FormButtonMarshaller {
    ...
    private static final FormButtonMarshaller instance = new FormButtonMarshaller();

    public static FormButtonMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FormButton formButton, ProtocolMarshaller protocolMarshaller) {
