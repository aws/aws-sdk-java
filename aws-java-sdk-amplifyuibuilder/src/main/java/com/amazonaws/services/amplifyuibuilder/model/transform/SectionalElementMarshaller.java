...
public class SectionalElementMarshaller {
    ...
    public static SectionalElementMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SectionalElement sectionalElement, ProtocolMarshaller protocolMarshaller) {

        if (sectionalElement == null) {
