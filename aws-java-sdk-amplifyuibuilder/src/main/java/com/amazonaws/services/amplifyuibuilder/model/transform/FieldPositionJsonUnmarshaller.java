...
/**
 * FieldPosition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FieldPositionJsonUnmarshaller implements Unmarshaller<FieldPosition, JsonUnmarshallerContext> {

    public FieldPosition unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static FieldPositionJsonUnmarshaller instance;

    public static FieldPositionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FieldPositionJsonUnmarshaller();
        return instance;
    }
}
