...
/**
 * PutMetadataFlagResult JSON Unmarshaller
 */
...
public class PutMetadataFlagResultJsonUnmarshaller implements Unmarshaller<PutMetadataFlagResult, JsonUnmarshallerContext> {
    ...
    public PutMetadataFlagResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutMetadataFlagResult putMetadataFlagResult = new PutMetadataFlagResult();

        return putMetadataFlagResult;
    }
