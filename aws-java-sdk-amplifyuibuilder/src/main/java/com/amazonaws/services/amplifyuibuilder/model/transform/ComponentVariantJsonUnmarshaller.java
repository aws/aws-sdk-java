...
/**
 * ComponentVariant JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ComponentVariantJsonUnmarshaller implements Unmarshaller<ComponentVariant, JsonUnmarshallerContext> {

    public ComponentVariant unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ComponentVariantJsonUnmarshaller instance;

    public static ComponentVariantJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ComponentVariantJsonUnmarshaller();
        return instance;
    }
}
