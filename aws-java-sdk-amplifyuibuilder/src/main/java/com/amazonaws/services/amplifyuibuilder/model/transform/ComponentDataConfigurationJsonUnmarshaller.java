...
/**
 * ComponentDataConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ComponentDataConfigurationJsonUnmarshaller implements Unmarshaller<ComponentDataConfiguration, JsonUnmarshallerContext> {

    public ComponentDataConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ComponentDataConfiguration componentDataConfiguration = new ComponentDataConfiguration();
    ...
    private static ComponentDataConfigurationJsonUnmarshaller instance;

    public static ComponentDataConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ComponentDataConfigurationJsonUnmarshaller();
        return instance;
    }
}
