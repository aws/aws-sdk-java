...
public class CreateFormResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Describes the configuration of the new form.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateFormResult == false)
            return false;
        CreateFormResult other = (CreateFormResult) obj;
    ...
    public CreateFormResult clone() {
        try {
            return (CreateFormResult) super.clone();
