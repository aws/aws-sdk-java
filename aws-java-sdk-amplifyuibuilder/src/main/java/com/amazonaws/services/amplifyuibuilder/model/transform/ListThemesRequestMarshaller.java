...
public class ListThemesRequestMarshaller {
    ...
    public void marshall(ListThemesRequest listThemesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listThemesRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(listThemesRequest.getEnvironmentName(), ENVIRONMENTNAME_BINDING);
