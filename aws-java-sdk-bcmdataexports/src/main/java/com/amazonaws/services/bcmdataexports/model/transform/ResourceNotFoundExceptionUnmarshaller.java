...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.bcmdataexports.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.bcmdataexports.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bcmdataexports.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.bcmdataexports.model.ResourceNotFoundException(
                null);
