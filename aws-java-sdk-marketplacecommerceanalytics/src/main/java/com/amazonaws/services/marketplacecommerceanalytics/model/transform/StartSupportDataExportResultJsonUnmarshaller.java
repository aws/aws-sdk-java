 ...
 */
public class StartSupportDataExportResultJsonUnmarshaller implements
        Unmarshaller<StartSupportDataExportResult, JsonUnmarshallerContext> {

    public StartSupportDataExportResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("dataSetRequestId", targetDepth)) {
                    context.nextToken();
                    startSupportDataExportResult.setDataSetRequestId(context
