...
public interface AWSMarketplaceCommerceAnalyticsAsync extends
     ...
     *        operation.
     * @return A Java Future containing the result of the StartSupportDataExport
     *         operation returned by the service.
     * @sample AWSMarketplaceCommerceAnalyticsAsync.StartSupportDataExport
     */
    java.util.concurrent.Future<StartSupportDataExportResult> startSupportDataExportAsync(
     ...
     *         operation returned by the service.
     * @sample 
     *         AWSMarketplaceCommerceAnalyticsAsyncHandler.StartSupportDataExport
     */
    java.util.concurrent.Future<StartSupportDataExportResult> startSupportDataExportAsync(
            StartSupportDataExportRequest startSupportDataExportRequest,
