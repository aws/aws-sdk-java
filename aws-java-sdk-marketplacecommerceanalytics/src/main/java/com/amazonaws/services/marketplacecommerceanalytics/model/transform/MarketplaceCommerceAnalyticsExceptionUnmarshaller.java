...
public class MarketplaceCommerceAnalyticsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MarketplaceCommerceAnalyticsExceptionUnmarshaller instance;

    public static MarketplaceCommerceAnalyticsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MarketplaceCommerceAnalyticsExceptionUnmarshaller();
        return instance;
    }
}
