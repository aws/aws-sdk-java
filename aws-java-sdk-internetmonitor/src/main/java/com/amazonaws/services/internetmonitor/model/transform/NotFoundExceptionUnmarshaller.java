...
public class NotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private NotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.internetmonitor.model.NotFoundException.class, "NotFoundException");
    }

    @Override
    public com.amazonaws.services.internetmonitor.model.NotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.internetmonitor.model.NotFoundException notFoundException = new com.amazonaws.services.internetmonitor.model.NotFoundException(
                null);
