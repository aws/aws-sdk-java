...
public class ClientLocationMarshaller {
    ...
    public void marshall(ClientLocation clientLocation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(clientLocation.getASName(), ASNAME_BINDING);
            protocolMarshaller.marshall(clientLocation.getASNumber(), ASNUMBER_BINDING);
            protocolMarshaller.marshall(clientLocation.getCountry(), COUNTRY_BINDING);
            protocolMarshaller.marshall(clientLocation.getSubdivision(), SUBDIVISION_BINDING);
            protocolMarshaller.marshall(clientLocation.getMetro(), METRO_BINDING);
            protocolMarshaller.marshall(clientLocation.getCity(), CITY_BINDING);
            protocolMarshaller.marshall(clientLocation.getLatitude(), LATITUDE_BINDING);
            protocolMarshaller.marshall(clientLocation.getLongitude(), LONGITUDE_BINDING);
        } catch (Exception e) {
