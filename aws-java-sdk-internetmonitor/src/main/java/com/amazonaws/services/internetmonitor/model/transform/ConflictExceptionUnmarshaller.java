...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.internetmonitor.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.internetmonitor.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.internetmonitor.model.ConflictException conflictException = new com.amazonaws.services.internetmonitor.model.ConflictException(
                null);
