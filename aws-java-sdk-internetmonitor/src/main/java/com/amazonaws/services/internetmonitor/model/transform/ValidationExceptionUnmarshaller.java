...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.internetmonitor.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.internetmonitor.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.internetmonitor.model.ValidationException validationException = new com.amazonaws.services.internetmonitor.model.ValidationException(
                null);
