...
public class GetQueryResultsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<QueryField> fields;
    /**
     * <p>
    ...
    public void setFields(java.util.Collection<QueryField> fields) {
        if (fields == null) {
            this.fields = null;
            return;
        }

        this.fields = new java.util.ArrayList<QueryField>(fields);
    }
    ...
    public GetQueryResultsResult withFields(QueryField... fields) {
        if (this.fields == null) {
            setFields(new java.util.ArrayList<QueryField>(fields.length));
        }
    ...
    public GetQueryResultsResult withFields(java.util.Collection<QueryField> fields) {
        setFields(fields);
        return this;
    }
     ...
     * 
     * @param data
     *        The data results that the query returns. Data is returned in arrays, aligned with the <code>Fields</code>
     *        for the query, which creates a repository of Amazon CloudWatch Internet Monitor information for your
     *        application. Then, you can filter the information in the repository by using <code>FilterParameters</code>
     *        that you define.
     */

    public void setData(java.util.Collection<java.util.List<String>> data) {
        if (data == null) {
            this.data = null;
            return;
        }

        this.data = new java.util.ArrayList<java.util.List<String>>(data);
    }
    ...
    public GetQueryResultsResult withData(java.util.List<String>... data) {
        if (this.data == null) {
            setData(new java.util.ArrayList<java.util.List<String>>(data.length));
        }
        for (java.util.List<String> ele : data) {
            this.data.add(ele);
        }
        return this;
    }
    ...
    public GetQueryResultsResult withData(java.util.Collection<java.util.List<String>> data) {
        setData(data);
        return this;
    }
