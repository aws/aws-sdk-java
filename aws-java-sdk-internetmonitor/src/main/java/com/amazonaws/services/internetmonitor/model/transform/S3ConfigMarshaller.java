...
public class S3ConfigMarshaller {
    ...
    private static final MarshallingInfo<String> LOGDELIVERYSTATUS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("LogDeliveryStatus").build();
    ...
    public void marshall(S3Config s3Config, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(s3Config.getLogDeliveryStatus(), LOGDELIVERYSTATUS_BINDING);
        } catch (Exception e) {
