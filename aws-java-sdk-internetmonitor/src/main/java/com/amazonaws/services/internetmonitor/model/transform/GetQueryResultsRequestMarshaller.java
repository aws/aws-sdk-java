...
/**
 * GetQueryResultsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetQueryResultsRequestMarshaller {
    ...
    private static final GetQueryResultsRequestMarshaller instance = new GetQueryResultsRequestMarshaller();

    public static GetQueryResultsRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetQueryResultsRequest getQueryResultsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getQueryResultsRequest.getMonitorName(), MONITORNAME_BINDING);
