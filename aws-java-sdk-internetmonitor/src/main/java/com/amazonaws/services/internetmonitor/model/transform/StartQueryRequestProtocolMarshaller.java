...
public class StartQueryRequestProtocolMarshaller implements Marshaller<Request<StartQueryRequest>, StartQueryRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.REST_JSON)
            .requestUri("/v20210603/Monitors/{MonitorName}/Queries").httpMethodName(HttpMethodName.POST).hasExplicitPayloadMember(false)
            .hasPayloadMembers(true).serviceName("AmazonInternetMonitor").build();
