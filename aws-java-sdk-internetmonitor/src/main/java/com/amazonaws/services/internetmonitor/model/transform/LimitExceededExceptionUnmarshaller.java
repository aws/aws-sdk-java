...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.internetmonitor.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.internetmonitor.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.internetmonitor.model.LimitExceededException limitExceededException = new com.amazonaws.services.internetmonitor.model.LimitExceededException(
                null);
