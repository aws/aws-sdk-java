...
public class InternalServerErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerErrorExceptionUnmarshaller() {
        super(com.amazonaws.services.internetmonitor.model.InternalServerErrorException.class, "InternalServerErrorException");
    }

    @Override
    public com.amazonaws.services.internetmonitor.model.InternalServerErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.internetmonitor.model.InternalServerErrorException internalServerErrorException = new com.amazonaws.services.internetmonitor.model.InternalServerErrorException(
                null);
