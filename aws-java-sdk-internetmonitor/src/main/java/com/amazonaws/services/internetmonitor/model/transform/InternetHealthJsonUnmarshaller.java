...
/**
 * InternetHealth JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InternetHealthJsonUnmarshaller implements Unmarshaller<InternetHealth, JsonUnmarshallerContext> {

    public InternetHealth unmarshall(JsonUnmarshallerContext context) throws Exception {
        InternetHealth internetHealth = new InternetHealth();
    ...
    private static InternetHealthJsonUnmarshaller instance;

    public static InternetHealthJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new InternetHealthJsonUnmarshaller();
        return instance;
    }
}
