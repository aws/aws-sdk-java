...
public class DescribeApplicationInstanceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeApplicationInstanceRequest withApplicationInstanceId(String applicationInstanceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeApplicationInstanceRequest == false)
            return false;
        DescribeApplicationInstanceRequest other = (DescribeApplicationInstanceRequest) obj;
    ...
    @Override
    public DescribeApplicationInstanceRequest clone() {
        return (DescribeApplicationInstanceRequest) super.clone();
    }
