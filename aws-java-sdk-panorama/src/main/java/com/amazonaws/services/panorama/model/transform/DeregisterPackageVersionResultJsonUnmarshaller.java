...
/**
 * DeregisterPackageVersionResult JSON Unmarshaller
 */
...
public class DeregisterPackageVersionResultJsonUnmarshaller implements Unmarshaller<DeregisterPackageVersionResult, JsonUnmarshallerContext> {
    ...
    public DeregisterPackageVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterPackageVersionResult deregisterPackageVersionResult = new DeregisterPackageVersionResult();
