...
public class CreateJobForDevicesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateJobForDevicesResult withJobs(Job... jobs) {
        if (this.jobs == null) {
    ...
    public CreateJobForDevicesResult withJobs(java.util.Collection<Job> jobs) {
        setJobs(jobs);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateJobForDevicesResult == false)
            return false;
        CreateJobForDevicesResult other = (CreateJobForDevicesResult) obj;
    ...
    public CreateJobForDevicesResult clone() {
        try {
            return (CreateJobForDevicesResult) super.clone();
