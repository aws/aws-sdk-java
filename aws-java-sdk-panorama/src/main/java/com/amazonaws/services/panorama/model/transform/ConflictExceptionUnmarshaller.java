...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.panorama.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.panorama.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.panorama.model.ConflictException conflictException = new com.amazonaws.services.panorama.model.ConflictException(null);
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorArguments", targetDepth)) {
                    context.nextToken();
                    conflictException.setErrorArguments(new ListUnmarshaller<ConflictExceptionErrorArgument>(ConflictExceptionErrorArgumentJsonUnmarshaller
                            .getInstance())
                ...
                if (context.testExpression("ErrorId", targetDepth)) {
                    context.nextToken();
                    conflictException.setErrorId(context.getUnmarshaller(String.class).unmarshall(context));
                }
