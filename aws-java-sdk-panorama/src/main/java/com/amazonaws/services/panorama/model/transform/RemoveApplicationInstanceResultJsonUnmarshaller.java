...
/**
 * RemoveApplicationInstanceResult JSON Unmarshaller
 */
...
public class RemoveApplicationInstanceResultJsonUnmarshaller implements Unmarshaller<RemoveApplicationInstanceResult, JsonUnmarshallerContext> {
    ...
    public RemoveApplicationInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RemoveApplicationInstanceResult removeApplicationInstanceResult = new RemoveApplicationInstanceResult();
