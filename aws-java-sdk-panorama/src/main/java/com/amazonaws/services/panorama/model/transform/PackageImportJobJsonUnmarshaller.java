...
/**
 * PackageImportJob JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PackageImportJobJsonUnmarshaller implements Unmarshaller<PackageImportJob, JsonUnmarshallerContext> {

    public PackageImportJob unmarshall(JsonUnmarshallerContext context) throws Exception {
        PackageImportJob packageImportJob = new PackageImportJob();
    ...
    private static PackageImportJobJsonUnmarshaller instance;

    public static PackageImportJobJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PackageImportJobJsonUnmarshaller();
        return instance;
    }
}
