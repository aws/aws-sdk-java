...
/**
 * NodeFromTemplateJob JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NodeFromTemplateJobJsonUnmarshaller implements Unmarshaller<NodeFromTemplateJob, JsonUnmarshallerContext> {

    public NodeFromTemplateJob unmarshall(JsonUnmarshallerContext context) throws Exception {
        NodeFromTemplateJob nodeFromTemplateJob = new NodeFromTemplateJob();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    nodeFromTemplateJob.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static NodeFromTemplateJobJsonUnmarshaller instance;

    public static NodeFromTemplateJobJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new NodeFromTemplateJobJsonUnmarshaller();
        return instance;
    }
}
