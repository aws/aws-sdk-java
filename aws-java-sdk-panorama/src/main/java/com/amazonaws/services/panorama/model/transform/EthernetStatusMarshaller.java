...
public class EthernetStatusMarshaller {
    ...
    public static EthernetStatusMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EthernetStatus ethernetStatus, ProtocolMarshaller protocolMarshaller) {
