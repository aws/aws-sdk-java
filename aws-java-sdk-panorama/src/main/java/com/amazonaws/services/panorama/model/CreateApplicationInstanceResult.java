...
public class CreateApplicationInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateApplicationInstanceResult withApplicationInstanceId(String applicationInstanceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateApplicationInstanceResult == false)
            return false;
        CreateApplicationInstanceResult other = (CreateApplicationInstanceResult) obj;
    ...
    @Override
    public CreateApplicationInstanceResult clone() {
        try {
            return (CreateApplicationInstanceResult) super.clone();
