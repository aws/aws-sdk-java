...
public class SignalApplicationInstanceNodeInstancesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public SignalApplicationInstanceNodeInstancesResult withApplicationInstanceId(String applicationInstanceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SignalApplicationInstanceNodeInstancesResult == false)
            return false;
        SignalApplicationInstanceNodeInstancesResult other = (SignalApplicationInstanceNodeInstancesResult) obj;
    ...
    @Override
    public SignalApplicationInstanceNodeInstancesResult clone() {
        try {
            return (SignalApplicationInstanceNodeInstancesResult) super.clone();
