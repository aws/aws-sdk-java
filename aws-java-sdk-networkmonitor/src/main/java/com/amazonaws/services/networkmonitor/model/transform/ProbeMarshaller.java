...
public class ProbeMarshaller {
    ...
    private static final MarshallingInfo<String> PROBEID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("probeId").build();
    private static final MarshallingInfo<String> PROBEARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("probeArn").build();
    ...
    public void marshall(Probe probe, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(probe.getProbeId(), PROBEID_BINDING);
            protocolMarshaller.marshall(probe.getProbeArn(), PROBEARN_BINDING);
            protocolMarshaller.marshall(probe.getSourceArn(), SOURCEARN_BINDING);
            protocolMarshaller.marshall(probe.getDestination(), DESTINATION_BINDING);
            protocolMarshaller.marshall(probe.getDestinationPort(), DESTINATIONPORT_BINDING);
            protocolMarshaller.marshall(probe.getProtocol(), PROTOCOL_BINDING);
            protocolMarshaller.marshall(probe.getPacketSize(), PACKETSIZE_BINDING);
            protocolMarshaller.marshall(probe.getAddressFamily(), ADDRESSFAMILY_BINDING);
            protocolMarshaller.marshall(probe.getVpcId(), VPCID_BINDING);
            protocolMarshaller.marshall(probe.getState(), STATE_BINDING);
            protocolMarshaller.marshall(probe.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(probe.getModifiedAt(), MODIFIEDAT_BINDING);
