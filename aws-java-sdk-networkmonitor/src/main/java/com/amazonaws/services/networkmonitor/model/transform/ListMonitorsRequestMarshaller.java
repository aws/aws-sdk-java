...
@SdkInternalApi
public class ListMonitorsRequestMarshaller {
    ...
    public static ListMonitorsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListMonitorsRequest listMonitorsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(listMonitorsRequest.getState(), STATE_BINDING);
        } catch (Exception e) {
