...
@SdkInternalApi
public class ListProfileObjectsItemMarshaller {
    ...
    private static final ListProfileObjectsItemMarshaller instance = new ListProfileObjectsItemMarshaller();

    public static ListProfileObjectsItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListProfileObjectsItem listProfileObjectsItem, ProtocolMarshaller protocolMarshaller) {

        if (listProfileObjectsItem == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(listProfileObjectsItem.getObjectTypeName(), OBJECTTYPENAME_BINDING);
            protocolMarshaller.marshall(listProfileObjectsItem.getProfileObjectUniqueKey(), PROFILEOBJECTUNIQUEKEY_BINDING);
            protocolMarshaller.marshall(listProfileObjectsItem.getObject(), OBJECT_BINDING);
        } catch (Exception e) {
