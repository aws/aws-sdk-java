...
@SdkInternalApi
public class DeleteProfileKeyRequestMarshaller {
    ...
    private static final DeleteProfileKeyRequestMarshaller instance = new DeleteProfileKeyRequestMarshaller();

    public static DeleteProfileKeyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteProfileKeyRequest deleteProfileKeyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteProfileKeyRequest.getProfileId(), PROFILEID_BINDING);
            protocolMarshaller.marshall(deleteProfileKeyRequest.getKeyName(), KEYNAME_BINDING);
            protocolMarshaller.marshall(deleteProfileKeyRequest.getValues(), VALUES_BINDING);
            protocolMarshaller.marshall(deleteProfileKeyRequest.getDomainName(), DOMAINNAME_BINDING);
        } catch (Exception e) {
