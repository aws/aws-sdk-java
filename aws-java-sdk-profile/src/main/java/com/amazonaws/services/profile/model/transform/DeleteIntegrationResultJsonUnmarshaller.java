...
public class DeleteIntegrationResultJsonUnmarshaller implements Unmarshaller<DeleteIntegrationResult, JsonUnmarshallerContext> {
    ...
    public DeleteIntegrationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    deleteIntegrationResult.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
