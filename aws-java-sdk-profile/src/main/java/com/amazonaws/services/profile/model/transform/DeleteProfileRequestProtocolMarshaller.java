...
public class DeleteProfileRequestProtocolMarshaller implements Marshaller<Request<DeleteProfileRequest>, DeleteProfileRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.REST_JSON)
            .requestUri("/domains/{DomainName}/profiles/delete").httpMethodName(HttpMethodName.POST).hasExplicitPayloadMember(false).hasPayloadMembers(true)
            .serviceName("AmazonProfile").build();
