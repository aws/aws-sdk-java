...
/**
 * ListAccountIntegrationsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListAccountIntegrationsRequestMarshaller {
    ...
    public static ListAccountIntegrationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListAccountIntegrationsRequest listAccountIntegrationsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listAccountIntegrationsRequest == null) {
