...
/**
 * Client for accessing Profile asynchronously. Each asynchronous method will return a Java Future object representing
...
public class AmazonProfileAsyncClient extends AmazonProfileClient implements AmazonProfileAsync {

    private static final int DEFAULT_THREAD_POOL_SIZE = 50;

    private final java.util.concurrent.ExecutorService executorService;

    public static AmazonProfileAsyncClientBuilder asyncBuilder() {
        return AmazonProfileAsyncClientBuilder.standard();
    }

    /**
     * Constructs a new asynchronous client to invoke service methods on Profile using the specified parameters.
     *
     * @param asyncClientParams
     *        Object providing client parameters.
     */
    AmazonProfileAsyncClient(AwsAsyncClientParams asyncClientParams) {
     ...
     */
    AmazonProfileAsyncClient(AwsAsyncClientParams asyncClientParams, boolean endpointDiscoveryEnabled) {
