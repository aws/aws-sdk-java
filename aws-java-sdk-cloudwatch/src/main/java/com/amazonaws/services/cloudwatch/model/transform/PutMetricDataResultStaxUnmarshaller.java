...
public class PutMetricDataResultStaxUnmarshaller implements Unmarshaller<PutMetricDataResult, StaxUnmarshallerContext> {

    public PutMetricDataResult unmarshall(StaxUnmarshallerContext context) throws Exception {
