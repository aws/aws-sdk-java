...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/monitoring-2010-08-01/StartMetricStreams" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartMetricStreamsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * list here, then none of the streams that you list in the operation will start streaming.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The array of the names of metric streams to start streaming.</p>
     *         <p>
     ...
     * 
     * @param names
     *        The array of the names of metric streams to start streaming.</p>
     *        <p>
     *        This is an "all or nothing" operation. If you do not have permission to access all of the metric streams
     *        that you list here, then none of the streams that you list in the operation will start streaming.
     */
    ...
    public StartMetricStreamsRequest withNames(String... names) {
        if (this.names == null) {
    ...
    public StartMetricStreamsRequest withNames(java.util.Collection<String> names) {
        setNames(names);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartMetricStreamsRequest == false)
            return false;
        StartMetricStreamsRequest other = (StartMetricStreamsRequest) obj;
    ...
    @Override
    public StartMetricStreamsRequest clone() {
        return (StartMetricStreamsRequest) super.clone();
    }
