...
/**
 * ManagedRule StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ManagedRuleStaxUnmarshaller implements Unmarshaller<ManagedRule, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("TemplateName", targetDepth)) {
                    managedRule.setTemplateName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ResourceARN", targetDepth)) {
                    managedRule.setResourceARN(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
