...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.cloudwatch.AmazonCloudWatchAsync}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonCloudWatchAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonCloudWatchAsyncClientBuilder, AmazonCloudWatchAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonCloudWatchAsync using
