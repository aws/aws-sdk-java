...
/**
 * Fluent builder for {@link com.amazonaws.services.cloudwatch.AmazonCloudWatch}
 * . Use of the builder is preferred over using constructors of the client
 * class.
 **/
@NotThreadSafe
public final class AmazonCloudWatchClientBuilder extends
        AwsSyncClientBuilder<AmazonCloudWatchClientBuilder, AmazonCloudWatch> {
    ...
    /**
     * Construct a synchronous implementation of AmazonCloudWatch using the
