 ...
 */
public class DescribeAlarmsForMetricResultStaxUnmarshaller implements
        Unmarshaller<DescribeAlarmsForMetricResult, StaxUnmarshallerContext> {

    public DescribeAlarmsForMetricResult unmarshall(
