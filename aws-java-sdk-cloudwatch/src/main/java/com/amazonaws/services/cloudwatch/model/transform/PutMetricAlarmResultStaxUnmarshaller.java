...
public class PutMetricAlarmResultStaxUnmarshaller implements Unmarshaller<PutMetricAlarmResult, StaxUnmarshallerContext> {

    public PutMetricAlarmResult unmarshall(StaxUnmarshallerContext context) throws Exception {
