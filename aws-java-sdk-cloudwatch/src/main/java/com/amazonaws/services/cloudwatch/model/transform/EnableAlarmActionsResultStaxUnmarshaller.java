...
public class EnableAlarmActionsResultStaxUnmarshaller implements Unmarshaller<EnableAlarmActionsResult, StaxUnmarshallerContext> {

    public EnableAlarmActionsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
