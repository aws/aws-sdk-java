...
/**
 * Container for the parameters to the {@link com.amazonaws.services.codedeploy.AmazonCodeDeploy#createApplication(CreateApplicationRequest) CreateApplication operation}.
 * <p>
...
public class CreateApplicationRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * <b>Length: </b>1 - 100<br/>
     *
     * @return The name of the application. This name must be unique within the AWS
     *         user account.
     */
     ...
     * <b>Length: </b>1 - 100<br/>
     *
     * @param applicationName The name of the application. This name must be unique within the AWS
     *         user account.
     */
