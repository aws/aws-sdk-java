...
/**
 * ContinueDeploymentResult JSON Unmarshaller
 */
...
public class ContinueDeploymentResultJsonUnmarshaller implements Unmarshaller<ContinueDeploymentResult, JsonUnmarshallerContext> {
    ...
    public ContinueDeploymentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ContinueDeploymentResult continueDeploymentResult = new ContinueDeploymentResult();
