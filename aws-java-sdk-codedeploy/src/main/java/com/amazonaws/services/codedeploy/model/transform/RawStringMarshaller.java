...
public class RawStringMarshaller {
    ...
    private static final MarshallingInfo<String> SHA256_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("sha256").build();
    ...
    public void marshall(RawString rawString, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(rawString.getContent(), CONTENT_BINDING);
            protocolMarshaller.marshall(rawString.getSha256(), SHA256_BINDING);
        } catch (Exception e) {
