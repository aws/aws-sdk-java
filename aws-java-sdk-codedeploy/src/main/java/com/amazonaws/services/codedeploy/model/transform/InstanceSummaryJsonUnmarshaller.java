...
/**
 * Instance Summary JSON Unmarshaller
 */
public class InstanceSummaryJsonUnmarshaller implements Unmarshaller<InstanceSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("deploymentId", targetDepth)) {
                    context.nextToken();
                    instanceSummary.setDeploymentId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("instanceId", targetDepth)) {
                    context.nextToken();
                    instanceSummary.setInstanceId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("status", targetDepth)) {
                    context.nextToken();
                    instanceSummary.setStatus(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("lastUpdatedAt", targetDepth)) {
                    context.nextToken();
                    instanceSummary.setLastUpdatedAt(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static InstanceSummaryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new InstanceSummaryJsonUnmarshaller();
        return instance;
    }
}
