...
public class MultipleIamArnsProvidedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MultipleIamArnsProvidedExceptionUnmarshaller instance;

    public static MultipleIamArnsProvidedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MultipleIamArnsProvidedExceptionUnmarshaller();
        return instance;
    }
}
