...
public class InvalidLoadBalancerInfoExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidLoadBalancerInfoExceptionUnmarshaller instance;

    public static InvalidLoadBalancerInfoExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidLoadBalancerInfoExceptionUnmarshaller();
        return instance;
    }
}
