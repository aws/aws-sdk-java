...
public class InvalidTargetInstancesExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTargetInstancesExceptionUnmarshaller instance;

    public static InvalidTargetInstancesExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTargetInstancesExceptionUnmarshaller();
        return instance;
    }
}
