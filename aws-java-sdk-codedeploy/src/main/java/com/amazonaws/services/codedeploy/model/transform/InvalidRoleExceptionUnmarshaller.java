...
public class InvalidRoleExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("InvalidRoleException"));
        } else {
            return errorTypeFromHeader.equals("InvalidRoleException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        InvalidRoleException e = (InvalidRoleException)super.unmarshall(json);
