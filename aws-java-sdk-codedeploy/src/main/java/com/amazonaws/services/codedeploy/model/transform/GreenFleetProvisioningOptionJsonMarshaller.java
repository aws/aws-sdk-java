...
public class GreenFleetProvisioningOptionJsonMarshaller {
     ...
     */
    public void marshall(GreenFleetProvisioningOption greenFleetProvisioningOption, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (greenFleetProvisioningOption.getAction() != null) {
                jsonGenerator.writeFieldName("action").writeValue(greenFleetProvisioningOption.getAction());
            }
