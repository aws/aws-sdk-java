...
public class InvalidDeploymentStatusExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDeploymentStatusExceptionUnmarshaller instance;

    public static InvalidDeploymentStatusExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDeploymentStatusExceptionUnmarshaller();
        return instance;
    }
}
