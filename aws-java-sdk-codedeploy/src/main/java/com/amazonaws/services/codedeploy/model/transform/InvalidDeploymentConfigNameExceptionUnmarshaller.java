...
public class InvalidDeploymentConfigNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDeploymentConfigNameExceptionUnmarshaller instance;

    public static InvalidDeploymentConfigNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDeploymentConfigNameExceptionUnmarshaller();
        return instance;
    }
}
