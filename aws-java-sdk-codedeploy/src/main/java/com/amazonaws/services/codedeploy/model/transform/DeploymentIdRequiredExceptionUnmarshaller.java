...
public class DeploymentIdRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentIdRequiredExceptionUnmarshaller instance;

    public static DeploymentIdRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentIdRequiredExceptionUnmarshaller();
        return instance;
    }
}
