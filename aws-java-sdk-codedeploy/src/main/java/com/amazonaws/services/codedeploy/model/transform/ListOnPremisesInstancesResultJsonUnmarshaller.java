...
/**
 * List On Premises Instances Result JSON Unmarshaller
 */
public class ListOnPremisesInstancesResultJsonUnmarshaller implements Unmarshaller<ListOnPremisesInstancesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("instanceNames", targetDepth)) {
                    context.nextToken();
                    listOnPremisesInstancesResult.setInstanceNames(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listOnPremisesInstancesResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ListOnPremisesInstancesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListOnPremisesInstancesResultJsonUnmarshaller();
        return instance;
    }
}
