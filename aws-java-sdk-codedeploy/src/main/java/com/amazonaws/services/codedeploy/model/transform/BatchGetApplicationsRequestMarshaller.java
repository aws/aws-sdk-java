...
/**
 * Batch Get Applications Request Marshaller
 */
    ...
    public Request<BatchGetApplicationsRequest> marshall(BatchGetApplicationsRequest batchGetApplicationsRequest) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            com.amazonaws.internal.ListWithAutoConstructFlag<String> applicationNamesList = (com.amazonaws.internal.ListWithAutoConstructFlag<String>)(batchGetApplicationsRequest.getApplicationNames());
            if (applicationNamesList != null && !(applicationNamesList.isAutoConstruct() && applicationNamesList.isEmpty())) {
