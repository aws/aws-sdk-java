...
/**
 * List Deployments Request Marshaller
 */
    ...
    public Request<ListDeploymentsRequest> marshall(ListDeploymentsRequest listDeploymentsRequest) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            com.amazonaws.internal.ListWithAutoConstructFlag<String> includeOnlyStatusesList = (com.amazonaws.internal.ListWithAutoConstructFlag<String>)(listDeploymentsRequest.getIncludeOnlyStatuses());
            if (includeOnlyStatusesList != null && !(includeOnlyStatusesList.isAutoConstruct() && includeOnlyStatusesList.isEmpty())) {
            ...
            TimeRange createTimeRange = listDeploymentsRequest.getCreateTimeRange();
