...
public class InvalidDeploymentTargetIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDeploymentTargetIdExceptionUnmarshaller instance;

    public static InvalidDeploymentTargetIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDeploymentTargetIdExceptionUnmarshaller();
        return instance;
    }
}
