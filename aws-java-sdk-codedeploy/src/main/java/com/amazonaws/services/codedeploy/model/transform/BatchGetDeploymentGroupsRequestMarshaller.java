...
public class BatchGetDeploymentGroupsRequestMarshaller
    ...
    public Request<BatchGetDeploymentGroupsRequest> marshall(
        ...
        Request<BatchGetDeploymentGroupsRequest> request = new DefaultRequest<BatchGetDeploymentGroupsRequest>(
                batchGetDeploymentGroupsRequest, "AmazonCodeDeploy");
        ...
        try {
            ...
            if (batchGetDeploymentGroupsRequest.getApplicationName() != null) {
                jsonWriter.key("applicationName").value(
                        batchGetDeploymentGroupsRequest.getApplicationName());
            }
            ...
            if (!deploymentGroupNamesList.isEmpty()
                    || !deploymentGroupNamesList.isAutoConstruct()) {
                jsonWriter.key("deploymentGroupNames");
                jsonWriter.array();
                for (String deploymentGroupNamesListValue : deploymentGroupNamesList) {
                    if (deploymentGroupNamesListValue != null) {
                        jsonWriter.value(deploymentGroupNamesListValue);
                    }
                }
                jsonWriter.endArray();
            }
