...
public class CreateDeploymentGroupRequestMarshaller {
    ...
    public void marshall(CreateDeploymentGroupRequest createDeploymentGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createDeploymentGroupRequest.getOutdatedInstancesStrategy(), OUTDATEDINSTANCESSTRATEGY_BINDING);
            ...
            protocolMarshaller.marshall(createDeploymentGroupRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(createDeploymentGroupRequest.getTerminationHookEnabled(), TERMINATIONHOOKENABLED_BINDING);
        } catch (Exception e) {
