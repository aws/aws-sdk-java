...
public class GetDeploymentRequestMarshaller implements Marshaller<Request<GetDeploymentRequest>, GetDeploymentRequest> {
    ...
    public Request<GetDeploymentRequest> marshall(GetDeploymentRequest getDeploymentRequest) {
        ...
        Request<GetDeploymentRequest> request = new DefaultRequest<GetDeploymentRequest>(getDeploymentRequest, "AmazonCodeDeploy");
        request.addHeader("X-Amz-Target", "CodeDeploy_20141006.GetDeployment");
        ...
        try {
            ...
            if (getDeploymentRequest.getDeploymentId() != null) {
                jsonGenerator.writeFieldName("deploymentId").writeValue(getDeploymentRequest.getDeploymentId());
            }
