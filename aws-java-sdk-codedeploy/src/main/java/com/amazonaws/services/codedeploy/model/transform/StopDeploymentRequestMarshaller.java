...
public class StopDeploymentRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> AUTOROLLBACKENABLED_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("autoRollbackEnabled").build();
    ...
    public void marshall(StopDeploymentRequest stopDeploymentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(stopDeploymentRequest.getDeploymentId(), DEPLOYMENTID_BINDING);
            protocolMarshaller.marshall(stopDeploymentRequest.getAutoRollbackEnabled(), AUTOROLLBACKENABLED_BINDING);
        } catch (Exception e) {
