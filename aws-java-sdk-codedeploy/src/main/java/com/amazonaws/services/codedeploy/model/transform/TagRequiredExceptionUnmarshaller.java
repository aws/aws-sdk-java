...
public class TagRequiredExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("TagRequiredException"));
        } else {
            return errorTypeFromHeader.equals("TagRequiredException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        TagRequiredException e = (TagRequiredException)super.unmarshall(json);
