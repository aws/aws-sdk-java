...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A list of keys of <code>Tag</code> objects. The <code>Tag</code> objects identified by the keys are disassociated
     * from the resource specified by the <code>ResourceArn</code> input parameter.
     * </p>
     */
     ...
     * </p>
     * 
     * @return A list of keys of <code>Tag</code> objects. The <code>Tag</code> objects identified by the keys are
     ...
     * 
     * @param tagKeys
     *        A list of keys of <code>Tag</code> objects. The <code>Tag</code> objects identified by the keys are
     *        disassociated from the resource specified by the <code>ResourceArn</code> input parameter.
     */
