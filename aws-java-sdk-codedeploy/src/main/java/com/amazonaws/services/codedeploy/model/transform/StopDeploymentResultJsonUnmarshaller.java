...
/**
 * Stop Deployment Result JSON Unmarshaller
 */
public class StopDeploymentResultJsonUnmarshaller implements Unmarshaller<StopDeploymentResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("statusMessage", targetDepth)) {
                    context.nextToken();
                    stopDeploymentResult.setStatusMessage(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static StopDeploymentResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new StopDeploymentResultJsonUnmarshaller();
        return instance;
    }
}
