...
public class DeploymentGroupDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentGroupDoesNotExistExceptionUnmarshaller instance;

    public static DeploymentGroupDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentGroupDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
