...
/**
 * BatchGetDeploymentTargetsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchGetDeploymentTargetsResultJsonUnmarshaller implements Unmarshaller<BatchGetDeploymentTargetsResult, JsonUnmarshallerContext> {

    public BatchGetDeploymentTargetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
