...
public class InvalidLifecycleEventHookExecutionIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidLifecycleEventHookExecutionIdExceptionUnmarshaller instance;

    public static InvalidLifecycleEventHookExecutionIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidLifecycleEventHookExecutionIdExceptionUnmarshaller();
        return instance;
    }
}
