 ...
 */
public class RegisterOnPremisesInstanceResultJsonUnmarshaller implements
        Unmarshaller<RegisterOnPremisesInstanceResult, JsonUnmarshallerContext> {

    public RegisterOnPremisesInstanceResult unmarshall(
