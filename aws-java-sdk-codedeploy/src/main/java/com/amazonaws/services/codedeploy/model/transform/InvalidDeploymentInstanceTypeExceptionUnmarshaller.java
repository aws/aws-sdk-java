...
public class InvalidDeploymentInstanceTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDeploymentInstanceTypeExceptionUnmarshaller instance;

    public static InvalidDeploymentInstanceTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDeploymentInstanceTypeExceptionUnmarshaller();
        return instance;
    }
}
