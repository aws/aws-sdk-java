...
public class IamSessionArnAlreadyRegisteredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static IamSessionArnAlreadyRegisteredExceptionUnmarshaller instance;

    public static IamSessionArnAlreadyRegisteredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IamSessionArnAlreadyRegisteredExceptionUnmarshaller();
        return instance;
    }
}
