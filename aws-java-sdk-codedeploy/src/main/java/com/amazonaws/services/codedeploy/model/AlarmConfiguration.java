...
public class AlarmConfiguration implements Serializable, Cloneable {
     ...
     *        CloudWatch. The default value is false.</p>
     *        <ul>
     *        <li>
     *        <p>
     ...
     * </ul>
     * 
     * @return Indicates whether a deployment should continue if information
     *         about the current state of alarms cannot be retrieved from Amazon
     *         CloudWatch. The default value is false.</p>
     *         <ul>
     *         <li>
     *         <p>
     *         true: The deployment will proceed even if alarm status
    ...
    public AlarmConfiguration withIgnorePollAlarmFailure(
     ...
     * </p>
     * 
     * @return A list of alarms configured for the deployment group. A maximum
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getIgnorePollAlarmFailure() == null
                ^ this.getIgnorePollAlarmFailure() == null)
            return false;
        if (other.getIgnorePollAlarmFailure() != null
                && other.getIgnorePollAlarmFailure().equals(
                        this.getIgnorePollAlarmFailure()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getIgnorePollAlarmFailure() == null) ? 0
                        : getIgnorePollAlarmFailure().hashCode());
        hashCode = prime * hashCode
