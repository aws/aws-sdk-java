...
public class ListDeploymentGroupsRequestMarshaller {
    ...
    private static final ListDeploymentGroupsRequestMarshaller instance = new ListDeploymentGroupsRequestMarshaller();

    public static ListDeploymentGroupsRequestMarshaller getInstance() {
        return instance;
    }
