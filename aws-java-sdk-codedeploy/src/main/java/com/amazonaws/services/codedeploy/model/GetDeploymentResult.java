...
public class GetDeploymentResult implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getDeploymentInfo() != null) sb.append("DeploymentInfo: " + getDeploymentInfo() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDeploymentResult == false) return false;
        GetDeploymentResult other = (GetDeploymentResult)obj;
        
        if (other.getDeploymentInfo() == null ^ this.getDeploymentInfo() == null) return false;
        if (other.getDeploymentInfo() != null && other.getDeploymentInfo().equals(this.getDeploymentInfo()) == false) return false; 
        return true;
    }
