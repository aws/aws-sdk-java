 ...
 */
public class RegisterApplicationRevisionResultJsonUnmarshaller
        implements
        Unmarshaller<RegisterApplicationRevisionResult, JsonUnmarshallerContext> {

    public RegisterApplicationRevisionResult unmarshall(
