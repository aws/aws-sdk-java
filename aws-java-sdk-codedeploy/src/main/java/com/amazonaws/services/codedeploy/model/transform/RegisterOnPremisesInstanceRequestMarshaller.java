...
public class RegisterOnPremisesInstanceRequestMarshaller
    ...
    public RegisterOnPremisesInstanceRequestMarshaller(
    ...
    public Request<RegisterOnPremisesInstanceRequest> marshall(
        ...
        Request<RegisterOnPremisesInstanceRequest> request = new DefaultRequest<RegisterOnPremisesInstanceRequest>(
