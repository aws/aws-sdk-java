...
/**
 * Revision Location JSON Unmarshaller
 */
public class RevisionLocationJsonUnmarshaller implements Unmarshaller<RevisionLocation, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("revisionType", targetDepth)) {
                    context.nextToken();
                    revisionLocation.setRevisionType(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static RevisionLocationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RevisionLocationJsonUnmarshaller();
        return instance;
    }
}
