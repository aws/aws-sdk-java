 ...
 */
public class DeleteDeploymentConfigResultJsonUnmarshaller implements
        Unmarshaller<DeleteDeploymentConfigResult, JsonUnmarshallerContext> {

    public DeleteDeploymentConfigResult unmarshall(
