...
public class DeploymentConfigLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentConfigLimitExceededExceptionUnmarshaller instance;

    public static DeploymentConfigLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentConfigLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
