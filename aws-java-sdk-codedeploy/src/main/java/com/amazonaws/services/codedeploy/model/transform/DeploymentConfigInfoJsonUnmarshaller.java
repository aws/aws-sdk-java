...
/**
 * Deployment Config Info JSON Unmarshaller
 */
public class DeploymentConfigInfoJsonUnmarshaller implements Unmarshaller<DeploymentConfigInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("deploymentConfigId", targetDepth)) {
                    context.nextToken();
                    deploymentConfigInfo.setDeploymentConfigId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("deploymentConfigName", targetDepth)) {
                    context.nextToken();
                    deploymentConfigInfo.setDeploymentConfigName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("createTime", targetDepth)) {
                    context.nextToken();
                    deploymentConfigInfo.setCreateTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DeploymentConfigInfoJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeploymentConfigInfoJsonUnmarshaller();
        return instance;
    }
}
