...
public class UpdateApplicationRequestMarshaller implements Marshaller<Request<UpdateApplicationRequest>, UpdateApplicationRequest> {
    ...
    public Request<UpdateApplicationRequest> marshall(UpdateApplicationRequest updateApplicationRequest) {
        ...
        Request<UpdateApplicationRequest> request = new DefaultRequest<UpdateApplicationRequest>(updateApplicationRequest, "AmazonCodeDeploy");
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (updateApplicationRequest.getApplicationName() != null) {
                jsonWriter.key("applicationName").value(updateApplicationRequest.getApplicationName());
            }
            if (updateApplicationRequest.getNewApplicationName() != null) {
                jsonWriter.key("newApplicationName").value(updateApplicationRequest.getNewApplicationName());
            }
