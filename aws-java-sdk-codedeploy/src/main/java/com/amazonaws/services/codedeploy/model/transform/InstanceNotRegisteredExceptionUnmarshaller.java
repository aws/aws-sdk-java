...
public class InstanceNotRegisteredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InstanceNotRegisteredExceptionUnmarshaller instance;

    public static InstanceNotRegisteredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InstanceNotRegisteredExceptionUnmarshaller();
        return instance;
    }
}
