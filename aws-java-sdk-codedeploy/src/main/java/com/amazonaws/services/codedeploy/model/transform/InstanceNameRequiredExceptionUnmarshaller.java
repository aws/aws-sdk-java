...
public class InstanceNameRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InstanceNameRequiredExceptionUnmarshaller instance;

    public static InstanceNameRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InstanceNameRequiredExceptionUnmarshaller();
        return instance;
    }
}
