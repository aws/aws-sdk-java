...
public class InvalidTargetGroupPairExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTargetGroupPairExceptionUnmarshaller instance;

    public static InvalidTargetGroupPairExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTargetGroupPairExceptionUnmarshaller();
        return instance;
    }
}
