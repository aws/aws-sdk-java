...
/**
 * Create Deployment Group Result JSON Unmarshaller
 */
public class CreateDeploymentGroupResultJsonUnmarshaller implements Unmarshaller<CreateDeploymentGroupResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("deploymentGroupId", targetDepth)) {
                    context.nextToken();
                    createDeploymentGroupResult.setDeploymentGroupId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CreateDeploymentGroupResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreateDeploymentGroupResultJsonUnmarshaller();
        return instance;
    }
}
