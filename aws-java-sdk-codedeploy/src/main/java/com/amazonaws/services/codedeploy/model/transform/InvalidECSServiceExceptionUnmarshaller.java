...
public class InvalidECSServiceExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidECSServiceExceptionUnmarshaller instance;

    public static InvalidECSServiceExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidECSServiceExceptionUnmarshaller();
        return instance;
    }
}
