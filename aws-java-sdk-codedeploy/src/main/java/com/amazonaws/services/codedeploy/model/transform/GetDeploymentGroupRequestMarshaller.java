...
/**
 * Get Deployment Group Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (getDeploymentGroupRequest.getApplicationName() != null) {
                jsonWriter.key("applicationName").value(getDeploymentGroupRequest.getApplicationName());
            }
            if (getDeploymentGroupRequest.getDeploymentGroupName() != null) {
                jsonWriter.key("deploymentGroupName").value(getDeploymentGroupRequest.getDeploymentGroupName());
            }
