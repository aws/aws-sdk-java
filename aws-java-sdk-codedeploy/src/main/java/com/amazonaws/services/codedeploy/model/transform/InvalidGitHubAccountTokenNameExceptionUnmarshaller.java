...
public class InvalidGitHubAccountTokenNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidGitHubAccountTokenNameExceptionUnmarshaller instance;

    public static InvalidGitHubAccountTokenNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidGitHubAccountTokenNameExceptionUnmarshaller();
        return instance;
    }
}
