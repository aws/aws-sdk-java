...
/**
 * Get Deployment Result JSON Unmarshaller
 */
public class GetDeploymentResultJsonUnmarshaller implements Unmarshaller<GetDeploymentResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("deploymentInfo", targetDepth)) {
                    context.nextToken();
                    getDeploymentResult.setDeploymentInfo(DeploymentInfoJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static GetDeploymentResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetDeploymentResultJsonUnmarshaller();
        return instance;
    }
}
