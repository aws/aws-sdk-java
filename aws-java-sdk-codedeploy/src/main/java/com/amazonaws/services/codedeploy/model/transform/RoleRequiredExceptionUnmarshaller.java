...
public class RoleRequiredExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("RoleRequiredException"));
        } else {
            return errorTypeFromHeader.equals("RoleRequiredException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        RoleRequiredException e = (RoleRequiredException)super.unmarshall(json);
