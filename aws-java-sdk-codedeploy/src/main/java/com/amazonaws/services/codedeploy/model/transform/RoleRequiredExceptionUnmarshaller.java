...
public class RoleRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RoleRequiredExceptionUnmarshaller instance;

    public static RoleRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RoleRequiredExceptionUnmarshaller();
        return instance;
    }
}
