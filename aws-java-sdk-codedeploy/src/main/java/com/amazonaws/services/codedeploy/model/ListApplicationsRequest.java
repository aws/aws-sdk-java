...
public class ListApplicationsRequest extends AmazonWebServiceRequest implements Serializable {
     ...
     * list.
     *
     * @return An identifier that was returned from the previous list applications
     *         call, which can be used to return the next set of applications in the
     *         list.
     */
     ...
     * list.
     *
     * @param nextToken An identifier that was returned from the previous list applications
     *         call, which can be used to return the next set of applications in the
     *         list.
     */
