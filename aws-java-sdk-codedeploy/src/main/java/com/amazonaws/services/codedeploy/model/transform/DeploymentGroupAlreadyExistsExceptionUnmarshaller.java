...
public class DeploymentGroupAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentGroupAlreadyExistsExceptionUnmarshaller instance;

    public static DeploymentGroupAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentGroupAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
