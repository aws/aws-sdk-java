...
public class DeploymentConfigInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentConfigInUseExceptionUnmarshaller instance;

    public static DeploymentConfigInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentConfigInUseExceptionUnmarshaller();
        return instance;
    }
}
