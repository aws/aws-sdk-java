...
public class LifecycleEventJsonMarshaller {
     ...
     */
    public void marshall(LifecycleEvent lifecycleEvent,
        ...
        try {
            ...
            if (lifecycleEvent.getLifecycleEventName() != null) {
                jsonGenerator.writeFieldName("lifecycleEventName").writeValue(
