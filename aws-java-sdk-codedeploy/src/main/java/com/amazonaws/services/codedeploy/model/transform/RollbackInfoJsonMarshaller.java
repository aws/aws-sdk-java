...
public class RollbackInfoJsonMarshaller {
     ...
     */
    public void marshall(RollbackInfo rollbackInfo,
        ...
        try {
            ...
            if (rollbackInfo.getRollbackDeploymentId() != null) {
                jsonGenerator.writeFieldName("rollbackDeploymentId")
                        .writeValue(rollbackInfo.getRollbackDeploymentId());
            }
            if (rollbackInfo.getRollbackTriggeringDeploymentId() != null) {
                jsonGenerator.writeFieldName("rollbackTriggeringDeploymentId")
                        .writeValue(
                                rollbackInfo
                                        .getRollbackTriggeringDeploymentId());
            }
            if (rollbackInfo.getRollbackMessage() != null) {
                jsonGenerator.writeFieldName("rollbackMessage").writeValue(
                        rollbackInfo.getRollbackMessage());
            }
