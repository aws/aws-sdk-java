...
public class InvalidSortByExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSortByExceptionUnmarshaller instance;

    public static InvalidSortByExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSortByExceptionUnmarshaller();
        return instance;
    }
}
