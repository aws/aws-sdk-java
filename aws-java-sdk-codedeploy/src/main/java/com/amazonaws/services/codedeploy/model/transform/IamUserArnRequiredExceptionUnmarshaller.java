...
public class IamUserArnRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static IamUserArnRequiredExceptionUnmarshaller instance;

    public static IamUserArnRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IamUserArnRequiredExceptionUnmarshaller();
        return instance;
    }
}
