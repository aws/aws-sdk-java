 ...
 */
public class AutoScalingGroupJsonUnmarshaller implements
        Unmarshaller<AutoScalingGroup, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    autoScalingGroup.setName(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("hook", targetDepth)) {
                    context.nextToken();
                    autoScalingGroup.setHook(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
    ...
    public static AutoScalingGroupJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AutoScalingGroupJsonUnmarshaller();
        return instance;
    }
}
