...
public class InvalidDeploymentWaitTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDeploymentWaitTypeExceptionUnmarshaller instance;

    public static InvalidDeploymentWaitTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDeploymentWaitTypeExceptionUnmarshaller();
        return instance;
    }
}
