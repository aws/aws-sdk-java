...
public class UnsupportedActionForDeploymentTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedActionForDeploymentTypeExceptionUnmarshaller instance;

    public static UnsupportedActionForDeploymentTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedActionForDeploymentTypeExceptionUnmarshaller();
        return instance;
    }
}
