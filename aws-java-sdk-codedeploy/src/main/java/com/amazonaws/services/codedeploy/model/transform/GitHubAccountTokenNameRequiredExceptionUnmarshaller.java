...
public class GitHubAccountTokenNameRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static GitHubAccountTokenNameRequiredExceptionUnmarshaller instance;

    public static GitHubAccountTokenNameRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new GitHubAccountTokenNameRequiredExceptionUnmarshaller();
        return instance;
    }
}
