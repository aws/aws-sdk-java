...
public class InvalidUpdateOutdatedInstancesOnlyValueExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidUpdateOutdatedInstancesOnlyValueExceptionUnmarshaller instance;

    public static InvalidUpdateOutdatedInstancesOnlyValueExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidUpdateOutdatedInstancesOnlyValueExceptionUnmarshaller();
        return instance;
    }
}
