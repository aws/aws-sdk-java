...
/**
 * Instance Info JSON Unmarshaller
 */
public class InstanceInfoJsonUnmarshaller implements Unmarshaller<InstanceInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("instanceName", targetDepth)) {
                    context.nextToken();
                    instanceInfo.setInstanceName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("iamUserArn", targetDepth)) {
                    context.nextToken();
                    instanceInfo.setIamUserArn(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("instanceArn", targetDepth)) {
                    context.nextToken();
                    instanceInfo.setInstanceArn(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("registerTime", targetDepth)) {
                    context.nextToken();
                    instanceInfo.setRegisterTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("deregisterTime", targetDepth)) {
                    context.nextToken();
                    instanceInfo.setDeregisterTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static InstanceInfoJsonUnmarshaller getInstance() {
        if (instance == null) instance = new InstanceInfoJsonUnmarshaller();
        return instance;
    }
}
