...
public class DeploymentDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentDoesNotExistExceptionUnmarshaller instance;

    public static DeploymentDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
