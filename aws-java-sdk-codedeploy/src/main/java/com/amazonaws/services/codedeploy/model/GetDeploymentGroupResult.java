 ...
 * </p>
 */
public class GetDeploymentGroupResult implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getDeploymentGroupInfo() != null) sb.append("DeploymentGroupInfo: " + getDeploymentGroupInfo() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDeploymentGroupResult == false) return false;
        GetDeploymentGroupResult other = (GetDeploymentGroupResult)obj;
        
        if (other.getDeploymentGroupInfo() == null ^ this.getDeploymentGroupInfo() == null) return false;
        if (other.getDeploymentGroupInfo() != null && other.getDeploymentGroupInfo().equals(this.getDeploymentGroupInfo()) == false) return false; 
        return true;
    }
