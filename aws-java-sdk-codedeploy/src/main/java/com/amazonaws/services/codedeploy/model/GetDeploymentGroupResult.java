...
public class GetDeploymentGroupResult implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDeploymentGroupInfo() == null
                ^ this.getDeploymentGroupInfo() == null)
            return false;
        if (other.getDeploymentGroupInfo() != null
                && other.getDeploymentGroupInfo().equals(
                        this.getDeploymentGroupInfo()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getDeploymentGroupInfo() == null) ? 0
                        : getDeploymentGroupInfo().hashCode());
        return hashCode;
    }
