...
public class ReturnSavingsPlanResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getSavingsPlanId() != null)
            sb.append("SavingsPlanId: ").append(getSavingsPlanId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReturnSavingsPlanResult == false)
            return false;
        ReturnSavingsPlanResult other = (ReturnSavingsPlanResult) obj;
    ...
    public ReturnSavingsPlanResult clone() {
        try {
            return (ReturnSavingsPlanResult) super.clone();
