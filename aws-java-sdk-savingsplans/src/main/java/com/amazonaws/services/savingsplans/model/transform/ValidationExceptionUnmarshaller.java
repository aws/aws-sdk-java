...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.savingsplans.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.savingsplans.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.savingsplans.model.ValidationException validationException = new com.amazonaws.services.savingsplans.model.ValidationException(
                null);
