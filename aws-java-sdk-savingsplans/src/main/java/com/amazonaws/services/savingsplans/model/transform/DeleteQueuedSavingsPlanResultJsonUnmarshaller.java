...
/**
 * DeleteQueuedSavingsPlanResult JSON Unmarshaller
 */
...
public class DeleteQueuedSavingsPlanResultJsonUnmarshaller implements Unmarshaller<DeleteQueuedSavingsPlanResult, JsonUnmarshallerContext> {
    ...
    public DeleteQueuedSavingsPlanResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteQueuedSavingsPlanResult deleteQueuedSavingsPlanResult = new DeleteQueuedSavingsPlanResult();

        return deleteQueuedSavingsPlanResult;
    }
