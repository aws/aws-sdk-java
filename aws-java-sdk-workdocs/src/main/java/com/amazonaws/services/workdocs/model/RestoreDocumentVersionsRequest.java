...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/workdocs-2016-05-01/RestoreDocumentVersions" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RestoreDocumentVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public RestoreDocumentVersionsRequest withAuthenticationToken(String authenticationToken) {
    ...
    public RestoreDocumentVersionsRequest withDocumentId(String documentId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RestoreDocumentVersionsRequest == false)
            return false;
        RestoreDocumentVersionsRequest other = (RestoreDocumentVersionsRequest) obj;
    ...
    @Override
    public RestoreDocumentVersionsRequest clone() {
        return (RestoreDocumentVersionsRequest) super.clone();
    }
