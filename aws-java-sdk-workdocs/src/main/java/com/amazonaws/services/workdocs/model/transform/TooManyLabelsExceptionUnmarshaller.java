...
public class TooManyLabelsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TooManyLabelsExceptionUnmarshaller instance;

    public static TooManyLabelsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TooManyLabelsExceptionUnmarshaller();
        return instance;
    }
}
