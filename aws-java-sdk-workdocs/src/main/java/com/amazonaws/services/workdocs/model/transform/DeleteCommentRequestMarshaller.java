...
public class DeleteCommentRequestMarshaller {
    ...
    private static final MarshallingInfo<String> COMMENTID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PATH)
            .marshallLocationName("CommentId").build();

    private static final DeleteCommentRequestMarshaller instance = new DeleteCommentRequestMarshaller();

    public static DeleteCommentRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DeleteCommentRequest deleteCommentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteCommentRequest.getAuthenticationToken(), AUTHENTICATIONTOKEN_BINDING);
            protocolMarshaller.marshall(deleteCommentRequest.getDocumentId(), DOCUMENTID_BINDING);
            protocolMarshaller.marshall(deleteCommentRequest.getVersionId(), VERSIONID_BINDING);
            protocolMarshaller.marshall(deleteCommentRequest.getCommentId(), COMMENTID_BINDING);
        } catch (Exception e) {
