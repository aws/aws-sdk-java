...
public class InvalidCommentOperationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidCommentOperationExceptionUnmarshaller instance;

    public static InvalidCommentOperationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidCommentOperationExceptionUnmarshaller();
        return instance;
    }
}
