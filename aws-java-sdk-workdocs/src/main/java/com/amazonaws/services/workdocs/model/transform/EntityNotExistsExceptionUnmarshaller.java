...
public class EntityNotExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EntityNotExistsExceptionUnmarshaller instance;

    public static EntityNotExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EntityNotExistsExceptionUnmarshaller();
        return instance;
    }
}
