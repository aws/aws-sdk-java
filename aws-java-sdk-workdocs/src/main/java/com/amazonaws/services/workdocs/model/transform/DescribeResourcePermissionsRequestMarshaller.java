...
/**
 * DescribeResourcePermissionsRequestMarshaller
 */
...
public class DescribeResourcePermissionsRequestMarshaller {
    ...
    private static final DescribeResourcePermissionsRequestMarshaller instance = new DescribeResourcePermissionsRequestMarshaller();

    public static DescribeResourcePermissionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeResourcePermissionsRequest describeResourcePermissionsRequest, ProtocolMarshaller protocolMarshaller) {
