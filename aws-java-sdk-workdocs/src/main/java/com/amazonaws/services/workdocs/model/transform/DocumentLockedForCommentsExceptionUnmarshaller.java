...
public class DocumentLockedForCommentsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DocumentLockedForCommentsExceptionUnmarshaller instance;

    public static DocumentLockedForCommentsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DocumentLockedForCommentsExceptionUnmarshaller();
        return instance;
    }
}
