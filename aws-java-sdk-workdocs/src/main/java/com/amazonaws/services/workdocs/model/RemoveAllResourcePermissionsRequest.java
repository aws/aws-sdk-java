...
public class RemoveAllResourcePermissionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public RemoveAllResourcePermissionsRequest withAuthenticationToken(String authenticationToken) {
    ...
    public RemoveAllResourcePermissionsRequest withResourceId(String resourceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RemoveAllResourcePermissionsRequest == false)
            return false;
        RemoveAllResourcePermissionsRequest other = (RemoveAllResourcePermissionsRequest) obj;
    ...
    @Override
    public RemoveAllResourcePermissionsRequest clone() {
