...
/**
 * RestoreDocumentVersionsResult JSON Unmarshaller
 */
...
public class RestoreDocumentVersionsResultJsonUnmarshaller implements Unmarshaller<RestoreDocumentVersionsResult, JsonUnmarshallerContext> {
    ...
    public RestoreDocumentVersionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RestoreDocumentVersionsResult restoreDocumentVersionsResult = new RestoreDocumentVersionsResult();

        return restoreDocumentVersionsResult;
    }
