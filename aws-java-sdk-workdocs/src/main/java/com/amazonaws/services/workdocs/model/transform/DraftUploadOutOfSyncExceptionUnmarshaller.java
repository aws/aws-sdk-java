...
public class DraftUploadOutOfSyncExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DraftUploadOutOfSyncExceptionUnmarshaller instance;

    public static DraftUploadOutOfSyncExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DraftUploadOutOfSyncExceptionUnmarshaller();
        return instance;
    }
}
