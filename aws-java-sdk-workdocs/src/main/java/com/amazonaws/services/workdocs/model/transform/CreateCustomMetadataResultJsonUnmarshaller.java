...
/**
 * CreateCustomMetadataResult JSON Unmarshaller
 */
...
public class CreateCustomMetadataResultJsonUnmarshaller implements Unmarshaller<CreateCustomMetadataResult, JsonUnmarshallerContext> {
    ...
    public CreateCustomMetadataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateCustomMetadataResult createCustomMetadataResult = new CreateCustomMetadataResult();
