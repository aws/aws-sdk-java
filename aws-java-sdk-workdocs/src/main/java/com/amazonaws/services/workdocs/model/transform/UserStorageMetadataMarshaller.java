...
/**
 * UserStorageMetadataMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UserStorageMetadataMarshaller {

    private static final MarshallingInfo<Long> STORAGEUTILIZEDINBYTES_BINDING = MarshallingInfo.builder(MarshallingType.LONG)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("StorageUtilizedInBytes").build();
    ...
    public void marshall(UserStorageMetadata userStorageMetadata, ProtocolMarshaller protocolMarshaller) {
        ...
        if (userStorageMetadata == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(userStorageMetadata.getStorageUtilizedInBytes(), STORAGEUTILIZEDINBYTES_BINDING);
            protocolMarshaller.marshall(userStorageMetadata.getStorageRule(), STORAGERULE_BINDING);
        } catch (Exception e) {
