...
/**
 * DeleteCustomMetadataResult JSON Unmarshaller
 */
...
public class DeleteCustomMetadataResultJsonUnmarshaller implements Unmarshaller<DeleteCustomMetadataResult, JsonUnmarshallerContext> {
    ...
    public DeleteCustomMetadataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCustomMetadataResult deleteCustomMetadataResult = new DeleteCustomMetadataResult();
