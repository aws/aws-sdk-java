...
public class InvalidArgumentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidArgumentExceptionUnmarshaller() {
        super(com.amazonaws.services.workdocs.model.InvalidArgumentException.class, "InvalidArgumentException");
    }

    @Override
    public com.amazonaws.services.workdocs.model.InvalidArgumentException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
