...
public class ResourceAlreadyCheckedOutExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceAlreadyCheckedOutExceptionUnmarshaller instance;

    public static ResourceAlreadyCheckedOutExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceAlreadyCheckedOutExceptionUnmarshaller();
        return instance;
    }
}
