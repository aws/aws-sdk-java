...
public class GetResourcesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetResourcesResult withFolders(FolderMetadata... folders) {
    ...
    public GetResourcesResult withFolders(java.util.Collection<FolderMetadata> folders) {
        setFolders(folders);
        return this;
    }
    ...
    public GetResourcesResult withDocuments(DocumentMetadata... documents) {
    ...
    public GetResourcesResult withDocuments(java.util.Collection<DocumentMetadata> documents) {
