...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/amplifybackend-2020-08-11/CreateBackend" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateBackendResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateBackendResult withAppId(String appId) {
        setAppId(appId);
        return this;
    }
    ...
    public CreateBackendResult withBackendEnvironmentName(String backendEnvironmentName) {
    ...
    public CreateBackendResult withError(String error) {
        setError(error);
        return this;
    }
    ...
    public CreateBackendResult withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
    ...
    public CreateBackendResult withOperation(String operation) {
    ...
    public CreateBackendResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBackendResult == false)
            return false;
        CreateBackendResult other = (CreateBackendResult) obj;
    ...
    @Override
    public CreateBackendResult clone() {
        try {
            return (CreateBackendResult) super.clone();
