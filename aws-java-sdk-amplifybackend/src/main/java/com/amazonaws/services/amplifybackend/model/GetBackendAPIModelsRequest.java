...
public class GetBackendAPIModelsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetBackendAPIModelsRequest withResourceName(String resourceName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetBackendAPIModelsRequest == false)
            return false;
        GetBackendAPIModelsRequest other = (GetBackendAPIModelsRequest) obj;
    ...
    @Override
    public GetBackendAPIModelsRequest clone() {
        return (GetBackendAPIModelsRequest) super.clone();
    }
