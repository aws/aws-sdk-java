...
public class SettingsMarshaller {
    ...
    private static final MarshallingInfo<List> MFATYPES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("mfaTypes").build();
    ...
    public void marshall(Settings settings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(settings.getMfaTypes(), MFATYPES_BINDING);
            protocolMarshaller.marshall(settings.getSmsMessage(), SMSMESSAGE_BINDING);
        } catch (Exception e) {
