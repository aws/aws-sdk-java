...
public class ImportBackendAuthResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ImportBackendAuthResult withAppId(String appId) {
        setAppId(appId);
        return this;
    }
    ...
    public ImportBackendAuthResult withBackendEnvironmentName(String backendEnvironmentName) {
    ...
    public ImportBackendAuthResult withError(String error) {
        setError(error);
        return this;
    }
    ...
    public ImportBackendAuthResult withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
    ...
    public ImportBackendAuthResult withOperation(String operation) {
    ...
    public ImportBackendAuthResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportBackendAuthResult == false)
            return false;
        ImportBackendAuthResult other = (ImportBackendAuthResult) obj;
    ...
    @Override
    public ImportBackendAuthResult clone() {
        try {
            return (ImportBackendAuthResult) super.clone();
