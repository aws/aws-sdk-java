...
public class GetBackendStorageRequestMarshaller {
    ...
    private static final GetBackendStorageRequestMarshaller instance = new GetBackendStorageRequestMarshaller();

    public static GetBackendStorageRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetBackendStorageRequest getBackendStorageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getBackendStorageRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(getBackendStorageRequest.getBackendEnvironmentName(), BACKENDENVIRONMENTNAME_BINDING);
            protocolMarshaller.marshall(getBackendStorageRequest.getResourceName(), RESOURCENAME_BINDING);
        } catch (Exception e) {
