...
public class ImportBackendStorageRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ImportBackendStorageRequest withServiceName(String serviceName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportBackendStorageRequest == false)
            return false;
        ImportBackendStorageRequest other = (ImportBackendStorageRequest) obj;
    ...
    @Override
    public ImportBackendStorageRequest clone() {
        return (ImportBackendStorageRequest) super.clone();
    }
