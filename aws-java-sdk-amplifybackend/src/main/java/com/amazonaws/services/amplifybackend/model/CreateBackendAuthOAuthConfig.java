...
public class CreateBackendAuthOAuthConfig implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The OAuth grant type which you use to allow app users to authenticate from your Amplify app.
     * @see OAuthGrantType
     */
     ...
     * </p>
     * 
     * @return List of OAuth related flows which use to allow your app users to authenticate from your Amplify app.
     ...
     * </p>
     * 
     * @return The redirected URI for sigining into your Amplify app.
     */
     ...
     * </p>
     * 
     * @return The settings for using the social providers for access to your Amplify app.
     */
