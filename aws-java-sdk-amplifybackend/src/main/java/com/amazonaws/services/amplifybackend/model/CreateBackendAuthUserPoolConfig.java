...
public class CreateBackendAuthUserPoolConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * Describes the sign-in methods that your Amplify app users to login using the Amazon Cognito user pool, configured
     ...
     * 
     * @param signInMethod
     *        Describes the sign-in methods that your Amplify app users to login using the Amazon Cognito user pool,
     *        configured as a part of your Amplify project.
     * @see SignInMethod
     */
     ...
     * </p>
     * 
     * @return Describes the sign-in methods that your Amplify app users to login using the Amazon Cognito user pool,
     *         configured as a part of your Amplify project.
     * @see SignInMethod
     */
