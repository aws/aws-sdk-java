...
@SdkInternalApi
public class UpdateBackendAuthRequestMarshaller {
    ...
    private static final UpdateBackendAuthRequestMarshaller instance = new UpdateBackendAuthRequestMarshaller();

    public static UpdateBackendAuthRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateBackendAuthRequest updateBackendAuthRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateBackendAuthRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(updateBackendAuthRequest.getBackendEnvironmentName(), BACKENDENVIRONMENTNAME_BINDING);
            protocolMarshaller.marshall(updateBackendAuthRequest.getResourceConfig(), RESOURCECONFIG_BINDING);
            protocolMarshaller.marshall(updateBackendAuthRequest.getResourceName(), RESOURCENAME_BINDING);
        } catch (Exception e) {
