...
public class CreateBackendStorageRequestMarshaller {
    ...
    private static final CreateBackendStorageRequestMarshaller instance = new CreateBackendStorageRequestMarshaller();

    public static CreateBackendStorageRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateBackendStorageRequest createBackendStorageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createBackendStorageRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(createBackendStorageRequest.getBackendEnvironmentName(), BACKENDENVIRONMENTNAME_BINDING);
            protocolMarshaller.marshall(createBackendStorageRequest.getResourceConfig(), RESOURCECONFIG_BINDING);
            protocolMarshaller.marshall(createBackendStorageRequest.getResourceName(), RESOURCENAME_BINDING);
        } catch (Exception e) {
