...
/**
 * LoginAuthConfigReqObj JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LoginAuthConfigReqObjJsonUnmarshaller implements Unmarshaller<LoginAuthConfigReqObj, JsonUnmarshallerContext> {

    public LoginAuthConfigReqObj unmarshall(JsonUnmarshallerContext context) throws Exception {
        LoginAuthConfigReqObj loginAuthConfigReqObj = new LoginAuthConfigReqObj();
    ...
    private static LoginAuthConfigReqObjJsonUnmarshaller instance;

    public static LoginAuthConfigReqObjJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LoginAuthConfigReqObjJsonUnmarshaller();
        return instance;
    }
}
