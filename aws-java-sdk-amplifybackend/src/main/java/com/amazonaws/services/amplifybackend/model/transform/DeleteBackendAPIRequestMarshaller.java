...
/**
 * DeleteBackendAPIRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteBackendAPIRequestMarshaller {
    ...
    private static final DeleteBackendAPIRequestMarshaller instance = new DeleteBackendAPIRequestMarshaller();

    public static DeleteBackendAPIRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteBackendAPIRequest deleteBackendAPIRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteBackendAPIRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(deleteBackendAPIRequest.getBackendEnvironmentName(), BACKENDENVIRONMENTNAME_BINDING);
            protocolMarshaller.marshall(deleteBackendAPIRequest.getResourceConfig(), RESOURCECONFIG_BINDING);
            protocolMarshaller.marshall(deleteBackendAPIRequest.getResourceName(), RESOURCENAME_BINDING);
        } catch (Exception e) {
