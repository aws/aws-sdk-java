...
/**
 * CreateBackendAuthOAuthConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateBackendAuthOAuthConfigMarshaller {
    ...
    private static final CreateBackendAuthOAuthConfigMarshaller instance = new CreateBackendAuthOAuthConfigMarshaller();

    public static CreateBackendAuthOAuthConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateBackendAuthOAuthConfig createBackendAuthOAuthConfig, ProtocolMarshaller protocolMarshaller) {

        if (createBackendAuthOAuthConfig == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createBackendAuthOAuthConfig.getDomainPrefix(), DOMAINPREFIX_BINDING);
            protocolMarshaller.marshall(createBackendAuthOAuthConfig.getOAuthGrantType(), OAUTHGRANTTYPE_BINDING);
            protocolMarshaller.marshall(createBackendAuthOAuthConfig.getOAuthScopes(), OAUTHSCOPES_BINDING);
            protocolMarshaller.marshall(createBackendAuthOAuthConfig.getRedirectSignInURIs(), REDIRECTSIGNINURIS_BINDING);
            protocolMarshaller.marshall(createBackendAuthOAuthConfig.getRedirectSignOutURIs(), REDIRECTSIGNOUTURIS_BINDING);
            protocolMarshaller.marshall(createBackendAuthOAuthConfig.getSocialProviderSettings(), SOCIALPROVIDERSETTINGS_BINDING);
        } catch (Exception e) {
