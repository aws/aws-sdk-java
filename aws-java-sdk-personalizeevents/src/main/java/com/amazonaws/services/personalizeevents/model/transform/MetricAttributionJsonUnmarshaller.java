    ...
    public MetricAttribution unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("eventAttributionSource", targetDepth)) {
                    context.nextToken();
                    metricAttribution.setEventAttributionSource(context.getUnmarshaller(String.class).unmarshall(context));
                }
