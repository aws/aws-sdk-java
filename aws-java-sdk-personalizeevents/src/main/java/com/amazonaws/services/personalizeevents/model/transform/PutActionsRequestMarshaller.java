...
/**
 * PutActionsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutActionsRequestMarshaller {
    ...
    private static final PutActionsRequestMarshaller instance = new PutActionsRequestMarshaller();

    public static PutActionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutActionsRequest putActionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putActionsRequest.getDatasetArn(), DATASETARN_BINDING);
            protocolMarshaller.marshall(putActionsRequest.getActions(), ACTIONS_BINDING);
        } catch (Exception e) {
