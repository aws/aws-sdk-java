...
/**
 * PutItemsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutItemsRequestMarshaller {
    ...
    private static final PutItemsRequestMarshaller instance = new PutItemsRequestMarshaller();

    public static PutItemsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutItemsRequest putItemsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putItemsRequest.getDatasetArn(), DATASETARN_BINDING);
            protocolMarshaller.marshall(putItemsRequest.getItems(), ITEMS_BINDING);
        } catch (Exception e) {
