...
/**
 * PutUsersRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutUsersRequestMarshaller {
    ...
    private static final PutUsersRequestMarshaller instance = new PutUsersRequestMarshaller();

    public static PutUsersRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutUsersRequest putUsersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putUsersRequest.getDatasetArn(), DATASETARN_BINDING);
            protocolMarshaller.marshall(putUsersRequest.getUsers(), USERS_BINDING);
        } catch (Exception e) {
