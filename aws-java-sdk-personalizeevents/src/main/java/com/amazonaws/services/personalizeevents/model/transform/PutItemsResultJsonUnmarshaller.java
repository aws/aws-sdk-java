...
/**
 * PutItemsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PutItemsResultJsonUnmarshaller implements Unmarshaller<PutItemsResult, JsonUnmarshallerContext> {

    public PutItemsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutItemsResult putItemsResult = new PutItemsResult();
