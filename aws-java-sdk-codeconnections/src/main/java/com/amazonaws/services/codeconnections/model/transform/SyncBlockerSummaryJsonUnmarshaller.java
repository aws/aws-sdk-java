...
/**
 * SyncBlockerSummary JSON Unmarshaller
 */
...
public class SyncBlockerSummaryJsonUnmarshaller implements Unmarshaller<SyncBlockerSummary, JsonUnmarshallerContext> {
    ...
    public SyncBlockerSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceName", targetDepth)) {
                    context.nextToken();
                    syncBlockerSummary.setResourceName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ParentResourceName", targetDepth)) {
                    context.nextToken();
                    syncBlockerSummary.setParentResourceName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("LatestBlockers", targetDepth)) {
                    context.nextToken();
                    syncBlockerSummary.setLatestBlockers(new ListUnmarshaller<SyncBlocker>(SyncBlockerJsonUnmarshaller.getInstance())
