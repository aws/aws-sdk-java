...
/**
 * ListRepositorySyncDefinitionsResult JSON Unmarshaller
 */
...
public class ListRepositorySyncDefinitionsResultJsonUnmarshaller implements Unmarshaller<ListRepositorySyncDefinitionsResult, JsonUnmarshallerContext> {
    ...
    public ListRepositorySyncDefinitionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RepositorySyncDefinitions", targetDepth)) {
                    context.nextToken();
                    listRepositorySyncDefinitionsResult.setRepositorySyncDefinitions(new ListUnmarshaller<RepositorySyncDefinition>(
                            RepositorySyncDefinitionJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listRepositorySyncDefinitionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
