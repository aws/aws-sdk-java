...
/**
 * SyncBlocker JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SyncBlockerJsonUnmarshaller implements Unmarshaller<SyncBlocker, JsonUnmarshallerContext> {

    public SyncBlocker unmarshall(JsonUnmarshallerContext context) throws Exception {
        SyncBlocker syncBlocker = new SyncBlocker();
    ...
    private static SyncBlockerJsonUnmarshaller instance;

    public static SyncBlockerJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SyncBlockerJsonUnmarshaller();
        return instance;
    }
}
