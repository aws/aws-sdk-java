...
public class UnsupportedOperationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UnsupportedOperationExceptionUnmarshaller() {
        super(com.amazonaws.services.codeconnections.model.UnsupportedOperationException.class, "UnsupportedOperationException");
    }

    @Override
    public com.amazonaws.services.codeconnections.model.UnsupportedOperationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeconnections.model.UnsupportedOperationException unsupportedOperationException = new com.amazonaws.services.codeconnections.model.UnsupportedOperationException(
                null);
