...
/**
 * UpdateHostResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateHostResultJsonUnmarshaller implements Unmarshaller<UpdateHostResult, JsonUnmarshallerContext> {

    public UpdateHostResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateHostResult updateHostResult = new UpdateHostResult();
