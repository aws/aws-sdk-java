...
public class VpcConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> TLSCERTIFICATE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("TlsCertificate").build();
    ...
    public void marshall(VpcConfiguration vpcConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(vpcConfiguration.getTlsCertificate(), TLSCERTIFICATE_BINDING);
        } catch (Exception e) {
