...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.codeconnections.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.codeconnections.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeconnections.model.LimitExceededException limitExceededException = new com.amazonaws.services.codeconnections.model.LimitExceededException(
                null);
