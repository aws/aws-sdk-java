...
public class InvalidInputExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidInputExceptionUnmarshaller() {
        super(com.amazonaws.services.codeconnections.model.InvalidInputException.class, "InvalidInputException");
    }

    @Override
    public com.amazonaws.services.codeconnections.model.InvalidInputException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeconnections.model.InvalidInputException invalidInputException = new com.amazonaws.services.codeconnections.model.InvalidInputException(
                null);
