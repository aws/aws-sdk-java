...
/**
 * UpdateDatabaseResult JSON Unmarshaller
 */
...
public class UpdateDatabaseResultJsonUnmarshaller implements Unmarshaller<UpdateDatabaseResult, JsonUnmarshallerContext> {
    ...
    public UpdateDatabaseResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDatabaseResult updateDatabaseResult = new UpdateDatabaseResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Database", targetDepth)) {
                    context.nextToken();
                    updateDatabaseResult.setDatabase(DatabaseJsonUnmarshaller.getInstance().unmarshall(context));
                }
