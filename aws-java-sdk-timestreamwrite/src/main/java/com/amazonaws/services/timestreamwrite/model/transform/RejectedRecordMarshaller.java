...
/**
 * RejectedRecordMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RejectedRecordMarshaller {

    private static final MarshallingInfo<Integer> RECORDINDEX_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
    ...
    public static RejectedRecordMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RejectedRecord rejectedRecord, ProtocolMarshaller protocolMarshaller) {
