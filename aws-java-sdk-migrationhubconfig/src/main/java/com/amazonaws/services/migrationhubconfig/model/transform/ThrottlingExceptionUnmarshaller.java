...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhubconfig.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.migrationhubconfig.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhubconfig.model.ThrottlingException throttlingException = new com.amazonaws.services.migrationhubconfig.model.ThrottlingException(
                null);
