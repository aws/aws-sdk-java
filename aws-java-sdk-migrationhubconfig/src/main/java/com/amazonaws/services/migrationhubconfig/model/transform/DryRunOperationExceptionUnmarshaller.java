...
public class DryRunOperationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private DryRunOperationExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhubconfig.model.DryRunOperationException.class, "DryRunOperation");
    }

    @Override
    public com.amazonaws.services.migrationhubconfig.model.DryRunOperationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhubconfig.model.DryRunOperationException dryRunOperationException = new com.amazonaws.services.migrationhubconfig.model.DryRunOperationException(
                null);
