 ...
 */
public class ListKeyPoliciesRequestMarshaller implements
        Marshaller<Request<ListKeyPoliciesRequest>, ListKeyPoliciesRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public ListKeyPoliciesRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<ListKeyPoliciesRequest> marshall(
        ...
        Request<ListKeyPoliciesRequest> request = new DefaultRequest<ListKeyPoliciesRequest>(
                listKeyPoliciesRequest, "AWSKMS");
