...
/**
 * Cancel Key Deletion Result JSON Unmarshaller
 */
public class CancelKeyDeletionResultJsonUnmarshaller implements Unmarshaller<CancelKeyDeletionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("KeyId", targetDepth)) {
                    context.nextToken();
                    cancelKeyDeletionResult.setKeyId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CancelKeyDeletionResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CancelKeyDeletionResultJsonUnmarshaller();
        return instance;
    }
}
