...
/**
 * Fluent builder for {@link com.amazonaws.services.kms.AWSKMS}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AWSKMSClientBuilder extends
        AwsSyncClientBuilder<AWSKMSClientBuilder, AWSKMS> {
    ...
    /**
     * Construct a synchronous implementation of AWSKMS using the current
