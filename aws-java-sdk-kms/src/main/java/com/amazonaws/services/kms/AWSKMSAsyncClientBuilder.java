...
/**
 * Fluent builder for {@link com.amazonaws.services.kms.AWSKMSAsync}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AWSKMSAsyncClientBuilder extends
        AwsAsyncClientBuilder<AWSKMSAsyncClientBuilder, AWSKMSAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSKMSAsync using the current
