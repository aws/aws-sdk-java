...
public class KMSInvalidSignatureExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private KMSInvalidSignatureExceptionUnmarshaller() {
        super(com.amazonaws.services.kms.model.KMSInvalidSignatureException.class, "KMSInvalidSignatureException");
    }

    @Override
    public com.amazonaws.services.kms.model.KMSInvalidSignatureException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.kms.model.KMSInvalidSignatureException kMSInvalidSignatureException = new com.amazonaws.services.kms.model.KMSInvalidSignatureException(
                null);
