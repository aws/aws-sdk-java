...
/**
 * Generate Data Key Result JSON Unmarshaller
 */
public class GenerateDataKeyResultJsonUnmarshaller implements Unmarshaller<GenerateDataKeyResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CiphertextBlob", targetDepth)) {
                    context.nextToken();
                    generateDataKeyResult.setCiphertextBlob(ByteBufferJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Plaintext", targetDepth)) {
                    context.nextToken();
                    generateDataKeyResult.setPlaintext(ByteBufferJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("KeyId", targetDepth)) {
                    context.nextToken();
                    generateDataKeyResult.setKeyId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static GenerateDataKeyResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GenerateDataKeyResultJsonUnmarshaller();
        return instance;
    }
}
