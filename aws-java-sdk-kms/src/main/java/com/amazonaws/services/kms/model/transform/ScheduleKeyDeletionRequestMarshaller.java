...
/**
 * Schedule Key Deletion Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (scheduleKeyDeletionRequest.getKeyId() != null) {
                jsonWriter.key("KeyId").value(scheduleKeyDeletionRequest.getKeyId());
            }
            if (scheduleKeyDeletionRequest.getPendingWindowInDays() != null) {
                jsonWriter.key("PendingWindowInDays").value(scheduleKeyDeletionRequest.getPendingWindowInDays());
            }
