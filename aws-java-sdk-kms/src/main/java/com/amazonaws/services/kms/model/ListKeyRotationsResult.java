...
public class ListKeyRotationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<RotationsListEntry> rotations;
    /**
     * <p>
    ...
    public java.util.List<RotationsListEntry> getRotations() {
        if (rotations == null) {
            rotations = new com.amazonaws.internal.SdkInternalList<RotationsListEntry>();
        }
        return rotations;
    }
    ...
    public void setRotations(java.util.Collection<RotationsListEntry> rotations) {
        ...
        this.rotations = new com.amazonaws.internal.SdkInternalList<RotationsListEntry>(rotations);
    }
    ...
    public ListKeyRotationsResult withRotations(RotationsListEntry... rotations) {
        if (this.rotations == null) {
            setRotations(new com.amazonaws.internal.SdkInternalList<RotationsListEntry>(rotations.length));
        }
    ...
    public String toString() {
        ...
        if (getRotations() != null)
            sb.append("Rotations: ").append(getRotations()).append(",");
