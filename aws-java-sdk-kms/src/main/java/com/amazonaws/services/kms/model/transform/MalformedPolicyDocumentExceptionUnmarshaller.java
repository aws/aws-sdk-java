...
public class MalformedPolicyDocumentExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("MalformedPolicyDocumentException"));
        } else {
            return errorTypeFromHeader.equals("MalformedPolicyDocumentException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        MalformedPolicyDocumentException e = (MalformedPolicyDocumentException)super.unmarshall(json);
