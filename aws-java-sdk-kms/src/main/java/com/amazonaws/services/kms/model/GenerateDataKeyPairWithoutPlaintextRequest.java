...
public class GenerateDataKeyPairWithoutPlaintextRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *
     * @see GenerateDataKeyPairWithoutPlaintextRequest#withEncryptionContext
    ...
    public GenerateDataKeyPairWithoutPlaintextRequest withGrantTokens(java.util.Collection<String> grantTokens) {
