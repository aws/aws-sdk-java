...
/**
 * Decrypt Result JSON Unmarshaller
 */
public class DecryptResultJsonUnmarshaller implements Unmarshaller<DecryptResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Plaintext", targetDepth)) {
                    context.nextToken();
                    decryptResult.setPlaintext(ByteBufferJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DecryptResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DecryptResultJsonUnmarshaller();
        return instance;
    }
}
