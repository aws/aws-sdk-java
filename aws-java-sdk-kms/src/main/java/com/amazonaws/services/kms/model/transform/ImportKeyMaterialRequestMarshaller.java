...
public class ImportKeyMaterialRequestMarshaller implements
    ...
    public ImportKeyMaterialRequestMarshaller(
        ...
        try {
            ...
            if (importKeyMaterialRequest.getKeyId() != null) {
                jsonGenerator.writeFieldName("KeyId").writeValue(
                        importKeyMaterialRequest.getKeyId());
            }
            if (importKeyMaterialRequest.getImportToken() != null) {
                jsonGenerator.writeFieldName("ImportToken").writeValue(
                        importKeyMaterialRequest.getImportToken());
            }
            if (importKeyMaterialRequest.getEncryptedKeyMaterial() != null) {
                jsonGenerator.writeFieldName("EncryptedKeyMaterial")
                        .writeValue(
