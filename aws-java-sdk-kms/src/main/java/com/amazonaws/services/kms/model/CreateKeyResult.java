...
public class CreateKeyResult implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getKeyMetadata() != null) sb.append("KeyMetadata: " + getKeyMetadata() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateKeyResult == false) return false;
        CreateKeyResult other = (CreateKeyResult)obj;
        
        if (other.getKeyMetadata() == null ^ this.getKeyMetadata() == null) return false;
        if (other.getKeyMetadata() != null && other.getKeyMetadata().equals(this.getKeyMetadata()) == false) return false; 
        return true;
    }
