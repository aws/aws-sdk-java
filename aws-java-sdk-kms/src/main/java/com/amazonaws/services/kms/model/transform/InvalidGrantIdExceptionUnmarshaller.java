...
public class InvalidGrantIdExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("InvalidGrantIdException"));
        } else {
            return errorTypeFromHeader.equals("InvalidGrantIdException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        InvalidGrantIdException e = (InvalidGrantIdException)super.unmarshall(json);
