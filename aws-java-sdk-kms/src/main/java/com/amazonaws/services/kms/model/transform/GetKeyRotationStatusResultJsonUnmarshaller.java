...
/**
 * Get Key Rotation Status Result JSON Unmarshaller
 */
public class GetKeyRotationStatusResultJsonUnmarshaller implements Unmarshaller<GetKeyRotationStatusResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("KeyRotationEnabled", targetDepth)) {
                    context.nextToken();
                    getKeyRotationStatusResult.setKeyRotationEnabled(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static GetKeyRotationStatusResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetKeyRotationStatusResultJsonUnmarshaller();
        return instance;
    }
}
