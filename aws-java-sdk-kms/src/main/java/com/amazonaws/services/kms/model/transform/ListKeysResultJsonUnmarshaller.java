...
/**
 * List Keys Result JSON Unmarshaller
 */
public class ListKeysResultJsonUnmarshaller implements Unmarshaller<ListKeysResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listKeysResult.setNextMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Truncated", targetDepth)) {
                    context.nextToken();
                    listKeysResult.setTruncated(BooleanJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ListKeysResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListKeysResultJsonUnmarshaller();
        return instance;
    }
}
