...
/**
 * List Retirable Grants Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (listRetirableGrantsRequest.getLimit() != null) {
                jsonWriter.key("Limit").value(listRetirableGrantsRequest.getLimit());
            }
            if (listRetirableGrantsRequest.getMarker() != null) {
                jsonWriter.key("Marker").value(listRetirableGrantsRequest.getMarker());
            }
            if (listRetirableGrantsRequest.getRetiringPrincipal() != null) {
                jsonWriter.key("RetiringPrincipal").value(listRetirableGrantsRequest.getRetiringPrincipal());
            }
