 ...
 */
public class DeleteImportedKeyMaterialResultJsonUnmarshaller implements
        Unmarshaller<DeleteImportedKeyMaterialResult, JsonUnmarshallerContext> {

    public DeleteImportedKeyMaterialResult unmarshall(
