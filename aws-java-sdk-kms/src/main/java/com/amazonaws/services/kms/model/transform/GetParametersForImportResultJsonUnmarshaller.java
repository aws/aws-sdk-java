...
public class GetParametersForImportResultJsonUnmarshaller implements
    ...
    public GetParametersForImportResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("KeyId", targetDepth)) {
                    context.nextToken();
                    getParametersForImportResult.setKeyId(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ImportToken", targetDepth)) {
                    context.nextToken();
                    getParametersForImportResult.setImportToken(context
                            .getUnmarshaller(java.nio.ByteBuffer.class)
                            .unmarshall(context));
                }
                if (context.testExpression("PublicKey", targetDepth)) {
                    context.nextToken();
                    getParametersForImportResult.setPublicKey(context
                            .getUnmarshaller(java.nio.ByteBuffer.class)
                            .unmarshall(context));
                }
                if (context.testExpression("ParametersValidTo", targetDepth)) {
                    context.nextToken();
                    getParametersForImportResult.setParametersValidTo(context
