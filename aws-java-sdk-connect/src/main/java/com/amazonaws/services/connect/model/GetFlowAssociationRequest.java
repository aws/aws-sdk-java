...
public class GetFlowAssociationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetFlowAssociationRequest clone() {
        return (GetFlowAssociationRequest) super.clone();
    }
