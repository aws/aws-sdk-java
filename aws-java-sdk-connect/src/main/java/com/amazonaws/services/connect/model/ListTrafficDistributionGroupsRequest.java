...
public class ListTrafficDistributionGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListTrafficDistributionGroupsRequest clone() {
        return (ListTrafficDistributionGroupsRequest) super.clone();
    }
