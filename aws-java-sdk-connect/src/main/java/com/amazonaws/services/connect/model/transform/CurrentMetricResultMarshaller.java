...
/**
 * CurrentMetricResultMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CurrentMetricResultMarshaller {
    ...
    private static final CurrentMetricResultMarshaller instance = new CurrentMetricResultMarshaller();

    public static CurrentMetricResultMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CurrentMetricResult currentMetricResult, ProtocolMarshaller protocolMarshaller) {
