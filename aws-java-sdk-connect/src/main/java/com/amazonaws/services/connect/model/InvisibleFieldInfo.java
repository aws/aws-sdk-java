 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/InvisibleFieldInfo" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InvisibleFieldInfo implements Serializable, Cloneable, StructuredPojo {
    ...
    public InvisibleFieldInfo clone() {
        try {
            return (InvisibleFieldInfo) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.InvisibleFieldInfoMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
