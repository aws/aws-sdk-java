...
/**
 * UpdateQueueNameResult JSON Unmarshaller
 */
...
public class UpdateQueueNameResultJsonUnmarshaller implements Unmarshaller<UpdateQueueNameResult, JsonUnmarshallerContext> {
    ...
    public UpdateQueueNameResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateQueueNameResult updateQueueNameResult = new UpdateQueueNameResult();

        return updateQueueNameResult;
    }
