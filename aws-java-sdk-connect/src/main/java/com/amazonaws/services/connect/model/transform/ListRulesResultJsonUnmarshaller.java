    ...
    public ListRulesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RuleSummaryList", targetDepth)) {
                    context.nextToken();
                    listRulesResult.setRuleSummaryList(new ListUnmarshaller<RuleSummary>(RuleSummaryJsonUnmarshaller.getInstance())
