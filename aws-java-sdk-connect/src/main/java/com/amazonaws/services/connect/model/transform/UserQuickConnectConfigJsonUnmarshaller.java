...
/**
 * UserQuickConnectConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UserQuickConnectConfigJsonUnmarshaller implements Unmarshaller<UserQuickConnectConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UserId", targetDepth)) {
                    context.nextToken();
                    userQuickConnectConfig.setUserId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ContactFlowId", targetDepth)) {
                    context.nextToken();
                    userQuickConnectConfig.setContactFlowId(context.getUnmarshaller(String.class).unmarshall(context));
                }
