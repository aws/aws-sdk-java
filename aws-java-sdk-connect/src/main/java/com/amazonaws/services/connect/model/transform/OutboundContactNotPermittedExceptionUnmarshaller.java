...
public class OutboundContactNotPermittedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OutboundContactNotPermittedExceptionUnmarshaller instance;

    public static OutboundContactNotPermittedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OutboundContactNotPermittedExceptionUnmarshaller();
        return instance;
    }
}
