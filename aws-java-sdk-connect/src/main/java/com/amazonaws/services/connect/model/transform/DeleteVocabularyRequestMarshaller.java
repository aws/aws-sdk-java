...
public class DeleteVocabularyRequestMarshaller {
    ...
    public void marshall(DeleteVocabularyRequest deleteVocabularyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteVocabularyRequest.getInstanceId(), INSTANCEID_BINDING);
            protocolMarshaller.marshall(deleteVocabularyRequest.getVocabularyId(), VOCABULARYID_BINDING);
        } catch (Exception e) {
