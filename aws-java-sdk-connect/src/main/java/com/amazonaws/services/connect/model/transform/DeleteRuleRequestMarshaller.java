...
public class DeleteRuleRequestMarshaller {
    ...
    private static final MarshallingInfo<String> RULEID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PATH)
    ...
    public void marshall(DeleteRuleRequest deleteRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteRuleRequest.getInstanceId(), INSTANCEID_BINDING);
