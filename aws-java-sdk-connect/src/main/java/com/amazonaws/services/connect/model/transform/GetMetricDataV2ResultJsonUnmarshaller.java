...
/**
 * GetMetricDataV2Result JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetMetricDataV2ResultJsonUnmarshaller implements Unmarshaller<GetMetricDataV2Result, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    getMetricDataV2Result.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MetricResults", targetDepth)) {
                    context.nextToken();
                    getMetricDataV2Result.setMetricResults(new ListUnmarshaller<MetricResultV2>(MetricResultV2JsonUnmarshaller.getInstance())
