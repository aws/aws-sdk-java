...
/**
 * CreateSecurityProfileResult JSON Unmarshaller
 */
...
public class CreateSecurityProfileResultJsonUnmarshaller implements Unmarshaller<CreateSecurityProfileResult, JsonUnmarshallerContext> {
    ...
    public CreateSecurityProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SecurityProfileId", targetDepth)) {
                    context.nextToken();
                    createSecurityProfileResult.setSecurityProfileId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("SecurityProfileArn", targetDepth)) {
                    context.nextToken();
                    createSecurityProfileResult.setSecurityProfileArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
