        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("VocabularyArn", targetDepth)) {
                    context.nextToken();
                    createVocabularyResult.setVocabularyArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("VocabularyId", targetDepth)) {
                    context.nextToken();
                    createVocabularyResult.setVocabularyId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("State", targetDepth)) {
                    context.nextToken();
                    createVocabularyResult.setState(context.getUnmarshaller(String.class).unmarshall(context));
                }
