...
/**
 * TaskTemplateFieldIdentifier JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TaskTemplateFieldIdentifierJsonUnmarshaller implements Unmarshaller<TaskTemplateFieldIdentifier, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    taskTemplateFieldIdentifier.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
