...
public class CreateTrafficDistributionGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTrafficDistributionGroupResult == false)
            return false;
        CreateTrafficDistributionGroupResult other = (CreateTrafficDistributionGroupResult) obj;
    ...
    public CreateTrafficDistributionGroupResult clone() {
        try {
            return (CreateTrafficDistributionGroupResult) super.clone();
