...
/**
 * UpdateContactFlowMetadataResult JSON Unmarshaller
 */
...
public class UpdateContactFlowMetadataResultJsonUnmarshaller implements Unmarshaller<UpdateContactFlowMetadataResult, JsonUnmarshallerContext> {
    ...
    public UpdateContactFlowMetadataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateContactFlowMetadataResult updateContactFlowMetadataResult = new UpdateContactFlowMetadataResult();

        return updateContactFlowMetadataResult;
    }
