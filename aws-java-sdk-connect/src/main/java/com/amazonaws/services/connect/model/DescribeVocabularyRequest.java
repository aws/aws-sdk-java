...
public class DescribeVocabularyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeVocabularyRequest withInstanceId(String instanceId) {
    ...
    public DescribeVocabularyRequest withVocabularyId(String vocabularyId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeVocabularyRequest == false)
            return false;
        DescribeVocabularyRequest other = (DescribeVocabularyRequest) obj;
    ...
    @Override
    public DescribeVocabularyRequest clone() {
        return (DescribeVocabularyRequest) super.clone();
    }
