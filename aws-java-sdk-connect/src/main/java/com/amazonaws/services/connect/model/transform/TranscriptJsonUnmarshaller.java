        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Criteria", targetDepth)) {
                    context.nextToken();
                    transcript.setCriteria(new ListUnmarshaller<TranscriptCriteria>(TranscriptCriteriaJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("MatchType", targetDepth)) {
                    context.nextToken();
                    transcript.setMatchType(context.getUnmarshaller(String.class).unmarshall(context));
                }
