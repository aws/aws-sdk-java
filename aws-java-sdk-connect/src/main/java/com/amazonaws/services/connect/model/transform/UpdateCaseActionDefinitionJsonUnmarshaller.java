...
/**
 * UpdateCaseActionDefinition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateCaseActionDefinitionJsonUnmarshaller implements Unmarshaller<UpdateCaseActionDefinition, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Fields", targetDepth)) {
                    context.nextToken();
                    updateCaseActionDefinition.setFields(new ListUnmarshaller<FieldValue>(FieldValueJsonUnmarshaller.getInstance())
