 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/EvaluationFormSingleSelectQuestionAutomationOption"
...
public class EvaluationFormSingleSelectQuestionAutomationOption implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRuleCategory() == null ^ this.getRuleCategory() == null)
            return false;
        if (other.getRuleCategory() != null && other.getRuleCategory().equals(this.getRuleCategory()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getRuleCategory() == null) ? 0 : getRuleCategory().hashCode());
        return hashCode;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.EvaluationFormSingleSelectQuestionAutomationOptionMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
