...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/CreatePredefinedAttribute" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreatePredefinedAttributeRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreatePredefinedAttributeRequest withInstanceId(String instanceId) {
    ...
    public CreatePredefinedAttributeRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public CreatePredefinedAttributeRequest withValues(PredefinedAttributeValues values) {
        setValues(values);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePredefinedAttributeRequest == false)
            return false;
    ...
    @Override
    public CreatePredefinedAttributeRequest clone() {
        return (CreatePredefinedAttributeRequest) super.clone();
    }
