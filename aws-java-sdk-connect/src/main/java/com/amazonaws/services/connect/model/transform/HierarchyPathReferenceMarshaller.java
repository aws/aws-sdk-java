...
/**
 * HierarchyPathReferenceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class HierarchyPathReferenceMarshaller {
    ...
    private static final HierarchyPathReferenceMarshaller instance = new HierarchyPathReferenceMarshaller();

    public static HierarchyPathReferenceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HierarchyPathReference hierarchyPathReference, ProtocolMarshaller protocolMarshaller) {

        if (hierarchyPathReference == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(hierarchyPathReference.getLevelOne(), LEVELONE_BINDING);
            protocolMarshaller.marshall(hierarchyPathReference.getLevelTwo(), LEVELTWO_BINDING);
            protocolMarshaller.marshall(hierarchyPathReference.getLevelThree(), LEVELTHREE_BINDING);
            protocolMarshaller.marshall(hierarchyPathReference.getLevelFour(), LEVELFOUR_BINDING);
            protocolMarshaller.marshall(hierarchyPathReference.getLevelFive(), LEVELFIVE_BINDING);
        } catch (Exception e) {
