...
public class DeleteTrafficDistributionGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteTrafficDistributionGroupRequest withTrafficDistributionGroupId(String trafficDistributionGroupId) {
    ...
    @Override
    public DeleteTrafficDistributionGroupRequest clone() {
