...
public class ResumeContactRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ResumeContactRequest withContactId(String contactId) {
    ...
    public ResumeContactRequest withInstanceId(String instanceId) {
    ...
    public ResumeContactRequest withContactFlowId(String contactFlowId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResumeContactRequest == false)
            return false;
    ...
    @Override
    public ResumeContactRequest clone() {
        return (ResumeContactRequest) super.clone();
    }
