...
/**
 * UpdateContactFlowNameResult JSON Unmarshaller
 */
...
public class UpdateContactFlowNameResultJsonUnmarshaller implements Unmarshaller<UpdateContactFlowNameResult, JsonUnmarshallerContext> {
    ...
    public UpdateContactFlowNameResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateContactFlowNameResult updateContactFlowNameResult = new UpdateContactFlowNameResult();

        return updateContactFlowNameResult;
    }
