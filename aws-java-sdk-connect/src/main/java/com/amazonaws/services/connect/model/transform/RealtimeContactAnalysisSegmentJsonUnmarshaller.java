        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Transcript", targetDepth)) {
                    context.nextToken();
                    realtimeContactAnalysisSegment.setTranscript(RealTimeContactAnalysisSegmentTranscriptJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Categories", targetDepth)) {
                    context.nextToken();
                    realtimeContactAnalysisSegment.setCategories(RealTimeContactAnalysisSegmentCategoriesJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Issues", targetDepth)) {
                    context.nextToken();
                    realtimeContactAnalysisSegment.setIssues(RealTimeContactAnalysisSegmentIssuesJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Event", targetDepth)) {
                    context.nextToken();
                    realtimeContactAnalysisSegment.setEvent(RealTimeContactAnalysisSegmentEventJsonUnmarshaller.getInstance().unmarshall(context));
                }
