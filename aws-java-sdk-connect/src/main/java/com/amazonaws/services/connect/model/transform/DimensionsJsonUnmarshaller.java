...
/**
 * Dimensions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DimensionsJsonUnmarshaller implements Unmarshaller<Dimensions, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Queue", targetDepth)) {
                    context.nextToken();
                    dimensions.setQueue(QueueReferenceJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("RoutingStepExpression", targetDepth)) {
                    context.nextToken();
                    dimensions.setRoutingStepExpression(context.getUnmarshaller(String.class).unmarshall(context));
                }
