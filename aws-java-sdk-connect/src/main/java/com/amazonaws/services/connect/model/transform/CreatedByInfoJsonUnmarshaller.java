...
/**
 * CreatedByInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreatedByInfoJsonUnmarshaller implements Unmarshaller<CreatedByInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ConnectUserArn", targetDepth)) {
                    context.nextToken();
                    createdByInfo.setConnectUserArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("AWSIdentityArn", targetDepth)) {
                    context.nextToken();
                    createdByInfo.setAWSIdentityArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
