...
/**
 * UpdateContactRoutingDataResult JSON Unmarshaller
 */
...
public class UpdateContactRoutingDataResultJsonUnmarshaller implements Unmarshaller<UpdateContactRoutingDataResult, JsonUnmarshallerContext> {
    ...
    public UpdateContactRoutingDataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateContactRoutingDataResult updateContactRoutingDataResult = new UpdateContactRoutingDataResult();

        return updateContactRoutingDataResult;
    }
