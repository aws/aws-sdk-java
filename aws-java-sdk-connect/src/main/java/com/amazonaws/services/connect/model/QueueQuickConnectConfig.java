...
public class QueueQuickConnectConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public QueueQuickConnectConfig clone() {
        try {
            return (QueueQuickConnectConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.QueueQuickConnectConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
