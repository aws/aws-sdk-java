...
public class SearchContactFlowsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public void setSearchFilter(ContactFlowSearchFilter searchFilter) {
    ...
    public ContactFlowSearchFilter getSearchFilter() {
    ...
    public void setSearchCriteria(ContactFlowSearchCriteria searchCriteria) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchContactFlowsRequest == false)
            return false;
    ...
    public SearchContactFlowsRequest clone() {
        return (SearchContactFlowsRequest) super.clone();
    }
