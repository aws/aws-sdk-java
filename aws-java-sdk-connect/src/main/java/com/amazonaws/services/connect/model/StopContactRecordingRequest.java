...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/StopContactRecording" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopContactRecordingRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StopContactRecordingRequest withInstanceId(String instanceId) {
    ...
    public StopContactRecordingRequest withContactId(String contactId) {
    ...
    public StopContactRecordingRequest withInitialContactId(String initialContactId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopContactRecordingRequest == false)
            return false;
        StopContactRecordingRequest other = (StopContactRecordingRequest) obj;
    ...
    @Override
    public StopContactRecordingRequest clone() {
        return (StopContactRecordingRequest) super.clone();
    }
