...
public enum NumericQuestionPropertyAutomationLabel {
    ...
    private NumericQuestionPropertyAutomationLabel(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return NumericQuestionPropertyAutomationLabel corresponding to the value
     *
    ...
    public static NumericQuestionPropertyAutomationLabel fromValue(String value) {
        ...
        for (NumericQuestionPropertyAutomationLabel enumEntry : NumericQuestionPropertyAutomationLabel.values()) {
