...
/**
 * ListHoursOfOperationsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListHoursOfOperationsResultJsonUnmarshaller implements Unmarshaller<ListHoursOfOperationsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listHoursOfOperationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
