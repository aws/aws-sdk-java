...
/**
 * AssociateRoutingProfileQueuesResult JSON Unmarshaller
 */
...
public class AssociateRoutingProfileQueuesResultJsonUnmarshaller implements Unmarshaller<AssociateRoutingProfileQueuesResult, JsonUnmarshallerContext> {
    ...
    public AssociateRoutingProfileQueuesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateRoutingProfileQueuesResult associateRoutingProfileQueuesResult = new AssociateRoutingProfileQueuesResult();

        return associateRoutingProfileQueuesResult;
    }
