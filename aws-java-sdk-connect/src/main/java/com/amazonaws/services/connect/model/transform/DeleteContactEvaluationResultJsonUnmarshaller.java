...
/**
 * DeleteContactEvaluationResult JSON Unmarshaller
 */
...
public class DeleteContactEvaluationResultJsonUnmarshaller implements Unmarshaller<DeleteContactEvaluationResult, JsonUnmarshallerContext> {
    ...
    public DeleteContactEvaluationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteContactEvaluationResult deleteContactEvaluationResult = new DeleteContactEvaluationResult();

        return deleteContactEvaluationResult;
    }
