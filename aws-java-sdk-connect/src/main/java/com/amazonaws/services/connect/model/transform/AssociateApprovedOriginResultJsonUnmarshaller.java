...
/**
 * AssociateApprovedOriginResult JSON Unmarshaller
 */
...
public class AssociateApprovedOriginResultJsonUnmarshaller implements Unmarshaller<AssociateApprovedOriginResult, JsonUnmarshallerContext> {
    ...
    public AssociateApprovedOriginResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateApprovedOriginResult associateApprovedOriginResult = new AssociateApprovedOriginResult();

        return associateApprovedOriginResult;
    }
