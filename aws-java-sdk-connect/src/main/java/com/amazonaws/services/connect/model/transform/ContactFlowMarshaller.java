...
/**
 * ContactFlowMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ContactFlowMarshaller {
    ...
    private static final ContactFlowMarshaller instance = new ContactFlowMarshaller();

    public static ContactFlowMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ContactFlow contactFlow, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(contactFlow.getArn(), ARN_BINDING);
