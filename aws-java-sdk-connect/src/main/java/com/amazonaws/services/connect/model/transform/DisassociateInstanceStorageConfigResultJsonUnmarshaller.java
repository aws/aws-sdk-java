...
/**
 * DisassociateInstanceStorageConfigResult JSON Unmarshaller
 */
...
public class DisassociateInstanceStorageConfigResultJsonUnmarshaller implements Unmarshaller<DisassociateInstanceStorageConfigResult, JsonUnmarshallerContext> {
    ...
    public DisassociateInstanceStorageConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateInstanceStorageConfigResult disassociateInstanceStorageConfigResult = new DisassociateInstanceStorageConfigResult();

        return disassociateInstanceStorageConfigResult;
    }
