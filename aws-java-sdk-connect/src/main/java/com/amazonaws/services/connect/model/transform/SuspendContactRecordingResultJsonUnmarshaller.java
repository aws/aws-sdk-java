...
/**
 * SuspendContactRecordingResult JSON Unmarshaller
 */
...
public class SuspendContactRecordingResultJsonUnmarshaller implements Unmarshaller<SuspendContactRecordingResult, JsonUnmarshallerContext> {
    ...
    public SuspendContactRecordingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SuspendContactRecordingResult suspendContactRecordingResult = new SuspendContactRecordingResult();

        return suspendContactRecordingResult;
    }
