...
/**
 * UpdateUserHierarchyResult JSON Unmarshaller
 */
...
public class UpdateUserHierarchyResultJsonUnmarshaller implements Unmarshaller<UpdateUserHierarchyResult, JsonUnmarshallerContext> {
    ...
    public UpdateUserHierarchyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateUserHierarchyResult updateUserHierarchyResult = new UpdateUserHierarchyResult();
