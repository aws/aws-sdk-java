...
/**
 * DescribeQuickConnectResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeQuickConnectResultJsonUnmarshaller implements Unmarshaller<DescribeQuickConnectResult, JsonUnmarshallerContext> {
    ...
    public DescribeQuickConnectResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("QuickConnect", targetDepth)) {
                    context.nextToken();
                    describeQuickConnectResult.setQuickConnect(QuickConnectJsonUnmarshaller.getInstance().unmarshall(context));
                }
