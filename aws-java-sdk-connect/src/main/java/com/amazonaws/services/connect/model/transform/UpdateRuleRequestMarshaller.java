...
public class UpdateRuleRequestMarshaller {
    ...
    public void marshall(UpdateRuleRequest updateRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateRuleRequest.getInstanceId(), INSTANCEID_BINDING);
            protocolMarshaller.marshall(updateRuleRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateRuleRequest.getFunction(), FUNCTION_BINDING);
            protocolMarshaller.marshall(updateRuleRequest.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(updateRuleRequest.getPublishStatus(), PUBLISHSTATUS_BINDING);
        } catch (Exception e) {
