...
/**
 * AssociateLexBotResult JSON Unmarshaller
 */
...
public class AssociateLexBotResultJsonUnmarshaller implements Unmarshaller<AssociateLexBotResult, JsonUnmarshallerContext> {
    ...
    public AssociateLexBotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateLexBotResult associateLexBotResult = new AssociateLexBotResult();

        return associateLexBotResult;
    }
