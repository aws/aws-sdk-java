...
/**
 * CurrentMetricSortCriteria JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CurrentMetricSortCriteriaJsonUnmarshaller implements Unmarshaller<CurrentMetricSortCriteria, JsonUnmarshallerContext> {
    ...
    public CurrentMetricSortCriteria unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SortByMetric", targetDepth)) {
                    context.nextToken();
                    currentMetricSortCriteria.setSortByMetric(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("SortOrder", targetDepth)) {
                    context.nextToken();
                    currentMetricSortCriteria.setSortOrder(context.getUnmarshaller(String.class).unmarshall(context));
                }
