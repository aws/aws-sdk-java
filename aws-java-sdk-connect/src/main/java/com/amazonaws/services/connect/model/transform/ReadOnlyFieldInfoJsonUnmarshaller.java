...
/**
 * ReadOnlyFieldInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReadOnlyFieldInfoJsonUnmarshaller implements Unmarshaller<ReadOnlyFieldInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Id", targetDepth)) {
                    context.nextToken();
                    readOnlyFieldInfo.setId(TaskTemplateFieldIdentifierJsonUnmarshaller.getInstance().unmarshall(context));
                }
