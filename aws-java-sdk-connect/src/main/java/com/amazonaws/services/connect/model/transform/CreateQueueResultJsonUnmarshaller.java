        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("QueueArn", targetDepth)) {
                    context.nextToken();
                    createQueueResult.setQueueArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("QueueId", targetDepth)) {
                    context.nextToken();
                    createQueueResult.setQueueId(context.getUnmarshaller(String.class).unmarshall(context));
                }
