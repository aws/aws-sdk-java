...
public class DeleteContactFlowRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteContactFlowRequest withInstanceId(String instanceId) {
    ...
    public DeleteContactFlowRequest withContactFlowId(String contactFlowId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteContactFlowRequest == false)
            return false;
        DeleteContactFlowRequest other = (DeleteContactFlowRequest) obj;
    ...
    @Override
    public DeleteContactFlowRequest clone() {
        return (DeleteContactFlowRequest) super.clone();
    }
