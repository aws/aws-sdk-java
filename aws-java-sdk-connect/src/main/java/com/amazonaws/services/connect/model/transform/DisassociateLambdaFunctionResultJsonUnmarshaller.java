...
/**
 * DisassociateLambdaFunctionResult JSON Unmarshaller
 */
...
public class DisassociateLambdaFunctionResultJsonUnmarshaller implements Unmarshaller<DisassociateLambdaFunctionResult, JsonUnmarshallerContext> {
    ...
    public DisassociateLambdaFunctionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateLambdaFunctionResult disassociateLambdaFunctionResult = new DisassociateLambdaFunctionResult();

        return disassociateLambdaFunctionResult;
    }
