...
public class DescribeInstanceStorageConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    @Override
    public DescribeInstanceStorageConfigResult clone() {
        try {
