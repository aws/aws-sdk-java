 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/UserQuickConnectConfig" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UserQuickConnectConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public UserQuickConnectConfig clone() {
        try {
            return (UserQuickConnectConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.UserQuickConnectConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
