 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/SubmitAutoEvaluationActionDefinition"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SubmitAutoEvaluationActionDefinition implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The identifier of the auto-evaluation enabled form.
     */
    ...
    public String toString() {
        ...
        if (getEvaluationFormId() != null)
            sb.append("EvaluationFormId: ").append(getEvaluationFormId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SubmitAutoEvaluationActionDefinition == false)
            return false;
        SubmitAutoEvaluationActionDefinition other = (SubmitAutoEvaluationActionDefinition) obj;
    ...
    public SubmitAutoEvaluationActionDefinition clone() {
        try {
            return (SubmitAutoEvaluationActionDefinition) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.SubmitAutoEvaluationActionDefinitionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
