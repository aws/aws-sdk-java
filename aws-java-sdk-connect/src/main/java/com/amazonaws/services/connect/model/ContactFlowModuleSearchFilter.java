 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/ContactFlowModuleSearchFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ContactFlowModuleSearchFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ContactFlowModuleSearchFilter == false)
            return false;
        ContactFlowModuleSearchFilter other = (ContactFlowModuleSearchFilter) obj;
    ...
    public ContactFlowModuleSearchFilter clone() {
        try {
            return (ContactFlowModuleSearchFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.ContactFlowModuleSearchFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
