...
/**
 * NotificationRecipientType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NotificationRecipientTypeJsonUnmarshaller implements Unmarshaller<NotificationRecipientType, JsonUnmarshallerContext> {
    ...
    public NotificationRecipientType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UserTags", targetDepth)) {
                    context.nextToken();
                    notificationRecipientType.setUserTags(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
                            .getUnmarshaller(String.class)).unmarshall(context));
                }
                if (context.testExpression("UserIds", targetDepth)) {
                    context.nextToken();
                    notificationRecipientType.setUserIds(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
