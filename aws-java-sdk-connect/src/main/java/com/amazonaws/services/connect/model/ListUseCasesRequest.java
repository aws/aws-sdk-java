...
public class ListUseCasesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListUseCasesRequest withInstanceId(String instanceId) {
    ...
    public ListUseCasesRequest withIntegrationAssociationId(String integrationAssociationId) {
    ...
    public ListUseCasesRequest withNextToken(String nextToken) {
    ...
    public ListUseCasesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListUseCasesRequest == false)
            return false;
        ListUseCasesRequest other = (ListUseCasesRequest) obj;
    ...
    @Override
    public ListUseCasesRequest clone() {
        return (ListUseCasesRequest) super.clone();
    }
