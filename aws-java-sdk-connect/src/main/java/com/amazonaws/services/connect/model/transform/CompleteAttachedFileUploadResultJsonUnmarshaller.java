...
/**
 * CompleteAttachedFileUploadResult JSON Unmarshaller
 */
...
public class CompleteAttachedFileUploadResultJsonUnmarshaller implements Unmarshaller<CompleteAttachedFileUploadResult, JsonUnmarshallerContext> {
    ...
    public CompleteAttachedFileUploadResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CompleteAttachedFileUploadResult completeAttachedFileUploadResult = new CompleteAttachedFileUploadResult();

        return completeAttachedFileUploadResult;
    }
