...
public class DestinationNotAllowedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DestinationNotAllowedExceptionUnmarshaller instance;

    public static DestinationNotAllowedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DestinationNotAllowedExceptionUnmarshaller();
        return instance;
    }
}
