...
/**
 * KinesisVideoStreamConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class KinesisVideoStreamConfigMarshaller {
    ...
    private static final KinesisVideoStreamConfigMarshaller instance = new KinesisVideoStreamConfigMarshaller();

    public static KinesisVideoStreamConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(KinesisVideoStreamConfig kinesisVideoStreamConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(kinesisVideoStreamConfig.getPrefix(), PREFIX_BINDING);
            protocolMarshaller.marshall(kinesisVideoStreamConfig.getRetentionPeriodHours(), RETENTIONPERIODHOURS_BINDING);
            protocolMarshaller.marshall(kinesisVideoStreamConfig.getEncryptionConfig(), ENCRYPTIONCONFIG_BINDING);
        } catch (Exception e) {
