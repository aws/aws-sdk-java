...
/**
 * UpdateQueueStatusResult JSON Unmarshaller
 */
...
public class UpdateQueueStatusResultJsonUnmarshaller implements Unmarshaller<UpdateQueueStatusResult, JsonUnmarshallerContext> {
    ...
    public UpdateQueueStatusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateQueueStatusResult updateQueueStatusResult = new UpdateQueueStatusResult();

        return updateQueueStatusResult;
    }
