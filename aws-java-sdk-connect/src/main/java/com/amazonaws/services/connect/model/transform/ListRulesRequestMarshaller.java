...
public class ListRulesRequestMarshaller {
    ...
    private static final MarshallingInfo<String> PUBLISHSTATUS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("publishStatus").build();
    private static final MarshallingInfo<String> EVENTSOURCENAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("eventSourceName").build();
    ...
    public void marshall(ListRulesRequest listRulesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listRulesRequest.getInstanceId(), INSTANCEID_BINDING);
            protocolMarshaller.marshall(listRulesRequest.getPublishStatus(), PUBLISHSTATUS_BINDING);
            protocolMarshaller.marshall(listRulesRequest.getEventSourceName(), EVENTSOURCENAME_BINDING);
            protocolMarshaller.marshall(listRulesRequest.getMaxResults(), MAXRESULTS_BINDING);
