...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/SearchContactFlowModules" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchContactFlowModulesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public SearchContactFlowModulesRequest withInstanceId(String instanceId) {
    ...
    public SearchContactFlowModulesRequest withNextToken(String nextToken) {
    ...
    public SearchContactFlowModulesRequest withMaxResults(Integer maxResults) {
    ...
    public void setSearchFilter(ContactFlowModuleSearchFilter searchFilter) {
    ...
    public ContactFlowModuleSearchFilter getSearchFilter() {
    ...
    public SearchContactFlowModulesRequest withSearchFilter(ContactFlowModuleSearchFilter searchFilter) {
     ...
     *        The search criteria to be used to return contact flow modules.</p> <note>
     *        <p>
     *        The <code>name</code> and <code>description</code> fields support "contains" queries with a minimum of 2
    ...
    public void setSearchCriteria(ContactFlowModuleSearchCriteria searchCriteria) {
     ...
     * </note>
     * 
     * @return The search criteria to be used to return contact flow modules.</p> <note>
     *         <p>
     *         The <code>name</code> and <code>description</code> fields support "contains" queries with a minimum of 2
     *         characters and a maximum of 25 characters. Any queries with character lengths outside of this range will
     *         result in invalid results.
    ...
    public ContactFlowModuleSearchCriteria getSearchCriteria() {
    ...
    public SearchContactFlowModulesRequest withSearchCriteria(ContactFlowModuleSearchCriteria searchCriteria) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchContactFlowModulesRequest == false)
            return false;
        SearchContactFlowModulesRequest other = (SearchContactFlowModulesRequest) obj;
    ...
    @Override
    public SearchContactFlowModulesRequest clone() {
        return (SearchContactFlowModulesRequest) super.clone();
    }
