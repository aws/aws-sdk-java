...
/**
 * CurrentMetricResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CurrentMetricResultJsonUnmarshaller implements Unmarshaller<CurrentMetricResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Dimensions", targetDepth)) {
                    context.nextToken();
                    currentMetricResult.setDimensions(DimensionsJsonUnmarshaller.getInstance().unmarshall(context));
                }
