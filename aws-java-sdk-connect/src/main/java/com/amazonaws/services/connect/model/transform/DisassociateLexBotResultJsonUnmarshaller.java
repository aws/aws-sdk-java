...
/**
 * DisassociateLexBotResult JSON Unmarshaller
 */
...
public class DisassociateLexBotResultJsonUnmarshaller implements Unmarshaller<DisassociateLexBotResult, JsonUnmarshallerContext> {
    ...
    public DisassociateLexBotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateLexBotResult disassociateLexBotResult = new DisassociateLexBotResult();

        return disassociateLexBotResult;
    }
