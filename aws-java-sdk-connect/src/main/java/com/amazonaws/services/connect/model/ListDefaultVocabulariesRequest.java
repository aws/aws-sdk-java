...
public class ListDefaultVocabulariesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListDefaultVocabulariesRequest clone() {
        return (ListDefaultVocabulariesRequest) super.clone();
    }
