...
/**
 * DeleteTaskTemplateResult JSON Unmarshaller
 */
...
public class DeleteTaskTemplateResultJsonUnmarshaller implements Unmarshaller<DeleteTaskTemplateResult, JsonUnmarshallerContext> {
    ...
    public DeleteTaskTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTaskTemplateResult deleteTaskTemplateResult = new DeleteTaskTemplateResult();

        return deleteTaskTemplateResult;
    }
