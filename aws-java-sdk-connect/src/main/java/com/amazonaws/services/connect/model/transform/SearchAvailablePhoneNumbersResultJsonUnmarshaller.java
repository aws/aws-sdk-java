...
/**
 * SearchAvailablePhoneNumbersResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchAvailablePhoneNumbersResultJsonUnmarshaller implements Unmarshaller<SearchAvailablePhoneNumbersResult, JsonUnmarshallerContext> {

    public SearchAvailablePhoneNumbersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("AvailableNumbersList", targetDepth)) {
                    context.nextToken();
                    searchAvailablePhoneNumbersResult.setAvailableNumbersList(new ListUnmarshaller<AvailableNumberSummary>(
