...
/**
 * EvaluationFormSingleSelectQuestionOption JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EvaluationFormSingleSelectQuestionOptionJsonUnmarshaller implements
        Unmarshaller<EvaluationFormSingleSelectQuestionOption, JsonUnmarshallerContext> {

    public EvaluationFormSingleSelectQuestionOption unmarshall(JsonUnmarshallerContext context) throws Exception {
