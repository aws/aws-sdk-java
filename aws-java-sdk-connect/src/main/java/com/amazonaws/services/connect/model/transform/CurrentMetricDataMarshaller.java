...
/**
 * CurrentMetricDataMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CurrentMetricDataMarshaller {
    ...
    private static final CurrentMetricDataMarshaller instance = new CurrentMetricDataMarshaller();

    public static CurrentMetricDataMarshaller getInstance() {
        return instance;
    }
