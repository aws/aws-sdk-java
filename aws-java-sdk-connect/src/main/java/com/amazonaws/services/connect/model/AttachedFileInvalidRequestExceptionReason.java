...
public enum AttachedFileInvalidRequestExceptionReason {
     ...
     * @param value
     *        real value
     * @return AttachedFileInvalidRequestExceptionReason corresponding to the value
     *
    ...
    public static AttachedFileInvalidRequestExceptionReason fromValue(String value) {
        ...
        for (AttachedFileInvalidRequestExceptionReason enumEntry : AttachedFileInvalidRequestExceptionReason.values()) {
