...
/**
 * AssociateQueueQuickConnectsResult JSON Unmarshaller
 */
...
public class AssociateQueueQuickConnectsResultJsonUnmarshaller implements Unmarshaller<AssociateQueueQuickConnectsResult, JsonUnmarshallerContext> {
    ...
    public AssociateQueueQuickConnectsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateQueueQuickConnectsResult associateQueueQuickConnectsResult = new AssociateQueueQuickConnectsResult();

        return associateQueueQuickConnectsResult;
    }
