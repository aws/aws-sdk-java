...
/**
 * DisassociateQueueQuickConnectsResult JSON Unmarshaller
 */
...
public class DisassociateQueueQuickConnectsResultJsonUnmarshaller implements Unmarshaller<DisassociateQueueQuickConnectsResult, JsonUnmarshallerContext> {
    ...
    public DisassociateQueueQuickConnectsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateQueueQuickConnectsResult disassociateQueueQuickConnectsResult = new DisassociateQueueQuickConnectsResult();

        return disassociateQueueQuickConnectsResult;
    }
