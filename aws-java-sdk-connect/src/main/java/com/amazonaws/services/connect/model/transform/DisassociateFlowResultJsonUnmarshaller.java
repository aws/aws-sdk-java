...
/**
 * DisassociateFlowResult JSON Unmarshaller
 */
...
public class DisassociateFlowResultJsonUnmarshaller implements Unmarshaller<DisassociateFlowResult, JsonUnmarshallerContext> {
    ...
    public DisassociateFlowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateFlowResult disassociateFlowResult = new DisassociateFlowResult();

        return disassociateFlowResult;
    }
