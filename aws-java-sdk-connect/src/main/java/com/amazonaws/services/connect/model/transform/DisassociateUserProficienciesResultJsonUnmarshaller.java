...
/**
 * DisassociateUserProficienciesResult JSON Unmarshaller
 */
...
public class DisassociateUserProficienciesResultJsonUnmarshaller implements Unmarshaller<DisassociateUserProficienciesResult, JsonUnmarshallerContext> {
    ...
    public DisassociateUserProficienciesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateUserProficienciesResult disassociateUserProficienciesResult = new DisassociateUserProficienciesResult();

        return disassociateUserProficienciesResult;
    }
