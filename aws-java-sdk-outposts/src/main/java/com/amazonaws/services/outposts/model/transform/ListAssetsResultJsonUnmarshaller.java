...
/**
 * ListAssetsResult JSON Unmarshaller
 */
...
public class ListAssetsResultJsonUnmarshaller implements Unmarshaller<ListAssetsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Assets", targetDepth)) {
                    context.nextToken();
                    listAssetsResult.setAssets(new ListUnmarshaller<AssetInfo>(AssetInfoJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listAssetsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ListAssetsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListAssetsResultJsonUnmarshaller();
        return instance;
    }
}
