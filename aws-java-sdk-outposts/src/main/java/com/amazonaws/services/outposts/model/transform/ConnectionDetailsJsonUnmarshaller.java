...
/**
 * ConnectionDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConnectionDetailsJsonUnmarshaller implements Unmarshaller<ConnectionDetails, JsonUnmarshallerContext> {

    public ConnectionDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ConnectionDetailsJsonUnmarshaller instance;

    public static ConnectionDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConnectionDetailsJsonUnmarshaller();
        return instance;
    }
}
