...
public class DeleteApplicationRequestMarshaller {
    ...
    public void marshall(DeleteApplicationRequest deleteApplicationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteApplicationRequest.getApplicationIdentifier(), APPLICATIONIDENTIFIER_BINDING);
            protocolMarshaller.marshall(deleteApplicationRequest.getEnvironmentIdentifier(), ENVIRONMENTIDENTIFIER_BINDING);
        } catch (Exception e) {
