...
public class EnvironmentSummaryMarshaller {
    ...
    private static final MarshallingInfo<String> NETWORKFABRICTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("NetworkFabricType").build();
    ...
    public void marshall(EnvironmentSummary environmentSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(environmentSummary.getCreatedTime(), CREATEDTIME_BINDING);
            ...
            protocolMarshaller.marshall(environmentSummary.getError(), ERROR_BINDING);
            protocolMarshaller.marshall(environmentSummary.getLastUpdatedTime(), LASTUPDATEDTIME_BINDING);
            protocolMarshaller.marshall(environmentSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(environmentSummary.getNetworkFabricType(), NETWORKFABRICTYPE_BINDING);
            protocolMarshaller.marshall(environmentSummary.getOwnerAccountId(), OWNERACCOUNTID_BINDING);
            protocolMarshaller.marshall(environmentSummary.getState(), STATE_BINDING);
            protocolMarshaller.marshall(environmentSummary.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(environmentSummary.getTransitGatewayId(), TRANSITGATEWAYID_BINDING);
        } catch (Exception e) {
