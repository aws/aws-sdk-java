...
@SdkInternalApi
public class GetRouteRequestMarshaller {
    ...
    private static final GetRouteRequestMarshaller instance = new GetRouteRequestMarshaller();

    public static GetRouteRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetRouteRequest getRouteRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getRouteRequest.getApplicationIdentifier(), APPLICATIONIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getRouteRequest.getEnvironmentIdentifier(), ENVIRONMENTIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getRouteRequest.getRouteIdentifier(), ROUTEIDENTIFIER_BINDING);
        } catch (Exception e) {
