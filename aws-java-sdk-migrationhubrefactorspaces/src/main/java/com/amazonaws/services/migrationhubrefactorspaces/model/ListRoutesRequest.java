...
public class ListRoutesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListRoutesRequest withApplicationIdentifier(String applicationIdentifier) {
    ...
    public ListRoutesRequest withEnvironmentIdentifier(String environmentIdentifier) {
    ...
    public ListRoutesRequest withMaxResults(Integer maxResults) {
