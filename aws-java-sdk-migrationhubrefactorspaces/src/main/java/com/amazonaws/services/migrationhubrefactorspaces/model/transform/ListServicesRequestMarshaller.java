...
public class ListServicesRequestMarshaller {
    ...
    public void marshall(ListServicesRequest listServicesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listServicesRequest.getApplicationIdentifier(), APPLICATIONIDENTIFIER_BINDING);
            protocolMarshaller.marshall(listServicesRequest.getEnvironmentIdentifier(), ENVIRONMENTIDENTIFIER_BINDING);
