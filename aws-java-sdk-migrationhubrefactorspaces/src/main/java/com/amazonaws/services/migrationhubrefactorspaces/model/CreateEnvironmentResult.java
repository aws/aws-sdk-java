...
public class CreateEnvironmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The tags assigned to the created environment. A tag is a label that you assign to an Amazon Web Services
    ...
    public CreateEnvironmentResult withCreatedTime(java.util.Date createdTime) {
    ...
    public CreateEnvironmentResult withLastUpdatedTime(java.util.Date lastUpdatedTime) {
     ...
     * </p>
     * 
     * @return The Amazon Web Services account ID of environment owner.
     */
     ...
     * </p>
     * 
     * @return The tags assigned to the created environment. A tag is a label that you assign to an Amazon Web Services
     *         resource. Each tag consists of a key-value pair..
     */
    ...
    public CreateEnvironmentResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateEnvironmentResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateEnvironmentResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
