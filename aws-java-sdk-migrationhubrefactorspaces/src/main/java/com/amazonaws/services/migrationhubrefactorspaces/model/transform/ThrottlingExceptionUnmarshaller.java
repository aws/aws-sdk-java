...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhubrefactorspaces.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.migrationhubrefactorspaces.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhubrefactorspaces.model.ThrottlingException throttlingException = new com.amazonaws.services.migrationhubrefactorspaces.model.ThrottlingException(
                null);
