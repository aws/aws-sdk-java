...
public class GetApplicationRequestMarshaller {
    ...
    public void marshall(GetApplicationRequest getApplicationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getApplicationRequest.getApplicationIdentifier(), APPLICATIONIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getApplicationRequest.getEnvironmentIdentifier(), ENVIRONMENTIDENTIFIER_BINDING);
        } catch (Exception e) {
