...
public class UpdateReplicationConfigurationRequestMarshaller {
    ...
    private static final MarshallingInfo<List> PITPOLICY_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("pitPolicy").build();
    ...
    public void marshall(UpdateReplicationConfigurationRequest updateReplicationConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateReplicationConfigurationRequest.getAutoReplicateNewDisks(), AUTOREPLICATENEWDISKS_BINDING);
            ...
            protocolMarshaller.marshall(updateReplicationConfigurationRequest.getPitPolicy(), PITPOLICY_BINDING);
