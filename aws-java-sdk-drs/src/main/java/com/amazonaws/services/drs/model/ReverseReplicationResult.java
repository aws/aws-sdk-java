...
public class ReverseReplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ReverseReplicationResult withReversedDirectionSourceServerArn(String reversedDirectionSourceServerArn) {
    ...
    public String toString() {
        ...
        if (getReversedDirectionSourceServerArn() != null)
            sb.append("ReversedDirectionSourceServerArn: ").append(getReversedDirectionSourceServerArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReverseReplicationResult == false)
            return false;
        ReverseReplicationResult other = (ReverseReplicationResult) obj;
    ...
    @Override
    public ReverseReplicationResult clone() {
        try {
            return (ReverseReplicationResult) super.clone();
