...
public class StartReplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartReplicationResult withSourceServer(SourceServer sourceServer) {
    ...
    public String toString() {
        ...
        if (getSourceServer() != null)
            sb.append("SourceServer: ").append(getSourceServer());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSourceServer() == null ^ this.getSourceServer() == null)
            return false;
        if (other.getSourceServer() != null && other.getSourceServer().equals(this.getSourceServer()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSourceServer() == null) ? 0 : getSourceServer().hashCode());
        return hashCode;
    }
