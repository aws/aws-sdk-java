    ...
    public UpdateLaunchConfigurationTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("launchConfigurationTemplate", targetDepth)) {
                    context.nextToken();
                    updateLaunchConfigurationTemplateResult.setLaunchConfigurationTemplate(LaunchConfigurationTemplateJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
