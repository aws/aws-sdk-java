 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/emr-containers-2020-10-01/ParametricCloudWatchMonitoringConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParametricCloudWatchMonitoringConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ParametricCloudWatchMonitoringConfiguration == false)
            return false;
    ...
    public ParametricCloudWatchMonitoringConfiguration clone() {
        try {
            return (ParametricCloudWatchMonitoringConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.emrcontainers.model.transform.ParametricCloudWatchMonitoringConfigurationMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
