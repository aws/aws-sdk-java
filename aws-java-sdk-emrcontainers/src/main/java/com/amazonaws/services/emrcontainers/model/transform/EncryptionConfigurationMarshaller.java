...
public class EncryptionConfigurationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> INTRANSITENCRYPTIONCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("inTransitEncryptionConfiguration").build();
    ...
    public void marshall(EncryptionConfiguration encryptionConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(encryptionConfiguration.getInTransitEncryptionConfiguration(), INTRANSITENCRYPTIONCONFIGURATION_BINDING);
        } catch (Exception e) {
