...
/**
 * <p>
 * A configuration specification to be used to override existing configurations. This data type allows job template
 * parameters to be specified within.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/emr-containers-2020-10-01/ParametricConfigurationOverrides"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParametricConfigurationOverrides implements Serializable, Cloneable, StructuredPojo {
    ...
    public ParametricConfigurationOverrides withApplicationConfiguration(java.util.Collection<Configuration> applicationConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ParametricConfigurationOverrides == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.emrcontainers.model.transform.ParametricConfigurationOverridesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
