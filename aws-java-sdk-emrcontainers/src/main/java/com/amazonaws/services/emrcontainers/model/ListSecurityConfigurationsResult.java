...
public class ListSecurityConfigurationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The list of returned security configurations.
     */
    ...
    public ListSecurityConfigurationsResult withSecurityConfigurations(SecurityConfiguration... securityConfigurations) {
    ...
    public ListSecurityConfigurationsResult withSecurityConfigurations(java.util.Collection<SecurityConfiguration> securityConfigurations) {
    ...
    public ListSecurityConfigurationsResult withNextToken(String nextToken) {
