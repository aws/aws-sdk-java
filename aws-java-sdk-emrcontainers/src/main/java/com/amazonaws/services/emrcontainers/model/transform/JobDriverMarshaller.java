...
@SdkInternalApi
public class JobDriverMarshaller {
    ...
    public static JobDriverMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(JobDriver jobDriver, ProtocolMarshaller protocolMarshaller) {
