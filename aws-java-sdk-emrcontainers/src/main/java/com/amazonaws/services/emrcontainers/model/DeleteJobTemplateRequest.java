...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/emr-containers-2020-10-01/DeleteJobTemplate" target="_top">AWS
 *      API Documentation</a>
 */
...
public class DeleteJobTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the job template that will be deleted.
     */
    ...
    public DeleteJobTemplateRequest withId(String id) {
        setId(id);
        return this;
    }
