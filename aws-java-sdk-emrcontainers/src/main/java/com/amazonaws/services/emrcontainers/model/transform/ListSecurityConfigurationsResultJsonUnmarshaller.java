        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("securityConfigurations", targetDepth)) {
                    context.nextToken();
                    listSecurityConfigurationsResult.setSecurityConfigurations(new ListUnmarshaller<SecurityConfiguration>(
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listSecurityConfigurationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
