        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    createSecurityConfigurationResult.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("arn", targetDepth)) {
                    context.nextToken();
                    createSecurityConfigurationResult.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
