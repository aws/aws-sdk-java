...
public class ParameterGroupNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.dax.model.ParameterGroupNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return parameterGroupNotFoundException;
    }

    private static ParameterGroupNotFoundExceptionUnmarshaller instance;

    public static ParameterGroupNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterGroupNotFoundExceptionUnmarshaller();
        return instance;
    }
}
