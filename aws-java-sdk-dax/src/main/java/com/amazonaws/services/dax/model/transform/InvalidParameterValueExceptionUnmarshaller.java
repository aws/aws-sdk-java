...
public class InvalidParameterValueExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidParameterValueExceptionUnmarshaller() {
        super(com.amazonaws.services.dax.model.InvalidParameterValueException.class, "InvalidParameterValueException");
    }

    @Override
    public com.amazonaws.services.dax.model.InvalidParameterValueException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
