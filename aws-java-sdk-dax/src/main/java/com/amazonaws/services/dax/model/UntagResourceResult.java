...
public class UntagResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The tag keys that have been removed from the cluster.
     */
    ...
    public UntagResourceResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public UntagResourceResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
