...
/**
 * ParameterGroupStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParameterGroupStatusJsonUnmarshaller implements Unmarshaller<ParameterGroupStatus, JsonUnmarshallerContext> {

    public ParameterGroupStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ParameterGroupStatus parameterGroupStatus = new ParameterGroupStatus();
    ...
    private static ParameterGroupStatusJsonUnmarshaller instance;

    public static ParameterGroupStatusJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterGroupStatusJsonUnmarshaller();
        return instance;
    }
}
