...
public class TagNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TagNotFoundExceptionUnmarshaller instance;

    public static TagNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TagNotFoundExceptionUnmarshaller();
        return instance;
    }
}
