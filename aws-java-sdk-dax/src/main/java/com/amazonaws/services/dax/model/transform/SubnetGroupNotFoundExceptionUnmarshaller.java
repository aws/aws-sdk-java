...
public class SubnetGroupNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.dax.model.SubnetGroupNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return subnetGroupNotFoundException;
    }

    private static SubnetGroupNotFoundExceptionUnmarshaller instance;

    public static SubnetGroupNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SubnetGroupNotFoundExceptionUnmarshaller();
        return instance;
    }
}
