...
public class DescribeDefaultParametersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeDefaultParametersRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeDefaultParametersRequest == false)
            return false;
        DescribeDefaultParametersRequest other = (DescribeDefaultParametersRequest) obj;
    ...
    @Override
    public DescribeDefaultParametersRequest clone() {
        return (DescribeDefaultParametersRequest) super.clone();
    }
