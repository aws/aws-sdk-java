...
/**
 * DescribeDefaultParametersRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeDefaultParametersRequestMarshaller {
    ...
    private static final DescribeDefaultParametersRequestMarshaller instance = new DescribeDefaultParametersRequestMarshaller();

    public static DescribeDefaultParametersRequestMarshaller getInstance() {
        return instance;
    }
