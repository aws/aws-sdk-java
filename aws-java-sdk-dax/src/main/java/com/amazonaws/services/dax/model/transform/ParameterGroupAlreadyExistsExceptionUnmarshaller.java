...
public class ParameterGroupAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.dax.model.ParameterGroupAlreadyExistsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return parameterGroupAlreadyExistsException;
    }

    private static ParameterGroupAlreadyExistsExceptionUnmarshaller instance;

    public static ParameterGroupAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterGroupAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
