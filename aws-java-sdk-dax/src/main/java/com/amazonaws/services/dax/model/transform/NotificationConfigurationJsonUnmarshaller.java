        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TopicArn", targetDepth)) {
                    context.nextToken();
                    notificationConfiguration.setTopicArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("TopicStatus", targetDepth)) {
                    context.nextToken();
                    notificationConfiguration.setTopicStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
