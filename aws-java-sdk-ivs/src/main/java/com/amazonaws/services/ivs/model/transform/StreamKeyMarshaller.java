...
@SdkInternalApi
public class StreamKeyMarshaller {
    ...
    public static StreamKeyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StreamKey streamKey, ProtocolMarshaller protocolMarshaller) {
