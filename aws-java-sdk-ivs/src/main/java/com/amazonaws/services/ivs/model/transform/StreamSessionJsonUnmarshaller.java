...
/**
 * StreamSession JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StreamSessionJsonUnmarshaller implements Unmarshaller<StreamSession, JsonUnmarshallerContext> {

    public StreamSession unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ingestConfiguration", targetDepth)) {
                    context.nextToken();
                    streamSession.setIngestConfiguration(IngestConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("truncatedEvents", targetDepth)) {
                    context.nextToken();
                    streamSession.setTruncatedEvents(new ListUnmarshaller<StreamEvent>(StreamEventJsonUnmarshaller.getInstance())
    ...
    private static StreamSessionJsonUnmarshaller instance;

    public static StreamSessionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StreamSessionJsonUnmarshaller();
        return instance;
    }
}
