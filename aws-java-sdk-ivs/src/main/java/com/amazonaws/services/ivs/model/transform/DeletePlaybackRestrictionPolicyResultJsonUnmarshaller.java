...
/**
 * DeletePlaybackRestrictionPolicyResult JSON Unmarshaller
 */
...
public class DeletePlaybackRestrictionPolicyResultJsonUnmarshaller implements Unmarshaller<DeletePlaybackRestrictionPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeletePlaybackRestrictionPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeletePlaybackRestrictionPolicyResult deletePlaybackRestrictionPolicyResult = new DeletePlaybackRestrictionPolicyResult();

        return deletePlaybackRestrictionPolicyResult;
    }
