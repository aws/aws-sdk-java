...
/**
 * StopStreamResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopStreamResultJsonUnmarshaller implements Unmarshaller<StopStreamResult, JsonUnmarshallerContext> {

    public StopStreamResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopStreamResult stopStreamResult = new StopStreamResult();
