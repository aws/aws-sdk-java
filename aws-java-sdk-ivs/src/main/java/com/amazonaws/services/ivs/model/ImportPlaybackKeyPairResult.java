...
public class ImportPlaybackKeyPairResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportPlaybackKeyPairResult == false)
            return false;
        ImportPlaybackKeyPairResult other = (ImportPlaybackKeyPairResult) obj;
    ...
    public ImportPlaybackKeyPairResult clone() {
        try {
            return (ImportPlaybackKeyPairResult) super.clone();
