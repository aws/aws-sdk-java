...
/**
 * DeleteRecordingConfigurationResult JSON Unmarshaller
 */
...
public class DeleteRecordingConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteRecordingConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteRecordingConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRecordingConfigurationResult deleteRecordingConfigurationResult = new DeleteRecordingConfigurationResult();
