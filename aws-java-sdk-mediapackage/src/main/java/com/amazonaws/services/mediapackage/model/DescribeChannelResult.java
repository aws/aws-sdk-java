...
public class DescribeChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeChannelResult withCreatedAt(String createdAt) {
    ...
    public DescribeChannelResult withEgressAccessLogs(EgressAccessLogs egressAccessLogs) {
    ...
    public DescribeChannelResult withIngressAccessLogs(IngressAccessLogs ingressAccessLogs) {
