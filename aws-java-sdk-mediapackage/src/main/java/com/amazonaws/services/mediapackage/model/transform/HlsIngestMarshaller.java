...
public class HlsIngestMarshaller {
    ...
    private static final MarshallingInfo<List> INGESTENDPOINTS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ingestEndpoints").build();
    ...
    public void marshall(HlsIngest hlsIngest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(hlsIngest.getIngestEndpoints(), INGESTENDPOINTS_BINDING);
        } catch (Exception e) {
