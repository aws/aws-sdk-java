...
public class DashEncryptionMarshaller {
    ...
    public void marshall(DashEncryption dashEncryption, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dashEncryption.getKeyRotationIntervalSeconds(), KEYROTATIONINTERVALSECONDS_BINDING);
            protocolMarshaller.marshall(dashEncryption.getSpekeKeyProvider(), SPEKEKEYPROVIDER_BINDING);
        } catch (Exception e) {
