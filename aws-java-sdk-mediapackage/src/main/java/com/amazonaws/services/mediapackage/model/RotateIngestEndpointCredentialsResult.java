...
public class RotateIngestEndpointCredentialsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public RotateIngestEndpointCredentialsResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see RotateIngestEndpointCredentialsResult#withTags
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RotateIngestEndpointCredentialsResult == false)
            return false;
        RotateIngestEndpointCredentialsResult other = (RotateIngestEndpointCredentialsResult) obj;
    ...
    public RotateIngestEndpointCredentialsResult clone() {
        try {
            return (RotateIngestEndpointCredentialsResult) super.clone();
