        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("manifestWindowSeconds", targetDepth)) {
                    context.nextToken();
                    mssPackage.setManifestWindowSeconds(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                ...
                if (context.testExpression("streamSelection", targetDepth)) {
                    context.nextToken();
                    mssPackage.setStreamSelection(StreamSelectionJsonUnmarshaller.getInstance().unmarshall(context));
                }
