...
public class CreateHarvestJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateHarvestJobResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreateHarvestJobResult withChannelId(String channelId) {
    ...
    public CreateHarvestJobResult withCreatedAt(String createdAt) {
    ...
    public CreateHarvestJobResult withEndTime(String endTime) {
        setEndTime(endTime);
        return this;
    }
    ...
    public CreateHarvestJobResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public CreateHarvestJobResult withOriginEndpointId(String originEndpointId) {
    ...
    public CreateHarvestJobResult withStartTime(String startTime) {
    ...
    public CreateHarvestJobResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateHarvestJobResult == false)
            return false;
        CreateHarvestJobResult other = (CreateHarvestJobResult) obj;
    ...
    @Override
    public CreateHarvestJobResult clone() {
        try {
