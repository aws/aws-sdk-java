...
public class RejectEnvironmentAccountConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectEnvironmentAccountConnectionResult == false)
            return false;
        RejectEnvironmentAccountConnectionResult other = (RejectEnvironmentAccountConnectionResult) obj;
    ...
    public RejectEnvironmentAccountConnectionResult clone() {
        try {
            return (RejectEnvironmentAccountConnectionResult) super.clone();
