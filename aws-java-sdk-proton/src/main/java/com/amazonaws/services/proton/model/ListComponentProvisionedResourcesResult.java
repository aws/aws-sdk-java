...
public class ListComponentProvisionedResourcesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public ListComponentProvisionedResourcesResult withProvisionedResources(ProvisionedResource... provisionedResources) {
    ...
    public ListComponentProvisionedResourcesResult withProvisionedResources(java.util.Collection<ProvisionedResource> provisionedResources) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListComponentProvisionedResourcesResult == false)
            return false;
        ListComponentProvisionedResourcesResult other = (ListComponentProvisionedResourcesResult) obj;
    ...
    public ListComponentProvisionedResourcesResult clone() {
        try {
            return (ListComponentProvisionedResourcesResult) super.clone();
