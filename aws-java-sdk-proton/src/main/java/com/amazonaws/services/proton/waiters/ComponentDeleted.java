...
class ComponentDeleted {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<GetComponentResult> {
        /**
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<GetComponentResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("component"), new JmesPathField("deploymentStatus"));
         ...
         */
        @Override
        public boolean matches(GetComponentResult result) {
