...
public class ServiceSummaryMarshaller {
    ...
    public void marshall(ServiceSummary serviceSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(serviceSummary.getLastModifiedAt(), LASTMODIFIEDAT_BINDING);
            ...
            protocolMarshaller.marshall(serviceSummary.getStatusMessage(), STATUSMESSAGE_BINDING);
            protocolMarshaller.marshall(serviceSummary.getTemplateName(), TEMPLATENAME_BINDING);
        } catch (Exception e) {
