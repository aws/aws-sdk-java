...
class ServiceInstanceDeployed {
    ...
    static class IsSUCCEEDEDMatcher extends WaiterAcceptor<GetServiceInstanceResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("serviceInstance"), new JmesPathField("deploymentStatus"));
         ...
         */
        @Override
        public boolean matches(GetServiceInstanceResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetServiceInstanceResult> {
        private static final JsonNode expectedResult;
