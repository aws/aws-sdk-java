...
public class CreateEnvironmentTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateEnvironmentTemplateResult == false)
            return false;
        CreateEnvironmentTemplateResult other = (CreateEnvironmentTemplateResult) obj;
    ...
    public CreateEnvironmentTemplateResult clone() {
        try {
            return (CreateEnvironmentTemplateResult) super.clone();
