...
public class UpdateEnvironmentTemplateVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateEnvironmentTemplateVersionResult withEnvironmentTemplateVersion(EnvironmentTemplateVersion environmentTemplateVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateEnvironmentTemplateVersionResult == false)
            return false;
        UpdateEnvironmentTemplateVersionResult other = (UpdateEnvironmentTemplateVersionResult) obj;
    ...
    @Override
    public UpdateEnvironmentTemplateVersionResult clone() {
        try {
            return (UpdateEnvironmentTemplateVersionResult) super.clone();
