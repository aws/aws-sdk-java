...
class ServiceCreated {
    ...
    static class IsCREATE_FAILED_CLEANUP_COMPLETEMatcher extends WaiterAcceptor<GetServiceResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"CREATE_FAILED_CLEANUP_COMPLETE\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsCREATE_FAILED_CLEANUP_FAILEDMatcher extends WaiterAcceptor<GetServiceResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"CREATE_FAILED_CLEANUP_FAILED\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<GetServiceResult> {
        private static final JsonNode expectedResult;
