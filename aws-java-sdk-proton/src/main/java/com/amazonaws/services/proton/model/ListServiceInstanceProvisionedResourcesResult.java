...
public class ListServiceInstanceProvisionedResourcesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public ListServiceInstanceProvisionedResourcesResult withNextToken(String nextToken) {
     ...
     * </p>
     * 
     * @return An array of provisioned resources for a service instance.
     */
    ...
    public ListServiceInstanceProvisionedResourcesResult withProvisionedResources(ProvisionedResource... provisionedResources) {
    ...
    public ListServiceInstanceProvisionedResourcesResult withProvisionedResources(java.util.Collection<ProvisionedResource> provisionedResources) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListServiceInstanceProvisionedResourcesResult == false)
            return false;
        ListServiceInstanceProvisionedResourcesResult other = (ListServiceInstanceProvisionedResourcesResult) obj;
    ...
    @Override
    public ListServiceInstanceProvisionedResourcesResult clone() {
        try {
            return (ListServiceInstanceProvisionedResourcesResult) super.clone();
