...
@SdkInternalApi
public class GetRepositoryRequestMarshaller {
    ...
    private static final GetRepositoryRequestMarshaller instance = new GetRepositoryRequestMarshaller();

    public static GetRepositoryRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetRepositoryRequest getRepositoryRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getRepositoryRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(getRepositoryRequest.getProvider(), PROVIDER_BINDING);
        } catch (Exception e) {
