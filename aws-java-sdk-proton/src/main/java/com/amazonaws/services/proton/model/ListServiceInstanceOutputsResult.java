...
public class ListServiceInstanceOutputsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array of service instance Infrastructure as Code (IaC) outputs.
     */
    ...
    public ListServiceInstanceOutputsResult withOutputs(Output... outputs) {
    ...
    public ListServiceInstanceOutputsResult withOutputs(java.util.Collection<Output> outputs) {
        setOutputs(outputs);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListServiceInstanceOutputsResult == false)
            return false;
        ListServiceInstanceOutputsResult other = (ListServiceInstanceOutputsResult) obj;
    ...
    public ListServiceInstanceOutputsResult clone() {
        try {
            return (ListServiceInstanceOutputsResult) super.clone();
