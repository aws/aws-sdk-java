...
public class CreateServiceTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateServiceTemplateResult withServiceTemplate(ServiceTemplate serviceTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateServiceTemplateResult == false)
            return false;
        CreateServiceTemplateResult other = (CreateServiceTemplateResult) obj;
    ...
    @Override
    public CreateServiceTemplateResult clone() {
        try {
            return (CreateServiceTemplateResult) super.clone();
