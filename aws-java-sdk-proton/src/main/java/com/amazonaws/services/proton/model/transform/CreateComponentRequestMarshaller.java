...
public class CreateComponentRequestMarshaller {
    ...
    private static final MarshallingInfo<String> MANIFEST_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("manifest").build();
    ...
    public void marshall(CreateComponentRequest createComponentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createComponentRequest.getServiceInstanceName(), SERVICEINSTANCENAME_BINDING);
            protocolMarshaller.marshall(createComponentRequest.getServiceName(), SERVICENAME_BINDING);
            protocolMarshaller.marshall(createComponentRequest.getServiceSpec(), SERVICESPEC_BINDING);
            protocolMarshaller.marshall(createComponentRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(createComponentRequest.getTemplateFile(), TEMPLATEFILE_BINDING);
        } catch (Exception e) {
