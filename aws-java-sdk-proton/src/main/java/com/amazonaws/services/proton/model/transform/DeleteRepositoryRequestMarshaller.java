...
public class DeleteRepositoryRequestMarshaller {
    ...
    public void marshall(DeleteRepositoryRequest deleteRepositoryRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteRepositoryRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(deleteRepositoryRequest.getProvider(), PROVIDER_BINDING);
        } catch (Exception e) {
