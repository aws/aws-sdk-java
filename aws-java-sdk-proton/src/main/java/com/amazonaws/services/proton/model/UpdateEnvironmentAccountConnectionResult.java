...
public class UpdateEnvironmentAccountConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The environment account connection detail data that's returned by AWS Proton.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateEnvironmentAccountConnectionResult == false)
            return false;
        UpdateEnvironmentAccountConnectionResult other = (UpdateEnvironmentAccountConnectionResult) obj;
    ...
    public UpdateEnvironmentAccountConnectionResult clone() {
        try {
            return (UpdateEnvironmentAccountConnectionResult) super.clone();
