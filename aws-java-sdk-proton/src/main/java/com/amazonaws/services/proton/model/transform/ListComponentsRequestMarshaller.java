...
public class ListComponentsRequestMarshaller {
    ...
    public void marshall(ListComponentsRequest listComponentsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listComponentsRequest.getEnvironmentName(), ENVIRONMENTNAME_BINDING);
            ...
            protocolMarshaller.marshall(listComponentsRequest.getServiceInstanceName(), SERVICEINSTANCENAME_BINDING);
            protocolMarshaller.marshall(listComponentsRequest.getServiceName(), SERVICENAME_BINDING);
        } catch (Exception e) {
