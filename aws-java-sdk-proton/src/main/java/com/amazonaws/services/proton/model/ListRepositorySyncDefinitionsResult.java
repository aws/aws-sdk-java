...
public class ListRepositorySyncDefinitionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
     ...
     * </p>
     */
    private java.util.List<RepositorySyncDefinition> syncDefinitions;
    ...
    public java.util.List<RepositorySyncDefinition> getSyncDefinitions() {
    ...
    public void setSyncDefinitions(java.util.Collection<RepositorySyncDefinition> syncDefinitions) {
        if (syncDefinitions == null) {
            this.syncDefinitions = null;
            return;
        }

        this.syncDefinitions = new java.util.ArrayList<RepositorySyncDefinition>(syncDefinitions);
    }
     ...
     * {@link #setSyncDefinitions(java.util.Collection)} or {@link #withSyncDefinitions(java.util.Collection)} if you
    ...
    public ListRepositorySyncDefinitionsResult withSyncDefinitions(RepositorySyncDefinition... syncDefinitions) {
        if (this.syncDefinitions == null) {
            setSyncDefinitions(new java.util.ArrayList<RepositorySyncDefinition>(syncDefinitions.length));
        }
        for (RepositorySyncDefinition ele : syncDefinitions) {
            this.syncDefinitions.add(ele);
        }
        return this;
    }
    ...
    public ListRepositorySyncDefinitionsResult withSyncDefinitions(java.util.Collection<RepositorySyncDefinition> syncDefinitions) {
        setSyncDefinitions(syncDefinitions);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getNextToken() != null && other.getNextToken().equals(this.getNextToken()) == false)
            return false;
        if (other.getSyncDefinitions() == null ^ this.getSyncDefinitions() == null)
            return false;
        if (other.getSyncDefinitions() != null && other.getSyncDefinitions().equals(this.getSyncDefinitions()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSyncDefinitions() == null) ? 0 : getSyncDefinitions().hashCode());
        return hashCode;
    }
