...
public class LinuxParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * Any of the host devices to expose to the container. This parameter maps to <code>Devices</code> in the <a
    ...
    /**
     * <p>
     * The container path, mount options, and size (in MiB) of the <code>tmpfs</code> mount. This parameter maps to the
     ...
     * doesn't use the swap configuration for the container instance that it's running on. A <code>maxSwap</code> value
     * must be set for the <code>swappiness</code> parameter to be used.
     * </p>
     * <note>
     * <p>
     * This parameter isn't applicable to jobs that are running on Fargate resources. Don't provide it for these jobs.
    ...
    /**
     * <p>
     * You can use this parameter to tune a container's memory swappiness behavior. A <code>swappiness</code> value of
     * <code>0</code> causes swapping to not occur unless absolutely necessary. A <code>swappiness</code> value of
     * <code>100</code> causes pages to be swapped aggressively. Valid values are whole numbers between <code>0</code>
     * and <code>100</code>. If the <code>swappiness</code> parameter isn't specified, a default value of
     ...
     * container has a default <code>swappiness</code> value of 60. Moreover, the total swap usage is limited to two
     ...
     * </note>
     * 
     * @return Any of the host devices to expose to the container. This parameter maps to <code>Devices</code> in the <a
     ...
     * </note>
     * 
     * @return The container path, mount options, and size (in MiB) of the <code>tmpfs</code> mount. This parameter maps
     ...
     * 
     * @param tmpfs
     *        The container path, mount options, and size (in MiB) of the <code>tmpfs</code> mount. This parameter maps
     *        to the <code>--tmpfs</code> option to <a href="https://docs.docker.com/engine/reference/run/">docker
     *        run</a>.</p> <note>
     *        <p>
     *        This parameter isn't applicable to jobs that are running on Fargate resources. Don't provide this
     ...
     *        value of <code>0</code> causes swapping to not occur unless absolutely necessary. A
     *        <code>swappiness</code> value of <code>100</code> causes pages to be swapped aggressively. Valid values
     *        are whole numbers between <code>0</code> and <code>100</code>. If the <code>swappiness</code> parameter
     *        isn't specified, a default value of <code>60</code> is used. If a value isn't specified for
     *        <code>maxSwap</code>, then this parameter is ignored. If <code>maxSwap</code> is set to 0, the container
     *        doesn't use swap. This parameter maps to the <code>--memory-swappiness</code> option to <a
     ...
     *        <p>
     *        If the <code>maxSwap</code> and <code>swappiness</code> parameters are omitted from a job definition, each
     *        container has a default <code>swappiness</code> value of 60. Moreover, the total swap usage is limited to
     ...
     * </note>
     * 
     * @return You can use this parameter to tune a container's memory swappiness behavior. A <code>swappiness</code>
     *         value of <code>0</code> causes swapping to not occur unless absolutely necessary. A
     *         <code>swappiness</code> value of <code>100</code> causes pages to be swapped aggressively. Valid values
     *         are whole numbers between <code>0</code> and <code>100</code>. If the <code>swappiness</code> parameter
     *         isn't specified, a default value of <code>60</code> is used. If a value isn't specified for
     ...
     *         to use this feature. For more information, see <a
     ...
     *         each container has a default <code>swappiness</code> value of 60. Moreover, the total swap usage is
