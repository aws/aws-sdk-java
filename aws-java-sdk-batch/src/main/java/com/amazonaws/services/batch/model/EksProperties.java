 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/EksProperties" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EksProperties implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private EksPodProperties podProperties;
    ...
    public EksPodProperties getPodProperties() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EksProperties == false)
            return false;
        EksProperties other = (EksProperties) obj;
    ...
    @Override
    public EksProperties clone() {
        try {
            return (EksProperties) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.batch.model.transform.EksPropertiesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
