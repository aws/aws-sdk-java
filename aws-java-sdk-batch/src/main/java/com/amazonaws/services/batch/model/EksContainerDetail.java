 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/EksContainerDetail" target="_top">AWS API
 *      Documentation</a>
 */
...
public class EksContainerDetail implements Serializable, Cloneable, StructuredPojo {
     ...
     * <code>Never</code>. This parameter defaults to <code>Always</code> if the <code>:latest</code> tag is specified,
     * <code>IfNotPresent</code> otherwise. For more information, see <a
     ...
     *        <code>IfNotPresent</code>, and <code>Never</code>. This parameter defaults to <code>Always</code> if the
     *        <code>:latest</code> tag is specified, <code>IfNotPresent</code> otherwise. For more information, see <a
     *        href="https://kubernetes.io/docs/concepts/containers/images/#updating-images">Updating images</a> in the
     *        <i>Kubernetes documentation</i>.
     */
     ...
     * </p>
     * 
     * @return The entrypoint for the container. For more information, see <a
    ...
    public EksContainerDetail withCommand(java.util.Collection<String> command) {
        setCommand(command);
        return this;
    }
    ...
    public EksContainerDetail withArgs(java.util.Collection<String> args) {
        setArgs(args);
        return this;
    }
    ...
    public EksContainerDetail withEnv(java.util.Collection<EksContainerEnvironmentVariable> env) {
        setEnv(env);
        return this;
    }
     ...
     * </p>
     * 
     * @return A short human-readable string to provide additional details for a running or stopped container. It can be
     *         up to 255 characters long.
     */
    ...
    public EksContainerDetail withVolumeMounts(java.util.Collection<EksContainerVolumeMount> volumeMounts) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EksContainerDetail == false)
            return false;
        EksContainerDetail other = (EksContainerDetail) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.batch.model.transform.EksContainerDetailMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
