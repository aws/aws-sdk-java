...
public class EksConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> KUBERNETESNAMESPACE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("kubernetesNamespace").build();
    ...
    public void marshall(EksConfiguration eksConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(eksConfiguration.getEksClusterArn(), EKSCLUSTERARN_BINDING);
            protocolMarshaller.marshall(eksConfiguration.getKubernetesNamespace(), KUBERNETESNAMESPACE_BINDING);
        } catch (Exception e) {
