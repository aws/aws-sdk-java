...
public class ResourceRequirement implements Serializable, Cloneable, StructuredPojo {
     ...
     * should not exceed the number of available GPUs on the compute resource that the job is launched on.
     * </p>
     */
    private String value;
    /**
     * <p>
     * The type of resource to assign to a container. Currently, the only supported resource type is <code>GPU</code>.
     * </p>
     */
    private String type;
     ...
     * </p>
     * 
     * @return The number of physical GPUs to reserve for the container. The number of GPUs reserved for all containers
     *         in a job should not exceed the number of available GPUs on the compute resource that the job is launched
     *         on.
     */
     ...
     * </p>
     * 
     * @return The type of resource to assign to a container. Currently, the only supported resource type is
     *         <code>GPU</code>.
     * @see ResourceType
     */
