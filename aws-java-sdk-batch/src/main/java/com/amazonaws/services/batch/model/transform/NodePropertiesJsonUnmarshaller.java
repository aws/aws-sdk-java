...
/**
 * NodeProperties JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NodePropertiesJsonUnmarshaller implements Unmarshaller<NodeProperties, JsonUnmarshallerContext> {

    public NodeProperties unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static NodePropertiesJsonUnmarshaller instance;

    public static NodePropertiesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new NodePropertiesJsonUnmarshaller();
        return instance;
    }
}
