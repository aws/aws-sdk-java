...
/**
 * AttemptDetail JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AttemptDetailJsonUnmarshaller implements Unmarshaller<AttemptDetail, JsonUnmarshallerContext> {
    ...
    private static AttemptDetailJsonUnmarshaller instance;

    public static AttemptDetailJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AttemptDetailJsonUnmarshaller();
        return instance;
    }
}
