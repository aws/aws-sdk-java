...
/**
 * ResourceRequirement JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("value", targetDepth)) {
                    context.nextToken();
                    resourceRequirement.setValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("type", targetDepth)) {
                    context.nextToken();
                    resourceRequirement.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
