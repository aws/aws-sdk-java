...
public class RegisterJobDefinitionRequestMarshaller {
    ...
    public void marshall(RegisterJobDefinitionRequest registerJobDefinitionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(registerJobDefinitionRequest.getSchedulingPriority(), SCHEDULINGPRIORITY_BINDING);
            ...
            protocolMarshaller.marshall(registerJobDefinitionRequest.getPropagateTags(), PROPAGATETAGS_BINDING);
