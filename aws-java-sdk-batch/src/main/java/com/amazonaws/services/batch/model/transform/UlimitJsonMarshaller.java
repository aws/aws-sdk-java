    ...
    public void marshall(Ulimit ulimit, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (ulimit.getHardLimit() != null) {
                jsonGenerator.writeFieldName("hardLimit").writeValue(ulimit.getHardLimit());
            }
            if (ulimit.getName() != null) {
                jsonGenerator.writeFieldName("name").writeValue(ulimit.getName());
            }
            if (ulimit.getSoftLimit() != null) {
                jsonGenerator.writeFieldName("softLimit").writeValue(ulimit.getSoftLimit());
            }
