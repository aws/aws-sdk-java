...
public class DetectLabelsImageForeground implements Serializable, Cloneable, StructuredPojo {
    ...
    public DetectLabelsImageForeground withDominantColors(java.util.Collection<DominantColor> dominantColors) {
    ...
    @Override
    public DetectLabelsImageForeground clone() {
        try {
            return (DetectLabelsImageForeground) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.DetectLabelsImageForegroundMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
