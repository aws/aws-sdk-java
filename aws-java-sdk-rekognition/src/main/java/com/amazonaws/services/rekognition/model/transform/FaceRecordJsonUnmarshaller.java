...
/**
 * FaceRecord JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FaceRecordJsonUnmarshaller implements Unmarshaller<FaceRecord, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("FaceDetail", targetDepth)) {
                    context.nextToken();
                    faceRecord.setFaceDetail(FaceDetailJsonUnmarshaller.getInstance().unmarshall(context));
                }
