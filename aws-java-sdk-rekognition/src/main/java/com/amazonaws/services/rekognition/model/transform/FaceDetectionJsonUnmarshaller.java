...
/**
 * FaceDetection JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FaceDetectionJsonUnmarshaller implements Unmarshaller<FaceDetection, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Timestamp", targetDepth)) {
                    context.nextToken();
                    faceDetection.setTimestamp(context.getUnmarshaller(Long.class).unmarshall(context));
                }
