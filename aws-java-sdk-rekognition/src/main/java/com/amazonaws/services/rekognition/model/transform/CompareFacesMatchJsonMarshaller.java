 ...
 */
public class CompareFacesMatchJsonMarshaller {

    /**
     * Marshall the given parameter object, and output to a SdkJsonGenerator
     */
    public void marshall(CompareFacesMatch compareFacesMatch, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (compareFacesMatch.getSimilarity() != null) {
                jsonGenerator.writeFieldName("Similarity").writeValue(compareFacesMatch.getSimilarity());
            }
            if (compareFacesMatch.getFace() != null) {
                jsonGenerator.writeFieldName("Face");
                ComparedFaceJsonMarshaller.getInstance().marshall(compareFacesMatch.getFace(), jsonGenerator);
            }
