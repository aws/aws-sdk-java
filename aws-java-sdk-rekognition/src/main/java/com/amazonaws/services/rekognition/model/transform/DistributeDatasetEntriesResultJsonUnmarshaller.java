...
/**
 * DistributeDatasetEntriesResult JSON Unmarshaller
 */
...
public class DistributeDatasetEntriesResultJsonUnmarshaller implements Unmarshaller<DistributeDatasetEntriesResult, JsonUnmarshallerContext> {
    ...
    public DistributeDatasetEntriesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DistributeDatasetEntriesResult distributeDatasetEntriesResult = new DistributeDatasetEntriesResult();

        return distributeDatasetEntriesResult;
    }
