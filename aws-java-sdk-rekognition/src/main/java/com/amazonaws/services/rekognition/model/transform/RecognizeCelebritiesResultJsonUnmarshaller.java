...
/**
 * RecognizeCelebritiesResult JSON Unmarshaller
 */
...
public class RecognizeCelebritiesResultJsonUnmarshaller implements Unmarshaller<RecognizeCelebritiesResult, JsonUnmarshallerContext> {
    ...
    public RecognizeCelebritiesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CelebrityFaces", targetDepth)) {
                    context.nextToken();
                    recognizeCelebritiesResult.setCelebrityFaces(new ListUnmarshaller<Celebrity>(CelebrityJsonUnmarshaller.getInstance()).unmarshall(context));
                }
