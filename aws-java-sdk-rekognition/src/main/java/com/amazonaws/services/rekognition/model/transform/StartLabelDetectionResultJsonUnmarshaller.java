...
/**
 * StartLabelDetectionResult JSON Unmarshaller
 */
...
public class StartLabelDetectionResultJsonUnmarshaller implements Unmarshaller<StartLabelDetectionResult, JsonUnmarshallerContext> {
    ...
    public StartLabelDetectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobId", targetDepth)) {
                    context.nextToken();
                    startLabelDetectionResult.setJobId(context.getUnmarshaller(String.class).unmarshall(context));
                }
