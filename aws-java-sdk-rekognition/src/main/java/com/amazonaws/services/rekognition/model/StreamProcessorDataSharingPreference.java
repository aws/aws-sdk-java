...
public class StreamProcessorDataSharingPreference implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public StreamProcessorDataSharingPreference clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.StreamProcessorDataSharingPreferenceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
