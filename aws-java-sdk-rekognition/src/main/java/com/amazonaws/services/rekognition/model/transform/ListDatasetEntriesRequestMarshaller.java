...
public class ListDatasetEntriesRequestMarshaller {
    ...
    private static final MarshallingInfo<List> CONTAINSLABELS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ContainsLabels").build();
    private static final MarshallingInfo<Boolean> LABELED_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Labeled").build();
    private static final MarshallingInfo<String> SOURCEREFCONTAINS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("SourceRefContains").build();
    private static final MarshallingInfo<Boolean> HASERRORS_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("HasErrors").build();
    ...
    public void marshall(ListDatasetEntriesRequest listDatasetEntriesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listDatasetEntriesRequest.getDatasetArn(), DATASETARN_BINDING);
            protocolMarshaller.marshall(listDatasetEntriesRequest.getContainsLabels(), CONTAINSLABELS_BINDING);
            ...
            protocolMarshaller.marshall(listDatasetEntriesRequest.getHasErrors(), HASERRORS_BINDING);
