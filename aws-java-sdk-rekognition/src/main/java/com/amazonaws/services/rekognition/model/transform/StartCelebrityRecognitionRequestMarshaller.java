...
@SdkInternalApi
public class StartCelebrityRecognitionRequestMarshaller {
    ...
    private static final StartCelebrityRecognitionRequestMarshaller instance = new StartCelebrityRecognitionRequestMarshaller();

    public static StartCelebrityRecognitionRequestMarshaller getInstance() {
        return instance;
    }
