...
public class VideoTooLargeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static VideoTooLargeExceptionUnmarshaller instance;

    public static VideoTooLargeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new VideoTooLargeExceptionUnmarshaller();
        return instance;
    }
}
