...
/**
 * Parent JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParentJsonUnmarshaller implements Unmarshaller<Parent, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    parent.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
