...
/**
 * ListProjectPoliciesResult JSON Unmarshaller
 */
...
public class ListProjectPoliciesResultJsonUnmarshaller implements Unmarshaller<ListProjectPoliciesResult, JsonUnmarshallerContext> {
    ...
    public ListProjectPoliciesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ProjectPolicies", targetDepth)) {
                    context.nextToken();
                    listProjectPoliciesResult.setProjectPolicies(new ListUnmarshaller<ProjectPolicy>(ProjectPolicyJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listProjectPoliciesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
