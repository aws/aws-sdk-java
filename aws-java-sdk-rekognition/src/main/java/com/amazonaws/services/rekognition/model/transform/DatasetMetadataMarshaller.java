...
public class DatasetMetadataMarshaller {
    ...
    private static final MarshallingInfo<String> STATUSMESSAGECODE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("StatusMessageCode").build();
    ...
    public void marshall(DatasetMetadata datasetMetadata, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(datasetMetadata.getStatusMessageCode(), STATUSMESSAGECODE_BINDING);
        } catch (Exception e) {
