...
public class InvalidImageFormatExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidImageFormatExceptionUnmarshaller instance;

    public static InvalidImageFormatExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidImageFormatExceptionUnmarshaller();
        return instance;
    }
}
