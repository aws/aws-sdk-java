...
/**
 * ShotSegment JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ShotSegmentJsonUnmarshaller implements Unmarshaller<ShotSegment, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Index", targetDepth)) {
                    context.nextToken();
                    shotSegment.setIndex(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("Confidence", targetDepth)) {
                    context.nextToken();
                    shotSegment.setConfidence(context.getUnmarshaller(Float.class).unmarshall(context));
                }
