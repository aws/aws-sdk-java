...
public class StartPersonTrackingRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The video in which you want to detect people. The video must be stored in an Amazon S3 bucket.
     */
    ...
    @Override
    public StartPersonTrackingRequest clone() {
        return (StartPersonTrackingRequest) super.clone();
    }
