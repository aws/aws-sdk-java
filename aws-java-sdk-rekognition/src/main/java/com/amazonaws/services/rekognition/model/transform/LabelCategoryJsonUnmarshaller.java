...
/**
 * LabelCategory JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LabelCategoryJsonUnmarshaller implements Unmarshaller<LabelCategory, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    labelCategory.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
