...
/**
 * StartFaceDetectionResult JSON Unmarshaller
 */
...
public class StartFaceDetectionResultJsonUnmarshaller implements Unmarshaller<StartFaceDetectionResult, JsonUnmarshallerContext> {
    ...
    public StartFaceDetectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobId", targetDepth)) {
                    context.nextToken();
                    startFaceDetectionResult.setJobId(context.getUnmarshaller(String.class).unmarshall(context));
                }
