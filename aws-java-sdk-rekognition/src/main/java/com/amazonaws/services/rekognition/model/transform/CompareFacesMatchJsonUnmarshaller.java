...
/**
 * CompareFacesMatch JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CompareFacesMatchJsonUnmarshaller implements Unmarshaller<CompareFacesMatch, JsonUnmarshallerContext> {

    public CompareFacesMatch unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Similarity", targetDepth)) {
                    context.nextToken();
                    compareFacesMatch.setSimilarity(context.getUnmarshaller(Float.class).unmarshall(context));
                }
