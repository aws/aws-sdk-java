...
/**
 * StreamProcessorInput JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StreamProcessorInputJsonUnmarshaller implements Unmarshaller<StreamProcessorInput, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("KinesisVideoStream", targetDepth)) {
                    context.nextToken();
                    streamProcessorInput.setKinesisVideoStream(KinesisVideoStreamJsonUnmarshaller.getInstance().unmarshall(context));
                }
