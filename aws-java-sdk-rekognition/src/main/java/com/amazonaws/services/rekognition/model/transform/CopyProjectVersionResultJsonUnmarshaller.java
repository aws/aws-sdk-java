...
/**
 * CopyProjectVersionResult JSON Unmarshaller
 */
...
public class CopyProjectVersionResultJsonUnmarshaller implements Unmarshaller<CopyProjectVersionResult, JsonUnmarshallerContext> {
    ...
    public CopyProjectVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ProjectVersionArn", targetDepth)) {
                    context.nextToken();
                    copyProjectVersionResult.setProjectVersionArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
