...
public class WarningMarshaller {
    ...
    private static final MarshallingInfo<List> SECTIONS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(Warning warning, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(warning.getErrorCode(), ERRORCODE_BINDING);
            protocolMarshaller.marshall(warning.getMessage(), MESSAGE_BINDING);
            protocolMarshaller.marshall(warning.getSections(), SECTIONS_BINDING);
        } catch (Exception e) {
