...
@SdkInternalApi
public class DeleteProjectPolicyRequestMarshaller {
    ...
    private static final DeleteProjectPolicyRequestMarshaller instance = new DeleteProjectPolicyRequestMarshaller();

    public static DeleteProjectPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteProjectPolicyRequest deleteProjectPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteProjectPolicyRequest.getProjectArn(), PROJECTARN_BINDING);
            protocolMarshaller.marshall(deleteProjectPolicyRequest.getPolicyName(), POLICYNAME_BINDING);
            protocolMarshaller.marshall(deleteProjectPolicyRequest.getPolicyRevisionId(), POLICYREVISIONID_BINDING);
        } catch (Exception e) {
