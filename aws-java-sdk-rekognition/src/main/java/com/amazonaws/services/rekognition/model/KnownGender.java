...
public class KnownGender implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return A string value of the KnownGender info about the Celebrity.
     * @see KnownGenderType
     */
    ...
    public KnownGender clone() {
        try {
            return (KnownGender) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.KnownGenderMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
