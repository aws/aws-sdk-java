...
public class StreamProcessorNotificationChannel implements Serializable, Cloneable, StructuredPojo {
    ...
    public StreamProcessorNotificationChannel clone() {
        try {
            return (StreamProcessorNotificationChannel) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.StreamProcessorNotificationChannelMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
