...
@SdkInternalApi
public class DescribeCollectionRequestMarshaller {
    ...
    private static final DescribeCollectionRequestMarshaller instance = new DescribeCollectionRequestMarshaller();

    public static DescribeCollectionRequestMarshaller getInstance() {
        return instance;
    }
