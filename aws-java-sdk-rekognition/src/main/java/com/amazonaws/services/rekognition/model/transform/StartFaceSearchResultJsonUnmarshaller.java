...
/**
 * StartFaceSearchResult JSON Unmarshaller
 */
...
public class StartFaceSearchResultJsonUnmarshaller implements Unmarshaller<StartFaceSearchResult, JsonUnmarshallerContext> {
    ...
    public StartFaceSearchResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobId", targetDepth)) {
                    context.nextToken();
                    startFaceSearchResult.setJobId(context.getUnmarshaller(String.class).unmarshall(context));
                }
