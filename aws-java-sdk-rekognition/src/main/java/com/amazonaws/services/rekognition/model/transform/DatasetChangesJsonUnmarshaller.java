...
/**
 * DatasetChanges JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DatasetChangesJsonUnmarshaller implements Unmarshaller<DatasetChanges, JsonUnmarshallerContext> {
    ...
    public DatasetChanges unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GroundTruth", targetDepth)) {
                    context.nextToken();
                    datasetChanges.setGroundTruth(context.getUnmarshaller(java.nio.ByteBuffer.class).unmarshall(context));
                }
