...
public class StreamProcessorSettingsForUpdate implements Serializable, Cloneable, StructuredPojo {
    ...
    public StreamProcessorSettingsForUpdate withConnectedHomeForUpdate(ConnectedHomeSettingsForUpdate connectedHomeForUpdate) {
        setConnectedHomeForUpdate(connectedHomeForUpdate);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getConnectedHomeForUpdate() != null)
            sb.append("ConnectedHomeForUpdate: ").append(getConnectedHomeForUpdate());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getConnectedHomeForUpdate() == null ^ this.getConnectedHomeForUpdate() == null)
            return false;
        if (other.getConnectedHomeForUpdate() != null && other.getConnectedHomeForUpdate().equals(this.getConnectedHomeForUpdate()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getConnectedHomeForUpdate() == null) ? 0 : getConnectedHomeForUpdate().hashCode());
        return hashCode;
    }

    @Override
    public StreamProcessorSettingsForUpdate clone() {
        try {
            return (StreamProcessorSettingsForUpdate) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.StreamProcessorSettingsForUpdateMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
