...
/**
 * StopProjectVersionResult JSON Unmarshaller
 */
...
public class StopProjectVersionResultJsonUnmarshaller implements Unmarshaller<StopProjectVersionResult, JsonUnmarshallerContext> {
    ...
    public StopProjectVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    stopProjectVersionResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
