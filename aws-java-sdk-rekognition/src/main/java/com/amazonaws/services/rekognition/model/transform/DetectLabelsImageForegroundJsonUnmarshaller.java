...
/**
 * DetectLabelsImageForeground JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DetectLabelsImageForegroundJsonUnmarshaller implements Unmarshaller<DetectLabelsImageForeground, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Quality", targetDepth)) {
                    context.nextToken();
                    detectLabelsImageForeground.setQuality(DetectLabelsImageQualityJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("DominantColors", targetDepth)) {
                    context.nextToken();
                    detectLabelsImageForeground.setDominantColors(new ListUnmarshaller<DominantColor>(DominantColorJsonUnmarshaller.getInstance())
