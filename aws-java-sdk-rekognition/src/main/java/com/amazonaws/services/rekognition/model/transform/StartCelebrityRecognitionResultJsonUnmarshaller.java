...
/**
 * StartCelebrityRecognitionResult JSON Unmarshaller
 */
...
public class StartCelebrityRecognitionResultJsonUnmarshaller implements Unmarshaller<StartCelebrityRecognitionResult, JsonUnmarshallerContext> {
    ...
    public StartCelebrityRecognitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobId", targetDepth)) {
                    context.nextToken();
                    startCelebrityRecognitionResult.setJobId(context.getUnmarshaller(String.class).unmarshall(context));
                }
