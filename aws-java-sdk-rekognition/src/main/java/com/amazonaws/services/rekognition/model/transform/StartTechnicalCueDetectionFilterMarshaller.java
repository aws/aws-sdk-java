...
/**
 * StartTechnicalCueDetectionFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StartTechnicalCueDetectionFilterMarshaller {
    ...
    public static StartTechnicalCueDetectionFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartTechnicalCueDetectionFilter startTechnicalCueDetectionFilter, ProtocolMarshaller protocolMarshaller) {

        if (startTechnicalCueDetectionFilter == null) {
