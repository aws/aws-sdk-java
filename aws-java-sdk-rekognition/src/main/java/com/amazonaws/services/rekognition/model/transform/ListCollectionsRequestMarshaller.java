...
public class ListCollectionsRequestMarshaller {
    ...
    private static final ListCollectionsRequestMarshaller instance = new ListCollectionsRequestMarshaller();

    public static ListCollectionsRequestMarshaller getInstance() {
        return instance;
    }
