...
/**
 * PutProjectPolicyResult JSON Unmarshaller
 */
...
public class PutProjectPolicyResultJsonUnmarshaller implements Unmarshaller<PutProjectPolicyResult, JsonUnmarshallerContext> {
    ...
    public PutProjectPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PolicyRevisionId", targetDepth)) {
                    context.nextToken();
                    putProjectPolicyResult.setPolicyRevisionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
