...
public class EyeOpenJsonMarshaller {
     ...
     */
    public void marshall(EyeOpen eyeOpen, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (eyeOpen.getValue() != null) {
                jsonGenerator.writeFieldName("Value").writeValue(eyeOpen.getValue());
            }
            if (eyeOpen.getConfidence() != null) {
                jsonGenerator.writeFieldName("Confidence").writeValue(eyeOpen.getConfidence());
            }
