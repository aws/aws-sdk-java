...
/**
 * DeleteProjectPolicyResult JSON Unmarshaller
 */
...
public class DeleteProjectPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteProjectPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteProjectPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteProjectPolicyResult deleteProjectPolicyResult = new DeleteProjectPolicyResult();

        return deleteProjectPolicyResult;
    }
