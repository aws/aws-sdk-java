...
/**
 * ListDatasetEntriesResult JSON Unmarshaller
 */
    ...
    public ListDatasetEntriesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DatasetEntries", targetDepth)) {
                    context.nextToken();
                    listDatasetEntriesResult.setDatasetEntries(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listDatasetEntriesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
