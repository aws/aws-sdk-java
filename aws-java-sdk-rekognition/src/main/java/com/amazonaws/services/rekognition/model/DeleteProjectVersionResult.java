...
public class DeleteProjectVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public DeleteProjectVersionResult clone() {
        try {
            return (DeleteProjectVersionResult) super.clone();
