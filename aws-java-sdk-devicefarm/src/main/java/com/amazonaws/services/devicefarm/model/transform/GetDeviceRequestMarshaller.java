...
public class GetDeviceRequestMarshaller implements Marshaller<Request<GetDeviceRequest>, GetDeviceRequest> {
    ...
    public Request<GetDeviceRequest> marshall(GetDeviceRequest getDeviceRequest) {
        ...
        Request<GetDeviceRequest> request = new DefaultRequest<GetDeviceRequest>(getDeviceRequest, "AWSDeviceFarm");
        ...
        try {
            ...
            if (getDeviceRequest.getArn() != null) {
                jsonGenerator.writeFieldName("arn").writeValue(getDeviceRequest.getArn());
            }
