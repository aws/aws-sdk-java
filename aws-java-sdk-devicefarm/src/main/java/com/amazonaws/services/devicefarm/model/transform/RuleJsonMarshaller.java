    ...
    public void marshall(Rule rule, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (rule.getAttribute() != null) {
                jsonGenerator.writeFieldName("attribute").writeValue(rule.getAttribute());
            }
            if (rule.getOperator() != null) {
                jsonGenerator.writeFieldName("operator").writeValue(rule.getOperator());
            }
            if (rule.getValue() != null) {
                jsonGenerator.writeFieldName("value").writeValue(rule.getValue());
            }
