 ...
 */
public class InstallToRemoteAccessSessionResultJsonUnmarshaller
        implements
        Unmarshaller<InstallToRemoteAccessSessionResult, JsonUnmarshallerContext> {

    public InstallToRemoteAccessSessionResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("appUpload", targetDepth)) {
                    ...
                    installToRemoteAccessSessionResult
                            .setAppUpload(UploadJsonUnmarshaller.getInstance()
                                    .unmarshall(context));
                }
