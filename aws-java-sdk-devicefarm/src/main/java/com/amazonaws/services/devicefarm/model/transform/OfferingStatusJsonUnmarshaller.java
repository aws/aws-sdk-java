 ...
 */
public class OfferingStatusJsonUnmarshaller implements
        Unmarshaller<OfferingStatus, JsonUnmarshallerContext> {

    public OfferingStatus unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("offering", targetDepth)) {
                    context.nextToken();
                    offeringStatus.setOffering(OfferingJsonUnmarshaller
