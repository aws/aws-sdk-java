...
public class OfferingTransactionJsonMarshaller {
     ...
     */
    public void marshall(OfferingTransaction offeringTransaction,
        ...
        try {
            ...
            if (offeringTransaction.getOfferingStatus() != null) {
                ...
                OfferingStatusJsonMarshaller.getInstance().marshall(
                        offeringTransaction.getOfferingStatus(), jsonGenerator);
            }
            if (offeringTransaction.getTransactionId() != null) {
                jsonGenerator.writeFieldName("transactionId").writeValue(
                        offeringTransaction.getTransactionId());
            }
            if (offeringTransaction.getCreatedOn() != null) {
                jsonGenerator.writeFieldName("createdOn").writeValue(
                        offeringTransaction.getCreatedOn());
            }
            if (offeringTransaction.getCost() != null) {
                jsonGenerator.writeFieldName("cost");
                MonetaryAmountJsonMarshaller.getInstance().marshall(
                        offeringTransaction.getCost(), jsonGenerator);
            }
