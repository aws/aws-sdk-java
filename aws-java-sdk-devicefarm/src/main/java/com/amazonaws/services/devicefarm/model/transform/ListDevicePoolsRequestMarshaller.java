...
public class ListDevicePoolsRequestMarshaller implements Marshaller<Request<ListDevicePoolsRequest>, ListDevicePoolsRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public ListDevicePoolsRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<ListDevicePoolsRequest> marshall(ListDevicePoolsRequest listDevicePoolsRequest) {
        ...
        Request<ListDevicePoolsRequest> request = new DefaultRequest<ListDevicePoolsRequest>(listDevicePoolsRequest, "AWSDeviceFarm");
