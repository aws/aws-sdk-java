 ...
 */
public class CreateDevicePoolResultJsonUnmarshaller implements
        Unmarshaller<CreateDevicePoolResult, JsonUnmarshallerContext> {

    public CreateDevicePoolResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
