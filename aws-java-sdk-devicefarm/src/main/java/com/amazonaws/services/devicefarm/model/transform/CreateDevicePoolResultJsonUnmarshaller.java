...
public class CreateDevicePoolResultJsonUnmarshaller implements Unmarshaller<CreateDevicePoolResult, JsonUnmarshallerContext> {
    ...
    public CreateDevicePoolResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("devicePool", targetDepth)) {
                    context.nextToken();
                    createDevicePoolResult.setDevicePool(DevicePoolJsonUnmarshaller.getInstance().unmarshall(context));
                }
