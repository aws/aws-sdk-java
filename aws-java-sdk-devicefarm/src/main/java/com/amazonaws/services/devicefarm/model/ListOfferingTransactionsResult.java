 ...
 * </p>
 */
public class ListOfferingTransactionsResult implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The audit log of subscriptions you have purchased and modified
    ...
    public void setOfferingTransactions(
            java.util.Collection<OfferingTransaction> offeringTransactions) {
        if (offeringTransactions == null) {
            this.offeringTransactions = null;
            return;
        }

        this.offeringTransactions = new java.util.ArrayList<OfferingTransaction>(
     ...
     * any). Use {@link #setOfferingTransactions(java.util.Collection)} or
     * {@link #withOfferingTransactions(java.util.Collection)} if you want to
    ...
    public ListOfferingTransactionsResult withOfferingTransactions(
            OfferingTransaction... offeringTransactions) {
        if (this.offeringTransactions == null) {
            setOfferingTransactions(new java.util.ArrayList<OfferingTransaction>(
                    offeringTransactions.length));
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getOfferingTransactions() == null
                ^ this.getOfferingTransactions() == null)
            return false;
        if (other.getOfferingTransactions() != null
                && other.getOfferingTransactions().equals(
                        this.getOfferingTransactions()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getOfferingTransactions() == null) ? 0
                        : getOfferingTransactions().hashCode());
