...
public class ListProjectsResultJsonUnmarshaller implements
    ...
    public ListProjectsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("projects", targetDepth)) {
                    context.nextToken();
                    listProjectsResult
                            .setProjects(new ListUnmarshaller<Project>(
                                    ProjectJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listProjectsResult.setNextToken(context.getUnmarshaller(
