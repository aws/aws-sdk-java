...
/**
 * ListRemoteAccessSessionsRequestMarshaller
 */
...
public class ListRemoteAccessSessionsRequestMarshaller {
    ...
    private static final ListRemoteAccessSessionsRequestMarshaller instance = new ListRemoteAccessSessionsRequestMarshaller();

    public static ListRemoteAccessSessionsRequestMarshaller getInstance() {
        return instance;
    }
