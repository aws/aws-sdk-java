...
public class OfferingStatusMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> OFFERING_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("offering").build();
