 ...
 * </p>
 */
public class ListArtifactsResult implements Serializable, Cloneable {
     ...
     * any). Use {@link #setArtifacts(java.util.Collection)} or
     * {@link #withArtifacts(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param artifacts
     ...
     *         chained together.
     */
    public ListArtifactsResult withArtifacts(
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getArtifacts() == null) ? 0 : getArtifacts().hashCode());
        hashCode = prime * hashCode
