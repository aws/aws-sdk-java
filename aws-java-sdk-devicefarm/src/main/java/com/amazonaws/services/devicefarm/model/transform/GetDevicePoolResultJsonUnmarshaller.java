 ...
 */
public class GetDevicePoolResultJsonUnmarshaller implements
        Unmarshaller<GetDevicePoolResult, JsonUnmarshallerContext> {

    public GetDevicePoolResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
