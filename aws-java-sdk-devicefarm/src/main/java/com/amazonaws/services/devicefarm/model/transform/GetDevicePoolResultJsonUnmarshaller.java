...
public class GetDevicePoolResultJsonUnmarshaller implements Unmarshaller<GetDevicePoolResult, JsonUnmarshallerContext> {
    ...
    public GetDevicePoolResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("devicePool", targetDepth)) {
                    context.nextToken();
                    getDevicePoolResult.setDevicePool(DevicePoolJsonUnmarshaller.getInstance().unmarshall(context));
                }
