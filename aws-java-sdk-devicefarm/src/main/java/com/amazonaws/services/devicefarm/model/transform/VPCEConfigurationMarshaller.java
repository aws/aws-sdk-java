...
/**
 * VPCEConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VPCEConfigurationMarshaller {
    ...
    private static final VPCEConfigurationMarshaller instance = new VPCEConfigurationMarshaller();

    public static VPCEConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VPCEConfiguration vPCEConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (vPCEConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(vPCEConfiguration.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(vPCEConfiguration.getVpceConfigurationName(), VPCECONFIGURATIONNAME_BINDING);
            protocolMarshaller.marshall(vPCEConfiguration.getVpceServiceName(), VPCESERVICENAME_BINDING);
            protocolMarshaller.marshall(vPCEConfiguration.getServiceDnsName(), SERVICEDNSNAME_BINDING);
            protocolMarshaller.marshall(vPCEConfiguration.getVpceConfigurationDescription(), VPCECONFIGURATIONDESCRIPTION_BINDING);
        } catch (Exception e) {
