 ...
 */
public class GetOfferingStatusResultJsonUnmarshaller implements
        Unmarshaller<GetOfferingStatusResult, JsonUnmarshallerContext> {

    public GetOfferingStatusResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
