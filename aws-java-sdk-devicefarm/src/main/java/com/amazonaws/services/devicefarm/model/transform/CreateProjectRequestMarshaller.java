...
public class CreateProjectRequestMarshaller implements
    ...
    public Request<CreateProjectRequest> marshall(
        ...
        Request<CreateProjectRequest> request = new DefaultRequest<CreateProjectRequest>(
                createProjectRequest, "AWSDeviceFarm");
        request.addHeader("X-Amz-Target", "DeviceFarm_20150623.CreateProject");
        ...
        try {
            ...
            if (createProjectRequest.getName() != null) {
                jsonWriter.key("name").value(createProjectRequest.getName());
            }
