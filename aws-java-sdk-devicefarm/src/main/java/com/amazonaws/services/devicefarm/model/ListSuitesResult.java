 ...
 * </p>
 */
public class ListSuitesResult implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSuites() == null ^ this.getSuites() == null)
            return false;
        if (other.getSuites() != null
                && other.getSuites().equals(this.getSuites()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSuites() == null) ? 0 : getSuites().hashCode());
        hashCode = prime * hashCode
