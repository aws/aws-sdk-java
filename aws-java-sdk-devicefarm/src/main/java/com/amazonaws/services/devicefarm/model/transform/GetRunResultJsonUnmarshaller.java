 ...
 */
public class GetRunResultJsonUnmarshaller implements
        Unmarshaller<GetRunResult, JsonUnmarshallerContext> {

    public GetRunResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("run", targetDepth)) {
                    context.nextToken();
                    getRunResult.setRun(RunJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
