 ...
 */
public class ScheduleRunTestJsonUnmarshaller implements
        Unmarshaller<ScheduleRunTest, JsonUnmarshallerContext> {

    public ScheduleRunTest unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("type", targetDepth)) {
                    context.nextToken();
                    scheduleRunTest.setType(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("testPackageArn", targetDepth)) {
                    context.nextToken();
                    scheduleRunTest.setTestPackageArn(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("filter", targetDepth)) {
                    context.nextToken();
                    scheduleRunTest.setFilter(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
