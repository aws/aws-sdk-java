...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/devicefarm-2015-06-23/UpdateNetworkProfile" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateNetworkProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateNetworkProfileResult == false)
            return false;
        UpdateNetworkProfileResult other = (UpdateNetworkProfileResult) obj;
    ...
    @Override
    public UpdateNetworkProfileResult clone() {
        try {
            return (UpdateNetworkProfileResult) super.clone();
