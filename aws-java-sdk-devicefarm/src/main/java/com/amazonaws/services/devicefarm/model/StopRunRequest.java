...
public class StopRunRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Represents the Amazon Resource Name (ARN) of the Device Farm run to stop.
     */
