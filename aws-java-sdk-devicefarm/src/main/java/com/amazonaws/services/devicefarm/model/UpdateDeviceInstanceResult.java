...
public class UpdateDeviceInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDeviceInstanceResult == false)
            return false;
        UpdateDeviceInstanceResult other = (UpdateDeviceInstanceResult) obj;
    ...
    @Override
    public UpdateDeviceInstanceResult clone() {
        try {
            return (UpdateDeviceInstanceResult) super.clone();
