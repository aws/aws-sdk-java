...
/**
 * DeviceSelectionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeviceSelectionResultJsonUnmarshaller implements Unmarshaller<DeviceSelectionResult, JsonUnmarshallerContext> {

    public DeviceSelectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeviceSelectionResult deviceSelectionResult = new DeviceSelectionResult();
    ...
    private static DeviceSelectionResultJsonUnmarshaller instance;

    public static DeviceSelectionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeviceSelectionResultJsonUnmarshaller();
        return instance;
    }
}
