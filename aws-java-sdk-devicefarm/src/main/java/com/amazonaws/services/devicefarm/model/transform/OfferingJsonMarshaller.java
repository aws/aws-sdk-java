...
public class OfferingJsonMarshaller {
     ...
     */
    public void marshall(Offering offering,
        ...
        try {
            ...
            if (offering.getPlatform() != null) {
                jsonGenerator.writeFieldName("platform").writeValue(
                        offering.getPlatform());
            }

            java.util.List<RecurringCharge> recurringChargesList = offering
                    .getRecurringCharges();
            if (recurringChargesList != null) {
                ...
                for (RecurringCharge recurringChargesListValue : recurringChargesList) {
                    if (recurringChargesListValue != null) {
                        ...
                        RecurringChargeJsonMarshaller.getInstance().marshall(
                                recurringChargesListValue, jsonGenerator);
                    }
                }
