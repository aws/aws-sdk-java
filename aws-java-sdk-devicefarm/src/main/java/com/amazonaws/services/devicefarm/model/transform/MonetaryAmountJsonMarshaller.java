...
public class MonetaryAmountJsonMarshaller {
     ...
     */
    public void marshall(MonetaryAmount monetaryAmount,
        ...
        try {
            ...
            if (monetaryAmount.getAmount() != null) {
                jsonGenerator.writeFieldName("amount").writeValue(
                        monetaryAmount.getAmount());
            }
            if (monetaryAmount.getCurrencyCode() != null) {
                jsonGenerator.writeFieldName("currencyCode").writeValue(
                        monetaryAmount.getCurrencyCode());
            }
