    ...
    public void marshall(RecurringCharge recurringCharge, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (recurringCharge.getCost() != null) {
                ...
                MonetaryAmountJsonMarshaller.getInstance().marshall(recurringCharge.getCost(), jsonGenerator);
            }
            if (recurringCharge.getFrequency() != null) {
                jsonGenerator.writeFieldName("frequency").writeValue(recurringCharge.getFrequency());
            }
