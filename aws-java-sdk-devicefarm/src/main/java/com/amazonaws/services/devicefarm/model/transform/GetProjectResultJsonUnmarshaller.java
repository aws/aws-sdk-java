 ...
 */
public class GetProjectResultJsonUnmarshaller implements
        Unmarshaller<GetProjectResult, JsonUnmarshallerContext> {

    public GetProjectResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("project", targetDepth)) {
                    context.nextToken();
                    getProjectResult.setProject(ProjectJsonUnmarshaller
