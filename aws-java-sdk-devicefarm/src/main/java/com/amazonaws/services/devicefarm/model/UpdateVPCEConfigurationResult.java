...
public class UpdateVPCEConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateVPCEConfigurationResult == false)
            return false;
        UpdateVPCEConfigurationResult other = (UpdateVPCEConfigurationResult) obj;
    ...
    @Override
    public UpdateVPCEConfigurationResult clone() {
        try {
            return (UpdateVPCEConfigurationResult) super.clone();
