...
public class GetDevicePoolCompatibilityRequestMarshaller
    ...
    public GetDevicePoolCompatibilityRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<GetDevicePoolCompatibilityRequest> marshall(
        ...
        Request<GetDevicePoolCompatibilityRequest> request = new DefaultRequest<GetDevicePoolCompatibilityRequest>(
                getDevicePoolCompatibilityRequest, "AWSDeviceFarm");
