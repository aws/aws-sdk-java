 ...
 */
public class StopRemoteAccessSessionResultJsonUnmarshaller implements
        Unmarshaller<StopRemoteAccessSessionResult, JsonUnmarshallerContext> {

    public StopRemoteAccessSessionResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("remoteAccessSession", targetDepth)) {
                    ...
                    stopRemoteAccessSessionResult
                            .setRemoteAccessSession(RemoteAccessSessionJsonUnmarshaller
