...
public class RuleMarshaller {
    ...
    public void marshall(Rule rule, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(rule.getAttribute(), ATTRIBUTE_BINDING);
            protocolMarshaller.marshall(rule.getOperator(), OPERATOR_BINDING);
            protocolMarshaller.marshall(rule.getValue(), VALUE_BINDING);
        } catch (Exception e) {
