...
public class RenewOfferingRequestMarshaller implements Marshaller<Request<RenewOfferingRequest>, RenewOfferingRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public RenewOfferingRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<RenewOfferingRequest> marshall(RenewOfferingRequest renewOfferingRequest) {
        ...
        Request<RenewOfferingRequest> request = new DefaultRequest<RenewOfferingRequest>(renewOfferingRequest, "AWSDeviceFarm");
