...
public class MaximumNumberOfTrailsExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaximumNumberOfTrailsExceededExceptionUnmarshaller instance;

    public static MaximumNumberOfTrailsExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaximumNumberOfTrailsExceededExceptionUnmarshaller();
        return instance;
    }
}
