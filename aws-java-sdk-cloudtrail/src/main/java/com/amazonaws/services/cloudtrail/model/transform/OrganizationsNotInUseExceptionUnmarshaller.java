...
public class OrganizationsNotInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OrganizationsNotInUseExceptionUnmarshaller instance;

    public static OrganizationsNotInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OrganizationsNotInUseExceptionUnmarshaller();
        return instance;
    }
}
