 ...
 */
public class LookupAttributeJsonUnmarshaller implements
        Unmarshaller<LookupAttribute, JsonUnmarshallerContext> {

    public LookupAttribute unmarshall(JsonUnmarshallerContext context)
            throws Exception {
