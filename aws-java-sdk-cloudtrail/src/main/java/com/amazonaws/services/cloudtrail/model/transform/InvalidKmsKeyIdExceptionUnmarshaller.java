...
public class InvalidKmsKeyIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidKmsKeyIdExceptionUnmarshaller instance;

    public static InvalidKmsKeyIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidKmsKeyIdExceptionUnmarshaller();
        return instance;
    }
}
