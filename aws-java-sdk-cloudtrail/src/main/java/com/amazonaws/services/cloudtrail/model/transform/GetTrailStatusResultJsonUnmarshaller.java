        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("LatestDigestDeliveryTime", targetDepth)) {
                    context.nextToken();
                    getTrailStatusResult.setLatestDigestDeliveryTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("LatestDigestDeliveryError", targetDepth)) {
                    context.nextToken();
                    getTrailStatusResult.setLatestDigestDeliveryError(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
