...
/**
 * List Public Keys Result JSON Unmarshaller
 */
public class ListPublicKeysResultJsonUnmarshaller implements Unmarshaller<ListPublicKeysResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listPublicKeysResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ListPublicKeysResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListPublicKeysResultJsonUnmarshaller();
        return instance;
    }
}
