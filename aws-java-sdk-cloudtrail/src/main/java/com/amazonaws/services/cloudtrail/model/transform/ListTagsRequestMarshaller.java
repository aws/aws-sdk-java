...
public class ListTagsRequestMarshaller implements Marshaller<Request<ListTagsRequest>, ListTagsRequest> {
    ...
    public Request<ListTagsRequest> marshall(ListTagsRequest listTagsRequest) {
        ...
        Request<ListTagsRequest> request = new DefaultRequest<ListTagsRequest>(listTagsRequest, "AWSCloudTrail");
        ...
        try {
          ...
          jsonWriter.object();
            ...
            com.amazonaws.internal.ListWithAutoConstructFlag<String> resourceIdListList = (com.amazonaws.internal.ListWithAutoConstructFlag<String>)(listTagsRequest.getResourceIdList());
