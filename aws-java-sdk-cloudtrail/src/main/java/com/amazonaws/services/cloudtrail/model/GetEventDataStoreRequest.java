...
public class GetEventDataStoreRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN (or ID suffix of the ARN) of the event data store about which you want information.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetEventDataStoreRequest == false)
            return false;
        GetEventDataStoreRequest other = (GetEventDataStoreRequest) obj;
    ...
    @Override
    public GetEventDataStoreRequest clone() {
        return (GetEventDataStoreRequest) super.clone();
    }
