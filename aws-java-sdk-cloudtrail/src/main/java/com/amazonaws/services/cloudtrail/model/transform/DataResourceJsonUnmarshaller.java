...
/**
 * DataResource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataResourceJsonUnmarshaller implements Unmarshaller<DataResource, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    dataResource.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
