...
public class TrailNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TrailNotFoundExceptionUnmarshaller instance;

    public static TrailNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TrailNotFoundExceptionUnmarshaller();
        return instance;
    }
}
