...
/**
 * ImportFailureListItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportFailureListItemJsonUnmarshaller implements Unmarshaller<ImportFailureListItem, JsonUnmarshallerContext> {

    public ImportFailureListItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        ImportFailureListItem importFailureListItem = new ImportFailureListItem();
    ...
    private static ImportFailureListItemJsonUnmarshaller instance;

    public static ImportFailureListItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ImportFailureListItemJsonUnmarshaller();
        return instance;
    }
}
