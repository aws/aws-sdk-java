...
public class StartImportRequestMarshaller {
    ...
    private static final MarshallingInfo<java.util.Date> STARTEVENTTIME_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("StartEventTime").timestampFormat("unixTimestamp").build();
    private static final MarshallingInfo<java.util.Date> ENDEVENTTIME_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("EndEventTime").timestampFormat("unixTimestamp").build();
    ...
    public void marshall(StartImportRequest startImportRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startImportRequest.getDestinations(), DESTINATIONS_BINDING);
            protocolMarshaller.marshall(startImportRequest.getImportSource(), IMPORTSOURCE_BINDING);
            protocolMarshaller.marshall(startImportRequest.getStartEventTime(), STARTEVENTTIME_BINDING);
            protocolMarshaller.marshall(startImportRequest.getEndEventTime(), ENDEVENTTIME_BINDING);
