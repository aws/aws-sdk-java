...
public class AWSCloudTrailAsyncClient extends AWSCloudTrailClient implements
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on
     * CloudTrail using the specified parameters.
     *
    ...
    @Override
    public java.util.concurrent.Future<CreateTrailResult> createTrailAsync(
    ...
    public java.util.concurrent.Future<CreateTrailResult> createTrailAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateTrailResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<DeleteTrailResult> deleteTrailAsync(
    ...
    public java.util.concurrent.Future<DeleteTrailResult> deleteTrailAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeleteTrailResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<DescribeTrailsResult> describeTrailsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DescribeTrailsResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<GetTrailStatusResult> getTrailStatusAsync(
    ...
    public java.util.concurrent.Future<GetTrailStatusResult> getTrailStatusAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetTrailStatusResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ListPublicKeysResult> listPublicKeysAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListPublicKeysResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ListTagsResult> listTagsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListTagsResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<LookupEventsResult> lookupEventsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<LookupEventsResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<StartLoggingResult> startLoggingAsync(
    ...
    public java.util.concurrent.Future<StartLoggingResult> startLoggingAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<StartLoggingResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<StopLoggingResult> stopLoggingAsync(
    ...
    public java.util.concurrent.Future<StopLoggingResult> stopLoggingAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<StopLoggingResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<UpdateTrailResult> updateTrailAsync(
    ...
    public java.util.concurrent.Future<UpdateTrailResult> updateTrailAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UpdateTrailResult>() {
                    @Override
