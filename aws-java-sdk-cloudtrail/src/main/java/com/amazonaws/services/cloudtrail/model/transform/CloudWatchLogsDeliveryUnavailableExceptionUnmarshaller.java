...
public class CloudWatchLogsDeliveryUnavailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CloudWatchLogsDeliveryUnavailableExceptionUnmarshaller instance;

    public static CloudWatchLogsDeliveryUnavailableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CloudWatchLogsDeliveryUnavailableExceptionUnmarshaller();
        return instance;
    }
}
