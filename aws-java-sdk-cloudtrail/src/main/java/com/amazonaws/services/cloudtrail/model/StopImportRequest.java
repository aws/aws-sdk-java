...
public class StopImportRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopImportRequest == false)
            return false;
        StopImportRequest other = (StopImportRequest) obj;
    ...
    @Override
    public StopImportRequest clone() {
        return (StopImportRequest) super.clone();
    }
