...
/**
 * Lookup Events Result JSON Unmarshaller
 */
public class LookupEventsResultJsonUnmarshaller implements Unmarshaller<LookupEventsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    lookupEventsResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static LookupEventsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new LookupEventsResultJsonUnmarshaller();
        return instance;
    }
}
