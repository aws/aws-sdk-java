...
public class InvalidEventSelectorsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidEventSelectorsExceptionUnmarshaller instance;

    public static InvalidEventSelectorsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidEventSelectorsExceptionUnmarshaller();
        return instance;
    }
}
