...
/**
 * DeleteEventDataStoreResult JSON Unmarshaller
 */
...
public class DeleteEventDataStoreResultJsonUnmarshaller implements Unmarshaller<DeleteEventDataStoreResult, JsonUnmarshallerContext> {
    ...
    public DeleteEventDataStoreResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEventDataStoreResult deleteEventDataStoreResult = new DeleteEventDataStoreResult();

        return deleteEventDataStoreResult;
    }
