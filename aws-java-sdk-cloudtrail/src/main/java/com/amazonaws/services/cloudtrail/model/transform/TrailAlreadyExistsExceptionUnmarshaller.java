...
public class TrailAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TrailAlreadyExistsExceptionUnmarshaller instance;

    public static TrailAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TrailAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
