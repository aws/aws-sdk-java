...
public class ImportsListItemMarshaller {
    ...
    public void marshall(ImportsListItem importsListItem, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(importsListItem.getImportId(), IMPORTID_BINDING);
            protocolMarshaller.marshall(importsListItem.getImportStatus(), IMPORTSTATUS_BINDING);
            protocolMarshaller.marshall(importsListItem.getDestinations(), DESTINATIONS_BINDING);
            protocolMarshaller.marshall(importsListItem.getCreatedTimestamp(), CREATEDTIMESTAMP_BINDING);
            protocolMarshaller.marshall(importsListItem.getUpdatedTimestamp(), UPDATEDTIMESTAMP_BINDING);
        } catch (Exception e) {
