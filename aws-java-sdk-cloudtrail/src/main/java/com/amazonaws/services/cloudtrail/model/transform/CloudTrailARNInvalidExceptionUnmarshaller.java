...
public class CloudTrailARNInvalidExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CloudTrailARNInvalidExceptionUnmarshaller instance;

    public static CloudTrailARNInvalidExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CloudTrailARNInvalidExceptionUnmarshaller();
        return instance;
    }
}
