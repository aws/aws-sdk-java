...
public class LookupAttribute implements Serializable, Cloneable {
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>EventId, EventName, Username, ResourceType, ResourceName
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getAttributeKey() != null) sb.append("AttributeKey: " + getAttributeKey() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LookupAttribute == false) return false;
        LookupAttribute other = (LookupAttribute)obj;
        
        if (other.getAttributeKey() == null ^ this.getAttributeKey() == null) return false;
        if (other.getAttributeKey() != null && other.getAttributeKey().equals(this.getAttributeKey()) == false) return false; 
