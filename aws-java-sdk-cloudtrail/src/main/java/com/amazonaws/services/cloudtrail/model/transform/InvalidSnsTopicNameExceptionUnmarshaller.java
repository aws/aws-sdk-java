...
public class InvalidSnsTopicNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSnsTopicNameExceptionUnmarshaller instance;

    public static InvalidSnsTopicNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSnsTopicNameExceptionUnmarshaller();
        return instance;
    }
}
