...
public class InvalidSnsTopicNameExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("InvalidSnsTopicNameException"));
        } else {
            return errorTypeFromHeader.equals("InvalidSnsTopicNameException");
        }
    }
    ...
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        ...
        e.setErrorCode("InvalidSnsTopicNameException");
