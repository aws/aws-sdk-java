...
public class StopImportResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StopImportResult withDestinations(java.util.Collection<String> destinations) {
