...
public class RemoveTagsRequestMarshaller implements Marshaller<Request<RemoveTagsRequest>, RemoveTagsRequest> {
    ...
    public Request<RemoveTagsRequest> marshall(RemoveTagsRequest removeTagsRequest) {
        ...
        request.addHeader("X-Amz-Target", "com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.RemoveTags");
        ...
        try {
            ...
            com.amazonaws.internal.SdkInternalList<Tag> tagsListList = (com.amazonaws.internal.SdkInternalList<Tag>) removeTagsRequest.getTagsList();
