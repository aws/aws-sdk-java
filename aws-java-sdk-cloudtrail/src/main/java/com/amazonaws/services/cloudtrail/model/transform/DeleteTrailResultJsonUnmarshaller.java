 ...
 */
public class DeleteTrailResultJsonUnmarshaller implements
        Unmarshaller<DeleteTrailResult, JsonUnmarshallerContext> {
    ...
    public static DeleteTrailResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeleteTrailResultJsonUnmarshaller();
        return instance;
    }
}
