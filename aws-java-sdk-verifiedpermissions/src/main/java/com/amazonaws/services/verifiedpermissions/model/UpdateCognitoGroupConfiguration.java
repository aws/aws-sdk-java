...
public class UpdateCognitoGroupConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateCognitoGroupConfiguration == false)
            return false;
    ...
    public UpdateCognitoGroupConfiguration clone() {
        try {
            return (UpdateCognitoGroupConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.UpdateCognitoGroupConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
