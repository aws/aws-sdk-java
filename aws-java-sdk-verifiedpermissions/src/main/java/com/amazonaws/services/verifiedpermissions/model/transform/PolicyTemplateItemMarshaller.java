...
/**
 * PolicyTemplateItemMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PolicyTemplateItemMarshaller {
    ...
    private static final PolicyTemplateItemMarshaller instance = new PolicyTemplateItemMarshaller();

    public static PolicyTemplateItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PolicyTemplateItem policyTemplateItem, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(policyTemplateItem.getPolicyStoreId(), POLICYSTOREID_BINDING);
            protocolMarshaller.marshall(policyTemplateItem.getPolicyTemplateId(), POLICYTEMPLATEID_BINDING);
            protocolMarshaller.marshall(policyTemplateItem.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(policyTemplateItem.getCreatedDate(), CREATEDDATE_BINDING);
            protocolMarshaller.marshall(policyTemplateItem.getLastUpdatedDate(), LASTUPDATEDDATE_BINDING);
        } catch (Exception e) {
