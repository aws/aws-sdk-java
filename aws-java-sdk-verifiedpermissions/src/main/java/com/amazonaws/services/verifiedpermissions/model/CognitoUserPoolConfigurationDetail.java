 ...
 * >ConfigurationDetail</a> structure that is part of the response to <a
 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/CognitoUserPoolConfigurationDetail"
...
public class CognitoUserPoolConfigurationDetail implements Serializable, Cloneable, StructuredPojo {
    ...
    public CognitoUserPoolConfigurationDetail withClientIds(java.util.Collection<String> clientIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CognitoUserPoolConfigurationDetail == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.CognitoUserPoolConfigurationDetailMarshaller.getInstance()
