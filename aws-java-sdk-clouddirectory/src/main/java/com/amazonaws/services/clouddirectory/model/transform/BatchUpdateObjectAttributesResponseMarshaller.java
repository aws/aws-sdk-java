...
@SdkInternalApi
public class BatchUpdateObjectAttributesResponseMarshaller {
    ...
    private static final BatchUpdateObjectAttributesResponseMarshaller instance = new BatchUpdateObjectAttributesResponseMarshaller();

    public static BatchUpdateObjectAttributesResponseMarshaller getInstance() {
        return instance;
    }
