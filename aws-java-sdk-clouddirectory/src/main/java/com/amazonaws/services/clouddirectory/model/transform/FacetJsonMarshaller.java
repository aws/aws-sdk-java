...
public class FacetJsonMarshaller {
     ...
     */
    public void marshall(Facet facet, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (facet.getName() != null) {
                jsonGenerator.writeFieldName("Name").writeValue(facet.getName());
            }
            if (facet.getObjectType() != null) {
                jsonGenerator.writeFieldName("ObjectType").writeValue(facet.getObjectType());
            }
