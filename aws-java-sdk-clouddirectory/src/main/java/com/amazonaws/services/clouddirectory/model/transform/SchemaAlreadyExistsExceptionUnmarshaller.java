...
public class SchemaAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SchemaAlreadyExistsExceptionUnmarshaller instance;

    public static SchemaAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SchemaAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
