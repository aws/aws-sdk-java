...
public class InvalidFacetUpdateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidFacetUpdateExceptionUnmarshaller instance;

    public static InvalidFacetUpdateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidFacetUpdateExceptionUnmarshaller();
        return instance;
    }
}
