...
public class DirectoryDeletedException extends com.amazonaws.services.clouddirectory.model.AmazonCloudDirectoryException {
     ...
     */
    public DirectoryDeletedException(String message) {
        super(message);
    }
