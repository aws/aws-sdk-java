...
public class ListPublishedSchemaArnsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARNs of published schemas.
     */
    ...
    public ListPublishedSchemaArnsResult withSchemaArns(String... schemaArns) {
    ...
    public ListPublishedSchemaArnsResult withSchemaArns(java.util.Collection<String> schemaArns) {
    ...
    public ListPublishedSchemaArnsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPublishedSchemaArnsResult == false)
            return false;
        ListPublishedSchemaArnsResult other = (ListPublishedSchemaArnsResult) obj;
    ...
    @Override
    public ListPublishedSchemaArnsResult clone() {
        try {
            return (ListPublishedSchemaArnsResult) super.clone();
