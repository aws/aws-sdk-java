...
/**
 * BatchGetObjectInformationMarshaller
 */
...
public class BatchGetObjectInformationMarshaller {
    ...
    public void marshall(BatchGetObjectInformation batchGetObjectInformation, ProtocolMarshaller protocolMarshaller) {
        ...
        if (batchGetObjectInformation == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(batchGetObjectInformation.getObjectReference(), OBJECTREFERENCE_BINDING);
        } catch (Exception e) {
