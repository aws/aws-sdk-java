...
/**
 * DeleteTypedLinkFacetRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteTypedLinkFacetRequestMarshaller {
    ...
    private static final DeleteTypedLinkFacetRequestMarshaller instance = new DeleteTypedLinkFacetRequestMarshaller();

    public static DeleteTypedLinkFacetRequestMarshaller getInstance() {
        return instance;
    }
