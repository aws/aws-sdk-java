...
/**
 * TypedLinkFacetAttributeUpdateMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TypedLinkFacetAttributeUpdateMarshaller {
    ...
    private static final TypedLinkFacetAttributeUpdateMarshaller instance = new TypedLinkFacetAttributeUpdateMarshaller();

    public static TypedLinkFacetAttributeUpdateMarshaller getInstance() {
        return instance;
    }
