...
public class ListTypedLinkFacetNamesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The names of typed link facets that exist within the schema.
     */
    ...
    public ListTypedLinkFacetNamesResult withFacetNames(String... facetNames) {
    ...
    public ListTypedLinkFacetNamesResult withFacetNames(java.util.Collection<String> facetNames) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTypedLinkFacetNamesResult == false)
            return false;
        ListTypedLinkFacetNamesResult other = (ListTypedLinkFacetNamesResult) obj;
    ...
    public ListTypedLinkFacetNamesResult clone() {
        try {
            return (ListTypedLinkFacetNamesResult) super.clone();
