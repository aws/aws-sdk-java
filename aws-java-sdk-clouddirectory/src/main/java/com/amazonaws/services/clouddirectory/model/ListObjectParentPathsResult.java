...
public class ListObjectParentPathsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Returns the path to the <code>ObjectIdentifiers</code> associated with the directory.
     */
    ...
    public ListObjectParentPathsResult withPathToObjectIdentifiersList(java.util.Collection<PathToObjectIdentifiers> pathToObjectIdentifiersList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListObjectParentPathsResult == false)
            return false;
        ListObjectParentPathsResult other = (ListObjectParentPathsResult) obj;
    ...
    @Override
    public ListObjectParentPathsResult clone() {
        try {
            return (ListObjectParentPathsResult) super.clone();
