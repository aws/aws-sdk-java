...
public class AttributeKeyAndValueJsonMarshaller {
     ...
     */
    public void marshall(AttributeKeyAndValue attributeKeyAndValue, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (attributeKeyAndValue.getKey() != null) {
                ...
                AttributeKeyJsonMarshaller.getInstance().marshall(attributeKeyAndValue.getKey(), jsonGenerator);
            }
            if (attributeKeyAndValue.getValue() != null) {
                jsonGenerator.writeFieldName("Value");
                TypedAttributeValueJsonMarshaller.getInstance().marshall(attributeKeyAndValue.getValue(), jsonGenerator);
            }
