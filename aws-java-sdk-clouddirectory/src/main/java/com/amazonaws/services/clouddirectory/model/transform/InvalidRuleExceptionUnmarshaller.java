...
public class InvalidRuleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidRuleExceptionUnmarshaller instance;

    public static InvalidRuleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRuleExceptionUnmarshaller();
        return instance;
    }
}
