...
public class DirectoryAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DirectoryAlreadyExistsExceptionUnmarshaller instance;

    public static DirectoryAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DirectoryAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
