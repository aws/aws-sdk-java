...
/**
 * BatchGetLinkAttributesResponseMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BatchGetLinkAttributesResponseMarshaller {
    ...
    private static final BatchGetLinkAttributesResponseMarshaller instance = new BatchGetLinkAttributesResponseMarshaller();

    public static BatchGetLinkAttributesResponseMarshaller getInstance() {
        return instance;
    }
