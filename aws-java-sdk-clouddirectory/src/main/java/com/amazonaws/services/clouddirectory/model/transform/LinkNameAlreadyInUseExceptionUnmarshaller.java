...
public class LinkNameAlreadyInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LinkNameAlreadyInUseExceptionUnmarshaller instance;

    public static LinkNameAlreadyInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LinkNameAlreadyInUseExceptionUnmarshaller();
        return instance;
    }
}
