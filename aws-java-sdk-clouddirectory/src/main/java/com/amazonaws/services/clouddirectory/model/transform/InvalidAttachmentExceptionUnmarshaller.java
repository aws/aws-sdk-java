...
public class InvalidAttachmentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidAttachmentExceptionUnmarshaller instance;

    public static InvalidAttachmentExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidAttachmentExceptionUnmarshaller();
        return instance;
    }
}
