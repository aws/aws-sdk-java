...
/**
 * BatchAttachTypedLinkResponseMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BatchAttachTypedLinkResponseMarshaller {
    ...
    private static final BatchAttachTypedLinkResponseMarshaller instance = new BatchAttachTypedLinkResponseMarshaller();

    public static BatchAttachTypedLinkResponseMarshaller getInstance() {
        return instance;
    }
