...
public class BatchListObjectAttributesResponseMarshaller {
    ...
    public void marshall(BatchListObjectAttributesResponse batchListObjectAttributesResponse, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(batchListObjectAttributesResponse.getAttributes(), ATTRIBUTES_BINDING);
            protocolMarshaller.marshall(batchListObjectAttributesResponse.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
