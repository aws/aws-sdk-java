...
/**
 * DetachTypedLinkResult JSON Unmarshaller
 */
...
public class DetachTypedLinkResultJsonUnmarshaller implements Unmarshaller<DetachTypedLinkResult, JsonUnmarshallerContext> {
    ...
    public DetachTypedLinkResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DetachTypedLinkResult detachTypedLinkResult = new DetachTypedLinkResult();
