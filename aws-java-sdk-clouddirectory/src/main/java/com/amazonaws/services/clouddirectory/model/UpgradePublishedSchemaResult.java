...
public class UpgradePublishedSchemaResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpgradePublishedSchemaResult withUpgradedSchemaArn(String upgradedSchemaArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpgradePublishedSchemaResult == false)
            return false;
        UpgradePublishedSchemaResult other = (UpgradePublishedSchemaResult) obj;
    ...
    @Override
    public UpgradePublishedSchemaResult clone() {
        try {
