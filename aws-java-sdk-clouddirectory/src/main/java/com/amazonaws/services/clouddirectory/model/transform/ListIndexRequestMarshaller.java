...
public class ListIndexRequestMarshaller implements Marshaller<Request<ListIndexRequest>, ListIndexRequest> {
    ...
    public Request<ListIndexRequest> marshall(ListIndexRequest listIndexRequest) {
        ...
        Request<ListIndexRequest> request = new DefaultRequest<ListIndexRequest>(listIndexRequest, "AmazonCloudDirectory");
        ...
        try {
            ...
            java.util.List<ObjectAttributeRange> rangesOnIndexedValuesList = listIndexRequest.getRangesOnIndexedValues();
            if (rangesOnIndexedValuesList != null) {
                ...
                for (ObjectAttributeRange rangesOnIndexedValuesListValue : rangesOnIndexedValuesList) {
                    if (rangesOnIndexedValuesListValue != null) {
