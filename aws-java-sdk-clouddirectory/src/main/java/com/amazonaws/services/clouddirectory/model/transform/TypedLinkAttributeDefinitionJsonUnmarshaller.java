...
/**
 * TypedLinkAttributeDefinition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TypedLinkAttributeDefinitionJsonUnmarshaller implements Unmarshaller<TypedLinkAttributeDefinition, JsonUnmarshallerContext> {

    public TypedLinkAttributeDefinition unmarshall(JsonUnmarshallerContext context) throws Exception {
        TypedLinkAttributeDefinition typedLinkAttributeDefinition = new TypedLinkAttributeDefinition();
    ...
    private static TypedLinkAttributeDefinitionJsonUnmarshaller instance;

    public static TypedLinkAttributeDefinitionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TypedLinkAttributeDefinitionJsonUnmarshaller();
        return instance;
    }
}
