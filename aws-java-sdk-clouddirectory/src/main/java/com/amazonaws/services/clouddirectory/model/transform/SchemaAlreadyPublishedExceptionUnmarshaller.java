...
public class SchemaAlreadyPublishedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SchemaAlreadyPublishedExceptionUnmarshaller instance;

    public static SchemaAlreadyPublishedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SchemaAlreadyPublishedExceptionUnmarshaller();
        return instance;
    }
}
