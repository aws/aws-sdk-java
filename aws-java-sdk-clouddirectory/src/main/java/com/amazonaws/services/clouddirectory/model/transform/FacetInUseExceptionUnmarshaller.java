...
public class FacetInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FacetInUseExceptionUnmarshaller instance;

    public static FacetInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FacetInUseExceptionUnmarshaller();
        return instance;
    }
}
