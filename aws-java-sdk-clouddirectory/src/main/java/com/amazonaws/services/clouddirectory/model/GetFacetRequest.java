...
public class GetFacetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetFacetRequest withSchemaArn(String schemaArn) {
     ...
     * </p>
     * 
     * @return The name of the facet to retrieve.
     */
    ...
    public GetFacetRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetFacetRequest == false)
            return false;
        GetFacetRequest other = (GetFacetRequest) obj;
    ...
    @Override
    public GetFacetRequest clone() {
        return (GetFacetRequest) super.clone();
    }
