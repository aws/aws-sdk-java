...
public class BatchAddFacetToObjectResponseJsonUnmarshaller implements Unmarshaller<BatchAddFacetToObjectResponse, JsonUnmarshallerContext> {
    ...
    public BatchAddFacetToObjectResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        BatchAddFacetToObjectResponse batchAddFacetToObjectResponse = new BatchAddFacetToObjectResponse();
