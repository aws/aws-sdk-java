...
public class BatchDeleteObjectJsonMarshaller {
     ...
     */
    public void marshall(BatchDeleteObject batchDeleteObject, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (batchDeleteObject.getObjectReference() != null) {
                ...
                ObjectReferenceJsonMarshaller.getInstance().marshall(batchDeleteObject.getObjectReference(), jsonGenerator);
            }
