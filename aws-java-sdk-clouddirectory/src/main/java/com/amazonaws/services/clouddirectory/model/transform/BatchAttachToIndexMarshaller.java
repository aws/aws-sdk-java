...
/**
 * BatchAttachToIndexMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BatchAttachToIndexMarshaller {
    ...
    private static final BatchAttachToIndexMarshaller instance = new BatchAttachToIndexMarshaller();

    public static BatchAttachToIndexMarshaller getInstance() {
        return instance;
    }
