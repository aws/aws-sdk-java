...
public class InvalidSchemaDocExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSchemaDocExceptionUnmarshaller instance;

    public static InvalidSchemaDocExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSchemaDocExceptionUnmarshaller();
        return instance;
    }
}
