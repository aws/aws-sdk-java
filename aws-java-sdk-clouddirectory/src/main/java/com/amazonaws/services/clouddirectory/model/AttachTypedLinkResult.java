...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2016-05-10/AttachTypedLink" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AttachTypedLinkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttachTypedLinkResult == false)
            return false;
        AttachTypedLinkResult other = (AttachTypedLinkResult) obj;
    ...
    @Override
    public AttachTypedLinkResult clone() {
        try {
            return (AttachTypedLinkResult) super.clone();
