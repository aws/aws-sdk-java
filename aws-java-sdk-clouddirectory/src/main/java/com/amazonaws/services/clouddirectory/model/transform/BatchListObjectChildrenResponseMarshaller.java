...
@SdkInternalApi
public class BatchListObjectChildrenResponseMarshaller {

    private static final MarshallingInfo<Map> CHILDREN_BINDING = MarshallingInfo.builder(MarshallingType.MAP).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Children").build();
    private static final MarshallingInfo<String> NEXTTOKEN_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("NextToken").build();

    private static final BatchListObjectChildrenResponseMarshaller instance = new BatchListObjectChildrenResponseMarshaller();

    public static BatchListObjectChildrenResponseMarshaller getInstance() {
        return instance;
    }
