...
public class GetLinkAttributesRequestMarshaller {
    ...
    private static final GetLinkAttributesRequestMarshaller instance = new GetLinkAttributesRequestMarshaller();

    public static GetLinkAttributesRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetLinkAttributesRequest getLinkAttributesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getLinkAttributesRequest.getDirectoryArn(), DIRECTORYARN_BINDING);
            protocolMarshaller.marshall(getLinkAttributesRequest.getTypedLinkSpecifier(), TYPEDLINKSPECIFIER_BINDING);
            protocolMarshaller.marshall(getLinkAttributesRequest.getAttributeNames(), ATTRIBUTENAMES_BINDING);
            protocolMarshaller.marshall(getLinkAttributesRequest.getConsistencyLevel(), CONSISTENCYLEVEL_BINDING);
        } catch (Exception e) {
