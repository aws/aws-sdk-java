...
/**
 * <p>
 * Returns policies attached to an object in pagination fashion inside a <a>BatchRead</a> operation. For more
 * information, see <a>ListObjectPolicies</a> and <a>BatchReadRequest$Operations</a>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/BatchListObjectPolicies"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchListObjectPolicies implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchListObjectPolicies == false)
            return false;
        BatchListObjectPolicies other = (BatchListObjectPolicies) obj;
    ...
    public BatchListObjectPolicies clone() {
        try {
            return (BatchListObjectPolicies) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.clouddirectory.model.transform.BatchListObjectPoliciesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
