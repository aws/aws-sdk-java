...
public class IncompatibleSchemaExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static IncompatibleSchemaExceptionUnmarshaller instance;

    public static IncompatibleSchemaExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IncompatibleSchemaExceptionUnmarshaller();
        return instance;
    }
}
