...
public class PolicyAttachmentMarshaller {
    ...
    public void marshall(PolicyAttachment policyAttachment, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(policyAttachment.getPolicyId(), POLICYID_BINDING);
            protocolMarshaller.marshall(policyAttachment.getObjectIdentifier(), OBJECTIDENTIFIER_BINDING);
            protocolMarshaller.marshall(policyAttachment.getPolicyType(), POLICYTYPE_BINDING);
        } catch (Exception e) {
