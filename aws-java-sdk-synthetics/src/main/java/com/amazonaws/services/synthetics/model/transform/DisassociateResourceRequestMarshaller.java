...
public class DisassociateResourceRequestMarshaller {
    ...
    public void marshall(DisassociateResourceRequest disassociateResourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(disassociateResourceRequest.getGroupIdentifier(), GROUPIDENTIFIER_BINDING);
            protocolMarshaller.marshall(disassociateResourceRequest.getResourceArn(), RESOURCEARN_BINDING);
        } catch (Exception e) {
