...
public class GroupSummaryMarshaller {
    ...
    public void marshall(GroupSummary groupSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(groupSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(groupSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(groupSummary.getArn(), ARN_BINDING);
        } catch (Exception e) {
