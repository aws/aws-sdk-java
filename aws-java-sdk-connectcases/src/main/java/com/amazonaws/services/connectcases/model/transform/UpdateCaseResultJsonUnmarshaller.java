...
/**
 * UpdateCaseResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateCaseResultJsonUnmarshaller implements Unmarshaller<UpdateCaseResult, JsonUnmarshallerContext> {

    public UpdateCaseResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateCaseResult updateCaseResult = new UpdateCaseResult();
