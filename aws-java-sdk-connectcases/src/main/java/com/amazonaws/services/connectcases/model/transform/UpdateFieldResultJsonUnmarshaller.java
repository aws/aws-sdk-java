...
/**
 * UpdateFieldResult JSON Unmarshaller
 */
...
public class UpdateFieldResultJsonUnmarshaller implements Unmarshaller<UpdateFieldResult, JsonUnmarshallerContext> {
    ...
    public UpdateFieldResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateFieldResult updateFieldResult = new UpdateFieldResult();
