...
public class FileContentMarshaller {
    ...
    private static final FileContentMarshaller instance = new FileContentMarshaller();

    public static FileContentMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FileContent fileContent, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(fileContent.getFileArn(), FILEARN_BINDING);
        } catch (Exception e) {
