...
/**
 * PutCaseEventConfigurationResult JSON Unmarshaller
 */
...
public class PutCaseEventConfigurationResultJsonUnmarshaller implements Unmarshaller<PutCaseEventConfigurationResult, JsonUnmarshallerContext> {
    ...
    public PutCaseEventConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutCaseEventConfigurationResult putCaseEventConfigurationResult = new PutCaseEventConfigurationResult();

        return putCaseEventConfigurationResult;
    }
