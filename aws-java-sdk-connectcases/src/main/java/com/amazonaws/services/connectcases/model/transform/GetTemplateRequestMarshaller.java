...
public class GetTemplateRequestMarshaller {
    ...
    public void marshall(GetTemplateRequest getTemplateRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getTemplateRequest.getDomainId(), DOMAINID_BINDING);
            protocolMarshaller.marshall(getTemplateRequest.getTemplateId(), TEMPLATEID_BINDING);
        } catch (Exception e) {
