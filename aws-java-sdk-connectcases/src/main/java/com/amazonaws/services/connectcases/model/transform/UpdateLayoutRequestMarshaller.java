...
@SdkInternalApi
public class UpdateLayoutRequestMarshaller {
    ...
    private static final UpdateLayoutRequestMarshaller instance = new UpdateLayoutRequestMarshaller();

    public static UpdateLayoutRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateLayoutRequest updateLayoutRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateLayoutRequest.getContent(), CONTENT_BINDING);
            protocolMarshaller.marshall(updateLayoutRequest.getDomainId(), DOMAINID_BINDING);
            protocolMarshaller.marshall(updateLayoutRequest.getLayoutId(), LAYOUTID_BINDING);
            protocolMarshaller.marshall(updateLayoutRequest.getName(), NAME_BINDING);
        } catch (Exception e) {
