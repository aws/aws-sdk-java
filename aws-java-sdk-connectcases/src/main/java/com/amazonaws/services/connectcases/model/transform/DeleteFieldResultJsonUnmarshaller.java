...
/**
 * DeleteFieldResult JSON Unmarshaller
 */
...
public class DeleteFieldResultJsonUnmarshaller implements Unmarshaller<DeleteFieldResult, JsonUnmarshallerContext> {
    ...
    public DeleteFieldResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFieldResult deleteFieldResult = new DeleteFieldResult();
