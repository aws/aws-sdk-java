...
@SdkInternalApi
public class BatchPutFieldOptionsRequestMarshaller {
    ...
    private static final BatchPutFieldOptionsRequestMarshaller instance = new BatchPutFieldOptionsRequestMarshaller();

    public static BatchPutFieldOptionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchPutFieldOptionsRequest batchPutFieldOptionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(batchPutFieldOptionsRequest.getDomainId(), DOMAINID_BINDING);
            protocolMarshaller.marshall(batchPutFieldOptionsRequest.getFieldId(), FIELDID_BINDING);
            protocolMarshaller.marshall(batchPutFieldOptionsRequest.getOptions(), OPTIONS_BINDING);
        } catch (Exception e) {
