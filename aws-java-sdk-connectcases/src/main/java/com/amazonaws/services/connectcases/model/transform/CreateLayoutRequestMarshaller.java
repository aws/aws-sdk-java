...
public class CreateLayoutRequestMarshaller {
    ...
    private static final CreateLayoutRequestMarshaller instance = new CreateLayoutRequestMarshaller();

    public static CreateLayoutRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateLayoutRequest createLayoutRequest, ProtocolMarshaller protocolMarshaller) {

        if (createLayoutRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createLayoutRequest.getContent(), CONTENT_BINDING);
            protocolMarshaller.marshall(createLayoutRequest.getDomainId(), DOMAINID_BINDING);
            protocolMarshaller.marshall(createLayoutRequest.getName(), NAME_BINDING);
        } catch (Exception e) {
