        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("domainId", targetDepth)) {
                    context.nextToken();
                    createDomainResult.setDomainId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("domainStatus", targetDepth)) {
                    context.nextToken();
                    createDomainResult.setDomainStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
