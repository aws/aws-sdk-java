...
public class PutCaseEventConfigurationRequestMarshaller {
    ...
    private static final PutCaseEventConfigurationRequestMarshaller instance = new PutCaseEventConfigurationRequestMarshaller();

    public static PutCaseEventConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutCaseEventConfigurationRequest putCaseEventConfigurationRequest, ProtocolMarshaller protocolMarshaller) {

        if (putCaseEventConfigurationRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(putCaseEventConfigurationRequest.getDomainId(), DOMAINID_BINDING);
            protocolMarshaller.marshall(putCaseEventConfigurationRequest.getEventBridge(), EVENTBRIDGE_BINDING);
        } catch (Exception e) {
