...
/**
 * RelatedItemTypeFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RelatedItemTypeFilterMarshaller {
    ...
    public static RelatedItemTypeFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RelatedItemTypeFilter relatedItemTypeFilter, ProtocolMarshaller protocolMarshaller) {

        if (relatedItemTypeFilter == null) {
