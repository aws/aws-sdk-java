...
/**
 * DeleteLayoutResult JSON Unmarshaller
 */
...
public class DeleteLayoutResultJsonUnmarshaller implements Unmarshaller<DeleteLayoutResult, JsonUnmarshallerContext> {
    ...
    public DeleteLayoutResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLayoutResult deleteLayoutResult = new DeleteLayoutResult();

        return deleteLayoutResult;
    }
