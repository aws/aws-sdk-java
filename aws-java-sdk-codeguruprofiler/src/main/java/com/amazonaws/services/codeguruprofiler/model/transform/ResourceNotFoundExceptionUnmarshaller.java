...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.codeguruprofiler.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.codeguruprofiler.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeguruprofiler.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.codeguruprofiler.model.ResourceNotFoundException(
                null);
