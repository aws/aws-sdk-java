...
/**
 * Match JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MatchJsonUnmarshaller implements Unmarshaller<Match, JsonUnmarshallerContext> {

    public Match unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static MatchJsonUnmarshaller instance;

    public static MatchJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MatchJsonUnmarshaller();
        return instance;
    }
}
