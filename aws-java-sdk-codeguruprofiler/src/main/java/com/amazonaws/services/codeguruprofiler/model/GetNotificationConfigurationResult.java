...
public class GetNotificationConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The current notification configuration for this profiling group.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetNotificationConfigurationResult == false)
            return false;
        GetNotificationConfigurationResult other = (GetNotificationConfigurationResult) obj;
    ...
    @Override
    public GetNotificationConfigurationResult clone() {
        try {
            return (GetNotificationConfigurationResult) super.clone();
