...
/**
 * Pattern JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PatternJsonUnmarshaller implements Unmarshaller<Pattern, JsonUnmarshallerContext> {

    public Pattern unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static PatternJsonUnmarshaller instance;

    public static PatternJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PatternJsonUnmarshaller();
        return instance;
    }
}
