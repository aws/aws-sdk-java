...
public class DeleteProfilingGroupRequestMarshaller {
    ...
    private static final DeleteProfilingGroupRequestMarshaller instance = new DeleteProfilingGroupRequestMarshaller();

    public static DeleteProfilingGroupRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteProfilingGroupRequest deleteProfilingGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteProfilingGroupRequest.getProfilingGroupName(), PROFILINGGROUPNAME_BINDING);
        } catch (Exception e) {
