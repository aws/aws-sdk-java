...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.codeguruprofiler.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.codeguruprofiler.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeguruprofiler.model.ConflictException conflictException = new com.amazonaws.services.codeguruprofiler.model.ConflictException(
                null);
