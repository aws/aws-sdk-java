...
/**
 * EnvironmentPlatform JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EnvironmentPlatformJsonUnmarshaller implements Unmarshaller<EnvironmentPlatform, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("platform", targetDepth)) {
                    context.nextToken();
                    environmentPlatform.setPlatform(context.getUnmarshaller(String.class).unmarshall(context));
                }
