...
public class EnvironmentLanguageMarshaller {
    ...
    private static final MarshallingInfo<List> IMAGES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("images").build();
