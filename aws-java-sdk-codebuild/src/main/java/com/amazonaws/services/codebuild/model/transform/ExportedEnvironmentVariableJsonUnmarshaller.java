...
/**
 * ExportedEnvironmentVariable JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExportedEnvironmentVariableJsonUnmarshaller implements Unmarshaller<ExportedEnvironmentVariable, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    exportedEnvironmentVariable.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("value", targetDepth)) {
                    context.nextToken();
                    exportedEnvironmentVariable.setValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
