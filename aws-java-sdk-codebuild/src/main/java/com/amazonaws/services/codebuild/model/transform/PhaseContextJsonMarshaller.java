...
public class PhaseContextJsonMarshaller {
     ...
     */
    public void marshall(PhaseContext phaseContext, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (phaseContext.getStatusCode() != null) {
                jsonGenerator.writeFieldName("statusCode").writeValue(phaseContext.getStatusCode());
            }
            if (phaseContext.getMessage() != null) {
                jsonGenerator.writeFieldName("message").writeValue(phaseContext.getMessage());
            }
