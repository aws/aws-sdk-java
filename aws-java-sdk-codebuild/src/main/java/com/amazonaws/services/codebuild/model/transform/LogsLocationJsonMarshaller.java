...
public class LogsLocationJsonMarshaller {
     ...
     */
    public void marshall(LogsLocation logsLocation, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (logsLocation.getGroupName() != null) {
                jsonGenerator.writeFieldName("groupName").writeValue(logsLocation.getGroupName());
            }
            if (logsLocation.getStreamName() != null) {
                jsonGenerator.writeFieldName("streamName").writeValue(logsLocation.getStreamName());
            }
            if (logsLocation.getDeepLink() != null) {
                jsonGenerator.writeFieldName("deepLink").writeValue(logsLocation.getDeepLink());
            }
