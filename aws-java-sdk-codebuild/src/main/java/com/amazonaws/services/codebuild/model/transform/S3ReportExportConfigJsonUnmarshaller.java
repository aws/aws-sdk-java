...
/**
 * S3ReportExportConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class S3ReportExportConfigJsonUnmarshaller implements Unmarshaller<S3ReportExportConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("packaging", targetDepth)) {
                    context.nextToken();
                    s3ReportExportConfig.setPackaging(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("encryptionKey", targetDepth)) {
                    context.nextToken();
                    s3ReportExportConfig.setEncryptionKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("encryptionDisabled", targetDepth)) {
                    context.nextToken();
                    s3ReportExportConfig.setEncryptionDisabled(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
