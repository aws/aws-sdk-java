...
public class CreateReportGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the report group that was created.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateReportGroupResult == false)
            return false;
        CreateReportGroupResult other = (CreateReportGroupResult) obj;
    ...
    public CreateReportGroupResult clone() {
        try {
            return (CreateReportGroupResult) super.clone();
