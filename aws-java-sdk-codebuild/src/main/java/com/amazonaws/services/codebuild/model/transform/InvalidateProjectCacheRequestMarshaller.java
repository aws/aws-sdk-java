...
@SdkInternalApi
public class InvalidateProjectCacheRequestMarshaller {
    ...
    private static final InvalidateProjectCacheRequestMarshaller instance = new InvalidateProjectCacheRequestMarshaller();

    public static InvalidateProjectCacheRequestMarshaller getInstance() {
        return instance;
    }
