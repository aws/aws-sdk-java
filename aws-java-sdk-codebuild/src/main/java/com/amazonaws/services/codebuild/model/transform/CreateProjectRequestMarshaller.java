...
public class CreateProjectRequestMarshaller {
    ...
    public void marshall(CreateProjectRequest createProjectRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createProjectRequest.getFileSystemLocations(), FILESYSTEMLOCATIONS_BINDING);
            protocolMarshaller.marshall(createProjectRequest.getBuildBatchConfig(), BUILDBATCHCONFIG_BINDING);
            protocolMarshaller.marshall(createProjectRequest.getConcurrentBuildLimit(), CONCURRENTBUILDLIMIT_BINDING);
        } catch (Exception e) {
