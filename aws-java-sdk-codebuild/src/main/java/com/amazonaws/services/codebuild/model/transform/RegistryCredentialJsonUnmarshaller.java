...
/**
 * RegistryCredential JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RegistryCredentialJsonUnmarshaller implements Unmarshaller<RegistryCredential, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("credential", targetDepth)) {
                    context.nextToken();
                    registryCredential.setCredential(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("credentialProvider", targetDepth)) {
                    context.nextToken();
                    registryCredential.setCredentialProvider(context.getUnmarshaller(String.class).unmarshall(context));
                }
