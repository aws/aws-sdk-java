...
public class ListBuildsForProjectRequestMarshaller implements Marshaller<Request<ListBuildsForProjectRequest>, ListBuildsForProjectRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public ListBuildsForProjectRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<ListBuildsForProjectRequest> marshall(ListBuildsForProjectRequest listBuildsForProjectRequest) {
        ...
        Request<ListBuildsForProjectRequest> request = new DefaultRequest<ListBuildsForProjectRequest>(listBuildsForProjectRequest, "AWSCodeBuild");
