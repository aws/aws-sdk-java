...
/**
 * GetGroupMembershipIdRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetGroupMembershipIdRequestMarshaller {
    ...
    private static final GetGroupMembershipIdRequestMarshaller instance = new GetGroupMembershipIdRequestMarshaller();

    public static GetGroupMembershipIdRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetGroupMembershipIdRequest getGroupMembershipIdRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getGroupMembershipIdRequest.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(getGroupMembershipIdRequest.getGroupId(), GROUPID_BINDING);
            protocolMarshaller.marshall(getGroupMembershipIdRequest.getMemberId(), MEMBERID_BINDING);
        } catch (Exception e) {
