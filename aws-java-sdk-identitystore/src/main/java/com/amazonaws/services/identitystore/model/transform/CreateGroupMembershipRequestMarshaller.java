...
public class CreateGroupMembershipRequestMarshaller {
    ...
    public void marshall(CreateGroupMembershipRequest createGroupMembershipRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createGroupMembershipRequest.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(createGroupMembershipRequest.getGroupId(), GROUPID_BINDING);
            protocolMarshaller.marshall(createGroupMembershipRequest.getMemberId(), MEMBERID_BINDING);
        } catch (Exception e) {
