...
/**
 * GetUserIdRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetUserIdRequestMarshaller {
    ...
    private static final GetUserIdRequestMarshaller instance = new GetUserIdRequestMarshaller();

    public static GetUserIdRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetUserIdRequest getUserIdRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getUserIdRequest.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(getUserIdRequest.getAlternateIdentifier(), ALTERNATEIDENTIFIER_BINDING);
        } catch (Exception e) {
