...
public class DescribeGroupMembershipResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeGroupMembershipResult withMembershipId(String membershipId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeGroupMembershipResult == false)
            return false;
        DescribeGroupMembershipResult other = (DescribeGroupMembershipResult) obj;
    ...
    @Override
    public DescribeGroupMembershipResult clone() {
        try {
            return (DescribeGroupMembershipResult) super.clone();
