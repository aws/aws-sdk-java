...
public class FilterMarshaller {
    ...
    private static final MarshallingInfo<String> ATTRIBUTEPATH_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AttributePath").build();
    ...
    public void marshall(Filter filter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(filter.getAttributePath(), ATTRIBUTEPATH_BINDING);
            protocolMarshaller.marshall(filter.getAttributeValue(), ATTRIBUTEVALUE_BINDING);
        } catch (Exception e) {
