        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Value", targetDepth)) {
                    context.nextToken();
                    phoneNumber.setValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("Primary", targetDepth)) {
                    context.nextToken();
                    phoneNumber.setPrimary(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
