...
public class CreateGroupMembershipResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The identifier for a newly created <code>GroupMembership</code> in an identity store.
     */
    ...
    public CreateGroupMembershipResult withMembershipId(String membershipId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateGroupMembershipResult == false)
            return false;
        CreateGroupMembershipResult other = (CreateGroupMembershipResult) obj;
    ...
    public CreateGroupMembershipResult clone() {
        try {
            return (CreateGroupMembershipResult) super.clone();
