...
/**
 * IsMemberInGroupsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class IsMemberInGroupsRequestMarshaller {
    ...
    private static final IsMemberInGroupsRequestMarshaller instance = new IsMemberInGroupsRequestMarshaller();

    public static IsMemberInGroupsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(IsMemberInGroupsRequest isMemberInGroupsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(isMemberInGroupsRequest.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(isMemberInGroupsRequest.getMemberId(), MEMBERID_BINDING);
            protocolMarshaller.marshall(isMemberInGroupsRequest.getGroupIds(), GROUPIDS_BINDING);
        } catch (Exception e) {
