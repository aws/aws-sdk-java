...
public class DescribeGroupRequestMarshaller {
    ...
    public void marshall(DescribeGroupRequest describeGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeGroupRequest.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(describeGroupRequest.getGroupId(), GROUPID_BINDING);
        } catch (Exception e) {
