...
public class GetUserIdResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetUserIdResult == false)
            return false;
        GetUserIdResult other = (GetUserIdResult) obj;
    ...
    public GetUserIdResult clone() {
        try {
            return (GetUserIdResult) super.clone();
