...
public class CreateGroupRequestMarshaller {
    ...
    public void marshall(CreateGroupRequest createGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createGroupRequest.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(createGroupRequest.getDisplayName(), DISPLAYNAME_BINDING);
