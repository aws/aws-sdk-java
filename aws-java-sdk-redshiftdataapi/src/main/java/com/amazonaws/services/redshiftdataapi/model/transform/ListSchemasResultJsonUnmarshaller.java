...
/**
 * ListSchemasResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSchemasResultJsonUnmarshaller implements Unmarshaller<ListSchemasResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listSchemasResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Schemas", targetDepth)) {
                    context.nextToken();
                    listSchemasResult.setSchemas(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
