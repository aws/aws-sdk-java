...
/**
 * OpenSearchServerlessConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpenSearchServerlessConfigurationJsonUnmarshaller implements Unmarshaller<OpenSearchServerlessConfiguration, JsonUnmarshallerContext> {

    public OpenSearchServerlessConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static OpenSearchServerlessConfigurationJsonUnmarshaller instance;

    public static OpenSearchServerlessConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OpenSearchServerlessConfigurationJsonUnmarshaller();
        return instance;
    }
}
