...
/**
 * AgentKnowledgeBase JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AgentKnowledgeBaseJsonUnmarshaller implements Unmarshaller<AgentKnowledgeBase, JsonUnmarshallerContext> {

    public AgentKnowledgeBase unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("agentId", targetDepth)) {
                    context.nextToken();
                    agentKnowledgeBase.setAgentId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static AgentKnowledgeBaseJsonUnmarshaller instance;

    public static AgentKnowledgeBaseJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AgentKnowledgeBaseJsonUnmarshaller();
        return instance;
    }
}
