        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("knowledgeBaseId", targetDepth)) {
                    context.nextToken();
                    deleteKnowledgeBaseResult.setKnowledgeBaseId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("status", targetDepth)) {
                    context.nextToken();
                    deleteKnowledgeBaseResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
