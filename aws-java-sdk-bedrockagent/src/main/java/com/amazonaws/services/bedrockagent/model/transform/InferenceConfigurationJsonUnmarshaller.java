...
/**
 * InferenceConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InferenceConfigurationJsonUnmarshaller implements Unmarshaller<InferenceConfiguration, JsonUnmarshallerContext> {

    public InferenceConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static InferenceConfigurationJsonUnmarshaller instance;

    public static InferenceConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new InferenceConfigurationJsonUnmarshaller();
        return instance;
    }
}
