...
public class UpdateAgentAliasResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateAgentAliasResult withAgentAlias(AgentAlias agentAlias) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAgentAliasResult == false)
            return false;
        UpdateAgentAliasResult other = (UpdateAgentAliasResult) obj;
    ...
    @Override
    public UpdateAgentAliasResult clone() {
        try {
            return (UpdateAgentAliasResult) super.clone();
