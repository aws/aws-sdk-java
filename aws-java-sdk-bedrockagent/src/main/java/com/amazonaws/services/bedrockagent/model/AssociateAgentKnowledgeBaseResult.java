...
public class AssociateAgentKnowledgeBaseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Contains details about the knowledge base that has been associated with the agent.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateAgentKnowledgeBaseResult == false)
            return false;
        AssociateAgentKnowledgeBaseResult other = (AssociateAgentKnowledgeBaseResult) obj;
    ...
    public AssociateAgentKnowledgeBaseResult clone() {
        try {
            return (AssociateAgentKnowledgeBaseResult) super.clone();
