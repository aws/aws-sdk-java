...
/**
 * RedisEnterpriseCloudConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RedisEnterpriseCloudConfigurationJsonUnmarshaller implements Unmarshaller<RedisEnterpriseCloudConfiguration, JsonUnmarshallerContext> {

    public RedisEnterpriseCloudConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        RedisEnterpriseCloudConfiguration redisEnterpriseCloudConfiguration = new RedisEnterpriseCloudConfiguration();
    ...
    private static RedisEnterpriseCloudConfigurationJsonUnmarshaller instance;

    public static RedisEnterpriseCloudConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RedisEnterpriseCloudConfigurationJsonUnmarshaller();
        return instance;
    }
}
