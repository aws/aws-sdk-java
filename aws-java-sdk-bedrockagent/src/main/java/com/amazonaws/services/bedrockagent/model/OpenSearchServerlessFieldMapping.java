...
public class OpenSearchServerlessFieldMapping implements Serializable, Cloneable, StructuredPojo {
    ...
    public OpenSearchServerlessFieldMapping clone() {
        try {
            return (OpenSearchServerlessFieldMapping) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.bedrockagent.model.transform.OpenSearchServerlessFieldMappingMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
