...
/**
 * AssociateAgentKnowledgeBaseRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssociateAgentKnowledgeBaseRequestMarshaller {
    ...
    private static final AssociateAgentKnowledgeBaseRequestMarshaller instance = new AssociateAgentKnowledgeBaseRequestMarshaller();

    public static AssociateAgentKnowledgeBaseRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssociateAgentKnowledgeBaseRequest associateAgentKnowledgeBaseRequest, ProtocolMarshaller protocolMarshaller) {

        if (associateAgentKnowledgeBaseRequest == null) {
