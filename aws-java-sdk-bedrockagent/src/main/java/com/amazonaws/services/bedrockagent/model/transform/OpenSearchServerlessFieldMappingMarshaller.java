...
/**
 * OpenSearchServerlessFieldMappingMarshaller
 */
...
public class OpenSearchServerlessFieldMappingMarshaller {
    ...
    public static OpenSearchServerlessFieldMappingMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OpenSearchServerlessFieldMapping openSearchServerlessFieldMapping, ProtocolMarshaller protocolMarshaller) {

        if (openSearchServerlessFieldMapping == null) {
