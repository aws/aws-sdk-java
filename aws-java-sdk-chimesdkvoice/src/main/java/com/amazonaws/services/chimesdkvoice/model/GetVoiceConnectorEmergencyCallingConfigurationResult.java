...
public class GetVoiceConnectorEmergencyCallingConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetVoiceConnectorEmergencyCallingConfigurationResult == false)
            return false;
        GetVoiceConnectorEmergencyCallingConfigurationResult other = (GetVoiceConnectorEmergencyCallingConfigurationResult) obj;
    ...
    public GetVoiceConnectorEmergencyCallingConfigurationResult clone() {
        try {
            return (GetVoiceConnectorEmergencyCallingConfigurationResult) super.clone();
