...
public class GetVoiceProfileDomainRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetVoiceProfileDomainRequest withVoiceProfileDomainId(String voiceProfileDomainId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetVoiceProfileDomainRequest == false)
            return false;
        GetVoiceProfileDomainRequest other = (GetVoiceProfileDomainRequest) obj;
    ...
    @Override
    public GetVoiceProfileDomainRequest clone() {
        return (GetVoiceProfileDomainRequest) super.clone();
    }
