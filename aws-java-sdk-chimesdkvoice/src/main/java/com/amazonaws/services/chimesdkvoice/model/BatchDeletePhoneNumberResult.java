...
public class BatchDeletePhoneNumberResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchDeletePhoneNumberResult withPhoneNumberErrors(PhoneNumberError... phoneNumberErrors) {
    ...
    public BatchDeletePhoneNumberResult withPhoneNumberErrors(java.util.Collection<PhoneNumberError> phoneNumberErrors) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchDeletePhoneNumberResult == false)
            return false;
        BatchDeletePhoneNumberResult other = (BatchDeletePhoneNumberResult) obj;
    ...
    @Override
    public BatchDeletePhoneNumberResult clone() {
        try {
            return (BatchDeletePhoneNumberResult) super.clone();
