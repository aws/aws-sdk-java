...
public class GetSipMediaApplicationAlexaSkillConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public GetSipMediaApplicationAlexaSkillConfigurationResult withSipMediaApplicationAlexaSkillConfiguration(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSipMediaApplicationAlexaSkillConfigurationResult == false)
            return false;
        GetSipMediaApplicationAlexaSkillConfigurationResult other = (GetSipMediaApplicationAlexaSkillConfigurationResult) obj;
    ...
    @Override
    public GetSipMediaApplicationAlexaSkillConfigurationResult clone() {
        try {
            return (GetSipMediaApplicationAlexaSkillConfigurationResult) super.clone();
