...
public class ProxyMarshaller {
    ...
    private static final MarshallingInfo<List> PHONENUMBERCOUNTRIES_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("PhoneNumberCountries").build();
