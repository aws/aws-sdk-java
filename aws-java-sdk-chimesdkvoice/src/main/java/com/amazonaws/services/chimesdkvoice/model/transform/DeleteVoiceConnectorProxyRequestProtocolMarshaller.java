...
public class DeleteVoiceConnectorProxyRequestProtocolMarshaller implements
        Marshaller<Request<DeleteVoiceConnectorProxyRequest>, DeleteVoiceConnectorProxyRequest> {
    ...
    public Request<DeleteVoiceConnectorProxyRequest> marshall(DeleteVoiceConnectorProxyRequest deleteVoiceConnectorProxyRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<DeleteVoiceConnectorProxyRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(
