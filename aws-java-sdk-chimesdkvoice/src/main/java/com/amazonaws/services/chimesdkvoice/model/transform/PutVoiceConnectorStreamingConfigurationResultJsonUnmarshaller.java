...
/**
 * PutVoiceConnectorStreamingConfigurationResult JSON Unmarshaller
 */
...
public class PutVoiceConnectorStreamingConfigurationResultJsonUnmarshaller implements
    ...
    public PutVoiceConnectorStreamingConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StreamingConfiguration", targetDepth)) {
                    context.nextToken();
                    putVoiceConnectorStreamingConfigurationResult.setStreamingConfiguration(StreamingConfigurationJsonUnmarshaller.getInstance().unmarshall(
                            context));
                }
