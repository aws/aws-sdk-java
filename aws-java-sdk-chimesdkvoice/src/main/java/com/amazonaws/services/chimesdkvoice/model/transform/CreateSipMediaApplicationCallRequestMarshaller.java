...
public class CreateSipMediaApplicationCallRequestMarshaller {
    ...
    private static final MarshallingInfo<Map> ARGUMENTSMAP_BINDING = MarshallingInfo.builder(MarshallingType.MAP).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("ArgumentsMap").build();
