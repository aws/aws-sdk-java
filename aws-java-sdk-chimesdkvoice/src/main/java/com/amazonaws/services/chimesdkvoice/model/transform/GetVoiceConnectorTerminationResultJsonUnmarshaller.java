...
/**
 * GetVoiceConnectorTerminationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetVoiceConnectorTerminationResultJsonUnmarshaller implements Unmarshaller<GetVoiceConnectorTerminationResult, JsonUnmarshallerContext> {

    public GetVoiceConnectorTerminationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Termination", targetDepth)) {
                    context.nextToken();
                    getVoiceConnectorTerminationResult.setTermination(TerminationJsonUnmarshaller.getInstance().unmarshall(context));
                }
