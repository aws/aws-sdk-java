...
/**
 * DeleteVoiceProfileResult JSON Unmarshaller
 */
...
public class DeleteVoiceProfileResultJsonUnmarshaller implements Unmarshaller<DeleteVoiceProfileResult, JsonUnmarshallerContext> {
    ...
    public DeleteVoiceProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteVoiceProfileResult deleteVoiceProfileResult = new DeleteVoiceProfileResult();

        return deleteVoiceProfileResult;
    }
