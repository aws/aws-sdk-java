...
public class PutVoiceConnectorStreamingConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
     ...
     * </p>
     * 
     * @return The updated streaming settings.
     */
    ...
    public PutVoiceConnectorStreamingConfigurationResult withStreamingConfiguration(StreamingConfiguration streamingConfiguration) {
    ...
    @Override
    public PutVoiceConnectorStreamingConfigurationResult clone() {
        try {
            return (PutVoiceConnectorStreamingConfigurationResult) super.clone();
