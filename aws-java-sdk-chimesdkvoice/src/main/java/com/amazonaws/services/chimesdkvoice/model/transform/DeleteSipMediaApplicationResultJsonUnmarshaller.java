...
/**
 * DeleteSipMediaApplicationResult JSON Unmarshaller
 */
...
public class DeleteSipMediaApplicationResultJsonUnmarshaller implements Unmarshaller<DeleteSipMediaApplicationResult, JsonUnmarshallerContext> {
    ...
    public DeleteSipMediaApplicationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSipMediaApplicationResult deleteSipMediaApplicationResult = new DeleteSipMediaApplicationResult();

        return deleteSipMediaApplicationResult;
    }
