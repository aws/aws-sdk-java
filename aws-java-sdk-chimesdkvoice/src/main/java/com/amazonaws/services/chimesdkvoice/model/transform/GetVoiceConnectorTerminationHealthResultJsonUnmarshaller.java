...
/**
 * GetVoiceConnectorTerminationHealthResult JSON Unmarshaller
 */
...
public class GetVoiceConnectorTerminationHealthResultJsonUnmarshaller implements
    ...
    public GetVoiceConnectorTerminationHealthResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TerminationHealth", targetDepth)) {
                    context.nextToken();
                    getVoiceConnectorTerminationHealthResult.setTerminationHealth(TerminationHealthJsonUnmarshaller.getInstance().unmarshall(context));
                }
