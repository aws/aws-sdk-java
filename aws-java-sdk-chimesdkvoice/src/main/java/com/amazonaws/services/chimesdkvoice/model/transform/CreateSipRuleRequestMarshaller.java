...
/**
 * CreateSipRuleRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateSipRuleRequestMarshaller {
    ...
    private static final CreateSipRuleRequestMarshaller instance = new CreateSipRuleRequestMarshaller();

    public static CreateSipRuleRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateSipRuleRequest createSipRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createSipRuleRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createSipRuleRequest.getTriggerType(), TRIGGERTYPE_BINDING);
            protocolMarshaller.marshall(createSipRuleRequest.getTriggerValue(), TRIGGERVALUE_BINDING);
            protocolMarshaller.marshall(createSipRuleRequest.getDisabled(), DISABLED_BINDING);
            protocolMarshaller.marshall(createSipRuleRequest.getTargetApplications(), TARGETAPPLICATIONS_BINDING);
        } catch (Exception e) {
