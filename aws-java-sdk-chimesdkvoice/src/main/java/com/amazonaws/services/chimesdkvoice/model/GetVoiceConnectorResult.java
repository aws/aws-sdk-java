...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-voice-2022-08-03/GetVoiceConnector" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetVoiceConnectorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetVoiceConnectorResult withVoiceConnector(VoiceConnector voiceConnector) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetVoiceConnectorResult == false)
            return false;
        GetVoiceConnectorResult other = (GetVoiceConnectorResult) obj;
    ...
    @Override
    public GetVoiceConnectorResult clone() {
        try {
            return (GetVoiceConnectorResult) super.clone();
