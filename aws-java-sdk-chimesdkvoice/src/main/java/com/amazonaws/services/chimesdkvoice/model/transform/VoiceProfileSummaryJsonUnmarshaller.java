...
/**
 * VoiceProfileSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VoiceProfileSummaryJsonUnmarshaller implements Unmarshaller<VoiceProfileSummary, JsonUnmarshallerContext> {

    public VoiceProfileSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        VoiceProfileSummary voiceProfileSummary = new VoiceProfileSummary();
    ...
    private static VoiceProfileSummaryJsonUnmarshaller instance;

    public static VoiceProfileSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new VoiceProfileSummaryJsonUnmarshaller();
        return instance;
    }
}
