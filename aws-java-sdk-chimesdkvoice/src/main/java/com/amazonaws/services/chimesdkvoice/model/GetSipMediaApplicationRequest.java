...
public class GetSipMediaApplicationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetSipMediaApplicationRequest withSipMediaApplicationId(String sipMediaApplicationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSipMediaApplicationRequest == false)
            return false;
        GetSipMediaApplicationRequest other = (GetSipMediaApplicationRequest) obj;
    ...
    @Override
    public GetSipMediaApplicationRequest clone() {
        return (GetSipMediaApplicationRequest) super.clone();
    }
