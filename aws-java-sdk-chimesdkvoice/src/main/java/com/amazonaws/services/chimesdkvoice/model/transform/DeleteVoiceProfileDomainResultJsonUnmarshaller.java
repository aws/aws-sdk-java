...
/**
 * DeleteVoiceProfileDomainResult JSON Unmarshaller
 */
...
public class DeleteVoiceProfileDomainResultJsonUnmarshaller implements Unmarshaller<DeleteVoiceProfileDomainResult, JsonUnmarshallerContext> {
    ...
    public DeleteVoiceProfileDomainResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteVoiceProfileDomainResult deleteVoiceProfileDomainResult = new DeleteVoiceProfileDomainResult();

        return deleteVoiceProfileDomainResult;
    }
