...
/**
 * Proxy JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProxyJsonUnmarshaller implements Unmarshaller<Proxy, JsonUnmarshallerContext> {

    public Proxy unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ProxyJsonUnmarshaller instance;

    public static ProxyJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProxyJsonUnmarshaller();
        return instance;
    }
}
