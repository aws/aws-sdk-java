...
public class UpdateSipMediaApplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateSipMediaApplicationResult withSipMediaApplication(SipMediaApplication sipMediaApplication) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSipMediaApplicationResult == false)
            return false;
        UpdateSipMediaApplicationResult other = (UpdateSipMediaApplicationResult) obj;
    ...
    @Override
    public UpdateSipMediaApplicationResult clone() {
        try {
            return (UpdateSipMediaApplicationResult) super.clone();
