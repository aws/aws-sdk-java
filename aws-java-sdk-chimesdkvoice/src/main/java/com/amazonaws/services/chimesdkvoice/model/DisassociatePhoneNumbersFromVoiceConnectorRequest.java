...
public class DisassociatePhoneNumbersFromVoiceConnectorRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DisassociatePhoneNumbersFromVoiceConnectorRequest withVoiceConnectorId(String voiceConnectorId) {
    ...
    public DisassociatePhoneNumbersFromVoiceConnectorRequest withE164PhoneNumbers(String... e164PhoneNumbers) {
    ...
    public DisassociatePhoneNumbersFromVoiceConnectorRequest withE164PhoneNumbers(java.util.Collection<String> e164PhoneNumbers) {
    ...
    @Override
    public DisassociatePhoneNumbersFromVoiceConnectorRequest clone() {
