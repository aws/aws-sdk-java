...
@SdkInternalApi
public class EC2ReplaceRouteActionMarshaller {
    ...
    private static final EC2ReplaceRouteActionMarshaller instance = new EC2ReplaceRouteActionMarshaller();

    public static EC2ReplaceRouteActionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EC2ReplaceRouteAction eC2ReplaceRouteAction, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(eC2ReplaceRouteAction.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(eC2ReplaceRouteAction.getDestinationCidrBlock(), DESTINATIONCIDRBLOCK_BINDING);
            protocolMarshaller.marshall(eC2ReplaceRouteAction.getDestinationPrefixListId(), DESTINATIONPREFIXLISTID_BINDING);
            protocolMarshaller.marshall(eC2ReplaceRouteAction.getDestinationIpv6CidrBlock(), DESTINATIONIPV6CIDRBLOCK_BINDING);
            protocolMarshaller.marshall(eC2ReplaceRouteAction.getGatewayId(), GATEWAYID_BINDING);
            protocolMarshaller.marshall(eC2ReplaceRouteAction.getRouteTableId(), ROUTETABLEID_BINDING);
        } catch (Exception e) {
