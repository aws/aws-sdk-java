...
public class ListAdminAccountsForOrganizationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAdminAccountsForOrganizationRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAdminAccountsForOrganizationRequest == false)
            return false;
        ListAdminAccountsForOrganizationRequest other = (ListAdminAccountsForOrganizationRequest) obj;
    ...
    @Override
    public ListAdminAccountsForOrganizationRequest clone() {
        return (ListAdminAccountsForOrganizationRequest) super.clone();
    }
