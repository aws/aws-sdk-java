...
/**
 * ListComplianceStatusRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListComplianceStatusRequestMarshaller {
    ...
    private static final ListComplianceStatusRequestMarshaller instance = new ListComplianceStatusRequestMarshaller();

    public static ListComplianceStatusRequestMarshaller getInstance() {
        return instance;
    }
