...
public class PutAppsListResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The details of the AWS Firewall Manager applications list.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutAppsListResult == false)
            return false;
        PutAppsListResult other = (PutAppsListResult) obj;
    ...
    public PutAppsListResult clone() {
        try {
            return (PutAppsListResult) super.clone();
