...
public class ListDiscoveredResourcesRequestMarshaller {
    ...
    private static final MarshallingInfo<List> MEMBERACCOUNTIDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MemberAccountIds").build();
    ...
    public void marshall(ListDiscoveredResourcesRequest listDiscoveredResourcesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listDiscoveredResourcesRequest.getMemberAccountIds(), MEMBERACCOUNTIDS_BINDING);
            protocolMarshaller.marshall(listDiscoveredResourcesRequest.getResourceType(), RESOURCETYPE_BINDING);
            protocolMarshaller.marshall(listDiscoveredResourcesRequest.getMaxResults(), MAXRESULTS_BINDING);
