...
/**
 * EC2DeleteRouteAction JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EC2DeleteRouteActionJsonUnmarshaller implements Unmarshaller<EC2DeleteRouteAction, JsonUnmarshallerContext> {

    public EC2DeleteRouteAction unmarshall(JsonUnmarshallerContext context) throws Exception {
        EC2DeleteRouteAction eC2DeleteRouteAction = new EC2DeleteRouteAction();
    ...
    private static EC2DeleteRouteActionJsonUnmarshaller instance;

    public static EC2DeleteRouteActionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EC2DeleteRouteActionJsonUnmarshaller();
        return instance;
    }
}
