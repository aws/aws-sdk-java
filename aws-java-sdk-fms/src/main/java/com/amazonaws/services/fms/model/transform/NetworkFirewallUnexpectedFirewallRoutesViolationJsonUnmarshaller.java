...
/**
 * NetworkFirewallUnexpectedFirewallRoutesViolation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NetworkFirewallUnexpectedFirewallRoutesViolationJsonUnmarshaller implements
        Unmarshaller<NetworkFirewallUnexpectedFirewallRoutesViolation, JsonUnmarshallerContext> {

    public NetworkFirewallUnexpectedFirewallRoutesViolation unmarshall(JsonUnmarshallerContext context) throws Exception {
        NetworkFirewallUnexpectedFirewallRoutesViolation networkFirewallUnexpectedFirewallRoutesViolation = new NetworkFirewallUnexpectedFirewallRoutesViolation();
    ...
    private static NetworkFirewallUnexpectedFirewallRoutesViolationJsonUnmarshaller instance;

    public static NetworkFirewallUnexpectedFirewallRoutesViolationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new NetworkFirewallUnexpectedFirewallRoutesViolationJsonUnmarshaller();
        return instance;
    }
}
