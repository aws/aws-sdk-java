...
/**
 * DeleteProtocolsListResult JSON Unmarshaller
 */
...
public class DeleteProtocolsListResultJsonUnmarshaller implements Unmarshaller<DeleteProtocolsListResult, JsonUnmarshallerContext> {
    ...
    public DeleteProtocolsListResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteProtocolsListResult deleteProtocolsListResult = new DeleteProtocolsListResult();

        return deleteProtocolsListResult;
    }
