...
/**
 * AwsVPCSecurityGroupViolation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsVPCSecurityGroupViolationJsonUnmarshaller implements Unmarshaller<AwsVPCSecurityGroupViolation, JsonUnmarshallerContext> {

    public AwsVPCSecurityGroupViolation unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsVPCSecurityGroupViolation awsVPCSecurityGroupViolation = new AwsVPCSecurityGroupViolation();
    ...
    private static AwsVPCSecurityGroupViolationJsonUnmarshaller instance;

    public static AwsVPCSecurityGroupViolationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsVPCSecurityGroupViolationJsonUnmarshaller();
        return instance;
    }
}
