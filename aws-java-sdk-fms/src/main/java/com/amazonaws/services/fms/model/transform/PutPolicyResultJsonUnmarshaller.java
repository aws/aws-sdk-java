...
/**
 * PutPolicyResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PutPolicyResultJsonUnmarshaller implements Unmarshaller<PutPolicyResult, JsonUnmarshallerContext> {

    public PutPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutPolicyResult putPolicyResult = new PutPolicyResult();
