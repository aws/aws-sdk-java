...
public class AssociateThirdPartyFirewallRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public AssociateThirdPartyFirewallRequest withThirdPartyFirewall(String thirdPartyFirewall) {
    ...
    public AssociateThirdPartyFirewallRequest withThirdPartyFirewall(ThirdPartyFirewall thirdPartyFirewall) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateThirdPartyFirewallRequest == false)
            return false;
        AssociateThirdPartyFirewallRequest other = (AssociateThirdPartyFirewallRequest) obj;
    ...
    @Override
    public AssociateThirdPartyFirewallRequest clone() {
        return (AssociateThirdPartyFirewallRequest) super.clone();
    }
