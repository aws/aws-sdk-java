...
public class GetThirdPartyFirewallAssociationStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetThirdPartyFirewallAssociationStatusRequest withThirdPartyFirewall(String thirdPartyFirewall) {
    ...
    public GetThirdPartyFirewallAssociationStatusRequest withThirdPartyFirewall(ThirdPartyFirewall thirdPartyFirewall) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetThirdPartyFirewallAssociationStatusRequest == false)
            return false;
    ...
    @Override
    public GetThirdPartyFirewallAssociationStatusRequest clone() {
        return (GetThirdPartyFirewallAssociationStatusRequest) super.clone();
    }
