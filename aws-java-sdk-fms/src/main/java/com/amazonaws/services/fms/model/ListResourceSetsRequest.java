...
public class ListResourceSetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListResourceSetsRequest withNextToken(String nextToken) {
    ...
    public ListResourceSetsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListResourceSetsRequest == false)
            return false;
        ListResourceSetsRequest other = (ListResourceSetsRequest) obj;
    ...
    @Override
    public ListResourceSetsRequest clone() {
        return (ListResourceSetsRequest) super.clone();
    }
