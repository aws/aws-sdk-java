 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/fms-2018-01-01/DeleteNetworkAclEntriesAction" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteNetworkAclEntriesAction implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<EntryDescription> networkAclEntriesToBeDeleted;
    /**
     * <p>
    ...
    public java.util.List<EntryDescription> getNetworkAclEntriesToBeDeleted() {
    ...
    public void setNetworkAclEntriesToBeDeleted(java.util.Collection<EntryDescription> networkAclEntriesToBeDeleted) {
        if (networkAclEntriesToBeDeleted == null) {
            this.networkAclEntriesToBeDeleted = null;
            return;
        }

        this.networkAclEntriesToBeDeleted = new java.util.ArrayList<EntryDescription>(networkAclEntriesToBeDeleted);
    }
     ...
     * {@link #setNetworkAclEntriesToBeDeleted(java.util.Collection)} or
     * {@link #withNetworkAclEntriesToBeDeleted(java.util.Collection)} if you want to override the existing values.
     * </p>
     * 
     * @param networkAclEntriesToBeDeleted
     *        Lists the entries that the remediation action would delete.
    ...
    public DeleteNetworkAclEntriesAction withNetworkAclEntriesToBeDeleted(EntryDescription... networkAclEntriesToBeDeleted) {
        if (this.networkAclEntriesToBeDeleted == null) {
            setNetworkAclEntriesToBeDeleted(new java.util.ArrayList<EntryDescription>(networkAclEntriesToBeDeleted.length));
        }
        for (EntryDescription ele : networkAclEntriesToBeDeleted) {
            this.networkAclEntriesToBeDeleted.add(ele);
        }
        return this;
    }
    ...
    public DeleteNetworkAclEntriesAction withNetworkAclEntriesToBeDeleted(java.util.Collection<EntryDescription> networkAclEntriesToBeDeleted) {
        setNetworkAclEntriesToBeDeleted(networkAclEntriesToBeDeleted);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getNetworkAclEntriesToBeDeleted() != null)
            sb.append("NetworkAclEntriesToBeDeleted: ").append(getNetworkAclEntriesToBeDeleted()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteNetworkAclEntriesAction == false)
            return false;
        ...
        if (other.getNetworkAclId() != null && other.getNetworkAclId().equals(this.getNetworkAclId()) == false)
            return false;
        if (other.getNetworkAclEntriesToBeDeleted() == null ^ this.getNetworkAclEntriesToBeDeleted() == null)
            return false;
        if (other.getNetworkAclEntriesToBeDeleted() != null && other.getNetworkAclEntriesToBeDeleted().equals(this.getNetworkAclEntriesToBeDeleted()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getNetworkAclEntriesToBeDeleted() == null) ? 0 : getNetworkAclEntriesToBeDeleted().hashCode());
    ...
    public DeleteNetworkAclEntriesAction clone() {
        try {
            return (DeleteNetworkAclEntriesAction) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.fms.model.transform.DeleteNetworkAclEntriesActionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
