...
/**
 * LocationAttributes JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LocationAttributesJsonUnmarshaller implements Unmarshaller<LocationAttributes, JsonUnmarshallerContext> {

    public LocationAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static LocationAttributesJsonUnmarshaller instance;

    public static LocationAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LocationAttributesJsonUnmarshaller();
        return instance;
    }
}
