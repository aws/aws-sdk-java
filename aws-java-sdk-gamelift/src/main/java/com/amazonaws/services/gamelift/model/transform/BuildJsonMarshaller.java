    ...
    public void marshall(Build build, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (build.getSizeOnDisk() != null) {
                jsonGenerator.writeFieldName("SizeOnDisk").writeValue(build.getSizeOnDisk());
            }
            if (build.getOperatingSystem() != null) {
                jsonGenerator.writeFieldName("OperatingSystem").writeValue(build.getOperatingSystem());
            }
