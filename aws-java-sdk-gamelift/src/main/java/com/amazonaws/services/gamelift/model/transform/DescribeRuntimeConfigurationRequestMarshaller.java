...
public class DescribeRuntimeConfigurationRequestMarshaller
    ...
    public DescribeRuntimeConfigurationRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeRuntimeConfigurationRequest> marshall(
        ...
        Request<DescribeRuntimeConfigurationRequest> request = new DefaultRequest<DescribeRuntimeConfigurationRequest>(
                describeRuntimeConfigurationRequest, "AmazonGameLift");
        ...
        try {
            ...
            if (describeRuntimeConfigurationRequest.getFleetId() != null) {
                jsonGenerator.writeFieldName("FleetId").writeValue(
                        describeRuntimeConfigurationRequest.getFleetId());
            }
