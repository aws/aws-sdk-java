...
/**
 * MatchedPlayerSessionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MatchedPlayerSessionMarshaller {
    ...
    private static final MatchedPlayerSessionMarshaller instance = new MatchedPlayerSessionMarshaller();

    public static MatchedPlayerSessionMarshaller getInstance() {
        return instance;
    }
