 ...
 */
public class SearchGameSessionsResultJsonUnmarshaller implements
        Unmarshaller<SearchGameSessionsResult, JsonUnmarshallerContext> {

    public SearchGameSessionsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    searchGameSessionsResult.setNextToken(context
