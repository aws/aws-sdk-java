 ...
 */
public class DescribeFleetPortSettingsResultJsonUnmarshaller implements
        Unmarshaller<DescribeFleetPortSettingsResult, JsonUnmarshallerContext> {

    public DescribeFleetPortSettingsResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("InboundPermissions", targetDepth)) {
                    ...
                    describeFleetPortSettingsResult
                            .setInboundPermissions(new ListUnmarshaller<IpPermission>(
