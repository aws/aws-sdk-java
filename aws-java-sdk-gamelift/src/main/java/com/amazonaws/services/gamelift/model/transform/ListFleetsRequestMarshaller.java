 ...
 */
public class ListFleetsRequestMarshaller implements
        Marshaller<Request<ListFleetsRequest>, ListFleetsRequest> {

    public Request<ListFleetsRequest> marshall(
        ...
        Request<ListFleetsRequest> request = new DefaultRequest<ListFleetsRequest>(
                listFleetsRequest, "AmazonGameLift");
