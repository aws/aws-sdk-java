 ...
 */
public class UpdateRuntimeConfigurationResultJsonUnmarshaller implements
        Unmarshaller<UpdateRuntimeConfigurationResult, JsonUnmarshallerContext> {

    public UpdateRuntimeConfigurationResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RuntimeConfiguration", targetDepth)) {
                    ...
                    updateRuntimeConfigurationResult
                            .setRuntimeConfiguration(RuntimeConfigurationJsonUnmarshaller
