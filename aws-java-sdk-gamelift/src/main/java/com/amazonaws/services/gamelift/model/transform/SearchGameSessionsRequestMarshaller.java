...
public class SearchGameSessionsRequestMarshaller
        implements
        Marshaller<Request<SearchGameSessionsRequest>, SearchGameSessionsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public SearchGameSessionsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<SearchGameSessionsRequest> marshall(
        ...
        Request<SearchGameSessionsRequest> request = new DefaultRequest<SearchGameSessionsRequest>(
                searchGameSessionsRequest, "AmazonGameLift");
