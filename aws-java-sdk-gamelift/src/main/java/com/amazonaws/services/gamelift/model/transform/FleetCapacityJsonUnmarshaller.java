 ...
 */
public class FleetCapacityJsonUnmarshaller implements
        Unmarshaller<FleetCapacity, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("InstanceCounts", targetDepth)) {
                    context.nextToken();
                    fleetCapacity
                            .setInstanceCounts(EC2InstanceCountsJsonUnmarshaller
