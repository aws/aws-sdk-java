 ...
 */
public class DescribeFleetAttributesRequestMarshaller implements Marshaller<Request<DescribeFleetAttributesRequest>, DescribeFleetAttributesRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public DescribeFleetAttributesRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<DescribeFleetAttributesRequest> marshall(DescribeFleetAttributesRequest describeFleetAttributesRequest) {
        ...
        Request<DescribeFleetAttributesRequest> request = new DefaultRequest<DescribeFleetAttributesRequest>(describeFleetAttributesRequest, "AmazonGameLift");
        ...
        try {
            ...
            java.util.List<String> fleetIdsList = describeFleetAttributesRequest.getFleetIds();
