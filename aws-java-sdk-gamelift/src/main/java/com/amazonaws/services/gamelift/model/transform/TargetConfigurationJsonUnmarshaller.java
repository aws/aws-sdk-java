...
/**
 * TargetConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TargetConfigurationJsonUnmarshaller implements Unmarshaller<TargetConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TargetValue", targetDepth)) {
                    context.nextToken();
                    targetConfiguration.setTargetValue(context.getUnmarshaller(Double.class).unmarshall(context));
                }
