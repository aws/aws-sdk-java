...
public class DeleteContainerGroupDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteContainerGroupDefinitionRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteContainerGroupDefinitionRequest == false)
            return false;
    ...
    public DeleteContainerGroupDefinitionRequest clone() {
        return (DeleteContainerGroupDefinitionRequest) super.clone();
    }
