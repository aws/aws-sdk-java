 ...
 */
public class CreatePlayerSessionsRequestMarshaller implements Marshaller<Request<CreatePlayerSessionsRequest>, CreatePlayerSessionsRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public CreatePlayerSessionsRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<CreatePlayerSessionsRequest> marshall(CreatePlayerSessionsRequest createPlayerSessionsRequest) {
        ...
        Request<CreatePlayerSessionsRequest> request = new DefaultRequest<CreatePlayerSessionsRequest>(createPlayerSessionsRequest, "AmazonGameLift");
