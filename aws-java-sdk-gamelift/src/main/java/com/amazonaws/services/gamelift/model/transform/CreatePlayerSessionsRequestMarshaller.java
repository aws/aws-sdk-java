...
public class CreatePlayerSessionsRequestMarshaller
        implements
        Marshaller<Request<CreatePlayerSessionsRequest>, CreatePlayerSessionsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public CreatePlayerSessionsRequestMarshaller(
    ...
    public Request<CreatePlayerSessionsRequest> marshall(
        ...
        Request<CreatePlayerSessionsRequest> request = new DefaultRequest<CreatePlayerSessionsRequest>(
        ...
        try {
            ...
            if (createPlayerSessionsRequest.getGameSessionId() != null) {
                jsonGenerator.writeFieldName("GameSessionId").writeValue(
                        createPlayerSessionsRequest.getGameSessionId());
            }

            java.util.List<String> playerIdsList = createPlayerSessionsRequest
                    .getPlayerIds();
