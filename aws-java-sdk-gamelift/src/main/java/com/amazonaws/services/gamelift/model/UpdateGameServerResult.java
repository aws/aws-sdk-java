...
public class UpdateGameServerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateGameServerResult == false)
            return false;
        UpdateGameServerResult other = (UpdateGameServerResult) obj;
    ...
    public UpdateGameServerResult clone() {
        try {
            return (UpdateGameServerResult) super.clone();
