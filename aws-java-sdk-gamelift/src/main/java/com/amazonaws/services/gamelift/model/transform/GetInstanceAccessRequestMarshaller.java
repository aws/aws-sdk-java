...
public class GetInstanceAccessRequestMarshaller implements Marshaller<Request<GetInstanceAccessRequest>, GetInstanceAccessRequest> {

    private final SdkJsonMarshallerFactory protocolFactory;

    public GetInstanceAccessRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<GetInstanceAccessRequest> marshall(GetInstanceAccessRequest getInstanceAccessRequest) {
        ...
        Request<GetInstanceAccessRequest> request = new DefaultRequest<GetInstanceAccessRequest>(getInstanceAccessRequest, "AmazonGameLift");
