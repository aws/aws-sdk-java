...
/**
 * ReplicaContainerGroupCountsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ReplicaContainerGroupCountsMarshaller {
    ...
    private static final ReplicaContainerGroupCountsMarshaller instance = new ReplicaContainerGroupCountsMarshaller();

    public static ReplicaContainerGroupCountsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ReplicaContainerGroupCounts replicaContainerGroupCounts, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(replicaContainerGroupCounts.getPENDING(), PENDING_BINDING);
            protocolMarshaller.marshall(replicaContainerGroupCounts.getACTIVE(), ACTIVE_BINDING);
            protocolMarshaller.marshall(replicaContainerGroupCounts.getIDLE(), IDLE_BINDING);
            protocolMarshaller.marshall(replicaContainerGroupCounts.getTERMINATING(), TERMINATING_BINDING);
        } catch (Exception e) {
