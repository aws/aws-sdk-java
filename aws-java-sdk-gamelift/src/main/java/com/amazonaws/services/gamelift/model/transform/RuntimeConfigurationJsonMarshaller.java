...
public class RuntimeConfigurationJsonMarshaller {
     ...
     */
    public void marshall(RuntimeConfiguration runtimeConfiguration,
        ...
        try {
            ...
            java.util.List<ServerProcess> serverProcessesList = runtimeConfiguration
                    .getServerProcesses();
            if (serverProcessesList != null) {
                ...
                for (ServerProcess serverProcessesListValue : serverProcessesList) {
                    if (serverProcessesListValue != null) {

                        ServerProcessJsonMarshaller.getInstance().marshall(
                                serverProcessesListValue, jsonGenerator);
                    }
                }
