...
public class InstanceCredentialsMarshaller {
    ...
    public void marshall(InstanceCredentials instanceCredentials, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(instanceCredentials.getUserName(), USERNAME_BINDING);
            protocolMarshaller.marshall(instanceCredentials.getSecret(), SECRET_BINDING);
        } catch (Exception e) {
