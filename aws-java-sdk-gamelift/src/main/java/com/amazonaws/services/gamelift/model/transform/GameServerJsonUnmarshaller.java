...
/**
 * GameServer JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GameServerJsonUnmarshaller implements Unmarshaller<GameServer, JsonUnmarshallerContext> {

    public GameServer unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static GameServerJsonUnmarshaller instance;

    public static GameServerJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GameServerJsonUnmarshaller();
        return instance;
    }
}
