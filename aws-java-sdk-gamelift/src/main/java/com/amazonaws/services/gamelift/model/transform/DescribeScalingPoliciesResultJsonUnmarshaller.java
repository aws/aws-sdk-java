 ...
 */
public class DescribeScalingPoliciesResultJsonUnmarshaller implements
        Unmarshaller<DescribeScalingPoliciesResult, JsonUnmarshallerContext> {

    public DescribeScalingPoliciesResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ScalingPolicies", targetDepth)) {
                    ...
                    describeScalingPoliciesResult
                            .setScalingPolicies(new ListUnmarshaller<ScalingPolicy>(
                                    ScalingPolicyJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeScalingPoliciesResult.setNextToken(context
