...
public class DescribeFleetAttributesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * Unique identifiers for the fleet(s) that you want to retrieve attributes for. To request attributes for all
     ...
     * </p>
     * 
     * @return Unique identifiers for the fleet(s) that you want to retrieve attributes for. To request attributes for
     ...
     * 
     * @param fleetIds
     *        Unique identifiers for the fleet(s) that you want to retrieve attributes for. To request attributes for
     *        all fleets, leave this parameter empty.
     */
