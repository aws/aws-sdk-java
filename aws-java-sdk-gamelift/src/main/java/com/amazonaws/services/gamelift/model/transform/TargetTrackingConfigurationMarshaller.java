...
@SdkInternalApi
public class TargetTrackingConfigurationMarshaller {
    ...
    private static final TargetTrackingConfigurationMarshaller instance = new TargetTrackingConfigurationMarshaller();

    public static TargetTrackingConfigurationMarshaller getInstance() {
        return instance;
    }
