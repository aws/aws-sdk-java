...
public class DeleteAliasRequestMarshaller implements Marshaller<Request<DeleteAliasRequest>, DeleteAliasRequest> {
    ...
    public Request<DeleteAliasRequest> marshall(DeleteAliasRequest deleteAliasRequest) {
        ...
        Request<DeleteAliasRequest> request = new DefaultRequest<DeleteAliasRequest>(deleteAliasRequest, "AmazonGameLift");
        request.addHeader("X-Amz-Target", "GameLift.DeleteAlias");
        ...
        try {
            ...
            if (deleteAliasRequest.getAliasId() != null) {
                jsonGenerator.writeFieldName("AliasId").writeValue(deleteAliasRequest.getAliasId());
            }
