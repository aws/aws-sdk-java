...
public class DescribeFleetCapacityRequestMarshaller
        implements
        Marshaller<Request<DescribeFleetCapacityRequest>, DescribeFleetCapacityRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeFleetCapacityRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeFleetCapacityRequest> marshall(
        ...
        Request<DescribeFleetCapacityRequest> request = new DefaultRequest<DescribeFleetCapacityRequest>(
                describeFleetCapacityRequest, "AmazonGameLift");
        ...
        try {
            ...
            java.util.List<String> fleetIdsList = describeFleetCapacityRequest
                    .getFleetIds();
