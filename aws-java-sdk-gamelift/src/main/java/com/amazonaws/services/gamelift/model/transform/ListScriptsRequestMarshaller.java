...
@SdkInternalApi
public class ListScriptsRequestMarshaller {
    ...
    private static final ListScriptsRequestMarshaller instance = new ListScriptsRequestMarshaller();

    public static ListScriptsRequestMarshaller getInstance() {
        return instance;
    }
