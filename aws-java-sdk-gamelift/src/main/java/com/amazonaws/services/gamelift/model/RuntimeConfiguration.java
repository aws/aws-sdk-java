 ...
 * should be run on each instance in a fleet. An instance can launch and
 * maintain multiple server processes based on the runtime configuration; it
 * regularly checks for an updated runtime configuration and starts new server
 ...
 * instance. This option might be useful, for example, to run more than one
 * version of your game server on the same fleet. Another option is to specify
 ...
 * add the values of the <code>ConcurrentExecutions</code> parameter for each
...
public class RuntimeConfiguration implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Collection of server process configurations describing what
    ...
    public void setServerProcesses(
            java.util.Collection<ServerProcess> serverProcesses) {
        if (serverProcesses == null) {
            this.serverProcesses = null;
            return;
        }

        this.serverProcesses = new java.util.ArrayList<ServerProcess>(
                serverProcesses);
    }
     ...
     * any). Use {@link #setServerProcesses(java.util.Collection)} or
     * {@link #withServerProcesses(java.util.Collection)} if you want to
    ...
    public RuntimeConfiguration withServerProcesses(
            ServerProcess... serverProcesses) {
        if (this.serverProcesses == null) {
            setServerProcesses(new java.util.ArrayList<ServerProcess>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getServerProcesses() == null
                ^ this.getServerProcesses() == null)
            return false;
        if (other.getServerProcesses() != null
                && other.getServerProcesses().equals(this.getServerProcesses()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getServerProcesses() == null) ? 0 : getServerProcesses()
                        .hashCode());
        return hashCode;
    }
