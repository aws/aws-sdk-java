...
/**
 * DeleteMatchmakingConfigurationResult JSON Unmarshaller
 */
...
public class DeleteMatchmakingConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteMatchmakingConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteMatchmakingConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMatchmakingConfigurationResult deleteMatchmakingConfigurationResult = new DeleteMatchmakingConfigurationResult();

        return deleteMatchmakingConfigurationResult;
    }
