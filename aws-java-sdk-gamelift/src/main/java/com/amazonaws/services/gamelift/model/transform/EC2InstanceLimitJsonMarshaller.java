...
public class EC2InstanceLimitJsonMarshaller {
     ...
     */
    public void marshall(EC2InstanceLimit eC2InstanceLimit, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (eC2InstanceLimit.getEC2InstanceType() != null) {
                jsonGenerator.writeFieldName("EC2InstanceType").writeValue(eC2InstanceLimit.getEC2InstanceType());
            }
            if (eC2InstanceLimit.getCurrentInstances() != null) {
                jsonGenerator.writeFieldName("CurrentInstances").writeValue(eC2InstanceLimit.getCurrentInstances());
            }
            if (eC2InstanceLimit.getInstanceLimit() != null) {
                jsonGenerator.writeFieldName("InstanceLimit").writeValue(eC2InstanceLimit.getInstanceLimit());
            }
