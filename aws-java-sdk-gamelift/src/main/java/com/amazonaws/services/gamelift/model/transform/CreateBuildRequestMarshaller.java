 ...
 */
public class CreateBuildRequestMarshaller implements
        Marshaller<Request<CreateBuildRequest>, CreateBuildRequest> {

    public Request<CreateBuildRequest> marshall(
        ...
        Request<CreateBuildRequest> request = new DefaultRequest<CreateBuildRequest>(
                createBuildRequest, "AmazonGameLift");
