...
/**
 * GameServerGroupAutoScalingPolicy JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GameServerGroupAutoScalingPolicyJsonUnmarshaller implements Unmarshaller<GameServerGroupAutoScalingPolicy, JsonUnmarshallerContext> {

    public GameServerGroupAutoScalingPolicy unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static GameServerGroupAutoScalingPolicyJsonUnmarshaller instance;

    public static GameServerGroupAutoScalingPolicyJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GameServerGroupAutoScalingPolicyJsonUnmarshaller();
        return instance;
    }
}
