...
public class ListFleetsResultJsonUnmarshaller implements
    ...
    public ListFleetsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FleetIds", targetDepth)) {
                    context.nextToken();
                    listFleetsResult.setFleetIds(new ListUnmarshaller<String>(
                            context.getUnmarshaller(String.class))
                            .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listFleetsResult.setNextToken(context.getUnmarshaller(
