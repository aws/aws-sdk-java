 ...
 */
public class RequestUploadCredentialsResultJsonUnmarshaller implements
        Unmarshaller<RequestUploadCredentialsResult, JsonUnmarshallerContext> {

    public RequestUploadCredentialsResult unmarshall(
