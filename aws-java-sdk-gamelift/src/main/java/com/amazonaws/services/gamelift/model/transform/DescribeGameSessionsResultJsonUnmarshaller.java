...
public class DescribeGameSessionsResultJsonUnmarshaller implements Unmarshaller<DescribeGameSessionsResult, JsonUnmarshallerContext> {
    ...
    private static DescribeGameSessionsResultJsonUnmarshaller instance;

    public static DescribeGameSessionsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeGameSessionsResultJsonUnmarshaller();
        return instance;
    }
}
