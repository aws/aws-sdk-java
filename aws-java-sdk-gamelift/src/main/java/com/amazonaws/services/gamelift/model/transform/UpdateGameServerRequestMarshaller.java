...
@SdkInternalApi
public class UpdateGameServerRequestMarshaller {
    ...
    private static final UpdateGameServerRequestMarshaller instance = new UpdateGameServerRequestMarshaller();

    public static UpdateGameServerRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateGameServerRequest updateGameServerRequest, ProtocolMarshaller protocolMarshaller) {
