...
public class GetComputeAuthTokenRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetComputeAuthTokenRequest withFleetId(String fleetId) {
        setFleetId(fleetId);
        return this;
    }
    ...
    public GetComputeAuthTokenRequest withComputeName(String computeName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetComputeAuthTokenRequest == false)
            return false;
    ...
    @Override
    public GetComputeAuthTokenRequest clone() {
