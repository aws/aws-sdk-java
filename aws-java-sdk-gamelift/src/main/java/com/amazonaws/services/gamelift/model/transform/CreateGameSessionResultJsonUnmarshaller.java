 ...
 */
public class CreateGameSessionResultJsonUnmarshaller implements
        Unmarshaller<CreateGameSessionResult, JsonUnmarshallerContext> {

    public CreateGameSessionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
