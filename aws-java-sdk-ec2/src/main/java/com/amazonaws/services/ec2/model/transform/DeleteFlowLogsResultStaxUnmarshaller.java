...
/**
 * Delete Flow Logs Result StAX Unmarshaller
 */
public class DeleteFlowLogsResultStaxUnmarshaller implements Unmarshaller<DeleteFlowLogsResult, StaxUnmarshallerContext> {
    ...
    public DeleteFlowLogsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return deleteFlowLogsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("unsuccessful/item", targetDepth)) {
                    deleteFlowLogsResult.getUnsuccessful().add(UnsuccessfulItemStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DeleteFlowLogsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteFlowLogsResultStaxUnmarshaller();
        return instance;
    }
}
