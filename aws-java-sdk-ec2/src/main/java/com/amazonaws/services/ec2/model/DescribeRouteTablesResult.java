 ...
 * 
 */
public class DescribeRouteTablesResult implements Serializable, Cloneable {
    ...
    public void setRouteTables(java.util.Collection<RouteTable> routeTables) {
        ...
        this.routeTables = new com.amazonaws.internal.SdkInternalList<RouteTable>(
                routeTables);
    }
     ...
     * any). Use {@link #setRouteTables(java.util.Collection)} or
     * {@link #withRouteTables(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param routeTables
