...
public class DisassociateIamInstanceProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateIamInstanceProfileResult == false)
            return false;
        DisassociateIamInstanceProfileResult other = (DisassociateIamInstanceProfileResult) obj;
    ...
    public DisassociateIamInstanceProfileResult clone() {
        try {
            return (DisassociateIamInstanceProfileResult) super.clone();
