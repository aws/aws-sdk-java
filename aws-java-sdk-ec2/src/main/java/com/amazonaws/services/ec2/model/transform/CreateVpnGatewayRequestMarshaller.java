...
public class CreateVpnGatewayRequestMarshaller implements
    ...
    public Request<CreateVpnGatewayRequest> marshall(
        ...
        Request<CreateVpnGatewayRequest> request = new DefaultRequest<CreateVpnGatewayRequest>(
                createVpnGatewayRequest, "AmazonEC2");
        ...
        if (createVpnGatewayRequest.getType() != null) {
            request.addParameter("Type",
                    StringUtils.fromString(createVpnGatewayRequest.getType()));
        }

        if (createVpnGatewayRequest.getAvailabilityZone() != null) {
            request.addParameter("AvailabilityZone", StringUtils
                    .fromString(createVpnGatewayRequest.getAvailabilityZone()));
        }
