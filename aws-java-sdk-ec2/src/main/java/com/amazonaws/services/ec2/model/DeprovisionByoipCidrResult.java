...
public class DeprovisionByoipCidrResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeprovisionByoipCidrResult withByoipCidr(ByoipCidr byoipCidr) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeprovisionByoipCidrResult == false)
            return false;
        DeprovisionByoipCidrResult other = (DeprovisionByoipCidrResult) obj;
    ...
    @Override
    public DeprovisionByoipCidrResult clone() {
        try {
            return (DeprovisionByoipCidrResult) super.clone();
