...
public class DeleteVpnConnectionRouteRequestMarshaller
        implements
        Marshaller<Request<DeleteVpnConnectionRouteRequest>, DeleteVpnConnectionRouteRequest> {

    public Request<DeleteVpnConnectionRouteRequest> marshall(
        ...
        if (deleteVpnConnectionRouteRequest.getVpnConnectionId() != null) {
            request.addParameter("VpnConnectionId", StringUtils
                    .fromString(deleteVpnConnectionRouteRequest
                            .getVpnConnectionId()));
        }
