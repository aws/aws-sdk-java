...
public class DeleteTransitGatewayRouteTableResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return Information about the deleted transit gateway route table.
     */
    ...
    public DeleteTransitGatewayRouteTableResult withTransitGatewayRouteTable(TransitGatewayRouteTable transitGatewayRouteTable) {
    ...
    @Override
    public DeleteTransitGatewayRouteTableResult clone() {
        try {
            return (DeleteTransitGatewayRouteTableResult) super.clone();
