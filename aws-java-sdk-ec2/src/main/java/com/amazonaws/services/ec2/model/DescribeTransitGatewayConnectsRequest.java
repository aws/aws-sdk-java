...
import com.amazonaws.services.ec2.model.transform.DescribeTransitGatewayConnectsRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeTransitGatewayConnectsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DescribeTransitGatewayConnectsRequest> {
     ...
     * <code>pendingAcceptance</code> | <code>rollingBack</code> | <code>pending</code> | <code>available</code> |
     * <code>modifying</code> | <code>deleting</code> | <code>deleted</code> | <code>failed</code> |
     * <code>rejected</code> | <code>rejecting</code> | <code>failing</code>).
     * </p>
     * </li>
     * <li>
     * <p>
     ...
     * <li>
     * <p>
     * <code>transport-transit-gateway-attachment-id</code> - The ID of the transit gateway attachment from which the
    ...
    public DescribeTransitGatewayConnectsRequest withTransitGatewayAttachmentIds(java.util.Collection<String> transitGatewayAttachmentIds) {
     ...
     *         <code>initiatingRequest</code> | <code>pendingAcceptance</code> | <code>rollingBack</code> |
     *         <code>pending</code> | <code>available</code> | <code>modifying</code> | <code>deleting</code> |
     *         <code>deleted</code> | <code>failed</code> | <code>rejected</code> | <code>rejecting</code> |
     *         <code>failing</code>).
     *         </p>
     *         </li>
     *         <li>
     ...
     *         <li>
     *         <p>
     *         <code>transport-transit-gateway-attachment-id</code> - The ID of the transit gateway attachment from
     ...
     *        <li>
     *        <p>
     *        <code>transport-transit-gateway-attachment-id</code> - The ID of the transit gateway attachment from which
    ...
    public DescribeTransitGatewayConnectsRequest withFilters(Filter... filters) {
    ...
    public DescribeTransitGatewayConnectsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeTransitGatewayConnectsRequest withMaxResults(Integer maxResults) {
     ...
     */
    @Override
    public Request<DescribeTransitGatewayConnectsRequest> getDryRunRequest() {
        Request<DescribeTransitGatewayConnectsRequest> request = new DescribeTransitGatewayConnectsRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeTransitGatewayConnectsRequest == false)
            return false;
        DescribeTransitGatewayConnectsRequest other = (DescribeTransitGatewayConnectsRequest) obj;
    ...
    @Override
    public DescribeTransitGatewayConnectsRequest clone() {
        return (DescribeTransitGatewayConnectsRequest) super.clone();
    }
}
