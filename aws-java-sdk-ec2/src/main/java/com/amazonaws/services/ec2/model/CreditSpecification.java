...
public class CreditSpecification implements Serializable, Cloneable {
     ...
     * 
     * @param cpuCredits
     *        The credit option for CPU usage of a T instance.</p>
     *        <p>
     *        Valid values: <code>standard</code> | <code>unlimited</code>
     */
     ...
     * </p>
     * 
     * @return The credit option for CPU usage of a T instance.</p>
     *         <p>
     *         Valid values: <code>standard</code> | <code>unlimited</code>
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreditSpecification == false)
            return false;
        CreditSpecification other = (CreditSpecification) obj;
    ...
    @Override
    public CreditSpecification clone() {
        try {
            return (CreditSpecification) super.clone();
