...
public class UnassignPrivateIpAddressesRequestMarshaller
        implements
        Marshaller<Request<UnassignPrivateIpAddressesRequest>, UnassignPrivateIpAddressesRequest> {

    public Request<UnassignPrivateIpAddressesRequest> marshall(
        ...
        Request<UnassignPrivateIpAddressesRequest> request = new DefaultRequest<UnassignPrivateIpAddressesRequest>(
                unassignPrivateIpAddressesRequest, "AmazonEC2");
        ...
        if (unassignPrivateIpAddressesRequest.getNetworkInterfaceId() != null) {
            request.addParameter("NetworkInterfaceId", StringUtils
                    .fromString(unassignPrivateIpAddressesRequest
