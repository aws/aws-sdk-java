 ...
 */
public class DescribeHostReservationsResultStaxUnmarshaller implements
        Unmarshaller<DescribeHostReservationsResult, StaxUnmarshallerContext> {

    public DescribeHostReservationsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("hostReservationSet/member",
                        targetDepth)) {
                    describeHostReservationsResult
                            .withHostReservationSet(HostReservationStaxUnmarshaller
