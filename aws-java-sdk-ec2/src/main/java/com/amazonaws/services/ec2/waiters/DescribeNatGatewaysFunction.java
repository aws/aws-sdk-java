...
@SdkInternalApi
public class DescribeNatGatewaysFunction implements
        SdkFunction<DescribeNatGatewaysRequest, DescribeNatGatewaysResult> {
     ...
     */
    @Override
    public DescribeNatGatewaysResult apply(
