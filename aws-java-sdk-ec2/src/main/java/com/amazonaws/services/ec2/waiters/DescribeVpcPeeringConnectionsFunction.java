...
@SdkInternalApi
public class DescribeVpcPeeringConnectionsFunction
        implements
        SdkFunction<DescribeVpcPeeringConnectionsRequest, DescribeVpcPeeringConnectionsResult> {
    ...
    /**
     * Constructs a new DescribeVpcPeeringConnectionsFunction with the given
     * client
     * 
     * @param client
     *        Service client
     ...
     */
    @Override
    public DescribeVpcPeeringConnectionsResult apply(
