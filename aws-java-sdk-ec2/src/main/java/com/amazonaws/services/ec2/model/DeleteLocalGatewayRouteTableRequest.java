...
import com.amazonaws.services.ec2.model.transform.DeleteLocalGatewayRouteTableRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteLocalGatewayRouteTableRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DeleteLocalGatewayRouteTableRequest> {
     ...
     */
    @Override
    public Request<DeleteLocalGatewayRouteTableRequest> getDryRunRequest() {
        Request<DeleteLocalGatewayRouteTableRequest> request = new DeleteLocalGatewayRouteTableRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteLocalGatewayRouteTableRequest == false)
            return false;
        DeleteLocalGatewayRouteTableRequest other = (DeleteLocalGatewayRouteTableRequest) obj;
    ...
    public DeleteLocalGatewayRouteTableRequest clone() {
        return (DeleteLocalGatewayRouteTableRequest) super.clone();
    }
}
