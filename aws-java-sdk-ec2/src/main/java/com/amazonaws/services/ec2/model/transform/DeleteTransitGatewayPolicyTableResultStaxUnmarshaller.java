...
/**
 * DeleteTransitGatewayPolicyTableResult StAX Unmarshaller
 */
...
public class DeleteTransitGatewayPolicyTableResultStaxUnmarshaller implements Unmarshaller<DeleteTransitGatewayPolicyTableResult, StaxUnmarshallerContext> {
    ...
    public DeleteTransitGatewayPolicyTableResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("transitGatewayPolicyTable", targetDepth)) {
                    deleteTransitGatewayPolicyTableResult.setTransitGatewayPolicyTable(TransitGatewayPolicyTableStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
