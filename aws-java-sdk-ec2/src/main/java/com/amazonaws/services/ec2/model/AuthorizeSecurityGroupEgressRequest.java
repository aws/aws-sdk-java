...
public class AuthorizeSecurityGroupEgressRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
    ...
    /**
     * <p>
     * The AWS account number for a destination security group. To authorize outbound access to a destination security
     ...
     * </p>
     * 
     * @return The name of a destination security group. To authorize outbound access to a destination security group,
     ...
     * </p>
     * 
     * @return The AWS account number for a destination security group. To authorize outbound access to a destination
     *         security group, we recommend that you use a set of IP permissions instead.
     */
