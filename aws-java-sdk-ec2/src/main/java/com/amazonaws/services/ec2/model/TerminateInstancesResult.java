 ...
 * </p>
 */
public class TerminateInstancesResult extends
    ...
    public void setTerminatingInstances(
        ...
        this.terminatingInstances = new com.amazonaws.internal.SdkInternalList<InstanceStateChange>(
     ...
     * any). Use {@link #setTerminatingInstances(java.util.Collection)} or
     * {@link #withTerminatingInstances(java.util.Collection)} if you want to
    ...
    public TerminateInstancesResult withTerminatingInstances(
        ...
        if (this.terminatingInstances == null) {
            setTerminatingInstances(new com.amazonaws.internal.SdkInternalList<InstanceStateChange>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTerminatingInstances() == null
                ^ this.getTerminatingInstances() == null)
            return false;
        if (other.getTerminatingInstances() != null
                && other.getTerminatingInstances().equals(
                        this.getTerminatingInstances()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getTerminatingInstances() == null) ? 0
                        : getTerminatingInstances().hashCode());
        return hashCode;
    }
