...
import com.amazonaws.services.ec2.model.transform.DisassociateTransitGatewayRouteTableRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DisassociateTransitGatewayRouteTableRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DisassociateTransitGatewayRouteTableRequest> {
     ...
     */
    @Override
    public Request<DisassociateTransitGatewayRouteTableRequest> getDryRunRequest() {
        Request<DisassociateTransitGatewayRouteTableRequest> request = new DisassociateTransitGatewayRouteTableRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateTransitGatewayRouteTableRequest == false)
            return false;
        DisassociateTransitGatewayRouteTableRequest other = (DisassociateTransitGatewayRouteTableRequest) obj;
    ...
    @Override
    public DisassociateTransitGatewayRouteTableRequest clone() {
        return (DisassociateTransitGatewayRouteTableRequest) super.clone();
    }
}
