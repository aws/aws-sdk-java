 ...
 */
public class DescribeSecurityGroupsResultStaxUnmarshaller implements
        Unmarshaller<DescribeSecurityGroupsResult, StaxUnmarshallerContext> {

    public DescribeSecurityGroupsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("securityGroupInfo/item",
                        targetDepth)) {
                    describeSecurityGroupsResult.getSecurityGroups().add(
                            SecurityGroupStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
