...
@SdkInternalApi
public class DescribeSpotInstanceRequestsFunction
        implements
        SdkFunction<DescribeSpotInstanceRequestsRequest, DescribeSpotInstanceRequestsResult> {
    ...
    /**
     * Constructs a new DescribeSpotInstanceRequestsFunction with the given
     * client
     * 
     * @param client
     *        Service client
     ...
     */
    @Override
    public DescribeSpotInstanceRequestsResult apply(
