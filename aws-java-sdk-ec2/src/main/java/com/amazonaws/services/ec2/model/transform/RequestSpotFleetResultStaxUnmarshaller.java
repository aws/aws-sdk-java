 ...
 */
public class RequestSpotFleetResultStaxUnmarshaller implements
        Unmarshaller<RequestSpotFleetResult, StaxUnmarshallerContext> {

    public RequestSpotFleetResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
