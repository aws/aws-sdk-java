...
public class DeleteTransitGatewayVpcAttachmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTransitGatewayVpcAttachmentResult == false)
            return false;
        DeleteTransitGatewayVpcAttachmentResult other = (DeleteTransitGatewayVpcAttachmentResult) obj;
    ...
    public DeleteTransitGatewayVpcAttachmentResult clone() {
        try {
            return (DeleteTransitGatewayVpcAttachmentResult) super.clone();
