...
public class ReplaceNetworkAclAssociationRequestMarshaller implements
        Marshaller<Request<ReplaceNetworkAclAssociationRequest>, ReplaceNetworkAclAssociationRequest> {
    ...
    public Request<ReplaceNetworkAclAssociationRequest> marshall(ReplaceNetworkAclAssociationRequest replaceNetworkAclAssociationRequest) {
        ...
        Request<ReplaceNetworkAclAssociationRequest> request = new DefaultRequest<ReplaceNetworkAclAssociationRequest>(replaceNetworkAclAssociationRequest,
                "AmazonEC2");
