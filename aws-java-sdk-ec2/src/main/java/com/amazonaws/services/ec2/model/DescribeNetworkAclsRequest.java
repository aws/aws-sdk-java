...
public class DescribeNetworkAclsRequest extends AmazonWebServiceRequest
     ...
     * <li>
     * <p>
     * <code>entry.egress</code> - Indicates whether the entry applies to egress
     * traffic.
     * </p>
     * </li>
     * <li>
    ...
    public void setNetworkAclIds(java.util.Collection<String> networkAclIds) {
        ...
        this.networkAclIds = new com.amazonaws.internal.SdkInternalList<String>(
                networkAclIds);
    }
     ...
     * any). Use {@link #setNetworkAclIds(java.util.Collection)} or
     * {@link #withNetworkAclIds(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param networkAclIds
     ...
     *         <li>
     *         <p>
     *         <code>entry.egress</code> - Indicates whether the entry applies
     *         to egress traffic.
     *         </p>
     *         </li>
     *         <li>
     ...
     *        <li>
     *        <p>
     *        <code>association.association-id</code> - The ID of an association
     *        ID for the ACL.
     *        </p>
     *        </li>
     *        <li>
     ...
     *        <li>
     *        <p>
     *        <code>entry.egress</code> - Indicates whether the entry applies to
     *        egress traffic.
     *        </p>
     *        </li>
     *        <li>
    ...
    public Request<DescribeNetworkAclsRequest> getDryRunRequest() {
        Request<DescribeNetworkAclsRequest> request = new DescribeNetworkAclsRequestMarshaller()
                .marshall(this);
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getNetworkAclIds() == null) ? 0 : getNetworkAclIds()
                        .hashCode());
