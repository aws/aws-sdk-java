 ...
 */
public class DescribeConversionTasksResultStaxUnmarshaller implements
        Unmarshaller<DescribeConversionTasksResult, StaxUnmarshallerContext> {

    public DescribeConversionTasksResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("conversionTasks/item", targetDepth)) {
                    describeConversionTasksResult.getConversionTasks().add(
                            ConversionTaskStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
