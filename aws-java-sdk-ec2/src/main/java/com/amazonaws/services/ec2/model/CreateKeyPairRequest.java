 ...
 * 
 */
public class CreateKeyPairRequest extends AmazonWebServiceRequest implements
        Serializable, Cloneable, DryRunSupportedRequest<CreateKeyPairRequest> {
    ...
    /**
     * Default constructor for CreateKeyPairRequest object. Callers should use
    ...
    /**
     * Constructs a new CreateKeyPairRequest object. Callers should use the
    ...
    public Request<CreateKeyPairRequest> getDryRunRequest() {
        Request<CreateKeyPairRequest> request = new CreateKeyPairRequestMarshaller()
                .marshall(this);
