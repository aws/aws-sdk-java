 ...
 */
public class AccountAttributeValueStaxUnmarshaller implements
        Unmarshaller<AccountAttributeValue, StaxUnmarshallerContext> {

    public AccountAttributeValue unmarshall(StaxUnmarshallerContext context)
            throws Exception {
