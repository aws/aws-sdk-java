...
public class ConnectionTrackingSpecificationResponse implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConnectionTrackingSpecificationResponse == false)
            return false;
    ...
    @Override
    public ConnectionTrackingSpecificationResponse clone() {
        try {
            return (ConnectionTrackingSpecificationResponse) super.clone();
