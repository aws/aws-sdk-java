 ...
 */
public class DescribeImportImageTasksResultStaxUnmarshaller implements
        Unmarshaller<DescribeImportImageTasksResult, StaxUnmarshallerContext> {

    public DescribeImportImageTasksResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("importImageTaskSet/item",
                        targetDepth)) {
                    describeImportImageTasksResult.getImportImageTasks().add(
                            ImportImageTaskStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
