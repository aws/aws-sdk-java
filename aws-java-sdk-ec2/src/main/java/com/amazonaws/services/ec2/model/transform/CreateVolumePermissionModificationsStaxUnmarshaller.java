...
public class CreateVolumePermissionModificationsStaxUnmarshaller implements Unmarshaller<CreateVolumePermissionModifications, StaxUnmarshallerContext> {

    public CreateVolumePermissionModifications unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Remove/item", targetDepth)) {
                    createVolumePermissionModifications.withRemove(CreateVolumePermissionStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    private static CreateVolumePermissionModificationsStaxUnmarshaller instance;

    public static CreateVolumePermissionModificationsStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateVolumePermissionModificationsStaxUnmarshaller();
        return instance;
    }
}
