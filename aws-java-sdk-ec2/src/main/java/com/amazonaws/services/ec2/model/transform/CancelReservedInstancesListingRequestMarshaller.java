...
public class CancelReservedInstancesListingRequestMarshaller
        implements
        Marshaller<Request<CancelReservedInstancesListingRequest>, CancelReservedInstancesListingRequest> {

    public Request<CancelReservedInstancesListingRequest> marshall(
