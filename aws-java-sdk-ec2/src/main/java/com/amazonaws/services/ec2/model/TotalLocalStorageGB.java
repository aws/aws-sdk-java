 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/TotalLocalStorageGB" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TotalLocalStorageGB implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The minimum amount of total local storage, in GB. If this parameter is not specified, there is no minimum
     *         limit.
     */
     ...
     * </p>
     * 
     * @return The maximum amount of total local storage, in GB. If this parameter is not specified, there is no maximum
     *         limit.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TotalLocalStorageGB == false)
            return false;
        TotalLocalStorageGB other = (TotalLocalStorageGB) obj;
    ...
    public TotalLocalStorageGB clone() {
        try {
            return (TotalLocalStorageGB) super.clone();
