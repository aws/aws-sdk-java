...
/**
 * DisableAddressTransferResult StAX Unmarshaller
 */
...
public class DisableAddressTransferResultStaxUnmarshaller implements Unmarshaller<DisableAddressTransferResult, StaxUnmarshallerContext> {
    ...
    public DisableAddressTransferResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("addressTransfer", targetDepth)) {
                    disableAddressTransferResult.setAddressTransfer(AddressTransferStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
