...
public class InstanceCreditSpecificationRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InstanceCreditSpecificationRequest == false)
            return false;
    ...
    public InstanceCreditSpecificationRequest clone() {
        try {
            return (InstanceCreditSpecificationRequest) super.clone();
