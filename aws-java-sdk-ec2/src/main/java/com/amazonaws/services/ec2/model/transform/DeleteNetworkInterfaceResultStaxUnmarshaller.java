 ...
 */
public class DeleteNetworkInterfaceResultStaxUnmarshaller implements
        Unmarshaller<DeleteNetworkInterfaceResult, StaxUnmarshallerContext> {

    public DeleteNetworkInterfaceResult unmarshall(
