...
public class CreateDefaultSubnetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDefaultSubnetResult == false)
            return false;
        CreateDefaultSubnetResult other = (CreateDefaultSubnetResult) obj;
    ...
    public CreateDefaultSubnetResult clone() {
        try {
            return (CreateDefaultSubnetResult) super.clone();
