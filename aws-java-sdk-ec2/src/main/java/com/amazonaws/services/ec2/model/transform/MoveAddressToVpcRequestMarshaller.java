...
public class MoveAddressToVpcRequestMarshaller implements
        Marshaller<Request<MoveAddressToVpcRequest>, MoveAddressToVpcRequest> {

    public Request<MoveAddressToVpcRequest> marshall(
        ...
        if (moveAddressToVpcRequest.getPublicIp() != null) {
            request.addParameter("PublicIp", StringUtils
                    .fromString(moveAddressToVpcRequest.getPublicIp()));
        }
