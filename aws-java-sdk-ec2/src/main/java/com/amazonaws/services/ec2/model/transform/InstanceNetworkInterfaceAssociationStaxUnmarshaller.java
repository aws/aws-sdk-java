 ...
 */
public class InstanceNetworkInterfaceAssociationStaxUnmarshaller
        implements
        Unmarshaller<InstanceNetworkInterfaceAssociation, StaxUnmarshallerContext> {

    public InstanceNetworkInterfaceAssociation unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("publicIp", targetDepth)) {
                    instanceNetworkInterfaceAssociation
                            .setPublicIp(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("publicDnsName", targetDepth)) {
                    instanceNetworkInterfaceAssociation
                            .setPublicDnsName(StringStaxUnmarshaller
                ...
                if (context.testExpression("ipOwnerId", targetDepth)) {
                    instanceNetworkInterfaceAssociation
                            .setIpOwnerId(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
