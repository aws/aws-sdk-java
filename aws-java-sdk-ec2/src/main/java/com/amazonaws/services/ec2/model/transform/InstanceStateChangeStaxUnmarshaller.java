 ...
 */
public class InstanceStateChangeStaxUnmarshaller implements
        Unmarshaller<InstanceStateChange, StaxUnmarshallerContext> {

    public InstanceStateChange unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("instanceId", targetDepth)) {
                    instanceStateChange.setInstanceId(StringStaxUnmarshaller
                ...
                if (context.testExpression("currentState", targetDepth)) {
                    instanceStateChange
                            .setCurrentState(InstanceStateStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("previousState", targetDepth)) {
                    instanceStateChange
                            .setPreviousState(InstanceStateStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
