...
public class RevokeSecurityGroupEgressRequest extends AmazonWebServiceRequest
     ...
     *        The name of a destination security group. To revoke outbound
     ...
     * </p>
     * 
     * @return The name of a destination security group. To revoke outbound
     *         access to a destination security group, we recommend that you use
     *         a set of IP permissions instead.
     */
    ...
    public RevokeSecurityGroupEgressRequest withSourceSecurityGroupName(
     ...
     *         revoke outbound access to a destination security group, we
    ...
    public RevokeSecurityGroupEgressRequest withSourceSecurityGroupOwnerId(
    ...
    public RevokeSecurityGroupEgressRequest withIpPermissions(
    ...
    public Request<RevokeSecurityGroupEgressRequest> getDryRunRequest() {
        Request<RevokeSecurityGroupEgressRequest> request = new RevokeSecurityGroupEgressRequestMarshaller()
                .marshall(this);
