...
public class AssociateAddressRequest extends AmazonWebServiceRequest implements
    ...
    /**
     * Default constructor for AssociateAddressRequest object. Callers should
    ...
    /**
     * Constructs a new AssociateAddressRequest object. Callers should use the
     ...
     * </p>
     * 
     * @return The ID of the instance. This is required for EC2-Classic. For
     *         EC2-VPC, you can specify either the instance ID or the network
     *         interface ID, but not both. The operation fails if you specify an
     *         instance ID unless exactly one network interface is attached.
     */
     ...
     * </p>
     * 
     * @return [EC2-VPC] The ID of the network interface. If the instance has
     *         more than one network interface, you must specify a network
     *         interface ID.
     */
     ...
     * </p>
     * 
     * @return [EC2-VPC] The primary or secondary private IP address to
     ...
     * </p>
     * 
     * @return [EC2-VPC] For a VPC in an EC2-Classic account, specify true to
     *         allow an Elastic IP address that is already associated with an
     *         instance or network interface to be reassociated with the
     *         specified instance or network interface. Otherwise, the operation
     *         fails. In a VPC in an EC2-VPC-only account, reassociation is
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAllowReassociation() == null
                ^ this.getAllowReassociation() == null)
            return false;
        if (other.getAllowReassociation() != null
                && other.getAllowReassociation().equals(
                        this.getAllowReassociation()) == false)
            return false;
        return true;
    }
