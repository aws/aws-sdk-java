...
/**
 * MediaDeviceInfo StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MediaDeviceInfoStaxUnmarshaller implements Unmarshaller<MediaDeviceInfo, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("count", targetDepth)) {
                    mediaDeviceInfo.setCount(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("name", targetDepth)) {
                    mediaDeviceInfo.setName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("manufacturer", targetDepth)) {
                    mediaDeviceInfo.setManufacturer(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
