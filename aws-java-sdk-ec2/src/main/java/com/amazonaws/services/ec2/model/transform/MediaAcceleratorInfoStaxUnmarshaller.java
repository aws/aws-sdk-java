...
/**
 * MediaAcceleratorInfo StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MediaAcceleratorInfoStaxUnmarshaller implements Unmarshaller<MediaAcceleratorInfo, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("totalMediaMemoryInMiB", targetDepth)) {
                    mediaAcceleratorInfo.setTotalMediaMemoryInMiB(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
