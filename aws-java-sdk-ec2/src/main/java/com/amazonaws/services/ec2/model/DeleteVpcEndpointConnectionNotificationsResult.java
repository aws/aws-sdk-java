...
public class DeleteVpcEndpointConnectionNotificationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public DeleteVpcEndpointConnectionNotificationsResult withUnsuccessful(UnsuccessfulItem... unsuccessful) {
    ...
    public DeleteVpcEndpointConnectionNotificationsResult withUnsuccessful(java.util.Collection<UnsuccessfulItem> unsuccessful) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVpcEndpointConnectionNotificationsResult == false)
            return false;
        DeleteVpcEndpointConnectionNotificationsResult other = (DeleteVpcEndpointConnectionNotificationsResult) obj;
    ...
    public DeleteVpcEndpointConnectionNotificationsResult clone() {
        try {
            return (DeleteVpcEndpointConnectionNotificationsResult) super.clone();
