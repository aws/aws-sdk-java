 ...
 * 
 */
public class DescribeBundleTasksResult implements Serializable, Cloneable {
    ...
    public void setBundleTasks(java.util.Collection<BundleTask> bundleTasks) {
        ...
        this.bundleTasks = new com.amazonaws.internal.SdkInternalList<BundleTask>(
                bundleTasks);
    }
     ...
     * any). Use {@link #setBundleTasks(java.util.Collection)} or
     * {@link #withBundleTasks(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param bundleTasks
