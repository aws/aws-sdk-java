...
@SdkInternalApi
public class DescribeInstanceStatusFunction
        implements
        SdkFunction<DescribeInstanceStatusRequest, DescribeInstanceStatusResult> {
     ...
     */
    @Override
    public DescribeInstanceStatusResult apply(
