 ...
 */
public class NetworkInterfacePrivateIpAddressStaxUnmarshaller implements
        Unmarshaller<NetworkInterfacePrivateIpAddress, StaxUnmarshallerContext> {

    public NetworkInterfacePrivateIpAddress unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("primary", targetDepth)) {
                    networkInterfacePrivateIpAddress
                            .setPrimary(BooleanStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("association", targetDepth)) {
                    networkInterfacePrivateIpAddress
                            .setAssociation(NetworkInterfaceAssociationStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
