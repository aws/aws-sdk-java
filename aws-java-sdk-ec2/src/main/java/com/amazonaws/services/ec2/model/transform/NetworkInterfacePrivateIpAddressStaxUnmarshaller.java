 ...
 */
public class NetworkInterfacePrivateIpAddressStaxUnmarshaller implements Unmarshaller<NetworkInterfacePrivateIpAddress, StaxUnmarshallerContext> {
    ...
    public NetworkInterfacePrivateIpAddress unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return networkInterfacePrivateIpAddress;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("association", targetDepth)) {
                    networkInterfacePrivateIpAddress.setAssociation(NetworkInterfaceAssociationStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static NetworkInterfacePrivateIpAddressStaxUnmarshaller getInstance() {
        if (instance == null) instance = new NetworkInterfacePrivateIpAddressStaxUnmarshaller();
        return instance;
    }
}
