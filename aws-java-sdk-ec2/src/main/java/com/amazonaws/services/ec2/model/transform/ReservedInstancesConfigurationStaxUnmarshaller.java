 ...
 */
public class ReservedInstancesConfigurationStaxUnmarshaller implements
        Unmarshaller<ReservedInstancesConfiguration, StaxUnmarshallerContext> {

    public ReservedInstancesConfiguration unmarshall(
