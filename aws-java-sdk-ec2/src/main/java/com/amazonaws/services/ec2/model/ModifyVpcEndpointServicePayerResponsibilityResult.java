...
public class ModifyVpcEndpointServicePayerResponsibilityResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyVpcEndpointServicePayerResponsibilityResult == false)
            return false;
        ModifyVpcEndpointServicePayerResponsibilityResult other = (ModifyVpcEndpointServicePayerResponsibilityResult) obj;
    ...
    @Override
    public ModifyVpcEndpointServicePayerResponsibilityResult clone() {
        try {
            return (ModifyVpcEndpointServicePayerResponsibilityResult) super.clone();
