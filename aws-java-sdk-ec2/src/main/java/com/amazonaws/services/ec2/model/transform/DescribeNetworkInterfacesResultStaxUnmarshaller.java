 ...
 */
public class DescribeNetworkInterfacesResultStaxUnmarshaller implements
        Unmarshaller<DescribeNetworkInterfacesResult, StaxUnmarshallerContext> {

    public DescribeNetworkInterfacesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("networkInterfaceSet/item",
                        targetDepth)) {
                    describeNetworkInterfacesResult.getNetworkInterfaces().add(
                            NetworkInterfaceStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
