 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/InstanceAttachmentEnaSrdSpecification"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceAttachmentEnaSrdSpecification implements Serializable, Cloneable {
    ...
    public void setEnaSrdUdpSpecification(InstanceAttachmentEnaSrdUdpSpecification enaSrdUdpSpecification) {
    ...
    public InstanceAttachmentEnaSrdUdpSpecification getEnaSrdUdpSpecification() {
    ...
    public InstanceAttachmentEnaSrdSpecification withEnaSrdUdpSpecification(InstanceAttachmentEnaSrdUdpSpecification enaSrdUdpSpecification) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InstanceAttachmentEnaSrdSpecification == false)
            return false;
        InstanceAttachmentEnaSrdSpecification other = (InstanceAttachmentEnaSrdSpecification) obj;
    ...
    @Override
    public InstanceAttachmentEnaSrdSpecification clone() {
        try {
            return (InstanceAttachmentEnaSrdSpecification) super.clone();
