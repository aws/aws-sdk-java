 ...
 */
public class DescribeReservedInstancesModificationsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeReservedInstancesModificationsResult, StaxUnmarshallerContext> {

    public DescribeReservedInstancesModificationsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression(
                        "reservedInstancesModificationsSet/item", targetDepth)) {
                    describeReservedInstancesModificationsResult
                            .withReservedInstancesModifications(ReservedInstancesModificationStaxUnmarshaller
