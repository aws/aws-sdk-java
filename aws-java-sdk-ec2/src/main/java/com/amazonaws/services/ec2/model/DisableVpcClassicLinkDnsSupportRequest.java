 ...
 * 
 */
public class DisableVpcClassicLinkDnsSupportRequest extends
    ...
    public Request<DisableVpcClassicLinkDnsSupportRequest> getDryRunRequest() {
        Request<DisableVpcClassicLinkDnsSupportRequest> request = new DisableVpcClassicLinkDnsSupportRequestMarshaller()
                .marshall(this);
