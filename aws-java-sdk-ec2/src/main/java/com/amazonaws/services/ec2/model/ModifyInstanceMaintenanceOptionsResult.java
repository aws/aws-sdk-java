...
public class ModifyInstanceMaintenanceOptionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyInstanceMaintenanceOptionsResult == false)
            return false;
        ModifyInstanceMaintenanceOptionsResult other = (ModifyInstanceMaintenanceOptionsResult) obj;
    ...
    public ModifyInstanceMaintenanceOptionsResult clone() {
        try {
            return (ModifyInstanceMaintenanceOptionsResult) super.clone();
