...
public class CreateSubnetResultStaxUnmarshaller implements Unmarshaller<CreateSubnetResult, StaxUnmarshallerContext> {
    ...
    public CreateSubnetResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createSubnetResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("subnet", targetDepth)) {
                    createSubnetResult.setSubnet(SubnetStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CreateSubnetResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateSubnetResultStaxUnmarshaller();
        return instance;
    }
}
