...
public class CreateTransitGatewayPeeringAttachmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateTransitGatewayPeeringAttachmentResult withTransitGatewayPeeringAttachment(TransitGatewayPeeringAttachment transitGatewayPeeringAttachment) {
    ...
    @Override
    public CreateTransitGatewayPeeringAttachmentResult clone() {
        try {
            return (CreateTransitGatewayPeeringAttachmentResult) super.clone();
