...
public class CreateTransitGatewayConnectResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the Connect attachment.
     */
    ...
    public CreateTransitGatewayConnectResult withTransitGatewayConnect(TransitGatewayConnect transitGatewayConnect) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTransitGatewayConnectResult == false)
            return false;
        CreateTransitGatewayConnectResult other = (CreateTransitGatewayConnectResult) obj;
    ...
    @Override
    public CreateTransitGatewayConnectResult clone() {
        try {
            return (CreateTransitGatewayConnectResult) super.clone();
