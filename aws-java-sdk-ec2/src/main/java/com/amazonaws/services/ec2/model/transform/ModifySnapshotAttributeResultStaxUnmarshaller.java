 ...
 */
public class ModifySnapshotAttributeResultStaxUnmarshaller implements
        Unmarshaller<ModifySnapshotAttributeResult, StaxUnmarshallerContext> {

    public ModifySnapshotAttributeResult unmarshall(
