...
public class DisableVgwRoutePropagationRequestMarshaller
        implements
        Marshaller<Request<DisableVgwRoutePropagationRequest>, DisableVgwRoutePropagationRequest> {
    ...
    public Request<DisableVgwRoutePropagationRequest> marshall(
        ...
        Request<DisableVgwRoutePropagationRequest> request = new DefaultRequest<DisableVgwRoutePropagationRequest>(
        ...
        if (disableVgwRoutePropagationRequest.getRouteTableId() != null) {
            request.addParameter("RouteTableId", StringUtils
                    .fromString(disableVgwRoutePropagationRequest
                            .getRouteTableId()));
        }

        if (disableVgwRoutePropagationRequest.getGatewayId() != null) {
            request.addParameter("GatewayId", StringUtils
                    .fromString(disableVgwRoutePropagationRequest
                            .getGatewayId()));
        }
