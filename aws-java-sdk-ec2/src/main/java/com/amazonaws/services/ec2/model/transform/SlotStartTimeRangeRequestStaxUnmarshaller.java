...
public class SlotStartTimeRangeRequestStaxUnmarshaller implements Unmarshaller<SlotStartTimeRangeRequest, StaxUnmarshallerContext> {

    public SlotStartTimeRangeRequest unmarshall(StaxUnmarshallerContext context) throws Exception {
