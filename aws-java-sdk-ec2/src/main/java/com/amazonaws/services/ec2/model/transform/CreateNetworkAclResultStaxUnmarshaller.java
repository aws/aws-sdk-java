 ...
 */
public class CreateNetworkAclResultStaxUnmarshaller implements Unmarshaller<CreateNetworkAclResult, StaxUnmarshallerContext> {

    public CreateNetworkAclResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createNetworkAclResult;
    ...
    public static CreateNetworkAclResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateNetworkAclResultStaxUnmarshaller();
        return instance;
    }
}
