 ...
 */
public class DeleteVpnGatewayResultStaxUnmarshaller implements
        Unmarshaller<DeleteVpnGatewayResult, StaxUnmarshallerContext> {

    public DeleteVpnGatewayResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
