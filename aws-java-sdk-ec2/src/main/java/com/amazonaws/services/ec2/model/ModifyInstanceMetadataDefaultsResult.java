...
public class ModifyInstanceMetadataDefaultsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public ModifyInstanceMetadataDefaultsResult withReturn(Boolean returnValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyInstanceMetadataDefaultsResult == false)
            return false;
        ModifyInstanceMetadataDefaultsResult other = (ModifyInstanceMetadataDefaultsResult) obj;
    ...
    @Override
    public ModifyInstanceMetadataDefaultsResult clone() {
        try {
            return (ModifyInstanceMetadataDefaultsResult) super.clone();
