 ...
 */
public class EbsInstanceBlockDeviceSpecificationStaxUnmarshaller
        implements
        Unmarshaller<EbsInstanceBlockDeviceSpecification, StaxUnmarshallerContext> {

    public EbsInstanceBlockDeviceSpecification unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("volumeId", targetDepth)) {
                    ebsInstanceBlockDeviceSpecification
                            .setVolumeId(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
    ...
    public static EbsInstanceBlockDeviceSpecificationStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new EbsInstanceBlockDeviceSpecificationStaxUnmarshaller();
        return instance;
    }
}
