...
/**
 * Detach Classic Link Vpc Request Marshaller
 */
public class DetachClassicLinkVpcRequestMarshaller implements Marshaller<Request<DetachClassicLinkVpcRequest>, DetachClassicLinkVpcRequest> {
    ...
    public Request<DetachClassicLinkVpcRequest> marshall(DetachClassicLinkVpcRequest detachClassicLinkVpcRequest) {
        ...
        if (detachClassicLinkVpcRequest.getInstanceId() != null) {
            request.addParameter("InstanceId", StringUtils.fromString(detachClassicLinkVpcRequest.getInstanceId()));
        }
        if (detachClassicLinkVpcRequest.getVpcId() != null) {
            request.addParameter("VpcId", StringUtils.fromString(detachClassicLinkVpcRequest.getVpcId()));
        }
