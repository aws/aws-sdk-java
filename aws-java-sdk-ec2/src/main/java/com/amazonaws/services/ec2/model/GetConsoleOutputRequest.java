 ...
 * 
 */
public class GetConsoleOutputRequest extends AmazonWebServiceRequest implements
        Serializable, Cloneable,
        DryRunSupportedRequest<GetConsoleOutputRequest> {
    ...
    /**
     * Default constructor for GetConsoleOutputRequest object. Callers should
    ...
    /**
     * Constructs a new GetConsoleOutputRequest object. Callers should use the
    ...
    public Request<GetConsoleOutputRequest> getDryRunRequest() {
        Request<GetConsoleOutputRequest> request = new GetConsoleOutputRequestMarshaller()
                .marshall(this);
