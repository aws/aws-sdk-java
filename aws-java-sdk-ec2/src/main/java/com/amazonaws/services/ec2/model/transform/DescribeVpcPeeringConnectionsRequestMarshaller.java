...
/**
 * Describe Vpc Peering Connections Request Marshaller
 */
public class DescribeVpcPeeringConnectionsRequestMarshaller implements Marshaller<Request<DescribeVpcPeeringConnectionsRequest>, DescribeVpcPeeringConnectionsRequest> {
    ...
    public Request<DescribeVpcPeeringConnectionsRequest> marshall(DescribeVpcPeeringConnectionsRequest describeVpcPeeringConnectionsRequest) {
        ...
        java.util.List<Filter> filtersList = describeVpcPeeringConnectionsRequest.getFilters();
