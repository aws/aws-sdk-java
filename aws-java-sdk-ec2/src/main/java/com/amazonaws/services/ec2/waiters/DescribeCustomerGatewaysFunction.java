...
@SdkInternalApi
public class DescribeCustomerGatewaysFunction
        implements
        SdkFunction<DescribeCustomerGatewaysRequest, DescribeCustomerGatewaysResult> {
     ...
     */
    @Override
    public DescribeCustomerGatewaysResult apply(
