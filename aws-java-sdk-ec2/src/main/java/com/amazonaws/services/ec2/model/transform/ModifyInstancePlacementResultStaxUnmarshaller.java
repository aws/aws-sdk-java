 ...
 */
public class ModifyInstancePlacementResultStaxUnmarshaller implements
        Unmarshaller<ModifyInstancePlacementResult, StaxUnmarshallerContext> {

    public ModifyInstancePlacementResult unmarshall(
