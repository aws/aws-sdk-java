 ...
 */
public class CreateFlowLogsResultStaxUnmarshaller implements
        Unmarshaller<CreateFlowLogsResult, StaxUnmarshallerContext> {

    public CreateFlowLogsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("flowLogIdSet/item", targetDepth)) {
                    createFlowLogsResult.getFlowLogIds().add(
                ...
                if (context.testExpression("clientToken", targetDepth)) {
                    createFlowLogsResult.setClientToken(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("unsuccessful/item", targetDepth)) {
                    createFlowLogsResult.getUnsuccessful().add(
