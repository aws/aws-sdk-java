 ...
 */
public class DescribeReservedInstancesOfferingsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeReservedInstancesOfferingsResult, StaxUnmarshallerContext> {

    public DescribeReservedInstancesOfferingsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression(
                        "reservedInstancesOfferingsSet/item", targetDepth)) {
                    describeReservedInstancesOfferingsResult
                            .withReservedInstancesOfferings(ReservedInstancesOfferingStaxUnmarshaller
