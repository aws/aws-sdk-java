...
public class DeleteVerifiedAccessEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVerifiedAccessEndpointResult == false)
            return false;
        DeleteVerifiedAccessEndpointResult other = (DeleteVerifiedAccessEndpointResult) obj;
    ...
    public DeleteVerifiedAccessEndpointResult clone() {
        try {
            return (DeleteVerifiedAccessEndpointResult) super.clone();
