 ...
 */
public class DeleteVolumeResultStaxUnmarshaller implements
        Unmarshaller<DeleteVolumeResult, StaxUnmarshallerContext> {

    public DeleteVolumeResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
