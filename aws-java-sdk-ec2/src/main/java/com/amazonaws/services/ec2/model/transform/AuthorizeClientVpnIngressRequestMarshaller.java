...
public class AuthorizeClientVpnIngressRequestMarshaller implements Marshaller<Request<AuthorizeClientVpnIngressRequest>, AuthorizeClientVpnIngressRequest> {
    ...
    public Request<AuthorizeClientVpnIngressRequest> marshall(AuthorizeClientVpnIngressRequest authorizeClientVpnIngressRequest) {
        ...
        Request<AuthorizeClientVpnIngressRequest> request = new DefaultRequest<AuthorizeClientVpnIngressRequest>(authorizeClientVpnIngressRequest, "AmazonEC2");
