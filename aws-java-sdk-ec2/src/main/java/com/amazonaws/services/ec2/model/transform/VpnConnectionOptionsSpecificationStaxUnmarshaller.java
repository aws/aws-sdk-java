 ...
 */
public class VpnConnectionOptionsSpecificationStaxUnmarshaller
        implements
        Unmarshaller<VpnConnectionOptionsSpecification, StaxUnmarshallerContext> {

    public VpnConnectionOptionsSpecification unmarshall(
