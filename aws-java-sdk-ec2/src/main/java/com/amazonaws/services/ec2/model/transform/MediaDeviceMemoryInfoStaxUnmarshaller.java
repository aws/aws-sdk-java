...
/**
 * MediaDeviceMemoryInfo StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MediaDeviceMemoryInfoStaxUnmarshaller implements Unmarshaller<MediaDeviceMemoryInfo, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("sizeInMiB", targetDepth)) {
                    mediaDeviceMemoryInfo.setSizeInMiB(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
