...
public class AssociateClientVpnTargetNetworkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    @Override
    public AssociateClientVpnTargetNetworkResult clone() {
        try {
            return (AssociateClientVpnTargetNetworkResult) super.clone();
