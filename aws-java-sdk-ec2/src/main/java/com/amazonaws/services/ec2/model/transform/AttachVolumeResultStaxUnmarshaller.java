 ...
 */
public class AttachVolumeResultStaxUnmarshaller implements
        Unmarshaller<AttachVolumeResult, StaxUnmarshallerContext> {

    public AttachVolumeResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
