...
public class ModifyVerifiedAccessInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ModifyVerifiedAccessInstanceResult withVerifiedAccessInstance(VerifiedAccessInstance verifiedAccessInstance) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyVerifiedAccessInstanceResult == false)
            return false;
        ModifyVerifiedAccessInstanceResult other = (ModifyVerifiedAccessInstanceResult) obj;
    ...
    @Override
    public ModifyVerifiedAccessInstanceResult clone() {
        try {
            return (ModifyVerifiedAccessInstanceResult) super.clone();
