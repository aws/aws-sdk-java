 ...
 */
public class AssignPrivateIpAddressesResultStaxUnmarshaller implements
        Unmarshaller<AssignPrivateIpAddressesResult, StaxUnmarshallerContext> {

    public AssignPrivateIpAddressesResult unmarshall(
