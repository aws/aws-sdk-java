 ...
 */
public class ImportVolumeTaskDetailsStaxUnmarshaller implements
        Unmarshaller<ImportVolumeTaskDetails, StaxUnmarshallerContext> {

    public ImportVolumeTaskDetails unmarshall(StaxUnmarshallerContext context)
            throws Exception {
