...
public class EnableSerialConsoleAccessResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableSerialConsoleAccessResult == false)
            return false;
        EnableSerialConsoleAccessResult other = (EnableSerialConsoleAccessResult) obj;
    ...
    @Override
    public EnableSerialConsoleAccessResult clone() {
        try {
            return (EnableSerialConsoleAccessResult) super.clone();
