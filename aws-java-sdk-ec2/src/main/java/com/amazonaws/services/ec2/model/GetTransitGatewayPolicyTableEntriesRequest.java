...
import com.amazonaws.services.ec2.model.transform.GetTransitGatewayPolicyTableEntriesRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetTransitGatewayPolicyTableEntriesRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<GetTransitGatewayPolicyTableEntriesRequest> {
    ...
    public GetTransitGatewayPolicyTableEntriesRequest withFilters(Filter... filters) {
    ...
    public GetTransitGatewayPolicyTableEntriesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public GetTransitGatewayPolicyTableEntriesRequest withMaxResults(Integer maxResults) {
     ...
     */
    @Override
    public Request<GetTransitGatewayPolicyTableEntriesRequest> getDryRunRequest() {
        Request<GetTransitGatewayPolicyTableEntriesRequest> request = new GetTransitGatewayPolicyTableEntriesRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTransitGatewayPolicyTableEntriesRequest == false)
            return false;
        GetTransitGatewayPolicyTableEntriesRequest other = (GetTransitGatewayPolicyTableEntriesRequest) obj;
    ...
    @Override
    public GetTransitGatewayPolicyTableEntriesRequest clone() {
        return (GetTransitGatewayPolicyTableEntriesRequest) super.clone();
    }
}
