...
public class DisassociateIpamByoasnResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DisassociateIpamByoasnResult withAsnAssociation(AsnAssociation asnAssociation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateIpamByoasnResult == false)
            return false;
        DisassociateIpamByoasnResult other = (DisassociateIpamByoasnResult) obj;
    ...
    @Override
    public DisassociateIpamByoasnResult clone() {
        try {
            return (DisassociateIpamByoasnResult) super.clone();
