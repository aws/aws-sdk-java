 ...
 */
public class CancelImportTaskResultStaxUnmarshaller implements
        Unmarshaller<CancelImportTaskResult, StaxUnmarshallerContext> {

    public CancelImportTaskResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("importTaskId", targetDepth)) {
                    cancelImportTaskResult
                            .setImportTaskId(StringStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("state", targetDepth)) {
                    cancelImportTaskResult.setState(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("previousState", targetDepth)) {
                    cancelImportTaskResult
                            .setPreviousState(StringStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
