...
class SnapshotImported {
    ...
    static class IsCompletedMatcher extends WaiterAcceptor<DescribeImportSnapshotTasksResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("ImportSnapshotTasks")),
                new JmesPathSubExpression(new JmesPathField("SnapshotTaskDetail"), new JmesPathField("Status")));
         ...
         */
        @Override
        public boolean matches(DescribeImportSnapshotTasksResult result) {
    ...
    static class IsErrorMatcher extends WaiterAcceptor<DescribeImportSnapshotTasksResult> {
        private static final JsonNode expectedResult;
