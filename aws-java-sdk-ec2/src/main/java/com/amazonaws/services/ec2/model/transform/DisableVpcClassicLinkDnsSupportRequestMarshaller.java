...
/**
 * Disable Vpc Classic Link Dns Support Request Marshaller
 */
public class DisableVpcClassicLinkDnsSupportRequestMarshaller implements Marshaller<Request<DisableVpcClassicLinkDnsSupportRequest>, DisableVpcClassicLinkDnsSupportRequest> {
    ...
    public Request<DisableVpcClassicLinkDnsSupportRequest> marshall(DisableVpcClassicLinkDnsSupportRequest disableVpcClassicLinkDnsSupportRequest) {
        ...
        Request<DisableVpcClassicLinkDnsSupportRequest> request = new DefaultRequest<DisableVpcClassicLinkDnsSupportRequest>(disableVpcClassicLinkDnsSupportRequest, "AmazonEC2");
