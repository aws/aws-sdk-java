...
public class DeleteNetworkAclResultStaxUnmarshaller implements Unmarshaller<DeleteNetworkAclResult, StaxUnmarshallerContext> {

    public DeleteNetworkAclResult unmarshall(StaxUnmarshallerContext context) throws Exception {
