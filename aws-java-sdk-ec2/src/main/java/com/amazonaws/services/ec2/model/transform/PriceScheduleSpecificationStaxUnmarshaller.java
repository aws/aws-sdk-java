...
public class PriceScheduleSpecificationStaxUnmarshaller implements Unmarshaller<PriceScheduleSpecification, StaxUnmarshallerContext> {

    public PriceScheduleSpecification unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("price", targetDepth)) {
                    priceScheduleSpecification.setPrice(DoubleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
