...
public class PeeringConnectionOptionsRequestStaxUnmarshaller implements Unmarshaller<PeeringConnectionOptionsRequest, StaxUnmarshallerContext> {

    public PeeringConnectionOptionsRequest unmarshall(StaxUnmarshallerContext context) throws Exception {
