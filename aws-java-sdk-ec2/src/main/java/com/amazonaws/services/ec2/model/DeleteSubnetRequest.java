...
public class DeleteSubnetRequest extends AmazonWebServiceRequest implements Serializable, Cloneable, DryRunSupportedRequest<DeleteSubnetRequest> {
    ...
    /**
     * Default constructor for DeleteSubnetRequest object. Callers should use the setter or fluent setter (with...)
    ...
    /**
     * Constructs a new DeleteSubnetRequest object. Callers should use the setter or fluent setter (with...) methods to
