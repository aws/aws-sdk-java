 ...
 * </p>
 */
public class RunScheduledInstancesResult extends
    ...
    public void setInstanceIdSet(java.util.Collection<String> instanceIdSet) {
        ...
        this.instanceIdSet = new com.amazonaws.internal.SdkInternalList<String>(
                instanceIdSet);
    }
     ...
     * any). Use {@link #setInstanceIdSet(java.util.Collection)} or
     * {@link #withInstanceIdSet(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param instanceIdSet
    ...
    public RunScheduledInstancesResult withInstanceIdSet(
        ...
        if (this.instanceIdSet == null) {
            setInstanceIdSet(new com.amazonaws.internal.SdkInternalList<String>(
                    instanceIdSet.length));
        }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getInstanceIdSet() == null) ? 0 : getInstanceIdSet()
                        .hashCode());
        return hashCode;
    }
