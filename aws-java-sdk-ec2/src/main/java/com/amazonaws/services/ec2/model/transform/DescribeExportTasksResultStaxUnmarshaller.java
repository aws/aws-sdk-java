...
public class DescribeExportTasksResultStaxUnmarshaller implements Unmarshaller<DescribeExportTasksResult, StaxUnmarshallerContext> {
    ...
    public DescribeExportTasksResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeExportTasksResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("exportTaskSet/item", targetDepth)) {
                    describeExportTasksResult.getExportTasks().add(ExportTaskStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeExportTasksResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeExportTasksResultStaxUnmarshaller();
        return instance;
    }
}
