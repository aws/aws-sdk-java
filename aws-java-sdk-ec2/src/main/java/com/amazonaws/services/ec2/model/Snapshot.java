...
public class Snapshot implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Value from an Amazon-maintained list (<code>amazon</code> |
     ...
     * </p>
     * 
     * @return The data encryption key identifier for the snapshot. This value
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDataEncryptionKeyId() == null
                ^ this.getDataEncryptionKeyId() == null)
            return false;
        if (other.getDataEncryptionKeyId() != null
                && other.getDataEncryptionKeyId().equals(
                        this.getDataEncryptionKeyId()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getStateMessage() == null) ? 0 : getStateMessage()
                        .hashCode());
        hashCode = prime * hashCode
        ...
        hashCode = prime * hashCode
                + ((getOwnerAlias() == null) ? 0 : getOwnerAlias().hashCode());
        hashCode = prime * hashCode
        ...
        hashCode = prime
                * hashCode
                + ((getDataEncryptionKeyId() == null) ? 0
                        : getDataEncryptionKeyId().hashCode());
        return hashCode;
    }
