...
class VpcPeeringConnectionExists {
    ...
    static class IsInvalidVpcPeeringConnectionIDNotFoundMatcher extends
            WaiterAcceptor<DescribeVpcPeeringConnectionsResult> {
        /**
        ...
        public boolean matches(AmazonServiceException e) {
            return "InvalidVpcPeeringConnectionID.NotFound".equals(e
                    .getErrorCode());
        }
