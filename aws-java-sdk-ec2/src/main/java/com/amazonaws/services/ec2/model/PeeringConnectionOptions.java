...
public class PeeringConnectionOptions implements Serializable, Cloneable {
    ...
    public PeeringConnectionOptions withAllowEgressFromLocalClassicLinkToRemoteVpc(
            Boolean allowEgressFromLocalClassicLinkToRemoteVpc) {
    ...
    public PeeringConnectionOptions withAllowEgressFromLocalVpcToRemoteClassicLink(
            Boolean allowEgressFromLocalVpcToRemoteClassicLink) {
     ...
     * </p>
     * 
     * @return If true, enables a local VPC to resolve public DNS hostnames to
     *         private IP addresses when queried from instances in the peer VPC.
     */
    ...
    public PeeringConnectionOptions withAllowDnsResolutionFromRemoteVpc(
            Boolean allowDnsResolutionFromRemoteVpc) {
