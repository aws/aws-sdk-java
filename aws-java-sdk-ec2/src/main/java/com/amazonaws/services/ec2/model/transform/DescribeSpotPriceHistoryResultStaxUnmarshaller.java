 ...
 */
public class DescribeSpotPriceHistoryResultStaxUnmarshaller implements
        Unmarshaller<DescribeSpotPriceHistoryResult, StaxUnmarshallerContext> {

    public DescribeSpotPriceHistoryResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("spotPriceHistorySet/item",
                        targetDepth)) {
                    describeSpotPriceHistoryResult.getSpotPriceHistory().add(
                            SpotPriceStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }
