 ...
 * 
 */
public class GetPasswordDataRequest extends AmazonWebServiceRequest implements
        Serializable, Cloneable, DryRunSupportedRequest<GetPasswordDataRequest> {
    ...
    /**
     * Default constructor for GetPasswordDataRequest object. Callers should use
    ...
    /**
     * Constructs a new GetPasswordDataRequest object. Callers should use the
    ...
    public Request<GetPasswordDataRequest> getDryRunRequest() {
        Request<GetPasswordDataRequest> request = new GetPasswordDataRequestMarshaller()
                .marshall(this);
