...
/**
 * DescribeInstanceTypesResult StAX Unmarshaller
 */
    ...
    public DescribeInstanceTypesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("instanceTypeSet", targetDepth)) {
                    describeInstanceTypesResult.withInstanceTypes(new ArrayList<InstanceTypeInfo>());
                    continue;
                }

                if (context.testExpression("instanceTypeSet/item", targetDepth)) {
                    describeInstanceTypesResult.withInstanceTypes(InstanceTypeInfoStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("nextToken", targetDepth)) {
                    describeInstanceTypesResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
