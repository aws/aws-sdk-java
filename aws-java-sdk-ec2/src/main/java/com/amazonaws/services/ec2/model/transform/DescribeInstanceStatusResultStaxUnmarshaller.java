 ...
 */
public class DescribeInstanceStatusResultStaxUnmarshaller implements
        Unmarshaller<DescribeInstanceStatusResult, StaxUnmarshallerContext> {

    public DescribeInstanceStatusResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("instanceStatusSet/item",
                        targetDepth)) {
                    describeInstanceStatusResult.getInstanceStatuses().add(
                            InstanceStatusStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
