 ...
 */
public class NetworkInterfaceAssociationStaxUnmarshaller implements
        Unmarshaller<NetworkInterfaceAssociation, StaxUnmarshallerContext> {

    public NetworkInterfaceAssociation unmarshall(
