 ...
 * </p>
 */
public class DescribeSpotFleetRequestsResult extends
    ...
    public void setSpotFleetRequestConfigs(
        ...
        this.spotFleetRequestConfigs = new com.amazonaws.internal.SdkInternalList<SpotFleetRequestConfig>(
     ...
     * {@link #withSpotFleetRequestConfigs(java.util.Collection)} if you want to
    ...
    public DescribeSpotFleetRequestsResult withSpotFleetRequestConfigs(
        ...
        if (this.spotFleetRequestConfigs == null) {
            setSpotFleetRequestConfigs(new com.amazonaws.internal.SdkInternalList<SpotFleetRequestConfig>(
    ...
    public String toString() {
        ...
        if (getSpotFleetRequestConfigs() != null)
            sb.append("SpotFleetRequestConfigs: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSpotFleetRequestConfigs() == null
                ^ this.getSpotFleetRequestConfigs() == null)
            return false;
        if (other.getSpotFleetRequestConfigs() != null
                && other.getSpotFleetRequestConfigs().equals(
                        this.getSpotFleetRequestConfigs()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getSpotFleetRequestConfigs() == null) ? 0
                        : getSpotFleetRequestConfigs().hashCode());
