 ...
 */
public class CancelSpotFleetRequestsSuccessItemStaxUnmarshaller
        implements
        Unmarshaller<CancelSpotFleetRequestsSuccessItem, StaxUnmarshallerContext> {

    public CancelSpotFleetRequestsSuccessItem unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("currentSpotFleetRequestState",
                        targetDepth)) {
                    cancelSpotFleetRequestsSuccessItem
                            .setCurrentSpotFleetRequestState(StringStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("previousSpotFleetRequestState",
                        targetDepth)) {
                    cancelSpotFleetRequestsSuccessItem
                            .setPreviousSpotFleetRequestState(StringStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
