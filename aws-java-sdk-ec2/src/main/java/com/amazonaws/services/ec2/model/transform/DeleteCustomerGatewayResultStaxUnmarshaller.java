 ...
 */
public class DeleteCustomerGatewayResultStaxUnmarshaller implements
        Unmarshaller<DeleteCustomerGatewayResult, StaxUnmarshallerContext> {

    public DeleteCustomerGatewayResult unmarshall(
