...
/**
 * Classic Link Instance StAX Unmarshaller
 */
public class ClassicLinkInstanceStaxUnmarshaller implements Unmarshaller<ClassicLinkInstance, StaxUnmarshallerContext> {
    ...
    public ClassicLinkInstance unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return classicLinkInstance;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("tagSet/item", targetDepth)) {
                    classicLinkInstance.getTags().add(TagStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ClassicLinkInstanceStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ClassicLinkInstanceStaxUnmarshaller();
        return instance;
    }
}
