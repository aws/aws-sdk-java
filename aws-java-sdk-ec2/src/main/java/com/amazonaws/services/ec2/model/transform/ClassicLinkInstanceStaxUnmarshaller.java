 ...
 */
public class ClassicLinkInstanceStaxUnmarshaller implements
        Unmarshaller<ClassicLinkInstance, StaxUnmarshallerContext> {

    public ClassicLinkInstance unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("instanceId", targetDepth)) {
                    classicLinkInstance.setInstanceId(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("vpcId", targetDepth)) {
                    classicLinkInstance.setVpcId(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("groupSet/item", targetDepth)) {
                    classicLinkInstance.getGroups().add(
                ...
                if (context.testExpression("tagSet/item", targetDepth)) {
                    classicLinkInstance.getTags().add(
