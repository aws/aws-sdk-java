...
class VolumeInUse {
    ...
    static class IsInuseMatcher extends WaiterAcceptor<DescribeVolumesResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"in-use\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }

        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("Volumes")), new JmesPathField("State"));
    ...
    static class IsDeletedMatcher extends WaiterAcceptor<DescribeVolumesResult> {
        private static final JsonNode expectedResult;
