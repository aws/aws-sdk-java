...
public class DeletePlacementGroupRequestMarshaller
        implements
        Marshaller<Request<DeletePlacementGroupRequest>, DeletePlacementGroupRequest> {

    public Request<DeletePlacementGroupRequest> marshall(
        ...
        if (deletePlacementGroupRequest.getGroupName() != null) {
            request.addParameter("GroupName", StringUtils
                    .fromString(deletePlacementGroupRequest.getGroupName()));
        }
