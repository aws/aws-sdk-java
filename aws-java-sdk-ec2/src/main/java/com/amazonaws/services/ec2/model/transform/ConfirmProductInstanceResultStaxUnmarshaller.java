 ...
 */
public class ConfirmProductInstanceResultStaxUnmarshaller implements
        Unmarshaller<ConfirmProductInstanceResult, StaxUnmarshallerContext> {

    public ConfirmProductInstanceResult unmarshall(
