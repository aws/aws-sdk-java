...
public class DescribeAvailabilityZonesRequest extends AmazonWebServiceRequest
     ...
     * <li>
     * <p>
     * <code>state</code> - The state of the Availability Zone (
    ...
    public void setZoneNames(java.util.Collection<String> zoneNames) {
        ...
        this.zoneNames = new com.amazonaws.internal.SdkInternalList<String>(
                zoneNames);
    }
     ...
     * any). Use {@link #setZoneNames(java.util.Collection)} or
     * {@link #withZoneNames(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param zoneNames
     ...
     *         Availability Zone (for example, <code>us-east-1</code>).
     *         </p>
     *         </li>
     *         <li>
     *         <p>
     *         <code>state</code> - The state of the Availability Zone (
     *         <code>available</code> | <code>information</code> |
