...
public class AuthorizeSecurityGroupEgressResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AuthorizeSecurityGroupEgressResult withReturn(Boolean returnValue) {
     ...
     * </p>
     * 
     * @return Information about the outbound (egress) security group rules that were added.
     */
    ...
    public AuthorizeSecurityGroupEgressResult withSecurityGroupRules(SecurityGroupRule... securityGroupRules) {
    ...
    public AuthorizeSecurityGroupEgressResult withSecurityGroupRules(java.util.Collection<SecurityGroupRule> securityGroupRules) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AuthorizeSecurityGroupEgressResult == false)
            return false;
