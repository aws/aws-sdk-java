 ...
 * </p>
 */
public class DescribeImportImageTasksResult extends
    ...
    public void setImportImageTasks(
        ...
        this.importImageTasks = new com.amazonaws.internal.SdkInternalList<ImportImageTask>(
                importImageTasks);
    }
     ...
     * any). Use {@link #setImportImageTasks(java.util.Collection)} or
     * {@link #withImportImageTasks(java.util.Collection)} if you want to
    ...
    public DescribeImportImageTasksResult withImportImageTasks(
        ...
        if (this.importImageTasks == null) {
            setImportImageTasks(new com.amazonaws.internal.SdkInternalList<ImportImageTask>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getImportImageTasks() == null
                ^ this.getImportImageTasks() == null)
            return false;
        if (other.getImportImageTasks() != null
                && other.getImportImageTasks().equals(
                        this.getImportImageTasks()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getImportImageTasks() == null) ? 0 : getImportImageTasks()
                        .hashCode());
