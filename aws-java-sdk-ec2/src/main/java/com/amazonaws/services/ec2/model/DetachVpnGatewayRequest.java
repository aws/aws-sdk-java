...
public class DetachVpnGatewayRequest extends AmazonWebServiceRequest implements
        ...
        DryRunSupportedRequest<DetachVpnGatewayRequest> {
    ...
    /**
     * Default constructor for DetachVpnGatewayRequest object. Callers should
    ...
    /**
     * Constructs a new DetachVpnGatewayRequest object. Callers should use the
    ...
    public Request<DetachVpnGatewayRequest> getDryRunRequest() {
        Request<DetachVpnGatewayRequest> request = new DetachVpnGatewayRequestMarshaller()
                .marshall(this);
