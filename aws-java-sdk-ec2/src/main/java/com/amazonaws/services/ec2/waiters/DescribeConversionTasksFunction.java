...
@SdkInternalApi
public class DescribeConversionTasksFunction
        implements
        SdkFunction<DescribeConversionTasksRequest, DescribeConversionTasksResult> {
     ...
     */
    @Override
    public DescribeConversionTasksResult apply(
