...
public class ReplaceRouteTableAssociationRequestMarshaller
    ...
    public Request<ReplaceRouteTableAssociationRequest> marshall(
        ...
        Request<ReplaceRouteTableAssociationRequest> request = new DefaultRequest<ReplaceRouteTableAssociationRequest>(
                replaceRouteTableAssociationRequest, "AmazonEC2");
        ...
        if (replaceRouteTableAssociationRequest.getAssociationId() != null) {
            request.addParameter("AssociationId", StringUtils
                    .fromString(replaceRouteTableAssociationRequest
                            .getAssociationId()));
        }
