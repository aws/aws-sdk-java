...
public class ModifyIdFormatRequestMarshaller implements
    ...
    public Request<ModifyIdFormatRequest> marshall(
        ...
        Request<ModifyIdFormatRequest> request = new DefaultRequest<ModifyIdFormatRequest>(
                modifyIdFormatRequest, "AmazonEC2");
        ...
        if (modifyIdFormatRequest.getResource() != null) {
            request.addParameter("Resource",
                    StringUtils.fromString(modifyIdFormatRequest.getResource()));
        }

        if (modifyIdFormatRequest.getUseLongIds() != null) {
            request.addParameter("UseLongIds", StringUtils
                    .fromBoolean(modifyIdFormatRequest.getUseLongIds()));
        }
