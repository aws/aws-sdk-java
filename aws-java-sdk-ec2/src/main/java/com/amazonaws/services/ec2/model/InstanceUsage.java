...
public class InstanceUsage implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the Amazon Web Services account that is making use of the Capacity Reservation.
     */
     ...
     * </p>
     * 
     * @return The number of instances the Amazon Web Services account currently has in the Capacity Reservation.
     */
