...
public class CreateTrafficMirrorFilterRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateTrafficMirrorFilterRuleResult withTrafficMirrorFilterRule(TrafficMirrorFilterRule trafficMirrorFilterRule) {
    ...
    public String toString() {
        ...
        if (getTrafficMirrorFilterRule() != null)
            sb.append("TrafficMirrorFilterRule: ").append(getTrafficMirrorFilterRule()).append(",");
    ...
    @Override
    public CreateTrafficMirrorFilterRuleResult clone() {
        try {
            return (CreateTrafficMirrorFilterRuleResult) super.clone();
