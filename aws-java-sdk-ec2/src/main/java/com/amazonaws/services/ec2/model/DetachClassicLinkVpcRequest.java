 ...
 * 
 */
public class DetachClassicLinkVpcRequest extends AmazonWebServiceRequest
    ...
    public Request<DetachClassicLinkVpcRequest> getDryRunRequest() {
        Request<DetachClassicLinkVpcRequest> request = new DetachClassicLinkVpcRequestMarshaller()
                .marshall(this);
