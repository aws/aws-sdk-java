 ...
 */
public class PeeringConnectionOptionsStaxUnmarshaller implements
        Unmarshaller<PeeringConnectionOptions, StaxUnmarshallerContext> {

    public PeeringConnectionOptions unmarshall(StaxUnmarshallerContext context)
            throws Exception {
