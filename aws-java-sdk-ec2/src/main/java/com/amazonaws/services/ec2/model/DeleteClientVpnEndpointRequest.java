...
import com.amazonaws.services.ec2.model.transform.DeleteClientVpnEndpointRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteClientVpnEndpointRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DeleteClientVpnEndpointRequest> {
     ...
     * </p>
     * 
     * @return The ID of the Client VPN to be deleted.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteClientVpnEndpointRequest == false)
            return false;
        DeleteClientVpnEndpointRequest other = (DeleteClientVpnEndpointRequest) obj;
    ...
    @Override
    public DeleteClientVpnEndpointRequest clone() {
        return (DeleteClientVpnEndpointRequest) super.clone();
    }
}
