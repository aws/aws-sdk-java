 ...
 */
public class DescribeVpcClassicLinkDnsSupportResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeVpcClassicLinkDnsSupportResult, StaxUnmarshallerContext> {

    public DescribeVpcClassicLinkDnsSupportResult unmarshall(
    ...
    public static DescribeVpcClassicLinkDnsSupportResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeVpcClassicLinkDnsSupportResultStaxUnmarshaller();
        return instance;
    }
}
