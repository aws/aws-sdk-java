 ...
 * 
 */
public class EnableVpcClassicLinkRequest extends AmazonWebServiceRequest
    ...
    public Request<EnableVpcClassicLinkRequest> getDryRunRequest() {
        Request<EnableVpcClassicLinkRequest> request = new EnableVpcClassicLinkRequestMarshaller()
                .marshall(this);
