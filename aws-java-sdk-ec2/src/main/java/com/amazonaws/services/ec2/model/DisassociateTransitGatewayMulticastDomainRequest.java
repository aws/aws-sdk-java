...
import com.amazonaws.services.ec2.model.transform.DisassociateTransitGatewayMulticastDomainRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DisassociateTransitGatewayMulticastDomainRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DisassociateTransitGatewayMulticastDomainRequest> {
    ...
    public DisassociateTransitGatewayMulticastDomainRequest withSubnetIds(java.util.Collection<String> subnetIds) {
     ...
     */
    @Override
    public Request<DisassociateTransitGatewayMulticastDomainRequest> getDryRunRequest() {
        Request<DisassociateTransitGatewayMulticastDomainRequest> request = new DisassociateTransitGatewayMulticastDomainRequestMarshaller().marshall(this);
    ...
    public DisassociateTransitGatewayMulticastDomainRequest clone() {
        return (DisassociateTransitGatewayMulticastDomainRequest) super.clone();
    }
}
