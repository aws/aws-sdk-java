...
/**
 * Enable Vpc Classic Link Dns Support Request Marshaller
 */
public class EnableVpcClassicLinkDnsSupportRequestMarshaller implements Marshaller<Request<EnableVpcClassicLinkDnsSupportRequest>, EnableVpcClassicLinkDnsSupportRequest> {
    ...
    public Request<EnableVpcClassicLinkDnsSupportRequest> marshall(EnableVpcClassicLinkDnsSupportRequest enableVpcClassicLinkDnsSupportRequest) {
        ...
        Request<EnableVpcClassicLinkDnsSupportRequest> request = new DefaultRequest<EnableVpcClassicLinkDnsSupportRequest>(enableVpcClassicLinkDnsSupportRequest, "AmazonEC2");
