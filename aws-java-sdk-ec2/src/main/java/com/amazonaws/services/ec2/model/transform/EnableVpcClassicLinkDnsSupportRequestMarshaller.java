...
public class EnableVpcClassicLinkDnsSupportRequestMarshaller
        implements
        Marshaller<Request<EnableVpcClassicLinkDnsSupportRequest>, EnableVpcClassicLinkDnsSupportRequest> {

    public Request<EnableVpcClassicLinkDnsSupportRequest> marshall(
        ...
        if (enableVpcClassicLinkDnsSupportRequest.getVpcId() != null) {
            request.addParameter("VpcId", StringUtils
                    .fromString(enableVpcClassicLinkDnsSupportRequest
                            .getVpcId()));
        }
