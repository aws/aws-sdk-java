...
public class ModifyInstanceAttributeResultStaxUnmarshaller implements Unmarshaller<ModifyInstanceAttributeResult, StaxUnmarshallerContext> {

    public ModifyInstanceAttributeResult unmarshall(StaxUnmarshallerContext context) throws Exception {
