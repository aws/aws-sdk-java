...
public class CreateTransitGatewayResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTransitGatewayResult == false)
            return false;
        CreateTransitGatewayResult other = (CreateTransitGatewayResult) obj;
    ...
    public CreateTransitGatewayResult clone() {
        try {
            return (CreateTransitGatewayResult) super.clone();
