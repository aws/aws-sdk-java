 ...
 */
public class AssociateDhcpOptionsResultStaxUnmarshaller implements
        Unmarshaller<AssociateDhcpOptionsResult, StaxUnmarshallerContext> {

    public AssociateDhcpOptionsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
