 ...
 */
public class CreateSpotDatafeedSubscriptionResultStaxUnmarshaller
        implements
        Unmarshaller<CreateSpotDatafeedSubscriptionResult, StaxUnmarshallerContext> {

    public CreateSpotDatafeedSubscriptionResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("spotDatafeedSubscription",
                        targetDepth)) {
                    createSpotDatafeedSubscriptionResult
                            .setSpotDatafeedSubscription(SpotDatafeedSubscriptionStaxUnmarshaller
