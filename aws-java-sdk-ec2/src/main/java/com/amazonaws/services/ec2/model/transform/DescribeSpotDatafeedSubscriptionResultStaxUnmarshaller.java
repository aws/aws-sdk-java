 ...
 */
public class DescribeSpotDatafeedSubscriptionResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeSpotDatafeedSubscriptionResult, StaxUnmarshallerContext> {

    public DescribeSpotDatafeedSubscriptionResult unmarshall(
