...
/**
 * PrefixListAssociation StAX Unmarshaller
 */
...
public class PrefixListAssociationStaxUnmarshaller implements Unmarshaller<PrefixListAssociation, StaxUnmarshallerContext> {
    ...
    public PrefixListAssociation unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("resourceId", targetDepth)) {
                    prefixListAssociation.setResourceId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("resourceOwner", targetDepth)) {
                    prefixListAssociation.setResourceOwner(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
