...
public class ModifyLocalGatewayRouteResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyLocalGatewayRouteResult == false)
            return false;
        ModifyLocalGatewayRouteResult other = (ModifyLocalGatewayRouteResult) obj;
    ...
    @Override
    public ModifyLocalGatewayRouteResult clone() {
        try {
            return (ModifyLocalGatewayRouteResult) super.clone();
