 ...
 */
public class NatGatewayAddressStaxUnmarshaller implements
        Unmarshaller<NatGatewayAddress, StaxUnmarshallerContext> {

    public NatGatewayAddress unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("publicIp", targetDepth)) {
                    natGatewayAddress.setPublicIp(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("allocationId", targetDepth)) {
                    natGatewayAddress.setAllocationId(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("privateIp", targetDepth)) {
                    natGatewayAddress.setPrivateIp(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
