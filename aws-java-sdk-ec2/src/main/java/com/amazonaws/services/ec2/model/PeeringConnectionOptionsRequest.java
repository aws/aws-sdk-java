...
public class PeeringConnectionOptionsRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return If true, enables outbound communication from an EC2-Classic
     *         instance that's linked to a local VPC via ClassicLink to
     ...
     * </p>
     * 
     * @return If true, enables outbound communication from instances in a local
     *         VPC to an EC2-Classic instance that's linked to a peer VPC via
     *         ClassicLink.
     */
