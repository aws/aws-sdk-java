 ...
 */
public class ImportSnapshotTaskStaxUnmarshaller implements
        Unmarshaller<ImportSnapshotTask, StaxUnmarshallerContext> {

    public ImportSnapshotTask unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("importTaskId", targetDepth)) {
                    importSnapshotTask.setImportTaskId(StringStaxUnmarshaller
                ...
                if (context.testExpression("description", targetDepth)) {
                    importSnapshotTask.setDescription(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
