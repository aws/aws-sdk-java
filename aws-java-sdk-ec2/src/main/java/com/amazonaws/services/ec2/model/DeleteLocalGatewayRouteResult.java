...
public class DeleteLocalGatewayRouteResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteLocalGatewayRouteResult == false)
            return false;
        DeleteLocalGatewayRouteResult other = (DeleteLocalGatewayRouteResult) obj;
    ...
    @Override
    public DeleteLocalGatewayRouteResult clone() {
        try {
            return (DeleteLocalGatewayRouteResult) super.clone();
