...
public class ScheduledInstanceRecurrence implements Serializable, Cloneable {
    ...
    public void setOccurrenceDaySet(
        ...
        this.occurrenceDaySet = new com.amazonaws.internal.SdkInternalList<Integer>(
                occurrenceDaySet);
    }
     ...
     * any). Use {@link #setOccurrenceDaySet(java.util.Collection)} or
     * {@link #withOccurrenceDaySet(java.util.Collection)} if you want to
    ...
    public ScheduledInstanceRecurrence withOccurrenceDaySet(
        ...
        if (this.occurrenceDaySet == null) {
            setOccurrenceDaySet(new com.amazonaws.internal.SdkInternalList<Integer>(
                    occurrenceDaySet.length));
        }
    ...
    public String toString() {
        ...
        if (getOccurrenceRelativeToEnd() != null)
            sb.append("OccurrenceRelativeToEnd: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getOccurrenceDaySet() == null
                ^ this.getOccurrenceDaySet() == null)
            return false;
        if (other.getOccurrenceDaySet() != null
                && other.getOccurrenceDaySet().equals(
                        this.getOccurrenceDaySet()) == false)
            return false;
        if (other.getOccurrenceRelativeToEnd() == null
                ^ this.getOccurrenceRelativeToEnd() == null)
            return false;
        if (other.getOccurrenceRelativeToEnd() != null
                && other.getOccurrenceRelativeToEnd().equals(
                        this.getOccurrenceRelativeToEnd()) == false)
            return false;
        if (other.getOccurrenceUnit() == null
                ^ this.getOccurrenceUnit() == null)
            return false;
        if (other.getOccurrenceUnit() != null
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getOccurrenceDaySet() == null) ? 0 : getOccurrenceDaySet()
                        .hashCode());
        hashCode = prime
                * hashCode
                + ((getOccurrenceRelativeToEnd() == null) ? 0
                        : getOccurrenceRelativeToEnd().hashCode());
        hashCode = prime
                * hashCode
                + ((getOccurrenceUnit() == null) ? 0 : getOccurrenceUnit()
                        .hashCode());
        return hashCode;
    }
