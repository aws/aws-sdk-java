...
public class ModifySubnetAttributeRequestMarshaller
        implements
        Marshaller<Request<ModifySubnetAttributeRequest>, ModifySubnetAttributeRequest> {
    ...
    public Request<ModifySubnetAttributeRequest> marshall(
        ...
        Request<ModifySubnetAttributeRequest> request = new DefaultRequest<ModifySubnetAttributeRequest>(
                modifySubnetAttributeRequest, "AmazonEC2");
        ...
        if (modifySubnetAttributeRequest.getSubnetId() != null) {
            request.addParameter("SubnetId", StringUtils
                    .fromString(modifySubnetAttributeRequest.getSubnetId()));
        }

        if (modifySubnetAttributeRequest.getMapPublicIpOnLaunch() != null) {
            request.addParameter("MapPublicIpOnLaunch.Value", StringUtils
                    .fromBoolean(modifySubnetAttributeRequest
