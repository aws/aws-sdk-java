 ...
 */
public class DescribeReservedInstancesResultStaxUnmarshaller implements
        Unmarshaller<DescribeReservedInstancesResult, StaxUnmarshallerContext> {

    public DescribeReservedInstancesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("reservedInstancesSet/item",
                        targetDepth)) {
                    describeReservedInstancesResult.getReservedInstances().add(
                            ReservedInstancesStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
