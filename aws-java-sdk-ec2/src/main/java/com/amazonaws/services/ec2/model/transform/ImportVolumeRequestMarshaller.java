...
public class ImportVolumeRequestMarshaller implements
    ...
    public Request<ImportVolumeRequest> marshall(
        ...
        if (importVolumeRequest.getAvailabilityZone() != null) {
            request.addParameter("AvailabilityZone", StringUtils
                    .fromString(importVolumeRequest.getAvailabilityZone()));
        }
        ...
        if (importVolumeRequest.getDescription() != null) {
            request.addParameter("Description", StringUtils
                    .fromString(importVolumeRequest.getDescription()));
        }
        ...
        if (volume != null) {
            ...
            if (volume.getSize() != null) {
                request.addParameter("Volume.Size",
