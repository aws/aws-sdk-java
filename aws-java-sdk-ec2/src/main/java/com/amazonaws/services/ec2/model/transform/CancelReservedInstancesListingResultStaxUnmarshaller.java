 ...
 */
public class CancelReservedInstancesListingResultStaxUnmarshaller
        implements
        Unmarshaller<CancelReservedInstancesListingResult, StaxUnmarshallerContext> {

    public CancelReservedInstancesListingResult unmarshall(
