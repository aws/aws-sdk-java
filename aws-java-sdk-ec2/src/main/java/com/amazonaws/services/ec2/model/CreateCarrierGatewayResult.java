...
public class CreateCarrierGatewayResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCarrierGatewayResult == false)
            return false;
        CreateCarrierGatewayResult other = (CreateCarrierGatewayResult) obj;
    ...
    public CreateCarrierGatewayResult clone() {
        try {
            return (CreateCarrierGatewayResult) super.clone();
