...
public class CreateNetworkAclRequest extends AmazonWebServiceRequest implements Serializable, Cloneable, DryRunSupportedRequest<CreateNetworkAclRequest> {
    ...
    public CreateNetworkAclRequest withTagSpecifications(TagSpecification... tagSpecifications) {
    ...
    public CreateNetworkAclRequest withTagSpecifications(java.util.Collection<TagSpecification> tagSpecifications) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateNetworkAclRequest == false)
            return false;
