 ...
 */
public class VpcPeeringConnectionStateReasonStaxUnmarshaller implements
        Unmarshaller<VpcPeeringConnectionStateReason, StaxUnmarshallerContext> {

    public VpcPeeringConnectionStateReason unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("code", targetDepth)) {
                    vpcPeeringConnectionStateReason
                            .setCode(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
    ...
    public static VpcPeeringConnectionStateReasonStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new VpcPeeringConnectionStateReasonStaxUnmarshaller();
        return instance;
    }
}
