...
import com.amazonaws.services.ec2.model.transform.DescribeManagedPrefixListsRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeManagedPrefixListsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DescribeManagedPrefixListsRequest> {
    ...
    public DescribeManagedPrefixListsRequest withFilters(Filter... filters) {
    ...
    public DescribeManagedPrefixListsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeManagedPrefixListsRequest withMaxResults(Integer maxResults) {
    ...
    public DescribeManagedPrefixListsRequest withPrefixListIds(java.util.Collection<String> prefixListIds) {
     ...
     */
    @Override
    public Request<DescribeManagedPrefixListsRequest> getDryRunRequest() {
        Request<DescribeManagedPrefixListsRequest> request = new DescribeManagedPrefixListsRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeManagedPrefixListsRequest == false)
            return false;
        DescribeManagedPrefixListsRequest other = (DescribeManagedPrefixListsRequest) obj;
    ...
    @Override
    public DescribeManagedPrefixListsRequest clone() {
        return (DescribeManagedPrefixListsRequest) super.clone();
    }
}
