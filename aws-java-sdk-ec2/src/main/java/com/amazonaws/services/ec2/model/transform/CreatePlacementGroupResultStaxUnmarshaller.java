...
public class CreatePlacementGroupResultStaxUnmarshaller implements Unmarshaller<CreatePlacementGroupResult, StaxUnmarshallerContext> {

    public CreatePlacementGroupResult unmarshall(StaxUnmarshallerContext context) throws Exception {
    ...
    public static CreatePlacementGroupResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreatePlacementGroupResultStaxUnmarshaller();
        return instance;
    }
}
