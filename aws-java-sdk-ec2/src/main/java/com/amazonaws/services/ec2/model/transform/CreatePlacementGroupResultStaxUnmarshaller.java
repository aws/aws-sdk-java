 ...
 */
public class CreatePlacementGroupResultStaxUnmarshaller implements
        Unmarshaller<CreatePlacementGroupResult, StaxUnmarshallerContext> {

    public CreatePlacementGroupResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
