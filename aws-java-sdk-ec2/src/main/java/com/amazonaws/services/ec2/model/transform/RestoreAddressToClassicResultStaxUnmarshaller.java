 ...
 */
public class RestoreAddressToClassicResultStaxUnmarshaller implements
        Unmarshaller<RestoreAddressToClassicResult, StaxUnmarshallerContext> {

    public RestoreAddressToClassicResult unmarshall(
