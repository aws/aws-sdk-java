...
class KeyPairExists {
    ...
    static class IsTrueMatcher extends WaiterAcceptor<DescribeKeyPairsResult> {
        ...
        private static final JmesPathExpression ast = new OpGreaterThan(
                new JmesPathLengthFunction(new JmesPathProjection(
                        new JmesPathFlatten(new JmesPathField("KeyPairs")),
                        new JmesPathField("KeyName"))),
    ...
    static class IsInvalidKeyPairNotFoundMatcher extends
            WaiterAcceptor<DescribeKeyPairsResult> {
        /**
