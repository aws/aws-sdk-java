 ...
 */
public class PortRangeStaxUnmarshaller implements
        Unmarshaller<PortRange, StaxUnmarshallerContext> {

    public PortRange unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("from", targetDepth)) {
                    portRange.setFrom(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }

                if (context.testExpression("to", targetDepth)) {
                    portRange.setTo(IntegerStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
