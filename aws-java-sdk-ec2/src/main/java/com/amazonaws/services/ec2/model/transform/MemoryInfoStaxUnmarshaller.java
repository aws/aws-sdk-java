...
/**
 * MemoryInfo StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MemoryInfoStaxUnmarshaller implements Unmarshaller<MemoryInfo, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("sizeInMiB", targetDepth)) {
                    memoryInfo.setSizeInMiB(LongStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
