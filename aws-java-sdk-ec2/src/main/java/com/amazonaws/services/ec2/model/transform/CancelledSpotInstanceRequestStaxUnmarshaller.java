 ...
 */
public class CancelledSpotInstanceRequestStaxUnmarshaller implements
        Unmarshaller<CancelledSpotInstanceRequest, StaxUnmarshallerContext> {

    public CancelledSpotInstanceRequest unmarshall(
