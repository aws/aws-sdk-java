...
public class DeleteManagedPrefixListResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteManagedPrefixListResult == false)
            return false;
        DeleteManagedPrefixListResult other = (DeleteManagedPrefixListResult) obj;
    ...
    public DeleteManagedPrefixListResult clone() {
        try {
            return (DeleteManagedPrefixListResult) super.clone();
