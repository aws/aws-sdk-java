        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("platformDetails", targetDepth)) {
                    instance.setPlatformDetails(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("usageOperation", targetDepth)) {
                    instance.setUsageOperation(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("usageOperationUpdateTime", targetDepth)) {
                    instance.setUsageOperationUpdateTime(DateStaxUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                    continue;
                }

                if (context.testExpression("privateDnsNameOptions", targetDepth)) {
                    instance.setPrivateDnsNameOptions(PrivateDnsNameOptionsResponseStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ipv6Address", targetDepth)) {
                    instance.setIpv6Address(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("currentInstanceBootMode", targetDepth)) {
                    instance.setCurrentInstanceBootMode(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
