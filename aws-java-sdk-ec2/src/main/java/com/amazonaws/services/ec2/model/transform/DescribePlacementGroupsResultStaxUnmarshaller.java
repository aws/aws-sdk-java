 ...
 */
public class DescribePlacementGroupsResultStaxUnmarshaller implements
        Unmarshaller<DescribePlacementGroupsResult, StaxUnmarshallerContext> {

    public DescribePlacementGroupsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("placementGroupSet/item",
                        targetDepth)) {
                    describePlacementGroupsResult.getPlacementGroups().add(
                            PlacementGroupStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
