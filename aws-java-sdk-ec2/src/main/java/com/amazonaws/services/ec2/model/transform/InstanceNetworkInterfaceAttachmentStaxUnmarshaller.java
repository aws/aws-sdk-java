 ...
 */
public class InstanceNetworkInterfaceAttachmentStaxUnmarshaller
        implements
        Unmarshaller<InstanceNetworkInterfaceAttachment, StaxUnmarshallerContext> {

    public InstanceNetworkInterfaceAttachment unmarshall(
