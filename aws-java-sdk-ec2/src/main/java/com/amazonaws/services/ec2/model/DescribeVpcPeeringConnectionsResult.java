 ...
 * </p>
 */
public class DescribeVpcPeeringConnectionsResult extends
    ...
    public void setVpcPeeringConnections(
        ...
        this.vpcPeeringConnections = new com.amazonaws.internal.SdkInternalList<VpcPeeringConnection>(
     ...
     * {@link #withVpcPeeringConnections(java.util.Collection)} if you want to
    ...
    public DescribeVpcPeeringConnectionsResult withVpcPeeringConnections(
        ...
        if (this.vpcPeeringConnections == null) {
            setVpcPeeringConnections(new com.amazonaws.internal.SdkInternalList<VpcPeeringConnection>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getVpcPeeringConnections() == null
                ^ this.getVpcPeeringConnections() == null)
            return false;
        if (other.getVpcPeeringConnections() != null
                && other.getVpcPeeringConnections().equals(
                        this.getVpcPeeringConnections()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getVpcPeeringConnections() == null) ? 0
                        : getVpcPeeringConnections().hashCode());
        return hashCode;
    }
