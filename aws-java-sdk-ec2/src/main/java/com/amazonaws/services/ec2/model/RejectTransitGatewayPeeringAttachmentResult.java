...
public class RejectTransitGatewayPeeringAttachmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public RejectTransitGatewayPeeringAttachmentResult withTransitGatewayPeeringAttachment(TransitGatewayPeeringAttachment transitGatewayPeeringAttachment) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectTransitGatewayPeeringAttachmentResult == false)
            return false;
        RejectTransitGatewayPeeringAttachmentResult other = (RejectTransitGatewayPeeringAttachmentResult) obj;
    ...
    @Override
    public RejectTransitGatewayPeeringAttachmentResult clone() {
        try {
            return (RejectTransitGatewayPeeringAttachmentResult) super.clone();
