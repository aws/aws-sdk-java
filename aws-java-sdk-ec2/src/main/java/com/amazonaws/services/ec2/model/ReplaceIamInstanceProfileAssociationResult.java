...
public class ReplaceIamInstanceProfileAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public ReplaceIamInstanceProfileAssociationResult withIamInstanceProfileAssociation(IamInstanceProfileAssociation iamInstanceProfileAssociation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReplaceIamInstanceProfileAssociationResult == false)
            return false;
        ReplaceIamInstanceProfileAssociationResult other = (ReplaceIamInstanceProfileAssociationResult) obj;
    ...
    @Override
    public ReplaceIamInstanceProfileAssociationResult clone() {
        try {
            return (ReplaceIamInstanceProfileAssociationResult) super.clone();
