...
public class CreateLocalGatewayRouteTableResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLocalGatewayRouteTableResult == false)
            return false;
        CreateLocalGatewayRouteTableResult other = (CreateLocalGatewayRouteTableResult) obj;
    ...
    @Override
    public CreateLocalGatewayRouteTableResult clone() {
        try {
            return (CreateLocalGatewayRouteTableResult) super.clone();
