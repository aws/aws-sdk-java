...
public class AcceptTransitGatewayPeeringAttachmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AcceptTransitGatewayPeeringAttachmentResult == false)
            return false;
        AcceptTransitGatewayPeeringAttachmentResult other = (AcceptTransitGatewayPeeringAttachmentResult) obj;
    ...
    @Override
    public AcceptTransitGatewayPeeringAttachmentResult clone() {
        try {
            return (AcceptTransitGatewayPeeringAttachmentResult) super.clone();
