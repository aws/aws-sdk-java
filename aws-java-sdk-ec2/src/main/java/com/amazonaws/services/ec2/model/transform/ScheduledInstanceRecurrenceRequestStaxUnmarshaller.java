 ...
 */
public class ScheduledInstanceRecurrenceRequestStaxUnmarshaller
        implements
        Unmarshaller<ScheduledInstanceRecurrenceRequest, StaxUnmarshallerContext> {

    public ScheduledInstanceRecurrenceRequest unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Frequency", targetDepth)) {
                    scheduledInstanceRecurrenceRequest
                            .setFrequency(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Interval", targetDepth)) {
                    scheduledInstanceRecurrenceRequest
                            .setInterval(IntegerStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }

                if (context.testExpression("OccurrenceDay/OccurenceDay",
                        targetDepth)) {
                    scheduledInstanceRecurrenceRequest.getOccurrenceDays().add(
                            IntegerStaxUnmarshaller.getInstance().unmarshall(
                                    context));
                    continue;
                }

                if (context.testExpression("OccurrenceRelativeToEnd",
                        targetDepth)) {
                    scheduledInstanceRecurrenceRequest
                            .setOccurrenceRelativeToEnd(BooleanStaxUnmarshaller
                ...
                if (context.testExpression("OccurrenceUnit", targetDepth)) {
                    scheduledInstanceRecurrenceRequest
                            .setOccurrenceUnit(StringStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
