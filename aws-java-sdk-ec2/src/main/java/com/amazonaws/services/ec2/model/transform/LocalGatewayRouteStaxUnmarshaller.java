...
/**
 * LocalGatewayRoute StAX Unmarshaller
 */
...
public class LocalGatewayRouteStaxUnmarshaller implements Unmarshaller<LocalGatewayRoute, StaxUnmarshallerContext> {
    ...
    public LocalGatewayRoute unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("destinationCidrBlock", targetDepth)) {
                    localGatewayRoute.setDestinationCidrBlock(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("localGatewayVirtualInterfaceGroupId", targetDepth)) {
                    localGatewayRoute.setLocalGatewayVirtualInterfaceGroupId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("type", targetDepth)) {
                    localGatewayRoute.setType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("state", targetDepth)) {
                    localGatewayRoute.setState(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("localGatewayRouteTableId", targetDepth)) {
                    localGatewayRoute.setLocalGatewayRouteTableId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("localGatewayRouteTableArn", targetDepth)) {
                    localGatewayRoute.setLocalGatewayRouteTableArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
