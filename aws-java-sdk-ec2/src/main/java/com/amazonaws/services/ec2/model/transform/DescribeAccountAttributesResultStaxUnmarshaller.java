 ...
 */
public class DescribeAccountAttributesResultStaxUnmarshaller implements
        Unmarshaller<DescribeAccountAttributesResult, StaxUnmarshallerContext> {

    public DescribeAccountAttributesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("accountAttributeSet/item",
                        targetDepth)) {
                    describeAccountAttributesResult.getAccountAttributes().add(
                            AccountAttributeStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
