 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/LaunchTemplateInstanceMarketOptionsRequest"
...
public class LaunchTemplateInstanceMarketOptionsRequest implements Serializable, Cloneable {
    ...
    public LaunchTemplateInstanceMarketOptionsRequest withMarketType(String marketType) {
    ...
    public void setSpotOptions(LaunchTemplateSpotMarketOptionsRequest spotOptions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LaunchTemplateInstanceMarketOptionsRequest == false)
            return false;
    ...
    @Override
    public LaunchTemplateInstanceMarketOptionsRequest clone() {
        try {
