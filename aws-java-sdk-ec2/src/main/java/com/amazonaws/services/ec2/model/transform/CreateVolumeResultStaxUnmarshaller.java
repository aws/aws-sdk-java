 ...
 */
public class CreateVolumeResultStaxUnmarshaller implements
        Unmarshaller<CreateVolumeResult, StaxUnmarshallerContext> {

    public CreateVolumeResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                createVolumeResult.setVolume(VolumeStaxUnmarshaller
