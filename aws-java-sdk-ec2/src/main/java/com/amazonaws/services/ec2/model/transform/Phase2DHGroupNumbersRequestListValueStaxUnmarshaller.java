...
/**
 * Phase2DHGroupNumbersRequestListValue StAX Unmarshaller
 */
...
public class Phase2DHGroupNumbersRequestListValueStaxUnmarshaller implements Unmarshaller<Phase2DHGroupNumbersRequestListValue, StaxUnmarshallerContext> {
    ...
    public Phase2DHGroupNumbersRequestListValue unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Value", targetDepth)) {
                    phase2DHGroupNumbersRequestListValue.setValue(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
