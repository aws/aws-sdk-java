...
public class AdvertiseByoipCidrResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdvertiseByoipCidrResult == false)
            return false;
        AdvertiseByoipCidrResult other = (AdvertiseByoipCidrResult) obj;
    ...
    @Override
    public AdvertiseByoipCidrResult clone() {
        try {
            return (AdvertiseByoipCidrResult) super.clone();
