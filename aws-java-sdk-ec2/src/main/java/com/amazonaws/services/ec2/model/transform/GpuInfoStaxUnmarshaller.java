...
/**
 * GpuInfo StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GpuInfoStaxUnmarshaller implements Unmarshaller<GpuInfo, StaxUnmarshallerContext> {
    ...
    public GpuInfo unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("totalGpuMemoryInMiB", targetDepth)) {
                    gpuInfo.setTotalGpuMemoryInMiB(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
