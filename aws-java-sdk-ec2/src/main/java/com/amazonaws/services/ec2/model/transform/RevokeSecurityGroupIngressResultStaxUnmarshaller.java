 ...
 */
public class RevokeSecurityGroupIngressResultStaxUnmarshaller implements
        Unmarshaller<RevokeSecurityGroupIngressResult, StaxUnmarshallerContext> {

    public RevokeSecurityGroupIngressResult unmarshall(
