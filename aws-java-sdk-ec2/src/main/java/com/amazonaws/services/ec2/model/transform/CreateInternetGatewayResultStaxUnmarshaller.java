 ...
 */
public class CreateInternetGatewayResultStaxUnmarshaller implements
        Unmarshaller<CreateInternetGatewayResult, StaxUnmarshallerContext> {

    public CreateInternetGatewayResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("internetGateway", targetDepth)) {
                    createInternetGatewayResult
                            .setInternetGateway(InternetGatewayStaxUnmarshaller
    ...
    public static CreateInternetGatewayResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateInternetGatewayResultStaxUnmarshaller();
        return instance;
    }
}
