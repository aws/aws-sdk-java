...
public class IpPermission implements Serializable, Cloneable {
     ...
     * value of <code>-1</code> indicates all ICMP codes for the specified ICMP
     * type.
     * </p>
     */
     ...
     * <a>RevokeSecurityGroupEgress</a> and <a>DescribeSecurityGroups</a> only)
     * One or more prefix list IDs for an AWS service. In an
     * <a>AuthorizeSecurityGroupEgress</a> request, this is the AWS service that
     ...
     *         <a>RevokeSecurityGroupEgress</a> and
     *         <a>DescribeSecurityGroups</a> only) One or more prefix list IDs
     *         for an AWS service. In an <a>AuthorizeSecurityGroupEgress</a>
     ...
     *        <a>AuthorizeSecurityGroupEgress</a> request, this is the AWS
    ...
    public void setPrefixListIds(
        ...
        this.prefixListIds = new com.amazonaws.internal.SdkInternalList<PrefixListId>(
                prefixListIds);
    }
