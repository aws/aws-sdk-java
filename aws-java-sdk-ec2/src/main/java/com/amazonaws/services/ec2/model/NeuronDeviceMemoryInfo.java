 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/NeuronDeviceMemoryInfo" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NeuronDeviceMemoryInfo implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The size of the memory available to the neuron accelerator, in MiB.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NeuronDeviceMemoryInfo == false)
            return false;
        NeuronDeviceMemoryInfo other = (NeuronDeviceMemoryInfo) obj;
    ...
    public NeuronDeviceMemoryInfo clone() {
        try {
            return (NeuronDeviceMemoryInfo) super.clone();
