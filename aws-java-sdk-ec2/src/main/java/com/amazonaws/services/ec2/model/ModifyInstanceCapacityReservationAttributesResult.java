...
public class ModifyInstanceCapacityReservationAttributesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    @Override
    public ModifyInstanceCapacityReservationAttributesResult clone() {
        try {
            return (ModifyInstanceCapacityReservationAttributesResult) super.clone();
