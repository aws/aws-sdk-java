...
@SdkInternalApi
public class DescribeBundleTasksFunction implements
        SdkFunction<DescribeBundleTasksRequest, DescribeBundleTasksResult> {
     ...
     */
    @Override
    public DescribeBundleTasksResult apply(
