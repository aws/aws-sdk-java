 ...
 */
public class ImportVolumeResultStaxUnmarshaller implements
        Unmarshaller<ImportVolumeResult, StaxUnmarshallerContext> {

    public ImportVolumeResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
