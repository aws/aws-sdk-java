...
/**
 * InstanceStorageInfo StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceStorageInfoStaxUnmarshaller implements Unmarshaller<InstanceStorageInfo, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("totalSizeInGB", targetDepth)) {
                    instanceStorageInfo.setTotalSizeInGB(LongStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
