    ...
    public Request<AssignPrivateIpAddressesRequest> marshall(
        ...
        if (assignPrivateIpAddressesRequest.getNetworkInterfaceId() != null) {
            request.addParameter("NetworkInterfaceId", StringUtils
                    .fromString(assignPrivateIpAddressesRequest
                            .getNetworkInterfaceId()));
        }

        com.amazonaws.internal.SdkInternalList<String> privateIpAddressesList = (com.amazonaws.internal.SdkInternalList<String>) assignPrivateIpAddressesRequest
        ...
        if (assignPrivateIpAddressesRequest.getSecondaryPrivateIpAddressCount() != null) {
            request.addParameter("SecondaryPrivateIpAddressCount", StringUtils
                    .fromInteger(assignPrivateIpAddressesRequest
                            .getSecondaryPrivateIpAddressCount()));
        }

        if (assignPrivateIpAddressesRequest.getAllowReassignment() != null) {
            request.addParameter("AllowReassignment", StringUtils
                    .fromBoolean(assignPrivateIpAddressesRequest
