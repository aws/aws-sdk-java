...
class CustomerGatewayAvailable {
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeCustomerGatewaysResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("CustomerGateways")), new JmesPathField(
                "State"));
         ...
         */
        @Override
        public boolean matches(DescribeCustomerGatewaysResult result) {
    ...
    static class IsDeletedMatcher extends WaiterAcceptor<DescribeCustomerGatewaysResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeCustomerGatewaysResult> {
        private static final JsonNode expectedResult;
