...
class CustomerGatewayAvailable {
    ...
    static class IsAvailableMatcher extends
            WaiterAcceptor<DescribeCustomerGatewaysResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(
                new JmesPathFlatten(new JmesPathField("CustomerGateways")),
                new JmesPathField("State"));
    ...
    static class IsDeletingMatcher extends
            WaiterAcceptor<DescribeCustomerGatewaysResult> {
        private static final JsonNode expectedResult;
