...
public class DeleteVpcRequest extends AmazonWebServiceRequest implements Serializable, Cloneable, DryRunSupportedRequest<DeleteVpcRequest> {
    ...
    /**
     * Default constructor for DeleteVpcRequest object. Callers should use the setter or fluent setter (with...) methods
    ...
    /**
     * Constructs a new DeleteVpcRequest object. Callers should use the setter or fluent setter (with...) methods to
