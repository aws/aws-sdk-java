...
/**
 * Modify Hosts Result StAX Unmarshaller
 */
public class ModifyHostsResultStaxUnmarshaller implements Unmarshaller<ModifyHostsResult, StaxUnmarshallerContext> {
    ...
    public ModifyHostsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return modifyHostsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("successful/item", targetDepth)) {
                    modifyHostsResult.getSuccessful().add(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("unsuccessful/item", targetDepth)) {
                    modifyHostsResult.getUnsuccessful().add(UnsuccessfulItemStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ModifyHostsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ModifyHostsResultStaxUnmarshaller();
        return instance;
    }
}
