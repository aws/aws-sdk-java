 ...
 */
public class ModifyHostsResultStaxUnmarshaller implements
        Unmarshaller<ModifyHostsResult, StaxUnmarshallerContext> {

    public ModifyHostsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("successful/item", targetDepth)) {
                    modifyHostsResult.getSuccessful().add(
                ...
                if (context.testExpression("unsuccessful/item", targetDepth)) {
                    modifyHostsResult.getUnsuccessful().add(
