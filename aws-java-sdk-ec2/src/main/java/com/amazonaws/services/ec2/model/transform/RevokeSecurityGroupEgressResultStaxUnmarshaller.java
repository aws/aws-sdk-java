 ...
 */
public class RevokeSecurityGroupEgressResultStaxUnmarshaller implements
        Unmarshaller<RevokeSecurityGroupEgressResult, StaxUnmarshallerContext> {

    public RevokeSecurityGroupEgressResult unmarshall(
