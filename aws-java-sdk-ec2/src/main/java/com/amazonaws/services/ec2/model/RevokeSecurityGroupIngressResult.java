...
public class RevokeSecurityGroupIngressResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The inbound rules that were unknown to the service. In some cases, <code>unknownIpPermissionSet</code> might be
    ...
    public RevokeSecurityGroupIngressResult withReturn(Boolean returnValue) {
     ...
     * </p>
     * 
     * @return The inbound rules that were unknown to the service. In some cases, <code>unknownIpPermissionSet</code>
    ...
    public RevokeSecurityGroupIngressResult withUnknownIpPermissions(IpPermission... unknownIpPermissions) {
    ...
    public RevokeSecurityGroupIngressResult withUnknownIpPermissions(java.util.Collection<IpPermission> unknownIpPermissions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RevokeSecurityGroupIngressResult == false)
            return false;
