 ...
 */
public class AttachNetworkInterfaceResultStaxUnmarshaller implements Unmarshaller<AttachNetworkInterfaceResult, StaxUnmarshallerContext> {

    public AttachNetworkInterfaceResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return attachNetworkInterfaceResult;
    ...
    public static AttachNetworkInterfaceResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new AttachNetworkInterfaceResultStaxUnmarshaller();
        return instance;
    }
}
