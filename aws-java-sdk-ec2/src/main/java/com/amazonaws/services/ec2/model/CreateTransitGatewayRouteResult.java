...
public class CreateTransitGatewayRouteResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public TransitGatewayRoute getRoute() {
        return this.route;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTransitGatewayRouteResult == false)
            return false;
        CreateTransitGatewayRouteResult other = (CreateTransitGatewayRouteResult) obj;
    ...
    public CreateTransitGatewayRouteResult clone() {
        try {
            return (CreateTransitGatewayRouteResult) super.clone();
