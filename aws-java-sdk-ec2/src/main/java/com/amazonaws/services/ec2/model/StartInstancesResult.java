 ...
 * </p>
 */
public class StartInstancesResult extends
    ...
    public void setStartingInstances(
        ...
        this.startingInstances = new com.amazonaws.internal.SdkInternalList<InstanceStateChange>(
                startingInstances);
    }
     ...
     * any). Use {@link #setStartingInstances(java.util.Collection)} or
     * {@link #withStartingInstances(java.util.Collection)} if you want to
    ...
    public StartInstancesResult withStartingInstances(
        ...
        if (this.startingInstances == null) {
            setStartingInstances(new com.amazonaws.internal.SdkInternalList<InstanceStateChange>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getStartingInstances() == null
                ^ this.getStartingInstances() == null)
            return false;
        if (other.getStartingInstances() != null
                && other.getStartingInstances().equals(
                        this.getStartingInstances()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getStartingInstances() == null) ? 0
                        : getStartingInstances().hashCode());
        return hashCode;
    }
