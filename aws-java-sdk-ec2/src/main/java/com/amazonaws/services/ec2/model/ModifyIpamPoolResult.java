...
public class ModifyIpamPoolResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ModifyIpamPoolResult withIpamPool(IpamPool ipamPool) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyIpamPoolResult == false)
            return false;
        ModifyIpamPoolResult other = (ModifyIpamPoolResult) obj;
    ...
    @Override
    public ModifyIpamPoolResult clone() {
        try {
            return (ModifyIpamPoolResult) super.clone();
