...
public class CertificateAuthentication implements Serializable, Cloneable {
    ...
    public String getClientRootCertificateChain() {
        return this.clientRootCertificateChain;
    }
    ...
    public CertificateAuthentication withClientRootCertificateChain(String clientRootCertificateChain) {
        setClientRootCertificateChain(clientRootCertificateChain);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getClientRootCertificateChain() != null)
            sb.append("ClientRootCertificateChain: ").append(getClientRootCertificateChain());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getClientRootCertificateChain() == null ^ this.getClientRootCertificateChain() == null)
            return false;
        if (other.getClientRootCertificateChain() != null && other.getClientRootCertificateChain().equals(this.getClientRootCertificateChain()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getClientRootCertificateChain() == null) ? 0 : getClientRootCertificateChain().hashCode());
        return hashCode;
    }
    ...
    public CertificateAuthentication clone() {
        try {
            return (CertificateAuthentication) super.clone();
