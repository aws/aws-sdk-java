 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/GpuDeviceMemoryInfo" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GpuDeviceMemoryInfo implements Serializable, Cloneable {
    ...
    public GpuDeviceMemoryInfo withSizeInMiB(Integer sizeInMiB) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GpuDeviceMemoryInfo == false)
            return false;
    ...
    @Override
    public GpuDeviceMemoryInfo clone() {
        try {
            return (GpuDeviceMemoryInfo) super.clone();
