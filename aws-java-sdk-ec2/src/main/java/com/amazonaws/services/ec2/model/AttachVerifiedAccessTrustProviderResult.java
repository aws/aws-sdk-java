...
public class AttachVerifiedAccessTrustProviderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public AttachVerifiedAccessTrustProviderResult withVerifiedAccessTrustProvider(VerifiedAccessTrustProvider verifiedAccessTrustProvider) {
    ...
    public AttachVerifiedAccessTrustProviderResult withVerifiedAccessInstance(VerifiedAccessInstance verifiedAccessInstance) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttachVerifiedAccessTrustProviderResult == false)
            return false;
        AttachVerifiedAccessTrustProviderResult other = (AttachVerifiedAccessTrustProviderResult) obj;
    ...
    @Override
    public AttachVerifiedAccessTrustProviderResult clone() {
        try {
            return (AttachVerifiedAccessTrustProviderResult) super.clone();
