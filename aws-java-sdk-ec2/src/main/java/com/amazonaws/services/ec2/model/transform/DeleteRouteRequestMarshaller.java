    ...
    public Request<DeleteRouteRequest> marshall(
        ...
        if (deleteRouteRequest.getRouteTableId() != null) {
            request.addParameter("RouteTableId", StringUtils
                    .fromString(deleteRouteRequest.getRouteTableId()));
        }

        if (deleteRouteRequest.getDestinationCidrBlock() != null) {
            request.addParameter("DestinationCidrBlock", StringUtils
                    .fromString(deleteRouteRequest.getDestinationCidrBlock()));
        }
