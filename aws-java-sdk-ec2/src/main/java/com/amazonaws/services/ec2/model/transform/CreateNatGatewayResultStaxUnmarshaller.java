...
/**
 * Create Nat Gateway Result StAX Unmarshaller
 */
public class CreateNatGatewayResultStaxUnmarshaller implements Unmarshaller<CreateNatGatewayResult, StaxUnmarshallerContext> {
    ...
    public CreateNatGatewayResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createNatGatewayResult;
    ...
    public static CreateNatGatewayResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateNatGatewayResultStaxUnmarshaller();
        return instance;
    }
}
