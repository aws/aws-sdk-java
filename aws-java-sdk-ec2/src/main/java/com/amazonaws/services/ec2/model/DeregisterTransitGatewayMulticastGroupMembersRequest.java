...
import com.amazonaws.services.ec2.model.transform.DeregisterTransitGatewayMulticastGroupMembersRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeregisterTransitGatewayMulticastGroupMembersRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DeregisterTransitGatewayMulticastGroupMembersRequest> {
    ...
    public DeregisterTransitGatewayMulticastGroupMembersRequest withNetworkInterfaceIds(java.util.Collection<String> networkInterfaceIds) {
     ...
     */
    @Override
    public Request<DeregisterTransitGatewayMulticastGroupMembersRequest> getDryRunRequest() {
        Request<DeregisterTransitGatewayMulticastGroupMembersRequest> request = new DeregisterTransitGatewayMulticastGroupMembersRequestMarshaller()
                .marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeregisterTransitGatewayMulticastGroupMembersRequest == false)
            return false;
    ...
    @Override
    public DeregisterTransitGatewayMulticastGroupMembersRequest clone() {
        return (DeregisterTransitGatewayMulticastGroupMembersRequest) super.clone();
    }
}
