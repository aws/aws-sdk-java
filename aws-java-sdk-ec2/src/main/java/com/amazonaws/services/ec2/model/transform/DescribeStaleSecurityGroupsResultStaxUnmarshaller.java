 ...
 */
public class DescribeStaleSecurityGroupsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeStaleSecurityGroupsResult, StaxUnmarshallerContext> {

    public DescribeStaleSecurityGroupsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("staleSecurityGroupSet/item",
                        targetDepth)) {
                    describeStaleSecurityGroupsResult
                            .withStaleSecurityGroupSet(StaleSecurityGroupStaxUnmarshaller
