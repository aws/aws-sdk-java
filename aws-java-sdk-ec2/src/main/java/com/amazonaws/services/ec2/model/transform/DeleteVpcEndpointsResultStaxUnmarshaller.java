 ...
 */
public class DeleteVpcEndpointsResultStaxUnmarshaller implements
        Unmarshaller<DeleteVpcEndpointsResult, StaxUnmarshallerContext> {

    public DeleteVpcEndpointsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("unsuccessful/item", targetDepth)) {
                    deleteVpcEndpointsResult.getUnsuccessful().add(
    ...
    public static DeleteVpcEndpointsResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeleteVpcEndpointsResultStaxUnmarshaller();
        return instance;
    }
}
