...
class NetworkInterfaceAvailable {
    ...
    static class IsAvailableMatcher extends
            WaiterAcceptor<DescribeNetworkInterfacesResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(
                new JmesPathFlatten(new JmesPathField("NetworkInterfaces")),
    ...
    static class IsInvalidNetworkInterfaceIDNotFoundMatcher extends
            WaiterAcceptor<DescribeNetworkInterfacesResult> {
        /**
        ...
        public boolean matches(AmazonServiceException e) {
            return "InvalidNetworkInterfaceID.NotFound"
