...
public class StaleIpPermission implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The start of the port range for the TCP and UDP protocols, or an
     *         ICMP type number. A value of <code>-1</code> indicates all ICMP
     *         types.
     */
     ...
     * </p>
     * 
     * @return One or more IP ranges. Not applicable for stale security group
     *         rules.
     */
    ...
    public void setIpRanges(java.util.Collection<String> ipRanges) {
        ...
        this.ipRanges = new com.amazonaws.internal.SdkInternalList<String>(
                ipRanges);
    }
     ...
     * </p>
     * 
     * @return One or more prefix list IDs for an AWS service. Not applicable
     *         for stale security group rules.
     */
    ...
    public StaleIpPermission withPrefixListIds(
     ...
     * </p>
     * 
     * @return The end of the port range for the TCP and UDP protocols, or an
     *         ICMP type number. A value of <code>-1</code> indicates all ICMP
     *         types.
     */
     ...
     * </p>
     * 
     * @return One or more security group pairs. Returns the ID of the
     *         referenced security group and VPC, and the ID and status of the
    ...
    public void setUserIdGroupPairs(
        ...
        this.userIdGroupPairs = new com.amazonaws.internal.SdkInternalList<UserIdGroupPair>(
                userIdGroupPairs);
    }
     ...
     * <p>
     * <b>NOTE:</b> This method appends the values to the existing list (if
     * any). Use {@link #setUserIdGroupPairs(java.util.Collection)} or
     * {@link #withUserIdGroupPairs(java.util.Collection)} if you want to
    ...
    public StaleIpPermission withUserIdGroupPairs(
        ...
        if (this.userIdGroupPairs == null) {
            setUserIdGroupPairs(new com.amazonaws.internal.SdkInternalList<UserIdGroupPair>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getUserIdGroupPairs() == null
                ^ this.getUserIdGroupPairs() == null)
            return false;
        if (other.getUserIdGroupPairs() != null
                && other.getUserIdGroupPairs().equals(
                        this.getUserIdGroupPairs()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getUserIdGroupPairs() == null) ? 0 : getUserIdGroupPairs()
                        .hashCode());
        return hashCode;
    }
