...
public class DescribeVpcPeeringConnectionsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeVpcPeeringConnectionsResult, StaxUnmarshallerContext> {

    public DescribeVpcPeeringConnectionsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("vpcPeeringConnectionSet/item",
                        targetDepth)) {
                    describeVpcPeeringConnectionsResult
                            .withVpcPeeringConnections(VpcPeeringConnectionStaxUnmarshaller
