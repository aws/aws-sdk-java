 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/VpnTunnelLogOptions" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VpnTunnelLogOptions implements Serializable, Cloneable {
    ...
    public void setCloudWatchLogOptions(CloudWatchLogOptions cloudWatchLogOptions) {
    ...
    public CloudWatchLogOptions getCloudWatchLogOptions() {
    ...
    public VpnTunnelLogOptions withCloudWatchLogOptions(CloudWatchLogOptions cloudWatchLogOptions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VpnTunnelLogOptions == false)
            return false;
    ...
    @Override
    public VpnTunnelLogOptions clone() {
        try {
            return (VpnTunnelLogOptions) super.clone();
