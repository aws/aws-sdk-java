...
public class DescribeKeyPairsResultStaxUnmarshaller implements Unmarshaller<DescribeKeyPairsResult, StaxUnmarshallerContext> {
    ...
    public DescribeKeyPairsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeKeyPairsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("keySet/item", targetDepth)) {
                    describeKeyPairsResult.getKeyPairs().add(KeyPairInfoStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeKeyPairsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeKeyPairsResultStaxUnmarshaller();
        return instance;
    }
}
