...
public class RequestSpotInstancesResultStaxUnmarshaller implements Unmarshaller<RequestSpotInstancesResult, StaxUnmarshallerContext> {
    ...
    public RequestSpotInstancesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return requestSpotInstancesResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("spotInstanceRequestSet/item", targetDepth)) {
                    requestSpotInstancesResult.getSpotInstanceRequests().add(SpotInstanceRequestStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static RequestSpotInstancesResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new RequestSpotInstancesResultStaxUnmarshaller();
        return instance;
    }
}
