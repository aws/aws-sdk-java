...
/**
 * Release Hosts Request Marshaller
 */
public class ReleaseHostsRequestMarshaller implements Marshaller<Request<ReleaseHostsRequest>, ReleaseHostsRequest> {
    ...
    public Request<ReleaseHostsRequest> marshall(ReleaseHostsRequest releaseHostsRequest) {
        ...
        java.util.List<String> hostIdsList = releaseHostsRequest.getHostIds();
