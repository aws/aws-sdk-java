...
/**
 * Cancel Spot Fleet Requests Result StAX Unmarshaller
 */
public class CancelSpotFleetRequestsResultStaxUnmarshaller implements Unmarshaller<CancelSpotFleetRequestsResult, StaxUnmarshallerContext> {
    ...
    public CancelSpotFleetRequestsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return cancelSpotFleetRequestsResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("unsuccessfulFleetRequestSet/item", targetDepth)) {
                    cancelSpotFleetRequestsResult.getUnsuccessfulFleetRequests().add(CancelSpotFleetRequestsErrorItemStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                if (context.testExpression("successfulFleetRequestSet/item", targetDepth)) {
                    cancelSpotFleetRequestsResult.getSuccessfulFleetRequests().add(CancelSpotFleetRequestsSuccessItemStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CancelSpotFleetRequestsResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CancelSpotFleetRequestsResultStaxUnmarshaller();
        return instance;
    }
}
