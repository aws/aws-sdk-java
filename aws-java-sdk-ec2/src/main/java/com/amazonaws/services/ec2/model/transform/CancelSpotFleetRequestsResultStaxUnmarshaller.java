 ...
 */
public class CancelSpotFleetRequestsResultStaxUnmarshaller implements
        Unmarshaller<CancelSpotFleetRequestsResult, StaxUnmarshallerContext> {

    public CancelSpotFleetRequestsResult unmarshall(
