...
/**
 * ModifyVpnConnectionRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModifyVpnConnectionRequestMarshaller implements Marshaller<Request<ModifyVpnConnectionRequest>, ModifyVpnConnectionRequest> {

    public Request<ModifyVpnConnectionRequest> marshall(ModifyVpnConnectionRequest modifyVpnConnectionRequest) {

        if (modifyVpnConnectionRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        Request<ModifyVpnConnectionRequest> request = new DefaultRequest<ModifyVpnConnectionRequest>(modifyVpnConnectionRequest, "AmazonEC2");
        request.addParameter("Action", "ModifyVpnConnection");
        request.addParameter("Version", "2016-11-15");
        request.setHttpMethod(HttpMethodName.POST);

        if (modifyVpnConnectionRequest.getVpnConnectionId() != null) {
            request.addParameter("VpnConnectionId", StringUtils.fromString(modifyVpnConnectionRequest.getVpnConnectionId()));
        }
