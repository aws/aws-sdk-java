...
public class DeleteInternetGatewayResultStaxUnmarshaller implements Unmarshaller<DeleteInternetGatewayResult, StaxUnmarshallerContext> {

    public DeleteInternetGatewayResult unmarshall(StaxUnmarshallerContext context) throws Exception {
