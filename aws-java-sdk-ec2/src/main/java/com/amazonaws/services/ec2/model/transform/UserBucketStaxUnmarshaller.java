...
public class UserBucketStaxUnmarshaller implements Unmarshaller<UserBucket, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("S3Bucket", targetDepth)) {
                    userBucket.setS3Bucket(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("S3Key", targetDepth)) {
                    userBucket.setS3Key(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
