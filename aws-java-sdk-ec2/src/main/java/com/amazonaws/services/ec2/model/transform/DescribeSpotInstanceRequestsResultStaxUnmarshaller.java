 ...
 */
public class DescribeSpotInstanceRequestsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeSpotInstanceRequestsResult, StaxUnmarshallerContext> {

    public DescribeSpotInstanceRequestsResult unmarshall(
