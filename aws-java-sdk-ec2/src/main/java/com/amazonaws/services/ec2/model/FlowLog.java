...
public class FlowLog implements Serializable, Cloneable {
     ...
     * <code>Access error</code> indicates that the IAM role associated with the
     * flow log does not have sufficient permissions to publish to CloudWatch
     * Logs. <code>Unknown error</code> indicates an internal error.
     * </p>
     */
     ...
     *        groups that you can create. <code>Access error</code> indicates
     ...
     * </p>
     * 
     * @return Information about the error that occurred.
     *         <code>Rate limited</code> indicates that CloudWatch logs
    ...
    public String toString() {
        ...
        if (getDeliverLogsErrorMessage() != null)
            sb.append("DeliverLogsErrorMessage: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDeliverLogsStatus() == null
                ^ this.getDeliverLogsStatus() == null)
            return false;
        if (other.getDeliverLogsStatus() != null
                && other.getDeliverLogsStatus().equals(
                        this.getDeliverLogsStatus()) == false)
            return false;
        if (other.getDeliverLogsErrorMessage() == null
                ^ this.getDeliverLogsErrorMessage() == null)
            return false;
        if (other.getDeliverLogsErrorMessage() != null
                && other.getDeliverLogsErrorMessage().equals(
                        this.getDeliverLogsErrorMessage()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getFlowLogId() == null) ? 0 : getFlowLogId().hashCode());
        hashCode = prime
                * hashCode
        ...
        hashCode = prime
                * hashCode
                + ((getDeliverLogsStatus() == null) ? 0
                        : getDeliverLogsStatus().hashCode());
        hashCode = prime
                * hashCode
                + ((getDeliverLogsErrorMessage() == null) ? 0
                        : getDeliverLogsErrorMessage().hashCode());
        hashCode = prime
                * hashCode
