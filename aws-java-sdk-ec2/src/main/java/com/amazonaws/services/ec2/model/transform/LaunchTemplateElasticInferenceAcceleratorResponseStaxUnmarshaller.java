...
/**
 * LaunchTemplateElasticInferenceAcceleratorResponse StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LaunchTemplateElasticInferenceAcceleratorResponseStaxUnmarshaller implements
        Unmarshaller<LaunchTemplateElasticInferenceAcceleratorResponse, StaxUnmarshallerContext> {

    public LaunchTemplateElasticInferenceAcceleratorResponse unmarshall(StaxUnmarshallerContext context) throws Exception {
