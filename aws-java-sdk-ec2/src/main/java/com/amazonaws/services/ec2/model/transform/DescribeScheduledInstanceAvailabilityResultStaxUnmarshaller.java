...
/**
 * Describe Scheduled Instance Availability Result StAX Unmarshaller
 */
public class DescribeScheduledInstanceAvailabilityResultStaxUnmarshaller implements Unmarshaller<DescribeScheduledInstanceAvailabilityResult, StaxUnmarshallerContext> {
    ...
    public DescribeScheduledInstanceAvailabilityResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return describeScheduledInstanceAvailabilityResult;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("scheduledInstanceAvailabilitySet/item", targetDepth)) {
                    describeScheduledInstanceAvailabilityResult.getScheduledInstanceAvailabilitySet().add(ScheduledInstanceAvailabilityStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeScheduledInstanceAvailabilityResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeScheduledInstanceAvailabilityResultStaxUnmarshaller();
        return instance;
    }
}
