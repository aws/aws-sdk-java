 ...
 */
public class DescribeVolumeAttributeResultStaxUnmarshaller implements
        Unmarshaller<DescribeVolumeAttributeResult, StaxUnmarshallerContext> {

    public DescribeVolumeAttributeResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("autoEnableIO/value", targetDepth)) {
                    describeVolumeAttributeResult
                            .setAutoEnableIO(BooleanStaxUnmarshaller
