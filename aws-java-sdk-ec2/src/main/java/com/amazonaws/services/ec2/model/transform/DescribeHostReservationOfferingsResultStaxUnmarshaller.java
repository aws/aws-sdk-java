 ...
 */
public class DescribeHostReservationOfferingsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeHostReservationOfferingsResult, StaxUnmarshallerContext> {

    public DescribeHostReservationOfferingsResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("offeringSet/member", targetDepth)) {
                    describeHostReservationOfferingsResult
                            .withOfferingSet(HostOfferingStaxUnmarshaller
