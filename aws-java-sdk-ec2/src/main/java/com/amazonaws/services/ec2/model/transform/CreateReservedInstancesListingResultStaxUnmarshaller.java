 ...
 */
public class CreateReservedInstancesListingResultStaxUnmarshaller
        implements
        Unmarshaller<CreateReservedInstancesListingResult, StaxUnmarshallerContext> {

    public CreateReservedInstancesListingResult unmarshall(
