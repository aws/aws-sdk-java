...
public class DescribeInternetGatewaysResultStaxUnmarshaller implements
    ...
    public DescribeInternetGatewaysResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("internetGatewaySet/item",
                        targetDepth)) {
                    describeInternetGatewaysResult.getInternetGateways().add(
                            InternetGatewayStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
