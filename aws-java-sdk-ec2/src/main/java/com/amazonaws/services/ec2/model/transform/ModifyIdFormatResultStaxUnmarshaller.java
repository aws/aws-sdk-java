 ...
 */
public class ModifyIdFormatResultStaxUnmarshaller implements
        Unmarshaller<ModifyIdFormatResult, StaxUnmarshallerContext> {

    public ModifyIdFormatResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
