 ...
 */
public class DescribeSpotFleetInstancesResultStaxUnmarshaller implements
        Unmarshaller<DescribeSpotFleetInstancesResult, StaxUnmarshallerContext> {

    public DescribeSpotFleetInstancesResult unmarshall(
