...
public class DescribeRegionsRequestMarshaller implements
    ...
    public Request<DescribeRegionsRequest> marshall(
        ...
        Request<DescribeRegionsRequest> request = new DefaultRequest<DescribeRegionsRequest>(
                describeRegionsRequest, "AmazonEC2");
        ...
        if (!regionNamesList.isEmpty() || !regionNamesList.isAutoConstruct()) {
            ...
            for (String regionNamesListValue : regionNamesList) {
                if (regionNamesListValue != null) {
                    request.addParameter("RegionName." + regionNamesListIndex,
                            StringUtils.fromString(regionNamesListValue));
                }
                regionNamesListIndex++;
            }
        }

        com.amazonaws.internal.SdkInternalList<Filter> filtersList = (com.amazonaws.internal.SdkInternalList<Filter>) describeRegionsRequest
                .getFilters();
