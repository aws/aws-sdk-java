 ...
 */
public class DescribeInstanceAttributeResultStaxUnmarshaller implements
        Unmarshaller<DescribeInstanceAttributeResult, StaxUnmarshallerContext> {

    public DescribeInstanceAttributeResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                describeInstanceAttributeResult
                        .setInstanceAttribute(InstanceAttributeStaxUnmarshaller
