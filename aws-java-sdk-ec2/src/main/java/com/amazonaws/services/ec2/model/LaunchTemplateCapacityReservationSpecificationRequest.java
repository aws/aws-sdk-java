 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/LaunchTemplateCapacityReservationSpecificationRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LaunchTemplateCapacityReservationSpecificationRequest implements Serializable, Cloneable {
    ...
    public LaunchTemplateCapacityReservationSpecificationRequest withCapacityReservationPreference(String capacityReservationPreference) {
    ...
    public LaunchTemplateCapacityReservationSpecificationRequest withCapacityReservationPreference(CapacityReservationPreference capacityReservationPreference) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LaunchTemplateCapacityReservationSpecificationRequest == false)
            return false;
        LaunchTemplateCapacityReservationSpecificationRequest other = (LaunchTemplateCapacityReservationSpecificationRequest) obj;
    ...
    @Override
    public LaunchTemplateCapacityReservationSpecificationRequest clone() {
        try {
            return (LaunchTemplateCapacityReservationSpecificationRequest) super.clone();
