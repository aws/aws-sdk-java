...
public class DescribeVolumesFunction implements SdkFunction<DescribeVolumesRequest, DescribeVolumesResult> {
     ...
     */
    @Override
    public DescribeVolumesResult apply(DescribeVolumesRequest describeVolumesRequest) {
