...
class BundleTaskComplete {
    ...
    static class IsCompleteMatcher extends WaiterAcceptor<DescribeBundleTasksResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"complete\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }

        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("BundleTasks")), new JmesPathField("State"));
         ...
         */
        @Override
        public boolean matches(DescribeBundleTasksResult result) {
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeBundleTasksResult> {
        private static final JsonNode expectedResult;
