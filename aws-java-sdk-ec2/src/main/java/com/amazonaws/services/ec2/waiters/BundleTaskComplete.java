...
class BundleTaskComplete {
    ...
    static class IsCompleteMatcher extends
            WaiterAcceptor<DescribeBundleTasksResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(
                new JmesPathFlatten(new JmesPathField("BundleTasks")),
    ...
    static class IsFailedMatcher extends
            WaiterAcceptor<DescribeBundleTasksResult> {
        private static final JsonNode expectedResult;
