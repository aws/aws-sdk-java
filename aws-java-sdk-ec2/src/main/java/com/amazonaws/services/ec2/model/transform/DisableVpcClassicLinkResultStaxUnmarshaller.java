 ...
 */
public class DisableVpcClassicLinkResultStaxUnmarshaller implements
        Unmarshaller<DisableVpcClassicLinkResult, StaxUnmarshallerContext> {

    public DisableVpcClassicLinkResult unmarshall(
