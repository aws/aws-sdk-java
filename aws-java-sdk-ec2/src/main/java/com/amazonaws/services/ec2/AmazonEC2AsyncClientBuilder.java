...
/**
 * Fluent builder for {@link com.amazonaws.services.ec2.AmazonEC2Async}. Use of
 * the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonEC2AsyncClientBuilder extends
        AwsAsyncClientBuilder<AmazonEC2AsyncClientBuilder, AmazonEC2Async> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonEC2Async using the
