 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/FilterPortRange" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FilterPortRange implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FilterPortRange == false)
            return false;
        FilterPortRange other = (FilterPortRange) obj;
    ...
    @Override
    public FilterPortRange clone() {
        try {
            return (FilterPortRange) super.clone();
