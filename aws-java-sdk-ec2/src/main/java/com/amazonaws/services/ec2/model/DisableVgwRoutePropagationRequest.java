...
public class DisableVgwRoutePropagationRequest extends AmazonWebServiceRequest
    ...
    public DisableVgwRoutePropagationRequest withRouteTableId(
            String routeTableId) {
    ...
    public Request<DisableVgwRoutePropagationRequest> getDryRunRequest() {
        Request<DisableVgwRoutePropagationRequest> request = new DisableVgwRoutePropagationRequestMarshaller()
                .marshall(this);
