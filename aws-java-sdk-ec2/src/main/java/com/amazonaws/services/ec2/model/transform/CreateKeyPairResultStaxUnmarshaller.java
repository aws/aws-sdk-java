 ...
 */
public class CreateKeyPairResultStaxUnmarshaller implements
        Unmarshaller<CreateKeyPairResult, StaxUnmarshallerContext> {

    public CreateKeyPairResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                createKeyPairResult.setKeyPair(KeyPairStaxUnmarshaller
