...
public class CreateTransitGatewayRouteTableResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTransitGatewayRouteTableResult == false)
            return false;
        CreateTransitGatewayRouteTableResult other = (CreateTransitGatewayRouteTableResult) obj;
    ...
    public CreateTransitGatewayRouteTableResult clone() {
        try {
            return (CreateTransitGatewayRouteTableResult) super.clone();
