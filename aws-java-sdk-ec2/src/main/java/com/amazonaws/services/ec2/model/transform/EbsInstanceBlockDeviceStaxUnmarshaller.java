 ...
 */
public class EbsInstanceBlockDeviceStaxUnmarshaller implements
        Unmarshaller<EbsInstanceBlockDevice, StaxUnmarshallerContext> {

    public EbsInstanceBlockDevice unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("volumeId", targetDepth)) {
                    ebsInstanceBlockDevice.setVolumeId(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("status", targetDepth)) {
                    ebsInstanceBlockDevice.setStatus(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("attachTime", targetDepth)) {
                    ebsInstanceBlockDevice.setAttachTime(DateStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
