 ...
 */
public class ModifyReservedInstancesResultStaxUnmarshaller implements
        Unmarshaller<ModifyReservedInstancesResult, StaxUnmarshallerContext> {

    public ModifyReservedInstancesResult unmarshall(
