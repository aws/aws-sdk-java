 ...
 */
public class ReservedInstancesIdStaxUnmarshaller implements
        Unmarshaller<ReservedInstancesId, StaxUnmarshallerContext> {

    public ReservedInstancesId unmarshall(StaxUnmarshallerContext context)
            throws Exception {
