...
/**
 * Spot Fleet Request Config StAX Unmarshaller
 */
public class SpotFleetRequestConfigStaxUnmarshaller implements Unmarshaller<SpotFleetRequestConfig, StaxUnmarshallerContext> {
    ...
    public SpotFleetRequestConfig unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return spotFleetRequestConfig;
    ...
    public static SpotFleetRequestConfigStaxUnmarshaller getInstance() {
        if (instance == null) instance = new SpotFleetRequestConfigStaxUnmarshaller();
        return instance;
    }
}
