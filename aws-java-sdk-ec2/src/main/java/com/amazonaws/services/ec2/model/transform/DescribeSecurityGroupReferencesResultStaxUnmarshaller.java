 ...
 */
public class DescribeSecurityGroupReferencesResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeSecurityGroupReferencesResult, StaxUnmarshallerContext> {

    public DescribeSecurityGroupReferencesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("securityGroupReferenceSet/item",
                        targetDepth)) {
                    describeSecurityGroupReferencesResult
                            .withSecurityGroupReferenceSet(SecurityGroupReferenceStaxUnmarshaller
