 ...
 */
public class CancelBundleTaskResultStaxUnmarshaller implements
        Unmarshaller<CancelBundleTaskResult, StaxUnmarshallerContext> {

    public CancelBundleTaskResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
