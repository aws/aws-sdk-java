 ...
 * 
 */
public class DeleteVpnConnectionRouteRequest extends AmazonWebServiceRequest
    ...
    public DeleteVpnConnectionRouteRequest withVpnConnectionId(
    ...
    public DeleteVpnConnectionRouteRequest withDestinationCidrBlock(
    ...
    public Request<DeleteVpnConnectionRouteRequest> getDryRunRequest() {
        Request<DeleteVpnConnectionRouteRequest> request = new DeleteVpnConnectionRouteRequestMarshaller()
                .marshall(this);
