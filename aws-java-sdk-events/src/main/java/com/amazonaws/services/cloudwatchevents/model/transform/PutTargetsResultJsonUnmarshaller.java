 ...
 */
public class PutTargetsResultJsonUnmarshaller implements
        Unmarshaller<PutTargetsResult, JsonUnmarshallerContext> {

    public PutTargetsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("FailedEntries", targetDepth)) {
                    context.nextToken();
                    putTargetsResult
                            .setFailedEntries(new ListUnmarshaller<PutTargetsResultEntry>(
