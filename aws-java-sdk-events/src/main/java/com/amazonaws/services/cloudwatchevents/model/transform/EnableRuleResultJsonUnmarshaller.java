 ...
 */
public class EnableRuleResultJsonUnmarshaller implements
        Unmarshaller<EnableRuleResult, JsonUnmarshallerContext> {

    public EnableRuleResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
