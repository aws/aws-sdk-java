...
public class ManagedRuleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ManagedRuleExceptionUnmarshaller instance;

    public static ManagedRuleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ManagedRuleExceptionUnmarshaller();
        return instance;
    }
}
