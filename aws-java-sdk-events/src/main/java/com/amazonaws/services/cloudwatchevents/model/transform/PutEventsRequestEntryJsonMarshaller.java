...
public class PutEventsRequestEntryJsonMarshaller {
     ...
     */
    public void marshall(PutEventsRequestEntry putEventsRequestEntry, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (putEventsRequestEntry.getTime() != null) {
                jsonGenerator.writeFieldName("Time").writeValue(putEventsRequestEntry.getTime());
            }
            if (putEventsRequestEntry.getSource() != null) {
                jsonGenerator.writeFieldName("Source").writeValue(putEventsRequestEntry.getSource());
            }
            ...
            if (putEventsRequestEntry.getDetailType() != null) {
                jsonGenerator.writeFieldName("DetailType").writeValue(putEventsRequestEntry.getDetailType());
            }
            if (putEventsRequestEntry.getDetail() != null) {
                jsonGenerator.writeFieldName("Detail").writeValue(putEventsRequestEntry.getDetail());
            }
