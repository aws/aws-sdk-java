 ...
 */
public class PutEventsRequestEntryJsonUnmarshaller implements
        Unmarshaller<PutEventsRequestEntry, JsonUnmarshallerContext> {

    public PutEventsRequestEntry unmarshall(JsonUnmarshallerContext context)
            throws Exception {
