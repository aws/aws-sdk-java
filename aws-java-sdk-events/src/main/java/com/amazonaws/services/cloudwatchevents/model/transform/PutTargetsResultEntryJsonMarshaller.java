...
public class PutTargetsResultEntryJsonMarshaller {
     ...
     */
    public void marshall(PutTargetsResultEntry putTargetsResultEntry, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (putTargetsResultEntry.getTargetId() != null) {
                jsonGenerator.writeFieldName("TargetId").writeValue(putTargetsResultEntry.getTargetId());
            }
            if (putTargetsResultEntry.getErrorCode() != null) {
                jsonGenerator.writeFieldName("ErrorCode").writeValue(putTargetsResultEntry.getErrorCode());
            }
            if (putTargetsResultEntry.getErrorMessage() != null) {
                jsonGenerator.writeFieldName("ErrorMessage").writeValue(putTargetsResultEntry.getErrorMessage());
            }
