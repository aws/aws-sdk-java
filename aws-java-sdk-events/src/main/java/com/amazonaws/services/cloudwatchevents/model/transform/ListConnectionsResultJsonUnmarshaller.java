...
/**
 * ListConnectionsResult JSON Unmarshaller
 */
...
public class ListConnectionsResultJsonUnmarshaller implements Unmarshaller<ListConnectionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listConnectionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ListConnectionsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListConnectionsResultJsonUnmarshaller();
        return instance;
    }
}
