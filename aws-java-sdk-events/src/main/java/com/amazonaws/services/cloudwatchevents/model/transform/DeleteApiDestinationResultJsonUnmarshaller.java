...
/**
 * DeleteApiDestinationResult JSON Unmarshaller
 */
...
public class DeleteApiDestinationResultJsonUnmarshaller implements Unmarshaller<DeleteApiDestinationResult, JsonUnmarshallerContext> {
    ...
    public DeleteApiDestinationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteApiDestinationResult deleteApiDestinationResult = new DeleteApiDestinationResult();

        return deleteApiDestinationResult;
    }
