...
public class ListRuleNamesByTargetRequestMarshaller
        implements
        Marshaller<Request<ListRuleNamesByTargetRequest>, ListRuleNamesByTargetRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public ListRuleNamesByTargetRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<ListRuleNamesByTargetRequest> marshall(
        ...
        Request<ListRuleNamesByTargetRequest> request = new DefaultRequest<ListRuleNamesByTargetRequest>(
                listRuleNamesByTargetRequest, "AmazonCloudWatchEvents");
