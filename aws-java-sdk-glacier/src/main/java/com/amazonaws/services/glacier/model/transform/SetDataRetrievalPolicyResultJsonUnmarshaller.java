 ...
 */
public class SetDataRetrievalPolicyResultJsonUnmarshaller implements
        Unmarshaller<SetDataRetrievalPolicyResult, JsonUnmarshallerContext> {

    public SetDataRetrievalPolicyResult unmarshall(
