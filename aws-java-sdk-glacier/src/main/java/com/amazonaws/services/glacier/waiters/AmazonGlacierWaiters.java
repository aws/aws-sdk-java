...
public class AmazonGlacierWaiters {
    ...
    /**
     * Builds a VaultExists waiter by using custom parameters waiterParameters
    ...
    public Waiter vaultExists() {
        ...
        return new WaiterBuilder<DescribeVaultRequest, DescribeVaultResult>()
                ...
                .withAcceptors(
                        ...
                        new VaultExists.IsResourceNotFoundExceptionMatcher())
                .withDefaultPollingStrategy(
                        new PollingStrategy(new MaxAttemptsRetryStrategy(15),
                                new FixedDelayStrategy(3)))
                .withExecutorService(executorService).build();
    }

    /**
     * Builds a VaultNotExists waiter by using custom parameters
    ...
    public Waiter vaultNotExists() {
        ...
        return new WaiterBuilder<DescribeVaultRequest, DescribeVaultResult>()
                .withSdkFunction(new DescribeVaultFunction(client))
                .withAcceptors(
                        new HttpSuccessStatusAcceptor(WaiterState.RETRY),
                        new VaultNotExists.IsResourceNotFoundExceptionMatcher())
                .withDefaultPollingStrategy(
                        new PollingStrategy(new MaxAttemptsRetryStrategy(15),
                                new FixedDelayStrategy(3)))
                .withExecutorService(executorService).build();
