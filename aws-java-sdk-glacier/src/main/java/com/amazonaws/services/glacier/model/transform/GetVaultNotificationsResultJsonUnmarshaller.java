 ...
 */
public class GetVaultNotificationsResultJsonUnmarshaller implements
        Unmarshaller<GetVaultNotificationsResult, JsonUnmarshallerContext> {

    public GetVaultNotificationsResult unmarshall(
        ...
        while (true) {
            ...
            getVaultNotificationsResult
                    .setVaultNotificationConfig(VaultNotificationConfigJsonUnmarshaller
