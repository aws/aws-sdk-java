...
/**
 * Fluent builder for {@link com.amazonaws.services.glacier.AmazonGlacier}. Use
 * of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonGlacierClientBuilder extends
        AwsSyncClientBuilder<AmazonGlacierClientBuilder, AmazonGlacier> {
    ...
    /**
     * Construct a synchronous implementation of AmazonGlacier using the current
     * builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AmazonGlacier.
     */
    @Override
    protected AmazonGlacier build(AwsSyncClientParams params) {
