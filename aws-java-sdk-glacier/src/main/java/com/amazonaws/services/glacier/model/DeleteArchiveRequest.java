...
public class DeleteArchiveRequest extends AmazonWebServiceRequest implements
    ...
    /**
     * Default constructor for DeleteArchiveRequest object. Callers should use
    ...
    /**
     * Constructs a new DeleteArchiveRequest object. Callers should use the
     ...
     *        The ID of the archive to delete.
     */
    public DeleteArchiveRequest(String accountId, String vaultName,
            String archiveId) {
