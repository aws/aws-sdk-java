 ...
 */
public class InitiateJobResultJsonUnmarshaller implements
        Unmarshaller<InitiateJobResult, JsonUnmarshallerContext> {
    ...
    public InitiateJobResult unmarshall(JsonUnmarshallerContext context)
        ...
        if (context.isStartOfDocument()) {
            if (context.getHeader("Location") != null) {
                ...
                initiateJobResult.setLocation(context.getUnmarshaller(
                        String.class).unmarshall(context));
            }
            if (context.getHeader("x-amz-job-id") != null) {
                context.setCurrentHeader("x-amz-job-id");
                initiateJobResult.setJobId(context
