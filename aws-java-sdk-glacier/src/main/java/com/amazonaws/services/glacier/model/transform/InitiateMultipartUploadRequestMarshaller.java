...
public class InitiateMultipartUploadRequestMarshaller
        implements
        Marshaller<Request<InitiateMultipartUploadRequest>, InitiateMultipartUploadRequest> {
    ...
    public Request<InitiateMultipartUploadRequest> marshall(
        ...
        Request<InitiateMultipartUploadRequest> request = new DefaultRequest<InitiateMultipartUploadRequest>(
                initiateMultipartUploadRequest, "AmazonGlacier");
        ...
        if (initiateMultipartUploadRequest.getArchiveDescription() != null) {
            request.addHeader("x-amz-archive-description", StringUtils
                    .fromString(initiateMultipartUploadRequest
                            .getArchiveDescription()));
        }

        if (initiateMultipartUploadRequest.getPartSize() != null) {
            request.addHeader("x-amz-part-size", StringUtils
                    .fromString(initiateMultipartUploadRequest.getPartSize()));
        }
