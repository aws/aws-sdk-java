...
/**
 * Initiate Vault Lock Request Marshaller
 */
public class InitiateVaultLockRequestMarshaller implements Marshaller<Request<InitiateVaultLockRequest>, InitiateVaultLockRequest> {
    ...
    public Request<InitiateVaultLockRequest> marshall(InitiateVaultLockRequest initiateVaultLockRequest) {
        ...
        String target = "Glacier.InitiateVaultLock";
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("accountId")) {
            ...
            String value = (initiateVaultLockRequest.getAccountId() == null) ? null : StringUtils.fromString(initiateVaultLockRequest.getAccountId());
            ...
            uriResourcePath = uriResourcePath.replace("{accountId}", (initiateVaultLockRequest.getAccountId() == null) ? "" : StringUtils.fromString(initiateVaultLockRequest.getAccountId())); 
        } 
        if (DYNAMIC_QUERY_PARAMS.containsKey("vaultName")) {
            String name = DYNAMIC_QUERY_PARAMS.get("vaultName");

            String value = (initiateVaultLockRequest.getVaultName() == null) ? null : StringUtils.fromString(initiateVaultLockRequest.getVaultName());
            ...
            uriResourcePath = uriResourcePath.replace("{vaultName}", (initiateVaultLockRequest.getVaultName() == null) ? "" : StringUtils.fromString(initiateVaultLockRequest.getVaultName())); 
        } 
