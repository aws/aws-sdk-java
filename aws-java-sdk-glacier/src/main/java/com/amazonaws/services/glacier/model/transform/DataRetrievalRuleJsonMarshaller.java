    ...
    public void marshall(DataRetrievalRule dataRetrievalRule, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (dataRetrievalRule.getStrategy() != null) {
                jsonGenerator.writeFieldName("Strategy").writeValue(dataRetrievalRule.getStrategy());
            }
            if (dataRetrievalRule.getBytesPerHour() != null) {
                jsonGenerator.writeFieldName("BytesPerHour").writeValue(dataRetrievalRule.getBytesPerHour());
            }
