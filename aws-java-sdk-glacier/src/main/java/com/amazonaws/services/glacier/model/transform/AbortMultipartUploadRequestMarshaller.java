...
public class AbortMultipartUploadRequestMarshaller
    ...
    public Request<AbortMultipartUploadRequest> marshall(
        ...
        Request<AbortMultipartUploadRequest> request = new DefaultRequest<AbortMultipartUploadRequest>(
                abortMultipartUploadRequest, "AmazonGlacier");
        ...
        uriResourcePath = uriResourcePath
                .replace(
                        "{accountId}",
                        (abortMultipartUploadRequest.getAccountId() != null) ? SdkHttpUtils
                                .urlEncode(StringUtils
                                        .fromString(abortMultipartUploadRequest
                                                .getAccountId()), false) : "");
        uriResourcePath = uriResourcePath
                .replace(
                        "{vaultName}",
                        (abortMultipartUploadRequest.getVaultName() != null) ? SdkHttpUtils
                                .urlEncode(StringUtils
                                        .fromString(abortMultipartUploadRequest
                                                .getVaultName()), false) : "");
        uriResourcePath = uriResourcePath
                .replace(
                        "{uploadId}",
                        (abortMultipartUploadRequest.getUploadId() != null) ? SdkHttpUtils
                                .urlEncode(StringUtils
                                        .fromString(abortMultipartUploadRequest
                                                .getUploadId()), false) : "");
