 ...
 */
public class InventoryRetrievalJobInputJsonUnmarshaller implements
        Unmarshaller<InventoryRetrievalJobInput, JsonUnmarshallerContext> {

    public InventoryRetrievalJobInput unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StartDate", targetDepth)) {
                    context.nextToken();
                    inventoryRetrievalJobInput.setStartDate(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("EndDate", targetDepth)) {
                    context.nextToken();
                    inventoryRetrievalJobInput.setEndDate(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Limit", targetDepth)) {
                    context.nextToken();
                    inventoryRetrievalJobInput.setLimit(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Marker", targetDepth)) {
                    context.nextToken();
                    inventoryRetrievalJobInput.setMarker(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
