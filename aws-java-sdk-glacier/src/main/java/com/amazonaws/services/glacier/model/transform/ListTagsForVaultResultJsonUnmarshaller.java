 ...
 */
public class ListTagsForVaultResultJsonUnmarshaller implements
        Unmarshaller<ListTagsForVaultResult, JsonUnmarshallerContext> {

    public ListTagsForVaultResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
    ...
    public static ListTagsForVaultResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListTagsForVaultResultJsonUnmarshaller();
        return instance;
    }
}
