 ...
 */
public class AbortMultipartUploadResultJsonUnmarshaller implements
        Unmarshaller<AbortMultipartUploadResult, JsonUnmarshallerContext> {

    public AbortMultipartUploadResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
