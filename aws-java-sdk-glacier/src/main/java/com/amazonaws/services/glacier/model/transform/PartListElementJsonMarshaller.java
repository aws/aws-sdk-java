...
public class PartListElementJsonMarshaller {
     ...
     */
    public void marshall(PartListElement partListElement,
        ...
        try {
            ...
            if (partListElement.getRangeInBytes() != null) {
                jsonGenerator.writeFieldName("RangeInBytes").writeValue(
                        partListElement.getRangeInBytes());
            }
            if (partListElement.getSHA256TreeHash() != null) {
                jsonGenerator.writeFieldName("SHA256TreeHash").writeValue(
                        partListElement.getSHA256TreeHash());
            }
