 ...
 */
public class InitiateVaultLockResultJsonUnmarshaller implements
        Unmarshaller<InitiateVaultLockResult, JsonUnmarshallerContext> {

    public InitiateVaultLockResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        if (context.isStartOfDocument()) {
            if (context.getHeader("x-amz-lock-id") != null) {
                ...
                initiateVaultLockResult.setLockId(context.getUnmarshaller(
