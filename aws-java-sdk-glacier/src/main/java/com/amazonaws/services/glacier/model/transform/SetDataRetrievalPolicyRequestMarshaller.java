...
/**
 * Set Data Retrieval Policy Request Marshaller
 */
public class SetDataRetrievalPolicyRequestMarshaller implements Marshaller<Request<SetDataRetrievalPolicyRequest>, SetDataRetrievalPolicyRequest> {
    ...
    public Request<SetDataRetrievalPolicyRequest> marshall(SetDataRetrievalPolicyRequest setDataRetrievalPolicyRequest) {
        ...
        if (DYNAMIC_QUERY_PARAMS.containsKey("accountId")) {
            ...
            String value = (setDataRetrievalPolicyRequest.getAccountId() == null) ? null : StringUtils.fromString(setDataRetrievalPolicyRequest.getAccountId());
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (policy != null) {
                ...
                com.amazonaws.internal.ListWithAutoConstructFlag<DataRetrievalRule> rulesList = (com.amazonaws.internal.ListWithAutoConstructFlag<DataRetrievalRule>)(policy.getRules());
