...
public interface AmazonGlacier {
     ...
     * ("https://glacier.us-east-1.amazonaws.com"). Callers can use this method
     * to control which AWS region they want to work with.
     * <p>
     * Callers can pass in just the endpoint (ex:
     * "glacier.us-east-1.amazonaws.com") or a full URL, including the protocol
     * (ex: "https://glacier.us-east-1.amazonaws.com"). If the protocol is not
     ...
     *
     * @param endpoint
     *        The endpoint (ex: "glacier.us-east-1.amazonaws.com") or a full
     *        URL, including the protocol (ex:
     *        "https://glacier.us-east-1.amazonaws.com") of the region specific
     ...
     */
    AbortVaultLockResult abortVaultLock(
     ...
     */
    AddTagsToVaultResult addTagsToVault(
     ...
     */
    CompleteVaultLockResult completeVaultLock(
     ...
     */
    DeleteVaultAccessPolicyResult deleteVaultAccessPolicy(
     ...
     */
    DeleteVaultNotificationsResult deleteVaultNotifications(
     ...
     */
    GetDataRetrievalPolicyResult getDataRetrievalPolicy(
     ...
     */
    GetVaultAccessPolicyResult getVaultAccessPolicy(
     ...
     */
    GetVaultNotificationsResult getVaultNotifications(
     ...
     */
    InitiateVaultLockResult initiateVaultLock(
     ...
     */
    ListTagsForVaultResult listTagsForVault(
     ...
     */
    RemoveTagsFromVaultResult removeTagsFromVault(
     ...
     */
    SetDataRetrievalPolicyResult setDataRetrievalPolicy(
     ...
     */
    SetVaultAccessPolicyResult setVaultAccessPolicy(
     ...
     */
    SetVaultNotificationsResult setVaultNotifications(
