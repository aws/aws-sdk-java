...
public class DataRetrievalPolicyJsonMarshaller {
     ...
     */
    public void marshall(DataRetrievalPolicy dataRetrievalPolicy,
        ...
        try {
            ...
            java.util.List<DataRetrievalRule> rulesList = dataRetrievalPolicy
                    .getRules();
            if (rulesList != null) {
                ...
                for (DataRetrievalRule rulesListValue : rulesList) {
                    if (rulesListValue != null) {
                        ...
                        DataRetrievalRuleJsonMarshaller.getInstance().marshall(
