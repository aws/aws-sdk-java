 ...
 */
public class SetVaultAccessPolicyResultJsonUnmarshaller implements
        Unmarshaller<SetVaultAccessPolicyResult, JsonUnmarshallerContext> {

    public SetVaultAccessPolicyResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
