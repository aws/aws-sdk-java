...
public class ListMultipartUploadsRequestMarshaller
    ...
    public Request<ListMultipartUploadsRequest> marshall(
        ...
        Request<ListMultipartUploadsRequest> request = new DefaultRequest<ListMultipartUploadsRequest>(
                listMultipartUploadsRequest, "AmazonGlacier");
        ...
        uriResourcePath = uriResourcePath
                .replace(
                        "{accountId}",
                        (listMultipartUploadsRequest.getAccountId() != null) ? SdkHttpUtils
                                .urlEncode(StringUtils
                                        .fromString(listMultipartUploadsRequest
                                                .getAccountId()), false) : "");
        uriResourcePath = uriResourcePath
                .replace(
                        "{vaultName}",
                        (listMultipartUploadsRequest.getVaultName() != null) ? SdkHttpUtils
                                .urlEncode(StringUtils
                                        .fromString(listMultipartUploadsRequest
                                                .getVaultName()), false) : "");
        ...
        if (listMultipartUploadsRequest.getLimit() != null) {
            request.addParameter("limit", StringUtils
                    .fromString(listMultipartUploadsRequest.getLimit()));
        }

        if (listMultipartUploadsRequest.getUploadIdMarker() != null) {
            request.addParameter("marker",
                    StringUtils.fromString(listMultipartUploadsRequest
                            .getUploadIdMarker()));
        }
