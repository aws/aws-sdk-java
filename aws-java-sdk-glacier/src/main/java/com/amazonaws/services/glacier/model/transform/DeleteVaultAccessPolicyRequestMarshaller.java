...
public class DeleteVaultAccessPolicyRequestMarshaller
    ...
    public Request<DeleteVaultAccessPolicyRequest> marshall(
        ...
        Request<DeleteVaultAccessPolicyRequest> request = new DefaultRequest<DeleteVaultAccessPolicyRequest>(
                deleteVaultAccessPolicyRequest, "AmazonGlacier");
        ...
        uriResourcePath = uriResourcePath
                .replace(
                        ...
                        (deleteVaultAccessPolicyRequest.getAccountId() != null) ? SdkHttpUtils.urlEncode(
                                StringUtils
                                        .fromString(deleteVaultAccessPolicyRequest
                                                .getAccountId()), false)
                                : "");
        uriResourcePath = uriResourcePath
                .replace(
