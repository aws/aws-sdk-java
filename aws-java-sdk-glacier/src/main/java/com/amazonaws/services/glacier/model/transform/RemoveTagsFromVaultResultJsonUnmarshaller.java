 ...
 */
public class RemoveTagsFromVaultResultJsonUnmarshaller implements
        Unmarshaller<RemoveTagsFromVaultResult, JsonUnmarshallerContext> {

    public RemoveTagsFromVaultResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
