...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ValidationException validationException = new com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ValidationException(
                null);
