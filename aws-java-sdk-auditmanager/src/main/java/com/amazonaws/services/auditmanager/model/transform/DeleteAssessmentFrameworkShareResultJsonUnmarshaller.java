...
/**
 * DeleteAssessmentFrameworkShareResult JSON Unmarshaller
 */
...
public class DeleteAssessmentFrameworkShareResultJsonUnmarshaller implements Unmarshaller<DeleteAssessmentFrameworkShareResult, JsonUnmarshallerContext> {
    ...
    public DeleteAssessmentFrameworkShareResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAssessmentFrameworkShareResult deleteAssessmentFrameworkShareResult = new DeleteAssessmentFrameworkShareResult();
