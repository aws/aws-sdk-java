        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("awsAccounts", targetDepth)) {
                    context.nextToken();
                    scope.setAwsAccounts(new ListUnmarshaller<AWSAccount>(AWSAccountJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("awsServices", targetDepth)) {
                    context.nextToken();
                    scope.setAwsServices(new ListUnmarshaller<AWSService>(AWSServiceJsonUnmarshaller.getInstance())
