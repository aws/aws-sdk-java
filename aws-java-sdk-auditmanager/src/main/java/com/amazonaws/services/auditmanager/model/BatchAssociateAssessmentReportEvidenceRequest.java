...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/auditmanager-2017-07-25/BatchAssociateAssessmentReportEvidence"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchAssociateAssessmentReportEvidenceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public BatchAssociateAssessmentReportEvidenceRequest withEvidenceFolderId(String evidenceFolderId) {
    ...
    public BatchAssociateAssessmentReportEvidenceRequest withEvidenceIds(String... evidenceIds) {
    ...
    public BatchAssociateAssessmentReportEvidenceRequest withEvidenceIds(java.util.Collection<String> evidenceIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchAssociateAssessmentReportEvidenceRequest == false)
            return false;
    ...
    @Override
    public BatchAssociateAssessmentReportEvidenceRequest clone() {
        return (BatchAssociateAssessmentReportEvidenceRequest) super.clone();
    }
