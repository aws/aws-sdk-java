...
/**
 * ControlMappingSource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ControlMappingSourceJsonUnmarshaller implements Unmarshaller<ControlMappingSource, JsonUnmarshallerContext> {

    public ControlMappingSource unmarshall(JsonUnmarshallerContext context) throws Exception {
        ControlMappingSource controlMappingSource = new ControlMappingSource();
    ...
    private static ControlMappingSourceJsonUnmarshaller instance;

    public static ControlMappingSourceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ControlMappingSourceJsonUnmarshaller();
        return instance;
    }
}
