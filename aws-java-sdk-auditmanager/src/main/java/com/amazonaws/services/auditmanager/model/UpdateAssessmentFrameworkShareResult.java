...
public class UpdateAssessmentFrameworkShareResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAssessmentFrameworkShareResult == false)
            return false;
        UpdateAssessmentFrameworkShareResult other = (UpdateAssessmentFrameworkShareResult) obj;
        if (other.getAssessmentFrameworkShareRequest() == null ^ this.getAssessmentFrameworkShareRequest() == null)
            return false;
        if (other.getAssessmentFrameworkShareRequest() != null
                && other.getAssessmentFrameworkShareRequest().equals(this.getAssessmentFrameworkShareRequest()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getAssessmentFrameworkShareRequest() == null) ? 0 : getAssessmentFrameworkShareRequest().hashCode());
        return hashCode;
    }

    @Override
    public UpdateAssessmentFrameworkShareResult clone() {
        try {
