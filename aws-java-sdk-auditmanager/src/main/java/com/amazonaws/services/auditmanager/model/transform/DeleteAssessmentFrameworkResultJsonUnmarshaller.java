...
/**
 * DeleteAssessmentFrameworkResult JSON Unmarshaller
 */
...
public class DeleteAssessmentFrameworkResultJsonUnmarshaller implements Unmarshaller<DeleteAssessmentFrameworkResult, JsonUnmarshallerContext> {
    ...
    public DeleteAssessmentFrameworkResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAssessmentFrameworkResult deleteAssessmentFrameworkResult = new DeleteAssessmentFrameworkResult();
