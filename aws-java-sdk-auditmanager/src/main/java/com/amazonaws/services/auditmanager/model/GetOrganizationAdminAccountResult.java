...
public class GetOrganizationAdminAccountResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetOrganizationAdminAccountResult == false)
            return false;
        GetOrganizationAdminAccountResult other = (GetOrganizationAdminAccountResult) obj;
    ...
    public GetOrganizationAdminAccountResult clone() {
        try {
            return (GetOrganizationAdminAccountResult) super.clone();
