...
/**
 * UpdateAssessmentControlRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateAssessmentControlRequestMarshaller {
    ...
    private static final UpdateAssessmentControlRequestMarshaller instance = new UpdateAssessmentControlRequestMarshaller();

    public static UpdateAssessmentControlRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateAssessmentControlRequest updateAssessmentControlRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateAssessmentControlRequest.getAssessmentId(), ASSESSMENTID_BINDING);
            protocolMarshaller.marshall(updateAssessmentControlRequest.getControlSetId(), CONTROLSETID_BINDING);
            protocolMarshaller.marshall(updateAssessmentControlRequest.getControlId(), CONTROLID_BINDING);
            protocolMarshaller.marshall(updateAssessmentControlRequest.getControlStatus(), CONTROLSTATUS_BINDING);
            protocolMarshaller.marshall(updateAssessmentControlRequest.getCommentBody(), COMMENTBODY_BINDING);
        } catch (Exception e) {
