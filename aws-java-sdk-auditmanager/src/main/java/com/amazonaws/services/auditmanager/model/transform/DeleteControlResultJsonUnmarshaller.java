...
/**
 * DeleteControlResult JSON Unmarshaller
 */
...
public class DeleteControlResultJsonUnmarshaller implements Unmarshaller<DeleteControlResult, JsonUnmarshallerContext> {
    ...
    public DeleteControlResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteControlResult deleteControlResult = new DeleteControlResult();
