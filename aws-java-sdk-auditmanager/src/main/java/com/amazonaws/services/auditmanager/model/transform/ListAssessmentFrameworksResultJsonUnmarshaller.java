...
/**
 * ListAssessmentFrameworksResult JSON Unmarshaller
 */
...
public class ListAssessmentFrameworksResultJsonUnmarshaller implements Unmarshaller<ListAssessmentFrameworksResult, JsonUnmarshallerContext> {
    ...
    public ListAssessmentFrameworksResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("frameworkMetadataList", targetDepth)) {
                    context.nextToken();
                    listAssessmentFrameworksResult.setFrameworkMetadataList(new ListUnmarshaller<AssessmentFrameworkMetadata>(
                            AssessmentFrameworkMetadataJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listAssessmentFrameworksResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
