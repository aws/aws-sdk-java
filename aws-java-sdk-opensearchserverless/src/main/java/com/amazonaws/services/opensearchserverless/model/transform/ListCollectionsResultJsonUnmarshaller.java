...
/**
 * ListCollectionsResult JSON Unmarshaller
 */
...
public class ListCollectionsResultJsonUnmarshaller implements Unmarshaller<ListCollectionsResult, JsonUnmarshallerContext> {
    ...
    public ListCollectionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("collectionSummaries", targetDepth)) {
                    context.nextToken();
                    listCollectionsResult.setCollectionSummaries(new ListUnmarshaller<CollectionSummary>(CollectionSummaryJsonUnmarshaller.getInstance())
