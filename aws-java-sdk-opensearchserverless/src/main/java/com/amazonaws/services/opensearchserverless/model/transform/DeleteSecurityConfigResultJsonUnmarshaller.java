...
/**
 * DeleteSecurityConfigResult JSON Unmarshaller
 */
...
public class DeleteSecurityConfigResultJsonUnmarshaller implements Unmarshaller<DeleteSecurityConfigResult, JsonUnmarshallerContext> {
    ...
    public DeleteSecurityConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSecurityConfigResult deleteSecurityConfigResult = new DeleteSecurityConfigResult();
