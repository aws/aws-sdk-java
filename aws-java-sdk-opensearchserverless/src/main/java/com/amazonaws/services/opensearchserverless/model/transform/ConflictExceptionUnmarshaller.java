...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.opensearchserverless.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.opensearchserverless.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.opensearchserverless.model.ConflictException conflictException = new com.amazonaws.services.opensearchserverless.model.ConflictException(
                null);
