...
public class UpdateAccessPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateAccessPolicyResult withAccessPolicyDetail(AccessPolicyDetail accessPolicyDetail) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAccessPolicyResult == false)
            return false;
        UpdateAccessPolicyResult other = (UpdateAccessPolicyResult) obj;
    ...
    @Override
    public UpdateAccessPolicyResult clone() {
        try {
            return (UpdateAccessPolicyResult) super.clone();
