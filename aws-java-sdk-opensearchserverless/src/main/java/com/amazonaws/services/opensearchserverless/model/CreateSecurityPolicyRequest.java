...
public class CreateSecurityPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The JSON policy document to use as the content for the new policy.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSecurityPolicyRequest == false)
            return false;
        CreateSecurityPolicyRequest other = (CreateSecurityPolicyRequest) obj;
    ...
    public CreateSecurityPolicyRequest clone() {
        return (CreateSecurityPolicyRequest) super.clone();
    }
