...
public class DeleteCollectionRequestMarshaller {
    ...
    public void marshall(DeleteCollectionRequest deleteCollectionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteCollectionRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(deleteCollectionRequest.getId(), ID_BINDING);
        } catch (Exception e) {
