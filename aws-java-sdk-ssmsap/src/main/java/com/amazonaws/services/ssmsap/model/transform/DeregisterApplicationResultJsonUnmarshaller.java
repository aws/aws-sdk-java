...
/**
 * DeregisterApplicationResult JSON Unmarshaller
 */
...
public class DeregisterApplicationResultJsonUnmarshaller implements Unmarshaller<DeregisterApplicationResult, JsonUnmarshallerContext> {
    ...
    public DeregisterApplicationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterApplicationResult deregisterApplicationResult = new DeregisterApplicationResult();
