...
/**
 * StartApplicationResult JSON Unmarshaller
 */
...
public class StartApplicationResultJsonUnmarshaller implements Unmarshaller<StartApplicationResult, JsonUnmarshallerContext> {
    ...
    public StartApplicationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartApplicationResult startApplicationResult = new StartApplicationResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("OperationId", targetDepth)) {
                    context.nextToken();
                    startApplicationResult.setOperationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
