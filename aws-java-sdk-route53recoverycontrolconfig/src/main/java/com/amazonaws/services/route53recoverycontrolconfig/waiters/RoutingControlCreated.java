...
class RoutingControlCreated {
    ...
    static class IsDEPLOYEDMatcher extends WaiterAcceptor<DescribeRoutingControlResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("RoutingControl"), new JmesPathField("Status"));
         ...
         */
        @Override
        public boolean matches(DescribeRoutingControlResult result) {
    ...
    static class IsPENDINGMatcher extends WaiterAcceptor<DescribeRoutingControlResult> {
        private static final JsonNode expectedResult;
