        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ASSERTION", targetDepth)) {
                    context.nextToken();
                    rule.setASSERTION(AssertionRuleJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("GATING", targetDepth)) {
                    context.nextToken();
                    rule.setGATING(GatingRuleJsonUnmarshaller.getInstance().unmarshall(context));
                }
