...
class ControlPanelCreated {
    ...
    static class IsDEPLOYEDMatcher extends WaiterAcceptor<DescribeControlPanelResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("ControlPanel"), new JmesPathField("Status"));
         ...
         */
        @Override
        public boolean matches(DescribeControlPanelResult result) {
    ...
    static class IsPENDINGMatcher extends WaiterAcceptor<DescribeControlPanelResult> {
        private static final JsonNode expectedResult;
