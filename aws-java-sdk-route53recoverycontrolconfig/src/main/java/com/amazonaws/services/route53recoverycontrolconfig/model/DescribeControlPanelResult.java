...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/route53-recovery-control-config-2020-11-02/DescribeControlPanel"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeControlPanelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeControlPanelResult == false)
            return false;
        DescribeControlPanelResult other = (DescribeControlPanelResult) obj;
    ...
    public DescribeControlPanelResult clone() {
        try {
            return (DescribeControlPanelResult) super.clone();
