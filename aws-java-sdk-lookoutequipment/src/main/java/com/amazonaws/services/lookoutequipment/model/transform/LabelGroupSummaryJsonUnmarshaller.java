...
/**
 * LabelGroupSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LabelGroupSummaryJsonUnmarshaller implements Unmarshaller<LabelGroupSummary, JsonUnmarshallerContext> {

    public LabelGroupSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        LabelGroupSummary labelGroupSummary = new LabelGroupSummary();
    ...
    private static LabelGroupSummaryJsonUnmarshaller instance;

    public static LabelGroupSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LabelGroupSummaryJsonUnmarshaller();
        return instance;
    }
}
