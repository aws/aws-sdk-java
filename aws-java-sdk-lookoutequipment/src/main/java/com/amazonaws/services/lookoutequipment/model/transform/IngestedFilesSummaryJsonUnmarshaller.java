...
/**
 * IngestedFilesSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IngestedFilesSummaryJsonUnmarshaller implements Unmarshaller<IngestedFilesSummary, JsonUnmarshallerContext> {

    public IngestedFilesSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        IngestedFilesSummary ingestedFilesSummary = new IngestedFilesSummary();
    ...
    private static IngestedFilesSummaryJsonUnmarshaller instance;

    public static IngestedFilesSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new IngestedFilesSummaryJsonUnmarshaller();
        return instance;
    }
}
