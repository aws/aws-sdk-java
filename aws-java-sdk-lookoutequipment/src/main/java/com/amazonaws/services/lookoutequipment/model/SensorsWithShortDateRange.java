 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/lookoutequipment-2020-12-15/SensorsWithShortDateRange"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SensorsWithShortDateRange implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SensorsWithShortDateRange == false)
            return false;
        SensorsWithShortDateRange other = (SensorsWithShortDateRange) obj;
    ...
    public SensorsWithShortDateRange clone() {
        try {
            return (SensorsWithShortDateRange) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lookoutequipment.model.transform.SensorsWithShortDateRangeMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
