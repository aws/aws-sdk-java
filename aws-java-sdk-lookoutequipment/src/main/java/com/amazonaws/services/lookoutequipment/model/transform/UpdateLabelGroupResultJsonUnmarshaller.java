...
/**
 * UpdateLabelGroupResult JSON Unmarshaller
 */
...
public class UpdateLabelGroupResultJsonUnmarshaller implements Unmarshaller<UpdateLabelGroupResult, JsonUnmarshallerContext> {
    ...
    public UpdateLabelGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateLabelGroupResult updateLabelGroupResult = new UpdateLabelGroupResult();

        return updateLabelGroupResult;
    }
