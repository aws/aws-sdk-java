...
public class GetFarmResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetFarmResult withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The farm ID of the farm to get.
     */
     ...
     * </p>
     * 
     * @return The ARN of the KMS key used on the farm.
     */
    ...
    public GetFarmResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetFarmResult == false)
            return false;
        GetFarmResult other = (GetFarmResult) obj;
    ...
    public GetFarmResult clone() {
        try {
            return (GetFarmResult) super.clone();
