...
/**
 * UpdateSessionResult JSON Unmarshaller
 */
...
public class UpdateSessionResultJsonUnmarshaller implements Unmarshaller<UpdateSessionResult, JsonUnmarshallerContext> {
    ...
    public UpdateSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateSessionResult updateSessionResult = new UpdateSessionResult();
