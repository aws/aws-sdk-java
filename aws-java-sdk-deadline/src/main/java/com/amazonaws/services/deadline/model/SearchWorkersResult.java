...
public class SearchWorkersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<WorkerSearchSummary> workers;
    ...
    public java.util.List<WorkerSearchSummary> getWorkers() {
        return workers;
    }
    ...
    public void setWorkers(java.util.Collection<WorkerSearchSummary> workers) {
        if (workers == null) {
            this.workers = null;
            return;
        }

        this.workers = new java.util.ArrayList<WorkerSearchSummary>(workers);
    }
    ...
    public SearchWorkersResult withWorkers(WorkerSearchSummary... workers) {
        if (this.workers == null) {
            setWorkers(new java.util.ArrayList<WorkerSearchSummary>(workers.length));
        }
    ...
    public SearchWorkersResult withWorkers(java.util.Collection<WorkerSearchSummary> workers) {
        setWorkers(workers);
        return this;
    }
