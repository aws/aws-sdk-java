...
public class ListQueuesRequestMarshaller {
    ...
    public void marshall(ListQueuesRequest listQueuesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listQueuesRequest.getFarmId(), FARMID_BINDING);
            ...
            protocolMarshaller.marshall(listQueuesRequest.getPrincipalId(), PRINCIPALID_BINDING);
            protocolMarshaller.marshall(listQueuesRequest.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
