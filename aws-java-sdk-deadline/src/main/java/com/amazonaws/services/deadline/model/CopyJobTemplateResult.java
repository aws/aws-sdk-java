...
public class CopyJobTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CopyJobTemplateResult == false)
            return false;
        CopyJobTemplateResult other = (CopyJobTemplateResult) obj;
    ...
    public CopyJobTemplateResult clone() {
        try {
            return (CopyJobTemplateResult) super.clone();
