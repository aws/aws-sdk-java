...
class QueueScheduling {
    ...
    static class IsSCHEDULINGMatcher extends WaiterAcceptor<GetQueueResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"SCHEDULING\"");
         ...
         */
        @Override
        public boolean matches(GetQueueResult result) {
