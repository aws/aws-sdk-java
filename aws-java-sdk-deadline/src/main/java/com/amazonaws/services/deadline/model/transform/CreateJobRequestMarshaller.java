...
public class CreateJobRequestMarshaller {
    ...
    public void marshall(CreateJobRequest createJobRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createJobRequest.getAttachments(), ATTACHMENTS_BINDING);
            protocolMarshaller.marshall(createJobRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createJobRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(createJobRequest.getMaxFailedTasksCount(), MAXFAILEDTASKSCOUNT_BINDING);
            protocolMarshaller.marshall(createJobRequest.getMaxRetriesPerTask(), MAXRETRIESPERTASK_BINDING);
            protocolMarshaller.marshall(createJobRequest.getParameters(), PARAMETERS_BINDING);
            protocolMarshaller.marshall(createJobRequest.getPriority(), PRIORITY_BINDING);
            protocolMarshaller.marshall(createJobRequest.getQueueId(), QUEUEID_BINDING);
            protocolMarshaller.marshall(createJobRequest.getStorageProfileId(), STORAGEPROFILEID_BINDING);
            protocolMarshaller.marshall(createJobRequest.getTargetTaskRunStatus(), TARGETTASKRUNSTATUS_BINDING);
            protocolMarshaller.marshall(createJobRequest.getTemplate(), TEMPLATE_BINDING);
            protocolMarshaller.marshall(createJobRequest.getTemplateType(), TEMPLATETYPE_BINDING);
        } catch (Exception e) {
