 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/WorkerSummary" target="_top">AWS API
 *      Documentation</a>
 */
...
public class WorkerSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public WorkerSummary withCreatedAt(java.util.Date createdAt) {
    ...
    public WorkerSummary withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WorkerSummary == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.deadline.model.transform.WorkerSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
