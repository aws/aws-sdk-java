...
/**
 * UpdateFarmResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateFarmResultJsonUnmarshaller implements Unmarshaller<UpdateFarmResult, JsonUnmarshallerContext> {

    public UpdateFarmResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateFarmResult updateFarmResult = new UpdateFarmResult();
