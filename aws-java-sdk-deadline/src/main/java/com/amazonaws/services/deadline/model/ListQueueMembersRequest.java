...
public class ListQueueMembersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListQueueMembersRequest withFarmId(String farmId) {
        setFarmId(farmId);
        return this;
    }
    ...
    public ListQueueMembersRequest withMaxResults(Integer maxResults) {
    ...
    public ListQueueMembersRequest withNextToken(String nextToken) {
    ...
    public ListQueueMembersRequest withQueueId(String queueId) {
        setQueueId(queueId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListQueueMembersRequest == false)
            return false;
        ListQueueMembersRequest other = (ListQueueMembersRequest) obj;
    ...
    @Override
    public ListQueueMembersRequest clone() {
        return (ListQueueMembersRequest) super.clone();
    }
