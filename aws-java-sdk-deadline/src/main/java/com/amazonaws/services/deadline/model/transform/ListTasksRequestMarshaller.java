...
public class ListTasksRequestMarshaller {
    ...
    public void marshall(ListTasksRequest listTasksRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listTasksRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(listTasksRequest.getJobId(), JOBID_BINDING);
            ...
            protocolMarshaller.marshall(listTasksRequest.getQueueId(), QUEUEID_BINDING);
            protocolMarshaller.marshall(listTasksRequest.getStepId(), STEPID_BINDING);
        } catch (Exception e) {
