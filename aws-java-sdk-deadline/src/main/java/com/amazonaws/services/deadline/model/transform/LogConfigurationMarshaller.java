...
@SdkInternalApi
public class LogConfigurationMarshaller {
    ...
    private static final LogConfigurationMarshaller instance = new LogConfigurationMarshaller();

    public static LogConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LogConfiguration logConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(logConfiguration.getError(), ERROR_BINDING);
            protocolMarshaller.marshall(logConfiguration.getLogDriver(), LOGDRIVER_BINDING);
            protocolMarshaller.marshall(logConfiguration.getOptions(), OPTIONS_BINDING);
            protocolMarshaller.marshall(logConfiguration.getParameters(), PARAMETERS_BINDING);
        } catch (Exception e) {
