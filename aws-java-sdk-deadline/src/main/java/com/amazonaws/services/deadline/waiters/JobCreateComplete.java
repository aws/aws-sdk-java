...
class JobCreateComplete {
    ...
    static class IsCREATE_COMPLETEMatcher extends WaiterAcceptor<GetJobResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("lifecycleStatus");
         ...
         */
        @Override
        public boolean matches(GetJobResult result) {
    ...
    static class IsUPDATE_IN_PROGRESSMatcher extends WaiterAcceptor<GetJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATE_FAILEDMatcher extends WaiterAcceptor<GetJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATE_SUCCEEDEDMatcher extends WaiterAcceptor<GetJobResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"UPDATE_SUCCEEDED\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsUPLOAD_FAILEDMatcher extends WaiterAcceptor<GetJobResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"UPLOAD_FAILED\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<GetJobResult> {
        private static final JsonNode expectedResult;
