...
/**
 * UpdateQueueFleetAssociationResult JSON Unmarshaller
 */
...
public class UpdateQueueFleetAssociationResultJsonUnmarshaller implements Unmarshaller<UpdateQueueFleetAssociationResult, JsonUnmarshallerContext> {
    ...
    public UpdateQueueFleetAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateQueueFleetAssociationResult updateQueueFleetAssociationResult = new UpdateQueueFleetAssociationResult();
