...
public class ListFarmMembersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListFarmMembersRequest withFarmId(String farmId) {
        setFarmId(farmId);
        return this;
    }
    ...
    public ListFarmMembersRequest withMaxResults(Integer maxResults) {
    ...
    public ListFarmMembersRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFarmMembersRequest == false)
            return false;
        ListFarmMembersRequest other = (ListFarmMembersRequest) obj;
    ...
    @Override
    public ListFarmMembersRequest clone() {
        return (ListFarmMembersRequest) super.clone();
    }
