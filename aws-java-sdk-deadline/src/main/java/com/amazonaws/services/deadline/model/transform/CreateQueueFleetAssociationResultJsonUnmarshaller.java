...
/**
 * CreateQueueFleetAssociationResult JSON Unmarshaller
 */
...
public class CreateQueueFleetAssociationResultJsonUnmarshaller implements Unmarshaller<CreateQueueFleetAssociationResult, JsonUnmarshallerContext> {
    ...
    public CreateQueueFleetAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateQueueFleetAssociationResult createQueueFleetAssociationResult = new CreateQueueFleetAssociationResult();
