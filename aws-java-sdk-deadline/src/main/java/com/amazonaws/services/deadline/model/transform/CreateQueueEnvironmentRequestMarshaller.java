...
public class CreateQueueEnvironmentRequestMarshaller {
    ...
    private static final CreateQueueEnvironmentRequestMarshaller instance = new CreateQueueEnvironmentRequestMarshaller();

    public static CreateQueueEnvironmentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateQueueEnvironmentRequest createQueueEnvironmentRequest, ProtocolMarshaller protocolMarshaller) {

        if (createQueueEnvironmentRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createQueueEnvironmentRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createQueueEnvironmentRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(createQueueEnvironmentRequest.getPriority(), PRIORITY_BINDING);
            protocolMarshaller.marshall(createQueueEnvironmentRequest.getQueueId(), QUEUEID_BINDING);
            protocolMarshaller.marshall(createQueueEnvironmentRequest.getTemplate(), TEMPLATE_BINDING);
            protocolMarshaller.marshall(createQueueEnvironmentRequest.getTemplateType(), TEMPLATETYPE_BINDING);
        } catch (Exception e) {
