...
public class UpdateMonitorRequestMarshaller {
    ...
    public void marshall(UpdateMonitorRequest updateMonitorRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateMonitorRequest.getDisplayName(), DISPLAYNAME_BINDING);
            protocolMarshaller.marshall(updateMonitorRequest.getMonitorId(), MONITORID_BINDING);
            protocolMarshaller.marshall(updateMonitorRequest.getRoleArn(), ROLEARN_BINDING);
            protocolMarshaller.marshall(updateMonitorRequest.getSubdomain(), SUBDOMAIN_BINDING);
        } catch (Exception e) {
