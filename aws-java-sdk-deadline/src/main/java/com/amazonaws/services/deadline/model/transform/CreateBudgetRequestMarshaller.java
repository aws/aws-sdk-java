...
public class CreateBudgetRequestMarshaller {
    ...
    public void marshall(CreateBudgetRequest createBudgetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createBudgetRequest.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(createBudgetRequest.getApproximateDollarLimit(), APPROXIMATEDOLLARLIMIT_BINDING);
            protocolMarshaller.marshall(createBudgetRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createBudgetRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(createBudgetRequest.getDisplayName(), DISPLAYNAME_BINDING);
            protocolMarshaller.marshall(createBudgetRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(createBudgetRequest.getSchedule(), SCHEDULE_BINDING);
            protocolMarshaller.marshall(createBudgetRequest.getUsageTrackingResource(), USAGETRACKINGRESOURCE_BINDING);
        } catch (Exception e) {
