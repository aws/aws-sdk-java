 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/JobMember" target="_top">AWS API
 *      Documentation</a>
 */
...
public class JobMember implements Serializable, Cloneable, StructuredPojo {
    ...
    public JobMember withFarmId(String farmId) {
        setFarmId(farmId);
        return this;
    }
    ...
    public JobMember withIdentityStoreId(String identityStoreId) {
    ...
    public JobMember withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
     ...
     * </p>
     * 
     * @return The job member's membership level.
     * @see MembershipLevel
     */
    ...
    public JobMember withMembershipLevel(String membershipLevel) {
     ...
     * </p>
     * 
     * @return The principal ID of the job member.
     */
    ...
    public JobMember withPrincipalId(String principalId) {
     ...
     * </p>
     * 
     * @return The principal type of the job member.
     * @see PrincipalType
     */
    ...
    public JobMember withPrincipalType(String principalType) {
    ...
    public JobMember withQueueId(String queueId) {
        setQueueId(queueId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof JobMember == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.deadline.model.transform.JobMemberMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
