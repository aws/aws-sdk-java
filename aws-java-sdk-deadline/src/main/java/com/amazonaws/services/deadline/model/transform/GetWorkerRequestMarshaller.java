...
public class GetWorkerRequestMarshaller {
    ...
    public void marshall(GetWorkerRequest getWorkerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getWorkerRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(getWorkerRequest.getFleetId(), FLEETID_BINDING);
            protocolMarshaller.marshall(getWorkerRequest.getWorkerId(), WORKERID_BINDING);
        } catch (Exception e) {
