...
/**
 * AssociateMemberToJobRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssociateMemberToJobRequestMarshaller {
    ...
    private static final AssociateMemberToJobRequestMarshaller instance = new AssociateMemberToJobRequestMarshaller();

    public static AssociateMemberToJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssociateMemberToJobRequest associateMemberToJobRequest, ProtocolMarshaller protocolMarshaller) {

        if (associateMemberToJobRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(associateMemberToJobRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(associateMemberToJobRequest.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(associateMemberToJobRequest.getJobId(), JOBID_BINDING);
            protocolMarshaller.marshall(associateMemberToJobRequest.getMembershipLevel(), MEMBERSHIPLEVEL_BINDING);
            protocolMarshaller.marshall(associateMemberToJobRequest.getPrincipalId(), PRINCIPALID_BINDING);
            protocolMarshaller.marshall(associateMemberToJobRequest.getPrincipalType(), PRINCIPALTYPE_BINDING);
            protocolMarshaller.marshall(associateMemberToJobRequest.getQueueId(), QUEUEID_BINDING);
        } catch (Exception e) {
