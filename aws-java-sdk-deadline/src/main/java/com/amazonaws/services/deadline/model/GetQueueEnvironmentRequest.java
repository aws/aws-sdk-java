...
public class GetQueueEnvironmentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The farm ID for the queue environment.
     */
    ...
    public GetQueueEnvironmentRequest withFarmId(String farmId) {
        setFarmId(farmId);
        return this;
    }
    ...
    public GetQueueEnvironmentRequest withQueueEnvironmentId(String queueEnvironmentId) {
     ...
     * </p>
     * 
     * @return The queue ID for the queue environment.
     */
    ...
    public GetQueueEnvironmentRequest withQueueId(String queueId) {
        setQueueId(queueId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetQueueEnvironmentRequest == false)
            return false;
        GetQueueEnvironmentRequest other = (GetQueueEnvironmentRequest) obj;
    ...
    @Override
    public GetQueueEnvironmentRequest clone() {
        return (GetQueueEnvironmentRequest) super.clone();
    }
