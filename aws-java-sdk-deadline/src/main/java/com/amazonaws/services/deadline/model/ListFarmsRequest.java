...
public class ListFarmsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListFarmsRequest withMaxResults(Integer maxResults) {
    ...
    public ListFarmsRequest withNextToken(String nextToken) {
     ...
     * </p>
     * 
     * @return The principal ID of the member to list on the farm.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFarmsRequest == false)
            return false;
        ListFarmsRequest other = (ListFarmsRequest) obj;
    ...
    @Override
    public ListFarmsRequest clone() {
        return (ListFarmsRequest) super.clone();
    }
