...
public class ListQueueMembersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<QueueMember> members;
    /**
     * <p>
    ...
    public java.util.List<QueueMember> getMembers() {
        return members;
    }
    ...
    public void setMembers(java.util.Collection<QueueMember> members) {
        if (members == null) {
            this.members = null;
            return;
        }

        this.members = new java.util.ArrayList<QueueMember>(members);
    }
    ...
    public ListQueueMembersResult withMembers(QueueMember... members) {
        if (this.members == null) {
            setMembers(new java.util.ArrayList<QueueMember>(members.length));
        }
        for (QueueMember ele : members) {
    ...
    public ListQueueMembersResult withMembers(java.util.Collection<QueueMember> members) {
        setMembers(members);
        return this;
    }
    ...
    public ListQueueMembersResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListQueueMembersResult == false)
            return false;
        ListQueueMembersResult other = (ListQueueMembersResult) obj;
    ...
    @Override
    public ListQueueMembersResult clone() {
        try {
            return (ListQueueMembersResult) super.clone();
