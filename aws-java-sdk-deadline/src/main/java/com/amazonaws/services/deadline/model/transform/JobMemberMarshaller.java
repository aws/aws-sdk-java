...
@SdkInternalApi
public class JobMemberMarshaller {
    ...
    private static final JobMemberMarshaller instance = new JobMemberMarshaller();

    public static JobMemberMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(JobMember jobMember, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(jobMember.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(jobMember.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(jobMember.getJobId(), JOBID_BINDING);
            protocolMarshaller.marshall(jobMember.getMembershipLevel(), MEMBERSHIPLEVEL_BINDING);
            protocolMarshaller.marshall(jobMember.getPrincipalId(), PRINCIPALID_BINDING);
            protocolMarshaller.marshall(jobMember.getPrincipalType(), PRINCIPALTYPE_BINDING);
            protocolMarshaller.marshall(jobMember.getQueueId(), QUEUEID_BINDING);
        } catch (Exception e) {
