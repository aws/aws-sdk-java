...
public class GetBudgetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetBudgetRequest withBudgetId(String budgetId) {
    ...
    public GetBudgetRequest withFarmId(String farmId) {
        setFarmId(farmId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetBudgetRequest == false)
            return false;
    ...
    public GetBudgetRequest clone() {
        return (GetBudgetRequest) super.clone();
    }
