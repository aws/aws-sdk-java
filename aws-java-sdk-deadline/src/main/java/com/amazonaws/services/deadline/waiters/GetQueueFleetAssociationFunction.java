...
public class GetQueueFleetAssociationFunction implements SdkFunction<GetQueueFleetAssociationRequest, GetQueueFleetAssociationResult> {
    ...
    /**
     * Constructs a new GetQueueFleetAssociationFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetQueueFleetAssociationFunction(AWSDeadline client) {
        this.client = client;
    }
    ...
    public GetQueueFleetAssociationResult apply(GetQueueFleetAssociationRequest getQueueFleetAssociationRequest) {
        return client.getQueueFleetAssociation(getQueueFleetAssociationRequest);
    }
}
