...
public class ServiceQuotaExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceQuotaExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.deadline.model.ServiceQuotaExceededException.class, "ServiceQuotaExceededException");
    }

    @Override
    public com.amazonaws.services.deadline.model.ServiceQuotaExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.deadline.model.ServiceQuotaExceededException serviceQuotaExceededException = new com.amazonaws.services.deadline.model.ServiceQuotaExceededException(
                null);
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("context", targetDepth)) {
                    context.nextToken();
                    serviceQuotaExceededException.setContext(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
                ...
                if (context.testExpression("reason", targetDepth)) {
                    context.nextToken();
                    serviceQuotaExceededException.setReason(context.getUnmarshaller(String.class).unmarshall(context));
                }
