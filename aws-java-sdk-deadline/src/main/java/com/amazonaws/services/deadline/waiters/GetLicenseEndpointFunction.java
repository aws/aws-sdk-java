...
public class GetLicenseEndpointFunction implements SdkFunction<GetLicenseEndpointRequest, GetLicenseEndpointResult> {
    ...
    /**
     * Constructs a new GetLicenseEndpointFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetLicenseEndpointFunction(AWSDeadline client) {
        this.client = client;
    }
    ...
    public GetLicenseEndpointResult apply(GetLicenseEndpointRequest getLicenseEndpointRequest) {
        return client.getLicenseEndpoint(getLicenseEndpointRequest);
    }
}
