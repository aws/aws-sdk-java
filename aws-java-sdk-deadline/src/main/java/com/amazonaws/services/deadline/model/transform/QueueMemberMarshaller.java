...
/**
 * QueueMemberMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class QueueMemberMarshaller {
    ...
    private static final QueueMemberMarshaller instance = new QueueMemberMarshaller();

    public static QueueMemberMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(QueueMember queueMember, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(queueMember.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(queueMember.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(queueMember.getMembershipLevel(), MEMBERSHIPLEVEL_BINDING);
            protocolMarshaller.marshall(queueMember.getPrincipalId(), PRINCIPALID_BINDING);
            protocolMarshaller.marshall(queueMember.getPrincipalType(), PRINCIPALTYPE_BINDING);
            protocolMarshaller.marshall(queueMember.getQueueId(), QUEUEID_BINDING);
        } catch (Exception e) {
