...
/**
 * UpdateQueueResult JSON Unmarshaller
 */
...
public class UpdateQueueResultJsonUnmarshaller implements Unmarshaller<UpdateQueueResult, JsonUnmarshallerContext> {
    ...
    public UpdateQueueResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateQueueResult updateQueueResult = new UpdateQueueResult();
