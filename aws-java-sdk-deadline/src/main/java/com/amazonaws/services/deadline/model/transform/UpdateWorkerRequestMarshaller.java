...
public class UpdateWorkerRequestMarshaller {
    ...
    public void marshall(UpdateWorkerRequest updateWorkerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateWorkerRequest.getCapabilities(), CAPABILITIES_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getFleetId(), FLEETID_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getHostProperties(), HOSTPROPERTIES_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(updateWorkerRequest.getWorkerId(), WORKERID_BINDING);
        } catch (Exception e) {
