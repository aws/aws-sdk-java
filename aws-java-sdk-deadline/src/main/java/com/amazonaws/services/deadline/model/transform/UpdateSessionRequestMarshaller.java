...
/**
 * UpdateSessionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateSessionRequestMarshaller {
    ...
    private static final UpdateSessionRequestMarshaller instance = new UpdateSessionRequestMarshaller();

    public static UpdateSessionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateSessionRequest updateSessionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateSessionRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(updateSessionRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(updateSessionRequest.getJobId(), JOBID_BINDING);
            protocolMarshaller.marshall(updateSessionRequest.getQueueId(), QUEUEID_BINDING);
            protocolMarshaller.marshall(updateSessionRequest.getSessionId(), SESSIONID_BINDING);
            protocolMarshaller.marshall(updateSessionRequest.getTargetLifecycleStatus(), TARGETLIFECYCLESTATUS_BINDING);
        } catch (Exception e) {
