...
public class ListStepsRequestMarshaller {
    ...
    public void marshall(ListStepsRequest listStepsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listStepsRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(listStepsRequest.getJobId(), JOBID_BINDING);
            protocolMarshaller.marshall(listStepsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listStepsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listStepsRequest.getQueueId(), QUEUEID_BINDING);
        } catch (Exception e) {
