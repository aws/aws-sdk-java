...
public class ListJobMembersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<JobMember> members;
    /**
     * <p>
    ...
    public java.util.List<JobMember> getMembers() {
        return members;
    }
    ...
    public void setMembers(java.util.Collection<JobMember> members) {
        if (members == null) {
            this.members = null;
            return;
        }

        this.members = new java.util.ArrayList<JobMember>(members);
    }
    ...
    public ListJobMembersResult withMembers(JobMember... members) {
        if (this.members == null) {
            setMembers(new java.util.ArrayList<JobMember>(members.length));
        }
    ...
    public ListJobMembersResult withMembers(java.util.Collection<JobMember> members) {
        setMembers(members);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListJobMembersResult == false)
            return false;
