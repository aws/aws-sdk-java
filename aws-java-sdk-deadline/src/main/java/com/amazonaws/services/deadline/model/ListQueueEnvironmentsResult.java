...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListQueueEnvironments" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListQueueEnvironmentsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<QueueEnvironmentSummary> environments;
    /**
     * <p>
    ...
    public java.util.List<QueueEnvironmentSummary> getEnvironments() {
        return environments;
    }
    ...
    public void setEnvironments(java.util.Collection<QueueEnvironmentSummary> environments) {
        if (environments == null) {
            this.environments = null;
            return;
        }

        this.environments = new java.util.ArrayList<QueueEnvironmentSummary>(environments);
    }
    ...
    public ListQueueEnvironmentsResult withEnvironments(QueueEnvironmentSummary... environments) {
        if (this.environments == null) {
            setEnvironments(new java.util.ArrayList<QueueEnvironmentSummary>(environments.length));
        }
        for (QueueEnvironmentSummary ele : environments) {
    ...
    public ListQueueEnvironmentsResult withEnvironments(java.util.Collection<QueueEnvironmentSummary> environments) {
    ...
    public ListQueueEnvironmentsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListQueueEnvironmentsResult == false)
            return false;
        ListQueueEnvironmentsResult other = (ListQueueEnvironmentsResult) obj;
    ...
    public ListQueueEnvironmentsResult clone() {
        try {
            return (ListQueueEnvironmentsResult) super.clone();
