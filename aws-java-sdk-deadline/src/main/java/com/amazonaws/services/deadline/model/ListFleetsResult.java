...
public class ListFleetsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<FleetSummary> fleets;
    /**
     * <p>
    ...
    public java.util.List<FleetSummary> getFleets() {
        return fleets;
    }
    ...
    public void setFleets(java.util.Collection<FleetSummary> fleets) {
        if (fleets == null) {
            this.fleets = null;
            return;
        }

        this.fleets = new java.util.ArrayList<FleetSummary>(fleets);
    }
    ...
    public ListFleetsResult withFleets(FleetSummary... fleets) {
        if (this.fleets == null) {
            setFleets(new java.util.ArrayList<FleetSummary>(fleets.length));
        }
        for (FleetSummary ele : fleets) {
            this.fleets.add(ele);
        }
        return this;
    }
    ...
    public ListFleetsResult withFleets(java.util.Collection<FleetSummary> fleets) {
        setFleets(fleets);
        return this;
    }
