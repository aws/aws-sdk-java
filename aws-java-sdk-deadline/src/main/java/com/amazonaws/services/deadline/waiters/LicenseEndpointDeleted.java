...
class LicenseEndpointDeleted {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<GetLicenseEndpointResult> {
        /**
    ...
    static class IsNOT_READYMatcher extends WaiterAcceptor<GetLicenseEndpointResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"NOT_READY\"");
         ...
         */
        @Override
        public boolean matches(GetLicenseEndpointResult result) {
