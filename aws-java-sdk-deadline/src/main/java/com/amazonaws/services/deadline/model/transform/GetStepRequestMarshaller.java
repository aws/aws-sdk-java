...
/**
 * GetStepRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetStepRequestMarshaller {
    ...
    private static final GetStepRequestMarshaller instance = new GetStepRequestMarshaller();

    public static GetStepRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetStepRequest getStepRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getStepRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(getStepRequest.getJobId(), JOBID_BINDING);
            protocolMarshaller.marshall(getStepRequest.getQueueId(), QUEUEID_BINDING);
            protocolMarshaller.marshall(getStepRequest.getStepId(), STEPID_BINDING);
        } catch (Exception e) {
