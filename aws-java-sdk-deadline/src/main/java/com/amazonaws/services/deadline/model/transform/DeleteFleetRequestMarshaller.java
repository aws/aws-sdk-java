...
public class DeleteFleetRequestMarshaller {
    ...
    public void marshall(DeleteFleetRequest deleteFleetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteFleetRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(deleteFleetRequest.getFarmId(), FARMID_BINDING);
