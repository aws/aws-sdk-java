...
public class ListLicenseEndpointsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListLicenseEndpointsRequest withMaxResults(Integer maxResults) {
    ...
    public ListLicenseEndpointsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLicenseEndpointsRequest == false)
            return false;
        ListLicenseEndpointsRequest other = (ListLicenseEndpointsRequest) obj;
    ...
    @Override
    public ListLicenseEndpointsRequest clone() {
        return (ListLicenseEndpointsRequest) super.clone();
    }
