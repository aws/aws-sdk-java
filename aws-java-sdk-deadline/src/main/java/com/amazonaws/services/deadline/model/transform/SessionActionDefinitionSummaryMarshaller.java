...
/**
 * SessionActionDefinitionSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SessionActionDefinitionSummaryMarshaller {
    ...
    private static final SessionActionDefinitionSummaryMarshaller instance = new SessionActionDefinitionSummaryMarshaller();

    public static SessionActionDefinitionSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SessionActionDefinitionSummary sessionActionDefinitionSummary, ProtocolMarshaller protocolMarshaller) {

        if (sessionActionDefinitionSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(sessionActionDefinitionSummary.getEnvEnter(), ENVENTER_BINDING);
            protocolMarshaller.marshall(sessionActionDefinitionSummary.getEnvExit(), ENVEXIT_BINDING);
            protocolMarshaller.marshall(sessionActionDefinitionSummary.getSyncInputJobAttachments(), SYNCINPUTJOBATTACHMENTS_BINDING);
            protocolMarshaller.marshall(sessionActionDefinitionSummary.getTaskRun(), TASKRUN_BINDING);
        } catch (Exception e) {
