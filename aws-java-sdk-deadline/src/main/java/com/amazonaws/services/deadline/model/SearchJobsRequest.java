...
public class SearchJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public SearchJobsRequest withQueueIds(java.util.Collection<String> queueIds) {
    ...
    public SearchJobsRequest withSortExpressions(java.util.Collection<SearchSortExpression> sortExpressions) {
