...
/**
 * UpdateStepResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateStepResultJsonUnmarshaller implements Unmarshaller<UpdateStepResult, JsonUnmarshallerContext> {

    public UpdateStepResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateStepResult updateStepResult = new UpdateStepResult();
