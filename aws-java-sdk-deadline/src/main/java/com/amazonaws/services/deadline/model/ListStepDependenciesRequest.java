...
public class ListStepDependenciesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The farm ID for the step dependencies list.
     */
    ...
    public ListStepDependenciesRequest withFarmId(String farmId) {
        setFarmId(farmId);
        return this;
    }
     ...
     * </p>
     * 
     * @return The job ID for the step dependencies list.
     */
    ...
    public ListStepDependenciesRequest withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
    ...
    public ListStepDependenciesRequest withMaxResults(Integer maxResults) {
    ...
    public ListStepDependenciesRequest withNextToken(String nextToken) {
     ...
     * </p>
     * 
     * @return The queue ID for the step dependencies list.
     */
    ...
    public ListStepDependenciesRequest withQueueId(String queueId) {
        setQueueId(queueId);
        return this;
    }
    ...
    public ListStepDependenciesRequest withStepId(String stepId) {
        setStepId(stepId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListStepDependenciesRequest == false)
            return false;
        ListStepDependenciesRequest other = (ListStepDependenciesRequest) obj;
    ...
    @Override
    public ListStepDependenciesRequest clone() {
        return (ListStepDependenciesRequest) super.clone();
    }
