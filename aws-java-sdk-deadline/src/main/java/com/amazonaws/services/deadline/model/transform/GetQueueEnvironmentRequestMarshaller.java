...
public class GetQueueEnvironmentRequestMarshaller {
    ...
    private static final GetQueueEnvironmentRequestMarshaller instance = new GetQueueEnvironmentRequestMarshaller();

    public static GetQueueEnvironmentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetQueueEnvironmentRequest getQueueEnvironmentRequest, ProtocolMarshaller protocolMarshaller) {

        if (getQueueEnvironmentRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(getQueueEnvironmentRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(getQueueEnvironmentRequest.getQueueEnvironmentId(), QUEUEENVIRONMENTID_BINDING);
            protocolMarshaller.marshall(getQueueEnvironmentRequest.getQueueId(), QUEUEID_BINDING);
        } catch (Exception e) {
