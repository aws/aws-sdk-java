...
public class GetStorageProfileForQueueRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The farm ID for the queue in storage profile.
     */
     ...
     * </p>
     * 
     * @return The queue ID the queue in the storage profile.
     */
     ...
     * </p>
     * 
     * @return The storage profile ID for the storage profile in the queue.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetStorageProfileForQueueRequest == false)
            return false;
        GetStorageProfileForQueueRequest other = (GetStorageProfileForQueueRequest) obj;
    ...
    public GetStorageProfileForQueueRequest clone() {
        return (GetStorageProfileForQueueRequest) super.clone();
    }
