...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListSessionsForWorker" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSessionsForWorkerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<WorkerSessionSummary> sessions;
    ...
    public java.util.List<WorkerSessionSummary> getSessions() {
        return sessions;
    }
    ...
    public void setSessions(java.util.Collection<WorkerSessionSummary> sessions) {
        if (sessions == null) {
            this.sessions = null;
            return;
        }

        this.sessions = new java.util.ArrayList<WorkerSessionSummary>(sessions);
    }
    ...
    public ListSessionsForWorkerResult withSessions(WorkerSessionSummary... sessions) {
        if (this.sessions == null) {
            setSessions(new java.util.ArrayList<WorkerSessionSummary>(sessions.length));
        }
    ...
    public ListSessionsForWorkerResult withSessions(java.util.Collection<WorkerSessionSummary> sessions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSessionsForWorkerResult == false)
            return false;
