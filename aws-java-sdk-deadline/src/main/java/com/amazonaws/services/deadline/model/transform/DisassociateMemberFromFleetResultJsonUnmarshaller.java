...
/**
 * DisassociateMemberFromFleetResult JSON Unmarshaller
 */
...
public class DisassociateMemberFromFleetResultJsonUnmarshaller implements Unmarshaller<DisassociateMemberFromFleetResult, JsonUnmarshallerContext> {
    ...
    public DisassociateMemberFromFleetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateMemberFromFleetResult disassociateMemberFromFleetResult = new DisassociateMemberFromFleetResult();
