...
/**
 * DeleteStorageProfileResult JSON Unmarshaller
 */
...
public class DeleteStorageProfileResultJsonUnmarshaller implements Unmarshaller<DeleteStorageProfileResult, JsonUnmarshallerContext> {
    ...
    public DeleteStorageProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteStorageProfileResult deleteStorageProfileResult = new DeleteStorageProfileResult();
