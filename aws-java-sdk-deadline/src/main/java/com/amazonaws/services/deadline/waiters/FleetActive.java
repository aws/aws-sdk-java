...
class FleetActive {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<GetFleetResult> {
         ...
         */
        @Override
        public boolean matches(GetFleetResult result) {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<GetFleetResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATE_FAILEDMatcher extends WaiterAcceptor<GetFleetResult> {
        private static final JsonNode expectedResult;
