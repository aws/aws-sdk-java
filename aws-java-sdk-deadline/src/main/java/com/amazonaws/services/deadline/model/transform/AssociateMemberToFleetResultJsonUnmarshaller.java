...
/**
 * AssociateMemberToFleetResult JSON Unmarshaller
 */
...
public class AssociateMemberToFleetResultJsonUnmarshaller implements Unmarshaller<AssociateMemberToFleetResult, JsonUnmarshallerContext> {
    ...
    public AssociateMemberToFleetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateMemberToFleetResult associateMemberToFleetResult = new AssociateMemberToFleetResult();
