...
/**
 * PutMeteredProductResult JSON Unmarshaller
 */
...
public class PutMeteredProductResultJsonUnmarshaller implements Unmarshaller<PutMeteredProductResult, JsonUnmarshallerContext> {
    ...
    public PutMeteredProductResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutMeteredProductResult putMeteredProductResult = new PutMeteredProductResult();
