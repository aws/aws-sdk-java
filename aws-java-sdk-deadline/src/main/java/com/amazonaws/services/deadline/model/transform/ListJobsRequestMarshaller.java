...
public class ListJobsRequestMarshaller {
    ...
    public void marshall(ListJobsRequest listJobsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listJobsRequest.getFarmId(), FARMID_BINDING);
            ...
            protocolMarshaller.marshall(listJobsRequest.getPrincipalId(), PRINCIPALID_BINDING);
            protocolMarshaller.marshall(listJobsRequest.getQueueId(), QUEUEID_BINDING);
        } catch (Exception e) {
