 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ResponseBudgetAction" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResponseBudgetAction implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The budget action description.
     */
     ...
     * </p>
     * 
     * @return The percentage threshold for the budget.
     */
     ...
     * </p>
     * 
     * @return The action taken on the budget once scheduling stops.
     * @see BudgetActionType
     */
    ...
    public ResponseBudgetAction withType(String type) {
        setType(type);
        return this;
    }
    ...
    public ResponseBudgetAction withType(BudgetActionType type) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResponseBudgetAction == false)
            return false;
    ...
    @Override
    public ResponseBudgetAction clone() {
        try {
            return (ResponseBudgetAction) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.deadline.model.transform.ResponseBudgetActionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
