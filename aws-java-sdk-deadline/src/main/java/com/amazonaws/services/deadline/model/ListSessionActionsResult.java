...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/deadline-2023-10-12/ListSessionActions" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSessionActionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<SessionActionSummary> sessionActions;
    ...
    public ListSessionActionsResult withNextToken(String nextToken) {
     ...
     * </p>
     * 
     * @return The session actions.
     */

    public java.util.List<SessionActionSummary> getSessionActions() {
    ...
    public void setSessionActions(java.util.Collection<SessionActionSummary> sessionActions) {
        if (sessionActions == null) {
            this.sessionActions = null;
            return;
        }

        this.sessionActions = new java.util.ArrayList<SessionActionSummary>(sessionActions);
    }
    ...
    public ListSessionActionsResult withSessionActions(SessionActionSummary... sessionActions) {
        if (this.sessionActions == null) {
            setSessionActions(new java.util.ArrayList<SessionActionSummary>(sessionActions.length));
        }
        for (SessionActionSummary ele : sessionActions) {
    ...
    public ListSessionActionsResult withSessionActions(java.util.Collection<SessionActionSummary> sessionActions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSessionActionsResult == false)
            return false;
        ListSessionActionsResult other = (ListSessionActionsResult) obj;
    ...
    @Override
    public ListSessionActionsResult clone() {
        try {
            return (ListSessionActionsResult) super.clone();
