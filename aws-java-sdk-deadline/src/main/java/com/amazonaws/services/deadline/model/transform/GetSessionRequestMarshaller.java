...
public class GetSessionRequestMarshaller {
    ...
    public void marshall(GetSessionRequest getSessionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getSessionRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(getSessionRequest.getJobId(), JOBID_BINDING);
            protocolMarshaller.marshall(getSessionRequest.getQueueId(), QUEUEID_BINDING);
            protocolMarshaller.marshall(getSessionRequest.getSessionId(), SESSIONID_BINDING);
        } catch (Exception e) {
