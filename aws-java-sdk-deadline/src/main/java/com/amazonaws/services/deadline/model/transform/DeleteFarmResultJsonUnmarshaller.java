...
/**
 * DeleteFarmResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteFarmResultJsonUnmarshaller implements Unmarshaller<DeleteFarmResult, JsonUnmarshallerContext> {

    public DeleteFarmResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFarmResult deleteFarmResult = new DeleteFarmResult();
