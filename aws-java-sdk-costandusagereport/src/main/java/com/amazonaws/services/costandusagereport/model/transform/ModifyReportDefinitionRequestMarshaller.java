...
public class ModifyReportDefinitionRequestMarshaller {
    ...
    private static final ModifyReportDefinitionRequestMarshaller instance = new ModifyReportDefinitionRequestMarshaller();

    public static ModifyReportDefinitionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ModifyReportDefinitionRequest modifyReportDefinitionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(modifyReportDefinitionRequest.getReportName(), REPORTNAME_BINDING);
            protocolMarshaller.marshall(modifyReportDefinitionRequest.getReportDefinition(), REPORTDEFINITION_BINDING);
        } catch (Exception e) {
