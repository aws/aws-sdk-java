...
public class AWSCostAndUsageReportAsyncClient extends AWSCostAndUsageReportClient implements AWSCostAndUsageReportAsync {
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSCostAndUsageReportAsyncClient(com.amazonaws.ClientConfiguration clientConfiguration) {
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSCostAndUsageReportAsyncClient(com.amazonaws.auth.AWSCredentials awsCredentials) {
     ...
     */
    public AWSCostAndUsageReportAsyncClient(com.amazonaws.auth.AWSCredentials awsCredentials, java.util.concurrent.ExecutorService executorService) {
     ...
     *        The executor service by which all asynchronous requests will be executed.
     */
    public AWSCostAndUsageReportAsyncClient(com.amazonaws.auth.AWSCredentials awsCredentials, com.amazonaws.ClientConfiguration clientConfiguration,
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     */
    public AWSCostAndUsageReportAsyncClient(com.amazonaws.auth.AWSCredentialsProvider awsCredentialsProvider) {
