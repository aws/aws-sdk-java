...
public class ReportLimitReachedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ReportLimitReachedExceptionUnmarshaller instance;

    public static ReportLimitReachedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReportLimitReachedExceptionUnmarshaller();
        return instance;
    }
}
