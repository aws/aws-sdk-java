        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("securityGroups", targetDepth)) {
                    context.nextToken();
                    vpc.setSecurityGroups(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("subnets", targetDepth)) {
                    context.nextToken();
                    vpc.setSubnets(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
