...
/**
 * AutoScalingUpdate JSON Unmarshaller
 */
...
public class AutoScalingUpdateJsonUnmarshaller implements Unmarshaller<AutoScalingUpdate, JsonUnmarshallerContext> {
    ...
    public AutoScalingUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("maxWorkerCount", targetDepth)) {
                    context.nextToken();
                    autoScalingUpdate.setMaxWorkerCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("mcuCount", targetDepth)) {
                    context.nextToken();
                    autoScalingUpdate.setMcuCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("minWorkerCount", targetDepth)) {
                    context.nextToken();
                    autoScalingUpdate.setMinWorkerCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("scaleInPolicy", targetDepth)) {
                    context.nextToken();
                    autoScalingUpdate.setScaleInPolicy(ScaleInPolicyUpdateJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("scaleOutPolicy", targetDepth)) {
                    context.nextToken();
                    autoScalingUpdate.setScaleOutPolicy(ScaleOutPolicyUpdateJsonUnmarshaller.getInstance().unmarshall(context));
                }
