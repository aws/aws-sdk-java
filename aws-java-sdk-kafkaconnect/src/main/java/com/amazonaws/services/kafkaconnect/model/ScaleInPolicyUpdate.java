 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafkaconnect-2021-09-14/ScaleInPolicyUpdate" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScaleInPolicyUpdate implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The target CPU utilization percentage threshold at which you want connector scale in to be triggered.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScaleInPolicyUpdate == false)
            return false;
        ScaleInPolicyUpdate other = (ScaleInPolicyUpdate) obj;
    ...
    public ScaleInPolicyUpdate clone() {
        try {
            return (ScaleInPolicyUpdate) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafkaconnect.model.transform.ScaleInPolicyUpdateMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
