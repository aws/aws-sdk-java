...
public class DescribeCustomPluginRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Returns information about a custom plugin.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeCustomPluginRequest == false)
            return false;
        DescribeCustomPluginRequest other = (DescribeCustomPluginRequest) obj;
    ...
    @Override
    public DescribeCustomPluginRequest clone() {
        return (DescribeCustomPluginRequest) super.clone();
    }
