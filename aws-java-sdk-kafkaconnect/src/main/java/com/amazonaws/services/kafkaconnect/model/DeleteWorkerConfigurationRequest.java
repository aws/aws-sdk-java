...
public class DeleteWorkerConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the worker configuration that you want to delete.
     */
    ...
    public DeleteWorkerConfigurationRequest withWorkerConfigurationArn(String workerConfigurationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteWorkerConfigurationRequest == false)
            return false;
        DeleteWorkerConfigurationRequest other = (DeleteWorkerConfigurationRequest) obj;
    ...
    @Override
    public DeleteWorkerConfigurationRequest clone() {
        return (DeleteWorkerConfigurationRequest) super.clone();
    }
