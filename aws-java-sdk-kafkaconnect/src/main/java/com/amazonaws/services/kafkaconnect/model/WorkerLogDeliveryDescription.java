 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafkaconnect-2021-09-14/WorkerLogDeliveryDescription"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorkerLogDeliveryDescription implements Serializable, Cloneable, StructuredPojo {
    ...
    public CloudWatchLogsLogDeliveryDescription getCloudWatchLogs() {
    ...
    public void setFirehose(FirehoseLogDeliveryDescription firehose) {
    ...
    public FirehoseLogDeliveryDescription getFirehose() {
    ...
    public void setS3(S3LogDeliveryDescription s3) {
        this.s3 = s3;
    }
    ...
    public S3LogDeliveryDescription getS3() {
        return this.s3;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WorkerLogDeliveryDescription == false)
            return false;
    ...
    public WorkerLogDeliveryDescription clone() {
        try {
            return (WorkerLogDeliveryDescription) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafkaconnect.model.transform.WorkerLogDeliveryDescriptionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
