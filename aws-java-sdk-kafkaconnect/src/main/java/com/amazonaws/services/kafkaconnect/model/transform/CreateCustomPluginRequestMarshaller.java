...
@SdkInternalApi
public class CreateCustomPluginRequestMarshaller {
    ...
    public static CreateCustomPluginRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateCustomPluginRequest createCustomPluginRequest, ProtocolMarshaller protocolMarshaller) {

        if (createCustomPluginRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createCustomPluginRequest.getContentType(), CONTENTTYPE_BINDING);
