 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafkaconnect-2021-09-14/FirehoseLogDelivery" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FirehoseLogDelivery implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FirehoseLogDelivery == false)
            return false;
        FirehoseLogDelivery other = (FirehoseLogDelivery) obj;
    ...
    @Override
    public FirehoseLogDelivery clone() {
        try {
            return (FirehoseLogDelivery) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafkaconnect.model.transform.FirehoseLogDeliveryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
