...
public class ProvisionedCapacityDescriptionMarshaller {
    ...
    public void marshall(ProvisionedCapacityDescription provisionedCapacityDescription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(provisionedCapacityDescription.getMcuCount(), MCUCOUNT_BINDING);
            protocolMarshaller.marshall(provisionedCapacityDescription.getWorkerCount(), WORKERCOUNT_BINDING);
        } catch (Exception e) {
