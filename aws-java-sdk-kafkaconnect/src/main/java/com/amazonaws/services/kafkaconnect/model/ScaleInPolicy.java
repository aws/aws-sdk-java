 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafkaconnect-2021-09-14/ScaleInPolicy" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScaleInPolicy implements Serializable, Cloneable, StructuredPojo {
    ...
    public ScaleInPolicy withCpuUtilizationPercentage(Integer cpuUtilizationPercentage) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScaleInPolicy == false)
            return false;
        ScaleInPolicy other = (ScaleInPolicy) obj;
    ...
    @Override
    public ScaleInPolicy clone() {
        try {
            return (ScaleInPolicy) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafkaconnect.model.transform.ScaleInPolicyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
