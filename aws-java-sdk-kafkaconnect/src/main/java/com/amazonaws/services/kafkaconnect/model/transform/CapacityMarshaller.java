...
public class CapacityMarshaller {
    ...
    public void marshall(Capacity capacity, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(capacity.getAutoScaling(), AUTOSCALING_BINDING);
            protocolMarshaller.marshall(capacity.getProvisionedCapacity(), PROVISIONEDCAPACITY_BINDING);
        } catch (Exception e) {
