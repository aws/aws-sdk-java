...
/**
 * AutoScalingDescriptionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AutoScalingDescriptionMarshaller {
    ...
    private static final AutoScalingDescriptionMarshaller instance = new AutoScalingDescriptionMarshaller();

    public static AutoScalingDescriptionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AutoScalingDescription autoScalingDescription, ProtocolMarshaller protocolMarshaller) {

        if (autoScalingDescription == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(autoScalingDescription.getMaxWorkerCount(), MAXWORKERCOUNT_BINDING);
            protocolMarshaller.marshall(autoScalingDescription.getMcuCount(), MCUCOUNT_BINDING);
            protocolMarshaller.marshall(autoScalingDescription.getMinWorkerCount(), MINWORKERCOUNT_BINDING);
            protocolMarshaller.marshall(autoScalingDescription.getScaleInPolicy(), SCALEINPOLICY_BINDING);
            protocolMarshaller.marshall(autoScalingDescription.getScaleOutPolicy(), SCALEOUTPOLICY_BINDING);
        } catch (Exception e) {
