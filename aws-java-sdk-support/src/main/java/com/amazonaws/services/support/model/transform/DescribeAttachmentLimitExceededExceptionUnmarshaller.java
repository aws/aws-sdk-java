...
public class DescribeAttachmentLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DescribeAttachmentLimitExceededExceptionUnmarshaller instance;

    public static DescribeAttachmentLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeAttachmentLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
