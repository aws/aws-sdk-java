 ...
 */
public class DescribeTrustedAdvisorChecksResultJsonUnmarshaller
        implements
        Unmarshaller<DescribeTrustedAdvisorChecksResult, JsonUnmarshallerContext> {

    public DescribeTrustedAdvisorChecksResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("checks", targetDepth)) {
                    ...
                    describeTrustedAdvisorChecksResult
                            .setChecks(new ListUnmarshaller<TrustedAdvisorCheckDescription>(
    ...
    public static DescribeTrustedAdvisorChecksResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeTrustedAdvisorChecksResultJsonUnmarshaller();
        return instance;
    }
}
