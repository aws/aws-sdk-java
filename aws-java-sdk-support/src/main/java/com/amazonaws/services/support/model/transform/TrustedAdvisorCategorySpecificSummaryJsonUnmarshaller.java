 ...
 */
public class TrustedAdvisorCategorySpecificSummaryJsonUnmarshaller
        implements
        Unmarshaller<TrustedAdvisorCategorySpecificSummary, JsonUnmarshallerContext> {

    public TrustedAdvisorCategorySpecificSummary unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("costOptimizing", targetDepth)) {
                    ...
                    trustedAdvisorCategorySpecificSummary
                            .setCostOptimizing(TrustedAdvisorCostOptimizingSummaryJsonUnmarshaller
    ...
    public static TrustedAdvisorCategorySpecificSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TrustedAdvisorCategorySpecificSummaryJsonUnmarshaller();
        return instance;
    }
}
