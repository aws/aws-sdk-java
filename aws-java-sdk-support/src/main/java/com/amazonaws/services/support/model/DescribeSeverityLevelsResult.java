 ...
 * </p>
 */
public class DescribeSeverityLevelsResult extends
    ...
    public void setSeverityLevels(
        ...
        this.severityLevels = new com.amazonaws.internal.SdkInternalList<SeverityLevel>(
                severityLevels);
    }
    ...
    public DescribeSeverityLevelsResult withSeverityLevels(
        ...
        if (this.severityLevels == null) {
            setSeverityLevels(new com.amazonaws.internal.SdkInternalList<SeverityLevel>(
