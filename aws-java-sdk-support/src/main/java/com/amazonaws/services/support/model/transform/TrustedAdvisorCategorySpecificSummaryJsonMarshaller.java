...
public class TrustedAdvisorCategorySpecificSummaryJsonMarshaller {
     ...
     */
    public void marshall(TrustedAdvisorCategorySpecificSummary trustedAdvisorCategorySpecificSummary, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (trustedAdvisorCategorySpecificSummary.getCostOptimizing() != null) {
                ...
                TrustedAdvisorCostOptimizingSummaryJsonMarshaller.getInstance().marshall(trustedAdvisorCategorySpecificSummary.getCostOptimizing(),
                        jsonGenerator);
            }
