 ...
 */
public class DescribeCommunicationsResultJsonUnmarshaller implements
        Unmarshaller<DescribeCommunicationsResult, JsonUnmarshallerContext> {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("communications", targetDepth)) {
                    ...
                    describeCommunicationsResult
                            .setCommunications(new ListUnmarshaller<Communication>(
    ...
    public static DescribeCommunicationsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeCommunicationsResultJsonUnmarshaller();
        return instance;
    }
}
