...
public class TrustedAdvisorCheckRefreshStatusJsonMarshaller {
     ...
     */
    public void marshall(TrustedAdvisorCheckRefreshStatus trustedAdvisorCheckRefreshStatus, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (trustedAdvisorCheckRefreshStatus.getCheckId() != null) {
                jsonGenerator.writeFieldName("checkId").writeValue(trustedAdvisorCheckRefreshStatus.getCheckId());
            }
            if (trustedAdvisorCheckRefreshStatus.getStatus() != null) {
                jsonGenerator.writeFieldName("status").writeValue(trustedAdvisorCheckRefreshStatus.getStatus());
            }
            if (trustedAdvisorCheckRefreshStatus.getMillisUntilNextRefreshable() != null) {
                jsonGenerator.writeFieldName("millisUntilNextRefreshable").writeValue(trustedAdvisorCheckRefreshStatus.getMillisUntilNextRefreshable());
            }
