...
public class AddCommunicationToCaseRequestMarshaller
        implements
        Marshaller<Request<AddCommunicationToCaseRequest>, AddCommunicationToCaseRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public AddCommunicationToCaseRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<AddCommunicationToCaseRequest> marshall(
        ...
        Request<AddCommunicationToCaseRequest> request = new DefaultRequest<AddCommunicationToCaseRequest>(
                addCommunicationToCaseRequest, "AWSSupport");
