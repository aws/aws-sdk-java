 ...
 */
public class AddCommunicationToCaseResultJsonUnmarshaller implements
        Unmarshaller<AddCommunicationToCaseResult, JsonUnmarshallerContext> {

    public AddCommunicationToCaseResult unmarshall(
    ...
    public static AddCommunicationToCaseResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AddCommunicationToCaseResultJsonUnmarshaller();
        return instance;
    }
}
