 ...
 */
public class AWSSupportModuleInjector implements InjectorSource {
    ...
    static class AWSSupportModule extends AbstractModule {

        @Override
        protected void configure() {
            bind(AmazonWebServiceClient.class).to(AWSSupportClient.class);
        }
    }
}
