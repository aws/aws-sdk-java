...
class ReplicationTaskStopped {
    ...
    static class IsStoppedMatcher extends WaiterAcceptor<DescribeReplicationTasksResult> {
    ...
    static class IsReadyMatcher extends WaiterAcceptor<DescribeReplicationTasksResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"ready\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsCreatingMatcher extends WaiterAcceptor<DescribeReplicationTasksResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsStartingMatcher extends WaiterAcceptor<DescribeReplicationTasksResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeReplicationTasksResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsModifyingMatcher extends WaiterAcceptor<DescribeReplicationTasksResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsTestingMatcher extends WaiterAcceptor<DescribeReplicationTasksResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"testing\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeReplicationTasksResult> {
        private static final JsonNode expectedResult;
