...
public class ResourceQuotaExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceQuotaExceededExceptionUnmarshaller instance;

    public static ResourceQuotaExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceQuotaExceededExceptionUnmarshaller();
        return instance;
    }
}
