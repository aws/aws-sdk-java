...
public class DescribeEventCategoriesRequestMarshaller {
    ...
    private static final DescribeEventCategoriesRequestMarshaller instance = new DescribeEventCategoriesRequestMarshaller();

    public static DescribeEventCategoriesRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DescribeEventCategoriesRequest describeEventCategoriesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeEventCategoriesRequest.getSourceType(), SOURCETYPE_BINDING);
            protocolMarshaller.marshall(describeEventCategoriesRequest.getFilters(), FILTERS_BINDING);
        } catch (Exception e) {
