...
@SdkInternalApi
public class AvailabilityZoneMarshaller {

    private static final MarshallingInfo<String> NAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Name").build();

    private static final AvailabilityZoneMarshaller instance = new AvailabilityZoneMarshaller();

    public static AvailabilityZoneMarshaller getInstance() {
        return instance;
    }
