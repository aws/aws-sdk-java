...
public class DescribeRefreshSchemasStatusResultJsonUnmarshaller implements Unmarshaller<DescribeRefreshSchemasStatusResult, JsonUnmarshallerContext> {

    public DescribeRefreshSchemasStatusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RefreshSchemasStatus", targetDepth)) {
                    context.nextToken();
                    describeRefreshSchemasStatusResult.setRefreshSchemasStatus(RefreshSchemasStatusJsonUnmarshaller.getInstance().unmarshall(context));
                }
