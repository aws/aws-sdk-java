...
public class DescribeCertificatesRequestMarshaller
    ...
    public DescribeCertificatesRequestMarshaller(
    ...
    public Request<DescribeCertificatesRequest> marshall(
        ...
        Request<DescribeCertificatesRequest> request = new DefaultRequest<DescribeCertificatesRequest>(
                describeCertificatesRequest, "AWSDatabaseMigrationService");
        ...
        try {
            ...
            java.util.List<Filter> filtersList = describeCertificatesRequest
                    .getFilters();
            if (filtersList != null) {
