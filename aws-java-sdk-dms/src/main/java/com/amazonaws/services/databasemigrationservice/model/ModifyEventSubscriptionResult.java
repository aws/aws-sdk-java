...
public class ModifyEventSubscriptionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyEventSubscriptionResult == false)
            return false;
        ModifyEventSubscriptionResult other = (ModifyEventSubscriptionResult) obj;
    ...
    @Override
    public ModifyEventSubscriptionResult clone() {
        try {
            return (ModifyEventSubscriptionResult) super.clone();
