...
public class DescribeReplicationSubnetGroupsRequestMarshaller
    ...
    public Request<DescribeReplicationSubnetGroupsRequest> marshall(
        ...
        try {
            ...
            java.util.List<Filter> filtersList = describeReplicationSubnetGroupsRequest
                    .getFilters();
            if (filtersList != null) {
