...
/**
 * Fluent builder for {@link com.amazonaws.services.databasemigrationservice.AWSDatabaseMigrationService}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AWSDatabaseMigrationServiceClientBuilder extends AwsSyncClientBuilder<AWSDatabaseMigrationServiceClientBuilder, AWSDatabaseMigrationService> {
    ...
    /**
     * Construct a synchronous implementation of AWSDatabaseMigrationService using the current builder configuration.
     *
     * @param params
