...
public class SNSInvalidTopicExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.databasemigrationservice.model.SNSInvalidTopicException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return sNSInvalidTopicException;
    }

    private static SNSInvalidTopicExceptionUnmarshaller instance;

    public static SNSInvalidTopicExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SNSInvalidTopicExceptionUnmarshaller();
        return instance;
    }
}
