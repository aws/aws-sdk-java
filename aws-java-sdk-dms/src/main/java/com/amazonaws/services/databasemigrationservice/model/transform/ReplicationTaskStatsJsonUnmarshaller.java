 ...
 */
public class ReplicationTaskStatsJsonUnmarshaller implements
        Unmarshaller<ReplicationTaskStats, JsonUnmarshallerContext> {

    public ReplicationTaskStats unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FullLoadProgressPercent",
                        targetDepth)) {
                    context.nextToken();
