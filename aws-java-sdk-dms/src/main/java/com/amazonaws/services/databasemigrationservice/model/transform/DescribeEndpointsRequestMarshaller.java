...
public class DescribeEndpointsRequestMarshaller {
    ...
    public void marshall(DescribeEndpointsRequest describeEndpointsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeEndpointsRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(describeEndpointsRequest.getMaxRecords(), MAXRECORDS_BINDING);
            protocolMarshaller.marshall(describeEndpointsRequest.getMarker(), MARKER_BINDING);
        } catch (Exception e) {
