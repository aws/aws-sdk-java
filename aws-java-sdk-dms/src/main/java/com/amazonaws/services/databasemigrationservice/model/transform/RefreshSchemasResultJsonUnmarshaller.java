 ...
 */
public class RefreshSchemasResultJsonUnmarshaller implements
        Unmarshaller<RefreshSchemasResult, JsonUnmarshallerContext> {

    public RefreshSchemasResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RefreshSchemasStatus", targetDepth)) {
                    ...
                    refreshSchemasResult
                            .setRefreshSchemasStatus(RefreshSchemasStatusJsonUnmarshaller
