...
/**
 * ReplicationTaskIndividualAssessment JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReplicationTaskIndividualAssessmentJsonUnmarshaller implements Unmarshaller<ReplicationTaskIndividualAssessment, JsonUnmarshallerContext> {

    public ReplicationTaskIndividualAssessment unmarshall(JsonUnmarshallerContext context) throws Exception {
        ReplicationTaskIndividualAssessment replicationTaskIndividualAssessment = new ReplicationTaskIndividualAssessment();
    ...
    private static ReplicationTaskIndividualAssessmentJsonUnmarshaller instance;

    public static ReplicationTaskIndividualAssessmentJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReplicationTaskIndividualAssessmentJsonUnmarshaller();
        return instance;
    }
}
