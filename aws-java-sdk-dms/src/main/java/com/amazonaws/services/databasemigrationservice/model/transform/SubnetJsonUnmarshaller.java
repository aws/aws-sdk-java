 ...
 */
public class SubnetJsonUnmarshaller implements
        Unmarshaller<Subnet, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("SubnetAvailabilityZone",
                        targetDepth)) {
                    context.nextToken();
                    subnet.setSubnetAvailabilityZone(AvailabilityZoneJsonUnmarshaller
