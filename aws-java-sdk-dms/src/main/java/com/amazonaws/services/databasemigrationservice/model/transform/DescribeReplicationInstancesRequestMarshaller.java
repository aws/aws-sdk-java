...
public class DescribeReplicationInstancesRequestMarshaller
    ...
    public DescribeReplicationInstancesRequestMarshaller(
    ...
    public Request<DescribeReplicationInstancesRequest> marshall(
        ...
        try {
            ...
            java.util.List<Filter> filtersList = describeReplicationInstancesRequest
                    .getFilters();
            if (filtersList != null) {
