...
public class DeleteConnectionRequestMarshaller {
    ...
    public void marshall(DeleteConnectionRequest deleteConnectionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteConnectionRequest.getEndpointArn(), ENDPOINTARN_BINDING);
            protocolMarshaller.marshall(deleteConnectionRequest.getReplicationInstanceArn(), REPLICATIONINSTANCEARN_BINDING);
        } catch (Exception e) {
