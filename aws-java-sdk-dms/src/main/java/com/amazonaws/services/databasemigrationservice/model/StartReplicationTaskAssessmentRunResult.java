...
public class StartReplicationTaskAssessmentRunResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The premigration assessment run that was started.
     */
    ...
    public StartReplicationTaskAssessmentRunResult withReplicationTaskAssessmentRun(ReplicationTaskAssessmentRun replicationTaskAssessmentRun) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartReplicationTaskAssessmentRunResult == false)
            return false;
        StartReplicationTaskAssessmentRunResult other = (StartReplicationTaskAssessmentRunResult) obj;
    ...
    @Override
    public StartReplicationTaskAssessmentRunResult clone() {
        try {
            return (StartReplicationTaskAssessmentRunResult) super.clone();
