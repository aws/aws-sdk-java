 ...
 * 
 */
public class DescribeEndpointTypesResult implements Serializable, Cloneable {
     ...
     * any). Use {@link #setSupportedEndpointTypes(java.util.Collection)} or
     * {@link #withSupportedEndpointTypes(java.util.Collection)} if you want to
    ...
    public DescribeEndpointTypesResult withSupportedEndpointTypes(
        ...
        if (this.supportedEndpointTypes == null) {
            setSupportedEndpointTypes(new java.util.ArrayList<SupportedEndpointType>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSupportedEndpointTypes() == null
                ^ this.getSupportedEndpointTypes() == null)
            return false;
        if (other.getSupportedEndpointTypes() != null
                && other.getSupportedEndpointTypes().equals(
                        this.getSupportedEndpointTypes()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getSupportedEndpointTypes() == null) ? 0
                        : getSupportedEndpointTypes().hashCode());
        return hashCode;
    }
