...
public class DescribeEndpointTypesRequestMarshaller
    ...
    public DescribeEndpointTypesRequestMarshaller(
    ...
    public Request<DescribeEndpointTypesRequest> marshall(
        ...
        try {
            ...
            java.util.List<Filter> filtersList = describeEndpointTypesRequest
                    .getFilters();
            if (filtersList != null) {
