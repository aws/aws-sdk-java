 ...
 */
public class DescribeConnectionsResultJsonUnmarshaller implements
        Unmarshaller<DescribeConnectionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Marker", targetDepth)) {
                    context.nextToken();
                    describeConnectionsResult.setMarker(StringJsonUnmarshaller
