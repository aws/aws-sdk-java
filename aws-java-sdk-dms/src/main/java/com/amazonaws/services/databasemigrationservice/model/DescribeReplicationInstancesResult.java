 ...
 * <p/>
 */
public class DescribeReplicationInstancesResult extends
     ...
     * any). Use {@link #setReplicationInstances(java.util.Collection)} or
     * {@link #withReplicationInstances(java.util.Collection)} if you want to
    ...
    public DescribeReplicationInstancesResult withReplicationInstances(
        ...
        if (this.replicationInstances == null) {
            setReplicationInstances(new java.util.ArrayList<ReplicationInstance>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getReplicationInstances() == null
                ^ this.getReplicationInstances() == null)
            return false;
        if (other.getReplicationInstances() != null
                && other.getReplicationInstances().equals(
                        this.getReplicationInstances()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getReplicationInstances() == null) ? 0
                        : getReplicationInstances().hashCode());
        return hashCode;
    }
