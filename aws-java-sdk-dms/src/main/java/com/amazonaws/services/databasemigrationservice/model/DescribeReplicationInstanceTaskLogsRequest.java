...
public class DescribeReplicationInstanceTaskLogsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeReplicationInstanceTaskLogsRequest withReplicationInstanceArn(String replicationInstanceArn) {
    ...
    @Override
    public DescribeReplicationInstanceTaskLogsRequest clone() {
        return (DescribeReplicationInstanceTaskLogsRequest) super.clone();
    }
