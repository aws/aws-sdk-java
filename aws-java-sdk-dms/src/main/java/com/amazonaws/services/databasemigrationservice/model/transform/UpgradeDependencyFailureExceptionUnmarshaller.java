...
public class UpgradeDependencyFailureExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.databasemigrationservice.model.UpgradeDependencyFailureException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return upgradeDependencyFailureException;
    }

    private static UpgradeDependencyFailureExceptionUnmarshaller instance;

    public static UpgradeDependencyFailureExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpgradeDependencyFailureExceptionUnmarshaller();
        return instance;
    }
}
