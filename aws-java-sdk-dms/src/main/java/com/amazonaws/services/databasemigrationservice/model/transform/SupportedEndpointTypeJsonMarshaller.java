...
public class SupportedEndpointTypeJsonMarshaller {
     ...
     */
    public void marshall(SupportedEndpointType supportedEndpointType, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (supportedEndpointType.getEngineName() != null) {
                jsonGenerator.writeFieldName("EngineName").writeValue(supportedEndpointType.getEngineName());
            }
            if (supportedEndpointType.getSupportsCDC() != null) {
                jsonGenerator.writeFieldName("SupportsCDC").writeValue(supportedEndpointType.getSupportsCDC());
            }
            if (supportedEndpointType.getEndpointType() != null) {
                jsonGenerator.writeFieldName("EndpointType").writeValue(supportedEndpointType.getEndpointType());
            }
