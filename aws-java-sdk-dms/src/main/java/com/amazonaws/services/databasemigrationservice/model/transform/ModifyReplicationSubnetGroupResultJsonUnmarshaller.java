 ...
 */
public class ModifyReplicationSubnetGroupResultJsonUnmarshaller
        implements
        Unmarshaller<ModifyReplicationSubnetGroupResult, JsonUnmarshallerContext> {

    public ModifyReplicationSubnetGroupResult unmarshall(
