...
public class StartRecommendationsRequestMarshaller {
    ...
    private static final StartRecommendationsRequestMarshaller instance = new StartRecommendationsRequestMarshaller();

    public static StartRecommendationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartRecommendationsRequest startRecommendationsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startRecommendationsRequest.getDatabaseId(), DATABASEID_BINDING);
            protocolMarshaller.marshall(startRecommendationsRequest.getSettings(), SETTINGS_BINDING);
        } catch (Exception e) {
