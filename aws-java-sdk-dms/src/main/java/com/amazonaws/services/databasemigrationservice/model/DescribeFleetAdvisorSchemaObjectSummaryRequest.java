...
public class DescribeFleetAdvisorSchemaObjectSummaryRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return If you specify any of the following filters, the output includes information for only those schema
     *         objects that meet the filter criteria:</p>
     *         <ul>
     *         <li>
     *         <p>
    ...
    public DescribeFleetAdvisorSchemaObjectSummaryRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeFleetAdvisorSchemaObjectSummaryRequest == false)
            return false;
        DescribeFleetAdvisorSchemaObjectSummaryRequest other = (DescribeFleetAdvisorSchemaObjectSummaryRequest) obj;
    ...
    public DescribeFleetAdvisorSchemaObjectSummaryRequest clone() {
        return (DescribeFleetAdvisorSchemaObjectSummaryRequest) super.clone();
    }
