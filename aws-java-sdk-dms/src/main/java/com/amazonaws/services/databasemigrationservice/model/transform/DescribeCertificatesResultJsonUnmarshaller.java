 ...
 */
public class DescribeCertificatesResultJsonUnmarshaller implements
        Unmarshaller<DescribeCertificatesResult, JsonUnmarshallerContext> {

    public DescribeCertificatesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Marker", targetDepth)) {
                    context.nextToken();
                    describeCertificatesResult.setMarker(context
