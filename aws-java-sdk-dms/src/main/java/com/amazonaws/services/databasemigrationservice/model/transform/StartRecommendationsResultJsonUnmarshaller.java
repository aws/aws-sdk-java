...
/**
 * StartRecommendationsResult JSON Unmarshaller
 */
...
public class StartRecommendationsResultJsonUnmarshaller implements Unmarshaller<StartRecommendationsResult, JsonUnmarshallerContext> {
    ...
    public StartRecommendationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartRecommendationsResult startRecommendationsResult = new StartRecommendationsResult();

        return startRecommendationsResult;
    }
