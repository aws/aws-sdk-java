 ...
 * <p/>
 */
public class DescribeSchemasResult extends
     ...
     * any). Use {@link #setSchemas(java.util.Collection)} or
     * {@link #withSchemas(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param schemas
    ...
    public DescribeSchemasResult withSchemas(
            java.util.Collection<String> schemas) {
        setSchemas(schemas);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSchemas() != null
                && other.getSchemas().equals(this.getSchemas()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSchemas() == null) ? 0 : getSchemas().hashCode());
        return hashCode;
    }
