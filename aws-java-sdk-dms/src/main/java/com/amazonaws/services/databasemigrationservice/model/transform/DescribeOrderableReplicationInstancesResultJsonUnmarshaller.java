 ...
 */
public class DescribeOrderableReplicationInstancesResultJsonUnmarshaller
        implements
        Unmarshaller<DescribeOrderableReplicationInstancesResult, JsonUnmarshallerContext> {

    public DescribeOrderableReplicationInstancesResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("OrderableReplicationInstances",
                        targetDepth)) {
                    context.nextToken();
