...
public class VpcSecurityGroupMembershipJsonMarshaller {
     ...
     */
    public void marshall(VpcSecurityGroupMembership vpcSecurityGroupMembership,
        ...
        try {
            ...
            if (vpcSecurityGroupMembership.getVpcSecurityGroupId() != null) {
                jsonGenerator.writeFieldName("VpcSecurityGroupId").writeValue(
                        vpcSecurityGroupMembership.getVpcSecurityGroupId());
            }
            if (vpcSecurityGroupMembership.getStatus() != null) {
                jsonGenerator.writeFieldName("Status").writeValue(
                        vpcSecurityGroupMembership.getStatus());
            }
