...
/**
 * GcpMySQLSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GcpMySQLSettingsMarshaller {
    ...
    private static final GcpMySQLSettingsMarshaller instance = new GcpMySQLSettingsMarshaller();

    public static GcpMySQLSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GcpMySQLSettings gcpMySQLSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(gcpMySQLSettings.getAfterConnectScript(), AFTERCONNECTSCRIPT_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getCleanSourceMetadataOnMismatch(), CLEANSOURCEMETADATAONMISMATCH_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getDatabaseName(), DATABASENAME_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getEventsPollInterval(), EVENTSPOLLINTERVAL_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getTargetDbType(), TARGETDBTYPE_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getMaxFileSize(), MAXFILESIZE_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getParallelLoadThreads(), PARALLELLOADTHREADS_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getPassword(), PASSWORD_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getPort(), PORT_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getServerName(), SERVERNAME_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getServerTimezone(), SERVERTIMEZONE_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getUsername(), USERNAME_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getSecretsManagerAccessRoleArn(), SECRETSMANAGERACCESSROLEARN_BINDING);
            protocolMarshaller.marshall(gcpMySQLSettings.getSecretsManagerSecretId(), SECRETSMANAGERSECRETID_BINDING);
        } catch (Exception e) {
