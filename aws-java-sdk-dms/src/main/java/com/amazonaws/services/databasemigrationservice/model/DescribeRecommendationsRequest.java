...
public class DescribeRecommendationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <code>MaxRecords</code> value, Fleet Advisor includes a pagination token in the response so that you can retrieve
     ...
     * </p>
     * 
     * @return Filters applied to the target engine recommendations described in the form of key-value pairs.
     */
    ...
    public DescribeRecommendationsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
     ...
     * @param maxRecords
     *        The maximum number of records to include in the response. If more records exist than the specified
     *        <code>MaxRecords</code> value, Fleet Advisor includes a pagination token in the response so that you can
    ...
    public DescribeRecommendationsRequest withMaxRecords(Integer maxRecords) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeRecommendationsRequest == false)
            return false;
        DescribeRecommendationsRequest other = (DescribeRecommendationsRequest) obj;
    ...
    public DescribeRecommendationsRequest clone() {
        return (DescribeRecommendationsRequest) super.clone();
    }
