...
public class DescribeConnectionsRequestMarshaller {
    ...
    public void marshall(DescribeConnectionsRequest describeConnectionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeConnectionsRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(describeConnectionsRequest.getMaxRecords(), MAXRECORDS_BINDING);
            protocolMarshaller.marshall(describeConnectionsRequest.getMarker(), MARKER_BINDING);
        } catch (Exception e) {
