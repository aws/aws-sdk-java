...
public class DescribeAppAssessmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private AppAssessment assessment;
    ...
    public void setAssessment(AppAssessment assessment) {
    ...
    public AppAssessment getAssessment() {
    ...
    public DescribeAppAssessmentResult withAssessment(AppAssessment assessment) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAppAssessmentResult == false)
            return false;
        DescribeAppAssessmentResult other = (DescribeAppAssessmentResult) obj;
    ...
    @Override
    public DescribeAppAssessmentResult clone() {
        try {
            return (DescribeAppAssessmentResult) super.clone();
