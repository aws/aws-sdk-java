...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.resiliencehub.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.resiliencehub.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.resiliencehub.model.ThrottlingException throttlingException = new com.amazonaws.services.resiliencehub.model.ThrottlingException(
                null);
