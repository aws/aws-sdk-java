...
public class UpdateResiliencyPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The type of resiliency policy that was updated, including the recovery time objective (RTO) and recovery
     *         point objective (RPO) in seconds.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateResiliencyPolicyResult == false)
            return false;
        UpdateResiliencyPolicyResult other = (UpdateResiliencyPolicyResult) obj;
    ...
    public UpdateResiliencyPolicyResult clone() {
        try {
            return (UpdateResiliencyPolicyResult) super.clone();
