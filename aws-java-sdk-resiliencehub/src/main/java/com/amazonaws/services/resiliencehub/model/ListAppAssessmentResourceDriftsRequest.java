...
public class ListAppAssessmentResourceDriftsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * specified <code>MaxResults</code> value, a token is included in the response so that the remaining results can be
     * retrieved.
     * </p>
     */
    ...
    public ListAppAssessmentResourceDriftsRequest withAssessmentArn(String assessmentArn) {
     ...
     * </p>
     * 
     * @return Indicates the maximum number of drift results to include in the response. If more results exist than the
    ...
    public ListAppAssessmentResourceDriftsRequest withMaxResults(Integer maxResults) {
    ...
    public ListAppAssessmentResourceDriftsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAppAssessmentResourceDriftsRequest == false)
            return false;
        ListAppAssessmentResourceDriftsRequest other = (ListAppAssessmentResourceDriftsRequest) obj;
    ...
    @Override
    public ListAppAssessmentResourceDriftsRequest clone() {
        return (ListAppAssessmentResourceDriftsRequest) super.clone();
    }
