...
/**
 * DisruptionCompliance JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DisruptionComplianceJsonUnmarshaller implements Unmarshaller<DisruptionCompliance, JsonUnmarshallerContext> {

    public DisruptionCompliance unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisruptionCompliance disruptionCompliance = new DisruptionCompliance();
    ...
    private static DisruptionComplianceJsonUnmarshaller instance;

    public static DisruptionComplianceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DisruptionComplianceJsonUnmarshaller();
        return instance;
    }
}
