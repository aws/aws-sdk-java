...
/**
 * Fluent builder for {@link com.amazonaws.services.resiliencehub.AWSResilienceHubAsync}. Use of the builder is
...
public final class AWSResilienceHubAsyncClientBuilder extends AwsAsyncClientBuilder<AWSResilienceHubAsyncClientBuilder, AWSResilienceHubAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSResilienceHubAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSResilienceHubAsync.
     */
    @Override
    protected AWSResilienceHubAsync build(AwsAsyncClientParams params) {
        return new AWSResilienceHubAsyncClient(params);
    }
