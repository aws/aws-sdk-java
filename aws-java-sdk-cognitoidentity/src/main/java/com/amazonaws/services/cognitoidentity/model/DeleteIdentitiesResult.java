...
public class DeleteIdentitiesResult implements Serializable, Cloneable {
     ...
     * {@link #withUnprocessedIdentityIds(java.util.Collection)} if you want to
    ...
    public DeleteIdentitiesResult withUnprocessedIdentityIds(
        ...
        if (this.unprocessedIdentityIds == null) {
            setUnprocessedIdentityIds(new java.util.ArrayList<UnprocessedIdentityId>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getUnprocessedIdentityIds() == null
                ^ this.getUnprocessedIdentityIds() == null)
            return false;
        if (other.getUnprocessedIdentityIds() != null
                && other.getUnprocessedIdentityIds().equals(
                        this.getUnprocessedIdentityIds()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getUnprocessedIdentityIds() == null) ? 0
                        : getUnprocessedIdentityIds().hashCode());
        return hashCode;
    }
