...
/**
 * DeleteIdentityPoolRequestMarshaller
 */
...
public class DeleteIdentityPoolRequestMarshaller {
    ...
    private static final DeleteIdentityPoolRequestMarshaller instance = new DeleteIdentityPoolRequestMarshaller();

    public static DeleteIdentityPoolRequestMarshaller getInstance() {
        return instance;
    }
