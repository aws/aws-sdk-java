...
/**
 * Fluent builder for {@link com.amazonaws.services.cognitoidentity.AmazonCognitoIdentity}. Use of the builder is
 * preferred over using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AmazonCognitoIdentityClientBuilder extends AwsSyncClientBuilder<AmazonCognitoIdentityClientBuilder, AmazonCognitoIdentity> {
    ...
    /**
     * Construct a synchronous implementation of AmazonCognitoIdentity using the current builder configuration.
     *
     * @param params
