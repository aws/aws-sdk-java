...
public class CreateIdentityPoolResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateIdentityPoolResult withAllowClassicFlow(Boolean allowClassicFlow) {
    ...
    public CreateIdentityPoolResult withSupportedLoginProviders(java.util.Map<String, String> supportedLoginProviders) {
     ...
     *
     * @see CreateIdentityPoolResult#withSupportedLoginProviders
    ...
    public CreateIdentityPoolResult withOpenIdConnectProviderARNs(java.util.Collection<String> openIdConnectProviderARNs) {
    ...
    public CreateIdentityPoolResult withCognitoIdentityProviders(java.util.Collection<CognitoIdentityProvider> cognitoIdentityProviders) {
    ...
    public CreateIdentityPoolResult withSamlProviderARNs(java.util.Collection<String> samlProviderARNs) {
     ...
     *
     * @see CreateIdentityPoolResult#withIdentityPoolTags
     * @returns a reference to this object so that method calls can be chained together.
     */
