...
public class IdentityPoolShortDescriptionMarshaller {
    ...
    public void marshall(IdentityPoolShortDescription identityPoolShortDescription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(identityPoolShortDescription.getIdentityPoolId(), IDENTITYPOOLID_BINDING);
            protocolMarshaller.marshall(identityPoolShortDescription.getIdentityPoolName(), IDENTITYPOOLNAME_BINDING);
        } catch (Exception e) {
