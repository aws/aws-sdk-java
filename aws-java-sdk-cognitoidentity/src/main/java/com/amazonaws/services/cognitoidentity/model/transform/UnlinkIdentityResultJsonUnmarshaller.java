 ...
 */
public class UnlinkIdentityResultJsonUnmarshaller implements
        Unmarshaller<UnlinkIdentityResult, JsonUnmarshallerContext> {

    public UnlinkIdentityResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
