...
/**
 * IdentityPoolShortDescriptionMarshaller
 */
public class IdentityPoolShortDescriptionJsonMarshaller {
     ...
     */
    public void marshall(IdentityPoolShortDescription identityPoolShortDescription, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (identityPoolShortDescription.getIdentityPoolId() != null) {
                jsonGenerator.writeFieldName("IdentityPoolId").writeValue(identityPoolShortDescription.getIdentityPoolId());
            }
            if (identityPoolShortDescription.getIdentityPoolName() != null) {
                jsonGenerator.writeFieldName("IdentityPoolName").writeValue(identityPoolShortDescription.getIdentityPoolName());
            }
