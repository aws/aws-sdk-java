...
public class ListIdentityPoolsResult implements Serializable, Cloneable {
     ...
     * any). Use {@link #setIdentityPools(java.util.Collection)} or
     * {@link #withIdentityPools(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param identityPools
    ...
    public ListIdentityPoolsResult withIdentityPools(
        ...
        if (this.identityPools == null) {
            setIdentityPools(new java.util.ArrayList<IdentityPoolShortDescription>(
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getIdentityPools() == null) ? 0 : getIdentityPools()
                        .hashCode());
