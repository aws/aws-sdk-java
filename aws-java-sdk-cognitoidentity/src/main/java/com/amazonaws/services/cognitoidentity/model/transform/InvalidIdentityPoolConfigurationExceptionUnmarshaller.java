...
public class InvalidIdentityPoolConfigurationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidIdentityPoolConfigurationExceptionUnmarshaller instance;

    public static InvalidIdentityPoolConfigurationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidIdentityPoolConfigurationExceptionUnmarshaller();
        return instance;
    }
}
