...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.cognitoidentity.AmazonCognitoIdentityAsync}.
 * Use of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonCognitoIdentityAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonCognitoIdentityAsyncClientBuilder, AmazonCognitoIdentityAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonCognitoIdentityAsync
