 ...
 */
public class DeleteIdentityPoolResultJsonUnmarshaller implements
        Unmarshaller<DeleteIdentityPoolResult, JsonUnmarshallerContext> {

    public DeleteIdentityPoolResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
