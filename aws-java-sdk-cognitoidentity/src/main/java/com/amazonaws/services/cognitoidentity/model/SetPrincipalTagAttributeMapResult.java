...
public class SetPrincipalTagAttributeMapResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return You can use this operation to select default (username and clientID) attribute mappings.
     */
    ...
    public SetPrincipalTagAttributeMapResult withPrincipalTags(java.util.Map<String, String> principalTags) {
     ...
     *
     * @see SetPrincipalTagAttributeMapResult#withPrincipalTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public SetPrincipalTagAttributeMapResult addPrincipalTagsEntry(String key, String value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetPrincipalTagAttributeMapResult == false)
            return false;
        SetPrincipalTagAttributeMapResult other = (SetPrincipalTagAttributeMapResult) obj;
    ...
    public SetPrincipalTagAttributeMapResult clone() {
        try {
            return (SetPrincipalTagAttributeMapResult) super.clone();
