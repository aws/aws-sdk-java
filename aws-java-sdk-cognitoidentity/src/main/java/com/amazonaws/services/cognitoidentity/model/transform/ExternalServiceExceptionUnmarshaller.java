...
public class ExternalServiceExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("ExternalServiceException"));
        } else {
            return errorTypeFromHeader.equals("ExternalServiceException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        ExternalServiceException e = (ExternalServiceException)super.unmarshall(json);
