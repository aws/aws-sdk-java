...
/**
 * Unprocessed Identity Id JSON Unmarshaller
 */
public class UnprocessedIdentityIdJsonUnmarshaller implements Unmarshaller<UnprocessedIdentityId, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityId", targetDepth)) {
                    context.nextToken();
                    unprocessedIdentityId.setIdentityId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    unprocessedIdentityId.setErrorCode(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static UnprocessedIdentityIdJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UnprocessedIdentityIdJsonUnmarshaller();
        return instance;
    }
}
