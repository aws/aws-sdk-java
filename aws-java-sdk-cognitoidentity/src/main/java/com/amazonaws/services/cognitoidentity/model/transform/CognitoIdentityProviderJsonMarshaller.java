...
public class CognitoIdentityProviderJsonMarshaller {
     ...
     */
    public void marshall(CognitoIdentityProvider cognitoIdentityProvider, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (cognitoIdentityProvider.getProviderName() != null) {
                jsonGenerator.writeFieldName("ProviderName").writeValue(cognitoIdentityProvider.getProviderName());
            }
