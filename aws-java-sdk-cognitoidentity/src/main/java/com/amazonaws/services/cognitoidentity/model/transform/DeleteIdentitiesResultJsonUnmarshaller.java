...
/**
 * Delete Identities Result JSON Unmarshaller
 */
public class DeleteIdentitiesResultJsonUnmarshaller implements Unmarshaller<DeleteIdentitiesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UnprocessedIdentityIds", targetDepth)) {
                    context.nextToken();
                    deleteIdentitiesResult.setUnprocessedIdentityIds(new ListUnmarshaller<UnprocessedIdentityId>(UnprocessedIdentityIdJsonUnmarshaller.getInstance()).unmarshall(context));
                }
    ...
    public static DeleteIdentitiesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteIdentitiesResultJsonUnmarshaller();
        return instance;
    }
}
