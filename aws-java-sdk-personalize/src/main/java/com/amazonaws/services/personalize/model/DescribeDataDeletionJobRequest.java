...
public class DescribeDataDeletionJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeDataDeletionJobRequest withDataDeletionJobArn(String dataDeletionJobArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeDataDeletionJobRequest == false)
            return false;
        DescribeDataDeletionJobRequest other = (DescribeDataDeletionJobRequest) obj;
    ...
    @Override
    public DescribeDataDeletionJobRequest clone() {
        return (DescribeDataDeletionJobRequest) super.clone();
    }
