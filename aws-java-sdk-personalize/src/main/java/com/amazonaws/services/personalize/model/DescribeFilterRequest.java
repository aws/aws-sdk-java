...
public class DescribeFilterRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the filter to describe.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeFilterRequest == false)
            return false;
        DescribeFilterRequest other = (DescribeFilterRequest) obj;
    ...
    @Override
    public DescribeFilterRequest clone() {
        return (DescribeFilterRequest) super.clone();
    }
