...
public class ListBatchSegmentJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the solution version that the batch segment jobs used to generate batch
     *         segments.
     */
     ...
     * </p>
     * 
     * @return The maximum number of batch segment job results to return in each page. The default value is 100.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListBatchSegmentJobsRequest == false)
            return false;
        ListBatchSegmentJobsRequest other = (ListBatchSegmentJobsRequest) obj;
    ...
    public ListBatchSegmentJobsRequest clone() {
        return (ListBatchSegmentJobsRequest) super.clone();
    }
