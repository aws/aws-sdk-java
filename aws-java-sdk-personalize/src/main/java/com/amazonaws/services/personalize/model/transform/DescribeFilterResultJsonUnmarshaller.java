...
/**
 * DescribeFilterResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeFilterResultJsonUnmarshaller implements Unmarshaller<DescribeFilterResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("filter", targetDepth)) {
                    context.nextToken();
                    describeFilterResult.setFilter(FilterJsonUnmarshaller.getInstance().unmarshall(context));
                }
