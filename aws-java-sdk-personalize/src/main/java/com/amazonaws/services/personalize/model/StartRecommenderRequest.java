...
public class StartRecommenderRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the recommender to start.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartRecommenderRequest == false)
            return false;
        StartRecommenderRequest other = (StartRecommenderRequest) obj;
    ...
    @Override
    public StartRecommenderRequest clone() {
        return (StartRecommenderRequest) super.clone();
    }
