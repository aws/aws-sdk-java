...
/**
 * DeleteDatasetGroupResult JSON Unmarshaller
 */
...
public class DeleteDatasetGroupResultJsonUnmarshaller implements Unmarshaller<DeleteDatasetGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteDatasetGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDatasetGroupResult deleteDatasetGroupResult = new DeleteDatasetGroupResult();
