...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/personalize-2018-05-22/StartRecommender" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartRecommenderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the recommender you started.
     */
    ...
    public StartRecommenderResult withRecommenderArn(String recommenderArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartRecommenderResult == false)
            return false;
        StartRecommenderResult other = (StartRecommenderResult) obj;
    ...
    @Override
    public StartRecommenderResult clone() {
        try {
            return (StartRecommenderResult) super.clone();
