 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/personalize-2018-05-22/BatchSegmentJobOutput" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchSegmentJobOutput implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchSegmentJobOutput == false)
            return false;
        BatchSegmentJobOutput other = (BatchSegmentJobOutput) obj;
    ...
    public BatchSegmentJobOutput clone() {
        try {
            return (BatchSegmentJobOutput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.personalize.model.transform.BatchSegmentJobOutputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
