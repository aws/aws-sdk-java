...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/personalize-2018-05-22/DeleteRecommender" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteRecommenderRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the recommender to delete.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRecommenderRequest == false)
            return false;
        DeleteRecommenderRequest other = (DeleteRecommenderRequest) obj;
    ...
    @Override
    public DeleteRecommenderRequest clone() {
        return (DeleteRecommenderRequest) super.clone();
    }
