...
/**
 * DefaultContinuousHyperParameterRange JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DefaultContinuousHyperParameterRangeJsonUnmarshaller implements Unmarshaller<DefaultContinuousHyperParameterRange, JsonUnmarshallerContext> {

    public DefaultContinuousHyperParameterRange unmarshall(JsonUnmarshallerContext context) throws Exception {
