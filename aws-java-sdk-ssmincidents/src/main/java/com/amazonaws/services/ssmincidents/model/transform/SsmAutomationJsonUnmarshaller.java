...
/**
 * SsmAutomation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SsmAutomationJsonUnmarshaller implements Unmarshaller<SsmAutomation, JsonUnmarshallerContext> {

    public SsmAutomation unmarshall(JsonUnmarshallerContext context) throws Exception {
        SsmAutomation ssmAutomation = new SsmAutomation();
    ...
    private static SsmAutomationJsonUnmarshaller instance;

    public static SsmAutomationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SsmAutomationJsonUnmarshaller();
        return instance;
    }
}
