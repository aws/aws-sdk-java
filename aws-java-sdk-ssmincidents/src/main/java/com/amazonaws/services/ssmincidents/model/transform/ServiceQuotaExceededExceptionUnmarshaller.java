...
public class ServiceQuotaExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceQuotaExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.ssmincidents.model.ServiceQuotaExceededException.class, "ServiceQuotaExceededException");
    }

    @Override
    public com.amazonaws.services.ssmincidents.model.ServiceQuotaExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ssmincidents.model.ServiceQuotaExceededException serviceQuotaExceededException = new com.amazonaws.services.ssmincidents.model.ServiceQuotaExceededException(
                null);
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("resourceIdentifier", targetDepth)) {
                    context.nextToken();
                    serviceQuotaExceededException.setResourceIdentifier(context.getUnmarshaller(String.class).unmarshall(context));
                }
