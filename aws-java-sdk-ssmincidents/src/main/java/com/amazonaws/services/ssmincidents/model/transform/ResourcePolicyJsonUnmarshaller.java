        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("policyId", targetDepth)) {
                    context.nextToken();
                    resourcePolicy.setPolicyId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ramResourceShareRegion", targetDepth)) {
                    context.nextToken();
                    resourcePolicy.setRamResourceShareRegion(context.getUnmarshaller(String.class).unmarshall(context));
                }
