...
public interface AWSSSMIncidents {
     ...
     */
    BatchGetIncidentFindingsResult batchGetIncidentFindings(BatchGetIncidentFindingsRequest batchGetIncidentFindingsRequest);
     ...
     *      target="_top">AWS API Documentation</a>
     */
    ListIncidentFindingsResult listIncidentFindings(ListIncidentFindingsRequest listIncidentFindingsRequest);
