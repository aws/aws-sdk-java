...
/**
 * UpdateResponsePlanResult JSON Unmarshaller
 */
...
public class UpdateResponsePlanResultJsonUnmarshaller implements Unmarshaller<UpdateResponsePlanResult, JsonUnmarshallerContext> {
    ...
    public UpdateResponsePlanResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateResponsePlanResult updateResponsePlanResult = new UpdateResponsePlanResult();
