...
class WaitForReplicationSetDeleted {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<GetReplicationSetResult> {
        /**
    ...
    static class IsDELETINGMatcher extends WaiterAcceptor<GetReplicationSetResult> {
