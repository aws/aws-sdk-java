        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("creationTime", targetDepth)) {
                    context.nextToken();
                    finding.setCreationTime(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
                if (context.testExpression("details", targetDepth)) {
                    context.nextToken();
                    finding.setDetails(FindingDetailsJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("lastModifiedTime", targetDepth)) {
                    context.nextToken();
                    finding.setLastModifiedTime(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
