...
public class ListIncidentFindingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of findings that represent deployments that might be the potential cause of the incident.
     */
    ...
    public ListIncidentFindingsResult withFindings(FindingSummary... findings) {
    ...
    public ListIncidentFindingsResult withFindings(java.util.Collection<FindingSummary> findings) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListIncidentFindingsResult == false)
            return false;
        ListIncidentFindingsResult other = (ListIncidentFindingsResult) obj;
    ...
    public ListIncidentFindingsResult clone() {
        try {
            return (ListIncidentFindingsResult) super.clone();
