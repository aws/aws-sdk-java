...
public class FindingMarshaller {
    ...
    public void marshall(Finding finding, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(finding.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(finding.getDetails(), DETAILS_BINDING);
            protocolMarshaller.marshall(finding.getId(), ID_BINDING);
            protocolMarshaller.marshall(finding.getLastModifiedTime(), LASTMODIFIEDTIME_BINDING);
        } catch (Exception e) {
