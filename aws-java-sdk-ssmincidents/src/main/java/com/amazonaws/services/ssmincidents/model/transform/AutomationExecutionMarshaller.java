...
public class AutomationExecutionMarshaller {
    ...
    private static final MarshallingInfo<String> SSMEXECUTIONARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ssmExecutionArn").build();
    ...
    public void marshall(AutomationExecution automationExecution, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(automationExecution.getSsmExecutionArn(), SSMEXECUTIONARN_BINDING);
        } catch (Exception e) {
