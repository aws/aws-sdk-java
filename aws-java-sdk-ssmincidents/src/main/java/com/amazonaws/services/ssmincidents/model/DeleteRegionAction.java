...
public class DeleteRegionAction implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRegionAction == false)
            return false;
        DeleteRegionAction other = (DeleteRegionAction) obj;
    ...
    @Override
    public DeleteRegionAction clone() {
        try {
            return (DeleteRegionAction) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.ssmincidents.model.transform.DeleteRegionActionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
