 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotfleetwise-2021-06-17/TimestreamResources" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TimestreamResources implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getTimestreamTableName() != null)
            sb.append("TimestreamTableName: ").append(getTimestreamTableName());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimestreamResources == false)
            return false;
    ...
    public TimestreamResources clone() {
        try {
            return (TimestreamResources) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotfleetwise.model.transform.TimestreamResourcesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
