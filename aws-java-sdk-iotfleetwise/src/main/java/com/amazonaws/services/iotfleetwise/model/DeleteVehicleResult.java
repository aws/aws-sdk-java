...
public class DeleteVehicleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteVehicleResult withVehicleName(String vehicleName) {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the deleted vehicle.
     */
    ...
    public DeleteVehicleResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVehicleResult == false)
            return false;
        DeleteVehicleResult other = (DeleteVehicleResult) obj;
    ...
    @Override
    public DeleteVehicleResult clone() {
        try {
            return (DeleteVehicleResult) super.clone();
