...
public class NetworkInterfaceMarshaller {
    ...
    private static final MarshallingInfo<String> INTERFACEID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("interfaceId").build();
    private static final MarshallingInfo<String> TYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("type").build();
    private static final MarshallingInfo<StructuredPojo> CANINTERFACE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public void marshall(NetworkInterface networkInterface, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(networkInterface.getInterfaceId(), INTERFACEID_BINDING);
