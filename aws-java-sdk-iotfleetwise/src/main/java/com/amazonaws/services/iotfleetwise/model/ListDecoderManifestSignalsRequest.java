...
public class ListDecoderManifestSignalsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the decoder manifest to list information about.
     */
    ...
    public ListDecoderManifestSignalsRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public ListDecoderManifestSignalsRequest withNextToken(String nextToken) {
    ...
    public ListDecoderManifestSignalsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDecoderManifestSignalsRequest == false)
            return false;
        ListDecoderManifestSignalsRequest other = (ListDecoderManifestSignalsRequest) obj;
    ...
    @Override
    public ListDecoderManifestSignalsRequest clone() {
        return (ListDecoderManifestSignalsRequest) super.clone();
    }
