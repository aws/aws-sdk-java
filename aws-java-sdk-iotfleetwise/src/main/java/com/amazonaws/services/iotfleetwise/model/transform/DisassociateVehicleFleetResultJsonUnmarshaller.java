...
/**
 * DisassociateVehicleFleetResult JSON Unmarshaller
 */
...
public class DisassociateVehicleFleetResultJsonUnmarshaller implements Unmarshaller<DisassociateVehicleFleetResult, JsonUnmarshallerContext> {
    ...
    public DisassociateVehicleFleetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateVehicleFleetResult disassociateVehicleFleetResult = new DisassociateVehicleFleetResult();
