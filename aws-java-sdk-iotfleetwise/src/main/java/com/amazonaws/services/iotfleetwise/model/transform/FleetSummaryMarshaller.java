...
public class FleetSummaryMarshaller {
    ...
    public void marshall(FleetSummary fleetSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(fleetSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(fleetSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(fleetSummary.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(fleetSummary.getSignalCatalogArn(), SIGNALCATALOGARN_BINDING);
            protocolMarshaller.marshall(fleetSummary.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(fleetSummary.getLastModificationTime(), LASTMODIFICATIONTIME_BINDING);
        } catch (Exception e) {
