...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotfleetwise-2021-06-17/ListDecoderManifests" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDecoderManifestsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDecoderManifestsRequest withModelManifestArn(String modelManifestArn) {
    ...
    public ListDecoderManifestsRequest withNextToken(String nextToken) {
    ...
    public ListDecoderManifestsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDecoderManifestsRequest == false)
            return false;
    ...
    @Override
    public ListDecoderManifestsRequest clone() {
        return (ListDecoderManifestsRequest) super.clone();
    }
