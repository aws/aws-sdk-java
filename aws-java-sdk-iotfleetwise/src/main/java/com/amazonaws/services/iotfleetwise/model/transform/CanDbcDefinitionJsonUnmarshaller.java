...
/**
 * CanDbcDefinition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CanDbcDefinitionJsonUnmarshaller implements Unmarshaller<CanDbcDefinition, JsonUnmarshallerContext> {

    public CanDbcDefinition unmarshall(JsonUnmarshallerContext context) throws Exception {
        CanDbcDefinition canDbcDefinition = new CanDbcDefinition();
    ...
    private static CanDbcDefinitionJsonUnmarshaller instance;

    public static CanDbcDefinitionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CanDbcDefinitionJsonUnmarshaller();
        return instance;
    }
}
