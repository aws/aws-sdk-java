...
public class UpdateCampaignRequestMarshaller {
    ...
    public void marshall(UpdateCampaignRequest updateCampaignRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateCampaignRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateCampaignRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateCampaignRequest.getDataExtraDimensions(), DATAEXTRADIMENSIONS_BINDING);
            protocolMarshaller.marshall(updateCampaignRequest.getAction(), ACTION_BINDING);
        } catch (Exception e) {
