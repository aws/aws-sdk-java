...
public class PutLoggingOptionsRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CLOUDWATCHLOGDELIVERY_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("cloudWatchLogDelivery").build();
    ...
    public void marshall(PutLoggingOptionsRequest putLoggingOptionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putLoggingOptionsRequest.getCloudWatchLogDelivery(), CLOUDWATCHLOGDELIVERY_BINDING);
        } catch (Exception e) {
