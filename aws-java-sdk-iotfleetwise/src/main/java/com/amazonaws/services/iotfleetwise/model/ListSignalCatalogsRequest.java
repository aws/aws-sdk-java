...
public class ListSignalCatalogsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListSignalCatalogsRequest withNextToken(String nextToken) {
    ...
    public ListSignalCatalogsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSignalCatalogsRequest == false)
            return false;
        ListSignalCatalogsRequest other = (ListSignalCatalogsRequest) obj;
    ...
    @Override
    public ListSignalCatalogsRequest clone() {
        return (ListSignalCatalogsRequest) super.clone();
    }
