...
/**
 * ConditionBasedCollectionScheme JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConditionBasedCollectionSchemeJsonUnmarshaller implements Unmarshaller<ConditionBasedCollectionScheme, JsonUnmarshallerContext> {

    public ConditionBasedCollectionScheme unmarshall(JsonUnmarshallerContext context) throws Exception {
        ConditionBasedCollectionScheme conditionBasedCollectionScheme = new ConditionBasedCollectionScheme();
    ...
    private static ConditionBasedCollectionSchemeJsonUnmarshaller instance;

    public static ConditionBasedCollectionSchemeJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConditionBasedCollectionSchemeJsonUnmarshaller();
        return instance;
    }
}
