...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotfleetwise-2021-06-17/ListModelManifests" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListModelManifestsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        The ARN of a signal catalog. If you specify a signal catalog, only the vehicle models associated with it
     *        are returned.
     */
    ...
    public ListModelManifestsRequest withSignalCatalogArn(String signalCatalogArn) {
    ...
    public ListModelManifestsRequest withNextToken(String nextToken) {
    ...
    public ListModelManifestsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListModelManifestsRequest == false)
            return false;
    ...
    @Override
    public ListModelManifestsRequest clone() {
        return (ListModelManifestsRequest) super.clone();
    }
