...
/**
 * CanInterface JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CanInterfaceJsonUnmarshaller implements Unmarshaller<CanInterface, JsonUnmarshallerContext> {

    public CanInterface unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static CanInterfaceJsonUnmarshaller instance;

    public static CanInterfaceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CanInterfaceJsonUnmarshaller();
        return instance;
    }
}
