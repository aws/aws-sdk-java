...
public class MessageSignalMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> STRUCTUREDMESSAGE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("structuredMessage").build();
    ...
    public void marshall(MessageSignal messageSignal, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(messageSignal.getTopicName(), TOPICNAME_BINDING);
            protocolMarshaller.marshall(messageSignal.getStructuredMessage(), STRUCTUREDMESSAGE_BINDING);
        } catch (Exception e) {
