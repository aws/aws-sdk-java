...
@SdkInternalApi
public class CreateVehicleRequestMarshaller {
    ...
    private static final CreateVehicleRequestMarshaller instance = new CreateVehicleRequestMarshaller();

    public static CreateVehicleRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateVehicleRequest createVehicleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createVehicleRequest.getVehicleName(), VEHICLENAME_BINDING);
            protocolMarshaller.marshall(createVehicleRequest.getModelManifestArn(), MODELMANIFESTARN_BINDING);
            protocolMarshaller.marshall(createVehicleRequest.getDecoderManifestArn(), DECODERMANIFESTARN_BINDING);
            protocolMarshaller.marshall(createVehicleRequest.getAttributes(), ATTRIBUTES_BINDING);
            protocolMarshaller.marshall(createVehicleRequest.getAssociationBehavior(), ASSOCIATIONBEHAVIOR_BINDING);
            protocolMarshaller.marshall(createVehicleRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
