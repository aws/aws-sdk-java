...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.iotfleetwise.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.iotfleetwise.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iotfleetwise.model.ValidationException validationException = new com.amazonaws.services.iotfleetwise.model.ValidationException(
                null);
