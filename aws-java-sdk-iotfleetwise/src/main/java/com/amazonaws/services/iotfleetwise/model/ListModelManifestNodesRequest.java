...
public class ListModelManifestNodesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the vehicle model to list information about.
     */
    ...
    public ListModelManifestNodesRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public ListModelManifestNodesRequest withNextToken(String nextToken) {
    ...
    public ListModelManifestNodesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListModelManifestNodesRequest == false)
            return false;
        ListModelManifestNodesRequest other = (ListModelManifestNodesRequest) obj;
    ...
    @Override
    public ListModelManifestNodesRequest clone() {
        return (ListModelManifestNodesRequest) super.clone();
    }
