...
/**
 * Update Evaluation Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (updateEvaluationRequest.getEvaluationId() != null) {
                jsonWriter.key("EvaluationId").value(updateEvaluationRequest.getEvaluationId());
            }
            if (updateEvaluationRequest.getEvaluationName() != null) {
                jsonWriter.key("EvaluationName").value(updateEvaluationRequest.getEvaluationName());
            }
