...
@SdkInternalApi
public class DescribeDataSourcesFunction implements
        SdkFunction<DescribeDataSourcesRequest, DescribeDataSourcesResult> {
     ...
     */
    @Override
    public DescribeDataSourcesResult apply(
