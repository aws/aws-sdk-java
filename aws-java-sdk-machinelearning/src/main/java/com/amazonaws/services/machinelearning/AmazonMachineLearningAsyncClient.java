...
public class AmazonMachineLearningAsyncClient extends
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * Machine Learning using the specified parameters.
     *
    ...
    public java.util.concurrent.Future<CreateBatchPredictionResult> createBatchPredictionAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateBatchPredictionResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<CreateDataSourceFromRDSResult> createDataSourceFromRDSAsync(
    ...
    public java.util.concurrent.Future<CreateDataSourceFromRDSResult> createDataSourceFromRDSAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateDataSourceFromRDSResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<CreateDataSourceFromRedshiftResult> createDataSourceFromRedshiftAsync(
    ...
    public java.util.concurrent.Future<CreateDataSourceFromRedshiftResult> createDataSourceFromRedshiftAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateDataSourceFromRedshiftResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<CreateDataSourceFromS3Result> createDataSourceFromS3Async(
    ...
    public java.util.concurrent.Future<CreateDataSourceFromS3Result> createDataSourceFromS3Async(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateDataSourceFromS3Result>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<CreateEvaluationResult> createEvaluationAsync(
    ...
    public java.util.concurrent.Future<CreateEvaluationResult> createEvaluationAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateEvaluationResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<CreateMLModelResult> createMLModelAsync(
    ...
    public java.util.concurrent.Future<CreateMLModelResult> createMLModelAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateMLModelResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<CreateRealtimeEndpointResult> createRealtimeEndpointAsync(
    ...
    public java.util.concurrent.Future<CreateRealtimeEndpointResult> createRealtimeEndpointAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateRealtimeEndpointResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<DeleteBatchPredictionResult> deleteBatchPredictionAsync(
    ...
    public java.util.concurrent.Future<DeleteBatchPredictionResult> deleteBatchPredictionAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeleteBatchPredictionResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<DeleteDataSourceResult> deleteDataSourceAsync(
    ...
    public java.util.concurrent.Future<DeleteDataSourceResult> deleteDataSourceAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeleteDataSourceResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<DeleteEvaluationResult> deleteEvaluationAsync(
    ...
    public java.util.concurrent.Future<DeleteEvaluationResult> deleteEvaluationAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeleteEvaluationResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<DeleteMLModelResult> deleteMLModelAsync(
    ...
    public java.util.concurrent.Future<DeleteMLModelResult> deleteMLModelAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeleteMLModelResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<DeleteRealtimeEndpointResult> deleteRealtimeEndpointAsync(
    ...
    public java.util.concurrent.Future<DeleteRealtimeEndpointResult> deleteRealtimeEndpointAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeleteRealtimeEndpointResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<DescribeBatchPredictionsResult> describeBatchPredictionsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DescribeBatchPredictionsResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<DescribeDataSourcesResult> describeDataSourcesAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DescribeDataSourcesResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<DescribeEvaluationsResult> describeEvaluationsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DescribeEvaluationsResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<DescribeMLModelsResult> describeMLModelsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DescribeMLModelsResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<GetBatchPredictionResult> getBatchPredictionAsync(
    ...
    public java.util.concurrent.Future<GetBatchPredictionResult> getBatchPredictionAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetBatchPredictionResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<GetDataSourceResult> getDataSourceAsync(
    ...
    public java.util.concurrent.Future<GetDataSourceResult> getDataSourceAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetDataSourceResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<GetEvaluationResult> getEvaluationAsync(
    ...
    public java.util.concurrent.Future<GetEvaluationResult> getEvaluationAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetEvaluationResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<GetMLModelResult> getMLModelAsync(
    ...
    public java.util.concurrent.Future<GetMLModelResult> getMLModelAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetMLModelResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<PredictResult> predictAsync(
    ...
    public java.util.concurrent.Future<PredictResult> predictAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<PredictResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<UpdateBatchPredictionResult> updateBatchPredictionAsync(
    ...
    public java.util.concurrent.Future<UpdateBatchPredictionResult> updateBatchPredictionAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UpdateBatchPredictionResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<UpdateDataSourceResult> updateDataSourceAsync(
    ...
    public java.util.concurrent.Future<UpdateDataSourceResult> updateDataSourceAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UpdateDataSourceResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<UpdateEvaluationResult> updateEvaluationAsync(
    ...
    public java.util.concurrent.Future<UpdateEvaluationResult> updateEvaluationAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UpdateEvaluationResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<UpdateMLModelResult> updateMLModelAsync(
    ...
    public java.util.concurrent.Future<UpdateMLModelResult> updateMLModelAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UpdateMLModelResult>() {
                    @Override
