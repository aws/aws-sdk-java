...
/**
 * Delete Data Source Result JSON Unmarshaller
 */
public class DeleteDataSourceResultJsonUnmarshaller implements Unmarshaller<DeleteDataSourceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DataSourceId", targetDepth)) {
                    context.nextToken();
                    deleteDataSourceResult.setDataSourceId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DeleteDataSourceResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteDataSourceResultJsonUnmarshaller();
        return instance;
    }
}
