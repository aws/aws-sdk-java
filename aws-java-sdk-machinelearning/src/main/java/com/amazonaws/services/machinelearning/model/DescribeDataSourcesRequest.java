...
/**
 * Container for the parameters to the {@link com.amazonaws.services.machinelearning.AmazonMachineLearning#describeDataSources(DescribeDataSourcesRequest) DescribeDataSources operation}.
 * <p>
 * Returns a list of <code>DataSource</code> that match the search
 * criteria in the request.
 * </p>
 *
 * @see com.amazonaws.services.machinelearning.AmazonMachineLearning#describeDataSources(DescribeDataSourcesRequest)
 */
public class DescribeDataSourcesRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * Use one of the following variables to filter a list of
     * <code>DataSource</code>: <ul> <li><code>CreatedAt</code> - Sets the
     * search criteria to <code>DataSource</code> creation dates.</li>
     * <li><code>Status</code> - Sets the search criteria to
     * <code>DataSource</code> statuses.</li> <li><code>Name</code> - Sets
     * the search criteria to the contents of <code>DataSource</code> <b>
     * </b> <code>Name</code>.</li> <li><code>DataUri</code> - Sets the
     * search criteria to the URI of data files used to create the
     * <code>DataSource</code>. The URI can identify either a file or an
     * Amazon Simple Storage Service (Amazon S3) bucket or directory.</li>
     * <li><code>IAMUser</code> - Sets the search criteria to the user
     * account that invoked the <code>DataSource</code> creation.</li> </ul>
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>CreatedAt, LastUpdatedAt, Status, Name, DataLocationS3, IAMUser
     */
    ...
    /**
     * The greater than operator. The <code>DataSource</code> results will
    ...
    /**
     * The not equal to operator. The <code>DataSource</code> results will
     ...
     * <code>Name</code> or <code>Id</code>. <p>For example, a
     ...
     * list of <code>DataSource</code>. <ul> <li><code>asc</code> - Arranges
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @return The equal to operator. The <code>DataSource</code> results will have
     *         <code>FilterVariable</code> values that exactly match the value
     *         specified with <code>EQ</code>.
     */
    public String getEQ() {
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param eQ The equal to operator. The <code>DataSource</code> results will have
     *         <code>FilterVariable</code> values that exactly match the value
     *         specified with <code>EQ</code>.
     */
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @return The greater than operator. The <code>DataSource</code> results will
     *         have <code>FilterVariable</code> values that are greater than the
     *         value specified with <code>GT</code>.
     */
    public String getGT() {
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param gT The greater than operator. The <code>DataSource</code> results will
     *         have <code>FilterVariable</code> values that are greater than the
     *         value specified with <code>GT</code>.
     */
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @return The less than operator. The <code>DataSource</code> results will have
     *         <code>FilterVariable</code> values that are less than the value
     *         specified with <code>LT</code>.
     */
    public String getLT() {
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param lT The less than operator. The <code>DataSource</code> results will have
     *         <code>FilterVariable</code> values that are less than the value
     *         specified with <code>LT</code>.
     */
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @return The greater than or equal to operator. The <code>DataSource</code>
     *         results will have <code>FilterVariable</code> values that are greater
     *         than or equal to the value specified with <code>GE</code>.
     */
    public String getGE() {
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param gE The greater than or equal to operator. The <code>DataSource</code>
     *         results will have <code>FilterVariable</code> values that are greater
     *         than or equal to the value specified with <code>GE</code>.
     */
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param lE The less than or equal to operator. The <code>DataSource</code>
     *         results will have <code>FilterVariable</code> values that are less
     *         than or equal to the value specified with <code>LE</code>.
     */
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @return The not equal to operator. The <code>DataSource</code> results will
     *         have <code>FilterVariable</code> values not equal to the value
     *         specified with <code>NE</code>.
     */
    public String getNE() {
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param nE The not equal to operator. The <code>DataSource</code> results will
     *         have <code>FilterVariable</code> values not equal to the value
     *         specified with <code>NE</code>.
     */
     ...
     * <b>Range: </b>1 - 100<br/>
     *
     * @param limit The maximum number of <code>DataSource</code> to include in the
     *         result.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeDataSourcesRequest == false) return false;
