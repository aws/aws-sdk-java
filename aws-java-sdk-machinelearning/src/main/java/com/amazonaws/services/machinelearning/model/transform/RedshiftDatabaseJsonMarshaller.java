...
public class RedshiftDatabaseJsonMarshaller {
     ...
     */
    public void marshall(RedshiftDatabase redshiftDatabase, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (redshiftDatabase.getDatabaseName() != null) {
                jsonGenerator.writeFieldName("DatabaseName").writeValue(redshiftDatabase.getDatabaseName());
            }
            if (redshiftDatabase.getClusterIdentifier() != null) {
                jsonGenerator.writeFieldName("ClusterIdentifier").writeValue(redshiftDatabase.getClusterIdentifier());
            }
