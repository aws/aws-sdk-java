...
/**
 * Container for the parameters to the {@link com.amazonaws.services.machinelearning.AmazonMachineLearning#describeMLModels(DescribeMLModelsRequest) DescribeMLModels operation}.
 * <p>
 * Returns a list of <code>MLModel</code> that match the search criteria
 * in the request.
 * </p>
 *
 * @see com.amazonaws.services.machinelearning.AmazonMachineLearning#describeMLModels(DescribeMLModelsRequest)
 */
public class DescribeMLModelsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * Use one of the following variables to filter a list of
     * <code>MLModel</code>: <ul> <li><code>CreatedAt</code> - Sets the
     * search criteria to <code>MLModel</code> creation date.</li>
     * <li><code>Status</code> - Sets the search criteria to
     * <code>MLModel</code> status.</li> <li><code>Name</code> - Sets the
     * search criteria to the contents of <code>MLModel</code><b> </b>
     * <code>Name</code>.</li> <li><code>IAMUser</code> - Sets the search
     * criteria to the user account that invoked the <code>MLModel</code>
     * creation.</li> <li><code>TrainingDataSourceId</code> - Sets the search
     * criteria to the <code>DataSource</code> used to train one or more
     * <code>MLModel</code>.</li> <li><code>RealtimeEndpointStatus</code> -
     * Sets the search criteria to the <code>MLModel</code> real-time
     * endpoint status.</li> <li><code>MLModelType</code> - Sets the search
     * criteria to <code>MLModel</code> type: binary, regression, or
     * multi-class.</li> <li><code>Algorithm</code> - Sets the search
     * criteria to the algorithm that the <code>MLModel</code> uses.</li>
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>CreatedAt, LastUpdatedAt, Status, Name, IAMUser, TrainingDataSourceId, RealtimeEndpointStatus, MLModelType, Algorithm, TrainingDataURI
     */
    ...
    /**
     * The less than or equal to operator. The <code>MLModel</code> results
     * will have <code>FilterVariable</code> values that are less than or
     ...
     * <code>FilterVariable</code> values not equal to the value specified
     * with <code>NE</code>.
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Length: </b>0 - 1024<br/>
     ...
     * list of <code>MLModel</code>. <ul> <li><code>asc</code> - Arranges the
     * list in ascending order (A-Z, 0-9).</li> <li><code>dsc</code> -
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param eQ The equal to operator. The <code>MLModel</code> results will have
     *         <code>FilterVariable</code> values that exactly match the value
     *         specified with <code>EQ</code>.
     */
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @return The greater than operator. The <code>MLModel</code> results will have
     *         <code>FilterVariable</code> values that are greater than the value
     *         specified with <code>GT</code>.
     */
    public String getGT() {
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param gT The greater than operator. The <code>MLModel</code> results will have
     *         <code>FilterVariable</code> values that are greater than the value
     *         specified with <code>GT</code>.
     */
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @return The less than operator. The <code>MLModel</code> results will have
     *         <code>FilterVariable</code> values that are less than the value
     *         specified with <code>LT</code>.
     */
    public String getLT() {
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param lT The less than operator. The <code>MLModel</code> results will have
     *         <code>FilterVariable</code> values that are less than the value
     *         specified with <code>LT</code>.
     */
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param gE The greater than or equal to operator. The <code>MLModel</code>
     *         results will have <code>FilterVariable</code> values that are greater
     *         than or equal to the value specified with <code>GE</code>.
     */
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @return The less than or equal to operator. The <code>MLModel</code> results
     *         will have <code>FilterVariable</code> values that are less than or
     *         equal to the value specified with <code>LE</code>.
     */
    public String getLE() {
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param lE The less than or equal to operator. The <code>MLModel</code> results
     *         will have <code>FilterVariable</code> values that are less than or
     *         equal to the value specified with <code>LE</code>.
     */
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @return The not equal to operator. The <code>MLModel</code> results will have
     *         <code>FilterVariable</code> values not equal to the value specified
     *         with <code>NE</code>.
     */
    public String getNE() {
     ...
     * <b>Pattern: </b>.*\S.*|^$<br/>
     *
     * @param nE The not equal to operator. The <code>MLModel</code> results will have
     *         <code>FilterVariable</code> values not equal to the value specified
     *         with <code>NE</code>.
     */
     ...
     * <b>Range: </b>1 - 100<br/>
     *
     * @return The number of pages of information to include in the result. The range
     *         of acceptable values is 1 through 100. The default value is 100.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMLModelsRequest == false) return false;
