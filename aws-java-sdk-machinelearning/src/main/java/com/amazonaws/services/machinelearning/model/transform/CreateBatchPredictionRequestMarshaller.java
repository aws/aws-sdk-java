...
/**
 * Create Batch Prediction Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (createBatchPredictionRequest.getBatchPredictionId() != null) {
                jsonWriter.key("BatchPredictionId").value(createBatchPredictionRequest.getBatchPredictionId());
            }
            if (createBatchPredictionRequest.getBatchPredictionName() != null) {
                jsonWriter.key("BatchPredictionName").value(createBatchPredictionRequest.getBatchPredictionName());
            }
            if (createBatchPredictionRequest.getMLModelId() != null) {
                jsonWriter.key("MLModelId").value(createBatchPredictionRequest.getMLModelId());
            }
            if (createBatchPredictionRequest.getBatchPredictionDataSourceId() != null) {
                jsonWriter.key("BatchPredictionDataSourceId").value(createBatchPredictionRequest.getBatchPredictionDataSourceId());
            }
            if (createBatchPredictionRequest.getOutputUri() != null) {
                jsonWriter.key("OutputUri").value(createBatchPredictionRequest.getOutputUri());
            }
