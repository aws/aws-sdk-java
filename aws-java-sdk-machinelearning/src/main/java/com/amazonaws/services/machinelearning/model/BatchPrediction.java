 ...
 * data file information of a <i>Batch Prediction</i> .
 * </p>
 */
public class BatchPrediction implements Serializable, Cloneable {
    ...
    /**
     * The time that the <code>BatchPrediction</code> was created. The time
    ...
    /**
     * The status of the <code>BatchPrediction</code>. This element can have
     ...
     * <b>Pattern: </b>[a-zA-Z0-9_.-]+<br/>
     *
     * @return The ID assigned to the <code>BatchPrediction</code> at creation. This
     *         value should be identical to the value of the
     *         <code>BatchPredictionID</code> in the request.
     */
     ...
     * <b>Pattern: </b>[a-zA-Z0-9_.-]+<br/>
     *
     * @param batchPredictionId The ID assigned to the <code>BatchPrediction</code> at creation. This
     *         value should be identical to the value of the
     *         <code>BatchPredictionID</code> in the request.
     */
     ...
     * is expressed in epoch time.
     *
     * @return The time that the <code>BatchPrediction</code> was created. The time
     *         is expressed in epoch time.
     */
     ...
     * is expressed in epoch time.
     *
     * @param createdAt The time that the <code>BatchPrediction</code> was created. The time
     *         is expressed in epoch time.
     */
     ...
     * <b>Allowed Values: </b>PENDING, INPROGRESS, FAILED, COMPLETED, DELETED
     *
     * @return The status of the <code>BatchPrediction</code>. This element can have
     *         one of the following values: <ul> <li><code>PENDING</code> - Amazon
     *         Machine Learning (Amazon ML) submitted a request to generate
     *         predictions for a batch of observations.</li>
     *         <li><code>INPROGRESS</code> - The process is underway.</li>
     ...
     * <b>Allowed Values: </b>PENDING, INPROGRESS, FAILED, COMPLETED, DELETED
     *
     * @param status The status of the <code>BatchPrediction</code>. This element can have
     *         one of the following values: <ul> <li><code>PENDING</code> - Amazon
     *         Machine Learning (Amazon ML) submitted a request to generate
     *         predictions for a batch of observations.</li>
     *         <li><code>INPROGRESS</code> - The process is underway.</li>
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchPrediction == false) return false;
