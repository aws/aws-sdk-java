...
/**
 * Redshift Metadata JSON Unmarshaller
 */
public class RedshiftMetadataJsonUnmarshaller implements Unmarshaller<RedshiftMetadata, JsonUnmarshallerContext> {
    ...
    public RedshiftMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        RedshiftMetadata redshiftMetadata = new RedshiftMetadata();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("DatabaseUserName", targetDepth)) {
                    context.nextToken();
                    redshiftMetadata.setDatabaseUserName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("SelectSqlQuery", targetDepth)) {
                    context.nextToken();
                    redshiftMetadata.setSelectSqlQuery(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static RedshiftMetadataJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RedshiftMetadataJsonUnmarshaller();
        return instance;
    }
}
