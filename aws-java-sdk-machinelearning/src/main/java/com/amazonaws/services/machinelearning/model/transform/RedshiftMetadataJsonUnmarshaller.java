 ...
 */
public class RedshiftMetadataJsonUnmarshaller implements
        Unmarshaller<RedshiftMetadata, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RedshiftDatabase", targetDepth)) {
                    context.nextToken();
                    redshiftMetadata
                            .setRedshiftDatabase(RedshiftDatabaseJsonUnmarshaller
    ...
    public static RedshiftMetadataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RedshiftMetadataJsonUnmarshaller();
        return instance;
    }
}
