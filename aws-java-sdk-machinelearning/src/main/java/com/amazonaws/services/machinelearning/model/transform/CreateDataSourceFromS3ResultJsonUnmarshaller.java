 ...
 */
public class CreateDataSourceFromS3ResultJsonUnmarshaller implements
        Unmarshaller<CreateDataSourceFromS3Result, JsonUnmarshallerContext> {

    public CreateDataSourceFromS3Result unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DataSourceId", targetDepth)) {
                    context.nextToken();
                    createDataSourceFromS3Result.setDataSourceId(context
