...
/**
 * Create Data Source From S3 Result JSON Unmarshaller
 */
public class CreateDataSourceFromS3ResultJsonUnmarshaller implements Unmarshaller<CreateDataSourceFromS3Result, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DataSourceId", targetDepth)) {
                    context.nextToken();
                    createDataSourceFromS3Result.setDataSourceId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CreateDataSourceFromS3ResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreateDataSourceFromS3ResultJsonUnmarshaller();
        return instance;
    }
}
