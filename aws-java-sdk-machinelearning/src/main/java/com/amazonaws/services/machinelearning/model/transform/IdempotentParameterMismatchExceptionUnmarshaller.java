...
public class IdempotentParameterMismatchExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("IdempotentParameterMismatchException"));
        } else {
            return errorTypeFromHeader.equals("IdempotentParameterMismatchException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        IdempotentParameterMismatchException e = (IdempotentParameterMismatchException)super.unmarshall(json);
