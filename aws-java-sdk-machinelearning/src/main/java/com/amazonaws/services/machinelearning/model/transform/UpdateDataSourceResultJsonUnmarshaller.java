...
/**
 * Update Data Source Result JSON Unmarshaller
 */
public class UpdateDataSourceResultJsonUnmarshaller implements Unmarshaller<UpdateDataSourceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DataSourceId", targetDepth)) {
                    context.nextToken();
                    updateDataSourceResult.setDataSourceId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static UpdateDataSourceResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new UpdateDataSourceResultJsonUnmarshaller();
        return instance;
    }
}
