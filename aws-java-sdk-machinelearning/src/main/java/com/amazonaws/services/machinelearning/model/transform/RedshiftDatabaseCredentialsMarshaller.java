...
@SdkInternalApi
public class RedshiftDatabaseCredentialsMarshaller {
    ...
    private static final RedshiftDatabaseCredentialsMarshaller instance = new RedshiftDatabaseCredentialsMarshaller();

    public static RedshiftDatabaseCredentialsMarshaller getInstance() {
        return instance;
    }
