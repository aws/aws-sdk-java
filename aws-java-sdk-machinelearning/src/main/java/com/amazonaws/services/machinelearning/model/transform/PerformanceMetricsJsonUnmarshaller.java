...
/**
 * Performance Metrics JSON Unmarshaller
 */
public class PerformanceMetricsJsonUnmarshaller implements Unmarshaller<PerformanceMetrics, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Properties", targetDepth)) {
                    context.nextToken();
                    performanceMetrics.setProperties(new MapUnmarshaller<String,String>(StringJsonUnmarshaller.getInstance(), StringJsonUnmarshaller.getInstance()).unmarshall(context));
                }
    ...
    public static PerformanceMetricsJsonUnmarshaller getInstance() {
        if (instance == null) instance = new PerformanceMetricsJsonUnmarshaller();
        return instance;
    }
}
