...
public class AddTagsRequestMarshaller implements Marshaller<Request<AddTagsRequest>, AddTagsRequest> {
    ...
    public Request<AddTagsRequest> marshall(AddTagsRequest addTagsRequest) {
        ...
        Request<AddTagsRequest> request = new DefaultRequest<AddTagsRequest>(addTagsRequest, "AmazonMachineLearning");
        request.addHeader("X-Amz-Target", "AmazonML_20141212.AddTags");
        ...
        try {
            ...
            if (addTagsRequest.getResourceType() != null) {
                jsonGenerator.writeFieldName("ResourceType").writeValue(addTagsRequest.getResourceType());
            }
