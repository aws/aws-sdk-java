 ...
 */
public class CreateBatchPredictionResultJsonUnmarshaller implements
        Unmarshaller<CreateBatchPredictionResult, JsonUnmarshallerContext> {

    public CreateBatchPredictionResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BatchPredictionId", targetDepth)) {
                    context.nextToken();
                    createBatchPredictionResult.setBatchPredictionId(context
