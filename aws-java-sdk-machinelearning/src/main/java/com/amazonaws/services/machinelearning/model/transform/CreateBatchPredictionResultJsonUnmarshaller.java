...
/**
 * Create Batch Prediction Result JSON Unmarshaller
 */
public class CreateBatchPredictionResultJsonUnmarshaller implements Unmarshaller<CreateBatchPredictionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BatchPredictionId", targetDepth)) {
                    context.nextToken();
                    createBatchPredictionResult.setBatchPredictionId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CreateBatchPredictionResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CreateBatchPredictionResultJsonUnmarshaller();
        return instance;
    }
}
