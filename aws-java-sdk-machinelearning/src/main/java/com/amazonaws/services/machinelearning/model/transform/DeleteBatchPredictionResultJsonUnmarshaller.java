...
/**
 * Delete Batch Prediction Result JSON Unmarshaller
 */
public class DeleteBatchPredictionResultJsonUnmarshaller implements Unmarshaller<DeleteBatchPredictionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BatchPredictionId", targetDepth)) {
                    context.nextToken();
                    deleteBatchPredictionResult.setBatchPredictionId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DeleteBatchPredictionResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteBatchPredictionResultJsonUnmarshaller();
        return instance;
    }
}
