 ...
 */
public class DeleteBatchPredictionResultJsonUnmarshaller implements
        Unmarshaller<DeleteBatchPredictionResult, JsonUnmarshallerContext> {

    public DeleteBatchPredictionResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BatchPredictionId", targetDepth)) {
                    context.nextToken();
                    deleteBatchPredictionResult.setBatchPredictionId(context
