...
public class PredictorNotMountedExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public boolean match(String errorTypeFromHeader, JSONObject json) throws Exception {
        if (errorTypeFromHeader == null) {
            ...
            return (errorCodeFromContent != null && errorCodeFromContent.equals("PredictorNotMountedException"));
        } else {
            return errorTypeFromHeader.equals("PredictorNotMountedException");
        }
    }

    @Override
    public AmazonServiceException unmarshall(JSONObject json) throws Exception {
        PredictorNotMountedException e = (PredictorNotMountedException)super.unmarshall(json);
