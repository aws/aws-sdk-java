...
public class DeleteRealtimeEndpointRequestMarshaller
        implements
        Marshaller<Request<DeleteRealtimeEndpointRequest>, DeleteRealtimeEndpointRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DeleteRealtimeEndpointRequestMarshaller(
    ...
    public Request<DeleteRealtimeEndpointRequest> marshall(
        ...
        Request<DeleteRealtimeEndpointRequest> request = new DefaultRequest<DeleteRealtimeEndpointRequest>(
        ...
        try {
            ...
            if (deleteRealtimeEndpointRequest.getMLModelId() != null) {
                jsonGenerator.writeFieldName("MLModelId").writeValue(
                        deleteRealtimeEndpointRequest.getMLModelId());
            }
