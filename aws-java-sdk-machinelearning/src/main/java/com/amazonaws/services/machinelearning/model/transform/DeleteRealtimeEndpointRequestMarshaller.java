...
public class DeleteRealtimeEndpointRequestMarshaller implements Marshaller<Request<DeleteRealtimeEndpointRequest>, DeleteRealtimeEndpointRequest> {
    ...
    public Request<DeleteRealtimeEndpointRequest> marshall(DeleteRealtimeEndpointRequest deleteRealtimeEndpointRequest) {
        ...
        Request<DeleteRealtimeEndpointRequest> request = new DefaultRequest<DeleteRealtimeEndpointRequest>(deleteRealtimeEndpointRequest,
        ...
        try {
            ...
            if (deleteRealtimeEndpointRequest.getMLModelId() != null) {
                jsonGenerator.writeFieldName("MLModelId").writeValue(deleteRealtimeEndpointRequest.getMLModelId());
            }
