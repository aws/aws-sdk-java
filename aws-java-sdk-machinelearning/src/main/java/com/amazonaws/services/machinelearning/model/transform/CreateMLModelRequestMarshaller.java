...
/**
 * Create M L Model Request Marshaller
 */
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (createMLModelRequest.getMLModelId() != null) {
                jsonWriter.key("MLModelId").value(createMLModelRequest.getMLModelId());
            }
            if (createMLModelRequest.getMLModelName() != null) {
                jsonWriter.key("MLModelName").value(createMLModelRequest.getMLModelName());
            }
            if (createMLModelRequest.getMLModelType() != null) {
                jsonWriter.key("MLModelType").value(createMLModelRequest.getMLModelType());
            }
            if (createMLModelRequest.getParameters() != null) {
                jsonWriter.key("Parameters");
                jsonWriter.object();
                for (Map.Entry<String, String> parametersListValue : createMLModelRequest.getParameters().entrySet()) {
            ...
            if (createMLModelRequest.getTrainingDataSourceId() != null) {
                jsonWriter.key("TrainingDataSourceId").value(createMLModelRequest.getTrainingDataSourceId());
            }
            if (createMLModelRequest.getRecipe() != null) {
                jsonWriter.key("Recipe").value(createMLModelRequest.getRecipe());
            }
            if (createMLModelRequest.getRecipeUri() != null) {
                jsonWriter.key("RecipeUri").value(createMLModelRequest.getRecipeUri());
            }
