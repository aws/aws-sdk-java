...
@SdkInternalApi
public class DescribeBatchPredictionsFunction
        implements
        SdkFunction<DescribeBatchPredictionsRequest, DescribeBatchPredictionsResult> {
     ...
     */
    @Override
    public DescribeBatchPredictionsResult apply(
