...
public class GetMLModelRequestMarshaller implements Marshaller<Request<GetMLModelRequest>, GetMLModelRequest> {
    ...
    public GetMLModelRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<GetMLModelRequest> marshall(GetMLModelRequest getMLModelRequest) {
        ...
        request.addHeader("X-Amz-Target", "AmazonML_20141212.GetMLModel");
        ...
        try {
            ...
            if (getMLModelRequest.getMLModelId() != null) {
                jsonGenerator.writeFieldName("MLModelId").writeValue(getMLModelRequest.getMLModelId());
            }
            if (getMLModelRequest.getVerbose() != null) {
                jsonGenerator.writeFieldName("Verbose").writeValue(getMLModelRequest.getVerbose());
            }
