...
/**
 * Describe Data Sources Result JSON Unmarshaller
 */
public class DescribeDataSourcesResultJsonUnmarshaller implements Unmarshaller<DescribeDataSourcesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeDataSourcesResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DescribeDataSourcesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeDataSourcesResultJsonUnmarshaller();
        return instance;
    }
}
