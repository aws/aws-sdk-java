 ...
 */
public class DescribeDataSourcesResultJsonUnmarshaller implements
        Unmarshaller<DescribeDataSourcesResult, JsonUnmarshallerContext> {

    public DescribeDataSourcesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Results", targetDepth)) {
                    ...
                    describeDataSourcesResult
                            .setResults(new ListUnmarshaller<DataSource>(
                                    DataSourceJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeDataSourcesResult.setNextToken(context
