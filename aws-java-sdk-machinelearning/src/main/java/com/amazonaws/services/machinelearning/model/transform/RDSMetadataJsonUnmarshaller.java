...
/**
 * R D S Metadata JSON Unmarshaller
 */
public class RDSMetadataJsonUnmarshaller implements Unmarshaller<RDSMetadata, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("DatabaseUserName", targetDepth)) {
                    context.nextToken();
                    rDSMetadata.setDatabaseUserName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("SelectSqlQuery", targetDepth)) {
                    context.nextToken();
                    rDSMetadata.setSelectSqlQuery(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ResourceRole", targetDepth)) {
                    context.nextToken();
                    rDSMetadata.setResourceRole(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ServiceRole", targetDepth)) {
                    context.nextToken();
                    rDSMetadata.setServiceRole(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("DataPipelineId", targetDepth)) {
                    context.nextToken();
                    rDSMetadata.setDataPipelineId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static RDSMetadataJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RDSMetadataJsonUnmarshaller();
        return instance;
    }
}
