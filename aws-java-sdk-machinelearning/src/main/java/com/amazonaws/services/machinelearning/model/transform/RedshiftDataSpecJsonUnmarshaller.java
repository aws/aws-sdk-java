 ...
 */
public class RedshiftDataSpecJsonUnmarshaller implements
        Unmarshaller<RedshiftDataSpec, JsonUnmarshallerContext> {

    public RedshiftDataSpec unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DatabaseInformation", targetDepth)) {
                    context.nextToken();
                    redshiftDataSpec
                            .setDatabaseInformation(RedshiftDatabaseJsonUnmarshaller
                ...
                if (context.testExpression("DatabaseCredentials", targetDepth)) {
                    context.nextToken();
                    redshiftDataSpec
                            .setDatabaseCredentials(RedshiftDatabaseCredentialsJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
