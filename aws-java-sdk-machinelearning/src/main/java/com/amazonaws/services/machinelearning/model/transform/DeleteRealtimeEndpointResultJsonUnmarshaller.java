...
/**
 * Delete Realtime Endpoint Result JSON Unmarshaller
 */
public class DeleteRealtimeEndpointResultJsonUnmarshaller implements Unmarshaller<DeleteRealtimeEndpointResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MLModelId", targetDepth)) {
                    context.nextToken();
                    deleteRealtimeEndpointResult.setMLModelId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DeleteRealtimeEndpointResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DeleteRealtimeEndpointResultJsonUnmarshaller();
        return instance;
    }
}
