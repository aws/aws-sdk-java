 ...
 */
public class DeleteRealtimeEndpointResultJsonUnmarshaller implements
        Unmarshaller<DeleteRealtimeEndpointResult, JsonUnmarshallerContext> {

    public DeleteRealtimeEndpointResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MLModelId", targetDepth)) {
                    context.nextToken();
                    deleteRealtimeEndpointResult.setMLModelId(context
