...
@SdkInternalApi
public class DescribeEvaluationsFunction implements
        SdkFunction<DescribeEvaluationsRequest, DescribeEvaluationsResult> {
     ...
     */
    @Override
    public DescribeEvaluationsResult apply(
