...
public class UpdateMLModelRequestMarshaller implements Marshaller<Request<UpdateMLModelRequest>, UpdateMLModelRequest> {
    ...
    public UpdateMLModelRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<UpdateMLModelRequest> marshall(UpdateMLModelRequest updateMLModelRequest) {
        ...
        try {
            ...
            if (updateMLModelRequest.getScoreThreshold() != null) {
                jsonGenerator.writeFieldName("ScoreThreshold").writeValue(updateMLModelRequest.getScoreThreshold());
            }
