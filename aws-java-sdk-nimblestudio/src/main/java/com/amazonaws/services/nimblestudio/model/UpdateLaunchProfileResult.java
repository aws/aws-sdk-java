...
public class UpdateLaunchProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateLaunchProfileResult withLaunchProfile(LaunchProfile launchProfile) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateLaunchProfileResult == false)
            return false;
        UpdateLaunchProfileResult other = (UpdateLaunchProfileResult) obj;
    ...
    @Override
    public UpdateLaunchProfileResult clone() {
        try {
            return (UpdateLaunchProfileResult) super.clone();
