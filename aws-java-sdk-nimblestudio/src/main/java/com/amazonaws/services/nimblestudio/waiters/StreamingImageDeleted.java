...
class StreamingImageDeleted {
    ...
    static class IsDELETEDMatcher extends WaiterAcceptor<GetStreamingImageResult> {
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<GetStreamingImageResult> {
        private static final JsonNode expectedResult;
