...
/**
 * StudioComponentConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StudioComponentConfigurationJsonUnmarshaller implements Unmarshaller<StudioComponentConfiguration, JsonUnmarshallerContext> {

    public StudioComponentConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        StudioComponentConfiguration studioComponentConfiguration = new StudioComponentConfiguration();
    ...
    private static StudioComponentConfigurationJsonUnmarshaller instance;

    public static StudioComponentConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StudioComponentConfigurationJsonUnmarshaller();
        return instance;
    }
}
