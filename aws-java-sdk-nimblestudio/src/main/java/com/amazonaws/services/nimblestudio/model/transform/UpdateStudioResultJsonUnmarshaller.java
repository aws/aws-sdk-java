...
/**
 * UpdateStudioResult JSON Unmarshaller
 */
...
public class UpdateStudioResultJsonUnmarshaller implements Unmarshaller<UpdateStudioResult, JsonUnmarshallerContext> {
    ...
    public UpdateStudioResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateStudioResult updateStudioResult = new UpdateStudioResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("studio", targetDepth)) {
                    context.nextToken();
                    updateStudioResult.setStudio(StudioJsonUnmarshaller.getInstance().unmarshall(context));
                }
