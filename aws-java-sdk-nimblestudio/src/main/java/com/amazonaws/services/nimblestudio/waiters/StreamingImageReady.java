...
class StreamingImageReady {
    ...
    static class IsREADYMatcher extends WaiterAcceptor<GetStreamingImageResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("streamingImage"), new JmesPathField("state"));
         ...
         */
        @Override
        public boolean matches(GetStreamingImageResult result) {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<GetStreamingImageResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATE_FAILEDMatcher extends WaiterAcceptor<GetStreamingImageResult> {
        private static final JsonNode expectedResult;
