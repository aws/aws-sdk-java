...
public enum LaunchProfileValidationType {
    ...
    private LaunchProfileValidationType(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return LaunchProfileValidationType corresponding to the value
     *
    ...
    public static LaunchProfileValidationType fromValue(String value) {
        ...
        for (LaunchProfileValidationType enumEntry : LaunchProfileValidationType.values()) {
