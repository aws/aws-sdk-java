...
public class GetStudioRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetStudioRequest == false)
            return false;
        GetStudioRequest other = (GetStudioRequest) obj;
    ...
    @Override
    public GetStudioRequest clone() {
        return (GetStudioRequest) super.clone();
    }
