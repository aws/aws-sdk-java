...
class StudioDeleted {
    ...
    static class IsDELETEDMatcher extends WaiterAcceptor<GetStudioResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("studio"), new JmesPathField("state"));
         ...
         */
        @Override
        public boolean matches(GetStudioResult result) {
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<GetStudioResult> {
        private static final JsonNode expectedResult;
