...
public class StopStreamingSessionRequestMarshaller {
    ...
    public static StopStreamingSessionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StopStreamingSessionRequest stopStreamingSessionRequest, ProtocolMarshaller protocolMarshaller) {
