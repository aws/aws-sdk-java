...
public class CreateLaunchProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateLaunchProfileResult withLaunchProfile(LaunchProfile launchProfile) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLaunchProfileResult == false)
            return false;
        CreateLaunchProfileResult other = (CreateLaunchProfileResult) obj;
    ...
    @Override
    public CreateLaunchProfileResult clone() {
        try {
            return (CreateLaunchProfileResult) super.clone();
