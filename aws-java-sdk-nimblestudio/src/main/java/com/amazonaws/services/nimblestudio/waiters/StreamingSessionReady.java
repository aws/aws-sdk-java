...
class StreamingSessionReady {
    ...
    static class IsREADYMatcher extends WaiterAcceptor<GetStreamingSessionResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("session"), new JmesPathField("state"));
         ...
         */
        @Override
        public boolean matches(GetStreamingSessionResult result) {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<GetStreamingSessionResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsSTART_FAILEDMatcher extends WaiterAcceptor<GetStreamingSessionResult> {
        private static final JsonNode expectedResult;
