 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/nimble-2020-08-01/StreamConfiguration" target="_top">AWS API
 *      Documentation</a>
 */
...
public class StreamConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public StreamConfiguration withEc2InstanceTypes(java.util.Collection<String> ec2InstanceTypes) {
     ...
     * </p>
     * 
     * @return The upload storage for a streaming session.
     */
    ...
    public StreamConfiguration withStreamingImageIds(java.util.Collection<String> streamingImageIds) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.nimblestudio.model.transform.StreamConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
