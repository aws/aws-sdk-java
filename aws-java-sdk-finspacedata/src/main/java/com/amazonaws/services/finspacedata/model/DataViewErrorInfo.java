 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/finspace-2020-07-13/DataViewErrorInfo" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataViewErrorInfo implements Serializable, Cloneable, StructuredPojo {
    ...
    public DataViewErrorInfo withErrorCategory(String errorCategory) {
    ...
    public DataViewErrorInfo withErrorCategory(ErrorCategory errorCategory) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DataViewErrorInfo == false)
            return false;
    ...
    @Override
    public DataViewErrorInfo clone() {
        try {
            return (DataViewErrorInfo) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.finspacedata.model.transform.DataViewErrorInfoMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
