...
public class DeletePermissionGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique identifier for the deleted permission group.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeletePermissionGroupResult == false)
            return false;
        DeletePermissionGroupResult other = (DeletePermissionGroupResult) obj;
    ...
    public DeletePermissionGroupResult clone() {
        try {
            return (DeletePermissionGroupResult) super.clone();
