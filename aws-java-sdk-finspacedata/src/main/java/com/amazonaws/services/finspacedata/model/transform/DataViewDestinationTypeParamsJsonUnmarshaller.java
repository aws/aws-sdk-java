...
/**
 * DataViewDestinationTypeParams JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataViewDestinationTypeParamsJsonUnmarshaller implements Unmarshaller<DataViewDestinationTypeParams, JsonUnmarshallerContext> {

    public DataViewDestinationTypeParams unmarshall(JsonUnmarshallerContext context) throws Exception {
        DataViewDestinationTypeParams dataViewDestinationTypeParams = new DataViewDestinationTypeParams();
    ...
    private static DataViewDestinationTypeParamsJsonUnmarshaller instance;

    public static DataViewDestinationTypeParamsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DataViewDestinationTypeParamsJsonUnmarshaller();
        return instance;
    }
}
