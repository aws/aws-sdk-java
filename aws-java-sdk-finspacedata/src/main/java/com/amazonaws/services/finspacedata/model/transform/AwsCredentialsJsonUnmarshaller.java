...
/**
 * AwsCredentials JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsCredentialsJsonUnmarshaller implements Unmarshaller<AwsCredentials, JsonUnmarshallerContext> {

    public AwsCredentials unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static AwsCredentialsJsonUnmarshaller instance;

    public static AwsCredentialsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsCredentialsJsonUnmarshaller();
        return instance;
    }
}
