...
public class DeleteDatasetRequestProtocolMarshaller implements Marshaller<Request<DeleteDatasetRequest>, DeleteDatasetRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.REST_JSON).requestUri("/datasetsv2/{datasetId}")
            .httpMethodName(HttpMethodName.DELETE).hasExplicitPayloadMember(false).hasPayloadMembers(false).serviceName("AWSFinSpaceData").build();
