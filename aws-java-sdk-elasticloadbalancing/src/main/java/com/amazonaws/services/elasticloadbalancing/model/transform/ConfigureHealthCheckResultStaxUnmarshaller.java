...
public class ConfigureHealthCheckResultStaxUnmarshaller implements Unmarshaller<ConfigureHealthCheckResult, StaxUnmarshallerContext> {
    ...
    public ConfigureHealthCheckResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return configureHealthCheckResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("HealthCheck", targetDepth)) {
                    configureHealthCheckResult.setHealthCheck(HealthCheckStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ConfigureHealthCheckResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ConfigureHealthCheckResultStaxUnmarshaller();
        return instance;
    }
}
