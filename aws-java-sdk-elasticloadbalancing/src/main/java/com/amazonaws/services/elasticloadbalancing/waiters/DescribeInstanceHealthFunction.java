...
@SdkInternalApi
public class DescribeInstanceHealthFunction
        implements
        SdkFunction<DescribeInstanceHealthRequest, DescribeInstanceHealthResult> {
     ...
     */
    @Override
    public DescribeInstanceHealthResult apply(
