 ...
 * </p>
 */
public class DescribeLoadBalancerPoliciesResult extends
    ...
    public void setPolicyDescriptions(
        ...
        this.policyDescriptions = new com.amazonaws.internal.SdkInternalList<PolicyDescription>(
                policyDescriptions);
    }
    ...
    public DescribeLoadBalancerPoliciesResult withPolicyDescriptions(
        ...
        if (this.policyDescriptions == null) {
            setPolicyDescriptions(new com.amazonaws.internal.SdkInternalList<PolicyDescription>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPolicyDescriptions() == null
                ^ this.getPolicyDescriptions() == null)
            return false;
        if (other.getPolicyDescriptions() != null
                && other.getPolicyDescriptions().equals(
                        this.getPolicyDescriptions()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getPolicyDescriptions() == null) ? 0
                        : getPolicyDescriptions().hashCode());
        return hashCode;
    }
