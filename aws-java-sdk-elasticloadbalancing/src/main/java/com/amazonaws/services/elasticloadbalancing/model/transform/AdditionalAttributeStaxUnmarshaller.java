 ...
 */
public class AdditionalAttributeStaxUnmarshaller implements
        Unmarshaller<AdditionalAttribute, StaxUnmarshallerContext> {

    public AdditionalAttribute unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Key", targetDepth)) {
                    additionalAttribute.setKey(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Value", targetDepth)) {
                    additionalAttribute.setValue(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
