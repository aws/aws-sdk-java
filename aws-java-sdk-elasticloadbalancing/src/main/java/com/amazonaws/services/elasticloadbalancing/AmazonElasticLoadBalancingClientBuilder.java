...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.elasticloadbalancing.AmazonElasticLoadBalancing}
 * . Use of the builder is preferred over using constructors of the client
 * class.
 **/
@NotThreadSafe
public final class AmazonElasticLoadBalancingClientBuilder
        extends
        AwsSyncClientBuilder<AmazonElasticLoadBalancingClientBuilder, AmazonElasticLoadBalancing> {
    ...
    /**
     * Construct a synchronous implementation of AmazonElasticLoadBalancing
