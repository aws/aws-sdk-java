 ...
 */
public class DescribeLoadBalancerPoliciesResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeLoadBalancerPoliciesResult, StaxUnmarshallerContext> {

    public DescribeLoadBalancerPoliciesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("PolicyDescriptions/member",
                        targetDepth)) {
                    describeLoadBalancerPoliciesResult
                            .withPolicyDescriptions(PolicyDescriptionStaxUnmarshaller
