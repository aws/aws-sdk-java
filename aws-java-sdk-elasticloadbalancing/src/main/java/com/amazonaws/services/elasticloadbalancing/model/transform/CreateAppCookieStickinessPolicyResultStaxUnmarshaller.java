...
public class CreateAppCookieStickinessPolicyResultStaxUnmarshaller implements Unmarshaller<CreateAppCookieStickinessPolicyResult, StaxUnmarshallerContext> {
    ...
    public CreateAppCookieStickinessPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createAppCookieStickinessPolicyResult;
    ...
    public static CreateAppCookieStickinessPolicyResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateAppCookieStickinessPolicyResultStaxUnmarshaller();
        return instance;
    }
}
