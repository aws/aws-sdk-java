...
/**
 * CreateAppCookieStickinessPolicyResult StAX Unmarshaller
 */
public class CreateAppCookieStickinessPolicyResultStaxUnmarshaller
        implements
        Unmarshaller<CreateAppCookieStickinessPolicyResult, StaxUnmarshallerContext> {

    public CreateAppCookieStickinessPolicyResult unmarshall(
