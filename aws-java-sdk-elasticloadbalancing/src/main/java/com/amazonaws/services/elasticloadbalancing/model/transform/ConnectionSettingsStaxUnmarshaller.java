 ...
 */
public class ConnectionSettingsStaxUnmarshaller implements
        Unmarshaller<ConnectionSettings, StaxUnmarshallerContext> {

    public ConnectionSettings unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("IdleTimeout", targetDepth)) {
                    connectionSettings.setIdleTimeout(IntegerStaxUnmarshaller
