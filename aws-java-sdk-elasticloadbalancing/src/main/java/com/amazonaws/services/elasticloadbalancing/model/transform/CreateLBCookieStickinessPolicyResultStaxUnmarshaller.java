...
public class CreateLBCookieStickinessPolicyResultStaxUnmarshaller implements Unmarshaller<CreateLBCookieStickinessPolicyResult, StaxUnmarshallerContext> {
    ...
    public CreateLBCookieStickinessPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return createLBCookieStickinessPolicyResult;
    ...
    public static CreateLBCookieStickinessPolicyResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new CreateLBCookieStickinessPolicyResultStaxUnmarshaller();
        return instance;
    }
}
