...
/**
 * CreateLBCookieStickinessPolicyResult StAX Unmarshaller
 */
public class CreateLBCookieStickinessPolicyResultStaxUnmarshaller
        implements
        Unmarshaller<CreateLBCookieStickinessPolicyResult, StaxUnmarshallerContext> {

    public CreateLBCookieStickinessPolicyResult unmarshall(
