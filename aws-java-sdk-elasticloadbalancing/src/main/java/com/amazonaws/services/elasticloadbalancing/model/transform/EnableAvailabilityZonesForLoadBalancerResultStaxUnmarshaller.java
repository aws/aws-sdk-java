...
public class EnableAvailabilityZonesForLoadBalancerResultStaxUnmarshaller implements Unmarshaller<EnableAvailabilityZonesForLoadBalancerResult, StaxUnmarshallerContext> {
    ...
    public EnableAvailabilityZonesForLoadBalancerResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return enableAvailabilityZonesForLoadBalancerResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("AvailabilityZones/member", targetDepth)) {
                    enableAvailabilityZonesForLoadBalancerResult.getAvailabilityZones().add(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static EnableAvailabilityZonesForLoadBalancerResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new EnableAvailabilityZonesForLoadBalancerResultStaxUnmarshaller();
        return instance;
    }
}
