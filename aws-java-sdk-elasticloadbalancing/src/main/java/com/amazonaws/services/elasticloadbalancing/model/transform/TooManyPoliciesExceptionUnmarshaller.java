...
public class TooManyPoliciesExceptionUnmarshaller extends
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("TooManyPolicies"))
            return null;

        TooManyPoliciesException e = (TooManyPoliciesException) super
                .unmarshall(node);
