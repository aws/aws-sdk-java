 ...
 */
public class AppCookieStickinessPolicyStaxUnmarshaller implements
        Unmarshaller<AppCookieStickinessPolicy, StaxUnmarshallerContext> {

    public AppCookieStickinessPolicy unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("CookieName", targetDepth)) {
                    appCookieStickinessPolicy
                            .setCookieName(StringStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
