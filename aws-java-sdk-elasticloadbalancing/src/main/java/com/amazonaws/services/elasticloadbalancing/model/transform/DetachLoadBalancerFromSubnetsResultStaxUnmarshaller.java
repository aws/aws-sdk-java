...
/**
 * DetachLoadBalancerFromSubnetsResult StAX Unmarshaller
 */
public class DetachLoadBalancerFromSubnetsResultStaxUnmarshaller
        implements
        Unmarshaller<DetachLoadBalancerFromSubnetsResult, StaxUnmarshallerContext> {

    public DetachLoadBalancerFromSubnetsResult unmarshall(
