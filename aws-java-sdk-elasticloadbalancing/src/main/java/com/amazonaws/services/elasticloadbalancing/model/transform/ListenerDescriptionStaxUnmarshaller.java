 ...
 */
public class ListenerDescriptionStaxUnmarshaller implements
        Unmarshaller<ListenerDescription, StaxUnmarshallerContext> {

    public ListenerDescription unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Listener", targetDepth)) {
                    listenerDescription.setListener(ListenerStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("PolicyNames/member", targetDepth)) {
                    listenerDescription.withPolicyNames(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
