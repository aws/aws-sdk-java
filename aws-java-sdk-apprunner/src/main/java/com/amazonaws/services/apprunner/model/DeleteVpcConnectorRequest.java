...
public class DeleteVpcConnectorRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        The Amazon Resource Name (ARN) of the App Runner VPC connector that you want to delete.</p>
     *        <p>
     *        The ARN must be a full VPC connector ARN.
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the App Runner VPC connector that you want to delete.</p>
     *         <p>
     *         The ARN must be a full VPC connector ARN.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVpcConnectorRequest == false)
            return false;
        DeleteVpcConnectorRequest other = (DeleteVpcConnectorRequest) obj;
    ...
    @Override
    public DeleteVpcConnectorRequest clone() {
        return (DeleteVpcConnectorRequest) super.clone();
    }
