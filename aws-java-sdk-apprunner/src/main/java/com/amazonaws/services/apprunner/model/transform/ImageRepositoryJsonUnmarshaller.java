...
/**
 * ImageRepository JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImageRepositoryJsonUnmarshaller implements Unmarshaller<ImageRepository, JsonUnmarshallerContext> {

    public ImageRepository unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ImageRepositoryJsonUnmarshaller instance;

    public static ImageRepositoryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ImageRepositoryJsonUnmarshaller();
        return instance;
    }
}
