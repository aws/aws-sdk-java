...
public class DescribeAutoScalingConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DescribeAutoScalingConfigurationResult withAutoScalingConfiguration(AutoScalingConfiguration autoScalingConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAutoScalingConfigurationResult == false)
            return false;
        DescribeAutoScalingConfigurationResult other = (DescribeAutoScalingConfigurationResult) obj;
    ...
    @Override
    public DescribeAutoScalingConfigurationResult clone() {
        try {
            return (DescribeAutoScalingConfigurationResult) super.clone();
