...
/**
 * ImageRepositoryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ImageRepositoryMarshaller {

    private static final MarshallingInfo<String> IMAGEIDENTIFIER_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ImageIdentifier").build();
    ...
    private static final MarshallingInfo<String> IMAGEREPOSITORYTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ImageRepositoryType").build();
