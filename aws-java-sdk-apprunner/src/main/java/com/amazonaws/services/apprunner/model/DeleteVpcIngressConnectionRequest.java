...
public class DeleteVpcIngressConnectionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the App Runner VPC Ingress Connection that you want to delete.
     */
    ...
    public String toString() {
        ...
        if (getVpcIngressConnectionArn() != null)
            sb.append("VpcIngressConnectionArn: ").append(getVpcIngressConnectionArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVpcIngressConnectionRequest == false)
            return false;
        DeleteVpcIngressConnectionRequest other = (DeleteVpcIngressConnectionRequest) obj;
    ...
    @Override
    public DeleteVpcIngressConnectionRequest clone() {
        return (DeleteVpcIngressConnectionRequest) super.clone();
    }
