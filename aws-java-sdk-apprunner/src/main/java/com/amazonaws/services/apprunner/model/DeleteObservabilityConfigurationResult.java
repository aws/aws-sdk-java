...
public class DeleteObservabilityConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DeleteObservabilityConfigurationResult withObservabilityConfiguration(ObservabilityConfiguration observabilityConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteObservabilityConfigurationResult == false)
            return false;
        DeleteObservabilityConfigurationResult other = (DeleteObservabilityConfigurationResult) obj;
    ...
    @Override
    public DeleteObservabilityConfigurationResult clone() {
        try {
            return (DeleteObservabilityConfigurationResult) super.clone();
