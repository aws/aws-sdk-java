...
public class PauseServiceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the App Runner service that you want to pause.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PauseServiceRequest == false)
            return false;
        PauseServiceRequest other = (PauseServiceRequest) obj;
    ...
    @Override
    public PauseServiceRequest clone() {
        return (PauseServiceRequest) super.clone();
    }
