...
public class ResumeServiceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A description of the App Runner service that this request just resumed.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResumeServiceResult == false)
            return false;
        ResumeServiceResult other = (ResumeServiceResult) obj;
    ...
    public ResumeServiceResult clone() {
        try {
            return (ResumeServiceResult) super.clone();
