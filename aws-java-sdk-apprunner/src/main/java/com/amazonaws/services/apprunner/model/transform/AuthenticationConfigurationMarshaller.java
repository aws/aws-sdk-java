...
public class AuthenticationConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> ACCESSROLEARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AccessRoleArn").build();
    ...
    public void marshall(AuthenticationConfiguration authenticationConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(authenticationConfiguration.getConnectionArn(), CONNECTIONARN_BINDING);
            protocolMarshaller.marshall(authenticationConfiguration.getAccessRoleArn(), ACCESSROLEARN_BINDING);
        } catch (Exception e) {
