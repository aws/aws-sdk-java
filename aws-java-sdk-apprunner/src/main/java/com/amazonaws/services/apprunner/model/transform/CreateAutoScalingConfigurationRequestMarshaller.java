...
public class CreateAutoScalingConfigurationRequestMarshaller {
    ...
    private static final CreateAutoScalingConfigurationRequestMarshaller instance = new CreateAutoScalingConfigurationRequestMarshaller();

    public static CreateAutoScalingConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateAutoScalingConfigurationRequest createAutoScalingConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createAutoScalingConfigurationRequest.getAutoScalingConfigurationName(), AUTOSCALINGCONFIGURATIONNAME_BINDING);
            protocolMarshaller.marshall(createAutoScalingConfigurationRequest.getMaxConcurrency(), MAXCONCURRENCY_BINDING);
            protocolMarshaller.marshall(createAutoScalingConfigurationRequest.getMinSize(), MINSIZE_BINDING);
            protocolMarshaller.marshall(createAutoScalingConfigurationRequest.getMaxSize(), MAXSIZE_BINDING);
            protocolMarshaller.marshall(createAutoScalingConfigurationRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
