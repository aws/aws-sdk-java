...
@SdkInternalApi
public class DeleteServiceRequestMarshaller {
    ...
    private static final DeleteServiceRequestMarshaller instance = new DeleteServiceRequestMarshaller();

    public static DeleteServiceRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DeleteServiceRequest deleteServiceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteServiceRequest.getServiceArn(), SERVICEARN_BINDING);
        } catch (Exception e) {
