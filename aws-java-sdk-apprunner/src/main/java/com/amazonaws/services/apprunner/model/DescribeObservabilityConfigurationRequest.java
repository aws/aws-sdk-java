...
public class DescribeObservabilityConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the App Runner observability configuration that you want a description
     *         for.</p>
     *         <p>
     *         The ARN can be a full observability configuration ARN, or a partial ARN ending with either
     *         <code>.../<i>name</i> </code> or <code>.../<i>name</i>/<i>revision</i> </code>. If a revision isn't
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeObservabilityConfigurationRequest == false)
            return false;
        DescribeObservabilityConfigurationRequest other = (DescribeObservabilityConfigurationRequest) obj;
    ...
    public DescribeObservabilityConfigurationRequest clone() {
        return (DescribeObservabilityConfigurationRequest) super.clone();
    }
