 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/bedrock-2023-04-20/GuardrailRegex" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GuardrailRegex implements Serializable, Cloneable, StructuredPojo {
    ...
    public GuardrailRegex withAction(String action) {
        setAction(action);
        return this;
    }
    ...
    public GuardrailRegex withAction(GuardrailSensitiveInformationAction action) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GuardrailRegex == false)
            return false;
    ...
    @Override
    public GuardrailRegex clone() {
        try {
            return (GuardrailRegex) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.bedrock.model.transform.GuardrailRegexMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
