...
/**
 * StopEvaluationJobResult JSON Unmarshaller
 */
...
public class StopEvaluationJobResultJsonUnmarshaller implements Unmarshaller<StopEvaluationJobResult, JsonUnmarshallerContext> {
    ...
    public StopEvaluationJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopEvaluationJobResult stopEvaluationJobResult = new StopEvaluationJobResult();
