...
/**
 * DeleteGuardrailResult JSON Unmarshaller
 */
...
public class DeleteGuardrailResultJsonUnmarshaller implements Unmarshaller<DeleteGuardrailResult, JsonUnmarshallerContext> {
    ...
    public DeleteGuardrailResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteGuardrailResult deleteGuardrailResult = new DeleteGuardrailResult();
