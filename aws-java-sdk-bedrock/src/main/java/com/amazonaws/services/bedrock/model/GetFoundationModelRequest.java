...
public class GetFoundationModelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetFoundationModelRequest withModelIdentifier(String modelIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetFoundationModelRequest == false)
            return false;
        GetFoundationModelRequest other = (GetFoundationModelRequest) obj;
    ...
    @Override
    public GetFoundationModelRequest clone() {
        return (GetFoundationModelRequest) super.clone();
    }
