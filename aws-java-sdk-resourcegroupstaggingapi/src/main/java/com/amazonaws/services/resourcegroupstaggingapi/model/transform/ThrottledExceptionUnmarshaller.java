...
public class ThrottledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottledExceptionUnmarshaller() {
        super(com.amazonaws.services.resourcegroupstaggingapi.model.ThrottledException.class, "ThrottledException");
    }

    @Override
    public com.amazonaws.services.resourcegroupstaggingapi.model.ThrottledException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
