...
/**
 * EnableTagPoliciesResult JSON Unmarshaller
 */
...
public class EnableTagPoliciesResultJsonUnmarshaller implements Unmarshaller<EnableTagPoliciesResult, JsonUnmarshallerContext> {
    ...
    public EnableTagPoliciesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        EnableTagPoliciesResult enableTagPoliciesResult = new EnableTagPoliciesResult();

        return enableTagPoliciesResult;
    }
