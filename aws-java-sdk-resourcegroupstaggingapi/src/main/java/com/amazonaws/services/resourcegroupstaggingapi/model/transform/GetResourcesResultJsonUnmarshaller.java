        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PaginationToken", targetDepth)) {
                    context.nextToken();
                    getResourcesResult.setPaginationToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ResourceTagMappingList", targetDepth)) {
                    context.nextToken();
                    getResourcesResult.setResourceTagMappingList(new ListUnmarshaller<ResourceTagMapping>(ResourceTagMappingJsonUnmarshaller.getInstance())
                            .unmarshall(context));
                }
