...
/**
 * GetTagKeysResult JSON Unmarshaller
 */
...
public class GetTagKeysResultJsonUnmarshaller implements Unmarshaller<GetTagKeysResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PaginationToken", targetDepth)) {
                    context.nextToken();
                    getTagKeysResult.setPaginationToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("TagKeys", targetDepth)) {
                    context.nextToken();
                    getTagKeysResult.setTagKeys(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
    ...
    private static GetTagKeysResultJsonUnmarshaller instance;

    public static GetTagKeysResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetTagKeysResultJsonUnmarshaller();
        return instance;
    }
}
