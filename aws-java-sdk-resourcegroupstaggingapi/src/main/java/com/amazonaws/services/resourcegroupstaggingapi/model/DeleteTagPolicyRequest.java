...
public class DeleteTagPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteTagPolicyRequest withTargetId(String targetId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTagPolicyRequest == false)
            return false;
        DeleteTagPolicyRequest other = (DeleteTagPolicyRequest) obj;
    ...
    @Override
    public DeleteTagPolicyRequest clone() {
        return (DeleteTagPolicyRequest) super.clone();
    }
