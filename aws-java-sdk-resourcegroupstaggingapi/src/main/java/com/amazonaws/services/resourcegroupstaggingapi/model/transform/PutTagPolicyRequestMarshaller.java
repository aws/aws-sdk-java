...
/**
 * PutTagPolicyRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutTagPolicyRequestMarshaller {
    ...
    private static final PutTagPolicyRequestMarshaller instance = new PutTagPolicyRequestMarshaller();

    public static PutTagPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutTagPolicyRequest putTagPolicyRequest, ProtocolMarshaller protocolMarshaller) {

        if (putTagPolicyRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(putTagPolicyRequest.getTargetId(), TARGETID_BINDING);
            protocolMarshaller.marshall(putTagPolicyRequest.getPolicy(), POLICY_BINDING);
        } catch (Exception e) {
