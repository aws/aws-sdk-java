...
public class StartReportCreationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * For more information on S3 bucket requirements, including an example bucket policy, see <a
     * href="http://docs.aws.amazon.com/ARG/latest/userguide/tag-policies-prereqs.html#bucket-policy-org-report"
     * >Additional Requirements for Running Organization-Wide Tag Compliance Report</a> in the <i>AWS Resource Groups
     * User Guide.</i>
     * </p>
     */
     ...
     * 
     * @param s3Bucket
     *        The name of the Amazon S3 bucket where the report will be stored.</p>
     *        <p>
     *        For more information on S3 bucket requirements, including an example bucket policy, see <a href=
     ...
     * </p>
     * 
     * @return The name of the Amazon S3 bucket where the report will be stored.</p>
     *         <p>
     *         For more information on S3 bucket requirements, including an example bucket policy, see <a href=
     *         "http://docs.aws.amazon.com/ARG/latest/userguide/tag-policies-prereqs.html#bucket-policy-org-report"
     *         >Additional Requirements for Running Organization-Wide Tag Compliance Report</a> in the <i>AWS Resource
