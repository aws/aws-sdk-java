...
public class ComplianceDetailsMarshaller {
    ...
    private static final MarshallingInfo<List> NONCOMPLIANTKEYS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("NoncompliantKeys").build();
    private static final MarshallingInfo<List> KEYSWITHNONCOMPLIANTVALUES_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("KeysWithNoncompliantValues").build();
