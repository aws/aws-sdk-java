...
public class DescribeIndexFieldsRequestMarshaller
        implements
        Marshaller<Request<DescribeIndexFieldsRequest>, DescribeIndexFieldsRequest> {

    public Request<DescribeIndexFieldsRequest> marshall(
        ...
        Request<DescribeIndexFieldsRequest> request = new DefaultRequest<DescribeIndexFieldsRequest>(
                describeIndexFieldsRequest, "AmazonCloudSearchv2");
        ...
        if (describeIndexFieldsRequest.getDomainName() != null) {
            request.addParameter("DomainName", StringUtils
                    .fromString(describeIndexFieldsRequest.getDomainName()));
        }
        ...
        if (!fieldNamesList.isEmpty() || !fieldNamesList.isAutoConstruct()) {
            ...
            for (String fieldNamesListValue : fieldNamesList) {
                if (fieldNamesListValue != null) {
                    request.addParameter("FieldNames.member."
                            + fieldNamesListIndex,
                            StringUtils.fromString(fieldNamesListValue));
                }
                fieldNamesListIndex++;
            }
        }
        ...
        if (describeIndexFieldsRequest.getDeployed() != null) {
            request.addParameter("Deployed", StringUtils
                    .fromBoolean(describeIndexFieldsRequest.getDeployed()));
        }
