...
/**
 * <p>
 * Container for the parameters to the <code><a>DescribeDomains</a></code>
 ...
 * </p>
 */
public class DescribeExpressionsRequest extends
     ...
     * </p>
     * 
     * @return Limits the <code><a>DescribeExpressions</a></code> response to
    ...
    public void setExpressionNames(java.util.Collection<String> expressionNames) {
        ...
        this.expressionNames = new com.amazonaws.internal.SdkInternalList<String>(
                expressionNames);
    }
    ...
    public DescribeExpressionsRequest withExpressionNames(
        ...
        if (this.expressionNames == null) {
            setExpressionNames(new com.amazonaws.internal.SdkInternalList<String>(
    ...
    public DescribeExpressionsRequest withExpressionNames(
            java.util.Collection<String> expressionNames) {
