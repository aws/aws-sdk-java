 ...
 */
public class AvailabilityOptionsStatusStaxUnmarshaller implements
        Unmarshaller<AvailabilityOptionsStatus, StaxUnmarshallerContext> {

    public AvailabilityOptionsStatus unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Options", targetDepth)) {
                    availabilityOptionsStatus
                            .setOptions(BooleanStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
    ...
    public static AvailabilityOptionsStatusStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new AvailabilityOptionsStatusStaxUnmarshaller();
        return instance;
    }
}
