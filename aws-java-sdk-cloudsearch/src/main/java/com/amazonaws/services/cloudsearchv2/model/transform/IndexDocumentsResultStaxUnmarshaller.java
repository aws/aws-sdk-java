 ...
 */
public class IndexDocumentsResultStaxUnmarshaller implements
        Unmarshaller<IndexDocumentsResult, StaxUnmarshallerContext> {

    public IndexDocumentsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("FieldNames/member", targetDepth)) {
                    indexDocumentsResult.withFieldNames(StringStaxUnmarshaller
