 ...
 */
public class UpdateAvailabilityOptionsResultStaxUnmarshaller implements
        Unmarshaller<UpdateAvailabilityOptionsResult, StaxUnmarshallerContext> {

    public UpdateAvailabilityOptionsResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("AvailabilityOptions", targetDepth)) {
                    updateAvailabilityOptionsResult
                            .setAvailabilityOptions(AvailabilityOptionsStatusStaxUnmarshaller
