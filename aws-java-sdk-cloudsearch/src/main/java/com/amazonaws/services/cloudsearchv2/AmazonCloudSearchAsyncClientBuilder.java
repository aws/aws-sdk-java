...
/**
 * Fluent builder for {@link com.amazonaws.services.cloudsearchv2.AmazonCloudSearchAsync}. Use of the builder is
 * preferred over using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AmazonCloudSearchAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonCloudSearchAsyncClientBuilder, AmazonCloudSearchAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonCloudSearchAsync using the current builder configuration.
     *
     * @param params
