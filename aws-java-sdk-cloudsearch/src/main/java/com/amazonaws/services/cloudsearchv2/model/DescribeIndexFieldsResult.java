...
public class DescribeIndexFieldsResult extends
    ...
    public void setIndexFields(
            java.util.Collection<IndexFieldStatus> indexFields) {
        if (indexFields == null) {
            this.indexFields = null;
            return;
        }

        this.indexFields = new com.amazonaws.internal.SdkInternalList<IndexFieldStatus>(
                indexFields);
    }
     ...
     * any). Use {@link #setIndexFields(java.util.Collection)} or
     * {@link #withIndexFields(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param indexFields
    ...
    public DescribeIndexFieldsResult withIndexFields(
            IndexFieldStatus... indexFields) {
        if (this.indexFields == null) {
            setIndexFields(new com.amazonaws.internal.SdkInternalList<IndexFieldStatus>(
                    indexFields.length));
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getIndexFields() == null ^ this.getIndexFields() == null)
            return false;
        if (other.getIndexFields() != null
                && other.getIndexFields().equals(this.getIndexFields()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getIndexFields() == null) ? 0 : getIndexFields().hashCode());
        return hashCode;
    }
