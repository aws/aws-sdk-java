...
public class DescribeAvailabilityOptionsRequestMarshaller
        implements
        Marshaller<Request<DescribeAvailabilityOptionsRequest>, DescribeAvailabilityOptionsRequest> {

    public Request<DescribeAvailabilityOptionsRequest> marshall(
        ...
        Request<DescribeAvailabilityOptionsRequest> request = new DefaultRequest<DescribeAvailabilityOptionsRequest>(
                describeAvailabilityOptionsRequest, "AmazonCloudSearchv2");
        ...
        if (describeAvailabilityOptionsRequest.getDomainName() != null) {
            request.addParameter("DomainName", StringUtils
                    .fromString(describeAvailabilityOptionsRequest
                            .getDomainName()));
        }

        if (describeAvailabilityOptionsRequest.getDeployed() != null) {
            request.addParameter("Deployed", StringUtils
                    .fromBoolean(describeAvailabilityOptionsRequest
                            .getDeployed()));
        }
