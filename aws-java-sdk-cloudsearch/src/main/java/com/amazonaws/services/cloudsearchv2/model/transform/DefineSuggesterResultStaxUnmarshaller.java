 ...
 */
public class DefineSuggesterResultStaxUnmarshaller implements
        Unmarshaller<DefineSuggesterResult, StaxUnmarshallerContext> {

    public DefineSuggesterResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
