...
public class DescribeExpressionsRequestMarshaller
        implements
        Marshaller<Request<DescribeExpressionsRequest>, DescribeExpressionsRequest> {

    public Request<DescribeExpressionsRequest> marshall(
        ...
        Request<DescribeExpressionsRequest> request = new DefaultRequest<DescribeExpressionsRequest>(
                describeExpressionsRequest, "AmazonCloudSearchv2");
        ...
        if (describeExpressionsRequest.getDomainName() != null) {
            request.addParameter("DomainName", StringUtils
                    .fromString(describeExpressionsRequest.getDomainName()));
        }
        ...
        if (describeExpressionsRequest.getDeployed() != null) {
            request.addParameter("Deployed", StringUtils
                    .fromBoolean(describeExpressionsRequest.getDeployed()));
        }
