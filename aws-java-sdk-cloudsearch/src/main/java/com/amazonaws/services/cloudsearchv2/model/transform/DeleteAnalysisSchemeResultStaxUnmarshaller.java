 ...
 */
public class DeleteAnalysisSchemeResultStaxUnmarshaller implements
        Unmarshaller<DeleteAnalysisSchemeResult, StaxUnmarshallerContext> {

    public DeleteAnalysisSchemeResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
