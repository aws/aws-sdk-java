 ...
 */
public class DescribeServiceAccessPoliciesResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeServiceAccessPoliciesResult, StaxUnmarshallerContext> {

    public DescribeServiceAccessPoliciesResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("AccessPolicies", targetDepth)) {
                    describeServiceAccessPoliciesResult
                            .setAccessPolicies(AccessPoliciesStatusStaxUnmarshaller
