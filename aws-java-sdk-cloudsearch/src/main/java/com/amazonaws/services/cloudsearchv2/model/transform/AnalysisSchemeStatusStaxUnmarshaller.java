 ...
 */
public class AnalysisSchemeStatusStaxUnmarshaller implements
        Unmarshaller<AnalysisSchemeStatus, StaxUnmarshallerContext> {

    public AnalysisSchemeStatus unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Options", targetDepth)) {
                    analysisSchemeStatus
                            .setOptions(AnalysisSchemeStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Status", targetDepth)) {
                    analysisSchemeStatus.setStatus(OptionStatusStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
