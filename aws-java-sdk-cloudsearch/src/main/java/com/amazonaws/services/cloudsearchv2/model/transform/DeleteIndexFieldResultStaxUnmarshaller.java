 ...
 */
public class DeleteIndexFieldResultStaxUnmarshaller implements
        Unmarshaller<DeleteIndexFieldResult, StaxUnmarshallerContext> {

    public DeleteIndexFieldResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
