 ...
 */
public class DescribeSuggestersResultStaxUnmarshaller implements
        Unmarshaller<DescribeSuggestersResult, StaxUnmarshallerContext> {

    public DescribeSuggestersResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Suggesters/member", targetDepth)) {
                    describeSuggestersResult
                            .withSuggesters(SuggesterStatusStaxUnmarshaller
