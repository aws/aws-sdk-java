 ...
 */
public class DescribeDomainsResultStaxUnmarshaller implements
        Unmarshaller<DescribeDomainsResult, StaxUnmarshallerContext> {

    public DescribeDomainsResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DomainStatusList/member",
                        targetDepth)) {
                    describeDomainsResult
                            .withDomainStatusList(DomainStatusStaxUnmarshaller
