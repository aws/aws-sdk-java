...
public class UpdateAvailabilityOptionsRequestMarshaller
        implements
        Marshaller<Request<UpdateAvailabilityOptionsRequest>, UpdateAvailabilityOptionsRequest> {

    public Request<UpdateAvailabilityOptionsRequest> marshall(
        ...
        Request<UpdateAvailabilityOptionsRequest> request = new DefaultRequest<UpdateAvailabilityOptionsRequest>(
                updateAvailabilityOptionsRequest, "AmazonCloudSearchv2");
        ...
        if (updateAvailabilityOptionsRequest.getDomainName() != null) {
            request.addParameter("DomainName", StringUtils
                    .fromString(updateAvailabilityOptionsRequest
                            .getDomainName()));
        }

        if (updateAvailabilityOptionsRequest.getMultiAZ() != null) {
            request.addParameter("MultiAZ", StringUtils
                    .fromBoolean(updateAvailabilityOptionsRequest.getMultiAZ()));
        }
