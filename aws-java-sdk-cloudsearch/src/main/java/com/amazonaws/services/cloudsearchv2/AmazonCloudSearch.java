...
public interface AmazonCloudSearch {
     ...
     * ("https://cloudsearch.us-east-1.amazonaws.com/"). Callers can use this
     * method to control which AWS region they want to work with.
     * <p>
     * Callers can pass in just the endpoint (ex:
     * "cloudsearch.us-east-1.amazonaws.com/") or a full URL, including the
     * protocol (ex: "https://cloudsearch.us-east-1.amazonaws.com/"). If the
     ...
     *
     * @param endpoint
     *        The endpoint (ex: "cloudsearch.us-east-1.amazonaws.com/") or a
     *        full URL, including the protocol (ex:
     *        "https://cloudsearch.us-east-1.amazonaws.com/") of the region
     ...
     */
    BuildSuggestersResult buildSuggesters(
     ...
     */
    DefineExpressionResult defineExpression(
     ...
     */
    DefineIndexFieldResult defineIndexField(
     ...
     */
    DeleteAnalysisSchemeResult deleteAnalysisScheme(
     ...
     */
    DeleteIndexFieldResult deleteIndexField(
     ...
     */
    DeleteSuggesterResult deleteSuggester(
     ...
     */
    DescribeAnalysisSchemesResult describeAnalysisSchemes(
     ...
     */
    DescribeAvailabilityOptionsResult describeAvailabilityOptions(
     ...
     */
    DescribeExpressionsResult describeExpressions(
     ...
     */
    DescribeIndexFieldsResult describeIndexFields(
     ...
     */
    DescribeScalingParametersResult describeScalingParameters(
     ...
     */
    DescribeServiceAccessPoliciesResult describeServiceAccessPolicies(
     ...
     */
    IndexDocumentsResult indexDocuments(
     ...
     */
    UpdateAvailabilityOptionsResult updateAvailabilityOptions(
     ...
     */
    UpdateScalingParametersResult updateScalingParameters(
     ...
     */
    UpdateServiceAccessPoliciesResult updateServiceAccessPolicies(
