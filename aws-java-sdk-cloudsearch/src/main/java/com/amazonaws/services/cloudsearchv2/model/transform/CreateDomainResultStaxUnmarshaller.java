 ...
 */
public class CreateDomainResultStaxUnmarshaller implements
        Unmarshaller<CreateDomainResult, StaxUnmarshallerContext> {

    public CreateDomainResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DomainStatus", targetDepth)) {
                    createDomainResult
                            .setDomainStatus(DomainStatusStaxUnmarshaller
