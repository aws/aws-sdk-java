 ...
 */
public class BuildSuggestersResultStaxUnmarshaller implements
        Unmarshaller<BuildSuggestersResult, StaxUnmarshallerContext> {

    public BuildSuggestersResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("FieldNames/member", targetDepth)) {
                    buildSuggestersResult.withFieldNames(StringStaxUnmarshaller
