...
/**
 * Build Suggesters Result StAX Unmarshaller
 */
public class BuildSuggestersResultStaxUnmarshaller implements Unmarshaller<BuildSuggestersResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("FieldNames/member", targetDepth)) {
                    buildSuggestersResult.getFieldNames().add(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static BuildSuggestersResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new BuildSuggestersResultStaxUnmarshaller();
        return instance;
    }
}
