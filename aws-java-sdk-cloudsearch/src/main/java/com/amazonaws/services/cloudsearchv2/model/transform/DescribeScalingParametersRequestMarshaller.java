...
public class DescribeScalingParametersRequestMarshaller
        implements
        Marshaller<Request<DescribeScalingParametersRequest>, DescribeScalingParametersRequest> {

    public Request<DescribeScalingParametersRequest> marshall(
        ...
        Request<DescribeScalingParametersRequest> request = new DefaultRequest<DescribeScalingParametersRequest>(
                describeScalingParametersRequest, "AmazonCloudSearchv2");
        ...
        if (describeScalingParametersRequest.getDomainName() != null) {
            request.addParameter("DomainName", StringUtils
                    .fromString(describeScalingParametersRequest
                            .getDomainName()));
        }
