 ...
 */
public class DefineAnalysisSchemeResultStaxUnmarshaller implements
        Unmarshaller<DefineAnalysisSchemeResult, StaxUnmarshallerContext> {

    public DefineAnalysisSchemeResult unmarshall(StaxUnmarshallerContext context)
            throws Exception {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("AnalysisScheme", targetDepth)) {
                    defineAnalysisSchemeResult
                            .setAnalysisScheme(AnalysisSchemeStatusStaxUnmarshaller
