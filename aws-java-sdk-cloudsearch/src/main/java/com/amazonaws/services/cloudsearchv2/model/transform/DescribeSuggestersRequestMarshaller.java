...
public class DescribeSuggestersRequestMarshaller
        implements
        Marshaller<Request<DescribeSuggestersRequest>, DescribeSuggestersRequest> {

    public Request<DescribeSuggestersRequest> marshall(
        ...
        Request<DescribeSuggestersRequest> request = new DefaultRequest<DescribeSuggestersRequest>(
                describeSuggestersRequest, "AmazonCloudSearchv2");
        ...
        if (describeSuggestersRequest.getDomainName() != null) {
            request.addParameter("DomainName", StringUtils
                    .fromString(describeSuggestersRequest.getDomainName()));
        }
        ...
        if (describeSuggestersRequest.getDeployed() != null) {
            request.addParameter("Deployed", StringUtils
                    .fromBoolean(describeSuggestersRequest.getDeployed()));
        }
