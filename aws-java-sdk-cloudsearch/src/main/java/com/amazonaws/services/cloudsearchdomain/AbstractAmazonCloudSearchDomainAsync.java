...
/**
 * Abstract implementation of {@code AmazonCloudSearchDomainAsync}. Convenient
 * method forms pass through to the corresponding overload that takes a request
 * object and an {@code AsyncHandler}, which throws an
 * {@code UnsupportedOperationException}.
 */
public class AbstractAmazonCloudSearchDomainAsync extends
        AbstractAmazonCloudSearchDomain implements AmazonCloudSearchDomainAsync {
