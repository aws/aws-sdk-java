 ...
 */
public class SuggestModelJsonUnmarshaller implements
        Unmarshaller<SuggestModel, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("suggestions", targetDepth)) {
                    context.nextToken();
                    suggestModel
                            .setSuggestions(new ListUnmarshaller<SuggestionMatch>(
