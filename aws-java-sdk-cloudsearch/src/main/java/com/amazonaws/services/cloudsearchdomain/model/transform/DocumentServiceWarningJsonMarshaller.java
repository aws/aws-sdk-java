...
/**
 * DocumentServiceWarningMarshaller
 */
public class DocumentServiceWarningJsonMarshaller {
     ...
     */
    public void marshall(DocumentServiceWarning documentServiceWarning,
        ...
        try {
            ...
            if (documentServiceWarning.getMessage() != null) {
                jsonWriter.key("message").value(
                        documentServiceWarning.getMessage());
            }
    ...
    public static DocumentServiceWarningJsonMarshaller getInstance() {
        if (instance == null)
            instance = new DocumentServiceWarningJsonMarshaller();
        return instance;
    }
