 ...
 */
public class UploadDocumentsResultJsonUnmarshaller implements
        Unmarshaller<UploadDocumentsResult, JsonUnmarshallerContext> {

    public UploadDocumentsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("warnings", targetDepth)) {
                    ...
                    uploadDocumentsResult
                            .setWarnings(new ListUnmarshaller<DocumentServiceWarning>(
