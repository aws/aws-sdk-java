...
/**
 * Search Result JSON Unmarshaller
 */
public class SearchResultJsonUnmarshaller implements Unmarshaller<SearchResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("facets", targetDepth)) {
                    context.nextToken();
                    searchResult.setFacets(new MapUnmarshaller<String,BucketInfo>(StringJsonUnmarshaller.getInstance(), BucketInfoJsonUnmarshaller.getInstance()).unmarshall(context));
                }
    ...
    public static SearchResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new SearchResultJsonUnmarshaller();
        return instance;
    }
}
