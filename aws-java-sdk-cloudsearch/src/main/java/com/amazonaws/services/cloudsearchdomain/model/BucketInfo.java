...
public class BucketInfo implements Serializable, Cloneable {
    ...
    public void setBuckets(java.util.Collection<Bucket> buckets) {
        ...
        this.buckets = new com.amazonaws.internal.SdkInternalList<Bucket>(
                buckets);
    }
     ...
     * any). Use {@link #setBuckets(java.util.Collection)} or
     * {@link #withBuckets(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param buckets
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getBuckets() != null
                && other.getBuckets().equals(this.getBuckets()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getBuckets() == null) ? 0 : getBuckets().hashCode());
        return hashCode;
    }
