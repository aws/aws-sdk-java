...
public class AmazonCloudSearchDomainAsyncClient extends
     ...
     * CloudSearch Domain. A credentials provider chain will be used that
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * CloudSearch Domain using the specified parameters.
     *
    ...
    @Override
    public java.util.concurrent.Future<SearchResult> searchAsync(
    ...
    public java.util.concurrent.Future<SearchResult> searchAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<SearchResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<SuggestResult> suggestAsync(
    ...
    public java.util.concurrent.Future<SuggestResult> suggestAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<SuggestResult>() {
                    @Override
    ...
    @Override
    public java.util.concurrent.Future<UploadDocumentsResult> uploadDocumentsAsync(
