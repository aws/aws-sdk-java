...
public enum SourceDataFunction {
    ...
    private SourceDataFunction(String value) {
        this.value = value;
    }
     ...
     * @param value
     *            real value
     * @return SourceDataFunction corresponding to the value
     */
    public static SourceDataFunction fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        
        } else if ("Copy".equals(value)) {
            return SourceDataFunction.Copy;
        } else if ("TrimTitle".equals(value)) {
