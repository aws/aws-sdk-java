 ...
 * @deprecated Use {@link com.amazonaws.services.cloudsearchv2.model.transform.IndexFieldStaxUnmarshaller} instead.
 */
 @Deprecated
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("UIntOptions", targetDepth)) {
                    indexField.setUIntOptions(UIntOptionsStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("SourceAttributes/member", targetDepth)) {
                    indexField.getSourceAttributes().add(SourceAttributeStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
