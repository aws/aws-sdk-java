...
/**
 * <p>
 * The result of a <code>UpdateAvailabilityOptions</code> request.
 * Contains the status of the domain's availability options.
 * </p>
 * @deprecated Use {@link com.amazonaws.services.cloudsearchv2.model.UpdateAvailabilityOptionsResult} instead.
 */
@Deprecated
public class UpdateAvailabilityOptionsResult implements Serializable {
     ...
     * is enabled for the domain.
     *
     * @return The newly-configured availability options. Indicates whether Multi-AZ
     *         is enabled for the domain.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAvailabilityOptionsResult == false) return false;
