...
/**
 * FixedUpfrontPricingTermMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FixedUpfrontPricingTermMarshaller {
    ...
    private static final FixedUpfrontPricingTermMarshaller instance = new FixedUpfrontPricingTermMarshaller();

    public static FixedUpfrontPricingTermMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FixedUpfrontPricingTerm fixedUpfrontPricingTerm, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(fixedUpfrontPricingTerm.getCurrencyCode(), CURRENCYCODE_BINDING);
            protocolMarshaller.marshall(fixedUpfrontPricingTerm.getDuration(), DURATION_BINDING);
            protocolMarshaller.marshall(fixedUpfrontPricingTerm.getGrants(), GRANTS_BINDING);
            protocolMarshaller.marshall(fixedUpfrontPricingTerm.getPrice(), PRICE_BINDING);
            protocolMarshaller.marshall(fixedUpfrontPricingTerm.getType(), TYPE_BINDING);
        } catch (Exception e) {
