...
/**
 * ListRuleGroupsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListRuleGroupsResultJsonUnmarshaller implements Unmarshaller<ListRuleGroupsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listRuleGroupsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RuleGroups", targetDepth)) {
                    context.nextToken();
                    listRuleGroupsResult.setRuleGroups(new ListUnmarshaller<RuleGroupMetadata>(RuleGroupMetadataJsonUnmarshaller.getInstance())
