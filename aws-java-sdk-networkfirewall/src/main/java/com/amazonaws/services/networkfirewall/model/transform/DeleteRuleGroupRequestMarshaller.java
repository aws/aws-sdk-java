...
public class DeleteRuleGroupRequestMarshaller {
    ...
    public void marshall(DeleteRuleGroupRequest deleteRuleGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteRuleGroupRequest.getRuleGroupName(), RULEGROUPNAME_BINDING);
            protocolMarshaller.marshall(deleteRuleGroupRequest.getRuleGroupArn(), RULEGROUPARN_BINDING);
            protocolMarshaller.marshall(deleteRuleGroupRequest.getType(), TYPE_BINDING);
        } catch (Exception e) {
