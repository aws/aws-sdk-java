...
@SdkInternalApi
public class SyncStateMarshaller {
    ...
    private static final SyncStateMarshaller instance = new SyncStateMarshaller();

    public static SyncStateMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SyncState syncState, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(syncState.getAttachment(), ATTACHMENT_BINDING);
            protocolMarshaller.marshall(syncState.getConfig(), CONFIG_BINDING);
        } catch (Exception e) {
