...
public class ListFirewallPoliciesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListFirewallPoliciesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFirewallPoliciesRequest == false)
            return false;
        ListFirewallPoliciesRequest other = (ListFirewallPoliciesRequest) obj;
    ...
    public ListFirewallPoliciesRequest clone() {
        return (ListFirewallPoliciesRequest) super.clone();
    }
