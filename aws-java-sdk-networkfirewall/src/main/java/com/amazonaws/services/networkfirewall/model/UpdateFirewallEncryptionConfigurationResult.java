...
public class UpdateFirewallEncryptionConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateFirewallEncryptionConfigurationResult withFirewallArn(String firewallArn) {
    ...
    public UpdateFirewallEncryptionConfigurationResult withFirewallName(String firewallName) {
    ...
    public UpdateFirewallEncryptionConfigurationResult withUpdateToken(String updateToken) {
    ...
    public UpdateFirewallEncryptionConfigurationResult withEncryptionConfiguration(EncryptionConfiguration encryptionConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateFirewallEncryptionConfigurationResult == false)
            return false;
        UpdateFirewallEncryptionConfigurationResult other = (UpdateFirewallEncryptionConfigurationResult) obj;
    ...
    @Override
    public UpdateFirewallEncryptionConfigurationResult clone() {
        try {
            return (UpdateFirewallEncryptionConfigurationResult) super.clone();
