 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/network-firewall-2020-11-12/ServerCertificateScope"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ServerCertificateScope implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The destination IP addresses and address ranges to decrypt for inspection, in CIDR notation. If not specified,
     ...
     * </p>
     * <p>
     * You can specify individual ports, for example <code>1994</code>, and you can specify port ranges, such as
     * <code>1990:1994</code>.
     * </p>
     */
    ...
    /**
     * <p>
     * The destination ports to decrypt for inspection, in Transmission Control Protocol (TCP) format. If not specified,
     * this matches with any destination port.
     * </p>
     * <p>
     * You can specify individual ports, for example <code>1994</code>, and you can specify port ranges, such as
     * <code>1990:1994</code>.
     ...
     * </p>
     * 
     * @return The source IP addresses and address ranges to decrypt for inspection, in CIDR notation. If not specified,
     *         this matches with any source address.
     */
    ...
    public ServerCertificateScope withSources(java.util.Collection<Address> sources) {
        setSources(sources);
        return this;
    }
     ...
     * </p>
     * 
     * @return The destination IP addresses and address ranges to decrypt for inspection, in CIDR notation. If not
    ...
    public ServerCertificateScope withDestinations(java.util.Collection<Address> destinations) {
     ...
     * </p>
     * 
     * @return The source ports to decrypt for inspection, in Transmission Control Protocol (TCP) format. If not
     *         specified, this matches with any source port.</p>
     *         <p>
     *         You can specify individual ports, for example <code>1994</code>, and you can specify port ranges, such as
     *         <code>1990:1994</code>.
     */
    ...
    public ServerCertificateScope withSourcePorts(java.util.Collection<PortRange> sourcePorts) {
     ...
     * </p>
     * 
     * @return The destination ports to decrypt for inspection, in Transmission Control Protocol (TCP) format. If not
     *         specified, this matches with any destination port.</p>
     *         <p>
     *         You can specify individual ports, for example <code>1994</code>, and you can specify port ranges, such as
     *         <code>1990:1994</code>.
     */
    ...
    public ServerCertificateScope withDestinationPorts(java.util.Collection<PortRange> destinationPorts) {
     ...
     * </p>
     * 
     * @return The protocols to decrypt for inspection, specified using each protocol's assigned internet protocol
     *         number (IANA). Network Firewall currently supports only TCP.
     */
    ...
    public ServerCertificateScope withProtocols(Integer... protocols) {
    ...
    public ServerCertificateScope withProtocols(java.util.Collection<Integer> protocols) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ServerCertificateScope == false)
            return false;
        ServerCertificateScope other = (ServerCertificateScope) obj;
    ...
    public ServerCertificateScope clone() {
        try {
            return (ServerCertificateScope) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.networkfirewall.model.transform.ServerCertificateScopeMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
