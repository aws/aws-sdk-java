...
public class CreateFirewallPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateFirewallPolicyResult withUpdateToken(String updateToken) {
    ...
    public CreateFirewallPolicyResult withFirewallPolicyResponse(FirewallPolicyResponse firewallPolicyResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateFirewallPolicyResult == false)
            return false;
        CreateFirewallPolicyResult other = (CreateFirewallPolicyResult) obj;
    ...
    @Override
    public CreateFirewallPolicyResult clone() {
        try {
            return (CreateFirewallPolicyResult) super.clone();
