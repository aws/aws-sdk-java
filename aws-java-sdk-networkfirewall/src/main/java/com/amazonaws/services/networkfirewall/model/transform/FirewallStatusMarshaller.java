...
/**
 * FirewallStatusMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FirewallStatusMarshaller {

    private static final MarshallingInfo<String> STATUS_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Status").build();
    private static final MarshallingInfo<String> CONFIGURATIONSYNCSTATESUMMARY_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public static FirewallStatusMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FirewallStatus firewallStatus, ProtocolMarshaller protocolMarshaller) {
