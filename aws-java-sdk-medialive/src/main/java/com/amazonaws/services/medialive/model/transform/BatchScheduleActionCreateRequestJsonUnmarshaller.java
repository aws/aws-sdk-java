...
/**
 * BatchScheduleActionCreateRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchScheduleActionCreateRequestJsonUnmarshaller implements Unmarshaller<BatchScheduleActionCreateRequest, JsonUnmarshallerContext> {

    public BatchScheduleActionCreateRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
