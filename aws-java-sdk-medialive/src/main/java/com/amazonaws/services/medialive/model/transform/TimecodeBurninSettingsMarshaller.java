...
/**
 * TimecodeBurninSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TimecodeBurninSettingsMarshaller {
    ...
    private static final TimecodeBurninSettingsMarshaller instance = new TimecodeBurninSettingsMarshaller();

    public static TimecodeBurninSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TimecodeBurninSettings timecodeBurninSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(timecodeBurninSettings.getFontSize(), FONTSIZE_BINDING);
            protocolMarshaller.marshall(timecodeBurninSettings.getPosition(), POSITION_BINDING);
            protocolMarshaller.marshall(timecodeBurninSettings.getPrefix(), PREFIX_BINDING);
        } catch (Exception e) {
