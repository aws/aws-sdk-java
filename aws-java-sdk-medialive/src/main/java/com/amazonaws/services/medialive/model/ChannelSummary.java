 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/ChannelSummary" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ChannelSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public ChannelSummary withDestinations(OutputDestination... destinations) {
    ...
    public ChannelSummary withDestinations(java.util.Collection<OutputDestination> destinations) {
    ...
    public ChannelSummary withEgressEndpoints(ChannelEgressEndpoint... egressEndpoints) {
    ...
    public ChannelSummary withEgressEndpoints(java.util.Collection<ChannelEgressEndpoint> egressEndpoints) {
    ...
    public ChannelSummary withInputAttachments(InputAttachment... inputAttachments) {
    ...
    public ChannelSummary withInputAttachments(java.util.Collection<InputAttachment> inputAttachments) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.ChannelSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
