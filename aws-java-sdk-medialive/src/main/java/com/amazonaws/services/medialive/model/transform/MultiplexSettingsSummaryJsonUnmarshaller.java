...
/**
 * MultiplexSettingsSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MultiplexSettingsSummaryJsonUnmarshaller implements Unmarshaller<MultiplexSettingsSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("transportStreamBitrate", targetDepth)) {
                    context.nextToken();
                    multiplexSettingsSummary.setTransportStreamBitrate(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
