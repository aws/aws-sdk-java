        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("cdiInputSpecification", targetDepth)) {
                    context.nextToken();
                    describeChannelResult.setCdiInputSpecification(CdiInputSpecificationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("maintenance", targetDepth)) {
                    context.nextToken();
                    describeChannelResult.setMaintenance(MaintenanceStatusJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("vpc", targetDepth)) {
                    context.nextToken();
                    describeChannelResult.setVpc(VpcOutputSettingsDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
