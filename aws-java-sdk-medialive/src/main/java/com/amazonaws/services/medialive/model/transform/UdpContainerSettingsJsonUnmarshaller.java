...
/**
 * UdpContainerSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UdpContainerSettingsJsonUnmarshaller implements Unmarshaller<UdpContainerSettings, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("m2tsSettings", targetDepth)) {
                    context.nextToken();
                    udpContainerSettings.setM2tsSettings(M2tsSettingsJsonUnmarshaller.getInstance().unmarshall(context));
                }
