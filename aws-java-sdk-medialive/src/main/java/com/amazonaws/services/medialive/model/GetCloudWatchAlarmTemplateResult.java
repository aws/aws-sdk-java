...
public class GetCloudWatchAlarmTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetCloudWatchAlarmTemplateResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public GetCloudWatchAlarmTemplateResult withComparisonOperator(String comparisonOperator) {
    ...
    public GetCloudWatchAlarmTemplateResult withComparisonOperator(CloudWatchAlarmTemplateComparisonOperator comparisonOperator) {
    ...
    public GetCloudWatchAlarmTemplateResult withCreatedAt(java.util.Date createdAt) {
    ...
    public GetCloudWatchAlarmTemplateResult withDatapointsToAlarm(Integer datapointsToAlarm) {
    ...
    public GetCloudWatchAlarmTemplateResult withDescription(String description) {
    ...
    public GetCloudWatchAlarmTemplateResult withEvaluationPeriods(Integer evaluationPeriods) {
    ...
    public GetCloudWatchAlarmTemplateResult withGroupId(String groupId) {
        setGroupId(groupId);
        return this;
    }
    ...
    public GetCloudWatchAlarmTemplateResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public GetCloudWatchAlarmTemplateResult withMetricName(String metricName) {
    ...
    public GetCloudWatchAlarmTemplateResult withModifiedAt(java.util.Date modifiedAt) {
    ...
    public GetCloudWatchAlarmTemplateResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public GetCloudWatchAlarmTemplateResult withPeriod(Integer period) {
        setPeriod(period);
        return this;
    }
    ...
    public GetCloudWatchAlarmTemplateResult withStatistic(String statistic) {
    ...
    public GetCloudWatchAlarmTemplateResult withStatistic(CloudWatchAlarmTemplateStatistic statistic) {
    ...
    public GetCloudWatchAlarmTemplateResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see GetCloudWatchAlarmTemplateResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetCloudWatchAlarmTemplateResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public GetCloudWatchAlarmTemplateResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public GetCloudWatchAlarmTemplateResult withTargetResourceType(String targetResourceType) {
    ...
    public GetCloudWatchAlarmTemplateResult withTargetResourceType(CloudWatchAlarmTemplateTargetResourceType targetResourceType) {
    ...
    public GetCloudWatchAlarmTemplateResult withThreshold(Double threshold) {
    ...
    public GetCloudWatchAlarmTemplateResult withTreatMissingData(String treatMissingData) {
    ...
    public GetCloudWatchAlarmTemplateResult withTreatMissingData(CloudWatchAlarmTemplateTreatMissingData treatMissingData) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCloudWatchAlarmTemplateResult == false)
            return false;
        GetCloudWatchAlarmTemplateResult other = (GetCloudWatchAlarmTemplateResult) obj;
    ...
    @Override
    public GetCloudWatchAlarmTemplateResult clone() {
        try {
            return (GetCloudWatchAlarmTemplateResult) super.clone();
