...
public class StartInputDeviceMaintenanceWindowRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The unique ID of the input device to start a maintenance window for. For example, hd-123456789abcdef.
     * 
     * @return The unique ID of the input device to start a maintenance window for. For example, hd-123456789abcdef.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartInputDeviceMaintenanceWindowRequest == false)
            return false;
        StartInputDeviceMaintenanceWindowRequest other = (StartInputDeviceMaintenanceWindowRequest) obj;
