...
/**
 * UpdateReservationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateReservationRequestMarshaller {
    ...
    private static final UpdateReservationRequestMarshaller instance = new UpdateReservationRequestMarshaller();

    public static UpdateReservationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateReservationRequest updateReservationRequest, ProtocolMarshaller protocolMarshaller) {
