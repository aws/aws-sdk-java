...
/**
 * InputChannelLevel JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InputChannelLevelJsonUnmarshaller implements Unmarshaller<InputChannelLevel, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("gain", targetDepth)) {
                    context.nextToken();
                    inputChannelLevel.setGain(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("inputChannel", targetDepth)) {
                    context.nextToken();
                    inputChannelLevel.setInputChannel(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
