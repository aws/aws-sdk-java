...
/**
 * DeleteEventBridgeRuleTemplateResult JSON Unmarshaller
 */
...
public class DeleteEventBridgeRuleTemplateResultJsonUnmarshaller implements Unmarshaller<DeleteEventBridgeRuleTemplateResult, JsonUnmarshallerContext> {
    ...
    public DeleteEventBridgeRuleTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEventBridgeRuleTemplateResult deleteEventBridgeRuleTemplateResult = new DeleteEventBridgeRuleTemplateResult();

        return deleteEventBridgeRuleTemplateResult;
    }
