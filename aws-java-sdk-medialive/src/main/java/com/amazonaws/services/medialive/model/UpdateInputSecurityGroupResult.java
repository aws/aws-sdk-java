...
public class UpdateInputSecurityGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateInputSecurityGroupResult withSecurityGroup(InputSecurityGroup securityGroup) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateInputSecurityGroupResult == false)
            return false;
        UpdateInputSecurityGroupResult other = (UpdateInputSecurityGroupResult) obj;
    ...
    @Override
    public UpdateInputSecurityGroupResult clone() {
        try {
            return (UpdateInputSecurityGroupResult) super.clone();
