...
/**
 * ColorCorrectionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ColorCorrectionMarshaller {
    ...
    private static final ColorCorrectionMarshaller instance = new ColorCorrectionMarshaller();

    public static ColorCorrectionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ColorCorrection colorCorrection, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(colorCorrection.getInputColorSpace(), INPUTCOLORSPACE_BINDING);
            protocolMarshaller.marshall(colorCorrection.getOutputColorSpace(), OUTPUTCOLORSPACE_BINDING);
            protocolMarshaller.marshall(colorCorrection.getUri(), URI_BINDING);
        } catch (Exception e) {
