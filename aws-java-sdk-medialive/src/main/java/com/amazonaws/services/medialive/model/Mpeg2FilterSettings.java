 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/Mpeg2FilterSettings" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Mpeg2FilterSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public Mpeg2FilterSettings withTemporalFilterSettings(TemporalFilterSettings temporalFilterSettings) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Mpeg2FilterSettings == false)
            return false;
        Mpeg2FilterSettings other = (Mpeg2FilterSettings) obj;
    ...
    @Override
    public Mpeg2FilterSettings clone() {
        try {
            return (Mpeg2FilterSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.Mpeg2FilterSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
