 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/UdpContainerSettings" target="_top">AWS API
 *      Documentation</a>
 */
...
public class UdpContainerSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UdpContainerSettings == false)
            return false;
    ...
    @Override
    public UdpContainerSettings clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.UdpContainerSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
