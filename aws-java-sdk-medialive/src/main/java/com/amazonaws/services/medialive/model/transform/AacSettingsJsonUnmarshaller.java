...
/**
 * AacSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AacSettingsJsonUnmarshaller implements Unmarshaller<AacSettings, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("bitrate", targetDepth)) {
                    context.nextToken();
                    aacSettings.setBitrate(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                ...
                if (context.testExpression("inputType", targetDepth)) {
                    context.nextToken();
                    aacSettings.setInputType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("profile", targetDepth)) {
                    context.nextToken();
                    aacSettings.setProfile(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("sampleRate", targetDepth)) {
                    context.nextToken();
                    aacSettings.setSampleRate(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("spec", targetDepth)) {
                    context.nextToken();
                    aacSettings.setSpec(context.getUnmarshaller(String.class).unmarshall(context));
                }
