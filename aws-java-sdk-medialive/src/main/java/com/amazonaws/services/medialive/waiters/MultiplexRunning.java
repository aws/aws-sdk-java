...
class MultiplexRunning {
    ...
    static class IsRUNNINGMatcher extends WaiterAcceptor<DescribeMultiplexResult> {
    ...
    static class IsSTARTINGMatcher extends WaiterAcceptor<DescribeMultiplexResult> {
        private static final JsonNode expectedResult;
