...
class SignalMapCreated {
    ...
    static class IsCREATE_COMPLETEMatcher extends WaiterAcceptor<GetSignalMapResult> {
    ...
    static class IsCREATE_IN_PROGRESSMatcher extends WaiterAcceptor<GetSignalMapResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<GetSignalMapResult> {
        private static final JsonNode expectedResult;
