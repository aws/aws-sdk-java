...
public class StandardHlsSettingsMarshaller {
    ...
    public void marshall(StandardHlsSettings standardHlsSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(standardHlsSettings.getAudioRenditionSets(), AUDIORENDITIONSETS_BINDING);
            protocolMarshaller.marshall(standardHlsSettings.getM3u8Settings(), M3U8SETTINGS_BINDING);
        } catch (Exception e) {
