...
/**
 * RebootInputDeviceResult JSON Unmarshaller
 */
...
public class RebootInputDeviceResultJsonUnmarshaller implements Unmarshaller<RebootInputDeviceResult, JsonUnmarshallerContext> {
    ...
    public RebootInputDeviceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RebootInputDeviceResult rebootInputDeviceResult = new RebootInputDeviceResult();

        return rebootInputDeviceResult;
    }
