...
public class StartUpdateSignalMapResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartUpdateSignalMapResult withCloudWatchAlarmTemplateGroupIds(java.util.Collection<String> cloudWatchAlarmTemplateGroupIds) {
    ...
    public StartUpdateSignalMapResult withCreatedAt(java.util.Date createdAt) {
    ...
    public StartUpdateSignalMapResult withEventBridgeRuleTemplateGroupIds(java.util.Collection<String> eventBridgeRuleTemplateGroupIds) {
    ...
    public StartUpdateSignalMapResult withFailedMediaResourceMap(java.util.Map<String, MediaResource> failedMediaResourceMap) {
     ...
     *
     * @see StartUpdateSignalMapResult#withFailedMediaResourceMap
    ...
    public StartUpdateSignalMapResult withLastDiscoveredAt(java.util.Date lastDiscoveredAt) {
    ...
    public StartUpdateSignalMapResult withMediaResourceMap(java.util.Map<String, MediaResource> mediaResourceMap) {
     ...
     *
     * @see StartUpdateSignalMapResult#withMediaResourceMap
     * @returns a reference to this object so that method calls can be chained together.
     */
    ...
    public StartUpdateSignalMapResult withModifiedAt(java.util.Date modifiedAt) {
    ...
    public StartUpdateSignalMapResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see StartUpdateSignalMapResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartUpdateSignalMapResult == false)
            return false;
        StartUpdateSignalMapResult other = (StartUpdateSignalMapResult) obj;
