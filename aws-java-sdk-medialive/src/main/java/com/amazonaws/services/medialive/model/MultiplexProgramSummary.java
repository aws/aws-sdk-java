 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/MultiplexProgramSummary" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MultiplexProgramSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public MultiplexProgramSummary clone() {
        try {
            return (MultiplexProgramSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.MultiplexProgramSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
