...
class SignalMapMonitorDeleted {
    ...
    static class IsDELETE_COMPLETEMatcher extends WaiterAcceptor<GetSignalMapResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("MonitorDeployment"), new JmesPathField("Status"));
         ...
         */
        @Override
        public boolean matches(GetSignalMapResult result) {
    ...
    static class IsDELETE_IN_PROGRESSMatcher extends WaiterAcceptor<GetSignalMapResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<GetSignalMapResult> {
        private static final JsonNode expectedResult;
