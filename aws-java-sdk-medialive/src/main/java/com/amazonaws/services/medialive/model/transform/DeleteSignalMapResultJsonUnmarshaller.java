...
/**
 * DeleteSignalMapResult JSON Unmarshaller
 */
...
public class DeleteSignalMapResultJsonUnmarshaller implements Unmarshaller<DeleteSignalMapResult, JsonUnmarshallerContext> {
    ...
    public DeleteSignalMapResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSignalMapResult deleteSignalMapResult = new DeleteSignalMapResult();

        return deleteSignalMapResult;
    }
