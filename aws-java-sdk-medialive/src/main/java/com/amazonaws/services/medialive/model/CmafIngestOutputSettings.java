 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/CmafIngestOutputSettings" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CmafIngestOutputSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CmafIngestOutputSettings == false)
            return false;
        CmafIngestOutputSettings other = (CmafIngestOutputSettings) obj;
    ...
    public CmafIngestOutputSettings clone() {
        try {
            return (CmafIngestOutputSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.CmafIngestOutputSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
