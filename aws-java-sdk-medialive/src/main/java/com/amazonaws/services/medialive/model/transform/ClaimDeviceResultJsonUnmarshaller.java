...
/**
 * ClaimDeviceResult JSON Unmarshaller
 */
...
public class ClaimDeviceResultJsonUnmarshaller implements Unmarshaller<ClaimDeviceResult, JsonUnmarshallerContext> {
    ...
    public ClaimDeviceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ClaimDeviceResult claimDeviceResult = new ClaimDeviceResult();

        return claimDeviceResult;
    }
