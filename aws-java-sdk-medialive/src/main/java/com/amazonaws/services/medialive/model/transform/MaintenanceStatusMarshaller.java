...
/**
 * MaintenanceStatusMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MaintenanceStatusMarshaller {
    ...
    private static final MaintenanceStatusMarshaller instance = new MaintenanceStatusMarshaller();

    public static MaintenanceStatusMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MaintenanceStatus maintenanceStatus, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(maintenanceStatus.getMaintenanceDay(), MAINTENANCEDAY_BINDING);
            protocolMarshaller.marshall(maintenanceStatus.getMaintenanceDeadline(), MAINTENANCEDEADLINE_BINDING);
            protocolMarshaller.marshall(maintenanceStatus.getMaintenanceScheduledDate(), MAINTENANCESCHEDULEDDATE_BINDING);
            protocolMarshaller.marshall(maintenanceStatus.getMaintenanceStartTime(), MAINTENANCESTARTTIME_BINDING);
        } catch (Exception e) {
