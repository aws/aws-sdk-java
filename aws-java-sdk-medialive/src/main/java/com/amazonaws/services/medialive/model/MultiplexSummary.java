 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/MultiplexSummary" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MultiplexSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public MultiplexSummary withAvailabilityZones(String... availabilityZones) {
    ...
    public MultiplexSummary withAvailabilityZones(java.util.Collection<String> availabilityZones) {
    ...
    public void setMultiplexSettings(MultiplexSettingsSummary multiplexSettings) {
    ...
    public MultiplexSettingsSummary getMultiplexSettings() {
    ...
    public MultiplexSummary withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MultiplexSummary == false)
            return false;
    ...
    public MultiplexSummary clone() {
        try {
            return (MultiplexSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.MultiplexSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
