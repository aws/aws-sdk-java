...
/**
 * TtmlDestinationSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TtmlDestinationSettingsMarshaller {
    ...
    private static final TtmlDestinationSettingsMarshaller instance = new TtmlDestinationSettingsMarshaller();

    public static TtmlDestinationSettingsMarshaller getInstance() {
        return instance;
    }
