...
/**
 * FrameCaptureOutputSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FrameCaptureOutputSettingsMarshaller {
    ...
    private static final FrameCaptureOutputSettingsMarshaller instance = new FrameCaptureOutputSettingsMarshaller();

    public static FrameCaptureOutputSettingsMarshaller getInstance() {
        return instance;
    }
