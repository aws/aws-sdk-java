...
class MultiplexDeleted {
    ...
    static class IsDELETEDMatcher extends WaiterAcceptor<DescribeMultiplexResult> {
    ...
    static class IsDELETINGMatcher extends WaiterAcceptor<DescribeMultiplexResult> {
        private static final JsonNode expectedResult;
