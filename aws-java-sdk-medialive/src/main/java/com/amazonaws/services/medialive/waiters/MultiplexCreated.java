...
class MultiplexCreated {
    ...
    static class IsCREATINGMatcher extends WaiterAcceptor<DescribeMultiplexResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<DescribeMultiplexResult> {
        private static final JsonNode expectedResult;
