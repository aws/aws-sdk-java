...
/**
 * OutputDestinationSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OutputDestinationSettingsMarshaller {
    ...
    private static final OutputDestinationSettingsMarshaller instance = new OutputDestinationSettingsMarshaller();

    public static OutputDestinationSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OutputDestinationSettings outputDestinationSettings, ProtocolMarshaller protocolMarshaller) {

        if (outputDestinationSettings == null) {
