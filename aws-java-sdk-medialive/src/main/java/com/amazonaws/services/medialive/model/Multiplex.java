 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/Multiplex" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Multiplex implements Serializable, Cloneable, StructuredPojo {
    ...
    public Multiplex withAvailabilityZones(java.util.Collection<String> availabilityZones) {
    ...
    public Multiplex withDestinations(java.util.Collection<MultiplexOutputDestination> destinations) {
    ...
    public Multiplex withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Multiplex == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.MultiplexMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
