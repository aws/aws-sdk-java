...
public enum FeatureActivationsInputPrepareScheduleActions {
     ...
     * @param value
     *        real value
     * @return FeatureActivationsInputPrepareScheduleActions corresponding to the value
     *
    ...
    public static FeatureActivationsInputPrepareScheduleActions fromValue(String value) {
        ...
        for (FeatureActivationsInputPrepareScheduleActions enumEntry : FeatureActivationsInputPrepareScheduleActions.values()) {
