...
class ChannelCreated {
    ...
    static class IsIDLEMatcher extends WaiterAcceptor<DescribeChannelResult> {
    ...
    static class IsCREATINGMatcher extends WaiterAcceptor<DescribeChannelResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<DescribeChannelResult> {
        private static final JsonNode expectedResult;
