...
@SdkInternalApi
public class StartChannelRequestMarshaller {
    ...
    private static final StartChannelRequestMarshaller instance = new StartChannelRequestMarshaller();

    public static StartChannelRequestMarshaller getInstance() {
        return instance;
    }
