...
public class StopChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StopChannelResult withEgressEndpoints(java.util.Collection<ChannelEgressEndpoint> egressEndpoints) {
    ...
    public StopChannelResult withInputAttachments(java.util.Collection<InputAttachment> inputAttachments) {
    ...
    public StopChannelResult withMaintenance(MaintenanceStatus maintenance) {
    ...
    public StopChannelResult withPipelineDetails(java.util.Collection<PipelineDetail> pipelineDetails) {
     ...
     *
     * @see StopChannelResult#withTags
    ...
    public StopChannelResult withVpc(VpcOutputSettingsDescription vpc) {
        setVpc(vpc);
        return this;
    }
    ...
    @Override
    public StopChannelResult clone() {
        try {
            return (StopChannelResult) super.clone();
