...
/**
 * MultiplexStatmuxVideoSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MultiplexStatmuxVideoSettingsMarshaller {

    private static final MarshallingInfo<Integer> MAXIMUMBITRATE_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
    ...
    public static MultiplexStatmuxVideoSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MultiplexStatmuxVideoSettings multiplexStatmuxVideoSettings, ProtocolMarshaller protocolMarshaller) {

        if (multiplexStatmuxVideoSettings == null) {
