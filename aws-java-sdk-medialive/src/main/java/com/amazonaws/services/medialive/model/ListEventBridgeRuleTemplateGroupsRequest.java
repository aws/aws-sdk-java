...
public class ListEventBridgeRuleTemplateGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListEventBridgeRuleTemplateGroupsRequest withMaxResults(Integer maxResults) {
    ...
    public ListEventBridgeRuleTemplateGroupsRequest withNextToken(String nextToken) {
    ...
    public ListEventBridgeRuleTemplateGroupsRequest withSignalMapIdentifier(String signalMapIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEventBridgeRuleTemplateGroupsRequest == false)
            return false;
        ListEventBridgeRuleTemplateGroupsRequest other = (ListEventBridgeRuleTemplateGroupsRequest) obj;
    ...
    @Override
    public ListEventBridgeRuleTemplateGroupsRequest clone() {
        return (ListEventBridgeRuleTemplateGroupsRequest) super.clone();
    }
