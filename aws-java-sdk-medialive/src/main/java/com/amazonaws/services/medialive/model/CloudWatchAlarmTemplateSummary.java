 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/CloudWatchAlarmTemplateSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CloudWatchAlarmTemplateSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public CloudWatchAlarmTemplateSummary withCreatedAt(java.util.Date createdAt) {
    ...
    public CloudWatchAlarmTemplateSummary withModifiedAt(java.util.Date modifiedAt) {
    ...
    public CloudWatchAlarmTemplateSummary withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CloudWatchAlarmTemplateSummary#withTags
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CloudWatchAlarmTemplateSummary == false)
            return false;
        CloudWatchAlarmTemplateSummary other = (CloudWatchAlarmTemplateSummary) obj;
    ...
    public CloudWatchAlarmTemplateSummary clone() {
        try {
            return (CloudWatchAlarmTemplateSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.CloudWatchAlarmTemplateSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
