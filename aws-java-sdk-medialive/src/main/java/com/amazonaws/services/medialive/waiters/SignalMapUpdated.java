...
class SignalMapUpdated {
    ...
    static class IsUPDATE_COMPLETEMatcher extends WaiterAcceptor<GetSignalMapResult> {
    ...
    static class IsUPDATE_IN_PROGRESSMatcher extends WaiterAcceptor<GetSignalMapResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATE_FAILEDMatcher extends WaiterAcceptor<GetSignalMapResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATE_REVERTEDMatcher extends WaiterAcceptor<GetSignalMapResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"UPDATE_REVERTED\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
