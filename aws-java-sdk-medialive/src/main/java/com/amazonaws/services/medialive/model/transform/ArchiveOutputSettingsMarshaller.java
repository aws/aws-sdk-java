...
/**
 * ArchiveOutputSettingsMarshaller
 */
...
public class ArchiveOutputSettingsMarshaller {
    ...
    public void marshall(ArchiveOutputSettings archiveOutputSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(archiveOutputSettings.getContainerSettings(), CONTAINERSETTINGS_BINDING);
            protocolMarshaller.marshall(archiveOutputSettings.getExtension(), EXTENSION_BINDING);
            protocolMarshaller.marshall(archiveOutputSettings.getNameModifier(), NAMEMODIFIER_BINDING);
        } catch (Exception e) {
