...
/**
 * StaticKeySettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StaticKeySettingsMarshaller {

    private static final MarshallingInfo<StructuredPojo> KEYPROVIDERSERVER_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("keyProviderServer").build();
    ...
    public void marshall(StaticKeySettings staticKeySettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(staticKeySettings.getKeyProviderServer(), KEYPROVIDERSERVER_BINDING);
            protocolMarshaller.marshall(staticKeySettings.getStaticKeyValue(), STATICKEYVALUE_BINDING);
        } catch (Exception e) {
