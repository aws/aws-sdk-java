 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/MonitorDeployment" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MonitorDeployment implements Serializable, Cloneable, StructuredPojo {
     ...
     * Error message associated with a failed monitor deployment of a signal map.
     * 
     * @return Error message associated with a failed monitor deployment of a signal map.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MonitorDeployment == false)
            return false;
    ...
    public MonitorDeployment clone() {
        try {
            return (MonitorDeployment) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.MonitorDeploymentMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
