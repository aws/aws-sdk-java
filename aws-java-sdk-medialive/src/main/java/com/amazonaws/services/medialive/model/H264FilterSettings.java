 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/H264FilterSettings" target="_top">AWS API
 *      Documentation</a>
 */
...
public class H264FilterSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public H264FilterSettings clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.H264FilterSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
