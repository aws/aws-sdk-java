...
/**
 * AvailConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AvailConfigurationMarshaller {
    ...
    public static AvailConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AvailConfiguration availConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (availConfiguration == null) {
