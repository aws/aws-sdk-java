...
/**
 * Hdr10Settings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Hdr10SettingsJsonUnmarshaller implements Unmarshaller<Hdr10Settings, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("maxCll", targetDepth)) {
                    context.nextToken();
                    hdr10Settings.setMaxCll(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("maxFall", targetDepth)) {
                    context.nextToken();
                    hdr10Settings.setMaxFall(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
