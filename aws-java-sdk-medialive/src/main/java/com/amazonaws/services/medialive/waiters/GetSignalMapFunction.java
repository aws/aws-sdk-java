...
public class GetSignalMapFunction implements SdkFunction<GetSignalMapRequest, GetSignalMapResult> {
    ...
    /**
     * Constructs a new GetSignalMapFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetSignalMapFunction(AWSMediaLive client) {
        this.client = client;
    }
    ...
    public GetSignalMapResult apply(GetSignalMapRequest getSignalMapRequest) {
        return client.getSignalMap(getSignalMapRequest);
    }
}
