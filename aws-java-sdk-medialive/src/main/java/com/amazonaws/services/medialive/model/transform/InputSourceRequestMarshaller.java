...
public class InputSourceRequestMarshaller {
    ...
    public void marshall(InputSourceRequest inputSourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        if (inputSourceRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(inputSourceRequest.getPasswordParam(), PASSWORDPARAM_BINDING);
            protocolMarshaller.marshall(inputSourceRequest.getUrl(), URL_BINDING);
            protocolMarshaller.marshall(inputSourceRequest.getUsername(), USERNAME_BINDING);
        } catch (Exception e) {
