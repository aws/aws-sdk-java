...
class ChannelDeleted {
    ...
    static class IsDELETEDMatcher extends WaiterAcceptor<DescribeChannelResult> {
         ...
         */
        @Override
        public boolean matches(DescribeChannelResult result) {
    ...
    static class IsDELETINGMatcher extends WaiterAcceptor<DescribeChannelResult> {
        private static final JsonNode expectedResult;
