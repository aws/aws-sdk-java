...
class MultiplexStopped {
    ...
    static class IsIDLEMatcher extends WaiterAcceptor<DescribeMultiplexResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"IDLE\"");
         ...
         */
        @Override
        public boolean matches(DescribeMultiplexResult result) {
    ...
    static class IsSTOPPINGMatcher extends WaiterAcceptor<DescribeMultiplexResult> {
        private static final JsonNode expectedResult;
