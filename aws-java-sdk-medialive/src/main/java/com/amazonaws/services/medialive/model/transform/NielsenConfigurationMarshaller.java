...
public class NielsenConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> NIELSENPCMTOID3TAGGING_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("nielsenPcmToId3Tagging").build();
    ...
    public void marshall(NielsenConfiguration nielsenConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(nielsenConfiguration.getNielsenPcmToId3Tagging(), NIELSENPCMTOID3TAGGING_BINDING);
        } catch (Exception e) {
