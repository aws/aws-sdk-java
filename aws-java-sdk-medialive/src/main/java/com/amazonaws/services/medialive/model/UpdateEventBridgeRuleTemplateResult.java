...
public class UpdateEventBridgeRuleTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateEventBridgeRuleTemplateResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public UpdateEventBridgeRuleTemplateResult withCreatedAt(java.util.Date createdAt) {
    ...
    public UpdateEventBridgeRuleTemplateResult withDescription(String description) {
    ...
    public UpdateEventBridgeRuleTemplateResult withEventTargets(EventBridgeRuleTemplateTarget... eventTargets) {
    ...
    public UpdateEventBridgeRuleTemplateResult withEventTargets(java.util.Collection<EventBridgeRuleTemplateTarget> eventTargets) {
    ...
    public UpdateEventBridgeRuleTemplateResult withEventType(String eventType) {
    ...
    public UpdateEventBridgeRuleTemplateResult withEventType(EventBridgeRuleTemplateEventType eventType) {
    ...
    public UpdateEventBridgeRuleTemplateResult withGroupId(String groupId) {
        setGroupId(groupId);
        return this;
    }
    ...
    public UpdateEventBridgeRuleTemplateResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public UpdateEventBridgeRuleTemplateResult withModifiedAt(java.util.Date modifiedAt) {
    ...
    public UpdateEventBridgeRuleTemplateResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public UpdateEventBridgeRuleTemplateResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateEventBridgeRuleTemplateResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateEventBridgeRuleTemplateResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UpdateEventBridgeRuleTemplateResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateEventBridgeRuleTemplateResult == false)
            return false;
        UpdateEventBridgeRuleTemplateResult other = (UpdateEventBridgeRuleTemplateResult) obj;
    ...
    @Override
    public UpdateEventBridgeRuleTemplateResult clone() {
        try {
            return (UpdateEventBridgeRuleTemplateResult) super.clone();
