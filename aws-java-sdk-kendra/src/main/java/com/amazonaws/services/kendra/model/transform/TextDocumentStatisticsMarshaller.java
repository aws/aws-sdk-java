...
@SdkInternalApi
public class TextDocumentStatisticsMarshaller {
    ...
    public static TextDocumentStatisticsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TextDocumentStatistics textDocumentStatistics, ProtocolMarshaller protocolMarshaller) {
