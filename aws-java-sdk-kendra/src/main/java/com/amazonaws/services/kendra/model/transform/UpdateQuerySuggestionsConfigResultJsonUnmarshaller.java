...
/**
 * UpdateQuerySuggestionsConfigResult JSON Unmarshaller
 */
...
public class UpdateQuerySuggestionsConfigResultJsonUnmarshaller implements Unmarshaller<UpdateQuerySuggestionsConfigResult, JsonUnmarshallerContext> {
    ...
    public UpdateQuerySuggestionsConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateQuerySuggestionsConfigResult updateQuerySuggestionsConfigResult = new UpdateQuerySuggestionsConfigResult();

        return updateQuerySuggestionsConfigResult;
    }
