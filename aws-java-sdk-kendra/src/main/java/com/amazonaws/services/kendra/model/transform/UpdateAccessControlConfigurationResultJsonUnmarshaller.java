...
/**
 * UpdateAccessControlConfigurationResult JSON Unmarshaller
 */
...
public class UpdateAccessControlConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateAccessControlConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateAccessControlConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateAccessControlConfigurationResult updateAccessControlConfigurationResult = new UpdateAccessControlConfigurationResult();

        return updateAccessControlConfigurationResult;
    }
