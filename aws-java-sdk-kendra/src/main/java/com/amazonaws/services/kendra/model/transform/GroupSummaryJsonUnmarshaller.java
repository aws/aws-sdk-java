        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GroupId", targetDepth)) {
                    context.nextToken();
                    groupSummary.setGroupId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("OrderingId", targetDepth)) {
                    context.nextToken();
                    groupSummary.setOrderingId(context.getUnmarshaller(Long.class).unmarshall(context));
                }
