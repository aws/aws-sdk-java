...
public class ListExperiencesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ExperiencesSummary> summaryItems;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return An array of summary information for one or more Amazon Kendra experiences.
     */

    public java.util.List<ExperiencesSummary> getSummaryItems() {
        return summaryItems;
    }
    ...
    public void setSummaryItems(java.util.Collection<ExperiencesSummary> summaryItems) {
        if (summaryItems == null) {
            this.summaryItems = null;
            return;
        }

        this.summaryItems = new java.util.ArrayList<ExperiencesSummary>(summaryItems);
    }
    ...
    public ListExperiencesResult withSummaryItems(ExperiencesSummary... summaryItems) {
        if (this.summaryItems == null) {
            setSummaryItems(new java.util.ArrayList<ExperiencesSummary>(summaryItems.length));
        }
        for (ExperiencesSummary ele : summaryItems) {
    ...
    public ListExperiencesResult withSummaryItems(java.util.Collection<ExperiencesSummary> summaryItems) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListExperiencesResult == false)
            return false;
        ListExperiencesResult other = (ListExperiencesResult) obj;
    ...
    public ListExperiencesResult clone() {
        try {
            return (ListExperiencesResult) super.clone();
