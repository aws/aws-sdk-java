...
/**
 * FeaturedResultsSet JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FeaturedResultsSetJsonUnmarshaller implements Unmarshaller<FeaturedResultsSet, JsonUnmarshallerContext> {

    public FeaturedResultsSet unmarshall(JsonUnmarshallerContext context) throws Exception {
        FeaturedResultsSet featuredResultsSet = new FeaturedResultsSet();
    ...
    private static FeaturedResultsSetJsonUnmarshaller instance;

    public static FeaturedResultsSetJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FeaturedResultsSetJsonUnmarshaller();
        return instance;
    }
}
