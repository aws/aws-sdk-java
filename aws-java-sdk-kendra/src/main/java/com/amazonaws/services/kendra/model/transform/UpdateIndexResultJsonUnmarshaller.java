...
/**
 * UpdateIndexResult JSON Unmarshaller
 */
...
public class UpdateIndexResultJsonUnmarshaller implements Unmarshaller<UpdateIndexResult, JsonUnmarshallerContext> {
    ...
    public UpdateIndexResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateIndexResult updateIndexResult = new UpdateIndexResult();
