...
/**
 * DescribeAccessControlConfigurationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeAccessControlConfigurationResultJsonUnmarshaller implements
        Unmarshaller<DescribeAccessControlConfigurationResult, JsonUnmarshallerContext> {

    public DescribeAccessControlConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribeAccessControlConfigurationResult describeAccessControlConfigurationResult = new DescribeAccessControlConfigurationResult();
    ...
    private static DescribeAccessControlConfigurationResultJsonUnmarshaller instance;

    public static DescribeAccessControlConfigurationResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeAccessControlConfigurationResultJsonUnmarshaller();
        return instance;
    }
}
