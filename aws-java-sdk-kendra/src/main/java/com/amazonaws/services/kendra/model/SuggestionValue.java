 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kendra-2019-02-03/SuggestionValue" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SuggestionValue implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setText(SuggestionTextWithHighlights text) {
        this.text = text;
    }
    ...
    public SuggestionTextWithHighlights getText() {
        return this.text;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SuggestionValue == false)
            return false;
    ...
    @Override
    public SuggestionValue clone() {
        try {
            return (SuggestionValue) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kendra.model.transform.SuggestionValueMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
