...
/**
 * DeleteThesaurusResult JSON Unmarshaller
 */
...
public class DeleteThesaurusResultJsonUnmarshaller implements Unmarshaller<DeleteThesaurusResult, JsonUnmarshallerContext> {
    ...
    public DeleteThesaurusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteThesaurusResult deleteThesaurusResult = new DeleteThesaurusResult();

        return deleteThesaurusResult;
    }
