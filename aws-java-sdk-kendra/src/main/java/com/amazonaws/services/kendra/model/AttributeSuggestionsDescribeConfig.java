 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kendra-2019-02-03/AttributeSuggestionsDescribeConfig"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AttributeSuggestionsDescribeConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public AttributeSuggestionsDescribeConfig withSuggestableConfigList(SuggestableConfig... suggestableConfigList) {
    ...
    public AttributeSuggestionsDescribeConfig withSuggestableConfigList(java.util.Collection<SuggestableConfig> suggestableConfigList) {
    ...
    public AttributeSuggestionsDescribeConfig withAttributeSuggestionsMode(String attributeSuggestionsMode) {
    ...
    public AttributeSuggestionsDescribeConfig withAttributeSuggestionsMode(AttributeSuggestionsMode attributeSuggestionsMode) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttributeSuggestionsDescribeConfig == false)
            return false;
    ...
    @Override
    public AttributeSuggestionsDescribeConfig clone() {
        try {
            return (AttributeSuggestionsDescribeConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kendra.model.transform.AttributeSuggestionsDescribeConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
