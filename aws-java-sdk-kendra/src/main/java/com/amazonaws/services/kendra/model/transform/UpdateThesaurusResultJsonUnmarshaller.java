...
/**
 * UpdateThesaurusResult JSON Unmarshaller
 */
...
public class UpdateThesaurusResultJsonUnmarshaller implements Unmarshaller<UpdateThesaurusResult, JsonUnmarshallerContext> {
    ...
    public UpdateThesaurusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateThesaurusResult updateThesaurusResult = new UpdateThesaurusResult();

        return updateThesaurusResult;
    }
