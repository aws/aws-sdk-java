...
public class StartDataSourceSyncJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The identifier of the data source connector to synchronize.
     */
    ...
    @Override
    public StartDataSourceSyncJobRequest clone() {
