...
public class AssociatePersonasToEntitiesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociatePersonasToEntitiesResult withFailedEntityList(FailedEntity... failedEntityList) {
    ...
    public AssociatePersonasToEntitiesResult withFailedEntityList(java.util.Collection<FailedEntity> failedEntityList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociatePersonasToEntitiesResult == false)
            return false;
        AssociatePersonasToEntitiesResult other = (AssociatePersonasToEntitiesResult) obj;
    ...
    public AssociatePersonasToEntitiesResult clone() {
        try {
            return (AssociatePersonasToEntitiesResult) super.clone();
