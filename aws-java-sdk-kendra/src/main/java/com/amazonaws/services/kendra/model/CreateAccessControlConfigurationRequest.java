...
public class CreateAccessControlConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateAccessControlConfigurationRequest withAccessControlList(java.util.Collection<Principal> accessControlList) {
    ...
    public CreateAccessControlConfigurationRequest withHierarchicalAccessControlList(java.util.Collection<HierarchicalPrincipal> hierarchicalAccessControlList) {
     ...
     *        to the <code>CreateAccessControlConfiguration</code> API with the same client token will create only one
