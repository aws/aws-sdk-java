...
/**
 * QueryStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class QueryStatusJsonUnmarshaller implements Unmarshaller<QueryStatus, JsonUnmarshallerContext> {

    public QueryStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static QueryStatusJsonUnmarshaller instance;

    public static QueryStatusJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new QueryStatusJsonUnmarshaller();
        return instance;
    }
}
