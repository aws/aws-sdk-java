...
public class DimensionMappingMarshaller {
    ...
    public void marshall(DimensionMapping dimensionMapping, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dimensionMapping.getName(), NAME_BINDING);
            protocolMarshaller.marshall(dimensionMapping.getDimensionValueType(), DIMENSIONVALUETYPE_BINDING);
        } catch (Exception e) {
