        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MaxQueryTCU", targetDepth)) {
                    context.nextToken();
                    updateAccountSettingsResult.setMaxQueryTCU(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("QueryPricingModel", targetDepth)) {
                    context.nextToken();
                    updateAccountSettingsResult.setQueryPricingModel(context.getUnmarshaller(String.class).unmarshall(context));
                }
