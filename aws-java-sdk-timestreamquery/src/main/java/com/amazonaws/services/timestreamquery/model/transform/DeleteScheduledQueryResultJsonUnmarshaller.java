...
/**
 * DeleteScheduledQueryResult JSON Unmarshaller
 */
...
public class DeleteScheduledQueryResultJsonUnmarshaller implements Unmarshaller<DeleteScheduledQueryResult, JsonUnmarshallerContext> {
    ...
    public DeleteScheduledQueryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteScheduledQueryResult deleteScheduledQueryResult = new DeleteScheduledQueryResult();
