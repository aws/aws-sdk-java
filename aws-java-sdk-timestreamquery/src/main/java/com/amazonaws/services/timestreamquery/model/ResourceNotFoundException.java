...
public class ResourceNotFoundException extends com.amazonaws.services.timestreamquery.model.AmazonTimestreamQueryException {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("ScheduledQueryArn")
    ...
    public ResourceNotFoundException withScheduledQueryArn(String scheduledQueryArn) {
