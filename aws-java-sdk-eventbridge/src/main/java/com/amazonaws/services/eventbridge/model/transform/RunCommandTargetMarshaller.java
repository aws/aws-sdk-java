...
/**
 * RunCommandTargetMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RunCommandTargetMarshaller {
    ...
    private static final RunCommandTargetMarshaller instance = new RunCommandTargetMarshaller();

    public static RunCommandTargetMarshaller getInstance() {
        return instance;
    }
