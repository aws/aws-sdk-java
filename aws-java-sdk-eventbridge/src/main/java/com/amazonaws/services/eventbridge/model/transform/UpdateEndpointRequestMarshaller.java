...
public class UpdateEndpointRequestMarshaller {
    ...
    public void marshall(UpdateEndpointRequest updateEndpointRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateEndpointRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateEndpointRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateEndpointRequest.getRoutingConfig(), ROUTINGCONFIG_BINDING);
            protocolMarshaller.marshall(updateEndpointRequest.getReplicationConfig(), REPLICATIONCONFIG_BINDING);
            protocolMarshaller.marshall(updateEndpointRequest.getEventBuses(), EVENTBUSES_BINDING);
            protocolMarshaller.marshall(updateEndpointRequest.getRoleArn(), ROLEARN_BINDING);
        } catch (Exception e) {
