...
public class PolicyLengthExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PolicyLengthExceededExceptionUnmarshaller instance;

    public static PolicyLengthExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PolicyLengthExceededExceptionUnmarshaller();
        return instance;
    }
}
