...
public class ConcurrentModificationExceptionUnmarshaller extends
        JsonErrorUnmarshaller<com.amazonaws.services.eventbridge.model.ConcurrentModificationException> {
    private ConcurrentModificationExceptionUnmarshaller() {
        super("ConcurrentModificationException");
    }

    @Override
    public com.amazonaws.services.eventbridge.model.ConcurrentModificationException unmarshall(JsonUnmarshallerContext context) throws Exception {
