...
public class PrimaryMarshaller {
    ...
    private static final PrimaryMarshaller instance = new PrimaryMarshaller();

    public static PrimaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Primary primary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(primary.getHealthCheck(), HEALTHCHECK_BINDING);
        } catch (Exception e) {
