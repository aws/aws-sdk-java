...
public class CancelReplayRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the replay to cancel.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelReplayRequest == false)
            return false;
        CancelReplayRequest other = (CancelReplayRequest) obj;
    ...
    @Override
    public CancelReplayRequest clone() {
        return (CancelReplayRequest) super.clone();
    }
