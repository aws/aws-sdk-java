...
@SdkInternalApi
public class EventBusMarshaller {
    ...
    public static EventBusMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EventBus eventBus, ProtocolMarshaller protocolMarshaller) {
