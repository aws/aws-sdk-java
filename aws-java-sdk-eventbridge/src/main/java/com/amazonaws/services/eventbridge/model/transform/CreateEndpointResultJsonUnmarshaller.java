...
public class CreateEndpointResultJsonUnmarshaller implements Unmarshaller<CreateEndpointResult, JsonUnmarshallerContext> {

    public CreateEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateEndpointResult createEndpointResult = new CreateEndpointResult();
    ...
    private static CreateEndpointResultJsonUnmarshaller instance;

    public static CreateEndpointResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateEndpointResultJsonUnmarshaller();
        return instance;
    }
}
