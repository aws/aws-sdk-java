...
/**
 * EventConfigurationItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EventConfigurationItemJsonUnmarshaller implements Unmarshaller<EventConfigurationItem, JsonUnmarshallerContext> {

    public EventConfigurationItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        EventConfigurationItem eventConfigurationItem = new EventConfigurationItem();
    ...
    private static EventConfigurationItemJsonUnmarshaller instance;

    public static EventConfigurationItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EventConfigurationItemJsonUnmarshaller();
        return instance;
    }
}
