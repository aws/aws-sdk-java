...
public class AssociateWirelessDeviceWithMulticastGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public AssociateWirelessDeviceWithMulticastGroupRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public AssociateWirelessDeviceWithMulticastGroupRequest withWirelessDeviceId(String wirelessDeviceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateWirelessDeviceWithMulticastGroupRequest == false)
            return false;
        AssociateWirelessDeviceWithMulticastGroupRequest other = (AssociateWirelessDeviceWithMulticastGroupRequest) obj;
    ...
    @Override
    public AssociateWirelessDeviceWithMulticastGroupRequest clone() {
        return (AssociateWirelessDeviceWithMulticastGroupRequest) super.clone();
    }
