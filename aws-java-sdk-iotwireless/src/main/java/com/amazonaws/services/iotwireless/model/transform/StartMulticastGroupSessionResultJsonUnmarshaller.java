...
/**
 * StartMulticastGroupSessionResult JSON Unmarshaller
 */
...
public class StartMulticastGroupSessionResultJsonUnmarshaller implements Unmarshaller<StartMulticastGroupSessionResult, JsonUnmarshallerContext> {
    ...
    public StartMulticastGroupSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartMulticastGroupSessionResult startMulticastGroupSessionResult = new StartMulticastGroupSessionResult();
