...
/**
 * GetEventConfigurationByResourceTypesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetEventConfigurationByResourceTypesResultJsonUnmarshaller implements
        Unmarshaller<GetEventConfigurationByResourceTypesResult, JsonUnmarshallerContext> {

    public GetEventConfigurationByResourceTypesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetEventConfigurationByResourceTypesResult getEventConfigurationByResourceTypesResult = new GetEventConfigurationByResourceTypesResult();
    ...
    private static GetEventConfigurationByResourceTypesResultJsonUnmarshaller instance;

    public static GetEventConfigurationByResourceTypesResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetEventConfigurationByResourceTypesResultJsonUnmarshaller();
        return instance;
    }
}
