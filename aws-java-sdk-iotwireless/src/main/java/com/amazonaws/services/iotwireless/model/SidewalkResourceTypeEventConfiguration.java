 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotwireless-2020-11-22/SidewalkResourceTypeEventConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SidewalkResourceTypeEventConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public SidewalkResourceTypeEventConfiguration withWirelessDeviceEventTopic(String wirelessDeviceEventTopic) {
    ...
    public SidewalkResourceTypeEventConfiguration withWirelessDeviceEventTopic(EventNotificationTopicStatus wirelessDeviceEventTopic) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SidewalkResourceTypeEventConfiguration == false)
            return false;
        SidewalkResourceTypeEventConfiguration other = (SidewalkResourceTypeEventConfiguration) obj;
    ...
    @Override
    public SidewalkResourceTypeEventConfiguration clone() {
        try {
            return (SidewalkResourceTypeEventConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotwireless.model.transform.SidewalkResourceTypeEventConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
