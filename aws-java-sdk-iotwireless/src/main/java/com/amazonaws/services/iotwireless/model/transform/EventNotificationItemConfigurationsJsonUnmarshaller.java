...
/**
 * EventNotificationItemConfigurations JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EventNotificationItemConfigurationsJsonUnmarshaller implements Unmarshaller<EventNotificationItemConfigurations, JsonUnmarshallerContext> {

    public EventNotificationItemConfigurations unmarshall(JsonUnmarshallerContext context) throws Exception {
        EventNotificationItemConfigurations eventNotificationItemConfigurations = new EventNotificationItemConfigurations();
    ...
    private static EventNotificationItemConfigurationsJsonUnmarshaller instance;

    public static EventNotificationItemConfigurationsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EventNotificationItemConfigurationsJsonUnmarshaller();
        return instance;
    }
}
