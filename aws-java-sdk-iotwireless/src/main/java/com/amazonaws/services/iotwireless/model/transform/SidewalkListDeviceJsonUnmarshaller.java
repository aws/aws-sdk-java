...
/**
 * SidewalkListDevice JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SidewalkListDeviceJsonUnmarshaller implements Unmarshaller<SidewalkListDevice, JsonUnmarshallerContext> {

    public SidewalkListDevice unmarshall(JsonUnmarshallerContext context) throws Exception {
        SidewalkListDevice sidewalkListDevice = new SidewalkListDevice();
    ...
    private static SidewalkListDeviceJsonUnmarshaller instance;

    public static SidewalkListDeviceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SidewalkListDeviceJsonUnmarshaller();
        return instance;
    }
}
