...
/**
 * UpdateEventConfigurationByResourceTypesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateEventConfigurationByResourceTypesRequestMarshaller {
    ...
    public static UpdateEventConfigurationByResourceTypesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateEventConfigurationByResourceTypesRequest updateEventConfigurationByResourceTypesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateEventConfigurationByResourceTypesRequest.getDeviceRegistrationState(), DEVICEREGISTRATIONSTATE_BINDING);
