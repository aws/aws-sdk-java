 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotwireless-2020-11-22/UpdateAbpV1_0_x" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateAbpV10X implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAbpV10X == false)
            return false;
        UpdateAbpV10X other = (UpdateAbpV10X) obj;
    ...
    @Override
    public UpdateAbpV10X clone() {
        try {
            return (UpdateAbpV10X) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotwireless.model.transform.UpdateAbpV10XMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
