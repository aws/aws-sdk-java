...
/**
 * GsmNmrObj JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GsmNmrObjJsonUnmarshaller implements Unmarshaller<GsmNmrObj, JsonUnmarshallerContext> {

    public GsmNmrObj unmarshall(JsonUnmarshallerContext context) throws Exception {
        GsmNmrObj gsmNmrObj = new GsmNmrObj();
    ...
    private static GsmNmrObjJsonUnmarshaller instance;

    public static GsmNmrObjJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GsmNmrObjJsonUnmarshaller();
        return instance;
    }
}
