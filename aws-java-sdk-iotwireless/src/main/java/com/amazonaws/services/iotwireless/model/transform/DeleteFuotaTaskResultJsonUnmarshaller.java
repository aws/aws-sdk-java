...
/**
 * DeleteFuotaTaskResult JSON Unmarshaller
 */
...
public class DeleteFuotaTaskResultJsonUnmarshaller implements Unmarshaller<DeleteFuotaTaskResult, JsonUnmarshallerContext> {
    ...
    public DeleteFuotaTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFuotaTaskResult deleteFuotaTaskResult = new DeleteFuotaTaskResult();
