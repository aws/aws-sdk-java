...
/**
 * SidewalkDeviceMetadata JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SidewalkDeviceMetadataJsonUnmarshaller implements Unmarshaller<SidewalkDeviceMetadata, JsonUnmarshallerContext> {

    public SidewalkDeviceMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        SidewalkDeviceMetadata sidewalkDeviceMetadata = new SidewalkDeviceMetadata();
    ...
    private static SidewalkDeviceMetadataJsonUnmarshaller instance;

    public static SidewalkDeviceMetadataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SidewalkDeviceMetadataJsonUnmarshaller();
        return instance;
    }
}
