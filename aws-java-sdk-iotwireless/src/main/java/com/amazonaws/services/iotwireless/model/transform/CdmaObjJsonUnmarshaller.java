...
/**
 * CdmaObj JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CdmaObjJsonUnmarshaller implements Unmarshaller<CdmaObj, JsonUnmarshallerContext> {

    public CdmaObj unmarshall(JsonUnmarshallerContext context) throws Exception {
        CdmaObj cdmaObj = new CdmaObj();
    ...
    private static CdmaObjJsonUnmarshaller instance;

    public static CdmaObjJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CdmaObjJsonUnmarshaller();
        return instance;
    }
}
