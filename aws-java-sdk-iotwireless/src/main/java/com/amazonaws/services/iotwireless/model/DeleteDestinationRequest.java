...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotwireless-2020-11-22/DeleteDestination" target="_top">AWS API
 *      Documentation</a>
 */
...
public class DeleteDestinationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the resource to delete.
     */
    ...
    public DeleteDestinationRequest withName(String name) {
        setName(name);
        return this;
    }
