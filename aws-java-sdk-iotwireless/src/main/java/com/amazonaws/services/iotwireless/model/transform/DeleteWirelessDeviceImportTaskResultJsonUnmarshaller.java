...
/**
 * DeleteWirelessDeviceImportTaskResult JSON Unmarshaller
 */
...
public class DeleteWirelessDeviceImportTaskResultJsonUnmarshaller implements Unmarshaller<DeleteWirelessDeviceImportTaskResult, JsonUnmarshallerContext> {
    ...
    public DeleteWirelessDeviceImportTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteWirelessDeviceImportTaskResult deleteWirelessDeviceImportTaskResult = new DeleteWirelessDeviceImportTaskResult();

        return deleteWirelessDeviceImportTaskResult;
    }
