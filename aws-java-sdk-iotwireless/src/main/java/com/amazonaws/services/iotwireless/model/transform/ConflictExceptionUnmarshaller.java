...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.iotwireless.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.iotwireless.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iotwireless.model.ConflictException conflictException = new com.amazonaws.services.iotwireless.model.ConflictException(null);
