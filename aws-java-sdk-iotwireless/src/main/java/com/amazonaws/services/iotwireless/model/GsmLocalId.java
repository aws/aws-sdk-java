 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotwireless-2020-11-22/GsmLocalId" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GsmLocalId implements Serializable, Cloneable, StructuredPojo {
    ...
    public GsmLocalId withBsic(Integer bsic) {
        setBsic(bsic);
        return this;
    }
    ...
    public GsmLocalId withBcch(Integer bcch) {
        setBcch(bcch);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GsmLocalId == false)
            return false;
    ...
    @Override
    public GsmLocalId clone() {
        try {
            return (GsmLocalId) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotwireless.model.transform.GsmLocalIdMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
