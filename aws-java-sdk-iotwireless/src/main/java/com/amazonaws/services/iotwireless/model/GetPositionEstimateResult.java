...
public class GetPositionEstimateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetPositionEstimateResult withGeoJsonPayload(java.nio.ByteBuffer geoJsonPayload) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPositionEstimateResult == false)
            return false;
        GetPositionEstimateResult other = (GetPositionEstimateResult) obj;
    ...
    public GetPositionEstimateResult clone() {
        try {
            return (GetPositionEstimateResult) super.clone();
