...
/**
 * AssociateWirelessGatewayWithThingResult JSON Unmarshaller
 */
...
public class AssociateWirelessGatewayWithThingResultJsonUnmarshaller implements Unmarshaller<AssociateWirelessGatewayWithThingResult, JsonUnmarshallerContext> {
    ...
    public AssociateWirelessGatewayWithThingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateWirelessGatewayWithThingResult associateWirelessGatewayWithThingResult = new AssociateWirelessGatewayWithThingResult();
