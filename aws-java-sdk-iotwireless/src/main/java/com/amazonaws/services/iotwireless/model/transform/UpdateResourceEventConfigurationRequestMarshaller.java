...
/**
 * UpdateResourceEventConfigurationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateResourceEventConfigurationRequestMarshaller {
    ...
    public static UpdateResourceEventConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateResourceEventConfigurationRequest updateResourceEventConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateResourceEventConfigurationRequest.getIdentifier(), IDENTIFIER_BINDING);
            protocolMarshaller.marshall(updateResourceEventConfigurationRequest.getIdentifierType(), IDENTIFIERTYPE_BINDING);
            ...
            protocolMarshaller.marshall(updateResourceEventConfigurationRequest.getMessageDeliveryStatus(), MESSAGEDELIVERYSTATUS_BINDING);
        } catch (Exception e) {
