...
public class UpdateProvisionedProductRequestMarshaller
    ...
    public UpdateProvisionedProductRequestMarshaller(
        ...
        try {
            ...
            if (updateProvisionedProductRequest.getAcceptLanguage() != null) {
                jsonGenerator.writeFieldName("AcceptLanguage").writeValue(
                        updateProvisionedProductRequest.getAcceptLanguage());
            }
            ...
            if (updateProvisionedProductRequest.getProductId() != null) {
                jsonGenerator.writeFieldName("ProductId").writeValue(
                        updateProvisionedProductRequest.getProductId());
            }
            ...
            if (updateProvisionedProductRequest.getPathId() != null) {
                jsonGenerator.writeFieldName("PathId").writeValue(
                        updateProvisionedProductRequest.getPathId());
            }

            java.util.List<UpdateProvisioningParameter> provisioningParametersList = updateProvisionedProductRequest
            ...
            if (provisioningParametersList != null) {
                ...
                for (UpdateProvisioningParameter provisioningParametersListValue : provisioningParametersList) {
                    if (provisioningParametersListValue != null) {
                        ...
                        UpdateProvisioningParameterJsonMarshaller.getInstance()
            ...
            jsonGenerator.writeFieldName("UpdateToken").writeValue(
                    IdempotentUtils
                            .resolveString(updateProvisionedProductRequest
                                    .getUpdateToken()));
