...
public class EnableAWSOrganizationsAccessRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public EnableAWSOrganizationsAccessRequest clone() {
        return (EnableAWSOrganizationsAccessRequest) super.clone();
    }
