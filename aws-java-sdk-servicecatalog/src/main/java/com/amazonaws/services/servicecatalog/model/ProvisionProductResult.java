 ...
 * 
 */
public class ProvisionProductResult implements Serializable, Cloneable {
     ...
     * 
     * @param recordDetail
     *        The detailed result of the <a>ProvisionProduct</a> request,
     *        containing the inputs made to that request, the current state of
     *        the request, a pointer to the ProvisionedProduct object of the
     *        request, and a list of any errors that the request encountered.
     */
     ...
     * </p>
     * 
     * @return The detailed result of the <a>ProvisionProduct</a> request,
     *         containing the inputs made to that request, the current state of
     *         the request, a pointer to the ProvisionedProduct object of the
     *         request, and a list of any errors that the request encountered.
     */
