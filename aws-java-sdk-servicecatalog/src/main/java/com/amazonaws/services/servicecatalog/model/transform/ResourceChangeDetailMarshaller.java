...
/**
 * ResourceChangeDetailMarshaller
 */
...
public class ResourceChangeDetailMarshaller {
    ...
    private static final MarshallingInfo<String> EVALUATION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("Evaluation").build();
    private static final MarshallingInfo<String> CAUSINGENTITY_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CausingEntity").build();
