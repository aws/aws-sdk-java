...
public class ProvisioningPreferences implements Serializable, Cloneable, StructuredPojo {
    ...
    public ProvisioningPreferences withStackSetAccounts(java.util.Collection<String> stackSetAccounts) {
    ...
    public ProvisioningPreferences withStackSetRegions(java.util.Collection<String> stackSetRegions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ProvisioningPreferences == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.servicecatalog.model.transform.ProvisioningPreferencesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
