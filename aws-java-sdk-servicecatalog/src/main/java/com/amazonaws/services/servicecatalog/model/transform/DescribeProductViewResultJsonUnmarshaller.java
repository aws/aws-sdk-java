...
public class DescribeProductViewResultJsonUnmarshaller implements
    ...
    public DescribeProductViewResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ProductViewSummary", targetDepth)) {
                    ...
                    describeProductViewResult
                            .setProductViewSummary(ProductViewSummaryJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
                if (context
                        .testExpression("ProvisioningArtifacts", targetDepth)) {
                    context.nextToken();
                    describeProductViewResult
                            .setProvisioningArtifacts(new ListUnmarshaller<ProvisioningArtifact>(
                                    ProvisioningArtifactJsonUnmarshaller
                                            .getInstance()).unmarshall(context));
                }
