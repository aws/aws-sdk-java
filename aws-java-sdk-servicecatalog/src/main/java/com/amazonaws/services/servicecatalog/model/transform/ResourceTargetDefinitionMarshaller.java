...
/**
 * ResourceTargetDefinitionMarshaller
 */
...
public class ResourceTargetDefinitionMarshaller {
    ...
    private static final MarshallingInfo<String> REQUIRESRECREATION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RequiresRecreation").build();
