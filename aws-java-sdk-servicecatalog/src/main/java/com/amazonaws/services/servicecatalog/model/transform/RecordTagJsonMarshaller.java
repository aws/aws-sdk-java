...
public class RecordTagJsonMarshaller {
     ...
     */
    public void marshall(RecordTag recordTag, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (recordTag.getKey() != null) {
                jsonGenerator.writeFieldName("Key").writeValue(recordTag.getKey());
            }
            if (recordTag.getValue() != null) {
                jsonGenerator.writeFieldName("Value").writeValue(recordTag.getValue());
            }
