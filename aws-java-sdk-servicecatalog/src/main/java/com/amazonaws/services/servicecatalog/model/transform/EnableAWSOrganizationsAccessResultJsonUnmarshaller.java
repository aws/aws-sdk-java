...
/**
 * EnableAWSOrganizationsAccessResult JSON Unmarshaller
 */
...
public class EnableAWSOrganizationsAccessResultJsonUnmarshaller implements Unmarshaller<EnableAWSOrganizationsAccessResult, JsonUnmarshallerContext> {
    ...
    public EnableAWSOrganizationsAccessResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        EnableAWSOrganizationsAccessResult enableAWSOrganizationsAccessResult = new EnableAWSOrganizationsAccessResult();
