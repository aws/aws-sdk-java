...
/**
 * ListTagOptionsFiltersMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListTagOptionsFiltersMarshaller {
    ...
    private static final ListTagOptionsFiltersMarshaller instance = new ListTagOptionsFiltersMarshaller();

    public static ListTagOptionsFiltersMarshaller getInstance() {
        return instance;
    }
