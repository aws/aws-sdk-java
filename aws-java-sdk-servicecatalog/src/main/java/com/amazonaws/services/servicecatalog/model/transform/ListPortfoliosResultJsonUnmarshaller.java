...
/**
 * ListPortfoliosResult JSON Unmarshaller
 */
...
public class ListPortfoliosResultJsonUnmarshaller implements Unmarshaller<ListPortfoliosResult, JsonUnmarshallerContext> {
    ...
    public ListPortfoliosResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextPageToken", targetDepth)) {
                    context.nextToken();
                    listPortfoliosResult.setNextPageToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
