 ...
 */
public class ProductViewAggregationValueJsonUnmarshaller implements
        Unmarshaller<ProductViewAggregationValue, JsonUnmarshallerContext> {

    public ProductViewAggregationValue unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Value", targetDepth)) {
                    context.nextToken();
                    productViewAggregationValue.setValue(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ApproximateCount", targetDepth)) {
                    context.nextToken();
                    productViewAggregationValue
                            .setApproximateCount(context.getUnmarshaller(
