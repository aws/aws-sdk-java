...
/**
 * ListTagOptionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListTagOptionsResultJsonUnmarshaller implements Unmarshaller<ListTagOptionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("PageToken", targetDepth)) {
                    context.nextToken();
                    listTagOptionsResult.setPageToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
