...
public class DescribeProductViewRequestMarshaller
        implements
        Marshaller<Request<DescribeProductViewRequest>, DescribeProductViewRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeProductViewRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeProductViewRequest> marshall(
        ...
        Request<DescribeProductViewRequest> request = new DefaultRequest<DescribeProductViewRequest>(
                describeProductViewRequest, "AWSServiceCatalog");
