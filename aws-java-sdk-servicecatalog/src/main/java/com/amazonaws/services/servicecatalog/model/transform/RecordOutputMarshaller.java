...
public class RecordOutputMarshaller {
    ...
    public void marshall(RecordOutput recordOutput, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(recordOutput.getOutputKey(), OUTPUTKEY_BINDING);
            protocolMarshaller.marshall(recordOutput.getOutputValue(), OUTPUTVALUE_BINDING);
            protocolMarshaller.marshall(recordOutput.getDescription(), DESCRIPTION_BINDING);
        } catch (Exception e) {
