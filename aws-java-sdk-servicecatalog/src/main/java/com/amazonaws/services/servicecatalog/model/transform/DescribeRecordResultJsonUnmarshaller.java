...
public class DescribeRecordResultJsonUnmarshaller implements
    ...
    public DescribeRecordResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("RecordOutputs", targetDepth)) {
                    context.nextToken();
                    describeRecordResult
                            .setRecordOutputs(new ListUnmarshaller<RecordOutput>(
                                    RecordOutputJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("NextPageToken", targetDepth)) {
                    context.nextToken();
                    describeRecordResult.setNextPageToken(context
