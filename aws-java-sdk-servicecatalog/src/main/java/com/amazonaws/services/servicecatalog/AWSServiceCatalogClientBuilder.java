...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.servicecatalog.AWSServiceCatalog}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AWSServiceCatalogClientBuilder extends
        AwsSyncClientBuilder<AWSServiceCatalogClientBuilder, AWSServiceCatalog> {
    ...
    /**
     * Construct a synchronous implementation of AWSServiceCatalog using the
