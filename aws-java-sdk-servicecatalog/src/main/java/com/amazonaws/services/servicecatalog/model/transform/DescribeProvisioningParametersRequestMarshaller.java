...
public class DescribeProvisioningParametersRequestMarshaller
    ...
    public DescribeProvisioningParametersRequestMarshaller(
        ...
        try {
            ...
            if (describeProvisioningParametersRequest.getProductId() != null) {
                jsonGenerator.writeFieldName("ProductId").writeValue(
                        describeProvisioningParametersRequest.getProductId());
            }
            if (describeProvisioningParametersRequest
                    .getProvisioningArtifactId() != null) {
            ...
            if (describeProvisioningParametersRequest.getPathId() != null) {
                jsonGenerator.writeFieldName("PathId").writeValue(
                        describeProvisioningParametersRequest.getPathId());
            }
