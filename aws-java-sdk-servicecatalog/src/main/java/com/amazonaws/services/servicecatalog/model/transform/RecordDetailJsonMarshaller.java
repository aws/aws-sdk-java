...
public class RecordDetailJsonMarshaller {
     ...
     */
    public void marshall(RecordDetail recordDetail,
        ...
        try {
            ...
            if (recordDetail.getRecordId() != null) {
                jsonGenerator.writeFieldName("RecordId").writeValue(
            ...
            if (recordDetail.getProvisionedProductName() != null) {
                jsonGenerator.writeFieldName("ProvisionedProductName")
                        .writeValue(recordDetail.getProvisionedProductName());
            }
            if (recordDetail.getStatus() != null) {
                jsonGenerator.writeFieldName("Status").writeValue(
                        recordDetail.getStatus());
            }
            if (recordDetail.getCreatedTime() != null) {
                jsonGenerator.writeFieldName("CreatedTime").writeValue(
                        recordDetail.getCreatedTime());
            }
            if (recordDetail.getUpdatedTime() != null) {
                jsonGenerator.writeFieldName("UpdatedTime").writeValue(
                        recordDetail.getUpdatedTime());
            }
            if (recordDetail.getProvisionedProductType() != null) {
                jsonGenerator.writeFieldName("ProvisionedProductType")
                        .writeValue(recordDetail.getProvisionedProductType());
            }
            if (recordDetail.getRecordType() != null) {
                jsonGenerator.writeFieldName("RecordType").writeValue(
                        recordDetail.getRecordType());
            }
            if (recordDetail.getProvisionedProductId() != null) {
                jsonGenerator.writeFieldName("ProvisionedProductId")
                        .writeValue(recordDetail.getProvisionedProductId());
            }
            ...
            if (recordDetail.getProvisioningArtifactId() != null) {
                jsonGenerator.writeFieldName("ProvisioningArtifactId")
                        .writeValue(recordDetail.getProvisioningArtifactId());
            }
            if (recordDetail.getPathId() != null) {
                jsonGenerator.writeFieldName("PathId").writeValue(
                        recordDetail.getPathId());
            }

            java.util.List<RecordError> recordErrorsList = recordDetail
                    .getRecordErrors();
            if (recordErrorsList != null) {
                ...
                for (RecordError recordErrorsListValue : recordErrorsList) {
                    if (recordErrorsListValue != null) {
                        ...
                        RecordErrorJsonMarshaller.getInstance().marshall(
                                recordErrorsListValue, jsonGenerator);
                    }
                }
                jsonGenerator.writeEndArray();
            }

            java.util.List<RecordTag> recordTagsList = recordDetail
                    .getRecordTags();
            if (recordTagsList != null) {
                ...
                for (RecordTag recordTagsListValue : recordTagsList) {
                    if (recordTagsListValue != null) {
                        ...
                        RecordTagJsonMarshaller.getInstance().marshall(
                                recordTagsListValue, jsonGenerator);
                    }
                }
                jsonGenerator.writeEndArray();
            }
