...
/**
 * AssociateTagOptionWithResourceRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssociateTagOptionWithResourceRequestMarshaller {
    ...
    private static final AssociateTagOptionWithResourceRequestMarshaller instance = new AssociateTagOptionWithResourceRequestMarshaller();

    public static AssociateTagOptionWithResourceRequestMarshaller getInstance() {
        return instance;
    }
