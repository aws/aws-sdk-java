...
/**
 * AcceptPortfolioShareRequest Marshaller
 */
public class AcceptPortfolioShareRequestMarshaller implements Marshaller<Request<AcceptPortfolioShareRequest>, AcceptPortfolioShareRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public AcceptPortfolioShareRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<AcceptPortfolioShareRequest> marshall(AcceptPortfolioShareRequest acceptPortfolioShareRequest) {
        ...
        Request<AcceptPortfolioShareRequest> request = new DefaultRequest<AcceptPortfolioShareRequest>(acceptPortfolioShareRequest, "AWSServiceCatalog");
