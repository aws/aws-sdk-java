...
/**
 * CreateProvisionedProductPlanRequestMarshaller
 */
...
public class CreateProvisionedProductPlanRequestMarshaller {
    ...
    private static final CreateProvisionedProductPlanRequestMarshaller instance = new CreateProvisionedProductPlanRequestMarshaller();

    public static CreateProvisionedProductPlanRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(CreateProvisionedProductPlanRequest createProvisionedProductPlanRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getAcceptLanguage(), ACCEPTLANGUAGE_BINDING);
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getPlanName(), PLANNAME_BINDING);
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getPlanType(), PLANTYPE_BINDING);
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getNotificationArns(), NOTIFICATIONARNS_BINDING);
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getPathId(), PATHID_BINDING);
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getProductId(), PRODUCTID_BINDING);
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getProvisionedProductName(), PROVISIONEDPRODUCTNAME_BINDING);
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getProvisioningArtifactId(), PROVISIONINGARTIFACTID_BINDING);
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getProvisioningParameters(), PROVISIONINGPARAMETERS_BINDING);
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getIdempotencyToken(), IDEMPOTENCYTOKEN_BINDING);
            protocolMarshaller.marshall(createProvisionedProductPlanRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
