...
/**
 * ProvisionProductResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProvisionProductResultJsonUnmarshaller implements Unmarshaller<ProvisionProductResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RecordDetail", targetDepth)) {
                    context.nextToken();
                    provisionProductResult.setRecordDetail(RecordDetailJsonUnmarshaller.getInstance().unmarshall(context));
                }
