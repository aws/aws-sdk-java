...
/**
 * AssociateBudgetWithResourceResult JSON Unmarshaller
 */
...
public class AssociateBudgetWithResourceResultJsonUnmarshaller implements Unmarshaller<AssociateBudgetWithResourceResult, JsonUnmarshallerContext> {
    ...
    public AssociateBudgetWithResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateBudgetWithResourceResult associateBudgetWithResourceResult = new AssociateBudgetWithResourceResult();

        return associateBudgetWithResourceResult;
    }
