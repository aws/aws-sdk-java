...
public class DeleteProductRequestProtocolMarshaller implements Marshaller<Request<DeleteProductRequest>, DeleteProductRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.AWS_JSON).requestUri("/")
            ...
            .operationIdentifier("AWS242ServiceCatalogService.DeleteProduct").serviceName("AWSServiceCatalog").build();

    private final com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory;

    public DeleteProductRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
