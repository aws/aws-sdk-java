...
/**
 * <p>
 * The parameter key/value pair used to update a ProvisionedProduct object. If
 * <code>UsePreviousValue</code> is set to true, <code>Value</code> is ignored
 * and the value for <code>Key</code> is kept as previously set (current value).
 * </p>
 */
public class UpdateProvisioningParameter implements Serializable, Cloneable {
     ...
     * on this value can be found in the
     ...
     * </p>
     * 
     * @return The value to use for updating the product provisioning. Any
     *         constraints on this value can be found in the
     *         <code>ProvisioningArtifactParameter</code> parameter for
     *         <code>Key</code>.
     */
     ...
     *        If true, uses the currently set value for <code>Key</code>,
     *        ignoring <code>UpdateProvisioningParameter.Value</code>.
     */
     ...
     * </p>
     * 
     * @return If true, uses the currently set value for <code>Key</code>,
     *         ignoring <code>UpdateProvisioningParameter.Value</code>.
     */
    ...
    public UpdateProvisioningParameter withUsePreviousValue(
