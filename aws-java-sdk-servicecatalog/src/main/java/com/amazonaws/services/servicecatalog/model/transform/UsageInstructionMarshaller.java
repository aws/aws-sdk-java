...
@SdkInternalApi
public class UsageInstructionMarshaller {
    ...
    private static final UsageInstructionMarshaller instance = new UsageInstructionMarshaller();

    public static UsageInstructionMarshaller getInstance() {
        return instance;
    }
