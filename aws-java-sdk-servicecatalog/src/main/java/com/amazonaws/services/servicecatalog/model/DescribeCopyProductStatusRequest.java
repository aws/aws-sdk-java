...
public class DescribeCopyProductStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DescribeCopyProductStatusRequest clone() {
        return (DescribeCopyProductStatusRequest) super.clone();
    }
