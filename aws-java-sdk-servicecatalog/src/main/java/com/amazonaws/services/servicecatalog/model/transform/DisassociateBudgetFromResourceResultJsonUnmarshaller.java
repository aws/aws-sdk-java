...
/**
 * DisassociateBudgetFromResourceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DisassociateBudgetFromResourceResultJsonUnmarshaller implements Unmarshaller<DisassociateBudgetFromResourceResult, JsonUnmarshallerContext> {

    public DisassociateBudgetFromResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
