 ...
 */
public class DescribeProvisioningParametersResultJsonUnmarshaller
        implements
        Unmarshaller<DescribeProvisioningParametersResult, JsonUnmarshallerContext> {

    public DescribeProvisioningParametersResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ProvisioningArtifactParameters",
                        targetDepth)) {
                    context.nextToken();
                    describeProvisioningParametersResult
                            .setProvisioningArtifactParameters(new ListUnmarshaller<ProvisioningArtifactParameter>(
                                    ProvisioningArtifactParameterJsonUnmarshaller
                ...
                if (context.testExpression("UsageInstructions", targetDepth)) {
                    context.nextToken();
                    describeProvisioningParametersResult
                            .setUsageInstructions(new ListUnmarshaller<UsageInstruction>(
                                    UsageInstructionJsonUnmarshaller
                                            .getInstance()).unmarshall(context));
                }
