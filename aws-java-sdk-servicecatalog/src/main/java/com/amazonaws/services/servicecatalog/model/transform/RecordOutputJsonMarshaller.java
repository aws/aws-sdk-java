...
public class RecordOutputJsonMarshaller {
     ...
     */
    public void marshall(RecordOutput recordOutput, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (recordOutput.getOutputKey() != null) {
                jsonGenerator.writeFieldName("OutputKey").writeValue(recordOutput.getOutputKey());
            }
            if (recordOutput.getOutputValue() != null) {
                jsonGenerator.writeFieldName("OutputValue").writeValue(recordOutput.getOutputValue());
            }
            if (recordOutput.getDescription() != null) {
                jsonGenerator.writeFieldName("Description").writeValue(recordOutput.getDescription());
            }
