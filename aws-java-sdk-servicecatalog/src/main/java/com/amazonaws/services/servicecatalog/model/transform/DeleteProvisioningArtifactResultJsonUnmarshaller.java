...
/**
 * DeleteProvisioningArtifactResult JSON Unmarshaller
 */
...
public class DeleteProvisioningArtifactResultJsonUnmarshaller implements Unmarshaller<DeleteProvisioningArtifactResult, JsonUnmarshallerContext> {
    ...
    public DeleteProvisioningArtifactResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteProvisioningArtifactResult deleteProvisioningArtifactResult = new DeleteProvisioningArtifactResult();
