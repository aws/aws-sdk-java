 ...
 */
public class DescribeProductResultJsonUnmarshaller implements
        Unmarshaller<DescribeProductResult, JsonUnmarshallerContext> {

    public DescribeProductResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
