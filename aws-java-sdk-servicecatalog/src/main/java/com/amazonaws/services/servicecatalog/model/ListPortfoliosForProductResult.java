...
public class ListPortfoliosForProductResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListPortfoliosForProductResult withPortfolioDetails(java.util.Collection<PortfolioDetail> portfolioDetails) {
    ...
    @Override
    public ListPortfoliosForProductResult clone() {
        try {
