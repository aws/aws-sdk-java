 ...
 */
public class ListRecordHistoryResultJsonUnmarshaller implements
        Unmarshaller<ListRecordHistoryResult, JsonUnmarshallerContext> {

    public ListRecordHistoryResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RecordDetails", targetDepth)) {
                    ...
                    listRecordHistoryResult
                            .setRecordDetails(new ListUnmarshaller<RecordDetail>(
                                    RecordDetailJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
                if (context.testExpression("NextPageToken", targetDepth)) {
                    context.nextToken();
                    listRecordHistoryResult.setNextPageToken(context
