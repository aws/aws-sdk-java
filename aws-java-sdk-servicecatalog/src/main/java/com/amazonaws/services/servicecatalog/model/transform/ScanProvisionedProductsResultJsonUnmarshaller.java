...
/**
 * ScanProvisionedProductsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScanProvisionedProductsResultJsonUnmarshaller implements Unmarshaller<ScanProvisionedProductsResult, JsonUnmarshallerContext> {

    public ScanProvisionedProductsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextPageToken", targetDepth)) {
                    context.nextToken();
                    scanProvisionedProductsResult.setNextPageToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
