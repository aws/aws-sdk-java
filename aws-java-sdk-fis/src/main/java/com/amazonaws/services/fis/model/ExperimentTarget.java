 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/fis-2020-12-01/ExperimentTarget" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ExperimentTarget implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<ExperimentTargetFilter> filters;
    /**
     * <p>
    ...
    public ExperimentTarget withResourceArns(java.util.Collection<String> resourceArns) {
    ...
    public java.util.List<ExperimentTargetFilter> getFilters() {
        return filters;
    }
    ...
    public void setFilters(java.util.Collection<ExperimentTargetFilter> filters) {
        if (filters == null) {
            this.filters = null;
            return;
        }

        this.filters = new java.util.ArrayList<ExperimentTargetFilter>(filters);
    }
    ...
    public ExperimentTarget withFilters(ExperimentTargetFilter... filters) {
        if (this.filters == null) {
            setFilters(new java.util.ArrayList<ExperimentTargetFilter>(filters.length));
        }
    ...
    public ExperimentTarget withFilters(java.util.Collection<ExperimentTargetFilter> filters) {
        setFilters(filters);
        return this;
    }
