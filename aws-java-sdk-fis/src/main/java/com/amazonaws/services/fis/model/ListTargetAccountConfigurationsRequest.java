...
public class ListTargetAccountConfigurationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListTargetAccountConfigurationsRequest withExperimentTemplateId(String experimentTemplateId) {
    ...
    public ListTargetAccountConfigurationsRequest withMaxResults(Integer maxResults) {
    ...
    public ListTargetAccountConfigurationsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTargetAccountConfigurationsRequest == false)
            return false;
        ListTargetAccountConfigurationsRequest other = (ListTargetAccountConfigurationsRequest) obj;
    ...
    @Override
    public ListTargetAccountConfigurationsRequest clone() {
        return (ListTargetAccountConfigurationsRequest) super.clone();
    }
