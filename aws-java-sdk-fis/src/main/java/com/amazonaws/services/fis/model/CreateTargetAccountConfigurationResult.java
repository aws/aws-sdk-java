...
public class CreateTargetAccountConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateTargetAccountConfigurationResult withTargetAccountConfiguration(TargetAccountConfiguration targetAccountConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTargetAccountConfigurationResult == false)
            return false;
        CreateTargetAccountConfigurationResult other = (CreateTargetAccountConfigurationResult) obj;
    ...
    @Override
    public CreateTargetAccountConfigurationResult clone() {
        try {
            return (CreateTargetAccountConfigurationResult) super.clone();
