...
public class GetExperimentTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetExperimentTemplateResult withExperimentTemplate(ExperimentTemplate experimentTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetExperimentTemplateResult == false)
            return false;
        GetExperimentTemplateResult other = (GetExperimentTemplateResult) obj;
    ...
    @Override
    public GetExperimentTemplateResult clone() {
        try {
            return (GetExperimentTemplateResult) super.clone();
