...
public class GetTargetAccountConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public GetTargetAccountConfigurationResult withTargetAccountConfiguration(TargetAccountConfiguration targetAccountConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTargetAccountConfigurationResult == false)
            return false;
        GetTargetAccountConfigurationResult other = (GetTargetAccountConfigurationResult) obj;
    ...
    @Override
    public GetTargetAccountConfigurationResult clone() {
        try {
            return (GetTargetAccountConfigurationResult) super.clone();
