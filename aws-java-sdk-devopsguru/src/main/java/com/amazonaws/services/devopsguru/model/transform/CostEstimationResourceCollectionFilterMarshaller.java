...
/**
 * CostEstimationResourceCollectionFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CostEstimationResourceCollectionFilterMarshaller {
    ...
    public static CostEstimationResourceCollectionFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CostEstimationResourceCollectionFilter costEstimationResourceCollectionFilter, ProtocolMarshaller protocolMarshaller) {

        if (costEstimationResourceCollectionFilter == null) {
