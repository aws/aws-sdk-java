...
public class DeleteInsightRequestProtocolMarshaller implements Marshaller<Request<DeleteInsightRequest>, DeleteInsightRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.REST_JSON).requestUri("/insights/{Id}")
            .httpMethodName(HttpMethodName.DELETE).hasExplicitPayloadMember(false).hasPayloadMembers(false).serviceName("AmazonDevOpsGuru").build();
