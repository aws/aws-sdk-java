...
/**
 * UpdateEventSourcesConfigResult JSON Unmarshaller
 */
...
public class UpdateEventSourcesConfigResultJsonUnmarshaller implements Unmarshaller<UpdateEventSourcesConfigResult, JsonUnmarshallerContext> {
    ...
    public UpdateEventSourcesConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateEventSourcesConfigResult updateEventSourcesConfigResult = new UpdateEventSourcesConfigResult();
