 ...
 * This collection of resources is used to create a monthly cost estimate for DevOps Guru to analyze Amazon Web Services
 * resources. The maximum number of tags you can specify for a cost estimate is one. The estimate created is for the
 * cost to analyze the Amazon Web Services resources defined by the tag. For more information, see <a
 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/devops-guru-2020-12-01/TagCostEstimationResourceCollectionFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TagCostEstimationResourceCollectionFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public TagCostEstimationResourceCollectionFilter withTagValues(java.util.Collection<String> tagValues) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TagCostEstimationResourceCollectionFilter == false)
            return false;
        TagCostEstimationResourceCollectionFilter other = (TagCostEstimationResourceCollectionFilter) obj;
    ...
    @Override
    public TagCostEstimationResourceCollectionFilter clone() {
        try {
            return (TagCostEstimationResourceCollectionFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.devopsguru.model.transform.TagCostEstimationResourceCollectionFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
