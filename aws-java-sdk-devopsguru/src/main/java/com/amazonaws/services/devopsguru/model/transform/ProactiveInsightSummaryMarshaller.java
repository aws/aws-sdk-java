...
/**
 * ProactiveInsightSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ProactiveInsightSummaryMarshaller {
    ...
    public static ProactiveInsightSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ProactiveInsightSummary proactiveInsightSummary, ProtocolMarshaller protocolMarshaller) {

        if (proactiveInsightSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(proactiveInsightSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(proactiveInsightSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(proactiveInsightSummary.getSeverity(), SEVERITY_BINDING);
            protocolMarshaller.marshall(proactiveInsightSummary.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(proactiveInsightSummary.getInsightTimeRange(), INSIGHTTIMERANGE_BINDING);
