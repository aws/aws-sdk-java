...
public class DescribeEventSourcesConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEventSourcesConfigResult == false)
            return false;
        DescribeEventSourcesConfigResult other = (DescribeEventSourcesConfigResult) obj;
    ...
    @Override
    public DescribeEventSourcesConfigResult clone() {
        try {
            return (DescribeEventSourcesConfigResult) super.clone();
