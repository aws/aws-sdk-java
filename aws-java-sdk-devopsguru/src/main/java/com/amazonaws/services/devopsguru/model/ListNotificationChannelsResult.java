...
public class ListNotificationChannelsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setChannels(java.util.Collection<NotificationChannel> channels) {
        ...
        this.channels = new java.util.ArrayList<NotificationChannel>(channels);
    }
    ...
    public ListNotificationChannelsResult withChannels(NotificationChannel... channels) {
        if (this.channels == null) {
            setChannels(new java.util.ArrayList<NotificationChannel>(channels.length));
        }
    ...
    public ListNotificationChannelsResult withChannels(java.util.Collection<NotificationChannel> channels) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListNotificationChannelsResult == false)
            return false;
