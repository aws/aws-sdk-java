...
public class ListAnomalousLogGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAnomalousLogGroupsRequest withInsightId(String insightId) {
    ...
    public ListAnomalousLogGroupsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAnomalousLogGroupsRequest == false)
            return false;
        ListAnomalousLogGroupsRequest other = (ListAnomalousLogGroupsRequest) obj;
    ...
    @Override
    public ListAnomalousLogGroupsRequest clone() {
        return (ListAnomalousLogGroupsRequest) super.clone();
    }
