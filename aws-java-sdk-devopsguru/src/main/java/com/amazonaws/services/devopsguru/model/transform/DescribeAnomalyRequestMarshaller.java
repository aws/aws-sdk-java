...
public class DescribeAnomalyRequestMarshaller {
    ...
    public static DescribeAnomalyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeAnomalyRequest describeAnomalyRequest, ProtocolMarshaller protocolMarshaller) {
