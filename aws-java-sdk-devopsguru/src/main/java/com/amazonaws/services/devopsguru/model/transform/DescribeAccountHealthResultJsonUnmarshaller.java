...
/**
 * DescribeAccountHealthResult JSON Unmarshaller
 */
...
public class DescribeAccountHealthResultJsonUnmarshaller implements Unmarshaller<DescribeAccountHealthResult, JsonUnmarshallerContext> {
    ...
    public DescribeAccountHealthResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ResourceHours", targetDepth)) {
                    context.nextToken();
                    describeAccountHealthResult.setResourceHours(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("AnalyzedResourceCount", targetDepth)) {
                    context.nextToken();
                    describeAccountHealthResult.setAnalyzedResourceCount(context.getUnmarshaller(Long.class).unmarshall(context));
                }
