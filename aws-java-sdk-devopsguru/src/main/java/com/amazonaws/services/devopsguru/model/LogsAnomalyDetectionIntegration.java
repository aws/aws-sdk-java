 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/devops-guru-2020-12-01/LogsAnomalyDetectionIntegration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LogsAnomalyDetectionIntegration implements Serializable, Cloneable, StructuredPojo {
    ...
    public LogsAnomalyDetectionIntegration withOptInStatus(String optInStatus) {
    ...
    public LogsAnomalyDetectionIntegration withOptInStatus(OptInStatus optInStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LogsAnomalyDetectionIntegration == false)
            return false;
    ...
    @Override
    public LogsAnomalyDetectionIntegration clone() {
        try {
            return (LogsAnomalyDetectionIntegration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.devopsguru.model.transform.LogsAnomalyDetectionIntegrationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
