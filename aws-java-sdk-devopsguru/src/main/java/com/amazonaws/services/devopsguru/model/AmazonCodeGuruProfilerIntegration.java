...
public class AmazonCodeGuruProfilerIntegration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AmazonCodeGuruProfilerIntegration == false)
            return false;
        AmazonCodeGuruProfilerIntegration other = (AmazonCodeGuruProfilerIntegration) obj;
    ...
    public AmazonCodeGuruProfilerIntegration clone() {
        try {
            return (AmazonCodeGuruProfilerIntegration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.devopsguru.model.transform.AmazonCodeGuruProfilerIntegrationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
