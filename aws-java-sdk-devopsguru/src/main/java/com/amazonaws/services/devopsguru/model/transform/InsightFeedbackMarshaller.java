...
public class InsightFeedbackMarshaller {
    ...
    public static InsightFeedbackMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(InsightFeedback insightFeedback, ProtocolMarshaller protocolMarshaller) {
