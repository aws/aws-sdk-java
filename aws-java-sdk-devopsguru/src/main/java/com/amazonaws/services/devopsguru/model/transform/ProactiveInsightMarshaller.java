...
/**
 * ProactiveInsightMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ProactiveInsightMarshaller {
    ...
    public static ProactiveInsightMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ProactiveInsight proactiveInsight, ProtocolMarshaller protocolMarshaller) {

        if (proactiveInsight == null) {
        ...
        try {
            ...
            protocolMarshaller.marshall(proactiveInsight.getDescription(), DESCRIPTION_BINDING);
        } catch (Exception e) {
