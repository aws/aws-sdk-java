...
/**
 * StartTimeRangeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StartTimeRangeMarshaller {
    ...
    private static final StartTimeRangeMarshaller instance = new StartTimeRangeMarshaller();

    public static StartTimeRangeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartTimeRange startTimeRange, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startTimeRange.getFromTime(), FROMTIME_BINDING);
            protocolMarshaller.marshall(startTimeRange.getToTime(), TOTIME_BINDING);
        } catch (Exception e) {
