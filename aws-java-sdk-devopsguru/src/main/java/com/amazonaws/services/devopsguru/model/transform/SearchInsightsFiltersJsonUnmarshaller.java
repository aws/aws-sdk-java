...
/**
 * SearchInsightsFilters JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchInsightsFiltersJsonUnmarshaller implements Unmarshaller<SearchInsightsFilters, JsonUnmarshallerContext> {

    public SearchInsightsFilters unmarshall(JsonUnmarshallerContext context) throws Exception {
        SearchInsightsFilters searchInsightsFilters = new SearchInsightsFilters();
    ...
    private static SearchInsightsFiltersJsonUnmarshaller instance;

    public static SearchInsightsFiltersJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SearchInsightsFiltersJsonUnmarshaller();
        return instance;
    }
}
