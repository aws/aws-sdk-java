...
/**
 * SearchInsightsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchInsightsResultJsonUnmarshaller implements Unmarshaller<SearchInsightsResult, JsonUnmarshallerContext> {

    public SearchInsightsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SearchInsightsResult searchInsightsResult = new SearchInsightsResult();
    ...
    private static SearchInsightsResultJsonUnmarshaller instance;

    public static SearchInsightsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SearchInsightsResultJsonUnmarshaller();
        return instance;
    }
}
