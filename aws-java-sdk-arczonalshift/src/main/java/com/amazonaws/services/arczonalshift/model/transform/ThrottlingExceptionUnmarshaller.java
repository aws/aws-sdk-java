...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.arczonalshift.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.arczonalshift.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.arczonalshift.model.ThrottlingException throttlingException = new com.amazonaws.services.arczonalshift.model.ThrottlingException(
                null);
