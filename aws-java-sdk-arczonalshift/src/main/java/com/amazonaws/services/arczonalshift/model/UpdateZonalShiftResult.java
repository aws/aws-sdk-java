...
public class UpdateZonalShiftResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateZonalShiftResult withAwayFrom(String awayFrom) {
    ...
    public UpdateZonalShiftResult withComment(String comment) {
        setComment(comment);
        return this;
    }
    ...
    public UpdateZonalShiftResult withExpiryTime(java.util.Date expiryTime) {
    ...
    public UpdateZonalShiftResult withResourceIdentifier(String resourceIdentifier) {
    ...
    public UpdateZonalShiftResult withStartTime(java.util.Date startTime) {
    ...
    public UpdateZonalShiftResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public UpdateZonalShiftResult withStatus(ZonalShiftStatus status) {
    ...
    public UpdateZonalShiftResult withZonalShiftId(String zonalShiftId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateZonalShiftResult == false)
            return false;
        UpdateZonalShiftResult other = (UpdateZonalShiftResult) obj;
    ...
    @Override
    public UpdateZonalShiftResult clone() {
        try {
