...
public class UpdateZonalAutoshiftConfigurationRequestMarshaller {
    ...
    private static final UpdateZonalAutoshiftConfigurationRequestMarshaller instance = new UpdateZonalAutoshiftConfigurationRequestMarshaller();

    public static UpdateZonalAutoshiftConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateZonalAutoshiftConfigurationRequest updateZonalAutoshiftConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateZonalAutoshiftConfigurationRequest.getResourceIdentifier(), RESOURCEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(updateZonalAutoshiftConfigurationRequest.getZonalAutoshiftStatus(), ZONALAUTOSHIFTSTATUS_BINDING);
        } catch (Exception e) {
