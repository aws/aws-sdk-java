...
/**
 * ListZonalShiftsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListZonalShiftsRequestMarshaller {
    ...
    private static final ListZonalShiftsRequestMarshaller instance = new ListZonalShiftsRequestMarshaller();

    public static ListZonalShiftsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListZonalShiftsRequest listZonalShiftsRequest, ProtocolMarshaller protocolMarshaller) {
