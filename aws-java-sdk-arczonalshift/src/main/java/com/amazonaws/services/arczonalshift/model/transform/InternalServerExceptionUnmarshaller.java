...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.arczonalshift.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.arczonalshift.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.arczonalshift.model.InternalServerException internalServerException = new com.amazonaws.services.arczonalshift.model.InternalServerException(
                null);
