...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.arczonalshift.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.arczonalshift.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.arczonalshift.model.ValidationException validationException = new com.amazonaws.services.arczonalshift.model.ValidationException(
                null);
