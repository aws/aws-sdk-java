...
public class UpdateZonalAutoshiftConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {

    /**
     * <p>
     * The identifier for the resource that you updated the zonal autoshift configuration for. The identifier is the
     ...
     * </p>
     * 
     * @return The identifier for the resource that you updated the zonal autoshift configuration for. The identifier is
     *         the Amazon Resource Name (ARN) for the resource.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateZonalAutoshiftConfigurationResult == false)
            return false;
        UpdateZonalAutoshiftConfigurationResult other = (UpdateZonalAutoshiftConfigurationResult) obj;
