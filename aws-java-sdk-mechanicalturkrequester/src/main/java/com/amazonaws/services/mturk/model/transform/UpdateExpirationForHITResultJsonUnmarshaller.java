...
/**
 * UpdateExpirationForHITResult JSON Unmarshaller
 */
...
public class UpdateExpirationForHITResultJsonUnmarshaller implements Unmarshaller<UpdateExpirationForHITResult, JsonUnmarshallerContext> {
    ...
    public UpdateExpirationForHITResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateExpirationForHITResult updateExpirationForHITResult = new UpdateExpirationForHITResult();
