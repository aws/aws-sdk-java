...
public class UpdateHITReviewStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateHITReviewStatusRequest == false)
            return false;
        ...
        if (other.getHITId() != null && other.getHITId().equals(this.getHITId()) == false)
            return false;
        if (other.getRevert() == null ^ this.getRevert() == null)
            return false;
        if (other.getRevert() != null && other.getRevert().equals(this.getRevert()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getRevert() == null) ? 0 : getRevert().hashCode());
        return hashCode;
    }

    @Override
    public UpdateHITReviewStatusRequest clone() {
        return (UpdateHITReviewStatusRequest) super.clone();
    }
