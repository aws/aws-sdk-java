...
public class ListReviewableHITsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListReviewableHITsResult withHITs(HIT... hITs) {
        if (this.hITs == null) {
    ...
    public ListReviewableHITsResult withHITs(java.util.Collection<HIT> hITs) {
        setHITs(hITs);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListReviewableHITsResult == false)
            return false;
        ListReviewableHITsResult other = (ListReviewableHITsResult) obj;
