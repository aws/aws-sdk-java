...
/**
 * CreateAdditionalAssignmentsForHITRequestMarshaller
 */
...
public class CreateAdditionalAssignmentsForHITRequestMarshaller {
    ...
    private static final MarshallingInfo<Integer> NUMBEROFADDITIONALASSIGNMENTS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("NumberOfAdditionalAssignments").build();
