...
/**
 * GetAssignmentRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetAssignmentRequestMarshaller {
    ...
    private static final GetAssignmentRequestMarshaller instance = new GetAssignmentRequestMarshaller();

    public static GetAssignmentRequestMarshaller getInstance() {
        return instance;
    }
