...
@SdkInternalApi
public class ListWorkerBlocksRequestMarshaller {
    ...
    private static final ListWorkerBlocksRequestMarshaller instance = new ListWorkerBlocksRequestMarshaller();

    public static ListWorkerBlocksRequestMarshaller getInstance() {
        return instance;
    }
