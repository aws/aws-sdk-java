...
public class GetHITRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the HIT to be retrieved.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetHITRequest == false)
            return false;
        GetHITRequest other = (GetHITRequest) obj;
    ...
    @Override
    public GetHITRequest clone() {
        return (GetHITRequest) super.clone();
    }
