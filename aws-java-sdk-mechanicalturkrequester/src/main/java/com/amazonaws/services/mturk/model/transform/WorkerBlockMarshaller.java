...
public class WorkerBlockMarshaller {
    ...
    public void marshall(WorkerBlock workerBlock, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(workerBlock.getWorkerId(), WORKERID_BINDING);
            protocolMarshaller.marshall(workerBlock.getReason(), REASON_BINDING);
        } catch (Exception e) {
