...
public class CreateQualificationTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateQualificationTypeResult withQualificationType(QualificationType qualificationType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateQualificationTypeResult == false)
            return false;
        CreateQualificationTypeResult other = (CreateQualificationTypeResult) obj;
    ...
    @Override
    public CreateQualificationTypeResult clone() {
        try {
            return (CreateQualificationTypeResult) super.clone();
