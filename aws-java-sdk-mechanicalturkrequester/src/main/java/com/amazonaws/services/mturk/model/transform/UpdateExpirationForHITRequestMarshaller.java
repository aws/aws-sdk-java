...
/**
 * UpdateExpirationForHITRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateExpirationForHITRequestMarshaller {
    ...
    private static final MarshallingInfo<java.util.Date> EXPIREAT_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ExpireAt").timestampFormat("unixTimestamp").build();

    private static final UpdateExpirationForHITRequestMarshaller instance = new UpdateExpirationForHITRequestMarshaller();

    public static UpdateExpirationForHITRequestMarshaller getInstance() {
        return instance;
    }
