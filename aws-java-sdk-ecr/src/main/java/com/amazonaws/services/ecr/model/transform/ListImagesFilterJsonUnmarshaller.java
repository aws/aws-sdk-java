...
/**
 * ListImagesFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListImagesFilterJsonUnmarshaller implements Unmarshaller<ListImagesFilter, JsonUnmarshallerContext> {
    ...
    public ListImagesFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("tagStatus", targetDepth)) {
                    context.nextToken();
                    listImagesFilter.setTagStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
