        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("registryId", targetDepth)) {
                    context.nextToken();
                    deleteLifecyclePolicyResult.setRegistryId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("repositoryName", targetDepth)) {
                    context.nextToken();
                    deleteLifecyclePolicyResult.setRepositoryName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("lifecyclePolicyText", targetDepth)) {
                    context.nextToken();
                    deleteLifecyclePolicyResult.setLifecyclePolicyText(context.getUnmarshaller(String.class).unmarshall(context));
                }
