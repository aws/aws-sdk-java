...
public class PutRegistryPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutRegistryPolicyResult == false)
            return false;
        PutRegistryPolicyResult other = (PutRegistryPolicyResult) obj;
    ...
    @Override
    public PutRegistryPolicyResult clone() {
        try {
            return (PutRegistryPolicyResult) super.clone();
