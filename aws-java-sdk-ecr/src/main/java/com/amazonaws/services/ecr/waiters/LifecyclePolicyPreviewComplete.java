...
class LifecyclePolicyPreviewComplete {
    ...
    static class IsCOMPLETEMatcher extends WaiterAcceptor<GetLifecyclePolicyPreviewResult> {
         ...
         */
        @Override
        public boolean matches(GetLifecyclePolicyPreviewResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetLifecyclePolicyPreviewResult> {
        private static final JsonNode expectedResult;
