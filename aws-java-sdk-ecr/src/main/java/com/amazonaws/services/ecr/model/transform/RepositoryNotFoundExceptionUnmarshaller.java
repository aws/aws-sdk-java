...
public class RepositoryNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RepositoryNotFoundExceptionUnmarshaller instance;

    public static RepositoryNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RepositoryNotFoundExceptionUnmarshaller();
        return instance;
    }
}
