...
/**
 * PutLifecyclePolicyResult JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("registryId", targetDepth)) {
                    context.nextToken();
                    putLifecyclePolicyResult.setRegistryId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("repositoryName", targetDepth)) {
                    context.nextToken();
                    putLifecyclePolicyResult.setRepositoryName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("lifecyclePolicyText", targetDepth)) {
                    context.nextToken();
                    putLifecyclePolicyResult.setLifecyclePolicyText(context.getUnmarshaller(String.class).unmarshall(context));
                }
