...
public class AmazonECRAsyncClient extends AmazonECRClient implements
     ...
     * ECR. A credentials provider chain will be used that searches for
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * ECR using the specified AWS account credentials provider. Default client
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * ECR using the specified parameters.
     *
    ...
    public java.util.concurrent.Future<BatchCheckLayerAvailabilityResult> batchCheckLayerAvailabilityAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<BatchCheckLayerAvailabilityResult>() {
                    @Override
                    public BatchCheckLayerAvailabilityResult call()
                            throws Exception {
    ...
    public java.util.concurrent.Future<GetDownloadUrlForLayerResult> getDownloadUrlForLayerAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetDownloadUrlForLayerResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ListImagesResult> listImagesAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListImagesResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<PutImageResult> putImageAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<PutImageResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<SetRepositoryPolicyResult> setRepositoryPolicyAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<SetRepositoryPolicyResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<UploadLayerPartResult> uploadLayerPartAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UploadLayerPartResult>() {
                    @Override
