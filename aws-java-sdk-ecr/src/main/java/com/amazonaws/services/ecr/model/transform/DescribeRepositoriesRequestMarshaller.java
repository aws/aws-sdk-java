...
public class DescribeRepositoriesRequestMarshaller implements Marshaller<Request<DescribeRepositoriesRequest>, DescribeRepositoriesRequest> {
    ...
    public DescribeRepositoriesRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<DescribeRepositoriesRequest> marshall(DescribeRepositoriesRequest describeRepositoriesRequest) {
        ...
        Request<DescribeRepositoriesRequest> request = new DefaultRequest<DescribeRepositoriesRequest>(describeRepositoriesRequest, "AmazonECR");
        ...
        try {
            ...
            java.util.List<String> repositoryNamesList = describeRepositoriesRequest.getRepositoryNames();
            ...
            if (describeRepositoriesRequest.getMaxResults() != null) {
                jsonGenerator.writeFieldName("maxResults").writeValue(describeRepositoriesRequest.getMaxResults());
            }
