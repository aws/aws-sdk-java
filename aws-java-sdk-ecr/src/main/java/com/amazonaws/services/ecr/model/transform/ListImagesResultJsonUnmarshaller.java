 ...
 */
public class ListImagesResultJsonUnmarshaller implements
        Unmarshaller<ListImagesResult, JsonUnmarshallerContext> {

    public ListImagesResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("imageIds", targetDepth)) {
                    context.nextToken();
                    listImagesResult
                            .setImageIds(new ListUnmarshaller<ImageIdentifier>(
                                    ImageIdentifierJsonUnmarshaller
                                            .getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listImagesResult.setNextToken(context.getUnmarshaller(
