...
public class LayersNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LayersNotFoundExceptionUnmarshaller instance;

    public static LayersNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LayersNotFoundExceptionUnmarshaller();
        return instance;
    }
}
