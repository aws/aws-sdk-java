...
public class ImageNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ImageNotFoundExceptionUnmarshaller instance;

    public static ImageNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ImageNotFoundExceptionUnmarshaller();
        return instance;
    }
}
