...
public class ImageScanFindingsMarshaller {
    ...
    private static final MarshallingInfo<List> ENHANCEDFINDINGS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("enhancedFindings").build();
