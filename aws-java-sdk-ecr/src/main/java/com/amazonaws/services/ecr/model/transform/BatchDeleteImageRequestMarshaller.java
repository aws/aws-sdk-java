...
/**
 * BatchDeleteImageRequest Marshaller
 */
public class BatchDeleteImageRequestMarshaller implements
        Marshaller<Request<BatchDeleteImageRequest>, BatchDeleteImageRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public BatchDeleteImageRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<BatchDeleteImageRequest> marshall(
        ...
        Request<BatchDeleteImageRequest> request = new DefaultRequest<BatchDeleteImageRequest>(
                batchDeleteImageRequest, "AmazonECR");
