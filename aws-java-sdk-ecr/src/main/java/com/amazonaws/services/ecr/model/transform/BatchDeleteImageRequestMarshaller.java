...
public class BatchDeleteImageRequestMarshaller implements Marshaller<Request<BatchDeleteImageRequest>, BatchDeleteImageRequest> {
    ...
    public Request<BatchDeleteImageRequest> marshall(BatchDeleteImageRequest batchDeleteImageRequest) {
        ...
        Request<BatchDeleteImageRequest> request = new DefaultRequest<BatchDeleteImageRequest>(batchDeleteImageRequest, "AmazonECR");
        ...
        try {
            ...
            java.util.List<ImageIdentifier> imageIdsList = batchDeleteImageRequest.getImageIds();
