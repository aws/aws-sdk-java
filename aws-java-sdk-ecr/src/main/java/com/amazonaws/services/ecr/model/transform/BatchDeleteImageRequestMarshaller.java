...
/**
 * BatchDeleteImageRequestMarshaller
 */
...
public class BatchDeleteImageRequestMarshaller {
    ...
    private static final BatchDeleteImageRequestMarshaller instance = new BatchDeleteImageRequestMarshaller();

    public static BatchDeleteImageRequestMarshaller getInstance() {
        return instance;
    }
