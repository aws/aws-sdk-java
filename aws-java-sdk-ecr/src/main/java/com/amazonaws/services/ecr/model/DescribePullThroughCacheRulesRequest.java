...
public class DescribePullThroughCacheRulesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<String> ecrRepositoryPrefixes;
    /**
     * <p>
    ...
    public java.util.List<String> getEcrRepositoryPrefixes() {
    ...
    public void setEcrRepositoryPrefixes(java.util.Collection<String> ecrRepositoryPrefixes) {
        if (ecrRepositoryPrefixes == null) {
            this.ecrRepositoryPrefixes = null;
            return;
        }

        this.ecrRepositoryPrefixes = new java.util.ArrayList<String>(ecrRepositoryPrefixes);
    }
    ...
    public DescribePullThroughCacheRulesRequest withEcrRepositoryPrefixes(String... ecrRepositoryPrefixes) {
        if (this.ecrRepositoryPrefixes == null) {
            setEcrRepositoryPrefixes(new java.util.ArrayList<String>(ecrRepositoryPrefixes.length));
        }
    ...
    public DescribePullThroughCacheRulesRequest withEcrRepositoryPrefixes(java.util.Collection<String> ecrRepositoryPrefixes) {
     ...
     *        <code>DescribePullThroughCacheRulesRequest</code> only returns <code>maxResults</code> results in a single
     *        page along with a <code>nextToken</code> response element. The remaining results of the initial request
     *        can be seen by sending another <code>DescribePullThroughCacheRulesRequest</code> request with the returned
