 ...
 */
public class SetRepositoryPolicyResultJsonUnmarshaller implements
        Unmarshaller<SetRepositoryPolicyResult, JsonUnmarshallerContext> {

    public SetRepositoryPolicyResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
