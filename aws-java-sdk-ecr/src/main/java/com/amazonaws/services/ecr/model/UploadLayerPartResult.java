 ...
 * 
 */
public class UploadLayerPartResult implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getLastByteReceived() != null)
            sb.append("LastByteReceived: " + getLastByteReceived());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getUploadId() != null
            ...
            return false;
        if (other.getLastByteReceived() == null
                ^ this.getLastByteReceived() == null)
            return false;
        if (other.getLastByteReceived() != null
                && other.getLastByteReceived().equals(
                        this.getLastByteReceived()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getLastByteReceived() == null) ? 0 : getLastByteReceived()
                        .hashCode());
        return hashCode;
    }
