...
/**
 * Fluent builder for {@link com.amazonaws.services.ecr.AmazonECRAsync}. Use of
 * the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonECRAsyncClientBuilder extends
        AwsAsyncClientBuilder<AmazonECRAsyncClientBuilder, AmazonECRAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonECRAsync using the
