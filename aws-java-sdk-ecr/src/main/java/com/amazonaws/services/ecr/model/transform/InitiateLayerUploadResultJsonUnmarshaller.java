 ...
 */
public class InitiateLayerUploadResultJsonUnmarshaller implements
        Unmarshaller<InitiateLayerUploadResult, JsonUnmarshallerContext> {

    public InitiateLayerUploadResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
