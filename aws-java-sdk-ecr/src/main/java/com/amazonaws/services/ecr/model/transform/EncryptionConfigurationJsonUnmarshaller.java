        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("encryptionType", targetDepth)) {
                    context.nextToken();
                    encryptionConfiguration.setEncryptionType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("kmsKey", targetDepth)) {
                    context.nextToken();
                    encryptionConfiguration.setKmsKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
