...
/**
 * CreateServerlessCacheResult StAX Unmarshaller
 */
...
public class CreateServerlessCacheResultStaxUnmarshaller implements Unmarshaller<CreateServerlessCacheResult, StaxUnmarshallerContext> {
    ...
    public CreateServerlessCacheResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ServerlessCache", targetDepth)) {
                    createServerlessCacheResult.setServerlessCache(ServerlessCacheStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
