...
/**
 * RegionalConfiguration StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RegionalConfigurationStaxUnmarshaller implements Unmarshaller<RegionalConfiguration, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ReplicationGroupId", targetDepth)) {
                    regionalConfiguration.setReplicationGroupId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ReplicationGroupRegion", targetDepth)) {
                    regionalConfiguration.setReplicationGroupRegion(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("ReshardingConfiguration/ReshardingConfiguration", targetDepth)) {
