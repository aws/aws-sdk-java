    ...
    public Request<DeleteReplicationGroupRequest> marshall(
        ...
        if (deleteReplicationGroupRequest.getReplicationGroupId() != null) {
            request.addParameter("ReplicationGroupId", StringUtils
                    .fromString(deleteReplicationGroupRequest
                            .getReplicationGroupId()));
        }

        if (deleteReplicationGroupRequest.getRetainPrimaryCluster() != null) {
            request.addParameter("RetainPrimaryCluster", StringUtils
                    .fromBoolean(deleteReplicationGroupRequest
                            .getRetainPrimaryCluster()));
        }

        if (deleteReplicationGroupRequest.getFinalSnapshotIdentifier() != null) {
            request.addParameter("FinalSnapshotIdentifier", StringUtils
                    .fromString(deleteReplicationGroupRequest
