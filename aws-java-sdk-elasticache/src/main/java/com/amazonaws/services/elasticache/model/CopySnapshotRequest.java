...
public class CopySnapshotRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * <b>Solution:</b> Give the <i>TargetSnapshotName</i> a new and unique value. If exporting a snapshot, you could
     * alternatively create a new Amazon S3 bucket and use this same value for <i>TargetSnapshotName</i>.
     * </p>
     * </li>
     * </ul>
     */
    ...
    /**
     * <p>
     * The Amazon S3 bucket to which the snapshot will be exported. This parameter is used only when exporting a
     ...
     * </p>
     * <p>
     * <b>Solution:</b> Before exporting your snapshot, create a new Amazon S3 bucket in the same region as your
     ...
     *        be unique within its context - ElastiCache or an Amazon S3 bucket if exporting.</p>
     *        <p class="title">
     *        <b>Error Message</b>
     *        </p>
     *        <ul>
     ...
     *        </p>
     *        <p>
     *        <b>Solution:</b> Give the <i>TargetSnapshotName</i> a new and unique value. If exporting a snapshot, you
     *        could alternatively create a new Amazon S3 bucket and use this same value for <i>TargetSnapshotName</i>.
     *        </p>
     *        </li>
     */
     ...
     *         must be unique within its context - ElastiCache or an Amazon S3 bucket if exporting.</p>
     *         <p class="title">
     *         <b>Error Message</b>
     *         </p>
     *         <ul>
     ...
     *        </p>
     *        <p>
     *        <b>Solution:</b> Create an Amazon S3 bucket in the same region as your snapshot. For more information, see
     *        <a href=
     *        "http://docs.aws.amazon.com/AmazonElastiCache/latest/UserGuide/Snapshots.Exporting.html#Snapshots.Exporting.CreateBucket"
     *        >Step 1: Create an Amazon S3 Bucket</a>.
     *        </p>
     ...
     * </p>
     * 
     * @return The Amazon S3 bucket to which the snapshot will be exported. This parameter is used only when exporting a
     *         snapshot for external access.</p>
     *         <p>
     *         When using this parameter to export a snapshot, be sure Amazon ElastiCache has the needed permissions to
     *         this S3 bucket. For more information, see <a href=
     ...
     *         </p>
     *         <p>
     *         <b>Solution:</b> Create an Amazon S3 bucket in the same region as your snapshot. For more information,
     *         see <a href=
     *         "http://docs.aws.amazon.com/AmazonElastiCache/latest/UserGuide/Snapshots.Exporting.html#Snapshots.Exporting.CreateBucket"
     *         >Step 1: Create an Amazon S3 Bucket</a>.
     *         </p>
