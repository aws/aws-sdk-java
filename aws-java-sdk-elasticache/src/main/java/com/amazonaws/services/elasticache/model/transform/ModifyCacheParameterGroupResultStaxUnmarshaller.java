...
/**
 * ModifyCacheParameterGroupResult StAX Unmarshaller
 */
public class ModifyCacheParameterGroupResultStaxUnmarshaller implements
        Unmarshaller<ModifyCacheParameterGroupResult, StaxUnmarshallerContext> {

    public ModifyCacheParameterGroupResult unmarshall(
