 ...
 */
public class ReplicationGroupPendingModifiedValuesStaxUnmarshaller
        implements
        Unmarshaller<ReplicationGroupPendingModifiedValues, StaxUnmarshallerContext> {

    public ReplicationGroupPendingModifiedValues unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("PrimaryClusterId", targetDepth)) {
                    replicationGroupPendingModifiedValues
                            .setPrimaryClusterId(StringStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("AutomaticFailoverStatus",
                        targetDepth)) {
                    replicationGroupPendingModifiedValues
                            .setAutomaticFailoverStatus(StringStaxUnmarshaller
                                    .getInstance().unmarshall(context));
                    continue;
                }
