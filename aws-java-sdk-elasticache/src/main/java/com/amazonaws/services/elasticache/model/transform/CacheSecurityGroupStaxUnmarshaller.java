 ...
 */
public class CacheSecurityGroupStaxUnmarshaller implements
        Unmarshaller<CacheSecurityGroup, StaxUnmarshallerContext> {

    public CacheSecurityGroup unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("OwnerId", targetDepth)) {
                    cacheSecurityGroup.setOwnerId(StringStaxUnmarshaller
                ...
                if (context.testExpression("Description", targetDepth)) {
                    cacheSecurityGroup.setDescription(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
