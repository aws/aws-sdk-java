 ...
 */
public class ParameterNameValueStaxUnmarshaller implements
        Unmarshaller<ParameterNameValue, StaxUnmarshallerContext> {

    public ParameterNameValue unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ParameterName", targetDepth)) {
                    parameterNameValue.setParameterName(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ParameterValue", targetDepth)) {
                    parameterNameValue.setParameterValue(StringStaxUnmarshaller
                            .getInstance().unmarshall(context));
                    continue;
                }
