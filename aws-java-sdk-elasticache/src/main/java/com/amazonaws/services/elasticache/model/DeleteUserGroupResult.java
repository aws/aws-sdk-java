...
public class DeleteUserGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteUserGroupResult withUserGroupId(String userGroupId) {
    ...
    public DeleteUserGroupResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public DeleteUserGroupResult withEngine(String engine) {
        setEngine(engine);
        return this;
    }
    ...
    public DeleteUserGroupResult withUserIds(String... userIds) {
    ...
    public DeleteUserGroupResult withUserIds(java.util.Collection<String> userIds) {
        setUserIds(userIds);
        return this;
    }
    ...
    public DeleteUserGroupResult withMinimumEngineVersion(String minimumEngineVersion) {
    ...
    public DeleteUserGroupResult withPendingChanges(UserGroupPendingChanges pendingChanges) {
    ...
    public DeleteUserGroupResult withReplicationGroups(String... replicationGroups) {
    ...
    public DeleteUserGroupResult withReplicationGroups(java.util.Collection<String> replicationGroups) {
    ...
    public DeleteUserGroupResult withServerlessCaches(String... serverlessCaches) {
    ...
    public DeleteUserGroupResult withServerlessCaches(java.util.Collection<String> serverlessCaches) {
    ...
    public DeleteUserGroupResult withARN(String aRN) {
        setARN(aRN);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteUserGroupResult == false)
            return false;
        DeleteUserGroupResult other = (DeleteUserGroupResult) obj;
    ...
    @Override
    public DeleteUserGroupResult clone() {
        try {
