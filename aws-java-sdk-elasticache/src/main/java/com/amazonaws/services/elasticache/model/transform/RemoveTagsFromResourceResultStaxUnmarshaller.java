...
/**
 * Remove Tags From Resource Result StAX Unmarshaller
 */
public class RemoveTagsFromResourceResultStaxUnmarshaller implements Unmarshaller<RemoveTagsFromResourceResult, StaxUnmarshallerContext> {
    ...
    public RemoveTagsFromResourceResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return removeTagsFromResourceResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("TagList/Tag", targetDepth)) {
                    removeTagsFromResourceResult.getTagList().add(TagStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static RemoveTagsFromResourceResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new RemoveTagsFromResourceResultStaxUnmarshaller();
        return instance;
    }
}
