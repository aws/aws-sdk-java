 ...
 */
public class RemoveTagsFromResourceResultStaxUnmarshaller implements
        Unmarshaller<RemoveTagsFromResourceResult, StaxUnmarshallerContext> {

    public RemoveTagsFromResourceResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("TagList/Tag", targetDepth)) {
                    removeTagsFromResourceResult
                            .withTagList(TagStaxUnmarshaller.getInstance()
                                    .unmarshall(context));
                    continue;
                }
