 ...
 */
public class CacheSecurityGroupMembershipStaxUnmarshaller implements
        Unmarshaller<CacheSecurityGroupMembership, StaxUnmarshallerContext> {

    public CacheSecurityGroupMembership unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("CacheSecurityGroupName",
                        targetDepth)) {
                    cacheSecurityGroupMembership
                            .setCacheSecurityGroupName(StringStaxUnmarshaller
    ...
    public static CacheSecurityGroupMembershipStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new CacheSecurityGroupMembershipStaxUnmarshaller();
        return instance;
    }
}
