...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/elasticache-2015-02-02/BatchApplyUpdateAction" target="_top">AWS
 *      API Documentation</a>
 */
...
public class BatchApplyUpdateActionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public BatchApplyUpdateActionRequest withReplicationGroupIds(java.util.Collection<String> replicationGroupIds) {
    ...
    public BatchApplyUpdateActionRequest withCacheClusterIds(java.util.Collection<String> cacheClusterIds) {
