 ...
 */
public class DescribeReservedCacheNodesResultStaxUnmarshaller implements
        Unmarshaller<DescribeReservedCacheNodesResult, StaxUnmarshallerContext> {

    public DescribeReservedCacheNodesResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression(
                        "ReservedCacheNodes/ReservedCacheNode", targetDepth)) {
                    describeReservedCacheNodesResult
                            .withReservedCacheNodes(ReservedCacheNodeStaxUnmarshaller
