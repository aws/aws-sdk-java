...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.elasticache.AmazonElastiCache}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonElastiCacheClientBuilder extends
        AwsSyncClientBuilder<AmazonElastiCacheClientBuilder, AmazonElastiCache> {
    ...
    /**
     * Construct a synchronous implementation of AmazonElastiCache using the
