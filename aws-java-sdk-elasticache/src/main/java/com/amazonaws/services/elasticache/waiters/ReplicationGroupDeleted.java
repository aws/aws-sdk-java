...
class ReplicationGroupDeleted {
    ...
    static class IsDeletedMatcher extends
            WaiterAcceptor<DescribeReplicationGroupsResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(
                new JmesPathFlatten(new JmesPathField("ReplicationGroups")),
    ...
    static class IsReplicationGroupNotFoundFaultMatcher extends
            WaiterAcceptor<DescribeReplicationGroupsResult> {
        /**
