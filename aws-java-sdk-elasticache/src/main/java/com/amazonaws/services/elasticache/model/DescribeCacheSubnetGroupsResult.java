 ...
 * </p>
 */
public class DescribeCacheSubnetGroupsResult extends
    ...
    public void setCacheSubnetGroups(
        ...
        this.cacheSubnetGroups = new com.amazonaws.internal.SdkInternalList<CacheSubnetGroup>(
                cacheSubnetGroups);
    }
    ...
    public DescribeCacheSubnetGroupsResult withCacheSubnetGroups(
        ...
        if (this.cacheSubnetGroups == null) {
            setCacheSubnetGroups(new com.amazonaws.internal.SdkInternalList<CacheSubnetGroup>(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCacheSubnetGroups() == null
                ^ this.getCacheSubnetGroups() == null)
            return false;
        if (other.getCacheSubnetGroups() != null
                && other.getCacheSubnetGroups().equals(
                        this.getCacheSubnetGroups()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getCacheSubnetGroups() == null) ? 0
                        : getCacheSubnetGroups().hashCode());
        return hashCode;
    }
