...
public class DescribeReplicationGroupsRequestMarshaller
        implements
    ...
    public Request<DescribeReplicationGroupsRequest> marshall(
        ...
        if (describeReplicationGroupsRequest.getMaxRecords() != null) {
            request.addParameter("MaxRecords", StringUtils
                    .fromInteger(describeReplicationGroupsRequest
                            .getMaxRecords()));
        }

        if (describeReplicationGroupsRequest.getMarker() != null) {
            request.addParameter("Marker", StringUtils
                    .fromString(describeReplicationGroupsRequest.getMarker()));
        }
