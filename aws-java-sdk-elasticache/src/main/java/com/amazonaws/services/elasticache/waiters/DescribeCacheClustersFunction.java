...
@SdkInternalApi
public class DescribeCacheClustersFunction implements
        SdkFunction<DescribeCacheClustersRequest, DescribeCacheClustersResult> {
     ...
     */
    @Override
    public DescribeCacheClustersResult apply(
