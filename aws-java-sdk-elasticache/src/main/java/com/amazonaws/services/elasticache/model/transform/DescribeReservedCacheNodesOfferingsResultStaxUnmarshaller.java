 ...
 */
public class DescribeReservedCacheNodesOfferingsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeReservedCacheNodesOfferingsResult, StaxUnmarshallerContext> {

    public DescribeReservedCacheNodesOfferingsResult unmarshall(
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context
                        .testExpression(
                                ...
                                targetDepth)) {
                    describeReservedCacheNodesOfferingsResult
                            .withReservedCacheNodesOfferings(ReservedCacheNodesOfferingStaxUnmarshaller
