 ...
 */
public class CacheParameterGroupStatusStaxUnmarshaller implements
        Unmarshaller<CacheParameterGroupStatus, StaxUnmarshallerContext> {

    public CacheParameterGroupStatus unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("CacheParameterGroupName",
                        targetDepth)) {
                    cacheParameterGroupStatus
                            .setCacheParameterGroupName(StringStaxUnmarshaller
                ...
                if (context.testExpression("CacheNodeIdsToReboot/CacheNodeId",
                        targetDepth)) {
                    cacheParameterGroupStatus
    ...
    public static CacheParameterGroupStatusStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new CacheParameterGroupStatusStaxUnmarshaller();
        return instance;
    }
}
