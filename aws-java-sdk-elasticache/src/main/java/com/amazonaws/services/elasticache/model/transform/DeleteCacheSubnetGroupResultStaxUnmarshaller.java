 ...
 */
public class DeleteCacheSubnetGroupResultStaxUnmarshaller implements
        Unmarshaller<DeleteCacheSubnetGroupResult, StaxUnmarshallerContext> {

    public DeleteCacheSubnetGroupResult unmarshall(
