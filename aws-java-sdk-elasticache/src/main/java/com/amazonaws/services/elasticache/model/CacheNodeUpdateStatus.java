 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/elasticache-2015-02-02/CacheNodeUpdateStatus" target="_top">AWS
 *      API Documentation</a>
 */
...
public class CacheNodeUpdateStatus implements Serializable, Cloneable {
    ...
    public CacheNodeUpdateStatus withNodeUpdateStatusModifiedDate(java.util.Date nodeUpdateStatusModifiedDate) {
    ...
    @Override
    public CacheNodeUpdateStatus clone() {
        try {
