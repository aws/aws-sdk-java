 ...
 */
public class DescribeCacheEngineVersionsResultStaxUnmarshaller
        implements
        Unmarshaller<DescribeCacheEngineVersionsResult, StaxUnmarshallerContext> {

    public DescribeCacheEngineVersionsResult unmarshall(
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression(
                        "CacheEngineVersions/CacheEngineVersion", targetDepth)) {
                    describeCacheEngineVersionsResult
