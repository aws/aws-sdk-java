...
public class DeleteUserResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteUserResult withMinimumEngineVersion(String minimumEngineVersion) {
    ...
    public DeleteUserResult withUserGroupIds(String... userGroupIds) {
    ...
    public DeleteUserResult withUserGroupIds(java.util.Collection<String> userGroupIds) {
