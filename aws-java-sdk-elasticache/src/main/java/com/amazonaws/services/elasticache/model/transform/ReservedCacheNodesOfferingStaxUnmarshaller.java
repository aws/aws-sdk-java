 ...
 */
public class ReservedCacheNodesOfferingStaxUnmarshaller implements
        Unmarshaller<ReservedCacheNodesOffering, StaxUnmarshallerContext> {

    public ReservedCacheNodesOffering unmarshall(StaxUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ReservedCacheNodesOfferingId",
                        targetDepth)) {
                    reservedCacheNodesOffering
                            .setReservedCacheNodesOfferingId(StringStaxUnmarshaller
    ...
    public static ReservedCacheNodesOfferingStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReservedCacheNodesOfferingStaxUnmarshaller();
        return instance;
    }
}
