...
class CacheClusterDeleted {
    ...
    static class IsDeletedMatcher extends WaiterAcceptor<DescribeCacheClustersResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("CacheClusters")), new JmesPathField(
                "CacheClusterStatus"));
    ...
    static class IsCacheClusterNotFoundMatcher extends WaiterAcceptor<DescribeCacheClustersResult> {
        /**
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeCacheClustersResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCreatingMatcher extends WaiterAcceptor<DescribeCacheClustersResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIncompatiblenetworkMatcher extends WaiterAcceptor<DescribeCacheClustersResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsModifyingMatcher extends WaiterAcceptor<DescribeCacheClustersResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsRestorefailedMatcher extends WaiterAcceptor<DescribeCacheClustersResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsSnapshottingMatcher extends WaiterAcceptor<DescribeCacheClustersResult> {
        private static final JsonNode expectedResult;
