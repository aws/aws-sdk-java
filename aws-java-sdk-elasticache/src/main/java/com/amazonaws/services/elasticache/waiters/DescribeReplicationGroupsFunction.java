...
@SdkInternalApi
public class DescribeReplicationGroupsFunction
        implements
        SdkFunction<DescribeReplicationGroupsRequest, DescribeReplicationGroupsResult> {
     ...
     */
    @Override
    public DescribeReplicationGroupsResult apply(
