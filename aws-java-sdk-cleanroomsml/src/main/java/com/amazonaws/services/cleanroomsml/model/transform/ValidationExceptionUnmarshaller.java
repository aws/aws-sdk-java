...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.cleanroomsml.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.cleanroomsml.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cleanroomsml.model.ValidationException validationException = new com.amazonaws.services.cleanroomsml.model.ValidationException(
                null);
