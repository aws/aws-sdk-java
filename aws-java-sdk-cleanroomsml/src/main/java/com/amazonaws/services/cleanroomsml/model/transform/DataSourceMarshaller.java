...
public class DataSourceMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> GLUEDATASOURCE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("glueDataSource").build();
    ...
    public void marshall(DataSource dataSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dataSource.getGlueDataSource(), GLUEDATASOURCE_BINDING);
        } catch (Exception e) {
