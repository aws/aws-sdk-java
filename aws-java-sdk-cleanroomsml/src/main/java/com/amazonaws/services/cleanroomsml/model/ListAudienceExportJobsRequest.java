...
public class ListAudienceExportJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAudienceExportJobsRequest clone() {
        return (ListAudienceExportJobsRequest) super.clone();
    }
