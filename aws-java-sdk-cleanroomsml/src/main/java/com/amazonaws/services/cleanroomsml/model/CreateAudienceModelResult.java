...
public class CreateAudienceModelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateAudienceModelResult withAudienceModelArn(String audienceModelArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAudienceModelResult == false)
            return false;
        CreateAudienceModelResult other = (CreateAudienceModelResult) obj;
    ...
    @Override
    public CreateAudienceModelResult clone() {
        try {
            return (CreateAudienceModelResult) super.clone();
