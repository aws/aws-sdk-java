...
public class AudienceSizeConfigMarshaller {
    ...
    public static AudienceSizeConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AudienceSizeConfig audienceSizeConfig, ProtocolMarshaller protocolMarshaller) {

        if (audienceSizeConfig == null) {
