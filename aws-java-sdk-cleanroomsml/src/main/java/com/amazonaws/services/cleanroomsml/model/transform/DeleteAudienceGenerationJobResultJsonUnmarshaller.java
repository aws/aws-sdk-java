...
/**
 * DeleteAudienceGenerationJobResult JSON Unmarshaller
 */
...
public class DeleteAudienceGenerationJobResultJsonUnmarshaller implements Unmarshaller<DeleteAudienceGenerationJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteAudienceGenerationJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAudienceGenerationJobResult deleteAudienceGenerationJobResult = new DeleteAudienceGenerationJobResult();

        return deleteAudienceGenerationJobResult;
    }
