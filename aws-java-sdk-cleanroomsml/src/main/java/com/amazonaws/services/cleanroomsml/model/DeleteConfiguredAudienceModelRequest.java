...
public class DeleteConfiguredAudienceModelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the configured audience model that you want to delete.
     */
    ...
    public DeleteConfiguredAudienceModelRequest withConfiguredAudienceModelArn(String configuredAudienceModelArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteConfiguredAudienceModelRequest == false)
            return false;
        DeleteConfiguredAudienceModelRequest other = (DeleteConfiguredAudienceModelRequest) obj;
    ...
    @Override
    public DeleteConfiguredAudienceModelRequest clone() {
