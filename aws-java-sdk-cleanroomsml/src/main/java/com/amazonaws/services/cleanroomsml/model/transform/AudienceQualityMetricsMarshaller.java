...
/**
 * AudienceQualityMetricsMarshaller
 */
...
public class AudienceQualityMetricsMarshaller {
    ...
    public static AudienceQualityMetricsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AudienceQualityMetrics audienceQualityMetrics, ProtocolMarshaller protocolMarshaller) {

        if (audienceQualityMetrics == null) {
