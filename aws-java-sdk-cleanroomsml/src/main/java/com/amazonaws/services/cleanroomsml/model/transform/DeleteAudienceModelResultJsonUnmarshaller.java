...
/**
 * DeleteAudienceModelResult JSON Unmarshaller
 */
...
public class DeleteAudienceModelResultJsonUnmarshaller implements Unmarshaller<DeleteAudienceModelResult, JsonUnmarshallerContext> {
    ...
    public DeleteAudienceModelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAudienceModelResult deleteAudienceModelResult = new DeleteAudienceModelResult();

        return deleteAudienceModelResult;
    }
