...
/**
 * DeleteConfiguredAudienceModelResult JSON Unmarshaller
 */
...
public class DeleteConfiguredAudienceModelResultJsonUnmarshaller implements Unmarshaller<DeleteConfiguredAudienceModelResult, JsonUnmarshallerContext> {
    ...
    public DeleteConfiguredAudienceModelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteConfiguredAudienceModelResult deleteConfiguredAudienceModelResult = new DeleteConfiguredAudienceModelResult();

        return deleteConfiguredAudienceModelResult;
    }
