...
public class CloudHsmResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CloudHsmResourceNotFoundExceptionUnmarshaller instance;

    public static CloudHsmResourceNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CloudHsmResourceNotFoundExceptionUnmarshaller();
        return instance;
    }
}
