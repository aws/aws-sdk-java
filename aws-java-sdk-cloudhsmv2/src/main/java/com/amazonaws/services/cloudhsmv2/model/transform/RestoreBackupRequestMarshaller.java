...
@SdkInternalApi
public class RestoreBackupRequestMarshaller {
    ...
    private static final RestoreBackupRequestMarshaller instance = new RestoreBackupRequestMarshaller();

    public static RestoreBackupRequestMarshaller getInstance() {
        return instance;
    }
