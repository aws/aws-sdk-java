...
public class CreateHsmResultJsonUnmarshaller implements Unmarshaller<CreateHsmResult, JsonUnmarshallerContext> {
    ...
    public CreateHsmResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateHsmResult createHsmResult = new CreateHsmResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Hsm", targetDepth)) {
                    context.nextToken();
                    createHsmResult.setHsm(HsmJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    private static CreateHsmResultJsonUnmarshaller instance;

    public static CreateHsmResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateHsmResultJsonUnmarshaller();
        return instance;
    }
}
