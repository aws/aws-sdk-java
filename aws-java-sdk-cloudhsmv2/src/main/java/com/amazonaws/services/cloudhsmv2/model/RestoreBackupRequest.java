...
public class RestoreBackupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * The ID of the backup to be restored. To find the ID of a backup, use the <a>DescribeBackups</a> operation.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The ID of the backup to be restored. To find the ID of a backup, use the <a>DescribeBackups</a>
     *         operation.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RestoreBackupRequest == false)
            return false;
        RestoreBackupRequest other = (RestoreBackupRequest) obj;
