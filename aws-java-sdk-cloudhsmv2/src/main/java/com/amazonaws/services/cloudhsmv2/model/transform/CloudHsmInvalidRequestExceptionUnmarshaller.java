...
public class CloudHsmInvalidRequestExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CloudHsmInvalidRequestExceptionUnmarshaller instance;

    public static CloudHsmInvalidRequestExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CloudHsmInvalidRequestExceptionUnmarshaller();
        return instance;
    }
}
