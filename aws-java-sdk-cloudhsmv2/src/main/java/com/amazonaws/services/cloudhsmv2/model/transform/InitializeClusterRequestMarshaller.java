...
/**
 * InitializeClusterRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class InitializeClusterRequestMarshaller {
    ...
    private static final MarshallingInfo<String> SIGNEDCERT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("SignedCert").build();
    private static final MarshallingInfo<String> TRUSTANCHOR_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("TrustAnchor").build();

    private static final InitializeClusterRequestMarshaller instance = new InitializeClusterRequestMarshaller();

    public static InitializeClusterRequestMarshaller getInstance() {
        return instance;
    }
