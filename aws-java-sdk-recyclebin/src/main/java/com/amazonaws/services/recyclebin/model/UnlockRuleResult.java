...
public class UnlockRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UnlockRuleResult withResourceTags(java.util.Collection<ResourceTag> resourceTags) {
    ...
    public UnlockRuleResult withLockEndTime(java.util.Date lockEndTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UnlockRuleResult == false)
            return false;
