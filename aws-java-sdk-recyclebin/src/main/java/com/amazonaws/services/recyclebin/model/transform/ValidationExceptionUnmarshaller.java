...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.recyclebin.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.recyclebin.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.recyclebin.model.ValidationException validationException = new com.amazonaws.services.recyclebin.model.ValidationException(null);
