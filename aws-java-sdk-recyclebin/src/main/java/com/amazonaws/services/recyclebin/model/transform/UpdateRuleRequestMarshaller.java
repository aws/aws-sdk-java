...
public class UpdateRuleRequestMarshaller {
    ...
    public void marshall(UpdateRuleRequest updateRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateRuleRequest.getIdentifier(), IDENTIFIER_BINDING);
            protocolMarshaller.marshall(updateRuleRequest.getRetentionPeriod(), RETENTIONPERIOD_BINDING);
            protocolMarshaller.marshall(updateRuleRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateRuleRequest.getResourceType(), RESOURCETYPE_BINDING);
            protocolMarshaller.marshall(updateRuleRequest.getResourceTags(), RESOURCETAGS_BINDING);
        } catch (Exception e) {
