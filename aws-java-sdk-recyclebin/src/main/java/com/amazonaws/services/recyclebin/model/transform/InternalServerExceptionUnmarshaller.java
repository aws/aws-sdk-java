...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.recyclebin.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.recyclebin.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.recyclebin.model.InternalServerException internalServerException = new com.amazonaws.services.recyclebin.model.InternalServerException(
                null);
