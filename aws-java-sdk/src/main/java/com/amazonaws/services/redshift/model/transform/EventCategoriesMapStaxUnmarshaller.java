...
public class EventCategoriesMapStaxUnmarshaller implements Unmarshaller<EventCategoriesMap, StaxUnmarshallerContext> {
    ...
    public EventCategoriesMap unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return eventCategoriesMap;
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Events/EventInfoMap", targetDepth)) {
                    eventCategoriesMap.getEvents().add(EventInfoMapStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static EventCategoriesMapStaxUnmarshaller getInstance() {
        if (instance == null) instance = new EventCategoriesMapStaxUnmarshaller();
        return instance;
    }
}
