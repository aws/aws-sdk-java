...
/**
 * Test Metric Filter Result JSON Unmarshaller
 */
public class TestMetricFilterResultJsonUnmarshaller implements Unmarshaller<TestMetricFilterResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("matches", targetDepth)) {
                    context.nextToken();
                    testMetricFilterResult.setMatches(new ListUnmarshaller<MetricFilterMatchRecord>(MetricFilterMatchRecordJsonUnmarshaller.getInstance()).unmarshall(context));
                }
    ...
    public static TestMetricFilterResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new TestMetricFilterResultJsonUnmarshaller();
        return instance;
    }
}
