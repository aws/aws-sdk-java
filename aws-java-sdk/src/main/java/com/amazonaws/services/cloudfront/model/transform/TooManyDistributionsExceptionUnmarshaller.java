...
public class TooManyDistributionsExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public TooManyDistributionsExceptionUnmarshaller() {
        super(TooManyDistributionsException.class);
    }
