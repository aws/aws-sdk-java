...
public class DescribeStackSummaryResult implements Serializable {
     ...
     * A <code>StackSummary</code> object that contains the results.
     *
     * @param stackSummary A <code>StackSummary</code> object that contains the results.
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getStackSummary() != null) sb.append("StackSummary: " + getStackSummary() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeStackSummaryResult == false) return false;
        DescribeStackSummaryResult other = (DescribeStackSummaryResult)obj;
        
        if (other.getStackSummary() == null ^ this.getStackSummary() == null) return false;
        if (other.getStackSummary() != null && other.getStackSummary().equals(this.getStackSummary()) == false) return false; 
        return true;
    }
