...
public class InstanceMonitoringStaxUnmarshaller implements Unmarshaller<InstanceMonitoring, StaxUnmarshallerContext> {
    ...
    public InstanceMonitoring unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return instanceMonitoring;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("Enabled", targetDepth)) {
                    instanceMonitoring.setEnabled(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static InstanceMonitoringStaxUnmarshaller getInstance() {
        if (instance == null) instance = new InstanceMonitoringStaxUnmarshaller();
        return instance;
    }
}
