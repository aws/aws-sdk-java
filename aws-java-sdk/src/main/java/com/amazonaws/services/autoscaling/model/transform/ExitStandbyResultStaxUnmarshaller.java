...
/**
 * Exit Standby Result StAX Unmarshaller
 */
public class ExitStandbyResultStaxUnmarshaller implements Unmarshaller<ExitStandbyResult, StaxUnmarshallerContext> {
    ...
    public ExitStandbyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return exitStandbyResult;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("Activities/member", targetDepth)) {
                    exitStandbyResult.getActivities().add(ActivityStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ExitStandbyResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ExitStandbyResultStaxUnmarshaller();
        return instance;
    }
}
