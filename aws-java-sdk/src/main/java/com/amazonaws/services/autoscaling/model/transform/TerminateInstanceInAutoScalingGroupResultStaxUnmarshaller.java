...
public class TerminateInstanceInAutoScalingGroupResultStaxUnmarshaller implements Unmarshaller<TerminateInstanceInAutoScalingGroupResult, StaxUnmarshallerContext> {
    ...
    public TerminateInstanceInAutoScalingGroupResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return terminateInstanceInAutoScalingGroupResult;
    ...
    public static TerminateInstanceInAutoScalingGroupResultStaxUnmarshaller getInstance() {
        if (instance == null) instance = new TerminateInstanceInAutoScalingGroupResultStaxUnmarshaller();
        return instance;
    }
}
