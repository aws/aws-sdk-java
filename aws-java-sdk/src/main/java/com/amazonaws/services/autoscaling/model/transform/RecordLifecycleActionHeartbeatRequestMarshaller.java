...
/**
 * Record Lifecycle Action Heartbeat Request Marshaller
 */
public class RecordLifecycleActionHeartbeatRequestMarshaller implements Marshaller<Request<RecordLifecycleActionHeartbeatRequest>, RecordLifecycleActionHeartbeatRequest> {
    ...
    public Request<RecordLifecycleActionHeartbeatRequest> marshall(RecordLifecycleActionHeartbeatRequest recordLifecycleActionHeartbeatRequest) {
        ...
        Request<RecordLifecycleActionHeartbeatRequest> request = new DefaultRequest<RecordLifecycleActionHeartbeatRequest>(recordLifecycleActionHeartbeatRequest, "AmazonAutoScaling");
