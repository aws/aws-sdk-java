...
public class DynamoDBMapper {
    ...
    public <T extends Object> T load(T keyObject, DynamoDBMapperConfig config) {
        ...
        T object = marshalIntoObject(toParameters(itemAttributes, clazz, tableName, config));
        return object;
    }
    ...
    public <T> T marshallIntoObject(Class<T> clazz, Map<String, AttributeValue> itemAttributes) {
        if (itemAttributes instanceof MapAnd) {
            ...
            // config.
            String tableName = getTableName(clazz, this.config);
            return privateMarshalIntoObject(
                toParameters(itemAttributes, clazz, tableName, this.config));
        }
    }
    ...
    public List<FailedBatch> batchWrite(List<? extends Object> objectsToWrite,
        ...
        HashMap<String, List<WriteRequest>> requestItems =
