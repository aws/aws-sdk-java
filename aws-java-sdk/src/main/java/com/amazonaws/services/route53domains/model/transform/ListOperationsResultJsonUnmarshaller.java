...
/**
 * List Operations Result JSON Unmarshaller
 */
public class ListOperationsResultJsonUnmarshaller implements Unmarshaller<ListOperationsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Operations", targetDepth)) {
                    context.nextToken();
                    listOperationsResult.setOperations(new ListUnmarshaller<OperationSummary>(OperationSummaryJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("NextPageMarker", targetDepth)) {
                    context.nextToken();
                    listOperationsResult.setNextPageMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ListOperationsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListOperationsResultJsonUnmarshaller();
        return instance;
    }
}
