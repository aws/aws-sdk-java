...
public class OptionStatus implements Serializable {
     ...
     * will not be deployed until <a>IndexDocuments</a> has been called and
     * indexing is complete.</li> <li><code>Processing</code>: the option's
     * latest value is in the process of being activated. </li>
     * <li><code>Active</code>: the option's latest value is completely
     * deployed.</li> <li><code>FailedToValidate</code>: the option value is
     ...
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Allowed Values: </b>RequiresIndexDocuments, Processing, Active, FailedToValidate
     */
