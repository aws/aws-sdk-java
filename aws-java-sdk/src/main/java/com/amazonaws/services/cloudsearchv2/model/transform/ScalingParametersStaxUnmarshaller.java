...
/**
 * Scaling Parameters StAX Unmarshaller
 */
public class ScalingParametersStaxUnmarshaller implements Unmarshaller<ScalingParameters, StaxUnmarshallerContext> {
    ...
    public ScalingParameters unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isEndDocument()) return scalingParameters;

            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                if (context.testExpression("DesiredInstanceType", targetDepth)) {
                    scalingParameters.setDesiredInstanceType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ScalingParametersStaxUnmarshaller getInstance() {
        if (instance == null) instance = new ScalingParametersStaxUnmarshaller();
        return instance;
    }
}
