 ...
 */
public class ValidationErrorJsonUnmarshaller implements Unmarshaller<ValidationError, JsonUnmarshallerContext> {
    ...
    public static ValidationErrorJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ValidationErrorJsonUnmarshaller();
        return instance;
    }
}
