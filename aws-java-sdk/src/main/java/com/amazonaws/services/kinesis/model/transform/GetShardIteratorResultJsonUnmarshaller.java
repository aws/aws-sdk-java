...
public class GetShardIteratorResultJsonUnmarshaller implements Unmarshaller<GetShardIteratorResult, JsonUnmarshallerContext> {
    ...
    public GetShardIteratorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ShardIterator", targetDepth)) {
                    context.nextToken();
                    getShardIteratorResult.setShardIterator(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static GetShardIteratorResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetShardIteratorResultJsonUnmarshaller();
        return instance;
    }
}
