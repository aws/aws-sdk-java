...
public class HostedZoneAlreadyExistsExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public HostedZoneAlreadyExistsExceptionUnmarshaller() {
        super(HostedZoneAlreadyExistsException.class);
    }
