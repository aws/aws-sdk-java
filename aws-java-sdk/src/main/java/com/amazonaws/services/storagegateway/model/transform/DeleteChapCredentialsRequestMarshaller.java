        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (deleteChapCredentialsRequest.getTargetARN() != null) {
                jsonWriter.key("TargetARN").value(deleteChapCredentialsRequest.getTargetARN());
            }
            if (deleteChapCredentialsRequest.getInitiatorName() != null) {
                jsonWriter.key("InitiatorName").value(deleteChapCredentialsRequest.getInitiatorName());
            }
