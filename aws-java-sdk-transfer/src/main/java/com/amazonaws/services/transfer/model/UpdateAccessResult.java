...
public class UpdateAccessResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAccessResult == false)
            return false;
        UpdateAccessResult other = (UpdateAccessResult) obj;
    ...
    public UpdateAccessResult clone() {
        try {
            return (UpdateAccessResult) super.clone();
