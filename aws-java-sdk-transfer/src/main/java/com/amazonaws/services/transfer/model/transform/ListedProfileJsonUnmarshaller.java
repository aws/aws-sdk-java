...
/**
 * ListedProfile JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListedProfileJsonUnmarshaller implements Unmarshaller<ListedProfile, JsonUnmarshallerContext> {

    public ListedProfile unmarshall(JsonUnmarshallerContext context) throws Exception {
        ListedProfile listedProfile = new ListedProfile();
    ...
    private static ListedProfileJsonUnmarshaller instance;

    public static ListedProfileJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListedProfileJsonUnmarshaller();
        return instance;
    }
}
