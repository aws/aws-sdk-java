...
/**
 * DescribedAgreement JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribedAgreementJsonUnmarshaller implements Unmarshaller<DescribedAgreement, JsonUnmarshallerContext> {

    public DescribedAgreement unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribedAgreement describedAgreement = new DescribedAgreement();
    ...
    private static DescribedAgreementJsonUnmarshaller instance;

    public static DescribedAgreementJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribedAgreementJsonUnmarshaller();
        return instance;
    }
}
