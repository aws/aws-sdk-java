...
/**
 * DescribeServerResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeServerResultJsonUnmarshaller implements Unmarshaller<DescribeServerResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Server", targetDepth)) {
                    context.nextToken();
                    describeServerResult.setServer(DescribedServerJsonUnmarshaller.getInstance().unmarshall(context));
                }
