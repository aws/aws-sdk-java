...
public class ListProfilesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * Returns a token that you can use to call <code>ListProfiles</code> again and receive additional results, if there
     * are any.
     * </p>
     */
     ...
     * </p>
     */
    private java.util.List<ListedProfile> profiles;
     ...
     * 
     * @param nextToken
     *        Returns a token that you can use to call <code>ListProfiles</code> again and receive additional results,
     *        if there are any.
     */
     ...
     * </p>
     * 
     * @return Returns a token that you can use to call <code>ListProfiles</code> again and receive additional results,
     *         if there are any.
     */
     ...
     * </p>
     * 
     * @return Returns an array, where each item contains the details of a profile.
     */

    public java.util.List<ListedProfile> getProfiles() {
        return profiles;
    }
    ...
    public void setProfiles(java.util.Collection<ListedProfile> profiles) {
        if (profiles == null) {
            this.profiles = null;
            return;
        }

        this.profiles = new java.util.ArrayList<ListedProfile>(profiles);
    }
    ...
    public ListProfilesResult withProfiles(ListedProfile... profiles) {
        if (this.profiles == null) {
            setProfiles(new java.util.ArrayList<ListedProfile>(profiles.length));
        }
    ...
    public ListProfilesResult withProfiles(java.util.Collection<ListedProfile> profiles) {
