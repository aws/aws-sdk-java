...
public class LoggingConfigurationMarshaller {
    ...
    public void marshall(LoggingConfiguration loggingConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(loggingConfiguration.getLoggingRole(), LOGGINGROLE_BINDING);
            protocolMarshaller.marshall(loggingConfiguration.getLogGroupName(), LOGGROUPNAME_BINDING);
        } catch (Exception e) {
