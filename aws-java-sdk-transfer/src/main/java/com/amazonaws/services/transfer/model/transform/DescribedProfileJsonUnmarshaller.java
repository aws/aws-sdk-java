...
/**
 * DescribedProfile JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribedProfileJsonUnmarshaller implements Unmarshaller<DescribedProfile, JsonUnmarshallerContext> {

    public DescribedProfile unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribedProfile describedProfile = new DescribedProfile();
    ...
    private static DescribedProfileJsonUnmarshaller instance;

    public static DescribedProfileJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribedProfileJsonUnmarshaller();
        return instance;
    }
}
