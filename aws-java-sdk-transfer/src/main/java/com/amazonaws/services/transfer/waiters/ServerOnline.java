...
class ServerOnline {
    ...
    static class IsONLINEMatcher extends WaiterAcceptor<DescribeServerResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("Server"), new JmesPathField("State"));
         ...
         */
        @Override
        public boolean matches(DescribeServerResult result) {
    ...
    static class IsSTART_FAILEDMatcher extends WaiterAcceptor<DescribeServerResult> {
        private static final JsonNode expectedResult;
