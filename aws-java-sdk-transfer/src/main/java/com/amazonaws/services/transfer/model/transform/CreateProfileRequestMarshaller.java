...
public class CreateProfileRequestMarshaller {
    ...
    private static final MarshallingInfo<List> CERTIFICATEIDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CertificateIds").build();
    ...
    public void marshall(CreateProfileRequest createProfileRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createProfileRequest.getAs2Id(), AS2ID_BINDING);
            protocolMarshaller.marshall(createProfileRequest.getProfileType(), PROFILETYPE_BINDING);
            protocolMarshaller.marshall(createProfileRequest.getCertificateIds(), CERTIFICATEIDS_BINDING);
