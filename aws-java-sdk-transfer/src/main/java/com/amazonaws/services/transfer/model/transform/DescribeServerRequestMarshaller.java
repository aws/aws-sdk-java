...
/**
 * DescribeServerRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeServerRequestMarshaller {
    ...
    private static final DescribeServerRequestMarshaller instance = new DescribeServerRequestMarshaller();

    public static DescribeServerRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DescribeServerRequest describeServerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeServerRequest.getServerId(), SERVERID_BINDING);
        } catch (Exception e) {
