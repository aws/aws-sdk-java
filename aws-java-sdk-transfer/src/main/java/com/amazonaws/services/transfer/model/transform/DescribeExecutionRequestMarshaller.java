...
public class DescribeExecutionRequestMarshaller {
    ...
    public void marshall(DescribeExecutionRequest describeExecutionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeExecutionRequest.getExecutionId(), EXECUTIONID_BINDING);
            protocolMarshaller.marshall(describeExecutionRequest.getWorkflowId(), WORKFLOWID_BINDING);
        } catch (Exception e) {
