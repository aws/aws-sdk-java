...
public class CreateConnectorRequestMarshaller {
    ...
    public void marshall(CreateConnectorRequest createConnectorRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createConnectorRequest.getUrl(), URL_BINDING);
            protocolMarshaller.marshall(createConnectorRequest.getAs2Config(), AS2CONFIG_BINDING);
