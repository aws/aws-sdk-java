...
public class DescribeAgreementResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setAgreement(DescribedAgreement agreement) {
    ...
    public DescribeAgreementResult withAgreement(DescribedAgreement agreement) {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAgreement() == null ^ this.getAgreement() == null)
            return false;
        if (other.getAgreement() != null && other.getAgreement().equals(this.getAgreement()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getAgreement() == null) ? 0 : getAgreement().hashCode());
        return hashCode;
    }
