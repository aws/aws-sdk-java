...
/**
 * DeleteAgreementResult JSON Unmarshaller
 */
...
public class DeleteAgreementResultJsonUnmarshaller implements Unmarshaller<DeleteAgreementResult, JsonUnmarshallerContext> {
    ...
    public DeleteAgreementResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAgreementResult deleteAgreementResult = new DeleteAgreementResult();

        return deleteAgreementResult;
    }
