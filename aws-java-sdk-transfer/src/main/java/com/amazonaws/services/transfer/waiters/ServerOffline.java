...
class ServerOffline {
    ...
    static class IsOFFLINEMatcher extends WaiterAcceptor<DescribeServerResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"OFFLINE\"");
    ...
    static class IsSTOP_FAILEDMatcher extends WaiterAcceptor<DescribeServerResult> {
        private static final JsonNode expectedResult;
