...
/**
 * ListedExecution JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListedExecutionJsonUnmarshaller implements Unmarshaller<ListedExecution, JsonUnmarshallerContext> {

    public ListedExecution unmarshall(JsonUnmarshallerContext context) throws Exception {
        ListedExecution listedExecution = new ListedExecution();
    ...
    private static ListedExecutionJsonUnmarshaller instance;

    public static ListedExecutionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListedExecutionJsonUnmarshaller();
        return instance;
    }
}
