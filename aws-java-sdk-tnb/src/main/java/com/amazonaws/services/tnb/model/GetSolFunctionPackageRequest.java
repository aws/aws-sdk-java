...
public class GetSolFunctionPackageRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetSolFunctionPackageRequest withVnfPkgId(String vnfPkgId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSolFunctionPackageRequest == false)
            return false;
        GetSolFunctionPackageRequest other = (GetSolFunctionPackageRequest) obj;
    ...
    @Override
    public GetSolFunctionPackageRequest clone() {
        return (GetSolFunctionPackageRequest) super.clone();
    }
