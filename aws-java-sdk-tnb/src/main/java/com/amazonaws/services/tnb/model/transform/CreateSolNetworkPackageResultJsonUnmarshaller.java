...
/**
 * CreateSolNetworkPackageResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateSolNetworkPackageResultJsonUnmarshaller implements Unmarshaller<CreateSolNetworkPackageResult, JsonUnmarshallerContext> {

    public CreateSolNetworkPackageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateSolNetworkPackageResult createSolNetworkPackageResult = new CreateSolNetworkPackageResult();
    ...
    private static CreateSolNetworkPackageResultJsonUnmarshaller instance;

    public static CreateSolNetworkPackageResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateSolNetworkPackageResultJsonUnmarshaller();
        return instance;
    }
}
