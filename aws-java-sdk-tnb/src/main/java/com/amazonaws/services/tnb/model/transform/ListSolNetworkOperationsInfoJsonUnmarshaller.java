...
/**
 * ListSolNetworkOperationsInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSolNetworkOperationsInfoJsonUnmarshaller implements Unmarshaller<ListSolNetworkOperationsInfo, JsonUnmarshallerContext> {

    public ListSolNetworkOperationsInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
        ListSolNetworkOperationsInfo listSolNetworkOperationsInfo = new ListSolNetworkOperationsInfo();
    ...
    private static ListSolNetworkOperationsInfoJsonUnmarshaller instance;

    public static ListSolNetworkOperationsInfoJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListSolNetworkOperationsInfoJsonUnmarshaller();
        return instance;
    }
}
