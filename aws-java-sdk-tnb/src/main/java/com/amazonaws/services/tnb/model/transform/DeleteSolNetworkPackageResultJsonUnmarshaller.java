...
/**
 * DeleteSolNetworkPackageResult JSON Unmarshaller
 */
...
public class DeleteSolNetworkPackageResultJsonUnmarshaller implements Unmarshaller<DeleteSolNetworkPackageResult, JsonUnmarshallerContext> {
    ...
    public DeleteSolNetworkPackageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSolNetworkPackageResult deleteSolNetworkPackageResult = new DeleteSolNetworkPackageResult();

        return deleteSolNetworkPackageResult;
    }
