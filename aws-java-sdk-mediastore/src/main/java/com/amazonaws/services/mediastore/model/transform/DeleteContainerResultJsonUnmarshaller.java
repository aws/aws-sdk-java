...
/**
 * DeleteContainerResult JSON Unmarshaller
 */
...
public class DeleteContainerResultJsonUnmarshaller implements Unmarshaller<DeleteContainerResult, JsonUnmarshallerContext> {
    ...
    public DeleteContainerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteContainerResult deleteContainerResult = new DeleteContainerResult();
