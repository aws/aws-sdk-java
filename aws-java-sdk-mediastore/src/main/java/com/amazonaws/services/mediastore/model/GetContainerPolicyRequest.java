...
public class GetContainerPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetContainerPolicyRequest withContainerName(String containerName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetContainerPolicyRequest == false)
            return false;
        GetContainerPolicyRequest other = (GetContainerPolicyRequest) obj;
    ...
    @Override
    public GetContainerPolicyRequest clone() {
        return (GetContainerPolicyRequest) super.clone();
    }
