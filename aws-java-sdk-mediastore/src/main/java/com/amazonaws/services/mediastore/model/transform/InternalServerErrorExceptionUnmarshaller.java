...
public class InternalServerErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerErrorExceptionUnmarshaller() {
        super(com.amazonaws.services.mediastore.model.InternalServerErrorException.class, "InternalServerError");
    }

    @Override
    public com.amazonaws.services.mediastore.model.InternalServerErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
