...
public class CorsPolicyNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CorsPolicyNotFoundExceptionUnmarshaller instance;

    public static CorsPolicyNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CorsPolicyNotFoundExceptionUnmarshaller();
        return instance;
    }
}
