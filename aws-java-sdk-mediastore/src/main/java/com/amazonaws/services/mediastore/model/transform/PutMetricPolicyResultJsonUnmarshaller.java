...
/**
 * PutMetricPolicyResult JSON Unmarshaller
 */
...
public class PutMetricPolicyResultJsonUnmarshaller implements Unmarshaller<PutMetricPolicyResult, JsonUnmarshallerContext> {
    ...
    public PutMetricPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutMetricPolicyResult putMetricPolicyResult = new PutMetricPolicyResult();
