...
/**
 * PutCorsPolicyRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutCorsPolicyRequestMarshaller {
    ...
    private static final MarshallingInfo<List> CORSPOLICY_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("CorsPolicy").build();

    private static final PutCorsPolicyRequestMarshaller instance = new PutCorsPolicyRequestMarshaller();

    public static PutCorsPolicyRequestMarshaller getInstance() {
        return instance;
    }
