...
public class StandardBeanPropertiesTest {
    ...
    public void testHashAndRangeKey() {
        ...
        final Map<String,BeanProperty<Object,Object>> beans = of((Class<Object>)obj.getClass());
        final BeanProperty<Object,Object> hk = beans.get("hk");
        final BeanProperty<Object,Object> rk = beans.get("rk");
    ...
    public void testAutoGeneratedHashKeyString() {
        ...
        final Map<String,BeanProperty<Object,Object>> beans = of((Class<Object>)obj.getClass());
        final BeanProperty<Object,Object> key = beans.get("key");
    ...
    public void testAutoGeneratedRangeKeyUuid() {
        ...
        final Map<String,BeanProperty<Object,Object>> beans = of((Class<Object>)obj.getClass());
        final BeanProperty<Object,Object> val = beans.get("val");
    ...
    public void testAutoGeneratedVersionBytePrimitive() {
        ...
        final Map<String,BeanProperty<Object,Object>> beans = of((Class<Object>)obj.getClass());
        final BeanProperty<Object,Object> rvn = beans.get("rvn");
    ...
    public void testIndexHashKeyGlobalSecondaryIndexName() {
        ...
        final Map<String,BeanProperty<Object,Object>> beans = of((Class<Object>)obj.getClass());
        final BeanProperty<Object,Object> gsi_hk = beans.get("gsi_hk");
    ...
    public void testIndexRangeKeyGlobalSecondaryIndexName() {
        ...
        assertEquals(0, gsi_hk.annotations().localSecondaryIndexNames().size());
        assertEquals("gsi", gsi_hk.annotations().globalSecondaryIndexNames(KeyType.HASH).get(0));
        final BeanProperty<Object,Object> gsi_rk = beans.get("gsi_rk");
    ...
    public void testIndexRangeKeyiLocalSecondaryIndexName() {
        ...
        final Map<String,BeanProperty<Object,Object>> beans = of((Class<Object>)obj.getClass());
        final BeanProperty<Object,Object> lsi_rk = beans.get("lsi_rk");
    ...
    public void testFindRelevantGettersWithBridgeMethod() {
        final Map<String,BeanProperty<SubClass,Object>> beans = of(SubClass.class);
        assertEquals("only one getter should be returned", 1, beans.size());
        assertEquals("return type should be Integer rather than Object", Integer.class, beans.get("t").valueType());
    }
    ...
    public void testNonMappedInheritedProperties() {
        final Map<String,BeanProperty<NonMappedInheritedProperties,Object>> beans = of(NonMappedInheritedProperties.class);
    ...
    public void testInheritedProperties() {
        final Map<String,BeanProperty<BaseTablePojo,Object>> beans1 = of(BaseTablePojo.class);
        assertEquals(3, beans1.size());
        assertNotNull(beans1.get("hashKeyOnField"));
        assertNotNull(beans1.get("rangeKeyOnGetter"));
        final Map<String,BeanProperty<TablePojoSubclass,Object>> beans2 = of(TablePojoSubclass.class);
    ...
    private static enum PojoAsserts {
        ...
        public static <T> void assertAll(final Class<T> clazz) {
            final Map<String,BeanProperty<T,Object>> beans = of(clazz);
            for (final PojoAsserts asserts : PojoAsserts.values()) {
                final BeanProperty<T,Object> bean = beans.get(asserts.name());
                assertNotNull(bean);
