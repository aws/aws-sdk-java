...
public class CreateTableRequest extends AmazonWebServiceRequest implements
     ...
     *        "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html"
     *        >Data Model</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p>
     *        <p>
     *        Each <i>KeySchemaElement</i> in the array is composed of:
     *        </p>
     *        <ul>
     ...
     * </p>
     * 
     * @return Specifies the attributes that make up the primary key for a table
     *         or an index. The attributes in <i>KeySchema</i> must also be
     *         defined in the <i>AttributeDefinitions</i> array. For more
     *         information, see <a href=
     *         "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html"
     *         >Data Model</a> in the <i>Amazon DynamoDB Developer
     *         Guide</i>.</p>
     *         <p>
     *         Each <i>KeySchemaElement</i> in the array is composed of:
     *         </p>
    ...
    public CreateTableRequest withLocalSecondaryIndexes(
        ...
        if (this.localSecondaryIndexes == null) {
            setLocalSecondaryIndexes(new java.util.ArrayList<LocalSecondaryIndex>(
    ...
    public CreateTableRequest withGlobalSecondaryIndexes(
        ...
        if (this.globalSecondaryIndexes == null) {
            setGlobalSecondaryIndexes(new java.util.ArrayList<GlobalSecondaryIndex>(
     ...
     * </ul>
     * 
     * @return The settings for DynamoDB Streams on the table. These settings
     *         consist of:</p>
     *         <ul>
     *         <li>
     *         <p>
