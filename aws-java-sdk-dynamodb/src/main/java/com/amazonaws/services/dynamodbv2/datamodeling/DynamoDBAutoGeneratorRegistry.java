...
final class DynamoDBAutoGeneratorRegistry {
    ...
    /**
     * Gets the generator given a mapping definition.
     * @param mapping The mapping.
     * @return The generator.
     */
    final Generator<Object> generatorOf(final DynamoDBMappingsRegistry.Mapping mapping) {
        if (mapping.isAutoGeneratedKey()) {
            return keyGeneratorOf(mapping.getGetterType());
        } else if (mapping.isVersionAttribute()) {
            return versionGeneratorOf(mapping.getGetterType());
        } else if (mapping.isAutoGeneratedTimestamp()) {
            return timestampGeneratorOf(mapping.getGetterType(), mapping.getAutoGenerateStrategy());
        } else {
            return neverGeneratorOf(mapping.getGetterType());
        }
    }
