 ...
 * </p>
 */
public class UpdateItemRequest extends com.amazonaws.AmazonWebServiceRequest
     ...
     *        </p>
     *        <p>
     *        Each <i>AttributeUpdates</i> element consists of an attribute name
     ...
     *        <li>
     *        <p>
     *        If the existing attribute is a number, and if <i>Value</i> is also
     *        a number, then <i>Value</i> is mathematically added to the
     ...
     *        example, if the attribute value is the set <code>[1,2]</code>, and
     *        the <code>ADD</code> action specified <code>[3]</code>, then the
     ...
     *        the existing data type is a set of strings, <i>Value</i> must also
     *        be a set of strings.
     *        </p>
     *        </li>
     *        </ul>
     ...
     *        <li>
     *        <p>
     *        <code>ALL_NEW</code> - All of the attributes of the new version of
     ...
     *        Use <i>ReturnValues</i> if you want to get the item attributes as
     *        they appeared either before or after they were updated. For
     *        <i>UpdateItem</i>, the valid values are:</p>
     *        <ul>
     *        <li>
     *        <p>
     *        <code>NONE</code> - If <i>ReturnValues</i> is not specified, or if
     ...
     *        types. In addition, <code>ADD</code> can only be used on top-level
