...
@SdkInternalApi
public class DescribeLimitsRequestProtocolMarshaller implements Marshaller<Request<DescribeLimitsRequest>, DescribeLimitsRequest> {
    ...
    public DescribeLimitsRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DescribeLimitsRequest> marshall(DescribeLimitsRequest describeLimitsRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<DescribeLimitsRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
