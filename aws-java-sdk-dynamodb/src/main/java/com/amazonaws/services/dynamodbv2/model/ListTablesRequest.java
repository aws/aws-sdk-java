 ...
 * </p>
 */
public class ListTablesRequest extends com.amazonaws.AmazonWebServiceRequest
     ...
     * </p>
     * 
     * @return The first table name that this operation will evaluate. Use the
     *         value that was returned for <i>LastEvaluatedTableName</i> in a
     *         previous operation, so that you can obtain the next page of
     *         results.
     */
    ...
    public String toString() {
        ...
        if (getExclusiveStartTableName() != null)
            sb.append("ExclusiveStartTableName: "
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getExclusiveStartTableName() == null
                ^ this.getExclusiveStartTableName() == null)
            return false;
        if (other.getExclusiveStartTableName() != null
                && other.getExclusiveStartTableName().equals(
                        this.getExclusiveStartTableName()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getExclusiveStartTableName() == null) ? 0
                        : getExclusiveStartTableName().hashCode());
