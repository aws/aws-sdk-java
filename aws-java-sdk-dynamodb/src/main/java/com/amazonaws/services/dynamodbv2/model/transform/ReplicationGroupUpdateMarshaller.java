...
@SdkInternalApi
public class ReplicationGroupUpdateMarshaller {
    ...
    private static final ReplicationGroupUpdateMarshaller instance = new ReplicationGroupUpdateMarshaller();

    public static ReplicationGroupUpdateMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ReplicationGroupUpdate replicationGroupUpdate, ProtocolMarshaller protocolMarshaller) {

        if (replicationGroupUpdate == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(replicationGroupUpdate.getCreate(), CREATE_BINDING);
            protocolMarshaller.marshall(replicationGroupUpdate.getUpdate(), UPDATE_BINDING);
            protocolMarshaller.marshall(replicationGroupUpdate.getDelete(), DELETE_BINDING);
        } catch (Exception e) {
