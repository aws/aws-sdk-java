...
/**
 * ReplicaAutoScalingDescriptionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ReplicaAutoScalingDescriptionMarshaller {
    ...
    private static final ReplicaAutoScalingDescriptionMarshaller instance = new ReplicaAutoScalingDescriptionMarshaller();

    public static ReplicaAutoScalingDescriptionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ReplicaAutoScalingDescription replicaAutoScalingDescription, ProtocolMarshaller protocolMarshaller) {

        if (replicaAutoScalingDescription == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(replicaAutoScalingDescription.getRegionName(), REGIONNAME_BINDING);
            protocolMarshaller.marshall(replicaAutoScalingDescription.getGlobalSecondaryIndexes(), GLOBALSECONDARYINDEXES_BINDING);
            protocolMarshaller.marshall(replicaAutoScalingDescription.getReplicaProvisionedReadCapacityAutoScalingSettings(),
                    REPLICAPROVISIONEDREADCAPACITYAUTOSCALINGSETTINGS_BINDING);
            protocolMarshaller.marshall(replicaAutoScalingDescription.getReplicaProvisionedWriteCapacityAutoScalingSettings(),
                    REPLICAPROVISIONEDWRITECAPACITYAUTOSCALINGSETTINGS_BINDING);
            protocolMarshaller.marshall(replicaAutoScalingDescription.getReplicaStatus(), REPLICASTATUS_BINDING);
        } catch (Exception e) {
