...
/**
 * ArchivalSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ArchivalSummaryJsonUnmarshaller implements Unmarshaller<ArchivalSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ArchivalDateTime", targetDepth)) {
                    context.nextToken();
                    archivalSummary.setArchivalDateTime(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
                if (context.testExpression("ArchivalReason", targetDepth)) {
                    context.nextToken();
                    archivalSummary.setArchivalReason(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ArchivalBackupArn", targetDepth)) {
                    context.nextToken();
                    archivalSummary.setArchivalBackupArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
