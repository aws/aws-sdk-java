...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.dynamodbv2.AmazonDynamoDBAsync}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonDynamoDBAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonDynamoDBAsyncClientBuilder, AmazonDynamoDBAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonDynamoDBAsync using the
