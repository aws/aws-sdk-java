...
/**
 * Interface for DynamoDBMapper. See the standard implementation {@link DynamoDBMapper} for the usage.
 *
 * @see DynamoDBMapper
 *
 */
public interface IDynamoDBMapper {
     ...
     */
    <T> List<T> marshallIntoObjects(Class<T> clazz,
     ...
     */
    <T extends Object> void save(T object,
            DynamoDBSaveExpression saveExpression, DynamoDBMapperConfig config);
     ...
     *            the object.
     */
    <T> void delete(T object, DynamoDBDeleteExpression deleteExpression,
            DynamoDBMapperConfig config);
     ...
     *         mapping that table.
     */
    Map<String, List<Object>> batchLoad(
