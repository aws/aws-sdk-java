...
/**
 * TransactWriteItemsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TransactWriteItemsResultJsonUnmarshaller implements Unmarshaller<TransactWriteItemsResult, JsonUnmarshallerContext> {

    public TransactWriteItemsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
