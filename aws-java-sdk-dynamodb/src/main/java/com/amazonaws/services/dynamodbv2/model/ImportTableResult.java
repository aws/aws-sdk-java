...
public class ImportTableResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ImportTableResult withImportTableDescription(ImportTableDescription importTableDescription) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportTableResult == false)
            return false;
        ImportTableResult other = (ImportTableResult) obj;
    ...
    @Override
    public ImportTableResult clone() {
        try {
            return (ImportTableResult) super.clone();
