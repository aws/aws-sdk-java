...
/**
 * TransactGetItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TransactGetItemJsonUnmarshaller implements Unmarshaller<TransactGetItem, JsonUnmarshallerContext> {

    public TransactGetItem unmarshall(JsonUnmarshallerContext context) throws Exception {
