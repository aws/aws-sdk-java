    ...
    public void marshall(ProvisionedThroughput provisionedThroughput, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (provisionedThroughput.getReadCapacityUnits() != null) {
                jsonGenerator.writeFieldName("ReadCapacityUnits").writeValue(provisionedThroughput.getReadCapacityUnits());
            }
            if (provisionedThroughput.getWriteCapacityUnits() != null) {
                jsonGenerator.writeFieldName("WriteCapacityUnits").writeValue(provisionedThroughput.getWriteCapacityUnits());
            }
