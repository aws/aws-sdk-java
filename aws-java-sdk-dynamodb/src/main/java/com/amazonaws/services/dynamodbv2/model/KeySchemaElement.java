 ...
 * primary key. For example, a hash type primary key would be represented
 * by one <i>KeySchemaElement</i> . A hash-and-range type primary key
 * would require one <i>KeySchemaElement</i> for the hash attribute, and
