...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.dynamodbv2.AmazonDynamoDBStreams}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonDynamoDBStreamsClientBuilder
        extends
        AwsSyncClientBuilder<AmazonDynamoDBStreamsClientBuilder, AmazonDynamoDBStreams> {
    ...
    /**
     * Construct a synchronous implementation of AmazonDynamoDBStreams using the
