...
@SdkInternalApi
public class DisableKinesisStreamingDestinationRequestMarshaller {
    ...
    public static DisableKinesisStreamingDestinationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DisableKinesisStreamingDestinationRequest disableKinesisStreamingDestinationRequest, ProtocolMarshaller protocolMarshaller) {

        if (disableKinesisStreamingDestinationRequest == null) {
