...
public class ContinuousBackupsDescriptionJsonUnmarshaller implements Unmarshaller<ContinuousBackupsDescription, JsonUnmarshallerContext> {

    public ContinuousBackupsDescription unmarshall(JsonUnmarshallerContext context) throws Exception {
