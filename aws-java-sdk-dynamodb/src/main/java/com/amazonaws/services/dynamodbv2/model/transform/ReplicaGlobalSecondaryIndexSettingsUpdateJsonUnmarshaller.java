...
public class ReplicaGlobalSecondaryIndexSettingsUpdateJsonUnmarshaller implements
        Unmarshaller<ReplicaGlobalSecondaryIndexSettingsUpdate, JsonUnmarshallerContext> {

    public ReplicaGlobalSecondaryIndexSettingsUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IndexName", targetDepth)) {
                    context.nextToken();
                    replicaGlobalSecondaryIndexSettingsUpdate.setIndexName(context.getUnmarshaller(String.class).unmarshall(context));
                }
