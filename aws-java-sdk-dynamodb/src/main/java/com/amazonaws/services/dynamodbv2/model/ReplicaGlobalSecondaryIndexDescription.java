 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ReplicaGlobalSecondaryIndexDescription"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReplicaGlobalSecondaryIndexDescription implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return If not described, uses the source table GSI's read capacity settings.
     */
    ...
    public ReplicaGlobalSecondaryIndexDescription clone() {
        try {
            return (ReplicaGlobalSecondaryIndexDescription) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.dynamodbv2.model.transform.ReplicaGlobalSecondaryIndexDescriptionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
