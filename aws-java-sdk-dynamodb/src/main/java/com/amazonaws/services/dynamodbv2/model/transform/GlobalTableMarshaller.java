...
/**
 * GlobalTableMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GlobalTableMarshaller {
    ...
    private static final GlobalTableMarshaller instance = new GlobalTableMarshaller();

    public static GlobalTableMarshaller getInstance() {
        return instance;
    }
