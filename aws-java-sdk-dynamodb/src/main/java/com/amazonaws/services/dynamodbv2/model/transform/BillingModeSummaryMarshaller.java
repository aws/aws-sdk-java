...
public class BillingModeSummaryMarshaller {
    ...
    private static final MarshallingInfo<java.util.Date> LASTUPDATETOPAYPERREQUESTDATETIME_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
