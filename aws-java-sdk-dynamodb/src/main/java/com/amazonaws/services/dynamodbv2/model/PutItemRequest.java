 ...
 * </p>
 */
public class PutItemRequest extends com.amazonaws.AmazonWebServiceRequest
     ...
     * </p>
     * 
     * @return A map of attribute name/value pairs, one for each attribute. Only
     *         the primary key attributes are required; you can optionally
     *         provide other attribute name-value pairs for the item.</p>
     *         <p>
     *         You must provide all of the attributes for the primary key. For
    ...
    public PutItemRequest addExpectedEntry(String key,
     ...
     *        Use <i>ReturnValues</i> if you want to get the item attributes as
     *        they appeared before they were updated with the <i>PutItem</i>
     *        request. For <i>PutItem</i>, the valid values are:</p>
     *        <ul>
     *        <li>
     *        <p>
     *        <code>NONE</code> - If <i>ReturnValues</i> is not specified, or if
     ...
     *        A condition that must be satisfied in order for a conditional
     *        <i>PutItem</i> operation to succeed.</p>
     *        <p>
     *        An expression can contain any of the following:
     *        </p>
     *        <ul>
    ...
    public PutItemRequest addExpressionAttributeNamesEntry(String key,
            String value) {
    ...
    public PutItemRequest addExpressionAttributeValuesEntry(String key,
