...
/**
 * UpdateGlobalTableSettingsResult JSON Unmarshaller
 */
...
public class UpdateGlobalTableSettingsResultJsonUnmarshaller implements Unmarshaller<UpdateGlobalTableSettingsResult, JsonUnmarshallerContext> {
    ...
    public UpdateGlobalTableSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GlobalTableName", targetDepth)) {
                    context.nextToken();
                    updateGlobalTableSettingsResult.setGlobalTableName(context.getUnmarshaller(String.class).unmarshall(context));
                }
