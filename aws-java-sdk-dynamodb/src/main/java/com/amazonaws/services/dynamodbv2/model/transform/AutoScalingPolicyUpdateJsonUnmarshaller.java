...
/**
 * AutoScalingPolicyUpdate JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AutoScalingPolicyUpdateJsonUnmarshaller implements Unmarshaller<AutoScalingPolicyUpdate, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PolicyName", targetDepth)) {
                    context.nextToken();
                    autoScalingPolicyUpdate.setPolicyName(context.getUnmarshaller(String.class).unmarshall(context));
                }
