...
public class ListImportsRequestMarshaller {
    ...
    public static ListImportsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListImportsRequest listImportsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listImportsRequest.getTableArn(), TABLEARN_BINDING);
            protocolMarshaller.marshall(listImportsRequest.getPageSize(), PAGESIZE_BINDING);
