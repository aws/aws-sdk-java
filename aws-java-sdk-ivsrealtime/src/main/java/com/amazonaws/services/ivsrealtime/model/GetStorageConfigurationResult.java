...
public class GetStorageConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The StorageConfiguration that was returned.
     */
    ...
    public GetStorageConfigurationResult withStorageConfiguration(StorageConfiguration storageConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetStorageConfigurationResult == false)
            return false;
        GetStorageConfigurationResult other = (GetStorageConfigurationResult) obj;
    ...
    @Override
    public GetStorageConfigurationResult clone() {
        try {
            return (GetStorageConfigurationResult) super.clone();
