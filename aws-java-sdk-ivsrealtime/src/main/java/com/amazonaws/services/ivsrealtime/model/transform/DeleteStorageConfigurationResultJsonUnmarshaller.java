...
/**
 * DeleteStorageConfigurationResult JSON Unmarshaller
 */
...
public class DeleteStorageConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteStorageConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteStorageConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteStorageConfigurationResult deleteStorageConfigurationResult = new DeleteStorageConfigurationResult();
