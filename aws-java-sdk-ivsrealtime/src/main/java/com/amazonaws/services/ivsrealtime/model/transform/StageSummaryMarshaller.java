...
public class StageSummaryMarshaller {
    ...
    private static final StageSummaryMarshaller instance = new StageSummaryMarshaller();

    public static StageSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StageSummary stageSummary, ProtocolMarshaller protocolMarshaller) {
