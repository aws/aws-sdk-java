...
/**
 * ListEncoderConfigurationsRequestMarshaller
 */
...
public class ListEncoderConfigurationsRequestMarshaller {
    ...
    public static ListEncoderConfigurationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListEncoderConfigurationsRequest listEncoderConfigurationsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listEncoderConfigurationsRequest == null) {
