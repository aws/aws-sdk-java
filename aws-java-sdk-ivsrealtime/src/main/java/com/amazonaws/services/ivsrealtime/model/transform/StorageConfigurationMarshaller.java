...
public class StorageConfigurationMarshaller {
    ...
    public void marshall(StorageConfiguration storageConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(storageConfiguration.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(storageConfiguration.getName(), NAME_BINDING);
            protocolMarshaller.marshall(storageConfiguration.getS3(), S3_BINDING);
            protocolMarshaller.marshall(storageConfiguration.getTags(), TAGS_BINDING);
        } catch (Exception e) {
