 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivs-realtime-2020-07-14/EncoderConfigurationSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EncoderConfigurationSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public EncoderConfigurationSummary withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see EncoderConfigurationSummary#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public EncoderConfigurationSummary addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EncoderConfigurationSummary == false)
            return false;
        EncoderConfigurationSummary other = (EncoderConfigurationSummary) obj;
    ...
    public EncoderConfigurationSummary clone() {
        try {
            return (EncoderConfigurationSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.ivsrealtime.model.transform.EncoderConfigurationSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
