 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivs-realtime-2020-07-14/StorageConfigurationSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StorageConfigurationSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public StorageConfigurationSummary withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see StorageConfigurationSummary#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public StorageConfigurationSummary addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StorageConfigurationSummary == false)
            return false;
        StorageConfigurationSummary other = (StorageConfigurationSummary) obj;
    ...
    public StorageConfigurationSummary clone() {
        try {
            return (StorageConfigurationSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.ivsrealtime.model.transform.StorageConfigurationSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
