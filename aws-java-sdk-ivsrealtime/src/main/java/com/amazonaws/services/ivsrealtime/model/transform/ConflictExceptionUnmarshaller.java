...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.ivsrealtime.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.ivsrealtime.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ivsrealtime.model.ConflictException conflictException = new com.amazonaws.services.ivsrealtime.model.ConflictException(null);
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("exceptionMessage", targetDepth)) {
                    context.nextToken();
                    conflictException.setExceptionMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
