 ...
 */
public class RemovePermissionResultJsonUnmarshaller implements
        Unmarshaller<RemovePermissionResult, JsonUnmarshallerContext> {

    public RemovePermissionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
