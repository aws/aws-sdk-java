...
/**
 * List Event Source Mappings Result JSON Unmarshaller
 */
public class ListEventSourceMappingsResultJsonUnmarshaller implements Unmarshaller<ListEventSourceMappingsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listEventSourceMappingsResult.setNextMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("EventSourceMappings", targetDepth)) {
                    context.nextToken();
                    listEventSourceMappingsResult.setEventSourceMappings(new ListUnmarshaller<EventSourceMappingConfiguration>(EventSourceMappingConfigurationJsonUnmarshaller.getInstance()).unmarshall(context));
                }
    ...
    public static ListEventSourceMappingsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListEventSourceMappingsResultJsonUnmarshaller();
        return instance;
    }
}
