...
public class ListProvisionedConcurrencyConfigsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListProvisionedConcurrencyConfigsRequest withMaxItems(Integer maxItems) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListProvisionedConcurrencyConfigsRequest == false)
            return false;
        ListProvisionedConcurrencyConfigsRequest other = (ListProvisionedConcurrencyConfigsRequest) obj;
    ...
    @Override
    public ListProvisionedConcurrencyConfigsRequest clone() {
        return (ListProvisionedConcurrencyConfigsRequest) super.clone();
    }
