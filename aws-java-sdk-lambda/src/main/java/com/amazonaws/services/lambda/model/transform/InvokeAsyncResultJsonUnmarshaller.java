 ...
 */
public class InvokeAsyncResultJsonUnmarshaller implements
        Unmarshaller<InvokeAsyncResult, JsonUnmarshallerContext> {

    public InvokeAsyncResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
