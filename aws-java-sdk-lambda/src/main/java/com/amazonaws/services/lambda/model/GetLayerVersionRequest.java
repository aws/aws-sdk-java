...
public class GetLayerVersionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetLayerVersionRequest withLayerName(String layerName) {
    ...
    public GetLayerVersionRequest withVersionNumber(Long versionNumber) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetLayerVersionRequest == false)
            return false;
    ...
    @Override
    public GetLayerVersionRequest clone() {
        return (GetLayerVersionRequest) super.clone();
    }
