...
/**
 * Get Policy Result JSON Unmarshaller
 */
public class GetPolicyResultJsonUnmarshaller implements Unmarshaller<GetPolicyResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Policy", targetDepth)) {
                    context.nextToken();
                    getPolicyResult.setPolicy(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static GetPolicyResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new GetPolicyResultJsonUnmarshaller();
        return instance;
    }
}
