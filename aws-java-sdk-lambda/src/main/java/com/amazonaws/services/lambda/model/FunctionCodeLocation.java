...
public class FunctionCodeLocation implements Serializable, Cloneable {
     ...
     * that you previously uploaded. The URL is valid for up to 10 minutes.
     *
     * @return The presigned URL you can use to download the function's .zip file
     *         that you previously uploaded. The URL is valid for up to 10 minutes.
     */
     ...
     * that you previously uploaded. The URL is valid for up to 10 minutes.
     *
     * @param location The presigned URL you can use to download the function's .zip file
     *         that you previously uploaded. The URL is valid for up to 10 minutes.
     */
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getRepositoryType() != null) sb.append("RepositoryType: " + getRepositoryType() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FunctionCodeLocation == false) return false;
        FunctionCodeLocation other = (FunctionCodeLocation)obj;
        
        if (other.getRepositoryType() == null ^ this.getRepositoryType() == null) return false;
        if (other.getRepositoryType() != null && other.getRepositoryType().equals(this.getRepositoryType()) == false) return false; 
