...
public class GetPolicyRequestMarshaller implements
    ...
    public Request<GetPolicyRequest> marshall(GetPolicyRequest getPolicyRequest) {
        ...
        uriResourcePath = uriResourcePath.replace(
                "{FunctionName}",
                (getPolicyRequest.getFunctionName() != null) ? StringUtils
                        .fromString(getPolicyRequest.getFunctionName()) : "");
        request.setResourcePath(uriResourcePath);

        if (getPolicyRequest.getQualifier() != null) {
            request.addParameter("Qualifier",
                    StringUtils.fromString(getPolicyRequest.getQualifier()));
        }
