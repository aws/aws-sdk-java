...
public class VpcConfigJsonMarshaller {
     ...
     */
    public void marshall(VpcConfig vpcConfig,
        ...
        try {
            ...
            com.amazonaws.internal.SdkInternalList<String> subnetIdsList = (com.amazonaws.internal.SdkInternalList<String>) vpcConfig
                    .getSubnetIds();
