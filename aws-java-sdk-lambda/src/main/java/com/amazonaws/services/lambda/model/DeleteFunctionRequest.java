 ...
 * 
 */
public class DeleteFunctionRequest extends AmazonWebServiceRequest implements
     ...
     * example,
     * <code>arn:aws:lambda:us-west-2:account-id:function:ThumbNail</code>). If
     ...
     * the <code>$LATEST</code> version) to direct AWS Lambda to delete a
     ...
     * <code>$LATEST</code>, that is, you cannot specify <code>$LATEST</code> as
     * the value of this parameter. The <code>$LATEST</code> version can be
     ...
     *        <code>account-id:Thumbnail</code>). Note that the length
     ...
     *        (but not the <code>$LATEST</code> version) to direct AWS Lambda to
     ...
     *        function version but not the <code>$LATEST</code>, that is, you
     *        cannot specify <code>$LATEST</code> as the value of this
     *        parameter. The <code>$LATEST</code> version can be deleted only
     ...
     *         (but not the <code>$LATEST</code> version) to direct AWS Lambda
     ...
     *         any function version but not the <code>$LATEST</code>, that is,
     *         you cannot specify <code>$LATEST</code> as the value of this
     *         parameter. The <code>$LATEST</code> version can be deleted only
