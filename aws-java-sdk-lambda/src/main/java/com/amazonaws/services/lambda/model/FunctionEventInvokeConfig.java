...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/lambda-2015-03-31/FunctionEventInvokeConfig" target="_top">AWS
 *      API Documentation</a>
 */
...
public class FunctionEventInvokeConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public FunctionEventInvokeConfig withLastModified(java.util.Date lastModified) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FunctionEventInvokeConfig == false)
            return false;
        FunctionEventInvokeConfig other = (FunctionEventInvokeConfig) obj;
    ...
    @Override
    public FunctionEventInvokeConfig clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lambda.model.transform.FunctionEventInvokeConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
