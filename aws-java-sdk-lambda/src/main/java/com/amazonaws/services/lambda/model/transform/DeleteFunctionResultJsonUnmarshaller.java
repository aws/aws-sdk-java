 ...
 */
public class DeleteFunctionResultJsonUnmarshaller implements
        Unmarshaller<DeleteFunctionResult, JsonUnmarshallerContext> {

    public DeleteFunctionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
