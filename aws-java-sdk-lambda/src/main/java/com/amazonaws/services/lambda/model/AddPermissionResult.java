...
public class AddPermissionResult implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getStatement() != null) sb.append("Statement: " + getStatement() );
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddPermissionResult == false) return false;
        AddPermissionResult other = (AddPermissionResult)obj;
        
        if (other.getStatement() == null ^ this.getStatement() == null) return false;
        if (other.getStatement() != null && other.getStatement().equals(this.getStatement()) == false) return false; 
        return true;
    }
