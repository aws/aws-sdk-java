...
class FunctionUpdated {
    ...
    static class IsSuccessfulMatcher extends WaiterAcceptor<GetFunctionConfigurationResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("LastUpdateStatus");
         ...
         */
        @Override
        public boolean matches(GetFunctionConfigurationResult result) {
    ...
    static class IsFailedMatcher extends WaiterAcceptor<GetFunctionConfigurationResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsInProgressMatcher extends WaiterAcceptor<GetFunctionConfigurationResult> {
        private static final JsonNode expectedResult;
