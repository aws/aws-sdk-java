...
public class InvalidSecurityGroupIDExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    invalidSecurityGroupIDException.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static InvalidSecurityGroupIDExceptionUnmarshaller instance;

    public static InvalidSecurityGroupIDExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSecurityGroupIDExceptionUnmarshaller();
        return instance;
    }
}
