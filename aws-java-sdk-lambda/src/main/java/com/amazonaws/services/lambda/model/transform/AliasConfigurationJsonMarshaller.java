...
public class AliasConfigurationJsonMarshaller {
     ...
     */
    public void marshall(AliasConfiguration aliasConfiguration,
        ...
        try {
            ...
            if (aliasConfiguration.getAliasArn() != null) {
                jsonGenerator.writeFieldName("AliasArn").writeValue(
                        aliasConfiguration.getAliasArn());
            }
            if (aliasConfiguration.getName() != null) {
                jsonGenerator.writeFieldName("Name").writeValue(
                        aliasConfiguration.getName());
            }
            if (aliasConfiguration.getFunctionVersion() != null) {
                jsonGenerator.writeFieldName("FunctionVersion").writeValue(
                        aliasConfiguration.getFunctionVersion());
            }
            if (aliasConfiguration.getDescription() != null) {
                jsonGenerator.writeFieldName("Description").writeValue(
                        aliasConfiguration.getDescription());
            }
