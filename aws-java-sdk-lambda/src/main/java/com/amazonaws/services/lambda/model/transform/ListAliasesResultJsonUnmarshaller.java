...
/**
 * List Aliases Result JSON Unmarshaller
 */
public class ListAliasesResultJsonUnmarshaller implements Unmarshaller<ListAliasesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listAliasesResult.setNextMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Aliases", targetDepth)) {
                    context.nextToken();
                    listAliasesResult.setAliases(new ListUnmarshaller<AliasConfiguration>(AliasConfigurationJsonUnmarshaller.getInstance()).unmarshall(context));
                }
    ...
    public static ListAliasesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListAliasesResultJsonUnmarshaller();
        return instance;
    }
}
