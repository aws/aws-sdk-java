...
public class FunctionCodeLocationJsonMarshaller {
     ...
     */
    public void marshall(FunctionCodeLocation functionCodeLocation,
        ...
        try {
            ...
            if (functionCodeLocation.getRepositoryType() != null) {
                jsonGenerator.writeFieldName("RepositoryType").writeValue(
                        functionCodeLocation.getRepositoryType());
            }
            if (functionCodeLocation.getLocation() != null) {
                jsonGenerator.writeFieldName("Location").writeValue(
                        functionCodeLocation.getLocation());
            }
