...
/**
 * Add Permission Result JSON Unmarshaller
 */
public class AddPermissionResultJsonUnmarshaller implements Unmarshaller<AddPermissionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Statement", targetDepth)) {
                    context.nextToken();
                    addPermissionResult.setStatement(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static AddPermissionResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new AddPermissionResultJsonUnmarshaller();
        return instance;
    }
}
