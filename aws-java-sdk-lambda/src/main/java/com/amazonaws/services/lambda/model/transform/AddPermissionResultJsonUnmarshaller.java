 ...
 */
public class AddPermissionResultJsonUnmarshaller implements
        Unmarshaller<AddPermissionResult, JsonUnmarshallerContext> {

    public AddPermissionResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Statement", targetDepth)) {
                    context.nextToken();
                    addPermissionResult.setStatement(context.getUnmarshaller(
