 ...
 */
public class CreateEventSourceMappingResultJsonUnmarshaller implements
        Unmarshaller<CreateEventSourceMappingResult, JsonUnmarshallerContext> {

    public CreateEventSourceMappingResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UUID", targetDepth)) {
                    context.nextToken();
                    createEventSourceMappingResult.setUUID(context
                ...
                if (context.testExpression("EventSourceArn", targetDepth)) {
                    context.nextToken();
                    createEventSourceMappingResult.setEventSourceArn(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("FunctionArn", targetDepth)) {
                    context.nextToken();
                    createEventSourceMappingResult.setFunctionArn(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("LastModified", targetDepth)) {
                    context.nextToken();
                    createEventSourceMappingResult.setLastModified(context
                ...
                if (context.testExpression("State", targetDepth)) {
                    context.nextToken();
                    createEventSourceMappingResult.setState(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
                if (context
