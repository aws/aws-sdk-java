...
public class CreateCodeSigningConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateCodeSigningConfigResult withCodeSigningConfig(CodeSigningConfig codeSigningConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCodeSigningConfigResult == false)
            return false;
        CreateCodeSigningConfigResult other = (CreateCodeSigningConfigResult) obj;
    ...
    @Override
    public CreateCodeSigningConfigResult clone() {
        try {
            return (CreateCodeSigningConfigResult) super.clone();
