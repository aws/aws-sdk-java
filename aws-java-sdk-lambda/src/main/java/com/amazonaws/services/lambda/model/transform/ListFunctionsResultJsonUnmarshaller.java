 ...
 */
public class ListFunctionsResultJsonUnmarshaller implements
        Unmarshaller<ListFunctionsResult, JsonUnmarshallerContext> {

    public ListFunctionsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listFunctionsResult.setNextMarker(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("Functions", targetDepth)) {
                    context.nextToken();
                    listFunctionsResult
                            .setFunctions(new ListUnmarshaller<FunctionConfiguration>(
