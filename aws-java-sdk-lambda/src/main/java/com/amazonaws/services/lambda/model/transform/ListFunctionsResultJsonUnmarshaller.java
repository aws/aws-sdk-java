...
/**
 * List Functions Result JSON Unmarshaller
 */
public class ListFunctionsResultJsonUnmarshaller implements Unmarshaller<ListFunctionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listFunctionsResult.setNextMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Functions", targetDepth)) {
                    context.nextToken();
                    listFunctionsResult.setFunctions(new ListUnmarshaller<FunctionConfiguration>(FunctionConfigurationJsonUnmarshaller.getInstance()).unmarshall(context));
                }
    ...
    public static ListFunctionsResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListFunctionsResultJsonUnmarshaller();
        return instance;
    }
}
