...
public class DeleteFunctionRequestMarshaller implements
    ...
    public Request<DeleteFunctionRequest> marshall(
        ...
        Request<DeleteFunctionRequest> request = new DefaultRequest<DeleteFunctionRequest>(
                deleteFunctionRequest, "AWSLambda");
        ...
        if (deleteFunctionRequest.getQualifier() != null) {
            request.addParameter("Qualifier", StringUtils
                    .fromString(deleteFunctionRequest.getQualifier()));
        }
