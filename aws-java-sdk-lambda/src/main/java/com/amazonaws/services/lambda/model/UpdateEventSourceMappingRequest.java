 ...
 * 
 */
public class UpdateEventSourceMappingRequest extends AmazonWebServiceRequest
     ...
     *        example, <code>account-id:Thumbnail</code>).
     *        </p>
     *        <p>
     ...
     * </p>
     * 
     * @return The Lambda function to which you want the stream records
     *         sent.</p>
     *         <p>
     *         You can specify a function name (for example,
     *         <code>Thumbnail</code>) or you can specify Amazon Resource Name
     ...
     *        not. If disabled, AWS Lambda will not poll the stream.
     */
     ...
     * </p>
     * 
     * @return Specifies whether AWS Lambda should actively poll the stream or
     *         not. If disabled, AWS Lambda will not poll the stream.
     */
     ...
     *        Lambda function for a single invocation.
     */
     ...
     * </p>
     * 
     * @return The maximum number of stream records that can be sent to your
     *         Lambda function for a single invocation.
     */
