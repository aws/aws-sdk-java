...
public class UpdateFunctionConfigurationResult implements Serializable,
    ...
    public UpdateFunctionConfigurationResult withFunctionName(
            String functionName) {
    ...
    public UpdateFunctionConfigurationResult withLastModified(
            String lastModified) {
    ...
    public UpdateFunctionConfigurationResult withVpcConfig(
