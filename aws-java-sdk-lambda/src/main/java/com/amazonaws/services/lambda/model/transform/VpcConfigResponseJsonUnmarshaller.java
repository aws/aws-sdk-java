 ...
 */
public class VpcConfigResponseJsonUnmarshaller implements
        Unmarshaller<VpcConfigResponse, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("VpcId", targetDepth)) {
                    context.nextToken();
                    vpcConfigResponse.setVpcId(context.getUnmarshaller(
