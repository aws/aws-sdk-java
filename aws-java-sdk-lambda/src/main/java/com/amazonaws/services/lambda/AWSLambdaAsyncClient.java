...
public class AWSLambdaAsyncClient extends AWSLambdaClient implements
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on AWS
     * Lambda using the specified parameters.
     *
    ...
    public java.util.concurrent.Future<CreateEventSourceMappingResult> createEventSourceMappingAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateEventSourceMappingResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<CreateFunctionResult> createFunctionAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateFunctionResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<DeleteEventSourceMappingResult> deleteEventSourceMappingAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DeleteEventSourceMappingResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<GetAliasResult> getAliasAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetAliasResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<GetEventSourceMappingResult> getEventSourceMappingAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetEventSourceMappingResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<GetFunctionResult> getFunctionAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetFunctionResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<GetFunctionConfigurationResult> getFunctionConfigurationAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<GetFunctionConfigurationResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<InvokeResult> invokeAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<InvokeResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<InvokeAsyncResult> invokeAsyncAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<InvokeAsyncResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ListEventSourceMappingsResult> listEventSourceMappingsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListEventSourceMappingsResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ListFunctionsResult> listFunctionsAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListFunctionsResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<ListVersionsByFunctionResult> listVersionsByFunctionAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<ListVersionsByFunctionResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<PublishVersionResult> publishVersionAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<PublishVersionResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<UpdateEventSourceMappingResult> updateEventSourceMappingAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UpdateEventSourceMappingResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<UpdateFunctionCodeResult> updateFunctionCodeAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UpdateFunctionCodeResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<UpdateFunctionConfigurationResult> updateFunctionConfigurationAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<UpdateFunctionConfigurationResult>() {
                    @Override
