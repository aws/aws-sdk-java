...
@SdkInternalApi
public class CreateFunctionUrlConfigRequestMarshaller {
    ...
    public static CreateFunctionUrlConfigRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateFunctionUrlConfigRequest createFunctionUrlConfigRequest, ProtocolMarshaller protocolMarshaller) {

        if (createFunctionUrlConfigRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createFunctionUrlConfigRequest.getFunctionName(), FUNCTIONNAME_BINDING);
