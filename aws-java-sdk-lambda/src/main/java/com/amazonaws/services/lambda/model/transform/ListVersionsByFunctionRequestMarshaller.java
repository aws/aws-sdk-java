...
public class ListVersionsByFunctionRequestMarshaller
    ...
    public Request<ListVersionsByFunctionRequest> marshall(
        ...
        Request<ListVersionsByFunctionRequest> request = new DefaultRequest<ListVersionsByFunctionRequest>(
                listVersionsByFunctionRequest, "AWSLambda");
        ...
        uriResourcePath = uriResourcePath
                .replace(
                        "{FunctionName}",
                        (listVersionsByFunctionRequest.getFunctionName() != null) ? StringUtils
                                .fromString(listVersionsByFunctionRequest
                                        .getFunctionName()) : "");
        request.setResourcePath(uriResourcePath);

        if (listVersionsByFunctionRequest.getMarker() != null) {
            request.addParameter("Marker", StringUtils
                    .fromString(listVersionsByFunctionRequest.getMarker()));
        }

        if (listVersionsByFunctionRequest.getMaxItems() != null) {
            request.addParameter("MaxItems", StringUtils
                    .fromInteger(listVersionsByFunctionRequest.getMaxItems()));
        }
