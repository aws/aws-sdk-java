...
public class TooManyRequestsExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.lambda.model.TooManyRequestsException> {
    private TooManyRequestsExceptionUnmarshaller() {
        super("TooManyRequestsException");
    }

    @Override
    public com.amazonaws.services.lambda.model.TooManyRequestsException unmarshall(JsonUnmarshallerContext context) throws Exception {
