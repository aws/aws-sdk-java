...
/**
 * List Versions By Function Result JSON Unmarshaller
 */
public class ListVersionsByFunctionResultJsonUnmarshaller implements Unmarshaller<ListVersionsByFunctionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextMarker", targetDepth)) {
                    context.nextToken();
                    listVersionsByFunctionResult.setNextMarker(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Versions", targetDepth)) {
                    context.nextToken();
                    listVersionsByFunctionResult.setVersions(new ListUnmarshaller<FunctionConfiguration>(FunctionConfigurationJsonUnmarshaller.getInstance()).unmarshall(context));
                }
    ...
    public static ListVersionsByFunctionResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ListVersionsByFunctionResultJsonUnmarshaller();
        return instance;
    }
}
