...
public interface AWSLambdaAsync extends AWSLambda {
     ...
     */
    java.util.concurrent.Future<CreateEventSourceMappingResult> createEventSourceMappingAsync(
     ...
     */
    java.util.concurrent.Future<CreateFunctionResult> createFunctionAsync(
     ...
     */
    java.util.concurrent.Future<DeleteEventSourceMappingResult> deleteEventSourceMappingAsync(
     ...
     */
    java.util.concurrent.Future<GetAliasResult> getAliasAsync(
     ...
     */
    java.util.concurrent.Future<GetEventSourceMappingResult> getEventSourceMappingAsync(
     ...
     */
    java.util.concurrent.Future<GetFunctionResult> getFunctionAsync(
     ...
     */
    java.util.concurrent.Future<GetFunctionConfigurationResult> getFunctionConfigurationAsync(
     ...
     */
    java.util.concurrent.Future<InvokeResult> invokeAsync(
     ...
     */
    @Deprecated
    java.util.concurrent.Future<InvokeAsyncResult> invokeAsyncAsync(
     ...
     */
    java.util.concurrent.Future<ListVersionsByFunctionResult> listVersionsByFunctionAsync(
     ...
     */
    java.util.concurrent.Future<PublishVersionResult> publishVersionAsync(
     ...
     */
    java.util.concurrent.Future<UpdateEventSourceMappingResult> updateEventSourceMappingAsync(
     ...
     */
    java.util.concurrent.Future<UpdateFunctionCodeResult> updateFunctionCodeAsync(
