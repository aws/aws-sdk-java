...
public class GetFunctionCodeSigningConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetFunctionCodeSigningConfigResult == false)
            return false;
        GetFunctionCodeSigningConfigResult other = (GetFunctionCodeSigningConfigResult) obj;
    ...
    public GetFunctionCodeSigningConfigResult clone() {
        try {
            return (GetFunctionCodeSigningConfigResult) super.clone();
