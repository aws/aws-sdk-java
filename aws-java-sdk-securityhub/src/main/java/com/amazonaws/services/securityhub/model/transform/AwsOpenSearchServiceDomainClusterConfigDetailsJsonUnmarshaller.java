...
/**
 * AwsOpenSearchServiceDomainClusterConfigDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsOpenSearchServiceDomainClusterConfigDetailsJsonUnmarshaller implements
        Unmarshaller<AwsOpenSearchServiceDomainClusterConfigDetails, JsonUnmarshallerContext> {

    public AwsOpenSearchServiceDomainClusterConfigDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsOpenSearchServiceDomainClusterConfigDetails awsOpenSearchServiceDomainClusterConfigDetails = new AwsOpenSearchServiceDomainClusterConfigDetails();
    ...
    private static AwsOpenSearchServiceDomainClusterConfigDetailsJsonUnmarshaller instance;

    public static AwsOpenSearchServiceDomainClusterConfigDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsOpenSearchServiceDomainClusterConfigDetailsJsonUnmarshaller();
        return instance;
    }
}
