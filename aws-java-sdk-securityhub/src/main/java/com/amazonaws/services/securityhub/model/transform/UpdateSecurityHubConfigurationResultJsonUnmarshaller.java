...
/**
 * UpdateSecurityHubConfigurationResult JSON Unmarshaller
 */
...
public class UpdateSecurityHubConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateSecurityHubConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateSecurityHubConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateSecurityHubConfigurationResult updateSecurityHubConfigurationResult = new UpdateSecurityHubConfigurationResult();

        return updateSecurityHubConfigurationResult;
    }
