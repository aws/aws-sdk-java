...
/**
 * AwsBackupRecoveryPointCreatedByDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsBackupRecoveryPointCreatedByDetailsJsonUnmarshaller implements Unmarshaller<AwsBackupRecoveryPointCreatedByDetails, JsonUnmarshallerContext> {

    public AwsBackupRecoveryPointCreatedByDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsBackupRecoveryPointCreatedByDetails awsBackupRecoveryPointCreatedByDetails = new AwsBackupRecoveryPointCreatedByDetails();
    ...
    private static AwsBackupRecoveryPointCreatedByDetailsJsonUnmarshaller instance;

    public static AwsBackupRecoveryPointCreatedByDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsBackupRecoveryPointCreatedByDetailsJsonUnmarshaller();
        return instance;
    }
}
