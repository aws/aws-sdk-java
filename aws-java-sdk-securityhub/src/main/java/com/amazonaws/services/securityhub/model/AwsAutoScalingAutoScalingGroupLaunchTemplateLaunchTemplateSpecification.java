 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification == false)
            return false;
        AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification other = (AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification) obj;
    ...
    public AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification clone() {
        try {
            return (AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecificationMarshaller.getInstance()
