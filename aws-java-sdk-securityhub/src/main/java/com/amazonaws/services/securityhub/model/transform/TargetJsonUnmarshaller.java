        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AccountId", targetDepth)) {
                    context.nextToken();
                    target.setAccountId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("OrganizationalUnitId", targetDepth)) {
                    context.nextToken();
                    target.setOrganizationalUnitId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RootId", targetDepth)) {
                    context.nextToken();
                    target.setRootId(context.getUnmarshaller(String.class).unmarshall(context));
                }
