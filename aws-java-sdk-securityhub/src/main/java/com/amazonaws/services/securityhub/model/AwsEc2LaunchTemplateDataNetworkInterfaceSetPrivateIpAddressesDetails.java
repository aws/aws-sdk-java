 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails == false)
            return false;
        AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails other = (AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails) obj;
    ...
    public AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails clone() {
        try {
            return (AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsEc2LaunchTemplateDataNetworkInterfaceSetPrivateIpAddressesDetailsMarshaller.getInstance()
