...
@SdkInternalApi
public class AwsBackupBackupPlanDetailsMarshaller {
    ...
    private static final AwsBackupBackupPlanDetailsMarshaller instance = new AwsBackupBackupPlanDetailsMarshaller();

    public static AwsBackupBackupPlanDetailsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AwsBackupBackupPlanDetails awsBackupBackupPlanDetails, ProtocolMarshaller protocolMarshaller) {

        if (awsBackupBackupPlanDetails == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(awsBackupBackupPlanDetails.getBackupPlan(), BACKUPPLAN_BINDING);
            protocolMarshaller.marshall(awsBackupBackupPlanDetails.getBackupPlanArn(), BACKUPPLANARN_BINDING);
            protocolMarshaller.marshall(awsBackupBackupPlanDetails.getBackupPlanId(), BACKUPPLANID_BINDING);
            protocolMarshaller.marshall(awsBackupBackupPlanDetails.getVersionId(), VERSIONID_BINDING);
        } catch (Exception e) {
