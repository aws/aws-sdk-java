...
/**
 * AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetailsJsonUnmarshaller implements
        Unmarshaller<AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails, JsonUnmarshallerContext> {

    public AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails awsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails = new AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetails();
    ...
    private static AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetailsJsonUnmarshaller instance;

    public static AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetailsJsonUnmarshaller();
        return instance;
    }
}
