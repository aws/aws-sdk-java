 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsRedshiftClusterVpcSecurityGroup"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsRedshiftClusterVpcSecurityGroup implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsRedshiftClusterVpcSecurityGroup == false)
            return false;
    ...
    @Override
    public AwsRedshiftClusterVpcSecurityGroup clone() {
        try {
            return (AwsRedshiftClusterVpcSecurityGroup) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsRedshiftClusterVpcSecurityGroupMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
