...
/**
 * DeleteMembersResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteMembersResultJsonUnmarshaller implements Unmarshaller<DeleteMembersResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UnprocessedAccounts", targetDepth)) {
                    context.nextToken();
                    deleteMembersResult.setUnprocessedAccounts(new ListUnmarshaller<Result>(ResultJsonUnmarshaller.getInstance()).unmarshall(context));
                }
