 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/RuleGroupSourceStatelessRuleMatchAttributesDestinations"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RuleGroupSourceStatelessRuleMatchAttributesDestinations implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RuleGroupSourceStatelessRuleMatchAttributesDestinations == false)
            return false;
    ...
    @Override
    public RuleGroupSourceStatelessRuleMatchAttributesDestinations clone() {
        try {
            return (RuleGroupSourceStatelessRuleMatchAttributesDestinations) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.RuleGroupSourceStatelessRuleMatchAttributesDestinationsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
