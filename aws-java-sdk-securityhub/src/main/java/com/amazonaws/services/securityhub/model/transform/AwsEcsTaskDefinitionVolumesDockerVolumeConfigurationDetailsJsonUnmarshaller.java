...
/**
 * AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetailsJsonUnmarshaller implements
        Unmarshaller<AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetails, JsonUnmarshallerContext> {

    public AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetails awsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetails = new AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetails();
    ...
    private static AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetailsJsonUnmarshaller instance;

    public static AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetailsJsonUnmarshaller();
        return instance;
    }
}
