 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/VpcInfoCidrBlockSetDetails"
...
public class VpcInfoCidrBlockSetDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VpcInfoCidrBlockSetDetails == false)
            return false;
        VpcInfoCidrBlockSetDetails other = (VpcInfoCidrBlockSetDetails) obj;
    ...
    @Override
    public VpcInfoCidrBlockSetDetails clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.VpcInfoCidrBlockSetDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
