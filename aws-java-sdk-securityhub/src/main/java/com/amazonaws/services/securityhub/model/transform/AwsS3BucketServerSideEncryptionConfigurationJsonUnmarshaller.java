...
/**
 * AwsS3BucketServerSideEncryptionConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsS3BucketServerSideEncryptionConfigurationJsonUnmarshaller implements
        Unmarshaller<AwsS3BucketServerSideEncryptionConfiguration, JsonUnmarshallerContext> {

    public AwsS3BucketServerSideEncryptionConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
