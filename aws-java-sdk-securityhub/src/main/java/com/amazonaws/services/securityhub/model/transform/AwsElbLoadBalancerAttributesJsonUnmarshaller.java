...
/**
 * AwsElbLoadBalancerAttributes JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsElbLoadBalancerAttributesJsonUnmarshaller implements Unmarshaller<AwsElbLoadBalancerAttributes, JsonUnmarshallerContext> {

    public AwsElbLoadBalancerAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsElbLoadBalancerAttributes awsElbLoadBalancerAttributes = new AwsElbLoadBalancerAttributes();
    ...
    private static AwsElbLoadBalancerAttributesJsonUnmarshaller instance;

    public static AwsElbLoadBalancerAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsElbLoadBalancerAttributesJsonUnmarshaller();
        return instance;
    }
}
