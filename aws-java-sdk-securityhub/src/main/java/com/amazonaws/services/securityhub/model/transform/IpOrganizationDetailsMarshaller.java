...
/**
 * IpOrganizationDetailsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class IpOrganizationDetailsMarshaller {
    ...
    private static final IpOrganizationDetailsMarshaller instance = new IpOrganizationDetailsMarshaller();

    public static IpOrganizationDetailsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(IpOrganizationDetails ipOrganizationDetails, ProtocolMarshaller protocolMarshaller) {

        if (ipOrganizationDetails == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(ipOrganizationDetails.getAsn(), ASN_BINDING);
            protocolMarshaller.marshall(ipOrganizationDetails.getAsnOrg(), ASNORG_BINDING);
            protocolMarshaller.marshall(ipOrganizationDetails.getIsp(), ISP_BINDING);
            protocolMarshaller.marshall(ipOrganizationDetails.getOrg(), ORG_BINDING);
        } catch (Exception e) {
