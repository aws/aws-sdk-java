...
@SdkInternalApi
public class FilePathsMarshaller {
    ...
    private static final FilePathsMarshaller instance = new FilePathsMarshaller();

    public static FilePathsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FilePaths filePaths, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(filePaths.getFilePath(), FILEPATH_BINDING);
            protocolMarshaller.marshall(filePaths.getFileName(), FILENAME_BINDING);
            protocolMarshaller.marshall(filePaths.getResourceId(), RESOURCEID_BINDING);
            protocolMarshaller.marshall(filePaths.getHash(), HASH_BINDING);
        } catch (Exception e) {
