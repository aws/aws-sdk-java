...
/**
 * UpdateSecurityControlResult JSON Unmarshaller
 */
...
public class UpdateSecurityControlResultJsonUnmarshaller implements Unmarshaller<UpdateSecurityControlResult, JsonUnmarshallerContext> {
    ...
    public UpdateSecurityControlResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateSecurityControlResult updateSecurityControlResult = new UpdateSecurityControlResult();

        return updateSecurityControlResult;
    }
