 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEc2VpcPeeringConnectionVpcInfoDetails"
...
public class AwsEc2VpcPeeringConnectionVpcInfoDetails implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<VpcInfoCidrBlockSetDetails> cidrBlockSet;
    /**
     * <p>
     * The IPv6 CIDR block for the VPC.
     * </p>
     */
    private java.util.List<VpcInfoIpv6CidrBlockSetDetails> ipv6CidrBlockSet;
    /**
     * <p>
    ...
    public java.util.List<VpcInfoCidrBlockSetDetails> getCidrBlockSet() {
        return cidrBlockSet;
    }
    ...
    public void setCidrBlockSet(java.util.Collection<VpcInfoCidrBlockSetDetails> cidrBlockSet) {
        if (cidrBlockSet == null) {
            this.cidrBlockSet = null;
            return;
        }

        this.cidrBlockSet = new java.util.ArrayList<VpcInfoCidrBlockSetDetails>(cidrBlockSet);
    }
    ...
    public AwsEc2VpcPeeringConnectionVpcInfoDetails withCidrBlockSet(VpcInfoCidrBlockSetDetails... cidrBlockSet) {
        if (this.cidrBlockSet == null) {
            setCidrBlockSet(new java.util.ArrayList<VpcInfoCidrBlockSetDetails>(cidrBlockSet.length));
        }
        for (VpcInfoCidrBlockSetDetails ele : cidrBlockSet) {
    ...
    public AwsEc2VpcPeeringConnectionVpcInfoDetails withCidrBlockSet(java.util.Collection<VpcInfoCidrBlockSetDetails> cidrBlockSet) {
    ...
    public java.util.List<VpcInfoIpv6CidrBlockSetDetails> getIpv6CidrBlockSet() {
    ...
    public void setIpv6CidrBlockSet(java.util.Collection<VpcInfoIpv6CidrBlockSetDetails> ipv6CidrBlockSet) {
        if (ipv6CidrBlockSet == null) {
            this.ipv6CidrBlockSet = null;
            return;
        }

        this.ipv6CidrBlockSet = new java.util.ArrayList<VpcInfoIpv6CidrBlockSetDetails>(ipv6CidrBlockSet);
    }
    ...
    public AwsEc2VpcPeeringConnectionVpcInfoDetails withIpv6CidrBlockSet(VpcInfoIpv6CidrBlockSetDetails... ipv6CidrBlockSet) {
        if (this.ipv6CidrBlockSet == null) {
            setIpv6CidrBlockSet(new java.util.ArrayList<VpcInfoIpv6CidrBlockSetDetails>(ipv6CidrBlockSet.length));
        }
        for (VpcInfoIpv6CidrBlockSetDetails ele : ipv6CidrBlockSet) {
    ...
    public AwsEc2VpcPeeringConnectionVpcInfoDetails withIpv6CidrBlockSet(java.util.Collection<VpcInfoIpv6CidrBlockSetDetails> ipv6CidrBlockSet) {
    ...
    public void setPeeringOptions(VpcInfoPeeringOptionsDetails peeringOptions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsEc2VpcPeeringConnectionVpcInfoDetails == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsEc2VpcPeeringConnectionVpcInfoDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
