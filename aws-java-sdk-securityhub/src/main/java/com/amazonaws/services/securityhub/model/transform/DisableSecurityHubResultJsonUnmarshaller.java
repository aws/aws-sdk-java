...
/**
 * DisableSecurityHubResult JSON Unmarshaller
 */
...
public class DisableSecurityHubResultJsonUnmarshaller implements Unmarshaller<DisableSecurityHubResult, JsonUnmarshallerContext> {
    ...
    public DisableSecurityHubResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisableSecurityHubResult disableSecurityHubResult = new DisableSecurityHubResult();
