...
public class ResourceNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.securityhub.model.ResourceNotFoundException> {
    private ResourceNotFoundExceptionUnmarshaller() {
        super("ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.securityhub.model.ResourceNotFoundException unmarshall(JsonUnmarshallerContext context) throws Exception {
