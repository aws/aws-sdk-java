...
public class StandardMarshaller {
    ...
    public static StandardMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Standard standard, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(standard.getStandardsArn(), STANDARDSARN_BINDING);
