 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEcsTaskDefinitionContainerDefinitionsMountPointsDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEcsTaskDefinitionContainerDefinitionsMountPointsDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The name of the volume to mount. Must match the name of a volume listed in <code>VolumeDetails</code> for the
     * task definition.
     * </p>
     */
     ...
     * 
     * @param sourceVolume
     *        The name of the volume to mount. Must match the name of a volume listed in <code>VolumeDetails</code> for
     *        the task definition.
     */
     ...
     * </p>
     * 
     * @return The name of the volume to mount. Must match the name of a volume listed in <code>VolumeDetails</code> for
     *         the task definition.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsEcsTaskDefinitionContainerDefinitionsMountPointsDetails == false)
            return false;
        AwsEcsTaskDefinitionContainerDefinitionsMountPointsDetails other = (AwsEcsTaskDefinitionContainerDefinitionsMountPointsDetails) obj;
    ...
    @Override
    public AwsEcsTaskDefinitionContainerDefinitionsMountPointsDetails clone() {
        try {
            return (AwsEcsTaskDefinitionContainerDefinitionsMountPointsDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsEcsTaskDefinitionContainerDefinitionsMountPointsDetailsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
