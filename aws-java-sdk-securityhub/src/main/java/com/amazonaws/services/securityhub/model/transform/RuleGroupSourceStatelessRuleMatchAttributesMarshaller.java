...
@SdkInternalApi
public class RuleGroupSourceStatelessRuleMatchAttributesMarshaller {
    ...
    private static final RuleGroupSourceStatelessRuleMatchAttributesMarshaller instance = new RuleGroupSourceStatelessRuleMatchAttributesMarshaller();

    public static RuleGroupSourceStatelessRuleMatchAttributesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RuleGroupSourceStatelessRuleMatchAttributes ruleGroupSourceStatelessRuleMatchAttributes, ProtocolMarshaller protocolMarshaller) {

        if (ruleGroupSourceStatelessRuleMatchAttributes == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(ruleGroupSourceStatelessRuleMatchAttributes.getDestinationPorts(), DESTINATIONPORTS_BINDING);
            protocolMarshaller.marshall(ruleGroupSourceStatelessRuleMatchAttributes.getDestinations(), DESTINATIONS_BINDING);
            protocolMarshaller.marshall(ruleGroupSourceStatelessRuleMatchAttributes.getProtocols(), PROTOCOLS_BINDING);
            protocolMarshaller.marshall(ruleGroupSourceStatelessRuleMatchAttributes.getSourcePorts(), SOURCEPORTS_BINDING);
            protocolMarshaller.marshall(ruleGroupSourceStatelessRuleMatchAttributes.getSources(), SOURCES_BINDING);
            protocolMarshaller.marshall(ruleGroupSourceStatelessRuleMatchAttributes.getTcpFlags(), TCPFLAGS_BINDING);
        } catch (Exception e) {
