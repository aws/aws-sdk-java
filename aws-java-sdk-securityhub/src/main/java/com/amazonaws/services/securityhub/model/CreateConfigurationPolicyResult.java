...
public class CreateConfigurationPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateConfigurationPolicyResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public CreateConfigurationPolicyResult withCreatedAt(java.util.Date createdAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateConfigurationPolicyResult == false)
            return false;
        CreateConfigurationPolicyResult other = (CreateConfigurationPolicyResult) obj;
    ...
    public CreateConfigurationPolicyResult clone() {
        try {
            return (CreateConfigurationPolicyResult) super.clone();
