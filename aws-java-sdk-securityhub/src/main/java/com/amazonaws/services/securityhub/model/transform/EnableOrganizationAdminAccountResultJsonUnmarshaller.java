...
/**
 * EnableOrganizationAdminAccountResult JSON Unmarshaller
 */
...
public class EnableOrganizationAdminAccountResultJsonUnmarshaller implements Unmarshaller<EnableOrganizationAdminAccountResult, JsonUnmarshallerContext> {
    ...
    public EnableOrganizationAdminAccountResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        EnableOrganizationAdminAccountResult enableOrganizationAdminAccountResult = new EnableOrganizationAdminAccountResult();
