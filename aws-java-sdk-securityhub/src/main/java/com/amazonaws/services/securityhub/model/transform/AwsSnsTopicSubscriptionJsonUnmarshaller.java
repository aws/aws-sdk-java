...
/**
 * AwsSnsTopicSubscription JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsSnsTopicSubscriptionJsonUnmarshaller implements Unmarshaller<AwsSnsTopicSubscription, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Endpoint", targetDepth)) {
                    context.nextToken();
                    awsSnsTopicSubscription.setEndpoint(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Protocol", targetDepth)) {
                    context.nextToken();
                    awsSnsTopicSubscription.setProtocol(context.getUnmarshaller(String.class).unmarshall(context));
                }
