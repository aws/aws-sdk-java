...
/**
 * Country JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CountryJsonUnmarshaller implements Unmarshaller<Country, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CountryCode", targetDepth)) {
                    context.nextToken();
                    country.setCountryCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("CountryName", targetDepth)) {
                    context.nextToken();
                    country.setCountryName(context.getUnmarshaller(String.class).unmarshall(context));
                }
