...
public class CreateFindingAggregatorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateFindingAggregatorResult withRegions(String... regions) {
    ...
    public CreateFindingAggregatorResult withRegions(java.util.Collection<String> regions) {
        setRegions(regions);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateFindingAggregatorResult == false)
            return false;
        CreateFindingAggregatorResult other = (CreateFindingAggregatorResult) obj;
