...
public class ThreatMarshaller {
    ...
    private static final ThreatMarshaller instance = new ThreatMarshaller();

    public static ThreatMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Threat threat, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(threat.getName(), NAME_BINDING);
            protocolMarshaller.marshall(threat.getSeverity(), SEVERITY_BINDING);
            protocolMarshaller.marshall(threat.getItemCount(), ITEMCOUNT_BINDING);
            protocolMarshaller.marshall(threat.getFilePaths(), FILEPATHS_BINDING);
        } catch (Exception e) {
