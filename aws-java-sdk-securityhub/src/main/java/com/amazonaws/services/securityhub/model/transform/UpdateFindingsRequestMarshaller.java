...
public class UpdateFindingsRequestMarshaller {
    ...
    public void marshall(UpdateFindingsRequest updateFindingsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateFindingsRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(updateFindingsRequest.getNote(), NOTE_BINDING);
            protocolMarshaller.marshall(updateFindingsRequest.getRecordState(), RECORDSTATE_BINDING);
        } catch (Exception e) {
