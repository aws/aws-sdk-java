...
/**
 * SoftwarePackage JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SoftwarePackageJsonUnmarshaller implements Unmarshaller<SoftwarePackage, JsonUnmarshallerContext> {

    public SoftwarePackage unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SoftwarePackageJsonUnmarshaller instance;

    public static SoftwarePackageJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SoftwarePackageJsonUnmarshaller();
        return instance;
    }
}
