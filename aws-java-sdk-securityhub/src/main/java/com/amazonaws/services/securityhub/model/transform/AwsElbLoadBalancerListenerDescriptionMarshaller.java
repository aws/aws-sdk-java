...
/**
 * AwsElbLoadBalancerListenerDescriptionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AwsElbLoadBalancerListenerDescriptionMarshaller {

    private static final MarshallingInfo<StructuredPojo> LISTENER_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("Listener").build();
