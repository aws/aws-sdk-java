...
@SdkInternalApi
public class GetInsightsRequestMarshaller {

    private static final MarshallingInfo<List> INSIGHTARNS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("InsightArns").build();
    private static final MarshallingInfo<String> NEXTTOKEN_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("NextToken").build();
    private static final MarshallingInfo<Integer> MAXRESULTS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MaxResults").build();

    private static final GetInsightsRequestMarshaller instance = new GetInsightsRequestMarshaller();

    public static GetInsightsRequestMarshaller getInstance() {
        return instance;
    }
