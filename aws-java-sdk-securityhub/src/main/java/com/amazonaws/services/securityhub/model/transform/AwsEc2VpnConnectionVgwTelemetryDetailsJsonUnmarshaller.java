...
/**
 * AwsEc2VpnConnectionVgwTelemetryDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEc2VpnConnectionVgwTelemetryDetailsJsonUnmarshaller implements Unmarshaller<AwsEc2VpnConnectionVgwTelemetryDetails, JsonUnmarshallerContext> {

    public AwsEc2VpnConnectionVgwTelemetryDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsEc2VpnConnectionVgwTelemetryDetails awsEc2VpnConnectionVgwTelemetryDetails = new AwsEc2VpnConnectionVgwTelemetryDetails();
    ...
    private static AwsEc2VpnConnectionVgwTelemetryDetailsJsonUnmarshaller instance;

    public static AwsEc2VpnConnectionVgwTelemetryDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsEc2VpnConnectionVgwTelemetryDetailsJsonUnmarshaller();
        return instance;
    }
}
