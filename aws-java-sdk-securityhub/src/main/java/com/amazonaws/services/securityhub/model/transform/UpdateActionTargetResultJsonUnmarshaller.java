...
/**
 * UpdateActionTargetResult JSON Unmarshaller
 */
...
public class UpdateActionTargetResultJsonUnmarshaller implements Unmarshaller<UpdateActionTargetResult, JsonUnmarshallerContext> {
    ...
    public UpdateActionTargetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateActionTargetResult updateActionTargetResult = new UpdateActionTargetResult();
