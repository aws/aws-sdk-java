 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsWafv2RulesActionCountDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsWafv2RulesActionCountDetails implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Defines custom handling for the web request. For more information, see <a
     *         href="https://docs.aws.amazon.com/waf/latest/developerguide/waf-custom-request-response.html">Customizing
     *         web requests and responses in WAF</a> in the <i>WAF Developer Guide.</i>.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsWafv2RulesActionCountDetails == false)
            return false;
        AwsWafv2RulesActionCountDetails other = (AwsWafv2RulesActionCountDetails) obj;
    ...
    public AwsWafv2RulesActionCountDetails clone() {
        try {
            return (AwsWafv2RulesActionCountDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsWafv2RulesActionCountDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
