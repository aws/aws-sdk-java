...
/**
 * WorkflowUpdate JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorkflowUpdateJsonUnmarshaller implements Unmarshaller<WorkflowUpdate, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    workflowUpdate.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
