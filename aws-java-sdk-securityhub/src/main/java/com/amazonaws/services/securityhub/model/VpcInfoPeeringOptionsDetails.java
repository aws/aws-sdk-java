 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/VpcInfoPeeringOptionsDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VpcInfoPeeringOptionsDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VpcInfoPeeringOptionsDetails == false)
            return false;
        VpcInfoPeeringOptionsDetails other = (VpcInfoPeeringOptionsDetails) obj;
    ...
    @Override
    public VpcInfoPeeringOptionsDetails clone() {
        try {
            return (VpcInfoPeeringOptionsDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.VpcInfoPeeringOptionsDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
