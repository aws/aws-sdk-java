...
/**
 * AwsDynamoDbTableReplica JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsDynamoDbTableReplicaJsonUnmarshaller implements Unmarshaller<AwsDynamoDbTableReplica, JsonUnmarshallerContext> {

    public AwsDynamoDbTableReplica unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsDynamoDbTableReplica awsDynamoDbTableReplica = new AwsDynamoDbTableReplica();
    ...
    private static AwsDynamoDbTableReplicaJsonUnmarshaller instance;

    public static AwsDynamoDbTableReplicaJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsDynamoDbTableReplicaJsonUnmarshaller();
        return instance;
    }
}
