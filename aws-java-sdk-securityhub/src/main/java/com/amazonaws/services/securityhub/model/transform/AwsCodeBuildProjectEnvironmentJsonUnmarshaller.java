...
/**
 * AwsCodeBuildProjectEnvironment JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsCodeBuildProjectEnvironmentJsonUnmarshaller implements Unmarshaller<AwsCodeBuildProjectEnvironment, JsonUnmarshallerContext> {

    public AwsCodeBuildProjectEnvironment unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsCodeBuildProjectEnvironment awsCodeBuildProjectEnvironment = new AwsCodeBuildProjectEnvironment();
    ...
    private static AwsCodeBuildProjectEnvironmentJsonUnmarshaller instance;

    public static AwsCodeBuildProjectEnvironmentJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsCodeBuildProjectEnvironmentJsonUnmarshaller();
        return instance;
    }
}
