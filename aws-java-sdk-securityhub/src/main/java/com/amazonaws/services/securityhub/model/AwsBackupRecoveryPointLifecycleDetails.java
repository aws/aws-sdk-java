 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsBackupRecoveryPointLifecycleDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsBackupRecoveryPointLifecycleDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getMoveToColdStorageAfterDays() != null)
            sb.append("MoveToColdStorageAfterDays: ").append(getMoveToColdStorageAfterDays());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsBackupRecoveryPointLifecycleDetails == false)
            return false;
        AwsBackupRecoveryPointLifecycleDetails other = (AwsBackupRecoveryPointLifecycleDetails) obj;
    ...
    public AwsBackupRecoveryPointLifecycleDetails clone() {
        try {
            return (AwsBackupRecoveryPointLifecycleDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsBackupRecoveryPointLifecycleDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
