 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEc2VpnConnectionRoutesDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEc2VpnConnectionRoutesDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsEc2VpnConnectionRoutesDetails == false)
            return false;
        AwsEc2VpnConnectionRoutesDetails other = (AwsEc2VpnConnectionRoutesDetails) obj;
    ...
    @Override
    public AwsEc2VpnConnectionRoutesDetails clone() {
        try {
            return (AwsEc2VpnConnectionRoutesDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsEc2VpnConnectionRoutesDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
