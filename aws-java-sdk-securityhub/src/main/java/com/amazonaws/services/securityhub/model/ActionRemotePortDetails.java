 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/ActionRemotePortDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ActionRemotePortDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ActionRemotePortDetails == false)
            return false;
        ActionRemotePortDetails other = (ActionRemotePortDetails) obj;
    ...
    public ActionRemotePortDetails clone() {
        try {
            return (ActionRemotePortDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.ActionRemotePortDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
