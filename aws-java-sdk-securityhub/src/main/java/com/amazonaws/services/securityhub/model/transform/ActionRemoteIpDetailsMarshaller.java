...
/**
 * ActionRemoteIpDetailsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ActionRemoteIpDetailsMarshaller {
    ...
    private static final ActionRemoteIpDetailsMarshaller instance = new ActionRemoteIpDetailsMarshaller();

    public static ActionRemoteIpDetailsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ActionRemoteIpDetails actionRemoteIpDetails, ProtocolMarshaller protocolMarshaller) {

        if (actionRemoteIpDetails == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(actionRemoteIpDetails.getIpAddressV4(), IPADDRESSV4_BINDING);
            protocolMarshaller.marshall(actionRemoteIpDetails.getOrganization(), ORGANIZATION_BINDING);
            protocolMarshaller.marshall(actionRemoteIpDetails.getCountry(), COUNTRY_BINDING);
            protocolMarshaller.marshall(actionRemoteIpDetails.getCity(), CITY_BINDING);
            protocolMarshaller.marshall(actionRemoteIpDetails.getGeoLocation(), GEOLOCATION_BINDING);
        } catch (Exception e) {
