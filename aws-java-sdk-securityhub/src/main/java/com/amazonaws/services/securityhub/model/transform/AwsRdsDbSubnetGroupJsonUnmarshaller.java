...
/**
 * AwsRdsDbSubnetGroup JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsRdsDbSubnetGroupJsonUnmarshaller implements Unmarshaller<AwsRdsDbSubnetGroup, JsonUnmarshallerContext> {

    public AwsRdsDbSubnetGroup unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsRdsDbSubnetGroup awsRdsDbSubnetGroup = new AwsRdsDbSubnetGroup();
    ...
    private static AwsRdsDbSubnetGroupJsonUnmarshaller instance;

    public static AwsRdsDbSubnetGroupJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsRdsDbSubnetGroupJsonUnmarshaller();
        return instance;
    }
}
