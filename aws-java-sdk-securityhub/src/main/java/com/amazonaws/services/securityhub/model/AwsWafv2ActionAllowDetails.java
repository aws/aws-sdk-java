 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsWafv2ActionAllowDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsWafv2ActionAllowDetails implements Serializable, Cloneable, StructuredPojo {

    /**
     * <p>
     * Defines custom handling for the web request. For information about customizing web requests and responses, see <a
     ...
     * </p>
     * 
     * @return Defines custom handling for the web request. For information about customizing web requests and
     *         responses, see <a
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsWafv2ActionAllowDetails == false)
            return false;
        AwsWafv2ActionAllowDetails other = (AwsWafv2ActionAllowDetails) obj;
    ...
    public AwsWafv2ActionAllowDetails clone() {
        try {
            return (AwsWafv2ActionAllowDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsWafv2ActionAllowDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
