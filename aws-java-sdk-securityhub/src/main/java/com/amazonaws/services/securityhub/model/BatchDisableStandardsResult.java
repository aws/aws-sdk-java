...
public class BatchDisableStandardsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The details of the standards subscriptions that were disabled.
     */
    ...
    public BatchDisableStandardsResult withStandardsSubscriptions(StandardsSubscription... standardsSubscriptions) {
    ...
    public BatchDisableStandardsResult withStandardsSubscriptions(java.util.Collection<StandardsSubscription> standardsSubscriptions) {
    ...
    public BatchDisableStandardsResult clone() {
        try {
            return (BatchDisableStandardsResult) super.clone();
