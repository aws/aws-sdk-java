 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/m2-2021-04-28/FileBatchJobDefinition" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FileBatchJobDefinition implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FileBatchJobDefinition == false)
            return false;
    ...
    public FileBatchJobDefinition clone() {
        try {
            return (FileBatchJobDefinition) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mainframemodernization.model.transform.FileBatchJobDefinitionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
