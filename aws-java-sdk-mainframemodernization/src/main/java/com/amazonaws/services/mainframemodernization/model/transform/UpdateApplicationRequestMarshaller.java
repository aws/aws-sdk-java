...
public class UpdateApplicationRequestMarshaller {
    ...
    private static final MarshallingInfo<Integer> CURRENTAPPLICATIONVERSION_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("currentApplicationVersion").build();
    ...
    public void marshall(UpdateApplicationRequest updateApplicationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateApplicationRequest.getCurrentApplicationVersion(), CURRENTAPPLICATIONVERSION_BINDING);
            protocolMarshaller.marshall(updateApplicationRequest.getDefinition(), DEFINITION_BINDING);
