        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("content", targetDepth)) {
                    context.nextToken();
                    definition.setContent(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("s3Location", targetDepth)) {
                    context.nextToken();
                    definition.setS3Location(context.getUnmarshaller(String.class).unmarshall(context));
                }
