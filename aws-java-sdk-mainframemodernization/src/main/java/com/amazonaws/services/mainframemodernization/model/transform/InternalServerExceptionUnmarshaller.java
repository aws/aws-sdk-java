...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.mainframemodernization.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.mainframemodernization.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.mainframemodernization.model.InternalServerException internalServerException = new com.amazonaws.services.mainframemodernization.model.InternalServerException(
                null);
