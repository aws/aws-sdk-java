...
/**
 * RecordLengthMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RecordLengthMarshaller {
    ...
    private static final RecordLengthMarshaller instance = new RecordLengthMarshaller();

    public static RecordLengthMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RecordLength recordLength, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(recordLength.getMax(), MAX_BINDING);
            protocolMarshaller.marshall(recordLength.getMin(), MIN_BINDING);
        } catch (Exception e) {
