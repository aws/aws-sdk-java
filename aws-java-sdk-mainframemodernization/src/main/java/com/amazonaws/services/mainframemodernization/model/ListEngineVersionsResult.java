...
public class ListEngineVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<EngineVersionsSummary> engineVersions;
    /**
     * <p>
    ...
    public java.util.List<EngineVersionsSummary> getEngineVersions() {
    ...
    public void setEngineVersions(java.util.Collection<EngineVersionsSummary> engineVersions) {
        if (engineVersions == null) {
            this.engineVersions = null;
            return;
        }

        this.engineVersions = new java.util.ArrayList<EngineVersionsSummary>(engineVersions);
    }
    ...
    public ListEngineVersionsResult withEngineVersions(EngineVersionsSummary... engineVersions) {
        if (this.engineVersions == null) {
            setEngineVersions(new java.util.ArrayList<EngineVersionsSummary>(engineVersions.length));
        }
        for (EngineVersionsSummary ele : engineVersions) {
    ...
    public ListEngineVersionsResult withEngineVersions(java.util.Collection<EngineVersionsSummary> engineVersions) {
