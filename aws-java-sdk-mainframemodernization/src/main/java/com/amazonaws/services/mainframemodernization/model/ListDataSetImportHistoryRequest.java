...
public class ListDataSetImportHistoryRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDataSetImportHistoryRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDataSetImportHistoryRequest == false)
            return false;
        ListDataSetImportHistoryRequest other = (ListDataSetImportHistoryRequest) obj;
    ...
    @Override
    public ListDataSetImportHistoryRequest clone() {
        return (ListDataSetImportHistoryRequest) super.clone();
    }
