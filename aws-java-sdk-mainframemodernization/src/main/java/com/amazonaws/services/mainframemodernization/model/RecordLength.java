 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/m2-2021-04-28/RecordLength" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RecordLength implements Serializable, Cloneable, StructuredPojo {
    ...
    public RecordLength withMax(Integer max) {
        setMax(max);
        return this;
    }
    ...
    public RecordLength withMin(Integer min) {
        setMin(min);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RecordLength == false)
            return false;
    ...
    @Override
    public RecordLength clone() {
        try {
            return (RecordLength) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mainframemodernization.model.transform.RecordLengthMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
