...
/**
 * AlternateKeyMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AlternateKeyMarshaller {
    ...
    private static final AlternateKeyMarshaller instance = new AlternateKeyMarshaller();

    public static AlternateKeyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AlternateKey alternateKey, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(alternateKey.getAllowDuplicates(), ALLOWDUPLICATES_BINDING);
            protocolMarshaller.marshall(alternateKey.getLength(), LENGTH_BINDING);
            protocolMarshaller.marshall(alternateKey.getName(), NAME_BINDING);
            protocolMarshaller.marshall(alternateKey.getOffset(), OFFSET_BINDING);
        } catch (Exception e) {
