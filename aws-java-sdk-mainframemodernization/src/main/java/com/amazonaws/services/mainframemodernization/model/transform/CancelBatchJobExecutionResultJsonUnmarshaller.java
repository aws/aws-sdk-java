...
/**
 * CancelBatchJobExecutionResult JSON Unmarshaller
 */
...
public class CancelBatchJobExecutionResultJsonUnmarshaller implements Unmarshaller<CancelBatchJobExecutionResult, JsonUnmarshallerContext> {
    ...
    public CancelBatchJobExecutionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelBatchJobExecutionResult cancelBatchJobExecutionResult = new CancelBatchJobExecutionResult();
