...
@SdkInternalApi
public class PrimaryKeyMarshaller {
    ...
    private static final PrimaryKeyMarshaller instance = new PrimaryKeyMarshaller();

    public static PrimaryKeyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PrimaryKey primaryKey, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(primaryKey.getLength(), LENGTH_BINDING);
            protocolMarshaller.marshall(primaryKey.getName(), NAME_BINDING);
            protocolMarshaller.marshall(primaryKey.getOffset(), OFFSET_BINDING);
        } catch (Exception e) {
