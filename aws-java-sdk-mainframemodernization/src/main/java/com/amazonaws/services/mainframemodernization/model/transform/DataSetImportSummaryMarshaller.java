...
/**
 * DataSetImportSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DataSetImportSummaryMarshaller {
    ...
    private static final DataSetImportSummaryMarshaller instance = new DataSetImportSummaryMarshaller();

    public static DataSetImportSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DataSetImportSummary dataSetImportSummary, ProtocolMarshaller protocolMarshaller) {

        if (dataSetImportSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(dataSetImportSummary.getFailed(), FAILED_BINDING);
            protocolMarshaller.marshall(dataSetImportSummary.getInProgress(), INPROGRESS_BINDING);
            protocolMarshaller.marshall(dataSetImportSummary.getPending(), PENDING_BINDING);
            protocolMarshaller.marshall(dataSetImportSummary.getSucceeded(), SUCCEEDED_BINDING);
            protocolMarshaller.marshall(dataSetImportSummary.getTotal(), TOTAL_BINDING);
        } catch (Exception e) {
