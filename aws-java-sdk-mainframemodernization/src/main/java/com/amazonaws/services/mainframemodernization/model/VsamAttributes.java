 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/m2-2021-04-28/VsamAttributes" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VsamAttributes implements Serializable, Cloneable, StructuredPojo {
    ...
    public VsamAttributes withAlternateKeys(java.util.Collection<AlternateKey> alternateKeys) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VsamAttributes == false)
            return false;
    ...
    @Override
    public VsamAttributes clone() {
        try {
            return (VsamAttributes) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mainframemodernization.model.transform.VsamAttributesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
