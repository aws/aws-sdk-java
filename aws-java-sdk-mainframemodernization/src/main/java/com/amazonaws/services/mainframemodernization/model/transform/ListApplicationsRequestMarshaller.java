...
public class ListApplicationsRequestMarshaller {
    ...
    private static final MarshallingInfo<List> NAMES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.QUERY_PARAM)
    ...
    public void marshall(ListApplicationsRequest listApplicationsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listApplicationsRequest.getEnvironmentId(), ENVIRONMENTID_BINDING);
            protocolMarshaller.marshall(listApplicationsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listApplicationsRequest.getNames(), NAMES_BINDING);
