...
/**
 * DescribeEnvironmentStatusRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeEnvironmentStatusRequestMarshaller {
    ...
    private static final DescribeEnvironmentStatusRequestMarshaller instance = new DescribeEnvironmentStatusRequestMarshaller();

    public static DescribeEnvironmentStatusRequestMarshaller getInstance() {
        return instance;
    }
