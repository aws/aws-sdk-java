    ...
    public void marshall(Notification notification, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (notification.getNotificationType() != null) {
                jsonGenerator.writeFieldName("NotificationType").writeValue(notification.getNotificationType());
            }
            if (notification.getComparisonOperator() != null) {
                jsonGenerator.writeFieldName("ComparisonOperator").writeValue(notification.getComparisonOperator());
            }
            if (notification.getThreshold() != null) {
                jsonGenerator.writeFieldName("Threshold").writeValue(notification.getThreshold());
            }
