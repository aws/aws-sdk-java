...
/**
 * CreateNotificationResult JSON Unmarshaller
 */
...
public class CreateNotificationResultJsonUnmarshaller implements Unmarshaller<CreateNotificationResult, JsonUnmarshallerContext> {
    ...
    public CreateNotificationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateNotificationResult createNotificationResult = new CreateNotificationResult();
