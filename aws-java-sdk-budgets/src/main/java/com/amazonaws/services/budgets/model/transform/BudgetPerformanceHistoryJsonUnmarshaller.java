...
/**
 * BudgetPerformanceHistory JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BudgetPerformanceHistoryJsonUnmarshaller implements Unmarshaller<BudgetPerformanceHistory, JsonUnmarshallerContext> {

    public BudgetPerformanceHistory unmarshall(JsonUnmarshallerContext context) throws Exception {
        BudgetPerformanceHistory budgetPerformanceHistory = new BudgetPerformanceHistory();
    ...
    private static BudgetPerformanceHistoryJsonUnmarshaller instance;

    public static BudgetPerformanceHistoryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BudgetPerformanceHistoryJsonUnmarshaller();
        return instance;
    }
}
