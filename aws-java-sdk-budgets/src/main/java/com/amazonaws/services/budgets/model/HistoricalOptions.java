...
public class HistoricalOptions implements Serializable, Cloneable, StructuredPojo {
     ...
     *        budget amount. The maximum value depends on the <code>TimeUnit</code> granularity of the budget:</p>
     *        <ul>
     *        <li>
     *        <p>
     *        For the <code>DAILY</code> granularity, the maximum value is <code>60</code>.
    ...
    public HistoricalOptions withBudgetAdjustmentPeriod(Integer budgetAdjustmentPeriod) {
        setBudgetAdjustmentPeriod(budgetAdjustmentPeriod);
        return this;
    }
