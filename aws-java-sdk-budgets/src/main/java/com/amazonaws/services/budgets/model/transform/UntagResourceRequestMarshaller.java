...
public class UntagResourceRequestMarshaller {
    ...
    private static final MarshallingInfo<List> RESOURCETAGKEYS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ResourceTagKeys").build();
    ...
    public void marshall(UntagResourceRequest untagResourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(untagResourceRequest.getResourceTagKeys(), RESOURCETAGKEYS_BINDING);
        } catch (Exception e) {
