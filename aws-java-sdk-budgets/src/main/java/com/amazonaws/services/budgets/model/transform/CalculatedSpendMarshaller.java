...
public class CalculatedSpendMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> ACTUALSPEND_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ActualSpend").build();
    private static final MarshallingInfo<StructuredPojo> FORECASTEDSPEND_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ForecastedSpend").build();
