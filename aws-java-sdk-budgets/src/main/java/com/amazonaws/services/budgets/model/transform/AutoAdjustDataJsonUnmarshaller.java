...
/**
 * AutoAdjustData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AutoAdjustDataJsonUnmarshaller implements Unmarshaller<AutoAdjustData, JsonUnmarshallerContext> {

    public AutoAdjustData unmarshall(JsonUnmarshallerContext context) throws Exception {
        AutoAdjustData autoAdjustData = new AutoAdjustData();
    ...
    private static AutoAdjustDataJsonUnmarshaller instance;

    public static AutoAdjustDataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AutoAdjustDataJsonUnmarshaller();
        return instance;
    }
}
