        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("creationTime", targetDepth)) {
                    context.nextToken();
                    application.setCreationTime(DateJsonUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                }
                if (context.testExpression("lastUpdateTime", targetDepth)) {
                    context.nextToken();
                    application.setLastUpdateTime(DateJsonUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                }
                ...
                if (context.testExpression("applicationTag", targetDepth)) {
                    context.nextToken();
                    application.setApplicationTag(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
