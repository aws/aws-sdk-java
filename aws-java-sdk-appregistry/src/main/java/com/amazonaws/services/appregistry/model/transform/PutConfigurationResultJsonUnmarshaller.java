...
/**
 * PutConfigurationResult JSON Unmarshaller
 */
...
public class PutConfigurationResultJsonUnmarshaller implements Unmarshaller<PutConfigurationResult, JsonUnmarshallerContext> {
    ...
    public PutConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutConfigurationResult putConfigurationResult = new PutConfigurationResult();

        return putConfigurationResult;
    }
