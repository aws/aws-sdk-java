...
public class DisassociateResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateResourceResult == false)
            return false;
        DisassociateResourceResult other = (DisassociateResourceResult) obj;
    ...
    public DisassociateResourceResult clone() {
        try {
            return (DisassociateResourceResult) super.clone();
