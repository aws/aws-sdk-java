...
public class AttributeGroup implements Serializable, Cloneable, StructuredPojo {
    ...
    public AttributeGroup withCreationTime(java.util.Date creationTime) {
    ...
    public AttributeGroup withLastUpdateTime(java.util.Date lastUpdateTime) {
     ...
     *
     * @see AttributeGroup#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public AttributeGroup addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttributeGroup == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appregistry.model.transform.AttributeGroupMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
