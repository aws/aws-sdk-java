...
/**
 * DescribePlacementRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribePlacementRequestMarshaller {
    ...
    private static final DescribePlacementRequestMarshaller instance = new DescribePlacementRequestMarshaller();

    public static DescribePlacementRequestMarshaller getInstance() {
        return instance;
    }
