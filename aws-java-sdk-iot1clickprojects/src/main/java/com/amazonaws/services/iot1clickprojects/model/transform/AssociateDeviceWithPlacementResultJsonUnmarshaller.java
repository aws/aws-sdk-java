...
/**
 * AssociateDeviceWithPlacementResult JSON Unmarshaller
 */
...
public class AssociateDeviceWithPlacementResultJsonUnmarshaller implements Unmarshaller<AssociateDeviceWithPlacementResult, JsonUnmarshallerContext> {
    ...
    public AssociateDeviceWithPlacementResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateDeviceWithPlacementResult associateDeviceWithPlacementResult = new AssociateDeviceWithPlacementResult();
