...
public class ResourceNotFoundExceptionUnmarshaller extends JsonErrorUnmarshaller<com.amazonaws.services.iot1clickprojects.model.ResourceNotFoundException> {
    private ResourceNotFoundExceptionUnmarshaller() {
        super("ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.iot1clickprojects.model.ResourceNotFoundException unmarshall(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iot1clickprojects.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.iot1clickprojects.model.ResourceNotFoundException(
                null);
