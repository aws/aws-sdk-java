...
/**
 * Fluent builder for {@link com.amazonaws.services.directconnect.AmazonDirectConnect}. Use of the builder is preferred
 * over using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AmazonDirectConnectClientBuilder extends AwsSyncClientBuilder<AmazonDirectConnectClientBuilder, AmazonDirectConnect> {
    ...
    /**
     * Construct a synchronous implementation of AmazonDirectConnect using the current builder configuration.
     *
     * @param params
