...
/**
 * DescribeDirectConnectGatewayAttachmentsResult JSON Unmarshaller
 */
...
public class DescribeDirectConnectGatewayAttachmentsResultJsonUnmarshaller implements
    ...
    public DescribeDirectConnectGatewayAttachmentsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeDirectConnectGatewayAttachmentsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
