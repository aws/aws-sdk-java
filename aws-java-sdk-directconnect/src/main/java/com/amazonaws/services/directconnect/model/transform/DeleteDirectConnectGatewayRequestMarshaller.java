...
/**
 * DeleteDirectConnectGatewayRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteDirectConnectGatewayRequestMarshaller {
    ...
    private static final DeleteDirectConnectGatewayRequestMarshaller instance = new DeleteDirectConnectGatewayRequestMarshaller();

    public static DeleteDirectConnectGatewayRequestMarshaller getInstance() {
        return instance;
    }
