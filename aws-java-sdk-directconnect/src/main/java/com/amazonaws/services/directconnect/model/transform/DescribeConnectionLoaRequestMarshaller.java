 ...
 */
public class DescribeConnectionLoaRequestMarshaller implements Marshaller<Request<DescribeConnectionLoaRequest>, DescribeConnectionLoaRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeConnectionLoaRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DescribeConnectionLoaRequest> marshall(DescribeConnectionLoaRequest describeConnectionLoaRequest) {
        ...
        Request<DescribeConnectionLoaRequest> request = new DefaultRequest<DescribeConnectionLoaRequest>(describeConnectionLoaRequest, "AmazonDirectConnect");
