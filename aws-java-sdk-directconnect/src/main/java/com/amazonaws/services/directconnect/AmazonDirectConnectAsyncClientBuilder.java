...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.directconnect.AmazonDirectConnectAsync}. Use of
 * the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonDirectConnectAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonDirectConnectAsyncClientBuilder, AmazonDirectConnectAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonDirectConnectAsync
