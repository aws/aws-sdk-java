...
public class DescribeLoaRequestMarshaller implements Marshaller<Request<DescribeLoaRequest>, DescribeLoaRequest> {
    ...
    public Request<DescribeLoaRequest> marshall(DescribeLoaRequest describeLoaRequest) {
        ...
        Request<DescribeLoaRequest> request = new DefaultRequest<DescribeLoaRequest>(describeLoaRequest, "AmazonDirectConnect");
