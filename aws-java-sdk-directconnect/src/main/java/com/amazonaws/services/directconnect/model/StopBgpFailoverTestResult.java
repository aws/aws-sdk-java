...
public class StopBgpFailoverTestResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StopBgpFailoverTestResult clone() {
        try {
            return (StopBgpFailoverTestResult) super.clone();
