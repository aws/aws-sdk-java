...
/**
 * CreateTransitVirtualInterfaceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateTransitVirtualInterfaceResultJsonUnmarshaller implements Unmarshaller<CreateTransitVirtualInterfaceResult, JsonUnmarshallerContext> {

    public CreateTransitVirtualInterfaceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("virtualInterface", targetDepth)) {
                    context.nextToken();
                    createTransitVirtualInterfaceResult.setVirtualInterface(VirtualInterfaceJsonUnmarshaller.getInstance().unmarshall(context));
                }
