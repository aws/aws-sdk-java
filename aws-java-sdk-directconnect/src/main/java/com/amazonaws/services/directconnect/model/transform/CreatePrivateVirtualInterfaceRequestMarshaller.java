...
public class CreatePrivateVirtualInterfaceRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> NEWPRIVATEVIRTUALINTERFACE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("newPrivateVirtualInterface").build();

    private static final CreatePrivateVirtualInterfaceRequestMarshaller instance = new CreatePrivateVirtualInterfaceRequestMarshaller();

    public static CreatePrivateVirtualInterfaceRequestMarshaller getInstance() {
        return instance;
    }
