...
public class CreatePrivateVirtualInterfaceRequestMarshaller
    ...
    public CreatePrivateVirtualInterfaceRequestMarshaller(
    ...
    public Request<CreatePrivateVirtualInterfaceRequest> marshall(
        ...
        Request<CreatePrivateVirtualInterfaceRequest> request = new DefaultRequest<CreatePrivateVirtualInterfaceRequest>(
        ...
        try {
            ...
            if (createPrivateVirtualInterfaceRequest.getConnectionId() != null) {
                jsonGenerator.writeFieldName("connectionId").writeValue(
                        createPrivateVirtualInterfaceRequest.getConnectionId());
            }
            if (createPrivateVirtualInterfaceRequest
                    .getNewPrivateVirtualInterface() != null) {
                jsonGenerator.writeFieldName("newPrivateVirtualInterface");
                NewPrivateVirtualInterfaceJsonMarshaller
                        .getInstance()
                        .marshall(
