...
public class DescribeConnectionsRequestMarshaller implements Marshaller<Request<DescribeConnectionsRequest>, DescribeConnectionsRequest> {
    ...
    public Request<DescribeConnectionsRequest> marshall(DescribeConnectionsRequest describeConnectionsRequest) {
        ...
        Request<DescribeConnectionsRequest> request = new DefaultRequest<DescribeConnectionsRequest>(describeConnectionsRequest, "AmazonDirectConnect");
        request.addHeader("X-Amz-Target", "OvertureService.DescribeConnections");
        ...
        try {
            ...
            if (describeConnectionsRequest.getConnectionId() != null) {
                jsonGenerator.writeFieldName("connectionId").writeValue(describeConnectionsRequest.getConnectionId());
            }
