...
public class ConfirmTransitVirtualInterfaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public ConfirmTransitVirtualInterfaceResult withVirtualInterfaceState(String virtualInterfaceState) {
    ...
    public ConfirmTransitVirtualInterfaceResult withVirtualInterfaceState(VirtualInterfaceState virtualInterfaceState) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConfirmTransitVirtualInterfaceResult == false)
            return false;
        ConfirmTransitVirtualInterfaceResult other = (ConfirmTransitVirtualInterfaceResult) obj;
    ...
    @Override
    public ConfirmTransitVirtualInterfaceResult clone() {
        try {
            return (ConfirmTransitVirtualInterfaceResult) super.clone();
