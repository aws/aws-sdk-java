...
public class DeleteInterconnectRequestMarshaller
        implements
        Marshaller<Request<DeleteInterconnectRequest>, DeleteInterconnectRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DeleteInterconnectRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DeleteInterconnectRequest> marshall(
        ...
        Request<DeleteInterconnectRequest> request = new DefaultRequest<DeleteInterconnectRequest>(
                deleteInterconnectRequest, "AmazonDirectConnect");
        ...
        try {
            ...
            if (deleteInterconnectRequest.getInterconnectId() != null) {
                jsonGenerator.writeFieldName("interconnectId").writeValue(
                        deleteInterconnectRequest.getInterconnectId());
            }
