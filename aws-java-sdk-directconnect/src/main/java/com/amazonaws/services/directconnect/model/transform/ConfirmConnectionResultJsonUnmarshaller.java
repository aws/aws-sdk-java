...
public class ConfirmConnectionResultJsonUnmarshaller implements Unmarshaller<ConfirmConnectionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("connectionState", targetDepth)) {
                    context.nextToken();
                    confirmConnectionResult.setConnectionState(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static ConfirmConnectionResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new ConfirmConnectionResultJsonUnmarshaller();
        return instance;
    }
}
