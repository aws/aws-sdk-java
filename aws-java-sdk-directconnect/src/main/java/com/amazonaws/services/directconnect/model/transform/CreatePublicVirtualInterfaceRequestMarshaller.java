...
public class CreatePublicVirtualInterfaceRequestMarshaller
    ...
    public CreatePublicVirtualInterfaceRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<CreatePublicVirtualInterfaceRequest> marshall(
        ...
        Request<CreatePublicVirtualInterfaceRequest> request = new DefaultRequest<CreatePublicVirtualInterfaceRequest>(
                createPublicVirtualInterfaceRequest, "AmazonDirectConnect");
        ...
        try {
            ...
            if (createPublicVirtualInterfaceRequest.getConnectionId() != null) {
                jsonGenerator.writeFieldName("connectionId").writeValue(
                        createPublicVirtualInterfaceRequest.getConnectionId());
            }
            if (createPublicVirtualInterfaceRequest
                    .getNewPublicVirtualInterface() != null) {
                jsonGenerator.writeFieldName("newPublicVirtualInterface");
                NewPublicVirtualInterfaceJsonMarshaller
                        .getInstance()
                        .marshall(
