 ...
 */
public class AllocatePrivateVirtualInterfaceResultJsonUnmarshaller
        implements
        Unmarshaller<AllocatePrivateVirtualInterfaceResult, JsonUnmarshallerContext> {

    public AllocatePrivateVirtualInterfaceResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("location", targetDepth)) {
                    context.nextToken();
                    allocatePrivateVirtualInterfaceResult.setLocation(context
                ...
                if (context.testExpression("authKey", targetDepth)) {
                    context.nextToken();
                    allocatePrivateVirtualInterfaceResult.setAuthKey(context
                            .getUnmarshaller(String.class).unmarshall(context));
                }
