 ...
 */
public class NewPublicVirtualInterfaceAllocationJsonUnmarshaller
        implements
        Unmarshaller<NewPublicVirtualInterfaceAllocation, JsonUnmarshallerContext> {

    public NewPublicVirtualInterfaceAllocation unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("authKey", targetDepth)) {
                    context.nextToken();
                    newPublicVirtualInterfaceAllocation.setAuthKey(context
