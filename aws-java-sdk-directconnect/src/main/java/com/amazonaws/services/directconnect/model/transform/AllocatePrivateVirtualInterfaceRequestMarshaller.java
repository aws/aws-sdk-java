...
public class AllocatePrivateVirtualInterfaceRequestMarshaller
    ...
    public AllocatePrivateVirtualInterfaceRequestMarshaller(
    ...
    public Request<AllocatePrivateVirtualInterfaceRequest> marshall(
        ...
        try {
            ...
            if (allocatePrivateVirtualInterfaceRequest
                    .getNewPrivateVirtualInterfaceAllocation() != null) {
                jsonGenerator
                        .writeFieldName("newPrivateVirtualInterfaceAllocation");
                NewPrivateVirtualInterfaceAllocationJsonMarshaller
                        .getInstance()
                        .marshall(
                                allocatePrivateVirtualInterfaceRequest
