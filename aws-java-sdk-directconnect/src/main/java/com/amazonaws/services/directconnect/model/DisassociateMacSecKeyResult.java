...
public class DisassociateMacSecKeyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The MAC Security (MACsec) security keys no longer associated with the dedicated connection.
     */
    ...
    public DisassociateMacSecKeyResult withMacSecKeys(MacSecKey... macSecKeys) {
    ...
    public DisassociateMacSecKeyResult withMacSecKeys(java.util.Collection<MacSecKey> macSecKeys) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateMacSecKeyResult == false)
            return false;
        DisassociateMacSecKeyResult other = (DisassociateMacSecKeyResult) obj;
    ...
    public DisassociateMacSecKeyResult clone() {
        try {
            return (DisassociateMacSecKeyResult) super.clone();
