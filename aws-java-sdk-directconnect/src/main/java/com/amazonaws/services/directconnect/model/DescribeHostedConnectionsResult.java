...
public class DescribeHostedConnectionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeHostedConnectionsResult withConnections(Connection... connections) {
    ...
    public DescribeHostedConnectionsResult withConnections(java.util.Collection<Connection> connections) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeHostedConnectionsResult == false)
            return false;
        DescribeHostedConnectionsResult other = (DescribeHostedConnectionsResult) obj;
    ...
    @Override
    public DescribeHostedConnectionsResult clone() {
        try {
            return (DescribeHostedConnectionsResult) super.clone();
