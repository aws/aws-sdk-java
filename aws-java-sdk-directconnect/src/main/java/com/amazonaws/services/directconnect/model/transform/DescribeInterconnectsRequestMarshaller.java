...
public class DescribeInterconnectsRequestMarshaller
        implements
        Marshaller<Request<DescribeInterconnectsRequest>, DescribeInterconnectsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeInterconnectsRequestMarshaller(
    ...
    public Request<DescribeInterconnectsRequest> marshall(
        ...
        Request<DescribeInterconnectsRequest> request = new DefaultRequest<DescribeInterconnectsRequest>(
        ...
        try {
            ...
            if (describeInterconnectsRequest.getInterconnectId() != null) {
                jsonGenerator.writeFieldName("interconnectId").writeValue(
                        describeInterconnectsRequest.getInterconnectId());
            }
