...
public class ListKeyspacesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<KeyspaceSummary> keyspaces;
    ...
    public java.util.List<KeyspaceSummary> getKeyspaces() {
        return keyspaces;
    }
    ...
    public void setKeyspaces(java.util.Collection<KeyspaceSummary> keyspaces) {
        if (keyspaces == null) {
            this.keyspaces = null;
            return;
        }

        this.keyspaces = new java.util.ArrayList<KeyspaceSummary>(keyspaces);
    }
    ...
    public ListKeyspacesResult withKeyspaces(KeyspaceSummary... keyspaces) {
        if (this.keyspaces == null) {
            setKeyspaces(new java.util.ArrayList<KeyspaceSummary>(keyspaces.length));
        }
    ...
    public ListKeyspacesResult withKeyspaces(java.util.Collection<KeyspaceSummary> keyspaces) {
