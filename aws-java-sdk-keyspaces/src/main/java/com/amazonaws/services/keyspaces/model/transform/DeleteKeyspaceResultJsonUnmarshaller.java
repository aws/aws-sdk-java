...
/**
 * DeleteKeyspaceResult JSON Unmarshaller
 */
...
public class DeleteKeyspaceResultJsonUnmarshaller implements Unmarshaller<DeleteKeyspaceResult, JsonUnmarshallerContext> {
    ...
    public DeleteKeyspaceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteKeyspaceResult deleteKeyspaceResult = new DeleteKeyspaceResult();
