...
public class DeleteKeyspaceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the keyspace to be deleted.
     */
    ...
    public String toString() {
        ...
        if (getKeyspaceName() != null)
            sb.append("KeyspaceName: ").append(getKeyspaceName());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteKeyspaceRequest == false)
            return false;
        DeleteKeyspaceRequest other = (DeleteKeyspaceRequest) obj;
    ...
    @Override
    public DeleteKeyspaceRequest clone() {
        return (DeleteKeyspaceRequest) super.clone();
    }
