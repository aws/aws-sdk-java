...
/**
 * EncryptionSpecificationMarshaller
 */
...
public class EncryptionSpecificationMarshaller {
    ...
    public void marshall(EncryptionSpecification encryptionSpecification, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(encryptionSpecification.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(encryptionSpecification.getKmsKeyIdentifier(), KMSKEYIDENTIFIER_BINDING);
        } catch (Exception e) {
