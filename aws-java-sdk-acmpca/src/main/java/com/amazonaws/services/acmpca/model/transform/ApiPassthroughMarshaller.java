...
/**
 * ApiPassthroughMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ApiPassthroughMarshaller {
    ...
    private static final ApiPassthroughMarshaller instance = new ApiPassthroughMarshaller();

    public static ApiPassthroughMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ApiPassthrough apiPassthrough, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(apiPassthrough.getExtensions(), EXTENSIONS_BINDING);
            protocolMarshaller.marshall(apiPassthrough.getSubject(), SUBJECT_BINDING);
        } catch (Exception e) {
