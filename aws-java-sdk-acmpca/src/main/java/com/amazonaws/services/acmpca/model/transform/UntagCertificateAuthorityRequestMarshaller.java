...
@SdkInternalApi
public class UntagCertificateAuthorityRequestMarshaller {
    ...
    private static final UntagCertificateAuthorityRequestMarshaller instance = new UntagCertificateAuthorityRequestMarshaller();

    public static UntagCertificateAuthorityRequestMarshaller getInstance() {
        return instance;
    }
