...
/**
 * PolicyInformation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PolicyInformationJsonUnmarshaller implements Unmarshaller<PolicyInformation, JsonUnmarshallerContext> {

    public PolicyInformation unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static PolicyInformationJsonUnmarshaller instance;

    public static PolicyInformationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PolicyInformationJsonUnmarshaller();
        return instance;
    }
}
