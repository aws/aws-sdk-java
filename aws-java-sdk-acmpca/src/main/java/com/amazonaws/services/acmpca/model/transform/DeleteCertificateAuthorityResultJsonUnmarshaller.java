...
/**
 * DeleteCertificateAuthorityResult JSON Unmarshaller
 */
...
public class DeleteCertificateAuthorityResultJsonUnmarshaller implements Unmarshaller<DeleteCertificateAuthorityResult, JsonUnmarshallerContext> {
    ...
    public DeleteCertificateAuthorityResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCertificateAuthorityResult deleteCertificateAuthorityResult = new DeleteCertificateAuthorityResult();
