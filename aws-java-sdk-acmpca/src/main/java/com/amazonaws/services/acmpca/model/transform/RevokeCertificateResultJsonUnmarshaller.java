...
/**
 * RevokeCertificateResult JSON Unmarshaller
 */
...
public class RevokeCertificateResultJsonUnmarshaller implements Unmarshaller<RevokeCertificateResult, JsonUnmarshallerContext> {
    ...
    public RevokeCertificateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RevokeCertificateResult revokeCertificateResult = new RevokeCertificateResult();
