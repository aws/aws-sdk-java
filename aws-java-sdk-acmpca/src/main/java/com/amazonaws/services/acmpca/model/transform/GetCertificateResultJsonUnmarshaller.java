...
public class GetCertificateResultJsonUnmarshaller implements Unmarshaller<GetCertificateResult, JsonUnmarshallerContext> {
    ...
    public static GetCertificateResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetCertificateResultJsonUnmarshaller();
        return instance;
    }
}
