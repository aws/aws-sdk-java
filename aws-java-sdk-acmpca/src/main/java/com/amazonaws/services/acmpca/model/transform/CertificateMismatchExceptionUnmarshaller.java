...
public class CertificateMismatchExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CertificateMismatchExceptionUnmarshaller instance;

    public static CertificateMismatchExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CertificateMismatchExceptionUnmarshaller();
        return instance;
    }
}
