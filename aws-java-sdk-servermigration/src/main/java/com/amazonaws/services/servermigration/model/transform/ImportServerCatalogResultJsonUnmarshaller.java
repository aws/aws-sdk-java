...
/**
 * ImportServerCatalogResult JSON Unmarshaller
 */
...
public class ImportServerCatalogResultJsonUnmarshaller implements Unmarshaller<ImportServerCatalogResult, JsonUnmarshallerContext> {
    ...
    public ImportServerCatalogResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ImportServerCatalogResult importServerCatalogResult = new ImportServerCatalogResult();
