...
/**
 * ListAppsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListAppsResultJsonUnmarshaller implements Unmarshaller<ListAppsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("apps", targetDepth)) {
                    context.nextToken();
                    listAppsResult.setApps(new ListUnmarshaller<AppSummary>(AppSummaryJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listAppsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
