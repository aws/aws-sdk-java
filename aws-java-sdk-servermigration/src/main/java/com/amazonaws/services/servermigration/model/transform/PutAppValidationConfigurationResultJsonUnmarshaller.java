...
/**
 * PutAppValidationConfigurationResult JSON Unmarshaller
 */
...
public class PutAppValidationConfigurationResultJsonUnmarshaller implements Unmarshaller<PutAppValidationConfigurationResult, JsonUnmarshallerContext> {
    ...
    public PutAppValidationConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutAppValidationConfigurationResult putAppValidationConfigurationResult = new PutAppValidationConfigurationResult();

        return putAppValidationConfigurationResult;
    }
