...
public class NoConnectorsAvailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoConnectorsAvailableExceptionUnmarshaller instance;

    public static NoConnectorsAvailableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoConnectorsAvailableExceptionUnmarshaller();
        return instance;
    }
}
