...
/**
 * DeleteAppLaunchConfigurationResult JSON Unmarshaller
 */
...
public class DeleteAppLaunchConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteAppLaunchConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteAppLaunchConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAppLaunchConfigurationResult deleteAppLaunchConfigurationResult = new DeleteAppLaunchConfigurationResult();
