...
public class InvalidArgumentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidArgumentExceptionUnmarshaller() {
        super(com.amazonaws.services.kinesisvideowebrtcstorage.model.InvalidArgumentException.class, "InvalidArgumentException");
    }

    @Override
    public com.amazonaws.services.kinesisvideowebrtcstorage.model.InvalidArgumentException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.kinesisvideowebrtcstorage.model.InvalidArgumentException invalidArgumentException = new com.amazonaws.services.kinesisvideowebrtcstorage.model.InvalidArgumentException(
                null);
