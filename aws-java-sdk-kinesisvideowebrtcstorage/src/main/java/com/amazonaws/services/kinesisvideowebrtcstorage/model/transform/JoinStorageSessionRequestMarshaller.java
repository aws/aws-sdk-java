...
public class JoinStorageSessionRequestMarshaller {
    ...
    private static final JoinStorageSessionRequestMarshaller instance = new JoinStorageSessionRequestMarshaller();

    public static JoinStorageSessionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(JoinStorageSessionRequest joinStorageSessionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(joinStorageSessionRequest.getChannelArn(), CHANNELARN_BINDING);
        } catch (Exception e) {
