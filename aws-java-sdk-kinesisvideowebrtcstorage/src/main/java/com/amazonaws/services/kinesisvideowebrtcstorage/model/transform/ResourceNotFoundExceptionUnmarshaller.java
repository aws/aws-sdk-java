...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.kinesisvideowebrtcstorage.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.kinesisvideowebrtcstorage.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.kinesisvideowebrtcstorage.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.kinesisvideowebrtcstorage.model.ResourceNotFoundException(
                null);
