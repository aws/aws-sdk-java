...
/**
 * BatchGetRecordIdentifier JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchGetRecordIdentifierJsonUnmarshaller implements Unmarshaller<BatchGetRecordIdentifier, JsonUnmarshallerContext> {

    public BatchGetRecordIdentifier unmarshall(JsonUnmarshallerContext context) throws Exception {
        BatchGetRecordIdentifier batchGetRecordIdentifier = new BatchGetRecordIdentifier();
    ...
    private static BatchGetRecordIdentifierJsonUnmarshaller instance;

    public static BatchGetRecordIdentifierJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BatchGetRecordIdentifierJsonUnmarshaller();
        return instance;
    }
}
