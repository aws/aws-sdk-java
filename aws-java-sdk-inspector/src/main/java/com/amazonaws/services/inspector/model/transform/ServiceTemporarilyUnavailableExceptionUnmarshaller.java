...
public class ServiceTemporarilyUnavailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("canRetry", targetDepth)) {
                    context.nextToken();
                    serviceTemporarilyUnavailableException.setCanRetry(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
    ...
    private static ServiceTemporarilyUnavailableExceptionUnmarshaller instance;

    public static ServiceTemporarilyUnavailableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ServiceTemporarilyUnavailableExceptionUnmarshaller();
        return instance;
    }
}
