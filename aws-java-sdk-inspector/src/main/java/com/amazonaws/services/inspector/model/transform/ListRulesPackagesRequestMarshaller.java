 ...
 */
public class ListRulesPackagesRequestMarshaller implements Marshaller<Request<ListRulesPackagesRequest>, ListRulesPackagesRequest> {
    ...
    public Request<ListRulesPackagesRequest> marshall(ListRulesPackagesRequest listRulesPackagesRequest) {
        ...
        Request<ListRulesPackagesRequest> request = new DefaultRequest<ListRulesPackagesRequest>(listRulesPackagesRequest, "AmazonInspector");
        ...
        try {
            ...
            if (listRulesPackagesRequest.getMaxResults() != null) {
                jsonGenerator.writeFieldName("maxResults").writeValue(listRulesPackagesRequest.getMaxResults());
            }
