...
public class UnsupportedFeatureExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UnsupportedFeatureExceptionUnmarshaller() {
        super(com.amazonaws.services.inspector.model.UnsupportedFeatureException.class, "UnsupportedFeatureException");
    }

    @Override
    public com.amazonaws.services.inspector.model.UnsupportedFeatureException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
