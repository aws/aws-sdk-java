...
/**
 * AssessmentRunStateChangeMarshaller
 */
    ...
    public void marshall(AssessmentRunStateChange assessmentRunStateChange, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (assessmentRunStateChange.getStateChangedAt() != null) {
                jsonGenerator.writeFieldName("stateChangedAt").writeValue(assessmentRunStateChange.getStateChangedAt());
            }
            if (assessmentRunStateChange.getState() != null) {
                jsonGenerator.writeFieldName("state").writeValue(assessmentRunStateChange.getState());
            }
