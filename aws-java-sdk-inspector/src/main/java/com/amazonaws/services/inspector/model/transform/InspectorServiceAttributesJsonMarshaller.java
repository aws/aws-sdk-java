...
public class InspectorServiceAttributesJsonMarshaller {
     ...
     */
    public void marshall(InspectorServiceAttributes inspectorServiceAttributes, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (inspectorServiceAttributes.getSchemaVersion() != null) {
                jsonGenerator.writeFieldName("schemaVersion").writeValue(inspectorServiceAttributes.getSchemaVersion());
            }
            if (inspectorServiceAttributes.getAssessmentRunArn() != null) {
                jsonGenerator.writeFieldName("assessmentRunArn").writeValue(inspectorServiceAttributes.getAssessmentRunArn());
            }
            if (inspectorServiceAttributes.getRulesPackageArn() != null) {
                jsonGenerator.writeFieldName("rulesPackageArn").writeValue(inspectorServiceAttributes.getRulesPackageArn());
            }
