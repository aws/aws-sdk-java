...
public class GetAssessmentReportRequestMarshaller {
    ...
    private static final MarshallingInfo<String> REPORTFILEFORMAT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("reportFileFormat").build();
    private static final MarshallingInfo<String> REPORTTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("reportType").build();

    private static final GetAssessmentReportRequestMarshaller instance = new GetAssessmentReportRequestMarshaller();

    public static GetAssessmentReportRequestMarshaller getInstance() {
        return instance;
    }
