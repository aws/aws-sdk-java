 ...
 * 
 */
public class DescribeRulesPackagesResult implements Serializable, Cloneable {
    ...
    public void setRulesPackages(
            java.util.Collection<RulesPackage> rulesPackages) {
        if (rulesPackages == null) {
            this.rulesPackages = null;
            return;
        }

        this.rulesPackages = new java.util.ArrayList<RulesPackage>(
                rulesPackages);
    }
    ...
    public DescribeRulesPackagesResult withRulesPackages(
            RulesPackage... rulesPackages) {
        if (this.rulesPackages == null) {
            setRulesPackages(new java.util.ArrayList<RulesPackage>(
     ...
     * </p>
     * 
     * @return Rules package details that cannot be described. An error code is
    ...
    public DescribeRulesPackagesResult withFailedItems(
            java.util.Map<String, FailedItemDetails> failedItems) {
        setFailedItems(failedItems);
        return this;
    }

    public DescribeRulesPackagesResult addFailedItemsEntry(String key,
