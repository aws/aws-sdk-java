...
public class RegisterCrossAccountAccessRoleRequestMarshaller
    ...
    public RegisterCrossAccountAccessRoleRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<RegisterCrossAccountAccessRoleRequest> marshall(
        ...
        try {
            ...
            if (registerCrossAccountAccessRoleRequest.getRoleArn() != null) {
                jsonGenerator.writeFieldName("roleArn").writeValue(
                        registerCrossAccountAccessRoleRequest.getRoleArn());
            }
