...
public class ListRunsResult implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<String> runArnList;
    /**
     * <p>
    ...
    public void setRunArnList(java.util.Collection<String> runArnList) {
        ...
        this.runArnList = new java.util.ArrayList<String>(runArnList);
    }
     ...
     * any). Use {@link #setRunArnList(java.util.Collection)} or
     * {@link #withRunArnList(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param runArnList
    ...
    public ListRunsResult withRunArnList(String... runArnList) {
        ...
        for (String ele : runArnList) {
            this.runArnList.add(ele);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getRunArnList() != null)
            sb.append("RunArnList: " + getRunArnList() + ",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getRunArnList() == null ^ this.getRunArnList() == null)
            return false;
        if (other.getRunArnList() != null
                && other.getRunArnList().equals(this.getRunArnList()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getRunArnList() == null) ? 0 : getRunArnList().hashCode());
        hashCode = prime * hashCode
