...
public class CreateApplicationRequestMarshaller implements
    ...
    public Request<CreateApplicationRequest> marshall(
        ...
        Request<CreateApplicationRequest> request = new DefaultRequest<CreateApplicationRequest>(
                createApplicationRequest, "AmazonInspector");
        request.addHeader("X-Amz-Target", "InspectorService.CreateApplication");
        ...
        try {
            ...
            if (createApplicationRequest.getResourceGroupArn() != null) {
                jsonWriter.key("resourceGroupArn").value(
                        createApplicationRequest.getResourceGroupArn());
            }
