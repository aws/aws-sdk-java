...
/**
 * LocalizeTextRequest Marshaller
 */
public class LocalizeTextRequestMarshaller implements
        Marshaller<Request<LocalizeTextRequest>, LocalizeTextRequest> {

    public Request<LocalizeTextRequest> marshall(
        ...
        Request<LocalizeTextRequest> request = new DefaultRequest<LocalizeTextRequest>(
                localizeTextRequest, "AmazonInspector");
