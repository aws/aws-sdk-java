 ...
 */
public class UpdateAssessmentRequestMarshaller implements
        Marshaller<Request<UpdateAssessmentRequest>, UpdateAssessmentRequest> {

    public Request<UpdateAssessmentRequest> marshall(
        ...
        Request<UpdateAssessmentRequest> request = new DefaultRequest<UpdateAssessmentRequest>(
                updateAssessmentRequest, "AmazonInspector");
