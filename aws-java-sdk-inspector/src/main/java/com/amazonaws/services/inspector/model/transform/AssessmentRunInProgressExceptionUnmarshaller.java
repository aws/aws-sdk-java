...
public class AssessmentRunInProgressExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AssessmentRunInProgressExceptionUnmarshaller instance;

    public static AssessmentRunInProgressExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssessmentRunInProgressExceptionUnmarshaller();
        return instance;
    }
}
