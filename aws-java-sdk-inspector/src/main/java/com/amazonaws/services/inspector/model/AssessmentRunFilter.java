...
public class AssessmentRunFilter implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return For a record to match a filter, one of the values specified for
     *         this data type property must be the exact match of the value of
     *         the <b>assessmentRunState</b> property of the
     *         <a>AssessmentRun</a> data type.
     ...
     *        this data type property must be the exact match of the value of
     *        the <b>assessmentRunState</b> property of the <a>AssessmentRun</a>
     *        data type.
     * @see AssessmentRunState
     */
     ...
     * any). Use {@link #setStates(java.util.Collection)} or
     * {@link #withStates(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param states
    ...
    public AssessmentRunFilter withStates(AssessmentRunState... states) {
        java.util.ArrayList<String> statesCopy = new java.util.ArrayList<String>(
                states.length);
    ...
    public AssessmentRunFilter withRulesPackageArns(
            java.util.Collection<String> rulesPackageArns) {
    ...
    public AssessmentRunFilter withCompletionTimeRange(
    ...
    public AssessmentRunFilter withStateChangeTimeRange(
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getStates() == null ^ this.getStates() == null)
            return false;
        if (other.getStates() != null
                && other.getStates().equals(this.getStates()) == false)
            return false;
        ...
        if (other.getStartTimeRange() != null
            ...
            return false;
        if (other.getCompletionTimeRange() == null
                ^ this.getCompletionTimeRange() == null)
            return false;
        if (other.getCompletionTimeRange() != null
                && other.getCompletionTimeRange().equals(
                        this.getCompletionTimeRange()) == false)
            return false;
        if (other.getStateChangeTimeRange() == null
                ^ this.getStateChangeTimeRange() == null)
            return false;
        if (other.getStateChangeTimeRange() != null
                && other.getStateChangeTimeRange().equals(
                        this.getStateChangeTimeRange()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getStates() == null) ? 0 : getStates().hashCode());
        hashCode = prime
                * hashCode
        ...
        hashCode = prime
                * hashCode
                + ((getCompletionTimeRange() == null) ? 0
                        : getCompletionTimeRange().hashCode());
        hashCode = prime
                * hashCode
                + ((getStateChangeTimeRange() == null) ? 0
                        : getStateChangeTimeRange().hashCode());
        return hashCode;
    }
