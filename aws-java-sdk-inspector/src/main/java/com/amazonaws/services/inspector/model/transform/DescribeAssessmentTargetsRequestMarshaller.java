...
public class DescribeAssessmentTargetsRequestMarshaller
    ...
    public DescribeAssessmentTargetsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeAssessmentTargetsRequest> marshall(
        ...
        Request<DescribeAssessmentTargetsRequest> request = new DefaultRequest<DescribeAssessmentTargetsRequest>(
                describeAssessmentTargetsRequest, "AmazonInspector");
        ...
        try {
            ...
            java.util.List<String> assessmentTargetArnsList = describeAssessmentTargetsRequest
