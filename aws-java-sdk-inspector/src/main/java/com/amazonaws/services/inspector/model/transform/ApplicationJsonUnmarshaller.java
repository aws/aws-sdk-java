 ...
 */
public class ApplicationJsonUnmarshaller implements
        Unmarshaller<Application, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("applicationArn", targetDepth)) {
                    context.nextToken();
                    application.setApplicationArn(StringJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
                if (context.testExpression("applicationName", targetDepth)) {
                    context.nextToken();
                    application.setApplicationName(StringJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
                if (context.testExpression("resourceGroupArn", targetDepth)) {
                    context.nextToken();
                    application.setResourceGroupArn(StringJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
