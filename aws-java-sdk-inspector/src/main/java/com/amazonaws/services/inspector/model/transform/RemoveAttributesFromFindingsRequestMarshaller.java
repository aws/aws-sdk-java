...
public class RemoveAttributesFromFindingsRequestMarshaller implements
    ...
    public Request<RemoveAttributesFromFindingsRequest> marshall(RemoveAttributesFromFindingsRequest removeAttributesFromFindingsRequest) {
        ...
        Request<RemoveAttributesFromFindingsRequest> request = new DefaultRequest<RemoveAttributesFromFindingsRequest>(removeAttributesFromFindingsRequest,
                "AmazonInspector");
        ...
        try {
            ...
            java.util.List<String> findingArnsList = removeAttributesFromFindingsRequest.getFindingArns();
            ...
            java.util.List<String> attributeKeysList = removeAttributesFromFindingsRequest.getAttributeKeys();
