 ...
 */
public class ListAssessmentTemplatesResultJsonUnmarshaller implements
        Unmarshaller<ListAssessmentTemplatesResult, JsonUnmarshallerContext> {

    public ListAssessmentTemplatesResult unmarshall(
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("assessmentTemplateArns",
                        targetDepth)) {
                    context.nextToken();
                    listAssessmentTemplatesResult
                            .setAssessmentTemplateArns(new ListUnmarshaller<String>(
                                    context.getUnmarshaller(String.class))
                                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listAssessmentTemplatesResult.setNextToken(context
