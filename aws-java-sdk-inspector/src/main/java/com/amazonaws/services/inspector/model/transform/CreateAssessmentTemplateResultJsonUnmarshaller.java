 ...
 */
public class CreateAssessmentTemplateResultJsonUnmarshaller implements
        Unmarshaller<CreateAssessmentTemplateResult, JsonUnmarshallerContext> {

    public CreateAssessmentTemplateResult unmarshall(
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context
                    ...
                    createAssessmentTemplateResult
                            .setAssessmentTemplateArn(context.getUnmarshaller(
