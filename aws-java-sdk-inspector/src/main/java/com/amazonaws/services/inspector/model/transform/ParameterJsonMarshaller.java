...
public class ParameterJsonMarshaller {
     ...
     */
    public void marshall(Parameter parameter, JSONWriter jsonWriter) {
        if (parameter == null) {
        ...
        try {
            ...
            if (parameter.getName() != null) {
                jsonWriter.key("name").value(parameter.getName());
            }

            if (parameter.getValue() != null) {
                jsonWriter.key("value").value(parameter.getValue());
            }
