 ...
 */
public class ListAssessmentTargetsRequestMarshaller implements Marshaller<Request<ListAssessmentTargetsRequest>, ListAssessmentTargetsRequest> {
    ...
    public Request<ListAssessmentTargetsRequest> marshall(ListAssessmentTargetsRequest listAssessmentTargetsRequest) {
        ...
        Request<ListAssessmentTargetsRequest> request = new DefaultRequest<ListAssessmentTargetsRequest>(listAssessmentTargetsRequest, "AmazonInspector");
