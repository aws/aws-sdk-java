...
public class EventSubscriptionJsonMarshaller {
     ...
     */
    public void marshall(EventSubscription eventSubscription,
        ...
        try {
            ...
            if (eventSubscription.getEvent() != null) {
                jsonGenerator.writeFieldName("event").writeValue(
                        eventSubscription.getEvent());
            }
            if (eventSubscription.getSubscribedAt() != null) {
                jsonGenerator.writeFieldName("subscribedAt").writeValue(
                        eventSubscription.getSubscribedAt());
            }
