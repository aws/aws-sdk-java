...
public class DescribeAssessmentTemplatesResultJsonUnmarshaller implements Unmarshaller<DescribeAssessmentTemplatesResult, JsonUnmarshallerContext> {
    ...
    private static DescribeAssessmentTemplatesResultJsonUnmarshaller instance;

    public static DescribeAssessmentTemplatesResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeAssessmentTemplatesResultJsonUnmarshaller();
        return instance;
    }
}
