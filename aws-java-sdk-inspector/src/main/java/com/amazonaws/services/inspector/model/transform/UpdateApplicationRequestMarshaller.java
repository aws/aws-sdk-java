...
public class UpdateApplicationRequestMarshaller implements
    ...
    public Request<UpdateApplicationRequest> marshall(
        ...
        Request<UpdateApplicationRequest> request = new DefaultRequest<UpdateApplicationRequest>(
                updateApplicationRequest, "AmazonInspector");
        request.addHeader("X-Amz-Target", "InspectorService.UpdateApplication");
        ...
        try {
            ...
            if (updateApplicationRequest.getApplicationArn() != null) {
                jsonWriter.key("applicationArn").value(
                        updateApplicationRequest.getApplicationArn());
            }

            if (updateApplicationRequest.getApplicationName() != null) {
                jsonWriter.key("applicationName").value(
                        updateApplicationRequest.getApplicationName());
            }

            if (updateApplicationRequest.getResourceGroupArn() != null) {
                jsonWriter.key("resourceGroupArn").value(
                        updateApplicationRequest.getResourceGroupArn());
            }
