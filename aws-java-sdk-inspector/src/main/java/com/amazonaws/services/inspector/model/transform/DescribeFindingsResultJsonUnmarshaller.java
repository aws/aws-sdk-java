 ...
 */
public class DescribeFindingsResultJsonUnmarshaller implements
        Unmarshaller<DescribeFindingsResult, JsonUnmarshallerContext> {

    public DescribeFindingsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("findings", targetDepth)) {
                    ...
                    describeFindingsResult
                            .setFindings(new ListUnmarshaller<Finding>(
                                    FindingJsonUnmarshaller.getInstance())
                                    .unmarshall(context));
                }
