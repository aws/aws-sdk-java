...
public class SetTagsForResourceRequestMarshaller
        implements
        Marshaller<Request<SetTagsForResourceRequest>, SetTagsForResourceRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public SetTagsForResourceRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<SetTagsForResourceRequest> marshall(
        ...
        Request<SetTagsForResourceRequest> request = new DefaultRequest<SetTagsForResourceRequest>(
                setTagsForResourceRequest, "AmazonInspector");
        ...
        try {
            ...
            if (setTagsForResourceRequest.getResourceArn() != null) {
                jsonGenerator.writeFieldName("resourceArn").writeValue(
                        setTagsForResourceRequest.getResourceArn());
            }
