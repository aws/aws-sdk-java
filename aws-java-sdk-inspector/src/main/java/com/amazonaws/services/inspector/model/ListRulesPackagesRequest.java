...
public class ListRulesPackagesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * You can use this parameter when paginating results. Set the value of this parameter to null on your first call to
     * the <b>ListRulesPackages</b> action. Subsequent calls to the action fill <b>nextToken</b> in the request with the
     ...
     *        call to the <b>ListRulesPackages</b> action. Subsequent calls to the action fill <b>nextToken</b> in the
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListRulesPackagesRequest == false)
            return false;
        ListRulesPackagesRequest other = (ListRulesPackagesRequest) obj;
