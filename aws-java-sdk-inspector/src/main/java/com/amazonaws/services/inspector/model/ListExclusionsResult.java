...
public class ListExclusionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListExclusionsResult withExclusionArns(String... exclusionArns) {
    ...
    public ListExclusionsResult withExclusionArns(java.util.Collection<String> exclusionArns) {
    ...
    public ListExclusionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListExclusionsResult == false)
            return false;
        ListExclusionsResult other = (ListExclusionsResult) obj;
    ...
    @Override
    public ListExclusionsResult clone() {
        try {
            return (ListExclusionsResult) super.clone();
