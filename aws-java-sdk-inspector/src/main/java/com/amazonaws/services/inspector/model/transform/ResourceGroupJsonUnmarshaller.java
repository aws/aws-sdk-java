 ...
 */
public class ResourceGroupJsonUnmarshaller implements
        Unmarshaller<ResourceGroup, JsonUnmarshallerContext> {

    public ResourceGroup unmarshall(JsonUnmarshallerContext context)
            throws Exception {
