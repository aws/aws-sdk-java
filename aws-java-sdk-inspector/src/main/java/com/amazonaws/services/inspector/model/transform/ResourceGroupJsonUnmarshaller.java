...
public class ResourceGroupJsonUnmarshaller implements Unmarshaller<ResourceGroup, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("arn", targetDepth)) {
                    context.nextToken();
                    resourceGroup.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ResourceGroupJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceGroupJsonUnmarshaller();
        return instance;
    }
}
