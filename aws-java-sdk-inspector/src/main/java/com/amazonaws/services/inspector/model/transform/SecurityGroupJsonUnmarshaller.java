...
/**
 * SecurityGroup JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("groupName", targetDepth)) {
                    context.nextToken();
                    securityGroup.setGroupName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("groupId", targetDepth)) {
                    context.nextToken();
                    securityGroup.setGroupId(context.getUnmarshaller(String.class).unmarshall(context));
                }
