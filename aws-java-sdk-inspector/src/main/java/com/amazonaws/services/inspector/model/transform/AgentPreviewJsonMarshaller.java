    ...
    public void marshall(AgentPreview agentPreview, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (agentPreview.getAgentId() != null) {
                jsonGenerator.writeFieldName("agentId").writeValue(agentPreview.getAgentId());
            }
            if (agentPreview.getAutoScalingGroup() != null) {
                jsonGenerator.writeFieldName("autoScalingGroup").writeValue(agentPreview.getAutoScalingGroup());
            }
