 ...
 */
public class StopAssessmentRunResultJsonUnmarshaller implements
        Unmarshaller<StopAssessmentRunResult, JsonUnmarshallerContext> {

    public StopAssessmentRunResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
