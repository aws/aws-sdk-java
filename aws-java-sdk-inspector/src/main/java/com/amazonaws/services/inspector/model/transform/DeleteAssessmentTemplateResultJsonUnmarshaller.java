 ...
 */
public class DeleteAssessmentTemplateResultJsonUnmarshaller implements
        Unmarshaller<DeleteAssessmentTemplateResult, JsonUnmarshallerContext> {

    public DeleteAssessmentTemplateResult unmarshall(
