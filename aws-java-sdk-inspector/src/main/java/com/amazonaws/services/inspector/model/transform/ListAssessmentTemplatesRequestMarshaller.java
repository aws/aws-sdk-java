...
public class ListAssessmentTemplatesRequestMarshaller
        implements
        Marshaller<Request<ListAssessmentTemplatesRequest>, ListAssessmentTemplatesRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public ListAssessmentTemplatesRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<ListAssessmentTemplatesRequest> marshall(
        ...
        Request<ListAssessmentTemplatesRequest> request = new DefaultRequest<ListAssessmentTemplatesRequest>(
                listAssessmentTemplatesRequest, "AmazonInspector");
        ...
        try {
            ...
            java.util.List<String> assessmentTargetArnsList = listAssessmentTemplatesRequest
