 ...
 */
public class ListAssessmentRunsResultJsonUnmarshaller implements
        Unmarshaller<ListAssessmentRunsResult, JsonUnmarshallerContext> {

    public ListAssessmentRunsResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("assessmentRunArns", targetDepth)) {
                    ...
                    listAssessmentRunsResult
                            .setAssessmentRunArns(new ListUnmarshaller<String>(
                                    context.getUnmarshaller(String.class))
                                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listAssessmentRunsResult.setNextToken(context
