...
public class AssessmentTemplateFilterJsonMarshaller {
     ...
     */
    public void marshall(AssessmentTemplateFilter assessmentTemplateFilter, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (assessmentTemplateFilter.getNamePattern() != null) {
                jsonGenerator.writeFieldName("namePattern").writeValue(assessmentTemplateFilter.getNamePattern());
            }
            if (assessmentTemplateFilter.getDurationRange() != null) {
                jsonGenerator.writeFieldName("durationRange");
                DurationRangeJsonMarshaller.getInstance().marshall(assessmentTemplateFilter.getDurationRange(), jsonGenerator);
            }

            java.util.List<String> rulesPackageArnsList = assessmentTemplateFilter.getRulesPackageArns();
