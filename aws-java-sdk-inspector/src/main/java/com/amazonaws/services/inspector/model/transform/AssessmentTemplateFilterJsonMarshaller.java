...
public class AssessmentTemplateFilterJsonMarshaller {
     ...
     */
    public void marshall(AssessmentTemplateFilter assessmentTemplateFilter,
        ...
        try {
            ...
            if (assessmentTemplateFilter.getNamePattern() != null) {
                jsonGenerator.writeFieldName("namePattern").writeValue(
                        assessmentTemplateFilter.getNamePattern());
            }
            ...
            java.util.List<String> rulesPackageArnsList = assessmentTemplateFilter
                    .getRulesPackageArns();
