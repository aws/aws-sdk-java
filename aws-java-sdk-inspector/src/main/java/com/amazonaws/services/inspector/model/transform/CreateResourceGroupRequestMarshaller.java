...
public class CreateResourceGroupRequestMarshaller
        implements
        Marshaller<Request<CreateResourceGroupRequest>, CreateResourceGroupRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public CreateResourceGroupRequestMarshaller(
    ...
    public Request<CreateResourceGroupRequest> marshall(
        ...
        Request<CreateResourceGroupRequest> request = new DefaultRequest<CreateResourceGroupRequest>(
