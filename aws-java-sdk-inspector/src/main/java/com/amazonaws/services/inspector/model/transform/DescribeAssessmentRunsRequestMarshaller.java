...
public class DescribeAssessmentRunsRequestMarshaller
        implements
        Marshaller<Request<DescribeAssessmentRunsRequest>, DescribeAssessmentRunsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeAssessmentRunsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<DescribeAssessmentRunsRequest> marshall(
        ...
        Request<DescribeAssessmentRunsRequest> request = new DefaultRequest<DescribeAssessmentRunsRequest>(
                describeAssessmentRunsRequest, "AmazonInspector");
        ...
        try {
            ...
            java.util.List<String> assessmentRunArnsList = describeAssessmentRunsRequest
