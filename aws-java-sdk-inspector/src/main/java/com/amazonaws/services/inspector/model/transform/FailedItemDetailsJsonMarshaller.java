...
public class FailedItemDetailsJsonMarshaller {
     ...
     */
    public void marshall(FailedItemDetails failedItemDetails,
        ...
        try {
            ...
            if (failedItemDetails.getFailureCode() != null) {
                jsonGenerator.writeFieldName("failureCode").writeValue(
                        failedItemDetails.getFailureCode());
            }
            if (failedItemDetails.getRetryable() != null) {
                jsonGenerator.writeFieldName("retryable").writeValue(
                        failedItemDetails.getRetryable());
            }
