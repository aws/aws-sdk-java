...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.inspector.AmazonInspectorAsync}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonInspectorAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonInspectorAsyncClientBuilder, AmazonInspectorAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonInspectorAsync using
