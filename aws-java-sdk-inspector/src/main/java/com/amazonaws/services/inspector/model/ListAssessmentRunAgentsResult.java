 ...
 * 
 */
public class ListAssessmentRunAgentsResult implements Serializable, Cloneable {
    ...
    public void setAssessmentRunAgents(
            java.util.Collection<AssessmentRunAgent> assessmentRunAgents) {
        if (assessmentRunAgents == null) {
            this.assessmentRunAgents = null;
            return;
        }

        this.assessmentRunAgents = new java.util.ArrayList<AssessmentRunAgent>(
                assessmentRunAgents);
    }
     ...
     * any). Use {@link #setAssessmentRunAgents(java.util.Collection)} or
     * {@link #withAssessmentRunAgents(java.util.Collection)} if you want to
    ...
    public ListAssessmentRunAgentsResult withAssessmentRunAgents(
            AssessmentRunAgent... assessmentRunAgents) {
        if (this.assessmentRunAgents == null) {
            setAssessmentRunAgents(new java.util.ArrayList<AssessmentRunAgent>(
                    assessmentRunAgents.length));
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAssessmentRunAgents() == null
                ^ this.getAssessmentRunAgents() == null)
            return false;
        if (other.getAssessmentRunAgents() != null
                && other.getAssessmentRunAgents().equals(
                        this.getAssessmentRunAgents()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getAssessmentRunAgents() == null) ? 0
                        : getAssessmentRunAgents().hashCode());
