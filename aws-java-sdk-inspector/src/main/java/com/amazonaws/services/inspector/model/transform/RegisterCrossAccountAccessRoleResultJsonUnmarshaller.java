...
public class RegisterCrossAccountAccessRoleResultJsonUnmarshaller implements Unmarshaller<RegisterCrossAccountAccessRoleResult, JsonUnmarshallerContext> {

    public RegisterCrossAccountAccessRoleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
