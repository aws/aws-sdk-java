 ...
 */
public class AssessmentRunStateChangeJsonUnmarshaller implements
        Unmarshaller<AssessmentRunStateChange, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("stateChangedAt", targetDepth)) {
                    context.nextToken();
                    assessmentRunStateChange.setStateChangedAt(context
                            .getUnmarshaller(java.util.Date.class).unmarshall(
                                    context));
                }
                if (context.testExpression("state", targetDepth)) {
                    context.nextToken();
                    assessmentRunStateChange.setState(context.getUnmarshaller(
