 ...
 */
public class DeleteApplicationResultJsonUnmarshaller implements
        Unmarshaller<DeleteApplicationResult, JsonUnmarshallerContext> {

    public DeleteApplicationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("message", targetDepth)) {
                    context.nextToken();
                    deleteApplicationResult.setMessage(StringJsonUnmarshaller
