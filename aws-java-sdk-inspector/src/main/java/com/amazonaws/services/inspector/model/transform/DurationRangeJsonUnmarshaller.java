 ...
 */
public class DurationRangeJsonUnmarshaller implements
        Unmarshaller<DurationRange, JsonUnmarshallerContext> {

    public DurationRange unmarshall(JsonUnmarshallerContext context)
            throws Exception {
