...
public class AgentAlreadyRunningAssessmentJsonMarshaller {
     ...
     */
    public void marshall(AgentAlreadyRunningAssessment agentAlreadyRunningAssessment, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (agentAlreadyRunningAssessment.getAgentId() != null) {
                jsonGenerator.writeFieldName("agentId").writeValue(agentAlreadyRunningAssessment.getAgentId());
            }
            if (agentAlreadyRunningAssessment.getAssessmentRunArn() != null) {
                jsonGenerator.writeFieldName("assessmentRunArn").writeValue(agentAlreadyRunningAssessment.getAssessmentRunArn());
            }
