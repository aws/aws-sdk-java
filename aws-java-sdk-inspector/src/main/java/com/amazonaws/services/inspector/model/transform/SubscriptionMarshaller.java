...
public class SubscriptionMarshaller {
    ...
    public void marshall(Subscription subscription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(subscription.getResourceArn(), RESOURCEARN_BINDING);
            protocolMarshaller.marshall(subscription.getTopicArn(), TOPICARN_BINDING);
            protocolMarshaller.marshall(subscription.getEventSubscriptions(), EVENTSUBSCRIPTIONS_BINDING);
        } catch (Exception e) {
