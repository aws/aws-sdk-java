...
/**
 * ListEventSubscriptionsRequestMarshaller
 */
...
public class ListEventSubscriptionsRequestMarshaller {
    ...
    private static final ListEventSubscriptionsRequestMarshaller instance = new ListEventSubscriptionsRequestMarshaller();

    public static ListEventSubscriptionsRequestMarshaller getInstance() {
        return instance;
    }
