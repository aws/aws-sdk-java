 ...
 */
public class DescribeApplicationResultJsonUnmarshaller implements
        Unmarshaller<DescribeApplicationResult, JsonUnmarshallerContext> {

    public DescribeApplicationResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("application", targetDepth)) {
                    ...
                    describeApplicationResult
                            .setApplication(ApplicationJsonUnmarshaller
