...
public class DescribeResourceGroupsRequestMarshaller implements Marshaller<Request<DescribeResourceGroupsRequest>, DescribeResourceGroupsRequest> {
    ...
    public DescribeResourceGroupsRequestMarshaller(SdkJsonMarshallerFactory protocolFactory) {
    ...
    public Request<DescribeResourceGroupsRequest> marshall(DescribeResourceGroupsRequest describeResourceGroupsRequest) {
        ...
        Request<DescribeResourceGroupsRequest> request = new DefaultRequest<DescribeResourceGroupsRequest>(describeResourceGroupsRequest, "AmazonInspector");
        ...
        try {
            ...
            java.util.List<String> resourceGroupArnsList = describeResourceGroupsRequest.getResourceGroupArns();
