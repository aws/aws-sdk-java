 ...
 */
public class DescribeFindingsRequestMarshaller implements Marshaller<Request<DescribeFindingsRequest>, DescribeFindingsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public DescribeFindingsRequestMarshaller(SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DescribeFindingsRequest> marshall(DescribeFindingsRequest describeFindingsRequest) {
        ...
        Request<DescribeFindingsRequest> request = new DefaultRequest<DescribeFindingsRequest>(describeFindingsRequest, "AmazonInspector");
        ...
        try {
            ...
            java.util.List<String> findingArnsList = describeFindingsRequest.getFindingArns();
