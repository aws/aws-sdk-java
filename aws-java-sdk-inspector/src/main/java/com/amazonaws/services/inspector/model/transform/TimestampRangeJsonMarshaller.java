    ...
    public void marshall(TimestampRange timestampRange, StructuredJsonGenerator jsonGenerator) {
        ...
        try {
            ...
            if (timestampRange.getBeginDate() != null) {
                jsonGenerator.writeFieldName("beginDate").writeValue(timestampRange.getBeginDate());
            }
            if (timestampRange.getEndDate() != null) {
                jsonGenerator.writeFieldName("endDate").writeValue(timestampRange.getEndDate());
            }
