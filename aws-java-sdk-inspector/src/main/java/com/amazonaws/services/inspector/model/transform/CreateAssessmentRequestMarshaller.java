 ...
 */
public class CreateAssessmentRequestMarshaller implements
        Marshaller<Request<CreateAssessmentRequest>, CreateAssessmentRequest> {

    public Request<CreateAssessmentRequest> marshall(
        ...
        Request<CreateAssessmentRequest> request = new DefaultRequest<CreateAssessmentRequest>(
                createAssessmentRequest, "AmazonInspector");
