 ...
 */
public class ListRunsRequestMarshaller implements
        Marshaller<Request<ListRunsRequest>, ListRunsRequest> {
    ...
    public Request<ListRunsRequest> marshall(ListRunsRequest listRunsRequest) {
        ...
        Request<ListRunsRequest> request = new DefaultRequest<ListRunsRequest>(
                listRunsRequest, "AmazonInspector");
        ...
        try {
            ...
            java.util.List<String> assessmentArnsList = listRunsRequest
                    .getAssessmentArns();
            if (assessmentArnsList != null) {
                ...
                for (String assessmentArnsListValue : assessmentArnsList) {
                    if (assessmentArnsListValue != null) {
            ...
            if (listRunsRequest.getFilter() != null) {
                ...
                RunsFilterJsonMarshaller.getInstance().marshall(
                        listRunsRequest.getFilter(), jsonGenerator);
            }
            if (listRunsRequest.getNextToken() != null) {
                jsonGenerator.writeFieldName("nextToken").writeValue(
                        listRunsRequest.getNextToken());
            }
            if (listRunsRequest.getMaxResults() != null) {
                jsonGenerator.writeFieldName("maxResults").writeValue(
                        listRunsRequest.getMaxResults());
            }
