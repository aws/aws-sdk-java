...
public class DeleteApplicationRequestMarshaller implements
    ...
    public Request<DeleteApplicationRequest> marshall(
        ...
        Request<DeleteApplicationRequest> request = new DefaultRequest<DeleteApplicationRequest>(
                deleteApplicationRequest, "AmazonInspector");
        request.addHeader("X-Amz-Target", "InspectorService.DeleteApplication");
        ...
        try {
            ...
            if (deleteApplicationRequest.getApplicationArn() != null) {
                jsonWriter.key("applicationArn").value(
                        deleteApplicationRequest.getApplicationArn());
            }
