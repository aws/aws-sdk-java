...
public class ListAssessmentRunsRequestMarshaller
        implements
        Marshaller<Request<ListAssessmentRunsRequest>, ListAssessmentRunsRequest> {

    private final SdkJsonProtocolFactory protocolFactory;

    public ListAssessmentRunsRequestMarshaller(
            SdkJsonProtocolFactory protocolFactory) {
        this.protocolFactory = protocolFactory;
    }

    public Request<ListAssessmentRunsRequest> marshall(
        ...
        Request<ListAssessmentRunsRequest> request = new DefaultRequest<ListAssessmentRunsRequest>(
                listAssessmentRunsRequest, "AmazonInspector");
        ...
        try {
            ...
            java.util.List<String> assessmentTemplateArnsList = listAssessmentRunsRequest
            ...
            if (listAssessmentRunsRequest.getFilter() != null) {
                ...
                AssessmentRunFilterJsonMarshaller.getInstance().marshall(
                        listAssessmentRunsRequest.getFilter(), jsonGenerator);
            }
            if (listAssessmentRunsRequest.getNextToken() != null) {
                jsonGenerator.writeFieldName("nextToken").writeValue(
                        listAssessmentRunsRequest.getNextToken());
            }
            if (listAssessmentRunsRequest.getMaxResults() != null) {
                jsonGenerator.writeFieldName("maxResults").writeValue(
                        listAssessmentRunsRequest.getMaxResults());
            }
