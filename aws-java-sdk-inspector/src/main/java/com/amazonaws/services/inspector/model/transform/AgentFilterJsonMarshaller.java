...
public class AgentFilterJsonMarshaller {
     ...
     */
    public void marshall(AgentFilter agentFilter, SdkJsonGenerator jsonGenerator) {
        if (agentFilter == null) {
        ...
        try {
            ...
            java.util.List<String> agentHealthsList = agentFilter
                    .getAgentHealths();
            ...
            java.util.List<String> agentHealthCodesList = agentFilter
                    .getAgentHealthCodes();
