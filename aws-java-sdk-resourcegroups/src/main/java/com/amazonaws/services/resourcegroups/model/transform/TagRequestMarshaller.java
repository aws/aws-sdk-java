...
@SdkInternalApi
public class TagRequestMarshaller {
    ...
    private static final TagRequestMarshaller instance = new TagRequestMarshaller();

    public static TagRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(TagRequest tagRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(tagRequest.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(tagRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
