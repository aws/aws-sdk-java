...
/**
 * SearchResourcesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchResourcesResultJsonUnmarshaller implements Unmarshaller<SearchResourcesResult, JsonUnmarshallerContext> {

    public SearchResourcesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SearchResourcesResult searchResourcesResult = new SearchResourcesResult();
    ...
    private static SearchResourcesResultJsonUnmarshaller instance;

    public static SearchResourcesResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SearchResourcesResultJsonUnmarshaller();
        return instance;
    }
}
