...
public class SearchResourcesRequestMarshaller {
    ...
    public void marshall(SearchResourcesRequest searchResourcesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(searchResourcesRequest.getResourceQuery(), RESOURCEQUERY_BINDING);
            protocolMarshaller.marshall(searchResourcesRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(searchResourcesRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
