 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/PrivateDnsNamespaceProperties"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PrivateDnsNamespaceProperties implements Serializable, Cloneable, StructuredPojo {
    ...
    public PrivateDnsPropertiesMutable getDnsProperties() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PrivateDnsNamespaceProperties == false)
            return false;
    ...
    public PrivateDnsNamespaceProperties clone() {
        try {
            return (PrivateDnsNamespaceProperties) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.servicediscovery.model.transform.PrivateDnsNamespacePropertiesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
