...
public class DnsConfig implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * <p>
     * For example, suppose the service includes configurations for one <code>A</code> record and a health check, and
     ...
     *        </p>
     *        <p>
     *        For example, suppose the service includes configurations for one <code>A</code> record and a health check,
     ...
     *         </p>
     *         <p>
     *         For example, suppose the service includes configurations for one <code>A</code> record and a health
