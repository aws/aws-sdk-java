...
public class InstanceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InstanceNotFoundExceptionUnmarshaller instance;

    public static InstanceNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InstanceNotFoundExceptionUnmarshaller();
        return instance;
    }
}
