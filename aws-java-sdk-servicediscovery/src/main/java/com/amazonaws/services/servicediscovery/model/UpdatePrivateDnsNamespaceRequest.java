...
public class UpdatePrivateDnsNamespaceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A unique string that identifies the request and that allows failed <code>UpdatePrivateDnsNamespace</code>
     * requests to be retried without the risk of running the operation twice. <code>UpdaterRequestId</code> can be any
     ...
     * </p>
     * 
     * @return A unique string that identifies the request and that allows failed <code>UpdatePrivateDnsNamespace</code>
     *         requests to be retried without the risk of running the operation twice. <code>UpdaterRequestId</code> can
     *         be any unique string (for example, a date/timestamp).
     */
    ...
    public void setNamespace(PrivateDnsNamespaceChange namespace) {
     ...
     * </p>
     * 
     * @return Updated properties for the private DNS namespace.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePrivateDnsNamespaceRequest == false)
            return false;
        UpdatePrivateDnsNamespaceRequest other = (UpdatePrivateDnsNamespaceRequest) obj;
    ...
    @Override
    public UpdatePrivateDnsNamespaceRequest clone() {
