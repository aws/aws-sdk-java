...
public class CreatePrivateDnsNamespaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePrivateDnsNamespaceResult == false)
            return false;
        CreatePrivateDnsNamespaceResult other = (CreatePrivateDnsNamespaceResult) obj;
    ...
    @Override
    public CreatePrivateDnsNamespaceResult clone() {
        try {
            return (CreatePrivateDnsNamespaceResult) super.clone();
