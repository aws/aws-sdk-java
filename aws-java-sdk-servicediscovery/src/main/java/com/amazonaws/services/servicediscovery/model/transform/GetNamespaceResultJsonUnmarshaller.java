...
/**
 * GetNamespaceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetNamespaceResultJsonUnmarshaller implements Unmarshaller<GetNamespaceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Namespace", targetDepth)) {
                    context.nextToken();
                    getNamespaceResult.setNamespace(NamespaceJsonUnmarshaller.getInstance().unmarshall(context));
                }
