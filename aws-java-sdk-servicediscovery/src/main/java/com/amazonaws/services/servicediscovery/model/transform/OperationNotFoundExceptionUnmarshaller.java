...
public class OperationNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OperationNotFoundExceptionUnmarshaller instance;

    public static OperationNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OperationNotFoundExceptionUnmarshaller();
        return instance;
    }
}
