...
public class DeregisterInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeregisterInstanceResult == false)
            return false;
        DeregisterInstanceResult other = (DeregisterInstanceResult) obj;
    ...
    public DeregisterInstanceResult clone() {
        try {
            return (DeregisterInstanceResult) super.clone();
