...
public class NamespaceAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.servicediscovery.model.NamespaceAlreadyExistsException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CreatorRequestId", targetDepth)) {
                    context.nextToken();
                    namespaceAlreadyExistsException.setCreatorRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("NamespaceId", targetDepth)) {
                    context.nextToken();
                    namespaceAlreadyExistsException.setNamespaceId(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return namespaceAlreadyExistsException;
    }

    private static NamespaceAlreadyExistsExceptionUnmarshaller instance;

    public static NamespaceAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NamespaceAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
