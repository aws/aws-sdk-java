        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("VpcId", targetDepth)) {
                    context.nextToken();
                    vpcEndpoint.setVpcId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("VpcOptions", targetDepth)) {
                    context.nextToken();
                    vpcEndpoint.setVpcOptions(VpcOptionsJsonUnmarshaller.getInstance().unmarshall(context));
                }
