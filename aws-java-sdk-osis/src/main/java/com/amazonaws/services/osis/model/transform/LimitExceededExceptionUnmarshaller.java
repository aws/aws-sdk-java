...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.osis.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.osis.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.osis.model.LimitExceededException limitExceededException = new com.amazonaws.services.osis.model.LimitExceededException(null);
