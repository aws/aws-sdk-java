...
/**
 * GetPipelineBlueprintRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetPipelineBlueprintRequestMarshaller {
    ...
    public static GetPipelineBlueprintRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetPipelineBlueprintRequest getPipelineBlueprintRequest, ProtocolMarshaller protocolMarshaller) {

        if (getPipelineBlueprintRequest == null) {
