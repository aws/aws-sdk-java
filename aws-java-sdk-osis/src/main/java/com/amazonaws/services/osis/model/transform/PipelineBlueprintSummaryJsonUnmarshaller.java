...
/**
 * PipelineBlueprintSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PipelineBlueprintSummaryJsonUnmarshaller implements Unmarshaller<PipelineBlueprintSummary, JsonUnmarshallerContext> {

    public PipelineBlueprintSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        PipelineBlueprintSummary pipelineBlueprintSummary = new PipelineBlueprintSummary();
    ...
    private static PipelineBlueprintSummaryJsonUnmarshaller instance;

    public static PipelineBlueprintSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PipelineBlueprintSummaryJsonUnmarshaller();
        return instance;
    }
}
