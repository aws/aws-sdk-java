 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/osis-2022-01-01/ChangeProgressStage" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ChangeProgressStage implements Serializable, Cloneable, StructuredPojo {
     ...
     * @param status
     *        The current status of the stage that the change is in.
     * @see ChangeProgressStageStatuses
     */
     ...
     * </p>
     * 
     * @return The current status of the stage that the change is in.
     * @see ChangeProgressStageStatuses
     */
    ...
    public ChangeProgressStage withStatus(ChangeProgressStageStatuses status) {
    ...
    public ChangeProgressStage withLastUpdatedAt(java.util.Date lastUpdatedAt) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.osis.model.transform.ChangeProgressStageMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
