...
/**
 * DatasetInputDataConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DatasetInputDataConfigJsonUnmarshaller implements Unmarshaller<DatasetInputDataConfig, JsonUnmarshallerContext> {

    public DatasetInputDataConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        DatasetInputDataConfig datasetInputDataConfig = new DatasetInputDataConfig();
    ...
    private static DatasetInputDataConfigJsonUnmarshaller instance;

    public static DatasetInputDataConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DatasetInputDataConfigJsonUnmarshaller();
        return instance;
    }
}
