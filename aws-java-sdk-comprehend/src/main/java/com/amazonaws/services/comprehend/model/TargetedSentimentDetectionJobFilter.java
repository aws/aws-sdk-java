...
public class TargetedSentimentDetectionJobFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public TargetedSentimentDetectionJobFilter withJobStatus(String jobStatus) {
    ...
    public TargetedSentimentDetectionJobFilter withJobStatus(JobStatus jobStatus) {
    ...
    public TargetedSentimentDetectionJobFilter withSubmitTimeBefore(java.util.Date submitTimeBefore) {
    ...
    public TargetedSentimentDetectionJobFilter withSubmitTimeAfter(java.util.Date submitTimeAfter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TargetedSentimentDetectionJobFilter == false)
            return false;
        TargetedSentimentDetectionJobFilter other = (TargetedSentimentDetectionJobFilter) obj;
    ...
    @Override
    public TargetedSentimentDetectionJobFilter clone() {
        try {
            return (TargetedSentimentDetectionJobFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehend.model.transform.TargetedSentimentDetectionJobFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
