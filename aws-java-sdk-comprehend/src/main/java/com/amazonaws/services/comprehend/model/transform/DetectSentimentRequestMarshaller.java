...
@SdkInternalApi
public class DetectSentimentRequestMarshaller {
    ...
    private static final DetectSentimentRequestMarshaller instance = new DetectSentimentRequestMarshaller();

    public static DetectSentimentRequestMarshaller getInstance() {
        return instance;
    }
