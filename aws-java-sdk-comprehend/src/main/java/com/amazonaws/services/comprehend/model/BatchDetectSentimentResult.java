...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/BatchDetectSentiment" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchDetectSentimentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<BatchDetectSentimentItemResult> resultList;
    /**
     * <p>
    ...
    public void setResultList(java.util.Collection<BatchDetectSentimentItemResult> resultList) {
        ...
        this.resultList = new java.util.ArrayList<BatchDetectSentimentItemResult>(resultList);
    }
    ...
    public BatchDetectSentimentResult withResultList(BatchDetectSentimentItemResult... resultList) {
        if (this.resultList == null) {
            setResultList(new java.util.ArrayList<BatchDetectSentimentItemResult>(resultList.length));
        }
        for (BatchDetectSentimentItemResult ele : resultList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchDetectSentimentResult == false)
            return false;
        BatchDetectSentimentResult other = (BatchDetectSentimentResult) obj;
    ...
    @Override
    public BatchDetectSentimentResult clone() {
        try {
