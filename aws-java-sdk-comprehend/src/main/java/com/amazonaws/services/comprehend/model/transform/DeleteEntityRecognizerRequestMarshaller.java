...
/**
 * DeleteEntityRecognizerRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteEntityRecognizerRequestMarshaller {
    ...
    private static final DeleteEntityRecognizerRequestMarshaller instance = new DeleteEntityRecognizerRequestMarshaller();

    public static DeleteEntityRecognizerRequestMarshaller getInstance() {
        return instance;
    }
