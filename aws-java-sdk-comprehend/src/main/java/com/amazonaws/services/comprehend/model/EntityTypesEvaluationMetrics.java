 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/EntityTypesEvaluationMetrics"
...
public class EntityTypesEvaluationMetrics implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EntityTypesEvaluationMetrics == false)
            return false;
    ...
    @Override
    public EntityTypesEvaluationMetrics clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehend.model.transform.EntityTypesEvaluationMetricsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
