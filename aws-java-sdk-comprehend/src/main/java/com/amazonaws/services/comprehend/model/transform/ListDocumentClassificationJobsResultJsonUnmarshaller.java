...
/**
 * ListDocumentClassificationJobsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDocumentClassificationJobsResultJsonUnmarshaller implements Unmarshaller<ListDocumentClassificationJobsResult, JsonUnmarshallerContext> {

    public ListDocumentClassificationJobsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listDocumentClassificationJobsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
