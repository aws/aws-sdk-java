...
/**
 * EntityRecognizerDocumentsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EntityRecognizerDocumentsMarshaller {
    ...
    public static EntityRecognizerDocumentsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EntityRecognizerDocuments entityRecognizerDocuments, ProtocolMarshaller protocolMarshaller) {

        if (entityRecognizerDocuments == null) {
