...
public class ListFlywheelsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * Filters the flywheels that are returned. You can filter flywheels on their status, or the date and time that they
     * were submitted. You can only set one filter at a time.
     * </p>
     */
    private FlywheelFilter filter;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return Filters the flywheels that are returned. You can filter flywheels on their status, or the date and time
     *         that they were submitted. You can only set one filter at a time.
     */

    public FlywheelFilter getFilter() {
        return this.filter;
    }
     ...
     * </p>
     * 
     * @return Maximum number of results to return in a response. The default is 100.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFlywheelsRequest == false)
            return false;
        ListFlywheelsRequest other = (ListFlywheelsRequest) obj;
    ...
    public ListFlywheelsRequest clone() {
        return (ListFlywheelsRequest) super.clone();
    }
