 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/EventsDetectionJobFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EventsDetectionJobFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Filters on the name of the events detection job.
     */
    ...
    public EventsDetectionJobFilter withSubmitTimeBefore(java.util.Date submitTimeBefore) {
    ...
    public EventsDetectionJobFilter withSubmitTimeAfter(java.util.Date submitTimeAfter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EventsDetectionJobFilter == false)
            return false;
        EventsDetectionJobFilter other = (EventsDetectionJobFilter) obj;
    ...
    public EventsDetectionJobFilter clone() {
        try {
            return (EventsDetectionJobFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehend.model.transform.EventsDetectionJobFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
