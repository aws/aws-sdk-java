...
public class ListSentimentDetectionJobsRequestMarshaller {
    ...
    private static final ListSentimentDetectionJobsRequestMarshaller instance = new ListSentimentDetectionJobsRequestMarshaller();

    public static ListSentimentDetectionJobsRequestMarshaller getInstance() {
        return instance;
    }
