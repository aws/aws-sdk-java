 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/DatasetEntityRecognizerAnnotations"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DatasetEntityRecognizerAnnotations implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DatasetEntityRecognizerAnnotations == false)
            return false;
        DatasetEntityRecognizerAnnotations other = (DatasetEntityRecognizerAnnotations) obj;
    ...
    public DatasetEntityRecognizerAnnotations clone() {
        try {
            return (DatasetEntityRecognizerAnnotations) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehend.model.transform.DatasetEntityRecognizerAnnotationsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
