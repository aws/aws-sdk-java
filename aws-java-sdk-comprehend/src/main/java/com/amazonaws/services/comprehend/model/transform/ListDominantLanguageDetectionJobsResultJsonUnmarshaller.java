...
/**
 * ListDominantLanguageDetectionJobsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDominantLanguageDetectionJobsResultJsonUnmarshaller implements Unmarshaller<ListDominantLanguageDetectionJobsResult, JsonUnmarshallerContext> {

    public ListDominantLanguageDetectionJobsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DominantLanguageDetectionJobPropertiesList", targetDepth)) {
                    context.nextToken();
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listDominantLanguageDetectionJobsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
