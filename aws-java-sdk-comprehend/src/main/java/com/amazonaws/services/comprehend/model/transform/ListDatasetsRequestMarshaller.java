...
public class ListDatasetsRequestMarshaller {
    ...
    public void marshall(ListDatasetsRequest listDatasetsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listDatasetsRequest.getFlywheelArn(), FLYWHEELARN_BINDING);
            protocolMarshaller.marshall(listDatasetsRequest.getFilter(), FILTER_BINDING);
