...
/**
 * EntityRecognizerMetadataMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EntityRecognizerMetadataMarshaller {
    ...
    private static final EntityRecognizerMetadataMarshaller instance = new EntityRecognizerMetadataMarshaller();

    public static EntityRecognizerMetadataMarshaller getInstance() {
        return instance;
    }
