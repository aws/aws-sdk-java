...
public class StopSentimentDetectionJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopSentimentDetectionJobResult == false)
            return false;
        StopSentimentDetectionJobResult other = (StopSentimentDetectionJobResult) obj;
    ...
    public StopSentimentDetectionJobResult clone() {
        try {
            return (StopSentimentDetectionJobResult) super.clone();
