...
public class DescribeSentimentDetectionJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DescribeSentimentDetectionJobResult withSentimentDetectionJobProperties(SentimentDetectionJobProperties sentimentDetectionJobProperties) {
        setSentimentDetectionJobProperties(sentimentDetectionJobProperties);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSentimentDetectionJobProperties() == null ^ this.getSentimentDetectionJobProperties() == null)
            return false;
        if (other.getSentimentDetectionJobProperties() != null
                && other.getSentimentDetectionJobProperties().equals(this.getSentimentDetectionJobProperties()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSentimentDetectionJobProperties() == null) ? 0 : getSentimentDetectionJobProperties().hashCode());
        return hashCode;
    }
    ...
    public DescribeSentimentDetectionJobResult clone() {
        try {
            return (DescribeSentimentDetectionJobResult) super.clone();
