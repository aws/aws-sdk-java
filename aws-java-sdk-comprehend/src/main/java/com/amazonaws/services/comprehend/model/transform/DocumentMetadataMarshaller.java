...
public class DocumentMetadataMarshaller {
    ...
    private static final MarshallingInfo<Integer> PAGES_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Pages").build();
    private static final MarshallingInfo<List> EXTRACTEDCHARACTERS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ExtractedCharacters").build();
    ...
    public void marshall(DocumentMetadata documentMetadata, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(documentMetadata.getPages(), PAGES_BINDING);
