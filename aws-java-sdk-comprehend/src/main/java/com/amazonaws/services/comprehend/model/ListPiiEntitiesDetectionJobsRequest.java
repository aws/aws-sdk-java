...
public class ListPiiEntitiesDetectionJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public void setFilter(PiiEntitiesDetectionJobFilter filter) {
        this.filter = filter;
    }
    ...
    public PiiEntitiesDetectionJobFilter getFilter() {
        return this.filter;
    }
    ...
    public ListPiiEntitiesDetectionJobsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPiiEntitiesDetectionJobsRequest == false)
            return false;
        ListPiiEntitiesDetectionJobsRequest other = (ListPiiEntitiesDetectionJobsRequest) obj;
    ...
    @Override
    public ListPiiEntitiesDetectionJobsRequest clone() {
        return (ListPiiEntitiesDetectionJobsRequest) super.clone();
    }
