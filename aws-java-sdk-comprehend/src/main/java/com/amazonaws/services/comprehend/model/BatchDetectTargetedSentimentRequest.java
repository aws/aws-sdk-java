...
public class BatchDetectTargetedSentimentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public BatchDetectTargetedSentimentRequest clone() {
        return (BatchDetectTargetedSentimentRequest) super.clone();
    }
