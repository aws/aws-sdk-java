...
public class StopEntitiesDetectionJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public StopEntitiesDetectionJobResult clone() {
        try {
            return (StopEntitiesDetectionJobResult) super.clone();
