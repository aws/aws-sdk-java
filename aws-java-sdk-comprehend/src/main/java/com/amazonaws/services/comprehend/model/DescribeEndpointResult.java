...
public class DescribeEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Describes information associated with the specific endpoint.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEndpointProperties() == null ^ this.getEndpointProperties() == null)
            return false;
        if (other.getEndpointProperties() != null && other.getEndpointProperties().equals(this.getEndpointProperties()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getEndpointProperties() == null) ? 0 : getEndpointProperties().hashCode());
        return hashCode;
    }
