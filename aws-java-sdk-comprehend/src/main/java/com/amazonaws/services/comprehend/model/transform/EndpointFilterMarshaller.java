...
/**
 * EndpointFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EndpointFilterMarshaller {
    ...
    private static final EndpointFilterMarshaller instance = new EndpointFilterMarshaller();

    public static EndpointFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EndpointFilter endpointFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(endpointFilter.getModelArn(), MODELARN_BINDING);
            protocolMarshaller.marshall(endpointFilter.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(endpointFilter.getCreationTimeBefore(), CREATIONTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(endpointFilter.getCreationTimeAfter(), CREATIONTIMEAFTER_BINDING);
        } catch (Exception e) {
