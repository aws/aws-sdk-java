...
public class DescribeDominantLanguageDetectionJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDominantLanguageDetectionJobProperties() == null ^ this.getDominantLanguageDetectionJobProperties() == null)
            return false;
        if (other.getDominantLanguageDetectionJobProperties() != null
                && other.getDominantLanguageDetectionJobProperties().equals(this.getDominantLanguageDetectionJobProperties()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getDominantLanguageDetectionJobProperties() == null) ? 0 : getDominantLanguageDetectionJobProperties().hashCode());
        return hashCode;
    }
