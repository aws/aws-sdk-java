...
public class BatchDetectEntitiesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<BatchDetectEntitiesItemResult> resultList;
    /**
     * <p>
    ...
    public java.util.List<BatchDetectEntitiesItemResult> getResultList() {
        return resultList;
    }
    ...
    public BatchDetectEntitiesResult withResultList(BatchDetectEntitiesItemResult... resultList) {
        if (this.resultList == null) {
            setResultList(new java.util.ArrayList<BatchDetectEntitiesItemResult>(resultList.length));
        }
    ...
    public BatchDetectEntitiesResult withResultList(java.util.Collection<BatchDetectEntitiesItemResult> resultList) {
    ...
    public BatchDetectEntitiesResult withErrorList(java.util.Collection<BatchItemError> errorList) {
