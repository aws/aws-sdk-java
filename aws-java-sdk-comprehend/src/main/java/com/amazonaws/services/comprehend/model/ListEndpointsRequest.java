...
public class ListEndpointsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * Filters the endpoints that are returned. You can filter endpoints on their name, model, status, or the date and
     * time that they were created. You can only set one filter at a time.
     * </p>
     */
     ...
     * </p>
     * 
     * @return Filters the endpoints that are returned. You can filter endpoints on their name, model, status, or the
     *         date and time that they were created. You can only set one filter at a time.
     */
