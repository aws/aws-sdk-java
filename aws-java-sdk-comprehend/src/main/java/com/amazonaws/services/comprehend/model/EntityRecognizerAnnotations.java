 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/EntityRecognizerAnnotations"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EntityRecognizerAnnotations implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public EntityRecognizerAnnotations clone() {
        try {
            return (EntityRecognizerAnnotations) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehend.model.transform.EntityRecognizerAnnotationsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
