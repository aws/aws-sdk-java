...
public class DetectSentimentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A UTF-8 text string. The maximum string size is 5 KB.
     */
    ...
    public DetectSentimentRequest clone() {
        return (DetectSentimentRequest) super.clone();
    }
