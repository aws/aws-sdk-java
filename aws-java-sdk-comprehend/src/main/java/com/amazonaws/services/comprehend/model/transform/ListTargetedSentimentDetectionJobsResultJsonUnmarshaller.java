...
/**
 * ListTargetedSentimentDetectionJobsResult JSON Unmarshaller
 */
...
public class ListTargetedSentimentDetectionJobsResultJsonUnmarshaller implements
    ...
    public ListTargetedSentimentDetectionJobsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
                ...
                if (context.testExpression("TargetedSentimentDetectionJobPropertiesList", targetDepth)) {
                    ...
                    listTargetedSentimentDetectionJobsResult
                            .setTargetedSentimentDetectionJobPropertiesList(new ListUnmarshaller<TargetedSentimentDetectionJobProperties>(
                                    TargetedSentimentDetectionJobPropertiesJsonUnmarshaller.getInstance())

                            .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listTargetedSentimentDetectionJobsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
