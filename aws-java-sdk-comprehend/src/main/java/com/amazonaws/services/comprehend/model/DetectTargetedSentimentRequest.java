...
public class DetectTargetedSentimentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A UTF-8 text string. The maximum string length is 5 KB.
     */
    ...
    public DetectTargetedSentimentRequest clone() {
        return (DetectTargetedSentimentRequest) super.clone();
    }
