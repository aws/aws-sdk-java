...
public class ToxicLabelsMarshaller {
    ...
    private static final MarshallingInfo<Float> TOXICITY_BINDING = MarshallingInfo.builder(MarshallingType.FLOAT).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Toxicity").build();
    ...
    public void marshall(ToxicLabels toxicLabels, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(toxicLabels.getToxicity(), TOXICITY_BINDING);
        } catch (Exception e) {
