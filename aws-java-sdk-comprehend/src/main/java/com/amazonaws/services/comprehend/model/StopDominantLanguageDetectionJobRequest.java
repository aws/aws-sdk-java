...
public class StopDominantLanguageDetectionJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public StopDominantLanguageDetectionJobRequest clone() {
        return (StopDominantLanguageDetectionJobRequest) super.clone();
    }
