...
public class CreateEntityRecognizerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateEntityRecognizerResult clone() {
        try {
            return (CreateEntityRecognizerResult) super.clone();
