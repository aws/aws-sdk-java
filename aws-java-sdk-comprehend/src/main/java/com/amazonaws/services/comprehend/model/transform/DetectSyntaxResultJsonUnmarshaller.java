...
/**
 * DetectSyntaxResult JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SyntaxTokens", targetDepth)) {
                    context.nextToken();
                    detectSyntaxResult.setSyntaxTokens(new ListUnmarshaller<SyntaxToken>(SyntaxTokenJsonUnmarshaller.getInstance()).unmarshall(context));
                }
