 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/SentimentDetectionJobProperties"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SentimentDetectionJobProperties implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The current status of the sentiment detection job. If the status is <code>FAILED</code>, the
     ...
     * your sentiment detection job. For more information, see <a
     ...
     * </p>
     * 
     * @return The identifier assigned to the sentiment detection job.
     */
     ...
     * </p>
     * 
     * @return The name that you assigned to the sentiment detection job
     */
     ...
     * </p>
     * 
     * @return The current status of the sentiment detection job. If the status is <code>FAILED</code>, the
     *         <code>Messages</code> field shows the reason for the failure.
     * @see JobStatus
     */
     ...
     * </p>
     * 
     * @return The time that the sentiment detection job was submitted for processing.
     */
     ...
     * </p>
     * 
     * @return The time that the sentiment detection job ended.
     */
     ...
     * </p>
     * 
     * @return The input data configuration that you supplied when you created the sentiment detection job.
     */
     ...
     * </p>
     * 
     * @return The output data configuration that you supplied when you created the sentiment detection job.
     */
     ...
     *        for your sentiment detection job. For more information, see <a
     *        href="https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html">Amazon VPC</a>.
     */
    ...
    @Override
    public SentimentDetectionJobProperties clone() {
        try {
            return (SentimentDetectionJobProperties) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehend.model.transform.SentimentDetectionJobPropertiesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
