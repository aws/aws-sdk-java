...
/**
 * DocumentClassifierDocuments JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DocumentClassifierDocumentsJsonUnmarshaller implements Unmarshaller<DocumentClassifierDocuments, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("S3Uri", targetDepth)) {
                    context.nextToken();
                    documentClassifierDocuments.setS3Uri(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("TestS3Uri", targetDepth)) {
                    context.nextToken();
                    documentClassifierDocuments.setTestS3Uri(context.getUnmarshaller(String.class).unmarshall(context));
                }
