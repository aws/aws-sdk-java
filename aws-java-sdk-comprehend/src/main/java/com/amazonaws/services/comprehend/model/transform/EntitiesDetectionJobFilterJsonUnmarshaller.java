...
/**
 * EntitiesDetectionJobFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EntitiesDetectionJobFilterJsonUnmarshaller implements Unmarshaller<EntitiesDetectionJobFilter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobName", targetDepth)) {
                    context.nextToken();
                    entitiesDetectionJobFilter.setJobName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("JobStatus", targetDepth)) {
                    context.nextToken();
                    entitiesDetectionJobFilter.setJobStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
