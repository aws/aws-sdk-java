...
public class StartDominantLanguageDetectionJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public StartDominantLanguageDetectionJobResult withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
    ...
    public StartDominantLanguageDetectionJobResult withJobArn(String jobArn) {
        setJobArn(jobArn);
        return this;
    }
    ...
    public StartDominantLanguageDetectionJobResult withJobStatus(String jobStatus) {
    ...
    public StartDominantLanguageDetectionJobResult withJobStatus(JobStatus jobStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartDominantLanguageDetectionJobResult == false)
            return false;
        StartDominantLanguageDetectionJobResult other = (StartDominantLanguageDetectionJobResult) obj;
    ...
    @Override
    public StartDominantLanguageDetectionJobResult clone() {
        try {
            return (StartDominantLanguageDetectionJobResult) super.clone();
