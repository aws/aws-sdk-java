...
public class JobListEntryJsonMarshaller {
     ...
     */
    public void marshall(JobListEntry jobListEntry,
        ...
        try {
            ...
            if (jobListEntry.getJobId() != null) {
                jsonGenerator.writeFieldName("JobId").writeValue(
                        jobListEntry.getJobId());
            }
            if (jobListEntry.getJobState() != null) {
                jsonGenerator.writeFieldName("JobState").writeValue(
                        jobListEntry.getJobState());
            }
            if (jobListEntry.getIsMaster() != null) {
                jsonGenerator.writeFieldName("IsMaster").writeValue(
                        jobListEntry.getIsMaster());
            }
