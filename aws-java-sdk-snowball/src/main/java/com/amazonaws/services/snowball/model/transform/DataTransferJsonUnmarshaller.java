 ...
 */
public class DataTransferJsonUnmarshaller implements
        Unmarshaller<DataTransfer, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BytesTransferred", targetDepth)) {
                    context.nextToken();
                    dataTransfer.setBytesTransferred(context.getUnmarshaller(
                            Long.class).unmarshall(context));
                }
                if (context.testExpression("ObjectsTransferred", targetDepth)) {
                    context.nextToken();
                    dataTransfer.setObjectsTransferred(context.getUnmarshaller(
                            Long.class).unmarshall(context));
                }
                if (context.testExpression("TotalBytes", targetDepth)) {
                    context.nextToken();
                    dataTransfer.setTotalBytes(context.getUnmarshaller(
                            Long.class).unmarshall(context));
                }
                if (context.testExpression("TotalObjects", targetDepth)) {
                    context.nextToken();
                    dataTransfer.setTotalObjects(context.getUnmarshaller(
                            Long.class).unmarshall(context));
                }
