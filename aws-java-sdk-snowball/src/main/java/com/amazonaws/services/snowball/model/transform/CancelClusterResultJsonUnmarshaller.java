...
/**
 * CancelClusterResult JSON Unmarshaller
 */
...
public class CancelClusterResultJsonUnmarshaller implements Unmarshaller<CancelClusterResult, JsonUnmarshallerContext> {
    ...
    public CancelClusterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelClusterResult cancelClusterResult = new CancelClusterResult();
