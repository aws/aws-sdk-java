...
/**
 * CreateAddressResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateAddressResultJsonUnmarshaller implements Unmarshaller<CreateAddressResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AddressId", targetDepth)) {
                    context.nextToken();
                    createAddressResult.setAddressId(context.getUnmarshaller(String.class).unmarshall(context));
                }
