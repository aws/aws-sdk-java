...
/**
 * INDTaxDocuments JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class INDTaxDocumentsJsonUnmarshaller implements Unmarshaller<INDTaxDocuments, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GSTIN", targetDepth)) {
                    context.nextToken();
                    iNDTaxDocuments.setGSTIN(context.getUnmarshaller(String.class).unmarshall(context));
                }
