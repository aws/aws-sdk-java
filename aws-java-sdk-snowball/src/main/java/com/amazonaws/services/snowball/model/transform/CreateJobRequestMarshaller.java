...
public class CreateJobRequestMarshaller implements
    ...
    public Request<CreateJobRequest> marshall(CreateJobRequest createJobRequest) {
        ...
        Request<CreateJobRequest> request = new DefaultRequest<CreateJobRequest>(
                createJobRequest, "AmazonSnowball");
        ...
        try {
            ...
            if (createJobRequest.getShippingOption() != null) {
                jsonGenerator.writeFieldName("ShippingOption").writeValue(
                        createJobRequest.getShippingOption());
            }
            if (createJobRequest.getNotification() != null) {
                ...
                NotificationJsonMarshaller.getInstance().marshall(
                        createJobRequest.getNotification(), jsonGenerator);
            }
