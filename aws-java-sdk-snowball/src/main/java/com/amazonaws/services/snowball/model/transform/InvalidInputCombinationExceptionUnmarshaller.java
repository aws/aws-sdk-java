...
public class InvalidInputCombinationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidInputCombinationExceptionUnmarshaller instance;

    public static InvalidInputCombinationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidInputCombinationExceptionUnmarshaller();
        return instance;
    }
}
