 ...
 */
public class JobLogsJsonUnmarshaller implements
        Unmarshaller<JobLogs, JsonUnmarshallerContext> {
    ...
    public JobLogs unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobCompletionReportURI",
                        targetDepth)) {
                    context.nextToken();
                    jobLogs.setJobCompletionReportURI(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("JobSuccessLogURI", targetDepth)) {
                    context.nextToken();
                    jobLogs.setJobSuccessLogURI(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("JobFailureLogURI", targetDepth)) {
                    context.nextToken();
                    jobLogs.setJobFailureLogURI(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
