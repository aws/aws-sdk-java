...
public class Notification implements Serializable, Cloneable {
     ...
     * <a href="http://docs.aws.amazon.com/sns/latest/api/API_CreateTopic.html">
     * CreateTopic</a> Amazon SNS API action.
     * </p>
     * <p>
     * Note that you can subscribe email addresses to an Amazon SNS topic
     * through the AWS Management Console, or by using the <a
     * href="http://docs.aws.amazon.com/sns/latest/api/API_Subscribe.html"
     ...
     *        >CreateTopic</a> Amazon SNS API action.</p>
     *        <p>
     *        Note that you can subscribe email addresses to an Amazon SNS topic
     ...
     * </p>
     * 
     * @return The new SNS <code>TopicArn</code> that you want to associate with
     *         this job. You can create Amazon Resource Names (ARNs) for topics
     *         by using the <a href=
     *         "http://docs.aws.amazon.com/sns/latest/api/API_CreateTopic.html"
     *         >CreateTopic</a> Amazon SNS API action.</p>
     *         <p>
     *         Note that you can subscribe email addresses to an Amazon SNS
    ...
    public void setJobStatesToNotify(
            java.util.Collection<String> jobStatesToNotify) {
        if (jobStatesToNotify == null) {
            this.jobStatesToNotify = null;
            return;
        }

        this.jobStatesToNotify = new java.util.ArrayList<String>(
                jobStatesToNotify);
    }
     ...
     * any). Use {@link #setJobStatesToNotify(java.util.Collection)} or
     * {@link #withJobStatesToNotify(java.util.Collection)} if you want to
    ...
    public Notification withJobStatesToNotify(String... jobStatesToNotify) {
        if (this.jobStatesToNotify == null) {
            setJobStatesToNotify(new java.util.ArrayList<String>(
                    jobStatesToNotify.length));
        }
    ...
    public Notification withJobStatesToNotify(
            java.util.Collection<String> jobStatesToNotify) {
    ...
    public Notification withJobStatesToNotify(JobState... jobStatesToNotify) {
        java.util.ArrayList<String> jobStatesToNotifyCopy = new java.util.ArrayList<String>(
                jobStatesToNotify.length);
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getJobStatesToNotify() == null
                ^ this.getJobStatesToNotify() == null)
            return false;
        if (other.getJobStatesToNotify() != null
                && other.getJobStatesToNotify().equals(
                        this.getJobStatesToNotify()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getJobStatesToNotify() == null) ? 0
                        : getJobStatesToNotify().hashCode());
        hashCode = prime * hashCode
                + ((getNotifyAll() == null) ? 0 : getNotifyAll().hashCode());
        return hashCode;
    }
