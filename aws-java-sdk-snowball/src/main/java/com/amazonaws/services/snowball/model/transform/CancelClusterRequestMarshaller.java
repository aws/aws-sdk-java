...
/**
 * CancelClusterRequestMarshaller
 */
...
public class CancelClusterRequestMarshaller {
    ...
    private static final CancelClusterRequestMarshaller instance = new CancelClusterRequestMarshaller();

    public static CancelClusterRequestMarshaller getInstance() {
        return instance;
    }
