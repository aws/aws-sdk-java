...
public class UpdateJobRequestMarshaller implements
    ...
    public Request<UpdateJobRequest> marshall(UpdateJobRequest updateJobRequest) {
        ...
        Request<UpdateJobRequest> request = new DefaultRequest<UpdateJobRequest>(
                updateJobRequest, "AmazonSnowball");
        ...
        try {
            ...
            if (updateJobRequest.getJobId() != null) {
                jsonGenerator.writeFieldName("JobId").writeValue(
                        updateJobRequest.getJobId());
            }
            if (updateJobRequest.getRoleARN() != null) {
                jsonGenerator.writeFieldName("RoleARN").writeValue(
                        updateJobRequest.getRoleARN());
            }
            if (updateJobRequest.getNotification() != null) {
                jsonGenerator.writeFieldName("Notification");
                NotificationJsonMarshaller.getInstance().marshall(
                        updateJobRequest.getNotification(), jsonGenerator);
            }
            if (updateJobRequest.getResources() != null) {
                jsonGenerator.writeFieldName("Resources");
                JobResourceJsonMarshaller.getInstance().marshall(
                        updateJobRequest.getResources(), jsonGenerator);
            }
            if (updateJobRequest.getAddressId() != null) {
                jsonGenerator.writeFieldName("AddressId").writeValue(
                        updateJobRequest.getAddressId());
            }
            if (updateJobRequest.getShippingOption() != null) {
                jsonGenerator.writeFieldName("ShippingOption").writeValue(
                        updateJobRequest.getShippingOption());
            }
            if (updateJobRequest.getDescription() != null) {
                jsonGenerator.writeFieldName("Description").writeValue(
                        updateJobRequest.getDescription());
            }
            if (updateJobRequest.getSnowballCapacityPreference() != null) {
                jsonGenerator.writeFieldName("SnowballCapacityPreference")
                        .writeValue(
                                updateJobRequest
