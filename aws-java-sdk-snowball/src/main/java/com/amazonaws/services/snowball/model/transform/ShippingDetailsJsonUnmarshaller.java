 ...
 */
public class ShippingDetailsJsonUnmarshaller implements
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ShippingOption", targetDepth)) {
                    context.nextToken();
                    shippingDetails.setShippingOption(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("InboundShipment", targetDepth)) {
                    context.nextToken();
                    shippingDetails.setInboundShipment(ShipmentJsonUnmarshaller
                            .getInstance().unmarshall(context));
                }
                if (context.testExpression("OutboundShipment", targetDepth)) {
                    context.nextToken();
                    shippingDetails
                            .setOutboundShipment(ShipmentJsonUnmarshaller
                                    .getInstance().unmarshall(context));
                }
