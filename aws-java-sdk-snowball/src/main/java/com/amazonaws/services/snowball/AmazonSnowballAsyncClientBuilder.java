...
/**
 * Fluent builder for
 * {@link com.amazonaws.services.snowball.AmazonSnowballAsync}. Use of the
 * builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonSnowballAsyncClientBuilder
        extends
        AwsAsyncClientBuilder<AmazonSnowballAsyncClientBuilder, AmazonSnowballAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonSnowballAsync using the
