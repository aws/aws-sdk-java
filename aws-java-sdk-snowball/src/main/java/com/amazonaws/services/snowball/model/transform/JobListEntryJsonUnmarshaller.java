 ...
 */
public class JobListEntryJsonUnmarshaller implements
        Unmarshaller<JobListEntry, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobId", targetDepth)) {
                    context.nextToken();
                    jobListEntry.setJobId(context.getUnmarshaller(String.class)
                            .unmarshall(context));
                }
                if (context.testExpression("JobState", targetDepth)) {
                    context.nextToken();
                    jobListEntry.setJobState(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("IsMaster", targetDepth)) {
                    context.nextToken();
                    jobListEntry.setIsMaster(context.getUnmarshaller(
