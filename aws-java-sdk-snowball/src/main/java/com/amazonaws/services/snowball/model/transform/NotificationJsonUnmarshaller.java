 ...
 */
public class NotificationJsonUnmarshaller implements
        Unmarshaller<Notification, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SnsTopicARN", targetDepth)) {
                    context.nextToken();
                    notification.setSnsTopicARN(context.getUnmarshaller(
                            String.class).unmarshall(context));
                }
                if (context.testExpression("JobStatesToNotify", targetDepth)) {
                    context.nextToken();
                    notification
                            .setJobStatesToNotify(new ListUnmarshaller<String>(
                                    context.getUnmarshaller(String.class))
                                    .unmarshall(context));
                }
                if (context.testExpression("NotifyAll", targetDepth)) {
                    context.nextToken();
                    notification.setNotifyAll(context.getUnmarshaller(
