...
/**
 * GetJobUnlockCodeResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetJobUnlockCodeResultJsonUnmarshaller implements Unmarshaller<GetJobUnlockCodeResult, JsonUnmarshallerContext> {
    ...
    public GetJobUnlockCodeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UnlockCode", targetDepth)) {
                    context.nextToken();
                    getJobUnlockCodeResult.setUnlockCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
