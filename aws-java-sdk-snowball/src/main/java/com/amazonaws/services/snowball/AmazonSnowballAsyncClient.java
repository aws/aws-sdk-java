 ...
 */
@ThreadSafe
public class AmazonSnowballAsyncClient extends AmazonSnowballClient implements
        AmazonSnowballAsync {
     ...
     * Snowball. A credentials provider chain will be used that searches for
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * Snowball using the specified AWS account credentials.
     * <p>
     * Asynchronous methods are delegated to a fixed-size thread pool containing
     * 50 threads (to match the default maximum number of concurrent connections
     * to the service).
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * Snowball using the specified AWS account credentials and executor
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * Snowball using the specified AWS account credentials, executor service,
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * Snowball using the specified AWS account credentials provider. Default
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * Snowball using the provided AWS account credentials provider and client
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * Snowball using the specified AWS account credentials provider and
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * Snowball using the specified AWS account credentials provider, executor
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon
     * Snowball using the specified parameters.
     *
    ...
    public java.util.concurrent.Future<CreateAddressResult> createAddressAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<CreateAddressResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<DescribeAddressesResult> describeAddressesAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DescribeAddressesResult>() {
                    @Override
    ...
    public java.util.concurrent.Future<DescribeJobResult> describeJobAsync(
        ...
        return executorService
                .submit(new java.util.concurrent.Callable<DescribeJobResult>() {
                    @Override
