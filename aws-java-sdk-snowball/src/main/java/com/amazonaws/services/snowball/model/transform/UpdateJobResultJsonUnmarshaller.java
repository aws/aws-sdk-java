 ...
 */
public class UpdateJobResultJsonUnmarshaller implements
        Unmarshaller<UpdateJobResult, JsonUnmarshallerContext> {

    public UpdateJobResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
