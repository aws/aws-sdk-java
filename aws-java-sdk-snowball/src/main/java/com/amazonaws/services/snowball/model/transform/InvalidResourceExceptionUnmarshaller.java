...
public class InvalidResourceExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceType", targetDepth)) {
                    context.nextToken();
                    invalidResourceException.setResourceType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static InvalidResourceExceptionUnmarshaller instance;

    public static InvalidResourceExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidResourceExceptionUnmarshaller();
        return instance;
    }
}
