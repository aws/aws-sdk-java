...
public class GetSnowballUsageResultJsonUnmarshaller implements
    ...
    public GetSnowballUsageResult unmarshall(JsonUnmarshallerContext context)
            throws Exception {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SnowballLimit", targetDepth)) {
                    ...
                    getSnowballUsageResult
                            .setSnowballLimit(context.getUnmarshaller(
                                    Integer.class).unmarshall(context));
                }
                if (context.testExpression("SnowballsInUse", targetDepth)) {
                    context.nextToken();
                    getSnowballUsageResult
                            .setSnowballsInUse(context.getUnmarshaller(
                                    Integer.class).unmarshall(context));
                }
