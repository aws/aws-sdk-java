...
/**
 * Fluent builder for {@link com.amazonaws.services.snowball.AmazonSnowball}.
 * Use of the builder is preferred over using constructors of the client class.
 **/
@NotThreadSafe
public final class AmazonSnowballClientBuilder extends
        AwsSyncClientBuilder<AmazonSnowballClientBuilder, AmazonSnowball> {
    ...
    /**
     * Construct a synchronous implementation of AmazonSnowball using the
