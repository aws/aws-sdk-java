...
public class KeyRangeJsonMarshaller {
     ...
     */
    public void marshall(KeyRange keyRange,
        ...
        try {
            ...
            if (keyRange.getBeginMarker() != null) {
                jsonGenerator.writeFieldName("BeginMarker").writeValue(
                        keyRange.getBeginMarker());
            }
            if (keyRange.getEndMarker() != null) {
                jsonGenerator.writeFieldName("EndMarker").writeValue(
                        keyRange.getEndMarker());
            }
