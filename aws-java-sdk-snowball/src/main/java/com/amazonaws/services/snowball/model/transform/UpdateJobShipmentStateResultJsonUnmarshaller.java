...
/**
 * UpdateJobShipmentStateResult JSON Unmarshaller
 */
...
public class UpdateJobShipmentStateResultJsonUnmarshaller implements Unmarshaller<UpdateJobShipmentStateResult, JsonUnmarshallerContext> {
    ...
    public UpdateJobShipmentStateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateJobShipmentStateResult updateJobShipmentStateResult = new UpdateJobShipmentStateResult();
