...
/**
 * SourceCodeType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SourceCodeTypeJsonUnmarshaller implements Unmarshaller<SourceCodeType, JsonUnmarshallerContext> {

    public SourceCodeType unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SourceCodeTypeJsonUnmarshaller instance;

    public static SourceCodeTypeJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SourceCodeTypeJsonUnmarshaller();
        return instance;
    }
}
