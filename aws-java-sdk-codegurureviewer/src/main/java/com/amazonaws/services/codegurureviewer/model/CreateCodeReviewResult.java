...
public class CreateCodeReviewResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateCodeReviewResult withCodeReview(CodeReview codeReview) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCodeReviewResult == false)
            return false;
        CreateCodeReviewResult other = (CreateCodeReviewResult) obj;
    ...
    @Override
    public CreateCodeReviewResult clone() {
        try {
            return (CreateCodeReviewResult) super.clone();
