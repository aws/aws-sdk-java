...
/**
 * CommitDiffSourceCodeTypeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CommitDiffSourceCodeTypeMarshaller {
    ...
    public static CommitDiffSourceCodeTypeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CommitDiffSourceCodeType commitDiffSourceCodeType, ProtocolMarshaller protocolMarshaller) {

        if (commitDiffSourceCodeType == null) {
